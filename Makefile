...
deps:
	...
	yq -i '.info.contact.name = "Cliffano Subagio"' specification/pinterest.yml
	yq -i '.info.contact.url = "https://github.com/cliffano/pinterest-sdk"' specification/pinterest.yml
	yq -i '.info.contact.email = "blah@cliffano.com"' specification/pinterest.yml
