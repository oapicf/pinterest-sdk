...
**customConversionEventMetrics** | [AdsAnalyticsCreateAsyncRequestAllOfCustomConversionEventMetrics] | List of advertiser-defined custom conversion event metrics to include in the report | [optional] 
