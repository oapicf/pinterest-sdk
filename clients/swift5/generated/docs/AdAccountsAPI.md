...
let adAccountCreate = AdAccountCreate(country: Country(), currency: Currency(), name: "name_example", ownerUserId: "ownerUserId_example") // AdAccountCreate | 
...
```swift
    open class func analyticsCreateConversionProductReport(adAccountId: String, conversionProductReportRequest: ConversionProductReportRequest, completion: @escaping (_ data: AdsAnalyticsCreateAsyncResponse?, _ error: Error?) -> Void)
```
...
let adAccountId = "adAccountId_example" // String | Unique identifier of an ad account.
let conversionProductReportRequest = ConversionProductReportRequest(adGroupIds: ["adGroupIds_example"], campaignIds: ["campaignIds_example"], campaignObjectiveTypes: [ObjectiveType()], clickWindowDays: ConversionAttributionWindowDays(), columns: [ConversionProductReportingColumn()], conversionProductAttributionType: "conversionProductAttributionType_example", conversionProductBreakdown: "conversionProductBreakdown_example", conversionReportTime: ConversionReportTimeType(), endDate: "endDate_example", granularity: "granularity_example", level: "level_example", productSkuIds: ["productSkuIds_example"], reportName: "reportName_example", startDate: "startDate_example", viewWindowDays: nil) // ConversionProductReportRequest | 

// Create a request for a brand, category, SKU report
AdAccountsAPI.analyticsCreateConversionProductReport(adAccountId: adAccountId, conversionProductReportRequest: conversionProductReportRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
let adAccountId = "adAccountId_example" // String | Unique identifier of an ad account.
let createMMMReportRequest = CreateMMMReportRequest(countries: [TargetingAdvertiserCountry()], columns: [MMMReportingColumn()], endDate: "endDate_example", granularity: "granularity_example", level: "level_example", reportName: "reportName_example", startDate: "startDate_example", targetingTypes: [MMMReportingTargetingType()]) // CreateMMMReportRequest | 
...
let adAccountId = "adAccountId_example" // String | Unique identifier of an ad account.
let adsAnalyticsCreateAsyncRequest = AdsAnalyticsCreateAsyncRequest(attributionTypes: [ConversionReportAttributionType()], clickWindowDays: ConversionAttributionWindowDays(), conversionReportTime: ConversionReportTimeType(), endDate: "endDate_example", engagementWindowDays: nil, granularity: Granularity(), startDate: "startDate_example", viewWindowDays: nil, campaignIds: ["campaignIds_example"], campaignStatuses: [CampaignSummaryStatus()], campaignObjectiveTypes: [ObjectiveType()], campaignBrandLabel: "campaignBrandLabel_example", adGroupIds: ["adGroupIds_example"], adGroupStatuses: [AdGroupSummaryStatus()], adIds: ["adIds_example"], adStatuses: [PinPromotionSummaryStatus()], productGroupIds: ["productGroupIds_example"], productGroupStatuses: [ProductGroupSummaryStatus()], productItemIds: ["productItemIds_example"], targetingTypes: ["targetingTypes_example"], metricsFilters: [AdsAnalyticsMetricsFilter(field: AdsAnalyticsFilterColumn(), _operator: AdsAnalyticsFilterOperator(), values: [123])], columns: [ReportingColumnAsync()], combineTargetingTypes: false, customConversionEventMetrics: [AdsAnalyticsCreateAsyncRequest_allOf_custom_conversion_event_metrics(customEventMetricsType: "customEventMetricsType_example", customEventName: "customEventName_example")], endHour: 123, level: MetricsReportingLevel(), primarySort: "primarySort_example", reportFormat: DataOutputFormat(), reportingTimezone: ReportingTimeZone(), startHour: 123) // AdsAnalyticsCreateAsyncRequest | 
...
let granularity = Granularity() // Granularity |    TOTAL - metrics are aggregated over the specified date range.    DAY - metrics are broken down daily.    HOUR - metrics are broken down hourly.    WEEKLY - metrics are broken down weekly.    MONTHLY - metrics are broken down monthly (optional)
...
```swift
    open class func analyticsGetConversionProductReport(adAccountId: String, token: String, completion: @escaping (_ data: AdsAnalyticsGetAsyncResponse?, _ error: Error?) -> Void)
```
