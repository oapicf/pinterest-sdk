...
# **searchUserPinsList**
```swift
    open class func searchUserPinsList(query: String, adAccountId: String? = nil, bookmark: String? = nil, completion: @escaping (_ data: SearchUserPinsList200Response?, _ error: Error?) -> Void)
```
