...
let customerListRequest = CustomerListRequest(listType: UserListType(), name: "name_example", records: "records_example") // CustomerListRequest | Parameters to get Customer lists info
...
let adAccountId = "adAccountId_example" // String | Unique identifier of an ad account.
let customerListId = "customerListId_example" // String | Unique identifier of a customer list
let customerListUpdateRequest = CustomerListUpdateRequest(operationType: UserListOperationType(), records: "records_example") // CustomerListUpdateRequest | 
