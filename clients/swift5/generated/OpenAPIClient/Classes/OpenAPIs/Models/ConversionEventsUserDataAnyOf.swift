//
// ConversionEventsUserDataAnyOf.swift
//
...
public struct ConversionEventsUserDataAnyOf: Codable, JSONEncodable, Hashable {
    ...
    public init(em: [String], hashedMaids: [String]? = nil, clientIpAddress: String? = nil, clientUserAgent: String? = nil) {
        self.em = em
