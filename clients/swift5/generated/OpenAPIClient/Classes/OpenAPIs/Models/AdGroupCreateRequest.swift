...
public struct AdGroupCreateRequest: Codable, JSONEncodable, Hashable {
    ...
    public init(name: String, status: EntityStatus? = nil, budgetInMicroCurrency: Int? = nil, bidInMicroCurrency: Int? = nil, optimizationGoalMetadata: AdGroupCommonOptimizationGoalMetadata? = nil, budgetType: BudgetType? = "DAILY", startTime: Int? = nil, endTime: Int? = nil, targetingSpec: TargetingSpec? = nil, lifetimeFrequencyCap: Int? = nil, trackingUrls: AdGroupCommonTrackingUrls? = nil, autoTargetingEnabled: Bool? = nil, placementGroup: PlacementGroupType? = nil, pacingDeliveryType: PacingDeliveryType? = "STANDARD", campaignId: String, billableEvent: ActionType, bidStrategyType: BidStrategyType? = nil) {
        self.name = name
        self.status = status
