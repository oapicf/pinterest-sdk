//
// CatalogsHotelItemsFilter.swift
//
...
public struct CatalogsHotelItemsFilter: Codable, JSONEncodable, Hashable {
    ...
    public static let hotelIdsRule = ArrayRule(minItems: 1, maxItems: 100, uniqueItems: false)
