...
public struct CatalogsCreativeAssetsAttributes: Codable, JSONEncodable, Hashable {
    ...
    public init(title: String? = nil, description: String? = nil, link: String? = nil, iosDeepLink: String? = nil, androidDeepLink: String? = nil, googleProductCategory: String? = nil, customLabel0: String? = nil, customLabel1: String? = nil, customLabel2: String? = nil, customLabel3: String? = nil, customLabel4: String? = nil, visibility: String? = nil, imageLink: String? = nil, videoLink: String? = nil) {
        self.title = title
