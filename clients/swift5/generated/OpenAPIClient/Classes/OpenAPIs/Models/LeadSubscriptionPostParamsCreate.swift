...
public struct LeadSubscriptionPostParamsCreate: Codable, JSONEncodable, Hashable {
    ...
    public var partnerMetadata: LeadSubscriptionPostParamsCreateAllOfPartnerMetadata?
    /** Partner refresh token. Only for clients that requires authentication. We recommend to avoid this param. */
    public var partnerRefreshToken: String?

    public init(leadFormId: String? = nil, webhookUrl: String, partnerAccessToken: String? = nil, partnerMetadata: LeadSubscriptionPostParamsCreateAllOfPartnerMetadata? = nil, partnerRefreshToken: String? = nil) {
