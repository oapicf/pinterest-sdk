...
public struct CampaignCommon: Codable, JSONEncodable, Hashable {
    ...
    public init(adAccountId: String, name: String? = nil, status: EntityStatus? = "ACTIVE", lifetimeSpendCap: Int? = nil, dailySpendCap: Int? = nil, orderLineId: String? = nil, trackingUrls: TrackingUrls? = nil, startTime: Int? = nil, endTime: Int? = nil) {
