...
public struct CatalogsHotelFeedsUpdateRequest: Codable, JSONEncodable, Hashable {
    ...
    public init(catalogType: CatalogsType, credentials: CatalogsFeedCredentials? = nil, defaultCurrency: NullableCurrency? = nil, format: CatalogsFormat? = nil, location: String? = nil, name: String? = nil, preferredProcessingSchedule: CatalogsFeedProcessingSchedule? = nil, status: CatalogsStatus? = nil) {
