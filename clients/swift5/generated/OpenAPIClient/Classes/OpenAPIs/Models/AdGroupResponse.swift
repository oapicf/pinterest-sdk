...
public struct AdGroupResponse: Codable, JSONEncodable, Hashable {
    ...
    public init(name: String? = nil, status: EntityStatus? = nil, budgetInMicroCurrency: Int? = nil, bidInMicroCurrency: Int? = nil, optimizationGoalMetadata: AdGroupCommonOptimizationGoalMetadata? = nil, budgetType: BudgetType? = nil, startTime: Int? = nil, endTime: Int? = nil, targetingSpec: TargetingSpec? = nil, lifetimeFrequencyCap: Int? = nil, trackingUrls: AdGroupCommonTrackingUrls? = nil, autoTargetingEnabled: Bool? = nil, placementGroup: PlacementGroupType? = nil, pacingDeliveryType: PacingDeliveryType? = nil, campaignId: String? = nil, billableEvent: ActionType? = nil, bidStrategyType: BidStrategyType? = nil, id: String? = nil, adAccountId: String? = nil, createdTime: Int? = nil, updatedTime: Int? = nil, type: String? = "adgroup", conversionLearningModeType: ConversionLearningModeType? = nil, summaryStatus: AdGroupSummaryStatus? = nil, feedProfileId: String? = nil, dcaAssets: AnyCodable? = nil) {
        self.name = name
        self.status = status
