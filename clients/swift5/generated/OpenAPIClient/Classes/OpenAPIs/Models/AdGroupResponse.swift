...
public struct AdGroupResponse: Codable, JSONEncodable, Hashable {
    ...
    public init(name: String? = nil, status: EntityStatus? = nil, budgetInMicroCurrency: Int? = nil, bidInMicroCurrency: Int? = nil, budgetType: BudgetType? = nil, startTime: Int? = nil, endTime: Int? = nil, targetingSpec: [String: [String]]? = nil, lifetimeFrequencyCap: Int? = nil, trackingUrls: TrackingUrls? = nil, autoTargetingEnabled: Bool? = nil, placementGroup: PlacementGroupType? = nil, pacingDeliveryType: PacingDeliveryType? = nil, conversionLearningModeType: ConversionLearningModeType? = nil, summaryStatus: AdGroupSummaryStatus? = nil, feedProfileId: String? = nil, campaignId: String? = nil, billableEvent: ActionType? = nil, id: String? = nil, type: String? = nil, adAccountId: String? = nil, createdTime: Int? = nil, updatedTime: Int? = nil) {
        self.name = name
        self.status = status
