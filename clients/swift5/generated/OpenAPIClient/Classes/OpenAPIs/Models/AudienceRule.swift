...
public struct AudienceRule: Codable, JSONEncodable, Hashable {
    ...
    public init(adAccountId: String? = nil, adId: [String]? = nil, campaignId: [String]? = nil, country: String? = nil, customerListId: String? = nil, engagementDomain: [String]? = nil, engagementType: String? = nil, engagerType: Int? = nil, event: String? = nil, eventData: EventData? = nil, eventSource: AnyCodable? = nil, ingestionSource: AnyCodable? = nil, objectiveType: [ObjectiveType]? = nil, percentage: Int? = nil, pinId: [String]? = nil, prefill: Bool? = nil, retentionDays: Int? = nil, seedId: [String]? = nil, url: [String]? = nil, visitorSourceId: String? = nil) {
