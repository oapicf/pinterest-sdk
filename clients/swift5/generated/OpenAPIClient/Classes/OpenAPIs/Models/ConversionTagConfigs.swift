...
public struct ConversionTagConfigs: Codable, JSONEncodable, Hashable {
    ...
    public init(aemEnabled: Bool? = false, mdFrequency: Double? = 1, aemFnlnEnabled: Bool? = false, aemPhEnabled: Bool? = false, aemGeEnabled: Bool? = false, aemDbEnabled: Bool? = false, aemLocEnabled: Bool? = false) {
