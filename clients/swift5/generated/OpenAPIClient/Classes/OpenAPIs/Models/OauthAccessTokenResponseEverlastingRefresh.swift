...
public struct OauthAccessTokenResponseEverlastingRefresh: Codable, JSONEncodable, Hashable {
    ...
    public init(refreshToken: String, refreshTokenExpiresIn: Int, refreshTokenExpiresAt: Int, responseType: ResponseType? = nil, accessToken: String, tokenType: String = "bearer", expiresIn: Int, scope: String) {
