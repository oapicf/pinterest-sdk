...
public struct CampaignCreateCommon: Codable, JSONEncodable, Hashable {
    ...
    public init(adAccountId: String? = nil, dailySpendCap: Int? = nil, endTime: Int? = nil, isAutomatedCampaign: Bool? = nil, isFlexibleDailyBudgets: Bool? = nil, lifetimeSpendCap: Int? = nil, name: String? = nil, orderLineId: String? = nil, startTime: Int? = nil, status: EntityStatus? = nil, trackingUrls: TrackingUrls? = nil, defaultAdGroupBudgetInMicroCurrency: Int? = nil, isCampaignBudgetOptimization: Bool? = nil) {
