...
public struct LeadFormUpdateRequest: Codable, JSONEncodable, Hashable {
    ...
    public init(name: String? = nil, privacyPolicyLink: String? = nil, hasAcceptedTerms: Bool? = nil, completionMessage: String? = nil, status: LeadFormStatus? = nil, disclosureLanguage: String? = nil, questions: [LeadFormQuestion]? = nil, policyLinks: [LeadFormCommonPolicyLinksInner]? = nil, id: String) {
        self.name = name
