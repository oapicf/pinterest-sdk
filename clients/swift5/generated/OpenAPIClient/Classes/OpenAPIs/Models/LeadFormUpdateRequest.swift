...
public struct LeadFormUpdateRequest: Codable, JSONEncodable, Hashable {
    ...
    public init(completionMessage: String? = nil, disclosureLanguage: String? = nil, hasAcceptedTerms: Bool? = nil, name: String? = nil, policyLinks: [LeadFormCommonPolicyLinksInner]? = nil, privacyPolicyLink: String? = nil, questions: [LeadFormQuestion]? = nil, status: LeadFormStatus? = nil, id: String) {
