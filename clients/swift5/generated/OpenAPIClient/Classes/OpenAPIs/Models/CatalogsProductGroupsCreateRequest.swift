//
// CatalogsProductGroupsCreateRequest.swift
//
...
public enum CatalogsProductGroupsCreateRequest: Codable, JSONEncodable, Hashable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        if let value = try? container.decode(CatalogsProductGroupCreateRequest.self) {
            ...
            throw DecodingError.typeMismatch(Self.Type.self, .init(codingPath: decoder.codingPath, debugDescription: "Unable to decode instance of CatalogsProductGroupsCreateRequest"))
        }
    }
}
