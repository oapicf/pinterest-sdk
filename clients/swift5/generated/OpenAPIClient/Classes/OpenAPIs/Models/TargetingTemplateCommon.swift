...
public struct TargetingTemplateCommon: Codable, JSONEncodable, Hashable {
    ...
    public init(name: String? = nil, autoTargetingEnabled: Bool? = true, targetingAttributes: TargetingSpec? = nil, placementGroup: PlacementGroupType? = nil, keywords: [TargetingTemplateKeyword]? = nil, trackingUrls: TrackingUrls? = nil) {
        self.name = name
