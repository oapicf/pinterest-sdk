...
public struct TargetingTemplateCommon: Codable, JSONEncodable, Hashable {
    ...
    public init(autoTargetingEnabled: Bool? = true, keywords: [TargetingTemplateKeyword]? = nil, name: String? = nil, placementGroup: PlacementGroupType? = nil, targetingAttributes: TargetingSpec? = nil, trackingUrls: TrackingUrls? = nil) {
