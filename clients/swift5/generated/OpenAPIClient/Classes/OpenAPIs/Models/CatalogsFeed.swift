...
public struct CatalogsFeed: Codable, JSONEncodable, Hashable {
    ...
    public init(createdAt: Date? = nil, id: String? = nil, updatedAt: Date? = nil, defaultCountry: Country, defaultAvailability: ProductAvailabilityType?, defaultCurrency: NullableCurrency?, name: String?, format: CatalogsFormat, defaultLocale: String, credentials: CatalogsFeedCredentials?, location: String, preferredProcessingSchedule: CatalogsFeedProcessingSchedule?, status: CatalogsStatus) {
