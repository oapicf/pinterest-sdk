//
// ConversionEventsUserDataAnyOf1.swift
//
...
public struct ConversionEventsUserDataAnyOf1: Codable, JSONEncodable, Hashable {
    ...
    public init(em: [String]? = nil, hashedMaids: [String], clientIpAddress: String? = nil, clientUserAgent: String? = nil) {
        self.em = em
