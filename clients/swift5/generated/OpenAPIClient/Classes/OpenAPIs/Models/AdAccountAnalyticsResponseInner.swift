//
// AdAccountAnalyticsResponseInner.swift
//
...
public struct AdAccountAnalyticsResponseInner: Codable, JSONEncodable, Hashable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        AD_ACCOUNT_ID = try container.decode(String.self, forKey: .AD_ACCOUNT_ID)
        DATE = try container.decodeIfPresent(Date.self, forKey: .DATE)
        var nonAdditionalPropertyKeys = Set<String>()
        nonAdditionalPropertyKeys.insert("AD_ACCOUNT_ID")
