...
public struct IntegrationRequest: Codable, JSONEncodable, Hashable {
    ...
    public init(additionalId1: String? = nil, connectedAdvertiserId: String? = nil, connectedLbaId: String? = nil, connectedMerchantId: String? = nil, connectedTagId: String? = nil, externalBusinessId: String? = nil, partnerAccessToken: String? = nil, partnerAccessTokenExpiry: Int? = nil, partnerMetadata: String? = nil, partnerPrimaryEmail: String? = nil, partnerRefreshToken: String? = nil, partnerRefreshTokenExpiry: Int? = nil, scopes: String? = nil) {
