...
public struct IntegrationRequest: Codable, JSONEncodable, Hashable {
    ...
    public init(externalBusinessId: String? = nil, connectedMerchantId: String? = nil, connectedAdvertiserId: String? = nil, connectedLbaId: String? = nil, connectedTagId: String? = nil, partnerAccessToken: String? = nil, partnerRefreshToken: String? = nil, partnerPrimaryEmail: String? = nil, partnerAccessTokenExpiry: Int? = nil, partnerRefreshTokenExpiry: Int? = nil, scopes: String? = nil, additionalId1: String? = nil, partnerMetadata: String? = nil) {
