...
public struct OrderLines: Codable, JSONEncodable, Hashable {
    ...
    public init(adAccountId: String? = nil, budget: Double? = nil, endTime: Double? = nil, id: String? = nil, name: String? = nil, paidBudget: Double? = nil, paidType: OrderLinePaidType? = nil, purchaseOrderId: String? = nil, startTime: Double? = nil, status: OrderLineStatus? = nil, type: String? = nil) {
