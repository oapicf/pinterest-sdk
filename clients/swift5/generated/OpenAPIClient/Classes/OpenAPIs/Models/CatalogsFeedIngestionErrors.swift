...
public struct CatalogsFeedIngestionErrors: Codable, JSONEncodable, Hashable {
    ...
    public init(ACCOUNT_FLAGGED: Int? = nil, FETCH_GOOGLE_SHEET_NOT_SHARED: Int? = nil, IMAGE_FILE_NOT_ACCESSIBLE: Int? = nil, IMAGE_FILE_NOT_FOUND: Int? = nil, IMAGE_INVALID_FILE: Int? = nil, IMAGE_LEVEL_INTERNAL_ERROR: Int? = nil, IMAGE_MALFORMED_URL: Int? = nil, LARGE_PRODUCT_COUNT_DECREASE: LARGEPRODUCTCOUNTDECREASE? = nil, LINE_LEVEL_INTERNAL_ERROR: Int? = nil) {
