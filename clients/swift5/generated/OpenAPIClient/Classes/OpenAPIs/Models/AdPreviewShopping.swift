...
public struct AdPreviewShopping: Codable, JSONEncodable, Hashable {
    ...
    public init(catalogProductGroupId: String, creativeType: CreativeType, customizableCtaType: CustomizableCTAType? = nil, heroImageTitle: String? = nil, heroImageUrl: String? = nil, heroPinId: String? = nil, imageTag: String? = nil, itemId: String? = nil, preferredMediaType: PreferredMediaType? = nil, videoTag: String? = nil) {
