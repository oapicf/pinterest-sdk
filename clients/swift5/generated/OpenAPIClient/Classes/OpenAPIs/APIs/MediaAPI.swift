...
open class MediaAPI {
     ...
     */
    @discardableResult
    open class func mediaList(bookmark: String? = nil, pageSize: Int? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: Paginated?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    open class func mediaListWithRequestBuilder(bookmark: String? = nil, pageSize: Int? = nil) -> RequestBuilder<Paginated> {
        let localVariablePath = "/media"
        let localVariableURLString = OpenAPIClientAPI.basePath + localVariablePath
        let localVariableParameters: [String: Any]? = nil
