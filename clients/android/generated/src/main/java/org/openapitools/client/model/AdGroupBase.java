...
public class AdGroupBase {
  ...
  public boolean equals(Object o) {
    ...
    return (this.adAccountId == null ? adGroupBase.adAccountId == null : this.adAccountId.equals(adGroupBase.adAccountId)) &&
        (this.bidInMicroCurrency == null ? adGroupBase.bidInMicroCurrency == null : this.bidInMicroCurrency.equals(adGroupBase.bidInMicroCurrency)) &&
        (this.bidStrategyType == null ? adGroupBase.bidStrategyType == null : this.bidStrategyType.equals(adGroupBase.bidStrategyType)) &&
        (this.billableEvent == null ? adGroupBase.billableEvent == null : this.billableEvent.equals(adGroupBase.billableEvent)) &&
        (this.budgetInMicroCurrency == null ? adGroupBase.budgetInMicroCurrency == null : this.budgetInMicroCurrency.equals(adGroupBase.budgetInMicroCurrency)) &&
        (this.campaignId == null ? adGroupBase.campaignId == null : this.campaignId.equals(adGroupBase.campaignId)) &&
        (this.conversionLearningModeType == null ? adGroupBase.conversionLearningModeType == null : this.conversionLearningModeType.equals(adGroupBase.conversionLearningModeType)) &&
        (this.createdTime == null ? adGroupBase.createdTime == null : this.createdTime.equals(adGroupBase.createdTime)) &&
        (this.customerSegmentId == null ? adGroupBase.customerSegmentId == null : this.customerSegmentId.equals(adGroupBase.customerSegmentId)) &&
        (this.dcaAssets == null ? adGroupBase.dcaAssets == null : this.dcaAssets.equals(adGroupBase.dcaAssets)) &&
        (this.endTime == null ? adGroupBase.endTime == null : this.endTime.equals(adGroupBase.endTime)) &&
        (this.extFeatures == null ? adGroupBase.extFeatures == null : this.extFeatures.equals(adGroupBase.extFeatures)) &&
        (this.feedProfileId == null ? adGroupBase.feedProfileId == null : this.feedProfileId.equals(adGroupBase.feedProfileId)) &&
        (this.id == null ? adGroupBase.id == null : this.id.equals(adGroupBase.id)) &&
        (this.isCreativeOptimization == null ? adGroupBase.isCreativeOptimization == null : this.isCreativeOptimization.equals(adGroupBase.isCreativeOptimization)) &&
        (this.isLocalInventory == null ? adGroupBase.isLocalInventory == null : this.isLocalInventory.equals(adGroupBase.isLocalInventory)) &&
        (this.lifetimeFrequencyCap == null ? adGroupBase.lifetimeFrequencyCap == null : this.lifetimeFrequencyCap.equals(adGroupBase.lifetimeFrequencyCap)) &&
        (this.localInventoryRadiusInMiles == null ? adGroupBase.localInventoryRadiusInMiles == null : this.localInventoryRadiusInMiles.equals(adGroupBase.localInventoryRadiusInMiles)) &&
        (this.name == null ? adGroupBase.name == null : this.name.equals(adGroupBase.name)) &&
        (this.optimizationGoalMetadata == null ? adGroupBase.optimizationGoalMetadata == null : this.optimizationGoalMetadata.equals(adGroupBase.optimizationGoalMetadata)) &&
        (this.performancePlusCampaignSettings == null ? adGroupBase.performancePlusCampaignSettings == null : this.performancePlusCampaignSettings.equals(adGroupBase.performancePlusCampaignSettings)) &&
        (this.placementGroup == null ? adGroupBase.placementGroup == null : this.placementGroup.equals(adGroupBase.placementGroup)) &&
        (this.placementTrafficType == null ? adGroupBase.placementTrafficType == null : this.placementTrafficType.equals(adGroupBase.placementTrafficType)) &&
        (this.promotionApplicationLevel == null ? adGroupBase.promotionApplicationLevel == null : this.promotionApplicationLevel.equals(adGroupBase.promotionApplicationLevel)) &&
        (this.promotionId == null ? adGroupBase.promotionId == null : this.promotionId.equals(adGroupBase.promotionId)) &&
        (this.promotionIds == null ? adGroupBase.promotionIds == null : this.promotionIds.equals(adGroupBase.promotionIds)) &&
        (this.startTime == null ? adGroupBase.startTime == null : this.startTime.equals(adGroupBase.startTime)) &&
        (this.status == null ? adGroupBase.status == null : this.status.equals(adGroupBase.status)) &&
        (this.summaryStatus == null ? adGroupBase.summaryStatus == null : this.summaryStatus.equals(adGroupBase.summaryStatus)) &&
        (this.targetingSpec == null ? adGroupBase.targetingSpec == null : this.targetingSpec.equals(adGroupBase.targetingSpec)) &&
        (this.targetingTemplateIds == null ? adGroupBase.targetingTemplateIds == null : this.targetingTemplateIds.equals(adGroupBase.targetingTemplateIds)) &&
        (this.trackingUrls == null ? adGroupBase.trackingUrls == null : this.trackingUrls.equals(adGroupBase.trackingUrls)) &&
        (this.type == null ? adGroupBase.type == null : this.type.equals(adGroupBase.type)) &&
        (this.updatedTime == null ? adGroupBase.updatedTime == null : this.updatedTime.equals(adGroupBase.updatedTime));
  }
