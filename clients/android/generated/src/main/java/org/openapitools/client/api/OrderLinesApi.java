...
public class OrderLinesApi {
  ...
  * Get a specific existing order line associated with an ad account.
   ...
   * @return OrderLine
  */
  public OrderLine orderLinesGet (String orderLineId, String adAccountId) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    ...
    String path = "/ad_accounts/{ad_account_id}/order_lines/{order_line_id}".replaceAll("\\{" + "order_line_id" + "\\}", apiInvoker.escapeString(orderLineId.toString())).replaceAll("\\{" + "ad_account_id" + "\\}", apiInvoker.escapeString(adAccountId.toString()));
   ...
   * Get order line
   * Get a specific existing order line associated with an ad account.
   * @param orderLineId Order line ID.   * @param adAccountId Unique identifier of an ad account.
  */
  public void orderLinesGet (String orderLineId, String adAccountId, final Response.Listener<OrderLine> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    // create path and map variables
    String path = "/ad_accounts/{ad_account_id}/order_lines/{order_line_id}".replaceAll("\\{format\\}","json").replaceAll("\\{" + "order_line_id" + "\\}", apiInvoker.escapeString(orderLineId.toString())).replaceAll("\\{" + "ad_account_id" + "\\}", apiInvoker.escapeString(adAccountId.toString()));
  ...
  */
  public OrderLinesList200Response orderLinesList (String adAccountId, String bookmark, Integer pageSize, PinterestLibPaginationOrder order) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'adAccountId' is set
    if (adAccountId == null) {
  ...
  */
  public void orderLinesList (String adAccountId, String bookmark, Integer pageSize, PinterestLibPaginationOrder order, final Response.Listener<OrderLinesList200Response> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
