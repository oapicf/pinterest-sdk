...
public class Campaign {
  ...
  public boolean equals(Object o) {
    ...
    return (this.adAccountId == null ? campaign.adAccountId == null : this.adAccountId.equals(campaign.adAccountId)) &&
        (this.bidOptions == null ? campaign.bidOptions == null : this.bidOptions.equals(campaign.bidOptions)) &&
        (this.createdTime == null ? campaign.createdTime == null : this.createdTime.equals(campaign.createdTime)) &&
        (this.dailySpendCap == null ? campaign.dailySpendCap == null : this.dailySpendCap.equals(campaign.dailySpendCap)) &&
        (this.defaultAdGroupBudgetInMicroCurrency == null ? campaign.defaultAdGroupBudgetInMicroCurrency == null : this.defaultAdGroupBudgetInMicroCurrency.equals(campaign.defaultAdGroupBudgetInMicroCurrency)) &&
        (this.endTime == null ? campaign.endTime == null : this.endTime.equals(campaign.endTime)) &&
        (this.id == null ? campaign.id == null : this.id.equals(campaign.id)) &&
        (this.intendedPromotionType == null ? campaign.intendedPromotionType == null : this.intendedPromotionType.equals(campaign.intendedPromotionType)) &&
        (this.isAutomatedCampaign == null ? campaign.isAutomatedCampaign == null : this.isAutomatedCampaign.equals(campaign.isAutomatedCampaign)) &&
        (this.isCampaignBudgetOptimization == null ? campaign.isCampaignBudgetOptimization == null : this.isCampaignBudgetOptimization.equals(campaign.isCampaignBudgetOptimization)) &&
        (this.isCarting == null ? campaign.isCarting == null : this.isCarting.equals(campaign.isCarting)) &&
        (this.isFlexibleDailyBudgets == null ? campaign.isFlexibleDailyBudgets == null : this.isFlexibleDailyBudgets.equals(campaign.isFlexibleDailyBudgets)) &&
        (this.isLtvOptimized == null ? campaign.isLtvOptimized == null : this.isLtvOptimized.equals(campaign.isLtvOptimized)) &&
        (this.isPerformancePlus == null ? campaign.isPerformancePlus == null : this.isPerformancePlus.equals(campaign.isPerformancePlus)) &&
        (this.isTopOfSearch == null ? campaign.isTopOfSearch == null : this.isTopOfSearch.equals(campaign.isTopOfSearch)) &&
        (this.lifetimeSpendCap == null ? campaign.lifetimeSpendCap == null : this.lifetimeSpendCap.equals(campaign.lifetimeSpendCap)) &&
        (this.name == null ? campaign.name == null : this.name.equals(campaign.name)) &&
        (this.objectiveType == null ? campaign.objectiveType == null : this.objectiveType.equals(campaign.objectiveType)) &&
        (this.orderLineId == null ? campaign.orderLineId == null : this.orderLineId.equals(campaign.orderLineId)) &&
        (this.performancePlusCampaignSettings == null ? campaign.performancePlusCampaignSettings == null : this.performancePlusCampaignSettings.equals(campaign.performancePlusCampaignSettings)) &&
        (this.startTime == null ? campaign.startTime == null : this.startTime.equals(campaign.startTime)) &&
        (this.status == null ? campaign.status == null : this.status.equals(campaign.status)) &&
        (this.summaryStatus == null ? campaign.summaryStatus == null : this.summaryStatus.equals(campaign.summaryStatus)) &&
        (this.trackingUrls == null ? campaign.trackingUrls == null : this.trackingUrls.equals(campaign.trackingUrls)) &&
        (this.type == null ? campaign.type == null : this.type.equals(campaign.type)) &&
        (this.updatedTime == null ? campaign.updatedTime == null : this.updatedTime.equals(campaign.updatedTime));
  }
