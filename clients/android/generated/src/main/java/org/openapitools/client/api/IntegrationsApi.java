  ...
  */
  public IntegrationMetadata integrationsCommercePatch (String externalBusinessId, IntegrationRequestPatch integrationRequestPatch) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    ...
    if (integrationRequestPatch == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'integrationRequestPatch' when calling integrationsCommercePatch",
        new ApiException(400, "Missing the required parameter 'integrationRequestPatch' when calling integrationsCommercePatch"));
    }
  ...
  */
  public IntegrationMetadata integrationsCommercePost (IntegrationRequest integrationRequest) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    ...
    if (integrationRequest == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'integrationRequest' when calling integrationsCommercePost",
        new ApiException(400, "Missing the required parameter 'integrationRequest' when calling integrationsCommercePost"));
    }
