...
public class BoardSectionUpdateWithRequiredBody {
  ...
  public boolean equals(Object o) {
    ...
    return (this.id == null ? boardSectionUpdateWithRequiredBody.id == null : this.id.equals(boardSectionUpdateWithRequiredBody.id)) &&
        (this.name == null ? boardSectionUpdateWithRequiredBody.name == null : this.name.equals(boardSectionUpdateWithRequiredBody.name));
  }
