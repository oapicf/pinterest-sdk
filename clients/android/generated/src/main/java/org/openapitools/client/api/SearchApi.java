...
import org.openapitools.client.model.SearchUserPinsList200Response;
...
public class SearchApi {
  ...
  */
  public SearchUserPinsList200Response searchUserPinsList (String query, String adAccountId, String bookmark) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    ...
    try {
      String localVarResponse = apiInvoker.invokeAPI (basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames);
      if (localVarResponse != null) {
         return (SearchUserPinsList200Response) ApiInvoker.deserialize(localVarResponse, "", SearchUserPinsList200Response.class);
      } else {
         return null;
      }
    } catch (ApiException ex) {
  ...
  */
  public void searchUserPinsList (String query, String adAccountId, String bookmark, final Response.Listener<SearchUserPinsList200Response> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((SearchUserPinsList200Response) ApiInvoker.deserialize(localVarResponse,  "", SearchUserPinsList200Response.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
