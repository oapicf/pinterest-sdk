...
public class IntegrationLogsInvalidLogResponseRejectedLogsItems {
  ...
  public boolean equals(Object o) {
    ...
    return (this.field == null ? integrationLogsInvalidLogResponseRejectedLogsItems.field == null : this.field.equals(integrationLogsInvalidLogResponseRejectedLogsItems.field)) &&
        (this.logIndex == null ? integrationLogsInvalidLogResponseRejectedLogsItems.logIndex == null : this.logIndex.equals(integrationLogsInvalidLogResponseRejectedLogsItems.logIndex)) &&
        (this.reason == null ? integrationLogsInvalidLogResponseRejectedLogsItems.reason == null : this.reason.equals(integrationLogsInvalidLogResponseRejectedLogsItems.reason)) &&
        (this.value == null ? integrationLogsInvalidLogResponseRejectedLogsItems.value == null : this.value.equals(integrationLogsInvalidLogResponseRejectedLogsItems.value));
  }
