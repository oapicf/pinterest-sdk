...
public class AudienceInsightsApi {
  ...
  */
  public AudienceInsights audienceInsightsGet (String adAccountId, AudienceInsightType audienceInsightType) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    ...
    try {
      ...
      if (localVarResponse != null) {
         return (AudienceInsights) ApiInvoker.deserialize(localVarResponse, "", AudienceInsights.class);
      } else {
         return null;
      }
  ...
  */
  public void audienceInsightsGet (String adAccountId, AudienceInsightType audienceInsightType, final Response.Listener<AudienceInsights> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
      ...
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((AudienceInsights) ApiInvoker.deserialize(localVarResponse,  "", AudienceInsights.class));
  ...
  */
  public AudienceInsightsScopeAndTypeGet200Response audienceInsightsScopeAndTypeGet (String adAccountId) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'adAccountId' is set
    if (adAccountId == null) {
    ...
    try {
      String localVarResponse = apiInvoker.invokeAPI (basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames);
      if (localVarResponse != null) {
         return (AudienceInsightsScopeAndTypeGet200Response) ApiInvoker.deserialize(localVarResponse, "", AudienceInsightsScopeAndTypeGet200Response.class);
      } else {
         return null;
      }
    } catch (ApiException ex) {
   ...
   * @param adAccountId Unique identifier of an ad account.
  */
  public void audienceInsightsScopeAndTypeGet (String adAccountId, final Response.Listener<AudienceInsightsScopeAndTypeGet200Response> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((AudienceInsightsScopeAndTypeGet200Response) ApiInvoker.deserialize(localVarResponse,  "", AudienceInsightsScopeAndTypeGet200Response.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
