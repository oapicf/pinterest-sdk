...
import org.openapitools.client.model.LeadFormArrayResponse;
import org.openapitools.client.model.LeadFormCreateRequest;
...
import org.openapitools.client.model.LeadFormUpdateRequest;
...
public class LeadFormsApi {
  ...
  */
  public LeadFormArrayResponse leadFormsCreate (String adAccountId, List<LeadFormCreateRequest> leadFormCreateRequest) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    ...
    if (leadFormCreateRequest == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'leadFormCreateRequest' when calling leadFormsCreate",
        new ApiException(400, "Missing the required parameter 'leadFormCreateRequest' when calling leadFormsCreate"));
    }
    ...
    try {
      String localVarResponse = apiInvoker.invokeAPI (basePath, path, "POST", queryParams, postBody, headerParams, formParams, contentType, authNames);
      if (localVarResponse != null) {
         return (LeadFormArrayResponse) ApiInvoker.deserialize(localVarResponse, "", LeadFormArrayResponse.class);
      } else {
         return null;
      }
    } catch (ApiException ex) {
   ...
   * Create lead forms
   * &lt;strong&gt;This feature is currently in beta and not available to all apps, if you&#39;re interested in joining the beta, please reach out to your Pinterest account manager.&lt;/strong&gt;  Create lead forms. Lead forms are used in lead ads and allow you to control what text appears on the lead form’ s description, questions and confirmation sections.  For more, see &lt;a class&#x3D;\&quot;reference external\&quot; href&#x3D;\&quot;https://help.pinterest.com/en/business/article/lead-ads\&quot;&gt;Lead ads&lt;/a&gt;.
   * @param adAccountId Unique identifier of an ad account.   * @param leadFormCreateRequest List of lead forms to create, size limit [1, 30].
  */
  public void leadFormsCreate (String adAccountId, List<LeadFormCreateRequest> leadFormCreateRequest, final Response.Listener<LeadFormArrayResponse> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = leadFormCreateRequest;
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "POST", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((LeadFormArrayResponse) ApiInvoker.deserialize(localVarResponse,  "", LeadFormArrayResponse.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
  ...
  * &lt;strong&gt;This feature is currently in beta and not available to all apps, if you&#39;re interested in joining the beta, please reach out to your Pinterest account manager.&lt;/strong&gt;  Update lead forms. Lead ads help you reach people who are actively looking for, and interested in, your goods and services. The lead form can be associated with an ad to allow people to fill out the form.  For more, see &lt;a class&#x3D;\&quot;reference external\&quot; href&#x3D;\&quot;https://help.pinterest.com/en/business/article/lead-ads\&quot;&gt;Lead ads&lt;/a&gt;.
   ...
   * @return LeadFormArrayResponse
  */
  public LeadFormArrayResponse leadFormsUpdate (String adAccountId, List<LeadFormUpdateRequest> leadFormUpdateRequest) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    ...
    if (leadFormUpdateRequest == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'leadFormUpdateRequest' when calling leadFormsUpdate",
        new ApiException(400, "Missing the required parameter 'leadFormUpdateRequest' when calling leadFormsUpdate"));
    }
   ...
   * Update lead forms
   * &lt;strong&gt;This feature is currently in beta and not available to all apps, if you&#39;re interested in joining the beta, please reach out to your Pinterest account manager.&lt;/strong&gt;  Update lead forms. Lead ads help you reach people who are actively looking for, and interested in, your goods and services. The lead form can be associated with an ad to allow people to fill out the form.  For more, see &lt;a class&#x3D;\&quot;reference external\&quot; href&#x3D;\&quot;https://help.pinterest.com/en/business/article/lead-ads\&quot;&gt;Lead ads&lt;/a&gt;.
   * @param adAccountId Unique identifier of an ad account.   * @param leadFormUpdateRequest List of lead forms to update, size limit [1, 30].
  */
  public void leadFormsUpdate (String adAccountId, List<LeadFormUpdateRequest> leadFormUpdateRequest, final Response.Listener<LeadFormArrayResponse> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = leadFormUpdateRequest;
