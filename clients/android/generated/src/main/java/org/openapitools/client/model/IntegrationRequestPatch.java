...
public class IntegrationRequestPatch {
  ...
  public boolean equals(Object o) {
    ...
    return (this.connectedMerchantId == null ? integrationRequestPatch.connectedMerchantId == null : this.connectedMerchantId.equals(integrationRequestPatch.connectedMerchantId)) &&
        (this.connectedAdvertiserId == null ? integrationRequestPatch.connectedAdvertiserId == null : this.connectedAdvertiserId.equals(integrationRequestPatch.connectedAdvertiserId)) &&
        (this.connectedLbaId == null ? integrationRequestPatch.connectedLbaId == null : this.connectedLbaId.equals(integrationRequestPatch.connectedLbaId)) &&
        (this.connectedTagId == null ? integrationRequestPatch.connectedTagId == null : this.connectedTagId.equals(integrationRequestPatch.connectedTagId)) &&
        (this.partnerAccessToken == null ? integrationRequestPatch.partnerAccessToken == null : this.partnerAccessToken.equals(integrationRequestPatch.partnerAccessToken)) &&
        (this.partnerRefreshToken == null ? integrationRequestPatch.partnerRefreshToken == null : this.partnerRefreshToken.equals(integrationRequestPatch.partnerRefreshToken)) &&
        (this.partnerPrimaryEmail == null ? integrationRequestPatch.partnerPrimaryEmail == null : this.partnerPrimaryEmail.equals(integrationRequestPatch.partnerPrimaryEmail)) &&
        (this.partnerAccessTokenExpiry == null ? integrationRequestPatch.partnerAccessTokenExpiry == null : this.partnerAccessTokenExpiry.equals(integrationRequestPatch.partnerAccessTokenExpiry)) &&
        (this.partnerRefreshTokenExpiry == null ? integrationRequestPatch.partnerRefreshTokenExpiry == null : this.partnerRefreshTokenExpiry.equals(integrationRequestPatch.partnerRefreshTokenExpiry)) &&
        (this.scopes == null ? integrationRequestPatch.scopes == null : this.scopes.equals(integrationRequestPatch.scopes)) &&
        (this.additionalId1 == null ? integrationRequestPatch.additionalId1 == null : this.additionalId1.equals(integrationRequestPatch.additionalId1)) &&
        (this.partnerMetadata == null ? integrationRequestPatch.partnerMetadata == null : this.partnerMetadata.equals(integrationRequestPatch.partnerMetadata));
  }
