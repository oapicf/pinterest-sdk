...
public class CatalogsHotelAttributes {
  ...
  private CatalogsHotelMainImage mainImage = null;
   ...
   **/
  @ApiModelProperty(value = "<= 2000 characters. The links to additional images for your hotel. Up to ten additional images can be used to show a hotel from different angles. Must begin with http:// or https://.")
   ...
   **/
  @ApiModelProperty(value = "AI content disclosures for individual assets (main_image.link or additional_image_link) on this hotel item. Each entry declares which disclosure types apply to a single asset URL.")
  ...
  public boolean equals(Object o) {
    ...
    return (this.address == null ? catalogsHotelAttributes.address == null : this.address.equals(catalogsHotelAttributes.address)) &&
        ...
        (this.name == null ? catalogsHotelAttributes.name == null : this.name.equals(catalogsHotelAttributes.name)) &&
        ...
        (this.aiDisclosures == null ? catalogsHotelAttributes.aiDisclosures == null : this.aiDisclosures.equals(catalogsHotelAttributes.aiDisclosures)) &&
