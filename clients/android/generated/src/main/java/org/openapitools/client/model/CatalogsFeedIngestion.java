...
public class CatalogsFeedIngestion {
   ...
   **/
  @ApiModelProperty(required = true, value = "Timestamp of the feed ingestion.")
   ...
   **/
  @ApiModelProperty(required = true, value = "Catalog Feed id pertaining to the feed ingestion.")
   ...
   **/
  @ApiModelProperty(required = true, value = "Unique identifier of a feed ingestion.")
  public String getId() {
    return id;
  }
  ...
  public boolean equals(Object o) {
    ...
    return (this.createdAt == null ? catalogsFeedIngestion.createdAt == null : this.createdAt.equals(catalogsFeedIngestion.createdAt)) &&
        (this.feedId == null ? catalogsFeedIngestion.feedId == null : this.feedId.equals(catalogsFeedIngestion.feedId)) &&
        (this.id == null ? catalogsFeedIngestion.id == null : this.id.equals(catalogsFeedIngestion.id)) &&
