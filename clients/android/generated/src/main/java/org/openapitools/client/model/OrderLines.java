...
public class OrderLines {
  ...
  public boolean equals(Object o) {
    ...
    return (this.id == null ? orderLines.id == null : this.id.equals(orderLines.id)) &&
        (this.type == null ? orderLines.type == null : this.type.equals(orderLines.type)) &&
        (this.adAccountId == null ? orderLines.adAccountId == null : this.adAccountId.equals(orderLines.adAccountId)) &&
        (this.purchaseOrderId == null ? orderLines.purchaseOrderId == null : this.purchaseOrderId.equals(orderLines.purchaseOrderId)) &&
        (this.startTime == null ? orderLines.startTime == null : this.startTime.equals(orderLines.startTime)) &&
        (this.endTime == null ? orderLines.endTime == null : this.endTime.equals(orderLines.endTime)) &&
        (this.budget == null ? orderLines.budget == null : this.budget.equals(orderLines.budget)) &&
        (this.paidBudget == null ? orderLines.paidBudget == null : this.paidBudget.equals(orderLines.paidBudget)) &&
        (this.status == null ? orderLines.status == null : this.status.equals(orderLines.status)) &&
        (this.name == null ? orderLines.name == null : this.name.equals(orderLines.name)) &&
        (this.paidType == null ? orderLines.paidType == null : this.paidType.equals(orderLines.paidType));
  }
