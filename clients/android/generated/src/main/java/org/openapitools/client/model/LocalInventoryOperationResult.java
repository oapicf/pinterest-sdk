...
public class LocalInventoryOperationResult {
  ...
  public boolean equals(Object o) {
    ...
    return (this.errors == null ? localInventoryOperationResult.errors == null : this.errors.equals(localInventoryOperationResult.errors)) &&
        (this.itemId == null ? localInventoryOperationResult.itemId == null : this.itemId.equals(localInventoryOperationResult.itemId)) &&
        (this.status == null ? localInventoryOperationResult.status == null : this.status.equals(localInventoryOperationResult.status)) &&
        (this.storeCode == null ? localInventoryOperationResult.storeCode == null : this.storeCode.equals(localInventoryOperationResult.storeCode)) &&
        (this.supplementalType == null ? localInventoryOperationResult.supplementalType == null : this.supplementalType.equals(localInventoryOperationResult.supplementalType)) &&
        (this.warnings == null ? localInventoryOperationResult.warnings == null : this.warnings.equals(localInventoryOperationResult.warnings));
  }
