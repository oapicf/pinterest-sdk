...
public class ConversionTag {
  ...
  public boolean equals(Object o) {
    ...
    return (this.codeSnippet == null ? conversionTag.codeSnippet == null : this.codeSnippet.equals(conversionTag.codeSnippet)) &&
        (this.configs == null ? conversionTag.configs == null : this.configs.equals(conversionTag.configs)) &&
        (this.enhancedMatchStatus == null ? conversionTag.enhancedMatchStatus == null : this.enhancedMatchStatus.equals(conversionTag.enhancedMatchStatus)) &&
        (this.id == null ? conversionTag.id == null : this.id.equals(conversionTag.id)) &&
        (this.lastFiredTimeMs == null ? conversionTag.lastFiredTimeMs == null : this.lastFiredTimeMs.equals(conversionTag.lastFiredTimeMs)) &&
        (this.name == null ? conversionTag.name == null : this.name.equals(conversionTag.name)) &&
        (this.version == null ? conversionTag.version == null : this.version.equals(conversionTag.version)) &&
        (this.adAccountId == null ? conversionTag.adAccountId == null : this.adAccountId.equals(conversionTag.adAccountId)) &&
        (this.status == null ? conversionTag.status == null : this.status.equals(conversionTag.status));
  }
