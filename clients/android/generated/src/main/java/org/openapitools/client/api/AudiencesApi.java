  ...
  */
  public Audience audiencesUpdate (String adAccountId, String audienceId, AudienceUpdateRequest audienceUpdateRequest) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    ...
    if (audienceUpdateRequest == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'audienceUpdateRequest' when calling audiencesUpdate",
        new ApiException(400, "Missing the required parameter 'audienceUpdateRequest' when calling audiencesUpdate"));
    }
