...
public class BusinessAccessAssetsApi {
  ...
  */
  public AssetGroupInput assetGroupCreate (String businessId, AssetGroupInputCreate assetGroupInputCreate) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    ...
    if (assetGroupInputCreate == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'assetGroupInputCreate' when calling assetGroupCreate",
        new ApiException(400, "Missing the required parameter 'assetGroupInputCreate' when calling assetGroupCreate"));
    }
    ...
    try {
      ...
      if (localVarResponse != null) {
         return (AssetGroupInput) ApiInvoker.deserialize(localVarResponse, "", AssetGroupInput.class);
      } else {
         return null;
      }
   ...
   * Create a new asset group.
   * Create a new asset group with the specified parameters. - An [asset group](https://help.pinterest.com/en/business/article/asset-groups) is a custom group of assets based on how you would like to manage your accounts.
   * @param businessId Unique identifier of the requesting business.   * @param assetGroupInputCreate 
  */
  public void assetGroupCreate (String businessId, AssetGroupInputCreate assetGroupInputCreate, final Response.Listener<AssetGroupInput> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = assetGroupInputCreate;
      ...
      apiInvoker.invokeAPI(basePath, path, "POST", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((AssetGroupInput) ApiInvoker.deserialize(localVarResponse,  "", AssetGroupInput.class));
  ...
  */
  public AssetGroupDeletion assetGroupDelete (String businessId, AssetGroupDeletionDelete assetGroupDeletionDelete) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    ...
    if (assetGroupDeletionDelete == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'assetGroupDeletionDelete' when calling assetGroupDelete",
        new ApiException(400, "Missing the required parameter 'assetGroupDeletionDelete' when calling assetGroupDelete"));
    }
    ...
    try {
      ...
      if (localVarResponse != null) {
         return (AssetGroupDeletion) ApiInvoker.deserialize(localVarResponse, "", AssetGroupDeletion.class);
      } else {
         return null;
      }
    } catch (ApiException ex) {
   ...
   * Delete asset groups.
   * Delete a batch of asset groups.
   * @param businessId Unique identifier of the requesting business.   * @param assetGroupDeletionDelete 
  */
  public void assetGroupDelete (String businessId, AssetGroupDeletionDelete assetGroupDeletionDelete, final Response.Listener<AssetGroupDeletion> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = assetGroupDeletionDelete;
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "DELETE", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((AssetGroupDeletion) ApiInvoker.deserialize(localVarResponse,  "", AssetGroupDeletion.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
  ...
  */
  public AssetGroupModification assetGroupUpdate (String businessId, AssetGroupModificationReadOrUpdate assetGroupModificationReadOrUpdate) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    ...
    if (assetGroupModificationReadOrUpdate == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'assetGroupModificationReadOrUpdate' when calling assetGroupUpdate",
        new ApiException(400, "Missing the required parameter 'assetGroupModificationReadOrUpdate' when calling assetGroupUpdate"));
    }
    ...
    try {
      ...
      if (localVarResponse != null) {
         return (AssetGroupModification) ApiInvoker.deserialize(localVarResponse, "", AssetGroupModification.class);
      } else {
         return null;
      }
    } catch (ApiException ex) {
   ...
   * Update asset groups.
   * Update a batch of asset groups with the specified parameters.
   * @param businessId Unique identifier of the requesting business.   * @param assetGroupModificationReadOrUpdate 
  */
  public void assetGroupUpdate (String businessId, AssetGroupModificationReadOrUpdate assetGroupModificationReadOrUpdate, final Response.Listener<AssetGroupModification> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = assetGroupModificationReadOrUpdate;
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "PATCH", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((AssetGroupModification) ApiInvoker.deserialize(localVarResponse,  "", AssetGroupModification.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
  ...
  */
  public BusinessAssetMembersGet200Response businessAssetMembersGet (String businessId, String assetId, Integer startIndex, Boolean fetchSystemUsers, String bookmark, Integer pageSize) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
  ...
  * Get all the partners the requesting business has granted access to on the given asset. Note: If the asset has been shared with you, an empty array will be returned. This is because an asset shared with you cannot be shared with a different partner.
   ...
   * @return BusinessAssetMembersGet200Response
  */
  public BusinessAssetMembersGet200Response businessAssetPartnersGet (String businessId, String assetId, Integer startIndex, String bookmark, Integer pageSize) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'businessId' is set
    if (businessId == null) {
  ...
  */
  public void businessAssetPartnersGet (String businessId, String assetId, Integer startIndex, String bookmark, Integer pageSize, final Response.Listener<BusinessAssetMembersGet200Response> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
  ...
  */
  public BusinessMemberAssetsGetResponse businessMemberAssetsGet (String businessId, String memberId, String assetType, Integer startIndex, AssetSortBy sortBy, Boolean sortAscending, AssetSearchBy searchBy, String searchValue, AssetPermissionType assetPermissionType, List<NonDraftEntityStatus> adAccountStatuses, String bookmark, Integer pageSize) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'businessId' is set
    if (businessId == null) {
    ...
    queryParams.addAll(ApiInvoker.parameterToPairs("", "search_by", searchBy));
    queryParams.addAll(ApiInvoker.parameterToPairs("", "search_value", searchValue));
    queryParams.addAll(ApiInvoker.parameterToPairs("", "asset_permission_type", assetPermissionType));
    queryParams.addAll(ApiInvoker.parameterToPairs("multi", "ad_account_statuses", adAccountStatuses));
    queryParams.addAll(ApiInvoker.parameterToPairs("", "bookmark", bookmark));
    queryParams.addAll(ApiInvoker.parameterToPairs("", "page_size", pageSize));
    String[] contentTypes = {
    };
    ...
    try {
      String localVarResponse = apiInvoker.invokeAPI (basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames);
      if (localVarResponse != null) {
         return (BusinessMemberAssetsGetResponse) ApiInvoker.deserialize(localVarResponse, "", BusinessMemberAssetsGetResponse.class);
      } else {
         return null;
      }
    } catch (ApiException ex) {
   ...
   * Get assets assigned to a member
   * Get assets on which you assigned asset permissions to the given member. Can be used to: - get all assets, regardless of asset type or - get assets of one asset type by using the asset_type query. The return response will include the permissions the member has to that asset and the asset type.
   * @param businessId Unique identifier of the requesting business.   * @param memberId The member id to fetch assets for.   * @param assetType A resource type to filter the assets by. Only assets of the specified type will be returned.   * @param startIndex An index to start fetching the results from. Only the results starting from this index will be returned.   * @param sortBy The field to sort member assets by   * @param sortAscending Sort assets in ascending order   * @param searchBy The field to search member assets by   * @param searchValue The value to search for   * @param assetPermissionType The type of asset permission to filter by   * @param adAccountStatuses A list of ad account statuses to filter the assets by. Only used when asset_type is AD_ACCOUNT.   * @param bookmark Cursor used to fetch the next page of items   * @param pageSize Maximum number of items to include in a single page. See documentation on [Pagination](/docs/reference/pagination/) for more information.
  */
  public void businessMemberAssetsGet (String businessId, String memberId, String assetType, Integer startIndex, AssetSortBy sortBy, Boolean sortAscending, AssetSearchBy searchBy, String searchValue, AssetPermissionType assetPermissionType, List<NonDraftEntityStatus> adAccountStatuses, String bookmark, Integer pageSize, final Response.Listener<BusinessMemberAssetsGetResponse> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((BusinessMemberAssetsGetResponse) ApiInvoker.deserialize(localVarResponse,  "", BusinessMemberAssetsGetResponse.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
  ...
  */
  public DeleteMemberAccessResultsResponseArray businessMembersAssetAccessDelete (String businessId, BusinessMembersAssetAccessDeleteBody businessMembersAssetAccessDeleteBody) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    ...
    if (businessMembersAssetAccessDeleteBody == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'businessMembersAssetAccessDeleteBody' when calling businessMembersAssetAccessDelete",
        new ApiException(400, "Missing the required parameter 'businessMembersAssetAccessDeleteBody' when calling businessMembersAssetAccessDelete"));
    }
   ...
   * Delete member access to asset
   * Terminate multiple members&#39; access to an asset.
   * @param businessId Unique identifier of the requesting business.   * @param businessMembersAssetAccessDeleteBody 
  */
  public void businessMembersAssetAccessDelete (String businessId, BusinessMembersAssetAccessDeleteBody businessMembersAssetAccessDeleteBody, final Response.Listener<DeleteMemberAccessResultsResponseArray> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = businessMembersAssetAccessDeleteBody;
  ...
  */
   ...
   * Assign/Update member asset permissions
   * Grant multiple members access to assets and/or update multiple member&#39;s exisiting permissions to an asset. Note: Not all listed permissions are applicable to each asset type. For example, PROFILE_PUBLISHER would not be applicable to an asset of type AD_ACCOUNT. The permission level PROFILE_PUBLISHER is only available to an asset of the type PROFILE.
   * @param businessId Unique identifier of the requesting business.   * @param updateMemberAssetAccessBody 
  */
  ...
  */
  public DeletePartnerAssetAccessResultsResponseArray deletePartnerAssetAccessHandlerImpl (String businessId, DeletePartnerAssetAccessBody deletePartnerAssetAccessBody) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    ...
    try {
      String localVarResponse = apiInvoker.invokeAPI (basePath, path, "DELETE", queryParams, postBody, headerParams, formParams, contentType, authNames);
      if (localVarResponse != null) {
         return (DeletePartnerAssetAccessResultsResponseArray) ApiInvoker.deserialize(localVarResponse, "", DeletePartnerAssetAccessResultsResponseArray.class);
      } else {
         return null;
      }
    } catch (ApiException ex) {
  ...
  */
  public void deletePartnerAssetAccessHandlerImpl (String businessId, DeletePartnerAssetAccessBody deletePartnerAssetAccessBody, final Response.Listener<DeletePartnerAssetAccessResultsResponseArray> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = deletePartnerAssetAccessBody;
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "DELETE", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((DeletePartnerAssetAccessResultsResponseArray) ApiInvoker.deserialize(localVarResponse,  "", DeletePartnerAssetAccessResultsResponseArray.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
  ...
  */
   ...
   * Assign/Update partner asset permissions
   * Grant multiple partners access to assets and/or update multiple partner&#39;s exisiting permissions to an asset. If your partner already had permissions on the asset, they will be overriden with the new permissions you assign to them. To learn more about permission levels, visit https://help.pinterest.com/en/business/article/business-manager-overview  Note: Not all listed permissions are applicable to each asset type. For example, PROFILE_PUBLISHER would not be applicable to an asset of type AD_ACCOUNT. The permission level PROFILE_PUBLISHER is only available to an asset of the type PROFILE.
   * @param businessId Unique identifier of the requesting business.   * @param updatePartnerAssetAccessBody 
  */
