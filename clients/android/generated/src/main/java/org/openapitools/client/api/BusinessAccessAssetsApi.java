...
public class BusinessAccessAssetsApi {
  ...
  */
  public BusinessAssetMembersGet200Response businessAssetMembersGet (String businessId, String assetId, Boolean fetchSystemUsers, String bookmark, Integer pageSize, Integer startIndex) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
   ...
   * Get members with access to asset
   * Get all the members the requesting business has granted access to on the given asset.
   * @param businessId Unique identifier of the requesting business.   * @param assetId Unique identifier of a business asset.   * @param fetchSystemUsers Fetches system users if True. Fetches regular user employees if False.   * @param bookmark Cursor used to fetch the next page of items   * @param pageSize Maximum number of items to include in a single page of the response. See documentation on &lt;a href&#x3D;&#39;/docs/reference/pagination/&#39;&gt;Pagination&lt;/a&gt; for more information.   * @param startIndex An index to start fetching the results from. Only the results starting from this index will be returned.
  */
  public void businessAssetMembersGet (String businessId, String assetId, Boolean fetchSystemUsers, String bookmark, Integer pageSize, Integer startIndex, final Response.Listener<BusinessAssetMembersGet200Response> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
