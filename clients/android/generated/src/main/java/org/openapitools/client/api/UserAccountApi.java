...
public class UserAccountApi {
  ...
  */
  public BoardsList200Response boardsUserFollowsList (String adAccountId, Boolean explicitFollowing, String bookmark, Integer pageSize) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
   ...
   * List following boards
   * Get a list of the boards a user follows. The request returns a board summary object array.
   * @param adAccountId Unique identifier of an ad account.   * @param explicitFollowing Whether or not to include implicit user follows, which means followees with board follows. When explicit_following is True, it means we only want explicit user follows.   * @param bookmark Cursor used to fetch the next page of items   * @param pageSize Maximum number of items to include in a single page. See documentation on [Pagination](/docs/reference/pagination/) for more information.
  */
  public void boardsUserFollowsList (String adAccountId, Boolean explicitFollowing, String bookmark, Integer pageSize, final Response.Listener<BoardsList200Response> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
  ...
  * **This endpoint is currently in beta and not available to all apps. [Learn more](/docs/getting-started/using-beta-and-restricted-features/).**  Use this request, as a signed-in user, to follow another user.
   ...
   * @return FollowUser
  */
  public FollowUser followUserUpdate (String username, FollowUserCreate followUserCreate) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    ...
    if (followUserCreate == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'followUserCreate' when calling followUserUpdate",
        new ApiException(400, "Missing the required parameter 'followUserCreate' when calling followUserUpdate"));
    }
    ...
    try {
      ...
      if (localVarResponse != null) {
         return (FollowUser) ApiInvoker.deserialize(localVarResponse, "", FollowUser.class);
      } else {
         return null;
      }
    } catch (ApiException ex) {
   ...
   * Follow user
   * **This endpoint is currently in beta and not available to all apps. [Learn more](/docs/getting-started/using-beta-and-restricted-features/).**  Use this request, as a signed-in user, to follow another user.
   * @param username A valid username   * @param followUserCreate 
  */
  public void followUserUpdate (String username, FollowUserCreate followUserCreate, final Response.Listener<FollowUser> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = followUserCreate;
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "POST", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((FollowUser) ApiInvoker.deserialize(localVarResponse,  "", FollowUser.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
  ...
  * Unverify a website verified by the signed-in user.
   ...
   * @return UserWebsite
  */
  public UserWebsite unverifyWebsiteDelete (String website) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    ...
    try {
      ...
      if (localVarResponse != null) {
         return (UserWebsite) ApiInvoker.deserialize(localVarResponse, "", UserWebsite.class);
      } else {
         return null;
      }
    } catch (ApiException ex) {
   ...
   * @param website Website with path or domain only
  */
  public void unverifyWebsiteDelete (String website, final Response.Listener<UserWebsite> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "DELETE", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((UserWebsite) ApiInvoker.deserialize(localVarResponse,  "", UserWebsite.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
  ...
  */
  public Map<String, AnalyticsMetricsResponse> userAccountAnalytics (Date startDate, Date endDate, String fromClaimedContent, String pinFormat, String appTypes, String contentType, String source, List<QuerymetrictypesItems> metricTypes, String splitField, String adAccountId) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
  ...
  */
  public void userAccountAnalytics (Date startDate, Date endDate, String fromClaimedContent, String pinFormat, String appTypes, String contentType, String source, List<QuerymetrictypesItems> metricTypes, String splitField, String adAccountId, final Response.Listener<Map<String, AnalyticsMetricsResponse>> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
  ...
  */
  public TopPinsAnalyticsResponse userAccountAnalyticsTopPins (Date startDate, Date endDate, TopPinsSortBy sortBy, String fromClaimedContent, String pinFormat, String appTypes, String contentType, String source, List<QuerymetrictypesItems> metricTypes, Integer numOfPins, BigDecimal createdInLastNDays, String adAccountId) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'startDate' is set
    if (startDate == null) {
  ...
  */
  public void userAccountAnalyticsTopPins (Date startDate, Date endDate, TopPinsSortBy sortBy, String fromClaimedContent, String pinFormat, String appTypes, String contentType, String source, List<QuerymetrictypesItems> metricTypes, Integer numOfPins, BigDecimal createdInLastNDays, String adAccountId, final Response.Listener<TopPinsAnalyticsResponse> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
  ...
  */
  public void userAccountAnalyticsTopVideoPins (Date startDate, Date endDate, TopVideoPinsSortBy sortBy, String fromClaimedContent, String pinFormat, String appTypes, String contentType, String source, List<QueryvideopinmetrictypesItems> metricTypes, Integer numOfPins, BigDecimal createdInLastNDays, String adAccountId, final Response.Listener<TopVideoPinsAnalyticsResponse> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
  ...
  */
   ...
   * List following interests
   * Get a list of a user&#39;s following interests in one place.
   * @param username A valid username   * @param bookmark Cursor used to fetch the next page of items   * @param pageSize Maximum number of items to include in a single page. See documentation on [Pagination](/docs/reference/pagination/) for more information.
  */
  ...
  * Get a list of who a certain user follows.
   ...
   * @return FollowersList200Response
  */
  public FollowersList200Response userFollowingGet (String adAccountId, Boolean explicitFollowing, UserFollowingFeedType feedType, String bookmark, Integer pageSize) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
   ...
   * List following
   * Get a list of who a certain user follows.
   * @param adAccountId Unique identifier of an ad account.   * @param explicitFollowing Whether or not to include implicit user follows, which means followees with board follows. When explicit_following is True, it means we only want explicit user follows.   * @param feedType Thrift param specifying what type of followees will be kept. Default to include all followees.   * @param bookmark Cursor used to fetch the next page of items   * @param pageSize Maximum number of items to include in a single page. See documentation on [Pagination](/docs/reference/pagination/) for more information.
  */
  public void userFollowingGet (String adAccountId, Boolean explicitFollowing, UserFollowingFeedType feedType, String bookmark, Integer pageSize, final Response.Listener<FollowersList200Response> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
  ...
  * Verify a website as a signed-in user.
   ...
   * @return UserWebsite
  */
  public UserWebsite verifyWebsiteUpdate (UserWebsiteCreate userWebsiteCreate, String adAccountId) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = userWebsiteCreate;
    // verify the required parameter 'userWebsiteCreate' is set
    if (userWebsiteCreate == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'userWebsiteCreate' when calling verifyWebsiteUpdate",
        new ApiException(400, "Missing the required parameter 'userWebsiteCreate' when calling verifyWebsiteUpdate"));
    }
   ...
   * Verify website
   * Verify a website as a signed-in user.
   * @param userWebsiteCreate    * @param adAccountId Unique identifier of an ad account.
  */
  public void verifyWebsiteUpdate (UserWebsiteCreate userWebsiteCreate, String adAccountId, final Response.Listener<UserWebsite> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = userWebsiteCreate;
  ...
  */
  public UserWebsiteVerification websiteVerificationGet (String adAccountId) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    ...
    try {
      String localVarResponse = apiInvoker.invokeAPI (basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames);
      if (localVarResponse != null) {
         return (UserWebsiteVerification) ApiInvoker.deserialize(localVarResponse, "", UserWebsiteVerification.class);
      } else {
         return null;
      }
    } catch (ApiException ex) {
   ...
   * @param adAccountId Unique identifier of an ad account.
  */
  public void websiteVerificationGet (String adAccountId, final Response.Listener<UserWebsiteVerification> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((UserWebsiteVerification) ApiInvoker.deserialize(localVarResponse,  "", UserWebsiteVerification.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
