...
public class IntegrationMetadataUpdate {
  ...
  public boolean equals(Object o) {
    ...
    return (this.additionalId1 == null ? integrationMetadataUpdate.additionalId1 == null : this.additionalId1.equals(integrationMetadataUpdate.additionalId1)) &&
        (this.connectedAdvertiserId == null ? integrationMetadataUpdate.connectedAdvertiserId == null : this.connectedAdvertiserId.equals(integrationMetadataUpdate.connectedAdvertiserId)) &&
        (this.connectedLbaId == null ? integrationMetadataUpdate.connectedLbaId == null : this.connectedLbaId.equals(integrationMetadataUpdate.connectedLbaId)) &&
        (this.connectedMerchantId == null ? integrationMetadataUpdate.connectedMerchantId == null : this.connectedMerchantId.equals(integrationMetadataUpdate.connectedMerchantId)) &&
        (this.connectedTagId == null ? integrationMetadataUpdate.connectedTagId == null : this.connectedTagId.equals(integrationMetadataUpdate.connectedTagId)) &&
        (this.partnerAccessToken == null ? integrationMetadataUpdate.partnerAccessToken == null : this.partnerAccessToken.equals(integrationMetadataUpdate.partnerAccessToken)) &&
        (this.partnerAccessTokenExpiry == null ? integrationMetadataUpdate.partnerAccessTokenExpiry == null : this.partnerAccessTokenExpiry.equals(integrationMetadataUpdate.partnerAccessTokenExpiry)) &&
        (this.partnerMetadata == null ? integrationMetadataUpdate.partnerMetadata == null : this.partnerMetadata.equals(integrationMetadataUpdate.partnerMetadata)) &&
        (this.partnerPrimaryEmail == null ? integrationMetadataUpdate.partnerPrimaryEmail == null : this.partnerPrimaryEmail.equals(integrationMetadataUpdate.partnerPrimaryEmail)) &&
        (this.partnerRefreshToken == null ? integrationMetadataUpdate.partnerRefreshToken == null : this.partnerRefreshToken.equals(integrationMetadataUpdate.partnerRefreshToken)) &&
        (this.partnerRefreshTokenExpiry == null ? integrationMetadataUpdate.partnerRefreshTokenExpiry == null : this.partnerRefreshTokenExpiry.equals(integrationMetadataUpdate.partnerRefreshTokenExpiry)) &&
        (this.scopes == null ? integrationMetadataUpdate.scopes == null : this.scopes.equals(integrationMetadataUpdate.scopes));
  }
