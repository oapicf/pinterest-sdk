...
public class LeadFormBatchUpdate {
  ...
  public boolean equals(Object o) {
    ...
    return (this.completionMessage == null ? leadFormBatchUpdate.completionMessage == null : this.completionMessage.equals(leadFormBatchUpdate.completionMessage)) &&
        (this.disclosureLanguage == null ? leadFormBatchUpdate.disclosureLanguage == null : this.disclosureLanguage.equals(leadFormBatchUpdate.disclosureLanguage)) &&
        (this.hasAcceptedTerms == null ? leadFormBatchUpdate.hasAcceptedTerms == null : this.hasAcceptedTerms.equals(leadFormBatchUpdate.hasAcceptedTerms)) &&
        (this.id == null ? leadFormBatchUpdate.id == null : this.id.equals(leadFormBatchUpdate.id)) &&
        (this.name == null ? leadFormBatchUpdate.name == null : this.name.equals(leadFormBatchUpdate.name)) &&
        (this.policyLinks == null ? leadFormBatchUpdate.policyLinks == null : this.policyLinks.equals(leadFormBatchUpdate.policyLinks)) &&
        (this.privacyPolicyLink == null ? leadFormBatchUpdate.privacyPolicyLink == null : this.privacyPolicyLink.equals(leadFormBatchUpdate.privacyPolicyLink)) &&
        (this.questions == null ? leadFormBatchUpdate.questions == null : this.questions.equals(leadFormBatchUpdate.questions)) &&
        (this.status == null ? leadFormBatchUpdate.status == null : this.status.equals(leadFormBatchUpdate.status));
  }
