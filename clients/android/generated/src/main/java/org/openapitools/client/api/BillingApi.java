...
public class BillingApi {
  ...
  */
  public BillingInvoicesGet200Response billingInvoicesGet (String adAccountId, String bookmark, Integer pageSize, String sort, String order, String status, String documentType, Date startDueDate, Date endDueDate) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'adAccountId' is set
    if (adAccountId == null) {
   ...
   * Get billing invoices
   * Get billing invoices in the advertiser account.
   * @param adAccountId Unique identifier of an ad account.   * @param bookmark Cursor used to fetch the next page of items   * @param pageSize Maximum number of items to include in a single page of the response. See documentation on &lt;a href&#x3D;&#39;/docs/reference/pagination/&#39;&gt;Pagination&lt;/a&gt; for more information.   * @param sort Field of which to sort billing invoices   * @param order The order in which to sort the items returned: “ASCENDING” or “DESCENDING” by ID. Note that higher-value IDs are associated with more-recently added items.   * @param status Status of billing invoices to filter by   * @param documentType Document type of billing invoices to filter by   * @param startDueDate Starting point for due dates when searching for invoices. Format: YYYY-MM-DD   * @param endDueDate Ending point for due dates when searching for invoices. Format: YYYY-MM-DD
  */
  public void billingInvoicesGet (String adAccountId, String bookmark, Integer pageSize, String sort, String order, String status, String documentType, Date startDueDate, Date endDueDate, final Response.Listener<BillingInvoicesGet200Response> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
