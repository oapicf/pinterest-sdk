...
public class AdGroupCreate {
  ...
  public boolean equals(Object o) {
    ...
    return (this.adAccountId == null ? adGroupCreate.adAccountId == null : this.adAccountId.equals(adGroupCreate.adAccountId)) &&
        (this.bidInMicroCurrency == null ? adGroupCreate.bidInMicroCurrency == null : this.bidInMicroCurrency.equals(adGroupCreate.bidInMicroCurrency)) &&
        (this.bidStrategyType == null ? adGroupCreate.bidStrategyType == null : this.bidStrategyType.equals(adGroupCreate.bidStrategyType)) &&
        (this.billableEvent == null ? adGroupCreate.billableEvent == null : this.billableEvent.equals(adGroupCreate.billableEvent)) &&
        (this.budgetInMicroCurrency == null ? adGroupCreate.budgetInMicroCurrency == null : this.budgetInMicroCurrency.equals(adGroupCreate.budgetInMicroCurrency)) &&
        (this.campaignId == null ? adGroupCreate.campaignId == null : this.campaignId.equals(adGroupCreate.campaignId)) &&
        (this.conversionLearningModeType == null ? adGroupCreate.conversionLearningModeType == null : this.conversionLearningModeType.equals(adGroupCreate.conversionLearningModeType)) &&
        (this.createdTime == null ? adGroupCreate.createdTime == null : this.createdTime.equals(adGroupCreate.createdTime)) &&
        (this.customerSegmentId == null ? adGroupCreate.customerSegmentId == null : this.customerSegmentId.equals(adGroupCreate.customerSegmentId)) &&
        (this.dcaAssets == null ? adGroupCreate.dcaAssets == null : this.dcaAssets.equals(adGroupCreate.dcaAssets)) &&
        (this.endTime == null ? adGroupCreate.endTime == null : this.endTime.equals(adGroupCreate.endTime)) &&
        (this.extFeatures == null ? adGroupCreate.extFeatures == null : this.extFeatures.equals(adGroupCreate.extFeatures)) &&
        (this.feedProfileId == null ? adGroupCreate.feedProfileId == null : this.feedProfileId.equals(adGroupCreate.feedProfileId)) &&
        (this.id == null ? adGroupCreate.id == null : this.id.equals(adGroupCreate.id)) &&
        (this.isCreativeOptimization == null ? adGroupCreate.isCreativeOptimization == null : this.isCreativeOptimization.equals(adGroupCreate.isCreativeOptimization)) &&
        (this.isLocalInventory == null ? adGroupCreate.isLocalInventory == null : this.isLocalInventory.equals(adGroupCreate.isLocalInventory)) &&
        (this.lifetimeFrequencyCap == null ? adGroupCreate.lifetimeFrequencyCap == null : this.lifetimeFrequencyCap.equals(adGroupCreate.lifetimeFrequencyCap)) &&
        (this.localInventoryRadiusInMiles == null ? adGroupCreate.localInventoryRadiusInMiles == null : this.localInventoryRadiusInMiles.equals(adGroupCreate.localInventoryRadiusInMiles)) &&
        (this.name == null ? adGroupCreate.name == null : this.name.equals(adGroupCreate.name)) &&
        (this.optimizationGoalMetadata == null ? adGroupCreate.optimizationGoalMetadata == null : this.optimizationGoalMetadata.equals(adGroupCreate.optimizationGoalMetadata)) &&
        (this.performancePlusCampaignSettings == null ? adGroupCreate.performancePlusCampaignSettings == null : this.performancePlusCampaignSettings.equals(adGroupCreate.performancePlusCampaignSettings)) &&
        (this.placementGroup == null ? adGroupCreate.placementGroup == null : this.placementGroup.equals(adGroupCreate.placementGroup)) &&
        (this.placementTrafficType == null ? adGroupCreate.placementTrafficType == null : this.placementTrafficType.equals(adGroupCreate.placementTrafficType)) &&
        (this.promotionApplicationLevel == null ? adGroupCreate.promotionApplicationLevel == null : this.promotionApplicationLevel.equals(adGroupCreate.promotionApplicationLevel)) &&
        (this.promotionId == null ? adGroupCreate.promotionId == null : this.promotionId.equals(adGroupCreate.promotionId)) &&
        (this.promotionIds == null ? adGroupCreate.promotionIds == null : this.promotionIds.equals(adGroupCreate.promotionIds)) &&
        (this.startTime == null ? adGroupCreate.startTime == null : this.startTime.equals(adGroupCreate.startTime)) &&
        (this.status == null ? adGroupCreate.status == null : this.status.equals(adGroupCreate.status)) &&
        (this.summaryStatus == null ? adGroupCreate.summaryStatus == null : this.summaryStatus.equals(adGroupCreate.summaryStatus)) &&
        (this.targetingSpec == null ? adGroupCreate.targetingSpec == null : this.targetingSpec.equals(adGroupCreate.targetingSpec)) &&
        (this.targetingTemplateIds == null ? adGroupCreate.targetingTemplateIds == null : this.targetingTemplateIds.equals(adGroupCreate.targetingTemplateIds)) &&
        (this.trackingUrls == null ? adGroupCreate.trackingUrls == null : this.trackingUrls.equals(adGroupCreate.trackingUrls)) &&
        (this.type == null ? adGroupCreate.type == null : this.type.equals(adGroupCreate.type)) &&
        (this.updatedTime == null ? adGroupCreate.updatedTime == null : this.updatedTime.equals(adGroupCreate.updatedTime)) &&
        (this.autoTargetingEnabled == null ? adGroupCreate.autoTargetingEnabled == null : this.autoTargetingEnabled.equals(adGroupCreate.autoTargetingEnabled)) &&
        (this.bidMultiplier == null ? adGroupCreate.bidMultiplier == null : this.bidMultiplier.equals(adGroupCreate.bidMultiplier)) &&
        (this.budgetType == null ? adGroupCreate.budgetType == null : this.budgetType.equals(adGroupCreate.budgetType)) &&
        (this.pacingDeliveryType == null ? adGroupCreate.pacingDeliveryType == null : this.pacingDeliveryType.equals(adGroupCreate.pacingDeliveryType));
  }
