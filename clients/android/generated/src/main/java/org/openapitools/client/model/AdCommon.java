...
public class AdCommon {
  ...
  public boolean equals(Object o) {
    ...
    return (this.adGroupId == null ? adCommon.adGroupId == null : this.adGroupId.equals(adCommon.adGroupId)) &&
        (this.androidDeepLink == null ? adCommon.androidDeepLink == null : this.androidDeepLink.equals(adCommon.androidDeepLink)) &&
        (this.carouselAndroidDeepLinks == null ? adCommon.carouselAndroidDeepLinks == null : this.carouselAndroidDeepLinks.equals(adCommon.carouselAndroidDeepLinks)) &&
        (this.carouselDestinationUrls == null ? adCommon.carouselDestinationUrls == null : this.carouselDestinationUrls.equals(adCommon.carouselDestinationUrls)) &&
        (this.carouselIosDeepLinks == null ? adCommon.carouselIosDeepLinks == null : this.carouselIosDeepLinks.equals(adCommon.carouselIosDeepLinks)) &&
        (this.clickTrackingUrl == null ? adCommon.clickTrackingUrl == null : this.clickTrackingUrl.equals(adCommon.clickTrackingUrl)) &&
        (this.creativeType == null ? adCommon.creativeType == null : this.creativeType.equals(adCommon.creativeType)) &&
        (this.customizableCtaType == null ? adCommon.customizableCtaType == null : this.customizableCtaType.equals(adCommon.customizableCtaType)) &&
        (this.destinationUrl == null ? adCommon.destinationUrl == null : this.destinationUrl.equals(adCommon.destinationUrl)) &&
        (this.disclosureType == null ? adCommon.disclosureType == null : this.disclosureType.equals(adCommon.disclosureType)) &&
        (this.disclosureUrl == null ? adCommon.disclosureUrl == null : this.disclosureUrl.equals(adCommon.disclosureUrl)) &&
        (this.gridClickType == null ? adCommon.gridClickType == null : this.gridClickType.equals(adCommon.gridClickType)) &&
        (this.iosDeepLink == null ? adCommon.iosDeepLink == null : this.iosDeepLink.equals(adCommon.iosDeepLink)) &&
        (this.isPinDeleted == null ? adCommon.isPinDeleted == null : this.isPinDeleted.equals(adCommon.isPinDeleted)) &&
        (this.isRemovable == null ? adCommon.isRemovable == null : this.isRemovable.equals(adCommon.isRemovable)) &&
        (this.leadFormId == null ? adCommon.leadFormId == null : this.leadFormId.equals(adCommon.leadFormId)) &&
        (this.name == null ? adCommon.name == null : this.name.equals(adCommon.name)) &&
        (this.quizPinData == null ? adCommon.quizPinData == null : this.quizPinData.equals(adCommon.quizPinData)) &&
        (this.status == null ? adCommon.status == null : this.status.equals(adCommon.status)) &&
        (this.trackingUrls == null ? adCommon.trackingUrls == null : this.trackingUrls.equals(adCommon.trackingUrls)) &&
        (this.viewTrackingUrl == null ? adCommon.viewTrackingUrl == null : this.viewTrackingUrl.equals(adCommon.viewTrackingUrl));
  }
