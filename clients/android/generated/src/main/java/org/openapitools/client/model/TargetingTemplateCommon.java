...
public class TargetingTemplateCommon {
  ...
  public boolean equals(Object o) {
    ...
    return (this.name == null ? targetingTemplateCommon.name == null : this.name.equals(targetingTemplateCommon.name)) &&
        (this.autoTargetingEnabled == null ? targetingTemplateCommon.autoTargetingEnabled == null : this.autoTargetingEnabled.equals(targetingTemplateCommon.autoTargetingEnabled)) &&
        (this.targetingAttributes == null ? targetingTemplateCommon.targetingAttributes == null : this.targetingAttributes.equals(targetingTemplateCommon.targetingAttributes)) &&
        (this.placementGroup == null ? targetingTemplateCommon.placementGroup == null : this.placementGroup.equals(targetingTemplateCommon.placementGroup)) &&
        (this.keywords == null ? targetingTemplateCommon.keywords == null : this.keywords.equals(targetingTemplateCommon.keywords)) &&
        (this.trackingUrls == null ? targetingTemplateCommon.trackingUrls == null : this.trackingUrls.equals(targetingTemplateCommon.trackingUrls));
  }
