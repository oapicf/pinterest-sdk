...
public class IntegrationMetadataCreate {
  ...
  public boolean equals(Object o) {
    ...
    return (this.additionalId1 == null ? integrationMetadataCreate.additionalId1 == null : this.additionalId1.equals(integrationMetadataCreate.additionalId1)) &&
        (this.connectedAdvertiserId == null ? integrationMetadataCreate.connectedAdvertiserId == null : this.connectedAdvertiserId.equals(integrationMetadataCreate.connectedAdvertiserId)) &&
        (this.connectedLbaId == null ? integrationMetadataCreate.connectedLbaId == null : this.connectedLbaId.equals(integrationMetadataCreate.connectedLbaId)) &&
        (this.connectedMerchantId == null ? integrationMetadataCreate.connectedMerchantId == null : this.connectedMerchantId.equals(integrationMetadataCreate.connectedMerchantId)) &&
        (this.connectedTagId == null ? integrationMetadataCreate.connectedTagId == null : this.connectedTagId.equals(integrationMetadataCreate.connectedTagId)) &&
        (this.externalBusinessId == null ? integrationMetadataCreate.externalBusinessId == null : this.externalBusinessId.equals(integrationMetadataCreate.externalBusinessId)) &&
        (this.partnerAccessToken == null ? integrationMetadataCreate.partnerAccessToken == null : this.partnerAccessToken.equals(integrationMetadataCreate.partnerAccessToken)) &&
        (this.partnerAccessTokenExpiry == null ? integrationMetadataCreate.partnerAccessTokenExpiry == null : this.partnerAccessTokenExpiry.equals(integrationMetadataCreate.partnerAccessTokenExpiry)) &&
        (this.partnerMetadata == null ? integrationMetadataCreate.partnerMetadata == null : this.partnerMetadata.equals(integrationMetadataCreate.partnerMetadata)) &&
        (this.partnerPrimaryEmail == null ? integrationMetadataCreate.partnerPrimaryEmail == null : this.partnerPrimaryEmail.equals(integrationMetadataCreate.partnerPrimaryEmail)) &&
        (this.partnerRefreshToken == null ? integrationMetadataCreate.partnerRefreshToken == null : this.partnerRefreshToken.equals(integrationMetadataCreate.partnerRefreshToken)) &&
        (this.partnerRefreshTokenExpiry == null ? integrationMetadataCreate.partnerRefreshTokenExpiry == null : this.partnerRefreshTokenExpiry.equals(integrationMetadataCreate.partnerRefreshTokenExpiry)) &&
        (this.scopes == null ? integrationMetadataCreate.scopes == null : this.scopes.equals(integrationMetadataCreate.scopes));
  }
