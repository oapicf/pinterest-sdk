...
import org.openapitools.client.model.CatalogsCreativeAssetsFeedsUpdateRequest;
...
import org.openapitools.client.model.CatalogsHotelFeedsUpdateRequest;
import org.openapitools.client.model.CatalogsRetailFeedsUpdateRequest;
...
public class CatalogsVerticalFeedsUpdateRequest {
  ...
  public boolean equals(Object o) {
    ...
    return (this.catalogType == null ? catalogsVerticalFeedsUpdateRequest.catalogType == null : this.catalogType.equals(catalogsVerticalFeedsUpdateRequest.catalogType)) &&
        (this.credentials == null ? catalogsVerticalFeedsUpdateRequest.credentials == null : this.credentials.equals(catalogsVerticalFeedsUpdateRequest.credentials)) &&
        (this.defaultAvailability == null ? catalogsVerticalFeedsUpdateRequest.defaultAvailability == null : this.defaultAvailability.equals(catalogsVerticalFeedsUpdateRequest.defaultAvailability)) &&
        (this.defaultCurrency == null ? catalogsVerticalFeedsUpdateRequest.defaultCurrency == null : this.defaultCurrency.equals(catalogsVerticalFeedsUpdateRequest.defaultCurrency)) &&
        (this.format == null ? catalogsVerticalFeedsUpdateRequest.format == null : this.format.equals(catalogsVerticalFeedsUpdateRequest.format)) &&
        (this.location == null ? catalogsVerticalFeedsUpdateRequest.location == null : this.location.equals(catalogsVerticalFeedsUpdateRequest.location)) &&
        (this.name == null ? catalogsVerticalFeedsUpdateRequest.name == null : this.name.equals(catalogsVerticalFeedsUpdateRequest.name)) &&
        (this.preferredProcessingSchedule == null ? catalogsVerticalFeedsUpdateRequest.preferredProcessingSchedule == null : this.preferredProcessingSchedule.equals(catalogsVerticalFeedsUpdateRequest.preferredProcessingSchedule)) &&
        (this.status == null ? catalogsVerticalFeedsUpdateRequest.status == null : this.status.equals(catalogsVerticalFeedsUpdateRequest.status));
  }
