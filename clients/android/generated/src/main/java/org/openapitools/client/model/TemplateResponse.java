...
import org.openapitools.client.model.TemplateResponseDateRange;
...
public class TemplateResponse {
  ...
  private TemplateResponseDateRange dateRange = null;
  ...
  private ConversionReportTimeTypeEnum conversionReportTimeType = null;
  ...
  public enum CreationSourceEnum {
     ADS_API,  ADS_MANAGER_REPORTING_PAGE,  ADS_MANAGER_REPORT_BUILDER, 
  };
  ...
  public enum TypeEnum {
     UNSPECIFIED,  BULK,  OVERVIEW,  TABLE, 
  };
  @SerializedName("type")
  private TypeEnum type = null;
  public enum List&lt;IngestionSourcesEnum&gt; {
   ...
   **/
  @ApiModelProperty(value = "Reporting template type")
  ...
  public boolean equals(Object o) {
    ...
    return (this.id == null ? templateResponse.id == null : this.id.equals(templateResponse.id)) &&
        (this.adAccountId == null ? templateResponse.adAccountId == null : this.adAccountId.equals(templateResponse.adAccountId)) &&
        (this.adAccountIds == null ? templateResponse.adAccountIds == null : this.adAccountIds.equals(templateResponse.adAccountIds)) &&
        (this.userId == null ? templateResponse.userId == null : this.userId.equals(templateResponse.userId)) &&
        (this.name == null ? templateResponse.name == null : this.name.equals(templateResponse.name)) &&
        (this.reportStartRelativeDaysInPast == null ? templateResponse.reportStartRelativeDaysInPast == null : this.reportStartRelativeDaysInPast.equals(templateResponse.reportStartRelativeDaysInPast)) &&
        (this.reportEndRelativeDaysInPast == null ? templateResponse.reportEndRelativeDaysInPast == null : this.reportEndRelativeDaysInPast.equals(templateResponse.reportEndRelativeDaysInPast)) &&
        (this.dateRange == null ? templateResponse.dateRange == null : this.dateRange.equals(templateResponse.dateRange)) &&
        (this.reportLevel == null ? templateResponse.reportLevel == null : this.reportLevel.equals(templateResponse.reportLevel)) &&
        (this.reportFormat == null ? templateResponse.reportFormat == null : this.reportFormat.equals(templateResponse.reportFormat)) &&
        (this.columns == null ? templateResponse.columns == null : this.columns.equals(templateResponse.columns)) &&
        (this.granularity == null ? templateResponse.granularity == null : this.granularity.equals(templateResponse.granularity)) &&
        (this.viewWindowDays == null ? templateResponse.viewWindowDays == null : this.viewWindowDays.equals(templateResponse.viewWindowDays)) &&
        (this.clickWindowDays == null ? templateResponse.clickWindowDays == null : this.clickWindowDays.equals(templateResponse.clickWindowDays)) &&
        (this.engagementWindowDays == null ? templateResponse.engagementWindowDays == null : this.engagementWindowDays.equals(templateResponse.engagementWindowDays)) &&
        (this.conversionReportTimeType == null ? templateResponse.conversionReportTimeType == null : this.conversionReportTimeType.equals(templateResponse.conversionReportTimeType)) &&
        (this.filtersJson == null ? templateResponse.filtersJson == null : this.filtersJson.equals(templateResponse.filtersJson)) &&
        (this.isOwnedByUser == null ? templateResponse.isOwnedByUser == null : this.isOwnedByUser.equals(templateResponse.isOwnedByUser)) &&
        (this.isScheduled == null ? templateResponse.isScheduled == null : this.isScheduled.equals(templateResponse.isScheduled)) &&
        (this.creationSource == null ? templateResponse.creationSource == null : this.creationSource.equals(templateResponse.creationSource)) &&
        (this.isDeleted == null ? templateResponse.isDeleted == null : this.isDeleted.equals(templateResponse.isDeleted)) &&
        (this.updatedTime == null ? templateResponse.updatedTime == null : this.updatedTime.equals(templateResponse.updatedTime)) &&
        (this.customColumnIds == null ? templateResponse.customColumnIds == null : this.customColumnIds.equals(templateResponse.customColumnIds)) &&
        (this.type == null ? templateResponse.type == null : this.type.equals(templateResponse.type)) &&
        (this.ingestionSources == null ? templateResponse.ingestionSources == null : this.ingestionSources.equals(templateResponse.ingestionSources));
  }
