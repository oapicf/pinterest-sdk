...
public class AdGroup {
  ...
  public boolean equals(Object o) {
    ...
    return (this.adAccountId == null ? adGroup.adAccountId == null : this.adAccountId.equals(adGroup.adAccountId)) &&
        (this.bidInMicroCurrency == null ? adGroup.bidInMicroCurrency == null : this.bidInMicroCurrency.equals(adGroup.bidInMicroCurrency)) &&
        (this.bidStrategyType == null ? adGroup.bidStrategyType == null : this.bidStrategyType.equals(adGroup.bidStrategyType)) &&
        (this.billableEvent == null ? adGroup.billableEvent == null : this.billableEvent.equals(adGroup.billableEvent)) &&
        (this.budgetInMicroCurrency == null ? adGroup.budgetInMicroCurrency == null : this.budgetInMicroCurrency.equals(adGroup.budgetInMicroCurrency)) &&
        (this.campaignId == null ? adGroup.campaignId == null : this.campaignId.equals(adGroup.campaignId)) &&
        (this.conversionLearningModeType == null ? adGroup.conversionLearningModeType == null : this.conversionLearningModeType.equals(adGroup.conversionLearningModeType)) &&
        (this.createdTime == null ? adGroup.createdTime == null : this.createdTime.equals(adGroup.createdTime)) &&
        (this.customerSegmentId == null ? adGroup.customerSegmentId == null : this.customerSegmentId.equals(adGroup.customerSegmentId)) &&
        (this.dcaAssets == null ? adGroup.dcaAssets == null : this.dcaAssets.equals(adGroup.dcaAssets)) &&
        (this.endTime == null ? adGroup.endTime == null : this.endTime.equals(adGroup.endTime)) &&
        (this.extFeatures == null ? adGroup.extFeatures == null : this.extFeatures.equals(adGroup.extFeatures)) &&
        (this.feedProfileId == null ? adGroup.feedProfileId == null : this.feedProfileId.equals(adGroup.feedProfileId)) &&
        (this.id == null ? adGroup.id == null : this.id.equals(adGroup.id)) &&
        (this.isCreativeOptimization == null ? adGroup.isCreativeOptimization == null : this.isCreativeOptimization.equals(adGroup.isCreativeOptimization)) &&
        (this.isLocalInventory == null ? adGroup.isLocalInventory == null : this.isLocalInventory.equals(adGroup.isLocalInventory)) &&
        (this.lifetimeFrequencyCap == null ? adGroup.lifetimeFrequencyCap == null : this.lifetimeFrequencyCap.equals(adGroup.lifetimeFrequencyCap)) &&
        (this.localInventoryRadiusInMiles == null ? adGroup.localInventoryRadiusInMiles == null : this.localInventoryRadiusInMiles.equals(adGroup.localInventoryRadiusInMiles)) &&
        (this.name == null ? adGroup.name == null : this.name.equals(adGroup.name)) &&
        (this.optimizationGoalMetadata == null ? adGroup.optimizationGoalMetadata == null : this.optimizationGoalMetadata.equals(adGroup.optimizationGoalMetadata)) &&
        (this.performancePlusCampaignSettings == null ? adGroup.performancePlusCampaignSettings == null : this.performancePlusCampaignSettings.equals(adGroup.performancePlusCampaignSettings)) &&
        (this.placementGroup == null ? adGroup.placementGroup == null : this.placementGroup.equals(adGroup.placementGroup)) &&
        (this.placementTrafficType == null ? adGroup.placementTrafficType == null : this.placementTrafficType.equals(adGroup.placementTrafficType)) &&
        (this.promotionApplicationLevel == null ? adGroup.promotionApplicationLevel == null : this.promotionApplicationLevel.equals(adGroup.promotionApplicationLevel)) &&
        (this.promotionId == null ? adGroup.promotionId == null : this.promotionId.equals(adGroup.promotionId)) &&
        (this.promotionIds == null ? adGroup.promotionIds == null : this.promotionIds.equals(adGroup.promotionIds)) &&
        (this.startTime == null ? adGroup.startTime == null : this.startTime.equals(adGroup.startTime)) &&
        (this.status == null ? adGroup.status == null : this.status.equals(adGroup.status)) &&
        (this.summaryStatus == null ? adGroup.summaryStatus == null : this.summaryStatus.equals(adGroup.summaryStatus)) &&
        (this.targetingSpec == null ? adGroup.targetingSpec == null : this.targetingSpec.equals(adGroup.targetingSpec)) &&
        (this.targetingTemplateIds == null ? adGroup.targetingTemplateIds == null : this.targetingTemplateIds.equals(adGroup.targetingTemplateIds)) &&
        (this.trackingUrls == null ? adGroup.trackingUrls == null : this.trackingUrls.equals(adGroup.trackingUrls)) &&
        (this.type == null ? adGroup.type == null : this.type.equals(adGroup.type)) &&
        (this.updatedTime == null ? adGroup.updatedTime == null : this.updatedTime.equals(adGroup.updatedTime)) &&
        (this.autoTargetingEnabled == null ? adGroup.autoTargetingEnabled == null : this.autoTargetingEnabled.equals(adGroup.autoTargetingEnabled)) &&
        (this.bidMultiplier == null ? adGroup.bidMultiplier == null : this.bidMultiplier.equals(adGroup.bidMultiplier)) &&
        (this.budgetType == null ? adGroup.budgetType == null : this.budgetType.equals(adGroup.budgetType)) &&
        (this.pacingDeliveryType == null ? adGroup.pacingDeliveryType == null : this.pacingDeliveryType.equals(adGroup.pacingDeliveryType));
  }
