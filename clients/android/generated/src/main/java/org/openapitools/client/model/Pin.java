...
public class Pin {
  ...
  public boolean equals(Object o) {
    ...
    Pin pin = (Pin) o;
    return (this.aiDisclosures == null ? pin.aiDisclosures == null : this.aiDisclosures.equals(pin.aiDisclosures)) &&
        (this.boardId == null ? pin.boardId == null : this.boardId.equals(pin.boardId)) &&
        (this.boardOwner == null ? pin.boardOwner == null : this.boardOwner.equals(pin.boardOwner)) &&
        (this.boardSectionId == null ? pin.boardSectionId == null : this.boardSectionId.equals(pin.boardSectionId)) &&
        (this.createdAt == null ? pin.createdAt == null : this.createdAt.equals(pin.createdAt)) &&
        (this.creativeType == null ? pin.creativeType == null : this.creativeType.equals(pin.creativeType)) &&
        (this.dominantColor == null ? pin.dominantColor == null : this.dominantColor.equals(pin.dominantColor)) &&
        (this.hasBeenPromoted == null ? pin.hasBeenPromoted == null : this.hasBeenPromoted.equals(pin.hasBeenPromoted)) &&
        (this.id == null ? pin.id == null : this.id.equals(pin.id)) &&
        (this.isOwner == null ? pin.isOwner == null : this.isOwner.equals(pin.isOwner)) &&
        (this.isProduct == null ? pin.isProduct == null : this.isProduct.equals(pin.isProduct)) &&
        (this.isStandard == null ? pin.isStandard == null : this.isStandard.equals(pin.isStandard)) &&
        (this.media == null ? pin.media == null : this.media.equals(pin.media)) &&
        (this.parentPinId == null ? pin.parentPinId == null : this.parentPinId.equals(pin.parentPinId)) &&
        (this.pinMetrics == null ? pin.pinMetrics == null : this.pinMetrics.equals(pin.pinMetrics)) &&
        (this.altText == null ? pin.altText == null : this.altText.equals(pin.altText)) &&
        (this.description == null ? pin.description == null : this.description.equals(pin.description)) &&
        (this.link == null ? pin.link == null : this.link.equals(pin.link)) &&
        (this.title == null ? pin.title == null : this.title.equals(pin.title));
  }
