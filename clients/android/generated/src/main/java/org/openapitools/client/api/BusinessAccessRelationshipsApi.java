...
import org.openapitools.client.model.BrandAccountsCreate200Response;
import org.openapitools.client.model.BrandAccountsCreateRequest;
import org.openapitools.client.model.BrandAccountsUpdateRequest;
...
import org.openapitools.client.model.SystemUserUpdateRequest;
...
public class BusinessAccessRelationshipsApi {
  ...
  */
  public BrandAccountsCreate200Response brandAccountsCreate (String businessHierarchyId, BrandAccountsCreateRequest brandAccountsCreateRequest) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    ...
    if (brandAccountsCreateRequest == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'brandAccountsCreateRequest' when calling brandAccountsCreate",
        new ApiException(400, "Missing the required parameter 'brandAccountsCreateRequest' when calling brandAccountsCreate"));
    }
    ...
    try {
      ...
      if (localVarResponse != null) {
         return (BrandAccountsCreate200Response) ApiInvoker.deserialize(localVarResponse, "", BrandAccountsCreate200Response.class);
      } else {
         return null;
      }
   ...
   * Create a Brand Account
   * Create a Brand Account that will be a child business of a business hierarchy. Request must contain name, username, and country.
   * @param businessHierarchyId business hierarchy node id   * @param brandAccountsCreateRequest 
  */
  public void brandAccountsCreate (String businessHierarchyId, BrandAccountsCreateRequest brandAccountsCreateRequest, final Response.Listener<BrandAccountsCreate200Response> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = brandAccountsCreateRequest;
      ...
      apiInvoker.invokeAPI(basePath, path, "POST", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((BrandAccountsCreate200Response) ApiInvoker.deserialize(localVarResponse,  "", BrandAccountsCreate200Response.class));
  ...
  * Update an existing Brand Account
   ...
   * @return BrandAccountsCreate200Response
  */
  public BrandAccountsCreate200Response brandAccountsUpdate (String businessHierarchyId, String brandAccountId, BrandAccountsUpdateRequest brandAccountsUpdateRequest) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    ...
    if (brandAccountsUpdateRequest == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'brandAccountsUpdateRequest' when calling brandAccountsUpdate",
        new ApiException(400, "Missing the required parameter 'brandAccountsUpdateRequest' when calling brandAccountsUpdate"));
    }

    // create path and map variables
    String path = "/business_access/business_hierarchy/{business_hierarchy_id}/brand_accounts/{brand_account_id}".replaceAll("\\{" + "business_hierarchy_id" + "\\}", apiInvoker.escapeString(businessHierarchyId.toString())).replaceAll("\\{" + "brand_account_id" + "\\}", apiInvoker.escapeString(brandAccountId.toString()));
   ...
   * Update a Brand Account
   * Update an existing Brand Account
   * @param businessHierarchyId business hierarchy node id   * @param brandAccountId Unique identifier of a brand account.   * @param brandAccountsUpdateRequest 
  */
  public void brandAccountsUpdate (String businessHierarchyId, String brandAccountId, BrandAccountsUpdateRequest brandAccountsUpdateRequest, final Response.Listener<BrandAccountsCreate200Response> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = brandAccountsUpdateRequest;
    ...
    // create path and map variables
    String path = "/business_access/business_hierarchy/{business_hierarchy_id}/brand_accounts/{brand_account_id}".replaceAll("\\{format\\}","json").replaceAll("\\{" + "business_hierarchy_id" + "\\}", apiInvoker.escapeString(businessHierarchyId.toString())).replaceAll("\\{" + "brand_account_id" + "\\}", apiInvoker.escapeString(brandAccountId.toString()));
  ...
  */
  public void getBusinessMembers (String businessId, Boolean fetchSystemUsers, Boolean assetsSummary, List<MemberBusinessRole> businessRoles, String memberIds, Integer startIndex, String bookmark, Integer pageSize, final Response.Listener<GetBusinessMembers200Response> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
  ...
  * Update a system user information such as name.
   ...
   * @return void
  */
  public void systemUserUpdate (String businessId, String systemUserId, SystemUserUpdateRequest systemUserUpdateRequest) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    ...
    if (systemUserUpdateRequest == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'systemUserUpdateRequest' when calling systemUserUpdate",
        new ApiException(400, "Missing the required parameter 'systemUserUpdateRequest' when calling systemUserUpdate"));
    }
   ...
   * Update a system user information.
   * Update a system user information such as name.
   * @param businessId Unique identifier of the requesting business.   * @param systemUserId Unique identifier of a system user.   * @param systemUserUpdateRequest 
  */
  public void systemUserUpdate (String businessId, String systemUserId, SystemUserUpdateRequest systemUserUpdateRequest, final Response.Listener<String> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = systemUserUpdateRequest;
