...
public class AggregatedPinComment {
  ...
  public boolean equals(Object o) {
    ...
    return (this.aiDisclosures == null ? aggregatedPinComment.aiDisclosures == null : this.aiDisclosures.equals(aggregatedPinComment.aiDisclosures)) &&
        (this.altText == null ? aggregatedPinComment.altText == null : this.altText.equals(aggregatedPinComment.altText)) &&
        (this.boardId == null ? aggregatedPinComment.boardId == null : this.boardId.equals(aggregatedPinComment.boardId)) &&
        (this.boardOwner == null ? aggregatedPinComment.boardOwner == null : this.boardOwner.equals(aggregatedPinComment.boardOwner)) &&
        (this.boardSectionId == null ? aggregatedPinComment.boardSectionId == null : this.boardSectionId.equals(aggregatedPinComment.boardSectionId)) &&
        (this.createdAt == null ? aggregatedPinComment.createdAt == null : this.createdAt.equals(aggregatedPinComment.createdAt)) &&
        (this.creativeType == null ? aggregatedPinComment.creativeType == null : this.creativeType.equals(aggregatedPinComment.creativeType)) &&
        (this.description == null ? aggregatedPinComment.description == null : this.description.equals(aggregatedPinComment.description)) &&
        (this.dominantColor == null ? aggregatedPinComment.dominantColor == null : this.dominantColor.equals(aggregatedPinComment.dominantColor)) &&
        (this.hasBeenPromoted == null ? aggregatedPinComment.hasBeenPromoted == null : this.hasBeenPromoted.equals(aggregatedPinComment.hasBeenPromoted)) &&
        (this.id == null ? aggregatedPinComment.id == null : this.id.equals(aggregatedPinComment.id)) &&
        (this.isOwner == null ? aggregatedPinComment.isOwner == null : this.isOwner.equals(aggregatedPinComment.isOwner)) &&
        (this.isProduct == null ? aggregatedPinComment.isProduct == null : this.isProduct.equals(aggregatedPinComment.isProduct)) &&
        (this.isStandard == null ? aggregatedPinComment.isStandard == null : this.isStandard.equals(aggregatedPinComment.isStandard)) &&
        (this.link == null ? aggregatedPinComment.link == null : this.link.equals(aggregatedPinComment.link)) &&
        (this.media == null ? aggregatedPinComment.media == null : this.media.equals(aggregatedPinComment.media)) &&
        (this.parentPinId == null ? aggregatedPinComment.parentPinId == null : this.parentPinId.equals(aggregatedPinComment.parentPinId)) &&
        (this.pinMetrics == null ? aggregatedPinComment.pinMetrics == null : this.pinMetrics.equals(aggregatedPinComment.pinMetrics)) &&
        (this.title == null ? aggregatedPinComment.title == null : this.title.equals(aggregatedPinComment.title));
  }
