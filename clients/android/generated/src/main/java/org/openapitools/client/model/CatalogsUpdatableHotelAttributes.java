...
public class CatalogsUpdatableHotelAttributes {
  ...
  public boolean equals(Object o) {
    ...
    return (this.address == null ? catalogsUpdatableHotelAttributes.address == null : this.address.equals(catalogsUpdatableHotelAttributes.address)) &&
        (this.basePrice == null ? catalogsUpdatableHotelAttributes.basePrice == null : this.basePrice.equals(catalogsUpdatableHotelAttributes.basePrice)) &&
        (this.brand == null ? catalogsUpdatableHotelAttributes.brand == null : this.brand.equals(catalogsUpdatableHotelAttributes.brand)) &&
        (this.category == null ? catalogsUpdatableHotelAttributes.category == null : this.category.equals(catalogsUpdatableHotelAttributes.category)) &&
        (this.customLabel0 == null ? catalogsUpdatableHotelAttributes.customLabel0 == null : this.customLabel0.equals(catalogsUpdatableHotelAttributes.customLabel0)) &&
        (this.customLabel1 == null ? catalogsUpdatableHotelAttributes.customLabel1 == null : this.customLabel1.equals(catalogsUpdatableHotelAttributes.customLabel1)) &&
        (this.customLabel2 == null ? catalogsUpdatableHotelAttributes.customLabel2 == null : this.customLabel2.equals(catalogsUpdatableHotelAttributes.customLabel2)) &&
        (this.customLabel3 == null ? catalogsUpdatableHotelAttributes.customLabel3 == null : this.customLabel3.equals(catalogsUpdatableHotelAttributes.customLabel3)) &&
        (this.customLabel4 == null ? catalogsUpdatableHotelAttributes.customLabel4 == null : this.customLabel4.equals(catalogsUpdatableHotelAttributes.customLabel4)) &&
        (this.description == null ? catalogsUpdatableHotelAttributes.description == null : this.description.equals(catalogsUpdatableHotelAttributes.description)) &&
        (this.guestRatings == null ? catalogsUpdatableHotelAttributes.guestRatings == null : this.guestRatings.equals(catalogsUpdatableHotelAttributes.guestRatings)) &&
        (this.latitude == null ? catalogsUpdatableHotelAttributes.latitude == null : this.latitude.equals(catalogsUpdatableHotelAttributes.latitude)) &&
        (this.link == null ? catalogsUpdatableHotelAttributes.link == null : this.link.equals(catalogsUpdatableHotelAttributes.link)) &&
        (this.longitude == null ? catalogsUpdatableHotelAttributes.longitude == null : this.longitude.equals(catalogsUpdatableHotelAttributes.longitude)) &&
        (this.name == null ? catalogsUpdatableHotelAttributes.name == null : this.name.equals(catalogsUpdatableHotelAttributes.name)) &&
        (this.neighborhood == null ? catalogsUpdatableHotelAttributes.neighborhood == null : this.neighborhood.equals(catalogsUpdatableHotelAttributes.neighborhood)) &&
        (this.salePrice == null ? catalogsUpdatableHotelAttributes.salePrice == null : this.salePrice.equals(catalogsUpdatableHotelAttributes.salePrice));
  }
