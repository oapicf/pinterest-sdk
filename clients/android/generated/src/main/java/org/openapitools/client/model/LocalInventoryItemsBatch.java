...
public class LocalInventoryItemsBatch {
  ...
  public boolean equals(Object o) {
    ...
    return (this.batchId == null ? localInventoryItemsBatch.batchId == null : this.batchId.equals(localInventoryItemsBatch.batchId)) &&
        (this.completedTime == null ? localInventoryItemsBatch.completedTime == null : this.completedTime.equals(localInventoryItemsBatch.completedTime)) &&
        (this.createdTime == null ? localInventoryItemsBatch.createdTime == null : this.createdTime.equals(localInventoryItemsBatch.createdTime)) &&
        (this.operationResults == null ? localInventoryItemsBatch.operationResults == null : this.operationResults.equals(localInventoryItemsBatch.operationResults)) &&
        (this.status == null ? localInventoryItemsBatch.status == null : this.status.equals(localInventoryItemsBatch.status));
  }
