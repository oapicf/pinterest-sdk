...
public class CatalogsCreativeAssetsFeedsUpdateRequest {
  ...
  public boolean equals(Object o) {
    ...
    return (this.catalogType == null ? catalogsCreativeAssetsFeedsUpdateRequest.catalogType == null : this.catalogType.equals(catalogsCreativeAssetsFeedsUpdateRequest.catalogType)) &&
        (this.credentials == null ? catalogsCreativeAssetsFeedsUpdateRequest.credentials == null : this.credentials.equals(catalogsCreativeAssetsFeedsUpdateRequest.credentials)) &&
        (this.defaultCurrency == null ? catalogsCreativeAssetsFeedsUpdateRequest.defaultCurrency == null : this.defaultCurrency.equals(catalogsCreativeAssetsFeedsUpdateRequest.defaultCurrency)) &&
        (this.format == null ? catalogsCreativeAssetsFeedsUpdateRequest.format == null : this.format.equals(catalogsCreativeAssetsFeedsUpdateRequest.format)) &&
        (this.location == null ? catalogsCreativeAssetsFeedsUpdateRequest.location == null : this.location.equals(catalogsCreativeAssetsFeedsUpdateRequest.location)) &&
        (this.name == null ? catalogsCreativeAssetsFeedsUpdateRequest.name == null : this.name.equals(catalogsCreativeAssetsFeedsUpdateRequest.name)) &&
        (this.preferredProcessingSchedule == null ? catalogsCreativeAssetsFeedsUpdateRequest.preferredProcessingSchedule == null : this.preferredProcessingSchedule.equals(catalogsCreativeAssetsFeedsUpdateRequest.preferredProcessingSchedule)) &&
        (this.status == null ? catalogsCreativeAssetsFeedsUpdateRequest.status == null : this.status.equals(catalogsCreativeAssetsFeedsUpdateRequest.status));
  }
