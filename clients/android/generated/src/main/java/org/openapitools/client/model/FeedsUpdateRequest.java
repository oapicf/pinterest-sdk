...
public class FeedsUpdateRequest {
  ...
  public boolean equals(Object o) {
    ...
    return (this.defaultCurrency == null ? feedsUpdateRequest.defaultCurrency == null : this.defaultCurrency.equals(feedsUpdateRequest.defaultCurrency)) &&
        (this.name == null ? feedsUpdateRequest.name == null : this.name.equals(feedsUpdateRequest.name)) &&
        (this.format == null ? feedsUpdateRequest.format == null : this.format.equals(feedsUpdateRequest.format)) &&
        (this.credentials == null ? feedsUpdateRequest.credentials == null : this.credentials.equals(feedsUpdateRequest.credentials)) &&
        (this.location == null ? feedsUpdateRequest.location == null : this.location.equals(feedsUpdateRequest.location)) &&
        (this.preferredProcessingSchedule == null ? feedsUpdateRequest.preferredProcessingSchedule == null : this.preferredProcessingSchedule.equals(feedsUpdateRequest.preferredProcessingSchedule)) &&
        (this.status == null ? feedsUpdateRequest.status == null : this.status.equals(feedsUpdateRequest.status)) &&
        (this.catalogType == null ? feedsUpdateRequest.catalogType == null : this.catalogType.equals(feedsUpdateRequest.catalogType)) &&
        (this.defaultAvailability == null ? feedsUpdateRequest.defaultAvailability == null : this.defaultAvailability.equals(feedsUpdateRequest.defaultAvailability));
  }
