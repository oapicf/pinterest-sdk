...
List<InviteFilterStatus> inviteStatus = null; // List<InviteFilterStatus> | A list of invite statuses to filter invites by. Only invites whose status is in the provided statuses will be returned.
 ...
 **inviteStatus** | [**List&lt;InviteFilterStatus&gt;**](InviteFilterStatus.md)| A list of invite statuses to filter invites by. Only invites whose status is in the provided statuses will be returned. | [optional] [default to null]
