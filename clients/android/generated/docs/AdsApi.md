...
AdPreviewRequest adPreviewRequest = new AdPreviewRequest(); // AdPreviewRequest | 
try {
...
List<AdsAnalyticsAdTargetingType> targetingTypes = null; // List<AdsAnalyticsAdTargetingType> | Targeting type breakdowns for the report. The reporting per targeting type is independent from each other. [\"AGE_BUCKET_AND_GENDER\"] is in BETA and not yet available to all users.
...
ConversionAttributionWindowDays viewWindowDays = null; // ConversionAttributionWindowDays | Number of days to use as the conversion attribution window for a view action. Applies to Pinterest Tag conversion metrics. Prior conversion tags use their defined attribution windows. If not specified, defaults to `1` day.
ConversionReportTimeType conversionReportTime = null; // ConversionReportTimeType | The date by which the conversion metrics returned from this endpoint will be reported. There are two dates associated with a conversion event: the date that the user interacted with the ad, and the date that the user completed a conversion event.
...
try {
    MetricsResponse result = apiInstance.adTargetingAnalyticsGet(adAccountId, adIds, startDate, endDate, targetingTypes, columns, granularity, clickWindowDays, engagementWindowDays, viewWindowDays, conversionReportTime, attributionTypes, reportingTimezone, sortColumns, sortAscending);
    System.out.println(result);
} catch (ApiException e) {
 ...
 **targetingTypes** | [**List&lt;AdsAnalyticsAdTargetingType&gt;**](AdsAnalyticsAdTargetingType.md)| Targeting type breakdowns for the report. The reporting per targeting type is independent from each other. [\&quot;AGE_BUCKET_AND_GENDER\&quot;] is in BETA and not yet available to all users. | [default to null]
...
> List&lt;AdsAnalytics&gt; adsAnalytics(startDate, endDate, columns, granularity, adAccountId, pinIds, adIds, clickWindowDays, engagementWindowDays, viewWindowDays, conversionReportTime, campaignIds, reportingTimezone)
...
ReportingTimeZone reportingTimezone = null; // ReportingTimeZone | Specify the timezone to be applied for the reporting. This feature is currently in BETA and is not available to all users.
try {
    List<AdsAnalytics> result = apiInstance.adsAnalytics(startDate, endDate, columns, granularity, adAccountId, pinIds, adIds, clickWindowDays, engagementWindowDays, viewWindowDays, conversionReportTime, campaignIds, reportingTimezone);
    System.out.println(result);
} catch (ApiException e) {
...
AdsApi apiInstance = new AdsApi();
String adAccountId = null; // String | Unique identifier of an ad account.
List<AdCreate> adCreate = Arrays.asList(new AdCreate()); // List<AdCreate> | 
try {
    AdBatchWriteResponseModel result = apiInstance.adsCreate(adAccountId, adCreate);
    System.out.println(result);
} catch (ApiException e) {
...
AdsApi apiInstance = new AdsApi();
String adId = null; // String | The ID of this ad.
String adAccountId = null; // String | Unique identifier of an ad account.
try {
    Ad result = apiInstance.adsGet(adId, adAccountId);
    System.out.println(result);
} catch (ApiException e) {
...
try {
    AdsList200Response result = apiInstance.adsList(adAccountId, bookmark, pageSize, order, campaignIds, adGroupIds, adIds, entityStatuses);
    System.out.println(result);
} catch (ApiException e) {
...
AdsApi apiInstance = new AdsApi();
String adAccountId = null; // String | Unique identifier of an ad account.
List<AdBatchUpdate> adBatchUpdate = Arrays.asList(new AdBatchUpdate()); // List<AdBatchUpdate> | 
try {
    AdBatchWriteResponseModel result = apiInstance.adsUpdate(adAccountId, adBatchUpdate);
    System.out.println(result);
} catch (ApiException e) {
...
> List&lt;CampaignAdPreviewCreate200ResponseInner&gt; campaignAdPreviewCreate(adAccountId, campaignAdPreviewCreate)
...
AdsApi apiInstance = new AdsApi();
String adAccountId = null; // String | Unique identifier of an ad account.
List<CampaignAdPreviewCreate> campaignAdPreviewCreate = Arrays.asList(new CampaignAdPreviewCreate()); // List<CampaignAdPreviewCreate> | 
try {
    List<CampaignAdPreviewCreate200ResponseInner> result = apiInstance.campaignAdPreviewCreate(adAccountId, campaignAdPreviewCreate);
    System.out.println(result);
} catch (ApiException e) {
...
> List&lt;CampaignAdPreviewDelete200ResponseInner&gt; campaignAdPreviewDelete(adGroupIds, adAccountId)
...
String adAccountId = null; // String | Unique identifier of an ad account.
try {
    List<CampaignAdPreviewDelete200ResponseInner> result = apiInstance.campaignAdPreviewDelete(adGroupIds, adAccountId);
    System.out.println(result);
} catch (ApiException e) {
...
> List&lt;CampaignAdPreview&gt; campaignAdPreviewRead(adGroupIds, adAccountId)
...
String adAccountId = null; // String | Unique identifier of an ad account.
try {
    List<CampaignAdPreview> result = apiInstance.campaignAdPreviewRead(adGroupIds, adAccountId);
    System.out.println(result);
} catch (ApiException e) {
