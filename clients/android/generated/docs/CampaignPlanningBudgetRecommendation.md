...
------------ | ------------- | ------------- | -------------
**budgetRecommendation** | **Integer** | The recommended budget amount. |  [optional]
...
**lifetimeDaysRecommendation** | **Integer** | Recommended number of days for the campaign lifetime. |  [optional]
