...
------------ | ------------- | ------------- | -------------
**createdTime** | [**Date**](Date.md) | Timestamp when the conversion deletion request was succesfully created. |  [readonly]
**processedTime** | [**Date**](Date.md) | Timestamp when the conversion deletion request was processed. |  [optional] [readonly]
