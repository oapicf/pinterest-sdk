...
**createdTimestamp** | **Integer** | Creation time. Unix timestamp in seconds. |  [optional] [readonly]
...
**updatedTimestamp** | **Integer** | Last update time. Unix timestamp in seconds. |  [optional] [readonly]
