...
**attributionType** | [**OasAnyTypeNotMapped**](.md) | Attribution type for Brand/Category/SKU reports |  [optional]
...
**sortBy** | [**OasAnyTypeNotMapped**](.md) | Unified metric sort configuration |  [optional]
**type** | **String** | Type of the template |  [optional]
**updatedTime** | [**BigDecimal**](BigDecimal.md) | Time of last update in seconds since Unix epoch |  [optional] [readonly]
