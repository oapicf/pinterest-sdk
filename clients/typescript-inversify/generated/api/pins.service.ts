...
export class PinsService {
     ...
     */
    public pinsAnalytics(pinId: string, startDate: string, endDate: string, metricTypes: Array<'IMPRESSION' | 'SAVE' | 'PIN_CLICK' | 'OUTBOUND_CLICK' | 'VIDEO_MRC_VIEW' | 'VIDEO_AVG_WATCH_TIME' | 'VIDEO_V50_WATCH_TIME' | 'QUARTILE_95_PERCENT_VIEW'>, appTypes?: 'ALL' | 'MOBILE' | 'TABLET' | 'WEB', splitField?: 'NO_SPLIT' | 'APP_TYPE', adAccountId?: string, observe?: 'body', headers?: Headers): Observable<{ [key: string]: AnalyticsMetricsResponse; }>;
    public pinsAnalytics(pinId: string, startDate: string, endDate: string, metricTypes: Array<'IMPRESSION' | 'SAVE' | 'PIN_CLICK' | 'OUTBOUND_CLICK' | 'VIDEO_MRC_VIEW' | 'VIDEO_AVG_WATCH_TIME' | 'VIDEO_V50_WATCH_TIME' | 'QUARTILE_95_PERCENT_VIEW'>, appTypes?: 'ALL' | 'MOBILE' | 'TABLET' | 'WEB', splitField?: 'NO_SPLIT' | 'APP_TYPE', adAccountId?: string, observe?: 'response', headers?: Headers): Observable<HttpResponse<{ [key: string]: AnalyticsMetricsResponse; }>>;
    public pinsAnalytics(pinId: string, startDate: string, endDate: string, metricTypes: Array<'IMPRESSION' | 'SAVE' | 'PIN_CLICK' | 'OUTBOUND_CLICK' | 'VIDEO_MRC_VIEW' | 'VIDEO_AVG_WATCH_TIME' | 'VIDEO_V50_WATCH_TIME' | 'QUARTILE_95_PERCENT_VIEW'>, appTypes?: 'ALL' | 'MOBILE' | 'TABLET' | 'WEB', splitField?: 'NO_SPLIT' | 'APP_TYPE', adAccountId?: string, observe: any = 'body', headers: Headers = {}): Observable<any> {
        ...
        const response: Observable<HttpResponse<{ [key: string]: AnalyticsMetricsResponse; }>> = this.httpClient.get(`${this.basePath}/pins/${encodeURIComponent(String(pinId))}/analytics?${queryParameters.join('&')}`, headers);
        if (observe === 'body') {
     ...
     */
    public pinsCreate(pin: Pin, observe?: 'body', headers?: Headers): Observable<Pin>;
    public pinsCreate(pin: Pin, observe?: 'response', headers?: Headers): Observable<HttpResponse<Pin>>;
    public pinsCreate(pin: Pin, observe: any = 'body', headers: Headers = {}): Observable<any> {
        ...
        const response: Observable<HttpResponse<Pin>> = this.httpClient.post(`${this.basePath}/pins`, pin , headers);
        if (observe === 'body') {
               return response.pipe(
     ...
     */
    public pinsDelete(pinId: string, observe?: 'body', headers?: Headers): Observable<any>;
    public pinsDelete(pinId: string, observe?: 'response', headers?: Headers): Observable<HttpResponse<any>>;
    public pinsDelete(pinId: string, observe: any = 'body', headers: Headers = {}): Observable<any> {
        if (pinId === null || pinId === undefined){
        ...
        const response: Observable<HttpResponse<any>> = this.httpClient.delete(`${this.basePath}/pins/${encodeURIComponent(String(pinId))}`, headers);
        if (observe === 'body') {
               return response.pipe(
     ...
     */
    public pinsGet(pinId: string, adAccountId?: string, observe?: 'body', headers?: Headers): Observable<Pin>;
    public pinsGet(pinId: string, adAccountId?: string, observe?: 'response', headers?: Headers): Observable<HttpResponse<Pin>>;
    public pinsGet(pinId: string, adAccountId?: string, observe: any = 'body', headers: Headers = {}): Observable<any> {
        if (pinId === null || pinId === undefined){
