...
export class BoardsService {
     ...
     */
    public boardsListPins(boardId: string, bookmark?: string, pageSize?: number, creativeTypes?: Array<CreativeType>, adAccountId?: string, pinMetrics?: boolean, observe?: 'body', headers?: Headers): Observable<BoardsListPins200Response>;
    public boardsListPins(boardId: string, bookmark?: string, pageSize?: number, creativeTypes?: Array<CreativeType>, adAccountId?: string, pinMetrics?: boolean, observe?: 'response', headers?: Headers): Observable<HttpResponse<BoardsListPins200Response>>;
    public boardsListPins(boardId: string, bookmark?: string, pageSize?: number, creativeTypes?: Array<CreativeType>, adAccountId?: string, pinMetrics?: boolean, observe: any = 'body', headers: Headers = {}): Observable<any> {
        if (boardId === null || boardId === undefined){
