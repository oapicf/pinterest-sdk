...
export class BoardsService {
     ...
     */
    public boardSectionsCreate(boardId: string, boardSectionCreate: BoardSectionCreate, adAccountId?: string, observe?: 'body', headers?: Headers): Observable<BoardSection>;
    public boardSectionsCreate(boardId: string, boardSectionCreate: BoardSectionCreate, adAccountId?: string, observe?: 'response', headers?: Headers): Observable<HttpResponse<BoardSection>>;
    public boardSectionsCreate(boardId: string, boardSectionCreate: BoardSectionCreate, adAccountId?: string, observe: any = 'body', headers: Headers = {}): Observable<any> {
        ...
        const response: Observable<HttpResponse<BoardSection>> = this.httpClient.post(`${this.basePath}/boards/${encodeURIComponent(String(boardId))}/sections?${queryParameters.join('&')}`, boardSectionCreate , headers);
        if (observe === 'body') {
     ...
     */
    public boardSectionsDelete(boardId: string, sectionId: string, adAccountId?: string, observe?: 'body', headers?: Headers): Observable<BoardSection>;
    public boardSectionsDelete(boardId: string, sectionId: string, adAccountId?: string, observe?: 'response', headers?: Headers): Observable<HttpResponse<BoardSection>>;
    public boardSectionsDelete(boardId: string, sectionId: string, adAccountId?: string, observe: any = 'body', headers: Headers = {}): Observable<any> {
        ...
        const response: Observable<HttpResponse<BoardSection>> = this.httpClient.delete(`${this.basePath}/boards/${encodeURIComponent(String(boardId))}/sections/${encodeURIComponent(String(sectionId))}?${queryParameters.join('&')}`, headers);
        if (observe === 'body') {
               return response.pipe(
                   map((httpResponse: HttpResponse) => <BoardSection>(httpResponse.response))
               );
     ...
     */
    public boardSectionsUpdate(boardId: string, sectionId: string, boardSectionUpdateWithRequiredBody: BoardSectionUpdateWithRequiredBody, adAccountId?: string, observe?: 'body', headers?: Headers): Observable<BoardSection>;
    public boardSectionsUpdate(boardId: string, sectionId: string, boardSectionUpdateWithRequiredBody: BoardSectionUpdateWithRequiredBody, adAccountId?: string, observe?: 'response', headers?: Headers): Observable<HttpResponse<BoardSection>>;
    public boardSectionsUpdate(boardId: string, sectionId: string, boardSectionUpdateWithRequiredBody: BoardSectionUpdateWithRequiredBody, adAccountId?: string, observe: any = 'body', headers: Headers = {}): Observable<any> {
        if (boardId === null || boardId === undefined){
        ...
        const response: Observable<HttpResponse<BoardSection>> = this.httpClient.patch(`${this.basePath}/boards/${encodeURIComponent(String(boardId))}/sections/${encodeURIComponent(String(sectionId))}?${queryParameters.join('&')}`, boardSectionUpdateWithRequiredBody , headers);
        if (observe === 'body') {
               return response.pipe(
                   map((httpResponse: HttpResponse) => <BoardSection>(httpResponse.response))
               );
     ...
     */
    public boardsCreate(boardCreate: BoardCreate, adAccountId?: string, observe?: 'body', headers?: Headers): Observable<Board>;
    public boardsCreate(boardCreate: BoardCreate, adAccountId?: string, observe?: 'response', headers?: Headers): Observable<HttpResponse<Board>>;
    public boardsCreate(boardCreate: BoardCreate, adAccountId?: string, observe: any = 'body', headers: Headers = {}): Observable<any> {
        ...
        const response: Observable<HttpResponse<Board>> = this.httpClient.post(`${this.basePath}/boards?${queryParameters.join('&')}`, boardCreate , headers);
        if (observe === 'body') {
               return response.pipe(
     ...
     */
    public boardsDelete(boardId: string, adAccountId?: string, observe?: 'body', headers?: Headers): Observable<Board>;
    public boardsDelete(boardId: string, adAccountId?: string, observe?: 'response', headers?: Headers): Observable<HttpResponse<Board>>;
    public boardsDelete(boardId: string, adAccountId?: string, observe: any = 'body', headers: Headers = {}): Observable<any> {
        ...
        const response: Observable<HttpResponse<Board>> = this.httpClient.delete(`${this.basePath}/boards/${encodeURIComponent(String(boardId))}?${queryParameters.join('&')}`, headers);
        if (observe === 'body') {
               return response.pipe(
                   map((httpResponse: HttpResponse) => <Board>(httpResponse.response))
               );
     ...
     */
    public boardsList(adAccountId?: string, privacy?: BoardPrivacyFilter, bookmark?: string, pageSize?: number, observe?: 'body', headers?: Headers): Observable<BoardsList200Response>;
    public boardsList(adAccountId?: string, privacy?: BoardPrivacyFilter, bookmark?: string, pageSize?: number, observe?: 'response', headers?: Headers): Observable<HttpResponse<BoardsList200Response>>;
    public boardsList(adAccountId?: string, privacy?: BoardPrivacyFilter, bookmark?: string, pageSize?: number, observe: any = 'body', headers: Headers = {}): Observable<any> {
        let queryParameters: string[] = [];
        if (adAccountId !== undefined) {
            queryParameters.push('adAccountId='+encodeURIComponent(String(adAccountId)));
        }
     ...
     */
    public boardsListPins(boardId: string, creativeTypes?: Array<CreativeType>, adAccountId?: string, pinMetrics?: boolean, bookmark?: string, pageSize?: number, observe?: 'body', headers?: Headers): Observable<BoardsListPins200Response>;
    public boardsListPins(boardId: string, creativeTypes?: Array<CreativeType>, adAccountId?: string, pinMetrics?: boolean, bookmark?: string, pageSize?: number, observe?: 'response', headers?: Headers): Observable<HttpResponse<BoardsListPins200Response>>;
    public boardsListPins(boardId: string, creativeTypes?: Array<CreativeType>, adAccountId?: string, pinMetrics?: boolean, bookmark?: string, pageSize?: number, observe: any = 'body', headers: Headers = {}): Observable<any> {
        if (boardId === null || boardId === undefined){
     ...
     */
    public boardsUpdate(boardId: string, boardWithUpdatePrivacyUpdate: BoardWithUpdatePrivacyUpdate, adAccountId?: string, observe?: 'body', headers?: Headers): Observable<BoardWithUpdatePrivacy>;
    public boardsUpdate(boardId: string, boardWithUpdatePrivacyUpdate: BoardWithUpdatePrivacyUpdate, adAccountId?: string, observe?: 'response', headers?: Headers): Observable<HttpResponse<BoardWithUpdatePrivacy>>;
    public boardsUpdate(boardId: string, boardWithUpdatePrivacyUpdate: BoardWithUpdatePrivacyUpdate, adAccountId?: string, observe: any = 'body', headers: Headers = {}): Observable<any> {
        if (boardId === null || boardId === undefined){
        ...
        const response: Observable<HttpResponse<BoardWithUpdatePrivacy>> = this.httpClient.patch(`${this.basePath}/boards/${encodeURIComponent(String(boardId))}?${queryParameters.join('&')}`, boardWithUpdatePrivacyUpdate , headers);
        if (observe === 'body') {
               return response.pipe(
                   map((httpResponse: HttpResponse) => <BoardWithUpdatePrivacy>(httpResponse.response))
               );
        }
        return response;
    }
