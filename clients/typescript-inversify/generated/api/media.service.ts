...
export class MediaService {
     ...
     */
    public mediaList(bookmark?: string, pageSize?: number, observe?: 'body', headers?: Headers): Observable<Paginated & object>;
    public mediaList(bookmark?: string, pageSize?: number, observe?: 'response', headers?: Headers): Observable<HttpResponse<Paginated & object>>;
    public mediaList(bookmark?: string, pageSize?: number, observe: any = 'body', headers: Headers = {}): Observable<any> {
        ...
        const response: Observable<HttpResponse<Paginated & object>> = this.httpClient.get(`${this.basePath}/media?${queryParameters.join('&')}`, headers);
        if (observe === 'body') {
               return response.pipe(
