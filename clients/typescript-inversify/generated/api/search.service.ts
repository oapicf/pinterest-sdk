...
export class SearchService {
     ...
     */
    public searchUserPinsList(query: string, adAccountId?: string, bookmark?: string, observe?: 'body', headers?: Headers): Observable<SearchUserPinsList200Response>;
    public searchUserPinsList(query: string, adAccountId?: string, bookmark?: string, observe?: 'response', headers?: Headers): Observable<HttpResponse<SearchUserPinsList200Response>>;
    public searchUserPinsList(query: string, adAccountId?: string, bookmark?: string, observe: any = 'body', headers: Headers = {}): Observable<any> {
        ...
        const response: Observable<HttpResponse<SearchUserPinsList200Response>> = this.httpClient.get(`${this.basePath}/search/pins?${queryParameters.join('&')}`, headers);
        if (observe === 'body') {
               return response.pipe(
                   map((httpResponse: HttpResponse) => <SearchUserPinsList200Response>(httpResponse.response))
               );
        }
        return response;
    }
