...
export class SearchService {
     ...
     */
    public searchUserBoardsGet(adAccountId?: string, query?: string, bookmark?: string, pageSize?: number, observe?: 'body', headers?: Headers): Observable<BoardsList200Response>;
    public searchUserBoardsGet(adAccountId?: string, query?: string, bookmark?: string, pageSize?: number, observe?: 'response', headers?: Headers): Observable<HttpResponse<BoardsList200Response>>;
    public searchUserBoardsGet(adAccountId?: string, query?: string, bookmark?: string, pageSize?: number, observe: any = 'body', headers: Headers = {}): Observable<any> {
        let queryParameters: string[] = [];
        ...
        const response: Observable<HttpResponse<BoardsList200Response>> = this.httpClient.get(`${this.basePath}/search/boards?${queryParameters.join('&')}`, headers);
        if (observe === 'body') {
               return response.pipe(
