...
export class AdAccountsService {
     ...
     */
    public analyticsCreateConversionProductReport(adAccountId: string, conversionProductReportRequest: ConversionProductReportRequest, observe?: 'body', headers?: Headers): Observable<AdsAnalyticsCreateAsyncResponse>;
    public analyticsCreateConversionProductReport(adAccountId: string, conversionProductReportRequest: ConversionProductReportRequest, observe?: 'response', headers?: Headers): Observable<HttpResponse<AdsAnalyticsCreateAsyncResponse>>;
    public analyticsCreateConversionProductReport(adAccountId: string, conversionProductReportRequest: ConversionProductReportRequest, observe: any = 'body', headers: Headers = {}): Observable<any> {
        if (adAccountId === null || adAccountId === undefined){
        ...
        const response: Observable<HttpResponse<AdsAnalyticsCreateAsyncResponse>> = this.httpClient.post(`${this.basePath}/ad_accounts/${encodeURIComponent(String(adAccountId))}/reports/brand_category_sku`, conversionProductReportRequest , headers);
        if (observe === 'body') {
               return response.pipe(
     ...
     */
    public analyticsGetConversionProductReport(adAccountId: string, token: string, observe?: 'body', headers?: Headers): Observable<AdsAnalyticsGetAsyncResponse>;
    public analyticsGetConversionProductReport(adAccountId: string, token: string, observe?: 'response', headers?: Headers): Observable<HttpResponse<AdsAnalyticsGetAsyncResponse>>;
    public analyticsGetConversionProductReport(adAccountId: string, token: string, observe: any = 'body', headers: Headers = {}): Observable<any> {
        ...
        const response: Observable<HttpResponse<AdsAnalyticsGetAsyncResponse>> = this.httpClient.get(`${this.basePath}/ad_accounts/${encodeURIComponent(String(adAccountId))}/reports/brand_category_sku?${queryParameters.join('&')}`, headers);
        if (observe === 'body') {
               return response.pipe(
