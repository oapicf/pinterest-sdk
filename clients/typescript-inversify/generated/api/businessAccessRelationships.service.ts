...
export class BusinessAccessRelationshipsService {
     ...
     */
    public brandAccountsCreate(businessHierarchyId: string, brandAccountsCreateRequest: BrandAccountsCreateRequest, observe?: 'body', headers?: Headers): Observable<BrandAccountsCreate200Response>;
    public brandAccountsCreate(businessHierarchyId: string, brandAccountsCreateRequest: BrandAccountsCreateRequest, observe?: 'response', headers?: Headers): Observable<HttpResponse<BrandAccountsCreate200Response>>;
    public brandAccountsCreate(businessHierarchyId: string, brandAccountsCreateRequest: BrandAccountsCreateRequest, observe: any = 'body', headers: Headers = {}): Observable<any> {
        ...
        const response: Observable<HttpResponse<BrandAccountsCreate200Response>> = this.httpClient.post(`${this.basePath}/business_access/business_hierarchy/${encodeURIComponent(String(businessHierarchyId))}/brand_accounts`, brandAccountsCreateRequest , headers);
        if (observe === 'body') {
               return response.pipe(
                   map((httpResponse: HttpResponse) => <BrandAccountsCreate200Response>(httpResponse.response))
               );
        }
        return response;
    }
     ...
     */
    public brandAccountsUpdate(businessHierarchyId: string, brandAccountId: string, brandAccountsUpdateRequest: BrandAccountsUpdateRequest, observe?: 'body', headers?: Headers): Observable<BrandAccountsCreate200Response>;
    public brandAccountsUpdate(businessHierarchyId: string, brandAccountId: string, brandAccountsUpdateRequest: BrandAccountsUpdateRequest, observe?: 'response', headers?: Headers): Observable<HttpResponse<BrandAccountsCreate200Response>>;
    public brandAccountsUpdate(businessHierarchyId: string, brandAccountId: string, brandAccountsUpdateRequest: BrandAccountsUpdateRequest, observe: any = 'body', headers: Headers = {}): Observable<any> {
        if (businessHierarchyId === null || businessHierarchyId === undefined){
        ...
        const response: Observable<HttpResponse<BrandAccountsCreate200Response>> = this.httpClient.patch(`${this.basePath}/business_access/business_hierarchy/${encodeURIComponent(String(businessHierarchyId))}/brand_accounts/${encodeURIComponent(String(brandAccountId))}`, brandAccountsUpdateRequest , headers);
        if (observe === 'body') {
               return response.pipe(
                   map((httpResponse: HttpResponse) => <BrandAccountsCreate200Response>(httpResponse.response))
               );
     ...
     */
    public getBusinessMembers(businessId: string, fetchSystemUsers?: boolean, assetsSummary?: boolean, businessRoles?: Array<MemberBusinessRole>, memberIds?: string, startIndex?: number, bookmark?: string, pageSize?: number, observe?: 'body', headers?: Headers): Observable<GetBusinessMembers200Response>;
    public getBusinessMembers(businessId: string, fetchSystemUsers?: boolean, assetsSummary?: boolean, businessRoles?: Array<MemberBusinessRole>, memberIds?: string, startIndex?: number, bookmark?: string, pageSize?: number, observe?: 'response', headers?: Headers): Observable<HttpResponse<GetBusinessMembers200Response>>;
     ...
     */
    public systemUserUpdate(businessId: string, systemUserId: string, systemUserUpdateRequest: SystemUserUpdateRequest, observe?: 'body', headers?: Headers): Observable<any>;
    public systemUserUpdate(businessId: string, systemUserId: string, systemUserUpdateRequest: SystemUserUpdateRequest, observe?: 'response', headers?: Headers): Observable<HttpResponse<any>>;
    public systemUserUpdate(businessId: string, systemUserId: string, systemUserUpdateRequest: SystemUserUpdateRequest, observe: any = 'body', headers: Headers = {}): Observable<any> {
        if (businessId === null || businessId === undefined){
        ...
        const response: Observable<HttpResponse<any>> = this.httpClient.patch(`${this.basePath}/businesses/${encodeURIComponent(String(businessId))}/system_users/${encodeURIComponent(String(systemUserId))}`, systemUserUpdateRequest , headers);
        if (observe === 'body') {
               return response.pipe(
