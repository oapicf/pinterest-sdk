...
export class UserAccountService {
     ...
     */
    public verifyWebsiteUpdate(userWebsiteVerifyRequest: UserWebsiteVerifyRequest, observe?: 'body', headers?: Headers): Observable<UserWebsiteSummary>;
    public verifyWebsiteUpdate(userWebsiteVerifyRequest: UserWebsiteVerifyRequest, observe?: 'response', headers?: Headers): Observable<HttpResponse<UserWebsiteSummary>>;
    public verifyWebsiteUpdate(userWebsiteVerifyRequest: UserWebsiteVerifyRequest, observe: any = 'body', headers: Headers = {}): Observable<any> {
        ...
        const response: Observable<HttpResponse<UserWebsiteSummary>> = this.httpClient.post(`${this.basePath}/user_account/websites`, userWebsiteVerifyRequest , headers);
        if (observe === 'body') {
               return response.pipe(
     ...
     */
    public websiteVerificationGet(observe?: 'body', headers?: Headers): Observable<UserWebsiteVerificationCode>;
    public websiteVerificationGet(observe?: 'response', headers?: Headers): Observable<HttpResponse<UserWebsiteVerificationCode>>;
    public websiteVerificationGet(observe: any = 'body', headers: Headers = {}): Observable<any> {
        // authentication (pinterest_oauth2) required
        if (this.APIConfiguration.accessToken) {
            let accessToken = typeof this.APIConfiguration.accessToken === 'function'
                ? this.APIConfiguration.accessToken()
        ...
        const response: Observable<HttpResponse<UserWebsiteVerificationCode>> = this.httpClient.get(`${this.basePath}/user_account/websites/verification`, headers);
        if (observe === 'body') {
               return response.pipe(
