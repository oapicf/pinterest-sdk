...
export class AdGroupsService {
    ...
    public adGroupsAudienceSizing(adAccountId: string, adGroupAudienceSizingRequest?: AdGroupAudienceSizingRequest, observe: any = 'body', headers: Headers = {}): Observable<any> {
        ...
        const response: Observable<HttpResponse<AdGroupAudienceSizingResponse>> = this.httpClient.get(`${this.basePath}/ad_accounts/${encodeURIComponent(String(adAccountId))}/ad_groups/audience_sizing`, adGroupAudienceSizingRequest , headers);
        if (observe === 'body') {
               return response.pipe(
