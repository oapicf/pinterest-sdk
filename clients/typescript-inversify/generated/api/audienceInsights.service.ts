...
export class AudienceInsightsService {
     ...
     */
    public audienceInsightsGet(adAccountId: string, audienceInsightType: AudienceInsightType, observe?: 'body', headers?: Headers): Observable<AudienceInsights>;
    public audienceInsightsGet(adAccountId: string, audienceInsightType: AudienceInsightType, observe?: 'response', headers?: Headers): Observable<HttpResponse<AudienceInsights>>;
    public audienceInsightsGet(adAccountId: string, audienceInsightType: AudienceInsightType, observe: any = 'body', headers: Headers = {}): Observable<any> {
        ...
        const response: Observable<HttpResponse<AudienceInsights>> = this.httpClient.get(`${this.basePath}/ad_accounts/${encodeURIComponent(String(adAccountId))}/audience_insights?${queryParameters.join('&')}`, headers);
        if (observe === 'body') {
               return response.pipe(
                   map((httpResponse: HttpResponse) => <AudienceInsights>(httpResponse.response))
               );
        }
        return response;
    }
     ...
     */
    public audienceInsightsScopeAndTypeGet(adAccountId: string, observe?: 'body', headers?: Headers): Observable<AudienceInsightsScopeAndTypeGet200Response>;
    public audienceInsightsScopeAndTypeGet(adAccountId: string, observe?: 'response', headers?: Headers): Observable<HttpResponse<AudienceInsightsScopeAndTypeGet200Response>>;
    public audienceInsightsScopeAndTypeGet(adAccountId: string, observe: any = 'body', headers: Headers = {}): Observable<any> {
        ...
        const response: Observable<HttpResponse<AudienceInsightsScopeAndTypeGet200Response>> = this.httpClient.get(`${this.basePath}/ad_accounts/${encodeURIComponent(String(adAccountId))}/insights/audiences`, headers);
        if (observe === 'body') {
               return response.pipe(
                   map((httpResponse: HttpResponse) => <AudienceInsightsScopeAndTypeGet200Response>(httpResponse.response))
               );
        }
        return response;
    }
