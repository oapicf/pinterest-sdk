...
export class BusinessAccessInviteService {
     ...
     */
    public cancelInvitesOrRequests(businessId: string, cancelInvitesRequest: CancelInvitesRequest, observe?: 'body', headers?: Headers): Observable<CancelInvitesResponse>;
    public cancelInvitesOrRequests(businessId: string, cancelInvitesRequest: CancelInvitesRequest, observe?: 'response', headers?: Headers): Observable<HttpResponse<CancelInvitesResponse>>;
    public cancelInvitesOrRequests(businessId: string, cancelInvitesRequest: CancelInvitesRequest, observe: any = 'body', headers: Headers = {}): Observable<any> {
        if (businessId === null || businessId === undefined){
        ...
        const response: Observable<HttpResponse<CancelInvitesResponse>> = this.httpClient.delete(`${this.basePath}/businesses/${encodeURIComponent(String(businessId))}/invites`, cancelInvitesRequest , headers);
        if (observe === 'body') {
               return response.pipe(
                   map((httpResponse: HttpResponse) => <CancelInvitesResponse>(httpResponse.response))
               );
        }
        return response;
    }
     ...
     */
    public getInvites(businessId: string, isMember?: boolean, inviteStatus?: Array<InviteFilterStatus>, inviteType?: InviteType, bookmark?: string, pageSize?: number, observe?: 'body', headers?: Headers): Observable<GetInvites200Response>;
    public getInvites(businessId: string, isMember?: boolean, inviteStatus?: Array<InviteFilterStatus>, inviteType?: InviteType, bookmark?: string, pageSize?: number, observe?: 'response', headers?: Headers): Observable<HttpResponse<GetInvites200Response>>;
    public getInvites(businessId: string, isMember?: boolean, inviteStatus?: Array<InviteFilterStatus>, inviteType?: InviteType, bookmark?: string, pageSize?: number, observe: any = 'body', headers: Headers = {}): Observable<any> {
        if (businessId === null || businessId === undefined){
