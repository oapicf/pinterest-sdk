...
export class ConversionTagsService {
     ...
     */
    public pageVisitConversionTagsGet(adAccountId: string, bookmark?: string, pageSize?: number, order?: PinterestLibPaginationOrder, observe?: 'body', headers?: Headers): Observable<PageVisitConversionTagsGet200Response>;
    public pageVisitConversionTagsGet(adAccountId: string, bookmark?: string, pageSize?: number, order?: PinterestLibPaginationOrder, observe?: 'response', headers?: Headers): Observable<HttpResponse<PageVisitConversionTagsGet200Response>>;
    public pageVisitConversionTagsGet(adAccountId: string, bookmark?: string, pageSize?: number, order?: PinterestLibPaginationOrder, observe: any = 'body', headers: Headers = {}): Observable<any> {
        if (adAccountId === null || adAccountId === undefined){
