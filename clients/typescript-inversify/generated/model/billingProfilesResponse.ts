...
export namespace BillingProfilesResponse {
    export type BillingTypeEnum = 'CREDIT_CARD' | 'INVOICE' | 'INTERNAL' | 'RECURRING' | 'PREPAID';
    export const BillingTypeEnum = {
        CreditCard: 'CREDIT_CARD' as BillingTypeEnum,
        Invoice: 'INVOICE' as BillingTypeEnum,
        Internal: 'INTERNAL' as BillingTypeEnum,
        Recurring: 'RECURRING' as BillingTypeEnum,
        Prepaid: 'PREPAID' as BillingTypeEnum
    }
