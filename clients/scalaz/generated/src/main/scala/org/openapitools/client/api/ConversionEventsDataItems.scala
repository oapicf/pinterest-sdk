...
import ConversionEventsDataItems._
...
customData: Option[ConversionEventsDataItemsCustomData],
...
object ConversionEventsDataItems {
  ...
  implicit val ConversionEventsDataItemsCodecJson: CodecJson[ConversionEventsDataItems] = CodecJson.derive[ConversionEventsDataItems]
  implicit val ConversionEventsDataItemsDecoder: EntityDecoder[ConversionEventsDataItems] = jsonOf[ConversionEventsDataItems]
  implicit val ConversionEventsDataItemsEncoder: EntityEncoder[ConversionEventsDataItems] = jsonEncoderOf[ConversionEventsDataItems]
}
