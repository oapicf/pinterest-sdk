...
object AdGroupCreate {
  ...
  implicit val AdGroupCreateCodecJson: CodecJson[AdGroupCreate] = CodecJson.derive[AdGroupCreate]
  implicit val AdGroupCreateDecoder: EntityDecoder[AdGroupCreate] = jsonOf[AdGroupCreate]
  implicit val AdGroupCreateEncoder: EntityEncoder[AdGroupCreate] = jsonEncoderOf[AdGroupCreate]
}
