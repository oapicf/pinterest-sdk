...
import ConversionEventsUserDataProperties._
...
object ConversionEventsUserDataProperties {
  ...
  implicit val ConversionEventsUserDataPropertiesCodecJson: CodecJson[ConversionEventsUserDataProperties] = CodecJson.derive[ConversionEventsUserDataProperties]
  implicit val ConversionEventsUserDataPropertiesDecoder: EntityDecoder[ConversionEventsUserDataProperties] = jsonOf[ConversionEventsUserDataProperties]
  implicit val ConversionEventsUserDataPropertiesEncoder: EntityEncoder[ConversionEventsUserDataProperties] = jsonEncoderOf[ConversionEventsUserDataProperties]
}
