...
import AdAccountsAudienceRule._
...
object AdAccountsAudienceRule {
  ...
  implicit val AdAccountsAudienceRuleCodecJson: CodecJson[AdAccountsAudienceRule] = CodecJson.derive[AdAccountsAudienceRule]
  implicit val AdAccountsAudienceRuleDecoder: EntityDecoder[AdAccountsAudienceRule] = jsonOf[AdAccountsAudienceRule]
  implicit val AdAccountsAudienceRuleEncoder: EntityEncoder[AdAccountsAudienceRule] = jsonEncoderOf[AdAccountsAudienceRule]
}
