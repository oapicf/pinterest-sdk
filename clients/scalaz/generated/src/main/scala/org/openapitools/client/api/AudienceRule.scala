...
object AudienceRule {
  ...
  implicit val AudienceRuleCodecJson: CodecJson[AudienceRule] = CodecJson.derive[AudienceRule]
  implicit val AudienceRuleDecoder: EntityDecoder[AudienceRule] = jsonOf[AudienceRule]
  implicit val AudienceRuleEncoder: EntityEncoder[AudienceRule] = jsonEncoderOf[AudienceRule]
}
