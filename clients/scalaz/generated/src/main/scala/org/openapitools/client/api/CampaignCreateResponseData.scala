...
import CampaignCreateResponseData._
...
object CampaignCreateResponseData {
  ...
  implicit val CampaignCreateResponseDataCodecJson: CodecJson[CampaignCreateResponseData] = CodecJson.derive[CampaignCreateResponseData]
  implicit val CampaignCreateResponseDataDecoder: EntityDecoder[CampaignCreateResponseData] = jsonOf[CampaignCreateResponseData]
  implicit val CampaignCreateResponseDataEncoder: EntityEncoder[CampaignCreateResponseData] = jsonEncoderOf[CampaignCreateResponseData]
}
