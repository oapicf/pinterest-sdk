...
import ConversionEventsDataInnerCustomData._
...
object ConversionEventsDataInnerCustomData {
  ...
  implicit val ConversionEventsDataInnerCustomDataCodecJson: CodecJson[ConversionEventsDataInnerCustomData] = CodecJson.derive[ConversionEventsDataInnerCustomData]
  implicit val ConversionEventsDataInnerCustomDataDecoder: EntityDecoder[ConversionEventsDataInnerCustomData] = jsonOf[ConversionEventsDataInnerCustomData]
  implicit val ConversionEventsDataInnerCustomDataEncoder: EntityEncoder[ConversionEventsDataInnerCustomData] = jsonEncoderOf[ConversionEventsDataInnerCustomData]
}
