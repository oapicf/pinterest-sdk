...
import CampaignBatchUpdateItem._
...
object CampaignBatchUpdateItem {
  ...
  implicit val CampaignBatchUpdateItemCodecJson: CodecJson[CampaignBatchUpdateItem] = CodecJson.derive[CampaignBatchUpdateItem]
  implicit val CampaignBatchUpdateItemDecoder: EntityDecoder[CampaignBatchUpdateItem] = jsonOf[CampaignBatchUpdateItem]
  implicit val CampaignBatchUpdateItemEncoder: EntityEncoder[CampaignBatchUpdateItem] = jsonEncoderOf[CampaignBatchUpdateItem]
}
