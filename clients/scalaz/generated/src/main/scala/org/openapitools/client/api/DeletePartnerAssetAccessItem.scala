...
import DeletePartnerAssetAccessItem._
...
object DeletePartnerAssetAccessItem {
  ...
  implicit val DeletePartnerAssetAccessItemCodecJson: CodecJson[DeletePartnerAssetAccessItem] = CodecJson.derive[DeletePartnerAssetAccessItem]
  implicit val DeletePartnerAssetAccessItemDecoder: EntityDecoder[DeletePartnerAssetAccessItem] = jsonOf[DeletePartnerAssetAccessItem]
  implicit val DeletePartnerAssetAccessItemEncoder: EntityEncoder[DeletePartnerAssetAccessItem] = jsonEncoderOf[DeletePartnerAssetAccessItem]
}
