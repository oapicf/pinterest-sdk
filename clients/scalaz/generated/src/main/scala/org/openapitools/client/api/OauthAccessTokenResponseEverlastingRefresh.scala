...
import OauthAccessTokenResponseEverlastingRefresh._
...
object OauthAccessTokenResponseEverlastingRefresh {
  ...
  implicit val OauthAccessTokenResponseEverlastingRefreshCodecJson: CodecJson[OauthAccessTokenResponseEverlastingRefresh] = CodecJson.derive[OauthAccessTokenResponseEverlastingRefresh]
  implicit val OauthAccessTokenResponseEverlastingRefreshDecoder: EntityDecoder[OauthAccessTokenResponseEverlastingRefresh] = jsonOf[OauthAccessTokenResponseEverlastingRefresh]
  implicit val OauthAccessTokenResponseEverlastingRefreshEncoder: EntityEncoder[OauthAccessTokenResponseEverlastingRefresh] = jsonEncoderOf[OauthAccessTokenResponseEverlastingRefresh]
}
