...
object AdGroup {
  ...
  implicit val AdGroupCodecJson: CodecJson[AdGroup] = CodecJson.derive[AdGroup]
  implicit val AdGroupDecoder: EntityDecoder[AdGroup] = jsonOf[AdGroup]
  implicit val AdGroupEncoder: EntityEncoder[AdGroup] = jsonEncoderOf[AdGroup]
}
