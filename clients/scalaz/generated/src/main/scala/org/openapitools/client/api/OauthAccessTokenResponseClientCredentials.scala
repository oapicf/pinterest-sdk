...
import OauthAccessTokenResponseClientCredentials._
...
object OauthAccessTokenResponseClientCredentials {
  ...
  implicit val OauthAccessTokenResponseClientCredentialsCodecJson: CodecJson[OauthAccessTokenResponseClientCredentials] = CodecJson.derive[OauthAccessTokenResponseClientCredentials]
  implicit val OauthAccessTokenResponseClientCredentialsDecoder: EntityDecoder[OauthAccessTokenResponseClientCredentials] = jsonOf[OauthAccessTokenResponseClientCredentials]
  implicit val OauthAccessTokenResponseClientCredentialsEncoder: EntityEncoder[OauthAccessTokenResponseClientCredentials] = jsonEncoderOf[OauthAccessTokenResponseClientCredentials]
}
