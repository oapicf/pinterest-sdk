...
import CatalogsHotelBatchItem._
...
object CatalogsHotelBatchItem {
  ...
  implicit val CatalogsHotelBatchItemCodecJson: CodecJson[CatalogsHotelBatchItem] = CodecJson.derive[CatalogsHotelBatchItem]
  implicit val CatalogsHotelBatchItemDecoder: EntityDecoder[CatalogsHotelBatchItem] = jsonOf[CatalogsHotelBatchItem]
  implicit val CatalogsHotelBatchItemEncoder: EntityEncoder[CatalogsHotelBatchItem] = jsonEncoderOf[CatalogsHotelBatchItem]
}
