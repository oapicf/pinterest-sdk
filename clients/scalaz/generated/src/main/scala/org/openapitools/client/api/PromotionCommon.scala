...
object PromotionCommon {
  ...
  implicit val PromotionCommonCodecJson: CodecJson[PromotionCommon] = CodecJson.derive[PromotionCommon]
  implicit val PromotionCommonDecoder: EntityDecoder[PromotionCommon] = jsonOf[PromotionCommon]
  implicit val PromotionCommonEncoder: EntityEncoder[PromotionCommon] = jsonEncoderOf[PromotionCommon]
}
