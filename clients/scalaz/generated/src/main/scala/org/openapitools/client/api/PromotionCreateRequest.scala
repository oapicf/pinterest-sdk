...
import PromotionCreateRequest._
...
object PromotionCreateRequest {
  ...
  implicit val PromotionCreateRequestCodecJson: CodecJson[PromotionCreateRequest] = CodecJson.derive[PromotionCreateRequest]
  implicit val PromotionCreateRequestDecoder: EntityDecoder[PromotionCreateRequest] = jsonOf[PromotionCreateRequest]
  implicit val PromotionCreateRequestEncoder: EntityEncoder[PromotionCreateRequest] = jsonEncoderOf[PromotionCreateRequest]
}
