...
object CatalogsReportFeedIngestionStats {
  ...
  implicit val CatalogsReportFeedIngestionStatsCodecJson: CodecJson[CatalogsReportFeedIngestionStats] = CodecJson.derive[CatalogsReportFeedIngestionStats]
  implicit val CatalogsReportFeedIngestionStatsDecoder: EntityDecoder[CatalogsReportFeedIngestionStats] = jsonOf[CatalogsReportFeedIngestionStats]
  implicit val CatalogsReportFeedIngestionStatsEncoder: EntityEncoder[CatalogsReportFeedIngestionStats] = jsonEncoderOf[CatalogsReportFeedIngestionStats]
}
