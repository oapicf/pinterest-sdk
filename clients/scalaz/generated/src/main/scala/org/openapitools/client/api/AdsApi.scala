...
object AdsApi {
  ...
  def adsAnalytics(host: String, adAccountId: String, startDate: LocalDate, endDate: LocalDate, columns: List[String] = List.empty[String] , granularity: Granularity, adIds: List[String] = List.empty[String] , clickWindowDays: Integer = 30, engagementWindowDays: Integer = 30, viewWindowDays: Integer = 1, conversionReportTime: String = TIME_OF_AD_ACTION, pinIds: List[String] = List.empty[String] , campaignIds: List[String] = List.empty[String] , reportingTimezone: ReportingTimeZone)(implicit startDateQuery: QueryParam[LocalDate], endDateQuery: QueryParam[LocalDate], adIdsQuery: QueryParam[List[String]], columnsQuery: QueryParam[List[String]], granularityQuery: QueryParam[Granularity], clickWindowDaysQuery: QueryParam[Integer], engagementWindowDaysQuery: QueryParam[Integer], viewWindowDaysQuery: QueryParam[Integer], conversionReportTimeQuery: QueryParam[String], pinIdsQuery: QueryParam[List[String]], campaignIdsQuery: QueryParam[List[String]], reportingTimezoneQuery: QueryParam[ReportingTimeZone]): Task[List[AdsAnalyticsResponseInner]] = {
    ...
    val queryParams = Query(
      ("startDate", Some(start_dateQuery.toParamString(start_date))), ("endDate", Some(end_dateQuery.toParamString(end_date))), ("adIds", Some(ad_idsQuery.toParamString(ad_ids))), ("columns", Some(columnsQuery.toParamString(columns))), ("granularity", Some(granularityQuery.toParamString(granularity))), ("clickWindowDays", Some(click_window_daysQuery.toParamString(click_window_days))), ("engagementWindowDays", Some(engagement_window_daysQuery.toParamString(engagement_window_days))), ("viewWindowDays", Some(view_window_daysQuery.toParamString(view_window_days))), ("conversionReportTime", Some(conversion_report_timeQuery.toParamString(conversion_report_time))), ("pinIds", Some(pin_idsQuery.toParamString(pin_ids))), ("campaignIds", Some(campaign_idsQuery.toParamString(campaign_ids))), ("reportingTimezone", Some(reporting_timezoneQuery.toParamString(reporting_timezone))))
