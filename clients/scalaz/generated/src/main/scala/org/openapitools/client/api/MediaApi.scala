...
object MediaApi {
  ...
  def mediaList(host: String, bookmark: String, pageSize: Integer = 25)(implicit bookmarkQuery: QueryParam[String], pageSizeQuery: QueryParam[Integer]): Task[MediaList200Response] = {
    implicit val returnTypeDecoder: EntityDecoder[MediaList200Response] = jsonOf[MediaList200Response]
    ...
    for {
      ...
      uriWithParams =  uri.copy(query = queryParams)
      req           =  Request(method = httpMethod, uri = uriWithParams, headers = headers.put(contentType))
      resp          <- client.expect[MediaList200Response](req)
...
class HttpServiceMediaApi(service: HttpService) {
  ...
  def mediaList(bookmark: String, pageSize: Integer = 25)(implicit bookmarkQuery: QueryParam[String], pageSizeQuery: QueryParam[Integer]): Task[MediaList200Response] = {
    implicit val returnTypeDecoder: EntityDecoder[MediaList200Response] = jsonOf[MediaList200Response]
