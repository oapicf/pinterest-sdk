...
import CatalogsRetailBatchRequestItemsItems._
...
object CatalogsRetailBatchRequestItemsItems {
  ...
  implicit val CatalogsRetailBatchRequestItemsItemsCodecJson: CodecJson[CatalogsRetailBatchRequestItemsItems] = CodecJson.derive[CatalogsRetailBatchRequestItemsItems]
  implicit val CatalogsRetailBatchRequestItemsItemsDecoder: EntityDecoder[CatalogsRetailBatchRequestItemsItems] = jsonOf[CatalogsRetailBatchRequestItemsItems]
  implicit val CatalogsRetailBatchRequestItemsItemsEncoder: EntityEncoder[CatalogsRetailBatchRequestItemsItems] = jsonEncoderOf[CatalogsRetailBatchRequestItemsItems]
}
