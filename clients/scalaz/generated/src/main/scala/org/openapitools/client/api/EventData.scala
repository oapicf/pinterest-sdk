...
object EventData {
  ...
  implicit val EventDataCodecJson: CodecJson[EventData] = CodecJson.derive[EventData]
  implicit val EventDataDecoder: EntityDecoder[EventData] = jsonOf[EventData]
  implicit val EventDataEncoder: EntityEncoder[EventData] = jsonEncoderOf[EventData]
}
