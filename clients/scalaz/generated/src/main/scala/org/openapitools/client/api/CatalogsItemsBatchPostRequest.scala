...
import CatalogsItemsBatchPostRequest._
...
object CatalogsItemsBatchPostRequest {
  ...
  implicit val CatalogsItemsBatchPostRequestCodecJson: CodecJson[CatalogsItemsBatchPostRequest] = CodecJson.derive[CatalogsItemsBatchPostRequest]
  implicit val CatalogsItemsBatchPostRequestDecoder: EntityDecoder[CatalogsItemsBatchPostRequest] = jsonOf[CatalogsItemsBatchPostRequest]
  implicit val CatalogsItemsBatchPostRequestEncoder: EntityEncoder[CatalogsItemsBatchPostRequest] = jsonEncoderOf[CatalogsItemsBatchPostRequest]
}
