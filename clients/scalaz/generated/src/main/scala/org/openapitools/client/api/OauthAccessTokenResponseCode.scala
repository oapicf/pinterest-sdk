...
import OauthAccessTokenResponseCode._
...
object OauthAccessTokenResponseCode {
  ...
  implicit val OauthAccessTokenResponseCodeCodecJson: CodecJson[OauthAccessTokenResponseCode] = CodecJson.derive[OauthAccessTokenResponseCode]
  implicit val OauthAccessTokenResponseCodeDecoder: EntityDecoder[OauthAccessTokenResponseCode] = jsonOf[OauthAccessTokenResponseCode]
  implicit val OauthAccessTokenResponseCodeEncoder: EntityEncoder[OauthAccessTokenResponseCode] = jsonEncoderOf[OauthAccessTokenResponseCode]
}
