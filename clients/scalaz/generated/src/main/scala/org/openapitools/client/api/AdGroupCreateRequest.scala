...
/* Optimization goals for objective-based performance campaigns. **REQUIRED** when campaign's `objective_type` is set to `\"WEB_CONVERSION\"`. */
  optimizationGoalMetadata: Option[Any],
...
object AdGroupCreateRequest {
  ...
  implicit val AdGroupCreateRequestCodecJson: CodecJson[AdGroupCreateRequest] = CodecJson.derive[AdGroupCreateRequest]
  implicit val AdGroupCreateRequestDecoder: EntityDecoder[AdGroupCreateRequest] = jsonOf[AdGroupCreateRequest]
  implicit val AdGroupCreateRequestEncoder: EntityEncoder[AdGroupCreateRequest] = jsonEncoderOf[AdGroupCreateRequest]
}
