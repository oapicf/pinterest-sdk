...
object CatalogsHotelReportStatsParametersReport {
  ...
  implicit val CatalogsHotelReportStatsParametersReportCodecJson: CodecJson[CatalogsHotelReportStatsParametersReport] = CodecJson.derive[CatalogsHotelReportStatsParametersReport]
  implicit val CatalogsHotelReportStatsParametersReportDecoder: EntityDecoder[CatalogsHotelReportStatsParametersReport] = jsonOf[CatalogsHotelReportStatsParametersReport]
  implicit val CatalogsHotelReportStatsParametersReportEncoder: EntityEncoder[CatalogsHotelReportStatsParametersReport] = jsonEncoderOf[CatalogsHotelReportStatsParametersReport]
}
