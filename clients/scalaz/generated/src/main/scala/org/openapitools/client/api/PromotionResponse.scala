...
object PromotionResponse {
  ...
  implicit val PromotionResponseCodecJson: CodecJson[PromotionResponse] = CodecJson.derive[PromotionResponse]
  implicit val PromotionResponseDecoder: EntityDecoder[PromotionResponse] = jsonOf[PromotionResponse]
  implicit val PromotionResponseEncoder: EntityEncoder[PromotionResponse] = jsonEncoderOf[PromotionResponse]
}
