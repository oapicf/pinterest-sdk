...
import CampaignBatchResponseData._
...
object CampaignBatchResponseData {
  ...
  implicit val CampaignBatchResponseDataCodecJson: CodecJson[CampaignBatchResponseData] = CodecJson.derive[CampaignBatchResponseData]
  implicit val CampaignBatchResponseDataDecoder: EntityDecoder[CampaignBatchResponseData] = jsonOf[CampaignBatchResponseData]
  implicit val CampaignBatchResponseDataEncoder: EntityEncoder[CampaignBatchResponseData] = jsonEncoderOf[CampaignBatchResponseData]
}
