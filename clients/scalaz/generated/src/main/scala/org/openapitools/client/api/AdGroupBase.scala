...
object AdGroupBase {
  ...
  implicit val AdGroupBaseCodecJson: CodecJson[AdGroupBase] = CodecJson.derive[AdGroupBase]
  implicit val AdGroupBaseDecoder: EntityDecoder[AdGroupBase] = jsonOf[AdGroupBase]
  implicit val AdGroupBaseEncoder: EntityEncoder[AdGroupBase] = jsonEncoderOf[AdGroupBase]
}
