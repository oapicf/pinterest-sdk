...
import SupplementalOperationResult._

case class SupplementalOperationResult (
...
object SupplementalOperationResult {
  ...
  implicit val SupplementalOperationResultCodecJson: CodecJson[SupplementalOperationResult] = CodecJson.derive[SupplementalOperationResult]
  implicit val SupplementalOperationResultDecoder: EntityDecoder[SupplementalOperationResult] = jsonOf[SupplementalOperationResult]
  implicit val SupplementalOperationResultEncoder: EntityEncoder[SupplementalOperationResult] = jsonEncoderOf[SupplementalOperationResult]
}
