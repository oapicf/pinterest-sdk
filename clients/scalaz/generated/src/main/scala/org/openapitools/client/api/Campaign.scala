...
object Campaign {
  ...
  implicit val CampaignCodecJson: CodecJson[Campaign] = CodecJson.derive[Campaign]
  implicit val CampaignDecoder: EntityDecoder[Campaign] = jsonOf[Campaign]
  implicit val CampaignEncoder: EntityEncoder[Campaign] = jsonEncoderOf[Campaign]
}
