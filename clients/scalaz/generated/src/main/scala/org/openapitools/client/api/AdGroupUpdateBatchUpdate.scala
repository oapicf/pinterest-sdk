...
import AdGroupUpdateBatchUpdate._
...
object AdGroupUpdateBatchUpdate {
  ...
  implicit val AdGroupUpdateBatchUpdateCodecJson: CodecJson[AdGroupUpdateBatchUpdate] = CodecJson.derive[AdGroupUpdateBatchUpdate]
  implicit val AdGroupUpdateBatchUpdateDecoder: EntityDecoder[AdGroupUpdateBatchUpdate] = jsonOf[AdGroupUpdateBatchUpdate]
  implicit val AdGroupUpdateBatchUpdateEncoder: EntityEncoder[AdGroupUpdateBatchUpdate] = jsonEncoderOf[AdGroupUpdateBatchUpdate]
}
