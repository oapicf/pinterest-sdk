...
import ItemAttributesRequest._
...
/* By default, product pins created from a catalog are able to be saved by Pinners. If you want to disable the save pin feature, set this attribute to true. This feature is only available for allowlisted merchants. Please contact your account manager to enable this feature. */
  savePinDisabled: Option[Boolean],
...
object ItemAttributesRequest {
  ...
  implicit val ItemAttributesRequestCodecJson: CodecJson[ItemAttributesRequest] = CodecJson.derive[ItemAttributesRequest]
  implicit val ItemAttributesRequestDecoder: EntityDecoder[ItemAttributesRequest] = jsonOf[ItemAttributesRequest]
  implicit val ItemAttributesRequestEncoder: EntityEncoder[ItemAttributesRequest] = jsonEncoderOf[ItemAttributesRequest]
}
