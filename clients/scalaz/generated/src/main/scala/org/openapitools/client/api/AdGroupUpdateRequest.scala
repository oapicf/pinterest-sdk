...
object AdGroupUpdateRequest {
  ...
  implicit val AdGroupUpdateRequestCodecJson: CodecJson[AdGroupUpdateRequest] = CodecJson.derive[AdGroupUpdateRequest]
  implicit val AdGroupUpdateRequestDecoder: EntityDecoder[AdGroupUpdateRequest] = jsonOf[AdGroupUpdateRequest]
  implicit val AdGroupUpdateRequestEncoder: EntityEncoder[AdGroupUpdateRequest] = jsonEncoderOf[AdGroupUpdateRequest]
}
