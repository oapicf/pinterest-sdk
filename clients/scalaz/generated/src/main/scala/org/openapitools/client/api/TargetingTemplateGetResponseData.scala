...
import TargetingTemplateGetResponseData._
...
object TargetingTemplateGetResponseData {
  ...
  implicit val TargetingTemplateGetResponseDataCodecJson: CodecJson[TargetingTemplateGetResponseData] = CodecJson.derive[TargetingTemplateGetResponseData]
  implicit val TargetingTemplateGetResponseDataDecoder: EntityDecoder[TargetingTemplateGetResponseData] = jsonOf[TargetingTemplateGetResponseData]
  implicit val TargetingTemplateGetResponseDataEncoder: EntityEncoder[TargetingTemplateGetResponseData] = jsonEncoderOf[TargetingTemplateGetResponseData]
}
