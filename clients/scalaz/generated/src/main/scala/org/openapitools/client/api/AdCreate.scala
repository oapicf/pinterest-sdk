...
object AdCreate {
  ...
  implicit val AdCreateCodecJson: CodecJson[AdCreate] = CodecJson.derive[AdCreate]
  implicit val AdCreateDecoder: EntityDecoder[AdCreate] = jsonOf[AdCreate]
  implicit val AdCreateEncoder: EntityEncoder[AdCreate] = jsonEncoderOf[AdCreate]
}
