...
import DeliveryMetricsResponseItemsItems._
...
object DeliveryMetricsResponseItemsItems {
  ...
  implicit val DeliveryMetricsResponseItemsItemsCodecJson: CodecJson[DeliveryMetricsResponseItemsItems] = CodecJson.derive[DeliveryMetricsResponseItemsItems]
  implicit val DeliveryMetricsResponseItemsItemsDecoder: EntityDecoder[DeliveryMetricsResponseItemsItems] = jsonOf[DeliveryMetricsResponseItemsItems]
  implicit val DeliveryMetricsResponseItemsItemsEncoder: EntityEncoder[DeliveryMetricsResponseItemsItems] = jsonEncoderOf[DeliveryMetricsResponseItemsItems]
}
