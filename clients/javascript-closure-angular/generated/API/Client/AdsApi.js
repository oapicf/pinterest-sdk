 ...
 */
API.Client.AdsApi.prototype.adTargetingAnalyticsGet = function(adAccountId, adIds, startDate, endDate, targetingTypes, columns, granularity, opt_clickWindowDays, opt_engagementWindowDays, opt_viewWindowDays, opt_conversionReportTime, opt_attributionTypes, opt_reportingTimezone, opt_extraHttpRequestParams) {
  /** @const {string} */
 ...
 */
API.Client.AdsApi.prototype.adsAnalytics = function(adAccountId, startDate, endDate, columns, granularity, opt_adIds, opt_clickWindowDays, opt_engagementWindowDays, opt_viewWindowDays, opt_conversionReportTime, opt_pinIds, opt_campaignIds, opt_reportingTimezone, opt_extraHttpRequestParams) {
  /** @const {string} */
