 ...
 */
API.Client.AdsApi.prototype.adsAnalytics = function(adAccountId, startDate, endDate, adIds, columns, granularity, opt_clickWindowDays, opt_engagementWindowDays, opt_viewWindowDays, opt_conversionReportTime, opt_extraHttpRequestParams) {
  /** @const {string} */
  ...
  // verify required parameter 'adIds' is set
  if (!adIds) {
    throw new Error('Missing required parameter adIds when calling adsAnalytics');
  }
  // verify required parameter 'columns' is set
  if (!columns) {
