goog.provide('API.Client.TemplateResponse_date_range');
 ...
 * @export
 */
API.Client.TemplateResponseDateRange.prototype.dynamicDateRange;

/**
 * @type {!API.Client.TemplateResponse_date_range_relative_date_range}
 * @export
 */
