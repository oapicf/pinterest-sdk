goog.provide('API.Client.ScheduleAudienceMultipliers');
 ...
 * @record
 */
API.Client.ScheduleAudienceMultipliers = function() {}

/**
 * @type {!string}
 * @export
 */
API.Client.ScheduleAudienceMultipliers.prototype.AUDIENCE_ID;
