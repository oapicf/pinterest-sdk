...
goog.require('API.Client.integrations_logs_post_400_response');
 ...
 * @return {!angular.$q.Promise<!API.Client.IntegrationMetadata>}
 */
API.Client.IntegrationsApi.prototype.integrationsCommercePatch = function(externalBusinessId, integrationRequestPatch, opt_extraHttpRequestParams) {
  /** @const {string} */
  var path = this.basePath_ + '/integrations/commerce/{external_business_id}'
      .replace('{' + 'external_business_id' + '}', String(externalBusinessId));
  ...
  // verify required parameter 'integrationRequestPatch' is set
  if (!integrationRequestPatch) {
    throw new Error('Missing required parameter integrationRequestPatch when calling integrationsCommercePatch');
  }
  /** @type {!Object} */
  var httpRequestParams = {
    method: 'PATCH',
 ...
 * @return {!angular.$q.Promise<!API.Client.IntegrationMetadata>}
 */
API.Client.IntegrationsApi.prototype.integrationsCommercePost = function(integrationRequest, opt_extraHttpRequestParams) {
  /** @const {string} */
  ...
  /** @type {!Object} */
  var headerParams = angular.extend({}, this.defaultHeaders_);
  // verify required parameter 'integrationRequest' is set
  if (!integrationRequest) {
    throw new Error('Missing required parameter integrationRequest when calling integrationsCommercePost');
  }
  /** @type {!Object} */
  var httpRequestParams = {
    method: 'POST',
