goog.provide('API.Client.TrendingKeywordsResponse_trends_inner_time_series');
 ...
 * @record
 */
API.Client.TrendingKeywordsResponseTrendsInnerTimeSeries = function() {}

/**
 * @type {!API.Client.date}
 * @export
 */
API.Client.TrendingKeywordsResponseTrendsInnerTimeSeries.prototype.date;
