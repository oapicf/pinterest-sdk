goog.provide('API.Client.ScheduleAppTypeMultipliers');
 ...
 * @record
 */
API.Client.ScheduleAppTypeMultipliers = function() {}

/**
 * @type {!API.Client.TargetingSpecAppType}
 * @export
 */
API.Client.ScheduleAppTypeMultipliers.prototype.APP_TYPE;
