 ...
 */
API.Client.OrderLinesApi.prototype.orderLinesGet = function(orderLineId, adAccountId, opt_extraHttpRequestParams) {
  /** @const {string} */
 ...
 */
API.Client.OrderLinesApi.prototype.orderLinesList = function(adAccountId, opt_bookmark, opt_pageSize, opt_order, opt_extraHttpRequestParams) {
  /** @const {string} */
