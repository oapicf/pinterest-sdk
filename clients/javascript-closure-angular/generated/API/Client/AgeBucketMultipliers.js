goog.provide('API.Client.AgeBucketMultipliers');
 ...
 * @record
 */
API.Client.AgeBucketMultipliers = function() {}

/**
 * Age bucket identifier.
 * @type {!API.Client.TargetingSpecAgeBucket}
 * @export
 */
API.Client.AgeBucketMultipliers.prototype.AGE_BUCKET;
