goog.provide('API.Client.BidOptionsAudienceMultipliers');
 ...
 * @record
 */
API.Client.BidOptionsAudienceMultipliers = function() {}

/**
 * @type {!string}
 * @export
 */
API.Client.BidOptionsAudienceMultipliers.prototype.audienceId;

/**
 * @type {!number}
 * @export
 */
API.Client.BidOptionsAudienceMultipliers.prototype.multiplier;
