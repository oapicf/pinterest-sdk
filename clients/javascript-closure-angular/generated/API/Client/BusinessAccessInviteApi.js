...
goog.require('API.Client.CancelInvitesRequest');
goog.require('API.Client.CancelInvitesResponse');
...
goog.require('API.Client.InviteFilterStatus');
 ...
 * @param {!string} businessId Unique identifier of the requesting business.
 * @param {!CancelInvitesRequest} cancelInvitesRequest 
 * @param {!angular.$http.Config=} opt_extraHttpRequestParams Extra HTTP parameters to send.
 * @return {!angular.$q.Promise<!API.Client.CancelInvitesResponse>}
 */
API.Client.BusinessAccessInviteApi.prototype.cancelInvitesOrRequests = function(businessId, cancelInvitesRequest, opt_extraHttpRequestParams) {
  /** @const {string} */
  ...
  // verify required parameter 'cancelInvitesRequest' is set
  if (!cancelInvitesRequest) {
    throw new Error('Missing required parameter cancelInvitesRequest when calling cancelInvitesOrRequests');
  }
  /** @type {!Object} */
  var httpRequestParams = {
    method: 'DELETE',
 ...
 * @param {!string} businessId Unique identifier of the requesting business.
 * @param {!CreateAssetInvitesRequest} createAssetInvitesRequest 
 * @param {!angular.$http.Config=} opt_extraHttpRequestParams Extra HTTP parameters to send.
 ...
 * @param {!string} businessId Unique identifier of the requesting business.
 * @param {!CreateMembershipOrPartnershipInvitesBody} createMembershipOrPartnershipInvitesBody 
 * @param {!angular.$http.Config=} opt_extraHttpRequestParams Extra HTTP parameters to send.
 ...
 * @param {!Array<!API.Client.InviteFilterStatus>=} opt_inviteStatus A list of invite statuses to filter invites by. Only invites whose status is in the provided statuses will be returned.
