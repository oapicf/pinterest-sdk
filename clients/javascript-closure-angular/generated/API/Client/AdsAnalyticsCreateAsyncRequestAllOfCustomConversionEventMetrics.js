goog.provide('API.Client.AdsAnalyticsCreateAsyncRequest_allOf_custom_conversion_event_metrics');

/**
 * @record
 */
API.Client.AdsAnalyticsCreateAsyncRequestAllOfCustomConversionEventMetrics = function() {}
 ...
 * @export
 */
API.Client.AdsAnalyticsCreateAsyncRequestAllOfCustomConversionEventMetrics.prototype.customEventMetricsType;
 ...
 * @export
 */
API.Client.AdsAnalyticsCreateAsyncRequestAllOfCustomConversionEventMetrics.prototype.customEventName;

/** @enum {string} */
API.Client.AdsAnalyticsCreateAsyncRequestAllOfCustomConversionEventMetrics.CustomEventMetricsTypeEnum = { 
