goog.provide('API.Client.CampaignCreateItem');

/**
 * Single campaign create item with create-specific defaults.
 * @record
 */
API.Client.CampaignCreateItem = function() {}
 ...
 * @export
 */
API.Client.CampaignCreateItem.prototype.adAccountId;
 ...
 * @export
 */
API.Client.CampaignCreateItem.prototype.appId;
 ...
 * @export
 */
API.Client.CampaignCreateItem.prototype.appPlatform;
 ...
 * @export
 */
API.Client.CampaignCreateItem.prototype.bidOptions;
 ...
 * @export
 */
API.Client.CampaignCreateItem.prototype.dailySpendCap;
 ...
 * @export
 */
API.Client.CampaignCreateItem.prototype.defaultAdGroupBudgetInMicroCurrency;
 ...
 * @export
 */
API.Client.CampaignCreateItem.prototype.endTime;

/**
 * @type {!API.Client.IntendedPromotionType}
 * @export
 */
API.Client.CampaignCreateItem.prototype.intendedPromotionType;
 ...
 * @export
 */
API.Client.CampaignCreateItem.prototype.isAutomatedCampaign;
 ...
 * @export
 */
API.Client.CampaignCreateItem.prototype.isCampaignBudgetOptimization;
 ...
 * @export
 */
API.Client.CampaignCreateItem.prototype.isFlexibleDailyBudgets;
 ...
 * @export
 */
API.Client.CampaignCreateItem.prototype.isLtvOptimized;
 ...
 * @export
 */
API.Client.CampaignCreateItem.prototype.isPerformancePlus;
 ...
 * @export
 */
API.Client.CampaignCreateItem.prototype.isTopOfSearch;
 ...
 * @export
 */
API.Client.CampaignCreateItem.prototype.lifetimeSpendCap;
 ...
 * @export
 */
API.Client.CampaignCreateItem.prototype.name;

/**
 * @type {!API.Client.ConversionObjectiveType}
 * @export
 */
API.Client.CampaignCreateItem.prototype.objectiveType;
 ...
 * @export
 */
API.Client.CampaignCreateItem.prototype.orderLineId;
 ...
 * @export
 */
API.Client.CampaignCreateItem.prototype.startTime;

/**
 * @type {!API.Client.EntityStatus}
 * @export
 */
API.Client.CampaignCreateItem.prototype.status;

/**
 * @type {!API.Client.TrackingUrls}
 * @export
 */
API.Client.CampaignCreateItem.prototype.trackingUrls;
