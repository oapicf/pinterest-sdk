 ...
 */
API.Client.CatalogProductGroupsApi.prototype.catalogsProductGroupPinsList = function(productGroupId, opt_bookmark, opt_pageSize, opt_adAccountId, opt_pinMetrics, opt_extraHttpRequestParams) {
  /** @const {string} */
 ...
 */
API.Client.CatalogProductGroupsApi.prototype.catalogsProductGroupsCreate = function(multipleProductGroupsInner, opt_adAccountId, opt_extraHttpRequestParams) {
  /** @const {string} */
 ...
 */
API.Client.CatalogProductGroupsApi.prototype.catalogsProductGroupsCreateMany = function(multipleProductGroupsInner, opt_adAccountId, opt_extraHttpRequestParams) {
  /** @const {string} */
 ...
 */
API.Client.CatalogProductGroupsApi.prototype.catalogsProductGroupsList = function(opt_id, opt_feedId, opt_catalogId, opt_bookmark, opt_pageSize, opt_adAccountId, opt_extraHttpRequestParams) {
  /** @const {string} */
  var path = this.basePath_ + '/catalogs/product_groups';
 ...
 * @return {!angular.$q.Promise<!API.Client.CatalogsVerticalProductGroup>}
 */
API.Client.CatalogProductGroupsApi.prototype.catalogsProductGroupsUpdate = function(productGroupId, catalogsProductGroupsUpdateRequest, opt_adAccountId, opt_extraHttpRequestParams) {
  /** @const {string} */
  var path = this.basePath_ + '/catalogs/product_groups/{product_group_id}'
      .replace('{' + 'product_group_id' + '}', String(productGroupId));
