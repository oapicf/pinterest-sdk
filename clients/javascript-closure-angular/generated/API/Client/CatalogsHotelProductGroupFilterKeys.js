goog.provide('API.Client.CatalogsHotelProductGroupFilterKeys');

/**
 * @record
 */
API.Client.CatalogsHotelProductGroupFilterKeys = function() {}

/**
 * @type {!API.Client.catalogs_product_group_pricing_currency_criteria}
 * @export
 */
API.Client.CatalogsHotelProductGroupFilterKeys.prototype.PRICE;

/**
 * @type {!API.Client.CatalogsProductGroupMultipleStringCriteria}
 * @export
 */
API.Client.CatalogsHotelProductGroupFilterKeys.prototype.HOTEL_ID;
...
/**
 * @type {!API.Client.CatalogsProductGroupMultipleCountriesCriteria}
 * @export
 */
