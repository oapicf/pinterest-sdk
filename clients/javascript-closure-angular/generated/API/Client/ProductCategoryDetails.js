goog.provide('API.Client.ProductCategoryDetails');

/**
 * Product category details
 * @record
 */
API.Client.ProductCategoryDetails = function() {}

/**
 * @type {!API.Client.ProductCategoriesDemographic}
 * @export
 */
API.Client.ProductCategoryDetails.prototype.demographics;
 ...
 * @export
 */
API.Client.ProductCategoryDetails.prototype.hasPrediction;

/**
 * @type {!API.Client.ProductCategoriesMetricsHighlights}
 * @export
 */
API.Client.ProductCategoryDetails.prototype.metricsHighlights;
 ...
 * @export
 */
API.Client.ProductCategoryDetails.prototype.predictedTimeSeries;

/**
 * @type {!API.Client.ProductCategoryEnum}
 * @export
 */
API.Client.ProductCategoryDetails.prototype.productCategory;
 ...
 * @export
 */
API.Client.ProductCategoryDetails.prototype.relatedSearches;
 ...
 * @export
 */
API.Client.ProductCategoryDetails.prototype.timeSeries;
