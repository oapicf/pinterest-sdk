...
goog.require('API.Client.AudienceInsights');
goog.require('API.Client.Pinterest.Lib.Error');
goog.require('API.Client.audience_insights_scope_and_type_get_200_response');
 ...
 * @return {!angular.$q.Promise<!API.Client.AudienceInsights>}
 */
 ...
 * @param {!string} adAccountId Unique identifier of an ad account.
 * @param {!angular.$http.Config=} opt_extraHttpRequestParams Extra HTTP parameters to send.
 * @return {!angular.$q.Promise<!API.Client.audience_insights_scope_and_type_get_200_response>}
 */
