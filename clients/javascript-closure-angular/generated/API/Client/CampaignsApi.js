 ...
 */
API.Client.CampaignsApi.prototype.adPinsAnalytics = function(adAccountId, campaignId, pinIds, startDate, endDate, columns, granularity, opt_clickWindowDays, opt_engagementWindowDays, opt_viewWindowDays, opt_conversionReportTime, opt_extraHttpRequestParams) {
  /** @const {string} */
 ...
 */
API.Client.CampaignsApi.prototype.campaignsAnalytics = function(adAccountId, startDate, endDate, campaignIds, columns, granularity, opt_clickWindowDays, opt_engagementWindowDays, opt_viewWindowDays, opt_conversionReportTime, opt_aggregateReportRows, opt_reportingTimezone, opt_extraHttpRequestParams) {
  /** @const {string} */
