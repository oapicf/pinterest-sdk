...
goog.require('API.Client.ConversionTag');
...
goog.require('API.Client.conversion_tags_list_200_response');
 ...
 * @param {!ConversionTagCreate} conversionTagCreate 
 * @param {!angular.$http.Config=} opt_extraHttpRequestParams Extra HTTP parameters to send.
 * @return {!angular.$q.Promise<!API.Client.ConversionTag>}
 */
 ...
 * @param {!string} adAccountId Unique identifier of an ad account.
 * @param {!boolean=} opt_filterDeleted Filter by deleted status
 * @param {!angular.$http.Config=} opt_extraHttpRequestParams Extra HTTP parameters to send.
 * @return {!angular.$q.Promise<!API.Client.conversion_tags_list_200_response>}
 */
 ...
 */
API.Client.ConversionTagsApi.prototype.pageVisitConversionTagsGet = function(adAccountId, opt_bookmark, opt_pageSize, opt_order, opt_extraHttpRequestParams) {
  /** @const {string} */
