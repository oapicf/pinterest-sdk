...
goog.require('API.Client.FollowUser');
goog.require('API.Client.FollowUserCreate');
goog.require('API.Client.LinkedBusiness');
goog.require('API.Client.Pinterest.Lib.Error');
goog.require('API.Client.QuerymetrictypesItems');
goog.require('API.Client.QueryvideopinmetrictypesItems');
goog.require('API.Client.TopPinsAnalyticsResponse');
goog.require('API.Client.TopPinsSortBy');
goog.require('API.Client.TopVideoPinsAnalyticsResponse');
goog.require('API.Client.TopVideoPinsSortBy');
goog.require('API.Client.UserFollowingFeedType');
goog.require('API.Client.UserWebsite');
goog.require('API.Client.UserWebsiteCreate');
goog.require('API.Client.UserWebsiteVerification');
 ...
 */
API.Client.UserAccountApi.prototype.boardsUserFollowsList = function(opt_adAccountId, opt_explicitFollowing, opt_bookmark, opt_pageSize, opt_extraHttpRequestParams) {
  /** @const {string} */
 ...
 * @param {!FollowUserCreate} followUserCreate 
 * @param {!angular.$http.Config=} opt_extraHttpRequestParams Extra HTTP parameters to send.
 * @return {!angular.$q.Promise<!API.Client.FollowUser>}
 */
API.Client.UserAccountApi.prototype.followUserUpdate = function(username, followUserCreate, opt_extraHttpRequestParams) {
  /** @const {string} */
  ...
  // verify required parameter 'followUserCreate' is set
  if (!followUserCreate) {
    throw new Error('Missing required parameter followUserCreate when calling followUserUpdate');
  }
  /** @type {!Object} */
  var httpRequestParams = {
    method: 'POST',
 ...
 * @param {!angular.$http.Config=} opt_extraHttpRequestParams Extra HTTP parameters to send.
 * @return {!angular.$q.Promise<!API.Client.UserWebsite>}
 */
 ...
 * @param {!Array<!API.Client.QuerymetrictypesItems>=} opt_metricTypes Metric types to get data for, default is all.
 ...
 * @param {!API.Client.date} startDate Metric report start date (UTC). Format: YYYY-MM-DD. Cannot be more than 90 days back from today.
 * @param {!API.Client.date} endDate Metric report end date (UTC). Format: YYYY-MM-DD. Cannot be more than 90 days past start_date.
 * @param {!TopPinsSortBy} sortBy Specify sorting order for metrics
 * @param {!string=} opt_fromClaimedContent Filter on Pins that match your claimed domain.
 * @param {!string=} opt_pinFormat Pin formats to get data for, default is all.
 * @param {!string=} opt_appTypes Apps or devices to get data for, default is all.
 * @param {!string=} opt_contentType Filter to paid or organic data. Default is all.
 ...
 * @param {!API.Client.date} startDate Metric report start date (UTC). Format: YYYY-MM-DD. Cannot be more than 90 days back from today.
 * @param {!API.Client.date} endDate Metric report end date (UTC). Format: YYYY-MM-DD. Cannot be more than 90 days past start_date.
 * @param {!TopVideoPinsSortBy} sortBy Specify sorting order for video metrics
 * @param {!string=} opt_fromClaimedContent Filter on Pins that match your claimed domain.
 * @param {!string=} opt_pinFormat Pin formats to get data for, default is all.
 * @param {!string=} opt_appTypes Apps or devices to get data for, default is all.
 * @param {!string=} opt_contentType Filter to paid or organic data. Default is all.
 * @param {!string=} opt_source Filter to activity from Pins created and saved by your, or activity created and saved by others from your claimed accounts
 * @param {!Array<!API.Client.QueryvideopinmetrictypesItems>=} opt_metricTypes Metric types to get video data for, default is all.
 * @param {!number=} opt_numOfPins Number of pins to include, default is 10. Max is 50.
 * @param {!number=} opt_createdInLastNDays Get metrics for pins created in the last \&quot;n\&quot; days.
 * @param {!string=} opt_adAccountId Unique identifier of an ad account.
 * @param {!angular.$http.Config=} opt_extraHttpRequestParams Extra HTTP parameters to send.
 ...
 * @return {!angular.$q.Promise<!API.Client.followers_list_200_response>}
 */
API.Client.UserAccountApi.prototype.userFollowingGet = function(opt_adAccountId, opt_explicitFollowing, opt_feedType, opt_bookmark, opt_pageSize, opt_extraHttpRequestParams) {
  /** @const {string} */
 ...
 * @param {!UserWebsiteCreate} userWebsiteCreate 
 * @param {!string=} opt_adAccountId Unique identifier of an ad account.
 * @param {!angular.$http.Config=} opt_extraHttpRequestParams Extra HTTP parameters to send.
 * @return {!angular.$q.Promise<!API.Client.UserWebsite>}
 */
API.Client.UserAccountApi.prototype.verifyWebsiteUpdate = function(userWebsiteCreate, opt_adAccountId, opt_extraHttpRequestParams) {
  /** @const {string} */
  var path = this.basePath_ + '/user_account/websites';
  ...
  /** @type {!Object} */
  var headerParams = angular.extend({}, this.defaultHeaders_);
  // verify required parameter 'userWebsiteCreate' is set
  if (!userWebsiteCreate) {
    throw new Error('Missing required parameter userWebsiteCreate when calling verifyWebsiteUpdate');
  }
  if (opt_adAccountId !== undefined) {
    queryParameters['ad_account_id'] = opt_adAccountId;
  }
 ...
 * @param {!string=} opt_adAccountId Unique identifier of an ad account.
 * @param {!angular.$http.Config=} opt_extraHttpRequestParams Extra HTTP parameters to send.
 * @return {!angular.$q.Promise<!API.Client.UserWebsiteVerification>}
 */
