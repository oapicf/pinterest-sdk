 ...
 */
API.Client.UserAccountApi.prototype.verifyWebsiteUpdate = function(userWebsiteVerifyRequest, opt_extraHttpRequestParams) {
  /** @const {string} */
  var path = this.basePath_ + '/user_account/websites';
 ...
 */
API.Client.UserAccountApi.prototype.websiteVerificationGet = function(opt_extraHttpRequestParams) {
  /** @const {string} */
