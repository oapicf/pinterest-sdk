goog.provide('API.Client.CampaignBatchUpdateItem');

/**
 * Single campaign update item with update-specific bid options.
 * @record
 */
API.Client.CampaignBatchUpdateItem = function() {}
 ...
 * @export
 */
API.Client.CampaignBatchUpdateItem.prototype.adAccountId;
 ...
 * @export
 */
API.Client.CampaignBatchUpdateItem.prototype.appId;

/**
 * [Closed beta](/docs/getting-started/using-beta-and-restricted-features/)  Platform of the mobile app for `APP_INSTALL` campaigns.
 * @type {!API.Client.MobileAppPlatform}
 * @export
 */
API.Client.CampaignBatchUpdateItem.prototype.appPlatform;
 ...
 * @export
 */
API.Client.CampaignBatchUpdateItem.prototype.bidOptions;
 ...
 * @export
 */
API.Client.CampaignBatchUpdateItem.prototype.dailySpendCap;
 ...
 * @export
 */
API.Client.CampaignBatchUpdateItem.prototype.defaultAdGroupBudgetInMicroCurrency;
 ...
 * @export
 */
API.Client.CampaignBatchUpdateItem.prototype.endTime;
 ...
 * @export
 */
API.Client.CampaignBatchUpdateItem.prototype.id;

/**
 * @type {!API.Client.IntendedPromotionType}
 * @export
 */
API.Client.CampaignBatchUpdateItem.prototype.intendedPromotionType;
 ...
 * @export
 */
API.Client.CampaignBatchUpdateItem.prototype.isAutomatedCampaign;
 ...
 * @export
 */
API.Client.CampaignBatchUpdateItem.prototype.isCampaignBudgetOptimization;
 ...
 * @export
 */
API.Client.CampaignBatchUpdateItem.prototype.isFlexibleDailyBudgets;
 ...
 * @export
 */
API.Client.CampaignBatchUpdateItem.prototype.isLtvOptimized;
 ...
 * @export
 */
API.Client.CampaignBatchUpdateItem.prototype.isPerformancePlus;
 ...
 * @export
 */
API.Client.CampaignBatchUpdateItem.prototype.isTopOfSearch;
 ...
 * @export
 */
API.Client.CampaignBatchUpdateItem.prototype.lifetimeSpendCap;
 ...
 * @export
 */
API.Client.CampaignBatchUpdateItem.prototype.name;

/**
 * @type {!API.Client.ConversionObjectiveType}
 * @export
 */
API.Client.CampaignBatchUpdateItem.prototype.objectiveType;
 ...
 * @export
 */
API.Client.CampaignBatchUpdateItem.prototype.orderLineId;
 ...
 * @export
 */
API.Client.CampaignBatchUpdateItem.prototype.performancePlusCampaignSettings;
 ...
 * @export
 */
API.Client.CampaignBatchUpdateItem.prototype.startTime;

/**
 * @type {!API.Client.EntityStatus}
 * @export
 */
API.Client.CampaignBatchUpdateItem.prototype.status;

/**
 * @type {!API.Client.TrackingUrls}
 * @export
 */
API.Client.CampaignBatchUpdateItem.prototype.trackingUrls;
