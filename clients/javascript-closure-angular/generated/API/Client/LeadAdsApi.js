...
goog.require('API.Client.LeadSubscription');
goog.require('API.Client.LeadSubscriptionPostParamsCreate');
 ...
 * @param {!string} subscriptionId Unique identifier of a subscription.
 * @param {!angular.$http.Config=} opt_extraHttpRequestParams Extra HTTP parameters to send.
 * @return {!angular.$q.Promise<!API.Client.LeadSubscription>}
 */
 ...
 */
API.Client.LeadAdsApi.prototype.adAccountsSubscriptionsGetList = function(adAccountId, opt_bookmark, opt_pageSize, opt_extraHttpRequestParams) {
  /** @const {string} */
 ...
 * @param {!string} adAccountId Unique identifier of an ad account.
 * @param {!LeadSubscriptionPostParamsCreate} leadSubscriptionPostParamsCreate 
 * @param {!angular.$http.Config=} opt_extraHttpRequestParams Extra HTTP parameters to send.
 * @return {!angular.$q.Promise<!API.Client.LeadSubscription>}
 */
API.Client.LeadAdsApi.prototype.adAccountsSubscriptionsPost = function(adAccountId, leadSubscriptionPostParamsCreate, opt_extraHttpRequestParams) {
  /** @const {string} */
  var path = this.basePath_ + '/ad_accounts/{ad_account_id}/leads/subscriptions'
      .replace('{' + 'ad_account_id' + '}', String(adAccountId));
  ...
  // verify required parameter 'leadSubscriptionPostParamsCreate' is set
  if (!leadSubscriptionPostParamsCreate) {
    throw new Error('Missing required parameter leadSubscriptionPostParamsCreate when calling adAccountsSubscriptionsPost');
  }
  /** @type {!Object} */
  var httpRequestParams = {
    method: 'POST',
    url: path,
    json: true,
    data: leadSubscriptionPostParamsCreate,
        params: queryParameters,
    headers: headerParams
  };
