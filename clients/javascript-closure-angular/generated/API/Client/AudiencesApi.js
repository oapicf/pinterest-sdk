 ...
 * @return {!angular.$q.Promise<!API.Client.Audience>}
 */
API.Client.AudiencesApi.prototype.audiencesUpdate = function(adAccountId, audienceId, audienceUpdateRequest, opt_extraHttpRequestParams) {
  /** @const {string} */
  var path = this.basePath_ + '/ad_accounts/{ad_account_id}/audiences/{audience_id}'
      .replace('{' + 'ad_account_id' + '}', String(adAccountId))
      .replace('{' + 'audience_id' + '}', String(audienceId));
  ...
  // verify required parameter 'audienceUpdateRequest' is set
  if (!audienceUpdateRequest) {
    throw new Error('Missing required parameter audienceUpdateRequest when calling audiencesUpdate');
  }
  /** @type {!Object} */
  var httpRequestParams = {
    method: 'PATCH',
