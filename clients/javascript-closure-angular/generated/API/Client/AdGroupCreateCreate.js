goog.provide('API.Client.AdGroupCreateCreate');

/**
 * Resource create operation model.
 * @record
 */
API.Client.AdGroupCreateCreate = function() {}
 ...
 * @export
 */
API.Client.AdGroupCreateCreate.prototype.autoTargetingEnabled;
 ...
 * @export
 */
API.Client.AdGroupCreateCreate.prototype.bidInMicroCurrency;
 ...
 * @export
 */
API.Client.AdGroupCreateCreate.prototype.bidMultiplier;

/**
 * @type {!API.Client.BidStrategyType}
 * @export
 */
API.Client.AdGroupCreateCreate.prototype.bidStrategyType;

/**
 * @type {!API.Client.ActionType}
 * @export
 */
API.Client.AdGroupCreateCreate.prototype.billableEvent;
 ...
 * @export
 */
API.Client.AdGroupCreateCreate.prototype.budgetInMicroCurrency;

/**
 * @type {!API.Client.BudgetType}
 * @export
 */
API.Client.AdGroupCreateCreate.prototype.budgetType;
 ...
 * @export
 */
API.Client.AdGroupCreateCreate.prototype.campaignId;
 ...
 * @export
 */
API.Client.AdGroupCreateCreate.prototype.customerSegmentId;
 ...
 * @export
 */
API.Client.AdGroupCreateCreate.prototype.endTime;

/**
 * @type {!API.Client.AdgroupTrackingFeatures}
 * @export
 */
API.Client.AdGroupCreateCreate.prototype.extFeatures;
 ...
 * @export
 */
API.Client.AdGroupCreateCreate.prototype.feedProfileId;
 ...
 * @export
 */
API.Client.AdGroupCreateCreate.prototype.isCreativeOptimization;
 ...
 * @export
 */
API.Client.AdGroupCreateCreate.prototype.isLocalInventory;
 ...
 * @export
 */
API.Client.AdGroupCreateCreate.prototype.lifetimeFrequencyCap;
 ...
 * @export
 */
API.Client.AdGroupCreateCreate.prototype.localInventoryRadiusInMiles;
 ...
 * @export
 */
API.Client.AdGroupCreateCreate.prototype.name;
 ...
 * @export
 */
API.Client.AdGroupCreateCreate.prototype.optimizationGoalMetadata;

/**
 * @type {!API.Client.PacingDeliveryType}
 * @export
 */
API.Client.AdGroupCreateCreate.prototype.pacingDeliveryType;
 ...
 * @export
 */
API.Client.AdGroupCreateCreate.prototype.performancePlusCampaignSettings;
 ...
 * @export
 */
API.Client.AdGroupCreateCreate.prototype.placementGroup;
 ...
 * @export
 */
API.Client.AdGroupCreateCreate.prototype.placementTrafficType;
 ...
 * @export
 */
API.Client.AdGroupCreateCreate.prototype.promotionApplicationLevel;
 ...
 * @export
 */
API.Client.AdGroupCreateCreate.prototype.promotionId;
 ...
 * @export
 */
API.Client.AdGroupCreateCreate.prototype.promotionIds;
 ...
 * @export
 */
API.Client.AdGroupCreateCreate.prototype.startTime;
 ...
 * @export
 */
API.Client.AdGroupCreateCreate.prototype.status;

/**
 * @type {!API.Client.TargetingSpecOptimal}
 * @export
 */
API.Client.AdGroupCreateCreate.prototype.targetingSpec;
 ...
 * @export
 */
API.Client.AdGroupCreateCreate.prototype.targetingTemplateIds;

/**
 * @type {!API.Client.AdGroupTrackingURLs}
 * @export
 */
API.Client.AdGroupCreateCreate.prototype.trackingUrls;
