...
-}
audiencesUpdate : String -> String -> Api.Data.AudienceUpdateRequest -> Api.Request Api.Data.Audience
audiencesUpdate adAccountId_path audienceId_path audienceUpdateRequest_body =
    Api.request
        ...
        []
        []
        (Maybe.map Http.jsonBody (Just (Api.Data.encodeAudienceUpdateRequest audienceUpdateRequest_body)))
        Api.Data.audienceDecoder
