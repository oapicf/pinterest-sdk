...
-}
integrationsCommercePatch : String -> Api.Data.IntegrationRequestPatch -> Api.Request Api.Data.IntegrationMetadata
integrationsCommercePatch externalBusinessId_path integrationRequestPatch_body =
    Api.request
        ...
        []
        []
        (Maybe.map Http.jsonBody (Just (Api.Data.encodeIntegrationRequestPatch integrationRequestPatch_body)))
        Api.Data.integrationMetadataDecoder
...
-}
integrationsCommercePost : Api.Data.IntegrationRequest -> Api.Request Api.Data.IntegrationMetadata
integrationsCommercePost integrationRequest_body =
    Api.request
        ...
        []
        []
        (Maybe.map Http.jsonBody (Just (Api.Data.encodeIntegrationRequest integrationRequest_body)))
        Api.Data.integrationMetadataDecoder
