...
package .Clients is
   ...
   procedure System_User_Update
      (Client : in out Client_Type;
       ...
       System_User_Update_Request_Type : in .Models.SystemUserUpdateRequest_Type);
   ...
   procedure Msot_Events_Create
      (Client : in out Client_Type;
       Ad_Account_Id : in Swagger.UString;
       Conversion_MSOTEvents_Type : in .Models.ConversionMSOTEvents_Type);
   ...
   procedure Targeting_Template_Update
      (Client : in out Client_Type;
       Ad_Account_Id : in Swagger.UString;
       Targeting_Template_Update_Request_Type : in .Models.TargetingTemplateUpdateRequest_Type);
