...
import apimodels.LeadFormArrayResponseItemsInner;
...
public class LeadFormArrayResponse   {
  ...
  private List<@Valid LeadFormArrayResponseItemsInner> items = null;
   ...
   * @return items
  **/
  public List<@Valid LeadFormArrayResponseItemsInner> getItems() {
    return items;
  }
