...
public class TrendsApiController extends Controller {
    private final TrendsApiControllerImpInterface imp;
    private final ObjectMapper mapper;
    private final Config configuration;

    @Inject
    private TrendsApiController(Config configuration, TrendsApiControllerImpInterface imp) {
        this.imp = imp;
    ...
    @ApiAction
    public Result trendsEditorialArticlesList(Http.Request request) throws Exception {
        ...
        return imp.trendsEditorialArticlesListHttp(request, region);
    }
