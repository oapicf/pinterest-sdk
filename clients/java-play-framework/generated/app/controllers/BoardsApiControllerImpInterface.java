...
public abstract class BoardsApiControllerImpInterface {
    ...
    public Result boardSectionsCreateHttp(Http.Request request,  @Pattern(regexp="^\\d+$")String boardId, BoardSectionCreate boardSectionCreate,  @Pattern(regexp="^\\d+$") @Size(max=18)String adAccountId) throws Exception {
        if (!securityAPIUtils.isRequestTokenValid(request, "pinterest_oauth2")) {
            return unauthorized();
        }

        BoardSection obj = boardSectionsCreate(request, boardId, boardSectionCreate, adAccountId);
    ...
    public abstract BoardSection boardSectionsCreate(Http.Request request,  @Pattern(regexp="^\\d+$")String boardId, BoardSectionCreate boardSectionCreate,  @Pattern(regexp="^\\d+$") @Size(max=18)String adAccountId) throws Exception;
    ...
    public Result boardSectionsDeleteHttp(Http.Request request,  @Pattern(regexp="^\\d+$")String boardId,  @Pattern(regexp="^\\d+$")String sectionId,  @Pattern(regexp="^\\d+$") @Size(max=18)String adAccountId) throws Exception {
        ...
        BoardSection obj = boardSectionsDelete(request, boardId, sectionId, adAccountId);
    ...
    public abstract BoardSection boardSectionsDelete(Http.Request request,  @Pattern(regexp="^\\d+$")String boardId,  @Pattern(regexp="^\\d+$")String sectionId,  @Pattern(regexp="^\\d+$") @Size(max=18)String adAccountId) throws Exception;
    ...
    public Result boardSectionsUpdateHttp(Http.Request request,  @Pattern(regexp="^\\d+$")String boardId,  @Pattern(regexp="^\\d+$")String sectionId, BoardSectionUpdateWithRequiredBody boardSectionUpdateWithRequiredBody,  @Pattern(regexp="^\\d+$") @Size(max=18)String adAccountId) throws Exception {
        if (!securityAPIUtils.isRequestTokenValid(request, "pinterest_oauth2")) {
            return unauthorized();
        }

        BoardSection obj = boardSectionsUpdate(request, boardId, sectionId, boardSectionUpdateWithRequiredBody, adAccountId);
    ...
    public abstract BoardSection boardSectionsUpdate(Http.Request request,  @Pattern(regexp="^\\d+$")String boardId,  @Pattern(regexp="^\\d+$")String sectionId, BoardSectionUpdateWithRequiredBody boardSectionUpdateWithRequiredBody,  @Pattern(regexp="^\\d+$") @Size(max=18)String adAccountId) throws Exception;
    ...
    public Result boardsDeleteHttp(Http.Request request,  @Pattern(regexp="^\\d+$")String boardId,  @Pattern(regexp="^\\d+$") @Size(max=18)String adAccountId) throws Exception {
        ...
        Board obj = boardsDelete(request, boardId, adAccountId);
    ...
    public abstract Board boardsDelete(Http.Request request,  @Pattern(regexp="^\\d+$")String boardId,  @Pattern(regexp="^\\d+$") @Size(max=18)String adAccountId) throws Exception;
    ...
    public Result boardsListPinsHttp(Http.Request request,  @Pattern(regexp="^\\d+$")String boardId, List<CreativeType> creativeTypes,  @Pattern(regexp="^\\d+$") @Size(max=18)String adAccountId, Boolean pinMetrics, String bookmark,  @Min(1) @Max(250)Integer pageSize) throws Exception {
        if (!securityAPIUtils.isRequestTokenValid(request, "pinterest_oauth2")) {
            return unauthorized();
        }

        BoardsListPins200Response obj = boardsListPins(request, boardId, creativeTypes, adAccountId, pinMetrics, bookmark, pageSize);
    ...
    public abstract BoardsListPins200Response boardsListPins(Http.Request request,  @Pattern(regexp="^\\d+$")String boardId, List<CreativeType> creativeTypes,  @Pattern(regexp="^\\d+$") @Size(max=18)String adAccountId, Boolean pinMetrics, String bookmark,  @Min(1) @Max(250)Integer pageSize) throws Exception;
