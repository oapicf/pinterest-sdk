...
public abstract class MediaApiControllerImpInterface {
    ...
    public Result mediaListHttp(Http.Request request, String bookmark,  @Min(1) @Max(100)Integer pageSize) throws Exception {
        if (!securityAPIUtils.isRequestTokenValid(request, "pinterest_oauth2")) {
            return unauthorized();
        }

        Paginated obj = mediaList(request, bookmark, pageSize);
    ...
    public abstract Paginated mediaList(Http.Request request, String bookmark,  @Min(1) @Max(100)Integer pageSize) throws Exception;
