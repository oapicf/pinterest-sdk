...
**collectionsUnderscoreheaderUnderscoretype** | [**CollectionsHeaderType**](CollectionsHeaderType.md) |  | [optional] [default to null]
...
**customizableUnderscorectaUnderscoretype** | [**ProductGroupPromotionCustomizableCTAType**](ProductGroupPromotionCustomizableCTAType.md) |  | [optional] [default to null]
...
**isUnderscoregenerateUnderscorebackground** | **boolean** |  | [optional] [default to null]
**isUnderscoreimageUnderscoreautoUnderscoreresizing** | **boolean** |  | [optional] [default to null]
**isUnderscoremdl** | **boolean** | is_mdl | [optional] [default to null]
**parentUnderscoreid** | **string** | parent_id | [optional] [default to null]
**preferredUnderscoremediaUnderscoretype** | [**PreferredMediaType**](PreferredMediaType.md) |  | [optional] [default to null]
**relativeUnderscoredefinition** | **string** | relative_definition | [optional] [default to null]
**selectedUnderscoreimageUnderscoretag** | **string** |  | [optional] [default to null]
**selectedUnderscorevideoUnderscoretag** | **string** |  | [optional] [default to null]
