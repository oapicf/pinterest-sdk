 ...
 */
case class ProductGroupPromotionCreateRequestElement(id: Option[String],
...
object ProductGroupPromotionCreateRequestElement {
    /**
     * Creates the codec for converting ProductGroupPromotionCreateRequestElement from and to JSON.
     */
    implicit val decoder: Decoder[ProductGroupPromotionCreateRequestElement] = deriveDecoder
    implicit val encoder: ObjectEncoder[ProductGroupPromotionCreateRequestElement] = deriveEncoder
}
