...
import org.openapitools.models.ItemAttributesRequestAllOfImageLink
 ...
 * @param saveUnderscorepinUnderscoredisabled By default, product pins created from a catalog are able to be saved by Pinners. If you want to disable the save pin feature, set this attribute to true. This feature is only available for allowlisted merchants. Please contact your account manager to enable this feature.
 * @param videoUnderscorelink <p><= 2,000 characters</p> <p>Hosted link to the product video.</p> <p>File types for linked videos must be .mp4, .mov or .m4v.</p> <p>File size cannot exceed 2GB.</p>
 */
case class ItemAttributesRequest(adUnderscoreimageUnderscore0Underscorelink: Option[String],
                ...
                imageUnderscorelink: Option[ItemAttributesRequestAllOfImageLink],
                saveUnderscorepinUnderscoredisabled: Option[Boolean],
                videoUnderscorelink: Option[String]
                )

object ItemAttributesRequest {
    /**
     * Creates the codec for converting ItemAttributesRequest from and to JSON.
     */
    implicit val decoder: Decoder[ItemAttributesRequest] = deriveDecoder
    implicit val encoder: ObjectEncoder[ItemAttributesRequest] = deriveEncoder
}
