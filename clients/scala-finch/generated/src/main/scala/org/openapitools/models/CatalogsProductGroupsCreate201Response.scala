 ...
 */
case class CatalogsProductGroupsCreate201Response(id: String,
                name: Option[String],
...
object CatalogsProductGroupsCreate201Response {
    /**
     * Creates the codec for converting CatalogsProductGroupsCreate201Response from and to JSON.
     */
    implicit val decoder: Decoder[CatalogsProductGroupsCreate201Response] = deriveDecoder
    implicit val encoder: ObjectEncoder[CatalogsProductGroupsCreate201Response] = deriveEncoder
}
