...
object AdCommon {
    /**
     * Creates the codec for converting AdCommon from and to JSON.
     */
    implicit val decoder: Decoder[AdCommon] = deriveDecoder
    implicit val encoder: ObjectEncoder[AdCommon] = deriveEncoder
}
