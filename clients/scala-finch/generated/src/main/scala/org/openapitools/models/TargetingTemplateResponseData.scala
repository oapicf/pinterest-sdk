...
object TargetingTemplateResponseData {
    /**
     * Creates the codec for converting TargetingTemplateResponseData from and to JSON.
     */
    implicit val decoder: Decoder[TargetingTemplateResponseData] = deriveDecoder
    implicit val encoder: ObjectEncoder[TargetingTemplateResponseData] = deriveEncoder
}
