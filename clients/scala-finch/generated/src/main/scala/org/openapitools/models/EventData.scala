 ...
 */
case class EventData(currency: Option[Currency],
...
object EventData {
    /**
     * Creates the codec for converting EventData from and to JSON.
     */
    implicit val decoder: Decoder[EventData] = deriveDecoder
    implicit val encoder: ObjectEncoder[EventData] = deriveEncoder
}
