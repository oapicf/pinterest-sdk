...
import org.openapitools.models.AdvancedAuctionItemsSubmitDeleteRecord
import org.openapitools.models.AdvancedAuctionItemsSubmitUpsertRecord
import org.openapitools.models.AdvancedAuctionOperation
 ...
 */
case class AdvancedAuctionItemsSubmitRecord(operation: AdvancedAuctionOperation,
...
object AdvancedAuctionItemsSubmitRecord {
    /**
     * Creates the codec for converting AdvancedAuctionItemsSubmitRecord from and to JSON.
     */
    implicit val decoder: Decoder[AdvancedAuctionItemsSubmitRecord] = deriveDecoder
    implicit val encoder: ObjectEncoder[AdvancedAuctionItemsSubmitRecord] = deriveEncoder
}
