 ...
 * @param status 
 */
case class LeadFormCreateRequest(completionUnderscoremessage: Option[String],
...
object LeadFormCreateRequest {
    /**
     * Creates the codec for converting LeadFormCreateRequest from and to JSON.
     */
    implicit val decoder: Decoder[LeadFormCreateRequest] = deriveDecoder
    implicit val encoder: ObjectEncoder[LeadFormCreateRequest] = deriveEncoder
}
