 ...
 */
case class LeadSubscription(adUnderscoreaccountUnderscoreid: Option[String],
...
object LeadSubscription {
    /**
     * Creates the codec for converting LeadSubscription from and to JSON.
     */
    implicit val decoder: Decoder[LeadSubscription] = deriveDecoder
    implicit val encoder: ObjectEncoder[LeadSubscription] = deriveEncoder
}
