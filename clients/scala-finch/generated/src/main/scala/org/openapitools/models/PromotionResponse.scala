 ...
 * @param adUnderscoreaccountUnderscoreid The Ad Account ID that this promotion belongs to.
 * @param id Promotion ID
 * @param status 
 */
case class PromotionResponse(discountUnderscorestatus: Option[String],
...
object PromotionResponse {
    /**
     * Creates the codec for converting PromotionResponse from and to JSON.
     */
    implicit val decoder: Decoder[PromotionResponse] = deriveDecoder
    implicit val encoder: ObjectEncoder[PromotionResponse] = deriveEncoder
}
