 ...
 */
case class ConversionEventsUserDataAnyOf(em: Seq[String],
...
object ConversionEventsUserDataAnyOf {
    /**
     * Creates the codec for converting ConversionEventsUserDataAnyOf from and to JSON.
     */
    implicit val decoder: Decoder[ConversionEventsUserDataAnyOf] = deriveDecoder
    implicit val encoder: ObjectEncoder[ConversionEventsUserDataAnyOf] = deriveEncoder
}
