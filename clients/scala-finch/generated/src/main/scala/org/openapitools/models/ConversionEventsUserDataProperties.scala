 ...
 */
case class ConversionEventsUserDataProperties(clickUnderscoreid: Option[String],
...
object ConversionEventsUserDataProperties {
    /**
     * Creates the codec for converting ConversionEventsUserDataProperties from and to JSON.
     */
    implicit val decoder: Decoder[ConversionEventsUserDataProperties] = deriveDecoder
    implicit val encoder: ObjectEncoder[ConversionEventsUserDataProperties] = deriveEncoder
}
