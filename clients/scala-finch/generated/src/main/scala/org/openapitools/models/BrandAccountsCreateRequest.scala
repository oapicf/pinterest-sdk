 ...
 */
case class BrandAccountsCreateRequest(name: String,
                username: String,
                country: Country,
                about: Option[String],
...
object BrandAccountsCreateRequest {
    /**
     * Creates the codec for converting BrandAccountsCreateRequest from and to JSON.
     */
    implicit val decoder: Decoder[BrandAccountsCreateRequest] = deriveDecoder
    implicit val encoder: ObjectEncoder[BrandAccountsCreateRequest] = deriveEncoder
}
