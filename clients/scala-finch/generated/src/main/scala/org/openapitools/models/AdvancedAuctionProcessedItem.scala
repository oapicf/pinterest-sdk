 ...
 */
case class AdvancedAuctionProcessedItem(operation: AdvancedAuctionOperation,
...
object AdvancedAuctionProcessedItem {
    /**
     * Creates the codec for converting AdvancedAuctionProcessedItem from and to JSON.
     */
    implicit val decoder: Decoder[AdvancedAuctionProcessedItem] = deriveDecoder
    implicit val encoder: ObjectEncoder[AdvancedAuctionProcessedItem] = deriveEncoder
}
