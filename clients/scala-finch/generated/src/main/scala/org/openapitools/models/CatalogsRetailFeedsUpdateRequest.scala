 ...
 */
case class CatalogsRetailFeedsUpdateRequest(defaultUnderscorecurrency: Option[NullableCurrency],
                name: Option[String],
...
object CatalogsRetailFeedsUpdateRequest {
    /**
     * Creates the codec for converting CatalogsRetailFeedsUpdateRequest from and to JSON.
     */
    implicit val decoder: Decoder[CatalogsRetailFeedsUpdateRequest] = deriveDecoder
    implicit val encoder: ObjectEncoder[CatalogsRetailFeedsUpdateRequest] = deriveEncoder
}
