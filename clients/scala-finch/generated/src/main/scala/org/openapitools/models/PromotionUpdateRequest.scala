 ...
 * @param status 
 */
case class PromotionUpdateRequest(discountUnderscorestatus: Option[String],
...
object PromotionUpdateRequest {
    /**
     * Creates the codec for converting PromotionUpdateRequest from and to JSON.
     */
    implicit val decoder: Decoder[PromotionUpdateRequest] = deriveDecoder
    implicit val encoder: ObjectEncoder[PromotionUpdateRequest] = deriveEncoder
}
