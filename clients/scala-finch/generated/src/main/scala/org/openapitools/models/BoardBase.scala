 ...
 */
case class BoardBase(boardUnderscorepinsUnderscoremodifiedUnderscoreat: Option[ZonedDateTime],
...
object BoardBase {
    /**
     * Creates the codec for converting BoardBase from and to JSON.
     */
    implicit val decoder: Decoder[BoardBase] = deriveDecoder
    implicit val encoder: ObjectEncoder[BoardBase] = deriveEncoder
}
