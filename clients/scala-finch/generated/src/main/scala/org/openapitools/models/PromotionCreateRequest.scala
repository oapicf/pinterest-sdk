 ...
 */
case class PromotionCreateRequest(discountUnderscorestatus: Option[String],
                ...
                promotionUnderscoretitle: String,
                promotionUnderscoretype: PromotionType,
...
object PromotionCreateRequest {
    /**
     * Creates the codec for converting PromotionCreateRequest from and to JSON.
     */
    implicit val decoder: Decoder[PromotionCreateRequest] = deriveDecoder
    implicit val encoder: ObjectEncoder[PromotionCreateRequest] = deriveEncoder
}
