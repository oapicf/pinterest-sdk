 ...
 */
case class CustomerListUpload(adUnderscoreaccountUnderscoreid: String,
...
object CustomerListUpload {
    /**
     * Creates the codec for converting CustomerListUpload from and to JSON.
     */
    implicit val decoder: Decoder[CustomerListUpload] = deriveDecoder
    implicit val encoder: ObjectEncoder[CustomerListUpload] = deriveEncoder
}
