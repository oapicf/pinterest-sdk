 ...
 */
case class AdGroupCommon(autoUnderscoretargetingUnderscoreenabled: Option[Boolean],
...
object AdGroupCommon {
    /**
     * Creates the codec for converting AdGroupCommon from and to JSON.
     */
    implicit val decoder: Decoder[AdGroupCommon] = deriveDecoder
    implicit val encoder: ObjectEncoder[AdGroupCommon] = deriveEncoder
}
