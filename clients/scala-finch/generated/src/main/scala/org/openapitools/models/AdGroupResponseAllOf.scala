 ...
 */
case class AdGroupResponseAllOf(name: Option[String],
...
object AdGroupResponseAllOf {
    /**
     * Creates the codec for converting AdGroupResponseAllOf from and to JSON.
     */
    implicit val decoder: Decoder[AdGroupResponseAllOf] = deriveDecoder
    implicit val encoder: ObjectEncoder[AdGroupResponseAllOf] = deriveEncoder
}
