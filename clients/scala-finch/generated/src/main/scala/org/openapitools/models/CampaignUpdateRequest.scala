...
import org.openapitools.models.CampaignBidOptionsUpdate
...
case class CampaignUpdateRequest(id: String,
                ...
                bidUnderscoreoptions: Option[CampaignBidOptionsUpdate],
...
object CampaignUpdateRequest {
    /**
     * Creates the codec for converting CampaignUpdateRequest from and to JSON.
     */
    implicit val decoder: Decoder[CampaignUpdateRequest] = deriveDecoder
    implicit val encoder: ObjectEncoder[CampaignUpdateRequest] = deriveEncoder
}
