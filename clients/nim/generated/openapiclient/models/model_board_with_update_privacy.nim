...
type BoardWithUpdatePrivacy* = object
  ## 
...
# Custom JSON deserialization for BoardWithUpdatePrivacy with custom field names
proc to*(node: JsonNode, T: typedesc[BoardWithUpdatePrivacy]): BoardWithUpdatePrivacy =
  result = BoardWithUpdatePrivacy()
...
# Custom JSON serialization for BoardWithUpdatePrivacy with custom field names
proc `%`*(obj: BoardWithUpdatePrivacy): JsonNode =
  result = newJObject()
