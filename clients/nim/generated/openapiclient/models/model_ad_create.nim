...
# Custom JSON deserialization for AdCreate with custom field names
proc to*(node: JsonNode, T: typedesc[AdCreate]): AdCreate =
  result = AdCreate()
...
# Custom JSON serialization for AdCreate with custom field names
proc `%`*(obj: AdCreate): JsonNode =
  result = newJObject()
