...
type SSIOInsertionOrderUpdate* = object
...
# Custom JSON deserialization for SSIOInsertionOrderUpdate with custom field names
proc to*(node: JsonNode, T: typedesc[SSIOInsertionOrderUpdate]): SSIOInsertionOrderUpdate =
  result = SSIOInsertionOrderUpdate()
...
# Custom JSON serialization for SSIOInsertionOrderUpdate with custom field names
proc `%`*(obj: SSIOInsertionOrderUpdate): JsonNode =
  result = newJObject()
