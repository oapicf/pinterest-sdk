...
# Custom JSON deserialization for OauthAccessTokenResponseEverlastingRefresh with custom field names
proc to*(node: JsonNode, T: typedesc[OauthAccessTokenResponseEverlastingRefresh]): OauthAccessTokenResponseEverlastingRefresh =
  result = OauthAccessTokenResponseEverlastingRefresh()
...
# Custom JSON serialization for OauthAccessTokenResponseEverlastingRefresh with custom field names
proc `%`*(obj: OauthAccessTokenResponseEverlastingRefresh): JsonNode =
  result = newJObject()
