...
type DeletePartnerAssetAccessResult* = object
  ...
  isSharedPartner*: Option[bool] ## If is_shared_partner=FALSE, you terminated a partner's asset access to your business asset. If is_shared_partner=TRUE, you terminated your asset access to your partner's business asset.
...
# Custom JSON deserialization for DeletePartnerAssetAccessResult with custom field names
proc to*(node: JsonNode, T: typedesc[DeletePartnerAssetAccessResult]): DeletePartnerAssetAccessResult =
  result = DeletePartnerAssetAccessResult()
...
# Custom JSON serialization for DeletePartnerAssetAccessResult with custom field names
proc `%`*(obj: DeletePartnerAssetAccessResult): JsonNode =
  result = newJObject()
