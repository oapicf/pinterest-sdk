...
type UpdatePartnerAssetAccessItem* = object
  ## 
...
# Custom JSON deserialization for UpdatePartnerAssetAccessItem with custom field names
proc to*(node: JsonNode, T: typedesc[UpdatePartnerAssetAccessItem]): UpdatePartnerAssetAccessItem =
  result = UpdatePartnerAssetAccessItem()
...
# Custom JSON serialization for UpdatePartnerAssetAccessItem with custom field names
proc `%`*(obj: UpdatePartnerAssetAccessItem): JsonNode =
  result = newJObject()
