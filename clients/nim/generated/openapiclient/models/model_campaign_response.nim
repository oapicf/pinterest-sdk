...
# Custom JSON deserialization for CampaignResponse with custom field names
proc to*(node: JsonNode, T: typedesc[CampaignResponse]): CampaignResponse =
...
# Custom JSON serialization for CampaignResponse with custom field names
proc `%`*(obj: CampaignResponse): JsonNode =
  result = newJObject()
  if obj.id.isSome():
