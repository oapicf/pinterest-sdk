...
type ProductGroupPromotionResponseElement* = object
  ## 
...
# Custom JSON deserialization for ProductGroupPromotionResponseElement with custom field names
proc to*(node: JsonNode, T: typedesc[ProductGroupPromotionResponseElement]): ProductGroupPromotionResponseElement =
  result = ProductGroupPromotionResponseElement()
...
# Custom JSON serialization for ProductGroupPromotionResponseElement with custom field names
proc `%`*(obj: ProductGroupPromotionResponseElement): JsonNode =
  result = newJObject()
  if obj.id.isSome():
