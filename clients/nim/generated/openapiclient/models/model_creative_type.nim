...
func `%`*(v: CreativeType): JsonNode =
  result = case v:
    ...
    of CreativeType.COLLAGE: %"COLLAGE"
    of CreativeType.MAXWIDTHREGULARCOLLECTION: %"MAX_WIDTH_REGULAR_COLLECTION"
    of CreativeType.MAXWIDTHVIDEOCOLLECTION: %"MAX_WIDTH_VIDEO_COLLECTION"
    of CreativeType.APP: %"APP"
