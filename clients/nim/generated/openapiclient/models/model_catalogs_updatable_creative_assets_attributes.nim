...
# Custom JSON deserialization for CatalogsUpdatableCreativeAssetsAttributes with custom field names
proc to*(node: JsonNode, T: typedesc[CatalogsUpdatableCreativeAssetsAttributes]): CatalogsUpdatableCreativeAssetsAttributes =
  result = CatalogsUpdatableCreativeAssetsAttributes()
...
# Custom JSON serialization for CatalogsUpdatableCreativeAssetsAttributes with custom field names
proc `%`*(obj: CatalogsUpdatableCreativeAssetsAttributes): JsonNode =
  result = newJObject()
