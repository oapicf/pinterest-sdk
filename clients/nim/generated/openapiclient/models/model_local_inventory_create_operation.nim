...
type LocalInventoryCreateOperation* = object
...
# Custom JSON deserialization for LocalInventoryCreateOperation with custom field names
proc to*(node: JsonNode, T: typedesc[LocalInventoryCreateOperation]): LocalInventoryCreateOperation =
  result = LocalInventoryCreateOperation()
...
# Custom JSON serialization for LocalInventoryCreateOperation with custom field names
proc `%`*(obj: LocalInventoryCreateOperation): JsonNode =
  result = newJObject()
