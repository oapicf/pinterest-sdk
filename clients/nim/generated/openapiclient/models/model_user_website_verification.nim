...
type UserWebsiteVerification* = object
  ## 
...
# Custom JSON deserialization for UserWebsiteVerification with custom field names
proc to*(node: JsonNode, T: typedesc[UserWebsiteVerification]): UserWebsiteVerification =
  result = UserWebsiteVerification()
...
# Custom JSON serialization for UserWebsiteVerification with custom field names
proc `%`*(obj: UserWebsiteVerification): JsonNode =
  result = newJObject()
