...
type AuthRespondInviteAction* = object
  ## 
...
# Custom JSON deserialization for AuthRespondInviteAction with custom field names
proc to*(node: JsonNode, T: typedesc[AuthRespondInviteAction]): AuthRespondInviteAction =
  result = AuthRespondInviteAction()
...
# Custom JSON serialization for AuthRespondInviteAction with custom field names
proc `%`*(obj: AuthRespondInviteAction): JsonNode =
  result = newJObject()
