...
type TopPinsAnalyticsResponsePinsItems* = object
...
# Custom JSON deserialization for TopPinsAnalyticsResponsePinsItems with custom field names
proc to*(node: JsonNode, T: typedesc[TopPinsAnalyticsResponsePinsItems]): TopPinsAnalyticsResponsePinsItems =
  result = TopPinsAnalyticsResponsePinsItems()
...
# Custom JSON serialization for TopPinsAnalyticsResponsePinsItems with custom field names
proc `%`*(obj: TopPinsAnalyticsResponsePinsItems): JsonNode =
  result = newJObject()
