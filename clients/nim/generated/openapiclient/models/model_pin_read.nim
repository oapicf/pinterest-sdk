...
# Custom JSON deserialization for PinRead with custom field names
proc to*(node: JsonNode, T: typedesc[PinRead]): PinRead =
  result = PinRead()
...
# Custom JSON serialization for PinRead with custom field names
proc `%`*(obj: PinRead): JsonNode =
  result = newJObject()
