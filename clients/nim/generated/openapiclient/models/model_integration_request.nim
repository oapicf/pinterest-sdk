...
# Custom JSON deserialization for IntegrationRequest with custom field names
proc to*(node: JsonNode, T: typedesc[IntegrationRequest]): IntegrationRequest =
...
# Custom JSON serialization for IntegrationRequest with custom field names
proc `%`*(obj: IntegrationRequest): JsonNode =
  result = newJObject()
