...
type NullableOptimizationGoalMetadata* = object
  ## 
...
# Custom JSON deserialization for NullableOptimizationGoalMetadata with custom field names
proc to*(node: JsonNode, T: typedesc[NullableOptimizationGoalMetadata]): NullableOptimizationGoalMetadata =
  result = NullableOptimizationGoalMetadata()
...
# Custom JSON serialization for NullableOptimizationGoalMetadata with custom field names
proc `%`*(obj: NullableOptimizationGoalMetadata): JsonNode =
  result = newJObject()
