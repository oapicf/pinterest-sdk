...
type LeadFormBatchUpdate* = object
  ## 
...
# Custom JSON deserialization for LeadFormBatchUpdate with custom field names
proc to*(node: JsonNode, T: typedesc[LeadFormBatchUpdate]): LeadFormBatchUpdate =
  result = LeadFormBatchUpdate()
...
# Custom JSON serialization for LeadFormBatchUpdate with custom field names
proc `%`*(obj: LeadFormBatchUpdate): JsonNode =
  result = newJObject()
