...
type ProductGroupPromotionCreateRequestElement* = object
  ## 
...
# Custom JSON deserialization for ProductGroupPromotionCreateRequestElement with custom field names
proc to*(node: JsonNode, T: typedesc[ProductGroupPromotionCreateRequestElement]): ProductGroupPromotionCreateRequestElement =
  result = ProductGroupPromotionCreateRequestElement()
...
# Custom JSON serialization for ProductGroupPromotionCreateRequestElement with custom field names
proc `%`*(obj: ProductGroupPromotionCreateRequestElement): JsonNode =
  result = newJObject()
  if obj.id.isSome():
