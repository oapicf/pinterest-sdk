...
type InviteDataResponse* = object
  ...
  inviteType*: Option[string] ## The type of invite. - 'MEMBER_INVITE' is to invite a member to access your business assets. - 'PARTNER_INVITE' is to invite a partner to access your business assets. - 'PARTNER_REQUEST' is to request access a partner's business assets.
...
# Custom JSON deserialization for InviteDataResponse with custom field names
proc to*(node: JsonNode, T: typedesc[InviteDataResponse]): InviteDataResponse =
  result = InviteDataResponse()
...
# Custom JSON serialization for InviteDataResponse with custom field names
proc `%`*(obj: InviteDataResponse): JsonNode =
  result = newJObject()
