...
type SSIOOrderLine* = object
  ...
  acceptedTermsTime*: Option[string] ## The UTC timestamp (to the nearest second) when terms were accepted.
  adsManagerOrderLineId*: Option[string] ## Ads manager order line id
  ...
  mediaContactFirstname*: Option[string] ## Billing media contact first name
  mediaContactLastname*: Option[string] ## Billing media contact last name
  ...
  salesforceOrderLineId*: Option[string] ## Order line id in SFDC
