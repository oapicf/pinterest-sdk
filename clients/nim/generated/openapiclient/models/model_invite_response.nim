...
type InviteResponse* = object
  ...
  createdByBusiness*: Option[BusinessAccessUserSummary] ## Metadata for the business that created the invite/request.
  createdByUser*: Option[BusinessAccessUserSummary] ## Metadata for the user that created the invite/request.
