...
# Custom JSON deserialization for AdBatchUpdate with custom field names
proc to*(node: JsonNode, T: typedesc[AdBatchUpdate]): AdBatchUpdate =
  result = AdBatchUpdate()
...
# Custom JSON serialization for AdBatchUpdate with custom field names
proc `%`*(obj: AdBatchUpdate): JsonNode =
  result = newJObject()
