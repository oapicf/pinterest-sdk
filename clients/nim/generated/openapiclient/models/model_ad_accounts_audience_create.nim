...
type AdAccountsAudienceCreate* = object
...
# Custom JSON deserialization for AdAccountsAudienceCreate with custom field names
proc to*(node: JsonNode, T: typedesc[AdAccountsAudienceCreate]): AdAccountsAudienceCreate =
  result = AdAccountsAudienceCreate()
...
# Custom JSON serialization for AdAccountsAudienceCreate with custom field names
proc `%`*(obj: AdAccountsAudienceCreate): JsonNode =
  result = newJObject()
