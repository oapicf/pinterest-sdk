...
type AssetGroupDeleteError* = object
  ## 
...
# Custom JSON deserialization for AssetGroupDeleteError with custom field names
proc to*(node: JsonNode, T: typedesc[AssetGroupDeleteError]): AssetGroupDeleteError =
  result = AssetGroupDeleteError()
...
# Custom JSON serialization for AssetGroupDeleteError with custom field names
proc `%`*(obj: AssetGroupDeleteError): JsonNode =
  result = newJObject()
