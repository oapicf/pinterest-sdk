...
# Custom JSON deserialization for LeadFormCreate with custom field names
proc to*(node: JsonNode, T: typedesc[LeadFormCreate]): LeadFormCreate =
  result = LeadFormCreate()
...
# Custom JSON serialization for LeadFormCreate with custom field names
proc `%`*(obj: LeadFormCreate): JsonNode =
  result = newJObject()
