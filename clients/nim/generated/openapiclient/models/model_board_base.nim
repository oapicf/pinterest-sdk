...
# Custom JSON deserialization for BoardBase with custom field names
proc to*(node: JsonNode, T: typedesc[BoardBase]): BoardBase =
  result = BoardBase()
...
# Custom JSON serialization for BoardBase with custom field names
proc `%`*(obj: BoardBase): JsonNode =
  result = newJObject()
