...
# Custom JSON deserialization for CatalogsRetailFeedsUpdateRequest with custom field names
proc to*(node: JsonNode, T: typedesc[CatalogsRetailFeedsUpdateRequest]): CatalogsRetailFeedsUpdateRequest =
  result = CatalogsRetailFeedsUpdateRequest()
...
# Custom JSON serialization for CatalogsRetailFeedsUpdateRequest with custom field names
proc `%`*(obj: CatalogsRetailFeedsUpdateRequest): JsonNode =
  result = newJObject()
