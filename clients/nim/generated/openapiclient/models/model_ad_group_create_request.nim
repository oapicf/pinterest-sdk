...
type AdGroupCreateRequest* = object
  ## 
...
# Custom JSON deserialization for AdGroupCreateRequest with custom field names
proc to*(node: JsonNode, T: typedesc[AdGroupCreateRequest]): AdGroupCreateRequest =
  result = AdGroupCreateRequest()
...
# Custom JSON serialization for AdGroupCreateRequest with custom field names
proc `%`*(obj: AdGroupCreateRequest): JsonNode =
  result = newJObject()
