...
# Custom JSON deserialization for PinBase with custom field names
proc to*(node: JsonNode, T: typedesc[PinBase]): PinBase =
  result = PinBase()
...
# Custom JSON serialization for PinBase with custom field names
proc `%`*(obj: PinBase): JsonNode =
  result = newJObject()
