...
# Custom JSON deserialization for SSIOAccount with custom field names
proc to*(node: JsonNode, T: typedesc[SSIOAccount]): SSIOAccount =
  result = SSIOAccount()
...
# Custom JSON serialization for SSIOAccount with custom field names
proc `%`*(obj: SSIOAccount): JsonNode =
  result = newJObject()
