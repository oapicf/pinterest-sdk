...
type IntegrationMetadataUpdate* = object
...
# Custom JSON deserialization for IntegrationMetadataUpdate with custom field names
proc to*(node: JsonNode, T: typedesc[IntegrationMetadataUpdate]): IntegrationMetadataUpdate =
  result = IntegrationMetadataUpdate()
...
# Custom JSON serialization for IntegrationMetadataUpdate with custom field names
proc `%`*(obj: IntegrationMetadataUpdate): JsonNode =
  result = newJObject()
