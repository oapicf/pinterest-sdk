...
type CatalogsRetailItemsBatch* = object
  ...
  createdTime*: Option[string] ## Date and time (UTC) of the batch creation: YYYY-MM-DD'T'hh:mm:ss. If null, batch creation was skipped due to a recent duplicate ingestion.
