...
# Custom JSON deserialization for OauthAccessTokenResponseIntegrationRefresh with custom field names
proc to*(node: JsonNode, T: typedesc[OauthAccessTokenResponseIntegrationRefresh]): OauthAccessTokenResponseIntegrationRefresh =
  result = OauthAccessTokenResponseIntegrationRefresh()
...
# Custom JSON serialization for OauthAccessTokenResponseIntegrationRefresh with custom field names
proc `%`*(obj: OauthAccessTokenResponseIntegrationRefresh): JsonNode =
  result = newJObject()
