...
type CatalogsRetailFeedsCreateRequest* = object
  ...
  catalogId*: Option[string] ## Catalog id pertaining to the feed. If not provided, feed will use a default catalog based on type. Currently, this field has no effect.
