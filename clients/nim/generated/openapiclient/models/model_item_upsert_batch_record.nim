...
# Custom JSON deserialization for ItemUpsertBatchRecord with custom field names
proc to*(node: JsonNode, T: typedesc[ItemUpsertBatchRecord]): ItemUpsertBatchRecord =
  result = ItemUpsertBatchRecord()
...
# Custom JSON serialization for ItemUpsertBatchRecord with custom field names
proc `%`*(obj: ItemUpsertBatchRecord): JsonNode =
  result = newJObject()
