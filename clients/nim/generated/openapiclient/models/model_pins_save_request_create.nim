...
type PinsSaveRequestCreate* = object
...
# Custom JSON deserialization for PinsSaveRequestCreate with custom field names
proc to*(node: JsonNode, T: typedesc[PinsSaveRequestCreate]): PinsSaveRequestCreate =
  result = PinsSaveRequestCreate()
...
# Custom JSON serialization for PinsSaveRequestCreate with custom field names
proc `%`*(obj: PinsSaveRequestCreate): JsonNode =
  result = newJObject()
