...
# Custom JSON deserialization for FollowUserCreate with custom field names
proc to*(node: JsonNode, T: typedesc[FollowUserCreate]): FollowUserCreate =
  result = FollowUserCreate()
...
# Custom JSON serialization for FollowUserCreate with custom field names
proc `%`*(obj: FollowUserCreate): JsonNode =
  result = newJObject()
