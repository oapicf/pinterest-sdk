...
import ../models/model_cancel_invites_request
import ../models/model_cancel_invites_response
...
import ../models/model_invite_filter_status
...
proc cancelInvitesOrRequests*(httpClient: HttpClient, businessId: string, cancelInvitesRequest: CancelInvitesRequest): (Option[CancelInvitesResponse], Response) =
  ## Cancel invites/requests
  httpClient.headers["Content-Type"] = "application/json"
  let response = httpClient.request(basepath & fmt"/businesses/{business_id}/invites", httpMethod = HttpDelete, body = $(%cancelInvitesRequest))
  constructResult[CancelInvitesResponse](response)
...
proc getInvites*(httpClient: HttpClient, businessId: string, isMember: bool, inviteStatus: seq[InviteFilterStatus], inviteType: InviteType, bookmark: string, pageSize: int): (Option[get_invites_200_response], Response) =
