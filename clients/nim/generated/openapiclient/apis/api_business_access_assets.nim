...
proc businessAssetMembersGet*(httpClient: HttpClient, businessId: string, assetId: string, fetchSystemUsers: bool, bookmark: string, pageSize: int, startIndex: int): (Option[business_asset_members_get_200_response], Response) =
