...
import ../models/model_catalogs_report_stats_parameters
...
proc reportsStats*(httpClient: HttpClient, parameters: CatalogsReportStatsParameters, adAccountId: string, bookmark: string, pageSize: int): (Option[reports_stats_200_response], Response) =
  ## List report stats
  var query_params_list: seq[(string, string)] = @[]
  if $adAccountId != "":
    query_params_list.add(("ad_account_id", $adAccountId))
