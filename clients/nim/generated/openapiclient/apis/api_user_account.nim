...
proc userAccountFollowedInterests*(httpClient: HttpClient, username: string, bookmark: string, pageSize: int): (Option[user_account_followed_interests_200_response], Response) {.deprecated.} =
