...
proc billingInvoicesGet*(httpClient: HttpClient, adAccountId: string, bookmark: string, pageSize: int, sort: string, order: string, status: string, documentType: string, startDueDate: string, endDueDate: string): (Option[billing_invoices_get_200_response], Response) =
