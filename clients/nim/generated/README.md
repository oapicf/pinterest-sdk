...
api_ad_accounts | analyticsCreateConversionProductReport | **POST** /ad_accounts/{ad_account_id}/reports/brand_category_sku | Create a request for a brand, category, SKU report
...
api_ad_accounts | analyticsGetConversionProductReport | **GET** /ad_accounts/{ad_account_id}/reports/brand_category_sku | Get advertiser brand, category, SKU report
...
api_ad_groups | adGroupsDynamicTitlesDownloadCsv | **GET** /ad_accounts/{ad_account_id}/ad_groups/{ad_group_id}/dynamic_titles/csv | Get dynamic titles CSV download URL
api_ad_groups | adGroupsDynamicTitlesGetStatus | **GET** /ad_accounts/{ad_account_id}/ad_groups/{ad_group_id}/dynamic_titles/status | Get dynamic titles status
api_ad_groups | adGroupsDynamicTitlesGetUploadUrl | **GET** /ad_accounts/{ad_account_id}/ad_groups/{ad_group_id}/dynamic_titles/uploads | Get dynamic titles upload URL
api_ad_groups | adGroupsDynamicTitlesProcessCsv | **POST** /ad_accounts/{ad_account_id}/ad_groups/{ad_group_id}/dynamic_titles | Process dynamic titles CSV
...
api_ad_groups | getAdGroupsByPromotionIdsList | **GET** /ad_accounts/{ad_account_id}/promotion_applied_entities | List of ad groups using promotions IDs.
...
api_ads | campaignAdPreviewCreate | **POST** /ad_accounts/{ad_account_id}/campaign_ad_preview | Create ad preview records for one or more ad groups
api_ads | campaignAdPreviewDelete | **DELETE** /ad_accounts/{ad_account_id}/campaign_ad_preview | Delete ad preview records for one or more ad groups
api_ads | campaignAdPreviewRead | **GET** /ad_accounts/{ad_account_id}/campaign_ad_preview | Fetch ad preview records for one or more ad groups
...
api_billing | billingInvoiceDownloadGet | **GET** /ad_accounts/{ad_account_id}/billing_invoice/{billing_invoice_id}/download | Get download url for a billing invoice
api_billing | billingInvoicesGet | **GET** /ad_accounts/{ad_account_id}/billing_invoices | Get billing invoices
...
api_business_access_relationships | brandAccountsCreate | **POST** /business_access/business_hierarchy/{business_hierarchy_id}/brand_accounts | Create a Brand Account
api_business_access_relationships | brandAccountsUpdate | **PATCH** /business_access/business_hierarchy/{business_hierarchy_id}/brand_accounts/{brand_account_id} | Update a Brand Account
...
api_business_access_relationships | systemUserUpdate | **PATCH** /businesses/{business_id}/system_users/{system_user_id} | Update a system user information.
...
api_campaigns | adPinsAnalytics | **GET** /ad_accounts/{ad_account_id}/pins/analytics | Get pins analytics
...
api_campaigns | getCampaignDeliveryEstimates | **POST** /ad_accounts/{ad_account_id}/campaigns/delivery_estimates | Get campaign delivery estimates
api_catalog_feeds | feedProcessingResultsList | **GET** /catalogs/feeds/{feed_id}/processing_results | List feed processing results
api_catalog_feeds | feedsCreate | **POST** /catalogs/feeds | Create feed
api_catalog_feeds | feedsDelete | **DELETE** /catalogs/feeds/{feed_id} | Delete feed
api_catalog_feeds | feedsGet | **GET** /catalogs/feeds/{feed_id} | Get feed
api_catalog_feeds | feedsIngest | **POST** /catalogs/feeds/{feed_id}/ingest | Ingest feed items
api_catalog_feeds | feedsList | **GET** /catalogs/feeds | List feeds
api_catalog_feeds | feedsUpdate | **PATCH** /catalogs/feeds/{feed_id} | Update feed
api_catalog_feeds | itemsIssuesList | **GET** /catalogs/processing_results/{processing_result_id}/item_issues | List item issues
api_catalog_items | itemsBatchGet | **GET** /catalogs/items/batch/{batch_id} | Get item batch status
api_catalog_items | itemsBatchPost | **POST** /catalogs/items/batch | Operate on item batch
api_catalog_items | itemsPost | **POST** /catalogs/items | Get catalogs items (POST)
api_catalog_product_groups | catalogsProductGroupPinsList | **GET** /catalogs/product_groups/{product_group_id}/products | List products by product group
api_catalog_product_groups | catalogsProductGroupsCreate | **POST** /catalogs/product_groups | Create product group
api_catalog_product_groups | catalogsProductGroupsCreateMany | **POST** /catalogs/product_groups/multiple | Create product groups
api_catalog_product_groups | catalogsProductGroupsDelete | **DELETE** /catalogs/product_groups/{product_group_id} | Delete product group
api_catalog_product_groups | catalogsProductGroupsDeleteMany | **DELETE** /catalogs/product_groups/multiple | Delete product groups
api_catalog_product_groups | catalogsProductGroupsGet | **GET** /catalogs/product_groups/{product_group_id} | Get product group
api_catalog_product_groups | catalogsProductGroupsList | **GET** /catalogs/product_groups | List product groups
api_catalog_product_groups | catalogsProductGroupsProductCountsGet | **GET** /catalogs/product_groups/{product_group_id}/product_counts | Get product counts
api_catalog_product_groups | catalogsProductGroupsUpdate | **PATCH** /catalogs/product_groups/{product_group_id} | Update single product group
api_catalog_product_groups | productsByProductGroupFilterList | **POST** /catalogs/products/get_by_product_group_filters | List products by filter
api_catalog_reports | reportsCreate | **POST** /catalogs/reports | Build catalogs report
api_catalog_reports | reportsGet | **GET** /catalogs/reports | Get catalogs report
api_catalog_reports | reportsStats | **GET** /catalogs/reports/stats | List report stats
api_catalog_supplemental | catalogsLocalInventoryItemsBatchOperate | **POST** /catalogs/{catalog_id}/local_inventory_items/batch | Operate on local inventory item batch
api_catalog_supplemental | catalogsLocalInventoryItemsPost | **POST** /catalogs/{catalog_id}/local_inventory_items/query | Get local inventory items (POST)
api_catalog_supplemental | catalogsLocalStoresCreate | **POST** /catalogs/{catalog_id}/local_stores | Create local stores
api_catalog_supplemental | catalogsLocalStoresDelete | **DELETE** /catalogs/{catalog_id}/local_stores | Delete local stores
api_catalog_supplemental | catalogsLocalStoresList | **GET** /catalogs/{catalog_id}/local_stores | List local stores
api_catalog_supplemental | catalogsLocalStoresUpdate | **PATCH** /catalogs/{catalog_id}/local_stores | Update local stores
api_catalog_supplemental | catalogsSupplementalItemsBatchGet | **GET** /catalogs/{catalog_id}/supplemental_items/batch/{batch_id} | Get supplemental items batch status
api_catalogs | catalogsAvailableFilterValues | **GET** /catalogs/available_filter_values | List available filter values
api_catalogs | catalogsCreate | **POST** /catalogs | Create catalog
api_catalogs | catalogsList | **GET** /catalogs | List catalogs
api_conversion_deletion_requests | conversionDeletionRequestCreate | **POST** /ad_accounts/{ad_account_id}/conversion_deletion_requests | Create a conversion deletion request
api_conversion_deletion_requests | conversionDeletionRequestDelete | **DELETE** /ad_accounts/{ad_account_id}/conversion_deletion_requests/{request_id} | Delete a conversion deletion request
api_conversion_deletion_requests | conversionDeletionRequestGet | **GET** /ad_accounts/{ad_account_id}/conversion_deletion_requests/{request_id} | Get a single conversion deletion request
api_conversion_deletion_requests | conversionDeletionRequestList | **GET** /ad_accounts/{ad_account_id}/conversion_deletion_requests | List conversion deletion requests
api_conversion_eqs | conversionEqsList | **GET** /ad_accounts/{ad_account_id}/conversion_eqs | Get event quality score (EQS)
...
api_conversion_tags | conversionTagsList | **GET** /ad_accounts/{ad_account_id}/conversion_tags | List conversion tags
...
api_conversions | advertiserDefinedEventsCreate | **POST** /ad_accounts/{ad_account_id}/advertiser_defined_events | Create advertiser defined events
api_conversions | advertiserDefinedEventsDelete | **DELETE** /ad_accounts/{ad_account_id}/advertiser_defined_events | Delete advertiser defined events
api_conversions | advertiserDefinedEventsGet | **GET** /ad_accounts/{ad_account_id}/advertiser_defined_events | Get advertiser defined events
api_conversions | advertiserDefinedEventsUpdate | **PATCH** /ad_accounts/{ad_account_id}/advertiser_defined_events | Update advertiser defined events
api_customer_list_uploads | customerListUploadsCreate | **POST** /ad_accounts/{ad_account_id}/customer_lists/{customer_list_id}/uploads | Create customer list upload
api_customer_list_uploads | customerListUploadsGet | **GET** /ad_accounts/{ad_account_id}/customer_lists/{customer_list_id}/uploads/{customer_list_upload_id} | Get customer list upload
api_customer_list_uploads | customerListUploadsRun | **POST** /ad_accounts/{ad_account_id}/customer_lists/{customer_list_id}/uploads/{customer_list_upload_id}/run | Run customer list upload
...
api_customer_segment | customerSegmentCreate | **POST** /ad_accounts/{ad_account_id}/customer_segments | Create customer segments
api_customer_segment | customerSegmentList | **GET** /ad_accounts/{ad_account_id}/customer_segments | List customer segments
api_customer_segment | customerSegmentUpdate | **PATCH** /ad_accounts/{ad_account_id}/customer_segments | Update customer segments
...
api_labels | labelsApply | **POST** /ad_accounts/{ad_account_id}/labels/{label_id}/apply | Apply label to entity
api_labels | labelsCreate | **POST** /ad_accounts/{ad_account_id}/labels | Create labels
api_labels | labelsList | **GET** /ad_accounts/{ad_account_id}/labels | List labels
api_labels | labelsRemove | **POST** /ad_accounts/{ad_account_id}/labels/{label_id}/remove | Remove label from entities
api_labels | labelsUpdate | **PATCH** /ad_accounts/{ad_account_id}/labels | Update labels
...
api_lead_ads | adAccountsSubscriptionsGetById | **GET** /ad_accounts/{ad_account_id}/leads/subscriptions/{subscription_id} | Get lead ads subscription by ID
...
api_msot_events | msotEventsCreate | **POST** /ad_accounts/{ad_account_id}/msot/events | Send Measurement Source Of Truth (MSOT) attributed conversion events
api_notification | notificationPost | **POST** /notifications | Receive notifications from external partners.
api_oauth | oauthConversionToken | **POST** /oauth/conversion_token | Generate OAuth access token for conversion API
api_oauth | oauthToken | **POST** /oauth/token | Generate OAuth access token
api_oauth | tokenRevoke | **POST** /oauth/token/revoke | Revoke a token
...
api_product_tags | productTagsBulkAdd | **POST** /pins/{pin_id}/product_tags | Add product tags to pin
api_product_tags | productTagsBulkDelete | **POST** /pins/{pin_id}/product_tags/bulk-delete | Delete product tags from pin
api_product_tags | productTagsList | **GET** /pins/{pin_id}/product_tags | Get product tags for pin
api_promotions | promotionsCreate | **POST** /ad_accounts/{ad_account_id}/promotions | Create promotions
api_promotions | promotionsDelete | **DELETE** /ad_accounts/{ad_account_id}/promotions/{promotion_id} | Delete promotion by id
api_promotions | promotionsGet | **GET** /ad_accounts/{ad_account_id}/promotions/{promotion_id} | Get promotion by id
api_promotions | promotionsList | **GET** /ad_accounts/{ad_account_id}/promotions | Get promotions
api_promotions | promotionsUpdate | **PATCH** /ad_accounts/{ad_account_id}/promotions | Update promotions
...
api_schedules | schedulesCreate | **POST** /ad_accounts/{ad_account_id}/schedules | Create schedules
api_schedules | schedulesList | **GET** /ad_accounts/{ad_account_id}/schedules | Get Schedules
api_schedules | schedulesUpdate | **PATCH** /ad_accounts/{ad_account_id}/schedules | Update schedules
...
api_trends | trendsEditorialArticlesList | **GET** /trends/editorial_articles | Returns editorial articles for a given region
api_trends | trendsFeaturedTopicsList | **GET** /trends/topics/featured | Get featured topics
api_trends | trendsProductCategoriesDetailsList | **GET** /trends/product_categories/details | Get product category details
api_trends | trendsProductCategoriesTrendingList | **GET** /trends/product_categories/trending | Get a list of growing Shopping Product Categories
