...
allowed_methods(
    Req,
    State = #state{
        operation_id = 'AudiencesCreateCustom'
    }
) ->
    {[<<"POST">>], Req, State};
...
is_authorized(
    Req0,
    State = #state{
        operation_id = 'AudiencesCreate' = OperationID,
        logic_handler = LogicHandler
    }
) ->
    From = header,
...
is_authorized(
    Req0,
    State = #state{
        operation_id = 'AudiencesCreateCustom' = OperationID,
        logic_handler = LogicHandler
    }
) ->
    From = header,
...
is_authorized(
    Req0,
    State = #state{
        operation_id = 'AudiencesGet' = OperationID,
        logic_handler = LogicHandler
    }
) ->
    From = header,
...
is_authorized(
    Req0,
    State = #state{
        operation_id = 'AudiencesList' = OperationID,
        logic_handler = LogicHandler
    }
) ->
    From = header,
...
is_authorized(
    Req0,
    State = #state{
        operation_id = 'AudiencesUpdate' = OperationID,
        logic_handler = LogicHandler
    }
) ->
    From = header,
