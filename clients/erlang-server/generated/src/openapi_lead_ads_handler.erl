...
allowed_methods(
    Req,
    State = #state{
        operation_id = 'AdAccountsSubscriptionsDelById'
    }
) ->
    {[<<"DELETE">>], Req, State};
...
allowed_methods(
    Req,
    State = #state{
        operation_id = 'AdAccountsSubscriptionsGetById'
    }
) ->
    {[<<"GET">>], Req, State};
...
allowed_methods(
    Req,
    State = #state{
        operation_id = 'AdAccountsSubscriptionsGetList'
    }
) ->
    {[<<"GET">>], Req, State};
...
allowed_methods(
    Req,
    State = #state{
        operation_id = 'AdAccountsSubscriptionsPost'
    }
) ->
    {[<<"POST">>], Req, State};
...
is_authorized(
    Req0,
    State = #state{
        operation_id = 'AdAccountsSubscriptionsDelById' = OperationID,
        logic_handler = LogicHandler
    }
) ->
    From = header,
...
is_authorized(
    Req0,
    State = #state{
        operation_id = 'AdAccountsSubscriptionsGetById' = OperationID,
        logic_handler = LogicHandler
    }
) ->
    From = header,
...
is_authorized(
    Req0,
    State = #state{
        operation_id = 'AdAccountsSubscriptionsGetList' = OperationID,
        logic_handler = LogicHandler
    }
) ->
    From = header,
...
is_authorized(
    Req0,
    State = #state{
        operation_id = 'AdAccountsSubscriptionsPost' = OperationID,
        logic_handler = LogicHandler
    }
) ->
    From = header,
