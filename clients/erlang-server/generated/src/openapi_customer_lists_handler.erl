...
allowed_methods(
    Req,
    State = #state{
        operation_id = 'CustomerListsCreate'
    }
) ->
    {[<<"POST">>], Req, State};
...
allowed_methods(
    Req,
    State = #state{
        operation_id = 'CustomerListsList'
    }
) ->
    {[<<"GET">>], Req, State};
...
allowed_methods(
    Req,
    State = #state{
        operation_id = 'CustomerListsUpdate'
    }
) ->
    {[<<"PATCH">>], Req, State};
...
is_authorized(
    Req0,
    State = #state{
        operation_id = 'CustomerListsCreate' = OperationID,
        logic_handler = LogicHandler
    }
) ->
    From = header,
...
is_authorized(
    Req0,
    State = #state{
        operation_id = 'CustomerListsGet' = OperationID,
        logic_handler = LogicHandler
    }
) ->
    From = header,
...
is_authorized(
    Req0,
    State = #state{
        operation_id = 'CustomerListsList' = OperationID,
        logic_handler = LogicHandler
    }
) ->
    From = header,
...
is_authorized(
    Req0,
    State = #state{
        operation_id = 'CustomerListsUpdate' = OperationID,
        logic_handler = LogicHandler
    }
) ->
    From = header,
