...
allowed_methods(
    Req,
    State = #state{
        operation_id = 'IntegrationsCommerceDel'
    }
) ->
    {[<<"DELETE">>], Req, State};
...
allowed_methods(
    Req,
    State = #state{
        operation_id = 'IntegrationsCommerceGet'
    }
) ->
    {[<<"GET">>], Req, State};
...
allowed_methods(
    Req,
    State = #state{
        operation_id = 'IntegrationsCommercePatch'
    }
) ->
    {[<<"PATCH">>], Req, State};
...
allowed_methods(
    Req,
    State = #state{
        operation_id = 'IntegrationsCommercePost'
    }
) ->
    {[<<"POST">>], Req, State};
...
allowed_methods(
    Req,
    State = #state{
        operation_id = 'IntegrationsGetById'
    }
) ->
    {[<<"GET">>], Req, State};
...
allowed_methods(
    Req,
    State = #state{
        operation_id = 'IntegrationsGetList'
    }
) ->
    {[<<"GET">>], Req, State};
...
allowed_methods(
    Req,
    State = #state{
        operation_id = 'IntegrationsLogsPost'
    }
) ->
    {[<<"POST">>], Req, State};
...
is_authorized(
    Req0,
    State = #state{
        operation_id = 'IntegrationsCommerceDel' = OperationID,
        logic_handler = LogicHandler
    }
) ->
    From = header,
...
is_authorized(
    Req0,
    State = #state{
        operation_id = 'IntegrationsCommerceGet' = OperationID,
        logic_handler = LogicHandler
    }
) ->
    From = header,
...
is_authorized(
    Req0,
    State = #state{
        operation_id = 'IntegrationsCommercePatch' = OperationID,
        logic_handler = LogicHandler
    }
) ->
    From = header,
...
is_authorized(
    Req0,
    State = #state{
        operation_id = 'IntegrationsCommercePost' = OperationID,
        logic_handler = LogicHandler
    }
) ->
    From = header,
...
is_authorized(
    Req0,
    State = #state{
        operation_id = 'IntegrationsGetById' = OperationID,
        logic_handler = LogicHandler
    }
) ->
    From = header,
...
is_authorized(
    Req0,
    State = #state{
        operation_id = 'IntegrationsGetList' = OperationID,
        logic_handler = LogicHandler
    }
) ->
    From = header,
...
is_authorized(
    Req0,
    State = #state{
        operation_id = 'IntegrationsLogsPost' = OperationID,
        logic_handler = LogicHandler
    }
) ->
    From = header,
