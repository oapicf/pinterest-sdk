...
allowed_methods(
    Req,
    State = #state{
        operation_id = 'LeadFormTestCreate'
    }
) ->
    {[<<"POST">>], Req, State};
...
is_authorized(
    Req0,
    State = #state{
        operation_id = 'LeadFormGet' = OperationID,
        logic_handler = LogicHandler
    }
) ->
    From = header,
...
is_authorized(
    Req0,
    State = #state{
        operation_id = 'LeadFormTestCreate' = OperationID,
        logic_handler = LogicHandler
    }
) ->
    From = header,
...
is_authorized(
    Req0,
    State = #state{
        operation_id = 'LeadFormsList' = OperationID,
        logic_handler = LogicHandler
    }
) ->
    From = header,
