...
allowed_methods(
    Req,
    State = #state{
        operation_id = 'ProductGroupPromotionsCreate'
    }
) ->
    {[<<"POST">>], Req, State};
...
allowed_methods(
    Req,
    State = #state{
        operation_id = 'ProductGroupPromotionsGet'
    }
) ->
    {[<<"GET">>], Req, State};
...
allowed_methods(
    Req,
    State = #state{
        operation_id = 'ProductGroupPromotionsList'
    }
) ->
    {[<<"GET">>], Req, State};
...
allowed_methods(
    Req,
    State = #state{
        operation_id = 'ProductGroupPromotionsUpdate'
    }
) ->
    {[<<"PATCH">>], Req, State};
...
is_authorized(
    Req0,
    State = #state{
        operation_id = 'ProductGroupPromotionsCreate' = OperationID,
        logic_handler = LogicHandler
    }
) ->
    From = header,
...
is_authorized(
    Req0,
    State = #state{
        operation_id = 'ProductGroupPromotionsGet' = OperationID,
        logic_handler = LogicHandler
    }
) ->
    From = header,
...
is_authorized(
    Req0,
    State = #state{
        operation_id = 'ProductGroupPromotionsList' = OperationID,
        logic_handler = LogicHandler
    }
) ->
    From = header,
...
is_authorized(
    Req0,
    State = #state{
        operation_id = 'ProductGroupPromotionsUpdate' = OperationID,
        logic_handler = LogicHandler
    }
) ->
    From = header,
