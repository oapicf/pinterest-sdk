...
--
SELECT bookmark, items FROM catalogs_list_200_response WHERE 1=1;
...
--
UPDATE catalogs_list_200_response SET bookmark = ?, items = ? WHERE 1=2;

--
-- DELETE template for table 'catalogs_list_200_response'
--
DELETE FROM catalogs_list_200_response WHERE 1=2;
