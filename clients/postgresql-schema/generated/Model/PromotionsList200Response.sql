...
--
SELECT bookmark, items FROM promotions_list_200_response WHERE 1=1;
...
--
UPDATE promotions_list_200_response SET bookmark = ?, items = ? WHERE 1=2;

--
-- DELETE template for table 'promotions_list_200_response'
--
DELETE FROM promotions_list_200_response WHERE 1=2;
