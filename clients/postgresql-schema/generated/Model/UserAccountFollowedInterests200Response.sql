...
--
SELECT bookmark, items FROM user_account_followed_interests_200_response WHERE 1=1;
...
--
UPDATE user_account_followed_interests_200_response SET bookmark = ?, items = ? WHERE 1=2;

--
-- DELETE template for table 'user_account_followed_interests_200_response'
--
DELETE FROM user_account_followed_interests_200_response WHERE 1=2;
