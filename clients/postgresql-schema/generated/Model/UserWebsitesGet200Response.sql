...
--
SELECT bookmark, items FROM user_websites_get_200_response WHERE 1=1;

--
-- INSERT template for table 'user_websites_get_200_response'
--
INSERT INTO user_websites_get_200_response (bookmark, items) VALUES (?, ?);

--
-- UPDATE template for table 'user_websites_get_200_response'
--
UPDATE user_websites_get_200_response SET bookmark = ?, items = ? WHERE 1=2;

--
-- DELETE template for table 'user_websites_get_200_response'
--
DELETE FROM user_websites_get_200_response WHERE 1=2;
