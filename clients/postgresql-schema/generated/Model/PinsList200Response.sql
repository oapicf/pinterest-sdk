...
--
SELECT bookmark, items FROM pins_list_200_response WHERE 1=1;
...
--
UPDATE pins_list_200_response SET bookmark = ?, items = ? WHERE 1=2;

--
-- DELETE template for table 'pins_list_200_response'
--
DELETE FROM pins_list_200_response WHERE 1=2;
