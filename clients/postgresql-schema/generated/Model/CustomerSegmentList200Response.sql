...
--
SELECT bookmark, items FROM customer_segment_list_200_response WHERE 1=1;
...
--
UPDATE customer_segment_list_200_response SET bookmark = ?, items = ? WHERE 1=2;

--
-- DELETE template for table 'customer_segment_list_200_response'
--
DELETE FROM customer_segment_list_200_response WHERE 1=2;
