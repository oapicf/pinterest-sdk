...
--
SELECT bookmark, items FROM ad_accounts_subscriptions_get_list_200_response WHERE 1=1;
...
--
UPDATE ad_accounts_subscriptions_get_list_200_response SET bookmark = ?, items = ? WHERE 1=2;

--
-- DELETE template for table 'ad_accounts_subscriptions_get_list_200_response'
--
DELETE FROM ad_accounts_subscriptions_get_list_200_response WHERE 1=2;
