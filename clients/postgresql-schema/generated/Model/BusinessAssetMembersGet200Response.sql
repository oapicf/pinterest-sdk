...
--
SELECT bookmark, items FROM business_asset_members_get_200_response WHERE 1=1;
...
--
UPDATE business_asset_members_get_200_response SET bookmark = ?, items = ? WHERE 1=2;

--
-- DELETE template for table 'business_asset_members_get_200_response'
--
DELETE FROM business_asset_members_get_200_response WHERE 1=2;
