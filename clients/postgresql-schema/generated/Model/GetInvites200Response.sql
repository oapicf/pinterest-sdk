...
--
SELECT bookmark, items FROM get_invites_200_response WHERE 1=1;
...
--
UPDATE get_invites_200_response SET bookmark = ?, items = ? WHERE 1=2;

--
-- DELETE template for table 'get_invites_200_response'
--
DELETE FROM get_invites_200_response WHERE 1=2;
