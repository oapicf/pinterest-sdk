...
--
SELECT bookmark, items FROM order_lines_list_200_response WHERE 1=1;
...
--
UPDATE order_lines_list_200_response SET bookmark = ?, items = ? WHERE 1=2;

--
-- DELETE template for table 'order_lines_list_200_response'
--
DELETE FROM order_lines_list_200_response WHERE 1=2;
