...
--
SELECT bookmark, items FROM catalogs_product_groups_list_200_response WHERE 1=1;

--
-- INSERT template for table 'catalogs_product_groups_list_200_response'
--
INSERT INTO catalogs_product_groups_list_200_response (bookmark, items) VALUES (?, ?);

--
-- UPDATE template for table 'catalogs_product_groups_list_200_response'
--
UPDATE catalogs_product_groups_list_200_response SET bookmark = ?, items = ? WHERE 1=2;

--
-- DELETE template for table 'catalogs_product_groups_list_200_response'
--
DELETE FROM catalogs_product_groups_list_200_response WHERE 1=2;
