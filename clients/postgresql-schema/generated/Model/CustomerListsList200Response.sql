...
--
SELECT bookmark, items FROM customer_lists_list_200_response WHERE 1=1;

--
-- INSERT template for table 'customer_lists_list_200_response'
--
INSERT INTO customer_lists_list_200_response (bookmark, items) VALUES (?, ?);

--
-- UPDATE template for table 'customer_lists_list_200_response'
--
UPDATE customer_lists_list_200_response SET bookmark = ?, items = ? WHERE 1=2;

--
-- DELETE template for table 'customer_lists_list_200_response'
--
DELETE FROM customer_lists_list_200_response WHERE 1=2;
