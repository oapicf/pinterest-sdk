...
--
SELECT bookmark, items FROM campaigns_list_200_response WHERE 1=1;

--
-- INSERT template for table 'campaigns_list_200_response'
--
INSERT INTO campaigns_list_200_response (bookmark, items) VALUES (?, ?);

--
-- UPDATE template for table 'campaigns_list_200_response'
--
UPDATE campaigns_list_200_response SET bookmark = ?, items = ? WHERE 1=2;

--
-- DELETE template for table 'campaigns_list_200_response'
--
DELETE FROM campaigns_list_200_response WHERE 1=2;
