...
--
SELECT bookmark, items FROM schedules_list_200_response WHERE 1=1;
...
--
UPDATE schedules_list_200_response SET bookmark = ?, items = ? WHERE 1=2;

--
-- DELETE template for table 'schedules_list_200_response'
--
DELETE FROM schedules_list_200_response WHERE 1=2;
