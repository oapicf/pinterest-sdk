...
--
SELECT deleted_members FROM delete_business_membership_200_response WHERE 1=1;
...
--
UPDATE delete_business_membership_200_response SET deleted_members = ? WHERE 1=2;

--
-- DELETE template for table 'delete_business_membership_200_response'
--
DELETE FROM delete_business_membership_200_response WHERE 1=2;
