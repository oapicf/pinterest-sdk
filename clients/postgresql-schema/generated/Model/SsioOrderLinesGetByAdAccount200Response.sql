...
--
SELECT bookmark, items FROM ssio_order_lines_get_by_ad_account_200_response WHERE 1=1;
...
--
UPDATE ssio_order_lines_get_by_ad_account_200_response SET bookmark = ?, items = ? WHERE 1=2;

--
-- DELETE template for table 'ssio_order_lines_get_by_ad_account_200_response'
--
DELETE FROM ssio_order_lines_get_by_ad_account_200_response WHERE 1=2;
