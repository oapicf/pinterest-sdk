...
--
SELECT bookmark, items FROM integrations_get_list_200_response WHERE 1=1;
...
--
UPDATE integrations_get_list_200_response SET bookmark = ?, items = ? WHERE 1=2;

--
-- DELETE template for table 'integrations_get_list_200_response'
--
DELETE FROM integrations_get_list_200_response WHERE 1=2;
