...
--
SELECT bookmark, items FROM ad_groups_list_200_response WHERE 1=1;

--
-- INSERT template for table 'ad_groups_list_200_response'
--
INSERT INTO ad_groups_list_200_response (bookmark, items) VALUES (?, ?);

--
-- UPDATE template for table 'ad_groups_list_200_response'
--
UPDATE ad_groups_list_200_response SET bookmark = ?, items = ? WHERE 1=2;

--
-- DELETE template for table 'ad_groups_list_200_response'
--
DELETE FROM ad_groups_list_200_response WHERE 1=2;
