...
--
SELECT bookmark, items FROM lead_forms_list_200_response WHERE 1=1;

--
-- INSERT template for table 'lead_forms_list_200_response'
--
INSERT INTO lead_forms_list_200_response (bookmark, items) VALUES (?, ?);

--
-- UPDATE template for table 'lead_forms_list_200_response'
--
UPDATE lead_forms_list_200_response SET bookmark = ?, items = ? WHERE 1=2;

--
-- DELETE template for table 'lead_forms_list_200_response'
--
DELETE FROM lead_forms_list_200_response WHERE 1=2;
