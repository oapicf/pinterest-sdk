...
Spectator.describe "CatalogsApi" do
  describe "test an instance of CatalogsApi" do
    it "should create an instance of CatalogsApi" do
      ...
      expect(api_instance).to be_instance_of(OpenAPIClient::CatalogsApi)
    end
  end
  ...
  # @option opts [Int32] :page_size Maximum number of items to include in a single page of the response. See documentation on &lt;a href&#x3D;&#39;/docs/reference/pagination/&#39;&gt;Pagination&lt;/a&gt; for more information.
  # @option opts [String] :ad_account_id Unique identifier of an ad account.
  # @option opts [Bool] :pin_metrics Specify whether to return 90d and lifetime Pin metrics. Total comments and total reactions are only available with lifetime Pin metrics. If Pin was created before &lt;code&gt;2023-03-20&lt;/code&gt; lifetime metrics will only be available for Video and Idea Pin formats. Lifetime metrics are available for all Pin formats since then.
