...
# Unit tests for OpenAPIClient::ProductGroupPromotionsApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
Spectator.describe "ProductGroupPromotionsApi" do
  describe "test an instance of ProductGroupPromotionsApi" do
    it "should create an instance of ProductGroupPromotionsApi" do
      api_instance = OpenAPIClient::ProductGroupPromotionsApi.new
      expect(api_instance).to be_instance_of(OpenAPIClient::ProductGroupPromotionsApi)
    end
  end
