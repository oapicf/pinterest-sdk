...
Spectator.describe "AdGroupsApi" do
  describe "test an instance of AdGroupsApi" do
    it "should create an instance of AdGroupsApi" do
      ...
      expect(api_instance).to be_instance_of(OpenAPIClient::AdGroupsApi)
    end
  end
  ...
  # @option opts [Bool] :aggregate_report_rows Determines if report rows should be aggregated across all requested entities. This feature is currently in BETA and is not available to all users.
