...
Spectator.describe "ConversionTagsApi" do
  describe "test an instance of ConversionTagsApi" do
    it "should create an instance of ConversionTagsApi" do
      ...
      expect(api_instance).to be_instance_of(OpenAPIClient::ConversionTagsApi)
    end
  end
  ...
  # @param ad_account_id Unique identifier of an ad account.
  # @param [Hash] opts the optional parameters
  # @option opts [Bool] :filter_deleted Filter by deleted status
