...
# Unit tests for OpenAPIClient::BoardsApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
Spectator.describe "BoardsApi" do
  describe "test an instance of BoardsApi" do
    it "should create an instance of BoardsApi" do
      api_instance = OpenAPIClient::BoardsApi.new
      expect(api_instance).to be_instance_of(OpenAPIClient::BoardsApi)
    end
  end
