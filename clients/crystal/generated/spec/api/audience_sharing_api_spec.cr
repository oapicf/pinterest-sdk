...
# Unit tests for OpenAPIClient::AudienceSharingApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
Spectator.describe "AudienceSharingApi" do
  describe "test an instance of AudienceSharingApi" do
    it "should create an instance of AudienceSharingApi" do
      api_instance = OpenAPIClient::AudienceSharingApi.new
      expect(api_instance).to be_instance_of(OpenAPIClient::AudienceSharingApi)
    end
  end
