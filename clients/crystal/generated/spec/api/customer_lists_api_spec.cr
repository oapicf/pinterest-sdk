...
# Unit tests for OpenAPIClient::CustomerListsApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
Spectator.describe "CustomerListsApi" do
  describe "test an instance of CustomerListsApi" do
    it "should create an instance of CustomerListsApi" do
      api_instance = OpenAPIClient::CustomerListsApi.new
      expect(api_instance).to be_instance_of(OpenAPIClient::CustomerListsApi)
    end
  end
