...
# Unit tests for OpenAPIClient::UserAccountApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
Spectator.describe "UserAccountApi" do
  describe "test an instance of UserAccountApi" do
    it "should create an instance of UserAccountApi" do
      api_instance = OpenAPIClient::UserAccountApi.new
      expect(api_instance).to be_instance_of(OpenAPIClient::UserAccountApi)
    end
  end
  ...
  # @option opts [Bool] :explicit_following Whether or not to include implicit user follows, which means followees with board follows. When explicit_following is True, it means we only want explicit user follows.
  ...
  # @option opts [String] :source Filter to activity from Pins created and saved by your, or activity created and saved by others from your claimed accounts
  # @option opts [Array(String)] :metric_types Metric types to get data for, default is all. 
  # @option opts [Int32] :num_of_pins Number of pins to include, default is 10. Max is 50.
  # @option opts [Int32] :created_in_last_n_days Get metrics for pins created in the last \&quot;n\&quot; days.
  # @option opts [String] :ad_account_id Unique identifier of an ad account.
