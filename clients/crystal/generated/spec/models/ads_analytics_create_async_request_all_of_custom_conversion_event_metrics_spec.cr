...
# Unit tests for OpenAPIClient::AdsAnalyticsCreateAsyncRequestAllOfCustomConversionEventMetrics
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
Spectator.describe OpenAPIClient::AdsAnalyticsCreateAsyncRequestAllOfCustomConversionEventMetrics do

  describe "test an instance of AdsAnalyticsCreateAsyncRequestAllOfCustomConversionEventMetrics" do
    skip "should create an instance of AdsAnalyticsCreateAsyncRequestAllOfCustomConversionEventMetrics" do
      #instance = OpenAPIClient::AdsAnalyticsCreateAsyncRequestAllOfCustomConversionEventMetrics.new
      #expect(instance).to be_instance_of(OpenAPIClient::AdsAnalyticsCreateAsyncRequestAllOfCustomConversionEventMetrics)
    end
  end
