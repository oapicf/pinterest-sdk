...
# Unit tests for ::OauthAccessTokenResponseCode
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ::OauthAccessTokenResponseCode do
  ...
  describe "test an instance of OauthAccessTokenResponseCode" do
    it "should create an instance of OauthAccessTokenResponseCode" do
      #instance = ::OauthAccessTokenResponseCode.new
      #expect(instance).to be_instance_of(::OauthAccessTokenResponseCode)
    end
  end
