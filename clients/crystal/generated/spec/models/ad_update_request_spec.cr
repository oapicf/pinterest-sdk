...
# Unit tests for OpenAPIClient::AdUpdateRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
Spectator.describe OpenAPIClient::AdUpdateRequest do

  describe "test an instance of AdUpdateRequest" do
    skip "should create an instance of AdUpdateRequest" do
      #instance = OpenAPIClient::AdUpdateRequest.new
      #expect(instance).to be_instance_of(OpenAPIClient::AdUpdateRequest)
    end
  end
