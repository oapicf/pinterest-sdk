...
module 
  class AdGroupResponseAllOf1
    ...
    def initialize(@campaign_id : String?, @billable_event : ActionType?, @id : String?, @_type : String?, @ad_account_id : String?, @created_time : Int32?, @updated_time : Int32?)
    end
    ...
    def hash
      [campaign_id, billable_event, id, _type, ad_account_id, created_time, updated_time].hash
    end
