...
module 
  class AdsAnalyticsCreateAsyncRequest
    ...
    def list_invalid_properties
      ...
      if !@campaign_objective_types.nil? && @campaign_objective_types.size > 6
    ...
    def valid?
      ...
      return false if !@campaign_objective_types.nil? && @campaign_objective_types.size > 6
    ...
    def campaign_objective_types=(campaign_objective_types)
      if !campaign_objective_types.nil? && campaign_objective_types.size > 6
        raise ArgumentError.new("invalid value for \"campaign_objective_types\", number of items must be less than or equal to 6.")
      end
