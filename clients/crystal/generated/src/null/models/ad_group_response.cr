...
module 
  class AdGroupResponse
    ...
    def initialize(@name : String?, @status : EntityStatus?, @budget_in_micro_currency : Int32?, @bid_in_micro_currency : Int32?, @budget_type : String?, @start_time : Int32?, @end_time : Int32?, @targeting_spec : Hash(String, Array(String))?, @lifetime_frequency_cap : Int32?, @tracking_urls : TrackingUrls?, @auto_targeting_enabled : Bool?, @placement_group : PlacementGroupType?, @pacing_delivery_type : PacingDeliveryType?, @conversion_learning_mode_type : String?, @summary_status : AdGroupSummaryStatus?, @feed_profile_id : String?, @campaign_id : String?, @billable_event : ActionType?, @id : String?, @_type : String?, @ad_account_id : String?, @created_time : Int32?, @updated_time : Int32?)
    end
