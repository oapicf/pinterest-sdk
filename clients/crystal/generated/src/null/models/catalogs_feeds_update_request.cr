...
module 
  ...
  class CatalogsFeedsUpdateRequest
    ...
    def initialize(@default_availability : ProductAvailabilityType?, @default_currency : NullableCurrency?, @name : String?, @format : CatalogsFormat?, @credentials : CatalogsFeedCredentials?, @location : String?, @preferred_processing_schedule : CatalogsFeedProcessingSchedule?, @status : CatalogsStatus?)
    end
