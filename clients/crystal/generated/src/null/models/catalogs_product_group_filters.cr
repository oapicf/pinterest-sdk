...
module 
  ...
  class CatalogsProductGroupFilters
    ...
    # Optional properties
    @[JSON::Field(key: "any_of", type: Array(CatalogsProductGroupFilterKeys)?, nillable: true, emit_null: false)]
    property any_of : Array(CatalogsProductGroupFilterKeys)?

    @[JSON::Field(key: "all_of", type: Array(CatalogsProductGroupFilterKeys)?, nillable: true, emit_null: false)]
