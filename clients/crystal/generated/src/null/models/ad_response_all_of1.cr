...
module 
  class AdResponseAllOf1
    ...
    def initialize(@ad_account_id : String?, @campaign_id : String?, @collection_items_destination_url_template : String?, @created_time : Int32?, @id : String?, @rejected_reasons : Array(String)?, @rejection_labels : Array(String)?, @review_status : String?, @_type : String?, @updated_time : Int32?, @summary_status : PinPromotionSummaryStatus?)
    end
    ...
    def hash
      [ad_account_id, campaign_id, collection_items_destination_url_template, created_time, id, rejected_reasons, rejection_labels, review_status, _type, updated_time, summary_status].hash
    end
