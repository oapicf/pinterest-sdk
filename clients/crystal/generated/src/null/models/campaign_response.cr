...
module 
  class CampaignResponse
    ...
    def initialize(@id : String, @ad_account_id : String, @name : String?, @status : EntityStatus?, @lifetime_spend_cap : Int32?, @daily_spend_cap : Int32?, @order_line_id : String?, @tracking_urls : TrackingUrls?, @start_time : Int32?, @end_time : Int32?, @objective_type : ObjectiveType?, @created_time : Int32?, @updated_time : Int32?, @_type : String?)
    end
    ...
    def hash
      [id, ad_account_id, name, status, lifetime_spend_cap, daily_spend_cap, order_line_id, tracking_urls, start_time, end_time, objective_type, created_time, updated_time, _type].hash
    end
