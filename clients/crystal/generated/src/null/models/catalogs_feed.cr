...
module 
  ...
  class CatalogsFeed
    ...
    def initialize(@default_country : Country, @default_availability : ProductAvailabilityType, @default_currency : NullableCurrency, @name : String, @format : CatalogsFormat, @default_locale : String, @credentials : CatalogsFeedCredentials, @location : String, @preferred_processing_schedule : CatalogsFeedProcessingSchedule, @status : CatalogsStatus, @created_at : Time?, @id : String?, @updated_at : Time?)
    end
    ...
    def hash
      [created_at, id, updated_at, default_country, default_availability, default_currency, name, format, default_locale, credentials, location, preferred_processing_schedule, status].hash
    end
