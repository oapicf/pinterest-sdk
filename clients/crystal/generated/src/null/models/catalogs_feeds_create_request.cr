...
module 
  ...
  class CatalogsFeedsCreateRequest
    ...
    @[JSON::Field(key: "default_locale", type: String?, nillable: true, emit_null: false)]
    ...
    def initialize(@name : String, @format : CatalogsFormat, @location : String, @default_country : Country?, @default_availability : ProductAvailabilityType?, @default_currency : NullableCurrency?, @default_locale : String?, @credentials : CatalogsFeedCredentials?, @preferred_processing_schedule : CatalogsFeedProcessingSchedule?)
    end
    ...
    def hash
      [default_country, default_availability, default_currency, name, format, default_locale, credentials, location, preferred_processing_schedule].hash
    end
