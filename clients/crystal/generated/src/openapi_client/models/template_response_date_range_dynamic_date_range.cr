...
module OpenAPIClient
  ...
  class TemplateResponseDateRangeDynamicDateRange
    ...
    @[JSON::Field(key: "range", type: String?, nillable: true, emit_null: false)]
    ...
    class EnumAttributeValidatorForRange < EnumAttributeValidator
      @attribute : String
      @allowable_values : Array(Int32 | Int64 | Float32 | Float64 | String)

      def initialize
        @attribute = "range"
        @allowable_values = ["YEAR_TO_DATE", "QUARTER_TO_DATE", "MONTH_TO_DATE", "LAST_MONTH", "LAST_QUARTER"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@range : String? = nil, @_type : String? = nil)
    end
    ...
    def list_invalid_properties
      ...
      range_validator = EnumAttributeValidatorForRange.new
      if !range_validator.valid?(@range)
        message = range_validator.message
    ...
    def range=(range)
      validator = EnumAttributeValidatorForRange.new
