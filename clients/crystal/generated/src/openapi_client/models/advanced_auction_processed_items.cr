...
module OpenAPIClient
  ...
  class AdvancedAuctionProcessedItems
    ...
    @[JSON::Field(key: "items", type: Array(AdvancedAuctionProcessedItem)?, nillable: true, emit_null: false)]
    property items : Array(AdvancedAuctionProcessedItem)?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@catalog_id : String? = nil, @items : Array(AdvancedAuctionProcessedItem)? = nil)
    end
