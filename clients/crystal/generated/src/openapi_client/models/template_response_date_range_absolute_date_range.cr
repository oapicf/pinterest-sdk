...
module OpenAPIClient
  ...
  class TemplateResponseDateRangeAbsoluteDateRange
    ...
    @[JSON::Field(key: "end_date", type: Float64?, nillable: true, emit_null: false)]
    property end_date : Float64?

    # The start date of the date range
    @[JSON::Field(key: "start_date", type: Float64?, nillable: true, emit_null: false)]
    property start_date : Float64?
    ...
    def initialize(@end_date : Float64? = nil, @start_date : Float64? = nil, @_type : String? = nil)
    end
    ...
    def hash
      [end_date, start_date, _type].hash
    end
