...
module OpenAPIClient
  ...
  class GenderDemographics
    ...
    @[JSON::Field(key: "female", type: Float64, nillable: false, emit_null: false)]
    property female : Float64

    # Percentage of male users
    @[JSON::Field(key: "male", type: Float64, nillable: false, emit_null: false)]
    property male : Float64

    # Percentage of users with unspecified gender
    @[JSON::Field(key: "unspecified", type: Float64, nillable: false, emit_null: false)]
    ...
    def to_h
      ...
      hash["female"] = _to_h(female)
      hash["male"] = _to_h(male)
      hash["unspecified"] = _to_h(unspecified)
      hash.to_h
    end
