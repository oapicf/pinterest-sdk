...
module OpenAPIClient
  class BusinessAssetPartnersGet200Response
    ...
    @[JSON::Field(key: "items", type: Array(UserSingleAssetBinding), nillable: false, emit_null: false)]
    property items : Array(UserSingleAssetBinding)
    ...
    def initialize(@items : Array(UserSingleAssetBinding), @bookmark : String? = nil)
    end
