...
module OpenAPIClient
  ...
  class CatalogsFeedProcessingSchedule
    ...
    def list_invalid_properties
      ...
      timezone_validator = EnumAttributeValidatorForTimezone.new
      if !timezone_validator.valid?(@timezone)
        message = timezone_validator.message
    ...
    def valid?
      return false if @time.try &.!~ /^(0[0-9]|1[0-9]|2[0-3]):[0-5][0-9]$/
      timezone_validator = EnumAttributeValidatorForTimezone.new
    ...
    def timezone=(timezone)
      validator = EnumAttributeValidatorForTimezone.new
