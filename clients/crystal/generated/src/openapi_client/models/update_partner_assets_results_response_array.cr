...
module OpenAPIClient
  class UpdatePartnerAssetsResultsResponseArray
    ...
    @[JSON::Field(key: "items", type: Array(UpdatePartnerAssetsResult)?, nillable: true, emit_null: false)]
    property items : Array(UpdatePartnerAssetsResult)?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@items : Array(UpdatePartnerAssetsResult)? = nil)
    end
