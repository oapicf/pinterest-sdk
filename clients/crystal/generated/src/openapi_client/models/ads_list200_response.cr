...
module OpenAPIClient
  class AdsList200Response
    ...
    # Required properties
    @[JSON::Field(key: "items", type: Array(AdResponse), nillable: false, emit_null: false)]
    property items : Array(AdResponse)
    ...
    def initialize(@items : Array(AdResponse), @bookmark : String? = nil)
    end
