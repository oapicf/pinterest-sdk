...
module OpenAPIClient
  class PromotionArrayElement
    ...
    # Optional properties
    @[JSON::Field(key: "data", type: PromotionResponse?, nillable: true, emit_null: false)]
    property data : PromotionResponse?

    @[JSON::Field(key: "exception", type: Exception?, nillable: true, emit_null: false)]
    property exception : Exception?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@data : PromotionResponse? = nil, @exception : Exception? = nil)
    end
