...
module OpenAPIClient
  ...
  class CatalogsRetailFeedsCreateRequest
    ...
    def initialize(@catalog_type : CatalogsType, @default_country : Country, @default_locale : CatalogsFeedsCreateRequestDefaultLocale, @format : CatalogsFormat, @location : String, @name : String, @catalog_id : String? = nil, @credentials : CatalogsFeedCredentials? = nil, @default_availability : ProductAvailabilityType? = nil, @default_currency : NullableCurrency? = nil, @preferred_processing_schedule : CatalogsFeedProcessingSchedule? = nil, @status : CatalogsStatus? = nil)
    end
