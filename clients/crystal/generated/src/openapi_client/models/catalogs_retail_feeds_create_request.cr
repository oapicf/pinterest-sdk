...
module OpenAPIClient
  ...
  class CatalogsRetailFeedsCreateRequest
    ...
    def initialize(@name : String, @format : CatalogsFormat, @default_locale : CatalogsFeedsCreateRequestDefaultLocale, @location : String, @catalog_type : CatalogsType, @default_country : Country, @default_currency : NullableCurrency? = nil, @credentials : CatalogsFeedCredentials? = nil, @preferred_processing_schedule : CatalogsFeedProcessingSchedule? = nil, @default_availability : ProductAvailabilityType? = nil, @status : CatalogsStatus? = nil)
    end
    ...
    def hash
      [default_currency, name, format, default_locale, credentials, location, preferred_processing_schedule, catalog_type, default_country, default_availability, status].hash
    end
