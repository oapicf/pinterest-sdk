...
module OpenAPIClient
  class SearchPartnerPins200Response
    ...
    # Required properties
    @[JSON::Field(key: "items", type: Array(SummaryPin), nillable: false, emit_null: false)]
    property items : Array(SummaryPin)
    ...
    def initialize(@items : Array(SummaryPin), @bookmark : String? = nil)
    end
