...
module OpenAPIClient
  ...
  class TrendingKeywordDemographics
    ...
    # Optional properties
    @[JSON::Field(key: "age_distribution", type: TrendingKeywordDemographicsAgeDistribution?, nillable: true, emit_null: false)]
    property age_distribution : TrendingKeywordDemographicsAgeDistribution?

    @[JSON::Field(key: "gender_distribution", type: TrendingKeywordDemographicsGenderDistribution?, nillable: true, emit_null: false)]
    property gender_distribution : TrendingKeywordDemographicsGenderDistribution?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@age_distribution : TrendingKeywordDemographicsAgeDistribution? = nil, @gender_distribution : TrendingKeywordDemographicsGenderDistribution? = nil)
    end
