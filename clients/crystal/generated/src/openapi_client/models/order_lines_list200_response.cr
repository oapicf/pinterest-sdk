...
module OpenAPIClient
  class OrderLinesList200Response
    ...
    # Required properties
    @[JSON::Field(key: "items", type: Array(OrderLine), nillable: false, emit_null: false)]
    property items : Array(OrderLine)
    ...
    def initialize(@items : Array(OrderLine), @bookmark : String? = nil)
    end
