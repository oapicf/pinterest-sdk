...
module OpenAPIClient
  ...
  class PlacementMultipliers
    ...
    def initialize(@placement : String?)
    end
    ...
    def valid?
      placement_validator = EnumAttributeValidator.new("String", ["SEARCH", "BROWSE"])
    ...
    def placement=(placement)
      validator = EnumAttributeValidator.new("String", ["SEARCH", "BROWSE"])
      unless validator.valid?(placement)
        raise ArgumentError.new("invalid value for \"placement\", must be one of #{validator.allowable_values}.")
      end
      @placement = placement
    end
