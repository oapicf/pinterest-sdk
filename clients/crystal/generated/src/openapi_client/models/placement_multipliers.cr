...
module OpenAPIClient
  ...
  class PlacementMultipliers
    ...
    # Optional properties
    @[JSON::Field(key: "PLACEMENT", type: String?, nillable: true, emit_null: false)]
    ...
    class EnumAttributeValidatorForPlacement < EnumAttributeValidator
      @attribute : String
      @allowable_values : Array(Int32 | Int64 | Float32 | Float64 | String)

      def initialize
        @attribute = "placement"
        @allowable_values = ["SEARCH", "BROWSE", "RELATED_PINS"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@placement : String? = nil)
    end
    ...
    def list_invalid_properties
      ...
      placement_validator = EnumAttributeValidatorForPlacement.new
      if !placement_validator.valid?(@placement)
        message = placement_validator.message
    ...
    def placement=(placement)
      validator = EnumAttributeValidatorForPlacement.new
    ...
    def to_h
      ...
      hash["PLACEMENT"] = _to_h(placement)
      hash.to_h
    end
