...
module OpenAPIClient
  ...
  class CatalogsRetailFeedsUpdateRequest
    ...
    def initialize(@catalog_type : CatalogsType, @default_currency : NullableCurrency?, @name : String?, @format : CatalogsFormat?, @credentials : CatalogsFeedCredentials?, @location : String?, @preferred_processing_schedule : CatalogsFeedProcessingSchedule?, @status : CatalogsStatus?, @default_availability : ProductAvailabilityType?)
    end
