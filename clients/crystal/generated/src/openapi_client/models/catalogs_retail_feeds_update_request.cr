...
module OpenAPIClient
  ...
  class CatalogsRetailFeedsUpdateRequest
    ...
    @[JSON::Field(key: "format", type: CatalogsFormat?, nillable: true, emit_null: false)]
    ...
    def initialize(@catalog_type : CatalogsType, @default_currency : NullableCurrency? = nil, @name : String? = nil, @format : CatalogsFormat? = nil, @credentials : CatalogsFeedCredentials? = nil, @location : String? = nil, @preferred_processing_schedule : CatalogsFeedProcessingSchedule? = nil, @status : CatalogsStatus? = nil, @default_availability : ProductAvailabilityType? = nil)
    end
    ...
    def list_invalid_properties
      ...
      if !@location.nil? && @location.try &.!~ pattern
    ...
    def valid?
      return false if !@location.nil? && @location.try &.!~ /^(http|https|ftp|sftp):\/\//
      true
    end
    ...
    def hash
      [default_currency, name, format, credentials, location, preferred_processing_schedule, status, catalog_type, default_availability].hash
    end
