...
module OpenAPIClient
  ...
  class CatalogsCreativeAssetsFeedsUpdateRequest
    ...
    def initialize(@catalog_type : CatalogsType, @credentials : CatalogsFeedCredentials? = nil, @default_currency : NullableCurrency? = nil, @format : CatalogsFormat? = nil, @location : String? = nil, @name : String? = nil, @preferred_processing_schedule : CatalogsFeedProcessingSchedule? = nil, @status : CatalogsStatus? = nil)
    end
