...
module OpenAPIClient
  class UpdateInvitesResultsResponseArray
    ...
    @[JSON::Field(key: "items", type: Array(UpdateInvitesResultsResponseArrayItemsInner)?, nillable: true, emit_null: false)]
    property items : Array(UpdateInvitesResultsResponseArrayItemsInner)?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@items : Array(UpdateInvitesResultsResponseArrayItemsInner)? = nil)
    end
