...
module OpenAPIClient
  class GetMMMReportResponse
    ...
    # Optional properties
    @[JSON::Field(key: "code", type: Float64?, nillable: true, emit_null: false)]
    property code : Float64?

    @[JSON::Field(key: "data", type: GetMMMReportResponseData?, nillable: true, emit_null: false)]
    property data : GetMMMReportResponseData?
    ...
    def initialize(@code : Float64? = nil, @data : GetMMMReportResponseData? = nil, @message : String? = nil, @status : String? = nil)
    end
