...
module OpenAPIClient
  class CampaignCreateResponseData
    ...
    def initialize(@ad_account_id : String? = nil, @name : String? = nil, @status : EntityStatus? = nil, @lifetime_spend_cap : Int32? = nil, @daily_spend_cap : Int32? = nil, @order_line_id : String? = nil, @tracking_urls : TrackingUrls? = nil, @start_time : Int32? = nil, @end_time : Int32? = nil, @is_flexible_daily_budgets : Bool? = nil, @default_ad_group_budget_in_micro_currency : Int32? = nil, @is_automated_campaign : Bool? = nil, @id : String? = nil, @objective_type : ObjectiveType? = nil, @created_time : Int32? = nil, @updated_time : Int32? = nil, @_type : String? = nil, @is_campaign_budget_optimization : Bool? = nil, @summary_status : CampaignSummaryStatus? = nil)
    end
    ...
    def hash
      [ad_account_id, name, status, lifetime_spend_cap, daily_spend_cap, order_line_id, tracking_urls, start_time, end_time, is_flexible_daily_budgets, default_ad_group_budget_in_micro_currency, is_automated_campaign, id, objective_type, created_time, updated_time, _type, is_campaign_budget_optimization, summary_status].hash
    end
