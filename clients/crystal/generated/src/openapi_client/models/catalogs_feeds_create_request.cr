...
module OpenAPIClient
  ...
  class CatalogsFeedsCreateRequest
    ...
    def initialize(@name : String, @format : CatalogsFormat, @location : String, @default_currency : NullableCurrency? = nil, @default_locale : CatalogsFeedsCreateRequestDefaultLocale? = nil, @credentials : CatalogsFeedCredentials? = nil, @preferred_processing_schedule : CatalogsFeedProcessingSchedule? = nil, @default_country : Country? = nil, @default_availability : ProductAvailabilityType? = nil, @status : CatalogsStatus? = nil)
    end
