...
module OpenAPIClient
  ...
  class CatalogsFeedsCreateRequest
    ...
    def initialize(@format : CatalogsFormat, @location : String, @name : String, @credentials : CatalogsFeedCredentials? = nil, @default_availability : ProductAvailabilityType? = nil, @default_country : Country? = nil, @default_currency : NullableCurrency? = nil, @default_locale : CatalogsFeedsCreateRequestDefaultLocale? = nil, @preferred_processing_schedule : CatalogsFeedProcessingSchedule? = nil, @status : CatalogsStatus? = nil)
    end
    ...
    def hash
      [credentials, default_availability, default_country, default_currency, default_locale, format, location, name, preferred_processing_schedule, status].hash
    end
