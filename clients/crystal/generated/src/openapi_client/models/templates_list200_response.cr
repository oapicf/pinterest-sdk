...
module OpenAPIClient
  class TemplatesList200Response
    ...
    # Required properties
    @[JSON::Field(key: "items", type: Array(TemplateResponse), nillable: false, emit_null: false)]
    property items : Array(TemplateResponse)
    ...
    def initialize(@items : Array(TemplateResponse), @bookmark : String? = nil)
    end
