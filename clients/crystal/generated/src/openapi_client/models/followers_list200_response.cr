...
module OpenAPIClient
  class FollowersList200Response
    ...
    # Required properties
    @[JSON::Field(key: "items", type: Array(UserSummary), nillable: false, emit_null: false)]
    property items : Array(UserSummary)
    ...
    def initialize(@items : Array(UserSummary), @bookmark : String? = nil)
    end
