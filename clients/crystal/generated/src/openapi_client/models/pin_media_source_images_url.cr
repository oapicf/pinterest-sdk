...
module OpenAPIClient
  ...
  class PinMediaSourceImagesURL
    ...
    @[JSON::Field(key: "items", type: Array(PinMediaSourceImagesURLItem), nillable: false, emit_null: false)]
    property items : Array(PinMediaSourceImagesURLItem)
    ...
    def initialize(@items : Array(PinMediaSourceImagesURLItem), @source_type : String, @index : Int32? = nil)
    end
