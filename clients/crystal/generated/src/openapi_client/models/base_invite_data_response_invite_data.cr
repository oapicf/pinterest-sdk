  ...
  class BaseInviteDataResponseInviteData
    ...
    def ==(other)
      ...
      self.class == other.class &&
          invite_expiration == other.invite_expiration &&
          invite_status == other.invite_status &&
    ...
    def to_h
      ...
      hash["invite_expiration"] = _to_h(invite_expiration)
      hash["invite_status"] = _to_h(invite_status)
      hash["invite_type"] = _to_h(invite_type)
      hash["last_updated_time"] = _to_h(last_updated_time)
      hash["sent_at"] = _to_h(sent_at)
      hash.to_h
    end
