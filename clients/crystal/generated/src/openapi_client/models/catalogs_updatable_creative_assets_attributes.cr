...
module OpenAPIClient
  class CatalogsUpdatableCreativeAssetsAttributes
    ...
    def initialize(@title : String?, @description : String?, @link : String?, @ios_deep_link : String?, @android_deep_link : String?, @google_product_category : String?, @custom_label_0 : String?, @custom_label_1 : String?, @custom_label_2 : String?, @custom_label_3 : String?, @custom_label_4 : String?, @visibility : String?)
    end
