...
module OpenAPIClient
  ...
  class IntegrationLog
    ...
    def list_invalid_properties
      ...
      if !@message.nil? && @message.try &.to_s.try &.size.try &.> 8192
    ...
    def valid?
      ...
      return false if !@message.nil? && @message.try &.to_s.try &.size.try &.> 8192
    ...
    def message=(message)
      if !message.nil? && message.to_s.size > 8192
        raise ArgumentError.new("invalid value for \"message\", the character length must be smaller than or equal to 8192.")
      end
