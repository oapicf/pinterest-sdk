...
module OpenAPIClient
  ...
  class ScheduleAppTypeMultipliers
    ...
    # Optional properties
    @[JSON::Field(key: "APP_TYPE", emit_null: false)]
    property app_type : TargetingSpecAppType?


    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@app_type : TargetingSpecAppType? = nil)
    end
