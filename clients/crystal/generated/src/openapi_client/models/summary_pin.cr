...
module OpenAPIClient
  ...
  class SummaryPin
    ...
    def initialize(@media : PinMedia? = nil, @alt_text : String? = nil, @link : String? = nil, @title : String? = nil, @description : String? = nil)
    end
    ...
    def hash
      [media, alt_text, link, title, description].hash
    end
