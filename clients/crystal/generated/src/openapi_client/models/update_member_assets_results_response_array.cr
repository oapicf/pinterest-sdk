...
module OpenAPIClient
  class UpdateMemberAssetsResultsResponseArray
    ...
    @[JSON::Field(key: "items", type: Array(UpdateMemberAssetsResultsResponseArrayItemsInner)?, nillable: true, emit_null: false)]
    property items : Array(UpdateMemberAssetsResultsResponseArrayItemsInner)?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@items : Array(UpdateMemberAssetsResultsResponseArrayItemsInner)? = nil)
    end
