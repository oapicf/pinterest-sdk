...
module OpenAPIClient
  class BusinessAssetsGet200Response
    ...
    @[JSON::Field(key: "items", type: Array(GetBusinessAssetsResponse), nillable: false, emit_null: false)]
    property items : Array(GetBusinessAssetsResponse)
    ...
    def initialize(@items : Array(GetBusinessAssetsResponse), @bookmark : String? = nil)
    end
