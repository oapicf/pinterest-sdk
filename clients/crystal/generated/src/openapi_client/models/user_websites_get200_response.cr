...
module OpenAPIClient
  class UserWebsitesGet200Response
    ...
    # Required properties
    @[JSON::Field(key: "items", type: Array(UserWebsiteSummary), nillable: false, emit_null: false)]
    property items : Array(UserWebsiteSummary)
    ...
    def initialize(@items : Array(UserWebsiteSummary), @bookmark : String? = nil)
    end
