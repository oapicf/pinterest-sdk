...
module OpenAPIClient
  class AdAccountsSubscriptionsGetList200Response
    ...
    # Required properties
    @[JSON::Field(key: "items", type: Array(LeadSubscription), nillable: false, emit_null: false)]
    property items : Array(LeadSubscription)
    ...
    def initialize(@items : Array(LeadSubscription), @bookmark : String? = nil)
    end
