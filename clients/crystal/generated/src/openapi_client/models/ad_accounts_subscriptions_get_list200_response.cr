...
module OpenAPIClient
  class AdAccountsSubscriptionsGetList200Response
    ...
    # Required properties
    @[JSON::Field(key: "items", type: Array(AdAccountGetSubscriptionResponse), nillable: false, emit_null: false)]
    property items : Array(AdAccountGetSubscriptionResponse)
    ...
    def initialize(@items : Array(AdAccountGetSubscriptionResponse), @bookmark : String? = nil)
    end
