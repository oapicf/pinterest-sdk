...
module OpenAPIClient
  ...
  class CatalogsFeedsUpdateRequest
    ...
    def initialize(@credentials : CatalogsFeedCredentials? = nil, @default_availability : ProductAvailabilityType? = nil, @default_currency : NullableCurrency? = nil, @format : CatalogsFormat? = nil, @location : String? = nil, @name : String? = nil, @preferred_processing_schedule : CatalogsFeedProcessingSchedule? = nil, @status : CatalogsStatus? = nil)
    end
