...
module OpenAPIClient
  ...
  class CatalogsFeedsUpdateRequest
    ...
    def initialize(@default_availability : ProductAvailabilityType? = nil, @default_currency : NullableCurrency? = nil, @name : String? = nil, @format : CatalogsFormat? = nil, @credentials : CatalogsFeedCredentials? = nil, @location : String? = nil, @preferred_processing_schedule : CatalogsFeedProcessingSchedule? = nil, @status : CatalogsStatus? = nil)
    end
    ...
    def hash
      [default_availability, default_currency, name, format, credentials, location, preferred_processing_schedule, status].hash
    end
