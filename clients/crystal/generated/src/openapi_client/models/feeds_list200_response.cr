...
module OpenAPIClient
  class FeedsList200Response
    ...
    # Required properties
    @[JSON::Field(key: "items", type: Array(CatalogsFeed), nillable: false, emit_null: false)]
    property items : Array(CatalogsFeed)
    ...
    def initialize(@items : Array(CatalogsFeed), @bookmark : String? = nil)
    end
