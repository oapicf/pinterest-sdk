...
module OpenAPIClient
  class InviteResponse
    ...
    def initialize(@assets_summary : InviteAssetsSummary?, @business_roles : Array(String)?, @created_by_business : BusinessAccessUserSummary?, @created_by_user : BusinessAccessUserSummary?, @created_time : Int32?, @id : String?, @invite_data : BaseInviteDataResponseInviteData?, @is_received_invite : Bool?, @user : BusinessAccessUserSummary?)
    end
    ...
    def hash
      [assets_summary, business_roles, created_by_business, created_by_user, created_time, id, invite_data, is_received_invite, user].hash
    end
