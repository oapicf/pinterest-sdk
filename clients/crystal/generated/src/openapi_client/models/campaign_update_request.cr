...
module OpenAPIClient
  class CampaignUpdateRequest
    ...
    @[JSON::Field(key: "bid_options", type: CampaignBidOptionsUpdate?, nillable: true, emit_null: false)]
    ...
    def initialize(@id : String, @ad_account_id : String, @daily_spend_cap : Int32? = nil, @end_time : Int32? = nil, @is_automated_campaign : Bool? = nil, @is_flexible_daily_budgets : Bool? = nil, @lifetime_spend_cap : Int32? = nil, @name : String? = nil, @order_line_id : String? = nil, @start_time : Int32? = nil, @status : EntityStatus? = nil, @tracking_urls : TrackingUrls? = nil, @default_ad_group_budget_in_micro_currency : Int32? = nil, @is_campaign_budget_optimization : Bool? = nil, @bid_options : CampaignBidOptionsUpdate? = nil, @is_performance_plus : Bool? = nil, @objective_type : ObjectiveType? = nil)
    end
    ...
    def hash
      [id, ad_account_id, daily_spend_cap, end_time, is_automated_campaign, is_flexible_daily_budgets, lifetime_spend_cap, name, order_line_id, start_time, status, tracking_urls, default_ad_group_budget_in_micro_currency, is_campaign_budget_optimization, bid_options, is_performance_plus, objective_type].hash
    end
