...
module OpenAPIClient
  class CampaignUpdateRequest
    ...
    def initialize(@id : String, @ad_account_id : String, @name : String? = nil, @status : EntityStatus? = nil, @lifetime_spend_cap : Int32? = nil, @daily_spend_cap : Int32? = nil, @order_line_id : String? = nil, @tracking_urls : TrackingUrls? = nil, @start_time : Int32? = nil, @end_time : Int32? = nil, @is_flexible_daily_budgets : Bool? = nil, @default_ad_group_budget_in_micro_currency : Int32? = nil, @is_automated_campaign : Bool? = nil, @is_campaign_budget_optimization : Bool? = nil, @objective_type : ObjectiveType? = nil)
    end
    ...
    def hash
      [id, ad_account_id, name, status, lifetime_spend_cap, daily_spend_cap, order_line_id, tracking_urls, start_time, end_time, is_flexible_daily_budgets, default_ad_group_budget_in_micro_currency, is_automated_campaign, is_campaign_budget_optimization, objective_type].hash
    end
