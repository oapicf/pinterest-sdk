...
module OpenAPIClient
  class ProductGroupPromotionResponse
    ...
    # Optional properties
    @[JSON::Field(key: "items", type: Array(ProductGroupPromotionResponseItem)?, nillable: true, emit_null: false)]
    property items : Array(ProductGroupPromotionResponseItem)?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@items : Array(ProductGroupPromotionResponseItem)? = nil)
    end
