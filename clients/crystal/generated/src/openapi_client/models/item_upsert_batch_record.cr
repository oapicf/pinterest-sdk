...
module OpenAPIClient
  ...
  class ItemUpsertBatchRecord
    ...
    # Optional properties
    @[JSON::Field(key: "attributes", type: ItemAttributesRequest?, nillable: true, emit_null: false)]
    ...
    def initialize(@attributes : ItemAttributesRequest? = nil, @item_id : String? = nil)
    end
