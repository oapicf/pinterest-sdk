...
module OpenAPIClient
  ...
  class CatalogsProductGroupUpdateRequest
    ...
    def initialize(@name : String? = nil, @description : String? = nil, @is_featured : Bool? = nil, @filters : CatalogsProductGroupFiltersRequest? = nil)
    end
    ...
    def hash
      [name, description, is_featured, filters].hash
    end
