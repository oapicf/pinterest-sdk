...
module OpenAPIClient
  ...
  class PinMediaWithImages
    ...
    # Optional properties
    @[JSON::Field(key: "items", type: Array(ImageMetadata)?, nillable: true, emit_null: false)]
    property items : Array(ImageMetadata)?
    ...
    class EnumAttributeValidatorForMedia_type < EnumAttributeValidator
      ...
      def initialize
        ...
        @allowable_values = ["multiple_images"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@media_type : String, @items : Array(ImageMetadata)? = nil)
    end
