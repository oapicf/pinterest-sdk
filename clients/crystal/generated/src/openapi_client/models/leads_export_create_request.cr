...
module OpenAPIClient
  class LeadsExportCreateRequest
    ...
    @[JSON::Field(key: "ad_id", type: String, nillable: false, emit_null: false)]
    ...
    def ad_id=(ad_id)
      pattern = /^\d+$/
      if ad_id !~ pattern
        raise ArgumentError.new("invalid value for \"ad_id\", must conform to the pattern #{pattern}.")
      end
