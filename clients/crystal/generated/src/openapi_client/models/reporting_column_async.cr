...
module OpenAPIClient
  class ReportingColumnAsync
    ...
    def build_from_hash(value)
      ...
      when "ADS_CREDIT_SPEND_IN_MICRO_DOLLAR"
        ADS_CREDIT_SPEND_IN_MICRO_DOLLAR
      when "ADS_CREDIT_SPEND_IN_DOLLAR"
      ...
      when "CAMPAIGN_STATUS"
        CAMPAIGN_STATUS
      when "CAMPAIGN_BRAND_LABEL"
        CAMPAIGN_BRAND_LABEL
      when "CAMPAIGN_CUSTOM_LABELS"
      ...
      when "PROMO_NAME"
        PROMO_NAME
      when "PRODUCT_ITEM_NAME"
        PRODUCT_ITEM_NAME
      when "PRODUCT_ITEM_IMAGE_URL"
        PRODUCT_ITEM_IMAGE_URL
      when "PRODUCT_ITEM_PRICE"
        PRODUCT_ITEM_PRICE
      when "PRODUCT_ITEM_PRODUCT_URL"
        PRODUCT_ITEM_PRODUCT_URL
      when "PRODUCT_ITEM_PIN_URL"
        PRODUCT_ITEM_PIN_URL
      when "PRODUCT_ITEM_BRAND"
        PRODUCT_ITEM_BRAND
      when "PRODUCT_ITEM_DESCRIPTION"
        PRODUCT_ITEM_DESCRIPTION
      when "PRODUCT_ITEM_SALE_PRICE"
        PRODUCT_ITEM_SALE_PRICE
      when "PRODUCT_ITEM_PRODUCT_TYPE"
        PRODUCT_ITEM_PRODUCT_TYPE
      when "PRODUCT_ITEM_PRODUCT_CATEGORY"
        PRODUCT_ITEM_PRODUCT_CATEGORY
      when "PRODUCT_ITEM_CURRENCY"
      ...
      when "COST_PER_OUTBOUND_CLICK_IN_DOLLAR_1"
      ...
      when "AD_GROUP_OPTIMIZATION"
        AD_GROUP_OPTIMIZATION
      when "CAMPAIGN_DAILY_SPEND_CAP"
        CAMPAIGN_DAILY_SPEND_CAP
      when "CAMPAIGN_BUDGET_OPTIMIZATION"
        CAMPAIGN_BUDGET_OPTIMIZATION
      when "IS_PREMIERE_CAMPAIGN"
      ...
      when "TOTAL_APP_INSTALL"
        TOTAL_APP_INSTALL
      when "TOTAL_ADD_TO_WISHLIST"
        TOTAL_ADD_TO_WISHLIST
      when "TOTAL_SUBSCRIBE"
        TOTAL_SUBSCRIBE
      ...
      when "CUSTOM_ROAS"
        CUSTOM_ROAS
      when "PRODUCT_GROUP_AD_IMAGE_TAG"
        PRODUCT_GROUP_AD_IMAGE_TAG
      when "PRODUCT_GROUP_AD_VIDEO_TAG"
        PRODUCT_GROUP_AD_VIDEO_TAG
      when "VIDEO_3SEC_VIEWS_1"
        VIDEO_3_SEC_VIEWS_1
      when "VIDEO_15SEC_UNIQUE_VIEWS_1"
      ...
      when "VIDEO_3SEC_VIEWS_2"
        VIDEO_3_SEC_VIEWS_2
      when "VIDEO_15SEC_UNIQUE_VIEWS_2"
      ...
      when "TOTAL_VIDEO_15SEC_UNIQUE_VIEWS"
      ...
      when "TOTAL_APP_INSTALL_CONVERSION_RATE"
        TOTAL_APP_INSTALL_CONVERSION_RATE
      when "TOTAL_INAPP_APP_INSTALL_CONVERSION_RATE"
        TOTAL_INAPP_APP_INSTALL_CONVERSION_RATE
      when "IDEA_PIN_PAGE_FORWARD_1"
        IDEA_PIN_PAGE_FORWARD_1
      when "IDEA_PIN_PAGE_FORWARD_2"
        IDEA_PIN_PAGE_FORWARD_2
      when "IDEA_PIN_PAGE_BACKWARD_1"
        IDEA_PIN_PAGE_BACKWARD_1
      when "IDEA_PIN_PAGE_BACKWARD_2"
        IDEA_PIN_PAGE_BACKWARD_2
      when "TOTAL_IDEA_PIN_PAGE_FORWARD"
        TOTAL_IDEA_PIN_PAGE_FORWARD
      when "TOTAL_IDEA_PIN_PAGE_BACKWARD"
