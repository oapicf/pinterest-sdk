...
module OpenAPIClient
  ...
  class DeletedMembersResponse
    ...
    @[JSON::Field(key: "deleted_members", type: Array(String)?, nillable: true, emit_null: false)]
    ...
    def ==(other)
      ...
      self.class == other.class &&
          deleted_members == other.deleted_members
    end
    ...
    def to_h
      ...
      hash["deleted_members"] = _to_h(deleted_members)
      hash.to_h
    end
