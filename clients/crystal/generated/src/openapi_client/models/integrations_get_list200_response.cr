...
module OpenAPIClient
  class IntegrationsGetList200Response
    ...
    # Required properties
    @[JSON::Field(key: "items", type: Array(IntegrationRecord), nillable: false, emit_null: false)]
    property items : Array(IntegrationRecord)
    ...
    def initialize(@items : Array(IntegrationRecord), @bookmark : String? = nil)
    end
