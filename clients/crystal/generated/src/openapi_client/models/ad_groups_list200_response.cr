...
module OpenAPIClient
  class AdGroupsList200Response
    ...
    # Required properties
    @[JSON::Field(key: "items", type: Array(AdGroupResponse), nillable: false, emit_null: false)]
    property items : Array(AdGroupResponse)
    ...
    def initialize(@items : Array(AdGroupResponse), @bookmark : String? = nil)
    end
