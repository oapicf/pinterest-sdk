...
module OpenAPIClient
  class BoardSectionsList200Response
    ...
    # Required properties
    # Board sections
    @[JSON::Field(key: "items", type: Array(BoardSection), nillable: false, emit_null: false)]
    property items : Array(BoardSection)
    ...
    def initialize(@items : Array(BoardSection), @bookmark : String? = nil)
    end
