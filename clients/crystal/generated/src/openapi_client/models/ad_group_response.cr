...
module OpenAPIClient
  class AdGroupResponse
    ...
    def initialize(@name : String?, @status : EntityStatus?, @budget_in_micro_currency : Int32?, @bid_in_micro_currency : Int32?, @optimization_goal_metadata : AdGroupCommonOptimizationGoalMetadata?, @budget_type : BudgetType?, @start_time : Int32?, @end_time : Int32?, @targeting_spec : TargetingSpec?, @lifetime_frequency_cap : Int32?, @tracking_urls : AdGroupCommonTrackingUrls?, @auto_targeting_enabled : Bool?, @placement_group : PlacementGroupType?, @pacing_delivery_type : PacingDeliveryType?, @campaign_id : String?, @billable_event : ActionType?, @bid_strategy_type : String?, @id : String?, @ad_account_id : String?, @created_time : Int32?, @updated_time : Int32?, @_type : String?, @conversion_learning_mode_type : String?, @summary_status : AdGroupSummaryStatus?, @feed_profile_id : String?, @dca_assets : Object?)
    end
