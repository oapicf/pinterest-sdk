...
module OpenAPIClient
  class CampaignCreateResponseItem
    ...
    # Optional properties
    @[JSON::Field(key: "data", type: CampaignCreateResponseData?, nillable: true, emit_null: false)]
    property data : CampaignCreateResponseData?
    ...
    def initialize(@data : CampaignCreateResponseData? = nil, @exceptions : Array(Exception)? = nil)
    end
