...
module OpenAPIClient
  ...
  class CatalogsProductGroupCurrencyCriteria
    ...
    # Required properties
    @[JSON::Field(key: "values", type: NonNullableCatalogsCurrency, nillable: false, emit_null: false)]
    property values : NonNullableCatalogsCurrency
    ...
    def initialize(@values : NonNullableCatalogsCurrency, @negated : Bool? = nil)
    end
