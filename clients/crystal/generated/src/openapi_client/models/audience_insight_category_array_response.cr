...
module OpenAPIClient
  class AudienceInsightCategoryArrayResponse
    ...
    # Optional properties
    @[JSON::Field(key: "items", type: Array(AudienceInsightCategoryCommon)?, nillable: true, emit_null: false)]
    property items : Array(AudienceInsightCategoryCommon)?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@items : Array(AudienceInsightCategoryCommon)? = nil)
    end
