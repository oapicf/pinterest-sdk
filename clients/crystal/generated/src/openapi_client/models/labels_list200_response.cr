...
module OpenAPIClient
  class LabelsList200Response
    ...
    # Required properties
    @[JSON::Field(key: "items", type: Array(LabelsResponse), nillable: false, emit_null: false)]
    property items : Array(LabelsResponse)
    ...
    def initialize(@items : Array(LabelsResponse), @bookmark : String? = nil)
    end
