...
module OpenAPIClient
  ...
  class QualityComponentDetails
    ...
    @[JSON::Field(key: "coverage", type: Float64, nillable: false, emit_null: false)]
    property coverage : Float64

    # Optional properties
    # List of issues detected for this event type, if any.
    @[JSON::Field(key: "issues", type: Array(QualityComponentIssue)?, nillable: true, emit_null: false)]
    property issues : Array(QualityComponentIssue)?

    # Overlap percentage for this event type. Only populated for external_event_id
    @[JSON::Field(key: "overlap", type: Float64?, nillable: true, emit_null: false)]
    ...
    def to_h
      ...
      hash["coverage"] = _to_h(coverage)
      hash["issues"] = _to_h(issues)
      hash["overlap"] = _to_h(overlap)
      hash.to_h
    end
