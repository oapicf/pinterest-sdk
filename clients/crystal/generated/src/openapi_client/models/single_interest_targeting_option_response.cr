...
module OpenAPIClient
  class SingleInterestTargetingOptionResponse
    ...
    # Optional properties
    @[JSON::Field(key: "child_interests", type: Array(String)?, nillable: true, emit_null: false)]
    property child_interests : Array(String)?
    ...
    def initialize(@child_interests : Array(String)? = nil, @id : String? = nil, @level : Int32? = nil, @name : String? = nil)
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
          child_interests == other.child_interests &&
          id == other.id &&
          level == other.level &&
          name == other.name
    end
    ...
    def to_h
      ...
      hash["child_interests"] = _to_h(child_interests)
      hash["id"] = _to_h(id)
