...
module OpenAPIClient
  ...
  class BulkUpsertStatusResponse
    ...
    # Optional properties
    @[JSON::Field(key: "result_url", type: String?, nillable: true, emit_null: false)]
    property result_url : String?

    @[JSON::Field(key: "status", type: BulkUpsertStatus?, nillable: true, emit_null: false)]
    property status : BulkUpsertStatus?
    ...
    def initialize(@result_url : String? = nil, @status : BulkUpsertStatus? = nil)
    end
    ...
    def to_h
      ...
      hash["result_url"] = _to_h(result_url)
