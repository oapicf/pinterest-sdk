...
module OpenAPIClient
  class CreateMMMReportRequest
    ...
    def initialize(@report_name : String, @start_date : String, @end_date : String, @granularity : String, @level : String, @targeting_types : Array(MMMReportingTargetingType), @columns : Array(MMMReportingColumn), @countries : Array(TargetingAdvertiserCountry)?)
    end
    ...
    def valid?
      ...
      return false if @targeting_types.size > 5
      return false if @targeting_types.size < 1
      true
    end
    ...
    def granularity=(granularity)
      ...
      unless validator.valid?(granularity)
        raise ArgumentError.new("invalid value for \"granularity\", must be one of #{validator.allowable_values}.")
      end
    ...
    def level=(level)
      ...
      unless validator.valid?(level)
        raise ArgumentError.new("invalid value for \"level\", must be one of #{validator.allowable_values}.")
      end
      @level = level
    end
    ...
    def hash
      [report_name, start_date, end_date, granularity, level, targeting_types, columns, countries].hash
    end
