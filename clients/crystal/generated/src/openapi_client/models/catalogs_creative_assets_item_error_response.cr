...
module OpenAPIClient
  ...
  class CatalogsCreativeAssetsItemErrorResponse
    ...
    @[JSON::Field(key: "errors", type: Array(ItemValidationEvent), nillable: false, emit_null: false)]
    ...
    def initialize(@catalog_type : CatalogsType, @errors : Array(ItemValidationEvent), @creative_assets_id : String? = nil)
    end
