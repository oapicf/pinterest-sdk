...
module OpenAPIClient
  ...
  class DeletePartnersResponse
    ...
    @[JSON::Field(key: "deleted_partners", type: Array(String)?, nillable: true, emit_null: false)]
    ...
    def ==(other)
      ...
      self.class == other.class &&
          deleted_partners == other.deleted_partners
    end
    ...
    def to_h
      ...
      hash["deleted_partners"] = _to_h(deleted_partners)
      hash.to_h
    end
