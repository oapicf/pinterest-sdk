...
module OpenAPIClient
  class PageVisitConversionTagsGet200Response
    ...
    # Required properties
    @[JSON::Field(key: "items", type: Array(ConversionEventResponse), nillable: false, emit_null: false)]
    property items : Array(ConversionEventResponse)
    ...
    def initialize(@items : Array(ConversionEventResponse), @bookmark : String? = nil)
    end
