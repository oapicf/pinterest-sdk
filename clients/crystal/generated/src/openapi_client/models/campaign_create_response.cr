...
module OpenAPIClient
  class CampaignCreateResponse
    ...
    # Optional properties
    @[JSON::Field(key: "items", type: Array(CampaignCreateResponseItem)?, nillable: true, emit_null: false)]
    property items : Array(CampaignCreateResponseItem)?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@items : Array(CampaignCreateResponseItem)? = nil)
    end
