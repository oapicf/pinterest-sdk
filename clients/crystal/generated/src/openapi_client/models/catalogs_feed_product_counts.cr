...
module OpenAPIClient
  ...
  class CatalogsFeedProductCounts
    ...
    @[JSON::Field(key: "ingested", type: Int32?, nillable: true, emit_null: false)]
    property ingested : Int32?

    # The number of products in the feed file.
    @[JSON::Field(key: "original", type: Int32?, nillable: true, emit_null: false)]
    ...
    def to_h
      ...
      hash["ingested"] = _to_h(ingested)
      hash["original"] = _to_h(original)
      hash.to_h
    end
