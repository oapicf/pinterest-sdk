...
module OpenAPIClient
  class AdCreateRequest
    ...
    def valid?
      return false if @ad_group_id.try &.!~ /^(AG)?\d+$/
      return false if !@lead_form_id.nil? && @lead_form_id.try &.!~ /^(AG)?\d+$/
      return false if @pin_id.try &.!~ /^\d+$/
      true
    end
