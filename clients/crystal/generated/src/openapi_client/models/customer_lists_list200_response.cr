...
module OpenAPIClient
  class CustomerListsList200Response
    ...
    # Required properties
    @[JSON::Field(key: "items", type: Array(CustomerList), nillable: false, emit_null: false)]
    property items : Array(CustomerList)
    ...
    def initialize(@items : Array(CustomerList), @bookmark : String? = nil)
    end
