...
module OpenAPIClient
  class UpdateMemberResultsResponseArray
    ...
    @[JSON::Field(key: "items", type: Array(UpdateMemberResult)?, nillable: true, emit_null: false)]
    property items : Array(UpdateMemberResult)?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@items : Array(UpdateMemberResult)? = nil)
    end
