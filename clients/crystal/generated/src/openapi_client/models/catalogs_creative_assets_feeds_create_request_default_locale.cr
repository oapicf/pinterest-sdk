...
module OpenAPIClient
  ...
  # CatalogsCreativeAssetsFeedsCreateRequestDefaultLocale (OpenAPI anyOf): a value matching at least one of the listed schemas.
  ...
  class CatalogsCreativeAssetsFeedsCreateRequestDefaultLocale
    ...
    def initialize(@value : CatalogsLocale)
    end
    ...
    def self.from_json_any(data : JSON::Any) : self
      json = data.to_json
      begin
        return new(CatalogsLocale.from_json(json))
      ...
      raise JSON::ParseException.new("`#{json}` doesn't match any schema listed in CatalogsCreativeAssetsFeedsCreateRequestDefaultLocale (anyOf)", 0, 0)
    end

    def self.new(ctx : YAML::ParseContext, node : YAML::Nodes::Node)
      begin
        return new(CatalogsLocale.new(ctx, node))
      ...
      raise YAML::ParseException.new("doesn't match any schema listed in CatalogsCreativeAssetsFeedsCreateRequestDefaultLocale (anyOf)", 0, 0)
    end
