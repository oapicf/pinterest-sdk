...
module OpenAPIClient
  ...
  class BoardUpdate
    ...
    @[JSON::Field(key: "privacy", type: String?, nillable: true, emit_null: false)]
    ...
    class EnumAttributeValidatorForPrivacy < EnumAttributeValidator
      ...
      def initialize
        @attribute = "privacy"
        @allowable_values = ["PUBLIC", "SECRET"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@name : String? = nil, @description : String? = nil, @privacy : String? = nil)
    end
