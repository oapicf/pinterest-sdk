...
module OpenAPIClient
  ...
  class BoardUpdate
    ...
    def initialize(@name : String?, @description : String?, @privacy : String?)
    end
    ...
    def valid?
      privacy_validator = EnumAttributeValidator.new("String", ["PUBLIC", "SECRET"])
    ...
    def privacy=(privacy)
      validator = EnumAttributeValidator.new("String", ["PUBLIC", "SECRET"])
