...
module OpenAPIClient
  ...
  class AudienceDefinitionType
    ...
    class EnumAttributeValidatorForScope < EnumAttributeValidator
      @attribute : String
      @allowable_values : Array(Int32 | Int64 | Float32 | Float64 | String)

      def initialize
        @attribute = "scope"
        @allowable_values = ["IMPRESSION_PLUS_ENGAGEMENT", "ENGAGEMENT"].map { |value| to(String, value)}
      end
    end
    ...
    def list_invalid_properties
      ...
      scope_validator = EnumAttributeValidatorForScope.new
      if !scope_validator.valid?(@scope)
        message = scope_validator.message
    ...
    def scope=(scope)
      validator = EnumAttributeValidatorForScope.new
