...
module OpenAPIClient
  class CampaignCreateCommon
    ...
    def initialize(@ad_account_id : String?, @name : String?, @status : EntityStatus?, @lifetime_spend_cap : Int32?, @daily_spend_cap : Int32?, @order_line_id : String?, @tracking_urls : TrackingUrls?, @start_time : Int32?, @end_time : Int32?, @is_flexible_daily_budgets : Bool?, @default_ad_group_budget_in_micro_currency : Int32?, @is_automated_campaign : Bool?)
    end
