...
module OpenAPIClient
  class CatalogsHotelProductGroupFilterKeys
    ...
    def initialize(@price : CatalogsProductGroupPricingCurrencyCriteria, @hotel_id : CatalogsProductGroupMultipleStringCriteria, @brand : CatalogsProductGroupMultipleStringCriteria, @custom_label_0 : CatalogsProductGroupMultipleStringCriteria, @custom_label_1 : CatalogsProductGroupMultipleStringCriteria, @custom_label_2 : CatalogsProductGroupMultipleStringCriteria, @custom_label_3 : CatalogsProductGroupMultipleStringCriteria, @custom_label_4 : CatalogsProductGroupMultipleStringCriteria, @country : CatalogsProductGroupMultipleCountriesCriteria)
    end
    ...
    def hash
      [price, hotel_id, brand, custom_label_0, custom_label_1, custom_label_2, custom_label_3, custom_label_4, country].hash
    end
