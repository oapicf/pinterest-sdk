...
module OpenAPIClient
  ...
  class TrendingKeywordDemographicsAgeDistribution
    ...
    # Optional properties
    @[JSON::Field(key: "age_distribution", type: String?, nillable: true, emit_null: false)]
    property age_distribution : String?
    ...
    class EnumAttributeValidatorForAge_distribution < EnumAttributeValidator
      @attribute : String
      @allowable_values : Array(Int32 | Int64 | Float32 | Float64 | String)

      def initialize
        @attribute = "age_distribution"
        @allowable_values = ["18-24", "25-34", "35-44", "45-49", "50-54", "55-64", "65+"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@age_distribution : String? = nil)
    end
    ...
    def list_invalid_properties
      ...
      age_distribution_validator = EnumAttributeValidatorForAge_distribution.new
      if !age_distribution_validator.valid?(@age_distribution)
        message = age_distribution_validator.message
    ...
    def age_distribution=(age_distribution)
      validator = EnumAttributeValidatorForAge_distribution.new
    ...
    def to_h
      ...
      hash["age_distribution"] = _to_h(age_distribution)
      hash.to_h
    end
