...
module OpenAPIClient
  class S3FilePart
    ...
    @[JSON::Field(key: "part_number", type: Int32, nillable: false, emit_null: false)]
    property part_number : Int32

    # Pre-signed URL.
    @[JSON::Field(key: "presigned_url", type: String, nillable: false, emit_null: false)]
    ...
    def ==(other)
      ...
      self.class == other.class &&
          ...
          presigned_url == other.presigned_url
    end
    ...
    def to_h
      ...
      hash["presigned_url"] = _to_h(presigned_url)
      hash.to_h
    end
