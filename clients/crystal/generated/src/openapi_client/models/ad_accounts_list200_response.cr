...
module OpenAPIClient
  class AdAccountsList200Response
    ...
    # Required properties
    # Ad accounts
    @[JSON::Field(key: "items", type: Array(AdAccount), nillable: false, emit_null: false)]
    property items : Array(AdAccount)
    ...
    def initialize(@items : Array(AdAccount), @bookmark : String? = nil)
    end
