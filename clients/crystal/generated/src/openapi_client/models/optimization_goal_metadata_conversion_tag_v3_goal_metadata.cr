...
module OpenAPIClient
  class OptimizationGoalMetadataConversionTagV3GoalMetadata
    ...
    @[JSON::Field(key: "reporting_event", type: String?, nillable: true, emit_null: false)]
    ...
    class EnumAttributeValidatorForConversion_event < EnumAttributeValidator
      @attribute : String
      @allowable_values : Array(Int32 | Int64 | Float32 | Float64 | String)

      def initialize
        @attribute = "conversion_event"
        @allowable_values = ["PAGE_VISIT", "SIGNUP", "CHECKOUT", "CUSTOM", "VIEW_CATEGORY", "SEARCH", "ADD_TO_CART", "WATCH_VIDEO", "LEAD", "APP_INSTALL"].map { |value| to(String, value)}
      end
    end

    class EnumAttributeValidatorForLearning_mode_type < EnumAttributeValidator
      @attribute : String
      @allowable_values : Array(Int32 | Int64 | Float32 | Float64 | String)

      def initialize
        @attribute = "learning_mode_type"
    ...
    def initialize(@attribution_windows : OptimizationGoalMetadataConversionTagV3GoalMetadataAttributionWindows? = nil, @conversion_event : String? = nil, @conversion_tag_id : String? = nil, @cpa_goal_value_in_micro_currency : String? = nil, @is_roas_optimized : Bool? = nil, @learning_mode_type : String? = nil, @reporting_event : String? = nil)
    end
    ...
    def list_invalid_properties
      ...
      conversion_event_validator = EnumAttributeValidatorForConversion_event.new
      if !conversion_event_validator.valid?(@conversion_event)
        message = conversion_event_validator.message
        invalid_properties.push(message)
      end

      pattern = /^[0-9]+$/
      if !@conversion_tag_id.nil? && @conversion_tag_id.try &.!~ pattern
        invalid_properties.push("invalid value for \"conversion_tag_id\", must conform to the pattern #{pattern}.")
      end

      pattern = /^[0-9]+$/
      if !@cpa_goal_value_in_micro_currency.nil? && @cpa_goal_value_in_micro_currency.try &.!~ pattern
        invalid_properties.push("invalid value for \"cpa_goal_value_in_micro_currency\", must conform to the pattern #{pattern}.")
      end

      learning_mode_type_validator = EnumAttributeValidatorForLearning_mode_type.new
      if !learning_mode_type_validator.valid?(@learning_mode_type)
        message = learning_mode_type_validator.message
        invalid_properties.push(message)
      end
    ...
    def valid?
      ...
      return false if !@conversion_tag_id.nil? && @conversion_tag_id.try &.!~ /^[0-9]+$/
      return false if !@cpa_goal_value_in_micro_currency.nil? && @cpa_goal_value_in_micro_currency.try &.!~ /^[0-9]+$/
      learning_mode_type_validator = EnumAttributeValidatorForLearning_mode_type.new
    ...
    def conversion_event=(conversion_event)
      validator = EnumAttributeValidatorForConversion_event.new
    ...
    def learning_mode_type=(learning_mode_type)
      validator = EnumAttributeValidatorForLearning_mode_type.new
    ...
    def ==(other)
      ...
      self.class == other.class &&
          attribution_windows == other.attribution_windows &&
          conversion_event == other.conversion_event &&
          conversion_tag_id == other.conversion_tag_id &&
          cpa_goal_value_in_micro_currency == other.cpa_goal_value_in_micro_currency &&
          is_roas_optimized == other.is_roas_optimized &&
          learning_mode_type == other.learning_mode_type &&
          reporting_event == other.reporting_event
    end
    ...
    def to_h
      ...
      hash["attribution_windows"] = _to_h(attribution_windows)
      hash["conversion_event"] = _to_h(conversion_event)
      hash["conversion_tag_id"] = _to_h(conversion_tag_id)
      hash["cpa_goal_value_in_micro_currency"] = _to_h(cpa_goal_value_in_micro_currency)
      hash["is_roas_optimized"] = _to_h(is_roas_optimized)
      hash["learning_mode_type"] = _to_h(learning_mode_type)
      hash["reporting_event"] = _to_h(reporting_event)
      hash.to_h
    end
