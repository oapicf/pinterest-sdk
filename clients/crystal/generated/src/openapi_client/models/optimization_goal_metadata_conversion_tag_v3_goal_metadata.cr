...
module OpenAPIClient
  class OptimizationGoalMetadataConversionTagV3GoalMetadata
    ...
    def initialize(@attribution_windows : OptimizationGoalMetadataConversionTagV3GoalMetadataAttributionWindows? = nil, @conversion_event : String? = nil, @conversion_tag_id : String? = nil, @cpa_goal_value_in_micro_currency : String? = nil, @is_roas_optimized : Bool? = nil, @learning_mode_type : String? = nil)
    end
