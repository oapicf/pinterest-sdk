...
module OpenAPIClient
  class BillingInvoicesGet200Response
    ...
    # Required properties
    @[JSON::Field(key: "items", type: Array(BillingInvoiceResponse), nillable: false, emit_null: false)]
    property items : Array(BillingInvoiceResponse)
    ...
    def initialize(@items : Array(BillingInvoiceResponse), @bookmark : String? = nil)
    end
