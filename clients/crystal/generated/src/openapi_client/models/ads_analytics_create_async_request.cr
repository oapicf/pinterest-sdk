...
module OpenAPIClient
  class AdsAnalyticsCreateAsyncRequest
    ...
    @[JSON::Field(key: "campaign_brand_label", type: String?, nillable: true, emit_null: false)]
    ...
    @[JSON::Field(key: "targeting_types", type: Array(String)?, nillable: true, emit_null: false)]
    property targeting_types : Array(String)?
    ...
    @[JSON::Field(key: "combine_targeting_types", type: Bool?, default: false, nillable: true, emit_null: false)]
    property combine_targeting_types : Bool?

    # List of advertiser-defined custom conversion event metrics to include in the report
    @[JSON::Field(key: "custom_conversion_event_metrics", type: Array(AdsAnalyticsCreateAsyncRequestAllOfCustomConversionEventMetrics)?, nillable: true, emit_null: false)]
    property custom_conversion_event_metrics : Array(AdsAnalyticsCreateAsyncRequestAllOfCustomConversionEventMetrics)?
    ...
    @[JSON::Field(key: "reporting_timezone", type: ReportingTimeZone?, nillable: true, emit_null: false)]
    ...
    class EnumAttributeValidatorForPrimary_sort < EnumAttributeValidator
      @attribute : String
      @allowable_values : Array(Int32 | Int64 | Float32 | Float64 | String)

      def initialize
        @attribute = "primary_sort"
        @allowable_values = ["BY_ID", "BY_DATE"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@end_date : String, @granularity : Granularity, @start_date : String, @columns : Array(ReportingColumnAsync), @level : MetricsReportingLevel, @attribution_types : Array(ConversionReportAttributionType)? = nil, @click_window_days : ConversionAttributionWindowDays? = nil, @conversion_report_time : ConversionReportTimeType? = nil, @engagement_window_days : ConversionAttributionWindowDays? = nil, @view_window_days : ConversionAttributionWindowDays? = nil, @campaign_ids : Array(String)? = nil, @campaign_statuses : Array(CampaignSummaryStatus)? = nil, @campaign_objective_types : Array(ObjectiveType)? = nil, @campaign_brand_label : String? = nil, @ad_group_ids : Array(String)? = nil, @ad_group_statuses : Array(AdGroupSummaryStatus)? = nil, @ad_ids : Array(String)? = nil, @ad_statuses : Array(PinPromotionSummaryStatus)? = nil, @product_group_ids : Array(String)? = nil, @product_group_statuses : Array(ProductGroupSummaryStatus)? = nil, @product_item_ids : Array(String)? = nil, @targeting_types : Array(String)? = nil, @metrics_filters : Array(AdsAnalyticsMetricsFilter)? = nil, @combine_targeting_types : Bool? = nil, @custom_conversion_event_metrics : Array(AdsAnalyticsCreateAsyncRequestAllOfCustomConversionEventMetrics)? = nil, @end_hour : Int32? = nil, @primary_sort : String? = nil, @report_format : DataOutputFormat? = nil, @reporting_timezone : ReportingTimeZone? = nil, @start_hour : Int32? = nil)
    end
    ...
    def list_invalid_properties
      ...
      if !@campaign_statuses.nil? && @campaign_statuses.try &.size.try &.> 6
        invalid_properties.push("invalid value for \"campaign_statuses\", number of items must be less than or equal to 6."
      end

      if !@campaign_statuses.nil? && @campaign_statuses.try &.size.try &.< 1
    ...
    def valid?
      ...
      return false if !@campaign_statuses.nil? && @campaign_statuses.try &.size.try &.> 6
      return false if !@campaign_statuses.nil? && @campaign_statuses.try &.size.try &.< 1
      ...
      return false if !@ad_group_statuses.nil? && @ad_group_statuses.try &.size.try &.> 6
      return false if !@ad_group_statuses.nil? && @ad_group_statuses.try &.size.try &.< 1
      return false if !@ad_ids.nil? && @ad_ids.try &.size.try &.> 500
      return false if !@ad_ids.nil? && @ad_ids.try &.size.try &.< 1
      return false if !@ad_statuses.nil? && @ad_statuses.try &.size.try &.> 6
      return false if !@ad_statuses.nil? && @ad_statuses.try &.size.try &.< 1
      return false if !@product_group_ids.nil? && @product_group_ids.try &.size.try &.> 500
      return false if !@product_group_ids.nil? && @product_group_ids.try &.size.try &.< 1
      return false if !@product_group_statuses.nil? && @product_group_statuses.try &.size.try &.> 6
      return false if !@product_group_statuses.nil? && @product_group_statuses.try &.size.try &.< 1
      return false if !@product_item_ids.nil? && @product_item_ids.try &.size.try &.> 500
      return false if !@product_item_ids.nil? && @product_item_ids.try &.size.try &.< 1
      return false if !@targeting_types.nil? && @targeting_types.try &.size.try &.> 5
      return false if !@targeting_types.nil? && @targeting_types.try &.size.try &.< 1
      return false if !@metrics_filters.nil? && @metrics_filters.try &.size.try &.< 1
      return false if !@end_hour.nil? && @end_hour.try &.> 23
      return false if !@end_hour.nil? && @end_hour.try &.< 0
      primary_sort_validator = EnumAttributeValidatorForPrimary_sort.new
      return false unless primary_sort_validator.valid?(@primary_sort)
      return false if !@start_hour.nil? && @start_hour.try &.> 23
      return false if !@start_hour.nil? && @start_hour.try &.< 0
      true
    end
    ...
    def primary_sort=(primary_sort)
      validator = EnumAttributeValidatorForPrimary_sort.new
    ...
    def ==(other)
      ...
      self.class == other.class &&
          attribution_types == other.attribution_types &&
          click_window_days == other.click_window_days &&
          conversion_report_time == other.conversion_report_time &&
          end_date == other.end_date &&
          engagement_window_days == other.engagement_window_days &&
          granularity == other.granularity &&
          start_date == other.start_date &&
          view_window_days == other.view_window_days &&
          campaign_ids == other.campaign_ids &&
          campaign_statuses == other.campaign_statuses &&
          campaign_objective_types == other.campaign_objective_types &&
          campaign_brand_label == other.campaign_brand_label &&
          ad_group_ids == other.ad_group_ids &&
          ad_group_statuses == other.ad_group_statuses &&
          ad_ids == other.ad_ids &&
          ad_statuses == other.ad_statuses &&
          product_group_ids == other.product_group_ids &&
          product_group_statuses == other.product_group_statuses &&
          product_item_ids == other.product_item_ids &&
          targeting_types == other.targeting_types &&
          metrics_filters == other.metrics_filters &&
          columns == other.columns &&
          combine_targeting_types == other.combine_targeting_types &&
          custom_conversion_event_metrics == other.custom_conversion_event_metrics &&
          end_hour == other.end_hour &&
          level == other.level &&
          primary_sort == other.primary_sort &&
          report_format == other.report_format &&
          reporting_timezone == other.reporting_timezone &&
    ...
    def to_h
      ...
      hash["attribution_types"] = _to_h(attribution_types)
      ...
      hash["engagement_window_days"] = _to_h(engagement_window_days)
      ...
      hash["campaign_statuses"] = _to_h(campaign_statuses)
      hash["campaign_objective_types"] = _to_h(campaign_objective_types)
      hash["campaign_brand_label"] = _to_h(campaign_brand_label)
      hash["ad_group_ids"] = _to_h(ad_group_ids)
      hash["ad_group_statuses"] = _to_h(ad_group_statuses)
      hash["ad_ids"] = _to_h(ad_ids)
      hash["ad_statuses"] = _to_h(ad_statuses)
      hash["product_group_ids"] = _to_h(product_group_ids)
      hash["product_group_statuses"] = _to_h(product_group_statuses)
      hash["product_item_ids"] = _to_h(product_item_ids)
      hash["targeting_types"] = _to_h(targeting_types)
      hash["metrics_filters"] = _to_h(metrics_filters)
      hash["columns"] = _to_h(columns)
      hash["combine_targeting_types"] = _to_h(combine_targeting_types)
      hash["custom_conversion_event_metrics"] = _to_h(custom_conversion_event_metrics)
      hash["end_hour"] = _to_h(end_hour)
      hash["level"] = _to_h(level)
      hash["primary_sort"] = _to_h(primary_sort)
      hash["report_format"] = _to_h(report_format)
      hash["reporting_timezone"] = _to_h(reporting_timezone)
      hash["start_hour"] = _to_h(start_hour)
      hash.to_h
    end
