...
module OpenAPIClient
  class AdsAnalyticsCreateAsyncRequest
    ...
    def initialize(@start_date : String, @end_date : String, @granularity : Granularity, @columns : Array(ReportingColumnAsync), @level : MetricsReportingLevel, @click_window_days : ConversionAttributionWindowDays? = nil, @engagement_window_days : ConversionAttributionWindowDays? = nil, @view_window_days : ConversionAttributionWindowDays? = nil, @conversion_report_time : ConversionReportTimeType? = nil, @attribution_types : Array(ConversionReportAttributionType)? = nil, @campaign_ids : Array(String)? = nil, @campaign_statuses : Array(CampaignSummaryStatus)? = nil, @campaign_objective_types : Array(ObjectiveType)? = nil, @ad_group_ids : Array(String)? = nil, @ad_group_statuses : Array(AdGroupSummaryStatus)? = nil, @ad_ids : Array(String)? = nil, @ad_statuses : Array(PinPromotionSummaryStatus)? = nil, @product_group_ids : Array(String)? = nil, @product_group_statuses : Array(ProductGroupSummaryStatus)? = nil, @product_item_ids : Array(String)? = nil, @targeting_types : Array(AdsAnalyticsTargetingType)? = nil, @metrics_filters : Array(AdsAnalyticsMetricsFilter)? = nil, @report_format : DataOutputFormat? = nil, @primary_sort : String? = nil, @start_hour : Int32? = nil, @end_hour : Int32? = nil)
    end
