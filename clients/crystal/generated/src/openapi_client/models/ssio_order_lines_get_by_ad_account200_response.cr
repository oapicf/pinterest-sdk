...
module OpenAPIClient
  class SsioOrderLinesGetByAdAccount200Response
    ...
    @[JSON::Field(key: "items", type: Array(SSIOOrderLine), nillable: false, emit_null: false)]
    property items : Array(SSIOOrderLine)
    ...
    def initialize(@items : Array(SSIOOrderLine), @bookmark : String? = nil)
    end
