...
module OpenAPIClient
  ...
  class ConversionEventsUserData
    ...
    def initialize(@em : Array(String), @hashed_maids : Array(String), @client_ip_address : String, @client_user_agent : String, @ph : Array(String)?, @ge : Array(String)?, @db : Array(String)?, @ln : Array(String)?, @fn : Array(String)?, @ct : Array(String)?, @st : Array(String)?, @zp : Array(String)?, @country : Array(String)?, @external_id : Array(String)?, @click_id : String?, @partner_id : String?)
    end
