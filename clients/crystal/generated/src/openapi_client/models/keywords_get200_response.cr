...
module OpenAPIClient
  class KeywordsGet200Response
    ...
    # Required properties
    @[JSON::Field(key: "items", type: Array(Keyword), nillable: false, emit_null: false)]
    property items : Array(Keyword)
    ...
    def initialize(@items : Array(Keyword), @bookmark : String? = nil)
    end
