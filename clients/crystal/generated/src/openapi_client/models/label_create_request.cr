...
module OpenAPIClient
  class LabelCreateRequest
    ...
    @[JSON::Field(key: "labels", type: Array(LabelCreateRequestLabelsInner), nillable: false, emit_null: false)]
    property labels : Array(LabelCreateRequestLabelsInner)

    # Unique identifier of the asset you are labelling. Currently, you can only label campaigns.
    @[JSON::Field(key: "parent_id", type: String, nillable: false, emit_null: false)]
    property parent_id : String

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@labels : Array(LabelCreateRequestLabelsInner), @parent_id : String)
    end
    ...
    def valid?
      return false if @parent_id.try &.!~ /^[C]?\d+$/
      true
    end
