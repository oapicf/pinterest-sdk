...
module OpenAPIClient
  class CatalogsList200Response
    ...
    # Required properties
    @[JSON::Field(key: "items", type: Array(Catalog), nillable: false, emit_null: false)]
    property items : Array(Catalog)
    ...
    def initialize(@items : Array(Catalog), @bookmark : String? = nil)
    end
