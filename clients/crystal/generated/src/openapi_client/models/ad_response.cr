...
module OpenAPIClient
  class AdResponse
    ...
    class EnumAttributeValidatorForReview_status < EnumAttributeValidator
      @attribute : String
      @allowable_values : Array(Int32 | Int64 | Float32 | Float64 | String)

      def initialize
        @attribute = "review_status"
        @allowable_values = ["OTHER", "PENDING", "REJECTED", "APPROVED"].map { |value| to(String, value)}
      end
    end
    ...
    def list_invalid_properties
      ...
      pattern = /^\d+$/
      if !@pin_id.nil? && @pin_id.try &.!~ pattern
      ...
      review_status_validator = EnumAttributeValidatorForReview_status.new
      if !review_status_validator.valid?(@review_status)
        message = review_status_validator.message
    ...
    def valid?
      ...
      return false if !@pin_id.nil? && @pin_id.try &.!~ /^\d+$/
    ...
    def review_status=(review_status)
      validator = EnumAttributeValidatorForReview_status.new
    ...
    def ==(other)
      ...
      self.class == other.class &&
          ...
          collection_items_destination_url_template == other.collection_items_destination_url_template &&
          created_time == other.created_time &&
          id == other.id &&
          rejected_reasons == other.rejected_reasons &&
          rejection_labels == other.rejection_labels &&
    ...
    def to_h
      ...
      hash["collection_items_destination_url_template"] = _to_h(collection_items_destination_url_template)
      hash["created_time"] = _to_h(created_time)
      hash["id"] = _to_h(id)
      hash["rejected_reasons"] = _to_h(rejected_reasons)
      hash["rejection_labels"] = _to_h(rejection_labels)
      hash["review_status"] = _to_h(review_status)
