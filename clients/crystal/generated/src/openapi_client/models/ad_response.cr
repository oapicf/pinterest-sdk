  ...
  class AdResponse
    ...
    class EnumAttributeValidatorForCustomizable_cta_type < EnumAttributeValidator
      ...
      def initialize
        ...
        @allowable_values = ["GET_OFFER", "LEARN_MORE", "ORDER_NOW", "SHOP_NOW", "SIGN_UP", "SUBSCRIBE", "BUY_NOW", "CONTACT_US", "GET_QUOTE", "VISIT_SITE", "APPLY_NOW", "BOOK_NOW", "REQUEST_DEMO", "REGISTER_NOW", "FIND_A_DEALER", "ADD_TO_CART", "WATCH_NOW", "READ_MORE"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@ad_group_id : String? = nil, @android_deep_link : String? = nil, @carousel_android_deep_links : Array(String)? = nil, @carousel_destination_urls : Array(String)? = nil, @carousel_ios_deep_links : Array(String)? = nil, @click_tracking_url : String? = nil, @creative_type : CreativeType? = nil, @destination_url : String? = nil, @ios_deep_link : String? = nil, @is_pin_deleted : Bool? = nil, @is_removable : Bool? = nil, @name : String? = nil, @status : EntityStatus? = nil, @tracking_urls : TrackingUrls? = nil, @view_tracking_url : String? = nil, @lead_form_id : String? = nil, @grid_click_type : GridClickType? = nil, @customizable_cta_type : String? = nil, @quiz_pin_data : QuizPinData? = nil, @pin_id : String? = nil, @ad_account_id : String? = nil, @campaign_id : String? = nil, @collection_items_destination_url_template : String? = nil, @created_time : Int32? = nil, @id : String? = nil, @rejected_reasons : Array(String)? = nil, @rejection_labels : Array(String)? = nil, @review_status : String? = nil, @_type : String? = nil, @updated_time : Int32? = nil, @summary_status : PinPromotionSummaryStatus? = nil)
    end
