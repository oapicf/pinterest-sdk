...
module OpenAPIClient
  ...
  class OrderLines
    ...
    def initialize(@id : String? = nil, @_type : String? = nil, @ad_account_id : String? = nil, @purchase_order_id : String? = nil, @start_time : Float64? = nil, @end_time : Float64? = nil, @budget : Float64? = nil, @paid_budget : Float64? = nil, @status : OrderLineStatus? = nil, @name : String? = nil, @paid_type : OrderLinePaidType? = nil)
    end
