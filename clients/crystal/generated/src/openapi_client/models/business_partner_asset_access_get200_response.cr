...
module OpenAPIClient
  class BusinessPartnerAssetAccessGet200Response
    ...
    @[JSON::Field(key: "items", type: Array(GetPartnerAssetsResponse), nillable: false, emit_null: false)]
    property items : Array(GetPartnerAssetsResponse)
    ...
    def initialize(@items : Array(GetPartnerAssetsResponse), @bookmark : String? = nil)
    end
