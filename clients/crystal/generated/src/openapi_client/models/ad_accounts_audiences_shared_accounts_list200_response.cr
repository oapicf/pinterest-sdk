...
module OpenAPIClient
  class AdAccountsAudiencesSharedAccountsList200Response
    ...
    # Required properties
    @[JSON::Field(key: "items", type: Array(SharedAudienceAccount), nillable: false, emit_null: false)]
    property items : Array(SharedAudienceAccount)
    ...
    def initialize(@items : Array(SharedAudienceAccount), @bookmark : String? = nil)
    end
