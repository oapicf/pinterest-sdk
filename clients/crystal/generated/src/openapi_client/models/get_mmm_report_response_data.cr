...
module OpenAPIClient
  class GetMMMReportResponseData
    ...
    # Optional properties
    @[JSON::Field(key: "report_status", type: String?, nillable: true, emit_null: false)]
    property report_status : String?

    @[JSON::Field(key: "size", type: Float64?, nillable: true, emit_null: false)]
    ...
    class EnumAttributeValidatorForReport_status < EnumAttributeValidator
      @attribute : String
      @allowable_values : Array(Int32 | Int64 | Float32 | Float64 | String)

      def initialize
        @attribute = "report_status"
        @allowable_values = ["DOES_NOT_EXIST", "FINISHED", "IN_PROGRESS", "EXPIRED", "FAILED", "CANCELLED"].map { |value| to(String, value)}
      end
    end
    ...
    def list_invalid_properties
      ...
      report_status_validator = EnumAttributeValidatorForReport_status.new
      if !report_status_validator.valid?(@report_status)
        message = report_status_validator.message
    ...
    def report_status=(report_status)
      validator = EnumAttributeValidatorForReport_status.new
