...
module OpenAPIClient
  ...
  class DeleteInvitesResultsResponseArray
    ...
    @[JSON::Field(key: "items", type: Array(DeleteInvitesResultsResponseArrayItemsInner)?, nillable: true, emit_null: false)]
    property items : Array(DeleteInvitesResultsResponseArrayItemsInner)?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@items : Array(DeleteInvitesResultsResponseArrayItemsInner)? = nil)
    end
