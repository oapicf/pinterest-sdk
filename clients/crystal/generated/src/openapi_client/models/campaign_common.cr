...
module OpenAPIClient
  ...
  class CampaignCommon
    ...
    def initialize(@ad_account_id : String?, @name : String?, @status : EntityStatus?, @lifetime_spend_cap : Int32?, @daily_spend_cap : Int32?, @order_line_id : String?, @tracking_urls : AdCommonTrackingUrls?, @start_time : Int32?, @end_time : Int32?, @summary_status : CampaignSummaryStatus?)
    end
    ...
    def hash
      [ad_account_id, name, status, lifetime_spend_cap, daily_spend_cap, order_line_id, tracking_urls, start_time, end_time, summary_status].hash
    end
