...
module OpenAPIClient
  ...
  class CampaignCommon
    ...
    def initialize(@ad_account_id : String? = nil, @name : String? = nil, @status : EntityStatus? = nil, @lifetime_spend_cap : Int32? = nil, @daily_spend_cap : Int32? = nil, @order_line_id : String? = nil, @tracking_urls : TrackingUrls? = nil, @start_time : Int32? = nil, @end_time : Int32? = nil, @is_flexible_daily_budgets : Bool? = nil)
    end
    ...
    def hash
      [ad_account_id, name, status, lifetime_spend_cap, daily_spend_cap, order_line_id, tracking_urls, start_time, end_time, is_flexible_daily_budgets].hash
    end
