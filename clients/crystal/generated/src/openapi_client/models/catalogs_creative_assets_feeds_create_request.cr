...
module OpenAPIClient
  ...
  class CatalogsCreativeAssetsFeedsCreateRequest
    ...
    @[JSON::Field(key: "status", type: CatalogsStatus?, default: "ACTIVE", nillable: true, emit_null: false)]
    ...
    def initialize(@catalog_type : CatalogsType, @default_country : Country, @default_locale : CatalogsFeedsCreateRequestDefaultLocale, @format : CatalogsFormat, @location : String, @name : String, @catalog_id : String? = nil, @credentials : CatalogsFeedCredentials? = nil, @default_currency : NullableCurrency? = nil, @preferred_processing_schedule : CatalogsFeedProcessingSchedule? = nil, @status : CatalogsStatus? = nil)
    end
    ...
    def valid?
      ...
      return false if @location.try &.!~ /^(http|https|ftp|sftp):\/\//
      true
    end
    ...
    def hash
      [catalog_id, catalog_type, credentials, default_country, default_currency, default_locale, format, location, name, preferred_processing_schedule, status].hash
    end
