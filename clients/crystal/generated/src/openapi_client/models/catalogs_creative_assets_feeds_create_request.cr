...
module OpenAPIClient
  ...
  class CatalogsCreativeAssetsFeedsCreateRequest
    ...
    def initialize(@name : String, @format : CatalogsFormat, @default_locale : CatalogsFeedsCreateRequestDefaultLocale, @default_country : Country, @location : String, @catalog_type : CatalogsType, @default_currency : NullableCurrency? = nil, @credentials : CatalogsFeedCredentials? = nil, @preferred_processing_schedule : CatalogsFeedProcessingSchedule? = nil, @catalog_id : String? = nil, @status : CatalogsStatus? = nil)
    end
    ...
    def hash
      [default_currency, name, format, default_locale, default_country, credentials, location, preferred_processing_schedule, catalog_type, catalog_id, status].hash
    end
