...
module OpenAPIClient
  ...
  class CatalogsCreativeAssetsFeedsCreateRequest
    ...
    def initialize(@name : String, @format : CatalogsFormat, @default_locale : CatalogsFeedsCreateRequestDefaultLocale, @default_country : Country, @location : String, @catalog_type : CatalogsType, @default_currency : NullableCurrency?, @credentials : CatalogsFeedCredentials?, @preferred_processing_schedule : CatalogsFeedProcessingSchedule?, @catalog_id : String?, @status : CatalogsStatus?)
    end
