...
module OpenAPIClient
  class DeliveryMetricsResponseItemsInner
    ...
    @[JSON::Field(key: "display_name", type: String?, nillable: true, emit_null: false)]
    ...
    class EnumAttributeValidatorForCategory < EnumAttributeValidator
      @attribute : String
      @allowable_values : Array(Int32 | Int64 | Float32 | Float64 | String)

      def initialize
        @attribute = "category"
        @allowable_values = ["ADS", "ORGANIC"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@name : String? = nil, @category : String? = nil, @definition : String? = nil, @display_name : String? = nil)
    end
    ...
    def list_invalid_properties
      ...
      category_validator = EnumAttributeValidatorForCategory.new
      if !category_validator.valid?(@category)
        message = category_validator.message
    ...
    def category=(category)
      validator = EnumAttributeValidatorForCategory.new
    ...
    def hash
      [name, category, definition, display_name].hash
    end
    ...
    def to_h
      ...
      hash["display_name"] = _to_h(display_name)
      hash.to_h
    end
