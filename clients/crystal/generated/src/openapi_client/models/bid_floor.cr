...
module OpenAPIClient
  class BidFloor
    ...
    @[JSON::Field(key: "bid_floors", type: Array(Int32)?, nillable: true, emit_null: false)]
    property bid_floors : Array(Int32)?

    # Always the string 'bidfloor'
    @[JSON::Field(key: "type", type: String?, default: "bidfloor", nillable: true, emit_null: false)]
    property _type : String?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@bid_floors : Array(Int32)? = nil, @_type : String? = nil)
    end
    ...
    def to_h
      ...
      hash["bid_floors"] = _to_h(bid_floors)
