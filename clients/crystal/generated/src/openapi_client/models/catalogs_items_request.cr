...
module OpenAPIClient
  ...
  class CatalogsItemsRequest
    ...
    @[JSON::Field(key: "filters", type: CatalogsItemsPostFilters, nillable: false, emit_null: false)]
    property filters : CatalogsItemsPostFilters
    ...
    def initialize(@country : Country, @language : String, @filters : CatalogsItemsPostFilters)
    end
