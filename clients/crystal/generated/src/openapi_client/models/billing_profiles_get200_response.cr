...
module OpenAPIClient
  class BillingProfilesGet200Response
    ...
    # Required properties
    @[JSON::Field(key: "items", type: Array(BillingProfilesResponse), nillable: false, emit_null: false)]
    property items : Array(BillingProfilesResponse)
    ...
    def initialize(@items : Array(BillingProfilesResponse), @bookmark : String? = nil)
    end
