...
module OpenAPIClient
  class BrandAccountsCreate200Response
    ...
    @[JSON::Field(key: "brand_account_id", type: String?, nillable: true, emit_null: false)]
    property brand_account_id : String?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@brand_account_id : String? = nil)
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
          brand_account_id == other.brand_account_id
    end
    ...
    def to_h
      ...
      hash["brand_account_id"] = _to_h(brand_account_id)
      hash.to_h
    end
