...
module OpenAPIClient
  class TrendingKeywordsResponse
    ...
    @[JSON::Field(key: "trends", type: Array(TrendingKeywordsResponseTrendsInner)?, nillable: true, emit_null: false)]
    property trends : Array(TrendingKeywordsResponseTrendsInner)?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@trends : Array(TrendingKeywordsResponseTrendsInner)? = nil)
    end
