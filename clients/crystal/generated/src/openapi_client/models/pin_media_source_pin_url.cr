...
module OpenAPIClient
  ...
  class PinMediaSourcePinURL
    ...
    @[JSON::Field(key: "is_affiliate_link", type: Bool?, default: false, nillable: true, emit_null: false)]
    property is_affiliate_link : Bool?
    ...
    class EnumAttributeValidatorForSource_type < EnumAttributeValidator
      ...
      def initialize
        ...
        @allowable_values = ["pin_url"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@source_type : String, @is_affiliate_link : Bool? = nil)
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
          is_affiliate_link == other.is_affiliate_link &&
    ...
    def to_h
      ...
      hash["is_affiliate_link"] = _to_h(is_affiliate_link)
