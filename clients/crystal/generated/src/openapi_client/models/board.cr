...
module OpenAPIClient
  ...
  class Board
    ...
    class EnumAttributeValidatorForPrivacy < EnumAttributeValidator
      @attribute : String
      @allowable_values : Array(Int32 | Int64 | Float32 | Float64 | String)

      def initialize
        @attribute = "privacy"
        @allowable_values = ["PUBLIC", "PROTECTED", "SECRET"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@name : String, @id : String? = nil, @created_at : Time? = nil, @board_pins_modified_at : Time? = nil, @description : String? = nil, @collaborator_count : Int32? = nil, @pin_count : Int32? = nil, @follower_count : Int32? = nil, @media : BoardMedia? = nil, @owner : BoardOwner? = nil, @privacy : String? = nil)
    end
    ...
    def list_invalid_properties
      ...
      privacy_validator = EnumAttributeValidatorForPrivacy.new
      if !privacy_validator.valid?(@privacy)
        message = privacy_validator.message
    ...
    def privacy=(privacy)
      validator = EnumAttributeValidatorForPrivacy.new
