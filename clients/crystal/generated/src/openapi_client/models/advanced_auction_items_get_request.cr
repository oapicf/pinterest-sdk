...
module OpenAPIClient
  ...
  class AdvancedAuctionItemsGetRequest
    ...
    @[JSON::Field(key: "items", type: Array(AdvancedAuctionItemsGetRecord), nillable: false, emit_null: false)]
    property items : Array(AdvancedAuctionItemsGetRecord)

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@catalog_id : String, @items : Array(AdvancedAuctionItemsGetRecord))
    end
