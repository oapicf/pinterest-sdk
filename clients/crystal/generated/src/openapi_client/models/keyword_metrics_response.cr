...
module OpenAPIClient
  class KeywordMetricsResponse
    ...
    @[JSON::Field(key: "metrics", type: KeywordMetrics?, nillable: true, emit_null: false)]
    property metrics : KeywordMetrics?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@keyword : String? = nil, @metrics : KeywordMetrics? = nil)
    end
