...
module OpenAPIClient
  class AdGroupAudienceSizingResponse
    ...
    @[JSON::Field(key: "audience_size_lower_bound", type: Float64?, nillable: true, emit_null: false)]
    ...
    @[JSON::Field(key: "audience_size_upper_bound", type: Float64?, nillable: true, emit_null: false)]
    ...
    def ==(other)
      ...
      self.class == other.class &&
          audience_size_lower_bound == other.audience_size_lower_bound &&
          audience_size_upper_bound == other.audience_size_upper_bound
    end
    ...
    def to_h
      ...
      hash["audience_size_lower_bound"] = _to_h(audience_size_lower_bound)
      hash["audience_size_upper_bound"] = _to_h(audience_size_upper_bound)
      hash.to_h
    end
