...
module OpenAPIClient
  class RespondToInvitesResponseArray
    ...
    @[JSON::Field(key: "items", type: Array(RespondToInvitesResponseArrayItemsInner)?, nillable: true, emit_null: false)]
    property items : Array(RespondToInvitesResponseArrayItemsInner)?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@items : Array(RespondToInvitesResponseArrayItemsInner)? = nil)
    end
