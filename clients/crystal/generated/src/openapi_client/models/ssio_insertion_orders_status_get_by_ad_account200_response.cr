...
module OpenAPIClient
  class SsioInsertionOrdersStatusGetByAdAccount200Response
    ...
    @[JSON::Field(key: "items", type: Array(SSIOInsertionOrderStatus), nillable: false, emit_null: false)]
    property items : Array(SSIOInsertionOrderStatus)
    ...
    def initialize(@items : Array(SSIOInsertionOrderStatus), @bookmark : String? = nil)
    end
