...
module OpenAPIClient
  class AudienceCreateRequest
    ...
    @[JSON::Field(key: "audience_type", type: AudienceCreateRequest1AudienceType, nillable: false, emit_null: false)]
    property audience_type : AudienceCreateRequest1AudienceType
    ...
    def initialize(@name : String, @rule : AudienceRule, @audience_type : AudienceCreateRequest1AudienceType, @ad_account_id : String?, @description : String?)
    end
