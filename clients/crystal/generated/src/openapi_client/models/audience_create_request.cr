...
module OpenAPIClient
  class AudienceCreateRequest
    ...
    @[JSON::Field(key: "audience_type", type: AudienceType, nillable: false, emit_null: false)]
    ...
    def initialize(@name : String, @rule : AudienceRule, @audience_type : AudienceType, @ad_account_id : String? = nil, @description : String? = nil)
    end
    ...
    def hash
      [ad_account_id, name, rule, description, audience_type].hash
    end
