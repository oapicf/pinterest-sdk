...
module OpenAPIClient
  class Audience
    ...
    def initialize(@ad_account_id : String?, @id : String?, @name : String?, @audience_type : String?, @description : String?, @rule : AudienceRule?, @size : Int32?, @status : String?, @_type : String?, @created_timestamp : Int32?, @updated_timestamp : Int32?)
    end
