...
module OpenAPIClient
  class Audience
    ...
    def initialize(@ad_account_id : String? = nil, @id : String? = nil, @name : String? = nil, @audience_type : String? = nil, @description : String? = nil, @rule : AudienceRule? = nil, @size : Int32? = nil, @status : String? = nil, @_type : String? = nil, @created_timestamp : Int32? = nil, @updated_timestamp : Int32? = nil)
    end
    ...
    def hash
      [ad_account_id, id, name, audience_type, description, rule, size, status, _type, created_timestamp, updated_timestamp].hash
    end
