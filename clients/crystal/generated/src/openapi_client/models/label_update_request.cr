...
module OpenAPIClient
  class LabelUpdateRequest
    ...
    @[JSON::Field(key: "labels", type: Array(LabelUpdateRequestLabelsInner), nillable: false, emit_null: false)]
    property labels : Array(LabelUpdateRequestLabelsInner)

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@labels : Array(LabelUpdateRequestLabelsInner))
    end
