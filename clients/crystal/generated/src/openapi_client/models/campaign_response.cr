...
module OpenAPIClient
  class CampaignResponse
    ...
    def initialize(@id : String? = nil, @ad_account_id : String? = nil, @name : String? = nil, @status : EntityStatus? = nil, @lifetime_spend_cap : Int32? = nil, @daily_spend_cap : Int32? = nil, @order_line_id : String? = nil, @tracking_urls : TrackingUrls? = nil, @start_time : Int32? = nil, @end_time : Int32? = nil, @is_flexible_daily_budgets : Bool? = nil, @objective_type : ObjectiveType? = nil, @created_time : Int32? = nil, @updated_time : Int32? = nil, @_type : String? = nil, @is_campaign_budget_optimization : Bool? = nil, @summary_status : CampaignSummaryStatus? = nil)
    end
