...
module OpenAPIClient
  class CampaignResponse
    ...
    def initialize(@id : String?, @ad_account_id : String?, @name : String?, @status : EntityStatus?, @lifetime_spend_cap : Int32?, @daily_spend_cap : Int32?, @order_line_id : String?, @tracking_urls : AdCommonTrackingUrls?, @start_time : Int32?, @end_time : Int32?, @summary_status : CampaignSummaryStatus?, @objective_type : ObjectiveType?, @created_time : Int32?, @updated_time : Int32?, @_type : String?, @is_flexible_daily_budgets : Bool?, @is_campaign_budget_optimization : Bool?)
    end
    ...
    def hash
      [id, ad_account_id, name, status, lifetime_spend_cap, daily_spend_cap, order_line_id, tracking_urls, start_time, end_time, summary_status, objective_type, created_time, updated_time, _type, is_flexible_daily_budgets, is_campaign_budget_optimization].hash
    end
