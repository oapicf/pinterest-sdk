...
module OpenAPIClient
  class ProductGroupPromotion
    ...
    def initialize(@id : String? = nil, @ad_group_id : String? = nil, @bid_in_micro_currency : Int32? = nil, @included : Bool? = nil, @definition : String? = nil, @relative_definition : String? = nil, @parent_id : String? = nil, @slideshow_collections_title : String? = nil, @slideshow_collections_description : String? = nil, @is_mdl : Bool? = nil, @status : EntityStatus? = nil, @tracking_url : String? = nil, @catalog_product_group_id : String? = nil, @catalog_product_group_name : String? = nil, @collections_hero_pin_id : String? = nil, @collections_hero_destination_url : String? = nil, @grid_click_type : GridClickType? = nil)
    end
