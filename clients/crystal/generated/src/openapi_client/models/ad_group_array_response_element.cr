...
module OpenAPIClient
  class AdGroupArrayResponseElement
    ...
    # Optional properties
    @[JSON::Field(key: "data", type: AdGroupResponse?, nillable: true, emit_null: false)]
    property data : AdGroupResponse?
    ...
    def initialize(@data : AdGroupResponse? = nil, @exceptions : Array(Exception)? = nil)
    end
