...
module OpenAPIClient
  class OauthAccessTokenRequestCode
    ...
    @[JSON::Field(key: "redirect_uri", type: String, nillable: false, emit_null: false)]
    ...
    def initialize(@code : String, @redirect_uri : String, @grant_type : String)
    end
    ...
    def hash
      [code, redirect_uri, grant_type].hash
    end
    ...
    def to_h
      ...
      hash["redirect_uri"] = _to_h(redirect_uri)
