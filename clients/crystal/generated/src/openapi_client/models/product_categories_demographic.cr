...
module OpenAPIClient
  ...
  class ProductCategoriesDemographic
    ...
    @[JSON::Field(key: "age", type: Hash(String, Float64), nillable: false, emit_null: false)]
    property age : Hash(String, Float64)

    @[JSON::Field(key: "gender", type: GenderDemographics, nillable: false, emit_null: false)]
