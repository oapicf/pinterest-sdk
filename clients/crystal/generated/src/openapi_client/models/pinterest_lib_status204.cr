...
module OpenAPIClient
  ...
  class PinterestLibStatus204
    ...
    # Required properties
    @[JSON::Field(key: "statusCode", type: Float64, nillable: false, emit_null: false)]
    ...
    class EnumAttributeValidatorForStatus_code < EnumAttributeValidator
      @attribute : String
      @allowable_values : Array(Int32 | Int64 | Float32 | Float64 | String)

      def initialize
        @attribute = "status_code"
        @allowable_values = ["204"].map { |value| to(Float64, value)}
      end
    end
    ...
    def list_invalid_properties
      ...
      status_code_validator = EnumAttributeValidatorForStatus_code.new
      if !status_code_validator.valid?(@status_code)
        message = status_code_validator.message
    ...
    def status_code=(status_code)
      validator = EnumAttributeValidatorForStatus_code.new
    ...
    def to_h
      ...
      hash["statusCode"] = _to_h(status_code)
      hash.to_h
    end
