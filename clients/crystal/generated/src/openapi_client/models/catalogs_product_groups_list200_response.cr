...
module OpenAPIClient
  class CatalogsProductGroupsList200Response
    ...
    # Required properties
    @[JSON::Field(key: "items", type: Array(CatalogsVerticalProductGroup), nillable: false, emit_null: false)]
    property items : Array(CatalogsVerticalProductGroup)
    ...
    def initialize(@items : Array(CatalogsVerticalProductGroup), @bookmark : String? = nil)
    end
