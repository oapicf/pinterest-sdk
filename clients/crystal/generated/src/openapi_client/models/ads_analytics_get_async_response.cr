...
module OpenAPIClient
  class AdsAnalyticsGetAsyncResponse
    ...
    # Optional properties
    @[JSON::Field(key: "report_status", type: BulkReportingJobStatus?, nillable: true, emit_null: false)]
    ...
    def initialize(@report_status : BulkReportingJobStatus? = nil, @url : String? = nil, @size : Float64? = nil)
    end
