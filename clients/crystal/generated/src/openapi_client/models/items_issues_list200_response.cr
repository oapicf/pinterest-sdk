...
module OpenAPIClient
  class ItemsIssuesList200Response
    ...
    # Required properties
    @[JSON::Field(key: "items", type: Array(CatalogsItemValidationIssues), nillable: false, emit_null: false)]
    property items : Array(CatalogsItemValidationIssues)
    ...
    def initialize(@items : Array(CatalogsItemValidationIssues), @bookmark : String? = nil)
    end
