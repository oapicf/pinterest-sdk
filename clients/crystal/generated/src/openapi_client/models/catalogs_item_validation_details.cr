...
module OpenAPIClient
  class CatalogsItemValidationDetails
    ...
    # Required properties
    @[JSON::Field(key: "attribute_name", type: NullableCatalogsItemFieldType, nillable: false, emit_null: false)]
    property attribute_name : NullableCatalogsItemFieldType

    # Provided value that caused the validation issue.
    @[JSON::Field(key: "provided_value", type: String, nillable: false, emit_null: false)]
    property provided_value : String
    ...
    def initialize(@attribute_name : NullableCatalogsItemFieldType, @provided_value : String)
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
          ...
          provided_value == other.provided_value
    end
    ...
    def to_h
      ...
      hash["attribute_name"] = _to_h(attribute_name)
      hash["provided_value"] = _to_h(provided_value)
      hash.to_h
    end
