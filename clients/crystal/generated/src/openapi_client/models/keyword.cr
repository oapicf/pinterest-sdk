...
module OpenAPIClient
  class Keyword
    ...
    # Required properties
    @[JSON::Field(key: "match_type", type: MatchTypeResponse, nillable: false, emit_null: false)]
    property match_type : MatchTypeResponse
    ...
    @[JSON::Field(key: "bid", type: Int32?, nillable: true, emit_null: false)]
    property bid : Int32?
    ...
    def initialize(@match_type : MatchTypeResponse, @value : String, @bid : Int32? = nil, @archived : Bool? = nil, @id : String? = nil, @parent_id : String? = nil, @parent_type : String? = nil, @_type : String? = nil)
    end
    ...
    def hash
      [bid, match_type, value, archived, id, parent_id, parent_type, _type].hash
    end
    ...
    def to_h
      ...
      hash["bid"] = _to_h(bid)
      hash["match_type"] = _to_h(match_type)
      hash["value"] = _to_h(value)
      hash["archived"] = _to_h(archived)
      hash["id"] = _to_h(id)
