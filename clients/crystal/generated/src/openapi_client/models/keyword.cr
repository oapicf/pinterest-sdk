...
module OpenAPIClient
  class Keyword
    ...
    def initialize(@match_type : MatchTypeResponse, @value : String, @archived : Bool?, @id : String?, @parent_id : String?, @parent_type : String?, @_type : String?, @bid : Int32?)
    end
    ...
    def hash
      [archived, id, parent_id, parent_type, _type, bid, match_type, value].hash
    end
