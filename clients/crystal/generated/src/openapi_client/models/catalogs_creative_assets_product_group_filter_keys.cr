...
module OpenAPIClient
  class CatalogsCreativeAssetsProductGroupFilterKeys
    ...
    def initialize(@creative_assets_id : CatalogsProductGroupMultipleStringCriteria, @custom_label_0 : CatalogsProductGroupMultipleStringCriteria, @custom_label_1 : CatalogsProductGroupMultipleStringCriteria, @custom_label_2 : CatalogsProductGroupMultipleStringCriteria, @custom_label_3 : CatalogsProductGroupMultipleStringCriteria, @custom_label_4 : CatalogsProductGroupMultipleStringCriteria, @google_product_category_6 : CatalogsProductGroupMultipleStringListCriteria, @google_product_category_5 : CatalogsProductGroupMultipleStringListCriteria, @google_product_category_4 : CatalogsProductGroupMultipleStringListCriteria, @google_product_category_3 : CatalogsProductGroupMultipleStringListCriteria, @google_product_category_2 : CatalogsProductGroupMultipleStringListCriteria, @google_product_category_1 : CatalogsProductGroupMultipleStringListCriteria, @google_product_category_0 : CatalogsProductGroupMultipleStringListCriteria, @media_type : CatalogsProductGroupMultipleMediaTypesCriteria)
    end
    ...
    def hash
      [creative_assets_id, custom_label_0, custom_label_1, custom_label_2, custom_label_3, custom_label_4, google_product_category_6, google_product_category_5, google_product_category_4, google_product_category_3, google_product_category_2, google_product_category_1, google_product_category_0, media_type].hash
    end
