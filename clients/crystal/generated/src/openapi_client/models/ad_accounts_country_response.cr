...
module OpenAPIClient
  class AdAccountsCountryResponse
    ...
    # Optional properties
    @[JSON::Field(key: "items", type: Array(AdAccountsCountryResponseData)?, nillable: true, emit_null: false)]
    property items : Array(AdAccountsCountryResponseData)?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@items : Array(AdAccountsCountryResponseData)? = nil)
    end
