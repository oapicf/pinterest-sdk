...
module OpenAPIClient
  ...
  class PinMediaWithVideos
    ...
    # Optional properties
    @[JSON::Field(key: "items", type: Array(VideoMetadataWithItemType)?, nillable: true, emit_null: false)]
    property items : Array(VideoMetadataWithItemType)?
    ...
    class EnumAttributeValidatorForMedia_type < EnumAttributeValidator
      ...
      def initialize
        ...
        @allowable_values = ["multiple_videos"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@media_type : String, @items : Array(VideoMetadataWithItemType)? = nil)
    end
