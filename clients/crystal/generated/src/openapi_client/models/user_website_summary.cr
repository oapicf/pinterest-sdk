...
module OpenAPIClient
  class UserWebsiteSummary
    ...
    @[JSON::Field(key: "verified_at", type: String?, nillable: true, emit_null: false)]
    property verified_at : String?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@website : String? = nil, @status : String? = nil, @verified_at : String? = nil)
    end
    ...
    def hash
      [website, status, verified_at].hash
    end
    ...
    def to_h
      ...
      hash["verified_at"] = _to_h(verified_at)
      hash.to_h
    end
