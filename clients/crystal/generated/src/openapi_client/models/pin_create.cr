...
module OpenAPIClient
  ...
  class PinCreate
    ...
    def initialize(@id : String? = nil, @created_at : Time? = nil, @link : String? = nil, @title : String? = nil, @description : String? = nil, @dominant_color : String? = nil, @alt_text : String? = nil, @board_id : String? = nil, @board_section_id : String? = nil, @board_owner : BoardOwner? = nil, @media : PinMedia? = nil, @media_source : PinMediaSource? = nil, @parent_pin_id : String? = nil, @note : String? = nil)
    end
    ...
    def hash
      [id, created_at, link, title, description, dominant_color, alt_text, board_id, board_section_id, board_owner, media, media_source, parent_pin_id, note].hash
    end
