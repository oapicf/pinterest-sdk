...
module OpenAPIClient
  ...
  class PinCreate
    ...
    @[JSON::Field(key: "sponsor_id", type: String?, nillable: true, emit_null: false)]
    ...
    def initialize(@alt_text : String? = nil, @board_id : String? = nil, @board_section_id : String? = nil, @description : String? = nil, @dominant_color : String? = nil, @link : String? = nil, @media_source : PinMediaSource? = nil, @parent_pin_id : String? = nil, @sponsor_id : String? = nil, @title : String? = nil)
    end
    ...
    def list_invalid_properties
      ...
      pattern = /^\d+$/
      if !@sponsor_id.nil? && @sponsor_id.try &.!~ pattern
    ...
    def valid?
      ...
      return false if !@sponsor_id.nil? && @sponsor_id.try &.!~ /^\d+$/
    ...
    def sponsor_id=(sponsor_id)
      ...
      if !sponsor_id.nil? && sponsor_id !~ pattern
        raise ArgumentError.new("invalid value for \"sponsor_id\", must conform to the pattern #{pattern}.")
      end
    ...
    def hash
      [alt_text, board_id, board_section_id, description, dominant_color, link, media_source, parent_pin_id, sponsor_id, title].hash
    end
    ...
    def to_h
      ...
      hash["sponsor_id"] = _to_h(sponsor_id)
