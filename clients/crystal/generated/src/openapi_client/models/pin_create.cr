...
module OpenAPIClient
  ...
  class PinCreate
    ...
    def initialize(@id : String?, @created_at : Time?, @link : String?, @title : String?, @description : String?, @dominant_color : String?, @alt_text : String?, @board_id : String?, @board_section_id : String?, @board_owner : BoardOwner?, @media : PinMedia?, @media_source : PinMediaSource?, @parent_pin_id : String?, @note : String?)
    end
