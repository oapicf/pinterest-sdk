...
module OpenAPIClient
  class CreateInvitesResultsResponseArray
    ...
    @[JSON::Field(key: "items", type: Array(CreateInvitesResultsResponseArrayItemsInner)?, nillable: true, emit_null: false)]
    property items : Array(CreateInvitesResultsResponseArrayItemsInner)?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@items : Array(CreateInvitesResultsResponseArrayItemsInner)? = nil)
    end
