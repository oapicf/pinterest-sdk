...
module OpenAPIClient
  class LeadFormArrayResponse
    ...
    # Optional properties
    @[JSON::Field(key: "items", type: Array(LeadFormArrayResponseItemsInner)?, nillable: true, emit_null: false)]
    property items : Array(LeadFormArrayResponseItemsInner)?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@items : Array(LeadFormArrayResponseItemsInner)? = nil)
    end
