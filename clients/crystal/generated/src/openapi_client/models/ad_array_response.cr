...
module OpenAPIClient
  class AdArrayResponse
    ...
    # Optional properties
    @[JSON::Field(key: "items", type: Array(AdArrayResponseElement)?, nillable: true, emit_null: false)]
    property items : Array(AdArrayResponseElement)?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@items : Array(AdArrayResponseElement)? = nil)
    end
