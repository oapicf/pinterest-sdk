...
module OpenAPIClient
  class GetInvites200Response
    ...
    @[JSON::Field(key: "items", type: Array(InviteResponse), nillable: false, emit_null: false)]
    property items : Array(InviteResponse)
    ...
    def initialize(@items : Array(InviteResponse), @bookmark : String? = nil)
    end
