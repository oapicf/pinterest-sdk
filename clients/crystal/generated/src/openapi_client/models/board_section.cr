...
module OpenAPIClient
  ...
  class BoardSection
    ...
    def list_invalid_properties
      ...
      if @name.try &.to_s.try &.size.try &.> 180
    ...
    def valid?
      return false if @name.try &.to_s.try &.size.try &.> 180
    ...
    def name=(name)
      if name.to_s.size > 180
        raise ArgumentError.new("invalid value for \"name\", the character length must be smaller than or equal to 180.")
      end
