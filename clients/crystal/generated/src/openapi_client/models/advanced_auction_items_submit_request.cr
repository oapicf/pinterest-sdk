...
module OpenAPIClient
  ...
  class AdvancedAuctionItemsSubmitRequest
    ...
    @[JSON::Field(key: "items", type: Array(AdvancedAuctionItemsSubmitRecord), nillable: false, emit_null: false)]
    ...
    def valid?
      ...
      return false if @items.try &.size.try &.> 10000
    ...
    def items=(items)
      if items.size > 10000
        raise ArgumentError.new("invalid value for \"items\", number of items must be less than or equal to 10000.")
      end
