...
module OpenAPIClient
  class AdvertiserDefinedEventsResponse
    ...
    # Optional properties
    @[JSON::Field(key: "items", type: Array(AdvertiserDefinedEvent)?, nillable: true, emit_null: false)]
    property items : Array(AdvertiserDefinedEvent)?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@items : Array(AdvertiserDefinedEvent)? = nil)
    end
