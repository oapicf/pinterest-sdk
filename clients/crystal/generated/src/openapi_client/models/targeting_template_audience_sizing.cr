...
module OpenAPIClient
  ...
  class TargetingTemplateAudienceSizing
    ...
    # Optional properties
    @[JSON::Field(key: "reach_estimate", type: TargetingTemplateAudienceSizingReachEstimate?, nillable: true, emit_null: false)]
    ...
    def ==(other)
      ...
      self.class == other.class &&
          reach_estimate == other.reach_estimate
    end
    ...
    def to_h
      ...
      hash["reach_estimate"] = _to_h(reach_estimate)
      hash.to_h
    end
