...
module OpenAPIClient
  class DeletePartnerAssetsResultsResponseArray
    ...
    @[JSON::Field(key: "items", type: Array(DeletePartnerAssetsResult)?, nillable: true, emit_null: false)]
    property items : Array(DeletePartnerAssetsResult)?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@items : Array(DeletePartnerAssetsResult)? = nil)
    end
