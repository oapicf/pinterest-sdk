...
module OpenAPIClient
  class FeedProcessingResultsList200Response
    ...
    # Required properties
    @[JSON::Field(key: "items", type: Array(CatalogsFeedProcessingResult), nillable: false, emit_null: false)]
    property items : Array(CatalogsFeedProcessingResult)
    ...
    def initialize(@items : Array(CatalogsFeedProcessingResult), @bookmark : String? = nil)
    end
