...
module OpenAPIClient
  class LeadFormArrayResponseItemsInner
    ...
    # Optional properties
    @[JSON::Field(key: "data", type: LeadFormResponse?, nillable: true, emit_null: false)]
    property data : LeadFormResponse?
    ...
    def initialize(@data : LeadFormResponse? = nil, @exceptions : Array(Exception)? = nil)
    end
