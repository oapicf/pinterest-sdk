...
module OpenAPIClient
  class AdAccountsCountryResponseData
    ...
    # Optional properties
    @[JSON::Field(key: "code", type: AdCountry?, nillable: true, emit_null: false)]
    property code : AdCountry?
    ...
    def initialize(@code : AdCountry? = nil, @currency : String? = nil, @index : Float64? = nil, @name : String? = nil)
    end
