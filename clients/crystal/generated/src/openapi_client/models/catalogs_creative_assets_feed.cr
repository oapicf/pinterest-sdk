...
module OpenAPIClient
  ...
  class CatalogsCreativeAssetsFeed
    ...
    def initialize(@created_at : Time, @id : String, @updated_at : Time, @catalog_id : String, @catalog_type : CatalogsType, @credentials : CatalogsFeedCredentials, @default_country : Country, @default_currency : NullableCurrency, @default_locale : String, @format : CatalogsFormat, @location : String, @name : String, @preferred_processing_schedule : CatalogsFeedProcessingSchedule, @status : CatalogsStatus)
    end
