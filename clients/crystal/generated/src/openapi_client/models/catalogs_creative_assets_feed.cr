...
module OpenAPIClient
  ...
  class CatalogsCreativeAssetsFeed
    ...
    def initialize(@created_at : Time, @id : String, @updated_at : Time, @name : String, @format : CatalogsFormat, @catalog_type : CatalogsType, @credentials : CatalogsFeedCredentials, @location : String, @preferred_processing_schedule : CatalogsFeedProcessingSchedule, @status : CatalogsStatus, @default_currency : NullableCurrency, @default_locale : String, @default_country : Country, @catalog_id : String)
    end
    ...
    def hash
      [created_at, id, updated_at, name, format, catalog_type, credentials, location, preferred_processing_schedule, status, default_currency, default_locale, default_country, catalog_id].hash
    end
