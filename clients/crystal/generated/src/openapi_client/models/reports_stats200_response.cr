...
module OpenAPIClient
  class ReportsStats200Response
    ...
    # Required properties
    @[JSON::Field(key: "items", type: Array(CatalogsReportStats), nillable: false, emit_null: false)]
    property items : Array(CatalogsReportStats)
    ...
    def initialize(@items : Array(CatalogsReportStats), @bookmark : String? = nil)
    end
