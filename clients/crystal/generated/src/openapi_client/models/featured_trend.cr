...
module OpenAPIClient
  ...
  class FeaturedTrend
    ...
    @[JSON::Field(key: "interest", type: InterestsEnum, nillable: false, emit_null: false)]
    property interest : InterestsEnum

    # Optional properties
    # Market code (e.g., 'US', 'UK', etc.)
    @[JSON::Field(key: "market", type: ProductCategoryRegion?, nillable: true, emit_null: false)]
    property market : ProductCategoryRegion?

    # List of trending topics within this interest category
    @[JSON::Field(key: "trends", type: Array(TrendingTopic)?, nillable: true, emit_null: false)]
    ...
    def to_h
      ...
      hash["market"] = _to_h(market)
      hash["trends"] = _to_h(trends)
      hash.to_h
    end
