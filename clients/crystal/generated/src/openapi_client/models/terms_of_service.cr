...
module OpenAPIClient
  class TermsOfService
    ...
    @[JSON::Field(key: "has_accepted", type: Bool?, nillable: true, emit_null: false)]
    property has_accepted : Bool?

    # The terms of service content
    @[JSON::Field(key: "html", type: String?, nillable: true, emit_null: false)]
    ...
    def ==(other)
      ...
      self.class == other.class &&
          ...
          has_accepted == other.has_accepted &&
          html == other.html &&
          id == other.id
    end
    ...
    def to_h
      ...
      hash["has_accepted"] = _to_h(has_accepted)
      hash["html"] = _to_h(html)
      hash["id"] = _to_h(id)
      hash.to_h
    end
