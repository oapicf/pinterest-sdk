...
module OpenAPIClient
  ...
  class PinUpdate
    ...
    def initialize(@alt_text : String? = nil, @board_id : String? = nil, @board_section_id : String? = nil, @description : String? = nil, @link : String? = nil, @title : String? = nil, @carousel_slots : Array(PinUpdateCarouselSlotsInner)? = nil, @note : String? = nil)
    end
