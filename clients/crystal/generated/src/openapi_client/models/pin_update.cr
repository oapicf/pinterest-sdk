...
module OpenAPIClient
  ...
  class PinUpdate
    ...
    @[JSON::Field(key: "carousel_slots", type: Array(CarouselSlot)?, nillable: true, emit_null: false)]
    ...
    def initialize(@alt_text : String? = nil, @board_id : String? = nil, @board_section_id : String? = nil, @carousel_slots : Array(CarouselSlot)? = nil, @description : String? = nil, @link : String? = nil, @title : String? = nil)
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
          ...
          carousel_slots == other.carousel_slots &&
    ...
    def to_h
      ...
      hash["carousel_slots"] = _to_h(carousel_slots)
