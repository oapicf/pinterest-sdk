...
module OpenAPIClient
  class LeadFormResponse
    ...
    def initialize(@name : String?, @privacy_policy_link : String?, @has_accepted_terms : Bool?, @completion_message : String?, @status : LeadFormStatus?, @disclosure_language : String?, @questions : Array(LeadFormQuestion)?, @id : String?, @ad_account_id : String?, @created_time : Int32?, @updated_time : Int32?)
    end
    ...
    def hash
      [name, privacy_policy_link, has_accepted_terms, completion_message, status, disclosure_language, questions, id, ad_account_id, created_time, updated_time].hash
    end
