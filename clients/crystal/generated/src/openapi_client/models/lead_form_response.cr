...
module OpenAPIClient
  class LeadFormResponse
    ...
    def initialize(@name : String? = nil, @privacy_policy_link : String? = nil, @has_accepted_terms : Bool? = nil, @completion_message : String? = nil, @status : LeadFormStatus? = nil, @disclosure_language : String? = nil, @questions : Array(LeadFormQuestion)? = nil, @policy_links : Array(LeadFormCommonPolicyLinksInner)? = nil, @id : String? = nil, @ad_account_id : String? = nil, @created_time : Int32? = nil, @updated_time : Int32? = nil)
    end
    ...
    def hash
      [name, privacy_policy_link, has_accepted_terms, completion_message, status, disclosure_language, questions, policy_links, id, ad_account_id, created_time, updated_time].hash
    end
