...
module OpenAPIClient
  class OrderLineError
    ...
    # Optional properties
    @[JSON::Field(key: "data", type: OrderLine?, nillable: true, emit_null: false)]
    property data : OrderLine?

    @[JSON::Field(key: "error_messages", type: Array(String)?, nillable: true, emit_null: false)]
    property error_messages : Array(String)?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@data : OrderLine? = nil, @error_messages : Array(String)? = nil)
    end
    ...
    def to_h
      ...
      hash["error_messages"] = _to_h(error_messages)
      hash.to_h
    end
