...
module OpenAPIClient
  class CatalogsCreativeAssetsAttributes
    ...
    @[JSON::Field(key: "visibility", type: String?, nillable: true, emit_null: false)]
    property visibility : String?

    # The creative assets image.
    @[JSON::Field(key: "image_link", type: String?, nillable: true, emit_null: false)]
    ...
    def initialize(@title : String? = nil, @description : String? = nil, @link : String? = nil, @ios_deep_link : String? = nil, @android_deep_link : String? = nil, @google_product_category : String? = nil, @custom_label_0 : String? = nil, @custom_label_1 : String? = nil, @custom_label_2 : String? = nil, @custom_label_3 : String? = nil, @custom_label_4 : String? = nil, @visibility : String? = nil, @image_link : String? = nil, @video_link : String? = nil)
    end
    ...
    def hash
      [title, description, link, ios_deep_link, android_deep_link, google_product_category, custom_label_0, custom_label_1, custom_label_2, custom_label_3, custom_label_4, visibility, image_link, video_link].hash
    end
    ...
    def to_h
      ...
      hash["visibility"] = _to_h(visibility)
