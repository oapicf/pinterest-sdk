...
module OpenAPIClient
  class AdGroupArrayResponse
    ...
    # Optional properties
    @[JSON::Field(key: "items", type: Array(AdGroupArrayResponseElement)?, nillable: true, emit_null: false)]
    property items : Array(AdGroupArrayResponseElement)?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@items : Array(AdGroupArrayResponseElement)? = nil)
    end
