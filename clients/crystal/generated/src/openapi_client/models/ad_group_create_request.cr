...
module OpenAPIClient
  class AdGroupCreateRequest
    ...
    def initialize(@name : String, @campaign_id : String, @billable_event : ActionType, @status : EntityStatus? = nil, @budget_in_micro_currency : Int32? = nil, @bid_in_micro_currency : Int32? = nil, @optimization_goal_metadata : OptimizationGoalMetadata? = nil, @budget_type : BudgetType? = nil, @start_time : Int32? = nil, @end_time : Int32? = nil, @targeting_spec : TargetingSpec? = nil, @lifetime_frequency_cap : Int32? = nil, @tracking_urls : TrackingUrls? = nil, @auto_targeting_enabled : Bool? = nil, @placement_group : PlacementGroupType? = nil, @pacing_delivery_type : PacingDeliveryType? = nil, @bid_strategy_type : String? = nil, @targeting_template_ids : Array(String)? = nil)
    end
