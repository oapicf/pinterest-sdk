...
module OpenAPIClient
  class ConversionTagListResponse
    ...
    # Optional properties
    @[JSON::Field(key: "items", type: Array(ConversionTagResponse)?, nillable: true, emit_null: false)]
    property items : Array(ConversionTagResponse)?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@items : Array(ConversionTagResponse)? = nil)
    end
