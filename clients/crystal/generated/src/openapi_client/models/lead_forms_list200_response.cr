...
module OpenAPIClient
  class LeadFormsList200Response
    ...
    # Required properties
    @[JSON::Field(key: "items", type: Array(LeadFormResponse), nillable: false, emit_null: false)]
    property items : Array(LeadFormResponse)
    ...
    def initialize(@items : Array(LeadFormResponse), @bookmark : String? = nil)
    end
