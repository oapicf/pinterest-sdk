...
module OpenAPIClient
  class BrandAccountsUpdateRequest
    ...
    @[JSON::Field(key: "profile_image", type: ImageBase64?, nillable: true, emit_null: false)]
    property profile_image : ImageBase64?
    ...
    def initialize(@name : String? = nil, @username : String? = nil, @country : Country? = nil, @about : String? = nil, @website : String? = nil, @profile_image : ImageBase64? = nil)
    end
    ...
    def hash
      [name, username, country, about, website, profile_image].hash
    end
