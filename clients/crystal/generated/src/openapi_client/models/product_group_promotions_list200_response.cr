...
module OpenAPIClient
  class ProductGroupPromotionsList200Response
    ...
    # Required properties
    @[JSON::Field(key: "items", type: Array(ProductGroupPromotion), nillable: false, emit_null: false)]
    property items : Array(ProductGroupPromotion)
    ...
    def initialize(@items : Array(ProductGroupPromotion), @bookmark : String? = nil)
    end
