...
module OpenAPIClient
  class UpdateMemberAssetsResultsResponseArrayItemsInner
    ...
    # Optional properties
    @[JSON::Field(key: "response", type: UsersForIndividualAssetResponse?, nillable: true, emit_null: false)]
    property response : UsersForIndividualAssetResponse?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@response : UsersForIndividualAssetResponse? = nil)
    end
