...
module OpenAPIClient
  class ConversionEventResponse
    ...
    def initialize(@ad_account_id : String? = nil, @conversion_event : ConversionTagType? = nil, @conversion_tag_id : String? = nil, @created_time : Int32? = nil)
    end
    ...
    def valid?
      ...
      return false if !@conversion_tag_id.nil? && @conversion_tag_id.try &.!~ /^\d+$/
      true
    end
