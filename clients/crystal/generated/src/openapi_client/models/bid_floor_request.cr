...
module OpenAPIClient
  class BidFloorRequest
    ...
    # Required properties
    @[JSON::Field(key: "bid_floor_specs", type: Array(BidFloorSpec), nillable: false, emit_null: false)]
    ...
    def initialize(@bid_floor_specs : Array(BidFloorSpec), @targeting_spec : TargetingSpec? = nil)
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
          bid_floor_specs == other.bid_floor_specs &&
    ...
    def to_h
      ...
      hash["bid_floor_specs"] = _to_h(bid_floor_specs)
