...
module OpenAPIClient
  class CatalogsProductGroupPinsList200Response
    ...
    # Required properties
    # Pins
    @[JSON::Field(key: "items", type: Array(CatalogsProduct), nillable: false, emit_null: false)]
    property items : Array(CatalogsProduct)
    ...
    def initialize(@items : Array(CatalogsProduct), @bookmark : String? = nil)
    end
