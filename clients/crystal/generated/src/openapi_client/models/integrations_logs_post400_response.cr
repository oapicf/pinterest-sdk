...
module OpenAPIClient
  class IntegrationsLogsPost400Response
    ...
    # Required properties
    @[JSON::Field(key: "code", type: Int32, nillable: false, emit_null: false)]
    property code : Int32

    @[JSON::Field(key: "message", type: String, nillable: false, emit_null: false)]
    property message : String

    @[JSON::Field(key: "details", type: Object, nillable: false, emit_null: false)]
    ...
    def initialize(@code : Int32, @message : String, @details : Object)
    end
