...
module OpenAPIClient
  class CampaignsList200Response
    ...
    # Required properties
    @[JSON::Field(key: "items", type: Array(CampaignResponse), nillable: false, emit_null: false)]
    property items : Array(CampaignResponse)
    ...
    def initialize(@items : Array(CampaignResponse), @bookmark : String? = nil)
    end
