...
module OpenAPIClient
  ...
  class CampaignBatchUpdateItem
    ...
    def initialize(@id : String, @ad_account_id : String? = nil, @app_id : String? = nil, @app_platform : MobileAppPlatform? = nil, @bid_options : CampaignBidOptionsUpdate? = nil, @daily_spend_cap : Int32? = nil, @default_ad_group_budget_in_micro_currency : Int32? = nil, @end_time : Int32? = nil, @intended_promotion_type : IntendedPromotionType? = nil, @is_automated_campaign : Bool? = nil, @is_campaign_budget_optimization : Bool? = nil, @is_flexible_daily_budgets : Bool? = nil, @is_ltv_optimized : Bool? = nil, @is_performance_plus : Bool? = nil, @is_top_of_search : Bool? = nil, @lifetime_spend_cap : Int32? = nil, @name : String? = nil, @objective_type : ConversionObjectiveType? = nil, @order_line_id : String? = nil, @performance_plus_campaign_settings : PerformancePlusCampaignSettings? = nil, @start_time : Int32? = nil, @status : EntityStatus? = nil, @tracking_urls : TrackingUrls? = nil)
    end
