...
module OpenAPIClient
  class CustomerListRequest
    ...
    # Optional properties
    @[JSON::Field(key: "list_type", type: UserListType?, default: "EMAIL", nillable: true, emit_null: false)]
    ...
    def initialize(@name : String, @records : String, @list_type : UserListType? = nil, @exceptions : Object? = nil)
    end
    ...
    def hash
      [name, records, list_type, exceptions].hash
    end
    ...
    def to_h
      ...
      hash["list_type"] = _to_h(list_type)
