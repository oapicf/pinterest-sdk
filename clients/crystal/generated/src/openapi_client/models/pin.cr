...
module OpenAPIClient
  ...
  class Pin
    ...
    def initialize(@id : String, @alt_text : String? = nil, @board_id : String? = nil, @board_owner : BoardOwner? = nil, @board_section_id : String? = nil, @created_at : Time? = nil, @creative_type : CreativeType? = nil, @description : String? = nil, @dominant_color : String? = nil, @has_been_promoted : Bool? = nil, @is_owner : Bool? = nil, @is_standard : Bool? = nil, @link : String? = nil, @media : PinMedia? = nil, @parent_pin_id : String? = nil, @pin_metrics : Object? = nil, @title : String? = nil)
    end
    ...
    def list_invalid_properties
      ...
      if !@description.nil? && @description.try &.to_s.try &.size.try &.> 800
    ...
    def valid?
      ...
      return false if !@description.nil? && @description.try &.to_s.try &.size.try &.> 800
    ...
    def hash
      [alt_text, board_id, board_owner, board_section_id, created_at, creative_type, description, dominant_color, has_been_promoted, id, is_owner, is_standard, link, media, parent_pin_id, pin_metrics, title].hash
    end
