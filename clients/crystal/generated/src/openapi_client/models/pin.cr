...
module OpenAPIClient
  ...
  class Pin
    ...
    def initialize(@id : String?, @created_at : Time?, @link : String?, @title : String?, @description : String?, @dominant_color : String?, @alt_text : String?, @creative_type : CreativeType?, @board_id : String?, @board_section_id : String?, @board_owner : BoardOwner?, @is_owner : Bool?, @media : PinMedia?, @media_source : PinMediaSource?, @parent_pin_id : String?, @is_standard : Bool?, @has_been_promoted : Bool?, @note : String?, @pin_metrics : Object?)
    end
