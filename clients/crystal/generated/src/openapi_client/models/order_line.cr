...
module OpenAPIClient
  class OrderLine
    ...
    def initialize(@campaign_ids : Array(String), @ad_account_id : String? = nil, @budget : Float64? = nil, @end_time : Float64? = nil, @id : String? = nil, @name : String? = nil, @paid_budget : Float64? = nil, @paid_type : OrderLinePaidType? = nil, @purchase_order_id : String? = nil, @start_time : Float64? = nil, @status : OrderLineStatus? = nil, @_type : String? = nil)
    end
    ...
    def hash
      [ad_account_id, budget, end_time, id, name, paid_budget, paid_type, purchase_order_id, start_time, status, _type, campaign_ids].hash
    end
