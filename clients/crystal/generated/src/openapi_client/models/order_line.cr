...
module OpenAPIClient
  class OrderLine
    ...
    def initialize(@campaign_ids : Array(String), @id : String?, @_type : String?, @ad_account_id : String?, @purchase_order_id : String?, @start_time : Float64?, @end_time : Float64?, @budget : Float64?, @paid_budget : Float64?, @status : OrderLineStatus?, @name : String?, @paid_type : OrderLinePaidType?)
    end
