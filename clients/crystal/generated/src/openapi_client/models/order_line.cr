...
module OpenAPIClient
  class OrderLine
    ...
    @[JSON::Field(key: "campaign_ids", type: Array(String), nillable: false, emit_null: false)]
    ...
    def initialize(@campaign_ids : Array(String), @id : String? = nil, @_type : String? = nil, @ad_account_id : String? = nil, @purchase_order_id : String? = nil, @start_time : Float64? = nil, @end_time : Float64? = nil, @budget : Float64? = nil, @paid_budget : Float64? = nil, @status : OrderLineStatus? = nil, @name : String? = nil, @paid_type : OrderLinePaidType? = nil)
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
          ...
          budget == other.budget &&
          paid_budget == other.paid_budget &&
          status == other.status &&
          name == other.name &&
          paid_type == other.paid_type &&
    ...
    def hash
      [id, _type, ad_account_id, purchase_order_id, start_time, end_time, budget, paid_budget, status, name, paid_type, campaign_ids].hash
    end
    ...
    def to_h
      ...
      hash["purchase_order_id"] = _to_h(purchase_order_id)
      hash["start_time"] = _to_h(start_time)
      hash["end_time"] = _to_h(end_time)
      hash["budget"] = _to_h(budget)
      hash["paid_budget"] = _to_h(paid_budget)
      hash["status"] = _to_h(status)
      hash["name"] = _to_h(name)
      hash["paid_type"] = _to_h(paid_type)
