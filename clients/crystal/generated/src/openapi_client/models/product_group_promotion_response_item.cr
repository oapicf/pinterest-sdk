...
module OpenAPIClient
  class ProductGroupPromotionResponseItem
    ...
    # Optional properties
    @[JSON::Field(key: "data", type: ProductGroupPromotion?, nillable: true, emit_null: false)]
    property data : ProductGroupPromotion?
    ...
    def initialize(@data : ProductGroupPromotion? = nil, @exceptions : Array(Exception)? = nil)
    end
