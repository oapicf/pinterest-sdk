...
module OpenAPIClient
  class MediaList200Response
    ...
    # Required properties
    # Media
    @[JSON::Field(key: "items", type: Array(MediaUploadDetails), nillable: false, emit_null: false)]
    property items : Array(MediaUploadDetails)
    ...
    def initialize(@items : Array(MediaUploadDetails), @bookmark : String? = nil)
    end
