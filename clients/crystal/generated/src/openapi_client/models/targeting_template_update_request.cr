...
module OpenAPIClient
  class TargetingTemplateUpdateRequest
    ...
    def valid?
      operation_type_validator = EnumAttributeValidator.new("String", ["REMOVE"])
    ...
    def operation_type=(operation_type)
      validator = EnumAttributeValidator.new("String", ["REMOVE"])
      unless validator.valid?(operation_type)
        raise ArgumentError.new("invalid value for \"operation_type\", must be one of #{validator.allowable_values}.")
      end
