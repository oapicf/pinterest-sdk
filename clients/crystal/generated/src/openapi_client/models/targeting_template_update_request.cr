...
module OpenAPIClient
  class TargetingTemplateUpdateRequest
    ...
    @[JSON::Field(key: "operation_type", type: String, nillable: false, emit_null: false)]
    ...
    class EnumAttributeValidatorForOperation_type < EnumAttributeValidator
      @attribute : String
      @allowable_values : Array(Int32 | Int64 | Float32 | Float64 | String)

      def initialize
        @attribute = "operation_type"
        @allowable_values = ["REMOVE", "UPDATE"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@id : String, @operation_type : String, @targeting_attributes : TargetingSpec? = nil)
    end
    ...
    def list_invalid_properties
      ...
      operation_type_validator = EnumAttributeValidatorForOperation_type.new
      if !operation_type_validator.valid?(@operation_type)
        message = operation_type_validator.message
    ...
    def operation_type=(operation_type)
      validator = EnumAttributeValidatorForOperation_type.new
