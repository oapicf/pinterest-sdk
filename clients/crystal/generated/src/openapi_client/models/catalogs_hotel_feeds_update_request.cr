...
module OpenAPIClient
  ...
  class CatalogsHotelFeedsUpdateRequest
    ...
    def initialize(@catalog_type : CatalogsType, @default_currency : NullableCurrency? = nil, @name : String? = nil, @format : CatalogsFormat? = nil, @credentials : CatalogsFeedCredentials? = nil, @location : String? = nil, @preferred_processing_schedule : CatalogsFeedProcessingSchedule? = nil, @status : CatalogsStatus? = nil)
    end
    ...
    def hash
      [default_currency, name, format, credentials, location, preferred_processing_schedule, status, catalog_type].hash
    end
