...
module OpenAPIClient
  class CreateMMMReportResponse
    ...
    @[JSON::Field(key: "data", type: CreateMMMReportResponseData?, nillable: true, emit_null: false)]
    property data : CreateMMMReportResponseData?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@code : Float64? = nil, @data : CreateMMMReportResponseData? = nil)
    end
