...
module OpenAPIClient
  class ImageMetadata
    ...
    def initialize(@item_type : String? = nil, @title : String? = nil, @description : String? = nil, @link : String? = nil, @images : ImageMetadataImages? = nil)
    end
    ...
    def hash
      [item_type, title, description, link, images].hash
    end
