...
module OpenAPIClient
  class ConversionEventsDataInnerCustomDataContentsInner
    ...
    def initialize(@id : String? = nil, @item_brand : String? = nil, @item_category : String? = nil, @item_name : String? = nil, @item_price : String? = nil, @quantity : Int64? = nil)
    end
    ...
    def hash
      [id, item_brand, item_category, item_name, item_price, quantity].hash
    end
