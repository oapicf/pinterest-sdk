...
module OpenAPIClient
  class ConversionEventsDataInnerCustomDataContentsInner
    ...
    @[JSON::Field(key: "item_price", type: String?, nillable: true, emit_null: false)]
    ...
    @[JSON::Field(key: "quantity", type: Int64?, nillable: true, emit_null: false)]
    property quantity : Int64?

    # The name of a product.
    @[JSON::Field(key: "item_name", type: String?, nillable: true, emit_null: false)]
    property item_name : String?

    # The category of a product.
    @[JSON::Field(key: "item_category", type: String?, nillable: true, emit_null: false)]
    property item_category : String?

    # The brand of a product.
    @[JSON::Field(key: "item_brand", type: String?, nillable: true, emit_null: false)]
    property item_brand : String?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@id : String? = nil, @item_price : String? = nil, @quantity : Int64? = nil, @item_name : String? = nil, @item_category : String? = nil, @item_brand : String? = nil)
    end
    ...
    def hash
      [id, item_price, quantity, item_name, item_category, item_brand].hash
    end
    ...
    def to_h
      ...
      hash["id"] = _to_h(id)
      hash["item_price"] = _to_h(item_price)
      hash["quantity"] = _to_h(quantity)
      hash["item_name"] = _to_h(item_name)
      hash["item_category"] = _to_h(item_category)
      hash["item_brand"] = _to_h(item_brand)
      hash.to_h
    end
