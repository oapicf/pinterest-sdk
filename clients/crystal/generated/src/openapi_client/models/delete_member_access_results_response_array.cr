...
module OpenAPIClient
  class DeleteMemberAccessResultsResponseArray
    ...
    @[JSON::Field(key: "items", type: Array(DeleteMemberAccessResult)?, nillable: true, emit_null: false)]
    property items : Array(DeleteMemberAccessResult)?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@items : Array(DeleteMemberAccessResult)? = nil)
    end
