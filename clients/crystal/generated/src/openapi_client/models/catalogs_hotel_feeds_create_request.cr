...
module OpenAPIClient
  ...
  class CatalogsHotelFeedsCreateRequest
    ...
    def initialize(@name : String, @format : CatalogsFormat, @default_locale : CatalogsFeedsCreateRequestDefaultLocale, @location : String, @catalog_type : CatalogsType, @default_currency : NullableCurrency?, @credentials : CatalogsFeedCredentials?, @preferred_processing_schedule : CatalogsFeedProcessingSchedule?, @catalog_id : String?)
    end
    ...
    def hash
      [default_currency, name, format, default_locale, credentials, location, preferred_processing_schedule, catalog_type, catalog_id].hash
    end
