...
module OpenAPIClient
  class AdsCreditsDiscountsGet200Response
    ...
    # Required properties
    @[JSON::Field(key: "items", type: Array(AdsCreditDiscountsResponse), nillable: false, emit_null: false)]
    property items : Array(AdsCreditDiscountsResponse)
    ...
    def initialize(@items : Array(AdsCreditDiscountsResponse), @bookmark : String? = nil)
    end
