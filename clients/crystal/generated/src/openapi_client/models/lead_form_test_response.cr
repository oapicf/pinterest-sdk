...
module OpenAPIClient
  ...
  class LeadFormTestResponse
    ...
    # Optional properties
    # Subscription ID.
    @[JSON::Field(key: "subscription_id", type: String?, nillable: true, emit_null: false)]
    property subscription_id : String?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@subscription_id : String? = nil)
    end
    ...
    def list_invalid_properties
      ...
      pattern = /^\d+$/
      if !@subscription_id.nil? && @subscription_id.try &.!~ pattern
    ...
    def valid?
      return false if !@subscription_id.nil? && @subscription_id.try &.!~ /^\d+$/
      true
    end
    ...
    def subscription_id=(subscription_id)
      ...
      if !subscription_id.nil? && subscription_id !~ pattern
        raise ArgumentError.new("invalid value for \"subscription_id\", must conform to the pattern #{pattern}.")
      end
    ...
    def to_h
      ...
      hash["subscription_id"] = _to_h(subscription_id)
      hash.to_h
    end
