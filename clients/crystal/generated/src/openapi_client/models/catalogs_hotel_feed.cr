...
module OpenAPIClient
  ...
  class CatalogsHotelFeed
    ...
    def initialize(@created_at : Time, @id : String, @updated_at : Time, @catalog_id : String, @catalog_type : CatalogsType, @credentials : CatalogsFeedCredentials, @default_currency : NullableCurrency, @default_locale : String, @format : CatalogsFormat, @location : String, @name : String, @preferred_processing_schedule : CatalogsFeedProcessingSchedule, @status : CatalogsStatus)
    end
    ...
    def hash
      [created_at, id, updated_at, catalog_id, catalog_type, credentials, default_currency, default_locale, format, location, name, preferred_processing_schedule, status].hash
    end
