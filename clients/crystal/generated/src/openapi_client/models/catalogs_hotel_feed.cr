...
module OpenAPIClient
  ...
  class CatalogsHotelFeed
    ...
    def hash
      [created_at, id, updated_at, name, format, catalog_type, credentials, location, preferred_processing_schedule, status, default_currency, default_locale, catalog_id].hash
    end
