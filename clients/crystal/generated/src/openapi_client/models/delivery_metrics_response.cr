...
module OpenAPIClient
  class DeliveryMetricsResponse
    ...
    # Optional properties
    @[JSON::Field(key: "items", type: Array(DeliveryMetricsResponseItemsInner)?, nillable: true, emit_null: false)]
    property items : Array(DeliveryMetricsResponseItemsInner)?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@items : Array(DeliveryMetricsResponseItemsInner)? = nil)
    end
