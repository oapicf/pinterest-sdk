...
module OpenAPIClient
  class AudienceCreateCustomRequest
    ...
    def initialize(@name : String, @rule : AudienceRule, @sharing_type : AudienceSharingType, @data_party : AudienceDataParty, @ad_account_id : String?, @category : String?)
    end
