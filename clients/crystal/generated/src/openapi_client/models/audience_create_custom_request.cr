...
module OpenAPIClient
  class AudienceCreateCustomRequest
    ...
    @[JSON::Field(key: "rule", type: AudienceRule, nillable: false, emit_null: false)]
    property rule : AudienceRule

    @[JSON::Field(key: "sharing_type", type: AudienceSharingType, nillable: false, emit_null: false)]
    property sharing_type : AudienceSharingType

    @[JSON::Field(key: "data_party", type: AudienceDataParty, nillable: false, emit_null: false)]
    property data_party : AudienceDataParty
    ...
    def initialize(@name : String, @rule : AudienceRule, @sharing_type : AudienceSharingType, @data_party : AudienceDataParty, @ad_account_id : String? = nil, @category : String? = nil)
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
          ...
          name == other.name &&
          rule == other.rule &&
          sharing_type == other.sharing_type &&
          data_party == other.data_party &&
    ...
    def hash
      [ad_account_id, name, rule, sharing_type, data_party, category].hash
    end
    ...
    def to_h
      ...
      hash["sharing_type"] = _to_h(sharing_type)
      hash["data_party"] = _to_h(data_party)
