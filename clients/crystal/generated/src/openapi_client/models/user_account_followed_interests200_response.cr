...
module OpenAPIClient
  class UserAccountFollowedInterests200Response
    ...
    # Required properties
    @[JSON::Field(key: "items", type: Array(Interest), nillable: false, emit_null: false)]
    property items : Array(Interest)
    ...
    def initialize(@items : Array(Interest), @bookmark : String? = nil)
    end
