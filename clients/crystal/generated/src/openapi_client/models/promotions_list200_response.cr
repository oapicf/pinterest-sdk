...
module OpenAPIClient
  class PromotionsList200Response
    ...
    # Required properties
    @[JSON::Field(key: "items", type: Array(PromotionResponse), nillable: false, emit_null: false)]
    property items : Array(PromotionResponse)
    ...
    def initialize(@items : Array(PromotionResponse), @bookmark : String? = nil)
    end
