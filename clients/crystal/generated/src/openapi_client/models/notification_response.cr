...
module OpenAPIClient
  class NotificationResponse
    ...
    @[JSON::Field(key: "success", type: Bool?, nillable: true, emit_null: false)]
    property success : Bool?

    # Received time. Unix timestamp in seconds.
    @[JSON::Field(key: "received_at", type: Int32?, nillable: true, emit_null: false)]
    property received_at : Int32?

    # error message when success is false
    @[JSON::Field(key: "error_msg", type: String?, nillable: true, emit_null: false)]
    property error_msg : String?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@success : Bool? = nil, @received_at : Int32? = nil, @error_msg : String? = nil)
    end
    ...
    def hash
      [success, received_at, error_msg].hash
    end
    ...
    def to_h
      ...
      hash["success"] = _to_h(success)
      hash["received_at"] = _to_h(received_at)
      hash["error_msg"] = _to_h(error_msg)
      hash.to_h
    end
