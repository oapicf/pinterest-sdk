...
module OpenAPIClient
  class TargetingTemplateList200Response
    ...
    # Required properties
    @[JSON::Field(key: "items", type: Array(TargetingTemplateResponseData), nillable: false, emit_null: false)]
    property items : Array(TargetingTemplateResponseData)
    ...
    def initialize(@items : Array(TargetingTemplateResponseData), @bookmark : String? = nil)
    end
