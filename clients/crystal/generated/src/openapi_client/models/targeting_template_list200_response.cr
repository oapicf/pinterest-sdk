...
module OpenAPIClient
  class TargetingTemplateList200Response
    ...
    # Required properties
    @[JSON::Field(key: "items", type: Array(TargetingTemplateGetResponseData), nillable: false, emit_null: false)]
    property items : Array(TargetingTemplateGetResponseData)
    ...
    def initialize(@items : Array(TargetingTemplateGetResponseData), @bookmark : String? = nil)
    end
