...
module OpenAPIClient
  class GetBusinessPartners200Response
    ...
    @[JSON::Field(key: "items", type: Array(UserBusinessRoleBinding), nillable: false, emit_null: false)]
    property items : Array(UserBusinessRoleBinding)
    ...
    def initialize(@items : Array(UserBusinessRoleBinding), @bookmark : String? = nil)
    end
