...
module OpenAPIClient
  ...
  class LeadFormCommon
    ...
    def initialize(@name : String? = nil, @privacy_policy_link : String? = nil, @has_accepted_terms : Bool? = nil, @completion_message : String? = nil, @status : LeadFormStatus? = nil, @disclosure_language : String? = nil, @questions : Array(LeadFormQuestion)? = nil, @policy_links : Array(LeadFormCommonPolicyLinksInner)? = nil)
    end
