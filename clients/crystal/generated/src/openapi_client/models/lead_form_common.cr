...
module OpenAPIClient
  ...
  class LeadFormCommon
    ...
    def initialize(@completion_message : String? = nil, @disclosure_language : String? = nil, @has_accepted_terms : Bool? = nil, @name : String? = nil, @policy_links : Array(LeadFormCommonPolicyLinksInner)? = nil, @privacy_policy_link : String? = nil, @questions : Array(LeadFormQuestion)? = nil, @status : LeadFormStatus? = nil)
    end
