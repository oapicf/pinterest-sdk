...
module OpenAPIClient
  class BoardBase
    ...
    def initialize(@id : String, @name : String, @board_pins_modified_at : Time? = nil, @collaborator_count : Int32? = nil, @created_at : Time? = nil, @description : String? = nil, @follower_count : Int32? = nil, @is_ads_only : Bool? = nil, @media : BoardMedia? = nil, @owner : BoardOwner? = nil, @pin_count : Int32? = nil)
    end
