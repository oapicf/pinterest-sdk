...
module OpenAPIClient
  class UpdatePartnerResultsResponseArray
    ...
    # Optional properties
    @[JSON::Field(key: "items", type: Array(UpdatePartnerResultsResponseArrayItemsInner)?, nillable: true, emit_null: false)]
    property items : Array(UpdatePartnerResultsResponseArrayItemsInner)?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@items : Array(UpdatePartnerResultsResponseArrayItemsInner)? = nil)
    end
