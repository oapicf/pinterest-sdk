...
module OpenAPIClient
  class MembersToDeleteBody
    ...
    # Required properties
    @[JSON::Field(key: "members", type: Array(MembersToDeleteBodyMembersInner), nillable: false, emit_null: false)]
    property members : Array(MembersToDeleteBodyMembersInner)

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@members : Array(MembersToDeleteBodyMembersInner))
    end
    ...
    def valid?
      return false if @members.try &.size.try &.> 50
      return false if @members.try &.size.try &.< 1
      true
    end
