...
module OpenAPIClient
  class CatalogsFeedIngestionInfo
    ...
    @[JSON::Field(key: "IN_STOCK", type: Int32?, nillable: true, emit_null: false)]
    property in_stock : Int32?

    # The number of ingested products that are in out of stock.
    @[JSON::Field(key: "OUT_OF_STOCK", type: Int32?, nillable: true, emit_null: false)]
    property out_of_stock : Int32?

    # The number of ingested products that are in preorder.
    @[JSON::Field(key: "PREORDER", type: Int32?, nillable: true, emit_null: false)]
    ...
    def hash
      [in_stock, out_of_stock, preorder].hash
    end
