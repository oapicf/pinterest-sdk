...
module OpenAPIClient
  class SSIOOrderLine
    ...
    def initialize(@salesforce_order_line_id : String? = nil, @ads_manager_order_line_id : String? = nil, @pin_order_id : String? = nil, @last_modified_date_time : String? = nil, @start_date : Time? = nil, @end_date : Time? = nil, @bill_to_company_name : String? = nil, @billing_contact_firstname : String? = nil, @billing_contact_lastname : String? = nil, @billing_contact_email : String? = nil, @media_contact_email : String? = nil, @media_contact_firstname : String? = nil, @media_contact_lastname : String? = nil, @currency_info : Currency? = nil, @agency_link : String? = nil, @po_number : String? = nil, @order_name : String? = nil, @pmp_name : String? = nil, @accepted_terms_id : String? = nil, @accepted_terms_time : String? = nil, @budget_amount : Float64? = nil, @estimated_monthly_spend : Float64? = nil)
    end
