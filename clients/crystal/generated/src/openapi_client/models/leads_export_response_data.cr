...
module OpenAPIClient
  class LeadsExportResponseData
    ...
    # Optional properties
    @[JSON::Field(key: "export_status", type: LeadsExportStatus?, nillable: true, emit_null: false)]
    property export_status : LeadsExportStatus?

    @[JSON::Field(key: "download_url", type: String?, nillable: true, emit_null: false)]
    ...
    def initialize(@export_status : LeadsExportStatus? = nil, @download_url : String? = nil)
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
          export_status == other.export_status &&
    ...
    def hash
      [export_status, download_url].hash
    end
    ...
    def to_h
      ...
      hash["export_status"] = _to_h(export_status)
      hash["download_url"] = _to_h(download_url)
      hash.to_h
    end
