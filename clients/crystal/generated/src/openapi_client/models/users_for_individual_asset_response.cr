...
module OpenAPIClient
  ...
  class UsersForIndividualAssetResponse
    ...
    @[JSON::Field(key: "member_id", type: String?, nillable: true, emit_null: false)]
    ...
    def initialize(@asset_id : String? = nil, @member_id : String? = nil, @permissions : Array(String)? = nil)
    end
    ...
    def list_invalid_properties
      ...
      pattern = /^\d+$/
      if !@member_id.nil? && @member_id.try &.!~ pattern
    ...
    def valid?
      ...
      return false if !@member_id.nil? && @member_id.try &.!~ /^\d+$/
      true
    end
