...
module OpenAPIClient
  ...
  class PinMediaWithImageAndVideo
    ...
    # Optional properties
    @[JSON::Field(key: "items", type: Array(PinMediaMetadata)?, nillable: true, emit_null: false)]
    property items : Array(PinMediaMetadata)?
    ...
    class EnumAttributeValidatorForMedia_type < EnumAttributeValidator
      ...
      def initialize
        ...
        @allowable_values = ["multiple_mixed"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@media_type : String, @items : Array(PinMediaMetadata)? = nil)
    end
