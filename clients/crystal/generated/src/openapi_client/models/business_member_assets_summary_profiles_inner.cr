...
module OpenAPIClient
  class BusinessMemberAssetsSummaryProfilesInner
    ...
    def valid?
      return false if !@id.nil? && @id.try &.to_s.try &.size.try &.> 20
      return false if !@id.nil? && @id.try &.to_s.try &.size.try &.< 1
