...
module OpenAPIClient
  class AudienceUpdateRequest
    ...
    @[JSON::Field(key: "operation_type", type: AudienceUpdateOperationType?, default: "UPDATE", nillable: true, emit_null: false)]
    ...
    def initialize(@ad_account_id : String? = nil, @name : String? = nil, @rule : AudienceRule? = nil, @description : String? = nil, @operation_type : AudienceUpdateOperationType? = nil)
    end
    ...
    def hash
      [ad_account_id, name, rule, description, operation_type].hash
    end
