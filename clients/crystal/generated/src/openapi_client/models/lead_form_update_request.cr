...
module OpenAPIClient
  class LeadFormUpdateRequest
    ...
    def initialize(@id : String, @name : String? = nil, @privacy_policy_link : String? = nil, @has_accepted_terms : Bool? = nil, @completion_message : String? = nil, @status : LeadFormStatus? = nil, @disclosure_language : String? = nil, @questions : Array(LeadFormQuestion)? = nil, @policy_links : Array(LeadFormCommonPolicyLinksInner)? = nil)
    end
    ...
    def hash
      [name, privacy_policy_link, has_accepted_terms, completion_message, status, disclosure_language, questions, policy_links, id].hash
    end
