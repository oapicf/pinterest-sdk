...
module OpenAPIClient
  ...
  class AppTypeMultipliers
    ...
    # Optional properties
    @[JSON::Field(key: "APP_TYPE", type: String?, nillable: true, emit_null: false)]
    ...
    class EnumAttributeValidatorForApp_type < EnumAttributeValidator
      @attribute : String
      @allowable_values : Array(Int32 | Int64 | Float32 | Float64 | String)

      def initialize
        @attribute = "app_type"
        @allowable_values = ["android_mobile", "android_tablet", "ipad", "iphone", "web", "web_mobile"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@app_type : String? = nil)
    end
    ...
    def list_invalid_properties
      ...
      app_type_validator = EnumAttributeValidatorForApp_type.new
      if !app_type_validator.valid?(@app_type)
        message = app_type_validator.message
    ...
    def app_type=(app_type)
      validator = EnumAttributeValidatorForApp_type.new
