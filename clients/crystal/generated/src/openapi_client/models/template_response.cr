...
module OpenAPIClient
  ...
  class TemplateResponse
    ...
    def initialize(@id : String? = nil, @ad_account_id : String? = nil, @ad_account_ids : Array(String)? = nil, @user_id : String? = nil, @name : String? = nil, @report_start_relative_days_in_past : Float64? = nil, @report_end_relative_days_in_past : Float64? = nil, @date_range : TemplateResponseDateRange? = nil, @report_level : MetricsReportingLevel? = nil, @report_format : DataOutputFormat? = nil, @columns : Array(String)? = nil, @granularity : Granularity? = nil, @view_window_days : Float64? = nil, @click_window_days : Float64? = nil, @engagement_window_days : Float64? = nil, @conversion_report_time_type : String? = nil, @filters_json : String? = nil, @is_owned_by_user : Bool? = nil, @is_scheduled : Bool? = nil, @creation_source : String? = nil, @is_deleted : Bool? = nil, @updated_time : Float64? = nil, @custom_column_ids : Array(String)? = nil, @_type : String? = nil, @ingestion_sources : Array(String)? = nil)
    end
