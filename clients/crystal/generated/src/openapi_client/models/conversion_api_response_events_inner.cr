...
module OpenAPIClient
  class ConversionApiResponseEventsInner
    ...
    @[JSON::Field(key: "warning_message", type: String?, nillable: true, emit_null: false)]
    ...
    class EnumAttributeValidatorForStatus < EnumAttributeValidator
      ...
      def initialize
        @attribute = "status"
        @allowable_values = ["failed", "processed"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@status : String, @error_message : String? = nil, @warning_message : String? = nil)
    end
    ...
    def to_h
      ...
      hash["error_message"] = _to_h(error_message)
      hash["status"] = _to_h(status)
      hash["warning_message"] = _to_h(warning_message)
      hash.to_h
    end
