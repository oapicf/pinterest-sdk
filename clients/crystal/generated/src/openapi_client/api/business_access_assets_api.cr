  ...
  class BusinessAccessAssetsApi
    ...
    def asset_group_create_with_http_info(business_id : String, create_asset_group_body : CreateAssetGroupBody)
      ...
      if @api_client.config.client_side_validation && business_id.to_s.size < 1
        raise ArgumentError.new("invalid value for \"business_id\" when calling BusinessAccessAssetsApi.asset_group_create, the character length must be greater than or equal to 1.")
      end
    ...
    def asset_group_delete_with_http_info(business_id : String, delete_asset_group_body : DeleteAssetGroupBody)
      ...
      if @api_client.config.client_side_validation && business_id.to_s.size < 1
        raise ArgumentError.new("invalid value for \"business_id\" when calling BusinessAccessAssetsApi.asset_group_delete, the character length must be greater than or equal to 1.")
      end
    ...
    def asset_group_update_with_http_info(business_id : String, update_asset_group_body : UpdateAssetGroupBody)
      ...
      if @api_client.config.client_side_validation && business_id.to_s.size < 1
        raise ArgumentError.new("invalid value for \"business_id\" when calling BusinessAccessAssetsApi.asset_group_update, the character length must be greater than or equal to 1.")
      end
    ...
    def business_asset_members_get(business_id : String, asset_id : String, fetch_system_users : Bool? = nil, bookmark : String? = nil, page_size : Int32? = nil, start_index : Int32? = nil)
      data, _status_code, _headers = business_asset_members_get_with_http_info(business_id, asset_id, fetch_system_users, bookmark, page_size, start_index)
      data
    end
    ...
    def business_asset_members_get_with_http_info(business_id : String, asset_id : String, fetch_system_users : Bool? = nil, bookmark : String? = nil, page_size : Int32? = nil, start_index : Int32? = nil)
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && business_id.to_s.size < 1
        raise ArgumentError.new("invalid value for \"business_id\" when calling BusinessAccessAssetsApi.business_asset_members_get, the character length must be greater than or equal to 1.")
      end
      ...
      if @api_client.config.client_side_validation && asset_id.to_s.size < 1
        raise ArgumentError.new("invalid value for \"asset_id\" when calling BusinessAccessAssetsApi.business_asset_members_get, the character length must be greater than or equal to 1.")
      end
    ...
    def business_asset_partners_get(business_id : String, asset_id : String, start_index : Int32? = nil, bookmark : String? = nil, page_size : Int32? = nil)
    ...
    def business_asset_partners_get_with_http_info(business_id : String, asset_id : String, start_index : Int32? = nil, bookmark : String? = nil, page_size : Int32? = nil)
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && business_id.to_s.size < 1
        raise ArgumentError.new("invalid value for \"business_id\" when calling BusinessAccessAssetsApi.business_asset_partners_get, the character length must be greater than or equal to 1.")
      end
      ...
      if @api_client.config.client_side_validation && asset_id.to_s.size < 1
        raise ArgumentError.new("invalid value for \"asset_id\" when calling BusinessAccessAssetsApi.business_asset_partners_get, the character length must be greater than or equal to 1.")
      end
    ...
    def business_assets_get(business_id : String, permissions : Array(PermissionsWithOwner)? = nil, child_asset_id : String? = nil, asset_group_id : String? = nil, asset_type : String? = nil, start_index : Int32? = nil, bookmark : String? = nil, page_size : Int32? = nil)
    ...
    def business_assets_get_with_http_info(business_id : String, permissions : Array(PermissionsWithOwner)? = nil, child_asset_id : String? = nil, asset_group_id : String? = nil, asset_type : String? = nil, start_index : Int32? = nil, bookmark : String? = nil, page_size : Int32? = nil)
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && business_id.to_s.size < 1
        raise ArgumentError.new("invalid value for \"business_id\" when calling BusinessAccessAssetsApi.business_assets_get, the character length must be greater than or equal to 1.")
      end
      ...
      if @api_client.config.client_side_validation && !child_asset_id.nil? && child_asset_id.to_s.size < 1
        raise ArgumentError.new("invalid value for \"child_asset_id\" when calling BusinessAccessAssetsApi.business_assets_get, the character length must be greater than or equal to 1.")
      end
      ...
      if @api_client.config.client_side_validation && !asset_group_id.nil? && asset_group_id.to_s.size < 1
        raise ArgumentError.new("invalid value for \"asset_group_id\" when calling BusinessAccessAssetsApi.business_assets_get, the character length must be greater than or equal to 1.")
      end
      ...
      # query parameters
      query_params = Hash(String, String | Array(String)).new
      query_params["permissions"] = @api_client.build_collection_param(permissions, :multi) unless permissions.nil?
    ...
    def business_member_assets_get(business_id : String, member_id : String, asset_type : String? = nil, start_index : Int32? = nil, bookmark : String? = nil, page_size : Int32? = nil)
    ...
    def business_member_assets_get_with_http_info(business_id : String, member_id : String, asset_type : String? = nil, start_index : Int32? = nil, bookmark : String? = nil, page_size : Int32? = nil)
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && business_id.to_s.size < 1
        raise ArgumentError.new("invalid value for \"business_id\" when calling BusinessAccessAssetsApi.business_member_assets_get, the character length must be greater than or equal to 1.")
      end
      ...
      if @api_client.config.client_side_validation && member_id.to_s.size < 1
        raise ArgumentError.new("invalid value for \"member_id\" when calling BusinessAccessAssetsApi.business_member_assets_get, the character length must be greater than or equal to 1.")
      end
    ...
    def business_members_asset_access_delete_with_http_info(business_id : String, business_members_asset_access_delete_request : BusinessMembersAssetAccessDeleteRequest)
      ...
      if @api_client.config.client_side_validation && business_id.to_s.size < 1
        raise ArgumentError.new("invalid value for \"business_id\" when calling BusinessAccessAssetsApi.business_members_asset_access_delete, the character length must be greater than or equal to 1.")
      end
    ...
    def business_members_asset_access_update_with_http_info(business_id : String, update_member_asset_access_body : UpdateMemberAssetAccessBody)
      ...
      if @api_client.config.client_side_validation && business_id.to_s.size < 1
        raise ArgumentError.new("invalid value for \"business_id\" when calling BusinessAccessAssetsApi.business_members_asset_access_update, the character length must be greater than or equal to 1.")
      end
    ...
    def business_partner_asset_access_get(business_id : String, partner_id : String, partner_type : PartnerType? = nil, asset_type : String? = nil, start_index : Int32? = nil, page_size : Int32? = nil, bookmark : String? = nil)
    ...
    def business_partner_asset_access_get_with_http_info(business_id : String, partner_id : String, partner_type : PartnerType? = nil, asset_type : String? = nil, start_index : Int32? = nil, page_size : Int32? = nil, bookmark : String? = nil)
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && business_id.to_s.size < 1
        raise ArgumentError.new("invalid value for \"business_id\" when calling BusinessAccessAssetsApi.business_partner_asset_access_get, the character length must be greater than or equal to 1.")
      end
      ...
      if @api_client.config.client_side_validation && partner_id.to_s.size < 1
        raise ArgumentError.new("invalid value for \"partner_id\" when calling BusinessAccessAssetsApi.business_partner_asset_access_get, the character length must be greater than or equal to 1.")
      end
    ...
    def delete_partner_asset_access_handler_impl_with_http_info(business_id : String, delete_partner_asset_access_body : DeletePartnerAssetAccessBody)
      ...
      if @api_client.config.client_side_validation && business_id.to_s.size < 1
        raise ArgumentError.new("invalid value for \"business_id\" when calling BusinessAccessAssetsApi.delete_partner_asset_access_handler_impl, the character length must be greater than or equal to 1.")
      end
    ...
    def update_partner_asset_access_handler_impl_with_http_info(business_id : String, update_partner_asset_access_body : UpdatePartnerAssetAccessBody)
      ...
      if @api_client.config.client_side_validation && business_id.to_s.size < 1
        raise ArgumentError.new("invalid value for \"business_id\" when calling BusinessAccessAssetsApi.update_partner_asset_access_handler_impl, the character length must be greater than or equal to 1.")
      end
