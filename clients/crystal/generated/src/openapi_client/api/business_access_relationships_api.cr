...
module OpenAPIClient
  class BusinessAccessRelationshipsApi
    ...
    def get_business_members(business_id : String, assets_summary : Bool? = nil, business_roles : Array(MemberBusinessRole)? = nil, member_ids : String? = nil, start_index : Int32? = nil, bookmark : String? = nil, page_size : Int32? = nil)
    ...
    def get_business_members_with_http_info(business_id : String, assets_summary : Bool? = nil, business_roles : Array(MemberBusinessRole)? = nil, member_ids : String? = nil, start_index : Int32? = nil, bookmark : String? = nil, page_size : Int32? = nil)
      if @api_client.config.debugging
