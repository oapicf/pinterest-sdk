...
module OpenAPIClient
  class ConversionTagsApi
    ...
    def conversion_tags_create_with_http_info(ad_account_id : String, conversion_tag_create : ConversionTagCreate)
      ...
      return ConversionTag.from_json(data), status_code, headers
    end
    ...
    def conversion_tags_list(ad_account_id : String, filter_deleted : Bool? = nil)
    ...
    def conversion_tags_list_with_http_info(ad_account_id : String, filter_deleted : Bool? = nil)
      if @api_client.config.debugging
      ...
      # return_type
      return_type = "ConversionTagsList200Response"
      ...
      return ConversionTagsList200Response.from_json(data), status_code, headers
    end
    ...
    def page_visit_conversion_tags_get(ad_account_id : String, page_size : Int32? = nil, order : String? = nil, bookmark : String? = nil)
    ...
    def page_visit_conversion_tags_get_with_http_info(ad_account_id : String, page_size : Int32? = nil, order : String? = nil, bookmark : String? = nil)
      if @api_client.config.debugging
