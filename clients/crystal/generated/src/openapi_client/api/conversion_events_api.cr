...
module OpenAPIClient
  class ConversionEventsApi
    ...
    def events_create(ad_account_id : String, conversion_events : ConversionEvents, test : Bool? = nil)
    ...
    def events_create_with_http_info(ad_account_id : String, conversion_events : ConversionEvents, test : Bool? = nil)
