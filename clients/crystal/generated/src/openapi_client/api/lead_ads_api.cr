...
module OpenAPIClient
  class LeadAdsApi
    ...
    def ad_accounts_subscriptions_get_list(ad_account_id : String, page_size : Int32? = nil, bookmark : String? = nil)
    ...
    def ad_accounts_subscriptions_get_list_with_http_info(ad_account_id : String, page_size : Int32? = nil, bookmark : String? = nil)
      if @api_client.config.debugging
