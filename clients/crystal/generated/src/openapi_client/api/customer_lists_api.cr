...
module OpenAPIClient
  class CustomerListsApi
    ...
    def customer_lists_list(ad_account_id : String, page_size : Int32? = nil, order : String? = nil, bookmark : String? = nil)
    ...
    def customer_lists_list_with_http_info(ad_account_id : String, page_size : Int32? = nil, order : String? = nil, bookmark : String? = nil)
      if @api_client.config.debugging
