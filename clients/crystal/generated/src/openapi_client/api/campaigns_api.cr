...
module OpenAPIClient
  class CampaignsApi
    ...
    def ad_pins_analytics(ad_account_id : String, campaign_id : String, pin_ids : Array(String), start_date : Time, end_date : Time, columns : Array(String), granularity : Granularity, click_window_days : Int32? = nil, engagement_window_days : Int32? = nil, view_window_days : Int32? = nil, conversion_report_time : String? = nil)
      data, _status_code, _headers = ad_pins_analytics_with_http_info(ad_account_id, campaign_id, pin_ids, start_date, end_date, columns, granularity, click_window_days, engagement_window_days, view_window_days, conversion_report_time)
      data
    end
    ...
    def ad_pins_analytics_with_http_info(ad_account_id : String, campaign_id : String, pin_ids : Array(String), start_date : Time, end_date : Time, columns : Array(String), granularity : Granularity, click_window_days : Int32? = nil, engagement_window_days : Int32? = nil, view_window_days : Int32? = nil, conversion_report_time : String? = nil)
      if @api_client.config.debugging
        Log.debug {"Calling API: CampaignsApi.ad_pins_analytics ..."}
      end
      # verify the required parameter "ad_account_id" is set
      if @api_client.config.client_side_validation && ad_account_id.nil?
        raise ArgumentError.new("Missing the required parameter 'ad_account_id' when calling CampaignsApi.ad_pins_analytics")
      end
      if @api_client.config.client_side_validation && ad_account_id.to_s.size > 18
        raise ArgumentError.new("invalid value for \"ad_account_id\" when calling CampaignsApi.ad_pins_analytics, the character length must be smaller than or equal to 18.")
      end

      pattern = Regexp.new(/^\d+$/)
      if @api_client.config.client_side_validation && ad_account_id !~ pattern
        raise ArgumentError.new("invalid value for \"ad_account_id\" when calling CampaignsApi.ad_pins_analytics, must conform to the pattern #{pattern}.")
      end

      # verify the required parameter "campaign_id" is set
      if @api_client.config.client_side_validation && campaign_id.nil?
        raise ArgumentError.new("Missing the required parameter 'campaign_id' when calling CampaignsApi.ad_pins_analytics")
      end
      if @api_client.config.client_side_validation && campaign_id.to_s.size > 18
        raise ArgumentError.new("invalid value for \"campaign_id\" when calling CampaignsApi.ad_pins_analytics, the character length must be smaller than or equal to 18.")
      end

      pattern = Regexp.new(/^\d+$/)
      if @api_client.config.client_side_validation && campaign_id !~ pattern
        raise ArgumentError.new("invalid value for \"campaign_id\" when calling CampaignsApi.ad_pins_analytics, must conform to the pattern #{pattern}.")
      end

      # verify the required parameter "pin_ids" is set
      if @api_client.config.client_side_validation && pin_ids.nil?
        raise ArgumentError.new("Missing the required parameter 'pin_ids' when calling CampaignsApi.ad_pins_analytics")
      end
      if @api_client.config.client_side_validation && pin_ids.size > 100
        raise ArgumentError.new("invalid value for \"pin_ids\" when calling CampaignsApi.ad_pins_analytics, number of items must be less than or equal to 100.")
      end

      if @api_client.config.client_side_validation && pin_ids.size < 1
        raise ArgumentError.new("invalid value for \"pin_ids\" when calling CampaignsApi.ad_pins_analytics, number of items must be greater than or equal to 1.")
      end

      # verify the required parameter "start_date" is set
      if @api_client.config.client_side_validation && start_date.nil?
        raise ArgumentError.new("Missing the required parameter 'start_date' when calling CampaignsApi.ad_pins_analytics")
      end
      # verify the required parameter "end_date" is set
      if @api_client.config.client_side_validation && end_date.nil?
        raise ArgumentError.new("Missing the required parameter 'end_date' when calling CampaignsApi.ad_pins_analytics")
      end
      # verify the required parameter "columns" is set
      if @api_client.config.client_side_validation && columns.nil?
        raise ArgumentError.new("Missing the required parameter 'columns' when calling CampaignsApi.ad_pins_analytics")
      end
      # verify the required parameter "granularity" is set
      if @api_client.config.client_side_validation && granularity.nil?
        raise ArgumentError.new("Missing the required parameter 'granularity' when calling CampaignsApi.ad_pins_analytics")
      end
      ...
      # resource path
      local_var_path = "/ad_accounts/{ad_account_id}/pins/analytics".sub("{" + "ad_account_id" + "}", URI.encode_path(ad_account_id.to_s))
      ...
      # return_type
      return_type = "Array(AdPinAnalytics)"
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        local_var_path,
                                                        :"CampaignsApi.ad_pins_analytics",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: CampaignsApi#ad_pins_analytics\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return Array(AdPinAnalytics).from_json(data), status_code, headers
    end
    ...
    def campaign_targeting_analytics_get(ad_account_id : String, campaign_ids : Array(String), start_date : Time, end_date : Time, targeting_types : Array(AdsAnalyticsCampaignTargetingType), columns : Array(String), granularity : Granularity, click_window_days : Int32? = nil, engagement_window_days : Int32? = nil, view_window_days : Int32? = nil, conversion_report_time : String? = nil, attribution_types : Array(ConversionReportAttributionType)? = nil, reporting_timezone : ReportingTimeZone? = nil)
      data, _status_code, _headers = campaign_targeting_analytics_get_with_http_info(ad_account_id, campaign_ids, start_date, end_date, targeting_types, columns, granularity, click_window_days, engagement_window_days, view_window_days, conversion_report_time, attribution_types, reporting_timezone)
      data
    end
    ...
    def campaign_targeting_analytics_get_with_http_info(ad_account_id : String, campaign_ids : Array(String), start_date : Time, end_date : Time, targeting_types : Array(AdsAnalyticsCampaignTargetingType), columns : Array(String), granularity : Granularity, click_window_days : Int32? = nil, engagement_window_days : Int32? = nil, view_window_days : Int32? = nil, conversion_report_time : String? = nil, attribution_types : Array(ConversionReportAttributionType)? = nil, reporting_timezone : ReportingTimeZone? = nil)
      ...
      if @api_client.config.client_side_validation && campaign_ids.size > 250
        raise ArgumentError.new("invalid value for \"campaign_ids\" when calling CampaignsApi.campaign_targeting_analytics_get, number of items must be less than or equal to 250.")
      end
      ...
      if @api_client.config.client_side_validation && attribution_types.nil? && attribution_types.size > 2
        raise ArgumentError.new("invalid value for \"attribution_types\" when calling CampaignsApi.campaign_targeting_analytics_get, number of items must be less than or equal to 2.")
      end
      ...
      query_params["start_date"] = start_date.to_s unless start_date.nil?
      query_params["end_date"] = end_date.to_s unless end_date.nil?
      query_params["targeting_types"] = @api_client.build_collection_param(targeting_types, :csv) unless targeting_types.nil?
      query_params["columns"] = @api_client.build_collection_param(columns, :csv) unless columns.nil?
      query_params["granularity"] = granularity.to_s unless granularity.nil?
      query_params["click_window_days"] = click_window_days.to_s unless click_window_days.nil?
      query_params["engagement_window_days"] = engagement_window_days.to_s unless engagement_window_days.nil?
      query_params["view_window_days"] = view_window_days.to_s unless view_window_days.nil?
      query_params["conversion_report_time"] = conversion_report_time.to_s unless conversion_report_time.nil?
      query_params["attribution_types"] = @api_client.build_collection_param(attribution_types, :csv) unless attribution_types.nil?
    ...
    def campaigns_analytics(ad_account_id : String, start_date : Time, end_date : Time, campaign_ids : Array(String), columns : Array(String), granularity : Granularity, click_window_days : Int32? = nil, engagement_window_days : Int32? = nil, view_window_days : Int32? = nil, conversion_report_time : String? = nil, aggregate_report_rows : Bool? = nil, reporting_timezone : ReportingTimeZone? = nil)
      data, _status_code, _headers = campaigns_analytics_with_http_info(ad_account_id, start_date, end_date, campaign_ids, columns, granularity, click_window_days, engagement_window_days, view_window_days, conversion_report_time, aggregate_report_rows, reporting_timezone)
      data
    end
    ...
    def campaigns_analytics_with_http_info(ad_account_id : String, start_date : Time, end_date : Time, campaign_ids : Array(String), columns : Array(String), granularity : Granularity, click_window_days : Int32? = nil, engagement_window_days : Int32? = nil, view_window_days : Int32? = nil, conversion_report_time : String? = nil, aggregate_report_rows : Bool? = nil, reporting_timezone : ReportingTimeZone? = nil)
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && campaign_ids.size > 250
        raise ArgumentError.new("invalid value for \"campaign_ids\" when calling CampaignsApi.campaigns_analytics, number of items must be less than or equal to 250.")
      end
      ...
      query_params["view_window_days"] = view_window_days.to_s unless view_window_days.nil?
      query_params["conversion_report_time"] = conversion_report_time.to_s unless conversion_report_time.nil?
      query_params["aggregate_report_rows"] = aggregate_report_rows.to_s unless aggregate_report_rows.nil?
      query_params["reporting_timezone"] = reporting_timezone.to_s unless reporting_timezone.nil?
    ...
    def campaigns_list(ad_account_id : String, campaign_ids : Array(String)? = nil, entity_statuses : Array(String)? = nil, page_size : Int32? = nil, order : String? = nil, bookmark : String? = nil)
    ...
    def campaigns_list_with_http_info(ad_account_id : String, campaign_ids : Array(String)? = nil, entity_statuses : Array(String)? = nil, page_size : Int32? = nil, order : String? = nil, bookmark : String? = nil)
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && campaign_ids.nil? && campaign_ids.size > 250
        raise ArgumentError.new("invalid value for \"campaign_ids\" when calling CampaignsApi.campaigns_list, number of items must be less than or equal to 250.")
      end
