...
module OpenAPIClient
  class CampaignsApi
    ...
    def campaigns_analytics(ad_account_id : String, start_date : Time, end_date : Time, campaign_ids : Array(String), columns : Array(String), granularity : Granularity, click_window_days : Int32? = nil, engagement_window_days : Int32? = nil, view_window_days : Int32? = nil, conversion_report_time : String? = nil)
    ...
    def campaigns_analytics_with_http_info(ad_account_id : String, start_date : Time, end_date : Time, campaign_ids : Array(String), columns : Array(String), granularity : Granularity, click_window_days : Int32? = nil, engagement_window_days : Int32? = nil, view_window_days : Int32? = nil, conversion_report_time : String? = nil)
      if @api_client.config.debugging
