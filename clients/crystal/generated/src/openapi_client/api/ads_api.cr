...
module OpenAPIClient
  class AdsApi
    ...
    def ad_targeting_analytics_get_with_http_info(ad_account_id : String, ad_ids : Array(String), start_date : Time, end_date : Time, targeting_types : Array(AdsAnalyticsTargetingType), columns : Array(String), granularity : Granularity, click_window_days : Int32?, engagement_window_days : Int32?, view_window_days : Int32?, conversion_report_time : String?, attribution_types : ConversionReportAttributionType?)
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && targeting_types.size > 15
        raise ArgumentError.new("invalid value for \"targeting_types\" when calling AdsApi.ad_targeting_analytics_get, number of items must be less than or equal to 15.")
      end
    ...
    def ads_analytics_with_http_info(ad_account_id : String, start_date : Time, end_date : Time, ad_ids : Array(String), columns : Array(String), granularity : Granularity, click_window_days : Int32?, engagement_window_days : Int32?, view_window_days : Int32?, conversion_report_time : String?)
      ...
      # verify the required parameter "ad_ids" is set
      if @api_client.config.client_side_validation && ad_ids.nil?
        raise ArgumentError.new("Missing the required parameter 'ad_ids' when calling AdsApi.ads_analytics")
      end
      if @api_client.config.client_side_validation && ad_ids.size > 100
