...
module OpenAPIClient
  class AdsApi
    ...
    def ads_analytics(ad_account_id : String, start_date : Time, end_date : Time, columns : Array(String), granularity : Granularity, ad_ids : Array(String)? = nil, click_window_days : Int32? = nil, engagement_window_days : Int32? = nil, view_window_days : Int32? = nil, conversion_report_time : String? = nil, pin_ids : Array(String)? = nil, campaign_ids : Array(String)? = nil)
