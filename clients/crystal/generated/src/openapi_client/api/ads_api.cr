...
module OpenAPIClient
  class AdsApi
    ...
    def ad_targeting_analytics_get(ad_account_id : String, ad_ids : Array(String), start_date : Time, end_date : Time, targeting_types : Array(AdsAnalyticsAdTargetingType), columns : Array(String), granularity : Granularity, click_window_days : Int32? = nil, engagement_window_days : Int32? = nil, view_window_days : Int32? = nil, conversion_report_time : String? = nil, attribution_types : Array(ConversionReportAttributionType)? = nil, reporting_timezone : ReportingTimeZone? = nil)
      data, _status_code, _headers = ad_targeting_analytics_get_with_http_info(ad_account_id, ad_ids, start_date, end_date, targeting_types, columns, granularity, click_window_days, engagement_window_days, view_window_days, conversion_report_time, attribution_types, reporting_timezone)
      data
    end
    ...
    def ad_targeting_analytics_get_with_http_info(ad_account_id : String, ad_ids : Array(String), start_date : Time, end_date : Time, targeting_types : Array(AdsAnalyticsAdTargetingType), columns : Array(String), granularity : Granularity, click_window_days : Int32? = nil, engagement_window_days : Int32? = nil, view_window_days : Int32? = nil, conversion_report_time : String? = nil, attribution_types : Array(ConversionReportAttributionType)? = nil, reporting_timezone : ReportingTimeZone? = nil)
      ...
      if @api_client.config.client_side_validation && ad_ids.size > 250
        raise ArgumentError.new("invalid value for \"ad_ids\" when calling AdsApi.ad_targeting_analytics_get, number of items must be less than or equal to 250.")
      end
      ...
      if @api_client.config.client_side_validation && attribution_types.nil? && attribution_types.size > 2
        raise ArgumentError.new("invalid value for \"attribution_types\" when calling AdsApi.ad_targeting_analytics_get, number of items must be less than or equal to 2.")
      end
      ...
      # query parameters
      query_params = Hash(String, String | Array(String)).new
      query_params["ad_ids"] = @api_client.build_collection_param(ad_ids, :multi) unless ad_ids.nil?
    ...
    def ads_analytics(ad_account_id : String, start_date : Time, end_date : Time, columns : Array(String), granularity : Granularity, ad_ids : Array(String)? = nil, click_window_days : Int32? = nil, engagement_window_days : Int32? = nil, view_window_days : Int32? = nil, conversion_report_time : String? = nil, pin_ids : Array(String)? = nil, campaign_ids : Array(String)? = nil, reporting_timezone : ReportingTimeZone? = nil)
      data, _status_code, _headers = ads_analytics_with_http_info(ad_account_id, start_date, end_date, columns, granularity, ad_ids, click_window_days, engagement_window_days, view_window_days, conversion_report_time, pin_ids, campaign_ids, reporting_timezone)
      data
    end
    ...
    def ads_analytics_with_http_info(ad_account_id : String, start_date : Time, end_date : Time, columns : Array(String), granularity : Granularity, ad_ids : Array(String)? = nil, click_window_days : Int32? = nil, engagement_window_days : Int32? = nil, view_window_days : Int32? = nil, conversion_report_time : String? = nil, pin_ids : Array(String)? = nil, campaign_ids : Array(String)? = nil, reporting_timezone : ReportingTimeZone? = nil)
      ...
      if @api_client.config.client_side_validation && ad_ids.nil? && ad_ids.size > 250
        raise ArgumentError.new("invalid value for \"ad_ids\" when calling AdsApi.ads_analytics, number of items must be less than or equal to 250.")
      end
      ...
      if @api_client.config.client_side_validation && campaign_ids.nil? && campaign_ids.size > 250
        raise ArgumentError.new("invalid value for \"campaign_ids\" when calling AdsApi.ads_analytics, number of items must be less than or equal to 250.")
      end
    ...
    def ads_list(ad_account_id : String, campaign_ids : Array(String)? = nil, ad_group_ids : Array(String)? = nil, ad_ids : Array(String)? = nil, entity_statuses : Array(String)? = nil, page_size : Int32? = nil, order : String? = nil, bookmark : String? = nil)
    ...
    def ads_list_with_http_info(ad_account_id : String, campaign_ids : Array(String)? = nil, ad_group_ids : Array(String)? = nil, ad_ids : Array(String)? = nil, entity_statuses : Array(String)? = nil, page_size : Int32? = nil, order : String? = nil, bookmark : String? = nil)
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && campaign_ids.nil? && campaign_ids.size > 250
        raise ArgumentError.new("invalid value for \"campaign_ids\" when calling AdsApi.ads_list, number of items must be less than or equal to 250.")
      end
      ...
      if @api_client.config.client_side_validation && ad_group_ids.nil? && ad_group_ids.size > 250
        raise ArgumentError.new("invalid value for \"ad_group_ids\" when calling AdsApi.ads_list, number of items must be less than or equal to 250.")
      end
      ...
      if @api_client.config.client_side_validation && ad_ids.nil? && ad_ids.size > 250
        raise ArgumentError.new("invalid value for \"ad_ids\" when calling AdsApi.ads_list, number of items must be less than or equal to 250.")
      end
