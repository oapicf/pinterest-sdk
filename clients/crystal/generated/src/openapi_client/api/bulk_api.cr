...
module OpenAPIClient
  class BulkApi
    ...
    def bulk_request_get(ad_account_id : String, bulk_request_id : String, include_details : Bool? = nil)
    ...
    def bulk_request_get_with_http_info(ad_account_id : String, bulk_request_id : String, include_details : Bool? = nil)
      if @api_client.config.debugging
