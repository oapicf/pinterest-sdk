...
module OpenAPIClient
  class AdAccountsApi
    ...
    def ad_account_analytics(ad_account_id : String, start_date : Time, end_date : Time, columns : Array(String), granularity : Granularity, click_window_days : Int32? = nil, engagement_window_days : Int32? = nil, view_window_days : Int32? = nil, conversion_report_time : String? = nil)
    ...
    def ad_account_analytics_with_http_info(ad_account_id : String, start_date : Time, end_date : Time, columns : Array(String), granularity : Granularity, click_window_days : Int32? = nil, engagement_window_days : Int32? = nil, view_window_days : Int32? = nil, conversion_report_time : String? = nil)
    ...
    def ad_accounts_list(bookmark : String? = nil, page_size : Int32? = nil, include_shared_accounts : Bool? = nil)
    ...
    def ad_accounts_list_with_http_info(bookmark : String? = nil, page_size : Int32? = nil, include_shared_accounts : Bool? = nil)
      if @api_client.config.debugging
