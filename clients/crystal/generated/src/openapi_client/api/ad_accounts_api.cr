...
module OpenAPIClient
  class AdAccountsApi
    ...
    def ad_account_analytics(ad_account_id : String, start_date : Time, end_date : Time, columns : Array(String), granularity : Granularity, click_window_days : Int32? = nil, engagement_window_days : Int32? = nil, view_window_days : Int32? = nil, conversion_report_time : String? = nil, reporting_timezone : ReportingTimeZone? = nil)
      data, _status_code, _headers = ad_account_analytics_with_http_info(ad_account_id, start_date, end_date, columns, granularity, click_window_days, engagement_window_days, view_window_days, conversion_report_time, reporting_timezone)
      data
    end
    ...
    def ad_account_analytics_with_http_info(ad_account_id : String, start_date : Time, end_date : Time, columns : Array(String), granularity : Granularity, click_window_days : Int32? = nil, engagement_window_days : Int32? = nil, view_window_days : Int32? = nil, conversion_report_time : String? = nil, reporting_timezone : ReportingTimeZone? = nil)
    ...
    def ad_account_targeting_analytics_get(ad_account_id : String, start_date : Time, end_date : Time, targeting_types : Array(AdsAnalyticsTargetingType), columns : Array(String), granularity : Granularity, click_window_days : Int32? = nil, engagement_window_days : Int32? = nil, view_window_days : Int32? = nil, conversion_report_time : String? = nil, attribution_types : Array(ConversionReportAttributionType)? = nil, reporting_timezone : ReportingTimeZone? = nil)
      data, _status_code, _headers = ad_account_targeting_analytics_get_with_http_info(ad_account_id, start_date, end_date, targeting_types, columns, granularity, click_window_days, engagement_window_days, view_window_days, conversion_report_time, attribution_types, reporting_timezone)
      data
    end
    ...
    def ad_account_targeting_analytics_get_with_http_info(ad_account_id : String, start_date : Time, end_date : Time, targeting_types : Array(AdsAnalyticsTargetingType), columns : Array(String), granularity : Granularity, click_window_days : Int32? = nil, engagement_window_days : Int32? = nil, view_window_days : Int32? = nil, conversion_report_time : String? = nil, attribution_types : Array(ConversionReportAttributionType)? = nil, reporting_timezone : ReportingTimeZone? = nil)
      ...
      if @api_client.config.client_side_validation && attribution_types.nil? && attribution_types.size > 2
        raise ArgumentError.new("invalid value for \"attribution_types\" when calling AdAccountsApi.ad_account_targeting_analytics_get, number of items must be less than or equal to 2.")
      end
    ...
    # @return [AdAccount]
    def ad_accounts_create(ad_account_create : AdAccountCreate)
      data, _status_code, _headers = ad_accounts_create_with_http_info(ad_account_create)
      data
    end
    ...
    def ad_accounts_create_with_http_info(ad_account_create : AdAccountCreate)
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && ad_account_create.nil?
        raise ArgumentError.new("Missing the required parameter 'ad_account_create' when calling AdAccountsApi.ad_accounts_create")
      end
      # resource path
      ...
      # http body (model)
      post_body = ad_account_create.to_json
    ...
    def ad_accounts_list(include_shared_accounts : Bool? = nil, bookmark : String? = nil, page_size : Int32? = nil)
      data, _status_code, _headers = ad_accounts_list_with_http_info(include_shared_accounts, bookmark, page_size)
      data
    end
    ...
    def ad_accounts_list_with_http_info(include_shared_accounts : Bool? = nil, bookmark : String? = nil, page_size : Int32? = nil)
      if @api_client.config.debugging
    ...
    def analytics_create_conversion_product_report(ad_account_id : String, conversion_product_report_request : ConversionProductReportRequest)
      data, _status_code, _headers = analytics_create_conversion_product_report_with_http_info(ad_account_id, conversion_product_report_request)
      data
    end
    ...
    def analytics_create_conversion_product_report_with_http_info(ad_account_id : String, conversion_product_report_request : ConversionProductReportRequest)
      if @api_client.config.debugging
        Log.debug {"Calling API: AdAccountsApi.analytics_create_conversion_product_report ..."}
      end
      # verify the required parameter "ad_account_id" is set
      if @api_client.config.client_side_validation && ad_account_id.nil?
        raise ArgumentError.new("Missing the required parameter 'ad_account_id' when calling AdAccountsApi.analytics_create_conversion_product_report")
      end
      if @api_client.config.client_side_validation && ad_account_id.to_s.size > 18
        raise ArgumentError.new("invalid value for \"ad_account_id\" when calling AdAccountsApi.analytics_create_conversion_product_report, the character length must be smaller than or equal to 18.")
      end

      pattern = Regexp.new(/^\d+$/)
      if @api_client.config.client_side_validation && ad_account_id !~ pattern
        raise ArgumentError.new("invalid value for \"ad_account_id\" when calling AdAccountsApi.analytics_create_conversion_product_report, must conform to the pattern #{pattern}.")
      end
      ...
      if @api_client.config.client_side_validation && conversion_product_report_request.nil?
        raise ArgumentError.new("Missing the required parameter 'conversion_product_report_request' when calling AdAccountsApi.analytics_create_conversion_product_report")
      end
      # resource path
      local_var_path = "/ad_accounts/{ad_account_id}/reports/brand_category_sku".sub("{" + "ad_account_id" + "}", URI.encode_path(ad_account_id.to_s))
      ...
      # http body (model)
      post_body = conversion_product_report_request.to_json
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        local_var_path,
                                                        :"AdAccountsApi.analytics_create_conversion_product_report",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: AdAccountsApi#analytics_create_conversion_product_report\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
    ...
    def analytics_create_template_report(ad_account_id : String, template_id : String, start_date : Time? = nil, end_date : Time? = nil, granularity : Granularity? = nil)
    ...
    def analytics_create_template_report_with_http_info(ad_account_id : String, template_id : String, start_date : Time? = nil, end_date : Time? = nil, granularity : Granularity? = nil)
      if @api_client.config.debugging
      ...
      # return_type
      return_type = "TemplateBasedReport"
      ...
      return TemplateBasedReport.from_json(data), status_code, headers
    end
    ...
    def analytics_get_conversion_product_report(ad_account_id : String, token : String)
      data, _status_code, _headers = analytics_get_conversion_product_report_with_http_info(ad_account_id, token)
      data
    end
    ...
    def analytics_get_conversion_product_report_with_http_info(ad_account_id : String, token : String)
      if @api_client.config.debugging
        Log.debug {"Calling API: AdAccountsApi.analytics_get_conversion_product_report ..."}
      end
      # verify the required parameter "ad_account_id" is set
      if @api_client.config.client_side_validation && ad_account_id.nil?
        raise ArgumentError.new("Missing the required parameter 'ad_account_id' when calling AdAccountsApi.analytics_get_conversion_product_report")
      end
      if @api_client.config.client_side_validation && ad_account_id.to_s.size > 18
        raise ArgumentError.new("invalid value for \"ad_account_id\" when calling AdAccountsApi.analytics_get_conversion_product_report, the character length must be smaller than or equal to 18.")
      end

      pattern = Regexp.new(/^\d+$/)
      if @api_client.config.client_side_validation && ad_account_id !~ pattern
        raise ArgumentError.new("invalid value for \"ad_account_id\" when calling AdAccountsApi.analytics_get_conversion_product_report, must conform to the pattern #{pattern}.")
      end

      # verify the required parameter "token" is set
      if @api_client.config.client_side_validation && token.nil?
        raise ArgumentError.new("Missing the required parameter 'token' when calling AdAccountsApi.analytics_get_conversion_product_report")
      end
      # resource path
      local_var_path = "/ad_accounts/{ad_account_id}/reports/brand_category_sku".sub("{" + "ad_account_id" + "}", URI.encode_path(ad_account_id.to_s))
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        local_var_path,
                                                        :"AdAccountsApi.analytics_get_conversion_product_report",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: AdAccountsApi#analytics_get_conversion_product_report\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
    ...
    def templates_list(ad_account_id : String, page_size : Int32? = nil, order : String? = nil, bookmark : String? = nil)
    ...
    def templates_list_with_http_info(ad_account_id : String, page_size : Int32? = nil, order : String? = nil, bookmark : String? = nil)
      if @api_client.config.debugging
