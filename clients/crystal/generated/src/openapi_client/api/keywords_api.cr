...
module OpenAPIClient
  class KeywordsApi
    ...
    def country_keywords_metrics_get_with_http_info(ad_account_id : String, country_code : String, keywords : Array(String))
      ...
      query_params["keywords"] = @api_client.build_collection_param(keywords, :csv) unless keywords.nil?
    ...
    def keywords_get(ad_account_id : String, campaign_id : String? = nil, ad_group_id : String? = nil, ad_group_ids : Array(String)? = nil, match_types : Array(MatchType)? = nil, page_size : Int32? = nil, bookmark : String? = nil)
      data, _status_code, _headers = keywords_get_with_http_info(ad_account_id, campaign_id, ad_group_id, ad_group_ids, match_types, page_size, bookmark)
      data
    end
    ...
    def keywords_get_with_http_info(ad_account_id : String, campaign_id : String? = nil, ad_group_id : String? = nil, ad_group_ids : Array(String)? = nil, match_types : Array(MatchType)? = nil, page_size : Int32? = nil, bookmark : String? = nil)
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && ad_group_ids.nil? && ad_group_ids.size > 250
        raise ArgumentError.new("invalid value for \"ad_group_ids\" when calling KeywordsApi.keywords_get, number of items must be less than or equal to 250.")
      end

      if @api_client.config.client_side_validation && ad_group_ids.nil? && ad_group_ids.size < 1
        raise ArgumentError.new("invalid value for \"ad_group_ids\" when calling KeywordsApi.keywords_get, number of items must be greater than or equal to 1.")
      end
      ...
      query_params["match_types"] = @api_client.build_collection_param(match_types, :multi) unless match_types.nil?
    ...
    def trending_keywords_list(region : TrendsSupportedRegion, trend_type : TrendType, interests : Array(String)? = nil, genders : Array(String)? = nil, ages : Array(String)? = nil, include_keywords : Array(String)? = nil, normalize_against_group : Bool? = nil, limit : Int32? = nil, include_prediction : Bool? = nil, include_demographics : Bool? = nil)
      data, _status_code, _headers = trending_keywords_list_with_http_info(region, trend_type, interests, genders, ages, include_keywords, normalize_against_group, limit, include_prediction, include_demographics)
      data
    end
    ...
    def trending_keywords_list_with_http_info(region : TrendsSupportedRegion, trend_type : TrendType, interests : Array(String)? = nil, genders : Array(String)? = nil, ages : Array(String)? = nil, include_keywords : Array(String)? = nil, normalize_against_group : Bool? = nil, limit : Int32? = nil, include_prediction : Bool? = nil, include_demographics : Bool? = nil)
      if @api_client.config.debugging
      ...
      # query parameters
      query_params = Hash(String, String | Array(String)).new
      query_params["interests"] = @api_client.build_collection_param(interests, :multi) unless interests.nil?
      ...
      query_params["include_keywords"] = @api_client.build_collection_param(include_keywords, :multi) unless include_keywords.nil?
      ...
      query_params["include_prediction"] = include_prediction.to_s unless include_prediction.nil?
      query_params["include_demographics"] = include_demographics.to_s unless include_demographics.nil?
