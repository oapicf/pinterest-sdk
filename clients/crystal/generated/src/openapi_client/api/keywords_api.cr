...
module OpenAPIClient
  class KeywordsApi
    ...
    def keywords_get(ad_account_id : String, campaign_id : String? = nil, ad_group_id : String? = nil, match_types : Array(MatchType)? = nil, page_size : Int32? = nil, bookmark : String? = nil)
    ...
    def keywords_get_with_http_info(ad_account_id : String, campaign_id : String? = nil, ad_group_id : String? = nil, match_types : Array(MatchType)? = nil, page_size : Int32? = nil, bookmark : String? = nil)
      if @api_client.config.debugging
    ...
    def trending_keywords_list(region : TrendsSupportedRegion, trend_type : TrendType, interests : Array(String)? = nil, genders : Array(String)? = nil, ages : Array(String)? = nil, include_keywords : Array(String)? = nil, normalize_against_group : Bool? = nil, limit : Int32? = nil)
    ...
    def trending_keywords_list_with_http_info(region : TrendsSupportedRegion, trend_type : TrendType, interests : Array(String)? = nil, genders : Array(String)? = nil, ages : Array(String)? = nil, include_keywords : Array(String)? = nil, normalize_against_group : Bool? = nil, limit : Int32? = nil)
      if @api_client.config.debugging
