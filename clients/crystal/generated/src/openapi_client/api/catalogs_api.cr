...
module OpenAPIClient
  class CatalogsApi
    ...
    def items_get(country : String, language : String, ad_account_id : String? = nil, item_ids : Array(String)? = nil, filters : CatalogsItemsFilters? = nil)
    ...
    def items_get_with_http_info(country : String, language : String, ad_account_id : String? = nil, item_ids : Array(String)? = nil, filters : CatalogsItemsFilters? = nil)
      if @api_client.config.debugging
      ...
      query_params["item_ids"] = @api_client.build_collection_param(item_ids, :multi) unless item_ids.nil?
    ...
    def reports_stats(parameters : CatalogsReportParameters, ad_account_id : String? = nil, page_size : Int32? = nil, bookmark : String? = nil)
    ...
    def reports_stats_with_http_info(parameters : CatalogsReportParameters, ad_account_id : String? = nil, page_size : Int32? = nil, bookmark : String? = nil)
      if @api_client.config.debugging
