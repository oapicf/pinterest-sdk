...
module OpenAPIClient
  class CatalogsApi
    ...
    def catalogs_product_group_pins_list(product_group_id : String, bookmark : String?, page_size : Int32?, ad_account_id : String?)
      data, _status_code, _headers = catalogs_product_group_pins_list_with_http_info(product_group_id, bookmark, page_size, ad_account_id)
      data
    end
    ...
    def catalogs_product_group_pins_list_with_http_info(product_group_id : String, bookmark : String?, page_size : Int32?, ad_account_id : String?)
      if @api_client.config.debugging
    ...
    def catalogs_product_groups_create(catalogs_product_groups_create_request : CatalogsProductGroupsCreateRequest, ad_account_id : String?)
      data, _status_code, _headers = catalogs_product_groups_create_with_http_info(catalogs_product_groups_create_request, ad_account_id)
      data
    end
    ...
    # Create product group to use in Catalogs owned by the \&quot;operation user_account\&quot;. - By default, the \&quot;operation user_account\&quot; is the token user_account.  Optional: Business Access: Specify an &lt;code&gt;ad_account_id&lt;/code&gt; (obtained via &lt;a href&#x3D;&#39;/docs/api/v5/#operation/ad_accounts/list&#39;&gt;List ad accounts&lt;/a&gt;) to use the owner of that ad_account as the \&quot;operation user_account\&quot;. In order to do this, the token user_account must have one of the following &lt;a href&#x3D;\&quot;https://help.pinterest.com/en/business/article/share-and-manage-access-to-your-ad-accounts\&quot;&gt;Business Access&lt;/a&gt; roles on the ad_account: Owner, Admin, Catalogs Manager.  &lt;a href&#x3D;&#39;/docs/shopping/catalog/&#39;&gt;Learn more&lt;/a&gt;
    # @param catalogs_product_groups_create_request [CatalogsProductGroupsCreateRequest] Request object used to created a catalogs product group.
    # @return [Array<(CatalogsProductGroupsCreate201Response, Integer, Hash)>] CatalogsProductGroupsCreate201Response data, response status code and response headers
    def catalogs_product_groups_create_with_http_info(catalogs_product_groups_create_request : CatalogsProductGroupsCreateRequest, ad_account_id : String?)
      if @api_client.config.debugging
        Log.debug {"Calling API: CatalogsApi.catalogs_product_groups_create ..."}
      end
      # verify the required parameter "catalogs_product_groups_create_request" is set
      if @api_client.config.client_side_validation && catalogs_product_groups_create_request.nil?
        raise ArgumentError.new("Missing the required parameter 'catalogs_product_groups_create_request' when calling CatalogsApi.catalogs_product_groups_create")
      end
      if @api_client.config.client_side_validation && !ad_account_id.nil? && ad_account_id.to_s.size > 18
      ...
      # http body (model)
      post_body = catalogs_product_groups_create_request.to_json

      # return_type
      return_type = "CatalogsProductGroupsCreate201Response"
      ...
      return CatalogsProductGroupsCreate201Response.from_json(data), status_code, headers
    end
    ...
    def catalogs_product_groups_list(feed_id : String?, catalog_id : String?, bookmark : String?, page_size : Int32?, ad_account_id : String?)
      data, _status_code, _headers = catalogs_product_groups_list_with_http_info(feed_id, catalog_id, bookmark, page_size, ad_account_id)
      data
    end
    ...
    def catalogs_product_groups_list_with_http_info(feed_id : String?, catalog_id : String?, bookmark : String?, page_size : Int32?, ad_account_id : String?)
      if @api_client.config.debugging
    ...
    # Get a product counts for a given Catalogs Product Group owned by the \&quot;operation user_account\&quot;. - By default, the \&quot;operation user_account\&quot; is the token user_account.  Optional: Business Access: Specify an &lt;code&gt;ad_account_id&lt;/code&gt; (obtained via &lt;a href&#x3D;&#39;/docs/api/v5/#operation/ad_accounts/list&#39;&gt;List ad accounts&lt;/a&gt;) to use the owner of that ad_account as the \&quot;operation user_account\&quot;. In order to do this, the token user_account must have one of the following &lt;a href&#x3D;\&quot;https://help.pinterest.com/en/business/article/share-and-manage-access-to-your-ad-accounts\&quot;&gt;Business Access&lt;/a&gt; roles on the ad_account: Owner, Admin, Catalogs Manager.  &lt;a href&#x3D;&#39;/docs/shopping/catalog/&#39;&gt;Learn more&lt;/a&gt;
    # @param product_group_id [String] Unique identifier of a product group
    # @return [Array<(CatalogsProductGroupProductCounts, Integer, Hash)>] CatalogsProductGroupProductCounts data, response status code and response headers
    def catalogs_product_groups_product_counts_get_with_http_info(product_group_id : String, ad_account_id : String?)
      ...
      # return_type
      return_type = "CatalogsProductGroupProductCounts"
      ...
      return CatalogsProductGroupProductCounts.from_json(data), status_code, headers
    end
    ...
    # @param processing_result_id [String] Unique identifier of a feed processing result. It can be acquired from the \&quot;id\&quot; field of the \&quot;items\&quot; array within the response of the [List processing results for a given feed](https://developers.pinterest.com/docs/api/v5/#operation/feed_processing_results/list).
    ...
    # @return [CatalogsProductGroupPinsList200Response]
    def products_by_product_group_filter_list(catalogs_list_products_by_filter_request : CatalogsListProductsByFilterRequest, bookmark : String?, page_size : Int32?, ad_account_id : String?)
      data, _status_code, _headers = products_by_product_group_filter_list_with_http_info(catalogs_list_products_by_filter_request, bookmark, page_size, ad_account_id)
      data
    end
    ...
    # @param catalogs_list_products_by_filter_request [CatalogsListProductsByFilterRequest] Object holding a group of filters for a catalog product group
    # @return [Array<(CatalogsProductGroupPinsList200Response, Integer, Hash)>] CatalogsProductGroupPinsList200Response data, response status code and response headers
    def products_by_product_group_filter_list_with_http_info(catalogs_list_products_by_filter_request : CatalogsListProductsByFilterRequest, bookmark : String?, page_size : Int32?, ad_account_id : String?)
      if @api_client.config.debugging
