...
module OpenAPIClient
  class AdGroupsApi
    ...
    def ad_groups_analytics(ad_account_id : String, start_date : Time, end_date : Time, ad_group_ids : Array(String), columns : Array(String), granularity : Granularity, click_window_days : Int32? = nil, engagement_window_days : Int32? = nil, view_window_days : Int32? = nil, conversion_report_time : String? = nil, aggregate_report_rows : Bool? = nil, reporting_timezone : ReportingTimeZone? = nil)
      data, _status_code, _headers = ad_groups_analytics_with_http_info(ad_account_id, start_date, end_date, ad_group_ids, columns, granularity, click_window_days, engagement_window_days, view_window_days, conversion_report_time, aggregate_report_rows, reporting_timezone)
      data
    end
    ...
    def ad_groups_analytics_with_http_info(ad_account_id : String, start_date : Time, end_date : Time, ad_group_ids : Array(String), columns : Array(String), granularity : Granularity, click_window_days : Int32? = nil, engagement_window_days : Int32? = nil, view_window_days : Int32? = nil, conversion_report_time : String? = nil, aggregate_report_rows : Bool? = nil, reporting_timezone : ReportingTimeZone? = nil)
      ...
      if @api_client.config.client_side_validation && ad_group_ids.size > 250
        raise ArgumentError.new("invalid value for \"ad_group_ids\" when calling AdGroupsApi.ad_groups_analytics, number of items must be less than or equal to 250.")
      end
      ...
      query_params["ad_group_ids"] = @api_client.build_collection_param(ad_group_ids, :multi) unless ad_group_ids.nil?
    ...
    def ad_groups_audience_sizing_with_http_info(ad_account_id : String, ad_group_audience_sizing_request : AdGroupAudienceSizingRequest)
      ...
      if @api_client.config.client_side_validation && ad_group_audience_sizing_request.nil?
        raise ArgumentError.new("Missing the required parameter 'ad_group_audience_sizing_request' when calling AdGroupsApi.ad_groups_audience_sizing")
      end
      # resource path
    ...
    def ad_groups_list(ad_account_id : String, campaign_ids : Array(String)? = nil, ad_group_ids : Array(String)? = nil, entity_statuses : Array(String)? = nil, page_size : Int32? = nil, order : String? = nil, bookmark : String? = nil, translate_interests_to_names : Bool? = nil)
    ...
    def ad_groups_list_with_http_info(ad_account_id : String, campaign_ids : Array(String)? = nil, ad_group_ids : Array(String)? = nil, entity_statuses : Array(String)? = nil, page_size : Int32? = nil, order : String? = nil, bookmark : String? = nil, translate_interests_to_names : Bool? = nil)
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && campaign_ids.nil? && campaign_ids.size > 250
        raise ArgumentError.new("invalid value for \"campaign_ids\" when calling AdGroupsApi.ad_groups_list, number of items must be less than or equal to 250.")
      end
      ...
      if @api_client.config.client_side_validation && ad_group_ids.nil? && ad_group_ids.size > 250
        raise ArgumentError.new("invalid value for \"ad_group_ids\" when calling AdGroupsApi.ad_groups_list, number of items must be less than or equal to 250.")
      end
    ...
    def ad_groups_targeting_analytics_get(ad_account_id : String, ad_group_ids : Array(String), start_date : Time, end_date : Time, targeting_types : Array(AdsAnalyticsAdGroupTargetingType), columns : Array(String), granularity : Granularity, click_window_days : Int32? = nil, engagement_window_days : Int32? = nil, view_window_days : Int32? = nil, conversion_report_time : String? = nil, attribution_types : Array(ConversionReportAttributionType)? = nil, reporting_timezone : ReportingTimeZone? = nil)
      data, _status_code, _headers = ad_groups_targeting_analytics_get_with_http_info(ad_account_id, ad_group_ids, start_date, end_date, targeting_types, columns, granularity, click_window_days, engagement_window_days, view_window_days, conversion_report_time, attribution_types, reporting_timezone)
      data
    end
    ...
    def ad_groups_targeting_analytics_get_with_http_info(ad_account_id : String, ad_group_ids : Array(String), start_date : Time, end_date : Time, targeting_types : Array(AdsAnalyticsAdGroupTargetingType), columns : Array(String), granularity : Granularity, click_window_days : Int32? = nil, engagement_window_days : Int32? = nil, view_window_days : Int32? = nil, conversion_report_time : String? = nil, attribution_types : Array(ConversionReportAttributionType)? = nil, reporting_timezone : ReportingTimeZone? = nil)
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && ad_group_ids.size > 250
        raise ArgumentError.new("invalid value for \"ad_group_ids\" when calling AdGroupsApi.ad_groups_targeting_analytics_get, number of items must be less than or equal to 250.")
      end
      ...
      if @api_client.config.client_side_validation && targeting_types.size > 14
        raise ArgumentError.new("invalid value for \"targeting_types\" when calling AdGroupsApi.ad_groups_targeting_analytics_get, number of items must be less than or equal to 14.")
      end
      ...
      if @api_client.config.client_side_validation && attribution_types.nil? && attribution_types.size > 2
        raise ArgumentError.new("invalid value for \"attribution_types\" when calling AdGroupsApi.ad_groups_targeting_analytics_get, number of items must be less than or equal to 2.")
      end
