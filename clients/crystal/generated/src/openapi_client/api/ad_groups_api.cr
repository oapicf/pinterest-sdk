...
module OpenAPIClient
  class AdGroupsApi
    ...
    def ad_groups_analytics(ad_account_id : String, start_date : Time, end_date : Time, ad_group_ids : Array(String), columns : Array(String), granularity : Granularity, click_window_days : Int32? = nil, engagement_window_days : Int32? = nil, view_window_days : Int32? = nil, conversion_report_time : String? = nil)
    ...
    def ad_groups_analytics_with_http_info(ad_account_id : String, start_date : Time, end_date : Time, ad_group_ids : Array(String), columns : Array(String), granularity : Granularity, click_window_days : Int32? = nil, engagement_window_days : Int32? = nil, view_window_days : Int32? = nil, conversion_report_time : String? = nil)
    ...
    def ad_groups_audience_sizing(ad_account_id : String, ad_group_audience_sizing_request : AdGroupAudienceSizingRequest? = nil)
    ...
    def ad_groups_audience_sizing_with_http_info(ad_account_id : String, ad_group_audience_sizing_request : AdGroupAudienceSizingRequest? = nil)
      if @api_client.config.debugging
