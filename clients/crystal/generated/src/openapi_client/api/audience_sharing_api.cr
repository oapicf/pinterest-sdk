...
module OpenAPIClient
  class AudienceSharingApi
    ...
    def ad_accounts_audiences_shared_accounts_list(ad_account_id : String, audience_id : String, account_type : AudienceAccountType, page_size : Int32? = nil, bookmark : String? = nil)
    ...
    def ad_accounts_audiences_shared_accounts_list_with_http_info(ad_account_id : String, audience_id : String, account_type : AudienceAccountType, page_size : Int32? = nil, bookmark : String? = nil)
    ...
    # @param account_type [AudienceAccountType] Filter accounts by account type.
    # @return [AdAccountsAudiencesSharedAccountsList200Response]
    def business_account_audiences_shared_accounts_list(business_id : String, audience_id : String, account_type : AudienceAccountType, page_size : Int32? = nil, bookmark : String? = nil)
    ...
    # @param account_type [AudienceAccountType] Filter accounts by account type.
    # @return [Array<(AdAccountsAudiencesSharedAccountsList200Response, Integer, Hash)>] AdAccountsAudiencesSharedAccountsList200Response data, response status code and response headers
    def business_account_audiences_shared_accounts_list_with_http_info(business_id : String, audience_id : String, account_type : AudienceAccountType, page_size : Int32? = nil, bookmark : String? = nil)
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && business_id.to_s.size < 1
        raise ArgumentError.new("invalid value for \"business_id\" when calling AudienceSharingApi.business_account_audiences_shared_accounts_list, the character length must be greater than or equal to 1.")
      end
    ...
    def shared_audiences_for_business_list(business_id : String, bookmark : String? = nil, order : String? = nil, page_size : Int32? = nil)
    ...
    def shared_audiences_for_business_list_with_http_info(business_id : String, bookmark : String? = nil, order : String? = nil, page_size : Int32? = nil)
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && business_id.to_s.size < 1
        raise ArgumentError.new("invalid value for \"business_id\" when calling AudienceSharingApi.shared_audiences_for_business_list, the character length must be greater than or equal to 1.")
      end
    ...
    def update_business_to_ad_account_shared_audience_with_http_info(business_id : String, shared_audience : SharedAudience)
      ...
      if @api_client.config.client_side_validation && business_id.to_s.size < 1
        raise ArgumentError.new("invalid value for \"business_id\" when calling AudienceSharingApi.update_business_to_ad_account_shared_audience, the character length must be greater than or equal to 1.")
      end
    ...
    def update_business_to_business_shared_audience_with_http_info(business_id : String, business_shared_audience : BusinessSharedAudience)
      ...
      if @api_client.config.client_side_validation && business_id.to_s.size < 1
        raise ArgumentError.new("invalid value for \"business_id\" when calling AudienceSharingApi.update_business_to_business_shared_audience, the character length must be greater than or equal to 1.")
      end
