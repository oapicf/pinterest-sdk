...
module OpenAPIClient
  class IntegrationsApi
    ...
    # @param external_business_id [String] External business ID for the integration.
    # @return [IntegrationMetadata]
    def integrations_commerce_patch(external_business_id : String, integration_request_patch : IntegrationRequestPatch? = nil)
    ...
    # @param external_business_id [String] External business ID for the integration.
    # @return [Array<(IntegrationMetadata, Integer, Hash)>] IntegrationMetadata data, response status code and response headers
    def integrations_commerce_patch_with_http_info(external_business_id : String, integration_request_patch : IntegrationRequestPatch? = nil)
      if @api_client.config.debugging
    ...
    # @return [IntegrationMetadata]
    def integrations_commerce_post(integration_request : IntegrationRequest? = nil)
    ...
    # Create commerce integration metadata to link an external business ID with a Pinterest merchant &amp; ad account. Note: If you&#39;re interested in joining the beta, please reach out to your Pinterest account manager.
    # @return [Array<(IntegrationMetadata, Integer, Hash)>] IntegrationMetadata data, response status code and response headers
    def integrations_commerce_post_with_http_info(integration_request : IntegrationRequest? = nil)
      if @api_client.config.debugging
