  ...
  class IntegrationsApi
    ...
    def integrations_commerce_patch_with_http_info(external_business_id : String, integration_request_patch : IntegrationRequestPatch)
      ...
      if @api_client.config.client_side_validation && integration_request_patch.nil?
        raise ArgumentError.new("Missing the required parameter 'integration_request_patch' when calling IntegrationsApi.integrations_commerce_patch")
      end
      # resource path
      local_var_path = "/integrations/commerce/{external_business_id}".sub("{" + "external_business_id" + "}", URI.encode_path(external_business_id.to_s))
    ...
    def integrations_commerce_post_with_http_info(integration_request : IntegrationRequest)
      ...
      if @api_client.config.client_side_validation && integration_request.nil?
        raise ArgumentError.new("Missing the required parameter 'integration_request' when calling IntegrationsApi.integrations_commerce_post")
      end
      # resource path
    ...
    def integrations_get_list(bookmark : String? = nil, page_size : Int32? = nil)
    ...
    def integrations_get_list_with_http_info(bookmark : String? = nil, page_size : Int32? = nil)
      if @api_client.config.debugging
