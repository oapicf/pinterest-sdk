  ...
  class BusinessAccessInviteApi
    ...
    def asset_access_requests_create_with_http_info(business_id : String, create_asset_access_request_body : CreateAssetAccessRequestBody)
      ...
      if @api_client.config.client_side_validation && business_id.to_s.size < 1
        raise ArgumentError.new("invalid value for \"business_id\" when calling BusinessAccessInviteApi.asset_access_requests_create, the character length must be greater than or equal to 1.")
      end
    ...
    def cancel_invites_or_requests_with_http_info(business_id : String, cancel_invites_body : CancelInvitesBody)
      ...
      if @api_client.config.client_side_validation && business_id.to_s.size < 1
        raise ArgumentError.new("invalid value for \"business_id\" when calling BusinessAccessInviteApi.cancel_invites_or_requests, the character length must be greater than or equal to 1.")
      end
    ...
    def create_asset_invites_with_http_info(business_id : String, create_asset_invites_request : CreateAssetInvitesRequest)
      ...
      if @api_client.config.client_side_validation && business_id.to_s.size < 1
        raise ArgumentError.new("invalid value for \"business_id\" when calling BusinessAccessInviteApi.create_asset_invites, the character length must be greater than or equal to 1.")
      end
    ...
    def create_membership_or_partnership_invites_with_http_info(business_id : String, create_membership_or_partnership_invites_body : CreateMembershipOrPartnershipInvitesBody)
      ...
      if @api_client.config.client_side_validation && business_id.to_s.size < 1
        raise ArgumentError.new("invalid value for \"business_id\" when calling BusinessAccessInviteApi.create_membership_or_partnership_invites, the character length must be greater than or equal to 1.")
      end
    ...
    def get_invites(business_id : String, is_member : Bool? = nil, invite_status : Array(String)? = nil, invite_type : InviteType? = nil, bookmark : String? = nil, page_size : Int32? = nil)
    ...
    def get_invites_with_http_info(business_id : String, is_member : Bool? = nil, invite_status : Array(String)? = nil, invite_type : InviteType? = nil, bookmark : String? = nil, page_size : Int32? = nil)
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && business_id.to_s.size < 1
        raise ArgumentError.new("invalid value for \"business_id\" when calling BusinessAccessInviteApi.get_invites, the character length must be greater than or equal to 1.")
      end
      ...
      query_params["invite_status"] = @api_client.build_collection_param(invite_status, :multi) unless invite_status.nil?
