...
module OpenAPIClient
  class BillingApi
    ...
    def ads_credits_discounts_get(ad_account_id : String, bookmark : String? = nil, page_size : Int32? = nil)
    ...
    def ads_credits_discounts_get_with_http_info(ad_account_id : String, bookmark : String? = nil, page_size : Int32? = nil)
      if @api_client.config.debugging
    ...
    def billing_invoice_download_get(ad_account_id : String, billing_invoice_id : String)
      data, _status_code, _headers = billing_invoice_download_get_with_http_info(ad_account_id, billing_invoice_id)
      data
    end
    ...
    def billing_invoice_download_get_with_http_info(ad_account_id : String, billing_invoice_id : String)
      if @api_client.config.debugging
        Log.debug {"Calling API: BillingApi.billing_invoice_download_get ..."}
      end
      # verify the required parameter "ad_account_id" is set
      if @api_client.config.client_side_validation && ad_account_id.nil?
        raise ArgumentError.new("Missing the required parameter 'ad_account_id' when calling BillingApi.billing_invoice_download_get")
      end
      if @api_client.config.client_side_validation && ad_account_id.to_s.size > 18
        raise ArgumentError.new("invalid value for \"ad_account_id\" when calling BillingApi.billing_invoice_download_get, the character length must be smaller than or equal to 18.")
      end

      pattern = Regexp.new(/^\d+$/)
      if @api_client.config.client_side_validation && ad_account_id !~ pattern
        raise ArgumentError.new("invalid value for \"ad_account_id\" when calling BillingApi.billing_invoice_download_get, must conform to the pattern #{pattern}.")
      end
      ...
      if @api_client.config.client_side_validation && billing_invoice_id.nil?
        raise ArgumentError.new("Missing the required parameter 'billing_invoice_id' when calling BillingApi.billing_invoice_download_get")
      end
      if @api_client.config.client_side_validation && billing_invoice_id.to_s.size > 18
        raise ArgumentError.new("invalid value for \"billing_invoice_id\" when calling BillingApi.billing_invoice_download_get, the character length must be smaller than or equal to 18.")
      end

      pattern = Regexp.new(/^\d+$/)
      if @api_client.config.client_side_validation && billing_invoice_id !~ pattern
        raise ArgumentError.new("invalid value for \"billing_invoice_id\" when calling BillingApi.billing_invoice_download_get, must conform to the pattern #{pattern}.")
      end

      # resource path
      local_var_path = "/ad_accounts/{ad_account_id}/billing_invoice/{billing_invoice_id}/download".sub("{" + "ad_account_id" + "}", URI.encode_path(ad_account_id.to_s)).sub("{" + "billing_invoice_id" + "}", URI.encode_path(billing_invoice_id.to_s))
      ...
      # return_type
      return_type = "BillingInvoiceDownloadResponse"
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        local_var_path,
                                                        :"BillingApi.billing_invoice_download_get",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: BillingApi#billing_invoice_download_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return BillingInvoiceDownloadResponse.from_json(data), status_code, headers
    end
    ...
    def billing_invoices_get(ad_account_id : String, bookmark : String? = nil, page_size : Int32? = nil, sort : String? = nil, order : String? = nil, status : String? = nil, document_type : String? = nil, start_due_date : Time? = nil, end_due_date : Time? = nil)
      data, _status_code, _headers = billing_invoices_get_with_http_info(ad_account_id, bookmark, page_size, sort, order, status, document_type, start_due_date, end_due_date)
      data
    end
    ...
    def billing_invoices_get_with_http_info(ad_account_id : String, bookmark : String? = nil, page_size : Int32? = nil, sort : String? = nil, order : String? = nil, status : String? = nil, document_type : String? = nil, start_due_date : Time? = nil, end_due_date : Time? = nil)
      if @api_client.config.debugging
        Log.debug {"Calling API: BillingApi.billing_invoices_get ..."}
      end
      # verify the required parameter "ad_account_id" is set
      if @api_client.config.client_side_validation && ad_account_id.nil?
        raise ArgumentError.new("Missing the required parameter 'ad_account_id' when calling BillingApi.billing_invoices_get")
      end
      if @api_client.config.client_side_validation && ad_account_id.to_s.size > 18
        raise ArgumentError.new("invalid value for \"ad_account_id\" when calling BillingApi.billing_invoices_get, the character length must be smaller than or equal to 18.")
      end

      pattern = Regexp.new(/^\d+$/)
      if @api_client.config.client_side_validation && ad_account_id !~ pattern
        raise ArgumentError.new("invalid value for \"ad_account_id\" when calling BillingApi.billing_invoices_get, must conform to the pattern #{pattern}.")
      end

      if @api_client.config.client_side_validation && !page_size.nil? && page_size > 250
        raise ArgumentError.new("invalid value for \"page_size\" when calling BillingApi.billing_invoices_get, must be smaller than or equal to 250.")
      end

      if @api_client.config.client_side_validation && !page_size.nil? && page_size < 1
        raise ArgumentError.new("invalid value for \"page_size\" when calling BillingApi.billing_invoices_get, must be greater than or equal to 1.")
      end
      ...
      if @api_client.config.client_side_validation && document_type && !allowable_values.includes?(document_type)
        raise ArgumentError.new("invalid value for \"document_type\", must be one of #{allowable_values}")
      end
      pattern = Regexp.new(/^(\d{4})-(\d{2})-(\d{2})$/)
      if @api_client.config.client_side_validation && start_due_date.nil? && start_due_date !~ pattern
        raise ArgumentError.new("invalid value for \"start_due_date\" when calling BillingApi.billing_invoices_get, must conform to the pattern #{pattern}.")
      end

      pattern = Regexp.new(/^(\d{4})-(\d{2})-(\d{2})$/)
      if @api_client.config.client_side_validation && end_due_date.nil? && end_due_date !~ pattern
        raise ArgumentError.new("invalid value for \"end_due_date\" when calling BillingApi.billing_invoices_get, must conform to the pattern #{pattern}.")
      end

      # resource path
      local_var_path = "/ad_accounts/{ad_account_id}/billing_invoices".sub("{" + "ad_account_id" + "}", URI.encode_path(ad_account_id.to_s))
      ...
      query_params["document_type"] = document_type.to_s unless document_type.nil?
      query_params["start_due_date"] = start_due_date.to_s unless start_due_date.nil?
      query_params["end_due_date"] = end_due_date.to_s unless end_due_date.nil?
      ...
      # return_type
      return_type = "BillingInvoicesGet200Response"
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        local_var_path,
                                                        :"BillingApi.billing_invoices_get",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: BillingApi#billing_invoices_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return BillingInvoicesGet200Response.from_json(data), status_code, headers
    end
    ...
    def billing_profiles_get(ad_account_id : String, is_active : Bool, bookmark : String? = nil, page_size : Int32? = nil)
    ...
    def billing_profiles_get_with_http_info(ad_account_id : String, is_active : Bool, bookmark : String? = nil, page_size : Int32? = nil)
      if @api_client.config.debugging
    ...
    def ssio_insertion_orders_status_get_by_ad_account(ad_account_id : String, bookmark : String? = nil, page_size : Int32? = nil)
    ...
    def ssio_insertion_orders_status_get_by_ad_account_with_http_info(ad_account_id : String, bookmark : String? = nil, page_size : Int32? = nil)
      if @api_client.config.debugging
    ...
    def ssio_order_lines_get_by_ad_account(ad_account_id : String, bookmark : String? = nil, page_size : Int32? = nil, pin_order_id : String? = nil)
    ...
    def ssio_order_lines_get_by_ad_account_with_http_info(ad_account_id : String, bookmark : String? = nil, page_size : Int32? = nil, pin_order_id : String? = nil)
      if @api_client.config.debugging
