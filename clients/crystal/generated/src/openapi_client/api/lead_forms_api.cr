...
module OpenAPIClient
  class LeadFormsApi
    ...
    def lead_forms_list(ad_account_id : String, page_size : Int32? = nil, order : String? = nil, bookmark : String? = nil)
    ...
    def lead_forms_list_with_http_info(ad_account_id : String, page_size : Int32? = nil, order : String? = nil, bookmark : String? = nil)
      if @api_client.config.debugging
