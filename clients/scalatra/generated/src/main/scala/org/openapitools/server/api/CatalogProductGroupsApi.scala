...
class CatalogProductGroupsApi(implicit val swagger: Swagger) extends ScalatraServlet
  ...
  val catalogsProductGroupPinsListOperation = (apiOperation[CatalogsProductGroupPinsList200Response]("catalogsProductGroupPinsList")
    ...
    parameters(pathParam[String]("productGroupId").description(""), queryParam[String]("adAccountId").description("").optional, queryParam[Boolean]("pinMetrics").description("").optional.defaultValue(false), queryParam[String]("bookmark").description("").optional, queryParam[Int]("pageSize").description("").optional.defaultValue(25))
  )
  ...
  val catalogsProductGroupsCreateOperation = (apiOperation[CatalogsVerticalProductGroup]("catalogsProductGroupsCreate")
    ...
    parameters(bodyParam[CatalogsProductGroupsCreateRequestSchema]("catalogsProductGroupsCreateRequestSchema").description(""), queryParam[String]("adAccountId").description("").optional)
  )

  post("/catalogs/product_groups", operation(catalogsProductGroupsCreateOperation)) {
    //println("catalogsProductGroupsCreateRequestSchema: " + catalogsProductGroupsCreateRequestSchema)
            val adAccountId = params.getAs[String]("adAccountId")
  ...
  val catalogsProductGroupsCreateManyOperation = (apiOperation[List[String]]("catalogsProductGroupsCreateMany")
    ...
    parameters(bodyParam[List[CatalogsProductGroupsCreateManyRequestItems]]("catalogsProductGroupsCreateManyRequestItems").description(""), queryParam[String]("adAccountId").description("").optional)
  )

  post("/catalogs/product_groups/multiple", operation(catalogsProductGroupsCreateManyOperation)) {
    //println("catalogsProductGroupsCreateManyRequestItems: " + catalogsProductGroupsCreateManyRequestItems)
            val adAccountId = params.getAs[String]("adAccountId")
  ...
  val catalogsProductGroupsDeleteOperation = (apiOperation[CatalogsVerticalProductGroup]("catalogsProductGroupsDelete")
  ...
  val catalogsProductGroupsUpdateOperation = (apiOperation[CatalogsVerticalProductGroup]("catalogsProductGroupsUpdate")
    ...
    parameters(pathParam[String]("productGroupId").description(""), bodyParam[CatalogsProductGroupsUpdateRequestSchema]("catalogsProductGroupsUpdateRequestSchema").description(""), queryParam[String]("adAccountId").description("").optional)
  )

  patch("/catalogs/product_groups/:product_group_id", operation(catalogsProductGroupsUpdateOperation)) {
    val productGroupId = params.getOrElse("productGroupId", halt(400))
    //println("productGroupId: " + productGroupId)
    //println("catalogsProductGroupsUpdateRequestSchema: " + catalogsProductGroupsUpdateRequestSchema)
            val adAccountId = params.getAs[String]("adAccountId")
