...
class CatalogsApi(implicit val swagger: Swagger) extends ScalatraServlet
  ...
  val catalogsProductGroupPinsListOperation = (apiOperation[CatalogsProductGroupPinsList200Response]("catalogsProductGroupPinsList")
    ...
    parameters(pathParam[String]("productGroupId").description(""), queryParam[String]("bookmark").description("").optional, queryParam[Int]("pageSize").description("").optional.defaultValue(25), queryParam[String]("adAccountId").description("").optional)
  )
  ...
  val catalogsProductGroupsCreateOperation = (apiOperation[CatalogsProductGroupsCreate201Response]("catalogsProductGroupsCreate")
    summary "Create product group"
    parameters(bodyParam[CatalogsProductGroupsCreateRequest]("catalogsProductGroupsCreateRequest").description(""), queryParam[String]("adAccountId").description("").optional)
  )

  post("/catalogs/product_groups", operation(catalogsProductGroupsCreateOperation)) {
    //println("catalogsProductGroupsCreateRequest: " + catalogsProductGroupsCreateRequest)
            val adAccountId = params.getAs[String]("adAccountId")
  ...
  val catalogsProductGroupsGetOperation = (apiOperation[CatalogsProductGroupsCreate201Response]("catalogsProductGroupsGet")
  ...
  val catalogsProductGroupsListOperation = (apiOperation[CatalogsProductGroupsList200Response]("catalogsProductGroupsList")
    ...
    parameters(queryParam[String]("feedId").description("").optional, queryParam[String]("catalogId").description("").optional, queryParam[String]("bookmark").description("").optional, queryParam[Int]("pageSize").description("").optional.defaultValue(25), queryParam[String]("adAccountId").description("").optional)
  )
  ...
  val catalogsProductGroupsProductCountsGetOperation = (apiOperation[CatalogsProductGroupProductCounts]("catalogsProductGroupsProductCountsGet")
  ...
  val catalogsProductGroupsUpdateOperation = (apiOperation[CatalogsProductGroupsCreate201Response]("catalogsProductGroupsUpdate")
  ...
  val productsByProductGroupFilterListOperation = (apiOperation[CatalogsProductGroupPinsList200Response]("productsByProductGroupFilterList")
    ...
    parameters(bodyParam[CatalogsListProductsByFilterRequest]("catalogsListProductsByFilterRequest").description(""), queryParam[String]("bookmark").description("").optional, queryParam[Int]("pageSize").description("").optional.defaultValue(25), queryParam[String]("adAccountId").description("").optional)
  )
