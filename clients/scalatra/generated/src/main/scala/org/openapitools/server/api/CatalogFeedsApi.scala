...
class CatalogFeedsApi(implicit val swagger: Swagger) extends ScalatraServlet
  ...
  val feedProcessingResultsListOperation = (apiOperation[FeedProcessingResultsList200Response]("feedProcessingResultsList")
    ...
    parameters(pathParam[String]("feedId").description(""), queryParam[String]("adAccountId").description("").optional, queryParam[String]("bookmark").description("").optional, queryParam[Int]("pageSize").description("").optional.defaultValue(25))
  )
  ...
  val feedsCreateOperation = (apiOperation[CatalogsFeed]("feedsCreate")
    summary "Create feed"
    parameters(bodyParam[CatalogsFeedCreateRequestSchema]("catalogsFeedCreateRequestSchema").description(""), queryParam[String]("adAccountId").description("").optional)
  )

  post("/catalogs/feeds", operation(feedsCreateOperation)) {
    //println("catalogsFeedCreateRequestSchema: " + catalogsFeedCreateRequestSchema)
            val adAccountId = params.getAs[String]("adAccountId")
  ...
  val feedsDeleteOperation = (apiOperation[CatalogsFeed]("feedsDelete")
    summary "Delete feed"
  ...
  val feedsListOperation = (apiOperation[FeedsList200Response]("feedsList")
    summary "List feeds"
    parameters(queryParam[String]("catalogId").description("").optional, queryParam[String]("adAccountId").description("").optional, queryParam[String]("bookmark").description("").optional, queryParam[Int]("pageSize").description("").optional.defaultValue(25))
  )
  ...
  val feedsUpdateOperation = (apiOperation[CatalogsFeed]("feedsUpdate")
    summary "Update feed"
    parameters(pathParam[String]("feedId").description(""), bodyParam[CatalogsFeedUpdateRequestSchema]("catalogsFeedUpdateRequestSchema").description(""), queryParam[String]("adAccountId").description("").optional)
  )

  patch("/catalogs/feeds/:feed_id", operation(feedsUpdateOperation)) {
    val feedId = params.getOrElse("feedId", halt(400))
    //println("feedId: " + feedId)
    //println("catalogsFeedUpdateRequestSchema: " + catalogsFeedUpdateRequestSchema)
            val adAccountId = params.getAs[String]("adAccountId")
