...
class AdAccountsApi(implicit val swagger: Swagger) extends ScalatraServlet
  ...
  val analyticsCreateConversionProductReportOperation = (apiOperation[AdsAnalyticsCreateAsyncResponse]("analyticsCreateConversionProductReport")
    summary "Create a request for a brand, category, SKU report"
    parameters(pathParam[String]("adAccountId").description(""), bodyParam[ConversionProductReportRequest]("conversionProductReportRequest").description(""))
  )

  post("/ad_accounts/:ad_account_id/reports/brand_category_sku", operation(analyticsCreateConversionProductReportOperation)) {
    val adAccountId = params.getOrElse("adAccountId", halt(400))
    //println("adAccountId: " + adAccountId)
    //println("conversionProductReportRequest: " + conversionProductReportRequest)
  }
  ...
  val analyticsGetConversionProductReportOperation = (apiOperation[AdsAnalyticsGetAsyncResponse]("analyticsGetConversionProductReport")
