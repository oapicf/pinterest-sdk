...
class UserAccountApi(implicit val swagger: Swagger) extends ScalatraServlet
  ...
  val boardsUserFollowsListOperation = (apiOperation[BoardsList200Response]("boardsUserFollowsList")
    summary "List following boards"
    parameters(queryParam[String]("adAccountId").description("").optional, queryParam[Boolean]("explicitFollowing").description("").optional.defaultValue(false), queryParam[String]("bookmark").description("").optional, queryParam[Int]("pageSize").description("").optional.defaultValue(25))
  )
  ...
  val followUserUpdateOperation = (apiOperation[FollowUser]("followUserUpdate")
    summary "Follow user"
    parameters(pathParam[String]("username").description(""), bodyParam[FollowUserCreate]("followUserCreate").description(""))
  )
  ...
  post("/user_account/following/:username", operation(followUserUpdateOperation)) {
    ...
    //println("followUserCreate: " + followUserCreate)
  }
  ...
  val unverifyWebsiteDeleteOperation = (apiOperation[UserWebsite]("unverifyWebsiteDelete")
  ...
  val userAccountAnalyticsTopPinsOperation = (apiOperation[TopPinsAnalyticsResponse]("userAccountAnalyticsTopPins")
    ...
    parameters(queryParam[LocalDate]("startDate").description(""), queryParam[LocalDate]("endDate").description(""), queryParam[TopPinsSortBy]("sortBy").description(""), queryParam[String]("fromClaimedContent").description("").optional.defaultValue(BOTH), queryParam[String]("pinFormat").description("").optional.defaultValue(ALL), queryParam[String]("appTypes").description("").optional.defaultValue(ALL), queryParam[String]("contentType").description("").optional.defaultValue(ALL), queryParam[String]("source").description("").optional.defaultValue(ALL), queryParam[List[QuerymetrictypesItems]]("metricTypes").description("").optional.defaultValue(List.empty[QuerymetrictypesItems] ), queryParam[Int]("numOfPins").description("").optional.defaultValue(10), queryParam[Double]("createdInLastNDays").description("").optional, queryParam[String]("adAccountId").description("").optional)
  )
  ...
  get("/user_account/analytics/top_pins", operation(userAccountAnalyticsTopPinsOperation)) {
    ...
    //println("endDate: " + endDate)
            val sortBy = params.getAs[TopPinsSortBy]("sortBy")
    ...
    //println("numOfPins: " + numOfPins)
            val createdInLastNDays = params.getAs[Double]("createdInLastNDays")
  ...
  val userAccountAnalyticsTopVideoPinsOperation = (apiOperation[TopVideoPinsAnalyticsResponse]("userAccountAnalyticsTopVideoPins")
    ...
    parameters(queryParam[LocalDate]("startDate").description(""), queryParam[LocalDate]("endDate").description(""), queryParam[TopVideoPinsSortBy]("sortBy").description(""), queryParam[String]("fromClaimedContent").description("").optional.defaultValue(BOTH), queryParam[String]("pinFormat").description("").optional.defaultValue(ALL), queryParam[String]("appTypes").description("").optional.defaultValue(ALL), queryParam[String]("contentType").description("").optional.defaultValue(ALL), queryParam[String]("source").description("").optional.defaultValue(ALL), queryParam[List[QueryvideopinmetrictypesItems]]("metricTypes").description("").optional.defaultValue(List.empty[QueryvideopinmetrictypesItems] ), queryParam[Int]("numOfPins").description("").optional.defaultValue(10), queryParam[Double]("createdInLastNDays").description("").optional, queryParam[String]("adAccountId").description("").optional)
  )
  ...
  get("/user_account/analytics/top_video_pins", operation(userAccountAnalyticsTopVideoPinsOperation)) {
    ...
    //println("endDate: " + endDate)
            val sortBy = params.getAs[TopVideoPinsSortBy]("sortBy")
  ...
  val userFollowingGetOperation = (apiOperation[FollowersList200Response]("userFollowingGet")
    summary "List following"
    parameters(queryParam[String]("adAccountId").description("").optional, queryParam[Boolean]("explicitFollowing").description("").optional.defaultValue(false), queryParam[UserFollowingFeedType]("feedType").description("").optional, queryParam[String]("bookmark").description("").optional, queryParam[Int]("pageSize").description("").optional.defaultValue(25))
  )
  ...
  val verifyWebsiteUpdateOperation = (apiOperation[UserWebsite]("verifyWebsiteUpdate")
    summary "Verify website"
    parameters(bodyParam[UserWebsiteCreate]("userWebsiteCreate").description(""), queryParam[String]("adAccountId").description("").optional)
  )

  post("/user_account/websites", operation(verifyWebsiteUpdateOperation)) {
    //println("userWebsiteCreate: " + userWebsiteCreate)
            val adAccountId = params.getAs[String]("adAccountId")
  ...
  val websiteVerificationGetOperation = (apiOperation[UserWebsiteVerification]("websiteVerificationGet")
