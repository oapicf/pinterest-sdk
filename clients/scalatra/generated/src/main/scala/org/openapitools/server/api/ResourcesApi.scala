...
class ResourcesApi(implicit val swagger: Swagger) extends ScalatraServlet
  ...
  val targetingOptionsGetOperation = (apiOperation[List[Any]]("targetingOptionsGet")
    ...
    parameters(pathParam[String]("targetingType").description(""), queryParam[String]("clientId").description("").optional, queryParam[String]("oauthSignature").description("").optional, queryParam[String]("timestamp").description("").optional, queryParam[String]("adAccountId").description("").optional)
  )
