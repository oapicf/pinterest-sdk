...
class SearchApi(implicit val swagger: Swagger) extends ScalatraServlet
  ...
  val searchUserBoardsGetOperation = (apiOperation[BoardsList200Response]("searchUserBoardsGet")
    summary "Search user's boards"
    parameters(queryParam[String]("adAccountId").description("").optional, queryParam[String]("query").description("").optional, queryParam[String]("bookmark").description("").optional, queryParam[Int]("pageSize").description("").optional.defaultValue(25))
  )
