...
class AudiencesApi(implicit val swagger: Swagger) extends ScalatraServlet
  ...
  val audiencesUpdateOperation = (apiOperation[Audience]("audiencesUpdate")
    ...
    parameters(pathParam[String]("adAccountId").description(""), pathParam[String]("audienceId").description(""), bodyParam[AudienceUpdateRequest]("audienceUpdateRequest").description(""))
  )
