...
class ConversionTagsApi(implicit val swagger: Swagger) extends ScalatraServlet
  ...
  val conversionTagsCreateOperation = (apiOperation[ConversionTag]("conversionTagsCreate")
  ...
  val conversionTagsGetOperation = (apiOperation[ConversionTag]("conversionTagsGet")
  ...
  val conversionTagsListOperation = (apiOperation[ConversionTagsList200Response]("conversionTagsList")
