...
class CatalogReportsApi(implicit val swagger: Swagger) extends ScalatraServlet
  ...
  val reportsStatsOperation = (apiOperation[ReportsStats200Response]("reportsStats")
    ...
    parameters(queryParam[ReportsStatsParametersParameter]("parameters").description(""), queryParam[String]("adAccountId").description("").optional, queryParam[Int]("pageSize").description("").optional.defaultValue(25), queryParam[String]("bookmark").description("").optional)
  )

  get("/catalogs/reports/stats", operation(reportsStatsOperation)) {
            val parameters = params.getAs[ReportsStatsParametersParameter]("parameters")
