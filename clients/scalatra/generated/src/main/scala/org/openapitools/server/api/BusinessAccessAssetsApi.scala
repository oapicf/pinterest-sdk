...
class BusinessAccessAssetsApi(implicit val swagger: Swagger) extends ScalatraServlet
  ...
  val businessAssetMembersGetOperation = (apiOperation[BusinessAssetMembersGet200Response]("businessAssetMembersGet")
    ...
    parameters(pathParam[String]("businessId").description(""), pathParam[String]("assetId").description(""), queryParam[Boolean]("fetchSystemUsers").description("").optional.defaultValue(false), queryParam[String]("bookmark").description("").optional, queryParam[Int]("pageSize").description("").optional.defaultValue(25), queryParam[Int]("startIndex").description("").optional.defaultValue(0))
  )
