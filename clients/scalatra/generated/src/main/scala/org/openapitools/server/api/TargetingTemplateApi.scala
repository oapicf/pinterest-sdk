...
class TargetingTemplateApi(implicit val swagger: Swagger) extends ScalatraServlet
  ...
  val targetingTemplateCreateOperation = (apiOperation[TargetingTemplate]("targetingTemplateCreate")
  ...
  val targetingTemplateUpdateOperation = (apiOperation[Unit]("targetingTemplateUpdate")
    ...
    parameters(pathParam[String]("adAccountId").description(""), bodyParam[TargetingTemplateUpdateRequestReadOrUpdate]("targetingTemplateUpdateRequestReadOrUpdate").description(""))
  )

  patch("/ad_accounts/:ad_account_id/targeting_templates", operation(targetingTemplateUpdateOperation)) {
    val adAccountId = params.getOrElse("adAccountId", halt(400))
    //println("adAccountId: " + adAccountId)
    //println("targetingTemplateUpdateRequestReadOrUpdate: " + targetingTemplateUpdateRequestReadOrUpdate)
  }
