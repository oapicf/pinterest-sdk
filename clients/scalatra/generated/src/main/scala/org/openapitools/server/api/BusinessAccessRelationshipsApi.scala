...
class BusinessAccessRelationshipsApi(implicit val swagger: Swagger) extends ScalatraServlet
  ...
  val brandAccountsCreateOperation = (apiOperation[BrandAccountsCreate200Response]("brandAccountsCreate")
    summary "Create a Brand Account"
    parameters(pathParam[String]("businessHierarchyId").description(""), bodyParam[BrandAccountsCreateRequest]("brandAccountsCreateRequest").description(""))
  )
  ...
  post("/business_access/business_hierarchy/:business_hierarchy_id/brand_accounts", operation(brandAccountsCreateOperation)) {
    ...
    //println("brandAccountsCreateRequest: " + brandAccountsCreateRequest)
  }

  

  val brandAccountsUpdateOperation = (apiOperation[BrandAccountsCreate200Response]("brandAccountsUpdate")
    summary "Update a Brand Account"
    parameters(pathParam[String]("businessHierarchyId").description(""), pathParam[String]("brandAccountId").description(""), bodyParam[BrandAccountsUpdateRequest]("brandAccountsUpdateRequest").description(""))
  )
  ...
  patch("/business_access/business_hierarchy/:business_hierarchy_id/brand_accounts/:brand_account_id", operation(brandAccountsUpdateOperation)) {
    ...
    //println("brandAccountsUpdateRequest: " + brandAccountsUpdateRequest)
  }
  ...
  val systemUserUpdateOperation = (apiOperation[Unit]("systemUserUpdate")
    ...
    parameters(pathParam[String]("businessId").description(""), pathParam[String]("systemUserId").description(""), bodyParam[SystemUserUpdateRequest]("systemUserUpdateRequest").description(""))
  )
  ...
  patch("/businesses/:business_id/system_users/:system_user_id", operation(systemUserUpdateOperation)) {
    ...
    //println("systemUserUpdateRequest: " + systemUserUpdateRequest)
  }
