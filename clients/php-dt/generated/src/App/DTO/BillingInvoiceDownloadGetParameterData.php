...
/**
 * Parameters for billingInvoiceDownloadGet
 */
class BillingInvoiceDownloadGetParameterData
{
    /**
     * Unique identifier of a billing invoice.
     * @DTA\Data(subset="path", field="billing_invoice_id")
     ...
     */
    public ?string $billing_invoice_id = null;
