...
/**
 * Parameters for schedulesList
 */
class SchedulesListParameterData
{
    /**
     ...
     * @DTA\Data(subset="query", field="schedule_type", nullable=true)
     * @DTA\Strategy(subset="query", name="QueryStringScalar", options={"type":"string"})
     * @DTA\Validator(subset="query", name="QueryStringScalar", options={"type":"string"})
     */
     ...
     * @DTA\Data(subset="query", field="schedule_statuses", nullable=true)
     ...
     */
    public ?array $schedule_statuses = null;

    /**
     * List of Entity IDs, must be associated with the Ad Accound ID provided in the path.
     * @DTA\Data(subset="query", field="entity_ids")
     * @DTA\Strategy(subset="query", name="QueryStringScalarArray", options={"type":"string", "format":"multi"})
     * @DTA\Validator(subset="query", name="QueryStringScalarArray", options={"type":"string", "format":"multi", "min_items":1})
     */
    public ?array $entity_ids = null;
