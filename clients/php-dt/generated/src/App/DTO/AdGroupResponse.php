...
class AdGroupResponse
{
     ...
     * @DTA\Validator(name="Scalar", options={"type":"string"})
     */
    public ?string $conversion_learning_mode_type = null;

    /**
     * Ad group summary status.
     * @DTA\Data(field="summary_status", nullable=true)
     * @DTA\Strategy(name="Object", options={"type":\App\DTO\AdGroupSummaryStatus::class})
     * @DTA\Validator(name="TypeCompliant", options={"type":\App\DTO\AdGroupSummaryStatus::class})
     */
    public ?\App\DTO\AdGroupSummaryStatus $summary_status = null;
