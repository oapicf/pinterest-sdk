...
/**
 * Parameters for ad_accounts_catalogs_product_groups/list
 */
class AdAccountsCatalogsProductGroupsListParameterData
{
    /**
     * The feed profile id whose catalog product groups we want to return.
     * @DTA\Data(subset="query", field="feed_profile_id", nullable=true)
