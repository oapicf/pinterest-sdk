...
class CatalogsHotelProductGroup
{
    ...
    /**
     * @DTA\Data(field="type")
     * @DTA\Strategy(name="Object", options={"type":\App\DTO\CatalogsHotelProductGroupType::class})
     * @DTA\Validator(name="TypeCompliant", options={"type":\App\DTO\CatalogsHotelProductGroupType::class})
     */
    public ?\App\DTO\CatalogsHotelProductGroupType $type = null;
