...
/**
 * Parameters for ssio_order_lines/get_by_ad_account
 */
class SsioOrderLinesGetByAdAccountParameterData
{
    /**
     ...
     * @DTA\Data(subset="query", field="pin_order_id", nullable=true)
     * @DTA\Strategy(subset="query", name="QueryStringScalar", options={"type":"string"})
     * @DTA\Validator(subset="query", name="QueryStringScalar", options={"type":"string"})
     */
