...
/**
 * Parameters for product_group_promotions/get
 */
class ProductGroupPromotionsGetParameterData
{
    /**
     * Unique identifier of a product group promotion
     * @DTA\Data(subset="path", field="product_group_promotion_id")
     ...
     */
    public ?string $product_group_promotion_id = null;
