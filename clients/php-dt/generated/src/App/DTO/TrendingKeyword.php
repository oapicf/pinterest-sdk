...
class TrendingKeyword
{
     ...
     * @DTA\Strategy(name="Object", options={"type":\App\DTO\TrendingKeywordDemographics::class})
     * @DTA\Validator(name="TypeCompliant", options={"type":\App\DTO\TrendingKeywordDemographics::class})
     */
    public ?\App\DTO\TrendingKeywordDemographics $demographics = null;
     ...
     * @DTA\Data(field="has_prediction", nullable=true)
     ...
     * @DTA\Strategy(name="Object", options={"type":\App\DTO\PredictedTimeSeries::class})
     * @DTA\Validator(name="TypeCompliant", options={"type":\App\DTO\PredictedTimeSeries::class})
     */
    public ?\App\DTO\PredictedTimeSeries $predicted_time_series = null;
     ...
     * @DTA\Strategy(name="Object", options={"type":\App\DTO\TimeSeries::class})
     * @DTA\Validator(name="TypeCompliant", options={"type":\App\DTO\TimeSeries::class})
     */
    public ?\App\DTO\TimeSeries $time_series = null;
