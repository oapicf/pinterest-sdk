...
/**
 * Parameters for userAccountAnalyticsTopVideoPins
 */
class UserAccountAnalyticsTopVideoPinsParameterData
{
    /**
     ...
     * TODO add validator(s) and strategy for list of \App\DTO\QueryvideopinmetrictypesItems::class and collection format csv inside query string
     */
     ...
     */
    public ?float $created_in_last_n_days = null;
