...
class Audience
{
     ...
     * @DTA\Strategy(name="Object", options={"type":\App\DTO\PinnerListType::class})
     * @DTA\Validator(name="TypeCompliant", options={"type":\App\DTO\PinnerListType::class})
     */
    public ?\App\DTO\PinnerListType $audience_type = null;
