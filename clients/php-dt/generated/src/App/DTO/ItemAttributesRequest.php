...
class ItemAttributesRequest
{
     ...
     * @DTA\Strategy(name="Object", options={"type":\App\DTO\ItemAttributesRequestImageLink::class})
     * @DTA\Validator(name="TypeCompliant", options={"type":\App\DTO\ItemAttributesRequestImageLink::class})
     */
    public ?\App\DTO\ItemAttributesRequestImageLink $image_link = null;
     ...
     * @DTA\Data(field="save_pin_disabled", nullable=true)
     * @DTA\Validator(name="Scalar", options={"type":"bool"})
     */
    public ?bool $save_pin_disabled = null;
