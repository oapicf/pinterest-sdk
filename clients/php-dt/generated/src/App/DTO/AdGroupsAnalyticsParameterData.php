...
/**
 * Parameters for adGroupsAnalytics
 */
class AdGroupsAnalyticsParameterData
{
    /**
     ...
     * @DTA\Data(subset="query", field="aggregate_report_rows", nullable=true)
     ...
     */
    public ?bool $aggregate_report_rows = null;
