...
class AdsAnalyticsMetricsFilter
{
     ...
     * @DTA\Strategy(name="Object", options={"type":\App\DTO\Collection280::class})
     * @DTA\Validator(name="TypeCompliant", options={"type":\App\DTO\Collection280::class})
     */
    public ?\App\DTO\Collection280 $values = null;
