...
class LeadFormQuestion
{
     ...
     * @DTA\Strategy(name="Object", options={"type":\App\DTO\Collection228::class})
     * @DTA\Validator(name="TypeCompliant", options={"type":\App\DTO\Collection228::class})
     */
    public ?\App\DTO\Collection228 $custom_question_options = null;
