...
/**
 * Parameters for adAccountsAudiencesSharedAccountsList
 */
class AdAccountsAudiencesSharedAccountsListParameterData
{
    /**
     ...
     * @DTA\Data(subset="query", field="account_type")
     * @DTA\Strategy(subset="query", name="QueryStringScalar", options={"type":"string"})
     * @DTA\Validator(subset="query", name="QueryStringScalar", options={"type":"string"})
     */
     ...
     * @DTA\Data(subset="query", field="audience_id")
     * @DTA\Strategy(subset="query", name="QueryStringScalar", options={"type":"string"})
     * @DTA\Validator(subset="query", name="QueryStringScalar", options={"type":"string"})
