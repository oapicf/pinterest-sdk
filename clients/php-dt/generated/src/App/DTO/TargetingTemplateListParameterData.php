...
/**
 * Parameters for targetingTemplateList
 */
class TargetingTemplateListParameterData
{
    /**
     ...
     * @DTA\Data(subset="query", field="include_sizing", nullable=true)
     ...
     */
    public ?bool $include_sizing = null;

    /**
     * Search query. Can contain pin description keywords or comma-separated pin IDs.
     * @DTA\Data(subset="query", field="search_query", nullable=true)
     * @DTA\Strategy(subset="query", name="QueryStringScalar", options={"type":"string"})
     * @DTA\Validator(subset="query", name="QueryStringScalar", options={"type":"string"})
     */
