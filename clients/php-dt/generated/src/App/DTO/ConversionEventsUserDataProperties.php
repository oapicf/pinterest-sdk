...
class ConversionEventsUserDataProperties
{
     ...
     * @DTA\Validator(name="TypeCompliant", options={"type":::class})
     */
    public ?array $hashed_maids = null;
