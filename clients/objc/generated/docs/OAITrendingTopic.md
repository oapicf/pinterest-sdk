...
**timeSeries** | **NSDictionary&lt;NSString*, NSNumber*&gt;*** | Time series data showing trend values over time, with dates as keys and values as numeric | 
**title** | **NSString*** | Title of the trending topic | 
