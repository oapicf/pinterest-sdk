...
------------ | ------------- | ------------- | -------------
**adAccountId** | **NSString*** | The Ad Account ID that this promotion belongs to. | [readonly] 
**discountStatus** | [**OAIDiscountStatus***](OAIDiscountStatus.md) |  | [optional] 
...
**promotionTitle** | **NSString*** | Internal name for the promotion. | 
**promotionType** | [**OAIPromotionType***](OAIPromotionType.md) |  | 
