...
------------ | ------------- | ------------- | -------------
**adAccountId** | **NSString*** | The Ad Account ID that this lead form belongs to. | [optional] [readonly] 
**completionMessage** | **NSString*** | A message for people who complete the form to let them know what happens next. | 
**createdTime** | **NSNumber*** | Lead form creation time. Unix timestamp in seconds. | [optional] [readonly] 
...
**_id** | **NSString*** | The ID of this lead form | 
**name** | **NSString*** | Internal name of the lead form. | 
**policyLinks** | [**NSArray&lt;OAILeadFormPolicyLink&gt;***](OAILeadFormPolicyLink.md) | List of additional policy links to be displayed on the lead form. | [optional] 
