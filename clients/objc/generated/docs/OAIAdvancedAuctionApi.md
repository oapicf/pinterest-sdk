...
OAIAdvancedAuctionItemsGetRequest* advancedAuctionItemsGetRequest = [[OAIAdvancedAuctionItemsGetRequest alloc] init]; // 
...
------------- | ------------- | ------------- | -------------
 **advancedAuctionItemsGetRequest** | [**OAIAdvancedAuctionItemsGetRequest***](OAIAdvancedAuctionItemsGetRequest.md)|  | 
...
OAIAdvancedAuctionItemsSubmitRequest* advancedAuctionItemsSubmitRequest = [[OAIAdvancedAuctionItemsSubmitRequest alloc] init]; // 
NSString* adAccountId = @"adAccountId_example"; // Unique identifier of an ad account. (optional)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **advancedAuctionItemsSubmitRequest** | [**OAIAdvancedAuctionItemsSubmitRequest***](OAIAdvancedAuctionItemsSubmitRequest.md)|  | 
 **adAccountId** | **NSString***| Unique identifier of an ad account. | [optional] 
