...
------------- | ------------- | -------------
[**trendsEditorialArticlesList**](OAITrendsApi.md#trendseditorialarticleslist) | **GET** /trends/editorial_articles | Returns editorial articles for a given region
[**trendsFeaturedTopicsList**](OAITrendsApi.md#trendsfeaturedtopicslist) | **GET** /trends/topics/featured | Get featured topics
[**trendsProductCategoriesDetailsList**](OAITrendsApi.md#trendsproductcategoriesdetailslist) | **GET** /trends/product_categories/details | Get product category details
[**trendsProductCategoriesTrendingList**](OAITrendsApi.md#trendsproductcategoriestrendinglist) | **GET** /trends/product_categories/trending | Get a list of growing Shopping Product Categories
...
OAITrendsApi*apiInstance = [[OAITrendsApi alloc] init];

// Returns editorial articles for a given region
[apiInstance trendsEditorialArticlesListWithRegion:region
          completionHandler: ^(NSArray<OAITrendsEditorial>* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling OAITrendsApi->trendsEditorialArticlesList: %@", error);
                        }
                    }];
```
...
[**NSArray<OAITrendsEditorial>***](OAITrendsEditorial.md)
...
[apiInstance trendsFeaturedTopicsListWithRegion:region
          ...
          completionHandler: ^(NSArray<OAIFeaturedTrend>* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAITrendsApi->trendsFeaturedTopicsList: %@", error);
                        }
                    }];
```
...
[apiInstance trendsProductCategoriesDetailsListWithProductCategories:productCategories
          ...
          completionHandler: ^(NSArray<OAIProductCategoryDetails>* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAITrendsApi->trendsProductCategoriesDetailsList: %@", error);
                        }
                    }];
```
...
[apiInstance trendsProductCategoriesTrendingListWithRegion:region
          ...
          completionHandler: ^(NSArray<OAITrendingProductCategory>* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAITrendsApi->trendsProductCategoriesTrendingList: %@", error);
                        }
                    }];
```
