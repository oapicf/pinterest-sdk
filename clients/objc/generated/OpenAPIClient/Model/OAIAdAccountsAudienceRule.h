...
@protocol OAIAudienceObjectiveType;
@class OAIAudienceObjectiveType;
...
@interface OAIAdAccountsAudienceRule : OAIObject
...
@property(nonatomic) OAIEventData* eventData;
 ...
 */
@property(nonatomic) NSArray<OAIAudienceObjectiveType>* objectiveType;
