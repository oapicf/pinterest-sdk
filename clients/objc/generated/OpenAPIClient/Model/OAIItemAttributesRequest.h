...
@protocol OAIItemAttributesRequestAllOfImageLink;
@class OAIItemAttributesRequestAllOfImageLink;
...
/* <p><= 2000 characters</p> <p>The links to additional images for your product. Up to ten additional images can be used to show a product from different angles or to show different stages. Must begin with http:// or https://.</p> [optional]
 */
@property(nonatomic) NSArray<NSString*>* additionalImageLink;

@property(nonatomic) OAIItemAttributesRequestAllOfImageLink* imageLink;
...
/* <p><= 2,000 characters</p> <p>Hosted link to the product video.</p> <p>File types for linked videos must be .mp4, .mov or .m4v.</p> <p>File size cannot exceed 2GB.</p> [optional]
 */
