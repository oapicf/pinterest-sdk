...
@implementation OAIPromotionCreateRequest
...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"discountStatus", @"endTime", @"externalId", @"platformType", @"promotionCode", @"promotionCustomId", @"startTime", @"templateValues"];
