#import "OAICatalogsRetailReportParametersReport.h"

@implementation OAICatalogsRetailReportParametersReport
...
- (id)initWithDictionary:(NSDictionary *)dict error:(NSError *__autoreleasing *)err {
    ...
    if ([discriminatedClassName isEqualToString:@"ALL_ITEMS"]) {
        class = NSClassFromString(@"OAICatalogsRetailReportAllItemsFilter");
    }
    else
...
+ (JSONKeyMapper *)keyMapper {
  return [[JSONKeyMapper alloc] initWithModelToJSONDictionary:@{ @"feedId": @"feed_id", @"processingResultId": @"processing_result_id", @"reportType": @"report_type", @"catalogId": @"catalog_id", @"productGroupId": @"product_group_id" }];
}
...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"processingResultId", @"catalogId", @"productGroupId"];
