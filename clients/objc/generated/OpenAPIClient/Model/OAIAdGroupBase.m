#import "OAIAdGroupBase.h"

@implementation OAIAdGroupBase
...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"adAccountId", @"bidInMicroCurrency", @"bidStrategyType", @"budgetInMicroCurrency", @"customerSegmentId", @"dcaAssets", @"endTime", @"extFeatures", @"feedProfileId", @"isCreativeOptimization", @"isLocalInventory", @"lifetimeFrequencyCap", @"localInventoryRadiusInMiles", @"optimizationGoalMetadata", @"performancePlusCampaignSettings", @"placementGroup", @"placementTrafficType", @"promotionApplicationLevel", @"promotionId", @"promotionIds", @"startTime", @"status", @"targetingSpec", @"targetingTemplateIds", @"trackingUrls", ];
