...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"name", @"status", @"lifetimeSpendCap", @"dailySpendCap", @"orderLineId", @"trackingUrls", @"startTime", @"endTime", @"isFlexibleDailyBudgets", @"defaultAdGroupBudgetInMicroCurrency", @"isAutomatedCampaign", @"isCampaignBudgetOptimization", @"objectiveType"];
