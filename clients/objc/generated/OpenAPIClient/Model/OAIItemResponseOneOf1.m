...
@implementation OAIItemResponseOneOf1
...
+ (JSONKeyMapper *)keyMapper {
  return [[JSONKeyMapper alloc] initWithModelToJSONDictionary:@{ @"catalogType": @"catalog_type", @"errors": @"errors", @"itemId": @"item_id", @"hotelId": @"hotel_id", @"creativeAssetsId": @"creative_assets_id" }];
}
...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"itemId", @"hotelId", @"creativeAssetsId"];
