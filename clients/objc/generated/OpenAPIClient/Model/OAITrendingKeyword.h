...
@protocol OAIPredictedTimeSeries;
@class OAIPredictedTimeSeries;
@protocol OAITimeSeries;
@class OAITimeSeries;
...
@protocol OAITrendingKeyword
@end

@interface OAITrendingKeyword : OAIObject


@property(nonatomic) OAITrendingKeywordDemographics* demographics;
/* Indicates whether the keyword has a prediction available for the next 90 days. This field is only applicable when `include_prediction` query parameter is set to `true`. By default, the value is `false` and no prediction data is included in the response. [optional]
 */
@property(nonatomic) NSNumber* hasPrediction;
/* The keyword that is trending. [optional]
 */
 ...
 */
@property(nonatomic) NSNumber* pctGrowthWow;
 ...
 */
@property(nonatomic) NSNumber* pctGrowthYoy;
 ...
 */
@property(nonatomic) OAIPredictedTimeSeries* predictedTimeSeries;
/* A sequence of weekly observations of the relative search volume for this keyword over the past year. These values are normalized to a [0-100] range, and can be used to visualize the history of user interest in this keyword. By default, normalization is applied independently to the time series of each keyword, but the `normalize_against_group` query parameter can be used in cases where you wish to compare relative volume between keywords.  **Note**: The date of each observation is in ISO-8601 format and represents the *end* of the week. For example, a value of `2023-10-31` would include searches that happened between `2023-10-25` and `2023-10-31`. [optional]
 */
@property(nonatomic) OAITimeSeries* timeSeries;
