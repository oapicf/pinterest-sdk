...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"androidDeepLink", @"customLabel0", @"customLabel1", @"customLabel2", @"customLabel3", @"customLabel4", @"_description", @"googleProductCategory", @"iosDeepLink", @"link", @"title", @"visibility", @"imageLink", @"videoLink"];
