...
+ (JSONKeyMapper *)keyMapper {
  return [[JSONKeyMapper alloc] initWithModelToJSONDictionary:@{ @"aemEnabled": @"aem_enabled", @"mdFrequency": @"md_frequency", @"aemFnlnEnabled": @"aem_fnln_enabled", @"aemPhEnabled": @"aem_ph_enabled", @"aemGeEnabled": @"aem_ge_enabled", @"aemDbEnabled": @"aem_db_enabled", @"aemLocEnabled": @"aem_loc_enabled" }];
}
