...
@implementation OAIItemResponseOneOf
...
+ (JSONKeyMapper *)keyMapper {
  return [[JSONKeyMapper alloc] initWithModelToJSONDictionary:@{ @"catalogType": @"catalog_type", @"attributes": @"attributes", @"itemId": @"item_id", @"pins": @"pins", @"hotelId": @"hotel_id", @"creativeAssetsId": @"creative_assets_id" }];
}
