...
@implementation OAIPromotionUpdateRequest
...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"discountStatus", @"endTime", @"externalId", @"platformType", @"promotionCode", @"promotionCustomId", @"promotionTitle", @"promotionType", @"startTime", @"templateValues", @"status"];
