...
@protocol OAIUserAccountType;
@class OAIUserAccountType;
 ...
 */
@property(nonatomic) OAIUserAccountType* accountType;
/*   User account board count.   **Note**: Board count on user account level may differ from counts found elsewhere due to attribution of collaborative Boards. [optional]
 */
