...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"adGroupId", @"androidDeepLink", @"carouselAndroidDeepLinks", @"carouselDestinationUrls", @"carouselIosDeepLinks", @"clickTrackingUrl", @"creativeType", @"destinationUrl", @"iosDeepLink", @"isPinDeleted", @"isRemovable", @"name", @"pinId", @"status", @"trackingUrls", @"viewTrackingUrl", @"adAccountId", @"campaignId", @"collectionItemsDestinationUrlTemplate", @"createdTime", @"_id", @"rejectedReasons", @"rejectionLabels", @"reviewStatus", @"type", @"updatedTime", @"summaryStatus"];
