...
@implementation OAICampaignBatchResponseData
...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"adAccountId", @"bidOptions", @"createdTime", @"dailySpendCap", @"defaultAdGroupBudgetInMicroCurrency", @"endTime", @"_id", @"intendedPromotionType", @"isAutomatedCampaign", @"isCampaignBudgetOptimization", @"isCarting", @"isFlexibleDailyBudgets", @"isLtvOptimized", @"isPerformancePlus", @"isTopOfSearch", @"lifetimeSpendCap", @"name", @"objectiveType", @"orderLineId", @"performancePlusCampaignSettings", @"startTime", @"status", @"summaryStatus", @"trackingUrls", @"type", @"updatedTime"];
