...
@protocol OAITrendingKeywordsResponseTrendsInnerTimeSeries;
@class OAITrendingKeywordsResponseTrendsInnerTimeSeries;
...
@interface OAITrendingKeywordsResponseTrendsInner : OAIObject
...
@property(nonatomic) OAITrendingKeywordsResponseTrendsInnerTimeSeries* timeSeries;
