...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"externalBusinessId", @"connectedMerchantId", @"connectedAdvertiserId", @"connectedLbaId", @"connectedTagId", @"partnerAccessToken", @"partnerRefreshToken", @"partnerPrimaryEmail", @"partnerAccessTokenExpiry", @"partnerRefreshTokenExpiry", @"scopes", @"additionalId1", @"partnerMetadata"];
