...
@implementation OAIMsotEventsApi

NSString* kOAIMsotEventsApiErrorDomain = @"OAIMsotEventsApiErrorDomain";
NSInteger kOAIMsotEventsApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) msotEventsCreateWithAdAccountId: (NSString*) adAccountId
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/ad_accounts/{ad_account_id}/msot/events"];
