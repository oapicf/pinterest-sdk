...
@interface OAITrendsApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation OAITrendsApi

NSString* kOAITrendsApiErrorDomain = @"OAITrendsApiErrorDomain";
NSInteger kOAITrendsApiMissingParamErrorCode = 234513;
...
///
///  @returns NSArray<OAITrendsEditorial>*
///
-(NSURLSessionTask*) trendsEditorialArticlesListWithRegion: (OAIProductCategoryRegion) region
    ...
    if (region == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kOAITrendsApiErrorDomain code:kOAITrendsApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }

    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/trends/editorial_articles"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"NSArray<OAITrendsEditorial>*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((NSArray<OAITrendsEditorial>*)data, error);
                                }
                            }];
}
