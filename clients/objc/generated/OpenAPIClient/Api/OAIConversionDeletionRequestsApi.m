#import "OAIConversionDeletionRequestsApi.h"
...
@interface OAIConversionDeletionRequestsApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation OAIConversionDeletionRequestsApi

NSString* kOAIConversionDeletionRequestsApiErrorDomain = @"OAIConversionDeletionRequestsApiErrorDomain";
NSInteger kOAIConversionDeletionRequestsApiMissingParamErrorCode = 234513;
...
///
///  @returns OAIConversionDeletionRequest*
///
-(NSURLSessionTask*) conversionDeletionRequestCreateWithAdAccountId: (NSString*) adAccountId
    ...
    if (adAccountId == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kOAIConversionDeletionRequestsApiErrorDomain code:kOAIConversionDeletionRequestsApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
    ...
    if (conversionDeletionRequestCreate == nil) {
        NSParameterAssert(conversionDeletionRequestCreate);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"conversionDeletionRequestCreate"] };
            NSError* error = [NSError errorWithDomain:kOAIConversionDeletionRequestsApiErrorDomain code:kOAIConversionDeletionRequestsApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/ad_accounts/{ad_account_id}/conversion_deletion_requests"];
    ...
    bodyParam = conversionDeletionRequestCreate;
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"OAIConversionDeletionRequest*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((OAIConversionDeletionRequest*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) conversionDeletionRequestDeleteWithRequestId: (NSString*) requestId
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/ad_accounts/{ad_account_id}/conversion_deletion_requests/{request_id}"];
...
///
///  @returns OAIConversionDeletionRequestList200Response*
///
-(NSURLSessionTask*) conversionDeletionRequestListWithAdAccountId: (NSString*) adAccountId
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"OAIConversionDeletionRequestList200Response*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((OAIConversionDeletionRequestList200Response*)data, error);
                                }
                            }];
}
