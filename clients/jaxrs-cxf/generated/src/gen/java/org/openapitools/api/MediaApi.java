...
public interface MediaApi  {
    ...
    public MediaUpload mediaCreate(@Valid @NotNull MediaUploadRequest mediaUploadRequest);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error", response = Error.class) })
    public Paginated mediaList(@QueryParam("bookmark") String bookmark, @QueryParam("page_size") @Min(1) @Max(100) @DefaultValue("25")Integer pageSize);
}
