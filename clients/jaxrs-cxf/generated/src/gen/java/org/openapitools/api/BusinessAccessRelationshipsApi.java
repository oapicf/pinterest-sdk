...
public interface BusinessAccessRelationshipsApi  {
    ...
    public BrandAccount brandAccountsCreate(@PathParam("business_hierarchy_id") @Pattern(regexp="^\\d+$") @Size(min=1,max=20) String businessHierarchyId, @Valid @NotNull BrandAccountCreate brandAccountCreate);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 429, message = "The user has sent too many requests in a given amount of time and is being rate limited.", response = PinterestLibError.class),
        @ApiResponse(code = 200, message = "An unexpected error response.", response = PinterestLibError.class) })
    public BrandAccount brandAccountsUpdate(@PathParam("brand_account_id") String brandAccountId, @PathParam("business_hierarchy_id") @Pattern(regexp="^\\d+$") @Size(min=1,max=20) String businessHierarchyId, @Valid @NotNull BrandAccountUpdate brandAccountUpdate);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "An unexpected error response.", response = PinterestLibError.class) })
    public DeleteBusinessMembership200Response deleteBusinessMembership(@PathParam("business_id") @Pattern(regexp="^\\d+$") @Size(min=1,max=20) String businessId, @Valid @NotNull DeleteBusinessMembershipBody deleteBusinessMembershipBody);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 404, message = "The requested resource could not be found on this server.", response = PinterestLibError.class),
        @ApiResponse(code = 200, message = "An unexpected error response.", response = PinterestLibError.class) })
    public DeleteBusinessPartners deleteBusinessPartners(@PathParam("business_id") @Pattern(regexp="^\\d+$") @Size(min=1,max=20) String businessId, @Valid @NotNull DeleteBusinessPartnersDelete deleteBusinessPartnersDelete);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 429, message = "The user has sent too many requests in a given amount of time and is being rate limited.", response = PinterestLibError.class),
        @ApiResponse(code = 200, message = "An unexpected error response.", response = PinterestLibError.class) })
    public GetBusinessEmployers200Response getBusinessEmployers(@QueryParam("assets_summary") @DefaultValue("true")Boolean assetsSummary, @QueryParam("bookmark") String bookmark, @QueryParam("page_size") @Min(1) @Max(250) @DefaultValue("25")Integer pageSize);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 429, message = "The user has sent too many requests in a given amount of time and is being rate limited.", response = PinterestLibError.class),
        @ApiResponse(code = 200, message = "An unexpected error response.", response = PinterestLibError.class) })
    public GetBusinessEmployers200Response getBusinessPartners(@PathParam("business_id") @Pattern(regexp="^\\d+$") @Size(min=1,max=20) String businessId, @QueryParam("assets_summary") @DefaultValue("false")Boolean assetsSummary, @QueryParam("partner_type") PartnerType partnerType, @QueryParam("partner_ids") @Size(max=500) String partnerIds, @QueryParam("start_index") @Min(0) @DefaultValue("0")Integer startIndex, @QueryParam("sort_ascending") Boolean sortAscending, @QueryParam("bookmark") String bookmark, @QueryParam("page_size") @Min(1) @Max(250) @DefaultValue("25")Integer pageSize);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 429, message = "The user has sent too many requests in a given amount of time and is being rate limited.", response = PinterestLibError.class),
        @ApiResponse(code = 200, message = "An unexpected error response.", response = PinterestLibError.class) })
    public void systemUserUpdate(@PathParam("business_id") @Pattern(regexp="^\\d+$") @Size(min=1,max=20) String businessId, @PathParam("system_user_id") @Pattern(regexp="^\\d+$") @Size(min=1,max=20) String systemUserId, @Valid @NotNull SystemUserUpdateWithRequiredBody systemUserUpdateWithRequiredBody);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 429, message = "The user has sent too many requests in a given amount of time and is being rate limited.", response = PinterestLibError.class),
        @ApiResponse(code = 200, message = "An unexpected error response.", response = PinterestLibError.class) })
    public UpdateBusinessMembershipsResponse updateBusinessMemberships(@PathParam("business_id") @Pattern(regexp="^\\d+$") @Size(min=1,max=20) String businessId, @Valid @NotNull List<@Valid BusinessMembershipMember> businessMembershipMember);
}
