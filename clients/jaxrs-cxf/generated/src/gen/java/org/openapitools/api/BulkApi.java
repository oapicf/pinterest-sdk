...
public interface BulkApi  {
    ...
    public BulkDownload bulkDownloadCreate(@PathParam("ad_account_id") @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId, @Valid @NotNull BulkDownloadCreate bulkDownloadCreate);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 429, message = "The user has sent too many requests in a given amount of time and is being rate limited.", response = PinterestLibError.class),
        @ApiResponse(code = 200, message = "An unexpected error response.", response = PinterestLibError.class) })
    public BulkJobData bulkRequestGet(@PathParam("ad_account_id") @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId, @PathParam("bulk_request_id") String bulkRequestId, @QueryParam("include_details") @DefaultValue("false")Boolean includeDetails);
    ...
    public BulkUpsertResponse bulkUpsertCreate(@PathParam("ad_account_id") @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId, @Valid @NotNull BulkUpsertRequest bulkUpsertRequest);
}
