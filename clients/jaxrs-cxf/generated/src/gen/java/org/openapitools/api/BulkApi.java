...
public interface BulkApi  {
    ...
    public BulkDownloadResponse bulkDownloadCreate(@PathParam("ad_account_id") @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId, @Valid @NotNull BulkDownloadRequest bulkDownloadRequest);
