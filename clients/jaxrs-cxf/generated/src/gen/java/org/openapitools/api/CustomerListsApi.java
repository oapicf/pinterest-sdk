...
public interface CustomerListsApi  {
    ...
    public CustomerList customerListsCreate(@PathParam("ad_account_id") @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId, @Valid @NotNull CustomerListRequest customerListRequest);
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Success", response = CustomerList.class),
        @ApiResponse(code = 200, message = "Unexpected error", response = Error.class) })
    public CustomerList customerListsUpdate(@PathParam("ad_account_id") @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId, @PathParam("customer_list_id") @Pattern(regexp="^\\d+$") @Size(max=18) String customerListId, @Valid @NotNull CustomerListUpdateRequest customerListUpdateRequest);
}
