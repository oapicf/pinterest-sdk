...
public interface CatalogSupplementalApi  {
    ...
    public SupplementalItemsBatchResponse catalogsLocalInventoryItemsBatchOperate(@PathParam("catalog_id") @Pattern(regexp="^\\d+$") @Size(max=19) String catalogId, @Valid @NotNull LocalInventoryItemsBatchCreate localInventoryItemsBatchCreate, @QueryParam("ad_account_id") @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 429, message = "The user has sent too many requests in a given amount of time and is being rate limited.", response = PinterestLibError.class),
        @ApiResponse(code = 200, message = "An unexpected error response.", response = PinterestLibError.class) })
    public LocalInventoryItemsGet catalogsLocalInventoryItemsPost(@PathParam("catalog_id") @Pattern(regexp="^\\d+$") @Size(max=19) String catalogId, @Valid @NotNull LocalInventoryItemsGetCreate localInventoryItemsGetCreate, @QueryParam("ad_account_id") @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 429, message = "The user has sent too many requests in a given amount of time and is being rate limited.", response = PinterestLibError.class),
        @ApiResponse(code = 200, message = "An unexpected error response.", response = PinterestLibError.class) })
    public List<CatalogsLocalStoresCreate200ResponseInner> catalogsLocalStoresCreate(@PathParam("catalog_id") @Pattern(regexp="^\\d+$") @Size(max=19) String catalogId, @Valid @NotNull List<@Valid LocalStoreCreate> localStoreCreate, @QueryParam("ad_account_id") @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 429, message = "The user has sent too many requests in a given amount of time and is being rate limited.", response = PinterestLibError.class),
        @ApiResponse(code = 200, message = "An unexpected error response.", response = PinterestLibError.class) })
    public List<CatalogsLocalStoresCreate200ResponseInner> catalogsLocalStoresUpdate(@PathParam("catalog_id") @Pattern(regexp="^\\d+$") @Size(max=19) String catalogId, @Valid @NotNull List<@Valid LocalStoreBatchUpdate> localStoreBatchUpdate, @QueryParam("ad_account_id") @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId);
