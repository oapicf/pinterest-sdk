...
public interface ResourcesApi  {
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error", response = Error.class) })
    public SingleInterestTargetingOptionResponse interestTargetingOptionsGet(@PathParam("interest_id") @Pattern(regexp="^\\d+$") @Size(max=18) String interestId);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error", response = Error.class) })
    public BookClosedResponse metricsReadyStateGet(@QueryParam("date") @NotNull @Pattern(regexp="^(\\d{4})-(\\d{2})-(\\d{2})$") String date);
