...
public interface AdAccountsApi  {
    ...
    public AdAccount adAccountsCreate(@Valid @NotNull AdAccountCreate adAccountCreate);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error", response = Error.class) })
    public AdsAnalyticsCreateAsyncResponse analyticsCreateConversionProductReport(@PathParam("ad_account_id") @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId, @Valid @NotNull ConversionProductReportRequest conversionProductReportRequest);
