...
public interface PinsApi  {
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 404, message = "Pin not found.", response = Error.class),
        @ApiResponse(code = 200, message = "Unexpected error", response = Error.class) })
    public Map<String, PinAnalyticsMetricsResponse> pinsAnalytics(@PathParam("pin_id") String pinId, @QueryParam("start_date") @NotNull LocalDate startDate, @QueryParam("end_date") @NotNull LocalDate endDate, @QueryParam("metric_types") @NotNull List<String> metricTypes, @QueryParam("app_types") @DefaultValue("ALL")String appTypes, @QueryParam("split_field") @DefaultValue("NO_SPLIT")String splitField, @QueryParam("ad_account_id") @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 429, message = "The user has sent too many requests in a given amount of time and is being rate limited.", response = PinterestLibError.class),
        @ApiResponse(code = 200, message = "An unexpected error response.", response = PinterestLibError.class) })
    public void pinsDelete(@PathParam("pin_id") @Pattern(regexp="^\\d+$") String pinId, @QueryParam("ad_account_id") @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 429, message = "The user has sent too many requests in a given amount of time and is being rate limited.", response = PinterestLibError.class),
        @ApiResponse(code = 200, message = "An unexpected error response.", response = PinterestLibError.class) })
    public PinsList200Response pinsList(@QueryParam("pin_filter") String pinFilter, @QueryParam("pin_metrics") @DefaultValue("false")Boolean pinMetrics, @QueryParam("include_protected_pins") @DefaultValue("false")Boolean includeProtectedPins, @QueryParam("pin_type") String pinType, @QueryParam("creative_types") List<CreativeType> creativeTypes, @QueryParam("ad_account_id") @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId, @QueryParam("bookmark") String bookmark, @QueryParam("page_size") @Min(1) @Max(250) @DefaultValue("25")Integer pageSize);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error", response = Error.class) })
    public Pin pinsSave(@PathParam("pin_id") String pinId, @Valid @NotNull PinsSaveRequest pinsSaveRequest, @QueryParam("ad_account_id") @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId);
