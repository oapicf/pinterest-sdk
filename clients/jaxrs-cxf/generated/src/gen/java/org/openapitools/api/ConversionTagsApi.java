...
public interface ConversionTagsApi  {
    ...
    public ConversionTagResponse conversionTagsCreate(@PathParam("ad_account_id") @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId, @Valid @NotNull ConversionTagCreate conversionTagCreate);
