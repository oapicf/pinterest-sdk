...
public interface CustomerListUploadsApi  {
    ...
    public CustomerListUploadCreateResponse customerListUploadsCreate(@PathParam("ad_account_id") @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId, @PathParam("customer_list_id") @Pattern(regexp="^\\d+$") @Size(max=18) String customerListId, @Valid @NotNull CustomerListUploadCreateRequest customerListUploadCreateRequest);
