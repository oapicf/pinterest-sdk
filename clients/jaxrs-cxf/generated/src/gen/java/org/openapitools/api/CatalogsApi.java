...
public interface CatalogsApi  {
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error.", response = Error.class) })
    public CatalogsProductGroupsCreate201Response catalogsProductGroupsCreate(@Valid @NotNull CatalogsProductGroupsCreateRequest catalogsProductGroupsCreateRequest, @QueryParam("ad_account_id") @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error.", response = Error.class) })
    public CatalogsProductGroupsCreate201Response catalogsProductGroupsUpdate(@PathParam("product_group_id") @Pattern(regexp="^\\d+$") String productGroupId, @Valid @NotNull CatalogsProductGroupsUpdateRequest catalogsProductGroupsUpdateRequest, @QueryParam("ad_account_id") @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error.", response = Error.class) })
    public CatalogsProductGroupPinsList200Response productsByProductGroupFilterList(@Valid @NotNull CatalogsListProductsByFilterRequest catalogsListProductsByFilterRequest, @QueryParam("bookmark") String bookmark, @QueryParam("page_size") @Min(1) @Max(250) @DefaultValue("25")Integer pageSize, @QueryParam("ad_account_id") @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId);
}
