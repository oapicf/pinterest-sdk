...
public interface LeadAdsApi  {
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 403, message = "Can't access this subscription.", response = Error.class),
        @ApiResponse(code = 200, message = "Unexpected error.", response = Error.class) })
    public AdAccountCreateSubscriptionResponse adAccountsSubscriptionsPost(@PathParam("ad_account_id") @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId, @Valid @NotNull AdAccountCreateSubscriptionRequest adAccountCreateSubscriptionRequest);
}
