...
public interface BusinessAccessAssetsApi  {
    ...
    public CreateAssetGroupResponse assetGroupCreate(@PathParam("business_id") @Pattern(regexp="^\\d+$") @Size(min=1,max=20) String businessId, @Valid @NotNull CreateAssetGroupBody createAssetGroupBody);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 400, message = "Invalid parameters.", response = Error.class),
        @ApiResponse(code = 200, message = "Unexpected error", response = Error.class) })
    public DeleteAssetGroupResponse assetGroupDelete(@PathParam("business_id") @Pattern(regexp="^\\d+$") @Size(min=1,max=20) String businessId, @Valid @NotNull DeleteAssetGroupBody deleteAssetGroupBody);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 400, message = "Invalid parameters.", response = Error.class),
        @ApiResponse(code = 200, message = "Unexpected error", response = Error.class) })
    public UpdateAssetGroupResponse assetGroupUpdate(@PathParam("business_id") @Pattern(regexp="^\\d+$") @Size(min=1,max=20) String businessId, @Valid @NotNull UpdateAssetGroupBody updateAssetGroupBody);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error", response = Error.class) })
    public DeleteMemberAccessResultsResponseArray businessMembersAssetAccessDelete(@PathParam("business_id") @Pattern(regexp="^\\d+$") @Size(min=1,max=20) String businessId, @Valid @NotNull BusinessMembersAssetAccessDeleteRequest businessMembersAssetAccessDeleteRequest);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error", response = Error.class) })
    public UpdateMemberAssetsResultsResponseArray businessMembersAssetAccessUpdate(@PathParam("business_id") @Pattern(regexp="^\\d+$") @Size(min=1,max=20) String businessId, @Valid @NotNull UpdateMemberAssetAccessBody updateMemberAssetAccessBody);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error", response = Error.class) })
    public DeletePartnerAssetsResultsResponseArray deletePartnerAssetAccessHandlerImpl(@PathParam("business_id") @Pattern(regexp="^\\d+$") @Size(min=1,max=20) String businessId, @Valid @NotNull DeletePartnerAssetAccessBody deletePartnerAssetAccessBody);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error", response = Error.class) })
    public UpdatePartnerAssetsResultsResponseArray updatePartnerAssetAccessHandlerImpl(@PathParam("business_id") @Pattern(regexp="^\\d+$") @Size(min=1,max=20) String businessId, @Valid @NotNull UpdatePartnerAssetAccessBody updatePartnerAssetAccessBody);
}
