...
public interface BusinessAccessAssetsApi  {
    ...
    public AssetGroupInput assetGroupCreate(@PathParam("business_id") @Pattern(regexp="^\\d+$") @Size(min=1,max=20) String businessId, @Valid @NotNull AssetGroupInputCreate assetGroupInputCreate);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "An unexpected error response.", response = PinterestLibError.class) })
    public AssetGroupDeletion assetGroupDelete(@PathParam("business_id") @Pattern(regexp="^\\d+$") @Size(min=1,max=20) String businessId, @Valid @NotNull AssetGroupDeletionDelete assetGroupDeletionDelete);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 429, message = "The user has sent too many requests in a given amount of time and is being rate limited.", response = PinterestLibError.class),
        @ApiResponse(code = 200, message = "An unexpected error response.", response = PinterestLibError.class) })
    public AssetGroupModification assetGroupUpdate(@PathParam("business_id") @Pattern(regexp="^\\d+$") @Size(min=1,max=20) String businessId, @Valid @NotNull AssetGroupModificationReadOrUpdate assetGroupModificationReadOrUpdate);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "An unexpected error response.", response = PinterestLibError.class) })
    public DeleteMemberAccessResultsResponseArray businessMembersAssetAccessDelete(@PathParam("business_id") @Pattern(regexp="^\\d+$") @Size(min=1,max=20) String businessId, @Valid @NotNull BusinessMembersAssetAccessDeleteBody businessMembersAssetAccessDeleteBody);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "An unexpected error response.", response = PinterestLibError.class) })
    public DeletePartnerAssetAccessResultsResponseArray deletePartnerAssetAccessHandlerImpl(@PathParam("business_id") @Pattern(regexp="^\\d+$") @Size(min=1,max=20) String businessId, @Valid @NotNull DeletePartnerAssetAccessBody deletePartnerAssetAccessBody);
