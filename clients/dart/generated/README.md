...
try {
    final result = api_instance.adAccountAnalytics(adAccountId, startDate, endDate, columns, granularity, clickWindowDays, engagementWindowDays, viewWindowDays, conversionReportTime, reportingTimezone);
    print(result);
} catch (e) {
...
*ProductCategoriesApi* | [**trendsFeaturedTopicsList**](doc//ProductCategoriesApi.md#trendsfeaturedtopicslist) | **GET** /trends/topics/featured | Get featured topics
*ProductCategoriesApi* | [**trendsProductCategoriesDetailsList**](doc//ProductCategoriesApi.md#trendsproductcategoriesdetailslist) | **GET** /trends/product_categories/details | Get product category details
*ProductCategoriesApi* | [**trendsProductCategoriesTrendingList**](doc//ProductCategoriesApi.md#trendsproductcategoriestrendinglist) | **GET** /trends/product_categories/trending | Get a list of growing Shopping Product Categories
