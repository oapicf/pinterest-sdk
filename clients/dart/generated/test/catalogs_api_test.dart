...
void main() {
  ...
  group('tests for CatalogsApi', () {
    ...
    //
    //Future catalogsProductGroupsDeleteMany(List<int> id, { String adAccountId }) async
    ...
    //
    //Future<CatalogsItems> itemsGet(String country, String language, { String adAccountId, List<String> itemIds, CatalogsItemsFilters filters }) async
