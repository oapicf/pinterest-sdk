...
void main() {
  ...
  group('tests for CampaignsApi', () {
    ...
    //
    //Future<MetricsResponse> campaignTargetingAnalyticsGet(String adAccountId, List<String> campaignIds, DateTime startDate, DateTime endDate, List<AdsAnalyticsTargetingType> targetingTypes, List<String> columns, Granularity granularity, { int clickWindowDays, int engagementWindowDays, int viewWindowDays, String conversionReportTime, ConversionReportAttributionType attributionTypes }) async
