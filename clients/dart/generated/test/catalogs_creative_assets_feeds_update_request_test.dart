...
// tests for CatalogsCreativeAssetsFeedsUpdateRequest
void main() {
  // final instance = CatalogsCreativeAssetsFeedsUpdateRequest();

  group('test CatalogsCreativeAssetsFeedsUpdateRequest', () {
