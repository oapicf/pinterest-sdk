...
// tests for CatalogsProductGroupsList200ResponseAllOfItemsInner
void main() {
  // final instance = CatalogsProductGroupsList200ResponseAllOfItemsInner();

  group('test CatalogsProductGroupsList200ResponseAllOfItemsInner', () {
