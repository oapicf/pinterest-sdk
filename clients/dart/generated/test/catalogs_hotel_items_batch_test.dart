...
// tests for CatalogsHotelItemsBatch
void main() {
  // final instance = CatalogsHotelItemsBatch();

  group('test CatalogsHotelItemsBatch', () {
    ...
    // List<HotelProcessingRecord> items (default value: const [])
