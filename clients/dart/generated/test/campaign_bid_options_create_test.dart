...
// tests for CampaignBidOptionsCreate
void main() {
  // final instance = CampaignBidOptionsCreate();

  group('test CampaignBidOptionsCreate', () {
    ...
    test('to test the property `audienceMultipliers`', () async {
      // TODO
    });
