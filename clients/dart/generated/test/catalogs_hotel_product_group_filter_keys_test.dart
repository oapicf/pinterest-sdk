...
// tests for CatalogsHotelProductGroupFilterKeys
void main() {
  // final instance = CatalogsHotelProductGroupFilterKeys();

  group('test CatalogsHotelProductGroupFilterKeys', () {
    ...
    test('to test the property `HOTEL_ID`', () async {
      // TODO
    });
