...
void main() {
  ...
  group('tests for AdAccountsApi', () {
    ...
    //
    //Future<List<AdAccountAnalyticsResponseInner>> adAccountAnalytics(String adAccountId, DateTime startDate, DateTime endDate, List<String> columns, Granularity granularity, { int clickWindowDays, int engagementWindowDays, int viewWindowDays, String conversionReportTime }) async
    ...
    //
    //Future<AdsAnalyticsCreateAsyncResponse> analyticsCreateTemplateReport(String adAccountId, String templateId, { DateTime startDate, DateTime endDate, Granularity granularity }) async
