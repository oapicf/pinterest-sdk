...
// tests for EventData
void main() {
  // final instance = EventData();

  group('test EventData', () {
    ...
    // String leadType
    test('to test the property `leadType`', () async {
      // TODO
    });
    ...
    // String pageName
    test('to test the property `pageName`', () async {
      // TODO
    });
    ...
    // String videoTitle
    test('to test the property `videoTitle`', () async {
      // TODO
    });
