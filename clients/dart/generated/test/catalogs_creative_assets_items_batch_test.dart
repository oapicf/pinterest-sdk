...
// tests for CatalogsCreativeAssetsItemsBatch
void main() {
  // final instance = CatalogsCreativeAssetsItemsBatch();

  group('test CatalogsCreativeAssetsItemsBatch', () {
    ...
    // List<CreativeAssetsProcessingRecord> items (default value: const [])
