...
// tests for ProductCategoryDetails
void main() {
  // final instance = ProductCategoryDetails();

  group('test ProductCategoryDetails', () {
    ...
    test('to test the property `metricsHighlights`', () async {
      // TODO
    });
    ...
    // Map<String, num> predictedTimeSeries (default value: const {})
