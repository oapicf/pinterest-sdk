...
// tests for OauthAccessTokenResponseClientCredentials
void main() {
  // final instance = OauthAccessTokenResponseClientCredentials();

  group('test OauthAccessTokenResponseClientCredentials', () {
    // String responseType
