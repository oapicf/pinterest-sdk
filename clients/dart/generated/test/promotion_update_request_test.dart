...
// tests for PromotionUpdateRequest
void main() {
  // final instance = PromotionUpdateRequest();

  group('test PromotionUpdateRequest', () {
    ...
    // List<PromotionTemplateValue> templateValues (default value: const [])
