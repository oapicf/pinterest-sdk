...
// tests for CreateInvitesResultsResponseArrayItemsInner
void main() {
  // final instance = CreateInvitesResultsResponseArrayItemsInner();

  group('test CreateInvitesResultsResponseArrayItemsInner', () {
