...
class CampaignBatchResponseData {
  /// Returns a new [CampaignBatchResponseData] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CampaignBatchResponseData &&
  ...
  /// Returns a new [CampaignBatchResponseData] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static CampaignBatchResponseData? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return CampaignBatchResponseData(
        ...
        status: NullableEntityStatus.fromJson(json[r'status']),
  ...
  static List<CampaignBatchResponseData> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CampaignBatchResponseData>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CampaignBatchResponseData.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, CampaignBatchResponseData> mapFromJson(dynamic json) {
    final map = <String, CampaignBatchResponseData>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CampaignBatchResponseData.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of CampaignBatchResponseData-objects as value to a dart map
  static Map<String, List<CampaignBatchResponseData>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<CampaignBatchResponseData>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = CampaignBatchResponseData.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
