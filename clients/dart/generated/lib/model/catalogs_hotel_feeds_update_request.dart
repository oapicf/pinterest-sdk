...
class CatalogsHotelFeedsUpdateRequest {
  /// Returns a new [CatalogsHotelFeedsUpdateRequest] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CatalogsHotelFeedsUpdateRequest &&
  ...
  @override
  String toString() => 'CatalogsHotelFeedsUpdateRequest[catalogType=$catalogType, credentials=$credentials, defaultCurrency=$defaultCurrency, format=$format, location=$location, name=$name, preferredProcessingSchedule=$preferredProcessingSchedule, status=$status]';
  ...
  /// Returns a new [CatalogsHotelFeedsUpdateRequest] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static CatalogsHotelFeedsUpdateRequest? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<CatalogsHotelFeedsUpdateRequest> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CatalogsHotelFeedsUpdateRequest>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CatalogsHotelFeedsUpdateRequest.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, CatalogsHotelFeedsUpdateRequest> mapFromJson(dynamic json) {
    final map = <String, CatalogsHotelFeedsUpdateRequest>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CatalogsHotelFeedsUpdateRequest.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of CatalogsHotelFeedsUpdateRequest-objects as value to a dart map
  static Map<String, List<CatalogsHotelFeedsUpdateRequest>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<CatalogsHotelFeedsUpdateRequest>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = CatalogsHotelFeedsUpdateRequest.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
