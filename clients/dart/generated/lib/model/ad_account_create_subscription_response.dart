...
class AdAccountCreateSubscriptionResponse {
  /// Returns a new [AdAccountCreateSubscriptionResponse] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is AdAccountCreateSubscriptionResponse &&
  ...
  @override
  String toString() => 'AdAccountCreateSubscriptionResponse[adAccountId=$adAccountId, apiVersion=$apiVersion, createdTime=$createdTime, cryptographicAlgorithm=$cryptographicAlgorithm, cryptographicKey=$cryptographicKey, id=$id, leadFormId=$leadFormId, userAccountId=$userAccountId, webhookUrl=$webhookUrl]';
  ...
  /// Returns a new [AdAccountCreateSubscriptionResponse] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static AdAccountCreateSubscriptionResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "AdAccountCreateSubscriptionResponse[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "AdAccountCreateSubscriptionResponse[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<AdAccountCreateSubscriptionResponse> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <AdAccountCreateSubscriptionResponse>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = AdAccountCreateSubscriptionResponse.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, AdAccountCreateSubscriptionResponse> mapFromJson(dynamic json) {
    final map = <String, AdAccountCreateSubscriptionResponse>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = AdAccountCreateSubscriptionResponse.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of AdAccountCreateSubscriptionResponse-objects as value to a dart map
  static Map<String, List<AdAccountCreateSubscriptionResponse>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<AdAccountCreateSubscriptionResponse>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = AdAccountCreateSubscriptionResponse.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
