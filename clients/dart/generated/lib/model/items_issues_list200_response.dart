...
class ItemsIssuesList200Response {
  ...
  static ItemsIssuesList200Response? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'items'), 'Required key "ItemsIssuesList200Response[items]" is missing from JSON.');
        assert(json[r'items'] != null, 'Required key "ItemsIssuesList200Response[items]" has a null value in JSON.');
        return true;
      }());
