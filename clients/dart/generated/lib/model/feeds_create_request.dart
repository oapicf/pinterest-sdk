...
class FeedsCreateRequest {
  /// Returns a new [FeedsCreateRequest] instance.
  FeedsCreateRequest({
    this.catalogId,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is FeedsCreateRequest &&
  ...
  /// Returns a new [FeedsCreateRequest] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static FeedsCreateRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "FeedsCreateRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "FeedsCreateRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<FeedsCreateRequest> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <FeedsCreateRequest>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = FeedsCreateRequest.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, FeedsCreateRequest> mapFromJson(dynamic json) {
    final map = <String, FeedsCreateRequest>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = FeedsCreateRequest.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of FeedsCreateRequest-objects as value to a dart map
  static Map<String, List<FeedsCreateRequest>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<FeedsCreateRequest>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = FeedsCreateRequest.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
