...
class FeedsUpdateRequest {
  /// Returns a new [FeedsUpdateRequest] instance.
  FeedsUpdateRequest({
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is FeedsUpdateRequest &&
  ...
  @override
  String toString() => 'FeedsUpdateRequest[catalogType=$catalogType, credentials=$credentials, defaultAvailability=$defaultAvailability, defaultCurrency=$defaultCurrency, format=$format, location=$location, name=$name, preferredProcessingSchedule=$preferredProcessingSchedule, status=$status]';
  ...
  /// Returns a new [FeedsUpdateRequest] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static FeedsUpdateRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "FeedsUpdateRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "FeedsUpdateRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<FeedsUpdateRequest> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <FeedsUpdateRequest>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = FeedsUpdateRequest.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, FeedsUpdateRequest> mapFromJson(dynamic json) {
    final map = <String, FeedsUpdateRequest>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = FeedsUpdateRequest.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of FeedsUpdateRequest-objects as value to a dart map
  static Map<String, List<FeedsUpdateRequest>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<FeedsUpdateRequest>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = FeedsUpdateRequest.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
