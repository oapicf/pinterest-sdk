...
class BulkOutputFormat {
  ...
  const BulkOutputFormat._(this.value);
  ...
  static const CSV = BulkOutputFormat._(r'CSV');
  static const JSON = BulkOutputFormat._(r'JSON');

  /// List of all possible values in this [enum][BulkOutputFormat].
  static const values = <BulkOutputFormat>[
    CSV,
    JSON,
  ];
...
class BulkOutputFormatTypeTransformer {
  ...
  String encode(BulkOutputFormat data) => data.value;

  /// Decodes a [dynamic value][data] to a BulkOutputFormat.
  ///
  ...
  /// Singleton [BulkOutputFormatTypeTransformer] instance.
