...
class ScheduleBidOptions {
  /// Returns a new [ScheduleBidOptions] instance.
  ScheduleBidOptions({
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ScheduleBidOptions &&
  ...
  @override
  String toString() => 'ScheduleBidOptions[ageBucketMultipliers=$ageBucketMultipliers, appTypeMultipliers=$appTypeMultipliers, audienceMultipliers=$audienceMultipliers, genderMultipliers=$genderMultipliers, placementMultipliers=$placementMultipliers]';
  ...
  /// Returns a new [ScheduleBidOptions] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ScheduleBidOptions? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<ScheduleBidOptions> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ScheduleBidOptions>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ScheduleBidOptions.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ScheduleBidOptions> mapFromJson(dynamic json) {
    final map = <String, ScheduleBidOptions>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ScheduleBidOptions.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ScheduleBidOptions-objects as value to a dart map
  static Map<String, List<ScheduleBidOptions>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ScheduleBidOptions>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ScheduleBidOptions.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
