...
class ProductCategoryDetails {
  ...
  static ProductCategoryDetails? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'has_prediction'), 'Required key "ProductCategoryDetails[has_prediction]" is missing from JSON.');
        assert(json[r'has_prediction'] != null, 'Required key "ProductCategoryDetails[has_prediction]" has a null value in JSON.');
        assert(json.containsKey(r'product_category'), 'Required key "ProductCategoryDetails[product_category]" is missing from JSON.');
        assert(json[r'product_category'] != null, 'Required key "ProductCategoryDetails[product_category]" has a null value in JSON.');
        return true;
      }());
