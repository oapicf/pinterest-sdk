...
class PinMediaWithVideos {
  ...
  static PinMediaWithVideos? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'media_type'), 'Required key "PinMediaWithVideos[media_type]" is missing from JSON.');
        assert(json[r'media_type'] != null, 'Required key "PinMediaWithVideos[media_type]" has a null value in JSON.');
        return true;
      }());
...
enum PinMediaWithVideosMediaTypeEnum {
  multipleVideos._(r'multiple_videos'),
  ;

  /// Instantiate a new enum with the provided value.
  const PinMediaWithVideosMediaTypeEnum._(this._value);
  ...
  /// Returns the instance of [PinMediaWithVideosMediaTypeEnum] that was successfully decoded
  ...
  /// Returns a [List] containing instances of [PinMediaWithVideosMediaTypeEnum]
...
class PinMediaWithVideosMediaTypeEnumTypeTransformer {
  ...
  String encode(PinMediaWithVideosMediaTypeEnum data) => data._value;
  ...
  PinMediaWithVideosMediaTypeEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data is PinMediaWithVideosMediaTypeEnum) {
      return data;
    }
    if (data != null) {
      switch (data) {
