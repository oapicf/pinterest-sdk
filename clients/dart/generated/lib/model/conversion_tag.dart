...
class ConversionTag {
  ...
  static ConversionTag? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'name'), 'Required key "ConversionTag[name]" is missing from JSON.');
        assert(json[r'name'] != null, 'Required key "ConversionTag[name]" has a null value in JSON.');
        assert(json.containsKey(r'ad_account_id'), 'Required key "ConversionTag[ad_account_id]" is missing from JSON.');
        assert(json[r'ad_account_id'] != null, 'Required key "ConversionTag[ad_account_id]" has a null value in JSON.');
        return true;
      }());
