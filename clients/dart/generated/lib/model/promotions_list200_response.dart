    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "PromotionsList200Response[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "PromotionsList200Response[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return PromotionsList200Response(
        ...
        items: PromotionResponse.listFromJson(json[r'items']),
      );
    }
    return null;
  }
