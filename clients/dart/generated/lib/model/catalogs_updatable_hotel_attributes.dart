...
class CatalogsUpdatableHotelAttributes {
  /// Returns a new [CatalogsUpdatableHotelAttributes] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CatalogsUpdatableHotelAttributes &&
  ...
  @override
  String toString() => 'CatalogsUpdatableHotelAttributes[address=$address, basePrice=$basePrice, brand=$brand, category=$category, customLabel0=$customLabel0, customLabel1=$customLabel1, customLabel2=$customLabel2, customLabel3=$customLabel3, customLabel4=$customLabel4, description=$description, guestRatings=$guestRatings, latitude=$latitude, link=$link, longitude=$longitude, name=$name, neighborhood=$neighborhood, salePrice=$salePrice]';
  ...
  /// Returns a new [CatalogsUpdatableHotelAttributes] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static CatalogsUpdatableHotelAttributes? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return CatalogsUpdatableHotelAttributes(
  ...
  static List<CatalogsUpdatableHotelAttributes> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CatalogsUpdatableHotelAttributes>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CatalogsUpdatableHotelAttributes.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, CatalogsUpdatableHotelAttributes> mapFromJson(dynamic json) {
    final map = <String, CatalogsUpdatableHotelAttributes>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CatalogsUpdatableHotelAttributes.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of CatalogsUpdatableHotelAttributes-objects as value to a dart map
  static Map<String, List<CatalogsUpdatableHotelAttributes>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<CatalogsUpdatableHotelAttributes>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = CatalogsUpdatableHotelAttributes.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
