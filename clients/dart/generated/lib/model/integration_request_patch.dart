...
class IntegrationRequestPatch {
  /// Returns a new [IntegrationRequestPatch] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IntegrationRequestPatch &&
  ...
  @override
  String toString() => 'IntegrationRequestPatch[additionalId1=$additionalId1, connectedAdvertiserId=$connectedAdvertiserId, connectedLbaId=$connectedLbaId, connectedMerchantId=$connectedMerchantId, connectedTagId=$connectedTagId, partnerAccessToken=$partnerAccessToken, partnerAccessTokenExpiry=$partnerAccessTokenExpiry, partnerMetadata=$partnerMetadata, partnerPrimaryEmail=$partnerPrimaryEmail, partnerRefreshToken=$partnerRefreshToken, partnerRefreshTokenExpiry=$partnerRefreshTokenExpiry, scopes=$scopes]';
  ...
  /// Returns a new [IntegrationRequestPatch] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static IntegrationRequestPatch? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IntegrationRequestPatch[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IntegrationRequestPatch[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<IntegrationRequestPatch> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <IntegrationRequestPatch>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = IntegrationRequestPatch.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, IntegrationRequestPatch> mapFromJson(dynamic json) {
    final map = <String, IntegrationRequestPatch>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IntegrationRequestPatch.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of IntegrationRequestPatch-objects as value to a dart map
  static Map<String, List<IntegrationRequestPatch>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IntegrationRequestPatch>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = IntegrationRequestPatch.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
