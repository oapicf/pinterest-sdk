...
class BusinessAssets {
  /// Returns a new [BusinessAssets] instance.
  BusinessAssets({
    this.assetGroupInfo,
    this.assetId,
    this.assetType,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is BusinessAssets &&
  ...
  @override
  String toString() => 'BusinessAssets[assetGroupInfo=$assetGroupInfo, assetId=$assetId, assetType=$assetType, permissions=$permissions, catalogInfo=$catalogInfo]';
  ...
  /// Returns a new [BusinessAssets] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static BusinessAssets? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return BusinessAssets(
        ...
        permissions: json[r'permissions'] is Iterable
            ...
            : const [],
        catalogInfo: CatalogBinding.fromJson(json[r'catalog_info']),
      );
    }
    return null;
  }

  static List<BusinessAssets> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <BusinessAssets>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = BusinessAssets.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, BusinessAssets> mapFromJson(dynamic json) {
    final map = <String, BusinessAssets>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = BusinessAssets.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of BusinessAssets-objects as value to a dart map
  static Map<String, List<BusinessAssets>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<BusinessAssets>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = BusinessAssets.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
