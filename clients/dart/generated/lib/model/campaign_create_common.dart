...
class CampaignCreateCommon {
  /// Returns a new [CampaignCreateCommon] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CampaignCreateCommon &&
  ...
  /// Returns a new [CampaignCreateCommon] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static CampaignCreateCommon? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "CampaignCreateCommon[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "CampaignCreateCommon[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return CampaignCreateCommon(
  ...
  static List<CampaignCreateCommon> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CampaignCreateCommon>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CampaignCreateCommon.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, CampaignCreateCommon> mapFromJson(dynamic json) {
    final map = <String, CampaignCreateCommon>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CampaignCreateCommon.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of CampaignCreateCommon-objects as value to a dart map
  static Map<String, List<CampaignCreateCommon>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<CampaignCreateCommon>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = CampaignCreateCommon.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
