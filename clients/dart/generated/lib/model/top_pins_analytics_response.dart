...
class TopPinsAnalyticsResponse {
  ...
  List<TopPinsAnalyticsResponsePinsItems> pins;
  ...
  static TopPinsAnalyticsResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return TopPinsAnalyticsResponse(
        ...
        pins: TopPinsAnalyticsResponsePinsItems.listFromJson(json[r'pins']),
        sortBy: TopPinsSortBy.fromJson(json[r'sort_by']),
      );
    }
    return null;
  }
