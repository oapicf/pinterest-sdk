...
class AdGroupCreate {
  /// Returns a new [AdGroupCreate] instance.
  AdGroupCreate({
    this.adAccountId,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is AdGroupCreate &&
  ...
  /// Returns a new [AdGroupCreate] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static AdGroupCreate? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'billable_event'), 'Required key "AdGroupCreate[billable_event]" is missing from JSON.');
        assert(json[r'billable_event'] != null, 'Required key "AdGroupCreate[billable_event]" has a null value in JSON.');
        assert(json.containsKey(r'campaign_id'), 'Required key "AdGroupCreate[campaign_id]" is missing from JSON.');
        assert(json[r'campaign_id'] != null, 'Required key "AdGroupCreate[campaign_id]" has a null value in JSON.');
        assert(json.containsKey(r'conversion_learning_mode_type'), 'Required key "AdGroupCreate[conversion_learning_mode_type]" is missing from JSON.');
        assert(json.containsKey(r'created_time'), 'Required key "AdGroupCreate[created_time]" is missing from JSON.');
        assert(json[r'created_time'] != null, 'Required key "AdGroupCreate[created_time]" has a null value in JSON.');
        assert(json.containsKey(r'id'), 'Required key "AdGroupCreate[id]" is missing from JSON.');
        assert(json[r'id'] != null, 'Required key "AdGroupCreate[id]" has a null value in JSON.');
        assert(json.containsKey(r'name'), 'Required key "AdGroupCreate[name]" is missing from JSON.');
        assert(json[r'name'] != null, 'Required key "AdGroupCreate[name]" has a null value in JSON.');
        assert(json.containsKey(r'summary_status'), 'Required key "AdGroupCreate[summary_status]" is missing from JSON.');
        assert(json[r'summary_status'] != null, 'Required key "AdGroupCreate[summary_status]" has a null value in JSON.');
        assert(json.containsKey(r'type'), 'Required key "AdGroupCreate[type]" is missing from JSON.');
        assert(json[r'type'] != null, 'Required key "AdGroupCreate[type]" has a null value in JSON.');
        assert(json.containsKey(r'updated_time'), 'Required key "AdGroupCreate[updated_time]" is missing from JSON.');
        assert(json[r'updated_time'] != null, 'Required key "AdGroupCreate[updated_time]" has a null value in JSON.');
        return true;
      }());
  ...
  static List<AdGroupCreate> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <AdGroupCreate>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = AdGroupCreate.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, AdGroupCreate> mapFromJson(dynamic json) {
    final map = <String, AdGroupCreate>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = AdGroupCreate.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of AdGroupCreate-objects as value to a dart map
  static Map<String, List<AdGroupCreate>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<AdGroupCreate>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = AdGroupCreate.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
