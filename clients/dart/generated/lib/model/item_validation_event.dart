    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ItemValidationEvent[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ItemValidationEvent[$key]" has a null value in JSON.');
        });
        return true;
      }());
