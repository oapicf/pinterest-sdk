...
class ConversionEventsDataItemsCustomData {
  /// Returns a new [ConversionEventsDataItemsCustomData] instance.
  ...
  List<ConversionEventsDataItemsCustomDataContentsItems> contents;
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ConversionEventsDataItemsCustomData &&
  ...
  /// Returns a new [ConversionEventsDataItemsCustomData] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ConversionEventsDataItemsCustomData? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return ConversionEventsDataItemsCustomData(
        ...
        contents: ConversionEventsDataItemsCustomDataContentsItems.listFromJson(json[r'contents']),
  ...
  static List<ConversionEventsDataItemsCustomData> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ConversionEventsDataItemsCustomData>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ConversionEventsDataItemsCustomData.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ConversionEventsDataItemsCustomData> mapFromJson(dynamic json) {
    final map = <String, ConversionEventsDataItemsCustomData>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ConversionEventsDataItemsCustomData.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ConversionEventsDataItemsCustomData-objects as value to a dart map
  static Map<String, List<ConversionEventsDataItemsCustomData>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ConversionEventsDataItemsCustomData>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ConversionEventsDataItemsCustomData.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
