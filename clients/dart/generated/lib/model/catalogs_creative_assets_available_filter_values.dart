...
class CatalogsCreativeAssetsAvailableFilterValues {
  ...
  static CatalogsCreativeAssetsAvailableFilterValues? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'catalog_type'), 'Required key "CatalogsCreativeAssetsAvailableFilterValues[catalog_type]" is missing from JSON.');
        assert(json[r'catalog_type'] != null, 'Required key "CatalogsCreativeAssetsAvailableFilterValues[catalog_type]" has a null value in JSON.');
        assert(json.containsKey(r'filter_values'), 'Required key "CatalogsCreativeAssetsAvailableFilterValues[filter_values]" is missing from JSON.');
        assert(json[r'filter_values'] != null, 'Required key "CatalogsCreativeAssetsAvailableFilterValues[filter_values]" has a null value in JSON.');
        return true;
      }());
...
enum CatalogsCreativeAssetsAvailableFilterValuesCatalogTypeEnum {
  CREATIVE_ASSETS._(r'CREATIVE_ASSETS'),
  ;

  /// Instantiate a new enum with the provided value.
  const CatalogsCreativeAssetsAvailableFilterValuesCatalogTypeEnum._(this._value);
  ...
  /// Returns the instance of [CatalogsCreativeAssetsAvailableFilterValuesCatalogTypeEnum] that was successfully decoded
  ...
  /// Returns a [List] containing instances of [CatalogsCreativeAssetsAvailableFilterValuesCatalogTypeEnum]
...
class CatalogsCreativeAssetsAvailableFilterValuesCatalogTypeEnumTypeTransformer {
  ...
  String encode(CatalogsCreativeAssetsAvailableFilterValuesCatalogTypeEnum data) => data._value;
  ...
  CatalogsCreativeAssetsAvailableFilterValuesCatalogTypeEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data is CatalogsCreativeAssetsAvailableFilterValuesCatalogTypeEnum) {
      return data;
    }
    if (data != null) {
      switch (data) {
