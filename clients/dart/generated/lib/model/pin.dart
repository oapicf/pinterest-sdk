...
class Pin {
  ...
  static List<Pin> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <Pin>[];
  ...
  static Map<String, List<Pin>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<Pin>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = Pin.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
