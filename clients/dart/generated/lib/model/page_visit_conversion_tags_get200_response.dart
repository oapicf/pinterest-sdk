    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "PageVisitConversionTagsGet200Response[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "PageVisitConversionTagsGet200Response[$key]" has a null value in JSON.');
        });
        return true;
      }());
