    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ProductGroupPromotionsList200Response[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ProductGroupPromotionsList200Response[$key]" has a null value in JSON.');
        });
        return true;
      }());
