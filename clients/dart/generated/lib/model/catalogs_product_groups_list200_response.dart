    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "CatalogsProductGroupsList200Response[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "CatalogsProductGroupsList200Response[$key]" has a null value in JSON.');
        });
        return true;
      }());
