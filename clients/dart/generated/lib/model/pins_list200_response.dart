...
class PinsList200Response {
  ...
  static PinsList200Response? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'items'), 'Required key "PinsList200Response[items]" is missing from JSON.');
        assert(json[r'items'] != null, 'Required key "PinsList200Response[items]" has a null value in JSON.');
        return true;
      }());
