...
class AudienceRule {
  /// Returns a new [AudienceRule] instance.
  AudienceRule({
    this.adAccountId,
    this.adId = const [],
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is AudienceRule &&
  ...
  /// Returns a new [AudienceRule] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static AudienceRule? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "AudienceRule[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "AudienceRule[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<AudienceRule> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <AudienceRule>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = AudienceRule.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, AudienceRule> mapFromJson(dynamic json) {
    final map = <String, AudienceRule>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = AudienceRule.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of AudienceRule-objects as value to a dart map
  static Map<String, List<AudienceRule>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<AudienceRule>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = AudienceRule.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
