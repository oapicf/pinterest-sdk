  ...
  static List<UserListOperationType> listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = UserListOperationType.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [UserListOperationType] to String,
/// and [decode] dynamic data back to [UserListOperationType].
class UserListOperationTypeTypeTransformer {
  factory UserListOperationTypeTypeTransformer() => _instance ??= const UserListOperationTypeTypeTransformer._();
  ...
  UserListOperationType? decode(dynamic data, {bool allowNull = true}) {
    ...
    if (data != null) {
      switch (data) {
        ...
        case r'REMOVE': return UserListOperationType.REMOVE;
        default:
          if (!allowNull) {
