...
class ConversionEventsDataInner {
  /// Returns a new [ConversionEventsDataInner] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ConversionEventsDataInner &&
  ...
  /// Returns a new [ConversionEventsDataInner] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ConversionEventsDataInner? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ConversionEventsDataInner[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ConversionEventsDataInner[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return ConversionEventsDataInner(
        ...
        customData: ConversionEventsDataInnerCustomData.fromJson(json[r'custom_data']),
        ...
        userData: ConversionEventsUserData.fromJson(json[r'user_data'])!,
  ...
  static List<ConversionEventsDataInner> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ConversionEventsDataInner>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ConversionEventsDataInner.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ConversionEventsDataInner> mapFromJson(dynamic json) {
    final map = <String, ConversionEventsDataInner>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ConversionEventsDataInner.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ConversionEventsDataInner-objects as value to a dart map
  static Map<String, List<ConversionEventsDataInner>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ConversionEventsDataInner>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ConversionEventsDataInner.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
