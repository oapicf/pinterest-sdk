...
class LeadFormBatchUpdate {
  /// Returns a new [LeadFormBatchUpdate] instance.
  LeadFormBatchUpdate({
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is LeadFormBatchUpdate &&
  ...
  @override
  String toString() => 'LeadFormBatchUpdate[completionMessage=$completionMessage, disclosureLanguage=$disclosureLanguage, hasAcceptedTerms=$hasAcceptedTerms, id=$id, name=$name, policyLinks=$policyLinks, privacyPolicyLink=$privacyPolicyLink, questions=$questions, status=$status]';
  ...
  /// Returns a new [LeadFormBatchUpdate] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static LeadFormBatchUpdate? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'id'), 'Required key "LeadFormBatchUpdate[id]" is missing from JSON.');
        assert(json[r'id'] != null, 'Required key "LeadFormBatchUpdate[id]" has a null value in JSON.');
        return true;
      }());

      return LeadFormBatchUpdate(
  ...
  static List<LeadFormBatchUpdate> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <LeadFormBatchUpdate>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = LeadFormBatchUpdate.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, LeadFormBatchUpdate> mapFromJson(dynamic json) {
    final map = <String, LeadFormBatchUpdate>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = LeadFormBatchUpdate.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of LeadFormBatchUpdate-objects as value to a dart map
  static Map<String, List<LeadFormBatchUpdate>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<LeadFormBatchUpdate>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = LeadFormBatchUpdate.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
