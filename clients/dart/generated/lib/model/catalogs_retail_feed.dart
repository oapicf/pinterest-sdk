    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "CatalogsRetailFeed[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "CatalogsRetailFeed[$key]" has a null value in JSON.');
        });
        return true;
      }());
