...
class CatalogsFeed {
  ...
  /// Returns a new [CatalogsFeed] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static CatalogsFeed? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<CatalogsFeed> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CatalogsFeed>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CatalogsFeed.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, CatalogsFeed> mapFromJson(dynamic json) {
    final map = <String, CatalogsFeed>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CatalogsFeed.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of CatalogsFeed-objects as value to a dart map
  static Map<String, List<CatalogsFeed>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<CatalogsFeed>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = CatalogsFeed.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
