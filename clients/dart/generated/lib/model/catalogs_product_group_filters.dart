...
class CatalogsProductGroupFilters {
  ...
  static CatalogsProductGroupFilters? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'any_of'), 'Required key "CatalogsProductGroupFilters[any_of]" is missing from JSON.');
        assert(json[r'any_of'] != null, 'Required key "CatalogsProductGroupFilters[any_of]" has a null value in JSON.');
        assert(json.containsKey(r'all_of'), 'Required key "CatalogsProductGroupFilters[all_of]" is missing from JSON.');
        assert(json[r'all_of'] != null, 'Required key "CatalogsProductGroupFilters[all_of]" has a null value in JSON.');
        return true;
      }());
