...
class IntegrationMetadataCreate {
  /// Returns a new [IntegrationMetadataCreate] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IntegrationMetadataCreate &&
  ...
  @override
  String toString() => 'IntegrationMetadataCreate[additionalId1=$additionalId1, connectedAdvertiserId=$connectedAdvertiserId, connectedLbaId=$connectedLbaId, connectedMerchantId=$connectedMerchantId, connectedTagId=$connectedTagId, externalBusinessId=$externalBusinessId, partnerAccessToken=$partnerAccessToken, partnerAccessTokenExpiry=$partnerAccessTokenExpiry, partnerMetadata=$partnerMetadata, partnerPrimaryEmail=$partnerPrimaryEmail, partnerRefreshToken=$partnerRefreshToken, partnerRefreshTokenExpiry=$partnerRefreshTokenExpiry, scopes=$scopes]';
  ...
  /// Returns a new [IntegrationMetadataCreate] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static IntegrationMetadataCreate? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return IntegrationMetadataCreate(
  ...
  static List<IntegrationMetadataCreate> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <IntegrationMetadataCreate>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = IntegrationMetadataCreate.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, IntegrationMetadataCreate> mapFromJson(dynamic json) {
    final map = <String, IntegrationMetadataCreate>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IntegrationMetadataCreate.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of IntegrationMetadataCreate-objects as value to a dart map
  static Map<String, List<IntegrationMetadataCreate>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IntegrationMetadataCreate>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = IntegrationMetadataCreate.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
