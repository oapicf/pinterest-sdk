...
class AdGroupBase {
  /// Returns a new [AdGroupBase] instance.
  AdGroupBase({
    this.adAccountId,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is AdGroupBase &&
  ...
  /// Returns a new [AdGroupBase] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static AdGroupBase? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'billable_event'), 'Required key "AdGroupBase[billable_event]" is missing from JSON.');
        assert(json[r'billable_event'] != null, 'Required key "AdGroupBase[billable_event]" has a null value in JSON.');
        assert(json.containsKey(r'campaign_id'), 'Required key "AdGroupBase[campaign_id]" is missing from JSON.');
        assert(json[r'campaign_id'] != null, 'Required key "AdGroupBase[campaign_id]" has a null value in JSON.');
        assert(json.containsKey(r'conversion_learning_mode_type'), 'Required key "AdGroupBase[conversion_learning_mode_type]" is missing from JSON.');
        assert(json.containsKey(r'created_time'), 'Required key "AdGroupBase[created_time]" is missing from JSON.');
        assert(json[r'created_time'] != null, 'Required key "AdGroupBase[created_time]" has a null value in JSON.');
        assert(json.containsKey(r'id'), 'Required key "AdGroupBase[id]" is missing from JSON.');
        assert(json[r'id'] != null, 'Required key "AdGroupBase[id]" has a null value in JSON.');
        assert(json.containsKey(r'name'), 'Required key "AdGroupBase[name]" is missing from JSON.');
        assert(json[r'name'] != null, 'Required key "AdGroupBase[name]" has a null value in JSON.');
        assert(json.containsKey(r'summary_status'), 'Required key "AdGroupBase[summary_status]" is missing from JSON.');
        assert(json[r'summary_status'] != null, 'Required key "AdGroupBase[summary_status]" has a null value in JSON.');
        assert(json.containsKey(r'type'), 'Required key "AdGroupBase[type]" is missing from JSON.');
        assert(json[r'type'] != null, 'Required key "AdGroupBase[type]" has a null value in JSON.');
        assert(json.containsKey(r'updated_time'), 'Required key "AdGroupBase[updated_time]" is missing from JSON.');
        assert(json[r'updated_time'] != null, 'Required key "AdGroupBase[updated_time]" has a null value in JSON.');
        return true;
      }());
  ...
  static List<AdGroupBase> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <AdGroupBase>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = AdGroupBase.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, AdGroupBase> mapFromJson(dynamic json) {
    final map = <String, AdGroupBase>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = AdGroupBase.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of AdGroupBase-objects as value to a dart map
  static Map<String, List<AdGroupBase>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<AdGroupBase>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = AdGroupBase.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
