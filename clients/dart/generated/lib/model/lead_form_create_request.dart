...
class LeadFormCreateRequest {
  /// Returns a new [LeadFormCreateRequest] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is LeadFormCreateRequest &&
  ...
  @override
  String toString() => 'LeadFormCreateRequest[completionMessage=$completionMessage, disclosureLanguage=$disclosureLanguage, hasAcceptedTerms=$hasAcceptedTerms, name=$name, policyLinks=$policyLinks, privacyPolicyLink=$privacyPolicyLink, questions=$questions, status=$status]';
  ...
  /// Returns a new [LeadFormCreateRequest] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static LeadFormCreateRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "LeadFormCreateRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "LeadFormCreateRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<LeadFormCreateRequest> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <LeadFormCreateRequest>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = LeadFormCreateRequest.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, LeadFormCreateRequest> mapFromJson(dynamic json) {
    final map = <String, LeadFormCreateRequest>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = LeadFormCreateRequest.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of LeadFormCreateRequest-objects as value to a dart map
  static Map<String, List<LeadFormCreateRequest>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<LeadFormCreateRequest>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = LeadFormCreateRequest.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
