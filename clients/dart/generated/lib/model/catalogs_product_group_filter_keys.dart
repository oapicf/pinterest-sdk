...
class CatalogsProductGroupFilterKeys {
  /// Returns a new [CatalogsProductGroupFilterKeys] instance.
  ...
  /// Returns a new [CatalogsProductGroupFilterKeys] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static CatalogsProductGroupFilterKeys? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<CatalogsProductGroupFilterKeys> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CatalogsProductGroupFilterKeys>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CatalogsProductGroupFilterKeys.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, CatalogsProductGroupFilterKeys> mapFromJson(dynamic json) {
    final map = <String, CatalogsProductGroupFilterKeys>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CatalogsProductGroupFilterKeys.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of CatalogsProductGroupFilterKeys-objects as value to a dart map
  static Map<String, List<CatalogsProductGroupFilterKeys>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<CatalogsProductGroupFilterKeys>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = CatalogsProductGroupFilterKeys.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
