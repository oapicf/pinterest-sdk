...
class AdGroupCreateCreate {
  /// Returns a new [AdGroupCreateCreate] instance.
  AdGroupCreateCreate({
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is AdGroupCreateCreate &&
  ...
  /// Returns a new [AdGroupCreateCreate] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static AdGroupCreateCreate? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'billable_event'), 'Required key "AdGroupCreateCreate[billable_event]" is missing from JSON.');
        assert(json[r'billable_event'] != null, 'Required key "AdGroupCreateCreate[billable_event]" has a null value in JSON.');
        assert(json.containsKey(r'campaign_id'), 'Required key "AdGroupCreateCreate[campaign_id]" is missing from JSON.');
        assert(json[r'campaign_id'] != null, 'Required key "AdGroupCreateCreate[campaign_id]" has a null value in JSON.');
        assert(json.containsKey(r'name'), 'Required key "AdGroupCreateCreate[name]" is missing from JSON.');
        assert(json[r'name'] != null, 'Required key "AdGroupCreateCreate[name]" has a null value in JSON.');
        return true;
      }());

      return AdGroupCreateCreate(
  ...
  static List<AdGroupCreateCreate> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <AdGroupCreateCreate>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = AdGroupCreateCreate.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, AdGroupCreateCreate> mapFromJson(dynamic json) {
    final map = <String, AdGroupCreateCreate>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = AdGroupCreateCreate.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of AdGroupCreateCreate-objects as value to a dart map
  static Map<String, List<AdGroupCreateCreate>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<AdGroupCreateCreate>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = AdGroupCreateCreate.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
