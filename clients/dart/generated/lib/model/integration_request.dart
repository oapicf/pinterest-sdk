...
class IntegrationRequest {
  ...
  /// Returns a new [IntegrationRequest] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static IntegrationRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IntegrationRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IntegrationRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<IntegrationRequest> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <IntegrationRequest>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = IntegrationRequest.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, IntegrationRequest> mapFromJson(dynamic json) {
    final map = <String, IntegrationRequest>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IntegrationRequest.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of IntegrationRequest-objects as value to a dart map
  static Map<String, List<IntegrationRequest>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IntegrationRequest>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = IntegrationRequest.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
