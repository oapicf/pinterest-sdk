...
enum CatalogsProductGroupStatus {
  ...
  const CatalogsProductGroupStatus._(this._value);
  ...
  /// Returns the instance of [CatalogsProductGroupStatus] that was successfully decoded
  /// from the passed [value] on success, null otherwise.
  static CatalogsProductGroupStatus? fromJson(dynamic value) => CatalogsProductGroupStatusTypeTransformer().decode(value);

  /// Returns a [List] containing instances of [CatalogsProductGroupStatus]
...
class CatalogsProductGroupStatusTypeTransformer {
  ...
  /// Encodes this enum as a value suitable for JSON.
  String encode(CatalogsProductGroupStatus data) => data._value;
  ...
  CatalogsProductGroupStatus? decode(dynamic data, {bool allowNull = true}) {
    if (data is CatalogsProductGroupStatus) {
      return data;
    }
    if (data != null) {
      switch (data) {
