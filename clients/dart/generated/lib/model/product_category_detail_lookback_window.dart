...
enum ProductCategoryDetailLookbackWindow {
  ...
  const ProductCategoryDetailLookbackWindow._(this._value);
  ...
  /// Returns the instance of [ProductCategoryDetailLookbackWindow] that was successfully decoded
  ...
  /// Returns a [List] containing instances of [ProductCategoryDetailLookbackWindow]
...
class ProductCategoryDetailLookbackWindowTypeTransformer {
  ...
  /// Encodes this enum as a value suitable for JSON.
  num encode(ProductCategoryDetailLookbackWindow data) => data._value;
  ...
  ProductCategoryDetailLookbackWindow? decode(dynamic data, {bool allowNull = true}) {
    if (data is ProductCategoryDetailLookbackWindow) {
      return data;
    }
    if (data != null) {
      switch (data) {
