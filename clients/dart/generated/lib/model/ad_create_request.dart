...
class AdCreateRequest {
  /// Returns a new [AdCreateRequest] instance.
  AdCreateRequest({
  ...
  /// Returns a new [AdCreateRequest] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static AdCreateRequest? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<AdCreateRequest> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <AdCreateRequest>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = AdCreateRequest.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, AdCreateRequest> mapFromJson(dynamic json) {
    final map = <String, AdCreateRequest>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = AdCreateRequest.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of AdCreateRequest-objects as value to a dart map
  static Map<String, List<AdCreateRequest>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<AdCreateRequest>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = AdCreateRequest.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
