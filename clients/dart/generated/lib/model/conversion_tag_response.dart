    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ConversionTagResponse[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ConversionTagResponse[$key]" has a null value in JSON.');
        });
        return true;
      }());
