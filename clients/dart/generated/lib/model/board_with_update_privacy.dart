...
class BoardWithUpdatePrivacy {
  /// Returns a new [BoardWithUpdatePrivacy] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is BoardWithUpdatePrivacy &&
  ...
  @override
  String toString() => 'BoardWithUpdatePrivacy[boardPinsModifiedAt=$boardPinsModifiedAt, collaboratorCount=$collaboratorCount, createdAt=$createdAt, description=$description, followerCount=$followerCount, id=$id, isAdsOnly=$isAdsOnly, media=$media, name=$name, owner=$owner, pinCount=$pinCount, privacy=$privacy]';
  ...
  /// Returns a new [BoardWithUpdatePrivacy] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static BoardWithUpdatePrivacy? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<BoardWithUpdatePrivacy> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <BoardWithUpdatePrivacy>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = BoardWithUpdatePrivacy.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, BoardWithUpdatePrivacy> mapFromJson(dynamic json) {
    final map = <String, BoardWithUpdatePrivacy>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = BoardWithUpdatePrivacy.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of BoardWithUpdatePrivacy-objects as value to a dart map
  static Map<String, List<BoardWithUpdatePrivacy>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<BoardWithUpdatePrivacy>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = BoardWithUpdatePrivacy.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
