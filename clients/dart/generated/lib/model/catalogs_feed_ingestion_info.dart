    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "CatalogsFeedIngestionInfo[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "CatalogsFeedIngestionInfo[$key]" has a null value in JSON.');
        });
        return true;
      }());
