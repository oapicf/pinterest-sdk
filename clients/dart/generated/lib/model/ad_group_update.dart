...
class AdGroupUpdate {
  /// Returns a new [AdGroupUpdate] instance.
  AdGroupUpdate({
    this.adAccountId,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is AdGroupUpdate &&
  ...
  /// Returns a new [AdGroupUpdate] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static AdGroupUpdate? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'billable_event'), 'Required key "AdGroupUpdate[billable_event]" is missing from JSON.');
        assert(json[r'billable_event'] != null, 'Required key "AdGroupUpdate[billable_event]" has a null value in JSON.');
        assert(json.containsKey(r'campaign_id'), 'Required key "AdGroupUpdate[campaign_id]" is missing from JSON.');
        assert(json[r'campaign_id'] != null, 'Required key "AdGroupUpdate[campaign_id]" has a null value in JSON.');
        assert(json.containsKey(r'conversion_learning_mode_type'), 'Required key "AdGroupUpdate[conversion_learning_mode_type]" is missing from JSON.');
        assert(json.containsKey(r'created_time'), 'Required key "AdGroupUpdate[created_time]" is missing from JSON.');
        assert(json[r'created_time'] != null, 'Required key "AdGroupUpdate[created_time]" has a null value in JSON.');
        assert(json.containsKey(r'id'), 'Required key "AdGroupUpdate[id]" is missing from JSON.');
        assert(json[r'id'] != null, 'Required key "AdGroupUpdate[id]" has a null value in JSON.');
        assert(json.containsKey(r'name'), 'Required key "AdGroupUpdate[name]" is missing from JSON.');
        assert(json[r'name'] != null, 'Required key "AdGroupUpdate[name]" has a null value in JSON.');
        assert(json.containsKey(r'summary_status'), 'Required key "AdGroupUpdate[summary_status]" is missing from JSON.');
        assert(json[r'summary_status'] != null, 'Required key "AdGroupUpdate[summary_status]" has a null value in JSON.');
        assert(json.containsKey(r'type'), 'Required key "AdGroupUpdate[type]" is missing from JSON.');
        assert(json[r'type'] != null, 'Required key "AdGroupUpdate[type]" has a null value in JSON.');
        assert(json.containsKey(r'updated_time'), 'Required key "AdGroupUpdate[updated_time]" is missing from JSON.');
        assert(json[r'updated_time'] != null, 'Required key "AdGroupUpdate[updated_time]" has a null value in JSON.');
        return true;
      }());
  ...
  static List<AdGroupUpdate> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <AdGroupUpdate>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = AdGroupUpdate.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, AdGroupUpdate> mapFromJson(dynamic json) {
    final map = <String, AdGroupUpdate>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = AdGroupUpdate.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of AdGroupUpdate-objects as value to a dart map
  static Map<String, List<AdGroupUpdate>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<AdGroupUpdate>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = AdGroupUpdate.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
