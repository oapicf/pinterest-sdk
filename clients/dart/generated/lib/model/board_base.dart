...
class BoardBase {
  ...
  static BoardBase? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'id'), 'Required key "BoardBase[id]" is missing from JSON.');
        assert(json[r'id'] != null, 'Required key "BoardBase[id]" has a null value in JSON.');
        assert(json.containsKey(r'name'), 'Required key "BoardBase[name]" is missing from JSON.');
        assert(json[r'name'] != null, 'Required key "BoardBase[name]" has a null value in JSON.');
        return true;
      }());
