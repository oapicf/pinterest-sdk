...
class CatalogsCreativeAssetsAttributes {
  /// Returns a new [CatalogsCreativeAssetsAttributes] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CatalogsCreativeAssetsAttributes &&
  ...
  /// Returns a new [CatalogsCreativeAssetsAttributes] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static CatalogsCreativeAssetsAttributes? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return CatalogsCreativeAssetsAttributes(
  ...
  static List<CatalogsCreativeAssetsAttributes> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CatalogsCreativeAssetsAttributes>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CatalogsCreativeAssetsAttributes.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, CatalogsCreativeAssetsAttributes> mapFromJson(dynamic json) {
    final map = <String, CatalogsCreativeAssetsAttributes>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CatalogsCreativeAssetsAttributes.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of CatalogsCreativeAssetsAttributes-objects as value to a dart map
  static Map<String, List<CatalogsCreativeAssetsAttributes>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<CatalogsCreativeAssetsAttributes>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = CatalogsCreativeAssetsAttributes.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
