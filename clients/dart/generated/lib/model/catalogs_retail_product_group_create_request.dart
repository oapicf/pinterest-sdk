    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "CatalogsRetailProductGroupCreateRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "CatalogsRetailProductGroupCreateRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());
...
/// Retail catalog based product group is available only for selected partners at the moment. If you are not eligible, please use feed based one.
class CatalogsRetailProductGroupCreateRequestCatalogTypeEnum {
  /// Instantiate a new enum with the provided [value].
  const CatalogsRetailProductGroupCreateRequestCatalogTypeEnum._(this.value);
  ...
  static const RETAIL = CatalogsRetailProductGroupCreateRequestCatalogTypeEnum._(r'RETAIL');

  /// List of all possible values in this [enum][CatalogsRetailProductGroupCreateRequestCatalogTypeEnum].
  static const values = <CatalogsRetailProductGroupCreateRequestCatalogTypeEnum>[
    RETAIL,
  ];
...
class CatalogsRetailProductGroupCreateRequestCatalogTypeEnumTypeTransformer {
  ...
  String encode(CatalogsRetailProductGroupCreateRequestCatalogTypeEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a CatalogsRetailProductGroupCreateRequestCatalogTypeEnum.
  ///
  ...
  /// Singleton [CatalogsRetailProductGroupCreateRequestCatalogTypeEnumTypeTransformer] instance.
