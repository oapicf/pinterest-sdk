...
class CatalogsItemsPostFilters {
  ...
  @override
  String toString() => 'CatalogsItemsPostFilters[catalogType=$catalogType, catalogId=$catalogId, itemIds=$itemIds, hotelIds=$hotelIds, creativeAssetsIds=$creativeAssetsIds]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "CatalogsItemsPostFilters[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "CatalogsItemsPostFilters[$key]" has a null value in JSON.');
        });
        return true;
      }());
