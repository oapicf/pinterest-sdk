...
class CatalogsHotelReportStatsParameters {
  ...
  static CatalogsHotelReportStatsParameters? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'catalog_type'), 'Required key "CatalogsHotelReportStatsParameters[catalog_type]" is missing from JSON.');
        assert(json[r'catalog_type'] != null, 'Required key "CatalogsHotelReportStatsParameters[catalog_type]" has a null value in JSON.');
        assert(json.containsKey(r'report'), 'Required key "CatalogsHotelReportStatsParameters[report]" is missing from JSON.');
        assert(json[r'report'] != null, 'Required key "CatalogsHotelReportStatsParameters[report]" has a null value in JSON.');
        return true;
      }());
...
enum CatalogsHotelReportStatsParametersCatalogTypeEnum {
  HOTEL._(r'HOTEL'),
  ;

  /// Instantiate a new enum with the provided value.
  const CatalogsHotelReportStatsParametersCatalogTypeEnum._(this._value);
  ...
  /// Returns the instance of [CatalogsHotelReportStatsParametersCatalogTypeEnum] that was successfully decoded
  ...
  /// Returns a [List] containing instances of [CatalogsHotelReportStatsParametersCatalogTypeEnum]
...
class CatalogsHotelReportStatsParametersCatalogTypeEnumTypeTransformer {
  ...
  String encode(CatalogsHotelReportStatsParametersCatalogTypeEnum data) => data._value;
  ...
  CatalogsHotelReportStatsParametersCatalogTypeEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data is CatalogsHotelReportStatsParametersCatalogTypeEnum) {
      return data;
    }
    if (data != null) {
      switch (data) {
