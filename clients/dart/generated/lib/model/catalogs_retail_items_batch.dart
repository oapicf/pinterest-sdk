...
class CatalogsRetailItemsBatch {
  /// Returns a new [CatalogsRetailItemsBatch] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CatalogsRetailItemsBatch &&
  ...
  @override
  String toString() => 'CatalogsRetailItemsBatch[batchId=$batchId, catalogType=$catalogType, completedTime=$completedTime, createdTime=$createdTime, items=$items, status=$status]';
  ...
  /// Returns a new [CatalogsRetailItemsBatch] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static CatalogsRetailItemsBatch? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<CatalogsRetailItemsBatch> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CatalogsRetailItemsBatch>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CatalogsRetailItemsBatch.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, CatalogsRetailItemsBatch> mapFromJson(dynamic json) {
    final map = <String, CatalogsRetailItemsBatch>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CatalogsRetailItemsBatch.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of CatalogsRetailItemsBatch-objects as value to a dart map
  static Map<String, List<CatalogsRetailItemsBatch>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<CatalogsRetailItemsBatch>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = CatalogsRetailItemsBatch.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
