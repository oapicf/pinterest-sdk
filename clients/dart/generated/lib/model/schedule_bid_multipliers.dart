...
class ScheduleBidMultipliers {
  /// Returns a new [ScheduleBidMultipliers] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ScheduleBidMultipliers &&
  ...
  @override
  String toString() => 'ScheduleBidMultipliers[ageBucketMultipliers=$ageBucketMultipliers, appTypeMultipliers=$appTypeMultipliers, audienceMultipliers=$audienceMultipliers, genderMultipliers=$genderMultipliers, placementMultipliers=$placementMultipliers]';
  ...
  /// Returns a new [ScheduleBidMultipliers] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ScheduleBidMultipliers? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<ScheduleBidMultipliers> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ScheduleBidMultipliers>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ScheduleBidMultipliers.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ScheduleBidMultipliers> mapFromJson(dynamic json) {
    final map = <String, ScheduleBidMultipliers>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ScheduleBidMultipliers.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ScheduleBidMultipliers-objects as value to a dart map
  static Map<String, List<ScheduleBidMultipliers>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ScheduleBidMultipliers>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ScheduleBidMultipliers.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
