...
class MediaTypeFilter {
  ...
  static MediaTypeFilter? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'MEDIA_TYPE'), 'Required key "MediaTypeFilter[MEDIA_TYPE]" is missing from JSON.');
        assert(json[r'MEDIA_TYPE'] != null, 'Required key "MediaTypeFilter[MEDIA_TYPE]" has a null value in JSON.');
        return true;
      }());
