...
class CampaignCreateRequestAllOf1 {
  /// Returns a new [CampaignCreateRequestAllOf1] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CampaignCreateRequestAllOf1 &&
  ...
  /// Returns a new [CampaignCreateRequestAllOf1] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static CampaignCreateRequestAllOf1? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'objective_type'), 'Required key "CampaignCreateRequestAllOf1[objective_type]" is missing from JSON.');
        assert(json[r'objective_type'] != null, 'Required key "CampaignCreateRequestAllOf1[objective_type]" has a null value in JSON.');
        return true;
      }());

      return CampaignCreateRequestAllOf1(
  ...
  static List<CampaignCreateRequestAllOf1> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CampaignCreateRequestAllOf1>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CampaignCreateRequestAllOf1.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, CampaignCreateRequestAllOf1> mapFromJson(dynamic json) {
    final map = <String, CampaignCreateRequestAllOf1>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CampaignCreateRequestAllOf1.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of CampaignCreateRequestAllOf1-objects as value to a dart map
  static Map<String, List<CampaignCreateRequestAllOf1>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<CampaignCreateRequestAllOf1>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = CampaignCreateRequestAllOf1.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
