...
class AdvancedAuctionApi {
  ...
  Future<Response> advancedAuctionItemsGetPostWithHttpInfo(AdvancedAuctionItemsGetRequest advancedAuctionItemsGetRequest, { String? adAccountId, Future<void>? abortTrigger, }) async {
  ...
  /// * [String] adAccountId:
  ///   Unique identifier of an ad account.
  Future<AdvancedAuctionItems?> advancedAuctionItemsGetPost(AdvancedAuctionItemsGetRequest advancedAuctionItemsGetRequest, { String? adAccountId, Future<void>? abortTrigger, }) async {
    final response = await advancedAuctionItemsGetPostWithHttpInfo(advancedAuctionItemsGetRequest, adAccountId: adAccountId, abortTrigger: abortTrigger,);
  ...
  /// * [String] adAccountId:
  ///   Unique identifier of an ad account.
  Future<Response> advancedAuctionItemsSubmitPostWithHttpInfo(AdvancedAuctionItemsSubmitRequest advancedAuctionItemsSubmitRequest, { String? adAccountId, Future<void>? abortTrigger, }) async {
    // ignore: prefer_const_declarations
  ...
  /// * [String] adAccountId:
  ///   Unique identifier of an ad account.
  Future<AdvancedAuctionProcessedItems?> advancedAuctionItemsSubmitPost(AdvancedAuctionItemsSubmitRequest advancedAuctionItemsSubmitRequest, { String? adAccountId, Future<void>? abortTrigger, }) async {
    final response = await advancedAuctionItemsSubmitPostWithHttpInfo(advancedAuctionItemsSubmitRequest, adAccountId: adAccountId, abortTrigger: abortTrigger,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
