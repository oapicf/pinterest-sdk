...
class ConversionsApi {
  ...
  Future<Response> advertiserDefinedEventsGetWithHttpInfo(String adAccountId,) async {
  ...
  Future<AdvertiserDefinedEventsResponse?> advertiserDefinedEventsGet(String adAccountId,) async {
    final response = await advertiserDefinedEventsGetWithHttpInfo(adAccountId,);
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'AdvertiserDefinedEventsResponse',) as AdvertiserDefinedEventsResponse;
