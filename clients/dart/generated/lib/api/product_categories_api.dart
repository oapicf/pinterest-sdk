...
class ProductCategoriesApi {
  ProductCategoriesApi([ApiClient? apiClient]) : apiClient = apiClient ?? defaultApiClient;
  ...
  Future<Response> trendsFeaturedTopicsListWithHttpInfo(ProductCategoryRegion region, { InterestsEnum? interest, }) async {
  ...
  /// * [InterestsEnum] interest:
  ///   Interest to filter by
  Future<List<FeaturedTrend>?> trendsFeaturedTopicsList(ProductCategoryRegion region, { InterestsEnum? interest, }) async {
    final response = await trendsFeaturedTopicsListWithHttpInfo(region,  interest: interest, );
  ...
  Future<Response> trendsProductCategoriesDetailsListWithHttpInfo(List<ProductCategoryEnum> productCategories, ProductCategoryRegion region, { ProductCategoryDetailLookbackWindow? lookbackWindow, ProductCategoriesEngagementType? engagementType, }) async {
    // ignore: prefer_const_declarations
  ...
  /// * [ProductCategoriesEngagementType] engagementType:
  ///        Type of engagement metric to analyze. - `ENGAGEMENT` - Overall engagement metric - `OUTBOUND_CLICK` - Number of outbound clicks - `SAVE` - Number of pin saves
  Future<List<ProductCategoryDetails>?> trendsProductCategoriesDetailsList(List<ProductCategoryEnum> productCategories, ProductCategoryRegion region, { ProductCategoryDetailLookbackWindow? lookbackWindow, ProductCategoriesEngagementType? engagementType, }) async {
    final response = await trendsProductCategoriesDetailsListWithHttpInfo(productCategories, region,  lookbackWindow: lookbackWindow, engagementType: engagementType, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  /// * [ProductCategoriesEngagementType] engagementType:
  ///        Type of engagement metric to analyze. - `ENGAGEMENT` - Overall engagement metric - `OUTBOUND_CLICK` - Number of outbound clicks - `SAVE` - Number of pin saves
  Future<Response> trendsProductCategoriesTrendingListWithHttpInfo(ProductCategoryRegion region, { List<VerticalProductCategory>? verticals, List<AgeTrendsBucket>? ages, List<GenderBucket>? genders, ProductCategoriesEngagementType? engagementType, }) async {
    // ignore: prefer_const_declarations
  ...
  /// * [ProductCategoriesEngagementType] engagementType:
  ///        Type of engagement metric to analyze. - `ENGAGEMENT` - Overall engagement metric - `OUTBOUND_CLICK` - Number of outbound clicks - `SAVE` - Number of pin saves
  Future<List<TrendingProductCategory>?> trendsProductCategoriesTrendingList(ProductCategoryRegion region, { List<VerticalProductCategory>? verticals, List<AgeTrendsBucket>? ages, List<GenderBucket>? genders, ProductCategoriesEngagementType? engagementType, }) async {
    final response = await trendsProductCategoriesTrendingListWithHttpInfo(region,  verticals: verticals, ages: ages, genders: genders, engagementType: engagementType, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
