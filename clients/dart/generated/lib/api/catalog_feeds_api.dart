...
class CatalogFeedsApi {
  ...
  Future<Response> feedProcessingResultsListWithHttpInfo(String feedId, { String? bookmark, int? pageSize, String? adAccountId, }) async {
  ...
  Future<FeedProcessingResultsList200Response?> feedProcessingResultsList(String feedId, { String? bookmark, int? pageSize, String? adAccountId, }) async {
    final response = await feedProcessingResultsListWithHttpInfo(feedId,  bookmark: bookmark, pageSize: pageSize, adAccountId: adAccountId, );
  ...
  /// Parameters:
  ///
  /// * [FeedsCreateRequest] feedsCreateRequest (required):
  ///   Request object used to created a feed.
  ///
  /// * [String] adAccountId:
  ///   Unique identifier of an ad account.
  Future<Response> feedsCreateWithHttpInfo(FeedsCreateRequest feedsCreateRequest, { String? adAccountId, }) async {
    // ignore: prefer_const_declarations
  ...
  Future<CatalogsFeed?> feedsCreate(FeedsCreateRequest feedsCreateRequest, { String? adAccountId, }) async {
    final response = await feedsCreateWithHttpInfo(feedsCreateRequest,  adAccountId: adAccountId, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  /// * [String] adAccountId:
  ///   Unique identifier of an ad account.
  Future<Response> feedsDeleteWithHttpInfo(String feedId, { String? adAccountId, }) async {
    // ignore: prefer_const_declarations
  ...
  /// * [String] adAccountId:
  ///   Unique identifier of an ad account.
  Future<void> feedsDelete(String feedId, { String? adAccountId, }) async {
    final response = await feedsDeleteWithHttpInfo(feedId,  adAccountId: adAccountId, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
  }
  ...
  /// * [String] adAccountId:
  ///   Unique identifier of an ad account.
  Future<Response> feedsGetWithHttpInfo(String feedId, { String? adAccountId, }) async {
    // ignore: prefer_const_declarations
    final path = r'/catalogs/feeds/{feed_id}'
      .replaceAll('{feed_id}', feedId);
  ...
  Future<CatalogsFeed?> feedsGet(String feedId, { String? adAccountId, }) async {
    final response = await feedsGetWithHttpInfo(feedId,  adAccountId: adAccountId, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  /// * [String] adAccountId:
  ///   Unique identifier of an ad account.
  Future<Response> feedsIngestWithHttpInfo(String feedId, { String? adAccountId, }) async {
    // ignore: prefer_const_declarations
  ...
  Future<CatalogsFeedIngestion?> feedsIngest(String feedId, { String? adAccountId, }) async {
    final response = await feedsIngestWithHttpInfo(feedId,  adAccountId: adAccountId, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  /// * [String] adAccountId:
  ///   Unique identifier of an ad account.
  Future<Response> feedsListWithHttpInfo({ String? bookmark, int? pageSize, String? catalogId, String? adAccountId, }) async {
    // ignore: prefer_const_declarations
    final path = r'/catalogs/feeds';
  ...
  Future<FeedsList200Response?> feedsList({ String? bookmark, int? pageSize, String? catalogId, String? adAccountId, }) async {
    final response = await feedsListWithHttpInfo( bookmark: bookmark, pageSize: pageSize, catalogId: catalogId, adAccountId: adAccountId, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  ///   Unique identifier of a feed
  ///
  /// * [FeedsUpdateRequest] feedsUpdateRequest (required):
  ///   Request object used to update a feed.
  ///
  /// * [String] adAccountId:
  ///   Unique identifier of an ad account.
  Future<Response> feedsUpdateWithHttpInfo(String feedId, FeedsUpdateRequest feedsUpdateRequest, { String? adAccountId, }) async {
    // ignore: prefer_const_declarations
    final path = r'/catalogs/feeds/{feed_id}'
      .replaceAll('{feed_id}', feedId);
  ...
  Future<CatalogsFeed?> feedsUpdate(String feedId, FeedsUpdateRequest feedsUpdateRequest, { String? adAccountId, }) async {
    final response = await feedsUpdateWithHttpInfo(feedId, feedsUpdateRequest,  adAccountId: adAccountId, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  /// * [String] adAccountId:
  ///   Unique identifier of an ad account.
  Future<Response> itemsIssuesListWithHttpInfo(String processingResultId, { String? bookmark, int? pageSize, List<int>? itemNumbers, CatalogsItemValidationIssue? itemValidationIssue, String? adAccountId, }) async {
    // ignore: prefer_const_declarations
  ...
  Future<ItemsIssuesList200Response?> itemsIssuesList(String processingResultId, { String? bookmark, int? pageSize, List<int>? itemNumbers, CatalogsItemValidationIssue? itemValidationIssue, String? adAccountId, }) async {
    final response = await itemsIssuesListWithHttpInfo(processingResultId,  bookmark: bookmark, pageSize: pageSize, itemNumbers: itemNumbers, itemValidationIssue: itemValidationIssue, adAccountId: adAccountId, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
