...
**report_type** | **pinterest_rest_api_catalogs_retail_report_parameters_report_REPORTTYPE_e** |  | 
**catalog_id** | **char \*** | Unique identifier of a catalog. If not given, oldest catalog will be used | [optional] 
**product_group_id** | **char \*** | Optional product group ID. If omitted, all items are included. This feature is only available for allowlisted merchants. Please contact your account manager to enable this feature. | [optional] 
