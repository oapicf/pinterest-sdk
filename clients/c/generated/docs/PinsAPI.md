...
**metric_types** | **[list_t](multi_pins_analytics_metric_types_item.md) \*** | Pin metric types to get data for. | 
...
//
pin_t* PinsAPI_pinsDelete(apiClient_t *apiClient, char *pin_id, char *ad_account_id);
```
...
//
pins_list_200_response_t* PinsAPI_pinsList(apiClient_t *apiClient, pin_filter_e pin_filter, int *pin_metrics, int *include_protected_pins, pin_type_e pin_type, list_t *creative_types, char *ad_account_id, char *domain, list_t *domains, int *include_product_tag_obj, char *bookmark, int *page_size);
```
...
------------- | ------------- | ------------- | -------------
**apiClient** | **apiClient_t \*** | context containing the client configuration |
**pin_filter** | **pin_filter_e** | The filter to apply to the pins | [optional] 
**pin_metrics** | **int \*** | Specify whether to return 90d and lifetime Pin metrics. Total comments and total reactions are only available with lifetime Pin metrics. If Pin was created before &#x60;2023-03-20&#x60; lifetime metrics will only be available for Video and Idea Pin formats. Lifetime metrics are available for all Pin formats since then. | [optional] [default to false]
**include_protected_pins** | **int \*** | Whether to include protected pins in the results | [optional] [default to false]
**pin_type** | **pin_type_e** | The type of pins to return, currently only enabled for private pins | [optional] 
...
**ad_account_id** | **char \*** | Unique identifier of an ad account. | [optional] 
**domain** | **char \*** | Only return pins with links that match the exact domain. Domain should not include &#39;www.&#39; prefix. For example, &#39;pinterest.com&#39; is a valid domain, but &#39;www.pinterest.com&#39; is not (will not match any pins). | [optional] 
**domains** | **[list_t](char.md) \*** | Only return pins with links whose domain matches any value in the list. Values are joined comma-separated on the wire (e.g. &#x60;?domains&#x3D;instagram.com,jcpenney.com&#x60;). | [optional] 
**include_product_tag_obj** | **int \*** | Include product tag objects in the response with their associated links. | [optional] 
...
//
pin_t* PinsAPI_pinsSave(apiClient_t *apiClient, char *pin_id, pins_save_request_create_t *pins_save_request_create, char *ad_account_id);
```
...
**apiClient** | **apiClient_t \*** | context containing the client configuration |
**pin_id** | **char \*** | Unique identifier of a Pin. | 
**pins_save_request_create** | **[pins_save_request_create_t](pins_save_request_create.md) \*** |  | 
**ad_account_id** | **char \*** | Unique identifier of an ad account. | [optional] 
