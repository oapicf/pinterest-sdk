...
//
conversion_events_t* ConversionEventsAPI_eventsCreate(apiClient_t *apiClient, char *ad_account_id, conversion_events_create_t *conversion_events_create, int *test);
```
...
**conversion_events_create** | **[conversion_events_create_t](conversion_events_create.md) \*** |  | 
...
[conversion_events_t](conversion_events.md) *
