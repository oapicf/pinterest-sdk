...
------------ | ------------- | ------------- | -------------
**ad_account_id** | **char \*** | Advertiser ID for this preview. | [readonly] 
**ad_group_id** | **char \*** | Ad group ID to create a preview record for. | 
...
**is_active** | **int** | Whether preview link is active. | [readonly] 
...
**url** | **char \*** | Campaign ad preview URL. | [readonly] 
**user_id** | **int** | User ID that created preview. | [readonly] 
**uuid** | **char \*** | Pin promotion preview key. | [readonly] 
