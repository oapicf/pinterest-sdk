...
//
product_group_promotions_t* ProductGroupPromotionsAPI_productGroupPromotionsCreate(apiClient_t *apiClient, char *ad_account_id, product_group_promotions_create_t *product_group_promotions_create);
```
...
**product_group_promotions_create** | **[product_group_promotions_create_t](product_group_promotions_create.md) \*** |  | 

### Return type

[product_group_promotions_t](product_group_promotions.md) *
...
// Get a product group promotion by id
//
product_group_promotion_t* ProductGroupPromotionsAPI_productGroupPromotionsGet(apiClient_t *apiClient, char *ad_account_id, char *product_group_promotion_id);
```
...
[product_group_promotion_t](product_group_promotion.md) *
...
//
product_group_promotions_list_200_response_t* ProductGroupPromotionsAPI_productGroupPromotionsList(apiClient_t *apiClient, char *ad_account_id, char *bookmark, int *page_size, pinterest_lib_pagination_order_e order, list_t *product_group_promotion_ids, list_t *entity_statuses, char *ad_group_id);
```
...
//
product_group_promotions_t* ProductGroupPromotionsAPI_productGroupPromotionsUpdate(apiClient_t *apiClient, char *ad_account_id, product_group_promotions_update_with_required_body_t *product_group_promotions_update_with_required_body);
```
...
**apiClient** | **apiClient_t \*** | context containing the client configuration |
**ad_account_id** | **char \*** | Unique identifier of an ad account. | 
**product_group_promotions_update_with_required_body** | **[product_group_promotions_update_with_required_body_t](product_group_promotions_update_with_required_body.md) \*** |  | 
...
[list_t](product_group_analytics_items.md) *
