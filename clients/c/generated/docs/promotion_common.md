...
------------ | ------------- | ------------- | -------------
**discount_status** | **pinterest_rest_api_promotion_common_DISCOUNTSTATUS_e** | Discount status based on the current time and start and end time of discount | [optional] 
