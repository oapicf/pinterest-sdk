...
//
reports_stats_200_response_t* CatalogReportsAPI_reportsStats(apiClient_t *apiClient, reports_stats_parameters_parameter_t *parameters, char *ad_account_id, int *page_size, char *bookmark);
```
...
------------- | ------------- | ------------- | -------------
**apiClient** | **apiClient_t \*** | context containing the client configuration |
**parameters** | **[reports_stats_parameters_parameter_t](.md) \*** | Contains the parameters for report identification. | 
**ad_account_id** | **char \*** | Unique identifier of an ad account. | [optional] 
