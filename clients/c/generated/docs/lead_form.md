...
------------ | ------------- | ------------- | -------------
**ad_account_id** | **char \*** | The Ad Account ID that this lead form belongs to. | [optional] [readonly] 
...
**id** | **char \*** | The ID of this lead form | 
**name** | **char \*** | Internal name of the lead form. | 
**policy_links** | [**list_t**](lead_form_policy_link.md) \* | List of additional policy links to be displayed on the lead form. | [optional] 
