...
//
catalogs_items_batch_t* CatalogItemsAPI_itemsBatchPost(apiClient_t *apiClient, catalogs_items_batch_post_request_t *catalogs_items_batch_post_request, char *ad_account_id);
```
...
------------- | ------------- | ------------- | -------------
**apiClient** | **apiClient_t \*** | context containing the client configuration |
**catalogs_items_batch_post_request** | **[catalogs_items_batch_post_request_t](catalogs_items_batch_post_request.md) \*** |  | 
**ad_account_id** | **char \*** | Unique identifier of an ad account. | [optional] 
...
//
items_post_200_response_t* CatalogItemsAPI_itemsPost(apiClient_t *apiClient, catalogs_items_request_t *catalogs_items_request, char *ad_account_id);
```
...
------------- | ------------- | ------------- | -------------
**apiClient** | **apiClient_t \*** | context containing the client configuration |
**catalogs_items_request** | **[catalogs_items_request_t](catalogs_items_request.md) \*** |  | 
**ad_account_id** | **char \*** | Unique identifier of an ad account. | [optional] 

### Return type

[items_post_200_response_t](items_post_200_response.md) *
