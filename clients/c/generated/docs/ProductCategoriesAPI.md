...
------------- | ------------- | -------------
[**ProductCategoriesAPI_trendsFeaturedTopicsList**](ProductCategoriesAPI.md#ProductCategoriesAPI_trendsFeaturedTopicsList) | **GET** /trends/topics/featured | Get featured topics
[**ProductCategoriesAPI_trendsProductCategoriesDetailsList**](ProductCategoriesAPI.md#ProductCategoriesAPI_trendsProductCategoriesDetailsList) | **GET** /trends/product_categories/details | Get product category details
[**ProductCategoriesAPI_trendsProductCategoriesTrendingList**](ProductCategoriesAPI.md#ProductCategoriesAPI_trendsProductCategoriesTrendingList) | **GET** /trends/product_categories/trending | Get a list of growing Shopping Product Categories


# **ProductCategoriesAPI_trendsFeaturedTopicsList**
```c
// Get featured topics
//
//   Enables advertisers to pull top five trending topics by interest and market, at full parity with the Pinterest Trends UI.
//
list_t* ProductCategoriesAPI_trendsFeaturedTopicsList(apiClient_t *apiClient, product_category_region_e region, interests_enum_e interest);
```
...
# **ProductCategoriesAPI_trendsProductCategoriesDetailsList**
```c
...
//
list_t* ProductCategoriesAPI_trendsProductCategoriesDetailsList(apiClient_t *apiClient, list_t *product_categories, product_category_region_e region, product_category_detail_lookback_window_e lookback_window, product_categories_engagement_type_e engagement_type);
```
...
# **ProductCategoriesAPI_trendsProductCategoriesTrendingList**
```c
...
//
list_t* ProductCategoriesAPI_trendsProductCategoriesTrendingList(apiClient_t *apiClient, product_category_region_e region, list_t *verticals, list_t *ages, list_t *genders, product_categories_engagement_type_e engagement_type);
```
