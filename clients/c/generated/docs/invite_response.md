...
**created_by_business** | [**object_t**](.md) \* | Metadata for the business that created the invite/request. | [optional] 
**created_by_user** | [**object_t**](.md) \* | Metadata for the user that created the invite/request. | [optional] 
