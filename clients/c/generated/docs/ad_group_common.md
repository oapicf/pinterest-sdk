...
**bid_strategy_type** | **pinterest_rest_api_ad_group_common_BIDSTRATEGYTYPE_e** | Bid strategy type. For Campaigns with Video Completion objectives, the only supported bid strategy type is AUTOMATIC_BID. | [optional] 
