...
**attribution_model** | **pinterest_rest_api_conversion_msot_events_ATTRIBUTIONMODEL_e** | The attribution model used to attribute the conversion event. | [optional] 
**attribution_scope** | **pinterest_rest_api_conversion_msot_events_ATTRIBUTIONSCOPE_e** | Ad event type. | 
...
**event_name** | **pinterest_rest_api_conversion_msot_events_EVENTNAME_e** | Type of user event. | 
