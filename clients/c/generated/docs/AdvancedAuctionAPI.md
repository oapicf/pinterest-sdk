...
**advanced_auction_items_get_request** | **[advanced_auction_items_get_request_t](advanced_auction_items_get_request.md) \*** |  | 
...
------------- | ------------- | ------------- | -------------
**apiClient** | **apiClient_t \*** | context containing the client configuration |
**advanced_auction_items_submit_request** | **[advanced_auction_items_submit_request_t](advanced_auction_items_submit_request.md) \*** |  | 
**ad_account_id** | **char \*** | Unique identifier of an ad account. | [optional] 
