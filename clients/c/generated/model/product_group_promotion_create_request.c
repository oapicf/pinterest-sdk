...
static product_group_promotion_create_request_t *product_group_promotion_create_request_create_internal(
    ...
    memset(product_group_promotion_create_request_local_var, 0, sizeof(product_group_promotion_create_request_t));
...
__attribute__((deprecated)) product_group_promotion_create_request_t *product_group_promotion_create_request_create(
    ...
    product_group_promotion_create_request_t *result = product_group_promotion_create_request_create_internal (
        ad_group_id,
