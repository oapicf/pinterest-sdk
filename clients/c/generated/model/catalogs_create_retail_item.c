...
static catalogs_create_retail_item_t *catalogs_create_retail_item_create_internal(
...
void catalogs_create_retail_item_free(catalogs_create_retail_item_t *catalogs_create_retail_item) {
    ...
    if(catalogs_create_retail_item->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "catalogs_create_retail_item_free");
        return ;
    }
...
cJSON *catalogs_create_retail_item_convertToJSON(catalogs_create_retail_item_t *catalogs_create_retail_item) {
    ...
    if(cJSON_AddStringToObject(item, "operation", catalogs_create_retail_item_operation_ToString(catalogs_create_retail_item->operation)) == NULL)
    {
    goto fail; //Enum
    }
