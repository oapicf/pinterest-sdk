...
static catalogs_hotel_product_group_filters_t *catalogs_hotel_product_group_filters_create_internal(
    list_t *any_of,
    list_t *all_of
    ) {
...
__attribute__((deprecated)) catalogs_hotel_product_group_filters_t *catalogs_hotel_product_group_filters_create(
    list_t *any_of,
    list_t *all_of
    ) {
...
void catalogs_hotel_product_group_filters_free(catalogs_hotel_product_group_filters_t *catalogs_hotel_product_group_filters) {
    ...
    if(catalogs_hotel_product_group_filters->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "catalogs_hotel_product_group_filters_free");
        return ;
    }
