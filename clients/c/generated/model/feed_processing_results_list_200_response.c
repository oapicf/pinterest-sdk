...
static feed_processing_results_list_200_response_t *feed_processing_results_list_200_response_create_internal(
    ...
    memset(feed_processing_results_list_200_response_local_var, 0, sizeof(feed_processing_results_list_200_response_t));
...
__attribute__((deprecated)) feed_processing_results_list_200_response_t *feed_processing_results_list_200_response_create(
    ...
    feed_processing_results_list_200_response_t *result = feed_processing_results_list_200_response_create_internal (
        bookmark,
        items
        );
    if (!result) {
