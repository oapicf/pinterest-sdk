...
static template_response_t *template_response_create_internal(
    char *id,
    char *ad_account_id,
    ...
    template_response_local_var->_library_owned = 1;
    return template_response_local_var;
}

__attribute__((deprecated)) template_response_t *template_response_create(
    char *id,
    char *ad_account_id,
    list_t *ad_account_ids,
    char *user_id,
    ...
    return template_response_create_internal (
        id,
        ad_account_id,
        ad_account_ids,
        user_id,
...
void template_response_free(template_response_t *template_response) {
    ...
    if(template_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "template_response_free");
        return ;
    }
...
cJSON *template_response_convertToJSON(template_response_t *template_response) {
    ...
    if(template_response->report_level != pinterest_rest_api_metrics_reporting_level__NULL) {
    ...
    if(template_response->report_format != pinterest_rest_api_data_output_format__NULL) {
    ...
    if(cJSON_AddStringToObject(columns, "", columnsListEntry->data) == NULL)
    {
        goto fail;
    }
    }
    ...
    if(template_response->granularity != pinterest_rest_api_granularity__NULL) {
    ...
    if(cJSON_AddStringToObject(item, "conversion_report_time_type", template_response_conversion_report_time_type_ToString(template_response->conversion_report_time_type)) == NULL)
    {
    goto fail; //Enum
    }
    }
    ...
    if(cJSON_AddStringToObject(item, "creation_source", template_response_creation_source_ToString(template_response->creation_source)) == NULL)
    {
    goto fail; //Enum
    }
    }
    ...
    if(cJSON_AddStringToObject(item, "type", template_response_type_ToString(template_response->type)) == NULL)
    {
    goto fail; //Enum
    }
    }
    ...
    if(cJSON_AddStringToObject(ingestion_sources, "", ingestion_sourcesListEntry->data) == NULL)
    {
        goto fail;
    }
    }
...
template_response_t *template_response_parseFromJSON(cJSON *template_responseJSON){
    ...
    template_response_local_var = template_response_create_internal (
