...
static reports_stats_200_response_t *reports_stats_200_response_create_internal(
    ...
    memset(reports_stats_200_response_local_var, 0, sizeof(reports_stats_200_response_t));
...
__attribute__((deprecated)) reports_stats_200_response_t *reports_stats_200_response_create(
    ...
    reports_stats_200_response_t *result = reports_stats_200_response_create_internal (
        bookmark,
        items
        );
    if (!result) {
