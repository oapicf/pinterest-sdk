...
char* ads_analytics_create_async_request_campaign_objective_types_ToString(pinterest_rest_api_ads_analytics_create_async_request__e campaign_objective_types) {
    char *campaign_objective_typesArray[] =  { "NULL", "AWARENESS", "CONSIDERATION", "VIDEO_VIEW", "WEB_CONVERSION", "CATALOG_SALES", "WEB_SESSIONS", "VIDEO_COMPLETION", "APP_INSTALL", "SALES", "LEADS", "CTV_CONSIDERATION" };
...
static ads_analytics_create_async_request_t *ads_analytics_create_async_request_create_internal(
    ...
    memset(ads_analytics_create_async_request_local_var, 0, sizeof(ads_analytics_create_async_request_t));
    ...
    ads_analytics_create_async_request_local_var->campaign_brand_label = campaign_brand_label;
    ads_analytics_create_async_request_local_var->campaign_custom_label = campaign_custom_label;
    ...
    ads_analytics_create_async_request_local_var->combine_targeting_types = combine_targeting_types;
    ads_analytics_create_async_request_local_var->conversion_report_time = conversion_report_time;
    ads_analytics_create_async_request_local_var->custom_conversion_event_metrics = custom_conversion_event_metrics;
    ...
    ads_analytics_create_async_request_local_var->reporting_timezone = reporting_timezone;
...
__attribute__((deprecated)) ads_analytics_create_async_request_t *ads_analytics_create_async_request_create(
    ...
    int *combine_targeting_types_copy = NULL;
    if (combine_targeting_types) {
        combine_targeting_types_copy = malloc(sizeof(int));
        if (combine_targeting_types_copy) *combine_targeting_types_copy = *combine_targeting_types;
    }
    int *end_hour_copy = NULL;
    if (end_hour) {
        end_hour_copy = malloc(sizeof(int));
        if (end_hour_copy) *end_hour_copy = *end_hour;
    }
    int *start_hour_copy = NULL;
    if (start_hour) {
        start_hour_copy = malloc(sizeof(int));
        if (start_hour_copy) *start_hour_copy = *start_hour;
    }
    ads_analytics_create_async_request_t *result = ads_analytics_create_async_request_create_internal (
        ad_group_ids,
        ad_group_statuses,
        ad_ids,
        ad_statuses,
    ...
    if (!result) {
        free(combine_targeting_types_copy);
        free(end_hour_copy);
        free(start_hour_copy);
    }
    return result;
}
...
void ads_analytics_create_async_request_free(ads_analytics_create_async_request_t *ads_analytics_create_async_request) {
    ...
    if (ads_analytics_create_async_request->campaign_brand_label) {
        free(ads_analytics_create_async_request->campaign_brand_label);
        ads_analytics_create_async_request->campaign_brand_label = NULL;
    }
    if (ads_analytics_create_async_request->campaign_custom_label) {
        free(ads_analytics_create_async_request->campaign_custom_label);
        ads_analytics_create_async_request->campaign_custom_label = NULL;
    }
    ...
    if (ads_analytics_create_async_request->campaign_objective_types) {
        list_ForEach(listEntry, ads_analytics_create_async_request->campaign_objective_types) {
            campaign_objective_type_free(listEntry->data);
        }
    ...
    if (ads_analytics_create_async_request->combine_targeting_types) {
        free(ads_analytics_create_async_request->combine_targeting_types);
        ads_analytics_create_async_request->combine_targeting_types = NULL;
    }
    ...
    if (ads_analytics_create_async_request->custom_conversion_event_metrics) {
        list_ForEach(listEntry, ads_analytics_create_async_request->custom_conversion_event_metrics) {
            custom_conversion_event_metrics_free(listEntry->data);
        }
        list_freeList(ads_analytics_create_async_request->custom_conversion_event_metrics);
        ads_analytics_create_async_request->custom_conversion_event_metrics = NULL;
    }
    ...
    if (ads_analytics_create_async_request->end_hour) {
        free(ads_analytics_create_async_request->end_hour);
        ads_analytics_create_async_request->end_hour = NULL;
    }
    ...
    if (ads_analytics_create_async_request->primary_sort) {
        primary_sort_free(ads_analytics_create_async_request->primary_sort);
        ads_analytics_create_async_request->primary_sort = NULL;
    }
    ...
    if (ads_analytics_create_async_request->reporting_timezone) {
        reporting_time_zone_free(ads_analytics_create_async_request->reporting_timezone);
        ads_analytics_create_async_request->reporting_timezone = NULL;
    }
    ...
    if (ads_analytics_create_async_request->start_hour) {
        free(ads_analytics_create_async_request->start_hour);
        ads_analytics_create_async_request->start_hour = NULL;
    }
    if (ads_analytics_create_async_request->targeting_types) {
        list_ForEach(listEntry, ads_analytics_create_async_request->targeting_types) {
            ad_ads_analytics_async_targeting_types_free(listEntry->data);
        }
...
cJSON *ads_analytics_create_async_request_convertToJSON(ads_analytics_create_async_request_t *ads_analytics_create_async_request) {
    ...
    // ads_analytics_create_async_request->campaign_brand_label
    if(ads_analytics_create_async_request->campaign_brand_label) {
    if(cJSON_AddStringToObject(item, "campaign_brand_label", ads_analytics_create_async_request->campaign_brand_label) == NULL) {
    goto fail; //String
    }
    }


    // ads_analytics_create_async_request->campaign_custom_label
    if(ads_analytics_create_async_request->campaign_custom_label) {
    if(cJSON_AddStringToObject(item, "campaign_custom_label", ads_analytics_create_async_request->campaign_custom_label) == NULL) {
    goto fail; //String
    }
    }
    ...
    cJSON *itemLocal = campaign_objective_type_convertToJSON((pinterest_rest_api_ads_analytics_create_async_request__e)campaign_objective_typesListEntry->data);
    if(itemLocal == NULL) {
    goto fail;
    }
    ...
    if(ads_analytics_create_async_request->columns != pinterest_rest_api_list_COLUMNS_NULL) {
    ...
    // ads_analytics_create_async_request->combine_targeting_types
    if(ads_analytics_create_async_request->combine_targeting_types) {
    if(cJSON_AddBoolToObject(item, "combine_targeting_types", *ads_analytics_create_async_request->combine_targeting_types) == NULL) {
    goto fail; //Bool
    }
    }
    ...
    // ads_analytics_create_async_request->custom_conversion_event_metrics
    if(ads_analytics_create_async_request->custom_conversion_event_metrics) {
    cJSON *custom_conversion_event_metrics = cJSON_AddArrayToObject(item, "custom_conversion_event_metrics");
    if(custom_conversion_event_metrics == NULL) {
    goto fail; //nonprimitive container
    }

    listEntry_t *custom_conversion_event_metricsListEntry;
    if (ads_analytics_create_async_request->custom_conversion_event_metrics) {
    list_ForEach(custom_conversion_event_metricsListEntry, ads_analytics_create_async_request->custom_conversion_event_metrics) {
    cJSON *itemLocal = custom_conversion_event_metrics_convertToJSON(custom_conversion_event_metricsListEntry->data);
    if(itemLocal == NULL) {
    goto fail;
    }
    cJSON_AddItemToArray(custom_conversion_event_metrics, itemLocal);
    }
    }
    }
    ...
    if(ads_analytics_create_async_request->primary_sort) {
    cJSON *primary_sort_local_JSON = primary_sort_convertToJSON(ads_analytics_create_async_request->primary_sort);
    if(primary_sort_local_JSON == NULL) {
        goto fail; // custom
    }
    cJSON_AddItemToObject(item, "primary_sort", primary_sort_local_JSON);
    if(item->child == NULL) {
        goto fail;
    }
    }
    ...
    // ads_analytics_create_async_request->reporting_timezone
    if(ads_analytics_create_async_request->reporting_timezone) {
    cJSON *reporting_timezone_local_JSON = reporting_time_zone_convertToJSON(ads_analytics_create_async_request->reporting_timezone);
    if(reporting_timezone_local_JSON == NULL) {
        goto fail; // custom
    }
    cJSON_AddItemToObject(item, "reporting_timezone", reporting_timezone_local_JSON);
    if(item->child == NULL) {
        goto fail;
    }
    }
    ...
    cJSON *itemLocal = ad_ads_analytics_async_targeting_types_convertToJSON((pinterest_rest_api_ads_analytics_create_async_request__e)targeting_typesListEntry->data);
    if(itemLocal == NULL) {
    goto fail;
    }
...
ads_analytics_create_async_request_t *ads_analytics_create_async_request_parseFromJSON(cJSON *ads_analytics_create_async_requestJSON){
    ...
    char *campaign_brand_label_local_str = NULL;

    char *campaign_custom_label_local_str = NULL;
    ...
    // define the local variable for ads_analytics_create_async_request->combine_targeting_types
    int *combine_targeting_types_local_var = NULL;
    ...
    // define the local list for ads_analytics_create_async_request->custom_conversion_event_metrics
    list_t *custom_conversion_event_metricsList = NULL;

    char *end_date_local_str = NULL;

    // define the local variable for ads_analytics_create_async_request->end_hour
    int *end_hour_local_var = NULL;
    ...
    // define the local variable for ads_analytics_create_async_request->primary_sort
    primary_sort_t *primary_sort_local_nonprim = NULL;
    ...
    // define the local variable for ads_analytics_create_async_request->reporting_timezone
    reporting_time_zone_t *reporting_timezone_local_nonprim = NULL;

    char *start_date_local_str = NULL;

    // define the local variable for ads_analytics_create_async_request->start_hour
    int *start_hour_local_var = NULL;
    ...
    // ads_analytics_create_async_request->campaign_brand_label
    cJSON *campaign_brand_label = cJSON_GetObjectItemCaseSensitive(ads_analytics_create_async_requestJSON, "campaign_brand_label");
    if (cJSON_IsNull(campaign_brand_label)) {
        campaign_brand_label = NULL;
    }
    if (campaign_brand_label) { 
    if(!cJSON_IsString(campaign_brand_label) && !cJSON_IsNull(campaign_brand_label))
    {
    goto end; //String
    }
    }
    ...
    // ads_analytics_create_async_request->campaign_custom_label
    cJSON *campaign_custom_label = cJSON_GetObjectItemCaseSensitive(ads_analytics_create_async_requestJSON, "campaign_custom_label");
    if (cJSON_IsNull(campaign_custom_label)) {
        campaign_custom_label = NULL;
    }
    if (campaign_custom_label) { 
    if(!cJSON_IsString(campaign_custom_label) && !cJSON_IsNull(campaign_custom_label))
    {
    goto end; //String
    }
    }
    ...
    cJSON_ArrayForEach(campaign_objective_types_local_nonprimitive,campaign_objective_types )
    {
        ...
        ads_analytics_create_async_request_campaign_objective_type_e campaign_objective_typesItem = campaign_objective_type_parseFromJSON(campaign_objective_types_local_nonprimitive);
    ...
    // ads_analytics_create_async_request->combine_targeting_types
    cJSON *combine_targeting_types = cJSON_GetObjectItemCaseSensitive(ads_analytics_create_async_requestJSON, "combine_targeting_types");
    if (cJSON_IsNull(combine_targeting_types)) {
        combine_targeting_types = NULL;
    }
    if (combine_targeting_types) { 
    if(!cJSON_IsBool(combine_targeting_types))
    {
    goto end; //Bool
    }
    combine_targeting_types_local_var = malloc(sizeof(int));
    if(!combine_targeting_types_local_var)
    {
        goto end;
    }
    *combine_targeting_types_local_var = combine_targeting_types->valueint;
    }
    ...
    // ads_analytics_create_async_request->custom_conversion_event_metrics
    cJSON *custom_conversion_event_metrics = cJSON_GetObjectItemCaseSensitive(ads_analytics_create_async_requestJSON, "custom_conversion_event_metrics");
    if (cJSON_IsNull(custom_conversion_event_metrics)) {
        custom_conversion_event_metrics = NULL;
    }
    if (custom_conversion_event_metrics) { 
    cJSON *custom_conversion_event_metrics_local_nonprimitive = NULL;
    if(!cJSON_IsArray(custom_conversion_event_metrics)){
        goto end; //nonprimitive container
    }

    custom_conversion_event_metricsList = list_createList();

    cJSON_ArrayForEach(custom_conversion_event_metrics_local_nonprimitive,custom_conversion_event_metrics )
    {
        if(!cJSON_IsObject(custom_conversion_event_metrics_local_nonprimitive)){
            goto end;
        }
        custom_conversion_event_metrics_t *custom_conversion_event_metricsItem = custom_conversion_event_metrics_parseFromJSON(custom_conversion_event_metrics_local_nonprimitive);

        list_addElement(custom_conversion_event_metricsList, custom_conversion_event_metricsItem);
    }
    }
    ...
    end_hour_local_var = malloc(sizeof(int));
    if(!end_hour_local_var)
    {
        goto end;
    }
    *end_hour_local_var = end_hour->valuedouble;
    }
    ...
    if (primary_sort) { 
    primary_sort_local_nonprim = primary_sort_parseFromJSON(primary_sort); //custom
    }
    ...
    // ads_analytics_create_async_request->reporting_timezone
    cJSON *reporting_timezone = cJSON_GetObjectItemCaseSensitive(ads_analytics_create_async_requestJSON, "reporting_timezone");
    if (cJSON_IsNull(reporting_timezone)) {
        reporting_timezone = NULL;
    }
    if (reporting_timezone) { 
    reporting_timezone_local_nonprim = reporting_time_zone_parseFromJSON(reporting_timezone); //custom
    }
    ...
    start_hour_local_var = malloc(sizeof(int));
    if(!start_hour_local_var)
    {
        goto end;
    }
    *start_hour_local_var = start_hour->valuedouble;
    }
    ...
    cJSON_ArrayForEach(targeting_types_local_nonprimitive,targeting_types )
    {
        ...
        ads_analytics_create_async_request_ad_ads_analytics_async_targeting_types_e targeting_typesItem = ad_ads_analytics_async_targeting_types_parseFromJSON(targeting_types_local_nonprimitive);
    ...
    if (campaign_brand_label && !cJSON_IsNull(campaign_brand_label)) campaign_brand_label_local_str = strdup(campaign_brand_label->valuestring);
    if (campaign_custom_label && !cJSON_IsNull(campaign_custom_label)) campaign_custom_label_local_str = strdup(campaign_custom_label->valuestring);
    ...
    ads_analytics_create_async_request_local_var = ads_analytics_create_async_request_create_internal (
        ...
        campaign_brand_label_local_str,
        campaign_custom_label_local_str,
        ...
        combine_targeting_types_local_var,
        conversion_report_time ? conversion_report_time_local_nonprim : NULL,
        custom_conversion_event_metrics ? custom_conversion_event_metricsList : NULL,
        end_date_local_str,
        end_hour_local_var,
        ...
        primary_sort ? primary_sort_local_nonprim : NULL,
        ...
        reporting_timezone ? reporting_timezone_local_nonprim : NULL,
        start_date_local_str,
        start_hour_local_var,
    ...
    if (campaign_brand_label_local_str) {
        free(campaign_brand_label_local_str);
        campaign_brand_label_local_str = NULL;
    }
    if (campaign_custom_label_local_str) {
        free(campaign_custom_label_local_str);
        campaign_custom_label_local_str = NULL;
    }
    if (campaign_idsList) {
        listEntry_t *listEntry = NULL;
    ...
    if (combine_targeting_types_local_var) {
        free(combine_targeting_types_local_var);
        combine_targeting_types_local_var = NULL;
    }
    ...
    if (custom_conversion_event_metricsList) {
        listEntry_t *listEntry = NULL;
        list_ForEach(listEntry, custom_conversion_event_metricsList) {
            custom_conversion_event_metrics_free(listEntry->data);
            listEntry->data = NULL;
        }
        list_freeList(custom_conversion_event_metricsList);
        custom_conversion_event_metricsList = NULL;
    }
    ...
    if (end_hour_local_var) {
        free(end_hour_local_var);
        end_hour_local_var = NULL;
    }
    ...
    if (primary_sort_local_nonprim) {
        primary_sort_free(primary_sort_local_nonprim);
        primary_sort_local_nonprim = NULL;
    }
    ...
    if (reporting_timezone_local_nonprim) {
        reporting_time_zone_free(reporting_timezone_local_nonprim);
        reporting_timezone_local_nonprim = NULL;
    }
    ...
    if (start_hour_local_var) {
        free(start_hour_local_var);
        start_hour_local_var = NULL;
    }
