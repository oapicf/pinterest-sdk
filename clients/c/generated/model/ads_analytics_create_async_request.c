...
char* ads_analytics_create_async_request_targeting_types_ToString(pinterest_rest_api_ads_analytics_create_async_request_TARGETINGTYPES_e targeting_types) {
...
pinterest_rest_api_ads_analytics_create_async_request_TARGETINGTYPES_e ads_analytics_create_async_request_targeting_types_FromString(char* targeting_types) {
    int stringToReturn = 0;
    char *targeting_typesArray[] =  { "NULL", "KEYWORD", "APPTYPE", "GENDER", "LOCATION", "PLACEMENT", "COUNTRY", "TARGETED_INTEREST", "PINNER_INTEREST", "AUDIENCE_INCLUDE", "GEO", "AGE_BUCKET", "REGION", "MEDIA_TYPE", "AGE_BUCKET_AND_GENDER", "AUDIENCE_MULTIPLIER", "CREATIVE_ENHANCEMENTS", "LOCAL_ADS_STORE_CODE" };
...
void ads_analytics_create_async_request_free(ads_analytics_create_async_request_t *ads_analytics_create_async_request) {
    ...
    if (ads_analytics_create_async_request->custom_conversion_event_metrics) {
        list_ForEach(listEntry, ads_analytics_create_async_request->custom_conversion_event_metrics) {
            ads_analytics_create_async_request_all_of_custom_conversion_event_metrics_free(listEntry->data);
        }
...
cJSON *ads_analytics_create_async_request_convertToJSON(ads_analytics_create_async_request_t *ads_analytics_create_async_request) {
    ...
    cJSON *itemLocal = ads_analytics_create_async_request_all_of_custom_conversion_event_metrics_convertToJSON(custom_conversion_event_metricsListEntry->data);
    if(itemLocal == NULL) {
    goto fail;
    }
...
ads_analytics_create_async_request_t *ads_analytics_create_async_request_parseFromJSON(cJSON *ads_analytics_create_async_requestJSON){
    ...
    cJSON_ArrayForEach(custom_conversion_event_metrics_local_nonprimitive,custom_conversion_event_metrics )
    {
        ...
        ads_analytics_create_async_request_all_of_custom_conversion_event_metrics_t *custom_conversion_event_metricsItem = ads_analytics_create_async_request_all_of_custom_conversion_event_metrics_parseFromJSON(custom_conversion_event_metrics_local_nonprimitive);
    ...
    ads_analytics_create_async_request_local_var = ads_analytics_create_async_request_create_internal (
        ...
        campaign_brand_label && !cJSON_IsNull(campaign_brand_label) ? strdup(campaign_brand_label->valuestring) : NULL,
        ...
        columnsList,
        combine_targeting_types ? combine_targeting_types->valueint : 0,
