/*
 * business_to_ad_account_shared_audience_update_with_required_body.h
 *
 * Resource create or update operation model with required body fields (no OptionalProperties).
 */

#ifndef _business_to_ad_account_shared_audience_update_with_required_body_H_
#define _business_to_ad_account_shared_audience_update_with_required_body_H_
...
typedef struct business_to_ad_account_shared_audience_update_with_required_body_t business_to_ad_account_shared_audience_update_with_required_body_t;

#include "operation_type.h"



typedef struct business_to_ad_account_shared_audience_update_with_required_body_t {
...
} business_to_ad_account_shared_audience_update_with_required_body_t;
...
#endif /* _business_to_ad_account_shared_audience_update_with_required_body_H_ */
