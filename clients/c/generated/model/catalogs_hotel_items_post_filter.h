/*
 * catalogs_hotel_items_post_filter.h
 *
 * 
 */

#ifndef _catalogs_hotel_items_post_filter_H_
#define _catalogs_hotel_items_post_filter_H_
...
typedef struct catalogs_hotel_items_post_filter_t catalogs_hotel_items_post_filter_t;


// Enum CATALOGTYPE for catalogs_hotel_items_post_filter

typedef enum  { pinterest_rest_api_catalogs_hotel_items_post_filter_CATALOGTYPE_NULL = 0, pinterest_rest_api_catalogs_hotel_items_post_filter_CATALOGTYPE_HOTEL } pinterest_rest_api_catalogs_hotel_items_post_filter_CATALOGTYPE_e;
...
typedef struct catalogs_hotel_items_post_filter_t {
    pinterest_rest_api_catalogs_hotel_items_post_filter_CATALOGTYPE_e catalog_type; //enum
...
#endif /* _catalogs_hotel_items_post_filter_H_ */
