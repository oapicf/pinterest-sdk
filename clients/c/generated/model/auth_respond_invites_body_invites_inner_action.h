...
typedef enum  { pinterest_rest_api_auth_respond_invites_body_invites_inner_action_INNER_NULL = 0, pinterest_rest_api_auth_respond_invites_body_invites_inner_action_INNER_ADMIN, pinterest_rest_api_auth_respond_invites_body_invites_inner_action_INNER_ANALYST, pinterest_rest_api_auth_respond_invites_body_invites_inner_action_INNER_FINANCE_MANAGER, pinterest_rest_api_auth_respond_invites_body_invites_inner_action_INNER_FINANCE_EDIT, pinterest_rest_api_auth_respond_invites_body_invites_inner_action_INNER_FINANCE_VIEW, pinterest_rest_api_auth_respond_invites_body_invites_inner_action_INNER_AUDIENCE_MANAGER, pinterest_rest_api_auth_respond_invites_body_invites_inner_action_INNER_CAMPAIGN_MANAGER, pinterest_rest_api_auth_respond_invites_body_invites_inner_action_INNER_CATALOGS_MANAGER, pinterest_rest_api_auth_respond_invites_body_invites_inner_action_INNER_CATALOGS_VIEWER, pinterest_rest_api_auth_respond_invites_body_invites_inner_action_INNER_PROFILE_PUBLISHER, pinterest_rest_api_auth_respond_invites_body_invites_inner_action_INNER_CONSUMER_USER } pinterest_rest_api_auth_respond_invites_body_invites_inner_action_INNER_e;
