...
typedef enum  { pinterest_rest_api_conversion_tag_common__NULL = 0, pinterest_rest_api_conversion_tag_common__UNKNOWN, pinterest_rest_api_conversion_tag_common__NOT_VALIDATED, pinterest_rest_api_conversion_tag_common__VALIDATING_IN_PROGRESS, pinterest_rest_api_conversion_tag_common__VALIDATION_COMPLETE, pinterest_rest_api_conversion_tag_common__null } pinterest_rest_api_conversion_tag_common__e;
