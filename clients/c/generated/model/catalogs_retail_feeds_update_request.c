...
void catalogs_retail_feeds_update_request_free(catalogs_retail_feeds_update_request_t *catalogs_retail_feeds_update_request) {
    ...
    if (catalogs_retail_feeds_update_request->default_currency) {
        nullable_currency_free(catalogs_retail_feeds_update_request->default_currency);
        catalogs_retail_feeds_update_request->default_currency = NULL;
    }
    ...
    if (catalogs_retail_feeds_update_request->format) {
        catalogs_format_free(catalogs_retail_feeds_update_request->format);
        catalogs_retail_feeds_update_request->format = NULL;
    }
    ...
    if (catalogs_retail_feeds_update_request->status) {
        catalogs_status_free(catalogs_retail_feeds_update_request->status);
        catalogs_retail_feeds_update_request->status = NULL;
    }
    if (catalogs_retail_feeds_update_request->catalog_type) {
        catalogs_type_free(catalogs_retail_feeds_update_request->catalog_type);
        catalogs_retail_feeds_update_request->catalog_type = NULL;
    }
    if (catalogs_retail_feeds_update_request->default_availability) {
        product_availability_type_free(catalogs_retail_feeds_update_request->default_availability);
        catalogs_retail_feeds_update_request->default_availability = NULL;
    }
...
cJSON *catalogs_retail_feeds_update_request_convertToJSON(catalogs_retail_feeds_update_request_t *catalogs_retail_feeds_update_request) {
    ...
    if(catalogs_retail_feeds_update_request->default_currency != pinterest_rest_api_catalogs_retail_feeds_update_request__NULL) {
    ...
    if(catalogs_retail_feeds_update_request->format != pinterest_rest_api_catalogs_retail_feeds_update_request__NULL) {
    ...
    if(catalogs_retail_feeds_update_request->status != pinterest_rest_api_catalogs_retail_feeds_update_request__NULL) {
    ...
    if (pinterest_rest_api_catalogs_retail_feeds_update_request__NULL == catalogs_retail_feeds_update_request->catalog_type) {
        goto fail;
    }
    cJSON *catalog_type_local_JSON = catalogs_type_convertToJSON(catalogs_retail_feeds_update_request->catalog_type);
    ...
    if(catalogs_retail_feeds_update_request->default_availability != pinterest_rest_api_catalogs_retail_feeds_update_request__NULL) {
...
catalogs_retail_feeds_update_request_t *catalogs_retail_feeds_update_request_parseFromJSON(cJSON *catalogs_retail_feeds_update_requestJSON){
    ...
    // define the local variable for catalogs_retail_feeds_update_request->catalog_type
    ...
    catalogs_retail_feeds_update_request_local_var = catalogs_retail_feeds_update_request_create (
