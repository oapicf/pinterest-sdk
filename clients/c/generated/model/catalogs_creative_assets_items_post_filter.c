...
void catalogs_creative_assets_items_post_filter_free(catalogs_creative_assets_items_post_filter_t *catalogs_creative_assets_items_post_filter) {
    ...
    if(catalogs_creative_assets_items_post_filter->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "catalogs_creative_assets_items_post_filter_free");
        return ;
    }
...
cJSON *catalogs_creative_assets_items_post_filter_convertToJSON(catalogs_creative_assets_items_post_filter_t *catalogs_creative_assets_items_post_filter) {
    ...
    if(cJSON_AddStringToObject(item, "catalog_type", catalogs_creative_assets_items_post_filter_catalog_type_ToString(catalogs_creative_assets_items_post_filter->catalog_type)) == NULL)
    {
    goto fail; //Enum
    }
