...
static catalogs_creative_assets_product_group_update_request_t *catalogs_creative_assets_product_group_update_request_create_internal(
    ...
    memset(catalogs_creative_assets_product_group_update_request_local_var, 0, sizeof(catalogs_creative_assets_product_group_update_request_t));
...
__attribute__((deprecated)) catalogs_creative_assets_product_group_update_request_t *catalogs_creative_assets_product_group_update_request_create(
    ...
    catalogs_creative_assets_product_group_update_request_t *result = catalogs_creative_assets_product_group_update_request_create_internal (
        catalog_type,
        description,
        filters,
        name
