...
char* catalogs_items_create_batch_request_operation_ToString(pinterest_rest_api_catalogs_items_create_batch_request_OPERATION_e operation) {
    char* operationArray[] =  { "NULL", "CREATE" };
    return operationArray[operation];
}

pinterest_rest_api_catalogs_items_create_batch_request_OPERATION_e catalogs_items_create_batch_request_operation_FromString(char* operation){
...
static catalogs_items_create_batch_request_t *catalogs_items_create_batch_request_create_internal(
    pinterest_rest_api_country__e country,
    list_t *items,
    pinterest_rest_api_catalogs_items_create_batch_request_LANGUAGE_e language,
    pinterest_rest_api_catalogs_items_create_batch_request_OPERATION_e operation
    ) {
    ...
    memset(catalogs_items_create_batch_request_local_var, 0, sizeof(catalogs_items_create_batch_request_t));
    catalogs_items_create_batch_request_local_var->_library_owned = 1;
...
__attribute__((deprecated)) catalogs_items_create_batch_request_t *catalogs_items_create_batch_request_create(
    ...
    catalogs_items_create_batch_request_t *result = catalogs_items_create_batch_request_create_internal (
        country,
        items,
        language,
        operation
...
void catalogs_items_create_batch_request_free(catalogs_items_create_batch_request_t *catalogs_items_create_batch_request) {
    ...
    if(catalogs_items_create_batch_request->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "catalogs_items_create_batch_request_free");
        return ;
    }
...
cJSON *catalogs_items_create_batch_request_convertToJSON(catalogs_items_create_batch_request_t *catalogs_items_create_batch_request) {
    ...
    if (pinterest_rest_api_country__NULL == catalogs_items_create_batch_request->country) {
        goto fail;
    }
    ...
    if (pinterest_rest_api_catalogs_items_create_batch_request_LANGUAGE_NULL == catalogs_items_create_batch_request->language) {
        goto fail;
    }
    if(cJSON_AddStringToObject(item, "language", catalogs_items_create_batch_request_language_ToString(catalogs_items_create_batch_request->language)) == NULL)
    {
    goto fail; //Enum
    }
    ...
    if (pinterest_rest_api_catalogs_items_create_batch_request_OPERATION_NULL == catalogs_items_create_batch_request->operation) {
        goto fail;
    }
    if(cJSON_AddStringToObject(item, "operation", catalogs_items_create_batch_request_operation_ToString(catalogs_items_create_batch_request->operation)) == NULL)
    {
    goto fail; //Enum
    }
...
catalogs_items_create_batch_request_t *catalogs_items_create_batch_request_parseFromJSON(cJSON *catalogs_items_create_batch_requestJSON){
    ...
    pinterest_rest_api_catalogs_items_create_batch_request_LANGUAGE_e languageVariable;
    
    if(!cJSON_IsString(language))
    {
    goto end; //Enum
    }
    languageVariable = catalogs_items_create_batch_request_language_FromString(language->valuestring);
    ...
    pinterest_rest_api_catalogs_items_create_batch_request_OPERATION_e operationVariable;
    
    if(!cJSON_IsString(operation))
    {
    goto end; //Enum
    }
    operationVariable = catalogs_items_create_batch_request_operation_FromString(operation->valuestring);



    catalogs_items_create_batch_request_local_var = catalogs_items_create_batch_request_create_internal (
