...
static business_member_assets_get_200_response_t *business_member_assets_get_200_response_create_internal(
    list_t *items,
    char *bookmark
    ) {
    ...
    business_member_assets_get_200_response_local_var->_library_owned = 1;
...
__attribute__((deprecated)) business_member_assets_get_200_response_t *business_member_assets_get_200_response_create(
    ...
    return business_member_assets_get_200_response_create_internal (
        items,
        bookmark
        );
}
...
void business_member_assets_get_200_response_free(business_member_assets_get_200_response_t *business_member_assets_get_200_response) {
    ...
    if(business_member_assets_get_200_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "business_member_assets_get_200_response_free");
        return ;
    }
...
business_member_assets_get_200_response_t *business_member_assets_get_200_response_parseFromJSON(cJSON *business_member_assets_get_200_responseJSON){
    ...
    business_member_assets_get_200_response_local_var = business_member_assets_get_200_response_create_internal (
        itemsList,
