/*
 * ad_account_to_business_shared_audience_update_with_required_body.h
 *
 * Resource create or update operation model with required body fields (no OptionalProperties).
 */

#ifndef _ad_account_to_business_shared_audience_update_with_required_body_H_
#define _ad_account_to_business_shared_audience_update_with_required_body_H_
...
typedef struct ad_account_to_business_shared_audience_update_with_required_body_t ad_account_to_business_shared_audience_update_with_required_body_t;

#include "operation_type.h"



typedef struct ad_account_to_business_shared_audience_update_with_required_body_t {
...
} ad_account_to_business_shared_audience_update_with_required_body_t;
...
#endif /* _ad_account_to_business_shared_audience_update_with_required_body_H_ */
