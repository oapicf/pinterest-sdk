...
typedef enum  { pinterest_rest_api_catalogs_delete_retail_item_OPERATION_NULL = 0, pinterest_rest_api_catalogs_delete_retail_item_OPERATION__DELETE } pinterest_rest_api_catalogs_delete_retail_item_OPERATION_e;
