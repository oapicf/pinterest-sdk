...
void targeting_template_response_data_free(targeting_template_response_data_t *targeting_template_response_data) {
    ...
    if (targeting_template_response_data->placement_group) {
        placement_group_type_free(targeting_template_response_data->placement_group);
        targeting_template_response_data->placement_group = NULL;
    }
...
cJSON *targeting_template_response_data_convertToJSON(targeting_template_response_data_t *targeting_template_response_data) {
    ...
    if(targeting_template_response_data->placement_group != pinterest_rest_api_targeting_template_response_data__NULL) {
    ...
    if(cJSON_AddStringToObject(item, "status", statustargeting_template_response_data_ToString(targeting_template_response_data->status)) == NULL)
    {
    goto fail; //Enum
    }
    }
...
targeting_template_response_data_t *targeting_template_response_data_parseFromJSON(cJSON *targeting_template_response_dataJSON){
    ...
    targeting_template_response_data_local_var = targeting_template_response_data_create (
