...
static ad_accounts_subscriptions_get_list_200_response_t *ad_accounts_subscriptions_get_list_200_response_create_internal(
    ...
    memset(ad_accounts_subscriptions_get_list_200_response_local_var, 0, sizeof(ad_accounts_subscriptions_get_list_200_response_t));
...
__attribute__((deprecated)) ad_accounts_subscriptions_get_list_200_response_t *ad_accounts_subscriptions_get_list_200_response_create(
    ...
    ad_accounts_subscriptions_get_list_200_response_t *result = ad_accounts_subscriptions_get_list_200_response_create_internal (
        bookmark,
        items
        );
    if (!result) {
...
void ad_accounts_subscriptions_get_list_200_response_free(ad_accounts_subscriptions_get_list_200_response_t *ad_accounts_subscriptions_get_list_200_response) {
    if(NULL == ad_accounts_subscriptions_get_list_200_response){
        return ;
    }
    if(ad_accounts_subscriptions_get_list_200_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "ad_accounts_subscriptions_get_list_200_response_free");
        return ;
    }
...
ad_accounts_subscriptions_get_list_200_response_t *ad_accounts_subscriptions_get_list_200_response_parseFromJSON(cJSON *ad_accounts_subscriptions_get_list_200_responseJSON){
    ...
    ad_accounts_subscriptions_get_list_200_response_t *ad_accounts_subscriptions_get_list_200_response_local_var = NULL;
