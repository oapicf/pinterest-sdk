/*
 * catalogs_retail_report_stats_parameters.h
 *
 * Parameters for retail report
 */

#ifndef _catalogs_retail_report_stats_parameters_H_
#define _catalogs_retail_report_stats_parameters_H_
...
typedef struct catalogs_retail_report_stats_parameters_t catalogs_retail_report_stats_parameters_t;

#include "catalogs_retail_report_stats_parameters_report.h"

// Enum CATALOGTYPE for catalogs_retail_report_stats_parameters

typedef enum  { pinterest_rest_api_catalogs_retail_report_stats_parameters_CATALOGTYPE_NULL = 0, pinterest_rest_api_catalogs_retail_report_stats_parameters_CATALOGTYPE_RETAIL } pinterest_rest_api_catalogs_retail_report_stats_parameters_CATALOGTYPE_e;
...
typedef struct catalogs_retail_report_stats_parameters_t {
    pinterest_rest_api_catalogs_retail_report_stats_parameters_CATALOGTYPE_e catalog_type; //enum
    struct catalogs_retail_report_stats_parameters_report_t *report; //model

    int _library_owned; // Is the library responsible for freeing this object?
} catalogs_retail_report_stats_parameters_t;
...
#endif /* _catalogs_retail_report_stats_parameters_H_ */
