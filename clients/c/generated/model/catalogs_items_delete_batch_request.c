...
char* catalogs_items_delete_batch_request_country_ToString(pinterest_rest_api_catalogs_items_delete_batch_request__e country) {
...
pinterest_rest_api_catalogs_items_delete_batch_request__e catalogs_items_delete_batch_request_country_FromString(char* country){
...
char* catalogs_items_delete_batch_request_language_ToString(pinterest_rest_api_catalogs_items_delete_batch_request__e language) {
...
pinterest_rest_api_catalogs_items_delete_batch_request__e catalogs_items_delete_batch_request_language_FromString(char* language){
    int stringToReturn = 0;
    char *languageArray[] =  { "NULL", "AM", "AR", "AZ", "BG", "BN", "BS", "CA", "CS", "DA", "DV", "DZ", "DE", "EL", "EN", "ES", "ET", "FA", "FI", "FR", "HE", "HI", "HR", "HU", "HY", "ID", "IN", "IS", "IT", "IW", "JA", "KA", "KM", "KO", "LO", "LT", "LV", "MK", "MN", "MS", "MY", "NB", "NE", "NL", "NO", "PL", "PT", "RO", "RU", "SK", "SL", "SQ", "SR", "SV", "TL", "UK", "VI", "TE", "TH", "TR", "XX", "ZH" };
...
char* catalogs_items_delete_batch_request_operation_ToString(pinterest_rest_api_catalogs_items_delete_batch_request__e operation) {
    char* operationArray[] =  { "NULL", "UPDATE", "UPSERT", "CREATE", "DELETE_DISCONTINUED", "DELETE" };
    return operationArray[operation];
}

pinterest_rest_api_catalogs_items_delete_batch_request__e catalogs_items_delete_batch_request_operation_FromString(char* operation){
    int stringToReturn = 0;
    char *operationArray[] =  { "NULL", "UPDATE", "UPSERT", "CREATE", "DELETE_DISCONTINUED", "DELETE" };
...
catalogs_items_delete_batch_request_t *catalogs_items_delete_batch_request_create(
    country_t *country,
    language_t *language,
...
void catalogs_items_delete_batch_request_free(catalogs_items_delete_batch_request_t *catalogs_items_delete_batch_request) {
    if(NULL == catalogs_items_delete_batch_request){
        return ;
    }
    listEntry_t *listEntry;
    if (catalogs_items_delete_batch_request->country) {
        country_free(catalogs_items_delete_batch_request->country);
        catalogs_items_delete_batch_request->country = NULL;
    }
    if (catalogs_items_delete_batch_request->language) {
        language_free(catalogs_items_delete_batch_request->language);
        catalogs_items_delete_batch_request->language = NULL;
    }
    if (catalogs_items_delete_batch_request->operation) {
        batch_operation_free(catalogs_items_delete_batch_request->operation);
        catalogs_items_delete_batch_request->operation = NULL;
    }
    if (catalogs_items_delete_batch_request->items) {
        list_ForEach(listEntry, catalogs_items_delete_batch_request->items) {
            item_delete_batch_record_free(listEntry->data);
        }
        list_freeList(catalogs_items_delete_batch_request->items);
        catalogs_items_delete_batch_request->items = NULL;
    }
    free(catalogs_items_delete_batch_request);
}
...
cJSON *catalogs_items_delete_batch_request_convertToJSON(catalogs_items_delete_batch_request_t *catalogs_items_delete_batch_request) {
    ...
    if (pinterest_rest_api_catalogs_items_delete_batch_request__NULL == catalogs_items_delete_batch_request->country) {
        goto fail;
    }
    cJSON *country_local_JSON = country_convertToJSON(catalogs_items_delete_batch_request->country);
    ...
    // catalogs_items_delete_batch_request->language
    if (pinterest_rest_api_catalogs_items_delete_batch_request__NULL == catalogs_items_delete_batch_request->language) {
        goto fail;
    }
    cJSON *language_local_JSON = language_convertToJSON(catalogs_items_delete_batch_request->language);
    ...
    if (pinterest_rest_api_catalogs_items_delete_batch_request__NULL == catalogs_items_delete_batch_request->operation) {
        goto fail;
    }
    ...
    // catalogs_items_delete_batch_request->items
    if (!catalogs_items_delete_batch_request->items) {
        goto fail;
    }
    ...
    if (catalogs_items_delete_batch_request->items) {
    list_ForEach(itemsListEntry, catalogs_items_delete_batch_request->items) {
...
catalogs_items_delete_batch_request_t *catalogs_items_delete_batch_request_parseFromJSON(cJSON *catalogs_items_delete_batch_requestJSON){
    ...
    catalogs_items_delete_batch_request_t *catalogs_items_delete_batch_request_local_var = NULL;

    // define the local variable for catalogs_items_delete_batch_request->country
    country_t *country_local_nonprim = NULL;

    // define the local variable for catalogs_items_delete_batch_request->language
    ...
    // catalogs_items_delete_batch_request->language
    cJSON *language = cJSON_GetObjectItemCaseSensitive(catalogs_items_delete_batch_requestJSON, "language");
    if (!language) {
        goto end;
    }
    ...
    // catalogs_items_delete_batch_request->operation
    cJSON *operation = cJSON_GetObjectItemCaseSensitive(catalogs_items_delete_batch_requestJSON, "operation");
    if (!operation) {
        goto end;
    }
    ...
    // catalogs_items_delete_batch_request->items
    cJSON *items = cJSON_GetObjectItemCaseSensitive(catalogs_items_delete_batch_requestJSON, "items");
    if (!items) {
        goto end;
    }
    ...
    catalogs_items_delete_batch_request_local_var = catalogs_items_delete_batch_request_create (
