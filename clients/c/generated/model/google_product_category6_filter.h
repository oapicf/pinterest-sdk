/*
 * google_product_category6_filter.h
 *
 * 
 */

#ifndef _google_product_category6_filter_H_
#define _google_product_category6_filter_H_
...
typedef struct google_product_category6_filter_t google_product_category6_filter_t;

#include "catalogs_product_group_multiple_string_list_criteria.h"



typedef struct google_product_category6_filter_t {
    catalogs_product_group_multiple_string_list_criteria_t *google_product_category_6; //object

} google_product_category6_filter_t;
...
#endif /* _google_product_category6_filter_H_ */
