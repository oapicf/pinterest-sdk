...
static catalogs_hotel_product_group_create_request_t *catalogs_hotel_product_group_create_request_create_internal(
    char *catalog_id,
    ...
    memset(catalogs_hotel_product_group_create_request_local_var, 0, sizeof(catalogs_hotel_product_group_create_request_t));
    catalogs_hotel_product_group_create_request_local_var->_library_owned = 1;
...
__attribute__((deprecated)) catalogs_hotel_product_group_create_request_t *catalogs_hotel_product_group_create_request_create(
    ...
    catalogs_hotel_product_group_create_request_t *result = catalogs_hotel_product_group_create_request_create_internal (
        catalog_id,
        catalog_type,
        description,
        filters,
...
void catalogs_hotel_product_group_create_request_free(catalogs_hotel_product_group_create_request_t *catalogs_hotel_product_group_create_request) {
    ...
    if(catalogs_hotel_product_group_create_request->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "catalogs_hotel_product_group_create_request_free");
        return ;
    }
...
cJSON *catalogs_hotel_product_group_create_request_convertToJSON(catalogs_hotel_product_group_create_request_t *catalogs_hotel_product_group_create_request) {
    ...
    if(cJSON_AddStringToObject(item, "catalog_type", catalogs_hotel_product_group_create_request_catalog_type_ToString(catalogs_hotel_product_group_create_request->catalog_type)) == NULL)
    {
    goto fail; //Enum
    }
...
catalogs_hotel_product_group_create_request_t *catalogs_hotel_product_group_create_request_parseFromJSON(cJSON *catalogs_hotel_product_group_create_requestJSON){
    ...
    catalogs_hotel_product_group_create_request_local_var = catalogs_hotel_product_group_create_request_create_internal (
