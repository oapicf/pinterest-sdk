...
static ssio_order_lines_get_by_ad_account_200_response_t *ssio_order_lines_get_by_ad_account_200_response_create_internal(
    ...
    memset(ssio_order_lines_get_by_ad_account_200_response_local_var, 0, sizeof(ssio_order_lines_get_by_ad_account_200_response_t));
...
__attribute__((deprecated)) ssio_order_lines_get_by_ad_account_200_response_t *ssio_order_lines_get_by_ad_account_200_response_create(
    ...
    ssio_order_lines_get_by_ad_account_200_response_t *result = ssio_order_lines_get_by_ad_account_200_response_create_internal (
        bookmark,
        items
        );
    if (!result) {
