...
char* advanced_auction_items_submit_delete_record_country_ToString(pinterest_rest_api_advanced_auction_items_submit_delete_record__e country) {
...
pinterest_rest_api_advanced_auction_items_submit_delete_record__e advanced_auction_items_submit_delete_record_country_FromString(char* country){
...
char* advanced_auction_items_submit_delete_record_language_ToString(pinterest_rest_api_advanced_auction_items_submit_delete_record__e language) {
...
pinterest_rest_api_advanced_auction_items_submit_delete_record__e advanced_auction_items_submit_delete_record_language_FromString(char* language){
    int stringToReturn = 0;
    char *languageArray[] =  { "NULL", "AM", "AR", "AZ", "BG", "BN", "BS", "CA", "CS", "DA", "DV", "DZ", "DE", "EL", "EN", "ES", "ET", "FA", "FI", "FR", "HE", "HI", "HR", "HU", "HY", "ID", "IN", "IS", "IT", "IW", "JA", "KA", "KM", "KO", "LO", "LT", "LV", "MK", "MN", "MS", "MY", "NB", "NE", "NL", "NO", "PL", "PT", "RO", "RU", "SK", "SL", "SQ", "SR", "SV", "TL", "UK", "VI", "TE", "TH", "TR", "XX", "ZH" };
...
advanced_auction_items_submit_delete_record_t *advanced_auction_items_submit_delete_record_create(
    char *item_id,
    country_t *country,
    language_t *language
    ) {
...
void advanced_auction_items_submit_delete_record_free(advanced_auction_items_submit_delete_record_t *advanced_auction_items_submit_delete_record) {
    ...
    if (advanced_auction_items_submit_delete_record->country) {
        country_free(advanced_auction_items_submit_delete_record->country);
        advanced_auction_items_submit_delete_record->country = NULL;
    }
    if (advanced_auction_items_submit_delete_record->language) {
        language_free(advanced_auction_items_submit_delete_record->language);
        advanced_auction_items_submit_delete_record->language = NULL;
    }
...
cJSON *advanced_auction_items_submit_delete_record_convertToJSON(advanced_auction_items_submit_delete_record_t *advanced_auction_items_submit_delete_record) {
    ...
    if (pinterest_rest_api_advanced_auction_items_submit_delete_record__NULL == advanced_auction_items_submit_delete_record->country) {
        goto fail;
    }
    ...
    if (pinterest_rest_api_advanced_auction_items_submit_delete_record__NULL == advanced_auction_items_submit_delete_record->language) {
        goto fail;
    }
...
advanced_auction_items_submit_delete_record_t *advanced_auction_items_submit_delete_record_parseFromJSON(cJSON *advanced_auction_items_submit_delete_recordJSON){
    ...
    advanced_auction_items_submit_delete_record_local_var = advanced_auction_items_submit_delete_record_create (
