...
void catalogs_creative_assets_batch_request_free(catalogs_creative_assets_batch_request_t *catalogs_creative_assets_batch_request) {
    ...
    if(catalogs_creative_assets_batch_request->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "catalogs_creative_assets_batch_request_free");
        return ;
    }
...
cJSON *catalogs_creative_assets_batch_request_convertToJSON(catalogs_creative_assets_batch_request_t *catalogs_creative_assets_batch_request) {
    ...
    if(cJSON_AddStringToObject(item, "catalog_type", catalogs_creative_assets_batch_request_catalog_type_ToString(catalogs_creative_assets_batch_request->catalog_type)) == NULL)
    {
    goto fail; //Enum
    }
    ...
    if (pinterest_rest_api_country__NULL == catalogs_creative_assets_batch_request->country) {
        goto fail;
    }
