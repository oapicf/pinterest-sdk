...
static catalogs_create_creative_assets_item_t *catalogs_create_creative_assets_item_create_internal(
    ...
    memset(catalogs_create_creative_assets_item_local_var, 0, sizeof(catalogs_create_creative_assets_item_t));
...
__attribute__((deprecated)) catalogs_create_creative_assets_item_t *catalogs_create_creative_assets_item_create(
    ...
    catalogs_create_creative_assets_item_t *result = catalogs_create_creative_assets_item_create_internal (
        attributes,
        creative_assets_id,
        operation
        );
