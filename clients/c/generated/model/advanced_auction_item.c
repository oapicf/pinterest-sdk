...
char* advanced_auction_item_country_ToString(pinterest_rest_api_advanced_auction_item__e country) {
...
pinterest_rest_api_advanced_auction_item__e advanced_auction_item_country_FromString(char* country){
...
char* advanced_auction_item_language_ToString(pinterest_rest_api_advanced_auction_item__e language) {
...
pinterest_rest_api_advanced_auction_item__e advanced_auction_item_language_FromString(char* language){
    int stringToReturn = 0;
    char *languageArray[] =  { "NULL", "AM", "AR", "AZ", "BG", "BN", "BS", "CA", "CS", "DA", "DV", "DZ", "DE", "EL", "EN", "ES", "ET", "FA", "FI", "FR", "HE", "HI", "HR", "HU", "HY", "ID", "IN", "IS", "IT", "IW", "JA", "KA", "KM", "KO", "LO", "LT", "LV", "MK", "MN", "MS", "MY", "NB", "NE", "NL", "NO", "PL", "PT", "RO", "RU", "SK", "SL", "SQ", "SR", "SV", "TL", "UK", "VI", "TE", "TH", "TR", "XX", "ZH" };
...
advanced_auction_item_t *advanced_auction_item_create(
    char *item_id,
    country_t *country,
    language_t *language,
...
void advanced_auction_item_free(advanced_auction_item_t *advanced_auction_item) {
    ...
    if (advanced_auction_item->country) {
        country_free(advanced_auction_item->country);
        advanced_auction_item->country = NULL;
    }
    if (advanced_auction_item->language) {
        language_free(advanced_auction_item->language);
        advanced_auction_item->language = NULL;
    }
...
cJSON *advanced_auction_item_convertToJSON(advanced_auction_item_t *advanced_auction_item) {
    ...
    if (pinterest_rest_api_advanced_auction_item__NULL == advanced_auction_item->country) {
        goto fail;
    }
    ...
    if (pinterest_rest_api_advanced_auction_item__NULL == advanced_auction_item->language) {
        goto fail;
    }
...
advanced_auction_item_t *advanced_auction_item_parseFromJSON(cJSON *advanced_auction_itemJSON){
    ...
    advanced_auction_item_local_var = advanced_auction_item_create (
