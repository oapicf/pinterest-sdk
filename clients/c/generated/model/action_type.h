...
typedef enum { pinterest_rest_api_action_type__NULL = 0, pinterest_rest_api_action_type__CLICKTHROUGH, pinterest_rest_api_action_type__IMPRESSION, pinterest_rest_api_action_type__VIDEO_V_50_MRC } pinterest_rest_api_action_type__e;
