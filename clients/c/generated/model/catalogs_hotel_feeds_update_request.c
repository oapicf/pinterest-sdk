...
char* catalogs_hotel_feeds_update_request_catalog_type_ToString(pinterest_rest_api_catalogs_hotel_feeds_update_request_CATALOGTYPE_e catalog_type) {
    char* catalog_typeArray[] =  { "NULL", "HOTEL" };
    return catalog_typeArray[catalog_type];
}

pinterest_rest_api_catalogs_hotel_feeds_update_request_CATALOGTYPE_e catalogs_hotel_feeds_update_request_catalog_type_FromString(char* catalog_type){
...
static catalogs_hotel_feeds_update_request_t *catalogs_hotel_feeds_update_request_create_internal(
    pinterest_rest_api_catalogs_hotel_feeds_update_request_CATALOGTYPE_e catalog_type,
    ...
    memset(catalogs_hotel_feeds_update_request_local_var, 0, sizeof(catalogs_hotel_feeds_update_request_t));
...
__attribute__((deprecated)) catalogs_hotel_feeds_update_request_t *catalogs_hotel_feeds_update_request_create(
    ...
    catalogs_hotel_feeds_update_request_t *result = catalogs_hotel_feeds_update_request_create_internal (
        catalog_type,
        credentials,
        default_currency,
        format,
...
cJSON *catalogs_hotel_feeds_update_request_convertToJSON(catalogs_hotel_feeds_update_request_t *catalogs_hotel_feeds_update_request) {
    ...
    if (pinterest_rest_api_catalogs_hotel_feeds_update_request_CATALOGTYPE_NULL == catalogs_hotel_feeds_update_request->catalog_type) {
        goto fail;
    }
    if(cJSON_AddStringToObject(item, "catalog_type", catalogs_hotel_feeds_update_request_catalog_type_ToString(catalogs_hotel_feeds_update_request->catalog_type)) == NULL)
    {
    goto fail; //Enum
    }
...
catalogs_hotel_feeds_update_request_t *catalogs_hotel_feeds_update_request_parseFromJSON(cJSON *catalogs_hotel_feeds_update_requestJSON){
    ...
    pinterest_rest_api_catalogs_hotel_feeds_update_request_CATALOGTYPE_e catalog_typeVariable;
    
    if(!cJSON_IsString(catalog_type))
    {
    goto end; //Enum
    }
    catalog_typeVariable = catalogs_hotel_feeds_update_request_catalog_type_FromString(catalog_type->valuestring);
