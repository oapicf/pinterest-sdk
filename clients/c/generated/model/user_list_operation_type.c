...
cJSON *user_list_operation_type_convertToJSON(pinterest_rest_api_user_list_operation_type__e user_list_operation_type) {
...
pinterest_rest_api_user_list_operation_type__e user_list_operation_type_parseFromJSON(cJSON *user_list_operation_typeJSON) {
    if(!cJSON_IsString(user_list_operation_typeJSON) || (user_list_operation_typeJSON->valuestring == NULL)) {
        return 0;
    }
    return user_list_operation_type_user_list_operation_type_FromString(user_list_operation_typeJSON->valuestring);
}
