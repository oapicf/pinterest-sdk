...
static ad_account_get_subscription_response_t *ad_account_get_subscription_response_create_internal(
    char *lead_form_id,
    char *webhook_url,
    char *id,
    ...
    ad_account_get_subscription_response_local_var->_library_owned = 1;
...
__attribute__((deprecated)) ad_account_get_subscription_response_t *ad_account_get_subscription_response_create(
    ...
    return ad_account_get_subscription_response_create_internal (
        lead_form_id,
        webhook_url,
        id,
        user_account_id,
...
void ad_account_get_subscription_response_free(ad_account_get_subscription_response_t *ad_account_get_subscription_response) {
    ...
    if(ad_account_get_subscription_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "ad_account_get_subscription_response_free");
        return ;
    }
...
ad_account_get_subscription_response_t *ad_account_get_subscription_response_parseFromJSON(cJSON *ad_account_get_subscription_responseJSON){
    ...
    ad_account_get_subscription_response_local_var = ad_account_get_subscription_response_create_internal (
