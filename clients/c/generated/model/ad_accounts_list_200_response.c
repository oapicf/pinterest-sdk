...
static ad_accounts_list_200_response_t *ad_accounts_list_200_response_create_internal(
    char *bookmark,
    list_t *items
    ) {
...
__attribute__((deprecated)) ad_accounts_list_200_response_t *ad_accounts_list_200_response_create(
    char *bookmark,
    list_t *items
    ) {
...
void ad_accounts_list_200_response_free(ad_accounts_list_200_response_t *ad_accounts_list_200_response) {
    ...
    if(ad_accounts_list_200_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "ad_accounts_list_200_response_free");
        return ;
    }
