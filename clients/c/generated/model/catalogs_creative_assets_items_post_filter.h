/*
 * catalogs_creative_assets_items_post_filter.h
 *
 * 
 */

#ifndef _catalogs_creative_assets_items_post_filter_H_
#define _catalogs_creative_assets_items_post_filter_H_
...
typedef struct catalogs_creative_assets_items_post_filter_t catalogs_creative_assets_items_post_filter_t;


// Enum CATALOGTYPE for catalogs_creative_assets_items_post_filter

typedef enum  { pinterest_rest_api_catalogs_creative_assets_items_post_filter_CATALOGTYPE_NULL = 0, pinterest_rest_api_catalogs_creative_assets_items_post_filter_CATALOGTYPE_CREATIVE_ASSETS } pinterest_rest_api_catalogs_creative_assets_items_post_filter_CATALOGTYPE_e;
...
typedef struct catalogs_creative_assets_items_post_filter_t {
    pinterest_rest_api_catalogs_creative_assets_items_post_filter_CATALOGTYPE_e catalog_type; //enum
...
#endif /* _catalogs_creative_assets_items_post_filter_H_ */
