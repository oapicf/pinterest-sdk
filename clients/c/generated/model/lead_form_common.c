...
static lead_form_common_t *lead_form_common_create_internal(
    char *name,
    ...
    lead_form_common_local_var->_library_owned = 1;
...
__attribute__((deprecated)) lead_form_common_t *lead_form_common_create(
    ...
    return lead_form_common_create_internal (
        name,
        privacy_policy_link,
        has_accepted_terms,
        completion_message,
...
void lead_form_common_free(lead_form_common_t *lead_form_common) {
    ...
    if(lead_form_common->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "lead_form_common_free");
        return ;
    }
...
cJSON *lead_form_common_convertToJSON(lead_form_common_t *lead_form_common) {
    ...
    if(lead_form_common->status != pinterest_rest_api_lead_form_status__NULL) {
...
lead_form_common_t *lead_form_common_parseFromJSON(cJSON *lead_form_commonJSON){
    ...
    lead_form_common_local_var = lead_form_common_create_internal (
