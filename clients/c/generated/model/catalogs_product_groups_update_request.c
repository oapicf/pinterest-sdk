...
static catalogs_product_groups_update_request_t *catalogs_product_groups_update_request_create_internal(
    ...
    catalogs_product_groups_update_request_local_var->_library_owned = 1;
...
void catalogs_product_groups_update_request_free(catalogs_product_groups_update_request_t *catalogs_product_groups_update_request) {
    ...
    if(catalogs_product_groups_update_request->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "catalogs_product_groups_update_request_free");
        return ;
    }
...
cJSON *catalogs_product_groups_update_request_convertToJSON(catalogs_product_groups_update_request_t *catalogs_product_groups_update_request) {
    ...
    if(cJSON_AddStringToObject(item, "catalog_type", catalogs_product_groups_update_request_catalog_type_ToString(catalogs_product_groups_update_request->catalog_type)) == NULL)
    {
    goto fail; //Enum
    }
    }
    ...
    if(catalogs_product_groups_update_request->country != pinterest_rest_api_country__NULL) {
    ...
    if(catalogs_product_groups_update_request->locale != pinterest_rest_api_catalogs_locale__NULL) {
