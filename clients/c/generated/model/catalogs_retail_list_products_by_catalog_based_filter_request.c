...
static catalogs_retail_list_products_by_catalog_based_filter_request_t *catalogs_retail_list_products_by_catalog_based_filter_request_create_internal(
    char *catalog_id,
...
void catalogs_retail_list_products_by_catalog_based_filter_request_free(catalogs_retail_list_products_by_catalog_based_filter_request_t *catalogs_retail_list_products_by_catalog_based_filter_request) {
    ...
    if(catalogs_retail_list_products_by_catalog_based_filter_request->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "catalogs_retail_list_products_by_catalog_based_filter_request_free");
        return ;
    }
...
cJSON *catalogs_retail_list_products_by_catalog_based_filter_request_convertToJSON(catalogs_retail_list_products_by_catalog_based_filter_request_t *catalogs_retail_list_products_by_catalog_based_filter_request) {
    ...
    if(cJSON_AddStringToObject(item, "catalog_type", catalogs_retail_list_products_by_catalog_based_filter_request_catalog_type_ToString(catalogs_retail_list_products_by_catalog_based_filter_request->catalog_type)) == NULL)
    {
    goto fail; //Enum
    }
    ...
    if (pinterest_rest_api_country__NULL == catalogs_retail_list_products_by_catalog_based_filter_request->country) {
        goto fail;
    }
    ...
    if (pinterest_rest_api_catalogs_locale__NULL == catalogs_retail_list_products_by_catalog_based_filter_request->locale) {
        goto fail;
    }
