...
static catalogs_creative_assets_feed_t *catalogs_creative_assets_feed_create_internal(
    ...
    memset(catalogs_creative_assets_feed_local_var, 0, sizeof(catalogs_creative_assets_feed_t));
...
__attribute__((deprecated)) catalogs_creative_assets_feed_t *catalogs_creative_assets_feed_create(
    ...
    catalogs_creative_assets_feed_t *result = catalogs_creative_assets_feed_create_internal (
        catalog_id,
        catalog_type,
        created_at,
        credentials,
...
cJSON *catalogs_creative_assets_feed_convertToJSON(catalogs_creative_assets_feed_t *catalogs_creative_assets_feed) {
    ...
    if (pinterest_rest_api_catalogs_creative_assets_feed_CATALOGTYPE_NULL == catalogs_creative_assets_feed->catalog_type) {
        goto fail;
    }
    if(cJSON_AddStringToObject(item, "catalog_type", catalogs_creative_assets_feed_catalog_type_ToString(catalogs_creative_assets_feed->catalog_type)) == NULL)
    {
    goto fail; //Enum
    }
    ...
    if(catalogs_creative_assets_feed->default_currency != pinterest_rest_api_nullable_currency__NULL) {
...
catalogs_creative_assets_feed_t *catalogs_creative_assets_feed_parseFromJSON(cJSON *catalogs_creative_assets_feedJSON){
    ...
    pinterest_rest_api_catalogs_creative_assets_feed_CATALOGTYPE_e catalog_typeVariable;
    
    if(!cJSON_IsString(catalog_type))
    {
    goto end; //Enum
    }
    catalog_typeVariable = catalogs_creative_assets_feed_catalog_type_FromString(catalog_type->valuestring);
