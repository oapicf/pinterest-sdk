...
char* pin_media_with_images_media_type_ToString(pinterest_rest_api_pin_media_with_images_MEDIATYPE_e media_type) {
    char* media_typeArray[] =  { "NULL", "multiple_images" };
...
cJSON *pin_media_with_images_convertToJSON(pin_media_with_images_t *pin_media_with_images) {
    ...
    if (pinterest_rest_api_pin_media_with_images_MEDIATYPE_NULL == pin_media_with_images->media_type) {
        goto fail;
    }
    if(cJSON_AddStringToObject(item, "media_type", pin_media_with_images_media_type_ToString(pin_media_with_images->media_type)) == NULL)
    {
    goto fail; //Enum
    }
...
pin_media_with_images_t *pin_media_with_images_parseFromJSON(cJSON *pin_media_with_imagesJSON){
    ...
    pinterest_rest_api_pin_media_with_images_MEDIATYPE_e media_typeVariable;
