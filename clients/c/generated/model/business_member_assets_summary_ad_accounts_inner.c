...
business_member_assets_summary_ad_accounts_inner_t *business_member_assets_summary_ad_accounts_inner_create(
    ...
    business_member_assets_summary_ad_accounts_inner_t *business_member_assets_summary_ad_accounts_inner_local_var = malloc(sizeof(business_member_assets_summary_ad_accounts_inner_t));
    if (!business_member_assets_summary_ad_accounts_inner_local_var) {
        return NULL;
    }
...
void business_member_assets_summary_ad_accounts_inner_free(business_member_assets_summary_ad_accounts_inner_t *business_member_assets_summary_ad_accounts_inner) {
    ...
    if (business_member_assets_summary_ad_accounts_inner->id) {
        free(business_member_assets_summary_ad_accounts_inner->id);
        business_member_assets_summary_ad_accounts_inner->id = NULL;
    }
    if (business_member_assets_summary_ad_accounts_inner->permissions) {
        list_ForEach(listEntry, business_member_assets_summary_ad_accounts_inner->permissions) {
            free(listEntry->data);
        }
        list_freeList(business_member_assets_summary_ad_accounts_inner->permissions);
        business_member_assets_summary_ad_accounts_inner->permissions = NULL;
    }
    free(business_member_assets_summary_ad_accounts_inner);
}
...
cJSON *business_member_assets_summary_ad_accounts_inner_convertToJSON(business_member_assets_summary_ad_accounts_inner_t *business_member_assets_summary_ad_accounts_inner) {
    ...
    if(business_member_assets_summary_ad_accounts_inner->id) {
    if(cJSON_AddStringToObject(item, "id", business_member_assets_summary_ad_accounts_inner->id) == NULL) {
    goto fail; //String
    }
    }
...
business_member_assets_summary_ad_accounts_inner_t *business_member_assets_summary_ad_accounts_inner_parseFromJSON(cJSON *business_member_assets_summary_ad_accounts_innerJSON){
    ...
    business_member_assets_summary_ad_accounts_inner_t *business_member_assets_summary_ad_accounts_inner_local_var = NULL;

    // define the local list for business_member_assets_summary_ad_accounts_inner->permissions
