...
cJSON *ads_analytics_targeting_type_convertToJSON(pinterest_rest_api_ads_analytics_targeting_type__e ads_analytics_targeting_type) {
...
pinterest_rest_api_ads_analytics_targeting_type__e ads_analytics_targeting_type_parseFromJSON(cJSON *ads_analytics_targeting_typeJSON) {
    if(!cJSON_IsString(ads_analytics_targeting_typeJSON) || (ads_analytics_targeting_typeJSON->valuestring == NULL)) {
        return 0;
    }
    return ads_analytics_targeting_type_ads_analytics_targeting_type_FromString(ads_analytics_targeting_typeJSON->valuestring);
}
