...
static billing_profiles_get_200_response_t *billing_profiles_get_200_response_create_internal(
    ...
    memset(billing_profiles_get_200_response_local_var, 0, sizeof(billing_profiles_get_200_response_t));
...
__attribute__((deprecated)) billing_profiles_get_200_response_t *billing_profiles_get_200_response_create(
    ...
    billing_profiles_get_200_response_t *result = billing_profiles_get_200_response_create_internal (
        bookmark,
        items
        );
    if (!result) {
...
void billing_profiles_get_200_response_free(billing_profiles_get_200_response_t *billing_profiles_get_200_response) {
    ...
    if(billing_profiles_get_200_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "billing_profiles_get_200_response_free");
        return ;
    }
