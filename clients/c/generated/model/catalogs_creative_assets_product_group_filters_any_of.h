/*
 * catalogs_creative_assets_product_group_filters_any_of.h
 *
 * 
 */

#ifndef _catalogs_creative_assets_product_group_filters_any_of_H_
#define _catalogs_creative_assets_product_group_filters_any_of_H_
...
typedef struct catalogs_creative_assets_product_group_filters_any_of_t catalogs_creative_assets_product_group_filters_any_of_t;

#include "catalogs_creative_assets_product_group_filter_keys.h"



typedef struct catalogs_creative_assets_product_group_filters_any_of_t {
    list_t *any_of; //nonprimitive container

    int _library_owned; // Is the library responsible for freeing this object?
} catalogs_creative_assets_product_group_filters_any_of_t;
...
#endif /* _catalogs_creative_assets_product_group_filters_any_of_H_ */
