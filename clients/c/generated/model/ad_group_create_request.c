...
void ad_group_create_request_free(ad_group_create_request_t *ad_group_create_request) {
    ...
    if (ad_group_create_request->optimization_goal_metadata) {
        ad_group_common_optimization_goal_metadata_free(ad_group_create_request->optimization_goal_metadata);
    ...
    if (ad_group_create_request->tracking_urls) {
        ad_group_common_tracking_urls_free(ad_group_create_request->tracking_urls);
...
cJSON *ad_group_create_request_convertToJSON(ad_group_create_request_t *ad_group_create_request) {
    ...
    if(ad_group_create_request->optimization_goal_metadata) {
    cJSON *optimization_goal_metadata_local_JSON = ad_group_common_optimization_goal_metadata_convertToJSON(ad_group_create_request->optimization_goal_metadata);
    ...
    if(ad_group_create_request->tracking_urls) {
    cJSON *tracking_urls_local_JSON = ad_group_common_tracking_urls_convertToJSON(ad_group_create_request->tracking_urls);
