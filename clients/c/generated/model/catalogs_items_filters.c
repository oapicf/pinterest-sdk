...
static catalogs_items_filters_t *catalogs_items_filters_create_internal(
    ...
    catalogs_items_filters_local_var->_library_owned = 1;
...
__attribute__((deprecated)) catalogs_items_filters_t *catalogs_items_filters_create(
    ...
    return catalogs_items_filters_create_internal (
        catalog_type,
        item_ids,
        catalog_id,
        hotel_ids,
...
void catalogs_items_filters_free(catalogs_items_filters_t *catalogs_items_filters) {
    ...
    if(catalogs_items_filters->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "catalogs_items_filters_free");
        return ;
    }
...
cJSON *catalogs_items_filters_convertToJSON(catalogs_items_filters_t *catalogs_items_filters) {
    ...
    if (pinterest_rest_api_catalogs_type__NULL == catalogs_items_filters->catalog_type) {
        goto fail;
    }
...
catalogs_items_filters_t *catalogs_items_filters_parseFromJSON(cJSON *catalogs_items_filtersJSON){
    ...
    catalogs_items_filters_local_var = catalogs_items_filters_create_internal (
