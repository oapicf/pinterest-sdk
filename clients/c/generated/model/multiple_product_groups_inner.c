...
cJSON *multiple_product_groups_inner_convertToJSON(multiple_product_groups_inner_t *multiple_product_groups_inner) {
    ...
    if(multiple_product_groups_inner->country != pinterest_rest_api_country__NULL) {
    ...
    if(multiple_product_groups_inner->locale != pinterest_rest_api_catalogs_locale__NULL) {
