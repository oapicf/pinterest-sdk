/*
 * schedule_bid_options_gender_multipliers.h
 *
...
#ifndef _schedule_bid_options_gender_multipliers_H_
#define _schedule_bid_options_gender_multipliers_H_
...
typedef struct schedule_bid_options_gender_multipliers_t schedule_bid_options_gender_multipliers_t;

#include "targeting_spec_gender.h"



typedef struct schedule_bid_options_gender_multipliers_t {
    pinterest_rest_api_targeting_spec_gender__e gender; //referenced enum

    int _library_owned; // Is the library responsible for freeing this object?
} schedule_bid_options_gender_multipliers_t;
...
#endif /* _schedule_bid_options_gender_multipliers_H_ */
