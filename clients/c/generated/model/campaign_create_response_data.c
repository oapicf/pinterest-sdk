...
static campaign_create_response_data_t *campaign_create_response_data_create_internal(
    ...
    campaign_create_response_data_local_var->bid_options = bid_options;
    campaign_create_response_data_local_var->created_time = created_time;
    campaign_create_response_data_local_var->is_performance_plus = is_performance_plus;
...
void campaign_create_response_data_free(campaign_create_response_data_t *campaign_create_response_data) {
    ...
    if (campaign_create_response_data->bid_options) {
        campaign_bid_options_free(campaign_create_response_data->bid_options);
        campaign_create_response_data->bid_options = NULL;
    }
...
cJSON *campaign_create_response_data_convertToJSON(campaign_create_response_data_t *campaign_create_response_data) {
    ...
    // campaign_create_response_data->bid_options
    if(campaign_create_response_data->bid_options) {
    cJSON *bid_options_local_JSON = campaign_bid_options_convertToJSON(campaign_create_response_data->bid_options);
    ...
    // campaign_create_response_data->is_performance_plus
    if(campaign_create_response_data->is_performance_plus) {
    if(cJSON_AddBoolToObject(item, "is_performance_plus", campaign_create_response_data->is_performance_plus) == NULL) {
    goto fail; //Bool
    }
    }
...
campaign_create_response_data_t *campaign_create_response_data_parseFromJSON(cJSON *campaign_create_response_dataJSON){
    ...
    // define the local variable for campaign_create_response_data->bid_options
    ...
    // campaign_create_response_data->bid_options
    cJSON *bid_options = cJSON_GetObjectItemCaseSensitive(campaign_create_response_dataJSON, "bid_options");
    ...
    // campaign_create_response_data->is_performance_plus
    cJSON *is_performance_plus = cJSON_GetObjectItemCaseSensitive(campaign_create_response_dataJSON, "is_performance_plus");
