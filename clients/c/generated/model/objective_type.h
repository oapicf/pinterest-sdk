...
typedef enum { pinterest_rest_api_objective_type__NULL = 0, pinterest_rest_api_objective_type__AWARENESS, pinterest_rest_api_objective_type__CONSIDERATION, pinterest_rest_api_objective_type__WEB_CONVERSION, pinterest_rest_api_objective_type__CATALOG_SALES, pinterest_rest_api_objective_type__VIDEO_COMPLETION, pinterest_rest_api_objective_type__SALES, pinterest_rest_api_objective_type__APP_INSTALL, pinterest_rest_api_objective_type__CTV_CONSIDERATION } pinterest_rest_api_objective_type__e;
