...
__attribute__((deprecated)) ad_update_request_t *ad_update_request_create(
    ...
    return ad_update_request_create_internal (
        ad_group_id,
        android_deep_link,
...
cJSON *ad_update_request_convertToJSON(ad_update_request_t *ad_update_request) {
    ...
    if(cJSON_AddStringToObject(item, "customizable_cta_type", ad_update_request_customizable_cta_type_ToString(ad_update_request->customizable_cta_type)) == NULL)
    {
    goto fail; //Enum
    }
    }
