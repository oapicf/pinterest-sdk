...
void ad_update_request_free(ad_update_request_t *ad_update_request) {
    ...
    if (ad_update_request->creative_type) {
        creative_type_free(ad_update_request->creative_type);
        ad_update_request->creative_type = NULL;
    }
    ...
    if (ad_update_request->status) {
        entity_status_free(ad_update_request->status);
        ad_update_request->status = NULL;
    }
    if (ad_update_request->tracking_urls) {
        ad_common_tracking_urls_free(ad_update_request->tracking_urls);
    ...
    if (ad_update_request->grid_click_type) {
        grid_click_type_free(ad_update_request->grid_click_type);
        ad_update_request->grid_click_type = NULL;
    }
    if (ad_update_request->quiz_pin_data) {
        ad_common_quiz_pin_data_free(ad_update_request->quiz_pin_data);
...
cJSON *ad_update_request_convertToJSON(ad_update_request_t *ad_update_request) {
    ...
    if(ad_update_request->creative_type != pinterest_rest_api_ad_update_request__NULL) {
    ...
    if(ad_update_request->status != pinterest_rest_api_ad_update_request__NULL) {
    ...
    if(ad_update_request->tracking_urls) {
    cJSON *tracking_urls_local_JSON = ad_common_tracking_urls_convertToJSON(ad_update_request->tracking_urls);
    ...
    if(ad_update_request->grid_click_type != pinterest_rest_api_ad_update_request__NULL) {
    ...
    if(ad_update_request->customizable_cta_type != pinterest_rest_api_ad_update_request_CUSTOMIZABLECTATYPE_NULL) {
    if(cJSON_AddStringToObject(item, "customizable_cta_type", customizable_cta_typead_update_request_ToString(ad_update_request->customizable_cta_type)) == NULL)
    {
    goto fail; //Enum
    }
    }
    ...
    if(ad_update_request->quiz_pin_data) {
    cJSON *quiz_pin_data_local_JSON = ad_common_quiz_pin_data_convertToJSON(ad_update_request->quiz_pin_data);
...
ad_update_request_t *ad_update_request_parseFromJSON(cJSON *ad_update_requestJSON){
    ...
    // define the local variable for ad_update_request->tracking_urls
    ...
    // define the local variable for ad_update_request->quiz_pin_data
    ...
    pinterest_rest_api_ad_update_request_CUSTOMIZABLECTATYPE_e customizable_cta_typeVariable;
    if (customizable_cta_type) { 
    if(!cJSON_IsString(customizable_cta_type))
    {
    goto end; //Enum
    }
    customizable_cta_typeVariable = ad_update_request_customizable_cta_type_FromString(customizable_cta_type->valuestring);
    }
    ...
    ad_update_request_local_var = ad_update_request_create (
        ...
        customizable_cta_type ? customizable_cta_typeVariable : pinterest_rest_api_ad_update_request_CUSTOMIZABLECTATYPE_NULL,
