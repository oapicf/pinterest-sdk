...
static trending_keywords_response_trends_inner_t *trending_keywords_response_trends_inner_create_internal(
    char *keyword,
    int pct_growth_wow,
    int pct_growth_mom,
    int pct_growth_yoy,
    ...
    trending_keywords_response_trends_inner_local_var->_library_owned = 1;
...
__attribute__((deprecated)) trending_keywords_response_trends_inner_t *trending_keywords_response_trends_inner_create(
    ...
    return trending_keywords_response_trends_inner_create_internal (
        keyword,
        pct_growth_wow,
        pct_growth_mom,
        pct_growth_yoy,
...
void trending_keywords_response_trends_inner_free(trending_keywords_response_trends_inner_t *trending_keywords_response_trends_inner) {
    ...
    if(trending_keywords_response_trends_inner->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "trending_keywords_response_trends_inner_free");
        return ;
    }
...
trending_keywords_response_trends_inner_t *trending_keywords_response_trends_inner_parseFromJSON(cJSON *trending_keywords_response_trends_innerJSON){
    ...
    trending_keywords_response_trends_inner_local_var = trending_keywords_response_trends_inner_create_internal (
