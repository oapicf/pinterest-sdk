...
static updatable_item_attributes_gtin_t *updatable_item_attributes_gtin_create_internal(
    ...
    memset(updatable_item_attributes_gtin_local_var, 0, sizeof(updatable_item_attributes_gtin_t));
...
__attribute__((deprecated)) updatable_item_attributes_gtin_t *updatable_item_attributes_gtin_create(
    ...
    updatable_item_attributes_gtin_t *result = updatable_item_attributes_gtin_create_internal (
        );
    if (!result) {
    }
    return result;
