/*
 * invite_assets_summary_ad_accounts_inner.h
 *
 * 
 */

#ifndef _invite_assets_summary_ad_accounts_inner_H_
#define _invite_assets_summary_ad_accounts_inner_H_
...
typedef struct invite_assets_summary_ad_accounts_inner_t invite_assets_summary_ad_accounts_inner_t;




typedef struct invite_assets_summary_ad_accounts_inner_t {
    char *id; // string
    list_t *permissions; //primitive container

} invite_assets_summary_ad_accounts_inner_t;
...
#endif /* _invite_assets_summary_ad_accounts_inner_H_ */
