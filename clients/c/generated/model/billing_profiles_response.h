...
// Enum BILLINGTYPE for billing_profiles_response

typedef enum  { pinterest_rest_api_billing_profiles_response_BILLINGTYPE_NULL = 0, pinterest_rest_api_billing_profiles_response_BILLINGTYPE_CREDIT_CARD, pinterest_rest_api_billing_profiles_response_BILLINGTYPE_INVOICE, pinterest_rest_api_billing_profiles_response_BILLINGTYPE_INTERNAL, pinterest_rest_api_billing_profiles_response_BILLINGTYPE_RECURRING, pinterest_rest_api_billing_profiles_response_BILLINGTYPE_PREPAID } pinterest_rest_api_billing_profiles_response_BILLINGTYPE_e;
...
typedef struct billing_profiles_response_t {
    ...
    pinterest_rest_api_billing_profiles_response_BILLINGTYPE_e billing_type; //enum
