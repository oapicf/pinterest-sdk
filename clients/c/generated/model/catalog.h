...
typedef enum  { pinterest_rest_api_catalog__NULL = 0, pinterest_rest_api_catalog__RETAIL, pinterest_rest_api_catalog__HOTEL, pinterest_rest_api_catalog__CREATIVE_ASSETS } pinterest_rest_api_catalog__e;
