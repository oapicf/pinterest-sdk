...
static product_group_promotion_update_request_t *product_group_promotion_update_request_create_internal(
    char *ad_group_id,
    list_t *product_group_promotion
    ) {
    product_group_promotion_update_request_t *product_group_promotion_update_request_local_var = malloc(sizeof(product_group_promotion_update_request_t));
...
__attribute__((deprecated)) product_group_promotion_update_request_t *product_group_promotion_update_request_create(
    char *ad_group_id,
    list_t *product_group_promotion
    ) {
...
void product_group_promotion_update_request_free(product_group_promotion_update_request_t *product_group_promotion_update_request) {
    if(NULL == product_group_promotion_update_request){
        return ;
    }
    if(product_group_promotion_update_request->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "product_group_promotion_update_request_free");
        return ;
    }
    listEntry_t *listEntry;
    if (product_group_promotion_update_request->ad_group_id) {
        free(product_group_promotion_update_request->ad_group_id);
        product_group_promotion_update_request->ad_group_id = NULL;
    }
    if (product_group_promotion_update_request->product_group_promotion) {
        list_ForEach(listEntry, product_group_promotion_update_request->product_group_promotion) {
            product_group_promotion_free(listEntry->data);
        }
        list_freeList(product_group_promotion_update_request->product_group_promotion);
        product_group_promotion_update_request->product_group_promotion = NULL;
    }
    free(product_group_promotion_update_request);
}
...
cJSON *product_group_promotion_update_request_convertToJSON(product_group_promotion_update_request_t *product_group_promotion_update_request) {
    ...
    // product_group_promotion_update_request->ad_group_id
    if (!product_group_promotion_update_request->ad_group_id) {
        goto fail;
    }
    if(cJSON_AddStringToObject(item, "ad_group_id", product_group_promotion_update_request->ad_group_id) == NULL) {
    goto fail; //String
    }


    // product_group_promotion_update_request->product_group_promotion
    if (!product_group_promotion_update_request->product_group_promotion) {
        goto fail;
    }
    ...
    if (product_group_promotion_update_request->product_group_promotion) {
    list_ForEach(product_group_promotionListEntry, product_group_promotion_update_request->product_group_promotion) {
...
product_group_promotion_update_request_t *product_group_promotion_update_request_parseFromJSON(cJSON *product_group_promotion_update_requestJSON){
    ...
    // product_group_promotion_update_request->ad_group_id
    cJSON *ad_group_id = cJSON_GetObjectItemCaseSensitive(product_group_promotion_update_requestJSON, "ad_group_id");
    ...
    // product_group_promotion_update_request->product_group_promotion
    cJSON *product_group_promotion = cJSON_GetObjectItemCaseSensitive(product_group_promotion_update_requestJSON, "product_group_promotion");
