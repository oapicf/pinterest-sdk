...
static item_response_any_of_t *item_response_any_of_create_internal(
    ...
    item_response_any_of_local_var->_library_owned = 1;
...
__attribute__((deprecated)) item_response_any_of_t *item_response_any_of_create(
    ...
    return item_response_any_of_create_internal (
        catalog_type,
        item_id,
        pins,
        attributes,
...
void item_response_any_of_free(item_response_any_of_t *item_response_any_of) {
    ...
    if(item_response_any_of->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "item_response_any_of_free");
        return ;
    }
...
cJSON *item_response_any_of_convertToJSON(item_response_any_of_t *item_response_any_of) {
    ...
    if (pinterest_rest_api_catalogs_type__NULL == item_response_any_of->catalog_type) {
        goto fail;
    }
...
item_response_any_of_t *item_response_any_of_parseFromJSON(cJSON *item_response_any_ofJSON){
    ...
    item_response_any_of_local_var = item_response_any_of_create_internal (
