...
// Enum OPERATION for catalogs_items_delete_discontinued_batch_request

typedef enum  { pinterest_rest_api_catalogs_items_delete_discontinued_batch_request_OPERATION_NULL = 0, pinterest_rest_api_catalogs_items_delete_discontinued_batch_request_OPERATION_DELETE_DISCONTINUED } pinterest_rest_api_catalogs_items_delete_discontinued_batch_request_OPERATION_e;
...
typedef struct catalogs_items_delete_discontinued_batch_request_t {
    ...
    pinterest_rest_api_catalogs_items_delete_discontinued_batch_request_LANGUAGE_e language; //enum
    pinterest_rest_api_catalogs_items_delete_discontinued_batch_request_OPERATION_e operation; //enum
