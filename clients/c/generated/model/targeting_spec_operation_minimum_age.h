/*
 * targeting_spec_operation_minimum_age.h
 *
 * 
 */

#ifndef _targeting_spec_operation_minimum_age_H_
#define _targeting_spec_operation_minimum_age_H_
...
typedef struct targeting_spec_operation_minimum_age_t targeting_spec_operation_minimum_age_t;


// Enum FIELD for targeting_spec_operation_minimum_age

typedef enum  { pinterest_rest_api_targeting_spec_operation_minimum_age_FIELD_NULL = 0, pinterest_rest_api_targeting_spec_operation_minimum_age_FIELD_MINIMUM_AGE } pinterest_rest_api_targeting_spec_operation_minimum_age_FIELD_e;
...
// Enum OPERATION for targeting_spec_operation_minimum_age

typedef enum  { pinterest_rest_api_targeting_spec_operation_minimum_age_OPERATION_NULL = 0, pinterest_rest_api_targeting_spec_operation_minimum_age_OPERATION_SET } pinterest_rest_api_targeting_spec_operation_minimum_age_OPERATION_e;
...
typedef struct targeting_spec_operation_minimum_age_t {
    pinterest_rest_api_targeting_spec_operation_minimum_age_FIELD_e field; //enum
    pinterest_rest_api_targeting_spec_operation_minimum_age_OPERATION_e operation; //enum
    char *value; // string

    int _library_owned; // Is the library responsible for freeing this object?
} targeting_spec_operation_minimum_age_t;
...
#endif /* _targeting_spec_operation_minimum_age_H_ */
