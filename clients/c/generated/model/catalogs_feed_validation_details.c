...
static catalogs_feed_validation_details_t *catalogs_feed_validation_details_create_internal(
    ...
    memset(catalogs_feed_validation_details_local_var, 0, sizeof(catalogs_feed_validation_details_t));
...
__attribute__((deprecated)) catalogs_feed_validation_details_t *catalogs_feed_validation_details_create(
    ...
    catalogs_feed_validation_details_t *result = catalogs_feed_validation_details_create_internal (
        errors,
        warnings
        );
    if (!result) {
