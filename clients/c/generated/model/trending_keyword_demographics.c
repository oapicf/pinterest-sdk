...
__attribute__((deprecated)) trending_keyword_demographics_t *trending_keyword_demographics_create(
    ...
    return trending_keyword_demographics_create_internal (
        age_distribution,
        gender_distribution
        );
}
...
void trending_keyword_demographics_free(trending_keyword_demographics_t *trending_keyword_demographics) {
    ...
    if (trending_keyword_demographics->age_distribution) {
        trending_keyword_demographics_age_distribution_free(trending_keyword_demographics->age_distribution);
        trending_keyword_demographics->age_distribution = NULL;
    }
    if (trending_keyword_demographics->gender_distribution) {
        trending_keyword_demographics_gender_distribution_free(trending_keyword_demographics->gender_distribution);
...
cJSON *trending_keyword_demographics_convertToJSON(trending_keyword_demographics_t *trending_keyword_demographics) {
    ...
    if(trending_keyword_demographics->age_distribution) {
    cJSON *age_distribution_local_JSON = trending_keyword_demographics_age_distribution_convertToJSON(trending_keyword_demographics->age_distribution);
    ...
    if(trending_keyword_demographics->gender_distribution) {
    cJSON *gender_distribution_local_JSON = trending_keyword_demographics_gender_distribution_convertToJSON(trending_keyword_demographics->gender_distribution);
...
trending_keyword_demographics_t *trending_keyword_demographics_parseFromJSON(cJSON *trending_keyword_demographicsJSON){
    ...
    trending_keyword_demographics_age_distribution_t *age_distribution_local_nonprim = NULL;

    // define the local variable for trending_keyword_demographics->gender_distribution
    trending_keyword_demographics_gender_distribution_t *gender_distribution_local_nonprim = NULL;
    ...
    if (age_distribution) { 
    age_distribution_local_nonprim = trending_keyword_demographics_age_distribution_parseFromJSON(age_distribution); //custom
    }
    ...
    gender_distribution_local_nonprim = trending_keyword_demographics_gender_distribution_parseFromJSON(gender_distribution); //custom
    }
    ...
    if (age_distribution_local_nonprim) {
        trending_keyword_demographics_age_distribution_free(age_distribution_local_nonprim);
        age_distribution_local_nonprim = NULL;
    }
    if (gender_distribution_local_nonprim) {
        trending_keyword_demographics_gender_distribution_free(gender_distribution_local_nonprim);
