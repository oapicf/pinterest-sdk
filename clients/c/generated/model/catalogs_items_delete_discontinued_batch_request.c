...
char* catalogs_items_delete_discontinued_batch_request_operation_ToString(pinterest_rest_api_catalogs_items_delete_discontinued_batch_request_OPERATION_e operation) {
    char* operationArray[] =  { "NULL", "DELETE_DISCONTINUED" };
    return operationArray[operation];
}

pinterest_rest_api_catalogs_items_delete_discontinued_batch_request_OPERATION_e catalogs_items_delete_discontinued_batch_request_operation_FromString(char* operation){
...
static catalogs_items_delete_discontinued_batch_request_t *catalogs_items_delete_discontinued_batch_request_create_internal(
    ...
    pinterest_rest_api_catalogs_items_delete_discontinued_batch_request_OPERATION_e operation
    ) {
    ...
    memset(catalogs_items_delete_discontinued_batch_request_local_var, 0, sizeof(catalogs_items_delete_discontinued_batch_request_t));
...
__attribute__((deprecated)) catalogs_items_delete_discontinued_batch_request_t *catalogs_items_delete_discontinued_batch_request_create(
    ...
    catalogs_items_delete_discontinued_batch_request_t *result = catalogs_items_delete_discontinued_batch_request_create_internal (
        country,
        items,
        language,
        operation
...
cJSON *catalogs_items_delete_discontinued_batch_request_convertToJSON(catalogs_items_delete_discontinued_batch_request_t *catalogs_items_delete_discontinued_batch_request) {
    ...
    if (pinterest_rest_api_catalogs_items_delete_discontinued_batch_request_OPERATION_NULL == catalogs_items_delete_discontinued_batch_request->operation) {
        goto fail;
    }
    if(cJSON_AddStringToObject(item, "operation", catalogs_items_delete_discontinued_batch_request_operation_ToString(catalogs_items_delete_discontinued_batch_request->operation)) == NULL)
    {
    goto fail; //Enum
    }
...
catalogs_items_delete_discontinued_batch_request_t *catalogs_items_delete_discontinued_batch_request_parseFromJSON(cJSON *catalogs_items_delete_discontinued_batch_requestJSON){
    ...
    pinterest_rest_api_catalogs_items_delete_discontinued_batch_request_OPERATION_e operationVariable;
    
    if(!cJSON_IsString(operation))
    {
    goto end; //Enum
    }
    operationVariable = catalogs_items_delete_discontinued_batch_request_operation_FromString(operation->valuestring);
