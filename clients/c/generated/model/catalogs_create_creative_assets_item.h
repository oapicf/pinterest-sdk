/*
 * catalogs_create_creative_assets_item.h
 *
 * A creative assets item to be created.
 */

#ifndef _catalogs_create_creative_assets_item_H_
#define _catalogs_create_creative_assets_item_H_
...
typedef struct catalogs_create_creative_assets_item_t catalogs_create_creative_assets_item_t;

#include "catalogs_creative_assets_attributes.h"

// Enum OPERATION for catalogs_create_creative_assets_item

typedef enum  { pinterest_rest_api_catalogs_create_creative_assets_item_OPERATION_NULL = 0, pinterest_rest_api_catalogs_create_creative_assets_item_OPERATION_CREATE } pinterest_rest_api_catalogs_create_creative_assets_item_OPERATION_e;
...
typedef struct catalogs_create_creative_assets_item_t {
    char *creative_assets_id; // string
    pinterest_rest_api_catalogs_create_creative_assets_item_OPERATION_e operation; //enum
    struct catalogs_creative_assets_attributes_t *attributes; //model

} catalogs_create_creative_assets_item_t;
...
#endif /* _catalogs_create_creative_assets_item_H_ */
