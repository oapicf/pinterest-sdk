...
// Enum PROMOTIONAPPLICATIONLEVEL for ad_group_common

typedef enum  { pinterest_rest_api_ad_group_common_PROMOTIONAPPLICATIONLEVEL_NULL = 0, pinterest_rest_api_ad_group_common_PROMOTIONAPPLICATIONLEVEL_NONE, pinterest_rest_api_ad_group_common_PROMOTIONAPPLICATIONLEVEL_ITEM, pinterest_rest_api_ad_group_common_PROMOTIONAPPLICATIONLEVEL_AD_GROUP } pinterest_rest_api_ad_group_common_PROMOTIONAPPLICATIONLEVEL_e;
...
typedef struct ad_group_common_t {
    ...
    pinterest_rest_api_ad_group_common_PROMOTIONAPPLICATIONLEVEL_e promotion_application_level; //enum
