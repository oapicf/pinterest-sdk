/*
 * invite_filter_status.h
 *
 * Invite statuses used for filters.
 */

#ifndef _invite_filter_status_H_
#define _invite_filter_status_H_
...
typedef struct invite_filter_status_t invite_filter_status_t;


// Enum  for invite_filter_status

typedef enum { pinterest_rest_api_invite_filter_status__NULL = 0, pinterest_rest_api_invite_filter_status__PENDING, pinterest_rest_api_invite_filter_status__EXPIRED } pinterest_rest_api_invite_filter_status__e;
...
#endif /* _invite_filter_status_H_ */
