...
static catalogs_product_group_filters_all_of_t *catalogs_product_group_filters_all_of_create_internal(
    ...
    if (!catalogs_product_group_filters_all_of_local_var) {
        return NULL;
    }
    memset(catalogs_product_group_filters_all_of_local_var, 0, sizeof(catalogs_product_group_filters_all_of_t));
...
__attribute__((deprecated)) catalogs_product_group_filters_all_of_t *catalogs_product_group_filters_all_of_create(
    ...
    catalogs_product_group_filters_all_of_t *result = catalogs_product_group_filters_all_of_create_internal (
        all_of
        );
    if (!result) {
    }
...
void catalogs_product_group_filters_all_of_free(catalogs_product_group_filters_all_of_t *catalogs_product_group_filters_all_of) {
    ...
    if (catalogs_product_group_filters_all_of->all_of) {
        list_ForEach(listEntry, catalogs_product_group_filters_all_of->all_of) {
            catalogs_product_group_filter_keys_free(listEntry->data);
        }
        list_freeList(catalogs_product_group_filters_all_of->all_of);
        catalogs_product_group_filters_all_of->all_of = NULL;
    }
    free(catalogs_product_group_filters_all_of);
}
...
cJSON *catalogs_product_group_filters_all_of_convertToJSON(catalogs_product_group_filters_all_of_t *catalogs_product_group_filters_all_of) {
    ...
    if (catalogs_product_group_filters_all_of->all_of) {
    list_ForEach(all_ofListEntry, catalogs_product_group_filters_all_of->all_of) {
...
catalogs_product_group_filters_all_of_t *catalogs_product_group_filters_all_of_parseFromJSON(cJSON *catalogs_product_group_filters_all_ofJSON){
    ...
    catalogs_product_group_filters_all_of_t *catalogs_product_group_filters_all_of_local_var = NULL;

    // define the local list for catalogs_product_group_filters_all_of->all_of
