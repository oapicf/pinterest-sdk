...
static catalogs_hotel_items_batch_t *catalogs_hotel_items_batch_create_internal(
    ...
    memset(catalogs_hotel_items_batch_local_var, 0, sizeof(catalogs_hotel_items_batch_t));
...
__attribute__((deprecated)) catalogs_hotel_items_batch_t *catalogs_hotel_items_batch_create(
    ...
    catalogs_hotel_items_batch_t *result = catalogs_hotel_items_batch_create_internal (
        batch_id,
        catalog_type,
        completed_time,
        created_time,
...
cJSON *catalogs_hotel_items_batch_convertToJSON(catalogs_hotel_items_batch_t *catalogs_hotel_items_batch) {
    ...
    if (pinterest_rest_api_catalogs_hotel_items_batch_CATALOGTYPE_NULL == catalogs_hotel_items_batch->catalog_type) {
        goto fail;
    }
    if(cJSON_AddStringToObject(item, "catalog_type", catalogs_hotel_items_batch_catalog_type_ToString(catalogs_hotel_items_batch->catalog_type)) == NULL)
    {
    goto fail; //Enum
    }
...
catalogs_hotel_items_batch_t *catalogs_hotel_items_batch_parseFromJSON(cJSON *catalogs_hotel_items_batchJSON){
    ...
    pinterest_rest_api_catalogs_hotel_items_batch_CATALOGTYPE_e catalog_typeVariable;
    
    if(!cJSON_IsString(catalog_type))
    {
    goto end; //Enum
    }
    catalog_typeVariable = catalogs_hotel_items_batch_catalog_type_FromString(catalog_type->valuestring);
