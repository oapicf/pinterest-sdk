...
static customer_lists_list_200_response_t *customer_lists_list_200_response_create_internal(
    char *bookmark,
    list_t *items
    ) {
    ...
    memset(customer_lists_list_200_response_local_var, 0, sizeof(customer_lists_list_200_response_t));
    customer_lists_list_200_response_local_var->_library_owned = 1;
...
__attribute__((deprecated)) customer_lists_list_200_response_t *customer_lists_list_200_response_create(
    char *bookmark,
    list_t *items
    ) {
    customer_lists_list_200_response_t *result = customer_lists_list_200_response_create_internal (
        bookmark,
        items
        );
    if (!result) {
...
void customer_lists_list_200_response_free(customer_lists_list_200_response_t *customer_lists_list_200_response) {
    ...
    if(customer_lists_list_200_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "customer_lists_list_200_response_free");
        return ;
    }
...
customer_lists_list_200_response_t *customer_lists_list_200_response_parseFromJSON(cJSON *customer_lists_list_200_responseJSON){
    ...
    customer_lists_list_200_response_local_var = customer_lists_list_200_response_create_internal (
        bookmark_local_str,
        itemsList
        );
