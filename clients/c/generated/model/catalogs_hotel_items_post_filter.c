...
cJSON *catalogs_hotel_items_post_filter_convertToJSON(catalogs_hotel_items_post_filter_t *catalogs_hotel_items_post_filter) {
    ...
    if(cJSON_AddStringToObject(item, "catalog_type", catalog_typecatalogs_hotel_items_post_filter_ToString(catalogs_hotel_items_post_filter->catalog_type)) == NULL)
    {
    goto fail; //Enum
    }
...
catalogs_hotel_items_post_filter_t *catalogs_hotel_items_post_filter_parseFromJSON(cJSON *catalogs_hotel_items_post_filterJSON){
    ...
    catalogs_hotel_items_post_filter_local_var = catalogs_hotel_items_post_filter_create (
