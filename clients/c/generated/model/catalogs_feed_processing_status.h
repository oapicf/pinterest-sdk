...
typedef enum { pinterest_rest_api_catalogs_feed_processing_status__NULL = 0, pinterest_rest_api_catalogs_feed_processing_status__COMPLETED, pinterest_rest_api_catalogs_feed_processing_status__COMPLETED_EARLY, pinterest_rest_api_catalogs_feed_processing_status__DISAPPROVED, pinterest_rest_api_catalogs_feed_processing_status__FAILED, pinterest_rest_api_catalogs_feed_processing_status__PROCESSING, pinterest_rest_api_catalogs_feed_processing_status__QUEUED_FOR_PROCESSING, pinterest_rest_api_catalogs_feed_processing_status__UNDER_APPEAL, pinterest_rest_api_catalogs_feed_processing_status__UNDER_REVIEW } pinterest_rest_api_catalogs_feed_processing_status__e;
