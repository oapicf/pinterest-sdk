...
static catalogs_verticals_list_products_by_catalog_based_filter_request_t *catalogs_verticals_list_products_by_catalog_based_filter_request_create_internal(
    ...
    memset(catalogs_verticals_list_products_by_catalog_based_filter_request_local_var, 0, sizeof(catalogs_verticals_list_products_by_catalog_based_filter_request_t));
...
__attribute__((deprecated)) catalogs_verticals_list_products_by_catalog_based_filter_request_t *catalogs_verticals_list_products_by_catalog_based_filter_request_create(
    ...
    catalogs_verticals_list_products_by_catalog_based_filter_request_t *result = catalogs_verticals_list_products_by_catalog_based_filter_request_create_internal (
        catalog_id,
        catalog_type,
        country,
        filters,
