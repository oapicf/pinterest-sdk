...
typedef enum  { pinterest_rest_api_feeds_update_request__NULL = 0, pinterest_rest_api_feeds_update_request__RETAIL, pinterest_rest_api_feeds_update_request__HOTEL, pinterest_rest_api_feeds_update_request__CREATIVE_ASSETS } pinterest_rest_api_feeds_update_request__e;
...
typedef enum  { pinterest_rest_api_feeds_update_request__NULL = 0, pinterest_rest_api_feeds_update_request__IN_STOCK, pinterest_rest_api_feeds_update_request__OUT_OF_STOCK, pinterest_rest_api_feeds_update_request__PREORDER } pinterest_rest_api_feeds_update_request__e;
