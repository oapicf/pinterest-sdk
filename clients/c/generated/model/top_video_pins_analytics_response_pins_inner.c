...
char* top_video_pins_analytics_response_pins_inner_inner_ToString(pinterest_rest_api_top_video_pins_analytics_response_pins_inner__e inner) {
...
pinterest_rest_api_top_video_pins_analytics_response_pins_inner__e top_video_pins_analytics_response_pins_inner_inner_FromString(char* inner) {
...
top_video_pins_analytics_response_pins_inner_t *top_video_pins_analytics_response_pins_inner_create(
    list_t* metrics,
    list_t* data_status,
    char *pin_id
    ) {
...
void top_video_pins_analytics_response_pins_inner_free(top_video_pins_analytics_response_pins_inner_t *top_video_pins_analytics_response_pins_inner) {
    if(NULL == top_video_pins_analytics_response_pins_inner){
        return ;
    }
    ...
    free(top_video_pins_analytics_response_pins_inner);
}
...
cJSON *top_video_pins_analytics_response_pins_inner_convertToJSON(top_video_pins_analytics_response_pins_inner_t *top_video_pins_analytics_response_pins_inner) {
    ...
    if (top_video_pins_analytics_response_pins_inner->metrics) {
    list_ForEach(metricsListEntry, top_video_pins_analytics_response_pins_inner->metrics) {
    ...
    if(top_video_pins_analytics_response_pins_inner->data_status != pinterest_rest_api_top_video_pins_analytics_response_pins_inner_DATASTATUS_NULL) {
    ...
    if(top_video_pins_analytics_response_pins_inner->pin_id) {
    if(cJSON_AddStringToObject(item, "pin_id", top_video_pins_analytics_response_pins_inner->pin_id) == NULL) {
    goto fail; //String
    }
    }
...
top_video_pins_analytics_response_pins_inner_t *top_video_pins_analytics_response_pins_inner_parseFromJSON(cJSON *top_video_pins_analytics_response_pins_innerJSON){
    ...
    top_video_pins_analytics_response_pins_inner_local_var = top_video_pins_analytics_response_pins_inner_create (
