...
typedef enum  { pinterest_rest_api_template_response_date_range_dynamic_date_range_RANGE_NULL = 0, pinterest_rest_api_template_response_date_range_dynamic_date_range_RANGE_YEAR_TO_DATE, pinterest_rest_api_template_response_date_range_dynamic_date_range_RANGE_QUARTER_TO_DATE, pinterest_rest_api_template_response_date_range_dynamic_date_range_RANGE_MONTH_TO_DATE, pinterest_rest_api_template_response_date_range_dynamic_date_range_RANGE_LAST_MONTH, pinterest_rest_api_template_response_date_range_dynamic_date_range_RANGE_LAST_QUARTER } pinterest_rest_api_template_response_date_range_dynamic_date_range_RANGE_e;
