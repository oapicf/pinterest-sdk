...
static boards_list_pins_200_response_t *boards_list_pins_200_response_create_internal(
    char *bookmark,
    list_t *items
    ) {
...
void boards_list_pins_200_response_free(boards_list_pins_200_response_t *boards_list_pins_200_response) {
    ...
    if(boards_list_pins_200_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "boards_list_pins_200_response_free");
        return ;
    }
