...
// Enum  for catalogs_hotel_items_batch

typedef enum  { pinterest_rest_api_catalogs_hotel_items_batch__NULL = 0, pinterest_rest_api_catalogs_hotel_items_batch__PROCESSING, pinterest_rest_api_catalogs_hotel_items_batch__COMPLETED, pinterest_rest_api_catalogs_hotel_items_batch__FAILED } pinterest_rest_api_catalogs_hotel_items_batch__e;
...
typedef enum  { pinterest_rest_api_catalogs_hotel_items_batch__NULL = 0, pinterest_rest_api_catalogs_hotel_items_batch__RETAIL, pinterest_rest_api_catalogs_hotel_items_batch__HOTEL, pinterest_rest_api_catalogs_hotel_items_batch__CREATIVE_ASSETS } pinterest_rest_api_catalogs_hotel_items_batch__e;
