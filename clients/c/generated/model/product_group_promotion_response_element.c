...
void product_group_promotion_response_element_free(product_group_promotion_response_element_t *product_group_promotion_response_element) {
    ...
    if (product_group_promotion_response_element->status) {
        entity_status_free(product_group_promotion_response_element->status);
        product_group_promotion_response_element->status = NULL;
    }
    ...
    if (product_group_promotion_response_element->grid_click_type) {
        grid_click_type_free(product_group_promotion_response_element->grid_click_type);
        product_group_promotion_response_element->grid_click_type = NULL;
    }
    if (product_group_promotion_response_element->creative_type) {
        creative_type_free(product_group_promotion_response_element->creative_type);
        product_group_promotion_response_element->creative_type = NULL;
    }
...
cJSON *product_group_promotion_response_element_convertToJSON(product_group_promotion_response_element_t *product_group_promotion_response_element) {
    ...
    if(product_group_promotion_response_element->status != pinterest_rest_api_product_group_promotion_response_element__NULL) {
    ...
    if(product_group_promotion_response_element->grid_click_type != pinterest_rest_api_product_group_promotion_response_element__NULL) {
    ...
    if(product_group_promotion_response_element->creative_type != pinterest_rest_api_product_group_promotion_response_element__NULL) {
...
product_group_promotion_response_element_t *product_group_promotion_response_element_parseFromJSON(cJSON *product_group_promotion_response_elementJSON){
    ...
    product_group_promotion_response_element_local_var = product_group_promotion_response_element_create (
