...
static board_sections_list_200_response_t *board_sections_list_200_response_create_internal(
    ...
    memset(board_sections_list_200_response_local_var, 0, sizeof(board_sections_list_200_response_t));
...
__attribute__((deprecated)) board_sections_list_200_response_t *board_sections_list_200_response_create(
    ...
    board_sections_list_200_response_t *result = board_sections_list_200_response_create_internal (
        bookmark,
        items
        );
    if (!result) {
