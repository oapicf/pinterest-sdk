...
static catalogs_creative_assets_product_t *catalogs_creative_assets_product_create_internal(
...
void catalogs_creative_assets_product_free(catalogs_creative_assets_product_t *catalogs_creative_assets_product) {
    ...
    if(catalogs_creative_assets_product->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "catalogs_creative_assets_product_free");
        return ;
    }
...
cJSON *catalogs_creative_assets_product_convertToJSON(catalogs_creative_assets_product_t *catalogs_creative_assets_product) {
    ...
    if(cJSON_AddStringToObject(item, "catalog_type", catalogs_creative_assets_product_catalog_type_ToString(catalogs_creative_assets_product->catalog_type)) == NULL)
    {
    goto fail; //Enum
    }
