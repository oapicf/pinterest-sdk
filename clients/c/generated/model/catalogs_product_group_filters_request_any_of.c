...
static catalogs_product_group_filters_request_any_of_t *catalogs_product_group_filters_request_any_of_create_internal(
    list_t *any_of
    ) {
    ...
    catalogs_product_group_filters_request_any_of_local_var->_library_owned = 1;
    return catalogs_product_group_filters_request_any_of_local_var;
}

__attribute__((deprecated)) catalogs_product_group_filters_request_any_of_t *catalogs_product_group_filters_request_any_of_create(
    list_t *any_of
    ) {
    return catalogs_product_group_filters_request_any_of_create_internal (
        any_of
        );
}
...
void catalogs_product_group_filters_request_any_of_free(catalogs_product_group_filters_request_any_of_t *catalogs_product_group_filters_request_any_of) {
    ...
    if(catalogs_product_group_filters_request_any_of->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "catalogs_product_group_filters_request_any_of_free");
        return ;
    }
...
catalogs_product_group_filters_request_any_of_t *catalogs_product_group_filters_request_any_of_parseFromJSON(cJSON *catalogs_product_group_filters_request_any_ofJSON){
    ...
    catalogs_product_group_filters_request_any_of_local_var = catalogs_product_group_filters_request_any_of_create_internal (
        any_ofList
        );
