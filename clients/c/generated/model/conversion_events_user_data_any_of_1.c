...
conversion_events_user_data_any_of_1_t *conversion_events_user_data_any_of_1_create(
    ...
    conversion_events_user_data_any_of_1_t *conversion_events_user_data_any_of_1_local_var = malloc(sizeof(conversion_events_user_data_any_of_1_t));
    if (!conversion_events_user_data_any_of_1_local_var) {
        return NULL;
    }
    conversion_events_user_data_any_of_1_local_var->em = em;
    conversion_events_user_data_any_of_1_local_var->hashed_maids = hashed_maids;
...
void conversion_events_user_data_any_of_1_free(conversion_events_user_data_any_of_1_t *conversion_events_user_data_any_of_1) {
    ...
    if (conversion_events_user_data_any_of_1->em) {
        list_ForEach(listEntry, conversion_events_user_data_any_of_1->em) {
            free(listEntry->data);
        }
        list_freeList(conversion_events_user_data_any_of_1->em);
        conversion_events_user_data_any_of_1->em = NULL;
    }
    if (conversion_events_user_data_any_of_1->hashed_maids) {
        list_ForEach(listEntry, conversion_events_user_data_any_of_1->hashed_maids) {
            free(listEntry->data);
        }
        list_freeList(conversion_events_user_data_any_of_1->hashed_maids);
        conversion_events_user_data_any_of_1->hashed_maids = NULL;
    }
    if (conversion_events_user_data_any_of_1->client_ip_address) {
        free(conversion_events_user_data_any_of_1->client_ip_address);
        conversion_events_user_data_any_of_1->client_ip_address = NULL;
    }
    if (conversion_events_user_data_any_of_1->client_user_agent) {
        free(conversion_events_user_data_any_of_1->client_user_agent);
        conversion_events_user_data_any_of_1->client_user_agent = NULL;
    }
    free(conversion_events_user_data_any_of_1);
}
...
cJSON *conversion_events_user_data_any_of_1_convertToJSON(conversion_events_user_data_any_of_1_t *conversion_events_user_data_any_of_1) {
    ...
    if(conversion_events_user_data_any_of_1->client_ip_address) {
    if(cJSON_AddStringToObject(item, "client_ip_address", conversion_events_user_data_any_of_1->client_ip_address) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(conversion_events_user_data_any_of_1->client_user_agent) {
    if(cJSON_AddStringToObject(item, "client_user_agent", conversion_events_user_data_any_of_1->client_user_agent) == NULL) {
    goto fail; //String
    }
    }
...
conversion_events_user_data_any_of_1_t *conversion_events_user_data_any_of_1_parseFromJSON(cJSON *conversion_events_user_data_any_of_1JSON){
    ...
    conversion_events_user_data_any_of_1_t *conversion_events_user_data_any_of_1_local_var = NULL;

    // define the local list for conversion_events_user_data_any_of_1->em
    list_t *emList = NULL;

    // define the local list for conversion_events_user_data_any_of_1->hashed_maids
