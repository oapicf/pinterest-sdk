...
static catalogs_creative_assets_batch_item_t *catalogs_creative_assets_batch_item_create_internal(
    ...
    memset(catalogs_creative_assets_batch_item_local_var, 0, sizeof(catalogs_creative_assets_batch_item_t));
...
__attribute__((deprecated)) catalogs_creative_assets_batch_item_t *catalogs_creative_assets_batch_item_create(
    ...
    catalogs_creative_assets_batch_item_t *result = catalogs_creative_assets_batch_item_create_internal (
        attributes,
        creative_assets_id,
        operation
        );
