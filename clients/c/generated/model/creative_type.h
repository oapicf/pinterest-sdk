...
typedef enum { pinterest_rest_api_creative_type__NULL = 0, pinterest_rest_api_creative_type__REGULAR, pinterest_rest_api_creative_type__VIDEO, pinterest_rest_api_creative_type__SHOPPING, pinterest_rest_api_creative_type__CAROUSEL, pinterest_rest_api_creative_type__MAX_VIDEO, pinterest_rest_api_creative_type__SHOP_THE_PIN, pinterest_rest_api_creative_type__COLLECTION, pinterest_rest_api_creative_type__IDEA, pinterest_rest_api_creative_type__SHOWCASE, pinterest_rest_api_creative_type__QUIZ, pinterest_rest_api_creative_type__COLLAGE, pinterest_rest_api_creative_type__MAX_WIDTH_REGULAR_COLLECTION, pinterest_rest_api_creative_type__MAX_WIDTH_VIDEO_COLLECTION, pinterest_rest_api_creative_type__APP } pinterest_rest_api_creative_type__e;
