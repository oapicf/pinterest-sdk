/*
 * catalogs_creative_assets_batch_request.h
 *
 * Request object to update catalogs creative assets items
 */

#ifndef _catalogs_creative_assets_batch_request_H_
#define _catalogs_creative_assets_batch_request_H_
...
typedef struct catalogs_creative_assets_batch_request_t catalogs_creative_assets_batch_request_t;

#include "catalogs_creative_assets_batch_item.h"
#include "country.h"

// Enum CATALOGTYPE for catalogs_creative_assets_batch_request

typedef enum  { pinterest_rest_api_catalogs_creative_assets_batch_request_CATALOGTYPE_NULL = 0, pinterest_rest_api_catalogs_creative_assets_batch_request_CATALOGTYPE_CREATIVE_ASSETS } pinterest_rest_api_catalogs_creative_assets_batch_request_CATALOGTYPE_e;
...
typedef struct catalogs_creative_assets_batch_request_t {
    char *catalog_id; // string
    pinterest_rest_api_catalogs_creative_assets_batch_request_CATALOGTYPE_e catalog_type; //enum
    pinterest_rest_api_country__e country; //referenced enum
    list_t *items; //nonprimitive container
    pinterest_rest_api_catalogs_creative_assets_batch_request_LANGUAGE_e language; //enum

    int _library_owned; // Is the library responsible for freeing this object?
} catalogs_creative_assets_batch_request_t;
...
#endif /* _catalogs_creative_assets_batch_request_H_ */
