...
// Enum CATALOGTYPE for catalogs_creative_assets_items_batch

typedef enum  { pinterest_rest_api_catalogs_creative_assets_items_batch_CATALOGTYPE_NULL = 0, pinterest_rest_api_catalogs_creative_assets_items_batch_CATALOGTYPE_CREATIVE_ASSETS } pinterest_rest_api_catalogs_creative_assets_items_batch_CATALOGTYPE_e;
...
typedef struct catalogs_creative_assets_items_batch_t {
    ...
    pinterest_rest_api_catalogs_creative_assets_items_batch_CATALOGTYPE_e catalog_type; //enum
