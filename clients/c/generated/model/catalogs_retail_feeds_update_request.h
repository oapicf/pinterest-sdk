...
// Enum CATALOGTYPE for catalogs_retail_feeds_update_request

typedef enum  { pinterest_rest_api_catalogs_retail_feeds_update_request_CATALOGTYPE_NULL = 0, pinterest_rest_api_catalogs_retail_feeds_update_request_CATALOGTYPE_RETAIL } pinterest_rest_api_catalogs_retail_feeds_update_request_CATALOGTYPE_e;
...
typedef struct catalogs_retail_feeds_update_request_t {
    pinterest_rest_api_catalogs_retail_feeds_update_request_CATALOGTYPE_e catalog_type; //enum
