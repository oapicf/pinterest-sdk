...
cJSON *ads_analytics_filter_column_convertToJSON(pinterest_rest_api_ads_analytics_filter_column__e ads_analytics_filter_column) {
...
pinterest_rest_api_ads_analytics_filter_column__e ads_analytics_filter_column_parseFromJSON(cJSON *ads_analytics_filter_columnJSON) {
    if(!cJSON_IsString(ads_analytics_filter_columnJSON) || (ads_analytics_filter_columnJSON->valuestring == NULL)) {
        return 0;
    }
    return ads_analytics_filter_column_ads_analytics_filter_column_FromString(ads_analytics_filter_columnJSON->valuestring);
}
