...
cJSON *product_availability_type_convertToJSON(pinterest_rest_api_product_availability_type__e product_availability_type) {
...
pinterest_rest_api_product_availability_type__e product_availability_type_parseFromJSON(cJSON *product_availability_typeJSON) {
    if(!cJSON_IsString(product_availability_typeJSON) || (product_availability_typeJSON->valuestring == NULL)) {
        return 0;
    }
    return product_availability_type_product_availability_type_FromString(product_availability_typeJSON->valuestring);
}
