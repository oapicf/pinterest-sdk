...
typedef enum  { pinterest_rest_api_catalogs_feed_processing_result__NULL = 0, pinterest_rest_api_catalogs_feed_processing_result__COMPLETED, pinterest_rest_api_catalogs_feed_processing_result__COMPLETED_EARLY, pinterest_rest_api_catalogs_feed_processing_result__DISAPPROVED, pinterest_rest_api_catalogs_feed_processing_result__FAILED, pinterest_rest_api_catalogs_feed_processing_result__PROCESSING, pinterest_rest_api_catalogs_feed_processing_result__QUEUED_FOR_PROCESSING, pinterest_rest_api_catalogs_feed_processing_result__UNDER_APPEAL, pinterest_rest_api_catalogs_feed_processing_result__UNDER_REVIEW } pinterest_rest_api_catalogs_feed_processing_result__e;
