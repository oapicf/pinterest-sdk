...
typedef enum  { pinterest_rest_api_update_member_asset_access_body_accesses_inner__NULL = 0, pinterest_rest_api_update_member_asset_access_body_accesses_inner__ADMIN, pinterest_rest_api_update_member_asset_access_body_accesses_inner__ANALYST, pinterest_rest_api_update_member_asset_access_body_accesses_inner__FINANCE_MANAGER, pinterest_rest_api_update_member_asset_access_body_accesses_inner__FINANCE_EDIT, pinterest_rest_api_update_member_asset_access_body_accesses_inner__FINANCE_VIEW, pinterest_rest_api_update_member_asset_access_body_accesses_inner__AUDIENCE_MANAGER, pinterest_rest_api_update_member_asset_access_body_accesses_inner__CAMPAIGN_MANAGER, pinterest_rest_api_update_member_asset_access_body_accesses_inner__CATALOGS_MANAGER, pinterest_rest_api_update_member_asset_access_body_accesses_inner__CATALOGS_VIEWER, pinterest_rest_api_update_member_asset_access_body_accesses_inner__PROFILE_PUBLISHER, pinterest_rest_api_update_member_asset_access_body_accesses_inner__CONSUMER_USER } pinterest_rest_api_update_member_asset_access_body_accesses_inner__e;
