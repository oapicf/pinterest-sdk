/*
 * catalogs_creative_assets_list_products_by_catalog_based_filter_request.h
 *
 * Request object to list products for a given creative assets catalog_id and product group filter.
 */

#ifndef _catalogs_creative_assets_list_products_by_catalog_based_filter_request_H_
#define _catalogs_creative_assets_list_products_by_catalog_based_filter_request_H_
...
typedef struct catalogs_creative_assets_list_products_by_catalog_based_filter_request_t catalogs_creative_assets_list_products_by_catalog_based_filter_request_t;

#include "catalogs_creative_assets_product_group_filters.h"

// Enum CATALOGTYPE for catalogs_creative_assets_list_products_by_catalog_based_filter_request

typedef enum  { pinterest_rest_api_catalogs_creative_assets_list_products_by_catalog_based_filter_request_CATALOGTYPE_NULL = 0, pinterest_rest_api_catalogs_creative_assets_list_products_by_catalog_based_filter_request_CATALOGTYPE_CREATIVE_ASSETS } pinterest_rest_api_catalogs_creative_assets_list_products_by_catalog_based_filter_request_CATALOGTYPE_e;
...
typedef struct catalogs_creative_assets_list_products_by_catalog_based_filter_request_t {
    pinterest_rest_api_catalogs_creative_assets_list_products_by_catalog_based_filter_request_CATALOGTYPE_e catalog_type; //enum
...
#endif /* _catalogs_creative_assets_list_products_by_catalog_based_filter_request_H_ */
