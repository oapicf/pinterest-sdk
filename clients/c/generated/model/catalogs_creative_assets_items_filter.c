...
catalogs_creative_assets_items_filter_t *catalogs_creative_assets_items_filter_create(
    ...
    catalogs_creative_assets_items_filter_t *catalogs_creative_assets_items_filter_local_var = malloc(sizeof(catalogs_creative_assets_items_filter_t));
    if (!catalogs_creative_assets_items_filter_local_var) {
        return NULL;
    }
    catalogs_creative_assets_items_filter_local_var->catalog_type = catalog_type;
...
void catalogs_creative_assets_items_filter_free(catalogs_creative_assets_items_filter_t *catalogs_creative_assets_items_filter) {
    ...
    if (catalogs_creative_assets_items_filter->creative_assets_ids) {
        list_ForEach(listEntry, catalogs_creative_assets_items_filter->creative_assets_ids) {
            free(listEntry->data);
        }
        list_freeList(catalogs_creative_assets_items_filter->creative_assets_ids);
        catalogs_creative_assets_items_filter->creative_assets_ids = NULL;
    }
    if (catalogs_creative_assets_items_filter->catalog_id) {
        free(catalogs_creative_assets_items_filter->catalog_id);
        catalogs_creative_assets_items_filter->catalog_id = NULL;
    }
    free(catalogs_creative_assets_items_filter);
}
...
cJSON *catalogs_creative_assets_items_filter_convertToJSON(catalogs_creative_assets_items_filter_t *catalogs_creative_assets_items_filter) {
    ...
    if(catalogs_creative_assets_items_filter->catalog_id) {
    if(cJSON_AddStringToObject(item, "catalog_id", catalogs_creative_assets_items_filter->catalog_id) == NULL) {
    goto fail; //String
    }
    }
...
catalogs_creative_assets_items_filter_t *catalogs_creative_assets_items_filter_parseFromJSON(cJSON *catalogs_creative_assets_items_filterJSON){
    ...
    catalogs_creative_assets_items_filter_t *catalogs_creative_assets_items_filter_local_var = NULL;

    // define the local list for catalogs_creative_assets_items_filter->creative_assets_ids
    ...
    pinterest_rest_api_catalogs_creative_assets_items_filter_CATALOGTYPE_e catalog_typeVariable;
    
    if(!cJSON_IsString(catalog_type))
    {
    goto end; //Enum
    }
    catalog_typeVariable = catalogs_creative_assets_items_filter_catalog_type_FromString(catalog_type->valuestring);
