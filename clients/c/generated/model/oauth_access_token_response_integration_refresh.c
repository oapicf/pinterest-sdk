...
#include <string.h>
#include <stdio.h>
#include "oauth_access_token_response_integration_refresh.h"
...
oauth_access_token_response_integration_refresh_t *oauth_access_token_response_integration_refresh_create(
    ...
    oauth_access_token_response_integration_refresh_t *oauth_access_token_response_integration_refresh_local_var = malloc(sizeof(oauth_access_token_response_integration_refresh_t));
    if (!oauth_access_token_response_integration_refresh_local_var) {
        return NULL;
    }
    oauth_access_token_response_integration_refresh_local_var->response_type = response_type;
    oauth_access_token_response_integration_refresh_local_var->access_token = access_token;
    oauth_access_token_response_integration_refresh_local_var->token_type = token_type;
    oauth_access_token_response_integration_refresh_local_var->expires_in = expires_in;
    oauth_access_token_response_integration_refresh_local_var->scope = scope;
...
void oauth_access_token_response_integration_refresh_free(oauth_access_token_response_integration_refresh_t *oauth_access_token_response_integration_refresh) {
    ...
    if (oauth_access_token_response_integration_refresh->access_token) {
        free(oauth_access_token_response_integration_refresh->access_token);
        oauth_access_token_response_integration_refresh->access_token = NULL;
    }
    if (oauth_access_token_response_integration_refresh->token_type) {
        free(oauth_access_token_response_integration_refresh->token_type);
        oauth_access_token_response_integration_refresh->token_type = NULL;
    }
    if (oauth_access_token_response_integration_refresh->scope) {
        free(oauth_access_token_response_integration_refresh->scope);
        oauth_access_token_response_integration_refresh->scope = NULL;
    }
    if (oauth_access_token_response_integration_refresh->refresh_token) {
        free(oauth_access_token_response_integration_refresh->refresh_token);
        oauth_access_token_response_integration_refresh->refresh_token = NULL;
    }
    free(oauth_access_token_response_integration_refresh);
}
...
cJSON *oauth_access_token_response_integration_refresh_convertToJSON(oauth_access_token_response_integration_refresh_t *oauth_access_token_response_integration_refresh) {
    ...
    if(cJSON_AddStringToObject(item, "access_token", oauth_access_token_response_integration_refresh->access_token) == NULL) {
    goto fail; //String
    }
    ...
    if(cJSON_AddStringToObject(item, "token_type", oauth_access_token_response_integration_refresh->token_type) == NULL) {
    goto fail; //String
    }


    // oauth_access_token_response_integration_refresh->expires_in
    if (!oauth_access_token_response_integration_refresh->expires_in) {
        goto fail;
    }
    if(cJSON_AddNumberToObject(item, "expires_in", oauth_access_token_response_integration_refresh->expires_in) == NULL) {
    goto fail; //Numeric
    }
    ...
    if(cJSON_AddStringToObject(item, "scope", oauth_access_token_response_integration_refresh->scope) == NULL) {
    goto fail; //String
    }
    ...
    if(cJSON_AddStringToObject(item, "refresh_token", oauth_access_token_response_integration_refresh->refresh_token) == NULL) {
    goto fail; //String
    }


    // oauth_access_token_response_integration_refresh->refresh_token_expires_in
    if (!oauth_access_token_response_integration_refresh->refresh_token_expires_in) {
        goto fail;
    }
    if(cJSON_AddNumberToObject(item, "refresh_token_expires_in", oauth_access_token_response_integration_refresh->refresh_token_expires_in) == NULL) {
    goto fail; //Numeric
    }
...
oauth_access_token_response_integration_refresh_t *oauth_access_token_response_integration_refresh_parseFromJSON(cJSON *oauth_access_token_response_integration_refreshJSON){
    ...
    oauth_access_token_response_integration_refresh_t *oauth_access_token_response_integration_refresh_local_var = NULL;
    ...
    response_typeVariable = oauth_access_token_response_integration_refresh_response_type_FromString(response_type->valuestring);
    }
