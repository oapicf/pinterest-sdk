...
static product_type2_filter_t *product_type2_filter_create_internal(
    ...
    memset(product_type2_filter_local_var, 0, sizeof(product_type2_filter_t));
    product_type2_filter_local_var->_library_owned = 1;
...
__attribute__((deprecated)) product_type2_filter_t *product_type2_filter_create(
    ...
    product_type2_filter_t *result = product_type2_filter_create_internal (
        product_type_2
        );
    if (!result) {
    }
...
void product_type2_filter_free(product_type2_filter_t *product_type2_filter) {
    ...
    if(product_type2_filter->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "product_type2_filter_free");
        return ;
    }
    listEntry_t *listEntry;
    if (product_type2_filter->product_type_2) {
        catalogs_product_group_multiple_string_list_criteria_free(product_type2_filter->product_type_2);
...
cJSON *product_type2_filter_convertToJSON(product_type2_filter_t *product_type2_filter) {
    ...
    cJSON *product_type_2_local_JSON = catalogs_product_group_multiple_string_list_criteria_convertToJSON(product_type2_filter->product_type_2);
...
product_type2_filter_t *product_type2_filter_parseFromJSON(cJSON *product_type2_filterJSON){
    ...
    // define the local variable for product_type2_filter->product_type_2
    ...
    product_type2_filter_local_var = product_type2_filter_create_internal (
