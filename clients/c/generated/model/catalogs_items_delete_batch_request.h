...
// Enum OPERATION for catalogs_items_delete_batch_request

typedef enum  { pinterest_rest_api_catalogs_items_delete_batch_request_OPERATION_NULL = 0, pinterest_rest_api_catalogs_items_delete_batch_request_OPERATION__DELETE } pinterest_rest_api_catalogs_items_delete_batch_request_OPERATION_e;
...
typedef struct catalogs_items_delete_batch_request_t {
    ...
    pinterest_rest_api_catalogs_items_delete_batch_request_OPERATION_e operation; //enum
