...
char* catalogs_vertical_feeds_create_request_catalog_type_ToString(pinterest_rest_api_catalogs_vertical_feeds_create_request_CATALOGTYPE_e catalog_type) {
    char* catalog_typeArray[] =  { "NULL", "CREATIVE_ASSETS" };
    return catalog_typeArray[catalog_type];
}

pinterest_rest_api_catalogs_vertical_feeds_create_request_CATALOGTYPE_e catalogs_vertical_feeds_create_request_catalog_type_FromString(char* catalog_type){
...
static catalogs_vertical_feeds_create_request_t *catalogs_vertical_feeds_create_request_create_internal(
    char *catalog_id,
    pinterest_rest_api_catalogs_vertical_feeds_create_request_CATALOGTYPE_e catalog_type,
    ...
    memset(catalogs_vertical_feeds_create_request_local_var, 0, sizeof(catalogs_vertical_feeds_create_request_t));
...
__attribute__((deprecated)) catalogs_vertical_feeds_create_request_t *catalogs_vertical_feeds_create_request_create(
    ...
    catalogs_vertical_feeds_create_request_t *result = catalogs_vertical_feeds_create_request_create_internal (
        catalog_id,
        catalog_type,
        credentials,
...
void catalogs_vertical_feeds_create_request_free(catalogs_vertical_feeds_create_request_t *catalogs_vertical_feeds_create_request) {
    ...
    if (catalogs_vertical_feeds_create_request->default_locale) {
        catalogs_creative_assets_feeds_create_request_default_locale_free(catalogs_vertical_feeds_create_request->default_locale);
...
cJSON *catalogs_vertical_feeds_create_request_convertToJSON(catalogs_vertical_feeds_create_request_t *catalogs_vertical_feeds_create_request) {
    ...
    if (pinterest_rest_api_catalogs_vertical_feeds_create_request_CATALOGTYPE_NULL == catalogs_vertical_feeds_create_request->catalog_type) {
        goto fail;
    }
    if(cJSON_AddStringToObject(item, "catalog_type", catalogs_vertical_feeds_create_request_catalog_type_ToString(catalogs_vertical_feeds_create_request->catalog_type)) == NULL)
    {
    goto fail; //Enum
    }
    ...
    cJSON *default_locale_local_JSON = catalogs_creative_assets_feeds_create_request_default_locale_convertToJSON(catalogs_vertical_feeds_create_request->default_locale);
...
catalogs_vertical_feeds_create_request_t *catalogs_vertical_feeds_create_request_parseFromJSON(cJSON *catalogs_vertical_feeds_create_requestJSON){
    ...
    pinterest_rest_api_catalogs_vertical_feeds_create_request_CATALOGTYPE_e catalog_typeVariable;
    
    if(!cJSON_IsString(catalog_type))
    {
    goto end; //Enum
    }
    catalog_typeVariable = catalogs_vertical_feeds_create_request_catalog_type_FromString(catalog_type->valuestring);
