...
void get_business_members_200_response_free(get_business_members_200_response_t *get_business_members_200_response) {
    if(NULL == get_business_members_200_response){
        return ;
    }
...
cJSON *get_business_members_200_response_convertToJSON(get_business_members_200_response_t *get_business_members_200_response) {
    ...
    if (get_business_members_200_response->items) {
    list_ForEach(itemsListEntry, get_business_members_200_response->items) {
...
get_business_members_200_response_t *get_business_members_200_response_parseFromJSON(cJSON *get_business_members_200_responseJSON){
    ...
    get_business_members_200_response_t *get_business_members_200_response_local_var = NULL;
    ...
    get_business_members_200_response_local_var = get_business_members_200_response_create (
        itemsList,
