...
typedef enum  { pinterest_rest_api_catalogs_retail_item_response__NULL = 0, pinterest_rest_api_catalogs_retail_item_response__RETAIL, pinterest_rest_api_catalogs_retail_item_response__HOTEL } pinterest_rest_api_catalogs_retail_item_response__e;
