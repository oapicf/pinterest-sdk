...
//
list_t*
AdAccountsAPI_adAccountAnalytics(apiClient_t *apiClient, char *ad_account_id, char start_date, char end_date, list_t *columns, granularity_e granularity, int *click_window_days, int *engagement_window_days, int *view_window_days, pinterest_rest_api_adAccountAnalytics_conversion_report_time_e conversion_report_time, reporting_time_zone_e reporting_timezone)
{
...
//
metrics_response_t*
AdAccountsAPI_adAccountTargetingAnalyticsGet(apiClient_t *apiClient, char *ad_account_id, char start_date, char end_date, list_t *targeting_types, list_t *columns, granularity_e granularity, int *click_window_days, int *engagement_window_days, int *view_window_days, pinterest_rest_api_adAccountTargetingAnalyticsGet_conversion_report_time_e conversion_report_time, list_t *attribution_types, reporting_time_zone_e reporting_timezone)
{
    list_t    *localVarQueryParameters = list_createList();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
...
AdAccountsAPI_analyticsCreateConversionProductReport(apiClient_t *apiClient, char *ad_account_id, conversion_product_report_request_t *conversion_product_report_request)
{
    list_t    *localVarQueryParameters = NULL;
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_conversion_product_report_request = NULL;
    if (conversion_product_report_request != NULL)
    {
        //not string, not binary
        localVarSingleItemJSON_conversion_product_report_request = conversion_product_report_request_convertToJSON(conversion_product_report_request);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_conversion_product_report_request);
        localVarBodyLength = strlen(localVarBodyParameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(localVarPath);
    free(localVarToReplace_ad_account_id);
    if (localVarSingleItemJSON_conversion_product_report_request) {
        cJSON_Delete(localVarSingleItemJSON_conversion_product_report_request);
        localVarSingleItemJSON_conversion_product_report_request = NULL;
    }
    free(localVarBodyParameters);
    return elementToReturn;
end:
