...
// Functions for enum  for CatalogsAPI_catalogsAvailableFilterValues

static char* catalogsAvailableFilterValues__ToString(pinterest_rest_api_catalogsAvailableFilterValues_country_e ){
...
static pinterest_rest_api_catalogsAvailableFilterValues_country_e catalogsAvailableFilterValues__FromString(char* ){
...
/*
// Function catalogsAvailableFilterValues__convertToJSON is not currently used,
// since conversion to JSON passes through the conversion of the model, and ToString. The function is kept for future reference.
//
static cJSON *catalogsAvailableFilterValues__convertToJSON(pinterest_rest_api_catalogsAvailableFilterValues_country_e ) {
...
// Function catalogsAvailableFilterValues__parseFromJSON is not currently used,
// since conversion from JSON passes through the conversion of the model, and FromString. The function is kept for future reference.
//
static pinterest_rest_api_catalogsAvailableFilterValues_country_e catalogsAvailableFilterValues__parseFromJSON(cJSON* JSON) {
    pinterest_rest_api_catalogsAvailableFilterValues_country_e Variable = 0;
    return Variable;
end:
    return 0;
}
...
static char* catalogsAvailableFilterValues__ToString(pinterest_rest_api_catalogsAvailableFilterValues_language_e ){
    char *Array[] =  { "NULL", "af-ZA", "ar-SA", "bg-BG", "bn-IN", "cs-CZ", "da-DK", "de", "el-GR", "en-AU", "en-CA", "en-GB", "en-IN", "en-US", "es-419", "es-AR", "es-ES", "es-MX", "fi-FI", "fr", "fr-CA", "he-IL", "hi-IN", "hr-HR", "hu-HU", "id-ID", "it", "ja", "ko-KR", "ms-MY", "nb-NO", "nl", "pl-PL", "pt-BR", "pt-PT", "ro-RO", "ru-RU", "sk-SK", "sv-SE", "te-IN", "th-TH", "tl-PH", "tr", "uk-UA", "vi-VN", "zh-CN", "zh-TW" };
    return Array[];
}

static pinterest_rest_api_catalogsAvailableFilterValues_language_e catalogsAvailableFilterValues__FromString(char* ){
    int stringToReturn = 0;
    char *Array[] =  { "NULL", "af-ZA", "ar-SA", "bg-BG", "bn-IN", "cs-CZ", "da-DK", "de", "el-GR", "en-AU", "en-CA", "en-GB", "en-IN", "en-US", "es-419", "es-AR", "es-ES", "es-MX", "fi-FI", "fr", "fr-CA", "he-IL", "hi-IN", "hr-HR", "hu-HU", "id-ID", "it", "ja", "ko-KR", "ms-MY", "nb-NO", "nl", "pl-PL", "pt-BR", "pt-PT", "ro-RO", "ru-RU", "sk-SK", "sv-SE", "te-IN", "th-TH", "tl-PH", "tr", "uk-UA", "vi-VN", "zh-CN", "zh-TW" };
    size_t sizeofArray = sizeof(Array) / sizeof(Array[0]);
    while(stringToReturn < sizeofArray) {
...
// since conversion to JSON passes through the conversion of the model, and ToString. The function is kept for future reference.
//
static cJSON *catalogsAvailableFilterValues__convertToJSON(pinterest_rest_api_catalogsAvailableFilterValues_language_e ) {
    cJSON *item = cJSON_CreateObject();
    return item;
    fail:
    cJSON_Delete(item);
...
// since conversion from JSON passes through the conversion of the model, and FromString. The function is kept for future reference.
//
static pinterest_rest_api_catalogsAvailableFilterValues_language_e catalogsAvailableFilterValues__parseFromJSON(cJSON* JSON) {
    pinterest_rest_api_catalogsAvailableFilterValues_language_e Variable = 0;
    return Variable;
end:
    return 0;
}
...
CatalogsAPI_catalogsAvailableFilterValues(apiClient_t *apiClient, char *catalog_id, char *feed_id, country_e country, catalogs_locale_e language, char *ad_account_id)
{
    ...
    // create the path
    char *localVarPath = strdup("/catalogs/available_filter_values");
    ...
    country_e valueQuery_country ;
    keyValuePair_t *keyPairQuery_country = 0;
    if (country)
    {
        keyQuery_country = strdup("country");
        valueQuery_country = (country);
        keyPairQuery_country = keyValuePair_create(keyQuery_country, strdup(catalogsAvailableFilterValues__ToString(
        &valueQuery_country)));
    ...
    catalogs_locale_e valueQuery_language ;
    keyValuePair_t *keyPairQuery_language = 0;
    if (language)
    {
        keyQuery_language = strdup("language");
        valueQuery_language = (language);
        keyPairQuery_language = keyValuePair_create(keyQuery_language, strdup(catalogsAvailableFilterValues__ToString(
        &valueQuery_language)));
    ...
    catalogs_available_filter_values_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *CatalogsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = catalogs_available_filter_values_parseFromJSON(CatalogsAPIlocalVarJSON);
