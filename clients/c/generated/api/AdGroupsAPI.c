...
static char* adGroupsAnalytics__ToString(pinterest_rest_api_adGroupsAnalytics_reporting_timezone_e ){
    char *Array[] =  { "NULL", "PINTEREST_TIME_ZONE", "AD_ACCOUNT_TIME_ZONE" };
    return Array[];
}

static pinterest_rest_api_adGroupsAnalytics_reporting_timezone_e adGroupsAnalytics__FromString(char* ){
    int stringToReturn = 0;
    char *Array[] =  { "NULL", "PINTEREST_TIME_ZONE", "AD_ACCOUNT_TIME_ZONE" };
    size_t sizeofArray = sizeof(Array) / sizeof(Array[0]);
    while(stringToReturn < sizeofArray) {
...
// since conversion to JSON passes through the conversion of the model, and ToString. The function is kept for future reference.
//
static cJSON *adGroupsAnalytics__convertToJSON(pinterest_rest_api_adGroupsAnalytics_reporting_timezone_e ) {
    cJSON *item = cJSON_CreateObject();
    return item;
    fail:
    cJSON_Delete(item);
...
// since conversion from JSON passes through the conversion of the model, and FromString. The function is kept for future reference.
//
static pinterest_rest_api_adGroupsAnalytics_reporting_timezone_e adGroupsAnalytics__parseFromJSON(cJSON* JSON) {
    pinterest_rest_api_adGroupsAnalytics_reporting_timezone_e Variable = 0;
    return Variable;
end:
    return 0;
}
...
// Functions for enum  for AdGroupsAPI_adGroupsList

static char* adGroupsList__ToString(pinterest_rest_api_adGroupsList_order_e ){
    char *Array[] =  { "NULL", "ASCENDING", "DESCENDING" };
    return Array[];
}

static pinterest_rest_api_adGroupsList_order_e adGroupsList__FromString(char* ){
    int stringToReturn = 0;
    char *Array[] =  { "NULL", "ASCENDING", "DESCENDING" };
    size_t sizeofArray = sizeof(Array) / sizeof(Array[0]);
    while(stringToReturn < sizeofArray) {
...
/*
// Function adGroupsList__convertToJSON is not currently used,
// since conversion to JSON passes through the conversion of the model, and ToString. The function is kept for future reference.
//
static cJSON *adGroupsList__convertToJSON(pinterest_rest_api_adGroupsList_order_e ) {
    cJSON *item = cJSON_CreateObject();
    return item;
    fail:
    cJSON_Delete(item);
...
// Function adGroupsList__parseFromJSON is not currently used,
// since conversion from JSON passes through the conversion of the model, and FromString. The function is kept for future reference.
//
static pinterest_rest_api_adGroupsList_order_e adGroupsList__parseFromJSON(cJSON* JSON) {
    pinterest_rest_api_adGroupsList_order_e Variable = 0;
    return Variable;
end:
    return 0;
}
...
static char* adGroupsTargetingAnalyticsGet_TARGETINGTYPES_ToString(pinterest_rest_api_adGroupsTargetingAnalyticsGet_targeting_types_e TARGETINGTYPES){
    char *TARGETINGTYPESArray[] =  { "NULL", "KEYWORD", "APPTYPE", "GENDER", "LOCATION", "PLACEMENT", "COUNTRY", "TARGETED_INTEREST", "PINNER_INTEREST", "AUDIENCE_INCLUDE", "GEO", "AGE_BUCKET", "REGION", "AGE_BUCKET_AND_GENDER", "CREATIVE_ENHANCEMENTS" };
...
// Functions for enum ATTRIBUTIONTYPES for AdGroupsAPI_adGroupsTargetingAnalyticsGet

static char* adGroupsTargetingAnalyticsGet_ATTRIBUTIONTYPES_ToString(pinterest_rest_api_adGroupsTargetingAnalyticsGet_attribution_types_e ATTRIBUTIONTYPES){
    char *ATTRIBUTIONTYPESArray[] =  { "NULL", "INDIVIDUAL", "HOUSEHOLD" };
    return ATTRIBUTIONTYPESArray[ATTRIBUTIONTYPES];
}

static pinterest_rest_api_adGroupsTargetingAnalyticsGet_attribution_types_e adGroupsTargetingAnalyticsGet_ATTRIBUTIONTYPES_FromString(char* ATTRIBUTIONTYPES){
    int stringToReturn = 0;
    char *ATTRIBUTIONTYPESArray[] =  { "NULL", "INDIVIDUAL", "HOUSEHOLD" };
...
/*
// Function adGroupsTargetingAnalyticsGet_ATTRIBUTIONTYPES_convertToJSON is not currently used,
// since conversion to JSON passes through the conversion of the model, and ToString. The function is kept for future reference.
//
static cJSON *adGroupsTargetingAnalyticsGet_ATTRIBUTIONTYPES_convertToJSON(pinterest_rest_api_adGroupsTargetingAnalyticsGet_attribution_types_e ATTRIBUTIONTYPES) {
    cJSON *item = cJSON_CreateObject();
    return item;
    fail:
    cJSON_Delete(item);
...
// Function adGroupsTargetingAnalyticsGet_ATTRIBUTIONTYPES_parseFromJSON is not currently used,
// since conversion from JSON passes through the conversion of the model, and FromString. The function is kept for future reference.
//
static pinterest_rest_api_adGroupsTargetingAnalyticsGet_attribution_types_e adGroupsTargetingAnalyticsGet_ATTRIBUTIONTYPES_parseFromJSON(cJSON* ATTRIBUTIONTYPESJSON) {
    pinterest_rest_api_adGroupsTargetingAnalyticsGet_attribution_types_e ATTRIBUTIONTYPESVariable = 0;
...
static char* adGroupsTargetingAnalyticsGet__ToString(pinterest_rest_api_adGroupsTargetingAnalyticsGet_reporting_timezone_e ){
    char *Array[] =  { "NULL", "PINTEREST_TIME_ZONE", "AD_ACCOUNT_TIME_ZONE" };
    return Array[];
}

static pinterest_rest_api_adGroupsTargetingAnalyticsGet_reporting_timezone_e adGroupsTargetingAnalyticsGet__FromString(char* ){
    int stringToReturn = 0;
    char *Array[] =  { "NULL", "PINTEREST_TIME_ZONE", "AD_ACCOUNT_TIME_ZONE" };
    size_t sizeofArray = sizeof(Array) / sizeof(Array[0]);
    while(stringToReturn < sizeofArray) {
...
// since conversion to JSON passes through the conversion of the model, and ToString. The function is kept for future reference.
//
static cJSON *adGroupsTargetingAnalyticsGet__convertToJSON(pinterest_rest_api_adGroupsTargetingAnalyticsGet_reporting_timezone_e ) {
    cJSON *item = cJSON_CreateObject();
    return item;
    fail:
    cJSON_Delete(item);
...
// since conversion from JSON passes through the conversion of the model, and FromString. The function is kept for future reference.
//
static pinterest_rest_api_adGroupsTargetingAnalyticsGet_reporting_timezone_e adGroupsTargetingAnalyticsGet__parseFromJSON(cJSON* JSON) {
    pinterest_rest_api_adGroupsTargetingAnalyticsGet_reporting_timezone_e Variable = 0;
    return Variable;
end:
    return 0;
}
...
// Functions for enum  for AdGroupsAPI_getAdGroupsByPromotionIdsList

static char* getAdGroupsByPromotionIdsList__ToString(pinterest_rest_api_getAdGroupsByPromotionIdsList_order_e ){
    char *Array[] =  { "NULL", "ASCENDING", "DESCENDING" };
    return Array[];
}

static pinterest_rest_api_getAdGroupsByPromotionIdsList_order_e getAdGroupsByPromotionIdsList__FromString(char* ){
    int stringToReturn = 0;
    char *Array[] =  { "NULL", "ASCENDING", "DESCENDING" };
    size_t sizeofArray = sizeof(Array) / sizeof(Array[0]);
    while(stringToReturn < sizeofArray) {
...
/*
// Function getAdGroupsByPromotionIdsList__convertToJSON is not currently used,
// since conversion to JSON passes through the conversion of the model, and ToString. The function is kept for future reference.
//
static cJSON *getAdGroupsByPromotionIdsList__convertToJSON(pinterest_rest_api_getAdGroupsByPromotionIdsList_order_e ) {
    cJSON *item = cJSON_CreateObject();
    return item;
    fail:
    cJSON_Delete(item);
...
// Function getAdGroupsByPromotionIdsList__parseFromJSON is not currently used,
// since conversion from JSON passes through the conversion of the model, and FromString. The function is kept for future reference.
//
static pinterest_rest_api_getAdGroupsByPromotionIdsList_order_e getAdGroupsByPromotionIdsList__parseFromJSON(cJSON* JSON) {
    pinterest_rest_api_getAdGroupsByPromotionIdsList_order_e Variable = 0;
    return Variable;
end:
    return 0;
}
...
AdGroupsAPI_adGroupsAnalytics(apiClient_t *apiClient, char start_date, char end_date, list_t *ad_group_ids, list_t *columns, granularity_e granularity, char *ad_account_id, double click_window_days, double engagement_window_days, double view_window_days, pinterest_rest_api_adGroupsAnalytics_conversion_report_time_e conversion_report_time, int *aggregate_report_rows, reporting_time_zone_e reporting_timezone)
{
    ...
    // create the path
    char *localVarPath = strdup("/ad_accounts/{ad_account_id}/ad_groups/analytics");
    ...
    if (granularity)
    {
        ...
        keyPairQuery_granularity = keyValuePair_create(keyQuery_granularity, strdup(adGroupsAnalytics__ToString(
    ...
    if (click_window_days)
    {
        ...
        keyPairQuery_click_window_days = keyValuePair_create(keyQuery_click_window_days, strdup(adGroupsAnalytics_CLICKWINDOWDAYS_ToString(
    ...
    if (engagement_window_days)
    {
        ...
        keyPairQuery_engagement_window_days = keyValuePair_create(keyQuery_engagement_window_days, strdup(adGroupsAnalytics_ENGAGEMENTWINDOWDAYS_ToString(
    ...
    if (view_window_days)
    {
        ...
        keyPairQuery_view_window_days = keyValuePair_create(keyQuery_view_window_days, strdup(adGroupsAnalytics_VIEWWINDOWDAYS_ToString(
    ...
    if (conversion_report_time)
    {
        ...
        keyPairQuery_conversion_report_time = keyValuePair_create(keyQuery_conversion_report_time, strdup(adGroupsAnalytics_CONVERSIONREPORTTIME_ToString(
    ...
    if (reporting_timezone)
    {
        ...
        keyPairQuery_reporting_timezone = keyValuePair_create(keyQuery_reporting_timezone, strdup(adGroupsAnalytics__ToString(
...
AdGroupsAPI_adGroupsAudienceSizing(apiClient_t *apiClient, char *ad_account_id, ad_group_audience_sizing_create_t *ad_group_audience_sizing_create)
{
    ...
    // create the path
    char *localVarPath = strdup("/ad_accounts/{ad_account_id}/ad_groups/audience_sizing");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_ad_group_audience_sizing_create = NULL;
    if (ad_group_audience_sizing_create != NULL)
    {
        //not string, not binary
        localVarSingleItemJSON_ad_group_audience_sizing_create = ad_group_audience_sizing_create_convertToJSON(ad_group_audience_sizing_create);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_ad_group_audience_sizing_create);
    ...
    ad_group_audience_sizing_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *AdGroupsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = ad_group_audience_sizing_parseFromJSON(AdGroupsAPIlocalVarJSON);
        cJSON_Delete(AdGroupsAPIlocalVarJSON);
    ...
    free(localVarPath);
    free(localVarToReplace_ad_account_id);
    if (localVarSingleItemJSON_ad_group_audience_sizing_create) {
        cJSON_Delete(localVarSingleItemJSON_ad_group_audience_sizing_create);
        localVarSingleItemJSON_ad_group_audience_sizing_create = NULL;
    }
...
//
bid_floor_t*
AdGroupsAPI_adGroupsBidFloorGet(apiClient_t *apiClient, char *ad_account_id, bid_floor_create_t *bid_floor_create)
{
    list_t    *localVarQueryParameters = NULL;
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
    ...
    // create the path
    char *localVarPath = strdup("/ad_accounts/{ad_account_id}/bid_floor");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_bid_floor_create = NULL;
    if (bid_floor_create != NULL)
    {
        //not string, not binary
        localVarSingleItemJSON_bid_floor_create = bid_floor_create_convertToJSON(bid_floor_create);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_bid_floor_create);
        localVarBodyLength = strlen(localVarBodyParameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //}
    //nonprimitive not container
    bid_floor_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *AdGroupsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = bid_floor_parseFromJSON(AdGroupsAPIlocalVarJSON);
        cJSON_Delete(AdGroupsAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
    ...
    free(localVarPath);
    free(localVarToReplace_ad_account_id);
    if (localVarSingleItemJSON_bid_floor_create) {
        cJSON_Delete(localVarSingleItemJSON_bid_floor_create);
        localVarSingleItemJSON_bid_floor_create = NULL;
    }
    free(localVarBodyParameters);
    return elementToReturn;
end:
...
//
ad_groups_create_200_response_t*
AdGroupsAPI_adGroupsCreate(apiClient_t *apiClient, char *ad_account_id, list_t *ad_group_create_create)
{
    list_t    *localVarQueryParameters = NULL;
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
    ...
    // create the path
    char *localVarPath = strdup("/ad_accounts/{ad_account_id}/ad_groups");
    ...
    // Body Param
    //notstring
    cJSON *localVar_ad_group_create_create = NULL;
    cJSON *localVarItemJSON_ad_group_create_create = NULL;
    cJSON *localVarSingleItemJSON_ad_group_create_create = NULL;
    if (ad_group_create_create != NULL)
    {
        localVarItemJSON_ad_group_create_create = cJSON_CreateObject();
        localVarSingleItemJSON_ad_group_create_create = cJSON_AddArrayToObject(localVarItemJSON_ad_group_create_create, "ad_group_create_create");
        if (localVarSingleItemJSON_ad_group_create_create == NULL)
        {
    ...
    listEntry_t *ad_group_create_createBodyListEntry;
    list_ForEach(ad_group_create_createBodyListEntry, ad_group_create_create)
    {
        localVar_ad_group_create_create = ad_group_create_create_convertToJSON(ad_group_create_createBodyListEntry->data);
        if(localVar_ad_group_create_create == NULL)
        {
            goto end;
        }
        cJSON_AddItemToArray(localVarSingleItemJSON_ad_group_create_create, localVar_ad_group_create_create);
        localVarBodyParameters = cJSON_Print(localVarItemJSON_ad_group_create_create);
        localVarBodyLength = strlen(localVarBodyParameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //}
    //nonprimitive not container
    ad_groups_create_200_response_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *AdGroupsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = ad_groups_create_200_response_parseFromJSON(AdGroupsAPIlocalVarJSON);
        cJSON_Delete(AdGroupsAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
    ...
    free(localVarPath);
    free(localVarToReplace_ad_account_id);
    if (localVarItemJSON_ad_group_create_create) {
        cJSON_Delete(localVarItemJSON_ad_group_create_create);
        localVarItemJSON_ad_group_create_create = NULL;
    }
    if (localVarSingleItemJSON_ad_group_create_create) {
        cJSON_Delete(localVarSingleItemJSON_ad_group_create_create);
        localVarSingleItemJSON_ad_group_create_create = NULL;
    }
    if (localVar_ad_group_create_create) {
        cJSON_Delete(localVar_ad_group_create_create);
        localVar_ad_group_create_create = NULL;
    }
    free(localVarBodyParameters);
    return elementToReturn;
end:
...
AdGroupsAPI_adGroupsDynamicTitlesDownloadCsv(apiClient_t *apiClient, char *ad_account_id, char *ad_group_id)
{
    list_t    *localVarQueryParameters = NULL;
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
    ...
    // create the path
    char *localVarPath = strdup("/ad_accounts/{ad_account_id}/ad_groups/{ad_group_id}/dynamic_titles/csv");
    ...
    // Path Params
    long sizeOfPathParams_ad_account_id = strlen(ad_account_id)+3 + strlen(ad_group_id)+3 + sizeof("{ ad_account_id }") - 1;
    if(ad_account_id == NULL) {
        goto end;
    }
    char* localVarToReplace_ad_account_id = malloc(sizeOfPathParams_ad_account_id);
    ...
    // Path Params
    long sizeOfPathParams_ad_group_id = strlen(ad_account_id)+3 + strlen(ad_group_id)+3 + sizeof("{ ad_group_id }") - 1;
    if(ad_group_id == NULL) {
        goto end;
    }
    ...
    //}
    //nonprimitive not container
    dynamic_titles_download_csv_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *AdGroupsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = dynamic_titles_download_csv_parseFromJSON(AdGroupsAPIlocalVarJSON);
        cJSON_Delete(AdGroupsAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
...
AdGroupsAPI_adGroupsDynamicTitlesGetStatus(apiClient_t *apiClient, char *ad_account_id, char *ad_group_id)
{
    list_t    *localVarQueryParameters = NULL;
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
    ...
    // create the path
    char *localVarPath = strdup("/ad_accounts/{ad_account_id}/ad_groups/{ad_group_id}/dynamic_titles/status");
    ...
    //}
    //nonprimitive not container
    dynamic_titles_get_status_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *AdGroupsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = dynamic_titles_get_status_parseFromJSON(AdGroupsAPIlocalVarJSON);
        cJSON_Delete(AdGroupsAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
...
AdGroupsAPI_adGroupsDynamicTitlesGetUploadUrl(apiClient_t *apiClient, char *ad_account_id, char *ad_group_id)
{
    list_t    *localVarQueryParameters = NULL;
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
    ...
    // create the path
    char *localVarPath = strdup("/ad_accounts/{ad_account_id}/ad_groups/{ad_group_id}/dynamic_titles/uploads");
    ...
    //}
    //nonprimitive not container
    dynamic_titles_upload_url_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *AdGroupsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = dynamic_titles_upload_url_parseFromJSON(AdGroupsAPIlocalVarJSON);
        cJSON_Delete(AdGroupsAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
...
AdGroupsAPI_adGroupsDynamicTitlesProcessCsv(apiClient_t *apiClient, char *ad_account_id, char *ad_group_id, dynamic_titles_process_csv_create_t *dynamic_titles_process_csv_create)
{
    list_t    *localVarQueryParameters = NULL;
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
    ...
    // create the path
    char *localVarPath = strdup("/ad_accounts/{ad_account_id}/ad_groups/{ad_group_id}/dynamic_titles");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_dynamic_titles_process_csv_create = NULL;
    if (dynamic_titles_process_csv_create != NULL)
    {
        //not string, not binary
        localVarSingleItemJSON_dynamic_titles_process_csv_create = dynamic_titles_process_csv_create_convertToJSON(dynamic_titles_process_csv_create);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_dynamic_titles_process_csv_create);
        localVarBodyLength = strlen(localVarBodyParameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //}
    //nonprimitive not container
    dynamic_titles_process_csv_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *AdGroupsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = dynamic_titles_process_csv_parseFromJSON(AdGroupsAPIlocalVarJSON);
        cJSON_Delete(AdGroupsAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
    ...
    free(localVarToReplace_ad_account_id);
    free(localVarToReplace_ad_group_id);
    if (localVarSingleItemJSON_dynamic_titles_process_csv_create) {
        cJSON_Delete(localVarSingleItemJSON_dynamic_titles_process_csv_create);
        localVarSingleItemJSON_dynamic_titles_process_csv_create = NULL;
    }
    free(localVarBodyParameters);
    return elementToReturn;
end:
...
//
ad_group_t*
AdGroupsAPI_adGroupsGet(apiClient_t *apiClient, char *ad_group_id, char *ad_account_id)
{
    list_t    *localVarQueryParameters = NULL;
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
    ...
    // create the path
    char *localVarPath = strdup("/ad_accounts/{ad_account_id}/ad_groups/{ad_group_id}");
    ...
    // Path Params
    long sizeOfPathParams_ad_group_id = strlen(ad_group_id)+3 + strlen(ad_account_id)+3 + sizeof("{ ad_group_id }") - 1;
    if(ad_group_id == NULL) {
        goto end;
    }
    char* localVarToReplace_ad_group_id = malloc(sizeOfPathParams_ad_group_id);
    ...
    // Path Params
    long sizeOfPathParams_ad_account_id = strlen(ad_group_id)+3 + strlen(ad_account_id)+3 + sizeof("{ ad_account_id }") - 1;
    if(ad_account_id == NULL) {
        goto end;
    }
    char* localVarToReplace_ad_account_id = malloc(sizeOfPathParams_ad_account_id);
    ...
    //}
    //nonprimitive not container
    ad_group_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *AdGroupsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = ad_group_parseFromJSON(AdGroupsAPIlocalVarJSON);
        cJSON_Delete(AdGroupsAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
...
AdGroupsAPI_adGroupsList(apiClient_t *apiClient, char *ad_account_id, char *bookmark, int *page_size, pinterest_lib_pagination_order_e order, list_t *campaign_ids, list_t *ad_group_ids, list_t *entity_statuses, int *translate_interests_to_names)
{
    list_t    *localVarQueryParameters = list_createList();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
    ...
    if (order)
    {
        ...
        keyPairQuery_order = keyValuePair_create(keyQuery_order, strdup(adGroupsList__ToString(
        &valueQuery_order)));
    ...
    //}
    //nonprimitive not container
    ad_groups_list_200_response_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *AdGroupsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = ad_groups_list_200_response_parseFromJSON(AdGroupsAPIlocalVarJSON);
        cJSON_Delete(AdGroupsAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
...
AdGroupsAPI_adGroupsTargetingAnalyticsGet(apiClient_t *apiClient, char *ad_account_id, list_t *ad_group_ids, char start_date, char end_date, list_t *targeting_types, list_t *columns, granularity_e granularity, double click_window_days, double engagement_window_days, double view_window_days, pinterest_rest_api_adGroupsTargetingAnalyticsGet_conversion_report_time_e conversion_report_time, list_t *attribution_types, reporting_time_zone_e reporting_timezone, list_t *sort_columns, int *sort_ascending)
{
    ...
    // create the path
    char *localVarPath = strdup("/ad_accounts/{ad_account_id}/ad_groups/targeting_analytics");
    ...
    if (granularity)
    {
        keyQuery_granularity = strdup("granularity");
        valueQuery_granularity = (granularity);
        keyPairQuery_granularity = keyValuePair_create(keyQuery_granularity, strdup(adGroupsTargetingAnalyticsGet__ToString(
        &valueQuery_granularity)));
        list_addElement(localVarQueryParameters,keyPairQuery_granularity);
    }
    ...
    if (click_window_days)
    {
        keyQuery_click_window_days = strdup("click_window_days");
        valueQuery_click_window_days = (click_window_days);
        keyPairQuery_click_window_days = keyValuePair_create(keyQuery_click_window_days, strdup(adGroupsTargetingAnalyticsGet_CLICKWINDOWDAYS_ToString(
        &valueQuery_click_window_days)));
        list_addElement(localVarQueryParameters,keyPairQuery_click_window_days);
    }
    ...
    if (engagement_window_days)
    {
        keyQuery_engagement_window_days = strdup("engagement_window_days");
        valueQuery_engagement_window_days = (engagement_window_days);
        keyPairQuery_engagement_window_days = keyValuePair_create(keyQuery_engagement_window_days, strdup(adGroupsTargetingAnalyticsGet_ENGAGEMENTWINDOWDAYS_ToString(
        &valueQuery_engagement_window_days)));
        list_addElement(localVarQueryParameters,keyPairQuery_engagement_window_days);
    }
    ...
    if (view_window_days)
    {
        keyQuery_view_window_days = strdup("view_window_days");
        valueQuery_view_window_days = (view_window_days);
        keyPairQuery_view_window_days = keyValuePair_create(keyQuery_view_window_days, strdup(adGroupsTargetingAnalyticsGet_VIEWWINDOWDAYS_ToString(
        &valueQuery_view_window_days)));
        list_addElement(localVarQueryParameters,keyPairQuery_view_window_days);
    }
    ...
    if (conversion_report_time)
    {
        keyQuery_conversion_report_time = strdup("conversion_report_time");
        valueQuery_conversion_report_time = (conversion_report_time);
        keyPairQuery_conversion_report_time = keyValuePair_create(keyQuery_conversion_report_time, strdup(adGroupsTargetingAnalyticsGet_CONVERSIONREPORTTIME_ToString(
        valueQuery_conversion_report_time)));
        list_addElement(localVarQueryParameters,keyPairQuery_conversion_report_time);
    }
    ...
    if (reporting_timezone)
    {
        keyQuery_reporting_timezone = strdup("reporting_timezone");
        valueQuery_reporting_timezone = (reporting_timezone);
        keyPairQuery_reporting_timezone = keyValuePair_create(keyQuery_reporting_timezone, strdup(adGroupsTargetingAnalyticsGet__ToString(
        &valueQuery_reporting_timezone)));
        list_addElement(localVarQueryParameters,keyPairQuery_reporting_timezone);
    }
    ...
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *AdGroupsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = metrics_response_parseFromJSON(AdGroupsAPIlocalVarJSON);
        cJSON_Delete(AdGroupsAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
...
//
ad_groups_create_200_response_t*
AdGroupsAPI_adGroupsUpdate(apiClient_t *apiClient, char *ad_account_id, list_t *ad_group_update_batch_update)
{
    list_t    *localVarQueryParameters = NULL;
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
    ...
    // Body Param
    //notstring
    cJSON *localVar_ad_group_update_batch_update = NULL;
    cJSON *localVarItemJSON_ad_group_update_batch_update = NULL;
    cJSON *localVarSingleItemJSON_ad_group_update_batch_update = NULL;
    if (ad_group_update_batch_update != NULL)
    {
        localVarItemJSON_ad_group_update_batch_update = cJSON_CreateObject();
        localVarSingleItemJSON_ad_group_update_batch_update = cJSON_AddArrayToObject(localVarItemJSON_ad_group_update_batch_update, "ad_group_update_batch_update");
        if (localVarSingleItemJSON_ad_group_update_batch_update == NULL)
        {
            // nonprimitive container
    ...
    listEntry_t *ad_group_update_batch_updateBodyListEntry;
    list_ForEach(ad_group_update_batch_updateBodyListEntry, ad_group_update_batch_update)
    {
        localVar_ad_group_update_batch_update = ad_group_update_batch_update_convertToJSON(ad_group_update_batch_updateBodyListEntry->data);
        if(localVar_ad_group_update_batch_update == NULL)
        {
            goto end;
        }
        cJSON_AddItemToArray(localVarSingleItemJSON_ad_group_update_batch_update, localVar_ad_group_update_batch_update);
        localVarBodyParameters = cJSON_Print(localVarItemJSON_ad_group_update_batch_update);
        localVarBodyLength = strlen(localVarBodyParameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(localVarPath);
    free(localVarToReplace_ad_account_id);
    if (localVarItemJSON_ad_group_update_batch_update) {
        cJSON_Delete(localVarItemJSON_ad_group_update_batch_update);
        localVarItemJSON_ad_group_update_batch_update = NULL;
    }
    if (localVarSingleItemJSON_ad_group_update_batch_update) {
        cJSON_Delete(localVarSingleItemJSON_ad_group_update_batch_update);
        localVarSingleItemJSON_ad_group_update_batch_update = NULL;
    }
    if (localVar_ad_group_update_batch_update) {
        cJSON_Delete(localVar_ad_group_update_batch_update);
        localVar_ad_group_update_batch_update = NULL;
    }
    free(localVarBodyParameters);
    return elementToReturn;
end:
...
//
ad_groups_list_200_response_t*
AdGroupsAPI_getAdGroupsByPromotionIdsList(apiClient_t *apiClient, char *ad_account_id, list_t *promotion_ids, char *bookmark, int *page_size, pinterest_lib_pagination_order_e order)
{
    list_t    *localVarQueryParameters = list_createList();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
    ...
    // create the path
    char *localVarPath = strdup("/ad_accounts/{ad_account_id}/promotion_applied_entities");
    ...
    if (order)
    {
        keyQuery_order = strdup("order");
        valueQuery_order = (order);
        keyPairQuery_order = keyValuePair_create(keyQuery_order, strdup(getAdGroupsByPromotionIdsList__ToString(
        &valueQuery_order)));
        list_addElement(localVarQueryParameters,keyPairQuery_order);
    }
    ...
    if (promotion_ids)
    {
        list_addElement(localVarQueryParameters,promotion_ids);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    apiClient_invoke(apiClient,
                    localVarPath,
