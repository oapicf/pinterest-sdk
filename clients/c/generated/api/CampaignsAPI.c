...
// Functions for enum COLUMNS for CampaignsAPI_adPinsAnalytics

static char* adPinsAnalytics_COLUMNS_ToString(pinterest_rest_api_adPinsAnalytics_columns_e COLUMNS){
...
static pinterest_rest_api_adPinsAnalytics_columns_e adPinsAnalytics_COLUMNS_FromString(char* COLUMNS){
...
/*
// Function adPinsAnalytics_COLUMNS_convertToJSON is not currently used,
// since conversion to JSON passes through the conversion of the model, and ToString. The function is kept for future reference.
//
static cJSON *adPinsAnalytics_COLUMNS_convertToJSON(pinterest_rest_api_adPinsAnalytics_columns_e COLUMNS) {
...
// Function adPinsAnalytics_COLUMNS_parseFromJSON is not currently used,
// since conversion from JSON passes through the conversion of the model, and FromString. The function is kept for future reference.
//
static pinterest_rest_api_adPinsAnalytics_columns_e adPinsAnalytics_COLUMNS_parseFromJSON(cJSON* COLUMNSJSON) {
    pinterest_rest_api_adPinsAnalytics_columns_e COLUMNSVariable = 0;
...
// Functions for enum  for CampaignsAPI_adPinsAnalytics

static char* adPinsAnalytics__ToString(pinterest_rest_api_adPinsAnalytics_granularity_e ){
    char *Array[] =  { "NULL", "TOTAL", "DAY", "HOUR", "WEEK", "MONTH" };
    return Array[];
}

static pinterest_rest_api_adPinsAnalytics_granularity_e adPinsAnalytics__FromString(char* ){
    int stringToReturn = 0;
    char *Array[] =  { "NULL", "TOTAL", "DAY", "HOUR", "WEEK", "MONTH" };
...
/*
// Function adPinsAnalytics__convertToJSON is not currently used,
// since conversion to JSON passes through the conversion of the model, and ToString. The function is kept for future reference.
//
static cJSON *adPinsAnalytics__convertToJSON(pinterest_rest_api_adPinsAnalytics_granularity_e ) {
    cJSON *item = cJSON_CreateObject();
    return item;
    fail:
    cJSON_Delete(item);
...
// Function adPinsAnalytics__parseFromJSON is not currently used,
// since conversion from JSON passes through the conversion of the model, and FromString. The function is kept for future reference.
//
static pinterest_rest_api_adPinsAnalytics_granularity_e adPinsAnalytics__parseFromJSON(cJSON* JSON) {
    pinterest_rest_api_adPinsAnalytics_granularity_e Variable = 0;
    return Variable;
end:
    return 0;
}
...
// Functions for enum CLICKWINDOWDAYS for CampaignsAPI_adPinsAnalytics

static char* adPinsAnalytics_CLICKWINDOWDAYS_ToString(pinterest_rest_api_adPinsAnalytics_click_window_days_e CLICKWINDOWDAYS){
    char *CLICKWINDOWDAYSArray[] =  { "NULL", "0", "1", "7", "14", "30", "60" };
    return CLICKWINDOWDAYSArray[CLICKWINDOWDAYS];
}

static pinterest_rest_api_adPinsAnalytics_click_window_days_e adPinsAnalytics_CLICKWINDOWDAYS_FromString(char* CLICKWINDOWDAYS){
    int stringToReturn = 0;
    char *CLICKWINDOWDAYSArray[] =  { "NULL", "0", "1", "7", "14", "30", "60" };
...
/*
// Function adPinsAnalytics_CLICKWINDOWDAYS_convertToJSON is not currently used,
// since conversion to JSON passes through the conversion of the model, and ToString. The function is kept for future reference.
//
static cJSON *adPinsAnalytics_CLICKWINDOWDAYS_convertToJSON(pinterest_rest_api_adPinsAnalytics_click_window_days_e CLICKWINDOWDAYS) {
    cJSON *item = cJSON_CreateObject();
    return item;
    fail:
    cJSON_Delete(item);
...
// Function adPinsAnalytics_CLICKWINDOWDAYS_parseFromJSON is not currently used,
// since conversion from JSON passes through the conversion of the model, and FromString. The function is kept for future reference.
//
static pinterest_rest_api_adPinsAnalytics_click_window_days_e adPinsAnalytics_CLICKWINDOWDAYS_parseFromJSON(cJSON* CLICKWINDOWDAYSJSON) {
    pinterest_rest_api_adPinsAnalytics_click_window_days_e CLICKWINDOWDAYSVariable = 0;
...
// Functions for enum ENGAGEMENTWINDOWDAYS for CampaignsAPI_adPinsAnalytics

static char* adPinsAnalytics_ENGAGEMENTWINDOWDAYS_ToString(pinterest_rest_api_adPinsAnalytics_engagement_window_days_e ENGAGEMENTWINDOWDAYS){
    char *ENGAGEMENTWINDOWDAYSArray[] =  { "NULL", "0", "1", "7", "14", "30", "60" };
    return ENGAGEMENTWINDOWDAYSArray[ENGAGEMENTWINDOWDAYS];
}

static pinterest_rest_api_adPinsAnalytics_engagement_window_days_e adPinsAnalytics_ENGAGEMENTWINDOWDAYS_FromString(char* ENGAGEMENTWINDOWDAYS){
    int stringToReturn = 0;
    char *ENGAGEMENTWINDOWDAYSArray[] =  { "NULL", "0", "1", "7", "14", "30", "60" };
...
/*
// Function adPinsAnalytics_ENGAGEMENTWINDOWDAYS_convertToJSON is not currently used,
// since conversion to JSON passes through the conversion of the model, and ToString. The function is kept for future reference.
//
static cJSON *adPinsAnalytics_ENGAGEMENTWINDOWDAYS_convertToJSON(pinterest_rest_api_adPinsAnalytics_engagement_window_days_e ENGAGEMENTWINDOWDAYS) {
    cJSON *item = cJSON_CreateObject();
    return item;
    fail:
    cJSON_Delete(item);
...
// Function adPinsAnalytics_ENGAGEMENTWINDOWDAYS_parseFromJSON is not currently used,
// since conversion from JSON passes through the conversion of the model, and FromString. The function is kept for future reference.
//
static pinterest_rest_api_adPinsAnalytics_engagement_window_days_e adPinsAnalytics_ENGAGEMENTWINDOWDAYS_parseFromJSON(cJSON* ENGAGEMENTWINDOWDAYSJSON) {
    pinterest_rest_api_adPinsAnalytics_engagement_window_days_e ENGAGEMENTWINDOWDAYSVariable = 0;
...
// Functions for enum VIEWWINDOWDAYS for CampaignsAPI_adPinsAnalytics

static char* adPinsAnalytics_VIEWWINDOWDAYS_ToString(pinterest_rest_api_adPinsAnalytics_view_window_days_e VIEWWINDOWDAYS){
    char *VIEWWINDOWDAYSArray[] =  { "NULL", "0", "1", "7", "14", "30", "60" };
    return VIEWWINDOWDAYSArray[VIEWWINDOWDAYS];
}

static pinterest_rest_api_adPinsAnalytics_view_window_days_e adPinsAnalytics_VIEWWINDOWDAYS_FromString(char* VIEWWINDOWDAYS){
    int stringToReturn = 0;
    char *VIEWWINDOWDAYSArray[] =  { "NULL", "0", "1", "7", "14", "30", "60" };
...
/*
// Function adPinsAnalytics_VIEWWINDOWDAYS_convertToJSON is not currently used,
// since conversion to JSON passes through the conversion of the model, and ToString. The function is kept for future reference.
//
static cJSON *adPinsAnalytics_VIEWWINDOWDAYS_convertToJSON(pinterest_rest_api_adPinsAnalytics_view_window_days_e VIEWWINDOWDAYS) {
    cJSON *item = cJSON_CreateObject();
    return item;
    fail:
    cJSON_Delete(item);
...
// Function adPinsAnalytics_VIEWWINDOWDAYS_parseFromJSON is not currently used,
// since conversion from JSON passes through the conversion of the model, and FromString. The function is kept for future reference.
//
static pinterest_rest_api_adPinsAnalytics_view_window_days_e adPinsAnalytics_VIEWWINDOWDAYS_parseFromJSON(cJSON* VIEWWINDOWDAYSJSON) {
    pinterest_rest_api_adPinsAnalytics_view_window_days_e VIEWWINDOWDAYSVariable = 0;
...
// Functions for enum CONVERSIONREPORTTIME for CampaignsAPI_adPinsAnalytics

static char* adPinsAnalytics_CONVERSIONREPORTTIME_ToString(pinterest_rest_api_adPinsAnalytics_conversion_report_time_e CONVERSIONREPORTTIME){
...
static pinterest_rest_api_adPinsAnalytics_conversion_report_time_e adPinsAnalytics_CONVERSIONREPORTTIME_FromString(char* CONVERSIONREPORTTIME){
    int stringToReturn = 0;
    char *CONVERSIONREPORTTIMEArray[] =  { "NULL", "TIME_OF_AD_ACTION", "TIME_OF_CONVERSION" };
...
/*
// Function adPinsAnalytics_CONVERSIONREPORTTIME_convertToJSON is not currently used,
// since conversion to JSON passes through the conversion of the model, and ToString. The function is kept for future reference.
//
static cJSON *adPinsAnalytics_CONVERSIONREPORTTIME_convertToJSON(pinterest_rest_api_adPinsAnalytics_conversion_report_time_e CONVERSIONREPORTTIME) {
    cJSON *item = cJSON_CreateObject();
    if(cJSON_AddStringToObject(item, "conversion_report_time", adPinsAnalytics_CONVERSIONREPORTTIME_ToString(CONVERSIONREPORTTIME)) == NULL) {
        goto fail;
    }
    return item;
    fail:
...
// Function adPinsAnalytics_CONVERSIONREPORTTIME_parseFromJSON is not currently used,
// since conversion from JSON passes through the conversion of the model, and FromString. The function is kept for future reference.
//
static pinterest_rest_api_adPinsAnalytics_conversion_report_time_e adPinsAnalytics_CONVERSIONREPORTTIME_parseFromJSON(cJSON* CONVERSIONREPORTTIMEJSON) {
    pinterest_rest_api_adPinsAnalytics_conversion_report_time_e CONVERSIONREPORTTIMEVariable = 0;
    ...
    CONVERSIONREPORTTIMEVariable = adPinsAnalytics_CONVERSIONREPORTTIME_FromString(CONVERSIONREPORTTIMEVar->valuestring);
...
static char* campaignTargetingAnalyticsGet_TARGETINGTYPES_ToString(pinterest_rest_api_campaignTargetingAnalyticsGet_targeting_types_e TARGETINGTYPES){
    char *TARGETINGTYPESArray[] =  { "NULL", "KEYWORD", "APPTYPE", "GENDER", "LOCATION", "PLACEMENT", "COUNTRY", "TARGETED_INTEREST", "PINNER_INTEREST", "AUDIENCE_INCLUDE", "GEO", "AGE_BUCKET", "REGION", "CREATIVE_TYPE", "AGE_BUCKET_AND_GENDER", "AUDIENCE_MULTIPLIER" };
...
// Functions for enum ATTRIBUTIONTYPES for CampaignsAPI_campaignTargetingAnalyticsGet

static char* campaignTargetingAnalyticsGet_ATTRIBUTIONTYPES_ToString(pinterest_rest_api_campaignTargetingAnalyticsGet_attribution_types_e ATTRIBUTIONTYPES){
    char *ATTRIBUTIONTYPESArray[] =  { "NULL", "INDIVIDUAL", "HOUSEHOLD" };
    return ATTRIBUTIONTYPESArray[ATTRIBUTIONTYPES];
}

static pinterest_rest_api_campaignTargetingAnalyticsGet_attribution_types_e campaignTargetingAnalyticsGet_ATTRIBUTIONTYPES_FromString(char* ATTRIBUTIONTYPES){
    int stringToReturn = 0;
    char *ATTRIBUTIONTYPESArray[] =  { "NULL", "INDIVIDUAL", "HOUSEHOLD" };
...
/*
// Function campaignTargetingAnalyticsGet_ATTRIBUTIONTYPES_convertToJSON is not currently used,
// since conversion to JSON passes through the conversion of the model, and ToString. The function is kept for future reference.
//
static cJSON *campaignTargetingAnalyticsGet_ATTRIBUTIONTYPES_convertToJSON(pinterest_rest_api_campaignTargetingAnalyticsGet_attribution_types_e ATTRIBUTIONTYPES) {
    cJSON *item = cJSON_CreateObject();
    return item;
    fail:
    cJSON_Delete(item);
...
// Function campaignTargetingAnalyticsGet_ATTRIBUTIONTYPES_parseFromJSON is not currently used,
// since conversion from JSON passes through the conversion of the model, and FromString. The function is kept for future reference.
//
static pinterest_rest_api_campaignTargetingAnalyticsGet_attribution_types_e campaignTargetingAnalyticsGet_ATTRIBUTIONTYPES_parseFromJSON(cJSON* ATTRIBUTIONTYPESJSON) {
    pinterest_rest_api_campaignTargetingAnalyticsGet_attribution_types_e ATTRIBUTIONTYPESVariable = 0;
...
static char* campaignTargetingAnalyticsGet__ToString(pinterest_rest_api_campaignTargetingAnalyticsGet_reporting_timezone_e ){
    char *Array[] =  { "NULL", "PINTEREST_TIME_ZONE", "AD_ACCOUNT_TIME_ZONE" };
    return Array[];
}

static pinterest_rest_api_campaignTargetingAnalyticsGet_reporting_timezone_e campaignTargetingAnalyticsGet__FromString(char* ){
    int stringToReturn = 0;
    char *Array[] =  { "NULL", "PINTEREST_TIME_ZONE", "AD_ACCOUNT_TIME_ZONE" };
    size_t sizeofArray = sizeof(Array) / sizeof(Array[0]);
    while(stringToReturn < sizeofArray) {
...
// since conversion to JSON passes through the conversion of the model, and ToString. The function is kept for future reference.
//
static cJSON *campaignTargetingAnalyticsGet__convertToJSON(pinterest_rest_api_campaignTargetingAnalyticsGet_reporting_timezone_e ) {
    cJSON *item = cJSON_CreateObject();
    return item;
    fail:
    cJSON_Delete(item);
...
// since conversion from JSON passes through the conversion of the model, and FromString. The function is kept for future reference.
//
static pinterest_rest_api_campaignTargetingAnalyticsGet_reporting_timezone_e campaignTargetingAnalyticsGet__parseFromJSON(cJSON* JSON) {
    pinterest_rest_api_campaignTargetingAnalyticsGet_reporting_timezone_e Variable = 0;
    return Variable;
end:
    return 0;
}
...
static char* campaignsAnalytics__ToString(pinterest_rest_api_campaignsAnalytics_reporting_timezone_e ){
    char *Array[] =  { "NULL", "PINTEREST_TIME_ZONE", "AD_ACCOUNT_TIME_ZONE" };
    return Array[];
}

static pinterest_rest_api_campaignsAnalytics_reporting_timezone_e campaignsAnalytics__FromString(char* ){
    int stringToReturn = 0;
    char *Array[] =  { "NULL", "PINTEREST_TIME_ZONE", "AD_ACCOUNT_TIME_ZONE" };
    size_t sizeofArray = sizeof(Array) / sizeof(Array[0]);
    while(stringToReturn < sizeofArray) {
...
// since conversion to JSON passes through the conversion of the model, and ToString. The function is kept for future reference.
//
static cJSON *campaignsAnalytics__convertToJSON(pinterest_rest_api_campaignsAnalytics_reporting_timezone_e ) {
    cJSON *item = cJSON_CreateObject();
    return item;
    fail:
    cJSON_Delete(item);
...
// since conversion from JSON passes through the conversion of the model, and FromString. The function is kept for future reference.
//
static pinterest_rest_api_campaignsAnalytics_reporting_timezone_e campaignsAnalytics__parseFromJSON(cJSON* JSON) {
    pinterest_rest_api_campaignsAnalytics_reporting_timezone_e Variable = 0;
    return Variable;
end:
    return 0;
}
...
// Functions for enum  for CampaignsAPI_campaignsList

static char* campaignsList__ToString(pinterest_rest_api_campaignsList_order_e ){
    char *Array[] =  { "NULL", "ASCENDING", "DESCENDING" };
    return Array[];
}

static pinterest_rest_api_campaignsList_order_e campaignsList__FromString(char* ){
    int stringToReturn = 0;
    char *Array[] =  { "NULL", "ASCENDING", "DESCENDING" };
    size_t sizeofArray = sizeof(Array) / sizeof(Array[0]);
    while(stringToReturn < sizeofArray) {
...
/*
// Function campaignsList__convertToJSON is not currently used,
// since conversion to JSON passes through the conversion of the model, and ToString. The function is kept for future reference.
//
static cJSON *campaignsList__convertToJSON(pinterest_rest_api_campaignsList_order_e ) {
    cJSON *item = cJSON_CreateObject();
    return item;
    fail:
    cJSON_Delete(item);
...
// Function campaignsList__parseFromJSON is not currently used,
// since conversion from JSON passes through the conversion of the model, and FromString. The function is kept for future reference.
//
static pinterest_rest_api_campaignsList_order_e campaignsList__parseFromJSON(cJSON* JSON) {
    pinterest_rest_api_campaignsList_order_e Variable = 0;
    return Variable;
end:
    return 0;
}
...
CampaignsAPI_adPinsAnalytics(apiClient_t *apiClient, char *campaign_id, list_t *pin_ids, char start_date, char end_date, list_t *columns, granularity_e granularity, char *ad_account_id, double click_window_days, double engagement_window_days, double view_window_days, pinterest_rest_api_adPinsAnalytics_conversion_report_time_e conversion_report_time)
{
    ...
    // create the path
    char *localVarPath = strdup("/ad_accounts/{ad_account_id}/pins/analytics");
    ...
    if (granularity)
    {
        ...
        keyPairQuery_granularity = keyValuePair_create(keyQuery_granularity, strdup(adPinsAnalytics__ToString(
    ...
    if (click_window_days)
    {
        ...
        keyPairQuery_click_window_days = keyValuePair_create(keyQuery_click_window_days, strdup(adPinsAnalytics_CLICKWINDOWDAYS_ToString(
    ...
    if (engagement_window_days)
    {
        ...
        keyPairQuery_engagement_window_days = keyValuePair_create(keyQuery_engagement_window_days, strdup(adPinsAnalytics_ENGAGEMENTWINDOWDAYS_ToString(
    ...
    if (view_window_days)
    {
        ...
        keyPairQuery_view_window_days = keyValuePair_create(keyQuery_view_window_days, strdup(adPinsAnalytics_VIEWWINDOWDAYS_ToString(
    ...
    pinterest_rest_api_adPinsAnalytics_conversion_report_time_e valueQuery_conversion_report_time ;
    ...
    if (conversion_report_time)
    {
        ...
        keyPairQuery_conversion_report_time = keyValuePair_create(keyQuery_conversion_report_time, strdup(adPinsAnalytics_CONVERSIONREPORTTIME_ToString(
...
CampaignsAPI_campaignTargetingAnalyticsGet(apiClient_t *apiClient, char *ad_account_id, list_t *campaign_ids, char start_date, char end_date, list_t *targeting_types, list_t *columns, granularity_e granularity, double click_window_days, double engagement_window_days, double view_window_days, pinterest_rest_api_campaignTargetingAnalyticsGet_conversion_report_time_e conversion_report_time, list_t *attribution_types, reporting_time_zone_e reporting_timezone)
{
    ...
    // create the path
    char *localVarPath = strdup("/ad_accounts/{ad_account_id}/campaigns/targeting_analytics");
    ...
    if (granularity)
    {
        keyQuery_granularity = strdup("granularity");
        valueQuery_granularity = (granularity);
        keyPairQuery_granularity = keyValuePair_create(keyQuery_granularity, strdup(campaignTargetingAnalyticsGet__ToString(
        &valueQuery_granularity)));
        list_addElement(localVarQueryParameters,keyPairQuery_granularity);
    }
    ...
    if (click_window_days)
    {
        keyQuery_click_window_days = strdup("click_window_days");
        valueQuery_click_window_days = (click_window_days);
        keyPairQuery_click_window_days = keyValuePair_create(keyQuery_click_window_days, strdup(campaignTargetingAnalyticsGet_CLICKWINDOWDAYS_ToString(
        &valueQuery_click_window_days)));
        list_addElement(localVarQueryParameters,keyPairQuery_click_window_days);
    }
    ...
    if (engagement_window_days)
    {
        keyQuery_engagement_window_days = strdup("engagement_window_days");
        valueQuery_engagement_window_days = (engagement_window_days);
        keyPairQuery_engagement_window_days = keyValuePair_create(keyQuery_engagement_window_days, strdup(campaignTargetingAnalyticsGet_ENGAGEMENTWINDOWDAYS_ToString(
        &valueQuery_engagement_window_days)));
        list_addElement(localVarQueryParameters,keyPairQuery_engagement_window_days);
    }
    ...
    if (view_window_days)
    {
        keyQuery_view_window_days = strdup("view_window_days");
        valueQuery_view_window_days = (view_window_days);
        keyPairQuery_view_window_days = keyValuePair_create(keyQuery_view_window_days, strdup(campaignTargetingAnalyticsGet_VIEWWINDOWDAYS_ToString(
        &valueQuery_view_window_days)));
        list_addElement(localVarQueryParameters,keyPairQuery_view_window_days);
    }
    ...
    if (conversion_report_time)
    {
        keyQuery_conversion_report_time = strdup("conversion_report_time");
        valueQuery_conversion_report_time = (conversion_report_time);
        keyPairQuery_conversion_report_time = keyValuePair_create(keyQuery_conversion_report_time, strdup(campaignTargetingAnalyticsGet_CONVERSIONREPORTTIME_ToString(
        valueQuery_conversion_report_time)));
        list_addElement(localVarQueryParameters,keyPairQuery_conversion_report_time);
    }
    ...
    if (reporting_timezone)
    {
        ...
        keyPairQuery_reporting_timezone = keyValuePair_create(keyQuery_reporting_timezone, strdup(campaignTargetingAnalyticsGet__ToString(
    ...
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *CampaignsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = metrics_response_parseFromJSON(CampaignsAPIlocalVarJSON);
        cJSON_Delete(CampaignsAPIlocalVarJSON);
...
//
list_t*
CampaignsAPI_campaignsAnalytics(apiClient_t *apiClient, char start_date, char end_date, list_t *campaign_ids, list_t *columns, granularity_e granularity, char *ad_account_id, double click_window_days, double engagement_window_days, double view_window_days, pinterest_rest_api_campaignsAnalytics_conversion_report_time_e conversion_report_time, int *aggregate_report_rows, reporting_time_zone_e reporting_timezone)
{
    list_t    *localVarQueryParameters = list_createList();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
    ...
    // create the path
    char *localVarPath = strdup("/ad_accounts/{ad_account_id}/campaigns/analytics");
    ...
    if (granularity)
    {
        keyQuery_granularity = strdup("granularity");
        valueQuery_granularity = (granularity);
        keyPairQuery_granularity = keyValuePair_create(keyQuery_granularity, strdup(campaignsAnalytics__ToString(
        &valueQuery_granularity)));
        list_addElement(localVarQueryParameters,keyPairQuery_granularity);
    }
    ...
    if (click_window_days)
    {
        keyQuery_click_window_days = strdup("click_window_days");
        valueQuery_click_window_days = (click_window_days);
        keyPairQuery_click_window_days = keyValuePair_create(keyQuery_click_window_days, strdup(campaignsAnalytics_CLICKWINDOWDAYS_ToString(
        &valueQuery_click_window_days)));
        list_addElement(localVarQueryParameters,keyPairQuery_click_window_days);
    }
    ...
    if (engagement_window_days)
    {
        keyQuery_engagement_window_days = strdup("engagement_window_days");
        valueQuery_engagement_window_days = (engagement_window_days);
        keyPairQuery_engagement_window_days = keyValuePair_create(keyQuery_engagement_window_days, strdup(campaignsAnalytics_ENGAGEMENTWINDOWDAYS_ToString(
        &valueQuery_engagement_window_days)));
        list_addElement(localVarQueryParameters,keyPairQuery_engagement_window_days);
    }
    ...
    if (view_window_days)
    {
        keyQuery_view_window_days = strdup("view_window_days");
        valueQuery_view_window_days = (view_window_days);
        keyPairQuery_view_window_days = keyValuePair_create(keyQuery_view_window_days, strdup(campaignsAnalytics_VIEWWINDOWDAYS_ToString(
        &valueQuery_view_window_days)));
        list_addElement(localVarQueryParameters,keyPairQuery_view_window_days);
    }
    ...
    if (conversion_report_time)
    {
        keyQuery_conversion_report_time = strdup("conversion_report_time");
        valueQuery_conversion_report_time = (conversion_report_time);
        keyPairQuery_conversion_report_time = keyValuePair_create(keyQuery_conversion_report_time, strdup(campaignsAnalytics_CONVERSIONREPORTTIME_ToString(
        valueQuery_conversion_report_time)));
        list_addElement(localVarQueryParameters,keyPairQuery_conversion_report_time);
    }

    // query parameters
    char *keyQuery_aggregate_report_rows = NULL;
    char * valueQuery_aggregate_report_rows = NULL;
    keyValuePair_t *keyPairQuery_aggregate_report_rows = 0;
    if (aggregate_report_rows)
    {
        keyQuery_aggregate_report_rows = strdup("aggregate_report_rows");
        valueQuery_aggregate_report_rows = calloc(1,MAX_NUMBER_LENGTH);
        snprintf(valueQuery_aggregate_report_rows, MAX_NUMBER_LENGTH, "%d", *aggregate_report_rows);
        keyPairQuery_aggregate_report_rows = keyValuePair_create(keyQuery_aggregate_report_rows, valueQuery_aggregate_report_rows);
        list_addElement(localVarQueryParameters,keyPairQuery_aggregate_report_rows);
    }
    ...
    if (reporting_timezone)
    {
        keyQuery_reporting_timezone = strdup("reporting_timezone");
        valueQuery_reporting_timezone = (reporting_timezone);
        keyPairQuery_reporting_timezone = keyValuePair_create(keyQuery_reporting_timezone, strdup(campaignsAnalytics__ToString(
        &valueQuery_reporting_timezone)));
        list_addElement(localVarQueryParameters,keyPairQuery_reporting_timezone);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    ...
    if(keyQuery_aggregate_report_rows){
        free(keyQuery_aggregate_report_rows);
        keyQuery_aggregate_report_rows = NULL;
    }
    if(valueQuery_aggregate_report_rows){
        free(valueQuery_aggregate_report_rows);
        valueQuery_aggregate_report_rows = NULL;
    }
    if(keyPairQuery_aggregate_report_rows){
        keyValuePair_free(keyPairQuery_aggregate_report_rows);
        keyPairQuery_aggregate_report_rows = NULL;
    }
    if(keyQuery_reporting_timezone){
        free(keyQuery_reporting_timezone);
        keyQuery_reporting_timezone = NULL;
...
CampaignsAPI_campaignsCreate(apiClient_t *apiClient, char *ad_account_id, list_t *campaign_create_item)
{
    ...
    // create the path
    char *localVarPath = strdup("/ad_accounts/{ad_account_id}/campaigns");
    ...
    // Body Param
    //notstring
    cJSON *localVar_campaign_create_item = NULL;
    cJSON *localVarItemJSON_campaign_create_item = NULL;
    cJSON *localVarSingleItemJSON_campaign_create_item = NULL;
    if (campaign_create_item != NULL)
    {
        localVarItemJSON_campaign_create_item = cJSON_CreateObject();
        localVarSingleItemJSON_campaign_create_item = cJSON_AddArrayToObject(localVarItemJSON_campaign_create_item, "campaign_create_item");
        if (localVarSingleItemJSON_campaign_create_item == NULL)
        {
    ...
    listEntry_t *campaign_create_itemBodyListEntry;
    list_ForEach(campaign_create_itemBodyListEntry, campaign_create_item)
    {
        localVar_campaign_create_item = campaign_create_item_convertToJSON(campaign_create_itemBodyListEntry->data);
        if(localVar_campaign_create_item == NULL)
        {
            goto end;
        }
        cJSON_AddItemToArray(localVarSingleItemJSON_campaign_create_item, localVar_campaign_create_item);
        localVarBodyParameters = cJSON_Print(localVarItemJSON_campaign_create_item);
    ...
    //}
    //nonprimitive not container
    campaign_batch_write_response_model_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *CampaignsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = campaign_batch_write_response_model_parseFromJSON(CampaignsAPIlocalVarJSON);
        cJSON_Delete(CampaignsAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
    ...
    free(localVarPath);
    free(localVarToReplace_ad_account_id);
    if (localVarItemJSON_campaign_create_item) {
        cJSON_Delete(localVarItemJSON_campaign_create_item);
        localVarItemJSON_campaign_create_item = NULL;
    }
    if (localVarSingleItemJSON_campaign_create_item) {
        cJSON_Delete(localVarSingleItemJSON_campaign_create_item);
        localVarSingleItemJSON_campaign_create_item = NULL;
    }
    if (localVar_campaign_create_item) {
        cJSON_Delete(localVar_campaign_create_item);
        localVar_campaign_create_item = NULL;
    }
...
//
campaign_t*
CampaignsAPI_campaignsGet(apiClient_t *apiClient, char *campaign_id, char *ad_account_id)
{
    list_t    *localVarQueryParameters = NULL;
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
    ...
    // create the path
    char *localVarPath = strdup("/ad_accounts/{ad_account_id}/campaigns/{campaign_id}");
    ...
    // Path Params
    long sizeOfPathParams_campaign_id = strlen(campaign_id)+3 + strlen(ad_account_id)+3 + sizeof("{ campaign_id }") - 1;
    if(campaign_id == NULL) {
        goto end;
    }
    ...
    // Path Params
    long sizeOfPathParams_ad_account_id = strlen(campaign_id)+3 + strlen(ad_account_id)+3 + sizeof("{ ad_account_id }") - 1;
    if(ad_account_id == NULL) {
        goto end;
    }
    char* localVarToReplace_ad_account_id = malloc(sizeOfPathParams_ad_account_id);
    ...
    //}
    //nonprimitive not container
    campaign_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *CampaignsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = campaign_parseFromJSON(CampaignsAPIlocalVarJSON);
        cJSON_Delete(CampaignsAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
...
CampaignsAPI_campaignsList(apiClient_t *apiClient, char *ad_account_id, char *bookmark, int *page_size, pinterest_lib_pagination_order_e order, list_t *campaign_ids, list_t *entity_statuses)
{
    list_t    *localVarQueryParameters = list_createList();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
    ...
    if (order)
    {
        ...
        keyPairQuery_order = keyValuePair_create(keyQuery_order, strdup(campaignsList__ToString(
        &valueQuery_order)));
    ...
    //}
    //nonprimitive not container
    campaigns_list_200_response_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *CampaignsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = campaigns_list_200_response_parseFromJSON(CampaignsAPIlocalVarJSON);
        cJSON_Delete(CampaignsAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
...
//
campaign_batch_write_response_model_t*
CampaignsAPI_campaignsUpdate(apiClient_t *apiClient, char *ad_account_id, list_t *campaign_batch_update_item)
{
    list_t    *localVarQueryParameters = NULL;
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
    ...
    // Body Param
    //notstring
    cJSON *localVar_campaign_batch_update_item = NULL;
    cJSON *localVarItemJSON_campaign_batch_update_item = NULL;
    cJSON *localVarSingleItemJSON_campaign_batch_update_item = NULL;
    if (campaign_batch_update_item != NULL)
    {
        localVarItemJSON_campaign_batch_update_item = cJSON_CreateObject();
        localVarSingleItemJSON_campaign_batch_update_item = cJSON_AddArrayToObject(localVarItemJSON_campaign_batch_update_item, "campaign_batch_update_item");
        if (localVarSingleItemJSON_campaign_batch_update_item == NULL)
        {
            // nonprimitive container
    ...
    listEntry_t *campaign_batch_update_itemBodyListEntry;
    list_ForEach(campaign_batch_update_itemBodyListEntry, campaign_batch_update_item)
    {
        localVar_campaign_batch_update_item = campaign_batch_update_item_convertToJSON(campaign_batch_update_itemBodyListEntry->data);
        if(localVar_campaign_batch_update_item == NULL)
        {
            goto end;
        }
        cJSON_AddItemToArray(localVarSingleItemJSON_campaign_batch_update_item, localVar_campaign_batch_update_item);
        localVarBodyParameters = cJSON_Print(localVarItemJSON_campaign_batch_update_item);
        localVarBodyLength = strlen(localVarBodyParameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(localVarPath);
    free(localVarToReplace_ad_account_id);
    if (localVarItemJSON_campaign_batch_update_item) {
        cJSON_Delete(localVarItemJSON_campaign_batch_update_item);
        localVarItemJSON_campaign_batch_update_item = NULL;
    }
    if (localVarSingleItemJSON_campaign_batch_update_item) {
        cJSON_Delete(localVarSingleItemJSON_campaign_batch_update_item);
        localVarSingleItemJSON_campaign_batch_update_item = NULL;
    }
    if (localVar_campaign_batch_update_item) {
        cJSON_Delete(localVar_campaign_batch_update_item);
        localVar_campaign_batch_update_item = NULL;
    }
    free(localVarBodyParameters);
    return elementToReturn;
end:
...
CampaignsAPI_getCampaignDeliveryEstimates(apiClient_t *apiClient, char *ad_account_id, list_t *campaign_delivery_estimates_campaign)
{
    list_t    *localVarQueryParameters = NULL;
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
    ...
    // create the path
    char *localVarPath = strdup("/ad_accounts/{ad_account_id}/campaigns/delivery_estimates");
    ...
    // Body Param
    //notstring
    cJSON *localVar_campaign_delivery_estimates_campaign = NULL;
    cJSON *localVarItemJSON_campaign_delivery_estimates_campaign = NULL;
    cJSON *localVarSingleItemJSON_campaign_delivery_estimates_campaign = NULL;
    if (campaign_delivery_estimates_campaign != NULL)
    {
        localVarItemJSON_campaign_delivery_estimates_campaign = cJSON_CreateObject();
        localVarSingleItemJSON_campaign_delivery_estimates_campaign = cJSON_AddArrayToObject(localVarItemJSON_campaign_delivery_estimates_campaign, "campaign_delivery_estimates_campaign");
        if (localVarSingleItemJSON_campaign_delivery_estimates_campaign == NULL)
        {
            // nonprimitive container
    ...
    listEntry_t *campaign_delivery_estimates_campaignBodyListEntry;
    list_ForEach(campaign_delivery_estimates_campaignBodyListEntry, campaign_delivery_estimates_campaign)
    {
        localVar_campaign_delivery_estimates_campaign = campaign_delivery_estimates_campaign_convertToJSON(campaign_delivery_estimates_campaignBodyListEntry->data);
        if(localVar_campaign_delivery_estimates_campaign == NULL)
        {
            goto end;
        }
        cJSON_AddItemToArray(localVarSingleItemJSON_campaign_delivery_estimates_campaign, localVar_campaign_delivery_estimates_campaign);
        localVarBodyParameters = cJSON_Print(localVarItemJSON_campaign_delivery_estimates_campaign);
        localVarBodyLength = strlen(localVarBodyParameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //}
    //nonprimitive not container
    campaign_delivery_estimates_response_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *CampaignsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = campaign_delivery_estimates_response_parseFromJSON(CampaignsAPIlocalVarJSON);
        cJSON_Delete(CampaignsAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
    ...
    free(localVarPath);
    free(localVarToReplace_ad_account_id);
    if (localVarItemJSON_campaign_delivery_estimates_campaign) {
        cJSON_Delete(localVarItemJSON_campaign_delivery_estimates_campaign);
        localVarItemJSON_campaign_delivery_estimates_campaign = NULL;
    }
    if (localVarSingleItemJSON_campaign_delivery_estimates_campaign) {
        cJSON_Delete(localVarSingleItemJSON_campaign_delivery_estimates_campaign);
        localVarSingleItemJSON_campaign_delivery_estimates_campaign = NULL;
    }
    if (localVar_campaign_delivery_estimates_campaign) {
        cJSON_Delete(localVar_campaign_delivery_estimates_campaign);
        localVar_campaign_delivery_estimates_campaign = NULL;
    }
    free(localVarBodyParameters);
    return elementToReturn;
end:
