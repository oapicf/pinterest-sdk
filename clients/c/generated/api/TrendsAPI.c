...
// Functions for enum  for TrendsAPI_trendsEditorialArticlesList

static char* trendsEditorialArticlesList__ToString(pinterest_rest_api_trendsEditorialArticlesList_region_e ){
    char *Array[] =  { "NULL", "US", "GB+IE", "CA" };
    return Array[];
}

static pinterest_rest_api_trendsEditorialArticlesList_region_e trendsEditorialArticlesList__FromString(char* ){
...
/*
// Function trendsEditorialArticlesList__convertToJSON is not currently used,
// since conversion to JSON passes through the conversion of the model, and ToString. The function is kept for future reference.
//
static cJSON *trendsEditorialArticlesList__convertToJSON(pinterest_rest_api_trendsEditorialArticlesList_region_e ) {
...
// Function trendsEditorialArticlesList__parseFromJSON is not currently used,
// since conversion from JSON passes through the conversion of the model, and FromString. The function is kept for future reference.
//
static pinterest_rest_api_trendsEditorialArticlesList_region_e trendsEditorialArticlesList__parseFromJSON(cJSON* JSON) {
    pinterest_rest_api_trendsEditorialArticlesList_region_e Variable = 0;
    return Variable;
end:
    return 0;
}
...
// Functions for enum  for TrendsAPI_trendsFeaturedTopicsList
...
// Functions for enum PRODUCTCATEGORIES for TrendsAPI_trendsProductCategoriesDetailsList
...
// Functions for enum  for TrendsAPI_trendsProductCategoriesDetailsList
...
// Functions for enum  for TrendsAPI_trendsProductCategoriesTrendingList
...
// Functions for enum VERTICALS for TrendsAPI_trendsProductCategoriesTrendingList
...
// Functions for enum AGES for TrendsAPI_trendsProductCategoriesTrendingList
...
// Functions for enum GENDERS for TrendsAPI_trendsProductCategoriesTrendingList
...
//
list_t*
TrendsAPI_trendsEditorialArticlesList(apiClient_t *apiClient, product_category_region_e region)
{
    ...
    // create the path
    char *localVarPath = strdup("/trends/editorial_articles");
    ...
    if (region)
    {
        ...
        keyPairQuery_region = keyValuePair_create(keyQuery_region, strdup(trendsEditorialArticlesList__ToString(
        &valueQuery_region)));
    ...
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *TrendsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        if(!cJSON_IsArray(TrendsAPIlocalVarJSON)) {
            return 0;//nonprimitive container
        }
        elementToReturn = list_createList();
        cJSON *VarJSON;
        cJSON_ArrayForEach(VarJSON, TrendsAPIlocalVarJSON)
        {
        ...
        cJSON_Delete( TrendsAPIlocalVarJSON);
...
//
list_t*
TrendsAPI_trendsFeaturedTopicsList(apiClient_t *apiClient, product_category_region_e region, interests_enum_e interest)
{
    list_t    *localVarQueryParameters = list_createList();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
...
//
list_t*
TrendsAPI_trendsProductCategoriesDetailsList(apiClient_t *apiClient, list_t *product_categories, product_category_region_e region, product_category_detail_lookback_window_e lookback_window, product_categories_engagement_type_e engagement_type)
{
    list_t    *localVarQueryParameters = list_createList();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
...
//
list_t*
TrendsAPI_trendsProductCategoriesTrendingList(apiClient_t *apiClient, product_category_region_e region, list_t *verticals, list_t *ages, list_t *genders, product_categories_engagement_type_e engagement_type)
{
    list_t    *localVarQueryParameters = list_createList();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
