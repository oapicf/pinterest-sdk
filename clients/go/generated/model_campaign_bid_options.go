...
// checks if the CampaignBidOptions type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CampaignBidOptions{}
...
func (o *CampaignBidOptions) SetAppTypeMultipliersNil() {
...
func (o *CampaignBidOptions) SetPlacementMultipliersNil() {
...
func (o CampaignBidOptions) MarshalJSON() ([]byte, error) {
...
type NullableCampaignBidOptions struct {
	value *CampaignBidOptions
	isSet bool
}

func (v NullableCampaignBidOptions) Get() *CampaignBidOptions {
	return v.value
}

func (v *NullableCampaignBidOptions) Set(val *CampaignBidOptions) {
	v.value = val
	v.isSet = true
}

func (v NullableCampaignBidOptions) IsSet() bool {
	return v.isSet
}

func (v *NullableCampaignBidOptions) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCampaignBidOptions(val *CampaignBidOptions) *NullableCampaignBidOptions {
	return &NullableCampaignBidOptions{value: val, isSet: true}
}

func (v NullableCampaignBidOptions) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCampaignBidOptions) UnmarshalJSON(src []byte) error {
	v.isSet = true
