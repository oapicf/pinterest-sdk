...
// checks if the LeadSubscription type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LeadSubscription{}
...
func (o *LeadSubscription) SetCryptographicAlgorithmNil() {
...
func (o *LeadSubscription) SetCryptographicKeyNil() {
...
func (o *LeadSubscription) SetLeadFormIdNil() {
...
func (o LeadSubscription) MarshalJSON() ([]byte, error) {
...
func (o LeadSubscription) ToMap() (map[string]interface{}, error) {
...
type NullableLeadSubscription struct {
	value *LeadSubscription
	isSet bool
}

func (v NullableLeadSubscription) Get() *LeadSubscription {
	return v.value
}

func (v *NullableLeadSubscription) Set(val *LeadSubscription) {
	v.value = val
	v.isSet = true
}

func (v NullableLeadSubscription) IsSet() bool {
	return v.isSet
}

func (v *NullableLeadSubscription) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLeadSubscription(val *LeadSubscription) *NullableLeadSubscription {
	return &NullableLeadSubscription{value: val, isSet: true}
}

func (v NullableLeadSubscription) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLeadSubscription) UnmarshalJSON(src []byte) error {
	v.isSet = true
