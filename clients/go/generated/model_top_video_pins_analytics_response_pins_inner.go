...
// checks if the TopVideoPinsAnalyticsResponsePinsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TopVideoPinsAnalyticsResponsePinsInner{}
...
func NewTopVideoPinsAnalyticsResponsePinsInner() *TopVideoPinsAnalyticsResponsePinsInner {
	this := TopVideoPinsAnalyticsResponsePinsInner{}
	return &this
}
...
func (o TopVideoPinsAnalyticsResponsePinsInner) MarshalJSON() ([]byte, error) {
...
func (o TopVideoPinsAnalyticsResponsePinsInner) ToMap() (map[string]interface{}, error) {
...
type NullableTopVideoPinsAnalyticsResponsePinsInner struct {
	value *TopVideoPinsAnalyticsResponsePinsInner
	isSet bool
}

func (v NullableTopVideoPinsAnalyticsResponsePinsInner) Get() *TopVideoPinsAnalyticsResponsePinsInner {
	return v.value
}

func (v *NullableTopVideoPinsAnalyticsResponsePinsInner) Set(val *TopVideoPinsAnalyticsResponsePinsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableTopVideoPinsAnalyticsResponsePinsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableTopVideoPinsAnalyticsResponsePinsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTopVideoPinsAnalyticsResponsePinsInner(val *TopVideoPinsAnalyticsResponsePinsInner) *NullableTopVideoPinsAnalyticsResponsePinsInner {
	return &NullableTopVideoPinsAnalyticsResponsePinsInner{value: val, isSet: true}
}

func (v NullableTopVideoPinsAnalyticsResponsePinsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTopVideoPinsAnalyticsResponsePinsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
