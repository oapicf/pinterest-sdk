...
// checks if the CatalogsHotelItemsFilter type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CatalogsHotelItemsFilter{}

// CatalogsHotelItemsFilter struct for CatalogsHotelItemsFilter
...
type _CatalogsHotelItemsFilter CatalogsHotelItemsFilter
...
func (o CatalogsHotelItemsFilter) MarshalJSON() ([]byte, error) {
...
func (o CatalogsHotelItemsFilter) ToMap() (map[string]interface{}, error) {
...
func (o *CatalogsHotelItemsFilter) UnmarshalJSON(data []byte) (err error) {
	...
	varCatalogsHotelItemsFilter := _CatalogsHotelItemsFilter{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCatalogsHotelItemsFilter)

	if err != nil {
		return err
	}

	*o = CatalogsHotelItemsFilter(varCatalogsHotelItemsFilter)

	return err
}

type NullableCatalogsHotelItemsFilter struct {
	value *CatalogsHotelItemsFilter
	isSet bool
}

func (v NullableCatalogsHotelItemsFilter) Get() *CatalogsHotelItemsFilter {
	return v.value
}

func (v *NullableCatalogsHotelItemsFilter) Set(val *CatalogsHotelItemsFilter) {
	v.value = val
	v.isSet = true
}

func (v NullableCatalogsHotelItemsFilter) IsSet() bool {
	return v.isSet
}

func (v *NullableCatalogsHotelItemsFilter) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCatalogsHotelItemsFilter(val *CatalogsHotelItemsFilter) *NullableCatalogsHotelItemsFilter {
	return &NullableCatalogsHotelItemsFilter{value: val, isSet: true}
}

func (v NullableCatalogsHotelItemsFilter) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCatalogsHotelItemsFilter) UnmarshalJSON(src []byte) error {
	v.isSet = true
