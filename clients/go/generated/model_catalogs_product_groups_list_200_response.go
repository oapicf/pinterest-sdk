...
// checks if the CatalogsProductGroupsList200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CatalogsProductGroupsList200Response{}
...
type _CatalogsProductGroupsList200Response CatalogsProductGroupsList200Response
...
func (o *CatalogsProductGroupsList200Response) SetBookmarkNil() {
	o.Bookmark.Set(nil)
}
...
func (o CatalogsProductGroupsList200Response) MarshalJSON() ([]byte, error) {
...
func (o CatalogsProductGroupsList200Response) ToMap() (map[string]interface{}, error) {
...
func (o *CatalogsProductGroupsList200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varCatalogsProductGroupsList200Response := _CatalogsProductGroupsList200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCatalogsProductGroupsList200Response)

	if err != nil {
		return err
	}

	*o = CatalogsProductGroupsList200Response(varCatalogsProductGroupsList200Response)

	return err
}

type NullableCatalogsProductGroupsList200Response struct {
	value *CatalogsProductGroupsList200Response
	isSet bool
}

func (v NullableCatalogsProductGroupsList200Response) Get() *CatalogsProductGroupsList200Response {
	return v.value
}

func (v *NullableCatalogsProductGroupsList200Response) Set(val *CatalogsProductGroupsList200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableCatalogsProductGroupsList200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableCatalogsProductGroupsList200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCatalogsProductGroupsList200Response(val *CatalogsProductGroupsList200Response) *NullableCatalogsProductGroupsList200Response {
	return &NullableCatalogsProductGroupsList200Response{value: val, isSet: true}
}

func (v NullableCatalogsProductGroupsList200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCatalogsProductGroupsList200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
