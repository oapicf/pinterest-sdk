...
// checks if the CampaignCreateCommon type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CampaignCreateCommon{}

// CampaignCreateCommon struct for CampaignCreateCommon
...
func (o *CampaignCreateCommon) SetLifetimeSpendCapNil() {
...
func (o *CampaignCreateCommon) SetDailySpendCapNil() {
...
func (o *CampaignCreateCommon) SetOrderLineIdNil() {
...
func (o *CampaignCreateCommon) SetTrackingUrlsNil() {
...
func (o *CampaignCreateCommon) SetStartTimeNil() {
	o.StartTime.Set(nil)
}
...
func (o *CampaignCreateCommon) SetEndTimeNil() {
	o.EndTime.Set(nil)
}
...
func (o *CampaignCreateCommon) SetDefaultAdGroupBudgetInMicroCurrencyNil() {
...
func (o CampaignCreateCommon) MarshalJSON() ([]byte, error) {
...
func (o CampaignCreateCommon) ToMap() (map[string]interface{}, error) {
...
type NullableCampaignCreateCommon struct {
	value *CampaignCreateCommon
	isSet bool
}

func (v NullableCampaignCreateCommon) Get() *CampaignCreateCommon {
	return v.value
}

func (v *NullableCampaignCreateCommon) Set(val *CampaignCreateCommon) {
	v.value = val
	v.isSet = true
}

func (v NullableCampaignCreateCommon) IsSet() bool {
	return v.isSet
}

func (v *NullableCampaignCreateCommon) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCampaignCreateCommon(val *CampaignCreateCommon) *NullableCampaignCreateCommon {
	return &NullableCampaignCreateCommon{value: val, isSet: true}
}

func (v NullableCampaignCreateCommon) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCampaignCreateCommon) UnmarshalJSON(src []byte) error {
	v.isSet = true
