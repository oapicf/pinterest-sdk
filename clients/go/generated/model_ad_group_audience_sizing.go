...
// checks if the AdGroupAudienceSizing type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AdGroupAudienceSizing{}

// AdGroupAudienceSizing struct for AdGroupAudienceSizing
...
func (o AdGroupAudienceSizing) MarshalJSON() ([]byte, error) {
...
func (o AdGroupAudienceSizing) ToMap() (map[string]interface{}, error) {
...
type NullableAdGroupAudienceSizing struct {
	value *AdGroupAudienceSizing
	isSet bool
}

func (v NullableAdGroupAudienceSizing) Get() *AdGroupAudienceSizing {
	return v.value
}

func (v *NullableAdGroupAudienceSizing) Set(val *AdGroupAudienceSizing) {
	v.value = val
	v.isSet = true
}

func (v NullableAdGroupAudienceSizing) IsSet() bool {
	return v.isSet
}

func (v *NullableAdGroupAudienceSizing) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAdGroupAudienceSizing(val *AdGroupAudienceSizing) *NullableAdGroupAudienceSizing {
	return &NullableAdGroupAudienceSizing{value: val, isSet: true}
}

func (v NullableAdGroupAudienceSizing) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAdGroupAudienceSizing) UnmarshalJSON(src []byte) error {
	v.isSet = true
