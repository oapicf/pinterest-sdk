...
// checks if the CatalogsProductGroup type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CatalogsProductGroup{}
...
type _CatalogsProductGroup CatalogsProductGroup
...
func (o CatalogsProductGroup) ToMap() (map[string]interface{}, error) {
...
func (o *CatalogsProductGroup) UnmarshalJSON(data []byte) (err error) {
	...
	varCatalogsProductGroup := _CatalogsProductGroup{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCatalogsProductGroup)

	if err != nil {
		return err
	}

	*o = CatalogsProductGroup(varCatalogsProductGroup)
