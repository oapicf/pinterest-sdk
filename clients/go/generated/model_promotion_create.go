...
// checks if the PromotionCreate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PromotionCreate{}
...
type _PromotionCreate PromotionCreate
...
func (o PromotionCreate) MarshalJSON() ([]byte, error) {
...
func (o PromotionCreate) ToMap() (map[string]interface{}, error) {
...
func (o *PromotionCreate) UnmarshalJSON(data []byte) (err error) {
	...
	varPromotionCreate := _PromotionCreate{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPromotionCreate)

	if err != nil {
		return err
	}

	*o = PromotionCreate(varPromotionCreate)

	return err
}

type NullablePromotionCreate struct {
	value *PromotionCreate
	isSet bool
}

func (v NullablePromotionCreate) Get() *PromotionCreate {
	return v.value
}

func (v *NullablePromotionCreate) Set(val *PromotionCreate) {
	v.value = val
	v.isSet = true
}

func (v NullablePromotionCreate) IsSet() bool {
	return v.isSet
}

func (v *NullablePromotionCreate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePromotionCreate(val *PromotionCreate) *NullablePromotionCreate {
	return &NullablePromotionCreate{value: val, isSet: true}
}

func (v NullablePromotionCreate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePromotionCreate) UnmarshalJSON(src []byte) error {
	v.isSet = true
