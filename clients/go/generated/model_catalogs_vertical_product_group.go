...
func (dst *CatalogsVerticalProductGroup) UnmarshalJSON(data []byte) error {
	...
	if match > 1 { // more than 1 match
        ...
        if err != nil {
            return fmt.Errorf("data failed to match schemas in oneOf(CatalogsVerticalProductGroup): %v", err)
        } else {
...
func (obj CatalogsVerticalProductGroup) GetActualInstanceValue() (interface{}) {
	if obj.CatalogsCreativeAssetsProductGroup != nil {
		return *obj.CatalogsCreativeAssetsProductGroup
	}
