...
func Test_openapi_BillingAPIService(t *testing.T) {
	...
	t.Run("Test BillingAPIService BillingInvoiceDownloadGet", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var adAccountId string
		var billingInvoiceId string

		resp, httpRes, err := apiClient.BillingAPI.BillingInvoiceDownloadGet(context.Background(), adAccountId, billingInvoiceId).Execute()
	...
	t.Run("Test BillingAPIService BillingInvoicesGet", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.BillingAPI.BillingInvoicesGet(context.Background(), adAccountId).Execute()
