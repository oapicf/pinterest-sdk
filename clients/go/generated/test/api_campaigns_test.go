...
func Test_openapi_CampaignsAPIService(t *testing.T) {
	...
	t.Run("Test CampaignsAPIService AdPinsAnalytics", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var adAccountId string

		resp, httpRes, err := apiClient.CampaignsAPI.AdPinsAnalytics(context.Background(), adAccountId).Execute()
