...
// checks if the AdGroupUpdate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AdGroupUpdate{}

// AdGroupUpdate struct for AdGroupUpdate
...
type _AdGroupUpdate AdGroupUpdate
...
func (o *AdGroupUpdate) SetBidInMicroCurrencyNil() {
...
func (o *AdGroupUpdate) SetBidStrategyTypeNil() {
...
func (o *AdGroupUpdate) SetBudgetInMicroCurrencyNil() {
...
func (o *AdGroupUpdate) SetEndTimeNil() {
	o.EndTime.Set(nil)
}
...
func (o *AdGroupUpdate) SetExtFeaturesNil() {
...
func (o *AdGroupUpdate) SetIsCreativeOptimizationNil() {
...
func (o *AdGroupUpdate) SetOptimizationGoalMetadataNil() {
...
func (o *AdGroupUpdate) SetPerformancePlusCampaignSettingsNil() {
...
func (o *AdGroupUpdate) SetPlacementTrafficTypeNil() {
...
func (o *AdGroupUpdate) SetPromotionApplicationLevelNil() {
...
func (o *AdGroupUpdate) SetPromotionIdNil() {
...
func (o *AdGroupUpdate) SetStartTimeNil() {
	o.StartTime.Set(nil)
}
...
func (o *AdGroupUpdate) SetTrackingUrlsNil() {
...
func (o *AdGroupUpdate) SetAutoTargetingEnabledNil() {
...
func (o AdGroupUpdate) MarshalJSON() ([]byte, error) {
...
func (o AdGroupUpdate) ToMap() (map[string]interface{}, error) {
...
func (o *AdGroupUpdate) UnmarshalJSON(data []byte) (err error) {
	...
	varAdGroupUpdate := _AdGroupUpdate{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAdGroupUpdate)

	if err != nil {
		return err
	}

	*o = AdGroupUpdate(varAdGroupUpdate)

	return err
}

type NullableAdGroupUpdate struct {
	value *AdGroupUpdate
	isSet bool
}

func (v NullableAdGroupUpdate) Get() *AdGroupUpdate {
	return v.value
}

func (v *NullableAdGroupUpdate) Set(val *AdGroupUpdate) {
	v.value = val
	v.isSet = true
}

func (v NullableAdGroupUpdate) IsSet() bool {
	return v.isSet
}

func (v *NullableAdGroupUpdate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAdGroupUpdate(val *AdGroupUpdate) *NullableAdGroupUpdate {
	return &NullableAdGroupUpdate{value: val, isSet: true}
}

func (v NullableAdGroupUpdate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAdGroupUpdate) UnmarshalJSON(src []byte) error {
	v.isSet = true
