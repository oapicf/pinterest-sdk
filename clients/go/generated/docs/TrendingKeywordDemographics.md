...
### NewTrendingKeywordDemographics
...
### NewTrendingKeywordDemographicsWithDefaults
...
### SetAgeDistributionNil

`func (o *TrendingKeywordDemographics) SetAgeDistributionNil(b bool)`

 SetAgeDistributionNil sets the value for AgeDistribution to be an explicit nil

### UnsetAgeDistribution
...
### SetGenderDistributionNil

`func (o *TrendingKeywordDemographics) SetGenderDistributionNil(b bool)`

 SetGenderDistributionNil sets the value for GenderDistribution to be an explicit nil

### UnsetGenderDistribution
