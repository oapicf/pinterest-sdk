...
**CreatedByBusiness** | Pointer to **map[string]interface{}** | Metadata for the business that created the invite/request. | [optional] 
**CreatedByUser** | Pointer to **map[string]interface{}** | Metadata for the user that created the invite/request. | [optional] 
