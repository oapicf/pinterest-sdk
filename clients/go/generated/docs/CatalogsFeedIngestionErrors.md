...
**FETCH_GOOGLE_SHEET_NOT_SHARED** | Pointer to **int32** | Update your Google Sheets sharing settings to &#39;Anyone with link&#39; as a Viewer so that Pinterest can access your file. | [optional] 
...
### GetFETCH_GOOGLE_SHEET_NOT_SHARED

`func (o *CatalogsFeedIngestionErrors) GetFETCH_GOOGLE_SHEET_NOT_SHARED() int32`

GetFETCH_GOOGLE_SHEET_NOT_SHARED returns the FETCH_GOOGLE_SHEET_NOT_SHARED field if non-nil, zero value otherwise.

### GetFETCH_GOOGLE_SHEET_NOT_SHAREDOk

`func (o *CatalogsFeedIngestionErrors) GetFETCH_GOOGLE_SHEET_NOT_SHAREDOk() (*int32, bool)`

GetFETCH_GOOGLE_SHEET_NOT_SHAREDOk returns a tuple with the FETCH_GOOGLE_SHEET_NOT_SHARED field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetFETCH_GOOGLE_SHEET_NOT_SHARED

`func (o *CatalogsFeedIngestionErrors) SetFETCH_GOOGLE_SHEET_NOT_SHARED(v int32)`

SetFETCH_GOOGLE_SHEET_NOT_SHARED sets FETCH_GOOGLE_SHEET_NOT_SHARED field to given value.

### HasFETCH_GOOGLE_SHEET_NOT_SHARED
