...
func main() {
	...
	resp, r, err := apiClient.ProductCategoriesAPI.TrendsFeaturedTopicsList(context.Background()).Region(region).Interest(interest).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `ProductCategoriesAPI.TrendsFeaturedTopicsList``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `TrendsFeaturedTopicsList`: []FeaturedTrend
	fmt.Fprintf(os.Stdout, "Response from `ProductCategoriesAPI.TrendsFeaturedTopicsList`: %v\n", resp)
}
```
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.ProductCategoriesAPI.TrendsProductCategoriesDetailsList(context.Background()).ProductCategories(productCategories).Region(region).LookbackWindow(lookbackWindow).EngagementType(engagementType).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `ProductCategoriesAPI.TrendsProductCategoriesDetailsList``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `TrendsProductCategoriesDetailsList`: []ProductCategoryDetails
	fmt.Fprintf(os.Stdout, "Response from `ProductCategoriesAPI.TrendsProductCategoriesDetailsList`: %v\n", resp)
}
```
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.ProductCategoriesAPI.TrendsProductCategoriesTrendingList(context.Background()).Region(region).Verticals(verticals).Ages(ages).Genders(genders).EngagementType(engagementType).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `ProductCategoriesAPI.TrendsProductCategoriesTrendingList``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `TrendsProductCategoriesTrendingList`: []TrendingProductCategory
	fmt.Fprintf(os.Stdout, "Response from `ProductCategoriesAPI.TrendsProductCategoriesTrendingList`: %v\n", resp)
}
```
