...
### NewScrollupGoalMetadata

`func NewScrollupGoalMetadata() *ScrollupGoalMetadata`

NewScrollupGoalMetadata instantiates a new ScrollupGoalMetadata object
This constructor will assign default values to properties that have it defined,
and makes sure properties required by API are set, but the set of arguments
will change when the set of required properties is changed

### NewScrollupGoalMetadataWithDefaults

`func NewScrollupGoalMetadataWithDefaults() *ScrollupGoalMetadata`

NewScrollupGoalMetadataWithDefaults instantiates a new ScrollupGoalMetadata object
This constructor will only assign default values to properties that have it defined,
but it doesn't guarantee that properties required by API are set

### GetScrollupGoalValueInMicroCurrency

`func (o *ScrollupGoalMetadata) GetScrollupGoalValueInMicroCurrency() string`
...
`func (o *ScrollupGoalMetadata) GetScrollupGoalValueInMicroCurrencyOk() (*string, bool)`
...
`func (o *ScrollupGoalMetadata) SetScrollupGoalValueInMicroCurrency(v string)`
...
`func (o *ScrollupGoalMetadata) HasScrollupGoalValueInMicroCurrency() bool`

HasScrollupGoalValueInMicroCurrency returns a boolean if a field has been set.

### SetScrollupGoalValueInMicroCurrencyNil

`func (o *ScrollupGoalMetadata) SetScrollupGoalValueInMicroCurrencyNil(b bool)`
...
`func (o *ScrollupGoalMetadata) UnsetScrollupGoalValueInMicroCurrency()`
