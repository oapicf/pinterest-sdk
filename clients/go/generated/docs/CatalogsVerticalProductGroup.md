...
`func NewCatalogsVerticalProductGroup(catalogId string, catalogType string, feedId NullableString, filters CatalogsCreativeAssetsProductGroupFilters, id string, type_ CatalogsHotelProductGroupType, ) *CatalogsVerticalProductGroup`
...
`func (o *CatalogsVerticalProductGroup) GetType() CatalogsHotelProductGroupType`

GetType returns the Type field if non-nil, zero value otherwise.

### GetTypeOk

`func (o *CatalogsVerticalProductGroup) GetTypeOk() (*CatalogsHotelProductGroupType, bool)`
...
`func (o *CatalogsVerticalProductGroup) SetType(v CatalogsHotelProductGroupType)`
