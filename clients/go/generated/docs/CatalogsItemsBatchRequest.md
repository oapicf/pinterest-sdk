...
`func NewCatalogsItemsBatchRequest(country Country, language string, operation BatchOperation, items []ItemDeleteBatchRecord, ) *CatalogsItemsBatchRequest`
...
`func (o *CatalogsItemsBatchRequest) GetLanguage() string`

GetLanguage returns the Language field if non-nil, zero value otherwise.

### GetLanguageOk

`func (o *CatalogsItemsBatchRequest) GetLanguageOk() (*string, bool)`
...
`func (o *CatalogsItemsBatchRequest) SetLanguage(v string)`
