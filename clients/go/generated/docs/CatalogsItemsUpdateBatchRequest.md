...
`func NewCatalogsItemsUpdateBatchRequest(country Country, language string, operation BatchOperation, items []ItemUpdateBatchRecord, ) *CatalogsItemsUpdateBatchRequest`
