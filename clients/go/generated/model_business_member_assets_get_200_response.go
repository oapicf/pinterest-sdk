...
// checks if the BusinessMemberAssetsGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BusinessMemberAssetsGet200Response{}
...
func (o *BusinessMemberAssetsGet200Response) SetBookmarkNil() {
	o.Bookmark.Set(nil)
}
...
func (o *BusinessMemberAssetsGet200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varBusinessMemberAssetsGet200Response := _BusinessMemberAssetsGet200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBusinessMemberAssetsGet200Response)

	if err != nil {
		return err
	}

	*o = BusinessMemberAssetsGet200Response(varBusinessMemberAssetsGet200Response)

	return err
}

type NullableBusinessMemberAssetsGet200Response struct {
	value *BusinessMemberAssetsGet200Response
	isSet bool
}

func (v NullableBusinessMemberAssetsGet200Response) Get() *BusinessMemberAssetsGet200Response {
	return v.value
}

func (v *NullableBusinessMemberAssetsGet200Response) Set(val *BusinessMemberAssetsGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableBusinessMemberAssetsGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableBusinessMemberAssetsGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBusinessMemberAssetsGet200Response(val *BusinessMemberAssetsGet200Response) *NullableBusinessMemberAssetsGet200Response {
	return &NullableBusinessMemberAssetsGet200Response{value: val, isSet: true}
}

func (v NullableBusinessMemberAssetsGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBusinessMemberAssetsGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
