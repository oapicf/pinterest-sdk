...
// checks if the InviteDataResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InviteDataResponse{}
...
func (o InviteDataResponse) MarshalJSON() ([]byte, error) {
...
func (o InviteDataResponse) ToMap() (map[string]interface{}, error) {
...
type NullableInviteDataResponse struct {
	value *InviteDataResponse
	isSet bool
}

func (v NullableInviteDataResponse) Get() *InviteDataResponse {
	return v.value
}

func (v *NullableInviteDataResponse) Set(val *InviteDataResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableInviteDataResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableInviteDataResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInviteDataResponse(val *InviteDataResponse) *NullableInviteDataResponse {
	return &NullableInviteDataResponse{value: val, isSet: true}
}

func (v NullableInviteDataResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInviteDataResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
