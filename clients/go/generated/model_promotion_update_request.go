...
// checks if the PromotionUpdateRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PromotionUpdateRequest{}

// PromotionUpdateRequest struct for PromotionUpdateRequest
...
type _PromotionUpdateRequest PromotionUpdateRequest
...
func (o PromotionUpdateRequest) MarshalJSON() ([]byte, error) {
...
func (o PromotionUpdateRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PromotionUpdateRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPromotionUpdateRequest := _PromotionUpdateRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPromotionUpdateRequest)

	if err != nil {
		return err
	}

	*o = PromotionUpdateRequest(varPromotionUpdateRequest)

	return err
}

type NullablePromotionUpdateRequest struct {
	value *PromotionUpdateRequest
	isSet bool
}

func (v NullablePromotionUpdateRequest) Get() *PromotionUpdateRequest {
	return v.value
}

func (v *NullablePromotionUpdateRequest) Set(val *PromotionUpdateRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePromotionUpdateRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePromotionUpdateRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePromotionUpdateRequest(val *PromotionUpdateRequest) *NullablePromotionUpdateRequest {
	return &NullablePromotionUpdateRequest{value: val, isSet: true}
}

func (v NullablePromotionUpdateRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePromotionUpdateRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
