...
func (o *MediaUploadAllOfUploadParameters) GetXAmzSecurityToken() string {
	if o == nil || o.XAmzSecurityToken == nil {
		var ret string
		return ret
	}
