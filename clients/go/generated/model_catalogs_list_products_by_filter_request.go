...
func (dst *CatalogsListProductsByFilterRequest) UnmarshalJSON(data []byte) error {
	...
	if match > 1 { // more than 1 match
        ...
        if err != nil {
            return fmt.Errorf("data failed to match schemas in oneOf(CatalogsListProductsByFilterRequest): %v", err)
        } else {
...
func (obj CatalogsListProductsByFilterRequest) GetActualInstanceValue() (interface{}) {
	if obj.CatalogsListProductsByFeedBasedFilter != nil {
		return *obj.CatalogsListProductsByFeedBasedFilter
	}
