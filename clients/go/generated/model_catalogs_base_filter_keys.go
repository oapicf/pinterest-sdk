...
func (dst *CatalogsBaseFilterKeys) UnmarshalJSON(data []byte) error {
	var err error
	...
	// try to unmarshal JSON data into PinterestProductCategoriesFilter
	err = json.Unmarshal(data, &dst.PinterestProductCategoriesFilter);
	if err == nil {
		jsonPinterestProductCategoriesFilter, _ := json.Marshal(dst.PinterestProductCategoriesFilter)
		if string(jsonPinterestProductCategoriesFilter) == "{}" { // empty struct
			dst.PinterestProductCategoriesFilter = nil
		} else {
			return nil // data stored in dst.PinterestProductCategoriesFilter, return on the first match
		}
	} else {
		dst.PinterestProductCategoriesFilter = nil
	}
	...
	return fmt.Errorf("data failed to match schemas in anyOf(CatalogsBaseFilterKeys)")
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src CatalogsBaseFilterKeys) MarshalJSON() ([]byte, error) {
	...
	if src.PinterestProductCategoriesFilter != nil {
		return json.Marshal(&src.PinterestProductCategoriesFilter)
	}
...
type NullableCatalogsBaseFilterKeys struct {
	value *CatalogsBaseFilterKeys
	isSet bool
}

func (v NullableCatalogsBaseFilterKeys) Get() *CatalogsBaseFilterKeys {
	return v.value
}

func (v *NullableCatalogsBaseFilterKeys) Set(val *CatalogsBaseFilterKeys) {
	v.value = val
	v.isSet = true
}

func (v NullableCatalogsBaseFilterKeys) IsSet() bool {
	return v.isSet
}

func (v *NullableCatalogsBaseFilterKeys) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCatalogsBaseFilterKeys(val *CatalogsBaseFilterKeys) *NullableCatalogsBaseFilterKeys {
	return &NullableCatalogsBaseFilterKeys{value: val, isSet: true}
}

func (v NullableCatalogsBaseFilterKeys) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCatalogsBaseFilterKeys) UnmarshalJSON(src []byte) error {
	v.isSet = true
