...
// checks if the AdGroupCommonTrackingUrls type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AdGroupCommonTrackingUrls{}
...
func NewAdGroupCommonTrackingUrls() *AdGroupCommonTrackingUrls {
	this := AdGroupCommonTrackingUrls{}
	return &this
}
...
func (o AdGroupCommonTrackingUrls) MarshalJSON() ([]byte, error) {
...
func (o AdGroupCommonTrackingUrls) ToMap() (map[string]interface{}, error) {
...
type NullableAdGroupCommonTrackingUrls struct {
	value *AdGroupCommonTrackingUrls
	isSet bool
}

func (v NullableAdGroupCommonTrackingUrls) Get() *AdGroupCommonTrackingUrls {
	return v.value
}

func (v *NullableAdGroupCommonTrackingUrls) Set(val *AdGroupCommonTrackingUrls) {
	v.value = val
	v.isSet = true
}

func (v NullableAdGroupCommonTrackingUrls) IsSet() bool {
	return v.isSet
}

func (v *NullableAdGroupCommonTrackingUrls) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAdGroupCommonTrackingUrls(val *AdGroupCommonTrackingUrls) *NullableAdGroupCommonTrackingUrls {
	return &NullableAdGroupCommonTrackingUrls{value: val, isSet: true}
}

func (v NullableAdGroupCommonTrackingUrls) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAdGroupCommonTrackingUrls) UnmarshalJSON(src []byte) error {
	v.isSet = true
