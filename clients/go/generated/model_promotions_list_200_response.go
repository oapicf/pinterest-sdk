...
// checks if the PromotionsList200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PromotionsList200Response{}
...
func (o *PromotionsList200Response) SetBookmarkNil() {
	o.Bookmark.Set(nil)
}
...
func (o PromotionsList200Response) MarshalJSON() ([]byte, error) {
...
func (o PromotionsList200Response) ToMap() (map[string]interface{}, error) {
...
func (o *PromotionsList200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varPromotionsList200Response := _PromotionsList200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPromotionsList200Response)

	if err != nil {
		return err
	}

	*o = PromotionsList200Response(varPromotionsList200Response)

	return err
}

type NullablePromotionsList200Response struct {
	value *PromotionsList200Response
	isSet bool
}

func (v NullablePromotionsList200Response) Get() *PromotionsList200Response {
	return v.value
}

func (v *NullablePromotionsList200Response) Set(val *PromotionsList200Response) {
	v.value = val
	v.isSet = true
}

func (v NullablePromotionsList200Response) IsSet() bool {
	return v.isSet
}

func (v *NullablePromotionsList200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePromotionsList200Response(val *PromotionsList200Response) *NullablePromotionsList200Response {
	return &NullablePromotionsList200Response{value: val, isSet: true}
}

func (v NullablePromotionsList200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePromotionsList200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
