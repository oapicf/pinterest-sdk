...
// checks if the BillingInvoicesGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BillingInvoicesGet200Response{}
...
func (o *BillingInvoicesGet200Response) SetBookmarkNil() {
	o.Bookmark.Set(nil)
}
...
func (o BillingInvoicesGet200Response) MarshalJSON() ([]byte, error) {
...
func (o BillingInvoicesGet200Response) ToMap() (map[string]interface{}, error) {
...
func (o *BillingInvoicesGet200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varBillingInvoicesGet200Response := _BillingInvoicesGet200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBillingInvoicesGet200Response)

	if err != nil {
		return err
	}

	*o = BillingInvoicesGet200Response(varBillingInvoicesGet200Response)

	return err
}

type NullableBillingInvoicesGet200Response struct {
	value *BillingInvoicesGet200Response
	isSet bool
}

func (v NullableBillingInvoicesGet200Response) Get() *BillingInvoicesGet200Response {
	return v.value
}

func (v *NullableBillingInvoicesGet200Response) Set(val *BillingInvoicesGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableBillingInvoicesGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableBillingInvoicesGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBillingInvoicesGet200Response(val *BillingInvoicesGet200Response) *NullableBillingInvoicesGet200Response {
	return &NullableBillingInvoicesGet200Response{value: val, isSet: true}
}

func (v NullableBillingInvoicesGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBillingInvoicesGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
