...
#include "AdGroupCreateRequest_allOfTest.cpp"

#include "AdGroupResponseTest.cpp"

#include "AdGroupResponse_allOfTest.cpp"

#include "AdGroupSummaryStatusTest.cpp"

#include "AdGroupUpdateRequestTest.cpp"

#include "AdGroupUpdateRequest_allOfTest.cpp"
...
#include "AdResponse_allOfTest.cpp"

#include "AdUpdateRequestTest.cpp"

#include "AdUpdateRequest_1Test.cpp"

#include "Ad_account_ownerTest.cpp"

#include "Ad_accounts_list_200_responseTest.cpp"

#include "Ad_accounts_list_200_response_allOfTest.cpp"

#include "Ad_groups_list_200_responseTest.cpp"

#include "Ad_groups_list_200_response_allOfTest.cpp"

#include "AdsAnalyticsCreateAsyncRequestTest.cpp"

#include "AdsAnalyticsCreateAsyncRequest_allOfTest.cpp"

#include "AdsAnalyticsCreateAsyncRequest_allOf_1Test.cpp"
...
#include "Ads_list_200_response_allOfTest.cpp"

#include "AnalyticsMetricsResponseTest.cpp"

#include "AnalyticsMetricsResponse_daily_metrics_innerTest.cpp"
...
#include "AudienceCreateRequest_1Test.cpp"
...
#include "AudienceUpdateRequest_1Test.cpp"

#include "Audiences_list_200_responseTest.cpp"

#include "Audiences_list_200_response_allOfTest.cpp"
...
#include "Board_sections_list_200_response_allOfTest.cpp"

#include "Board_sections_list_pins_200_responseTest.cpp"

#include "Board_sections_list_pins_200_response_allOfTest.cpp"

#include "Boards_list_200_responseTest.cpp"

#include "Boards_list_200_response_allOfTest.cpp"
...
#include "CampaignCreateCommon_allOfTest.cpp"

#include "CampaignCreateRequestTest.cpp"

#include "CampaignCreateRequest_allOfTest.cpp"

#include "CampaignCreateResponseTest.cpp"

#include "CampaignCreateResponseDataTest.cpp"

#include "CampaignCreateResponseData_allOfTest.cpp"
...
#include "CampaignResponse_allOfTest.cpp"

#include "CampaignSummaryStatusTest.cpp"

#include "CampaignUpdateRequestTest.cpp"

#include "CampaignUpdateRequest_allOfTest.cpp"
...
#include "Campaigns_list_200_response_allOfTest.cpp"
...
#include "CatalogsProductGroupFiltersAllOfRequestTest.cpp"

#include "CatalogsProductGroupFiltersAllOfRequest_anyOfTest.cpp"

#include "CatalogsProductGroupFiltersAllOfRequest_anyOf_1Test.cpp"
...
#include "Catalogs_feed_processing_result_fieldsTest.cpp"

#include "Catalogs_product_group_feed_based_caseTest.cpp"

#include "Catalogs_product_group_merchant_based_caseTest.cpp"

#include "Catalogs_product_groups_list_200_responseTest.cpp"

#include "Catalogs_product_groups_list_200_response_allOfTest.cpp"
...
#include "Customer_lists_list_200_response_allOfTest.cpp"
...
#include "Feed_fieldsTest.cpp"

#include "Feed_processing_results_list_200_responseTest.cpp"

#include "Feed_processing_results_list_200_response_allOfTest.cpp"

#include "Feeds_list_200_responseTest.cpp"

#include "Feeds_list_200_response_allOfTest.cpp"
...
#include "ItemAttributes_allOfTest.cpp"
...
#include "Items_issues_list_200_response_allOfTest.cpp"
...
#include "Keywords_get_200_response_allOfTest.cpp"
...
#include "OauthAccessTokenRequestRefresh_allOfTest.cpp"

#include "OauthAccessTokenResponseTest.cpp"

#include "OauthAccessTokenResponseCodeTest.cpp"

#include "OauthAccessTokenResponseCode_allOfTest.cpp"
...
#include "PinMediaWithImageAndVideo_allOfTest.cpp"

#include "PinMediaWithImage_allOfTest.cpp"

#include "PinMediaWithImagesTest.cpp"

#include "PinMediaWithImages_allOfTest.cpp"

#include "PinMediaWithVideoTest.cpp"

#include "PinMediaWithVideo_allOfTest.cpp"

#include "PinMediaWithVideosTest.cpp"

#include "PinMediaWithVideos_allOfTest.cpp"

#include "PinPromotionSummaryStatusTest.cpp"

#include "Pin_mediaTest.cpp"

#include "Pin_media_sourceTest.cpp"
...
#include "ProductGroupPromotionArrayElementTest.cpp"

#include "ProductGroupPromotionCommonTest.cpp"

#include "ProductGroupPromotionCreateRequestTest.cpp"

#include "ProductGroupPromotionUpdateItemTest.cpp"

#include "ProductGroupPromotionUpdateRequestTest.cpp"

#include "ProductGroupPromotionUpdateResponseItemTest.cpp"
...
#include "Product_groups_create_request_feed_base_caseTest.cpp"

#include "Products_by_product_group_filter_list_200_responseTest.cpp"

#include "Products_by_product_group_filter_list_200_response_allOfTest.cpp"
...
#include "TargetingSpec_1Test.cpp"

#include "TargetingSpec_SHOPPING_RETARGETINGTest.cpp"

#include "TargetingSpec_SHOPPING_RETARGETING_1_innerTest.cpp"
...
void runTests(){
    ...
    RUN_TEST(test_AdCommon_pin_id_is_assigned_from_json);
    ...
    RUN_TEST(test_AdGroupResponse_allOf_id_is_assigned_from_json);
    
    
    RUN_TEST(test_AdGroupResponse_allOf_ad_account_id_is_assigned_from_json);
    
    
    RUN_TEST(test_AdGroupResponse_allOf_created_time_is_assigned_from_json);
    
    
    RUN_TEST(test_AdGroupResponse_allOf_updated_time_is_assigned_from_json);
    
    
    RUN_TEST(test_AdGroupResponse_allOf_type_is_assigned_from_json);
    
    
    RUN_TEST(test_AdGroupResponse_allOf_conversion_learning_mode_type_is_assigned_from_json);
    
    
    
    RUN_TEST(test_AdGroupResponse_allOf_feed_profile_id_is_assigned_from_json);
    ...
    RUN_TEST(test_AdGroupUpdateRequest_allOf_id_is_assigned_from_json);
    ...
    RUN_TEST(test_AdResponse_allOf_ad_account_id_is_assigned_from_json);
    
    
    RUN_TEST(test_AdResponse_allOf_campaign_id_is_assigned_from_json);
    
    
    RUN_TEST(test_AdResponse_allOf_collection_items_destination_url_template_is_assigned_from_json);
    
    
    RUN_TEST(test_AdResponse_allOf_created_time_is_assigned_from_json);
    
    
    RUN_TEST(test_AdResponse_allOf_id_is_assigned_from_json);
    
    
    
    
    RUN_TEST(test_AdResponse_allOf_review_status_is_assigned_from_json);
    
    
    RUN_TEST(test_AdResponse_allOf_type_is_assigned_from_json);
    
    
    RUN_TEST(test_AdResponse_allOf_updated_time_is_assigned_from_json);
    ...
    RUN_TEST(test_AdUpdateRequest_1_id_is_assigned_from_json);
    ...
    RUN_TEST(test_AdsAnalyticsCreateAsyncRequest_allOf_start_date_is_assigned_from_json);
    
    
    RUN_TEST(test_AdsAnalyticsCreateAsyncRequest_allOf_end_date_is_assigned_from_json);
    ...
    RUN_TEST(test_AdsAnalyticsCreateAsyncResponse_report_status_is_assigned_from_json);
    ...
    RUN_TEST(test_AdsAnalyticsGetAsyncResponse_report_status_is_assigned_from_json);
    ...
    RUN_TEST(test_AnalyticsMetricsResponse_daily_metrics_inner_date_is_assigned_from_json);
    
    
    RUN_TEST(test_AnalyticsMetricsResponse_daily_metrics_inner_metrics_is_assigned_from_json);
    ...
    RUN_TEST(test_AudienceCreateRequest_1_description_is_assigned_from_json);
    ...
    RUN_TEST(test_AudienceUpdateRequest_1_description_is_assigned_from_json);
    ...
    RUN_TEST(test_Board_sections_list_pins_200_response_bookmark_is_assigned_from_json);
    ...
    RUN_TEST(test_CampaignCreateCommon_allOf_is_campaign_budget_optimization_is_assigned_from_json);
    
    
    RUN_TEST(test_CampaignCreateCommon_allOf_is_flexible_daily_budgets_is_assigned_from_json);
    
    
    RUN_TEST(test_CampaignCreateCommon_allOf_default_ad_group_budget_in_micro_currency_is_assigned_from_json);
    
    
    RUN_TEST(test_CampaignCreateCommon_allOf_is_automated_campaign_is_assigned_from_json);
    ...
    RUN_TEST(test_CampaignResponse_allOf_created_time_is_assigned_from_json);
    
    
    RUN_TEST(test_CampaignResponse_allOf_updated_time_is_assigned_from_json);
    
    
    RUN_TEST(test_CampaignResponse_allOf_type_is_assigned_from_json);
    
    
    RUN_TEST(test_CampaignResponse_allOf_is_flexible_daily_budgets_is_assigned_from_json);
    
    
    RUN_TEST(test_CampaignResponse_allOf_is_campaign_budget_optimization_is_assigned_from_json);
    ...
    RUN_TEST(test_CampaignUpdateRequest_allOf_is_campaign_budget_optimization_is_assigned_from_json);
    
    
    RUN_TEST(test_CampaignUpdateRequest_allOf_is_flexible_daily_budgets_is_assigned_from_json);
    
    
    RUN_TEST(test_CampaignUpdateRequest_allOf_is_automated_campaign_is_assigned_from_json);
    ...
    RUN_TEST(test_CatalogsFeedIngestionErrors_iMAGE_DOWNLOAD_ERROR_is_assigned_from_json);
    ...
    RUN_TEST(test_CatalogsFeedValidationWarnings_dUPLICATE_PRODUCTS_is_assigned_from_json);
    ...
    RUN_TEST(test_CatalogsFeedValidationWarnings_aVAILABILITY_NORMALIZED_is_assigned_from_json);
    
    
    RUN_TEST(test_CatalogsFeedValidationWarnings_cONDITION_NORMALIZED_is_assigned_from_json);
    
    
    RUN_TEST(test_CatalogsFeedValidationWarnings_gENDER_NORMALIZED_is_assigned_from_json);
    
    
    RUN_TEST(test_CatalogsFeedValidationWarnings_sIZE_TYPE_NORMALIZED_is_assigned_from_json);
    
    
    RUN_TEST(test_CatalogsFeedValidationWarnings_aGE_GROUP_NORMALIZED_is_assigned_from_json);
    ...
    RUN_TEST(test_CatalogsFeedsCreateRequest_default_locale_is_assigned_from_json);
    ...
    RUN_TEST(test_Catalogs_product_group_feed_based_case_id_is_assigned_from_json);
    
    
    RUN_TEST(test_Catalogs_product_group_feed_based_case_name_is_assigned_from_json);
    
    
    RUN_TEST(test_Catalogs_product_group_feed_based_case_description_is_assigned_from_json);
    
    
    
    RUN_TEST(test_Catalogs_product_group_feed_based_case_is_featured_is_assigned_from_json);
    
    
    
    
    RUN_TEST(test_Catalogs_product_group_feed_based_case_created_at_is_assigned_from_json);
    
    
    RUN_TEST(test_Catalogs_product_group_feed_based_case_updated_at_is_assigned_from_json);
    
    
    RUN_TEST(test_Catalogs_product_group_feed_based_case_feed_id_is_assigned_from_json);
    
    
    
    RUN_TEST(test_Catalogs_product_group_merchant_based_case_id_is_assigned_from_json);
    
    
    RUN_TEST(test_Catalogs_product_group_merchant_based_case_name_is_assigned_from_json);
    
    
    RUN_TEST(test_Catalogs_product_group_merchant_based_case_description_is_assigned_from_json);
    
    
    
    RUN_TEST(test_Catalogs_product_group_merchant_based_case_is_featured_is_assigned_from_json);
    
    
    
    
    RUN_TEST(test_Catalogs_product_group_merchant_based_case_created_at_is_assigned_from_json);
    
    
    RUN_TEST(test_Catalogs_product_group_merchant_based_case_updated_at_is_assigned_from_json);
    
    
    RUN_TEST(test_Catalogs_product_group_merchant_based_case_feed_id_is_assigned_from_json);
    ...
    RUN_TEST(test_Feed_fields_name_is_assigned_from_json);
    
    
    
    RUN_TEST(test_Feed_fields_default_locale_is_assigned_from_json);
    
    
    
    RUN_TEST(test_Feed_fields_location_is_assigned_from_json);
    ...
    RUN_TEST(test_MediaUpload_allOf_media_id_is_assigned_from_json);
    
    
    
    RUN_TEST(test_MediaUpload_allOf_upload_url_is_assigned_from_json);
    ...
    RUN_TEST(test_OauthAccessTokenRequestCode_allOf_code_is_assigned_from_json);
    
    
    RUN_TEST(test_OauthAccessTokenRequestCode_allOf_redirect_uri_is_assigned_from_json);
    ...
    RUN_TEST(test_OauthAccessTokenRequestRefresh_allOf_refresh_token_is_assigned_from_json);
    
    
    RUN_TEST(test_OauthAccessTokenRequestRefresh_allOf_scope_is_assigned_from_json);
    ...
    RUN_TEST(test_OauthAccessTokenResponseCode_allOf_refresh_token_is_assigned_from_json);
    
    
    RUN_TEST(test_OauthAccessTokenResponseCode_allOf_refresh_token_expires_in_is_assigned_from_json);
    ...
    RUN_TEST(test_PinMediaWithVideo_allOf_cover_image_url_is_assigned_from_json);
    
    
    RUN_TEST(test_PinMediaWithVideo_allOf_duration_is_assigned_from_json);
    
    
    RUN_TEST(test_PinMediaWithVideo_allOf_height_is_assigned_from_json);
    
    
    RUN_TEST(test_PinMediaWithVideo_allOf_width_is_assigned_from_json);
    ...
    RUN_TEST(test_Pin_media_media_type_is_assigned_from_json);
    
    
    
    RUN_TEST(test_Pin_media_source_source_type_is_assigned_from_json);
    
    
    RUN_TEST(test_Pin_media_source_content_type_is_assigned_from_json);
    
    
    RUN_TEST(test_Pin_media_source_data_is_assigned_from_json);
    
    
    RUN_TEST(test_Pin_media_source_url_is_assigned_from_json);
    
    
    RUN_TEST(test_Pin_media_source_cover_image_url_is_assigned_from_json);
    
    
    RUN_TEST(test_Pin_media_source_media_id_is_assigned_from_json);
    ...
    RUN_TEST(test_ProductGroupPromotion_type_is_assigned_from_json);
    ...
    RUN_TEST(test_ProductGroupPromotion_catalogs_product_group_id_is_assigned_from_json);
    
    
    RUN_TEST(test_ProductGroupPromotion_catalogs_product_group_name_is_assigned_from_json);
    ...
    RUN_TEST(test_ProductGroupPromotionCommon_tracking_url_is_assigned_from_json);
    
    
    RUN_TEST(test_ProductGroupPromotionCommon_catalogs_product_group_id_is_assigned_from_json);
    
    
    RUN_TEST(test_ProductGroupPromotionCommon_catalogs_product_group_name_is_assigned_from_json);
    
    
    
    RUN_TEST(test_ProductGroupPromotionCommon_collections_hero_pin_id_is_assigned_from_json);
    
    
    RUN_TEST(test_ProductGroupPromotionCommon_collections_hero_destination_url_is_assigned_from_json);
    
    
    RUN_TEST(test_ProductGroupPromotionCommon_slideshow_collections_title_is_assigned_from_json);
    
    
    RUN_TEST(test_ProductGroupPromotionCommon_slideshow_collections_description_is_assigned_from_json);
    
    
    RUN_TEST(test_ProductGroupPromotionCommon_is_mdl_is_assigned_from_json);
    ...
    RUN_TEST(test_ProductGroupPromotionUpdateItem_id_is_assigned_from_json);
    ...
    RUN_TEST(test_Product_groups_create_request_feed_base_case_name_is_assigned_from_json);
    
    
    RUN_TEST(test_Product_groups_create_request_feed_base_case_description_is_assigned_from_json);
    
    
    RUN_TEST(test_Product_groups_create_request_feed_base_case_is_featured_is_assigned_from_json);
    
    
    
    RUN_TEST(test_Product_groups_create_request_feed_base_case_feed_id_is_assigned_from_json);
    
    
    
    
    RUN_TEST(test_Products_by_product_group_filter_list_200_response_bookmark_is_assigned_from_json);
    ...
    RUN_TEST(test_TargetingSpec_SHOPPING_RETARGETING_1_inner_lookback_window_is_assigned_from_json);
    
    
    
    RUN_TEST(test_TargetingSpec_SHOPPING_RETARGETING_1_inner_exclusion_window_is_assigned_from_json);
    ...
    RUN_TEST(test_AdCommon_pin_id_is_converted_to_json);
    ...
    RUN_TEST(test_AdGroupResponse_allOf_id_is_converted_to_json);
    
    
    RUN_TEST(test_AdGroupResponse_allOf_ad_account_id_is_converted_to_json);
    
    
    RUN_TEST(test_AdGroupResponse_allOf_created_time_is_converted_to_json);
    
    
    RUN_TEST(test_AdGroupResponse_allOf_updated_time_is_converted_to_json);
    
    
    RUN_TEST(test_AdGroupResponse_allOf_type_is_converted_to_json);
    
    
    RUN_TEST(test_AdGroupResponse_allOf_conversion_learning_mode_type_is_converted_to_json);
    
    
    
    RUN_TEST(test_AdGroupResponse_allOf_feed_profile_id_is_converted_to_json);
    ...
    RUN_TEST(test_AdGroupUpdateRequest_allOf_id_is_converted_to_json);
    ...
    RUN_TEST(test_AdResponse_allOf_ad_account_id_is_converted_to_json);
    
    
    RUN_TEST(test_AdResponse_allOf_campaign_id_is_converted_to_json);
    
    
    RUN_TEST(test_AdResponse_allOf_collection_items_destination_url_template_is_converted_to_json);
    
    
    RUN_TEST(test_AdResponse_allOf_created_time_is_converted_to_json);
    
    
    RUN_TEST(test_AdResponse_allOf_id_is_converted_to_json);
    
    
    
    
    RUN_TEST(test_AdResponse_allOf_review_status_is_converted_to_json);
    
    
    RUN_TEST(test_AdResponse_allOf_type_is_converted_to_json);
    
    
    RUN_TEST(test_AdResponse_allOf_updated_time_is_converted_to_json);
    ...
    RUN_TEST(test_AdUpdateRequest_1_id_is_converted_to_json);
    ...
    RUN_TEST(test_AdsAnalyticsCreateAsyncRequest_allOf_start_date_is_converted_to_json);
    
    
    RUN_TEST(test_AdsAnalyticsCreateAsyncRequest_allOf_end_date_is_converted_to_json);
    ...
    RUN_TEST(test_AdsAnalyticsCreateAsyncResponse_report_status_is_converted_to_json);
    ...
    RUN_TEST(test_AdsAnalyticsGetAsyncResponse_report_status_is_converted_to_json);
    ...
    RUN_TEST(test_AnalyticsMetricsResponse_daily_metrics_inner_date_is_converted_to_json);
    
    
    RUN_TEST(test_AnalyticsMetricsResponse_daily_metrics_inner_metrics_is_converted_to_json);
    ...
    RUN_TEST(test_AudienceCreateRequest_1_description_is_converted_to_json);
    ...
    RUN_TEST(test_AudienceUpdateRequest_1_description_is_converted_to_json);
    ...
    RUN_TEST(test_Board_sections_list_pins_200_response_bookmark_is_converted_to_json);
    ...
    RUN_TEST(test_CampaignCreateCommon_allOf_is_campaign_budget_optimization_is_converted_to_json);
    
    
    RUN_TEST(test_CampaignCreateCommon_allOf_is_flexible_daily_budgets_is_converted_to_json);
    
    
    RUN_TEST(test_CampaignCreateCommon_allOf_default_ad_group_budget_in_micro_currency_is_converted_to_json);
    
    
    RUN_TEST(test_CampaignCreateCommon_allOf_is_automated_campaign_is_converted_to_json);
    ...
    RUN_TEST(test_CampaignResponse_allOf_created_time_is_converted_to_json);
    
    
    RUN_TEST(test_CampaignResponse_allOf_updated_time_is_converted_to_json);
    
    
    RUN_TEST(test_CampaignResponse_allOf_type_is_converted_to_json);
    
    
    RUN_TEST(test_CampaignResponse_allOf_is_flexible_daily_budgets_is_converted_to_json);
    
    
    RUN_TEST(test_CampaignResponse_allOf_is_campaign_budget_optimization_is_converted_to_json);
    ...
    RUN_TEST(test_CampaignUpdateRequest_allOf_is_campaign_budget_optimization_is_converted_to_json);
    
    
    RUN_TEST(test_CampaignUpdateRequest_allOf_is_flexible_daily_budgets_is_converted_to_json);
    
    
    RUN_TEST(test_CampaignUpdateRequest_allOf_is_automated_campaign_is_converted_to_json);
    ...
    RUN_TEST(test_CatalogsFeedIngestionErrors_iMAGE_DOWNLOAD_ERROR_is_converted_to_json);
    ...
    RUN_TEST(test_CatalogsFeedValidationWarnings_dUPLICATE_PRODUCTS_is_converted_to_json);
    ...
    RUN_TEST(test_CatalogsFeedValidationWarnings_aVAILABILITY_NORMALIZED_is_converted_to_json);
    
    
    RUN_TEST(test_CatalogsFeedValidationWarnings_cONDITION_NORMALIZED_is_converted_to_json);
    
    
    RUN_TEST(test_CatalogsFeedValidationWarnings_gENDER_NORMALIZED_is_converted_to_json);
    
    
    RUN_TEST(test_CatalogsFeedValidationWarnings_sIZE_TYPE_NORMALIZED_is_converted_to_json);
    
    
    RUN_TEST(test_CatalogsFeedValidationWarnings_aGE_GROUP_NORMALIZED_is_converted_to_json);
    ...
    RUN_TEST(test_CatalogsFeedsCreateRequest_default_locale_is_converted_to_json);
    ...
    RUN_TEST(test_Catalogs_product_group_feed_based_case_id_is_converted_to_json);
    
    
    RUN_TEST(test_Catalogs_product_group_feed_based_case_name_is_converted_to_json);
    
    
    RUN_TEST(test_Catalogs_product_group_feed_based_case_description_is_converted_to_json);
    
    
    
    RUN_TEST(test_Catalogs_product_group_feed_based_case_is_featured_is_converted_to_json);
    
    
    
    
    RUN_TEST(test_Catalogs_product_group_feed_based_case_created_at_is_converted_to_json);
    
    
    RUN_TEST(test_Catalogs_product_group_feed_based_case_updated_at_is_converted_to_json);
    
    
    RUN_TEST(test_Catalogs_product_group_feed_based_case_feed_id_is_converted_to_json);
    
    
    
    RUN_TEST(test_Catalogs_product_group_merchant_based_case_id_is_converted_to_json);
    
    
    RUN_TEST(test_Catalogs_product_group_merchant_based_case_name_is_converted_to_json);
    
    
    RUN_TEST(test_Catalogs_product_group_merchant_based_case_description_is_converted_to_json);
    
    
    
    RUN_TEST(test_Catalogs_product_group_merchant_based_case_is_featured_is_converted_to_json);
    
    
    
    
    RUN_TEST(test_Catalogs_product_group_merchant_based_case_created_at_is_converted_to_json);
    
    
    RUN_TEST(test_Catalogs_product_group_merchant_based_case_updated_at_is_converted_to_json);
    
    
    RUN_TEST(test_Catalogs_product_group_merchant_based_case_feed_id_is_converted_to_json);
    ...
    RUN_TEST(test_Feed_fields_name_is_converted_to_json);
    
    
    
    RUN_TEST(test_Feed_fields_default_locale_is_converted_to_json);
    
    
    
    RUN_TEST(test_Feed_fields_location_is_converted_to_json);
    ...
    RUN_TEST(test_MediaUpload_allOf_media_id_is_converted_to_json);
    
    
    
    RUN_TEST(test_MediaUpload_allOf_upload_url_is_converted_to_json);
    ...
    RUN_TEST(test_OauthAccessTokenRequestCode_allOf_code_is_converted_to_json);
    
    
    RUN_TEST(test_OauthAccessTokenRequestCode_allOf_redirect_uri_is_converted_to_json);
    ...
    RUN_TEST(test_OauthAccessTokenRequestRefresh_allOf_refresh_token_is_converted_to_json);
    
    
    RUN_TEST(test_OauthAccessTokenRequestRefresh_allOf_scope_is_converted_to_json);
    ...
    RUN_TEST(test_OauthAccessTokenResponseCode_allOf_refresh_token_is_converted_to_json);
    
    
    RUN_TEST(test_OauthAccessTokenResponseCode_allOf_refresh_token_expires_in_is_converted_to_json);
    ...
    RUN_TEST(test_PinMediaWithVideo_allOf_cover_image_url_is_converted_to_json);
    
    
    RUN_TEST(test_PinMediaWithVideo_allOf_duration_is_converted_to_json);
    
    
    RUN_TEST(test_PinMediaWithVideo_allOf_height_is_converted_to_json);
    
    
    RUN_TEST(test_PinMediaWithVideo_allOf_width_is_converted_to_json);
    ...
    RUN_TEST(test_Pin_media_media_type_is_converted_to_json);
    
    
    
    RUN_TEST(test_Pin_media_source_source_type_is_converted_to_json);
    
    
    RUN_TEST(test_Pin_media_source_content_type_is_converted_to_json);
    
    
    RUN_TEST(test_Pin_media_source_data_is_converted_to_json);
    
    
    RUN_TEST(test_Pin_media_source_url_is_converted_to_json);
    
    
    RUN_TEST(test_Pin_media_source_cover_image_url_is_converted_to_json);
    
    
    RUN_TEST(test_Pin_media_source_media_id_is_converted_to_json);
    ...
    RUN_TEST(test_ProductGroupPromotion_type_is_converted_to_json);
    ...
    RUN_TEST(test_ProductGroupPromotion_catalogs_product_group_id_is_converted_to_json);
    
    
    RUN_TEST(test_ProductGroupPromotion_catalogs_product_group_name_is_converted_to_json);
    ...
    RUN_TEST(test_ProductGroupPromotionCommon_tracking_url_is_converted_to_json);
    
    
    RUN_TEST(test_ProductGroupPromotionCommon_catalogs_product_group_id_is_converted_to_json);
    
    
    RUN_TEST(test_ProductGroupPromotionCommon_catalogs_product_group_name_is_converted_to_json);
    
    
    
    RUN_TEST(test_ProductGroupPromotionCommon_collections_hero_pin_id_is_converted_to_json);
    
    
    RUN_TEST(test_ProductGroupPromotionCommon_collections_hero_destination_url_is_converted_to_json);
    
    
    RUN_TEST(test_ProductGroupPromotionCommon_slideshow_collections_title_is_converted_to_json);
    
    
    RUN_TEST(test_ProductGroupPromotionCommon_slideshow_collections_description_is_converted_to_json);
    
    
    RUN_TEST(test_ProductGroupPromotionCommon_is_mdl_is_converted_to_json);
    ...
    RUN_TEST(test_ProductGroupPromotionUpdateItem_id_is_converted_to_json);
    ...
    RUN_TEST(test_Product_groups_create_request_feed_base_case_name_is_converted_to_json);
    
    
    RUN_TEST(test_Product_groups_create_request_feed_base_case_description_is_converted_to_json);
    
    
    RUN_TEST(test_Product_groups_create_request_feed_base_case_is_featured_is_converted_to_json);
    
    
    
    RUN_TEST(test_Product_groups_create_request_feed_base_case_feed_id_is_converted_to_json);
    
    
    
    
    RUN_TEST(test_Products_by_product_group_filter_list_200_response_bookmark_is_converted_to_json);
    ...
    RUN_TEST(test_TargetingSpec_SHOPPING_RETARGETING_1_inner_lookback_window_is_converted_to_json);
    
    
    
    RUN_TEST(test_TargetingSpec_SHOPPING_RETARGETING_1_inner_exclusion_window_is_converted_to_json);
