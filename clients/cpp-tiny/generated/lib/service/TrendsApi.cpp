...
using namespace Tiny;
        ...
        {
            std::string url = basepath + "/trends/editorial_articles"; //
            ...
            std::list<TrendsEditorial> obj = std::list<TrendsEditorial>();
            ...
            Response<std::list<TrendsEditorial>> response(obj, httpCode);
            return response;
        }
