...
{
	bookmark = std::string();
	items = std::list<Keyword>();
}

Keywords_get_200_response::Keywords_get_200_response(std::string jsonString)
{
...
void
Keywords_get_200_response::fromJson(std::string jsonObj)
{
...
Keywords_get_200_response::toJson()
{
    ...
    std::list<Keyword> items_list = getItems();
