...
AdAccountToAdAccountSharedAudience::AdAccountToAdAccountSharedAudience(std::string jsonString)
{
...
void
AdAccountToAdAccountSharedAudience::fromJson(std::string jsonObj)
{
