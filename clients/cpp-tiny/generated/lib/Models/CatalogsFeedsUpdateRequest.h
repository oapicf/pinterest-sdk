...
#ifndef TINY_CPP_CLIENT_CatalogsFeedsUpdateRequest_H_
#define TINY_CPP_CLIENT_CatalogsFeedsUpdateRequest_H_
...
public:
    ...
    CatalogsFeedsUpdateRequest(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_CatalogsFeedsUpdateRequest_H_ */
