...
#ifndef TINY_CPP_CLIENT_PromotionBatchUpdate_H_
#define TINY_CPP_CLIENT_PromotionBatchUpdate_H_
...
public:
    ...
    PromotionBatchUpdate(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_PromotionBatchUpdate_H_ */
