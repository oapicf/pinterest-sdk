...
#ifndef TINY_CPP_CLIENT_SSIOCreateInsertionOrderRequest_H_
#define TINY_CPP_CLIENT_SSIOCreateInsertionOrderRequest_H_
...
public:
    ...
    SSIOCreateInsertionOrderRequest(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_SSIOCreateInsertionOrderRequest_H_ */
