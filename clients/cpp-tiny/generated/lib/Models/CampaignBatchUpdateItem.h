...
#ifndef TINY_CPP_CLIENT_CampaignBatchUpdateItem_H_
#define TINY_CPP_CLIENT_CampaignBatchUpdateItem_H_
...
/*! \brief Single campaign update item with update-specific bid options.
 *
 *  \ingroup Models
 *
 */
...
public:
    ...
    CampaignBatchUpdateItem(std::string jsonString);
	...
	/*! \brief Get Object describing an update to the campaign level bid multipliers.
	 */
	CampaignBidOptionsUpdate getBidOptions();

	/*! \brief Set Object describing an update to the campaign level bid multipliers.
	 */
	...
	/*! \brief Get Campaign ID, must be associated with the ad account ID provided in the path.
	 */
	std::string getId();

	/*! \brief Set Campaign ID, must be associated with the ad account ID provided in the path.
	 */
...
#endif /* TINY_CPP_CLIENT_CampaignBatchUpdateItem_H_ */
