...
#ifndef TINY_CPP_CLIENT_CatalogsCreativeAssetsItemsFilter_H_
#define TINY_CPP_CLIENT_CatalogsCreativeAssetsItemsFilter_H_
...
public:
    ...
    CatalogsCreativeAssetsItemsFilter(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_CatalogsCreativeAssetsItemsFilter_H_ */
