...
TargetingTemplateGetResponseData::TargetingTemplateGetResponseData(std::string jsonString)
{
...
void
TargetingTemplateGetResponseData::fromJson(std::string jsonObj)
{
...
bool
TargetingTemplateGetResponseData::isAutoTargetingEnabled()
{
...
bool
TargetingTemplateGetResponseData::isValid()
{
	return valid;
}
