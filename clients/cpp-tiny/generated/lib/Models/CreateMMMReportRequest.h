...
#ifndef TINY_CPP_CLIENT_CreateMMMReportRequest_H_
#define TINY_CPP_CLIENT_CreateMMMReportRequest_H_
...
public:
    ...
    CreateMMMReportRequest(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_CreateMMMReportRequest_H_ */
