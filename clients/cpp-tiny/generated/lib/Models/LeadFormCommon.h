...
#ifndef TINY_CPP_CLIENT_LeadFormCommon_H_
#define TINY_CPP_CLIENT_LeadFormCommon_H_
...
public:
	 ...
	 */
    LeadFormCommon();
    LeadFormCommon(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_LeadFormCommon_H_ */
