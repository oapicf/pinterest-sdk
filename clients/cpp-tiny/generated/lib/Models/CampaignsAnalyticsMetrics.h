...
#ifndef TINY_CPP_CLIENT_CampaignsAnalyticsMetrics_H_
#define TINY_CPP_CLIENT_CampaignsAnalyticsMetrics_H_
...
public:
    ...
    CampaignsAnalyticsMetrics(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_CampaignsAnalyticsMetrics_H_ */
