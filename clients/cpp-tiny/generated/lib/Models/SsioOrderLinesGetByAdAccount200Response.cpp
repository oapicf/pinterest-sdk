...
{
	bookmark = std::string();
	items = std::list<SSIOOrderLine>();
}

Ssio_order_lines_get_by_ad_account_200_response::Ssio_order_lines_get_by_ad_account_200_response(std::string jsonString)
{
...
void
Ssio_order_lines_get_by_ad_account_200_response::fromJson(std::string jsonObj)
{
    ...
    if(object.has_key(itemsKey))
    {
        ...
        std::list<SSIOOrderLine> items_list;
        SSIOOrderLine element;
...
Ssio_order_lines_get_by_ad_account_200_response::toJson()
{
    ...
    std::list<SSIOOrderLine> items_list = getItems();
    bourne::json items_arr = bourne::json::array();

    for(auto& var : items_list)
    {
        SSIOOrderLine obj = var;
