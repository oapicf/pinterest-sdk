...
#ifndef TINY_CPP_CLIENT_AdAccountCreateSubscriptionResponse_H_
#define TINY_CPP_CLIENT_AdAccountCreateSubscriptionResponse_H_
...
public:
    ...
    AdAccountCreateSubscriptionResponse(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_AdAccountCreateSubscriptionResponse_H_ */
