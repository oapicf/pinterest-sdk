...
#ifndef TINY_CPP_CLIENT_LocalInventoryUpsertOperation_H_
#define TINY_CPP_CLIENT_LocalInventoryUpsertOperation_H_
...
/*! \brief Upsert operation for local inventory item
 *
 *  \ingroup Models
 *
 */
...
public:
    ...
    LocalInventoryUpsertOperation(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_LocalInventoryUpsertOperation_H_ */
