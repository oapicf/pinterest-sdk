...
Schedule::Schedule(std::string jsonString)
{
...
void
Schedule::fromJson(std::string jsonObj)
{
...
Schedule::getDeltaValue()
{
	return delta_value;
}

void
Schedule::setDeltaValue(Schedule_delta_value delta_value)
{
...
void
Schedule::setEndTimestamp(int end_timestamp)
{
...
void
Schedule::setEntityId(std::string entity_id)
{
...
void
Schedule::setEntityType(AdAccountEntityType entity_type)
{
...
void
Schedule::setName(std::string name)
{
	this->name = name;
}

ScheduleAction
Schedule::getScheduleAction()
{
	return schedule_action;
}

void
Schedule::setScheduleAction(ScheduleAction schedule_action)
{
...
void
Schedule::setScheduleId(std::string schedule_id)
{
...
void
Schedule::setScheduleStatus(ScheduleStatus schedule_status)
{
...
void
Schedule::setScheduleType(ScheduleType schedule_type)
{
...
void
Schedule::setStartTimestamp(int start_timestamp)
{
