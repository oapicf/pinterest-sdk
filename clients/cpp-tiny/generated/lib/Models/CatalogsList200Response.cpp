...
{
	bookmark = std::string();
	items = std::list<Catalog>();
}

Catalogs_list_200_response::Catalogs_list_200_response(std::string jsonString)
{
...
void
Catalogs_list_200_response::fromJson(std::string jsonObj)
{
...
Catalogs_list_200_response::toJson()
{
    ...
    std::list<Catalog> items_list = getItems();
