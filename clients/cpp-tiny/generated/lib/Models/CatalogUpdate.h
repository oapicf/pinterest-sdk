...
#ifndef TINY_CPP_CLIENT_CatalogUpdate_H_
#define TINY_CPP_CLIENT_CatalogUpdate_H_
...
public:
	 ...
	 */
    CatalogUpdate();
    CatalogUpdate(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_CatalogUpdate_H_ */
