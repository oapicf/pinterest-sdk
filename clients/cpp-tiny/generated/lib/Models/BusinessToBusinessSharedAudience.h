...
#ifndef TINY_CPP_CLIENT_BusinessToBusinessSharedAudience_H_
#define TINY_CPP_CLIENT_BusinessToBusinessSharedAudience_H_
...
public:
    ...
    BusinessToBusinessSharedAudience(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_BusinessToBusinessSharedAudience_H_ */
