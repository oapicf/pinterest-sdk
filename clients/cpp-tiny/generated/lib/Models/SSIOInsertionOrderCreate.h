...
#ifndef TINY_CPP_CLIENT_SSIOInsertionOrderCreate_H_
#define TINY_CPP_CLIENT_SSIOInsertionOrderCreate_H_
...
public:
    ...
    SSIOInsertionOrderCreate(std::string jsonString);
	 ...
	 */
	double getEstimatedMonthlySpend();

	/*! \brief Set If Ongoing (perpetual) order line, the estimated monthly spend
	 */
	void setEstimatedMonthlySpend(double estimated_monthly_spend);
	 ...
	 */
	SSIOOrderLineType getOrderLineType();

	/*! \brief Set Type can be Budget or Perpetual
	 */
	void setOrderLineType(SSIOOrderLineType order_line_type);
    ...
    SSIOOrderLineType order_line_type;
...
#endif /* TINY_CPP_CLIENT_SSIOInsertionOrderCreate_H_ */
