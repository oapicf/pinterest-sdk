...
#ifndef TINY_CPP_CLIENT_LeadFormUpdateRequest_H_
#define TINY_CPP_CLIENT_LeadFormUpdateRequest_H_
...
public:
    ...
    LeadFormUpdateRequest(std::string jsonString);
	...
	/*! \brief Set The ID of this lead form to be updated
	 */
...
#endif /* TINY_CPP_CLIENT_LeadFormUpdateRequest_H_ */
