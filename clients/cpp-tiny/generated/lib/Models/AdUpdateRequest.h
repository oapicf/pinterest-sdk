...
#ifndef TINY_CPP_CLIENT_AdUpdateRequest_H_
#define TINY_CPP_CLIENT_AdUpdateRequest_H_
...
public:
	 ...
	 */
    AdUpdateRequest();
    AdUpdateRequest(std::string jsonString);
	 ...
	 */
	void setQuizPinData(Object quiz_pin_data);
	/*! \brief Get 
	 */
...
#endif /* TINY_CPP_CLIENT_AdUpdateRequest_H_ */
