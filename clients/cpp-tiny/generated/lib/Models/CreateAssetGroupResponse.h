...
#ifndef TINY_CPP_CLIENT_CreateAssetGroupResponse_H_
#define TINY_CPP_CLIENT_CreateAssetGroupResponse_H_
...
public:
    ...
    CreateAssetGroupResponse(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_CreateAssetGroupResponse_H_ */
