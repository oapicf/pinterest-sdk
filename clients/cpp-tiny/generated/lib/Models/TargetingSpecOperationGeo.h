...
#ifndef TINY_CPP_CLIENT_TargetingSpecOperationGeo_H_
#define TINY_CPP_CLIENT_TargetingSpecOperationGeo_H_
...
public:
    ...
    TargetingSpecOperationGeo(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_TargetingSpecOperationGeo_H_ */
