...
#ifndef TINY_CPP_CLIENT_CatalogsFeedCreateRequestSchema_H_
#define TINY_CPP_CLIENT_CatalogsFeedCreateRequestSchema_H_
...
public:
    ...
    CatalogsFeedCreateRequestSchema(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_CatalogsFeedCreateRequestSchema_H_ */
