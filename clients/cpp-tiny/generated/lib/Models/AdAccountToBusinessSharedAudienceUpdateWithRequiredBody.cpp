...
AdAccountToBusinessSharedAudienceUpdateWithRequiredBody::AdAccountToBusinessSharedAudienceUpdateWithRequiredBody(std::string jsonString)
{
...
void
AdAccountToBusinessSharedAudienceUpdateWithRequiredBody::fromJson(std::string jsonObj)
{
