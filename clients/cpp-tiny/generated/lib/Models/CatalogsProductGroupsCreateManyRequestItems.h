...
#ifndef TINY_CPP_CLIENT_CatalogsProductGroupsCreateManyRequestItems_H_
#define TINY_CPP_CLIENT_CatalogsProductGroupsCreateManyRequestItems_H_
...
public:
    ...
    CatalogsProductGroupsCreateManyRequestItems(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_CatalogsProductGroupsCreateManyRequestItems_H_ */
