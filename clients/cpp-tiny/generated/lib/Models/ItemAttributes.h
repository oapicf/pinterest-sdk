...
#ifndef TINY_CPP_CLIENT_ItemAttributes_H_
#define TINY_CPP_CLIENT_ItemAttributes_H_
...
public:
	 ...
	 */
    ItemAttributes();
    ItemAttributes(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_ItemAttributes_H_ */
