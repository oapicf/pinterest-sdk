...
LocalInventoryUpdateOperation::LocalInventoryUpdateOperation(std::string jsonString)
{
...
void
LocalInventoryUpdateOperation::fromJson(std::string jsonObj)
{
    ...
    if(object.has_key(attributesKey))
    {
        ...
        RetailLocalInventoryItemAttributesOptional* obj = &attributes;
