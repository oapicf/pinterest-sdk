...
#ifndef TINY_CPP_CLIENT_CatalogsRetailReportParametersReport_H_
#define TINY_CPP_CLIENT_CatalogsRetailReportParametersReport_H_
...
public:
    ...
    CatalogsRetailReportParametersReport(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_CatalogsRetailReportParametersReport_H_ */
