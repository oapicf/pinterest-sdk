...
#ifndef TINY_CPP_CLIENT_UpdateMemberBusinessRoleBody_H_
#define TINY_CPP_CLIENT_UpdateMemberBusinessRoleBody_H_
...
public:
    ...
    UpdateMemberBusinessRoleBody(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_UpdateMemberBusinessRoleBody_H_ */
