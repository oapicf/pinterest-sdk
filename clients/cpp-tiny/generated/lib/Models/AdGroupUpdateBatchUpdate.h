...
#ifndef TINY_CPP_CLIENT_AdGroupUpdateBatchUpdate_H_
#define TINY_CPP_CLIENT_AdGroupUpdateBatchUpdate_H_
...
public:
    ...
    AdGroupUpdateBatchUpdate(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_AdGroupUpdateBatchUpdate_H_ */
