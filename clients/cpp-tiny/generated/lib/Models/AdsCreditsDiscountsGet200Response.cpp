...
{
	bookmark = std::string();
	items = std::list<AdsCreditDiscountsResponse>();
}

Ads_credits_discounts_get_200_response::Ads_credits_discounts_get_200_response(std::string jsonString)
{
...
void
Ads_credits_discounts_get_200_response::fromJson(std::string jsonObj)
{
    ...
    if(object.has_key(itemsKey))
    {
        ...
        std::list<AdsCreditDiscountsResponse> items_list;
        AdsCreditDiscountsResponse element;
...
Ads_credits_discounts_get_200_response::toJson()
{
    ...
    std::list<AdsCreditDiscountsResponse> items_list = getItems();
    bourne::json items_arr = bourne::json::array();

    for(auto& var : items_list)
    {
        AdsCreditDiscountsResponse obj = var;
