...
#ifndef TINY_CPP_CLIENT_PromotionCommon_H_
#define TINY_CPP_CLIENT_PromotionCommon_H_
...
public:
	 ...
	 */
    PromotionCommon();
    PromotionCommon(std::string jsonString);


    /*! \brief Destructor.
	 */
    virtual ~PromotionCommon();
...
#endif /* TINY_CPP_CLIENT_PromotionCommon_H_ */
