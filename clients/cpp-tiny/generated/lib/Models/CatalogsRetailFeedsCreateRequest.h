...
#ifndef TINY_CPP_CLIENT_CatalogsRetailFeedsCreateRequest_H_
#define TINY_CPP_CLIENT_CatalogsRetailFeedsCreateRequest_H_
...
/*! \brief Request object for creating a retail feed.
 *
 *  \ingroup Models
 *
 */
...
public:
    ...
    CatalogsRetailFeedsCreateRequest(std::string jsonString);
	...
	/*! \brief Get Catalog id pertaining to the feed. If not provided, feed will use a default catalog based on type. Currently, this field has no effect.
	 */
	std::string getCatalogId();

	/*! \brief Set Catalog id pertaining to the feed. If not provided, feed will use a default catalog based on type. Currently, this field has no effect.
	 */
...
#endif /* TINY_CPP_CLIENT_CatalogsRetailFeedsCreateRequest_H_ */
