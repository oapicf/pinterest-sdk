...
#ifndef TINY_CPP_CLIENT_CatalogsRetailItemsPostFilter_H_
#define TINY_CPP_CLIENT_CatalogsRetailItemsPostFilter_H_
...
public:
    ...
    CatalogsRetailItemsPostFilter(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_CatalogsRetailItemsPostFilter_H_ */
