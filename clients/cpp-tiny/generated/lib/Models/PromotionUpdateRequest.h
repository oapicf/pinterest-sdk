...
#ifndef TINY_CPP_CLIENT_PromotionUpdateRequest_H_
#define TINY_CPP_CLIENT_PromotionUpdateRequest_H_
...
public:
    ...
    PromotionUpdateRequest(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_PromotionUpdateRequest_H_ */
