...
#ifndef TINY_CPP_CLIENT_Catalogs_list_200_response_H_
#define TINY_CPP_CLIENT_Catalogs_list_200_response_H_
...
public:
    ...
    Catalogs_list_200_response(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_Catalogs_list_200_response_H_ */
