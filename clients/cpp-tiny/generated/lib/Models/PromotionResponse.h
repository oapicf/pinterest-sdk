...
#ifndef TINY_CPP_CLIENT_PromotionResponse_H_
#define TINY_CPP_CLIENT_PromotionResponse_H_
...
public:
	 ...
	 */
    PromotionResponse();
    PromotionResponse(std::string jsonString);


    /*! \brief Destructor.
	 */
    virtual ~PromotionResponse();
...
#endif /* TINY_CPP_CLIENT_PromotionResponse_H_ */
