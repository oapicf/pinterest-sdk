...
#ifndef TINY_CPP_CLIENT_ConversionTag_H_
#define TINY_CPP_CLIENT_ConversionTag_H_
...
public:
	 ...
	 */
    ConversionTag();
    ConversionTag(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_ConversionTag_H_ */
