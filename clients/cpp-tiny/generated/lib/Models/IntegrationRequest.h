...
#ifndef TINY_CPP_CLIENT_IntegrationRequest_H_
#define TINY_CPP_CLIENT_IntegrationRequest_H_
...
public:
	 ...
	 */
    IntegrationRequest();
    IntegrationRequest(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_IntegrationRequest_H_ */
