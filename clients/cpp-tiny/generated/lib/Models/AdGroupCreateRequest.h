...
#ifndef TINY_CPP_CLIENT_AdGroupCreateRequest_H_
#define TINY_CPP_CLIENT_AdGroupCreateRequest_H_
...
public:
    ...
    AdGroupCreateRequest(std::string jsonString);
	 ...
	 */
	Object getOptimizationGoalMetadata();
	 ...
	 */
	void setOptimizationGoalMetadata(Object optimization_goal_metadata);
    ...
    std::string name{};
    Object optimization_goal_metadata;
...
#endif /* TINY_CPP_CLIENT_AdGroupCreateRequest_H_ */
