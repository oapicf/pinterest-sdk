...
#ifndef TINY_CPP_CLIENT_ConversionEvents_data_inner_H_
#define TINY_CPP_CLIENT_ConversionEvents_data_inner_H_
...
public:
    ...
    ConversionEvents_data_inner(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_ConversionEvents_data_inner_H_ */
