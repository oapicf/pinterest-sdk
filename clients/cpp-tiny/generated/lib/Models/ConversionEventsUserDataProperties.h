...
#ifndef TINY_CPP_CLIENT_ConversionEventsUserDataProperties_H_
#define TINY_CPP_CLIENT_ConversionEventsUserDataProperties_H_
...
public:
    ...
    ConversionEventsUserDataProperties(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_ConversionEventsUserDataProperties_H_ */
