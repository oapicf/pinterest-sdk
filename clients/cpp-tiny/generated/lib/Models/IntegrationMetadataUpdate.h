...
#ifndef TINY_CPP_CLIENT_IntegrationMetadataUpdate_H_
#define TINY_CPP_CLIENT_IntegrationMetadataUpdate_H_
...
public:
    ...
    IntegrationMetadataUpdate(std::string jsonString);


    /*! \brief Destructor.
	 */
    virtual ~IntegrationMetadataUpdate();
...
#endif /* TINY_CPP_CLIENT_IntegrationMetadataUpdate_H_ */
