...
AdBatchUpdate::AdBatchUpdate(std::string jsonString)
{
...
void
AdBatchUpdate::fromJson(std::string jsonObj)
{
...
bool
AdBatchUpdate::isIsCollageAcceptedTerms()
{
...
bool
AdBatchUpdate::isIsCollageSingleDestination()
{
