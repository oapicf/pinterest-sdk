...
#ifndef TINY_CPP_CLIENT_BidFloorObjectiveType_H_
#define TINY_CPP_CLIENT_BidFloorObjectiveType_H_
...
public:
    ...
    BidFloorObjectiveType(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_BidFloorObjectiveType_H_ */
