...
#ifndef TINY_CPP_CLIENT_SchedulePlacementMultipliers_H_
#define TINY_CPP_CLIENT_SchedulePlacementMultipliers_H_
...
public:
    ...
    SchedulePlacementMultipliers(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_SchedulePlacementMultipliers_H_ */
