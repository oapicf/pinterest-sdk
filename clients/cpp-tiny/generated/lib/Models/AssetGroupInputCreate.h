...
#ifndef TINY_CPP_CLIENT_AssetGroupInputCreate_H_
#define TINY_CPP_CLIENT_AssetGroupInputCreate_H_
...
public:
    ...
    AssetGroupInputCreate(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_AssetGroupInputCreate_H_ */
