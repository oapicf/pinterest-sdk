...
#ifndef TINY_CPP_CLIENT_CatalogsHotelItemsPostFilter_H_
#define TINY_CPP_CLIENT_CatalogsHotelItemsPostFilter_H_
...
public:
    ...
    CatalogsHotelItemsPostFilter(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_CatalogsHotelItemsPostFilter_H_ */
