...
AdGroupCreate::AdGroupCreate(std::string jsonString)
{
...
void
AdGroupCreate::fromJson(std::string jsonObj)
{
...
std::string
AdGroupCreate::getAdAccountId()
{
	return ad_account_id;
}

void
AdGroupCreate::setAdAccountId(std::string ad_account_id)
{
	this->ad_account_id = ad_account_id;
}

int
AdGroupCreate::getBidInMicroCurrency()
{
	return bid_in_micro_currency;
}

void
AdGroupCreate::setBidInMicroCurrency(int bid_in_micro_currency)
{
	this->bid_in_micro_currency = bid_in_micro_currency;
}

BidStrategyType
AdGroupCreate::getBidStrategyType()
{
	return bid_strategy_type;
}

void
AdGroupCreate::setBidStrategyType(BidStrategyType bid_strategy_type)
{
	this->bid_strategy_type = bid_strategy_type;
}

ActionType
AdGroupCreate::getBillableEvent()
{
	return billable_event;
}

void
AdGroupCreate::setBillableEvent(ActionType billable_event)
{
	this->billable_event = billable_event;
}

int
AdGroupCreate::getBudgetInMicroCurrency()
{
	return budget_in_micro_currency;
}

void
AdGroupCreate::setBudgetInMicroCurrency(int budget_in_micro_currency)
{
	this->budget_in_micro_currency = budget_in_micro_currency;
}

std::string
AdGroupCreate::getCampaignId()
{
	return campaign_id;
}

void
AdGroupCreate::setCampaignId(std::string campaign_id)
{
	this->campaign_id = campaign_id;
}

ConversionLearningModeType
AdGroupCreate::getConversionLearningModeType()
{
	return conversion_learning_mode_type;
}

void
AdGroupCreate::setConversionLearningModeType(ConversionLearningModeType conversion_learning_mode_type)
{
	this->conversion_learning_mode_type = conversion_learning_mode_type;
}

int
AdGroupCreate::getCreatedTime()
{
	return created_time;
}

void
AdGroupCreate::setCreatedTime(int created_time)
{
	this->created_time = created_time;
}

std::string
AdGroupCreate::getCustomerSegmentId()
{
	return customer_segment_id;
}

void
AdGroupCreate::setCustomerSegmentId(std::string customer_segment_id)
{
	this->customer_segment_id = customer_segment_id;
}

AnyType
AdGroupCreate::getDcaAssets()
{
	return dca_assets;
}

void
AdGroupCreate::setDcaAssets(AnyType dca_assets)
{
	this->dca_assets = dca_assets;
}

int
AdGroupCreate::getEndTime()
{
	return end_time;
}

void
AdGroupCreate::setEndTime(int end_time)
{
	this->end_time = end_time;
}

AdgroupTrackingFeatures
AdGroupCreate::getExtFeatures()
{
	return ext_features;
}

void
AdGroupCreate::setExtFeatures(AdgroupTrackingFeatures ext_features)
{
	this->ext_features = ext_features;
}

std::string
AdGroupCreate::getFeedProfileId()
{
	return feed_profile_id;
}

void
AdGroupCreate::setFeedProfileId(std::string feed_profile_id)
{
...
void
AdGroupCreate::setId(std::string id)
{
	this->id = id;
}

bool
AdGroupCreate::isIsCreativeOptimization()
{
	return is_creative_optimization;
}

void
AdGroupCreate::setIsCreativeOptimization(bool is_creative_optimization)
{
	this->is_creative_optimization = is_creative_optimization;
}

bool
AdGroupCreate::isIsLocalInventory()
{
	return is_local_inventory;
}

void
AdGroupCreate::setIsLocalInventory(bool is_local_inventory)
{
	this->is_local_inventory = is_local_inventory;
}

int
AdGroupCreate::getLifetimeFrequencyCap()
{
	return lifetime_frequency_cap;
}

void
AdGroupCreate::setLifetimeFrequencyCap(int lifetime_frequency_cap)
{
	this->lifetime_frequency_cap = lifetime_frequency_cap;
}

long
AdGroupCreate::getLocalInventoryRadiusInMiles()
{
	return local_inventory_radius_in_miles;
}

void
AdGroupCreate::setLocalInventoryRadiusInMiles(long local_inventory_radius_in_miles)
{
	this->local_inventory_radius_in_miles = local_inventory_radius_in_miles;
}

std::string
AdGroupCreate::getName()
{
	return name;
}

void
AdGroupCreate::setName(std::string name)
{
	this->name = name;
}

NullableOptimizationGoalMetadata
AdGroupCreate::getOptimizationGoalMetadata()
{
	return optimization_goal_metadata;
}

void
AdGroupCreate::setOptimizationGoalMetadata(NullableOptimizationGoalMetadata optimization_goal_metadata)
{
	this->optimization_goal_metadata = optimization_goal_metadata;
}

PerformancePlusCampaignSettings
AdGroupCreate::getPerformancePlusCampaignSettings()
{
	return performance_plus_campaign_settings;
}

void
AdGroupCreate::setPerformancePlusCampaignSettings(PerformancePlusCampaignSettings performance_plus_campaign_settings)
{
	this->performance_plus_campaign_settings = performance_plus_campaign_settings;
}

PlacementGroupType
AdGroupCreate::getPlacementGroup()
{
	return placement_group;
}

void
AdGroupCreate::setPlacementGroup(PlacementGroupType placement_group)
{
	this->placement_group = placement_group;
}

PlacementTrafficType
AdGroupCreate::getPlacementTrafficType()
{
	return placement_traffic_type;
}

void
AdGroupCreate::setPlacementTrafficType(PlacementTrafficType placement_traffic_type)
{
	this->placement_traffic_type = placement_traffic_type;
}

PromotionApplicationLevel
AdGroupCreate::getPromotionApplicationLevel()
{
	return promotion_application_level;
}

void
AdGroupCreate::setPromotionApplicationLevel(PromotionApplicationLevel promotion_application_level)
{
	this->promotion_application_level = promotion_application_level;
}

std::string
AdGroupCreate::getPromotionId()
{
	return promotion_id;
}

void
AdGroupCreate::setPromotionId(std::string promotion_id)
{
	this->promotion_id = promotion_id;
}

std::list<std::string>
AdGroupCreate::getPromotionIds()
{
	return promotion_ids;
}

void
AdGroupCreate::setPromotionIds(std::list<std::string> promotion_ids)
{
	this->promotion_ids = promotion_ids;
}

int
AdGroupCreate::getStartTime()
{
	return start_time;
}

void
AdGroupCreate::setStartTime(int start_time)
{
	this->start_time = start_time;
}

EntityStatus
AdGroupCreate::getStatus()
{
	return status;
}

void
AdGroupCreate::setStatus(EntityStatus status)
{
	this->status = status;
}

SummaryStatus
AdGroupCreate::getSummaryStatus()
{
	return summary_status;
}

void
AdGroupCreate::setSummaryStatus(SummaryStatus summary_status)
{
	this->summary_status = summary_status;
}

TargetingSpecOptimal
AdGroupCreate::getTargetingSpec()
{
	return targeting_spec;
}

void
AdGroupCreate::setTargetingSpec(TargetingSpecOptimal targeting_spec)
{
	this->targeting_spec = targeting_spec;
}

std::list<std::string>
AdGroupCreate::getTargetingTemplateIds()
{
	return targeting_template_ids;
}

void
AdGroupCreate::setTargetingTemplateIds(std::list<std::string> targeting_template_ids)
{
	this->targeting_template_ids = targeting_template_ids;
}

AdGroupTrackingURLs
AdGroupCreate::getTrackingUrls()
{
	return tracking_urls;
}

void
AdGroupCreate::setTrackingUrls(AdGroupTrackingURLs tracking_urls)
{
	this->tracking_urls = tracking_urls;
}

std::string
AdGroupCreate::getType()
{
	return type;
}

void
AdGroupCreate::setType(std::string type)
{
	this->type = type;
}

int
AdGroupCreate::getUpdatedTime()
{
	return updated_time;
}

void
AdGroupCreate::setUpdatedTime(int updated_time)
{
	this->updated_time = updated_time;
}

bool
AdGroupCreate::isAutoTargetingEnabled()
{
	return auto_targeting_enabled;
}

void
AdGroupCreate::setAutoTargetingEnabled(bool auto_targeting_enabled)
{
	this->auto_targeting_enabled = auto_targeting_enabled;
}

long
AdGroupCreate::getBidMultiplier()
{
	return bid_multiplier;
}

void
AdGroupCreate::setBidMultiplier(long bid_multiplier)
{
	this->bid_multiplier = bid_multiplier;
}

BudgetType
AdGroupCreate::getBudgetType()
{
	return budget_type;
}

void
AdGroupCreate::setBudgetType(BudgetType budget_type)
{
	this->budget_type = budget_type;
}

PacingDeliveryType
AdGroupCreate::getPacingDeliveryType()
{
	return pacing_delivery_type;
}

void
AdGroupCreate::setPacingDeliveryType(PacingDeliveryType pacing_delivery_type)
{
