...
AdAccountToBusinessSharedAudience::AdAccountToBusinessSharedAudience(std::string jsonString)
{
...
void
AdAccountToBusinessSharedAudience::fromJson(std::string jsonObj)
{
