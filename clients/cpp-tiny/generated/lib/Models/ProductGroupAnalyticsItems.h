...
#ifndef TINY_CPP_CLIENT_ProductGroupAnalyticsItems_H_
#define TINY_CPP_CLIENT_ProductGroupAnalyticsItems_H_
...
public:
    ...
    ProductGroupAnalyticsItems(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_ProductGroupAnalyticsItems_H_ */
