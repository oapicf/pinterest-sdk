...
#ifndef TINY_CPP_CLIENT_AdPreviewShopping_H_
#define TINY_CPP_CLIENT_AdPreviewShopping_H_
...
public:
	 ...
	 */
    AdPreviewShopping();
    AdPreviewShopping(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_AdPreviewShopping_H_ */
