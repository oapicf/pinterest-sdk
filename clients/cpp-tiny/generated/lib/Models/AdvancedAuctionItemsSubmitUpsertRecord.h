...
#ifndef TINY_CPP_CLIENT_AdvancedAuctionItemsSubmitUpsertRecord_H_
#define TINY_CPP_CLIENT_AdvancedAuctionItemsSubmitUpsertRecord_H_
...
public:
    ...
    AdvancedAuctionItemsSubmitUpsertRecord(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_AdvancedAuctionItemsSubmitUpsertRecord_H_ */
