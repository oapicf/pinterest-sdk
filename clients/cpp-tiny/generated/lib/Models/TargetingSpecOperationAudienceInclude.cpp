...
TargetingSpecOperationAudienceInclude::TargetingSpecOperationAudienceInclude(std::string jsonString)
{
...
void
TargetingSpecOperationAudienceInclude::fromJson(std::string jsonObj)
{
