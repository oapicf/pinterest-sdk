...
#ifndef TINY_CPP_CLIENT_ScheduleAudienceMultipliers_H_
#define TINY_CPP_CLIENT_ScheduleAudienceMultipliers_H_
...
public:
    ...
    ScheduleAudienceMultipliers(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_ScheduleAudienceMultipliers_H_ */
