...
IntegrationMetadataUpdate::IntegrationMetadataUpdate(std::string jsonString)
{
...
void
IntegrationMetadataUpdate::fromJson(std::string jsonObj)
{
...
void
IntegrationMetadataUpdate::setPartnerAccessTokenExpiry(long partner_access_token_expiry)
{
...
void
IntegrationMetadataUpdate::setPartnerRefreshTokenExpiry(long partner_refresh_token_expiry)
{
