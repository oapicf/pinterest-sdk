...
#ifndef TINY_CPP_CLIENT_AdGroupAudienceSizingRequest_H_
#define TINY_CPP_CLIENT_AdGroupAudienceSizingRequest_H_
...
public:
    ...
    AdGroupAudienceSizingRequest(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_AdGroupAudienceSizingRequest_H_ */
