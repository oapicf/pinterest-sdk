...
#ifndef TINY_CPP_CLIENT_SingleInterestTargetingOption_H_
#define TINY_CPP_CLIENT_SingleInterestTargetingOption_H_
...
public:
    ...
    SingleInterestTargetingOption(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_SingleInterestTargetingOption_H_ */
