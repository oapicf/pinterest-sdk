...
#ifndef TINY_CPP_CLIENT_ScheduleBidMultipliers_H_
#define TINY_CPP_CLIENT_ScheduleBidMultipliers_H_
...
public:
    ...
    ScheduleBidMultipliers(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_ScheduleBidMultipliers_H_ */
