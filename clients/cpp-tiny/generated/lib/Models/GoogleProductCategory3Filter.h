...
#ifndef TINY_CPP_CLIENT_GoogleProductCategory3Filter_H_
#define TINY_CPP_CLIENT_GoogleProductCategory3Filter_H_
...
public:
    ...
    GoogleProductCategory3Filter(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_GoogleProductCategory3Filter_H_ */
