...
#ifndef TINY_CPP_CLIENT_DeletePartnerAssetsResult_H_
#define TINY_CPP_CLIENT_DeletePartnerAssetsResult_H_
...
public:
    ...
    DeletePartnerAssetsResult(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_DeletePartnerAssetsResult_H_ */
