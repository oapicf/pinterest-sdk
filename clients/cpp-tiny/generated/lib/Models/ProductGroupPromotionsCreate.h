...
#ifndef TINY_CPP_CLIENT_ProductGroupPromotionsCreate_H_
#define TINY_CPP_CLIENT_ProductGroupPromotionsCreate_H_
...
public:
    ...
    ProductGroupPromotionsCreate(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_ProductGroupPromotionsCreate_H_ */
