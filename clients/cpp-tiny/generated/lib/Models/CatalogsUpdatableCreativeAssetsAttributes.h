...
#ifndef TINY_CPP_CLIENT_CatalogsUpdatableCreativeAssetsAttributes_H_
#define TINY_CPP_CLIENT_CatalogsUpdatableCreativeAssetsAttributes_H_
...
public:
    ...
    CatalogsUpdatableCreativeAssetsAttributes(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_CatalogsUpdatableCreativeAssetsAttributes_H_ */
