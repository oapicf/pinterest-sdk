...
#ifndef TINY_CPP_CLIENT_CatalogsBaseFilterKeys_H_
#define TINY_CPP_CLIENT_CatalogsBaseFilterKeys_H_
...
public:
    ...
    CatalogsBaseFilterKeys(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_CatalogsBaseFilterKeys_H_ */
