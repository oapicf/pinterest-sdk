...
#ifndef TINY_CPP_CLIENT_LabelErrorData_H_
#define TINY_CPP_CLIENT_LabelErrorData_H_
...
public:
	 ...
	 */
    LabelErrorData();
    LabelErrorData(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_LabelErrorData_H_ */
