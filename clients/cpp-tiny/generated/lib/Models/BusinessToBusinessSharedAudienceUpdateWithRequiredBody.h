...
#ifndef TINY_CPP_CLIENT_BusinessToBusinessSharedAudienceUpdateWithRequiredBody_H_
#define TINY_CPP_CLIENT_BusinessToBusinessSharedAudienceUpdateWithRequiredBody_H_
...
public:
    ...
    BusinessToBusinessSharedAudienceUpdateWithRequiredBody(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_BusinessToBusinessSharedAudienceUpdateWithRequiredBody_H_ */
