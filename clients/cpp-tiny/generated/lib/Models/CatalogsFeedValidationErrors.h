...
#ifndef TINY_CPP_CLIENT_CatalogsFeedValidationErrors_H_
#define TINY_CPP_CLIENT_CatalogsFeedValidationErrors_H_
...
public:
    ...
    CatalogsFeedValidationErrors(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_CatalogsFeedValidationErrors_H_ */
