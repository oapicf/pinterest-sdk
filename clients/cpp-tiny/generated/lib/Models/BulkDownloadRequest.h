...
#ifndef TINY_CPP_CLIENT_BulkDownloadRequest_H_
#define TINY_CPP_CLIENT_BulkDownloadRequest_H_
...
public:
	 ...
	 */
    BulkDownloadRequest();
    BulkDownloadRequest(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_BulkDownloadRequest_H_ */
