...
#ifndef TINY_CPP_CLIENT_SSIOAccountResponse_H_
#define TINY_CPP_CLIENT_SSIOAccountResponse_H_
...
public:
	 ...
	 */
    SSIOAccountResponse();
    SSIOAccountResponse(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_SSIOAccountResponse_H_ */
