...
#ifndef TINY_CPP_CLIENT_Multiple_product_groups_inner_H_
#define TINY_CPP_CLIENT_Multiple_product_groups_inner_H_
...
public:
    ...
    Multiple_product_groups_inner(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_Multiple_product_groups_inner_H_ */
