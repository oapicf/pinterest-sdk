...
#ifndef TINY_CPP_CLIENT_ConversionEventAppInfo_H_
#define TINY_CPP_CLIENT_ConversionEventAppInfo_H_
...
public:
    ...
    ConversionEventAppInfo(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_ConversionEventAppInfo_H_ */
