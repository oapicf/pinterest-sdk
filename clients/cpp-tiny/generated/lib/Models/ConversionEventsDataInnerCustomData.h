...
#ifndef TINY_CPP_CLIENT_ConversionEvents_data_inner_custom_data_H_
#define TINY_CPP_CLIENT_ConversionEvents_data_inner_custom_data_H_
...
public:
    ...
    ConversionEvents_data_inner_custom_data(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_ConversionEvents_data_inner_custom_data_H_ */
