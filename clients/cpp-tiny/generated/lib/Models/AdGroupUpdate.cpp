...
AdGroupUpdate::AdGroupUpdate(std::string jsonString)
{
...
void
AdGroupUpdate::fromJson(std::string jsonObj)
{
...
bool
AdGroupUpdate::isIsCreativeOptimization()
{
...
bool
AdGroupUpdate::isIsLocalInventory()
{
...
void
AdGroupUpdate::setLocalInventoryRadiusInMiles(long local_inventory_radius_in_miles)
{
...
bool
AdGroupUpdate::isAutoTargetingEnabled()
{
...
void
AdGroupUpdate::setBidMultiplier(long bid_multiplier)
{
