...
#ifndef TINY_CPP_CLIENT_CatalogsHotelFeedsUpdateRequest_H_
#define TINY_CPP_CLIENT_CatalogsHotelFeedsUpdateRequest_H_
...
public:
    ...
    CatalogsHotelFeedsUpdateRequest(std::string jsonString);


    /*! \brief Destructor.
	 */
    virtual ~CatalogsHotelFeedsUpdateRequest();
...
#endif /* TINY_CPP_CLIENT_CatalogsHotelFeedsUpdateRequest_H_ */
