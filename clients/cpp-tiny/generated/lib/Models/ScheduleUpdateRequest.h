...
#ifndef TINY_CPP_CLIENT_ScheduleUpdateRequest_H_
#define TINY_CPP_CLIENT_ScheduleUpdateRequest_H_
...
public:
    ...
    ScheduleUpdateRequest(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_ScheduleUpdateRequest_H_ */
