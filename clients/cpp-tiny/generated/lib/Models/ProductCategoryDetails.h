...
public:
	 ...
	 */
	std::map<std::string, long> getPredictedTimeSeries();
	 ...
	 */
	void setPredictedTimeSeries(std::map<std::string, long> predicted_time_series);
	/*! \brief Get 
	 */
    ...
    std::map<std::string, long> predicted_time_series;
