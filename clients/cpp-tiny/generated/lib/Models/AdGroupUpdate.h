...
#ifndef TINY_CPP_CLIENT_AdGroupUpdate_H_
#define TINY_CPP_CLIENT_AdGroupUpdate_H_
...
public:
	 ...
	 */
    AdGroupUpdate();
    AdGroupUpdate(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_AdGroupUpdate_H_ */
