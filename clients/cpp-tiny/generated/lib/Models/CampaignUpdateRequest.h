...
#ifndef TINY_CPP_CLIENT_CampaignUpdateRequest_H_
#define TINY_CPP_CLIENT_CampaignUpdateRequest_H_
...
public:
    ...
    CampaignUpdateRequest(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_CampaignUpdateRequest_H_ */
