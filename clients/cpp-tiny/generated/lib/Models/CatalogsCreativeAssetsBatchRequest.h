...
#ifndef TINY_CPP_CLIENT_CatalogsCreativeAssetsBatchRequest_H_
#define TINY_CPP_CLIENT_CatalogsCreativeAssetsBatchRequest_H_
...
public:
    ...
    CatalogsCreativeAssetsBatchRequest(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_CatalogsCreativeAssetsBatchRequest_H_ */
