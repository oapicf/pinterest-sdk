...
#ifndef TINY_CPP_CLIENT_SSIOInsertionOrder_H_
#define TINY_CPP_CLIENT_SSIOInsertionOrder_H_
...
public:
	 ...
	 */
    SSIOInsertionOrder();
    SSIOInsertionOrder(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_SSIOInsertionOrder_H_ */
