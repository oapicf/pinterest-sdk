...
#ifndef TINY_CPP_CLIENT_LocalStoreBatchUpdate_H_
#define TINY_CPP_CLIENT_LocalStoreBatchUpdate_H_
...
public:
    ...
    LocalStoreBatchUpdate(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_LocalStoreBatchUpdate_H_ */
