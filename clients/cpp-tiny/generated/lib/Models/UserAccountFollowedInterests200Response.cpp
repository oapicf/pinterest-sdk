...
{
	bookmark = std::string();
	items = std::list<Interest>();
}

User_account_followed_interests_200_response::User_account_followed_interests_200_response(std::string jsonString)
{
...
void
User_account_followed_interests_200_response::fromJson(std::string jsonObj)
{
...
User_account_followed_interests_200_response::toJson()
{
    ...
    std::list<Interest> items_list = getItems();
