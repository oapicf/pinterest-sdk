...
ScheduleBidOptions::ScheduleBidOptions(std::string jsonString)
{
...
void
ScheduleBidOptions::fromJson(std::string jsonObj)
{
...
ScheduleBidOptions::getAgeBucketMultipliers()
{
	return age_bucket_multipliers;
}

void
ScheduleBidOptions::setAgeBucketMultipliers(ScheduleAgeBucketMultipliers&lt;std::string, double&gt; age_bucket_multipliers)
{
	this->age_bucket_multipliers = age_bucket_multipliers;
}

ScheduleAppTypeMultipliers&lt;std::string, double&gt;
ScheduleBidOptions::getAppTypeMultipliers()
{
	return app_type_multipliers;
}

void
ScheduleBidOptions::setAppTypeMultipliers(ScheduleAppTypeMultipliers&lt;std::string, double&gt; app_type_multipliers)
{
	this->app_type_multipliers = app_type_multipliers;
}

ScheduleAudienceMultipliers&lt;std::string, double&gt;
ScheduleBidOptions::getAudienceMultipliers()
{
	return audience_multipliers;
}

void
ScheduleBidOptions::setAudienceMultipliers(ScheduleAudienceMultipliers&lt;std::string, double&gt; audience_multipliers)
{
	this->audience_multipliers = audience_multipliers;
}

ScheduleBidOptions_gender_multipliers&lt;std::string, double&gt;
ScheduleBidOptions::getGenderMultipliers()
{
	return gender_multipliers;
}

void
ScheduleBidOptions::setGenderMultipliers(ScheduleBidOptions_gender_multipliers&lt;std::string, double&gt; gender_multipliers)
{
	this->gender_multipliers = gender_multipliers;
}

ScheduleBidOptions_placement_multipliers
ScheduleBidOptions::getPlacementMultipliers()
{
	return placement_multipliers;
}

void
ScheduleBidOptions::setPlacementMultipliers(ScheduleBidOptions_placement_multipliers placement_multipliers)
{
