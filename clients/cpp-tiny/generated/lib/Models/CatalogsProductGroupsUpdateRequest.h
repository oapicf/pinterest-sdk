...
#ifndef TINY_CPP_CLIENT_Catalogs_product_groups_update_request_H_
#define TINY_CPP_CLIENT_Catalogs_product_groups_update_request_H_
...
public:
    ...
    Catalogs_product_groups_update_request(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_Catalogs_product_groups_update_request_H_ */
