...
#ifndef TINY_CPP_CLIENT_IntegrationRequestPatch_H_
#define TINY_CPP_CLIENT_IntegrationRequestPatch_H_
...
public:
    ...
    IntegrationRequestPatch(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_IntegrationRequestPatch_H_ */
