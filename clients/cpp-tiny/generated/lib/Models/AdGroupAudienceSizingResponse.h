...
#ifndef TINY_CPP_CLIENT_AdGroupAudienceSizingResponse_H_
#define TINY_CPP_CLIENT_AdGroupAudienceSizingResponse_H_
...
public:
    ...
    AdGroupAudienceSizingResponse(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_AdGroupAudienceSizingResponse_H_ */
