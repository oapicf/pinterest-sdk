...
#ifndef TINY_CPP_CLIENT_AdCreateRequest_H_
#define TINY_CPP_CLIENT_AdCreateRequest_H_
...
public:
	 ...
	 */
    AdCreateRequest();
    AdCreateRequest(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_AdCreateRequest_H_ */
