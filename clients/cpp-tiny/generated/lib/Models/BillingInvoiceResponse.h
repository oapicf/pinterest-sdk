...
#ifndef TINY_CPP_CLIENT_BillingInvoiceResponse_H_
#define TINY_CPP_CLIENT_BillingInvoiceResponse_H_
...
public:
    ...
    BillingInvoiceResponse(std::string jsonString);
	 ...
	 */
	void setDocumentType(std::string  document_type);
...
#endif /* TINY_CPP_CLIENT_BillingInvoiceResponse_H_ */
