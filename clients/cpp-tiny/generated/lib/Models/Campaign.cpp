...
Campaign::Campaign(std::string jsonString)
{
...
void
Campaign::fromJson(std::string jsonObj)
{
...
bool
Campaign::isIsAutomatedCampaign()
{
...
bool
Campaign::isIsCampaignBudgetOptimization()
{
...
bool
Campaign::isIsFlexibleDailyBudgets()
{
