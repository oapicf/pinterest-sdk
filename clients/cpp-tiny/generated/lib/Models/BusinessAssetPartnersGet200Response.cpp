...
Business_asset_partners_get_200_response::Business_asset_partners_get_200_response(std::string jsonString)
{
...
void
Business_asset_partners_get_200_response::fromJson(std::string jsonObj)
{
