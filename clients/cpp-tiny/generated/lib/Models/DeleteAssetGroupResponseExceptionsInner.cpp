...
DeleteAssetGroupResponse_exceptions_inner::DeleteAssetGroupResponse_exceptions_inner(std::string jsonString)
{
...
void
DeleteAssetGroupResponse_exceptions_inner::fromJson(std::string jsonObj)
{
