...
#ifndef TINY_CPP_CLIENT_Catalogs_creative_assets_filter_values_map_H_
#define TINY_CPP_CLIENT_Catalogs_creative_assets_filter_values_map_H_
...
public:
    ...
    Catalogs_creative_assets_filter_values_map(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_Catalogs_creative_assets_filter_values_map_H_ */
