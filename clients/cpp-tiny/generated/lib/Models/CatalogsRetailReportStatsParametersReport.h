...
#ifndef TINY_CPP_CLIENT_CatalogsRetailReportStatsParametersReport_H_
#define TINY_CPP_CLIENT_CatalogsRetailReportStatsParametersReport_H_
...
public:
    ...
    CatalogsRetailReportStatsParametersReport(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_CatalogsRetailReportStatsParametersReport_H_ */
