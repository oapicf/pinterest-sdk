...
#ifndef TINY_CPP_CLIENT_CatalogsUpsertCreativeAssetsItem_H_
#define TINY_CPP_CLIENT_CatalogsUpsertCreativeAssetsItem_H_
...
public:
    ...
    CatalogsUpsertCreativeAssetsItem(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_CatalogsUpsertCreativeAssetsItem_H_ */
