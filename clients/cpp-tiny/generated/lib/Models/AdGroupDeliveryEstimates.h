...
#ifndef TINY_CPP_CLIENT_AdGroupDeliveryEstimates_H_
#define TINY_CPP_CLIENT_AdGroupDeliveryEstimates_H_
...
public:
    ...
    AdGroupDeliveryEstimates(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_AdGroupDeliveryEstimates_H_ */
