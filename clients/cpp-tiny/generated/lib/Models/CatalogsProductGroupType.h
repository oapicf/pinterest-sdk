...
#ifndef TINY_CPP_CLIENT_CatalogsProductGroupType_H_
#define TINY_CPP_CLIENT_CatalogsProductGroupType_H_
...
public:
    ...
    CatalogsProductGroupType(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_CatalogsProductGroupType_H_ */
