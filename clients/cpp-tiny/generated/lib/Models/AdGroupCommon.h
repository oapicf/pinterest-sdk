...
#ifndef TINY_CPP_CLIENT_AdGroupCommon_H_
#define TINY_CPP_CLIENT_AdGroupCommon_H_
...
public:
	 ...
	 */
    AdGroupCommon();
    AdGroupCommon(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_AdGroupCommon_H_ */
