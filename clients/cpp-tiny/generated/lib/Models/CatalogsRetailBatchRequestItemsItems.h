...
#ifndef TINY_CPP_CLIENT_CatalogsRetailBatchRequestItemsItems_H_
#define TINY_CPP_CLIENT_CatalogsRetailBatchRequestItemsItems_H_
...
public:
    ...
    CatalogsRetailBatchRequestItemsItems(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_CatalogsRetailBatchRequestItemsItems_H_ */
