...
#ifndef TINY_CPP_CLIENT_LeadFormCreate_H_
#define TINY_CPP_CLIENT_LeadFormCreate_H_
...
public:
	 ...
	 */
    LeadFormCreate();
    LeadFormCreate(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_LeadFormCreate_H_ */
