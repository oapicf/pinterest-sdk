...
#ifndef TINY_CPP_CLIENT_BusinessToAdAccountSharedAudienceUpdateWithRequiredBody_H_
#define TINY_CPP_CLIENT_BusinessToAdAccountSharedAudienceUpdateWithRequiredBody_H_
...
public:
    ...
    BusinessToAdAccountSharedAudienceUpdateWithRequiredBody(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_BusinessToAdAccountSharedAudienceUpdateWithRequiredBody_H_ */
