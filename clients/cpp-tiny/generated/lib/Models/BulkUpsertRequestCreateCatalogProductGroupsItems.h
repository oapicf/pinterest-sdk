...
#ifndef TINY_CPP_CLIENT_BulkUpsertRequestCreateCatalogProductGroupsItems_H_
#define TINY_CPP_CLIENT_BulkUpsertRequestCreateCatalogProductGroupsItems_H_
...
public:
    ...
    BulkUpsertRequestCreateCatalogProductGroupsItems(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_BulkUpsertRequestCreateCatalogProductGroupsItems_H_ */
