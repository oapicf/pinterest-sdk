...
#ifndef TINY_CPP_CLIENT_ScheduleBidOptions_H_
#define TINY_CPP_CLIENT_ScheduleBidOptions_H_
...
public:
	 ...
	 */
    ScheduleBidOptions();
    ScheduleBidOptions(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_ScheduleBidOptions_H_ */
