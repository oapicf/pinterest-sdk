...
#ifndef TINY_CPP_CLIENT_UserWebsiteVerificationCode_H_
#define TINY_CPP_CLIENT_UserWebsiteVerificationCode_H_
...
public:
    ...
    UserWebsiteVerificationCode(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_UserWebsiteVerificationCode_H_ */
