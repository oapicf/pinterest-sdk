...
#ifndef TINY_CPP_CLIENT_AdGroupResponse_H_
#define TINY_CPP_CLIENT_AdGroupResponse_H_
...
public:
	 ...
	 */
    AdGroupResponse();
    AdGroupResponse(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_AdGroupResponse_H_ */
