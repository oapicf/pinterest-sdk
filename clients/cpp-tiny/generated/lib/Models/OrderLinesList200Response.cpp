...
{
	bookmark = std::string();
	items = std::list<OrderLine>();
}

Order_lines_list_200_response::Order_lines_list_200_response(std::string jsonString)
{
...
void
Order_lines_list_200_response::fromJson(std::string jsonObj)
{
...
Order_lines_list_200_response::toJson()
{
    ...
    std::list<OrderLine> items_list = getItems();
