...
#ifndef TINY_CPP_CLIENT_CatalogsHotelReportParametersReport_H_
#define TINY_CPP_CLIENT_CatalogsHotelReportParametersReport_H_
...
public:
    ...
    CatalogsHotelReportParametersReport(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_CatalogsHotelReportParametersReport_H_ */
