...
#ifndef TINY_CPP_CLIENT_CatalogsFeedUpdateRequestSchema_H_
#define TINY_CPP_CLIENT_CatalogsFeedUpdateRequestSchema_H_
...
public:
    ...
    CatalogsFeedUpdateRequestSchema(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_CatalogsFeedUpdateRequestSchema_H_ */
