...
#ifndef TINY_CPP_CLIENT_RetailLocalInventoryItemAttributesOptional_H_
#define TINY_CPP_CLIENT_RetailLocalInventoryItemAttributesOptional_H_
...
public:
    ...
    RetailLocalInventoryItemAttributesOptional(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_RetailLocalInventoryItemAttributesOptional_H_ */
