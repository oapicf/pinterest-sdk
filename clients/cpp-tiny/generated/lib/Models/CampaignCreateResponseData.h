...
#ifndef TINY_CPP_CLIENT_CampaignCreateResponseData_H_
#define TINY_CPP_CLIENT_CampaignCreateResponseData_H_
...
public:
    ...
    CampaignCreateResponseData(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_CampaignCreateResponseData_H_ */
