...
#ifndef TINY_CPP_CLIENT_BrandAccountUpdate_H_
#define TINY_CPP_CLIENT_BrandAccountUpdate_H_
...
public:
	 ...
	 */
    BrandAccountUpdate();
    BrandAccountUpdate(std::string jsonString);
	...
	/*! \brief Get 
	 */
	BrandAccountProfileImageUpdate getProfileImage();

	/*! \brief Set 
	 */
	void setProfileImage(BrandAccountProfileImageUpdate profile_image);
    ...
    Country country;
    std::string name{};
    BrandAccountProfileImageUpdate profile_image;
    std::string username{};
    std::string website{};
};
}

#endif /* TINY_CPP_CLIENT_BrandAccountUpdate_H_ */
