...
#ifndef TINY_CPP_CLIENT_CampaignCreateCommon_H_
#define TINY_CPP_CLIENT_CampaignCreateCommon_H_
...
public:
    ...
    CampaignCreateCommon(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_CampaignCreateCommon_H_ */
