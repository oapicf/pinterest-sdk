...
#ifndef TINY_CPP_CLIENT_UpdateMemberAssetAccessItem_H_
#define TINY_CPP_CLIENT_UpdateMemberAssetAccessItem_H_
...
public:
    ...
    UpdateMemberAssetAccessItem(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_UpdateMemberAssetAccessItem_H_ */
