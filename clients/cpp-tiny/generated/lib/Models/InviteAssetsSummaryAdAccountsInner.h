...
#ifndef TINY_CPP_CLIENT_InviteAssetsSummary_ad_accounts_inner_H_
#define TINY_CPP_CLIENT_InviteAssetsSummary_ad_accounts_inner_H_
...
public:
    ...
    InviteAssetsSummary_ad_accounts_inner(std::string jsonString);


    /*! \brief Destructor.
	 */
    virtual ~InviteAssetsSummary_ad_accounts_inner();
...
#endif /* TINY_CPP_CLIENT_InviteAssetsSummary_ad_accounts_inner_H_ */
