...
#ifndef TINY_CPP_CLIENT_Feeds_create_request_H_
#define TINY_CPP_CLIENT_Feeds_create_request_H_
...
public:
    ...
    Feeds_create_request(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_Feeds_create_request_H_ */
