...
#ifndef TINY_CPP_CLIENT_CatalogsVerticalFeedsCreateRequest_H_
#define TINY_CPP_CLIENT_CatalogsVerticalFeedsCreateRequest_H_
...
public:
    ...
    CatalogsVerticalFeedsCreateRequest(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_CatalogsVerticalFeedsCreateRequest_H_ */
