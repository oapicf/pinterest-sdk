...
#ifndef TINY_CPP_CLIENT_ScheduleGenderMultipliers_H_
#define TINY_CPP_CLIENT_ScheduleGenderMultipliers_H_
...
public:
    ...
    ScheduleGenderMultipliers(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_ScheduleGenderMultipliers_H_ */
