...
#ifndef TINY_CPP_CLIENT_LeadFormBatchUpdate_H_
#define TINY_CPP_CLIENT_LeadFormBatchUpdate_H_
...
public:
	 ...
	 */
    LeadFormBatchUpdate();
    LeadFormBatchUpdate(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_LeadFormBatchUpdate_H_ */
