...
#ifndef TINY_CPP_CLIENT_SupplementalOperationResult_H_
#define TINY_CPP_CLIENT_SupplementalOperationResult_H_
...
/*! \brief Result of a supplemental item operation, discriminated by supplemental_type
 *
 *  \ingroup Models
 *
 */
...
public:
    ...
    SupplementalOperationResult(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_SupplementalOperationResult_H_ */
