...
#ifndef TINY_CPP_CLIENT_CatalogsVerticalFeedsUpdateRequest_H_
#define TINY_CPP_CLIENT_CatalogsVerticalFeedsUpdateRequest_H_
...
public:
    ...
    CatalogsVerticalFeedsUpdateRequest(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_CatalogsVerticalFeedsUpdateRequest_H_ */
