...
#ifndef TINY_CPP_CLIENT_UserWebsiteSummary_H_
#define TINY_CPP_CLIENT_UserWebsiteSummary_H_
...
public:
	 ...
	 */
    UserWebsiteSummary();
    UserWebsiteSummary(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_UserWebsiteSummary_H_ */
