...
#ifndef TINY_CPP_CLIENT_AdAccountGetSubscriptionResponse_H_
#define TINY_CPP_CLIENT_AdAccountGetSubscriptionResponse_H_
...
public:
    ...
    AdAccountGetSubscriptionResponse(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_AdAccountGetSubscriptionResponse_H_ */
