...
#ifndef TINY_CPP_CLIENT_ScheduleCreate_H_
#define TINY_CPP_CLIENT_ScheduleCreate_H_
...
public:
	 ...
	 */
    ScheduleCreate();
    ScheduleCreate(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_ScheduleCreate_H_ */
