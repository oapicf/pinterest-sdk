...
#ifndef TINY_CPP_CLIENT_ScheduleBatchUpdate_H_
#define TINY_CPP_CLIENT_ScheduleBatchUpdate_H_
...
public:
	 ...
	 */
    ScheduleBatchUpdate();
    ScheduleBatchUpdate(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_ScheduleBatchUpdate_H_ */
