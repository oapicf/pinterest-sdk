...
AdvancedAuctionItemsSubmitRecord::AdvancedAuctionItemsSubmitRecord(std::string jsonString)
{
...
void
AdvancedAuctionItemsSubmitRecord::fromJson(std::string jsonObj)
{
...
bourne::json
AdvancedAuctionItemsSubmitRecord::toJson()
{
...
Country
AdvancedAuctionItemsSubmitRecord::getCountry()
{
	return country;
}
...
std::string
AdvancedAuctionItemsSubmitRecord::getItemId()
{
	return item_id;
}
...
Language
AdvancedAuctionItemsSubmitRecord::getLanguage()
{
	return language;
}
...
AdvancedAuctionItemsSubmitRecord::getUpdateMask()
{
	return update_mask;
}
