...
#ifndef TINY_CPP_CLIENT_TopPinsAnalyticsResponse_pins_inner_H_
#define TINY_CPP_CLIENT_TopPinsAnalyticsResponse_pins_inner_H_
...
public:
    ...
    TopPinsAnalyticsResponse_pins_inner(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_TopPinsAnalyticsResponse_pins_inner_H_ */
