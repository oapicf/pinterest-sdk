...
#ifndef TINY_CPP_CLIENT_TopPinsAnalyticsResponsePinsItems_H_
#define TINY_CPP_CLIENT_TopPinsAnalyticsResponsePinsItems_H_
...
public:
    ...
    TopPinsAnalyticsResponsePinsItems(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_TopPinsAnalyticsResponsePinsItems_H_ */
