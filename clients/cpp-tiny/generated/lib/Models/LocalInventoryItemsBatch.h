...
#ifndef TINY_CPP_CLIENT_LocalInventoryItemsBatch_H_
#define TINY_CPP_CLIENT_LocalInventoryItemsBatch_H_
...
public:
    ...
    LocalInventoryItemsBatch(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_LocalInventoryItemsBatch_H_ */
