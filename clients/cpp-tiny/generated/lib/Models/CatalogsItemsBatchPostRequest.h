...
#ifndef TINY_CPP_CLIENT_CatalogsItemsBatchPostRequest_H_
#define TINY_CPP_CLIENT_CatalogsItemsBatchPostRequest_H_
...
public:
    ...
    CatalogsItemsBatchPostRequest(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_CatalogsItemsBatchPostRequest_H_ */
