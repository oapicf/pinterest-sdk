...
#ifndef TINY_CPP_CLIENT_CatalogsHotelReportStatsParameters_report_H_
#define TINY_CPP_CLIENT_CatalogsHotelReportStatsParameters_report_H_
...
public:
    ...
    CatalogsHotelReportStatsParameters_report(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_CatalogsHotelReportStatsParameters_report_H_ */
