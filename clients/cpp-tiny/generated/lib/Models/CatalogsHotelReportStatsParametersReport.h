...
#ifndef TINY_CPP_CLIENT_CatalogsHotelReportStatsParametersReport_H_
#define TINY_CPP_CLIENT_CatalogsHotelReportStatsParametersReport_H_
...
public:
    ...
    CatalogsHotelReportStatsParametersReport(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_CatalogsHotelReportStatsParametersReport_H_ */
