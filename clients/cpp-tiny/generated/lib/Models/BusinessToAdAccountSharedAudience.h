...
#ifndef TINY_CPP_CLIENT_BusinessToAdAccountSharedAudience_H_
#define TINY_CPP_CLIENT_BusinessToAdAccountSharedAudience_H_
...
public:
    ...
    BusinessToAdAccountSharedAudience(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_BusinessToAdAccountSharedAudience_H_ */
