...
#ifndef TINY_CPP_CLIENT_CampaignCreateRequest_H_
#define TINY_CPP_CLIENT_CampaignCreateRequest_H_
...
public:
    ...
    CampaignCreateRequest(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_CampaignCreateRequest_H_ */
