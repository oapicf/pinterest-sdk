...
ItemAttributes::ItemAttributes()
{
	...
	image_link = std::list<std::string>();
	video_link = std::string();
}

ItemAttributes::ItemAttributes(std::string jsonString)
{
...
void
ItemAttributes::fromJson(std::string jsonObj)
{
    ...
    if(object.has_key(image_linkKey))
    {
        ...
        std::list<std::string> image_link_list;
        std::string element;
        for(auto& var : value.array_range())
        {
            ...
            image_link_list.push_back(element);
        }
...
ItemAttributes::toJson()
{
    ...
    std::list<std::string> image_link_list = getImageLink();
    bourne::json image_link_arr = bourne::json::array();

    for(auto& var : image_link_list)
    {
        image_link_arr.append(var);
    }
    object["image_link"] = image_link_arr;
...
void
ItemAttributes::setAverageReviewRating(long average_review_rating)
{
...
bool
ItemAttributes::isCheckoutEnabled()
{
...
bool
ItemAttributes::isFreeShippingLabel()
{
...
void
ItemAttributes::setLastUpdatedTime(long last_updated_time)
{
