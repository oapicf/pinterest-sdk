...
#ifndef TINY_CPP_CLIENT_KeywordUpdateGenerated_H_
#define TINY_CPP_CLIENT_KeywordUpdateGenerated_H_
...
public:
    ...
    KeywordUpdateGenerated(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_KeywordUpdateGenerated_H_ */
