...
#ifndef TINY_CPP_CLIENT_CustomerListUploadResponse_H_
#define TINY_CPP_CLIENT_CustomerListUploadResponse_H_
...
public:
    ...
    CustomerListUploadResponse(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_CustomerListUploadResponse_H_ */
