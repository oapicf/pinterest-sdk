...
#ifndef TINY_CPP_CLIENT_AudienceInsights_H_
#define TINY_CPP_CLIENT_AudienceInsights_H_
...
public:
	 ...
	 */
    AudienceInsights();
    AudienceInsights(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_AudienceInsights_H_ */
