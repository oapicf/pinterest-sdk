...
#ifndef TINY_CPP_CLIENT_CatalogsProductGroupFiltersAllOf_H_
#define TINY_CPP_CLIENT_CatalogsProductGroupFiltersAllOf_H_
...
public:
    ...
    CatalogsProductGroupFiltersAllOf(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_CatalogsProductGroupFiltersAllOf_H_ */
