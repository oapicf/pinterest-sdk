...
#ifndef TINY_CPP_CLIENT_TargetingSpecOperationInterest_H_
#define TINY_CPP_CLIENT_TargetingSpecOperationInterest_H_
...
public:
    ...
    TargetingSpecOperationInterest(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_TargetingSpecOperationInterest_H_ */
