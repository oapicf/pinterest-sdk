...
#ifndef TINY_CPP_CLIENT_LocalStoreCreate_H_
#define TINY_CPP_CLIENT_LocalStoreCreate_H_
...
public:
	 ...
	 */
    LocalStoreCreate();
    LocalStoreCreate(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_LocalStoreCreate_H_ */
