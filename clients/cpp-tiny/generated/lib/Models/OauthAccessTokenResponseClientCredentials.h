...
#ifndef TINY_CPP_CLIENT_OauthAccessTokenResponseClientCredentials_H_
#define TINY_CPP_CLIENT_OauthAccessTokenResponseClientCredentials_H_
...
public:
    ...
    OauthAccessTokenResponseClientCredentials(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_OauthAccessTokenResponseClientCredentials_H_ */
