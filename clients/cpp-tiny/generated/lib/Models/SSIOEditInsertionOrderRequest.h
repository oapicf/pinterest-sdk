...
#ifndef TINY_CPP_CLIENT_SSIOEditInsertionOrderRequest_H_
#define TINY_CPP_CLIENT_SSIOEditInsertionOrderRequest_H_
...
public:
    ...
    SSIOEditInsertionOrderRequest(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_SSIOEditInsertionOrderRequest_H_ */
