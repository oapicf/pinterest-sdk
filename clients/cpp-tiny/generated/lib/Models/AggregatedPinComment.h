...
/*
 * AggregatedPinComment.h
 *
 * 
 */

#ifndef TINY_CPP_CLIENT_AggregatedPinComment_H_
#define TINY_CPP_CLIENT_AggregatedPinComment_H_
...
public:
    ...
    AggregatedPinComment(std::string jsonString);


    /*! \brief Destructor.
	 */
    virtual ~AggregatedPinComment();
...
#endif /* TINY_CPP_CLIENT_AggregatedPinComment_H_ */
