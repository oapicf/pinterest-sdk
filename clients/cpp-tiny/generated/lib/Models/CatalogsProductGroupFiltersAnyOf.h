...
#ifndef TINY_CPP_CLIENT_CatalogsProductGroupFiltersAnyOf_H_
#define TINY_CPP_CLIENT_CatalogsProductGroupFiltersAnyOf_H_
...
public:
    ...
    CatalogsProductGroupFiltersAnyOf(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_CatalogsProductGroupFiltersAnyOf_H_ */
