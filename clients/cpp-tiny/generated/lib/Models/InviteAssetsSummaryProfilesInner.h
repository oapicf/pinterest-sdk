...
#ifndef TINY_CPP_CLIENT_InviteAssetsSummary_profiles_inner_H_
#define TINY_CPP_CLIENT_InviteAssetsSummary_profiles_inner_H_
...
public:
    ...
    InviteAssetsSummary_profiles_inner(std::string jsonString);


    /*! \brief Destructor.
	 */
    virtual ~InviteAssetsSummary_profiles_inner();
...
#endif /* TINY_CPP_CLIENT_InviteAssetsSummary_profiles_inner_H_ */
