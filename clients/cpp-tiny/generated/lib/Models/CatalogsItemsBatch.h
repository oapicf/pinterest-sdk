...
#ifndef TINY_CPP_CLIENT_CatalogsItemsBatch_H_
#define TINY_CPP_CLIENT_CatalogsItemsBatch_H_
...
public:
	 ...
	 */
    CatalogsItemsBatch();
    CatalogsItemsBatch(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_CatalogsItemsBatch_H_ */
