...
#ifndef TINY_CPP_CLIENT_AdAccountCreateSubscriptionRequest_partner_metadata_H_
#define TINY_CPP_CLIENT_AdAccountCreateSubscriptionRequest_partner_metadata_H_
...
public:
    ...
    AdAccountCreateSubscriptionRequest_partner_metadata(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_AdAccountCreateSubscriptionRequest_partner_metadata_H_ */
