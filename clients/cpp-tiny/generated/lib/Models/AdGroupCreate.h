...
#ifndef TINY_CPP_CLIENT_AdGroupCreate_H_
#define TINY_CPP_CLIENT_AdGroupCreate_H_
...
public:
	 ...
	 */
    AdGroupCreate();
    AdGroupCreate(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_AdGroupCreate_H_ */
