...
#ifndef TINY_CPP_CLIENT_CancelInviteResultUser_H_
#define TINY_CPP_CLIENT_CancelInviteResultUser_H_
...
public:
    ...
    CancelInviteResultUser(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_CancelInviteResultUser_H_ */
