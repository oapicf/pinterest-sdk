...
public:
	...
	/*! \brief Get 
	 */
	ItemAttributesRequestImageLink getImageLink();

	/*! \brief Set 
	 */
	void setImageLink(ItemAttributesRequestImageLink image_link);
	...
	/*! \brief Get <= 2,000 characters Hosted link to the product video. File types for linked videos must be .mp4, .mov or .m4v. File size cannot exceed 2GB.
	 */
	std::string getVideoLink();

	/*! \brief Set <= 2,000 characters Hosted link to the product video. File types for linked videos must be .mp4, .mov or .m4v. File size cannot exceed 2GB.
	 */
    ...
    std::string id{};
    ItemAttributesRequestImageLink image_link;
