...
#ifndef TINY_CPP_CLIENT_ItemAttributesRequest_H_
#define TINY_CPP_CLIENT_ItemAttributesRequest_H_
...
public:
    ...
    ItemAttributesRequest(std::string jsonString);
	...
	/*! \brief Get 
	 */
	ItemAttributesRequest_allOf_image_link getImageLink();

	/*! \brief Set 
	 */
	void setImageLink(ItemAttributesRequest_allOf_image_link  image_link);
	/*! \brief Get By default, product pins created from a catalog are able to be saved by Pinners. If you want to disable the save pin feature, set this attribute to true. This feature is only available for allowlisted merchants. Please contact your account manager to enable this feature.
	 */
	bool isSavePinDisabled();

	/*! \brief Set By default, product pins created from a catalog are able to be saved by Pinners. If you want to disable the save pin feature, set this attribute to true. This feature is only available for allowlisted merchants. Please contact your account manager to enable this feature.
	 */
	void setSavePinDisabled(bool  save_pin_disabled);
	/*! \brief Get <p><= 2,000 characters</p> <p>Hosted link to the product video.</p> <p>File types for linked videos must be .mp4, .mov or .m4v.</p> <p>File size cannot exceed 2GB.</p>
	 */
	std::string getVideoLink();

	/*! \brief Set <p><= 2,000 characters</p> <p>Hosted link to the product video.</p> <p>File types for linked videos must be .mp4, .mov or .m4v.</p> <p>File size cannot exceed 2GB.</p>
	 */
    ...
    ItemAttributesRequest_allOf_image_link image_link;
    bool save_pin_disabled{};
    std::string video_link{};
};
}

#endif /* TINY_CPP_CLIENT_ItemAttributesRequest_H_ */
