...
#ifndef TINY_CPP_CLIENT_GenderMultipliers_H_
#define TINY_CPP_CLIENT_GenderMultipliers_H_
...
public:
	 ...
	 */
    GenderMultipliers();
    GenderMultipliers(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_GenderMultipliers_H_ */
