...
#ifndef TINY_CPP_CLIENT_CatalogsProductGroupsUpdateRequestSchema_H_
#define TINY_CPP_CLIENT_CatalogsProductGroupsUpdateRequestSchema_H_
...
public:
    ...
    CatalogsProductGroupsUpdateRequestSchema(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_CatalogsProductGroupsUpdateRequestSchema_H_ */
