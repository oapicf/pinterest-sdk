...
#ifndef TINY_CPP_CLIENT_SSIOInsertionOrderCommon_H_
#define TINY_CPP_CLIENT_SSIOInsertionOrderCommon_H_
...
public:
    ...
    SSIOInsertionOrderCommon(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_SSIOInsertionOrderCommon_H_ */
