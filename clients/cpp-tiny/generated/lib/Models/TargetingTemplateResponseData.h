...
#ifndef TINY_CPP_CLIENT_TargetingTemplateResponseData_H_
#define TINY_CPP_CLIENT_TargetingTemplateResponseData_H_
...
public:
    ...
    TargetingTemplateResponseData(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_TargetingTemplateResponseData_H_ */
