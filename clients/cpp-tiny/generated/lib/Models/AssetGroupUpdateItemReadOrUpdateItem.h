...
#ifndef TINY_CPP_CLIENT_AssetGroupUpdateItemReadOrUpdateItem_H_
#define TINY_CPP_CLIENT_AssetGroupUpdateItemReadOrUpdateItem_H_
...
public:
    ...
    AssetGroupUpdateItemReadOrUpdateItem(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_AssetGroupUpdateItemReadOrUpdateItem_H_ */
