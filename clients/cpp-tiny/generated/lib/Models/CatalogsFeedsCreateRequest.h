...
#ifndef TINY_CPP_CLIENT_CatalogsFeedsCreateRequest_H_
#define TINY_CPP_CLIENT_CatalogsFeedsCreateRequest_H_
...
public:
    ...
    CatalogsFeedsCreateRequest(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_CatalogsFeedsCreateRequest_H_ */
