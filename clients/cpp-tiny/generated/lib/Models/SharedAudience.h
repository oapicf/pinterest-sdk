...
#ifndef TINY_CPP_CLIENT_SharedAudience_H_
#define TINY_CPP_CLIENT_SharedAudience_H_
...
public:
	 ...
	 */
    SharedAudience();
    SharedAudience(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_SharedAudience_H_ */
