...
#ifndef TINY_CPP_CLIENT_CampaignResponse_H_
#define TINY_CPP_CLIENT_CampaignResponse_H_
...
public:
	 ...
	 */
    CampaignResponse();
    CampaignResponse(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_CampaignResponse_H_ */
