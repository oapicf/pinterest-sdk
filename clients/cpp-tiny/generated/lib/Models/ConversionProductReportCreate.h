...
#ifndef TINY_CPP_CLIENT_ConversionProductReportCreate_H_
#define TINY_CPP_CLIENT_ConversionProductReportCreate_H_
...
public:
    ...
    ConversionProductReportCreate(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_ConversionProductReportCreate_H_ */
