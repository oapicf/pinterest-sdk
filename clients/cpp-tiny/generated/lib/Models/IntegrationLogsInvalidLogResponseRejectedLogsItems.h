...
#ifndef TINY_CPP_CLIENT_IntegrationLogsInvalidLogResponseRejectedLogsItems_H_
#define TINY_CPP_CLIENT_IntegrationLogsInvalidLogResponseRejectedLogsItems_H_
...
public:
    ...
    IntegrationLogsInvalidLogResponseRejectedLogsItems(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_IntegrationLogsInvalidLogResponseRejectedLogsItems_H_ */
