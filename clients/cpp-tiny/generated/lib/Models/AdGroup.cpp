...
AdGroup::AdGroup(std::string jsonString)
{
...
void
AdGroup::fromJson(std::string jsonObj)
{
...
std::string
AdGroup::getAdAccountId()
{
	return ad_account_id;
}

void
AdGroup::setAdAccountId(std::string ad_account_id)
{
	this->ad_account_id = ad_account_id;
}

int
AdGroup::getBidInMicroCurrency()
{
	return bid_in_micro_currency;
}

void
AdGroup::setBidInMicroCurrency(int bid_in_micro_currency)
{
	this->bid_in_micro_currency = bid_in_micro_currency;
}

BidStrategyType
AdGroup::getBidStrategyType()
{
	return bid_strategy_type;
}

void
AdGroup::setBidStrategyType(BidStrategyType bid_strategy_type)
{
	this->bid_strategy_type = bid_strategy_type;
}

ActionType
AdGroup::getBillableEvent()
{
	return billable_event;
}

void
AdGroup::setBillableEvent(ActionType billable_event)
{
	this->billable_event = billable_event;
}

int
AdGroup::getBudgetInMicroCurrency()
{
	return budget_in_micro_currency;
}

void
AdGroup::setBudgetInMicroCurrency(int budget_in_micro_currency)
{
...
void
AdGroup::setCampaignId(std::string campaign_id)
{
	this->campaign_id = campaign_id;
}

ConversionLearningModeType
AdGroup::getConversionLearningModeType()
{
	return conversion_learning_mode_type;
}

void
AdGroup::setConversionLearningModeType(ConversionLearningModeType conversion_learning_mode_type)
{
	this->conversion_learning_mode_type = conversion_learning_mode_type;
}

int
AdGroup::getCreatedTime()
{
	return created_time;
}

void
AdGroup::setCreatedTime(int created_time)
{
	this->created_time = created_time;
}

std::string
AdGroup::getCustomerSegmentId()
{
	return customer_segment_id;
}

void
AdGroup::setCustomerSegmentId(std::string customer_segment_id)
{
	this->customer_segment_id = customer_segment_id;
}

AnyType
AdGroup::getDcaAssets()
{
	return dca_assets;
}

void
AdGroup::setDcaAssets(AnyType dca_assets)
{
...
void
AdGroup::setEndTime(int end_time)
{
	this->end_time = end_time;
}

AdgroupTrackingFeatures
AdGroup::getExtFeatures()
{
	return ext_features;
}

void
AdGroup::setExtFeatures(AdgroupTrackingFeatures ext_features)
{
	this->ext_features = ext_features;
}

std::string
AdGroup::getFeedProfileId()
{
	return feed_profile_id;
}

void
AdGroup::setFeedProfileId(std::string feed_profile_id)
{
...
void
AdGroup::setId(std::string id)
{
	this->id = id;
}

bool
AdGroup::isIsCreativeOptimization()
{
	return is_creative_optimization;
}

void
AdGroup::setIsCreativeOptimization(bool is_creative_optimization)
{
	this->is_creative_optimization = is_creative_optimization;
}

bool
AdGroup::isIsLocalInventory()
{
	return is_local_inventory;
}

void
AdGroup::setIsLocalInventory(bool is_local_inventory)
{
	this->is_local_inventory = is_local_inventory;
}

int
AdGroup::getLifetimeFrequencyCap()
{
	return lifetime_frequency_cap;
}

void
AdGroup::setLifetimeFrequencyCap(int lifetime_frequency_cap)
{
	this->lifetime_frequency_cap = lifetime_frequency_cap;
}

long
AdGroup::getLocalInventoryRadiusInMiles()
{
	return local_inventory_radius_in_miles;
}

void
AdGroup::setLocalInventoryRadiusInMiles(long local_inventory_radius_in_miles)
{
...
void
AdGroup::setName(std::string name)
{
	this->name = name;
}

NullableOptimizationGoalMetadata
AdGroup::getOptimizationGoalMetadata()
{
	return optimization_goal_metadata;
}

void
AdGroup::setOptimizationGoalMetadata(NullableOptimizationGoalMetadata optimization_goal_metadata)
{
	this->optimization_goal_metadata = optimization_goal_metadata;
}

PerformancePlusCampaignSettings
AdGroup::getPerformancePlusCampaignSettings()
{
	return performance_plus_campaign_settings;
}

void
AdGroup::setPerformancePlusCampaignSettings(PerformancePlusCampaignSettings performance_plus_campaign_settings)
{
	this->performance_plus_campaign_settings = performance_plus_campaign_settings;
}

PlacementGroupType
AdGroup::getPlacementGroup()
{
	return placement_group;
}

void
AdGroup::setPlacementGroup(PlacementGroupType placement_group)
{
	this->placement_group = placement_group;
}

PlacementTrafficType
AdGroup::getPlacementTrafficType()
{
	return placement_traffic_type;
}

void
AdGroup::setPlacementTrafficType(PlacementTrafficType placement_traffic_type)
{
	this->placement_traffic_type = placement_traffic_type;
}

PromotionApplicationLevel
AdGroup::getPromotionApplicationLevel()
{
	return promotion_application_level;
}

void
AdGroup::setPromotionApplicationLevel(PromotionApplicationLevel promotion_application_level)
{
	this->promotion_application_level = promotion_application_level;
}

std::string
AdGroup::getPromotionId()
{
	return promotion_id;
}

void
AdGroup::setPromotionId(std::string promotion_id)
{
	this->promotion_id = promotion_id;
}

std::list<std::string>
AdGroup::getPromotionIds()
{
	return promotion_ids;
}

void
AdGroup::setPromotionIds(std::list<std::string> promotion_ids)
{
	this->promotion_ids = promotion_ids;
}

int
AdGroup::getStartTime()
{
	return start_time;
}

void
AdGroup::setStartTime(int start_time)
{
...
void
AdGroup::setStatus(EntityStatus status)
{
	this->status = status;
}

SummaryStatus
AdGroup::getSummaryStatus()
{
	return summary_status;
}

void
AdGroup::setSummaryStatus(SummaryStatus summary_status)
{
	this->summary_status = summary_status;
}

TargetingSpecOptimal
AdGroup::getTargetingSpec()
{
	return targeting_spec;
}

void
AdGroup::setTargetingSpec(TargetingSpecOptimal targeting_spec)
{
	this->targeting_spec = targeting_spec;
}

std::list<std::string>
AdGroup::getTargetingTemplateIds()
{
	return targeting_template_ids;
}

void
AdGroup::setTargetingTemplateIds(std::list<std::string> targeting_template_ids)
{
	this->targeting_template_ids = targeting_template_ids;
}

AdGroupTrackingURLs
AdGroup::getTrackingUrls()
{
	return tracking_urls;
}

void
AdGroup::setTrackingUrls(AdGroupTrackingURLs tracking_urls)
{
...
void
AdGroup::setType(std::string type)
{
	this->type = type;
}

int
AdGroup::getUpdatedTime()
{
	return updated_time;
}

void
AdGroup::setUpdatedTime(int updated_time)
{
	this->updated_time = updated_time;
}

bool
AdGroup::isAutoTargetingEnabled()
{
	return auto_targeting_enabled;
}

void
AdGroup::setAutoTargetingEnabled(bool auto_targeting_enabled)
{
	this->auto_targeting_enabled = auto_targeting_enabled;
}

long
AdGroup::getBidMultiplier()
{
	return bid_multiplier;
}

void
AdGroup::setBidMultiplier(long bid_multiplier)
{
...
void
AdGroup::setBudgetType(BudgetType budget_type)
{
	this->budget_type = budget_type;
}

PacingDeliveryType
AdGroup::getPacingDeliveryType()
{
	return pacing_delivery_type;
}

void
AdGroup::setPacingDeliveryType(PacingDeliveryType pacing_delivery_type)
{
