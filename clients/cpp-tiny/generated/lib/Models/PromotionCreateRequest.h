...
#ifndef TINY_CPP_CLIENT_PromotionCreateRequest_H_
#define TINY_CPP_CLIENT_PromotionCreateRequest_H_
...
public:
    ...
    PromotionCreateRequest(std::string jsonString);


    /*! \brief Destructor.
	 */
    virtual ~PromotionCreateRequest();
...
#endif /* TINY_CPP_CLIENT_PromotionCreateRequest_H_ */
