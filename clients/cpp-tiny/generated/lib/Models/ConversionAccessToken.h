...
#ifndef TINY_CPP_CLIENT_ConversionAccessToken_H_
#define TINY_CPP_CLIENT_ConversionAccessToken_H_
...
public:
    ...
    ConversionAccessToken(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_ConversionAccessToken_H_ */
