...
#ifndef TINY_CPP_CLIENT_Feeds_update_request_H_
#define TINY_CPP_CLIENT_Feeds_update_request_H_
...
public:
    ...
    Feeds_update_request(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_Feeds_update_request_H_ */
