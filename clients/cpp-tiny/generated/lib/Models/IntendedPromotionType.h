...
#ifndef TINY_CPP_CLIENT_IntendedPromotionType_H_
#define TINY_CPP_CLIENT_IntendedPromotionType_H_
...
public:
    ...
    IntendedPromotionType(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_IntendedPromotionType_H_ */
