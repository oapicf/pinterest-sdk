...
#ifndef TINY_CPP_CLIENT_CatalogsCreativeAssetsFeedsUpdateRequest_H_
#define TINY_CPP_CLIENT_CatalogsCreativeAssetsFeedsUpdateRequest_H_
...
public:
    ...
    CatalogsCreativeAssetsFeedsUpdateRequest(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_CatalogsCreativeAssetsFeedsUpdateRequest_H_ */
