...
#ifndef TINY_CPP_CLIENT_CatalogsRetailFilterValuesMap_H_
#define TINY_CPP_CLIENT_CatalogsRetailFilterValuesMap_H_
...
public:
    ...
    CatalogsRetailFilterValuesMap(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_CatalogsRetailFilterValuesMap_H_ */
