...
#ifndef TINY_CPP_CLIENT_CatalogsHotelAttributes_H_
#define TINY_CPP_CLIENT_CatalogsHotelAttributes_H_
...
public:
    ...
    CatalogsHotelAttributes(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_CatalogsHotelAttributes_H_ */
