...
#ifndef TINY_CPP_CLIENT_LeadFormCreateRequest_H_
#define TINY_CPP_CLIENT_LeadFormCreateRequest_H_
...
public:
    ...
    LeadFormCreateRequest(std::string jsonString);


    /*! \brief Destructor.
	 */
    virtual ~LeadFormCreateRequest();
...
#endif /* TINY_CPP_CLIENT_LeadFormCreateRequest_H_ */
