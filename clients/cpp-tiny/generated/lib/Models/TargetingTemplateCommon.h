...
#ifndef TINY_CPP_CLIENT_TargetingTemplateCommon_H_
#define TINY_CPP_CLIENT_TargetingTemplateCommon_H_
...
public:
    ...
    TargetingTemplateCommon(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_TargetingTemplateCommon_H_ */
