...
#ifndef TINY_CPP_CLIENT_AdAccountToBusinessSharedAudienceUpdateWithRequiredBody_H_
#define TINY_CPP_CLIENT_AdAccountToBusinessSharedAudienceUpdateWithRequiredBody_H_
...
public:
    ...
    AdAccountToBusinessSharedAudienceUpdateWithRequiredBody(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_AdAccountToBusinessSharedAudienceUpdateWithRequiredBody_H_ */
