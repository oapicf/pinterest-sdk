...
#ifndef TINY_CPP_CLIENT_AdGroupCreateCreate_H_
#define TINY_CPP_CLIENT_AdGroupCreateCreate_H_
...
public:
	 ...
	 */
    AdGroupCreateCreate();
    AdGroupCreateCreate(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_AdGroupCreateCreate_H_ */
