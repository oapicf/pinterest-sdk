...
#ifndef TINY_CPP_CLIENT_EventData_H_
#define TINY_CPP_CLIENT_EventData_H_
...
public:
	 ...
	 */
    EventData();
    EventData(std::string jsonString);
	...
	/*! \brief Get Currency. For example, 'USD'.
	 */
	Currency getCurrency();

	/*! \brief Set Currency. For example, 'USD'.
	 */
...
#endif /* TINY_CPP_CLIENT_EventData_H_ */
