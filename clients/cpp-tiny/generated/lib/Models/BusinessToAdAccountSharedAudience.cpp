...
BusinessToAdAccountSharedAudience::BusinessToAdAccountSharedAudience(std::string jsonString)
{
...
void
BusinessToAdAccountSharedAudience::fromJson(std::string jsonObj)
{
