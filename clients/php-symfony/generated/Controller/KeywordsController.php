...
class KeywordsController extends Controller
{
    ...
    public function keywordsGetAction(Request $request, $adAccountId)
    {
        ...
        try {
            ...
            $result = $handler->keywordsGet($adAccountId, $campaignId, $adGroupId, $adGroupIds, $matchTypes, $pageSize, $bookmark, $responseCode, $responseHeaders);
    ...
    public function trendingKeywordsListAction(Request $request, $region, $trendType)
    {
        ...
        $includePrediction = $request->query->get('includePrediction', false);
        $includeDemographics = $request->query->get('includeDemographics', false);
        ...
        try {
            ...
            $includePrediction = $this->deserialize($includePrediction, 'bool', 'string');
        ...
        $asserts = [];
        $asserts[] = new Assert\Type("bool");
        $response = $this->validate($includePrediction, $asserts);
        if ($response instanceof Response) {
            return $response;
        }
        $asserts = [];
        ...
        try {
            ...
            $result = $handler->trendingKeywordsList($region, $trendType, $interests, $genders, $ages, $includeKeywords, $normalizeAgainstGroup, $limit, $includePrediction, $includeDemographics, $responseCode, $responseHeaders);
