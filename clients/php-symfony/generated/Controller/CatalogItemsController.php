...
use OpenAPI\Server\Model\CatalogsItemsBatchPostRequest;
use OpenAPI\Server\Model\CatalogsItemsRequest;
use OpenAPI\Server\Model\ItemsPost200Response;
...
class CatalogItemsController extends Controller
{
    ...
    public function itemsBatchPostAction(Request $request)
    {
        ...
        // Read out all input parameter values into variables
        $adAccountId = $request->query->get('ad_account_id');
        $catalogsItemsBatchPostRequest = $request->getContent();
        ...
        try {
            ...
            $catalogsItemsBatchPostRequest = $this->deserialize($catalogsItemsBatchPostRequest, 'OpenAPI\Server\Model\CatalogsItemsBatchPostRequest', $inputFormat);
            $adAccountId = $this->deserialize($adAccountId, 'string', 'string');
        } catch (SerializerRuntimeException $exception) {
            return $this->createBadRequestResponse($exception->getMessage());
        }
        ...
        $asserts = [];
        $asserts[] = new Assert\NotNull();
        $asserts[] = new Assert\Type('OpenAPI\Server\Model\CatalogsItemsBatchPostRequest');
        $asserts[] = new Assert\Valid();
        $response = $this->validate($catalogsItemsBatchPostRequest, $asserts);
        if ($response instanceof Response) {
            return $response;
        }
        $asserts = [];
        ...
        try {
            ...
            $result = $handler->itemsBatchPost($catalogsItemsBatchPostRequest, $adAccountId, $responseCode, $responseHeaders);
