...
class UserAccountController extends Controller
{
    ...
    public function unverifyWebsiteDeleteAction(Request $request)
    {
        ...
        try {
            ...
            switch ($responseCode) {
                case 204:
                    $message = 'Successfully unverified website';
                    break;
                case 404:
    ...
    public function userAccountAnalyticsAction(Request $request)
    {
        ...
        $asserts = [];
        $asserts[] = new Assert\Choice([ "ALL", "ORGANIC_IMAGE", "ORGANIC_PRODUCT", "ORGANIC_VIDEO", "ADS_STANDARD", "ADS_PRODUCT", "ADS_VIDEO", "ADS_IDEA", "PRODUCT", "REGULAR", "VIDEO" ]);
        $asserts[] = new Assert\Type("string");
    ...
    public function verifyWebsiteUpdateAction(Request $request)
    {
        ...
        try {
            ...
            $result = $handler->verifyWebsiteUpdate($userWebsiteVerifyRequest, $responseCode, $responseHeaders);
    ...
    public function websiteVerificationGetAction(Request $request)
    {
        ...
        try {
            ...
            $result = $handler->websiteVerificationGet($responseCode, $responseHeaders);
