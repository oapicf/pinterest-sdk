...
use OpenAPI\Server\Model\CatalogCreate;
...
class CatalogsController extends Controller
{
    ...
    public function catalogsAvailableFilterValuesAction(Request $request)
    {
        ...
        try {
            ...
            $country = $this->deserialize($country, '\OpenAPI\Server\Model\Country', 'string');
            $language = $this->deserialize($language, '\OpenAPI\Server\Model\CatalogsLocale', 'string');
        ...
        $asserts = [];
        $asserts[] = new Assert\Type('\OpenAPI\Server\Model\Country');
        $response = $this->validate($country, $asserts);
        if ($response instanceof Response) {
            return $response;
        }
        $asserts = [];
        $asserts[] = new Assert\Type('\OpenAPI\Server\Model\CatalogsLocale');
    ...
    public function catalogsCreateAction(Request $request)
    {
        ...
        // Read out all input parameter values into variables
        $adAccountId = $request->query->get('ad_account_id');
        $catalogCreate = $request->getContent();
        ...
        try {
            ...
            $catalogCreate = $this->deserialize($catalogCreate, 'OpenAPI\Server\Model\CatalogCreate', $inputFormat);
            $adAccountId = $this->deserialize($adAccountId, 'string', 'string');
        } catch (SerializerRuntimeException $exception) {
            return $this->createBadRequestResponse($exception->getMessage());
        }
        ...
        $asserts = [];
        $asserts[] = new Assert\NotNull();
        $asserts[] = new Assert\Type('OpenAPI\Server\Model\CatalogCreate');
        $asserts[] = new Assert\Valid();
        $response = $this->validate($catalogCreate, $asserts);
        if ($response instanceof Response) {
            return $response;
        }
        $asserts = [];
        ...
        try {
            ...
            $result = $handler->catalogsCreate($catalogCreate, $adAccountId, $responseCode, $responseHeaders);
    ...
    public function catalogsListAction(Request $request)
    {
        ...
        try {
            ...
            $result = $handler->catalogsList($adAccountId, $bookmark, $pageSize, $responseCode, $responseHeaders);
