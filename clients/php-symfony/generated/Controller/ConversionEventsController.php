        ...
        try {
            ...
            switch ($responseCode) {
                ...
                case 400:
                    ...
                    break;
                case 401:
                    $message = 'Not authorized to send conversion events';
                    break;
                case 403:
                    $message = 'Unauthorized access.';
                    break;
                case 422:
                    $message = 'Not all events were successfully processed.';
                    break;
                case 429:
                    $message = 'This request exceeded a rate limit. This can happen if the client exceeds one of the published rate limits within a short time window.';
                    break;
                case 503:
