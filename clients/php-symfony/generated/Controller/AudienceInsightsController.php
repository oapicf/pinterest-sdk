...
class AudienceInsightsController extends Controller
{
    ...
    public function audienceInsightsGetAction(Request $request, $adAccountId)
    {
        ...
        try {
            ...
            $audienceInsightType = $this->deserialize($audienceInsightType, '\OpenAPI\Server\Model\OpenAPI\Server\Model\AudienceInsightType', 'string');
        ...
        $asserts = [];
        $asserts[] = new Assert\NotNull();
        $asserts[] = new Assert\Type("\OpenAPI\Server\Model\OpenAPI\Server\Model\AudienceInsightType");
