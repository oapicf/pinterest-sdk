...
class AdAccountsController extends Controller
{
    ...
    public function adAccountTargetingAnalyticsGetAction(Request $request, $adAccountId)
    {
        ...
        try {
            ...
            $viewWindowDays = $this->deserialize($viewWindowDays, 'int', 'string');
            $conversionReportTime = $this->deserialize($conversionReportTime, 'string', 'string');
            $attributionTypes = $this->deserialize($attributionTypes, '\OpenAPI\Server\Model\ConversionReportAttributionType', 'string');
        } catch (SerializerRuntimeException $exception) {
            return $this->createBadRequestResponse($exception->getMessage());
        }
        ...
        $asserts = [];
        $asserts[] = new Assert\Type("\OpenAPI\Server\Model\ConversionReportAttributionType");
        ...
        try {
            ...
            $result = $handler->adAccountTargetingAnalyticsGet($adAccountId, $startDate, $endDate, $targetingTypes, $columns, $granularity, $clickWindowDays, $engagementWindowDays, $viewWindowDays, $conversionReportTime, $attributionTypes, $responseCode, $responseHeaders);
    ...
    public function adAccountsCreateAction(Request $request)
    {
        ...
        // Read out all input parameter values into variables
        $adAccountCreateRequest = $request->getContent();
        ...
        try {
            ...
            $adAccountCreateRequest = $this->deserialize($adAccountCreateRequest, 'OpenAPI\Server\Model\AdAccountCreateRequest', $inputFormat);
        } catch (SerializerRuntimeException $exception) {
            return $this->createBadRequestResponse($exception->getMessage());
        }
        ...
        $asserts = [];
        $asserts[] = new Assert\NotNull();
        $asserts[] = new Assert\Type("OpenAPI\Server\Model\AdAccountCreateRequest");
        $asserts[] = new Assert\Valid();
        $response = $this->validate($adAccountCreateRequest, $asserts);
        if ($response instanceof Response) {
            return $response;
        }
        ...
        try {
            ...
            $result = $handler->adAccountsCreate($adAccountCreateRequest, $responseCode, $responseHeaders);
        ...
        try {
            ...
            switch ($responseCode) {
                case 200:
                    ...
                    break;
                case 400:
                    $message = 'Invalid ad account ads analytics template parameters.';
                    break;
                case 0:
                    $message = 'Unexpected error';
                    break;
