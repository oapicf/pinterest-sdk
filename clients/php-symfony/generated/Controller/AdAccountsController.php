...
class AdAccountsController extends Controller
{
    ...
    public function adAccountAnalyticsAction(Request $request, $adAccountId)
    {
        ...
        $reportingTimezone = $request->query->get('reportingTimezone');
        ...
        try {
            ...
            $reportingTimezone = $this->deserialize($reportingTimezone, '\OpenAPI\Server\Model\OpenAPI\Server\Model\ReportingTimeZone', 'string');
        ...
        $asserts = [];
        $asserts[] = new Assert\Type("\OpenAPI\Server\Model\OpenAPI\Server\Model\ReportingTimeZone");
        ...
        try {
            ...
            $result = $handler->adAccountAnalytics($adAccountId, $startDate, $endDate, $columns, $granularity, $clickWindowDays, $engagementWindowDays, $viewWindowDays, $conversionReportTime, $reportingTimezone, $responseCode, $responseHeaders);
    ...
    public function adAccountTargetingAnalyticsGetAction(Request $request, $adAccountId)
    {
        ...
        try {
            ...
            $startDate = $this->deserialize($startDate, '\DateTime', 'string');
            $endDate = $this->deserialize($endDate, '\DateTime', 'string');
            $targetingTypes = $this->deserialize($targetingTypes, 'array<csv,OpenAPI\Server\Model\AdsAnalyticsTargetingType>', 'string');
            $columns = $this->deserialize($columns, 'array<csv,string>', 'string');
            $granularity = $this->deserialize($granularity, '\OpenAPI\Server\Model\OpenAPI\Server\Model\Granularity', 'string');
            $clickWindowDays = $this->deserialize($clickWindowDays, 'int', 'string');
            $engagementWindowDays = $this->deserialize($engagementWindowDays, 'int', 'string');
    ...
    public function adAccountsListAction(Request $request)
    {
        ...
        // Read out all input parameter values into variables
        $includeSharedAccounts = $request->query->get('includeSharedAccounts', true);
    ...
    public function analyticsCreateConversionProductReportAction(Request $request, $adAccountId)
    {
        ...
        // Read out all input parameter values into variables
        $conversionProductReportRequest = $request->getContent();
        ...
        try {
            $adAccountId = $this->deserialize($adAccountId, 'string', 'string');
            $inputFormat = $request->getMimeType($request->getContentTypeFormat());
            $conversionProductReportRequest = $this->deserialize($conversionProductReportRequest, 'OpenAPI\Server\Model\ConversionProductReportRequest', $inputFormat);
        } catch (SerializerRuntimeException $exception) {
            return $this->createBadRequestResponse($exception->getMessage());
        }
        ...
        $asserts = [];
        $asserts[] = new Assert\NotNull();
        $asserts[] = new Assert\Type("OpenAPI\Server\Model\ConversionProductReportRequest");
        $asserts[] = new Assert\Valid();
        $response = $this->validate($conversionProductReportRequest, $asserts);
        if ($response instanceof Response) {
            return $response;
        }
        ...
        try {
            ...
            $result = $handler->analyticsCreateConversionProductReport($adAccountId, $conversionProductReportRequest, $responseCode, $responseHeaders);
    ...
    public function analyticsCreateMmmReportAction(Request $request, $adAccountId)
    {
        ...
        // Read out all input parameter values into variables
        $createMMMReportRequest = $request->getContent();
        ...
        try {
            $adAccountId = $this->deserialize($adAccountId, 'string', 'string');
            $inputFormat = $request->getMimeType($request->getContentTypeFormat());
            $createMMMReportRequest = $this->deserialize($createMMMReportRequest, 'OpenAPI\Server\Model\CreateMMMReportRequest', $inputFormat);
        } catch (SerializerRuntimeException $exception) {
            return $this->createBadRequestResponse($exception->getMessage());
        }
        ...
        $asserts = [];
        $asserts[] = new Assert\NotNull();
        $asserts[] = new Assert\Type("OpenAPI\Server\Model\CreateMMMReportRequest");
        $asserts[] = new Assert\Valid();
        $response = $this->validate($createMMMReportRequest, $asserts);
        if ($response instanceof Response) {
            return $response;
        }
        ...
        try {
            ...
            $result = $handler->analyticsCreateMmmReport($adAccountId, $createMMMReportRequest, $responseCode, $responseHeaders);
    ...
    public function templatesListAction(Request $request, $adAccountId)
    {
        ...
        try {
            ...
            $result = $handler->templatesList($adAccountId, $pageSize, $order, $bookmark, $responseCode, $responseHeaders);
