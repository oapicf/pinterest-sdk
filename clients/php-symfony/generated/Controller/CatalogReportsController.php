...
class CatalogReportsController extends Controller
{
    ...
    public function reportsStatsAction(Request $request)
    {
        ...
        // Deserialize the input values that needs it
        try {
            $parameters = $this->deserialize($parameters, 'OpenAPI\Server\Model\ReportsStatsParametersParameter', 'string');
            $adAccountId = $this->deserialize($adAccountId, 'string', 'string');
        ...
        $asserts = [];
        $asserts[] = new Assert\NotNull();
        $asserts[] = new Assert\Type("OpenAPI\Server\Model\ReportsStatsParametersParameter");
        $asserts[] = new Assert\Valid();
