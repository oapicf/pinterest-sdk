...
use OpenAPI\Server\Model\AdAccountCountriesGet200Response;
use OpenAPI\Server\Model\BookClosed;
use OpenAPI\Server\Model\DeliveryMetricsGet200Response;
use OpenAPI\Server\Model\PinterestLibError;
use OpenAPI\Server\Model\PublicTargetingType;
use OpenAPI\Server\Model\ReportType;
use OpenAPI\Server\Model\SingleInterestTargetingOption;
...
class ResourcesController extends Controller
{
    ...
    public function deliveryMetricsGetAction(Request $request)
    {
        ...
        try {
            $reportType = $this->deserialize($reportType, '\OpenAPI\Server\Model\ReportType', 'string');
        ...
        // Validate the input values
        $asserts = [];
        $asserts[] = new Assert\Type('\OpenAPI\Server\Model\ReportType');
    ...
    public function targetingOptionsGetAction(Request $request, $targetingType)
    {
        ...
        $oauthSignature = $request->query->get('oauth_signature');
        ...
        // Deserialize the input values that needs it
        try {
            $targetingType = $this->deserialize($targetingType, '\OpenAPI\Server\Model\PublicTargetingType', 'string');
        ...
        $asserts = [];
        $asserts[] = new Assert\NotNull();
        $asserts[] = new Assert\Type('\OpenAPI\Server\Model\PublicTargetingType');
        ...
        try {
            ...
            $result = $handler->targetingOptionsGet($targetingType, $adAccountId, $clientId, $oauthSignature, $timestamp, $responseCode, $responseHeaders);
