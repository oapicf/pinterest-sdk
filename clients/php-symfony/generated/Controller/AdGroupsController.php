...
class AdGroupsController extends Controller
{
        ...
        try {
            ...
            switch ($responseCode) {
                ...
                case 400:
                    ...
                    break;
                case 403:
                    $message = 'No access to requested audience list or product group.';
                    break;
                case 0:
                    $message = 'Unexpected error';
                    break;
    ...
    public function adGroupsTargetingAnalyticsGetAction(Request $request, $adAccountId)
    {
        ...
        try {
            ...
            $result = $handler->adGroupsTargetingAnalyticsGet($adAccountId, $adGroupIds, $startDate, $endDate, $targetingTypes, $columns, $granularity, $clickWindowDays, $engagementWindowDays, $viewWindowDays, $conversionReportTime, $attributionTypes, $responseCode, $responseHeaders);
