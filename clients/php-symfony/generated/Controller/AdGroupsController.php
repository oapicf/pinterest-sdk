...
class AdGroupsController extends Controller
{
    ...
    public function adGroupsAnalyticsAction(Request $request, $adAccountId)
    {
        ...
        $aggregateReportRows = $request->query->get('aggregateReportRows', false);
        ...
        try {
            ...
            $result = $handler->adGroupsAnalytics($adAccountId, $startDate, $endDate, $adGroupIds, $columns, $granularity, $clickWindowDays, $engagementWindowDays, $viewWindowDays, $conversionReportTime, $aggregateReportRows, $reportingTimezone, $responseCode, $responseHeaders);
    ...
    public function adGroupsAudienceSizingAction(Request $request, $adAccountId)
    {
        ...
        // Read out all input parameter values into variables
        $adGroupAudienceSizingRequest = $request->getContent();
        ...
        try {
            ...
            $adGroupAudienceSizingRequest = $this->deserialize($adGroupAudienceSizingRequest, 'OpenAPI\Server\Model\AdGroupAudienceSizingRequest', $inputFormat);
        } catch (SerializerRuntimeException $exception) {
            return $this->createBadRequestResponse($exception->getMessage());
        }
        ...
        $asserts = [];
        $asserts[] = new Assert\NotNull();
        $asserts[] = new Assert\Type("OpenAPI\Server\Model\AdGroupAudienceSizingRequest");
        $asserts[] = new Assert\Valid();
        $response = $this->validate($adGroupAudienceSizingRequest, $asserts);
        if ($response instanceof Response) {
            return $response;
        }
        ...
        try {
            ...
            $result = $handler->adGroupsAudienceSizing($adAccountId, $adGroupAudienceSizingRequest, $responseCode, $responseHeaders);
    ...
    public function adGroupsBidFloorGetAction(Request $request, $adAccountId)
    {
        ...
        // Read out all input parameter values into variables
        $bidFloorRequest = $request->getContent();
        ...
        try {
            $adAccountId = $this->deserialize($adAccountId, 'string', 'string');
            $inputFormat = $request->getMimeType($request->getContentTypeFormat());
            $bidFloorRequest = $this->deserialize($bidFloorRequest, 'OpenAPI\Server\Model\BidFloorRequest', $inputFormat);
        } catch (SerializerRuntimeException $exception) {
            return $this->createBadRequestResponse($exception->getMessage());
        }
        ...
        $asserts = [];
        $asserts[] = new Assert\NotNull();
        $asserts[] = new Assert\Type("OpenAPI\Server\Model\BidFloorRequest");
        $asserts[] = new Assert\Valid();
        $response = $this->validate($bidFloorRequest, $asserts);
        if ($response instanceof Response) {
            return $response;
        }
        ...
        try {
            ...
            $result = $handler->adGroupsBidFloorGet($adAccountId, $bidFloorRequest, $responseCode, $responseHeaders);
    ...
    public function adGroupsCreateAction(Request $request, $adAccountId)
    {
        ...
        // Read out all input parameter values into variables
        $adGroupCreateRequest = $request->getContent();
        ...
        try {
            $adAccountId = $this->deserialize($adAccountId, 'string', 'string');
            $inputFormat = $request->getMimeType($request->getContentTypeFormat());
            $adGroupCreateRequest = $this->deserialize($adGroupCreateRequest, 'array<OpenAPI\Server\Model\AdGroupCreateRequest>', $inputFormat);
        } catch (SerializerRuntimeException $exception) {
            return $this->createBadRequestResponse($exception->getMessage());
        }
        ...
        $asserts[] = new Assert\NotNull();
        $asserts[] = new Assert\All([
            new Assert\Type("OpenAPI\Server\Model\AdGroupCreateRequest"),
        ]);
        $asserts[] = new Assert\Valid();
        $asserts[] = new Assert\Count([
            'max' => 30
        ...
        $response = $this->validate($adGroupCreateRequest, $asserts);
        if ($response instanceof Response) {
            return $response;
        }
        ...
        try {
            ...
            $result = $handler->adGroupsCreate($adAccountId, $adGroupCreateRequest, $responseCode, $responseHeaders);
     ...
     * @return Response The Symfony response.
     */
    public function adGroupsGetAction(Request $request, $adAccountId, $adGroupId)
    {
        // Figure out what data format to return to the client
        $produces = ['application/json'];
        // Figure out what the client accepts
        ...
        try {
            ...
            $result = $handler->adGroupsGet($adAccountId, $adGroupId, $responseCode, $responseHeaders);
    ...
    public function adGroupsListAction(Request $request, $adAccountId)
    {
        ...
        $translateInterestsToNames = $request->query->get('translateInterestsToNames', false);
    ...
    public function adGroupsTargetingAnalyticsGetAction(Request $request, $adAccountId)
    {
        ...
        try {
            ...
            $result = $handler->adGroupsTargetingAnalyticsGet($adAccountId, $adGroupIds, $startDate, $endDate, $targetingTypes, $columns, $granularity, $clickWindowDays, $engagementWindowDays, $viewWindowDays, $conversionReportTime, $attributionTypes, $reportingTimezone, $responseCode, $responseHeaders);
    ...
    public function adGroupsUpdateAction(Request $request, $adAccountId)
    {
        ...
        // Read out all input parameter values into variables
        $adGroupUpdateRequest = $request->getContent();
        ...
        try {
            $adAccountId = $this->deserialize($adAccountId, 'string', 'string');
            $inputFormat = $request->getMimeType($request->getContentTypeFormat());
            $adGroupUpdateRequest = $this->deserialize($adGroupUpdateRequest, 'array<OpenAPI\Server\Model\AdGroupUpdateRequest>', $inputFormat);
        } catch (SerializerRuntimeException $exception) {
            return $this->createBadRequestResponse($exception->getMessage());
        }
        ...
        $response = $this->validate($adGroupUpdateRequest, $asserts);
        if ($response instanceof Response) {
            return $response;
        }
        ...
        try {
            ...
            $result = $handler->adGroupsUpdate($adAccountId, $adGroupUpdateRequest, $responseCode, $responseHeaders);
