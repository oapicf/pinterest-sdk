...
class ProductGroupPromotionsController extends Controller
{
    ...
    public function productGroupsAnalyticsAction(Request $request, $adAccountId)
    {
        ...
        try {
            ...
            $result = $handler->productGroupsAnalytics($adAccountId, $startDate, $endDate, $productGroupIds, $columns, $granularity, $clickWindowDays, $engagementWindowDays, $viewWindowDays, $conversionReportTime, $reportingTimezone, $responseCode, $responseHeaders);
