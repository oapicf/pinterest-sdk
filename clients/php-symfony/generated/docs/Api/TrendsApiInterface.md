# OpenAPI\Server\Api\TrendsApiInterface

All URIs are relative to *https://api.pinterest.com/v5*

Method | HTTP request | Description
------------- | ------------- | -------------
[**trendsEditorialArticlesList**](TrendsApiInterface.md#trendsEditorialArticlesList) | **GET** /trends/editorial_articles | Returns editorial articles for a given region
[**trendsFeaturedTopicsList**](TrendsApiInterface.md#trendsFeaturedTopicsList) | **GET** /trends/topics/featured | Get featured topics
[**trendsProductCategoriesDetailsList**](TrendsApiInterface.md#trendsProductCategoriesDetailsList) | **GET** /trends/product_categories/details | Get product category details
[**trendsProductCategoriesTrendingList**](TrendsApiInterface.md#trendsProductCategoriesTrendingList) | **GET** /trends/product_categories/trending | Get a list of growing Shopping Product Categories
...
services:
    # ...
    Acme\MyBundle\Api\TrendsApi:
        tags:
            - { name: "open_api_server.api", api: "trends" }
    # ...
```

## **trendsEditorialArticlesList**
> OpenAPI\Server\Model\TrendsEditorial trendsEditorialArticlesList($region)
...
```php
<?php
// src/Acme/MyBundle/Api/TrendsApiInterface.php

namespace Acme\MyBundle\Api;

use OpenAPI\Server\Api\TrendsApiInterface;

class TrendsApi implements TrendsApiInterface
{
    ...
    /**
     * Implementation of TrendsApiInterface#trendsEditorialArticlesList
     */
    public function trendsEditorialArticlesList(ProductCategoryRegion $region, int &$responseCode, array &$responseHeaders): array|object|null
    {
...
------------- | ------------- | ------------- | -------------
 **region** | [**ProductCategoryRegion**](../Model/.md)| The geographic region of interest. Only top product categories within the specified region will be returned.      The &#x60;region&#x60; parameter is formatted as ISO 3166-2 country codes delimited by &#x60;+&#x60;.      - &#x60;US&#x60; - United States     - &#x60;GB+IE&#x60; - Great Britain &amp; Ireland     - &#x60;CA&#x60; - Canada |

### Return type

[**OpenAPI\Server\Model\TrendsEditorial**](../Model/TrendsEditorial.md)
...
class TrendsApi implements TrendsApiInterface
{
    ...
    /**
     * Implementation of TrendsApiInterface#trendsFeaturedTopicsList
     */
...
------------- | ------------- | ------------- | -------------
 **region** | [**ProductCategoryRegion**](../Model/.md)| The geographic region of interest. Only top product categories within the specified region will be returned.      The &#x60;region&#x60; parameter is formatted as ISO 3166-2 country codes delimited by &#x60;+&#x60;.      - &#x60;US&#x60; - United States     - &#x60;GB+IE&#x60; - Great Britain &amp; Ireland     - &#x60;CA&#x60; - Canada |
 **interest** | [**InterestsEnum**](../Model/.md)| Interest to filter by | [optional]
...
class TrendsApi implements TrendsApiInterface
{
    ...
    /**
     * Implementation of TrendsApiInterface#trendsProductCategoriesDetailsList
     */
 ...
 **region** | [**ProductCategoryRegion**](../Model/.md)| The geographic region of interest. Only top product categories within the specified region will be returned.      The &#x60;region&#x60; parameter is formatted as ISO 3166-2 country codes delimited by &#x60;+&#x60;.      - &#x60;US&#x60; - United States     - &#x60;GB+IE&#x60; - Great Britain &amp; Ireland     - &#x60;CA&#x60; - Canada |
 **lookbackWindow** | [**ProductCategoryDetailLookbackWindow**](../Model/.md)| Time period for historical data analysis in days. The lookback window defines how far back in time the API will analyze data to compute trend metrics.   - &#x60;90&#x60; - Last 90 days (3 months)   - &#x60;180&#x60; - Last 180 days (6 months)   - &#x60;365&#x60; - Last 365 days (1 year)   - &#x60;730&#x60; - Last 730 days (2 years) | [optional]
 **engagementType** | [**ProductCategoriesEngagementType**](../Model/.md)| Type of engagement metric to analyze. - &#x60;ENGAGEMENT&#x60; - Overall engagement metric - &#x60;OUTBOUND_CLICK&#x60; - Number of outbound clicks - &#x60;SAVE&#x60; - Number of pin saves | [optional]
...
class TrendsApi implements TrendsApiInterface
{
    ...
    /**
     * Implementation of TrendsApiInterface#trendsProductCategoriesTrendingList
     */
