...
**createdByBusiness** | **array** | Metadata for the business that created the invite/request. | [optional] 
**createdByUser** | **array** | Metadata for the user that created the invite/request. | [optional] 
