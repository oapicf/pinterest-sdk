...
------------ | ------------- | ------------- | -------------
**demographics** | [**OpenAPI\Server\Model\TrendingKeywordDemographics**](TrendingKeywordDemographics.md) |  | [optional] 
**hasPrediction** | **bool** | Indicates whether the keyword has a prediction available for the next 90 days.&lt;br /&gt; This field is only applicable when &#x60;include_prediction&#x60; query parameter is set to &#x60;true&#x60;. &lt;br /&gt; By default, the value is &#x60;false&#x60; and no prediction data is included in the response. | [optional] 
...
**predictedTimeSeries** | [**OpenAPI\Server\Model\PredictedTimeSeries**](PredictedTimeSeries.md) |  | [optional] 
**timeSeries** | [**OpenAPI\Server\Model\TimeSeries**](TimeSeries.md) |  | [optional] 
