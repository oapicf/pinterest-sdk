...
**eventData** | [**OpenAPI\Server\Model\PinterestTagEventData**](PinterestTagEventData.md) |  | [optional] 
...
**eventSource** | **array** | Optional for VISITOR. You can use it as a {&#39;&#x3D;&#39;: [value]}. Supported values are: web, mobile, offline | [optional] 
**ingestionSource** | **array** | Optional for VISITOR. You can use it as a {&#39;&#x3D;&#39;: [value]}. Supported values are: tag, mmp, file_upload, conversions_api | [optional] 
...
**objectiveType** | [**OpenAPI\Server\Model\ObjectiveType**](ObjectiveType.md) | Objective for engagement audience filter. | [optional] 
