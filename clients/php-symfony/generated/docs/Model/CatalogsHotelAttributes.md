...
**aiDisclosures** | [**OpenAPI\Server\Model\CatalogsAiContentDisclosure**](CatalogsAiContentDisclosure.md) | AI content disclosures for individual assets (main_image.link or additional_image_link) on this hotel item. Each entry declares which disclosure types apply to a single asset URL. | [optional] 
**mainImage** | [**OpenAPI\Server\Model\CatalogsHotelMainImage**](CatalogsHotelMainImage.md) | The main hotel image | [optional] 
