...
services:
    # ...
    acme.my_bundle.api.media:
        class: Acme\MyBundle\Api\MediaApi
        tags:
...
class MediaApi implements MediaApiInterface
{
     ...
     */
    public function mediaCreate(MediaUploadRequest $mediaUploadRequest)
    {
...
class MediaApi implements MediaApiInterface
{
     ...
     */
    public function mediaList($bookmark = null, $pageSize = '25')
    {
        // Implement the operation ...
    }
