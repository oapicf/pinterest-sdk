...
class CatalogsItemsCreateBatchRequest 
{
    ...
    */
     ...
     *
     * @var ItemCreateBatchRecord[]|null
     * @SerializedName("items")
     * @Type("array<OpenAPI\Server\Model\ItemCreateBatchRecord>")
    */
    #[Assert\NotNull]
    #[Assert\Valid]
    #[Assert\All([
        new Assert\Type("OpenAPI\Server\Model\ItemCreateBatchRecord"),
    ])]
    ...
    */
     ...
     * Gets items.
     *
     * @return ItemCreateBatchRecord[]|null
     */
    ...
    * Sets items.
    *
    * @param ItemCreateBatchRecord[]|null $items  Array with catalogs items
    *
    * @return $this
    */
