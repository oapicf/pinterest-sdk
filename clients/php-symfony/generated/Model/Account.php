...
class Account 
{
     ...
     * @Accessor(getter="getSerializedAccountType", setter="setDeserializedAccountType")
     * @Type("string")
     */
    protected ?UserAccountType $accountType = null;
     ...
     * Sets accountType.
     *
     * @param UserAccountType|null $accountType  Type of account
     *
     * @return $this
     */
    public function setAccountType(?UserAccountType $accountType = null): self
    {
    ...
    /**
     * Gets accountType for serialization.
     *
     * @return string|null
     */
    public function getSerializedAccountType(): string|null
    {
        return !is_null($this->accountType?->value) ? (string) $this->accountType->value : null;
    }

    /**
     * Sets accountType.
     *
     * @param string|UserAccountType|null $accountType  Type of account
     *
     * @return $this
     */
    public function setDeserializedAccountType(string|UserAccountType|null $accountType = null): self
    {
        if (is_string($accountType)) {
            $accountType = UserAccountType::tryFrom($accountType);
        }
     ...
     * Sets boardCount.
     *
     * @param int|null $boardCount  User account board count.   **Note**: Board count on user account level may differ from counts found elsewhere due to attribution of collaborative Boards.
     *
     * @return $this
     */
