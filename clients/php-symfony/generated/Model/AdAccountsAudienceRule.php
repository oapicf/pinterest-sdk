...
class AdAccountsAudienceRule 
{
     ...
     * @Type("OpenAPI\Server\Model\EventData")
     */
    #[Assert\Type("OpenAPI\Server\Model\EventData")]
     ...
     */
    #[Assert\All([
        new Assert\Type("OpenAPI\Server\Model\AudienceObjectiveType"),
    ])]
     ...
     * @return $this
     */
    public function setEventData(?EventData $eventData = null): self
    {
     ...
     * Gets objectiveType.
     *
     * @return AudienceObjectiveType[]|null
     */
     ...
     * Sets objectiveType.
     *
     * @param AudienceObjectiveType[]|null $objectiveType  Objective for engagement audience filter.
     *
     * @return $this
     */
    ...
    public function setDeserializedObjectiveType(?array $objectiveType = []): self
    {
        $this->objectiveType = array_map(
            static function ($value) {
                if (is_string($value)) {
                    $value = AudienceObjectiveType::tryFrom($value);
                }
