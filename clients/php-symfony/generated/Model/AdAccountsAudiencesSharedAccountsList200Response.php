...
class AdAccountsAudiencesSharedAccountsList200Response 
{
    ...
    /**
     * @var SharedAudienceAccount[]|null
     * @SerializedName("items")
     * @Type("array<OpenAPI\Server\Model\SharedAudienceAccount>")
     */
    #[Assert\NotNull]
    #[Assert\Valid]
    #[Assert\All([
        new Assert\Type("OpenAPI\Server\Model\SharedAudienceAccount"),
    ])]
     ...
     * Gets items.
     *
     * @return SharedAudienceAccount[]|null
     */
     ...
     * Sets items.
     *
     * @param SharedAudienceAccount[]|null $items
     *
     * @return $this
     */
