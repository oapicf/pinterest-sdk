...
class TargetingTemplateList200Response 
{
    ...
    */
    ...
    /**
     * @var TargetingTemplateGetResponseData[]|null
     * @SerializedName("items")
     * @Type("array<OpenAPI\Server\Model\TargetingTemplateGetResponseData>")
    */
    #[Assert\NotNull]
    #[Assert\Valid]
    #[Assert\All([
        new Assert\Type("OpenAPI\Server\Model\TargetingTemplateGetResponseData"),
    ])]
    ...
    */
     ...
     * Gets items.
     *
     * @return TargetingTemplateGetResponseData[]|null
     */
    ...
    * Sets items.
    *
    * @param TargetingTemplateGetResponseData[]|null $items
    *
    * @return $this
    */
