...
class CatalogsVerticalFeedsCreateRequest 
{
    ...
    */
     ...
     * Sets catalogId.
     *
     * @param string|null $catalogId  Catalog id pertaining to the feed. If not provided, feed will use a default catalog based on type. At the moment a catalog can not have multiple hotel feeds but this will change in the future.
     *
     * @return $this
     */
