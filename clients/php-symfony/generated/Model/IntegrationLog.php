...
class IntegrationLog 
{
     ...
     * Log event type
     *
     * @var IntegrationLogEventType|null
     * @SerializedName("event_type")
     * @Accessor(getter="getSerializedEventType", setter="setDeserializedEventType")
     * @Type("string")
     */
    #[Assert\NotNull]
    #[Assert\Valid]
    protected ?IntegrationLogEventType $eventType = null;
     ...
     * Log level type
     *
     * @var IntegrationLogLevel|null
     * @SerializedName("log_level")
     * @Accessor(getter="getSerializedLogLevel", setter="setDeserializedLogLevel")
     * @Type("string")
     */
    #[Assert\NotNull]
    #[Assert\Valid]
    protected ?IntegrationLogLevel $logLevel = null;
     ...
     * Gets eventType.
     *
     * @return IntegrationLogEventType|null
     */
    public function getEventType(): ?IntegrationLogEventType
    {
     ...
     * Sets eventType.
     *
     * @param IntegrationLogEventType|null $eventType  Log event type
     *
     * @return $this
     */
    public function setEventType(?IntegrationLogEventType $eventType): self
    {
    ...
    /**
     * Gets eventType for serialization.
     *
     * @return string|null
     */
    public function getSerializedEventType(): string|null
    {
        return !is_null($this->eventType?->value) ? (string) $this->eventType->value : null;
    }

    /**
     * Sets eventType.
     *
     * @param string|IntegrationLogEventType|null $eventType  Log event type
     *
     * @return $this
     */
    public function setDeserializedEventType(string|IntegrationLogEventType|null $eventType): self
    {
        if (is_string($eventType)) {
            $eventType = IntegrationLogEventType::tryFrom($eventType);
        }
     ...
     * Gets logLevel.
     *
     * @return IntegrationLogLevel|null
     */
    public function getLogLevel(): ?IntegrationLogLevel
    {
     ...
     * Sets logLevel.
     *
     * @param IntegrationLogLevel|null $logLevel  Log level type
     *
     * @return $this
     */
    public function setLogLevel(?IntegrationLogLevel $logLevel): self
    {
    ...
    /**
     * Gets logLevel for serialization.
     *
     * @return string|null
     */
    public function getSerializedLogLevel(): string|null
    {
        return !is_null($this->logLevel?->value) ? (string) $this->logLevel->value : null;
    }

    /**
     * Sets logLevel.
     *
     * @param string|IntegrationLogLevel|null $logLevel  Log level type
     *
     * @return $this
     */
    public function setDeserializedLogLevel(string|IntegrationLogLevel|null $logLevel): self
    {
        if (is_string($logLevel)) {
            $logLevel = IntegrationLogLevel::tryFrom($logLevel);
        }
