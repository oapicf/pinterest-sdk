...
class CampaignBatchResponseData 
{
     ...
     * @Type("string")
     */
    protected ?NullableEntityStatus $status = null;
     ...
     * @return $this
     */
    public function setObjectiveType(?CampaignObjectiveType $objectiveType = null): self
    {
     ...
     * @return $this
     */
    public function setDeserializedObjectiveType(string|CampaignObjectiveType|null $objectiveType = null): self
    {
     ...
     * Gets status.
     *
     * @return NullableEntityStatus|null
     */
    public function getStatus(): ?NullableEntityStatus
    {
        return $this->status;
    }
     ...
     * @return $this
     */
    public function setStatus(?NullableEntityStatus $status = null): self
    {
        $this->status = $status;
     ...
     * Sets status.
     *
     * @param string|NullableEntityStatus|null $status
     *
     * @return $this
     */
    public function setDeserializedStatus(string|NullableEntityStatus|null $status = null): self
    {
        if (is_string($status)) {
            $status = NullableEntityStatus::tryFrom($status);
        }
