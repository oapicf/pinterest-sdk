...
class BulkDownloadCreate 
{
     ...
     * @Type("OpenAPI\Server\Model\BulkDownloadCampaignFilter")
     */
    #[Assert\Type("OpenAPI\Server\Model\BulkDownloadCampaignFilter")]
    protected ?BulkDownloadCampaignFilter $campaignFilter = null;
     ...
     * @Type("string")
     */
    protected ?BulkOutputFormat $outputFormat = BulkOutputFormat::JSON;
     ...
     * Gets campaignFilter.
     *
     * @return BulkDownloadCampaignFilter|null
     */
    public function getCampaignFilter(): ?BulkDownloadCampaignFilter
    {
     ...
     * @return $this
     */
    public function setCampaignFilter(?BulkDownloadCampaignFilter $campaignFilter = null): self
    {
     ...
     * Sets entityTypes.
     *
     * @param BulkEntityType[]|null $entityTypes  All entity types specified will be downloaded. Fewer types result in faster downloads.
     *
     * @return $this
     */
