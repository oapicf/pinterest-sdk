...
class AdAccountsSubscriptionsGetList200Response 
{
    ...
    /**
     * @var LeadSubscription[]|null
     * @SerializedName("items")
     * @Type("array<OpenAPI\Server\Model\LeadSubscription>")
     */
    #[Assert\NotNull]
    #[Assert\Valid]
    #[Assert\All([
        new Assert\Type("OpenAPI\Server\Model\LeadSubscription"),
    ])]
     ...
     * Sets items.
     *
     * @param LeadSubscription[]|null $items
     *
     * @return $this
     */
