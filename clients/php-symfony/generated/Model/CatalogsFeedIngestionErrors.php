...
class CatalogsFeedIngestionErrors 
{
     ...
     */
    #[Assert\Type("int")]
    protected ?int $fETCHGOOGLESHEETNOTSHARED = null;
    ...
    public function __construct(?array $data = null)
    {
        if (is_array($data)) {
            ...
            $this->fETCHGOOGLESHEETNOTSHARED = array_key_exists('fETCHGOOGLESHEETNOTSHARED', $data) ? $data['fETCHGOOGLESHEETNOTSHARED'] : $this->fETCHGOOGLESHEETNOTSHARED;
    ...
    /**
     * Gets fETCHGOOGLESHEETNOTSHARED.
     *
     * @return int|null
     */
    public function getFETCHGOOGLESHEETNOTSHARED(): ?int
    {
        return $this->fETCHGOOGLESHEETNOTSHARED;
    }

    /**
     * Sets fETCHGOOGLESHEETNOTSHARED.
     *
     * @param int|null $fETCHGOOGLESHEETNOTSHARED  Update your Google Sheets sharing settings to 'Anyone with link' as a Viewer so that Pinterest can access your file.
     *
     * @return $this
     */
    public function setFETCHGOOGLESHEETNOTSHARED(?int $fETCHGOOGLESHEETNOTSHARED = null): self
    {
