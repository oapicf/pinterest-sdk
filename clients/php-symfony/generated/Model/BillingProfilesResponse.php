...
class BillingProfilesResponse 
{
    ...
    */
     ...
     * @Type("string")
    */
    #[Assert\Choice(['CREDIT_CARD', 'INVOICE', 'INTERNAL', 'RECURRING', 'PREPAID'])]
    #[Assert\Type("string")]
    ...
    * Sets billingType.
    *
    * @param string|null $billingType  Billing type of the advertiser
    *
    * @return $this
    */
    public function setBillingType(?string $billingType = null): self
    {
