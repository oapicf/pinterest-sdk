...
class SsioOrderLinesGetByAdAccount200Response 
{
    ...
    /**
     * @var SSIOOrderLine[]|null
     * @SerializedName("items")
     * @Type("array<OpenAPI\Server\Model\SSIOOrderLine>")
     */
    #[Assert\NotNull]
    #[Assert\Valid]
    #[Assert\All([
        new Assert\Type("OpenAPI\Server\Model\SSIOOrderLine"),
    ])]
     ...
     * Sets items.
     *
     * @param SSIOOrderLine[]|null $items
     *
     * @return $this
     */
