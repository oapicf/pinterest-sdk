...
class AdsCreditDiscountsResponse 
{
     ...
     * @Accessor(getter="getSerializedDiscountType", setter="setDeserializedDiscountType")
     * @Type("string")
     */
    protected ?AdsCreditDiscountType $discountType = null;
     ...
     * Gets discountType.
     *
     * @return AdsCreditDiscountType|null
     */
    public function getDiscountType(): ?AdsCreditDiscountType
    {
     ...
     * Sets discountType.
     *
     * @param AdsCreditDiscountType|null $discountType  The type of discount of this credit
     *
     * @return $this
     */
    public function setDiscountType(?AdsCreditDiscountType $discountType = null): self
    {
    ...
    /**
     * Gets discountType for serialization.
     *
     * @return string|null
     */
    public function getSerializedDiscountType(): string|null
    {
        return !is_null($this->discountType?->value) ? (string) $this->discountType->value : null;
    }

    /**
     * Sets discountType.
     *
     * @param string|AdsCreditDiscountType|null $discountType  The type of discount of this credit
     *
     * @return $this
     */
    public function setDeserializedDiscountType(string|AdsCreditDiscountType|null $discountType = null): self
    {
        if (is_string($discountType)) {
            $discountType = AdsCreditDiscountType::tryFrom($discountType);
        }
