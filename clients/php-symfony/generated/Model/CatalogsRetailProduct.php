...
class CatalogsRetailProduct 
{
    ...
    /**
     * @var CatalogsRetailProductMetadata|null
     * @SerializedName("metadata")
     * @Type("OpenAPI\Server\Model\CatalogsRetailProductMetadata")
     */
    #[Assert\NotNull]
    #[Assert\Valid]
    #[Assert\Type("OpenAPI\Server\Model\CatalogsRetailProductMetadata")]
    protected ?CatalogsRetailProductMetadata $metadata = null;
     ...
     * Gets metadata.
     *
     * @return CatalogsRetailProductMetadata|null
     */
    public function getMetadata(): ?CatalogsRetailProductMetadata
    {
     ...
     * Sets metadata.
     *
     * @param CatalogsRetailProductMetadata|null $metadata
     *
     * @return $this
     */
    public function setMetadata(?CatalogsRetailProductMetadata $metadata): self
    {
