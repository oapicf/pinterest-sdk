...
class CatalogsCreativeAssetsAttributes 
{
     ...
     * Sets aiDisclosures.
     *
     * @param CatalogsAiContentDisclosure[]|null $aiDisclosures  AI content disclosures for individual assets (image_link or video_link) on this creative assets item. Each entry declares which disclosure types apply to a single asset URL.
     *
     * @return $this
     */
     ...
     * Sets imageLink.
     *
     * @param string|null $imageLink  The creative assets image.
     *
     * @return $this
     */
    public function setImageLink(?string $imageLink = null): self
    {
     ...
     * Sets videoLink.
     *
     * @param string|null $videoLink  The creative assets video.
     *
     * @return $this
     */
