...
class CatalogsRetailProductMetadata 
{
     ...
     * @return $this
     */
    public function setAvailability(?ProductAvailability $availability): self
    {
     ...
     * Sets availability.
     *
     * @param string|ProductAvailability|null $availability
     *
     * @return $this
     */
    public function setDeserializedAvailability(string|ProductAvailability|null $availability): self
    {
        if (is_string($availability)) {
            $availability = ProductAvailability::tryFrom($availability);
        }
