...
class BulkUpsertRequestUpdate 
{
     ...
     * @Assert\All({
     *   @Assert\Type("OpenAPI\Server\Model\CampaignUpdateRequest")
     * })
     ...
     * @Assert\All({
     *   @Assert\Type("OpenAPI\Server\Model\AdGroupUpdateRequest")
     * })
     ...
     * @SerializedName("ads")
     * @Assert\All({
     *   @Assert\Type("OpenAPI\Server\Model\AdUpdateRequest")
     * })
     ...
     * @Assert\All({
     *   @Assert\Type("OpenAPI\Server\Model\ProductGroupPromotionUpdateRequest")
     * })
