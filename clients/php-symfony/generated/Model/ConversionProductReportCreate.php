...
class ConversionProductReportCreate 
{
     ...
     */
    #[Assert\All([
        new Assert\Type("OpenAPI\Server\Model\ConversionObjectiveType"),
    ])]
    #[Assert\Count(max: 7)]
    #[Assert\Count(min: 1)]
     ...
     * @Accessor(getter="getSerializedConversionProductAttributionType", setter="setDeserializedConversionProductAttributionType")
     * @Type("string")
     */
    protected ?ConversionProductAttributionType $conversionProductAttributionType = ConversionProductAttributionType::_DEFAULT;
     ...
     * @Accessor(getter="getSerializedConversionProductBreakdown", setter="setDeserializedConversionProductBreakdown")
     * @Type("string")
     */
    protected ?ConversionProductReportBreakdownType $conversionProductBreakdown = ConversionProductReportBreakdownType::PRODUCT_BRAND;
     ...
     *
     * @var ConversionProductReportGranularity|null
    ...
    #[Assert\NotNull]
    #[Assert\Valid]
    protected ?ConversionProductReportGranularity $granularity = null;

    /**
     * Level of the report
     *
     * @var ConversionProductReportLevel|null
    ...
    #[Assert\NotNull]
    #[Assert\Valid]
    protected ?ConversionProductReportLevel $level = null;
     ...
     * Sets adGroupIds.
     *
     * @param string[]|null $adGroupIds  List of ad group ids.   Only support ad_group_ids field when level of the report is AD_GROUP.
     *
     * @return $this
     */
     ...
     * Sets campaignIds.
     *
     * @param string[]|null $campaignIds  List of campaign ids.   Only support campaign_ids field when level of the report is CAMPAIGN.
     *
     * @return $this
     */
     ...
     *
     * @param ConversionObjectiveType[]|null $campaignObjectiveTypes  List of values for filtering. Default is ['CONSIDERATION','AWARENESS','WEB_CONVERSION','VIDEO_COMPLETION'].
     *
     * @return $this
     */
    ...
    public function setDeserializedCampaignObjectiveTypes(?array $campaignObjectiveTypes = []): self
    {
        $this->campaignObjectiveTypes = array_map(
            static function ($value) {
                if (is_string($value)) {
                    $value = ConversionObjectiveType::tryFrom($value);
                }
     ...
     *
     * @return ConversionProductAttributionType|null
     */
    public function getConversionProductAttributionType(): ?ConversionProductAttributionType
    {
     ...
     *
     * @param ConversionProductAttributionType|null $conversionProductAttributionType  Required attribution type of the B/C/S report.   When the attribution type is BRAND_ATTRIBUTION, start_date for the report must be after 2025-04-01.
     *
     * @return $this
     */
    public function setConversionProductAttributionType(?ConversionProductAttributionType $conversionProductAttributionType = null): self
    {
    ...
    /**
     * Gets conversionProductAttributionType for serialization.
     *
     * @return string|null
     */
    public function getSerializedConversionProductAttributionType(): string|null
    {
        return !is_null($this->conversionProductAttributionType?->value) ? (string) $this->conversionProductAttributionType->value : null;
    }

    /**
     * Sets conversionProductAttributionType.
     *
     * @param string|ConversionProductAttributionType|null $conversionProductAttributionType  Required attribution type of the B/C/S report.   When the attribution type is BRAND_ATTRIBUTION, start_date for the report must be after 2025-04-01.
     *
     * @return $this
     */
    public function setDeserializedConversionProductAttributionType(string|ConversionProductAttributionType|null $conversionProductAttributionType = null): self
    {
        if (is_string($conversionProductAttributionType)) {
            $conversionProductAttributionType = ConversionProductAttributionType::tryFrom($conversionProductAttributionType);
        }
     ...
     *
     * @return ConversionProductReportBreakdownType|null
     */
    public function getConversionProductBreakdown(): ?ConversionProductReportBreakdownType
    {
     ...
     *
     * @param ConversionProductReportBreakdownType|null $conversionProductBreakdown  Report breakdown type. This is used to specify the breakdown of the report by brand, category, or SKU.
     *
     * @return $this
     */
    public function setConversionProductBreakdown(?ConversionProductReportBreakdownType $conversionProductBreakdown = null): self
    {
    ...
    /**
     * Gets conversionProductBreakdown for serialization.
     *
     * @return string|null
     */
    public function getSerializedConversionProductBreakdown(): string|null
    {
        return !is_null($this->conversionProductBreakdown?->value) ? (string) $this->conversionProductBreakdown->value : null;
    }

    /**
     * Sets conversionProductBreakdown.
     *
     * @param string|ConversionProductReportBreakdownType|null $conversionProductBreakdown  Report breakdown type. This is used to specify the breakdown of the report by brand, category, or SKU.
     *
     * @return $this
     */
    public function setDeserializedConversionProductBreakdown(string|ConversionProductReportBreakdownType|null $conversionProductBreakdown = null): self
    {
        if (is_string($conversionProductBreakdown)) {
            $conversionProductBreakdown = ConversionProductReportBreakdownType::tryFrom($conversionProductBreakdown);
        }
     ...
     * Sets endDate.
     *
     * @param string|null $endDate  Metric report end date (UTC). Format: YYYY-MM-DD.   A max of 1 year is allowed between the start and end date for reports.
     *
     * @return $this
     */
     ...
     * Gets granularity.
     *
     * @return ConversionProductReportGranularity|null
     */
    public function getGranularity(): ?ConversionProductReportGranularity
    {
     ...
     * Sets granularity.
     *
     * @param ConversionProductReportGranularity|null $granularity  Report granularity for time-based metric aggregation
     *
     * @return $this
     */
    public function setGranularity(?ConversionProductReportGranularity $granularity): self
    {
     ...
     * Sets granularity.
     *
     * @param string|ConversionProductReportGranularity|null $granularity  Report granularity for time-based metric aggregation
     *
     * @return $this
     */
    public function setDeserializedGranularity(string|ConversionProductReportGranularity|null $granularity): self
    {
        if (is_string($granularity)) {
            $granularity = ConversionProductReportGranularity::tryFrom($granularity);
        }
     ...
     * Gets level.
     *
     * @return ConversionProductReportLevel|null
     */
    public function getLevel(): ?ConversionProductReportLevel
    {
        return $this->level;
    }
     ...
     * Sets level.
     *
     * @param ConversionProductReportLevel|null $level  Level of the report
     *
     * @return $this
     */
    public function setLevel(?ConversionProductReportLevel $level): self
    {
        $this->level = $level;
     ...
     * Sets level.
     *
     * @param string|ConversionProductReportLevel|null $level  Level of the report
     *
     * @return $this
     */
    public function setDeserializedLevel(string|ConversionProductReportLevel|null $level): self
    {
        if (is_string($level)) {
            $level = ConversionProductReportLevel::tryFrom($level);
        }
     ...
     * Sets productSkuIds.
     *
     * @param string[]|null $productSkuIds  List of SKU ids.   Only support product_sku_ids field when report breakdown type is PRODUCT_SKU_GROUP.
     *
     * @return $this
     */
     ...
     * Sets startDate.
     *
     * @param string|null $startDate  Metric report start date (UTC). Format: YYYY-MM-DD.   Start date must be after 2024-03-16. 7 day minimum time window for report is required.
     *
     * @return $this
     */
