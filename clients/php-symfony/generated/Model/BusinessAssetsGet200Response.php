...
class BusinessAssetsGet200Response 
{
     ...
     *
     * @var GetBusinessAssetsResponse[]|null
     * @SerializedName("items")
     * @Type("array<OpenAPI\Server\Model\GetBusinessAssetsResponse>")
    */
    #[Assert\NotNull]
    #[Assert\Valid]
    #[Assert\All([
        new Assert\Type("OpenAPI\Server\Model\GetBusinessAssetsResponse"),
    ])]
    ...
    */
     ...
     * Gets items.
     *
     * @return GetBusinessAssetsResponse[]|null
     */
    ...
    * Sets items.
    *
    * @param GetBusinessAssetsResponse[]|null $items  List of assets the requesting business has access to.
    *
    * @return $this
    */
