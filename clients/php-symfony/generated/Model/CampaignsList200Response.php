...
class CampaignsList200Response 
{
     ...
     * @Type("array<OpenAPI\Server\Model\CampaignResponse>")
    */
    #[Assert\NotNull]
    #[Assert\Valid]
    #[Assert\All([
        new Assert\Type("OpenAPI\Server\Model\CampaignResponse"),
    ])]
    ...
    * Sets items.
    *
    * @param CampaignResponse[]|null $items
    *
    * @return $this
    */
