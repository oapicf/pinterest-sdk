...
class ConversionEventsDataItemsCustomDataContentsItems 
{
    ...
    protected ?string $itemBrandId = null;
    ...
    public function __construct(?array $data = null)
    {
        if (is_array($data)) {
            ...
            $this->itemBrandId = array_key_exists('itemBrandId', $data) ? $data['itemBrandId'] : $this->itemBrandId;
     ...
     * Sets itemBrandId.
     *
     * @param string|null $itemBrandId  The brand ID of a product.
     *
     * @return $this
     */
    public function setItemBrandId(?string $itemBrandId = null): self
    {
