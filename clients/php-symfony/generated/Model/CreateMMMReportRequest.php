...
class CreateMMMReportRequest 
{
     ...
     * @Assert\Valid()
     * @Assert\All({
     *   @Assert\Type("OpenAPI\Server\Model\MMMReportingTargetingType")
     * })
     ...
     * @Assert\Valid()
     * @Assert\All({
     *   @Assert\Type("OpenAPI\Server\Model\MMMReportingColumn")
     * })
     ...
     * @Assert\All({
     *   @Assert\Type("OpenAPI\Server\Model\TargetingAdvertiserCountry")
     * })
