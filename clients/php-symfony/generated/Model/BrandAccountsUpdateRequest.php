...
/**
 * Class representing the BrandAccountsUpdateRequest model.
 *
 * @package OpenAPI\Server\Model
 * @author  OpenAPI Generator team
 */
...
class BrandAccountsUpdateRequest 
{
    ...
    */
     ...
     * @Type("OpenAPI\Server\Model\ImageBase64")
    */
    #[Assert\Type("OpenAPI\Server\Model\ImageBase64")]
    protected ?ImageBase64 $profileImage = null;
    ...
    */
     ...
     */
    public function getProfileImage(): ?ImageBase64
    {
    ...
    * Sets profileImage.
    *
    * @param ImageBase64|null $profileImage
    *
    * @return $this
    */
    public function setProfileImage(?ImageBase64 $profileImage = null): self
    {
