...
class AdGroupAudienceSizingRequest 
{
     ...
     * @Assert\All({
     *   @Assert\Choice({ "REGULAR", "VIDEO", "SHOPPING", "CAROUSEL", "MAX_VIDEO", "SHOP_THE_PIN", "COLLECTION", "IDEA" })
     * })
     * @Assert\All({
     *   @Assert\Type("string")
     * })
     ...
     * @Assert\All({
     *   @Assert\Type("OpenAPI\Server\Model\AdGroupAudienceSizingRequestKeywordsInner")
     * })
