...
class EntityLabelError 
{
     ...
     * @SerializedName("data")
     * @Type("OpenAPI\Server\Model\EntityLabel")
     */
    #[Assert\Type("OpenAPI\Server\Model\EntityLabel")]
    protected ?EntityLabel $data = null;
     ...
     */
    public function getData(): ?EntityLabel
    {
        return $this->data;
    }
     ...
     * @return $this
     */
    public function setData(?EntityLabel $data = null): self
    {
        $this->data = $data;
