...
/**
 * Class representing the BusinessMemberAssetsGet200Response model.
 *
 * @package OpenAPI\Server\Model
 * @author  OpenAPI Generator team
 */
...
class BusinessMemberAssetsGet200Response 
{
    ...
    * Sets items.
    *
    * @param AssetIdPermissions[]|null $items  List asset permissions the given member was granted.
    *
    * @return $this
    */
