...
class AdCreateRequest 
{
     ...
     */
    #[Assert\Type("array")]
    protected ?array $quizPinData = null;
     ...
     * @return array|null
     */
    public function getQuizPinData(): ?array
    {
     ...
     * Sets quizPinData.
     *
     * @param array|null $quizPinData  Before creating a quiz ad, you must create an organic Pin using POST/Create Pin for each result in the quiz. Quiz ads cannot be saved by a Pinner. Quiz ad results can be saved.
     *
     * @return $this
     */
    public function setQuizPinData(?array $quizPinData = null): self
    {
