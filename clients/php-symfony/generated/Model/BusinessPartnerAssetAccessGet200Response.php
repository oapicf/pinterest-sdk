...
class BusinessPartnerAssetAccessGet200Response 
{
     ...
     *
     * @var GetPartnerAssetsResponse[]|null
     * @SerializedName("items")
     * @Type("array<OpenAPI\Server\Model\GetPartnerAssetsResponse>")
    */
    #[Assert\NotNull]
    #[Assert\Valid]
    #[Assert\All([
        new Assert\Type("OpenAPI\Server\Model\GetPartnerAssetsResponse"),
    ])]
    ...
    */
     ...
     * Gets items.
     *
     * @return GetPartnerAssetsResponse[]|null
     */
    ...
    * Sets items.
    *
    * @param GetPartnerAssetsResponse[]|null $items  List assets on which you granted access to your partner or assets on which your partner has granted you access.
    *
    * @return $this
    */
