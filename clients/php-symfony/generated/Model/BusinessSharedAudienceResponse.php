...
/**
 * Class representing the BusinessSharedAudienceResponse model.
 *
 * @package OpenAPI\Server\Model
 * @author  OpenAPI Generator team
 */
...
class BusinessSharedAudienceResponse 
{
    ...
    *
    * @param string[]|null $recipientBusinessIds  Business IDs that received the audience
    *
    * @return $this
    */
    public function setRecipientBusinessIds(?array $recipientBusinessIds = null): self
    {
