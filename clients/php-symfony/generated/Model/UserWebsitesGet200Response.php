...
{
        /**
     * @var UserWebsiteSummary[]|null
     * @SerializedName("items")
     * @Type("array<OpenAPI\Server\Model\UserWebsiteSummary>")
    */
    #[Assert\NotNull]
    #[Assert\Valid]
    #[Assert\All([
        new Assert\Type("OpenAPI\Server\Model\UserWebsiteSummary"),
    ])]
    ...
    */
     ...
     * Gets items.
     *
     * @return UserWebsiteSummary[]|null
     */
    ...
    * Sets items.
    *
    * @param UserWebsiteSummary[]|null $items
    *
    * @return $this
    */
