...
class CatalogsItemsUpdateBatchRequest 
{
    ...
    */
     ...
     *
     * @var ItemUpdateBatchRecord[]|null
     * @SerializedName("items")
     * @Type("array<OpenAPI\Server\Model\ItemUpdateBatchRecord>")
    */
    #[Assert\NotNull]
    #[Assert\Valid]
    #[Assert\All([
        new Assert\Type("OpenAPI\Server\Model\ItemUpdateBatchRecord"),
    ])]
    ...
    */
     ...
     * Gets items.
     *
     * @return ItemUpdateBatchRecord[]|null
     */
    ...
    * Sets items.
    *
    * @param ItemUpdateBatchRecord[]|null $items  Array with catalogs items
    *
    * @return $this
    */
