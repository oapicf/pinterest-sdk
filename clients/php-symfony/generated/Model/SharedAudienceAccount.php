...
class SharedAudienceAccount 
{
    ...
    #[Assert\NotNull]
    #[Assert\Valid]
    protected ?AudienceAccountType $accountType = null;
     ...
     * Gets accountType.
     *
     * @return AudienceAccountType|null
     */
    public function getAccountType(): ?AudienceAccountType
    {
     ...
     * Sets accountType.
     *
     * @param AudienceAccountType|null $accountType  account type
     *
     * @return $this
     */
    public function setAccountType(?AudienceAccountType $accountType): self
    {
     ...
     * Sets accountType.
     *
     * @param string|AudienceAccountType|null $accountType  account type
     *
     * @return $this
     */
    public function setDeserializedAccountType(string|AudienceAccountType|null $accountType): self
    {
        if (is_string($accountType)) {
            $accountType = AudienceAccountType::tryFrom($accountType);
        }
