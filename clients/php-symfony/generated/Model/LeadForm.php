...
class LeadForm 
{
     ...
     * @Type("array<OpenAPI\Server\Model\LeadFormPolicyLink>")
     */
    #[Assert\All([
        new Assert\Type("OpenAPI\Server\Model\LeadFormPolicyLink"),
    ])]
    #[Assert\Count(max: 3)]
    #[Assert\Count(min: 0)]
     ...
     * Sets createdTime.
     *
     * @param int|null $createdTime  Lead form creation time. Unix timestamp in seconds.
     *
     * @return $this
     */
     ...
     * Gets policyLinks.
     *
     * @return LeadFormPolicyLink[]|null
     */
     ...
     * Sets policyLinks.
     *
     * @param LeadFormPolicyLink[]|null $policyLinks  List of additional policy links to be displayed on the lead form.
     *
     * @return $this
     */
