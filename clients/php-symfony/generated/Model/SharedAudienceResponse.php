...
/**
 * Class representing the SharedAudienceResponse model.
 *
 * @package OpenAPI\Server\Model
 * @author  OpenAPI Generator team
 */
...
class SharedAudienceResponse 
{
    ...
    *
    * @param string[]|null $recipientAccountIds  Account IDs that received the audience
    *
    * @return $this
    */
    public function setRecipientAccountIds(?array $recipientAccountIds = null): self
    {
