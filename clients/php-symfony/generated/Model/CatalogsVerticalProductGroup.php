...
class CatalogsVerticalProductGroup 
{
    ...
    */
    ...
    /**
     * @var CatalogsHotelProductGroupType|null
     * @SerializedName("type")
    ...
    */
    #[Assert\NotNull]
    #[Assert\Valid]
    protected ?CatalogsHotelProductGroupType $type = null;
    ...
    * Sets id.
    *
    * @param string|null $id  ID of the creative assets product group.
    *
    * @return $this
    */
    ...
    */
     ...
     * Gets type.
     *
     * @return CatalogsHotelProductGroupType|null
     */
    public function getType(): ?CatalogsHotelProductGroupType
    {
        return $this->type;
    }
    ...
    * Sets type.
    *
    * @param CatalogsHotelProductGroupType|null $type
    *
    * @return $this
    */
    public function setType(?CatalogsHotelProductGroupType $type): self
    {
        $this->type = $type;
    ...
    * Sets type.
    *
    * @param string|CatalogsHotelProductGroupType|null $type
    *
    * @return $this
    */
    public function setDeserializedType(string|CatalogsHotelProductGroupType|null $type): self
    {
        if (is_string($type)) {
            $type = CatalogsHotelProductGroupType::tryFrom($type);
        }
