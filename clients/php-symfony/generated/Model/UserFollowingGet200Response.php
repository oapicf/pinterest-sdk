...
/**
 * Class representing the UserFollowingGet200Response model.
 *
 * @package OpenAPI\Server\Model
 * @author  OpenAPI Generator team
 */
...
class UserFollowingGet200Response 
{
     ...
     * @Type("array<OpenAPI\Server\Model\UserSummary>")
    */
    #[Assert\NotNull]
    #[Assert\Valid]
    #[Assert\All([
        new Assert\Type("OpenAPI\Server\Model\UserSummary"),
    ])]
    ...
    * Sets items.
    *
    * @param UserSummary[]|null $items  Users
    *
    * @return $this
    */
