...
class AdGroupResponse 
{
    ...
    *
    * @param string|null $bidStrategyType  Bid strategy type. For Campaigns with Video Completion objectives, the only supported bid strategy type is AUTOMATIC_BID, also known as \"Pinterest Performance+ bidding\".
    *
    * @return $this
    */
    ...
    * Sets summaryStatus.
    *
    * @param string|AdGroupSummaryStatus|null $summaryStatus  Ad group summary status.
    *
    * @return $this
    */
    public function setDeserializedSummaryStatus(string|AdGroupSummaryStatus|null $summaryStatus = null): self
    {
        if (is_string($summaryStatus)) {
            $summaryStatus = AdGroupSummaryStatus::tryFrom($summaryStatus);
        }
