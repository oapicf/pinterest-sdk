...
class CatalogsHotelAttributes 
{
     ...
     * @Type("OpenAPI\Server\Model\CatalogsHotelMainImage")
     */
    #[Assert\Type("OpenAPI\Server\Model\CatalogsHotelMainImage")]
    protected ?CatalogsHotelMainImage $mainImage = null;
     ...
     * Sets address.
     *
     * @param CatalogsHotelAddress|null $address  Hotel address
     *
     * @return $this
     */
     ...
     * Sets guestRatings.
     *
     * @param CatalogsHotelGuestRatings|null $guestRatings  If specified, you must provide all properties
     *
     * @return $this
     */
     ...
     *
     * @param string[]|null $additionalImageLink  <= 2000 characters. The links to additional images for your hotel. Up to ten additional images can be used to show a hotel from different angles. Must begin with http:// or https://.
     *
     * @return $this
     */
     ...
     * Sets aiDisclosures.
     *
     * @param CatalogsAiContentDisclosure[]|null $aiDisclosures  AI content disclosures for individual assets (main_image.link or additional_image_link) on this hotel item. Each entry declares which disclosure types apply to a single asset URL.
     *
     * @return $this
     */
     ...
     * Gets mainImage.
     *
     * @return CatalogsHotelMainImage|null
     */
    public function getMainImage(): ?CatalogsHotelMainImage
    {
     ...
     * Sets mainImage.
     *
     * @param CatalogsHotelMainImage|null $mainImage  The main hotel image
     *
     * @return $this
     */
    public function setMainImage(?CatalogsHotelMainImage $mainImage = null): self
    {
