...
class BillingInvoicesGet200Response 
{
    ...
    */
    ...
    /**
     * @var BillingInvoiceResponse[]|null
     * @SerializedName("items")
     * @Type("array<OpenAPI\Server\Model\BillingInvoiceResponse>")
    */
    #[Assert\NotNull]
    #[Assert\Valid]
    #[Assert\All([
        new Assert\Type("OpenAPI\Server\Model\BillingInvoiceResponse"),
    ])]
    ...
    */
     ...
     * Gets items.
     *
     * @return BillingInvoiceResponse[]|null
     */
    ...
    * Sets items.
    *
    * @param BillingInvoiceResponse[]|null $items
    *
    * @return $this
    */
