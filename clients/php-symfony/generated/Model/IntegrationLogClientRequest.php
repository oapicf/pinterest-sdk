...
class IntegrationLogClientRequest 
{
     ...
     * @Accessor(getter="getSerializedMethod", setter="setDeserializedMethod")
     * @Type("string")
     */
    #[Assert\NotNull]
    #[Assert\Valid]
    ...
    /**
     * Gets method for serialization.
     *
     * @return string|null
     */
    public function getSerializedMethod(): string|null
    {
        return !is_null($this->method?->value) ? (string) $this->method->value : null;
    }

    /**
     * Sets method.
     *
     * @param string|HttpMethod|null $method
     *
     * @return $this
     */
    public function setDeserializedMethod(string|HttpMethod|null $method): self
    {
        if (is_string($method)) {
