...
class CatalogsItemValidationErrors 
{
     ...
     * Sets aDULTINVALID.
     *
     * @param CatalogsItemValidationDetails|null $aDULTINVALID  Item has an invalid adult value.
     *
     * @return $this
     */
     ...
     *
     * @param CatalogsItemValidationDetails|null $aDWORDSFORMATINVALID  Adword link contains too many characters.
     *
     * @return $this
     */
     ...
     *
     * @param CatalogsItemValidationDetails|null $aVAILABILITYINVALID  Item is missing availability value in its product metadata, this item will not be published.
     *
     * @return $this
     */
     ...
     *
     * @param CatalogsItemValidationDetails|null $bLOCKLISTEDIMAGESIGNATURE  Item will not be published because it doesn't meet Pinterest's Merchant Guidelines.
     *
     * @return $this
     */
     ...
     *
     * @param CatalogsItemValidationDetails|null $dESCRIPTIONMISSING  Item is missing description in its product metadata, this item will not be published.
     *
     * @return $this
     */
     ...
     *
     * @param CatalogsItemValidationDetails|null $dUPLICATEPRODUCTS  This product is duplicated. The duplicate entry will not be published.
     *
     * @return $this
     */
     ...
     *
     * @param CatalogsItemValidationDetails|null $iMAGELINKINVALID  Image link is invalid.
     *
     * @return $this
     */
     ...
     *
     * @param CatalogsItemValidationDetails|null $iMAGELINKLENGTHTOOLONG  Item has image_link URL that contains too many characters, so the item will not be published.
     *
     * @return $this
     */
     ...
     *
     * @param CatalogsItemValidationDetails|null $iMAGELINKMISSING  Item is missing an image link URL in its product metadata, this item will not be published.
     *
     * @return $this
     */
     ...
     * Sets iNVALIDDOMAIN.
     *
     * @param CatalogsItemValidationDetails|null $iNVALIDDOMAIN  Product link value doesn't match the verified domain associated with this account.
     *
     * @return $this
     */
     ...
     *
     * @param CatalogsItemValidationDetails|null $iTEMMAINIMAGEDOWNLOADFAILURE  Main image can't be found.
     *
     * @return $this
     */
     ...
     * Sets iTEMIDMISSING.
     *
     * @param CatalogsItemValidationDetails|null $iTEMIDMISSING  Item is missing item id in its product metadata, this item will not be published.
     *
     * @return $this
     */
     ...
     *
     * @param CatalogsItemValidationDetails|null $lINKFORMATINVALID  Link is invalid.
     *
     * @return $this
     */
     ...
     *
     * @param CatalogsItemValidationDetails|null $lINKLENGTHTOOLONG  Product link contains too many characters, this item will not be published.
     *
     * @return $this
     */
     ...
     *
     * @param CatalogsItemValidationDetails|null $lISTPRICEINVALID  Item has a list price formatting error, this item will not be published.
     *
     * @return $this
     */
     ...
     *
     * @param CatalogsItemValidationDetails|null $mAXITEMSPERITEMGROUPEXCEEDED  Item exceed the maximum number of items per item group, this item will not be published.
     *
     * @return $this
     */
     ...
     * Sets pARSELINEERROR.
     *
     * @param CatalogsItemValidationDetails|null $pARSELINEERROR  Item contains formating errors.
     *
     * @return $this
     */
     ...
     *
     * @param CatalogsItemValidationDetails|null $pINJOINCONTENTUNSAFE  Item will not be published because it doesn't meet Pinterest's Merchant Guidelines.
     *
     * @return $this
     */
     ...
     *
     * @param CatalogsItemValidationDetails|null $pRICECANNOTBEDETERMINED  Item price cannot be determined because the price, list price, and sale price are all different.
     *
     * @return $this
     */
     ...
     * Sets pRICEMISSING.
     *
     * @param CatalogsItemValidationDetails|null $pRICEMISSING  Product is missing a price, this item will not be published.
     *
     * @return $this
     */
     ...
     *
     * @param CatalogsItemValidationDetails|null $pRODUCTLINKMISSING  Item is missing a link URL in its product metadata, this item will not be published.
     *
     * @return $this
     */
     ...
     *
     * @param CatalogsItemValidationDetails|null $pRODUCTPRICEINVALID  Item has a price formatting error in its product metadata, this item will not be published.
     *
     * @return $this
     */
     ...
     * Sets tITLEMISSING.
     *
     * @param CatalogsItemValidationDetails|null $tITLEMISSING  Item is missing title in its product metadata, this item will not be published.
     *
     * @return $this
     */
