...
class CatalogsCreativeAssetsItemsBatch 
{
     ...
     * @Type("array<OpenAPI\Server\Model\CreativeAssetsProcessingRecord>")
     */
    #[Assert\All([
        new Assert\Type("OpenAPI\Server\Model\CreativeAssetsProcessingRecord"),
    ])]
     ...
     * Gets items.
     *
     * @return CreativeAssetsProcessingRecord[]|null
     */
     ...
     * Sets items.
     *
     * @param CreativeAssetsProcessingRecord[]|null $items  Array with the catalogs items processing records part of the catalogs items batch
     *
     * @return $this
     */
