...
class CatalogsCreativeAssetsBatchRequest 
{
     ...
     *
     * @var CatalogsCreativeAssetsBatchItem[]|null
     * @SerializedName("items")
     * @Type("array<OpenAPI\Server\Model\CatalogsCreativeAssetsBatchItem>")
     */
    #[Assert\NotNull]
    #[Assert\Valid]
    #[Assert\All([
        new Assert\Type("OpenAPI\Server\Model\CatalogsCreativeAssetsBatchItem"),
    ])]
     ...
     * Gets items.
     *
     * @return CatalogsCreativeAssetsBatchItem[]|null
     */
     ...
     * Sets items.
     *
     * @param CatalogsCreativeAssetsBatchItem[]|null $items  Array with creative assets item operations
     *
     * @return $this
     */
