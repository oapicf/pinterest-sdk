...
class AdGroupUpdateRequest 
{
     ...
     */
    #[Assert\Type("array")]
    protected ?array $optimizationGoalMetadata = null;
     ...
     * @Type("string")
     */
    #[Assert\Choice(['NONE', 'ITEM', 'AD_GROUP'])]
    #[Assert\Type("string")]
    protected ?string $promotionApplicationLevel = null;
     ...
     *
     * @param int|null $bidInMicroCurrency  Bid price in micro currency. This field is **REQUIRED** for the following campaign objective_type/billable_event combinations: AWARENESS/IMPRESSION, CONSIDERATION/CLICKTHROUGH, CATALOG_SALES/CLICKTHROUGH.
     *
     * @return $this
     */
     ...
     * @return array|null
     */
    public function getOptimizationGoalMetadata(): ?array
    {
     ...
     *
     * @param array|null $optimizationGoalMetadata  Optimization goals for objective-based performance campaigns. **REQUIRED** when campaign's `objective_type` is set to `\"WEB_CONVERSION\"`.
     *
     * @return $this
     */
    public function setOptimizationGoalMetadata(?array $optimizationGoalMetadata = null): self
    {
     ...
     *
     * @param string|null $promotionApplicationLevel  Specify if the promotion is applied at ad group or item level
     *
     * @return $this
     */
    public function setPromotionApplicationLevel(?string $promotionApplicationLevel = null): self
    {
     ...
     * Sets trackingUrls.
     *
     * @param array|null $trackingUrls  Third-party tracking URLs.<br> JSON object with the format: {\"<a href=\"/docs/redoc/#section/Tracking-URL-event\">Tracking event enum</a>\":[URL string array],...}<br> For example: {\"impression\": [\"URL1\", \"URL2\"], \"click\": [\"URL1\", \"URL2\", \"URL3\"]}.<br>Up to three tracking URLs are supported for each event type. Tracking URLs set at the ad group or ad level can override those set at the campaign level. May be null. Pass in an empty object - EmptyObject - to remove tracking URLs.<br><br> For more information, see <a href=\"https://help.pinterest.com/en/business/article/third-party-and-dynamic-tracking\" target=\"_blank\">Third-party and dynamic tracking</a>.
     *
     * @return $this
     */
