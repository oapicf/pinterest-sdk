...
class ConversionEventResponse 
{
     ...
     */
    #[Assert\Type("string")]
    protected ?string $reportingConversionEvent = null;
    ...
    public function __construct(?array $data = null)
    {
        if (is_array($data)) {
            ...
            $this->reportingConversionEvent = array_key_exists('reportingConversionEvent', $data) ? $data['reportingConversionEvent'] : $this->reportingConversionEvent;
        }
    }
    ...
    /**
     * Gets reportingConversionEvent.
     *
     * @return string|null
     */
    public function getReportingConversionEvent(): ?string
    {
        return $this->reportingConversionEvent;
    }

    /**
     * Sets reportingConversionEvent.
     *
     * @param string|null $reportingConversionEvent  For advertiser-defined events, the reporting event label shown in optimization UIs.
     *
     * @return $this
     */
    public function setReportingConversionEvent(?string $reportingConversionEvent = null): self
    {
