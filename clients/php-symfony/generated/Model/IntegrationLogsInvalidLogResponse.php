...
class IntegrationLogsInvalidLogResponse 
{
     ...
     * @Type("array<OpenAPI\Server\Model\IntegrationLogsInvalidLogResponseRejectedLogsItems>")
     */
    #[Assert\All([
        new Assert\Type("OpenAPI\Server\Model\IntegrationLogsInvalidLogResponseRejectedLogsItems"),
    ])]
     ...
     * Gets rejectedLogs.
     *
     * @return IntegrationLogsInvalidLogResponseRejectedLogsItems[]|null
     */
