...
class MMMReportCreate 
{
    ...
    protected ?array $advertiserIds = null;
    ...
    #[Assert\NotNull]
    #[Assert\Valid]
    protected ?MMMReportGranularity $granularity = null;

    /**
     * Level of the report
     *
     * @var MMMReportLevel|null
    ...
    #[Assert\NotNull]
    #[Assert\Valid]
    protected ?MMMReportLevel $level = null;
    ...
    {
        if (is_array($data)) {
            $this->advertiserIds = array_key_exists('advertiserIds', $data) ? $data['advertiserIds'] : $this->advertiserIds;
     ...
     * Sets advertiserIds.
     *
     * @param string[]|null $advertiserIds  Advertiser IDs for multi-advertiser report
     *
     * @return $this
     */
    public function setAdvertiserIds(?array $advertiserIds = null): self
    {
     ...
     *
     * @param string[]|null $customColumnIds  List of custom column IDs
     *
     * @return $this
     */
     ...
     * Gets granularity.
     *
     * @return MMMReportGranularity|null
     */
    public function getGranularity(): ?MMMReportGranularity
    {
     ...
     * Sets granularity.
     *
     * @param MMMReportGranularity|null $granularity  DAY - metrics are broken down daily.    WEEK - metrics are broken down weekly.
     *
     * @return $this
     */
    public function setGranularity(?MMMReportGranularity $granularity): self
    {
     ...
     * Sets granularity.
     *
     * @param string|MMMReportGranularity|null $granularity  DAY - metrics are broken down daily.    WEEK - metrics are broken down weekly.
     *
     * @return $this
     */
    public function setDeserializedGranularity(string|MMMReportGranularity|null $granularity): self
    {
        if (is_string($granularity)) {
            $granularity = MMMReportGranularity::tryFrom($granularity);
        }
     ...
     * Gets level.
     *
     * @return MMMReportLevel|null
     */
    public function getLevel(): ?MMMReportLevel
    {
        return $this->level;
    }
     ...
     * Sets level.
     *
     * @param MMMReportLevel|null $level  Level of the report
     *
     * @return $this
     */
    public function setLevel(?MMMReportLevel $level): self
    {
        $this->level = $level;
     ...
     * Sets level.
     *
     * @param string|MMMReportLevel|null $level  Level of the report
     *
     * @return $this
     */
    public function setDeserializedLevel(string|MMMReportLevel|null $level): self
    {
        if (is_string($level)) {
            $level = MMMReportLevel::tryFrom($level);
        }
