...
class CatalogsRetailItemsBatch 
{
     ...
     */
    #[Assert\All([
        new Assert\Type("OpenAPI\Server\Model\ItemProcessingRecord"),
    ])]
     ...
     * Sets createdTime.
     *
     * @param \DateTime|null $createdTime  Date and time (UTC) of the batch creation: YYYY-MM-DD'T'hh:mm:ss. If null, batch creation was skipped due to a recent duplicate ingestion.
     *
     * @return $this
     */
