...
class LabelsList200Response 
{
    ...
    */
    ...
    /**
     * @var LabelsResponse[]|null
     * @SerializedName("items")
     * @Type("array<OpenAPI\Server\Model\LabelsResponse>")
    */
    #[Assert\NotNull]
    #[Assert\Valid]
    #[Assert\All([
        new Assert\Type("OpenAPI\Server\Model\LabelsResponse"),
    ])]
    ...
    * Sets items.
    *
    * @param LabelsResponse[]|null $items
    *
    * @return $this
    */
