...
class DeletePartnerAssetAccessItem 
{
     ...
     * Sets partnerType.
     *
     * @param string|null $partnerType  If partner_type=INTERNAL, the deleted asset access is for the access the partner has to your business asset. If partner_type=EXTERNAL, the deleted asset access is for the access you have to the partner's business asset.
     *
     * @return $this
     */
