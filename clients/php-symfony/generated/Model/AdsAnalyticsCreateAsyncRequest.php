...
class AdsAnalyticsCreateAsyncRequest 
{
     ...
     */
    #[Assert\Type("string")]
    protected ?string $campaignBrandLabel = null;
     ...
     */
    #[Assert\Type("string")]
    protected ?string $campaignCustomLabel = null;
     ...
     */
    #[Assert\All([
        new Assert\Type("OpenAPI\Server\Model\CampaignObjectiveType"),
    ])]
    #[Assert\Count(max: 7)]
    #[Assert\Count(min: 1)]
     ...
     */
    #[Assert\Type("bool")]
    protected ?bool $combineTargetingTypes = false;
     ...
     * @Type("string")
     */
    protected ?ConversionReportTimeType $conversionReportTime = ConversionReportTimeType::TIME_OF_AD_ACTION;
     ...
     * @Type("array<OpenAPI\Server\Model\CustomConversionEventMetrics>")
     */
    #[Assert\All([
        new Assert\Type("OpenAPI\Server\Model\CustomConversionEventMetrics"),
    ])]
    protected ?array $customConversionEventMetrics = null;
     ...
     * @Accessor(getter="getSerializedPrimarySort", setter="setDeserializedPrimarySort")
     * @Type("string")
     */
    protected ?PrimarySort $primarySort = PrimarySort::BY_ID;
     ...
     * @Type("string")
     */
    protected ?DataOutputFormat $reportFormat = DataOutputFormat::JSON;
     ...
     */
    #[Assert\All([
        new Assert\Type("OpenAPI\Server\Model\AdAdsAnalyticsAsyncTargetingTypes"),
    ])]
    #[Assert\Count(max: 5)]
    #[Assert\Count(min: 1)]
    ...
    public function __construct(?array $data = null)
    {
        if (is_array($data)) {
            ...
            $this->campaignBrandLabel = array_key_exists('campaignBrandLabel', $data) ? $data['campaignBrandLabel'] : $this->campaignBrandLabel;
            $this->campaignCustomLabel = array_key_exists('campaignCustomLabel', $data) ? $data['campaignCustomLabel'] : $this->campaignCustomLabel;
            ...
            $this->combineTargetingTypes = array_key_exists('combineTargetingTypes', $data) ? $data['combineTargetingTypes'] : $this->combineTargetingTypes;
            $this->conversionReportTime = array_key_exists('conversionReportTime', $data) ? $data['conversionReportTime'] : $this->conversionReportTime;
            $this->customConversionEventMetrics = array_key_exists('customConversionEventMetrics', $data) ? $data['customConversionEventMetrics'] : $this->customConversionEventMetrics;
     ...
     * Sets adIds.
     *
     * @param string[]|null $adIds  List of ad ids. This parameter is not supported for Product Item level reports.
     *
     * @return $this
     */
     ...
     *
     * @param ConversionReportAttributionType[]|null $attributionTypes  List of attribution types for the conversion report.
     *
     * @return $this
     */
    ...
    /**
     * Gets campaignBrandLabel.
     *
     * @return string|null
     */
    public function getCampaignBrandLabel(): ?string
    {
        return $this->campaignBrandLabel;
    }

    /**
     * Sets campaignBrandLabel.
     *
     * @param string|null $campaignBrandLabel  Campaign brand label for filtering.
     *
     * @return $this
     */
    public function setCampaignBrandLabel(?string $campaignBrandLabel = null): self
    {
    ...
    /**
     * Gets campaignCustomLabel.
     *
     * @return string|null
     */
    public function getCampaignCustomLabel(): ?string
    {
        return $this->campaignCustomLabel;
    }

    /**
     * Sets campaignCustomLabel.
     *
     * @param string|null $campaignCustomLabel  Campaign custom label for filtering.
     *
     * @return $this
     */
    public function setCampaignCustomLabel(?string $campaignCustomLabel = null): self
    {
     ...
     *
     * @param CampaignObjectiveType[]|null $campaignObjectiveTypes  List of values for filtering. [\"WEB_SESSIONS\"] is in BETA.
     *
     * @return $this
     */
    ...
    public function setDeserializedCampaignObjectiveTypes(?array $campaignObjectiveTypes = []): self
    {
        $this->campaignObjectiveTypes = array_map(
            static function ($value) {
                if (is_string($value)) {
                    $value = CampaignObjectiveType::tryFrom($value);
                }
     ...
     *
     * @param ConversionAttributionWindowDays|null $clickWindowDays  Number of days to use as the conversion attribution window for a pin click action.
     *
     * @return $this
     */
     ...
     * Sets clickWindowDays.
     *
     * @param string|ConversionAttributionWindowDays|null $clickWindowDays  Number of days to use as the conversion attribution window for a pin click action.
     *
     * @return $this
     */
     ...
     * Sets columns.
     *
     * @param ReportingColumnAsync[]|null $columns  Metric and entity columns. Pin promotion and ad related columns are not supported for Product Item level reports.
     *
     * @return $this
     */
    ...
    /**
     * Gets combineTargetingTypes.
     *
     * @return bool|null
     */
    public function isCombineTargetingTypes(): ?bool
    {
        return $this->combineTargetingTypes;
    }

    /**
     * Sets combineTargetingTypes.
     *
     * @param bool|null $combineTargetingTypes  Determines if the targeting types included in the request should be consolidated into a single breakdown.
     *
     * @return $this
     */
    public function setCombineTargetingTypes(?bool $combineTargetingTypes = null): self
    {
     ...
     *
     * @param ConversionReportTimeType|null $conversionReportTime  Date dimension for conversion metrics.
     *
     * @return $this
     */
     ...
     * Sets conversionReportTime.
     *
     * @param string|ConversionReportTimeType|null $conversionReportTime  Date dimension for conversion metrics.
     *
     * @return $this
     */
    ...
    /**
     * Gets customConversionEventMetrics.
     *
     * @return CustomConversionEventMetrics[]|null
     */
    public function getCustomConversionEventMetrics(): ?array
    {
        return $this->customConversionEventMetrics;
    }

    /**
     * Sets customConversionEventMetrics.
     *
     * @param CustomConversionEventMetrics[]|null $customConversionEventMetrics  List of advertiser-defined custom conversion event metrics to include in the report
     *
     * @return $this
     */
    public function setCustomConversionEventMetrics(?array $customConversionEventMetrics = null): self
    {
     ...
     * Sets endHour.
     *
     * @param int|null $endHour  Which hour of the end date to stop the report (inclusive). Only allowed for hourly reports.
     *
     * @return $this
     */
     ...
     *
     * @param ConversionAttributionWindowDays|null $engagementWindowDays  Number of days to use as the conversion attribution window for an engagement action.
     *
     * @return $this
     */
     ...
     * Sets granularity.
     *
     * @param Granularity|null $granularity  TOTAL - metrics are aggregated over the specified date range.   DAY - metrics are broken down daily.   HOUR - metrics are broken down hourly.   WEEKLY - metrics are broken down weekly.   MONTHLY - metrics are broken down monthly.
     *
     * @return $this
     */
     ...
     * Sets granularity.
     *
     * @param string|Granularity|null $granularity  TOTAL - metrics are aggregated over the specified date range.   DAY - metrics are broken down daily.   HOUR - metrics are broken down hourly.   WEEKLY - metrics are broken down weekly.   MONTHLY - metrics are broken down monthly.
     *
     * @return $this
     */
     ...
     * @return $this
     */
    public function setLevel(?MetricsReportingLevel $level = null): self
    {
        $this->level = $level;
     ...
     * @return $this
     */
    public function setDeserializedLevel(string|MetricsReportingLevel|null $level = null): self
    {
        if (is_string($level)) {
     ...
     * Gets primarySort.
     *
     * @return PrimarySort|null
     */
    public function getPrimarySort(): ?PrimarySort
    {
     ...
     * @return $this
     */
    public function setPrimarySort(?PrimarySort $primarySort = null): self
    {
    ...
    /**
     * Gets primarySort for serialization.
     *
     * @return string|null
     */
    public function getSerializedPrimarySort(): string|null
    {
        return !is_null($this->primarySort?->value) ? (string) $this->primarySort->value : null;
    }

    /**
     * Sets primarySort.
     *
     * @param string|PrimarySort|null $primarySort
     *
     * @return $this
     */
    public function setDeserializedPrimarySort(string|PrimarySort|null $primarySort = null): self
    {
        if (is_string($primarySort)) {
            $primarySort = PrimarySort::tryFrom($primarySort);
        }
     ...
     *
     * @param ReportingTimeZone|null $reportingTimezone  Specify the timezone to be applied for the reporting.
     *
     * @return $this
     */
     ...
     * Sets reportingTimezone.
     *
     * @param string|ReportingTimeZone|null $reportingTimezone  Specify the timezone to be applied for the reporting.
     *
     * @return $this
     */
     ...
     * Sets startHour.
     *
     * @param int|null $startHour  Which hour of the start date to begin the report. Only allowed for hourly reports.
     *
     * @return $this
     */
     ...
     * Gets targetingTypes.
     *
     * @return AdAdsAnalyticsAsyncTargetingTypes[]|null
     */
     ...
     * Sets targetingTypes.
     *
     * @param AdAdsAnalyticsAsyncTargetingTypes[]|null $targetingTypes  List of targeting types. Requires `level` to be a value ending in `_TARGETING`.
     *
     * @return $this
     */
    ...
    public function setDeserializedTargetingTypes(?array $targetingTypes = []): self
    {
        $this->targetingTypes = array_map(
            static function ($value) {
                if (is_string($value)) {
                    $value = AdAdsAnalyticsAsyncTargetingTypes::tryFrom($value);
                }
     ...
     * Sets viewWindowDays.
     *
     * @param ConversionAttributionWindowDays|null $viewWindowDays  Number of days to use as the conversion attribution window for a view action.
     *
     * @return $this
     */
     ...
     * Sets viewWindowDays.
     *
     * @param string|ConversionAttributionWindowDays|null $viewWindowDays  Number of days to use as the conversion attribution window for a view action.
     *
     * @return $this
     */
