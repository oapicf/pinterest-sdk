...
class AdsAnalyticsCreateAsyncRequest 
{
    ...
    */
     ...
     *
     * @var AdsAnalyticsCreateAsyncRequestAllOfCustomConversionEventMetrics[]|null
     * @SerializedName("custom_conversion_event_metrics")
     * @Type("array<OpenAPI\Server\Model\AdsAnalyticsCreateAsyncRequestAllOfCustomConversionEventMetrics>")
    */
    #[Assert\All([
        new Assert\Type("OpenAPI\Server\Model\AdsAnalyticsCreateAsyncRequestAllOfCustomConversionEventMetrics"),
    ])]
    ...
    *
    * @param bool|null $combineTargetingTypes  Determines if the targeting types included in the request should be consolidated into a single breakdown. For example, when combine_targeting_types is set to true, if GENDER and COUNTRY are targeting types in the request, the response will have a targeting type of GENDER_AND_COUNTRY and targeting values such as female&US. This feature is currently in BETA and is not available to all users.
    *
    * @return $this
    */
     ...
     *
     * @return AdsAnalyticsCreateAsyncRequestAllOfCustomConversionEventMetrics[]|null
     */
    ...
    *
    * @param AdsAnalyticsCreateAsyncRequestAllOfCustomConversionEventMetrics[]|null $customConversionEventMetrics  List of advertiser-defined custom conversion event metrics to include in the report
    *
    * @return $this
    */
    ...
    *
    * @param ReportingTimeZone|null $reportingTimezone  Specify the timezone to be applied for the reporting. This feature is currently in BETA and is not available to all users.
    *
    * @return $this
    */
    ...
    * Sets reportingTimezone.
    *
    * @param string|ReportingTimeZone|null $reportingTimezone  Specify the timezone to be applied for the reporting. This feature is currently in BETA and is not available to all users.
    *
    * @return $this
    */
