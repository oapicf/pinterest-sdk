...
class CatalogsProductGroupPinsList200Response 
{
    ...
    /**
     * @var CatalogsProduct[]|null
     * @SerializedName("items")
     * @Type("array<OpenAPI\Server\Model\CatalogsProduct>")
     */
    #[Assert\NotNull]
    #[Assert\Valid]
    #[Assert\All([
        new Assert\Type("OpenAPI\Server\Model\CatalogsProduct"),
    ])]
     ...
     * Sets items.
     *
     * @param CatalogsProduct[]|null $items
     *
     * @return $this
     */
