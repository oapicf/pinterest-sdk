...
class BillingApiInterfaceTest extends WebTestCase
{
     ...
     *
     */
    public function testBillingInvoiceDownloadGet(): void
    {
        $client = self::$client;
        ...
        $data = $this->genTestData('^\\d+$');
        $path = str_replace($pattern, $data, $path);
        $pattern = '{billingInvoiceId}';
        $data = $this->genTestData('^\\d+$');
        $path = str_replace($pattern, $data, $path);

        $crawler = $client->request('GET', $path);
        $this->markTestSkipped('Test for billingInvoiceDownloadGet not implemented');
    }
     ...
     *
     */
    public function testBillingInvoicesGet(): void
    {
        $client = self::$client;
        ...
        $crawler = $client->request('GET', $path);
        $this->markTestSkipped('Test for billingInvoicesGet not implemented');
    }
