...
class AdAccountsApiInterfaceTest extends WebTestCase
{
     ...
     *
     */
    public function testAnalyticsCreateConversionProductReport(): void
    {
        $client = self::$client;
        ...
        $crawler = $client->request('POST', $path, [], [], ['CONTENT_TYPE' => 'application/json']);
        $this->markTestSkipped('Test for analyticsCreateConversionProductReport not implemented');
    }
     ...
     *
     */
    public function testAnalyticsGetConversionProductReport(): void
    {
        $client = self::$client;
        ...
        $crawler = $client->request('GET', $path);
        $this->markTestSkipped('Test for analyticsGetConversionProductReport not implemented');
    }
