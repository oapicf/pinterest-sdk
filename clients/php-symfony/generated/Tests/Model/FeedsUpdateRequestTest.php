 ...
 *
 * @category    Class
 * @description FeedsUpdateRequest
 * @package     OpenAPI\Server\Tests\Model
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\FeedsUpdateRequest
 */
class FeedsUpdateRequestTest extends TestCase
{
    protected FeedsUpdateRequest|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(FeedsUpdateRequest::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(FeedsUpdateRequest::class));
        $this->assertInstanceOf(FeedsUpdateRequest::class, $this->object);
    }
