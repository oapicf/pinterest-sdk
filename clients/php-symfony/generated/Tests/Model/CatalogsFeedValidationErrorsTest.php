...
use OpenAPI\Server\Model\CatalogsFeedValidationErrors;
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\CatalogsFeedValidationErrors
 */
class CatalogsFeedValidationErrorsTest extends TestCase
{
    protected CatalogsFeedValidationErrors|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(CatalogsFeedValidationErrors::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(CatalogsFeedValidationErrors::class));
        $this->assertInstanceOf(CatalogsFeedValidationErrors::class, $this->object);
    }
     ...
     * @small
     */
    public function testPropertyFETCHERROR(): void
    {
        $this->markTestSkipped('Test for property fETCHERROR not implemented');
    }
     ...
     * @small
     */
    public function testPropertyFETCHINACTIVEFEEDERROR(): void
    {
        $this->markTestSkipped('Test for property fETCHINACTIVEFEEDERROR not implemented');
    }
     ...
     * @small
     */
    public function testPropertyENCODINGERROR(): void
    {
        $this->markTestSkipped('Test for property eNCODINGERROR not implemented');
    }
     ...
     * @small
     */
    public function testPropertyDELIMITERERROR(): void
    {
        $this->markTestSkipped('Test for property dELIMITERERROR not implemented');
    }
     ...
     * @small
     */
    public function testPropertyREQUIREDCOLUMNSMISSING(): void
    {
        $this->markTestSkipped('Test for property rEQUIREDCOLUMNSMISSING not implemented');
    }
     ...
     * @small
     */
    public function testPropertyINTERNALSERVICEERROR(): void
    {
        $this->markTestSkipped('Test for property iNTERNALSERVICEERROR not implemented');
    }
     ...
     * @small
     */
    public function testPropertyNOVERIFIEDDOMAIN(): void
    {
        $this->markTestSkipped('Test for property nOVERIFIEDDOMAIN not implemented');
    }
     ...
     * @small
     */
    public function testPropertyFEEDLENGTHTOOLONG(): void
    {
        $this->markTestSkipped('Test for property fEEDLENGTHTOOLONG not implemented');
    }
     ...
     * @small
     */
    public function testPropertyMALFORMEDXML(): void
    {
        $this->markTestSkipped('Test for property mALFORMEDXML not implemented');
    }
     ...
     * @small
     */
    public function testPropertyFEEDTOOSMALL(): void
    {
        $this->markTestSkipped('Test for property fEEDTOOSMALL not implemented');
    }
