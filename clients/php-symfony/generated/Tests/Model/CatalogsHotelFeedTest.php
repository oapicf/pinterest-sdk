...
use OpenAPI\Server\Model\CatalogsHotelFeed;
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\CatalogsHotelFeed
 */
class CatalogsHotelFeedTest extends TestCase
{
    protected CatalogsHotelFeed|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(CatalogsHotelFeed::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(CatalogsHotelFeed::class));
        $this->assertInstanceOf(CatalogsHotelFeed::class, $this->object);
    }
