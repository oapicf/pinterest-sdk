...
use OpenAPI\Server\Model\CampaignCreateCommon;
 ...
 *
 * @category    Class
 * @description CampaignCreateCommon
 * @package     OpenAPI\Server\Tests\Model
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\CampaignCreateCommon
 */
class CampaignCreateCommonTest extends TestCase
{
    protected CampaignCreateCommon|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(CampaignCreateCommon::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(CampaignCreateCommon::class));
        $this->assertInstanceOf(CampaignCreateCommon::class, $this->object);
    }
