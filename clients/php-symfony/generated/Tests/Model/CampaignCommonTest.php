...
use OpenAPI\Server\Model\CampaignCommon;
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\CampaignCommon
 */
class CampaignCommonTest extends TestCase
{
    protected CampaignCommon|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(CampaignCommon::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(CampaignCommon::class));
        $this->assertInstanceOf(CampaignCommon::class, $this->object);
    }
