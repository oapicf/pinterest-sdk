 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\SSIOEditInsertionOrderRequest
 */
class SSIOEditInsertionOrderRequestTest extends TestCase
{
    protected SSIOEditInsertionOrderRequest|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(SSIOEditInsertionOrderRequest::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(SSIOEditInsertionOrderRequest::class));
        $this->assertInstanceOf(SSIOEditInsertionOrderRequest::class, $this->object);
    }
     ...
     * @small
     */
    public function testPropertyOracleLineId(): void
    {
        $this->markTestSkipped('Test for property oracleLineId not implemented');
    }
     ...
     * @small
     */
    public function testPropertySalesforceOrderId(): void
    {
        $this->markTestSkipped('Test for property salesforceOrderId not implemented');
    }
