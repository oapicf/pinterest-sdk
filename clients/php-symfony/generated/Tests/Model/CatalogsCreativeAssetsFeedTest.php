...
use OpenAPI\Server\Model\CatalogsCreativeAssetsFeed;
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\CatalogsCreativeAssetsFeed
 */
class CatalogsCreativeAssetsFeedTest extends TestCase
{
    protected CatalogsCreativeAssetsFeed|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(CatalogsCreativeAssetsFeed::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(CatalogsCreativeAssetsFeed::class));
        $this->assertInstanceOf(CatalogsCreativeAssetsFeed::class, $this->object);
    }
