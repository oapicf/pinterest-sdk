 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\IntegrationRequestPatch
 */
class IntegrationRequestPatchTest extends TestCase
{
    protected IntegrationRequestPatch|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(IntegrationRequestPatch::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(IntegrationRequestPatch::class));
        $this->assertInstanceOf(IntegrationRequestPatch::class, $this->object);
    }
