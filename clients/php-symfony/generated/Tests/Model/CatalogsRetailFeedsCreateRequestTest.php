<?php
/**
 * CatalogsRetailFeedsCreateRequestTest
 *
 * PHP version 8.1.1
 *
 * @category Class
...
use OpenAPI\Server\Model\CatalogsRetailFeedsCreateRequest;
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\CatalogsRetailFeedsCreateRequest
 */
class CatalogsRetailFeedsCreateRequestTest extends TestCase
{
    protected CatalogsRetailFeedsCreateRequest|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(CatalogsRetailFeedsCreateRequest::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(CatalogsRetailFeedsCreateRequest::class));
        $this->assertInstanceOf(CatalogsRetailFeedsCreateRequest::class, $this->object);
    }
