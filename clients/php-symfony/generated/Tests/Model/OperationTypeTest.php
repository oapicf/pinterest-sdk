...
use OpenAPI\Server\Model\OperationType;
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\OperationType
 */
class OperationTypeTest extends TestCase
{
    protected OperationType|MockObject $object;
    ...
    {
        $this->assertTrue(enum_exists(OperationType::class));
    }
}
