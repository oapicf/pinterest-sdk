...
use OpenAPI\Server\Model\ErrorDetail;
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\ErrorDetail
 */
class ErrorDetailTest extends TestCase
{
    protected ErrorDetail|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(ErrorDetail::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(ErrorDetail::class));
        $this->assertInstanceOf(ErrorDetail::class, $this->object);
    }
