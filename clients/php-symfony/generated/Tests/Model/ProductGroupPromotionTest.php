 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\ProductGroupPromotion
 */
class ProductGroupPromotionTest extends TestCase
{
    protected ProductGroupPromotion|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(ProductGroupPromotion::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(ProductGroupPromotion::class));
        $this->assertInstanceOf(ProductGroupPromotion::class, $this->object);
    }
     ...
     * @small
     */
    public function testPropertyCollectionsHeaderType(): void
    {
        $this->markTestSkipped('Test for property collectionsHeaderType not implemented');
    }
     ...
     * @small
     */
    public function testPropertyIsGenerateBackground(): void
    {
        $this->markTestSkipped('Test for property isGenerateBackground not implemented');
    }
     ...
     * @small
     */
    public function testPropertySelectedImageTag(): void
    {
        $this->markTestSkipped('Test for property selectedImageTag not implemented');
    }
     ...
     * @small
     */
    public function testPropertySelectedVideoTag(): void
    {
        $this->markTestSkipped('Test for property selectedVideoTag not implemented');
    }
