...
use OpenAPI\Server\Model\CatalogsRetailFeed;
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\CatalogsRetailFeed
 */
class CatalogsRetailFeedTest extends TestCase
{
    protected CatalogsRetailFeed|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(CatalogsRetailFeed::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(CatalogsRetailFeed::class));
        $this->assertInstanceOf(CatalogsRetailFeed::class, $this->object);
    }
