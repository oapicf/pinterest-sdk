<?php
/**
 * CatalogsCreativeAssetsBatchRequestTest
 *
 * PHP version 8.1.1
 *
 * @category Class
...
use OpenAPI\Server\Model\CatalogsCreativeAssetsBatchRequest;
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\CatalogsCreativeAssetsBatchRequest
 */
class CatalogsCreativeAssetsBatchRequestTest extends TestCase
{
    protected CatalogsCreativeAssetsBatchRequest|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(CatalogsCreativeAssetsBatchRequest::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(CatalogsCreativeAssetsBatchRequest::class));
        $this->assertInstanceOf(CatalogsCreativeAssetsBatchRequest::class, $this->object);
    }
