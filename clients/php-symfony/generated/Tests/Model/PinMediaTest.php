...
use OpenAPI\Server\Model\PinMedia;
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\PinMedia
 */
class PinMediaTest extends TestCase
{
    protected PinMedia|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(PinMedia::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(PinMedia::class));
        $this->assertInstanceOf(PinMedia::class, $this->object);
    }
