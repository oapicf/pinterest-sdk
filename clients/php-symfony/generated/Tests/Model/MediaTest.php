 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\Media
 */
class MediaTest extends TestCase
{
    protected Media|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(Media::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(Media::class));
        $this->assertInstanceOf(Media::class, $this->object);
    }
