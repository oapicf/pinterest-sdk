...
use OpenAPI\Server\Model\TimeSeries;
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\TimeSeries
 */
class TimeSeriesTest extends TestCase
{
    protected TimeSeries|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(TimeSeries::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(TimeSeries::class));
        $this->assertInstanceOf(TimeSeries::class, $this->object);
    }
