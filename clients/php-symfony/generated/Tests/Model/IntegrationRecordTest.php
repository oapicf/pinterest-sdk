 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\IntegrationRecord
 */
class IntegrationRecordTest extends TestCase
{
    protected IntegrationRecord|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(IntegrationRecord::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(IntegrationRecord::class));
        $this->assertInstanceOf(IntegrationRecord::class, $this->object);
    }
