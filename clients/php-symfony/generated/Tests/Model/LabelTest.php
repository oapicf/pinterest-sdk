 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\Label
 */
class LabelTest extends TestCase
{
    protected Label|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(Label::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(Label::class));
