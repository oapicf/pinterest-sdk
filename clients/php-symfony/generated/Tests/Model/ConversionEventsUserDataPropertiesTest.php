<?php
/**
 * ConversionEventsUserDataPropertiesTest
 *
 * PHP version 8.1.1
 *
 * @category Class
...
use OpenAPI\Server\Model\ConversionEventsUserDataProperties;
 ...
 *
 * @category    Class
 * @description ConversionEventsUserDataProperties
 * @package     OpenAPI\Server\Tests\Model
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\ConversionEventsUserDataProperties
 */
class ConversionEventsUserDataPropertiesTest extends TestCase
{
    protected ConversionEventsUserDataProperties|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(ConversionEventsUserDataProperties::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(ConversionEventsUserDataProperties::class));
        $this->assertInstanceOf(ConversionEventsUserDataProperties::class, $this->object);
    }
