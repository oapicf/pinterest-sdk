 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\AdCreateRequest
 */
class AdCreateRequestTest extends TestCase
{
    protected AdCreateRequest|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(AdCreateRequest::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(AdCreateRequest::class));
        $this->assertInstanceOf(AdCreateRequest::class, $this->object);
    }
     ...
     * @small
     */
    public function testPropertyDisclosureType(): void
    {
        $this->markTestSkipped('Test for property disclosureType not implemented');
    }
     ...
     * @small
     */
    public function testPropertyDisclosureUrl(): void
    {
        $this->markTestSkipped('Test for property disclosureUrl not implemented');
    }
