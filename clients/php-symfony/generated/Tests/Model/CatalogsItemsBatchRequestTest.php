 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\CatalogsItemsBatchRequest
 */
class CatalogsItemsBatchRequestTest extends TestCase
{
    protected CatalogsItemsBatchRequest|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(CatalogsItemsBatchRequest::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(CatalogsItemsBatchRequest::class));
        $this->assertInstanceOf(CatalogsItemsBatchRequest::class, $this->object);
    }
