<?php
/**
 * OauthAccessTokenResponseClientCredentialsTest
 *
 * PHP version 8.1.1
 *
 * @category Class
...
use OpenAPI\Server\Model\OauthAccessTokenResponseClientCredentials;
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\OauthAccessTokenResponseClientCredentials
 */
class OauthAccessTokenResponseClientCredentialsTest extends TestCase
{
    protected OauthAccessTokenResponseClientCredentials|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(OauthAccessTokenResponseClientCredentials::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(OauthAccessTokenResponseClientCredentials::class));
        $this->assertInstanceOf(OauthAccessTokenResponseClientCredentials::class, $this->object);
    }
