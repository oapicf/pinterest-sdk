...
use OpenAPI\Server\Model\ItemResponseOneOf1;
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\ItemResponseOneOf1
 */
class ItemResponseOneOf1Test extends TestCase
{
    protected ItemResponseOneOf1|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(ItemResponseOneOf1::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(ItemResponseOneOf1::class));
        $this->assertInstanceOf(ItemResponseOneOf1::class, $this->object);
    }
