<?php
/**
 * CatalogsCreativeAssetsFeedsCreateRequestTest
 *
 * PHP version 8.1.1
 *
 * @category Class
...
use OpenAPI\Server\Model\CatalogsCreativeAssetsFeedsCreateRequest;
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\CatalogsCreativeAssetsFeedsCreateRequest
 */
class CatalogsCreativeAssetsFeedsCreateRequestTest extends TestCase
{
    protected CatalogsCreativeAssetsFeedsCreateRequest|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(CatalogsCreativeAssetsFeedsCreateRequest::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(CatalogsCreativeAssetsFeedsCreateRequest::class));
        $this->assertInstanceOf(CatalogsCreativeAssetsFeedsCreateRequest::class, $this->object);
    }
