 ...
 *
 * @category    Class
 * @description FeedsCreateRequest
 * @package     OpenAPI\Server\Tests\Model
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\FeedsCreateRequest
 */
class FeedsCreateRequestTest extends TestCase
{
    protected FeedsCreateRequest|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(FeedsCreateRequest::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(FeedsCreateRequest::class));
        $this->assertInstanceOf(FeedsCreateRequest::class, $this->object);
    }
