<?php
/**
 * CatalogsUpdatableCreativeAssetsAttributesTest
 *
 * PHP version 8.1.1
 *
 * @category Class
...
use OpenAPI\Server\Model\CatalogsUpdatableCreativeAssetsAttributes;
 ...
 *
 * @category    Class
 * @description CatalogsUpdatableCreativeAssetsAttributes
 * @package     OpenAPI\Server\Tests\Model
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\CatalogsUpdatableCreativeAssetsAttributes
 */
class CatalogsUpdatableCreativeAssetsAttributesTest extends TestCase
{
    protected CatalogsUpdatableCreativeAssetsAttributes|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(CatalogsUpdatableCreativeAssetsAttributes::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(CatalogsUpdatableCreativeAssetsAttributes::class));
        $this->assertInstanceOf(CatalogsUpdatableCreativeAssetsAttributes::class, $this->object);
    }
