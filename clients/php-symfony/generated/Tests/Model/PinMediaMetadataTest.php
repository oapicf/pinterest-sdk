...
use OpenAPI\Server\Model\PinMediaMetadata;
 ...
 *
 * @category    Class
 * @description PinMediaMetadata
 * @package     OpenAPI\Server\Tests\Model
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\PinMediaMetadata
 */
class PinMediaMetadataTest extends TestCase
{
    protected PinMediaMetadata|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(PinMediaMetadata::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(PinMediaMetadata::class));
        $this->assertInstanceOf(PinMediaMetadata::class, $this->object);
    }
