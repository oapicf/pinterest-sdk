 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\CatalogsFeedsUpdateRequest
 */
class CatalogsFeedsUpdateRequestTest extends TestCase
{
    protected CatalogsFeedsUpdateRequest|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(CatalogsFeedsUpdateRequest::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(CatalogsFeedsUpdateRequest::class));
        $this->assertInstanceOf(CatalogsFeedsUpdateRequest::class, $this->object);
    }
