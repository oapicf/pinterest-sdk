<?php
/**
 * CatalogsCreativeAssetsProductGroupTest
 *
 * PHP version 8.1.1
 *
 * @category Class
...
use OpenAPI\Server\Model\CatalogsCreativeAssetsProductGroup;
 ...
 *
 * @category    Class
 * @description CatalogsCreativeAssetsProductGroup
 * @package     OpenAPI\Server\Tests\Model
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\CatalogsCreativeAssetsProductGroup
 */
class CatalogsCreativeAssetsProductGroupTest extends TestCase
{
    protected CatalogsCreativeAssetsProductGroup|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(CatalogsCreativeAssetsProductGroup::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(CatalogsCreativeAssetsProductGroup::class));
        $this->assertInstanceOf(CatalogsCreativeAssetsProductGroup::class, $this->object);
    }
