<?php
/**
 * AdvancedAuctionItemsSubmitRequestTest
 *
 * PHP version 8.1.1
 *
 * @category Class
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\AdvancedAuctionItemsSubmitRequest
 */
class AdvancedAuctionItemsSubmitRequestTest extends TestCase
{
    protected AdvancedAuctionItemsSubmitRequest|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(AdvancedAuctionItemsSubmitRequest::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(AdvancedAuctionItemsSubmitRequest::class));
        $this->assertInstanceOf(AdvancedAuctionItemsSubmitRequest::class, $this->object);
    }
