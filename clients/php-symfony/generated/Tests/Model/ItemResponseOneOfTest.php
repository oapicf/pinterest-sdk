...
use OpenAPI\Server\Model\ItemResponseOneOf;
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\ItemResponseOneOf
 */
class ItemResponseOneOfTest extends TestCase
{
    protected ItemResponseOneOf|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(ItemResponseOneOf::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(ItemResponseOneOf::class));
        $this->assertInstanceOf(ItemResponseOneOf::class, $this->object);
    }
