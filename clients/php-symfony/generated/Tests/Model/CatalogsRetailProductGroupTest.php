<?php
/**
 * CatalogsRetailProductGroupTest
 *
 * PHP version 8.1.1
 *
 * @category Class
...
use OpenAPI\Server\Model\CatalogsRetailProductGroup;
 ...
 *
 * @category    Class
 * @description CatalogsRetailProductGroup
 * @package     OpenAPI\Server\Tests\Model
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\CatalogsRetailProductGroup
 */
class CatalogsRetailProductGroupTest extends TestCase
{
    protected CatalogsRetailProductGroup|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(CatalogsRetailProductGroup::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(CatalogsRetailProductGroup::class));
        $this->assertInstanceOf(CatalogsRetailProductGroup::class, $this->object);
    }
