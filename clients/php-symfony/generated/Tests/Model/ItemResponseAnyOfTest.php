...
use OpenAPI\Server\Model\ItemResponseAnyOf;
 ...
 *
 * @category    Class
 * @description ItemResponseAnyOf
 * @package     OpenAPI\Server\Tests\Model
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\ItemResponseAnyOf
 */
class ItemResponseAnyOfTest extends TestCase
{
    protected ItemResponseAnyOf|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(ItemResponseAnyOf::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(ItemResponseAnyOf::class));
        $this->assertInstanceOf(ItemResponseAnyOf::class, $this->object);
    }
