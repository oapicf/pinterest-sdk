...
use OpenAPI\Server\Model\ProductGroupPromotionCreateRequestElement;
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\ProductGroupPromotionCreateRequestElement
 */
class ProductGroupPromotionCreateRequestElementTest extends TestCase
{
    protected ProductGroupPromotionCreateRequestElement|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(ProductGroupPromotionCreateRequestElement::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(ProductGroupPromotionCreateRequestElement::class));
        $this->assertInstanceOf(ProductGroupPromotionCreateRequestElement::class, $this->object);
    }
