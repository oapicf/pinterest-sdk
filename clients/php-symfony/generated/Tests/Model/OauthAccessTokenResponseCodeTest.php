...
use OpenAPI\Server\Model\OauthAccessTokenResponseCode;
 ...
 *
 * @category    Class
 * @description OauthAccessTokenResponseCode
 * @package     OpenAPI\Server\Tests\Model
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\OauthAccessTokenResponseCode
 */
class OauthAccessTokenResponseCodeTest extends TestCase
{
    protected OauthAccessTokenResponseCode|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(OauthAccessTokenResponseCode::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(OauthAccessTokenResponseCode::class));
        $this->assertInstanceOf(OauthAccessTokenResponseCode::class, $this->object);
    }
