<?php
/**
 * CampaignCreateResponseDataTest
 *
 * PHP version 8.1.1
 *
 * @category Class
...
use OpenAPI\Server\Model\CampaignCreateResponseData;
 ...
 *
 * @category    Class
 * @description CampaignCreateResponseData
 * @package     OpenAPI\Server\Tests\Model
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\CampaignCreateResponseData
 */
class CampaignCreateResponseDataTest extends TestCase
{
    protected CampaignCreateResponseData|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(CampaignCreateResponseData::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(CampaignCreateResponseData::class));
        $this->assertInstanceOf(CampaignCreateResponseData::class, $this->object);
    }
     ...
     * @small
     */
    public function testPropertyIsPerformancePlus(): void
    {
        $this->markTestSkipped('Test for property isPerformancePlus not implemented');
    }
