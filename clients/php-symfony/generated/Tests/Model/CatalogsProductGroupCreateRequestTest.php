<?php
/**
 * CatalogsProductGroupCreateRequestTest
 *
 * PHP version 8.1.1
 *
 * @category Class
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\CatalogsProductGroupCreateRequest
 */
class CatalogsProductGroupCreateRequestTest extends TestCase
{
    protected CatalogsProductGroupCreateRequest|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(CatalogsProductGroupCreateRequest::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(CatalogsProductGroupCreateRequest::class));
        $this->assertInstanceOf(CatalogsProductGroupCreateRequest::class, $this->object);
    }
