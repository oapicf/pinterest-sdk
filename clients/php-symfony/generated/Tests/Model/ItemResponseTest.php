...
use OpenAPI\Server\Model\ItemResponse;
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\ItemResponse
 */
class ItemResponseTest extends TestCase
{
    protected ItemResponse|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(ItemResponse::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(ItemResponse::class));
        $this->assertInstanceOf(ItemResponse::class, $this->object);
    }
