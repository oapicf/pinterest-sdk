<?php
/**
 * CatalogsHotelFeedsUpdateRequestTest
 *
 * PHP version 8.1.1
 *
 * @category Class
...
use OpenAPI\Server\Model\CatalogsHotelFeedsUpdateRequest;
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\CatalogsHotelFeedsUpdateRequest
 */
class CatalogsHotelFeedsUpdateRequestTest extends TestCase
{
    protected CatalogsHotelFeedsUpdateRequest|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(CatalogsHotelFeedsUpdateRequest::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(CatalogsHotelFeedsUpdateRequest::class));
        $this->assertInstanceOf(CatalogsHotelFeedsUpdateRequest::class, $this->object);
    }
