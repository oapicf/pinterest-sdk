...
use OpenAPI\Server\Model\CatalogsUpdateRetailItem;
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\CatalogsUpdateRetailItem
 */
class CatalogsUpdateRetailItemTest extends TestCase
{
    protected CatalogsUpdateRetailItem|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(CatalogsUpdateRetailItem::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(CatalogsUpdateRetailItem::class));
        $this->assertInstanceOf(CatalogsUpdateRetailItem::class, $this->object);
    }
