...
use OpenAPI\Server\Model\ImageBase64;
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\ImageBase64
 */
class ImageBase64Test extends TestCase
{
    protected ImageBase64|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(ImageBase64::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(ImageBase64::class));
        $this->assertInstanceOf(ImageBase64::class, $this->object);
    }
