<?php
/**
 * CatalogsCreativeAssetsFeedsUpdateRequestTest
 *
 * PHP version 8.1.1
 *
 * @category Class
...
use OpenAPI\Server\Model\CatalogsCreativeAssetsFeedsUpdateRequest;
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\CatalogsCreativeAssetsFeedsUpdateRequest
 */
class CatalogsCreativeAssetsFeedsUpdateRequestTest extends TestCase
{
    protected CatalogsCreativeAssetsFeedsUpdateRequest|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(CatalogsCreativeAssetsFeedsUpdateRequest::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(CatalogsCreativeAssetsFeedsUpdateRequest::class));
        $this->assertInstanceOf(CatalogsCreativeAssetsFeedsUpdateRequest::class, $this->object);
    }
