...
use OpenAPI\Server\Model\OauthAccessTokenResponseRefresh;
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\OauthAccessTokenResponseRefresh
 */
class OauthAccessTokenResponseRefreshTest extends TestCase
{
    protected OauthAccessTokenResponseRefresh|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(OauthAccessTokenResponseRefresh::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(OauthAccessTokenResponseRefresh::class));
        $this->assertInstanceOf(OauthAccessTokenResponseRefresh::class, $this->object);
    }
