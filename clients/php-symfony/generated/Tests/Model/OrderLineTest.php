 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\OrderLine
 */
class OrderLineTest extends TestCase
{
    protected OrderLine|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(OrderLine::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(OrderLine::class));
        $this->assertInstanceOf(OrderLine::class, $this->object);
    }
