<?php
/**
 * CatalogsRetailFeedsUpdateRequestTest
 *
 * PHP version 8.1.1
 *
 * @category Class
...
use OpenAPI\Server\Model\CatalogsRetailFeedsUpdateRequest;
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\CatalogsRetailFeedsUpdateRequest
 */
class CatalogsRetailFeedsUpdateRequestTest extends TestCase
{
    protected CatalogsRetailFeedsUpdateRequest|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(CatalogsRetailFeedsUpdateRequest::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(CatalogsRetailFeedsUpdateRequest::class));
        $this->assertInstanceOf(CatalogsRetailFeedsUpdateRequest::class, $this->object);
    }
