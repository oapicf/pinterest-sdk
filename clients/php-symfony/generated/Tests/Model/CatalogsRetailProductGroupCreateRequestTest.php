<?php
/**
 * CatalogsRetailProductGroupCreateRequestTest
 *
 * PHP version 8.1.1
 *
 * @category Class
...
use OpenAPI\Server\Model\CatalogsRetailProductGroupCreateRequest;
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\CatalogsRetailProductGroupCreateRequest
 */
class CatalogsRetailProductGroupCreateRequestTest extends TestCase
{
    protected CatalogsRetailProductGroupCreateRequest|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(CatalogsRetailProductGroupCreateRequest::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(CatalogsRetailProductGroupCreateRequest::class));
        $this->assertInstanceOf(CatalogsRetailProductGroupCreateRequest::class, $this->object);
    }
