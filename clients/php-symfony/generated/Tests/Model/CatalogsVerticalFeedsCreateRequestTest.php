...
use OpenAPI\Server\Model\CatalogsVerticalFeedsCreateRequest;
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\CatalogsVerticalFeedsCreateRequest
 */
class CatalogsVerticalFeedsCreateRequestTest extends TestCase
{
    protected CatalogsVerticalFeedsCreateRequest|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(CatalogsVerticalFeedsCreateRequest::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(CatalogsVerticalFeedsCreateRequest::class));
        $this->assertInstanceOf(CatalogsVerticalFeedsCreateRequest::class, $this->object);
    }
