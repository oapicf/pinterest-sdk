 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\Paginated
 */
class PaginatedTest extends TestCase
{
    protected Paginated|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(Paginated::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(Paginated::class));
        $this->assertInstanceOf(Paginated::class, $this->object);
    }
