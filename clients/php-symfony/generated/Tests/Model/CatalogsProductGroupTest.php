 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\CatalogsProductGroup
 */
class CatalogsProductGroupTest extends TestCase
{
    protected CatalogsProductGroup|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(CatalogsProductGroup::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(CatalogsProductGroup::class));
        $this->assertInstanceOf(CatalogsProductGroup::class, $this->object);
    }
