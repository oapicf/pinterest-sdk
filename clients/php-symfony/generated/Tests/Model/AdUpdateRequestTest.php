 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\AdUpdateRequest
 */
class AdUpdateRequestTest extends TestCase
{
    protected AdUpdateRequest|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(AdUpdateRequest::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(AdUpdateRequest::class));
        $this->assertInstanceOf(AdUpdateRequest::class, $this->object);
    }
