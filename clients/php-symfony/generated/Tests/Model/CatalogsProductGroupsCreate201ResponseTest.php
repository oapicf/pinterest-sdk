<?php
/**
 * CatalogsProductGroupsCreate201ResponseTest
 *
 * PHP version 8.1.1
 *
 * @category Class
 ...
 *
 * @category    Class
 * @description CatalogsProductGroupsCreate201Response
 * @package     OpenAPI\Server\Tests\Model
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\CatalogsProductGroupsCreate201Response
 */
class CatalogsProductGroupsCreate201ResponseTest extends TestCase
{
    protected CatalogsProductGroupsCreate201Response|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(CatalogsProductGroupsCreate201Response::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(CatalogsProductGroupsCreate201Response::class));
        $this->assertInstanceOf(CatalogsProductGroupsCreate201Response::class, $this->object);
    }
