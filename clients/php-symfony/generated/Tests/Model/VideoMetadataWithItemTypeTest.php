...
use OpenAPI\Server\Model\VideoMetadataWithItemType;
 ...
 *
 * @category    Class
 * @description VideoMetadataWithItemType
 * @package     OpenAPI\Server\Tests\Model
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\VideoMetadataWithItemType
 */
class VideoMetadataWithItemTypeTest extends TestCase
{
    protected VideoMetadataWithItemType|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(VideoMetadataWithItemType::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(VideoMetadataWithItemType::class));
        $this->assertInstanceOf(VideoMetadataWithItemType::class, $this->object);
    }
