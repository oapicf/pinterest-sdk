...
use OpenAPI\Server\Model\CatalogsCreativeAssetsProductGroupFilterKeys;
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\CatalogsCreativeAssetsProductGroupFilterKeys
 */
class CatalogsCreativeAssetsProductGroupFilterKeysTest extends TestCase
{
    protected CatalogsCreativeAssetsProductGroupFilterKeys|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(CatalogsCreativeAssetsProductGroupFilterKeys::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(CatalogsCreativeAssetsProductGroupFilterKeys::class));
        $this->assertInstanceOf(CatalogsCreativeAssetsProductGroupFilterKeys::class, $this->object);
    }
