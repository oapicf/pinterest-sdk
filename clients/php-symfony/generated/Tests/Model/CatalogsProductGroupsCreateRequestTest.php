<?php
/**
 * CatalogsProductGroupsCreateRequestTest
 *
 * PHP version 8.1.1
 *
 * @category Class
 ...
 *
 * @category    Class
 * @description CatalogsProductGroupsCreateRequest
 * @package     OpenAPI\Server\Tests\Model
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\CatalogsProductGroupsCreateRequest
 */
class CatalogsProductGroupsCreateRequestTest extends TestCase
{
    protected CatalogsProductGroupsCreateRequest|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(CatalogsProductGroupsCreateRequest::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(CatalogsProductGroupsCreateRequest::class));
        $this->assertInstanceOf(CatalogsProductGroupsCreateRequest::class, $this->object);
    }
