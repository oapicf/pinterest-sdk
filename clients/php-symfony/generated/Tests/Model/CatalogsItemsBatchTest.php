 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\CatalogsItemsBatch
 */
class CatalogsItemsBatchTest extends TestCase
{
    protected CatalogsItemsBatch|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(CatalogsItemsBatch::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(CatalogsItemsBatch::class));
        $this->assertInstanceOf(CatalogsItemsBatch::class, $this->object);
    }
