...
use OpenAPI\Server\Model\CatalogsHotelBatchRequest;
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\CatalogsHotelBatchRequest
 */
class CatalogsHotelBatchRequestTest extends TestCase
{
    protected CatalogsHotelBatchRequest|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(CatalogsHotelBatchRequest::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(CatalogsHotelBatchRequest::class));
        $this->assertInstanceOf(CatalogsHotelBatchRequest::class, $this->object);
    }
