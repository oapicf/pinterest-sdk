 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\CampaignUpdateRequest
 */
class CampaignUpdateRequestTest extends TestCase
{
    protected CampaignUpdateRequest|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(CampaignUpdateRequest::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(CampaignUpdateRequest::class));
        $this->assertInstanceOf(CampaignUpdateRequest::class, $this->object);
    }
