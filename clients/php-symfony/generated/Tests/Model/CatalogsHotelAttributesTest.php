...
use OpenAPI\Server\Model\CatalogsHotelAttributes;
 ...
 *
 * @category    Class
 * @description CatalogsHotelAttributes
 * @package     OpenAPI\Server\Tests\Model
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\CatalogsHotelAttributes
 */
class CatalogsHotelAttributesTest extends TestCase
{
    protected CatalogsHotelAttributes|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(CatalogsHotelAttributes::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(CatalogsHotelAttributes::class));
        $this->assertInstanceOf(CatalogsHotelAttributes::class, $this->object);
    }
