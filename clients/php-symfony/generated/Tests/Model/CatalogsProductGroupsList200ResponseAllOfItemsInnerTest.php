<?php
/**
 * CatalogsProductGroupsList200ResponseAllOfItemsInnerTest
 *
 * PHP version 8.1.1
 *
 * @category Class
...
use OpenAPI\Server\Model\CatalogsProductGroupsList200ResponseAllOfItemsInner;
 ...
 *
 * @category    Class
 * @description CatalogsProductGroupsList200ResponseAllOfItemsInner
 * @package     OpenAPI\Server\Tests\Model
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\CatalogsProductGroupsList200ResponseAllOfItemsInner
 */
class CatalogsProductGroupsList200ResponseAllOfItemsInnerTest extends TestCase
{
    protected CatalogsProductGroupsList200ResponseAllOfItemsInner|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(CatalogsProductGroupsList200ResponseAllOfItemsInner::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(CatalogsProductGroupsList200ResponseAllOfItemsInner::class));
        $this->assertInstanceOf(CatalogsProductGroupsList200ResponseAllOfItemsInner::class, $this->object);
    }
