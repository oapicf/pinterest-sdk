...
use OpenAPI\Server\Model\CatalogsCreateHotelItem;
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\CatalogsCreateHotelItem
 */
class CatalogsCreateHotelItemTest extends TestCase
{
    protected CatalogsCreateHotelItem|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(CatalogsCreateHotelItem::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(CatalogsCreateHotelItem::class));
        $this->assertInstanceOf(CatalogsCreateHotelItem::class, $this->object);
    }
