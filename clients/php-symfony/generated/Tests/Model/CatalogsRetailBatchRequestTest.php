<?php
/**
 * CatalogsRetailBatchRequestTest
 *
 * PHP version 8.1.1
 *
 * @category Class
...
use OpenAPI\Server\Model\CatalogsRetailBatchRequest;
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\CatalogsRetailBatchRequest
 */
class CatalogsRetailBatchRequestTest extends TestCase
{
    protected CatalogsRetailBatchRequest|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(CatalogsRetailBatchRequest::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(CatalogsRetailBatchRequest::class));
        $this->assertInstanceOf(CatalogsRetailBatchRequest::class, $this->object);
    }
