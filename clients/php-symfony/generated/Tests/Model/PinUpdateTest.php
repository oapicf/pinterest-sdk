 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\PinUpdate
 */
class PinUpdateTest extends TestCase
{
    protected PinUpdate|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(PinUpdate::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(PinUpdate::class));
        $this->assertInstanceOf(PinUpdate::class, $this->object);
    }
     ...
     * @small
     */
    public function testPropertyCarouselSlots(): void
    {
        $this->markTestSkipped('Test for property carouselSlots not implemented');
    }
