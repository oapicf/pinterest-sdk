...
interface IntegrationsApiInterface
{
     ...
     *
     * @param  string $externalBusinessId  External business ID for the integration. (required)
     * @param  IntegrationMetadataUpdate $integrationMetadataUpdate   (required)
     * @param  int     &$responseCode    The HTTP Response Code
     * @param  array   $responseHeaders  Additional HTTP headers to return with the response ()
     *
     * @return array|object|null
     ...
     *
     * @param  IntegrationMetadataCreate $integrationMetadataCreate   (required)
     * @param  int     &$responseCode    The HTTP Response Code
     * @param  array   $responseHeaders  Additional HTTP headers to return with the response ()
     *
     * @return array|object|null
     ...
     *
     * @param  IntegrationLogsRequestCreate $integrationLogsRequestCreate   (required)
     * @param  int     &$responseCode    The HTTP Response Code
     * @param  array   $responseHeaders  Additional HTTP headers to return with the response ()
     *
     * @return array|object|null
