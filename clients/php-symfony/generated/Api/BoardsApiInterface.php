...
interface BoardsApiInterface
{
     ...
     *
     * @param  string|null $adAccountId  Unique identifier of an ad account. (optional)
     * @param  \OpenAPI\Server\Model\OpenAPI\Server\Model\BoardPrivacyFilter|null $privacy  The privacy level of the board (optional)
     * @param  string|null $bookmark  Cursor used to fetch the next page of items (optional)
    ...
    public function boardsList(
        ?string $adAccountId,
        ?\OpenAPI\Server\Model\OpenAPI\Server\Model\BoardPrivacyFilter $privacy,
        ?string $bookmark,
        int $pageSize,
        int &$responseCode,
        array &$responseHeaders
