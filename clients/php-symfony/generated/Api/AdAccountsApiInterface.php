...
interface AdAccountsApiInterface
{
     ...
     *
     * @param  string $adAccountId  Unique identifier of an ad account. (required)
     * @param  ConversionProductReportRequest $conversionProductReportRequest   (required)
     * @param  int     &$responseCode    The HTTP Response Code
     * @param  array   $responseHeaders  Additional HTTP headers to return with the response ()
     *
     * @return array|object|null
     ...
     * @param  \OpenAPI\Server\Model\OpenAPI\Server\Model\Granularity|null $granularity  TOTAL - metrics are aggregated over the specified date range.    DAY - metrics are broken down daily.    HOUR - metrics are broken down hourly.    WEEKLY - metrics are broken down weekly.    MONTHLY - metrics are broken down monthly (optional)
     * @param  int     &$responseCode    The HTTP Response Code
     * @param  array   $responseHeaders  Additional HTTP headers to return with the response ()
     *
     * @return array|object|null
