...
interface PromotionsApiInterface
{
     ...
     * @param  array $promotionCreateRequest  List of promotions to create, size limit [1, 30]. (required)
     ...
     *
     * @param  string $adAccountId  Unique identifier of an ad account. (required)
     * @param  string $promotionId  Unique identifier of a promotion (required)
     * @param  int     &$responseCode    The HTTP Response Code
     * @param  array   $responseHeaders  Additional HTTP headers to return with the response ()
     *
     * @return void
     ...
     *
     * @param  string $adAccountId  Unique identifier of an ad account. (required)
     * @param  array $promotionUpdateRequest  List of promotions to create, size limit [1, 30]. (required)
     * @param  int     &$responseCode    The HTTP Response Code
     * @param  array   $responseHeaders  Additional HTTP headers to return with the response ()
     *
     * @return array|object|null
