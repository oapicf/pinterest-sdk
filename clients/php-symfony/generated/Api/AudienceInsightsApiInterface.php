...
interface AudienceInsightsApiInterface
{
     ...
     * @param  \OpenAPI\Server\Model\OpenAPI\Server\Model\AudienceInsightType $audienceInsightType  Type of audience insights. (required)
    ...
    public function audienceInsightsGet(
        string $adAccountId,
        \OpenAPI\Server\Model\OpenAPI\Server\Model\AudienceInsightType $audienceInsightType,
        int &$responseCode,
