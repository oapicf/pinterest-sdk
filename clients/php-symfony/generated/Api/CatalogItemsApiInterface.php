...
/**
 * CatalogItemsApiInterface Interface Doc Comment
 *
 * @category Interface
...
interface CatalogItemsApiInterface
{
     ...
     *
     * @param  CatalogsItemsBatchPostRequest $catalogsItemsBatchPostRequest   (required)
     * @param  string|null $adAccountId  Unique identifier of an ad account. (optional)
     * @param  int     &$responseCode    The HTTP Response Code
     * @param  array   $responseHeaders  Additional HTTP headers to return with the response ()
     *
     ...
     *
     * @param  CatalogsItemsRequest $catalogsItemsRequest   (required)
     * @param  string|null $adAccountId  Unique identifier of an ad account. (optional)
     * @param  int     &$responseCode    The HTTP Response Code
     * @param  array   $responseHeaders  Additional HTTP headers to return with the response ()
     *
