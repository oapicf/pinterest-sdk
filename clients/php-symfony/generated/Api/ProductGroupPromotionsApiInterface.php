...
interface ProductGroupPromotionsApiInterface
{
     ...
     * @param  ProductGroupPromotionCreateRequest $productGroupPromotionCreateRequest  List of Product Group Promotions to create, size limit [1, 30]. (required)
     ...
     *
     * @param  string $adAccountId  Unique identifier of an ad account. (required)
     * @param  ProductGroupPromotionUpdateRequest $productGroupPromotionUpdateRequest  Parameters to update Product group promotions (required)
     * @param  int     &$responseCode    The HTTP Response Code
     * @param  array   $responseHeaders  Additional HTTP headers to return with the response ()
     *
     * @return array|object|null
