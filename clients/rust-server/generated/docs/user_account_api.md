...
> models::BoardsList200Response boards_user_follows/list(ctx, ctx, optional)
...
# **followers/list**
> models::FollowersList200Response followers/list(ctx, ctx, optional)
List followers
...
> Vec<models::LinkedBusiness> linked_business_accounts/get(ctx, ctx, )
...
> models::UserWebsite unverify_website/delete(ctx, website)
Unverify website
 ...
 **start_date** | **chrono::naive::NaiveDate**| Metric report start date (UTC). Format: YYYY-MM-DD. Cannot be more than 90 days back from today. | 
 **end_date** | **chrono::naive::NaiveDate**| Metric report end date (UTC). Format: YYYY-MM-DD. Cannot be more than 90 days past start_date. | 
 **from_claimed_content** | [****](.md)| Filter on Pins that match your claimed domain. | 
 **pin_format** | [****](.md)| Pin formats to get data for, default is all. | 
 **app_types** | [****](.md)| Apps or devices to get data for, default is all. | 
 **content_type** | [****](.md)| Filter to paid or organic data. Default is all. | 
 **source** | [****](.md)| Filter to activity from Pins created and saved by your, or activity created and saved by others from your claimed accounts | 
 **metric_types** | [**models::QuerymetrictypesItems**](models::QuerymetrictypesItems.md)| Metric types to get data for, default is all. | 
...
> models::TopPinsAnalyticsResponse user_account/analytics/top_pins(ctx, ctx, start_date, end_date, sort_by, optional)
 ...
 **ctx** | **context.Context** | context containing the authentication | nil if no authentication
  **start_date** | **chrono::naive::NaiveDate**| Metric report start date (UTC). Format: YYYY-MM-DD. Cannot be more than 90 days back from today. | 
  **end_date** | **chrono::naive::NaiveDate**| Metric report end date (UTC). Format: YYYY-MM-DD. Cannot be more than 90 days past start_date. | 
  **sort_by** | [****](.md)| Specify sorting order for metrics | 
 **optional** | **map[string]interface{}** | optional parameters | nil if no parameters
 ...
 **source** | [****](.md)| Filter to activity from Pins created and saved by your, or activity created and saved by others from your claimed accounts | 
 **metric_types** | [**models::QuerymetrictypesItems**](models::QuerymetrictypesItems.md)| Metric types to get data for, default is all. | 
 **num_of_pins** | **u8**| Number of pins to include, default is 10. Max is 50. | [default to 10]
 **created_in_last_n_days** | [****](.md)| Get metrics for pins created in the last \"n\" days. | 
 **ad_account_id** | **String**| Unique identifier of an ad account. | 
...
> models::TopVideoPinsAnalyticsResponse user_account/analytics/top_video_pins(ctx, ctx, start_date, end_date, sort_by, optional)
 ...
 **ctx** | **context.Context** | context containing the authentication | nil if no authentication
  **start_date** | **chrono::naive::NaiveDate**| Metric report start date (UTC). Format: YYYY-MM-DD. Cannot be more than 90 days back from today. | 
  **end_date** | **chrono::naive::NaiveDate**| Metric report end date (UTC). Format: YYYY-MM-DD. Cannot be more than 90 days past start_date. | 
  **sort_by** | [****](.md)| Specify sorting order for video metrics | 
 **optional** | **map[string]interface{}** | optional parameters | nil if no parameters
 ...
 **content_type** | [****](.md)| Filter to paid or organic data. Default is all. | 
 **source** | [****](.md)| Filter to activity from Pins created and saved by your, or activity created and saved by others from your claimed accounts | 
 **metric_types** | [**models::QueryvideopinmetrictypesItems**](models::QueryvideopinmetrictypesItems.md)| Metric types to get video data for, default is all. | 
 **num_of_pins** | **u8**| Number of pins to include, default is 10. Max is 50. | [default to 10]
 **created_in_last_n_days** | [****](.md)| Get metrics for pins created in the last \"n\" days. | 
 **ad_account_id** | **String**| Unique identifier of an ad account. | 
...
# **user_account/get**
> models::Account user_account/get(ctx, ctx, optional)
Get user account
...
# **user_following/get**
> models::FollowersList200Response user_following/get(ctx, ctx, optional)
List following
 ...
 **ad_account_id** | **String**| Unique identifier of an ad account. | 
 **explicit_following** | **bool**| Whether or not to include implicit user follows, which means followees with board follows. When explicit_following is True, it means we only want explicit user follows. | [default to false]
 **feed_type** | [****](.md)| Thrift param specifying what type of followees will be kept. Default to include all followees. | 
 **bookmark** | **String**| Cursor used to fetch the next page of items | 
 **page_size** | **u8**| Maximum number of items to include in a single page. See documentation on [Pagination](/docs/reference/pagination/) for more information. | [default to 25]
...
> models::UserWebsite verify_website/update(ctx, user_website_create, optional)
Verify website
...
> models::UserWebsiteVerification website_verification/get(ctx, ctx, optional)
...
# **follow_user/update**
> models::FollowUser follow_user/update(ctx, username, follow_user_create)
Follow user
...
> models::UserAccountFollowedInterests200Response user_account/followed_interests(ctx, ctx, username, optional)
