...
**error_counts** | [**swagger::Nullable<Vec<models::ErrorDetail>>**](ErrorDetail.md) | Error counts by error code | [optional] [default to None]
**id** | **String** | Customer List Upload ID. | 
**operation** | [***models::UserListOperationType**](UserListOperationType.md) |  | 
**record_counts** | [***models::RecordCounts**](RecordCounts.md) | Record processing counts | [optional] [default to None]
