...
**ad_groups/audience_sizing**](ad_groups_api.md#ad_groups/audience_sizing) | **GET** /ad_accounts/{ad_account_id}/ad_groups/audience_sizing | Get audience sizing
...
> models::BidFloor ad_groups_bid_floor/get(ctx, ad_account_id, bid_floor_request)
Get bid floors
...
# **ad_groups/analytics**
> Vec<models::AdGroupsAnalyticsResponseInner> ad_groups/analytics(ctx, ad_account_id, start_date, end_date, ad_group_ids, columns, granularity, optional)
...
> models::AdGroupAudienceSizingResponse ad_groups/audience_sizing(ctx, ad_account_id, optional)
Get audience sizing
...
# **ad_groups/create**
> models::AdGroupArrayResponse ad_groups/create(ctx, ad_account_id, ad_group_create_request)
Create ad groups
...
# **ad_groups/get**
> models::AdGroupResponse ad_groups/get(ctx, ad_account_id, ad_group_id)
Get ad group
...
# **ad_groups/list**
> models::AdGroupsList200Response ad_groups/list(ctx, ad_account_id, optional)
List ad groups
...
# **ad_groups/update**
> models::AdGroupArrayResponse ad_groups/update(ctx, ad_account_id, ad_group_update_request)
Update ad groups
...
> models::MetricsResponse ad_groups_targeting_analytics/get(ctx, ad_account_id, ad_group_ids, start_date, end_date, targeting_types, columns, granularity, optional)
