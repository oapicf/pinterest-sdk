...
> models::CustomerList customer_lists/create(ctx, ad_account_id, customer_list_request)
...
# **customer_lists/get**
> models::CustomerList customer_lists/get(ctx, ad_account_id, customer_list_id)
Get customer list
...
> models::CustomerList customer_lists/update(ctx, ad_account_id, customer_list_id, customer_list_update_request)
