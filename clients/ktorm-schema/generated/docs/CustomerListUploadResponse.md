...
# Table `CustomerListUploadResponse`
(mapped from: CustomerListUploadResponse)
...
# **Table `CustomerListUploadResponseErrorDetail`**
(mapped from: CustomerListUploadResponseErrorDetail)

## Properties
Name | Mapping | SQL Type | Default | Type | Description | Notes
---- | ------- | -------- | ------- | ---- | ----------- | -----
customerListUploadResponse | customerListUploadResponse | long | | kotlin.Long | Primary Key | *one*
