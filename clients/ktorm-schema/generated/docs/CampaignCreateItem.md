...
# Table `CampaignCreateItem`
(mapped from: CampaignCreateItem)

## Properties
Name | Mapping | SQL Type | Default | Type | Description | Notes
---- | ------- | -------- | ------- | ---- | ----------- | -----
**name** | name | text NOT NULL |  | **kotlin.String** | Campaign name - 255 chars max. | 
**objectiveType** | objective_type | long NOT NULL |  | [**ConversionObjectiveType**](ConversionObjectiveType.md) |  |  [foreignkey]
