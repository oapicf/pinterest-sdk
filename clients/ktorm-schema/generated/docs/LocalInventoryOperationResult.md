...
# Table `LocalInventoryOperationResult`
(mapped from: LocalInventoryOperationResult)
...
# **Table `LocalInventoryOperationResultSupplementalItemValidationEvent`**
(mapped from: LocalInventoryOperationResultSupplementalItemValidationEvent)

## Properties
Name | Mapping | SQL Type | Default | Type | Description | Notes
---- | ------- | -------- | ------- | ---- | ----------- | -----
localInventoryOperationResult | localInventoryOperationResult | long | | kotlin.Long | Primary Key | *one*
