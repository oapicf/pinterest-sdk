...
# **Table `AdvancedAuctionItemsSubmitUpsertRecordAdvancedAuctionOperationError`**
(mapped from: AdvancedAuctionItemsSubmitUpsertRecordAdvancedAuctionOperationError)
