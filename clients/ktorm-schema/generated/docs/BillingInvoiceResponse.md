...
# Table `BillingInvoiceResponse`
(mapped from: BillingInvoiceResponse)
...
**documentType** | document_type | text |  | [**document_type**](#DocumentType) | The type of the document |  [optional]
...
**status** | status | text |  | [**status**](#Status) | The status of the invoice |  [optional]
