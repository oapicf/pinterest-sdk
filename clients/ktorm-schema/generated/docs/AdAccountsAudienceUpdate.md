...
# Table `AdAccountsAudienceUpdate`
(mapped from: AdAccountsAudienceUpdate)
...
**operationType** | operation_type | long |  | [**AudienceUpdateOperationType**](AudienceUpdateOperationType.md) | Audience operation type (update or remove). Only valid in update request body. |  [optional] [foreignkey]
