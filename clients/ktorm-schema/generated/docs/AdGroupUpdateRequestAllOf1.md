...
# Table `AdGroupUpdateRequestAllOf1`
(mapped from: AdGroupUpdateRequestAllOf1)
...
# **Table `AdGroupUpdateRequestAllOf1TargetingSpecOperations`**
(mapped from: AdGroupUpdateRequestAllOf1TargetingSpecOperations)

## Properties
Name | Mapping | SQL Type | Default | Type | Description | Notes
---- | ------- | -------- | ------- | ---- | ----------- | -----
adGroupUpdateRequestAllOf1 | adGroupUpdateRequestAllOf1 | long | | kotlin.Long | Primary Key | *one*
