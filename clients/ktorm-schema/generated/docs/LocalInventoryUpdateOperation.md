...
# Table `LocalInventoryUpdateOperation`
(mapped from: LocalInventoryUpdateOperation)

## Properties
Name | Mapping | SQL Type | Default | Type | Description | Notes
---- | ------- | -------- | ------- | ---- | ----------- | -----
**attributes** | attributes | long NOT NULL |  | [**RetailLocalInventoryItemAttributesOptional**](RetailLocalInventoryItemAttributesOptional.md) |  |  [foreignkey]
