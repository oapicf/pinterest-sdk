...
# **Table `AdGroupCreatePromotionIds`**
(mapped from: AdGroupCreatePromotionIds)

## Properties
Name | Mapping | SQL Type | Default | Type | Description | Notes
---- | ------- | -------- | ------- | ---- | ----------- | -----
adGroupCreate | adGroupCreate | long | | kotlin.Long | Primary Key | *one*
...
# **Table `AdGroupCreateTargetingTemplateIds`**
(mapped from: AdGroupCreateTargetingTemplateIds)
