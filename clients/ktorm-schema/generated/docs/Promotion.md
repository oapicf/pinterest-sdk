...
# Table `Promotion`
(mapped from: Promotion)

## Properties
Name | Mapping | SQL Type | Default | Type | Description | Notes
---- | ------- | -------- | ------- | ---- | ----------- | -----
**adAccountId** | ad_account_id | text NOT NULL |  | **kotlin.String** | The Ad Account ID that this promotion belongs to. |  [readonly]
**id** | id | text NOT NULL PRIMARY KEY |  | **kotlin.String** | Promotion ID | 
...
# **Table `PromotionPromotionTemplateValue`**
(mapped from: PromotionPromotionTemplateValue)

## Properties
Name | Mapping | SQL Type | Default | Type | Description | Notes
---- | ------- | -------- | ------- | ---- | ----------- | -----
promotion | promotion | long | | kotlin.Long | Primary Key | *one*
