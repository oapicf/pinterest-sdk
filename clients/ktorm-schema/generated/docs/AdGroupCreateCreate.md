...
# Table `AdGroupCreateCreate`
(mapped from: AdGroupCreateCreate)
...
# **Table `AdGroupCreateCreatePromotionIds`**
(mapped from: AdGroupCreateCreatePromotionIds)

## Properties
Name | Mapping | SQL Type | Default | Type | Description | Notes
---- | ------- | -------- | ------- | ---- | ----------- | -----
adGroupCreateCreate | adGroupCreateCreate | long | | kotlin.Long | Primary Key | *one*
...
# **Table `AdGroupCreateCreateTargetingTemplateIds`**
(mapped from: AdGroupCreateCreateTargetingTemplateIds)
