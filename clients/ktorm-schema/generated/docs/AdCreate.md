...
# **Table `AdCreateCarouselAndroidDeepLinks`**
(mapped from: AdCreateCarouselAndroidDeepLinks)

## Properties
Name | Mapping | SQL Type | Default | Type | Description | Notes
---- | ------- | -------- | ------- | ---- | ----------- | -----
adCreate | adCreate | long | | kotlin.Long | Primary Key | *one*
carouselAndroidDeepLinks | carouselAndroidDeepLinks | text | | kotlin.String | Foreign Key | *many*



# **Table `AdCreateCarouselDestinationUrls`**
(mapped from: AdCreateCarouselDestinationUrls)
...
# **Table `AdCreateCarouselIosDeepLinks`**
(mapped from: AdCreateCarouselIosDeepLinks)
