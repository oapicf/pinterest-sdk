...
# Table `AdAccountsAudienceRule`
(mapped from: AdAccountsAudienceRule)
...
**eventData** | event_data | long |  | [**EventData**](EventData.md) |  |  [optional] [foreignkey]
...
**objectiveType** | `One-To-Many` | `----` | `----`  | [**kotlin.Array&lt;AudienceObjectiveType&gt;**](AudienceObjectiveType.md) | Objective for engagement audience filter. |  [optional]
...
# **Table `AdAccountsAudienceRuleAdId`**
(mapped from: AdAccountsAudienceRuleAdId)

## Properties
Name | Mapping | SQL Type | Default | Type | Description | Notes
---- | ------- | -------- | ------- | ---- | ----------- | -----
adAccountsAudienceRule | adAccountsAudienceRule | long | | kotlin.Long | Primary Key | *one*
adId | adId | text | | kotlin.String | Foreign Key | *many*



# **Table `AdAccountsAudienceRuleCampaignId`**
(mapped from: AdAccountsAudienceRuleCampaignId)
...
# **Table `AdAccountsAudienceRuleEngagementDomain`**
(mapped from: AdAccountsAudienceRuleEngagementDomain)
...
# **Table `AdAccountsAudienceRuleAudienceObjectiveType`**
(mapped from: AdAccountsAudienceRuleAudienceObjectiveType)

## Properties
Name | Mapping | SQL Type | Default | Type | Description | Notes
---- | ------- | -------- | ------- | ---- | ----------- | -----
adAccountsAudienceRule | adAccountsAudienceRule | long | | kotlin.Long | Primary Key | *one*
audienceObjectiveType | audienceObjectiveType | long | | kotlin.Long | Foreign Key | *many*




# **Table `AdAccountsAudienceRulePinId`**
(mapped from: AdAccountsAudienceRulePinId)
...
# **Table `AdAccountsAudienceRuleSeedId`**
(mapped from: AdAccountsAudienceRuleSeedId)
...
# **Table `AdAccountsAudienceRuleUrl`**
(mapped from: AdAccountsAudienceRuleUrl)
