...
# Table `AdGroupCreateRequest`
(mapped from: AdGroupCreateRequest)
...
# **Table `AdGroupCreateRequestPromotionIds`**
(mapped from: AdGroupCreateRequestPromotionIds)

## Properties
Name | Mapping | SQL Type | Default | Type | Description | Notes
---- | ------- | -------- | ------- | ---- | ----------- | -----
adGroupCreateRequest | adGroupCreateRequest | long | | kotlin.Long | Primary Key | *one*
...
# **Table `AdGroupCreateRequestTargetingTemplateIds`**
(mapped from: AdGroupCreateRequestTargetingTemplateIds)
