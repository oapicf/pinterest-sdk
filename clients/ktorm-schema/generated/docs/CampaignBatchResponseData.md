...
# Table `CampaignBatchResponseData`
(mapped from: CampaignBatchResponseData)

## Properties
Name | Mapping | SQL Type | Default | Type | Description | Notes
---- | ------- | -------- | ------- | ---- | ----------- | -----
**adAccountId** | ad_account_id | text |  | **kotlin.String** | Campaign&#39;s Advertiser ID. |  [optional]
**bidOptions** | bid_options | long |  | [**CampaignBidOptions**](CampaignBidOptions.md) | [Restricted](/docs/getting-started/using-beta-and-restricted-features/)  Object describing the campaign level bid multipliers. |  [optional] [foreignkey]
**createdTime** | created_time | int |  | **kotlin.Int** | Campaign creation time. Unix timestamp in seconds. |  [optional] [readonly]
...
**isCarting** | is_carting | boolean |  | **kotlin.Boolean** | Whether the campaign contains a carting(where-to-buy link) ad. |  [optional] [readonly]
...
**objectiveType** | objective_type | long |  | [**CampaignObjectiveType**](CampaignObjectiveType.md) |  |  [optional] [foreignkey]
...
**status** | status | long |  | [**NullableEntityStatus**](NullableEntityStatus.md) |  |  [optional] [foreignkey]
**summaryStatus** | summary_status | long |  | [**SummaryStatus**](SummaryStatus.md) |  |  [optional] [readonly] [foreignkey]
**trackingUrls** | tracking_urls | long |  | [**TrackingUrls**](TrackingUrls.md) |  |  [optional] [foreignkey]
**type** | type | text |  | **kotlin.String** | Always \&quot;campaign\&quot;. |  [optional] [readonly]
**updatedTime** | updated_time | int |  | **kotlin.Int** | UTC timestamp. Last update time. |  [optional] [readonly]
