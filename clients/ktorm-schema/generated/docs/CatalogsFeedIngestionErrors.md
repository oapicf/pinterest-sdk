...
**FETCH_GOOGLE_SHEET_NOT_SHARED** | FETCH_GOOGLE_SHEET_NOT_SHARED | int |  | **kotlin.Int** | Update your Google Sheets sharing settings to &#39;Anyone with link&#39; as a Viewer so that Pinterest can access your file. |  [optional]
...
**LARGE_PRODUCT_COUNT_DECREASE** | LARGE_PRODUCT_COUNT_DECREASE | int |  | **kotlin.Int** | The product count has decreased by more than 99% compared to the last successful ingestion. |  [optional]
