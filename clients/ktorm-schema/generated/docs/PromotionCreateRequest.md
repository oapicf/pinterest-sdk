...
# Table `PromotionCreateRequest`
(mapped from: PromotionCreateRequest)
...
# **Table `PromotionCreateRequestPromotionTemplateValue`**
(mapped from: PromotionCreateRequestPromotionTemplateValue)

## Properties
Name | Mapping | SQL Type | Default | Type | Description | Notes
---- | ------- | -------- | ------- | ---- | ----------- | -----
promotionCreateRequest | promotionCreateRequest | long | | kotlin.Long | Primary Key | *one*
