...
**creativeType** | creative_type | long NOT NULL |  | [**AdShoppingPreviewCreativeType**](AdShoppingPreviewCreativeType.md) | Ad format of the shopping ad preview. |  [foreignkey]
...
**promotionId** | promotion_id | text |  | **kotlin.String** | Promotion id for the ad to preview, optional and only applicable when creating ad preview for an existing promotion. |  [optional]
...
**preferredMediaType** | preferred_media_type | long |  | [**BasePreferredMediaType**](BasePreferredMediaType.md) | Preferred media type. |  [optional] [foreignkey]
**showPromotion** | show_promotion | boolean |  | **kotlin.Boolean** | Include promotion data in preview when available on catalog item. Defaults to false. |  [optional]
