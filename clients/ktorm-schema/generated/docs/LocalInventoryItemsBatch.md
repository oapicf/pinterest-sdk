...
# Table `LocalInventoryItemsBatch`
(mapped from: LocalInventoryItemsBatch)
...
# **Table `LocalInventoryItemsBatchSupplementalOperationResult`**
(mapped from: LocalInventoryItemsBatchSupplementalOperationResult)

## Properties
Name | Mapping | SQL Type | Default | Type | Description | Notes
---- | ------- | -------- | ------- | ---- | ----------- | -----
localInventoryItemsBatch | localInventoryItemsBatch | long | | kotlin.Long | Primary Key | *one*
