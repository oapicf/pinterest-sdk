...
# **Table `AdGroupUpdatePromotionIds`**
(mapped from: AdGroupUpdatePromotionIds)

## Properties
Name | Mapping | SQL Type | Default | Type | Description | Notes
---- | ------- | -------- | ------- | ---- | ----------- | -----
adGroupUpdate | adGroupUpdate | long | | kotlin.Long | Primary Key | *one*
...
# **Table `AdGroupUpdateTargetingTemplateIds`**
(mapped from: AdGroupUpdateTargetingTemplateIds)
