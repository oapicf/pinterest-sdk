...
# Table `PromotionBatchUpdate`
(mapped from: PromotionBatchUpdate)
...
# **Table `PromotionBatchUpdatePromotionTemplateValue`**
(mapped from: PromotionBatchUpdatePromotionTemplateValue)

## Properties
Name | Mapping | SQL Type | Default | Type | Description | Notes
---- | ------- | -------- | ------- | ---- | ----------- | -----
promotionBatchUpdate | promotionBatchUpdate | long | | kotlin.Long | Primary Key | *one*
