...
# Table `PromotionCommon`
(mapped from: PromotionCommon)
...
# **Table `PromotionCommonPromotionTemplateValue`**
(mapped from: PromotionCommonPromotionTemplateValue)

## Properties
Name | Mapping | SQL Type | Default | Type | Description | Notes
---- | ------- | -------- | ------- | ---- | ----------- | -----
promotionCommon | promotionCommon | long | | kotlin.Long | Primary Key | *one*
