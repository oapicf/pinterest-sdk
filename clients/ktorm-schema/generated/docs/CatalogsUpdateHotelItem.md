...
# Table `CatalogsUpdateHotelItem`
(mapped from: CatalogsUpdateHotelItem)
...
**hotelId** | hotel_id | text NOT NULL |  | **kotlin.String** | The catalog hotel item id in the merchant namespace | 
