...
# **Table `AdGroupBasePromotionIds`**
(mapped from: AdGroupBasePromotionIds)

## Properties
Name | Mapping | SQL Type | Default | Type | Description | Notes
---- | ------- | -------- | ------- | ---- | ----------- | -----
adGroupBase | adGroupBase | long | | kotlin.Long | Primary Key | *one*
...
# **Table `AdGroupBaseTargetingTemplateIds`**
(mapped from: AdGroupBaseTargetingTemplateIds)
