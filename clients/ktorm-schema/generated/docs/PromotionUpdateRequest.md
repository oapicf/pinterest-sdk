...
# Table `PromotionUpdateRequest`
(mapped from: PromotionUpdateRequest)
...
# **Table `PromotionUpdateRequestPromotionTemplateValue`**
(mapped from: PromotionUpdateRequestPromotionTemplateValue)

## Properties
Name | Mapping | SQL Type | Default | Type | Description | Notes
---- | ------- | -------- | ------- | ---- | ----------- | -----
promotionUpdateRequest | promotionUpdateRequest | long | | kotlin.Long | Primary Key | *one*
