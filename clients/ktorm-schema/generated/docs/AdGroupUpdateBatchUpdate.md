...
# Table `AdGroupUpdateBatchUpdate`
(mapped from: AdGroupUpdateBatchUpdate)
...
**targetingSpecOperations** | `One-To-Many` | `----` | `----`  | [**kotlin.Array&lt;TargetingSpecOperations&gt;**](TargetingSpecOperations.md) |  |  [optional]
...
# **Table `AdGroupUpdateBatchUpdatePromotionIds`**
(mapped from: AdGroupUpdateBatchUpdatePromotionIds)

## Properties
Name | Mapping | SQL Type | Default | Type | Description | Notes
---- | ------- | -------- | ------- | ---- | ----------- | -----
adGroupUpdateBatchUpdate | adGroupUpdateBatchUpdate | long | | kotlin.Long | Primary Key | *one*
...
# **Table `AdGroupUpdateBatchUpdateTargetingSpecOperations`**
(mapped from: AdGroupUpdateBatchUpdateTargetingSpecOperations)
...
# **Table `AdGroupUpdateBatchUpdateTargetingTemplateIds`**
(mapped from: AdGroupUpdateBatchUpdateTargetingTemplateIds)
