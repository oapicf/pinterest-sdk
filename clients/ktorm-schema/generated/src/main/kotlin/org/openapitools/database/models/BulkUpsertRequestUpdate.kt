...
object BulkUpsertRequestUpdates : BaseTable<BulkUpsertRequestUpdate>("BulkUpsertRequestUpdate") {
    ...
    override fun doCreateEntity(row: QueryRowSet, withReferences: Boolean) = BulkUpsertRequestUpdate(
        ...
        catalogProductGroups = emptyList() /* kotlin.Array<CatalogsProductGroupsUpdateRequest>? */,
...
object BulkUpsertRequestUpdateCatalogsProductGroupsUpdateRequest : BaseTable<Pair<kotlin.Long, kotlin.Long>>("BulkUpsertRequestUpdateCatalogsProductGroupsUpdateRequest") {
    val bulkUpsertRequestUpdate = long("bulkUpsertRequestUpdate")
    val catalogsProductGroupsUpdateRequest = long("catalogsProductGroupsUpdateRequest")

    override fun doCreateEntity(row: QueryRowSet, withReferences: Boolean): Pair<kotlin.Long, kotlin.Long> =
        Pair(row[bulkUpsertRequestUpdate] ?: 0, row[catalogsProductGroupsUpdateRequest] ?: 0)

    fun AssignmentsBuilder.assignFrom(entity: Pair<kotlin.Long, kotlin.Long>) {
        this.apply {
            set(BulkUpsertRequestUpdateCatalogsProductGroupsUpdateRequest.bulkUpsertRequestUpdate, entity.first)
            set(BulkUpsertRequestUpdateCatalogsProductGroupsUpdateRequest.catalogsProductGroupsUpdateRequest, entity.second)
        }
    }
