...
object AdsAnalyticsCreateAsyncRequests : BaseTable<AdsAnalyticsCreateAsyncRequest>("AdsAnalyticsCreateAsyncRequest") {
    ...
    val combineTargetingTypes = boolean("combine_targeting_types") /* null */ /* Determines if the targeting types included in the request should be consolidated into a single breakdown. For example, when combine_targeting_types is set to true, if GENDER and COUNTRY are targeting types in the request, the response will have a targeting type of GENDER_AND_COUNTRY and targeting values such as female&US. This feature is currently in BETA and is not available to all users. */
    ...
    val reportingTimezone = long("reporting_timezone") /* null */ /* Specify the timezone to be applied for the reporting. This feature is currently in BETA and is not available to all users. */
    ...
    override fun doCreateEntity(row: QueryRowSet, withReferences: Boolean) = AdsAnalyticsCreateAsyncRequest(
        ...
        combineTargetingTypes = row[combineTargetingTypes] ?: false /* kotlin.Boolean? */ /* Determines if the targeting types included in the request should be consolidated into a single breakdown. For example, when combine_targeting_types is set to true, if GENDER and COUNTRY are targeting types in the request, the response will have a targeting type of GENDER_AND_COUNTRY and targeting values such as female&US. This feature is currently in BETA and is not available to all users. */,
        customConversionEventMetrics = emptyList() /* kotlin.Array<AdsAnalyticsCreateAsyncRequestAllOfCustomConversionEventMetrics>? */ /* List of advertiser-defined custom conversion event metrics to include in the report */,
        ...
        reportingTimezone = ReportingTimeZones.createEntity(row, withReferences) /* ReportingTimeZone? */ /* Specify the timezone to be applied for the reporting. This feature is currently in BETA and is not available to all users. */,
...
object AdsAnalyticsCreateAsyncRequestTargetingTypes : BaseTable<Pair<kotlin.Long, kotlin.String>>("AdsAnalyticsCreateAsyncRequestTargetingTypes") {
    val adsAnalyticsCreateAsyncRequest = long("adsAnalyticsCreateAsyncRequest")
    val targetingTypes = text("targetingTypes")

    override fun doCreateEntity(row: QueryRowSet, withReferences: Boolean): Pair<kotlin.Long, kotlin.String> =
        Pair(row[adsAnalyticsCreateAsyncRequest] ?: 0, row[targetingTypes] ?: "")

    fun AssignmentsBuilder.assignFrom(entity: Pair<kotlin.Long, kotlin.String>) {
        this.apply {
            set(AdsAnalyticsCreateAsyncRequestTargetingTypes.adsAnalyticsCreateAsyncRequest, entity.first)
            set(AdsAnalyticsCreateAsyncRequestTargetingTypes.targetingTypes, entity.second)
        }
    }
...
object AdsAnalyticsCreateAsyncRequestAdsAnalyticsCreateAsyncRequestAllOfCustomConversionEventMetrics : BaseTable<Pair<kotlin.Long, kotlin.Long>>("AdsAnalyticsCreateAsyncRequestAdsAnalyticsCreateAsyncRequestAllOfCustomConversionEventMetrics") {
    val adsAnalyticsCreateAsyncRequest = long("adsAnalyticsCreateAsyncRequest")
    val adsAnalyticsCreateAsyncRequestAllOfCustomConversionEventMetrics = long("adsAnalyticsCreateAsyncRequestAllOfCustomConversionEventMetrics")

    override fun doCreateEntity(row: QueryRowSet, withReferences: Boolean): Pair<kotlin.Long, kotlin.Long> =
        Pair(row[adsAnalyticsCreateAsyncRequest] ?: 0, row[adsAnalyticsCreateAsyncRequestAllOfCustomConversionEventMetrics] ?: 0)

    fun AssignmentsBuilder.assignFrom(entity: Pair<kotlin.Long, kotlin.Long>) {
        this.apply {
            set(AdsAnalyticsCreateAsyncRequestAdsAnalyticsCreateAsyncRequestAllOfCustomConversionEventMetrics.adsAnalyticsCreateAsyncRequest, entity.first)
            set(AdsAnalyticsCreateAsyncRequestAdsAnalyticsCreateAsyncRequestAllOfCustomConversionEventMetrics.adsAnalyticsCreateAsyncRequestAllOfCustomConversionEventMetrics, entity.second)
        }
    }
