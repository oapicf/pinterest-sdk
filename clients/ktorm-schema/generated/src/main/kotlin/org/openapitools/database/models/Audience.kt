...
object Audiences : BaseTable<Audience>("Audience") {
    ...
    override fun doCreateEntity(row: QueryRowSet, withReferences: Boolean) = Audience(
        ...
        audienceType = PinnerListTypes.createEntity(row, withReferences) /* PinnerListType? */ /* [Audience types](/docs/reference/glossary/#Audience Types): ACTALIKE, ENGAGEMENT, CUSTOMER_LIST and VISITOR */,
    ...
    */
    fun AssignmentsBuilder.assignFrom(entity: Audience) {
        this.apply {
            ...
            set(Audiences.isNca, entity.isNca)
