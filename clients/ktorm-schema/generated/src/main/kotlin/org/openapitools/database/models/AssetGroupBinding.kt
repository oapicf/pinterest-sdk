...
object AssetGroupBindings : BaseTable<AssetGroupBinding>("AssetGroupBinding") {
    ...
    val createdBy = long("created_by") /* The data of the user that created the asset group. */
    val createdTime = int("created_time") /* The creation time of the asset group */
    val id = text("id") /* Asset Group ID. */
    val owner = long("owner") /* The data of the business that owns the asset group. */
    val updatedTime = int("updated_time") /* The last update time of the asset group */
    ...
    override fun doCreateEntity(row: QueryRowSet, withReferences: Boolean) = AssetGroupBinding(
        ...
        createdTime = row[createdTime] ?: 0 /* kotlin.Int */ /* The creation time of the asset group */,
        ...
        updatedTime = row[updatedTime] ?: 0 /* kotlin.Int */ /* The last update time of the asset group */
    )
