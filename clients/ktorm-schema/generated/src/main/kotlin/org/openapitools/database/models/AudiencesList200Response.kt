...
object AudiencesList200Responses : BaseTable<AudiencesList200Response>("audiences_list_200_response") {
    ...
    override fun doCreateEntity(row: QueryRowSet, withReferences: Boolean) = AudiencesList200Response(
        items = emptyList() /* kotlin.Array<AdAccountsAudience> */,
...
object AudiencesList200ResponseAdAccountsAudience : BaseTable<Pair<kotlin.Long, kotlin.Long>>("AudiencesList200ResponseAdAccountsAudience") {
    val audiencesList200Response = long("audiencesList200Response")
    val adAccountsAudience = long("adAccountsAudience")

    override fun doCreateEntity(row: QueryRowSet, withReferences: Boolean): Pair<kotlin.Long, kotlin.Long> =
        Pair(row[audiencesList200Response] ?: 0, row[adAccountsAudience] ?: 0)

    fun AssignmentsBuilder.assignFrom(entity: Pair<kotlin.Long, kotlin.Long>) {
        this.apply {
            set(AudiencesList200ResponseAdAccountsAudience.audiencesList200Response, entity.first)
            set(AudiencesList200ResponseAdAccountsAudience.adAccountsAudience, entity.second)
        }
    }
