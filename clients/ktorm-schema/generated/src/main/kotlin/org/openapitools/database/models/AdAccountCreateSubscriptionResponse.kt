...
object AdAccountCreateSubscriptionResponses : BaseTable<AdAccountCreateSubscriptionResponse>("AdAccountCreateSubscriptionResponse") {
    ...
    */
    fun AssignmentsBuilder.assignFrom(entity: AdAccountCreateSubscriptionResponse) {
        this.apply {
            set(AdAccountCreateSubscriptionResponses.adAccountId, entity.adAccountId)
            set(AdAccountCreateSubscriptionResponses.apiVersion, entity.apiVersion)
            ...
            set(AdAccountCreateSubscriptionResponses.leadFormId, entity.leadFormId)
            set(AdAccountCreateSubscriptionResponses.userAccountId, entity.userAccountId)
            set(AdAccountCreateSubscriptionResponses.webhookUrl, entity.webhookUrl)
        }
    }
