...
object TemplatesList200Responses : BaseTable<TemplatesList200Response>("templates_list_200_response") {
    ...
    override fun doCreateEntity(row: QueryRowSet, withReferences: Boolean) = TemplatesList200Response(
        items = emptyList() /* kotlin.Array<AccountTemplate> */,
...
object TemplatesList200ResponseAccountTemplate : BaseTable<Pair<kotlin.Long, kotlin.Long>>("TemplatesList200ResponseAccountTemplate") {
    val templatesList200Response = long("templatesList200Response")
    val accountTemplate = long("accountTemplate")

    override fun doCreateEntity(row: QueryRowSet, withReferences: Boolean): Pair<kotlin.Long, kotlin.Long> =
        Pair(row[templatesList200Response] ?: 0, row[accountTemplate] ?: 0)

    fun AssignmentsBuilder.assignFrom(entity: Pair<kotlin.Long, kotlin.Long>) {
        this.apply {
            set(TemplatesList200ResponseAccountTemplate.templatesList200Response, entity.first)
            set(TemplatesList200ResponseAccountTemplate.accountTemplate, entity.second)
        }
    }
