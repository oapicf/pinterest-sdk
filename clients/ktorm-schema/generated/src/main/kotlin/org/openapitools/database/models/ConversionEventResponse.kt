...
object ConversionEventResponses : BaseTable<ConversionEventResponse>("ConversionEventResponse") {
    ...
    val reportingConversionEvent = text("reporting_conversion_event") /* null */ /* For advertiser-defined events, the reporting event label shown in optimization UIs. */
    ...
    override fun doCreateEntity(row: QueryRowSet, withReferences: Boolean) = ConversionEventResponse(
        ...
        reportingConversionEvent = row[reportingConversionEvent]  /* kotlin.String? */ /* For advertiser-defined events, the reporting event label shown in optimization UIs. */
    )
    ...
    */
    fun AssignmentsBuilder.assignFrom(entity: ConversionEventResponse) {
        this.apply {
            ...
            set(ConversionEventResponses.reportingConversionEvent, entity.reportingConversionEvent)
        }
    }
