...
object CatalogsFeedProcessingSchedules : BaseTable<CatalogsFeedProcessingSchedule>("CatalogsFeedProcessingSchedule") {
    ...
    val timezone = long("timezone") /* The timezone considered for the processing schedule time. */
    ...
    override fun doCreateEntity(row: QueryRowSet, withReferences: Boolean) = CatalogsFeedProcessingSchedule(
        ...
        timezone = CatalogsFeedProcessingScheduleTimezones.createEntity(row, withReferences) /* CatalogsFeedProcessingScheduleTimezone */ /* The timezone considered for the processing schedule time. */
    )
