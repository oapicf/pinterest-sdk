...
object CatalogsHotelItemsBatchs : BaseTable<CatalogsHotelItemsBatch>("CatalogsHotelItemsBatch") {
    val catalogType = text("catalog_type").transform({ CatalogsHotelItemsBatch.CatalogType.valueOf(it) }, { it.value })
    ...
    override fun doCreateEntity(row: QueryRowSet, withReferences: Boolean) = CatalogsHotelItemsBatch(
        catalogType = row[catalogType] ?: CatalogsHotelItemsBatch.CatalogType.valueOf("") /* kotlin.String */,
