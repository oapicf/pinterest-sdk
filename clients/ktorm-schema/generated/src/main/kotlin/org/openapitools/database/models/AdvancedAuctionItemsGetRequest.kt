...
object AdvancedAuctionItemsGetRequests : BaseTable<AdvancedAuctionItemsGetRequest>("AdvancedAuctionItemsGetRequest") {
    ...
    override fun doCreateEntity(row: QueryRowSet, withReferences: Boolean) = AdvancedAuctionItemsGetRequest(
        ...
        items = emptyList() /* kotlin.Array<AdvancedAuctionKey> */ /* A list of retail catalog items to fetch bid options for */
    )
...
object AdvancedAuctionItemsGetRequestAdvancedAuctionKey : BaseTable<Pair<kotlin.Long, kotlin.Long>>("AdvancedAuctionItemsGetRequestAdvancedAuctionKey") {
    val advancedAuctionItemsGetRequest = long("advancedAuctionItemsGetRequest")
    val advancedAuctionKey = long("advancedAuctionKey")

    override fun doCreateEntity(row: QueryRowSet, withReferences: Boolean): Pair<kotlin.Long, kotlin.Long> =
        Pair(row[advancedAuctionItemsGetRequest] ?: 0, row[advancedAuctionKey] ?: 0)

    fun AssignmentsBuilder.assignFrom(entity: Pair<kotlin.Long, kotlin.Long>) {
        this.apply {
            set(AdvancedAuctionItemsGetRequestAdvancedAuctionKey.advancedAuctionItemsGetRequest, entity.first)
            set(AdvancedAuctionItemsGetRequestAdvancedAuctionKey.advancedAuctionKey, entity.second)
        }
    }
