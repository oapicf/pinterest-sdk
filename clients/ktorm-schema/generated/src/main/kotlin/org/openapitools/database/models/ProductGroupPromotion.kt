...
object ProductGroupPromotions : BaseTable<ProductGroupPromotion>("ProductGroupPromotion") {
    ...
    val catalogProductGroupId = text("catalog_product_group_id") /* null */ /* ID of the catalogs product group that this product group promotion references (required for create operations) */
    ...
    val id = text("id") /* null */ /* ID of the product group promotion (required for update operations). */
    ...
    val isImageAutoResizing = boolean("is_image_auto_resizing") /* null */ /* Set to `TRUE` to automatically resize your product images with generative AI. This ensures that images have optimal appearance for better performance. */
    ...
    val preferredMediaType = long("preferred_media_type") /* null */
    ...
    override fun doCreateEntity(row: QueryRowSet, withReferences: Boolean) = ProductGroupPromotion(
        ...
        catalogProductGroupId = row[catalogProductGroupId]  /* kotlin.String? */ /* ID of the catalogs product group that this product group promotion references (required for create operations) */,
        catalogProductGroupName = row[catalogProductGroupName]  /* kotlin.String? */ /* Catalogs product group name */,
        collectionsHeaderType = CollectionsHeaderTypes.createEntity(row, withReferences) /* CollectionsHeaderType? */,
        ...
        customizableCtaType = ProductGroupPromotionCustomizableCTATypes.createEntity(row, withReferences) /* ProductGroupPromotionCustomizableCTAType? */,
        ...
        id = row[id]  /* kotlin.String? */ /* ID of the product group promotion (required for update operations). */,
        ...
        isImageAutoResizing = row[isImageAutoResizing]  /* kotlin.Boolean? */ /* Set to `TRUE` to automatically resize your product images with generative AI. This ensures that images have optimal appearance for better performance. */,
        ...
        preferredMediaType = PreferredMediaTypes.createEntity(row, withReferences) /* PreferredMediaType? */,
    ...
    */
    fun AssignmentsBuilder.assignFrom(entity: ProductGroupPromotion) {
        this.apply {
            ...
            set(ProductGroupPromotions.isImageAutoResizing, entity.isImageAutoResizing)
