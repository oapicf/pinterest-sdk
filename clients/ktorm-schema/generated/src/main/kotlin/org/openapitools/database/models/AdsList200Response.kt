...
object AdsList200Responses : BaseTable<AdsList200Response>("ads_list_200_response") {
    ...
    override fun doCreateEntity(row: QueryRowSet, withReferences: Boolean) = AdsList200Response(
        items = emptyList() /* kotlin.Array<Ad> */,
...
object AdsList200ResponseAd : BaseTable<Pair<kotlin.Long, kotlin.Long>>("AdsList200ResponseAd") {
    val adsList200Response = long("adsList200Response")
    val ad = long("ad")

    override fun doCreateEntity(row: QueryRowSet, withReferences: Boolean): Pair<kotlin.Long, kotlin.Long> =
        Pair(row[adsList200Response] ?: 0, row[ad] ?: 0)

    fun AssignmentsBuilder.assignFrom(entity: Pair<kotlin.Long, kotlin.Long>) {
        this.apply {
            set(AdsList200ResponseAd.adsList200Response, entity.first)
            set(AdsList200ResponseAd.ad, entity.second)
        }
    }
