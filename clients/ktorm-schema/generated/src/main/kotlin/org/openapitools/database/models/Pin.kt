...
object Pins : BaseTable<Pin>("Pin") {
    ...
    val isStandard = boolean("is_standard") /* null */ /* Whether the Pin is standard or not. See documentation on <a href=\"/docs/api-features/content-overview/\">Changes to Pin creation</a> for more information. */
    ...
    override fun doCreateEntity(row: QueryRowSet, withReferences: Boolean) = Pin(
        ...
        isStandard = row[isStandard]  /* kotlin.Boolean? */ /* Whether the Pin is standard or not. See documentation on <a href=\"/docs/api-features/content-overview/\">Changes to Pin creation</a> for more information. */,
