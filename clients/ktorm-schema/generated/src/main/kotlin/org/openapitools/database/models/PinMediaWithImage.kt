...
object PinMediaWithImages : BaseTable<PinMediaWithImage>("PinMediaWithImage") {
    val mediaType = text("media_type").transform({ PinMediaWithImage.MediaType.valueOf(it) }, { it.value })
    ...
    override fun doCreateEntity(row: QueryRowSet, withReferences: Boolean) = PinMediaWithImage(
        mediaType = row[mediaType] ?: PinMediaWithImage.MediaType.valueOf("") /* kotlin.String */,
