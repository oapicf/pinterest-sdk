...
object UpdateMemberAssetAccessBodys : BaseTable<UpdateMemberAssetAccessBody>("UpdateMemberAssetAccessBody") {
    ...
    override fun doCreateEntity(row: QueryRowSet, withReferences: Boolean) = UpdateMemberAssetAccessBody(
        accesses = emptyList() /* kotlin.Array<UpdateMemberAssetAccessItem> */ /* List of member asset accesses to assign or update. */
    )
...
object UpdateMemberAssetAccessBodyUpdateMemberAssetAccessItem : BaseTable<Pair<kotlin.Long, kotlin.Long>>("UpdateMemberAssetAccessBodyUpdateMemberAssetAccessItem") {
    ...
    override fun doCreateEntity(row: QueryRowSet, withReferences: Boolean): Pair<kotlin.Long, kotlin.Long> =
        Pair(row[updateMemberAssetAccessBody] ?: 0, row[updateMemberAssetAccessItem] ?: 0)

    fun AssignmentsBuilder.assignFrom(entity: Pair<kotlin.Long, kotlin.Long>) {
        this.apply {
            set(UpdateMemberAssetAccessBodyUpdateMemberAssetAccessItem.updateMemberAssetAccessBody, entity.first)
            set(UpdateMemberAssetAccessBodyUpdateMemberAssetAccessItem.updateMemberAssetAccessItem, entity.second)
        }
    }
