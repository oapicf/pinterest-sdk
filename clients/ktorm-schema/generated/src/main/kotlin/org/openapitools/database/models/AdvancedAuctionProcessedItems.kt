...
object AdvancedAuctionProcessedItemss : BaseTable<AdvancedAuctionProcessedItems>("AdvancedAuctionProcessedItems") {
    ...
    override fun doCreateEntity(row: QueryRowSet, withReferences: Boolean) = AdvancedAuctionProcessedItems(
        ...
        items = emptyList() /* kotlin.Array<AdvancedAuctionItemsSubmitRecord>? */ /* Array of advanced auction processed items */
    )
...
object AdvancedAuctionProcessedItemsAdvancedAuctionItemsSubmitRecord : BaseTable<Pair<kotlin.Long, kotlin.Long>>("AdvancedAuctionProcessedItemsAdvancedAuctionItemsSubmitRecord") {
    ...
    override fun doCreateEntity(row: QueryRowSet, withReferences: Boolean): Pair<kotlin.Long, kotlin.Long> =
        Pair(row[advancedAuctionProcessedItems] ?: 0, row[advancedAuctionItemsSubmitRecord] ?: 0)

    fun AssignmentsBuilder.assignFrom(entity: Pair<kotlin.Long, kotlin.Long>) {
        this.apply {
            set(AdvancedAuctionProcessedItemsAdvancedAuctionItemsSubmitRecord.advancedAuctionProcessedItems, entity.first)
            set(AdvancedAuctionProcessedItemsAdvancedAuctionItemsSubmitRecord.advancedAuctionItemsSubmitRecord, entity.second)
        }
    }
