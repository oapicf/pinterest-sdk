...
object RelatedTermss : BaseTable<RelatedTerms>("RelatedTerms") {
    ...
    override fun doCreateEntity(row: QueryRowSet, withReferences: Boolean) = RelatedTerms(
        ...
        relatedTermsList = emptyList() /* kotlin.Array<RelatedTermsRelatedTermsListItems>? */ /* The id of the advertiser. */
    )
...
object RelatedTermsRelatedTermsRelatedTermsListItems : BaseTable<Pair<kotlin.Long, kotlin.Long>>("RelatedTermsRelatedTermsRelatedTermsListItems") {
    ...
    override fun doCreateEntity(row: QueryRowSet, withReferences: Boolean): Pair<kotlin.Long, kotlin.Long> =
        Pair(row[relatedTerms] ?: 0, row[relatedTermsRelatedTermsListItems] ?: 0)

    fun AssignmentsBuilder.assignFrom(entity: Pair<kotlin.Long, kotlin.Long>) {
        this.apply {
            set(RelatedTermsRelatedTermsRelatedTermsListItems.relatedTerms, entity.first)
            set(RelatedTermsRelatedTermsRelatedTermsListItems.relatedTermsRelatedTermsListItems, entity.second)
        }
    }
