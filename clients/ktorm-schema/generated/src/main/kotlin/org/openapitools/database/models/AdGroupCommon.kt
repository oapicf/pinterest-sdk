...
object AdGroupCommons : BaseTable<AdGroupCommon>("AdGroupCommon") {
    ...
    val bidStrategyType = text("bid_strategy_type").transform({ AdGroupCommon.BidStrategyType.valueOf(it ?: "AUTOMATIC_BID") }, { it.value }) /* null */ /* Bid strategy type. For Campaigns with Video Completion objectives, the only supported bid strategy type is AUTOMATIC_BID, also known as \"Pinterest Performance+ bidding\". */
    ...
    val promotionApplicationLevel = text("promotion_application_level").transform({ AdGroupCommon.PromotionApplicationLevel.valueOf(it ?: "NONE") }, { it.value }) /* null */ /* Specify if the promotion is applied at ad group or item level */
    ...
    */
    fun AssignmentsBuilder.assignFrom(entity: AdGroupCommon) {
        this.apply {
            ...
            set(AdGroupCommons.isCreativeOptimization, entity.isCreativeOptimization)
            ...
            set(AdGroupCommons.promotionApplicationLevel, entity.promotionApplicationLevel)
            set(AdGroupCommons.promotionId, entity.promotionId)
