...
object TrendingKeywordsResponses : BaseTable<TrendingKeywordsResponse>("TrendingKeywordsResponse") {
    ...
    override fun doCreateEntity(row: QueryRowSet, withReferences: Boolean) = TrendingKeywordsResponse(
        trends = emptyList() /* kotlin.Array<TrendingKeyword>? */ /* The top trending keywords for the specified trend type in the requested region. Results are ordered, with the first element in the array representing the #1 top trend. */
    )
...
object TrendingKeywordsResponseTrendingKeyword : BaseTable<Pair<kotlin.Long, kotlin.Long>>("TrendingKeywordsResponseTrendingKeyword") {
    val trendingKeywordsResponse = long("trendingKeywordsResponse")
    val trendingKeyword = long("trendingKeyword")

    override fun doCreateEntity(row: QueryRowSet, withReferences: Boolean): Pair<kotlin.Long, kotlin.Long> =
        Pair(row[trendingKeywordsResponse] ?: 0, row[trendingKeyword] ?: 0)

    fun AssignmentsBuilder.assignFrom(entity: Pair<kotlin.Long, kotlin.Long>) {
        this.apply {
            set(TrendingKeywordsResponseTrendingKeyword.trendingKeywordsResponse, entity.first)
            set(TrendingKeywordsResponseTrendingKeyword.trendingKeyword, entity.second)
        }
    }
