...
object TrendingKeywordsResponses : BaseTable<TrendingKeywordsResponse>("TrendingKeywordsResponse") {
    ...
    override fun doCreateEntity(row: QueryRowSet, withReferences: Boolean) = TrendingKeywordsResponse(
        trends = emptyList() /* kotlin.Array<TrendingKeyword>? */ /* The top trending keywords for the specified trend type in the requested region.<br /> Results are ordered, with the first element in the array representing the #1 top trend. */
    )
