 ...
 */
object InviteDataResponses : BaseTable<InviteDataResponse>("InviteDataResponse") {
    ...
    val inviteType = text("invite_type") /* null */ /* The type of invite. - 'MEMBER_INVITE' is to invite a member to access your business assets. - 'PARTNER_INVITE' is to invite a partner to access your business assets. - 'PARTNER_REQUEST' is to request access a partner's business assets. */
    ...
    /**
     * Create an entity of type InviteDataResponse from the model
     */
    override fun doCreateEntity(row: QueryRowSet, withReferences: Boolean) = InviteDataResponse(
        ...
        inviteType = row[inviteType]  /* kotlin.String? */ /* The type of invite. - 'MEMBER_INVITE' is to invite a member to access your business assets. - 'PARTNER_INVITE' is to invite a partner to access your business assets. - 'PARTNER_REQUEST' is to request access a partner's business assets. */,
    ...
    /**
    * Assign all the columns from the entity of type InviteDataResponse to the DML expression.
    *
    * Usage:
    *
    * ```kotlin
    * let entity = InviteDataResponse()
    * database.update(InviteDataResponses, {
    *     assignFrom(entity)
    * })
    * ```
    * @return the builder with the columns for the update or insert.
    */
    fun AssignmentsBuilder.assignFrom(entity: InviteDataResponse) {
        this.apply {
            set(InviteDataResponses.inviteExpiration, entity.inviteExpiration)
            set(InviteDataResponses.inviteStatus, entity.inviteStatus)
            set(InviteDataResponses.inviteType, entity.inviteType)
            set(InviteDataResponses.lastUpdatedTime, entity.lastUpdatedTime)
            set(InviteDataResponses.sentAt, entity.sentAt)
        }
    }
