...
object AdGroupUpdateRequests : BaseTable<AdGroupUpdateRequest>("AdGroupUpdateRequest") {
    ...
    val bidStrategyType = text("bid_strategy_type").transform({ AdGroupUpdateRequest.BidStrategyType.valueOf(it ?: "AUTOMATIC_BID") }, { it.value }) /* null */ /* Bid strategy type. For Campaigns with Video Completion objectives, the only supported bid strategy type is AUTOMATIC_BID. */
