    ...
    */
    fun AssignmentsBuilder.assignFrom(entity: CatalogsProductGroupFilterKeys) {
        this.apply {
            ...
            set(CatalogsProductGroupFilterKeyss.CUSTOM_NUMBER_0, entity.CUSTOM_NUMBER_0)
            set(CatalogsProductGroupFilterKeyss.CUSTOM_NUMBER_1, entity.CUSTOM_NUMBER_1)
            set(CatalogsProductGroupFilterKeyss.CUSTOM_NUMBER_2, entity.CUSTOM_NUMBER_2)
            set(CatalogsProductGroupFilterKeyss.CUSTOM_NUMBER_3, entity.CUSTOM_NUMBER_3)
            set(CatalogsProductGroupFilterKeyss.CUSTOM_NUMBER_4, entity.CUSTOM_NUMBER_4)
            set(CatalogsProductGroupFilterKeyss.TITLE_KEYWORDS, entity.TITLE_KEYWORDS)
            set(CatalogsProductGroupFilterKeyss.PINTEREST_PRODUCT_CATEGORIES, entity.PINTEREST_PRODUCT_CATEGORIES)
