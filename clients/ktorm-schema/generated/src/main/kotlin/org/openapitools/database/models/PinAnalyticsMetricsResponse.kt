...
object PinAnalyticsMetricsResponses : BaseTable<PinAnalyticsMetricsResponse>("PinAnalyticsMetricsResponse") {
    ...
    override fun doCreateEntity(row: QueryRowSet, withReferences: Boolean) = PinAnalyticsMetricsResponse(
        dailyMetrics = emptyList() /* kotlin.Array<PinAnalyticsDailyMetrics>? */ /* Array with the requested daily metric records */,
...
object PinAnalyticsMetricsResponsePinAnalyticsDailyMetrics : BaseTable<Pair<kotlin.Long, kotlin.Long>>("PinAnalyticsMetricsResponsePinAnalyticsDailyMetrics") {
    val pinAnalyticsMetricsResponse = long("pinAnalyticsMetricsResponse")
    val pinAnalyticsDailyMetrics = long("pinAnalyticsDailyMetrics")

    override fun doCreateEntity(row: QueryRowSet, withReferences: Boolean): Pair<kotlin.Long, kotlin.Long> =
        Pair(row[pinAnalyticsMetricsResponse] ?: 0, row[pinAnalyticsDailyMetrics] ?: 0)

    fun AssignmentsBuilder.assignFrom(entity: Pair<kotlin.Long, kotlin.Long>) {
        this.apply {
            set(PinAnalyticsMetricsResponsePinAnalyticsDailyMetrics.pinAnalyticsMetricsResponse, entity.first)
            set(PinAnalyticsMetricsResponsePinAnalyticsDailyMetrics.pinAnalyticsDailyMetrics, entity.second)
        }
    }
