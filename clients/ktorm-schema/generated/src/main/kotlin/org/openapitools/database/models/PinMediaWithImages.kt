...
object PinMediaWithImagess : BaseTable<PinMediaWithImages>("PinMediaWithImages") {
    val mediaType = text("media_type").transform({ PinMediaWithImages.MediaType.valueOf(it) }, { it.value })
    ...
    override fun doCreateEntity(row: QueryRowSet, withReferences: Boolean) = PinMediaWithImages(
        mediaType = row[mediaType] ?: PinMediaWithImages.MediaType.valueOf("") /* kotlin.String */,
