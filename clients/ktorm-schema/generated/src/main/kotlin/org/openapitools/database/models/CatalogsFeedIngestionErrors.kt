...
object CatalogsFeedIngestionErrorss : BaseTable<CatalogsFeedIngestionErrors>("CatalogsFeedIngestionErrors") {
    ...
    val FETCH_GOOGLE_SHEET_NOT_SHARED = int("FETCH_GOOGLE_SHEET_NOT_SHARED") /* null */ /* Update your Google Sheets sharing settings to 'Anyone with link' as a Viewer so that Pinterest can access your file. */
    ...
    val LARGE_PRODUCT_COUNT_DECREASE = int("LARGE_PRODUCT_COUNT_DECREASE") /* null */ /* The product count has decreased by more than 99% compared to the last successful ingestion. */
    ...
    override fun doCreateEntity(row: QueryRowSet, withReferences: Boolean) = CatalogsFeedIngestionErrors(
        ...
        FETCH_GOOGLE_SHEET_NOT_SHARED = row[FETCH_GOOGLE_SHEET_NOT_SHARED]  /* kotlin.Int? */ /* Update your Google Sheets sharing settings to 'Anyone with link' as a Viewer so that Pinterest can access your file. */,
    ...
    */
    fun AssignmentsBuilder.assignFrom(entity: CatalogsFeedIngestionErrors) {
        this.apply {
            ...
            set(CatalogsFeedIngestionErrorss.FETCH_GOOGLE_SHEET_NOT_SHARED, entity.FETCH_GOOGLE_SHEET_NOT_SHARED)
