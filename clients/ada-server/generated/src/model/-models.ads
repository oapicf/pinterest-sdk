...
package .Models is
   ...
   type ConversionReportTimeType_Type is (TIME_OF_AD_ACTION,TIME_OF_CONVERSION);
   ...
   type InviteResponse_Type is
     record
       ...
       Business_Roles : Swagger.UString_Vectors.Vector;
       Created_By_Business : Swagger.Object;
       Created_By_User : Swagger.Object;
       Created_Time : Swagger.Nullable_Integer;
     end record;
   ...
   type AudienceCreateRequest_Type is
     record
       ...
       Rule : .Models.AudienceRule_Type;
       Description : Swagger.Nullable_UString;
       Audience_Type : .Models.AudienceType_Type;
     end record;
