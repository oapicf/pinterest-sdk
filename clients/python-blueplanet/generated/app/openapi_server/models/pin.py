...
class Pin(Model):
    ...
    def __init__(self, ai_disclosures: AiDisclosures=None, board_id: str=None, board_owner: BoardOwner=None, board_section_id: str=None, created_at: datetime=None, creative_type: CreativeType=None, dominant_color: str=None, has_been_promoted: bool=None, id: str=None, is_owner: bool=None, is_product: bool=None, is_standard: bool=None, media: PinMedia=None, parent_pin_id: str=None, pin_metrics: object=None, alt_text: str=None, description: str=None, link: str=None, title: str=None):  # noqa: E501
        ...
        :param board_section_id: The board_section_id of this Pin.  # noqa: E501
        :type board_section_id: str
        :param created_at: The created_at of this Pin.  # noqa: E501
    ...
    def board_id(self) -> str:
        """Gets the board_id of this Pin.

        The board to which this Pin belongs.  # noqa: E501

        :return: The board_id of this Pin.
        :rtype: str
        """
    ...
    def board_id(self, board_id: str):
        """Sets the board_id of this Pin.

        The board to which this Pin belongs.  # noqa: E501

        :param board_id: The board_id of this Pin.
        :type board_id: str
        """
    ...
    def board_owner(self) -> BoardOwner:
        """Gets the board_owner of this Pin.


        :return: The board_owner of this Pin.
        :rtype: BoardOwner
        """
    ...
    def board_owner(self, board_owner: BoardOwner):
        """Sets the board_owner of this Pin.


        :param board_owner: The board_owner of this Pin.
        :type board_owner: BoardOwner
        """
    ...
    def board_section_id(self) -> str:
        """Gets the board_section_id of this Pin.

        The board section to which this Pin belongs.  # noqa: E501

        :return: The board_section_id of this Pin.
        :rtype: str
        """
    ...
    def board_section_id(self, board_section_id: str):
        """Sets the board_section_id of this Pin.

        The board section to which this Pin belongs.  # noqa: E501

        :param board_section_id: The board_section_id of this Pin.
        :type board_section_id: str
        """
    ...
    def created_at(self) -> datetime:
        """Gets the created_at of this Pin.


        :return: The created_at of this Pin.
        :rtype: datetime
        """
    ...
    def created_at(self, created_at: datetime):
        """Sets the created_at of this Pin.


        :param created_at: The created_at of this Pin.
        :type created_at: datetime
        """
    ...
    def creative_type(self) -> CreativeType:
        """Gets the creative_type of this Pin.


        :return: The creative_type of this Pin.
        :rtype: CreativeType
        """
    ...
    def creative_type(self, creative_type: CreativeType):
        """Sets the creative_type of this Pin.


        :param creative_type: The creative_type of this Pin.
        :type creative_type: CreativeType
        """
    ...
    def dominant_color(self) -> str:
        ...
        :return: The dominant_color of this Pin.
        :rtype: str
        """
    ...
    def dominant_color(self, dominant_color: str):
        """Sets the dominant_color of this Pin.

        Dominant pin color. Hex number, e.g. `#6E7874`.  # noqa: E501

        :param dominant_color: The dominant_color of this Pin.
        :type dominant_color: str
        """
    ...
    def has_been_promoted(self) -> bool:
        """Gets the has_been_promoted of this Pin.

        Whether the Pin has been promoted or not.  # noqa: E501

        :return: The has_been_promoted of this Pin.
        :rtype: bool
        """
    ...
    def has_been_promoted(self, has_been_promoted: bool):
        """Sets the has_been_promoted of this Pin.

        Whether the Pin has been promoted or not.  # noqa: E501

        :param has_been_promoted: The has_been_promoted of this Pin.
        :type has_been_promoted: bool
        """
    ...
    def is_owner(self, is_owner: bool):
        """Sets the is_owner of this Pin.

        Whether the \"operation user_account\" is the Pin owner.  # noqa: E501

        :param is_owner: The is_owner of this Pin.
        :type is_owner: bool
        """
    ...
    def is_standard(self) -> bool:
        ...
        :return: The is_standard of this Pin.
        :rtype: bool
        """
    ...
    def is_standard(self, is_standard: bool):
        """Sets the is_standard of this Pin.

        Whether the Pin is standard or not. See documentation on [Changes to Pin creation](/docs/api-features/content-overview/) for more information.  # noqa: E501

        :param is_standard: The is_standard of this Pin.
        :type is_standard: bool
        """
    ...
    def media(self) -> PinMedia:
        """Gets the media of this Pin.


        :return: The media of this Pin.
        :rtype: PinMedia
        """
        return self._media
    ...
    def media(self, media: PinMedia):
        """Sets the media of this Pin.


        :param media: The media of this Pin.
        :type media: PinMedia
        """
    ...
    def parent_pin_id(self) -> str:
        """Gets the parent_pin_id of this Pin.
        ...
        :return: The parent_pin_id of this Pin.
        :rtype: str
        """
    ...
    def parent_pin_id(self, parent_pin_id: str):
        """Sets the parent_pin_id of this Pin.

        The source pin id if this pin was saved from another pin. [Learn more](https://help.pinterest.com/article/save-pins-on-pinterest).  # noqa: E501

        :param parent_pin_id: The parent_pin_id of this Pin.
        :type parent_pin_id: str
        """
    ...
    def pin_metrics(self) -> object:
        """Gets the pin_metrics of this Pin.

        Pin metrics with associated time intervals if any.  # noqa: E501

        :return: The pin_metrics of this Pin.
        :rtype: object
        """
    ...
    def pin_metrics(self, pin_metrics: object):
        """Sets the pin_metrics of this Pin.

        Pin metrics with associated time intervals if any.  # noqa: E501

        :param pin_metrics: The pin_metrics of this Pin.
        :type pin_metrics: object
        """
    ...
    @property
    def title(self) -> str:
        """Gets the title of this Pin.


        :return: The title of this Pin.
        :rtype: str
        """
        return self._title
    ...
    def title(self, title: str):
        """Sets the title of this Pin.


        :param title: The title of this Pin.
        :type title: str
        """
