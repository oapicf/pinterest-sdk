...
class CatalogsHotelReportParametersReport(Model):
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'CatalogsHotelReportParametersReport':
    ...
    def feed_id(self) -> str:
        """Gets the feed_id of this CatalogsHotelReportParametersReport.

        ID of the feed entity.  # noqa: E501

        :return: The feed_id of this CatalogsHotelReportParametersReport.
        :rtype: str
        """
    ...
    def feed_id(self, feed_id: str):
        """Sets the feed_id of this CatalogsHotelReportParametersReport.

        ID of the feed entity.  # noqa: E501

        :param feed_id: The feed_id of this CatalogsHotelReportParametersReport.
        :type feed_id: str
        """
        if feed_id is None:
    ...
    def processing_result_id(self) -> str:
        """Gets the processing_result_id of this CatalogsHotelReportParametersReport.
        ...
        :return: The processing_result_id of this CatalogsHotelReportParametersReport.
        :rtype: str
        """
    ...
    def processing_result_id(self, processing_result_id: str):
        """Sets the processing_result_id of this CatalogsHotelReportParametersReport.

        Unique identifier of a feed processing result. It can be acquired from the \"id\" field of the \"items\" array within the response of the [List processing results for a given feed](/docs/api/v5/#operation/feed_processing_results/list). If not provided, default to most recent completed processing result.  # noqa: E501

        :param processing_result_id: The processing_result_id of this CatalogsHotelReportParametersReport.
        :type processing_result_id: str
        """
    ...
    def catalog_id(self) -> str:
        """Gets the catalog_id of this CatalogsHotelReportParametersReport.

        Unique identifier of a catalog. If not given, oldest catalog will be used  # noqa: E501

        :return: The catalog_id of this CatalogsHotelReportParametersReport.
        :rtype: str
        """
    ...
    def catalog_id(self, catalog_id: str):
        """Sets the catalog_id of this CatalogsHotelReportParametersReport.

        Unique identifier of a catalog. If not given, oldest catalog will be used  # noqa: E501

        :param catalog_id: The catalog_id of this CatalogsHotelReportParametersReport.
        :type catalog_id: str
        """
