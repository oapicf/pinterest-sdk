...
class CatalogsCreativeAssetsFeedsCreateRequest(Model):
    ...
    def __init__(self, catalog_id: str=None, catalog_type: str=None, credentials: CatalogsFeedCredentials=None, default_country: Country=None, default_currency: NullableCurrency=None, default_locale: CatalogsCreativeAssetsFeedsCreateRequestDefaultLocale=None, format: CatalogsFormat=None, location: str=None, name: str=None, preferred_processing_schedule: CatalogsFeedProcessingSchedule=None, status: CatalogsStatus=None):  # noqa: E501
        ...
        :type location: str
        :param name: The name of this CatalogsCreativeAssetsFeedsCreateRequest.  # noqa: E501
        :type name: str
        :param preferred_processing_schedule: The preferred_processing_schedule of this CatalogsCreativeAssetsFeedsCreateRequest.  # noqa: E501
        :type preferred_processing_schedule: CatalogsFeedProcessingSchedule
        :param status: The status of this CatalogsCreativeAssetsFeedsCreateRequest.  # noqa: E501
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'CatalogsCreativeAssetsFeedsCreateRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :type: dict
        :return: The CatalogsCreativeAssetsFeedsCreateRequest of this CatalogsCreativeAssetsFeedsCreateRequest.  # noqa: E501
        :rtype: CatalogsCreativeAssetsFeedsCreateRequest
        """
    ...
    def credentials(self) -> CatalogsFeedCredentials:
        """Gets the credentials of this CatalogsCreativeAssetsFeedsCreateRequest.


        :return: The credentials of this CatalogsCreativeAssetsFeedsCreateRequest.
    ...
    def credentials(self, credentials: CatalogsFeedCredentials):
        """Sets the credentials of this CatalogsCreativeAssetsFeedsCreateRequest.


        :param credentials: The credentials of this CatalogsCreativeAssetsFeedsCreateRequest.
        :type credentials: CatalogsFeedCredentials
        """
    ...
    def default_country(self) -> Country:
        """Gets the default_country of this CatalogsCreativeAssetsFeedsCreateRequest.


        :return: The default_country of this CatalogsCreativeAssetsFeedsCreateRequest.
        :rtype: Country
        """
    ...
    def default_country(self, default_country: Country):
        """Sets the default_country of this CatalogsCreativeAssetsFeedsCreateRequest.


        :param default_country: The default_country of this CatalogsCreativeAssetsFeedsCreateRequest.
        :type default_country: Country
        """
    ...
    def default_currency(self) -> NullableCurrency:
        """Gets the default_currency of this CatalogsCreativeAssetsFeedsCreateRequest.


        :return: The default_currency of this CatalogsCreativeAssetsFeedsCreateRequest.
    ...
    def default_currency(self, default_currency: NullableCurrency):
        """Sets the default_currency of this CatalogsCreativeAssetsFeedsCreateRequest.


        :param default_currency: The default_currency of this CatalogsCreativeAssetsFeedsCreateRequest.
        :type default_currency: NullableCurrency
        """
    ...
    def format(self) -> CatalogsFormat:
        """Gets the format of this CatalogsCreativeAssetsFeedsCreateRequest.


        :return: The format of this CatalogsCreativeAssetsFeedsCreateRequest.
    ...
    def format(self, format: CatalogsFormat):
        """Sets the format of this CatalogsCreativeAssetsFeedsCreateRequest.


        :param format: The format of this CatalogsCreativeAssetsFeedsCreateRequest.
        :type format: CatalogsFormat
        """
        if format is None:
    ...
    def location(self) -> str:
        """Gets the location of this CatalogsCreativeAssetsFeedsCreateRequest.
        ...
        :return: The location of this CatalogsCreativeAssetsFeedsCreateRequest.
        :rtype: str
        """
    ...
    def location(self, location: str):
        """Sets the location of this CatalogsCreativeAssetsFeedsCreateRequest.

        The URL where a feed is available for download. This URL is what Pinterest will use to download a feed for processing.  # noqa: E501

        :param location: The location of this CatalogsCreativeAssetsFeedsCreateRequest.
        :type location: str
        """
        if location is None:
    ...
    @property
    def name(self) -> str:
        """Gets the name of this CatalogsCreativeAssetsFeedsCreateRequest.

        A human-friendly name associated to a given feed.  # noqa: E501

        :return: The name of this CatalogsCreativeAssetsFeedsCreateRequest.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name: str):
        """Sets the name of this CatalogsCreativeAssetsFeedsCreateRequest.

        A human-friendly name associated to a given feed.  # noqa: E501

        :param name: The name of this CatalogsCreativeAssetsFeedsCreateRequest.
        :type name: str
        """
        if name is None:
    ...
    def preferred_processing_schedule(self) -> CatalogsFeedProcessingSchedule:
        """Gets the preferred_processing_schedule of this CatalogsCreativeAssetsFeedsCreateRequest.


        :return: The preferred_processing_schedule of this CatalogsCreativeAssetsFeedsCreateRequest.
    ...
    def preferred_processing_schedule(self, preferred_processing_schedule: CatalogsFeedProcessingSchedule):
        """Sets the preferred_processing_schedule of this CatalogsCreativeAssetsFeedsCreateRequest.


        :param preferred_processing_schedule: The preferred_processing_schedule of this CatalogsCreativeAssetsFeedsCreateRequest.
        :type preferred_processing_schedule: CatalogsFeedProcessingSchedule
        """
    ...
    def status(self) -> CatalogsStatus:
        """Gets the status of this CatalogsCreativeAssetsFeedsCreateRequest.


        :return: The status of this CatalogsCreativeAssetsFeedsCreateRequest.
    ...
    def status(self, status: CatalogsStatus):
        """Sets the status of this CatalogsCreativeAssetsFeedsCreateRequest.


        :param status: The status of this CatalogsCreativeAssetsFeedsCreateRequest.
        :type status: CatalogsStatus
        """
