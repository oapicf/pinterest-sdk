...
def keywords_create(ad_account_id, body):  # noqa: E501
    ...
    if connexion.request.is_json:
        body = KeywordsRequest.from_dict(connexion.request.get_json())  # noqa: E501
    return 'do some magic!'


def keywords_get(ad_account_id, campaign_id=None, ad_group_id=None, ad_group_ids=None, match_types=None, page_size=None, bookmark=None):  # noqa: E501
    """Get keywords
...
def keywords_update(ad_account_id, body):  # noqa: E501
    ...
    """
    if connexion.request.is_json:
        body = KeywordUpdateBody.from_dict(connexion.request.get_json())  # noqa: E501
    return 'do some magic!'


def trending_keywords_list(region, trend_type, interests=None, genders=None, ages=None, include_keywords=None, normalize_against_group=None, limit=None, include_prediction=None, include_demographics=None):  # noqa: E501
