...
from app.openapi_server.models.keywords import Keywords  # noqa: E501
from app.openapi_server.models.keywords_create import KeywordsCreate  # noqa: E501
...
from app.openapi_server.models.keywords_update import KeywordsUpdate  # noqa: E501
...
from app.openapi_server.models.trends_age_bucket import TrendsAgeBucket  # noqa: E501
from app.openapi_server.models.trends_gender_filter import TrendsGenderFilter  # noqa: E501
from app.openapi_server.models.trends_l1_interest import TrendsL1Interest  # noqa: E501
from app.openapi_server.models.trends_supported_region import TrendsSupportedRegion  # noqa: E501
from openapi_server import util


def country_keywords_metrics_get(ad_account_id, country_code, keywords):  # noqa: E501
...
def keywords_create(ad_account_id, body):  # noqa: E501
    """Create keywords
    ...
    if connexion.request.is_json:
        body = KeywordsCreate.from_dict(connexion.request.get_json())  # noqa: E501
    return 'do some magic!'


def keywords_get(ad_account_id, campaign_id=None, ad_group_id=None, ad_group_ids=None, match_types=None, bookmark=None, page_size=None):  # noqa: E501
    """Get keywords
    ...
    """
    if connexion.request.is_json:
        match_types = [MatchType.from_dict(d) for d in connexion.request.get_json()]  # noqa: E501
    return 'do some magic!'


def keywords_update(ad_account_id, body):  # noqa: E501
    """Update keywords
    ...
    """
    if connexion.request.is_json:
        body = KeywordsUpdate.from_dict(connexion.request.get_json())  # noqa: E501
    return 'do some magic!'


def trending_keywords_list(region, trend_type, interests=None, genders=None, ages=None, include_keywords=None, normalize_against_group=None, limit=None, include_demographics=None):  # noqa: E501
    ...
    if connexion.request.is_json:
        trend_type = .from_dict(connexion.request.get_json())  # noqa: E501
    if connexion.request.is_json:
        interests = [TrendsL1Interest.from_dict(d) for d in connexion.request.get_json()]  # noqa: E501
    if connexion.request.is_json:
        genders = [TrendsGenderFilter.from_dict(d) for d in connexion.request.get_json()]  # noqa: E501
    if connexion.request.is_json:
        ages = [TrendsAgeBucket.from_dict(d) for d in connexion.request.get_json()]  # noqa: E501
    return 'do some magic!'
