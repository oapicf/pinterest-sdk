...
public class KeywordsApiTest {
    ...
    ResponseEntity<KeywordsGet200Response> response = api.keywordsGet(adAccountId, campaignId, adGroupId, adGroupIds, matchTypes, pageSize, bookmark , accept);
    ...
    ResponseEntity<TrendingKeywordsResponse> response = api.trendingKeywordsList(region, trendType, interests, genders, ages, includeKeywords, normalizeAgainstGroup, limit, includePrediction, includeDemographics , accept);
