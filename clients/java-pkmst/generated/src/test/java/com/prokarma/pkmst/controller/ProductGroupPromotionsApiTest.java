...
public class ProductGroupPromotionsApiTest {
    ...
    ResponseEntity<ProductGroupPromotionResponse> response = api.productGroupPromotionsGet(adAccountId, productGroupPromotionId , accept);
    ...
    ResponseEntity<List<ProductGroupAnalyticsResponseInner>> response = api.productGroupsAnalytics(adAccountId, startDate, endDate, productGroupIds, columns, granularity, clickWindowDays, engagementWindowDays, viewWindowDays, conversionReportTime , accept);
