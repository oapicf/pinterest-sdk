...
public class UserAccountApiTest {
    ...
    ResponseEntity<UserWebsiteSummary> response = api.verifyWebsiteUpdate(userWebsiteVerifyRequest , accept);
    ...
    ResponseEntity<UserWebsiteVerificationCode> response = api.websiteVerificationGet(  accept);
