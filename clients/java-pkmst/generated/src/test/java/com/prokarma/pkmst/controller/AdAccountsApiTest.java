...
public class AdAccountsApiTest {
    ...
    ResponseEntity<List<AdAccountAnalyticsResponseInner>> response = api.adAccountAnalytics(adAccountId, startDate, endDate, columns, granularity, clickWindowDays, engagementWindowDays, viewWindowDays, conversionReportTime, reportingTimezone , accept);
    ...
    public void adAccountTargetingAnalyticsGetTest() throws Exception {
        ...
        ReportingTimeZone reportingTimezone = null;
    ResponseEntity<MetricsResponse> response = api.adAccountTargetingAnalyticsGet(adAccountId, startDate, endDate, targetingTypes, columns, granularity, clickWindowDays, engagementWindowDays, viewWindowDays, conversionReportTime, attributionTypes, reportingTimezone , accept);
    ...
    ResponseEntity<AdAccount> response = api.adAccountsCreate(adAccountCreate , accept);
    ...
    ResponseEntity<AdAccountsList200Response> response = api.adAccountsList(includeSharedAccounts, bookmark, pageSize , accept);
    ...
    ResponseEntity<AdsAnalyticsCreateAsyncResponse> response = api.analyticsCreateConversionProductReport(adAccountId, conversionProductReportRequest , accept);
    ...
    public void analyticsCreateTemplateReportTest() throws Exception {
        ...
        LocalDate endDate = null;
        Granularity granularity = null;
    ResponseEntity<TemplateBasedReport> response = api.analyticsCreateTemplateReport(adAccountId, templateId, startDate, endDate, granularity , accept);
    ...
    public void analyticsGetConversionProductReportTest() throws Exception {
        String adAccountId = null;
        String token = null;
    ResponseEntity<AdsAnalyticsGetAsyncResponse> response = api.analyticsGetConversionProductReport(adAccountId, token , accept);
