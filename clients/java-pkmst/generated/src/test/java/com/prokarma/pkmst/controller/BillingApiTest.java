...
public class BillingApiTest {
    ...
    ResponseEntity<BillingInvoiceDownloadResponse> response = api.billingInvoiceDownloadGet(adAccountId, billingInvoiceId , accept);
    ...
    ResponseEntity<BillingInvoicesGet200Response> response = api.billingInvoicesGet(adAccountId, bookmark, pageSize, sort, order, status, documentType, startDueDate, endDueDate , accept);
