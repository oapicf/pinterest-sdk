...
public class BusinessAccessAssetsApiTest {
    ...
    ResponseEntity<BusinessAssetMembersGet200Response> response = api.businessAssetMembersGet(businessId, assetId, fetchSystemUsers, bookmark, pageSize, startIndex , accept);
