...
public class CampaignsApiTest {
    ...
    ResponseEntity<List<AdPinAnalytics>> response = api.adPinsAnalytics(adAccountId, campaignId, pinIds, startDate, endDate, columns, granularity, clickWindowDays, engagementWindowDays, viewWindowDays, conversionReportTime , accept);
    ...
    ResponseEntity<MetricsResponse> response = api.campaignTargetingAnalyticsGet(adAccountId, campaignIds, startDate, endDate, targetingTypes, columns, granularity, clickWindowDays, engagementWindowDays, viewWindowDays, conversionReportTime, attributionTypes, reportingTimezone , accept);
    ...
    public void campaignsAnalyticsTest() throws Exception {
        ...
        ReportingTimeZone reportingTimezone = null;
    ResponseEntity<List<CampaignsAnalyticsResponseInner>> response = api.campaignsAnalytics(adAccountId, startDate, endDate, campaignIds, columns, granularity, clickWindowDays, engagementWindowDays, viewWindowDays, conversionReportTime, aggregateReportRows, reportingTimezone , accept);
