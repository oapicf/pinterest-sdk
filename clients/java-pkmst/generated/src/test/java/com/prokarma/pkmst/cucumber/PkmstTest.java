...
@CucumberOptions(format = { "pretty", "html:target/cucumber-html-report",
 "json:./report/account_claiming-report-json/account_claiming.json",
 ...
 "json:./report/advanced_auction-report-json/advanced_auction.json",
 "json:./report/audience_insights-report-json/audience_insights.json",
 "json:./report/audience_sharing-report-json/audience_sharing.json",
 ...
 "json:./report/catalog_feeds-report-json/catalog_feeds.json",
 "json:./report/catalog_items-report-json/catalog_items.json",
 "json:./report/catalog_product_groups-report-json/catalog_product_groups.json",
 "json:./report/catalog_regions-report-json/catalog_regions.json",
 "json:./report/catalog_reports-report-json/catalog_reports.json",
 "json:./report/catalog_supplemental-report-json/catalog_supplemental.json",
 "json:./report/catalogs-report-json/catalogs.json",
 "json:./report/conversion_eqs-report-json/conversion_eqs.json",
 ...
 "json:./report/leads_export-report-json/leads_export.json",
 "json:./report/media-report-json/media.json",
 "json:./report/msot_events-report-json/msot_events.json",
 ...
 "json:./report/promotions-report-json/promotions.json",
 "json:./report/resources-report-json/resources.json",
 "json:./report/search-report-json/search.json",
 "json:./report/targeting_template-report-json/targeting_template.json",
