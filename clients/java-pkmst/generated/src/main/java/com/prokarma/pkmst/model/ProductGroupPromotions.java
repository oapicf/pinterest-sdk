...
import com.prokarma.pkmst.model.ProductGroupPromotionResponseItem;
...
public class ProductGroupPromotions   {
   ...
   * @return items
   */
  @ApiModelProperty(readOnly = true, value = "Response-only: created or updated product group promotions, or exceptions.")
