...
import com.prokarma.pkmst.model.AdDisapprovalReasons;
import com.prokarma.pkmst.model.AdReviewStatus;
import com.prokarma.pkmst.model.CartingProduct;
...
public class Ad   {
   ...
   * @return adAccountId
   */
  @ApiModelProperty(required = true, readOnly = true, value = "The ID of the advertiser that this ad belongs to.")
   ...
   * @return campaignId
   */
  @ApiModelProperty(required = true, readOnly = true, value = "ID of the ad campaign that contains this ad.")
   ...
   */
  @ApiModelProperty(readOnly = true, value = "The vendor platform type of the carting/WTB ad.")
   ...
   */
  @ApiModelProperty(readOnly = true, value = "Array of carting/WTB products for the ad.")
   ...
   * @return createdTime
   */
  @ApiModelProperty(readOnly = true, value = "Pin creation time. Unix timestamp in seconds.")
   ...
   */
  @ApiModelProperty(required = true, readOnly = true, value = "Enum reason why the pin was rejected. Returned if `review_status` is \"REJECTED\".")
   ...
   */
  @ApiModelProperty(required = true, readOnly = true, value = "Text reason why the pin was rejected. Returned if `review_status` is \"REJECTED\".")
   ...
   * @return reviewStatus
   */
  @ApiModelProperty(required = true, readOnly = true, value = "Ad review status")
   ...
   */
  @ApiModelProperty(required = true, readOnly = true, value = "Ad summary status")
   ...
   * @return type
   */
  @ApiModelProperty(required = true, readOnly = true, value = "Always \"ad\".")
   ...
   * @return updatedTime
   */
  @ApiModelProperty(readOnly = true, value = "Last update time. Unix timestamp in seconds.")
