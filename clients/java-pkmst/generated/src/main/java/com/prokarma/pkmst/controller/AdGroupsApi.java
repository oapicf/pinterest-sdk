...
public interface AdGroupsApi {
    ...
    ResponseEntity<AdGroupAudienceSizingResponse> adGroupsAudienceSizing(@ApiParam(value = "Unique identifier of an ad account.",required=true ) @PathVariable("ad_account_id") String adAccountId,@ApiParam(value = "" ,required=true )   @RequestBody AdGroupAudienceSizingRequest adGroupAudienceSizingRequest, @RequestHeader(value = "Accept", required = false) String accept) throws Exception;
