...
public interface IntegrationsApi {
    ...
    ResponseEntity<IntegrationMetadata> integrationsCommerceDel(@ApiParam(value = "External business ID for the integration.",required=true ) @PathVariable("external_business_id") String externalBusinessId, @RequestHeader(value = "Accept", required = false) String accept) throws Exception;
    ...
    ResponseEntity<IntegrationMetadata> integrationsCommercePatch(@ApiParam(value = "External business ID for the integration.",required=true ) @PathVariable("external_business_id") String externalBusinessId,@ApiParam(value = "" ,required=true )   @RequestBody IntegrationMetadataUpdate integrationMetadataUpdate, @RequestHeader(value = "Accept", required = false) String accept) throws Exception;
    ...
    ResponseEntity<IntegrationMetadata> integrationsCommercePost(@ApiParam(value = "" ,required=true )   @RequestBody IntegrationMetadataCreate integrationMetadataCreate, @RequestHeader(value = "Accept", required = false) String accept) throws Exception;
    ...
    ResponseEntity<IntegrationRecord> integrationsGetById(@ApiParam(value = "Integration record ID.",required=true ) @PathVariable("id") String id, @RequestHeader(value = "Accept", required = false) String accept) throws Exception;
    ...
    ResponseEntity<IntegrationLogsSuccessResponse> integrationsLogsPost(@ApiParam(value = "" ,required=true )   @RequestBody IntegrationLogsRequestCreate integrationLogsRequestCreate, @RequestHeader(value = "Accept", required = false) String accept) throws Exception;
