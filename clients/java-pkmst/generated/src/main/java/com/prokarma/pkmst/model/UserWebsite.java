...
public class UserWebsite   {
   ...
   * @return status
   */
  @ApiModelProperty(readOnly = true, value = "Status of the verification process")
   ...
   * @return verifiedAt
   */
  @ApiModelProperty(readOnly = true, value = "UTC timestamp when the verification happened - sometimes missing")
