...
@Autowired
    ...
    public ResponseEntity<Map<String, PinAnalyticsMetricsResponse>> pinsAnalytics(@ApiParam(value = "Unique identifier of a Pin.",required=true ) @PathVariable("pin_id") String pinId,
        ...
        @ApiParam(value = "Pin metric types to get data for, default is all.", required = true)  @RequestParam(value = "metric_types", required = true) List<PinsAnalyticsMetricTypesParameterInner> metricTypes,
