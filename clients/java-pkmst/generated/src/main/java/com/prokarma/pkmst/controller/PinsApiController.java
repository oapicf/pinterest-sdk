...
import com.prokarma.pkmst.model.MultiPinsAnalyticsMetricTypesItem;
...
import com.prokarma.pkmst.model.PinFilter;
import com.prokarma.pkmst.model.PinType;
import com.prokarma.pkmst.model.PinUpdate;
import com.prokarma.pkmst.model.PinsList200Response;
import com.prokarma.pkmst.model.PinsSaveRequestCreate;
import com.prokarma.pkmst.model.PinterestLibError;
import com.prokarma.pkmst.model.QuerypinanalyticsmetrictypesItems;
...
@Autowired
    ...
    public ResponseEntity<Map<String, Map<String>> multiPinsAnalytics(@ApiParam(value = "List of Pin IDs.", required = true)  @RequestParam(value = "pin_ids", required = true) List<String> pinIds,
        ...
        @ApiParam(value = "Pin metric types to get data for.", required = true)  @RequestParam(value = "metric_types", required = true) List<MultiPinsAnalyticsMetricTypesItem> metricTypes,
    ...
    public ResponseEntity<Pin> pinsDelete(@ApiParam(value = "",required=true ) @PathVariable("pin_id") String pinId,
        @ApiParam(value = "Unique identifier of an ad account.")  @RequestParam(value = "ad_account_id", required = false) String adAccountId,
        @RequestHeader(value = "Accept", required = false) String accept) throws Exception {
        // do some magic!
    ...
    public ResponseEntity<PinsList200Response> pinsList(@ApiParam(value = "The filter to apply to the pins", allowableValues = "exclude_native, exclude_repins, has_been_promoted")  @RequestParam(value = "pin_filter", required = false) PinFilter pinFilter,
        @ApiParam(value = "Specify whether to return 90d and lifetime Pin metrics. Total comments and total reactions are only available with lifetime Pin metrics. If Pin was created before `2023-03-20` lifetime metrics will only be available for Video and Idea Pin formats. Lifetime metrics are available for all Pin formats since then.", defaultValue = "false")  @RequestParam(value = "pin_metrics", required = false, defaultValue="false") Boolean pinMetrics,
        ...
        @ApiParam(value = "The type of pins to return, currently only enabled for private pins", allowableValues = "PRIVATE")  @RequestParam(value = "pin_type", required = false) PinType pinType,
        ...
        @ApiParam(value = "Unique identifier of an ad account.")  @RequestParam(value = "ad_account_id", required = false) String adAccountId,
        @ApiParam(value = "Only return pins with links that match the exact domain. Domain should not include 'www.' prefix. For example, 'pinterest.com' is a valid domain, but 'www.pinterest.com' is not (will not match any pins).")  @RequestParam(value = "domain", required = false) String domain,
        @ApiParam(value = "Only return pins with links whose domain matches any value in the list. Values are joined comma-separated on the wire (e.g. `?domains=instagram.com,jcpenney.com`).")  @RequestParam(value = "domains", required = false) List<String> domains,
        @ApiParam(value = "Include product tag objects in the response with their associated links.")  @RequestParam(value = "include_product_tag_obj", required = false) Boolean includeProductTagObj,
    ...
    public ResponseEntity<Pin> pinsSave(@ApiParam(value = "Unique identifier of a Pin.",required=true ) @PathVariable("pin_id") String pinId,
        @ApiParam(value = "" ,required=true )   @RequestBody PinsSaveRequestCreate pinsSaveRequestCreate,
        @ApiParam(value = "Unique identifier of an ad account.")  @RequestParam(value = "ad_account_id", required = false) String adAccountId,
        @RequestHeader(value = "Accept", required = false) String accept) throws Exception {
        // do some magic!
