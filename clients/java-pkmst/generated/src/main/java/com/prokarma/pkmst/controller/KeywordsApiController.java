...
@Autowired
    ...
    public ResponseEntity<KeywordsGet200Response> keywordsGet(@ApiParam(value = "Unique identifier of an ad account.",required=true ) @PathVariable("ad_account_id") String adAccountId,
        ...
        @ApiParam(value = "Keyword <a target=\"_blank\" href=\"/docs/ads/targeting/#Match%20type%20and%20targeting%20level\">match type</a>")  @RequestParam(value = "match_types", required = false) List<MatchType> matchTypes,
