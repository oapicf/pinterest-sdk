...
public interface AdsApi {
    ...
    ResponseEntity<AdArrayResponse> adsCreate(@ApiParam(value = "Unique identifier of an ad account.",required=true ) @PathVariable("ad_account_id") String adAccountId,@ApiParam(value = "List of ads to create, size limit [1, 30]." ,required=true )   @RequestBody List<AdCreateRequest> adCreateRequest, @RequestHeader(value = "Accept", required = false) String accept) throws Exception;
    ...
    ResponseEntity<AdResponse> adsGet(@ApiParam(value = "Unique identifier of an ad account.",required=true ) @PathVariable("ad_account_id") String adAccountId,@ApiParam(value = "Unique identifier of an ad.",required=true ) @PathVariable("ad_id") String adId, @RequestHeader(value = "Accept", required = false) String accept) throws Exception;
    ...
    ResponseEntity<AdArrayResponse> adsUpdate(@ApiParam(value = "Unique identifier of an ad account.",required=true ) @PathVariable("ad_account_id") String adAccountId,@ApiParam(value = "List of ads to update, size limit [1, 30]" ,required=true )   @RequestBody List<AdUpdateRequest> adUpdateRequest, @RequestHeader(value = "Accept", required = false) String accept) throws Exception;
