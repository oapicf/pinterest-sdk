...
public interface KeywordsApi {
    ...
    ResponseEntity<Keywords> keywordsCreate(@ApiParam(value = "Unique identifier of an ad account.",required=true ) @PathVariable("ad_account_id") String adAccountId,@ApiParam(value = "" ,required=true )   @RequestBody KeywordsCreate keywordsCreate, @RequestHeader(value = "Accept", required = false) String accept) throws Exception;
    ...
    ResponseEntity<Keywords> keywordsUpdate(@ApiParam(value = "Unique identifier of an ad account.",required=true ) @PathVariable("ad_account_id") String adAccountId,@ApiParam(value = "" ,required=true )   @RequestBody KeywordsUpdate keywordsUpdate, @RequestHeader(value = "Accept", required = false) String accept) throws Exception;
