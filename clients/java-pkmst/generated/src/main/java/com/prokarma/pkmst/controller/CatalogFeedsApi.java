...
public interface CatalogFeedsApi {
    ...
    ResponseEntity<CatalogsFeed> feedsCreate(@ApiParam(value = "" ,required=true )   @RequestBody CatalogsFeedCreateRequestSchema catalogsFeedCreateRequestSchema,@ApiParam(value = "Unique identifier of an ad account.")  @RequestParam(value = "ad_account_id", required = false) String adAccountId, @RequestHeader(value = "Accept", required = false) String accept) throws Exception;
    ...
    ResponseEntity<CatalogsFeed> feedsDelete(@ApiParam(value = "Unique identifier of a feed.",required=true ) @PathVariable("feed_id") String feedId,@ApiParam(value = "Unique identifier of an ad account.")  @RequestParam(value = "ad_account_id", required = false) String adAccountId, @RequestHeader(value = "Accept", required = false) String accept) throws Exception;
    ...
    ResponseEntity<CatalogsFeed> feedsUpdate(@ApiParam(value = "Unique identifier of a feed.",required=true ) @PathVariable("feed_id") String feedId,@ApiParam(value = "" ,required=true )   @RequestBody CatalogsFeedUpdateRequestSchema catalogsFeedUpdateRequestSchema,@ApiParam(value = "Unique identifier of an ad account.")  @RequestParam(value = "ad_account_id", required = false) String adAccountId, @RequestHeader(value = "Accept", required = false) String accept) throws Exception;
