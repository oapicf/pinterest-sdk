...
@Autowired
    ...
    public ResponseEntity<ProductGroupPromotionResponse> productGroupPromotionsCreate(@ApiParam(value = "Unique identifier of an ad account.",required=true ) @PathVariable("ad_account_id") String adAccountId,
        @ApiParam(value = "List of Product Group Promotions to create, size limit [1, 30]." ,required=true )   @RequestBody ProductGroupPromotionCreateRequest productGroupPromotionCreateRequest,
        @RequestHeader(value = "Accept", required = false) String accept) throws Exception {
        // do some magic!

        if (accept != null && accept.contains("application/json")) {
            return new ResponseEntity<ProductGroupPromotionResponse>(objectMapper.readValue("", ProductGroupPromotionResponse.class), HttpStatus.OK);
        }
        ...
        return new ResponseEntity<ProductGroupPromotionResponse>(HttpStatus.OK);
    }

    public ResponseEntity<ProductGroupPromotionResponse> productGroupPromotionsGet(@ApiParam(value = "Unique identifier of an ad account.",required=true ) @PathVariable("ad_account_id") String adAccountId,
    ...
    public ResponseEntity<ProductGroupPromotionResponse> productGroupPromotionsUpdate(@ApiParam(value = "Unique identifier of an ad account.",required=true ) @PathVariable("ad_account_id") String adAccountId,
        @ApiParam(value = "Parameters to update Product group promotions" ,required=true )   @RequestBody ProductGroupPromotionUpdateRequest productGroupPromotionUpdateRequest,
        @RequestHeader(value = "Accept", required = false) String accept) throws Exception {
        // do some magic!
    ...
    public ResponseEntity<List<ProductGroupAnalyticsResponseInner>> productGroupsAnalytics(@ApiParam(value = "Unique identifier of an ad account.",required=true ) @PathVariable("ad_account_id") String adAccountId,
        ...
        if (accept != null && accept.contains("application/json")) {
            return new ResponseEntity<List<ProductGroupAnalyticsResponseInner>>(objectMapper.readValue("", List.class), HttpStatus.OK);
        }
        ...
        return new ResponseEntity<List<ProductGroupAnalyticsResponseInner>>(HttpStatus.OK);
    }
