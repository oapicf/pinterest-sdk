...
public class LeadForm   {
   ...
   * @return adAccountId
   */
  @ApiModelProperty(readOnly = true, value = "The Ad Account ID that this lead form belongs to.")
   ...
   * @return createdTime
   */
  @ApiModelProperty(readOnly = true, value = "Lead form creation time. Unix timestamp in seconds.")
