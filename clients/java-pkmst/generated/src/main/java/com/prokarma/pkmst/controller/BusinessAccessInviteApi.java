...
public interface BusinessAccessInviteApi {
    ...
    ResponseEntity<CancelInvitesResponse> cancelInvitesOrRequests(@ApiParam(value = "Unique identifier of the requesting business.",required=true ) @PathVariable("business_id") String businessId,@ApiParam(value = "" ,required=true )   @RequestBody CancelInvitesRequest cancelInvitesRequest, @RequestHeader(value = "Accept", required = false) String accept) throws Exception;
    ...
    ResponseEntity<UpdateInvitesResultsResponseArray> createAssetInvites(@ApiParam(value = "Unique identifier of the requesting business.",required=true ) @PathVariable("business_id") String businessId,@ApiParam(value = "" ,required=true )   @RequestBody CreateAssetInvitesRequest createAssetInvitesRequest, @RequestHeader(value = "Accept", required = false) String accept) throws Exception;
