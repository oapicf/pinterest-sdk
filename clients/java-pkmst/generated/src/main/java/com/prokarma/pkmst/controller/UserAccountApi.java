...
public interface UserAccountApi {
    ...
    ResponseEntity<UserWebsiteSummary> verifyWebsiteUpdate(@ApiParam(value = "Verify a website." ,required=true )   @RequestBody UserWebsiteVerifyRequest userWebsiteVerifyRequest, @RequestHeader(value = "Accept", required = false) String accept) throws Exception;
    ...
    ResponseEntity<UserWebsiteVerificationCode> websiteVerificationGet( @RequestHeader(value = "Accept", required = false) String accept) throws Exception;
