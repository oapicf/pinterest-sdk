...
public class ResourceServerConfiguration extends ResourceServerConfigurerAdapter {
    ...
    //configure security for the http methods
        http.
        anonymous().disable()
        .requestMatchers().antMatchers(HttpMethod.GET, "/account_claiming/**")
        .and().authorizeRequests()
        .antMatchers(HttpMethod.GET, "/account_claiming/**").access("hasRole('ADMIN')")
        ...
        http.
        anonymous().disable()
        .requestMatchers().antMatchers(HttpMethod.GET, "/catalog_feeds/**")
        .and().authorizeRequests()
        .antMatchers(HttpMethod.GET, "/catalog_feeds/**").access("hasRole('ADMIN')")
        .and().exceptionHandling().accessDeniedHandler(new OAuth2AccessDeniedHandler());
        http.
        anonymous().disable()
        .requestMatchers().antMatchers(HttpMethod.GET, "/catalog_items/**")
        .and().authorizeRequests()
        .antMatchers(HttpMethod.GET, "/catalog_items/**").access("hasRole('ADMIN')")
        .and().exceptionHandling().accessDeniedHandler(new OAuth2AccessDeniedHandler());
        http.
        anonymous().disable()
        .requestMatchers().antMatchers(HttpMethod.GET, "/catalog_product_groups/**")
        .and().authorizeRequests()
        .antMatchers(HttpMethod.GET, "/catalog_product_groups/**").access("hasRole('ADMIN')")
        .and().exceptionHandling().accessDeniedHandler(new OAuth2AccessDeniedHandler());
        http.
        anonymous().disable()
        .requestMatchers().antMatchers(HttpMethod.GET, "/catalog_regions/**")
        .and().authorizeRequests()
        .antMatchers(HttpMethod.GET, "/catalog_regions/**").access("hasRole('ADMIN')")
        .and().exceptionHandling().accessDeniedHandler(new OAuth2AccessDeniedHandler());
        http.
        anonymous().disable()
        .requestMatchers().antMatchers(HttpMethod.GET, "/catalog_reports/**")
        .and().authorizeRequests()
        .antMatchers(HttpMethod.GET, "/catalog_reports/**").access("hasRole('ADMIN')")
        .and().exceptionHandling().accessDeniedHandler(new OAuth2AccessDeniedHandler());
        http.
        anonymous().disable()
        .requestMatchers().antMatchers(HttpMethod.GET, "/catalog_supplemental/**")
        .and().authorizeRequests()
        .antMatchers(HttpMethod.GET, "/catalog_supplemental/**").access("hasRole('ADMIN')")
        .and().exceptionHandling().accessDeniedHandler(new OAuth2AccessDeniedHandler());
        http.
        anonymous().disable()
        ...
        http.
        anonymous().disable()
        .requestMatchers().antMatchers(HttpMethod.GET, "/conversion_deletion_requests/**")
        .and().authorizeRequests()
        .antMatchers(HttpMethod.GET, "/conversion_deletion_requests/**").access("hasRole('ADMIN')")
        .and().exceptionHandling().accessDeniedHandler(new OAuth2AccessDeniedHandler());
        http.
        anonymous().disable()
        .requestMatchers().antMatchers(HttpMethod.GET, "/conversion_eqs/**")
        .and().authorizeRequests()
        .antMatchers(HttpMethod.GET, "/conversion_eqs/**").access("hasRole('ADMIN')")
        .and().exceptionHandling().accessDeniedHandler(new OAuth2AccessDeniedHandler());
        http.
        anonymous().disable()
        ...
        http.
        anonymous().disable()
        .requestMatchers().antMatchers(HttpMethod.GET, "/conversion_segments/**")
        .and().authorizeRequests()
        .antMatchers(HttpMethod.GET, "/conversion_segments/**").access("hasRole('ADMIN')")
        .and().exceptionHandling().accessDeniedHandler(new OAuth2AccessDeniedHandler());
        http.
        anonymous().disable()
        ...
        http.
        anonymous().disable()
        .requestMatchers().antMatchers(HttpMethod.GET, "/customer_list_uploads/**")
        .and().authorizeRequests()
        .antMatchers(HttpMethod.GET, "/customer_list_uploads/**").access("hasRole('ADMIN')")
        .and().exceptionHandling().accessDeniedHandler(new OAuth2AccessDeniedHandler());
        http.
        anonymous().disable()
        ...
        http.
        anonymous().disable()
        .requestMatchers().antMatchers(HttpMethod.GET, "/customer_segment/**")
        .and().authorizeRequests()
        .antMatchers(HttpMethod.GET, "/customer_segment/**").access("hasRole('ADMIN')")
        .and().exceptionHandling().accessDeniedHandler(new OAuth2AccessDeniedHandler());
        http.
        anonymous().disable()
        ...
        http.
        anonymous().disable()
        .requestMatchers().antMatchers(HttpMethod.GET, "/labels/**")
        .and().authorizeRequests()
        .antMatchers(HttpMethod.GET, "/labels/**").access("hasRole('ADMIN')")
        .and().exceptionHandling().accessDeniedHandler(new OAuth2AccessDeniedHandler());
        http.
        anonymous().disable()
        ...
        http.
        anonymous().disable()
        .requestMatchers().antMatchers(HttpMethod.GET, "/msot_events/**")
        .and().authorizeRequests()
        .antMatchers(HttpMethod.GET, "/msot_events/**").access("hasRole('ADMIN')")
        .and().exceptionHandling().accessDeniedHandler(new OAuth2AccessDeniedHandler());
        http.
        anonymous().disable()
        .requestMatchers().antMatchers(HttpMethod.GET, "/notification/**")
        .and().authorizeRequests()
        .antMatchers(HttpMethod.GET, "/notification/**").access("hasRole('ADMIN')")
        .and().exceptionHandling().accessDeniedHandler(new OAuth2AccessDeniedHandler());
        http.
        anonymous().disable()
        ...
        http.
        anonymous().disable()
        .requestMatchers().antMatchers(HttpMethod.GET, "/opportunities/**")
        .and().authorizeRequests()
        .antMatchers(HttpMethod.GET, "/opportunities/**").access("hasRole('ADMIN')")
        .and().exceptionHandling().accessDeniedHandler(new OAuth2AccessDeniedHandler());
        http.
        anonymous().disable()
        ...
        http.
        anonymous().disable()
        .requestMatchers().antMatchers(HttpMethod.GET, "/overlay_assignment_rules/**")
        .and().authorizeRequests()
        .antMatchers(HttpMethod.GET, "/overlay_assignment_rules/**").access("hasRole('ADMIN')")
        .and().exceptionHandling().accessDeniedHandler(new OAuth2AccessDeniedHandler());
        http.
        anonymous().disable()
        .requestMatchers().antMatchers(HttpMethod.GET, "/overlays/**")
        .and().authorizeRequests()
        .antMatchers(HttpMethod.GET, "/overlays/**").access("hasRole('ADMIN')")
        .and().exceptionHandling().accessDeniedHandler(new OAuth2AccessDeniedHandler());
        http.
        anonymous().disable()
        ...
        http.
        anonymous().disable()
        .requestMatchers().antMatchers(HttpMethod.GET, "/product_tags/**")
        .and().authorizeRequests()
        .antMatchers(HttpMethod.GET, "/product_tags/**").access("hasRole('ADMIN')")
        .and().exceptionHandling().accessDeniedHandler(new OAuth2AccessDeniedHandler());
        http.
        anonymous().disable()
        .requestMatchers().antMatchers(HttpMethod.GET, "/promotions/**")
        .and().authorizeRequests()
        .antMatchers(HttpMethod.GET, "/promotions/**").access("hasRole('ADMIN')")
        .and().exceptionHandling().accessDeniedHandler(new OAuth2AccessDeniedHandler());
        http.
        anonymous().disable()
        .requestMatchers().antMatchers(HttpMethod.GET, "/resellers/**")
        .and().authorizeRequests()
        .antMatchers(HttpMethod.GET, "/resellers/**").access("hasRole('ADMIN')")
        .and().exceptionHandling().accessDeniedHandler(new OAuth2AccessDeniedHandler());
        http.
        anonymous().disable()
        ...
        http.
        anonymous().disable()
        .requestMatchers().antMatchers(HttpMethod.GET, "/trends/**")
        .and().authorizeRequests()
        .antMatchers(HttpMethod.GET, "/trends/**").access("hasRole('ADMIN')")
        .and().exceptionHandling().accessDeniedHandler(new OAuth2AccessDeniedHandler());
        http.
        anonymous().disable()
