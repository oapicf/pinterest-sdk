...
public interface BoardsApi {
    ...
    ResponseEntity<BoardSection> boardSectionsUpdate(@ApiParam(value = "Unique identifier of a board.",required=true ) @PathVariable("board_id") String boardId,@ApiParam(value = "Unique identifier of a board section.",required=true ) @PathVariable("section_id") String sectionId,@ApiParam(value = "" ,required=true )   @RequestBody BoardSectionUpdateWithRequiredBody boardSectionUpdateWithRequiredBody,@ApiParam(value = "Unique identifier of an ad account.")  @RequestParam(value = "ad_account_id", required = false) String adAccountId, @RequestHeader(value = "Accept", required = false) String accept) throws Exception;
    ...
    ResponseEntity<Board> boardsDelete(@ApiParam(value = "",required=true ) @PathVariable("board_id") String boardId,@ApiParam(value = "Unique identifier of an ad account.")  @RequestParam(value = "ad_account_id", required = false) String adAccountId, @RequestHeader(value = "Accept", required = false) String accept) throws Exception;
