...
public class AdAccountsAudience   {
   ...
   */
  @ApiModelProperty(readOnly = true, value = "The company that created this audience.")
   ...
   * @return isNca
   */
  @ApiModelProperty(readOnly = true, value = "Whether the audience derives from a new customer acquisition (expanded matching) customer list. Read-only.")
   ...
   * @return size
   */
  @ApiModelProperty(readOnly = true, value = "Audience size.")
   ...
   * @return status
   */
  @ApiModelProperty(readOnly = true, value = "Audience status. READY, INITIALIZING, TOO_SMALL - Each audience list needs to have at least 100 people with Pinterest accounts before you can start using it.")
   ...
   * @return type
   */
  @ApiModelProperty(readOnly = true, value = "Always \"audience\".")
