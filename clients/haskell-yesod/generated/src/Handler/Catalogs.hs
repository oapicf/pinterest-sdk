...
-- operationId: catalogs/availableFilterValues
getCatalogsAvailableFilterValuesR :: Handler Value
getCatalogsAvailableFilterValuesR = notImplemented
...
postCatalogsR :: Handler Value
postCatalogsR = notImplemented
