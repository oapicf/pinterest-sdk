...
getAdAccountsByTextAdGroupsAudienceSizingR :: Text -- ^ Unique identifier of an ad account.
                                           -> Handler Value
getAdAccountsByTextAdGroupsAudienceSizingR adAccountId = notImplemented
...
getAdAccountsByTextAdGroupsByTextR :: Text -- ^ Unique identifier of an ad account.
                                   -> Text -- ^ Unique identifier of an ad group.
                                   -> Handler Value
getAdAccountsByTextAdGroupsByTextR adAccountId adGroupId = notImplemented
