...
module Handler.CatalogSupplemental where
...
-- operationId: catalogsLocalInventoryItems/post
postCatalogsByTextLocalInventoryItemsQueryR :: Text -- ^ Unique identifier of a catalog.
                                            -> Handler Value
postCatalogsByTextLocalInventoryItemsQueryR catalogId = notImplemented
...
-- operationId: catalogsLocalInventoryItemsBatch/operate
postCatalogsByTextLocalInventoryItemsBatchR :: Text -- ^ Unique identifier of a catalog.
                                            -> Handler Value
postCatalogsByTextLocalInventoryItemsBatchR catalogId = notImplemented
...
-- operationId: catalogsLocalStores/create
postCatalogsByTextLocalStoresR :: Text -- ^ Unique identifier of a catalog.
                               -> Handler Value
postCatalogsByTextLocalStoresR catalogId = notImplemented
...
-- operationId: catalogsLocalStores/delete
deleteCatalogsByTextLocalStoresR :: Text -- ^ Unique identifier of a catalog.
                                 -> Handler Value
deleteCatalogsByTextLocalStoresR catalogId = notImplemented
...
-- operationId: catalogsLocalStores/list
getCatalogsByTextLocalStoresR :: Text -- ^ Unique identifier of a catalog.
                              -> Handler Value
getCatalogsByTextLocalStoresR catalogId = notImplemented
...
-- operationId: catalogsLocalStores/update
patchCatalogsByTextLocalStoresR :: Text -- ^ Unique identifier of a catalog.
                                -> Handler Value
patchCatalogsByTextLocalStoresR catalogId = notImplemented
...
-- operationId: catalogsSupplementalItemsBatch/get
getCatalogsByTextSupplementalItemsBatchByTextR :: Text -- ^ Unique identifier of a catalog.
                                               -> Text -- ^ Unique identifier of an items batch operation.
                                               -> Handler Value
getCatalogsByTextSupplementalItemsBatchByTextR catalogId batchId = notImplemented
