...
- If granularity is HOUR, you can pull data from up to 8 days before the current date in UTC time, with a maximum time range of 3 days.
     ...
     * @param reportingTimezone Specify the timezone to be applied for the reporting. This feature is currently in BETA and is not available to all users. (optional)
     */
    @Resource("/ad_accounts/{ad_account_id}/ad_groups/targeting_analytics") class adGroupsTargetingAnalyticsGet(val adAccountId: kotlin.String, val adGroupIds: kotlin.collections.List<kotlin.String>, val startDate: java.time.LocalDate, val endDate: java.time.LocalDate, val targetingTypes: kotlin.collections.List<AdsAnalyticsAdGroupTargetingType>, val columns: kotlin.collections.List<kotlin.String>, val granularity: Granularity, val clickWindowDays: kotlin.Int? = null, val engagementWindowDays: kotlin.Int? = null, val viewWindowDays: kotlin.Int? = null, val conversionReportTime: kotlin.String? = null, val attributionTypes: kotlin.collections.List<ConversionReportAttributionType>? = null, val reportingTimezone: ReportingTimeZone? = null)
...
&lt;strong&gt;This endpoint might not be available to all apps. &lt;a href&#x3D;&#39;/docs/getting-started/using-beta-and-restricted-features/&#39;&gt;Learn more&lt;/a&gt;.&lt;/strong&gt;
     ...
     */
    @Resource("/ad_accounts/{ad_account_id}/billing_invoices") class billingInvoicesGet(val adAccountId: kotlin.String, val bookmark: kotlin.String? = null, val pageSize: kotlin.Int? = null, val sort: kotlin.String? = null, val order: kotlin.String? = null, val status: kotlin.String? = null, val documentType: kotlin.String? = null, val startDueDate: java.time.LocalDate? = null, val endDueDate: java.time.LocalDate? = null)
...
- By default, the &quot;operation user_account&quot; is the token user_account.
     ...
     */
    @Resource("/boards/{board_id}/pins") class boardsListPins(val boardId: kotlin.String, val bookmark: kotlin.String? = null, val pageSize: kotlin.Int? = null, val creativeTypes: kotlin.collections.List<CreativeType>? = null, val adAccountId: kotlin.String? = null, val pinMetrics: kotlin.Boolean? = null)
...
- An &lt;a href&#x3D;&quot;https://help.pinterest.com/en/business/article/asset-groups&quot;&gt;asset group&lt;/a&gt; is a custom group of assets based on how you’d like to manage your accounts.
     ...
     */
    @Resource("/businesses/{business_id}/assets/{asset_id}/members") class businessAssetMembersGet(val businessId: kotlin.String, val assetId: kotlin.String, val fetchSystemUsers: kotlin.Boolean? = null, val bookmark: kotlin.String? = null, val pageSize: kotlin.Int? = null, val startIndex: kotlin.Int? = null)
...
- Request to be a partner so you can access their assets. This would require specifying the following:
     ...
     */
    @Resource("/business_access/business_hierarchy/{business_hierarchy_id}/brand_accounts/{brand_account_id}") class brandAccountsUpdate(val businessHierarchyId: kotlin.String, val brandAccountId: kotlin.String)
...
Optional: Business Access: Specify an &lt;code&gt;ad_account_id&lt;/code&gt; (obtained via &lt;a href&#x3D;&#39;/docs/api/v5/#operation/ad_accounts/list&#39;&gt;List ad accounts&lt;/a&gt;) to use the owner of that ad_account as the &quot;operation user_account&quot;. In order to do this, the token user_account must have one of the following &lt;a href&#x3D;&quot;https://help.pinterest.com/en/business/article/share-and-manage-access-to-your-ad-accounts&quot;&gt;Business Access&lt;/a&gt; roles on the ad_account: Owner, Admin, Catalogs Manager.
     ...
     * @param bookmark Cursor used to fetch the next page of items (optional)
     */
    @Resource("/catalogs/reports/stats") class reportsStats(val adAccountId: kotlin.String? = null, val pageSize: kotlin.Int? = null, val bookmark: kotlin.String? = null, val parameters: ReportsStatsParametersParameter)
...
&lt;p&gt;&lt;b&gt;Returns:&lt;/b&gt;&lt;/p&gt; &lt;ul style&#x3D;&quot;list-style-type: square;&quot;&gt; &lt;li&gt;&lt;p&gt;A successful call returns an object containing an array of new keyword objects and an empty &amp;quot;errors&amp;quot; object array.&lt;/p&gt;&lt;/li&gt; &lt;li&gt;&lt;p&gt;An unsuccessful call returns an empty keywords array, and, instead, inserts the entire object with nulled/negated properties into the &amp;quot;errors&amp;quot; object array:&lt;/p&gt; &lt;pre class&#x3D;&quot;last literal-block&quot;&gt; { &quot;keywords&quot;: [], &quot;errors&quot;: [ { &quot;data&quot;: { &quot;archived&quot;: null, &quot;match_type&quot;: &quot;EXACT&quot;, &quot;parent_type&quot;: null, &quot;value&quot;: &quot;foobar&quot;, &quot;parent_id&quot;: null, &quot;type&quot;: &quot;keyword&quot;, &quot;id&quot;: null }, &quot;error_messages&quot;: [ &quot;Advertisers and Campaigns only accept excluded targeting attributes.&quot; ] } } &lt;/pre&gt;&lt;/li&gt; &lt;/ul&gt;
     ...
     * @param bookmark Cursor used to fetch the next page of items (optional)
     */
    @Resource("/ad_accounts/{ad_account_id}/keywords") class keywordsGet(val adAccountId: kotlin.String, val campaignId: kotlin.String? = null, val adGroupId: kotlin.String? = null, val adGroupIds: kotlin.collections.List<kotlin.String>? = null, val matchTypes: kotlin.collections.List<MatchType>? = null, val pageSize: kotlin.Int? = null, val bookmark: kotlin.String? = null)
...
&lt;/p&gt;
     ...
     * @param entityStatuses Label entity status (optional, default to arrayListOf(EntityStatuses.ACTIVE))
     * @param labelTypes Label type. (optional, default to arrayListOf(LabelTypes.BRAND,LabelTypes.CUSTOM))
     * @param pageSize Maximum number of items to include in a single page of the response. See documentation on &lt;a href&#x3D;&#39;/docs/reference/pagination/&#39;&gt;Pagination&lt;/a&gt; for more information. (optional, default to 25)
     * @param bookmark Cursor used to fetch the next page of items (optional)
     */
    @Resource("/ad_accounts/{ad_account_id}/labels") class labelsList(val adAccountId: kotlin.String, val campaignIds: kotlin.collections.List<kotlin.String>? = null, val labelIds: kotlin.collections.List<kotlin.String>? = null, val entityStatuses: kotlin.collections.List<kotlin.String>? = null, val labelTypes: kotlin.collections.List<kotlin.String>? = null, val pageSize: kotlin.Int? = null, val bookmark: kotlin.String? = null)
...
**[Learn more](/docs/api-features/creating-boards-and-pins/#creating-image-pins)** about image Pin creation.
  ...
  - For Pins on secret boards: Owner, Admin.
     ...
     * @param pageSize Maximum number of items to include in a single page. See documentation on [Pagination](/docs/reference/pagination/) for more information. (optional, default to 25)
     */
    @Resource("/pins") class pinsList(val pinFilter: kotlin.String? = null, val pinMetrics: kotlin.Boolean? = null, val includeProtectedPins: kotlin.Boolean? = null, val pinType: kotlin.String? = null, val creativeTypes: kotlin.collections.List<CreativeType>? = null, val adAccountId: kotlin.String? = null, val bookmark: kotlin.String? = null, val pageSize: kotlin.Int? = null)
...
- If granularity is HOUR, you can pull data from up to 8 days before the current date in UTC time, with a maximum time range of 3 days.
     ...
     */
    @Resource("/ad_accounts/{ad_account_id}/promotions/{promotion_id}") class promotionsDelete(val adAccountId: kotlin.String, val promotionId: kotlin.String)
     ...
     * @param promotionId Unique identifier of a promotion 
     */
    @Resource("/ad_accounts/{ad_account_id}/promotions/{promotion_id}") class promotionsGet(val adAccountId: kotlin.String, val promotionId: kotlin.String)
     ...
     * @param bookmark Cursor used to fetch the next page of items (optional)
     */
    @Resource("/ad_accounts/{ad_account_id}/promotions") class promotionsList(val adAccountId: kotlin.String, val pageSize: kotlin.Int? = null, val order: kotlin.String? = null, val bookmark: kotlin.String? = null)
