...
import org.openapitools.server.models.ConversionProductReportRequest
...
fun Route.AdAccountsApi() {
    ...
    authenticate("pinterest_oauth2") {
    post<Paths.analyticsCreateConversionProductReport> {
    ...
    authenticate("pinterest_oauth2") {
    get<Paths.analyticsGetConversionProductReport> {
