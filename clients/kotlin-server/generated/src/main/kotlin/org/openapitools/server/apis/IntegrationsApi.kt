...
import org.openapitools.server.models.IntegrationLogsInvalidLogResponse
import org.openapitools.server.models.IntegrationLogsRequestCreate
...
import org.openapitools.server.models.IntegrationMetadataCreate
import org.openapitools.server.models.IntegrationMetadataUpdate
...
fun Route.IntegrationsApi() {
    ...
    delete<Paths.integrationsCommerceDel> { integrationsCommerceDel ->
    ...
    authenticate("pinterest_oauth2") {
    get<Paths.integrationsCommerceGet> { integrationsCommerceGet ->
    ...
    authenticate("pinterest_oauth2") {
    patch<Paths.integrationsCommercePatch> { integrationsCommercePatch ->
    ...
    authenticate("pinterest_oauth2") {
    post<Paths.integrationsCommercePost> { integrationsCommercePost ->
    ...
    authenticate("pinterest_oauth2") {
    get<Paths.integrationsGetById> { integrationsGetById ->
    ...
    authenticate("pinterest_oauth2") {
    get<Paths.integrationsGetList> { integrationsGetList ->
    ...
    authenticate("pinterest_oauth2") {
    post<Paths.integrationsLogsPost> { integrationsLogsPost ->
