...
,@ApiParam(value = "If set, filters the results to top trends which include at least one of the specified keywords.<br /> If unset, no keyword filtering logic is applied.") @QueryParam("include_keywords") List<@Size(min = 1, max = 100)String> includeKeywords
...
,@ApiParam(value = "<a href=\"/docs/getting-started/using-beta-and-restricted-features/\" target=\"blank\" target=\"blank\">Closed beta</a> Including predicted weekly search volume data for the next 90 days. By default (`false`), the response will not include predicted data.", defaultValue="false") @DefaultValue("false") @QueryParam("include_prediction") Boolean includePrediction
,@ApiParam(value = "<a href=\"/docs/getting-started/using-beta-and-restricted-features/\" target=\"blank\" target=\"blank\">Closed beta</a> Including the age and gender distribution for each keyword. By default (`false`), the response will not include demographics data.", defaultValue="false") @DefaultValue("false") @QueryParam("include_demographics") Boolean includeDemographics
    ...
    throws NotFoundException {
        return delegate.trendingKeywordsList(region,trendType,interests,genders,ages,includeKeywords,normalizeAgainstGroup,limit,includePrediction,includeDemographics);
    }
    @GET
