...
public class BusinessesApi  {
   private final BusinessesApiService delegate = BusinessesApiServiceFactory.getBusinessesApi();
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 200, message = "Unexpected error", response = CreateAssetAccessRequestResponse.class) })
...
,@ApiParam(value = "" ,required=true) CreateAssetAccessRequestBody createAssetAccessRequestBody
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 400, message = "Invalid parameters.", response = CreateAssetGroupResponse.class),
        
        @io.swagger.annotations.ApiResponse(code = 200, message = "Unexpected error", response = CreateAssetGroupResponse.class) })
...
,@ApiParam(value = "" ,required=true) CreateAssetGroupBody createAssetGroupBody
)
    throws NotFoundException {
        return delegate.assetGroupCreate(businessId,createAssetGroupBody);
    }
    @DELETE
    @Path("/{business_id}/asset_groups")
    @Consumes({ "application/json" })
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 400, message = "Invalid parameters.", response = DeleteAssetGroupResponse.class),
        
        @io.swagger.annotations.ApiResponse(code = 200, message = "Unexpected error", response = DeleteAssetGroupResponse.class) })
...
,@ApiParam(value = "" ,required=true) DeleteAssetGroupBody deleteAssetGroupBody
)
    throws NotFoundException {
        return delegate.assetGroupDelete(businessId,deleteAssetGroupBody);
    }
    @PATCH
    @Path("/{business_id}/asset_groups")
    @Consumes({ "application/json" })
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 400, message = "Invalid parameters.", response = UpdateAssetGroupResponse.class),
        
        @io.swagger.annotations.ApiResponse(code = 200, message = "Unexpected error", response = UpdateAssetGroupResponse.class) })
...
,@ApiParam(value = "" ,required=true) UpdateAssetGroupBody updateAssetGroupBody
)
    throws NotFoundException {
        return delegate.assetGroupUpdate(businessId,updateAssetGroupBody);
    }
    @GET
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 400, message = "Invalid business audiences shared accounts parameters.", response = AdAccountsAudiencesSharedAccountsList200Response.class),
...
,@ApiParam(value = "Cursor used to fetch the next page of items") @QueryParam("bookmark") String bookmark
    ...
    throws NotFoundException {
        return delegate.businessAccountAudiencesSharedAccountsList(businessId,audienceId,accountType,pageSize,bookmark);
    }
    @GET
...
,@ApiParam(value = "An index to start fetching the results from. Only the results starting from this index will be returned.", defaultValue="0") @DefaultValue("0") @QueryParam("start_index") Integer startIndex
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 200, message = "Unexpected error", response = BusinessAssetPartnersGet200Response.class) })
...
,@ApiParam(value = "Maximum number of items to include in a single page of the response. See documentation on <a href='/docs/reference/pagination/'>Pagination</a> for more information.", defaultValue="25") @DefaultValue("25") @QueryParam("page_size") Integer pageSize
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 200, message = "Unexpected error", response = BusinessAssetsGet200Response.class) })
...
,@ApiParam(value = "Maximum number of items to include in a single page of the response. See documentation on <a href='/docs/reference/pagination/'>Pagination</a> for more information.", defaultValue="25") @DefaultValue("25") @QueryParam("page_size") Integer pageSize
    ...
    throws NotFoundException {
        return delegate.businessMemberAssetsGet(businessId,memberId,assetType,startIndex,bookmark,pageSize);
    }
    @DELETE
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 200, message = "Unexpected error", response = DeleteMemberAccessResultsResponseArray.class) })
...
,@ApiParam(value = "List member assset permissions to delete." ,required=true) BusinessMembersAssetAccessDeleteRequest businessMembersAssetAccessDeleteRequest
)
    throws NotFoundException {
        return delegate.businessMembersAssetAccessDelete(businessId,businessMembersAssetAccessDeleteRequest);
    }
    @PATCH
    @Path("/{business_id}/members/assets/access")
    @Consumes({ "application/json" })
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 200, message = "Unexpected error", response = UpdateMemberAssetsResultsResponseArray.class) })
...
,@ApiParam(value = "List of member asset permissions to create or update." ,required=true) UpdateMemberAssetAccessBody updateMemberAssetAccessBody
)
    throws NotFoundException {
...
,@ApiParam(value = "Cursor used to fetch the next page of items") @QueryParam("bookmark") String bookmark
    ...
    throws NotFoundException {
        return delegate.businessPartnerAssetAccessGet(businessId,partnerId,partnerType,assetType,startIndex,pageSize,bookmark);
    }
    @DELETE
...
,@ApiParam(value = "A list with invite ids" ,required=true) CancelInvitesBody cancelInvitesBody
    ...
    throws NotFoundException {
        return delegate.cancelInvitesOrRequests(businessId,cancelInvitesBody);
    }
    @POST
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 200, message = "Unexpected error", response = UpdateInvitesResultsResponseArray.class) })
...
,@ApiParam(value = "A list of invites/requests together with the asset permissions to be assigned to the invite/request. " ,required=true) CreateAssetInvitesRequest createAssetInvitesRequest
)
    throws NotFoundException {
...
,@ApiParam(value = "An object with the properties: invite_type, partners, members, business_role" ,required=true) CreateMembershipOrPartnershipInvitesBody createMembershipOrPartnershipInvitesBody
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 200, message = "Unexpected error", response = DeletedMembersResponse.class) })
...
,@ApiParam(value = "List of members with role to delete." ,required=true) MembersToDeleteBody membersToDeleteBody
)
    throws NotFoundException {
        return delegate.deleteBusinessMembership(businessId,membersToDeleteBody);
    }
    @DELETE
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 404, message = "A supplied partner id doesn't exist", response = DeletePartnersResponse.class),
        
        @io.swagger.annotations.ApiResponse(code = 200, message = "Unexpected error", response = DeletePartnersResponse.class) })
...
,@ApiParam(value = "An object containing a \"partner_ids\" property composed of a list of partner IDs and a \"partners_type\" property specifying the type of partners to delete. " ,required=true) DeletePartnersRequest deletePartnersRequest
)
    throws NotFoundException {
        return delegate.deleteBusinessPartners(businessId,deletePartnersRequest);
    }
    @DELETE
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 200, message = "Unexpected error", response = DeletePartnerAssetsResultsResponseArray.class) })
...
,@ApiParam(value = "" ,required=true) DeletePartnerAssetAccessBody deletePartnerAssetAccessBody
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 200, message = "Unexpected error", response = GetBusinessEmployers200Response.class) })
    public Response getBusinessEmployers(@ApiParam(value = "Maximum number of items to include in a single page of the response. See documentation on <a href='/docs/reference/pagination/'>Pagination</a> for more information.", defaultValue="25") @DefaultValue("25") @QueryParam("page_size") Integer pageSize
,@ApiParam(value = "Cursor used to fetch the next page of items") @QueryParam("bookmark") String bookmark
)
    throws NotFoundException {
        return delegate.getBusinessEmployers(pageSize,bookmark);
    }
    @GET
    @Path("/{business_id}/members")
...
,@ApiParam(value = "Maximum number of items to include in a single page of the response. See documentation on <a href='/docs/reference/pagination/'>Pagination</a> for more information.", defaultValue="25") @DefaultValue("25") @QueryParam("page_size") Integer pageSize
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 200, message = "Unexpected error", response = GetBusinessPartners200Response.class) })
...
,@ApiParam(value = "Cursor used to fetch the next page of items") @QueryParam("bookmark") String bookmark
    ...
    throws NotFoundException {
        return delegate.getBusinessPartners(businessId,assetsSummary,partnerType,partnerIds,startIndex,pageSize,bookmark);
    }
    @GET
    @Path("/{business_id}/invites")
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 200, message = "Unexpected error", response = GetInvites200Response.class) })
...
,@ApiParam(value = "A list of invite statuses to filter invites by. Only invites whose status is in the provided statuses will be returned.", allowableValues="PENDING, EXPIRED") @QueryParam("invite_status") List<String> inviteStatus
...
,@ApiParam(value = "Maximum number of items to include in a single page of the response. See documentation on <a href='/docs/reference/pagination/'>Pagination</a> for more information.", defaultValue="25") @DefaultValue("25") @QueryParam("page_size") Integer pageSize
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 200, message = "Unexpected error", response = RespondToInvitesResponseArray.class) })
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 400, message = "Invalid parameters.", response = AudiencesList200Response.class),
...
,@ApiParam(value = "Maximum number of items to include in a single page of the response. See documentation on <a href='/docs/reference/pagination/'>Pagination</a> for more information.", defaultValue="25") @DefaultValue("25") @QueryParam("page_size") Integer pageSize
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 200, message = "Unexpected error", response = UpdateMemberResultsResponseArray.class) })
...
,@ApiParam(value = "List of objects with the member id and the business_role." ,required=true) List<@Valid UpdateMemberBusinessRoleBody> updateMemberBusinessRoleBody
)
    throws NotFoundException {
        return delegate.updateBusinessMemberships(businessId,updateMemberBusinessRoleBody);
    }
    @PATCH
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 400, message = "Invalid parameters.", response = SharedAudienceResponse.class),
...
,@ApiParam(value = "" ,required=true) SharedAudience sharedAudience
    ...
    throws NotFoundException {
        return delegate.updateBusinessToAdAccountSharedAudience(businessId,sharedAudience);
    }
    @PATCH
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 400, message = "Invalid parameters.", response = BusinessSharedAudienceResponse.class),
...
,@ApiParam(value = "" ,required=true) BusinessSharedAudience businessSharedAudience
    ...
    throws NotFoundException {
        return delegate.updateBusinessToBusinessSharedAudience(businessId,businessSharedAudience);
    }
    @PATCH
    @Path("/{business_id}/partners/assets")
    @Consumes({ "application/json" })
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 200, message = "Unexpected error", response = UpdatePartnerAssetsResultsResponseArray.class) })
...
,@ApiParam(value = "A list of assets and permissions to assign to your partners." ,required=true) UpdatePartnerAssetAccessBody updatePartnerAssetAccessBody
)
    throws NotFoundException {
