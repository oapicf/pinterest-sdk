...
,@ApiParam(value = "Pin metric types to get data for, default is all.",required=true) @QueryParam("metric_types") List<PinsAnalyticsMetricTypesParameterInner> metricTypes
