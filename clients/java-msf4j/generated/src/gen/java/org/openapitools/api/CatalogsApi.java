...
public class CatalogsApi  {
   private final CatalogsApiService delegate = CatalogsApiServiceFactory.getCatalogsApi();
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 400, message = "Invalid parameters.", response = CatalogsAvailableFilterValues.class),
        
        @io.swagger.annotations.ApiResponse(code = 401, message = "Unauthorized access.", response = CatalogsAvailableFilterValues.class),
        
        @io.swagger.annotations.ApiResponse(code = 403, message = "Forbidden. Account not authorized to access available filter values.", response = CatalogsAvailableFilterValues.class),
        
        @io.swagger.annotations.ApiResponse(code = 404, message = "Data feed not found.", response = CatalogsAvailableFilterValues.class),
        
        @io.swagger.annotations.ApiResponse(code = 409, message = "Can't access this feature without an existing catalog.", response = CatalogsAvailableFilterValues.class),
        
        @io.swagger.annotations.ApiResponse(code = 200, message = "Unexpected error.", response = CatalogsAvailableFilterValues.class) })
...
,@ApiParam(value = "Unique identifier of an ad account.") @QueryParam("ad_account_id") String adAccountId
    ...
    public Response reportsStats(@ApiParam(value = "Contains the parameters for report identification.",required=true) @QueryParam("parameters") ReportsStatsParametersParameter parameters
,@ApiParam(value = "Unique identifier of an ad account.") @QueryParam("ad_account_id") String adAccountId
,@ApiParam(value = "Maximum number of items to include in a single page of the response. See documentation on <a href='/docs/reference/pagination/'>Pagination</a> for more information.", defaultValue="25") @DefaultValue("25") @QueryParam("page_size") Integer pageSize
,@ApiParam(value = "Cursor used to fetch the next page of items") @QueryParam("bookmark") String bookmark
)
