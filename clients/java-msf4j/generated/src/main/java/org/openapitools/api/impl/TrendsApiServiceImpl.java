...
, Boolean includeDemographics
    ...
    @Override
    public Response trendsFeaturedTopicsList(ProductCategoryRegion region
, InterestsEnum interest
    ...
    @Override
    public Response trendsProductCategoriesDetailsList(List<ProductCategoryEnum> productCategories
...
, ProductCategoriesEngagementType engagementType
    ...
    @Override
    public Response trendsProductCategoriesTrendingList(ProductCategoryRegion region
