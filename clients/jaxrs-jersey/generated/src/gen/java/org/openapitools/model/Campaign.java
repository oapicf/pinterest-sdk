 ...
 */
@JsonPropertyOrder({
  Campaign.JSON_PROPERTY_AD_ACCOUNT_ID,
  Campaign.JSON_PROPERTY_BID_OPTIONS,
  Campaign.JSON_PROPERTY_CREATED_TIME,
  Campaign.JSON_PROPERTY_DAILY_SPEND_CAP,
  Campaign.JSON_PROPERTY_DEFAULT_AD_GROUP_BUDGET_IN_MICRO_CURRENCY,
  Campaign.JSON_PROPERTY_END_TIME,
  Campaign.JSON_PROPERTY_ID,
  Campaign.JSON_PROPERTY_INTENDED_PROMOTION_TYPE,
  Campaign.JSON_PROPERTY_IS_AUTOMATED_CAMPAIGN,
  Campaign.JSON_PROPERTY_IS_CAMPAIGN_BUDGET_OPTIMIZATION,
  Campaign.JSON_PROPERTY_IS_CARTING,
  Campaign.JSON_PROPERTY_IS_FLEXIBLE_DAILY_BUDGETS,
  Campaign.JSON_PROPERTY_IS_LTV_OPTIMIZED,
  Campaign.JSON_PROPERTY_IS_PERFORMANCE_PLUS,
  Campaign.JSON_PROPERTY_IS_TOP_OF_SEARCH,
  Campaign.JSON_PROPERTY_LIFETIME_SPEND_CAP,
  Campaign.JSON_PROPERTY_NAME,
  Campaign.JSON_PROPERTY_OBJECTIVE_TYPE,
  Campaign.JSON_PROPERTY_ORDER_LINE_ID,
  Campaign.JSON_PROPERTY_PERFORMANCE_PLUS_CAMPAIGN_SETTINGS,
  Campaign.JSON_PROPERTY_START_TIME,
  Campaign.JSON_PROPERTY_STATUS,
  Campaign.JSON_PROPERTY_SUMMARY_STATUS,
  Campaign.JSON_PROPERTY_TRACKING_URLS,
  Campaign.JSON_PROPERTY_TYPE,
  Campaign.JSON_PROPERTY_UPDATED_TIME
})
