...
public abstract class AdAccountsApiService {
    ...
    public abstract Response adPinsAnalytics( @Pattern(regexp="^\\d+$") @Size(max=18)String adAccountId, @NotNull  @Pattern(regexp="^\\d+$") @Size(max=18)String campaignId, @NotNull  @Size(min=1,max=100)List<@Pattern(regexp = "^\\d+$")String> pinIds, @NotNull Date startDate, @NotNull Date endDate, @NotNull List<String> columns, @NotNull Granularity granularity,Integer clickWindowDays,Integer engagementWindowDays,Integer viewWindowDays,String conversionReportTime,SecurityContext securityContext) throws NotFoundException;
    ...
    public abstract Response analyticsCreateConversionProductReport( @Pattern(regexp="^\\d+$") @Size(max=18)String adAccountId,ConversionProductReportRequest conversionProductReportRequest,SecurityContext securityContext) throws NotFoundException;
    ...
    public abstract Response campaignsList( @Pattern(regexp="^\\d+$") @Size(max=18)String adAccountId, @Size(min=1,max=250)List<@Pattern(regexp = "^\\d+$")@Size(max = 18)String> campaignIds,List<String> entityStatuses, @Min(1) @Max(250)Integer pageSize,String order,String bookmark,SecurityContext securityContext) throws NotFoundException;
    ...
    public abstract Response customerListUploadsGet( @Pattern(regexp="^\\d+$") @Size(max=18)String adAccountId, @Pattern(regexp="^\\d+$") @Size(max=18)String customerListId, @Pattern(regexp="^\\d+$") @Size(max=18)String customerListUploadId,SecurityContext securityContext) throws NotFoundException;
    public abstract Response customerListUploadsRun( @Pattern(regexp="^\\d+$") @Size(max=18)String adAccountId, @Pattern(regexp="^\\d+$") @Size(max=18)String customerListId, @Pattern(regexp="^\\d+$") @Size(max=18)String customerListUploadId,SecurityContext securityContext) throws NotFoundException;
    ...
    public abstract Response msotEventsCreate( @Pattern(regexp="^\\d+$") @Size(max=18)String adAccountId,ConversionMSOTEvents conversionMSOTEvents,SecurityContext securityContext) throws NotFoundException;
    ...
    public abstract Response productGroupPromotionsList( @Pattern(regexp="^\\d+$") @Size(max=18)String adAccountId, @Size(min=1,max=250)List<@Pattern(regexp = "^\\d+$")String> productGroupPromotionIds,List<String> entityStatuses, @Pattern(regexp="^\\d+$") @Size(max=18)String adGroupId, @Min(1) @Max(250)Integer pageSize,String order,String bookmark,SecurityContext securityContext) throws NotFoundException;
    ...
    public abstract Response productGroupsAnalytics( @Pattern(regexp="^\\d+$") @Size(max=18)String adAccountId, @NotNull Date startDate, @NotNull Date endDate, @NotNull  @Size(min=1,max=250)List<@Pattern(regexp = "^\\d+$")String> productGroupIds, @NotNull List<String> columns, @NotNull Granularity granularity,Integer clickWindowDays,Integer engagementWindowDays,Integer viewWindowDays,String conversionReportTime,ReportingTimeZone reportingTimezone,SecurityContext securityContext) throws NotFoundException;
    public abstract Response promotionsCreate( @Pattern(regexp="^\\d+$") @Size(max=18)String adAccountId,List<@Valid PromotionCreateRequest> promotionCreateRequest,SecurityContext securityContext) throws NotFoundException;
    public abstract Response promotionsDelete( @Pattern(regexp="^\\d+$") @Size(max=18)String adAccountId, @Pattern(regexp="^\\d+$") @Size(max=18)String promotionId,SecurityContext securityContext) throws NotFoundException;
    public abstract Response promotionsGet( @Pattern(regexp="^\\d+$") @Size(max=18)String adAccountId, @Pattern(regexp="^\\d+$") @Size(max=18)String promotionId,SecurityContext securityContext) throws NotFoundException;
    public abstract Response promotionsList( @Pattern(regexp="^\\d+$") @Size(max=18)String adAccountId, @Min(1) @Max(250)Integer pageSize,String order,String bookmark,SecurityContext securityContext) throws NotFoundException;
    public abstract Response promotionsUpdate( @Pattern(regexp="^\\d+$") @Size(max=18)String adAccountId,List<@Valid PromotionUpdateRequest> promotionUpdateRequest,SecurityContext securityContext) throws NotFoundException;
