...
public class AdAccountsApi  {
   ...
   public AdAccountsApi(@Context ServletConfig servletContext) {
    ...
    public Response adGroupsCreate(@ApiParam(value = "Unique identifier of an ad account.", required = true) @PathParam("ad_account_id") @NotNull  @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId,@ApiParam(value = "List of ad groups to create, size limit [1, 30].", required = true) @NotNull @Valid  @Size(min=1,max=30) List<@Valid AdGroupCreateRequest> adGroupCreateRequest,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response adGroupsUpdate(@ApiParam(value = "Unique identifier of an ad account.", required = true) @PathParam("ad_account_id") @NotNull  @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId,@ApiParam(value = "List of ad groups to update, size limit [1, 30].", required = true) @NotNull @Valid  @Size(min=1,max=30) List<@Valid AdGroupUpdateRequest> adGroupUpdateRequest,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response adsCreate(@ApiParam(value = "Unique identifier of an ad account.", required = true) @PathParam("ad_account_id") @NotNull  @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId,@ApiParam(value = "List of ads to create, size limit [1, 30].", required = true) @NotNull @Valid  @Size(min=1,max=30) List<@Valid AdCreateRequest> adCreateRequest,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response audienceInsightsGet(@ApiParam(value = "Unique identifier of an ad account.", required = true) @PathParam("ad_account_id") @NotNull  @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId,@ApiParam(value = "Type of audience insights.", required = true, allowableValues="YOUR_TOTAL_AUDIENCE, YOUR_ENGAGED_AUDIENCE, PINTEREST_TOTAL_AUDIENCE", defaultValue = "YOUR_TOTAL_AUDIENCE") @DefaultValue("YOUR_TOTAL_AUDIENCE") @QueryParam("audience_insight_type") @NotNull  AudienceInsightType audienceInsightType,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response audiencesList(@ApiParam(value = "Unique identifier of an ad account.", required = true) @PathParam("ad_account_id") @NotNull  @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId,@ApiParam(value = "Cursor used to fetch the next page of items") @QueryParam("bookmark")  String bookmark,@ApiParam(value = "The order in which to sort the items returned: “ASCENDING” or “DESCENDING” by ID. For received audiences, it is sorted by sharing event time. Note that higher-value IDs are associated with more-recently added items.", allowableValues="ASCENDING, DESCENDING") @QueryParam("order")  String order,@ApiParam(value = "Maximum number of items to include in a single page of the response. See documentation on <a href='/docs/reference/pagination/'>Pagination</a> for more information.", defaultValue = "25") @DefaultValue("25") @QueryParam("page_size")  @Min(1) @Max(250) Integer pageSize,@ApiParam(value = "Filter audiences by ownership type.", allowableValues="OWNED, RECEIVED", defaultValue = "OWNED") @DefaultValue("OWNED") @QueryParam("ownership_type")  String ownershipType,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response billingProfilesGet(@ApiParam(value = "Unique identifier of an ad account.", required = true) @PathParam("ad_account_id") @NotNull  @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId,@ApiParam(value = "Return active billing profiles, if false return all billing profiles.", required = true) @QueryParam("is_active") @NotNull  Boolean isActive,@ApiParam(value = "Cursor used to fetch the next page of items") @QueryParam("bookmark")  String bookmark,@ApiParam(value = "Maximum number of items to include in a single page of the response. See documentation on <a href='/docs/reference/pagination/'>Pagination</a> for more information.", defaultValue = "25") @DefaultValue("25") @QueryParam("page_size")  @Min(1) @Max(250) Integer pageSize,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response leadFormsCreate(@ApiParam(value = "Unique identifier of an ad account.", required = true) @PathParam("ad_account_id") @NotNull  @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId,@ApiParam(value = "List of lead forms to create, size limit [1, 30].", required = true) @NotNull @Valid  @Size(min=1,max=30) List<@Valid LeadFormCreateRequest> leadFormCreateRequest,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response leadFormsUpdate(@ApiParam(value = "Unique identifier of an ad account.", required = true) @PathParam("ad_account_id") @NotNull  @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId,@ApiParam(value = "List of lead forms to update, size limit [1, 30].", required = true) @NotNull @Valid  @Size(min=1,max=30) List<@Valid LeadFormUpdateRequest> leadFormUpdateRequest,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response leadsExportCreate(@ApiParam(value = "Unique identifier of an ad account.", required = true) @PathParam("ad_account_id") @NotNull  @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId,@ApiParam(value = "", required = true) @NotNull @Valid  LeadsExportCreateRequest leadsExportCreateRequest,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response ssioOrderLinesGetByAdAccount(@ApiParam(value = "Unique identifier of an ad account.", required = true) @PathParam("ad_account_id") @NotNull  @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId,@ApiParam(value = "Cursor used to fetch the next page of items") @QueryParam("bookmark")  String bookmark,@ApiParam(value = "Maximum number of items to include in a single page of the response. See documentation on <a href='/docs/reference/pagination/'>Pagination</a> for more information.", defaultValue = "25") @DefaultValue("25") @QueryParam("page_size")  @Min(1) @Max(250) Integer pageSize,@ApiParam(value = "The pin order id associated with the ssio insertino order") @QueryParam("pin_order_id")  String pinOrderId,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response targetingTemplateCreate(@ApiParam(value = "Unique identifier of an ad account.", required = true) @PathParam("ad_account_id") @NotNull  @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId,@ApiParam(value = "targeting template creation entity", required = true) @NotNull @Valid  TargetingTemplateCreate targetingTemplateCreate,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response targetingTemplateUpdate(@ApiParam(value = "Unique identifier of an ad account.", required = true) @PathParam("ad_account_id") @NotNull  @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId,@ApiParam(value = "Operation type and targeting template ID", required = true) @NotNull @Valid  TargetingTemplateUpdateRequest targetingTemplateUpdateRequest,@Context SecurityContext securityContext)
    throws NotFoundException {
