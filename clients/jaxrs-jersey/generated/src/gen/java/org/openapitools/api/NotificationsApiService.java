...
public abstract class NotificationsApiService {
    public abstract Response notificationPost(NotificationPostRequest notificationPostRequest,SecurityContext securityContext) throws NotFoundException;
}
