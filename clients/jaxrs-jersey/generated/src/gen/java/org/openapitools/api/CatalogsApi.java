   ...
   public CatalogsApi(@Context ServletConfig servletContext) {
      ...
      if (servletContext != null) {
         ...
         if (implClass != null && !"".equals(implClass.trim())) {
            try {
               delegate = (CatalogsApiService) Class.forName(implClass).getDeclaredConstructor().newInstance();
            } catch (Exception e) {
    ...
    public Response catalogsCreate(@ApiParam(value = "", required = true) @NotNull @Valid  CatalogCreate catalogCreate,@ApiParam(value = "Unique identifier of an ad account.") @QueryParam("ad_account_id")  @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId,@Context SecurityContext securityContext)
    throws NotFoundException {
        return delegate.catalogsCreate(catalogCreate, adAccountId, securityContext);
    }
    @javax.ws.rs.GET
    ...
    public Response catalogsLocalInventoryItemsBatchOperate(@ApiParam(value = "Unique identifier of a catalog.", required = true) @PathParam("catalog_id") @NotNull  @Pattern(regexp="^\\d+$") @Size(max=19) String catalogId,@ApiParam(value = "", required = true) @NotNull @Valid  LocalInventoryItemsBatchCreate localInventoryItemsBatchCreate,@ApiParam(value = "Unique identifier of an ad account.") @QueryParam("ad_account_id")  @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId,@Context SecurityContext securityContext)
    throws NotFoundException {
        return delegate.catalogsLocalInventoryItemsBatchOperate(catalogId, localInventoryItemsBatchCreate, adAccountId, securityContext);
    }
    @javax.ws.rs.POST
    ...
    public Response catalogsLocalInventoryItemsPost(@ApiParam(value = "Unique identifier of a catalog.", required = true) @PathParam("catalog_id") @NotNull  @Pattern(regexp="^\\d+$") @Size(max=19) String catalogId,@ApiParam(value = "", required = true) @NotNull @Valid  LocalInventoryItemsGetCreate localInventoryItemsGetCreate,@ApiParam(value = "Unique identifier of an ad account.") @QueryParam("ad_account_id")  @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId,@Context SecurityContext securityContext)
    throws NotFoundException {
        return delegate.catalogsLocalInventoryItemsPost(catalogId, localInventoryItemsGetCreate, adAccountId, securityContext);
    }
    @javax.ws.rs.POST
    ...
    public Response catalogsLocalStoresCreate(@ApiParam(value = "Unique identifier of a catalog.", required = true) @PathParam("catalog_id") @NotNull  @Pattern(regexp="^\\d+$") @Size(max=19) String catalogId,@ApiParam(value = "", required = true) @NotNull @Valid  List<@Valid LocalStoreCreate> localStoreCreate,@ApiParam(value = "Unique identifier of an ad account.") @QueryParam("ad_account_id")  @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId,@Context SecurityContext securityContext)
    throws NotFoundException {
        return delegate.catalogsLocalStoresCreate(catalogId, localStoreCreate, adAccountId, securityContext);
    }
    @javax.ws.rs.DELETE
    @Path("/{catalog_id}/local_stores")
    ...
    public Response catalogsLocalStoresDelete(@ApiParam(value = "Unique identifier of a catalog.", required = true) @PathParam("catalog_id") @NotNull  @Pattern(regexp="^\\d+$") @Size(max=19) String catalogId,@ApiParam(value = "List of local store IDs to filter by.", required = true) @QueryParam("ids") @NotNull  List<@Pattern(regexp = "^\\d+$")String> ids,@ApiParam(value = "Unique identifier of an ad account.") @QueryParam("ad_account_id")  @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId,@Context SecurityContext securityContext)
    throws NotFoundException {
        return delegate.catalogsLocalStoresDelete(catalogId, ids, adAccountId, securityContext);
    }
    @javax.ws.rs.GET
    @Path("/{catalog_id}/local_stores")
    ...
    public Response catalogsLocalStoresList(@ApiParam(value = "Unique identifier of a catalog.", required = true) @PathParam("catalog_id") @NotNull  @Pattern(regexp="^\\d+$") @Size(max=19) String catalogId,@ApiParam(value = "List of local store IDs to filter by.") @QueryParam("ids")  List<@Pattern(regexp = "^\\d+$")String> ids,@ApiParam(value = "Unique identifier of an ad account.") @QueryParam("ad_account_id")  @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId,@ApiParam(value = "Cursor used to fetch the next page of items") @QueryParam("bookmark")  String bookmark,@ApiParam(value = "Maximum number of items to include in a single page. See documentation on [Pagination](/docs/reference/pagination/) for more information.", defaultValue = "25") @DefaultValue("25") @QueryParam("page_size")  @Min(1) @Max(250) Integer pageSize,@Context SecurityContext securityContext)
    throws NotFoundException {
        return delegate.catalogsLocalStoresList(catalogId, ids, adAccountId, bookmark, pageSize, securityContext);
    }
    @javax.ws.rs.PATCH
    @Path("/{catalog_id}/local_stores")
    @Consumes({ "application/json" })
    ...
    public Response catalogsLocalStoresUpdate(@ApiParam(value = "Unique identifier of a catalog.", required = true) @PathParam("catalog_id") @NotNull  @Pattern(regexp="^\\d+$") @Size(max=19) String catalogId,@ApiParam(value = "", required = true) @NotNull @Valid  List<@Valid LocalStoreBatchUpdate> localStoreBatchUpdate,@ApiParam(value = "Unique identifier of an ad account.") @QueryParam("ad_account_id")  @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId,@Context SecurityContext securityContext)
    throws NotFoundException {
        return delegate.catalogsLocalStoresUpdate(catalogId, localStoreBatchUpdate, adAccountId, securityContext);
    }
    @javax.ws.rs.GET
    ...
    public Response catalogsProductGroupPinsList(@ApiParam(value = "Unique identifier of a product group", required = true) @PathParam("product_group_id") @NotNull  @Pattern(regexp="^\\d+$") String productGroupId,@ApiParam(value = "Unique identifier of an ad account.") @QueryParam("ad_account_id")  @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId,@ApiParam(value = "Specify whether to return 90d and lifetime Pin metrics. Total comments and total reactions are only available with lifetime Pin metrics. If Pin was created before `2023-03-20` lifetime metrics will only be available for Video and Idea Pin formats. Lifetime metrics are available for all Pin formats since then.", defaultValue = "false") @DefaultValue("false") @QueryParam("pin_metrics")  Boolean pinMetrics,@ApiParam(value = "Cursor used to fetch the next page of items") @QueryParam("bookmark")  String bookmark,@ApiParam(value = "Maximum number of items to include in a single page. See documentation on [Pagination](/docs/reference/pagination/) for more information.", defaultValue = "25") @DefaultValue("25") @QueryParam("page_size")  @Min(1) @Max(250) Integer pageSize,@Context SecurityContext securityContext)
    throws NotFoundException {
        return delegate.catalogsProductGroupPinsList(productGroupId, adAccountId, pinMetrics, bookmark, pageSize, securityContext);
    }
    @javax.ws.rs.POST
    @Path("/product_groups")
    @Consumes({ "application/json" })
    ...
    public Response catalogsProductGroupsCreate(@ApiParam(value = "", required = true) @NotNull @Valid  CatalogsProductGroupsCreateRequestSchema catalogsProductGroupsCreateRequestSchema,@ApiParam(value = "Unique identifier of an ad account.") @QueryParam("ad_account_id")  @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId,@Context SecurityContext securityContext)
    throws NotFoundException {
        return delegate.catalogsProductGroupsCreate(catalogsProductGroupsCreateRequestSchema, adAccountId, securityContext);
    }
    @javax.ws.rs.POST
    ...
    public Response catalogsProductGroupsCreateMany(@ApiParam(value = "", required = true) @NotNull @Valid  @Size(min=1,max=1000) List<CatalogsProductGroupsCreateManyRequestItems> catalogsProductGroupsCreateManyRequestItems,@ApiParam(value = "Unique identifier of an ad account.") @QueryParam("ad_account_id")  @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId,@Context SecurityContext securityContext)
    throws NotFoundException {
        return delegate.catalogsProductGroupsCreateMany(catalogsProductGroupsCreateManyRequestItems, adAccountId, securityContext);
    }
    @javax.ws.rs.DELETE
    ...
    public Response catalogsProductGroupsDelete(@ApiParam(value = "Unique identifier of a product group", required = true) @PathParam("product_group_id") @NotNull  @Pattern(regexp="^\\d+$") String productGroupId,@ApiParam(value = "Unique identifier of an ad account.") @QueryParam("ad_account_id")  @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response catalogsProductGroupsDeleteMany(@ApiParam(value = "Comma-separated list of product group ids", required = true) @QueryParam("id") @NotNull  @Size(min=1,max=1000) List<Integer> id,@ApiParam(value = "Unique identifier of an ad account.") @QueryParam("ad_account_id")  @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response catalogsProductGroupsGet(@ApiParam(value = "Unique identifier of a product group", required = true) @PathParam("product_group_id") @NotNull  @Pattern(regexp="^\\d+$") String productGroupId,@ApiParam(value = "Unique identifier of an ad account.") @QueryParam("ad_account_id")  @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response catalogsProductGroupsList(@ApiParam(value = "Comma-separated list of product group ids") @QueryParam("id")  @Size(min=1,max=1000) List<Integer> id,@ApiParam(value = "Filter entities for a given feed_id. If not given, all feeds are considered.") @QueryParam("feed_id")  @Pattern(regexp="^\\d+$") String feedId,@ApiParam(value = "Filter entities for a given catalog_id. If not given, all catalogs are considered.") @QueryParam("catalog_id")  @Pattern(regexp="^\\d+$") String catalogId,@ApiParam(value = "Unique identifier of an ad account.") @QueryParam("ad_account_id")  @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId,@ApiParam(value = "Cursor used to fetch the next page of items") @QueryParam("bookmark")  String bookmark,@ApiParam(value = "Maximum number of items to include in a single page. See documentation on [Pagination](/docs/reference/pagination/) for more information.", defaultValue = "25") @DefaultValue("25") @QueryParam("page_size")  @Min(1) @Max(250) Integer pageSize,@Context SecurityContext securityContext)
    throws NotFoundException {
        return delegate.catalogsProductGroupsList(id, feedId, catalogId, adAccountId, bookmark, pageSize, securityContext);
    }
    @javax.ws.rs.GET
    ...
    public Response catalogsProductGroupsUpdate(@ApiParam(value = "Unique identifier of a product group", required = true) @PathParam("product_group_id") @NotNull  @Pattern(regexp="^\\d+$") String productGroupId,@ApiParam(value = "", required = true) @NotNull @Valid  CatalogsProductGroupsUpdateRequestSchema catalogsProductGroupsUpdateRequestSchema,@ApiParam(value = "Unique identifier of an ad account.") @QueryParam("ad_account_id")  @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId,@Context SecurityContext securityContext)
    throws NotFoundException {
        return delegate.catalogsProductGroupsUpdate(productGroupId, catalogsProductGroupsUpdateRequestSchema, adAccountId, securityContext);
    }
    @javax.ws.rs.GET
    ...
    public Response catalogsSupplementalItemsBatchGet(@ApiParam(value = "Unique identifier of a catalog.", required = true) @PathParam("catalog_id") @NotNull  @Pattern(regexp="^\\d+$") @Size(max=19) String catalogId,@ApiParam(value = "Unique identifier of an items batch operation.", required = true) @PathParam("batch_id") @NotNull  @Pattern(regexp="^\\d+$") String batchId,@ApiParam(value = "Unique identifier of an ad account.") @QueryParam("ad_account_id")  @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId,@Context SecurityContext securityContext)
    throws NotFoundException {
        return delegate.catalogsSupplementalItemsBatchGet(catalogId, batchId, adAccountId, securityContext);
    }
    @javax.ws.rs.GET
    ...
    public Response feedProcessingResultsList(@ApiParam(value = "Unique identifier of a feed.", required = true) @PathParam("feed_id") @NotNull  @Pattern(regexp="^\\d+$") String feedId,@ApiParam(value = "Unique identifier of an ad account.") @QueryParam("ad_account_id")  @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId,@ApiParam(value = "Cursor used to fetch the next page of items") @QueryParam("bookmark")  String bookmark,@ApiParam(value = "Maximum number of items to include in a single page. See documentation on [Pagination](/docs/reference/pagination/) for more information.", defaultValue = "25") @DefaultValue("25") @QueryParam("page_size")  @Min(1) @Max(250) Integer pageSize,@Context SecurityContext securityContext)
    throws NotFoundException {
        return delegate.feedProcessingResultsList(feedId, adAccountId, bookmark, pageSize, securityContext);
    }
    @javax.ws.rs.POST
    @Path("/feeds")
    @Consumes({ "application/json" })
    ...
    public Response feedsCreate(@ApiParam(value = "", required = true) @NotNull @Valid  CatalogsFeedCreateRequestSchema catalogsFeedCreateRequestSchema,@ApiParam(value = "Unique identifier of an ad account.") @QueryParam("ad_account_id")  @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId,@Context SecurityContext securityContext)
    throws NotFoundException {
        return delegate.feedsCreate(catalogsFeedCreateRequestSchema, adAccountId, securityContext);
    }
    @javax.ws.rs.DELETE
    @Path("/feeds/{feed_id}")
    ...
    public Response feedsDelete(@ApiParam(value = "Unique identifier of a feed.", required = true) @PathParam("feed_id") @NotNull  @Pattern(regexp="^\\d+$") String feedId,@ApiParam(value = "Unique identifier of an ad account.") @QueryParam("ad_account_id")  @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response feedsGet(@ApiParam(value = "Unique identifier of a feed.", required = true) @PathParam("feed_id") @NotNull  @Pattern(regexp="^\\d+$") String feedId,@ApiParam(value = "Unique identifier of an ad account.") @QueryParam("ad_account_id")  @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response feedsList(@ApiParam(value = "Filter entities for a given catalog_id. If not given, all catalogs are considered.") @QueryParam("catalog_id")  @Pattern(regexp="^\\d+$") String catalogId,@ApiParam(value = "Unique identifier of an ad account.") @QueryParam("ad_account_id")  @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId,@ApiParam(value = "Cursor used to fetch the next page of items") @QueryParam("bookmark")  String bookmark,@ApiParam(value = "Maximum number of items to include in a single page. See documentation on [Pagination](/docs/reference/pagination/) for more information.", defaultValue = "25") @DefaultValue("25") @QueryParam("page_size")  @Min(1) @Max(250) Integer pageSize,@Context SecurityContext securityContext)
    throws NotFoundException {
        return delegate.feedsList(catalogId, adAccountId, bookmark, pageSize, securityContext);
    }
    @javax.ws.rs.PATCH
    @Path("/feeds/{feed_id}")
    @Consumes({ "application/json" })
    ...
    public Response feedsUpdate(@ApiParam(value = "Unique identifier of a feed.", required = true) @PathParam("feed_id") @NotNull  @Pattern(regexp="^\\d+$") String feedId,@ApiParam(value = "", required = true) @NotNull @Valid  CatalogsFeedUpdateRequestSchema catalogsFeedUpdateRequestSchema,@ApiParam(value = "Unique identifier of an ad account.") @QueryParam("ad_account_id")  @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId,@Context SecurityContext securityContext)
    throws NotFoundException {
        return delegate.feedsUpdate(feedId, catalogsFeedUpdateRequestSchema, adAccountId, securityContext);
    }
    @javax.ws.rs.GET
    ...
    public Response itemsBatchGet(@ApiParam(value = "Id of a catalogs items batch to fetch", required = true) @PathParam("batch_id") @NotNull  @Pattern(regexp="^\\d+$") String batchId,@ApiParam(value = "Unique identifier of an ad account.") @QueryParam("ad_account_id")  @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response itemsBatchPost(@ApiParam(value = "", required = true) @NotNull @Valid  CatalogsItemsBatchPostRequest catalogsItemsBatchPostRequest,@ApiParam(value = "Unique identifier of an ad account.") @QueryParam("ad_account_id")  @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId,@Context SecurityContext securityContext)
    throws NotFoundException {
        return delegate.itemsBatchPost(catalogsItemsBatchPostRequest, adAccountId, securityContext);
    }
    @javax.ws.rs.GET
    ...
    public Response itemsPost(@ApiParam(value = "", required = true) @NotNull @Valid  CatalogsItemsRequest catalogsItemsRequest,@ApiParam(value = "Unique identifier of an ad account.") @QueryParam("ad_account_id")  @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response productsByProductGroupFilterList(@ApiParam(value = "", required = true) @NotNull @Valid  CatalogsListProductsByFilterRequest catalogsListProductsByFilterRequest,@ApiParam(value = "Cursor used to fetch the next page of items") @QueryParam("bookmark")  String bookmark,@ApiParam(value = "Maximum number of items to include in a single page. See documentation on [Pagination](/docs/reference/pagination/) for more information.", defaultValue = "25") @DefaultValue("25") @QueryParam("page_size")  @Min(1) @Max(250) Integer pageSize,@ApiParam(value = "Unique identifier of an ad account.") @QueryParam("ad_account_id")  @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId,@ApiParam(value = "Specify whether to return 90d and lifetime Pin metrics. Total comments and total reactions are only available with lifetime Pin metrics. If Pin was created before `2023-03-20` lifetime metrics will only be available for Video and Idea Pin formats. Lifetime metrics are available for all Pin formats since then.", defaultValue = "false") @DefaultValue("false") @QueryParam("pin_metrics")  Boolean pinMetrics,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response reportsCreate(@ApiParam(value = "", required = true) @NotNull @Valid  CatalogsReportParameters catalogsReportParameters,@ApiParam(value = "Unique identifier of an ad account.") @QueryParam("ad_account_id")  @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response reportsGet(@ApiParam(value = "Token returned from the post request creation call", required = true) @QueryParam("token") @NotNull  String token,@ApiParam(value = "Unique identifier of an ad account.") @QueryParam("ad_account_id")  @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response reportsStats(@ApiParam(value = "Contains the parameters for report identification.", required = true) @QueryParam("parameters") @NotNull @Valid  CatalogsReportStatsParameters parameters,@ApiParam(value = "Unique identifier of an ad account.") @QueryParam("ad_account_id")  @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId,@ApiParam(value = "Cursor used to fetch the next page of items") @QueryParam("bookmark")  String bookmark,@ApiParam(value = "Maximum number of items to include in a single page. See documentation on [Pagination](/docs/reference/pagination/) for more information.", defaultValue = "25") @DefaultValue("25") @QueryParam("page_size")  @Min(1) @Max(250) Integer pageSize,@Context SecurityContext securityContext)
    throws NotFoundException {
        return delegate.reportsStats(parameters, adAccountId, bookmark, pageSize, securityContext);
    }
}
