...
@JsonPropertyOrder({
  ...
  ProductGroupPromotion.JSON_PROPERTY_IS_IMAGE_AUTO_RESIZING,
...
public class ProductGroupPromotion   {
  ...
  public static final String JSON_PROPERTY_IS_IMAGE_AUTO_RESIZING = "is_image_auto_resizing";
  @JsonProperty(JSON_PROPERTY_IS_IMAGE_AUTO_RESIZING)
   ...
   **/
  @JsonProperty(value = "is_generate_background")
   ...
   **/
  @JsonProperty(value = "is_image_auto_resizing")
   ...
   **/
  @JsonProperty(value = "selected_image_tag")
   ...
   **/
  @JsonProperty(value = "selected_video_tag")
