   ...
   public BoardsApi(@Context ServletConfig servletContext) {
      ...
      if (servletContext != null) {
         ...
         if (implClass != null && !"".equals(implClass.trim())) {
            try {
               delegate = (BoardsApiService) Class.forName(implClass).getDeclaredConstructor().newInstance();
            } catch (Exception e) {
    ...
    public Response boardSectionsUpdate(@ApiParam(value = "Unique identifier of a board.", required = true) @PathParam("board_id") @NotNull  @Pattern(regexp="^\\d+$") String boardId,@ApiParam(value = "Unique identifier of a board section.", required = true) @PathParam("section_id") @NotNull  @Pattern(regexp="^\\d+$") String sectionId,@ApiParam(value = "", required = true) @NotNull @Valid  BoardSectionUpdateWithRequiredBody boardSectionUpdateWithRequiredBody,@ApiParam(value = "Unique identifier of an ad account.") @QueryParam("ad_account_id")  @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId,@Context SecurityContext securityContext)
    throws NotFoundException {
        return delegate.boardSectionsUpdate(boardId, sectionId, boardSectionUpdateWithRequiredBody, adAccountId, securityContext);
    }
    @javax.ws.rs.POST
    ...
    public Response boardsCreate(@ApiParam(value = "", required = true) @NotNull @Valid  BoardCreate boardCreate,@ApiParam(value = "Unique identifier of an ad account.") @QueryParam("ad_account_id")  @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response boardsDelete(@ApiParam(value = "", required = true) @PathParam("board_id") @NotNull  @Pattern(regexp="^\\d+$") String boardId,@ApiParam(value = "Unique identifier of an ad account.") @QueryParam("ad_account_id")  @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response boardsGet(@ApiParam(value = "", required = true) @PathParam("board_id") @NotNull  @Pattern(regexp="^\\d+$") String boardId,@ApiParam(value = "Unique identifier of an ad account.") @QueryParam("ad_account_id")  @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response boardsList(@ApiParam(value = "Unique identifier of an ad account.") @QueryParam("ad_account_id")  @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId,@ApiParam(value = "The privacy level of the board", allowableValues="ALL, PUBLIC, PROTECTED, SECRET, PUBLIC_AND_SECRET") @QueryParam("privacy")  BoardPrivacyFilter privacy,@ApiParam(value = "Cursor used to fetch the next page of items") @QueryParam("bookmark")  String bookmark,@ApiParam(value = "Maximum number of items to include in a single page. See documentation on [Pagination](/docs/reference/pagination/) for more information.", defaultValue = "25") @DefaultValue("25") @QueryParam("page_size")  @Min(1) @Max(250) Integer pageSize,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    throws NotFoundException {
        return delegate.boardsListPins(boardId, creativeTypes, adAccountId, pinMetrics, bookmark, pageSize, securityContext);
    }
    @javax.ws.rs.PATCH
    @Path("/{board_id}")
    @Consumes({ "application/json" })
    ...
    public Response boardsUpdate(@ApiParam(value = "", required = true) @PathParam("board_id") @NotNull  @Pattern(regexp="^\\d+$") String boardId,@ApiParam(value = "", required = true) @NotNull @Valid  BoardWithUpdatePrivacyUpdate boardWithUpdatePrivacyUpdate,@ApiParam(value = "Unique identifier of an ad account.") @QueryParam("ad_account_id")  @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId,@Context SecurityContext securityContext)
    throws NotFoundException {
