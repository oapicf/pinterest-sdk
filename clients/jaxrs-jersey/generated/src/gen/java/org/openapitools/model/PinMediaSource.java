...
@JsonPropertyOrder({
  ...
  PinMediaSource.JSON_PROPERTY_COVER_IMAGE_KEY_FRAME_TIME,
...
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaJerseyServerCodegen", date = "2026-08-30T09:54:14.357431345Z[Etc/UTC]", comments = "Generator version: 7.24.0")@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, include = JsonTypeInfo.As.PROPERTY, property = "source_type", visible = true)
@JsonSubTypes({
...
public class PinMediaSource   {
  ...
  public static final String JSON_PROPERTY_COVER_IMAGE_KEY_FRAME_TIME = "cover_image_key_frame_time";
  @JsonProperty(JSON_PROPERTY_COVER_IMAGE_KEY_FRAME_TIME)
   ...
   **/
  @JsonProperty(value = "cover_image_key_frame_time")
