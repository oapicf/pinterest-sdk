...
public class AdvancedAuctionApi  {
   ...
   public AdvancedAuctionApi(@Context ServletConfig servletContext) {
    ...
    public Response advancedAuctionItemsGetPost(@ApiParam(value = "", required = true) @NotNull @Valid  AdvancedAuctionItemsGetRequest advancedAuctionItemsGetRequest,@ApiParam(value = "Unique identifier of an ad account.") @QueryParam("ad_account_id")  @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId,@Context SecurityContext securityContext)
    ...
    public Response advancedAuctionItemsSubmitPost(@ApiParam(value = "", required = true) @NotNull @Valid  AdvancedAuctionItemsSubmitRequest advancedAuctionItemsSubmitRequest,@ApiParam(value = "Unique identifier of an ad account.") @QueryParam("ad_account_id")  @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId,@Context SecurityContext securityContext)
    throws NotFoundException {
