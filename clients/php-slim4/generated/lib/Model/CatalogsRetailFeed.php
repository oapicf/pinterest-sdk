    ...
    protected const MODEL_SCHEMA = <<<'SCHEMA'
{
  ...
  "allOf" : [ {
    ...
    "title" : "feed_fields",
    "required" : [ "catalog_type", "credentials", "default_availability", "default_country", "default_currency", "default_locale", "format", "location", "name", "preferred_processing_schedule", "status" ],
    "type" : "object",
    "properties" : {
      "catalog_type" : {
