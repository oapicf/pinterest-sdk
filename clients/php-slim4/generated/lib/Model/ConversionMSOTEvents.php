 ...
 * @link    https://github.com/openapitools/openapi-generator
 */
class ConversionMSOTEvents extends BaseModel
{
    /**
    ...
    protected const MODEL_SCHEMA = <<<'SCHEMA'
{
  ...
  "required" : [ "ad_group_id", "attribution_scope", "event_id", "event_name", "event_timestamp" ],
  "type" : "object",
  "properties" : {
    "action_timestamps" : {
      "type" : "array",
    ...
    "currency" : {
      "allOf" : [ {
        ...
        "type" : "string",
        "description" : "Currency code for the value field, required if <code>value</code> is present. Currency Codes should be in ISO 4217 standard."
      } ]
    },
    "event_id" : {
      "maxLength" : 256,
    ...
    "event_name" : {
      ...
      "example" : "add_to_cart",
      "enum" : [ "add_to_cart", "checkout", "lead", "signup" ]
    },
    "event_timestamp" : {
      "type" : "integer",
