 ...
 * @link    https://github.com/openapitools/openapi-generator
 */
class CatalogsRetailBatchRequest extends BaseModel
{
    /**
...
{
  "required" : [ "catalog_type", "country", "items", "language" ],
  "type" : "object",
  "properties" : {
    "catalog_id" : {
      "pattern" : "^\\d+$",
    ...
    "items" : {
      ...
      "items" : {
        "$ref" : "#/components/schemas/CatalogsRetailBatchRequest_items_inner"
      }
    },
    "language" : {
      "type" : "string",
