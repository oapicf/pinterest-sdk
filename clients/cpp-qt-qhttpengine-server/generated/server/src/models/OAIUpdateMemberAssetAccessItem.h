...
/*
 * OAIUpdateMemberAssetAccessItem.h
 *
 * 
 */

#ifndef OAIUpdateMemberAssetAccessItem_H
#define OAIUpdateMemberAssetAccessItem_H
...
class OAIUpdateMemberAssetAccessItem : public OAIObject {
public:
    OAIUpdateMemberAssetAccessItem();
    OAIUpdateMemberAssetAccessItem(QString json);
    ~OAIUpdateMemberAssetAccessItem() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateMemberAssetAccessItem)

#endif // OAIUpdateMemberAssetAccessItem_H
