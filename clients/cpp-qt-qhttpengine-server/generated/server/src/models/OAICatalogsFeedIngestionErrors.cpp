...
void OAICatalogsFeedIngestionErrors::fromJsonObject(QJsonObject json) {
    ...
    m_fetch_google_sheet_not_shared_isValid = ::OpenAPI::fromJsonValue(fetch_google_sheet_not_shared, json[QString("FETCH_GOOGLE_SHEET_NOT_SHARED")]);
...
QJsonObject OAICatalogsFeedIngestionErrors::asJsonObject() const {
    ...
    if (m_fetch_google_sheet_not_shared_isSet) {
        obj.insert(QString("FETCH_GOOGLE_SHEET_NOT_SHARED"), ::OpenAPI::toJsonValue(fetch_google_sheet_not_shared));
    }
...
void OAICatalogsFeedIngestionErrors::setFetchGoogleSheetNotShared(const qint32 &fetch_google_sheet_not_shared) {
    ...
    this->m_fetch_google_sheet_not_shared_isSet = true;
}
