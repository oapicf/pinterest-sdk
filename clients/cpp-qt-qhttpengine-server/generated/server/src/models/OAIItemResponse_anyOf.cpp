...
OAICatalogsCreativeAssetsAttributes OAIItemResponse_anyOf::getAttributes() const {
    return attributes;
}
void OAIItemResponse_anyOf::setAttributes(const OAICatalogsCreativeAssetsAttributes &attributes) {
...
QString OAIItemResponse_anyOf::getCreativeAssetsId() const {
    return creative_assets_id;
}
void OAIItemResponse_anyOf::setCreativeAssetsId(const QString &creative_assets_id) {
    this->creative_assets_id = creative_assets_id;
    this->m_creative_assets_id_isSet = true;
}

bool OAIItemResponse_anyOf::is_creative_assets_id_Set() const{
    return m_creative_assets_id_isSet;
}

bool OAIItemResponse_anyOf::is_creative_assets_id_Valid() const{
