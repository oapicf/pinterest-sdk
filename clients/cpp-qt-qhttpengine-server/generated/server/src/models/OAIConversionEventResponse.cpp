...
void OAIConversionEventResponse::fromJsonObject(QJsonObject json) {
    ...
    m_reporting_conversion_event_isValid = ::OpenAPI::fromJsonValue(reporting_conversion_event, json[QString("reporting_conversion_event")]);
...
QJsonObject OAIConversionEventResponse::asJsonObject() const {
    ...
    if (m_reporting_conversion_event_isSet) {
        obj.insert(QString("reporting_conversion_event"), ::OpenAPI::toJsonValue(reporting_conversion_event));
    }
    return obj;
}
...
void OAIConversionEventResponse::setReportingConversionEvent(const QString &reporting_conversion_event) {
    ...
    this->m_reporting_conversion_event_isSet = true;
}
