...
OAIPinMediaWithImage_allOf_images OAIPinMediaWithImage::getImages() const {
    return images;
}
void OAIPinMediaWithImage::setImages(const OAIPinMediaWithImage_allOf_images &images) {
    this->images = images;
