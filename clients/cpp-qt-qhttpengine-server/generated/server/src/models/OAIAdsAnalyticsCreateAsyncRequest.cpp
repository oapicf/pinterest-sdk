...
void OAIAdsAnalyticsCreateAsyncRequest::fromJsonObject(QJsonObject json) {
    ...
    m_campaign_brand_label_isValid = ::OpenAPI::fromJsonValue(campaign_brand_label, json[QString("campaign_brand_label")]);
    m_campaign_brand_label_isSet = !json[QString("campaign_brand_label")].isNull() && m_campaign_brand_label_isValid;

    m_campaign_custom_label_isValid = ::OpenAPI::fromJsonValue(campaign_custom_label, json[QString("campaign_custom_label")]);
    ...
    m_combine_targeting_types_isValid = ::OpenAPI::fromJsonValue(combine_targeting_types, json[QString("combine_targeting_types")]);
    ...
    m_custom_conversion_event_metrics_isValid = ::OpenAPI::fromJsonValue(custom_conversion_event_metrics, json[QString("custom_conversion_event_metrics")]);
    ...
    m_reporting_timezone_isValid = ::OpenAPI::fromJsonValue(reporting_timezone, json[QString("reporting_timezone")]);
...
QJsonObject OAIAdsAnalyticsCreateAsyncRequest::asJsonObject() const {
    ...
    if (m_campaign_brand_label_isSet) {
        obj.insert(QString("campaign_brand_label"), ::OpenAPI::toJsonValue(campaign_brand_label));
    }
    if (m_campaign_custom_label_isSet) {
        obj.insert(QString("campaign_custom_label"), ::OpenAPI::toJsonValue(campaign_custom_label));
    }
    ...
    if (m_combine_targeting_types_isSet) {
        obj.insert(QString("combine_targeting_types"), ::OpenAPI::toJsonValue(combine_targeting_types));
    }
    if (conversion_report_time.isSet()) {
        obj.insert(QString("conversion_report_time"), ::OpenAPI::toJsonValue(conversion_report_time));
    }
    if (custom_conversion_event_metrics.size() > 0) {
        obj.insert(QString("custom_conversion_event_metrics"), ::OpenAPI::toJsonValue(custom_conversion_event_metrics));
    }
    if (m_end_date_isSet) {
    ...
    if (reporting_timezone.isSet()) {
        obj.insert(QString("reporting_timezone"), ::OpenAPI::toJsonValue(reporting_timezone));
    }
...
void OAIAdsAnalyticsCreateAsyncRequest::setCampaignBrandLabel(const QString &campaign_brand_label) {
    ...
    this->m_campaign_brand_label_isSet = true;
}
...
void OAIAdsAnalyticsCreateAsyncRequest::setCampaignCustomLabel(const QString &campaign_custom_label) {
    ...
    this->m_campaign_custom_label_isSet = true;
}
...
void OAIAdsAnalyticsCreateAsyncRequest::setCombineTargetingTypes(const bool &combine_targeting_types) {
    ...
    this->m_combine_targeting_types_isSet = true;
}
...
void OAIAdsAnalyticsCreateAsyncRequest::setCustomConversionEventMetrics(const QList<OAICustomConversionEventMetrics> &custom_conversion_event_metrics) {
    ...
    this->m_custom_conversion_event_metrics_isSet = true;
}
...
void OAIAdsAnalyticsCreateAsyncRequest::setReportingTimezone(const OAIReportingTimeZone &reporting_timezone) {
    ...
    this->m_reporting_timezone_isSet = true;
}
