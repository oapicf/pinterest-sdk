...
void OAILeadFormQuestionType::fromJson(QString jsonString) {
    ...
    else if ( jsonString.compare("PREFERRED_CONTACT_METHOD", Qt::CaseInsensitive) == 0) {
        m_value = eOAILeadFormQuestionType::PREFERRED_CONTACT_METHOD;
        m_value_isSet = m_value_isValid = true;
    }
...
QString OAILeadFormQuestionType::asJson() const {
    ...
    switch (m_value){
        ...
        case eOAILeadFormQuestionType::COUNTRY:
            val = "COUNTRY";
            break;
        case eOAILeadFormQuestionType::PREFERRED_CONTACT_METHOD:
