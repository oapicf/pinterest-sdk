...
QList<OAIPinAnalyticsDailyMetrics> OAIPinAnalyticsMetricsResponse::getDailyMetrics() const {
    return daily_metrics;
}
void OAIPinAnalyticsMetricsResponse::setDailyMetrics(const QList<OAIPinAnalyticsDailyMetrics> &daily_metrics) {
