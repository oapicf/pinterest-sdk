...
/*
 * OAICatalogsCreativeAssetsBatchRequest.h
 *
 * Request object to update catalogs creative assets items
 */

#ifndef OAICatalogsCreativeAssetsBatchRequest_H
#define OAICatalogsCreativeAssetsBatchRequest_H
...
class OAICatalogsCreativeAssetsBatchRequest : public OAIObject {
public:
    OAICatalogsCreativeAssetsBatchRequest();
    OAICatalogsCreativeAssetsBatchRequest(QString json);
    ~OAICatalogsCreativeAssetsBatchRequest() override;
...
private:
    ...
    QList<OAICatalogsCreativeAssetsBatchItem> items;
    bool m_items_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAICatalogsCreativeAssetsBatchRequest)

#endif // OAICatalogsCreativeAssetsBatchRequest_H
