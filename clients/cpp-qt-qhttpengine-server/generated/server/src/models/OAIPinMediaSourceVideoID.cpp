...
void OAIPinMediaSourceVideoID::fromJsonObject(QJsonObject json) {
    ...
    m_cover_image_key_frame_time_isValid = ::OpenAPI::fromJsonValue(cover_image_key_frame_time, json[QString("cover_image_key_frame_time")]);
...
QJsonObject OAIPinMediaSourceVideoID::asJsonObject() const {
    QJsonObject obj;
    if (cover_image_content_type.isSet()) {
    ...
    if (m_cover_image_key_frame_time_isSet) {
        obj.insert(QString("cover_image_key_frame_time"), ::OpenAPI::toJsonValue(cover_image_key_frame_time));
    }
...
void OAIPinMediaSourceVideoID::setCoverImageKeyFrameTime(const qint32 &cover_image_key_frame_time) {
    ...
    this->m_cover_image_key_frame_time_isSet = true;
}
