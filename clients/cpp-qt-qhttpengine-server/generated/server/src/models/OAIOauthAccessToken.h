...
/*
 * OAIOauthAccessToken.h
 *
 * Describes the valid schema for possible OAuth access token requests.
 */

#ifndef OAIOauthAccessToken_H
#define OAIOauthAccessToken_H
...
class OAIOauthAccessToken : public OAIObject {
public:
    OAIOauthAccessToken();
    OAIOauthAccessToken(QString json);
    ~OAIOauthAccessToken() override;
    ...
    OAITokenGrantType getResponseType() const;
    void setResponseType(const OAITokenGrantType &response_type);
...
private:
    ...
    OAITokenGrantType response_type;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOauthAccessToken)

#endif // OAIOauthAccessToken_H
