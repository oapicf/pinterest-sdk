...
void OAILinkedBusiness::fromJsonObject(QJsonObject json) {
    ...
    m_image_large_url_isValid = ::OpenAPI::fromJsonValue(image_large_url, json[QString("image_large_url")]);
    m_image_large_url_isSet = !json[QString("image_large_url")].isNull() && m_image_large_url_isValid;

    m_image_medium_url_isValid = ::OpenAPI::fromJsonValue(image_medium_url, json[QString("image_medium_url")]);
    m_image_medium_url_isSet = !json[QString("image_medium_url")].isNull() && m_image_medium_url_isValid;

    m_image_small_url_isValid = ::OpenAPI::fromJsonValue(image_small_url, json[QString("image_small_url")]);
    m_image_small_url_isSet = !json[QString("image_small_url")].isNull() && m_image_small_url_isValid;

    m_image_xlarge_url_isValid = ::OpenAPI::fromJsonValue(image_xlarge_url, json[QString("image_xlarge_url")]);
...
QJsonObject OAILinkedBusiness::asJsonObject() const {
    ...
    if (m_image_large_url_isSet) {
        obj.insert(QString("image_large_url"), ::OpenAPI::toJsonValue(image_large_url));
    }
    if (m_image_medium_url_isSet) {
        obj.insert(QString("image_medium_url"), ::OpenAPI::toJsonValue(image_medium_url));
    }
    if (m_image_small_url_isSet) {
        obj.insert(QString("image_small_url"), ::OpenAPI::toJsonValue(image_small_url));
    }
    if (m_image_xlarge_url_isSet) {
        obj.insert(QString("image_xlarge_url"), ::OpenAPI::toJsonValue(image_xlarge_url));
    }
    if (m_username_isSet) {
...
void OAILinkedBusiness::setImageLargeUrl(const QString &image_large_url) {
    ...
    this->m_image_large_url_isSet = true;
}
...
void OAILinkedBusiness::setImageMediumUrl(const QString &image_medium_url) {
    ...
    this->m_image_medium_url_isSet = true;
}
...
void OAILinkedBusiness::setImageSmallUrl(const QString &image_small_url) {
    ...
    this->m_image_small_url_isSet = true;
}
...
void OAILinkedBusiness::setImageXlargeUrl(const QString &image_xlarge_url) {
    ...
    this->m_image_xlarge_url_isSet = true;
}
