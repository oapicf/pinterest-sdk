...
OAIAdAccountOwner OAIAdAccount::getOwner() const {
    return owner;
}
void OAIAdAccount::setOwner(const OAIAdAccountOwner &owner) {
    this->owner = owner;
...
QString OAIAdAccount::getTimeZone() const {
    return time_zone;
}
void OAIAdAccount::setTimeZone(const QString &time_zone) {
    this->time_zone = time_zone;
    this->m_time_zone_isSet = true;
}

bool OAIAdAccount::is_time_zone_Set() const{
    return m_time_zone_isSet;
}

bool OAIAdAccount::is_time_zone_Valid() const{
