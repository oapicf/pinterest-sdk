...
#ifndef OAISSIOAccount_H
#define OAISSIOAccount_H
...
class OAISSIOAccount : public OAIObject {
public:
    OAISSIOAccount();
    OAISSIOAccount(QString json);
    ~OAISSIOAccount() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISSIOAccount)

#endif // OAISSIOAccount_H
