...
OAIAdGroupCommon_optimization_goal_metadata OAIAdGroupCreateRequest::getOptimizationGoalMetadata() const {
    return optimization_goal_metadata;
}
void OAIAdGroupCreateRequest::setOptimizationGoalMetadata(const OAIAdGroupCommon_optimization_goal_metadata &optimization_goal_metadata) {
...
OAIAdGroupCommon_tracking_urls OAIAdGroupCreateRequest::getTrackingUrls() const {
    return tracking_urls;
}
void OAIAdGroupCreateRequest::setTrackingUrls(const OAIAdGroupCommon_tracking_urls &tracking_urls) {
