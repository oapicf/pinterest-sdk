...
qint32 OAIOauthAccessTokenResponseCode::getRefreshTokenExpiresAt() const {
    return refresh_token_expires_at;
}
void OAIOauthAccessTokenResponseCode::setRefreshTokenExpiresAt(const qint32 &refresh_token_expires_at) {
    this->refresh_token_expires_at = refresh_token_expires_at;
    this->m_refresh_token_expires_at_isSet = true;
}

bool OAIOauthAccessTokenResponseCode::is_refresh_token_expires_at_Set() const{
    return m_refresh_token_expires_at_isSet;
}

bool OAIOauthAccessTokenResponseCode::is_refresh_token_expires_at_Valid() const{
