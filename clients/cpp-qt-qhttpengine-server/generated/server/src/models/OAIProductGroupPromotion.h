...
private:
    ...
    OAICollectionsHeaderType collections_header_type;
    ...
    OAIProductGroupPromotionCustomizableCTAType customizable_cta_type;
    ...
    OAIPreferredMediaType preferred_media_type;
