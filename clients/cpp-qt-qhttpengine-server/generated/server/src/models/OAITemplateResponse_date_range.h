...
private:
    ...
    OAITemplateResponse_date_range_dynamic_date_range dynamic_date_range;
    bool m_dynamic_date_range_isSet;
    bool m_dynamic_date_range_isValid;

    OAITemplateResponse_date_range_relative_date_range relative_date_range;
    bool m_relative_date_range_isSet;
    bool m_relative_date_range_isValid;

    OAITemplateResponse_date_range_absolute_date_range absolute_date_range;
