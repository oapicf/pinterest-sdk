...
void OAIOptimizationGoalMetadata_conversion_tag_v3_goal_metadata::fromJsonObject(QJsonObject json) {
    ...
    m_learning_mode_type_isValid = ::OpenAPI::fromJsonValue(learning_mode_type, json[QString("learning_mode_type")]);
...
QJsonObject OAIOptimizationGoalMetadata_conversion_tag_v3_goal_metadata::asJsonObject() const {
    ...
    if (m_learning_mode_type_isSet) {
        obj.insert(QString("learning_mode_type"), ::OpenAPI::toJsonValue(learning_mode_type));
    }
...
void OAIOptimizationGoalMetadata_conversion_tag_v3_goal_metadata::setLearningModeType(const QString &learning_mode_type) {
    ...
    this->m_learning_mode_type_isSet = true;
}
...
QString OAIOptimizationGoalMetadata_conversion_tag_v3_goal_metadata::getReportingEvent() const {
    return reporting_event;
}
void OAIOptimizationGoalMetadata_conversion_tag_v3_goal_metadata::setReportingEvent(const QString &reporting_event) {
    this->reporting_event = reporting_event;
    this->m_reporting_event_isSet = true;
}

bool OAIOptimizationGoalMetadata_conversion_tag_v3_goal_metadata::is_reporting_event_Set() const{
    return m_reporting_event_isSet;
}

bool OAIOptimizationGoalMetadata_conversion_tag_v3_goal_metadata::is_reporting_event_Valid() const{
