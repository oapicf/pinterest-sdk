...
OAIAppTypeMultipliers<QString, double> OAIAdvancedAuctionBidOptions::getAppTypeMultipliers() const {
    return app_type_multipliers;
}
void OAIAdvancedAuctionBidOptions::setAppTypeMultipliers(const OAIAppTypeMultipliers<QString, double> &app_type_multipliers) {
...
OAIPlacementMultipliers<QString, double> OAIAdvancedAuctionBidOptions::getPlacementMultipliers() const {
    return placement_multipliers;
}
void OAIAdvancedAuctionBidOptions::setPlacementMultipliers(const OAIPlacementMultipliers<QString, double> &placement_multipliers) {
