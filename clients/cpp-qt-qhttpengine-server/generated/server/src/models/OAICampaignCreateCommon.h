...
/*
 * OAICampaignCreateCommon.h
 *
 * 
 */

#ifndef OAICampaignCreateCommon_H
#define OAICampaignCreateCommon_H
...
class OAICampaignCreateCommon : public OAIObject {
public:
    OAICampaignCreateCommon();
    OAICampaignCreateCommon(QString json);
    ~OAICampaignCreateCommon() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICampaignCreateCommon)

#endif // OAICampaignCreateCommon_H
