...
/*
 * OAIOauthAccessTokenResponseCode.h
 *
 * 
 */

#ifndef OAIOauthAccessTokenResponseCode_H
#define OAIOauthAccessTokenResponseCode_H
...
class OAIOauthAccessTokenResponseCode : public OAIObject {
public:
    OAIOauthAccessTokenResponseCode();
    OAIOauthAccessTokenResponseCode(QString json);
    ~OAIOauthAccessTokenResponseCode() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOauthAccessTokenResponseCode)

#endif // OAIOauthAccessTokenResponseCode_H
