...
QList<OAIAssetIdWithPermissions> OAIBusinessMemberAssetsSummary::getAdAccounts() const {
    return ad_accounts;
}
void OAIBusinessMemberAssetsSummary::setAdAccounts(const QList<OAIAssetIdWithPermissions> &ad_accounts) {
...
QList<OAIAssetIdWithPermissions> OAIBusinessMemberAssetsSummary::getProfiles() const {
    return profiles;
}
void OAIBusinessMemberAssetsSummary::setProfiles(const QList<OAIAssetIdWithPermissions> &profiles) {
