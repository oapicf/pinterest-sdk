...
public:
    ...
    OAIConversionTagV3GoalMetadata(QString json);
...
private:
    ...
    OAIAttributionWindows attribution_windows;
    bool m_attribution_windows_isSet;
    bool m_attribution_windows_isValid;

    OAIConversionEvent conversion_event;
    ...
    QString cpa_goal_value_in_micro_currency;
