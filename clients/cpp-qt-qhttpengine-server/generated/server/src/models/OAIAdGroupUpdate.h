...
private:
    ...
    OAIBidStrategyType bid_strategy_type;
    ...
    OAIConversionLearningModeType conversion_learning_mode_type;
    ...
    OAIAdgroupTrackingFeatures ext_features;
    ...
    OAINullableOptimizationGoalMetadata optimization_goal_metadata;
    ...
    OAIPlacementTrafficType placement_traffic_type;
    bool m_placement_traffic_type_isSet;
    bool m_placement_traffic_type_isValid;

    OAIPromotionApplicationLevel promotion_application_level;
    ...
    OAIAdGroupTrackingURLs tracking_urls;
