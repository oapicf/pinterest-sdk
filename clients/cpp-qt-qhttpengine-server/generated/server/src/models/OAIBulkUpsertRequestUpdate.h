...
private:
    ...
    QList<OAIBulkUpsertRequestUpdateCatalogProductGroupsItems> catalog_product_groups;
    bool m_catalog_product_groups_isSet;
    bool m_catalog_product_groups_isValid;

    QList<OAIKeywordUpdateGenerated> keywords;
    bool m_keywords_isSet;
    bool m_keywords_isValid;

    QList<OAILabelBulkUpdateRequest> labels;
    bool m_labels_isSet;
    ...
    QList<OAIScheduleUpdateRequest> schedules;
