...
OAIAdGroupCommon_optimization_goal_metadata OAIAdGroupCommon::getOptimizationGoalMetadata() const {
    return optimization_goal_metadata;
}
void OAIAdGroupCommon::setOptimizationGoalMetadata(const OAIAdGroupCommon_optimization_goal_metadata &optimization_goal_metadata) {
