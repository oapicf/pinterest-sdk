...
OAIBaseInviteDataResponse_invite_data OAIInviteBusinessRoleBinding::getInviteData() const {
    return invite_data;
}
void OAIInviteBusinessRoleBinding::setInviteData(const OAIBaseInviteDataResponse_invite_data &invite_data) {
