...
/*
 * OAICampaignCreateResponseData.h
 *
 * 
 */

#ifndef OAICampaignCreateResponseData_H
#define OAICampaignCreateResponseData_H
...
class OAICampaignCreateResponseData : public OAIObject {
public:
    OAICampaignCreateResponseData();
    OAICampaignCreateResponseData(QString json);
    ~OAICampaignCreateResponseData() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICampaignCreateResponseData)

#endif // OAICampaignCreateResponseData_H
