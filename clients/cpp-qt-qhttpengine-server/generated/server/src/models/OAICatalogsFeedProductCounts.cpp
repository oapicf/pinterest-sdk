...
void OAICatalogsFeedProductCounts::fromJsonObject(QJsonObject json) {
    ...
    m_ingested_isValid = ::OpenAPI::fromJsonValue(ingested, json[QString("ingested")]);
...
QJsonObject OAICatalogsFeedProductCounts::asJsonObject() const {
    QJsonObject obj;
    if (m_ingested_isSet) {
        obj.insert(QString("ingested"), ::OpenAPI::toJsonValue(ingested));
    }
    if (m_original_isSet) {
