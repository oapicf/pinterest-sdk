...
#ifndef OAIOrderLines_H
#define OAIOrderLines_H
...
class OAIOrderLines : public OAIObject {
public:
    OAIOrderLines();
    OAIOrderLines(QString json);
    ~OAIOrderLines() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOrderLines)

#endif // OAIOrderLines_H
