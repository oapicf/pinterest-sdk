...
void OAIObjectiveType::fromJson(QString jsonString) {
    ...
    else if ( jsonString.compare("AWARENESS_RESERVED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIObjectiveType::AWARENESS_RESERVED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ENGAGEMENT", Qt::CaseInsensitive) == 0) {
        m_value = eOAIObjectiveType::ENGAGEMENT;
        m_value_isSet = m_value_isValid = true;
    }
}
...
QString OAIObjectiveType::asJson() const {
    ...
    switch (m_value){
        ...
        case eOAIObjectiveType::WEB_SESSIONS:
            val = "WEB_SESSIONS";
            break;
        case eOAIObjectiveType::AWARENESS_RESERVED:
            val = "AWARENESS_RESERVED";
            break;
        case eOAIObjectiveType::ENGAGEMENT:
            val = "ENGAGEMENT";
            break;
        default:
            break;
