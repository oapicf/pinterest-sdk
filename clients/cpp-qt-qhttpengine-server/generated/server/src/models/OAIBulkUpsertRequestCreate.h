...
public:
    ...
    QList<OAIMultiple_product_groups_inner> getCatalogProductGroups() const;
    void setCatalogProductGroups(const QList<OAIMultiple_product_groups_inner> &catalog_product_groups);
    ...
    QList<OAILabelCreateRequest> getLabels() const;
    void setLabels(const QList<OAILabelCreateRequest> &labels);
...
private:
    ...
    QList<OAIMultiple_product_groups_inner> catalog_product_groups;
    ...
    QList<OAILabelCreateRequest> labels;
    bool m_labels_isSet;
