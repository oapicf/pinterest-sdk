...
private:
    ...
    QList<OAIAdGroupCreateRequest> ad_groups;
    bool m_ad_groups_isSet;
    bool m_ad_groups_isValid;

    QList<OAIAdCreateRequest> ads;
    bool m_ads_isSet;
    bool m_ads_isValid;

    QList<OAICampaignCreateRequest> campaigns;
    bool m_campaigns_isSet;
    bool m_campaigns_isValid;

    QList<OAIBulkUpsertRequestCreateCatalogProductGroupsItems> catalog_product_groups;
    bool m_catalog_product_groups_isSet;
    bool m_catalog_product_groups_isValid;

    QList<OAIKeywordsRequest> keywords;
    bool m_keywords_isSet;
    bool m_keywords_isValid;

    QList<OAILabelBulkCreateRequest> labels;
    bool m_labels_isSet;
    bool m_labels_isValid;

    QList<OAIProductGroupPromotionCreateRequest> product_groups;
    bool m_product_groups_isSet;
    bool m_product_groups_isValid;

    QList<OAIScheduleCreateRequest> schedules;
