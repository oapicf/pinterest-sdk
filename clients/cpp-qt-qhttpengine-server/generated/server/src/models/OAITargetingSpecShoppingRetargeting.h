...
/*
 * OAITargetingSpecShoppingRetargeting.h
 *
 * 
 */

#ifndef OAITargetingSpecShoppingRetargeting_H
#define OAITargetingSpecShoppingRetargeting_H
...
class OAITargetingSpecShoppingRetargeting : public OAIObject {
public:
    OAITargetingSpecShoppingRetargeting();
    OAITargetingSpecShoppingRetargeting(QString json);
    ~OAITargetingSpecShoppingRetargeting() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITargetingSpecShoppingRetargeting)

#endif // OAITargetingSpecShoppingRetargeting_H
