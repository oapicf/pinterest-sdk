...
void OAICatalogsItemValidationDetails::fromJsonObject(QJsonObject json) {
    ...
    m_attribute_name_isValid = ::OpenAPI::fromJsonValue(attribute_name, json[QString("attribute_name")]);
    m_attribute_name_isSet = !json[QString("attribute_name")].isNull() && m_attribute_name_isValid;

    m_provided_value_isValid = ::OpenAPI::fromJsonValue(provided_value, json[QString("provided_value")]);
...
QJsonObject OAICatalogsItemValidationDetails::asJsonObject() const {
    ...
    if (attribute_name.isSet()) {
        obj.insert(QString("attribute_name"), ::OpenAPI::toJsonValue(attribute_name));
    }
    if (m_provided_value_isSet) {
        obj.insert(QString("provided_value"), ::OpenAPI::toJsonValue(provided_value));
    }
    return obj;
}
...
void OAICatalogsItemValidationDetails::setProvidedValue(const QString &provided_value) {
    ...
    this->m_provided_value_isSet = true;
}
