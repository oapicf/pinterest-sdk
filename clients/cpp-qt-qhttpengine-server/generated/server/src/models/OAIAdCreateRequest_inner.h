...
/*
 * OAIAdCreateRequest_inner.h
 *
 * 
 */

#ifndef OAIAdCreateRequest_inner_H
#define OAIAdCreateRequest_inner_H
...
class OAIAdCreateRequest_inner : public OAIObject {
public:
    OAIAdCreateRequest_inner();
    OAIAdCreateRequest_inner(QString json);
    ~OAIAdCreateRequest_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAdCreateRequest_inner)

#endif // OAIAdCreateRequest_inner_H
