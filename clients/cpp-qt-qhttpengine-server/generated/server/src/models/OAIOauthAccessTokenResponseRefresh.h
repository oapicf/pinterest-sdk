...
/*
 * OAIOauthAccessTokenResponseRefresh.h
 *
 * A successful OAuth access token response for the refresh token flow.
 */

#ifndef OAIOauthAccessTokenResponseRefresh_H
#define OAIOauthAccessTokenResponseRefresh_H
...
class OAIOauthAccessTokenResponseRefresh : public OAIObject {
public:
    OAIOauthAccessTokenResponseRefresh();
    OAIOauthAccessTokenResponseRefresh(QString json);
    ~OAIOauthAccessTokenResponseRefresh() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOauthAccessTokenResponseRefresh)

#endif // OAIOauthAccessTokenResponseRefresh_H
