...
void OAIPinCreate::fromJsonObject(QJsonObject json) {
    ...
    m_sponsor_id_isValid = ::OpenAPI::fromJsonValue(sponsor_id, json[QString("sponsor_id")]);
...
QJsonObject OAIPinCreate::asJsonObject() const {
    ...
    if (m_sponsor_id_isSet) {
        obj.insert(QString("sponsor_id"), ::OpenAPI::toJsonValue(sponsor_id));
    }
    if (m_title_isSet) {
