...
public:
    ...
    OAIConversionEventsDataItems(QString json);
...
private:
    ...
    OAIConversionEventAppInfo app_info;
    ...
    OAIConversionEventsDataItemsCustomData custom_data;
    ...
    OAIConversionEventDeviceInfo device_info;
    ...
    OAIConversionEventsUserDataProperties user_data;
