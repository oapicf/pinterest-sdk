...
/*
 * OAICatalogsHotelItemsPostFilter.h
 *
 * 
 */

#ifndef OAICatalogsHotelItemsPostFilter_H
#define OAICatalogsHotelItemsPostFilter_H
...
class OAICatalogsHotelItemsPostFilter : public OAIObject {
public:
    OAICatalogsHotelItemsPostFilter();
    OAICatalogsHotelItemsPostFilter(QString json);
    ~OAICatalogsHotelItemsPostFilter() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICatalogsHotelItemsPostFilter)

#endif // OAICatalogsHotelItemsPostFilter_H
