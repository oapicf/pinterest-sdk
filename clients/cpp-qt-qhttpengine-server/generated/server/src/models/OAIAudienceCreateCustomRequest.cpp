...
void OAIAudienceCreateCustomRequest::fromJsonObject(QJsonObject json) {
    ...
    m_sharing_type_isValid = ::OpenAPI::fromJsonValue(sharing_type, json[QString("sharing_type")]);
    m_sharing_type_isSet = !json[QString("sharing_type")].isNull() && m_sharing_type_isValid;

    m_data_party_isValid = ::OpenAPI::fromJsonValue(data_party, json[QString("data_party")]);
...
QJsonObject OAIAudienceCreateCustomRequest::asJsonObject() const {
    ...
    if (sharing_type.isSet()) {
        obj.insert(QString("sharing_type"), ::OpenAPI::toJsonValue(sharing_type));
    }
    if (data_party.isSet()) {
        obj.insert(QString("data_party"), ::OpenAPI::toJsonValue(data_party));
    }
    if (m_category_isSet) {
...
void OAIAudienceCreateCustomRequest::setSharingType(const OAIAudienceSharingType &sharing_type) {
    ...
    this->m_sharing_type_isSet = true;
}
