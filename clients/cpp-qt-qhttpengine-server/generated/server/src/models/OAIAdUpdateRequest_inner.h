...
/*
 * OAIAdUpdateRequest_inner.h
 *
 * 
 */

#ifndef OAIAdUpdateRequest_inner_H
#define OAIAdUpdateRequest_inner_H
...
class OAIAdUpdateRequest_inner : public OAIObject {
public:
    OAIAdUpdateRequest_inner();
    OAIAdUpdateRequest_inner(QString json);
    ~OAIAdUpdateRequest_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAdUpdateRequest_inner)

#endif // OAIAdUpdateRequest_inner_H
