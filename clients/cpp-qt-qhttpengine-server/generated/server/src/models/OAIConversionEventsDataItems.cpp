...
OAIConversionEventsDataItems::OAIConversionEventsDataItems(QString json) {
...
void OAIConversionEventsDataItems::fromJson(QString jsonString) {
...
void OAIConversionEventsDataItems::fromJsonObject(QJsonObject json) {
    ...
    m_app_info_isValid = ::OpenAPI::fromJsonValue(app_info, json[QString("app_info")]);
    ...
    m_device_info_isValid = ::OpenAPI::fromJsonValue(device_info, json[QString("device_info")]);
...
QJsonObject OAIConversionEventsDataItems::asJsonObject() const {
    ...
    if (app_info.isSet()) {
        obj.insert(QString("app_info"), ::OpenAPI::toJsonValue(app_info));
    }
    if (m_app_name_isSet) {
    ...
    if (device_info.isSet()) {
        obj.insert(QString("device_info"), ::OpenAPI::toJsonValue(device_info));
    }
