...
QString OAIConversionEvents_data_inner_custom_data::getExternalMeasurementId() const {
    return external_measurement_id;
}
void OAIConversionEvents_data_inner_custom_data::setExternalMeasurementId(const QString &external_measurement_id) {
    this->external_measurement_id = external_measurement_id;
    this->m_external_measurement_id_isSet = true;
}

bool OAIConversionEvents_data_inner_custom_data::is_external_measurement_id_Set() const{
    return m_external_measurement_id_isSet;
}

bool OAIConversionEvents_data_inner_custom_data::is_external_measurement_id_Valid() const{
    return m_external_measurement_id_isValid;
}

qint32 OAIConversionEvents_data_inner_custom_data::getExternalMeasurementVendorId() const {
    return external_measurement_vendor_id;
}
void OAIConversionEvents_data_inner_custom_data::setExternalMeasurementVendorId(const qint32 &external_measurement_vendor_id) {
    this->external_measurement_vendor_id = external_measurement_vendor_id;
    this->m_external_measurement_vendor_id_isSet = true;
}

bool OAIConversionEvents_data_inner_custom_data::is_external_measurement_vendor_id_Set() const{
    return m_external_measurement_vendor_id_isSet;
}

bool OAIConversionEvents_data_inner_custom_data::is_external_measurement_vendor_id_Valid() const{
...
QString OAIConversionEvents_data_inner_custom_data::getPredictedLtv() const {
    return predicted_ltv;
}
void OAIConversionEvents_data_inner_custom_data::setPredictedLtv(const QString &predicted_ltv) {
    this->predicted_ltv = predicted_ltv;
    this->m_predicted_ltv_isSet = true;
}

bool OAIConversionEvents_data_inner_custom_data::is_predicted_ltv_Set() const{
    return m_predicted_ltv_isSet;
}

bool OAIConversionEvents_data_inner_custom_data::is_predicted_ltv_Valid() const{
