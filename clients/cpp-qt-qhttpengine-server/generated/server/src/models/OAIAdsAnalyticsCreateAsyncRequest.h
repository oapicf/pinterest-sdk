...
private:
    ...
    QList<OAICampaignObjectiveType> campaign_objective_types;
    ...
    QList<OAICustomConversionEventMetrics> custom_conversion_event_metrics;
    ...
    QList<OAIAdAdsAnalyticsAsyncTargetingTypes> targeting_types;
