...
/*
 * OAIItemResponse_oneOf_1.h
 *
 * Error item response
 */

#ifndef OAIItemResponse_oneOf_1_H
#define OAIItemResponse_oneOf_1_H
...
class OAIItemResponse_oneOf_1 : public OAIObject {
public:
    OAIItemResponse_oneOf_1();
    OAIItemResponse_oneOf_1(QString json);
    ~OAIItemResponse_oneOf_1() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIItemResponse_oneOf_1)

#endif // OAIItemResponse_oneOf_1_H
