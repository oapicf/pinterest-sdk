...
public:
    ...
    QList<OAIAnalyticsMetricsResponse_daily_metrics> getDailyMetrics() const;
    void setDailyMetrics(const QList<OAIAnalyticsMetricsResponse_daily_metrics> &daily_metrics);
...
private:
    ...
    QList<OAIAnalyticsMetricsResponse_daily_metrics> daily_metrics;
