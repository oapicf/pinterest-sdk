...
OAIMediaUploadParameters OAIMediaUpload::getUploadParameters() const {
    return upload_parameters;
}
void OAIMediaUpload::setUploadParameters(const OAIMediaUploadParameters &upload_parameters) {
