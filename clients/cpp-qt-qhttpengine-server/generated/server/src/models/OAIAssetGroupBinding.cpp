...
void OAIAssetGroupBinding::initializeModel() {
    ...
    m_catalogs_ids_isSet = false;
    m_catalogs_ids_isValid = false;
...
void OAIAssetGroupBinding::fromJsonObject(QJsonObject json) {
    ...
    m_ad_accounts_ids_isValid = ::OpenAPI::fromJsonValue(ad_accounts_ids, json[QString("ad_accounts_ids")]);
    ...
    m_catalogs_ids_isValid = ::OpenAPI::fromJsonValue(catalogs_ids, json[QString("catalogs_ids")]);
    m_catalogs_ids_isSet = !json[QString("catalogs_ids")].isNull() && m_catalogs_ids_isValid;
    ...
    m_profiles_ids_isValid = ::OpenAPI::fromJsonValue(profiles_ids, json[QString("profiles_ids")]);
...
QJsonObject OAIAssetGroupBinding::asJsonObject() const {
    QJsonObject obj;
    if (ad_accounts_ids.size() > 0) {
        obj.insert(QString("ad_accounts_ids"), ::OpenAPI::toJsonValue(ad_accounts_ids));
    }
    ...
    if (catalogs_ids.size() > 0) {
        obj.insert(QString("catalogs_ids"), ::OpenAPI::toJsonValue(catalogs_ids));
    }
    if (created_by.isSet()) {
    ...
    if (profiles_ids.size() > 0) {
        obj.insert(QString("profiles_ids"), ::OpenAPI::toJsonValue(profiles_ids));
    }
...
void OAIAssetGroupBinding::setAdAccountsIds(const QList<QString> &ad_accounts_ids) {
    ...
    this->m_ad_accounts_ids_isSet = true;
}
...
QList<QString> OAIAssetGroupBinding::getCatalogsIds() const {
    return catalogs_ids;
}
void OAIAssetGroupBinding::setCatalogsIds(const QList<QString> &catalogs_ids) {
    this->catalogs_ids = catalogs_ids;
    this->m_catalogs_ids_isSet = true;
}

bool OAIAssetGroupBinding::is_catalogs_ids_Set() const{
    return m_catalogs_ids_isSet;
}

bool OAIAssetGroupBinding::is_catalogs_ids_Valid() const{
    return m_catalogs_ids_isValid;
}
...
void OAIAssetGroupBinding::setProfilesIds(const QList<QString> &profiles_ids) {
    ...
    this->m_profiles_ids_isSet = true;
}
...
bool OAIAssetGroupBinding::isValid() const {
    ...
    return m_ad_accounts_ids_isValid && m_asset_group_description_isValid && m_asset_group_name_isValid && m_asset_group_types_isValid && m_catalogs_ids_isValid && m_created_by_isValid && m_created_time_isValid && m_id_isValid && m_owner_isValid && m_profiles_ids_isValid && m_updated_time_isValid && true;
}
