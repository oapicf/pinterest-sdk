...
OAICampaignSummaryStatus OAICampaignCommon::getSummaryStatus() const {
    return summary_status;
}
void OAICampaignCommon::setSummaryStatus(const OAICampaignSummaryStatus &summary_status) {
    this->summary_status = summary_status;
    this->m_summary_status_isSet = true;
}

bool OAICampaignCommon::is_summary_status_Set() const{
    return m_summary_status_isSet;
}

bool OAICampaignCommon::is_summary_status_Valid() const{
