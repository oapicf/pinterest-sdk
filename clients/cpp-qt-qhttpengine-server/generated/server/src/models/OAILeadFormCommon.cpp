...
QList<OAILeadFormCommon_policy_links_inner> OAILeadFormCommon::getPolicyLinks() const {
    return policy_links;
}
void OAILeadFormCommon::setPolicyLinks(const QList<OAILeadFormCommon_policy_links_inner> &policy_links) {
    this->policy_links = policy_links;
    this->m_policy_links_isSet = true;
}

bool OAILeadFormCommon::is_policy_links_Set() const{
    return m_policy_links_isSet;
}

bool OAILeadFormCommon::is_policy_links_Valid() const{
