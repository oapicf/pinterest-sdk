...
OAIAdGroupCommon_tracking_urls::OAIAdGroupCommon_tracking_urls(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAdGroupCommon_tracking_urls::OAIAdGroupCommon_tracking_urls() {
    this->initializeModel();
}

OAIAdGroupCommon_tracking_urls::~OAIAdGroupCommon_tracking_urls() {}

void OAIAdGroupCommon_tracking_urls::initializeModel() {
...
void OAIAdGroupCommon_tracking_urls::fromJson(QString jsonString) {
...
void OAIAdGroupCommon_tracking_urls::fromJsonObject(QJsonObject json) {
...
QString OAIAdGroupCommon_tracking_urls::asJson() const {
...
QJsonObject OAIAdGroupCommon_tracking_urls::asJsonObject() const {
    QJsonObject obj;
...
QList<QString> OAIAdGroupCommon_tracking_urls::getImpression() const {
    return impression;
}
void OAIAdGroupCommon_tracking_urls::setImpression(const QList<QString> &impression) {
    this->impression = impression;
    this->m_impression_isSet = true;
}

bool OAIAdGroupCommon_tracking_urls::is_impression_Set() const{
    return m_impression_isSet;
}

bool OAIAdGroupCommon_tracking_urls::is_impression_Valid() const{
    return m_impression_isValid;
}

QList<QString> OAIAdGroupCommon_tracking_urls::getClick() const {
    return click;
}
void OAIAdGroupCommon_tracking_urls::setClick(const QList<QString> &click) {
    this->click = click;
    this->m_click_isSet = true;
}

bool OAIAdGroupCommon_tracking_urls::is_click_Set() const{
    return m_click_isSet;
}

bool OAIAdGroupCommon_tracking_urls::is_click_Valid() const{
    return m_click_isValid;
}

QList<QString> OAIAdGroupCommon_tracking_urls::getEngagement() const {
    return engagement;
}
void OAIAdGroupCommon_tracking_urls::setEngagement(const QList<QString> &engagement) {
    this->engagement = engagement;
    this->m_engagement_isSet = true;
}

bool OAIAdGroupCommon_tracking_urls::is_engagement_Set() const{
    return m_engagement_isSet;
}

bool OAIAdGroupCommon_tracking_urls::is_engagement_Valid() const{
    return m_engagement_isValid;
}

QList<QString> OAIAdGroupCommon_tracking_urls::getBuyableButton() const {
    return buyable_button;
}
void OAIAdGroupCommon_tracking_urls::setBuyableButton(const QList<QString> &buyable_button) {
    this->buyable_button = buyable_button;
    this->m_buyable_button_isSet = true;
}

bool OAIAdGroupCommon_tracking_urls::is_buyable_button_Set() const{
    return m_buyable_button_isSet;
}

bool OAIAdGroupCommon_tracking_urls::is_buyable_button_Valid() const{
    return m_buyable_button_isValid;
}

QList<QString> OAIAdGroupCommon_tracking_urls::getAudienceVerification() const {
    return audience_verification;
}
void OAIAdGroupCommon_tracking_urls::setAudienceVerification(const QList<QString> &audience_verification) {
    this->audience_verification = audience_verification;
    this->m_audience_verification_isSet = true;
}

bool OAIAdGroupCommon_tracking_urls::is_audience_verification_Set() const{
    return m_audience_verification_isSet;
}

bool OAIAdGroupCommon_tracking_urls::is_audience_verification_Valid() const{
    return m_audience_verification_isValid;
}

bool OAIAdGroupCommon_tracking_urls::isSet() const {
...
bool OAIAdGroupCommon_tracking_urls::isValid() const {
