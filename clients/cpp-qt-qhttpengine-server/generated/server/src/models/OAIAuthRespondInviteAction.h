...
/*
 * OAIAuthRespondInviteAction.h
 *
 * 
 */

#ifndef OAIAuthRespondInviteAction_H
#define OAIAuthRespondInviteAction_H
...
class OAIAuthRespondInviteAction : public OAIObject {
public:
    OAIAuthRespondInviteAction();
    OAIAuthRespondInviteAction(QString json);
    ~OAIAuthRespondInviteAction() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAuthRespondInviteAction)

#endif // OAIAuthRespondInviteAction_H
