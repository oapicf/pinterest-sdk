...
OAITargetingSpec_1::OAITargetingSpec_1(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITargetingSpec_1::OAITargetingSpec_1() {
    this->initializeModel();
}

OAITargetingSpec_1::~OAITargetingSpec_1() {}

void OAITargetingSpec_1::initializeModel() {
...
void OAITargetingSpec_1::fromJson(QString jsonString) {
...
void OAITargetingSpec_1::fromJsonObject(QJsonObject json) {
...
QString OAITargetingSpec_1::asJson() const {
...
QJsonObject OAITargetingSpec_1::asJsonObject() const {
    QJsonObject obj;
...
QList<QString> OAITargetingSpec_1::getAgeBucket() const {
    return age_bucket;
}
void OAITargetingSpec_1::setAgeBucket(const QList<QString> &age_bucket) {
    this->age_bucket = age_bucket;
    this->m_age_bucket_isSet = true;
}

bool OAITargetingSpec_1::is_age_bucket_Set() const{
    return m_age_bucket_isSet;
}

bool OAITargetingSpec_1::is_age_bucket_Valid() const{
    return m_age_bucket_isValid;
}

QList<QString> OAITargetingSpec_1::getApptype() const {
    return apptype;
}
void OAITargetingSpec_1::setApptype(const QList<QString> &apptype) {
    this->apptype = apptype;
    this->m_apptype_isSet = true;
}

bool OAITargetingSpec_1::is_apptype_Set() const{
    return m_apptype_isSet;
}

bool OAITargetingSpec_1::is_apptype_Valid() const{
    return m_apptype_isValid;
}

QList<QString> OAITargetingSpec_1::getAudienceExclude() const {
    return audience_exclude;
}
void OAITargetingSpec_1::setAudienceExclude(const QList<QString> &audience_exclude) {
    this->audience_exclude = audience_exclude;
    this->m_audience_exclude_isSet = true;
}

bool OAITargetingSpec_1::is_audience_exclude_Set() const{
    return m_audience_exclude_isSet;
}

bool OAITargetingSpec_1::is_audience_exclude_Valid() const{
    return m_audience_exclude_isValid;
}

QList<QString> OAITargetingSpec_1::getAudienceInclude() const {
    return audience_include;
}
void OAITargetingSpec_1::setAudienceInclude(const QList<QString> &audience_include) {
    this->audience_include = audience_include;
    this->m_audience_include_isSet = true;
}

bool OAITargetingSpec_1::is_audience_include_Set() const{
    return m_audience_include_isSet;
}

bool OAITargetingSpec_1::is_audience_include_Valid() const{
    return m_audience_include_isValid;
}

QList<QString> OAITargetingSpec_1::getGender() const {
    return gender;
}
void OAITargetingSpec_1::setGender(const QList<QString> &gender) {
    this->gender = gender;
    this->m_gender_isSet = true;
}

bool OAITargetingSpec_1::is_gender_Set() const{
    return m_gender_isSet;
}

bool OAITargetingSpec_1::is_gender_Valid() const{
    return m_gender_isValid;
}

QList<QString> OAITargetingSpec_1::getGeo() const {
    return geo;
}
void OAITargetingSpec_1::setGeo(const QList<QString> &geo) {
    this->geo = geo;
    this->m_geo_isSet = true;
}

bool OAITargetingSpec_1::is_geo_Set() const{
    return m_geo_isSet;
}

bool OAITargetingSpec_1::is_geo_Valid() const{
    return m_geo_isValid;
}

QList<QString> OAITargetingSpec_1::getInterest() const {
    return interest;
}
void OAITargetingSpec_1::setInterest(const QList<QString> &interest) {
    this->interest = interest;
    this->m_interest_isSet = true;
}

bool OAITargetingSpec_1::is_interest_Set() const{
    return m_interest_isSet;
}

bool OAITargetingSpec_1::is_interest_Valid() const{
    return m_interest_isValid;
}

QList<QString> OAITargetingSpec_1::getLocale() const {
    return locale;
}
void OAITargetingSpec_1::setLocale(const QList<QString> &locale) {
    this->locale = locale;
    this->m_locale_isSet = true;
}

bool OAITargetingSpec_1::is_locale_Set() const{
    return m_locale_isSet;
}

bool OAITargetingSpec_1::is_locale_Valid() const{
    return m_locale_isValid;
}

QList<QString> OAITargetingSpec_1::getLocation() const {
    return location;
}
void OAITargetingSpec_1::setLocation(const QList<QString> &location) {
    this->location = location;
    this->m_location_isSet = true;
}

bool OAITargetingSpec_1::is_location_Set() const{
    return m_location_isSet;
}

bool OAITargetingSpec_1::is_location_Valid() const{
    return m_location_isValid;
}

QList<OAITargetingSpec_SHOPPING_RETARGETING> OAITargetingSpec_1::getShoppingRetargeting() const {
    return shopping_retargeting;
}
void OAITargetingSpec_1::setShoppingRetargeting(const QList<OAITargetingSpec_SHOPPING_RETARGETING> &shopping_retargeting) {
    this->shopping_retargeting = shopping_retargeting;
    this->m_shopping_retargeting_isSet = true;
}

bool OAITargetingSpec_1::is_shopping_retargeting_Set() const{
    return m_shopping_retargeting_isSet;
}

bool OAITargetingSpec_1::is_shopping_retargeting_Valid() const{
    return m_shopping_retargeting_isValid;
}

QList<QString> OAITargetingSpec_1::getTargetingStrategy() const {
    return targeting_strategy;
}
void OAITargetingSpec_1::setTargetingStrategy(const QList<QString> &targeting_strategy) {
    this->targeting_strategy = targeting_strategy;
    this->m_targeting_strategy_isSet = true;
}

bool OAITargetingSpec_1::is_targeting_strategy_Set() const{
    return m_targeting_strategy_isSet;
}

bool OAITargetingSpec_1::is_targeting_strategy_Valid() const{
    return m_targeting_strategy_isValid;
}

bool OAITargetingSpec_1::isSet() const {
...
bool OAITargetingSpec_1::isValid() const {
