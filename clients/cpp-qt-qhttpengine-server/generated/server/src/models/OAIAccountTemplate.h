...
/*
 * OAIAccountTemplate.h
 *
 * 
 */

#ifndef OAIAccountTemplate_H
#define OAIAccountTemplate_H
...
class OAIAccountTemplate : public OAIObject {
public:
    OAIAccountTemplate();
    OAIAccountTemplate(QString json);
    ~OAIAccountTemplate() override;
    ...
    QList<QString> getAdeColumns() const;
    void setAdeColumns(const QList<QString> &ade_columns);
    bool is_ade_columns_Set() const;
    bool is_ade_columns_Valid() const;

    OAIAnyType getAttributionType() const;
    void setAttributionType(const OAIAnyType &attribution_type);
    ...
    QList<OAIReportingColumn> getColumns() const;
    void setColumns(const QList<OAIReportingColumn> &columns);
    bool is_columns_Set() const;
    bool is_columns_Valid() const;

    OAIConversionReportTimeType getConversionReportTimeType() const;
    void setConversionReportTimeType(const OAIConversionReportTimeType &conversion_report_time_type);
    bool is_conversion_report_time_type_Set() const;
    bool is_conversion_report_time_type_Valid() const;

    OAICreationSource getCreationSource() const;
    void setCreationSource(const OAICreationSource &creation_source);
    ...
    QString getDisplayMetadata() const;
    void setDisplayMetadata(const QString &display_metadata);
    ...
    QList<OAIIngestionSource> getIngestionSources() const;
    void setIngestionSources(const QList<OAIIngestionSource> &ingestion_sources);
    ...
    void setReportingTimeZone(const OAIReportingTimeZone &reporting_time_zone);
    bool is_reporting_time_zone_Set() const;
    bool is_reporting_time_zone_Valid() const;

    OAIAnyType getSortBy() const;
    void setSortBy(const OAIAnyType &sort_by);
...
private:
    ...
    QList<QString> ad_account_ids;
    bool m_ad_account_ids_isSet;
    bool m_ad_account_ids_isValid;

    QList<QString> ade_columns;
    bool m_ade_columns_isSet;
    bool m_ade_columns_isValid;

    OAIAnyType attribution_type;
    ...
    QList<OAIIngestionSource> ingestion_sources;
    ...
    OAIMetricsReportingLevel report_level;
    ...
    OAIReportingTimeZone reporting_time_zone;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAccountTemplate)

#endif // OAIAccountTemplate_H
