...
public:
    ...
    qint32 getDuplicateLinks() const;
    void setDuplicateLinks(const qint32 &duplicate_links);
    bool is_duplicate_links_Set() const;
    bool is_duplicate_links_Valid() const;
...
private:
    ...
    qint32 duplicate_links;
    bool m_duplicate_links_isSet;
    bool m_duplicate_links_isValid;
