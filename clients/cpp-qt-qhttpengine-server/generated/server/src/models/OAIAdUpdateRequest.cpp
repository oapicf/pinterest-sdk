...
QString OAIAdUpdateRequest::getCustomizableCtaType() const {
    return customizable_cta_type;
}
void OAIAdUpdateRequest::setCustomizableCtaType(const QString &customizable_cta_type) {
...
OAIAdCommon_quiz_pin_data OAIAdUpdateRequest::getQuizPinData() const {
    return quiz_pin_data;
}
void OAIAdUpdateRequest::setQuizPinData(const OAIAdCommon_quiz_pin_data &quiz_pin_data) {
