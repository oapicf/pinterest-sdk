...
OAIProductGroupPromotionResponseElement OAIProductGroupPromotionResponseItem::getData() const {
    return data;
}
void OAIProductGroupPromotionResponseItem::setData(const OAIProductGroupPromotionResponseElement &data) {
    this->data = data;
