...
void OAIBoardsApiHandler::boardSections_create(QString board_id, OAIBoardSectionCreate oai_board_section_create, QString ad_account_id) {
    Q_UNUSED(board_id);
    Q_UNUSED(oai_board_section_create);
...
void OAIBoardsApiHandler::boardSections_delete(QString board_id, QString section_id, QString ad_account_id) {
    ...
    {
        OAIBoardSection res;
        reqObj->boardSections_deleteResponse(res);
    }
}
...
void OAIBoardsApiHandler::boardSections_update(QString board_id, QString section_id, OAIBoardSectionUpdateWithRequiredBody oai_board_section_update_with_required_body, QString ad_account_id) {
    Q_UNUSED(board_id);
    Q_UNUSED(section_id);
    Q_UNUSED(oai_board_section_update_with_required_body);
    Q_UNUSED(ad_account_id);
    auto reqObj = qobject_cast<OAIBoardsApiRequest*>(sender());
    if( reqObj != nullptr )
    {
...
void OAIBoardsApiHandler::boards_create(OAIBoardCreate oai_board_create, QString ad_account_id) {
    Q_UNUSED(oai_board_create);
    Q_UNUSED(ad_account_id);
    auto reqObj = qobject_cast<OAIBoardsApiRequest*>(sender());
    if( reqObj != nullptr )
    {
...
void OAIBoardsApiHandler::boards_delete(QString board_id, QString ad_account_id) {
    ...
    {
        OAIBoard res;
        reqObj->boards_deleteResponse(res);
    }
}
...
void OAIBoardsApiHandler::boards_list(QString ad_account_id, OAIBoardPrivacyFilter privacy, QString bookmark, qint32 page_size) {
    Q_UNUSED(ad_account_id);
    Q_UNUSED(privacy);
    Q_UNUSED(bookmark);
    Q_UNUSED(page_size);
...
void OAIBoardsApiHandler::boards_listPins(QString board_id, QList<OAICreativeType> creative_types, QString ad_account_id, bool pin_metrics, QString bookmark, qint32 page_size) {
    Q_UNUSED(board_id);
...
void OAIBoardsApiHandler::boards_update(QString board_id, OAIBoardWithUpdatePrivacyUpdate oai_board_with_update_privacy_update, QString ad_account_id) {
    Q_UNUSED(board_id);
    Q_UNUSED(oai_board_with_update_privacy_update);
    Q_UNUSED(ad_account_id);
    auto reqObj = qobject_cast<OAIBoardsApiRequest*>(sender());
    if( reqObj != nullptr )
    {
        OAIBoardWithUpdatePrivacy res;
