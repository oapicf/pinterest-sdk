...
void OAIBoardsApiHandler::boards_listPins(QString board_id, QString bookmark, qint32 page_size, QList<OAICreativeType> creative_types, QString ad_account_id, bool pin_metrics) {
    Q_UNUSED(board_id);
    Q_UNUSED(bookmark);
    Q_UNUSED(page_size);
