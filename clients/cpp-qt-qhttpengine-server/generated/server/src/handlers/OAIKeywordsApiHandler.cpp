...
void OAIKeywordsApiHandler::keywords_get(QString ad_account_id, QString campaign_id, QString ad_group_id, QList<QString> ad_group_ids, QList<OAIMatchType> match_types, qint32 page_size, QString bookmark) {
    Q_UNUSED(ad_account_id);
...
void OAIKeywordsApiHandler::trendingKeywords_list(OAITrendsSupportedRegion region, OAITrendType trend_type, QList<QString> interests, QList<QString> genders, QList<QString> ages, QList<QString> include_keywords, bool normalize_against_group, qint32 limit, bool include_prediction, bool include_demographics) {
    Q_UNUSED(region);
    Q_UNUSED(trend_type);
    Q_UNUSED(interests);
    Q_UNUSED(genders);
