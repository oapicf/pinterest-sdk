...
void OAIConversionTagsApiHandler::conversionTags_list(QString ad_account_id, bool filter_deleted) {
    ...
    if( reqObj != nullptr )
    {
        OAIConversion_tags_list_200_response res;
...
void OAIConversionTagsApiHandler::pageVisitConversionTags_get(QString ad_account_id, QString bookmark, qint32 page_size, OAIPinterest_Lib_PaginationOrder order) {
    Q_UNUSED(ad_account_id);
    Q_UNUSED(bookmark);
    Q_UNUSED(page_size);
    Q_UNUSED(order);
