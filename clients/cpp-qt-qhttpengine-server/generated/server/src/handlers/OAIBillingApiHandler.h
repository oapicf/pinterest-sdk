...
public Q_SLOTS:
    ...
    virtual void billingInvoices_get(QString ad_account_id, QString bookmark, qint32 page_size, QString sort, QString order, QString status, QString document_type, QDate start_due_date, QDate end_due_date);
