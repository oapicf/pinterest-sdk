...
public Q_SLOTS:
    ...
    virtual void cancelInvitesOrRequests(QString business_id, OAICancelInvitesRequest oai_cancel_invites_request);
    ...
    virtual void get_invites(QString business_id, bool is_member, QList<OAIInviteFilterStatus> invite_status, OAIInviteType invite_type, QString bookmark, qint32 page_size);
