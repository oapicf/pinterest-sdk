...
public:
    ...
    void setOAIProductGroupsApiHandler(QSharedPointer<OAIProductGroupsApiHandler> handler);
...
private:
    ...
    QSharedPointer<OAIProductGroupsApiHandler> mOAIProductGroupsApiHandler;
