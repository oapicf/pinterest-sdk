...
public:
    ...
    void setOAIProductCategoriesApiHandler(QSharedPointer<OAIProductCategoriesApiHandler> handler);
...
private:
    ...
    QSharedPointer<OAIProductCategoriesApiHandler> mOAIProductCategoriesApiHandler;
