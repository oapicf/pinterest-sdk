...
void OAIResourcesApiHandler::adAccountCountries_get() {
    ...
    if( reqObj != nullptr )
    {
        OAIAd_account_countries_get_200_response res;
        reqObj->adAccountCountries_getResponse(res);
    }
}
void OAIResourcesApiHandler::deliveryMetrics_get(OAIReportType report_type) {
    Q_UNUSED(report_type);
    auto reqObj = qobject_cast<OAIResourcesApiRequest*>(sender());
    if( reqObj != nullptr )
    {
        OAIDelivery_metrics_get_200_response res;
...
void OAIResourcesApiHandler::interestTargetingOptions_get(QString interest_id) {
    ...
    if( reqObj != nullptr )
    {
        OAISingleInterestTargetingOption res;
...
void OAIResourcesApiHandler::targetingOptions_get(OAIPublicTargetingType targeting_type, QString ad_account_id, QString client_id, QString oauth_signature, QString timestamp) {
