...
void OAIApiRouter::createApiHandlers() { 
    ...
    mOAIProductCategoriesApiHandler = QSharedPointer<OAIProductCategoriesApiHandler>::create();
...
void OAIApiRouter::setOAIProductCategoriesApiHandler(QSharedPointer<OAIProductCategoriesApiHandler> handler){
    mOAIProductCategoriesApiHandler = handler;
}
...
void OAIApiRouter::setUpRoutes() {
    ...
    Routes.insert(QString("%1 %2").arg("GET").arg("/v5/trends/topics/featured").toLower(), [this](QHttpEngine::Socket *socket) {
            auto reqObj = new OAIProductCategoriesApiRequest(socket, mOAIProductCategoriesApiHandler);
    ...
    }
    {
        ...
        if ( reqPath.startsWith(completePath.leftRef( completePath.indexOf(QString("/{")))) ) {
            ...
            if ( match.hasMatch() ){
                ...
                auto reqObj = new OAIBusinessAccessRelationshipsApiRequest(socket, mOAIBusinessAccessRelationshipsApiHandler);
                reqObj->brandAccounts_updateRequest(business_hierarchy_id, brand_account_id);
                return true;
            }
        }
    }
    ...
    }
    {
        ...
        if ( reqPath.startsWith(completePath.leftRef( completePath.indexOf(QString("/{")))) ) {
            ...
            if ( match.hasMatch() ){
                ...
                auto reqObj = new OAIPromotionsApiRequest(socket, mOAIPromotionsApiHandler);
                reqObj->promotions_deleteRequest(ad_account_id, promotion_id);
                return true;
            }
        }
    }
    {
        ...
        if ( reqPath.startsWith(completePath.leftRef( completePath.indexOf(QString("/{")))) ) {
            ...
            if ( match.hasMatch() ){
                ...
                QString promotion_id = match.captured(QString("promotion_id").toLower());
                auto reqObj = new OAIPromotionsApiRequest(socket, mOAIPromotionsApiHandler);
                reqObj->promotions_getRequest(ad_account_id, promotion_id);
                return true;
            }
        }
    }
