...
void OAIAdAccountsApiHandler::adAccount_analytics(QString ad_account_id, QDate start_date, QDate end_date, QList<QString> columns, OAIGranularity granularity, qint32 click_window_days, qint32 engagement_window_days, qint32 view_window_days, QString conversion_report_time, OAIReportingTimeZone reporting_timezone) {
    Q_UNUSED(ad_account_id);
    Q_UNUSED(start_date);
    Q_UNUSED(end_date);
    Q_UNUSED(columns);
...
void OAIAdAccountsApiHandler::analytics_createConversionProductReport(QString ad_account_id, OAIConversionProductReportRequest oai_conversion_product_report_request) {
    Q_UNUSED(ad_account_id);
    Q_UNUSED(oai_conversion_product_report_request);
    auto reqObj = qobject_cast<OAIAdAccountsApiRequest*>(sender());
    if( reqObj != nullptr )
    {
