...
void OAIBusinessAccessRelationshipsApiHandler::brandAccounts_create(QString business_hierarchy_id, OAIBrand_accounts_create_request oai_brand_accounts_create_request) {
    Q_UNUSED(business_hierarchy_id);
    Q_UNUSED(oai_brand_accounts_create_request);
    auto reqObj = qobject_cast<OAIBusinessAccessRelationshipsApiRequest*>(sender());
    if( reqObj != nullptr )
    {
        OAIBrand_accounts_create_200_response res;
        reqObj->brandAccounts_createResponse(res);
    }
}
void OAIBusinessAccessRelationshipsApiHandler::brandAccounts_update(QString business_hierarchy_id, QString brand_account_id, OAIBrand_accounts_update_request oai_brand_accounts_update_request) {
    Q_UNUSED(business_hierarchy_id);
    Q_UNUSED(brand_account_id);
    Q_UNUSED(oai_brand_accounts_update_request);
    auto reqObj = qobject_cast<OAIBusinessAccessRelationshipsApiRequest*>(sender());
    if( reqObj != nullptr )
    {
        OAIBrand_accounts_create_200_response res;
...
void OAIBusinessAccessRelationshipsApiHandler::systemUser_update(QString business_id, QString system_user_id, OAISystem_user_update_request oai_system_user_update_request) {
    Q_UNUSED(business_id);
    Q_UNUSED(system_user_id);
    Q_UNUSED(oai_system_user_update_request);
    auto reqObj = qobject_cast<OAIBusinessAccessRelationshipsApiRequest*>(sender());
    if( reqObj != nullptr )
    {
