...
public:
    ...
    void multiPins_analyticsResponse(const QMap<QString, QMap>& res);
    ...
    void multiPins_analyticsError(const QMap<QString, QMap>& res, QNetworkReply::NetworkError error_type, QString& error_str);
...
Q_SIGNALS:
    ...
    void pins_list(QString pin_filter, bool pin_metrics, bool include_protected_pins, QString pin_type, QList<OAICreativeType> creative_types, QString ad_account_id, QString bookmark, qint32 page_size);
    void pins_save(QString pin_id, OAIPins_save_request oai_pins_save_request, QString ad_account_id);
