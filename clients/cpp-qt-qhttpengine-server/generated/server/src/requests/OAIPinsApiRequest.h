...
Q_SIGNALS:
    ...
    void pins_list(QString bookmark, qint32 page_size, QString pin_filter, bool include_protected_pins, QString pin_type, QList<QString> creative_types, QString ad_account_id, bool pin_metrics);
