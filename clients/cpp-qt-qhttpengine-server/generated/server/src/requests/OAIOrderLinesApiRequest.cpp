...
void OAIOrderLinesApiRequest::orderLines_getRequest(const QString& order_line_idstr, const QString& ad_account_idstr){
    ...
    Q_EMIT orderLines_get(order_line_id, ad_account_id);
}
...
void OAIOrderLinesApiRequest::orderLines_listRequest(const QString& ad_account_idstr){
    ...
    Q_EMIT orderLines_list(ad_account_id, bookmark, page_size, order);
}
