...
void OAILeadFormsApiRequest::leadFormTest_createRequest(const QString& ad_account_idstr, const QString& lead_form_idstr){
    ...
    OAILeadFormTestCreate oai_lead_form_test_create;
    ::OpenAPI::fromJsonValue(oai_lead_form_test_create, obj);
    

    Q_EMIT leadFormTest_create(ad_account_id, lead_form_id, oai_lead_form_test_create);
}


void OAILeadFormsApiRequest::leadForm_getRequest(const QString& lead_form_idstr, const QString& ad_account_idstr){
    ...
    Q_EMIT leadForm_get(lead_form_id, ad_account_id);
}
...
void OAILeadFormsApiRequest::leadForms_createRequest(const QString& ad_account_idstr){
    ...
    QJsonDocument doc;
    QList<OAILeadFormCreate> oai_lead_form_create;
    if(socket->readJson(doc)){
        QJsonArray jsonArray = doc.array();
        foreach(QJsonValue obj, jsonArray) {
            OAILeadFormCreate o;
            ::OpenAPI::fromJsonValue(o, obj);
            oai_lead_form_create.append(o);
        }
    }
    

    Q_EMIT leadForms_create(ad_account_id, oai_lead_form_create);
}
...
void OAILeadFormsApiRequest::leadForms_listRequest(const QString& ad_account_idstr){
    ...
    Q_EMIT leadForms_list(ad_account_id, bookmark, page_size, order);
}
...
void OAILeadFormsApiRequest::leadForms_updateRequest(const QString& ad_account_idstr){
    ...
    QJsonDocument doc;
    QList<OAILeadFormBatchUpdate> oai_lead_form_batch_update;
    if(socket->readJson(doc)){
        QJsonArray jsonArray = doc.array();
        foreach(QJsonValue obj, jsonArray) {
            OAILeadFormBatchUpdate o;
            ::OpenAPI::fromJsonValue(o, obj);
            oai_lead_form_batch_update.append(o);
        }
    }
    

    Q_EMIT leadForms_update(ad_account_id, oai_lead_form_batch_update);
}



void OAILeadFormsApiRequest::leadFormTest_createResponse(const OAILeadFormTest& res){
...
void OAILeadFormsApiRequest::leadForm_getResponse(const OAILeadForm& res){
    setSocketResponseHeaders();
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
    socket->writeJson(resDoc);
    if(socket->isOpen()){
...
void OAILeadFormsApiRequest::leadForms_createResponse(const OAILead_forms_create_200_response& res){
    setSocketResponseHeaders();
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
    socket->writeJson(resDoc);
    if(socket->isOpen()){
...
void OAILeadFormsApiRequest::leadForms_updateResponse(const OAILead_forms_create_200_response& res){
    setSocketResponseHeaders();
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
    socket->writeJson(resDoc);
    if(socket->isOpen()){
...
void OAILeadFormsApiRequest::leadFormTest_createError(const OAILeadFormTest& res, QNetworkReply::NetworkError error_type, QString& error_str){
...
void OAILeadFormsApiRequest::leadForm_getError(const OAILeadForm& res, QNetworkReply::NetworkError error_type, QString& error_str){
    Q_UNUSED(error_type); // TODO: Remap error_type to QHttpEngine::Socket errors
    setSocketResponseHeaders();
    Q_UNUSED(error_str);  // response will be used instead of error string
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
...
void OAILeadFormsApiRequest::leadForms_createError(const OAILead_forms_create_200_response& res, QNetworkReply::NetworkError error_type, QString& error_str){
    Q_UNUSED(error_type); // TODO: Remap error_type to QHttpEngine::Socket errors
    setSocketResponseHeaders();
    Q_UNUSED(error_str);  // response will be used instead of error string
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
...
void OAILeadFormsApiRequest::leadForms_updateError(const OAILead_forms_create_200_response& res, QNetworkReply::NetworkError error_type, QString& error_str){
    Q_UNUSED(error_type); // TODO: Remap error_type to QHttpEngine::Socket errors
    setSocketResponseHeaders();
    Q_UNUSED(error_str);  // response will be used instead of error string
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
