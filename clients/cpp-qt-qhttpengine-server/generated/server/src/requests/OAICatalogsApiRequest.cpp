...
void OAICatalogsApiRequest::catalogsProductGroups_createRequest(){
    ...
    Q_EMIT catalogsProductGroups_create(oai_catalogs_product_group_create_request, ad_account_id);
}
...
void OAICatalogsApiRequest::catalogsProductGroups_listRequest(){
    ...
    Q_EMIT catalogsProductGroups_list(feed_id, bookmark, page_size, ad_account_id);
}
...
void OAICatalogsApiRequest::catalogsProductGroups_updateRequest(const QString& product_group_idstr){
    ...
    Q_EMIT catalogsProductGroups_update(product_group_id, oai_catalogs_product_group_update_request, ad_account_id);
}
...
void OAICatalogsApiRequest::feeds_createRequest(){
    ...
    Q_EMIT feeds_create(oai_catalogs_feeds_create_request, ad_account_id);
}
...
void OAICatalogsApiRequest::feeds_listRequest(){
    ...
    Q_EMIT feeds_list(bookmark, page_size, ad_account_id);
}
...
void OAICatalogsApiRequest::feeds_updateRequest(const QString& feed_idstr){
    ...
    Q_EMIT feeds_update(feed_id, oai_catalogs_feeds_update_request, ad_account_id);
}
...
void OAICatalogsApiRequest::itemsBatch_postRequest(){
    ...
    Q_EMIT itemsBatch_post(oai_catalogs_items_batch_request, ad_account_id);
}
...
void OAICatalogsApiRequest::items_getRequest(){
    ...
    Q_EMIT items_get(country, item_ids, language, ad_account_id);
}
