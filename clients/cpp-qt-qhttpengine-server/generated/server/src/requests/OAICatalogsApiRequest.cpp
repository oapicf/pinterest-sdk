...
void OAICatalogsApiRequest::catalogs_createRequest(){
    ...
    OAICatalogCreate oai_catalog_create;
    ::OpenAPI::fromJsonValue(oai_catalog_create, obj);
    

    Q_EMIT catalogs_create(oai_catalog_create, ad_account_id);
}
...
void OAICatalogsApiRequest::catalogs_listRequest(){
    ...
    Q_EMIT catalogs_list(ad_account_id, bookmark, page_size);
}
