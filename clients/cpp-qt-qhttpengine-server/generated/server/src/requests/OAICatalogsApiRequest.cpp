...
void OAICatalogsApiRequest::catalogsProductGroupPins_listRequest(const QString& product_group_idstr){
    ...
    Q_EMIT catalogsProductGroupPins_list(product_group_id, bookmark, page_size, ad_account_id);
}
...
void OAICatalogsApiRequest::catalogsProductGroups_createRequest(){
    ...
    OAICatalogs_product_groups_create_request oai_catalogs_product_groups_create_request;
    ::OpenAPI::fromJsonValue(oai_catalogs_product_groups_create_request, obj);
    

    Q_EMIT catalogsProductGroups_create(oai_catalogs_product_groups_create_request, ad_account_id);
}
...
void OAICatalogsApiRequest::catalogsProductGroups_listRequest(){
    ...
    Q_EMIT catalogsProductGroups_list(feed_id, catalog_id, bookmark, page_size, ad_account_id);
}
...
void OAICatalogsApiRequest::productsByProductGroupFilter_listRequest(){
    ...
    Q_EMIT productsByProductGroupFilter_list(oai_catalogs_list_products_by_filter_request, bookmark, page_size, ad_account_id);
}
...
void OAICatalogsApiRequest::catalogsProductGroups_createResponse(const OAICatalogs_product_groups_create_201_response& res){
    setSocketResponseHeaders();
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
    socket->writeJson(resDoc);
    if(socket->isOpen()){
...
void OAICatalogsApiRequest::catalogsProductGroups_getResponse(const OAICatalogs_product_groups_create_201_response& res){
    setSocketResponseHeaders();
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
    socket->writeJson(resDoc);
    if(socket->isOpen()){
...
void OAICatalogsApiRequest::catalogsProductGroups_updateResponse(const OAICatalogs_product_groups_create_201_response& res){
    setSocketResponseHeaders();
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
    socket->writeJson(resDoc);
    if(socket->isOpen()){
...
void OAICatalogsApiRequest::catalogsProductGroups_createError(const OAICatalogs_product_groups_create_201_response& res, QNetworkReply::NetworkError error_type, QString& error_str){
    Q_UNUSED(error_type); // TODO: Remap error_type to QHttpEngine::Socket errors
    setSocketResponseHeaders();
    Q_UNUSED(error_str);  // response will be used instead of error string
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
...
void OAICatalogsApiRequest::catalogsProductGroups_getError(const OAICatalogs_product_groups_create_201_response& res, QNetworkReply::NetworkError error_type, QString& error_str){
    Q_UNUSED(error_type); // TODO: Remap error_type to QHttpEngine::Socket errors
    setSocketResponseHeaders();
    Q_UNUSED(error_str);  // response will be used instead of error string
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
...
void OAICatalogsApiRequest::catalogsProductGroups_updateError(const OAICatalogs_product_groups_create_201_response& res, QNetworkReply::NetworkError error_type, QString& error_str){
    Q_UNUSED(error_type); // TODO: Remap error_type to QHttpEngine::Socket errors
    setSocketResponseHeaders();
    Q_UNUSED(error_str);  // response will be used instead of error string
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
