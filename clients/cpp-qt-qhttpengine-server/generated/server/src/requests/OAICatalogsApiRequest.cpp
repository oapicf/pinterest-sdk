...
void OAICatalogsApiRequest::catalogsProductGroups_createRequest(){
    ...
    emit catalogsProductGroups_create(oai_catalogs_product_group_create_request);
}
...
void OAICatalogsApiRequest::catalogsProductGroups_deleteRequest(const QString& product_group_idstr){
    ...
    emit catalogsProductGroups_delete(product_group_id);
}
...
void OAICatalogsApiRequest::catalogsProductGroups_listRequest(){
    ...
    emit catalogsProductGroups_list(feed_id, bookmark, page_size);
}
...
void OAICatalogsApiRequest::catalogsProductGroups_updateRequest(const QString& product_group_idstr){
    ...
    emit catalogsProductGroups_update(product_group_id, oai_catalogs_product_group_update_request);
}
...
void OAICatalogsApiRequest::feedProcessingResults_listRequest(const QString& feed_idstr){
    ...
    emit feedProcessingResults_list(feed_id, bookmark, page_size);
}
...
void OAICatalogsApiRequest::feeds_createRequest(){
    ...
    emit feeds_create(oai_catalogs_feeds_create_request);
}
...
void OAICatalogsApiRequest::feeds_listRequest(){
    ...
    emit feeds_list(bookmark, page_size);
}
...
void OAICatalogsApiRequest::feeds_updateRequest(const QString& feed_idstr){
    ...
    emit feeds_update(feed_id, oai_catalogs_feeds_update_request);
}
...
void OAICatalogsApiRequest::itemsBatch_postRequest(){
    ...
    emit itemsBatch_post(oai_catalogs_items_batch_request);
}
...
void OAICatalogsApiRequest::items_getRequest(){
    ...
    emit items_get(country, item_ids, language);
}



void OAICatalogsApiRequest::catalogsProductGroups_createResponse(const OAIObject& res){
...
void OAICatalogsApiRequest::catalogsProductGroups_listResponse(const OAIPaginated& res){
    setSocketResponseHeaders();
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
    socket->writeJson(resDoc);
    if(socket->isOpen()){
...
void OAICatalogsApiRequest::feedProcessingResults_listResponse(const OAIPaginated& res){
    setSocketResponseHeaders();
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
    socket->writeJson(resDoc);
    if(socket->isOpen()){
...
void OAICatalogsApiRequest::feeds_listResponse(const OAIPaginated& res){
    setSocketResponseHeaders();
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
    socket->writeJson(resDoc);
    if(socket->isOpen()){
...
void OAICatalogsApiRequest::catalogsProductGroups_createError(const OAIObject& res, QNetworkReply::NetworkError error_type, QString& error_str){
...
void OAICatalogsApiRequest::catalogsProductGroups_listError(const OAIPaginated& res, QNetworkReply::NetworkError error_type, QString& error_str){
    Q_UNUSED(error_type); // TODO: Remap error_type to QHttpEngine::Socket errors
    setSocketResponseHeaders();
    Q_UNUSED(error_str);  // response will be used instead of error string
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
...
void OAICatalogsApiRequest::feedProcessingResults_listError(const OAIPaginated& res, QNetworkReply::NetworkError error_type, QString& error_str){
    Q_UNUSED(error_type); // TODO: Remap error_type to QHttpEngine::Socket errors
    setSocketResponseHeaders();
    Q_UNUSED(error_str);  // response will be used instead of error string
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
...
void OAICatalogsApiRequest::feeds_listError(const OAIPaginated& res, QNetworkReply::NetworkError error_type, QString& error_str){
    Q_UNUSED(error_type); // TODO: Remap error_type to QHttpEngine::Socket errors
    setSocketResponseHeaders();
    Q_UNUSED(error_str);  // response will be used instead of error string
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
