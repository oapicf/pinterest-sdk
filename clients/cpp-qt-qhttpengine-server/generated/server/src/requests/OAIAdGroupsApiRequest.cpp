...
void OAIAdGroupsApiRequest::adGroupsTargetingAnalytics_getRequest(const QString& ad_account_idstr){
    ...
    Q_EMIT adGroupsTargetingAnalytics_get(ad_account_id, ad_group_ids, start_date, end_date, targeting_types, columns, granularity, click_window_days, engagement_window_days, view_window_days, conversion_report_time, attribution_types, reporting_timezone);
}
...
void OAIAdGroupsApiRequest::adGroups_analyticsRequest(const QString& ad_account_idstr){
    ...
    Q_EMIT adGroups_analytics(ad_account_id, start_date, end_date, ad_group_ids, columns, granularity, click_window_days, engagement_window_days, view_window_days, conversion_report_time, aggregate_report_rows, reporting_timezone);
}
