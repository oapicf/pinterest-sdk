...
void OAIIntegrationsApiRequest::integrationsCommerce_patchRequest(const QString& external_business_idstr){
    ...
    OAIIntegrationMetadataUpdate oai_integration_metadata_update;
    ::OpenAPI::fromJsonValue(oai_integration_metadata_update, obj);
    

    Q_EMIT integrationsCommerce_patch(external_business_id, oai_integration_metadata_update);
}
...
void OAIIntegrationsApiRequest::integrationsCommerce_postRequest(){
    ...
    socket->readJson(doc);
    QJsonObject obj = doc.object();
    OAIIntegrationMetadataCreate oai_integration_metadata_create;
    ::OpenAPI::fromJsonValue(oai_integration_metadata_create, obj);
    

    Q_EMIT integrationsCommerce_post(oai_integration_metadata_create);
}
...
void OAIIntegrationsApiRequest::integrationsLogs_postRequest(){
    ...
    socket->readJson(doc);
    QJsonObject obj = doc.object();
    OAIIntegrationLogsRequestCreate oai_integration_logs_request_create;
    ::OpenAPI::fromJsonValue(oai_integration_logs_request_create, obj);
    

    Q_EMIT integrationsLogs_post(oai_integration_logs_request_create);
}
...
void OAIIntegrationsApiRequest::integrationsCommerce_delResponse(const OAIIntegrationMetadata& res){
...
void OAIIntegrationsApiRequest::integrationsCommerce_delError(const OAIIntegrationMetadata& res, QNetworkReply::NetworkError error_type, QString& error_str){
