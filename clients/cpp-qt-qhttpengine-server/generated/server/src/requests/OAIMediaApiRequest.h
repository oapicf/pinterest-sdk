...
public:
    ...
    void media_getResponse(const OAIMedia& res);
    ...
    void media_getError(const OAIMedia& res, QNetworkReply::NetworkError error_type, QString& error_str);
...
Q_SIGNALS:
    void media_create(OAIMediaUploadCreate oai_media_upload_create);
