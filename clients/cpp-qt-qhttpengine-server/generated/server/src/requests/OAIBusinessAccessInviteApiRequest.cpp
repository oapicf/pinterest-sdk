...
void OAIBusinessAccessInviteApiRequest::cancelInvitesOrRequestsRequest(const QString& business_idstr){
    ...
    socket->readJson(doc);
    QJsonObject obj = doc.object();
    OAICancelInvitesRequest oai_cancel_invites_request;
    ::OpenAPI::fromJsonValue(oai_cancel_invites_request, obj);
    

    Q_EMIT cancelInvitesOrRequests(business_id, oai_cancel_invites_request);
}
...
void OAIBusinessAccessInviteApiRequest::get_invitesRequest(const QString& business_idstr){
    ...
    QList<OAIInviteFilterStatus> invite_status;
...
void OAIBusinessAccessInviteApiRequest::cancelInvitesOrRequestsResponse(const OAICancelInvitesResponse& res){
    setSocketResponseHeaders();
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
    socket->writeJson(resDoc);
    if(socket->isOpen()){
...
void OAIBusinessAccessInviteApiRequest::cancelInvitesOrRequestsError(const OAICancelInvitesResponse& res, QNetworkReply::NetworkError error_type, QString& error_str){
    Q_UNUSED(error_type); // TODO: Remap error_type to QHttpEngine::Socket errors
    setSocketResponseHeaders();
    Q_UNUSED(error_str);  // response will be used instead of error string
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
