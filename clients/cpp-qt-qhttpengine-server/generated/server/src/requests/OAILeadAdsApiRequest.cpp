...
void OAILeadAdsApiRequest::adAccountsSubscriptions_getListRequest(const QString& ad_account_idstr){
    ...
    Q_EMIT adAccountsSubscriptions_getList(ad_account_id, bookmark, page_size);
}
...
void OAILeadAdsApiRequest::adAccountsSubscriptions_postRequest(const QString& ad_account_idstr){
    ...
    OAILeadSubscriptionPostParamsCreate oai_lead_subscription_post_params_create;
    ::OpenAPI::fromJsonValue(oai_lead_subscription_post_params_create, obj);
    

    Q_EMIT adAccountsSubscriptions_post(ad_account_id, oai_lead_subscription_post_params_create);
}



void OAILeadAdsApiRequest::adAccountsSubscriptions_delByIdResponse(const OAILeadSubscription& res){
...
void OAILeadAdsApiRequest::adAccountsSubscriptions_getByIdResponse(const OAILeadSubscription& res){
    setSocketResponseHeaders();
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
    socket->writeJson(resDoc);
    if(socket->isOpen()){
...
void OAILeadAdsApiRequest::adAccountsSubscriptions_postResponse(const OAILeadSubscription& res){
    setSocketResponseHeaders();
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
    socket->writeJson(resDoc);
    if(socket->isOpen()){
...
void OAILeadAdsApiRequest::adAccountsSubscriptions_delByIdError(const OAILeadSubscription& res, QNetworkReply::NetworkError error_type, QString& error_str){
...
void OAILeadAdsApiRequest::adAccountsSubscriptions_getByIdError(const OAILeadSubscription& res, QNetworkReply::NetworkError error_type, QString& error_str){
    Q_UNUSED(error_type); // TODO: Remap error_type to QHttpEngine::Socket errors
    setSocketResponseHeaders();
    Q_UNUSED(error_str);  // response will be used instead of error string
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
...
void OAILeadAdsApiRequest::adAccountsSubscriptions_postError(const OAILeadSubscription& res, QNetworkReply::NetworkError error_type, QString& error_str){
    Q_UNUSED(error_type); // TODO: Remap error_type to QHttpEngine::Socket errors
    setSocketResponseHeaders();
    Q_UNUSED(error_str);  // response will be used instead of error string
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
