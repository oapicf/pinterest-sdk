...
void OAICustomerListsApiRequest::customerLists_createRequest(const QString& ad_account_idstr){
    ...
    OAICustomerListCreate oai_customer_list_create;
    ::OpenAPI::fromJsonValue(oai_customer_list_create, obj);
    

    Q_EMIT customerLists_create(ad_account_id, oai_customer_list_create);
}
...
void OAICustomerListsApiRequest::customerLists_listRequest(const QString& ad_account_idstr){
    ...
    Q_EMIT customerLists_list(ad_account_id, bookmark, page_size, order, exclude_nca);
}
...
void OAICustomerListsApiRequest::customerLists_updateRequest(const QString& ad_account_idstr, const QString& customer_list_idstr){
    ...
    socket->readJson(doc);
    QJsonObject obj = doc.object();
    OAICustomerListUpdateWithRequiredBody oai_customer_list_update_with_required_body;
    ::OpenAPI::fromJsonValue(oai_customer_list_update_with_required_body, obj);
    

    Q_EMIT customerLists_update(ad_account_id, customer_list_id, oai_customer_list_update_with_required_body);
}
