...
public:
    ...
    void integrationsCommerce_delResponse(const OAIIntegrationMetadata& res);
    ...
    void integrationsCommerce_delError(const OAIIntegrationMetadata& res, QNetworkReply::NetworkError error_type, QString& error_str);
...
Q_SIGNALS:
    ...
    void integrationsCommerce_patch(QString external_business_id, OAIIntegrationMetadataUpdate oai_integration_metadata_update);
    void integrationsCommerce_post(OAIIntegrationMetadataCreate oai_integration_metadata_create);
    void integrationsLogs_post(OAIIntegrationLogsRequestCreate oai_integration_logs_request_create);
