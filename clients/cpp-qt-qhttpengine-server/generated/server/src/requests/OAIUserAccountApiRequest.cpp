...
void OAIUserAccountApiRequest::userAccount_analytics_topPinsRequest(){
    ...
    emit userAccount_analytics_topPins(start_date, end_date, sort_by, from_claimed_content, pin_format, app_types, metric_types, num_of_pins, created_in_last_n_days, ad_account_id);
}
...
void OAIUserAccountApiRequest::userAccount_analytics_topVideoPinsRequest(){
    ...
    emit userAccount_analytics_topVideoPins(start_date, end_date, sort_by, from_claimed_content, pin_format, app_types, metric_types, num_of_pins, created_in_last_n_days, ad_account_id);
}
