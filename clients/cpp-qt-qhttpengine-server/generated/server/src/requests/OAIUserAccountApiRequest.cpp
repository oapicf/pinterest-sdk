...
void OAIUserAccountApiRequest::boardsUserFollows_listRequest(){
    ...
    Q_EMIT boardsUserFollows_list(ad_account_id, explicit_following, bookmark, page_size);
}
...
void OAIUserAccountApiRequest::followUser_updateRequest(const QString& usernamestr){
    ...
    OAIFollowUserCreate oai_follow_user_create;
    ::OpenAPI::fromJsonValue(oai_follow_user_create, obj);
    

    Q_EMIT followUser_update(username, oai_follow_user_create);
}
...
void OAIUserAccountApiRequest::userAccount_analyticsRequest(){
    ...
    QList<OAIQuerymetrictypesItems> metric_types;
...
void OAIUserAccountApiRequest::userAccount_analytics_topVideoPinsRequest(){
    ...
    QList<OAIQueryvideopinmetrictypesItems> metric_types;
    if(socket->queryString().keys().contains("metric_types")){
        fromStringValue(socket->queryString().values("metric_types"), metric_types);
    }
...
void OAIUserAccountApiRequest::userFollowing_getRequest(){
    ...
    Q_EMIT userFollowing_get(ad_account_id, explicit_following, feed_type, bookmark, page_size);
}
...
void OAIUserAccountApiRequest::verifyWebsite_updateRequest(){
    ...
    socket->readJson(doc);
    QJsonObject obj = doc.object();
    OAIUserWebsiteCreate oai_user_website_create;
    ::OpenAPI::fromJsonValue(oai_user_website_create, obj);
    

    Q_EMIT verifyWebsite_update(oai_user_website_create, ad_account_id);
}
...
void OAIUserAccountApiRequest::boardsUserFollows_listResponse(const OAIBoards_list_200_response& res){
...
void OAIUserAccountApiRequest::followUser_updateResponse(const OAIFollowUser& res){
    setSocketResponseHeaders();
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
    socket->writeJson(resDoc);
    if(socket->isOpen()){
...
void OAIUserAccountApiRequest::unverifyWebsite_deleteResponse(const OAIUserWebsite& res){
    setSocketResponseHeaders();
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
    socket->writeJson(resDoc);
    if(socket->isOpen()){
...
void OAIUserAccountApiRequest::userFollowing_getResponse(const OAIFollowers_list_200_response& res){
    setSocketResponseHeaders();
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
    socket->writeJson(resDoc);
    if(socket->isOpen()){
...
void OAIUserAccountApiRequest::verifyWebsite_updateResponse(const OAIUserWebsite& res){
    setSocketResponseHeaders();
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
    socket->writeJson(resDoc);
    if(socket->isOpen()){
...
void OAIUserAccountApiRequest::websiteVerification_getResponse(const OAIUserWebsiteVerification& res){
    setSocketResponseHeaders();
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
    socket->writeJson(resDoc);
    if(socket->isOpen()){
...
void OAIUserAccountApiRequest::boardsUserFollows_listError(const OAIBoards_list_200_response& res, QNetworkReply::NetworkError error_type, QString& error_str){
...
void OAIUserAccountApiRequest::followUser_updateError(const OAIFollowUser& res, QNetworkReply::NetworkError error_type, QString& error_str){
    Q_UNUSED(error_type); // TODO: Remap error_type to QHttpEngine::Socket errors
    setSocketResponseHeaders();
    Q_UNUSED(error_str);  // response will be used instead of error string
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
...
void OAIUserAccountApiRequest::unverifyWebsite_deleteError(const OAIUserWebsite& res, QNetworkReply::NetworkError error_type, QString& error_str){
    Q_UNUSED(error_type); // TODO: Remap error_type to QHttpEngine::Socket errors
    setSocketResponseHeaders();
    Q_UNUSED(error_str);  // response will be used instead of error string
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
...
void OAIUserAccountApiRequest::userFollowing_getError(const OAIFollowers_list_200_response& res, QNetworkReply::NetworkError error_type, QString& error_str){
    Q_UNUSED(error_type); // TODO: Remap error_type to QHttpEngine::Socket errors
    setSocketResponseHeaders();
    Q_UNUSED(error_str);  // response will be used instead of error string
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
...
void OAIUserAccountApiRequest::verifyWebsite_updateError(const OAIUserWebsite& res, QNetworkReply::NetworkError error_type, QString& error_str){
    Q_UNUSED(error_type); // TODO: Remap error_type to QHttpEngine::Socket errors
    setSocketResponseHeaders();
    Q_UNUSED(error_str);  // response will be used instead of error string
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
...
void OAIUserAccountApiRequest::websiteVerification_getError(const OAIUserWebsiteVerification& res, QNetworkReply::NetworkError error_type, QString& error_str){
    Q_UNUSED(error_type); // TODO: Remap error_type to QHttpEngine::Socket errors
    setSocketResponseHeaders();
    Q_UNUSED(error_str);  // response will be used instead of error string
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
