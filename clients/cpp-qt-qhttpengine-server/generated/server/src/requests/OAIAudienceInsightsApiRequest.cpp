...
void OAIAudienceInsightsApiRequest::audienceInsightsScopeAndType_getResponse(const OAIAudience_insights_scope_and_type_get_200_response& res){
...
void OAIAudienceInsightsApiRequest::audienceInsights_getResponse(const OAIAudienceInsights& res){
    setSocketResponseHeaders();
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
    socket->writeJson(resDoc);
    if(socket->isOpen()){
...
void OAIAudienceInsightsApiRequest::audienceInsightsScopeAndType_getError(const OAIAudience_insights_scope_and_type_get_200_response& res, QNetworkReply::NetworkError error_type, QString& error_str){
...
void OAIAudienceInsightsApiRequest::audienceInsights_getError(const OAIAudienceInsights& res, QNetworkReply::NetworkError error_type, QString& error_str){
    Q_UNUSED(error_type); // TODO: Remap error_type to QHttpEngine::Socket errors
    setSocketResponseHeaders();
    Q_UNUSED(error_str);  // response will be used instead of error string
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
