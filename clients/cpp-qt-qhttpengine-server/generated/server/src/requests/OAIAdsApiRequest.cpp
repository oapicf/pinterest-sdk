...
void OAIAdsApiRequest::ads_analyticsRequest(const QString& ad_account_idstr){
    ...
    Q_EMIT ads_analytics(ad_account_id, start_date, end_date, columns, granularity, ad_ids, click_window_days, engagement_window_days, view_window_days, conversion_report_time, pin_ids, campaign_ids);
}
