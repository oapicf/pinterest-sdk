...
void OAIAdAccountsApiRequest::adAccountTargetingAnalytics_getRequest(const QString& ad_account_idstr){
    ...
    QList<OAIAdsAnalyticsAccountTargetingType> targeting_types;
    ...
    Q_EMIT adAccountTargetingAnalytics_get(ad_account_id, start_date, end_date, targeting_types, columns, granularity, click_window_days, engagement_window_days, view_window_days, conversion_report_time, attribution_types, reporting_timezone);
}
...
void OAIAdAccountsApiRequest::adAccount_analyticsRequest(const QString& ad_account_idstr){
    ...
    Q_EMIT adAccount_analytics(start_date, end_date, columns, granularity, ad_account_id, click_window_days, engagement_window_days, view_window_days, conversion_report_time, reporting_timezone);
}
...
void OAIAdAccountsApiRequest::adAccounts_createRequest(){
    ...
    OAIAdAccountCreate oaiad_account_create;
    ::OpenAPI::fromJsonValue(oaiad_account_create, obj);
    

    Q_EMIT adAccounts_create(oaiad_account_create);
}
...
void OAIAdAccountsApiRequest::adAccounts_listRequest(){
    ...
    Q_EMIT adAccounts_list(include_shared_accounts, bookmark, page_size);
}


void OAIAdAccountsApiRequest::analytics_createConversionProductReportRequest(const QString& ad_account_idstr){
    qDebug() << "/v5/ad_accounts/{ad_account_id}/reports/brand_category_sku";
    connect(this, &OAIAdAccountsApiRequest::analytics_createConversionProductReport, handler.data(), &OAIAdAccountsApiHandler::analytics_createConversionProductReport);
    ...
    socket->readJson(doc);
    QJsonObject obj = doc.object();
    OAIConversionProductReportCreate oai_conversion_product_report_create;
    ::OpenAPI::fromJsonValue(oai_conversion_product_report_create, obj);
    

    Q_EMIT analytics_createConversionProductReport(ad_account_id, oai_conversion_product_report_create);
}
...
void OAIAdAccountsApiRequest::analytics_createMmmReportRequest(const QString& ad_account_idstr){
    ...
    socket->readJson(doc);
    QJsonObject obj = doc.object();
    OAIMMMReportCreate oaimmm_report_create;
    ::OpenAPI::fromJsonValue(oaimmm_report_create, obj);
    

    Q_EMIT analytics_createMmmReport(ad_account_id, oaimmm_report_create);
}
...
void OAIAdAccountsApiRequest::analytics_getConversionProductReportRequest(const QString& ad_account_idstr){
    qDebug() << "/v5/ad_accounts/{ad_account_id}/reports/brand_category_sku";
    connect(this, &OAIAdAccountsApiRequest::analytics_getConversionProductReport, handler.data(), &OAIAdAccountsApiHandler::analytics_getConversionProductReport);
    ...
    Q_EMIT analytics_getConversionProductReport(ad_account_id, token);
}
...
void OAIAdAccountsApiRequest::templates_listRequest(const QString& ad_account_idstr){
    ...
    Q_EMIT templates_list(ad_account_id, bookmark, page_size, order);
}
...
void OAIAdAccountsApiRequest::adAccount_analyticsResponse(const QList<OAIAdAccountAnalyticsItems>& res){
    setSocketResponseHeaders();
...
void OAIAdAccountsApiRequest::analytics_createConversionProductReportResponse(const OAIConversionProductReport& res){
    setSocketResponseHeaders();
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
    socket->writeJson(resDoc);
    if(socket->isOpen()){
...
void OAIAdAccountsApiRequest::analytics_createMmmReportResponse(const OAIMMMReport& res){
    setSocketResponseHeaders();
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
    socket->writeJson(resDoc);
    if(socket->isOpen()){
...
void OAIAdAccountsApiRequest::analytics_createTemplateReportResponse(const OAITemplateBasedReport& res){
    setSocketResponseHeaders();
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
    socket->writeJson(resDoc);
    if(socket->isOpen()){
...
void OAIAdAccountsApiRequest::analytics_getConversionProductReportResponse(const OAIConversionProductReport& res){
    setSocketResponseHeaders();
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
    socket->writeJson(resDoc);
    if(socket->isOpen()){
...
void OAIAdAccountsApiRequest::analytics_getMmmReportResponse(const OAIMMMReport& res){
    setSocketResponseHeaders();
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
    socket->writeJson(resDoc);
    if(socket->isOpen()){
...
void OAIAdAccountsApiRequest::adAccount_analyticsError(const QList<OAIAdAccountAnalyticsItems>& res, QNetworkReply::NetworkError error_type, QString& error_str){
    Q_UNUSED(error_type); // TODO: Remap error_type to QHttpEngine::Socket errors
    setSocketResponseHeaders();
    Q_UNUSED(error_str);  // response will be used instead of error string
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toArray());
...
void OAIAdAccountsApiRequest::analytics_createConversionProductReportError(const OAIConversionProductReport& res, QNetworkReply::NetworkError error_type, QString& error_str){
    Q_UNUSED(error_type); // TODO: Remap error_type to QHttpEngine::Socket errors
    setSocketResponseHeaders();
    Q_UNUSED(error_str);  // response will be used instead of error string
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
...
void OAIAdAccountsApiRequest::analytics_createMmmReportError(const OAIMMMReport& res, QNetworkReply::NetworkError error_type, QString& error_str){
    Q_UNUSED(error_type); // TODO: Remap error_type to QHttpEngine::Socket errors
    setSocketResponseHeaders();
    Q_UNUSED(error_str);  // response will be used instead of error string
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
...
void OAIAdAccountsApiRequest::analytics_createTemplateReportError(const OAITemplateBasedReport& res, QNetworkReply::NetworkError error_type, QString& error_str){
    Q_UNUSED(error_type); // TODO: Remap error_type to QHttpEngine::Socket errors
    setSocketResponseHeaders();
    Q_UNUSED(error_str);  // response will be used instead of error string
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
...
void OAIAdAccountsApiRequest::analytics_getConversionProductReportError(const OAIConversionProductReport& res, QNetworkReply::NetworkError error_type, QString& error_str){
    Q_UNUSED(error_type); // TODO: Remap error_type to QHttpEngine::Socket errors
    setSocketResponseHeaders();
    Q_UNUSED(error_str);  // response will be used instead of error string
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
...
void OAIAdAccountsApiRequest::analytics_getMmmReportError(const OAIMMMReport& res, QNetworkReply::NetworkError error_type, QString& error_str){
    Q_UNUSED(error_type); // TODO: Remap error_type to QHttpEngine::Socket errors
    setSocketResponseHeaders();
    Q_UNUSED(error_str);  // response will be used instead of error string
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
