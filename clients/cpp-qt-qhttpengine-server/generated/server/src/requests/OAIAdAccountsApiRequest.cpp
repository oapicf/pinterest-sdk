...
void OAIAdAccountsApiRequest::adAccount_analyticsRequest(const QString& ad_account_idstr){
    ...
    Q_EMIT adAccount_analytics(ad_account_id, start_date, end_date, columns, granularity, click_window_days, engagement_window_days, view_window_days, conversion_report_time, reporting_timezone);
}
...
void OAIAdAccountsApiRequest::analytics_createConversionProductReportRequest(const QString& ad_account_idstr){
    ...
    socket->readJson(doc);
    QJsonObject obj = doc.object();
    OAIConversionProductReportRequest oai_conversion_product_report_request;
    ::OpenAPI::fromJsonValue(oai_conversion_product_report_request, obj);
    

    Q_EMIT analytics_createConversionProductReport(ad_account_id, oai_conversion_product_report_request);
}
...
void OAIAdAccountsApiRequest::analytics_createConversionProductReportResponse(const OAIAdsAnalyticsCreateAsyncResponse& res){
    setSocketResponseHeaders();
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
    socket->writeJson(resDoc);
    if(socket->isOpen()){
...
void OAIAdAccountsApiRequest::analytics_getConversionProductReportResponse(const OAIAdsAnalyticsGetAsyncResponse& res){
    setSocketResponseHeaders();
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
    socket->writeJson(resDoc);
    if(socket->isOpen()){
...
void OAIAdAccountsApiRequest::analytics_createConversionProductReportError(const OAIAdsAnalyticsCreateAsyncResponse& res, QNetworkReply::NetworkError error_type, QString& error_str){
    Q_UNUSED(error_type); // TODO: Remap error_type to QHttpEngine::Socket errors
    setSocketResponseHeaders();
    Q_UNUSED(error_str);  // response will be used instead of error string
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
...
void OAIAdAccountsApiRequest::analytics_getConversionProductReportError(const OAIAdsAnalyticsGetAsyncResponse& res, QNetworkReply::NetworkError error_type, QString& error_str){
    Q_UNUSED(error_type); // TODO: Remap error_type to QHttpEngine::Socket errors
    setSocketResponseHeaders();
    Q_UNUSED(error_str);  // response will be used instead of error string
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
