...
public:
    ...
    void boardSections_deleteResponse(const OAIBoardSection& res);
    ...
    void boards_deleteResponse(const OAIBoard& res);
    ...
    void boards_updateResponse(const OAIBoardWithUpdatePrivacy& res);
    

    void boardSections_createError(const OAIBoardSection& res, QNetworkReply::NetworkError error_type, QString& error_str);
    void boardSections_deleteError(const OAIBoardSection& res, QNetworkReply::NetworkError error_type, QString& error_str);
    ...
    void boards_deleteError(const OAIBoard& res, QNetworkReply::NetworkError error_type, QString& error_str);
    ...
    void boards_updateError(const OAIBoardWithUpdatePrivacy& res, QNetworkReply::NetworkError error_type, QString& error_str);
...
Q_SIGNALS:
    void boardSections_create(QString board_id, OAIBoardSectionCreate oai_board_section_create, QString ad_account_id);
    ...
    void boardSections_update(QString board_id, QString section_id, OAIBoardSectionUpdateWithRequiredBody oai_board_section_update_with_required_body, QString ad_account_id);
    void boards_create(OAIBoardCreate oai_board_create, QString ad_account_id);
    void boards_delete(QString board_id, QString ad_account_id);
    void boards_get(QString board_id, QString ad_account_id);
    void boards_list(QString ad_account_id, OAIBoardPrivacyFilter privacy, QString bookmark, qint32 page_size);
    void boards_listPins(QString board_id, QList<OAICreativeType> creative_types, QString ad_account_id, bool pin_metrics, QString bookmark, qint32 page_size);
    void boards_update(QString board_id, OAIBoardWithUpdatePrivacyUpdate oai_board_with_update_privacy_update, QString ad_account_id);
