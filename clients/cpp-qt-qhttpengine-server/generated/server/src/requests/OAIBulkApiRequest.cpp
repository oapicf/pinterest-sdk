...
void OAIBulkApiRequest::bulkDownload_createRequest(const QString& ad_account_idstr){
    ...
    OAIBulkDownloadCreate oai_bulk_download_create;
    ::OpenAPI::fromJsonValue(oai_bulk_download_create, obj);
    

    Q_EMIT bulkDownload_create(ad_account_id, oai_bulk_download_create);
}
...
void OAIBulkApiRequest::bulkDownload_createResponse(const OAIBulkDownload& res){
...
void OAIBulkApiRequest::bulkRequest_getResponse(const OAIBulkJobData& res){
    setSocketResponseHeaders();
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
    socket->writeJson(resDoc);
    if(socket->isOpen()){
...
void OAIBulkApiRequest::bulkDownload_createError(const OAIBulkDownload& res, QNetworkReply::NetworkError error_type, QString& error_str){
...
void OAIBulkApiRequest::bulkRequest_getError(const OAIBulkJobData& res, QNetworkReply::NetworkError error_type, QString& error_str){
    Q_UNUSED(error_type); // TODO: Remap error_type to QHttpEngine::Socket errors
    setSocketResponseHeaders();
    Q_UNUSED(error_str);  // response will be used instead of error string
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
