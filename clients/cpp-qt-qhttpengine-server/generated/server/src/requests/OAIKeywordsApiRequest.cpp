...
void OAIKeywordsApiRequest::keywords_createRequest(const QString& ad_account_idstr){
    ...
    OAIKeywordsCreate oai_keywords_create;
    ::OpenAPI::fromJsonValue(oai_keywords_create, obj);
    

    Q_EMIT keywords_create(ad_account_id, oai_keywords_create);
}
...
void OAIKeywordsApiRequest::keywords_getRequest(const QString& ad_account_idstr){
    ...
    Q_EMIT keywords_get(ad_account_id, campaign_id, ad_group_id, ad_group_ids, match_types, bookmark, page_size);
}
...
void OAIKeywordsApiRequest::keywords_updateRequest(const QString& ad_account_idstr){
    ...
    socket->readJson(doc);
    QJsonObject obj = doc.object();
    OAIKeywordsUpdate oai_keywords_update;
    ::OpenAPI::fromJsonValue(oai_keywords_update, obj);
    

    Q_EMIT keywords_update(ad_account_id, oai_keywords_update);
}
...
void OAIKeywordsApiRequest::trendingKeywords_listRequest(const QString& regionstr, const QString& trend_typestr){
    ...
    if(socket->queryString().keys().contains("include_demographics")){
        fromStringValue(socket->queryString().value("include_demographics"), include_demographics);
    }
    ...
    Q_EMIT trendingKeywords_list(region, trend_type, interests, genders, ages, include_keywords, normalize_against_group, limit, include_demographics);
}
...
void OAIKeywordsApiRequest::keywords_createResponse(const OAIKeywords& res){
    setSocketResponseHeaders();
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
    socket->writeJson(resDoc);
    if(socket->isOpen()){
...
void OAIKeywordsApiRequest::keywords_updateResponse(const OAIKeywords& res){
    setSocketResponseHeaders();
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
    socket->writeJson(resDoc);
    if(socket->isOpen()){
...
void OAIKeywordsApiRequest::keywords_createError(const OAIKeywords& res, QNetworkReply::NetworkError error_type, QString& error_str){
    Q_UNUSED(error_type); // TODO: Remap error_type to QHttpEngine::Socket errors
    setSocketResponseHeaders();
    Q_UNUSED(error_str);  // response will be used instead of error string
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
...
void OAIKeywordsApiRequest::keywords_updateError(const OAIKeywords& res, QNetworkReply::NetworkError error_type, QString& error_str){
    Q_UNUSED(error_type); // TODO: Remap error_type to QHttpEngine::Socket errors
    setSocketResponseHeaders();
    Q_UNUSED(error_str);  // response will be used instead of error string
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
