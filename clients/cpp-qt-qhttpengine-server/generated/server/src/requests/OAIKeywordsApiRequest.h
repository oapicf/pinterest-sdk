...
Q_SIGNALS:
    ...
    void trendingKeywords_list(OAITrendsSupportedRegion region, OAITrendType trend_type, QList<QString> interests, QList<QString> genders, QList<QString> ages, QList<QString> include_keywords, bool normalize_against_group, qint32 limit);
