...
Q_SIGNALS:
    ...
    void keywords_get(QString ad_account_id, QString campaign_id, QString ad_group_id, QList<QString> ad_group_ids, QList<OAIMatchType> match_types, qint32 page_size, QString bookmark);
    void keywords_update(QString ad_account_id, OAIKeywordUpdateBody oai_keyword_update_body);
    void trendingKeywords_list(OAITrendsSupportedRegion region, OAITrendType trend_type, QList<QString> interests, QList<QString> genders, QList<QString> ages, QList<QString> include_keywords, bool normalize_against_group, qint32 limit, bool include_prediction, bool include_demographics);
