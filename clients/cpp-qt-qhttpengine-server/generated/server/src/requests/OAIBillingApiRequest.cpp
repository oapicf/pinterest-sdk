...
void OAIBillingApiRequest::adsCredit_redeemRequest(const QString& ad_account_idstr){
    ...
    OAIAdsCreditRedeemCreate oai_ads_credit_redeem_create;
    ::OpenAPI::fromJsonValue(oai_ads_credit_redeem_create, obj);
    

    Q_EMIT adsCredit_redeem(ad_account_id, oai_ads_credit_redeem_create);
}
...
void OAIBillingApiRequest::billingInvoiceDownload_getRequest(const QString& ad_account_idstr, const QString& billing_invoice_idstr){
    qDebug() << "/v5/ad_accounts/{ad_account_id}/billing_invoice/{billing_invoice_id}/download";
    connect(this, &OAIBillingApiRequest::billingInvoiceDownload_get, handler.data(), &OAIBillingApiHandler::billingInvoiceDownload_get);

    
    QString ad_account_id;
    fromStringValue(ad_account_idstr, ad_account_id);
        QString billing_invoice_id;
    fromStringValue(billing_invoice_idstr, billing_invoice_id);
    

    Q_EMIT billingInvoiceDownload_get(ad_account_id, billing_invoice_id);
}


void OAIBillingApiRequest::billingInvoices_getRequest(const QString& ad_account_idstr){
    qDebug() << "/v5/ad_accounts/{ad_account_id}/billing_invoices";
    connect(this, &OAIBillingApiRequest::billingInvoices_get, handler.data(), &OAIBillingApiHandler::billingInvoices_get);
    ...
    OAIBillingInvoiceSortField sort;
    if(socket->queryString().keys().contains("sort")){
        fromStringValue(socket->queryString().value("sort"), sort);
    }
    
    OAIBillingInvoiceStatus status;
    if(socket->queryString().keys().contains("status")){
        fromStringValue(socket->queryString().value("status"), status);
    }
    
    OAIBillingInvoiceDocumentType document_type;
    if(socket->queryString().keys().contains("document_type")){
        fromStringValue(socket->queryString().value("document_type"), document_type);
    }
    
    QDate start_due_date;
    if(socket->queryString().keys().contains("start_due_date")){
        fromStringValue(socket->queryString().value("start_due_date"), start_due_date);
    }
    
    QDate end_due_date;
    if(socket->queryString().keys().contains("end_due_date")){
        fromStringValue(socket->queryString().value("end_due_date"), end_due_date);
    }
    ...
    Q_EMIT billingInvoices_get(ad_account_id, bookmark, page_size, order, sort, status, document_type, start_due_date, end_due_date);
}
...
void OAIBillingApiRequest::billingProfiles_getRequest(const QString& ad_account_idstr){
    ...
    Q_EMIT billingProfiles_get(is_active, ad_account_id, bookmark, page_size);
}
...
void OAIBillingApiRequest::ssioInsertionOrder_createRequest(const QString& ad_account_idstr){
    ...
    socket->readJson(doc);
    QJsonObject obj = doc.object();
    OAISSIOInsertionOrderCreate oaissio_insertion_order_create;
    ::OpenAPI::fromJsonValue(oaissio_insertion_order_create, obj);
    

    Q_EMIT ssioInsertionOrder_create(ad_account_id, oaissio_insertion_order_create);
}
...
void OAIBillingApiRequest::ssioInsertionOrder_editRequest(const QString& ad_account_idstr){
    ...
    socket->readJson(doc);
    QJsonObject obj = doc.object();
    OAISSIOInsertionOrderUpdate oaissio_insertion_order_update;
    ::OpenAPI::fromJsonValue(oaissio_insertion_order_update, obj);
    

    Q_EMIT ssioInsertionOrder_edit(ad_account_id, oaissio_insertion_order_update);
}
...
void OAIBillingApiRequest::ssioOrderLines_getByAdAccountRequest(const QString& ad_account_idstr){
    ...
    Q_EMIT ssioOrderLines_getByAdAccount(ad_account_id, pin_order_id, bookmark, page_size);
}



void OAIBillingApiRequest::adsCredit_redeemResponse(const OAIAdsCreditRedeem& res){
...
void OAIBillingApiRequest::billingInvoiceDownload_getResponse(const OAIBillingInvoiceDownloadResponse& res){
    setSocketResponseHeaders();
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
    socket->writeJson(resDoc);
    if(socket->isOpen()){
...
void OAIBillingApiRequest::billingInvoices_getResponse(const OAIBilling_invoices_get_200_response& res){
    setSocketResponseHeaders();
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
    socket->writeJson(resDoc);
    if(socket->isOpen()){
...
void OAIBillingApiRequest::ssioAccounts_getResponse(const OAISSIOAccount& res){
    setSocketResponseHeaders();
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
    socket->writeJson(resDoc);
    if(socket->isOpen()){
...
void OAIBillingApiRequest::ssioInsertionOrder_createResponse(const OAISSIOInsertionOrder& res){
    setSocketResponseHeaders();
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
    socket->writeJson(resDoc);
    if(socket->isOpen()){
...
void OAIBillingApiRequest::ssioInsertionOrder_editResponse(const OAISSIOInsertionOrder& res){
    setSocketResponseHeaders();
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
    socket->writeJson(resDoc);
    if(socket->isOpen()){
...
void OAIBillingApiRequest::adsCredit_redeemError(const OAIAdsCreditRedeem& res, QNetworkReply::NetworkError error_type, QString& error_str){
...
void OAIBillingApiRequest::billingInvoiceDownload_getError(const OAIBillingInvoiceDownloadResponse& res, QNetworkReply::NetworkError error_type, QString& error_str){
    Q_UNUSED(error_type); // TODO: Remap error_type to QHttpEngine::Socket errors
    setSocketResponseHeaders();
    Q_UNUSED(error_str);  // response will be used instead of error string
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
...
void OAIBillingApiRequest::billingInvoices_getError(const OAIBilling_invoices_get_200_response& res, QNetworkReply::NetworkError error_type, QString& error_str){
    Q_UNUSED(error_type); // TODO: Remap error_type to QHttpEngine::Socket errors
    setSocketResponseHeaders();
    Q_UNUSED(error_str);  // response will be used instead of error string
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
...
void OAIBillingApiRequest::ssioAccounts_getError(const OAISSIOAccount& res, QNetworkReply::NetworkError error_type, QString& error_str){
    Q_UNUSED(error_type); // TODO: Remap error_type to QHttpEngine::Socket errors
    setSocketResponseHeaders();
    Q_UNUSED(error_str);  // response will be used instead of error string
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
...
void OAIBillingApiRequest::ssioInsertionOrder_createError(const OAISSIOInsertionOrder& res, QNetworkReply::NetworkError error_type, QString& error_str){
    Q_UNUSED(error_type); // TODO: Remap error_type to QHttpEngine::Socket errors
    setSocketResponseHeaders();
    Q_UNUSED(error_str);  // response will be used instead of error string
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
...
void OAIBillingApiRequest::ssioInsertionOrder_editError(const OAISSIOInsertionOrder& res, QNetworkReply::NetworkError error_type, QString& error_str){
    Q_UNUSED(error_type); // TODO: Remap error_type to QHttpEngine::Socket errors
    setSocketResponseHeaders();
    Q_UNUSED(error_str);  // response will be used instead of error string
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
