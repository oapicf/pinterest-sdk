...
void OAIBoardsApiRequest::boardSections_createRequest(const QString& board_idstr){
    ...
    OAIBoardSectionCreate oai_board_section_create;
    ::OpenAPI::fromJsonValue(oai_board_section_create, obj);
    

    Q_EMIT boardSections_create(board_id, oai_board_section_create, ad_account_id);
}
...
void OAIBoardsApiRequest::boardSections_updateRequest(const QString& board_idstr, const QString& section_idstr){
    ...
    socket->readJson(doc);
    QJsonObject obj = doc.object();
    OAIBoardSectionUpdateWithRequiredBody oai_board_section_update_with_required_body;
    ::OpenAPI::fromJsonValue(oai_board_section_update_with_required_body, obj);
    

    Q_EMIT boardSections_update(board_id, section_id, oai_board_section_update_with_required_body, ad_account_id);
}
...
void OAIBoardsApiRequest::boards_createRequest(){
    ...
    socket->readJson(doc);
    QJsonObject obj = doc.object();
    OAIBoardCreate oai_board_create;
    ::OpenAPI::fromJsonValue(oai_board_create, obj);
    

    Q_EMIT boards_create(oai_board_create, ad_account_id);
}
...
void OAIBoardsApiRequest::boards_listRequest(){
    ...
    Q_EMIT boards_list(ad_account_id, privacy, bookmark, page_size);
}
...
void OAIBoardsApiRequest::boards_listPinsRequest(const QString& board_idstr){
    ...
    Q_EMIT boards_listPins(board_id, creative_types, ad_account_id, pin_metrics, bookmark, page_size);
}
...
void OAIBoardsApiRequest::boards_updateRequest(const QString& board_idstr){
    ...
    socket->readJson(doc);
    QJsonObject obj = doc.object();
    OAIBoardWithUpdatePrivacyUpdate oai_board_with_update_privacy_update;
    ::OpenAPI::fromJsonValue(oai_board_with_update_privacy_update, obj);
    

    Q_EMIT boards_update(board_id, oai_board_with_update_privacy_update, ad_account_id);
}
...
void OAIBoardsApiRequest::boardSections_deleteResponse(const OAIBoardSection& res){
    setSocketResponseHeaders();
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
    socket->writeJson(resDoc);
    if(socket->isOpen()){
...
void OAIBoardsApiRequest::boards_deleteResponse(const OAIBoard& res){
    setSocketResponseHeaders();
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
    socket->writeJson(resDoc);
    if(socket->isOpen()){
...
void OAIBoardsApiRequest::boards_updateResponse(const OAIBoardWithUpdatePrivacy& res){
    setSocketResponseHeaders();
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
    socket->writeJson(resDoc);
    if(socket->isOpen()){
...
void OAIBoardsApiRequest::boardSections_deleteError(const OAIBoardSection& res, QNetworkReply::NetworkError error_type, QString& error_str){
    Q_UNUSED(error_type); // TODO: Remap error_type to QHttpEngine::Socket errors
    setSocketResponseHeaders();
    Q_UNUSED(error_str);  // response will be used instead of error string
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
...
void OAIBoardsApiRequest::boards_deleteError(const OAIBoard& res, QNetworkReply::NetworkError error_type, QString& error_str){
    Q_UNUSED(error_type); // TODO: Remap error_type to QHttpEngine::Socket errors
    setSocketResponseHeaders();
    Q_UNUSED(error_str);  // response will be used instead of error string
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
...
void OAIBoardsApiRequest::boards_updateError(const OAIBoardWithUpdatePrivacy& res, QNetworkReply::NetworkError error_type, QString& error_str){
    Q_UNUSED(error_type); // TODO: Remap error_type to QHttpEngine::Socket errors
    setSocketResponseHeaders();
    Q_UNUSED(error_str);  // response will be used instead of error string
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
