...
void OAIMediaApiRequest::media_createRequest(){
    ...
    emit media_create(oai_media_upload_request);
}
...
void OAIMediaApiRequest::media_listRequest(){
    ...
    emit media_list(bookmark, page_size);
}
...
void OAIMediaApiRequest::media_listResponse(const OAIPaginated& res){
    setSocketResponseHeaders();
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
    socket->writeJson(resDoc);
    if(socket->isOpen()){
...
void OAIMediaApiRequest::media_listError(const OAIPaginated& res, QNetworkReply::NetworkError error_type, QString& error_str){
    Q_UNUSED(error_type); // TODO: Remap error_type to QHttpEngine::Socket errors
    setSocketResponseHeaders();
    Q_UNUSED(error_str);  // response will be used instead of error string
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
