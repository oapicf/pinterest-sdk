...
void OAIMediaApiRequest::media_createRequest(){
    ...
    OAIMediaUploadCreate oai_media_upload_create;
    ::OpenAPI::fromJsonValue(oai_media_upload_create, obj);
    

    Q_EMIT media_create(oai_media_upload_create);
}
...
void OAIMediaApiRequest::media_getResponse(const OAIMedia& res){
    setSocketResponseHeaders();
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
    socket->writeJson(resDoc);
    if(socket->isOpen()){
...
void OAIMediaApiRequest::media_getError(const OAIMedia& res, QNetworkReply::NetworkError error_type, QString& error_str){
    Q_UNUSED(error_type); // TODO: Remap error_type to QHttpEngine::Socket errors
    setSocketResponseHeaders();
    Q_UNUSED(error_str);  // response will be used instead of error string
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
