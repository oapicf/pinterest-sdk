...
void OAIResourcesApiRequest::targetingOptions_getRequest(const QString& targeting_typestr){
    ...
    OAIPublicTargetingType targeting_type;
    fromStringValue(targeting_typestr, targeting_type);
    

    Q_EMIT targetingOptions_get(targeting_type, ad_account_id, client_id, oauth_signature, timestamp);
}



void OAIResourcesApiRequest::adAccountCountries_getResponse(const OAIAd_account_countries_get_200_response& res){
...
void OAIResourcesApiRequest::deliveryMetrics_getResponse(const OAIDelivery_metrics_get_200_response& res){
    setSocketResponseHeaders();
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
    socket->writeJson(resDoc);
    if(socket->isOpen()){
...
void OAIResourcesApiRequest::interestTargetingOptions_getResponse(const OAISingleInterestTargetingOption& res){
    setSocketResponseHeaders();
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
    socket->writeJson(resDoc);
    if(socket->isOpen()){
...
void OAIResourcesApiRequest::metricsReadyState_getResponse(const OAIBookClosed& res){
    setSocketResponseHeaders();
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
    socket->writeJson(resDoc);
    if(socket->isOpen()){
...
void OAIResourcesApiRequest::adAccountCountries_getError(const OAIAd_account_countries_get_200_response& res, QNetworkReply::NetworkError error_type, QString& error_str){
...
void OAIResourcesApiRequest::deliveryMetrics_getError(const OAIDelivery_metrics_get_200_response& res, QNetworkReply::NetworkError error_type, QString& error_str){
    Q_UNUSED(error_type); // TODO: Remap error_type to QHttpEngine::Socket errors
    setSocketResponseHeaders();
    Q_UNUSED(error_str);  // response will be used instead of error string
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
...
void OAIResourcesApiRequest::interestTargetingOptions_getError(const OAISingleInterestTargetingOption& res, QNetworkReply::NetworkError error_type, QString& error_str){
    Q_UNUSED(error_type); // TODO: Remap error_type to QHttpEngine::Socket errors
    setSocketResponseHeaders();
    Q_UNUSED(error_str);  // response will be used instead of error string
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
...
void OAIResourcesApiRequest::metricsReadyState_getError(const OAIBookClosed& res, QNetworkReply::NetworkError error_type, QString& error_str){
    Q_UNUSED(error_type); // TODO: Remap error_type to QHttpEngine::Socket errors
    setSocketResponseHeaders();
    Q_UNUSED(error_str);  // response will be used instead of error string
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
