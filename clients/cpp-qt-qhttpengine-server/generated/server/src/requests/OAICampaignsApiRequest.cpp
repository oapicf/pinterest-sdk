...
void OAICampaignsApiRequest::campaignTargetingAnalytics_getRequest(const QString& ad_account_idstr){
    ...
    emit campaignTargetingAnalytics_get(ad_account_id, campaign_ids, start_date, end_date, targeting_types, columns, granularity, click_window_days, engagement_window_days, view_window_days, conversion_report_time, attribution_types);
}
