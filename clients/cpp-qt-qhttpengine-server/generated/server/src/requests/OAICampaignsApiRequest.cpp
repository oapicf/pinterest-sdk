...
void OAICampaignsApiRequest::adPins_analyticsRequest(const QString& ad_account_idstr){
    ...
    Q_EMIT adPins_analytics(ad_account_id, campaign_id, pin_ids, start_date, end_date, columns, granularity, click_window_days, engagement_window_days, view_window_days, conversion_report_time);
}
...
void OAICampaignsApiRequest::campaigns_analyticsRequest(const QString& ad_account_idstr){
    ...
    Q_EMIT campaigns_analytics(ad_account_id, start_date, end_date, campaign_ids, columns, granularity, click_window_days, engagement_window_days, view_window_days, conversion_report_time, aggregate_report_rows, reporting_timezone);
}
