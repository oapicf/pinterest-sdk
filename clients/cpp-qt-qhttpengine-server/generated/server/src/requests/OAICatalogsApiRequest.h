...
Q_SIGNALS:
    ...
    void catalogs_create(OAICatalogCreate oai_catalog_create, QString ad_account_id);
    void catalogs_list(QString ad_account_id, QString bookmark, qint32 page_size);
