...
signals:
    void catalogsProductGroupPins_list(QString product_group_id, QString bookmark, qint32 page_size);
    ...
    void catalogsProductGroups_get(QString product_group_id);
    void catalogsProductGroups_list(QString feed_id, QString bookmark, qint32 page_size);
    void catalogsProductGroups_productCountsGet(QString product_group_id);
    ...
    void itemsIssues_list(QString processing_result_id, QString bookmark, qint32 page_size, QList<qint32> item_numbers, OAICatalogsItemValidationIssue item_validation_issue);
    void items_get(QString country, QList<QString> item_ids, QString language);
    void productsByProductGroupFilter_list(OAICatalogsListProductsByFilterRequest oai_catalogs_list_products_by_filter_request, QString bookmark, qint32 page_size);
