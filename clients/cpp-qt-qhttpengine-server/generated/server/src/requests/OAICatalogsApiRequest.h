...
public:
    ...
    void catalogsProductGroups_createResponse(const OAICatalogs_product_groups_create_201_response& res);
    void catalogsProductGroups_deleteResponse();
    void catalogsProductGroups_getResponse(const OAICatalogs_product_groups_create_201_response& res);
    ...
    void catalogsProductGroups_updateResponse(const OAICatalogs_product_groups_create_201_response& res);
    ...
    void catalogsProductGroups_createError(const OAICatalogs_product_groups_create_201_response& res, QNetworkReply::NetworkError error_type, QString& error_str);
    void catalogsProductGroups_deleteError(QNetworkReply::NetworkError error_type, QString& error_str);
    void catalogsProductGroups_getError(const OAICatalogs_product_groups_create_201_response& res, QNetworkReply::NetworkError error_type, QString& error_str);
    ...
    void catalogsProductGroups_updateError(const OAICatalogs_product_groups_create_201_response& res, QNetworkReply::NetworkError error_type, QString& error_str);
...
Q_SIGNALS:
    ...
    void catalogsProductGroups_create(OAICatalogs_product_groups_create_request oai_catalogs_product_groups_create_request, QString ad_account_id);
    ...
    void catalogsProductGroups_list(QString feed_id, QString catalog_id, QString bookmark, qint32 page_size, QString ad_account_id);
