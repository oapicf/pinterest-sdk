...
void OAIProductGroupPromotionsApiRequest::productGroupPromotions_createRequest(const QString& ad_account_idstr){
    ...
    OAIProductGroupPromotionsCreate oai_product_group_promotions_create;
    ::OpenAPI::fromJsonValue(oai_product_group_promotions_create, obj);
    

    Q_EMIT productGroupPromotions_create(ad_account_id, oai_product_group_promotions_create);
}
...
void OAIProductGroupPromotionsApiRequest::productGroupPromotions_listRequest(const QString& ad_account_idstr){
    ...
    Q_EMIT productGroupPromotions_list(ad_account_id, bookmark, page_size, order, product_group_promotion_ids, entity_statuses, ad_group_id);
}
...
void OAIProductGroupPromotionsApiRequest::productGroupPromotions_updateRequest(const QString& ad_account_idstr){
    ...
    socket->readJson(doc);
    QJsonObject obj = doc.object();
    OAIProductGroupPromotionsUpdateWithRequiredBody oai_product_group_promotions_update_with_required_body;
    ::OpenAPI::fromJsonValue(oai_product_group_promotions_update_with_required_body, obj);
    

    Q_EMIT productGroupPromotions_update(ad_account_id, oai_product_group_promotions_update_with_required_body);
}
...
void OAIProductGroupPromotionsApiRequest::productGroups_analyticsRequest(const QString& ad_account_idstr){
    ...
    Q_EMIT productGroups_analytics(start_date, end_date, product_group_ids, columns, granularity, ad_account_id, click_window_days, engagement_window_days, view_window_days, conversion_report_time, reporting_timezone);
}



void OAIProductGroupPromotionsApiRequest::productGroupPromotions_createResponse(const OAIProductGroupPromotions& res){
...
void OAIProductGroupPromotionsApiRequest::productGroupPromotions_getResponse(const OAIProductGroupPromotion& res){
    setSocketResponseHeaders();
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
    socket->writeJson(resDoc);
    if(socket->isOpen()){
...
void OAIProductGroupPromotionsApiRequest::productGroupPromotions_updateResponse(const OAIProductGroupPromotions& res){
    setSocketResponseHeaders();
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
    socket->writeJson(resDoc);
    if(socket->isOpen()){
...
void OAIProductGroupPromotionsApiRequest::productGroups_analyticsResponse(const QList<OAIProductGroupAnalyticsItems>& res){
    setSocketResponseHeaders();
...
void OAIProductGroupPromotionsApiRequest::productGroupPromotions_createError(const OAIProductGroupPromotions& res, QNetworkReply::NetworkError error_type, QString& error_str){
...
void OAIProductGroupPromotionsApiRequest::productGroupPromotions_getError(const OAIProductGroupPromotion& res, QNetworkReply::NetworkError error_type, QString& error_str){
    Q_UNUSED(error_type); // TODO: Remap error_type to QHttpEngine::Socket errors
    setSocketResponseHeaders();
    Q_UNUSED(error_str);  // response will be used instead of error string
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
...
void OAIProductGroupPromotionsApiRequest::productGroupPromotions_updateError(const OAIProductGroupPromotions& res, QNetworkReply::NetworkError error_type, QString& error_str){
    Q_UNUSED(error_type); // TODO: Remap error_type to QHttpEngine::Socket errors
    setSocketResponseHeaders();
    Q_UNUSED(error_str);  // response will be used instead of error string
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
...
void OAIProductGroupPromotionsApiRequest::productGroups_analyticsError(const QList<OAIProductGroupAnalyticsItems>& res, QNetworkReply::NetworkError error_type, QString& error_str){
    Q_UNUSED(error_type); // TODO: Remap error_type to QHttpEngine::Socket errors
    setSocketResponseHeaders();
    Q_UNUSED(error_str);  // response will be used instead of error string
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toArray());
