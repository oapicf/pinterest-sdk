...
void OAIProductGroupPromotionsApiRequest::productGroups_analyticsRequest(const QString& ad_account_idstr){
    ...
    Q_EMIT productGroups_analytics(ad_account_id, start_date, end_date, product_group_ids, columns, granularity, click_window_days, engagement_window_days, view_window_days, conversion_report_time, reporting_timezone);
}
