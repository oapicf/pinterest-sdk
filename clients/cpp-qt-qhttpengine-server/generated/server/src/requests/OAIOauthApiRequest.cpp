...
void OAIOauthApiRequest::oauth_conversionTokenResponse(const OAIConversionAccessTokenResponse& res){
...
void OAIOauthApiRequest::oauth_conversionTokenError(const OAIConversionAccessTokenResponse& res, QNetworkReply::NetworkError error_type, QString& error_str){
