...
void OAIConversionEventsApiRequest::events_createRequest(const QString& ad_account_idstr){
    ...
    OAIConversionEventsCreate oai_conversion_events_create;
    ::OpenAPI::fromJsonValue(oai_conversion_events_create, obj);
    

    Q_EMIT events_create(ad_account_id, oai_conversion_events_create, test);
}



void OAIConversionEventsApiRequest::events_createResponse(const OAIConversionEvents& res){
...
void OAIConversionEventsApiRequest::events_createError(const OAIConversionEvents& res, QNetworkReply::NetworkError error_type, QString& error_str){
