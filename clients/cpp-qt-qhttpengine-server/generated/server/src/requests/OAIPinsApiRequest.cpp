...
void OAIPinsApiRequest::pins_listRequest(){
    ...
    Q_EMIT pins_list(pin_filter, pin_metrics, include_protected_pins, pin_type, creative_types, ad_account_id, bookmark, page_size);
}
...
void OAIPinsApiRequest::multiPins_analyticsResponse(const QMap<QString, QMap>& res){
...
void OAIPinsApiRequest::multiPins_analyticsError(const QMap<QString, QMap>& res, QNetworkReply::NetworkError error_type, QString& error_str){
