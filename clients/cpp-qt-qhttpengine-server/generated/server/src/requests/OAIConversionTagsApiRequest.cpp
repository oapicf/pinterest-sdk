...
void OAIConversionTagsApiRequest::pageVisitConversionTags_getRequest(const QString& ad_account_idstr){
    ...
    Q_EMIT pageVisitConversionTags_get(ad_account_id, bookmark, page_size, order);
}



void OAIConversionTagsApiRequest::conversionTags_createResponse(const OAIConversionTag& res){
...
void OAIConversionTagsApiRequest::conversionTags_getResponse(const OAIConversionTag& res){
    setSocketResponseHeaders();
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
    socket->writeJson(resDoc);
    if(socket->isOpen()){
...
void OAIConversionTagsApiRequest::conversionTags_listResponse(const OAIConversion_tags_list_200_response& res){
    setSocketResponseHeaders();
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
    socket->writeJson(resDoc);
    if(socket->isOpen()){
...
void OAIConversionTagsApiRequest::conversionTags_createError(const OAIConversionTag& res, QNetworkReply::NetworkError error_type, QString& error_str){
...
void OAIConversionTagsApiRequest::conversionTags_getError(const OAIConversionTag& res, QNetworkReply::NetworkError error_type, QString& error_str){
    Q_UNUSED(error_type); // TODO: Remap error_type to QHttpEngine::Socket errors
    setSocketResponseHeaders();
    Q_UNUSED(error_str);  // response will be used instead of error string
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
...
void OAIConversionTagsApiRequest::conversionTags_listError(const OAIConversion_tags_list_200_response& res, QNetworkReply::NetworkError error_type, QString& error_str){
    Q_UNUSED(error_type); // TODO: Remap error_type to QHttpEngine::Socket errors
    setSocketResponseHeaders();
    Q_UNUSED(error_str);  // response will be used instead of error string
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
