...
public:
    ...
    void cancelInvitesOrRequestsResponse(const OAICancelInvitesResponse& res);
    ...
    void cancelInvitesOrRequestsError(const OAICancelInvitesResponse& res, QNetworkReply::NetworkError error_type, QString& error_str);
...
Q_SIGNALS:
    ...
    void cancelInvitesOrRequests(QString business_id, OAICancelInvitesRequest oai_cancel_invites_request);
    ...
    void get_invites(QString business_id, bool is_member, QList<OAIInviteFilterStatus> invite_status, OAIInviteType invite_type, QString bookmark, qint32 page_size);
