...
public interface BusinessesApi {
    ...
    default ResponseEntity<BusinessMemberAssetsGet200Response> businessMemberAssetsGet(
        @NotNull @Pattern(regexp = "^\\d+$") @Size(min = 1, max = 20) @Parameter(name = "business_id", description = "Unique identifier of the requesting business.", required = true, in = ParameterIn.PATH) @PathVariable("business_id") String businessId,
        @NotNull @Pattern(regexp = "^\\d+$") @Size(min = 1, max = 20) @Parameter(name = "member_id", description = "The member id to fetch assets for.", required = true, in = ParameterIn.PATH) @PathVariable("member_id") String memberId,
        @Parameter(name = "asset_type", description = "A resource type to filter the assets by. Only assets of the specified type will be returned.", in = ParameterIn.QUERY) @Valid @RequestParam(value = "asset_type", required = false, defaultValue = "AD_ACCOUNT") String assetType,
        @Min(value = 0) @Parameter(name = "start_index", description = "An index to start fetching the results from. Only the results starting from this index will be returned.", in = ParameterIn.QUERY) @Valid @RequestParam(value = "start_index", required = false, defaultValue = "0") Integer startIndex,
        @Parameter(name = "bookmark", description = "Cursor used to fetch the next page of items", in = ParameterIn.QUERY) @Valid @RequestParam(value = "bookmark", required = false) @Nullable String bookmark,
        @Min(value = 1) @Max(value = 250) @Parameter(name = "page_size", description = "Maximum number of items to include in a single page of the response. See documentation on <a href='/docs/reference/pagination/'>Pagination</a> for more information.", in = ParameterIn.QUERY) @Valid @RequestParam(value = "page_size", required = false, defaultValue = "25") Integer pageSize
    ...
    default ResponseEntity<BusinessPartnerAssetAccessGet200Response> businessPartnerAssetAccessGet(
        @NotNull @Pattern(regexp = "^\\d+$") @Size(min = 1, max = 20) @Parameter(name = "business_id", description = "Unique identifier of the requesting business.", required = true, in = ParameterIn.PATH) @PathVariable("business_id") String businessId,
        @NotNull @Pattern(regexp = "^\\d+$") @Size(min = 1, max = 20) @Parameter(name = "partner_id", description = "The partner id to be bound to the Business", required = true, in = ParameterIn.PATH) @PathVariable("partner_id") String partnerId,
        @Parameter(name = "partner_type", description = "Specifies whether to fetch internal or external (shared) partners. If partner_type=INTERNAL, the asset being queried is for accesses the partner has to your business assets.<br> If partner_type=EXTERNAL, the asset being queried is for the accesses you have to the partner's business asset.", in = ParameterIn.QUERY) @Valid @RequestParam(value = "partner_type", required = false, defaultValue = "INTERNAL") PartnerType partnerType,
        @Parameter(name = "asset_type", description = "A resource type to filter the assets by. Only assets of the specified type will be returned.", in = ParameterIn.QUERY) @Valid @RequestParam(value = "asset_type", required = false, defaultValue = "AD_ACCOUNT") String assetType,
        @Min(value = 0) @Parameter(name = "start_index", description = "An index to start fetching the results from. Only the results starting from this index will be returned.", in = ParameterIn.QUERY) @Valid @RequestParam(value = "start_index", required = false, defaultValue = "0") Integer startIndex,
        @Min(value = 1) @Max(value = 250) @Parameter(name = "page_size", description = "Maximum number of items to include in a single page of the response. See documentation on <a href='/docs/reference/pagination/'>Pagination</a> for more information.", in = ParameterIn.QUERY) @Valid @RequestParam(value = "page_size", required = false, defaultValue = "25") Integer pageSize,
        @Parameter(name = "bookmark", description = "Cursor used to fetch the next page of items", in = ParameterIn.QUERY) @Valid @RequestParam(value = "bookmark", required = false) @Nullable String bookmark
    ...
    default ResponseEntity<UpdateInvitesResultsResponseArray> createAssetInvites(
        ...
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"items\" : [ { \"exception\" : { \"code\" : 403, \"users_or_partner_ids\" : [ \"businessMember0101\", \"business+member@business.com\" ], \"invite_or_request_id\" : \"383791336903426391\", \"message\" : \"You hit the maximum number of pending invites allowed.\" }, \"invite\" : { \"created_by_business_id\" : \"1234567890123\", \"invite_data\" : { \"invite_type\" : \"MEMBER_INVITE\", \"sent_at\" : 1646767577816, \"last_updated_time\" : 1646767577816, \"invite_expiration\" : 1709748104775, \"invite_status\" : \"PENDING\" }, \"id\" : \"383791336903426391\", \"created_by_user_id\" : \"1234567890123\", \"is_received_invite\" : true } }, { \"exception\" : { \"code\" : 403, \"users_or_partner_ids\" : [ \"businessMember0101\", \"business+member@business.com\" ], \"invite_or_request_id\" : \"383791336903426391\", \"message\" : \"You hit the maximum number of pending invites allowed.\" }, \"invite\" : { \"created_by_business_id\" : \"1234567890123\", \"invite_data\" : { \"invite_type\" : \"MEMBER_INVITE\", \"sent_at\" : 1646767577816, \"last_updated_time\" : 1646767577816, \"invite_expiration\" : 1709748104775, \"invite_status\" : \"PENDING\" }, \"id\" : \"383791336903426391\", \"created_by_user_id\" : \"1234567890123\", \"is_received_invite\" : true } } ] }";
                    ApiUtil.setExampleResponse(request, "application/json", exampleString);
                    break;
                }
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
    ...
    default ResponseEntity<GetInvites200Response> getInvites(
        ...
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"bookmark\" : \"bookmark\", \"items\" : [ { \"created_time\" : 1646767577816, \"assets_summary\" : { \"ad_accounts\" : [ { \"permissions\" : [ \"FINANCE_MANAGER\", \"CATALOGS_MANAGER\", \"AUDIENCE_MANAGER\" ], \"id\" : \"549755885175\" }, { \"permissions\" : [ \"FINANCE_MANAGER\", \"CATALOGS_MANAGER\", \"AUDIENCE_MANAGER\" ], \"id\" : \"549755885175\" } ], \"profiles\" : [ { \"permissions\" : [ \"FINANCE_MANAGER\", \"CATALOGS_MANAGER\", \"AUDIENCE_MANAGER\" ], \"id\" : \"383791336903426391\" }, { \"permissions\" : [ \"FINANCE_MANAGER\", \"CATALOGS_MANAGER\", \"AUDIENCE_MANAGER\" ], \"id\" : \"383791336903426391\" } ] }, \"business_roles\" : [ \"BIZ_ADMIN\" ], \"invite_data\" : { \"invite_type\" : \"MEMBER_INVITE\", \"sent_at\" : 1646767577816, \"last_updated_time\" : 1646767577816, \"invite_expiration\" : 1709748104775, \"invite_status\" : \"PENDING\" }, \"id\" : \"383791336903426391\", \"user\" : \"{}\", \"is_received_invite\" : true }, { \"created_time\" : 1646767577816, \"assets_summary\" : { \"ad_accounts\" : [ { \"permissions\" : [ \"FINANCE_MANAGER\", \"CATALOGS_MANAGER\", \"AUDIENCE_MANAGER\" ], \"id\" : \"549755885175\" }, { \"permissions\" : [ \"FINANCE_MANAGER\", \"CATALOGS_MANAGER\", \"AUDIENCE_MANAGER\" ], \"id\" : \"549755885175\" } ], \"profiles\" : [ { \"permissions\" : [ \"FINANCE_MANAGER\", \"CATALOGS_MANAGER\", \"AUDIENCE_MANAGER\" ], \"id\" : \"383791336903426391\" }, { \"permissions\" : [ \"FINANCE_MANAGER\", \"CATALOGS_MANAGER\", \"AUDIENCE_MANAGER\" ], \"id\" : \"383791336903426391\" } ] }, \"business_roles\" : [ \"BIZ_ADMIN\" ], \"invite_data\" : { \"invite_type\" : \"MEMBER_INVITE\", \"sent_at\" : 1646767577816, \"last_updated_time\" : 1646767577816, \"invite_expiration\" : 1709748104775, \"invite_status\" : \"PENDING\" }, \"id\" : \"383791336903426391\", \"user\" : \"{}\", \"is_received_invite\" : true } ] }";
                    ApiUtil.setExampleResponse(request, "application/json", exampleString);
                    break;
                }
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
