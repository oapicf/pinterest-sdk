...
public class CatalogsItemsCreateBatchRequest implements CatalogsItemsBatchRequest {
   ...
   */
  public CatalogsItemsCreateBatchRequest(Country country, CatalogsItemsRequestLanguage language, BatchOperation operation, List<@Valid ItemCreateBatchRecord> items) {
