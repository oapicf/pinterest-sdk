...
public class LeadFormCommon {
  ...
  public LeadFormCommon hasAcceptedTerms(@Nullable Boolean hasAcceptedTerms) {
  ...
  public LeadFormCommon status(@Nullable LeadFormStatus status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.completionMessage, leadFormCommon.completionMessage) &&
        ...
        equalsNullable(this.name, leadFormCommon.name) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hashCodeNullable(completionMessage), hashCodeNullable(disclosureLanguage), hasAcceptedTerms, hashCodeNullable(name), policyLinks, hashCodeNullable(privacyPolicyLink), questions, status);
  }
