...
public class ProductGroupPromotionResponseElement {
  ...
  public ProductGroupPromotionResponseElement id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public ProductGroupPromotionResponseElement adGroupId(@Nullable String adGroupId) {
  ...
  public ProductGroupPromotionResponseElement status(@Nullable EntityStatus status) {
    this.status = status;
    return this;
  }
  ...
  public ProductGroupPromotionResponseElement creativeType(@Nullable CreativeType creativeType) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, productGroupPromotionResponseElement.id) &&
        ...
        equalsNullable(this.bidInMicroCurrency, productGroupPromotionResponseElement.bidInMicroCurrency) &&
        equalsNullable(this.included, productGroupPromotionResponseElement.included) &&
        equalsNullable(this.definition, productGroupPromotionResponseElement.definition) &&
        equalsNullable(this.relativeDefinition, productGroupPromotionResponseElement.relativeDefinition) &&
        equalsNullable(this.parentId, productGroupPromotionResponseElement.parentId) &&
        equalsNullable(this.slideshowCollectionsTitle, productGroupPromotionResponseElement.slideshowCollectionsTitle) &&
        equalsNullable(this.slideshowCollectionsDescription, productGroupPromotionResponseElement.slideshowCollectionsDescription) &&
        equalsNullable(this.isMdl, productGroupPromotionResponseElement.isMdl) &&
        Objects.equals(this.status, productGroupPromotionResponseElement.status) &&
        equalsNullable(this.trackingUrl, productGroupPromotionResponseElement.trackingUrl) &&
        equalsNullable(this.catalogProductGroupId, productGroupPromotionResponseElement.catalogProductGroupId) &&
        equalsNullable(this.catalogProductGroupName, productGroupPromotionResponseElement.catalogProductGroupName) &&
        equalsNullable(this.collectionsHeroPinId, productGroupPromotionResponseElement.collectionsHeroPinId) &&
        equalsNullable(this.collectionsHeroDestinationUrl, productGroupPromotionResponseElement.collectionsHeroDestinationUrl) &&
        equalsNullable(this.gridClickType, productGroupPromotionResponseElement.gridClickType) &&
