...
public class ScheduleDeltaValue {
  ...
  public ScheduleDeltaValue ageBucketMultipliers(@Nullable BidOptionsAgeBucketMultipliers ageBucketMultipliers) {
  ...
  public ScheduleDeltaValue appTypeMultipliers(@Nullable BidOptionsAppTypeMultipliers appTypeMultipliers) {
  ...
  public ScheduleDeltaValue genderMultipliers(@Nullable BidOptionsGenderMultipliers genderMultipliers) {
  ...
  public ScheduleDeltaValue placementMultipliers(@Nullable BidOptionsPlacementMultipliers placementMultipliers) {
