...
public class ScheduleBidOptions implements ScheduleCommonDeltaValue {
  ...
  private @Nullable ScheduleAudienceMultipliers audienceMultipliers;
  ...
  public ScheduleBidOptions audienceMultipliers(@Nullable ScheduleAudienceMultipliers audienceMultipliers) {
  ...
  public @Nullable ScheduleAudienceMultipliers getAudienceMultipliers() {
    return audienceMultipliers;
  }

  @JsonProperty("audience_multipliers")
  public void setAudienceMultipliers(@Nullable ScheduleAudienceMultipliers audienceMultipliers) {
    this.audienceMultipliers = audienceMultipliers;
  }
