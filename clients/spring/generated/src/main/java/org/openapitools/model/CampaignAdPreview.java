...
public class CampaignAdPreview implements CampaignAdPreviewCreate200ResponseInnerData {
  ...
  @JsonInclude(JsonInclude.Include.NON_NULL)
  private @Nullable Integer pinId;

  @JsonInclude(JsonInclude.Include.NON_NULL)
  private @Nullable Integer pinPromotionId;

  @JsonInclude(JsonInclude.Include.NON_NULL)
  private @Nullable Integer promotedProductGroupId;
  ...
  public CampaignAdPreview clientId(@Nullable Integer clientId) {
  ...
  public CampaignAdPreview pinId(@Nullable Integer pinId) {
    this.pinId = pinId;
    return this;
  }
  ...
  @JsonProperty("pin_id")
  public @Nullable Integer getPinId() {
    return pinId;
  }

  @JsonProperty("pin_id")
  public void setPinId(@Nullable Integer pinId) {
    this.pinId = pinId;
  }

  public CampaignAdPreview pinPromotionId(@Nullable Integer pinPromotionId) {
  ...
  public @Nullable Integer getPinPromotionId() {
    return pinPromotionId;
  }

  @JsonProperty("pin_promotion_id")
  public void setPinPromotionId(@Nullable Integer pinPromotionId) {
    this.pinPromotionId = pinPromotionId;
  }

  public CampaignAdPreview promotedProductGroupId(@Nullable Integer promotedProductGroupId) {
  ...
  public @Nullable Integer getPromotedProductGroupId() {
    return promotedProductGroupId;
  }

  @JsonProperty("promoted_product_group_id")
  public void setPromotedProductGroupId(@Nullable Integer promotedProductGroupId) {
    this.promotedProductGroupId = promotedProductGroupId;
  }
