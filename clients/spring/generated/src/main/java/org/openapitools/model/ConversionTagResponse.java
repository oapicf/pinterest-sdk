...
public class ConversionTagResponse {
  ...
  public ConversionTagResponse adAccountId(@Nullable String adAccountId) {
  ...
  public ConversionTagResponse codeSnippet(@Nullable String codeSnippet) {
  ...
  public ConversionTagResponse id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public ConversionTagResponse name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public ConversionTagResponse status(@Nullable EntityStatus status) {
    this.status = status;
    return this;
  }
  ...
  public ConversionTagResponse version(@Nullable String version) {
  ...
  public ConversionTagResponse configs(@Nullable ConversionTagConfigs configs) {
