...
public class TrendsAgeDistribution {
  ...
  private @Nullable TrendsAgeBucket ageDistribution;

  public TrendsAgeDistribution ageDistribution(@Nullable TrendsAgeBucket ageDistribution) {
  ...
  public @Nullable TrendsAgeBucket getAgeDistribution() {
    return ageDistribution;
  }

  @JsonProperty("age_distribution")
  public void setAgeDistribution(@Nullable TrendsAgeBucket ageDistribution) {
    this.ageDistribution = ageDistribution;
  }
    /**
