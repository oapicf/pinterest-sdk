...
public class CatalogsRetailItemsBatch implements CatalogsItemsBatch {
   ...
   */
  public CatalogsRetailItemsBatch(CatalogTypeEnum catalogType, OffsetDateTime createdTime) {
    this.catalogType = catalogType;
    this.createdTime = JsonNullable.of(createdTime);
  }

  public CatalogsRetailItemsBatch batchId(@Nullable String batchId) {
  ...
  public JsonNullable<OffsetDateTime> getCreatedTime() {
    return createdTime;
  }

  @JsonProperty("created_time")
  public void setCreatedTime(JsonNullable<OffsetDateTime> createdTime) {
  ...
  public CatalogsRetailItemsBatch status(@Nullable BatchOperationStatus status) {
    this.status = status;
    return this;
  }
