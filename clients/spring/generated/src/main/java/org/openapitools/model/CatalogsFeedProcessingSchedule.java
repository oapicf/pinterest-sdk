...
public class CatalogsFeedProcessingSchedule   {
  ...
  private JsonNullable<TimezoneEnum> timezone = JsonNullable.undefined();
  ...
  */
  ...
  @Schema(name = "time", example = "02:59", description = "A time in format HH:MM with leading 0 (zero)", required = true)
  ...
  */
  @NotNull 
  @Schema(name = "timezone", description = "The timezone considered for the processing schedule time.", required = true)
  public JsonNullable<TimezoneEnum> getTimezone() {
    return timezone;
  }

  public void setTimezone(JsonNullable<TimezoneEnum> timezone) {
