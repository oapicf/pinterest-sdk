...
public class DeletePartnerAssetAccessResult {
  ...
  @JsonInclude(JsonInclude.Include.NON_NULL)
  private @Nullable Boolean isSharedPartner;
  ...
  public DeletePartnerAssetAccessResult assetId(@Nullable String assetId) {
  ...
  public DeletePartnerAssetAccessResult assetType(@Nullable String assetType) {
  ...
  public DeletePartnerAssetAccessResult isSharedPartner(@Nullable Boolean isSharedPartner) {
  ...
  public DeletePartnerAssetAccessResult partnerId(@Nullable String partnerId) {
