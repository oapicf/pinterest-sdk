...
public class CampaignCreateRequest {
  ...
  private @Nullable CampaignBidOptionsCreate bidOptions;
  ...
  public CampaignCreateRequest bidOptions(@Nullable CampaignBidOptionsCreate bidOptions) {
  ...
  public @Nullable CampaignBidOptionsCreate getBidOptions() {
    return bidOptions;
  }

  public void setBidOptions(@Nullable CampaignBidOptionsCreate bidOptions) {
    this.bidOptions = bidOptions;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(adAccountId, hashCodeNullable(dailySpendCap), hashCodeNullable(endTime), isAutomatedCampaign, isFlexibleDailyBudgets, hashCodeNullable(lifetimeSpendCap), name, hashCodeNullable(orderLineId), hashCodeNullable(startTime), status, hashCodeNullable(trackingUrls), hashCodeNullable(defaultAdGroupBudgetInMicroCurrency), hashCodeNullable(isCampaignBudgetOptimization), bidOptions, isPerformancePlus, objectiveType);
  }
