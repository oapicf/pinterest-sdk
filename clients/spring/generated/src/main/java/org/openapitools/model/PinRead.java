...
public class PinRead {
  ...
  public PinRead aiDisclosures(@Nullable AiDisclosures aiDisclosures) {
  ...
  public PinRead boardId(@Nullable String boardId) {
  ...
  public PinRead boardOwner(@Nullable BoardOwner boardOwner) {
  ...
  public PinRead createdAt(@Nullable OffsetDateTime createdAt) {
  ...
  public PinRead hasBeenPromoted(@Nullable Boolean hasBeenPromoted) {
  ...
  public PinRead isOwner(@Nullable Boolean isOwner) {
  ...
  public PinRead isProduct(@Nullable Boolean isProduct) {
  ...
  public PinRead isStandard(@Nullable Boolean isStandard) {
  ...
  public PinRead media(@Nullable PinMedia media) {
    this.media = media;
    return this;
  }
