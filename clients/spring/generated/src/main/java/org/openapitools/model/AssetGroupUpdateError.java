...
public class AssetGroupUpdateError {
  ...
  public AssetGroupUpdateError assetGroupId(@Nullable String assetGroupId) {
  ...
  public AssetGroupUpdateError code(@Nullable Integer code) {
    this.code = code;
    return this;
  }
  ...
  public AssetGroupUpdateError message(@Nullable String message) {
