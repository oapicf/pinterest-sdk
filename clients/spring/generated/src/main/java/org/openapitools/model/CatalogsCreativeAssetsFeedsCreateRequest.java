...
public class CatalogsCreativeAssetsFeedsCreateRequest implements CatalogsVerticalFeedsCreateRequest {
   ...
   */
  public CatalogsCreativeAssetsFeedsCreateRequest(CatalogTypeEnum catalogType, Country defaultCountry, CatalogsCreativeAssetsFeedsCreateRequestDefaultLocale defaultLocale, CatalogsFormat format, String location, String name) {
  ...
  public CatalogsCreativeAssetsFeedsCreateRequest catalogId(@Nullable String catalogId) {
  ...
  public CatalogsCreativeAssetsFeedsCreateRequest status(@Nullable CatalogsStatus status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.catalogId, catalogsCreativeAssetsFeedsCreateRequest.catalogId) &&
        ...
        equalsNullable(this.credentials, catalogsCreativeAssetsFeedsCreateRequest.credentials) &&
        Objects.equals(this.defaultCountry, catalogsCreativeAssetsFeedsCreateRequest.defaultCountry) &&
        equalsNullable(this.defaultCurrency, catalogsCreativeAssetsFeedsCreateRequest.defaultCurrency) &&
        ...
        equalsNullable(this.preferredProcessingSchedule, catalogsCreativeAssetsFeedsCreateRequest.preferredProcessingSchedule) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(catalogId, catalogType, hashCodeNullable(credentials), defaultCountry, hashCodeNullable(defaultCurrency), defaultLocale, format, location, name, hashCodeNullable(preferredProcessingSchedule), status);
  }
