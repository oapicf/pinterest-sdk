...
public class CatalogsCreativeAssetsFeedsCreateRequest implements CatalogsVerticalFeedsCreateRequest {
   ...
   */
  public CatalogsCreativeAssetsFeedsCreateRequest(String name, CatalogsFormat format, CatalogsFeedsCreateRequestDefaultLocale defaultLocale, Country defaultCountry, String location, CatalogsType catalogType) {
    this.name = name;
    this.format = format;
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.defaultCurrency, catalogsCreativeAssetsFeedsCreateRequest.defaultCurrency) &&
        ...
        equalsNullable(this.catalogId, catalogsCreativeAssetsFeedsCreateRequest.catalogId) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hashCodeNullable(defaultCurrency), name, format, defaultLocale, defaultCountry, hashCodeNullable(credentials), location, hashCodeNullable(preferredProcessingSchedule), catalogType, hashCodeNullable(catalogId), status);
  }
