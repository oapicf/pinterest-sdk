...
public interface PinsApi {
    ...
    default ResponseEntity<Map<String, Map<String, PinAnalyticsMetricsResponse>>> multiPinsAnalytics(
        ...
        @NotNull @Parameter(name = "metric_types", description = "Pin metric types to get data for.", required = true, in = ParameterIn.QUERY) @Valid @RequestParam(value = "metric_types", required = true) List<PinsAnalyticsMetricTypesParameterInner> metricTypes,
    ...
    default ResponseEntity<Map<String, PinAnalyticsMetricsResponse>> pinsAnalytics(
        ...
        @NotNull @Parameter(name = "start_date", description = "Metric report start date (UTC). Format: YYYY-MM-DD. Cannot be more than 90 days back from today.", required = true, in = ParameterIn.QUERY) @Valid @RequestParam(value = "start_date", required = true) @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate startDate,
        @NotNull @Parameter(name = "end_date", description = "Metric report end date (UTC). Format: YYYY-MM-DD. Cannot be more than 90 days past start_date.", required = true, in = ParameterIn.QUERY) @Valid @RequestParam(value = "end_date", required = true) @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate endDate,
        @NotNull @Parameter(name = "metric_types", description = "Pin metric types to get data for. VIDEO_MRC_VIEW are Video views, VIDEO_V50_WATCH_TIME is Total play time. If Pin was created before <code>2023-03-20</code>, Profile visits and Follows will only be available for Idea Pins. These metrics are available for all Pin formats since then. Keep in mind this cannot have ALL if split_field is set to any value other than <code>NO_SPLIT</code>.", required = true, in = ParameterIn.QUERY) @Valid @RequestParam(value = "metric_types", required = true) List<PinsAnalyticsMetricTypesParameterInner> metricTypes,
        @Parameter(name = "app_types", description = "Apps or devices to get data for, default is all.", in = ParameterIn.QUERY) @Valid @RequestParam(value = "app_types", required = false, defaultValue = "ALL") String appTypes,
