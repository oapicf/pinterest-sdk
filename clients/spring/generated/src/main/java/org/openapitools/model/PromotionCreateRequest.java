...
public class PromotionCreateRequest {
   ...
   */
  public PromotionCreateRequest(String promotionTitle, PromotionType promotionType) {
    this.promotionTitle = promotionTitle;
    this.promotionType = promotionType;
  }

  public PromotionCreateRequest discountStatus(@Nullable DiscountStatusEnum discountStatus) {
  ...
  public PromotionCreateRequest endTime(@Nullable Integer endTime) {
  ...
  public PromotionCreateRequest externalId(@Nullable String externalId) {
  ...
  public PromotionCreateRequest platformType(@Nullable String platformType) {
  ...
  public PromotionCreateRequest promotionCode(@Nullable String promotionCode) {
  ...
  public PromotionCreateRequest promotionCustomId(@Nullable String promotionCustomId) {
   ...
   */
  @NotNull 
  @Schema(name = "promotion_title", example = "Black Friday 10% off", description = "Internal name for the promotion.", requiredMode = Schema.RequiredMode.REQUIRED)
  ...
  public PromotionCreateRequest startTime(@Nullable Integer startTime) {
