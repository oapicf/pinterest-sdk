...
public class AdPreviewSourcePinId implements AdPreviewRequest {
  ...
  private @Nullable AdPinPreviewCreativeType creativeType;
  ...
  public AdPreviewSourcePinId creativeType(@Nullable AdPinPreviewCreativeType creativeType) {
  ...
  public @Nullable AdPinPreviewCreativeType getCreativeType() {
    return creativeType;
  }

  @JsonProperty("creative_type")
  public void setCreativeType(@Nullable AdPinPreviewCreativeType creativeType) {
    this.creativeType = creativeType;
  }
