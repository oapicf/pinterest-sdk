...
public class ScheduleAgeBucketMultipliers {
  ...
  private @Nullable AGEBUCKETEnum AGE_BUCKET;

  public ScheduleAgeBucketMultipliers AGE_BUCKET(@Nullable AGEBUCKETEnum AGE_BUCKET) {
  ...
  @Schema(name = "AGE_BUCKET", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("AGE_BUCKET")
  public @Nullable AGEBUCKETEnum getAGEBUCKET() {
    return AGE_BUCKET;
  }

  @JsonProperty("AGE_BUCKET")
  public void setAGEBUCKET(@Nullable AGEBUCKETEnum AGE_BUCKET) {
    this.AGE_BUCKET = AGE_BUCKET;
  }
    /**
