...
@JsonTypeName("get_business_employers_200_response")
...
public class GetBusinessEmployers200Response {
   ...
   */
  public GetBusinessEmployers200Response(List<@Valid UserBusinessRoleBinding> items) {
    this.items = items;
  }
   ...
   */
  @NotNull @Valid 
  @Schema(name = "items", description = "List of employers.", requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty("items")
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.bookmark, getBusinessEmployers200Response.bookmark) &&
