        ...
        responses = {
            ...
            @ApiResponse(responseCode = "400", description = "Invalid request parameters.", content = {
                @Content(mediaType = "application/json", schema = @Schema(implementation = Error.class), examples = {
                    @ExampleObject(
                        name = "",
                        value = "{\"code\":1,\"message\":\"Invalid request: {'catalog_id': '1234'} list of retail catalog items not provided\"}"
                    )
                })
        ...
        responses = {
            ...
            @ApiResponse(responseCode = "400", description = "Invalid request parameters.", content = {
                @Content(mediaType = "application/json", schema = @Schema(implementation = Error.class), examples = {
                    @ExampleObject(
                        name = "",
                        value = "{\"code\":1,\"message\":\"Invalid request: {'catalog_id': '1234'} list of item bid option operations not provided\"}"
                    )
                })
