...
public class CampaignBatchUpdateItem {
  ...
  @JsonInclude(JsonInclude.Include.NON_NULL)
  private @Nullable MobileAppPlatform appPlatform;
  ...
  @JsonInclude(JsonInclude.Include.NON_NULL)
  private @Nullable ConversionObjectiveType objectiveType;
  ...
  public CampaignBatchUpdateItem adAccountId(@Nullable String adAccountId) {
  ...
  public CampaignBatchUpdateItem appId(@Nullable String appId) {
    this.appId = appId;
    return this;
  }
  ...
  public CampaignBatchUpdateItem appPlatform(@Nullable MobileAppPlatform appPlatform) {
  ...
  public @Nullable MobileAppPlatform getAppPlatform() {
    return appPlatform;
  }

  @JsonProperty("app_platform")
  public void setAppPlatform(@Nullable MobileAppPlatform appPlatform) {
    this.appPlatform = appPlatform;
  }
  ...
  public CampaignBatchUpdateItem intendedPromotionType(@Nullable IntendedPromotionType intendedPromotionType) {
  ...
  public CampaignBatchUpdateItem isLtvOptimized(@Nullable Boolean isLtvOptimized) {
  ...
  public CampaignBatchUpdateItem isPerformancePlus(@Nullable Boolean isPerformancePlus) {
  ...
  public CampaignBatchUpdateItem isTopOfSearch(@Nullable Boolean isTopOfSearch) {
  ...
  public CampaignBatchUpdateItem name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public CampaignBatchUpdateItem objectiveType(@Nullable ConversionObjectiveType objectiveType) {
  ...
  public @Nullable ConversionObjectiveType getObjectiveType() {
    return objectiveType;
  }

  @JsonProperty("objective_type")
  public void setObjectiveType(@Nullable ConversionObjectiveType objectiveType) {
    this.objectiveType = objectiveType;
  }
  ...
  public CampaignBatchUpdateItem status(@Nullable EntityStatus status) {
    this.status = status;
    return this;
  }
