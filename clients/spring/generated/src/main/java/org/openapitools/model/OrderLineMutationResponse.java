...
public class OrderLineMutationResponse {
  ...
  private @Nullable OrderLineMutationResult data;

  public OrderLineMutationResponse data(@Nullable OrderLineMutationResult data) {
    this.data = data;
    return this;
  }
  ...
  @JsonProperty("data")
  public @Nullable OrderLineMutationResult getData() {
    return data;
  }

  @JsonProperty("data")
  public void setData(@Nullable OrderLineMutationResult data) {
    this.data = data;
  }
