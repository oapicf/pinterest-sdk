...
public interface ResourcesApi {
    ...
    default ResponseEntity<DeliveryMetricsResponse> deliveryMetricsGet(
        @Parameter(name = "report_type", description = "Report type.", in = ParameterIn.QUERY) @Valid @RequestParam(value = "report_type", required = false) @Nullable String reportType
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
    ...
    default ResponseEntity<SingleInterestTargetingOptionResponse> interestTargetingOptionsGet(
        @NotNull @Pattern(regexp = "^\\d+$") @Size(max = 18) @Parameter(name = "interest_id", description = "Unique identifier of an interest.", required = true, in = ParameterIn.PATH) @PathVariable("interest_id") String interestId
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
    ...
    default ResponseEntity<List<Object>> targetingOptionsGet(
        @NotNull @Parameter(name = "targeting_type", description = "Public targeting type.", required = true, in = ParameterIn.PATH) @PathVariable("targeting_type") String targetingType,
