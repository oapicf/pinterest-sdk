        ...
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"bookmark\" : \"bookmark\", \"items\" : [ { \"alt_text\" : \"alt_text\", \"link\" : \"https://www.pinterest.com/\", \"description\" : \"description\", \"media\" : { \"media_type\" : \"media_type\" }, \"title\" : \"title\" }, { \"alt_text\" : \"alt_text\", \"link\" : \"https://www.pinterest.com/\", \"description\" : \"description\", \"media\" : { \"media_type\" : \"media_type\" }, \"title\" : \"title\" } ] }";
