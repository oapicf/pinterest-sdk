...
public interface AdAccountsApi {
    ...
    default ResponseEntity<MetricsResponse> adAccountTargetingAnalyticsGet(
        ...
        @NotNull @Parameter(name = "start_date", description = "Metric report start date (UTC). Format: YYYY-MM-DD. Cannot be more than 90 days back from today.", required = true, in = ParameterIn.QUERY) @Valid @RequestParam(value = "start_date", required = true) @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate startDate,
        @NotNull @Parameter(name = "end_date", description = "Metric report end date (UTC). Format: YYYY-MM-DD. Cannot be more than 90 days past start_date.", required = true, in = ParameterIn.QUERY) @Valid @RequestParam(value = "end_date", required = true) @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate endDate,
        @NotNull @Size(min = 1, max = 15) @Parameter(name = "targeting_types", description = "Targeting type breakdowns for the report. The reporting per targeting type <br> is independent from each other.", required = true, in = ParameterIn.QUERY) @Valid @RequestParam(value = "targeting_types", required = true) List<AdsAnalyticsTargetingType> targetingTypes,
        @NotNull @Parameter(name = "columns", description = "Columns to retrieve, encoded as a comma-separated string. **NOTE**: Any metrics defined as MICRO_DOLLARS returns a value based on the advertiser profile's currency field. For USD,($1/1,000,000, or $0.000001 - one one-ten-thousandth of a cent). it's microdollars. Otherwise, it's in microunits of the advertiser's currency.<br/>For example, if the advertiser's currency is GBP (British pound sterling), all MICRO_DOLLARS fields will be in GBP microunits (1/1,000,000 British pound).<br/>If a column has no value, it may not be returned", required = true, in = ParameterIn.QUERY) @Valid @RequestParam(value = "columns", required = true) List<String> columns,
        @NotNull @Parameter(name = "granularity", description = "TOTAL - metrics are aggregated over the specified date range.<br> DAY - metrics are broken down daily.<br> HOUR - metrics are broken down hourly.<br>WEEKLY - metrics are broken down weekly.<br>MONTHLY - metrics are broken down monthly", required = true, in = ParameterIn.QUERY) @Valid @RequestParam(value = "granularity", required = true) Granularity granularity,
        @Parameter(name = "click_window_days", description = "Number of days to use as the conversion attribution window for a pin click action. Applies to Pinterest Tag conversion metrics. Prior conversion tags use their defined attribution windows. If not specified, defaults to `30` days.", in = ParameterIn.QUERY) @Valid @RequestParam(value = "click_window_days", required = false, defaultValue = "30") Integer clickWindowDays,
        @Parameter(name = "engagement_window_days", description = "Number of days to use as the conversion attribution window for an engagement action. Engagements include saves, closeups, link clicks, and carousel card swipes. Applies to Pinterest Tag conversion metrics. Prior conversion tags use their defined attribution windows. If not specified, defaults to `30` days.", in = ParameterIn.QUERY) @Valid @RequestParam(value = "engagement_window_days", required = false, defaultValue = "30") Integer engagementWindowDays,
     ...
     *         or Access Denied. This can happen if account is not yet approved to operate as Merchant on Pinterest. (status code 401)
     *         or Merchant data not found. (status code 404)
     *         or Unexpected error (status code 200)
     * @deprecated
     */
    @Deprecated
    ...
    default ResponseEntity<AdAccountsCatalogsProductGroupsList200Response> adAccountsCatalogsProductGroupsList(
        @Pattern(regexp = "^\\d+$") @Size(max = 18) @Parameter(name = "ad_account_id", description = "Unique identifier of an ad account.", required = true, in = ParameterIn.PATH) @PathVariable("ad_account_id") String adAccountId,
        @Pattern(regexp = "^\\d+$") @Size(max = 18) @Parameter(name = "feed_profile_id", description = "The feed profile id whose catalog product groups we want to return.", in = ParameterIn.QUERY) @Valid @RequestParam(value = "feed_profile_id", required = false) String feedProfileId
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"bookmark\" : \"bookmark\", \"items\" : [ { \"filter_v2\" : { \"1\" : [ \"123chars_title\" ] }, \"product_count\" : 6, \"last_update\" : 1622742155000, \"featured_position\" : 2, \"name\" : \"Most Popular\", \"created_at\" : 1621350033000, \"feed_profile_id\" : \"feed_profile_id\", \"id\" : \"2680059592705\", \"merchant_id\" : \"2680059592705\", \"filters\" : { \"1\" : [ \"123chars_title\" ] }, \"type\" : { \"owner\" : { \"username\" : \"username\" }, \"board_pins_modified_at\" : \"2020-01-01T20:10:40Z\", \"name\" : \"Summer Recipes\", \"pin_count\" : 5, \"created_at\" : \"2020-01-01T20:10:40Z\", \"description\" : \"My favorite summer recipes\", \"collaborator_count\" : 17, \"privacy\" : \"PUBLIC\", \"id\" : \"549755885175\", \"media\" : { \"pin_thumbnail_urls\" : [ \"https://i.pinimg.com/150x150/b4/57/10/b45710f1ede96af55230f4b43935c4af.jpg\", \"https://i.pinimg.com/150x150/dd/ff/46/ddff4616e39c1935cd05738794fa860e.jpg\", \"https://i.pinimg.com/150x150/84/ac/59/84ac59b670ccb5b903dace480a98930c.jpg\", \"https://i.pinimg.com/150x150/4c/54/6f/4c546f521be85e30838fb742bfff6936.jpg\" ], \"image_cover_url\" : \"https://i.pinimg.com/400x300/fd/cd/d5/fdcdd5a6d8a80824add0d054125cd957.jpg\" }, \"follower_count\" : 13 }, \"status\" : \"ACTIVE\" }, { \"filter_v2\" : { \"1\" : [ \"123chars_title\" ] }, \"product_count\" : 6, \"last_update\" : 1622742155000, \"featured_position\" : 2, \"name\" : \"Most Popular\", \"created_at\" : 1621350033000, \"feed_profile_id\" : \"feed_profile_id\", \"id\" : \"2680059592705\", \"merchant_id\" : \"2680059592705\", \"filters\" : { \"1\" : [ \"123chars_title\" ] }, \"type\" : { \"owner\" : { \"username\" : \"username\" }, \"board_pins_modified_at\" : \"2020-01-01T20:10:40Z\", \"name\" : \"Summer Recipes\", \"pin_count\" : 5, \"created_at\" : \"2020-01-01T20:10:40Z\", \"description\" : \"My favorite summer recipes\", \"collaborator_count\" : 17, \"privacy\" : \"PUBLIC\", \"id\" : \"549755885175\", \"media\" : { \"pin_thumbnail_urls\" : [ \"https://i.pinimg.com/150x150/b4/57/10/b45710f1ede96af55230f4b43935c4af.jpg\", \"https://i.pinimg.com/150x150/dd/ff/46/ddff4616e39c1935cd05738794fa860e.jpg\", \"https://i.pinimg.com/150x150/84/ac/59/84ac59b670ccb5b903dace480a98930c.jpg\", \"https://i.pinimg.com/150x150/4c/54/6f/4c546f521be85e30838fb742bfff6936.jpg\" ], \"image_cover_url\" : \"https://i.pinimg.com/400x300/fd/cd/d5/fdcdd5a6d8a80824add0d054125cd957.jpg\" }, \"follower_count\" : 13 }, \"status\" : \"ACTIVE\" } ] }";
                    ApiUtil.setExampleResponse(request, "application/json", exampleString);
                    break;
                }
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
    ...
    default ResponseEntity<AdGroupResponse> adGroupsGet(
        ...
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"updated_time\" : 1476477189, \"type\" : \"adgroup\", \"tracking_urls\" : { \"engagement\" : [ \"engagement\", \"engagement\" ], \"audience_verification\" : [ \"audience_verification\", \"audience_verification\" ], \"impression\" : [ \"impression\", \"impression\" ], \"buyable_button\" : [ \"buyable_button\", \"buyable_button\" ], \"click\" : [ \"click\", \"click\" ] }, \"budget_in_micro_currency\" : 5000000, \"bid_strategy_type\" : \"MAX_BID\", \"ad_account_id\" : \"549755885175\", \"conversion_learning_mode_type\" : \"ACTIVE\", \"dca_assets\" : \"\", \"feed_profile_id\" : \"626736533506\", \"lifetime_frequency_cap\" : 100, \"id\" : \"2680060704746\", \"optimization_goal_metadata\" : { \"frequency_goal_metadata\" : { \"timerange\" : \"DAY\", \"frequency\" : 5 }, \"conversion_tag_v3_goal_metadata\" : { \"attribution_windows\" : { \"view_window_days\" : 1, \"click_window_days\" : 0, \"engagement_window_days\" : 6 }, \"conversion_tag_id\" : \"conversion_tag_id\", \"learning_mode_type\" : \"ACTIVE\", \"conversion_event\" : \"PAGE_VISIT\", \"is_roas_optimized\" : true, \"cpa_goal_value_in_micro_currency\" : \"cpa_goal_value_in_micro_currency\" }, \"scrollup_goal_metadata\" : { \"scrollup_goal_value_in_micro_currency\" : \"scrollup_goal_value_in_micro_currency\" } }, \"placement_group\" : \"placement_group\", \"budget_type\" : \"budget_type\", \"campaign_id\" : \"626736533506\", \"pacing_delivery_type\" : \"pacing_delivery_type\", \"created_time\" : 1476477189, \"bid_in_micro_currency\" : 5000000, \"end_time\" : 5705424000, \"summary_status\" : \"summary_status\", \"auto_targeting_enabled\" : true, \"start_time\" : 5686848000, \"billable_event\" : \"CLICKTHROUGH\", \"targeting_spec\" : { \"AUDIENCE_INCLUDE'\" : [ \"AUDIENCE_INCLUDE'\", \"AUDIENCE_INCLUDE'\" ], \"GEO\" : [ \"GEO\", \"GEO\" ], \"LOCATION\" : [ \"LOCATION\", \"LOCATION\" ], \"LOCALE\" : [ \"LOCALE\", \"LOCALE\" ], \"AGE_BUCKET\" : [ \"35-44\", \"50-54\" ], \"SHOPPING_RETARGETING\" : [ { \"lookback_window\" : 30, \"exclusion_window\" : 14, \"tag_types\" : [ 0, 6 ] }, { \"lookback_window\" : 30, \"exclusion_window\" : 14, \"tag_types\" : [ 0, 6 ] } ], \"GENDER\" : [ \"unknown\", \"unknown\" ], \"TARGETING_STRATEGY\" : [ \"CHOOSE_YOUR_OWN\", \"CHOOSE_YOUR_OWN\" ], \"APPTYPE\" : [ \"ipad\", \"iphone\" ], \"AUDIENCE_EXCLUDE\" : [ \"AUDIENCE_EXCLUDE\", \"AUDIENCE_EXCLUDE\" ], \"INTEREST\" : [ \"INTEREST\", \"INTEREST\" ] }, \"name\" : \"Ad Group For Pin: 687195905986\", \"status\" : \"status\" }";
                    ApiUtil.setExampleResponse(request, "application/json", exampleString);
                    break;
                }
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
    ...
    default ResponseEntity<AdGroupsList200Response> adGroupsList(
        ...
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"bookmark\" : \"bookmark\", \"items\" : [ { \"updated_time\" : 1476477189, \"type\" : \"adgroup\", \"tracking_urls\" : { \"engagement\" : [ \"engagement\", \"engagement\" ], \"audience_verification\" : [ \"audience_verification\", \"audience_verification\" ], \"impression\" : [ \"impression\", \"impression\" ], \"buyable_button\" : [ \"buyable_button\", \"buyable_button\" ], \"click\" : [ \"click\", \"click\" ] }, \"budget_in_micro_currency\" : 5000000, \"bid_strategy_type\" : \"MAX_BID\", \"ad_account_id\" : \"549755885175\", \"conversion_learning_mode_type\" : \"ACTIVE\", \"dca_assets\" : \"\", \"feed_profile_id\" : \"626736533506\", \"lifetime_frequency_cap\" : 100, \"id\" : \"2680060704746\", \"optimization_goal_metadata\" : { \"frequency_goal_metadata\" : { \"timerange\" : \"DAY\", \"frequency\" : 5 }, \"conversion_tag_v3_goal_metadata\" : { \"attribution_windows\" : { \"view_window_days\" : 1, \"click_window_days\" : 0, \"engagement_window_days\" : 6 }, \"conversion_tag_id\" : \"conversion_tag_id\", \"learning_mode_type\" : \"ACTIVE\", \"conversion_event\" : \"PAGE_VISIT\", \"is_roas_optimized\" : true, \"cpa_goal_value_in_micro_currency\" : \"cpa_goal_value_in_micro_currency\" }, \"scrollup_goal_metadata\" : { \"scrollup_goal_value_in_micro_currency\" : \"scrollup_goal_value_in_micro_currency\" } }, \"placement_group\" : \"placement_group\", \"budget_type\" : \"budget_type\", \"campaign_id\" : \"626736533506\", \"pacing_delivery_type\" : \"pacing_delivery_type\", \"created_time\" : 1476477189, \"bid_in_micro_currency\" : 5000000, \"end_time\" : 5705424000, \"summary_status\" : \"summary_status\", \"auto_targeting_enabled\" : true, \"start_time\" : 5686848000, \"billable_event\" : \"CLICKTHROUGH\", \"targeting_spec\" : { \"AUDIENCE_INCLUDE'\" : [ \"AUDIENCE_INCLUDE'\", \"AUDIENCE_INCLUDE'\" ], \"GEO\" : [ \"GEO\", \"GEO\" ], \"LOCATION\" : [ \"LOCATION\", \"LOCATION\" ], \"LOCALE\" : [ \"LOCALE\", \"LOCALE\" ], \"AGE_BUCKET\" : [ \"35-44\", \"50-54\" ], \"SHOPPING_RETARGETING\" : [ { \"lookback_window\" : 30, \"exclusion_window\" : 14, \"tag_types\" : [ 0, 6 ] }, { \"lookback_window\" : 30, \"exclusion_window\" : 14, \"tag_types\" : [ 0, 6 ] } ], \"GENDER\" : [ \"unknown\", \"unknown\" ], \"TARGETING_STRATEGY\" : [ \"CHOOSE_YOUR_OWN\", \"CHOOSE_YOUR_OWN\" ], \"APPTYPE\" : [ \"ipad\", \"iphone\" ], \"AUDIENCE_EXCLUDE\" : [ \"AUDIENCE_EXCLUDE\", \"AUDIENCE_EXCLUDE\" ], \"INTEREST\" : [ \"INTEREST\", \"INTEREST\" ] }, \"name\" : \"Ad Group For Pin: 687195905986\", \"status\" : \"status\" }, { \"updated_time\" : 1476477189, \"type\" : \"adgroup\", \"tracking_urls\" : { \"engagement\" : [ \"engagement\", \"engagement\" ], \"audience_verification\" : [ \"audience_verification\", \"audience_verification\" ], \"impression\" : [ \"impression\", \"impression\" ], \"buyable_button\" : [ \"buyable_button\", \"buyable_button\" ], \"click\" : [ \"click\", \"click\" ] }, \"budget_in_micro_currency\" : 5000000, \"bid_strategy_type\" : \"MAX_BID\", \"ad_account_id\" : \"549755885175\", \"conversion_learning_mode_type\" : \"ACTIVE\", \"dca_assets\" : \"\", \"feed_profile_id\" : \"626736533506\", \"lifetime_frequency_cap\" : 100, \"id\" : \"2680060704746\", \"optimization_goal_metadata\" : { \"frequency_goal_metadata\" : { \"timerange\" : \"DAY\", \"frequency\" : 5 }, \"conversion_tag_v3_goal_metadata\" : { \"attribution_windows\" : { \"view_window_days\" : 1, \"click_window_days\" : 0, \"engagement_window_days\" : 6 }, \"conversion_tag_id\" : \"conversion_tag_id\", \"learning_mode_type\" : \"ACTIVE\", \"conversion_event\" : \"PAGE_VISIT\", \"is_roas_optimized\" : true, \"cpa_goal_value_in_micro_currency\" : \"cpa_goal_value_in_micro_currency\" }, \"scrollup_goal_metadata\" : { \"scrollup_goal_value_in_micro_currency\" : \"scrollup_goal_value_in_micro_currency\" } }, \"placement_group\" : \"placement_group\", \"budget_type\" : \"budget_type\", \"campaign_id\" : \"626736533506\", \"pacing_delivery_type\" : \"pacing_delivery_type\", \"created_time\" : 1476477189, \"bid_in_micro_currency\" : 5000000, \"end_time\" : 5705424000, \"summary_status\" : \"summary_status\", \"auto_targeting_enabled\" : true, \"start_time\" : 5686848000, \"billable_event\" : \"CLICKTHROUGH\", \"targeting_spec\" : { \"AUDIENCE_INCLUDE'\" : [ \"AUDIENCE_INCLUDE'\", \"AUDIENCE_INCLUDE'\" ], \"GEO\" : [ \"GEO\", \"GEO\" ], \"LOCATION\" : [ \"LOCATION\", \"LOCATION\" ], \"LOCALE\" : [ \"LOCALE\", \"LOCALE\" ], \"AGE_BUCKET\" : [ \"35-44\", \"50-54\" ], \"SHOPPING_RETARGETING\" : [ { \"lookback_window\" : 30, \"exclusion_window\" : 14, \"tag_types\" : [ 0, 6 ] }, { \"lookback_window\" : 30, \"exclusion_window\" : 14, \"tag_types\" : [ 0, 6 ] } ], \"GENDER\" : [ \"unknown\", \"unknown\" ], \"TARGETING_STRATEGY\" : [ \"CHOOSE_YOUR_OWN\", \"CHOOSE_YOUR_OWN\" ], \"APPTYPE\" : [ \"ipad\", \"iphone\" ], \"AUDIENCE_EXCLUDE\" : [ \"AUDIENCE_EXCLUDE\", \"AUDIENCE_EXCLUDE\" ], \"INTEREST\" : [ \"INTEREST\", \"INTEREST\" ] }, \"name\" : \"Ad Group For Pin: 687195905986\", \"status\" : \"status\" } ] }";
                    ApiUtil.setExampleResponse(request, "application/json", exampleString);
                    break;
                }
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
    ...
    default ResponseEntity<AdGroupArrayResponse> adGroupsUpdate(
        @Pattern(regexp = "^\\d+$") @Size(max = 18) @Parameter(name = "ad_account_id", description = "Unique identifier of an ad account.", required = true, in = ParameterIn.PATH) @PathVariable("ad_account_id") String adAccountId,
        @Parameter(name = "AdGroupUpdateRequest", description = "List of ad groups to update, size limit [1, 30].", required = true) @Valid@Size(min = 1, max = 30)  @RequestBody List<AdGroupUpdateRequest> adGroupUpdateRequest
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
    ...
    default ResponseEntity<AdArrayResponse> adsCreate(
        @Pattern(regexp = "^\\d+$") @Size(max = 18) @Parameter(name = "ad_account_id", description = "Unique identifier of an ad account.", required = true, in = ParameterIn.PATH) @PathVariable("ad_account_id") String adAccountId,
        @Parameter(name = "AdCreateRequest", description = "List of ads to create, size limit [1, 30].", required = true) @Valid@Size(min = 1, max = 30)  @RequestBody List<AdCreateRequest> adCreateRequest
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"items\" : [ { \"data\" : { \"is_removable\" : false, \"updated_time\" : 1451431341, \"collection_items_destination_url_template\" : \"collection_items_destination_url_template\", \"destination_url\" : \"destination_url\", \"type\" : \"pinpromotion\", \"tracking_urls\" : { \"engagement\" : [ \"engagement\", \"engagement\" ], \"audience_verification\" : [ \"audience_verification\", \"audience_verification\" ], \"impression\" : [ \"impression\", \"impression\" ], \"buyable_button\" : [ \"buyable_button\", \"buyable_button\" ], \"click\" : [ \"click\", \"click\" ] }, \"ios_deep_link\" : \"ios_deep_link\", \"ad_account_id\" : \"549755885175\", \"is_pin_deleted\" : false, \"creative_type\" : \"REGULAR\", \"grid_click_type\" : \"CLOSEUP\", \"rejection_labels\" : [ \"rejection_labels\", \"rejection_labels\" ], \"id\" : \"687195134316\", \"review_status\" : \"PENDING\", \"ad_group_id\" : \"2680059592705\", \"pin_id\" : \"394205773611545468\", \"campaign_id\" : \"626735565838\", \"created_time\" : 1451431341, \"view_tracking_url\" : \"view_tracking_url\", \"android_deep_link\" : \"android_deep_link\", \"summary_status\" : \"summary_status\", \"carousel_android_deep_links\" : [ \"carousel_android_deep_links\", \"carousel_android_deep_links\" ], \"carousel_destination_urls\" : [ \"carousel_destination_urls\", \"carousel_destination_urls\" ], \"carousel_ios_deep_links\" : [ \"carousel_ios_deep_links\", \"carousel_ios_deep_links\" ], \"click_tracking_url\" : \"click_tracking_url\", \"quiz_pin_data\" : { \"questions\" : [ { \"question_id\" : 1, \"question_text\" : \"Where do you thrive?\", \"options\" : [ { \"text\" : \"Hangout vibes\" }, { \"text\" : \"Time to party!\" }, { \"text\" : \"Keeping it lowkey\" } ] }, { \"question_id\" : 1, \"question_text\" : \"Where do you thrive?\", \"options\" : [ { \"text\" : \"Hangout vibes\" }, { \"text\" : \"Time to party!\" }, { \"text\" : \"Keeping it lowkey\" } ] } ], \"results\" : [ { \"organic_pin_id\" : \"pinId\", \"android_deep_link\" : \"https://www.pinterest.com/\", \"ios_deep_link\" : \"https://www.pinterest.com/\", \"destination_url\" : \"https://www.pinterest.com/\" }, { \"organic_pin_id\" : \"pinId\", \"android_deep_link\" : \"https://www.pinterest.com/\", \"ios_deep_link\" : \"https://www.pinterest.com/\", \"destination_url\" : \"https://www.pinterest.com/\" } ] }, \"name\" : \"name\", \"lead_form_id\" : \"lead_form_id\", \"customizable_cta_type\" : \"LEARN_MORE\", \"rejected_reasons\" : [ \"HASHTAGS\", \"HASHTAGS\" ], \"status\" : \"ACTIVE\" }, \"exceptions\" : { \"code\" : 2, \"message\" : \"Advertiser not found.\" } }, { \"data\" : { \"is_removable\" : false, \"updated_time\" : 1451431341, \"collection_items_destination_url_template\" : \"collection_items_destination_url_template\", \"destination_url\" : \"destination_url\", \"type\" : \"pinpromotion\", \"tracking_urls\" : { \"engagement\" : [ \"engagement\", \"engagement\" ], \"audience_verification\" : [ \"audience_verification\", \"audience_verification\" ], \"impression\" : [ \"impression\", \"impression\" ], \"buyable_button\" : [ \"buyable_button\", \"buyable_button\" ], \"click\" : [ \"click\", \"click\" ] }, \"ios_deep_link\" : \"ios_deep_link\", \"ad_account_id\" : \"549755885175\", \"is_pin_deleted\" : false, \"creative_type\" : \"REGULAR\", \"grid_click_type\" : \"CLOSEUP\", \"rejection_labels\" : [ \"rejection_labels\", \"rejection_labels\" ], \"id\" : \"687195134316\", \"review_status\" : \"PENDING\", \"ad_group_id\" : \"2680059592705\", \"pin_id\" : \"394205773611545468\", \"campaign_id\" : \"626735565838\", \"created_time\" : 1451431341, \"view_tracking_url\" : \"view_tracking_url\", \"android_deep_link\" : \"android_deep_link\", \"summary_status\" : \"summary_status\", \"carousel_android_deep_links\" : [ \"carousel_android_deep_links\", \"carousel_android_deep_links\" ], \"carousel_destination_urls\" : [ \"carousel_destination_urls\", \"carousel_destination_urls\" ], \"carousel_ios_deep_links\" : [ \"carousel_ios_deep_links\", \"carousel_ios_deep_links\" ], \"click_tracking_url\" : \"click_tracking_url\", \"quiz_pin_data\" : { \"questions\" : [ { \"question_id\" : 1, \"question_text\" : \"Where do you thrive?\", \"options\" : [ { \"text\" : \"Hangout vibes\" }, { \"text\" : \"Time to party!\" }, { \"text\" : \"Keeping it lowkey\" } ] }, { \"question_id\" : 1, \"question_text\" : \"Where do you thrive?\", \"options\" : [ { \"text\" : \"Hangout vibes\" }, { \"text\" : \"Time to party!\" }, { \"text\" : \"Keeping it lowkey\" } ] } ], \"results\" : [ { \"organic_pin_id\" : \"pinId\", \"android_deep_link\" : \"https://www.pinterest.com/\", \"ios_deep_link\" : \"https://www.pinterest.com/\", \"destination_url\" : \"https://www.pinterest.com/\" }, { \"organic_pin_id\" : \"pinId\", \"android_deep_link\" : \"https://www.pinterest.com/\", \"ios_deep_link\" : \"https://www.pinterest.com/\", \"destination_url\" : \"https://www.pinterest.com/\" } ] }, \"name\" : \"name\", \"lead_form_id\" : \"lead_form_id\", \"customizable_cta_type\" : \"LEARN_MORE\", \"rejected_reasons\" : [ \"HASHTAGS\", \"HASHTAGS\" ], \"status\" : \"ACTIVE\" }, \"exceptions\" : { \"code\" : 2, \"message\" : \"Advertiser not found.\" } } ] }";
                    ApiUtil.setExampleResponse(request, "application/json", exampleString);
                    break;
                }
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
    ...
    default ResponseEntity<AdResponse> adsGet(
        ...
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"is_removable\" : false, \"updated_time\" : 1451431341, \"collection_items_destination_url_template\" : \"collection_items_destination_url_template\", \"destination_url\" : \"destination_url\", \"type\" : \"pinpromotion\", \"tracking_urls\" : { \"engagement\" : [ \"engagement\", \"engagement\" ], \"audience_verification\" : [ \"audience_verification\", \"audience_verification\" ], \"impression\" : [ \"impression\", \"impression\" ], \"buyable_button\" : [ \"buyable_button\", \"buyable_button\" ], \"click\" : [ \"click\", \"click\" ] }, \"ios_deep_link\" : \"ios_deep_link\", \"ad_account_id\" : \"549755885175\", \"is_pin_deleted\" : false, \"creative_type\" : \"REGULAR\", \"grid_click_type\" : \"CLOSEUP\", \"rejection_labels\" : [ \"rejection_labels\", \"rejection_labels\" ], \"id\" : \"687195134316\", \"review_status\" : \"PENDING\", \"ad_group_id\" : \"2680059592705\", \"pin_id\" : \"394205773611545468\", \"campaign_id\" : \"626735565838\", \"created_time\" : 1451431341, \"view_tracking_url\" : \"view_tracking_url\", \"android_deep_link\" : \"android_deep_link\", \"summary_status\" : \"summary_status\", \"carousel_android_deep_links\" : [ \"carousel_android_deep_links\", \"carousel_android_deep_links\" ], \"carousel_destination_urls\" : [ \"carousel_destination_urls\", \"carousel_destination_urls\" ], \"carousel_ios_deep_links\" : [ \"carousel_ios_deep_links\", \"carousel_ios_deep_links\" ], \"click_tracking_url\" : \"click_tracking_url\", \"quiz_pin_data\" : { \"questions\" : [ { \"question_id\" : 1, \"question_text\" : \"Where do you thrive?\", \"options\" : [ { \"text\" : \"Hangout vibes\" }, { \"text\" : \"Time to party!\" }, { \"text\" : \"Keeping it lowkey\" } ] }, { \"question_id\" : 1, \"question_text\" : \"Where do you thrive?\", \"options\" : [ { \"text\" : \"Hangout vibes\" }, { \"text\" : \"Time to party!\" }, { \"text\" : \"Keeping it lowkey\" } ] } ], \"results\" : [ { \"organic_pin_id\" : \"pinId\", \"android_deep_link\" : \"https://www.pinterest.com/\", \"ios_deep_link\" : \"https://www.pinterest.com/\", \"destination_url\" : \"https://www.pinterest.com/\" }, { \"organic_pin_id\" : \"pinId\", \"android_deep_link\" : \"https://www.pinterest.com/\", \"ios_deep_link\" : \"https://www.pinterest.com/\", \"destination_url\" : \"https://www.pinterest.com/\" } ] }, \"name\" : \"name\", \"lead_form_id\" : \"lead_form_id\", \"customizable_cta_type\" : \"LEARN_MORE\", \"rejected_reasons\" : [ \"HASHTAGS\", \"HASHTAGS\" ], \"status\" : \"ACTIVE\" }";
                    ApiUtil.setExampleResponse(request, "application/json", exampleString);
                    break;
                }
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
    ...
    default ResponseEntity<AdsList200Response> adsList(
        ...
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"bookmark\" : \"bookmark\", \"items\" : [ { \"is_removable\" : false, \"updated_time\" : 1451431341, \"collection_items_destination_url_template\" : \"collection_items_destination_url_template\", \"destination_url\" : \"destination_url\", \"type\" : \"pinpromotion\", \"tracking_urls\" : { \"engagement\" : [ \"engagement\", \"engagement\" ], \"audience_verification\" : [ \"audience_verification\", \"audience_verification\" ], \"impression\" : [ \"impression\", \"impression\" ], \"buyable_button\" : [ \"buyable_button\", \"buyable_button\" ], \"click\" : [ \"click\", \"click\" ] }, \"ios_deep_link\" : \"ios_deep_link\", \"ad_account_id\" : \"549755885175\", \"is_pin_deleted\" : false, \"creative_type\" : \"REGULAR\", \"grid_click_type\" : \"CLOSEUP\", \"rejection_labels\" : [ \"rejection_labels\", \"rejection_labels\" ], \"id\" : \"687195134316\", \"review_status\" : \"PENDING\", \"ad_group_id\" : \"2680059592705\", \"pin_id\" : \"394205773611545468\", \"campaign_id\" : \"626735565838\", \"created_time\" : 1451431341, \"view_tracking_url\" : \"view_tracking_url\", \"android_deep_link\" : \"android_deep_link\", \"summary_status\" : \"summary_status\", \"carousel_android_deep_links\" : [ \"carousel_android_deep_links\", \"carousel_android_deep_links\" ], \"carousel_destination_urls\" : [ \"carousel_destination_urls\", \"carousel_destination_urls\" ], \"carousel_ios_deep_links\" : [ \"carousel_ios_deep_links\", \"carousel_ios_deep_links\" ], \"click_tracking_url\" : \"click_tracking_url\", \"quiz_pin_data\" : { \"questions\" : [ { \"question_id\" : 1, \"question_text\" : \"Where do you thrive?\", \"options\" : [ { \"text\" : \"Hangout vibes\" }, { \"text\" : \"Time to party!\" }, { \"text\" : \"Keeping it lowkey\" } ] }, { \"question_id\" : 1, \"question_text\" : \"Where do you thrive?\", \"options\" : [ { \"text\" : \"Hangout vibes\" }, { \"text\" : \"Time to party!\" }, { \"text\" : \"Keeping it lowkey\" } ] } ], \"results\" : [ { \"organic_pin_id\" : \"pinId\", \"android_deep_link\" : \"https://www.pinterest.com/\", \"ios_deep_link\" : \"https://www.pinterest.com/\", \"destination_url\" : \"https://www.pinterest.com/\" }, { \"organic_pin_id\" : \"pinId\", \"android_deep_link\" : \"https://www.pinterest.com/\", \"ios_deep_link\" : \"https://www.pinterest.com/\", \"destination_url\" : \"https://www.pinterest.com/\" } ] }, \"name\" : \"name\", \"lead_form_id\" : \"lead_form_id\", \"customizable_cta_type\" : \"LEARN_MORE\", \"rejected_reasons\" : [ \"HASHTAGS\", \"HASHTAGS\" ], \"status\" : \"ACTIVE\" }, { \"is_removable\" : false, \"updated_time\" : 1451431341, \"collection_items_destination_url_template\" : \"collection_items_destination_url_template\", \"destination_url\" : \"destination_url\", \"type\" : \"pinpromotion\", \"tracking_urls\" : { \"engagement\" : [ \"engagement\", \"engagement\" ], \"audience_verification\" : [ \"audience_verification\", \"audience_verification\" ], \"impression\" : [ \"impression\", \"impression\" ], \"buyable_button\" : [ \"buyable_button\", \"buyable_button\" ], \"click\" : [ \"click\", \"click\" ] }, \"ios_deep_link\" : \"ios_deep_link\", \"ad_account_id\" : \"549755885175\", \"is_pin_deleted\" : false, \"creative_type\" : \"REGULAR\", \"grid_click_type\" : \"CLOSEUP\", \"rejection_labels\" : [ \"rejection_labels\", \"rejection_labels\" ], \"id\" : \"687195134316\", \"review_status\" : \"PENDING\", \"ad_group_id\" : \"2680059592705\", \"pin_id\" : \"394205773611545468\", \"campaign_id\" : \"626735565838\", \"created_time\" : 1451431341, \"view_tracking_url\" : \"view_tracking_url\", \"android_deep_link\" : \"android_deep_link\", \"summary_status\" : \"summary_status\", \"carousel_android_deep_links\" : [ \"carousel_android_deep_links\", \"carousel_android_deep_links\" ], \"carousel_destination_urls\" : [ \"carousel_destination_urls\", \"carousel_destination_urls\" ], \"carousel_ios_deep_links\" : [ \"carousel_ios_deep_links\", \"carousel_ios_deep_links\" ], \"click_tracking_url\" : \"click_tracking_url\", \"quiz_pin_data\" : { \"questions\" : [ { \"question_id\" : 1, \"question_text\" : \"Where do you thrive?\", \"options\" : [ { \"text\" : \"Hangout vibes\" }, { \"text\" : \"Time to party!\" }, { \"text\" : \"Keeping it lowkey\" } ] }, { \"question_id\" : 1, \"question_text\" : \"Where do you thrive?\", \"options\" : [ { \"text\" : \"Hangout vibes\" }, { \"text\" : \"Time to party!\" }, { \"text\" : \"Keeping it lowkey\" } ] } ], \"results\" : [ { \"organic_pin_id\" : \"pinId\", \"android_deep_link\" : \"https://www.pinterest.com/\", \"ios_deep_link\" : \"https://www.pinterest.com/\", \"destination_url\" : \"https://www.pinterest.com/\" }, { \"organic_pin_id\" : \"pinId\", \"android_deep_link\" : \"https://www.pinterest.com/\", \"ios_deep_link\" : \"https://www.pinterest.com/\", \"destination_url\" : \"https://www.pinterest.com/\" } ] }, \"name\" : \"name\", \"lead_form_id\" : \"lead_form_id\", \"customizable_cta_type\" : \"LEARN_MORE\", \"rejected_reasons\" : [ \"HASHTAGS\", \"HASHTAGS\" ], \"status\" : \"ACTIVE\" } ] }";
                    ApiUtil.setExampleResponse(request, "application/json", exampleString);
                    break;
                }
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
    ...
    default ResponseEntity<AdArrayResponse> adsUpdate(
        @Pattern(regexp = "^\\d+$") @Size(max = 18) @Parameter(name = "ad_account_id", description = "Unique identifier of an ad account.", required = true, in = ParameterIn.PATH) @PathVariable("ad_account_id") String adAccountId,
        @Parameter(name = "AdUpdateRequest", description = "List of ads to update, size limit [1, 30]", required = true) @Valid@Size(min = 1, max = 30)  @RequestBody List<AdUpdateRequest> adUpdateRequest
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
    ...
    default ResponseEntity<AudiencesList200Response> audiencesList(
        ...
        @Min(1) @Max(250) @Parameter(name = "page_size", description = "Maximum number of items to include in a single page of the response. See documentation on <a href='/docs/getting-started/pagination/'>Pagination</a> for more information.", in = ParameterIn.QUERY) @Valid @RequestParam(value = "page_size", required = false, defaultValue = "25") Integer pageSize,
        @Parameter(name = "ownership_type", description = "<strong>This feature is currently in beta and not available to all apps.</strong> Filter audiences by ownership type.", in = ParameterIn.QUERY) @Valid @RequestParam(value = "ownership_type", required = false, defaultValue = "OWNED") String ownershipType
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
    ...
    default ResponseEntity<CampaignCreateResponse> campaignsCreate(
        ...
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"items\" : [ { \"data\" : { }, \"exceptions\" : [ { \"code\" : 2, \"message\" : \"Advertiser not found.\" }, { \"code\" : 2, \"message\" : \"Advertiser not found.\" } ] }, { \"data\" : { }, \"exceptions\" : [ { \"code\" : 2, \"message\" : \"Advertiser not found.\" }, { \"code\" : 2, \"message\" : \"Advertiser not found.\" } ] } ] }";
                    ApiUtil.setExampleResponse(request, "application/json", exampleString);
                    break;
                }
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
    ...
    default ResponseEntity<CampaignResponse> campaignsGet(
        ...
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"created_time\" : 1432744744, \"updated_time\" : 1432744744, \"lifetime_spend_cap\" : 1432744744, \"end_time\" : 1644023526, \"is_flexible_daily_budgets\" : true, \"daily_spend_cap\" : 1432744744, \"summary_status\" : \"summary_status\", \"is_campaign_budget_optimization\" : true, \"type\" : \"campaign\", \"tracking_urls\" : { \"engagement\" : [ \"engagement\", \"engagement\" ], \"audience_verification\" : [ \"audience_verification\", \"audience_verification\" ], \"impression\" : [ \"impression\", \"impression\" ], \"buyable_button\" : [ \"buyable_button\", \"buyable_button\" ], \"click\" : [ \"click\", \"click\" ] }, \"ad_account_id\" : \"549755885175\", \"start_time\" : 1580865126, \"name\" : \"ACME Tools\", \"order_line_id\" : \"549755885175\", \"id\" : \"549755885175\", \"status\" : \"status\" }";
                    ApiUtil.setExampleResponse(request, "application/json", exampleString);
                    break;
                }
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
    ...
    default ResponseEntity<KeywordsResponse> keywordsCreate(
        ...
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"keywords\" : [ { \"archived\" : false, \"parent_id\" : \"383791336903426391\", \"id\" : \"383791336903426391\", \"parent_type\" : \"campaign\", \"type\" : \"keyword\" }, { \"archived\" : false, \"parent_id\" : \"383791336903426391\", \"id\" : \"383791336903426391\", \"parent_type\" : \"campaign\", \"type\" : \"keyword\" } ], \"errors\" : [ { \"data\" : { \"archived\" : false, \"parent_id\" : \"383791336903426391\", \"id\" : \"383791336903426391\", \"parent_type\" : \"campaign\", \"type\" : \"keyword\" }, \"error_messages\" : [ \"error_messages\", \"error_messages\" ] }, { \"data\" : { \"archived\" : false, \"parent_id\" : \"383791336903426391\", \"id\" : \"383791336903426391\", \"parent_type\" : \"campaign\", \"type\" : \"keyword\" }, \"error_messages\" : [ \"error_messages\", \"error_messages\" ] } ] }";
                    ApiUtil.setExampleResponse(request, "application/json", exampleString);
                    break;
                }
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
    ...
    default ResponseEntity<KeywordsGet200Response> keywordsGet(
        ...
        @Size(min = 1, max = 5) @Parameter(name = "match_types", description = "Keyword <a target=\"_blank\" href=\"/docs/ads/targeting/#Match%20type%20and%20targeting%20level\">match type</a>", in = ParameterIn.QUERY) @Valid @RequestParam(value = "match_types", required = false) List<MatchType> matchTypes,
        @Min(1) @Max(250) @Parameter(name = "page_size", description = "Maximum number of items to include in a single page of the response. See documentation on <a href='/docs/getting-started/pagination/'>Pagination</a> for more information.", in = ParameterIn.QUERY) @Valid @RequestParam(value = "page_size", required = false, defaultValue = "25") Integer pageSize,
        @Parameter(name = "bookmark", description = "Cursor used to fetch the next page of items", in = ParameterIn.QUERY) @Valid @RequestParam(value = "bookmark", required = false) String bookmark
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"bookmark\" : \"bookmark\", \"items\" : [ { \"archived\" : false, \"parent_id\" : \"383791336903426391\", \"id\" : \"383791336903426391\", \"parent_type\" : \"campaign\", \"type\" : \"keyword\" }, { \"archived\" : false, \"parent_id\" : \"383791336903426391\", \"id\" : \"383791336903426391\", \"parent_type\" : \"campaign\", \"type\" : \"keyword\" } ] }";
                    ApiUtil.setExampleResponse(request, "application/json", exampleString);
                    break;
                }
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
    ...
    default ResponseEntity<LeadFormResponse> leadFormGet(
        ...
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"completion_message\" : \"Thank you for submitting. We will contact you soon.\", \"created_time\" : 1451431341, \"updated_time\" : 1451431341, \"disclosure_language\" : \"By entering your personal information, you agree that your data will be collected and used.\", \"name\" : \"Lead Form 3/14/2023\", \"questions\" : [ { \"question_type\" : \"CUSTOM\", \"custom_question_field_type\" : \"CHECKBOX\", \"custom_question_label\" : \"What is your favorite animal?\", \"custom_question_options\" : [ \"Dog\", \"Cat\", \"Bird\", \"Turtle\" ] } ], \"has_accepted_terms\" : false, \"id\" : \"7765300871171\", \"privacy_policy_link\" : \"https://www.advertisername.com/privacy-policy\", \"status\" : \"DRAFT\", \"ad_account_id\" : \"549755885175\" }";
                    ApiUtil.setExampleResponse(request, "application/json", exampleString);
                    break;
                }
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
    ...
    /**
     * GET /ad_accounts/{ad_account_id}/lead_forms : Get lead forms
    ...
    default ResponseEntity<ProductGroupPromotionResponse> productGroupPromotionsCreate(
        ...
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"items\" : [ { \"data\" : { \"catalog_product_group_id\" : \"1231235\", \"bid_in_micro_currency\" : 14000000, \"relative_definition\" : \"product_type_1='beverage appliances'\", \"slideshow_collections_description\" : \"slideshow description\", \"collections_hero_pin_id\" : \"123123\", \"catalog_product_group_name\" : \"catalogProductGroupName\", \"slideshow_collections_title\" : \"slideshow title\", \"is_mdl\" : true, \"parent_id\" : \"1231234\", \"creative_type\" : \"REGULAR\", \"grid_click_type\" : \"CLOSEUP\", \"definition\" : \"*/product_type_0='kitchen'/product_type_1='beverage appliances'\", \"id\" : \"2680059592705\", \"ad_group_id\" : \"2680059592705\", \"collections_hero_destination_url\" : \"http://www.pinterest.com\", \"included\" : true, \"tracking_url\" : \"https://www.pinterest.com\", \"status\" : \"ACTIVE\" }, \"exceptions\" : [ { \"code\" : 2, \"message\" : \"Advertiser not found.\" }, { \"code\" : 2, \"message\" : \"Advertiser not found.\" } ] }, { \"data\" : { \"catalog_product_group_id\" : \"1231235\", \"bid_in_micro_currency\" : 14000000, \"relative_definition\" : \"product_type_1='beverage appliances'\", \"slideshow_collections_description\" : \"slideshow description\", \"collections_hero_pin_id\" : \"123123\", \"catalog_product_group_name\" : \"catalogProductGroupName\", \"slideshow_collections_title\" : \"slideshow title\", \"is_mdl\" : true, \"parent_id\" : \"1231234\", \"creative_type\" : \"REGULAR\", \"grid_click_type\" : \"CLOSEUP\", \"definition\" : \"*/product_type_0='kitchen'/product_type_1='beverage appliances'\", \"id\" : \"2680059592705\", \"ad_group_id\" : \"2680059592705\", \"collections_hero_destination_url\" : \"http://www.pinterest.com\", \"included\" : true, \"tracking_url\" : \"https://www.pinterest.com\", \"status\" : \"ACTIVE\" }, \"exceptions\" : [ { \"code\" : 2, \"message\" : \"Advertiser not found.\" }, { \"code\" : 2, \"message\" : \"Advertiser not found.\" } ] } ] }";
                    ApiUtil.setExampleResponse(request, "application/json", exampleString);
                    break;
                }
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
