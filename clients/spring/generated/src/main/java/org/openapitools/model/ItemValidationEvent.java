...
public class ItemValidationEvent   {
  ...
  */
  ...
  @Schema(name = "attribute", example = "title", description = "The attribute that the item validation event references", required = false)
  ...
  */
  ...
  @Schema(name = "code", example = "106", description = "The event code that the item validation event references", required = false)
  ...
  */
  ...
  @Schema(name = "message", example = "Title is missing from product metadata.", description = "Title message describing the item validation event", required = false)
