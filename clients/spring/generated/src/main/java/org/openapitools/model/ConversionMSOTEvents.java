...
public class ConversionMSOTEvents {
  ...
  private @Nullable AttributionModelEnum attributionModel;
  ...
  public ConversionMSOTEvents attributionModel(@Nullable AttributionModelEnum attributionModel) {
  ...
  public @Nullable AttributionModelEnum getAttributionModel() {
    return attributionModel;
  }

  public void setAttributionModel(@Nullable AttributionModelEnum attributionModel) {
    this.attributionModel = attributionModel;
  }
  ...
  public ConversionMSOTEvents attributionScore(@Nullable Double attributionScore) {
  ...
  public ConversionMSOTEvents campaignId(@Nullable String campaignId) {
  ...
  public ConversionMSOTEvents currency(@Nullable Currency currency) {
  ...
  public ConversionMSOTEvents totalEventTouchpoints(@Nullable Integer totalEventTouchpoints) {
  ...
  public ConversionMSOTEvents totalEvents(@Nullable Integer totalEvents) {
  ...
  public ConversionMSOTEvents value(@Nullable Double value) {
    this.value = value;
    return this;
  }
