...
public class SchedulePlacementMultipliers {
  ...
  public SchedulePlacementMultipliers browse(@Nullable Double browse) {
    this.browse = browse;
    return this;
  }
  ...
  public SchedulePlacementMultipliers relatedPins(@Nullable Double relatedPins) {
  ...
  public SchedulePlacementMultipliers search(@Nullable Double search) {
    this.search = search;
    return this;
  }
