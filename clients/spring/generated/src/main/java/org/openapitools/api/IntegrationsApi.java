...
public interface IntegrationsApi {
        ...
        responses = {
            ...
            @ApiResponse(responseCode = "404", description = "Integration not found.", content = {
                @Content(mediaType = "application/json", schema = @Schema(implementation = Error.class), examples = {
                    @ExampleObject(
                        name = "",
                        value = "{\"code\":4180,\"message\":\"Sorry! We could not find your integration.\"}"
                    )
                })
            ...
            @ApiResponse(responseCode = "409", description = "Can't access this integration metadata.", content = {
                @Content(mediaType = "application/json", schema = @Schema(implementation = Error.class), examples = {
                    @ExampleObject(
                        name = "",
                        value = "{\"code\":4182,\"message\":\"Can't access this integration metadata.\"}"
                    )
                })
        ...
        responses = {
            ...
            @ApiResponse(responseCode = "404", description = "Integration not found.", content = {
                @Content(mediaType = "application/json", schema = @Schema(implementation = Error.class), examples = {
                    @ExampleObject(
                        name = "",
                        value = "{\"code\":4517,\"message\":\"Sorry! We could not find your integration.\"}"
                    )
                })
    ...
    default ResponseEntity<IntegrationRecord> integrationsGetById(
        @NotNull @Parameter(name = "id", description = "Integration ID.", required = true, in = ParameterIn.PATH) @PathVariable("id") String id
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
