...
public interface BoardsApi {
    ...
    default ResponseEntity<BoardSection> boardSectionsCreate(
        ...
        @Parameter(name = "BoardSectionCreate", description = "", required = true) @Valid @RequestBody BoardSectionCreate boardSectionCreate,
        ...
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"id\" : \"549755885175\", \"name\" : \"Salads\" }";
    ...
    default ResponseEntity<BoardSection> boardSectionsDelete(
        @Pattern(regexp = "^\\d+$") @Parameter(name = "board_id", description = "Unique identifier of a board.", required = true, in = ParameterIn.PATH) @PathVariable("board_id") String boardId,
    ...
    default ResponseEntity<BoardSectionsList200Response> boardSectionsList(
        ...
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"bookmark\" : \"bookmark\", \"items\" : [ { \"id\" : \"549755885175\", \"name\" : \"Salads\" }, { \"id\" : \"549755885175\", \"name\" : \"Salads\" } ] }";
                    ApiUtil.setExampleResponse(request, "application/json", exampleString);
                    break;
                }
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
    ...
    default ResponseEntity<BoardSection> boardSectionsUpdate(
        @Pattern(regexp = "^\\d+$") @Parameter(name = "board_id", description = "Unique identifier of a board.", required = true, in = ParameterIn.PATH) @PathVariable("board_id") String boardId,
        @Pattern(regexp = "^\\d+$") @Parameter(name = "section_id", description = "Unique identifier of a board section.", required = true, in = ParameterIn.PATH) @PathVariable("section_id") String sectionId,
        @Parameter(name = "BoardSectionUpdateWithRequiredBody", description = "", required = true) @Valid @RequestBody BoardSectionUpdateWithRequiredBody boardSectionUpdateWithRequiredBody,
        @Pattern(regexp = "^\\d+$") @Size(max = 18) @Parameter(name = "ad_account_id", description = "Unique identifier of an ad account.", in = ParameterIn.QUERY) @Valid @RequestParam(value = "ad_account_id", required = false) @Nullable String adAccountId
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
    ...
    default ResponseEntity<Board> boardsCreate(
        ...
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"board_pins_modified_at\" : \"2000-01-23T04:56:07.000+00:00\", \"collaborator_count\" : 17, \"created_at\" : \"2000-01-23T04:56:07.000+00:00\", \"description\" : \"My favorite summer recipes\", \"follower_count\" : 13, \"id\" : \"549755885175\", \"is_ads_only\" : true, \"media\" : \"\", \"name\" : \"Summer recipes\", \"owner\" : \"\", \"pin_count\" : 5, \"privacy\" : \"\" }";
                    ApiUtil.setExampleResponse(request, "application/json", exampleString);
                    break;
                }
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
    ...
    default ResponseEntity<Board> boardsDelete(
        @Pattern(regexp = "^\\d+$") @Parameter(name = "board_id", description = "", required = true, in = ParameterIn.PATH) @PathVariable("board_id") String boardId,
        @Pattern(regexp = "^\\d+$") @Size(max = 18) @Parameter(name = "ad_account_id", description = "Unique identifier of an ad account.", in = ParameterIn.QUERY) @Valid @RequestParam(value = "ad_account_id", required = false) @Nullable String adAccountId
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
    ...
    default ResponseEntity<BoardWithUpdatePrivacy> boardsUpdate(
        ...
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"board_pins_modified_at\" : \"2000-01-23T04:56:07.000+00:00\", \"collaborator_count\" : 17, \"created_at\" : \"2000-01-23T04:56:07.000+00:00\", \"description\" : \"My favorite summer recipes\", \"follower_count\" : 13, \"id\" : \"549755885175\", \"is_ads_only\" : true, \"media\" : \"\", \"name\" : \"Summer recipes\", \"owner\" : \"\", \"pin_count\" : 5, \"privacy\" : \"PUBLIC\" }";
                    ApiUtil.setExampleResponse(request, "application/json", exampleString);
                    break;
                }
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
