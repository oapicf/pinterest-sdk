...
public interface UserAccountApi {
        ...
        responses = {
            ...
            @ApiResponse(responseCode = "404", description = "User not found", content = {
                @Content(mediaType = "application/json", schema = @Schema(implementation = Error.class), examples = {
                    @ExampleObject(
                        name = "",
                        value = "{\"code\":30,\"message\":\"User not found.\"}"
                    )
                })
    ...
    default ResponseEntity<UserSummary> followUserUpdate(
        @NotNull @Pattern(regexp = "(?!^\\d+$)^.+$") @Parameter(name = "username", description = "A valid username", required = true, in = ParameterIn.PATH) @PathVariable("username") String username,
    ...
    default ResponseEntity<Map<String, AnalyticsMetricsResponse>> userAccountAnalytics(
        ...
        @Parameter(name = "metric_types", description = "Metric types to get data for, default is all. ", in = ParameterIn.QUERY) @Valid @RequestParam(value = "metric_types", required = false) @Nullable List<String> metricTypes,
    ...
    default ResponseEntity<TopPinsAnalyticsResponse> userAccountAnalyticsTopPins(
        ...
        @Parameter(name = "created_in_last_n_days", description = "Get metrics for pins created in the last \"n\" days.", in = ParameterIn.QUERY) @Valid @RequestParam(value = "created_in_last_n_days", required = false) @Nullable Integer createdInLastNDays,
        @Pattern(regexp = "^\\d+$") @Size(max = 18) @Parameter(name = "ad_account_id", description = "Unique identifier of an ad account.", in = ParameterIn.QUERY) @Valid @RequestParam(value = "ad_account_id", required = false) @Nullable String adAccountId
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
    ...
    default ResponseEntity<TopVideoPinsAnalyticsResponse> userAccountAnalyticsTopVideoPins(
        ...
        @Parameter(name = "content_type", description = "Filter to paid or organic data. Default is all.", in = ParameterIn.QUERY) @Valid @RequestParam(value = "content_type", required = false, defaultValue = "ALL") String contentType,
        @Parameter(name = "source", description = "Filter to activity from Pins created and saved by your, or activity created and saved by others from your claimed accounts", in = ParameterIn.QUERY) @Valid @RequestParam(value = "source", required = false, defaultValue = "ALL") String source,
        @Parameter(name = "metric_types", description = "Metric types to get video data for, default is all. ", in = ParameterIn.QUERY) @Valid @RequestParam(value = "metric_types", required = false) @Nullable List<String> metricTypes,
        @Min(value = 1) @Max(value = 50) @Parameter(name = "num_of_pins", description = "Number of pins to include, default is 10. Max is 50.", in = ParameterIn.QUERY) @Valid @RequestParam(value = "num_of_pins", required = false, defaultValue = "10") Integer numOfPins,
        @Parameter(name = "created_in_last_n_days", description = "Get metrics for pins created in the last \"n\" days.", in = ParameterIn.QUERY) @Valid @RequestParam(value = "created_in_last_n_days", required = false) @Nullable Integer createdInLastNDays,
        @Pattern(regexp = "^\\d+$") @Size(max = 18) @Parameter(name = "ad_account_id", description = "Unique identifier of an ad account.", in = ParameterIn.QUERY) @Valid @RequestParam(value = "ad_account_id", required = false) @Nullable String adAccountId
    ) {
