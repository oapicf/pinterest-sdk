...
public class BidOptionsPlacementMultipliers {
  ...
  private @Nullable BigDecimal browse;

  @JsonInclude(JsonInclude.Include.NON_NULL)
  private @Nullable BigDecimal relatedPins;

  @JsonInclude(JsonInclude.Include.NON_NULL)
  private @Nullable BigDecimal search;

  public BidOptionsPlacementMultipliers browse(@Nullable BigDecimal browse) {
    this.browse = browse;
    return this;
  }
  ...
  @JsonProperty("browse")
  public @Nullable BigDecimal getBrowse() {
    return browse;
  }

  @JsonProperty("browse")
  public void setBrowse(@Nullable BigDecimal browse) {
    this.browse = browse;
  }

  public BidOptionsPlacementMultipliers relatedPins(@Nullable BigDecimal relatedPins) {
  ...
  public @Nullable BigDecimal getRelatedPins() {
    return relatedPins;
  }

  @JsonProperty("related_pins")
  public void setRelatedPins(@Nullable BigDecimal relatedPins) {
    this.relatedPins = relatedPins;
  }

  public BidOptionsPlacementMultipliers search(@Nullable BigDecimal search) {
    this.search = search;
    return this;
  }
  ...
  @JsonProperty("search")
  public @Nullable BigDecimal getSearch() {
    return search;
  }

  @JsonProperty("search")
  public void setSearch(@Nullable BigDecimal search) {
    this.search = search;
  }
