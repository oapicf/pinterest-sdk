...
public class AgeBucketMultipliers {

  @JsonInclude(JsonInclude.Include.NON_NULL)
  private @Nullable TargetingSpecAgeBucket AGE_BUCKET;

  public AgeBucketMultipliers AGE_BUCKET(@Nullable TargetingSpecAgeBucket AGE_BUCKET) {
  ...
  public @Nullable TargetingSpecAgeBucket getAGEBUCKET() {
    return AGE_BUCKET;
  }

  @JsonProperty("AGE_BUCKET")
  public void setAGEBUCKET(@Nullable TargetingSpecAgeBucket AGE_BUCKET) {
    this.AGE_BUCKET = AGE_BUCKET;
  }
    /**
  ...
  public boolean equals(Object o) {
    ...
    Objects.equals(this.additionalProperties, ageBucketMultipliers.additionalProperties);
  }
