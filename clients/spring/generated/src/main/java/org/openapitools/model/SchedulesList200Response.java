...
public class SchedulesList200Response {
  ...
  private List<@Valid Schedule> items = new ArrayList<>();
   ...
   */
  public SchedulesList200Response(List<@Valid Schedule> items) {
    this.items = items;
  }
  ...
  @JsonProperty("items")
  public List<@Valid Schedule> getItems() {
    return items;
  }
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.bookmark, schedulesList200Response.bookmark) &&
