...
public class ConversionEventsDataInner {
  ...
  public ConversionEventsDataInner appInfo(@Nullable ConversionEventAppInfo appInfo) {
  ...
  public ConversionEventsDataInner deviceInfo(@Nullable ConversionEventDeviceInfo deviceInfo) {
