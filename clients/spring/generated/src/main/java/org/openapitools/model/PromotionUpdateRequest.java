...
public class PromotionUpdateRequest {
  ...
  public PromotionUpdateRequest discountStatus(@Nullable DiscountStatusEnum discountStatus) {
  ...
  public PromotionUpdateRequest endTime(@Nullable Integer endTime) {
  ...
  public PromotionUpdateRequest externalId(@Nullable String externalId) {
  ...
  public PromotionUpdateRequest platformType(@Nullable String platformType) {
  ...
  public PromotionUpdateRequest promotionCode(@Nullable String promotionCode) {
  ...
  public PromotionUpdateRequest promotionCustomId(@Nullable String promotionCustomId) {
  ...
  public PromotionUpdateRequest promotionTitle(@Nullable String promotionTitle) {
  ...
  public PromotionUpdateRequest promotionType(@Nullable PromotionType promotionType) {
  ...
  public PromotionUpdateRequest startTime(@Nullable Integer startTime) {
  ...
  public PromotionUpdateRequest status(@Nullable EntityStatus status) {
    this.status = status;
    return this;
  }
