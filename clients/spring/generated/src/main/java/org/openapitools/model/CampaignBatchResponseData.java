...
public class CampaignBatchResponseData {
  ...
  @JsonInclude(JsonInclude.Include.NON_NULL)
  private @Nullable CampaignObjectiveType objectiveType;
  ...
  @JsonInclude(JsonInclude.Include.NON_ABSENT)
  private JsonNullable<NullableEntityStatus> status = JsonNullable.<NullableEntityStatus>undefined();
  ...
  public CampaignBatchResponseData adAccountId(@Nullable String adAccountId) {
  ...
  public CampaignBatchResponseData createdTime(@Nullable Integer createdTime) {
  ...
  public CampaignBatchResponseData id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public CampaignBatchResponseData intendedPromotionType(@Nullable IntendedPromotionType intendedPromotionType) {
  ...
  public CampaignBatchResponseData isCarting(@Nullable Boolean isCarting) {
  ...
  public CampaignBatchResponseData isLtvOptimized(@Nullable Boolean isLtvOptimized) {
  ...
  public CampaignBatchResponseData isPerformancePlus(@Nullable Boolean isPerformancePlus) {
  ...
  public CampaignBatchResponseData isTopOfSearch(@Nullable Boolean isTopOfSearch) {
  ...
  public CampaignBatchResponseData name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public CampaignBatchResponseData objectiveType(@Nullable CampaignObjectiveType objectiveType) {
  ...
  public @Nullable CampaignObjectiveType getObjectiveType() {
    return objectiveType;
  }

  @JsonProperty("objective_type")
  public void setObjectiveType(@Nullable CampaignObjectiveType objectiveType) {
    this.objectiveType = objectiveType;
  }
  ...
  @JsonProperty("status")
  public JsonNullable<NullableEntityStatus> getStatus() {
    return status;
  }

  public void setStatus(JsonNullable<NullableEntityStatus> status) {
    this.status = status;
  }

  public CampaignBatchResponseData summaryStatus(@Nullable SummaryStatus summaryStatus) {
  ...
  public CampaignBatchResponseData type(@Nullable String type) {
    this.type = type;
    return this;
  }
  ...
  public CampaignBatchResponseData updatedTime(@Nullable Integer updatedTime) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.adAccountId, campaignBatchResponseData.adAccountId) &&
        equalsNullable(this.bidOptions, campaignBatchResponseData.bidOptions) &&
        Objects.equals(this.createdTime, campaignBatchResponseData.createdTime) &&
        equalsNullable(this.dailySpendCap, campaignBatchResponseData.dailySpendCap) &&
        equalsNullable(this.defaultAdGroupBudgetInMicroCurrency, campaignBatchResponseData.defaultAdGroupBudgetInMicroCurrency) &&
        equalsNullable(this.endTime, campaignBatchResponseData.endTime) &&
        ...
        equalsNullable(this.isAutomatedCampaign, campaignBatchResponseData.isAutomatedCampaign) &&
        equalsNullable(this.isCampaignBudgetOptimization, campaignBatchResponseData.isCampaignBudgetOptimization) &&
        Objects.equals(this.isCarting, campaignBatchResponseData.isCarting) &&
        equalsNullable(this.isFlexibleDailyBudgets, campaignBatchResponseData.isFlexibleDailyBudgets) &&
        ...
        equalsNullable(this.lifetimeSpendCap, campaignBatchResponseData.lifetimeSpendCap) &&
        ...
        equalsNullable(this.orderLineId, campaignBatchResponseData.orderLineId) &&
        equalsNullable(this.performancePlusCampaignSettings, campaignBatchResponseData.performancePlusCampaignSettings) &&
        equalsNullable(this.startTime, campaignBatchResponseData.startTime) &&
        equalsNullable(this.status, campaignBatchResponseData.status) &&
        Objects.equals(this.summaryStatus, campaignBatchResponseData.summaryStatus) &&
        equalsNullable(this.trackingUrls, campaignBatchResponseData.trackingUrls) &&
