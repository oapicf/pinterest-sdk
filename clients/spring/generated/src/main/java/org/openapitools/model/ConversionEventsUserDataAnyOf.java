...
public class ConversionEventsUserDataAnyOf {
  ...
  public ConversionEventsUserDataAnyOf clientIpAddress(@Nullable String clientIpAddress) {
  ...
  public ConversionEventsUserDataAnyOf clientUserAgent(@Nullable String clientUserAgent) {
