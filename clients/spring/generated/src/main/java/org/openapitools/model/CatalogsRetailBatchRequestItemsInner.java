...
@JsonSubTypes({
  ...
  @JsonSubTypes.Type(value = CatalogsCreateRetailItem.class, name = "CatalogsCreateRetailItem"),
  @JsonSubTypes.Type(value = CatalogsDeleteRetailItem.class, name = "CatalogsDeleteRetailItem"),
  @JsonSubTypes.Type(value = CatalogsUpdateRetailItem.class, name = "CatalogsUpdateRetailItem"),
