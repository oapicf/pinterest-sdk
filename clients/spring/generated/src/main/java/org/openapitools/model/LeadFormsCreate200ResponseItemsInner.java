...
public class LeadFormsCreate200ResponseItemsInner {
  ...
  private @Nullable LeadForm data;

  @JsonInclude(JsonInclude.Include.NON_NULL)
  private List<@Valid PinterestLibBatchItemException> exceptions = new ArrayList<>();

  public LeadFormsCreate200ResponseItemsInner data(@Nullable LeadForm data) {
    this.data = data;
    return this;
  }
  ...
  @JsonProperty("data")
  public @Nullable LeadForm getData() {
    return data;
  }

  @JsonProperty("data")
  public void setData(@Nullable LeadForm data) {
    this.data = data;
  }
