...
public class PinAnalyticsDailyMetrics {
  ...
  public PinAnalyticsDailyMetrics dataStatus(@Nullable DataStatus dataStatus) {
  ...
  public PinAnalyticsDailyMetrics date(@Nullable String date) {
    this.date = date;
    return this;
  }
  ...
  @Schema(name = "date", description = "Metrics date (UTC): YYYY-MM-DD.", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("date")
