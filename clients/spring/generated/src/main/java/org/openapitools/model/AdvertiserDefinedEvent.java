...
public class AdvertiserDefinedEvent {
  ...
  private @Nullable ConversionTagTypeOptimal mappedConversionType;

  @JsonInclude(JsonInclude.Include.NON_NULL)
  private @Nullable String name;

  public AdvertiserDefinedEvent mappedConversionType(@Nullable ConversionTagTypeOptimal mappedConversionType) {
  ...
  public @Nullable ConversionTagTypeOptimal getMappedConversionType() {
    return mappedConversionType;
  }

  @JsonProperty("mapped_conversion_type")
  public void setMappedConversionType(@Nullable ConversionTagTypeOptimal mappedConversionType) {
    this.mappedConversionType = mappedConversionType;
  }

  public AdvertiserDefinedEvent name(@Nullable String name) {
    this.name = name;
    return this;
  }
