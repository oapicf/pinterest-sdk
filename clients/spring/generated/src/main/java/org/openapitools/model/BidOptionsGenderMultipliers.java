...
public class BidOptionsGenderMultipliers {
  ...
  private @Nullable BigDecimal female;

  @JsonInclude(JsonInclude.Include.NON_NULL)
  private @Nullable BigDecimal male;

  public BidOptionsGenderMultipliers female(@Nullable BigDecimal female) {
    this.female = female;
    return this;
  }
  ...
  @JsonProperty("female")
  public @Nullable BigDecimal getFemale() {
    return female;
  }

  @JsonProperty("female")
  public void setFemale(@Nullable BigDecimal female) {
    this.female = female;
  }

  public BidOptionsGenderMultipliers male(@Nullable BigDecimal male) {
    this.male = male;
    return this;
  }
  ...
  @JsonProperty("male")
  public @Nullable BigDecimal getMale() {
    return male;
  }

  @JsonProperty("male")
  public void setMale(@Nullable BigDecimal male) {
    this.male = male;
  }
