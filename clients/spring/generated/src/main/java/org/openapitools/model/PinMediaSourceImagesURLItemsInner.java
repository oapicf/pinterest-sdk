...
public class PinMediaSourceImagesURLItemsInner {
  ...
  public PinMediaSourceImagesURLItemsInner title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public PinMediaSourceImagesURLItemsInner description(@Nullable String description) {
  ...
  public PinMediaSourceImagesURLItemsInner link(@Nullable String link) {
    this.link = link;
    return this;
  }
