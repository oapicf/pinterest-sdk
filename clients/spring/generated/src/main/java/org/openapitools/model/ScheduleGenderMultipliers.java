...
@Schema(name = "ScheduleGenderMultipliers", description = "This represents a mapping from gender targeting criteria to a bid price change value. Values represent the change in bid price and can be positive or negative. For percentage changes, a value of 500.0 means a 5% change. For value changes, the amount represents the direct bid adjustment. All gender multipliers must be set at the same time. If a multiplier is not provided it is assumed to be 0 (no bid adjustment). The change must still remain between the range of 0 and 10.")
...
public class ScheduleGenderMultipliers {
  ...
  public ScheduleGenderMultipliers GENDER(@Nullable TargetingSpecGender GENDER) {
    this.GENDER = GENDER;
    return this;
  }
  ...
  public void setGENDER(@Nullable TargetingSpecGender GENDER) {
    ...
    */
    @JsonAnySetter
    public ScheduleGenderMultipliers putAdditionalProperty(String key, Double value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.GENDER, scheduleGenderMultipliers.GENDER) &&
    Objects.equals(this.additionalProperties, scheduleGenderMultipliers.additionalProperties);
  }
