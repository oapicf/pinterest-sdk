...
public class AmazonConnectRequest {
  ...
  public AmazonConnectRequest amazonStorefrontId(@Nullable String amazonStorefrontId) {
  ...
  public @Nullable String getAmazonStorefrontId() {
    return amazonStorefrontId;
  }
  ...
  public AmazonConnectRequest amazonUserId(@Nullable String amazonUserId) {
  ...
  public @Nullable String getAmazonUserId() {
    return amazonUserId;
  }
  ...
  public AmazonConnectRequest oneTimePasscode(@Nullable String oneTimePasscode) {
  ...
  public @Nullable String getOneTimePasscode() {
    return oneTimePasscode;
  }
  ...
  public AmazonConnectRequest pinterestUserId(@Nullable String pinterestUserId) {
  ...
  public @Nullable String getPinterestUserId() {
    return pinterestUserId;
  }
