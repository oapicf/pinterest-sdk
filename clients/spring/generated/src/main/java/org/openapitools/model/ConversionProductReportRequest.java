...
@Schema(name = "ConversionProductReportRequest", description = "Request for a brand, category, SKU report")
...
public class ConversionProductReportRequest {
  ...
  private @Nullable ConversionProductAttributionTypeEnum conversionProductAttributionType;
  ...
  private @Nullable ConversionProductBreakdownEnum conversionProductBreakdown;
   ...
   */
  @Size(min = 1, max = 500) 
  @Schema(name = "ad_group_ids", example = "[\"12345678\"]", description = "List of ad group ids. <br>Only support ad_group_ids field when level of the report is AD_GROUP.", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
   ...
   */
  @Size(min = 1, max = 500) 
  @Schema(name = "campaign_ids", example = "[\"12345678\"]", description = "List of campaign ids. <br>Only support campaign_ids field when level of the report is CAMPAIGN.", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  ...
  public ConversionProductReportRequest conversionProductAttributionType(@Nullable ConversionProductAttributionTypeEnum conversionProductAttributionType) {
  ...
  @Schema(name = "conversion_product_attribution_type", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("conversion_product_attribution_type")
  public @Nullable ConversionProductAttributionTypeEnum getConversionProductAttributionType() {
    return conversionProductAttributionType;
  }

  public void setConversionProductAttributionType(@Nullable ConversionProductAttributionTypeEnum conversionProductAttributionType) {
    this.conversionProductAttributionType = conversionProductAttributionType;
  }

  public ConversionProductReportRequest conversionProductBreakdown(@Nullable ConversionProductBreakdownEnum conversionProductBreakdown) {
  ...
  @Schema(name = "conversion_product_breakdown", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("conversion_product_breakdown")
  public @Nullable ConversionProductBreakdownEnum getConversionProductBreakdown() {
    return conversionProductBreakdown;
  }

  public void setConversionProductBreakdown(@Nullable ConversionProductBreakdownEnum conversionProductBreakdown) {
    this.conversionProductBreakdown = conversionProductBreakdown;
  }
  ...
  @Schema(name = "end_date", example = "2024-04-23", description = "Metric report end date (UTC). Format: YYYY-MM-DD.<br> A max of 1 year is allowed between the start and end date for reports.", requiredMode = Schema.RequiredMode.REQUIRED)
   ...
   */
  @NotNull 
  @Schema(name = "granularity", description = "TOTAL - metrics are aggregated over the specified date range.<br> WEEK - metrics are broken down weekly.<br> MONTH - metrics are broken down monthly.", requiredMode = Schema.RequiredMode.REQUIRED)
   ...
   */
  @Size(min = 2, max = 500) 
  @Schema(name = "product_sku_ids", example = "[\"WBC45678\",\"WBC45679\"]", description = "List of SKU ids. <br>Only support product_sku_ids field when report breakdown type is PRODUCT_SKU_GROUP.", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
   ...
   */
  @NotNull @Pattern(regexp = "^(\\d{4})-(\\d{2})-(\\d{2})$") 
  @Schema(name = "start_date", example = "2024-03-17", description = "Metric report start date (UTC). Format: YYYY-MM-DD.<br> Start date must be after 2024-03-16. 7 day minimum time window for report is required.", requiredMode = Schema.RequiredMode.REQUIRED)
