...
public class TargetingSpecOptimal {
  ...
  @JsonInclude(JsonInclude.Include.NON_ABSENT)
  private JsonNullable<List<TargetingStrategy>> TARGETING_STRATEGY = JsonNullable.<List<TargetingStrategy>>undefined();
  ...
  public TargetingSpecOptimal MAXIMUM_AGE(@Nullable String MAXIMUM_AGE) {
  ...
  public TargetingSpecOptimal MINIMUM_AGE(@Nullable String MINIMUM_AGE) {
  ...
  public JsonNullable<List<TargetingStrategy>> getTARGETINGSTRATEGY() {
    return TARGETING_STRATEGY;
  }

  public void setTARGETINGSTRATEGY(JsonNullable<List<TargetingStrategy>> TARGETING_STRATEGY) {
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.AGE_BUCKET, targetingSpecOptimal.AGE_BUCKET) &&
        equalsNullable(this.APPTYPE, targetingSpecOptimal.APPTYPE) &&
        equalsNullable(this.AUDIENCE_EXCLUDE, targetingSpecOptimal.AUDIENCE_EXCLUDE) &&
        equalsNullable(this.AUDIENCE_INCLUDE, targetingSpecOptimal.AUDIENCE_INCLUDE) &&
        equalsNullable(this.GENDER, targetingSpecOptimal.GENDER) &&
        equalsNullable(this.GEO, targetingSpecOptimal.GEO) &&
        ...
        equalsNullable(this.LOCALE, targetingSpecOptimal.LOCALE) &&
        equalsNullable(this.LOCATION, targetingSpecOptimal.LOCATION) &&
        ...
        equalsNullable(this.SHOPPING_RETARGETING, targetingSpecOptimal.SHOPPING_RETARGETING) &&
        equalsNullable(this.TARGETING_STRATEGY, targetingSpecOptimal.TARGETING_STRATEGY);
  }
