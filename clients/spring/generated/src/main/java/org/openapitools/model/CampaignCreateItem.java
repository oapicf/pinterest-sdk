...
public class CampaignCreateItem {
  ...
  public CampaignCreateItem adAccountId(@Nullable String adAccountId) {
  ...
  public CampaignCreateItem appId(@Nullable String appId) {
    this.appId = appId;
    return this;
  }
  ...
  public CampaignCreateItem appPlatform(@Nullable MobileAppPlatform appPlatform) {
  ...
  public CampaignCreateItem intendedPromotionType(@Nullable IntendedPromotionType intendedPromotionType) {
  ...
  public CampaignCreateItem isLtvOptimized(@Nullable Boolean isLtvOptimized) {
  ...
  public CampaignCreateItem status(@Nullable EntityStatus status) {
    this.status = status;
    return this;
  }
