...
public class SSIOOrderLine {
  ...
  public void setStartDate(JsonNullable<LocalDate> startDate) {
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.acceptedTermsId, ssIOOrderLine.acceptedTermsId) &&
        ...
        equalsNullable(this.salesforceOrderLineId, ssIOOrderLine.salesforceOrderLineId) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hashCodeNullable(acceptedTermsId), hashCodeNullable(acceptedTermsTime), hashCodeNullable(adsManagerOrderLineId), hashCodeNullable(agencyLink), hashCodeNullable(billToCompanyName), hashCodeNullable(billingContactEmail), hashCodeNullable(billingContactFirstname), hashCodeNullable(billingContactLastname), hashCodeNullable(budgetAmount), currencyInfo, hashCodeNullable(endDate), hashCodeNullable(estimatedMonthlySpend), hashCodeNullable(lastModifiedDateTime), hashCodeNullable(mediaContactEmail), hashCodeNullable(mediaContactFirstname), hashCodeNullable(mediaContactLastname), hashCodeNullable(orderName), hashCodeNullable(pinOrderId), hashCodeNullable(pmpName), hashCodeNullable(poNumber), hashCodeNullable(salesforceOrderLineId), hashCodeNullable(startDate));
  }
