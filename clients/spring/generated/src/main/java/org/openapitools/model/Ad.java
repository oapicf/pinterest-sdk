...
public class Ad {
  ...
  private @Nullable Integer cartingPlatformType;
  ...
  public Ad cartingPlatformType(@Nullable Integer cartingPlatformType) {
  ...
  public @Nullable Integer getCartingPlatformType() {
    return cartingPlatformType;
  }

  @JsonProperty("carting_platform_type")
  public void setCartingPlatformType(@Nullable Integer cartingPlatformType) {
    this.cartingPlatformType = cartingPlatformType;
  }
  ...
  public Ad createdTime(@Nullable Integer createdTime) {
  ...
  public Ad isCarting(@Nullable Boolean isCarting) {
  ...
  public Ad isCollageAcceptedTerms(@Nullable Boolean isCollageAcceptedTerms) {
  ...
  public Ad isCollageSingleDestination(@Nullable Boolean isCollageSingleDestination) {
  ...
  public Ad isPinDeleted(@Nullable Boolean isPinDeleted) {
  ...
  public Ad isRemovable(@Nullable Boolean isRemovable) {
  ...
  public Ad status(@Nullable EntityStatus status) {
    this.status = status;
    return this;
  }
  ...
  public Ad updatedTime(@Nullable Integer updatedTime) {
