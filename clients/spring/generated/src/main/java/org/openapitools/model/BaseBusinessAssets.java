...
public class BaseBusinessAssets {
  ...
  public BaseBusinessAssets assetGroupInfo(@Nullable AssetGroupBinding assetGroupInfo) {
  ...
  public BaseBusinessAssets assetId(@Nullable String assetId) {
  ...
  public BaseBusinessAssets assetType(@Nullable AssetTypeResponse assetType) {
