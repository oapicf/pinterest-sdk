...
public class LabelError {
  ...
  private @Nullable LabelErrorData data;

  @JsonInclude(JsonInclude.Include.NON_NULL)
  private List<String> errorMessages = new ArrayList<>();

  public LabelError data(@Nullable LabelErrorData data) {
    this.data = data;
    return this;
  }
  ...
  @JsonProperty("data")
  public @Nullable LabelErrorData getData() {
    return data;
  }

  @JsonProperty("data")
  public void setData(@Nullable LabelErrorData data) {
    this.data = data;
  }
