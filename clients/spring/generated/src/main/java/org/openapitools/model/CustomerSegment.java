...
public class CustomerSegment {
  ...
  public CustomerSegment adAccountId(@Nullable String adAccountId) {
  ...
  public CustomerSegment createdTime(@Nullable Integer createdTime) {
  ...
  public CustomerSegment id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public CustomerSegment status(@Nullable TargetingTemplateStatus status) {
    this.status = status;
    return this;
  }
  ...
  public CustomerSegment updatedTime(@Nullable Integer updatedTime) {
