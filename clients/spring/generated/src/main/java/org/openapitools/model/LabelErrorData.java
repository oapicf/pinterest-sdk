...
public class LabelErrorData {
  ...
  public LabelErrorData id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public LabelErrorData value(@Nullable String value) {
    this.value = value;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, labelErrorData.id) &&
        equalsNullable(this.labelType, labelErrorData.labelType) &&
        equalsNullable(this.status, labelErrorData.status) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, hashCodeNullable(labelType), hashCodeNullable(status), value);
  }
