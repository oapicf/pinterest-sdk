...
public class CatalogsItemsUpdateBatchRequest implements CatalogsItemsBatchRequest {
   ...
   */
  public CatalogsItemsUpdateBatchRequest(Country country, CatalogsItemsRequestLanguage language, BatchOperation operation, List<@Valid ItemUpdateBatchRecord> items) {
