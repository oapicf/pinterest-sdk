...
public class AdPreviewShopping implements AdPreviewRequest {
  ...
  public AdPreviewShopping heroImageTitle(@Nullable String heroImageTitle) {
  ...
  public @Nullable String getHeroImageTitle() {
    return heroImageTitle;
  }
  ...
  public AdPreviewShopping heroImageUrl(@Nullable String heroImageUrl) {
  ...
  public @Nullable String getHeroImageUrl() {
    return heroImageUrl;
  }
  ...
  public AdPreviewShopping heroPinId(@Nullable String heroPinId) {
  ...
  public @Nullable String getHeroPinId() {
    return heroPinId;
  }
  ...
  public AdPreviewShopping imageTag(@Nullable String imageTag) {
  ...
  public AdPreviewShopping itemId(@Nullable String itemId) {
    this.itemId = itemId;
    return this;
  }
  ...
  public @Nullable String getVideoTag() {
    return videoTag;
  }
