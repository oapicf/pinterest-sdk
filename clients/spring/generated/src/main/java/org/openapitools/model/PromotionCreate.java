...
public class PromotionCreate {
  ...
  public PromotionCreate discountStatus(@Nullable DiscountStatus discountStatus) {
  ...
  public PromotionCreate endTime(@Nullable Integer endTime) {
  ...
  public PromotionCreate externalId(@Nullable String externalId) {
  ...
  public PromotionCreate platformType(@Nullable String platformType) {
  ...
  public PromotionCreate promotionCode(@Nullable String promotionCode) {
  ...
  public PromotionCreate promotionCustomId(@Nullable String promotionCustomId) {
  ...
  public PromotionCreate startTime(@Nullable Integer startTime) {
