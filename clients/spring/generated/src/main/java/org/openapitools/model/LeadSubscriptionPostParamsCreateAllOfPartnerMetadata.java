...
@Schema(name = "LeadSubscriptionPostParamsCreate_allOf_partner_metadata", description = "Partner metadata. Only for clients that requires special handling. We recommend to avoid this param.")
...
public class LeadSubscriptionPostParamsCreateAllOfPartnerMetadata {
  ...
  public LeadSubscriptionPostParamsCreateAllOfPartnerMetadata subscriberKey(@Nullable String subscriberKey) {
