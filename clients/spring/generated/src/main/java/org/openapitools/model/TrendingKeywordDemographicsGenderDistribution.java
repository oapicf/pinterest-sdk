...
public class TrendingKeywordDemographicsGenderDistribution {
  ...
  private @Nullable GenderDistributionEnum genderDistribution;

  public TrendingKeywordDemographicsGenderDistribution genderDistribution(@Nullable GenderDistributionEnum genderDistribution) {
  ...
  public @Nullable GenderDistributionEnum getGenderDistribution() {
    return genderDistribution;
  }

  public void setGenderDistribution(@Nullable GenderDistributionEnum genderDistribution) {
    this.genderDistribution = genderDistribution;
  }
    /**
    ...
    */
    @JsonAnySetter
    public TrendingKeywordDemographicsGenderDistribution putAdditionalProperty(String key, Double value) {
  ...
  public boolean equals(Object o) {
    ...
    Objects.equals(this.additionalProperties, trendingKeywordDemographicsGenderDistribution.additionalProperties);
  }
