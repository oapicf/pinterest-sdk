...
public class QuizPinData {
  ...
  @JsonInclude(JsonInclude.Include.NON_NULL)
  private @Nullable TieBreakerType tieBreakerType;
  ...
  public QuizPinData tieBreakerType(@Nullable TieBreakerType tieBreakerType) {
  ...
  public @Nullable TieBreakerType getTieBreakerType() {
    return tieBreakerType;
  }

  @JsonProperty("tie_breaker_type")
  public void setTieBreakerType(@Nullable TieBreakerType tieBreakerType) {
    this.tieBreakerType = tieBreakerType;
  }
