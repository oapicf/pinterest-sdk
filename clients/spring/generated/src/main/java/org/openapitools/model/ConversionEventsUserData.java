...
public class ConversionEventsUserData {
  ...
  public ConversionEventsUserData clientIpAddress(@Nullable String clientIpAddress) {
  ...
  public ConversionEventsUserData clientUserAgent(@Nullable String clientUserAgent) {
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.clickId, conversionEventsUserData.clickId) &&
