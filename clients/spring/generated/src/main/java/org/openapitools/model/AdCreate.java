...
public class AdCreate {
  ...
  public AdCreate isCarting(@Nullable Boolean isCarting) {
  ...
  public AdCreate isCollageAcceptedTerms(@Nullable Boolean isCollageAcceptedTerms) {
  ...
  public AdCreate isCollageSingleDestination(@Nullable Boolean isCollageSingleDestination) {
  ...
  public AdCreate isPinDeleted(@Nullable Boolean isPinDeleted) {
  ...
  public AdCreate isRemovable(@Nullable Boolean isRemovable) {
  ...
  public AdCreate status(@Nullable EntityStatus status) {
    this.status = status;
    return this;
  }
