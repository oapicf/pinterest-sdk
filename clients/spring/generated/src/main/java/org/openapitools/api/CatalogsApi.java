...
public interface CatalogsApi {
    ...
    default ResponseEntity<CatalogsItemsBatch> itemsBatchGet(
        @NotNull @Parameter(name = "batch_id", description = "Id of a catalogs items batch to fetch", required = true, in = ParameterIn.PATH) @PathVariable("batch_id") String batchId,
        @Pattern(regexp = "^\\d+$") @Size(max = 18) @Parameter(name = "ad_account_id", description = "Unique identifier of an ad account.", in = ParameterIn.QUERY) @Valid @RequestParam(value = "ad_account_id", required = false) @Nullable String adAccountId
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
    ...
    String PATH_ITEMS_GET = "/catalogs/items";
    /**
        ...
        responses = {
            ...
            @ApiResponse(responseCode = "400", description = "Invalid request parameters.", content = {
                @Content(mediaType = "application/json", schema = @Schema(implementation = Error.class), examples = {
                    @ExampleObject(
                        name = "",
                        value = "{\"code\":1,\"message\":\"Parameter 'item_ids' is required.\"}"
                    )
                })
    ...
    @RequestMapping(
        method = RequestMethod.GET,
        value = CatalogsApi.PATH_ITEMS_GET,
        produces = { "application/json" }
    )
    default ResponseEntity<CatalogsItems> itemsGet(
        ...
        @Pattern(regexp = "^\\d+$") @Size(max = 18) @Parameter(name = "ad_account_id", description = "Unique identifier of an ad account.", in = ParameterIn.QUERY) @Valid @RequestParam(value = "ad_account_id", required = false) @Nullable String adAccountId,
        @Parameter(name = "item_ids", deprecated = true, description = "This parameter is deprecated. Use filters instead.", in = ParameterIn.QUERY) @Valid @RequestParam(value = "item_ids", required = false) @Deprecated @Nullable List<String> itemIds,
        @Parameter(name = "filters", description = "Identifies items to be retrieved. This is a required parameter.", in = ParameterIn.QUERY) @Valid @Nullable CatalogsItemsFilters filters
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
