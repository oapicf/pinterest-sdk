...
public class KeywordUpdateGenerated {
   ...
   */
  public KeywordUpdateGenerated(String id) {
    this.id = id;
  }

  public KeywordUpdateGenerated archived(@Nullable Boolean archived) {
  ...
  @Schema(name = "archived", description = "Is keyword archived?", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  ...
  @Schema(name = "id", description = "Keyword ID.", requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty("id")
  public String getId() {
    return id;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.archived, keywordUpdateGenerated.archived) &&
        equalsNullable(this.bid, keywordUpdateGenerated.bid) &&
