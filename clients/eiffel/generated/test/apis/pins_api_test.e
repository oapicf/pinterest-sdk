...
feature -- Test routines
    ...
    test_pins_get
        ...
        do
            ...
            -- l_response := api.pins_get(l_pin_id, l_ad_account_id, l_pin_metrics)
            assert ("not_implemented", False)
        end
    ...
    test_pins_list
        ...
        do
            ...
            -- l_response := api.pins_list(l_pin_filter, l_pin_metrics, l_include_protected_pins, l_pin_type, l_creative_types, l_ad_account_id, l_bookmark, l_page_size)
            assert ("not_implemented", False)
        end
