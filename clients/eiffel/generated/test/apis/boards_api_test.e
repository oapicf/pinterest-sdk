...
feature -- Test routines
    ...
    test_board_sections_create
        ...
        do
            ...
            -- l_response := api.board_sections_create(l_board_id, l_board_section, l_ad_account_id)
    ...
    test_board_sections_delete
        ...
        do
            ...
            -- api.board_sections_delete(l_board_id, l_section_id, l_ad_account_id)
            assert ("not_implemented", False)
        end
    ...
    test_board_sections_list
        ...
        local
            l_response: BOARD_SECTIONS_LIST_200_RESPONSE
            l_board_id: STRING_32
            l_ad_account_id: STRING_32
        ...
        do
            ...
            -- l_response := api.board_sections_list(l_board_id, l_ad_account_id, l_bookmark, l_page_size)
            assert ("not_implemented", False)
        end
    ...
    test_board_sections_list_pins
        ...
        local
            l_response: BOARDS_LIST_PINS_200_RESPONSE
            l_board_id: STRING_32
            l_section_id: STRING_32
            l_ad_account_id: STRING_32
            l_bookmark: STRING_32
        ...
        do
            ...
            -- l_response := api.board_sections_list_pins(l_board_id, l_section_id, l_ad_account_id, l_bookmark, l_page_size)
            assert ("not_implemented", False)
        end
    ...
    test_board_sections_update
        ...
        do
            ...
            -- l_response := api.board_sections_update(l_board_id, l_section_id, l_board_section, l_ad_account_id)
            assert ("not_implemented", False)
        end
    ...
    test_boards_delete
        ...
        do
            ...
            -- api.boards_delete(l_board_id, l_ad_account_id)
            assert ("not_implemented", False)
        end
    ...
    test_boards_get
        ...
        do
            ...
            -- l_response := api.boards_get(l_board_id, l_ad_account_id)
            assert ("not_implemented", False)
        end
    ...
    test_boards_list_pins
        ...
        do
            ...
            -- l_response := api.boards_list_pins(l_board_id, l_bookmark, l_page_size, l_creative_types, l_ad_account_id, l_pin_metrics)
            assert ("not_implemented", False)
        end
