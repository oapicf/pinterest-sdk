...
feature -- Test routines
    ...
    test_ad_pins_analytics
        ...
        local
            l_response: LIST [AD_PIN_ANALYTICS]
        ...
        do
            ...
            -- l_response := api.ad_pins_analytics(l_ad_account_id, l_campaign_id, l_pin_ids, l_start_date, l_end_date, l_columns, l_granularity, l_click_window_days, l_engagement_window_days, l_view_window_days, l_conversion_report_time)
    ...
    test_campaign_targeting_analytics_get
        ...
        do
            ...
            -- l_response := api.campaign_targeting_analytics_get(l_ad_account_id, l_campaign_ids, l_start_date, l_end_date, l_targeting_types, l_columns, l_granularity, l_click_window_days, l_engagement_window_days, l_view_window_days, l_conversion_report_time, l_attribution_types, l_reporting_timezone)
            assert ("not_implemented", False)
        end
    ...
    test_campaigns_analytics
        ...
        do
            ...
            -- l_response := api.campaigns_analytics(l_ad_account_id, l_start_date, l_end_date, l_campaign_ids, l_columns, l_granularity, l_click_window_days, l_engagement_window_days, l_view_window_days, l_conversion_report_time, l_aggregate_report_rows, l_reporting_timezone)
            assert ("not_implemented", False)
        end
