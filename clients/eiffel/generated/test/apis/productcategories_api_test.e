note
    description: "API tests for PRODUCTCATEGORIES_API"
    date: "$Date$"
    revision: "$Revision$"


class PRODUCTCATEGORIES_API_TEST
...
feature {NONE} -- Implementation
    ...
    api: PRODUCTCATEGORIES_API
            -- Create an object instance of `PRODUCTCATEGORIES_API'.
        once
            create { PRODUCTCATEGORIES_API } Result
        end
