...
# **events_create**
> events_create (ad_account_id: STRING_32 ; conversion_events_create: CONVERSION_EVENTS_CREATE ; test:  detachable BOOLEAN ): detachable CONVERSION_EVENTS
 ...
 **conversion_events_create** | [**CONVERSION_EVENTS_CREATE**](CONVERSION_EVENTS_CREATE.md)|  | 
...
[**CONVERSION_EVENTS**](ConversionEvents.md)
