# CATALOGS_CREATIVE_ASSETS_FEEDS_CREATE_REQUEST

## Properties
Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**catalog_id** | [**STRING_32**](STRING_32.md) | Catalog id pertaining to the feed. If not provided, feed will use a default catalog based on type. | [optional] [default to null]
...
**default_locale** | [**CATALOGS_CREATIVE_ASSETS_FEEDS_CREATE_REQUEST_DEFAULT_LOCALE**](CatalogsCreativeAssetsFeedsCreateRequest_default_locale.md) |  | [default to null]
...
**status** | [**CATALOGS_STATUS**](CatalogsStatus.md) |  | [optional] [default to ACTIVE]
