...
------------ | ------------- | ------------- | -------------
**ad_account_id** | [**STRING_32**](STRING_32.md) | The Ad Account ID that this promotion belongs to. | [readonly] [default to null]
**discount_status** | [**DISCOUNT_STATUS**](DiscountStatus.md) |  | [optional] [default to null]
...
**id** | [**STRING_32**](STRING_32.md) | Promotion ID | [default to null]
...
**promotion_title** | [**STRING_32**](STRING_32.md) | Internal name for the promotion. | [default to null]
**promotion_type** | [**PROMOTION_TYPE**](PromotionType.md) |  | [default to null]
