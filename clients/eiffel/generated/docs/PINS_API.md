...
> multi_pins_analytics (pin_ids: LIST [STRING_32] ; start_date: DATE ; end_date: DATE ; metric_types: LIST [MULTI_PINS_ANALYTICS_METRIC_TYPES_ITEM] ; app_types:  detachable STRING_32 ; ad_account_id:  detachable STRING_32 ): detachable STRING_TABLE [STRING_TABLE]
 ...
 **metric_types** | [**LIST [MULTI_PINS_ANALYTICS_METRIC_TYPES_ITEM]**](MULTI_PINS_ANALYTICS_METRIC_TYPES_ITEM.md)| Pin metric types to get data for. | [default to null]
...
# **pins_analytics**
> pins_analytics (pin_id: STRING_32 ; start_date: DATE ; end_date: DATE ; metric_types: LIST [QUERYPINANALYTICSMETRICTYPES_ITEMS] ; app_types:  detachable STRING_32 ; split_field:  detachable STRING_32 ; ad_account_id:  detachable STRING_32 ): detachable STRING_TABLE [PIN_ANALYTICS_METRICS_RESPONSE]
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **pin_create** | [**PIN_CREATE**](PIN_CREATE.md)|  | 
 **ad_account_id** | **STRING_32**| Unique identifier of an ad account. | [optional] [default to null]
...
# **pins_delete**
> pins_delete (pin_id: STRING_32 ; ad_account_id:  detachable STRING_32 ): detachable PIN
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **pin_id** | **STRING_32**|  | [default to null]
 **ad_account_id** | **STRING_32**| Unique identifier of an ad account. | [optional] [default to null]
...
# **pins_get**
> pins_get (pin_id: STRING_32 ; ad_account_id:  detachable STRING_32 ; pin_metrics:  detachable BOOLEAN ): detachable PIN
...
# **pins_list**
> pins_list (pin_filter:  detachable PIN_FILTER ; pin_metrics:  detachable BOOLEAN ; include_protected_pins:  detachable BOOLEAN ; pin_type:  detachable PIN_TYPE ; creative_types:  detachable LIST [CREATIVE_TYPE] ; ad_account_id:  detachable STRING_32 ; domain:  detachable STRING_32 ; domains:  detachable LIST [STRING_32] ; include_product_tag_obj:  detachable BOOLEAN ; bookmark:  detachable STRING_32 ; page_size:  detachable INTEGER_32 ): detachable PINS_LIST_200_RESPONSE
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **pin_filter** | [**PIN_FILTER**](.md)| The filter to apply to the pins | [optional] [default to null]
 **pin_metrics** | **BOOLEAN**| Specify whether to return 90d and lifetime Pin metrics. Total comments and total reactions are only available with lifetime Pin metrics. If Pin was created before &#x60;2023-03-20&#x60; lifetime metrics will only be available for Video and Idea Pin formats. Lifetime metrics are available for all Pin formats since then. | [optional] [default to false]
 **include_protected_pins** | **BOOLEAN**| Whether to include protected pins in the results | [optional] [default to false]
 **pin_type** | [**PIN_TYPE**](.md)| The type of pins to return, currently only enabled for private pins | [optional] [default to null]
 ...
 **ad_account_id** | **STRING_32**| Unique identifier of an ad account. | [optional] [default to null]
 **domain** | **STRING_32**| Only return pins with links that match the exact domain. Domain should not include &#39;www.&#39; prefix. For example, &#39;pinterest.com&#39; is a valid domain, but &#39;www.pinterest.com&#39; is not (will not match any pins). | [optional] [default to null]
 **domains** | [**LIST [STRING_32]**](STRING_32.md)| Only return pins with links whose domain matches any value in the list. Values are joined comma-separated on the wire (e.g. &#x60;?domains&#x3D;instagram.com,jcpenney.com&#x60;). | [optional] [default to null]
 **include_product_tag_obj** | **BOOLEAN**| Include product tag objects in the response with their associated links. | [optional] [default to null]
...
# **pins_save**
> pins_save (pin_id: STRING_32 ; pins_save_request_create: PINS_SAVE_REQUEST_CREATE ; ad_account_id:  detachable STRING_32 ): detachable PIN
...
------------- | ------------- | ------------- | -------------
 **pin_id** | **STRING_32**| Unique identifier of a Pin. | [default to null]
 **pins_save_request_create** | [**PINS_SAVE_REQUEST_CREATE**](PINS_SAVE_REQUEST_CREATE.md)|  | 
 **ad_account_id** | **STRING_32**| Unique identifier of an ad account. | [optional] [default to null]
