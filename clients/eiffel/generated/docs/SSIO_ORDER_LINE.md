...
**accepted_terms_time** | [**STRING_32**](STRING_32.md) | The UTC timestamp (to the nearest second) when terms were accepted. | [optional] [default to null]
**ads_manager_order_line_id** | [**STRING_32**](STRING_32.md) | Ads manager order line id | [optional] [default to null]
...
**media_contact_firstname** | [**STRING_32**](STRING_32.md) | Billing media contact first name | [optional] [default to null]
**media_contact_lastname** | [**STRING_32**](STRING_32.md) | Billing media contact last name | [optional] [default to null]
...
**salesforce_order_line_id** | [**STRING_32**](STRING_32.md) | Order line id in SFDC | [optional] [default to null]
