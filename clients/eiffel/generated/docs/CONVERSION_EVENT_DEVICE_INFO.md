...
**form_factor** | [**FORM_FACTOR**](FormFactor.md) | Device form factor | [optional] [default to null]
...
**network_type** | [**NETWORK_TYPE**](NetworkType.md) | Network type: 4G, 5G, ethernet, wifi In Android: NetworkCapabilities.getNetworkCapabilities() | [optional] [default to null]
**os_family** | [**OS_FAMILY**](OsFamily.md) | OS Family | [optional] [default to null]
