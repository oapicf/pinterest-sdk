...
# **order_lines_get**
> order_lines_get (order_line_id: STRING_32 ; ad_account_id: STRING_32 ): detachable ORDER_LINE
...
------------- | ------------- | ------------- | -------------
 **order_line_id** | **STRING_32**| Order line ID. | [default to null]
...
# **order_lines_list**
> order_lines_list (ad_account_id: STRING_32 ; bookmark:  detachable STRING_32 ; page_size:  detachable INTEGER_32 ; order:  detachable PINTEREST_LIB_PAGINATION_ORDER ): detachable ORDER_LINES_LIST_200_RESPONSE
