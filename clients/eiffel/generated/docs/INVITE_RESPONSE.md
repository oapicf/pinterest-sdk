...
**created_by_business** | [**ANY**](.md) | Metadata for the business that created the invite/request. | [optional] [default to null]
**created_by_user** | [**ANY**](.md) | Metadata for the user that created the invite/request. | [optional] [default to null]
