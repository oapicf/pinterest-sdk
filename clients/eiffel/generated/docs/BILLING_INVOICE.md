...
**document_type** | [**BILLING_INVOICE_DOCUMENT_TYPE**](BillingInvoiceDocumentType.md) | The type of the document | [optional] [default to null]
...
**status** | [**BILLING_INVOICE_STATUS**](BillingInvoiceStatus.md) | The status of the invoice | [optional] [default to null]
