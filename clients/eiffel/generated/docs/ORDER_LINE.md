...
------------ | ------------- | ------------- | -------------
**ad_account_id** | [**STRING_32**](STRING_32.md) | Ad account ID. | [default to null]
...
**id** | [**STRING_32**](STRING_32.md) | Order line ID. | [default to null]
...
**status** | [**ORDER_LINE_STATUS**](OrderLineStatus.md) | Order line status. | [default to null]
**type** | [**STRING_32**](STRING_32.md) | Always \&quot;orderline\&quot;. | [default to null]
