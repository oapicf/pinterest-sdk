...
------------- | ------------- | ------------- | -------------
 **advanced_auction_items_get_request** | [**ADVANCED_AUCTION_ITEMS_GET_REQUEST**](ADVANCED_AUCTION_ITEMS_GET_REQUEST.md)|  | 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **advanced_auction_items_submit_request** | [**ADVANCED_AUCTION_ITEMS_SUBMIT_REQUEST**](ADVANCED_AUCTION_ITEMS_SUBMIT_REQUEST.md)|  | 
 **ad_account_id** | **STRING_32**| Unique identifier of an ad account. | [optional] [default to null]
