...
> feed_processing_results_list (feed_id: STRING_32 ; ad_account_id:  detachable STRING_32 ; bookmark:  detachable STRING_32 ; page_size:  detachable INTEGER_32 ): detachable FEED_PROCESSING_RESULTS_LIST_200_RESPONSE
...
# **feeds_create**
> feeds_create (catalogs_feed_create_request_schema: CATALOGS_FEED_CREATE_REQUEST_SCHEMA ; ad_account_id:  detachable STRING_32 ): detachable CATALOGS_FEED
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **catalogs_feed_create_request_schema** | [**CATALOGS_FEED_CREATE_REQUEST_SCHEMA**](CATALOGS_FEED_CREATE_REQUEST_SCHEMA.md)|  | 
 **ad_account_id** | **STRING_32**| Unique identifier of an ad account. | [optional] [default to null]
...
# **feeds_delete**
> feeds_delete (feed_id: STRING_32 ; ad_account_id:  detachable STRING_32 ): detachable CATALOGS_FEED
...
# **feeds_list**
> feeds_list (catalog_id:  detachable STRING_32 ; ad_account_id:  detachable STRING_32 ; bookmark:  detachable STRING_32 ; page_size:  detachable INTEGER_32 ): detachable FEEDS_LIST_200_RESPONSE
...
# **feeds_update**
> feeds_update (feed_id: STRING_32 ; catalogs_feed_update_request_schema: CATALOGS_FEED_UPDATE_REQUEST_SCHEMA ; ad_account_id:  detachable STRING_32 ): detachable CATALOGS_FEED
...
------------- | ------------- | ------------- | -------------
 **feed_id** | **STRING_32**| Unique identifier of a feed. | [default to null]
 **catalogs_feed_update_request_schema** | [**CATALOGS_FEED_UPDATE_REQUEST_SCHEMA**](CATALOGS_FEED_UPDATE_REQUEST_SCHEMA.md)|  | 
 **ad_account_id** | **STRING_32**| Unique identifier of an ad account. | [optional] [default to null]
...
# **items_issues_list**
> items_issues_list (processing_result_id: STRING_32 ; item_numbers:  detachable LIST [INTEGER_32] ; item_validation_issue:  detachable CATALOGS_ITEM_VALIDATION_ISSUE ; ad_account_id:  detachable STRING_32 ; bookmark:  detachable STRING_32 ; page_size:  detachable INTEGER_32 ): detachable ITEMS_ISSUES_LIST_200_RESPONSE
