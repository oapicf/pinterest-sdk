...
------------ | ------------- | ------------- | -------------
**demographics** | [**TRENDING_KEYWORD_DEMOGRAPHICS**](TrendingKeyword_demographics.md) |  | [optional] [default to null]
**has_prediction** | **BOOLEAN** | Indicates whether the keyword has a prediction available for the next 90 days.&lt;br /&gt; This field is only applicable when &#x60;include_prediction&#x60; query parameter is set to &#x60;true&#x60;. &lt;br /&gt; By default, the value is &#x60;false&#x60; and no prediction data is included in the response. | [optional] [default to null]
...
**predicted_time_series** | [**PREDICTED_TIME_SERIES**](PredictedTimeSeries.md) |  | [optional] [default to null]
**time_series** | [**TIME_SERIES**](TimeSeries.md) |  | [optional] [default to null]
