...
**budget_amount** | **REAL_64** | If Budget order line, the budget amount. | [optional] [default to null]
...
**estimated_monthly_spend** | **REAL_64** | If Ongoing (perpetual) order line, the estimated monthly spend | [optional] [default to null]
...
**order_line_type** | [**SSIO_ORDER_LINE_TYPE**](SSIOOrderLineType.md) | Type can be Budget or Perpetual | [default to null]
