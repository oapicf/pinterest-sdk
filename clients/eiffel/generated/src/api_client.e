...
feature {NONE} -- Initialization
	...
	make
		do
			...
			authentications.force (create {OAUTH},"pinterest_oauth2")
			is_oauth_configured := True	 
			authentications.force (create {OAUTH},"client_credentials")
			is_oauth_configured := True	 
			authentications.force (create {HTTP_BASIC_AUTH}, "basic")
			is_basic_auth_configured := True 
		end

feature -- Access

	default_base_path: STRING = "https://api.pinterest.com/v5"
			-- default base path.
