...
class CATALOGS_BASE_FILTER_KEYS
...
feature --Access
    ...
    c_us_to_m__la_be_l_0: detachable CATALOGS_PRODUCT_GROUP_FILTER_OPERATOR_TYPE_CRITERIA
      
    c_us_to_m__la_be_l_1: detachable CATALOGS_PRODUCT_GROUP_FILTER_OPERATOR_TYPE_CRITERIA
      
    c_us_to_m__la_be_l_2: detachable CATALOGS_PRODUCT_GROUP_FILTER_OPERATOR_TYPE_CRITERIA
      
    c_us_to_m__la_be_l_3: detachable CATALOGS_PRODUCT_GROUP_FILTER_OPERATOR_TYPE_CRITERIA
      
    c_us_to_m__la_be_l_4: detachable CATALOGS_PRODUCT_GROUP_FILTER_OPERATOR_TYPE_CRITERIA
    ...
    c_us_to_m__nu_mb_er_0: detachable CATALOGS_PRODUCT_GROUP_UINT32_CRITERIA
      
    c_us_to_m__nu_mb_er_1: detachable CATALOGS_PRODUCT_GROUP_UINT32_CRITERIA
      
    c_us_to_m__nu_mb_er_2: detachable CATALOGS_PRODUCT_GROUP_UINT32_CRITERIA
...
feature -- Change Element
    ...
    set_c_us_to_m__nu_mb_er_0 (a_name: like c_us_to_m__nu_mb_er_0)
        -- Set 'c_us_to_m__nu_mb_er_0' with 'a_name'.
      do
        c_us_to_m__nu_mb_er_0 := a_name
      ensure
        c_us_to_m__nu_mb_er_0_set: c_us_to_m__nu_mb_er_0 = a_name
      end

    set_c_us_to_m__nu_mb_er_1 (a_name: like c_us_to_m__nu_mb_er_1)
        -- Set 'c_us_to_m__nu_mb_er_1' with 'a_name'.
      do
        c_us_to_m__nu_mb_er_1 := a_name
      ensure
        c_us_to_m__nu_mb_er_1_set: c_us_to_m__nu_mb_er_1 = a_name
      end

    set_c_us_to_m__nu_mb_er_2 (a_name: like c_us_to_m__nu_mb_er_2)
        -- Set 'c_us_to_m__nu_mb_er_2' with 'a_name'.
      do
        c_us_to_m__nu_mb_er_2 := a_name
      ensure
        c_us_to_m__nu_mb_er_2_set: c_us_to_m__nu_mb_er_2 = a_name
      end
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass CATALOGS_BASE_FILTER_KEYS%N")
        ...
        if attached c_us_to_m__nu_mb_er_0 as l_c_us_to_m__nu_mb_er_0 then
          Result.append ("%Nc_us_to_m__nu_mb_er_0:")
          Result.append (l_c_us_to_m__nu_mb_er_0.out)
          Result.append ("%N")
        end
        if attached c_us_to_m__nu_mb_er_1 as l_c_us_to_m__nu_mb_er_1 then
          Result.append ("%Nc_us_to_m__nu_mb_er_1:")
          Result.append (l_c_us_to_m__nu_mb_er_1.out)
          Result.append ("%N")
        end
        if attached c_us_to_m__nu_mb_er_2 as l_c_us_to_m__nu_mb_er_2 then
          Result.append ("%Nc_us_to_m__nu_mb_er_2:")
          Result.append (l_c_us_to_m__nu_mb_er_2.out)
          Result.append ("%N")
        end
