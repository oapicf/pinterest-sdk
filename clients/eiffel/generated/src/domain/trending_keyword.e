...
feature --Access
    ...
    demographics: detachable TRENDING_KEYWORD_DEMOGRAPHICS
    ...
    predicted_time_series: detachable PREDICTED_TIME_SERIES
    ...
    time_series: detachable TIME_SERIES
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass TRENDING_KEYWORD%N")
        ...
        if attached predicted_time_series as l_predicted_time_series then
          ...
          Result.append (l_predicted_time_series.out)
          Result.append ("%N")
        end
