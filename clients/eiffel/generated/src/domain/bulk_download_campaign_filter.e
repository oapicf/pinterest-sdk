...
class BULK_DOWNLOAD_CAMPAIGN_FILTER
...
feature --Access
    ...
    campaign_status: detachable LIST [SUMMARY_STATUS]
      
    end_time: detachable STRING_32
      -- Unix UTC timestamp.
    name: detachable STRING_32
      -- Campaign name
    objective_type: detachable LIST [CONVERSION_OBJECTIVE_TYPE]
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass BULK_DOWNLOAD_CAMPAIGN_FILTER%N")
