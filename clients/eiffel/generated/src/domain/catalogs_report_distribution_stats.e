...
class CATALOGS_REPORT_DISTRIBUTION_STATS
...
feature -- Change Element
    ...
    set_ineligible_for_ads (a_name: like ineligible_for_ads)
        -- Set 'ineligible_for_ads' with 'a_name'.
      do
        ineligible_for_ads := a_name
      ensure
        ineligible_for_ads_set: ineligible_for_ads = a_name
      end

    set_ineligible_for_organic (a_name: like ineligible_for_organic)
        -- Set 'ineligible_for_organic' with 'a_name'.
      do
        ineligible_for_organic := a_name
      ensure
        ineligible_for_organic_set: ineligible_for_organic = a_name
      end
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass CATALOGS_REPORT_DISTRIBUTION_STATS%N")
        ...
        if attached ineligible_for_ads as l_ineligible_for_ads then
          Result.append ("%Nineligible_for_ads:")
          Result.append (l_ineligible_for_ads.out)
          Result.append ("%N")
        end
        if attached ineligible_for_organic as l_ineligible_for_organic then
          Result.append ("%Nineligible_for_organic:")
          Result.append (l_ineligible_for_organic.out)
          Result.append ("%N")
        end
