...
feature --Access
    ...
    connected_user_id: detachable STRING_32
      
    created_timestamp: REAL_32
...
feature -- Change Element
    ...
    set_connected_user_id (a_name: like connected_user_id)
        -- Set 'connected_user_id' with 'a_name'.
      do
        connected_user_id := a_name
      ensure
        connected_user_id_set: connected_user_id = a_name
      end
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass INTEGRATION_METADATA%N")
        ...
        if attached connected_user_id as l_connected_user_id then
          Result.append ("%Nconnected_user_id:")
          Result.append (l_connected_user_id.out)
          Result.append ("%N")
        end
