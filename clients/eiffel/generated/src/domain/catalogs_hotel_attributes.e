...
class CATALOGS_HOTEL_ATTRIBUTES
...
feature --Access
    ...
    main_image: detachable CATALOGS_HOTEL_MAIN_IMAGE
...
feature -- Change Element
    ...
    set_main_image (a_name: like main_image)
        -- Set 'main_image' with 'a_name'.
      do
        main_image := a_name
      ensure
        main_image_set: main_image = a_name
      end
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass CATALOGS_HOTEL_ATTRIBUTES%N")
        ...
        if attached main_image as l_main_image then
          Result.append ("%Nmain_image:")
          Result.append (l_main_image.out)
          Result.append ("%N")
        end
      end
end
