...
feature --Access
    ...
    content_type: detachable CONTENT_TYPE
    ...
    cover_image_content_type: detachable CONTENT_TYPE
      -- Content type for cover image Base64.
    cover_image_data: detachable STRING_32
      -- Cover image Base64.
    cover_image_key_frame_time: INTEGER_32
    ...
    items: detachable LIST [PIN_MEDIA_SOURCE_IMAGES_URL_ITEM]
...
feature -- Change Element
    ...
    set_cover_image_key_frame_time (a_name: like cover_image_key_frame_time)
        -- Set 'cover_image_key_frame_time' with 'a_name'.
      do
        cover_image_key_frame_time := a_name
      ensure
        cover_image_key_frame_time_set: cover_image_key_frame_time = a_name
      end
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        if attached cover_image_key_frame_time as l_cover_image_key_frame_time then
          Result.append ("%Ncover_image_key_frame_time:")
          Result.append (l_cover_image_key_frame_time.out)
          Result.append ("%N")
        end
