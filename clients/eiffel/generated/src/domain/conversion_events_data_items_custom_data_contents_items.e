...
class CONVERSION_EVENTS_DATA_ITEMS_CUSTOM_DATA_CONTENTS_ITEMS
...
feature --Access
    ...
    item_brand_id: detachable STRING_32
...
feature -- Change Element
    ...
    set_item_brand_id (a_name: like item_brand_id)
        -- Set 'item_brand_id' with 'a_name'.
      do
        item_brand_id := a_name
      ensure
        item_brand_id_set: item_brand_id = a_name
      end
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass CONVERSION_EVENTS_DATA_ITEMS_CUSTOM_DATA_CONTENTS_ITEMS%N")
        ...
        if attached item_brand_id as l_item_brand_id then
          Result.append ("%Nitem_brand_id:")
          Result.append (l_item_brand_id.out)
          Result.append ("%N")
        end
