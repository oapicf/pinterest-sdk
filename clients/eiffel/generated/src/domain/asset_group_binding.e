...
feature --Access
    ...
    asset_group_types: detachable LIST [STRING_32]
      -- Asset group types
    catalogs_ids: detachable LIST [STRING_32]
...
feature -- Change Element
    ...
    set_catalogs_ids (a_name: like catalogs_ids)
        -- Set 'catalogs_ids' with 'a_name'.
      do
        catalogs_ids := a_name
      ensure
        catalogs_ids_set: catalogs_ids = a_name
      end
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        if attached catalogs_ids as l_catalogs_ids then
          across l_catalogs_ids as ic loop
            Result.append ("%N catalogs_ids:")
            Result.append (ic.item.out)
            Result.append ("%N")
          end
        end
