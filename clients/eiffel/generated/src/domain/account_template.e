...
feature --Access
    ...
    ade_columns: detachable LIST [STRING_32]
      -- A list of ADE columns
    attribution_type: detachable ANY
    ...
    columns: detachable LIST [REPORTING_COLUMN]
      -- A list of columns to be included in the report
    conversion_report_time_type: detachable CONVERSION_REPORT_TIME_TYPE
      -- Conversion report time type
    creation_source: detachable CREATION_SOURCE
      -- The surface used to create this template
    custom_column_ids: detachable LIST [STRING_32]
      -- A list of custom column IDs
    display_metadata: detachable STRING_32
    ...
    id: detachable STRING_32
      -- Template ID
    ingestion_sources: detachable LIST [INGESTION_SOURCE]
    ...
    reporting_time_zone: detachable REPORTING_TIME_ZONE
      -- Timezone for reporting data
    sort_by: detachable ANY
...
feature -- Change Element
    ...
    set_ade_columns (a_name: like ade_columns)
        -- Set 'ade_columns' with 'a_name'.
      do
        ade_columns := a_name
      ensure
        ade_columns_set: ade_columns = a_name
      end
    ...
    set_display_metadata (a_name: like display_metadata)
        -- Set 'display_metadata' with 'a_name'.
      do
        display_metadata := a_name
      ensure
        display_metadata_set: display_metadata = a_name
      end
    ...
    set_reporting_time_zone (a_name: like reporting_time_zone)
        -- Set 'reporting_time_zone' with 'a_name'.
      do
        reporting_time_zone := a_name
      ensure
        reporting_time_zone_set: reporting_time_zone = a_name
      end
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass ACCOUNT_TEMPLATE%N")
        ...
        if attached ade_columns as l_ade_columns then
          across l_ade_columns as ic loop
            Result.append ("%N ade_columns:")
            Result.append (ic.item.out)
            Result.append ("%N")
          end
        end
        ...
        if attached display_metadata as l_display_metadata then
          Result.append ("%Ndisplay_metadata:")
          Result.append (l_display_metadata.out)
          Result.append ("%N")
        end
        ...
        if attached reporting_time_zone as l_reporting_time_zone then
          Result.append ("%Nreporting_time_zone:")
          Result.append (l_reporting_time_zone.out)
          Result.append ("%N")
        end
