...
feature --Access
    ...
    ai_disclosures: detachable AI_DISCLOSURES
...
feature -- Change Element
    ...
    set_is_product (a_name: like is_product)
        -- Set 'is_product' with 'a_name'.
      do
        is_product := a_name
      ensure
        is_product_set: is_product = a_name
      end
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass AGGREGATED_PIN_COMMENT%N")
        if attached ai_disclosures as l_ai_disclosures then
          Result.append ("%Nai_disclosures:")
          Result.append (l_ai_disclosures.out)
          Result.append ("%N")
        end
        ...
        if attached is_product as l_is_product then
          Result.append ("%Nis_product:")
          Result.append (l_is_product.out)
          Result.append ("%N")
        end
