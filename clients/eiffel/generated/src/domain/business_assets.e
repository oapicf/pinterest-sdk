...
feature -- Change Element
    ...
    set_catalog_info (a_name: like catalog_info)
        -- Set 'catalog_info' with 'a_name'.
      do
        catalog_info := a_name
      ensure
        catalog_info_set: catalog_info = a_name
      end
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass BUSINESS_ASSETS%N")
        ...
        if attached catalog_info as l_catalog_info then
          Result.append ("%Ncatalog_info:")
          Result.append (l_catalog_info.out)
          Result.append ("%N")
        end
      end
end
