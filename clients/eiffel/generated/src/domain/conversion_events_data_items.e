...
class CONVERSION_EVENTS_DATA_ITEMS
...
feature --Access
    ...
    app_info: detachable CONVERSION_EVENT_APP_INFO
      
    app_name: detachable STRING_32
      -- Name of the app.
    app_version: detachable STRING_32
      -- Version of the app.
    custom_data: detachable CONVERSION_EVENTS_DATA_ITEMS_CUSTOM_DATA
      
    device_brand: detachable STRING_32
      -- Brand of the user device.
    device_carrier: detachable STRING_32
      -- User device's mobile carrier.
    device_info: detachable CONVERSION_EVENT_DEVICE_INFO
    ...
    user_data: detachable CONVERSION_EVENTS_USER_DATA_PROPERTIES
...
feature -- Change Element
    ...
    set_app_info (a_name: like app_info)
        -- Set 'app_info' with 'a_name'.
      do
        app_info := a_name
      ensure
        app_info_set: app_info = a_name
      end
    ...
    set_device_info (a_name: like device_info)
        -- Set 'device_info' with 'a_name'.
      do
        device_info := a_name
      ensure
        device_info_set: device_info = a_name
      end
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass CONVERSION_EVENTS_DATA_ITEMS%N")
        ...
        if attached app_info as l_app_info then
          Result.append ("%Napp_info:")
          Result.append (l_app_info.out)
          Result.append ("%N")
        end
        ...
        if attached device_info as l_device_info then
          Result.append ("%Ndevice_info:")
          Result.append (l_device_info.out)
          Result.append ("%N")
        end
