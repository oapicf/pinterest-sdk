...
feature --Access
    ...
    date_availability: detachable TOP_VIDEO_PINS_ANALYTICS_RESPONSE_DATE_AVAILABILITY
      
    pins: detachable LIST [TOP_VIDEO_PINS_ANALYTICS_RESPONSE_PINS_ITEMS]
      
    sort_by: detachable TOP_VIDEO_PINS_SORT_BY
