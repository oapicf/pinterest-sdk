...
class CONVERSION_EVENTS_DATA_ITEMS_CUSTOM_DATA
...
feature --Access
    ...
    contents: detachable LIST [CONVERSION_EVENTS_DATA_ITEMS_CUSTOM_DATA_CONTENTS_ITEMS]
    ...
    external_measurement_id: detachable STRING_32
      -- Only use when instructed.
    external_measurement_vendor_id: INTEGER_32
      -- Only use when instructed.
    ...
    predicted_ltv: detachable STRING_32
...
feature -- Change Element
    ...
    set_external_measurement_id (a_name: like external_measurement_id)
        -- Set 'external_measurement_id' with 'a_name'.
      do
        external_measurement_id := a_name
      ensure
        external_measurement_id_set: external_measurement_id = a_name
      end

    set_external_measurement_vendor_id (a_name: like external_measurement_vendor_id)
        -- Set 'external_measurement_vendor_id' with 'a_name'.
      do
        external_measurement_vendor_id := a_name
      ensure
        external_measurement_vendor_id_set: external_measurement_vendor_id = a_name
      end
    ...
    set_predicted_ltv (a_name: like predicted_ltv)
        -- Set 'predicted_ltv' with 'a_name'.
      do
        predicted_ltv := a_name
      ensure
        predicted_ltv_set: predicted_ltv = a_name
      end
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass CONVERSION_EVENTS_DATA_ITEMS_CUSTOM_DATA%N")
        ...
        if attached external_measurement_id as l_external_measurement_id then
          Result.append ("%Nexternal_measurement_id:")
          Result.append (l_external_measurement_id.out)
          Result.append ("%N")
        end
        if attached external_measurement_vendor_id as l_external_measurement_vendor_id then
          Result.append ("%Nexternal_measurement_vendor_id:")
          Result.append (l_external_measurement_vendor_id.out)
          Result.append ("%N")
        end
        ...
        if attached predicted_ltv as l_predicted_ltv then
          Result.append ("%Npredicted_ltv:")
          Result.append (l_predicted_ltv.out)
          Result.append ("%N")
        end
