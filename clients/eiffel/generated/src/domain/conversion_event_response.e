...
feature --Access
    ...
    reporting_conversion_event: detachable STRING_32
...
feature -- Change Element
    ...
    set_reporting_conversion_event (a_name: like reporting_conversion_event)
        -- Set 'reporting_conversion_event' with 'a_name'.
      do
        reporting_conversion_event := a_name
      ensure
        reporting_conversion_event_set: reporting_conversion_event = a_name
      end
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        if attached reporting_conversion_event as l_reporting_conversion_event then
          Result.append ("%Nreporting_conversion_event:")
          Result.append (l_reporting_conversion_event.out)
          Result.append ("%N")
        end
      end
end
