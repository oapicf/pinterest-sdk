...
feature -- Enum
 ...
 val_campaign_objective_type: MMM_REPORTING_COLUMN
    once
      create Result
      Result.set_value ("CAMPAIGN_OBJECTIVE_TYPE")
    end

 val_pinner_list_name: MMM_REPORTING_COLUMN
    once
      create Result
      Result.set_value ("PINNER_LIST_NAME")
    end

 val_ads_credit_spend_in_dollar: MMM_REPORTING_COLUMN
    once
      create Result
      Result.set_value ("ADS_CREDIT_SPEND_IN_DOLLAR")
    end

 val_advertiser_paid_spend_in_dollar: MMM_REPORTING_COLUMN
    once
      create Result
      Result.set_value ("ADVERTISER_PAID_SPEND_IN_DOLLAR")
    end

 val_advertiser_paid_ecpc_in_dollar: MMM_REPORTING_COLUMN
    once
      create Result
      Result.set_value ("ADVERTISER_PAID_ECPC_IN_DOLLAR")
    end

 val_advertiser_paid_ecpm_in_dollar: MMM_REPORTING_COLUMN
    once
      create Result
      Result.set_value ("ADVERTISER_PAID_ECPM_IN_DOLLAR")
    end
