...
feature --Access
    ...
    video_counts: detachable CATALOGS_FEED_VIDEO_COUNTS
...
feature -- Change Element
    ...
    set_video_counts (a_name: like video_counts)
        -- Set 'video_counts' with 'a_name'.
      do
        video_counts := a_name
      ensure
        video_counts_set: video_counts = a_name
      end
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        if attached video_counts as l_video_counts then
          Result.append ("%Nvideo_counts:")
          Result.append (l_video_counts.out)
          Result.append ("%N")
        end
      end
end
