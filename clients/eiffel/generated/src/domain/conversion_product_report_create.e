...
class CONVERSION_PRODUCT_REPORT_CREATE
...
feature --Access
    ...
    campaign_objective_types: detachable LIST [CONVERSION_OBJECTIVE_TYPE]
    ...
    conversion_product_attribution_type: detachable CONVERSION_PRODUCT_ATTRIBUTION_TYPE
    ...
    conversion_product_breakdown: detachable CONVERSION_PRODUCT_REPORT_BREAKDOWN_TYPE
    ...
    granularity: detachable CONVERSION_PRODUCT_REPORT_GRANULARITY
      -- Report granularity for time-based metric aggregation
    level: detachable CONVERSION_PRODUCT_REPORT_LEVEL
      -- Level of the report
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass CONVERSION_PRODUCT_REPORT_CREATE%N")
