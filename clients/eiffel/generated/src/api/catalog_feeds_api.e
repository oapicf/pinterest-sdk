...
feature -- API Access
	...
	feed_processing_results_list (feed_id: STRING_32; ad_account_id: STRING_32; bookmark: STRING_32; page_size: INTEGER_32): detachable FEED_PROCESSING_RESULTS_LIST_200_RESPONSE
	...
	feeds_create (catalogs_feed_create_request_schema: CATALOGS_FEED_CREATE_REQUEST_SCHEMA; ad_account_id: STRING_32): detachable CATALOGS_FEED
			-- Create feed
			...
			-- 
			-- argument: catalogs_feed_create_request_schema  (required)
			-- 
			-- argument: ad_account_id Unique identifier of an ad account. (optional, default to null)
			-- 
			-- 
		...
		do
			reset_error
			create l_request
			l_request.set_body(catalogs_feed_create_request_schema)
	...
	feeds_delete (feed_id: STRING_32; ad_account_id: STRING_32): detachable CATALOGS_FEED
			-- Delete feed
	...
	feeds_list (catalog_id: STRING_32; ad_account_id: STRING_32; bookmark: STRING_32; page_size: INTEGER_32): detachable FEEDS_LIST_200_RESPONSE
			-- List feeds
	...
	feeds_update (feed_id: STRING_32; catalogs_feed_update_request_schema: CATALOGS_FEED_UPDATE_REQUEST_SCHEMA; ad_account_id: STRING_32): detachable CATALOGS_FEED
			-- Update feed
			-- Update a feed owned by the \&quot;operation user_account\&quot;. - By default, the \&quot;operation user_account\&quot; is the token user_account.  Optional: Business Access: Specify an &#x60;ad_account_id&#x60; (obtained via [List ad accounts](/docs/api/v5/#operation/ad_accounts/list)) to use the owner of that ad_account as the \&quot;operation user_account\&quot;. In order to do this, the token user_account must have one of the following [Business Access](https://help.pinterest.com/en/business/article/share-and-manage-access-to-your-ad-accounts) roles on the ad_account: Owner, Admin, Catalogs Manager.  For Retail partners, refer to [Before you get started with Catalogs](https://help.pinterest.com/en/business/article/before-you-get-started-with-catalogs). For Hotel partners, refer to [Pinterest API for shopping](/docs/api-features/shopping-overview/).  Note: Access to the Creative Assets catalog type is restricted to a specific group of users. If you require access, please reach out to your partner manager.
			-- 
			-- argument: feed_id Unique identifier of a feed. (required)
			-- 
			-- argument: catalogs_feed_update_request_schema  (required)
			-- 
			-- argument: ad_account_id Unique identifier of an ad account. (optional, default to null)
			-- 
			-- 
		...
		do
			reset_error
			create l_request
			l_request.set_body(catalogs_feed_update_request_schema)
			l_path := "/catalogs/feeds/{feed_id}"
			l_path.replace_substring_all ("{"+"feed_id"+"}", api_client.url_encode (feed_id.out))
			l_request.fill_query_params(api_client.parameter_to_tuple("", "ad_account_id", ad_account_id));
	...
	items_issues_list (processing_result_id: STRING_32; item_numbers: detachable LIST [INTEGER_32]; item_validation_issue: detachable CATALOGS_ITEM_VALIDATION_ISSUE; ad_account_id: STRING_32; bookmark: STRING_32; page_size: INTEGER_32): detachable ITEMS_ISSUES_LIST_200_RESPONSE
			-- List item issues
