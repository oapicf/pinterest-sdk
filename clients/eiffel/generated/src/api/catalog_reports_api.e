...
feature -- API Access
	...
	reports_create (catalogs_report_parameters: CATALOGS_REPORT_PARAMETERS; ad_account_id: STRING_32): detachable CATALOGS_CREATE_REPORT_RESPONSE
			...
			-- 
			-- argument: catalogs_report_parameters  (required)
			-- 
	...
	reports_stats (parameters: CATALOGS_REPORT_STATS_PARAMETERS; ad_account_id: STRING_32; bookmark: STRING_32; page_size: INTEGER_32): detachable REPORTS_STATS_200_RESPONSE
			-- List report stats
