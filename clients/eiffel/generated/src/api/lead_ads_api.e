...
feature -- API Access
	...
	ad_accounts_subscriptions_del_by_id (ad_account_id: STRING_32; subscription_id: STRING_32): detachable LEAD_SUBSCRIPTION
		...
		do
			...
			elseif attached { LEAD_SUBSCRIPTION } l_response.data ({ LEAD_SUBSCRIPTION }) as l_data then
				Result := l_data
			else
	...
	ad_accounts_subscriptions_get_list (ad_account_id: STRING_32; bookmark: STRING_32; page_size: INTEGER_32): detachable AD_ACCOUNTS_SUBSCRIPTIONS_GET_LIST_200_RESPONSE
	...
	ad_accounts_subscriptions_post (ad_account_id: STRING_32; lead_subscription_post_params_create: LEAD_SUBSCRIPTION_POST_PARAMS_CREATE): detachable LEAD_SUBSCRIPTION
			...
			-- argument: ad_account_id Unique identifier of an ad account. (required)
			-- 
			-- argument: lead_subscription_post_params_create  (required)
			-- 
			-- 
			-- Result LEAD_SUBSCRIPTION
		require
		...
		do
			reset_error
			create l_request
			l_request.set_body(lead_subscription_post_params_create)
			l_path := "/ad_accounts/{ad_account_id}/leads/subscriptions"
			l_path.replace_substring_all ("{"+"ad_account_id"+"}", api_client.url_encode (ad_account_id.out))
