...
feature -- API Access
	...
	brand_accounts_create (business_hierarchy_id: STRING_32; brand_accounts_create_request: BRAND_ACCOUNTS_CREATE_REQUEST): detachable BRAND_ACCOUNTS_CREATE_200_RESPONSE
			...
			-- 
			-- argument: brand_accounts_create_request  (required)
			-- 
			-- 
			-- Result BRAND_ACCOUNTS_CREATE_200_RESPONSE
		require
		local
  			l_path: STRING
		...
		do
			reset_error
			create l_request
			l_request.set_body(brand_accounts_create_request)
			...
			elseif attached { BRAND_ACCOUNTS_CREATE_200_RESPONSE } l_response.data ({ BRAND_ACCOUNTS_CREATE_200_RESPONSE }) as l_data then
				Result := l_data
			else
	...
	brand_accounts_update (business_hierarchy_id: STRING_32; brand_account_id: STRING_32; brand_accounts_update_request: BRAND_ACCOUNTS_UPDATE_REQUEST): detachable BRAND_ACCOUNTS_CREATE_200_RESPONSE
			...
			-- argument: business_hierarchy_id business hierarchy node id (required)
			-- 
			-- argument: brand_account_id Unique identifier of a brand account. (required)
			-- 
			-- argument: brand_accounts_update_request  (required)
			-- 
			-- 
			-- Result BRAND_ACCOUNTS_CREATE_200_RESPONSE
		require
		...
		do
			reset_error
			create l_request
			l_request.set_body(brand_accounts_update_request)
	...
	business_members (business_id: STRING_32; fetch_system_users: BOOLEAN; assets_summary: BOOLEAN; business_roles: detachable LIST [MEMBER_BUSINESS_ROLE]; member_ids: STRING_32; start_index: INTEGER_32; bookmark: STRING_32; page_size: INTEGER_32): detachable GET_BUSINESS_MEMBERS_200_RESPONSE
	...
	system_user_update (business_id: STRING_32; system_user_id: STRING_32; system_user_update_request: SYSTEM_USER_UPDATE_REQUEST)
			...
			-- 
			-- argument: system_user_update_request  (required)
			-- 
			-- 
		require
		local
		...
		do
			reset_error
			create l_request
			l_request.set_body(system_user_update_request)
