...
feature -- API Access
	...
	catalogs_product_group_pins_list (product_group_id: STRING_32; ad_account_id: STRING_32; pin_metrics: BOOLEAN; bookmark: STRING_32; page_size: INTEGER_32): detachable CATALOGS_PRODUCT_GROUP_PINS_LIST_200_RESPONSE
	...
	catalogs_product_groups_create (catalogs_product_groups_create_request_schema: CATALOGS_PRODUCT_GROUPS_CREATE_REQUEST_SCHEMA; ad_account_id: STRING_32): detachable CATALOGS_VERTICAL_PRODUCT_GROUP
			...
			-- 
			-- argument: catalogs_product_groups_create_request_schema  (required)
			-- 
			-- argument: ad_account_id Unique identifier of an ad account. (optional, default to null)
			-- 
			-- 
		...
		do
			reset_error
			create l_request
			l_request.set_body(catalogs_product_groups_create_request_schema)
	...
	catalogs_product_groups_create_many (catalogs_product_groups_create_many_request_items: LIST [CATALOGS_PRODUCT_GROUPS_CREATE_MANY_REQUEST_ITEMS]; ad_account_id: STRING_32): detachable LIST [STRING_32]
			...
			-- 
			-- argument: catalogs_product_groups_create_many_request_items  (required)
			-- 
			-- argument: ad_account_id Unique identifier of an ad account. (optional, default to null)
			-- 
			-- 
		...
		do
			reset_error
			create l_request
			l_request.set_body(catalogs_product_groups_create_many_request_items)
	...
	catalogs_product_groups_delete (product_group_id: STRING_32; ad_account_id: STRING_32): detachable CATALOGS_VERTICAL_PRODUCT_GROUP
	...
	catalogs_product_groups_list (id: detachable LIST [INTEGER_32]; feed_id: STRING_32; catalog_id: STRING_32; ad_account_id: STRING_32; bookmark: STRING_32; page_size: INTEGER_32): detachable CATALOGS_PRODUCT_GROUPS_LIST_200_RESPONSE
			-- List product groups
	...
	catalogs_product_groups_update (product_group_id: STRING_32; catalogs_product_groups_update_request_schema: CATALOGS_PRODUCT_GROUPS_UPDATE_REQUEST_SCHEMA; ad_account_id: STRING_32): detachable CATALOGS_VERTICAL_PRODUCT_GROUP
			-- Update single product group
			-- Update product group owned by the \&quot;operation user_account\&quot; to use in Catalogs. - By default, the \&quot;operation user_account\&quot; is the token user_account.  Optional: Business Access: Specify an &#x60;ad_account_id&#x60; (obtained via [List ad accounts](/docs/api/v5/#operation/ad_accounts/list)) to use the owner of that ad_account as the \&quot;operation user_account\&quot;. In order to do this, the token user_account must have one of the following [Business Access](https://help.pinterest.com/en/business/article/share-and-manage-access-to-your-ad-accounts) roles on the ad_account: Owner, Admin, Catalogs Manager. \&quot;Catalog-based product groups\&quot; can include items from all data sources (feeds and API) and are available to both non-retail catalogs with any data sources and retail catalogs with API-created items. If your catalog only contains retail items created via feeds, you should use the \&quot;retail feed-based\&quot; option. [Learn more](/docs/api-features/shopping-overview/)  Note: Access to the Creative Assets catalog type is restricted to a specific group of users. If you require access, please reach out to your partner manager.
			-- 
			-- argument: product_group_id Unique identifier of a product group (required)
			-- 
			-- argument: catalogs_product_groups_update_request_schema  (required)
			-- 
			-- argument: ad_account_id Unique identifier of an ad account. (optional, default to null)
			-- 
			-- 
		...
		do
			reset_error
			create l_request
			l_request.set_body(catalogs_product_groups_update_request_schema)
			l_path := "/catalogs/product_groups/{product_group_id}"
			l_path.replace_substring_all ("{"+"product_group_id"+"}", api_client.url_encode (product_group_id.out))
			l_request.fill_query_params(api_client.parameter_to_tuple("", "ad_account_id", ad_account_id));
	...
	products_by_product_group_filter_list (catalogs_list_products_by_filter_request: CATALOGS_LIST_PRODUCTS_BY_FILTER_REQUEST; bookmark: STRING_32; page_size: INTEGER_32; ad_account_id: STRING_32; pin_metrics: BOOLEAN): detachable CATALOGS_PRODUCT_GROUP_PINS_LIST_200_RESPONSE
			...
			-- 
			-- argument: catalogs_list_products_by_filter_request  (required)
			-- 
			-- argument: bookmark Cursor used to fetch the next page of items (optional, default to null)
			-- 
			-- argument: page_size Maximum number of items to include in a single page. See documentation on [Pagination](/docs/reference/pagination/) for more information. (optional, default to 25)
