...
feature -- API Access
	...
	integrations_commerce_patch (external_business_id: STRING_32; integration_request_patch: INTEGRATION_REQUEST_PATCH): detachable INTEGRATION_METADATA
			...
			-- argument: external_business_id External business ID for the integration. (required)
			-- 
			-- argument: integration_request_patch Parameters to get create/update the Integration Metadata (required)
			-- 
			-- 
			-- Result INTEGRATION_METADATA
		require
	...
	integrations_commerce_post (integration_request: INTEGRATION_REQUEST): detachable INTEGRATION_METADATA
			...
			-- 
			-- argument: integration_request Parameters to get create/update the Integration Metadata (required)
			-- 
			-- 
			-- Result INTEGRATION_METADATA
		require
