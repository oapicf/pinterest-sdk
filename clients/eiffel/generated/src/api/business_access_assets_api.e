...
feature -- API Access
	...
	asset_group_create (business_id: STRING_32; asset_group_input_create: ASSET_GROUP_INPUT_CREATE): detachable ASSET_GROUP_INPUT
			...
			-- 
			-- argument: asset_group_input_create  (required)
			-- 
			-- 
			-- Result ASSET_GROUP_INPUT
		require
		local
  			l_path: STRING
		...
		do
			reset_error
			create l_request
			l_request.set_body(asset_group_input_create)
			...
			elseif attached { ASSET_GROUP_INPUT } l_response.data ({ ASSET_GROUP_INPUT }) as l_data then
				Result := l_data
			else
	...
	asset_group_delete (business_id: STRING_32; asset_group_deletion_delete: ASSET_GROUP_DELETION_DELETE): detachable ASSET_GROUP_DELETION
			...
			-- argument: business_id Unique identifier of the requesting business. (required)
			-- 
			-- argument: asset_group_deletion_delete  (required)
			-- 
			-- 
			-- Result ASSET_GROUP_DELETION
		require
		local
  			l_path: STRING
  			l_request: API_CLIENT_REQUEST
		...
		do
			reset_error
			create l_request
			l_request.set_body(asset_group_deletion_delete)
			l_path := "/businesses/{business_id}/asset_groups"
			l_path.replace_substring_all ("{"+"business_id"+"}", api_client.url_encode (business_id.out))
			...
			if l_response.has_error then
				last_error := l_response.error
			elseif attached { ASSET_GROUP_DELETION } l_response.data ({ ASSET_GROUP_DELETION }) as l_data then
				Result := l_data
			else
				create last_error.make ("Unknown error: Status response [ " + l_response.status.out + "]")
			end
	...
	asset_group_update (business_id: STRING_32; asset_group_modification_read_or_update: ASSET_GROUP_MODIFICATION_READ_OR_UPDATE): detachable ASSET_GROUP_MODIFICATION
			...
			-- argument: business_id Unique identifier of the requesting business. (required)
			-- 
			-- argument: asset_group_modification_read_or_update  (required)
			-- 
			-- 
			-- Result ASSET_GROUP_MODIFICATION
		require
		local
  			l_path: STRING
  			l_request: API_CLIENT_REQUEST
		...
		do
			reset_error
			create l_request
			l_request.set_body(asset_group_modification_read_or_update)
			l_path := "/businesses/{business_id}/asset_groups"
			l_path.replace_substring_all ("{"+"business_id"+"}", api_client.url_encode (business_id.out))
			...
			if l_response.has_error then
				last_error := l_response.error
			elseif attached { ASSET_GROUP_MODIFICATION } l_response.data ({ ASSET_GROUP_MODIFICATION }) as l_data then
				Result := l_data
			else
				create last_error.make ("Unknown error: Status response [ " + l_response.status.out + "]")
			end
	...
	business_asset_members_get (business_id: STRING_32; asset_id: STRING_32; start_index: INTEGER_32; fetch_system_users: BOOLEAN; bookmark: STRING_32; page_size: INTEGER_32): detachable BUSINESS_ASSET_MEMBERS_GET_200_RESPONSE
	...
	business_asset_partners_get (business_id: STRING_32; asset_id: STRING_32; start_index: INTEGER_32; bookmark: STRING_32; page_size: INTEGER_32): detachable BUSINESS_ASSET_MEMBERS_GET_200_RESPONSE
	...
	business_member_assets_get (business_id: STRING_32; member_id: STRING_32; asset_type: STRING_32; start_index: INTEGER_32; sort_by: detachable ASSET_SORT_BY; sort_ascending: BOOLEAN; search_by: detachable ASSET_SEARCH_BY; search_value: STRING_32; asset_permission_type: detachable ASSET_PERMISSION_TYPE; ad_account_statuses: detachable LIST [NON_DRAFT_ENTITY_STATUS]; bookmark: STRING_32; page_size: INTEGER_32): detachable BUSINESS_MEMBER_ASSETS_GET_RESPONSE
			...
			-- argument: start_index An index to start fetching the results from. Only the results starting from this index will be returned. (optional, default to 0)
			-- 
			-- argument: sort_by The field to sort member assets by (optional, default to null)
			-- 
			-- argument: sort_ascending Sort assets in ascending order (optional, default to true)
			-- 
			-- argument: search_by The field to search member assets by (optional, default to null)
			-- 
			-- argument: search_value The value to search for (optional, default to null)
			-- 
			-- argument: asset_permission_type The type of asset permission to filter by (optional, default to null)
			-- 
			-- argument: ad_account_statuses A list of ad account statuses to filter the assets by. Only used when asset_type is AD_ACCOUNT. (optional, default to null)
			-- 
			-- argument: bookmark Cursor used to fetch the next page of items (optional, default to null)
			-- 
			-- argument: page_size Maximum number of items to include in a single page. See documentation on [Pagination](/docs/reference/pagination/) for more information. (optional, default to 25)
			-- 
			-- 
			-- Result BUSINESS_MEMBER_ASSETS_GET_RESPONSE
		require
     		start_index_is_greater_or_equal_than: start_index >= 0
			page_size_is_less_or_equal_than: page_size <= 250
     		page_size_is_greater_or_equal_than: page_size >= 1
		...
		do
			...
			l_request.fill_query_params(api_client.parameter_to_tuple("", "search_by", search_by));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "search_value", search_value));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "asset_permission_type", asset_permission_type));
			l_request.fill_query_params(api_client.parameter_to_tuple("multi", "ad_account_statuses", ad_account_statuses));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "bookmark", bookmark));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "page_size", page_size));
			...
			if l_response.has_error then
				last_error := l_response.error
			elseif attached { BUSINESS_MEMBER_ASSETS_GET_RESPONSE } l_response.data ({ BUSINESS_MEMBER_ASSETS_GET_RESPONSE }) as l_data then
				Result := l_data
			else
				create last_error.make ("Unknown error: Status response [ " + l_response.status.out + "]")
			end
	...
	business_members_asset_access_delete (business_id: STRING_32; business_members_asset_access_delete_body: BUSINESS_MEMBERS_ASSET_ACCESS_DELETE_BODY): detachable DELETE_MEMBER_ACCESS_RESULTS_RESPONSE_ARRAY
			...
			-- argument: business_id Unique identifier of the requesting business. (required)
			-- 
			-- argument: business_members_asset_access_delete_body  (required)
			-- 
			-- 
		...
		do
			reset_error
			create l_request
			l_request.set_body(business_members_asset_access_delete_body)
	...
	business_members_asset_access_update (business_id: STRING_32; update_member_asset_access_body: UPDATE_MEMBER_ASSET_ACCESS_BODY): detachable UPDATE_MEMBER_ASSETS_RESULTS_RESPONSE_ARRAY
			...
			-- argument: business_id Unique identifier of the requesting business. (required)
			-- 
			-- argument: update_member_asset_access_body  (required)
			-- 
			-- 
	...
	business_partner_asset_access_get (business_id: STRING_32; partner_id: STRING_32; partner_type: STRING_32; asset_type: STRING_32; start_index: INTEGER_32; sort_by: detachable ASSET_SORT_BY; sort_ascending: BOOLEAN; search_by: detachable ASSET_SEARCH_BY; search_value: STRING_32; bookmark: STRING_32; page_size: INTEGER_32): detachable BUSINESS_PARTNER_ASSET_ACCESS_GET_200_RESPONSE
	...
	delete_partner_asset_access_handler_impl (business_id: STRING_32; delete_partner_asset_access_body: DELETE_PARTNER_ASSET_ACCESS_BODY): detachable DELETE_PARTNER_ASSET_ACCESS_RESULTS_RESPONSE_ARRAY
			...
			-- 
			-- 
			-- Result DELETE_PARTNER_ASSET_ACCESS_RESULTS_RESPONSE_ARRAY
		require
		local
  			l_path: STRING
  			l_request: API_CLIENT_REQUEST
		...
		do
			...
			if l_response.has_error then
				last_error := l_response.error
			elseif attached { DELETE_PARTNER_ASSET_ACCESS_RESULTS_RESPONSE_ARRAY } l_response.data ({ DELETE_PARTNER_ASSET_ACCESS_RESULTS_RESPONSE_ARRAY }) as l_data then
				Result := l_data
			else
				create last_error.make ("Unknown error: Status response [ " + l_response.status.out + "]")
			end
	...
	update_partner_asset_access_handler_impl (business_id: STRING_32; update_partner_asset_access_body: UPDATE_PARTNER_ASSET_ACCESS_BODY): detachable UPDATE_PARTNER_ASSETS_RESULTS_RESPONSE_ARRAY
			...
			-- argument: business_id Unique identifier of the requesting business. (required)
			-- 
			-- argument: update_partner_asset_access_body  (required)
			-- 
			-- 
