...
feature -- API Access
	...
	pins_analytics (pin_id: STRING_32; start_date: DATE; end_date: DATE; metric_types: LIST [STRING_32]; app_types: STRING_32; split_field: STRING_32; ad_account_id: STRING_32): detachable STRING_TABLE [ANALYTICS_METRICS_RESPONSE]
			-- Get Pin analytics
	...
	pins_create (pin: PIN): detachable PIN
			...
			-- 
			-- argument: pin Create a new Pin. (required)
			-- 
			-- 
			-- Result PIN
		require
	...
	pins_get (pin_id: STRING_32; ad_account_id: STRING_32): detachable PIN
			-- Get Pin
