...
feature -- API Access
	...
	audiences_list (ad_account_id: STRING_32; bookmark: STRING_32; order: STRING_32; page_size: INTEGER_32; ownership_type: STRING_32): detachable AUDIENCES_LIST_200_RESPONSE
			...
			-- 
			-- argument: ownership_type &lt;strong&gt;This feature is currently in beta and not available to all apps.&lt;/strong&gt; Filter audiences by ownership type. (optional, default to OWNED)
			-- 
			-- 
