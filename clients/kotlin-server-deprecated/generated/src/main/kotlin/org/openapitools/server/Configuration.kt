...
val ApplicationAuthProviders: Map<String, OAuthServerSettings> = listOf<OAuthServerSettings>(
        OAuthServerSettings.OAuth2ServerSettings(
            ...
            clientId = settings.property("auth.oauth.pinterest_oauth2.clientId").getString(),
            clientSecret = settings.property("auth.oauth.pinterest_oauth2.clientSecret").getString(),
            defaultScopes = listOf("ads:read", "ads:write", "boards:read", "boards:read_secret", "boards:write", "boards:write_secret", "catalogs:read", "catalogs:write", "pins:read", "pins:read_secret", "pins:write", "pins:write_secret", "user_accounts:read")
        )
//        OAuthServerSettings.OAuth2ServerSettings(
//                name = "facebook",
