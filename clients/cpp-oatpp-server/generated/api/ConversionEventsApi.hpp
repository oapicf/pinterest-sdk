...
class ConversionEventsApi : public oatpp::web::server::api::ApiController {
public:

  ConversionEventsApi(OATPP_COMPONENT(std::shared_ptr<ObjectMapper>, objectMapper) /* Inject object mapper */)
  ...
  virtual std::shared_ptr<oatpp::web::protocol::http::outgoing::Response> events_create(const std::shared_ptr<IncomingRequest> &request, const oatpp::String &adAccountId, const oatpp::Object<org::openapitools::server::model::ConversionEventsCreate> &conversionEventsCreate, const oatpp::Boolean &test) = 0;

  ENDPOINT("POST", "/ad_accounts/{ad_account_id}/events", events_create_handler, REQUEST(std::shared_ptr<IncomingRequest>, request), PATH(oatpp::String, adAccountId), BODY_DTO(oatpp::Object<org::openapitools::server::model::ConversionEventsCreate>, conversionEventsCreate), QUERY(oatpp::Boolean, test)) {
      return events_create(request, adAccountId, conversionEventsCreate, test);
  }
};
