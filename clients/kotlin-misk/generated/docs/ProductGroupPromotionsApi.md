...
> kotlin.collections.List&lt;ProductGroupAnalyticsItems&gt; productGroupsAnalytics(startDate, endDate, productGroupIds, columns, granularity, adAccountId, clickWindowDays, engagementWindowDays, viewWindowDays, conversionReportTime, reportingTimezone)
...
try {
    val result : kotlin.collections.List<ProductGroupAnalyticsItems> = apiInstance.productGroupsAnalytics(startDate, endDate, productGroupIds, columns, granularity, adAccountId, clickWindowDays, engagementWindowDays, viewWindowDays, conversionReportTime, reportingTimezone)
    println(result)
} catch (e: ClientException) {
