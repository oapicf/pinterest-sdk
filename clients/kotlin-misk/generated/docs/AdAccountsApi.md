...
# **adAccountAnalytics**
> kotlin.collections.List&lt;AdAccountAnalyticsItems&gt; adAccountAnalytics(startDate, endDate, columns, granularity, adAccountId, clickWindowDays, engagementWindowDays, viewWindowDays, conversionReportTime, reportingTimezone)
...
try {
    val result : kotlin.collections.List<AdAccountAnalyticsItems> = apiInstance.adAccountAnalytics(startDate, endDate, columns, granularity, adAccountId, clickWindowDays, engagementWindowDays, viewWindowDays, conversionReportTime, reportingTimezone)
    println(result)
