...
*/
@Singleton
class ConversionEventsApiAction @Inject constructor(
) : WebAction {
    ...
    fun eventsCreate(
        ...
        @Valid @RequestBody conversionEventsCreate: ConversionEventsCreate, 
         @QueryParam(value = "test") test: kotlin.Boolean?
    ): ConversionEvents {
        TODO()
    }
}
