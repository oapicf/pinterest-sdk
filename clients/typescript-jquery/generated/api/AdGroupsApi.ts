...
export class AdGroupsApi {
    ...
    { response: JQueryXHR; body: Array<models.AdGroupsAnalyticsResponseInner>;  },
    ...
    > {
        ...
        $.ajax(requestOptions).then(
            (data: Array<models.AdGroupsAnalyticsResponseInner>, textStatus: string, jqXHR: JQueryXHR) =>
     ...
     */
    public adGroupsAudienceSizing(adAccountId: string, adGroupAudienceSizingRequest: models.AdGroupAudienceSizingRequest, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: models.AdGroupAudienceSizingResponse;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        ...
        requestOptions.data = JSON.stringify(adGroupAudienceSizingRequest);
        if (headerParams['Content-Type']) {
            requestOptions.contentType = headerParams['Content-Type'];
        }
        ...
        >();
        $.ajax(requestOptions).then(
            (data: models.AdGroupAudienceSizingResponse, textStatus: string, jqXHR: JQueryXHR) =>
                dfd.resolve({response: jqXHR, body: data}),
            (xhr: JQueryXHR, textStatus: string, errorThrown: string) =>
                dfd.reject({response: xhr, errorThrown: errorThrown})
        );
     ...
     */
    public adGroupsBidFloorGet(adAccountId: string, bidFloorRequest: models.BidFloorRequest, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    ...
    > {
        ...
        requestOptions.data = JSON.stringify(bidFloorRequest);
        if (headerParams['Content-Type']) {
            requestOptions.contentType = headerParams['Content-Type'];
        }
     ...
     * @param adAccountId Unique identifier of an ad account.
     * @param modelsAdGroupCreateRequest List of ad groups to create, size limit [1, 30].
     */
    public adGroupsCreate(adAccountId: string, modelsAdGroupCreateRequest: Array<models.AdGroupCreateRequest>, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: models.AdGroupArrayResponse;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        ...
        // verify required parameter 'modelsAdGroupCreateRequest' is not null or undefined
        if (modelsAdGroupCreateRequest === null || modelsAdGroupCreateRequest === undefined) {
            throw new Error('Required parameter modelsAdGroupCreateRequest was null or undefined when calling adGroupsCreate.');
        }
        ...
        requestOptions.data = JSON.stringify(modelsAdGroupCreateRequest);
        if (headerParams['Content-Type']) {
            requestOptions.contentType = headerParams['Content-Type'];
        }
        ...
        >();
        $.ajax(requestOptions).then(
            (data: models.AdGroupArrayResponse, textStatus: string, jqXHR: JQueryXHR) =>
                dfd.resolve({response: jqXHR, body: data}),
            (xhr: JQueryXHR, textStatus: string, errorThrown: string) =>
                dfd.reject({response: xhr, errorThrown: errorThrown})
        );
     ...
     */
    public adGroupsGet(adAccountId: string, adGroupId: string, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: models.AdGroupResponse;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/ad_accounts/{ad_account_id}/ad_groups/{ad_group_id}'.replace('{' + 'ad_account_id' + '}', encodeURIComponent(String(adAccountId))).replace('{' + 'ad_group_id' + '}', encodeURIComponent(String(adGroupId)));
        ...
        >();
        $.ajax(requestOptions).then(
            (data: models.AdGroupResponse, textStatus: string, jqXHR: JQueryXHR) =>
                dfd.resolve({response: jqXHR, body: data}),
            (xhr: JQueryXHR, textStatus: string, errorThrown: string) =>
                dfd.reject({response: xhr, errorThrown: errorThrown})
        );
     ...
     */
    public adGroupsList(adAccountId: string, campaignIds?: Array<string>, adGroupIds?: Array<string>, entityStatuses?: Array<'ACTIVE' | 'PAUSED' | 'ARCHIVED' | 'DRAFT' | 'DELETED_DRAFT'>, pageSize?: number, order?: 'ASCENDING' | 'DESCENDING', bookmark?: string, translateInterestsToNames?: boolean, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
     ...
     * @param adAccountId Unique identifier of an ad account.
     * @param modelsAdGroupUpdateRequest List of ad groups to update, size limit [1, 30].
     */
    public adGroupsUpdate(adAccountId: string, modelsAdGroupUpdateRequest: Array<models.AdGroupUpdateRequest>, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: models.AdGroupArrayResponse;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/ad_accounts/{ad_account_id}/ad_groups'.replace('{' + 'ad_account_id' + '}', encodeURIComponent(String(adAccountId)));
        ...
        // verify required parameter 'modelsAdGroupUpdateRequest' is not null or undefined
        if (modelsAdGroupUpdateRequest === null || modelsAdGroupUpdateRequest === undefined) {
            throw new Error('Required parameter modelsAdGroupUpdateRequest was null or undefined when calling adGroupsUpdate.');
        }
        ...
        requestOptions.data = JSON.stringify(modelsAdGroupUpdateRequest);
        if (headerParams['Content-Type']) {
            requestOptions.contentType = headerParams['Content-Type'];
        }
