...
export class MediaApi {
     ...
     */
    public mediaCreate(mediaUploadCreate: models.MediaUploadCreate, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    ...
    > {
        ...
        requestOptions.data = JSON.stringify(mediaUploadCreate);
    ...
    { response: JQueryXHR; body: models.Media;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        ...
        >();
        $.ajax(requestOptions).then(
            (data: models.Media, textStatus: string, jqXHR: JQueryXHR) =>
                dfd.resolve({response: jqXHR, body: data}),
            (xhr: JQueryXHR, textStatus: string, errorThrown: string) =>
                dfd.reject({response: xhr, errorThrown: errorThrown})
        );
