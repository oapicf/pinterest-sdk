...
export class PinsApi {
     ...
     */
    public multiPinsAnalytics(pinIds: Array<string>, startDate: string, endDate: string, metricTypes: Array<models.MultiPinsAnalyticsMetricTypesItem>, appTypes?: 'ALL' | 'MOBILE' | 'TABLET' | 'WEB', adAccountId?: string, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
     ...
     * @param adAccountId Unique identifier of an ad account.
     */
    public pinsAnalytics(pinId: string, startDate: string, endDate: string, metricTypes: Array<models.QuerypinanalyticsmetrictypesItems>, appTypes?: 'ALL' | 'MOBILE' | 'TABLET' | 'WEB', splitField?: 'NO_SPLIT' | 'APP_TYPE', adAccountId?: string, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
     ...
     */
    public pinsGet(pinId: string, adAccountId?: string, pinMetrics?: boolean, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: models.Pin;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/pins/{pin_id}'.replace('{pin_id}', encodeURIComponent(String(pinId)));
     ...
     */
    public pinsList(pinFilter?: models.PinFilter, pinMetrics?: boolean, includeProtectedPins?: boolean, pinType?: models.PinType, creativeTypes?: Array<models.CreativeType>, adAccountId?: string, domain?: string, domains?: Array<string>, includeProductTagObj?: boolean, bookmark?: string, pageSize?: number, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    ...
    > {
        ...
        if (domains) {
            queryParameters['domains'] = [];
            domains.forEach((element: any) => {
                queryParameters['domains'].push(element);
            });
        }
        if (includeProductTagObj !== null && includeProductTagObj !== undefined) {
            queryParameters['include_product_tag_obj'] = <string><any>includeProductTagObj;
        }
     ...
     * @param adAccountId Unique identifier of an ad account.
     */
    public pinsSave(pinId: string, pinsSaveRequestCreate: models.PinsSaveRequestCreate, adAccountId?: string, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: models.Pin;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        ...
        requestOptions.data = JSON.stringify(pinsSaveRequestCreate);
        if (headerParams['Content-Type']) {
            requestOptions.contentType = headerParams['Content-Type'];
        }
