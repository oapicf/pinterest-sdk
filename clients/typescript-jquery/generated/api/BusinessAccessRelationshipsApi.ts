...
export class BusinessAccessRelationshipsApi {
     ...
     */
    public brandAccountsCreate(businessHierarchyId: string, brandAccountsCreateRequest: models.BrandAccountsCreateRequest, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: models.BrandAccountsCreate200Response;  },
    ...
    > {
        ...
        requestOptions.data = JSON.stringify(brandAccountsCreateRequest);
        ...
        $.ajax(requestOptions).then(
            (data: models.BrandAccountsCreate200Response, textStatus: string, jqXHR: JQueryXHR) =>
     ...
     */
    public brandAccountsUpdate(businessHierarchyId: string, brandAccountId: string, brandAccountsUpdateRequest: models.BrandAccountsUpdateRequest, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: models.BrandAccountsCreate200Response;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/business_access/business_hierarchy/{business_hierarchy_id}/brand_accounts/{brand_account_id}'.replace('{' + 'business_hierarchy_id' + '}', encodeURIComponent(String(businessHierarchyId))).replace('{' + 'brand_account_id' + '}', encodeURIComponent(String(brandAccountId)));
        ...
        requestOptions.data = JSON.stringify(brandAccountsUpdateRequest);
        if (headerParams['Content-Type']) {
            requestOptions.contentType = headerParams['Content-Type'];
        }
     ...
     */
    public systemUserUpdate(businessId: string, systemUserId: string, systemUserUpdateRequest: models.SystemUserUpdateRequest, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    ...
    > {
        ...
        requestOptions.data = JSON.stringify(systemUserUpdateRequest);
        if (headerParams['Content-Type']) {
            requestOptions.contentType = headerParams['Content-Type'];
        }
