...
export class LeadAdsApi {
    ...
    { response: JQueryXHR; body: models.LeadSubscription;  },
    ...
    > {
        ...
        $.ajax(requestOptions).then(
            (data: models.LeadSubscription, textStatus: string, jqXHR: JQueryXHR) =>
     ...
     */
    public adAccountsSubscriptionsGetList(adAccountId: string, bookmark?: string, pageSize?: number, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
     ...
     */
    public adAccountsSubscriptionsPost(adAccountId: string, leadSubscriptionPostParamsCreate: models.LeadSubscriptionPostParamsCreate, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: models.LeadSubscription;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/ad_accounts/{ad_account_id}/leads/subscriptions'.replace('{ad_account_id}', encodeURIComponent(String(adAccountId)));
        ...
        requestOptions.data = JSON.stringify(leadSubscriptionPostParamsCreate);
        if (headerParams['Content-Type']) {
            requestOptions.contentType = headerParams['Content-Type'];
        }
