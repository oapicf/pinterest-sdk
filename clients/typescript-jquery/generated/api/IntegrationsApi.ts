...
export class IntegrationsApi {
     ...
     */
    public integrationsCommercePatch(externalBusinessId: string, integrationMetadataUpdate: models.IntegrationMetadataUpdate, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: models.IntegrationMetadata;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/integrations/commerce/{external_business_id}'.replace('{external_business_id}', encodeURIComponent(String(externalBusinessId)));
        ...
        requestOptions.data = JSON.stringify(integrationMetadataUpdate);
        if (headerParams['Content-Type']) {
            requestOptions.contentType = headerParams['Content-Type'];
        }
     ...
     */
    public integrationsCommercePost(integrationMetadataCreate: models.IntegrationMetadataCreate, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: models.IntegrationMetadata;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        ...
        requestOptions.data = JSON.stringify(integrationMetadataCreate);
        if (headerParams['Content-Type']) {
            requestOptions.contentType = headerParams['Content-Type'];
        }
     ...
     */
    public integrationsLogsPost(integrationLogsRequestCreate: models.IntegrationLogsRequestCreate, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    ...
    > {
        ...
        requestOptions.data = JSON.stringify(integrationLogsRequestCreate);
        if (headerParams['Content-Type']) {
            requestOptions.contentType = headerParams['Content-Type'];
        }
