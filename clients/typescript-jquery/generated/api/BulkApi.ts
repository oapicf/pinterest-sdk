...
export class BulkApi {
     ...
     */
    public bulkDownloadCreate(adAccountId: string, bulkDownloadCreate: models.BulkDownloadCreate, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: models.BulkDownload;  },
    ...
    > {
        ...
        requestOptions.data = JSON.stringify(bulkDownloadCreate);
        ...
        $.ajax(requestOptions).then(
            (data: models.BulkDownload, textStatus: string, jqXHR: JQueryXHR) =>
    ...
    { response: JQueryXHR; body: models.BulkJobData;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        ...
        >();
        $.ajax(requestOptions).then(
            (data: models.BulkJobData, textStatus: string, jqXHR: JQueryXHR) =>
                dfd.resolve({response: jqXHR, body: data}),
            (xhr: JQueryXHR, textStatus: string, errorThrown: string) =>
                dfd.reject({response: xhr, errorThrown: errorThrown})
        );
