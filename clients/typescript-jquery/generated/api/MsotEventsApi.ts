...
export class MsotEventsApi {
     ...
     */
    public msotEventsCreate(adAccountId: string, conversionMSOTEvents: models.ConversionMSOTEvents, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    ...
    > {
        ...
        requestOptions.data = JSON.stringify(conversionMSOTEvents);
