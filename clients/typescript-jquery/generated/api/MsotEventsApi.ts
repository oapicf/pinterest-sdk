...
export class MsotEventsApi {
     ...
     */
    public msotEventsCreate(adAccountId: string, conversionMSOTEventsCreate: models.ConversionMSOTEventsCreate, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body?: any;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/ad_accounts/{ad_account_id}/msot/events'.replace('{ad_account_id}', encodeURIComponent(String(adAccountId)));
        ...
        requestOptions.data = JSON.stringify(conversionMSOTEventsCreate);
