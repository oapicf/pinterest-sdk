...
export class ConversionTagsApi {
    ...
    { response: JQueryXHR; body: models.ConversionTag;  },
    ...
    > {
        ...
        $.ajax(requestOptions).then(
            (data: models.ConversionTag, textStatus: string, jqXHR: JQueryXHR) =>
    ...
    { response: JQueryXHR; body: models.ConversionTagsList200Response;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/ad_accounts/{ad_account_id}/conversion_tags'.replace('{ad_account_id}', encodeURIComponent(String(adAccountId)));
        ...
        >();
        $.ajax(requestOptions).then(
            (data: models.ConversionTagsList200Response, textStatus: string, jqXHR: JQueryXHR) =>
                dfd.resolve({response: jqXHR, body: data}),
            (xhr: JQueryXHR, textStatus: string, errorThrown: string) =>
                dfd.reject({response: xhr, errorThrown: errorThrown})
        );
     ...
     */
    public pageVisitConversionTagsGet(adAccountId: string, bookmark?: string, pageSize?: number, order?: models.PinterestLibPaginationOrder, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
