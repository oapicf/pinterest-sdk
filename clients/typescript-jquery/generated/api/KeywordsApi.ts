...
export class KeywordsApi {
     ...
     */
    public keywordsGet(adAccountId: string, campaignId?: string, adGroupId?: string, adGroupIds?: Array<string>, matchTypes?: Array<models.MatchType>, pageSize?: number, bookmark?: string, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    ...
    > {
        ...
        if (includePrediction !== null && includePrediction !== undefined) {
            queryParameters['include_prediction'] = <string><any>includePrediction;
        }
