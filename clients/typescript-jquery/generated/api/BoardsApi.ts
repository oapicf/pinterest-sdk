...
export class BoardsApi {
     ...
     */
    public boardSectionsCreate(boardId: string, boardSectionCreate: models.BoardSectionCreate, adAccountId?: string, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    ...
    > {
        ...
        requestOptions.data = JSON.stringify(boardSectionCreate);
     ...
     * @param adAccountId Unique identifier of an ad account.
     */
    public boardSectionsUpdate(boardId: string, sectionId: string, boardSectionUpdateWithRequiredBody: models.BoardSectionUpdateWithRequiredBody, adAccountId?: string, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: models.BoardSection;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/boards/{board_id}/sections/{section_id}'.replace('{board_id}', encodeURIComponent(String(boardId))).replace('{section_id}', encodeURIComponent(String(sectionId)));
        ...
        requestOptions.data = JSON.stringify(boardSectionUpdateWithRequiredBody);
        if (headerParams['Content-Type']) {
            requestOptions.contentType = headerParams['Content-Type'];
        }
     ...
     * @param adAccountId Unique identifier of an ad account.
     */
    public boardsCreate(boardCreate: models.BoardCreate, adAccountId?: string, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    ...
    > {
        ...
        requestOptions.data = JSON.stringify(boardCreate);
        if (headerParams['Content-Type']) {
            requestOptions.contentType = headerParams['Content-Type'];
        }
     ...
     * @param pageSize Maximum number of items to include in a single page. See documentation on [Pagination](/docs/reference/pagination/) for more information.
     */
    public boardsList(adAccountId?: string, privacy?: models.BoardPrivacyFilter, bookmark?: string, pageSize?: number, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
     ...
     * @param pageSize Maximum number of items to include in a single page. See documentation on [Pagination](/docs/reference/pagination/) for more information.
     */
    public boardsListPins(boardId: string, creativeTypes?: Array<models.CreativeType>, adAccountId?: string, pinMetrics?: boolean, bookmark?: string, pageSize?: number, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: models.BoardsListPins200Response;  },
    { response: JQueryXHR; errorThrown: string }
    > {
     ...
     * @param adAccountId Unique identifier of an ad account.
     */
    public boardsUpdate(boardId: string, boardWithUpdatePrivacyUpdate: models.BoardWithUpdatePrivacyUpdate, adAccountId?: string, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: models.BoardWithUpdatePrivacy;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/boards/{board_id}'.replace('{board_id}', encodeURIComponent(String(boardId)));
        ...
        requestOptions.data = JSON.stringify(boardWithUpdatePrivacyUpdate);
        if (headerParams['Content-Type']) {
            requestOptions.contentType = headerParams['Content-Type'];
        }
        ...
        >();
        $.ajax(requestOptions).then(
            (data: models.BoardWithUpdatePrivacy, textStatus: string, jqXHR: JQueryXHR) =>
                dfd.resolve({response: jqXHR, body: data}),
            (xhr: JQueryXHR, textStatus: string, errorThrown: string) =>
                dfd.reject({response: xhr, errorThrown: errorThrown})
        );
