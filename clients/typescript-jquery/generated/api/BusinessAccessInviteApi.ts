...
export class BusinessAccessInviteApi {
     ...
     */
    public cancelInvitesOrRequests(businessId: string, cancelInvitesRequest: models.CancelInvitesRequest, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: models.CancelInvitesResponse;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        ...
        requestOptions.data = JSON.stringify(cancelInvitesRequest);
        if (headerParams['Content-Type']) {
            requestOptions.contentType = headerParams['Content-Type'];
        }
        ...
        >();
        $.ajax(requestOptions).then(
            (data: models.CancelInvitesResponse, textStatus: string, jqXHR: JQueryXHR) =>
                dfd.resolve({response: jqXHR, body: data}),
            (xhr: JQueryXHR, textStatus: string, errorThrown: string) =>
                dfd.reject({response: xhr, errorThrown: errorThrown})
        );
     ...
     */
    public getInvites(businessId: string, isMember?: boolean, inviteStatus?: Array<models.InviteFilterStatus>, inviteType?: models.InviteType, bookmark?: string, pageSize?: number, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
