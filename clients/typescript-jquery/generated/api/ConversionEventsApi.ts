...
export class ConversionEventsApi {
     ...
     */
    public eventsCreate(adAccountId: string, conversionEventsCreate: models.ConversionEventsCreate, test?: boolean, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: models.ConversionEvents;  },
    ...
    > {
        ...
        requestOptions.data = JSON.stringify(conversionEventsCreate);
        ...
        $.ajax(requestOptions).then(
            (data: models.ConversionEvents, textStatus: string, jqXHR: JQueryXHR) =>
