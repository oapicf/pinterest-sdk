...
// UnmarshalJSON validates required property keys then unmarshals into CatalogsVerticalFeedsUpdateRequest
func (o *CatalogsVerticalFeedsUpdateRequest) UnmarshalJSON(data []byte) (err error) {
	...
	var decoded CatalogsVerticalFeedsUpdateRequest
...
// AssertCatalogsVerticalFeedsUpdateRequestRequired checks complex required fields (models, arrays, maps) and embedded parents.
