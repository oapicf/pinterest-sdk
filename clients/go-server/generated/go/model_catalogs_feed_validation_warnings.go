...
// AssertRecurseCatalogsFeedValidationWarningsRequired recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of CatalogsFeedValidationWarnings (e.g. [][]CatalogsFeedValidationWarnings), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseCatalogsFeedValidationWarningsRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aCatalogsFeedValidationWarnings, ok := obj.(CatalogsFeedValidationWarnings)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertCatalogsFeedValidationWarningsRequired(aCatalogsFeedValidationWarnings)
	})
}
