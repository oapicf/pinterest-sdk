...
// UnmarshalJSON validates required property keys then unmarshals into CatalogsProductGroupFiltersAnyOf
func (o *CatalogsProductGroupFiltersAnyOf) UnmarshalJSON(data []byte) (err error) {
	...
	var decoded CatalogsProductGroupFiltersAnyOf
...
// AssertCatalogsProductGroupFiltersAnyOfRequired checks complex required fields (models, arrays, maps) and embedded parents.
