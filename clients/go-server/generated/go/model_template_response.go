...
func AssertTemplateResponseRequired(obj TemplateResponse) error {
	if err := AssertTemplateResponseDateRangeRequired(obj.DateRange); err != nil {
		return err
	}
	return nil
}

// AssertTemplateResponseConstraints checks if the values respects the defined constraints
func AssertTemplateResponseConstraints(obj TemplateResponse) error {
	if err := AssertTemplateResponseDateRangeConstraints(obj.DateRange); err != nil {
		return err
	}
	return nil
}
