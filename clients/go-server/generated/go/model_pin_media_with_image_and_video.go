...
// UnmarshalJSON validates required property keys then unmarshals into PinMediaWithImageAndVideo
func (o *PinMediaWithImageAndVideo) UnmarshalJSON(data []byte) (err error) {
	...
	var decoded PinMediaWithImageAndVideo
...
// AssertPinMediaWithImageAndVideoRequired checks complex required fields (models, arrays, maps) and embedded parents.
