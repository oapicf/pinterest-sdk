...
// UnmarshalJSON validates required property keys then unmarshals into CatalogsHotelBatchRequest
func (o *CatalogsHotelBatchRequest) UnmarshalJSON(data []byte) (err error) {
	...
	var decoded CatalogsHotelBatchRequest
...
// AssertCatalogsHotelBatchRequestRequired checks complex required fields (models, arrays, maps) and embedded parents.
