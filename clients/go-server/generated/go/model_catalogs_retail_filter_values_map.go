...
// AssertCatalogsRetailFilterValuesMapRequired checks complex required fields (models, arrays, maps) and embedded parents.
// Primitive required fields are validated for JSON request bodies in UnmarshalJSON so zero values remain valid.
func AssertCatalogsRetailFilterValuesMapRequired(obj CatalogsRetailFilterValuesMap) error {
	return nil
}

// AssertCatalogsRetailFilterValuesMapConstraints checks if the values respects the defined constraints
func AssertCatalogsRetailFilterValuesMapConstraints(obj CatalogsRetailFilterValuesMap) error {
	return nil
}
