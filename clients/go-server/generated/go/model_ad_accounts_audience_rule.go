...
// AssertAdAccountsAudienceRuleRequired checks complex required fields (models, arrays, maps) and embedded parents.
// Primitive required fields are validated for JSON request bodies in UnmarshalJSON so zero values remain valid.
func AssertAdAccountsAudienceRuleRequired(obj AdAccountsAudienceRule) error {
	if err := AssertEventDataRequired(obj.EventData); err != nil {
		return err
	}
	return nil
}

// AssertAdAccountsAudienceRuleConstraints checks if the values respects the defined constraints
func AssertAdAccountsAudienceRuleConstraints(obj AdAccountsAudienceRule) error {
	if err := AssertEventDataConstraints(obj.EventData); err != nil {
		return err
	}
	return nil
}
