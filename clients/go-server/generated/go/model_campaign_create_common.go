...
// AssertCampaignCreateCommonRequired checks if the required fields are not zero-ed
func AssertCampaignCreateCommonRequired(obj CampaignCreateCommon) error {
...
// AssertCampaignCreateCommonConstraints checks if the values respects the defined constraints
func AssertCampaignCreateCommonConstraints(obj CampaignCreateCommon) error {
	return nil
}
