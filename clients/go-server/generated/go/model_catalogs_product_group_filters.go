...
// UnmarshalJSON validates required property keys then unmarshals into CatalogsProductGroupFilters
func (o *CatalogsProductGroupFilters) UnmarshalJSON(data []byte) (err error) {
	...
	var decoded CatalogsProductGroupFilters
...
// AssertCatalogsProductGroupFiltersRequired checks complex required fields (models, arrays, maps) and embedded parents.
