...
// UnmarshalJSON validates required property keys then unmarshals into AdvancedAuctionItemsSubmitUpsertRecord
func (o *AdvancedAuctionItemsSubmitUpsertRecord) UnmarshalJSON(data []byte) (err error) {
	...
	var decoded AdvancedAuctionItemsSubmitUpsertRecord
...
// AssertAdvancedAuctionItemsSubmitUpsertRecordRequired checks complex required fields (models, arrays, maps) and embedded parents.
