...
// UnmarshalJSON validates required property keys then unmarshals into BoardCreate
...
// AssertBoardCreateRequired checks complex required fields (models, arrays, maps) and embedded parents.
