...
// UnmarshalJSON validates required property keys then unmarshals into AdBatchUpdate
...
// AssertAdBatchUpdateRequired checks complex required fields (models, arrays, maps) and embedded parents.
// Primitive required fields are validated for JSON request bodies in UnmarshalJSON so zero values remain valid.
func AssertAdBatchUpdateRequired(obj AdBatchUpdate) error {
...
// AssertAdBatchUpdateConstraints checks if the values respects the defined constraints
func AssertAdBatchUpdateConstraints(obj AdBatchUpdate) error {
    if obj.QuizPinData != nil {
