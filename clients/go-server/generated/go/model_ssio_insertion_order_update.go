...
// AssertSsioInsertionOrderUpdateRequired checks complex required fields (models, arrays, maps) and embedded parents.
// Primitive required fields are validated for JSON request bodies in UnmarshalJSON so zero values remain valid.
func AssertSsioInsertionOrderUpdateRequired(obj SsioInsertionOrderUpdate) error {
	return nil
}

// AssertSsioInsertionOrderUpdateConstraints checks if the values respects the defined constraints
func AssertSsioInsertionOrderUpdateConstraints(obj SsioInsertionOrderUpdate) error {
	return nil
}
