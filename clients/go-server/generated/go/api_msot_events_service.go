...
func (s *MsotEventsAPIService) MsotEventsCreate(ctx context.Context, adAccountId string, conversionMsotEventsCreate ConversionMsotEventsCreate) (ImplResponse, error) {
