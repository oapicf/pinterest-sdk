...
// UnmarshalJSON validates required property keys then unmarshals into CatalogsCreateCreativeAssetsItem
func (o *CatalogsCreateCreativeAssetsItem) UnmarshalJSON(data []byte) (err error) {
	...
	var decoded CatalogsCreateCreativeAssetsItem
...
// AssertCatalogsCreateCreativeAssetsItemRequired checks complex required fields (models, arrays, maps) and embedded parents.
