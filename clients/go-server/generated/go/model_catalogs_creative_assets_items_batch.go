...
// UnmarshalJSON validates required property keys then unmarshals into CatalogsCreativeAssetsItemsBatch
func (o *CatalogsCreativeAssetsItemsBatch) UnmarshalJSON(data []byte) (err error) {
	...
	var decoded CatalogsCreativeAssetsItemsBatch
...
// AssertCatalogsCreativeAssetsItemsBatchRequired checks complex required fields (models, arrays, maps) and embedded parents.
