...
// AssertCatalogsCreativeAssetsFilterValuesMapRequired checks complex required fields (models, arrays, maps) and embedded parents.
// Primitive required fields are validated for JSON request bodies in UnmarshalJSON so zero values remain valid.
func AssertCatalogsCreativeAssetsFilterValuesMapRequired(obj CatalogsCreativeAssetsFilterValuesMap) error {
	return nil
}

// AssertCatalogsCreativeAssetsFilterValuesMapConstraints checks if the values respects the defined constraints
func AssertCatalogsCreativeAssetsFilterValuesMapConstraints(obj CatalogsCreativeAssetsFilterValuesMap) error {
	return nil
}
