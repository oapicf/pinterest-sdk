...
// AssertAccountTemplateRequired checks complex required fields (models, arrays, maps) and embedded parents.
// Primitive required fields are validated for JSON request bodies in UnmarshalJSON so zero values remain valid.
func AssertAccountTemplateRequired(obj AccountTemplate) error {
	return nil
}

// AssertAccountTemplateConstraints checks if the values respects the defined constraints
func AssertAccountTemplateConstraints(obj AccountTemplate) error {
	return nil
}
