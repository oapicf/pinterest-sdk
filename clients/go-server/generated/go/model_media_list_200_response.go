...
// UnmarshalJSON validates required property keys then unmarshals into MediaList200Response
func (o *MediaList200Response) UnmarshalJSON(data []byte) (err error) {
	...
	var decoded MediaList200Response
...
// AssertMediaList200ResponseRequired checks complex required fields (models, arrays, maps) and embedded parents.
