...
// AssertProductGroupPromotionCreateRequestElementRequired checks if the required fields are not zero-ed
func AssertProductGroupPromotionCreateRequestElementRequired(obj ProductGroupPromotionCreateRequestElement) error {
	return nil
}

// AssertProductGroupPromotionCreateRequestElementConstraints checks if the values respects the defined constraints
func AssertProductGroupPromotionCreateRequestElementConstraints(obj ProductGroupPromotionCreateRequestElement) error {
	return nil
}
