...
// AssertCatalogsRetailFeedsUpdateRequestConstraints checks if the values respects the defined constraints
func AssertCatalogsRetailFeedsUpdateRequestConstraints(obj CatalogsRetailFeedsUpdateRequest) error {
    if obj.Credentials != nil {
