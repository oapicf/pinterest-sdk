...
// AllowedCountryEnumValues is all the allowed values of Country enum
...
// validCountryEnumValue provides a map of Countrys for fast verification of use input
var validCountryEnumValues = map[Country]struct{}{
	"AD": {},
	"AE": {},
	"AF": {},
	"AG": {},
...
func NewCountryFromValue(v string) (Country, error) {
	...
	return "", fmt.Errorf("invalid value '%v' for Country: valid values are %v", v, AllowedCountryEnumValues)
}
