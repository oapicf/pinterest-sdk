...
// AssertCatalogsFeedIngestionWarningsRequired checks complex required fields (models, arrays, maps) and embedded parents.
// Primitive required fields are validated for JSON request bodies in UnmarshalJSON so zero values remain valid.
func AssertCatalogsFeedIngestionWarningsRequired(obj CatalogsFeedIngestionWarnings) error {
	return nil
}

// AssertCatalogsFeedIngestionWarningsConstraints checks if the values respects the defined constraints
func AssertCatalogsFeedIngestionWarningsConstraints(obj CatalogsFeedIngestionWarnings) error {
	return nil
}
