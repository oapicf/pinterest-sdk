...
// AssertConversionEventsUserDataRequired checks if the required fields are not zero-ed
func AssertConversionEventsUserDataRequired(obj ConversionEventsUserData) error {
...
// AssertConversionEventsUserDataConstraints checks if the values respects the defined constraints
func AssertConversionEventsUserDataConstraints(obj ConversionEventsUserData) error {
	return nil
}
