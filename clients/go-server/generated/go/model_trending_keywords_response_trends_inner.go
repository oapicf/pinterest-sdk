...
// AssertTrendingKeywordsResponseTrendsInnerRequired checks if the required fields are not zero-ed
func AssertTrendingKeywordsResponseTrendsInnerRequired(obj TrendingKeywordsResponseTrendsInner) error {
	return nil
}

// AssertTrendingKeywordsResponseTrendsInnerConstraints checks if the values respects the defined constraints
func AssertTrendingKeywordsResponseTrendsInnerConstraints(obj TrendingKeywordsResponseTrendsInner) error {
	return nil
}
