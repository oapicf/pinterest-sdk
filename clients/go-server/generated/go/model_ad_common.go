...
// AssertAdCommonRequired checks if the required fields are not zero-ed
func AssertAdCommonRequired(obj AdCommon) error {
...
// AssertAdCommonConstraints checks if the values respects the defined constraints
func AssertAdCommonConstraints(obj AdCommon) error {
	return nil
}
