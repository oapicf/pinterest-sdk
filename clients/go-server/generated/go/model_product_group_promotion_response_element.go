...
// AssertProductGroupPromotionResponseElementRequired checks if the required fields are not zero-ed
func AssertProductGroupPromotionResponseElementRequired(obj ProductGroupPromotionResponseElement) error {
	return nil
}

// AssertProductGroupPromotionResponseElementConstraints checks if the values respects the defined constraints
func AssertProductGroupPromotionResponseElementConstraints(obj ProductGroupPromotionResponseElement) error {
	return nil
}
