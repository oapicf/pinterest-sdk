...
// UnmarshalJSON validates required property keys then unmarshals into BulkUpsertRequestCreateCatalogProductGroupsItems
func (o *BulkUpsertRequestCreateCatalogProductGroupsItems) UnmarshalJSON(data []byte) (err error) {
	...
	var decoded BulkUpsertRequestCreateCatalogProductGroupsItems
...
// AssertBulkUpsertRequestCreateCatalogProductGroupsItemsRequired checks complex required fields (models, arrays, maps) and embedded parents.
// Primitive required fields are validated for JSON request bodies in UnmarshalJSON so zero values remain valid.
func AssertBulkUpsertRequestCreateCatalogProductGroupsItemsRequired(obj BulkUpsertRequestCreateCatalogProductGroupsItems) error {
...
// AssertBulkUpsertRequestCreateCatalogProductGroupsItemsConstraints checks if the values respects the defined constraints
func AssertBulkUpsertRequestCreateCatalogProductGroupsItemsConstraints(obj BulkUpsertRequestCreateCatalogProductGroupsItems) error {
