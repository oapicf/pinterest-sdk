...
// UnmarshalJSON validates required property keys then unmarshals into TemplatesList200Response
func (o *TemplatesList200Response) UnmarshalJSON(data []byte) (err error) {
	...
	var decoded TemplatesList200Response
...
// AssertTemplatesList200ResponseRequired checks complex required fields (models, arrays, maps) and embedded parents.
...
func AssertTemplatesList200ResponseRequired(obj TemplatesList200Response) error {
	...
	for _, el := range obj.Items {
		if err := AssertAccountTemplateRequired(el); err != nil {
			return err
		}
	}
	return nil
...
func AssertTemplatesList200ResponseConstraints(obj TemplatesList200Response) error {
	for _, el := range obj.Items {
		if err := AssertAccountTemplateConstraints(el); err != nil {
			return err
		}
	}
	return nil
