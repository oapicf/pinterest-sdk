...
// UnmarshalJSON validates required property keys then unmarshals into ProductGroupPromotionsCreate
func (o *ProductGroupPromotionsCreate) UnmarshalJSON(data []byte) (err error) {
	...
	var decoded ProductGroupPromotionsCreate
...
// AssertProductGroupPromotionsCreateRequired checks complex required fields (models, arrays, maps) and embedded parents.
// Primitive required fields are validated for JSON request bodies in UnmarshalJSON so zero values remain valid.
func AssertProductGroupPromotionsCreateRequired(obj ProductGroupPromotionsCreate) error {
...
// AssertProductGroupPromotionsCreateConstraints checks if the values respects the defined constraints
func AssertProductGroupPromotionsCreateConstraints(obj ProductGroupPromotionsCreate) error {
	for _, el := range obj.ProductGroupPromotion {
