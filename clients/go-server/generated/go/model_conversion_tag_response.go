...
// UnmarshalJSON validates required property keys then unmarshals into ConversionTagResponse
func (o *ConversionTagResponse) UnmarshalJSON(data []byte) (err error) {
	...
	var decoded ConversionTagResponse
...
// AssertConversionTagResponseRequired checks complex required fields (models, arrays, maps) and embedded parents.
