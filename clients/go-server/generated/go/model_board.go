...
// UnmarshalJSON validates required property keys then unmarshals into Board
...
// AssertBoardRequired checks complex required fields (models, arrays, maps) and embedded parents.
