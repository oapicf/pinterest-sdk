...
// UnmarshalJSON validates required property keys then unmarshals into FeedProcessingResultsList200Response
func (o *FeedProcessingResultsList200Response) UnmarshalJSON(data []byte) (err error) {
	...
	var decoded FeedProcessingResultsList200Response
...
// AssertFeedProcessingResultsList200ResponseRequired checks complex required fields (models, arrays, maps) and embedded parents.
