...
// UnmarshalJSON validates required property keys then unmarshals into PinMediaWithImages
func (o *PinMediaWithImages) UnmarshalJSON(data []byte) (err error) {
	...
	var decoded PinMediaWithImages
...
// AssertPinMediaWithImagesRequired checks complex required fields (models, arrays, maps) and embedded parents.
