...
// UnmarshalJSON validates required property keys then unmarshals into CatalogsHotelFeedsUpdateRequest
func (o *CatalogsHotelFeedsUpdateRequest) UnmarshalJSON(data []byte) (err error) {
	...
	var decoded CatalogsHotelFeedsUpdateRequest
...
// AssertCatalogsHotelFeedsUpdateRequestRequired checks complex required fields (models, arrays, maps) and embedded parents.
