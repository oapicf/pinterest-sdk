...
// UnmarshalJSON validates required property keys then unmarshals into AdUpdateRequest
...
// AssertAdUpdateRequestRequired checks complex required fields (models, arrays, maps) and embedded parents.
// Primitive required fields are validated for JSON request bodies in UnmarshalJSON so zero values remain valid.
func AssertAdUpdateRequestRequired(obj AdUpdateRequest) error {
	return nil
}

// AssertAdUpdateRequestConstraints checks if the values respects the defined constraints
func AssertAdUpdateRequestConstraints(obj AdUpdateRequest) error {
	return nil
}
