...
// AssertAdUpdateRequestRequired checks if the required fields are not zero-ed
func AssertAdUpdateRequestRequired(obj AdUpdateRequest) error {
	...
	if obj.TrackingUrls != nil {
		if err := AssertAdCommonTrackingUrlsRequired(*obj.TrackingUrls); err != nil {
			return err
		}
	}
	if obj.QuizPinData != nil {
		if err := AssertAdCommonQuizPinDataRequired(*obj.QuizPinData); err != nil {
			return err
		}
	}
	return nil
