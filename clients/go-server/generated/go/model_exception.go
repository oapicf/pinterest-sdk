...
// UnmarshalJSON validates required property keys then unmarshals into Exception
...
// AssertExceptionRequired checks complex required fields (models, arrays, maps) and embedded parents.
