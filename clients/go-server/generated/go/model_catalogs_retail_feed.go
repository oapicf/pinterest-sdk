...
// UnmarshalJSON validates required property keys then unmarshals into CatalogsRetailFeed
func (o *CatalogsRetailFeed) UnmarshalJSON(data []byte) (err error) {
	...
	var decoded CatalogsRetailFeed
...
// AssertCatalogsRetailFeedRequired checks complex required fields (models, arrays, maps) and embedded parents.
// Primitive required fields are validated for JSON request bodies in UnmarshalJSON so zero values remain valid.
func AssertCatalogsRetailFeedRequired(obj CatalogsRetailFeed) error {
...
// AssertCatalogsRetailFeedConstraints checks if the values respects the defined constraints
func AssertCatalogsRetailFeedConstraints(obj CatalogsRetailFeed) error {
    if obj.Credentials != nil {
