...
// UnmarshalJSON validates required property keys then unmarshals into AdGroup
...
// AssertAdGroupRequired checks complex required fields (models, arrays, maps) and embedded parents.
// Primitive required fields are validated for JSON request bodies in UnmarshalJSON so zero values remain valid.
func AssertAdGroupRequired(obj AdGroup) error {
...
// AssertAdGroupConstraints checks if the values respects the defined constraints
func AssertAdGroupConstraints(obj AdGroup) error {
    if obj.ExtFeatures != nil {
	...
	if obj.BidMultiplier != nil && *obj.BidMultiplier < 0 {
		return &ParsingError{Param: "BidMultiplier", Err: errors.New(errMsgMinValueConstraint)}
	}
	if obj.BidMultiplier != nil && *obj.BidMultiplier > 10 {
