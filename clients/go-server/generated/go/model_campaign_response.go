...
// AssertCampaignResponseConstraints checks if the values respects the defined constraints
func AssertCampaignResponseConstraints(obj CampaignResponse) error {
	return nil
}
