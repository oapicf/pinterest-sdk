...
// AssertRecurseItemAttributesRequired recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of ItemAttributes (e.g. [][]ItemAttributes), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseItemAttributesRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aItemAttributes, ok := obj.(ItemAttributes)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertItemAttributesRequired(aItemAttributes)
	})
}
