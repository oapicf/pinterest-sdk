...
// AssertItemAttributesRequired checks complex required fields (models, arrays, maps) and embedded parents.
// Primitive required fields are validated for JSON request bodies in UnmarshalJSON so zero values remain valid.
func AssertItemAttributesRequired(obj ItemAttributes) error {
	if obj.Gtin != nil {
...
// AssertItemAttributesConstraints checks if the values respects the defined constraints
func AssertItemAttributesConstraints(obj ItemAttributes) error {
    if obj.Gtin != nil {
