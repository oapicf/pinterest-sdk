...
// UnmarshalJSON validates required property keys then unmarshals into CatalogsItemsUpsertBatchRequest
func (o *CatalogsItemsUpsertBatchRequest) UnmarshalJSON(data []byte) (err error) {
	...
	var decoded CatalogsItemsUpsertBatchRequest
...
// AssertCatalogsItemsUpsertBatchRequestRequired checks complex required fields (models, arrays, maps) and embedded parents.
