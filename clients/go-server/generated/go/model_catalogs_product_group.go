...
// AssertCatalogsProductGroupConstraints checks if the values respects the defined constraints
func AssertCatalogsProductGroupConstraints(obj CatalogsProductGroup) error {
	return nil
}
