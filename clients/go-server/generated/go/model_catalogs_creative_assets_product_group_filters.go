...
// UnmarshalJSON validates required property keys then unmarshals into CatalogsCreativeAssetsProductGroupFilters
func (o *CatalogsCreativeAssetsProductGroupFilters) UnmarshalJSON(data []byte) (err error) {
	...
	var decoded CatalogsCreativeAssetsProductGroupFilters
...
// AssertCatalogsCreativeAssetsProductGroupFiltersRequired checks complex required fields (models, arrays, maps) and embedded parents.
