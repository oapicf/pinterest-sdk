...
// AssertAudienceRuleRequired checks complex required fields (models, arrays, maps) and embedded parents.
// Primitive required fields are validated for JSON request bodies in UnmarshalJSON so zero values remain valid.
func AssertAudienceRuleRequired(obj AudienceRule) error {
...
// AssertAudienceRuleConstraints checks if the values respects the defined constraints
func AssertAudienceRuleConstraints(obj AudienceRule) error {
