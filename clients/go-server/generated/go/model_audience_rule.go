...
// AssertAudienceRuleRequired checks if the required fields are not zero-ed
func AssertAudienceRuleRequired(obj AudienceRule) error {
	if err := AssertPinterestTagEventDataRequired(obj.EventData); err != nil {
		return err
	}
	return nil
}
...
func AssertAudienceRuleConstraints(obj AudienceRule) error {
	if err := AssertPinterestTagEventDataConstraints(obj.EventData); err != nil {
		return err
	}
	return nil
}
