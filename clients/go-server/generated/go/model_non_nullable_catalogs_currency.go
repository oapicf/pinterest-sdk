...
// AssertRecurseNonNullableCatalogsCurrencyRequired recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of NonNullableCatalogsCurrency (e.g. [][]NonNullableCatalogsCurrency), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseNonNullableCatalogsCurrencyRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aNonNullableCatalogsCurrency, ok := obj.(NonNullableCatalogsCurrency)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertNonNullableCatalogsCurrencyRequired(aNonNullableCatalogsCurrency)
	})
}
