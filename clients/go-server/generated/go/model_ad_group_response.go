...
// AssertRecurseAdGroupResponseRequired recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of AdGroupResponse (e.g. [][]AdGroupResponse), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseAdGroupResponseRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aAdGroupResponse, ok := obj.(AdGroupResponse)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertAdGroupResponseRequired(aAdGroupResponse)
	})
}
