...
// AssertConversionProductReportRequestRequired checks if the required fields are not zero-ed
func AssertConversionProductReportRequestRequired(obj ConversionProductReportRequest) error {
...
// AssertConversionProductReportRequestConstraints checks if the values respects the defined constraints
func AssertConversionProductReportRequestConstraints(obj ConversionProductReportRequest) error {
	return nil
}
