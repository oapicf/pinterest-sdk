...
// AssertCampaignBatchResponseDataRequired checks complex required fields (models, arrays, maps) and embedded parents.
// Primitive required fields are validated for JSON request bodies in UnmarshalJSON so zero values remain valid.
func AssertCampaignBatchResponseDataRequired(obj CampaignBatchResponseData) error {
...
// AssertCampaignBatchResponseDataConstraints checks if the values respects the defined constraints
func AssertCampaignBatchResponseDataConstraints(obj CampaignBatchResponseData) error {
    if obj.BidOptions != nil {
