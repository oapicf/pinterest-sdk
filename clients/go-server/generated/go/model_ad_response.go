...
// AssertAdResponseRequired checks if the required fields are not zero-ed
func AssertAdResponseRequired(obj AdResponse) error {
...
// AssertRecurseAdResponseRequired recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of AdResponse (e.g. [][]AdResponse), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseAdResponseRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aAdResponse, ok := obj.(AdResponse)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertAdResponseRequired(aAdResponse)
	})
}
