...
// UnmarshalJSON validates required property keys then unmarshals into AdGroupBase
...
// AssertAdGroupBaseRequired checks complex required fields (models, arrays, maps) and embedded parents.
// Primitive required fields are validated for JSON request bodies in UnmarshalJSON so zero values remain valid.
func AssertAdGroupBaseRequired(obj AdGroupBase) error {
...
// AssertAdGroupBaseConstraints checks if the values respects the defined constraints
func AssertAdGroupBaseConstraints(obj AdGroupBase) error {
    if obj.ExtFeatures != nil {
