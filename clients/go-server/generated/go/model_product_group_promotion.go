...
// AssertProductGroupPromotionRequired checks complex required fields (models, arrays, maps) and embedded parents.
// Primitive required fields are validated for JSON request bodies in UnmarshalJSON so zero values remain valid.
func AssertProductGroupPromotionRequired(obj ProductGroupPromotion) error {
	return nil
}

// AssertProductGroupPromotionConstraints checks if the values respects the defined constraints
func AssertProductGroupPromotionConstraints(obj ProductGroupPromotion) error {
	return nil
}
