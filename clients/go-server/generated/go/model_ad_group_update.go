...
// UnmarshalJSON validates required property keys then unmarshals into AdGroupUpdate
...
// AssertAdGroupUpdateRequired checks complex required fields (models, arrays, maps) and embedded parents.
// Primitive required fields are validated for JSON request bodies in UnmarshalJSON so zero values remain valid.
func AssertAdGroupUpdateRequired(obj AdGroupUpdate) error {
...
// AssertAdGroupUpdateConstraints checks if the values respects the defined constraints
func AssertAdGroupUpdateConstraints(obj AdGroupUpdate) error {
    if obj.ExtFeatures != nil {
