...
// UnmarshalJSON validates required property keys then unmarshals into OrderLinesList200Response
func (o *OrderLinesList200Response) UnmarshalJSON(data []byte) (err error) {
	...
	var decoded OrderLinesList200Response
...
// AssertOrderLinesList200ResponseRequired checks complex required fields (models, arrays, maps) and embedded parents.
