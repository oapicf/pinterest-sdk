...
// AssertAgeBucketMultipliersRequired checks complex required fields (models, arrays, maps) and embedded parents.
// Primitive required fields are validated for JSON request bodies in UnmarshalJSON so zero values remain valid.
func AssertAgeBucketMultipliersRequired(obj AgeBucketMultipliers) error {
	return nil
}

// AssertAgeBucketMultipliersConstraints checks if the values respects the defined constraints
func AssertAgeBucketMultipliersConstraints(obj AgeBucketMultipliers) error {
	return nil
}
