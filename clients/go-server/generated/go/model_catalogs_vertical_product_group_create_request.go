...
// UnmarshalJSON validates required property keys then unmarshals into CatalogsVerticalProductGroupCreateRequest
func (o *CatalogsVerticalProductGroupCreateRequest) UnmarshalJSON(data []byte) (err error) {
	...
	var decoded CatalogsVerticalProductGroupCreateRequest
...
// AssertCatalogsVerticalProductGroupCreateRequestRequired checks complex required fields (models, arrays, maps) and embedded parents.
