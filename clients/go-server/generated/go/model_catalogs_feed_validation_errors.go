...
// AssertCatalogsFeedValidationErrorsConstraints checks if the values respects the defined constraints
func AssertCatalogsFeedValidationErrorsConstraints(obj CatalogsFeedValidationErrors) error {
	return nil
}
