...
// UnmarshalJSON validates required property keys then unmarshals into SsioInsertionOrdersStatusGetByAdAccount200Response
func (o *SsioInsertionOrdersStatusGetByAdAccount200Response) UnmarshalJSON(data []byte) (err error) {
	...
	var decoded SsioInsertionOrdersStatusGetByAdAccount200Response
...
// AssertSsioInsertionOrdersStatusGetByAdAccount200ResponseRequired checks complex required fields (models, arrays, maps) and embedded parents.
