...
// AssertSsioInsertionOrderCommonRequired checks if the required fields are not zero-ed
func AssertSsioInsertionOrderCommonRequired(obj SsioInsertionOrderCommon) error {
	return nil
}

// AssertSsioInsertionOrderCommonConstraints checks if the values respects the defined constraints
func AssertSsioInsertionOrderCommonConstraints(obj SsioInsertionOrderCommon) error {
	return nil
}
