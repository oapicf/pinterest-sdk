...
// UnmarshalJSON validates required property keys then unmarshals into CatalogsRetailItemsBatch
func (o *CatalogsRetailItemsBatch) UnmarshalJSON(data []byte) (err error) {
	...
	var decoded CatalogsRetailItemsBatch
...
// AssertCatalogsRetailItemsBatchRequired checks complex required fields (models, arrays, maps) and embedded parents.
