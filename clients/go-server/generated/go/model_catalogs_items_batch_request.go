...
// UnmarshalJSON validates required property keys then unmarshals into CatalogsItemsBatchRequest
func (o *CatalogsItemsBatchRequest) UnmarshalJSON(data []byte) (err error) {
	...
	var decoded CatalogsItemsBatchRequest
...
// AssertCatalogsItemsBatchRequestRequired checks complex required fields (models, arrays, maps) and embedded parents.
