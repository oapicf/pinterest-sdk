...
func NewKeywordsAPIService() KeywordsAPIServicer {
...
func (s *KeywordsAPIService) TrendingKeywordsList(ctx context.Context, region TrendsSupportedRegion, trendType TrendType, interests []string, genders []string, ages []string, normalizeAgainstGroup bool, limit int32) (ImplResponse, error) {
