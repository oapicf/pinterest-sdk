...
// UnmarshalJSON validates required property keys then unmarshals into CampaignUpdateRequest
func (o *CampaignUpdateRequest) UnmarshalJSON(data []byte) (err error) {
	...
	var decoded CampaignUpdateRequest
...
// AssertCampaignUpdateRequestRequired checks complex required fields (models, arrays, maps) and embedded parents.
// Primitive required fields are validated for JSON request bodies in UnmarshalJSON so zero values remain valid.
func AssertCampaignUpdateRequestRequired(obj CampaignUpdateRequest) error {
...
// AssertCampaignUpdateRequestConstraints checks if the values respects the defined constraints
func AssertCampaignUpdateRequestConstraints(obj CampaignUpdateRequest) error {
    if obj.BidOptions != nil {
