...
// UnmarshalJSON validates required property keys then unmarshals into PinMediaWithVideo
...
// AssertPinMediaWithVideoRequired checks complex required fields (models, arrays, maps) and embedded parents.
