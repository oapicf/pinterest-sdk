...
// UnmarshalJSON validates required property keys then unmarshals into BoardSectionsList200Response
func (o *BoardSectionsList200Response) UnmarshalJSON(data []byte) (err error) {
	...
	var decoded BoardSectionsList200Response
...
// AssertBoardSectionsList200ResponseRequired checks complex required fields (models, arrays, maps) and embedded parents.
