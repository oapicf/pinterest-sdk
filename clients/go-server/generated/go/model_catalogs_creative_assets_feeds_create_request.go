...
// UnmarshalJSON validates required property keys then unmarshals into CatalogsCreativeAssetsFeedsCreateRequest
func (o *CatalogsCreativeAssetsFeedsCreateRequest) UnmarshalJSON(data []byte) (err error) {
	...
	var decoded CatalogsCreativeAssetsFeedsCreateRequest
...
// AssertCatalogsCreativeAssetsFeedsCreateRequestRequired checks complex required fields (models, arrays, maps) and embedded parents.
