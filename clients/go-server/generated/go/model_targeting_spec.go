...
// AssertTargetingSpecRequired checks complex required fields (models, arrays, maps) and embedded parents.
// Primitive required fields are validated for JSON request bodies in UnmarshalJSON so zero values remain valid.
func AssertTargetingSpecRequired(obj TargetingSpec) error {
...
// AssertTargetingSpecConstraints checks if the values respects the defined constraints
func AssertTargetingSpecConstraints(obj TargetingSpec) error {
    if obj.SHOPPING_RETARGETING != nil {
     	for _, el := range *obj.SHOPPING_RETARGETING {
