...
// UnmarshalJSON validates required property keys then unmarshals into CatalogsHotelListProductsByCatalogBasedFilterRequest
func (o *CatalogsHotelListProductsByCatalogBasedFilterRequest) UnmarshalJSON(data []byte) (err error) {
	...
	var decoded CatalogsHotelListProductsByCatalogBasedFilterRequest
...
// AssertCatalogsHotelListProductsByCatalogBasedFilterRequestRequired checks complex required fields (models, arrays, maps) and embedded parents.
