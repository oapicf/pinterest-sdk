...
// UnmarshalJSON validates required property keys then unmarshals into HotelIdFilter
...
// AssertHotelIdFilterRequired checks complex required fields (models, arrays, maps) and embedded parents.
