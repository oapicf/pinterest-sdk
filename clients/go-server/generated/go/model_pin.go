...
// UnmarshalJSON validates required property keys then unmarshals into Pin
...
// AssertPinRequired checks complex required fields (models, arrays, maps) and embedded parents.
