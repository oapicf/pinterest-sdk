...
// UnmarshalJSON validates required property keys then unmarshals into BoardBase
...
// AssertBoardBaseRequired checks complex required fields (models, arrays, maps) and embedded parents.
// Primitive required fields are validated for JSON request bodies in UnmarshalJSON so zero values remain valid.
func AssertBoardBaseRequired(obj BoardBase) error {
	return nil
}

// AssertBoardBaseConstraints checks if the values respects the defined constraints
func AssertBoardBaseConstraints(obj BoardBase) error {
	return nil
}
