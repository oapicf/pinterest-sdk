...
// AssertCatalogsUpdatableHotelAttributesConstraints checks if the values respects the defined constraints
func AssertCatalogsUpdatableHotelAttributesConstraints(obj CatalogsUpdatableHotelAttributes) error {
	return nil
}
