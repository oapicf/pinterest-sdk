...
func AssertAdsAnalyticsCreateAsyncRequestRequired(obj AdsAnalyticsCreateAsyncRequest) error {
	...
	for _, el := range obj.CustomConversionEventMetrics {
		if err := AssertAdsAnalyticsCreateAsyncRequestAllOfCustomConversionEventMetricsRequired(el); err != nil {
			return err
		}
	}
	return nil
...
func AssertAdsAnalyticsCreateAsyncRequestConstraints(obj AdsAnalyticsCreateAsyncRequest) error {
	...
	for _, el := range obj.CustomConversionEventMetrics {
		if err := AssertAdsAnalyticsCreateAsyncRequestAllOfCustomConversionEventMetricsConstraints(el); err != nil {
			return err
		}
	}
	if obj.EndHour < 0 {
