...
// AssertAdsAnalyticsCreateAsyncRequestRequired checks if the required fields are not zero-ed
...
// AssertRecurseAdsAnalyticsCreateAsyncRequestRequired recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of AdsAnalyticsCreateAsyncRequest (e.g. [][]AdsAnalyticsCreateAsyncRequest), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseAdsAnalyticsCreateAsyncRequestRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aAdsAnalyticsCreateAsyncRequest, ok := obj.(AdsAnalyticsCreateAsyncRequest)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertAdsAnalyticsCreateAsyncRequestRequired(aAdsAnalyticsCreateAsyncRequest)
	})
}
