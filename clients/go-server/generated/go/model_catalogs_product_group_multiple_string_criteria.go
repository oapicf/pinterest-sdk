...
// UnmarshalJSON validates required property keys then unmarshals into CatalogsProductGroupMultipleStringCriteria
func (o *CatalogsProductGroupMultipleStringCriteria) UnmarshalJSON(data []byte) (err error) {
	...
	var decoded CatalogsProductGroupMultipleStringCriteria
...
// AssertCatalogsProductGroupMultipleStringCriteriaRequired checks complex required fields (models, arrays, maps) and embedded parents.
