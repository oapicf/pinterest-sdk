...
// UnmarshalJSON validates required property keys then unmarshals into CatalogsItemsCreateBatchRequest
func (o *CatalogsItemsCreateBatchRequest) UnmarshalJSON(data []byte) (err error) {
	...
	var decoded CatalogsItemsCreateBatchRequest
...
// AssertCatalogsItemsCreateBatchRequestRequired checks complex required fields (models, arrays, maps) and embedded parents.
