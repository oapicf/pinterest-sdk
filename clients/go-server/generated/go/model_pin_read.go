...
// UnmarshalJSON validates required property keys then unmarshals into PinRead
...
// AssertPinReadRequired checks complex required fields (models, arrays, maps) and embedded parents.
// Primitive required fields are validated for JSON request bodies in UnmarshalJSON so zero values remain valid.
func AssertPinReadRequired(obj PinRead) error {
...
// AssertPinReadConstraints checks if the values respects the defined constraints
func AssertPinReadConstraints(obj PinRead) error {
