...
// AssertCustomerListUploadResponseRequired checks if the required fields are not zero-ed
func AssertCustomerListUploadResponseRequired(obj CustomerListUploadResponse) error {
...
// AssertCustomerListUploadResponseConstraints checks if the values respects the defined constraints
func AssertCustomerListUploadResponseConstraints(obj CustomerListUploadResponse) error {
    if obj.ErrorCounts != nil {
     	for _, el := range *obj.ErrorCounts {
