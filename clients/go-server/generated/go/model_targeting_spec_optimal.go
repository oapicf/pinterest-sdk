...
// AssertTargetingSpecOptimalRequired checks complex required fields (models, arrays, maps) and embedded parents.
// Primitive required fields are validated for JSON request bodies in UnmarshalJSON so zero values remain valid.
func AssertTargetingSpecOptimalRequired(obj TargetingSpecOptimal) error {
	if obj.SHOPPING_RETARGETING != nil {
		for _, el := range *obj.SHOPPING_RETARGETING {
...
// AssertTargetingSpecOptimalConstraints checks if the values respects the defined constraints
func AssertTargetingSpecOptimalConstraints(obj TargetingSpecOptimal) error {
    if obj.SHOPPING_RETARGETING != nil {
     	for _, el := range *obj.SHOPPING_RETARGETING {
