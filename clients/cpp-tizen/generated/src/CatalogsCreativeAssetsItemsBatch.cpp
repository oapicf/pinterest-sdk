...
void
CatalogsCreativeAssetsItemsBatch::__init()
{
	//batch_id = std::string();
	//created_time = null;
	//completed_time = null;
...
void
CatalogsCreativeAssetsItemsBatch::__cleanup()
{
	//if(batch_id != NULL) {
	//
	//delete batch_id;
...
void
CatalogsCreativeAssetsItemsBatch::fromJson(char* jsonStr)
{
...
CatalogsCreativeAssetsItemsBatch::CatalogsCreativeAssetsItemsBatch(char* json)
{
	this->fromJson(json);
}
