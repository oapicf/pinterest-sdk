...
void
Lead_forms_list_200_response::__init()
{
...
void
Lead_forms_list_200_response::__cleanup()
{
	//if(items != NULL) {
...
void
Lead_forms_list_200_response::fromJson(char* jsonStr)
{
...
Lead_forms_list_200_response::Lead_forms_list_200_response(char* json)
{
	this->fromJson(json);
}

char*
Lead_forms_list_200_response::toJson()
{
...
std::string
Lead_forms_list_200_response::getBookmark()
{
	return bookmark;
}
