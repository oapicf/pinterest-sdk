...
#ifndef _AdResponse_allOf_1_H_
#define _AdResponse_allOf_1_H_
...
class AdResponse_allOf_1 : public Object {
public:
	/*! \brief Constructor.
	 */
	AdResponse_allOf_1();
	AdResponse_allOf_1(char* str);

	/*! \brief Destructor.
	 */
	virtual ~AdResponse_allOf_1();
