...
void
ItemAttributesRequest::__cleanup()
{
	//if(ad_link != NULL) {
	//
	//delete ad_link;
...
void
ItemAttributesRequest::fromJson(char* jsonStr)
{
...
ItemAttributesRequest::ItemAttributesRequest(char* json)
{
	this->fromJson(json);
}
...
void
ItemAttributesRequest::setAverageReviewRating(long long  average_review_rating)
{
...
bool
ItemAttributesRequest::getCheckoutEnabled()
{
...
bool
ItemAttributesRequest::getFreeShippingLabel()
{
...
void
ItemAttributesRequest::setGtin(int  gtin)
{
	this->gtin = gtin;
}
...
void
ItemAttributesRequest::setLastUpdatedTime(long long  last_updated_time)
{
