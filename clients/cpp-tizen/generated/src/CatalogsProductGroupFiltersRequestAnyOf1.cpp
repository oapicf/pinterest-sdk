...
void
CatalogsProductGroupFiltersRequest_anyOf_1::__init()
{
	//new std::list()std::list> all_of;
}

void
CatalogsProductGroupFiltersRequest_anyOf_1::__cleanup()
{
	//if(all_of != NULL) {
...
void
CatalogsProductGroupFiltersRequest_anyOf_1::fromJson(char* jsonStr)
{
...
CatalogsProductGroupFiltersRequest_anyOf_1::CatalogsProductGroupFiltersRequest_anyOf_1(char* json)
{
	this->fromJson(json);
}

char*
CatalogsProductGroupFiltersRequest_anyOf_1::toJson()
{
...
CatalogsProductGroupFiltersRequest_anyOf_1::getAllOf()
{
	return all_of;
}

void
CatalogsProductGroupFiltersRequest_anyOf_1::setAllOf(std::list <CatalogsProductGroupFilterKeys> all_of)
{
	this->all_of = all_of;
}
