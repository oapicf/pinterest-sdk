...
void
BusinessToBusinessSharedAudienceUpdateWithRequiredBody::__init()
{
	//audience_id = null;
...
void
BusinessToBusinessSharedAudienceUpdateWithRequiredBody::__cleanup()
{
	//if(audience_id != NULL) {
	//
	//delete audience_id;
...
void
BusinessToBusinessSharedAudienceUpdateWithRequiredBody::fromJson(char* jsonStr)
{
...
BusinessToBusinessSharedAudienceUpdateWithRequiredBody::BusinessToBusinessSharedAudienceUpdateWithRequiredBody(char* json)
{
	this->fromJson(json);
}

char*
BusinessToBusinessSharedAudienceUpdateWithRequiredBody::toJson()
{
...
std::string
BusinessToBusinessSharedAudienceUpdateWithRequiredBody::getAudienceId()
{
	return audience_id;
}

void
BusinessToBusinessSharedAudienceUpdateWithRequiredBody::setAudienceId(std::string  audience_id)
{
	this->audience_id = audience_id;
}

OperationType
BusinessToBusinessSharedAudienceUpdateWithRequiredBody::getOperationType()
{
	return operation_type;
}

void
BusinessToBusinessSharedAudienceUpdateWithRequiredBody::setOperationType(OperationType  operation_type)
{
	this->operation_type = operation_type;
}

std::list<std::string>
BusinessToBusinessSharedAudienceUpdateWithRequiredBody::getRecipientBusinessIds()
{
	return recipient_business_ids;
}

void
BusinessToBusinessSharedAudienceUpdateWithRequiredBody::setRecipientBusinessIds(std::list <std::string> recipient_business_ids)
{
