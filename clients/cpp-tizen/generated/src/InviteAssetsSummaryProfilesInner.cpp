...
void
InviteAssetsSummary_profiles_inner::__init()
{
	//id = std::string();
...
void
InviteAssetsSummary_profiles_inner::__cleanup()
{
	//if(id != NULL) {
	//
	//delete id;
...
void
InviteAssetsSummary_profiles_inner::fromJson(char* jsonStr)
{
...
InviteAssetsSummary_profiles_inner::InviteAssetsSummary_profiles_inner(char* json)
{
	this->fromJson(json);
}
