...
void
Catalogs_product_group_pins_list_200_response::__init()
{
...
void
Catalogs_product_group_pins_list_200_response::__cleanup()
{
	//if(items != NULL) {
...
void
Catalogs_product_group_pins_list_200_response::fromJson(char* jsonStr)
{
...
Catalogs_product_group_pins_list_200_response::Catalogs_product_group_pins_list_200_response(char* json)
{
	this->fromJson(json);
}
