...
void
CatalogsReportAllItemsFilter::__init()
{
...
void
CatalogsReportAllItemsFilter::__cleanup()
{
	//if(catalog_id != NULL) {
	//
	//delete catalog_id;
...
void
CatalogsReportAllItemsFilter::fromJson(char* jsonStr)
{
...
CatalogsReportAllItemsFilter::CatalogsReportAllItemsFilter(char* json)
{
	this->fromJson(json);
}
