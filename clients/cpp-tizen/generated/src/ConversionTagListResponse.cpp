...
void
ConversionTagListResponse::__init()
{
	//new std::list()std::list> items;
}

void
ConversionTagListResponse::__cleanup()
{
	//if(items != NULL) {
...
void
ConversionTagListResponse::fromJson(char* jsonStr)
{
...
ConversionTagListResponse::ConversionTagListResponse(char* json)
{
	this->fromJson(json);
}
