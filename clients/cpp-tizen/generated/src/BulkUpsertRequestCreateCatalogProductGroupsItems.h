/*
 * BulkUpsertRequestCreateCatalogProductGroupsItems.h
 *
 * 
 */

#ifndef _BulkUpsertRequestCreateCatalogProductGroupsItems_H_
#define _BulkUpsertRequestCreateCatalogProductGroupsItems_H_
...
class BulkUpsertRequestCreateCatalogProductGroupsItems : public Object {
public:
	/*! \brief Constructor.
	 */
	BulkUpsertRequestCreateCatalogProductGroupsItems();
	BulkUpsertRequestCreateCatalogProductGroupsItems(char* str);

	/*! \brief Destructor.
	 */
	virtual ~BulkUpsertRequestCreateCatalogProductGroupsItems();
...
#endif /* _BulkUpsertRequestCreateCatalogProductGroupsItems_H_ */
