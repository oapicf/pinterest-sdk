...
void
ScheduleAppTypeMultipliers::__init()
{
	//aPP_TYPE = new TargetingSpecAppType();
}

void
ScheduleAppTypeMultipliers::__cleanup()
{
	//if(aPP_TYPE != NULL) {
	//
	//delete aPP_TYPE;
...
void
ScheduleAppTypeMultipliers::fromJson(char* jsonStr)
{
...
ScheduleAppTypeMultipliers::ScheduleAppTypeMultipliers(char* json)
{
	this->fromJson(json);
}
