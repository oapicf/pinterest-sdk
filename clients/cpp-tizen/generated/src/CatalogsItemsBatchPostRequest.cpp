...
void
CatalogsItemsBatchPostRequest::__init()
{
	//catalog_id = null;
...
void
CatalogsItemsBatchPostRequest::__cleanup()
{
	//if(catalog_id != NULL) {
	//
	//delete catalog_id;
...
void
CatalogsItemsBatchPostRequest::fromJson(char* jsonStr)
{
...
CatalogsItemsBatchPostRequest::CatalogsItemsBatchPostRequest(char* json)
{
	this->fromJson(json);
}
