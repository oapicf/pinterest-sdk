...
void
BusinessMembershipMember::__init()
{
...
void
BusinessMembershipMember::__cleanup()
{
...
void
BusinessMembershipMember::fromJson(char* jsonStr)
{
...
BusinessMembershipMember::BusinessMembershipMember(char* json)
{
	this->fromJson(json);
}
