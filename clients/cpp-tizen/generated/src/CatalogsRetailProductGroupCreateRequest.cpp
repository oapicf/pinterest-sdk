...
void
CatalogsRetailProductGroupCreateRequest::fromJson(char* jsonStr)
{
...
CatalogsRetailProductGroupCreateRequest::CatalogsRetailProductGroupCreateRequest(char* json)
{
	this->fromJson(json);
}
