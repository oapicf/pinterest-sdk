...
#ifndef _AdvancedAuctionItemsGetRecord_H_
#define _AdvancedAuctionItemsGetRecord_H_
...
class AdvancedAuctionItemsGetRecord : public Object {
public:
	/*! \brief Constructor.
	 */
	AdvancedAuctionItemsGetRecord();
	AdvancedAuctionItemsGetRecord(char* str);
...
#endif /* _AdvancedAuctionItemsGetRecord_H_ */
