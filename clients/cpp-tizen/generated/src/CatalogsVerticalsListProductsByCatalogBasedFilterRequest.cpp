...
void
CatalogsVerticalsListProductsByCatalogBasedFilterRequest::__init()
{
...
void
CatalogsVerticalsListProductsByCatalogBasedFilterRequest::__cleanup()
{
...
void
CatalogsVerticalsListProductsByCatalogBasedFilterRequest::fromJson(char* jsonStr)
{
...
CatalogsVerticalsListProductsByCatalogBasedFilterRequest::CatalogsVerticalsListProductsByCatalogBasedFilterRequest(char* json)
{
	this->fromJson(json);
}
