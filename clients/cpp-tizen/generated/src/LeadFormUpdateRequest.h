...
#ifndef _LeadFormUpdateRequest_H_
#define _LeadFormUpdateRequest_H_
...
class LeadFormUpdateRequest : public Object {
public:
	/*! \brief Constructor.
	 */
	LeadFormUpdateRequest();
	LeadFormUpdateRequest(char* str);
...
#endif /* _LeadFormUpdateRequest_H_ */
