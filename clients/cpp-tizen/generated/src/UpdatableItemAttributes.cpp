...
void
UpdatableItemAttributes::__init()
{
...
void
UpdatableItemAttributes::__cleanup()
{
...
void
UpdatableItemAttributes::fromJson(char* jsonStr)
{
...
UpdatableItemAttributes::UpdatableItemAttributes(char* json)
{
	this->fromJson(json);
}
...
bool
UpdatableItemAttributes::getAdult()
{
	return adult;
}
...
void
UpdatableItemAttributes::setAverageReviewRating(long long  average_review_rating)
{
...
bool
UpdatableItemAttributes::getCheckoutEnabled()
{
...
bool
UpdatableItemAttributes::getFreeShippingLabel()
{
...
void
UpdatableItemAttributes::setLastUpdatedTime(long long  last_updated_time)
{
