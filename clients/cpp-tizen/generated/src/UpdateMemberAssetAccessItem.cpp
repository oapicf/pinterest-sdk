...
void
UpdateMemberAssetAccessItem::__init()
{
	//asset_id = std::string();
...
void
UpdateMemberAssetAccessItem::__cleanup()
{
	//if(asset_id != NULL) {
	//
	//delete asset_id;
...
void
UpdateMemberAssetAccessItem::fromJson(char* jsonStr)
{
...
UpdateMemberAssetAccessItem::UpdateMemberAssetAccessItem(char* json)
{
	this->fromJson(json);
}
