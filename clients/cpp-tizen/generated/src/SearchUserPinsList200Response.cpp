...
void
Search_user_pins_list_200_response::__init()
{
	//bookmark = std::string();
...
void
Search_user_pins_list_200_response::__cleanup()
{
	//if(bookmark != NULL) {
	//
	//delete bookmark;
...
void
Search_user_pins_list_200_response::fromJson(char* jsonStr)
{
...
Search_user_pins_list_200_response::Search_user_pins_list_200_response(char* json)
{
	this->fromJson(json);
}
