...
void
CampaignCreateResponse::__init()
{
	//new std::list()std::list> items;
}

void
CampaignCreateResponse::__cleanup()
{
	//if(items != NULL) {
...
void
CampaignCreateResponse::fromJson(char* jsonStr)
{
...
CampaignCreateResponse::CampaignCreateResponse(char* json)
{
	this->fromJson(json);
}
