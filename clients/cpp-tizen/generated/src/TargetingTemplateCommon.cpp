...
void
TargetingTemplateCommon::__init()
{
	//name = std::string();
...
void
TargetingTemplateCommon::__cleanup()
{
	//if(name != NULL) {
	//
	//delete name;
...
void
TargetingTemplateCommon::fromJson(char* jsonStr)
{
...
TargetingTemplateCommon::TargetingTemplateCommon(char* json)
{
	this->fromJson(json);
}
...
bool
TargetingTemplateCommon::getAutoTargetingEnabled()
{
