...
void
ConversionEventsUserDataProperties::__init()
{
	//click_id = std::string();
...
void
ConversionEventsUserDataProperties::__cleanup()
{
	//if(click_id != NULL) {
	//
	//delete click_id;
...
void
ConversionEventsUserDataProperties::fromJson(char* jsonStr)
{
...
ConversionEventsUserDataProperties::ConversionEventsUserDataProperties(char* json)
{
	this->fromJson(json);
}
