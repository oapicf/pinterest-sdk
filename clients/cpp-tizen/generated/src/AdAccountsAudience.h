...
#ifndef _AdAccountsAudience_H_
#define _AdAccountsAudience_H_
...
class AdAccountsAudience : public Object {
public:
	/*! \brief Constructor.
	 */
	AdAccountsAudience();
	AdAccountsAudience(char* str);
