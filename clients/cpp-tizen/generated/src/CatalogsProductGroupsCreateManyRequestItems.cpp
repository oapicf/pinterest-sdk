...
void
CatalogsProductGroupsCreateManyRequestItems::__init()
{
...
void
CatalogsProductGroupsCreateManyRequestItems::__cleanup()
{
	//if(description != NULL) {
	//
	//delete description;
...
void
CatalogsProductGroupsCreateManyRequestItems::fromJson(char* jsonStr)
{
...
CatalogsProductGroupsCreateManyRequestItems::CatalogsProductGroupsCreateManyRequestItems(char* json)
{
	this->fromJson(json);
}
...
bool
CatalogsProductGroupsCreateManyRequestItems::getIsFeatured()
{
	return is_featured;
}
