...
void
Billing_invoices_get_200_response::__init()
{
	//bookmark = std::string();
...
void
Billing_invoices_get_200_response::__cleanup()
{
	//if(bookmark != NULL) {
	//
	//delete bookmark;
...
void
Billing_invoices_get_200_response::fromJson(char* jsonStr)
{
...
Billing_invoices_get_200_response::Billing_invoices_get_200_response(char* json)
{
	this->fromJson(json);
}
