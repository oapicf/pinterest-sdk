...
void
LeadFormCreate::fromJson(char* jsonStr)
{
...
LeadFormCreate::LeadFormCreate(char* json)
{
	this->fromJson(json);
}

char*
LeadFormCreate::toJson()
{
...
std::string
LeadFormCreate::getCompletionMessage()
{
	return completion_message;
}

void
LeadFormCreate::setCompletionMessage(std::string  completion_message)
{
	this->completion_message = completion_message;
}

std::string
LeadFormCreate::getDisclosureLanguage()
{
	return disclosure_language;
}

void
LeadFormCreate::setDisclosureLanguage(std::string  disclosure_language)
{
	this->disclosure_language = disclosure_language;
}

bool
LeadFormCreate::getHasAcceptedTerms()
{
	return has_accepted_terms;
}

void
LeadFormCreate::setHasAcceptedTerms(bool  has_accepted_terms)
{
	this->has_accepted_terms = has_accepted_terms;
}

std::string
LeadFormCreate::getName()
{
	return name;
}

void
LeadFormCreate::setName(std::string  name)
{
	this->name = name;
}

std::list<LeadFormPolicyLink>
LeadFormCreate::getPolicyLinks()
{
	return policy_links;
}

void
LeadFormCreate::setPolicyLinks(std::list <LeadFormPolicyLink> policy_links)
{
	this->policy_links = policy_links;
}

std::string
LeadFormCreate::getPrivacyPolicyLink()
{
	return privacy_policy_link;
}

void
LeadFormCreate::setPrivacyPolicyLink(std::string  privacy_policy_link)
{
	this->privacy_policy_link = privacy_policy_link;
}

std::list<LeadFormQuestion>
LeadFormCreate::getQuestions()
{
	return questions;
}

void
LeadFormCreate::setQuestions(std::list <LeadFormQuestion> questions)
{
	this->questions = questions;
}

LeadFormStatus
LeadFormCreate::getStatus()
{
	return status;
}

void
LeadFormCreate::setStatus(LeadFormStatus  status)
{
	this->status = status;
}
