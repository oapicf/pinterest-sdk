...
void
CatalogsProductGroupsUpdateRequestSchema::__init()
{
...
void
CatalogsProductGroupsUpdateRequestSchema::__cleanup()
{
	//if(description != NULL) {
	//
	//delete description;
...
void
CatalogsProductGroupsUpdateRequestSchema::fromJson(char* jsonStr)
{
...
CatalogsProductGroupsUpdateRequestSchema::CatalogsProductGroupsUpdateRequestSchema(char* json)
{
	this->fromJson(json);
}
...
bool
CatalogsProductGroupsUpdateRequestSchema::getIsFeatured()
{
	return is_featured;
}
