...
void
LocalInventoryCreateOperation::__init()
{
...
void
LocalInventoryCreateOperation::__cleanup()
{
	//if(attributes != NULL) {
	//
	//delete attributes;
...
void
LocalInventoryCreateOperation::fromJson(char* jsonStr)
{
...
LocalInventoryCreateOperation::LocalInventoryCreateOperation(char* json)
{
	this->fromJson(json);
}
