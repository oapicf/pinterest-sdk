...
void
TargetingSpecOperationAudienceExclude::__init()
{
	//field = std::string();
...
void
TargetingSpecOperationAudienceExclude::__cleanup()
{
	//if(field != NULL) {
	//
	//delete field;
...
void
TargetingSpecOperationAudienceExclude::fromJson(char* jsonStr)
{
...
TargetingSpecOperationAudienceExclude::TargetingSpecOperationAudienceExclude(char* json)
{
	this->fromJson(json);
}
