...
#ifndef _CatalogsCreativeAssetsItemsFilter_H_
#define _CatalogsCreativeAssetsItemsFilter_H_
...
class CatalogsCreativeAssetsItemsFilter : public Object {
public:
	/*! \brief Constructor.
	 */
	CatalogsCreativeAssetsItemsFilter();
	CatalogsCreativeAssetsItemsFilter(char* str);
...
#endif /* _CatalogsCreativeAssetsItemsFilter_H_ */
