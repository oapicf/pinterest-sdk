...
#ifndef _AdUpdateRequest_inner_H_
#define _AdUpdateRequest_inner_H_
...
class AdUpdateRequest_inner : public Object {
public:
	/*! \brief Constructor.
	 */
	AdUpdateRequest_inner();
	AdUpdateRequest_inner(char* str);

	/*! \brief Destructor.
	 */
	virtual ~AdUpdateRequest_inner();
...
#endif /* _AdUpdateRequest_inner_H_ */
