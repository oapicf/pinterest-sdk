...
void
CatalogsHotelItemsPostFilter::__init()
{
...
void
CatalogsHotelItemsPostFilter::__cleanup()
{
...
void
CatalogsHotelItemsPostFilter::fromJson(char* jsonStr)
{
...
CatalogsHotelItemsPostFilter::CatalogsHotelItemsPostFilter(char* json)
{
	this->fromJson(json);
}
