...
void
AdCreateRequest_inner::__cleanup()
{
	//if(ad_group_id != NULL) {
	//
	//delete ad_group_id;
...
void
AdCreateRequest_inner::fromJson(char* jsonStr)
{
...
AdCreateRequest_inner::AdCreateRequest_inner(char* json)
{
	this->fromJson(json);
}

char*
AdCreateRequest_inner::toJson()
{
...
std::string
AdCreateRequest_inner::getAdGroupId()
{
	return ad_group_id;
}

void
AdCreateRequest_inner::setAdGroupId(std::string  ad_group_id)
{
	this->ad_group_id = ad_group_id;
}

std::string
AdCreateRequest_inner::getAndroidDeepLink()
{
	return android_deep_link;
}

void
AdCreateRequest_inner::setAndroidDeepLink(std::string  android_deep_link)
{
	this->android_deep_link = android_deep_link;
}

std::list<std::string>
AdCreateRequest_inner::getCarouselAndroidDeepLinks()
{
	return carousel_android_deep_links;
}

void
AdCreateRequest_inner::setCarouselAndroidDeepLinks(std::list <std::string> carousel_android_deep_links)
{
	this->carousel_android_deep_links = carousel_android_deep_links;
}

std::list<std::string>
AdCreateRequest_inner::getCarouselDestinationUrls()
{
	return carousel_destination_urls;
}

void
AdCreateRequest_inner::setCarouselDestinationUrls(std::list <std::string> carousel_destination_urls)
{
	this->carousel_destination_urls = carousel_destination_urls;
}

std::list<std::string>
AdCreateRequest_inner::getCarouselIosDeepLinks()
{
	return carousel_ios_deep_links;
}

void
AdCreateRequest_inner::setCarouselIosDeepLinks(std::list <std::string> carousel_ios_deep_links)
{
	this->carousel_ios_deep_links = carousel_ios_deep_links;
}

std::string
AdCreateRequest_inner::getClickTrackingUrl()
{
	return click_tracking_url;
}

void
AdCreateRequest_inner::setClickTrackingUrl(std::string  click_tracking_url)
{
	this->click_tracking_url = click_tracking_url;
}

CreativeType
AdCreateRequest_inner::getCreativeType()
{
	return creative_type;
}

void
AdCreateRequest_inner::setCreativeType(CreativeType  creative_type)
{
	this->creative_type = creative_type;
}

std::string
AdCreateRequest_inner::getDestinationUrl()
{
	return destination_url;
}

void
AdCreateRequest_inner::setDestinationUrl(std::string  destination_url)
{
	this->destination_url = destination_url;
}

std::string
AdCreateRequest_inner::getIosDeepLink()
{
	return ios_deep_link;
}

void
AdCreateRequest_inner::setIosDeepLink(std::string  ios_deep_link)
{
	this->ios_deep_link = ios_deep_link;
}

bool
AdCreateRequest_inner::getIsPinDeleted()
{
	return is_pin_deleted;
}

void
AdCreateRequest_inner::setIsPinDeleted(bool  is_pin_deleted)
{
	this->is_pin_deleted = is_pin_deleted;
}

bool
AdCreateRequest_inner::getIsRemovable()
{
	return is_removable;
}

void
AdCreateRequest_inner::setIsRemovable(bool  is_removable)
{
	this->is_removable = is_removable;
}

std::string
AdCreateRequest_inner::getName()
{
	return name;
}

void
AdCreateRequest_inner::setName(std::string  name)
{
	this->name = name;
}

std::string
AdCreateRequest_inner::getPinId()
{
	return pin_id;
}

void
AdCreateRequest_inner::setPinId(std::string  pin_id)
{
	this->pin_id = pin_id;
}

EntityStatus
AdCreateRequest_inner::getStatus()
{
	return status;
}

void
AdCreateRequest_inner::setStatus(EntityStatus  status)
{
	this->status = status;
}

AdCommon_tracking_urls
AdCreateRequest_inner::getTrackingUrls()
{
	return tracking_urls;
}

void
AdCreateRequest_inner::setTrackingUrls(AdCommon_tracking_urls  tracking_urls)
{
	this->tracking_urls = tracking_urls;
}

std::string
AdCreateRequest_inner::getViewTrackingUrl()
{
	return view_tracking_url;
}

void
AdCreateRequest_inner::setViewTrackingUrl(std::string  view_tracking_url)
{
