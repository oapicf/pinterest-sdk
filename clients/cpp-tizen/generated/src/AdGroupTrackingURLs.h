...
#ifndef _AdGroupTrackingURLs_H_
#define _AdGroupTrackingURLs_H_
...
class AdGroupTrackingURLs : public Object {
public:
	/*! \brief Constructor.
	 */
	AdGroupTrackingURLs();
	AdGroupTrackingURLs(char* str);
