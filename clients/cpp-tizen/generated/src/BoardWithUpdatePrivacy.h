...
#ifndef _BoardWithUpdatePrivacy_H_
#define _BoardWithUpdatePrivacy_H_
...
class BoardWithUpdatePrivacy : public Object {
public:
	/*! \brief Constructor.
	 */
	BoardWithUpdatePrivacy();
	BoardWithUpdatePrivacy(char* str);
...
#endif /* _BoardWithUpdatePrivacy_H_ */
