...
#ifndef _CatalogsCreativeAssetsAttributes_H_
#define _CatalogsCreativeAssetsAttributes_H_
...
class CatalogsCreativeAssetsAttributes : public Object {
public:
	/*! \brief Constructor.
	 */
	CatalogsCreativeAssetsAttributes();
	CatalogsCreativeAssetsAttributes(char* str);
...
#endif /* _CatalogsCreativeAssetsAttributes_H_ */
