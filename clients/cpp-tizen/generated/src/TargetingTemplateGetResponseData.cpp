...
void
TargetingTemplateGetResponseData::__init()
{
	//name = std::string();
...
void
TargetingTemplateGetResponseData::__cleanup()
{
	//if(name != NULL) {
	//
	//delete name;
...
void
TargetingTemplateGetResponseData::fromJson(char* jsonStr)
{
...
TargetingTemplateGetResponseData::TargetingTemplateGetResponseData(char* json)
{
	this->fromJson(json);
}

char*
TargetingTemplateGetResponseData::toJson()
{
...
std::string
TargetingTemplateGetResponseData::getName()
{
	return name;
}

void
TargetingTemplateGetResponseData::setName(std::string  name)
{
	this->name = name;
}

bool
TargetingTemplateGetResponseData::getAutoTargetingEnabled()
{
	return auto_targeting_enabled;
}

void
TargetingTemplateGetResponseData::setAutoTargetingEnabled(bool  auto_targeting_enabled)
{
	this->auto_targeting_enabled = auto_targeting_enabled;
}

TargetingSpec
TargetingTemplateGetResponseData::getTargetingAttributes()
{
	return targeting_attributes;
}

void
TargetingTemplateGetResponseData::setTargetingAttributes(TargetingSpec  targeting_attributes)
{
	this->targeting_attributes = targeting_attributes;
}

PlacementGroupType
TargetingTemplateGetResponseData::getPlacementGroup()
{
	return placement_group;
}

void
TargetingTemplateGetResponseData::setPlacementGroup(PlacementGroupType  placement_group)
{
	this->placement_group = placement_group;
}

std::list<TargetingTemplateKeyword>
TargetingTemplateGetResponseData::getKeywords()
{
	return keywords;
}

void
TargetingTemplateGetResponseData::setKeywords(std::list <TargetingTemplateKeyword> keywords)
{
	this->keywords = keywords;
}

TrackingUrls
TargetingTemplateGetResponseData::getTrackingUrls()
{
	return tracking_urls;
}

void
TargetingTemplateGetResponseData::setTrackingUrls(TrackingUrls  tracking_urls)
{
	this->tracking_urls = tracking_urls;
}

std::string
TargetingTemplateGetResponseData::getId()
{
	return id;
}

void
TargetingTemplateGetResponseData::setId(std::string  id)
{
	this->id = id;
}

int
TargetingTemplateGetResponseData::getCreatedTime()
{
	return created_time;
}

void
TargetingTemplateGetResponseData::setCreatedTime(int  created_time)
{
	this->created_time = created_time;
}

int
TargetingTemplateGetResponseData::getUpdatedTime()
{
	return updated_time;
}

void
TargetingTemplateGetResponseData::setUpdatedTime(int  updated_time)
{
	this->updated_time = updated_time;
}

std::string
TargetingTemplateGetResponseData::getAdAccountId()
{
	return ad_account_id;
}

void
TargetingTemplateGetResponseData::setAdAccountId(std::string  ad_account_id)
{
	this->ad_account_id = ad_account_id;
}

std::string
TargetingTemplateGetResponseData::getStatus()
{
	return status;
}

void
TargetingTemplateGetResponseData::setStatus(std::string  status)
{
	this->status = status;
}

TargetingTemplateAudienceSizing
TargetingTemplateGetResponseData::getSizing()
{
	return sizing;
}

void
TargetingTemplateGetResponseData::setSizing(TargetingTemplateAudienceSizing  sizing)
{
	this->sizing = sizing;
}

bool
TargetingTemplateGetResponseData::getValid()
{
	return valid;
}

void
TargetingTemplateGetResponseData::setValid(bool  valid)
{
	this->valid = valid;
}
