...
#ifndef _TargetingSpecOptimal_H_
#define _TargetingSpecOptimal_H_
...
class TargetingSpecOptimal : public Object {
public:
	/*! \brief Constructor.
	 */
	TargetingSpecOptimal();
	TargetingSpecOptimal(char* str);
...
#endif /* _TargetingSpecOptimal_H_ */
