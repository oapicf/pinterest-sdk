...
void
BusinessToBusinessSharedAudience::__init()
{
	//audience_id = null;
...
void
BusinessToBusinessSharedAudience::__cleanup()
{
	//if(audience_id != NULL) {
	//
	//delete audience_id;
...
void
BusinessToBusinessSharedAudience::fromJson(char* jsonStr)
{
...
BusinessToBusinessSharedAudience::BusinessToBusinessSharedAudience(char* json)
{
	this->fromJson(json);
}
