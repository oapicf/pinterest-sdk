...
void
CatalogsProductGroupFiltersAllOfRequest_anyOf::__init()
{
	//new std::list()std::list> any_of;
}

void
CatalogsProductGroupFiltersAllOfRequest_anyOf::__cleanup()
{
	//if(any_of != NULL) {
...
void
CatalogsProductGroupFiltersAllOfRequest_anyOf::fromJson(char* jsonStr)
{
...
CatalogsProductGroupFiltersAllOfRequest_anyOf::CatalogsProductGroupFiltersAllOfRequest_anyOf(char* json)
{
	this->fromJson(json);
}

char*
CatalogsProductGroupFiltersAllOfRequest_anyOf::toJson()
{
...
CatalogsProductGroupFiltersAllOfRequest_anyOf::getAnyOf()
{
	return any_of;
}

void
CatalogsProductGroupFiltersAllOfRequest_anyOf::setAnyOf(std::list <CatalogsProductGroupFilterKeys> any_of)
{
	this->any_of = any_of;
}
