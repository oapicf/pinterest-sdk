...
void
BulkUpsertRequestUpdateCatalogProductGroupsItems::__init()
{
...
void
BulkUpsertRequestUpdateCatalogProductGroupsItems::__cleanup()
{
	//if(description != NULL) {
	//
	//delete description;
...
void
BulkUpsertRequestUpdateCatalogProductGroupsItems::fromJson(char* jsonStr)
{
...
BulkUpsertRequestUpdateCatalogProductGroupsItems::BulkUpsertRequestUpdateCatalogProductGroupsItems(char* json)
{
	this->fromJson(json);
}
...
bool
BulkUpsertRequestUpdateCatalogProductGroupsItems::getIsFeatured()
{
	return is_featured;
}
