...
static gboolean __ProductCategoriesManagerresponseHandler(gpointer data)
{
...
static gpointer __ProductCategoriesManagerthreadFunc(gpointer data)
{
	RequestInfo *request = static_cast<RequestInfo*>(data);
	...
	g_idle_add(__ProductCategoriesManagerresponseHandler, static_cast<gpointer>(request));
	...
	, void* userData, bool isAsync)
{
	...
	if(!isAsync){
		NetClient::easycurl(ProductCategoriesManager::getBasePath(), url, myhttpmethod, queryParams,
		...
		requestInfo = new(nothrow) RequestInfo (ProductCategoriesManager::getBasePath(), url, myhttpmethod, queryParams,
			mBody, headerList, p_chunk, &code, errormsg, userData, reinterpret_cast<void(*)()>(handler), trendsFeaturedTopicsListProcessor);;
		if(requestInfo == NULL)
			return false;

		thread = g_thread_new(NULL, __ProductCategoriesManagerthreadFunc, static_cast<gpointer>(requestInfo));
		return true;
	}
}
...
bool ProductCategoriesManager::trendsFeaturedTopicsListAsync(char * accessToken,
	ProductCategoryRegion region, InterestsEnum interest, 
	void(* handler)(std::list<FeaturedTrend>, Error, void* )
	, void* userData)
{
...
bool ProductCategoriesManager::trendsFeaturedTopicsListSync(char * accessToken,
	ProductCategoryRegion region, InterestsEnum interest, 
	void(* handler)(std::list<FeaturedTrend>, Error, void* )
	, void* userData)
{
...
bool ProductCategoriesManager::trendsProductCategoriesDetailsListAsync(char * accessToken,
	std::list<ProductCategoryEnum> productCategories, ProductCategoryRegion region, ProductCategoryDetailLookbackWindow lookbackWindow, ProductCategoriesEngagementType engagementType, 
	void(* handler)(std::list<ProductCategoryDetails>, Error, void* )
	, void* userData)
{
...
bool ProductCategoriesManager::trendsProductCategoriesDetailsListSync(char * accessToken,
	std::list<ProductCategoryEnum> productCategories, ProductCategoryRegion region, ProductCategoryDetailLookbackWindow lookbackWindow, ProductCategoriesEngagementType engagementType, 
	void(* handler)(std::list<ProductCategoryDetails>, Error, void* )
	, void* userData)
{
...
bool ProductCategoriesManager::trendsProductCategoriesTrendingListAsync(char * accessToken,
	ProductCategoryRegion region, std::list<VerticalProductCategory> verticals, std::list<AgeTrendsBucket> ages, std::list<GenderBucket> genders, ProductCategoriesEngagementType engagementType, 
	void(* handler)(std::list<TrendingProductCategory>, Error, void* )
	, void* userData)
{
...
bool ProductCategoriesManager::trendsProductCategoriesTrendingListSync(char * accessToken,
	ProductCategoryRegion region, std::list<VerticalProductCategory> verticals, std::list<AgeTrendsBucket> ages, std::list<GenderBucket> genders, ProductCategoriesEngagementType engagementType, 
	void(* handler)(std::list<TrendingProductCategory>, Error, void* )
	, void* userData)
{
