...
void
CatalogsUpdateCreativeAssetsItem::__init()
{
...
void
CatalogsUpdateCreativeAssetsItem::__cleanup()
{
...
void
CatalogsUpdateCreativeAssetsItem::fromJson(char* jsonStr)
{
...
CatalogsUpdateCreativeAssetsItem::CatalogsUpdateCreativeAssetsItem(char* json)
{
	this->fromJson(json);
}
