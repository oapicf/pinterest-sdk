...
void
PromotionCreateRequest::__cleanup()
{
...
void
PromotionCreateRequest::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
		...
		if (isprimitive("std::string")) {
			jsonToValue(&discount_status, node, "std::string", "");
		} else {
...
PromotionCreateRequest::PromotionCreateRequest(char* json)
{
	this->fromJson(json);
}
...
PromotionCreateRequest::toJson()
{
	...
	JsonNode *node;
	if (isprimitive("std::string")) {
		std::string obj = getDiscountStatus();
