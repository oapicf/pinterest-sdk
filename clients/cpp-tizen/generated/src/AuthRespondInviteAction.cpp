...
void
AuthRespondInviteAction::__init()
{
...
void
AuthRespondInviteAction::__cleanup()
{
...
void
AuthRespondInviteAction::fromJson(char* jsonStr)
{
...
AuthRespondInviteAction::AuthRespondInviteAction(char* json)
{
	this->fromJson(json);
}
...
bool
AuthRespondInviteAction::getAcceptInvite()
{
...
void
AuthRespondInviteAction::setAssetIdToPermissions(std::map <string, string> asset_id_to_permissions)
{
