...
void
CatalogsCreativeAssetsItemsPostFilter::__init()
{
...
void
CatalogsCreativeAssetsItemsPostFilter::__cleanup()
{
...
void
CatalogsCreativeAssetsItemsPostFilter::fromJson(char* jsonStr)
{
...
CatalogsCreativeAssetsItemsPostFilter::CatalogsCreativeAssetsItemsPostFilter(char* json)
{
	this->fromJson(json);
}
