...
void
Feeds_create_request::__cleanup()
{
...
void
Feeds_create_request::fromJson(char* jsonStr)
{
...
Feeds_create_request::Feeds_create_request(char* json)
{
	this->fromJson(json);
}
