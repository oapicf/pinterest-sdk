...
#ifndef _BrandAccountUpdate_H_
#define _BrandAccountUpdate_H_
...
class BrandAccountUpdate : public Object {
public:
	/*! \brief Constructor.
	 */
	BrandAccountUpdate();
	BrandAccountUpdate(char* str);
