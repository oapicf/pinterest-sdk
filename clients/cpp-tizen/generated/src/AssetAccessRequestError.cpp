...
void
AssetAccessRequestError::__init()
{
	//code = int(0);
...
void
AssetAccessRequestError::__cleanup()
{
	//if(code != NULL) {
	//
	//delete code;
...
void
AssetAccessRequestError::fromJson(char* jsonStr)
{
...
AssetAccessRequestError::AssetAccessRequestError(char* json)
{
	this->fromJson(json);
}
