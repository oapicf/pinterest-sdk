...
void
TargetingSpecOperationInterest::__init()
{
	//field = std::string();
...
void
TargetingSpecOperationInterest::__cleanup()
{
	//if(field != NULL) {
	//
	//delete field;
...
void
TargetingSpecOperationInterest::fromJson(char* jsonStr)
{
...
TargetingSpecOperationInterest::TargetingSpecOperationInterest(char* json)
{
	this->fromJson(json);
}
