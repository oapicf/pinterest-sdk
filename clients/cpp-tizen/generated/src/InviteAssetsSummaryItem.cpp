...
void
InviteAssetsSummaryItem::__init()
{
	//id = std::string();
...
void
InviteAssetsSummaryItem::__cleanup()
{
	//if(id != NULL) {
	//
	//delete id;
...
void
InviteAssetsSummaryItem::fromJson(char* jsonStr)
{
...
InviteAssetsSummaryItem::InviteAssetsSummaryItem(char* json)
{
	this->fromJson(json);
}
