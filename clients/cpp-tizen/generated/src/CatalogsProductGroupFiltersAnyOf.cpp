...
void
CatalogsProductGroupFiltersAnyOf::__init()
{
	//new std::list()std::list> any_of;
}

void
CatalogsProductGroupFiltersAnyOf::__cleanup()
{
	//if(any_of != NULL) {
...
void
CatalogsProductGroupFiltersAnyOf::fromJson(char* jsonStr)
{
...
CatalogsProductGroupFiltersAnyOf::CatalogsProductGroupFiltersAnyOf(char* json)
{
	this->fromJson(json);
}
