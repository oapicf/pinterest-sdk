...
#ifndef _AdvancedAuctionKey_H_
#define _AdvancedAuctionKey_H_
...
class AdvancedAuctionKey : public Object {
public:
	/*! \brief Constructor.
	 */
	AdvancedAuctionKey();
	AdvancedAuctionKey(char* str);
