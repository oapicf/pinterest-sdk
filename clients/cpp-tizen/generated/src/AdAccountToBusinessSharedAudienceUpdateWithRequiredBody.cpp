...
void
AdAccountToBusinessSharedAudienceUpdateWithRequiredBody::__init()
{
	//audience_id = null;
...
void
AdAccountToBusinessSharedAudienceUpdateWithRequiredBody::__cleanup()
{
	//if(audience_id != NULL) {
	//
	//delete audience_id;
...
void
AdAccountToBusinessSharedAudienceUpdateWithRequiredBody::fromJson(char* jsonStr)
{
...
AdAccountToBusinessSharedAudienceUpdateWithRequiredBody::AdAccountToBusinessSharedAudienceUpdateWithRequiredBody(char* json)
{
	this->fromJson(json);
}

char*
AdAccountToBusinessSharedAudienceUpdateWithRequiredBody::toJson()
{
...
std::string
AdAccountToBusinessSharedAudienceUpdateWithRequiredBody::getAudienceId()
{
	return audience_id;
}

void
AdAccountToBusinessSharedAudienceUpdateWithRequiredBody::setAudienceId(std::string  audience_id)
{
	this->audience_id = audience_id;
}

OperationType
AdAccountToBusinessSharedAudienceUpdateWithRequiredBody::getOperationType()
{
	return operation_type;
}

void
AdAccountToBusinessSharedAudienceUpdateWithRequiredBody::setOperationType(OperationType  operation_type)
{
	this->operation_type = operation_type;
}

std::list<std::string>
AdAccountToBusinessSharedAudienceUpdateWithRequiredBody::getRecipientBusinessIds()
{
	return recipient_business_ids;
}

void
AdAccountToBusinessSharedAudienceUpdateWithRequiredBody::setRecipientBusinessIds(std::list <std::string> recipient_business_ids)
{
