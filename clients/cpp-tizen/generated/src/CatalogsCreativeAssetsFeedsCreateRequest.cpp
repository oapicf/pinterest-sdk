...
void
CatalogsCreativeAssetsFeedsCreateRequest::__init()
{
...
void
CatalogsCreativeAssetsFeedsCreateRequest::__cleanup()
{
...
void
CatalogsCreativeAssetsFeedsCreateRequest::fromJson(char* jsonStr)
{
...
CatalogsCreativeAssetsFeedsCreateRequest::CatalogsCreativeAssetsFeedsCreateRequest(char* json)
{
	this->fromJson(json);
}
