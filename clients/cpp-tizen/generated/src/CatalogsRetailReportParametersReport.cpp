...
void
CatalogsRetailReportParametersReport::__init()
{
	//feed_id = std::string();
...
void
CatalogsRetailReportParametersReport::__cleanup()
{
	//if(feed_id != NULL) {
	//
	//delete feed_id;
...
void
CatalogsRetailReportParametersReport::fromJson(char* jsonStr)
{
...
CatalogsRetailReportParametersReport::CatalogsRetailReportParametersReport(char* json)
{
	this->fromJson(json);
}
