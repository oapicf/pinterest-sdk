...
void
AssetGroupDeletionDelete::__init()
{
	//new std::list()std::list> asset_groups_to_delete;
}

void
AssetGroupDeletionDelete::__cleanup()
{
...
void
AssetGroupDeletionDelete::fromJson(char* jsonStr)
{
...
AssetGroupDeletionDelete::AssetGroupDeletionDelete(char* json)
{
	this->fromJson(json);
}
