...
void
AssetGroupUpdateItemReadOrUpdateItem::__init()
{
...
void
AssetGroupUpdateItemReadOrUpdateItem::__cleanup()
{
...
void
AssetGroupUpdateItemReadOrUpdateItem::fromJson(char* jsonStr)
{
...
AssetGroupUpdateItemReadOrUpdateItem::AssetGroupUpdateItemReadOrUpdateItem(char* json)
{
	this->fromJson(json);
}
