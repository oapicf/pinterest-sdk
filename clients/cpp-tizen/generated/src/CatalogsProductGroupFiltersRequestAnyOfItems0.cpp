...
void
CatalogsProductGroupFiltersRequestAnyOfItems0::__init()
{
	//new std::list()std::list> any_of;
}

void
CatalogsProductGroupFiltersRequestAnyOfItems0::__cleanup()
{
	//if(any_of != NULL) {
...
void
CatalogsProductGroupFiltersRequestAnyOfItems0::fromJson(char* jsonStr)
{
...
CatalogsProductGroupFiltersRequestAnyOfItems0::CatalogsProductGroupFiltersRequestAnyOfItems0(char* json)
{
	this->fromJson(json);
}
