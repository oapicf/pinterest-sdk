...
void
UserWebsiteVerification::__init()
{
...
void
UserWebsiteVerification::__cleanup()
{
...
void
UserWebsiteVerification::fromJson(char* jsonStr)
{
...
UserWebsiteVerification::UserWebsiteVerification(char* json)
{
	this->fromJson(json);
}
