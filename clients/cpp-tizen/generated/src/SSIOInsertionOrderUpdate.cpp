...
void
SSIOInsertionOrderUpdate::__init()
{
...
void
SSIOInsertionOrderUpdate::__cleanup()
{
...
void
SSIOInsertionOrderUpdate::fromJson(char* jsonStr)
{
...
SSIOInsertionOrderUpdate::SSIOInsertionOrderUpdate(char* json)
{
	this->fromJson(json);
}
