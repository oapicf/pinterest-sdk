...
void
Ad_groups_list_200_response::__init()
{
...
void
Ad_groups_list_200_response::__cleanup()
{
	//if(items != NULL) {
...
void
Ad_groups_list_200_response::fromJson(char* jsonStr)
{
...
Ad_groups_list_200_response::Ad_groups_list_200_response(char* json)
{
	this->fromJson(json);
}
