...
void
ProductGroupPromotions::__init()
{
	//new std::list()std::list> items;
}

void
ProductGroupPromotions::__cleanup()
{
	//if(items != NULL) {
...
void
ProductGroupPromotions::fromJson(char* jsonStr)
{
...
ProductGroupPromotions::ProductGroupPromotions(char* json)
{
	this->fromJson(json);
}
