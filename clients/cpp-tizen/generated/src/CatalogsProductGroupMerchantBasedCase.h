/*
 * Catalogs_product_group_merchant_based_case.h
 *
 * 
 */

#ifndef _Catalogs_product_group_merchant_based_case_H_
#define _Catalogs_product_group_merchant_based_case_H_
...
class Catalogs_product_group_merchant_based_case : public Object {
public:
	/*! \brief Constructor.
	 */
	Catalogs_product_group_merchant_based_case();
	Catalogs_product_group_merchant_based_case(char* str);

	/*! \brief Destructor.
	 */
	virtual ~Catalogs_product_group_merchant_based_case();
...
#endif /* _Catalogs_product_group_merchant_based_case_H_ */
