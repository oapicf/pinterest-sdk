...
#ifndef _AdCreateRequest_inner_H_
#define _AdCreateRequest_inner_H_
...
class AdCreateRequest_inner : public Object {
public:
	/*! \brief Constructor.
	 */
	AdCreateRequest_inner();
	AdCreateRequest_inner(char* str);

	/*! \brief Destructor.
	 */
	virtual ~AdCreateRequest_inner();
...
#endif /* _AdCreateRequest_inner_H_ */
