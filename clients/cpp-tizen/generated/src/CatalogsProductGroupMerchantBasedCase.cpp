...
Catalogs_product_group_merchant_based_case::Catalogs_product_group_merchant_based_case()
{
	//__init();
}
...
void
Catalogs_product_group_merchant_based_case::__init()
{
	//id = std::string();
	//name = std::string();
...
void
Catalogs_product_group_merchant_based_case::__cleanup()
{
	//if(id != NULL) {
	//
	//delete id;
...
void
Catalogs_product_group_merchant_based_case::fromJson(char* jsonStr)
{
...
Catalogs_product_group_merchant_based_case::Catalogs_product_group_merchant_based_case(char* json)
{
	this->fromJson(json);
}

char*
Catalogs_product_group_merchant_based_case::toJson()
{
...
std::string
Catalogs_product_group_merchant_based_case::getId()
{
	return id;
}

void
Catalogs_product_group_merchant_based_case::setId(std::string  id)
{
	this->id = id;
}

std::string
Catalogs_product_group_merchant_based_case::getName()
{
	return name;
}

void
Catalogs_product_group_merchant_based_case::setName(std::string  name)
{
	this->name = name;
}

std::string
Catalogs_product_group_merchant_based_case::getDescription()
{
	return description;
}

void
Catalogs_product_group_merchant_based_case::setDescription(std::string  description)
{
	this->description = description;
}

CatalogsProductGroupFilters
Catalogs_product_group_merchant_based_case::getFilters()
{
	return filters;
}

void
Catalogs_product_group_merchant_based_case::setFilters(CatalogsProductGroupFilters  filters)
{
	this->filters = filters;
}

bool
Catalogs_product_group_merchant_based_case::getIsFeatured()
{
	return is_featured;
}

void
Catalogs_product_group_merchant_based_case::setIsFeatured(bool  is_featured)
{
	this->is_featured = is_featured;
}

CatalogsProductGroupType
Catalogs_product_group_merchant_based_case::getType()
{
	return type;
}

void
Catalogs_product_group_merchant_based_case::setType(CatalogsProductGroupType  type)
{
	this->type = type;
}

CatalogsProductGroupStatus
Catalogs_product_group_merchant_based_case::getStatus()
{
	return status;
}

void
Catalogs_product_group_merchant_based_case::setStatus(CatalogsProductGroupStatus  status)
{
	this->status = status;
}

int
Catalogs_product_group_merchant_based_case::getCreatedAt()
{
	return created_at;
}

void
Catalogs_product_group_merchant_based_case::setCreatedAt(int  created_at)
{
	this->created_at = created_at;
}

int
Catalogs_product_group_merchant_based_case::getUpdatedAt()
{
	return updated_at;
}

void
Catalogs_product_group_merchant_based_case::setUpdatedAt(int  updated_at)
{
	this->updated_at = updated_at;
}

std::string
Catalogs_product_group_merchant_based_case::getFeedId()
{
	return feed_id;
}

void
Catalogs_product_group_merchant_based_case::setFeedId(std::string  feed_id)
{
