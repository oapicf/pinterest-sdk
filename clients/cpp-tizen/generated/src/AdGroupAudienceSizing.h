...
#ifndef _AdGroupAudienceSizing_H_
#define _AdGroupAudienceSizing_H_
...
class AdGroupAudienceSizing : public Object {
public:
	/*! \brief Constructor.
	 */
	AdGroupAudienceSizing();
	AdGroupAudienceSizing(char* str);
...
#endif /* _AdGroupAudienceSizing_H_ */
