...
void
PromotionBatchUpdate::__cleanup()
{
...
void
PromotionBatchUpdate::fromJson(char* jsonStr)
{
...
PromotionBatchUpdate::PromotionBatchUpdate(char* json)
{
	this->fromJson(json);
}

char*
PromotionBatchUpdate::toJson()
{
...
DiscountStatus
PromotionBatchUpdate::getDiscountStatus()
{
	return discount_status;
}

void
PromotionBatchUpdate::setDiscountStatus(DiscountStatus  discount_status)
{
	this->discount_status = discount_status;
}

int
PromotionBatchUpdate::getEndTime()
{
	return end_time;
}

void
PromotionBatchUpdate::setEndTime(int  end_time)
{
	this->end_time = end_time;
}

std::string
PromotionBatchUpdate::getExternalId()
{
	return external_id;
}

void
PromotionBatchUpdate::setExternalId(std::string  external_id)
{
	this->external_id = external_id;
}

std::string
PromotionBatchUpdate::getId()
{
	return id;
}

void
PromotionBatchUpdate::setId(std::string  id)
{
	this->id = id;
}

std::string
PromotionBatchUpdate::getPlatformType()
{
	return platform_type;
}

void
PromotionBatchUpdate::setPlatformType(std::string  platform_type)
{
	this->platform_type = platform_type;
}

std::string
PromotionBatchUpdate::getPromotionCode()
{
	return promotion_code;
}

void
PromotionBatchUpdate::setPromotionCode(std::string  promotion_code)
{
	this->promotion_code = promotion_code;
}

std::string
PromotionBatchUpdate::getPromotionCustomId()
{
	return promotion_custom_id;
}

void
PromotionBatchUpdate::setPromotionCustomId(std::string  promotion_custom_id)
{
	this->promotion_custom_id = promotion_custom_id;
}

std::string
PromotionBatchUpdate::getPromotionTitle()
{
	return promotion_title;
}

void
PromotionBatchUpdate::setPromotionTitle(std::string  promotion_title)
{
	this->promotion_title = promotion_title;
}

PromotionType
PromotionBatchUpdate::getPromotionType()
{
	return promotion_type;
}

void
PromotionBatchUpdate::setPromotionType(PromotionType  promotion_type)
{
	this->promotion_type = promotion_type;
}

int
PromotionBatchUpdate::getStartTime()
{
	return start_time;
}

void
PromotionBatchUpdate::setStartTime(int  start_time)
{
	this->start_time = start_time;
}

std::list<PromotionTemplateValue>
PromotionBatchUpdate::getTemplateValues()
{
	return template_values;
}

void
PromotionBatchUpdate::setTemplateValues(std::list <PromotionTemplateValue> template_values)
{
