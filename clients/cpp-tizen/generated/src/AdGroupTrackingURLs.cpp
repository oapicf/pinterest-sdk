...
void
AdGroupTrackingURLs::fromJson(char* jsonStr)
{
...
AdGroupTrackingURLs::AdGroupTrackingURLs(char* json)
{
	this->fromJson(json);
}

char*
AdGroupTrackingURLs::toJson()
{
...
std::list<std::string>
AdGroupTrackingURLs::getAudienceVerification()
{
	return audience_verification;
}

void
AdGroupTrackingURLs::setAudienceVerification(std::list <std::string> audience_verification)
{
	this->audience_verification = audience_verification;
}

std::list<std::string>
AdGroupTrackingURLs::getBuyableButton()
{
	return buyable_button;
}

void
AdGroupTrackingURLs::setBuyableButton(std::list <std::string> buyable_button)
{
	this->buyable_button = buyable_button;
}

std::list<std::string>
AdGroupTrackingURLs::getClick()
{
	return click;
}

void
AdGroupTrackingURLs::setClick(std::list <std::string> click)
{
	this->click = click;
}

std::list<std::string>
AdGroupTrackingURLs::getEngagement()
{
	return engagement;
}

void
AdGroupTrackingURLs::setEngagement(std::list <std::string> engagement)
{
	this->engagement = engagement;
}

std::list<std::string>
AdGroupTrackingURLs::getImpression()
{
	return impression;
}

void
AdGroupTrackingURLs::setImpression(std::list <std::string> impression)
{
