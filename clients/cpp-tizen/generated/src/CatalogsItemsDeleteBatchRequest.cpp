...
void
CatalogsItemsDeleteBatchRequest::__init()
{
	//country = new Country();
...
void
CatalogsItemsDeleteBatchRequest::__cleanup()
{
	//if(country != NULL) {
	//
	//delete country;
...
void
CatalogsItemsDeleteBatchRequest::fromJson(char* jsonStr)
{
...
CatalogsItemsDeleteBatchRequest::CatalogsItemsDeleteBatchRequest(char* json)
{
	this->fromJson(json);
}
...
void
CatalogsItemsDeleteBatchRequest::setLanguage(CatalogsItemsRequest_language  language)
{
