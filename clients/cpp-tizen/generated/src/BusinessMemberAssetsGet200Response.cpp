...
Business_member_assets_get_200_response::Business_member_assets_get_200_response()
{
	//__init();
}
...
void
Business_member_assets_get_200_response::__init()
{
...
void
Business_member_assets_get_200_response::__cleanup()
{
	//if(items != NULL) {
...
void
Business_member_assets_get_200_response::fromJson(char* jsonStr)
{
...
Business_member_assets_get_200_response::Business_member_assets_get_200_response(char* json)
{
	this->fromJson(json);
}

char*
Business_member_assets_get_200_response::toJson()
{
...
Business_member_assets_get_200_response::getItems()
{
	return items;
}

void
Business_member_assets_get_200_response::setItems(std::list <AssetIdPermissions> items)
{
	this->items = items;
}

std::string
Business_member_assets_get_200_response::getBookmark()
{
	return bookmark;
}

void
Business_member_assets_get_200_response::setBookmark(std::string  bookmark)
{
