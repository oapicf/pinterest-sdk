/*
 * AdGroupCreateCreate.h
 *
 * Resource create operation model.
 */

#ifndef _AdGroupCreateCreate_H_
#define _AdGroupCreateCreate_H_
...
class AdGroupCreateCreate : public Object {
public:
	/*! \brief Constructor.
	 */
	AdGroupCreateCreate();
	AdGroupCreateCreate(char* str);

	/*! \brief Destructor.
	 */
	virtual ~AdGroupCreateCreate();
