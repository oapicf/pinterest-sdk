...
#ifndef _BidFloorObjectiveType_H_
#define _BidFloorObjectiveType_H_
...
class BidFloorObjectiveType : public Object {
public:
	/*! \brief Constructor.
	 */
	BidFloorObjectiveType();
	BidFloorObjectiveType(char* str);
...
#endif /* _BidFloorObjectiveType_H_ */
