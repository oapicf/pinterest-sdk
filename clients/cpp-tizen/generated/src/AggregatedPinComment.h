...
#ifndef _AggregatedPinComment_H_
#define _AggregatedPinComment_H_
...
class AggregatedPinComment : public Object {
public:
	/*! \brief Constructor.
	 */
	AggregatedPinComment();
	AggregatedPinComment(char* str);
...
#endif /* _AggregatedPinComment_H_ */
