...
void
AdUpdateRequest_inner::__cleanup()
{
	//if(ad_group_id != NULL) {
	//
	//delete ad_group_id;
...
void
AdUpdateRequest_inner::fromJson(char* jsonStr)
{
...
AdUpdateRequest_inner::AdUpdateRequest_inner(char* json)
{
	this->fromJson(json);
}

char*
AdUpdateRequest_inner::toJson()
{
...
std::string
AdUpdateRequest_inner::getAdGroupId()
{
	return ad_group_id;
}

void
AdUpdateRequest_inner::setAdGroupId(std::string  ad_group_id)
{
	this->ad_group_id = ad_group_id;
}

std::string
AdUpdateRequest_inner::getAndroidDeepLink()
{
	return android_deep_link;
}

void
AdUpdateRequest_inner::setAndroidDeepLink(std::string  android_deep_link)
{
	this->android_deep_link = android_deep_link;
}

std::list<std::string>
AdUpdateRequest_inner::getCarouselAndroidDeepLinks()
{
	return carousel_android_deep_links;
}

void
AdUpdateRequest_inner::setCarouselAndroidDeepLinks(std::list <std::string> carousel_android_deep_links)
{
	this->carousel_android_deep_links = carousel_android_deep_links;
}

std::list<std::string>
AdUpdateRequest_inner::getCarouselDestinationUrls()
{
	return carousel_destination_urls;
}

void
AdUpdateRequest_inner::setCarouselDestinationUrls(std::list <std::string> carousel_destination_urls)
{
	this->carousel_destination_urls = carousel_destination_urls;
}

std::list<std::string>
AdUpdateRequest_inner::getCarouselIosDeepLinks()
{
	return carousel_ios_deep_links;
}

void
AdUpdateRequest_inner::setCarouselIosDeepLinks(std::list <std::string> carousel_ios_deep_links)
{
	this->carousel_ios_deep_links = carousel_ios_deep_links;
}

std::string
AdUpdateRequest_inner::getClickTrackingUrl()
{
	return click_tracking_url;
}

void
AdUpdateRequest_inner::setClickTrackingUrl(std::string  click_tracking_url)
{
	this->click_tracking_url = click_tracking_url;
}

CreativeType
AdUpdateRequest_inner::getCreativeType()
{
	return creative_type;
}

void
AdUpdateRequest_inner::setCreativeType(CreativeType  creative_type)
{
	this->creative_type = creative_type;
}

std::string
AdUpdateRequest_inner::getDestinationUrl()
{
	return destination_url;
}

void
AdUpdateRequest_inner::setDestinationUrl(std::string  destination_url)
{
	this->destination_url = destination_url;
}

std::string
AdUpdateRequest_inner::getIosDeepLink()
{
	return ios_deep_link;
}

void
AdUpdateRequest_inner::setIosDeepLink(std::string  ios_deep_link)
{
	this->ios_deep_link = ios_deep_link;
}

bool
AdUpdateRequest_inner::getIsPinDeleted()
{
	return is_pin_deleted;
}

void
AdUpdateRequest_inner::setIsPinDeleted(bool  is_pin_deleted)
{
	this->is_pin_deleted = is_pin_deleted;
}

bool
AdUpdateRequest_inner::getIsRemovable()
{
	return is_removable;
}

void
AdUpdateRequest_inner::setIsRemovable(bool  is_removable)
{
	this->is_removable = is_removable;
}

std::string
AdUpdateRequest_inner::getName()
{
	return name;
}

void
AdUpdateRequest_inner::setName(std::string  name)
{
	this->name = name;
}

std::string
AdUpdateRequest_inner::getPinId()
{
	return pin_id;
}

void
AdUpdateRequest_inner::setPinId(std::string  pin_id)
{
	this->pin_id = pin_id;
}

EntityStatus
AdUpdateRequest_inner::getStatus()
{
	return status;
}

void
AdUpdateRequest_inner::setStatus(EntityStatus  status)
{
	this->status = status;
}

AdCommon_tracking_urls
AdUpdateRequest_inner::getTrackingUrls()
{
	return tracking_urls;
}

void
AdUpdateRequest_inner::setTrackingUrls(AdCommon_tracking_urls  tracking_urls)
{
	this->tracking_urls = tracking_urls;
}

std::string
AdUpdateRequest_inner::getViewTrackingUrl()
{
	return view_tracking_url;
}

void
AdUpdateRequest_inner::setViewTrackingUrl(std::string  view_tracking_url)
{
	this->view_tracking_url = view_tracking_url;
}

std::string
AdUpdateRequest_inner::getId()
{
	return id;
}

void
AdUpdateRequest_inner::setId(std::string  id)
{
	this->id = id;
}
