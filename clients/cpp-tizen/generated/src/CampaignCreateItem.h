...
#ifndef _CampaignCreateItem_H_
#define _CampaignCreateItem_H_
...
class CampaignCreateItem : public Object {
public:
	/*! \brief Constructor.
	 */
	CampaignCreateItem();
	CampaignCreateItem(char* str);
