...
void
CatalogsHotelMainImage::__cleanup()
{
	//if(link != NULL) {
	//
	//delete link;
...
void
CatalogsHotelMainImage::fromJson(char* jsonStr)
{
...
CatalogsHotelMainImage::CatalogsHotelMainImage(char* json)
{
	this->fromJson(json);
}
