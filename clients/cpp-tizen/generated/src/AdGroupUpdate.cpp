...
void
AdGroupUpdate::fromJson(char* jsonStr)
{
...
AdGroupUpdate::AdGroupUpdate(char* json)
{
	this->fromJson(json);
}

char*
AdGroupUpdate::toJson()
{
...
std::string
AdGroupUpdate::getAdAccountId()
{
	return ad_account_id;
}

void
AdGroupUpdate::setAdAccountId(std::string  ad_account_id)
{
	this->ad_account_id = ad_account_id;
}

int
AdGroupUpdate::getBidInMicroCurrency()
{
	return bid_in_micro_currency;
}

void
AdGroupUpdate::setBidInMicroCurrency(int  bid_in_micro_currency)
{
	this->bid_in_micro_currency = bid_in_micro_currency;
}

BidStrategyType
AdGroupUpdate::getBidStrategyType()
{
	return bid_strategy_type;
}

void
AdGroupUpdate::setBidStrategyType(BidStrategyType  bid_strategy_type)
{
	this->bid_strategy_type = bid_strategy_type;
}

ActionType
AdGroupUpdate::getBillableEvent()
{
	return billable_event;
}

void
AdGroupUpdate::setBillableEvent(ActionType  billable_event)
{
	this->billable_event = billable_event;
}

int
AdGroupUpdate::getBudgetInMicroCurrency()
{
	return budget_in_micro_currency;
}

void
AdGroupUpdate::setBudgetInMicroCurrency(int  budget_in_micro_currency)
{
	this->budget_in_micro_currency = budget_in_micro_currency;
}

std::string
AdGroupUpdate::getCampaignId()
{
	return campaign_id;
}

void
AdGroupUpdate::setCampaignId(std::string  campaign_id)
{
	this->campaign_id = campaign_id;
}

ConversionLearningModeType
AdGroupUpdate::getConversionLearningModeType()
{
	return conversion_learning_mode_type;
}

void
AdGroupUpdate::setConversionLearningModeType(ConversionLearningModeType  conversion_learning_mode_type)
{
	this->conversion_learning_mode_type = conversion_learning_mode_type;
}

int
AdGroupUpdate::getCreatedTime()
{
	return created_time;
}

void
AdGroupUpdate::setCreatedTime(int  created_time)
{
	this->created_time = created_time;
}

std::string
AdGroupUpdate::getCustomerSegmentId()
{
	return customer_segment_id;
}

void
AdGroupUpdate::setCustomerSegmentId(std::string  customer_segment_id)
{
	this->customer_segment_id = customer_segment_id;
}

AnyType
AdGroupUpdate::getDcaAssets()
{
	return dca_assets;
}

void
AdGroupUpdate::setDcaAssets(AnyType  dca_assets)
{
	this->dca_assets = dca_assets;
}

int
AdGroupUpdate::getEndTime()
{
	return end_time;
}

void
AdGroupUpdate::setEndTime(int  end_time)
{
	this->end_time = end_time;
}

AdgroupTrackingFeatures
AdGroupUpdate::getExtFeatures()
{
	return ext_features;
}

void
AdGroupUpdate::setExtFeatures(AdgroupTrackingFeatures  ext_features)
{
	this->ext_features = ext_features;
}

std::string
AdGroupUpdate::getFeedProfileId()
{
	return feed_profile_id;
}

void
AdGroupUpdate::setFeedProfileId(std::string  feed_profile_id)
{
...
void
AdGroupUpdate::setId(std::string  id)
{
	this->id = id;
}

bool
AdGroupUpdate::getIsCreativeOptimization()
{
	return is_creative_optimization;
}

void
AdGroupUpdate::setIsCreativeOptimization(bool  is_creative_optimization)
{
	this->is_creative_optimization = is_creative_optimization;
}

bool
AdGroupUpdate::getIsLocalInventory()
{
	return is_local_inventory;
}

void
AdGroupUpdate::setIsLocalInventory(bool  is_local_inventory)
{
	this->is_local_inventory = is_local_inventory;
}

int
AdGroupUpdate::getLifetimeFrequencyCap()
{
	return lifetime_frequency_cap;
}

void
AdGroupUpdate::setLifetimeFrequencyCap(int  lifetime_frequency_cap)
{
	this->lifetime_frequency_cap = lifetime_frequency_cap;
}

long long
AdGroupUpdate::getLocalInventoryRadiusInMiles()
{
	return local_inventory_radius_in_miles;
}

void
AdGroupUpdate::setLocalInventoryRadiusInMiles(long long  local_inventory_radius_in_miles)
{
	this->local_inventory_radius_in_miles = local_inventory_radius_in_miles;
}

std::string
AdGroupUpdate::getName()
{
	return name;
}

void
AdGroupUpdate::setName(std::string  name)
{
	this->name = name;
}

NullableOptimizationGoalMetadata
AdGroupUpdate::getOptimizationGoalMetadata()
{
	return optimization_goal_metadata;
}

void
AdGroupUpdate::setOptimizationGoalMetadata(NullableOptimizationGoalMetadata  optimization_goal_metadata)
{
	this->optimization_goal_metadata = optimization_goal_metadata;
}

PerformancePlusCampaignSettings
AdGroupUpdate::getPerformancePlusCampaignSettings()
{
	return performance_plus_campaign_settings;
}

void
AdGroupUpdate::setPerformancePlusCampaignSettings(PerformancePlusCampaignSettings  performance_plus_campaign_settings)
{
	this->performance_plus_campaign_settings = performance_plus_campaign_settings;
}

PlacementGroupType
AdGroupUpdate::getPlacementGroup()
{
	return placement_group;
}

void
AdGroupUpdate::setPlacementGroup(PlacementGroupType  placement_group)
{
	this->placement_group = placement_group;
}

PlacementTrafficType
AdGroupUpdate::getPlacementTrafficType()
{
	return placement_traffic_type;
}

void
AdGroupUpdate::setPlacementTrafficType(PlacementTrafficType  placement_traffic_type)
{
	this->placement_traffic_type = placement_traffic_type;
}

PromotionApplicationLevel
AdGroupUpdate::getPromotionApplicationLevel()
{
	return promotion_application_level;
}

void
AdGroupUpdate::setPromotionApplicationLevel(PromotionApplicationLevel  promotion_application_level)
{
	this->promotion_application_level = promotion_application_level;
}

std::string
AdGroupUpdate::getPromotionId()
{
	return promotion_id;
}

void
AdGroupUpdate::setPromotionId(std::string  promotion_id)
{
	this->promotion_id = promotion_id;
}

std::list<std::string>
AdGroupUpdate::getPromotionIds()
{
	return promotion_ids;
}

void
AdGroupUpdate::setPromotionIds(std::list <std::string> promotion_ids)
{
	this->promotion_ids = promotion_ids;
}

int
AdGroupUpdate::getStartTime()
{
	return start_time;
}

void
AdGroupUpdate::setStartTime(int  start_time)
{
	this->start_time = start_time;
}

EntityStatus
AdGroupUpdate::getStatus()
{
	return status;
}

void
AdGroupUpdate::setStatus(EntityStatus  status)
{
	this->status = status;
}

SummaryStatus
AdGroupUpdate::getSummaryStatus()
{
	return summary_status;
}

void
AdGroupUpdate::setSummaryStatus(SummaryStatus  summary_status)
{
	this->summary_status = summary_status;
}

TargetingSpecOptimal
AdGroupUpdate::getTargetingSpec()
{
	return targeting_spec;
}

void
AdGroupUpdate::setTargetingSpec(TargetingSpecOptimal  targeting_spec)
{
	this->targeting_spec = targeting_spec;
}

std::list<std::string>
AdGroupUpdate::getTargetingTemplateIds()
{
	return targeting_template_ids;
}

void
AdGroupUpdate::setTargetingTemplateIds(std::list <std::string> targeting_template_ids)
{
	this->targeting_template_ids = targeting_template_ids;
}

AdGroupTrackingURLs
AdGroupUpdate::getTrackingUrls()
{
	return tracking_urls;
}

void
AdGroupUpdate::setTrackingUrls(AdGroupTrackingURLs  tracking_urls)
{
	this->tracking_urls = tracking_urls;
}

std::string
AdGroupUpdate::getType()
{
	return type;
}

void
AdGroupUpdate::setType(std::string  type)
{
	this->type = type;
}

int
AdGroupUpdate::getUpdatedTime()
{
	return updated_time;
}

void
AdGroupUpdate::setUpdatedTime(int  updated_time)
{
	this->updated_time = updated_time;
}

bool
AdGroupUpdate::getAutoTargetingEnabled()
{
	return auto_targeting_enabled;
}

void
AdGroupUpdate::setAutoTargetingEnabled(bool  auto_targeting_enabled)
{
	this->auto_targeting_enabled = auto_targeting_enabled;
}

long long
AdGroupUpdate::getBidMultiplier()
{
	return bid_multiplier;
}

void
AdGroupUpdate::setBidMultiplier(long long  bid_multiplier)
{
	this->bid_multiplier = bid_multiplier;
}

BudgetType
AdGroupUpdate::getBudgetType()
{
	return budget_type;
}

void
AdGroupUpdate::setBudgetType(BudgetType  budget_type)
{
	this->budget_type = budget_type;
}

PacingDeliveryType
AdGroupUpdate::getPacingDeliveryType()
{
	return pacing_delivery_type;
}

void
AdGroupUpdate::setPacingDeliveryType(PacingDeliveryType  pacing_delivery_type)
{
