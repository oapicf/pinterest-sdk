...
void
CampaignBatchResponseData::__init()
{
...
void
CampaignBatchResponseData::__cleanup()
{
...
void
CampaignBatchResponseData::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
		...
		if (isprimitive("NullableEntityStatus")) {
			jsonToValue(&status, node, "NullableEntityStatus", "NullableEntityStatus");
		} else {
			
			NullableEntityStatus* obj = static_cast<NullableEntityStatus*> (&status);
			obj->fromJson(json_to_string(node, false));
...
CampaignBatchResponseData::CampaignBatchResponseData(char* json)
{
	this->fromJson(json);
}
...
CampaignBatchResponseData::toJson()
{
	...
	if (isprimitive("NullableEntityStatus")) {
		NullableEntityStatus obj = getStatus();
		node = converttoJson(&obj, "NullableEntityStatus", "");
	}
	else {
		
		NullableEntityStatus obj = static_cast<NullableEntityStatus> (getStatus());
		GError *mygerror;
		mygerror = NULL;
		node = json_from_string(obj.toJson(), &mygerror);
...
bool
CampaignBatchResponseData::getIsAutomatedCampaign()
{
...
bool
CampaignBatchResponseData::getIsCampaignBudgetOptimization()
{
...
bool
CampaignBatchResponseData::getIsCarting()
{
	return is_carting;
}
...
bool
CampaignBatchResponseData::getIsFlexibleDailyBudgets()
{
...
bool
CampaignBatchResponseData::getIsLtvOptimized()
{
...
bool
CampaignBatchResponseData::getIsPerformancePlus()
{
...
bool
CampaignBatchResponseData::getIsTopOfSearch()
{
