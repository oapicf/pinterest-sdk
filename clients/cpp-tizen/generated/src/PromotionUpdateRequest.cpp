...
void
PromotionUpdateRequest::__cleanup()
{
...
void
PromotionUpdateRequest::fromJson(char* jsonStr)
{
...
PromotionUpdateRequest::PromotionUpdateRequest(char* json)
{
	this->fromJson(json);
}
