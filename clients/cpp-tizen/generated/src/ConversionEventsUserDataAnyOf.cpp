...
std::list<std::string>
ConversionEventsUserData_anyOf::getHashedMaids()
{
	return hashed_maids;
}

void
ConversionEventsUserData_anyOf::setHashedMaids(std::list <std::string> hashed_maids)
{
	this->hashed_maids = hashed_maids;
}

std::string
ConversionEventsUserData_anyOf::getClientIpAddress()
{
	return client_ip_address;
}

void
ConversionEventsUserData_anyOf::setClientIpAddress(std::string  client_ip_address)
{
	this->client_ip_address = client_ip_address;
}

std::string
ConversionEventsUserData_anyOf::getClientUserAgent()
{
	return client_user_agent;
}

void
ConversionEventsUserData_anyOf::setClientUserAgent(std::string  client_user_agent)
{
