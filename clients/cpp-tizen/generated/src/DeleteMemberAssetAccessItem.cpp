...
void
DeleteMemberAssetAccessItem::__init()
{
	//asset_id = std::string();
...
void
DeleteMemberAssetAccessItem::__cleanup()
{
	//if(asset_id != NULL) {
	//
	//delete asset_id;
...
void
DeleteMemberAssetAccessItem::fromJson(char* jsonStr)
{
...
DeleteMemberAssetAccessItem::DeleteMemberAssetAccessItem(char* json)
{
	this->fromJson(json);
}
