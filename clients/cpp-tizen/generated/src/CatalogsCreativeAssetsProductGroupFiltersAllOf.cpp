...
void
CatalogsCreativeAssetsProductGroupFiltersAllOf::__init()
{
	//new std::list()std::list> all_of;
}

void
CatalogsCreativeAssetsProductGroupFiltersAllOf::__cleanup()
{
	//if(all_of != NULL) {
...
void
CatalogsCreativeAssetsProductGroupFiltersAllOf::fromJson(char* jsonStr)
{
...
CatalogsCreativeAssetsProductGroupFiltersAllOf::CatalogsCreativeAssetsProductGroupFiltersAllOf(char* json)
{
	this->fromJson(json);
}
