...
void
ItemResponse_oneOf_1::__cleanup()
{
...
void
ItemResponse_oneOf_1::fromJson(char* jsonStr)
{
...
ItemResponse_oneOf_1::ItemResponse_oneOf_1(char* json)
{
	this->fromJson(json);
}
