...
#ifndef _InviteAssetsSummary_profiles_inner_H_
#define _InviteAssetsSummary_profiles_inner_H_
...
class InviteAssetsSummary_profiles_inner : public Object {
public:
	/*! \brief Constructor.
	 */
	InviteAssetsSummary_profiles_inner();
	InviteAssetsSummary_profiles_inner(char* str);
...
#endif /* _InviteAssetsSummary_profiles_inner_H_ */
