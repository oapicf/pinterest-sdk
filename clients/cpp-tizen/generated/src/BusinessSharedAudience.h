...
#ifndef _BusinessSharedAudience_H_
#define _BusinessSharedAudience_H_
...
class BusinessSharedAudience : public Object {
public:
	/*! \brief Constructor.
	 */
	BusinessSharedAudience();
	BusinessSharedAudience(char* str);
...
#endif /* _BusinessSharedAudience_H_ */
