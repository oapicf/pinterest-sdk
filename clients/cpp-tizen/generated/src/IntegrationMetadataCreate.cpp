...
void
IntegrationMetadataCreate::__init()
{
...
void
IntegrationMetadataCreate::__cleanup()
{
...
void
IntegrationMetadataCreate::fromJson(char* jsonStr)
{
...
IntegrationMetadataCreate::IntegrationMetadataCreate(char* json)
{
	this->fromJson(json);
}
...
void
IntegrationMetadataCreate::setPartnerAccessTokenExpiry(long long  partner_access_token_expiry)
{
...
void
IntegrationMetadataCreate::setPartnerRefreshTokenExpiry(long long  partner_refresh_token_expiry)
{
