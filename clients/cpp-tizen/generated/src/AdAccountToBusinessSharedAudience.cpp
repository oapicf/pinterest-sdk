...
void
AdAccountToBusinessSharedAudience::__init()
{
	//audience_id = null;
...
void
AdAccountToBusinessSharedAudience::__cleanup()
{
	//if(audience_id != NULL) {
	//
	//delete audience_id;
...
void
AdAccountToBusinessSharedAudience::fromJson(char* jsonStr)
{
...
AdAccountToBusinessSharedAudience::AdAccountToBusinessSharedAudience(char* json)
{
	this->fromJson(json);
}

char*
AdAccountToBusinessSharedAudience::toJson()
{
...
std::string
AdAccountToBusinessSharedAudience::getAudienceId()
{
	return audience_id;
}

void
AdAccountToBusinessSharedAudience::setAudienceId(std::string  audience_id)
{
	this->audience_id = audience_id;
}

std::list<Role>
AdAccountToBusinessSharedAudience::getPermissions()
{
	return permissions;
}

void
AdAccountToBusinessSharedAudience::setPermissions(std::list <Role> permissions)
{
	this->permissions = permissions;
}

std::list<std::string>
AdAccountToBusinessSharedAudience::getRecipientBusinessIds()
{
	return recipient_business_ids;
}

void
AdAccountToBusinessSharedAudience::setRecipientBusinessIds(std::list <std::string> recipient_business_ids)
{
