...
void
CatalogsProductGroupFilters::__init()
{
...
void
CatalogsProductGroupFilters::__cleanup()
{
	//if(any_of != NULL) {
...
void
CatalogsProductGroupFilters::fromJson(char* jsonStr)
{
...
CatalogsProductGroupFilters::CatalogsProductGroupFilters(char* json)
{
	this->fromJson(json);
}

char*
CatalogsProductGroupFilters::toJson()
{
...
CatalogsProductGroupFilters::getAnyOf()
{
	return any_of;
}
...
std::list<CatalogsProductGroupFilterKeys>
CatalogsProductGroupFilters::getAllOf()
{
	return all_of;
}
