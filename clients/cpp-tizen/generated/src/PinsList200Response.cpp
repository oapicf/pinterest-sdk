...
Pins_list_200_response::Pins_list_200_response()
{
	//__init();
}
...
void
Pins_list_200_response::__cleanup()
{
	//if(items != NULL) {
...
void
Pins_list_200_response::fromJson(char* jsonStr)
{
...
Pins_list_200_response::Pins_list_200_response(char* json)
{
	this->fromJson(json);
}

char*
Pins_list_200_response::toJson()
{
...
std::list<Pin>
Pins_list_200_response::getItems()
{
	return items;
}
...
std::string
Pins_list_200_response::getBookmark()
{
	return bookmark;
}
