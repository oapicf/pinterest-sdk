...
#ifndef _ScheduleBatchUpdate_H_
#define _ScheduleBatchUpdate_H_
...
class ScheduleBatchUpdate : public Object {
public:
	/*! \brief Constructor.
	 */
	ScheduleBatchUpdate();
	ScheduleBatchUpdate(char* str);
