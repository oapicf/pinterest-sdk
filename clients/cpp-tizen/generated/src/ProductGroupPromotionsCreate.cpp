...
void
ProductGroupPromotionsCreate::__init()
{
...
void
ProductGroupPromotionsCreate::__cleanup()
{
	//if(ad_group_id != NULL) {
	//
	//delete ad_group_id;
...
void
ProductGroupPromotionsCreate::fromJson(char* jsonStr)
{
...
ProductGroupPromotionsCreate::ProductGroupPromotionsCreate(char* json)
{
	this->fromJson(json);
}

char*
ProductGroupPromotionsCreate::toJson()
{
...
std::string
ProductGroupPromotionsCreate::getAdGroupId()
{
	return ad_group_id;
}

void
ProductGroupPromotionsCreate::setAdGroupId(std::string  ad_group_id)
{
	this->ad_group_id = ad_group_id;
}

std::list<ProductGroupPromotion>
ProductGroupPromotionsCreate::getProductGroupPromotion()
{
	return product_group_promotion;
}

void
ProductGroupPromotionsCreate::setProductGroupPromotion(std::list <ProductGroupPromotion> product_group_promotion)
{
