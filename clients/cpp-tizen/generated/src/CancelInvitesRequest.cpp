...
void
CancelInvitesRequest::__init()
{
	//new std::list()std::list> invite_ids;
}

void
CancelInvitesRequest::__cleanup()
{
	//if(invite_ids != NULL) {
...
void
CancelInvitesRequest::fromJson(char* jsonStr)
{
...
CancelInvitesRequest::CancelInvitesRequest(char* json)
{
	this->fromJson(json);
}
