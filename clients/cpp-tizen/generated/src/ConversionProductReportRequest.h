...
#ifndef _ConversionProductReportRequest_H_
#define _ConversionProductReportRequest_H_
...
class ConversionProductReportRequest : public Object {
public:
	/*! \brief Constructor.
	 */
	ConversionProductReportRequest();
	ConversionProductReportRequest(char* str);
...
#endif /* _ConversionProductReportRequest_H_ */
