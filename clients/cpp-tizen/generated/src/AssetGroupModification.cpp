...
void
AssetGroupModification::__cleanup()
{
	//if(exceptions != NULL) {
...
void
AssetGroupModification::fromJson(char* jsonStr)
{
...
AssetGroupModification::AssetGroupModification(char* json)
{
	this->fromJson(json);
}
