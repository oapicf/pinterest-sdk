...
#ifndef _LeadFormCreateRequest_H_
#define _LeadFormCreateRequest_H_
...
class LeadFormCreateRequest : public Object {
public:
	/*! \brief Constructor.
	 */
	LeadFormCreateRequest();
	LeadFormCreateRequest(char* str);
...
#endif /* _LeadFormCreateRequest_H_ */
