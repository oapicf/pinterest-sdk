...
Campaign::__init()
{
	...
	//name = std::string();
	//objective_type = new CampaignObjectiveType();
...
void
Campaign::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
		...
		if (isprimitive("CampaignObjectiveType")) {
			jsonToValue(&objective_type, node, "CampaignObjectiveType", "CampaignObjectiveType");
		} else {
			
			CampaignObjectiveType* obj = static_cast<CampaignObjectiveType*> (&objective_type);
			obj->fromJson(json_to_string(node, false));
...
Campaign::toJson()
{
	...
	if (isprimitive("CampaignObjectiveType")) {
		CampaignObjectiveType obj = getObjectiveType();
		node = converttoJson(&obj, "CampaignObjectiveType", "");
	}
	else {
		
		CampaignObjectiveType obj = static_cast<CampaignObjectiveType> (getObjectiveType());
		GError *mygerror;
		mygerror = NULL;
		node = json_from_string(obj.toJson(), &mygerror);
...
void
Campaign::setAdAccountId(std::string  ad_account_id)
{
	this->ad_account_id = ad_account_id;
}

CampaignBidOptions
Campaign::getBidOptions()
{
	return bid_options;
}

void
Campaign::setBidOptions(CampaignBidOptions  bid_options)
{
	this->bid_options = bid_options;
}

int
Campaign::getCreatedTime()
{
	return created_time;
}

void
Campaign::setCreatedTime(int  created_time)
{
	this->created_time = created_time;
}

int
Campaign::getDailySpendCap()
{
	return daily_spend_cap;
}

void
Campaign::setDailySpendCap(int  daily_spend_cap)
{
	this->daily_spend_cap = daily_spend_cap;
}

int
Campaign::getDefaultAdGroupBudgetInMicroCurrency()
{
	return default_ad_group_budget_in_micro_currency;
}

void
Campaign::setDefaultAdGroupBudgetInMicroCurrency(int  default_ad_group_budget_in_micro_currency)
{
...
void
Campaign::setEndTime(int  end_time)
{
...
void
Campaign::setId(std::string  id)
{
	this->id = id;
}

IntendedPromotionType
Campaign::getIntendedPromotionType()
{
	return intended_promotion_type;
}

void
Campaign::setIntendedPromotionType(IntendedPromotionType  intended_promotion_type)
{
	this->intended_promotion_type = intended_promotion_type;
}

bool
Campaign::getIsAutomatedCampaign()
{
	return is_automated_campaign;
}

void
Campaign::setIsAutomatedCampaign(bool  is_automated_campaign)
{
	this->is_automated_campaign = is_automated_campaign;
}

bool
Campaign::getIsCampaignBudgetOptimization()
{
	return is_campaign_budget_optimization;
}

void
Campaign::setIsCampaignBudgetOptimization(bool  is_campaign_budget_optimization)
{
	this->is_campaign_budget_optimization = is_campaign_budget_optimization;
}

bool
Campaign::getIsCarting()
{
	return is_carting;
}

void
Campaign::setIsCarting(bool  is_carting)
{
	this->is_carting = is_carting;
}

bool
Campaign::getIsFlexibleDailyBudgets()
{
	return is_flexible_daily_budgets;
}

void
Campaign::setIsFlexibleDailyBudgets(bool  is_flexible_daily_budgets)
{
	this->is_flexible_daily_budgets = is_flexible_daily_budgets;
}

bool
Campaign::getIsLtvOptimized()
{
	return is_ltv_optimized;
}

void
Campaign::setIsLtvOptimized(bool  is_ltv_optimized)
{
	this->is_ltv_optimized = is_ltv_optimized;
}

bool
Campaign::getIsPerformancePlus()
{
	return is_performance_plus;
}

void
Campaign::setIsPerformancePlus(bool  is_performance_plus)
{
	this->is_performance_plus = is_performance_plus;
}

bool
Campaign::getIsTopOfSearch()
{
	return is_top_of_search;
}

void
Campaign::setIsTopOfSearch(bool  is_top_of_search)
{
	this->is_top_of_search = is_top_of_search;
}

int
Campaign::getLifetimeSpendCap()
{
	return lifetime_spend_cap;
}

void
Campaign::setLifetimeSpendCap(int  lifetime_spend_cap)
{
...
void
Campaign::setName(std::string  name)
{
	this->name = name;
}

CampaignObjectiveType
Campaign::getObjectiveType()
{
	return objective_type;
}

void
Campaign::setObjectiveType(CampaignObjectiveType  objective_type)
{
	this->objective_type = objective_type;
}

std::string
Campaign::getOrderLineId()
{
	return order_line_id;
}

void
Campaign::setOrderLineId(std::string  order_line_id)
{
	this->order_line_id = order_line_id;
}

PerformancePlusCampaignSettings
Campaign::getPerformancePlusCampaignSettings()
{
	return performance_plus_campaign_settings;
}

void
Campaign::setPerformancePlusCampaignSettings(PerformancePlusCampaignSettings  performance_plus_campaign_settings)
{
...
void
Campaign::setStartTime(int  start_time)
{
...
void
Campaign::setStatus(EntityStatus  status)
{
	this->status = status;
}

SummaryStatus
Campaign::getSummaryStatus()
{
	return summary_status;
}

void
Campaign::setSummaryStatus(SummaryStatus  summary_status)
{
	this->summary_status = summary_status;
}

TrackingUrls
Campaign::getTrackingUrls()
{
	return tracking_urls;
}

void
Campaign::setTrackingUrls(TrackingUrls  tracking_urls)
{
...
void
Campaign::setType(std::string  type)
{
	this->type = type;
}

int
Campaign::getUpdatedTime()
{
	return updated_time;
}

void
Campaign::setUpdatedTime(int  updated_time)
{
