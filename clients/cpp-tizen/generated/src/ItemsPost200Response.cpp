...
void
Items_post_200_response::__init()
{
	//new std::list()std::list> items;
}

void
Items_post_200_response::__cleanup()
{
	//if(items != NULL) {
...
void
Items_post_200_response::fromJson(char* jsonStr)
{
...
Items_post_200_response::Items_post_200_response(char* json)
{
	this->fromJson(json);
}
