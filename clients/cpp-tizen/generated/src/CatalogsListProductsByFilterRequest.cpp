...
void
CatalogsListProductsByFilterRequest::__init()
{
	//feed_id = std::string();
...
void
CatalogsListProductsByFilterRequest::__cleanup()
{
	//if(feed_id != NULL) {
	//
	//delete feed_id;
...
void
CatalogsListProductsByFilterRequest::fromJson(char* jsonStr)
{
...
CatalogsListProductsByFilterRequest::CatalogsListProductsByFilterRequest(char* json)
{
	this->fromJson(json);
}
...
void
CatalogsListProductsByFilterRequest::setFilters(CatalogsProductGroupFilters  filters)
{
