...
#ifndef _AdvancedAuctionItemsSubmitRecord_H_
#define _AdvancedAuctionItemsSubmitRecord_H_
...
class AdvancedAuctionItemsSubmitRecord : public Object {
public:
	/*! \brief Constructor.
	 */
	AdvancedAuctionItemsSubmitRecord();
	AdvancedAuctionItemsSubmitRecord(char* str);
...
#endif /* _AdvancedAuctionItemsSubmitRecord_H_ */
