...
#ifndef _SSIOInsertionOrderUpdate_H_
#define _SSIOInsertionOrderUpdate_H_
...
class SSIOInsertionOrderUpdate : public Object {
public:
	/*! \brief Constructor.
	 */
	SSIOInsertionOrderUpdate();
	SSIOInsertionOrderUpdate(char* str);
...
#endif /* _SSIOInsertionOrderUpdate_H_ */
