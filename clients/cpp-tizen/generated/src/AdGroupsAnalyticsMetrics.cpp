...
void
AdGroupsAnalyticsMetrics::__init()
{
...
void
AdGroupsAnalyticsMetrics::__cleanup()
{
	//if(aD_GROUP_ID != NULL) {
	//
	//delete aD_GROUP_ID;
...
void
AdGroupsAnalyticsMetrics::fromJson(char* jsonStr)
{
...
AdGroupsAnalyticsMetrics::AdGroupsAnalyticsMetrics(char* json)
{
	this->fromJson(json);
}
