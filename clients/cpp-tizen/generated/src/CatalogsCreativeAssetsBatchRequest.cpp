...
void
CatalogsCreativeAssetsBatchRequest::__init()
{
...
void
CatalogsCreativeAssetsBatchRequest::__cleanup()
{
...
void
CatalogsCreativeAssetsBatchRequest::fromJson(char* jsonStr)
{
...
CatalogsCreativeAssetsBatchRequest::CatalogsCreativeAssetsBatchRequest(char* json)
{
	this->fromJson(json);
}
...
void
CatalogsCreativeAssetsBatchRequest::setLanguage(CatalogsItemsRequest_language  language)
{
