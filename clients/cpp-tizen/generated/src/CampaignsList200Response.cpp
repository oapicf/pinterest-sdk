...
void
Campaigns_list_200_response::__init()
{
...
void
Campaigns_list_200_response::__cleanup()
{
	//if(items != NULL) {
...
void
Campaigns_list_200_response::fromJson(char* jsonStr)
{
...
Campaigns_list_200_response::Campaigns_list_200_response(char* json)
{
	this->fromJson(json);
}
