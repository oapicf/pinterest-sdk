/*
 * CatalogsRetailReportStatsParametersReport.h
 *
 * 
 */

#ifndef _CatalogsRetailReportStatsParametersReport_H_
#define _CatalogsRetailReportStatsParametersReport_H_
...
class CatalogsRetailReportStatsParametersReport : public Object {
public:
	/*! \brief Constructor.
	 */
	CatalogsRetailReportStatsParametersReport();
	CatalogsRetailReportStatsParametersReport(char* str);

	/*! \brief Destructor.
	 */
	virtual ~CatalogsRetailReportStatsParametersReport();
...
#endif /* _CatalogsRetailReportStatsParametersReport_H_ */
