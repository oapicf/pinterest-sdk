...
#ifndef _LocalInventoryUpsertOperation_H_
#define _LocalInventoryUpsertOperation_H_
...
class LocalInventoryUpsertOperation : public Object {
public:
	/*! \brief Constructor.
	 */
	LocalInventoryUpsertOperation();
	LocalInventoryUpsertOperation(char* str);
...
#endif /* _LocalInventoryUpsertOperation_H_ */
