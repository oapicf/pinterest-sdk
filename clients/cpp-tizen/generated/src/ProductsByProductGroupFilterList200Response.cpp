...
void
Products_by_product_group_filter_list_200_response::__init()
{
...
void
Products_by_product_group_filter_list_200_response::__cleanup()
{
	//if(items != NULL) {
...
void
Products_by_product_group_filter_list_200_response::fromJson(char* jsonStr)
{
...
Products_by_product_group_filter_list_200_response::Products_by_product_group_filter_list_200_response(char* json)
{
	this->fromJson(json);
}

char*
Products_by_product_group_filter_list_200_response::toJson()
{
...
Products_by_product_group_filter_list_200_response::getItems()
{
	return items;
}

void
Products_by_product_group_filter_list_200_response::setItems(std::list <CatalogsProduct> items)
{
	this->items = items;
}

std::string
Products_by_product_group_filter_list_200_response::getBookmark()
{
	return bookmark;
}

void
Products_by_product_group_filter_list_200_response::setBookmark(std::string  bookmark)
{
