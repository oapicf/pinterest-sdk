...
#ifndef _ConversionDeletionRequestTargets_H_
#define _ConversionDeletionRequestTargets_H_
...
class ConversionDeletionRequestTargets : public Object {
public:
	/*! \brief Constructor.
	 */
	ConversionDeletionRequestTargets();
	ConversionDeletionRequestTargets(char* str);
...
#endif /* _ConversionDeletionRequestTargets_H_ */
