...
void
Catalogs_product_groups_create_201_response::__init()
{
	//id = std::string();
	//name = std::string();
...
void
Catalogs_product_groups_create_201_response::__cleanup()
{
	//if(id != NULL) {
	//
	//delete id;
...
void
Catalogs_product_groups_create_201_response::fromJson(char* jsonStr)
{
...
Catalogs_product_groups_create_201_response::Catalogs_product_groups_create_201_response(char* json)
{
	this->fromJson(json);
}

char*
Catalogs_product_groups_create_201_response::toJson()
{
...
std::string
Catalogs_product_groups_create_201_response::getId()
{
	return id;
}

void
Catalogs_product_groups_create_201_response::setId(std::string  id)
{
	this->id = id;
}

std::string
Catalogs_product_groups_create_201_response::getName()
{
	return name;
}

void
Catalogs_product_groups_create_201_response::setName(std::string  name)
{
	this->name = name;
}

std::string
Catalogs_product_groups_create_201_response::getDescription()
{
	return description;
}

void
Catalogs_product_groups_create_201_response::setDescription(std::string  description)
{
	this->description = description;
}

CatalogsProductGroupFilters
Catalogs_product_groups_create_201_response::getFilters()
{
	return filters;
}

void
Catalogs_product_groups_create_201_response::setFilters(CatalogsProductGroupFilters  filters)
{
	this->filters = filters;
}

bool
Catalogs_product_groups_create_201_response::getIsFeatured()
{
	return is_featured;
}

void
Catalogs_product_groups_create_201_response::setIsFeatured(bool  is_featured)
{
	this->is_featured = is_featured;
}

CatalogsProductGroupType
Catalogs_product_groups_create_201_response::getType()
{
	return type;
}

void
Catalogs_product_groups_create_201_response::setType(CatalogsProductGroupType  type)
{
	this->type = type;
}

CatalogsProductGroupStatus
Catalogs_product_groups_create_201_response::getStatus()
{
	return status;
}

void
Catalogs_product_groups_create_201_response::setStatus(CatalogsProductGroupStatus  status)
{
	this->status = status;
}

int
Catalogs_product_groups_create_201_response::getCreatedAt()
{
	return created_at;
}

void
Catalogs_product_groups_create_201_response::setCreatedAt(int  created_at)
{
	this->created_at = created_at;
}

int
Catalogs_product_groups_create_201_response::getUpdatedAt()
{
	return updated_at;
}

void
Catalogs_product_groups_create_201_response::setUpdatedAt(int  updated_at)
{
	this->updated_at = updated_at;
}

std::string
Catalogs_product_groups_create_201_response::getFeedId()
{
	return feed_id;
}

void
Catalogs_product_groups_create_201_response::setFeedId(std::string  feed_id)
{
	this->feed_id = feed_id;
}

std::string
Catalogs_product_groups_create_201_response::getCatalogType()
{
	return catalog_type;
}

void
Catalogs_product_groups_create_201_response::setCatalogType(std::string  catalog_type)
{
	this->catalog_type = catalog_type;
}

std::string
Catalogs_product_groups_create_201_response::getCatalogId()
{
	return catalog_id;
}

void
Catalogs_product_groups_create_201_response::setCatalogId(std::string  catalog_id)
{
