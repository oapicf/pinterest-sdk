...
void
BusinessToAdAccountSharedAudience::__init()
{
	//audience_id = null;
...
void
BusinessToAdAccountSharedAudience::__cleanup()
{
	//if(audience_id != NULL) {
	//
	//delete audience_id;
...
void
BusinessToAdAccountSharedAudience::fromJson(char* jsonStr)
{
...
BusinessToAdAccountSharedAudience::BusinessToAdAccountSharedAudience(char* json)
{
	this->fromJson(json);
}

char*
BusinessToAdAccountSharedAudience::toJson()
{
...
std::string
BusinessToAdAccountSharedAudience::getAudienceId()
{
	return audience_id;
}

void
BusinessToAdAccountSharedAudience::setAudienceId(std::string  audience_id)
{
	this->audience_id = audience_id;
}

std::list<Role>
BusinessToAdAccountSharedAudience::getPermissions()
{
	return permissions;
}

void
BusinessToAdAccountSharedAudience::setPermissions(std::list <Role> permissions)
{
	this->permissions = permissions;
}

std::list<std::string>
BusinessToAdAccountSharedAudience::getRecipientAccountIds()
{
	return recipient_account_ids;
}

void
BusinessToAdAccountSharedAudience::setRecipientAccountIds(std::list <std::string> recipient_account_ids)
{
