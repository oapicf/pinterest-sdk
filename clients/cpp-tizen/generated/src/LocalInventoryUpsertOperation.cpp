...
void
LocalInventoryUpsertOperation::__init()
{
...
void
LocalInventoryUpsertOperation::__cleanup()
{
	//if(attributes != NULL) {
	//
	//delete attributes;
...
void
LocalInventoryUpsertOperation::fromJson(char* jsonStr)
{
...
LocalInventoryUpsertOperation::LocalInventoryUpsertOperation(char* json)
{
	this->fromJson(json);
}
