...
void
UpdatePartnerAssetAccessBody_accesses_inner::__init()
{
...
void
UpdatePartnerAssetAccessBody_accesses_inner::__cleanup()
{
	//if(partner_id != NULL) {
	//
	//delete partner_id;
...
void
UpdatePartnerAssetAccessBody_accesses_inner::fromJson(char* jsonStr)
{
...
UpdatePartnerAssetAccessBody_accesses_inner::UpdatePartnerAssetAccessBody_accesses_inner(char* json)
{
	this->fromJson(json);
}
