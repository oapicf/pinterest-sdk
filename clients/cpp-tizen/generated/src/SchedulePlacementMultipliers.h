...
#ifndef _SchedulePlacementMultipliers_H_
#define _SchedulePlacementMultipliers_H_
...
class SchedulePlacementMultipliers : public Object {
public:
	/*! \brief Constructor.
	 */
	SchedulePlacementMultipliers();
	SchedulePlacementMultipliers(char* str);
...
#endif /* _SchedulePlacementMultipliers_H_ */
