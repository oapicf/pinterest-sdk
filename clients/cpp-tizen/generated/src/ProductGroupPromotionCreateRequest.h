...
public:
	...
	/*! \brief Get 
	 */
	std::list<ProductGroupPromotionCreateRequestElement> getProductGroupPromotion();

	/*! \brief Set 
	 */
	void setProductGroupPromotion(std::list <ProductGroupPromotionCreateRequestElement> product_group_promotion);

private:
	std::string ad_group_id;
	std::list <ProductGroupPromotionCreateRequestElement>product_group_promotion;
	void __init();
	void __cleanup();
