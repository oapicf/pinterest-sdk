...
void
SupplementalItemsBatchResponse::__init()
{
	//batch_id = std::string();
	//completed_time = null;
	//created_time = null;
...
void
SupplementalItemsBatchResponse::__cleanup()
{
	//if(batch_id != NULL) {
	//
	//delete batch_id;
...
void
SupplementalItemsBatchResponse::fromJson(char* jsonStr)
{
...
SupplementalItemsBatchResponse::SupplementalItemsBatchResponse(char* json)
{
	this->fromJson(json);
}
