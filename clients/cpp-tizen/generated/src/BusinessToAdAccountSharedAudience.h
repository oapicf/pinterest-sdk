...
#ifndef _BusinessToAdAccountSharedAudience_H_
#define _BusinessToAdAccountSharedAudience_H_
...
class BusinessToAdAccountSharedAudience : public Object {
public:
	/*! \brief Constructor.
	 */
	BusinessToAdAccountSharedAudience();
	BusinessToAdAccountSharedAudience(char* str);
...
#endif /* _BusinessToAdAccountSharedAudience_H_ */
