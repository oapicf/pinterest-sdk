...
void
Brand_accounts_update_request::__init()
{
	//name = std::string();
	//username = std::string();
	//country = new Country();
...
void
Brand_accounts_update_request::__cleanup()
{
	//if(name != NULL) {
	//
	//delete name;
...
void
Brand_accounts_update_request::fromJson(char* jsonStr)
{
...
Brand_accounts_update_request::Brand_accounts_update_request(char* json)
{
	this->fromJson(json);
}

char*
Brand_accounts_update_request::toJson()
{
...
std::string
Brand_accounts_update_request::getName()
{
	return name;
}

void
Brand_accounts_update_request::setName(std::string  name)
{
	this->name = name;
}

std::string
Brand_accounts_update_request::getUsername()
{
	return username;
}

void
Brand_accounts_update_request::setUsername(std::string  username)
{
	this->username = username;
}

Country
Brand_accounts_update_request::getCountry()
{
	return country;
}

void
Brand_accounts_update_request::setCountry(Country  country)
{
	this->country = country;
}

std::string
Brand_accounts_update_request::getAbout()
{
	return about;
}

void
Brand_accounts_update_request::setAbout(std::string  about)
{
	this->about = about;
}

std::string
Brand_accounts_update_request::getWebsite()
{
	return website;
}

void
Brand_accounts_update_request::setWebsite(std::string  website)
{
	this->website = website;
}

Image_Base64
Brand_accounts_update_request::getProfileImage()
{
	return profile_image;
}

void
Brand_accounts_update_request::setProfileImage(Image_Base64  profile_image)
{
