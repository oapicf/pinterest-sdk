...
void
AdGroupCommon_optimization_goal_metadata::__init()
{
...
void
AdGroupCommon_optimization_goal_metadata::__cleanup()
{
...
void
AdGroupCommon_optimization_goal_metadata::fromJson(char* jsonStr)
{
...
AdGroupCommon_optimization_goal_metadata::AdGroupCommon_optimization_goal_metadata(char* json)
{
	this->fromJson(json);
}

char*
AdGroupCommon_optimization_goal_metadata::toJson()
{
...
AdGroupCommon_optimization_goal_metadata::getConversionTagV3GoalMetadata()
{
	return conversion_tag_v3_goal_metadata;
}

void
AdGroupCommon_optimization_goal_metadata::setConversionTagV3GoalMetadata(OptimizationGoalMetadata_conversion_tag_v3_goal_metadata  conversion_tag_v3_goal_metadata)
{
	this->conversion_tag_v3_goal_metadata = conversion_tag_v3_goal_metadata;
}

OptimizationGoalMetadata_frequency_goal_metadata
AdGroupCommon_optimization_goal_metadata::getFrequencyGoalMetadata()
{
	return frequency_goal_metadata;
}

void
AdGroupCommon_optimization_goal_metadata::setFrequencyGoalMetadata(OptimizationGoalMetadata_frequency_goal_metadata  frequency_goal_metadata)
{
	this->frequency_goal_metadata = frequency_goal_metadata;
}

OptimizationGoalMetadata_scrollup_goal_metadata
AdGroupCommon_optimization_goal_metadata::getScrollupGoalMetadata()
{
	return scrollup_goal_metadata;
}

void
AdGroupCommon_optimization_goal_metadata::setScrollupGoalMetadata(OptimizationGoalMetadata_scrollup_goal_metadata  scrollup_goal_metadata)
{
