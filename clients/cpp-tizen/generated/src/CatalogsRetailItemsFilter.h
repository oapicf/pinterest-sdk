...
#ifndef _CatalogsRetailItemsFilter_H_
#define _CatalogsRetailItemsFilter_H_
...
class CatalogsRetailItemsFilter : public Object {
public:
	/*! \brief Constructor.
	 */
	CatalogsRetailItemsFilter();
	CatalogsRetailItemsFilter(char* str);
...
#endif /* _CatalogsRetailItemsFilter_H_ */
