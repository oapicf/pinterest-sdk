...
AdGroupCommon_tracking_urls::AdGroupCommon_tracking_urls()
{
	//__init();
}
...
void
AdGroupCommon_tracking_urls::__init()
{
...
void
AdGroupCommon_tracking_urls::__cleanup()
{
	//if(impression != NULL) {
...
void
AdGroupCommon_tracking_urls::fromJson(char* jsonStr)
{
...
AdGroupCommon_tracking_urls::AdGroupCommon_tracking_urls(char* json)
{
	this->fromJson(json);
}

char*
AdGroupCommon_tracking_urls::toJson()
{
...
std::list<std::string>
AdGroupCommon_tracking_urls::getImpression()
{
	return impression;
}

void
AdGroupCommon_tracking_urls::setImpression(std::list <std::string> impression)
{
	this->impression = impression;
}

std::list<std::string>
AdGroupCommon_tracking_urls::getClick()
{
	return click;
}

void
AdGroupCommon_tracking_urls::setClick(std::list <std::string> click)
{
	this->click = click;
}

std::list<std::string>
AdGroupCommon_tracking_urls::getEngagement()
{
	return engagement;
}

void
AdGroupCommon_tracking_urls::setEngagement(std::list <std::string> engagement)
{
	this->engagement = engagement;
}

std::list<std::string>
AdGroupCommon_tracking_urls::getBuyableButton()
{
	return buyable_button;
}

void
AdGroupCommon_tracking_urls::setBuyableButton(std::list <std::string> buyable_button)
{
	this->buyable_button = buyable_button;
}

std::list<std::string>
AdGroupCommon_tracking_urls::getAudienceVerification()
{
	return audience_verification;
}

void
AdGroupCommon_tracking_urls::setAudienceVerification(std::list <std::string> audience_verification)
{
