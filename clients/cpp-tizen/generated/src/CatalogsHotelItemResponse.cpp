...
void
CatalogsHotelItemResponse::__init()
{
...
void
CatalogsHotelItemResponse::__cleanup()
{
...
void
CatalogsHotelItemResponse::fromJson(char* jsonStr)
{
...
CatalogsHotelItemResponse::CatalogsHotelItemResponse(char* json)
{
	this->fromJson(json);
}
