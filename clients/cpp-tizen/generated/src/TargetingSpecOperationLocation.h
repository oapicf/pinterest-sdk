...
#ifndef _TargetingSpecOperationLocation_H_
#define _TargetingSpecOperationLocation_H_
...
class TargetingSpecOperationLocation : public Object {
public:
	/*! \brief Constructor.
	 */
	TargetingSpecOperationLocation();
	TargetingSpecOperationLocation(char* str);
...
#endif /* _TargetingSpecOperationLocation_H_ */
