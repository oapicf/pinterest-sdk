...
void
CatalogsProductGroupFiltersRequestAnyOfItems1::__init()
{
	//new std::list()std::list> all_of;
}

void
CatalogsProductGroupFiltersRequestAnyOfItems1::__cleanup()
{
	//if(all_of != NULL) {
...
void
CatalogsProductGroupFiltersRequestAnyOfItems1::fromJson(char* jsonStr)
{
...
CatalogsProductGroupFiltersRequestAnyOfItems1::CatalogsProductGroupFiltersRequestAnyOfItems1(char* json)
{
	this->fromJson(json);
}
