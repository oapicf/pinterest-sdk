...
void
AdvancedAuctionProcessedItem::__init()
{
...
void
AdvancedAuctionProcessedItem::__cleanup()
{
	//if(operation != NULL) {
	//
	//delete operation;
...
void
AdvancedAuctionProcessedItem::fromJson(char* jsonStr)
{
...
AdvancedAuctionProcessedItem::AdvancedAuctionProcessedItem(char* json)
{
	this->fromJson(json);
}

char*
AdvancedAuctionProcessedItem::toJson()
{
...
AdvancedAuctionProcessedItem::getOperation()
{
	return operation;
}

void
AdvancedAuctionProcessedItem::setOperation(AdvancedAuctionOperation  operation)
{
	this->operation = operation;
}

std::string
AdvancedAuctionProcessedItem::getItemId()
{
	return item_id;
}

void
AdvancedAuctionProcessedItem::setItemId(std::string  item_id)
{
	this->item_id = item_id;
}

Country
AdvancedAuctionProcessedItem::getCountry()
{
	return country;
}

void
AdvancedAuctionProcessedItem::setCountry(Country  country)
{
	this->country = country;
}

Language
AdvancedAuctionProcessedItem::getLanguage()
{
	return language;
}

void
AdvancedAuctionProcessedItem::setLanguage(Language  language)
{
	this->language = language;
}

AdvancedAuctionBidOptions
AdvancedAuctionProcessedItem::getBidOptions()
{
	return bid_options;
}

void
AdvancedAuctionProcessedItem::setBidOptions(AdvancedAuctionBidOptions  bid_options)
{
	this->bid_options = bid_options;
}

std::list<UpdateMaskBidOptionField>
AdvancedAuctionProcessedItem::getUpdateMask()
{
	return update_mask;
}

void
AdvancedAuctionProcessedItem::setUpdateMask(std::list <UpdateMaskBidOptionField> update_mask)
{
	this->update_mask = update_mask;
}

std::list<AdvancedAuctionOperationError>
AdvancedAuctionProcessedItem::getErrors()
{
	return errors;
}

void
AdvancedAuctionProcessedItem::setErrors(std::list <AdvancedAuctionOperationError> errors)
{
	this->errors = errors;
}
