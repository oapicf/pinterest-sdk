...
#ifndef _AdGroupsAnalyticsMetrics_H_
#define _AdGroupsAnalyticsMetrics_H_
...
class AdGroupsAnalyticsMetrics : public Object {
public:
	/*! \brief Constructor.
	 */
	AdGroupsAnalyticsMetrics();
	AdGroupsAnalyticsMetrics(char* str);
...
#endif /* _AdGroupsAnalyticsMetrics_H_ */
