...
#ifndef _IntegrationMetadataUpdate_H_
#define _IntegrationMetadataUpdate_H_
...
class IntegrationMetadataUpdate : public Object {
public:
	/*! \brief Constructor.
	 */
	IntegrationMetadataUpdate();
	IntegrationMetadataUpdate(char* str);
...
#endif /* _IntegrationMetadataUpdate_H_ */
