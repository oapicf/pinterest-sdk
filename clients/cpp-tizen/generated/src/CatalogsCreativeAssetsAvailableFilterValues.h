...
#ifndef _CatalogsCreativeAssetsAvailableFilterValues_H_
#define _CatalogsCreativeAssetsAvailableFilterValues_H_
...
class CatalogsCreativeAssetsAvailableFilterValues : public Object {
public:
	/*! \brief Constructor.
	 */
	CatalogsCreativeAssetsAvailableFilterValues();
	CatalogsCreativeAssetsAvailableFilterValues(char* str);
...
#endif /* _CatalogsCreativeAssetsAvailableFilterValues_H_ */
