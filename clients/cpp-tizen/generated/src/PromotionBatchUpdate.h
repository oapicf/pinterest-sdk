...
#ifndef _PromotionBatchUpdate_H_
#define _PromotionBatchUpdate_H_
...
class PromotionBatchUpdate : public Object {
public:
	/*! \brief Constructor.
	 */
	PromotionBatchUpdate();
	PromotionBatchUpdate(char* str);
...
#endif /* _PromotionBatchUpdate_H_ */
