...
void
BoardWithUpdatePrivacy::__cleanup()
{
...
void
BoardWithUpdatePrivacy::fromJson(char* jsonStr)
{
...
BoardWithUpdatePrivacy::BoardWithUpdatePrivacy(char* json)
{
	this->fromJson(json);
}
...
bool
BoardWithUpdatePrivacy::getIsAdsOnly()
{
	return is_ads_only;
}
