...
void
TargetingSpecOperationLocationExclude::__init()
{
	//field = std::string();
...
void
TargetingSpecOperationLocationExclude::__cleanup()
{
	//if(field != NULL) {
	//
	//delete field;
...
void
TargetingSpecOperationLocationExclude::fromJson(char* jsonStr)
{
...
TargetingSpecOperationLocationExclude::TargetingSpecOperationLocationExclude(char* json)
{
	this->fromJson(json);
}
