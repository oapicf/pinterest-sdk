...
void
AdvancedAuctionItemsGetRecord::__init()
{
	//item_id = std::string();
	//country = new Country();
...
void
AdvancedAuctionItemsGetRecord::__cleanup()
{
	//if(item_id != NULL) {
	//
	//delete item_id;
...
void
AdvancedAuctionItemsGetRecord::fromJson(char* jsonStr)
{
...
AdvancedAuctionItemsGetRecord::AdvancedAuctionItemsGetRecord(char* json)
{
	this->fromJson(json);
}
