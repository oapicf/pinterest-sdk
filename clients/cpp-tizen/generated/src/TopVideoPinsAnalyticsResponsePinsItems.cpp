...
void
TopVideoPinsAnalyticsResponsePinsItems::__init()
{
...
void
TopVideoPinsAnalyticsResponsePinsItems::__cleanup()
{
	//if(data_status != NULL) {
...
void
TopVideoPinsAnalyticsResponsePinsItems::fromJson(char* jsonStr)
{
...
TopVideoPinsAnalyticsResponsePinsItems::TopVideoPinsAnalyticsResponsePinsItems(char* json)
{
	this->fromJson(json);
}
...
void
TopVideoPinsAnalyticsResponsePinsItems::setDataStatus(std::map <string, string> data_status)
{
...
void
TopVideoPinsAnalyticsResponsePinsItems::setMetrics(std::map <string, string> metrics)
{
