...
void
ScheduleBidMultipliers::__cleanup()
{
...
void
ScheduleBidMultipliers::fromJson(char* jsonStr)
{
...
ScheduleBidMultipliers::ScheduleBidMultipliers(char* json)
{
	this->fromJson(json);
}

char*
ScheduleBidMultipliers::toJson()
{
...
ScheduleBidMultipliers::getAgeBucketMultipliers()
{
	return age_bucket_multipliers;
}

void
ScheduleBidMultipliers::setAgeBucketMultipliers(BidOptionsAgeBucketMultipliers  age_bucket_multipliers)
{
	this->age_bucket_multipliers = age_bucket_multipliers;
}

BidOptionsAppTypeMultipliers
ScheduleBidMultipliers::getAppTypeMultipliers()
{
	return app_type_multipliers;
}

void
ScheduleBidMultipliers::setAppTypeMultipliers(BidOptionsAppTypeMultipliers  app_type_multipliers)
{
	this->app_type_multipliers = app_type_multipliers;
}

std::list<BidOptionsAudienceMultipliers>
ScheduleBidMultipliers::getAudienceMultipliers()
{
	return audience_multipliers;
}

void
ScheduleBidMultipliers::setAudienceMultipliers(std::list <BidOptionsAudienceMultipliers> audience_multipliers)
{
	this->audience_multipliers = audience_multipliers;
}

BidOptionsGenderMultipliers
ScheduleBidMultipliers::getGenderMultipliers()
{
	return gender_multipliers;
}

void
ScheduleBidMultipliers::setGenderMultipliers(BidOptionsGenderMultipliers  gender_multipliers)
{
	this->gender_multipliers = gender_multipliers;
}

BidOptionsPlacementMultipliers
ScheduleBidMultipliers::getPlacementMultipliers()
{
	return placement_multipliers;
}

void
ScheduleBidMultipliers::setPlacementMultipliers(BidOptionsPlacementMultipliers  placement_multipliers)
{
