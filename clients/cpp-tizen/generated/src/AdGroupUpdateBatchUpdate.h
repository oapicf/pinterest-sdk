...
#ifndef _AdGroupUpdateBatchUpdate_H_
#define _AdGroupUpdateBatchUpdate_H_
...
class AdGroupUpdateBatchUpdate : public Object {
public:
	/*! \brief Constructor.
	 */
	AdGroupUpdateBatchUpdate();
	AdGroupUpdateBatchUpdate(char* str);
	 ...
	 */
	long long getLocalInventoryRadiusInMiles();

	/*! \brief Set The targeting radius of the local inventory ads in miles.
	 */
	void setLocalInventoryRadiusInMiles(long long  local_inventory_radius_in_miles);
...
private:
	...
	long long local_inventory_radius_in_miles;
	std::string name;
...
#endif /* _AdGroupUpdateBatchUpdate_H_ */
