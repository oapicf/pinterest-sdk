...
void
AssetGroupUpdateError::__cleanup()
{
...
void
AssetGroupUpdateError::fromJson(char* jsonStr)
{
...
AssetGroupUpdateError::AssetGroupUpdateError(char* json)
{
	this->fromJson(json);
}
