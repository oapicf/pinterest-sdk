...
std::list<std::string>
ConversionEventsUserData_anyOf_1::getEm()
{
	return em;
}

void
ConversionEventsUserData_anyOf_1::setEm(std::list <std::string> em)
{
	this->em = em;
}
...
std::string
ConversionEventsUserData_anyOf_1::getClientIpAddress()
{
	return client_ip_address;
}

void
ConversionEventsUserData_anyOf_1::setClientIpAddress(std::string  client_ip_address)
{
	this->client_ip_address = client_ip_address;
}

std::string
ConversionEventsUserData_anyOf_1::getClientUserAgent()
{
	return client_user_agent;
}

void
ConversionEventsUserData_anyOf_1::setClientUserAgent(std::string  client_user_agent)
{
