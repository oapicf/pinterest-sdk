...
void
CatalogsProductGroupFilterKeys::__init()
{
...
void
CatalogsProductGroupFilterKeys::__cleanup()
{
	//if(mIN_PRICE != NULL) {
	//
	//delete mIN_PRICE;
...
void
CatalogsProductGroupFilterKeys::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
		...
		if (isprimitive("CatalogsProductGroupMultipleStringCriteria")) {
			jsonToValue(&cONDITION, node, "CatalogsProductGroupMultipleStringCriteria", "CatalogsProductGroupMultipleStringCriteria");
		} else {
	...
	if (node !=NULL) {
		...
		if (isprimitive("CatalogsProductGroupMultipleStringCriteria")) {
			jsonToValue(&iTEM_GROUP_ID, node, "CatalogsProductGroupMultipleStringCriteria", "CatalogsProductGroupMultipleStringCriteria");
		} else {
	...
	if (node !=NULL) {
		...
		if (isprimitive("CatalogsProductGroupMultipleStringListCriteria")) {
			jsonToValue(&pRODUCT_TYPE_4, node, "CatalogsProductGroupMultipleStringListCriteria", "CatalogsProductGroupMultipleStringListCriteria");
		} else {
	...
	if (node !=NULL) {
		...
		if (isprimitive("CatalogsProductGroupMultipleStringListCriteria")) {
			jsonToValue(&pRODUCT_TYPE_2, node, "CatalogsProductGroupMultipleStringListCriteria", "CatalogsProductGroupMultipleStringListCriteria");
		} else {
	...
	if (node !=NULL) {
		...
		if (isprimitive("CatalogsProductGroupMultipleStringListCriteria")) {
			jsonToValue(&pRODUCT_TYPE_1, node, "CatalogsProductGroupMultipleStringListCriteria", "CatalogsProductGroupMultipleStringListCriteria");
		} else {
	...
	if (node !=NULL) {
		...
		if (isprimitive("CatalogsProductGroupMultipleStringListCriteria")) {
			jsonToValue(&pRODUCT_TYPE_0, node, "CatalogsProductGroupMultipleStringListCriteria", "CatalogsProductGroupMultipleStringListCriteria");
		} else {
...
CatalogsProductGroupFilterKeys::CatalogsProductGroupFilterKeys(char* json)
{
	this->fromJson(json);
}
...
void
CatalogsProductGroupFilterKeys::setCUSTOMLABEL0(CatalogsProductGroupMultipleStringCriteria  cUSTOM_LABEL_0)
{
...
void
CatalogsProductGroupFilterKeys::setCUSTOMLABEL1(CatalogsProductGroupMultipleStringCriteria  cUSTOM_LABEL_1)
{
...
void
CatalogsProductGroupFilterKeys::setCUSTOMLABEL2(CatalogsProductGroupMultipleStringCriteria  cUSTOM_LABEL_2)
{
...
void
CatalogsProductGroupFilterKeys::setCUSTOMLABEL3(CatalogsProductGroupMultipleStringCriteria  cUSTOM_LABEL_3)
{
...
void
CatalogsProductGroupFilterKeys::setCUSTOMLABEL4(CatalogsProductGroupMultipleStringCriteria  cUSTOM_LABEL_4)
{
