...
void
ConversionTagResponse::__cleanup()
{
...
void
ConversionTagResponse::fromJson(char* jsonStr)
{
...
ConversionTagResponse::ConversionTagResponse(char* json)
{
	this->fromJson(json);
}
...
void
ConversionTagResponse::setLastFiredTimeMs(long long  last_fired_time_ms)
{
