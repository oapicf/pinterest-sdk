...
CatalogsFeedIngestionErrors::__cleanup()
{
	...
	//}
	//if(fETCH_GOOGLE_SHEET_NOT_SHARED != NULL) {
	//
	//delete fETCH_GOOGLE_SHEET_NOT_SHARED;
...
CatalogsFeedIngestionErrors::fromJson(char* jsonStr)
{
	...
	const gchar *fETCH_GOOGLE_SHEET_NOT_SHAREDKey = "FETCH_GOOGLE_SHEET_NOT_SHARED";
	node = json_object_get_member(pJsonObject, fETCH_GOOGLE_SHEET_NOT_SHAREDKey);
	if (node !=NULL) {
	

		if (isprimitive("int")) {
			jsonToValue(&fETCH_GOOGLE_SHEET_NOT_SHARED, node, "int", "");
		} else {
...
CatalogsFeedIngestionErrors::toJson()
{
	...
	if (isprimitive("int")) {
		int obj = getFETCHGOOGLESHEETNOTSHARED();
		node = converttoJson(&obj, "int", "");
	}
	else {
	...
	const gchar *fETCH_GOOGLE_SHEET_NOT_SHAREDKey = "FETCH_GOOGLE_SHEET_NOT_SHARED";
	json_object_set_member(pJsonObject, fETCH_GOOGLE_SHEET_NOT_SHAREDKey, node);
	if (isprimitive("int")) {
