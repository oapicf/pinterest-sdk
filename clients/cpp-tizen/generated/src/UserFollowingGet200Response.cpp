...
void
User_following_get_200_response::__init()
{
...
void
User_following_get_200_response::__cleanup()
{
	//if(items != NULL) {
...
void
User_following_get_200_response::fromJson(char* jsonStr)
{
...
User_following_get_200_response::User_following_get_200_response(char* json)
{
	this->fromJson(json);
}
