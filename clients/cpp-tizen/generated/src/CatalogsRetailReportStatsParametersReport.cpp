...
void
CatalogsRetailReportStatsParametersReport::__init()
{
	//feed_id = std::string();
...
void
CatalogsRetailReportStatsParametersReport::__cleanup()
{
	//if(feed_id != NULL) {
	//
	//delete feed_id;
...
void
CatalogsRetailReportStatsParametersReport::fromJson(char* jsonStr)
{
...
CatalogsRetailReportStatsParametersReport::CatalogsRetailReportStatsParametersReport(char* json)
{
	this->fromJson(json);
}
