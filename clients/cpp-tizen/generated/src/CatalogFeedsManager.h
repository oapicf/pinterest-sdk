#ifndef _CatalogFeedsManager_H_
#define _CatalogFeedsManager_H_
...
/** \addtogroup CatalogFeeds CatalogFeeds
 * \ingroup Operations
 *  @{
 */
class CatalogFeedsManager {
public:
	CatalogFeedsManager();
	virtual ~CatalogFeedsManager();
