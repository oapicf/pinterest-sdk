...
void
CatalogsRetailFeedsUpdateRequest::__init()
{
...
void
CatalogsRetailFeedsUpdateRequest::__cleanup()
{
...
void
CatalogsRetailFeedsUpdateRequest::fromJson(char* jsonStr)
{
...
CatalogsRetailFeedsUpdateRequest::CatalogsRetailFeedsUpdateRequest(char* json)
{
	this->fromJson(json);
}
