...
void
ProductGroupPromotionResponseElement::__init()
{
	//id = std::string();
...
void
ProductGroupPromotionResponseElement::__cleanup()
{
	//if(id != NULL) {
	//
	//delete id;
...
void
ProductGroupPromotionResponseElement::fromJson(char* jsonStr)
{
...
ProductGroupPromotionResponseElement::ProductGroupPromotionResponseElement(char* json)
{
	this->fromJson(json);
}

char*
ProductGroupPromotionResponseElement::toJson()
{
...
std::string
ProductGroupPromotionResponseElement::getId()
{
	return id;
}

void
ProductGroupPromotionResponseElement::setId(std::string  id)
{
	this->id = id;
}

std::string
ProductGroupPromotionResponseElement::getAdGroupId()
{
	return ad_group_id;
}

void
ProductGroupPromotionResponseElement::setAdGroupId(std::string  ad_group_id)
{
	this->ad_group_id = ad_group_id;
}

int
ProductGroupPromotionResponseElement::getBidInMicroCurrency()
{
	return bid_in_micro_currency;
}

void
ProductGroupPromotionResponseElement::setBidInMicroCurrency(int  bid_in_micro_currency)
{
	this->bid_in_micro_currency = bid_in_micro_currency;
}

bool
ProductGroupPromotionResponseElement::getIncluded()
{
	return included;
}

void
ProductGroupPromotionResponseElement::setIncluded(bool  included)
{
	this->included = included;
}

std::string
ProductGroupPromotionResponseElement::getDefinition()
{
	return definition;
}

void
ProductGroupPromotionResponseElement::setDefinition(std::string  definition)
{
	this->definition = definition;
}

std::string
ProductGroupPromotionResponseElement::getRelativeDefinition()
{
	return relative_definition;
}

void
ProductGroupPromotionResponseElement::setRelativeDefinition(std::string  relative_definition)
{
	this->relative_definition = relative_definition;
}

std::string
ProductGroupPromotionResponseElement::getParentId()
{
	return parent_id;
}

void
ProductGroupPromotionResponseElement::setParentId(std::string  parent_id)
{
	this->parent_id = parent_id;
}

std::string
ProductGroupPromotionResponseElement::getSlideshowCollectionsTitle()
{
	return slideshow_collections_title;
}

void
ProductGroupPromotionResponseElement::setSlideshowCollectionsTitle(std::string  slideshow_collections_title)
{
	this->slideshow_collections_title = slideshow_collections_title;
}

std::string
ProductGroupPromotionResponseElement::getSlideshowCollectionsDescription()
{
	return slideshow_collections_description;
}

void
ProductGroupPromotionResponseElement::setSlideshowCollectionsDescription(std::string  slideshow_collections_description)
{
	this->slideshow_collections_description = slideshow_collections_description;
}

bool
ProductGroupPromotionResponseElement::getIsMdl()
{
	return is_mdl;
}

void
ProductGroupPromotionResponseElement::setIsMdl(bool  is_mdl)
{
	this->is_mdl = is_mdl;
}

EntityStatus
ProductGroupPromotionResponseElement::getStatus()
{
	return status;
}

void
ProductGroupPromotionResponseElement::setStatus(EntityStatus  status)
{
	this->status = status;
}

std::string
ProductGroupPromotionResponseElement::getTrackingUrl()
{
	return tracking_url;
}

void
ProductGroupPromotionResponseElement::setTrackingUrl(std::string  tracking_url)
{
	this->tracking_url = tracking_url;
}

std::string
ProductGroupPromotionResponseElement::getCatalogProductGroupId()
{
	return catalog_product_group_id;
}

void
ProductGroupPromotionResponseElement::setCatalogProductGroupId(std::string  catalog_product_group_id)
{
	this->catalog_product_group_id = catalog_product_group_id;
}

std::string
ProductGroupPromotionResponseElement::getCatalogProductGroupName()
{
	return catalog_product_group_name;
}

void
ProductGroupPromotionResponseElement::setCatalogProductGroupName(std::string  catalog_product_group_name)
{
	this->catalog_product_group_name = catalog_product_group_name;
}

std::string
ProductGroupPromotionResponseElement::getCollectionsHeroPinId()
{
	return collections_hero_pin_id;
}

void
ProductGroupPromotionResponseElement::setCollectionsHeroPinId(std::string  collections_hero_pin_id)
{
	this->collections_hero_pin_id = collections_hero_pin_id;
}

std::string
ProductGroupPromotionResponseElement::getCollectionsHeroDestinationUrl()
{
	return collections_hero_destination_url;
}

void
ProductGroupPromotionResponseElement::setCollectionsHeroDestinationUrl(std::string  collections_hero_destination_url)
{
	this->collections_hero_destination_url = collections_hero_destination_url;
}

GridClickType
ProductGroupPromotionResponseElement::getGridClickType()
{
	return grid_click_type;
}

void
ProductGroupPromotionResponseElement::setGridClickType(GridClickType  grid_click_type)
{
	this->grid_click_type = grid_click_type;
}

CreativeType
ProductGroupPromotionResponseElement::getCreativeType()
{
	return creative_type;
}

void
ProductGroupPromotionResponseElement::setCreativeType(CreativeType  creative_type)
{
