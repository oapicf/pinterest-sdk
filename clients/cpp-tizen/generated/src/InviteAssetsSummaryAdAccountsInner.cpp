...
void
InviteAssetsSummary_ad_accounts_inner::__init()
{
	//id = std::string();
...
void
InviteAssetsSummary_ad_accounts_inner::__cleanup()
{
	//if(id != NULL) {
	//
	//delete id;
...
void
InviteAssetsSummary_ad_accounts_inner::fromJson(char* jsonStr)
{
...
InviteAssetsSummary_ad_accounts_inner::InviteAssetsSummary_ad_accounts_inner(char* json)
{
	this->fromJson(json);
}
