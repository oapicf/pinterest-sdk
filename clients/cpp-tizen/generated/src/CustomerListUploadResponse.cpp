...
void
CustomerListUploadResponse::__init()
{
...
void
CustomerListUploadResponse::__cleanup()
{
...
void
CustomerListUploadResponse::fromJson(char* jsonStr)
{
...
CustomerListUploadResponse::CustomerListUploadResponse(char* json)
{
	this->fromJson(json);
}

char*
CustomerListUploadResponse::toJson()
{
...
std::string
CustomerListUploadResponse::getAdAccountId()
{
	return ad_account_id;
}

void
CustomerListUploadResponse::setAdAccountId(std::string  ad_account_id)
{
	this->ad_account_id = ad_account_id;
}

int
CustomerListUploadResponse::getCreationTime()
{
	return creation_time;
}

void
CustomerListUploadResponse::setCreationTime(int  creation_time)
{
	this->creation_time = creation_time;
}

std::string
CustomerListUploadResponse::getCustomerListId()
{
	return customer_list_id;
}

void
CustomerListUploadResponse::setCustomerListId(std::string  customer_list_id)
{
	this->customer_list_id = customer_list_id;
}

std::list<ErrorDetail>
CustomerListUploadResponse::getErrorCounts()
{
	return error_counts;
}

void
CustomerListUploadResponse::setErrorCounts(std::list <ErrorDetail> error_counts)
{
	this->error_counts = error_counts;
}

std::string
CustomerListUploadResponse::getId()
{
	return id;
}

void
CustomerListUploadResponse::setId(std::string  id)
{
	this->id = id;
}

UserListOperationType
CustomerListUploadResponse::getOperation()
{
	return operation;
}

void
CustomerListUploadResponse::setOperation(UserListOperationType  operation)
{
	this->operation = operation;
}

RecordCounts
CustomerListUploadResponse::getRecordCounts()
{
	return record_counts;
}

void
CustomerListUploadResponse::setRecordCounts(RecordCounts  record_counts)
{
	this->record_counts = record_counts;
}

std::string
CustomerListUploadResponse::getState()
{
	return state;
}

void
CustomerListUploadResponse::setState(std::string  state)
{
	this->state = state;
}

int
CustomerListUploadResponse::getUpdatedTime()
{
	return updated_time;
}

void
CustomerListUploadResponse::setUpdatedTime(int  updated_time)
{
