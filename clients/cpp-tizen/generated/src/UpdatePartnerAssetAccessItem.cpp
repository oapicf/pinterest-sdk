...
void
UpdatePartnerAssetAccessItem::__init()
{
	//asset_id = std::string();
...
void
UpdatePartnerAssetAccessItem::__cleanup()
{
	//if(asset_id != NULL) {
	//
	//delete asset_id;
...
void
UpdatePartnerAssetAccessItem::fromJson(char* jsonStr)
{
...
UpdatePartnerAssetAccessItem::UpdatePartnerAssetAccessItem(char* json)
{
	this->fromJson(json);
}
