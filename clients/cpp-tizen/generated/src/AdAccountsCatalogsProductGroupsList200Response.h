...
class Ad_accounts_catalogs_product_groups_list_200_response : public Object {
public:
	/*! \brief Constructor.
	 */
	Ad_accounts_catalogs_product_groups_list_200_response();
	Ad_accounts_catalogs_product_groups_list_200_response(char* str);

	/*! \brief Destructor.
	 */
	virtual ~Ad_accounts_catalogs_product_groups_list_200_response();
	...
	/*! \brief Get 
	 */
	std::list<CatalogProductGroup> getItems();

	/*! \brief Set 
	 */
	void setItems(std::list <CatalogProductGroup> items);
	/*! \brief Get 
	 */
...
private:
	std::list <CatalogProductGroup>items;
	std::string bookmark;
	void __init();
	void __cleanup();
