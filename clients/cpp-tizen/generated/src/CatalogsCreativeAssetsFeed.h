...
#ifndef _CatalogsCreativeAssetsFeed_H_
#define _CatalogsCreativeAssetsFeed_H_
...
class CatalogsCreativeAssetsFeed : public Object {
public:
	/*! \brief Constructor.
	 */
	CatalogsCreativeAssetsFeed();
	CatalogsCreativeAssetsFeed(char* str);
...
#endif /* _CatalogsCreativeAssetsFeed_H_ */
