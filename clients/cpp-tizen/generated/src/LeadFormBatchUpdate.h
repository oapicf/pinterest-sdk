...
#ifndef _LeadFormBatchUpdate_H_
#define _LeadFormBatchUpdate_H_
...
class LeadFormBatchUpdate : public Object {
public:
	/*! \brief Constructor.
	 */
	LeadFormBatchUpdate();
	LeadFormBatchUpdate(char* str);
