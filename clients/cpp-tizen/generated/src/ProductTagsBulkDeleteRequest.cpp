...
void
ProductTagsBulkDeleteRequest::__init()
{
	//new std::list()std::list> product_tags;
}

void
ProductTagsBulkDeleteRequest::__cleanup()
{
...
void
ProductTagsBulkDeleteRequest::fromJson(char* jsonStr)
{
...
ProductTagsBulkDeleteRequest::ProductTagsBulkDeleteRequest(char* json)
{
	this->fromJson(json);
}
