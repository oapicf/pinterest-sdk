...
void
TargetingSpecOperationGeo::__init()
{
	//field = std::string();
...
void
TargetingSpecOperationGeo::__cleanup()
{
	//if(field != NULL) {
	//
	//delete field;
...
void
TargetingSpecOperationGeo::fromJson(char* jsonStr)
{
...
TargetingSpecOperationGeo::TargetingSpecOperationGeo(char* json)
{
	this->fromJson(json);
}
