...
#ifndef _CatalogsProductMetadata_H_
#define _CatalogsProductMetadata_H_
...
/*! \brief Product metadata entity
 *
 *  \ingroup Models
 *
 */

class CatalogsProductMetadata : public Object {
public:
	/*! \brief Constructor.
	 */
	CatalogsProductMetadata();
	CatalogsProductMetadata(char* str);
...
#endif /* _CatalogsProductMetadata_H_ */
