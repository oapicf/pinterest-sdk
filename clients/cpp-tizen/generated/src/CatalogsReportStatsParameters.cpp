...
void
CatalogsReportStatsParameters::__init()
{
...
void
CatalogsReportStatsParameters::__cleanup()
{
...
void
CatalogsReportStatsParameters::fromJson(char* jsonStr)
{
...
CatalogsReportStatsParameters::CatalogsReportStatsParameters(char* json)
{
	this->fromJson(json);
}
