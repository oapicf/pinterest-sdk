...
void
DeletePartnerAssetAccessBody::__init()
{
	//new std::list()std::list> accesses;
}

void
DeletePartnerAssetAccessBody::__cleanup()
{
	//if(accesses != NULL) {
...
void
DeletePartnerAssetAccessBody::fromJson(char* jsonStr)
{
...
DeletePartnerAssetAccessBody::DeletePartnerAssetAccessBody(char* json)
{
	this->fromJson(json);
}
