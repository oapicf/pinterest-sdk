...
void
LeadSubscriptionPostParamsCreate_allOf_partner_metadata::__init()
{
	//subscriber_key = std::string();
}

void
LeadSubscriptionPostParamsCreate_allOf_partner_metadata::__cleanup()
{
...
void
LeadSubscriptionPostParamsCreate_allOf_partner_metadata::fromJson(char* jsonStr)
{
...
LeadSubscriptionPostParamsCreate_allOf_partner_metadata::LeadSubscriptionPostParamsCreate_allOf_partner_metadata(char* json)
{
	this->fromJson(json);
}
