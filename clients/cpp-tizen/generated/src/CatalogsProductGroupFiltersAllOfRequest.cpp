...
void
CatalogsProductGroupFiltersAllOfRequest::__init()
{
...
void
CatalogsProductGroupFiltersAllOfRequest::__cleanup()
{
	//if(any_of != NULL) {
...
void
CatalogsProductGroupFiltersAllOfRequest::fromJson(char* jsonStr)
{
...
CatalogsProductGroupFiltersAllOfRequest::CatalogsProductGroupFiltersAllOfRequest(char* json)
{
	this->fromJson(json);
}

char*
CatalogsProductGroupFiltersAllOfRequest::toJson()
{
...
CatalogsProductGroupFiltersAllOfRequest::getAnyOf()
{
	return any_of;
}

void
CatalogsProductGroupFiltersAllOfRequest::setAnyOf(std::list <CatalogsProductGroupFilterKeys> any_of)
{
	this->any_of = any_of;
}

std::list<CatalogsProductGroupFilterKeys>
CatalogsProductGroupFiltersAllOfRequest::getAllOf()
{
	return all_of;
}

void
CatalogsProductGroupFiltersAllOfRequest::setAllOf(std::list <CatalogsProductGroupFilterKeys> all_of)
{
	this->all_of = all_of;
}
