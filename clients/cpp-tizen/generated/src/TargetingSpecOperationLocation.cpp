...
void
TargetingSpecOperationLocation::__init()
{
	//field = std::string();
...
void
TargetingSpecOperationLocation::__cleanup()
{
	//if(field != NULL) {
	//
	//delete field;
...
void
TargetingSpecOperationLocation::fromJson(char* jsonStr)
{
...
TargetingSpecOperationLocation::TargetingSpecOperationLocation(char* json)
{
	this->fromJson(json);
}

char*
TargetingSpecOperationLocation::toJson()
{
...
std::string
TargetingSpecOperationLocation::getField()
{
	return field;
}

void
TargetingSpecOperationLocation::setField(std::string  field)
{
	this->field = field;
}

TargetingSpecListOperation
TargetingSpecOperationLocation::getOperation()
{
	return operation;
}

void
TargetingSpecOperationLocation::setOperation(TargetingSpecListOperation  operation)
{
	this->operation = operation;
}

std::list<std::string>
TargetingSpecOperationLocation::getValues()
{
	return values;
}

void
TargetingSpecOperationLocation::setValues(std::list <std::string> values)
{
	this->values = values;
}
