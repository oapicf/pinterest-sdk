...
void
SupplementalOperationResult::__init()
{
...
void
SupplementalOperationResult::__cleanup()
{
	//if(errors != NULL) {
...
void
SupplementalOperationResult::fromJson(char* jsonStr)
{
...
SupplementalOperationResult::SupplementalOperationResult(char* json)
{
	this->fromJson(json);
}

char*
SupplementalOperationResult::toJson()
{
...
SupplementalOperationResult::getErrors()
{
	return errors;
}

void
SupplementalOperationResult::setErrors(std::list <SupplementalItemValidationEvent> errors)
{
	this->errors = errors;
}

std::string
SupplementalOperationResult::getItemId()
{
	return item_id;
}

void
SupplementalOperationResult::setItemId(std::string  item_id)
{
	this->item_id = item_id;
}

SupplementalItemProcessingStatus
SupplementalOperationResult::getStatus()
{
	return status;
}

void
SupplementalOperationResult::setStatus(SupplementalItemProcessingStatus  status)
{
	this->status = status;
}

std::string
SupplementalOperationResult::getStoreCode()
{
	return store_code;
}

void
SupplementalOperationResult::setStoreCode(std::string  store_code)
{
	this->store_code = store_code;
}

std::string
SupplementalOperationResult::getSupplementalType()
{
	return supplemental_type;
}

void
SupplementalOperationResult::setSupplementalType(std::string  supplemental_type)
{
	this->supplemental_type = supplemental_type;
}

std::list<SupplementalItemValidationEvent>
SupplementalOperationResult::getWarnings()
{
	return warnings;
}

void
SupplementalOperationResult::setWarnings(std::list <SupplementalItemValidationEvent> warnings)
{
