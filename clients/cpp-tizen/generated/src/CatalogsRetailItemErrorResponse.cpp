...
void
CatalogsRetailItemErrorResponse::__init()
{
...
void
CatalogsRetailItemErrorResponse::__cleanup()
{
...
void
CatalogsRetailItemErrorResponse::fromJson(char* jsonStr)
{
...
CatalogsRetailItemErrorResponse::CatalogsRetailItemErrorResponse(char* json)
{
	this->fromJson(json);
}
