...
#ifndef _TargetingSpecOperationLocale_H_
#define _TargetingSpecOperationLocale_H_
...
class TargetingSpecOperationLocale : public Object {
public:
	/*! \brief Constructor.
	 */
	TargetingSpecOperationLocale();
	TargetingSpecOperationLocale(char* str);
...
#endif /* _TargetingSpecOperationLocale_H_ */
