...
#ifndef _RetailLocalInventoryItemAttributesOptional_H_
#define _RetailLocalInventoryItemAttributesOptional_H_
...
/*! \brief Local inventory attributes for retail items (all fields optional for update/get)
 *
 *  \ingroup Models
 *
 */

class RetailLocalInventoryItemAttributesOptional : public Object {
public:
	/*! \brief Constructor.
	 */
	RetailLocalInventoryItemAttributesOptional();
	RetailLocalInventoryItemAttributesOptional(char* str);
...
#endif /* _RetailLocalInventoryItemAttributesOptional_H_ */
