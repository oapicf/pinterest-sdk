...
void
ScheduleBidOptions::fromJson(char* jsonStr)
{
...
ScheduleBidOptions::ScheduleBidOptions(char* json)
{
	this->fromJson(json);
}
...
void
ScheduleBidOptions::setAgeBucketMultipliers(ScheduleAgeBucketMultipliers  age_bucket_multipliers)
{
...
void
ScheduleBidOptions::setAppTypeMultipliers(ScheduleAppTypeMultipliers  app_type_multipliers)
{
...
void
ScheduleBidOptions::setAudienceMultipliers(ScheduleAudienceMultipliers  audience_multipliers)
{
...
void
ScheduleBidOptions::setGenderMultipliers(ScheduleBidOptions_gender_multipliers  gender_multipliers)
{
