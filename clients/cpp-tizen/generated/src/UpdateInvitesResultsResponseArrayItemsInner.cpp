...
void
UpdateInvitesResultsResponseArray_items_inner::__init()
{
...
void
UpdateInvitesResultsResponseArray_items_inner::__cleanup()
{
	//if(exception != NULL) {
	//
	//delete exception;
...
void
UpdateInvitesResultsResponseArray_items_inner::fromJson(char* jsonStr)
{
...
UpdateInvitesResultsResponseArray_items_inner::UpdateInvitesResultsResponseArray_items_inner(char* json)
{
	this->fromJson(json);
}
