...
#ifndef _TargetingSpecOperationGeoExclude_H_
#define _TargetingSpecOperationGeoExclude_H_
...
class TargetingSpecOperationGeoExclude : public Object {
public:
	/*! \brief Constructor.
	 */
	TargetingSpecOperationGeoExclude();
	TargetingSpecOperationGeoExclude(char* str);
...
#endif /* _TargetingSpecOperationGeoExclude_H_ */
