...
void
IntegrationMetadataUpdate::__init()
{
...
void
IntegrationMetadataUpdate::__cleanup()
{
...
void
IntegrationMetadataUpdate::fromJson(char* jsonStr)
{
...
IntegrationMetadataUpdate::IntegrationMetadataUpdate(char* json)
{
	this->fromJson(json);
}

char*
IntegrationMetadataUpdate::toJson()
{
...
std::string
IntegrationMetadataUpdate::getAdditionalId1()
{
	return additional_id_1;
}

void
IntegrationMetadataUpdate::setAdditionalId1(std::string  additional_id_1)
{
	this->additional_id_1 = additional_id_1;
}

std::string
IntegrationMetadataUpdate::getConnectedAdvertiserId()
{
	return connected_advertiser_id;
}

void
IntegrationMetadataUpdate::setConnectedAdvertiserId(std::string  connected_advertiser_id)
{
	this->connected_advertiser_id = connected_advertiser_id;
}

std::string
IntegrationMetadataUpdate::getConnectedLbaId()
{
	return connected_lba_id;
}

void
IntegrationMetadataUpdate::setConnectedLbaId(std::string  connected_lba_id)
{
	this->connected_lba_id = connected_lba_id;
}

std::string
IntegrationMetadataUpdate::getConnectedMerchantId()
{
	return connected_merchant_id;
}

void
IntegrationMetadataUpdate::setConnectedMerchantId(std::string  connected_merchant_id)
{
	this->connected_merchant_id = connected_merchant_id;
}

std::string
IntegrationMetadataUpdate::getConnectedTagId()
{
	return connected_tag_id;
}

void
IntegrationMetadataUpdate::setConnectedTagId(std::string  connected_tag_id)
{
	this->connected_tag_id = connected_tag_id;
}

std::string
IntegrationMetadataUpdate::getPartnerAccessToken()
{
	return partner_access_token;
}

void
IntegrationMetadataUpdate::setPartnerAccessToken(std::string  partner_access_token)
{
	this->partner_access_token = partner_access_token;
}

long long
IntegrationMetadataUpdate::getPartnerAccessTokenExpiry()
{
	return partner_access_token_expiry;
}

void
IntegrationMetadataUpdate::setPartnerAccessTokenExpiry(long long  partner_access_token_expiry)
{
	this->partner_access_token_expiry = partner_access_token_expiry;
}

std::string
IntegrationMetadataUpdate::getPartnerMetadata()
{
	return partner_metadata;
}

void
IntegrationMetadataUpdate::setPartnerMetadata(std::string  partner_metadata)
{
	this->partner_metadata = partner_metadata;
}

std::string
IntegrationMetadataUpdate::getPartnerPrimaryEmail()
{
	return partner_primary_email;
}

void
IntegrationMetadataUpdate::setPartnerPrimaryEmail(std::string  partner_primary_email)
{
	this->partner_primary_email = partner_primary_email;
}

std::string
IntegrationMetadataUpdate::getPartnerRefreshToken()
{
	return partner_refresh_token;
}

void
IntegrationMetadataUpdate::setPartnerRefreshToken(std::string  partner_refresh_token)
{
	this->partner_refresh_token = partner_refresh_token;
}

long long
IntegrationMetadataUpdate::getPartnerRefreshTokenExpiry()
{
	return partner_refresh_token_expiry;
}

void
IntegrationMetadataUpdate::setPartnerRefreshTokenExpiry(long long  partner_refresh_token_expiry)
{
	this->partner_refresh_token_expiry = partner_refresh_token_expiry;
}

std::string
IntegrationMetadataUpdate::getScopes()
{
	return scopes;
}

void
IntegrationMetadataUpdate::setScopes(std::string  scopes)
{
	this->scopes = scopes;
}
