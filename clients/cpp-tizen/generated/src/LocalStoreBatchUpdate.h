...
#ifndef _LocalStoreBatchUpdate_H_
#define _LocalStoreBatchUpdate_H_
...
class LocalStoreBatchUpdate : public Object {
public:
	/*! \brief Constructor.
	 */
	LocalStoreBatchUpdate();
	LocalStoreBatchUpdate(char* str);
...
#endif /* _LocalStoreBatchUpdate_H_ */
