...
void
AdResponse_allOf_1::fromJson(char* jsonStr)
{
...
AdResponse_allOf_1::AdResponse_allOf_1(char* json)
{
	this->fromJson(json);
}

char*
AdResponse_allOf_1::toJson()
{
...
std::string
AdResponse_allOf_1::getAdAccountId()
{
	return ad_account_id;
}

void
AdResponse_allOf_1::setAdAccountId(std::string  ad_account_id)
{
	this->ad_account_id = ad_account_id;
}

std::string
AdResponse_allOf_1::getCampaignId()
{
	return campaign_id;
}

void
AdResponse_allOf_1::setCampaignId(std::string  campaign_id)
{
	this->campaign_id = campaign_id;
}

std::string
AdResponse_allOf_1::getCollectionItemsDestinationUrlTemplate()
{
	return collection_items_destination_url_template;
}

void
AdResponse_allOf_1::setCollectionItemsDestinationUrlTemplate(std::string  collection_items_destination_url_template)
{
	this->collection_items_destination_url_template = collection_items_destination_url_template;
}

int
AdResponse_allOf_1::getCreatedTime()
{
	return created_time;
}

void
AdResponse_allOf_1::setCreatedTime(int  created_time)
{
	this->created_time = created_time;
}

std::string
AdResponse_allOf_1::getId()
{
	return id;
}

void
AdResponse_allOf_1::setId(std::string  id)
{
	this->id = id;
}

std::list<std::string>
AdResponse_allOf_1::getRejectedReasons()
{
	return rejected_reasons;
}

void
AdResponse_allOf_1::setRejectedReasons(std::list <std::string> rejected_reasons)
{
	this->rejected_reasons = rejected_reasons;
}

std::list<std::string>
AdResponse_allOf_1::getRejectionLabels()
{
	return rejection_labels;
}

void
AdResponse_allOf_1::setRejectionLabels(std::list <std::string> rejection_labels)
{
	this->rejection_labels = rejection_labels;
}

std::string
AdResponse_allOf_1::getReviewStatus()
{
	return review_status;
}

void
AdResponse_allOf_1::setReviewStatus(std::string  review_status)
{
	this->review_status = review_status;
}

std::string
AdResponse_allOf_1::getType()
{
	return type;
}

void
AdResponse_allOf_1::setType(std::string  type)
{
	this->type = type;
}

int
AdResponse_allOf_1::getUpdatedTime()
{
	return updated_time;
}

void
AdResponse_allOf_1::setUpdatedTime(int  updated_time)
{
	this->updated_time = updated_time;
}

PinPromotionSummaryStatus
AdResponse_allOf_1::getSummaryStatus()
{
	return summary_status;
}

void
AdResponse_allOf_1::setSummaryStatus(PinPromotionSummaryStatus  summary_status)
{
