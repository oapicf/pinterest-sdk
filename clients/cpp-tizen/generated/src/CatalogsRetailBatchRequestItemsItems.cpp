...
void
CatalogsRetailBatchRequestItemsItems::__init()
{
...
void
CatalogsRetailBatchRequestItemsItems::__cleanup()
{
	//if(attributes != NULL) {
	//
	//delete attributes;
...
void
CatalogsRetailBatchRequestItemsItems::fromJson(char* jsonStr)
{
...
CatalogsRetailBatchRequestItemsItems::CatalogsRetailBatchRequestItemsItems(char* json)
{
	this->fromJson(json);
}
...
void
CatalogsRetailBatchRequestItemsItems::setLastUpdatedTime(long long  last_updated_time)
{
