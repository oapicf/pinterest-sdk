...
void
CatalogsProductGroupsCreateRequestSchema::__init()
{
...
void
CatalogsProductGroupsCreateRequestSchema::__cleanup()
{
	//if(description != NULL) {
	//
	//delete description;
...
void
CatalogsProductGroupsCreateRequestSchema::fromJson(char* jsonStr)
{
...
CatalogsProductGroupsCreateRequestSchema::CatalogsProductGroupsCreateRequestSchema(char* json)
{
	this->fromJson(json);
}

char*
CatalogsProductGroupsCreateRequestSchema::toJson()
{
...
std::string
CatalogsProductGroupsCreateRequestSchema::getDescription()
{
	return description;
}

void
CatalogsProductGroupsCreateRequestSchema::setDescription(std::string  description)
{
	this->description = description;
}

std::string
CatalogsProductGroupsCreateRequestSchema::getFeedId()
{
	return feed_id;
}

void
CatalogsProductGroupsCreateRequestSchema::setFeedId(std::string  feed_id)
{
	this->feed_id = feed_id;
}

CatalogsCreativeAssetsProductGroupFilters
CatalogsProductGroupsCreateRequestSchema::getFilters()
{
	return filters;
}

void
CatalogsProductGroupsCreateRequestSchema::setFilters(CatalogsCreativeAssetsProductGroupFilters  filters)
{
	this->filters = filters;
}

bool
CatalogsProductGroupsCreateRequestSchema::getIsFeatured()
{
	return is_featured;
}

void
CatalogsProductGroupsCreateRequestSchema::setIsFeatured(bool  is_featured)
{
	this->is_featured = is_featured;
}

std::string
CatalogsProductGroupsCreateRequestSchema::getName()
{
	return name;
}

void
CatalogsProductGroupsCreateRequestSchema::setName(std::string  name)
{
	this->name = name;
}

std::string
CatalogsProductGroupsCreateRequestSchema::getCatalogId()
{
	return catalog_id;
}

void
CatalogsProductGroupsCreateRequestSchema::setCatalogId(std::string  catalog_id)
{
	this->catalog_id = catalog_id;
}

std::string
CatalogsProductGroupsCreateRequestSchema::getCatalogType()
{
	return catalog_type;
}

void
CatalogsProductGroupsCreateRequestSchema::setCatalogType(std::string  catalog_type)
{
	this->catalog_type = catalog_type;
}

Country
CatalogsProductGroupsCreateRequestSchema::getCountry()
{
	return country;
}

void
CatalogsProductGroupsCreateRequestSchema::setCountry(Country  country)
{
	this->country = country;
}

CatalogsLocale
CatalogsProductGroupsCreateRequestSchema::getLocale()
{
	return locale;
}

void
CatalogsProductGroupsCreateRequestSchema::setLocale(CatalogsLocale  locale)
{
	this->locale = locale;
}
