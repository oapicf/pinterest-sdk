...
#ifndef _TrendingKeyword_demographics_gender_distribution_H_
#define _TrendingKeyword_demographics_gender_distribution_H_
...
class TrendingKeyword_demographics_gender_distribution : public Object {
public:
	/*! \brief Constructor.
	 */
	TrendingKeyword_demographics_gender_distribution();
	TrendingKeyword_demographics_gender_distribution(char* str);
...
#endif /* _TrendingKeyword_demographics_gender_distribution_H_ */
