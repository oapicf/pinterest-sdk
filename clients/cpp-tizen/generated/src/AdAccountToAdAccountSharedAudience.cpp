...
void
AdAccountToAdAccountSharedAudience::__init()
{
	//audience_id = null;
...
void
AdAccountToAdAccountSharedAudience::__cleanup()
{
	//if(audience_id != NULL) {
	//
	//delete audience_id;
...
void
AdAccountToAdAccountSharedAudience::fromJson(char* jsonStr)
{
...
AdAccountToAdAccountSharedAudience::AdAccountToAdAccountSharedAudience(char* json)
{
	this->fromJson(json);
}

char*
AdAccountToAdAccountSharedAudience::toJson()
{
...
std::string
AdAccountToAdAccountSharedAudience::getAudienceId()
{
	return audience_id;
}

void
AdAccountToAdAccountSharedAudience::setAudienceId(std::string  audience_id)
{
	this->audience_id = audience_id;
}

std::list<Role>
AdAccountToAdAccountSharedAudience::getPermissions()
{
	return permissions;
}

void
AdAccountToAdAccountSharedAudience::setPermissions(std::list <Role> permissions)
{
	this->permissions = permissions;
}

std::list<std::string>
AdAccountToAdAccountSharedAudience::getRecipientAccountIds()
{
	return recipient_account_ids;
}

void
AdAccountToAdAccountSharedAudience::setRecipientAccountIds(std::list <std::string> recipient_account_ids)
{
