...
void
PinAnalyticsDailyMetrics::__init()
{
...
void
PinAnalyticsDailyMetrics::__cleanup()
{
	//if(data_status != NULL) {
	//
	//delete data_status;
...
void
PinAnalyticsDailyMetrics::fromJson(char* jsonStr)
{
...
PinAnalyticsDailyMetrics::PinAnalyticsDailyMetrics(char* json)
{
	this->fromJson(json);
}
...
void
PinAnalyticsDailyMetrics::setMetrics(std::map <string, string> metrics)
{
