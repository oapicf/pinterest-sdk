...
void
ScheduleUpdateRequest::__cleanup()
{
	//if(entity_id != NULL) {
	//
	//delete entity_id;
...
void
ScheduleUpdateRequest::fromJson(char* jsonStr)
{
...
ScheduleUpdateRequest::ScheduleUpdateRequest(char* json)
{
	this->fromJson(json);
}
