...
void
LeadFormArrayResponse_items_inner::__init()
{
	//data = new LeadFormResponse();
	//new std::list()std::list> exceptions;
}

void
LeadFormArrayResponse_items_inner::__cleanup()
{
	//if(data != NULL) {
	//
	//delete data;
...
void
LeadFormArrayResponse_items_inner::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
		...
		if (isprimitive("LeadFormResponse")) {
			jsonToValue(&data, node, "LeadFormResponse", "LeadFormResponse");
		} else {
			
			LeadFormResponse* obj = static_cast<LeadFormResponse*> (&data);
...
LeadFormArrayResponse_items_inner::LeadFormArrayResponse_items_inner(char* json)
{
	this->fromJson(json);
}
...
LeadFormArrayResponse_items_inner::toJson()
{
	...
	JsonNode *node;
	if (isprimitive("LeadFormResponse")) {
		LeadFormResponse obj = getData();
		node = converttoJson(&obj, "LeadFormResponse", "");
	}
	else {
		
		LeadFormResponse obj = static_cast<LeadFormResponse> (getData());
		GError *mygerror;
		mygerror = NULL;
