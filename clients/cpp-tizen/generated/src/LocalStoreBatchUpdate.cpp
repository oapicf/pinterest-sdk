...
void
LocalStoreBatchUpdate::__cleanup()
{
...
void
LocalStoreBatchUpdate::fromJson(char* jsonStr)
{
...
LocalStoreBatchUpdate::LocalStoreBatchUpdate(char* json)
{
	this->fromJson(json);
}
