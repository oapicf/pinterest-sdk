...
void
TargetingSpecOperationLocale::__init()
{
	//field = std::string();
...
void
TargetingSpecOperationLocale::__cleanup()
{
	//if(field != NULL) {
	//
	//delete field;
...
void
TargetingSpecOperationLocale::fromJson(char* jsonStr)
{
...
TargetingSpecOperationLocale::TargetingSpecOperationLocale(char* json)
{
	this->fromJson(json);
}
