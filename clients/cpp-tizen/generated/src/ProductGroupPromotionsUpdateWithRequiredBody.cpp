...
void
ProductGroupPromotionsUpdateWithRequiredBody::__init()
{
...
void
ProductGroupPromotionsUpdateWithRequiredBody::__cleanup()
{
	//if(ad_group_id != NULL) {
	//
	//delete ad_group_id;
...
void
ProductGroupPromotionsUpdateWithRequiredBody::fromJson(char* jsonStr)
{
...
ProductGroupPromotionsUpdateWithRequiredBody::ProductGroupPromotionsUpdateWithRequiredBody(char* json)
{
	this->fromJson(json);
}
