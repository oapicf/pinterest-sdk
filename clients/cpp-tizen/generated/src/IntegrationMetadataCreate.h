...
#ifndef _IntegrationMetadataCreate_H_
#define _IntegrationMetadataCreate_H_
...
class IntegrationMetadataCreate : public Object {
public:
	/*! \brief Constructor.
	 */
	IntegrationMetadataCreate();
	IntegrationMetadataCreate(char* str);
...
#endif /* _IntegrationMetadataCreate_H_ */
