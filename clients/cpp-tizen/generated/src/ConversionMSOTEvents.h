...
#ifndef _ConversionMSOTEvents_H_
#define _ConversionMSOTEvents_H_
...
class ConversionMSOTEvents : public Object {
public:
	/*! \brief Constructor.
	 */
	ConversionMSOTEvents();
	ConversionMSOTEvents(char* str);
...
#endif /* _ConversionMSOTEvents_H_ */
