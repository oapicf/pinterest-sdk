...
#ifndef _AdAccountToBusinessSharedAudience_H_
#define _AdAccountToBusinessSharedAudience_H_
...
class AdAccountToBusinessSharedAudience : public Object {
public:
	/*! \brief Constructor.
	 */
	AdAccountToBusinessSharedAudience();
	AdAccountToBusinessSharedAudience(char* str);
...
#endif /* _AdAccountToBusinessSharedAudience_H_ */
