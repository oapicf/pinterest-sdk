...
#ifndef _UpdateMemberAssetAccessItem_H_
#define _UpdateMemberAssetAccessItem_H_
...
class UpdateMemberAssetAccessItem : public Object {
public:
	/*! \brief Constructor.
	 */
	UpdateMemberAssetAccessItem();
	UpdateMemberAssetAccessItem(char* str);
...
#endif /* _UpdateMemberAssetAccessItem_H_ */
