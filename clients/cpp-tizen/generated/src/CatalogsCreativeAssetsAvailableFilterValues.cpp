...
void
CatalogsCreativeAssetsAvailableFilterValues::__init()
{
...
void
CatalogsCreativeAssetsAvailableFilterValues::__cleanup()
{
...
void
CatalogsCreativeAssetsAvailableFilterValues::fromJson(char* jsonStr)
{
...
CatalogsCreativeAssetsAvailableFilterValues::CatalogsCreativeAssetsAvailableFilterValues(char* json)
{
	this->fromJson(json);
}
