...
#ifndef _SupplementalOperationResult_H_
#define _SupplementalOperationResult_H_
...
class SupplementalOperationResult : public Object {
public:
	/*! \brief Constructor.
	 */
	SupplementalOperationResult();
	SupplementalOperationResult(char* str);
...
#endif /* _SupplementalOperationResult_H_ */
