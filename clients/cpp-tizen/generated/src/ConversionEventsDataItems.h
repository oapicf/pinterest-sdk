...
#ifndef _ConversionEventsDataItems_H_
#define _ConversionEventsDataItems_H_
...
class ConversionEventsDataItems : public Object {
public:
	/*! \brief Constructor.
	 */
	ConversionEventsDataItems();
	ConversionEventsDataItems(char* str);
...
#endif /* _ConversionEventsDataItems_H_ */
