...
void
IntegrationLogsRequestCreate::__init()
{
	//new std::list()std::list> logs;
}

void
IntegrationLogsRequestCreate::__cleanup()
{
	//if(logs != NULL) {
	//logs.RemoveAll(true);
	//delete logs;
...
void
IntegrationLogsRequestCreate::fromJson(char* jsonStr)
{
...
IntegrationLogsRequestCreate::IntegrationLogsRequestCreate(char* json)
{
	this->fromJson(json);
}
