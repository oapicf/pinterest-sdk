...
void
ConversionProductReportCreate::__init()
{
...
void
ConversionProductReportCreate::__cleanup()
{
...
void
ConversionProductReportCreate::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
		...
		if (isprimitive("ConversionProductAttributionType")) {
			jsonToValue(&conversion_product_attribution_type, node, "ConversionProductAttributionType", "ConversionProductAttributionType");
		} else {
			
			ConversionProductAttributionType* obj = static_cast<ConversionProductAttributionType*> (&conversion_product_attribution_type);
			obj->fromJson(json_to_string(node, false));
	...
	if (node !=NULL) {
		...
		if (isprimitive("ConversionProductReportBreakdownType")) {
			jsonToValue(&conversion_product_breakdown, node, "ConversionProductReportBreakdownType", "ConversionProductReportBreakdownType");
		} else {
			
			ConversionProductReportBreakdownType* obj = static_cast<ConversionProductReportBreakdownType*> (&conversion_product_breakdown);
			obj->fromJson(json_to_string(node, false));
	...
	if (node !=NULL) {
		...
		if (isprimitive("ConversionProductReportGranularity")) {
			jsonToValue(&granularity, node, "ConversionProductReportGranularity", "ConversionProductReportGranularity");
		} else {
			
			ConversionProductReportGranularity* obj = static_cast<ConversionProductReportGranularity*> (&granularity);
			obj->fromJson(json_to_string(node, false));
	...
	if (node !=NULL) {
		...
		if (isprimitive("ConversionProductReportLevel")) {
			jsonToValue(&level, node, "ConversionProductReportLevel", "ConversionProductReportLevel");
		} else {
			
			ConversionProductReportLevel* obj = static_cast<ConversionProductReportLevel*> (&level);
			obj->fromJson(json_to_string(node, false));
...
ConversionProductReportCreate::ConversionProductReportCreate(char* json)
{
	this->fromJson(json);
}
...
ConversionProductReportCreate::toJson()
{
	...
	if (isprimitive("ConversionObjectiveType")) {
		list<ConversionObjectiveType> new_list = static_cast<list <ConversionObjectiveType> > (getCampaignObjectiveTypes());
	...
	if (isprimitive("ConversionProductAttributionType")) {
		ConversionProductAttributionType obj = getConversionProductAttributionType();
		node = converttoJson(&obj, "ConversionProductAttributionType", "");
	}
	else {
		
		ConversionProductAttributionType obj = static_cast<ConversionProductAttributionType> (getConversionProductAttributionType());
		GError *mygerror;
		mygerror = NULL;
		node = json_from_string(obj.toJson(), &mygerror);
	...
	if (isprimitive("ConversionProductReportBreakdownType")) {
		ConversionProductReportBreakdownType obj = getConversionProductBreakdown();
		node = converttoJson(&obj, "ConversionProductReportBreakdownType", "");
	}
	else {
		
		ConversionProductReportBreakdownType obj = static_cast<ConversionProductReportBreakdownType> (getConversionProductBreakdown());
		GError *mygerror;
		mygerror = NULL;
		node = json_from_string(obj.toJson(), &mygerror);
	...
	if (isprimitive("ConversionProductReportGranularity")) {
		ConversionProductReportGranularity obj = getGranularity();
		node = converttoJson(&obj, "ConversionProductReportGranularity", "");
	}
	else {
		
		ConversionProductReportGranularity obj = static_cast<ConversionProductReportGranularity> (getGranularity());
		GError *mygerror;
		mygerror = NULL;
		node = json_from_string(obj.toJson(), &mygerror);
	...
	if (isprimitive("ConversionProductReportLevel")) {
		ConversionProductReportLevel obj = getLevel();
		node = converttoJson(&obj, "ConversionProductReportLevel", "");
	}
	else {
		
		ConversionProductReportLevel obj = static_cast<ConversionProductReportLevel> (getLevel());
		GError *mygerror;
		mygerror = NULL;
		node = json_from_string(obj.toJson(), &mygerror);
