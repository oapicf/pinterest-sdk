...
void
CatalogsFeedCreateRequestSchema::__init()
{
...
void
CatalogsFeedCreateRequestSchema::__cleanup()
{
	//if(catalog_id != NULL) {
	//
	//delete catalog_id;
...
void
CatalogsFeedCreateRequestSchema::fromJson(char* jsonStr)
{
...
CatalogsFeedCreateRequestSchema::CatalogsFeedCreateRequestSchema(char* json)
{
	this->fromJson(json);
}
