...
void
CatalogsCreativeAssetsFeedsUpdateRequest::__init()
{
...
void
CatalogsCreativeAssetsFeedsUpdateRequest::__cleanup()
{
...
void
CatalogsCreativeAssetsFeedsUpdateRequest::fromJson(char* jsonStr)
{
...
CatalogsCreativeAssetsFeedsUpdateRequest::CatalogsCreativeAssetsFeedsUpdateRequest(char* json)
{
	this->fromJson(json);
}
