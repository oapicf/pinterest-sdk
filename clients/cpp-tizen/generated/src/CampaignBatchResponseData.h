...
#ifndef _CampaignBatchResponseData_H_
#define _CampaignBatchResponseData_H_
...
class CampaignBatchResponseData : public Object {
public:
	/*! \brief Constructor.
	 */
	CampaignBatchResponseData();
	CampaignBatchResponseData(char* str);
...
#endif /* _CampaignBatchResponseData_H_ */
