...
#ifndef _OauthAccessTokenResponseIntegrationRefresh_H_
#define _OauthAccessTokenResponseIntegrationRefresh_H_
...
/*! \brief A successful OAuth access token response for the refresh token flow, with an added refresh token.
 *
 *  \ingroup Models
 *
 */

class OauthAccessTokenResponseIntegrationRefresh : public Object {
public:
	/*! \brief Constructor.
	 */
	OauthAccessTokenResponseIntegrationRefresh();
	OauthAccessTokenResponseIntegrationRefresh(char* str);
...
#endif /* _OauthAccessTokenResponseIntegrationRefresh_H_ */
