 ...
 */
class PlacementMultipliers : public oatpp::DTO {

  DTO_INIT(PlacementMultipliers, DTO /* Extends */)

  DTO_FIELD(org::openapitools::client::model::PlacementType, PLACEMENT);
  DTO_FIELD(oatpp::Boolean, PLACEMENTIsSet);
