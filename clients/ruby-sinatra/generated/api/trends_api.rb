...
MyApp.add_route('GET', '/v5/trends/editorial_articles', {
  "resourcePath" => "/Trends",
  "summary" => "Returns editorial articles for a given region",
  "nickname" => "trends_editorial_articles/list",
  "responseClass" => "Array<TrendsEditorial>",
  "endpoint" => "/trends/editorial_articles",
