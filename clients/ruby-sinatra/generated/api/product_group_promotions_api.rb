...
MyApp.add_route('POST', '/v5/ad_accounts/{ad_account_id}/product_group_promotions', {
  ...
  "responseClass" => "ProductGroupPromotions",
  ...
  "parameters" => [
    ...
    },
    {
      "name" => "body",
      "description" => "",
      "dataType" => "ProductGroupPromotionsCreate",
      "paramType" => "body",
    }
    ]}) do
  cross_origin
...
MyApp.add_route('PATCH', '/v5/ad_accounts/{ad_account_id}/product_group_promotions', {
  ...
  "parameters" => [
    ...
    },
    {
      "name" => "body",
      "description" => "",
      "dataType" => "ProductGroupPromotionsUpdateWithRequiredBody",
      "paramType" => "body",
    }
    ]}) do
  cross_origin
...
MyApp.add_route('GET', '/v5/ad_accounts/{ad_account_id}/product_groups/analytics', {
  ...
  "responseClass" => "Array<ProductGroupAnalyticsItems>",
