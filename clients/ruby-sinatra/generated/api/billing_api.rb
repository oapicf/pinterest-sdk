...
MyApp.add_route('POST', '/v5/ad_accounts/{ad_account_id}/ads_credit/redeem', {
  ...
  "parameters" => [
    ...
    },
    {
      "name" => "body",
      "description" => "",
      "dataType" => "AdsCreditRedeemCreate",
      "paramType" => "body",
    }
    ]}) do
  cross_origin
...
MyApp.add_route('GET', '/v5/ad_accounts/{ad_account_id}/billing_invoices', {
  ...
  "parameters" => [
    ...
    },
    {
      ...
      "dataType" => "BillingInvoiceSortField",
    ...
    },
    {
      ...
      "dataType" => "BillingInvoiceDocumentType",
...
MyApp.add_route('POST', '/v5/ad_accounts/{ad_account_id}/ssio/insertion_orders', {
  ...
  "responseClass" => "SSIOInsertionOrder",
  ...
  "parameters" => [
    ...
    },
    {
      "name" => "body",
      "description" => "",
      "dataType" => "SSIOInsertionOrderCreate",
      "paramType" => "body",
    }
    ]}) do
  cross_origin
...
MyApp.add_route('PATCH', '/v5/ad_accounts/{ad_account_id}/ssio/insertion_orders', {
  ...
  "parameters" => [
    ...
    },
    {
      "name" => "body",
      "description" => "",
      "dataType" => "SSIOInsertionOrderUpdate",
      "paramType" => "body",
    }
    ]}) do
  cross_origin
