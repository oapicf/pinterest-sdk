...
module SchedulesApiHandlers =
    ...
    /// Create schedules
    /// </summary>
   [<FunctionName("SchedulesCreate")>]
    let SchedulesCreate
        ([<HttpTrigger(Extensions.Http.AuthorizationLevel.Anonymous, "POST", Route = "/v5/ad_accounts/{ad_account_id}/schedules")>]
        req:HttpRequest ) =
      ...
      let bind (contentType:string) body  =
        ...
        | "application/json" ->
          body |> JsonConvert.DeserializeObject<SchedulesCreateBodyParams>
        | _ -> failwith (sprintf "TODO - ContentType %s not currently supported" contentType)

      let bodyParams = reader.ReadToEnd() |> bind req.ContentType
      let result = SchedulesApiService.SchedulesCreate bodyParams
      match result with
    ...
    /// Get Schedules
    /// </summary>
   [<FunctionName("SchedulesList")>]
    let SchedulesList
        ([<HttpTrigger(Extensions.Http.AuthorizationLevel.Anonymous, "GET", Route = "/v5/ad_accounts/{ad_account_id}/schedules")>]
        req:HttpRequest ) =

      let result = SchedulesApiService.SchedulesList ()
      match result with
    ...
    /// Update schedules
    /// </summary>
   [<FunctionName("SchedulesUpdate")>]
    let SchedulesUpdate
        ([<HttpTrigger(Extensions.Http.AuthorizationLevel.Anonymous, "PATCH", Route = "/v5/ad_accounts/{ad_account_id}/schedules")>]
        req:HttpRequest ) =
      ...
      let bind (contentType:string) body  =
        match (contentType.ToLower()) with
        | "application/json" ->
          body |> JsonConvert.DeserializeObject<SchedulesUpdateBodyParams>
        | _ -> failwith (sprintf "TODO - ContentType %s not currently supported" contentType)

      let bodyParams = reader.ReadToEnd() |> bind req.ContentType
      let result = SchedulesApiService.SchedulesUpdate bodyParams
      match result with
