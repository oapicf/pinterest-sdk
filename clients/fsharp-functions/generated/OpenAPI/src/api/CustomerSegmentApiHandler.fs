...
module CustomerSegmentApiHandlers =
    ...
    /// </summary>
   [<FunctionName("CustomerSegmentCreate")>]
    let CustomerSegmentCreate
        ([<HttpTrigger(Extensions.Http.AuthorizationLevel.Anonymous, "POST", Route = "/v5/ad_accounts/{ad_account_id}/customer_segments")>]
        req:HttpRequest ) =
      ...
      let bind (contentType:string) body  =
        ...
        | "application/json" ->
          body |> JsonConvert.DeserializeObject<CustomerSegmentCreateBodyParams>
        | _ -> failwith (sprintf "TODO - ContentType %s not currently supported" contentType)

      let bodyParams = reader.ReadToEnd() |> bind req.ContentType
      let result = CustomerSegmentApiService.CustomerSegmentCreate bodyParams
      match result with
    ...
    /// </summary>
   [<FunctionName("CustomerSegmentList")>]
    let CustomerSegmentList
        ([<HttpTrigger(Extensions.Http.AuthorizationLevel.Anonymous, "GET", Route = "/v5/ad_accounts/{ad_account_id}/customer_segments")>]
        req:HttpRequest ) =

      let result = CustomerSegmentApiService.CustomerSegmentList ()
      match result with
    ...
    /// </summary>
   [<FunctionName("CustomerSegmentUpdate")>]
    let CustomerSegmentUpdate
        ([<HttpTrigger(Extensions.Http.AuthorizationLevel.Anonymous, "PATCH", Route = "/v5/ad_accounts/{ad_account_id}/customer_segments")>]
        req:HttpRequest ) =
      ...
      let bind (contentType:string) body  =
        match (contentType.ToLower()) with
        | "application/json" ->
          body |> JsonConvert.DeserializeObject<CustomerSegmentUpdateBodyParams>
        | _ -> failwith (sprintf "TODO - ContentType %s not currently supported" contentType)

      let bodyParams = reader.ReadToEnd() |> bind req.ContentType
      let result = CustomerSegmentApiService.CustomerSegmentUpdate bodyParams
      match result with
