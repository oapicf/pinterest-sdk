...
module ConversionsApiHandlers =
    ...
    /// </summary>
   [<FunctionName("AdvertiserDefinedEventsCreate")>]
    let AdvertiserDefinedEventsCreate
        ([<HttpTrigger(Extensions.Http.AuthorizationLevel.Anonymous, "POST", Route = "/v5/ad_accounts/{ad_account_id}/advertiser_defined_events")>]
        req:HttpRequest ) =
      ...
      let bind (contentType:string) body  =
        ...
        | "application/json" ->
          body |> JsonConvert.DeserializeObject<AdvertiserDefinedEventsCreateBodyParams>
        | _ -> failwith (sprintf "TODO - ContentType %s not currently supported" contentType)

      let bodyParams = reader.ReadToEnd() |> bind req.ContentType
      let result = ConversionsApiService.AdvertiserDefinedEventsCreate bodyParams
      match result with
    ...
    /// </summary>
   [<FunctionName("AdvertiserDefinedEventsDelete")>]
    let AdvertiserDefinedEventsDelete
        ([<HttpTrigger(Extensions.Http.AuthorizationLevel.Anonymous, "DELETE", Route = "/v5/ad_accounts/{ad_account_id}/advertiser_defined_events")>]
        req:HttpRequest ) =

      let result = ConversionsApiService.AdvertiserDefinedEventsDelete ()
      match result with
   ...
   [<FunctionName("AdvertiserDefinedEventsGet")>]
    ...
    /// </summary>
   [<FunctionName("AdvertiserDefinedEventsUpdate")>]
    let AdvertiserDefinedEventsUpdate
        ([<HttpTrigger(Extensions.Http.AuthorizationLevel.Anonymous, "PATCH", Route = "/v5/ad_accounts/{ad_account_id}/advertiser_defined_events")>]
        req:HttpRequest ) =
      ...
      let bind (contentType:string) body  =
        match (contentType.ToLower()) with
        | "application/json" ->
          body |> JsonConvert.DeserializeObject<AdvertiserDefinedEventsUpdateBodyParams>
        | _ -> failwith (sprintf "TODO - ContentType %s not currently supported" contentType)

      let bodyParams = reader.ReadToEnd() |> bind req.ContentType
      let result = ConversionsApiService.AdvertiserDefinedEventsUpdate bodyParams
      match result with
