...
module ProductCategoriesApiHandlers =
   ...
   [<FunctionName("TrendsFeaturedTopicsList")>]
    let TrendsFeaturedTopicsList
      ...
      let result = ProductCategoriesApiService.TrendsFeaturedTopicsList ()
      match result with
   ...
   [<FunctionName("TrendsProductCategoriesDetailsList")>]
    let TrendsProductCategoriesDetailsList
      ...
      let result = ProductCategoriesApiService.TrendsProductCategoriesDetailsList ()
      match result with
   ...
   [<FunctionName("TrendsProductCategoriesTrendingList")>]
    let TrendsProductCategoriesTrendingList
      ...
      let result = ProductCategoriesApiService.TrendsProductCategoriesTrendingList ()
      match result with
