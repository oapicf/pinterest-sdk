...
module CatalogSupplementalApiHandlers =
    ...
    /// </summary>
   [<FunctionName("CatalogsLocalInventoryItemsBatchOperate")>]
    let CatalogsLocalInventoryItemsBatchOperate
        ([<HttpTrigger(Extensions.Http.AuthorizationLevel.Anonymous, "POST", Route = "/v5/catalogs/{catalog_id}/local_inventory_items/batch")>]
        req:HttpRequest ) =
      ...
      let bind (contentType:string) body  =
        ...
        | "application/json" ->
          body |> JsonConvert.DeserializeObject<CatalogsLocalInventoryItemsBatchOperateBodyParams>
        | _ -> failwith (sprintf "TODO - ContentType %s not currently supported" contentType)

      let bodyParams = reader.ReadToEnd() |> bind req.ContentType
      let result = CatalogSupplementalApiService.CatalogsLocalInventoryItemsBatchOperate bodyParams
      match result with
    ...
    /// </summary>
   [<FunctionName("CatalogsLocalInventoryItemsPost")>]
    let CatalogsLocalInventoryItemsPost
        ([<HttpTrigger(Extensions.Http.AuthorizationLevel.Anonymous, "POST", Route = "/v5/catalogs/{catalog_id}/local_inventory_items/query")>]
        req:HttpRequest ) =
      ...
      let bind (contentType:string) body  =
        match (contentType.ToLower()) with
        | "application/json" ->
          body |> JsonConvert.DeserializeObject<CatalogsLocalInventoryItemsPostBodyParams>
        | _ -> failwith (sprintf "TODO - ContentType %s not currently supported" contentType)

      let bodyParams = reader.ReadToEnd() |> bind req.ContentType
      let result = CatalogSupplementalApiService.CatalogsLocalInventoryItemsPost bodyParams
      match result with
    ...
    /// Create local stores
    /// </summary>
   [<FunctionName("CatalogsLocalStoresCreate")>]
    let CatalogsLocalStoresCreate
        ([<HttpTrigger(Extensions.Http.AuthorizationLevel.Anonymous, "POST", Route = "/v5/catalogs/{catalog_id}/local_stores")>]
        req:HttpRequest ) =
      ...
      let bind (contentType:string) body  =
        match (contentType.ToLower()) with
        | "application/json" ->
          body |> JsonConvert.DeserializeObject<CatalogsLocalStoresCreateBodyParams>
        | _ -> failwith (sprintf "TODO - ContentType %s not currently supported" contentType)

      let bodyParams = reader.ReadToEnd() |> bind req.ContentType
      let result = CatalogSupplementalApiService.CatalogsLocalStoresCreate bodyParams
      match result with
    ...
    /// Delete local stores
    /// </summary>
   [<FunctionName("CatalogsLocalStoresDelete")>]
    let CatalogsLocalStoresDelete
        ([<HttpTrigger(Extensions.Http.AuthorizationLevel.Anonymous, "DELETE", Route = "/v5/catalogs/{catalog_id}/local_stores")>]
        req:HttpRequest ) =

      let result = CatalogSupplementalApiService.CatalogsLocalStoresDelete ()
      match result with
    ...
    /// List local stores
    /// </summary>
   [<FunctionName("CatalogsLocalStoresList")>]
    let CatalogsLocalStoresList
        ([<HttpTrigger(Extensions.Http.AuthorizationLevel.Anonymous, "GET", Route = "/v5/catalogs/{catalog_id}/local_stores")>]
        req:HttpRequest ) =

      let result = CatalogSupplementalApiService.CatalogsLocalStoresList ()
      match result with
    ...
    /// Update local stores
    /// </summary>
   [<FunctionName("CatalogsLocalStoresUpdate")>]
    let CatalogsLocalStoresUpdate
        ([<HttpTrigger(Extensions.Http.AuthorizationLevel.Anonymous, "PATCH", Route = "/v5/catalogs/{catalog_id}/local_stores")>]
        req:HttpRequest ) =
      ...
      let bind (contentType:string) body  =
        match (contentType.ToLower()) with
        | "application/json" ->
          body |> JsonConvert.DeserializeObject<CatalogsLocalStoresUpdateBodyParams>
        | _ -> failwith (sprintf "TODO - ContentType %s not currently supported" contentType)

      let bodyParams = reader.ReadToEnd() |> bind req.ContentType
      let result = CatalogSupplementalApiService.CatalogsLocalStoresUpdate bodyParams
      match result with
    ...
    /// </summary>
   [<FunctionName("CatalogsSupplementalItemsBatchGet")>]
    let CatalogsSupplementalItemsBatchGet
        ([<HttpTrigger(Extensions.Http.AuthorizationLevel.Anonymous, "GET", Route = "/v5/catalogs/{catalog_id}/supplemental_items/batch/{batch_id}")>]
        req:HttpRequest ) =

      let result = CatalogSupplementalApiService.CatalogsSupplementalItemsBatchGet ()
      match result with
