...
module AdGroupsApiHandlers =
   ...
   [<FunctionName("AdGroupsCreate")>]
    ...
    /// </summary>
   [<FunctionName("AdGroupsDynamicTitlesDownloadCsv")>]
    let AdGroupsDynamicTitlesDownloadCsv
        ([<HttpTrigger(Extensions.Http.AuthorizationLevel.Anonymous, "GET", Route = "/v5/ad_accounts/{ad_account_id}/ad_groups/{ad_group_id}/dynamic_titles/csv")>]
        req:HttpRequest ) =

      let result = AdGroupsApiService.AdGroupsDynamicTitlesDownloadCsv ()
      match result with
    ...
    /// </summary>
   [<FunctionName("AdGroupsDynamicTitlesGetStatus")>]
    let AdGroupsDynamicTitlesGetStatus
        ([<HttpTrigger(Extensions.Http.AuthorizationLevel.Anonymous, "GET", Route = "/v5/ad_accounts/{ad_account_id}/ad_groups/{ad_group_id}/dynamic_titles/status")>]
        req:HttpRequest ) =

      let result = AdGroupsApiService.AdGroupsDynamicTitlesGetStatus ()
      match result with
    ...
    /// </summary>
   [<FunctionName("AdGroupsDynamicTitlesGetUploadUrl")>]
    let AdGroupsDynamicTitlesGetUploadUrl
        ([<HttpTrigger(Extensions.Http.AuthorizationLevel.Anonymous, "GET", Route = "/v5/ad_accounts/{ad_account_id}/ad_groups/{ad_group_id}/dynamic_titles/uploads")>]
        req:HttpRequest ) =

      let result = AdGroupsApiService.AdGroupsDynamicTitlesGetUploadUrl ()
      match result with
    ...
    /// </summary>
   [<FunctionName("AdGroupsDynamicTitlesProcessCsv")>]
    let AdGroupsDynamicTitlesProcessCsv
        ([<HttpTrigger(Extensions.Http.AuthorizationLevel.Anonymous, "POST", Route = "/v5/ad_accounts/{ad_account_id}/ad_groups/{ad_group_id}/dynamic_titles")>]
        req:HttpRequest ) =
      ...
      let bind (contentType:string) body  =
        match (contentType.ToLower()) with
        | "application/json" ->
          body |> JsonConvert.DeserializeObject<AdGroupsDynamicTitlesProcessCsvBodyParams>
        | _ -> failwith (sprintf "TODO - ContentType %s not currently supported" contentType)

      let bodyParams = reader.ReadToEnd() |> bind req.ContentType
      let result = AdGroupsApiService.AdGroupsDynamicTitlesProcessCsv bodyParams
      match result with
   ...
   [<FunctionName("AdGroupsUpdate")>]
    ...
    /// </summary>
   [<FunctionName("GetAdGroupsByPromotionIdsList")>]
    let GetAdGroupsByPromotionIdsList
        ([<HttpTrigger(Extensions.Http.AuthorizationLevel.Anonymous, "GET", Route = "/v5/ad_accounts/{ad_account_id}/promotion_applied_entities")>]
        req:HttpRequest ) =

      let result = AdGroupsApiService.GetAdGroupsByPromotionIdsList ()
      match result with
