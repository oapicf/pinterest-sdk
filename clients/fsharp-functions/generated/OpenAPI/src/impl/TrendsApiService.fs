...
module TrendsApiServiceImplementation =

    //#region Service implementation
    type TrendsApiServiceImpl() =
      interface ITrendsApiService with

        member this.TrendsEditorialArticlesList () =
          if true then
            let content = "The request has succeeded." :> obj :?> TrendsEditorial[] // this cast is obviously wrong, and is only intended to allow generated project to compile   
            TrendsEditorialArticlesListStatusCode200 { content = content }
          else if true then
            ...
            TrendsEditorialArticlesListStatusCode400 { content = content }
          else if true then
            ...
            TrendsEditorialArticlesListStatusCode401 { content = content }
          else if true then
            ...
            TrendsEditorialArticlesListStatusCode403 { content = content }
          else if true then
            ...
            TrendsEditorialArticlesListStatusCode404 { content = content }
          else if true then
            ...
            TrendsEditorialArticlesListStatusCode429 { content = content }
          else
            ...
            TrendsEditorialArticlesListDefaultStatusCode { content = content }

        member this.TrendsFeaturedTopicsList () =
          if true then
        ...
        member this.TrendsProductCategoriesDetailsList () =
          if true then
        ...
        member this.TrendsProductCategoriesTrendingList () =
          if true then
    ...
    let TrendsApiService = TrendsApiServiceImpl() :> ITrendsApiService