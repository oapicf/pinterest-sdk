...
module UserAccountApiServiceImplementation =
    ...
    type UserAccountApiServiceImpl() =
      interface IUserAccountApiService with
        ...
        member this.BoardsUserFollowsList () =
          if true then
        ...
        member this.FollowUserUpdate (parameters:FollowUserUpdateBodyParams) =
          if true then
        ...
        member this.LinkedBusinessAccountsGet () =
          if true then
        ...
        member this.UnverifyWebsiteDelete () =
          if true then
        ...
        member this.UserAccountAnalytics () =
          if true then
        ...
        member this.UserAccountAnalyticsTopPins () =
          if true then
        ...
        member this.UserAccountAnalyticsTopVideoPins () =
          if true then
        ...
        member this.UserAccountFollowedInterests () =
          if true then
        ...
        member this.VerifyWebsiteUpdate (parameters:VerifyWebsiteUpdateBodyParams) =
          if true then
        ...
        member this.WebsiteVerificationGet () =
          if true then
