...
module CatalogSupplementalApiServiceImplementation =
    ...
    type CatalogSupplementalApiServiceImpl() =
      interface ICatalogSupplementalApiService with
        ...
        member this.CatalogsLocalInventoryItemsBatchOperate (parameters:CatalogsLocalInventoryItemsBatchOperateBodyParams) =
          if true then
        ...
        member this.CatalogsLocalInventoryItemsPost (parameters:CatalogsLocalInventoryItemsPostBodyParams) =
          if true then
        ...
        member this.CatalogsLocalStoresCreate (parameters:CatalogsLocalStoresCreateBodyParams) =
          if true then
        ...
        member this.CatalogsLocalStoresDelete () =
          if true then
        ...
        member this.CatalogsLocalStoresList () =
          if true then
        ...
        member this.CatalogsLocalStoresUpdate (parameters:CatalogsLocalStoresUpdateBodyParams) =
          if true then
            let content = "The request has succeeded." :> obj :?> CatalogsLocalStoresCreate200ResponseInner[] // this cast is obviously wrong, and is only intended to allow generated project to compile   
        ...
        member this.CatalogsSupplementalItemsBatchGet () =
          if true then
            let content = "The request has succeeded." :> obj :?> SupplementalItemsBatchResponse // this cast is obviously wrong, and is only intended to allow generated project to compile   
