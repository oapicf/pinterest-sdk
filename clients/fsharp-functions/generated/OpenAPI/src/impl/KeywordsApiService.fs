...
module KeywordsApiServiceImplementation =
    ...
    type KeywordsApiServiceImpl() =
      interface IKeywordsApiService with
        ...
        member this.CountryKeywordsMetricsGet () =
          if true then
        ...
        member this.KeywordsCreate (parameters:KeywordsCreateBodyParams) =
          if true then
        ...
        member this.KeywordsUpdate (parameters:KeywordsUpdateBodyParams) =
          if true then
            let content = "Success" :> obj :?> KeywordsResponse // this cast is obviously wrong, and is only intended to allow generated project to compile   
        ...
        member this.TrendingKeywordsList () =
          if true then
