...
module BusinessAccessAssetsApiServiceImplementation =
    ...
    type BusinessAccessAssetsApiServiceImpl() =
      interface IBusinessAccessAssetsApiService with
        ...
        member this.AssetGroupCreate (parameters:AssetGroupCreateBodyParams) =
          if true then
        ...
        member this.AssetGroupDelete (parameters:AssetGroupDeleteBodyParams) =
          if true then
        ...
        member this.AssetGroupUpdate (parameters:AssetGroupUpdateBodyParams) =
          if true then
        ...
        member this.BusinessAssetMembersGet () =
          if true then
        ...
        member this.BusinessAssetPartnersGet () =
          if true then
        ...
        member this.BusinessMemberAssetsGet () =
          if true then
        ...
        member this.BusinessMembersAssetAccessDelete (parameters:BusinessMembersAssetAccessDeleteBodyParams) =
          if true then
        ...
        member this.BusinessMembersAssetAccessUpdate (parameters:BusinessMembersAssetAccessUpdateBodyParams) =
          if true then
        ...
        member this.BusinessPartnerAssetAccessGet () =
          if true then
        ...
        member this.DeletePartnerAssetAccessHandlerImpl (parameters:DeletePartnerAssetAccessHandlerImplBodyParams) =
          if true then
        ...
        member this.UpdatePartnerAssetAccessHandlerImpl (parameters:UpdatePartnerAssetAccessHandlerImplBodyParams) =
          if true then
