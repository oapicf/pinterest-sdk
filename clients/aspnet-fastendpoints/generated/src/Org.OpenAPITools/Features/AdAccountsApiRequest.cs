...
public class AdAccountAnalyticsRequest
{
    /// <summary>
...
public class AdAccountTargetingAnalyticsGetRequest
{
    /// <summary>
    /// Unique identifier of an ad account.
    /// </summary>
    ...
    public List<AdsAnalyticsAccountTargetingType> TargetingTypes { get; set; }
    /// <summary>
    /// Columns to retrieve, encoded as a comma-separated string. **NOTE**: Any metrics defined as MICRO_DOLLARS returns a value based on the advertiser profile&#39;s currency field. For USD, ($1/1,000,000, or $0.000001 - one one-ten-thousandth of a cent). it&#39;s microdollars. Otherwise, it&#39;s in microunits of the advertiser&#39;s currency.  For example, if the advertiser&#39;s currency is GBP (British pound sterling), all MICRO_DOLLARS fields will be in GBP microunits (1/1,000,000 British pound).  If a column has no value, it may not be returned.
    /// </summary>
    [FastEndpoints.QueryParam, FastEndpoints.BindFrom("columns")]
...
public class AdAccountsCreateRequest
{
    /// <summary>
    /// 
    /// </summary>
    [FastEndpoints.FromBody]
    public AdAccountCreate adAccountCreate { get; set; }
}
public class AdAccountsGetRequest
{
    /// <summary>
    /// 
    /// </summary>
...
public class AdAccountsListRequest
{
    /// <summary>
    /// Include shared ad accounts
    /// </summary>
    [FastEndpoints.QueryParam, FastEndpoints.BindFrom("include_shared_accounts")]
...
public class AnalyticsCreateConversionProductReportRequest
{
    /// <summary>
    /// Unique identifier of an ad account.
    /// </summary>
    ...
    /// </summary>
    [FastEndpoints.FromBody]
    public ConversionProductReportCreate conversionProductReportCreate { get; set; }
}
public class AnalyticsCreateMmmReportRequest
{
    /// <summary>
    /// 
    /// </summary>
    ...
    /// </summary>
    [FastEndpoints.FromBody]
    public MMMReportCreate mMMReportCreate { get; set; }
}
public class AnalyticsCreateReportRequest
{
    /// <summary>
    /// Unique identifier of an ad account.
    /// </summary>
    ...
    /// </summary>
    [FastEndpoints.FromBody]
    public AdsAnalyticsCreateAsyncRequest adsAnalyticsCreateAsyncRequest { get; set; }
}
public class AnalyticsCreateTemplateReportRequest
{
    /// <summary>
    /// 
    /// </summary>
    ...
    /// </summary>
    [FastEndpoints.BindFrom("template_id")]
...
public class AnalyticsGetConversionProductReportRequest
{
    /// <summary>
    /// Unique identifier of an ad account.
    /// </summary>
...
public class AnalyticsGetMmmReportRequest
{
    /// <summary>
    /// 
    /// </summary>
...
public class AnalyticsGetReportRequest
{
    /// <summary>
    /// Unique identifier of an ad account.
    /// </summary>
...
public class SandboxDeleteRequest
{
    /// <summary>
    /// Unique identifier of an ad account.
    /// </summary>
...
public class TemplatesListRequest
{
    /// <summary>
    /// Unique identifier of an ad account.
    /// </summary>
