...
public class SchedulesCreateEndpoint : FastEndpoints.Endpoint<SchedulesCreateRequest, List<SchedulesCreate200ResponseInner>>
{
    public override void Configure()
    {
        ...
        Summary(s => {
            s.Summary = "Create schedules";
            s.RequestParam(r => r.AdAccountId, "");
            s.RequestParam(r => r.scheduleCreate, "");
    ...
    public override async Task HandleAsync(SchedulesCreateRequest req, CancellationToken ct)
    {
        //Response = new()
        //{
            //...
...
public class SchedulesListEndpoint : FastEndpoints.Endpoint<SchedulesListRequest, SchedulesList200Response>
{
    public override void Configure()
    {
        ...
        Summary(s => {
            s.Summary = "Get Schedules";
            s.RequestParam(r => r.AdAccountId, "");
            s.RequestParam(r => r.EntityIds, "List of Entity IDs, must be associated with the Ad Accound ID provided in the path.");
            ...
            s.RequestParam(r => r.ScheduleStatuses, "Filter schedules by status (one or more)");
            s.RequestParam(r => r.ScheduleType, "Filter schedules by a type");
            s.Responses[200] = "The request has succeeded.";
            s.Responses[400] = "The request could not be understood by the server due to unexpected data.";
            s.Responses[401] = "Authentication is required and has either failed or not been provided.";
            s.Responses[403] = "The request was valid, but the server is refusing action. The user might not have the necessary permissions for a resource.";
    ...
    public override async Task HandleAsync(SchedulesListRequest req, CancellationToken ct)
    {
        //Response = new()
        //{
            //...
...
public class SchedulesUpdateEndpoint : FastEndpoints.Endpoint<SchedulesUpdateRequest, List<SchedulesCreate200ResponseInner>>
{
    public override void Configure()
    {
        ...
        Summary(s => {
            s.Summary = "Update schedules";
            s.RequestParam(r => r.AdAccountId, "");
            s.RequestParam(r => r.scheduleBatchUpdate, "");
            s.Responses[200] = "The request has succeeded.";
            s.Responses[400] = "The request could not be understood by the server due to unexpected data.";
            s.Responses[401] = "Authentication is required and has either failed or not been provided.";
            s.Responses[403] = "The request was valid, but the server is refusing action. The user might not have the necessary permissions for a resource.";
    ...
    public override async Task HandleAsync(SchedulesUpdateRequest req, CancellationToken ct)
    {
        //Response = new()
        //{
            //...
