...
public class AdPreviewsCreateRequest
{
    /// <summary>
    ...
    public AdPreviewRequest adPreviewRequest { get; set; }
}
public class AdTargetingAnalyticsGetRequest
{
    /// <summary>
    /// Unique identifier of an ad account.
    /// </summary>
    ...
    /// </summary>
    [FastEndpoints.QueryParam, FastEndpoints.BindFrom("ad_ids")]
    ...
    public List<AdsAnalyticsAdTargetingType> TargetingTypes { get; set; }
    /// <summary>
...
public class AdsAnalyticsRequest
{
    /// <summary>
    /// Unique identifier of an ad account.
    /// </summary>
...
public class AdsCreateRequest
{
    ...
    /// </summary>
    [FastEndpoints.FromBody]
    public List<AdCreate> adCreate { get; set; }
}
public class AdsGetRequest
{
    /// <summary>
    /// The ID of this ad.
    /// </summary>
    [FastEndpoints.BindFrom("ad_id")]
...
public class AdsUpdateRequest
{
    ...
    /// </summary>
    [FastEndpoints.FromBody]
    public List<AdBatchUpdate> adBatchUpdate { get; set; }
}
public class CampaignAdPreviewCreateRequest
{
    /// <summary>
    /// Unique identifier of an ad account.
    /// </summary>
    ...
    /// </summary>
    [FastEndpoints.FromBody]
    public List<CampaignAdPreviewCreate> campaignAdPreviewCreate { get; set; }
}
public class CampaignAdPreviewDeleteRequest
{
    /// <summary>
    /// Unique identifier of an ad account.
    /// </summary>
...
public class CampaignAdPreviewReadRequest
{
    /// <summary>
    /// Unique identifier of an ad account.
    /// </summary>
