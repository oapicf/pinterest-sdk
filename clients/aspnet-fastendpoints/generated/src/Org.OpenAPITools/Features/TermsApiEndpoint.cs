...
public class TermsRelatedListEndpoint : FastEndpoints.Endpoint<TermsRelatedListRequest, RelatedTerms>
{
    public override void Configure()
    {
        ...
        Summary(s => {
            s.Summary = "List related terms";
            s.RequestParam(r => r.Terms, "List of input terms.");
    ...
    public override async Task HandleAsync(TermsRelatedListRequest req, CancellationToken ct)
    {
        //Response = new()
        //{
            //...
...
public class TermsSuggestedListEndpoint : FastEndpoints.Endpoint<TermsSuggestedListRequest, List<string>>
{
    public override void Configure()
    {
        ...
        Summary(s => {
            s.Summary = "List suggested terms";
            s.RequestParam(r => r.Term, "Input term.");
            s.RequestParam(r => r.Limit, "Max suggested terms to return.");
            s.Responses[200] = "The request has succeeded.";
            s.Responses[400] = "The request could not be understood by the server due to unexpected data.";
            s.Responses[401] = "Authentication is required and has either failed or not been provided.";
            s.Responses[403] = "The request was valid, but the server is refusing action. The user might not have the necessary permissions for a resource.";
    ...
    public override async Task HandleAsync(TermsSuggestedListRequest req, CancellationToken ct)
    {
        //Response = new()
        //{
            //...
