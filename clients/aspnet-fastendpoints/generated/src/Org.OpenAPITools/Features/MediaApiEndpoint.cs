...
public class MediaCreateEndpoint : FastEndpoints.Endpoint<MediaCreateRequest, MediaUpload>
{
    public override void Configure()
    {
        ...
        Summary(s => {
            s.Summary = "Register media upload";
            s.RequestParam(r => r.mediaUploadCreate, "");
    ...
    public override async Task HandleAsync(MediaCreateRequest req, CancellationToken ct)
    {
        //Response = new()
        //{
            //...
...
public class MediaGetEndpoint : FastEndpoints.Endpoint<MediaGetRequest, Media>
{
    public override void Configure()
    {
        ...
        Summary(s => {
            s.Summary = "Get media upload details";
            s.RequestParam(r => r.MediaId, "Unique identifier for this media upload. Used to track status and for attaching during Pin creation.");
            s.Responses[200] = "The request has succeeded.";
            s.Responses[400] = "The request could not be understood by the server due to unexpected data.";
            s.Responses[401] = "Authentication is required and has either failed or not been provided.";
            s.Responses[403] = "The request was valid, but the server is refusing action. The user might not have the necessary permissions for a resource.";
    ...
    public override async Task HandleAsync(MediaGetRequest req, CancellationToken ct)
    {
        //Response = new()
        //{
            //...
...
public class MediaListEndpoint : FastEndpoints.Endpoint<MediaListRequest, MediaList200Response>
{
    public override void Configure()
    {
        Get("/v5/media");
    ...
    public override async Task HandleAsync(MediaListRequest req, CancellationToken ct)
    {
        //Response = new()
        //{
            //...
