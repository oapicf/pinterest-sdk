...
public class CustomerSegmentCreateRequest
{
    /// <summary>
    ...
    public CustomerSegmentCreate customerSegmentCreate { get; set; }
}
public class CustomerSegmentListRequest
{
    /// <summary>
    /// Unique identifier of an ad account.
    /// </summary>
...
public class CustomerSegmentUpdateRequest
{
    /// <summary>
    /// Unique identifier of an ad account.
    /// </summary>
    ...
    /// </summary>
    [FastEndpoints.FromBody]
    public CustomerSegmentUpdateRequestUpdateWithRequiredBody customerSegmentUpdateRequestUpdateWithRequiredBody { get; set; }
}
