...
public class TargetingTemplateCreateEndpoint : FastEndpoints.Endpoint<TargetingTemplateCreateRequest, TargetingTemplate>
{
    public override void Configure()
    {
        ...
        Summary(s => {
            s.Summary = "Create targeting templates";
            s.RequestParam(r => r.AdAccountId, "Unique identifier of an ad account.");
            s.RequestParam(r => r.targetingTemplateCreate, "");
    ...
    public override async Task HandleAsync(TargetingTemplateCreateRequest req, CancellationToken ct)
    {
        //Response = new()
        //{
            //...
...
public class TargetingTemplateListEndpoint : FastEndpoints.Endpoint<TargetingTemplateListRequest, TargetingTemplateList200Response>
{
    public override void Configure()
    {
        ...
        Summary(s => {
            s.Summary = "List targeting templates";
            s.RequestParam(r => r.AdAccountId, "Unique identifier of an ad account.");
    ...
    public override async Task HandleAsync(TargetingTemplateListRequest req, CancellationToken ct)
    {
        //Response = new()
        //{
            //...
...
public class TargetingTemplateUpdateEndpoint : FastEndpoints.Endpoint<TargetingTemplateUpdateRequest>
{
    public override void Configure()
    {
        ...
        Summary(s => {
            s.Summary = "Update targeting templates";
            s.RequestParam(r => r.AdAccountId, "Unique identifier of an ad account.");
            s.RequestParam(r => r.targetingTemplateUpdateRequestReadOrUpdate, "");
            s.Responses[200] = "The request has succeeded.";
            s.Responses[400] = "The request could not be understood by the server due to unexpected data.";
            s.Responses[401] = "Authentication is required and has either failed or not been provided.";
            s.Responses[403] = "The request was valid, but the server is refusing action. The user might not have the necessary permissions for a resource.";
    ...
    public override async Task HandleAsync(TargetingTemplateUpdateRequest req, CancellationToken ct)
    {
        //Response = new()
        //{
            //...
