...
public class CatalogsAvailableFilterValuesEndpoint : FastEndpoints.Endpoint<CatalogsAvailableFilterValuesRequest, CatalogsAvailableFilterValues>
{
    public override void Configure()
    {
        ...
        Summary(s => {
            s.Summary = "List available filter values";
            s.RequestParam(r => r.CatalogId, "Filter entities for a given catalog_id.");
            s.RequestParam(r => r.FeedId, "Filter entities for a given feed_id. If not given, all feeds are considered.");
            s.RequestParam(r => r.Country, "Country for the Catalogs Items");
            s.RequestParam(r => r.Language, "Language for the Catalogs Items");
    ...
    public override async Task HandleAsync(CatalogsAvailableFilterValuesRequest req, CancellationToken ct)
    {
        //Response = new()
        //{
            //...
...
public class CatalogsCreateEndpoint : FastEndpoints.Endpoint<CatalogsCreateRequest, Catalog>
{
    public override void Configure()
    {
        Post("/v5/catalogs");
        ...
        Summary(s => {
            s.Summary = "Create catalog";
            s.RequestParam(r => r.catalogCreate, "");
            s.RequestParam(r => r.AdAccountId, "Unique identifier of an ad account.");
            s.Responses[200] = "The request has succeeded.";
    ...
    public override async Task HandleAsync(CatalogsCreateRequest req, CancellationToken ct)
    {
        //Response = new()
        //{
            //...
...
public class CatalogsListEndpoint : FastEndpoints.Endpoint<CatalogsListRequest, CatalogsList200Response>
{
    public override void Configure()
    {
        Get("/v5/catalogs");
    ...
    public override async Task HandleAsync(CatalogsListRequest req, CancellationToken ct)
    {
        //Response = new()
        //{
            //...
