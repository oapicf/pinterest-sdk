 ...
 */
function audienceInsightsGetRaw<T>(requestParameters: AudienceInsightsGetRequest, requestConfig: runtime.TypedQueryConfig<T, AudienceInsights> = {}): QueryConfig<T> {
    ...
    if (requestTransform) {
        config.transform = (body: ResponseBody, text: ResponseBody) => requestTransform(AudienceInsightsFromJSON(body), text);
    }
...
* Get audience insights
*/
export function audienceInsightsGet<T>(requestParameters: AudienceInsightsGetRequest, requestConfig?: runtime.TypedQueryConfig<T, AudienceInsights>): QueryConfig<T> {
 ...
 */
function audienceInsightsScopeAndTypeGetRaw<T>(requestParameters: AudienceInsightsScopeAndTypeGetRequest, requestConfig: runtime.TypedQueryConfig<T, AudienceInsightsScopeAndTypeGet200Response> = {}): QueryConfig<T> {
    if (requestParameters.adAccountId === null || requestParameters.adAccountId === undefined) {
    ...
    const { transform: requestTransform } = requestConfig;
    if (requestTransform) {
        config.transform = (body: ResponseBody, text: ResponseBody) => requestTransform(AudienceInsightsScopeAndTypeGet200ResponseFromJSON(body), text);
    }
...
* Get audience insights scope and type
*/
export function audienceInsightsScopeAndTypeGet<T>(requestParameters: AudienceInsightsScopeAndTypeGetRequest, requestConfig?: runtime.TypedQueryConfig<T, AudienceInsightsScopeAndTypeGet200Response>): QueryConfig<T> {
