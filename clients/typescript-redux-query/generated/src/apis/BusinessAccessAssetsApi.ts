 ...
 */
function assetGroupCreateRaw<T>(requestParameters: AssetGroupCreateRequest, requestConfig: runtime.TypedQueryConfig<T, AssetGroupInput> = {}): QueryConfig<T> {
    ...
    if (requestParameters.assetGroupInputCreate === null || requestParameters.assetGroupInputCreate === undefined) {
        throw new runtime.RequiredError('assetGroupInputCreate','Required parameter requestParameters.assetGroupInputCreate was null or undefined when calling assetGroupCreate.');
    }
    ...
    const config: QueryConfig<T> = {
        ...
        body: queryParameters || AssetGroupInputCreateToJSON(requestParameters.assetGroupInputCreate),
    };

    const { transform: requestTransform } = requestConfig;
    if (requestTransform) {
        config.transform = (body: ResponseBody, text: ResponseBody) => requestTransform(AssetGroupInputFromJSON(body), text);
    }
...
* Create a new asset group.
*/
export function assetGroupCreate<T>(requestParameters: AssetGroupCreateRequest, requestConfig?: runtime.TypedQueryConfig<T, AssetGroupInput>): QueryConfig<T> {
 ...
 * Delete asset groups.
 */
function assetGroupDeleteRaw<T>(requestParameters: AssetGroupDeleteRequest, requestConfig: runtime.TypedQueryConfig<T, AssetGroupDeletion> = {}): QueryConfig<T> {
    if (requestParameters.businessId === null || requestParameters.businessId === undefined) {
    ...
    if (requestParameters.assetGroupDeletionDelete === null || requestParameters.assetGroupDeletionDelete === undefined) {
        throw new runtime.RequiredError('assetGroupDeletionDelete','Required parameter requestParameters.assetGroupDeletionDelete was null or undefined when calling assetGroupDelete.');
    }
    ...
    const config: QueryConfig<T> = {
        ...
        body: queryParameters || AssetGroupDeletionDeleteToJSON(requestParameters.assetGroupDeletionDelete),
    };

    const { transform: requestTransform } = requestConfig;
    if (requestTransform) {
        config.transform = (body: ResponseBody, text: ResponseBody) => requestTransform(AssetGroupDeletionFromJSON(body), text);
    }
...
* Delete asset groups.
*/
export function assetGroupDelete<T>(requestParameters: AssetGroupDeleteRequest, requestConfig?: runtime.TypedQueryConfig<T, AssetGroupDeletion>): QueryConfig<T> {
 ...
 * Update asset groups.
 */
function assetGroupUpdateRaw<T>(requestParameters: AssetGroupUpdateRequest, requestConfig: runtime.TypedQueryConfig<T, AssetGroupModification> = {}): QueryConfig<T> {
    if (requestParameters.businessId === null || requestParameters.businessId === undefined) {
    ...
    if (requestParameters.assetGroupModificationReadOrUpdate === null || requestParameters.assetGroupModificationReadOrUpdate === undefined) {
        throw new runtime.RequiredError('assetGroupModificationReadOrUpdate','Required parameter requestParameters.assetGroupModificationReadOrUpdate was null or undefined when calling assetGroupUpdate.');
    }
    ...
    const config: QueryConfig<T> = {
        ...
        body: queryParameters || AssetGroupModificationReadOrUpdateToJSON(requestParameters.assetGroupModificationReadOrUpdate),
    };

    const { transform: requestTransform } = requestConfig;
    if (requestTransform) {
        config.transform = (body: ResponseBody, text: ResponseBody) => requestTransform(AssetGroupModificationFromJSON(body), text);
    }
...
* Update asset groups.
*/
export function assetGroupUpdate<T>(requestParameters: AssetGroupUpdateRequest, requestConfig?: runtime.TypedQueryConfig<T, AssetGroupModification>): QueryConfig<T> {
 ...
 */
function businessAssetPartnersGetRaw<T>(requestParameters: BusinessAssetPartnersGetRequest, requestConfig: runtime.TypedQueryConfig<T, BusinessAssetMembersGet200Response> = {}): QueryConfig<T> {
    if (requestParameters.businessId === null || requestParameters.businessId === undefined) {
...
* Get partners with access to asset
*/
export function businessAssetPartnersGet<T>(requestParameters: BusinessAssetPartnersGetRequest, requestConfig?: runtime.TypedQueryConfig<T, BusinessAssetMembersGet200Response>): QueryConfig<T> {
 ...
 */
function businessMemberAssetsGetRaw<T>(requestParameters: BusinessMemberAssetsGetRequest, requestConfig: runtime.TypedQueryConfig<T, BusinessMemberAssetsGetResponse> = {}): QueryConfig<T> {
    if (requestParameters.businessId === null || requestParameters.businessId === undefined) {
    ...
    if (requestParameters.assetPermissionType !== undefined) {
        queryParameters['asset_permission_type'] = requestParameters.assetPermissionType;
    }


    if (requestParameters.adAccountStatuses) {
    ...
    const { transform: requestTransform } = requestConfig;
    if (requestTransform) {
        config.transform = (body: ResponseBody, text: ResponseBody) => requestTransform(BusinessMemberAssetsGetResponseFromJSON(body), text);
    }
...
* Get assets assigned to a member
*/
export function businessMemberAssetsGet<T>(requestParameters: BusinessMemberAssetsGetRequest, requestConfig?: runtime.TypedQueryConfig<T, BusinessMemberAssetsGetResponse>): QueryConfig<T> {
...
function businessMembersAssetAccessDeleteRaw<T>(requestParameters: BusinessMembersAssetAccessDeleteRequest, requestConfig: runtime.TypedQueryConfig<T, DeleteMemberAccessResultsResponseArray> = {}): QueryConfig<T> {
    ...
    if (requestParameters.businessMembersAssetAccessDeleteBody === null || requestParameters.businessMembersAssetAccessDeleteBody === undefined) {
        throw new runtime.RequiredError('businessMembersAssetAccessDeleteBody','Required parameter requestParameters.businessMembersAssetAccessDeleteBody was null or undefined when calling businessMembersAssetAccessDelete.');
    }
    ...
    const config: QueryConfig<T> = {
        ...
        body: queryParameters || BusinessMembersAssetAccessDeleteBodyToJSON(requestParameters.businessMembersAssetAccessDeleteBody),
    };
 ...
 */
function deletePartnerAssetAccessHandlerImplRaw<T>(requestParameters: DeletePartnerAssetAccessHandlerImplRequest, requestConfig: runtime.TypedQueryConfig<T, DeletePartnerAssetAccessResultsResponseArray> = {}): QueryConfig<T> {
    if (requestParameters.businessId === null || requestParameters.businessId === undefined) {
    ...
    const { transform: requestTransform } = requestConfig;
    if (requestTransform) {
        config.transform = (body: ResponseBody, text: ResponseBody) => requestTransform(DeletePartnerAssetAccessResultsResponseArrayFromJSON(body), text);
    }
...
* Delete partner access to asset
*/
export function deletePartnerAssetAccessHandlerImpl<T>(requestParameters: DeletePartnerAssetAccessHandlerImplRequest, requestConfig?: runtime.TypedQueryConfig<T, DeletePartnerAssetAccessResultsResponseArray>): QueryConfig<T> {
