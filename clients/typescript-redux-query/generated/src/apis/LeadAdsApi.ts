 ...
 */
function adAccountsSubscriptionsDelByIdRaw<T>(requestParameters: AdAccountsSubscriptionsDelByIdRequest, requestConfig: runtime.TypedQueryConfig<T, LeadSubscription> = {}): QueryConfig<T> {
    ...
    if (requestTransform) {
        config.transform = (body: ResponseBody, text: ResponseBody) => requestTransform(LeadSubscriptionFromJSON(body), text);
    }
...
* Delete lead ads subscription
*/
export function adAccountsSubscriptionsDelById<T>(requestParameters: AdAccountsSubscriptionsDelByIdRequest, requestConfig?: runtime.TypedQueryConfig<T, LeadSubscription>): QueryConfig<T> {
 ...
 */
function adAccountsSubscriptionsGetByIdRaw<T>(requestParameters: AdAccountsSubscriptionsGetByIdRequest, requestConfig: runtime.TypedQueryConfig<T, LeadSubscription> = {}): QueryConfig<T> {
    if (requestParameters.adAccountId === null || requestParameters.adAccountId === undefined) {
...
* Get lead ads subscription by ID
*/
export function adAccountsSubscriptionsGetById<T>(requestParameters: AdAccountsSubscriptionsGetByIdRequest, requestConfig?: runtime.TypedQueryConfig<T, LeadSubscription>): QueryConfig<T> {
 ...
 */
function adAccountsSubscriptionsPostRaw<T>(requestParameters: AdAccountsSubscriptionsPostRequest, requestConfig: runtime.TypedQueryConfig<T, LeadSubscription> = {}): QueryConfig<T> {
    if (requestParameters.adAccountId === null || requestParameters.adAccountId === undefined) {
    ...
    if (requestParameters.leadSubscriptionPostParamsCreate === null || requestParameters.leadSubscriptionPostParamsCreate === undefined) {
        throw new runtime.RequiredError('leadSubscriptionPostParamsCreate','Required parameter requestParameters.leadSubscriptionPostParamsCreate was null or undefined when calling adAccountsSubscriptionsPost.');
    }
    ...
    const config: QueryConfig<T> = {
        ...
        body: queryParameters || LeadSubscriptionPostParamsCreateToJSON(requestParameters.leadSubscriptionPostParamsCreate),
    };
...
* Create lead ads subscription
*/
export function adAccountsSubscriptionsPost<T>(requestParameters: AdAccountsSubscriptionsPostRequest, requestConfig?: runtime.TypedQueryConfig<T, LeadSubscription>): QueryConfig<T> {
