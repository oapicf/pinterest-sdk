 ...
 */
function bulkDownloadCreateRaw<T>(requestParameters: BulkDownloadCreateRequest, requestConfig: runtime.TypedQueryConfig<T, BulkDownload> = {}): QueryConfig<T> {
    ...
    if (requestParameters.bulkDownloadCreate === null || requestParameters.bulkDownloadCreate === undefined) {
        throw new runtime.RequiredError('bulkDownloadCreate','Required parameter requestParameters.bulkDownloadCreate was null or undefined when calling bulkDownloadCreate.');
    }
    ...
    const config: QueryConfig<T> = {
        ...
        body: queryParameters || BulkDownloadCreateToJSON(requestParameters.bulkDownloadCreate),
    };

    const { transform: requestTransform } = requestConfig;
    if (requestTransform) {
        config.transform = (body: ResponseBody, text: ResponseBody) => requestTransform(BulkDownloadFromJSON(body), text);
    }
...
* Get advertiser entities in bulk
*/
export function bulkDownloadCreate<T>(requestParameters: BulkDownloadCreateRequest, requestConfig?: runtime.TypedQueryConfig<T, BulkDownload>): QueryConfig<T> {
 ...
 */
function bulkRequestGetRaw<T>(requestParameters: BulkRequestGetRequest, requestConfig: runtime.TypedQueryConfig<T, BulkJobData> = {}): QueryConfig<T> {
    if (requestParameters.adAccountId === null || requestParameters.adAccountId === undefined) {
    ...
    const { transform: requestTransform } = requestConfig;
    if (requestTransform) {
        config.transform = (body: ResponseBody, text: ResponseBody) => requestTransform(BulkJobDataFromJSON(body), text);
    }
...
* Download advertiser entities in bulk
*/
export function bulkRequestGet<T>(requestParameters: BulkRequestGetRequest, requestConfig?: runtime.TypedQueryConfig<T, BulkJobData>): QueryConfig<T> {
