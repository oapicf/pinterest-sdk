...
function audiencesUpdateRaw<T>(requestParameters: AudiencesUpdateRequest, requestConfig: runtime.TypedQueryConfig<T, Audience> = {}): QueryConfig<T> {
    ...
    if (requestParameters.audienceUpdateRequest === null || requestParameters.audienceUpdateRequest === undefined) {
        throw new runtime.RequiredError('audienceUpdateRequest','Required parameter requestParameters.audienceUpdateRequest was null or undefined when calling audiencesUpdate.');
    }
