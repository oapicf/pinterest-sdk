 ...
 */
function searchUserBoardsGetRaw<T>(requestParameters: SearchUserBoardsGetRequest, requestConfig: runtime.TypedQueryConfig<T, BoardsList200Response> = {}): QueryConfig<T> {
    let queryParameters = null;
...
* Search user\'s boards
*/
export function searchUserBoardsGet<T>(requestParameters: SearchUserBoardsGetRequest, requestConfig?: runtime.TypedQueryConfig<T, BoardsList200Response>): QueryConfig<T> {
