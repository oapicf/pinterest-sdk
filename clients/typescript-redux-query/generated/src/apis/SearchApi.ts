 ...
 * Search user\'s Pins
 */
function searchUserPinsListRaw<T>(requestParameters: SearchUserPinsListRequest, requestConfig: runtime.TypedQueryConfig<T, SearchUserPinsList200Response> = {}): QueryConfig<T> {
    ...
    const { transform: requestTransform } = requestConfig;
    if (requestTransform) {
        config.transform = (body: ResponseBody, text: ResponseBody) => requestTransform(SearchUserPinsList200ResponseFromJSON(body), text);
    }
...
* Search user\'s Pins
*/
export function searchUserPinsList<T>(requestParameters: SearchUserPinsListRequest, requestConfig?: runtime.TypedQueryConfig<T, SearchUserPinsList200Response>): QueryConfig<T> {
