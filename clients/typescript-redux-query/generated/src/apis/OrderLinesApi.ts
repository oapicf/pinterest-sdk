...
function orderLinesGetRaw<T>(requestParameters: OrderLinesGetRequest, requestConfig: runtime.TypedQueryConfig<T, OrderLine> = {}): QueryConfig<T> {
    ...
    const config: QueryConfig<T> = {
        url: `${runtime.Configuration.basePath}/ad_accounts/{ad_account_id}/order_lines/{order_line_id}`.replace('{order_line_id}', encodeURIComponent(String(requestParameters.orderLineId))).replace('{ad_account_id}', encodeURIComponent(String(requestParameters.adAccountId))),
        meta,
