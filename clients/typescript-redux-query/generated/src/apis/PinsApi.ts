 ...
 * Delete Pin
 */
function pinsDeleteRaw<T>(requestParameters: PinsDeleteRequest, requestConfig: runtime.TypedQueryConfig<T, Pin> = {}): QueryConfig<T> {
    if (requestParameters.pinId === null || requestParameters.pinId === undefined) {
...
* Delete Pin
*/
export function pinsDelete<T>(requestParameters: PinsDeleteRequest, requestConfig?: runtime.TypedQueryConfig<T, Pin>): QueryConfig<T> {
...
function pinsListRaw<T>(requestParameters: PinsListRequest, requestConfig: runtime.TypedQueryConfig<T, PinsList200Response> = {}): QueryConfig<T> {
    ...
    if (requestParameters.includeProductTagObj !== undefined) {
...
function pinsSaveRaw<T>(requestParameters: PinsSaveRequest, requestConfig: runtime.TypedQueryConfig<T, Pin> = {}): QueryConfig<T> {
    ...
    if (requestParameters.pinsSaveRequestCreate === null || requestParameters.pinsSaveRequestCreate === undefined) {
        throw new runtime.RequiredError('pinsSaveRequestCreate','Required parameter requestParameters.pinsSaveRequestCreate was null or undefined when calling pinsSave.');
    }
    ...
    const config: QueryConfig<T> = {
        ...
        body: queryParameters || PinsSaveRequestCreateToJSON(requestParameters.pinsSaveRequestCreate),
    };
