...
function boardSectionsCreateRaw<T>(requestParameters: BoardSectionsCreateRequest, requestConfig: runtime.TypedQueryConfig<T, BoardSection> = {}): QueryConfig<T> {
    ...
    if (requestParameters.boardSectionCreate === null || requestParameters.boardSectionCreate === undefined) {
        throw new runtime.RequiredError('boardSectionCreate','Required parameter requestParameters.boardSectionCreate was null or undefined when calling boardSectionsCreate.');
    }
    ...
    const config: QueryConfig<T> = {
        ...
        body: queryParameters || BoardSectionCreateToJSON(requestParameters.boardSectionCreate),
    };
 ...
 */
function boardSectionsDeleteRaw<T>(requestParameters: BoardSectionsDeleteRequest, requestConfig: runtime.TypedQueryConfig<T, BoardSection> = {}): QueryConfig<T> {
    if (requestParameters.boardId === null || requestParameters.boardId === undefined) {
...
* Delete board section
*/
export function boardSectionsDelete<T>(requestParameters: BoardSectionsDeleteRequest, requestConfig?: runtime.TypedQueryConfig<T, BoardSection>): QueryConfig<T> {
...
function boardSectionsUpdateRaw<T>(requestParameters: BoardSectionsUpdateRequest, requestConfig: runtime.TypedQueryConfig<T, BoardSection> = {}): QueryConfig<T> {
    ...
    if (requestParameters.boardSectionUpdateWithRequiredBody === null || requestParameters.boardSectionUpdateWithRequiredBody === undefined) {
        throw new runtime.RequiredError('boardSectionUpdateWithRequiredBody','Required parameter requestParameters.boardSectionUpdateWithRequiredBody was null or undefined when calling boardSectionsUpdate.');
    }
    ...
    const config: QueryConfig<T> = {
        ...
        body: queryParameters || BoardSectionUpdateWithRequiredBodyToJSON(requestParameters.boardSectionUpdateWithRequiredBody),
    };
...
function boardsCreateRaw<T>(requestParameters: BoardsCreateRequest, requestConfig: runtime.TypedQueryConfig<T, Board> = {}): QueryConfig<T> {
    if (requestParameters.boardCreate === null || requestParameters.boardCreate === undefined) {
        throw new runtime.RequiredError('boardCreate','Required parameter requestParameters.boardCreate was null or undefined when calling boardsCreate.');
    }
    ...
    const config: QueryConfig<T> = {
        ...
        body: queryParameters || BoardCreateToJSON(requestParameters.boardCreate),
    };
 ...
 * Delete board
 */
function boardsDeleteRaw<T>(requestParameters: BoardsDeleteRequest, requestConfig: runtime.TypedQueryConfig<T, Board> = {}): QueryConfig<T> {
    if (requestParameters.boardId === null || requestParameters.boardId === undefined) {
...
* Delete board
*/
export function boardsDelete<T>(requestParameters: BoardsDeleteRequest, requestConfig?: runtime.TypedQueryConfig<T, Board>): QueryConfig<T> {
 ...
 * Update board
 */
function boardsUpdateRaw<T>(requestParameters: BoardsUpdateRequest, requestConfig: runtime.TypedQueryConfig<T, BoardWithUpdatePrivacy> = {}): QueryConfig<T> {
    if (requestParameters.boardId === null || requestParameters.boardId === undefined) {
    ...
    if (requestParameters.boardWithUpdatePrivacyUpdate === null || requestParameters.boardWithUpdatePrivacyUpdate === undefined) {
        throw new runtime.RequiredError('boardWithUpdatePrivacyUpdate','Required parameter requestParameters.boardWithUpdatePrivacyUpdate was null or undefined when calling boardsUpdate.');
    }
    ...
    const config: QueryConfig<T> = {
        ...
        body: queryParameters || BoardWithUpdatePrivacyUpdateToJSON(requestParameters.boardWithUpdatePrivacyUpdate),
    };

    const { transform: requestTransform } = requestConfig;
    if (requestTransform) {
        config.transform = (body: ResponseBody, text: ResponseBody) => requestTransform(BoardWithUpdatePrivacyFromJSON(body), text);
    }
...
* Update board
*/
export function boardsUpdate<T>(requestParameters: BoardsUpdateRequest, requestConfig?: runtime.TypedQueryConfig<T, BoardWithUpdatePrivacy>): QueryConfig<T> {
