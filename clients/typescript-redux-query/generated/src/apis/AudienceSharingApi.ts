 ...
 */
function sharedAudiencesForBusinessListRaw<T>(requestParameters: SharedAudiencesForBusinessListRequest, requestConfig: runtime.TypedQueryConfig<T, SharedAudiencesForBusinessList200Response> = {}): QueryConfig<T> {
    if (requestParameters.businessId === null || requestParameters.businessId === undefined) {
    ...
    const { transform: requestTransform } = requestConfig;
    if (requestTransform) {
        config.transform = (body: ResponseBody, text: ResponseBody) => requestTransform(SharedAudiencesForBusinessList200ResponseFromJSON(body), text);
    }
...
* List received audiences for a business
*/
export function sharedAudiencesForBusinessList<T>(requestParameters: SharedAudiencesForBusinessListRequest, requestConfig?: runtime.TypedQueryConfig<T, SharedAudiencesForBusinessList200Response>): QueryConfig<T> {
 ...
 */
function updateAdAccountToAdAccountSharedAudienceRaw<T>(requestParameters: UpdateAdAccountToAdAccountSharedAudienceRequest, requestConfig: runtime.TypedQueryConfig<T, AdAccountToAdAccountSharedAudience> = {}): QueryConfig<T> {
    if (requestParameters.adAccountId === null || requestParameters.adAccountId === undefined) {
    ...
    if (requestParameters.adAccountToAdAccountSharedAudienceUpdateWithRequiredBody === null || requestParameters.adAccountToAdAccountSharedAudienceUpdateWithRequiredBody === undefined) {
        throw new runtime.RequiredError('adAccountToAdAccountSharedAudienceUpdateWithRequiredBody','Required parameter requestParameters.adAccountToAdAccountSharedAudienceUpdateWithRequiredBody was null or undefined when calling updateAdAccountToAdAccountSharedAudience.');
    }
    ...
    const config: QueryConfig<T> = {
        ...
        body: queryParameters || AdAccountToAdAccountSharedAudienceUpdateWithRequiredBodyToJSON(requestParameters.adAccountToAdAccountSharedAudienceUpdateWithRequiredBody),
    };

    const { transform: requestTransform } = requestConfig;
    if (requestTransform) {
        config.transform = (body: ResponseBody, text: ResponseBody) => requestTransform(AdAccountToAdAccountSharedAudienceFromJSON(body), text);
    }
...
* Update audience sharing between ad accounts
*/
export function updateAdAccountToAdAccountSharedAudience<T>(requestParameters: UpdateAdAccountToAdAccountSharedAudienceRequest, requestConfig?: runtime.TypedQueryConfig<T, AdAccountToAdAccountSharedAudience>): QueryConfig<T> {
 ...
 */
function updateAdAccountToBusinessSharedAudienceRaw<T>(requestParameters: UpdateAdAccountToBusinessSharedAudienceRequest, requestConfig: runtime.TypedQueryConfig<T, AdAccountToBusinessSharedAudience> = {}): QueryConfig<T> {
    if (requestParameters.adAccountId === null || requestParameters.adAccountId === undefined) {
    ...
    if (requestParameters.adAccountToBusinessSharedAudienceUpdateWithRequiredBody === null || requestParameters.adAccountToBusinessSharedAudienceUpdateWithRequiredBody === undefined) {
        throw new runtime.RequiredError('adAccountToBusinessSharedAudienceUpdateWithRequiredBody','Required parameter requestParameters.adAccountToBusinessSharedAudienceUpdateWithRequiredBody was null or undefined when calling updateAdAccountToBusinessSharedAudience.');
    }
    ...
    const config: QueryConfig<T> = {
        ...
        body: queryParameters || AdAccountToBusinessSharedAudienceUpdateWithRequiredBodyToJSON(requestParameters.adAccountToBusinessSharedAudienceUpdateWithRequiredBody),
    };

    const { transform: requestTransform } = requestConfig;
    if (requestTransform) {
        config.transform = (body: ResponseBody, text: ResponseBody) => requestTransform(AdAccountToBusinessSharedAudienceFromJSON(body), text);
    }
...
* Update audience sharing from an ad account to businesses
*/
export function updateAdAccountToBusinessSharedAudience<T>(requestParameters: UpdateAdAccountToBusinessSharedAudienceRequest, requestConfig?: runtime.TypedQueryConfig<T, AdAccountToBusinessSharedAudience>): QueryConfig<T> {
 ...
 */
function updateBusinessToAdAccountSharedAudienceRaw<T>(requestParameters: UpdateBusinessToAdAccountSharedAudienceRequest, requestConfig: runtime.TypedQueryConfig<T, BusinessToAdAccountSharedAudience> = {}): QueryConfig<T> {
    if (requestParameters.businessId === null || requestParameters.businessId === undefined) {
    ...
    if (requestParameters.businessToAdAccountSharedAudienceUpdateWithRequiredBody === null || requestParameters.businessToAdAccountSharedAudienceUpdateWithRequiredBody === undefined) {
        throw new runtime.RequiredError('businessToAdAccountSharedAudienceUpdateWithRequiredBody','Required parameter requestParameters.businessToAdAccountSharedAudienceUpdateWithRequiredBody was null or undefined when calling updateBusinessToAdAccountSharedAudience.');
    }
    ...
    const config: QueryConfig<T> = {
        ...
        body: queryParameters || BusinessToAdAccountSharedAudienceUpdateWithRequiredBodyToJSON(requestParameters.businessToAdAccountSharedAudienceUpdateWithRequiredBody),
    };

    const { transform: requestTransform } = requestConfig;
    if (requestTransform) {
        config.transform = (body: ResponseBody, text: ResponseBody) => requestTransform(BusinessToAdAccountSharedAudienceFromJSON(body), text);
    }
...
* Update audience sharing from a business to ad accounts
*/
export function updateBusinessToAdAccountSharedAudience<T>(requestParameters: UpdateBusinessToAdAccountSharedAudienceRequest, requestConfig?: runtime.TypedQueryConfig<T, BusinessToAdAccountSharedAudience>): QueryConfig<T> {
 ...
 */
function updateBusinessToBusinessSharedAudienceRaw<T>(requestParameters: UpdateBusinessToBusinessSharedAudienceRequest, requestConfig: runtime.TypedQueryConfig<T, BusinessToBusinessSharedAudience> = {}): QueryConfig<T> {
    if (requestParameters.businessId === null || requestParameters.businessId === undefined) {
    ...
    if (requestParameters.businessToBusinessSharedAudienceUpdateWithRequiredBody === null || requestParameters.businessToBusinessSharedAudienceUpdateWithRequiredBody === undefined) {
        throw new runtime.RequiredError('businessToBusinessSharedAudienceUpdateWithRequiredBody','Required parameter requestParameters.businessToBusinessSharedAudienceUpdateWithRequiredBody was null or undefined when calling updateBusinessToBusinessSharedAudience.');
    }
    ...
    const config: QueryConfig<T> = {
        ...
        body: queryParameters || BusinessToBusinessSharedAudienceUpdateWithRequiredBodyToJSON(requestParameters.businessToBusinessSharedAudienceUpdateWithRequiredBody),
    };

    const { transform: requestTransform } = requestConfig;
    if (requestTransform) {
        config.transform = (body: ResponseBody, text: ResponseBody) => requestTransform(BusinessToBusinessSharedAudienceFromJSON(body), text);
    }
...
* Update audience sharing between businesses
*/
export function updateBusinessToBusinessSharedAudience<T>(requestParameters: UpdateBusinessToBusinessSharedAudienceRequest, requestConfig?: runtime.TypedQueryConfig<T, BusinessToBusinessSharedAudience>): QueryConfig<T> {
