 ...
 */
function analyticsCreateConversionProductReportRaw<T>(requestParameters: AnalyticsCreateConversionProductReportRequest, requestConfig: runtime.TypedQueryConfig<T, AdsAnalyticsCreateAsyncResponse> = {}): QueryConfig<T> {
    if (requestParameters.adAccountId === null || requestParameters.adAccountId === undefined) {
    ...
    if (requestParameters.conversionProductReportRequest === null || requestParameters.conversionProductReportRequest === undefined) {
        throw new runtime.RequiredError('conversionProductReportRequest','Required parameter requestParameters.conversionProductReportRequest was null or undefined when calling analyticsCreateConversionProductReport.');
    }
    ...
    const config: QueryConfig<T> = {
        ...
        body: queryParameters || ConversionProductReportRequestToJSON(requestParameters.conversionProductReportRequest),
    };
...
* Create a request for a brand, category, SKU report
*/
export function analyticsCreateConversionProductReport<T>(requestParameters: AnalyticsCreateConversionProductReportRequest, requestConfig?: runtime.TypedQueryConfig<T, AdsAnalyticsCreateAsyncResponse>): QueryConfig<T> {
 ...
 */
function analyticsGetConversionProductReportRaw<T>(requestParameters: AnalyticsGetConversionProductReportRequest, requestConfig: runtime.TypedQueryConfig<T, AdsAnalyticsGetAsyncResponse> = {}): QueryConfig<T> {
    if (requestParameters.adAccountId === null || requestParameters.adAccountId === undefined) {
...
* Get advertiser brand, category, SKU report
*/
export function analyticsGetConversionProductReport<T>(requestParameters: AnalyticsGetConversionProductReportRequest, requestConfig?: runtime.TypedQueryConfig<T, AdsAnalyticsGetAsyncResponse>): QueryConfig<T> {
