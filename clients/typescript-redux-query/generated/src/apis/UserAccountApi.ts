 ...
 */
function boardsUserFollowsListRaw<T>(requestParameters: BoardsUserFollowsListRequest, requestConfig: runtime.TypedQueryConfig<T, BoardsList200Response> = {}): QueryConfig<T> {
...
* List following boards
*/
export function boardsUserFollowsList<T>(requestParameters: BoardsUserFollowsListRequest, requestConfig?: runtime.TypedQueryConfig<T, BoardsList200Response>): QueryConfig<T> {
 ...
 * Follow user
 */
function followUserUpdateRaw<T>(requestParameters: FollowUserUpdateRequest, requestConfig: runtime.TypedQueryConfig<T, FollowUser> = {}): QueryConfig<T> {
    ...
    if (requestParameters.followUserCreate === null || requestParameters.followUserCreate === undefined) {
        throw new runtime.RequiredError('followUserCreate','Required parameter requestParameters.followUserCreate was null or undefined when calling followUserUpdate.');
    }
    ...
    const config: QueryConfig<T> = {
        ...
        body: queryParameters || FollowUserCreateToJSON(requestParameters.followUserCreate),
    };

    const { transform: requestTransform } = requestConfig;
    if (requestTransform) {
        config.transform = (body: ResponseBody, text: ResponseBody) => requestTransform(FollowUserFromJSON(body), text);
    }
...
* Follow user
*/
export function followUserUpdate<T>(requestParameters: FollowUserUpdateRequest, requestConfig?: runtime.TypedQueryConfig<T, FollowUser>): QueryConfig<T> {
 ...
 * Unverify website
 */
function unverifyWebsiteDeleteRaw<T>(requestParameters: UnverifyWebsiteDeleteRequest, requestConfig: runtime.TypedQueryConfig<T, UserWebsite> = {}): QueryConfig<T> {
    ...
    const { transform: requestTransform } = requestConfig;
    if (requestTransform) {
        config.transform = (body: ResponseBody, text: ResponseBody) => requestTransform(UserWebsiteFromJSON(body), text);
    }
...
* Unverify website
*/
export function unverifyWebsiteDelete<T>(requestParameters: UnverifyWebsiteDeleteRequest, requestConfig?: runtime.TypedQueryConfig<T, UserWebsite>): QueryConfig<T> {
 ...
 * List following
 */
function userFollowingGetRaw<T>(requestParameters: UserFollowingGetRequest, requestConfig: runtime.TypedQueryConfig<T, FollowersList200Response> = {}): QueryConfig<T> {
    let queryParameters = null;
...
* List following
*/
export function userFollowingGet<T>(requestParameters: UserFollowingGetRequest, requestConfig?: runtime.TypedQueryConfig<T, FollowersList200Response>): QueryConfig<T> {
 ...
 * Verify website
 */
function verifyWebsiteUpdateRaw<T>(requestParameters: VerifyWebsiteUpdateRequest, requestConfig: runtime.TypedQueryConfig<T, UserWebsite> = {}): QueryConfig<T> {
    if (requestParameters.userWebsiteCreate === null || requestParameters.userWebsiteCreate === undefined) {
        throw new runtime.RequiredError('userWebsiteCreate','Required parameter requestParameters.userWebsiteCreate was null or undefined when calling verifyWebsiteUpdate.');
    }
    ...
    const config: QueryConfig<T> = {
        ...
        body: queryParameters || UserWebsiteCreateToJSON(requestParameters.userWebsiteCreate),
    };
...
* Verify website
*/
export function verifyWebsiteUpdate<T>(requestParameters: VerifyWebsiteUpdateRequest, requestConfig?: runtime.TypedQueryConfig<T, UserWebsite>): QueryConfig<T> {
 ...
 */
function websiteVerificationGetRaw<T>(requestParameters: WebsiteVerificationGetRequest, requestConfig: runtime.TypedQueryConfig<T, UserWebsiteVerification> = {}): QueryConfig<T> {
    let queryParameters = null;
    ...
    const { transform: requestTransform } = requestConfig;
    if (requestTransform) {
        config.transform = (body: ResponseBody, text: ResponseBody) => requestTransform(UserWebsiteVerificationFromJSON(body), text);
    }
...
* Get user verification code for website claiming
*/
export function websiteVerificationGet<T>(requestParameters: WebsiteVerificationGetRequest, requestConfig?: runtime.TypedQueryConfig<T, UserWebsiteVerification>): QueryConfig<T> {
