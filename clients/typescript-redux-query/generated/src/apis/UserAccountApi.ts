 ...
 */
function websiteVerificationGetRaw<T>( requestConfig: runtime.TypedQueryConfig<T, UserWebsiteVerificationCode> = {}): QueryConfig<T> {
    let queryParameters = null;
...
* Get user verification code for website claiming
*/
export function websiteVerificationGet<T>( requestConfig?: runtime.TypedQueryConfig<T, UserWebsiteVerificationCode>): QueryConfig<T> {
    return websiteVerificationGetRaw( requestConfig);
}
