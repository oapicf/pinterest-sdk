...
/**
    ...
    * @enum {string}
    */
export enum BillingInvoicesGetSortEnum {
    DueDate = 'DUE_DATE',
...
/**
    ...
    * @enum {string}
    */
export enum BillingInvoicesGetOrderEnum {
    Ascending = 'ASCENDING',
...
/**
    ...
    * @enum {string}
    */
export enum BillingInvoicesGetStatusEnum {
    Open = 'OPEN',
    Closed = 'CLOSED'
}
/**
    ...
    * @enum {string}
    */
export enum BillingInvoicesGetDocumentTypeEnum {
    Invoice = 'INVOICE',
