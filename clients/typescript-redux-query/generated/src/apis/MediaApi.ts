 ...
 * List media uploads
 */
function mediaListRaw<T>(requestParameters: MediaListRequest, requestConfig: runtime.TypedQueryConfig<T, Paginated & object> = {}): QueryConfig<T> {
    let queryParameters = null;
...
* List media uploads
*/
export function mediaList<T>(requestParameters: MediaListRequest, requestConfig?: runtime.TypedQueryConfig<T, Paginated & object>): QueryConfig<T> {
