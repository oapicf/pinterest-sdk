 ...
 */
function integrationsCommerceDelRaw<T>(requestParameters: IntegrationsCommerceDelRequest, requestConfig: runtime.TypedQueryConfig<T, IntegrationMetadata> = {}): QueryConfig<T> {
...
* Delete commerce integration
*/
export function integrationsCommerceDel<T>(requestParameters: IntegrationsCommerceDelRequest, requestConfig?: runtime.TypedQueryConfig<T, IntegrationMetadata>): QueryConfig<T> {
...
function integrationsCommercePatchRaw<T>(requestParameters: IntegrationsCommercePatchRequest, requestConfig: runtime.TypedQueryConfig<T, IntegrationMetadata> = {}): QueryConfig<T> {
    ...
    if (requestParameters.integrationMetadataUpdate === null || requestParameters.integrationMetadataUpdate === undefined) {
        throw new runtime.RequiredError('integrationMetadataUpdate','Required parameter requestParameters.integrationMetadataUpdate was null or undefined when calling integrationsCommercePatch.');
    }
    ...
    const config: QueryConfig<T> = {
        ...
        body: queryParameters || IntegrationMetadataUpdateToJSON(requestParameters.integrationMetadataUpdate),
    };
...
function integrationsCommercePostRaw<T>(requestParameters: IntegrationsCommercePostRequest, requestConfig: runtime.TypedQueryConfig<T, IntegrationMetadata> = {}): QueryConfig<T> {
    if (requestParameters.integrationMetadataCreate === null || requestParameters.integrationMetadataCreate === undefined) {
        throw new runtime.RequiredError('integrationMetadataCreate','Required parameter requestParameters.integrationMetadataCreate was null or undefined when calling integrationsCommercePost.');
    }
    ...
    const config: QueryConfig<T> = {
        ...
        body: queryParameters || IntegrationMetadataCreateToJSON(requestParameters.integrationMetadataCreate),
    };
...
function integrationsLogsPostRaw<T>(requestParameters: IntegrationsLogsPostRequest, requestConfig: runtime.TypedQueryConfig<T, IntegrationLogsSuccessResponse> = {}): QueryConfig<T> {
    if (requestParameters.integrationLogsRequestCreate === null || requestParameters.integrationLogsRequestCreate === undefined) {
        throw new runtime.RequiredError('integrationLogsRequestCreate','Required parameter requestParameters.integrationLogsRequestCreate was null or undefined when calling integrationsLogsPost.');
    }
    ...
    const config: QueryConfig<T> = {
        ...
        body: queryParameters || IntegrationLogsRequestCreateToJSON(requestParameters.integrationLogsRequestCreate),
    };
