...
import {
    ...
    IntegrationsLogsPost400ResponseFromJSON,
    IntegrationsLogsPost400ResponseToJSON,
} from '../models';
...
function integrationsCommercePatchRaw<T>(requestParameters: IntegrationsCommercePatchRequest, requestConfig: runtime.TypedQueryConfig<T, IntegrationMetadata> = {}): QueryConfig<T> {
    ...
    if (requestParameters.integrationRequestPatch === null || requestParameters.integrationRequestPatch === undefined) {
        throw new runtime.RequiredError('integrationRequestPatch','Required parameter requestParameters.integrationRequestPatch was null or undefined when calling integrationsCommercePatch.');
    }
...
function integrationsCommercePostRaw<T>(requestParameters: IntegrationsCommercePostRequest, requestConfig: runtime.TypedQueryConfig<T, IntegrationMetadata> = {}): QueryConfig<T> {
    if (requestParameters.integrationRequest === null || requestParameters.integrationRequest === undefined) {
        throw new runtime.RequiredError('integrationRequest','Required parameter requestParameters.integrationRequest was null or undefined when calling integrationsCommercePost.');
    }
