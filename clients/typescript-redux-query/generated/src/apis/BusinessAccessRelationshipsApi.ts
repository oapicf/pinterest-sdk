 ...
 */
function brandAccountsCreateRaw<T>(requestParameters: BrandAccountsCreateRequest, requestConfig: runtime.TypedQueryConfig<T, BrandAccountsCreate200Response> = {}): QueryConfig<T> {
    ...
    if (requestParameters.brandAccountsCreateRequest === null || requestParameters.brandAccountsCreateRequest === undefined) {
        throw new runtime.RequiredError('brandAccountsCreateRequest','Required parameter requestParameters.brandAccountsCreateRequest was null or undefined when calling brandAccountsCreate.');
    }
    ...
    const config: QueryConfig<T> = {
        ...
        body: queryParameters || BrandAccountsCreateRequestToJSON(requestParameters.brandAccountsCreateRequest),
    };

    const { transform: requestTransform } = requestConfig;
    if (requestTransform) {
        config.transform = (body: ResponseBody, text: ResponseBody) => requestTransform(BrandAccountsCreate200ResponseFromJSON(body), text);
    }
...
* Create a Brand Account
*/
export function brandAccountsCreate<T>(requestParameters: BrandAccountsCreateRequest, requestConfig?: runtime.TypedQueryConfig<T, BrandAccountsCreate200Response>): QueryConfig<T> {
 ...
 */
function brandAccountsUpdateRaw<T>(requestParameters: BrandAccountsUpdateRequest, requestConfig: runtime.TypedQueryConfig<T, BrandAccountsCreate200Response> = {}): QueryConfig<T> {
    if (requestParameters.businessHierarchyId === null || requestParameters.businessHierarchyId === undefined) {
    ...
    if (requestParameters.brandAccountsUpdateRequest === null || requestParameters.brandAccountsUpdateRequest === undefined) {
        throw new runtime.RequiredError('brandAccountsUpdateRequest','Required parameter requestParameters.brandAccountsUpdateRequest was null or undefined when calling brandAccountsUpdate.');
    }
    ...
    meta.authType = ['oauth', ["biz_access:read", "biz_access:write"]];
    const config: QueryConfig<T> = {
        url: `${runtime.Configuration.basePath}/business_access/business_hierarchy/{business_hierarchy_id}/brand_accounts/{brand_account_id}`.replace(`{${"business_hierarchy_id"}}`, encodeURIComponent(String(requestParameters.businessHierarchyId))).replace(`{${"brand_account_id"}}`, encodeURIComponent(String(requestParameters.brandAccountId))),
        meta,
        update: requestConfig.update,
        queryKey: requestConfig.queryKey,
        optimisticUpdate: requestConfig.optimisticUpdate,
        ...
        body: queryParameters || BrandAccountsUpdateRequestToJSON(requestParameters.brandAccountsUpdateRequest),
    };
...
* Update a Brand Account
*/
export function brandAccountsUpdate<T>(requestParameters: BrandAccountsUpdateRequest, requestConfig?: runtime.TypedQueryConfig<T, BrandAccountsCreate200Response>): QueryConfig<T> {
...
function systemUserUpdateRaw<T>(requestParameters: SystemUserUpdateRequest, requestConfig: runtime.TypedQueryConfig<T, void> = {}): QueryConfig<T> {
    ...
    if (requestParameters.systemUserUpdateRequest === null || requestParameters.systemUserUpdateRequest === undefined) {
        throw new runtime.RequiredError('systemUserUpdateRequest','Required parameter requestParameters.systemUserUpdateRequest was null or undefined when calling systemUserUpdate.');
    }
    ...
    const config: QueryConfig<T> = {
        ...
        body: queryParameters || SystemUserUpdateRequestToJSON(requestParameters.systemUserUpdateRequest),
    };
