...
function adGroupsAudienceSizingRaw<T>(requestParameters: AdGroupsAudienceSizingRequest, requestConfig: runtime.TypedQueryConfig<T, AdGroupAudienceSizingResponse> = {}): QueryConfig<T> {
    ...
    if (requestParameters.adGroupAudienceSizingRequest === null || requestParameters.adGroupAudienceSizingRequest === undefined) {
        throw new runtime.RequiredError('adGroupAudienceSizingRequest','Required parameter requestParameters.adGroupAudienceSizingRequest was null or undefined when calling adGroupsAudienceSizing.');
    }
