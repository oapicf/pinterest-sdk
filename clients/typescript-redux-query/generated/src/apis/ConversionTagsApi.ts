 ...
 */
function conversionTagsCreateRaw<T>(requestParameters: ConversionTagsCreateRequest, requestConfig: runtime.TypedQueryConfig<T, ConversionTag> = {}): QueryConfig<T> {
    ...
    if (requestTransform) {
        config.transform = (body: ResponseBody, text: ResponseBody) => requestTransform(ConversionTagFromJSON(body), text);
    }
...
* Create conversion tag
*/
export function conversionTagsCreate<T>(requestParameters: ConversionTagsCreateRequest, requestConfig?: runtime.TypedQueryConfig<T, ConversionTag>): QueryConfig<T> {
 ...
 * Get conversion tag
 */
function conversionTagsGetRaw<T>(requestParameters: ConversionTagsGetRequest, requestConfig: runtime.TypedQueryConfig<T, ConversionTag> = {}): QueryConfig<T> {
    if (requestParameters.adAccountId === null || requestParameters.adAccountId === undefined) {
...
* Get conversion tag
*/
export function conversionTagsGet<T>(requestParameters: ConversionTagsGetRequest, requestConfig?: runtime.TypedQueryConfig<T, ConversionTag>): QueryConfig<T> {
 ...
 */
function conversionTagsListRaw<T>(requestParameters: ConversionTagsListRequest, requestConfig: runtime.TypedQueryConfig<T, ConversionTagsList200Response> = {}): QueryConfig<T> {
    if (requestParameters.adAccountId === null || requestParameters.adAccountId === undefined) {
    ...
    const { transform: requestTransform } = requestConfig;
    if (requestTransform) {
        config.transform = (body: ResponseBody, text: ResponseBody) => requestTransform(ConversionTagsList200ResponseFromJSON(body), text);
    }
...
* List conversion tags
*/
export function conversionTagsList<T>(requestParameters: ConversionTagsListRequest, requestConfig?: runtime.TypedQueryConfig<T, ConversionTagsList200Response>): QueryConfig<T> {
