 ...
 */
function cancelInvitesOrRequestsRaw<T>(requestParameters: CancelInvitesOrRequestsRequest, requestConfig: runtime.TypedQueryConfig<T, CancelInvitesResponse> = {}): QueryConfig<T> {
    if (requestParameters.businessId === null || requestParameters.businessId === undefined) {
    ...
    if (requestParameters.cancelInvitesRequest === null || requestParameters.cancelInvitesRequest === undefined) {
        throw new runtime.RequiredError('cancelInvitesRequest','Required parameter requestParameters.cancelInvitesRequest was null or undefined when calling cancelInvitesOrRequests.');
    }
    ...
    const config: QueryConfig<T> = {
        ...
        body: queryParameters || CancelInvitesRequestToJSON(requestParameters.cancelInvitesRequest),
    };

    const { transform: requestTransform } = requestConfig;
    if (requestTransform) {
        config.transform = (body: ResponseBody, text: ResponseBody) => requestTransform(CancelInvitesResponseFromJSON(body), text);
    }
...
* Cancel invites/requests
*/
export function cancelInvitesOrRequests<T>(requestParameters: CancelInvitesOrRequestsRequest, requestConfig?: runtime.TypedQueryConfig<T, CancelInvitesResponse>): QueryConfig<T> {
