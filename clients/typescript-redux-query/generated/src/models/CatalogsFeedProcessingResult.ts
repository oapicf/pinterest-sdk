 ...
 * @export
 */
export interface CatalogsFeedProcessingResult extends CatalogsDbItem, CatalogsFeedProcessingResultFields {
}

export function CatalogsFeedProcessingResultFromJSON(json: any): CatalogsFeedProcessingResult {
    return {
        ...CatalogsDbItemFromJSON(json),
        ...CatalogsFeedProcessingResultFieldsFromJSON(json),
    };
}
...
export function CatalogsFeedProcessingResultToJSON(value?: CatalogsFeedProcessingResult): any {
    ...
    return {
        ...
        ...CatalogsFeedProcessingResultFieldsToJSON(value),
    };
}
