...
export function AdCommonFromJSON(json: any): AdCommon {
    return {
        ...
        'trackingUrls': !exists(json, 'tracking_urls') ? undefined : AdCommonTrackingUrlsFromJSON(json['tracking_urls']),
        ...
        'quizPinData': !exists(json, 'quiz_pin_data') ? undefined : AdCommonQuizPinDataFromJSON(json['quiz_pin_data']),
    };
}
