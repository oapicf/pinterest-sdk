...
export function PinAnalyticsMetricsResponseFromJSON(json: any): PinAnalyticsMetricsResponse {
    return {
        'dailyMetrics': !exists(json, 'daily_metrics') ? undefined : (json['daily_metrics'] as Array<any>).map(PinAnalyticsDailyMetricsFromJSON),
...
export function PinAnalyticsMetricsResponseToJSON(value?: PinAnalyticsMetricsResponse): any {
    ...
    return {
        'daily_metrics': value.dailyMetrics === undefined ? undefined : (value.dailyMetrics as Array<any>).map(PinAnalyticsDailyMetricsToJSON),
