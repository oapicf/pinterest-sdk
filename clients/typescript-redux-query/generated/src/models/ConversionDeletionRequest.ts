...
export function ConversionDeletionRequestFromJSON(json: any): ConversionDeletionRequest {
    return {
        ...
        'processedTime': !exists(json, 'processed_time') ? undefined : new Date(json['processed_time']),
        'requestId': json['request_id'],
        'status': ConversionDeletionRequestStatusFromJSON(json['status']),
    };
}

export function ConversionDeletionRequestToJSON(value?: ConversionDeletionRequest): any {
    if (value === undefined) {
        return undefined;
    }
    return {
