 ...
 * @enum {string}
 */
export enum CatalogsFeedProcessingScheduleTimezone {
...
export function CatalogsFeedProcessingScheduleTimezoneToJSON(value?: CatalogsFeedProcessingScheduleTimezone): any {
    return value as any;
}
