...
export function DeleteInvitesResultsResponseArrayFromJSON(json: any): DeleteInvitesResultsResponseArray {
    return {
        'items': !exists(json, 'items') ? undefined : (json['items'] as Array<any>).map(DeleteInvitesResultsResponseArrayItemsInnerFromJSON),
    };
}

export function DeleteInvitesResultsResponseArrayToJSON(value?: DeleteInvitesResultsResponseArray): any {
    if (value === undefined) {
        return undefined;
    }
    return {
        'items': value.items === undefined ? undefined : (value.items as Array<any>).map(DeleteInvitesResultsResponseArrayItemsInnerToJSON),
    };
}
