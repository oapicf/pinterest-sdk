...
export function CatalogsRetailFeedsUpdateRequestToJSON(value?: CatalogsRetailFeedsUpdateRequest): any {
    if (value === undefined) {
        return undefined;
    }
    return {
...
* @enum {string}
*/
export enum CatalogsRetailFeedsUpdateRequestCatalogTypeEnum {
    Retail = 'RETAIL'
}
