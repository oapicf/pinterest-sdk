...
export function CampaignBatchUpdateItemFromJSON(json: any): CampaignBatchUpdateItem {
    return {
        ...
        'objectiveType': !exists(json, 'objective_type') ? undefined : ConversionObjectiveTypeFromJSON(json['objective_type']),
...
export function CampaignBatchUpdateItemToJSON(value?: CampaignBatchUpdateItem): any {
    if (value === undefined) {
        return undefined;
    }
    return {
