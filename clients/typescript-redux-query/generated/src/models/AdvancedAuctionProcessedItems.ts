...
export function AdvancedAuctionProcessedItemsFromJSON(json: any): AdvancedAuctionProcessedItems {
    return {
        ...
        'items': !exists(json, 'items') ? undefined : (json['items'] as Array<any>).map(AdvancedAuctionItemsSubmitRecordFromJSON),
    };
}
...
export function AdvancedAuctionProcessedItemsToJSON(value?: AdvancedAuctionProcessedItems): any {
    ...
    return {
        ...
        'items': value.items === undefined ? undefined : (value.items as Array<any>).map(AdvancedAuctionItemsSubmitRecordToJSON),
    };
}
