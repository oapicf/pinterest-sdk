...
import org.openapitools.vertxweb.server.model.AdsAnalyticsCreateAsyncRequestAllOf;
import org.openapitools.vertxweb.server.model.AdsAnalyticsCreateAsyncRequestAllOf1;
...
public class AdsAnalyticsCreateAsyncRequest   {
  ...
  public AdsAnalyticsCreateAsyncRequest (String startDate, String endDate, Granularity granularity, ConversionAttributionWindowDays clickWindowDays, ConversionAttributionWindowDays engagementWindowDays, ConversionAttributionWindowDays viewWindowDays, ConversionReportTimeType conversionReportTime, List<ConversionReportAttributionType> attributionTypes, List<ReportingColumnAsync> columns, MetricsReportingLevel level, DataOutputFormat reportFormat, List<String> campaignIds, List<CampaignSummaryStatus> campaignStatuses, List<ObjectiveType> campaignObjectiveTypes, List<String> adGroupIds, List<AdGroupSummaryStatus> adGroupStatuses, List<String> adIds, List<PinPromotionSummaryStatus> adStatuses, List<String> productGroupIds, List<ProductGroupSummaryStatus> productGroupStatuses, List<String> productItemIds, List<AdsAnalyticsTargetingType> targetingTypes, List<AdsAnalyticsMetricsFilter> metricsFilters) {
