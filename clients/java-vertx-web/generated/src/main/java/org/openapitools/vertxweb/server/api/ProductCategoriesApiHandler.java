...
public class ProductCategoriesApiHandler {

    private static final Logger logger = LoggerFactory.getLogger(ProductCategoriesApiHandler.class);

    private final ProductCategoriesApi api;

    public ProductCategoriesApiHandler(ProductCategoriesApi api) {
        this.api = api;
    }

    @Deprecated
    public ProductCategoriesApiHandler() {
        this(new ProductCategoriesApiImpl());
    }
