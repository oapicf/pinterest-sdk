...
import org.openapitools.vertxweb.server.model.AdResponseAllOf;
import org.openapitools.vertxweb.server.model.AdResponseAllOf1;
...
public class AdResponse   {
  ...
  public AdResponse (String adGroupId, String androidDeepLink, List<String> carouselAndroidDeepLinks, List<String> carouselDestinationUrls, List<String> carouselIosDeepLinks, String clickTrackingUrl, CreativeTypeEnum creativeType, String destinationUrl, String iosDeepLink, Boolean isPinDeleted, Boolean isRemovable, String name, String pinId, EntityStatus status, TrackingUrls trackingUrls, String viewTrackingUrl, String adAccountId, String campaignId, String collectionItemsDestinationUrlTemplate, Integer createdTime, String id, List<RejectedReasonsEnum> rejectedReasons, List<String> rejectionLabels, ReviewStatusEnum reviewStatus, String type, Integer updatedTime, PinPromotionSummaryStatus summaryStatus) {
