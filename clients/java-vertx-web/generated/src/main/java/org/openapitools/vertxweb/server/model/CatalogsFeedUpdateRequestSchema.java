...
public class CatalogsFeedUpdateRequestSchema   {
  ...
  public CatalogsFeedUpdateRequestSchema () {

  }

  public CatalogsFeedUpdateRequestSchema (CatalogsFeedCredentials credentials, ProductAvailabilityType defaultAvailability, NullableCurrency defaultCurrency, CatalogsFormat format, String location, String name, CatalogsFeedProcessingSchedule preferredProcessingSchedule, CatalogsStatus status) {
