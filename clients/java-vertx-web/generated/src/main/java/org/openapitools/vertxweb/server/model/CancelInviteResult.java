...
import org.openapitools.vertxweb.server.model.CancelInviteResultUser;
...
public class CancelInviteResult   {
  ...
  public CancelInviteResult (String id, InviteDataResponse inviteData, Boolean isReceivedInvite, CancelInviteResultUser user) {
    this.id = id;
