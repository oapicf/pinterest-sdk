...
public interface CatalogReportsApi  {
    ...
    Future<ApiResponse<ReportsStats200Response>> reportsStats(ReportsStatsParametersParameter parameters, String adAccountId, Integer pageSize, String bookmark);
}
