...
public class CatalogsHotelFilterValuesMap   {
  ...
  public CatalogsHotelFilterValuesMap (List<String> brand, List<String> customLabel0, List<String> customLabel1, List<String> customLabel2, List<String> customLabel3, List<String> customLabel4) {
    this.brand = brand;
