...
public interface CampaignsApi  {
    ...
    Future<ApiResponse<CampaignBatchWriteResponseModel>> campaignsCreate(String adAccountId, List<CampaignCreateItem> campaignCreateItem);
    Future<ApiResponse<Campaign>> campaignsGet(String campaignId, String adAccountId);
    Future<ApiResponse<CampaignsList200Response>> campaignsList(String adAccountId, String bookmark, Integer pageSize, PinterestLibPaginationOrder order, List<String> campaignIds, List<EntityStatus> entityStatuses);
    Future<ApiResponse<CampaignBatchWriteResponseModel>> campaignsUpdate(String adAccountId, List<CampaignBatchUpdateItem> campaignBatchUpdateItem);
    Future<ApiResponse<CampaignDeliveryEstimatesResponse>> getCampaignDeliveryEstimates(String adAccountId, List<CampaignDeliveryEstimatesCampaign> campaignDeliveryEstimatesCampaign);
}
