...
import org.openapitools.vertxweb.server.api.ProductCategoriesApiHandler;
import org.openapitools.vertxweb.server.api.ProductCategoriesApiImpl;
...
public class HttpServerVerticle extends AbstractVerticle {
    ...
    private final ProductCategoriesApiHandler productCategoriesHandler = new ProductCategoriesApiHandler(new ProductCategoriesApiImpl());
    ...
    public void start(Promise<Void> startPromise) {
        RouterBuilder.create(vertx, specFile)
            .map(builder -> {
              ...
              productCategoriesHandler.mount(builder);
