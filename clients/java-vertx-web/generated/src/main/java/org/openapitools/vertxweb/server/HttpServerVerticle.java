...
import org.openapitools.vertxweb.server.api.CatalogFeedsApiHandler;
import org.openapitools.vertxweb.server.api.CatalogFeedsApiImpl;
import org.openapitools.vertxweb.server.api.CatalogItemsApiHandler;
import org.openapitools.vertxweb.server.api.CatalogItemsApiImpl;
import org.openapitools.vertxweb.server.api.CatalogProductGroupsApiHandler;
import org.openapitools.vertxweb.server.api.CatalogProductGroupsApiImpl;
import org.openapitools.vertxweb.server.api.CatalogReportsApiHandler;
import org.openapitools.vertxweb.server.api.CatalogReportsApiImpl;
import org.openapitools.vertxweb.server.api.CatalogSupplementalApiHandler;
import org.openapitools.vertxweb.server.api.CatalogSupplementalApiImpl;
...
import org.openapitools.vertxweb.server.api.ConversionDeletionRequestsApiHandler;
import org.openapitools.vertxweb.server.api.ConversionDeletionRequestsApiImpl;
import org.openapitools.vertxweb.server.api.ConversionEqsApiHandler;
import org.openapitools.vertxweb.server.api.ConversionEqsApiImpl;
...
import org.openapitools.vertxweb.server.api.ConversionsApiHandler;
import org.openapitools.vertxweb.server.api.ConversionsApiImpl;
import org.openapitools.vertxweb.server.api.CustomerListUploadsApiHandler;
import org.openapitools.vertxweb.server.api.CustomerListUploadsApiImpl;
...
import org.openapitools.vertxweb.server.api.CustomerSegmentApiHandler;
import org.openapitools.vertxweb.server.api.CustomerSegmentApiImpl;
...
import org.openapitools.vertxweb.server.api.LabelsApiHandler;
import org.openapitools.vertxweb.server.api.LabelsApiImpl;
...
import org.openapitools.vertxweb.server.api.MsotEventsApiHandler;
import org.openapitools.vertxweb.server.api.MsotEventsApiImpl;
import org.openapitools.vertxweb.server.api.NotificationApiHandler;
import org.openapitools.vertxweb.server.api.NotificationApiImpl;
...
import org.openapitools.vertxweb.server.api.ProductTagsApiHandler;
import org.openapitools.vertxweb.server.api.ProductTagsApiImpl;
import org.openapitools.vertxweb.server.api.PromotionsApiHandler;
import org.openapitools.vertxweb.server.api.PromotionsApiImpl;
...
import org.openapitools.vertxweb.server.api.SchedulesApiHandler;
import org.openapitools.vertxweb.server.api.SchedulesApiImpl;
...
import org.openapitools.vertxweb.server.api.TrendsApiHandler;
import org.openapitools.vertxweb.server.api.TrendsApiImpl;
...
public class HttpServerVerticle extends AbstractVerticle {
    ...
    private final CatalogFeedsApiHandler catalogFeedsHandler = new CatalogFeedsApiHandler(new CatalogFeedsApiImpl());
    private final CatalogItemsApiHandler catalogItemsHandler = new CatalogItemsApiHandler(new CatalogItemsApiImpl());
    private final CatalogProductGroupsApiHandler catalogProductGroupsHandler = new CatalogProductGroupsApiHandler(new CatalogProductGroupsApiImpl());
    private final CatalogReportsApiHandler catalogReportsHandler = new CatalogReportsApiHandler(new CatalogReportsApiImpl());
    private final CatalogSupplementalApiHandler catalogSupplementalHandler = new CatalogSupplementalApiHandler(new CatalogSupplementalApiImpl());
    private final CatalogsApiHandler catalogsHandler = new CatalogsApiHandler(new CatalogsApiImpl());
    private final ConversionDeletionRequestsApiHandler conversionDeletionRequestsHandler = new ConversionDeletionRequestsApiHandler(new ConversionDeletionRequestsApiImpl());
    private final ConversionEqsApiHandler conversionEqsHandler = new ConversionEqsApiHandler(new ConversionEqsApiImpl());
    ...
    private final ConversionsApiHandler conversionsHandler = new ConversionsApiHandler(new ConversionsApiImpl());
    private final CustomerListUploadsApiHandler customerListUploadsHandler = new CustomerListUploadsApiHandler(new CustomerListUploadsApiImpl());
    private final CustomerListsApiHandler customerListsHandler = new CustomerListsApiHandler(new CustomerListsApiImpl());
    private final CustomerSegmentApiHandler customerSegmentHandler = new CustomerSegmentApiHandler(new CustomerSegmentApiImpl());
    ...
    private final LabelsApiHandler labelsHandler = new LabelsApiHandler(new LabelsApiImpl());
    ...
    private final MsotEventsApiHandler msotEventsHandler = new MsotEventsApiHandler(new MsotEventsApiImpl());
    private final NotificationApiHandler notificationHandler = new NotificationApiHandler(new NotificationApiImpl());
    ...
    private final ProductTagsApiHandler productTagsHandler = new ProductTagsApiHandler(new ProductTagsApiImpl());
    private final PromotionsApiHandler promotionsHandler = new PromotionsApiHandler(new PromotionsApiImpl());
    private final ResourcesApiHandler resourcesHandler = new ResourcesApiHandler(new ResourcesApiImpl());
    private final SchedulesApiHandler schedulesHandler = new SchedulesApiHandler(new SchedulesApiImpl());
    ...
    private final TrendsApiHandler trendsHandler = new TrendsApiHandler(new TrendsApiImpl());
    ...
    public void start(Promise<Void> startPromise) {
        RouterBuilder.create(vertx, specFile)
            .map(builder -> {
              ...
              catalogFeedsHandler.mount(builder);
              catalogItemsHandler.mount(builder);
              catalogProductGroupsHandler.mount(builder);
              catalogReportsHandler.mount(builder);
              catalogSupplementalHandler.mount(builder);
              catalogsHandler.mount(builder);
              conversionDeletionRequestsHandler.mount(builder);
              conversionEqsHandler.mount(builder);
              conversionEventsHandler.mount(builder);
              conversionTagsHandler.mount(builder);
              conversionsHandler.mount(builder);
              customerListUploadsHandler.mount(builder);
              customerListsHandler.mount(builder);
              customerSegmentHandler.mount(builder);
              integrationsHandler.mount(builder);
              keywordsHandler.mount(builder);
              labelsHandler.mount(builder);
              leadAdsHandler.mount(builder);
              leadFormsHandler.mount(builder);
              leadsExportHandler.mount(builder);
              mediaHandler.mount(builder);
              msotEventsHandler.mount(builder);
              notificationHandler.mount(builder);
              ...
              productTagsHandler.mount(builder);
              promotionsHandler.mount(builder);
              resourcesHandler.mount(builder);
              schedulesHandler.mount(builder);
