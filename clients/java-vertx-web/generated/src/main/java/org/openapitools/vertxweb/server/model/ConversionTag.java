...
public class ConversionTag   {
  ...
  public ConversionTag (String codeSnippet, ConversionTagConfigs configs, EnhancedMatchStatusType enhancedMatchStatus, String id, BigDecimal lastFiredTimeMs, String name, String version, String adAccountId, EntityStatus status) {
