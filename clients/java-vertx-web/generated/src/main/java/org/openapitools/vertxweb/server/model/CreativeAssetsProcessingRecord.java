...
public class CreativeAssetsProcessingRecord   {
  ...
  public CreativeAssetsProcessingRecord (String creativeAssetsId, List<ItemValidationEvent> errors, ItemProcessingStatus status, List<ItemValidationEvent> warnings) {
