...
public class CreativeAssetsProcessingRecord   {
  ...
  public CreativeAssetsProcessingRecord (String creativeAssetsId, List<ItemValidationEvent> errors, List<ItemValidationEvent> warnings, ItemProcessingStatus status) {
