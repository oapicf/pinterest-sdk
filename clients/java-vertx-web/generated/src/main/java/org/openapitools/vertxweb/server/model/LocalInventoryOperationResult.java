...
public class LocalInventoryOperationResult   {
  ...
  public LocalInventoryOperationResult (List<SupplementalItemValidationEvent> errors, String itemId, SupplementalItemProcessingStatus status, String storeCode, SupplementalTypeEnum supplementalType, List<SupplementalItemValidationEvent> warnings) {
    this.errors = errors;
    this.itemId = itemId;
    this.status = status;
