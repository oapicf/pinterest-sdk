...
public class AggregatedPinComment   {
  ...
  public AggregatedPinComment (AiDisclosures aiDisclosures, String altText, String boardId, BoardOwner boardOwner, String boardSectionId, OffsetDateTime createdAt, CreativeType creativeType, String description, String dominantColor, Boolean hasBeenPromoted, String id, Boolean isOwner, Boolean isProduct, Boolean isStandard, String link, PinMedia media, String parentPinId, Object pinMetrics, String title) {
