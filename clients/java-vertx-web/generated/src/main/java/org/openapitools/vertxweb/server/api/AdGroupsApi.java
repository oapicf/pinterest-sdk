...
public interface AdGroupsApi  {
    ...
    Future<ApiResponse<AdGroupAudienceSizing>> adGroupsAudienceSizing(String adAccountId, AdGroupAudienceSizingCreate adGroupAudienceSizingCreate);
    Future<ApiResponse<BidFloor>> adGroupsBidFloorGet(String adAccountId, BidFloorCreate bidFloorCreate);
    Future<ApiResponse<AdGroupsCreate200Response>> adGroupsCreate(String adAccountId, List<AdGroupCreateCreate> adGroupCreateCreate);
    Future<ApiResponse<DynamicTitlesDownloadCSV>> adGroupsDynamicTitlesDownloadCsv(String adAccountId, String adGroupId);
    Future<ApiResponse<DynamicTitlesGetStatus>> adGroupsDynamicTitlesGetStatus(String adAccountId, String adGroupId);
    Future<ApiResponse<DynamicTitlesUploadURL>> adGroupsDynamicTitlesGetUploadUrl(String adAccountId, String adGroupId);
    Future<ApiResponse<DynamicTitlesProcessCSV>> adGroupsDynamicTitlesProcessCsv(String adAccountId, String adGroupId, DynamicTitlesProcessCSVCreate dynamicTitlesProcessCSVCreate);
    Future<ApiResponse<AdGroup>> adGroupsGet(String adGroupId, String adAccountId);
    Future<ApiResponse<AdGroupsList200Response>> adGroupsList(String adAccountId, String bookmark, Integer pageSize, PinterestLibPaginationOrder order, List<String> campaignIds, List<String> adGroupIds, List<EntityStatus> entityStatuses, Boolean translateInterestsToNames);
    ...
    Future<ApiResponse<AdGroupsCreate200Response>> adGroupsUpdate(String adAccountId, List<AdGroupUpdateBatchUpdate> adGroupUpdateBatchUpdate);
    Future<ApiResponse<AdGroupsList200Response>> getAdGroupsByPromotionIdsList(String adAccountId, List<String> promotionIds, String bookmark, Integer pageSize, PinterestLibPaginationOrder order);
}
