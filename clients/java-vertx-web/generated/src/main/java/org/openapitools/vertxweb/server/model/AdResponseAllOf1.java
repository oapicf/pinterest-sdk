...
public class AdResponseAllOf1   {
  ...
  public AdResponseAllOf1 (String adAccountId, String campaignId, String collectionItemsDestinationUrlTemplate, Integer createdTime, String id, List<RejectedReasonsEnum> rejectedReasons, List<String> rejectionLabels, ReviewStatusEnum reviewStatus, String type, Integer updatedTime, PinPromotionSummaryStatus summaryStatus) {
