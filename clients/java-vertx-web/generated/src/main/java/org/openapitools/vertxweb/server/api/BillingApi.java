...
public interface BillingApi  {
    ...
    Future<ApiResponse<BillingInvoicesGet200Response>> billingInvoicesGet(String adAccountId, String bookmark, Integer pageSize, String sort, String order, String status, String documentType, LocalDate startDueDate, LocalDate endDueDate);
