...
import org.openapitools.vertxweb.server.model.OrderLineMutationError;
...
public class OrderLineMutationResult   {
  ...
  public OrderLineMutationResult (List<OrderLineMutationError> errors, List<OrderLine> orderLine) {
    this.errors = errors;
