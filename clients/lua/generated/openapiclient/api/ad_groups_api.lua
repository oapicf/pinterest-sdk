...
function ad_groups_api:ad_groups_analytics(ad_account_id, start_date, end_date, ad_group_ids, columns, granularity, click_window_days, engagement_window_days, view_window_days, conversion_report_time, aggregate_report_rows, reporting_timezone)
...
function ad_groups_api:ad_groups_targeting_analytics_get(ad_account_id, ad_group_ids, start_date, end_date, targeting_types, columns, granularity, click_window_days, engagement_window_days, view_window_days, conversion_report_time, attribution_types, reporting_timezone)
	local req = http_request.new_from_uri({
		scheme = self.default_scheme;
		host = self.host;
		port = self.port;
		path = string.format("%s/ad_accounts/%s/ad_groups/targeting_analytics?ad_group_ids=%s&start_date=%s&end_date=%s&targeting_types=%s&columns=%s&granularity=%s&click_window_days=%s&engagement_window_days=%s&view_window_days=%s&conversion_report_time=%s&attribution_types=%s&reporting_timezone=%s",
