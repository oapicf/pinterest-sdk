...
local openapiclient_leads_exports = require "openapiclient.model.leads_exports"
local openapiclient_pinterest_lib_error = require "openapiclient.model.pinterest_lib_error"
local openapiclient_leads_exports_create = require "openapiclient.model.leads_exports_create"
...
function leads_export_api:leads_export_create(ad_account_id, leads_exports_create)
	...
	req:set_body(dkjson.encode(leads_exports_create))
	...
	if http_status:sub(1,1) == "2" then
		...
		return openapiclient_leads_exports.cast(result), headers
	else
		local body, err, errno2 = stream:get_body_as_string()
		if not body then
			return nil, err, errno2
