...
local function new_pin_media_source(content_type, data, is_standard, source_type, url, cover_image_content_type, cover_image_data, cover_image_key_frame_time, cover_image_url, media_id, index, items, is_affiliate_link)
