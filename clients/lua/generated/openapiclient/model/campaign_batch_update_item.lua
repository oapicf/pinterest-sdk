...
-- campaign_batch_update_item class
local campaign_batch_update_item = {}
local campaign_batch_update_item_mt = {
	__name = "campaign_batch_update_item";
	__index = campaign_batch_update_item;
}

local function cast_campaign_batch_update_item(t)
	return setmetatable(t, campaign_batch_update_item_mt)
end

local function new_campaign_batch_update_item(ad_account_id, app_id, app_platform, bid_options, daily_spend_cap, default_ad_group_budget_in_micro_currency, end_time, id, intended_promotion_type, is_automated_campaign, is_campaign_budget_optimization, is_flexible_daily_budgets, is_ltv_optimized, is_performance_plus, is_top_of_search, lifetime_spend_cap, name, objective_type, order_line_id, performance_plus_campaign_settings, start_time, status, tracking_urls)
	return cast_campaign_batch_update_item({
...
return {
	cast = cast_campaign_batch_update_item;
	new = new_campaign_batch_update_item;
}
