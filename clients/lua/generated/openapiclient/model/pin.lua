...
local function new_pin(alt_text, board_id, board_owner, board_section_id, created_at, creative_type, description, dominant_color, has_been_promoted, id, is_owner, is_standard, link, media, parent_pin_id, pin_metrics, title)
	return cast_pin({
		["alt_text"] = alt_text;
		["board_id"] = board_id;
