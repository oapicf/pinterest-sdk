...
local function new_catalogs_hotel_feeds_create_request(catalog_id, catalog_type, credentials, default_currency, default_locale, format, location, name, preferred_processing_schedule, status)
