...
local function new_catalogs_vertical_feeds_create_request(default_currency, name, format, default_locale, credentials, location, preferred_processing_schedule, catalog_type, default_country, default_availability, catalog_id)
