...
------------ | ------------- | ------------- | -------------
**ad_account_id** | **str** | Advertiser ID. | [optional] [readonly] 
...
**type** | **str** | Always \&quot;adgroup\&quot;. | [readonly] [default to 'adgroup']
...
json = "{}"
# create an instance of AdGroupCreate from a JSON string
ad_group_create_instance = AdGroupCreate.from_json(json)
# print the JSON string representation of the object
print AdGroupCreate.to_json()

# convert the object into a dict
ad_group_create_dict = ad_group_create_instance.to_dict()
# create an instance of AdGroupCreate from a dict
ad_group_create_from_dict = AdGroupCreate.from_dict(ad_group_create_dict)
```
