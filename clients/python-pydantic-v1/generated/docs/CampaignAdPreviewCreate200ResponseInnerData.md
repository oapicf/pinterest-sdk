...
campaign_ad_preview_create200_response_inner_data_instance = CampaignAdPreviewCreate200ResponseInnerData.from_json(json)
# print the JSON string representation of the object
print CampaignAdPreviewCreate200ResponseInnerData.to_json()

# convert the object into a dict
campaign_ad_preview_create200_response_inner_data_dict = campaign_ad_preview_create200_response_inner_data_instance.to_dict()
# create an instance of CampaignAdPreviewCreate200ResponseInnerData from a dict
campaign_ad_preview_create200_response_inner_data_from_dict = CampaignAdPreviewCreate200ResponseInnerData.from_dict(campaign_ad_preview_create200_response_inner_data_dict)
```
