...
**targeting_strategy** | [**List[TargetingStrategy]**](TargetingStrategy.md) |  | [optional] 
...
json = "{}"
# create an instance of TargetingSpecOptimal from a JSON string
targeting_spec_optimal_instance = TargetingSpecOptimal.from_json(json)
# print the JSON string representation of the object
print TargetingSpecOptimal.to_json()

# convert the object into a dict
targeting_spec_optimal_dict = targeting_spec_optimal_instance.to_dict()
# create an instance of TargetingSpecOptimal from a dict
targeting_spec_optimal_from_dict = TargetingSpecOptimal.from_dict(targeting_spec_optimal_dict)
```
