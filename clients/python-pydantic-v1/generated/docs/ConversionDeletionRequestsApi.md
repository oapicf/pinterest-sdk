# openapi_client.ConversionDeletionRequestsApi
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.ConversionDeletionRequestsApi(api_client)
    ad_account_id = 'ad_account_id_example' # str | Unique identifier of an ad account.
    conversion_deletion_request_create = openapi_client.ConversionDeletionRequestCreate() # ConversionDeletionRequestCreate | 
