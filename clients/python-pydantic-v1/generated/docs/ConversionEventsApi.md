# openapi_client.ConversionEventsApi
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.ConversionEventsApi(api_client)
    ad_account_id = 'ad_account_id_example' # str | Unique identifier of an ad account.
    conversion_events_create = openapi_client.ConversionEventsCreate() # ConversionEventsCreate | 
