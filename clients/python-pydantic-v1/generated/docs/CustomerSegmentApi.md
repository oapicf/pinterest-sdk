# openapi_client.CustomerSegmentApi
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.CustomerSegmentApi(api_client)
    ad_account_id = 'ad_account_id_example' # str | Unique identifier of an ad account.
    customer_segment_create = openapi_client.CustomerSegmentCreate() # CustomerSegmentCreate | 
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.CustomerSegmentApi(api_client)
    ad_account_id = 'ad_account_id_example' # str | Unique identifier of an ad account.
    customer_segment_update_request_update_with_required_body = openapi_client.CustomerSegmentUpdateRequestUpdateWithRequiredBody() # CustomerSegmentUpdateRequestUpdateWithRequiredBody | 
