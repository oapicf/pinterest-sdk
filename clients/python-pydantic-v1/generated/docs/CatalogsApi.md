...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    country = openapi_client.Country() # Country | Country for the Catalogs Items (optional)
    language = openapi_client.CatalogsLocale() # CatalogsLocale | Language for the Catalogs Items (optional)
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.CatalogsApi(api_client)
    catalog_create = openapi_client.CatalogCreate() # CatalogCreate | 
    ad_account_id = 'ad_account_id_example' # str | Unique identifier of an ad account. (optional)
