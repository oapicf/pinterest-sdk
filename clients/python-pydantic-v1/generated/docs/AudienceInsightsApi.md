# openapi_client.AudienceInsightsApi
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.AudienceInsightsApi(api_client)
    ad_account_id = 'ad_account_id_example' # str | Unique identifier of an ad account.
    audience_insight_type = openapi_client.AudienceInsightType() # AudienceInsightType | Type of audience insights.
