# openapi_client.ConversionTagsApi
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.ConversionTagsApi(api_client)
    ad_account_id = 'ad_account_id_example' # str | Unique identifier of an ad account.
    conversion_tag_create = openapi_client.ConversionTagCreate() # ConversionTagCreate | 
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.ConversionTagsApi(api_client)
    ad_account_id = 'ad_account_id_example' # str | Unique identifier of an ad account.
    conversion_tag_id = 'conversion_tag_id_example' # str | Id of the conversion tag.
...
> PageVisitConversionTagsGet200Response page_visit_conversion_tags_get(ad_account_id, bookmark=bookmark, page_size=page_size, order=order)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get page visit conversion tags
        api_response = api_instance.page_visit_conversion_tags_get(ad_account_id, bookmark=bookmark, page_size=page_size, order=order)
