...
ad_group_update_request_all_of1_instance = AdGroupUpdateRequestAllOf1.from_json(json)
# print the JSON string representation of the object
print AdGroupUpdateRequestAllOf1.to_json()

# convert the object into a dict
ad_group_update_request_all_of1_dict = ad_group_update_request_all_of1_instance.to_dict()
# create an instance of AdGroupUpdateRequestAllOf1 from a dict
ad_group_update_request_all_of1_from_dict = AdGroupUpdateRequestAllOf1.from_dict(ad_group_update_request_all_of1_dict)
```
