...
json = "{}"
# create an instance of AdCreate from a JSON string
ad_create_instance = AdCreate.from_json(json)
# print the JSON string representation of the object
print AdCreate.to_json()

# convert the object into a dict
ad_create_dict = ad_create_instance.to_dict()
# create an instance of AdCreate from a dict
ad_create_from_dict = AdCreate.from_dict(ad_create_dict)
```
