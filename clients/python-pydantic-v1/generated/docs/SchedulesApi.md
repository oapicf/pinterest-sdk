...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    schedule_create = [openapi_client.ScheduleCreate()] # List[ScheduleCreate] | 
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    schedule_statuses = [openapi_client.ScheduleStatus()] # List[ScheduleStatus] | Filter schedules by status (one or more) (optional)
    schedule_type = openapi_client.ScheduleType() # ScheduleType | Filter schedules by a type (optional)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.SchedulesApi(api_client)
    ad_account_id = 'ad_account_id_example' # str | 
    schedule_batch_update = [openapi_client.ScheduleBatchUpdate()] # List[ScheduleBatchUpdate] | 
