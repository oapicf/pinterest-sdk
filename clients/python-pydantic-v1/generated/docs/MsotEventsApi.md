...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.MsotEventsApi(api_client)
    ad_account_id = 'ad_account_id_example' # str | Unique identifier of an ad account.
    conversion_msot_events_create = openapi_client.ConversionMSOTEventsCreate() # ConversionMSOTEventsCreate | 
