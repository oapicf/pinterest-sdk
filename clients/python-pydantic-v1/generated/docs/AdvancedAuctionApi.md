# openapi_client.AdvancedAuctionApi
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.AdvancedAuctionApi(api_client)
    advanced_auction_items_get_request = openapi_client.AdvancedAuctionItemsGetRequest() # AdvancedAuctionItemsGetRequest | 
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.AdvancedAuctionApi(api_client)
    advanced_auction_items_submit_request = openapi_client.AdvancedAuctionItemsSubmitRequest() # AdvancedAuctionItemsSubmitRequest | 
    ad_account_id = 'ad_account_id_example' # str | Unique identifier of an ad account. (optional)
