...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.IntegrationsApi(api_client)
    external_business_id = 'external_business_id_example' # str | External business ID for the integration.
    integration_metadata_update = openapi_client.IntegrationMetadataUpdate() # IntegrationMetadataUpdate | 
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.IntegrationsApi(api_client)
    integration_metadata_create = openapi_client.IntegrationMetadataCreate() # IntegrationMetadataCreate | 
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.IntegrationsApi(api_client)
    integration_logs_request_create = openapi_client.IntegrationLogsRequestCreate() # IntegrationLogsRequestCreate | 
