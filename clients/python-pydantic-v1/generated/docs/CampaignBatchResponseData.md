...
**objective_type** | [**CampaignObjectiveType**](CampaignObjectiveType.md) |  | [optional] 
...
campaign_batch_response_data_instance = CampaignBatchResponseData.from_json(json)
# print the JSON string representation of the object
print CampaignBatchResponseData.to_json()

# convert the object into a dict
campaign_batch_response_data_dict = campaign_batch_response_data_instance.to_dict()
# create an instance of CampaignBatchResponseData from a dict
campaign_batch_response_data_from_dict = CampaignBatchResponseData.from_dict(campaign_batch_response_data_dict)
```
