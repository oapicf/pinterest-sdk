...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.LeadFormsApi(api_client)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    lead_form_test_create = openapi_client.LeadFormTestCreate() # LeadFormTestCreate | 
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.LeadFormsApi(api_client)
    ad_account_id = 'ad_account_id_example' # str | Unique identifier of an ad account.
    lead_form_create = [openapi_client.LeadFormCreate()] # List[LeadFormCreate] | 
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.LeadFormsApi(api_client)
    ad_account_id = 'ad_account_id_example' # str | Unique identifier of an ad account.
    lead_form_batch_update = [openapi_client.LeadFormBatchUpdate()] # List[LeadFormBatchUpdate] | 
