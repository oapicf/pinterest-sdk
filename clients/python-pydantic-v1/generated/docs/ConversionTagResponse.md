...
conversion_tag_response_instance = ConversionTagResponse.from_json(json)
# print the JSON string representation of the object
print ConversionTagResponse.to_json()

# convert the object into a dict
conversion_tag_response_dict = conversion_tag_response_instance.to_dict()
# create an instance of ConversionTagResponse from a dict
conversion_tag_response_from_dict = ConversionTagResponse.from_dict(conversion_tag_response_dict)
```
