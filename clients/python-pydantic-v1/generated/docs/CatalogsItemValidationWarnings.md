...
catalogs_item_validation_warnings_instance = CatalogsItemValidationWarnings.from_json(json)
# print the JSON string representation of the object
print CatalogsItemValidationWarnings.to_json()

# convert the object into a dict
catalogs_item_validation_warnings_dict = catalogs_item_validation_warnings_instance.to_dict()
# create an instance of CatalogsItemValidationWarnings from a dict
catalogs_item_validation_warnings_from_dict = CatalogsItemValidationWarnings.from_dict(catalogs_item_validation_warnings_dict)
```
