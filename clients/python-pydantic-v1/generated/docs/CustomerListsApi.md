# openapi_client.CustomerListsApi
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.CustomerListsApi(api_client)
    ad_account_id = 'ad_account_id_example' # str | 
    customer_list_create = openapi_client.CustomerListCreate() # CustomerListCreate | 
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    ad_account_id = 'ad_account_id_example' # str | 
    customer_list_id = 'customer_list_id_example' # str | Customer list ID.
    customer_list_update_with_required_body = openapi_client.CustomerListUpdateWithRequiredBody() # CustomerListUpdateWithRequiredBody | 
