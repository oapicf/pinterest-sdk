...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    labeled_entities_create = openapi_client.LabeledEntitiesCreate() # LabeledEntitiesCreate | 
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    label_create_request = openapi_client.LabelCreateRequest() # LabelCreateRequest | 
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.LabelsApi(api_client)
    ad_account_id = 'ad_account_id_example' # str | Unique identifier of an ad account.
    label_update_request = openapi_client.LabelUpdateRequest() # LabelUpdateRequest | 
