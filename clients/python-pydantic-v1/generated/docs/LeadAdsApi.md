...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.LeadAdsApi(api_client)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.LeadAdsApi(api_client)
    ad_account_id = 'ad_account_id_example' # str | Unique identifier of an ad account.
    lead_subscription_post_params_create = openapi_client.LeadSubscriptionPostParamsCreate() # LeadSubscriptionPostParamsCreate | 
