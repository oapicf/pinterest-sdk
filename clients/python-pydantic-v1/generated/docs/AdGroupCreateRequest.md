...
ad_group_create_request_instance = AdGroupCreateRequest.from_json(json)
# print the JSON string representation of the object
print AdGroupCreateRequest.to_json()

# convert the object into a dict
ad_group_create_request_dict = ad_group_create_request_instance.to_dict()
# create an instance of AdGroupCreateRequest from a dict
ad_group_create_request_from_dict = AdGroupCreateRequest.from_dict(ad_group_create_request_dict)
```
