...
json = "{}"
# create an instance of AdGroupCreateCreate from a JSON string
ad_group_create_create_instance = AdGroupCreateCreate.from_json(json)
# print the JSON string representation of the object
print AdGroupCreateCreate.to_json()

# convert the object into a dict
ad_group_create_create_dict = ad_group_create_create_instance.to_dict()
# create an instance of AdGroupCreateCreate from a dict
ad_group_create_create_from_dict = AdGroupCreateCreate.from_dict(ad_group_create_create_dict)
```
