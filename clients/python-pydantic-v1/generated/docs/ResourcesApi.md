...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.ResourcesApi(api_client)
    report_type = openapi_client.ReportType() # ReportType | Report type. (optional)
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.ResourcesApi(api_client)
    targeting_type = openapi_client.PublicTargetingType() # PublicTargetingType | Public targeting type
