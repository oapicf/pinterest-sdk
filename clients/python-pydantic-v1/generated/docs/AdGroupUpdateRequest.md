...
**optimization_goal_metadata** | **object** | Optimization goals for objective-based performance campaigns. **REQUIRED** when campaign&#39;s &#x60;objective_type&#x60; is set to &#x60;\&quot;WEB_CONVERSION\&quot;&#x60;. | [optional] 
...
**promotion_application_level** | **str** | Specify if the promotion is applied at ad group or item level | [optional] 
**promotion_id** | **str** | Promotion ID. To clear this field, set to null. | [optional] [default to '0']
**promotion_ids** | **List[str]** | Promotion IDs list. To clear this field, set to an empty array []. | [optional] 
...
json = "{}"
# create an instance of AdGroupUpdateRequest from a JSON string
ad_group_update_request_instance = AdGroupUpdateRequest.from_json(json)
# print the JSON string representation of the object
print AdGroupUpdateRequest.to_json()

# convert the object into a dict
ad_group_update_request_dict = ad_group_update_request_instance.to_dict()
# create an instance of AdGroupUpdateRequest from a dict
ad_group_update_request_from_dict = AdGroupUpdateRequest.from_dict(ad_group_update_request_dict)
```
