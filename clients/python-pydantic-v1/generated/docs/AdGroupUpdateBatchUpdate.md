...
------------ | ------------- | ------------- | -------------
**auto_targeting_enabled** | **bool** | Enable auto-targeting for ad group. Default value is True. Also known as [\&quot;Performance+ targeting\&quot;](https://help.pinterest.com/en/business/article/performance-plus-targeting). | [optional] 
...
**customer_segment_id** | **str** | Customer segment ID applied to the ad group. We currently only support 1 customer segment per ad group. To use customer segments, do not set the &#x60;targeting_template_ids&#x60; field as well as the &#x60;AUDIENCE_INCLUDE&#x60; field of the &#x60;targeting_spec&#x60;. To clear the customer segment ID, set this field to &#39;0&#39;. | [optional] 
...
**targeting_spec_operations** | [**List[TargetingSpecOperations]**](TargetingSpecOperations.md) |  | [optional] 
...
json = "{}"
# create an instance of AdGroupUpdateBatchUpdate from a JSON string
ad_group_update_batch_update_instance = AdGroupUpdateBatchUpdate.from_json(json)
# print the JSON string representation of the object
print AdGroupUpdateBatchUpdate.to_json()

# convert the object into a dict
ad_group_update_batch_update_dict = ad_group_update_batch_update_instance.to_dict()
# create an instance of AdGroupUpdateBatchUpdate from a dict
ad_group_update_batch_update_from_dict = AdGroupUpdateBatchUpdate.from_dict(ad_group_update_batch_update_dict)
```
