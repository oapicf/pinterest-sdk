# openapi_client.ProductGroupPromotionsApi
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.ProductGroupPromotionsApi(api_client)
    ad_account_id = 'ad_account_id_example' # str | Unique identifier of an ad account.
    product_group_promotions_create = openapi_client.ProductGroupPromotionsCreate() # ProductGroupPromotionsCreate | 
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.ProductGroupPromotionsApi(api_client)
    ad_account_id = 'ad_account_id_example' # str | Unique identifier of an ad account.
    product_group_promotions_update_with_required_body = openapi_client.ProductGroupPromotionsUpdateWithRequiredBody() # ProductGroupPromotionsUpdateWithRequiredBody | 
