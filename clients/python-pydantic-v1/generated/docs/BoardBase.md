...
board_base_instance = BoardBase.from_json(json)
# print the JSON string representation of the object
print BoardBase.to_json()

# convert the object into a dict
board_base_dict = board_base_instance.to_dict()
# create an instance of BoardBase from a dict
board_base_from_dict = BoardBase.from_dict(board_base_dict)
```
