...
**objective_type** | [**List[AudienceObjectiveType]**](AudienceObjectiveType.md) | Objective for engagement audience filter. | [optional] 
...
ad_accounts_audience_rule_instance = AdAccountsAudienceRule.from_json(json)
# print the JSON string representation of the object
print AdAccountsAudienceRule.to_json()

# convert the object into a dict
ad_accounts_audience_rule_dict = ad_accounts_audience_rule_instance.to_dict()
# create an instance of AdAccountsAudienceRule from a dict
ad_accounts_audience_rule_from_dict = AdAccountsAudienceRule.from_dict(ad_accounts_audience_rule_dict)
```
