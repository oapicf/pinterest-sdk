# openapi_client.CatalogSupplementalApi
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.CatalogSupplementalApi(api_client)
    catalog_id = 'catalog_id_example' # str | Unique identifier of a catalog.
    local_inventory_items_batch_create = openapi_client.LocalInventoryItemsBatchCreate() # LocalInventoryItemsBatchCreate | 
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.CatalogSupplementalApi(api_client)
    catalog_id = 'catalog_id_example' # str | Unique identifier of a catalog.
    local_inventory_items_get_create = openapi_client.LocalInventoryItemsGetCreate() # LocalInventoryItemsGetCreate | 
    ad_account_id = 'ad_account_id_example' # str | Unique identifier of an ad account. (optional)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.CatalogSupplementalApi(api_client)
    catalog_id = 'catalog_id_example' # str | Unique identifier of a catalog.
    local_store_create = [openapi_client.LocalStoreCreate()] # List[LocalStoreCreate] | 
    ad_account_id = 'ad_account_id_example' # str | Unique identifier of an ad account. (optional)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.CatalogSupplementalApi(api_client)
    catalog_id = 'catalog_id_example' # str | Unique identifier of a catalog.
    local_store_batch_update = [openapi_client.LocalStoreBatchUpdate()] # List[LocalStoreBatchUpdate] | 
    ad_account_id = 'ad_account_id_example' # str | Unique identifier of an ad account. (optional)
