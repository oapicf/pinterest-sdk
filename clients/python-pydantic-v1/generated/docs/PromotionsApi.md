...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    promotion_create = [openapi_client.PromotionCreate()] # List[PromotionCreate] | 
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.PromotionsApi(api_client)
    ad_account_id = 'ad_account_id_example' # str | Unique identifier of an ad account.
    promotion_batch_update = [openapi_client.PromotionBatchUpdate()] # List[PromotionBatchUpdate] | 
