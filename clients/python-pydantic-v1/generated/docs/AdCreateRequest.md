...
ad_create_request_instance = AdCreateRequest.from_json(json)
# print the JSON string representation of the object
print AdCreateRequest.to_json()

# convert the object into a dict
ad_create_request_dict = ad_create_request_instance.to_dict()
# create an instance of AdCreateRequest from a dict
ad_create_request_from_dict = AdCreateRequest.from_dict(ad_create_request_dict)
```
