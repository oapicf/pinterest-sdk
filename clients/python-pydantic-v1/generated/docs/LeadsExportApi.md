...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.LeadsExportApi(api_client)
    ad_account_id = 'ad_account_id_example' # str | Unique identifier of an ad account.
    leads_exports_create = openapi_client.LeadsExportsCreate() # LeadsExportsCreate | 
