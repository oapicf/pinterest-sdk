...
json = "{}"
# create an instance of AdGroupUpdate from a JSON string
ad_group_update_instance = AdGroupUpdate.from_json(json)
# print the JSON string representation of the object
print AdGroupUpdate.to_json()

# convert the object into a dict
ad_group_update_dict = ad_group_update_instance.to_dict()
# create an instance of AdGroupUpdate from a dict
ad_group_update_from_dict = AdGroupUpdate.from_dict(ad_group_update_dict)
```
