...
json = "{}"
# create an instance of PinRead from a JSON string
pin_read_instance = PinRead.from_json(json)
# print the JSON string representation of the object
print PinRead.to_json()

# convert the object into a dict
pin_read_dict = pin_read_instance.to_dict()
# create an instance of PinRead from a dict
pin_read_from_dict = PinRead.from_dict(pin_read_dict)
```
