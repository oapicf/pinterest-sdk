...
class CampaignCreateRequest(BaseModel):
    ...
    name: StrictStr = Field(default=..., description="Campaign name.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CampaignCreateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CampaignCreateRequest:
        """Create an instance of CampaignCreateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CampaignCreateRequest.parse_obj(obj)

        _obj = CampaignCreateRequest.parse_obj({
