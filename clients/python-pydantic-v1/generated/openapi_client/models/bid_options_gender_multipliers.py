...
class BidOptionsGenderMultipliers(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BidOptionsGenderMultipliers:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BidOptionsGenderMultipliers:
        """Create an instance of BidOptionsGenderMultipliers from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BidOptionsGenderMultipliers.parse_obj(obj)

        _obj = BidOptionsGenderMultipliers.parse_obj({
