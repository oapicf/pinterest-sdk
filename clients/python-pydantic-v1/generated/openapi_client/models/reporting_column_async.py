...
class ReportingColumnAsync(str, Enum):
    """
    Reporting columns
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ReportingColumnAsync:
        """Create an instance of ReportingColumnAsync from a JSON string"""
        return ReportingColumnAsync(json.loads(json_str))
