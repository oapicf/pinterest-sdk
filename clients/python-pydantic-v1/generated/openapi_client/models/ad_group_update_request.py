...
class AdGroupUpdateRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AdGroupUpdateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AdGroupUpdateRequest:
        """Create an instance of AdGroupUpdateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AdGroupUpdateRequest.parse_obj(obj)

        _obj = AdGroupUpdateRequest.parse_obj({
