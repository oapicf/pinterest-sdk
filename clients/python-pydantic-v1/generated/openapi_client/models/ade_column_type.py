...
class AdeColumnType(str, Enum):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AdeColumnType:
        """Create an instance of AdeColumnType from a JSON string"""
        return AdeColumnType(json.loads(json_str))
