...
class Keywords(BaseModel):
    ...
    Keywords
    """
    errors: conlist(KeywordError) = Field(default=..., description="Keyword error")
    keywords: conlist(Keyword) = Field(default=..., description="Keywords")
    __properties = ["errors", "keywords"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Keywords:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Keywords:
        """Create an instance of Keywords from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Keywords.parse_obj(obj)

        _obj = Keywords.parse_obj({
            "errors": [KeywordError.from_dict(_item) for _item in obj.get("errors")] if obj.get("errors") is not None else None,
