...
class AudienceRule(BaseModel):
    ...
    objective_type: Optional[conlist(ObjectiveType)] = Field(default=None, description="Objective for engagement audience filter.")
    ...
    visitor_source_id: Optional[constr(strict=True)] = Field(default=None, description="The conversion tag ID, or the Pinterest tag ID, that you use on your website. For VISITOR `audience_type`.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AudienceRule:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AudienceRule:
        """Create an instance of AudienceRule from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AudienceRule.parse_obj(obj)

        _obj = AudienceRule.parse_obj({
