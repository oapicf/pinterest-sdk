...
class ReportingColumnSync(str, Enum):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ReportingColumnSync:
        """Create an instance of ReportingColumnSync from a JSON string"""
        return ReportingColumnSync(json.loads(json_str))
