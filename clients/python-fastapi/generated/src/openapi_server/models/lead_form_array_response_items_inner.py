...
class LeadFormArrayResponseItemsInner(BaseModel):
    """
    LeadFormArrayResponseItemsInner
    """ # noqa: E501
    data: Optional[LeadFormResponse] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": LeadFormResponse.from_dict(obj.get("data")) if obj.get("data") is not None else None,
