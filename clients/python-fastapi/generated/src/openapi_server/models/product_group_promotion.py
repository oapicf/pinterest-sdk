...
class ProductGroupPromotion(BaseModel):
    ...
    def collections_header_type_validate_enum(cls, value):
        ...
        if value not in ('SHOP_THIS_COLLECTION', 'EXPLORE_THIS_COLLECTION', 'NO_HEADER', 'ON_SALE', 'GET_DEAL',):
    ...
    def customizable_cta_type_validate_enum(cls, value):
        ...
        if value not in ('SHOP_NOW', 'BOOK_NOW', 'ON_SALE', 'GET_DEAL', 'BUY_ONLINE_PICKUP_IN_STORE',):
