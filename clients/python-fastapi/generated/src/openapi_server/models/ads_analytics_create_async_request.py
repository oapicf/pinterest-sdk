...
from openapi_server.models.ads_analytics_create_async_request_all_of_custom_conversion_event_metrics import AdsAnalyticsCreateAsyncRequestAllOfCustomConversionEventMetrics
...
class AdsAnalyticsCreateAsyncRequest(BaseModel):
    ...
    def targeting_types_validate_enum(cls, value):
        ...
        for i in value:
            if i not in ('KEYWORD', 'APPTYPE', 'GENDER', 'LOCATION', 'PLACEMENT', 'COUNTRY', 'TARGETED_INTEREST', 'PINNER_INTEREST', 'AUDIENCE_INCLUDE', 'GEO', 'AGE_BUCKET', 'REGION', 'MEDIA_TYPE', 'AGE_BUCKET_AND_GENDER', 'AUDIENCE_MULTIPLIER', 'CREATIVE_ENHANCEMENTS', 'LOCAL_ADS_STORE_CODE',):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "custom_conversion_event_metrics": [AdsAnalyticsCreateAsyncRequestAllOfCustomConversionEventMetrics.from_dict(_item) for _item in obj.get("custom_conversion_event_metrics")] if obj.get("custom_conversion_event_metrics") is not None else None,
