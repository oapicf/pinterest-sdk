...
from openapi_server.models.ssio_insertion_order_status import SSIOInsertionOrderStatus
try:
...
class SsioInsertionOrdersStatusGetByAdAccount200Response(BaseModel):
    ...
    items: List[SSIOInsertionOrderStatus] = Field(description="Insertion orders status by ad acount id")
