...
class LeadFormUpdateRequest(BaseModel):
    ...
    id: Annotated[str, Field(strict=True)] = Field(description="The ID of this lead form to be updated")
    __properties: ClassVar[List[str]] = ["completion_message", "disclosure_language", "has_accepted_terms", "name", "policy_links", "privacy_policy_link", "questions", "status", "id"]
