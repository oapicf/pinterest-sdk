...
class ScheduleAudienceMultipliers(float):
    """
    ...
    """ # noqa: E501
    audience_id: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, alias="AUDIENCE_ID")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["AUDIENCE_ID"]
