...
from openapi_server.models.billing_invoice_response import BillingInvoiceResponse
try:
...
class BillingInvoicesGet200Response(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "items": [BillingInvoiceResponse.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
