...
class AdAccountsAudienceRule(BaseModel):
    ...
    ad_id: Optional[List[StrictStr]] = Field(default=None, description="Ad ID for engagement audience filter.")
    campaign_id: Optional[List[StrictStr]] = Field(default=None, description="Campaign ID for engagement audience filter.")
    ...
    objective_type: Optional[List[AudienceObjectiveType]] = Field(default=None, description="Objective for engagement audience filter.")
    ...
    pin_id: Optional[List[StrictStr]] = Field(default=None, description="IDs of engaged organic pins. Optional for ENGAGEMENT `audience_type`. For example, \"pin_id:\": [\"34567\"]")
    ...
    seed_id: Optional[List[StrictStr]] = Field(default=None, description="Audience ID(s). For ACTALIKE `audience_type`.")
