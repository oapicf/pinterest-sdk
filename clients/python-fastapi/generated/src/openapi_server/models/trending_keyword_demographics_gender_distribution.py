...
class TrendingKeywordDemographicsGenderDistribution(float):
    """
    ...
    """ # noqa: E501
    gender_distribution: Optional[StrictStr] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["gender_distribution"]

    @field_validator('gender_distribution')
    def gender_distribution_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value

        if value not in ('male', 'female', 'unspecified',):
