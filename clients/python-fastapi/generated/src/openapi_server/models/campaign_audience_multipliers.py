...
class CampaignAudienceMultipliers(float):
    """
    ...
    """ # noqa: E501
    audience_id: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="Audience ID for the multiplier.", alias="AUDIENCE_ID")
