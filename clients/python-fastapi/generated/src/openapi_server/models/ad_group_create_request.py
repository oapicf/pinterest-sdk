...
class AdGroupCreateRequest(BaseModel):
    ...
    campaign_id: Annotated[str, Field(strict=True)] = Field(description="Campaign ID of the ad group.", json_schema_extra={"examples": ["626736533506"]})
    ...
    name: StrictStr = Field(description="Ad group name.", json_schema_extra={"examples": ["Ad Group For Pin: 687195905986"]})
