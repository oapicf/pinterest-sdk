...
class AdGroupCreateRequest(BaseModel):
    ...
    budget_type: Optional[BudgetType] = 'DAILY'
    ...
    pacing_delivery_type: Optional[PacingDeliveryType] = 'STANDARD'
    ...
    def bid_strategy_type_validate_enum(cls, value):
        ...
        if value not in ('AUTOMATIC_BID', 'MAX_BID', 'TARGET_AVG',):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "budget_type": obj.get("budget_type") if obj.get("budget_type") is not None else &#39;DAILY&#39;,
            ...
            "pacing_delivery_type": obj.get("pacing_delivery_type") if obj.get("pacing_delivery_type") is not None else &#39;STANDARD&#39;,
