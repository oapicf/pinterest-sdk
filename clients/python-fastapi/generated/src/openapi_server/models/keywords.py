...
from openapi_server.models.keyword_error import KeywordError
try:
...
class Keywords(BaseModel):
    ...
    Keywords
    """ # noqa: E501
    errors: List[KeywordError] = Field(description="Keyword error")
    keywords: List[Keyword] = Field(description="Keywords")
