...
class AdGroupArrayResponseElement(BaseModel):
    """
    AdGroupArrayResponseElement
    """ # noqa: E501
    data: Optional[AdGroupResponse] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": AdGroupResponse.from_dict(obj.get("data")) if obj.get("data") is not None else None,
