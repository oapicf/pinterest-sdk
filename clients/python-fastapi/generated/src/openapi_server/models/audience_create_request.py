...
class AudienceCreateRequest(BaseModel):
    ...
    name: StrictStr = Field(description="Audience name.")
    rule: AudienceRule
    audience_type: AudienceType = Field(description="<a href=\"/docs/reference/glossary/#Audience Types\">Audience types</a>: ACTALIKE, ENGAGEMENT, CUSTOMER_LIST and VISITOR. Values are case-sensitive.")
    description: Optional[StrictStr] = Field(default=None, description="Audience description.")
    __properties: ClassVar[List[str]] = ["ad_account_id", "name", "rule", "audience_type", "description"]
