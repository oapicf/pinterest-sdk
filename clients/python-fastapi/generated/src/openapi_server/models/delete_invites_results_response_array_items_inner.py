...
from openapi_server.models.delete_invites_results_response_array_items_inner_exception import DeleteInvitesResultsResponseArrayItemsInnerException
try:
    from typing import Self
except ImportError:
    from typing_extensions import Self

class DeleteInvitesResultsResponseArrayItemsInner(BaseModel):
    """
    DeleteInvitesResultsResponseArrayItemsInner
    """ # noqa: E501
    exception: Optional[DeleteInvitesResultsResponseArrayItemsInnerException] = None
    invite: Optional[BaseInviteDataResponse] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "exception": DeleteInvitesResultsResponseArrayItemsInnerException.from_dict(obj.get("exception")) if obj.get("exception") is not None else None,
