...
from openapi_server.models.create_mmm_report_response_data import CreateMMMReportResponseData
try:
    from typing import Self
except ImportError:
    from typing_extensions import Self

class CreateMMMReportResponse(BaseModel):
    """
    CreateMMMReportResponse
    """ # noqa: E501
    code: Optional[Union[StrictFloat, StrictInt]] = None
    data: Optional[CreateMMMReportResponseData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "code": obj.get("code"),
            "data": CreateMMMReportResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
