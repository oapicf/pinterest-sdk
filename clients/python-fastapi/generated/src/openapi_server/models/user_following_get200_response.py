...
class UserFollowingGet200Response(BaseModel):
    """
    UserFollowingGet200Response
    """ # noqa: E501
    bookmark: Optional[StrictStr] = None
    items: List[UserSummary] = Field(description="Users")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "items": [UserSummary.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
