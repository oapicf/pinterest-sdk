...
from openapi_server.models.campaign_create_response_data import CampaignCreateResponseData
...
class CampaignCreateResponseItem(BaseModel):
    """
    CampaignCreateResponseItem
    """ # noqa: E501
    data: Optional[CampaignCreateResponseData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": CampaignCreateResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
