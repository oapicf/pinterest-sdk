...
class CatalogsFeedCredentials(BaseModel):
    ...
    """ # noqa: E501
    password: SecretStr = Field(description="The required password for downloading a feed.")
    username: StrictStr = Field(description="The required username for downloading a feed.")
