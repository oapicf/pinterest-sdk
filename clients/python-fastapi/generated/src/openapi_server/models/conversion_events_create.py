...
class ConversionEventsCreate(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": [ConversionEventsDataItems.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
