...
class CampaignUpdateRequest(BaseModel):
    ...
    id: Annotated[str, Field(strict=True)] = Field(description="Campaign ID.", json_schema_extra={"examples": ["549755885175"]})
    ...
    name: Optional[StrictStr] = Field(default=None, description="Campaign name.", json_schema_extra={"examples": ["ACME Tools"]})
