...
class MembersToDeleteBodyMembersInner(BaseModel):
    """
    MembersToDeleteBodyMembersInner
    """ # noqa: E501
    business_role: BusinessRoleForMembers
    member_id: Annotated[str, Field(strict=True, max_length=25)] = Field(description="Unique identifier of the member")
