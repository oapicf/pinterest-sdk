...
from openapi_server.models.targeting_spec_age_bucket import TargetingSpecAgeBucket
from openapi_server.models.targeting_spec_app_type import TargetingSpecAppType
from openapi_server.models.targeting_spec_gender import TargetingSpecGender
from openapi_server.models.targeting_spec_shopping_retargeting import TargetingSpecShoppingRetargeting
try:
...
class TargetingSpec(BaseModel):
    ...
    @field_validator('audience_exclude')
    def audience_exclude_items_validate_regular_expression(cls, value):
    ...
    @field_validator('audience_include')
    def audience_include_items_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
