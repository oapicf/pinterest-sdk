...
from openapi_server.models.user_business_role_binding import UserBusinessRoleBinding
try:
    from typing import Self
except ImportError:
    from typing_extensions import Self

class GetBusinessPartners200Response(BaseModel):
    """
    GetBusinessPartners200Response
    """ # noqa: E501
    bookmark: Optional[StrictStr] = None
    items: List[UserBusinessRoleBinding] = Field(description="List of business partners.")
