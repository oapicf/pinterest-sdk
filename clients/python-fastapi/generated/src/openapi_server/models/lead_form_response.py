...
from openapi_server.models.lead_form_common_policy_links_inner import LeadFormCommonPolicyLinksInner
...
class LeadFormResponse(BaseModel):
    ...
    id: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="The ID of this lead form")
    updated_time: Optional[StrictInt] = Field(default=None, description="Last update time. Unix timestamp in seconds.")
    __properties: ClassVar[List[str]] = ["completion_message", "disclosure_language", "has_accepted_terms", "name", "policy_links", "privacy_policy_link", "questions", "status", "ad_account_id", "created_time", "id", "updated_time"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "policy_links": [LeadFormCommonPolicyLinksInner.from_dict(_item) for _item in obj.get("policy_links")] if obj.get("policy_links") is not None else None,
