...
class CampaignCreateRequest(BaseModel):
    ...
    """ # noqa: E501
    ad_account_id: Annotated[str, Field(strict=True)] = Field(description="Campaign's Advertiser ID. If you want to create a campaign in a Business Account shared account you need to specify the Business Access advertiser ID in both the query path param as well as the request body schema.")
    ...
    is_automated_campaign: Optional[StrictBool] = Field(default=False, description="Specifies whether the campaign was created in the automated campaign flow")
    is_flexible_daily_budgets: Optional[StrictBool] = Field(default=False, description="Determine if a campaign has setup for flexible daily budgets, also known as \"Pinterest Performance+ budgets\".")
