...
from openapi_server.apis.trends_api_base import BaseTrendsApi
...
@router.get(
    ...
    responses={
        200: {"model": List[TrendsEditorial], "description": "The request has succeeded."},
...
async def trends_editorial_articles_list(
    ...
    if not BaseTrendsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseTrendsApi.subclasses[0]().trends_editorial_articles_list(region)
...
async def trends_product_categories_details_list(
    ...
    if not BaseTrendsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseTrendsApi.subclasses[0]().trends_product_categories_details_list(product_categories, region, lookback_window, engagement_type)
...
async def trends_product_categories_trending_list(
    ...
    if not BaseTrendsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseTrendsApi.subclasses[0]().trends_product_categories_trending_list(region, verticals, ages, genders, engagement_type)
...
async def trends_featured_topics_list(
    ...
    if not BaseTrendsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseTrendsApi.subclasses[0]().trends_featured_topics_list(region, interest)
