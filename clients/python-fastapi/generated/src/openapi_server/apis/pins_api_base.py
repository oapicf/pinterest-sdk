...
class BasePinsApi:
    ...
    async def pins_list(
        self,
        pin_filter: Annotated[Optional[StrictStr], Field(description="The filter to apply to the pins")],
        ...
        pin_type: Annotated[Optional[StrictStr], Field(description="The type of pins to return, currently only enabled for private pins")],
