...
**collections_header_type** | Option<**String**> | Collections ad header type | [optional]
...
**customizable_cta_type** | Option<**String**> | Select a call to action (CTA) to display below your ad. CTA options for catalog sales campaigns are SHOP_NOW, BOOK_NOW, ON_SALE, GET_DEAL, BUY_ONLINE_PICKUP_IN_STORE | [optional]
