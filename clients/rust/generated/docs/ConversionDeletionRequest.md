...
------------ | ------------- | ------------- | -------------
**created_time** | **chrono::NaiveDate** | Timestamp when the conversion deletion request was succesfully created. | [readonly]
**processed_time** | Option<**chrono::NaiveDate**> | Timestamp when the conversion deletion request was processed. | [optional][readonly]
