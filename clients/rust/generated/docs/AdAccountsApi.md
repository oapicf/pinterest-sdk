...
> Vec<models::AdAccountAnalyticsResponseInner> ad_account_slash_analytics(ad_account_id, start_date, end_date, columns, granularity, click_window_days, engagement_window_days, view_window_days, conversion_report_time, reporting_timezone)
...
> models::AdsAnalyticsCreateAsyncResponse analytics_slash_create_conversion_product_report(ad_account_id, conversion_product_report_request)
...
------------- | ------------- | ------------- | ------------- | -------------
**ad_account_id** | **String** | Unique identifier of an ad account. | [required] |
**conversion_product_report_request** | [**ConversionProductReportRequest**](ConversionProductReportRequest.md) |  | [required] |
...
**granularity** | Option<[**Granularity**](.md)> |    TOTAL - metrics are aggregated over the specified date range.    DAY - metrics are broken down daily.    HOUR - metrics are broken down hourly.    WEEKLY - metrics are broken down weekly.    MONTHLY - metrics are broken down monthly |  |
...
> models::AdsAnalyticsGetAsyncResponse analytics_slash_get_conversion_product_report(ad_account_id, token)
