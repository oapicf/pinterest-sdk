...
> models::AudienceInsightsScopeAndTypeGet200Response audience_insights_scope_and_type_slash_get(ad_account_id)
...
> models::AudienceInsights audience_insights_slash_get(ad_account_id, audience_insight_type)
...
------------- | ------------- | ------------- | ------------- | -------------
**ad_account_id** | **String** | Unique identifier of an ad account. | [required] |
**audience_insight_type** | [**AudienceInsightType**](AudienceInsightType.md) | Type of audience insights. | [required] |
