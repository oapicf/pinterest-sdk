...
> models::ProductGroupPromotions product_group_promotions_slash_create(ad_account_id, product_group_promotions_create)
...
**product_group_promotions_create** | [**ProductGroupPromotionsCreate**](ProductGroupPromotionsCreate.md) |  | [required] |
...
> models::ProductGroupPromotion product_group_promotions_slash_get(ad_account_id, product_group_promotion_id)
...
> models::ProductGroupPromotionsList200Response product_group_promotions_slash_list(ad_account_id, bookmark, page_size, order, product_group_promotion_ids, entity_statuses, ad_group_id)
...
> models::ProductGroupPromotions product_group_promotions_slash_update(ad_account_id, product_group_promotions_update_with_required_body)
...
------------- | ------------- | ------------- | ------------- | -------------
**ad_account_id** | **String** | Unique identifier of an ad account. | [required] |
**product_group_promotions_update_with_required_body** | [**ProductGroupPromotionsUpdateWithRequiredBody**](ProductGroupPromotionsUpdateWithRequiredBody.md) |  | [required] |
...
> Vec<models::ProductGroupAnalyticsItems> product_groups_slash_analytics(start_date, end_date, product_group_ids, columns, granularity, ad_account_id, click_window_days, engagement_window_days, view_window_days, conversion_report_time, reporting_timezone)
