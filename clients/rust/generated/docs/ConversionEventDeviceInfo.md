...
**form_factor** | Option<[**models::FormFactor**](FormFactor.md)> | Device form factor | [optional]
...
**network_type** | Option<[**models::NetworkType**](NetworkType.md)> | Network type: 4G, 5G, ethernet, wifi In Android: NetworkCapabilities.getNetworkCapabilities() | [optional]
**os_family** | Option<[**models::OsFamily**](OsFamily.md)> | OS Family | [optional]
