...
**customer_list_upload_create_request** | [**CustomerListUploadCreateRequest**](CustomerListUploadCreateRequest.md) |  | [required] |
...
> models::CustomerListUpload customer_list_uploads_slash_get(ad_account_id, customer_list_id, customer_list_upload_id)
...
**ad_account_id** | **String** |  | [required] |
**customer_list_id** | **String** | Customer list ID. | [required] |
**customer_list_upload_id** | **String** | Customer List Upload ID. | [required] |
...
> models::CustomerListUpload customer_list_uploads_slash_run(ad_account_id, customer_list_id, customer_list_upload_id)
