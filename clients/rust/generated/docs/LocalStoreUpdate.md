...
**country** | Option<[**models::Country**](Country.md)> | Country code where the store is located. | [optional]
...
**name** | Option<**String**> | The name of the local store. | [optional]
...
**store_code** | Option<**String**> | Merchant provided code for the local store. Unique within the merchant's catalog. | [optional]
