...
**metric_types** | [**Vec<models::PinsAnalyticsMetricTypesParameterInner>**](models::PinsAnalyticsMetricTypesParameterInner.md) | Pin metric types to get data for, default is all. | [required] |
