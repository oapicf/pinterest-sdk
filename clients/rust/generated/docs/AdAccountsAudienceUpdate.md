...
**operation_type** | Option<[**models::AudienceUpdateOperationType**](AudienceUpdateOperationType.md)> | Audience operation type (update or remove). Only valid in update request body. | [optional]
