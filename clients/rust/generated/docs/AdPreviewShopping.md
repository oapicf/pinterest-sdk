...
**preferred_media_type** | Option<[**models::BasePreferredMediaType**](BasePreferredMediaType.md)> | Preferred media type. | [optional]
**show_promotion** | Option<**bool**> | Include promotion data in preview when available on catalog item. Defaults to false. | [optional]
