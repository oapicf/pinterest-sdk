...
**event_source** | Option<**serde_json::Value**> | Optional for VISITOR. You can use it as a {'=': [value]}. Supported values are: web, mobile, offline | [optional]
**ingestion_source** | Option<**serde_json::Value**> | Optional for VISITOR. You can use it as a {'=': [value]}. Supported values are: tag, mmp, file_upload, conversions_api | [optional]
**objective_type** | Option<[**Vec<models::AudienceObjectiveType>**](AudienceObjectiveType.md)> | Objective for engagement audience filter. | [optional]
