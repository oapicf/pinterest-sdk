...
**audience_type** | Option<[**models::PinnerListType**](PinnerListType.md)> | [Audience types](/docs/reference/glossary/#Audience Types): ACTALIKE, ENGAGEMENT, CUSTOMER_LIST and VISITOR | [optional]
...
**is_nca** | Option<**bool**> | Whether the audience derives from a new customer acquisition (expanded matching) customer list. Read-only. | [optional]
...
**status** | Option<[**models::AudienceStatus**](AudienceStatus.md)> | Audience status. READY, INITIALIZING, TOO_SMALL - Each audience list needs to have at least 100 people with Pinterest accounts before you can start using it. | [optional]
