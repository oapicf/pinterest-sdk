...
**catalog_info** | Option<[**models::CatalogBinding**](CatalogBinding.md)> | An object containing all the information specific to the provided catalog. This field will be populated only if asset_type equals 'CATALOG'. | [optional]
