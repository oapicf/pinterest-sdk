...
**completed_time** | Option<**chrono::DateTime<chrono::FixedOffset>**> | Date and time (UTC) of the batch completion: YYYY-MM-DD'T'hh:mm:ss | [optional][readonly]
**created_time** | **chrono::DateTime<chrono::FixedOffset>** | Date and time (UTC) of the batch creation: YYYY-MM-DD'T'hh:mm:ss | [readonly]
