...
**created_by_business** | Option<[**serde_json::Value**](.md)> | Metadata for the business that created the invite/request. | [optional]
**created_by_user** | Option<[**serde_json::Value**](.md)> | Metadata for the user that created the invite/request. | [optional]
