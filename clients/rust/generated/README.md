...
*AdGroupsApi* | [**ad_groups_dynamic_titles_slash_download_csv**](docs/AdGroupsApi.md#ad_groups_dynamic_titles_slash_download_csv) | **GET** /ad_accounts/{ad_account_id}/ad_groups/{ad_group_id}/dynamic_titles/csv | Get dynamic titles CSV download URL
*AdGroupsApi* | [**ad_groups_dynamic_titles_slash_get_status**](docs/AdGroupsApi.md#ad_groups_dynamic_titles_slash_get_status) | **GET** /ad_accounts/{ad_account_id}/ad_groups/{ad_group_id}/dynamic_titles/status | Get dynamic titles status
*AdGroupsApi* | [**ad_groups_dynamic_titles_slash_get_upload_url**](docs/AdGroupsApi.md#ad_groups_dynamic_titles_slash_get_upload_url) | **GET** /ad_accounts/{ad_account_id}/ad_groups/{ad_group_id}/dynamic_titles/uploads | Get dynamic titles upload URL
*AdGroupsApi* | [**ad_groups_dynamic_titles_slash_process_csv**](docs/AdGroupsApi.md#ad_groups_dynamic_titles_slash_process_csv) | **POST** /ad_accounts/{ad_account_id}/ad_groups/{ad_group_id}/dynamic_titles | Process dynamic titles CSV
...
*AdGroupsApi* | [**get_ad_groups_by_promotion_ids_slash_list**](docs/AdGroupsApi.md#get_ad_groups_by_promotion_ids_slash_list) | **GET** /ad_accounts/{ad_account_id}/promotion_applied_entities | List of ad groups using promotions IDs.
...
*AdsApi* | [**campaign_ad_preview_slash_create**](docs/AdsApi.md#campaign_ad_preview_slash_create) | **POST** /ad_accounts/{ad_account_id}/campaign_ad_preview | Create ad preview records for one or more ad groups
*AdsApi* | [**campaign_ad_preview_slash_delete**](docs/AdsApi.md#campaign_ad_preview_slash_delete) | **DELETE** /ad_accounts/{ad_account_id}/campaign_ad_preview | Delete ad preview records for one or more ad groups
*AdsApi* | [**campaign_ad_preview_slash_read**](docs/AdsApi.md#campaign_ad_preview_slash_read) | **GET** /ad_accounts/{ad_account_id}/campaign_ad_preview | Fetch ad preview records for one or more ad groups
...
*CatalogSupplementalApi* | [**catalogs_local_inventory_items_batch_slash_operate**](docs/CatalogSupplementalApi.md#catalogs_local_inventory_items_batch_slash_operate) | **POST** /catalogs/{catalog_id}/local_inventory_items/batch | Operate on local inventory item batch
*CatalogSupplementalApi* | [**catalogs_local_inventory_items_slash_post**](docs/CatalogSupplementalApi.md#catalogs_local_inventory_items_slash_post) | **POST** /catalogs/{catalog_id}/local_inventory_items/query | Get local inventory items (POST)
*CatalogSupplementalApi* | [**catalogs_local_stores_slash_create**](docs/CatalogSupplementalApi.md#catalogs_local_stores_slash_create) | **POST** /catalogs/{catalog_id}/local_stores | Create local stores
*CatalogSupplementalApi* | [**catalogs_local_stores_slash_delete**](docs/CatalogSupplementalApi.md#catalogs_local_stores_slash_delete) | **DELETE** /catalogs/{catalog_id}/local_stores | Delete local stores
*CatalogSupplementalApi* | [**catalogs_local_stores_slash_list**](docs/CatalogSupplementalApi.md#catalogs_local_stores_slash_list) | **GET** /catalogs/{catalog_id}/local_stores | List local stores
*CatalogSupplementalApi* | [**catalogs_local_stores_slash_update**](docs/CatalogSupplementalApi.md#catalogs_local_stores_slash_update) | **PATCH** /catalogs/{catalog_id}/local_stores | Update local stores
*CatalogSupplementalApi* | [**catalogs_supplemental_items_batch_slash_get**](docs/CatalogSupplementalApi.md#catalogs_supplemental_items_batch_slash_get) | **GET** /catalogs/{catalog_id}/supplemental_items/batch/{batch_id} | Get supplemental items batch status
...
*ConversionDeletionRequestsApi* | [**conversion_deletion_request_slash_create**](docs/ConversionDeletionRequestsApi.md#conversion_deletion_request_slash_create) | **POST** /ad_accounts/{ad_account_id}/conversion_deletion_requests | Create a conversion deletion request
*ConversionDeletionRequestsApi* | [**conversion_deletion_request_slash_delete**](docs/ConversionDeletionRequestsApi.md#conversion_deletion_request_slash_delete) | **DELETE** /ad_accounts/{ad_account_id}/conversion_deletion_requests/{request_id} | Delete a conversion deletion request
*ConversionDeletionRequestsApi* | [**conversion_deletion_request_slash_get**](docs/ConversionDeletionRequestsApi.md#conversion_deletion_request_slash_get) | **GET** /ad_accounts/{ad_account_id}/conversion_deletion_requests/{request_id} | Get a single conversion deletion request
*ConversionDeletionRequestsApi* | [**conversion_deletion_request_slash_list**](docs/ConversionDeletionRequestsApi.md#conversion_deletion_request_slash_list) | **GET** /ad_accounts/{ad_account_id}/conversion_deletion_requests | List conversion deletion requests
...
*ConversionsApi* | [**advertiser_defined_events_slash_create**](docs/ConversionsApi.md#advertiser_defined_events_slash_create) | **POST** /ad_accounts/{ad_account_id}/advertiser_defined_events | Create advertiser defined events
*ConversionsApi* | [**advertiser_defined_events_slash_delete**](docs/ConversionsApi.md#advertiser_defined_events_slash_delete) | **DELETE** /ad_accounts/{ad_account_id}/advertiser_defined_events | Delete advertiser defined events
...
*ConversionsApi* | [**advertiser_defined_events_slash_update**](docs/ConversionsApi.md#advertiser_defined_events_slash_update) | **PATCH** /ad_accounts/{ad_account_id}/advertiser_defined_events | Update advertiser defined events
...
*CustomerSegmentApi* | [**customer_segment_slash_create**](docs/CustomerSegmentApi.md#customer_segment_slash_create) | **POST** /ad_accounts/{ad_account_id}/customer_segments | Create customer segments
*CustomerSegmentApi* | [**customer_segment_slash_list**](docs/CustomerSegmentApi.md#customer_segment_slash_list) | **GET** /ad_accounts/{ad_account_id}/customer_segments | List customer segments
*CustomerSegmentApi* | [**customer_segment_slash_update**](docs/CustomerSegmentApi.md#customer_segment_slash_update) | **PATCH** /ad_accounts/{ad_account_id}/customer_segments | Update customer segments
...
*LabelsApi* | [**labels_slash_apply**](docs/LabelsApi.md#labels_slash_apply) | **POST** /ad_accounts/{ad_account_id}/labels/{label_id}/apply | Apply label to entity
...
*LabelsApi* | [**labels_slash_remove**](docs/LabelsApi.md#labels_slash_remove) | **POST** /ad_accounts/{ad_account_id}/labels/{label_id}/remove | Remove label from entities
...
*ProductTagsApi* | [**product_tags_slash_bulk_add**](docs/ProductTagsApi.md#product_tags_slash_bulk_add) | **POST** /pins/{pin_id}/product_tags | Add product tags to pin
*ProductTagsApi* | [**product_tags_slash_bulk_delete**](docs/ProductTagsApi.md#product_tags_slash_bulk_delete) | **POST** /pins/{pin_id}/product_tags/bulk-delete | Delete product tags from pin
*ProductTagsApi* | [**product_tags_slash_list**](docs/ProductTagsApi.md#product_tags_slash_list) | **GET** /pins/{pin_id}/product_tags | Get product tags for pin
...
*SchedulesApi* | [**schedules_slash_create**](docs/SchedulesApi.md#schedules_slash_create) | **POST** /ad_accounts/{ad_account_id}/schedules | Create schedules
*SchedulesApi* | [**schedules_slash_list**](docs/SchedulesApi.md#schedules_slash_list) | **GET** /ad_accounts/{ad_account_id}/schedules | Get Schedules
*SchedulesApi* | [**schedules_slash_update**](docs/SchedulesApi.md#schedules_slash_update) | **PATCH** /ad_accounts/{ad_account_id}/schedules | Update schedules
...
*TrendsApi* | [**trends_editorial_articles_slash_list**](docs/TrendsApi.md#trends_editorial_articles_slash_list) | **GET** /trends/editorial_articles | Returns editorial articles for a given region
*TrendsApi* | [**trends_featured_topics_slash_list**](docs/TrendsApi.md#trends_featured_topics_slash_list) | **GET** /trends/topics/featured | Get featured topics
*TrendsApi* | [**trends_product_categories_details_slash_list**](docs/TrendsApi.md#trends_product_categories_details_slash_list) | **GET** /trends/product_categories/details | Get product category details
*TrendsApi* | [**trends_product_categories_trending_slash_list**](docs/TrendsApi.md#trends_product_categories_trending_slash_list) | **GET** /trends/product_categories/trending | Get a list of growing Shopping Product Categories
