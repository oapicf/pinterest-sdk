...
pub async fn trending_keywords_slash_list(configuration: &configuration::Configuration, region: models::TrendsSupportedRegion, trend_type: models::TrendType, interests: Option<Vec<String>>, genders: Option<Vec<String>>, ages: Option<Vec<String>>, include_keywords: Option<Vec<String>>, normalize_against_group: Option<bool>, limit: Option<i32>, include_prediction: Option<bool>, include_demographics: Option<bool>) -> Result<models::TrendingKeywordsResponse, Error<TrendingKeywordsSlashListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    let p_query_include_prediction = include_prediction;
    ...
    if let Some(ref param_value) = p_query_include_prediction {
        req_builder = req_builder.query(&[("include_prediction", &param_value.to_string())]);
    }
