...
pub async fn audiences_slash_update(configuration: &configuration::Configuration, ad_account_id: &str, audience_id: &str, audience_update_request: models::AudienceUpdateRequest) -> Result<models::Audience, Error<AudiencesSlashUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_ad_account_id = ad_account_id;
    let p_path_audience_id = audience_id;
