...
pub async fn pins_slash_list(configuration: &configuration::Configuration, pin_filter: Option<&str>, pin_metrics: Option<bool>, include_protected_pins: Option<bool>, pin_type: Option<&str>, creative_types: Option<Vec<models::CreativeType>>, ad_account_id: Option<&str>, bookmark: Option<&str>, page_size: Option<i32>) -> Result<models::PinsList200Response, Error<PinsSlashListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
