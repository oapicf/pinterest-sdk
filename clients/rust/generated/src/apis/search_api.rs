...
pub async fn search_user_boards_slash_get(configuration: &configuration::Configuration, ad_account_id: Option<&str>, query: Option<&str>, bookmark: Option<&str>, page_size: Option<i32>) -> Result<models::BoardsList200Response, Error<SearchUserBoardsSlashGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
