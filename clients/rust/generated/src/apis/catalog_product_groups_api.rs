...
pub async fn catalogs_product_group_pins_slash_list(configuration: &configuration::Configuration, product_group_id: &str, ad_account_id: Option<&str>, pin_metrics: Option<bool>, bookmark: Option<&str>, page_size: Option<i32>) -> Result<models::CatalogsProductGroupPinsList200Response, Error<CatalogsProductGroupPinsSlashListError>> {
...
pub async fn catalogs_product_groups_slash_create(configuration: &configuration::Configuration, catalogs_product_groups_create_request_schema: models::CatalogsProductGroupsCreateRequestSchema, ad_account_id: Option<&str>) -> Result<models::CatalogsVerticalProductGroup, Error<CatalogsProductGroupsSlashCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_catalogs_product_groups_create_request_schema = catalogs_product_groups_create_request_schema;
    let p_query_ad_account_id = ad_account_id;
    ...
    req_builder = req_builder.json(&p_body_catalogs_product_groups_create_request_schema);
...
pub async fn catalogs_product_groups_slash_create_many(configuration: &configuration::Configuration, catalogs_product_groups_create_many_request_items: Vec<models::CatalogsProductGroupsCreateManyRequestItems>, ad_account_id: Option<&str>) -> Result<Vec<String>, Error<CatalogsProductGroupsSlashCreateManyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_catalogs_product_groups_create_many_request_items = catalogs_product_groups_create_many_request_items;
    let p_query_ad_account_id = ad_account_id;
    ...
    req_builder = req_builder.json(&p_body_catalogs_product_groups_create_many_request_items);
...
pub async fn catalogs_product_groups_slash_delete(configuration: &configuration::Configuration, product_group_id: &str, ad_account_id: Option<&str>) -> Result<models::CatalogsVerticalProductGroup, Error<CatalogsProductGroupsSlashDeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_product_group_id = product_group_id;
    let p_query_ad_account_id = ad_account_id;
...
pub async fn catalogs_product_groups_slash_update(configuration: &configuration::Configuration, product_group_id: &str, catalogs_product_groups_update_request_schema: models::CatalogsProductGroupsUpdateRequestSchema, ad_account_id: Option<&str>) -> Result<models::CatalogsVerticalProductGroup, Error<CatalogsProductGroupsSlashUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_product_group_id = product_group_id;
    let p_body_catalogs_product_groups_update_request_schema = catalogs_product_groups_update_request_schema;
    let p_query_ad_account_id = ad_account_id;
    ...
    req_builder = req_builder.json(&p_body_catalogs_product_groups_update_request_schema);
