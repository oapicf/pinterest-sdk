...
pub async fn boards_slash_list_pins(configuration: &configuration::Configuration, board_id: &str, bookmark: Option<&str>, page_size: Option<i32>, creative_types: Option<Vec<models::CreativeType>>, ad_account_id: Option<&str>, pin_metrics: Option<bool>) -> Result<models::BoardsListPins200Response, Error<BoardsSlashListPinsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_board_id = board_id;
    let p_query_bookmark = bookmark;
    let p_query_page_size = page_size;
