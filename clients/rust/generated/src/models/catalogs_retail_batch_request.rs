...
pub struct CatalogsRetailBatchRequest {
    ...
    #[serde(rename = "items")]
    pub items: Vec<models::CatalogsRetailBatchRequestItemsItems>,
...
impl CatalogsRetailBatchRequest {
    ...
    pub fn new(catalog_type: CatalogType, country: models::Country, items: Vec<models::CatalogsRetailBatchRequestItemsItems>, language: Language) -> CatalogsRetailBatchRequest {
