...
impl CatalogsRetailBatchRequest {
    ...
    pub fn new(catalog_type: CatalogType, country: models::Country, language: Language, items: Vec<models::CatalogsRetailBatchRequestItemsInner>) -> CatalogsRetailBatchRequest {
