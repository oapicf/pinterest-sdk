...
impl CatalogsRetailBatchRequest {
    ...
    pub fn new(catalog_type: CatalogType, country: models::Country, items: Vec<models::CatalogsRetailBatchRequestItemsInner>, language: Language) -> CatalogsRetailBatchRequest {
