...
impl CatalogsHotelFeedsCreateRequest {
    ...
    pub fn new(catalog_type: models::CatalogsType, default_locale: models::CatalogsFeedsCreateRequestDefaultLocale, format: models::CatalogsFormat, location: String, name: String) -> CatalogsHotelFeedsCreateRequest {
