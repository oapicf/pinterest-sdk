...
impl CatalogsRetailProductMetadata {
    ...
    pub fn new(availability: models::NonNullableProductAvailabilityType, currency: models::NonNullableCatalogsCurrency, item_group_id: Option<String>, item_id: String, price: f64, sale_price: Option<f64>) -> CatalogsRetailProductMetadata {
