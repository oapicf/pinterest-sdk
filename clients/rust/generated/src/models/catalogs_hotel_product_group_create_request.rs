...
impl CatalogsHotelProductGroupCreateRequest {
    ...
    pub fn new(catalog_id: String, catalog_type: CatalogType, filters: models::CatalogsHotelProductGroupFilters, name: String) -> CatalogsHotelProductGroupCreateRequest {
