...
impl CatalogsRetailFeed {
    ...
    pub fn new(created_at: String, id: String, updated_at: String, catalog_type: models::CatalogsType, credentials: Option<models::CatalogsFeedCredentials>, default_availability: Option<models::ProductAvailabilityType>, default_country: models::Country, default_currency: Option<models::NullableCurrency>, default_locale: String, format: models::CatalogsFormat, location: String, name: Option<String>, preferred_processing_schedule: Option<models::CatalogsFeedProcessingSchedule>, status: models::CatalogsStatus) -> CatalogsRetailFeed {
        CatalogsRetailFeed {
            created_at,
            id,
            updated_at,
