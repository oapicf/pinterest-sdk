...
impl CatalogsHotelFeed {
    ...
    pub fn new(created_at: String, id: String, updated_at: String, catalog_id: Option<String>, catalog_type: models::CatalogsType, credentials: Option<models::CatalogsFeedCredentials>, default_currency: Option<models::NullableCurrency>, default_locale: String, format: models::CatalogsFormat, location: String, name: Option<String>, preferred_processing_schedule: Option<models::CatalogsFeedProcessingSchedule>, status: models::CatalogsStatus) -> CatalogsHotelFeed {
        CatalogsHotelFeed {
            created_at,
            id,
            updated_at,
