...
pub enum MmmReportingColumn {
    ...
    #[serde(rename = "ADVERTISER_PAID_SPEND_IN_DOLLAR")]
    AdvertiserPaidSpendInDollar,
    #[serde(rename = "ADVERTISER_PAID_ECPC_IN_DOLLAR")]
    AdvertiserPaidEcpcInDollar,
    #[serde(rename = "ADVERTISER_PAID_ECPM_IN_DOLLAR")]
...
impl std::fmt::Display for MmmReportingColumn {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match self {
            ...
            Self::AdvertiserPaidSpendInDollar => write!(f, "ADVERTISER_PAID_SPEND_IN_DOLLAR"),
            Self::AdvertiserPaidEcpcInDollar => write!(f, "ADVERTISER_PAID_ECPC_IN_DOLLAR"),
            Self::AdvertiserPaidEcpmInDollar => write!(f, "ADVERTISER_PAID_ECPM_IN_DOLLAR"),
        }
    }
}
