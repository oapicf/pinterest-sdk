...
pub enum AdsAnalyticsAccountTargetingType {
...
impl std::fmt::Display for AdsAnalyticsAccountTargetingType {
...
impl Default for AdsAnalyticsAccountTargetingType {
    fn default() -> AdsAnalyticsAccountTargetingType {
        Self::Keyword
    }
}
