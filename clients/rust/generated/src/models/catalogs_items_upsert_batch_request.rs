...
impl CatalogsItemsUpsertBatchRequest {
    ...
    pub fn new(country: models::Country, language: Language, operation: models::BatchOperation, items: Vec<models::ItemUpsertBatchRecord>) -> CatalogsItemsUpsertBatchRequest {
