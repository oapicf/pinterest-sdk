...
impl CatalogsItemsUpsertBatchRequest {
    ...
    pub fn new(country: models::Country, items: Vec<models::ItemUpsertBatchRecord>, language: Language, operation: models::BatchOperation) -> CatalogsItemsUpsertBatchRequest {
