...
pub struct TrendingKeywordDemographics {
    ...
    pub age_distribution: Option<Option<models::TrendingKeywordDemographicsAgeDistribution>>,
    #[serde(rename = "gender_distribution", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub gender_distribution: Option<Option<models::TrendingKeywordDemographicsGenderDistribution>>,
}
