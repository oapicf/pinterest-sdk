...
impl CatalogsFeedProcessingResult {
    pub fn new(created_at: String, id: String, updated_at: String, ingestion_details: models::CatalogsFeedIngestionDetails, product_counts: Option<models::CatalogsFeedProductCounts>, status: models::CatalogsFeedProcessingStatus, validation_details: models::CatalogsFeedValidationDetails) -> CatalogsFeedProcessingResult {
