...
pub enum IntendedPromotionType {
    #[serde(rename = "LEGACY")]
    Legacy,
    #[serde(rename = "STANDARD_AD")]
    StandardAd,
...
impl std::fmt::Display for IntendedPromotionType {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match self {
            Self::Legacy => write!(f, "LEGACY"),
            Self::StandardAd => write!(f, "STANDARD_AD"),
            Self::Catalog => write!(f, "CATALOG"),
        }
    }
}

impl Default for IntendedPromotionType {
    fn default() -> IntendedPromotionType {
        Self::Legacy
    }
}
