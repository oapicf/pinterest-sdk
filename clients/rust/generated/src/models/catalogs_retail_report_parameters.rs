...
pub struct CatalogsRetailReportParameters {
    ...
    #[serde(rename = "report")]
    pub report: Box<models::CatalogsRetailReportParametersReport>,
}

impl CatalogsRetailReportParameters {
    /// Parameters for retail report
    pub fn new(catalog_type: CatalogType, report: models::CatalogsRetailReportParametersReport) -> CatalogsRetailReportParameters {
