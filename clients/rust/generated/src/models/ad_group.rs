...
pub struct AdGroup {
    ...
    /// oCPM learn mode
    #[serde(rename = "conversion_learning_mode_type", deserialize_with = "Option::deserialize")]
    pub conversion_learning_mode_type: Option<models::ConversionLearningModeType>,
    ...
    pub summary_status: models::SummaryStatus,
...
impl AdGroup {
    pub fn new(billable_event: models::ActionType, campaign_id: String, conversion_learning_mode_type: Option<models::ConversionLearningModeType>, created_time: i32, id: String, name: String, summary_status: models::SummaryStatus, r#type: String, updated_time: i32) -> AdGroup {
        AdGroup {
            ad_account_id: None,
