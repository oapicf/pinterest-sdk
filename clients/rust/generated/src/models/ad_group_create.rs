...
impl AdGroupCreate {
    pub fn new(billable_event: models::ActionType, campaign_id: String, conversion_learning_mode_type: Option<models::ConversionLearningModeType>, created_time: i32, id: String, name: String, summary_status: models::SummaryStatus, r#type: String, updated_time: i32) -> AdGroupCreate {
        AdGroupCreate {
            ad_account_id: None,
