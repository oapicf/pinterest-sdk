...
pub struct ProductCategoryDetails {
    #[serde(rename = "demographics", skip_serializing_if = "Option::is_none")]
    pub demographics: Option<Box<models::ProductCategoriesDemographic>>,
    ...
    #[serde(rename = "has_prediction")]
    pub has_prediction: bool,
    #[serde(rename = "metrics_highlights", skip_serializing_if = "Option::is_none")]
    pub metrics_highlights: Option<Box<models::ProductCategoriesMetricsHighlights>>,
    ...
    pub predicted_time_series: Option<std::collections::HashMap<String, f64>>,
    #[serde(rename = "product_category")]
    pub product_category: models::ProductCategoryEnum,
    /// Related search terms for this product category
    #[serde(rename = "related_searches", skip_serializing_if = "Option::is_none")]
    ...
    pub time_series: Option<std::collections::HashMap<String, f64>>,
}

impl ProductCategoryDetails {
    /// Product category details
    pub fn new(has_prediction: bool, product_category: models::ProductCategoryEnum) -> ProductCategoryDetails {
        ProductCategoryDetails {
            demographics: None,
            has_prediction,
            metrics_highlights: None,
