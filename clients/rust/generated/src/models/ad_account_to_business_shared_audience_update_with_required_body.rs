...
pub struct AdAccountToBusinessSharedAudienceUpdateWithRequiredBody {
...
impl AdAccountToBusinessSharedAudienceUpdateWithRequiredBody {
    /// Resource create or update operation model with required body fields (no OptionalProperties).
    pub fn new(audience_id: String, operation_type: models::OperationType, recipient_business_ids: Vec<String>) -> AdAccountToBusinessSharedAudienceUpdateWithRequiredBody {
