...
pub struct InviteResponse {
    ...
    #[serde(rename = "created_by_business", skip_serializing_if = "Option::is_none")]
    pub created_by_business: Option<Box<models::BusinessAccessUserSummary>>,
    /// Metadata for the user that created the invite/request.
    #[serde(rename = "created_by_user", skip_serializing_if = "Option::is_none")]
    pub created_by_user: Option<Box<models::BusinessAccessUserSummary>>,
