...
pub struct BusinessAssetPartnersGet200Response {
...
impl BusinessAssetPartnersGet200Response {
    pub fn new(items: Vec<models::UserSingleAssetBinding>) -> BusinessAssetPartnersGet200Response {
