...
impl CatalogsItemsDeleteDiscontinuedBatchRequest {
    ...
    pub fn new(country: models::Country, items: Vec<models::ItemDeleteDiscontinuedBatchRecord>, language: Language, operation: models::BatchOperation) -> CatalogsItemsDeleteDiscontinuedBatchRequest {
