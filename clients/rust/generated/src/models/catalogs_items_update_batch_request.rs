...
impl CatalogsItemsUpdateBatchRequest {
    ...
    pub fn new(country: models::Country, items: Vec<models::ItemUpdateBatchRecord>, language: Language, operation: models::BatchOperation) -> CatalogsItemsUpdateBatchRequest {
