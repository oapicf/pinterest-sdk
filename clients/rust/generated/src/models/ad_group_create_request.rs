...
pub struct AdGroupCreateRequest {
    ...
    pub optimization_goal_metadata: Option<Option<Box<models::AdGroupCommonOptimizationGoalMetadata>>>,
    ...
    pub tracking_urls: Option<Option<Box<models::AdGroupCommonTrackingUrls>>>,
