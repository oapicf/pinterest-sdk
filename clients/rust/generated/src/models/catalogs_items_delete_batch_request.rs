...
impl CatalogsItemsDeleteBatchRequest {
    ...
    pub fn new(country: models::Country, items: Vec<models::ItemDeleteBatchRecord>, language: Language, operation: models::BatchOperation) -> CatalogsItemsDeleteBatchRequest {
