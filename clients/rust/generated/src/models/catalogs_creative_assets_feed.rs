...
impl CatalogsCreativeAssetsFeed {
    ...
    pub fn new(catalog_id: String, catalog_type: CatalogType, created_at: chrono::DateTime<chrono::FixedOffset>, default_country: models::Country, default_locale: String, format: models::CatalogsFormat, id: String, location: String, name: Option<String>, status: models::CatalogsStatus, updated_at: chrono::DateTime<chrono::FixedOffset>) -> CatalogsCreativeAssetsFeed {
