...
pub enum QueryvideopinmetrictypesItems {
...
impl std::fmt::Display for QueryvideopinmetrictypesItems {
...
impl Default for QueryvideopinmetrictypesItems {
    fn default() -> QueryvideopinmetrictypesItems {
        Self::Impression
    }
}
