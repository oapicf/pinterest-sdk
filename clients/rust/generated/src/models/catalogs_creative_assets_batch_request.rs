...
impl CatalogsCreativeAssetsBatchRequest {
    ...
    pub fn new(catalog_type: CatalogType, country: models::Country, language: Language, items: Vec<models::CatalogsCreativeAssetsBatchItem>) -> CatalogsCreativeAssetsBatchRequest {
