...
impl CatalogsCreativeAssetsBatchRequest {
    ...
    pub fn new(catalog_type: CatalogType, country: models::Country, items: Vec<models::CatalogsCreativeAssetsBatchItem>, language: Language) -> CatalogsCreativeAssetsBatchRequest {
