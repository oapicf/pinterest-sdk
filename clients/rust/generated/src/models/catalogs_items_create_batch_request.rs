...
impl CatalogsItemsCreateBatchRequest {
    ...
    pub fn new(country: models::Country, items: Vec<models::ItemCreateBatchRecord>, language: Language, operation: models::BatchOperation) -> CatalogsItemsCreateBatchRequest {
