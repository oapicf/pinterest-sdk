...
impl CatalogsItemsCreateBatchRequest {
    ...
    pub fn new(country: models::Country, language: Language, operation: models::BatchOperation, items: Vec<models::ItemCreateBatchRecord>) -> CatalogsItemsCreateBatchRequest {
