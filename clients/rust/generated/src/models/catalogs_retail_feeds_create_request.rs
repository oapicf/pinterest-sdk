...
impl CatalogsRetailFeedsCreateRequest {
    ...
    pub fn new(catalog_type: CatalogType, default_country: models::Country, default_locale: models::CatalogsCreativeAssetsFeedsCreateRequestDefaultLocale, format: models::CatalogsFormat, location: String, name: String) -> CatalogsRetailFeedsCreateRequest {
