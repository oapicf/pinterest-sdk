...
impl CatalogsRetailFeedsCreateRequest {
    ...
    pub fn new(catalog_type: models::CatalogsType, default_country: models::Country, default_locale: models::CatalogsFeedsCreateRequestDefaultLocale, format: models::CatalogsFormat, location: String, name: String) -> CatalogsRetailFeedsCreateRequest {
