...
pub struct ConversionEventsDataInner {
    ...
    pub user_data: Option<Box<models::ConversionEventsUserData>>,
...
impl ConversionEventsDataInner {
    pub fn new(event_name: String, action_source: String, event_time: i64, event_id: String, user_data: Option<models::ConversionEventsUserData>) -> ConversionEventsDataInner {
