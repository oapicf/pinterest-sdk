...
| [**adAccountsSubscriptions/getById**](LeadAdsApi.md#adAccountsSubscriptions/getById) | **GET** /ad_accounts/{ad_account_id}/leads/subscriptions/{subscription_id} | Get lead ads subscription by ID |
...
> LeadSubscription adAccountsSubscriptions/getById(ad\_account\_id, subscription\_id)
...
> ad_accounts_subscriptions_get_list_200_response adAccountsSubscriptions/getList(ad\_account\_id, bookmark, page\_size)
...
> LeadSubscription adAccountsSubscriptions/post(ad\_account\_id, LeadSubscriptionPostParamsCreate)
...
|------------- | ------------- | ------------- | -------------|
| **ad\_account\_id** | **String**| Unique identifier of an ad account. | [default to null] |
| **LeadSubscriptionPostParamsCreate** | [**LeadSubscriptionPostParamsCreate**](../Models/LeadSubscriptionPostParamsCreate.md)|  | |
