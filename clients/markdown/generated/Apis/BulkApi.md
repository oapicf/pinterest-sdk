...
# **bulkDownload/create**
> BulkDownload bulkDownload/create(ad\_account\_id, BulkDownloadCreate)
...
| **BulkDownloadCreate** | [**BulkDownloadCreate**](../Models/BulkDownloadCreate.md)|  | |
...
# **bulkRequest/get**
> BulkJobData bulkRequest/get(ad\_account\_id, bulk\_request\_id, include\_details)
...
|------------- | ------------- | ------------- | -------------|
| **ad\_account\_id** | **String**| Unique identifier of an ad account. | [default to null] |
| **bulk\_request\_id** | **String**| Bulk request ID that is from one of the entities bulk endpoints | [default to null] |
