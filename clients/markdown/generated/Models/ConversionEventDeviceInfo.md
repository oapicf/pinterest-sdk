...
|------------ | ------------- | ------------- | -------------|
| **battery\_level** | **Integer** | Battery charge level percentage | [optional] [default to null] |
...
| **screen\_density** | **Integer** | Screen density, PPI | [optional] [default to null] |
| **screen\_height** | **Integer** | Screen height in pixels | [optional] [default to null] |
| **screen\_width** | **Integer** | Screen width in pixels | [optional] [default to null] |
| **storage\_free\_space** | **Integer** | Internal storage size in GB | [optional] [default to null] |
| **storage\_size** | **Integer** | Internal storage size in GB | [optional] [default to null] |
| **timezone** | **String** | Device timezone | [optional] [default to null] |
| **timezone\_abbr** | **String** | Timezone abbreviation | [optional] [default to null] |
| **type** | **String** | Device type | [optional] [default to null] |
