...
| **budget\_amount** | **Double** | If Budget order line, the budget amount. | [optional] [default to null] |
...
| **estimated\_monthly\_spend** | **Double** | If Ongoing (perpetual) order line, the estimated monthly spend | [optional] [default to null] |
...
| **order\_line\_type** | [**SSIOOrderLineType**](SSIOOrderLineType.md) | Type can be Budget or Perpetual | [default to null] |
