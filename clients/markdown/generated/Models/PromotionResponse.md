...
|------------ | ------------- | ------------- | -------------|
| **discount\_status** | **String** | Discount status based on the current time and start and end time of discount | [optional] [default to null] |
...
| **promotion\_title** | **String** | Internal name for the promotion. | [optional] [default to null] |
| **promotion\_type** | [**PromotionType**](PromotionType.md) |  | [optional] [default to null] |
...
| **ad\_account\_id** | **String** | The Ad Account ID that this promotion belongs to. | [optional] [default to null] |
| **id** | **String** | Promotion ID | [optional] [default to null] |
