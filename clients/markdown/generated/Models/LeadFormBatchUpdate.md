...
| **id** | **String** | The ID of this lead form | [default to null] |
| **name** | **String** | Internal name of the lead form. | [optional] [default to null] |
| **policy\_links** | [**List**](LeadFormPolicyLink.md) | List of additional policy links to be displayed on the lead form. | [optional] [default to null] |
