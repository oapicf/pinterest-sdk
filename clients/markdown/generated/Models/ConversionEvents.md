...
|------------ | ------------- | ------------- | -------------|
| **events** | [**List**](ConversionApiResponseEventsItems.md) | Specific messages for each event received. The order will match the order in which the events were received in the request. | [default to null] |
