...
|------------ | ------------- | ------------- | -------------|
| **ad\_account\_id** | **String** | The ID of the advertiser that this ad belongs to. | [default to null] |
...
| **campaign\_id** | **String** | ID of the ad campaign that contains this ad. | [default to null] |
...
| **carting\_platform\_type** | **Integer** | The vendor platform type of the carting/WTB ad. | [optional] [default to null] |
| **carting\_products** | [**List**](CartingProduct.md) | Array of carting/WTB products for the ad. | [optional] [default to null] |
...
| **pin\_id** | **String** | Pin ID. This field may only be updated for draft ads. | [default to null] |
...
| **rejected\_reasons** | [**List**](AdDisapprovalReasons.md) | Enum reason why the pin was rejected. Returned if &#x60;review_status&#x60; is \&quot;REJECTED\&quot;. | [default to null] |
| **rejection\_labels** | **List** | Text reason why the pin was rejected. Returned if &#x60;review_status&#x60; is \&quot;REJECTED\&quot;. | [default to null] |
| **review\_status** | [**AdReviewStatus**](AdReviewStatus.md) | Ad review status | [default to null] |
| **status** | [**EntityStatus**](EntityStatus.md) |  | [optional] [default to null] |
| **summary\_status** | [**PinPromotionSummaryStatus**](PinPromotionSummaryStatus.md) | Ad summary status | [default to null] |
| **tracking\_urls** | [**TrackingUrls**](TrackingUrls.md) |  | [optional] [default to null] |
| **type** | **String** | Always \&quot;ad\&quot;. | [default to null] |
