...
| **accepted\_terms\_time** | **String** | The UTC timestamp (to the nearest second) when terms were accepted. | [optional] [default to null] |
| **ads\_manager\_order\_line\_id** | **String** | Ads manager order line id | [optional] [default to null] |
...
| **media\_contact\_firstname** | **String** | Billing media contact first name | [optional] [default to null] |
| **media\_contact\_lastname** | **String** | Billing media contact last name | [optional] [default to null] |
...
| **salesforce\_order\_line\_id** | **String** | Order line id in SFDC | [optional] [default to null] |
