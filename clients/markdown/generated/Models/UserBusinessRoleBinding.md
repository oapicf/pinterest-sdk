...
|------------ | ------------- | ------------- | -------------|
| **assets\_summary** | [**BusinessMemberAssetsSummary**](BusinessMemberAssetsSummary.md) | Ad accounts and profiles the business member/partner has access to. | [optional] [default to null] |
...
| **is\_shared\_partner** | **Boolean** | This field is only relevant when business_role&#x3D;\&quot;PARTNER\&quot;. If is_shared_partner&#x3D;FALSE, the partner can access your business assets. If assets_summary is not empty, the assets listed are your business assets the partner has access to. If is_shared_partner&#x3D;TRUE, you can access the partner&#39;s business asset. If assets_summary is not empty, the assets listed are the partner&#39;s business assets you have access to. | [optional] [default to null] |
