...
| **collections\_header\_type** | **String** | Collections ad header type | [optional] [default to null] |
...
| **customizable\_cta\_type** | **String** | Select a call to action (CTA) to display below your ad. CTA options for catalog sales campaigns are SHOP_NOW, BOOK_NOW, ON_SALE, GET_DEAL, BUY_ONLINE_PICKUP_IN_STORE | [optional] [default to null] |
