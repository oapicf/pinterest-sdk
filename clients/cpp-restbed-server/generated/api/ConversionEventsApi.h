...
public:
    ...
    virtual ~Ad_accountsAd_account_idEventsResource();
    ...
    /////////////////////////////////////////////////////
    std::function<std::pair<int, ConversionEvents>(
        std::string & adAccountId, ConversionEventsCreate & conversionEventsCreate, bool & test)> handler_POST_func =
            [](std::string &, ConversionEventsCreate &, bool &) -> std::pair<int, ConversionEvents>
...
protected:
    ...
    virtual std::pair<int, ConversionEvents> handler_POST(
