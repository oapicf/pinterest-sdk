...
public:
    ...
    std::function<std::pair<int, std::map<std::string, std::map>>(
        std::vector<std::string> & pinIds, std::string & startDate, std::string & endDate, std::vector<std::string> & metricTypes, std::string & appTypes, std::string & adAccountId)> handler_GET_func =
            [](std::vector<std::string> &, std::string &, std::string &, std::vector<std::string> &, std::string &, std::string &) -> std::pair<int, std::map<std::string, std::map>>
...
protected:
    ...
    virtual std::pair<int, std::map<std::string, std::map>> handler_GET(
        std::vector<std::string> & pinIds, std::string & startDate, std::string & endDate, std::vector<std::string> & metricTypes, std::string & appTypes, std::string & adAccountId);
...
public:
    ...
    std::function<std::pair<int, std::map<std::string, PinAnalyticsMetricsResponse>>(
        std::string & pinId, std::string & startDate, std::string & endDate, std::vector<std::string> & metricTypes, std::string & appTypes, std::string & splitField, std::string & adAccountId)> handler_GET_func =
            [](std::string &, std::string &, std::string &, std::vector<std::string> &, std::string &, std::string &, std::string &) -> std::pair<int, std::map<std::string, PinAnalyticsMetricsResponse>>
                { throw PinsApiException(501, "Not implemented"); };
...
protected:
    ...
    virtual std::pair<int, std::map<std::string, PinAnalyticsMetricsResponse>> handler_GET(
        std::string & pinId, std::string & startDate, std::string & endDate, std::vector<std::string> & metricTypes, std::string & appTypes, std::string & splitField, std::string & adAccountId);
...
public:
    ...
    std::function<std::pair<int, Pins_list_200_response>(
        std::string & pinFilter, bool & pinMetrics, bool & includeProtectedPins, std::string & pinType, std::vector<CreativeType> & creativeTypes, std::string & adAccountId, std::string & bookmark, int32_t & pageSize)> handler_GET_func =
            [](std::string &, bool &, bool &, std::string &, std::vector<CreativeType> &, std::string &, std::string &, int32_t &) -> std::pair<int, Pins_list_200_response>
                { throw PinsApiException(501, "Not implemented"); };
...
protected:
    ...
    virtual std::pair<int, Pins_list_200_response> handler_GET(
        std::string & pinFilter, bool & pinMetrics, bool & includeProtectedPins, std::string & pinType, std::vector<CreativeType> & creativeTypes, std::string & adAccountId, std::string & bookmark, int32_t & pageSize);
