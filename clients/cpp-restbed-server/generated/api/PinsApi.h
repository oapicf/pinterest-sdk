...
public:
    ...
    std::function<std::pair<int, std::map<std::string, std::map>>(
        std::vector<std::string> & pinIds, std::string & startDate, std::string & endDate, std::vector<MultiPinsAnalyticsMetricTypesItem> & metricTypes, std::string & appTypes, std::string & adAccountId)> handler_GET_func =
            [](std::vector<std::string> &, std::string &, std::string &, std::vector<MultiPinsAnalyticsMetricTypesItem> &, std::string &, std::string &) -> std::pair<int, std::map<std::string, std::map>>
...
public:
    ...
    virtual ~PinsPin_idAnalyticsResource();
    ...
    std::function<std::pair<int, std::map<std::string, PinAnalyticsMetricsResponse>>(
        std::string & pinId, std::string & startDate, std::string & endDate, std::vector<QuerypinanalyticsmetrictypesItems> & metricTypes, std::string & appTypes, std::string & splitField, std::string & adAccountId)> handler_GET_func =
            [](std::string &, std::string &, std::string &, std::vector<QuerypinanalyticsmetrictypesItems> &, std::string &, std::string &, std::string &) -> std::pair<int, std::map<std::string, PinAnalyticsMetricsResponse>>
                { throw PinsApiException(501, "Not implemented"); };
...
public:
    ...
    std::function<std::pair<int, Pins_list_200_response>(
        PinFilter & pinFilter, bool & pinMetrics, bool & includeProtectedPins, PinType & pinType, std::vector<CreativeType> & creativeTypes, std::string & adAccountId, std::string & domain, std::vector<std::string> & domains, bool & includeProductTagObj, std::string & bookmark, int32_t & pageSize)> handler_GET_func =
            [](PinFilter &, bool &, bool &, PinType &, std::vector<CreativeType> &, std::string &, std::string &, std::vector<std::string> &, bool &, std::string &, int32_t &) -> std::pair<int, Pins_list_200_response>
                { throw PinsApiException(501, "Not implemented"); };
...
public:
    ...
    std::function<std::pair<int, Pin>(
        std::string & pinId, std::string & adAccountId)> handler_DELETE_func =
            [](std::string &, std::string &) -> std::pair<int, Pin>
                { throw PinsApiException(501, "Not implemented"); };

    std::function<std::pair<int, Pin>(
        std::string & pinId, std::string & adAccountId, bool & pinMetrics)> handler_GET_func =
            [](std::string &, std::string &, bool &) -> std::pair<int, Pin>
                { throw PinsApiException(501, "Not implemented"); };
...
protected:
    ...
    virtual std::pair<int, Pin> handler_DELETE(
...
public:
    ...
    virtual ~PinsPin_idSaveResource();
    ...
    /////////////////////////////////////////////////////
    std::function<std::pair<int, Pin>(
        std::string & pinId, PinsSaveRequestCreate & pinsSaveRequestCreate, std::string & adAccountId)> handler_POST_func =
            [](std::string &, PinsSaveRequestCreate &, std::string &) -> std::pair<int, Pin>
                { throw PinsApiException(501, "Not implemented"); };
