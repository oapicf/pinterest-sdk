...
public:
    ...
    virtual ~Ad_accountsAd_account_idLeads_exportResource();
    ...
    /////////////////////////////////////////////////////
    std::function<std::pair<int, LeadsExports>(
        std::string & adAccountId, LeadsExportsCreate & leadsExportsCreate)> handler_POST_func =
            [](std::string &, LeadsExportsCreate &) -> std::pair<int, LeadsExports>
...
protected:
    ...
    virtual std::pair<int, LeadsExports> handler_POST(
...
public:
    ...
    virtual ~Ad_accountsAd_account_idLeads_exportLeads_export_idResource();
