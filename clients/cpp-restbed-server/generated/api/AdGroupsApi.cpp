...
void Ad_accountsAd_account_idAd_groupsTargeting_analyticsResource::handler_GET_internal(const std::shared_ptr<restbed::Session> session)
{
    ...
    try {
        std::tie(status_code, resultObject) =
            handler_GET(adAccountId, adGroupIds, startDate, endDate, targetingTypes, columns, granularity, clickWindowDays, engagementWindowDays, viewWindowDays, conversionReportTime, attributionTypes, reportingTimezone);
    }
    catch(const AdGroupsApiException& e) {
        std::tie(status_code, result) = handleAdGroupsApiException(e);
    }
...
{
    return handler_GET_func(adAccountId, adGroupIds, startDate, endDate, targetingTypes, columns, granularity, clickWindowDays, engagementWindowDays, viewWindowDays, conversionReportTime, attributionTypes, reportingTimezone);
}
...
void Ad_accountsAd_account_idAd_groupsAnalyticsResource::handler_GET_internal(const std::shared_ptr<restbed::Session> session)
{
    ...
    try {
        std::tie(status_code, resultObject) =
            handler_GET(adAccountId, startDate, endDate, adGroupIds, columns, granularity, clickWindowDays, engagementWindowDays, viewWindowDays, conversionReportTime, aggregateReportRows, reportingTimezone);
    }
    catch(const AdGroupsApiException& e) {
        std::tie(status_code, result) = handleAdGroupsApiException(e);
    }
...
std::pair<int, std::vector<AdGroupsAnalyticsResponse_inner>> Ad_accountsAd_account_idAd_groupsAnalyticsResource::handler_GET(
        std::string & adAccountId, std::string & startDate, std::string & endDate, std::vector<std::string> & adGroupIds, std::vector<std::string> & columns, Granularity & granularity, int32_t & clickWindowDays, int32_t & engagementWindowDays, int32_t & viewWindowDays, std::string & conversionReportTime, bool & aggregateReportRows, ReportingTimeZone & reportingTimezone)
{
    return handler_GET_func(adAccountId, startDate, endDate, adGroupIds, columns, granularity, clickWindowDays, engagementWindowDays, viewWindowDays, conversionReportTime, aggregateReportRows, reportingTimezone);
}
