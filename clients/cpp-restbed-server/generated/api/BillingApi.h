...
public:
    ...
    virtual ~Ad_accountsAd_account_idBilling_invoiceBilling_invoice_idDownloadResource() = default;
...
public:
    ...
    virtual ~Ad_accountsAd_account_idBilling_invoicesResource() = default;
    ...
    std::function<std::pair<int, Billing_invoices_get_200_response>(
        std::string & adAccountId, std::string & bookmark, int32_t & pageSize, std::string & sort, std::string & order, std::string & status, std::string & documentType, std::string & startDueDate, std::string & endDueDate)> handler_GET_func =
            [](std::string &, std::string &, int32_t &, std::string &, std::string &, std::string &, std::string &, std::string &, std::string &) -> std::pair<int, Billing_invoices_get_200_response>
                { throw BillingApiException(501, "Not implemented"); };
