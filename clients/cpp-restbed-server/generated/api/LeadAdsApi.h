...
public:
    ...
    virtual ~Ad_accountsAd_account_idLeadsSubscriptionsSubscription_idResource();
    ...
    /////////////////////////////////////////////////////
    std::function<std::pair<int, LeadSubscription>(
        std::string & adAccountId, std::string & subscriptionId)> handler_DELETE_func =
            [](std::string &, std::string &) -> std::pair<int, LeadSubscription>
...
protected:
    ...
    virtual std::pair<int, LeadSubscription> handler_DELETE(
        std::string & adAccountId, std::string & subscriptionId);

    virtual std::pair<int, LeadSubscription> handler_GET(
        std::string & adAccountId, std::string & subscriptionId);
...
public:
    ...
    virtual ~Ad_accountsAd_account_idLeadsSubscriptionsResource();
    ...
    std::function<std::pair<int, Ad_accounts_subscriptions_get_list_200_response>(
        std::string & adAccountId, std::string & bookmark, int32_t & pageSize)> handler_GET_func =
            [](std::string &, std::string &, int32_t &) -> std::pair<int, Ad_accounts_subscriptions_get_list_200_response>
                { throw LeadAdsApiException(501, "Not implemented"); };

    std::function<std::pair<int, LeadSubscription>(
        std::string & adAccountId, LeadSubscriptionPostParamsCreate & leadSubscriptionPostParamsCreate)> handler_POST_func =
            [](std::string &, LeadSubscriptionPostParamsCreate &) -> std::pair<int, LeadSubscription>
                { throw LeadAdsApiException(501, "Not implemented"); };
...
protected:
    ...
    virtual std::pair<int, LeadSubscription> handler_POST(
