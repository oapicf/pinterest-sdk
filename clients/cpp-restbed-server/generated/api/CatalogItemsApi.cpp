...
CatalogsItemsBatchBatch_idResource::~CatalogsItemsBatchBatch_idResource() = default;
...
CatalogsItemsBatchResource::~CatalogsItemsBatchResource() = default;
...
std::pair<int, CatalogsItemsBatch> CatalogsItemsBatchResource::handler_POST(
        CatalogsItemsBatchPostRequest & catalogsItemsBatchPostRequest, std::string & adAccountId)
{
    return handler_POST_func(catalogsItemsBatchPostRequest, adAccountId);
}
...
CatalogsItemsResource::~CatalogsItemsResource() = default;
...
void CatalogsItemsResource::handler_POST_internal(const std::shared_ptr<restbed::Session> session)
{
    ...
    int status_code = 500;
    Items_post_200_response resultObject = Items_post_200_response{};
    std::string result = "";
...
std::pair<int, Items_post_200_response> CatalogsItemsResource::handler_POST(
