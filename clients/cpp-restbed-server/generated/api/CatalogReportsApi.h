...
public:
    ...
    std::function<std::pair<int, Reports_stats_200_response>(
        Reports_stats_parameters_parameter & parameters, std::string & adAccountId, int32_t & pageSize, std::string & bookmark)> handler_GET_func =
            [](Reports_stats_parameters_parameter &, std::string &, int32_t &, std::string &) -> std::pair<int, Reports_stats_200_response>
                { throw CatalogReportsApiException(501, "Not implemented"); };
...
protected:
    ...
    virtual std::pair<int, Reports_stats_200_response> handler_GET(
        Reports_stats_parameters_parameter & parameters, std::string & adAccountId, int32_t & pageSize, std::string & bookmark);
