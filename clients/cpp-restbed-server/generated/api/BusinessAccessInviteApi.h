...
public:
    ...
    virtual ~BusinessesBusiness_idRequestsAssetsAccessResource();
...
public:
    ...
    virtual ~BusinessesBusiness_idInvitesResource();
    ...
    // Set these to implement the server functionality //
    /////////////////////////////////////////////////////
    std::function<std::pair<int, CancelInvitesResponse>(
        std::string & businessId, CancelInvitesRequest & cancelInvitesRequest)> handler_DELETE_func =
            [](std::string &, CancelInvitesRequest &) -> std::pair<int, CancelInvitesResponse>
                { throw BusinessAccessInviteApiException(501, "Not implemented"); };
    ...
    std::function<std::pair<int, Get_invites_200_response>(
        std::string & businessId, bool & isMember, std::vector<InviteFilterStatus> & inviteStatus, InviteType & inviteType, std::string & bookmark, int32_t & pageSize)> handler_GET_func =
            [](std::string &, bool &, std::vector<InviteFilterStatus> &, InviteType &, std::string &, int32_t &) -> std::pair<int, Get_invites_200_response>
                { throw BusinessAccessInviteApiException(501, "Not implemented"); };
...
protected:
    ...
    virtual std::pair<int, CancelInvitesResponse> handler_DELETE(
...
public:
    ...
    virtual ~BusinessesBusiness_idInvitesAssetsAccessResource();
...
public:
    ...
    virtual ~BusinessesInvitesResource();
