...
public:
    ...
    std::function<std::pair<int, MetricsResponse>(
        std::string & adAccountId, std::string & startDate, std::string & endDate, std::vector<AdsAnalyticsTargetingType> & targetingTypes, std::vector<std::string> & columns, Granularity & granularity, int32_t & clickWindowDays, int32_t & engagementWindowDays, int32_t & viewWindowDays, std::string & conversionReportTime, std::vector<ConversionReportAttributionType> & attributionTypes, ReportingTimeZone & reportingTimezone)> handler_GET_func =
            [](std::string &, std::string &, std::string &, std::vector<AdsAnalyticsTargetingType> &, std::vector<std::string> &, Granularity &, int32_t &, int32_t &, int32_t &, std::string &, std::vector<ConversionReportAttributionType> &, ReportingTimeZone &) -> std::pair<int, MetricsResponse>
...
public:
    ...
    std::function<std::pair<int, std::vector<AdAccountAnalyticsResponse_inner>>(
        std::string & adAccountId, std::string & startDate, std::string & endDate, std::vector<std::string> & columns, Granularity & granularity, int32_t & clickWindowDays, int32_t & engagementWindowDays, int32_t & viewWindowDays, std::string & conversionReportTime, ReportingTimeZone & reportingTimezone)> handler_GET_func =
            [](std::string &, std::string &, std::string &, std::vector<std::string> &, Granularity &, int32_t &, int32_t &, int32_t &, std::string &, ReportingTimeZone &) -> std::pair<int, std::vector<AdAccountAnalyticsResponse_inner>>
                { throw AdAccountsApiException(501, "Not implemented"); };
...
public:
    ...
    virtual ~Ad_accountsAd_account_idReportsBrand_category_skuResource() = default;
    ...
    std::function<std::pair<int, AdsAnalyticsCreateAsyncResponse>(
        std::string & adAccountId, ConversionProductReportRequest & conversionProductReportRequest)> handler_POST_func =
            [](std::string &, ConversionProductReportRequest &) -> std::pair<int, AdsAnalyticsCreateAsyncResponse>
                { throw AdAccountsApiException(501, "Not implemented"); };
