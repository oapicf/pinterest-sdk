...
public:
    ...
    virtual ~Ad_accountsAd_account_idTargeting_analyticsResource();
    ...
    std::function<std::pair<int, MetricsResponse>(
        std::string & adAccountId, std::string & startDate, std::string & endDate, std::vector<AdsAnalyticsAccountTargetingType> & targetingTypes, std::vector<ReportingColumnSync> & columns, Granularity & granularity, double & clickWindowDays, double & engagementWindowDays, double & viewWindowDays, std::string & conversionReportTime, std::vector<ConversionReportAttributionType> & attributionTypes, ReportingTimeZone & reportingTimezone)> handler_GET_func =
            [](std::string &, std::string &, std::string &, std::vector<AdsAnalyticsAccountTargetingType> &, std::vector<ReportingColumnSync> &, Granularity &, double &, double &, double &, std::string &, std::vector<ConversionReportAttributionType> &, ReportingTimeZone &) -> std::pair<int, MetricsResponse>
...
public:
    ...
    virtual ~Ad_accountsAd_account_idAnalyticsResource();
    ...
    // Set these to implement the server functionality //
    /////////////////////////////////////////////////////
    std::function<std::pair<int, std::vector<AdAccountAnalyticsItems>>(
        std::string & startDate, std::string & endDate, std::vector<ReportingColumnSync> & columns, Granularity & granularity, std::string & adAccountId, double & clickWindowDays, double & engagementWindowDays, double & viewWindowDays, std::string & conversionReportTime, ReportingTimeZone & reportingTimezone)> handler_GET_func =
            [](std::string &, std::string &, std::vector<ReportingColumnSync> &, Granularity &, std::string &, double &, double &, double &, std::string &, ReportingTimeZone &) -> std::pair<int, std::vector<AdAccountAnalyticsItems>>
                { throw AdAccountsApiException(501, "Not implemented"); };
...
protected:
    ...
    virtual std::pair<int, std::vector<AdAccountAnalyticsItems>> handler_GET(
...
public:
    ...
    std::function<std::pair<int, AdAccount>(
        AdAccountCreate & adAccountCreate)> handler_POST_func =
            [](AdAccountCreate &) -> std::pair<int, AdAccount>
                { throw AdAccountsApiException(501, "Not implemented"); };

    std::function<std::pair<int, Ad_accounts_list_200_response>(
        bool & includeSharedAccounts, std::string & bookmark, int32_t & pageSize)> handler_GET_func =
            [](bool &, std::string &, int32_t &) -> std::pair<int, Ad_accounts_list_200_response>
                { throw AdAccountsApiException(501, "Not implemented"); };
...
public:
    ...
    virtual ~Ad_accountsAd_account_idResource();
...
/// </remarks>
class  Ad_accountsAd_account_idReportsBrand_category_skuResource: public restbed::Resource
{
public:
    Ad_accountsAd_account_idReportsBrand_category_skuResource(const std::string& context = "/v5");
    virtual ~Ad_accountsAd_account_idReportsBrand_category_skuResource();

    Ad_accountsAd_account_idReportsBrand_category_skuResource(
        const Ad_accountsAd_account_idReportsBrand_category_skuResource& other) = default; // copy constructor
    Ad_accountsAd_account_idReportsBrand_category_skuResource(Ad_accountsAd_account_idReportsBrand_category_skuResource&& other) noexcept = default; // move constructor

    Ad_accountsAd_account_idReportsBrand_category_skuResource& operator=(const Ad_accountsAd_account_idReportsBrand_category_skuResource& other) = default; // copy assignment
    Ad_accountsAd_account_idReportsBrand_category_skuResource& operator=(Ad_accountsAd_account_idReportsBrand_category_skuResource&& other) noexcept = default; // move assignment

    /////////////////////////////////////////////////////
    // Set these to implement the server functionality //
    /////////////////////////////////////////////////////
    std::function<std::pair<int, ConversionProductReport>(
        std::string & adAccountId, ConversionProductReportCreate & conversionProductReportCreate)> handler_POST_func =
            [](std::string &, ConversionProductReportCreate &) -> std::pair<int, ConversionProductReport>
                { throw AdAccountsApiException(501, "Not implemented"); };

    std::function<std::pair<int, ConversionProductReport>(
        std::string & adAccountId, std::string & token)> handler_GET_func =
            [](std::string &, std::string &) -> std::pair<int, ConversionProductReport>
                { throw AdAccountsApiException(501, "Not implemented"); };
...
protected:
    ...
    virtual std::pair<int, ConversionProductReport> handler_POST(
        std::string & adAccountId, ConversionProductReportCreate & conversionProductReportCreate);

    virtual std::pair<int, ConversionProductReport> handler_GET(
...
public:
    ...
    virtual ~Ad_accountsAd_account_idMmm_reportsResource();
    ...
    // Set these to implement the server functionality //
    /////////////////////////////////////////////////////
    std::function<std::pair<int, MMMReport>(
        std::string & adAccountId, MMMReportCreate & mMMReportCreate)> handler_POST_func =
            [](std::string &, MMMReportCreate &) -> std::pair<int, MMMReport>
                { throw AdAccountsApiException(501, "Not implemented"); };

    std::function<std::pair<int, MMMReport>(
        std::string & adAccountId, std::string & token)> handler_GET_func =
            [](std::string &, std::string &) -> std::pair<int, MMMReport>
                { throw AdAccountsApiException(501, "Not implemented"); };
...
protected:
    ...
    virtual std::pair<int, MMMReport> handler_POST(
        std::string & adAccountId, MMMReportCreate & mMMReportCreate);

    virtual std::pair<int, MMMReport> handler_GET(
        std::string & adAccountId, std::string & token);
...
public:
    ...
    virtual ~Ad_accountsAd_account_idReportsResource();
...
public:
    ...
    virtual ~Ad_accountsAd_account_idTemplatesTemplate_idReportsResource();
    ...
    // Set these to implement the server functionality //
    /////////////////////////////////////////////////////
    std::function<std::pair<int, TemplateBasedReport>(
        std::string & adAccountId, std::string & templateId, std::string & startDate, std::string & endDate, Granularity & granularity)> handler_POST_func =
            [](std::string &, std::string &, std::string &, std::string &, Granularity &) -> std::pair<int, TemplateBasedReport>
                { throw AdAccountsApiException(501, "Not implemented"); };
...
protected:
    ...
    virtual std::pair<int, TemplateBasedReport> handler_POST(
...
public:
    ...
    virtual ~Ad_accountsAd_account_idSandboxResource();
...
public:
    ...
    virtual ~Ad_accountsAd_account_idTemplatesResource();
    ...
    std::function<std::pair<int, Templates_list_200_response>(
        std::string & adAccountId, std::string & bookmark, int32_t & pageSize, Pinterest_Lib_PaginationOrder & order)> handler_GET_func =
            [](std::string &, std::string &, int32_t &, Pinterest_Lib_PaginationOrder &) -> std::pair<int, Templates_list_200_response>
                { throw AdAccountsApiException(501, "Not implemented"); };
...
using AdAccountsApiAd_accountsAd_account_idReportsBrand_category_skuResource [[deprecated]] = AdAccountsApiResources::Ad_accountsAd_account_idReportsBrand_category_skuResource;
...
public:
    ...
    std::shared_ptr<AdAccountsApiResources::Ad_accountsAd_account_idReportsBrand_category_skuResource> getAd_accountsAd_account_idReportsBrand_category_skuResource();
    ...
    void setResource(std::shared_ptr<AdAccountsApiResources::Ad_accountsAd_account_idReportsBrand_category_skuResource> resource);
    ...
    [[deprecated("use setResource()")]]
    virtual void setAdAccountsApiAd_accountsAd_account_idReportsBrand_category_skuResource(std::shared_ptr<AdAccountsApiResources::Ad_accountsAd_account_idReportsBrand_category_skuResource> spAdAccountsApiAd_accountsAd_account_idReportsBrand_category_skuResource);
    [[deprecated("use setResource()")]]
...
protected:
    ...
    std::shared_ptr<AdAccountsApiResources::Ad_accountsAd_account_idReportsBrand_category_skuResource> m_spAd_accountsAd_account_idReportsBrand_category_skuResource;
