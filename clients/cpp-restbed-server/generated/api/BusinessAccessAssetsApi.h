...
public:
    ...
    std::function<std::pair<int, Business_asset_members_get_200_response>(
        std::string & businessId, std::string & assetId, bool & fetchSystemUsers, std::string & bookmark, int32_t & pageSize, int32_t & startIndex)> handler_GET_func =
            [](std::string &, std::string &, bool &, std::string &, int32_t &, int32_t &) -> std::pair<int, Business_asset_members_get_200_response>
                { throw BusinessAccessAssetsApiException(501, "Not implemented"); };
...
protected:
    ...
    virtual std::pair<int, Business_asset_members_get_200_response> handler_GET(
        std::string & businessId, std::string & assetId, bool & fetchSystemUsers, std::string & bookmark, int32_t & pageSize, int32_t & startIndex);
