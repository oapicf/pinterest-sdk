...
public:
    ...
    virtual ~BusinessesBusiness_idAsset_groupsResource();
    ...
    /////////////////////////////////////////////////////
    std::function<std::pair<int, AssetGroupInput>(
        std::string & businessId, AssetGroupInputCreate & assetGroupInputCreate)> handler_POST_func =
            [](std::string &, AssetGroupInputCreate &) -> std::pair<int, AssetGroupInput>
                { throw BusinessAccessAssetsApiException(501, "Not implemented"); };

    std::function<std::pair<int, AssetGroupDeletion>(
        std::string & businessId, AssetGroupDeletionDelete & assetGroupDeletionDelete)> handler_DELETE_func =
            [](std::string &, AssetGroupDeletionDelete &) -> std::pair<int, AssetGroupDeletion>
                { throw BusinessAccessAssetsApiException(501, "Not implemented"); };

    std::function<std::pair<int, AssetGroupModification>(
        std::string & businessId, AssetGroupModificationReadOrUpdate & assetGroupModificationReadOrUpdate)> handler_PATCH_func =
            [](std::string &, AssetGroupModificationReadOrUpdate &) -> std::pair<int, AssetGroupModification>
                { throw BusinessAccessAssetsApiException(501, "Not implemented"); };
...
protected:
    ...
    virtual std::pair<int, AssetGroupInput> handler_POST(
        std::string & businessId, AssetGroupInputCreate & assetGroupInputCreate);

    virtual std::pair<int, AssetGroupDeletion> handler_DELETE(
        std::string & businessId, AssetGroupDeletionDelete & assetGroupDeletionDelete);
    virtual std::pair<int, AssetGroupModification> handler_PATCH(
...
public:
    ...
    virtual ~BusinessesBusiness_idAssetsAsset_idMembersResource();
    ...
    std::function<std::pair<int, Business_asset_members_get_200_response>(
        std::string & businessId, std::string & assetId, int32_t & startIndex, bool & fetchSystemUsers, std::string & bookmark, int32_t & pageSize)> handler_GET_func =
            [](std::string &, std::string &, int32_t &, bool &, std::string &, int32_t &) -> std::pair<int, Business_asset_members_get_200_response>
                { throw BusinessAccessAssetsApiException(501, "Not implemented"); };
...
public:
    ...
    virtual ~BusinessesBusiness_idAssetsAsset_idPartnersResource();
    ...
    std::function<std::pair<int, Business_asset_members_get_200_response>(
        std::string & businessId, std::string & assetId, int32_t & startIndex, std::string & bookmark, int32_t & pageSize)> handler_GET_func =
            [](std::string &, std::string &, int32_t &, std::string &, int32_t &) -> std::pair<int, Business_asset_members_get_200_response>
                { throw BusinessAccessAssetsApiException(501, "Not implemented"); };
...
public:
    ...
    virtual ~BusinessesBusiness_idAssetsResource();
...
public:
    ...
    virtual ~BusinessesBusiness_idMembersMember_idAssetsResource();
    ...
    // Set these to implement the server functionality //
    /////////////////////////////////////////////////////
    std::function<std::pair<int, BusinessMemberAssetsGetResponse>(
        std::string & businessId, std::string & memberId, std::string & assetType, int32_t & startIndex, AssetSortBy & sortBy, bool & sortAscending, AssetSearchBy & searchBy, std::string & searchValue, AssetPermissionType & assetPermissionType, std::vector<NonDraftEntityStatus> & adAccountStatuses, std::string & bookmark, int32_t & pageSize)> handler_GET_func =
            [](std::string &, std::string &, std::string &, int32_t &, AssetSortBy &, bool &, AssetSearchBy &, std::string &, AssetPermissionType &, std::vector<NonDraftEntityStatus> &, std::string &, int32_t &) -> std::pair<int, BusinessMemberAssetsGetResponse>
                { throw BusinessAccessAssetsApiException(501, "Not implemented"); };
...
protected:
    ...
    virtual std::pair<int, BusinessMemberAssetsGetResponse> handler_GET(
...
public:
    ...
    virtual ~BusinessesBusiness_idMembersAssetsAccessResource();
    ...
    std::function<std::pair<int, DeleteMemberAccessResultsResponseArray>(
        std::string & businessId, BusinessMembersAssetAccessDeleteBody & businessMembersAssetAccessDeleteBody)> handler_DELETE_func =
            [](std::string &, BusinessMembersAssetAccessDeleteBody &) -> std::pair<int, DeleteMemberAccessResultsResponseArray>
                { throw BusinessAccessAssetsApiException(501, "Not implemented"); };
...
public:
    ...
    virtual ~BusinessesBusiness_idPartnersPartner_idAssetsResource();
    ...
    std::function<std::pair<int, Business_partner_asset_access_get_200_response>(
        std::string & businessId, std::string & partnerId, std::string & partnerType, std::string & assetType, int32_t & startIndex, AssetSortBy & sortBy, bool & sortAscending, AssetSearchBy & searchBy, std::string & searchValue, std::string & bookmark, int32_t & pageSize)> handler_GET_func =
            [](std::string &, std::string &, std::string &, std::string &, int32_t &, AssetSortBy &, bool &, AssetSearchBy &, std::string &, std::string &, int32_t &) -> std::pair<int, Business_partner_asset_access_get_200_response>
                { throw BusinessAccessAssetsApiException(501, "Not implemented"); };
...
public:
    ...
    virtual ~BusinessesBusiness_idPartnersAssetsResource();
    ...
    // Set these to implement the server functionality //
    /////////////////////////////////////////////////////
    std::function<std::pair<int, DeletePartnerAssetAccessResultsResponseArray>(
        std::string & businessId, DeletePartnerAssetAccessBody & deletePartnerAssetAccessBody)> handler_DELETE_func =
            [](std::string &, DeletePartnerAssetAccessBody &) -> std::pair<int, DeletePartnerAssetAccessResultsResponseArray>
                { throw BusinessAccessAssetsApiException(501, "Not implemented"); };
...
protected:
    ...
    virtual std::pair<int, DeletePartnerAssetAccessResultsResponseArray> handler_DELETE(
