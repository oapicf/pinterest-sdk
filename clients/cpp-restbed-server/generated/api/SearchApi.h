...
public:
    ...
    virtual ~SearchPartnerPinsResource();
...
public:
    ...
    std::function<std::pair<int, Boards_list_200_response>(
        std::string & adAccountId, std::string & query, std::string & bookmark, int32_t & pageSize)> handler_GET_func =
            [](std::string &, std::string &, std::string &, int32_t &) -> std::pair<int, Boards_list_200_response>
                { throw SearchApiException(501, "Not implemented"); };
