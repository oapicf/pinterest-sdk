...
public:
    ...
    // Set these to implement the server functionality //
    /////////////////////////////////////////////////////
    std::function<std::pair<int, Search_user_pins_list_200_response>(
        std::string & query, std::string & adAccountId, std::string & bookmark)> handler_GET_func =
            [](std::string &, std::string &, std::string &) -> std::pair<int, Search_user_pins_list_200_response>
                { throw SearchApiException(501, "Not implemented"); };
...
protected:
    ...
    virtual std::pair<int, Search_user_pins_list_200_response> handler_GET(
