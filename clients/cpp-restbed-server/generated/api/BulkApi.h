...
public:
    ...
    virtual ~Ad_accountsAd_account_idBulkDownloadResource();
    ...
    /////////////////////////////////////////////////////
    std::function<std::pair<int, BulkDownload>(
        std::string & adAccountId, BulkDownloadCreate & bulkDownloadCreate)> handler_POST_func =
            [](std::string &, BulkDownloadCreate &) -> std::pair<int, BulkDownload>
...
protected:
    ...
    virtual std::pair<int, BulkDownload> handler_POST(
...
public:
    ...
    virtual ~Ad_accountsAd_account_idBulkBulk_request_idResource();
    ...
    // Set these to implement the server functionality //
    /////////////////////////////////////////////////////
    std::function<std::pair<int, BulkJobData>(
        std::string & adAccountId, std::string & bulkRequestId, bool & includeDetails)> handler_GET_func =
            [](std::string &, std::string &, bool &) -> std::pair<int, BulkJobData>
                { throw BulkApiException(501, "Not implemented"); };
...
protected:
    ...
    virtual std::pair<int, BulkJobData> handler_GET(
...
public:
    ...
    virtual ~Ad_accountsAd_account_idBulkUpsertResource();
