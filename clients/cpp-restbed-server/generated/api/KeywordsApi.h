...
public:
    ...
    std::function<std::pair<int, Keywords_get_200_response>(
        std::string & adAccountId, std::string & campaignId, std::string & adGroupId, std::vector<std::string> & adGroupIds, std::vector<MatchType> & matchTypes, int32_t & pageSize, std::string & bookmark)> handler_GET_func =
            [](std::string &, std::string &, std::string &, std::vector<std::string> &, std::vector<MatchType> &, int32_t &, std::string &) -> std::pair<int, Keywords_get_200_response>
                { throw KeywordsApiException(501, "Not implemented"); };
...
public:
    ...
    std::function<std::pair<int, TrendingKeywordsResponse>(
        TrendsSupportedRegion & region, TrendType & trendType, std::vector<std::string> & interests, std::vector<std::string> & genders, std::vector<std::string> & ages, std::vector<std::string> & includeKeywords, bool & normalizeAgainstGroup, int32_t & limit, bool & includePrediction, bool & includeDemographics)> handler_GET_func =
            [](TrendsSupportedRegion &, TrendType &, std::vector<std::string> &, std::vector<std::string> &, std::vector<std::string> &, std::vector<std::string> &, bool &, int32_t &, bool &, bool &) -> std::pair<int, TrendingKeywordsResponse>
                { throw KeywordsApiException(501, "Not implemented"); };
