...
Ad_accountsAd_account_idAds_creditRedeemResource::~Ad_accountsAd_account_idAds_creditRedeemResource() = default;
...
void Ad_accountsAd_account_idAds_creditRedeemResource::handler_POST_internal(const std::shared_ptr<restbed::Session> session)
{
    ...
    int status_code = 500;
    AdsCreditRedeem resultObject = AdsCreditRedeem{};
    std::string result = "";
...
std::pair<int, AdsCreditRedeem> Ad_accountsAd_account_idAds_creditRedeemResource::handler_POST(
        std::string & adAccountId, AdsCreditRedeemCreate & adsCreditRedeemCreate)
{
    return handler_POST_func(adAccountId, adsCreditRedeemCreate);
}
...
Ad_accountsAd_account_idAds_creditDiscountsResource::~Ad_accountsAd_account_idAds_creditDiscountsResource() = default;
...
Ad_accountsAd_account_idBilling_invoiceBilling_invoice_idDownloadResource::Ad_accountsAd_account_idBilling_invoiceBilling_invoice_idDownloadResource(const std::string& context /* = "/v5" */)
{
	this->set_path(context + "/ad_accounts/{ad_account_id: .*}/billing_invoice/{billing_invoice_id: .*}/download");
	this->set_method_handler("GET",
		std::bind(&Ad_accountsAd_account_idBilling_invoiceBilling_invoice_idDownloadResource::handler_GET_internal, this,
			std::placeholders::_1));
}

Ad_accountsAd_account_idBilling_invoiceBilling_invoice_idDownloadResource::~Ad_accountsAd_account_idBilling_invoiceBilling_invoice_idDownloadResource() = default;

std::pair<int, std::string> Ad_accountsAd_account_idBilling_invoiceBilling_invoice_idDownloadResource::handleBillingApiException(const BillingApiException& e)
{
    return std::make_pair<int, std::string>(e.getStatus(), e.what());
}

std::pair<int, std::string> Ad_accountsAd_account_idBilling_invoiceBilling_invoice_idDownloadResource::handleStdException(const std::exception& e)
{
    return std::make_pair<int, std::string>(500, e.what());
}

std::pair<int, std::string> Ad_accountsAd_account_idBilling_invoiceBilling_invoice_idDownloadResource::handleUnspecifiedException()
{
    return std::make_pair<int, std::string>(500, "Unknown exception occurred");
}

void Ad_accountsAd_account_idBilling_invoiceBilling_invoice_idDownloadResource::setResponseHeader(const std::shared_ptr<restbed::Session>& session, const std::string& header)
{
    session->set_header(header, "");
}

void Ad_accountsAd_account_idBilling_invoiceBilling_invoice_idDownloadResource::returnResponse(const std::shared_ptr<restbed::Session>& session, const int status, const std::string& result, std::multimap<std::string, std::string>& responseHeaders)
{
    responseHeaders.insert(std::make_pair("Connection", "close"));
    session->close(status, result, responseHeaders);
}

void Ad_accountsAd_account_idBilling_invoiceBilling_invoice_idDownloadResource::defaultSessionClose(const std::shared_ptr<restbed::Session>& session, const int status, const std::string& result)
{
    session->close(status, result, { {"Connection", "close"} });
}

void Ad_accountsAd_account_idBilling_invoiceBilling_invoice_idDownloadResource::handler_GET_internal(const std::shared_ptr<restbed::Session> session)
{
    const auto request = session->get_request();
    // Getting the path params
    std::string adAccountId = request->get_path_parameter("ad_account_id", "");
    std::string billingInvoiceId = request->get_path_parameter("billing_invoice_id", "");
    
    int status_code = 500;
    BillingInvoiceDownloadResponse resultObject = BillingInvoiceDownloadResponse{};
    std::string result = "";
...
std::pair<int, BillingInvoiceDownloadResponse> Ad_accountsAd_account_idBilling_invoiceBilling_invoice_idDownloadResource::handler_GET(
        std::string & adAccountId, std::string & billingInvoiceId)
{
    return handler_GET_func(adAccountId, billingInvoiceId);
}


std::string Ad_accountsAd_account_idBilling_invoiceBilling_invoice_idDownloadResource::extractBodyContent(const std::shared_ptr<restbed::Session>& session) {
  const auto request = session->get_request();
  int content_length = request->get_header("Content-Length", 0);
  std::string bodyContent;
  session->fetch(content_length,
...
std::string Ad_accountsAd_account_idBilling_invoiceBilling_invoice_idDownloadResource::extractFormParamsFromBody(const std::string& paramName, const std::string& body) {
    const auto uri = restbed::Uri("urlencoded?" + body, true);
    const auto params = uri.get_query_parameters();
    const auto result = params.find(paramName);
    if (result != params.cend()) {
...
Ad_accountsAd_account_idBilling_invoicesResource::Ad_accountsAd_account_idBilling_invoicesResource(const std::string& context /* = "/v5" */)
{
	this->set_path(context + "/ad_accounts/{ad_account_id: .*}/billing_invoices");
	this->set_method_handler("GET",
		std::bind(&Ad_accountsAd_account_idBilling_invoicesResource::handler_GET_internal, this,
			std::placeholders::_1));
}

Ad_accountsAd_account_idBilling_invoicesResource::~Ad_accountsAd_account_idBilling_invoicesResource() = default;

std::pair<int, std::string> Ad_accountsAd_account_idBilling_invoicesResource::handleBillingApiException(const BillingApiException& e)
{
    return std::make_pair<int, std::string>(e.getStatus(), e.what());
}

std::pair<int, std::string> Ad_accountsAd_account_idBilling_invoicesResource::handleStdException(const std::exception& e)
{
    return std::make_pair<int, std::string>(500, e.what());
}

std::pair<int, std::string> Ad_accountsAd_account_idBilling_invoicesResource::handleUnspecifiedException()
{
    return std::make_pair<int, std::string>(500, "Unknown exception occurred");
}

void Ad_accountsAd_account_idBilling_invoicesResource::setResponseHeader(const std::shared_ptr<restbed::Session>& session, const std::string& header)
{
    session->set_header(header, "");
}

void Ad_accountsAd_account_idBilling_invoicesResource::returnResponse(const std::shared_ptr<restbed::Session>& session, const int status, const std::string& result, std::multimap<std::string, std::string>& responseHeaders)
{
    responseHeaders.insert(std::make_pair("Connection", "close"));
    session->close(status, result, responseHeaders);
}

void Ad_accountsAd_account_idBilling_invoicesResource::defaultSessionClose(const std::shared_ptr<restbed::Session>& session, const int status, const std::string& result)
{
    session->close(status, result, { {"Connection", "close"} });
}

void Ad_accountsAd_account_idBilling_invoicesResource::handler_GET_internal(const std::shared_ptr<restbed::Session> session)
{
    const auto request = session->get_request();
    // Getting the path params
    std::string adAccountId = request->get_path_parameter("ad_account_id", "");
    ...
    std::string bookmark = request->get_query_parameter("bookmark", "");
    int32_t pageSize = request->get_query_parameter("pageSize", 25);
    std::string startDueDate = request->get_query_parameter("startDueDate", "");
    std::string endDueDate = request->get_query_parameter("endDueDate", "");
    
    int status_code = 500;
    Billing_invoices_get_200_response resultObject = Billing_invoices_get_200_response{};
    std::string result = "";
...
std::pair<int, Billing_invoices_get_200_response> Ad_accountsAd_account_idBilling_invoicesResource::handler_GET(
...
{
    return handler_GET_func(adAccountId, bookmark, pageSize, order, sort, status, documentType, startDueDate, endDueDate);
}


std::string Ad_accountsAd_account_idBilling_invoicesResource::extractBodyContent(const std::shared_ptr<restbed::Session>& session) {
  const auto request = session->get_request();
  int content_length = request->get_header("Content-Length", 0);
  std::string bodyContent;
  session->fetch(content_length,
...
std::string Ad_accountsAd_account_idBilling_invoicesResource::extractFormParamsFromBody(const std::string& paramName, const std::string& body) {
    const auto uri = restbed::Uri("urlencoded?" + body, true);
    const auto params = uri.get_query_parameters();
    const auto result = params.find(paramName);
    if (result != params.cend()) {
...
Ad_accountsAd_account_idBilling_profilesResource::~Ad_accountsAd_account_idBilling_profilesResource() = default;
...
{
    return handler_GET_func(isActive, adAccountId, bookmark, pageSize);
}
...
Ad_accountsAd_account_idSsioAccountsResource::~Ad_accountsAd_account_idSsioAccountsResource() = default;
...
void Ad_accountsAd_account_idSsioAccountsResource::handler_GET_internal(const std::shared_ptr<restbed::Session> session)
{
    ...
    int status_code = 500;
    SSIOAccount resultObject = SSIOAccount{};
    std::string result = "";
...
std::pair<int, SSIOAccount> Ad_accountsAd_account_idSsioAccountsResource::handler_GET(
...
Ad_accountsAd_account_idSsioInsertion_ordersResource::~Ad_accountsAd_account_idSsioInsertion_ordersResource() = default;
...
void Ad_accountsAd_account_idSsioInsertion_ordersResource::handler_POST_internal(const std::shared_ptr<restbed::Session> session)
{
    ...
    int status_code = 500;
    SSIOInsertionOrder resultObject = SSIOInsertionOrder{};
    std::string result = "";
...
std::pair<int, SSIOInsertionOrder> Ad_accountsAd_account_idSsioInsertion_ordersResource::handler_POST(
        std::string & adAccountId, SSIOInsertionOrderCreate & sSIOInsertionOrderCreate)
{
    return handler_POST_func(adAccountId, sSIOInsertionOrderCreate);
}

std::pair<int, SSIOInsertionOrder> Ad_accountsAd_account_idSsioInsertion_ordersResource::handler_PATCH(
    std::string & adAccountId, SSIOInsertionOrderUpdate & sSIOInsertionOrderUpdate)
{
    return handler_PATCH_func(adAccountId, sSIOInsertionOrderUpdate);
}
...
Ad_accountsAd_account_idSsioInsertion_ordersStatusResource::~Ad_accountsAd_account_idSsioInsertion_ordersStatusResource() = default;
...
Ad_accountsAd_account_idSsioInsertion_ordersPin_order_idStatusResource::~Ad_accountsAd_account_idSsioInsertion_ordersPin_order_idStatusResource() = default;
...
Ad_accountsAd_account_idSsioOrder_linesResource::~Ad_accountsAd_account_idSsioOrder_linesResource() = default;
...
{
    return handler_GET_func(adAccountId, pinOrderId, bookmark, pageSize);
}
...
std::shared_ptr<BillingApiResources::Ad_accountsAd_account_idBilling_invoiceBilling_invoice_idDownloadResource> BillingApi::getAd_accountsAd_account_idBilling_invoiceBilling_invoice_idDownloadResource() {
    if (!m_spAd_accountsAd_account_idBilling_invoiceBilling_invoice_idDownloadResource) {
        setResource(std::make_shared<BillingApiResources::Ad_accountsAd_account_idBilling_invoiceBilling_invoice_idDownloadResource>());
    }
    return m_spAd_accountsAd_account_idBilling_invoiceBilling_invoice_idDownloadResource;
}
std::shared_ptr<BillingApiResources::Ad_accountsAd_account_idBilling_invoicesResource> BillingApi::getAd_accountsAd_account_idBilling_invoicesResource() {
    if (!m_spAd_accountsAd_account_idBilling_invoicesResource) {
        setResource(std::make_shared<BillingApiResources::Ad_accountsAd_account_idBilling_invoicesResource>());
    }
    return m_spAd_accountsAd_account_idBilling_invoicesResource;
}
...
void BillingApi::setResource(std::shared_ptr<BillingApiResources::Ad_accountsAd_account_idBilling_invoiceBilling_invoice_idDownloadResource> resource) {
    m_spAd_accountsAd_account_idBilling_invoiceBilling_invoice_idDownloadResource = resource;
    m_service->publish(m_spAd_accountsAd_account_idBilling_invoiceBilling_invoice_idDownloadResource);
}
void BillingApi::setResource(std::shared_ptr<BillingApiResources::Ad_accountsAd_account_idBilling_invoicesResource> resource) {
    m_spAd_accountsAd_account_idBilling_invoicesResource = resource;
    m_service->publish(m_spAd_accountsAd_account_idBilling_invoicesResource);
}
...
void BillingApi::setBillingApiAd_accountsAd_account_idBilling_invoiceBilling_invoice_idDownloadResource(std::shared_ptr<BillingApiResources::Ad_accountsAd_account_idBilling_invoiceBilling_invoice_idDownloadResource> spAd_accountsAd_account_idBilling_invoiceBilling_invoice_idDownloadResource) {
    m_spAd_accountsAd_account_idBilling_invoiceBilling_invoice_idDownloadResource = spAd_accountsAd_account_idBilling_invoiceBilling_invoice_idDownloadResource;
    m_service->publish(m_spAd_accountsAd_account_idBilling_invoiceBilling_invoice_idDownloadResource);
}
void BillingApi::setBillingApiAd_accountsAd_account_idBilling_invoicesResource(std::shared_ptr<BillingApiResources::Ad_accountsAd_account_idBilling_invoicesResource> spAd_accountsAd_account_idBilling_invoicesResource) {
    m_spAd_accountsAd_account_idBilling_invoicesResource = spAd_accountsAd_account_idBilling_invoicesResource;
    m_service->publish(m_spAd_accountsAd_account_idBilling_invoicesResource);
}
