...
public:
    ...
    virtual ~CatalogsItemsBatchBatch_idResource();
...
public:
    ...
    virtual ~CatalogsItemsBatchResource();
    ...
    /////////////////////////////////////////////////////
    std::function<std::pair<int, CatalogsItemsBatch>(
        CatalogsItemsBatchPostRequest & catalogsItemsBatchPostRequest, std::string & adAccountId)> handler_POST_func =
            [](CatalogsItemsBatchPostRequest &, std::string &) -> std::pair<int, CatalogsItemsBatch>
                { throw CatalogItemsApiException(501, "Not implemented"); };
...
public:
    ...
    // Set these to implement the server functionality //
    /////////////////////////////////////////////////////
    std::function<std::pair<int, Items_post_200_response>(
        CatalogsItemsRequest & catalogsItemsRequest, std::string & adAccountId)> handler_POST_func =
            [](CatalogsItemsRequest &, std::string &) -> std::pair<int, Items_post_200_response>
                { throw CatalogItemsApiException(501, "Not implemented"); };
...
protected:
    ...
    virtual std::pair<int, Items_post_200_response> handler_POST(
