...
public:
    ...
    /////////////////////////////////////////////////////
    std::function<std::pair<int, Boards_list_pins_200_response>(
        std::string & boardId, std::string & bookmark, int32_t & pageSize, std::vector<CreativeType> & creativeTypes, std::string & adAccountId, bool & pinMetrics)> handler_GET_func =
            [](std::string &, std::string &, int32_t &, std::vector<CreativeType> &, std::string &, bool &) -> std::pair<int, Boards_list_pins_200_response>
                { throw BoardsApiException(501, "Not implemented"); };
