...
public:
    ...
    virtual ~BoardsBoard_idSectionsResource();
    ...
    std::function<std::pair<int, BoardSection>(
        std::string & boardId, BoardSectionCreate & boardSectionCreate, std::string & adAccountId)> handler_POST_func =
            [](std::string &, BoardSectionCreate &, std::string &) -> std::pair<int, BoardSection>
...
public:
    ...
    virtual ~BoardsBoard_idSectionsSection_idResource();
    ...
    std::function<std::pair<int, BoardSection>(
        std::string & boardId, std::string & sectionId, std::string & adAccountId)> handler_DELETE_func =
            [](std::string &, std::string &, std::string &) -> std::pair<int, BoardSection>
                { throw BoardsApiException(501, "Not implemented"); };

    std::function<std::pair<int, BoardSection>(
        std::string & boardId, std::string & sectionId, BoardSectionUpdateWithRequiredBody & boardSectionUpdateWithRequiredBody, std::string & adAccountId)> handler_PATCH_func =
            [](std::string &, std::string &, BoardSectionUpdateWithRequiredBody &, std::string &) -> std::pair<int, BoardSection>
                { throw BoardsApiException(501, "Not implemented"); };
...
protected:
    ...
    virtual std::pair<int, BoardSection> handler_DELETE(
...
public:
    ...
    virtual ~BoardsBoard_idSectionsSection_idPinsResource();
...
public:
    ...
    std::function<std::pair<int, Board>(
        BoardCreate & boardCreate, std::string & adAccountId)> handler_POST_func =
            [](BoardCreate &, std::string &) -> std::pair<int, Board>
                { throw BoardsApiException(501, "Not implemented"); };

    std::function<std::pair<int, Boards_list_200_response>(
        std::string & adAccountId, BoardPrivacyFilter & privacy, std::string & bookmark, int32_t & pageSize)> handler_GET_func =
            [](std::string &, BoardPrivacyFilter &, std::string &, int32_t &) -> std::pair<int, Boards_list_200_response>
                { throw BoardsApiException(501, "Not implemented"); };
...
public:
    ...
    virtual ~BoardsBoard_idResource();
    ...
    std::function<std::pair<int, BoardWithUpdatePrivacy>(
        std::string & boardId, BoardWithUpdatePrivacyUpdate & boardWithUpdatePrivacyUpdate, std::string & adAccountId)> handler_PATCH_func =
            [](std::string &, BoardWithUpdatePrivacyUpdate &, std::string &) -> std::pair<int, BoardWithUpdatePrivacy>
                { throw BoardsApiException(501, "Not implemented"); };
...
protected:
    ...
    virtual std::pair<int, Board> handler_DELETE(
        std::string & boardId, std::string & adAccountId);

    virtual std::pair<int, Board> handler_GET(
        std::string & boardId, std::string & adAccountId);
    virtual std::pair<int, BoardWithUpdatePrivacy> handler_PATCH(
...
public:
    ...
    virtual ~BoardsBoard_idPinsResource();
    ...
    /////////////////////////////////////////////////////
    std::function<std::pair<int, Boards_list_pins_200_response>(
        std::string & boardId, std::vector<CreativeType> & creativeTypes, std::string & adAccountId, bool & pinMetrics, std::string & bookmark, int32_t & pageSize)> handler_GET_func =
            [](std::string &, std::vector<CreativeType> &, std::string &, bool &, std::string &, int32_t &) -> std::pair<int, Boards_list_pins_200_response>
                { throw BoardsApiException(501, "Not implemented"); };
