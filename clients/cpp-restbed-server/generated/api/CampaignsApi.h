...
public:
    ...
    virtual ~Ad_accountsAd_account_idPinsAnalyticsResource() = default;
    ...
    std::function<std::pair<int, std::vector<AdPinAnalytics>>(
        std::string & adAccountId, std::string & campaignId, std::vector<std::string> & pinIds, std::string & startDate, std::string & endDate, std::vector<std::string> & columns, Granularity & granularity, int32_t & clickWindowDays, int32_t & engagementWindowDays, int32_t & viewWindowDays, std::string & conversionReportTime)> handler_GET_func =
            [](std::string &, std::string &, std::vector<std::string> &, std::string &, std::string &, std::vector<std::string> &, Granularity &, int32_t &, int32_t &, int32_t &, std::string &) -> std::pair<int, std::vector<AdPinAnalytics>>
...
public:
    ...
    std::function<std::pair<int, MetricsResponse>(
        std::string & adAccountId, std::vector<std::string> & campaignIds, std::string & startDate, std::string & endDate, std::vector<AdsAnalyticsCampaignTargetingType> & targetingTypes, std::vector<std::string> & columns, Granularity & granularity, int32_t & clickWindowDays, int32_t & engagementWindowDays, int32_t & viewWindowDays, std::string & conversionReportTime, std::vector<ConversionReportAttributionType> & attributionTypes, ReportingTimeZone & reportingTimezone)> handler_GET_func =
            [](std::string &, std::vector<std::string> &, std::string &, std::string &, std::vector<AdsAnalyticsCampaignTargetingType> &, std::vector<std::string> &, Granularity &, int32_t &, int32_t &, int32_t &, std::string &, std::vector<ConversionReportAttributionType> &, ReportingTimeZone &) -> std::pair<int, MetricsResponse>
                { throw CampaignsApiException(501, "Not implemented"); };
...
public:
    ...
    std::function<std::pair<int, std::vector<CampaignsAnalyticsResponse_inner>>(
        std::string & adAccountId, std::string & startDate, std::string & endDate, std::vector<std::string> & campaignIds, std::vector<std::string> & columns, Granularity & granularity, int32_t & clickWindowDays, int32_t & engagementWindowDays, int32_t & viewWindowDays, std::string & conversionReportTime, bool & aggregateReportRows, ReportingTimeZone & reportingTimezone)> handler_GET_func =
            [](std::string &, std::string &, std::string &, std::vector<std::string> &, std::vector<std::string> &, Granularity &, int32_t &, int32_t &, int32_t &, std::string &, bool &, ReportingTimeZone &) -> std::pair<int, std::vector<CampaignsAnalyticsResponse_inner>>
                { throw CampaignsApiException(501, "Not implemented"); };
