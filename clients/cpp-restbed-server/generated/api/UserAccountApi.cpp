...
User_accountFollowingBoardsResource::~User_accountFollowingBoardsResource() = default;
...
std::pair<int, Boards_list_200_response> User_accountFollowingBoardsResource::handler_GET(
        std::string & adAccountId, bool & explicitFollowing, std::string & bookmark, int32_t & pageSize)
{
    return handler_GET_func(adAccountId, explicitFollowing, bookmark, pageSize);
}
...
User_accountFollowingUsernameResource::~User_accountFollowingUsernameResource() = default;
...
void User_accountFollowingUsernameResource::handler_POST_internal(const std::shared_ptr<restbed::Session> session)
{
    ...
    int status_code = 500;
    FollowUser resultObject = FollowUser{};
    std::string result = "";
...
std::pair<int, FollowUser> User_accountFollowingUsernameResource::handler_POST(
        std::string & username, FollowUserCreate & followUserCreate)
{
    return handler_POST_func(username, followUserCreate);
}
...
User_accountFollowersResource::~User_accountFollowersResource() = default;
...
User_accountBusinessesResource::~User_accountBusinessesResource() = default;
...
User_accountWebsitesResource::~User_accountWebsitesResource() = default;
...
void User_accountWebsitesResource::handler_DELETE_internal(const std::shared_ptr<restbed::Session> session)
{
    ...
    int status_code = 500;
    UserWebsite resultObject = UserWebsite{};
    std::string result = "";
...
std::pair<int, UserWebsite> User_accountWebsitesResource::handler_DELETE(
        std::string & website)
{
...
std::pair<int, UserWebsite> User_accountWebsitesResource::handler_POST(
    UserWebsiteCreate & userWebsiteCreate, std::string & adAccountId)
{
    return handler_POST_func(userWebsiteCreate, adAccountId);
}
...
User_accountAnalyticsResource::~User_accountAnalyticsResource() = default;
...
void User_accountAnalyticsResource::handler_GET_internal(const std::shared_ptr<restbed::Session> session)
{
    ...
    std::vector<QuerymetrictypesItems> metricTypes;
    std::vector<std::string> metricTypes_temp;
    boost::split(metricTypes_temp, metricTypes_raw, boost::is_any_of(","));
    std::transform(metricTypes_temp.begin(), metricTypes_temp.end(), std::back_inserter(metricTypes), [](const auto& i){ QuerymetrictypesItems ret; ret.fromString(i); return ret;});
...
User_accountAnalyticsTop_pinsResource::~User_accountAnalyticsTop_pinsResource() = default;
...
void User_accountAnalyticsTop_pinsResource::handler_GET_internal(const std::shared_ptr<restbed::Session> session)
{
    ...
    double createdInLastNDays = request->get_query_parameter("createdInLastNDays", 0.0);
    std::string adAccountId = request->get_query_parameter("adAccountId", "");
...
User_accountAnalyticsTop_video_pinsResource::~User_accountAnalyticsTop_video_pinsResource() = default;
...
void User_accountAnalyticsTop_video_pinsResource::handler_GET_internal(const std::shared_ptr<restbed::Session> session)
{
    ...
    std::string source = request->get_query_parameter("source", "ALL");
    std::string metricTypes_raw = request->get_query_parameter("metricTypes");
    std::vector<QueryvideopinmetrictypesItems> metricTypes;
    std::vector<std::string> metricTypes_temp;
    boost::split(metricTypes_temp, metricTypes_raw, boost::is_any_of(","));
    std::transform(metricTypes_temp.begin(), metricTypes_temp.end(), std::back_inserter(metricTypes), [](const auto& i){ QueryvideopinmetrictypesItems ret; ret.fromString(i); return ret;});
    int32_t numOfPins = request->get_query_parameter("numOfPins", 10);
    double createdInLastNDays = request->get_query_parameter("createdInLastNDays", 0.0);
    std::string adAccountId = request->get_query_parameter("adAccountId", "");
...
UsersUsernameInterestsFollowResource::~UsersUsernameInterestsFollowResource() = default;
...
void UsersUsernameInterestsFollowResource::handler_GET_internal(const std::shared_ptr<restbed::Session> session)
{
    ...
    if (status_code == 404) {
        responseHeaders.insert(std::make_pair("Content-Type", "text/plain"));
        result = "The server cannot find the requested resource.";
...
User_accountResource::~User_accountResource() = default;
...
User_accountFollowingResource::~User_accountFollowingResource() = default;
...
std::pair<int, Followers_list_200_response> User_accountFollowingResource::handler_GET(
        std::string & adAccountId, bool & explicitFollowing, UserFollowingFeedType & feedType, std::string & bookmark, int32_t & pageSize)
{
    return handler_GET_func(adAccountId, explicitFollowing, feedType, bookmark, pageSize);
}
...
User_accountWebsitesVerificationResource::~User_accountWebsitesVerificationResource() = default;
...
void User_accountWebsitesVerificationResource::handler_GET_internal(const std::shared_ptr<restbed::Session> session)
{
    ...
    int status_code = 500;
    UserWebsiteVerification resultObject = UserWebsiteVerification{};
    std::string result = "";
...
std::pair<int, UserWebsiteVerification> User_accountWebsitesVerificationResource::handler_GET(
        std::string & adAccountId)
{
    return handler_GET_func(adAccountId);
}
