...
PinsAnalyticsResource::~PinsAnalyticsResource() = default;
...
void PinsAnalyticsResource::handler_GET_internal(const std::shared_ptr<restbed::Session> session)
{
    ...
    std::vector<MultiPinsAnalyticsMetricTypesItem> metricTypes;
    std::vector<std::string> metricTypes_temp;
    boost::split(metricTypes_temp, metricTypes_raw, boost::is_any_of(","));
    std::transform(metricTypes_temp.begin(), metricTypes_temp.end(), std::back_inserter(metricTypes), [](const auto& i){ MultiPinsAnalyticsMetricTypesItem ret; ret.fromString(i); return ret;});
...
std::pair<int, std::map<std::string, std::map>> PinsAnalyticsResource::handler_GET(
        std::vector<std::string> & pinIds, std::string & startDate, std::string & endDate, std::vector<MultiPinsAnalyticsMetricTypesItem> & metricTypes, std::string & appTypes, std::string & adAccountId)
{
...
PinsPin_idAnalyticsResource::~PinsPin_idAnalyticsResource() = default;
...
void PinsPin_idAnalyticsResource::handler_GET_internal(const std::shared_ptr<restbed::Session> session)
{
    ...
    std::string appTypes = request->get_query_parameter("appTypes", "ALL");
    std::string metricTypes_raw = request->get_query_parameter("metricTypes");
    std::vector<QuerypinanalyticsmetrictypesItems> metricTypes;
    std::vector<std::string> metricTypes_temp;
    boost::split(metricTypes_temp, metricTypes_raw, boost::is_any_of(","));
    std::transform(metricTypes_temp.begin(), metricTypes_temp.end(), std::back_inserter(metricTypes), [](const auto& i){ QuerypinanalyticsmetrictypesItems ret; ret.fromString(i); return ret;});
...
std::pair<int, std::map<std::string, PinAnalyticsMetricsResponse>> PinsPin_idAnalyticsResource::handler_GET(
        std::string & pinId, std::string & startDate, std::string & endDate, std::vector<QuerypinanalyticsmetrictypesItems> & metricTypes, std::string & appTypes, std::string & splitField, std::string & adAccountId)
{
...
PinsResource::~PinsResource() = default;
...
void PinsResource::handler_GET_internal(const std::shared_ptr<restbed::Session> session) {
    ...
    std::string adAccountId = request->get_query_parameter("adAccountId", "");
    std::string domain = request->get_query_parameter("domain", "");
    std::string domains_raw = request->get_query_parameter("domains");
    std::vector<std::string> domains;
    std::vector<std::string> domains_temp;
    boost::split(domains_temp, domains_raw, boost::is_any_of(","));
    std::copy(domains_temp.begin(), domains_temp.end(), std::inserter(domains, std::next(domains.begin())));
    bool includeProductTagObj = request->get_query_parameter("includeProductTagObj", false);
...
std::pair<int, Pins_list_200_response> PinsResource::handler_GET(
    PinFilter & pinFilter, bool & pinMetrics, bool & includeProtectedPins, PinType & pinType, std::vector<CreativeType> & creativeTypes, std::string & adAccountId, std::string & domain, std::vector<std::string> & domains, bool & includeProductTagObj, std::string & bookmark, int32_t & pageSize)
{
    return handler_GET_func(pinFilter, pinMetrics, includeProtectedPins, pinType, creativeTypes, adAccountId, domain, domains, includeProductTagObj, bookmark, pageSize);
}
...
PinsPin_idResource::~PinsPin_idResource() = default;
...
std::pair<int, Pin> PinsPin_idResource::handler_DELETE(
...
{
    return handler_GET_func(pinId, adAccountId, pinMetrics);
}
...
PinsPin_idSaveResource::~PinsPin_idSaveResource() = default;
...
std::pair<int, Pin> PinsPin_idSaveResource::handler_POST(
        std::string & pinId, PinsSaveRequestCreate & pinsSaveRequestCreate, std::string & adAccountId)
{
    return handler_POST_func(pinId, pinsSaveRequestCreate, adAccountId);
}
