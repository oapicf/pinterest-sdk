...
public:
    ...
    std::function<std::pair<int, MetricsResponse>(
        std::string & adAccountId, std::vector<std::string> & adIds, std::string & startDate, std::string & endDate, std::vector<AdsAnalyticsAdTargetingType> & targetingTypes, std::vector<std::string> & columns, Granularity & granularity, int32_t & clickWindowDays, int32_t & engagementWindowDays, int32_t & viewWindowDays, std::string & conversionReportTime, std::vector<ConversionReportAttributionType> & attributionTypes, ReportingTimeZone & reportingTimezone)> handler_GET_func =
            [](std::string &, std::vector<std::string> &, std::string &, std::string &, std::vector<AdsAnalyticsAdTargetingType> &, std::vector<std::string> &, Granularity &, int32_t &, int32_t &, int32_t &, std::string &, std::vector<ConversionReportAttributionType> &, ReportingTimeZone &) -> std::pair<int, MetricsResponse>
                { throw AdsApiException(501, "Not implemented"); };
...
public:
    ...
    std::function<std::pair<int, std::vector<AdsAnalyticsResponse_inner>>(
        std::string & adAccountId, std::string & startDate, std::string & endDate, std::vector<std::string> & columns, Granularity & granularity, std::vector<std::string> & adIds, int32_t & clickWindowDays, int32_t & engagementWindowDays, int32_t & viewWindowDays, std::string & conversionReportTime, std::vector<std::string> & pinIds, std::vector<std::string> & campaignIds, ReportingTimeZone & reportingTimezone)> handler_GET_func =
            [](std::string &, std::string &, std::string &, std::vector<std::string> &, Granularity &, std::vector<std::string> &, int32_t &, int32_t &, int32_t &, std::string &, std::vector<std::string> &, std::vector<std::string> &, ReportingTimeZone &) -> std::pair<int, std::vector<AdsAnalyticsResponse_inner>>
                { throw AdsApiException(501, "Not implemented"); };
