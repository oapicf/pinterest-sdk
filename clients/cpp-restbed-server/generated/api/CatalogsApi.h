...
public:
    ...
    virtual ~CatalogsAvailable_filter_valuesResource();
...
public:
    ...
    std::function<std::pair<int, Catalog>(
        CatalogCreate & catalogCreate, std::string & adAccountId)> handler_POST_func =
            [](CatalogCreate &, std::string &) -> std::pair<int, Catalog>
                { throw CatalogsApiException(501, "Not implemented"); };
    ...
    std::function<std::pair<int, Catalogs_list_200_response>(
        std::string & adAccountId, std::string & bookmark, int32_t & pageSize)> handler_GET_func =
            [](std::string &, std::string &, int32_t &) -> std::pair<int, Catalogs_list_200_response>
                { throw CatalogsApiException(501, "Not implemented"); };
