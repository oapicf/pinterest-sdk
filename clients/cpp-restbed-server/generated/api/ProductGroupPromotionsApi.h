...
public:
    ...
    virtual ~Ad_accountsAd_account_idProduct_group_promotionsResource();
    ...
    /////////////////////////////////////////////////////
    std::function<std::pair<int, ProductGroupPromotions>(
        std::string & adAccountId, ProductGroupPromotionsCreate & productGroupPromotionsCreate)> handler_POST_func =
            [](std::string &, ProductGroupPromotionsCreate &) -> std::pair<int, ProductGroupPromotions>
    ...
    std::function<std::pair<int, Product_group_promotions_list_200_response>(
        std::string & adAccountId, std::string & bookmark, int32_t & pageSize, Pinterest_Lib_PaginationOrder & order, std::vector<std::string> & productGroupPromotionIds, std::vector<EntityStatus> & entityStatuses, std::string & adGroupId)> handler_GET_func =
            [](std::string &, std::string &, int32_t &, Pinterest_Lib_PaginationOrder &, std::vector<std::string> &, std::vector<EntityStatus> &, std::string &) -> std::pair<int, Product_group_promotions_list_200_response>
                { throw ProductGroupPromotionsApiException(501, "Not implemented"); };

    std::function<std::pair<int, ProductGroupPromotions>(
        std::string & adAccountId, ProductGroupPromotionsUpdateWithRequiredBody & productGroupPromotionsUpdateWithRequiredBody)> handler_PATCH_func =
            [](std::string &, ProductGroupPromotionsUpdateWithRequiredBody &) -> std::pair<int, ProductGroupPromotions>
                { throw ProductGroupPromotionsApiException(501, "Not implemented"); };
...
protected:
    ...
    virtual std::pair<int, ProductGroupPromotions> handler_POST(
    ...
    virtual std::pair<int, ProductGroupPromotions> handler_PATCH(
...
public:
    ...
    virtual ~Ad_accountsAd_account_idProduct_group_promotionsProduct_group_promotion_idResource();
    ...
    // Set these to implement the server functionality //
    /////////////////////////////////////////////////////
    std::function<std::pair<int, ProductGroupPromotion>(
        std::string & adAccountId, std::string & productGroupPromotionId)> handler_GET_func =
            [](std::string &, std::string &) -> std::pair<int, ProductGroupPromotion>
                { throw ProductGroupPromotionsApiException(501, "Not implemented"); };
...
protected:
    ...
    virtual std::pair<int, ProductGroupPromotion> handler_GET(
...
public:
    ...
    virtual ~Ad_accountsAd_account_idProduct_groupsAnalyticsResource();
    ...
    // Set these to implement the server functionality //
    /////////////////////////////////////////////////////
    std::function<std::pair<int, std::vector<ProductGroupAnalyticsItems>>(
        std::string & startDate, std::string & endDate, std::vector<std::string> & productGroupIds, std::vector<ReportingColumnSync> & columns, Granularity & granularity, std::string & adAccountId, double & clickWindowDays, double & engagementWindowDays, double & viewWindowDays, std::string & conversionReportTime, ReportingTimeZone & reportingTimezone)> handler_GET_func =
            [](std::string &, std::string &, std::vector<std::string> &, std::vector<ReportingColumnSync> &, Granularity &, std::string &, double &, double &, double &, std::string &, ReportingTimeZone &) -> std::pair<int, std::vector<ProductGroupAnalyticsItems>>
                { throw ProductGroupPromotionsApiException(501, "Not implemented"); };
...
protected:
    ...
    virtual std::pair<int, std::vector<ProductGroupAnalyticsItems>> handler_GET(
