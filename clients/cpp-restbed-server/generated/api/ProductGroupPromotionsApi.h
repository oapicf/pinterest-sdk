...
public:
    ...
    std::function<std::pair<int, std::vector<ProductGroupAnalyticsResponse_inner>>(
        std::string & adAccountId, std::string & startDate, std::string & endDate, std::vector<std::string> & productGroupIds, std::vector<std::string> & columns, Granularity & granularity, int32_t & clickWindowDays, int32_t & engagementWindowDays, int32_t & viewWindowDays, std::string & conversionReportTime, ReportingTimeZone & reportingTimezone)> handler_GET_func =
            [](std::string &, std::string &, std::string &, std::vector<std::string> &, std::vector<std::string> &, Granularity &, int32_t &, int32_t &, int32_t &, std::string &, ReportingTimeZone &) -> std::pair<int, std::vector<ProductGroupAnalyticsResponse_inner>>
                { throw ProductGroupPromotionsApiException(501, "Not implemented"); };
