...
public:
    ...
    virtual ~IntegrationsCommerceExternal_business_idResource();
    ...
    std::function<std::pair<int, IntegrationMetadata>(
        std::string & externalBusinessId, IntegrationMetadataUpdate & integrationMetadataUpdate)> handler_PATCH_func =
            [](std::string &, IntegrationMetadataUpdate &) -> std::pair<int, IntegrationMetadata>
                { throw IntegrationsApiException(501, "Not implemented"); };
...
protected:
    ...
    virtual std::pair<int, IntegrationMetadata> handler_DELETE(
...
public:
    ...
    virtual ~IntegrationsCommerceResource();
    ...
    /////////////////////////////////////////////////////
    std::function<std::pair<int, IntegrationMetadata>(
        IntegrationMetadataCreate & integrationMetadataCreate)> handler_POST_func =
            [](IntegrationMetadataCreate &) -> std::pair<int, IntegrationMetadata>
                { throw IntegrationsApiException(501, "Not implemented"); };
...
public:
    ...
    virtual ~IntegrationsLogsResource();
    ...
    std::function<std::pair<int, IntegrationLogsSuccessResponse>(
        IntegrationLogsRequestCreate & integrationLogsRequestCreate)> handler_POST_func =
            [](IntegrationLogsRequestCreate &) -> std::pair<int, IntegrationLogsSuccessResponse>
                { throw IntegrationsApiException(501, "Not implemented"); };
...
public:
    ...
    virtual ~IntegrationsIdResource();
