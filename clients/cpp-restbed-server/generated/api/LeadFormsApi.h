...
public:
    ...
    virtual ~Ad_accountsAd_account_idLead_formsLead_form_idTestResource();
    ...
    /////////////////////////////////////////////////////
    std::function<std::pair<int, LeadFormTest>(
        std::string & adAccountId, std::string & leadFormId, LeadFormTestCreate & leadFormTestCreate)> handler_POST_func =
            [](std::string &, std::string &, LeadFormTestCreate &) -> std::pair<int, LeadFormTest>
...
protected:
    ...
    virtual std::pair<int, LeadFormTest> handler_POST(
...
public:
    ...
    virtual ~Ad_accountsAd_account_idLead_formsLead_form_idResource();
    ...
    // Set these to implement the server functionality //
    /////////////////////////////////////////////////////
    std::function<std::pair<int, LeadForm>(
        std::string & leadFormId, std::string & adAccountId)> handler_GET_func =
            [](std::string &, std::string &) -> std::pair<int, LeadForm>
                { throw LeadFormsApiException(501, "Not implemented"); };
...
protected:
    ...
    virtual std::pair<int, LeadForm> handler_GET(
...
public:
    ...
    virtual ~Ad_accountsAd_account_idLead_formsResource();
    ...
    // Set these to implement the server functionality //
    /////////////////////////////////////////////////////
    std::function<std::pair<int, Lead_forms_create_200_response>(
        std::string & adAccountId, std::vector<LeadFormCreate> & leadFormCreate)> handler_POST_func =
            [](std::string &, std::vector<LeadFormCreate> &) -> std::pair<int, Lead_forms_create_200_response>
                { throw LeadFormsApiException(501, "Not implemented"); };
    ...
    std::function<std::pair<int, Lead_forms_list_200_response>(
        std::string & adAccountId, std::string & bookmark, int32_t & pageSize, Pinterest_Lib_PaginationOrder & order)> handler_GET_func =
            [](std::string &, std::string &, int32_t &, Pinterest_Lib_PaginationOrder &) -> std::pair<int, Lead_forms_list_200_response>
                { throw LeadFormsApiException(501, "Not implemented"); };

    std::function<std::pair<int, Lead_forms_create_200_response>(
        std::string & adAccountId, std::vector<LeadFormBatchUpdate> & leadFormBatchUpdate)> handler_PATCH_func =
            [](std::string &, std::vector<LeadFormBatchUpdate> &) -> std::pair<int, Lead_forms_create_200_response>
                { throw LeadFormsApiException(501, "Not implemented"); };
...
protected:
    ...
    virtual std::pair<int, Lead_forms_create_200_response> handler_POST(
    ...
    virtual std::pair<int, Lead_forms_create_200_response> handler_PATCH(
