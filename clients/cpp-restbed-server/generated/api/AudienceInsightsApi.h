...
public:
    ...
    virtual ~Ad_accountsAd_account_idInsightsAudiencesResource();
    ...
    /////////////////////////////////////////////////////
    std::function<std::pair<int, Audience_insights_scope_and_type_get_200_response>(
        std::string & adAccountId)> handler_GET_func =
            [](std::string &) -> std::pair<int, Audience_insights_scope_and_type_get_200_response>
...
protected:
    ...
    virtual std::pair<int, Audience_insights_scope_and_type_get_200_response> handler_GET(
...
public:
    ...
    virtual ~Ad_accountsAd_account_idAudience_insightsResource();
    ...
    // Set these to implement the server functionality //
    /////////////////////////////////////////////////////
    std::function<std::pair<int, AudienceInsights>(
        std::string & adAccountId, AudienceInsightType & audienceInsightType)> handler_GET_func =
            [](std::string &, AudienceInsightType &) -> std::pair<int, AudienceInsights>
                { throw AudienceInsightsApiException(501, "Not implemented"); };
...
protected:
    ...
    virtual std::pair<int, AudienceInsights> handler_GET(
