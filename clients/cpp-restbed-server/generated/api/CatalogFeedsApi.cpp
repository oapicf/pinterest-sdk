...
CatalogsFeedsFeed_idProcessing_resultsResource::~CatalogsFeedsFeed_idProcessing_resultsResource() = default;
...
{
    return handler_GET_func(feedId, adAccountId, bookmark, pageSize);
}
...
CatalogsFeedsResource::~CatalogsFeedsResource() = default;
...
{
    return handler_POST_func(catalogsFeedCreateRequestSchema, adAccountId);
}
...
{
    return handler_GET_func(catalogId, adAccountId, bookmark, pageSize);
}
...
CatalogsFeedsFeed_idResource::~CatalogsFeedsFeed_idResource() = default;
...
std::pair<int, CatalogsFeed> CatalogsFeedsFeed_idResource::handler_DELETE(
...
{
    return handler_PATCH_func(feedId, catalogsFeedUpdateRequestSchema, adAccountId);
}
...
CatalogsFeedsFeed_idIngestResource::~CatalogsFeedsFeed_idIngestResource() = default;
...
CatalogsProcessing_resultsProcessing_result_idItem_issuesResource::~CatalogsProcessing_resultsProcessing_result_idItem_issuesResource() = default;
...
{
    return handler_GET_func(processingResultId, itemNumbers, itemValidationIssue, adAccountId, bookmark, pageSize);
}
