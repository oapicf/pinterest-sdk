...
BoardsBoard_idSectionsResource::~BoardsBoard_idSectionsResource() = default;
...
std::pair<int, BoardSection> BoardsBoard_idSectionsResource::handler_POST(
        std::string & boardId, BoardSectionCreate & boardSectionCreate, std::string & adAccountId)
{
    return handler_POST_func(boardId, boardSectionCreate, adAccountId);
}
...
BoardsBoard_idSectionsSection_idResource::~BoardsBoard_idSectionsSection_idResource() = default;
...
std::pair<int, BoardSection> BoardsBoard_idSectionsSection_idResource::handler_DELETE(
...
std::pair<int, BoardSection> BoardsBoard_idSectionsSection_idResource::handler_PATCH(
    std::string & boardId, std::string & sectionId, BoardSectionUpdateWithRequiredBody & boardSectionUpdateWithRequiredBody, std::string & adAccountId)
{
    return handler_PATCH_func(boardId, sectionId, boardSectionUpdateWithRequiredBody, adAccountId);
}
...
BoardsBoard_idSectionsSection_idPinsResource::~BoardsBoard_idSectionsSection_idPinsResource() = default;
...
BoardsResource::~BoardsResource() = default;
...
std::pair<int, Board> BoardsResource::handler_POST(
        BoardCreate & boardCreate, std::string & adAccountId)
{
    return handler_POST_func(boardCreate, adAccountId);
}

std::pair<int, Boards_list_200_response> BoardsResource::handler_GET(
    std::string & adAccountId, BoardPrivacyFilter & privacy, std::string & bookmark, int32_t & pageSize)
{
    return handler_GET_func(adAccountId, privacy, bookmark, pageSize);
}
...
BoardsBoard_idResource::~BoardsBoard_idResource() = default;
...
void BoardsBoard_idResource::handler_PATCH_internal(const std::shared_ptr<restbed::Session> session) {
    ...
    int status_code = 500;
    BoardWithUpdatePrivacy resultObject = BoardWithUpdatePrivacy{};
    std::string result = "";
...
std::pair<int, Board> BoardsBoard_idResource::handler_DELETE(
...
std::pair<int, BoardWithUpdatePrivacy> BoardsBoard_idResource::handler_PATCH(
    std::string & boardId, BoardWithUpdatePrivacyUpdate & boardWithUpdatePrivacyUpdate, std::string & adAccountId)
{
    return handler_PATCH_func(boardId, boardWithUpdatePrivacyUpdate, adAccountId);
}
...
BoardsBoard_idPinsResource::~BoardsBoard_idPinsResource() = default;
...
void BoardsBoard_idPinsResource::handler_GET_internal(const std::shared_ptr<restbed::Session> session)
{
    ...
    std::vector<CreativeType> creativeTypes;
    std::vector<std::string> creativeTypes_temp;
    boost::split(creativeTypes_temp, creativeTypes_raw, boost::is_any_of(","));
    std::transform(creativeTypes_temp.begin(), creativeTypes_temp.end(), std::back_inserter(creativeTypes), [](const auto& i){ CreativeType ret; ret.fromString(i); return ret;});
    std::string adAccountId = request->get_query_parameter("adAccountId", "");
...
std::pair<int, Boards_list_pins_200_response> BoardsBoard_idPinsResource::handler_GET(
        std::string & boardId, std::vector<CreativeType> & creativeTypes, std::string & adAccountId, bool & pinMetrics, std::string & bookmark, int32_t & pageSize)
{
    return handler_GET_func(boardId, creativeTypes, adAccountId, pinMetrics, bookmark, pageSize);
}
