...
Ad_accountsAd_account_idConversion_tagsResource::~Ad_accountsAd_account_idConversion_tagsResource() = default;
...
void Ad_accountsAd_account_idConversion_tagsResource::handler_POST_internal(const std::shared_ptr<restbed::Session> session)
{
    ...
    int status_code = 500;
    ConversionTag resultObject = ConversionTag{};
    std::string result = "";
...
void Ad_accountsAd_account_idConversion_tagsResource::handler_GET_internal(const std::shared_ptr<restbed::Session> session) {
    ...
    int status_code = 500;
    Conversion_tags_list_200_response resultObject = Conversion_tags_list_200_response{};
    std::string result = "";
...
std::pair<int, ConversionTag> Ad_accountsAd_account_idConversion_tagsResource::handler_POST(
        std::string & adAccountId, ConversionTagCreate & conversionTagCreate)
{
    return handler_POST_func(adAccountId, conversionTagCreate);
}

std::pair<int, Conversion_tags_list_200_response> Ad_accountsAd_account_idConversion_tagsResource::handler_GET(
...
Ad_accountsAd_account_idConversion_tagsConversion_tag_idResource::~Ad_accountsAd_account_idConversion_tagsConversion_tag_idResource() = default;
...
std::pair<int, ConversionTag> Ad_accountsAd_account_idConversion_tagsConversion_tag_idResource::handler_GET(
...
Ad_accountsAd_account_idConversion_tagsOcpm_eligibleResource::~Ad_accountsAd_account_idConversion_tagsOcpm_eligibleResource() = default;
...
Ad_accountsAd_account_idConversion_tagsPage_visitResource::~Ad_accountsAd_account_idConversion_tagsPage_visitResource() = default;
