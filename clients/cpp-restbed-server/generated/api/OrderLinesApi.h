...
public:
    ...
    virtual ~Ad_accountsAd_account_idOrder_linesOrder_line_idResource();
    ...
    std::function<std::pair<int, OrderLine>(
        std::string & orderLineId, std::string & adAccountId)> handler_GET_func =
...
public:
    ...
    virtual ~Ad_accountsAd_account_idOrder_linesResource();
    ...
    std::function<std::pair<int, Order_lines_list_200_response>(
        std::string & adAccountId, std::string & bookmark, int32_t & pageSize, Pinterest_Lib_PaginationOrder & order)> handler_GET_func =
            [](std::string &, std::string &, int32_t &, Pinterest_Lib_PaginationOrder &) -> std::pair<int, Order_lines_list_200_response>
                { throw OrderLinesApiException(501, "Not implemented"); };
