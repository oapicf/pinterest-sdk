...
public:
    ...
    /// </summary>
    std::vector<PinAnalyticsDailyMetrics> getDailyMetrics() const;
    void setDailyMetrics(std::vector<PinAnalyticsDailyMetrics> value);
...
protected:
    std::vector<PinAnalyticsDailyMetrics> m_Daily_metrics;
