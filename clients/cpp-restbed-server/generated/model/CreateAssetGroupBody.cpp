...
CreateAssetGroupBody::CreateAssetGroupBody(boost::property_tree::ptree const& pt)
{
        fromPropertyTree(pt);
}


std::string CreateAssetGroupBody::toJsonString(bool prettyJson /* = false */) const
{
	std::stringstream ss;
...
void CreateAssetGroupBody::fromJsonString(std::string const& jsonString)
{
...
ptree CreateAssetGroupBody::toPropertyTree() const
{
	ptree pt;
	ptree tmp_node;
...
void CreateAssetGroupBody::fromPropertyTree(ptree const &pt)
{
	ptree tmp_node;
...
void CreateAssetGroupBody::setAssetGroupName(std::string value)
{
...
void CreateAssetGroupBody::setAssetGroupDescription(std::string value)
{
    m_Asset_group_description = value;
}


std::vector<AssetGroupType> CreateAssetGroupBody::getAssetGroupTypes() const
{
    return m_Asset_group_types;
}

void CreateAssetGroupBody::setAssetGroupTypes(std::vector<AssetGroupType> value)
{
...
std::vector<CreateAssetGroupBody> createCreateAssetGroupBodyVectorFromJsonString(const std::string& json)
{
    ...
    auto vec = std::vector<CreateAssetGroupBody>();
    for (const auto& child: pt) {
        vec.emplace_back(CreateAssetGroupBody(child.second));
    }
