...
/// 
/// </summary>
class  LeadFormCreateRequest : public LeadFormCommon
{
public:
    LeadFormCreateRequest() = default;
    explicit LeadFormCreateRequest(boost::property_tree::ptree const& pt);
    virtual ~LeadFormCreateRequest() = default;

    LeadFormCreateRequest(const LeadFormCreateRequest& other) = default; // copy constructor
    LeadFormCreateRequest(LeadFormCreateRequest&& other) noexcept = default; // move constructor

    LeadFormCreateRequest& operator=(const LeadFormCreateRequest& other) = default; // copy assignment
    LeadFormCreateRequest& operator=(LeadFormCreateRequest&& other) noexcept = default; // move assignment
...
template<>
inline boost::property_tree::ptree toPt<LeadFormCreateRequest>(const LeadFormCreateRequest& val) {
    return val.toPropertyTree();
}

template<>
inline LeadFormCreateRequest fromPt<LeadFormCreateRequest>(const boost::property_tree::ptree& pt) {
    LeadFormCreateRequest ret;
