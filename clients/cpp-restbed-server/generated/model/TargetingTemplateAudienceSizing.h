...
public:
    ...
    /// 
    /// </summary>
    TargetingTemplateAudienceSizingReachEstimate getReachEstimate() const;
    void setReachEstimate(TargetingTemplateAudienceSizingReachEstimate value);

protected:
    TargetingTemplateAudienceSizingReachEstimate m_Reach_estimate;
};
