...
std::string OauthAccessTokenRequestCode::toJsonString(bool prettyJson /* = false */) const
{
	std::stringstream ss;
...
ptree OauthAccessTokenRequestCode::toPropertyTree() const
{
	ptree pt;
	ptree tmp_node;
...
void OauthAccessTokenRequestCode::fromPropertyTree(ptree const &pt)
{
	ptree tmp_node;
