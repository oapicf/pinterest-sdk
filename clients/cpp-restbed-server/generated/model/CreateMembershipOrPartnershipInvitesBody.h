...
public:
    ...
    /// 
    /// </summary>
    BusinessRoleForInvite getBusinessRole() const;
    void setBusinessRole(BusinessRoleForInvite value);
...
protected:
    BusinessRoleForInvite m_Business_role = BusinessRoleForInvite{};
