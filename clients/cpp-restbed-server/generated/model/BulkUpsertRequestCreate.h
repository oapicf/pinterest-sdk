...
public:
    ...
    /// 
    /// </summary>
    std::vector<Multiple_product_groups_inner> getCatalogProductGroups() const;
    void setCatalogProductGroups(std::vector<Multiple_product_groups_inner> value);
    ...
    /// 
    /// </summary>
    std::vector<LabelCreateRequest> getLabels() const;
    void setLabels(std::vector<LabelCreateRequest> value);
...
protected:
    ...
    std::vector<Multiple_product_groups_inner> m_Catalog_product_groups;
    std::vector<KeywordsRequest> m_Keywords;
    std::vector<LabelCreateRequest> m_Labels;
