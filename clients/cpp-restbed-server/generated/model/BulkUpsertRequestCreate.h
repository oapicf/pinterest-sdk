...
public:
    ...
    /// 
    /// </summary>
    std::vector<BulkUpsertRequestCreateCatalogProductGroupsItems> getCatalogProductGroups() const;
    void setCatalogProductGroups(std::vector<BulkUpsertRequestCreateCatalogProductGroupsItems> value);
    ...
    /// 
    /// </summary>
    std::vector<LabelBulkCreateRequest> getLabels() const;
    void setLabels(std::vector<LabelBulkCreateRequest> value);
    ...
    /// 
    /// </summary>
    std::vector<ScheduleCreateRequest> getSchedules() const;
    void setSchedules(std::vector<ScheduleCreateRequest> value);

protected:
    std::vector<AdGroupCreateRequest> m_Ad_groups;
    std::vector<AdCreateRequest> m_Ads;
    std::vector<CampaignCreateRequest> m_Campaigns;
    std::vector<BulkUpsertRequestCreateCatalogProductGroupsItems> m_Catalog_product_groups;
    std::vector<KeywordsRequest> m_Keywords;
    std::vector<LabelBulkCreateRequest> m_Labels;
    std::vector<ProductGroupPromotionCreateRequest> m_Product_groups;
    std::vector<ScheduleCreateRequest> m_Schedules;
};
