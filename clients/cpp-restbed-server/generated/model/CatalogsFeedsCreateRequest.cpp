...
CatalogsCreativeAssetsFeedsCreateRequest_default_locale CatalogsFeedsCreateRequest::getDefaultLocale() const
{
    return m_Default_locale;
}

void CatalogsFeedsCreateRequest::setDefaultLocale(CatalogsCreativeAssetsFeedsCreateRequest_default_locale value)
{
