...
void BulkUpsertRequestCreate::fromPropertyTree(ptree const &pt)
{
	...
	if (pt.get_child_optional("catalog_product_groups")) {
        m_Catalog_product_groups = fromPt<std::vector<Multiple_product_groups_inner>>(pt.get_child("catalog_product_groups"));
	}
	...
	if (pt.get_child_optional("labels")) {
        m_Labels = fromPt<std::vector<LabelCreateRequest>>(pt.get_child("labels"));
	}
...
std::vector<Multiple_product_groups_inner> BulkUpsertRequestCreate::getCatalogProductGroups() const
{
    return m_Catalog_product_groups;
}

void BulkUpsertRequestCreate::setCatalogProductGroups(std::vector<Multiple_product_groups_inner> value)
{
...
std::vector<LabelCreateRequest> BulkUpsertRequestCreate::getLabels() const
{
    return m_Labels;
}

void BulkUpsertRequestCreate::setLabels(std::vector<LabelCreateRequest> value)
{
    m_Labels = value;
}
