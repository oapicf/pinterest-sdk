...
void BulkUpsertRequestCreate::fromPropertyTree(ptree const &pt)
{
	...
	if (pt.get_child_optional("catalog_product_groups")) {
        m_Catalog_product_groups = fromPt<std::vector<BulkUpsertRequestCreateCatalogProductGroupsItems>>(pt.get_child("catalog_product_groups"));
	}
	...
	if (pt.get_child_optional("labels")) {
        m_Labels = fromPt<std::vector<LabelBulkCreateRequest>>(pt.get_child("labels"));
	}
	...
	if (pt.get_child_optional("schedules")) {
        m_Schedules = fromPt<std::vector<ScheduleCreateRequest>>(pt.get_child("schedules"));
	}
}
...
void BulkUpsertRequestCreate::setCatalogProductGroups(std::vector<BulkUpsertRequestCreateCatalogProductGroupsItems> value)
{
...
void BulkUpsertRequestCreate::setLabels(std::vector<LabelBulkCreateRequest> value)
{
    m_Labels = value;
}
...
void BulkUpsertRequestCreate::setSchedules(std::vector<ScheduleCreateRequest> value)
{
    m_Schedules = value;
}
