...
public:
    ...
    /// Log event type
    /// </summary>
    IntegrationLogEventType getEventType() const;
    void setEventType(IntegrationLogEventType value);
    ...
    /// Log level type
    /// </summary>
    IntegrationLogLevel getLogLevel() const;
    void setLogLevel(IntegrationLogLevel value);
...
protected:
    ...
    IntegrationLogEventType m_Event_type = IntegrationLogEventType{};
    std::string m_External_business_id = "";
    std::string m_Feed_profile_id = "";
    IntegrationLogLevel m_Log_level = IntegrationLogLevel{};
