...
ptree CatalogsProductGroupFiltersAllOf::toPropertyTree() const
{
	ptree pt;
	ptree tmp_node;
...
void CatalogsProductGroupFiltersAllOf::fromPropertyTree(ptree const &pt)
{
	ptree tmp_node;
...
void CatalogsProductGroupFiltersAllOf::setAllOf(std::vector<CatalogsProductGroupFilterKeys> value)
{
    m_All_of = value;
}
