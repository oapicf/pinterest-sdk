...
AdsAnalyticsFilterColumn::~AdsAnalyticsFilterColumn = default;
...
ptree AdsAnalyticsFilterColumn::toPropertyTree() const
{
	ptree pt;
	ptree tmp_node;
	return pt;
...
void AdsAnalyticsFilterColumn::fromPropertyTree(ptree const &pt)
{
	ptree tmp_node;
}

std::string AdsAnalyticsFilterColumn::toString() const {
    return boost::lexical_cast<std::string>(getEnumValue());
}

void AdsAnalyticsFilterColumn::fromString(const std::string& str) {
    setEnumValue(boost::lexical_cast<std::string>(str));
}

std::string AdsAnalyticsFilterColumn::getEnumValue() const {
    return m_AdsAnalyticsFilterColumnEnumValue;
}

void AdsAnalyticsFilterColumn::setEnumValue(const std::string& val) {
    ...
    if (std::find(allowedValues.begin(), allowedValues.end(), val) != allowedValues.end()) {
        m_AdsAnalyticsFilterColumnEnumValue = val;
    } else {
