...
ptree CatalogsProductGroupFiltersAnyOf::toPropertyTree() const
{
	ptree pt;
	ptree tmp_node;
...
void CatalogsProductGroupFiltersAnyOf::fromPropertyTree(ptree const &pt)
{
	ptree tmp_node;
...
void CatalogsProductGroupFiltersAnyOf::setAnyOf(std::vector<CatalogsProductGroupFilterKeys> value)
{
    m_Any_of = value;
}
