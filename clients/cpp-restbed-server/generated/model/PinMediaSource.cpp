...
ContentType PinMediaSource::getContentType() const
{
    return m_Content_type;
}

void PinMediaSource::setContentType(ContentType value)
{
...
ContentType PinMediaSource::getCoverImageContentType() const
{
    return m_Cover_image_content_type;
}

void PinMediaSource::setCoverImageContentType(ContentType value)
{
...
std::vector<PinMediaSourceImagesURLItem> PinMediaSource::getItems() const
{
    return m_Items;
}

void PinMediaSource::setItems(std::vector<PinMediaSourceImagesURLItem> value)
{
    m_Items = value;
}
