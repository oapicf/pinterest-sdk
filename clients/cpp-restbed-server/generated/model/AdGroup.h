...
public:
    ...
    AdGroup(const AdGroup& other) = default; // copy constructor
    AdGroup(AdGroup&& other) noexcept = default; // move constructor

    AdGroup& operator=(const AdGroup& other) = default; // copy assignment
    AdGroup& operator=(AdGroup&& other) noexcept = default; // move assignment
...
template<>
inline boost::property_tree::ptree toPt<AdGroup>(const AdGroup& val) {
    return val.toPropertyTree();
}

template<>
inline AdGroup fromPt<AdGroup>(const boost::property_tree::ptree& pt) {
    AdGroup ret;
