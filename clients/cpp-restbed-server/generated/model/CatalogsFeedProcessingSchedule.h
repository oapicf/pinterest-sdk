...
public:
    ...
    /// </summary>
    CatalogsFeedProcessingScheduleTimezone getTimezone() const;
    void setTimezone(CatalogsFeedProcessingScheduleTimezone value);

protected:
    std::string m_Time = "";
    CatalogsFeedProcessingScheduleTimezone m_Timezone = CatalogsFeedProcessingScheduleTimezone{};
};
