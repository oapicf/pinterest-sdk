...
void Order::fromString(const std::string& str) {
    setEnumValue(boost::lexical_cast<std::string>(str));
}

std::string Order::getEnumValue() const {
    return m_OrderEnumValue;
}

void Order::setEnumValue(const std::string& val) {
