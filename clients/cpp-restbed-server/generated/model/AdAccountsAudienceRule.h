...
public:
    ...
    explicit AdAccountsAudienceRule(boost::property_tree::ptree const& pt);
    virtual ~AdAccountsAudienceRule();

    AdAccountsAudienceRule(const AdAccountsAudienceRule& other) = default; // copy constructor
    AdAccountsAudienceRule(AdAccountsAudienceRule&& other) noexcept = default; // move constructor

    AdAccountsAudienceRule& operator=(const AdAccountsAudienceRule& other) = default; // copy assignment
    AdAccountsAudienceRule& operator=(AdAccountsAudienceRule&& other) noexcept = default; // move assignment
    ...
    void setEventData(EventData value);
    ...
    /// </summary>
    std::vector<AudienceObjectiveType> getObjectiveType() const;
    void setObjectiveType(std::vector<AudienceObjectiveType> value);
...
protected:
    ...
    std::vector<AudienceObjectiveType> m_Objective_type;
...
template<>
inline boost::property_tree::ptree toPt<AdAccountsAudienceRule>(const AdAccountsAudienceRule& val) {
    return val.toPropertyTree();
}

template<>
inline AdAccountsAudienceRule fromPt<AdAccountsAudienceRule>(const boost::property_tree::ptree& pt) {
    AdAccountsAudienceRule ret;
