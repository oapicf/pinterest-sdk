...
std::string BatchOperation::toJsonString(bool prettyJson /* = false */) const
{
	std::stringstream ss;
...
ptree BatchOperation::toPropertyTree() const
{
	ptree pt;
	ptree tmp_node;
	return pt;
...
void BatchOperation::fromPropertyTree(ptree const &pt)
{
	ptree tmp_node;
}

std::string BatchOperation::toString() const {
    return boost::lexical_cast<std::string>(getEnumValue());
}

void BatchOperation::fromString(const std::string& str) {
    setEnumValue(boost::lexical_cast<std::string>(str));
}

std::string BatchOperation::getEnumValue() const {
    return m_BatchOperationEnumValue;
}

void BatchOperation::setEnumValue(const std::string& val) {
