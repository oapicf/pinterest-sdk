...
void CatalogsHotelAttributes::fromPropertyTree(ptree const &pt)
{
	...
	if (pt.get_child_optional("main_image")) {
        m_Main_image = fromPt<CatalogsHotelMainImage>(pt.get_child("main_image"));
	}
}
...
void CatalogsHotelAttributes::setAiDisclosures(std::vector<CatalogsAiContentDisclosure> value)
{
...
void CatalogsHotelAttributes::setMainImage(CatalogsHotelMainImage value)
{
    m_Main_image = value;
}
