...
void AdGroupCreateRequest::setBidStrategyType(BidStrategyType value)
{
...
std::string AdGroupCreateRequest::getOptimizationGoalMetadata() const
{
    return m_Optimization_goal_metadata;
}

void AdGroupCreateRequest::setOptimizationGoalMetadata(std::string value)
{
...
std::string AdGroupCreateRequest::getTrackingUrls() const
{
    return m_Tracking_urls;
}

void AdGroupCreateRequest::setTrackingUrls(std::string value)
{
