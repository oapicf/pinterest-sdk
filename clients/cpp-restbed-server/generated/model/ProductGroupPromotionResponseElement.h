...
#ifndef ProductGroupPromotionResponseElement_H_
#define ProductGroupPromotionResponseElement_H_
...
/// 
/// </summary>
class  ProductGroupPromotionResponseElement : public ProductGroupPromotion
{
public:
    ProductGroupPromotionResponseElement() = default;
    explicit ProductGroupPromotionResponseElement(boost::property_tree::ptree const& pt);
    virtual ~ProductGroupPromotionResponseElement() = default;

    ProductGroupPromotionResponseElement(const ProductGroupPromotionResponseElement& other) = default; // copy constructor
    ProductGroupPromotionResponseElement(ProductGroupPromotionResponseElement&& other) noexcept = default; // move constructor

    ProductGroupPromotionResponseElement& operator=(const ProductGroupPromotionResponseElement& other) = default; // copy assignment
    ProductGroupPromotionResponseElement& operator=(ProductGroupPromotionResponseElement&& other) noexcept = default; // move assignment
    ...
    /////////////////////////////////////////////
    /// ProductGroupPromotionResponseElement members
...
template<>
inline boost::property_tree::ptree toPt<ProductGroupPromotionResponseElement>(const ProductGroupPromotionResponseElement& val) {
    return val.toPropertyTree();
}

template<>
inline ProductGroupPromotionResponseElement fromPt<ProductGroupPromotionResponseElement>(const boost::property_tree::ptree& pt) {
    ProductGroupPromotionResponseElement ret;
...
#endif /* ProductGroupPromotionResponseElement_H_ */
