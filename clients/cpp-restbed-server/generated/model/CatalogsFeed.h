...
/// Catalogs Feed object
/// </summary>
class  CatalogsFeed : public CatalogsRetailFeed, public CatalogsHotelFeed, public CatalogsCreativeAssetsFeed
{
public:
    ...
    CatalogsFeed(const CatalogsFeed& other) = default; // copy constructor
    CatalogsFeed(CatalogsFeed&& other) noexcept = default; // move constructor

    CatalogsFeed& operator=(const CatalogsFeed& other) = default; // copy assignment
    CatalogsFeed& operator=(CatalogsFeed&& other) noexcept = default; // move assignment
...
template<>
inline boost::property_tree::ptree toPt<CatalogsFeed>(const CatalogsFeed& val) {
    return val.toPropertyTree();
}

template<>
inline CatalogsFeed fromPt<CatalogsFeed>(const boost::property_tree::ptree& pt) {
    CatalogsFeed ret;
