...
std::string OauthAccessTokenResponseRefresh::toJsonString(bool prettyJson /* = false */) const
{
	std::stringstream ss;
...
ptree OauthAccessTokenResponseRefresh::toPropertyTree() const
{
	ptree pt;
	ptree tmp_node;
...
void OauthAccessTokenResponseRefresh::fromPropertyTree(ptree const &pt)
{
	ptree tmp_node;
...
void OauthAccessTokenResponseRefresh::setRefreshToken(std::string value)
{
