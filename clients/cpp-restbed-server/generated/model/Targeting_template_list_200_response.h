...
public:
    ...
    /// 
    /// </summary>
    std::vector<TargetingTemplateGetResponseData> getItems() const;
    void setItems(std::vector<TargetingTemplateGetResponseData> value);

protected:
    std::string m_Bookmark = "";
    std::vector<TargetingTemplateGetResponseData> m_Items;
};
