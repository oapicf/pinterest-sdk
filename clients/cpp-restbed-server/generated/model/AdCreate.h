...
public:
    ...
    AdCreate(const AdCreate& other) = default; // copy constructor
    AdCreate(AdCreate&& other) noexcept = default; // move constructor

    AdCreate& operator=(const AdCreate& other) = default; // copy assignment
    AdCreate& operator=(AdCreate&& other) noexcept = default; // move assignment
...
template<>
inline boost::property_tree::ptree toPt<AdCreate>(const AdCreate& val) {
    return val.toPropertyTree();
}

template<>
inline AdCreate fromPt<AdCreate>(const boost::property_tree::ptree& pt) {
    AdCreate ret;
