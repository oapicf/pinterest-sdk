...
ptree AdsAnalyticsFilterOperator::toPropertyTree() const
{
	ptree pt;
	ptree tmp_node;
	return pt;
...
void AdsAnalyticsFilterOperator::fromPropertyTree(ptree const &pt)
{
	ptree tmp_node;
}

std::string AdsAnalyticsFilterOperator::toString() const {
    return boost::lexical_cast<std::string>(getEnumValue());
}

void AdsAnalyticsFilterOperator::fromString(const std::string& str) {
    setEnumValue(boost::lexical_cast<std::string>(str));
}

std::string AdsAnalyticsFilterOperator::getEnumValue() const {
    return m_AdsAnalyticsFilterOperatorEnumValue;
}

void AdsAnalyticsFilterOperator::setEnumValue(const std::string& val) {
    ...
    if (std::find(allowedValues.begin(), allowedValues.end(), val) != allowedValues.end()) {
        m_AdsAnalyticsFilterOperatorEnumValue = val;
    } else {
