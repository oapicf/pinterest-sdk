...
#ifndef AdGroupCommon_H_
#define AdGroupCommon_H_
...
{
public:
    AdGroupCommon() = default;
    explicit AdGroupCommon(boost::property_tree::ptree const& pt);
    virtual ~AdGroupCommon() = default;

    AdGroupCommon(const AdGroupCommon& other) = default; // copy constructor
    AdGroupCommon(AdGroupCommon&& other) noexcept = default; // move constructor

    AdGroupCommon& operator=(const AdGroupCommon& other) = default; // copy assignment
    AdGroupCommon& operator=(AdGroupCommon&& other) noexcept = default; // move assignment
...
template<>
inline boost::property_tree::ptree toPt<AdGroupCommon>(const AdGroupCommon& val) {
    return val.toPropertyTree();
}

template<>
inline AdGroupCommon fromPt<AdGroupCommon>(const boost::property_tree::ptree& pt) {
    AdGroupCommon ret;
