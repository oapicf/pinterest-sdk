...
public:
    Campaign() = default;
    explicit Campaign(boost::property_tree::ptree const& pt);
    virtual ~Campaign();

    Campaign(const Campaign& other) = default; // copy constructor
    Campaign(Campaign&& other) noexcept = default; // move constructor

    Campaign& operator=(const Campaign& other) = default; // copy assignment
    Campaign& operator=(Campaign&& other) noexcept = default; // move assignment
...
template<>
inline boost::property_tree::ptree toPt<Campaign>(const Campaign& val) {
    return val.toPropertyTree();
}

template<>
inline Campaign fromPt<Campaign>(const boost::property_tree::ptree& pt) {
    Campaign ret;
