...
public:
    ...
    AdGroupUpdate(const AdGroupUpdate& other) = default; // copy constructor
    AdGroupUpdate(AdGroupUpdate&& other) noexcept = default; // move constructor

    AdGroupUpdate& operator=(const AdGroupUpdate& other) = default; // copy assignment
    AdGroupUpdate& operator=(AdGroupUpdate&& other) noexcept = default; // move assignment
...
template<>
inline boost::property_tree::ptree toPt<AdGroupUpdate>(const AdGroupUpdate& val) {
    return val.toPropertyTree();
}

template<>
inline AdGroupUpdate fromPt<AdGroupUpdate>(const boost::property_tree::ptree& pt) {
    AdGroupUpdate ret;
