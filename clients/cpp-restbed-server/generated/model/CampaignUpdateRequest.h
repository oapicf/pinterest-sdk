...
public:
    ...
    CampaignUpdateRequest(const CampaignUpdateRequest& other) = default; // copy constructor
    CampaignUpdateRequest(CampaignUpdateRequest&& other) noexcept = default; // move constructor

    CampaignUpdateRequest& operator=(const CampaignUpdateRequest& other) = default; // copy assignment
    CampaignUpdateRequest& operator=(CampaignUpdateRequest&& other) noexcept = default; // move assignment
...
template<>
inline boost::property_tree::ptree toPt<CampaignUpdateRequest>(const CampaignUpdateRequest& val) {
    return val.toPropertyTree();
}

template<>
inline CampaignUpdateRequest fromPt<CampaignUpdateRequest>(const boost::property_tree::ptree& pt) {
    CampaignUpdateRequest ret;
