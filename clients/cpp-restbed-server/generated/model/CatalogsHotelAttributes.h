...
public:
    ...
    CatalogsHotelAttributes(const CatalogsHotelAttributes& other) = default; // copy constructor
    CatalogsHotelAttributes(CatalogsHotelAttributes&& other) noexcept = default; // move constructor

    CatalogsHotelAttributes& operator=(const CatalogsHotelAttributes& other) = default; // copy assignment
    CatalogsHotelAttributes& operator=(CatalogsHotelAttributes&& other) noexcept = default; // move assignment
    ...
    /// </summary>
    CatalogsHotelMainImage getMainImage() const;
    void setMainImage(CatalogsHotelMainImage value);
...
protected:
    ...
    CatalogsHotelMainImage m_Main_image;
};

std::vector<CatalogsHotelAttributes> createCatalogsHotelAttributesVectorFromJsonString(const std::string& json);

template<>
inline boost::property_tree::ptree toPt<CatalogsHotelAttributes>(const CatalogsHotelAttributes& val) {
    return val.toPropertyTree();
}

template<>
inline CatalogsHotelAttributes fromPt<CatalogsHotelAttributes>(const boost::property_tree::ptree& pt) {
    CatalogsHotelAttributes ret;
