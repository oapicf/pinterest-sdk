...
public:
    ...
    /// 
    /// </summary>
    CatalogsHotelAttributes_allOf_main_image getMainImage() const;
    void setMainImage(CatalogsHotelAttributes_allOf_main_image value);
...
protected:
    ...
    CatalogsHotelAttributes_allOf_main_image m_Main_image;
