...
CatalogsProductGroupFilterOperatorTypeCriteria CustomLabel2Filter::getCUSTOMLABEL2() const
{
    return m_CUSTOM_LABEL_2;
}

void CustomLabel2Filter::setCUSTOMLABEL2(CatalogsProductGroupFilterOperatorTypeCriteria value)
{
