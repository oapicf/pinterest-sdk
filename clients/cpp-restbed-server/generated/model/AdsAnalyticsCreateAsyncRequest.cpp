...
ptree AdsAnalyticsCreateAsyncRequest::toPropertyTree() const
{
	...
	if (!m_Custom_conversion_event_metrics.empty()) {
        tmp_node = toPt(m_Custom_conversion_event_metrics);
...
void AdsAnalyticsCreateAsyncRequest::fromPropertyTree(ptree const &pt)
{
	...
	if (pt.get_child_optional("campaign_objective_types")) {
        m_Campaign_objective_types = fromPt<std::vector<CampaignObjectiveType>>(pt.get_child("campaign_objective_types"));
	}
	...
	// push all items of Custom_conversion_event_metrics into member
	if (pt.get_child_optional("custom_conversion_event_metrics")) {
        m_Custom_conversion_event_metrics = fromPt<std::vector<CustomConversionEventMetrics>>(pt.get_child("custom_conversion_event_metrics"));
	}
	...
	if (pt.get_child_optional("targeting_types")) {
        m_Targeting_types = fromPt<std::vector<AdAdsAnalyticsAsyncTargetingTypes>>(pt.get_child("targeting_types"));
	}
}
...
void AdsAnalyticsCreateAsyncRequest::setCampaignObjectiveTypes(std::vector<CampaignObjectiveType> value)
{
...
void AdsAnalyticsCreateAsyncRequest::setCustomConversionEventMetrics(std::vector<CustomConversionEventMetrics> value)
{
...
void AdsAnalyticsCreateAsyncRequest::setPrimarySort(PrimarySort value)
{
...
void AdsAnalyticsCreateAsyncRequest::setReportingTimezone(ReportingTimeZone value)
{
...
void AdsAnalyticsCreateAsyncRequest::setTargetingTypes(std::vector<AdAdsAnalyticsAsyncTargetingTypes> value)
{
