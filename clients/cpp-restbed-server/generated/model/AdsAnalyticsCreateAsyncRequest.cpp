...
void AdsAnalyticsCreateAsyncRequest::fromPropertyTree(ptree const &pt)
{
	...
	if (pt.get_child_optional("custom_conversion_event_metrics")) {
        m_Custom_conversion_event_metrics = fromPt<std::vector<AdsAnalyticsCreateAsyncRequest_allOf_custom_conversion_event_metrics>>(pt.get_child("custom_conversion_event_metrics"));
	}
...
void AdsAnalyticsCreateAsyncRequest::setTargetingTypes(std::vector<std::string> value)
{
...
std::vector<AdsAnalyticsCreateAsyncRequest_allOf_custom_conversion_event_metrics> AdsAnalyticsCreateAsyncRequest::getCustomConversionEventMetrics() const
{
    return m_Custom_conversion_event_metrics;
}

void AdsAnalyticsCreateAsyncRequest::setCustomConversionEventMetrics(std::vector<AdsAnalyticsCreateAsyncRequest_allOf_custom_conversion_event_metrics> value)
{
