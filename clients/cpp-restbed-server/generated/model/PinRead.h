...
/// 
/// </summary>
class  PinRead : public PinBase
{
public:
    PinRead() = default;
    explicit PinRead(boost::property_tree::ptree const& pt);
    virtual ~PinRead();

    PinRead(const PinRead& other) = default; // copy constructor
    PinRead(PinRead&& other) noexcept = default; // move constructor

    PinRead& operator=(const PinRead& other) = default; // copy assignment
    PinRead& operator=(PinRead&& other) noexcept = default; // move assignment
...
template<>
inline boost::property_tree::ptree toPt<PinRead>(const PinRead& val) {
    return val.toPropertyTree();
}

template<>
inline PinRead fromPt<PinRead>(const boost::property_tree::ptree& pt) {
    PinRead ret;
