...
CustomizableCTAType AdResponse::getCustomizableCtaType() const
{
    return m_Customizable_cta_type;
}

void AdResponse::setCustomizableCtaType(CustomizableCTAType value)
{
...
DisclosureType AdResponse::getDisclosureType() const
{
    return m_Disclosure_type;
}

void AdResponse::setDisclosureType(DisclosureType value)
{
...
void AdResponse::setDisclosureUrl(std::string value)
{
