...
public:
    ...
    explicit CampaignBatchUpdateItem(boost::property_tree::ptree const& pt);
    virtual ~CampaignBatchUpdateItem();

    CampaignBatchUpdateItem(const CampaignBatchUpdateItem& other) = default; // copy constructor
    CampaignBatchUpdateItem(CampaignBatchUpdateItem&& other) noexcept = default; // move constructor

    CampaignBatchUpdateItem& operator=(const CampaignBatchUpdateItem& other) = default; // copy assignment
    CampaignBatchUpdateItem& operator=(CampaignBatchUpdateItem&& other) noexcept = default; // move assignment
...
template<>
inline boost::property_tree::ptree toPt<CampaignBatchUpdateItem>(const CampaignBatchUpdateItem& val) {
    return val.toPropertyTree();
}

template<>
inline CampaignBatchUpdateItem fromPt<CampaignBatchUpdateItem>(const boost::property_tree::ptree& pt) {
    CampaignBatchUpdateItem ret;
