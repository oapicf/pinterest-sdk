...
std::string OauthAccessTokenResponse::toJsonString(bool prettyJson /* = false */) const
{
	std::stringstream ss;
...
ptree OauthAccessTokenResponse::toPropertyTree() const
{
	ptree pt;
	ptree tmp_node;
...
void OauthAccessTokenResponse::fromPropertyTree(ptree const &pt)
{
	ptree tmp_node;
