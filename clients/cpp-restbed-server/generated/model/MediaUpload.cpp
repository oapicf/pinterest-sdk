...
void MediaUpload::fromPropertyTree(ptree const &pt)
{
	...
	if (pt.get_child_optional("upload_parameters")) {
        m_Upload_parameters = fromPt<MediaUploadParameters>(pt.get_child("upload_parameters"));
	}
...
MediaUploadParameters MediaUpload::getUploadParameters() const
{
    return m_Upload_parameters;
}

void MediaUpload::setUploadParameters(MediaUploadParameters value)
{
