...
public:
    ...
    /// </summary>
    std::vector<UpdateMemberAssetResultItem> getItems() const;
    void setItems(std::vector<UpdateMemberAssetResultItem> value);

protected:
    std::vector<UpdateMemberAssetResultItem> m_Items;
};
