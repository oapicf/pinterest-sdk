...
public:
    ...
    explicit SSIOInsertionOrderUpdate(boost::property_tree::ptree const& pt);
    virtual ~SSIOInsertionOrderUpdate();

    SSIOInsertionOrderUpdate(const SSIOInsertionOrderUpdate& other) = default; // copy constructor
    SSIOInsertionOrderUpdate(SSIOInsertionOrderUpdate&& other) noexcept = default; // move constructor

    SSIOInsertionOrderUpdate& operator=(const SSIOInsertionOrderUpdate& other) = default; // copy assignment
    SSIOInsertionOrderUpdate& operator=(SSIOInsertionOrderUpdate&& other) noexcept = default; // move assignment
...
template<>
inline boost::property_tree::ptree toPt<SSIOInsertionOrderUpdate>(const SSIOInsertionOrderUpdate& val) {
    return val.toPropertyTree();
}

template<>
inline SSIOInsertionOrderUpdate fromPt<SSIOInsertionOrderUpdate>(const boost::property_tree::ptree& pt) {
    SSIOInsertionOrderUpdate ret;
