...
public:
    ...
    AdGroupCreateCreate(const AdGroupCreateCreate& other) = default; // copy constructor
    AdGroupCreateCreate(AdGroupCreateCreate&& other) noexcept = default; // move constructor

    AdGroupCreateCreate& operator=(const AdGroupCreateCreate& other) = default; // copy assignment
    AdGroupCreateCreate& operator=(AdGroupCreateCreate&& other) noexcept = default; // move assignment
...
template<>
inline boost::property_tree::ptree toPt<AdGroupCreateCreate>(const AdGroupCreateCreate& val) {
    return val.toPropertyTree();
}

template<>
inline AdGroupCreateCreate fromPt<AdGroupCreateCreate>(const boost::property_tree::ptree& pt) {
    AdGroupCreateCreate ret;
