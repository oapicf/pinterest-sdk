...
public:
    ...
    /// </summary>
    std::vector<InviteAssetsSummaryItem> getAdAccounts() const;
    void setAdAccounts(std::vector<InviteAssetsSummaryItem> value);

    /// <summary>
    /// List of profile IDs and respective permission levels that will be assigned.
    /// </summary>
    std::vector<InviteAssetsSummaryItem> getProfiles() const;
    void setProfiles(std::vector<InviteAssetsSummaryItem> value);

protected:
    std::vector<InviteAssetsSummaryItem> m_Ad_accounts;
    std::vector<InviteAssetsSummaryItem> m_Profiles;
};
