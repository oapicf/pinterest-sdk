...
LeadFormUpdateRequest::LeadFormUpdateRequest(boost::property_tree::ptree const& pt)
{
        fromPropertyTree(pt);
}


std::string LeadFormUpdateRequest::toJsonString(bool prettyJson /* = false */) const
{
	std::stringstream ss;
...
void LeadFormUpdateRequest::fromJsonString(std::string const& jsonString)
{
...
ptree LeadFormUpdateRequest::toPropertyTree() const
{
	ptree pt;
	ptree tmp_node;
	pt.put("name", m_Name);
...
void LeadFormUpdateRequest::fromPropertyTree(ptree const &pt)
{
	ptree tmp_node;
	m_Name = pt.get("name", "");
...
void LeadFormUpdateRequest::setName(std::string value)
{
    m_Name = value;
}
...
void LeadFormUpdateRequest::setPrivacyPolicyLink(std::string value)
{
...
void LeadFormUpdateRequest::setCompletionMessage(std::string value)
{
    m_Completion_message = value;
}


LeadFormStatus LeadFormUpdateRequest::getStatus() const
{
    return m_Status;
}

void LeadFormUpdateRequest::setStatus(LeadFormStatus value)
{
    m_Status = value;
}
...
void LeadFormUpdateRequest::setDisclosureLanguage(std::string value)
{
    m_Disclosure_language = value;
}


std::vector<LeadFormQuestion> LeadFormUpdateRequest::getQuestions() const
{
    return m_Questions;
}

void LeadFormUpdateRequest::setQuestions(std::vector<LeadFormQuestion> value)
{
    m_Questions = value;
}


std::vector<LeadFormCommon_policy_links_inner> LeadFormUpdateRequest::getPolicyLinks() const
{
    return m_Policy_links;
}

void LeadFormUpdateRequest::setPolicyLinks(std::vector<LeadFormCommon_policy_links_inner> value)
{
...
void LeadFormUpdateRequest::setId(std::string value)
{
    m_Id = value;
}
...
std::vector<LeadFormUpdateRequest> createLeadFormUpdateRequestVectorFromJsonString(const std::string& json)
{
    ...
    auto vec = std::vector<LeadFormUpdateRequest>();
    for (const auto& child: pt) {
        vec.emplace_back(LeadFormUpdateRequest(child.second));
    }
