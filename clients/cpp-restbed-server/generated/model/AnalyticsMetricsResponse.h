...
public:
    ...
    /// </summary>
    std::vector<std::shared_ptr<AnalyticsMetricsResponse_daily_metrics>> getDailyMetrics() const;
    void setDailyMetrics(std::vector<std::shared_ptr<AnalyticsMetricsResponse_daily_metrics>> value);
