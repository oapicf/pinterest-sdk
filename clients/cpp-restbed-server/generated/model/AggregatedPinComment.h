...
public:
    ...
    explicit AggregatedPinComment(boost::property_tree::ptree const& pt);
    virtual ~AggregatedPinComment();

    AggregatedPinComment(const AggregatedPinComment& other) = default; // copy constructor
    AggregatedPinComment(AggregatedPinComment&& other) noexcept = default; // move constructor

    AggregatedPinComment& operator=(const AggregatedPinComment& other) = default; // copy assignment
    AggregatedPinComment& operator=(AggregatedPinComment&& other) noexcept = default; // move assignment
...
template<>
inline boost::property_tree::ptree toPt<AggregatedPinComment>(const AggregatedPinComment& val) {
    return val.toPropertyTree();
}

template<>
inline AggregatedPinComment fromPt<AggregatedPinComment>(const boost::property_tree::ptree& pt) {
    AggregatedPinComment ret;
