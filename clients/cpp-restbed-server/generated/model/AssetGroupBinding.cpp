...
void AssetGroupBinding::fromPropertyTree(ptree const &pt)
{
	...
	// push all items of Catalogs_ids into member
	if (pt.get_child_optional("catalogs_ids")) {
        m_Catalogs_ids = fromPt<std::vector<std::string>>(pt.get_child("catalogs_ids"));
	}
...
void AssetGroupBinding::setCatalogsIds(std::vector<std::string> value)
{
