...
std::vector<AdsAnalyticsTargetingType> TargetingTypeFilter::getTargetingTypes() const
{
    return m_Targeting_types;
}

void TargetingTypeFilter::setTargetingTypes(std::vector<AdsAnalyticsTargetingType> value)
{
