...
TemplateResponse::TemplateResponse(boost::property_tree::ptree const& pt)
{
        fromPropertyTree(pt);
}


std::string TemplateResponse::toJsonString(bool prettyJson /* = false */) const
{
	std::stringstream ss;
...
void TemplateResponse::fromJsonString(std::string const& jsonString)
{
...
ptree TemplateResponse::toPropertyTree() const
{
	ptree pt;
	ptree tmp_node;
	pt.put("id", m_Id);
	...
	pt.add_child("date_range", m_Date_range.toPropertyTree());
...
void TemplateResponse::fromPropertyTree(ptree const &pt)
{
	ptree tmp_node;
	m_Id = pt.get("id", "");
	...
	if (pt.get_child_optional("date_range")) {
        m_Date_range = fromPt<TemplateResponse_date_range>(pt.get_child("date_range"));
	}
	// push all items of Columns into member
	if (pt.get_child_optional("columns")) {
        m_Columns = fromPt<std::vector<std::string>>(pt.get_child("columns"));
	}
	...
	setConversionReportTimeType(pt.get("conversion_report_time_type", ""));
	...
	setCreationSource(pt.get("creation_source", ""));
	...
	if (pt.get_child_optional("ingestion_sources")) {
        m_Ingestion_sources = fromPt<std::vector<std::string>>(pt.get_child("ingestion_sources"));
	}
}
...
void TemplateResponse::setId(std::string value)
{
    m_Id = value;
}
...
void TemplateResponse::setAdAccountId(std::string value)
{
...
void TemplateResponse::setAdAccountIds(std::vector<std::string> value)
{
...
void TemplateResponse::setUserId(std::string value)
{
    m_User_id = value;
}
...
void TemplateResponse::setName(std::string value)
{
    m_Name = value;
}
...
TemplateResponse_date_range TemplateResponse::getDateRange() const
{
    return m_Date_range;
}

void TemplateResponse::setDateRange(TemplateResponse_date_range value)
{
    m_Date_range = value;
}


MetricsReportingLevel TemplateResponse::getReportLevel() const
{
    return m_Report_level;
}

void TemplateResponse::setReportLevel(MetricsReportingLevel value)
{
    m_Report_level = value;
}


DataOutputFormat TemplateResponse::getReportFormat() const
{
    return m_Report_format;
}

void TemplateResponse::setReportFormat(DataOutputFormat value)
{
...
void TemplateResponse::setColumns(std::vector<std::string> value)
{
    static const std::array<std::string, 1586> allowedValues = {
...
Granularity TemplateResponse::getGranularity() const
{
    return m_Granularity;
}

void TemplateResponse::setGranularity(Granularity value)
{
    m_Granularity = value;
}
...
void TemplateResponse::setConversionReportTimeType(std::string value)
{
...
void TemplateResponse::setFiltersJson(std::string value)
{
...
void TemplateResponse::setCreationSource(std::string value)
{
...
void TemplateResponse::setCustomColumnIds(std::vector<std::string> value)
{
...
void TemplateResponse::setType(std::string value)
{
...
void TemplateResponse::setIngestionSources(std::vector<std::string> value)
{
...
std::vector<TemplateResponse> createTemplateResponseVectorFromJsonString(const std::string& json)
{
    ...
    auto vec = std::vector<TemplateResponse>();
    for (const auto& child: pt) {
        vec.emplace_back(TemplateResponse(child.second));
    }
