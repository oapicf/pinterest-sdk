...
void TargetingSpec::setAGEBUCKET(std::vector<TargetingSpecAgeBucket> value)
{
    m_AGE_BUCKET = value;
}
...
void TargetingSpec::setAPPTYPE(std::vector<TargetingSpecAppType> value)
{
    m_APPTYPE = value;
}
...
void TargetingSpec::setGENDER(std::vector<TargetingSpecGender> value)
{
    m_GENDER = value;
}
...
void TargetingSpec::setSHOPPINGRETARGETING(std::vector<TargetingSpecShoppingRetargeting> value)
{
