...
public:
    ...
    /// </summary>
    std::vector<ConversionApiResponseEventsItems> getEvents() const;
    void setEvents(std::vector<ConversionApiResponseEventsItems> value);
...
protected:
    std::vector<ConversionApiResponseEventsItems> m_Events;
