...
public:
    ...
    ConversionEventsUserDataProperties(const ConversionEventsUserDataProperties& other) = default; // copy constructor
    ConversionEventsUserDataProperties(ConversionEventsUserDataProperties&& other) noexcept = default; // move constructor

    ConversionEventsUserDataProperties& operator=(const ConversionEventsUserDataProperties& other) = default; // copy assignment
    ConversionEventsUserDataProperties& operator=(ConversionEventsUserDataProperties&& other) noexcept = default; // move assignment
...
template<>
inline boost::property_tree::ptree toPt<ConversionEventsUserDataProperties>(const ConversionEventsUserDataProperties& val) {
    return val.toPropertyTree();
}

template<>
inline ConversionEventsUserDataProperties fromPt<ConversionEventsUserDataProperties>(const boost::property_tree::ptree& pt) {
    ConversionEventsUserDataProperties ret;
