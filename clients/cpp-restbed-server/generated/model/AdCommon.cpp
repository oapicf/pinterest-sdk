...
CustomizableCTAType AdCommon::getCustomizableCtaType() const
{
    return m_Customizable_cta_type;
}

void AdCommon::setCustomizableCtaType(CustomizableCTAType value)
{
...
DisclosureType AdCommon::getDisclosureType() const
{
    return m_Disclosure_type;
}

void AdCommon::setDisclosureType(DisclosureType value)
{
    m_Disclosure_type = value;
}


std::string AdCommon::getDisclosureUrl() const
{
    return m_Disclosure_url;
}

void AdCommon::setDisclosureUrl(std::string value)
{
