...
std::string CatalogsDbItem::toJsonString(bool prettyJson /* = false */) const
{
	std::stringstream ss;
...
ptree CatalogsDbItem::toPropertyTree() const
{
	ptree pt;
	ptree tmp_node;
...
void CatalogsDbItem::fromPropertyTree(ptree const &pt)
{
	ptree tmp_node;
