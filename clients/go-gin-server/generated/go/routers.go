...
type ApiHandleFunctions struct {
	...
	PinsAPI PinsAPI
	// Routes for the ProductCategoriesAPI part of the API
...
func getRoutes(handleFunctions ApiHandleFunctions) []Route {
	return []Route{ 
		...
		},
		{
			...
			handleFunctions.ProductCategoriesAPI.TrendsFeaturedTopicsList,
		},
		{
			"TrendsProductCategoriesDetailsList",
			http.MethodGet,
			"/v5/trends/product_categories/details",
			handleFunctions.ProductCategoriesAPI.TrendsProductCategoriesDetailsList,
		},
		{
			"TrendsProductCategoriesTrendingList",
			http.MethodGet,
			"/v5/trends/product_categories/trending",
			handleFunctions.ProductCategoriesAPI.TrendsProductCategoriesTrendingList,
		},
		{
