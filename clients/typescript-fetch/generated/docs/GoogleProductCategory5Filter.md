...
```typescript
import type { GoogleProductCategory5Filter } from ''

// TODO: Update the object below with actual values
const example = {
  "gOOGLEPRODUCTCATEGORY5": null,
} satisfies GoogleProductCategory5Filter
...
const exampleParsed = JSON.parse(exampleJSON) as GoogleProductCategory5Filter
