...
```typescript
import type { ScheduleBidOptionsPlacementMultipliers } from ''
...
const example = {
  ...
  "relatedPins": null,
  "search": null,
} satisfies ScheduleBidOptionsPlacementMultipliers
...
const exampleParsed = JSON.parse(exampleJSON) as ScheduleBidOptionsPlacementMultipliers
