...
```typescript
import type { AdAccountsAudiencesSharedAccountsList200Response } from ''
...
const exampleParsed = JSON.parse(exampleJSON) as AdAccountsAudiencesSharedAccountsList200Response
