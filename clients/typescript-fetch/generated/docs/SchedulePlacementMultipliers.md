...
```typescript
import type { SchedulePlacementMultipliers } from ''
...
const example = {
  ...
  "relatedPins": null,
  "search": null,
} satisfies SchedulePlacementMultipliers
...
const exampleParsed = JSON.parse(exampleJSON) as SchedulePlacementMultipliers
