...
```typescript
import type { BidOptionsPlacementMultipliers } from ''
...
const example = {
  ...
  "relatedPins": null,
  "search": null,
} satisfies BidOptionsPlacementMultipliers
...
const exampleParsed = JSON.parse(exampleJSON) as BidOptionsPlacementMultipliers
