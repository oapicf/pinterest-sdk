...
| [**feedsCreate**](CatalogFeedsApi.md#feedscreateoperation) | **POST** /catalogs/feeds | Create feed |
...
| [**feedsUpdate**](CatalogFeedsApi.md#feedsupdateoperation) | **PATCH** /catalogs/feeds/{feed_id} | Update feed |
...
async function example() {
  ...
  const api = new CatalogFeedsApi(config);
