...
```typescript
import type { AdAccountToAdAccountSharedAudience } from ''
...
} satisfies AdAccountToAdAccountSharedAudience
...
const exampleParsed = JSON.parse(exampleJSON) as AdAccountToAdAccountSharedAudience
