...
```typescript
import type { SsioInsertionOrdersStatusGetByAdAccount200Response } from ''
...
const exampleParsed = JSON.parse(exampleJSON) as SsioInsertionOrdersStatusGetByAdAccount200Response
