...
```typescript
import type { LocalInventoryUpdateOperation } from ''
...
const example = {
  ...
  "operation": null,
  "storeCode": store_1,
} satisfies LocalInventoryUpdateOperation
...
const exampleParsed = JSON.parse(exampleJSON) as LocalInventoryUpdateOperation
