...
```typescript
import type { ItemAttributesRequestAllOfImageLink } from ''

// TODO: Update the object below with actual values
const example = {
} satisfies ItemAttributesRequestAllOfImageLink
...
const exampleParsed = JSON.parse(exampleJSON) as ItemAttributesRequestAllOfImageLink
