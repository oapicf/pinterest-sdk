...
```typescript
import type { ProductGroupPromotionCreateRequestElement } from ''
...
const example = {
  ...
  "gridClickType": null,
  "creativeType": null,
} satisfies ProductGroupPromotionCreateRequestElement
...
const exampleParsed = JSON.parse(exampleJSON) as ProductGroupPromotionCreateRequestElement
