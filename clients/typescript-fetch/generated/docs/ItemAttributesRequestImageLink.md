...
```typescript
import type { ItemAttributesRequestImageLink } from ''

// TODO: Update the object below with actual values
const example = {
} satisfies ItemAttributesRequestImageLink
...
const exampleParsed = JSON.parse(exampleJSON) as ItemAttributesRequestImageLink
