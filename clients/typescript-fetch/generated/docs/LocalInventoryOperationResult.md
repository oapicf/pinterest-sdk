...
```typescript
import type { LocalInventoryOperationResult } from ''
...
const example = {
  ...
  "warnings": null,
} satisfies LocalInventoryOperationResult
...
const exampleParsed = JSON.parse(exampleJSON) as LocalInventoryOperationResult
