...
```typescript
import type { CatalogsCreateCreativeAssetsItem } from ''
...
const example = {
  ...
  "operation": null,
} satisfies CatalogsCreateCreativeAssetsItem
...
const exampleParsed = JSON.parse(exampleJSON) as CatalogsCreateCreativeAssetsItem
