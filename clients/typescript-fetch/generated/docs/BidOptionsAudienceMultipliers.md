...
```typescript
import type { BidOptionsAudienceMultipliers } from ''

// TODO: Update the object below with actual values
const example = {
  "audienceId": null,
  "multiplier": null,
} satisfies BidOptionsAudienceMultipliers
...
const exampleParsed = JSON.parse(exampleJSON) as BidOptionsAudienceMultipliers
