...
```typescript
import type { CatalogsRetailProductGroup } from ''
...
} satisfies CatalogsRetailProductGroup
...
const exampleParsed = JSON.parse(exampleJSON) as CatalogsRetailProductGroup
