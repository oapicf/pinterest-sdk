...
Name | Type
------------ | -------------
`aGEBUCKET` | [TargetingSpecAgeBucket](TargetingSpecAgeBucket.md)

## Example

```typescript
import type { AgeBucketMultipliers } from ''

// TODO: Update the object below with actual values
const example = {
  "aGEBUCKET": null,
} satisfies AgeBucketMultipliers
...
const exampleParsed = JSON.parse(exampleJSON) as AgeBucketMultipliers
