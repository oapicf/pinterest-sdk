...
```typescript
import type { AdvancedAuctionProcessedItem } from ''

// TODO: Update the object below with actual values
const example = {
  "errors": null,
} satisfies AdvancedAuctionProcessedItem
...
const exampleParsed = JSON.parse(exampleJSON) as AdvancedAuctionProcessedItem
