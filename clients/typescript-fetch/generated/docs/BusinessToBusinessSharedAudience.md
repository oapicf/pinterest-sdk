...
```typescript
import type { BusinessToBusinessSharedAudience } from ''
...
} satisfies BusinessToBusinessSharedAudience
...
const exampleParsed = JSON.parse(exampleJSON) as BusinessToBusinessSharedAudience
