...
```typescript
import type { TargetingTemplateUpdateRequestReadOrUpdate } from ''
...
} satisfies TargetingTemplateUpdateRequestReadOrUpdate
...
const exampleParsed = JSON.parse(exampleJSON) as TargetingTemplateUpdateRequestReadOrUpdate
