...
```typescript
import type { CustomerListUploadResponse } from ''
...
} satisfies CustomerListUploadResponse
...
const exampleParsed = JSON.parse(exampleJSON) as CustomerListUploadResponse
