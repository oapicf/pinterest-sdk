...
```typescript
import type { CreateAssetAccessRequestBodyAssetRequestsInner } from ''
...
const exampleParsed = JSON.parse(exampleJSON) as CreateAssetAccessRequestBodyAssetRequestsInner
