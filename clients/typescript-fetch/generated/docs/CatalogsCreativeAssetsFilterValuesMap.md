...
```typescript
import type { CatalogsCreativeAssetsFilterValuesMap } from ''
...
const example = {
  ...
  "mediaType": null,
} satisfies CatalogsCreativeAssetsFilterValuesMap
...
const exampleParsed = JSON.parse(exampleJSON) as CatalogsCreativeAssetsFilterValuesMap
