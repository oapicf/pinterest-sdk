...
```typescript
import type { AdvancedAuctionItemsSubmitRequest } from ''

// TODO: Update the object below with actual values
const example = {
  "catalogId": 2680059592705,
  "items": null,
} satisfies AdvancedAuctionItemsSubmitRequest
...
const exampleParsed = JSON.parse(exampleJSON) as AdvancedAuctionItemsSubmitRequest
