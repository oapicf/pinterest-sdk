...
```typescript
import type { ConversionEventsUserDataAnyOf2 } from ''
...
} satisfies ConversionEventsUserDataAnyOf2
...
const exampleParsed = JSON.parse(exampleJSON) as ConversionEventsUserDataAnyOf2
