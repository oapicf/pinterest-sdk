...
```typescript
import type { CatalogsFeedCreateRequestSchema } from ''
...
const example = {
  ...
  "status": null,
} satisfies CatalogsFeedCreateRequestSchema
...
const exampleParsed = JSON.parse(exampleJSON) as CatalogsFeedCreateRequestSchema
