...
```typescript
import type { ConversionEventsUserDataAnyOf } from ''
...
} satisfies ConversionEventsUserDataAnyOf
...
const exampleParsed = JSON.parse(exampleJSON) as ConversionEventsUserDataAnyOf
