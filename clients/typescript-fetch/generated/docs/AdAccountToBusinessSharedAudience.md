...
```typescript
import type { AdAccountToBusinessSharedAudience } from ''
...
} satisfies AdAccountToBusinessSharedAudience
...
const exampleParsed = JSON.parse(exampleJSON) as AdAccountToBusinessSharedAudience
