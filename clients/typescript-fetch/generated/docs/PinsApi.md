...
| **pinFilter** | `exclude_native`, `exclude_repins`, `has_been_promoted` | Pin filter. | [Optional] [Defaults to `undefined`] [Enum: exclude_native, exclude_repins, has_been_promoted] |
