...
```typescript
import type { GoogleProductCategory3Filter } from ''

// TODO: Update the object below with actual values
const example = {
  "gOOGLEPRODUCTCATEGORY3": null,
} satisfies GoogleProductCategory3Filter
...
const exampleParsed = JSON.parse(exampleJSON) as GoogleProductCategory3Filter
