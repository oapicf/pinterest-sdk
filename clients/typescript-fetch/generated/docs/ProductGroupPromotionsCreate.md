...
```typescript
import type { ProductGroupPromotionsCreate } from ''
...
} satisfies ProductGroupPromotionsCreate
...
const exampleParsed = JSON.parse(exampleJSON) as ProductGroupPromotionsCreate
