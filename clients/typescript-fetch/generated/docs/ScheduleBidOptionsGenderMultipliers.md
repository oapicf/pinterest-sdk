...
Name | Type
------------ | -------------
`gENDER` | [TargetingSpecGender](TargetingSpecGender.md)

## Example

```typescript
import type { ScheduleBidOptionsGenderMultipliers } from ''

// TODO: Update the object below with actual values
const example = {
  "gENDER": null,
} satisfies ScheduleBidOptionsGenderMultipliers
...
const exampleParsed = JSON.parse(exampleJSON) as ScheduleBidOptionsGenderMultipliers
