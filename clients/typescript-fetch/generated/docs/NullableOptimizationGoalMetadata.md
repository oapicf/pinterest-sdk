...
```typescript
import type { NullableOptimizationGoalMetadata } from ''
...
} satisfies NullableOptimizationGoalMetadata
...
const exampleParsed = JSON.parse(exampleJSON) as NullableOptimizationGoalMetadata
