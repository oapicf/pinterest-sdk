...
```typescript
import type { SupplementalItemsBatchResponse } from ''
...
const example = {
  ...
  "status": null,
} satisfies SupplementalItemsBatchResponse
...
const exampleParsed = JSON.parse(exampleJSON) as SupplementalItemsBatchResponse
