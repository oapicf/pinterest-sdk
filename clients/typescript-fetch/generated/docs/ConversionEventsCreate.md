...
Name | Type
------------ | -------------
`data` | [Array&lt;ConversionEventsDataItems&gt;](ConversionEventsDataItems.md)

## Example

```typescript
import type { ConversionEventsCreate } from ''
...
} satisfies ConversionEventsCreate
...
const exampleParsed = JSON.parse(exampleJSON) as ConversionEventsCreate
