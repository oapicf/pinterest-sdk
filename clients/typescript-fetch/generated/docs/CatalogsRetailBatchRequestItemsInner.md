...
```typescript
import type { CatalogsRetailBatchRequestItemsInner } from ''
...
} satisfies CatalogsRetailBatchRequestItemsInner
...
const exampleParsed = JSON.parse(exampleJSON) as CatalogsRetailBatchRequestItemsInner
