...
```typescript
import type { PinterestProductCategoriesFilter } from ''

// TODO: Update the object below with actual values
const example = {
  "pINTERESTPRODUCTCATEGORIES": null,
} satisfies PinterestProductCategoriesFilter
...
const exampleParsed = JSON.parse(exampleJSON) as PinterestProductCategoriesFilter
