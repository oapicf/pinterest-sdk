...
```typescript
import type { ConversionEventsUserDataProperties } from ''
...
} satisfies ConversionEventsUserDataProperties
...
const exampleParsed = JSON.parse(exampleJSON) as ConversionEventsUserDataProperties
