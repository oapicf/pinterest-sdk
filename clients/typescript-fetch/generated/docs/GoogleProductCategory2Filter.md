...
```typescript
import type { GoogleProductCategory2Filter } from ''

// TODO: Update the object below with actual values
const example = {
  "gOOGLEPRODUCTCATEGORY2": null,
} satisfies GoogleProductCategory2Filter
...
const exampleParsed = JSON.parse(exampleJSON) as GoogleProductCategory2Filter
