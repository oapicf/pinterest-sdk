...
```typescript
import type { RetailLocalInventoryItemAttributes } from ''
...
const example = {
  ...
  "price": 49.99 USD,
  "salePrice": 24.99 USD,
} satisfies RetailLocalInventoryItemAttributes
...
const exampleParsed = JSON.parse(exampleJSON) as RetailLocalInventoryItemAttributes
