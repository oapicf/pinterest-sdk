...
import {
    ...
    SearchUserPinsList200ResponseFromJSON,
    SearchUserPinsList200ResponseToJSON,
} from '../models/index';
...
export class SearchApi extends runtime.BaseAPI {
     ...
     * Search user\'s Pins
     */
    async searchUserPinsListRaw(requestParameters: SearchUserPinsListRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<SearchUserPinsList200Response>> {
        if (requestParameters['query'] == null) {
            throw new runtime.RequiredError(
                'query',
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => SearchUserPinsList200ResponseFromJSON(jsonValue));
    }
     ...
     * Search user\'s Pins
     */
    async searchUserPinsList(requestParameters: SearchUserPinsListRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<SearchUserPinsList200Response> {
