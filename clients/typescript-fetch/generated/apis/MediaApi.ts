...
export class MediaApi extends runtime.BaseAPI {
     ...
     */
    async mediaCreateRaw(requestParameters: MediaCreateRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<MediaUpload>> {
     ...
     * Register media upload
     */
    async mediaCreate(requestParameters: MediaCreateRequest, initOverrides?: RequestInit): Promise<MediaUpload> {
     ...
     */
    async mediaGetRaw(requestParameters: MediaGetRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<MediaUploadDetails>> {
     ...
     * Get media upload details
     */
    async mediaGet(requestParameters: MediaGetRequest, initOverrides?: RequestInit): Promise<MediaUploadDetails> {
     ...
     * List media uploads
     */
    async mediaListRaw(requestParameters: MediaListRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<Paginated & object>> {
        const queryParameters: any = {};
     ...
     * List media uploads
     */
    async mediaList(requestParameters: MediaListRequest = {}, initOverrides?: RequestInit): Promise<Paginated & object> {
