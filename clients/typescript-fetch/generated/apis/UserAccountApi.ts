...
export class UserAccountApi extends runtime.BaseAPI {
     ...
     */
    async websiteVerificationGetRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<UserWebsiteVerificationCode>> {
        const queryParameters: any = {};
     ...
     * Get user verification code for website claiming
     */
    async websiteVerificationGet(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<UserWebsiteVerificationCode> {
        const response = await this.websiteVerificationGetRaw(initOverrides);
        return await response.value();
    }
