...
export function instanceOfDataStatus(value: any): boolean {
    for (const key in DataStatus) {
        if (Object.prototype.hasOwnProperty.call(DataStatus, key)) {
            if (DataStatus[key as keyof typeof DataStatus] === value) {
                return true;
            }
        }
    }
...
export function DataStatusToJSONTyped(value: any, ignoreDiscriminator: boolean): DataStatus {
