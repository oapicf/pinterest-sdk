...
/**
 *     Optional for VISITOR `audience_type`.
...
export function EventDataToJSON(json: any): EventData {
    return EventDataToJSONTyped(json, false);
}

export function EventDataToJSONTyped(value?: EventData | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
