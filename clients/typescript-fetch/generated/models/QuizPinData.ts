...
import type { TieBreakerType } from './TieBreakerType';
import {
    TieBreakerTypeFromJSON,
    TieBreakerTypeFromJSONTyped,
    TieBreakerTypeToJSON,
    TieBreakerTypeToJSONTyped,
} from './TieBreakerType';
...
export function QuizPinDataFromJSONTyped(json: any, ignoreDiscriminator: boolean): QuizPinData {
    ...
    return {
        ...
        'tieBreakerCustomResult': json['tie_breaker_custom_result'] === undefined ? undefined : json['tie_breaker_custom_result'] === null ? null : QuizPinResultFromJSON(json['tie_breaker_custom_result']),
        'tieBreakerType': json['tie_breaker_type'] == null ? undefined : TieBreakerTypeFromJSON(json['tie_breaker_type']),
    };
}
...
export function QuizPinDataToJSONTyped(value?: QuizPinData | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'tie_breaker_type': TieBreakerTypeToJSON(value['tieBreakerType']),
    };
}
