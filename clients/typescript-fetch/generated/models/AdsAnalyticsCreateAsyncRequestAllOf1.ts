...
export function AdsAnalyticsCreateAsyncRequestAllOf1FromJSON(json: any): AdsAnalyticsCreateAsyncRequestAllOf1 {
    return AdsAnalyticsCreateAsyncRequestAllOf1FromJSONTyped(json, false);
}

export function AdsAnalyticsCreateAsyncRequestAllOf1FromJSONTyped(json: any, ignoreDiscriminator: boolean): AdsAnalyticsCreateAsyncRequestAllOf1 {
...
export function AdsAnalyticsCreateAsyncRequestAllOf1ToJSON(value?: AdsAnalyticsCreateAsyncRequestAllOf1 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
