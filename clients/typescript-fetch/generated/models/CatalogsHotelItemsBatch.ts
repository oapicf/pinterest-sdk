...
export function CatalogsHotelItemsBatchToJSONTyped(value?: Omit<CatalogsHotelItemsBatch, 'completed_time'|'created_time'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
