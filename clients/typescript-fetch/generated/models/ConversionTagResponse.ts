...
export function ConversionTagResponseToJSONTyped(value?: Omit<ConversionTagResponse, 'codeSnippet'|'configs'|'enhancedMatchStatus'|'id'|'lastFiredTimeMs'|'version'|'adAccountId'|'status'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
