...
export function CatalogsVerticalBatchRequestToJSONTyped(value?: CatalogsVerticalBatchRequest | null, ignoreDiscriminator: boolean = false): any {
    ...
    switch (value['catalogType']) {
        case 'CREATIVE_ASSETS':
            return Object.assign({}, CatalogsCreativeAssetsBatchRequestToJSON(value), { 'catalog_type': 'CREATIVE_ASSETS' } as const);
        case 'HOTEL':
            return Object.assign({}, CatalogsHotelBatchRequestToJSON(value), { 'catalog_type': 'HOTEL' } as const);
        case 'RETAIL':
            return Object.assign({}, CatalogsRetailBatchRequestToJSON(value), { 'catalog_type': 'RETAIL' } as const);
        default:
            return value;
    }
}
