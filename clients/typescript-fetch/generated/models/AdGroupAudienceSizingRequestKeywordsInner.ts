 ...
 */
export function instanceOfAdGroupAudienceSizingRequestKeywordsInner(value: object): boolean {
...
export function AdGroupAudienceSizingRequestKeywordsInnerToJSON(value?: AdGroupAudienceSizingRequestKeywordsInner | null): any {
    if (value == null) {
        return value;
    }
    return {
