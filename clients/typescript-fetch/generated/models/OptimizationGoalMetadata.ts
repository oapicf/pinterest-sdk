 ...
 */
export function instanceOfOptimizationGoalMetadata(value: object): boolean {
    return true;
}
...
export function OptimizationGoalMetadataToJSON(value?: OptimizationGoalMetadata | null): any {
    if (value == null) {
        return value;
    }
    return {
