...
export function BoardToJSONTyped(value?: Omit<Board, 'board_pins_modified_at'|'collaborator_count'|'created_at'|'follower_count'|'id'|'media'|'owner'|'pin_count'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
