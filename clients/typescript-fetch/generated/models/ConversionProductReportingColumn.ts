...
export type ConversionProductReportingColumn = typeof ConversionProductReportingColumn[keyof typeof ConversionProductReportingColumn];


export function instanceOfConversionProductReportingColumn(value: any): boolean {
    for (const key in ConversionProductReportingColumn) {
        if (Object.prototype.hasOwnProperty.call(ConversionProductReportingColumn, key)) {
            if (ConversionProductReportingColumn[key as keyof typeof ConversionProductReportingColumn] === value) {
                return true;
            }
        }
    }
...
export function ConversionProductReportingColumnFromJSON(json: any): ConversionProductReportingColumn {
    return ConversionProductReportingColumnFromJSONTyped(json, false);
}

export function ConversionProductReportingColumnFromJSONTyped(json: any, ignoreDiscriminator: boolean): ConversionProductReportingColumn {
    return json as ConversionProductReportingColumn;
}

export function ConversionProductReportingColumnToJSON(value?: ConversionProductReportingColumn | null): any {
    return value as any;
}

export function ConversionProductReportingColumnToJSONTyped(value: any, ignoreDiscriminator: boolean): ConversionProductReportingColumn {
    return value as ConversionProductReportingColumn;
}
