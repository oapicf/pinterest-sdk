 ...
 */
export function instanceOfCatalogsCreateHotelItem(value: object): boolean {
...
export function CatalogsCreateHotelItemToJSON(value?: CatalogsCreateHotelItem | null): any {
    if (value == null) {
        return value;
    }
    return {
