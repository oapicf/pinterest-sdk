 ...
 * @export
 */
export const AdGroupCreateRequestPromotionApplicationLevelEnum = {
    None: 'NONE',
    Item: 'ITEM',
    AdGroup: 'AD_GROUP'
} as const;
export type AdGroupCreateRequestPromotionApplicationLevelEnum = typeof AdGroupCreateRequestPromotionApplicationLevelEnum[keyof typeof AdGroupCreateRequestPromotionApplicationLevelEnum];


/**
 * Check if a given object implements the AdGroupCreateRequest interface.
 */
export function instanceOfAdGroupCreateRequest(value: object): value is AdGroupCreateRequest {
