 ...
 */
export function instanceOfCatalogsRetailItemResponse(value: object): boolean {
...
export function CatalogsRetailItemResponseToJSON(value?: CatalogsRetailItemResponse | null): any {
    if (value == null) {
        return value;
    }
    return {
