...
export function CatalogsRetailItemsBatchToJSONTyped(value?: Omit<CatalogsRetailItemsBatch, 'completed_time'|'created_time'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
