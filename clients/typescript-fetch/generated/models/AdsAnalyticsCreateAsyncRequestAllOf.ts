...
export function AdsAnalyticsCreateAsyncRequestAllOfFromJSON(json: any): AdsAnalyticsCreateAsyncRequestAllOf {
    return AdsAnalyticsCreateAsyncRequestAllOfFromJSONTyped(json, false);
}

export function AdsAnalyticsCreateAsyncRequestAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): AdsAnalyticsCreateAsyncRequestAllOf {
...
export function AdsAnalyticsCreateAsyncRequestAllOfToJSON(value?: AdsAnalyticsCreateAsyncRequestAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
