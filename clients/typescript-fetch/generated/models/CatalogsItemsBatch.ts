...
export function CatalogsItemsBatchToJSONTyped(value?: CatalogsItemsBatch | null, ignoreDiscriminator: boolean = false): any {
    ...
    switch (value['catalogType']) {
        case 'CREATIVE_ASSETS':
            return Object.assign({}, CatalogsCreativeAssetsItemsBatchToJSON(value), { 'catalog_type': 'CREATIVE_ASSETS' } as const);
        case 'HOTEL':
            return Object.assign({}, CatalogsHotelItemsBatchToJSON(value), { 'catalog_type': 'HOTEL' } as const);
        case 'RETAIL':
            return Object.assign({}, CatalogsRetailItemsBatchToJSON(value), { 'catalog_type': 'RETAIL' } as const);
        default:
            return value;
    }
}
