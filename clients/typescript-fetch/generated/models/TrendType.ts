...
export function instanceOfTrendType(value: any): boolean {
    for (const key in TrendType) {
        if (Object.prototype.hasOwnProperty.call(TrendType, key)) {
            if (TrendType[key as keyof typeof TrendType] === value) {
                return true;
            }
        }
    }
...
export function TrendTypeToJSONTyped(value: any, ignoreDiscriminator: boolean): TrendType {
    return value as TrendType;
}
