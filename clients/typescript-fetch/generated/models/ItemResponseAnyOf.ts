 ...
 * @export
 */
export type ItemResponseAnyOf = { catalogType: 'HOTEL' } & CatalogsHotelItemResponse | { catalogType: 'RETAIL' } & CatalogsRetailItemResponse;
...
export function ItemResponseAnyOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): ItemResponseAnyOf {
    ...
    switch (json['catalog_type']) {
        case 'HOTEL':
            return {...CatalogsHotelItemResponseFromJSONTyped(json, true), catalogType: 'HOTEL'};
        case 'RETAIL':
            return {...CatalogsRetailItemResponseFromJSONTyped(json, true), catalogType: 'RETAIL'};
        default:
