 ...
 */
export function instanceOfConversionEventResponse(value: object): boolean {
    return true;
}
...
export function ConversionEventResponseToJSON(value?: ConversionEventResponse | null): any {
    if (value == null) {
        return value;
    }
    return {
