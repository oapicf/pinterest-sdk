...
export function CatalogsCreativeAssetsItemsBatchToJSONTyped(value?: Omit<CatalogsCreativeAssetsItemsBatch, 'completed_time'|'created_time'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
