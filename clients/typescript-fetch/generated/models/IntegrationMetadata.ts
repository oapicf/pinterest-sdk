...
export function IntegrationMetadataToJSONTyped(value?: Omit<IntegrationMetadata, 'connected_advertiser_id'|'connected_user_id'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
