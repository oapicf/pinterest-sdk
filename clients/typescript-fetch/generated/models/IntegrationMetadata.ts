...
export function IntegrationMetadataToJSONTyped(value?: Omit<IntegrationMetadata, 'connectedUserId'|'createdTimestamp'|'id'|'updatedTimestamp'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
