...
import type { RelatedTermsRelatedTermsListItems } from './RelatedTermsRelatedTermsListItems';
import {
    RelatedTermsRelatedTermsListItemsFromJSON,
    RelatedTermsRelatedTermsListItemsFromJSONTyped,
    RelatedTermsRelatedTermsListItemsToJSON,
    RelatedTermsRelatedTermsListItemsToJSONTyped,
} from './RelatedTermsRelatedTermsListItems';
...
export function RelatedTermsFromJSONTyped(json: any, ignoreDiscriminator: boolean): RelatedTerms {
    ...
    return {
        ...
        'relatedTermsList': json['related_terms_list'] == null ? undefined : ((json['related_terms_list'] as Array<any>).map(RelatedTermsRelatedTermsListItemsFromJSON)),
    };
}
...
export function RelatedTermsToJSONTyped(value?: RelatedTerms | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'related_terms_list': value['relatedTermsList'] == null ? undefined : ((value['relatedTermsList'] as Array<any>).map(RelatedTermsRelatedTermsListItemsToJSON)),
    };
}
