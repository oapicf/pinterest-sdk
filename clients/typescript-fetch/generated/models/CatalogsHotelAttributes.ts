 ...
 */
export function instanceOfCatalogsHotelAttributes(value: object): boolean {
    return true;
}
...
export function CatalogsHotelAttributesToJSON(value?: CatalogsHotelAttributes | null): any {
    if (value == null) {
        return value;
    }
    return {
