...
export type CatalogsFeedProcessingScheduleTimezone = typeof CatalogsFeedProcessingScheduleTimezone[keyof typeof CatalogsFeedProcessingScheduleTimezone];


export function instanceOfCatalogsFeedProcessingScheduleTimezone(value: any): boolean {
    for (const key in CatalogsFeedProcessingScheduleTimezone) {
        if (Object.prototype.hasOwnProperty.call(CatalogsFeedProcessingScheduleTimezone, key)) {
            if (CatalogsFeedProcessingScheduleTimezone[key as keyof typeof CatalogsFeedProcessingScheduleTimezone] === value) {
                return true;
            }
        }
    }
...
export function CatalogsFeedProcessingScheduleTimezoneFromJSON(json: any): CatalogsFeedProcessingScheduleTimezone {
    return CatalogsFeedProcessingScheduleTimezoneFromJSONTyped(json, false);
}

export function CatalogsFeedProcessingScheduleTimezoneFromJSONTyped(json: any, ignoreDiscriminator: boolean): CatalogsFeedProcessingScheduleTimezone {
    return json as CatalogsFeedProcessingScheduleTimezone;
}

export function CatalogsFeedProcessingScheduleTimezoneToJSON(value?: CatalogsFeedProcessingScheduleTimezone | null): any {
    return value as any;
}

export function CatalogsFeedProcessingScheduleTimezoneToJSONTyped(value: any, ignoreDiscriminator: boolean): CatalogsFeedProcessingScheduleTimezone {
    return value as CatalogsFeedProcessingScheduleTimezone;
}
