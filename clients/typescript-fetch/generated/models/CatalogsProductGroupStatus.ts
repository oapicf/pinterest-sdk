...
export function instanceOfCatalogsProductGroupStatus(value: any): boolean {
    for (const key in CatalogsProductGroupStatus) {
        if (Object.prototype.hasOwnProperty.call(CatalogsProductGroupStatus, key)) {
            if (CatalogsProductGroupStatus[key as keyof typeof CatalogsProductGroupStatus] === value) {
                return true;
            }
        }
    }
...
export function CatalogsProductGroupStatusToJSONTyped(value: any, ignoreDiscriminator: boolean): CatalogsProductGroupStatus {
    return value as CatalogsProductGroupStatus;
}
