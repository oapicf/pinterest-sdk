 ...
 */
export function instanceOfCatalogsHotelProductGroupUpdateRequest(value: object): boolean {
    return true;
}
...
export function CatalogsHotelProductGroupUpdateRequestToJSON(value?: CatalogsHotelProductGroupUpdateRequest | null): any {
    if (value == null) {
        return value;
    }
    return {
