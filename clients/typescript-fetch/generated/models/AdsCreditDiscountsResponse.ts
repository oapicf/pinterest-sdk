 ...
 */
export function instanceOfAdsCreditDiscountsResponse(value: object): boolean {
    return true;
}
...
export function AdsCreditDiscountsResponseToJSON(value?: AdsCreditDiscountsResponse | null): any {
    if (value == null) {
        return value;
    }
    return {
