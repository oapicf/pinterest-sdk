 ...
 */
export function instanceOfIntegrationLogsInvalidLogResponse(value: object): boolean {
    return true;
}
...
export function IntegrationLogsInvalidLogResponseToJSON(value?: IntegrationLogsInvalidLogResponse | null): any {
    if (value == null) {
        return value;
    }
    return {
