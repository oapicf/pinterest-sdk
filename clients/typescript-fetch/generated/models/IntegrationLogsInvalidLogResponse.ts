...
import type { IntegrationLogsInvalidLogResponseRejectedLogsItems } from './IntegrationLogsInvalidLogResponseRejectedLogsItems';
import {
    IntegrationLogsInvalidLogResponseRejectedLogsItemsFromJSON,
    IntegrationLogsInvalidLogResponseRejectedLogsItemsFromJSONTyped,
    IntegrationLogsInvalidLogResponseRejectedLogsItemsToJSON,
    IntegrationLogsInvalidLogResponseRejectedLogsItemsToJSONTyped,
} from './IntegrationLogsInvalidLogResponseRejectedLogsItems';
...
export function IntegrationLogsInvalidLogResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): IntegrationLogsInvalidLogResponse {
    ...
    return {
        ...
        'rejectedLogs': json['rejected_logs'] == null ? undefined : ((json['rejected_logs'] as Array<any>).map(IntegrationLogsInvalidLogResponseRejectedLogsItemsFromJSON)),
    };
}
...
export function IntegrationLogsInvalidLogResponseToJSONTyped(value?: IntegrationLogsInvalidLogResponse | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'rejected_logs': value['rejectedLogs'] == null ? undefined : ((value['rejectedLogs'] as Array<any>).map(IntegrationLogsInvalidLogResponseRejectedLogsItemsToJSON)),
    };
}
