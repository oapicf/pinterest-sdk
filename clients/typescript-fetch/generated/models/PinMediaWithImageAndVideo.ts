...
export interface PinMediaWithImageAndVideo {
    ...
    /**
     * 
     * @type {PinMediaWithImageAndVideoMediaTypeEnum}
     * @memberof PinMediaWithImageAndVideo
     */
...
export function instanceOfPinMediaWithImageAndVideo(value: object): value is PinMediaWithImageAndVideo {
    ...
    if ((value as Record<string, any>)['mediaType'] !== 'multiple_mixed' && (value as Record<string, any>)['media_type'] !== 'multiple_mixed') return false;
