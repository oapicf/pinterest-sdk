...
export interface UserBusinessRoleBinding {
     ...
     * If is_shared_partner=TRUE, you can access the partner's business asset. If assets_summary is not empty, the assets listed are the partner's business assets you have access to.
     * @type {boolean}
     * @memberof UserBusinessRoleBinding
     */
...
export function UserBusinessRoleBindingFromJSONTyped(json: any, ignoreDiscriminator: boolean): UserBusinessRoleBinding {
    ...
    return {
        ...
        'assetsSummary': json['assets_summary'] === undefined ? undefined : json['assets_summary'] === null ? null : BusinessMemberAssetsSummaryFromJSON(json['assets_summary']),
        'businessRoles': json['business_roles'] == null ? undefined : json['business_roles'],
        'createdByBusiness': json['created_by_business'] === undefined ? undefined : json['created_by_business'] === null ? null : BusinessAccessUserSummaryFromJSON(json['created_by_business']),
        'createdByUser': json['created_by_user'] === undefined ? undefined : json['created_by_user'] === null ? null : BusinessAccessUserSummaryFromJSON(json['created_by_user']),
        ...
        'user': json['user'] === undefined ? undefined : json['user'] === null ? null : BusinessAccessUserSummaryFromJSON(json['user']),
    };
}
