 ...
 */
export function instanceOfCatalogsFeedProcessingSchedule(value: object): boolean {
...
export function CatalogsFeedProcessingScheduleToJSON(value?: CatalogsFeedProcessingSchedule | null): any {
    if (value == null) {
        return value;
    }
    return {
