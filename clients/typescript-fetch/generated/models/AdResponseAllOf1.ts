...
export function AdResponseAllOf1FromJSON(json: any): AdResponseAllOf1 {
    return AdResponseAllOf1FromJSONTyped(json, false);
}

export function AdResponseAllOf1FromJSONTyped(json: any, ignoreDiscriminator: boolean): AdResponseAllOf1 {
...
export function AdResponseAllOf1ToJSON(value?: AdResponseAllOf1 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
