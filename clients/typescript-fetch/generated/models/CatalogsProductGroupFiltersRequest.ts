 ...
 */
export function instanceOfCatalogsProductGroupFiltersRequest(value: object): boolean {
...
export function CatalogsProductGroupFiltersRequestToJSON(value?: CatalogsProductGroupFiltersRequest | null): any {
    if (value == null) {
        return value;
    }
    return {
