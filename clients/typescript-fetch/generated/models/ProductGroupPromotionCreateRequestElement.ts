...
/**
 * Check if a given object implements the ProductGroupPromotionCreateRequestElement interface.
 */
export function instanceOfProductGroupPromotionCreateRequestElement(value: object): value is ProductGroupPromotionCreateRequestElement {
    return true;
}

export function ProductGroupPromotionCreateRequestElementFromJSON(json: any): ProductGroupPromotionCreateRequestElement {
    return ProductGroupPromotionCreateRequestElementFromJSONTyped(json, false);
}

export function ProductGroupPromotionCreateRequestElementFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProductGroupPromotionCreateRequestElement {
    if (json == null) {
        return json;
    }
    return {
