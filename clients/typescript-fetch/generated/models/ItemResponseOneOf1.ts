 ...
 * @export
 */
export type ItemResponseOneOf1 = { catalogType: 'CREATIVE_ASSETS' } & CatalogsCreativeAssetsItemErrorResponse | { catalogType: 'HOTEL' } & CatalogsHotelItemErrorResponse | { catalogType: 'RETAIL' } & CatalogsRetailItemErrorResponse;

export function ItemResponseOneOf1FromJSON(json: any): ItemResponseOneOf1 {
    return ItemResponseOneOf1FromJSONTyped(json, false);
}

export function ItemResponseOneOf1FromJSONTyped(json: any, ignoreDiscriminator: boolean): ItemResponseOneOf1 {
    if (json == null) {
        return json;
    }
...
export function ItemResponseOneOf1ToJSON(json: any): any {
    return ItemResponseOneOf1ToJSONTyped(json, false);
}

export function ItemResponseOneOf1ToJSONTyped(value?: ItemResponseOneOf1 | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    switch (value['catalogType']) {
        case 'CREATIVE_ASSETS':
            return Object.assign({}, CatalogsCreativeAssetsItemErrorResponseToJSON(value), { catalogType: 'CREATIVE_ASSETS' } as const);
        case 'HOTEL':
            return Object.assign({}, CatalogsHotelItemErrorResponseToJSON(value), { catalogType: 'HOTEL' } as const);
        case 'RETAIL':
            return Object.assign({}, CatalogsRetailItemErrorResponseToJSON(value), { catalogType: 'RETAIL' } as const);
        default:
            return value;
    }
}
