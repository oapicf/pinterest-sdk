...
export function CatalogsVerticalProductGroupUpdateRequestToJSONTyped(value?: CatalogsVerticalProductGroupUpdateRequest | null, ignoreDiscriminator: boolean = false): any {
    ...
    switch (value['catalogType']) {
        case 'CREATIVE_ASSETS':
            return Object.assign({}, CatalogsCreativeAssetsProductGroupUpdateRequestToJSON(value), { 'catalog_type': 'CREATIVE_ASSETS' } as const);
        case 'HOTEL':
            return Object.assign({}, CatalogsHotelProductGroupUpdateRequestToJSON(value), { 'catalog_type': 'HOTEL' } as const);
        case 'RETAIL':
            return Object.assign({}, CatalogsRetailProductGroupUpdateRequestToJSON(value), { 'catalog_type': 'RETAIL' } as const);
        default:
            return value;
    }
}
