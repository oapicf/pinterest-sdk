...
export function AnalyticsMetricsResponseDailyMetricsFromJSON(json: any): AnalyticsMetricsResponseDailyMetrics {
    return AnalyticsMetricsResponseDailyMetricsFromJSONTyped(json, false);
}

export function AnalyticsMetricsResponseDailyMetricsFromJSONTyped(json: any, ignoreDiscriminator: boolean): AnalyticsMetricsResponseDailyMetrics {
...
export function AnalyticsMetricsResponseDailyMetricsToJSON(value?: AnalyticsMetricsResponseDailyMetrics | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
