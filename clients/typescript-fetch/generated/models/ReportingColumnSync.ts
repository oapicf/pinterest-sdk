...
export function instanceOfReportingColumnSync(value: any): boolean {
    for (const key in ReportingColumnSync) {
        if (Object.prototype.hasOwnProperty.call(ReportingColumnSync, key)) {
            if (ReportingColumnSync[key as keyof typeof ReportingColumnSync] === value) {
                return true;
            }
        }
    }
...
export function ReportingColumnSyncFromJSON(json: any): ReportingColumnSync {
    return ReportingColumnSyncFromJSONTyped(json, false);
}

export function ReportingColumnSyncFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReportingColumnSync {
    return json as ReportingColumnSync;
}

export function ReportingColumnSyncToJSON(value?: ReportingColumnSync | null): any {
    return value as any;
}

export function ReportingColumnSyncToJSONTyped(value: any, ignoreDiscriminator: boolean): ReportingColumnSync {
    return value as ReportingColumnSync;
}
