...
export function ConversionTagCommonToJSONTyped(value?: Omit<ConversionTagCommon, 'code_snippet'|'configs'|'enhanced_match_status'|'id'|'last_fired_time_ms'|'version'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
