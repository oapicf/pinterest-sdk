 ...
 */
export function instanceOfCatalogsHotelProductGroupFiltersAnyOf(value: object): boolean {
...
export function CatalogsHotelProductGroupFiltersAnyOfToJSON(value?: CatalogsHotelProductGroupFiltersAnyOf | null): any {
    if (value == null) {
        return value;
    }
    return {
