 ...
 */
export function instanceOfCatalogsUpdatableHotelAttributes(value: object): boolean {
    return true;
}
...
export function CatalogsUpdatableHotelAttributesToJSON(value?: CatalogsUpdatableHotelAttributes | null): any {
    if (value == null) {
        return value;
    }
    return {
