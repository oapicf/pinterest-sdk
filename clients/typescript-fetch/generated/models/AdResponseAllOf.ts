...
export function AdResponseAllOfFromJSON(json: any): AdResponseAllOf {
    return AdResponseAllOfFromJSONTyped(json, false);
}

export function AdResponseAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): AdResponseAllOf {
...
export function AdResponseAllOfToJSON(value?: AdResponseAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
