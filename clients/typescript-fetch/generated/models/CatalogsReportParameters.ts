...
export function CatalogsReportParametersToJSONTyped(value?: CatalogsReportParameters | null, ignoreDiscriminator: boolean = false): any {
    ...
    switch (value['catalogType']) {
        case 'HOTEL':
            return Object.assign({}, CatalogsHotelReportParametersToJSON(value), { 'catalog_type': 'HOTEL' } as const);
        case 'RETAIL':
            return Object.assign({}, CatalogsRetailReportParametersToJSON(value), { 'catalog_type': 'RETAIL' } as const);
        default:
            return value;
    }
}
