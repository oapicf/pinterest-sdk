...
export function CatalogsVerticalsListProductsByCatalogBasedFilterRequestToJSONTyped(value?: CatalogsVerticalsListProductsByCatalogBasedFilterRequest | null, ignoreDiscriminator: boolean = false): any {
    ...
    switch (value['catalogType']) {
        case 'CREATIVE_ASSETS':
            return Object.assign({}, CatalogsCreativeAssetsListProductsByCatalogBasedFilterRequestToJSON(value), { 'catalog_type': 'CREATIVE_ASSETS' } as const);
        case 'HOTEL':
            return Object.assign({}, CatalogsHotelListProductsByCatalogBasedFilterRequestToJSON(value), { 'catalog_type': 'HOTEL' } as const);
        case 'RETAIL':
            return Object.assign({}, CatalogsRetailListProductsByCatalogBasedFilterRequestToJSON(value), { 'catalog_type': 'RETAIL' } as const);
        default:
            return value;
    }
}
