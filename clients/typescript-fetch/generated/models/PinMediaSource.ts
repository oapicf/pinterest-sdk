...
export function PinMediaSourceToJSONTyped(value?: PinMediaSource | null, ignoreDiscriminator: boolean = false): any {
    ...
    switch (value['sourceType']) {
        case 'image_base64':
            return Object.assign({}, PinMediaSourceImageBase64ToJSON(value), { 'source_type': 'image_base64' } as const);
        case 'image_url':
            return Object.assign({}, PinMediaSourceImageURLToJSON(value), { 'source_type': 'image_url' } as const);
        case 'multiple_image_base64':
            return Object.assign({}, PinMediaSourceImagesBase64ToJSON(value), { 'source_type': 'multiple_image_base64' } as const);
        case 'multiple_image_urls':
            return Object.assign({}, PinMediaSourceImagesURLToJSON(value), { 'source_type': 'multiple_image_urls' } as const);
        case 'pin_url':
            return Object.assign({}, PinMediaSourcePinURLToJSON(value), { 'source_type': 'pin_url' } as const);
        case 'video_id':
            return Object.assign({}, PinMediaSourceVideoIDToJSON(value), { 'source_type': 'video_id' } as const);
        default:
            return value;
    }
}
