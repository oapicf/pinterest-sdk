...
import {
     ...
     OauthAccessTokenResponseEverlastingRefreshFromJSONTyped,
     OauthAccessTokenResponseIntegrationRefreshFromJSONTyped,
...
export function OauthAccessTokenResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): OauthAccessTokenResponse {
    ...
    if (!ignoreDiscriminator) {
        ...
        if (json['response_type'] === 'everlasting_refresh') {
            return OauthAccessTokenResponseEverlastingRefreshFromJSONTyped(json, true);
        }
        if (json['response_type'] === 'integration_refresh') {
            return OauthAccessTokenResponseIntegrationRefreshFromJSONTyped(json, true);
        }
