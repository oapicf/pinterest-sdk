 ...
 */
export function instanceOfCreateMMMReportRequest(value: object): boolean {
    ...
    if (!('targetingTypes' in value)) return false;
...
export function CreateMMMReportRequestToJSON(value?: CreateMMMReportRequest | null): any {
    if (value == null) {
        return value;
    }
    return {
