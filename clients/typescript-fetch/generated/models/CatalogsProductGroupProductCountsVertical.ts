...
export function CatalogsProductGroupProductCountsVerticalToJSON(json: any): any {
    return CatalogsProductGroupProductCountsVerticalToJSONTyped(json, false);
}

export function CatalogsProductGroupProductCountsVerticalToJSONTyped(value?: CatalogsProductGroupProductCountsVertical | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    switch (value['catalogType']) {
        case 'CREATIVE_ASSETS':
            return Object.assign({}, CatalogsCreativeAssetsProductGroupProductCountsToJSON(value), { 'catalog_type': 'CREATIVE_ASSETS' } as const);
        case 'HOTEL':
            return Object.assign({}, CatalogsHotelProductGroupProductCountsToJSON(value), { 'catalog_type': 'HOTEL' } as const);
        case 'RETAIL':
            return Object.assign({}, CatalogsRetailProductGroupProductCountsToJSON(value), { 'catalog_type': 'RETAIL' } as const);
        default:
            return value;
    }
}
