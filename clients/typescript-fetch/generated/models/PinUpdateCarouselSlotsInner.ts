 ...
 */
export function instanceOfPinUpdateCarouselSlotsInner(value: object): boolean {
    return true;
}
...
export function PinUpdateCarouselSlotsInnerToJSON(value?: PinUpdateCarouselSlotsInner | null): any {
    if (value == null) {
        return value;
    }
    return {
