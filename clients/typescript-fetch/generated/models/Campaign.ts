...
export function CampaignToJSONTyped(value?: Omit<Campaign, 'createdTime'|'isCarting'|'summaryStatus'|'type'|'updatedTime'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
