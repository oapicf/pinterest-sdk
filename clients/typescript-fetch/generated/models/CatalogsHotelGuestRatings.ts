...
export function CatalogsHotelGuestRatingsFromJSONTyped(json: any, ignoreDiscriminator: boolean): CatalogsHotelGuestRatings {
    ...
    return {
        ...
        'maxScore': json['max_score'] === undefined ? undefined : json['max_score'] === null ? null : json['max_score'],
        'numberOfReviewers': json['number_of_reviewers'] === undefined ? undefined : json['number_of_reviewers'] === null ? null : json['number_of_reviewers'],
        'ratingSystem': json['rating_system'] === undefined ? undefined : json['rating_system'] === null ? null : json['rating_system'],
        'score': json['score'] === undefined ? undefined : json['score'] === null ? null : json['score'],
    };
}
