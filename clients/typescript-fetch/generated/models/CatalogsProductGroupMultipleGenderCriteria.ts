 ...
 */
export function instanceOfCatalogsProductGroupMultipleGenderCriteria(value: object): boolean {
...
export function CatalogsProductGroupMultipleGenderCriteriaToJSON(value?: CatalogsProductGroupMultipleGenderCriteria | null): any {
    if (value == null) {
        return value;
    }
    return {
