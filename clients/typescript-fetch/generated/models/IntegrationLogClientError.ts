 ...
 */
export function instanceOfIntegrationLogClientError(value: object): boolean {
    return true;
}
...
export function IntegrationLogClientErrorToJSON(value?: IntegrationLogClientError | null): any {
    if (value == null) {
        return value;
    }
    return {
