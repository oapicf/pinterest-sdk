...
export interface ConversionEventsDataInner {
     ...
     */
    eventName: ConversionEventsDataInnerEventNameEnum;
    /**
     * The source indicating where the conversion event occurred.
     * @type {string}
     * @memberof ConversionEventsDataInner
     */
    actionSource: ConversionEventsDataInnerActionSourceEnum;
    /**
 ...
 * @export
 */
export const ConversionEventsDataInnerEventNameEnum = {
...
export type ConversionEventsDataInnerEventNameEnum = typeof ConversionEventsDataInnerEventNameEnum[keyof typeof ConversionEventsDataInnerEventNameEnum];

/**
 * @export
 */
export const ConversionEventsDataInnerActionSourceEnum = {
    AppAndroid: 'app_android',
    AppIos: 'app_ios',
    Web: 'web',
    Offline: 'offline'
} as const;
export type ConversionEventsDataInnerActionSourceEnum = typeof ConversionEventsDataInnerActionSourceEnum[keyof typeof ConversionEventsDataInnerActionSourceEnum];
