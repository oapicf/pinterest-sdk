 ...
 */
export function instanceOfGoogleProductCategory2Filter(value: object): boolean {
...
export function GoogleProductCategory2FilterToJSON(value?: GoogleProductCategory2Filter | null): any {
    if (value == null) {
        return value;
    }
    return {
