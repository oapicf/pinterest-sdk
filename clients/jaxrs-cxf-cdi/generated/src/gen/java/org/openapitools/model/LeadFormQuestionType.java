...
public enum LeadFormQuestionType {
    ...
    @JsonProperty("CUSTOM") CUSTOM(String.valueOf("CUSTOM")), @JsonProperty("FULL_NAME") FULL_NAME(String.valueOf("FULL_NAME")), @JsonProperty("FIRST_NAME") FIRST_NAME(String.valueOf("FIRST_NAME")), @JsonProperty("LAST_NAME") LAST_NAME(String.valueOf("LAST_NAME")), @JsonProperty("EMAIL") EMAIL(String.valueOf("EMAIL")), @JsonProperty("PHONE_NUMBER") PHONE_NUMBER(String.valueOf("PHONE_NUMBER")), @JsonProperty("ZIP_CODE") ZIP_CODE(String.valueOf("ZIP_CODE")), @JsonProperty("GENDER") GENDER(String.valueOf("GENDER")), @JsonProperty("CITY") CITY(String.valueOf("CITY")), @JsonProperty("COUNTRY") COUNTRY(String.valueOf("COUNTRY")), @JsonProperty("STATE_PROVINCE") STATE_PROVINCE(String.valueOf("STATE_PROVINCE")), @JsonProperty("ADDRESS") ADDRESS(String.valueOf("ADDRESS")), @JsonProperty("DATE_OF_BIRTH") DATE_OF_BIRTH(String.valueOf("DATE_OF_BIRTH")), @JsonProperty("AGE") AGE(String.valueOf("AGE"));
