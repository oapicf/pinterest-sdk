...
public enum CustomizableCtaTypeEnum {
    ...
    @JsonProperty("SHOP_NOW") SHOP_NOW(String.valueOf("SHOP_NOW")), @JsonProperty("BOOK_NOW") BOOK_NOW(String.valueOf("BOOK_NOW")), @JsonProperty("ON_SALE") ON_SALE(String.valueOf("ON_SALE")), @JsonProperty("GET_DEAL") GET_DEAL(String.valueOf("GET_DEAL")), @JsonProperty("BUY_ONLINE_PICKUP_IN_STORE") BUY_ONLINE_PICKUP_IN_STORE(String.valueOf("BUY_ONLINE_PICKUP_IN_STORE"));
