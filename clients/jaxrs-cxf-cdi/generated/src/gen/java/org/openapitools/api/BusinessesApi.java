...
public class BusinessesApi  {
  ...
  @Inject BusinessesApiService delegate;
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error", response = Error.class) })
    public Response businessAssetMembersGet( @Pattern(regexp="^\\d+$") @Size(min=1,max=20)@ApiParam(value = "Unique identifier of the requesting business.",required=true) @PathParam("business_id") String businessId,  @Pattern(regexp="^\\d+$") @Size(min=1,max=20)@ApiParam(value = "Unique identifier of a business asset.",required=true) @PathParam("asset_id") String assetId, @ApiParam(value = "Fetches system users if True. Fetches regular user employees if False.", defaultValue="false") @DefaultValue("false")  @QueryParam("fetch_system_users") Boolean fetchSystemUsers, @ApiParam(value = "Cursor used to fetch the next page of items")  @QueryParam("bookmark") String bookmark,  @Min(1) @Max(250)@ApiParam(value = "Maximum number of items to include in a single page of the response. See documentation on <a href='/docs/reference/pagination/'>Pagination</a> for more information.", defaultValue="25") @DefaultValue("25")  @QueryParam("page_size") Integer pageSize,  @Min(0)@ApiParam(value = "An index to start fetching the results from. Only the results starting from this index will be returned.", defaultValue="0") @DefaultValue("0")  @QueryParam("start_index") Integer startIndex) {
        return delegate.businessAssetMembersGet(businessId, assetId, fetchSystemUsers, bookmark, pageSize, startIndex, securityContext);
    }
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error", response = Error.class) })
    public Response businessMemberAssetsGet( @Pattern(regexp="^\\d+$") @Size(min=1,max=20)@ApiParam(value = "Unique identifier of the requesting business.",required=true) @PathParam("business_id") String businessId,  @Pattern(regexp="^\\d+$") @Size(min=1,max=20)@ApiParam(value = "The member id to fetch assets for.",required=true) @PathParam("member_id") String memberId, @ApiParam(value = "A resource type to filter the assets by. Only assets of the specified type will be returned.", allowableValues="AD_ACCOUNT, PROFILE, ASSET_GROUP, CATALOG, CONSUMER", defaultValue="AD_ACCOUNT") @DefaultValue("AD_ACCOUNT")  @QueryParam("asset_type") String assetType,  @Min(0)@ApiParam(value = "An index to start fetching the results from. Only the results starting from this index will be returned.", defaultValue="0") @DefaultValue("0")  @QueryParam("start_index") Integer startIndex, @ApiParam(value = "Cursor used to fetch the next page of items")  @QueryParam("bookmark") String bookmark,  @Min(1) @Max(250)@ApiParam(value = "Maximum number of items to include in a single page of the response. See documentation on <a href='/docs/reference/pagination/'>Pagination</a> for more information.", defaultValue="25") @DefaultValue("25")  @QueryParam("page_size") Integer pageSize) {
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error", response = Error.class) })
    public Response cancelInvitesOrRequests( @Pattern(regexp="^\\d+$") @Size(min=1)@ApiParam(value = "Unique identifier of the requesting business.",required=true) @PathParam("business_id") String businessId, @ApiParam(value = "A list with invite ids" ,required=true) CancelInvitesBody cancelInvitesBody) {
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 400, message = "Invalid parameters.", response = Error.class),
        @ApiResponse(code = 200, message = "Unexpected error", response = Error.class) })
    public Response systemUserUpdate( @Pattern(regexp="^\\d+$") @Size(min=1,max=20)@ApiParam(value = "Unique identifier of the requesting business.",required=true) @PathParam("business_id") String businessId,  @Pattern(regexp="^\\d+$") @Size(min=1,max=20)@ApiParam(value = "Unique identifier of a system user.",required=true) @PathParam("system_user_id") String systemUserId, @ApiParam(value = "" ,required=true) SystemUserUpdateRequest systemUserUpdateRequest) {
        return delegate.systemUserUpdate(businessId, systemUserId, systemUserUpdateRequest, securityContext);
    }
