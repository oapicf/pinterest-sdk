...
public enum AvailabilityEnum {
    ...
    @JsonProperty("IN_STOCK") IN_STOCK(String.valueOf("IN_STOCK")), @JsonProperty("OUT_OF_STOCK") OUT_OF_STOCK(String.valueOf("OUT_OF_STOCK")), @JsonProperty("PREORDER") PREORDER(String.valueOf("PREORDER")), @JsonProperty("UNAVAILABLE") UNAVAILABLE(String.valueOf("UNAVAILABLE"));
