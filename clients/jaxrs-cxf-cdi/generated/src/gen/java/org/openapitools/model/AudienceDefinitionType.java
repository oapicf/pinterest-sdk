...
public enum ScopeEnum {
    ...
    @JsonProperty("IMPRESSION_PLUS_ENGAGEMENT") IMPRESSION_PLUS_ENGAGEMENT(String.valueOf("IMPRESSION_PLUS_ENGAGEMENT")), @JsonProperty("ENGAGEMENT") ENGAGEMENT(String.valueOf("ENGAGEMENT"));
