...
public interface ConversionDeletionRequestsApi  {
    ...
    ConversionDeletionRequest conversionDeletionRequestCreate(@PathParam("ad_account_id") String adAccountId, ConversionDeletionRequestCreate conversionDeletionRequestCreate) throws ApiException, ProcessingException;
    ...
    @Path("/{request_id}")
    @Produces({ "application/json" })
    ConversionDeletionRequest conversionDeletionRequestDelete(@PathParam("request_id") String requestId, @PathParam("ad_account_id") String adAccountId) throws ApiException, ProcessingException;
