...
|------------ | ------------- | ------------- | -------------|
|**createdTime** | **LocalDate** | Timestamp when the conversion deletion request was succesfully created. |  [readonly] |
|**processedTime** | **LocalDate** | Timestamp when the conversion deletion request was processed. |  [optional] [readonly] |
