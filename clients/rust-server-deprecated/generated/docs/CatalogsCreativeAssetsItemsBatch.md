...
**created_time** | [**chrono::DateTime::<chrono::Utc>**](DateTime.md) | Date and time (UTC) of the batch creation: YYYY-MM-DD'T'hh:mm:ss | [optional] [default to None]
**items** | [**Vec<models::CreativeAssetsProcessingRecord>**](CreativeAssetsProcessingRecord.md) | Array with the catalogs items processing records part of the catalogs items batch | [optional] [default to None]
