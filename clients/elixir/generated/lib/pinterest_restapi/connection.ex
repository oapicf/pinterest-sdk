...
defmodule PinterestRESTAPI.Connection do
  @moduledoc """
  Handle Tesla connections for PinterestRESTAPI.

  Additional middleware can be set in the compile-time or runtime configuration:

      config :tesla, PinterestRESTAPI.Connection,
        base_url: "https://api.pinterest.com/v5",
        adapter: Tesla.Adapter.Hackney

  The default base URL can also be set as:

      config :pinterest_restapi,
        :base_url, "https://api.pinterest.com/v5"
  """
  ...
  @doc """
  Configure a PinterestRESTAPI client.

  ### Parameters

  - `options`: an optional keyword list of PinterestRESTAPI.Connection.options.
  ...
  def middleware(options \\ []) do
    base_url =
      Keyword.get(
        options,
        :base_url,
        Application.get_env(:pinterest_restapi, :base_url, @default_base_url)
      )
    ...
    user_agent =
      Keyword.get(
        ...
        Keyword.get(
          tesla_options,
          :user_agent,
          "openapi-generator - PinterestRESTAPI 1.0.0 - elixir"
        )
      )
