...
[**analyticsCreateConversionProductReportWithHttpInfo**](AdAccountsApi.md#analyticsCreateConversionProductReportWithHttpInfo) | **POST** /ad_accounts/{ad_account_id}/reports/brand_category_sku | Create a request for a brand, category, SKU report
...
[**analyticsGetConversionProductReportWithHttpInfo**](AdAccountsApi.md#analyticsGetConversionProductReportWithHttpInfo) | **GET** /ad_accounts/{ad_account_id}/reports/brand_category_sku | Get advertiser brand, category, SKU report
...
> adAccountAnalytics(adAccountAnalyticsRequest): ApiRequest[Seq[AdAccountAnalyticsItems]]
...
object Example extends App {
    ...
    val request = apiInstance.adAccountAnalytics(startDate, endDate, columns, granularity, adAccountId, clickWindowDays, engagementWindowDays, viewWindowDays, conversionReportTime, reportingTimezone)
...
ApiRequest[[**Seq[AdAccountAnalyticsItems]**](AdAccountAnalyticsItems.md)]
...
object Example extends App {
    ...
    val targetingTypes: Seq[AdsAnalyticsAccountTargetingType] =  // Seq[AdsAnalyticsAccountTargetingType] | Targeting type breakdowns for the report. The reporting per targeting type is independent from each other. [\"AGE_BUCKET_AND_GENDER\"] is in BETA and not yet available to all users.
    ...
    val request = apiInstance.adAccountTargetingAnalyticsGet(adAccountId, startDate, endDate, targetingTypes, columns, granularity, clickWindowDays, engagementWindowDays, viewWindowDays, conversionReportTime, attributionTypes, reportingTimezone)
    val response = apiInvoker.execute(request)
 ...
 **startDate** | **LocalDate**| Metric report start date (UTC). Format: YYYY-MM-DD. Cannot be more than 90 days back from today. |
 **endDate** | **LocalDate**| Metric report end date (UTC). Format: YYYY-MM-DD. Cannot be more than 90 days past start_date. |
 **targetingTypes** | [**Seq[AdsAnalyticsAccountTargetingType]**](AdsAnalyticsAccountTargetingType.md)| Targeting type breakdowns for the report. The reporting per targeting type is independent from each other. [\&quot;AGE_BUCKET_AND_GENDER\&quot;] is in BETA and not yet available to all users. |
 **columns** | [**Seq[ReportingColumnSync]**](ReportingColumnSync.md)| Columns to retrieve, encoded as a comma-separated string. **NOTE**: Any metrics defined as MICRO_DOLLARS returns a value based on the advertiser profile&#39;s currency field. For USD, ($1/1,000,000, or $0.000001 - one one-ten-thousandth of a cent). it&#39;s microdollars. Otherwise, it&#39;s in microunits of the advertiser&#39;s currency.  For example, if the advertiser&#39;s currency is GBP (British pound sterling), all MICRO_DOLLARS fields will be in GBP microunits (1/1,000,000 British pound).  If a column has no value, it may not be returned. |
 **granularity** | [**Granularity**](.md)|   TOTAL - metrics are aggregated over the specified date range.    DAY - metrics are broken down daily.    HOUR - metrics are broken down hourly.    WEEK - metrics are broken down weekly.    MONTH - metrics are broken down monthly | [enum: TOTAL, DAY, HOUR, WEEK, MONTH]
 **clickWindowDays** | **BigDecimal**| Number of days to use as the conversion attribution window for a pin click action. Applies to Pinterest Tag conversion metrics. Prior conversion tags use their defined attribution windows. If not specified, defaults to &#x60;30&#x60; days. | [optional] [enum: 0, 1, 7, 14, 30, 60]
 **engagementWindowDays** | **BigDecimal**| Number of days to use as the conversion attribution window for an engagement action. Engagements include saves, closeups, link clicks, and carousel card swipes. Applies to Pinterest Tag conversion metrics. Prior conversion tags use their defined attribution windows. If not specified, defaults to &#x60;30&#x60; days. **Note:** This parameter no longer returns new data. However, you can still access historic data through **Sept 30, 2027**. | [optional] [enum: 0, 1, 7, 14, 30, 60]
...
object Example extends App {
    ...
    val request = apiInstance.adAccountsCreate(adAccountCreate)
    val response = apiInvoker.execute(request)
...
> adAccountsGet(adAccountsGetRequest): ApiRequest[AdAccount]
...
object Example extends App {
    ...
    val request = apiInstance.adAccountsList(includeSharedAccounts, bookmark, pageSize)
    val response = apiInvoker.execute(request)
...
> analyticsCreateConversionProductReport(analyticsCreateConversionProductReportRequest): ApiRequest[ConversionProductReport]
...
object Example extends App {
    ...
    val request = apiInstance.analyticsCreateConversionProductReport(adAccountId, conversionProductReportCreate)
    val response = apiInvoker.execute(request)
...
ApiRequest[[**ConversionProductReport**](ConversionProductReport.md)]
...
> analyticsCreateMmmReport(analyticsCreateMmmReportRequest): ApiRequest[MMMReport]
...
object Example extends App {
    ...
    val request = apiInstance.analyticsCreateMmmReport(adAccountId, mMMReportCreate)
    val response = apiInvoker.execute(request)
...
ApiRequest[[**MMMReport**](MMMReport.md)]
...
> analyticsCreateTemplateReport(analyticsCreateTemplateReportRequest): ApiRequest[TemplateBasedReport]
...
ApiRequest[[**TemplateBasedReport**](TemplateBasedReport.md)]
...
> analyticsGetConversionProductReport(analyticsGetConversionProductReportRequest): ApiRequest[ConversionProductReport]
...
object Example extends App {
    ...
    val request = apiInstance.analyticsGetConversionProductReport(adAccountId, token)
    val response = apiInvoker.execute(request)
...
> analyticsGetMmmReport(analyticsGetMmmReportRequest): ApiRequest[MMMReport]
...
> templatesList(templatesListRequest): ApiRequest[TemplatesList200Response]
...
object Example extends App {
    ...
    val request = apiInstance.templatesList(adAccountId, bookmark, pageSize, order)
    val response = apiInvoker.execute(request)
