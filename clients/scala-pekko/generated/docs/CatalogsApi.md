...
[**catalogsAvailableFilterValuesWithHttpInfo**](CatalogsApi.md#catalogsAvailableFilterValuesWithHttpInfo) | **GET** /catalogs/available_filter_values | List available filter values
...
> catalogsAvailableFilterValues(catalogsAvailableFilterValuesRequest): ApiRequest[CatalogsAvailableFilterValues]
...
object Example extends App {
    ...
    val catalogId: String = catalogId_example // String | Filter entities for a given catalog_id.
    ...
    val request = apiInstance.catalogsAvailableFilterValues(catalogId, feedId, country, language, adAccountId)
...
ApiRequest[[**CatalogsAvailableFilterValues**](CatalogsAvailableFilterValues.md)]
...
object Example extends App {
    ...
    val request = apiInstance.catalogsCreate(catalogCreate, adAccountId)
    val response = apiInvoker.execute(request)
...
object Example extends App {
    ...
    val request = apiInstance.catalogsList(adAccountId, bookmark, pageSize)
    val response = apiInvoker.execute(request)
