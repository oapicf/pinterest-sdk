...
**dcaAssets** | **AnyType** | [DCA] The Dynamic creative assets to use for DCA. Dynamic Creative Assembly (DCA) accepts basic creative assets of an ad (image, video, title, call to action, logo etc). Then it automatically generates optimized ad combinations based on these assets. |  [optional] [readonly]
...
**localInventoryRadiusInMiles** | **BigDecimal** | The targeting radius of the local inventory ads in miles. |  [optional]
