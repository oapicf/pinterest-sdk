...
case class CatalogsItemsBatchPostRequest (
  ...
  catalogType: CatalogsItemsBatchPostRequestEnums.CatalogType,
  country: Country,
  /* Array with catalogs items */
  items: Seq[ItemDeleteBatchRecord],
  /* We recommend using the CatalogsLocale values. */
  language: CatalogsItemsBatchPostRequestEnums.Language,
  operation: CatalogsItemsBatchPostRequestEnums.Operation
) extends ApiModel

object CatalogsItemsBatchPostRequestEnums {
