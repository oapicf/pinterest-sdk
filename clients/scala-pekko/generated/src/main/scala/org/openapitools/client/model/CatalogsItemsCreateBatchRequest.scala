...
case class CatalogsItemsCreateBatchRequest (
  ...
  language: CatalogsItemsCreateBatchRequestEnums.Language,
  operation: CatalogsItemsCreateBatchRequestEnums.Operation
) extends ApiModel

object CatalogsItemsCreateBatchRequestEnums {
