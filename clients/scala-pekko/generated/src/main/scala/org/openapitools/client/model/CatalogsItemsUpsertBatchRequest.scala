...
case class CatalogsItemsUpsertBatchRequest (
  ...
  language: CatalogsItemsUpsertBatchRequestEnums.Language,
  operation: CatalogsItemsUpsertBatchRequestEnums.Operation
) extends ApiModel

object CatalogsItemsUpsertBatchRequestEnums {
