...
case class CatalogsItemsUpdateBatchRequest (
  ...
  language: CatalogsItemsUpdateBatchRequestEnums.Language,
  operation: CatalogsItemsUpdateBatchRequestEnums.Operation
) extends ApiModel

object CatalogsItemsUpdateBatchRequestEnums {
