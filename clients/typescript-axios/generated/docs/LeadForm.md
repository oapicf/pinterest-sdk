...
------------ | ------------- | ------------- | -------------
**ad_account_id** | **string** | The Ad Account ID that this lead form belongs to. | [optional] [readonly] [default to undefined]
...
**created_time** | **number** | Lead form creation time. Unix timestamp in seconds. | [optional] [readonly] [default to undefined]
...
```typescript
import { LeadForm } from './api';

const instance: LeadForm = {
    ad_account_id,
    completion_message,
    created_time,
    disclosure_language,
