...
**invite_type** | **string** | The type of invite. - \&#39;MEMBER_INVITE\&#39; is to invite a member to access your business assets. - \&#39;PARTNER_INVITE\&#39; is to invite a partner to access your business assets. - \&#39;PARTNER_REQUEST\&#39; is to request access a partner\&#39;s business assets. | [optional] [default to undefined]
...
```typescript
import { InviteDataResponse } from './api';

const instance: InviteDataResponse = {
    invite_expiration,
    invite_status,
    invite_type,
    last_updated_time,
