...
**status** | [**EventProcessingStatus**](EventProcessingStatus.md) | Whether the event was processed successfully. | [default to undefined]
...
```typescript
import { ConversionApiResponseEventsItems } from './api';

const instance: ConversionApiResponseEventsItems = {
    error_message,
    status,
    warning_message,
};
