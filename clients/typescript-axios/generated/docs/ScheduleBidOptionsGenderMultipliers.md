...
------------ | ------------- | ------------- | -------------
**GENDER** | [**TargetingSpecGender**](TargetingSpecGender.md) |  | [optional] [default to undefined]

## Example

```typescript
import { ScheduleBidOptionsGenderMultipliers } from './api';

const instance: ScheduleBidOptionsGenderMultipliers = {
    GENDER,
};
```
