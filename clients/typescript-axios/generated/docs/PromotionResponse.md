...
**ad_account_id** | **string** | The Ad Account ID that this promotion belongs to. | [optional] [default to undefined]
**id** | **string** | Promotion ID | [optional] [default to undefined]
