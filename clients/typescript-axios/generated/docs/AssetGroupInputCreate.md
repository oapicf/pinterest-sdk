...
------------ | ------------- | ------------- | -------------
**asset_group** | [**AssetGroupBinding**](AssetGroupBinding.md) |  | [optional] [default to undefined]
...
```typescript
import { AssetGroupInputCreate } from './api';

const instance: AssetGroupInputCreate = {
    asset_group,
