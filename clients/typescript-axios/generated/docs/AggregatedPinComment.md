...
**is_product** | **boolean** | Whether the Pin is a product Pin. | [optional] [readonly] [default to undefined]
...
```typescript
import { AggregatedPinComment } from './api';

const instance: AggregatedPinComment = {
    ai_disclosures,
    alt_text,
    board_id,
    board_owner,
