...
------------ | ------------- | ------------- | -------------
**GENDER** | [**TargetingSpecGender**](TargetingSpecGender.md) | Gender identifier. | [optional] [default to undefined]

## Example

```typescript
import { GenderMultipliers } from './api';

const instance: GenderMultipliers = {
    GENDER,
};
```
