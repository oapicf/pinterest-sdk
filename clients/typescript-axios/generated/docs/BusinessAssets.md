...
**catalog_info** | [**CatalogBinding**](CatalogBinding.md) | An object containing all the information specific to the provided catalog. This field will be populated only if asset_type equals \&#39;CATALOG\&#39;. | [optional] [default to undefined]

## Example

```typescript
import { BusinessAssets } from './api';

const instance: BusinessAssets = {
    asset_group_info,
    asset_id,
    asset_type,
    permissions,
