...
------------ | ------------- | ------------- | -------------
**AGE_BUCKET** | [**TargetingSpecAgeBucket**](TargetingSpecAgeBucket.md) | Age bucket identifier. | [optional] [default to undefined]

## Example

```typescript
import { AgeBucketMultipliers } from './api';

const instance: AgeBucketMultipliers = {
    AGE_BUCKET,
};
```
