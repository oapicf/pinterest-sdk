...
------------ | ------------- | ------------- | -------------
**AUDIENCE_ID** | **string** | Audience ID for the multiplier. | [optional] [default to undefined]

## Example

```typescript
import { CampaignAudienceMultipliers } from './api';

const instance: CampaignAudienceMultipliers = {
    AUDIENCE_ID,
};
```
