...
------------ | ------------- | ------------- | -------------
**ad_account_id** | **string** | The Ad Account ID that this promotion belongs to. | [readonly] [default to undefined]
**discount_status** | [**DiscountStatus**](DiscountStatus.md) |  | [optional] [default to undefined]
...
**id** | **string** | Promotion ID | [default to undefined]
...
**promotion_title** | **string** | Internal name for the promotion. | [default to undefined]
**promotion_type** | [**PromotionType**](PromotionType.md) |  | [default to undefined]
