...
**list_type** | [**UserListType**](UserListType.md) | Type of customer list (e.g., EMAIL, IDFA, MAID). | [optional] [default to undefined]
...
```typescript
import { CustomerListCreate } from './api';

const instance: CustomerListCreate = {
    is_nca,
    list_type,
    name,
    records,
