...
**id** | **string** | The ID of this lead form | [optional] [default to undefined]
**ad_account_id** | **string** | The Ad Account ID that this lead form belongs to. | [optional] [default to undefined]
**created_time** | **number** | Lead form creation time. Unix timestamp in seconds. | [optional] [default to undefined]
**updated_time** | **number** | Last update time. Unix timestamp in seconds. | [optional] [default to undefined]

## Example

```typescript
import { LeadFormResponse } from './api';

const instance: LeadFormResponse = {
    name,
    privacy_policy_link,
    has_accepted_terms,
    completion_message,
