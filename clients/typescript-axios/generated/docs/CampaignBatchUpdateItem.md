...
------------ | ------------- | ------------- | -------------
**ad_account_id** | **string** | Setting this field does nothing. The ad account ID gets set from the path parameter. | [optional] [default to undefined]
**app_id** | **string** | [Closed beta](/docs/getting-started/using-beta-and-restricted-features/)  The store ID of the mobile app for &#x60;APP_INSTALL&#x60; campaigns. | [optional] [default to undefined]
**app_platform** | [**MobileAppPlatform**](MobileAppPlatform.md) | [Closed beta](/docs/getting-started/using-beta-and-restricted-features/)  Platform of the mobile app for &#x60;APP_INSTALL&#x60; campaigns. | [optional] [default to undefined]
**bid_options** | [**CampaignBidOptionsUpdate**](CampaignBidOptionsUpdate.md) | Object describing an update to the campaign level bid multipliers. | [optional] [default to undefined]
...
**default_ad_group_budget_in_micro_currency** | **number** | Setting this field does nothing. | [optional] [default to undefined]
...
**id** | **string** | Campaign ID, must be associated with the ad account ID provided in the path. | [default to undefined]
...
**objective_type** | [**ConversionObjectiveType**](ConversionObjectiveType.md) |  | [optional] [default to undefined]
...
```typescript
import { CampaignBatchUpdateItem } from './api';

const instance: CampaignBatchUpdateItem = {
    ad_account_id,
    app_id,
    app_platform,
    bid_options,
