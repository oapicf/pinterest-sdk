...
------------ | ------------- | ------------- | -------------
**APP_TYPE** | [**TargetingSpecAppType**](TargetingSpecAppType.md) |  | [optional] [default to undefined]

## Example

```typescript
import { ScheduleAppTypeMultipliers } from './api';

const instance: ScheduleAppTypeMultipliers = {
    APP_TYPE,
};
```
