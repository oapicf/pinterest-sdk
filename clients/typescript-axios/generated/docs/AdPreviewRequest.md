...
**creative_type** | **string** | Ad format of the shopping ad preview. | [default to undefined]
...
**preferred_media_type** | **string** | Preferred media type. | [optional] [default to undefined]
**video_tag** | **string** | Multi video template tag, image_tag and video_tag are mutual exclusive. | [optional] [default to undefined]

## Example

```typescript
import { AdPreviewRequest } from './api';

const instance: AdPreviewRequest = {
    image_url,
    title,
    pin_id,
