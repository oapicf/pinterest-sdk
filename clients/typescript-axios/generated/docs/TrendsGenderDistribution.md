...
------------ | ------------- | ------------- | -------------
**gender_distribution** | [**TrendsGender**](TrendsGender.md) |  | [optional] [default to undefined]

## Example

```typescript
import { TrendsGenderDistribution } from './api';

const instance: TrendsGenderDistribution = {
    gender_distribution,
};
```
