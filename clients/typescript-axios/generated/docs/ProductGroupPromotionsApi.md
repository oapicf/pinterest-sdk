...
let productGroupPromotionCreateRequest: ProductGroupPromotionCreateRequest; //List of Product Group Promotions to create, size limit [1, 30].
...
let adAccountId: string; //Unique identifier of an ad account. (default to undefined)
let productGroupPromotionUpdateRequest: ProductGroupPromotionUpdateRequest; //Parameters to update Product group promotions
