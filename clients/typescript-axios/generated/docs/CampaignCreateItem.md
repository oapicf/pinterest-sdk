...
**name** | **string** | Campaign name - 255 chars max. | [default to undefined]
**objective_type** | [**ConversionObjectiveType**](ConversionObjectiveType.md) |  | [default to undefined]
...
```typescript
import { CampaignCreateItem } from './api';

const instance: CampaignCreateItem = {
    ad_account_id,
    app_id,
    app_platform,
    bid_options,
