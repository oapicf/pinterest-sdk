...
------------ | ------------- | ------------- | -------------
**attributes** | [**RetailLocalInventoryItemAttributesOptional**](RetailLocalInventoryItemAttributesOptional.md) |  | [default to undefined]
...
```typescript
import { LocalInventoryUpdateOperation } from './api';

const instance: LocalInventoryUpdateOperation = {
    attributes,
    item_id,
    operation,
    store_code,
