...
------------ | ------------- | ------------- | -------------
**id** | **string** | The id of a product. We recommend using this if you are a merchant for AddToCart and Checkouts. For detail, please check &lt;a href&#x3D;\&quot;https://help.pinterest.com/en/business/article/before-you-get-started-with-catalogs\&quot; target&#x3D;\&quot;_blank\&quot;&gt;here&lt;/a&gt; (Install the Pinterest tag section). | [optional] [default to undefined]
...
**quantity** | **number** | The amount of a product. We recommend using this if you are a merchant for AddToCart and Checkouts. For detail, please check &lt;a href&#x3D;\&quot;https://help.pinterest.com/en/business/article/before-you-get-started-with-catalogs\&quot; target&#x3D;\&quot;_blank\&quot;&gt;here&lt;/a&gt; (Install the Pinterest tag section). | [optional] [default to undefined]

## Example

```typescript
import { ConversionEventsDataInnerCustomDataContentsInner } from './api';

const instance: ConversionEventsDataInnerCustomDataContentsInner = {
    id,
    item_brand,
    item_category,
    item_name,
