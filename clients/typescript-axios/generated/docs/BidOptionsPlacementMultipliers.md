...
------------ | ------------- | ------------- | -------------
**browse** | **number** |  | [optional] [default to undefined]
**related_pins** | **number** |  | [optional] [default to undefined]
**search** | **number** |  | [optional] [default to undefined]

## Example

```typescript
import { BidOptionsPlacementMultipliers } from './api';

const instance: BidOptionsPlacementMultipliers = {
    browse,
    related_pins,
    search,
};
