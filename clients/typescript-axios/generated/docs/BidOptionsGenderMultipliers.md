...
------------ | ------------- | ------------- | -------------
**female** | **number** |  | [optional] [default to undefined]
**male** | **number** |  | [optional] [default to undefined]

## Example

```typescript
import { BidOptionsGenderMultipliers } from './api';

const instance: BidOptionsGenderMultipliers = {
    female,
    male,
};
```
