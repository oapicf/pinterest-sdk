...
------------ | ------------- | ------------- | -------------
**reach_estimate** | [**TargetingTemplateAudienceSizingReachEstimate**](TargetingTemplateAudienceSizingReachEstimate.md) |  | [optional] [default to undefined]

## Example

```typescript
import { TargetingTemplateAudienceSizing } from './api';

const instance: TargetingTemplateAudienceSizing = {
    reach_estimate,
};
```
