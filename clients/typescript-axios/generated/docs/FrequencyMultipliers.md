...
------------ | ------------- | ------------- | -------------
**IMPRESSION_COUNT** | **string** | Impression count identifier. | [optional] [default to undefined]

## Example

```typescript
import { FrequencyMultipliers } from './api';

const instance: FrequencyMultipliers = {
    IMPRESSION_COUNT,
};
```
