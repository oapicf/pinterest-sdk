...
data class TargetingSpecOperationGender (
    @SerializedName("`field`") private val _`field`: TargetingSpecOperationGender.&#x60;Field&#x60;?,
    @SerializedName("operation") private val _operation: TargetingSpecListOperation?,
    @SerializedName("propertyValues") private val _propertyValues: kotlin.Array<TargetingSpecGender>?
) {
