...
interface TrendsApi  {
    ...
    suspend fun trendsEditorialArticlesList(region:ProductCategoryRegion?,context:OperationRequest):Response<kotlin.Array<TrendsEditorial>>
    ...
    companion object {
        const val address = "TrendsApi-service"
        suspend fun createRouterFactory(vertx: Vertx,path:String): io.vertx.ext.web.api.contract.openapi3.OpenAPI3RouterFactory {
            ...
            for (m in TrendsApi::class.java.methods) {
            ...
            routerFactory.mountServiceInterface(TrendsApi::class.java, address)
