...
class PromotionsApiVertxProxyHandler(private val vertx: Vertx, private val service: PromotionsApi, topLevel: Boolean, private val timeoutSeconds: Long) : ProxyHandler() {
