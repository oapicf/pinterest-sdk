...
interface KeywordsApi  {
    ...
    /* keywordsGet
     * Get keywords */
    suspend fun keywordsGet(adAccountId:kotlin.String?,campaignId:kotlin.String?,adGroupId:kotlin.String?,adGroupIds:kotlin.Array<kotlin.String>?,matchTypes:kotlin.Array<MatchType>?,pageSize:kotlin.Int?,bookmark:kotlin.String?,context:OperationRequest):Response<KeywordsGet200Response>
    /* keywordsUpdate
     * Update keywords */
    ...
    suspend fun trendingKeywordsList(region:TrendsSupportedRegion?,trendType:TrendType?,interests:kotlin.Array<kotlin.String>?,genders:kotlin.Array<kotlin.String>?,ages:kotlin.Array<kotlin.String>?,includeKeywords:kotlin.Array<kotlin.String>?,normalizeAgainstGroup:kotlin.Boolean?,limit:kotlin.Int?,includePrediction:kotlin.Boolean?,includeDemographics:kotlin.Boolean?,context:OperationRequest):Response<TrendingKeywordsResponse>
    companion object {
