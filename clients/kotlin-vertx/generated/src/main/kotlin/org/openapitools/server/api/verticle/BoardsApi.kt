...
interface BoardsApi  {
    ...
    /* boardsListPins
     * List Pins on board */
    suspend fun boardsListPins(boardId:kotlin.String?,bookmark:kotlin.String?,pageSize:kotlin.Int?,creativeTypes:kotlin.Array<CreativeType>?,adAccountId:kotlin.String?,pinMetrics:kotlin.Boolean?,context:OperationRequest):Response<BoardsListPins200Response>
    /* boardsUpdate
     * Update board */
