...
interface UserAccountApi  {
    ...
    suspend fun userAccountAnalytics(startDate:java.time.LocalDate?,endDate:java.time.LocalDate?,fromClaimedContent:kotlin.String?,pinFormat:kotlin.String?,appTypes:kotlin.String?,metricTypes:kotlin.Array<kotlin.String>?,splitField:kotlin.String?,adAccountId:kotlin.String?,context:OperationRequest):Response<kotlin.collections.Map<kotlin.String, AnalyticsMetricsResponse>>
    /* userAccountGet
     * Get user account */
