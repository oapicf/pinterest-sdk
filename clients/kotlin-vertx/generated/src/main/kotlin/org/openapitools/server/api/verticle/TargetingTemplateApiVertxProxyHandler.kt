        ...
        try {
            ...
            when (action) {
                ...
                "targetingTemplateCreate" -> {
                    ...
                    val targetingTemplateCreateParam = ApiHandlerUtils.searchJsonObjectInJson(params,"body")
                    if (targetingTemplateCreateParam == null) {
                        throw IllegalArgumentException("targetingTemplateCreate is required")
                    }
                    val targetingTemplateCreate = Gson().fromJson(targetingTemplateCreateParam.encode(), TargetingTemplateCreate::class.java)
                    GlobalScope.launch(vertx.dispatcher()){
                        val result = service.targetingTemplateCreate(adAccountId,targetingTemplateCreate,context)
