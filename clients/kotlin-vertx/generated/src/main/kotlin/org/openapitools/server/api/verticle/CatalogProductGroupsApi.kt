...
interface CatalogProductGroupsApi  {
    ...
    suspend fun catalogsProductGroupPinsList(productGroupId:kotlin.String?,adAccountId:kotlin.String?,pinMetrics:kotlin.Boolean?,bookmark:kotlin.String?,pageSize:kotlin.Int?,context:OperationRequest):Response<CatalogsProductGroupPinsList200Response>
    /* catalogsProductGroupsCreate
     * Create product group */
    suspend fun catalogsProductGroupsCreate(catalogsProductGroupsCreateRequestSchema:CatalogsProductGroupsCreateRequestSchema?,adAccountId:kotlin.String?,context:OperationRequest):Response<CatalogsVerticalProductGroup>
    /* catalogsProductGroupsCreateMany
     * Create product groups */
    suspend fun catalogsProductGroupsCreateMany(catalogsProductGroupsCreateManyRequestItems:kotlin.Array<CatalogsProductGroupsCreateManyRequestItems>?,adAccountId:kotlin.String?,context:OperationRequest):Response<kotlin.Array<kotlin.String>>
    /* catalogsProductGroupsDelete
     * Delete product group */
    suspend fun catalogsProductGroupsDelete(productGroupId:kotlin.String?,adAccountId:kotlin.String?,context:OperationRequest):Response<CatalogsVerticalProductGroup>
     ...
     * List product groups */
    suspend fun catalogsProductGroupsList(id:kotlin.Array<kotlin.Int>?,feedId:kotlin.String?,catalogId:kotlin.String?,adAccountId:kotlin.String?,bookmark:kotlin.String?,pageSize:kotlin.Int?,context:OperationRequest):Response<CatalogsProductGroupsList200Response>
    ...
    suspend fun catalogsProductGroupsUpdate(productGroupId:kotlin.String?,catalogsProductGroupsUpdateRequestSchema:CatalogsProductGroupsUpdateRequestSchema?,adAccountId:kotlin.String?,context:OperationRequest):Response<CatalogsVerticalProductGroup>
