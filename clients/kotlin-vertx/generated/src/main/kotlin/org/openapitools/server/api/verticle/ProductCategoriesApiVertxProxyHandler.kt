...
class ProductCategoriesApiVertxProxyHandler(private val vertx: Vertx, private val service: ProductCategoriesApi, topLevel: Boolean, private val timeoutSeconds: Long) : ProxyHandler() {
