...
data class BidOptionsAudienceMultipliers (
    ...
    @SerializedName("multiplier") private val _multiplier: java.math.BigDecimal?
) {

        val audienceId get() = _audienceId ?: throw IllegalArgumentException("audienceId is required")
                    
        val multiplier get() = _multiplier ?: throw IllegalArgumentException("multiplier is required")
