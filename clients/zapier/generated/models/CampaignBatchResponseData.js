...
const NullableEntityStatus = require('../models/NullableEntityStatus');
    ...
    fields: (prefix = '', isInput = true, isArrayChild = false) => {
        ...
        return [
            ...
            },
            {
                ...
                label: `Whether the campaign contains a carting(where-to-buy link) ad. - [${labelPrefix}is_carting]`,
                type: 'boolean',
            },
            {
            ...
            },
            {
                ...
                ...CampaignObjectiveType.fields(`${keyPrefix}objective_type`, isInput),
            },
            {
            ...
            },
            {
                ...
                ...NullableEntityStatus.fields(`${keyPrefix}status`, isInput),
            },
            {
