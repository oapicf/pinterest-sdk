...
const AudienceObjectiveType = require('../models/AudienceObjectiveType');
...
module.exports = {
    fields: (prefix = '', isInput = true, isArrayChild = false) => {
        ...
        return [
            ...
            },
            {
                ...
                list: true,
                type: 'string',
                ...AudienceObjectiveType.fields(`${keyPrefix}objective_type`, isInput),
            },
            {
    ...
    mapping: (bundle, prefix = '') => {
        ...
        return {
            ...
            'objective_type': utils.childMapping(bundle.inputData?.[`${keyPrefix}objective_type`], `${keyPrefix}objective_type`, AudienceObjectiveType),
