...
const ConversionEventsDataItemsCustomDataContentsItems = require('../models/ConversionEventsDataItemsCustomDataContentsItems');
...
module.exports = {
    fields: (prefix = '', isInput = true, isArrayChild = false) => {
        ...
        return [
            ...
            },
            {
                ...
                label: `List of products IDs. We recommend using this if you are a merchant for PageVisit, AddToCart and Checkouts. For detail, please check [here](https://help.pinterest.com/en/business/article/before-you-get-started-with-catalogs) (Install the Pinterest tag section). - [${labelPrefix}content_ids]`,
                list: true,
                type: 'string',
            },
            {
            ...
            },
            {
                ...
                children: ConversionEventsDataItemsCustomDataContentsItems.fields(`${keyPrefix}contents${!isInput ? '[]' : ''}`, isInput, true), 
            },
            {
            ...
            },
            {
                ...
                label: `Total number of products of the event. For example, the total number of items purchased in a checkout event. We recommend using this if you are a merchant for AddToCart and Checkouts. For detail, please check [here](https://help.pinterest.com/en/business/article/before-you-get-started-with-catalogs) (Install the Pinterest tag section). - [${labelPrefix}num_items]`,
                type: 'number',
            },
            {
                key: `${keyPrefix}opt_out_type`,
                label: `Flags for different privacy rights laws to opt out users of sharing personal information. Separate values with commas. See the Help Center article about [limited data processing](https://help.pinterest.com/en/business/article/limited-data-processing) and the developer's guide for [tracking conversion events](/docs/track-conversions/track-conversions-in-the-api/#whether-the-user-has-opted-out-of-web-or-offline-conversion-events) for help with using this parameter. - [${labelPrefix}opt_out_type]`,
                type: 'string',
            },
            {
    ...
    mapping: (bundle, prefix = '') => {
        ...
        return {
            ...
            'contents': utils.childMapping(bundle.inputData?.[`${keyPrefix}contents`], `${keyPrefix}contents`, ConversionEventsDataItemsCustomDataContentsItems),
