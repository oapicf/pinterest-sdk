...
const ItemAttributesRequestImageLink = require('../models/ItemAttributesRequestImageLink');
...
module.exports = {
    fields: (prefix = '', isInput = true, isArrayChild = false) => {
        ...
        return [
            ...
            ...ItemAttributesRequestImageLink.fields(`${keyPrefix}image_link`, isInput),
            {
            ...
            },
            {
                ...
                label: `<= 2,000 characters Hosted link to the product video. File types for linked videos must be .mp4, .mov or .m4v. File size cannot exceed 2GB. - [${labelPrefix}video_link]`,
                type: 'string',
            },
        ]
    },
    mapping: (bundle, prefix = '') => {
        ...
        return {
            ...
            'image_link': utils.removeIfEmpty(ItemAttributesRequestImageLink.mapping(bundle, `${keyPrefix}image_link`)),
