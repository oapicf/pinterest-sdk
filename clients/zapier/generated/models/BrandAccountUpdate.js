...
const BrandAccountProfileImageUpdate = require('../models/BrandAccountProfileImageUpdate');
...
module.exports = {
    fields: (prefix = '', isInput = true, isArrayChild = false) => {
        ...
        return [
            ...
            ...BrandAccountProfileImageUpdate.fields(`${keyPrefix}profile_image`, isInput),
            {
    ...
    mapping: (bundle, prefix = '') => {
        ...
        return {
            ...
            'profile_image': utils.removeIfEmpty(BrandAccountProfileImageUpdate.mapping(bundle, `${keyPrefix}profile_image`)),
