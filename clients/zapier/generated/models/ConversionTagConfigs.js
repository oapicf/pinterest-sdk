...
module.exports = {
    fields: (prefix = '', isInput = true, isArrayChild = false) => {
        ...
        return [
            ...
            {
                key: `${keyPrefix}no_code_capi_domains`,
                label: `List of advertiser subdomains configured for NoCodeCAPI calls. - [${labelPrefix}no_code_capi_domains]`,
                list: true,
                type: 'string',
            },
        ]
    ...
    mapping: (bundle, prefix = '') => {
        ...
        return {
            ...
            'no_code_capi_domains': bundle.inputData?.[`${keyPrefix}no_code_capi_domains`],
        }
    },
}
