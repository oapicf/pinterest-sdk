...
const ConversionEventsDataItemsCustomData = require('../models/ConversionEventsDataItemsCustomData');
const ConversionEventsUserDataProperties = require('../models/ConversionEventsUserDataProperties');
...
module.exports = {
        ...
        return [
            {
                ...
                label: `The source indicating where the conversion event occurred. - `app_android` - `app_ios` - `web` - `offline` - [${labelPrefix}action_source]`,
                required: true,
                type: 'string',
            },
            {
            ...
            ...ConversionEventsDataItemsCustomData.fields(`${keyPrefix}custom_data`, isInput),
            {
            ...
            ...ConversionEventsUserDataProperties.fields(`${keyPrefix}user_data`, isInput),
            {
                key: `${keyPrefix}wifi`,
    ...
    mapping: (bundle, prefix = '') => {
        ...
        return {
            ...
            'custom_data': utils.removeIfEmpty(ConversionEventsDataItemsCustomData.mapping(bundle, `${keyPrefix}custom_data`)),
            ...
            'user_data': utils.removeIfEmpty(ConversionEventsUserDataProperties.mapping(bundle, `${keyPrefix}user_data`)),
