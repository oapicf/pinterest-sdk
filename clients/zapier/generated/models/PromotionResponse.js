        ...
        return [
            {
                ...
                label: `Discount status based on the current time and start and end time of discount - [${labelPrefix}discount_status]`,
                type: 'string',
                choices: [
                    'OTHER',
                    'ACTIVE',
            ...
            },
            {
                ...
                label: `The Ad Account ID that this promotion belongs to. - [${labelPrefix}ad_account_id]`,
                type: 'string',
            },
            {
                key: `${keyPrefix}id`,
                label: `Promotion ID - [${labelPrefix}id]`,
                type: 'string',
            },
            {
