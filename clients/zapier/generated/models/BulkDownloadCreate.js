...
const BulkDownloadCampaignFilter = require('../models/BulkDownloadCampaignFilter');
...
module.exports = {
    fields: (prefix = '', isInput = true, isArrayChild = false) => {
        ...
        return [
            ...BulkDownloadCampaignFilter.fields(`${keyPrefix}campaign_filter`, isInput),
            {
    ...
    mapping: (bundle, prefix = '') => {
        ...
        return {
            'campaign_filter': utils.removeIfEmpty(BulkDownloadCampaignFilter.mapping(bundle, `${keyPrefix}campaign_filter`)),
