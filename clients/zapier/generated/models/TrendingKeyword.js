...
const TrendingKeywordDemographics = require('../models/TrendingKeywordDemographics');

module.exports = {
    fields: (prefix = '', isInput = true, isArrayChild = false) => {
        const {keyPrefix, labelPrefix} = utils.buildKeyAndLabel(prefix, isInput, isArrayChild)
        return [
            ...TrendingKeywordDemographics.fields(`${keyPrefix}demographics`, isInput),
            {
            ...
            },
            {
                ...
                label: `The month-over-month percent change in search volume for this keyword. For example, a value of \"400\" would represent a 400% increase in searches in the last 30 days compared to the month prior. **Note**: growth rates are rounded, with a maximum of +/- 10000% change. A value of 10001 indicates that this keyword experienced > 10000% month-over-month growth. - [${labelPrefix}pct_growth_mom]`,
                type: 'integer',
            },
            {
                key: `${keyPrefix}pct_growth_wow`,
                label: `The week-over-week percent change in search volume for this keyword. For example, a value of \"50\" would represent a 50% increase in searches in the last seven days compared to the week prior. **Note**: growth rates are rounded, with a maximum of +/- 10000% change. A value of 10001 indicates that this keyword experienced > 10000% week-over-week growth. - [${labelPrefix}pct_growth_wow]`,
                type: 'integer',
            },
            {
                key: `${keyPrefix}pct_growth_yoy`,
                label: `The year-over-year percent change in search volume for this keyword. For example, a value of \"-5\" would represent a 5% decrease in searches in the last 365 days compared to the month prior. **Note**: growth rates are rounded, with a maximum of +/- 10000% change. A value of 10001 indicates that this keyword experienced > 10000% year-over-year growth. - [${labelPrefix}pct_growth_yoy]`,
                type: 'integer',
            },
    ...
    mapping: (bundle, prefix = '') => {
        ...
        return {
            'demographics': utils.removeIfEmpty(TrendingKeywordDemographics.mapping(bundle, `${keyPrefix}demographics`)),
