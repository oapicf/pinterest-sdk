...
OAIBusinessAccessRole::OAIBusinessAccessRole(const QString &json) {
...
void OAIBusinessAccessRole::fromJson(const QString &jsonString) {
    ...
    if ( jsonString.compare("OWNER", Qt::CaseInsensitive) == 0) {
        ...
        m_value = eOAIBusinessAccessRole::FINANCE_VIEW;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("FINANCE_EDIT", Qt::CaseInsensitive) == 0) {
        m_value = eOAIBusinessAccessRole::FINANCE_EDIT;
        m_value_isSet = m_value_isValid = true;
    }
...
QString OAIBusinessAccessRole::asJson() const {
    ...
    switch (m_value){
        ...
        case eOAIBusinessAccessRole::FINANCE_MANAGER:
            val = "FINANCE_MANAGER";
            break;
        case eOAIBusinessAccessRole::FINANCE_VIEW:
            val = "FINANCE_VIEW";
            break;
        case eOAIBusinessAccessRole::FINANCE_EDIT:
            val = "FINANCE_EDIT";
            break;
