...
OAIPinMediaWithVideos::OAIPinMediaWithVideos(const QString &json) {
...
void OAIPinMediaWithVideos::fromJson(const QString &jsonString) {
...
QList<OAIVideoMetadataWithItemType> OAIPinMediaWithVideos::getItems() const {
    return m_items;
}
void OAIPinMediaWithVideos::setItems(const QList<OAIVideoMetadataWithItemType> &items) {
    m_items = items;
    m_items_isSet = true;
}
