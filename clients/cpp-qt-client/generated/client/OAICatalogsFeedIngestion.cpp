...
OAICatalogsFeedIngestion::OAICatalogsFeedIngestion(const QString &json) {
...
void OAICatalogsFeedIngestion::fromJson(const QString &jsonString) {
...
bool OAICatalogsFeedIngestion::isValid() const {
    ...
    return m_created_at_isValid && m_feed_id_isValid && m_id_isValid && m_status_isValid && true;
}
