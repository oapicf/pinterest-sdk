...
OAIAudienceRule::OAIAudienceRule(const QString &json) {
...
void OAIAudienceRule::fromJson(const QString &jsonString) {
...
OAIEventData OAIAudienceRule::getEventData() const {
    return m_event_data;
}
void OAIAudienceRule::setEventData(const OAIEventData &event_data) {
