...
/*
 * OAILeadSubscription.h
 *
 * 
 */

#ifndef OAILeadSubscription_H
#define OAILeadSubscription_H
...
class OAILeadSubscription : public OAIObject {
public:
    OAILeadSubscription();
    OAILeadSubscription(const QString &json);
    ~OAILeadSubscription() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILeadSubscription)

#endif // OAILeadSubscription_H
