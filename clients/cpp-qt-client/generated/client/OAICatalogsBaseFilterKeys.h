...
public:
    ...
    OAICatalogsBaseFilterKeys(const QString &json);
...
private:
    ...
    OAICatalogsProductGroupPricingCriteria m_min_price;
    bool m_min_price_isSet;
    bool m_min_price_isValid;

    OAICatalogsProductGroupPricingCriteria m_max_price;
    ...
    OAICatalogsProductGroupMultipleStringCriteria m_availability;
    ...
    OAICatalogsProductGroupMultipleStringCriteria m_condition;
    bool m_condition_isSet;
    bool m_condition_isValid;

    OAICatalogsProductGroupFilterOperatorTypeCriteria m_custom_label_0;
    bool m_custom_label_0_isSet;
    bool m_custom_label_0_isValid;

    OAICatalogsProductGroupFilterOperatorTypeCriteria m_custom_label_1;
    bool m_custom_label_1_isSet;
    bool m_custom_label_1_isValid;

    OAICatalogsProductGroupFilterOperatorTypeCriteria m_custom_label_2;
    bool m_custom_label_2_isSet;
    bool m_custom_label_2_isValid;

    OAICatalogsProductGroupFilterOperatorTypeCriteria m_custom_label_3;
    ...
    OAICatalogsProductGroupMultipleStringCriteria m_item_group_id;
    ...
    OAICatalogsProductGroupMultipleMediaTypesCriteria m_media_type;
    ...
    OAICatalogsProductGroupMultipleStringListCriteria m_product_type_3;
    ...
    OAICatalogsProductGroupMultipleStringListCriteria m_product_type_1;
    ...
    OAICatalogsProductGroupMultipleStringListCriteria m_google_product_category_4;
    bool m_google_product_category_4_isSet;
    bool m_google_product_category_4_isValid;

    OAICatalogsProductGroupMultipleStringListCriteria m_google_product_category_3;
    bool m_google_product_category_3_isSet;
    bool m_google_product_category_3_isValid;

    OAICatalogsProductGroupMultipleStringListCriteria m_google_product_category_2;
    bool m_google_product_category_2_isSet;
    bool m_google_product_category_2_isValid;

    OAICatalogsProductGroupMultipleStringListCriteria m_google_product_category_1;
    ...
    OAICatalogsProductGroupUint32Criteria m_custom_number_4;
    bool m_custom_number_4_isSet;
    bool m_custom_number_4_isValid;

    OAICatalogsProductGroupMultipleStringCriteria m_title_keywords;
    bool m_title_keywords_isSet;
    bool m_title_keywords_isValid;

    OAICatalogsProductGroupMultiplePinterestProductCategoryCriteria m_pinterest_product_categories;
