...
OAIIntegrationLog::OAIIntegrationLog(const QString &json) {
...
void OAIIntegrationLog::fromJson(const QString &jsonString) {
...
void OAIIntegrationLog::fromJsonObject(QJsonObject json) {
    ...
    m_app_version_number_isValid = ::OpenAPI::fromJsonValue(m_app_version_number, json[QString("app_version_number")]);
    m_app_version_number_isSet = !json[QString("app_version_number")].isNull() && m_app_version_number_isValid;

    m_client_timestamp_isValid = ::OpenAPI::fromJsonValue(m_client_timestamp, json[QString("client_timestamp")]);
    ...
    m_platform_version_number_isValid = ::OpenAPI::fromJsonValue(m_platform_version_number, json[QString("platform_version_number")]);
    ...
    m_tag_id_isValid = ::OpenAPI::fromJsonValue(m_tag_id, json[QString("tag_id")]);
...
QJsonObject OAIIntegrationLog::asJsonObject() const {
    ...
    if (m_app_version_number_isSet) {
        obj.insert(QString("app_version_number"), ::OpenAPI::toJsonValue(m_app_version_number));
    }
    if (m_client_timestamp_isSet) {
        obj.insert(QString("client_timestamp"), ::OpenAPI::toJsonValue(m_client_timestamp));
    }
    if (m_error.isSet()) {
    ...
    if (m_platform_version_number_isSet) {
        obj.insert(QString("platform_version_number"), ::OpenAPI::toJsonValue(m_platform_version_number));
    }
    if (m_request.isSet()) {
        obj.insert(QString("request"), ::OpenAPI::toJsonValue(m_request));
    }
    if (m_tag_id_isSet) {
        obj.insert(QString("tag_id"), ::OpenAPI::toJsonValue(m_tag_id));
    }
    return obj;
}
...
void OAIIntegrationLog::setAppVersionNumber(const QString &app_version_number) {
    m_app_version_number = app_version_number;
    m_app_version_number_isSet = true;
}
...
OAIIntegrationLogEventType OAIIntegrationLog::getEventType() const {
    return m_event_type;
}
void OAIIntegrationLog::setEventType(const OAIIntegrationLogEventType &event_type) {
...
OAIIntegrationLogLevel OAIIntegrationLog::getLogLevel() const {
    return m_log_level;
}
void OAIIntegrationLog::setLogLevel(const OAIIntegrationLogLevel &log_level) {
...
void OAIIntegrationLog::setPlatformVersionNumber(const QString &platform_version_number) {
    m_platform_version_number = platform_version_number;
    m_platform_version_number_isSet = true;
}
