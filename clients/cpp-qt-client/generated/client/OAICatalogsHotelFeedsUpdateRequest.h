...
/*
 * OAICatalogsHotelFeedsUpdateRequest.h
 *
 * Request object for updating a feed.
 */

#ifndef OAICatalogsHotelFeedsUpdateRequest_H
#define OAICatalogsHotelFeedsUpdateRequest_H
...
class OAICatalogsHotelFeedsUpdateRequest : public OAIObject {
public:
    OAICatalogsHotelFeedsUpdateRequest();
    OAICatalogsHotelFeedsUpdateRequest(const QString &json);
    ~OAICatalogsHotelFeedsUpdateRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICatalogsHotelFeedsUpdateRequest)

#endif // OAICatalogsHotelFeedsUpdateRequest_H
