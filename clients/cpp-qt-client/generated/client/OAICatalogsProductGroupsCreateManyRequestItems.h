...
/*
 * OAICatalogsProductGroupsCreateManyRequestItems.h
 *
 * 
 */

#ifndef OAICatalogsProductGroupsCreateManyRequestItems_H
#define OAICatalogsProductGroupsCreateManyRequestItems_H
...
class OAICatalogsProductGroupsCreateManyRequestItems : public OAIObject {
public:
    OAICatalogsProductGroupsCreateManyRequestItems();
    OAICatalogsProductGroupsCreateManyRequestItems(const QString &json);
    ~OAICatalogsProductGroupsCreateManyRequestItems() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICatalogsProductGroupsCreateManyRequestItems)

#endif // OAICatalogsProductGroupsCreateManyRequestItems_H
