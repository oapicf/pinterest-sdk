...
OAICustomLabel1Filter::OAICustomLabel1Filter(const QString &json) {
...
void OAICustomLabel1Filter::fromJson(const QString &jsonString) {
...
OAICatalogsProductGroupFilterOperatorTypeCriteria OAICustomLabel1Filter::getCustomLabel1() const {
    return m_custom_label_1;
}
void OAICustomLabel1Filter::setCustomLabel1(const OAICatalogsProductGroupFilterOperatorTypeCriteria &custom_label_1) {
