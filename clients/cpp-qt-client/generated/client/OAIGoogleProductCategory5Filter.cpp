...
OAIGoogleProductCategory5Filter::OAIGoogleProductCategory5Filter(const QString &json) {
...
void OAIGoogleProductCategory5Filter::fromJson(const QString &jsonString) {
