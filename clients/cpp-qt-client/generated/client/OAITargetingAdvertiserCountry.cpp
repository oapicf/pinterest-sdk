...
OAITargetingAdvertiserCountry::OAITargetingAdvertiserCountry(const QString &json) {
...
void OAITargetingAdvertiserCountry::fromJson(const QString &jsonString) {
    ...
    if ( jsonString.compare("US", Qt::CaseInsensitive) == 0) {
        ...
        m_value = eOAITargetingAdvertiserCountry::FALSE;
        m_value_isSet = m_value_isValid = true;
    }
...
QString OAITargetingAdvertiserCountry::asJson() const {
    ...
    switch (m_value){
        ...
        case eOAITargetingAdvertiserCountry::SG:
            val = "SG";
            break;
        case eOAITargetingAdvertiserCountry::FALSE:
            val = "false";
            break;
