...
OAIUsersForIndividualAssetResponse::OAIUsersForIndividualAssetResponse(const QString &json) {
...
void OAIUsersForIndividualAssetResponse::fromJson(const QString &jsonString) {
