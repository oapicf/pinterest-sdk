...
OAICustomLabel0Filter::OAICustomLabel0Filter(const QString &json) {
...
void OAICustomLabel0Filter::fromJson(const QString &jsonString) {
...
OAICatalogsProductGroupFilterOperatorTypeCriteria OAICustomLabel0Filter::getCustomLabel0() const {
    return m_custom_label_0;
}
void OAICustomLabel0Filter::setCustomLabel0(const OAICatalogsProductGroupFilterOperatorTypeCriteria &custom_label_0) {
