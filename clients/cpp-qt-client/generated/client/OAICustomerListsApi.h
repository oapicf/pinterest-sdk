...
public:
    ...
    */
    virtual void customerLists_create(const QString &ad_account_id, const OAICustomerListRequest &oai_customer_list_request);
    ...
    */
    virtual void customerLists_list(const QString &ad_account_id, const ::OpenAPI::OptionalParam<qint32> &page_size = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &order = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &bookmark = ::OpenAPI::OptionalParam<QString>());
    ...
    */
    virtual void customerLists_update(const QString &ad_account_id, const QString &customer_list_id, const OAICustomerListUpdateRequest &oai_customer_list_update_request);
