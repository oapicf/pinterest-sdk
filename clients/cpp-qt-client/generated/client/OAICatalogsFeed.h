...
#ifndef OAICatalogsFeed_H
#define OAICatalogsFeed_H
...
class OAICatalogsFeed : public OAIObject {
public:
    OAICatalogsFeed();
    OAICatalogsFeed(const QString &json);
    ~OAICatalogsFeed() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICatalogsFeed)

#endif // OAICatalogsFeed_H
