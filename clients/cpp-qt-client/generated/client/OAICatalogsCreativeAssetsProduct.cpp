...
OAICatalogsCreativeAssetsProduct::OAICatalogsCreativeAssetsProduct(const QString &json) {
...
void OAICatalogsCreativeAssetsProduct::fromJson(const QString &jsonString) {
