...
/*
 * OAICatalogsProductGroupsCreateRequestSchema.h
 *
 * 
 */

#ifndef OAICatalogsProductGroupsCreateRequestSchema_H
#define OAICatalogsProductGroupsCreateRequestSchema_H
...
class OAICatalogsProductGroupsCreateRequestSchema : public OAIObject {
public:
    OAICatalogsProductGroupsCreateRequestSchema();
    OAICatalogsProductGroupsCreateRequestSchema(const QString &json);
    ~OAICatalogsProductGroupsCreateRequestSchema() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICatalogsProductGroupsCreateRequestSchema)

#endif // OAICatalogsProductGroupsCreateRequestSchema_H
