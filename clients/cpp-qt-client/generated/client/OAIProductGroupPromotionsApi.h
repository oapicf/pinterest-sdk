...
Q_SIGNALS:
    ...
    Q_DECL_DEPRECATED_X("Use productGroupPromotion_getSignalError() instead")
    ...
    void productGroupPromotion_getSignalError(OAIProductGroupPromotion summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void productGroupPromotions_createSignalError(QList<OAIProductGroupPromotionArrayElement> summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void productGroupPromotions_updateSignalError(QList<OAIProductGroupPromotionUpdateResponseItem> summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use productGroupPromotion_getSignalErrorFull() instead")
    ...
    void productGroupPromotion_getSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
