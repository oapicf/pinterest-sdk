...
QList<OAIMultiple_product_groups_inner> OAIBulkUpsertRequestCreate::getCatalogProductGroups() const {
    return m_catalog_product_groups;
}
void OAIBulkUpsertRequestCreate::setCatalogProductGroups(const QList<OAIMultiple_product_groups_inner> &catalog_product_groups) {
...
QList<OAILabelCreateRequest> OAIBulkUpsertRequestCreate::getLabels() const {
    return m_labels;
}
void OAIBulkUpsertRequestCreate::setLabels(const QList<OAILabelCreateRequest> &labels) {
    m_labels = labels;
    m_labels_isSet = true;
}
