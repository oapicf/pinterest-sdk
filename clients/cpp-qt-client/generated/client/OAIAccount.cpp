...
OAIAccount::OAIAccount(const QString &json) {
...
void OAIAccount::fromJson(const QString &jsonString) {
...
void OAIAccount::fromJsonObject(QJsonObject json) {
    ...
    m_monthly_views_isValid = ::OpenAPI::fromJsonValue(m_monthly_views, json[QString("monthly_views")]);
...
QJsonObject OAIAccount::asJsonObject() const {
    ...
    if (m_monthly_views_isSet) {
        obj.insert(QString("monthly_views"), ::OpenAPI::toJsonValue(m_monthly_views));
    }
...
OAIUserAccountType OAIAccount::getAccountType() const {
    return m_account_type;
}
void OAIAccount::setAccountType(const OAIUserAccountType &account_type) {
...
void OAIAccount::setMonthlyViews(const qint32 &monthly_views) {
    m_monthly_views = monthly_views;
    m_monthly_views_isSet = true;
}
