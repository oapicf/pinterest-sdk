...
/*
 * OAICatalogsReportStats.h
 *
 * Diagnostics aggregated numbers
 */

#ifndef OAICatalogsReportStats_H
#define OAICatalogsReportStats_H
...
class OAICatalogsReportStats : public OAIObject {
public:
    OAICatalogsReportStats();
    OAICatalogsReportStats(const QString &json);
    ~OAICatalogsReportStats() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICatalogsReportStats)

#endif // OAICatalogsReportStats_H
