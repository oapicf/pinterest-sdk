...
OAIConversionEventResponse::OAIConversionEventResponse(const QString &json) {
...
void OAIConversionEventResponse::initializeModel() {
    ...
    m_reporting_conversion_event_isSet = false;
    m_reporting_conversion_event_isValid = false;
}

void OAIConversionEventResponse::fromJson(const QString &jsonString) {
...
void OAIConversionEventResponse::fromJsonObject(QJsonObject json) {
    ...
    m_reporting_conversion_event_isValid = ::OpenAPI::fromJsonValue(m_reporting_conversion_event, json[QString("reporting_conversion_event")]);
    m_reporting_conversion_event_isSet = !json[QString("reporting_conversion_event")].isNull() && m_reporting_conversion_event_isValid;
}
...
QJsonObject OAIConversionEventResponse::asJsonObject() const {
    ...
    if (m_reporting_conversion_event_isSet) {
        obj.insert(QString("reporting_conversion_event"), ::OpenAPI::toJsonValue(m_reporting_conversion_event));
    }
    return obj;
}
...
QString OAIConversionEventResponse::getReportingConversionEvent() const {
    return m_reporting_conversion_event;
}
void OAIConversionEventResponse::setReportingConversionEvent(const QString &reporting_conversion_event) {
    m_reporting_conversion_event = reporting_conversion_event;
    m_reporting_conversion_event_isSet = true;
}

bool OAIConversionEventResponse::is_reporting_conversion_event_Set() const{
    return m_reporting_conversion_event_isSet;
}

bool OAIConversionEventResponse::is_reporting_conversion_event_Valid() const{
    return m_reporting_conversion_event_isValid;
}
