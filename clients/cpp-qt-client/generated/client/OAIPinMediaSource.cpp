...
OAIPinMediaSource::OAIPinMediaSource(const QString &json) {
...
void OAIPinMediaSource::fromJson(const QString &jsonString) {
...
OAIContentType OAIPinMediaSource::getContentType() const {
    return m_content_type;
}
void OAIPinMediaSource::setContentType(const OAIContentType &content_type) {
...
OAIContentType OAIPinMediaSource::getCoverImageContentType() const {
    return m_cover_image_content_type;
}
void OAIPinMediaSource::setCoverImageContentType(const OAIContentType &cover_image_content_type) {
...
qint32 OAIPinMediaSource::getCoverImageKeyFrameTime() const {
    return m_cover_image_key_frame_time;
}
void OAIPinMediaSource::setCoverImageKeyFrameTime(const qint32 &cover_image_key_frame_time) {
    m_cover_image_key_frame_time = cover_image_key_frame_time;
    m_cover_image_key_frame_time_isSet = true;
}

bool OAIPinMediaSource::is_cover_image_key_frame_time_Set() const{
    return m_cover_image_key_frame_time_isSet;
}

bool OAIPinMediaSource::is_cover_image_key_frame_time_Valid() const{
...
QList<OAIPinMediaSourceImagesURLItem> OAIPinMediaSource::getItems() const {
    return m_items;
}
void OAIPinMediaSource::setItems(const QList<OAIPinMediaSourceImagesURLItem> &items) {
    m_items = items;
    m_items_isSet = true;
}
...
bool OAIPinMediaSource::isValid() const {
    ...
    return m_content_type_isValid && m_data_isValid && m_source_type_isValid && m_url_isValid && m_media_id_isValid && m_items_isValid && true;
}
