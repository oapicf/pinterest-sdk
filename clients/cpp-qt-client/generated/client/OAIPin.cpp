...
OAIPin::OAIPin(const QString &json) {
...
void OAIPin::fromJson(const QString &jsonString) {
...
OAIAiDisclosures OAIPin::getAiDisclosures() const {
    return m_ai_disclosures;
}
void OAIPin::setAiDisclosures(const OAIAiDisclosures &ai_disclosures) {
    m_ai_disclosures = ai_disclosures;
    m_ai_disclosures_isSet = true;
}

bool OAIPin::is_ai_disclosures_Set() const{
    return m_ai_disclosures_isSet;
}

bool OAIPin::is_ai_disclosures_Valid() const{
...
bool OAIPin::isIsProduct() const {
    return m_is_product;
}
void OAIPin::setIsProduct(const bool &is_product) {
    m_is_product = is_product;
    m_is_product_isSet = true;
}

bool OAIPin::is_is_product_Set() const{
    return m_is_product_isSet;
}

bool OAIPin::is_is_product_Valid() const{
