...
public:
    ...
    * @param[in]  ad_account_id QString [required]
    * @param[in]  audience_id QString [required]
    * @param[in]  oai_audience_update_request OAIAudienceUpdateRequest [required]
    */
    virtual void audiences_update(const QString &ad_account_id, const QString &audience_id, const OAIAudienceUpdateRequest &oai_audience_update_request);
