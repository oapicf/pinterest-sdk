...
public:
    ...
    */
    void audiences_createCustom(const QString &ad_account_id, const OAIAudienceCreateCustomRequest &oai_audience_create_custom_request);
    ...
    */
    void audiences_list(const QString &ad_account_id, const ::OpenAPI::OptionalParam<QString> &bookmark = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &order = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<qint32> &page_size = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &ownership_type = ::OpenAPI::OptionalParam<QString>());
