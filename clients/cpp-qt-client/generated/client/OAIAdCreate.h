...
#ifndef OAIAdCreate_H
#define OAIAdCreate_H
...
class OAIAdCreate : public OAIObject {
public:
    OAIAdCreate();
    OAIAdCreate(const QString &json);
    ~OAIAdCreate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAdCreate)
