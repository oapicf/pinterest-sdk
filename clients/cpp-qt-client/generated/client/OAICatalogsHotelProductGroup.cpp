...
OAICatalogsHotelProductGroup::OAICatalogsHotelProductGroup(const QString &json) {
...
void OAICatalogsHotelProductGroup::fromJson(const QString &jsonString) {
...
OAICatalogsHotelProductGroupType OAICatalogsHotelProductGroup::getType() const {
    return m_type;
}
void OAICatalogsHotelProductGroup::setType(const OAICatalogsHotelProductGroupType &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAICatalogsHotelProductGroup::is_type_Set() const{
    return m_type_isSet;
}

bool OAICatalogsHotelProductGroup::is_type_Valid() const{
...
bool OAICatalogsHotelProductGroup::isValid() const {
    ...
    return m_catalog_id_isValid && m_catalog_type_isValid && m_filters_isValid && m_id_isValid && m_type_isValid && true;
}
