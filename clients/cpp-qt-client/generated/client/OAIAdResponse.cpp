...
OAICustomizableCTAType OAIAdResponse::getCustomizableCtaType() const {
    return m_customizable_cta_type;
}
void OAIAdResponse::setCustomizableCtaType(const OAICustomizableCTAType &customizable_cta_type) {
...
OAIDisclosureType OAIAdResponse::getDisclosureType() const {
    return m_disclosure_type;
}
void OAIAdResponse::setDisclosureType(const OAIDisclosureType &disclosure_type) {
    m_disclosure_type = disclosure_type;
    m_disclosure_type_isSet = true;
}

bool OAIAdResponse::is_disclosure_type_Set() const{
    return m_disclosure_type_isSet;
}

bool OAIAdResponse::is_disclosure_type_Valid() const{
    return m_disclosure_type_isValid;
}

QString OAIAdResponse::getDisclosureUrl() const {
    return m_disclosure_url;
}
void OAIAdResponse::setDisclosureUrl(const QString &disclosure_url) {
    m_disclosure_url = disclosure_url;
    m_disclosure_url_isSet = true;
}

bool OAIAdResponse::is_disclosure_url_Set() const{
    return m_disclosure_url_isSet;
}

bool OAIAdResponse::is_disclosure_url_Valid() const{
