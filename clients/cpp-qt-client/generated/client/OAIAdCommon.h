...
#ifndef OAIAdCommon_H
#define OAIAdCommon_H
...
class OAIAdCommon : public OAIObject {
public:
    OAIAdCommon();
    OAIAdCommon(QString json);
    ~OAIAdCommon() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAdCommon)
