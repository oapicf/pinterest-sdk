...
/*
 * OAICatalogsFeedCreateRequestSchema.h
 *
 * 
 */

#ifndef OAICatalogsFeedCreateRequestSchema_H
#define OAICatalogsFeedCreateRequestSchema_H
...
class OAICatalogsFeedCreateRequestSchema : public OAIObject {
public:
    OAICatalogsFeedCreateRequestSchema();
    OAICatalogsFeedCreateRequestSchema(const QString &json);
    ~OAICatalogsFeedCreateRequestSchema() override;
    ...
    OAICatalogsCreativeAssetsFeedsCreateRequest_default_locale getDefaultLocale() const;
    void setDefaultLocale(const OAICatalogsCreativeAssetsFeedsCreateRequest_default_locale &default_locale);
...
private:
    ...
    OAICatalogsCreativeAssetsFeedsCreateRequest_default_locale m_default_locale;
...
Q_DECLARE_METATYPE(OpenAPI::OAICatalogsFeedCreateRequestSchema)

#endif // OAICatalogsFeedCreateRequestSchema_H
