...
OAIMetricsResponse::OAIMetricsResponse(const QString &json) {
...
void OAIMetricsResponse::fromJson(const QString &jsonString) {
...
QList<OAIMetricsResponseDataItems> OAIMetricsResponse::getData() const {
    return m_data;
}
void OAIMetricsResponse::setData(const QList<OAIMetricsResponseDataItems> &data) {
    m_data = data;
    m_data_isSet = true;
}
