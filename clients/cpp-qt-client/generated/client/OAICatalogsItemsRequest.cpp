...
OAICatalogsItemsRequest::OAICatalogsItemsRequest(const QString &json) {
...
void OAICatalogsItemsRequest::fromJson(const QString &jsonString) {
...
QString OAICatalogsItemsRequest::getLanguage() const {
    return m_language;
}
void OAICatalogsItemsRequest::setLanguage(const QString &language) {
    m_language = language;
...
bool OAICatalogsItemsRequest::isValid() const {
    ...
    return m_country_isValid && m_filters_isValid && m_language_isValid && true;
}
