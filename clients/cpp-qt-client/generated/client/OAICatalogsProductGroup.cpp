...
bool OAICatalogsProductGroup::isIsFeatured() const {
    return m_is_featured;
}
void OAICatalogsProductGroup::setIsFeatured(const bool &is_featured) {
    m_is_featured = is_featured;
    m_is_featured_isSet = true;
}

bool OAICatalogsProductGroup::is_is_featured_Set() const{
    return m_is_featured_isSet;
}

bool OAICatalogsProductGroup::is_is_featured_Valid() const{
...
QString OAICatalogsProductGroup::getCatalogType() const {
    return m_catalog_type;
}
void OAICatalogsProductGroup::setCatalogType(const QString &catalog_type) {
    m_catalog_type = catalog_type;
    m_catalog_type_isSet = true;
}

bool OAICatalogsProductGroup::is_catalog_type_Set() const{
    return m_catalog_type_isSet;
}

bool OAICatalogsProductGroup::is_catalog_type_Valid() const{
