...
OAICustomLabel3Filter::OAICustomLabel3Filter(const QString &json) {
...
void OAICustomLabel3Filter::fromJson(const QString &jsonString) {
...
OAICatalogsProductGroupFilterOperatorTypeCriteria OAICustomLabel3Filter::getCustomLabel3() const {
    return m_custom_label_3;
}
void OAICustomLabel3Filter::setCustomLabel3(const OAICatalogsProductGroupFilterOperatorTypeCriteria &custom_label_3) {
