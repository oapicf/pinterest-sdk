...
public:
    ...
    qint32 getProductCategoryInvalid() const;
    void setProductCategoryInvalid(const qint32 &product_category_invalid);
    bool is_product_category_invalid_Set() const;
    bool is_product_category_invalid_Valid() const;
    ...
    qint32 getProductCategoryMissing() const;
    void setProductCategoryMissing(const qint32 &product_category_missing);
    bool is_product_category_missing_Set() const;
    bool is_product_category_missing_Valid() const;
    ...
    qint32 getRedirectInvalid() const;
    void setRedirectInvalid(const qint32 &redirect_invalid);
    bool is_redirect_invalid_Set() const;
    bool is_redirect_invalid_Valid() const;
    ...
    qint32 getConditionInvalid() const;
    void setConditionInvalid(const qint32 &condition_invalid);
    bool is_condition_invalid_Set() const;
    bool is_condition_invalid_Valid() const;

    qint32 getShopifyNoProducts() const;
    void setShopifyNoProducts(const qint32 &shopify_no_products);
    bool is_shopify_no_products_Set() const;
    bool is_shopify_no_products_Valid() const;
...
private:
    ...
    qint32 product_category_invalid;
    bool m_product_category_invalid_isSet;
    bool m_product_category_invalid_isValid;
    ...
    qint32 product_category_missing;
    bool m_product_category_missing_isSet;
    bool m_product_category_missing_isValid;
    ...
    qint32 redirect_invalid;
    bool m_redirect_invalid_isSet;
    bool m_redirect_invalid_isValid;
    ...
    qint32 condition_invalid;
    bool m_condition_invalid_isSet;
    bool m_condition_invalid_isValid;

    qint32 shopify_no_products;
    bool m_shopify_no_products_isSet;
    bool m_shopify_no_products_isValid;
