...
#ifndef OAIAdGroupCommon_H
#define OAIAdGroupCommon_H
...
class OAIAdGroupCommon : public OAIObject {
public:
    OAIAdGroupCommon();
    OAIAdGroupCommon(QString json);
    ~OAIAdGroupCommon() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAdGroupCommon)

#endif // OAIAdGroupCommon_H
