...
Q_SIGNALS:
    ...
    void searchUserPins_listSignal(OAISearch_user_pins_list_200_response summary);
    ...
    void searchUserPins_listSignalFull(OAIHttpRequestWorker *worker, OAISearch_user_pins_list_200_response summary);
    ...
    void searchUserPins_listSignalE(OAISearch_user_pins_list_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void searchUserPins_listSignalError(OAISearch_user_pins_list_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
