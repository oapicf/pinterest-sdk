...
OAICampaignUpdateRequest::OAICampaignUpdateRequest(const QString &json) {
...
void OAICampaignUpdateRequest::fromJson(const QString &jsonString) {
...
OAICampaignBidOptionsUpdate OAICampaignUpdateRequest::getBidOptions() const {
    return m_bid_options;
}
void OAICampaignUpdateRequest::setBidOptions(const OAICampaignBidOptionsUpdate &bid_options) {
    m_bid_options = bid_options;
    m_bid_options_isSet = true;
}

bool OAICampaignUpdateRequest::is_bid_options_Set() const{
    return m_bid_options_isSet;
}

bool OAICampaignUpdateRequest::is_bid_options_Valid() const{
    return m_bid_options_isValid;
}

OAIIntendedPromotionType OAICampaignUpdateRequest::getIntendedPromotionType() const {
    return m_intended_promotion_type;
}
void OAICampaignUpdateRequest::setIntendedPromotionType(const OAIIntendedPromotionType &intended_promotion_type) {
    m_intended_promotion_type = intended_promotion_type;
    m_intended_promotion_type_isSet = true;
}

bool OAICampaignUpdateRequest::is_intended_promotion_type_Set() const{
    return m_intended_promotion_type_isSet;
}

bool OAICampaignUpdateRequest::is_intended_promotion_type_Valid() const{
    return m_intended_promotion_type_isValid;
}

bool OAICampaignUpdateRequest::isIsLtvOptimized() const {
    return m_is_ltv_optimized;
}
void OAICampaignUpdateRequest::setIsLtvOptimized(const bool &is_ltv_optimized) {
    m_is_ltv_optimized = is_ltv_optimized;
    m_is_ltv_optimized_isSet = true;
}

bool OAICampaignUpdateRequest::is_is_ltv_optimized_Set() const{
    return m_is_ltv_optimized_isSet;
}

bool OAICampaignUpdateRequest::is_is_ltv_optimized_Valid() const{
    return m_is_ltv_optimized_isValid;
}

bool OAICampaignUpdateRequest::isIsPerformancePlus() const {
    return m_is_performance_plus;
}
void OAICampaignUpdateRequest::setIsPerformancePlus(const bool &is_performance_plus) {
    m_is_performance_plus = is_performance_plus;
    m_is_performance_plus_isSet = true;
}

bool OAICampaignUpdateRequest::is_is_performance_plus_Set() const{
    return m_is_performance_plus_isSet;
}

bool OAICampaignUpdateRequest::is_is_performance_plus_Valid() const{
    return m_is_performance_plus_isValid;
}

bool OAICampaignUpdateRequest::isIsTopOfSearch() const {
    return m_is_top_of_search;
}
void OAICampaignUpdateRequest::setIsTopOfSearch(const bool &is_top_of_search) {
    m_is_top_of_search = is_top_of_search;
    m_is_top_of_search_isSet = true;
}

bool OAICampaignUpdateRequest::is_is_top_of_search_Set() const{
    return m_is_top_of_search_isSet;
}

bool OAICampaignUpdateRequest::is_is_top_of_search_Valid() const{
...
OAIObject OAICampaignUpdateRequest::getTrackingUrls() const {
    return m_tracking_urls;
}
void OAICampaignUpdateRequest::setTrackingUrls(const OAIObject &tracking_urls) {
...
bool OAICampaignUpdateRequest::isValid() const {
    ...
    return m_ad_account_id_isValid && m_id_isValid && true;
}
