...
OAICatalogsFeedIngestionErrors::OAICatalogsFeedIngestionErrors(const QString &json) {
...
void OAICatalogsFeedIngestionErrors::initializeModel() {
    ...
    m_fetch_google_sheet_not_shared_isSet = false;
    m_fetch_google_sheet_not_shared_isValid = false;
...
void OAICatalogsFeedIngestionErrors::fromJson(const QString &jsonString) {
...
void OAICatalogsFeedIngestionErrors::fromJsonObject(QJsonObject json) {
    ...
    m_fetch_google_sheet_not_shared_isValid = ::OpenAPI::fromJsonValue(m_fetch_google_sheet_not_shared, json[QString("FETCH_GOOGLE_SHEET_NOT_SHARED")]);
    m_fetch_google_sheet_not_shared_isSet = !json[QString("FETCH_GOOGLE_SHEET_NOT_SHARED")].isNull() && m_fetch_google_sheet_not_shared_isValid;
...
QJsonObject OAICatalogsFeedIngestionErrors::asJsonObject() const {
    ...
    if (m_fetch_google_sheet_not_shared_isSet) {
        obj.insert(QString("FETCH_GOOGLE_SHEET_NOT_SHARED"), ::OpenAPI::toJsonValue(m_fetch_google_sheet_not_shared));
    }
...
qint32 OAICatalogsFeedIngestionErrors::getFetchGoogleSheetNotShared() const {
    return m_fetch_google_sheet_not_shared;
}
void OAICatalogsFeedIngestionErrors::setFetchGoogleSheetNotShared(const qint32 &fetch_google_sheet_not_shared) {
    m_fetch_google_sheet_not_shared = fetch_google_sheet_not_shared;
    m_fetch_google_sheet_not_shared_isSet = true;
}

bool OAICatalogsFeedIngestionErrors::is_fetch_google_sheet_not_shared_Set() const{
    return m_fetch_google_sheet_not_shared_isSet;
}

bool OAICatalogsFeedIngestionErrors::is_fetch_google_sheet_not_shared_Valid() const{
    return m_fetch_google_sheet_not_shared_isValid;
}
