...
public:
    ...
    OAICatalogsHotelAttributes(const QString &json);
    ...
    OAICatalogsHotelMainImage getMainImage() const;
    void setMainImage(const OAICatalogsHotelMainImage &main_image);
...
private:
    ...
    OAICatalogsHotelMainImage m_main_image;
