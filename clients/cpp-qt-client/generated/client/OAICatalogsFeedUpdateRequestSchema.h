...
/*
 * OAICatalogsFeedUpdateRequestSchema.h
 *
 * 
 */

#ifndef OAICatalogsFeedUpdateRequestSchema_H
#define OAICatalogsFeedUpdateRequestSchema_H
...
class OAICatalogsFeedUpdateRequestSchema : public OAIObject {
public:
    OAICatalogsFeedUpdateRequestSchema();
    OAICatalogsFeedUpdateRequestSchema(const QString &json);
    ~OAICatalogsFeedUpdateRequestSchema() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICatalogsFeedUpdateRequestSchema)

#endif // OAICatalogsFeedUpdateRequestSchema_H
