...
bool OAICatalogsFeedProcessingResult::isValid() const {
    ...
    return m_created_at_isValid && m_id_isValid && m_updated_at_isValid && m_ingestion_details_isValid && m_product_counts_isValid && m_status_isValid && m_validation_details_isValid && true;
}
