...
OAICatalogsFeedProcessingResult::OAICatalogsFeedProcessingResult(const QString &json) {
...
void OAICatalogsFeedProcessingResult::initializeModel() {
    ...
    m_video_counts_isSet = false;
    m_video_counts_isValid = false;
}

void OAICatalogsFeedProcessingResult::fromJson(const QString &jsonString) {
...
void OAICatalogsFeedProcessingResult::fromJsonObject(QJsonObject json) {
    ...
    m_video_counts_isValid = ::OpenAPI::fromJsonValue(m_video_counts, json[QString("video_counts")]);
    m_video_counts_isSet = !json[QString("video_counts")].isNull() && m_video_counts_isValid;
}
...
QJsonObject OAICatalogsFeedProcessingResult::asJsonObject() const {
    ...
    if (m_video_counts.isSet()) {
        obj.insert(QString("video_counts"), ::OpenAPI::toJsonValue(m_video_counts));
    }
    return obj;
}
...
OAICatalogsFeedVideoCounts OAICatalogsFeedProcessingResult::getVideoCounts() const {
    return m_video_counts;
}
void OAICatalogsFeedProcessingResult::setVideoCounts(const OAICatalogsFeedVideoCounts &video_counts) {
    m_video_counts = video_counts;
    m_video_counts_isSet = true;
}

bool OAICatalogsFeedProcessingResult::is_video_counts_Set() const{
    return m_video_counts_isSet;
}

bool OAICatalogsFeedProcessingResult::is_video_counts_Valid() const{
    return m_video_counts_isValid;
}
...
bool OAICatalogsFeedProcessingResult::isValid() const {
    ...
    return m_created_at_isValid && m_id_isValid && m_ingestion_details_isValid && m_product_counts_isValid && m_status_isValid && m_updated_at_isValid && m_validation_details_isValid && true;
}
