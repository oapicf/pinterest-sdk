...
bool OAIAdGroupCommon::isIsCreativeOptimization() const {
    return m_is_creative_optimization;
}
void OAIAdGroupCommon::setIsCreativeOptimization(const bool &is_creative_optimization) {
    m_is_creative_optimization = is_creative_optimization;
    m_is_creative_optimization_isSet = true;
}

bool OAIAdGroupCommon::is_is_creative_optimization_Set() const{
    return m_is_creative_optimization_isSet;
}

bool OAIAdGroupCommon::is_is_creative_optimization_Valid() const{
...
OAIOptimizationGoalMetadata OAIAdGroupCommon::getOptimizationGoalMetadata() const {
    return m_optimization_goal_metadata;
}
void OAIAdGroupCommon::setOptimizationGoalMetadata(const OAIOptimizationGoalMetadata &optimization_goal_metadata) {
    m_optimization_goal_metadata = optimization_goal_metadata;
    m_optimization_goal_metadata_isSet = true;
}

bool OAIAdGroupCommon::is_optimization_goal_metadata_Set() const{
    return m_optimization_goal_metadata_isSet;
}

bool OAIAdGroupCommon::is_optimization_goal_metadata_Valid() const{
...
QString OAIAdGroupCommon::getPromotionApplicationLevel() const {
    return m_promotion_application_level;
}
void OAIAdGroupCommon::setPromotionApplicationLevel(const QString &promotion_application_level) {
    m_promotion_application_level = promotion_application_level;
    m_promotion_application_level_isSet = true;
}

bool OAIAdGroupCommon::is_promotion_application_level_Set() const{
    return m_promotion_application_level_isSet;
}

bool OAIAdGroupCommon::is_promotion_application_level_Valid() const{
    return m_promotion_application_level_isValid;
}

QString OAIAdGroupCommon::getPromotionId() const {
    return m_promotion_id;
}
void OAIAdGroupCommon::setPromotionId(const QString &promotion_id) {
    m_promotion_id = promotion_id;
    m_promotion_id_isSet = true;
}

bool OAIAdGroupCommon::is_promotion_id_Set() const{
    return m_promotion_id_isSet;
}

bool OAIAdGroupCommon::is_promotion_id_Valid() const{
...
OAITargetingSpec OAIAdGroupCommon::getTargetingSpec() const {
    return m_targeting_spec;
}
void OAIAdGroupCommon::setTargetingSpec(const OAITargetingSpec &targeting_spec) {
...
QList<QString> OAIAdGroupCommon::getTargetingTemplateIds() const {
    return m_targeting_template_ids;
}
void OAIAdGroupCommon::setTargetingTemplateIds(const QList<QString> &targeting_template_ids) {
    m_targeting_template_ids = targeting_template_ids;
    m_targeting_template_ids_isSet = true;
}

bool OAIAdGroupCommon::is_targeting_template_ids_Set() const{
    return m_targeting_template_ids_isSet;
}

bool OAIAdGroupCommon::is_targeting_template_ids_Valid() const{
    return m_targeting_template_ids_isValid;
}

OAITrackingUrls OAIAdGroupCommon::getTrackingUrls() const {
    return m_tracking_urls;
}
void OAIAdGroupCommon::setTrackingUrls(const OAITrackingUrls &tracking_urls) {
