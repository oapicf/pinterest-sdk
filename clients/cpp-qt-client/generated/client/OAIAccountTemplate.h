...
public:
    OAIAccountTemplate();
    OAIAccountTemplate(const QString &json);
    ...
    QJsonValue getAttributionType() const;
    void setAttributionType(const QJsonValue &attribution_type);
    ...
    QJsonValue getSortBy() const;
    void setSortBy(const QJsonValue &sort_by);
...
private:
    ...
    QList<QString> m_ade_columns;
    bool m_ade_columns_isSet;
    bool m_ade_columns_isValid;

    QJsonValue m_attribution_type;
    ...
    QList<OAIReportingColumn> m_columns;
    bool m_columns_isSet;
    bool m_columns_isValid;

    OAIConversionReportTimeType m_conversion_report_time_type;
    bool m_conversion_report_time_type_isSet;
    bool m_conversion_report_time_type_isValid;

    OAICreationSource m_creation_source;
    ...
    QList<OAIIngestionSource> m_ingestion_sources;
