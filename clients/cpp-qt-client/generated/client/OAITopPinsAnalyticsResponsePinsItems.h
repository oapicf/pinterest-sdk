...
/*
 * OAITopPinsAnalyticsResponsePinsItems.h
 *
 * Array with metrics, status, and pin id for the requested metric
 */

#ifndef OAITopPinsAnalyticsResponsePinsItems_H
#define OAITopPinsAnalyticsResponsePinsItems_H
...
class OAITopPinsAnalyticsResponsePinsItems : public OAIObject {
public:
    OAITopPinsAnalyticsResponsePinsItems();
    OAITopPinsAnalyticsResponsePinsItems(const QString &json);
    ~OAITopPinsAnalyticsResponsePinsItems() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITopPinsAnalyticsResponsePinsItems)

#endif // OAITopPinsAnalyticsResponsePinsItems_H
