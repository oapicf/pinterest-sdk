...
public:
    ...
    OAIAdGroupUpdateRequest(const QString &json);
    ...
    QString getPromotionApplicationLevel() const;
    void setPromotionApplicationLevel(const QString &promotion_application_level);
...
private:
    ...
    OAIObject m_optimization_goal_metadata;
    ...
    QString m_promotion_application_level;
