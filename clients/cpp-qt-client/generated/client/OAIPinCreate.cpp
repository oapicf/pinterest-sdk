...
OAIPinCreate::OAIPinCreate(const QString &json) {
...
void OAIPinCreate::fromJson(const QString &jsonString) {
...
OAIAiDisclosures OAIPinCreate::getAiDisclosures() const {
    return m_ai_disclosures;
}
void OAIPinCreate::setAiDisclosures(const OAIAiDisclosures &ai_disclosures) {
    m_ai_disclosures = ai_disclosures;
    m_ai_disclosures_isSet = true;
}

bool OAIPinCreate::is_ai_disclosures_Set() const{
    return m_ai_disclosures_isSet;
}

bool OAIPinCreate::is_ai_disclosures_Valid() const{
