...
OAIPinMediaSourceImageBase64::OAIPinMediaSourceImageBase64(const QString &json) {
...
void OAIPinMediaSourceImageBase64::fromJson(const QString &jsonString) {
...
OAIContentType OAIPinMediaSourceImageBase64::getContentType() const {
    return m_content_type;
}
void OAIPinMediaSourceImageBase64::setContentType(const OAIContentType &content_type) {
...
bool OAIPinMediaSourceImageBase64::isValid() const {
    ...
    return m_content_type_isValid && m_data_isValid && m_source_type_isValid && true;
}
