...
OAILeadFormQuestion::OAILeadFormQuestion(const QString &json) {
...
void OAILeadFormQuestion::fromJson(const QString &jsonString) {
...
void OAILeadFormQuestion::fromJsonObject(QJsonObject json) {
    ...
    m_custom_question_field_type_isValid = ::OpenAPI::fromJsonValue(m_custom_question_field_type, json[QString("custom_question_field_type")]);
    m_custom_question_field_type_isSet = !json[QString("custom_question_field_type")].isNull() && m_custom_question_field_type_isValid;

    m_custom_question_label_isValid = ::OpenAPI::fromJsonValue(m_custom_question_label, json[QString("custom_question_label")]);
    m_custom_question_label_isSet = !json[QString("custom_question_label")].isNull() && m_custom_question_label_isValid;

    m_custom_question_options_isValid = ::OpenAPI::fromJsonValue(m_custom_question_options, json[QString("custom_question_options")]);
...
QJsonObject OAILeadFormQuestion::asJsonObject() const {
    QJsonObject obj;
    if (m_custom_question_field_type.isSet()) {
        obj.insert(QString("custom_question_field_type"), ::OpenAPI::toJsonValue(m_custom_question_field_type));
    }
    if (m_custom_question_label_isSet) {
        obj.insert(QString("custom_question_label"), ::OpenAPI::toJsonValue(m_custom_question_label));
    }
    if (m_custom_question_options.size() > 0) {
        obj.insert(QString("custom_question_options"), ::OpenAPI::toJsonValue(m_custom_question_options));
    }
...
void OAILeadFormQuestion::setCustomQuestionFieldType(const OAILeadFormQuestionFieldType &custom_question_field_type) {
    m_custom_question_field_type = custom_question_field_type;
    m_custom_question_field_type_isSet = true;
}
...
void OAILeadFormQuestion::setCustomQuestionLabel(const QString &custom_question_label) {
    m_custom_question_label = custom_question_label;
    m_custom_question_label_isSet = true;
}
...
void OAILeadFormQuestion::setCustomQuestionOptions(const QList<QString> &custom_question_options) {
    m_custom_question_options = custom_question_options;
    m_custom_question_options_isSet = true;
}
