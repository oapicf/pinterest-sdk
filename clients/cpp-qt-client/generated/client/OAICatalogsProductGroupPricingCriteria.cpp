...
OAICatalogsProductGroupPricingCriteria::OAICatalogsProductGroupPricingCriteria(const QString &json) {
...
void OAICatalogsProductGroupPricingCriteria::fromJson(const QString &jsonString) {
