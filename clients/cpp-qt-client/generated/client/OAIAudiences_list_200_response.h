...
public:
    ...
    QList<OAIAdAccountsAudience> getItems() const;
    void setItems(const QList<OAIAdAccountsAudience> &items);
...
private:
    ...
    QList<OAIAdAccountsAudience> m_items;
    bool m_items_isSet;
