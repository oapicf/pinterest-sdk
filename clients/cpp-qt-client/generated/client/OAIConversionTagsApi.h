...
Q_SIGNALS:
    ...
    void conversionTags_createSignalE(OAIConversionTag summary, QNetworkReply::NetworkError error_type, QString error_str);
    ...
    void conversionTags_getSignalE(OAIConversionTag summary, QNetworkReply::NetworkError error_type, QString error_str);
    ...
    void conversionTags_listSignalE(OAIConversion_tags_list_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
