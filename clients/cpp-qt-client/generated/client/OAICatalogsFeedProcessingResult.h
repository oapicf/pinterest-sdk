...
public:
    ...
    OAICatalogsFeedVideoCounts getVideoCounts() const;
    void setVideoCounts(const OAICatalogsFeedVideoCounts &video_counts);
    bool is_video_counts_Set() const;
    bool is_video_counts_Valid() const;
...
private:
    ...
    OAICatalogsFeedIngestionDetails m_ingestion_details;
    bool m_ingestion_details_isSet;
    bool m_ingestion_details_isValid;

    OAICatalogsFeedProductCounts m_product_counts;
    ...
    OAICatalogsFeedValidationDetails m_validation_details;
    bool m_validation_details_isSet;
    bool m_validation_details_isValid;

    OAICatalogsFeedVideoCounts m_video_counts;
    bool m_video_counts_isSet;
    bool m_video_counts_isValid;
};
