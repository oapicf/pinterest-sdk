...
OAIAdCommon_tracking_urls OAICampaignCreateResponseData::getTrackingUrls() const {
    return m_tracking_urls;
}
void OAICampaignCreateResponseData::setTrackingUrls(const OAIAdCommon_tracking_urls &tracking_urls) {
