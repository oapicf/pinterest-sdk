...
OAICatalogsItemValidationIssues::OAICatalogsItemValidationIssues(const QString &json) {
...
void OAICatalogsItemValidationIssues::fromJson(const QString &jsonString) {
...
void OAICatalogsItemValidationIssues::fromJsonObject(QJsonObject json) {
    ...
    m_item_number_isValid = ::OpenAPI::fromJsonValue(m_item_number, json[QString("item_number")]);
...
QJsonObject OAICatalogsItemValidationIssues::asJsonObject() const {
    ...
    if (m_item_number_isSet) {
        obj.insert(QString("item_number"), ::OpenAPI::toJsonValue(m_item_number));
    }
    if (m_warnings.isSet()) {
...
void OAICatalogsItemValidationIssues::setItemNumber(const qint32 &item_number) {
    m_item_number = item_number;
    m_item_number_isSet = true;
}
...
bool OAICatalogsItemValidationIssues::isValid() const {
    ...
    return m_errors_isValid && m_item_id_isValid && m_item_number_isValid && m_warnings_isValid && true;
}
