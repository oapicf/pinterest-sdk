...
public:
    ...
    */
    virtual void pins_list(const ::OpenAPI::OptionalParam<QString> &pin_filter = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &pin_metrics = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<bool> &include_protected_pins = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<QString> &pin_type = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QList<OAICreativeType>> &creative_types = ::OpenAPI::OptionalParam<QList<OAICreativeType>>(), const ::OpenAPI::OptionalParam<QString> &ad_account_id = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &bookmark = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<qint32> &page_size = ::OpenAPI::OptionalParam<qint32>());
