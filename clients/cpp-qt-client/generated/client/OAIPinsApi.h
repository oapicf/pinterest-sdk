...
public:
    ...
    */
    void pins_save(const QString &pin_id, const OAIPins_save_request &oai_pins_save_request);
...
Q_SIGNALS:
    ...
    void pins_analyticsSignalError(QMap<QString, OAIAnalyticsMetricsResponse> summary, QNetworkReply::NetworkError error_type, const QString &error_str);
