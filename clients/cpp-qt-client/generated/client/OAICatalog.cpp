...
OAICatalog::OAICatalog(const QString &json) {
...
void OAICatalog::fromJson(const QString &jsonString) {
...
bool OAICatalog::isValid() const {
    ...
    return m_catalog_type_isValid && m_created_at_isValid && m_id_isValid && m_name_isValid && m_updated_at_isValid && true;
}
