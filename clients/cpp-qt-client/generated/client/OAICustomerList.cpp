...
OAICustomerList::OAICustomerList(const QString &json) {
...
void OAICustomerList::fromJson(const QString &jsonString) {
...
bool OAICustomerList::isIsNca() const {
    return m_is_nca;
}
void OAICustomerList::setIsNca(const bool &is_nca) {
    m_is_nca = is_nca;
    m_is_nca_isSet = true;
}

bool OAICustomerList::is_is_nca_Set() const{
    return m_is_nca_isSet;
}

bool OAICustomerList::is_is_nca_Valid() const{
...
OAICustomerListStatus OAICustomerList::getStatus() const {
    return m_status;
}
void OAICustomerList::setStatus(const OAICustomerListStatus &status) {
    m_status = status;
    m_status_isSet = true;
}
