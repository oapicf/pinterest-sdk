...
public:
    ...
    */
    virtual void billingInvoices_get(const QString &ad_account_id, const ::OpenAPI::OptionalParam<QString> &bookmark = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<qint32> &page_size = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &sort = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &order = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &status = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &document_type = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QDate> &start_due_date = ::OpenAPI::OptionalParam<QDate>(), const ::OpenAPI::OptionalParam<QDate> &end_due_date = ::OpenAPI::OptionalParam<QDate>());
...
Q_SIGNALS:
    ...
    Q_DECL_DEPRECATED_X("Use billingInvoiceDownload_getSignalError() instead")
    void billingInvoiceDownload_getSignalE(OAIBillingInvoiceDownloadResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    ...
    Q_DECL_DEPRECATED_X("Use billingInvoices_getSignalError() instead")
    void billingInvoices_getSignalE(OAIBilling_invoices_get_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    ...
    Q_DECL_DEPRECATED_X("Use billingInvoiceDownload_getSignalErrorFull() instead")
    void billingInvoiceDownload_getSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    ...
    Q_DECL_DEPRECATED_X("Use billingInvoices_getSignalErrorFull() instead")
    void billingInvoices_getSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
