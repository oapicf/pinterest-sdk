...
public:
    ...
    */
    void adsCredit_redeem(const QString &ad_account_id, const OAIAdsCreditRedeemRequest &oai_ads_credit_redeem_request);
    ...
    */
    void adsCreditsDiscounts_get(const QString &ad_account_id, const ::OpenAPI::OptionalParam<QString> &bookmark = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<qint32> &page_size = ::OpenAPI::OptionalParam<qint32>());
    ...
    * @param[in]  page_size qint32 [optional]
    */
    void billingProfiles_get(const QString &ad_account_id, const bool &is_active, const ::OpenAPI::OptionalParam<QString> &bookmark = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<qint32> &page_size = ::OpenAPI::OptionalParam<qint32>());

    /**
    * @param[in]  ad_account_id QString [required]
    */
    void ssioAccounts_get(const QString &ad_account_id);

    /**
    * @param[in]  ad_account_id QString [required]
    * @param[in]  oaissio_create_insertion_order_request OAISSIOCreateInsertionOrderRequest [required]
    */
    void ssioInsertionOrder_create(const QString &ad_account_id, const OAISSIOCreateInsertionOrderRequest &oaissio_create_insertion_order_request);

    /**
    * @param[in]  ad_account_id QString [required]
    * @param[in]  oaissio_edit_insertion_order_request OAISSIOEditInsertionOrderRequest [required]
    */
    void ssioInsertionOrder_edit(const QString &ad_account_id, const OAISSIOEditInsertionOrderRequest &oaissio_edit_insertion_order_request);
    ...
    * @param[in]  page_size qint32 [optional]
    */
    void ssioInsertionOrdersStatus_getByAdAccount(const QString &ad_account_id, const ::OpenAPI::OptionalParam<QString> &bookmark = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<qint32> &page_size = ::OpenAPI::OptionalParam<qint32>());

    /**
    * @param[in]  ad_account_id QString [required]
    * @param[in]  pin_order_id QString [required]
    */
    void ssioInsertionOrdersStatus_getByPinOrderId(const QString &ad_account_id, const QString &pin_order_id);
    ...
    */
    void ssioOrderLines_getByAdAccount(const QString &ad_account_id, const ::OpenAPI::OptionalParam<QString> &bookmark = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<qint32> &page_size = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &pin_order_id = ::OpenAPI::OptionalParam<QString>());
