...
Q_SIGNALS:
    ...
    void adAccountsSubscriptions_getByIdSignalE(OAILeadSubscription summary, QNetworkReply::NetworkError error_type, QString error_str);
    ...
    void adAccountsSubscriptions_postSignalE(OAILeadSubscription summary, QNetworkReply::NetworkError error_type, QString error_str);
