...
public:
    ...
    */
    virtual void adAccountsSubscriptions_getList(const QString &ad_account_id, const ::OpenAPI::OptionalParam<QString> &bookmark = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<qint32> &page_size = ::OpenAPI::OptionalParam<qint32>());

    /**
    * @param[in]  ad_account_id QString [required]
    * @param[in]  oai_lead_subscription_post_params_create OAILeadSubscriptionPostParamsCreate [required]
    */
    virtual void adAccountsSubscriptions_post(const QString &ad_account_id, const OAILeadSubscriptionPostParamsCreate &oai_lead_subscription_post_params_create);
...
Q_SIGNALS:
    ...
    void adAccountsSubscriptions_delByIdSignal(OAILeadSubscription summary);
    void adAccountsSubscriptions_getByIdSignal(OAILeadSubscription summary);
    void adAccountsSubscriptions_getListSignal(OAIAd_accounts_subscriptions_get_list_200_response summary);
    void adAccountsSubscriptions_postSignal(OAILeadSubscription summary);


    void adAccountsSubscriptions_delByIdSignalFull(OAIHttpRequestWorker *worker, OAILeadSubscription summary);
    void adAccountsSubscriptions_getByIdSignalFull(OAIHttpRequestWorker *worker, OAILeadSubscription summary);
    ...
    void adAccountsSubscriptions_postSignalFull(OAIHttpRequestWorker *worker, OAILeadSubscription summary);

    void adAccountsSubscriptions_delByIdSignalError(OAILeadSubscription summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    void adAccountsSubscriptions_getByIdSignalError(OAILeadSubscription summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void adAccountsSubscriptions_postSignalError(OAILeadSubscription summary, QNetworkReply::NetworkError error_type, const QString &error_str);
