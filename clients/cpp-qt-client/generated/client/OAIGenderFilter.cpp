...
OAICatalogsProductGroupMultipleStringCriteria OAIGenderFilter::getGender() const {
    return m_gender;
}
void OAIGenderFilter::setGender(const OAICatalogsProductGroupMultipleStringCriteria &gender) {
    m_gender = gender;
    m_gender_isSet = true;
}
