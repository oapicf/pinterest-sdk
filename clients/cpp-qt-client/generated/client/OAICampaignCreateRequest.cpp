...
OAICampaignSummaryStatus OAICampaignCreateRequest::getSummaryStatus() const {
    return m_summary_status;
}
void OAICampaignCreateRequest::setSummaryStatus(const OAICampaignSummaryStatus &summary_status) {
    m_summary_status = summary_status;
    m_summary_status_isSet = true;
}

bool OAICampaignCreateRequest::is_summary_status_Set() const{
    return m_summary_status_isSet;
}

bool OAICampaignCreateRequest::is_summary_status_Valid() const{
