...
/*
 * OAILeadSubscriptionPostParamsCreate.h
 *
 * 
 */

#ifndef OAILeadSubscriptionPostParamsCreate_H
#define OAILeadSubscriptionPostParamsCreate_H
...
namespace OpenAPI {
class OAILeadSubscriptionPostParamsCreate_allOf_partner_metadata;

class OAILeadSubscriptionPostParamsCreate : public OAIObject {
public:
    OAILeadSubscriptionPostParamsCreate();
    OAILeadSubscriptionPostParamsCreate(QString json);
    ~OAILeadSubscriptionPostParamsCreate() override;
    ...
    OAILeadSubscriptionPostParamsCreate_allOf_partner_metadata getPartnerMetadata() const;
    void setPartnerMetadata(const OAILeadSubscriptionPostParamsCreate_allOf_partner_metadata &partner_metadata);
...
private:
    ...
    OAILeadSubscriptionPostParamsCreate_allOf_partner_metadata m_partner_metadata;
...
Q_DECLARE_METATYPE(OpenAPI::OAILeadSubscriptionPostParamsCreate)

#endif // OAILeadSubscriptionPostParamsCreate_H
