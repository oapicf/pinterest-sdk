...
bool OAIAdGroupResponse::isIsCreativeOptimization() const {
    return m_is_creative_optimization;
}
void OAIAdGroupResponse::setIsCreativeOptimization(const bool &is_creative_optimization) {
    m_is_creative_optimization = is_creative_optimization;
    m_is_creative_optimization_isSet = true;
}

bool OAIAdGroupResponse::is_is_creative_optimization_Set() const{
    return m_is_creative_optimization_isSet;
}

bool OAIAdGroupResponse::is_is_creative_optimization_Valid() const{
...
QString OAIAdGroupResponse::getPromotionApplicationLevel() const {
    return m_promotion_application_level;
}
void OAIAdGroupResponse::setPromotionApplicationLevel(const QString &promotion_application_level) {
    m_promotion_application_level = promotion_application_level;
    m_promotion_application_level_isSet = true;
}

bool OAIAdGroupResponse::is_promotion_application_level_Set() const{
    return m_promotion_application_level_isSet;
}

bool OAIAdGroupResponse::is_promotion_application_level_Valid() const{
    return m_promotion_application_level_isValid;
}

QString OAIAdGroupResponse::getPromotionId() const {
    return m_promotion_id;
}
void OAIAdGroupResponse::setPromotionId(const QString &promotion_id) {
    m_promotion_id = promotion_id;
    m_promotion_id_isSet = true;
}

bool OAIAdGroupResponse::is_promotion_id_Set() const{
    return m_promotion_id_isSet;
}

bool OAIAdGroupResponse::is_promotion_id_Valid() const{
...
double OAIAdGroupResponse::getBidMultiplier() const {
    return m_bid_multiplier;
}
void OAIAdGroupResponse::setBidMultiplier(const double &bid_multiplier) {
    m_bid_multiplier = bid_multiplier;
    m_bid_multiplier_isSet = true;
}

bool OAIAdGroupResponse::is_bid_multiplier_Set() const{
    return m_bid_multiplier_isSet;
}

bool OAIAdGroupResponse::is_bid_multiplier_Valid() const{
