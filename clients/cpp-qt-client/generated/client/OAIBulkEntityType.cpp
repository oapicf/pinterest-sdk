...
OAIBulkEntityType::OAIBulkEntityType(const QString &json) {
...
void OAIBulkEntityType::fromJson(const QString &jsonString) {
    ...
    if ( jsonString.compare("CAMPAIGN", Qt::CaseInsensitive) == 0) {
        ...
        m_value = eOAIBulkEntityType::LABEL;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("SCHEDULE", Qt::CaseInsensitive) == 0) {
        m_value = eOAIBulkEntityType::SCHEDULE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ENTITY_HISTORY", Qt::CaseInsensitive) == 0) {
        m_value = eOAIBulkEntityType::ENTITY_HISTORY;
        m_value_isSet = m_value_isValid = true;
    }
}
...
QString OAIBulkEntityType::asJson() const {
    ...
    switch (m_value){
        ...
        case eOAIBulkEntityType::KEYWORD:
            val = "KEYWORD";
            break;
        case eOAIBulkEntityType::LABEL:
            val = "LABEL";
            break;
        case eOAIBulkEntityType::SCHEDULE:
            val = "SCHEDULE";
            break;
        case eOAIBulkEntityType::ENTITY_HISTORY:
            val = "ENTITY_HISTORY";
            break;
        default:
            break;
