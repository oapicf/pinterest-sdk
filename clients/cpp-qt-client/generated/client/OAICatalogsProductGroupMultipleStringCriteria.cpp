...
OAICatalogsProductGroupMultipleStringCriteria::OAICatalogsProductGroupMultipleStringCriteria(const QString &json) {
...
void OAICatalogsProductGroupMultipleStringCriteria::fromJson(const QString &jsonString) {
