...
OAIBatchOperationStatus::OAIBatchOperationStatus(const QString &json) {
...
void OAIBatchOperationStatus::fromJson(const QString &jsonString) {
    ...
    if ( jsonString.compare("PROCESSING", Qt::CaseInsensitive) == 0) {
        ...
        m_value = eOAIBatchOperationStatus::FAILED;
        m_value_isSet = m_value_isValid = true;
    }
}
...
QString OAIBatchOperationStatus::asJson() const {
    ...
    switch (m_value){
        ...
        case eOAIBatchOperationStatus::COMPLETED:
            val = "COMPLETED";
            break;
        case eOAIBatchOperationStatus::FAILED:
            val = "FAILED";
            break;
        default:
            break;
