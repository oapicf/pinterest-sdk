...
/*
 * OAILeadFormBatchUpdate.h
 *
 * 
 */

#ifndef OAILeadFormBatchUpdate_H
#define OAILeadFormBatchUpdate_H
...
class OAILeadFormBatchUpdate : public OAIObject {
public:
    OAILeadFormBatchUpdate();
    OAILeadFormBatchUpdate(const QString &json);
    ~OAILeadFormBatchUpdate() override;
...
private:
    ...
    QList<OAILeadFormPolicyLink> m_policy_links;
...
Q_DECLARE_METATYPE(OpenAPI::OAILeadFormBatchUpdate)

#endif // OAILeadFormBatchUpdate_H
