...
QString OAIAdResponse_allOf::getAdAccountId() const {
    return ad_account_id;
}
void OAIAdResponse_allOf::setAdAccountId(const QString &ad_account_id) {
    this->ad_account_id = ad_account_id;
    this->m_ad_account_id_isSet = true;
}

bool OAIAdResponse_allOf::is_ad_account_id_Set() const{
    return m_ad_account_id_isSet;
}

bool OAIAdResponse_allOf::is_ad_account_id_Valid() const{
    return m_ad_account_id_isValid;
}

QString OAIAdResponse_allOf::getCampaignId() const {
    return campaign_id;
}
void OAIAdResponse_allOf::setCampaignId(const QString &campaign_id) {
    this->campaign_id = campaign_id;
    this->m_campaign_id_isSet = true;
}

bool OAIAdResponse_allOf::is_campaign_id_Set() const{
    return m_campaign_id_isSet;
}

bool OAIAdResponse_allOf::is_campaign_id_Valid() const{
    return m_campaign_id_isValid;
}

QString OAIAdResponse_allOf::getCollectionItemsDestinationUrlTemplate() const {
    return collection_items_destination_url_template;
}
void OAIAdResponse_allOf::setCollectionItemsDestinationUrlTemplate(const QString &collection_items_destination_url_template) {
...
bool OAIAdResponse_allOf::is_collection_items_destination_url_template_Set() const{
    return m_collection_items_destination_url_template_isSet;
}

bool OAIAdResponse_allOf::is_collection_items_destination_url_template_Valid() const{
    return m_collection_items_destination_url_template_isValid;
}

qint32 OAIAdResponse_allOf::getCreatedTime() const {
    return created_time;
}
void OAIAdResponse_allOf::setCreatedTime(const qint32 &created_time) {
    this->created_time = created_time;
    this->m_created_time_isSet = true;
}

bool OAIAdResponse_allOf::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIAdResponse_allOf::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIAdResponse_allOf::getId() const {
    return id;
}
void OAIAdResponse_allOf::setId(const QString &id) {
    this->id = id;
    this->m_id_isSet = true;
}

bool OAIAdResponse_allOf::is_id_Set() const{
    return m_id_isSet;
}

bool OAIAdResponse_allOf::is_id_Valid() const{
    return m_id_isValid;
}

QList<QString> OAIAdResponse_allOf::getRejectedReasons() const {
    return rejected_reasons;
}
void OAIAdResponse_allOf::setRejectedReasons(const QList<QString> &rejected_reasons) {
    this->rejected_reasons = rejected_reasons;
    this->m_rejected_reasons_isSet = true;
}

bool OAIAdResponse_allOf::is_rejected_reasons_Set() const{
    return m_rejected_reasons_isSet;
}

bool OAIAdResponse_allOf::is_rejected_reasons_Valid() const{
    return m_rejected_reasons_isValid;
}

QList<QString> OAIAdResponse_allOf::getRejectionLabels() const {
    return rejection_labels;
}
void OAIAdResponse_allOf::setRejectionLabels(const QList<QString> &rejection_labels) {
    this->rejection_labels = rejection_labels;
    this->m_rejection_labels_isSet = true;
}

bool OAIAdResponse_allOf::is_rejection_labels_Set() const{
    return m_rejection_labels_isSet;
}

bool OAIAdResponse_allOf::is_rejection_labels_Valid() const{
    return m_rejection_labels_isValid;
}

QString OAIAdResponse_allOf::getReviewStatus() const {
    return review_status;
}
void OAIAdResponse_allOf::setReviewStatus(const QString &review_status) {
    this->review_status = review_status;
    this->m_review_status_isSet = true;
}

bool OAIAdResponse_allOf::is_review_status_Set() const{
    return m_review_status_isSet;
}

bool OAIAdResponse_allOf::is_review_status_Valid() const{
    return m_review_status_isValid;
}

QString OAIAdResponse_allOf::getType() const {
    return type;
}
void OAIAdResponse_allOf::setType(const QString &type) {
    this->type = type;
    this->m_type_isSet = true;
}

bool OAIAdResponse_allOf::is_type_Set() const{
    return m_type_isSet;
}

bool OAIAdResponse_allOf::is_type_Valid() const{
    return m_type_isValid;
}

qint32 OAIAdResponse_allOf::getUpdatedTime() const {
    return updated_time;
}
void OAIAdResponse_allOf::setUpdatedTime(const qint32 &updated_time) {
    this->updated_time = updated_time;
    this->m_updated_time_isSet = true;
}

bool OAIAdResponse_allOf::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIAdResponse_allOf::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

OAIPinPromotionSummaryStatus OAIAdResponse_allOf::getSummaryStatus() const {
    return summary_status;
}
void OAIAdResponse_allOf::setSummaryStatus(const OAIPinPromotionSummaryStatus &summary_status) {
    this->summary_status = summary_status;
    this->m_summary_status_isSet = true;
}

bool OAIAdResponse_allOf::is_summary_status_Set() const{
    return m_summary_status_isSet;
}

bool OAIAdResponse_allOf::is_summary_status_Valid() const{
