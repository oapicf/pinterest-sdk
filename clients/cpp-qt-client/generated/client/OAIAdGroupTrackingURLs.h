...
#ifndef OAIAdGroupTrackingURLs_H
#define OAIAdGroupTrackingURLs_H
...
class OAIAdGroupTrackingURLs : public OAIObject {
public:
    OAIAdGroupTrackingURLs();
    OAIAdGroupTrackingURLs(const QString &json);
    ~OAIAdGroupTrackingURLs() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAdGroupTrackingURLs)

#endif // OAIAdGroupTrackingURLs_H
