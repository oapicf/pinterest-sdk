...
OAISharedAudienceAccount::OAISharedAudienceAccount(const QString &json) {
...
void OAISharedAudienceAccount::fromJson(const QString &jsonString) {
...
void OAISharedAudienceAccount::fromJsonObject(QJsonObject json) {
    ...
    m_shared_on_timestamp_isValid = ::OpenAPI::fromJsonValue(m_shared_on_timestamp, json[QString("shared_on_timestamp")]);
...
QJsonObject OAISharedAudienceAccount::asJsonObject() const {
    ...
    if (m_shared_on_timestamp_isSet) {
        obj.insert(QString("shared_on_timestamp"), ::OpenAPI::toJsonValue(m_shared_on_timestamp));
    }
    return obj;
}
...
OAIAudienceAccountType OAISharedAudienceAccount::getAccountType() const {
    return m_account_type;
}
void OAISharedAudienceAccount::setAccountType(const OAIAudienceAccountType &account_type) {
...
void OAISharedAudienceAccount::setSharedOnTimestamp(const qint32 &shared_on_timestamp) {
    m_shared_on_timestamp = shared_on_timestamp;
    m_shared_on_timestamp_isSet = true;
}
