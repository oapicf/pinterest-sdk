...
OAITopPinsAnalyticsResponse::OAITopPinsAnalyticsResponse(const QString &json) {
...
void OAITopPinsAnalyticsResponse::fromJson(const QString &jsonString) {
...
OAITopPinsAnalyticsResponseDateAvailability OAITopPinsAnalyticsResponse::getDateAvailability() const {
    return m_date_availability;
}
void OAITopPinsAnalyticsResponse::setDateAvailability(const OAITopPinsAnalyticsResponseDateAvailability &date_availability) {
...
QList<OAITopPinsAnalyticsResponsePinsItems> OAITopPinsAnalyticsResponse::getPins() const {
    return m_pins;
}
void OAITopPinsAnalyticsResponse::setPins(const QList<OAITopPinsAnalyticsResponsePinsItems> &pins) {
    m_pins = pins;
    m_pins_isSet = true;
}
...
OAITopPinsSortBy OAITopPinsAnalyticsResponse::getSortBy() const {
    return m_sort_by;
}
void OAITopPinsAnalyticsResponse::setSortBy(const OAITopPinsSortBy &sort_by) {
    m_sort_by = sort_by;
