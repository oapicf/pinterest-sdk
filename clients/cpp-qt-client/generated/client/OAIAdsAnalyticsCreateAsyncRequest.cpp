...
QList<QString> OAIAdsAnalyticsCreateAsyncRequest::getTargetingTypes() const {
    return m_targeting_types;
}
void OAIAdsAnalyticsCreateAsyncRequest::setTargetingTypes(const QList<QString> &targeting_types) {
...
QList<OAIAdsAnalyticsCreateAsyncRequest_allOf_custom_conversion_event_metrics> OAIAdsAnalyticsCreateAsyncRequest::getCustomConversionEventMetrics() const {
    return m_custom_conversion_event_metrics;
}
void OAIAdsAnalyticsCreateAsyncRequest::setCustomConversionEventMetrics(const QList<OAIAdsAnalyticsCreateAsyncRequest_allOf_custom_conversion_event_metrics> &custom_conversion_event_metrics) {
...
bool OAIAdsAnalyticsCreateAsyncRequest::isValid() const {
    ...
    return m_end_date_isValid && m_granularity_isValid && m_start_date_isValid && m_columns_isValid && m_level_isValid && true;
}
