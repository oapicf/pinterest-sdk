...
OAIAdsAnalyticsCreateAsyncRequest::OAIAdsAnalyticsCreateAsyncRequest(const QString &json) {
...
void OAIAdsAnalyticsCreateAsyncRequest::initializeModel() {
    ...
    m_campaign_brand_label_isSet = false;
    m_campaign_brand_label_isValid = false;

    m_campaign_custom_label_isSet = false;
    m_campaign_custom_label_isValid = false;
    ...
    m_combine_targeting_types_isSet = false;
    m_combine_targeting_types_isValid = false;

    m_conversion_report_time_isSet = false;
    m_conversion_report_time_isValid = false;

    m_custom_conversion_event_metrics_isSet = false;
    m_custom_conversion_event_metrics_isValid = false;
    ...
    m_reporting_timezone_isSet = false;
    m_reporting_timezone_isValid = false;
...
void OAIAdsAnalyticsCreateAsyncRequest::fromJson(const QString &jsonString) {
...
void OAIAdsAnalyticsCreateAsyncRequest::fromJsonObject(QJsonObject json) {
    ...
    m_campaign_brand_label_isValid = ::OpenAPI::fromJsonValue(m_campaign_brand_label, json[QString("campaign_brand_label")]);
    m_campaign_brand_label_isSet = !json[QString("campaign_brand_label")].isNull() && m_campaign_brand_label_isValid;

    m_campaign_custom_label_isValid = ::OpenAPI::fromJsonValue(m_campaign_custom_label, json[QString("campaign_custom_label")]);
    m_campaign_custom_label_isSet = !json[QString("campaign_custom_label")].isNull() && m_campaign_custom_label_isValid;
    ...
    m_combine_targeting_types_isValid = ::OpenAPI::fromJsonValue(m_combine_targeting_types, json[QString("combine_targeting_types")]);
    m_combine_targeting_types_isSet = !json[QString("combine_targeting_types")].isNull() && m_combine_targeting_types_isValid;
    ...
    m_custom_conversion_event_metrics_isValid = ::OpenAPI::fromJsonValue(m_custom_conversion_event_metrics, json[QString("custom_conversion_event_metrics")]);
    m_custom_conversion_event_metrics_isSet = !json[QString("custom_conversion_event_metrics")].isNull() && m_custom_conversion_event_metrics_isValid;
    ...
    m_end_hour_isValid = ::OpenAPI::fromJsonValue(m_end_hour, json[QString("end_hour")]);
    ...
    m_primary_sort_isValid = ::OpenAPI::fromJsonValue(m_primary_sort, json[QString("primary_sort")]);
    ...
    m_reporting_timezone_isValid = ::OpenAPI::fromJsonValue(m_reporting_timezone, json[QString("reporting_timezone")]);
    m_reporting_timezone_isSet = !json[QString("reporting_timezone")].isNull() && m_reporting_timezone_isValid;
...
QJsonObject OAIAdsAnalyticsCreateAsyncRequest::asJsonObject() const {
    ...
    if (m_campaign_brand_label_isSet) {
        obj.insert(QString("campaign_brand_label"), ::OpenAPI::toJsonValue(m_campaign_brand_label));
    }
    if (m_campaign_custom_label_isSet) {
        obj.insert(QString("campaign_custom_label"), ::OpenAPI::toJsonValue(m_campaign_custom_label));
    }
    ...
    if (m_combine_targeting_types_isSet) {
        obj.insert(QString("combine_targeting_types"), ::OpenAPI::toJsonValue(m_combine_targeting_types));
    }
    if (m_conversion_report_time.isSet()) {
        obj.insert(QString("conversion_report_time"), ::OpenAPI::toJsonValue(m_conversion_report_time));
    }
    if (m_custom_conversion_event_metrics.size() > 0) {
        obj.insert(QString("custom_conversion_event_metrics"), ::OpenAPI::toJsonValue(m_custom_conversion_event_metrics));
    }
    if (m_end_date_isSet) {
        obj.insert(QString("end_date"), ::OpenAPI::toJsonValue(m_end_date));
    }
    if (m_end_hour_isSet) {
        obj.insert(QString("end_hour"), ::OpenAPI::toJsonValue(m_end_hour));
    }
    ...
    if (m_primary_sort.isSet()) {
        obj.insert(QString("primary_sort"), ::OpenAPI::toJsonValue(m_primary_sort));
    }
    ...
    if (m_reporting_timezone.isSet()) {
        obj.insert(QString("reporting_timezone"), ::OpenAPI::toJsonValue(m_reporting_timezone));
    }
...
QString OAIAdsAnalyticsCreateAsyncRequest::getCampaignBrandLabel() const {
    return m_campaign_brand_label;
}
void OAIAdsAnalyticsCreateAsyncRequest::setCampaignBrandLabel(const QString &campaign_brand_label) {
    m_campaign_brand_label = campaign_brand_label;
    m_campaign_brand_label_isSet = true;
}

bool OAIAdsAnalyticsCreateAsyncRequest::is_campaign_brand_label_Set() const{
    return m_campaign_brand_label_isSet;
}

bool OAIAdsAnalyticsCreateAsyncRequest::is_campaign_brand_label_Valid() const{
    return m_campaign_brand_label_isValid;
}

QString OAIAdsAnalyticsCreateAsyncRequest::getCampaignCustomLabel() const {
    return m_campaign_custom_label;
}
void OAIAdsAnalyticsCreateAsyncRequest::setCampaignCustomLabel(const QString &campaign_custom_label) {
    m_campaign_custom_label = campaign_custom_label;
    m_campaign_custom_label_isSet = true;
}

bool OAIAdsAnalyticsCreateAsyncRequest::is_campaign_custom_label_Set() const{
    return m_campaign_custom_label_isSet;
}

bool OAIAdsAnalyticsCreateAsyncRequest::is_campaign_custom_label_Valid() const{
    return m_campaign_custom_label_isValid;
}
...
QList<OAICampaignObjectiveType> OAIAdsAnalyticsCreateAsyncRequest::getCampaignObjectiveTypes() const {
    return m_campaign_objective_types;
}
void OAIAdsAnalyticsCreateAsyncRequest::setCampaignObjectiveTypes(const QList<OAICampaignObjectiveType> &campaign_objective_types) {
...
bool OAIAdsAnalyticsCreateAsyncRequest::isCombineTargetingTypes() const {
    return m_combine_targeting_types;
}
void OAIAdsAnalyticsCreateAsyncRequest::setCombineTargetingTypes(const bool &combine_targeting_types) {
    m_combine_targeting_types = combine_targeting_types;
    m_combine_targeting_types_isSet = true;
}

bool OAIAdsAnalyticsCreateAsyncRequest::is_combine_targeting_types_Set() const{
    return m_combine_targeting_types_isSet;
}

bool OAIAdsAnalyticsCreateAsyncRequest::is_combine_targeting_types_Valid() const{
    return m_combine_targeting_types_isValid;
}
...
QList<OAICustomConversionEventMetrics> OAIAdsAnalyticsCreateAsyncRequest::getCustomConversionEventMetrics() const {
    return m_custom_conversion_event_metrics;
}
void OAIAdsAnalyticsCreateAsyncRequest::setCustomConversionEventMetrics(const QList<OAICustomConversionEventMetrics> &custom_conversion_event_metrics) {
    m_custom_conversion_event_metrics = custom_conversion_event_metrics;
    m_custom_conversion_event_metrics_isSet = true;
}

bool OAIAdsAnalyticsCreateAsyncRequest::is_custom_conversion_event_metrics_Set() const{
    return m_custom_conversion_event_metrics_isSet;
}

bool OAIAdsAnalyticsCreateAsyncRequest::is_custom_conversion_event_metrics_Valid() const{
    return m_custom_conversion_event_metrics_isValid;
}
...
OAIPrimarySort OAIAdsAnalyticsCreateAsyncRequest::getPrimarySort() const {
    return m_primary_sort;
}
void OAIAdsAnalyticsCreateAsyncRequest::setPrimarySort(const OAIPrimarySort &primary_sort) {
    m_primary_sort = primary_sort;
    m_primary_sort_isSet = true;
}
...
OAIReportingTimeZone OAIAdsAnalyticsCreateAsyncRequest::getReportingTimezone() const {
    return m_reporting_timezone;
}
void OAIAdsAnalyticsCreateAsyncRequest::setReportingTimezone(const OAIReportingTimeZone &reporting_timezone) {
    m_reporting_timezone = reporting_timezone;
    m_reporting_timezone_isSet = true;
}

bool OAIAdsAnalyticsCreateAsyncRequest::is_reporting_timezone_Set() const{
    return m_reporting_timezone_isSet;
}

bool OAIAdsAnalyticsCreateAsyncRequest::is_reporting_timezone_Valid() const{
    return m_reporting_timezone_isValid;
}
...
QList<OAIAdAdsAnalyticsAsyncTargetingTypes> OAIAdsAnalyticsCreateAsyncRequest::getTargetingTypes() const {
    return m_targeting_types;
}
void OAIAdsAnalyticsCreateAsyncRequest::setTargetingTypes(const QList<OAIAdAdsAnalyticsAsyncTargetingTypes> &targeting_types) {
...
bool OAIAdsAnalyticsCreateAsyncRequest::isValid() const {
    ...
    return m_end_date_isValid && m_granularity_isValid && m_start_date_isValid && true;
}
