...
/*
 * OAITargetingTemplateCommon.h
 *
 * 
 */

#ifndef OAITargetingTemplateCommon_H
#define OAITargetingTemplateCommon_H
...
class OAITargetingTemplateCommon : public OAIObject {
public:
    OAITargetingTemplateCommon();
    OAITargetingTemplateCommon(QString json);
    ~OAITargetingTemplateCommon() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITargetingTemplateCommon)

#endif // OAITargetingTemplateCommon_H
