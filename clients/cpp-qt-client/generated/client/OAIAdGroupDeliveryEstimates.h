...
public:
    ...
    OAIAdGroupDeliveryEstimates(const QString &json);
...
private:
    ...
    QList<OAIAdGroupAudienceSizingCreativeTypes> m_creative_types;
    bool m_creative_types_isSet;
    bool m_creative_types_isValid;

    QList<OAIAdGroupDeliveryEstimatesKeywordsItems> m_keywords;
    bool m_keywords_isSet;
    bool m_keywords_isValid;

    qint32 m_monthly_frequency_cap;
