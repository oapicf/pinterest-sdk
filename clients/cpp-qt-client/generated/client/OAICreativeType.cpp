...
OAICreativeType::OAICreativeType(const QString &json) {
...
void OAICreativeType::fromJson(const QString &jsonString) {
    ...
    else if ( jsonString.compare("COLLAGE", Qt::CaseInsensitive) == 0) {
        m_value = eOAICreativeType::COLLAGE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("MAX_WIDTH_REGULAR_COLLECTION", Qt::CaseInsensitive) == 0) {
        m_value = eOAICreativeType::MAX_WIDTH_REGULAR_COLLECTION;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("MAX_WIDTH_VIDEO_COLLECTION", Qt::CaseInsensitive) == 0) {
        m_value = eOAICreativeType::MAX_WIDTH_VIDEO_COLLECTION;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("APP", Qt::CaseInsensitive) == 0) {
        m_value = eOAICreativeType::APP;
        m_value_isSet = m_value_isValid = true;
    }
}
...
QString OAICreativeType::asJson() const {
    ...
    switch (m_value){
        ...
        case eOAICreativeType::QUIZ:
            val = "QUIZ";
            break;
        case eOAICreativeType::COLLAGE:
            val = "COLLAGE";
            break;
        case eOAICreativeType::MAX_WIDTH_REGULAR_COLLECTION:
            val = "MAX_WIDTH_REGULAR_COLLECTION";
            break;
        case eOAICreativeType::MAX_WIDTH_VIDEO_COLLECTION:
            val = "MAX_WIDTH_VIDEO_COLLECTION";
            break;
        case eOAICreativeType::APP:
            val = "APP";
            break;
        default:
            break;
