...
public:
    OAICustomerList();
    OAICustomerList(const QString &json);
    ...
    OAICustomerListStatus getStatus() const;
    void setStatus(const OAICustomerListStatus &status);
...
private:
    ...
    OAICustomerListStatus m_status;
    bool m_status_isSet;
