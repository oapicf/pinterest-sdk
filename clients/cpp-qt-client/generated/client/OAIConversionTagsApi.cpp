...
void OAIConversionTagsApi::setServerIndex(int serverIndex) {
...
void OAIConversionTagsApi::conversionTags_createCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIConversionTag output(QString(worker->response));
    worker->deleteLater();
...
void OAIConversionTagsApi::conversionTags_listCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIConversion_tags_list_200_response output(QString(worker->response));
    worker->deleteLater();
...
void OAIConversionTagsApi::pageVisitConversionTags_get(const QString &ad_account_id, const ::OpenAPI::OptionalParam<QString> &bookmark, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<OAIPinterest_Lib_PaginationOrder> &order) {
