...
public:
    ...
    OAISharedAudienceAccount(const QString &json);
    ...
    OAIAudienceAccountType getAccountType() const;
    void setAccountType(const OAIAudienceAccountType &account_type);
...
private:
    ...
    OAIAudienceAccountType m_account_type;
    bool m_account_type_isSet;
    bool m_account_type_isValid;

    qint32 m_shared_on_timestamp;
