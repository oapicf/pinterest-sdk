...
public:
    ...
    */
    void adGroups_audienceSizing(const QString &ad_account_id, const ::OpenAPI::OptionalParam<OAIAdGroupAudienceSizingRequest> &oaiad_group_audience_sizing_request = ::OpenAPI::OptionalParam<OAIAdGroupAudienceSizingRequest>());
