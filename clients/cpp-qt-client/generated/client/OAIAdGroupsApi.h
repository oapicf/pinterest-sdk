...
public:
    ...
    */
    ...
    /**
    * @param[in]  ad_account_id QString [required]
    * @param[in]  oaiad_group_audience_sizing_request OAIAdGroupAudienceSizingRequest [optional]
    */
    virtual void adGroups_audienceSizing(const QString &ad_account_id, const ::OpenAPI::OptionalParam<OAIAdGroupAudienceSizingRequest> &oaiad_group_audience_sizing_request = ::OpenAPI::OptionalParam<OAIAdGroupAudienceSizingRequest>());
