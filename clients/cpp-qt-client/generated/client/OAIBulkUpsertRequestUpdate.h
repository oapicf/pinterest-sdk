...
class OAICatalogs_product_groups_update_request;
...
public:
    ...
    QList<OAICatalogs_product_groups_update_request> getCatalogProductGroups() const;
    void setCatalogProductGroups(const QList<OAICatalogs_product_groups_update_request> &catalog_product_groups);
...
private:
    ...
    QList<OAICatalogs_product_groups_update_request> m_catalog_product_groups;
