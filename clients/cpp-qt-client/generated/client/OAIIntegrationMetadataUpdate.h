...
/*
 * OAIIntegrationMetadataUpdate.h
 *
 * Resource create or update operation model.
 */

#ifndef OAIIntegrationMetadataUpdate_H
#define OAIIntegrationMetadataUpdate_H
...
class OAIIntegrationMetadataUpdate : public OAIObject {
public:
    OAIIntegrationMetadataUpdate();
    OAIIntegrationMetadataUpdate(const QString &json);
    ~OAIIntegrationMetadataUpdate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIntegrationMetadataUpdate)

#endif // OAIIntegrationMetadataUpdate_H
