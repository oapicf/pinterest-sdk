...
OAIKeywordsMetricsArrayResponse::OAIKeywordsMetricsArrayResponse(const QString &json) {
...
void OAIKeywordsMetricsArrayResponse::fromJson(const QString &jsonString) {
