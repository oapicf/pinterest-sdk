...
OAIMMMReportingColumn::OAIMMMReportingColumn(const QString &json) {
...
void OAIMMMReportingColumn::fromJson(const QString &jsonString) {
    ...
    if ( jsonString.compare("SPEND_IN_DOLLAR", Qt::CaseInsensitive) == 0) {
        ...
        m_value = eOAIMMMReportingColumn::CAMPAIGN_OBJECTIVE_TYPE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("PINNER_LIST_NAME", Qt::CaseInsensitive) == 0) {
        m_value = eOAIMMMReportingColumn::PINNER_LIST_NAME;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ADS_CREDIT_SPEND_IN_DOLLAR", Qt::CaseInsensitive) == 0) {
        m_value = eOAIMMMReportingColumn::ADS_CREDIT_SPEND_IN_DOLLAR;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ADVERTISER_PAID_SPEND_IN_DOLLAR", Qt::CaseInsensitive) == 0) {
        m_value = eOAIMMMReportingColumn::ADVERTISER_PAID_SPEND_IN_DOLLAR;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ADVERTISER_PAID_ECPC_IN_DOLLAR", Qt::CaseInsensitive) == 0) {
        m_value = eOAIMMMReportingColumn::ADVERTISER_PAID_ECPC_IN_DOLLAR;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ADVERTISER_PAID_ECPM_IN_DOLLAR", Qt::CaseInsensitive) == 0) {
        m_value = eOAIMMMReportingColumn::ADVERTISER_PAID_ECPM_IN_DOLLAR;
        m_value_isSet = m_value_isValid = true;
    }
}
...
QString OAIMMMReportingColumn::asJson() const {
    ...
    switch (m_value){
        ...
        case eOAIMMMReportingColumn::SPEND_ORDER_LINE_PAID_TYPE:
            ...
            break;
        case eOAIMMMReportingColumn::CAMPAIGN_OBJECTIVE_TYPE:
            val = "CAMPAIGN_OBJECTIVE_TYPE";
            break;
        case eOAIMMMReportingColumn::PINNER_LIST_NAME:
            val = "PINNER_LIST_NAME";
            break;
        case eOAIMMMReportingColumn::ADS_CREDIT_SPEND_IN_DOLLAR:
            val = "ADS_CREDIT_SPEND_IN_DOLLAR";
            break;
        case eOAIMMMReportingColumn::ADVERTISER_PAID_SPEND_IN_DOLLAR:
            val = "ADVERTISER_PAID_SPEND_IN_DOLLAR";
            break;
        case eOAIMMMReportingColumn::ADVERTISER_PAID_ECPC_IN_DOLLAR:
            val = "ADVERTISER_PAID_ECPC_IN_DOLLAR";
            break;
        case eOAIMMMReportingColumn::ADVERTISER_PAID_ECPM_IN_DOLLAR:
            val = "ADVERTISER_PAID_ECPM_IN_DOLLAR";
            break;
        default:
            break;
    }
