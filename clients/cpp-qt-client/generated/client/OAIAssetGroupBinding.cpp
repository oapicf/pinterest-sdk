...
OAIAssetGroupBinding::OAIAssetGroupBinding(const QString &json) {
...
void OAIAssetGroupBinding::fromJson(const QString &jsonString) {
...
void OAIAssetGroupBinding::fromJsonObject(QJsonObject json) {
    ...
    m_catalogs_ids_isValid = ::OpenAPI::fromJsonValue(m_catalogs_ids, json[QString("catalogs_ids")]);
...
QJsonObject OAIAssetGroupBinding::asJsonObject() const {
    ...
    if (m_catalogs_ids.size() > 0) {
        obj.insert(QString("catalogs_ids"), ::OpenAPI::toJsonValue(m_catalogs_ids));
    }
...
void OAIAssetGroupBinding::setCatalogsIds(const QList<QString> &catalogs_ids) {
    m_catalogs_ids = catalogs_ids;
    m_catalogs_ids_isSet = true;
}
