...
/*
 * OAIReportingColumnAsync.h
 *
 * Reporting columns
 */

#ifndef OAIReportingColumnAsync_H
#define OAIReportingColumnAsync_H
...
class OAIReportingColumnAsync : public OAIEnum {
public:
    OAIReportingColumnAsync();
    OAIReportingColumnAsync(const QString &json);
    ~OAIReportingColumnAsync() override;
    ...
    enum class eOAIReportingColumnAsync {
    ...
    OAIReportingColumnAsync::eOAIReportingColumnAsync getValue() const;
    void setValue(const OAIReportingColumnAsync::eOAIReportingColumnAsync& value);
...
private:
    ...
    eOAIReportingColumnAsync m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReportingColumnAsync)

#endif // OAIReportingColumnAsync_H
