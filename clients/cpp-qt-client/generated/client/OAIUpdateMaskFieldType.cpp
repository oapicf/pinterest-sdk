...
OAIUpdateMaskFieldType::OAIUpdateMaskFieldType(const QString &json) {
...
void OAIUpdateMaskFieldType::fromJson(const QString &jsonString) {
    ...
    else if ( jsonString.compare("custom_number_0", Qt::CaseInsensitive) == 0) {
        m_value = eOAIUpdateMaskFieldType::CUSTOM_NUMBER_0;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("custom_number_1", Qt::CaseInsensitive) == 0) {
        m_value = eOAIUpdateMaskFieldType::CUSTOM_NUMBER_1;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("custom_number_2", Qt::CaseInsensitive) == 0) {
        m_value = eOAIUpdateMaskFieldType::CUSTOM_NUMBER_2;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("custom_number_3", Qt::CaseInsensitive) == 0) {
        m_value = eOAIUpdateMaskFieldType::CUSTOM_NUMBER_3;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("custom_number_4", Qt::CaseInsensitive) == 0) {
        m_value = eOAIUpdateMaskFieldType::CUSTOM_NUMBER_4;
        m_value_isSet = m_value_isValid = true;
    }
    ...
    else if ( jsonString.compare("promotion_id", Qt::CaseInsensitive) == 0) {
        m_value = eOAIUpdateMaskFieldType::PROMOTION_ID;
        m_value_isSet = m_value_isValid = true;
    }
}
...
QString OAIUpdateMaskFieldType::asJson() const {
    ...
    switch (m_value){
        ...
        case eOAIUpdateMaskFieldType::CUSTOM_LABEL_4:
            val = "custom_label_4";
            break;
        case eOAIUpdateMaskFieldType::CUSTOM_NUMBER_0:
            val = "custom_number_0";
            break;
        case eOAIUpdateMaskFieldType::CUSTOM_NUMBER_1:
            val = "custom_number_1";
            break;
        case eOAIUpdateMaskFieldType::CUSTOM_NUMBER_2:
            val = "custom_number_2";
            break;
        case eOAIUpdateMaskFieldType::CUSTOM_NUMBER_3:
            val = "custom_number_3";
            break;
        case eOAIUpdateMaskFieldType::CUSTOM_NUMBER_4:
            val = "custom_number_4";
            break;
        ...
        case eOAIUpdateMaskFieldType::VARIANT_VALUES:
            val = "variant_values";
            break;
        case eOAIUpdateMaskFieldType::PROMOTION_ID:
            val = "promotion_id";
            break;
        default:
            break;
