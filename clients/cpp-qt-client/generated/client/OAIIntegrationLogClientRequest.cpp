...
OAIIntegrationLogClientRequest::OAIIntegrationLogClientRequest(const QString &json) {
...
void OAIIntegrationLogClientRequest::fromJson(const QString &jsonString) {
...
OAIHttpMethod OAIIntegrationLogClientRequest::getMethod() const {
    return m_method;
}
void OAIIntegrationLogClientRequest::setMethod(const OAIHttpMethod &method) {
    m_method = method;
    m_method_isSet = true;
}
...
bool OAIIntegrationLogClientRequest::isValid() const {
    ...
    return m_host_isValid && m_method_isValid && m_path_isValid && true;
}
