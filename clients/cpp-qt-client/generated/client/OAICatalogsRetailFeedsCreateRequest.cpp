...
OAICatalogsRetailFeedsCreateRequest::OAICatalogsRetailFeedsCreateRequest(const QString &json) {
...
void OAICatalogsRetailFeedsCreateRequest::fromJson(const QString &jsonString) {
...
QString OAICatalogsRetailFeedsCreateRequest::getCatalogId() const {
    return m_catalog_id;
}
void OAICatalogsRetailFeedsCreateRequest::setCatalogId(const QString &catalog_id) {
    m_catalog_id = catalog_id;
    m_catalog_id_isSet = true;
}

bool OAICatalogsRetailFeedsCreateRequest::is_catalog_id_Set() const{
    return m_catalog_id_isSet;
}

bool OAICatalogsRetailFeedsCreateRequest::is_catalog_id_Valid() const{
    return m_catalog_id_isValid;
}

QString OAICatalogsRetailFeedsCreateRequest::getCatalogType() const {
    return m_catalog_type;
}
void OAICatalogsRetailFeedsCreateRequest::setCatalogType(const QString &catalog_type) {
...
OAICatalogsCreativeAssetsFeedsCreateRequest_default_locale OAICatalogsRetailFeedsCreateRequest::getDefaultLocale() const {
    return m_default_locale;
}
void OAICatalogsRetailFeedsCreateRequest::setDefaultLocale(const OAICatalogsCreativeAssetsFeedsCreateRequest_default_locale &default_locale) {
...
OAICatalogsStatus OAICatalogsRetailFeedsCreateRequest::getStatus() const {
    return m_status;
}
void OAICatalogsRetailFeedsCreateRequest::setStatus(const OAICatalogsStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAICatalogsRetailFeedsCreateRequest::is_status_Set() const{
    return m_status_isSet;
}

bool OAICatalogsRetailFeedsCreateRequest::is_status_Valid() const{
