...
/*
 * OAIConversionEventsUserDataProperties.h
 *
 * 
 */

#ifndef OAIConversionEventsUserDataProperties_H
#define OAIConversionEventsUserDataProperties_H
...
class OAIConversionEventsUserDataProperties : public OAIObject {
public:
    OAIConversionEventsUserDataProperties();
    OAIConversionEventsUserDataProperties(const QString &json);
    ~OAIConversionEventsUserDataProperties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConversionEventsUserDataProperties)

#endif // OAIConversionEventsUserDataProperties_H
