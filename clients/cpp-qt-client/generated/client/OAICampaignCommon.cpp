...
bool OAICampaignCommon::isIsAutomatedCampaign() const {
    return m_is_automated_campaign;
}
void OAICampaignCommon::setIsAutomatedCampaign(const bool &is_automated_campaign) {
    m_is_automated_campaign = is_automated_campaign;
    m_is_automated_campaign_isSet = true;
}

bool OAICampaignCommon::is_is_automated_campaign_Set() const{
    return m_is_automated_campaign_isSet;
}

bool OAICampaignCommon::is_is_automated_campaign_Valid() const{
