...
bool OAICampaignResponse::isIsAutomatedCampaign() const {
    return m_is_automated_campaign;
}
void OAICampaignResponse::setIsAutomatedCampaign(const bool &is_automated_campaign) {
    m_is_automated_campaign = is_automated_campaign;
    m_is_automated_campaign_isSet = true;
}

bool OAICampaignResponse::is_is_automated_campaign_Set() const{
    return m_is_automated_campaign_isSet;
}

bool OAICampaignResponse::is_is_automated_campaign_Valid() const{
...
OAICampaignBidOptions OAICampaignResponse::getBidOptions() const {
    return m_bid_options;
}
void OAICampaignResponse::setBidOptions(const OAICampaignBidOptions &bid_options) {
    m_bid_options = bid_options;
    m_bid_options_isSet = true;
}

bool OAICampaignResponse::is_bid_options_Set() const{
    return m_bid_options_isSet;
}

bool OAICampaignResponse::is_bid_options_Valid() const{
...
bool OAICampaignResponse::isIsPerformancePlus() const {
    return m_is_performance_plus;
}
void OAICampaignResponse::setIsPerformancePlus(const bool &is_performance_plus) {
    m_is_performance_plus = is_performance_plus;
    m_is_performance_plus_isSet = true;
}

bool OAICampaignResponse::is_is_performance_plus_Set() const{
    return m_is_performance_plus_isSet;
}

bool OAICampaignResponse::is_is_performance_plus_Valid() const{
