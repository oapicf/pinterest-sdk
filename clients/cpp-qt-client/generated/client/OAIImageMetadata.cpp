...
OAIImageMetadata::OAIImageMetadata(const QString &json) {
...
void OAIImageMetadata::fromJson(const QString &jsonString) {
...
OAIImageSize OAIImageMetadata::getImages() const {
    return m_images;
}
void OAIImageMetadata::setImages(const OAIImageSize &images) {
    m_images = images;
    m_images_isSet = true;
}
