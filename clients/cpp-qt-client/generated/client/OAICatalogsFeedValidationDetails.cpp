...
OAICatalogsFeedValidationDetails::OAICatalogsFeedValidationDetails(const QString &json) {
...
void OAICatalogsFeedValidationDetails::fromJson(const QString &jsonString) {
