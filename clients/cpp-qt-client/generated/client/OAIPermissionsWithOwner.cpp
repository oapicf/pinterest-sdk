...
OAIPermissionsWithOwner::OAIPermissionsWithOwner(const QString &json) {
...
void OAIPermissionsWithOwner::fromJson(const QString &jsonString) {
    ...
    if ( jsonString.compare("ADMIN", Qt::CaseInsensitive) == 0) {
        ...
        m_value = eOAIPermissionsWithOwner::FINANCE_EDIT;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("FINANCE_VIEW", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPermissionsWithOwner::FINANCE_VIEW;
        m_value_isSet = m_value_isValid = true;
    }
...
QString OAIPermissionsWithOwner::asJson() const {
    ...
    switch (m_value){
        ...
        case eOAIPermissionsWithOwner::FINANCE_MANAGER:
            val = "FINANCE_MANAGER";
            break;
        case eOAIPermissionsWithOwner::FINANCE_EDIT:
            val = "FINANCE_EDIT";
            break;
        case eOAIPermissionsWithOwner::FINANCE_VIEW:
            val = "FINANCE_VIEW";
            break;
