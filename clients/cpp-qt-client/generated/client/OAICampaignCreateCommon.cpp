...
OAICampaignSummaryStatus OAICampaignCreateCommon::getSummaryStatus() const {
    return m_summary_status;
}
void OAICampaignCreateCommon::setSummaryStatus(const OAICampaignSummaryStatus &summary_status) {
    m_summary_status = summary_status;
    m_summary_status_isSet = true;
}

bool OAICampaignCreateCommon::is_summary_status_Set() const{
    return m_summary_status_isSet;
}

bool OAICampaignCreateCommon::is_summary_status_Valid() const{
