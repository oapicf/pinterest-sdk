...
OAIObjectiveType OAICampaignCreateCommon::getObjectiveType() const {
    return objective_type;
}
void OAICampaignCreateCommon::setObjectiveType(const OAIObjectiveType &objective_type) {
    this->objective_type = objective_type;
    this->m_objective_type_isSet = true;
}

bool OAICampaignCreateCommon::is_objective_type_Set() const{
    return m_objective_type_isSet;
}

bool OAICampaignCreateCommon::is_objective_type_Valid() const{
