...
OAIPinMediaWithImage::OAIPinMediaWithImage(const QString &json) {
...
void OAIPinMediaWithImage::fromJson(const QString &jsonString) {
...
OAIImageSize OAIPinMediaWithImage::getImages() const {
    return m_images;
}
void OAIPinMediaWithImage::setImages(const OAIImageSize &images) {
    m_images = images;
    m_images_isSet = true;
}
