...
public:
    ...
    * @param[in]  reporting_timezone OAIReportingTimeZone [optional]
    */
    virtual void adAccount_analytics(const QString &ad_account_id, const QDate &start_date, const QDate &end_date, const QList<QString> &columns, const OAIGranularity &granularity, const ::OpenAPI::OptionalParam<qint32> &click_window_days = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<qint32> &engagement_window_days = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<qint32> &view_window_days = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &conversion_report_time = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<OAIReportingTimeZone> &reporting_timezone = ::OpenAPI::OptionalParam<OAIReportingTimeZone>());
    ...
    */
    ...
    /**
    * @param[in]  ad_account_id QString [required]
    * @param[in]  oai_conversion_product_report_request OAIConversionProductReportRequest [required]
    */
    virtual void analytics_createConversionProductReport(const QString &ad_account_id, const OAIConversionProductReportRequest &oai_conversion_product_report_request);
...
Q_SIGNALS:
    ...
    void analytics_createConversionProductReportSignal(OAIAdsAnalyticsCreateAsyncResponse summary);
    ...
    void analytics_getConversionProductReportSignal(OAIAdsAnalyticsGetAsyncResponse summary);
    ...
    void analytics_createConversionProductReportSignalFull(OAIHttpRequestWorker *worker, OAIAdsAnalyticsCreateAsyncResponse summary);
    ...
    void analytics_getConversionProductReportSignalFull(OAIHttpRequestWorker *worker, OAIAdsAnalyticsGetAsyncResponse summary);
    ...
    Q_DECL_DEPRECATED_X("Use analytics_createConversionProductReportSignalError() instead")
    void analytics_createConversionProductReportSignalE(OAIAdsAnalyticsCreateAsyncResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void analytics_createConversionProductReportSignalError(OAIAdsAnalyticsCreateAsyncResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void analytics_createTemplateReportSignalE(OAITemplateBasedReport summary, QNetworkReply::NetworkError error_type, QString error_str);
    ...
    Q_DECL_DEPRECATED_X("Use analytics_getConversionProductReportSignalError() instead")
    void analytics_getConversionProductReportSignalE(OAIAdsAnalyticsGetAsyncResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void analytics_getConversionProductReportSignalError(OAIAdsAnalyticsGetAsyncResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use analytics_createConversionProductReportSignalErrorFull() instead")
    void analytics_createConversionProductReportSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    ...
    Q_DECL_DEPRECATED_X("Use analytics_getConversionProductReportSignalErrorFull() instead")
    void analytics_getConversionProductReportSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
