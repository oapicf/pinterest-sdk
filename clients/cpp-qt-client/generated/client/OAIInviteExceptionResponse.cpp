...
OAIInviteExceptionResponse::OAIInviteExceptionResponse(const QString &json) {
...
void OAIInviteExceptionResponse::fromJson(const QString &jsonString) {
...
void OAIInviteExceptionResponse::fromJsonObject(QJsonObject json) {
    ...
    m_invite_or_request_id_isValid = ::OpenAPI::fromJsonValue(m_invite_or_request_id, json[QString("invite_or_request_id")]);
    ...
    m_users_or_partner_ids_isValid = ::OpenAPI::fromJsonValue(m_users_or_partner_ids, json[QString("users_or_partner_ids")]);
...
QJsonObject OAIInviteExceptionResponse::asJsonObject() const {
    ...
    if (m_invite_or_request_id_isSet) {
        obj.insert(QString("invite_or_request_id"), ::OpenAPI::toJsonValue(m_invite_or_request_id));
    }
    if (m_message_isSet) {
        obj.insert(QString("message"), ::OpenAPI::toJsonValue(m_message));
    }
    if (m_users_or_partner_ids.size() > 0) {
        obj.insert(QString("users_or_partner_ids"), ::OpenAPI::toJsonValue(m_users_or_partner_ids));
    }
    return obj;
}
...
void OAIInviteExceptionResponse::setInviteOrRequestId(const QString &invite_or_request_id) {
    m_invite_or_request_id = invite_or_request_id;
    m_invite_or_request_id_isSet = true;
}
...
void OAIInviteExceptionResponse::setUsersOrPartnerIds(const QList<QString> &users_or_partner_ids) {
    m_users_or_partner_ids = users_or_partner_ids;
    m_users_or_partner_ids_isSet = true;
}
