...
/*
 * OAIReportingColumnSync.h
 *
 * Reporting columns for sync reporting endpoints
 */

#ifndef OAIReportingColumnSync_H
#define OAIReportingColumnSync_H
...
class OAIReportingColumnSync : public OAIEnum {
public:
    OAIReportingColumnSync();
    OAIReportingColumnSync(const QString &json);
    ~OAIReportingColumnSync() override;
    ...
    enum class eOAIReportingColumnSync {
    ...
    OAIReportingColumnSync::eOAIReportingColumnSync getValue() const;
    void setValue(const OAIReportingColumnSync::eOAIReportingColumnSync& value);
...
private:
    ...
    eOAIReportingColumnSync m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReportingColumnSync)

#endif // OAIReportingColumnSync_H
