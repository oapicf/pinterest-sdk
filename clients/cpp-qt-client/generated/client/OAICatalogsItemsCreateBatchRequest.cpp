...
OAICatalogsItemsCreateBatchRequest::OAICatalogsItemsCreateBatchRequest(const QString &json) {
...
void OAICatalogsItemsCreateBatchRequest::fromJson(const QString &jsonString) {
...
QString OAICatalogsItemsCreateBatchRequest::getOperation() const {
    return m_operation;
}
void OAICatalogsItemsCreateBatchRequest::setOperation(const QString &operation) {
