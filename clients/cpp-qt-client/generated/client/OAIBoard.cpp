...
OAIBoard::OAIBoard(const QString &json) {
...
void OAIBoard::fromJson(const QString &jsonString) {
...
bool OAIBoard::isIsAdsOnly() const {
    return m_is_ads_only;
}
void OAIBoard::setIsAdsOnly(const bool &is_ads_only) {
    m_is_ads_only = is_ads_only;
    m_is_ads_only_isSet = true;
}

bool OAIBoard::is_is_ads_only_Set() const{
    return m_is_ads_only_isSet;
}

bool OAIBoard::is_is_ads_only_Valid() const{
    return m_is_ads_only_isValid;
}

OAIBoardMedia OAIBoard::getMedia() const {
    return m_media;
}
void OAIBoard::setMedia(const OAIBoardMedia &media) {
    m_media = media;
    m_media_isSet = true;
}
...
OAIBoardPrivacy OAIBoard::getPrivacy() const {
    return m_privacy;
}
void OAIBoard::setPrivacy(const OAIBoardPrivacy &privacy) {
    m_privacy = privacy;
