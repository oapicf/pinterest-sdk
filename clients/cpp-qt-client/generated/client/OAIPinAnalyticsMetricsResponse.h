...
public:
    ...
    OAIPinAnalyticsMetricsResponse(const QString &json);
    ...
    QList<OAIPinAnalyticsDailyMetrics> getDailyMetrics() const;
    void setDailyMetrics(const QList<OAIPinAnalyticsDailyMetrics> &daily_metrics);
...
private:
    ...
    QList<OAIPinAnalyticsDailyMetrics> m_daily_metrics;
