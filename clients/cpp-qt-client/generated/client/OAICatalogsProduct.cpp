...
OAICatalogsProduct::OAICatalogsProduct(const QString &json) {
...
void OAICatalogsProduct::fromJson(const QString &jsonString) {
...
QString OAICatalogsProduct::getCatalogType() const {
    return m_catalog_type;
}
void OAICatalogsProduct::setCatalogType(const QString &catalog_type) {
