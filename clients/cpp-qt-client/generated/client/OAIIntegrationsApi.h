...
public:
    ...
    */
    ...
    /**
    * @param[in]  external_business_id QString [required]
    * @param[in]  oai_integration_request_patch OAIIntegrationRequestPatch [required]
    */
    virtual void integrationsCommerce_patch(const QString &external_business_id, const OAIIntegrationRequestPatch &oai_integration_request_patch);

    /**
    * @param[in]  oai_integration_request OAIIntegrationRequest [required]
    */
    virtual void integrationsCommerce_post(const OAIIntegrationRequest &oai_integration_request);
