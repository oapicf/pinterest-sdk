...
OAICatalogsFeedProcessingStatus::OAICatalogsFeedProcessingStatus(const QString &json) {
...
void OAICatalogsFeedProcessingStatus::fromJson(const QString &jsonString) {
