...
public:
    OAIIntegrationLog();
    OAIIntegrationLog(const QString &json);
    ...
    OAIIntegrationLogEventType getEventType() const;
    void setEventType(const OAIIntegrationLogEventType &event_type);
    ...
    OAIIntegrationLogLevel getLogLevel() const;
    void setLogLevel(const OAIIntegrationLogLevel &log_level);
...
private:
    ...
    OAIIntegrationLogEventType m_event_type;
    ...
    OAIIntegrationLogLevel m_log_level;
