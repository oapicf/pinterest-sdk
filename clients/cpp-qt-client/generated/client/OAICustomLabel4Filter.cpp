...
OAICustomLabel4Filter::OAICustomLabel4Filter(const QString &json) {
...
void OAICustomLabel4Filter::fromJson(const QString &jsonString) {
...
OAICatalogsProductGroupFilterOperatorTypeCriteria OAICustomLabel4Filter::getCustomLabel4() const {
    return m_custom_label_4;
}
void OAICustomLabel4Filter::setCustomLabel4(const OAICatalogsProductGroupFilterOperatorTypeCriteria &custom_label_4) {
