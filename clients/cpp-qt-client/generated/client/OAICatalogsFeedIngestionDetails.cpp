...
OAICatalogsFeedIngestionDetails::OAICatalogsFeedIngestionDetails(const QString &json) {
...
void OAICatalogsFeedIngestionDetails::fromJson(const QString &jsonString) {
