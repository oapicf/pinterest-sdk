...
OAICatalogsHotelFeedsCreateRequest::OAICatalogsHotelFeedsCreateRequest(const QString &json) {
...
void OAICatalogsHotelFeedsCreateRequest::fromJson(const QString &jsonString) {
...
QString OAICatalogsHotelFeedsCreateRequest::getCatalogType() const {
    return m_catalog_type;
}
void OAICatalogsHotelFeedsCreateRequest::setCatalogType(const QString &catalog_type) {
...
OAICatalogsCreativeAssetsFeedsCreateRequest_default_locale OAICatalogsHotelFeedsCreateRequest::getDefaultLocale() const {
    return m_default_locale;
}
void OAICatalogsHotelFeedsCreateRequest::setDefaultLocale(const OAICatalogsCreativeAssetsFeedsCreateRequest_default_locale &default_locale) {
...
bool OAICatalogsHotelFeedsCreateRequest::isValid() const {
    ...
    return m_catalog_type_isValid && m_default_locale_isValid && m_format_isValid && m_location_isValid && m_name_isValid && true;
}
