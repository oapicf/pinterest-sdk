...
OAILeadForm::OAILeadForm(const QString &json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILeadForm::OAILeadForm() {
    this->initializeModel();
}

OAILeadForm::~OAILeadForm() {}

void OAILeadForm::initializeModel() {
...
void OAILeadForm::fromJson(const QString &jsonString) {
...
void OAILeadForm::fromJsonObject(QJsonObject json) {
...
QString OAILeadForm::asJson() const {
...
QJsonObject OAILeadForm::asJsonObject() const {
    QJsonObject obj;
...
QString OAILeadForm::getAdAccountId() const {
    return m_ad_account_id;
}
void OAILeadForm::setAdAccountId(const QString &ad_account_id) {
    m_ad_account_id = ad_account_id;
    m_ad_account_id_isSet = true;
}

bool OAILeadForm::is_ad_account_id_Set() const{
    return m_ad_account_id_isSet;
}

bool OAILeadForm::is_ad_account_id_Valid() const{
    return m_ad_account_id_isValid;
}

QString OAILeadForm::getCompletionMessage() const {
    return m_completion_message;
}
void OAILeadForm::setCompletionMessage(const QString &completion_message) {
    m_completion_message = completion_message;
    m_completion_message_isSet = true;
}

bool OAILeadForm::is_completion_message_Set() const{
    return m_completion_message_isSet;
}

bool OAILeadForm::is_completion_message_Valid() const{
    return m_completion_message_isValid;
}

qint32 OAILeadForm::getCreatedTime() const {
    return m_created_time;
}
void OAILeadForm::setCreatedTime(const qint32 &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAILeadForm::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAILeadForm::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAILeadForm::getDisclosureLanguage() const {
    return m_disclosure_language;
}
void OAILeadForm::setDisclosureLanguage(const QString &disclosure_language) {
    m_disclosure_language = disclosure_language;
    m_disclosure_language_isSet = true;
}

bool OAILeadForm::is_disclosure_language_Set() const{
    return m_disclosure_language_isSet;
}

bool OAILeadForm::is_disclosure_language_Valid() const{
    return m_disclosure_language_isValid;
}

bool OAILeadForm::isHasAcceptedTerms() const {
    return m_has_accepted_terms;
}
void OAILeadForm::setHasAcceptedTerms(const bool &has_accepted_terms) {
    m_has_accepted_terms = has_accepted_terms;
    m_has_accepted_terms_isSet = true;
}

bool OAILeadForm::is_has_accepted_terms_Set() const{
    return m_has_accepted_terms_isSet;
}

bool OAILeadForm::is_has_accepted_terms_Valid() const{
    return m_has_accepted_terms_isValid;
}

QString OAILeadForm::getId() const {
    return m_id;
}
void OAILeadForm::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAILeadForm::is_id_Set() const{
    return m_id_isSet;
}

bool OAILeadForm::is_id_Valid() const{
    return m_id_isValid;
}

QString OAILeadForm::getName() const {
    return m_name;
}
void OAILeadForm::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAILeadForm::is_name_Set() const{
    return m_name_isSet;
}

bool OAILeadForm::is_name_Valid() const{
    return m_name_isValid;
}

QList<OAILeadFormPolicyLink> OAILeadForm::getPolicyLinks() const {
    return m_policy_links;
}
void OAILeadForm::setPolicyLinks(const QList<OAILeadFormPolicyLink> &policy_links) {
    m_policy_links = policy_links;
    m_policy_links_isSet = true;
}

bool OAILeadForm::is_policy_links_Set() const{
    return m_policy_links_isSet;
}

bool OAILeadForm::is_policy_links_Valid() const{
    return m_policy_links_isValid;
}

QString OAILeadForm::getPrivacyPolicyLink() const {
    return m_privacy_policy_link;
}
void OAILeadForm::setPrivacyPolicyLink(const QString &privacy_policy_link) {
    m_privacy_policy_link = privacy_policy_link;
    m_privacy_policy_link_isSet = true;
}

bool OAILeadForm::is_privacy_policy_link_Set() const{
    return m_privacy_policy_link_isSet;
}

bool OAILeadForm::is_privacy_policy_link_Valid() const{
    return m_privacy_policy_link_isValid;
}

QList<OAILeadFormQuestion> OAILeadForm::getQuestions() const {
    return m_questions;
}
void OAILeadForm::setQuestions(const QList<OAILeadFormQuestion> &questions) {
    m_questions = questions;
    m_questions_isSet = true;
}

bool OAILeadForm::is_questions_Set() const{
    return m_questions_isSet;
}

bool OAILeadForm::is_questions_Valid() const{
    return m_questions_isValid;
}

OAILeadFormStatus OAILeadForm::getStatus() const {
    return m_status;
}
void OAILeadForm::setStatus(const OAILeadFormStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAILeadForm::is_status_Set() const{
    return m_status_isSet;
}

bool OAILeadForm::is_status_Valid() const{
    return m_status_isValid;
}

qint32 OAILeadForm::getUpdatedTime() const {
    return m_updated_time;
}
void OAILeadForm::setUpdatedTime(const qint32 &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAILeadForm::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAILeadForm::is_updated_time_Valid() const{
    return m_updated_time_isValid;
}

bool OAILeadForm::isSet() const {
...
bool OAILeadForm::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_completion_message_isValid && m_has_accepted_terms_isValid && m_id_isValid && m_name_isValid && m_privacy_policy_link_isValid && m_questions_isValid && true;
}
