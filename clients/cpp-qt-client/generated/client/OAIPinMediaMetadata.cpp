...
OAIPinMediaMetadata::OAIPinMediaMetadata(const QString &json) {
...
void OAIPinMediaMetadata::fromJson(const QString &jsonString) {
...
OAIImageSize OAIPinMediaMetadata::getImages() const {
    return m_images;
}
void OAIPinMediaMetadata::setImages(const OAIImageSize &images) {
    m_images = images;
    m_images_isSet = true;
}
...
QString OAIPinMediaMetadata::getVideoUrlHls() const {
    return m_video_url_hls;
}
void OAIPinMediaMetadata::setVideoUrlHls(const QString &video_url_hls) {
    m_video_url_hls = video_url_hls;
    m_video_url_hls_isSet = true;
}

bool OAIPinMediaMetadata::is_video_url_hls_Set() const{
    return m_video_url_hls_isSet;
}

bool OAIPinMediaMetadata::is_video_url_hls_Valid() const{
