...
public:
    ...
    OAIUserAccountType getAccountType() const;
    void setAccountType(const OAIUserAccountType &account_type);
...
private:
    ...
    OAIUserAccountType m_account_type;
