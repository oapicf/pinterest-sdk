...
OAIConversionEventAppInfo OAIConversionEvents_data_inner::getAppInfo() const {
    return m_app_info;
}
void OAIConversionEvents_data_inner::setAppInfo(const OAIConversionEventAppInfo &app_info) {
    m_app_info = app_info;
    m_app_info_isSet = true;
}

bool OAIConversionEvents_data_inner::is_app_info_Set() const{
    return m_app_info_isSet;
}

bool OAIConversionEvents_data_inner::is_app_info_Valid() const{
...
OAIConversionEventDeviceInfo OAIConversionEvents_data_inner::getDeviceInfo() const {
    return m_device_info;
}
void OAIConversionEvents_data_inner::setDeviceInfo(const OAIConversionEventDeviceInfo &device_info) {
    m_device_info = device_info;
    m_device_info_isSet = true;
}

bool OAIConversionEvents_data_inner::is_device_info_Set() const{
    return m_device_info_isSet;
}

bool OAIConversionEvents_data_inner::is_device_info_Valid() const{
