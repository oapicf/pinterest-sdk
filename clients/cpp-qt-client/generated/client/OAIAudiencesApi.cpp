...
void OAIAudiencesApi::audiences_update(const QString &ad_account_id, const QString &audience_id, const OAIAudienceUpdateRequest &oai_audience_update_request) {
...

    {
        ...
        QByteArray output = oai_audience_update_request.asJson().toUtf8();
        input.request_body.append(output);
    }
    for (auto keyValueIt = _defaultHeaders.keyValueBegin(); keyValueIt != _defaultHeaders.keyValueEnd(); keyValueIt++) {
        input.headers.insert(keyValueIt->first, keyValueIt->second);
