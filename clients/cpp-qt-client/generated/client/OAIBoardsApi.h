...
Q_SIGNALS:
    ...
    void boardSections_listPinsSignalError(OAIBoard_sections_list_pins_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void boards_listPinsSignalError(OAIBoard_sections_list_pins_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
