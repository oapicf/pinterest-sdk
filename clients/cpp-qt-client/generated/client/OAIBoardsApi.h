...
public:
    ...
    */
    virtual void boards_listPins(const QString &board_id, const ::OpenAPI::OptionalParam<QString> &bookmark = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<qint32> &page_size = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QList<OAICreativeType>> &creative_types = ::OpenAPI::OptionalParam<QList<OAICreativeType>>(), const ::OpenAPI::OptionalParam<QString> &ad_account_id = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &pin_metrics = ::OpenAPI::OptionalParam<bool>());
...
Q_SIGNALS:
    ...
    void boards_updateSignalE(OAIBoardWithUpdatePrivacy summary, QNetworkReply::NetworkError error_type, QString error_str);
