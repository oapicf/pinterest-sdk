...
signals:
    ...
    void boardSections_listSignal(OAIPaginated summary);
    void boardSections_listPinsSignal(OAIPaginated summary);
    ...
    void boards_listSignal(OAIPaginated summary);
    void boards_listPinsSignal(OAIPaginated summary);
    ...
    void boardSections_listSignalFull(OAIHttpRequestWorker *worker, OAIPaginated summary);
    void boardSections_listPinsSignalFull(OAIHttpRequestWorker *worker, OAIPaginated summary);
    ...
    void boards_listSignalFull(OAIHttpRequestWorker *worker, OAIPaginated summary);
    void boards_listPinsSignalFull(OAIHttpRequestWorker *worker, OAIPaginated summary);
    ...
    void boardSections_listSignalE(OAIPaginated summary, QNetworkReply::NetworkError error_type, QString error_str);
    void boardSections_listPinsSignalE(OAIPaginated summary, QNetworkReply::NetworkError error_type, QString error_str);
    ...
    void boards_listSignalE(OAIPaginated summary, QNetworkReply::NetworkError error_type, QString error_str);
    void boards_listPinsSignalE(OAIPaginated summary, QNetworkReply::NetworkError error_type, QString error_str);
