...
/*
 * OAIAdsCreditRedeem.h
 *
 * Ads credit redemption
 */

#ifndef OAIAdsCreditRedeem_H
#define OAIAdsCreditRedeem_H
...
class OAIAdsCreditRedeem : public OAIObject {
public:
    OAIAdsCreditRedeem();
    OAIAdsCreditRedeem(const QString &json);
    ~OAIAdsCreditRedeem() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAdsCreditRedeem)

#endif // OAIAdsCreditRedeem_H
