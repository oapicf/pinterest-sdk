...
OAIIntegrationLogsInvalidLogResponse::OAIIntegrationLogsInvalidLogResponse(const QString &json) {
...
void OAIIntegrationLogsInvalidLogResponse::fromJson(const QString &jsonString) {
...
QList<OAIIntegrationLogsInvalidLogResponseRejectedLogsItems> OAIIntegrationLogsInvalidLogResponse::getRejectedLogs() const {
    return m_rejected_logs;
}
void OAIIntegrationLogsInvalidLogResponse::setRejectedLogs(const QList<OAIIntegrationLogsInvalidLogResponseRejectedLogsItems> &rejected_logs) {
