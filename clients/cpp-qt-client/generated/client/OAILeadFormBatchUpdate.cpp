...
OAILeadFormBatchUpdate::OAILeadFormBatchUpdate(const QString &json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILeadFormBatchUpdate::OAILeadFormBatchUpdate() {
    this->initializeModel();
}

OAILeadFormBatchUpdate::~OAILeadFormBatchUpdate() {}

void OAILeadFormBatchUpdate::initializeModel() {
...
void OAILeadFormBatchUpdate::fromJson(const QString &jsonString) {
...
void OAILeadFormBatchUpdate::fromJsonObject(QJsonObject json) {
...
QString OAILeadFormBatchUpdate::asJson() const {
...
QJsonObject OAILeadFormBatchUpdate::asJsonObject() const {
    QJsonObject obj;
...
QString OAILeadFormBatchUpdate::getCompletionMessage() const {
    return m_completion_message;
}
void OAILeadFormBatchUpdate::setCompletionMessage(const QString &completion_message) {
    m_completion_message = completion_message;
    m_completion_message_isSet = true;
}

bool OAILeadFormBatchUpdate::is_completion_message_Set() const{
    return m_completion_message_isSet;
}

bool OAILeadFormBatchUpdate::is_completion_message_Valid() const{
    return m_completion_message_isValid;
}

QString OAILeadFormBatchUpdate::getDisclosureLanguage() const {
    return m_disclosure_language;
}
void OAILeadFormBatchUpdate::setDisclosureLanguage(const QString &disclosure_language) {
    m_disclosure_language = disclosure_language;
    m_disclosure_language_isSet = true;
}

bool OAILeadFormBatchUpdate::is_disclosure_language_Set() const{
    return m_disclosure_language_isSet;
}

bool OAILeadFormBatchUpdate::is_disclosure_language_Valid() const{
    return m_disclosure_language_isValid;
}

bool OAILeadFormBatchUpdate::isHasAcceptedTerms() const {
    return m_has_accepted_terms;
}
void OAILeadFormBatchUpdate::setHasAcceptedTerms(const bool &has_accepted_terms) {
    m_has_accepted_terms = has_accepted_terms;
    m_has_accepted_terms_isSet = true;
}

bool OAILeadFormBatchUpdate::is_has_accepted_terms_Set() const{
    return m_has_accepted_terms_isSet;
}

bool OAILeadFormBatchUpdate::is_has_accepted_terms_Valid() const{
    return m_has_accepted_terms_isValid;
}

QString OAILeadFormBatchUpdate::getId() const {
    return m_id;
}
void OAILeadFormBatchUpdate::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAILeadFormBatchUpdate::is_id_Set() const{
    return m_id_isSet;
}

bool OAILeadFormBatchUpdate::is_id_Valid() const{
    return m_id_isValid;
}

QString OAILeadFormBatchUpdate::getName() const {
    return m_name;
}
void OAILeadFormBatchUpdate::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAILeadFormBatchUpdate::is_name_Set() const{
    return m_name_isSet;
}

bool OAILeadFormBatchUpdate::is_name_Valid() const{
    return m_name_isValid;
}

QList<OAILeadFormPolicyLink> OAILeadFormBatchUpdate::getPolicyLinks() const {
    return m_policy_links;
}
void OAILeadFormBatchUpdate::setPolicyLinks(const QList<OAILeadFormPolicyLink> &policy_links) {
    m_policy_links = policy_links;
    m_policy_links_isSet = true;
}

bool OAILeadFormBatchUpdate::is_policy_links_Set() const{
    return m_policy_links_isSet;
}

bool OAILeadFormBatchUpdate::is_policy_links_Valid() const{
    return m_policy_links_isValid;
}

QString OAILeadFormBatchUpdate::getPrivacyPolicyLink() const {
    return m_privacy_policy_link;
}
void OAILeadFormBatchUpdate::setPrivacyPolicyLink(const QString &privacy_policy_link) {
    m_privacy_policy_link = privacy_policy_link;
    m_privacy_policy_link_isSet = true;
}

bool OAILeadFormBatchUpdate::is_privacy_policy_link_Set() const{
    return m_privacy_policy_link_isSet;
}

bool OAILeadFormBatchUpdate::is_privacy_policy_link_Valid() const{
    return m_privacy_policy_link_isValid;
}

QList<OAILeadFormQuestion> OAILeadFormBatchUpdate::getQuestions() const {
    return m_questions;
}
void OAILeadFormBatchUpdate::setQuestions(const QList<OAILeadFormQuestion> &questions) {
    m_questions = questions;
    m_questions_isSet = true;
}

bool OAILeadFormBatchUpdate::is_questions_Set() const{
    return m_questions_isSet;
}

bool OAILeadFormBatchUpdate::is_questions_Valid() const{
    return m_questions_isValid;
}

OAILeadFormStatus OAILeadFormBatchUpdate::getStatus() const {
    return m_status;
}
void OAILeadFormBatchUpdate::setStatus(const OAILeadFormStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAILeadFormBatchUpdate::is_status_Set() const{
    return m_status_isSet;
}

bool OAILeadFormBatchUpdate::is_status_Valid() const{
    return m_status_isValid;
}

bool OAILeadFormBatchUpdate::isSet() const {
...
bool OAILeadFormBatchUpdate::isValid() const {
