...
OAICatalogsItemsDeleteBatchRequest::OAICatalogsItemsDeleteBatchRequest(const QString &json) {
...
void OAICatalogsItemsDeleteBatchRequest::fromJson(const QString &jsonString) {
...
QString OAICatalogsItemsDeleteBatchRequest::getLanguage() const {
    return m_language;
}
void OAICatalogsItemsDeleteBatchRequest::setLanguage(const QString &language) {
    m_language = language;
...
QString OAICatalogsItemsDeleteBatchRequest::getOperation() const {
    return m_operation;
}
void OAICatalogsItemsDeleteBatchRequest::setOperation(const QString &operation) {
