...
OAIUpdatePartnerAssetsResult::OAIUpdatePartnerAssetsResult(const QString &json) {
...
void OAIUpdatePartnerAssetsResult::fromJson(const QString &jsonString) {
...
OAIAssetTypeResponse OAIUpdatePartnerAssetsResult::getAssetType() const {
    return m_asset_type;
}
void OAIUpdatePartnerAssetsResult::setAssetType(const OAIAssetTypeResponse &asset_type) {
