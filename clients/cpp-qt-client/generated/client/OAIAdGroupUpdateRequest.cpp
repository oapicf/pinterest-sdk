...
OAIAdGroupCommon_optimization_goal_metadata OAIAdGroupUpdateRequest::getOptimizationGoalMetadata() const {
    return m_optimization_goal_metadata;
}
void OAIAdGroupUpdateRequest::setOptimizationGoalMetadata(const OAIAdGroupCommon_optimization_goal_metadata &optimization_goal_metadata) {
