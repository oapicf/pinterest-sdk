...
OAIAdGroupUpdateRequest::OAIAdGroupUpdateRequest(const QString &json) {
...
void OAIAdGroupUpdateRequest::fromJson(const QString &jsonString) {
...
QJsonObject OAIAdGroupUpdateRequest::asJsonObject() const {
    ...
    if (m_promotion_application_level_isSet) {
...
double OAIAdGroupUpdateRequest::getBidMultiplier() const {
    return m_bid_multiplier;
}
void OAIAdGroupUpdateRequest::setBidMultiplier(const double &bid_multiplier) {
    m_bid_multiplier = bid_multiplier;
    m_bid_multiplier_isSet = true;
}

bool OAIAdGroupUpdateRequest::is_bid_multiplier_Set() const{
    return m_bid_multiplier_isSet;
}

bool OAIAdGroupUpdateRequest::is_bid_multiplier_Valid() const{
...
QList<OAITargetingSpecOperations> OAIAdGroupUpdateRequest::getTargetingSpecOperations() const {
    return m_targeting_spec_operations;
}
void OAIAdGroupUpdateRequest::setTargetingSpecOperations(const QList<OAITargetingSpecOperations> &targeting_spec_operations) {
    m_targeting_spec_operations = targeting_spec_operations;
    m_targeting_spec_operations_isSet = true;
}

bool OAIAdGroupUpdateRequest::is_targeting_spec_operations_Set() const{
    return m_targeting_spec_operations_isSet;
}

bool OAIAdGroupUpdateRequest::is_targeting_spec_operations_Valid() const{
...
OAIBidStrategyType OAIAdGroupUpdateRequest::getBidStrategyType() const {
    return m_bid_strategy_type;
}
void OAIAdGroupUpdateRequest::setBidStrategyType(const OAIBidStrategyType &bid_strategy_type) {
...
bool OAIAdGroupUpdateRequest::isIsCreativeOptimization() const {
    return m_is_creative_optimization;
}
void OAIAdGroupUpdateRequest::setIsCreativeOptimization(const bool &is_creative_optimization) {
    m_is_creative_optimization = is_creative_optimization;
    m_is_creative_optimization_isSet = true;
}

bool OAIAdGroupUpdateRequest::is_is_creative_optimization_Set() const{
    return m_is_creative_optimization_isSet;
}

bool OAIAdGroupUpdateRequest::is_is_creative_optimization_Valid() const{
...
OAIObject OAIAdGroupUpdateRequest::getOptimizationGoalMetadata() const {
    return m_optimization_goal_metadata;
}
void OAIAdGroupUpdateRequest::setOptimizationGoalMetadata(const OAIObject &optimization_goal_metadata) {
    m_optimization_goal_metadata = optimization_goal_metadata;
    m_optimization_goal_metadata_isSet = true;
}

bool OAIAdGroupUpdateRequest::is_optimization_goal_metadata_Set() const{
    return m_optimization_goal_metadata_isSet;
}

bool OAIAdGroupUpdateRequest::is_optimization_goal_metadata_Valid() const{
...
QString OAIAdGroupUpdateRequest::getPromotionApplicationLevel() const {
    return m_promotion_application_level;
}
void OAIAdGroupUpdateRequest::setPromotionApplicationLevel(const QString &promotion_application_level) {
    m_promotion_application_level = promotion_application_level;
    m_promotion_application_level_isSet = true;
}

bool OAIAdGroupUpdateRequest::is_promotion_application_level_Set() const{
    return m_promotion_application_level_isSet;
}

bool OAIAdGroupUpdateRequest::is_promotion_application_level_Valid() const{
    return m_promotion_application_level_isValid;
}

QString OAIAdGroupUpdateRequest::getPromotionId() const {
    return m_promotion_id;
}
void OAIAdGroupUpdateRequest::setPromotionId(const QString &promotion_id) {
    m_promotion_id = promotion_id;
    m_promotion_id_isSet = true;
}

bool OAIAdGroupUpdateRequest::is_promotion_id_Set() const{
    return m_promotion_id_isSet;
}

bool OAIAdGroupUpdateRequest::is_promotion_id_Valid() const{
    return m_promotion_id_isValid;
}

QList<QString> OAIAdGroupUpdateRequest::getPromotionIds() const {
    return m_promotion_ids;
}
void OAIAdGroupUpdateRequest::setPromotionIds(const QList<QString> &promotion_ids) {
    m_promotion_ids = promotion_ids;
    m_promotion_ids_isSet = true;
}

bool OAIAdGroupUpdateRequest::is_promotion_ids_Set() const{
    return m_promotion_ids_isSet;
}

bool OAIAdGroupUpdateRequest::is_promotion_ids_Valid() const{
...
OAITargetingSpec OAIAdGroupUpdateRequest::getTargetingSpec() const {
    return m_targeting_spec;
}
void OAIAdGroupUpdateRequest::setTargetingSpec(const OAITargetingSpec &targeting_spec) {
...
QList<QString> OAIAdGroupUpdateRequest::getTargetingTemplateIds() const {
    return m_targeting_template_ids;
}
void OAIAdGroupUpdateRequest::setTargetingTemplateIds(const QList<QString> &targeting_template_ids) {
    m_targeting_template_ids = targeting_template_ids;
    m_targeting_template_ids_isSet = true;
}

bool OAIAdGroupUpdateRequest::is_targeting_template_ids_Set() const{
    return m_targeting_template_ids_isSet;
}

bool OAIAdGroupUpdateRequest::is_targeting_template_ids_Valid() const{
    return m_targeting_template_ids_isValid;
}

OAIObject OAIAdGroupUpdateRequest::getTrackingUrls() const {
    return m_tracking_urls;
}
void OAIAdGroupUpdateRequest::setTrackingUrls(const OAIObject &tracking_urls) {
