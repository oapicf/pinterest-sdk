...
OAIOptimizationGoalMetadata OAIAdGroupUpdateRequest::getOptimizationGoalMetadata() const {
    return m_optimization_goal_metadata;
}
void OAIAdGroupUpdateRequest::setOptimizationGoalMetadata(const OAIOptimizationGoalMetadata &optimization_goal_metadata) {
...
OAITrackingUrls OAIAdGroupUpdateRequest::getTrackingUrls() const {
    return m_tracking_urls;
}
void OAIAdGroupUpdateRequest::setTrackingUrls(const OAITrackingUrls &tracking_urls) {
