...
OAICatalogsFeedProcessingSchedule::OAICatalogsFeedProcessingSchedule(const QString &json) {
...
void OAICatalogsFeedProcessingSchedule::fromJson(const QString &jsonString) {
...
OAICatalogsFeedProcessingScheduleTimezone OAICatalogsFeedProcessingSchedule::getTimezone() const {
    return m_timezone;
}
void OAICatalogsFeedProcessingSchedule::setTimezone(const OAICatalogsFeedProcessingScheduleTimezone &timezone) {
    m_timezone = timezone;
