...
OAIConversionTagCreate::OAIConversionTagCreate(const QString &json) {
...
void OAIConversionTagCreate::fromJson(const QString &jsonString) {
...
bool OAIConversionTagCreate::isAemExternalIdEnabled() const {
    return m_aem_external_id_enabled;
}
void OAIConversionTagCreate::setAemExternalIdEnabled(const bool &aem_external_id_enabled) {
    m_aem_external_id_enabled = aem_external_id_enabled;
    m_aem_external_id_enabled_isSet = true;
}

bool OAIConversionTagCreate::is_aem_external_id_enabled_Set() const{
    return m_aem_external_id_enabled_isSet;
}

bool OAIConversionTagCreate::is_aem_external_id_enabled_Valid() const{
