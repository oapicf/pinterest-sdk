...
OAICatalogsUpsertCreativeAssetsItem::OAICatalogsUpsertCreativeAssetsItem(const QString &json) {
...
void OAICatalogsUpsertCreativeAssetsItem::fromJson(const QString &jsonString) {
