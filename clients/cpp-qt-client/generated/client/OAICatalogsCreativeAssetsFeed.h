...
/*
 * OAICatalogsCreativeAssetsFeed.h
 *
 * Catalogs Creative Asset Feed object
 */

#ifndef OAICatalogsCreativeAssetsFeed_H
#define OAICatalogsCreativeAssetsFeed_H
...
class OAICatalogsCreativeAssetsFeed : public OAIObject {
public:
    OAICatalogsCreativeAssetsFeed();
    OAICatalogsCreativeAssetsFeed(const QString &json);
    ~OAICatalogsCreativeAssetsFeed() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICatalogsCreativeAssetsFeed)

#endif // OAICatalogsCreativeAssetsFeed_H
