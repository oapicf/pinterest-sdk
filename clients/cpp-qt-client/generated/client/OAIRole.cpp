...
OAIRole::OAIRole(const QString &json) {
...
void OAIRole::fromJson(const QString &jsonString) {
    ...
    if ( jsonString.compare("UNKNOWN", Qt::CaseInsensitive) == 0) {
        ...
        m_value = eOAIRole::CATALOGS_VIEWER;
        m_value_isSet = m_value_isValid = true;
    }
...
QString OAIRole::asJson() const {
    ...
    switch (m_value){
        ...
        case eOAIRole::FINANCE_MANAGER:
            val = "FINANCE_MANAGER";
            break;
        case eOAIRole::FINANCE_EDIT:
            val = "FINANCE_EDIT";
            break;
        case eOAIRole::FINANCE_VIEW:
            val = "FINANCE_VIEW";
            break;
