...
OAIPinMediaSourceImagesURL::OAIPinMediaSourceImagesURL(const QString &json) {
...
void OAIPinMediaSourceImagesURL::fromJson(const QString &jsonString) {
...
QList<OAIPinMediaSourceImagesURLItem> OAIPinMediaSourceImagesURL::getItems() const {
    return m_items;
}
void OAIPinMediaSourceImagesURL::setItems(const QList<OAIPinMediaSourceImagesURLItem> &items) {
    m_items = items;
    m_items_isSet = true;
}
