...
OAILeadsExportResponseData::OAILeadsExportResponseData(const QString &json) {
...
void OAILeadsExportResponseData::fromJson(const QString &jsonString) {
...
void OAILeadsExportResponseData::fromJsonObject(QJsonObject json) {
    ...
    m_export_status_isValid = ::OpenAPI::fromJsonValue(m_export_status, json[QString("export_status")]);
...
QJsonObject OAILeadsExportResponseData::asJsonObject() const {
    ...
    if (m_export_status.isSet()) {
        obj.insert(QString("export_status"), ::OpenAPI::toJsonValue(m_export_status));
    }
    return obj;
}
