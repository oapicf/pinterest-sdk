...
public:
    ...
    * @param[in]  ad_account_id QString [optional]
    */
    void catalogsProductGroups_create(const OAICatalogsProductGroupCreateRequest &oai_catalogs_product_group_create_request, const ::OpenAPI::OptionalParam<QString> &ad_account_id = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  ad_account_id QString [optional]
    */
    void catalogsProductGroups_list(const QString &feed_id, const ::OpenAPI::OptionalParam<QString> &bookmark = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<qint32> &page_size = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &ad_account_id = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  ad_account_id QString [optional]
    */
    void catalogsProductGroups_update(const QString &product_group_id, const OAICatalogsProductGroupUpdateRequest &oai_catalogs_product_group_update_request, const ::OpenAPI::OptionalParam<QString> &ad_account_id = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  ad_account_id QString [optional]
    */
    void feeds_create(const OAICatalogsFeedsCreateRequest &oai_catalogs_feeds_create_request, const ::OpenAPI::OptionalParam<QString> &ad_account_id = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  ad_account_id QString [optional]
    */
    void feeds_list(const ::OpenAPI::OptionalParam<QString> &bookmark = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<qint32> &page_size = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &ad_account_id = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  ad_account_id QString [optional]
    */
    void feeds_update(const QString &feed_id, const OAICatalogsFeedsUpdateRequest &oai_catalogs_feeds_update_request, const ::OpenAPI::OptionalParam<QString> &ad_account_id = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  ad_account_id QString [optional]
    */
    void itemsBatch_post(const OAICatalogsItemsBatchRequest &oai_catalogs_items_batch_request, const ::OpenAPI::OptionalParam<QString> &ad_account_id = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  ad_account_id QString [optional]
    */
    void items_get(const QString &country, const QList<QString> &item_ids, const QString &language, const ::OpenAPI::OptionalParam<QString> &ad_account_id = ::OpenAPI::OptionalParam<QString>());
...
Q_SIGNALS:
    ...
    void catalogsProductGroupPins_listSignalError(OAIProducts_by_product_group_filter_list_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void catalogsProductGroups_createSignalError(OAICatalogsProductGroup summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void catalogsProductGroups_getSignalError(OAICatalogsProductGroup summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void catalogsProductGroups_updateSignalError(OAICatalogsProductGroup summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void productsByProductGroupFilter_listSignalError(OAIProducts_by_product_group_filter_list_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
