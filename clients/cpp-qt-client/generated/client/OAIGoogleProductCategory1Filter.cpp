...
OAIGoogleProductCategory1Filter::OAIGoogleProductCategory1Filter(const QString &json) {
...
void OAIGoogleProductCategory1Filter::fromJson(const QString &jsonString) {
