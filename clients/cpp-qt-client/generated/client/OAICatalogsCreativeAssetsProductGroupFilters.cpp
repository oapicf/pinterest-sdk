...
OAICatalogsCreativeAssetsProductGroupFilters::OAICatalogsCreativeAssetsProductGroupFilters(const QString &json) {
...
void OAICatalogsCreativeAssetsProductGroupFilters::fromJson(const QString &jsonString) {
