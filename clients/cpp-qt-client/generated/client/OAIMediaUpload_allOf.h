...
/*
 * OAIMediaUpload_allOf.h
 *
 * 
 */

#ifndef OAIMediaUpload_allOf_H
#define OAIMediaUpload_allOf_H
...
namespace OpenAPI {
class OAIMediaUpload_allOf_upload_parameters;

class OAIMediaUpload_allOf : public OAIObject {
public:
    OAIMediaUpload_allOf();
    OAIMediaUpload_allOf(QString json);
    ~OAIMediaUpload_allOf() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMediaUpload_allOf)

#endif // OAIMediaUpload_allOf_H
