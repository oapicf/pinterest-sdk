...
QList<OAICatalogs_product_groups_update_request> OAIBulkUpsertRequestUpdate::getCatalogProductGroups() const {
    return m_catalog_product_groups;
}
void OAIBulkUpsertRequestUpdate::setCatalogProductGroups(const QList<OAICatalogs_product_groups_update_request> &catalog_product_groups) {
