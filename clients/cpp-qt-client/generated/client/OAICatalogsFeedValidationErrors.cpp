...
OAICatalogsFeedValidationErrors::OAICatalogsFeedValidationErrors(const QString &json) {
...
void OAICatalogsFeedValidationErrors::fromJson(const QString &jsonString) {
...
void OAICatalogsFeedValidationErrors::fromJsonObject(QJsonObject json) {
    ...
    m_delimiter_error_isValid = ::OpenAPI::fromJsonValue(m_delimiter_error, json[QString("DELIMITER_ERROR")]);
    ...
    m_encoding_error_isValid = ::OpenAPI::fromJsonValue(m_encoding_error, json[QString("ENCODING_ERROR")]);
    m_encoding_error_isSet = !json[QString("ENCODING_ERROR")].isNull() && m_encoding_error_isValid;

    m_feed_length_too_long_isValid = ::OpenAPI::fromJsonValue(m_feed_length_too_long, json[QString("FEED_LENGTH_TOO_LONG")]);
    m_feed_length_too_long_isSet = !json[QString("FEED_LENGTH_TOO_LONG")].isNull() && m_feed_length_too_long_isValid;

    m_feed_too_small_isValid = ::OpenAPI::fromJsonValue(m_feed_too_small, json[QString("FEED_TOO_SMALL")]);
    m_feed_too_small_isSet = !json[QString("FEED_TOO_SMALL")].isNull() && m_feed_too_small_isValid;

    m_fetch_error_isValid = ::OpenAPI::fromJsonValue(m_fetch_error, json[QString("FETCH_ERROR")]);
    m_fetch_error_isSet = !json[QString("FETCH_ERROR")].isNull() && m_fetch_error_isValid;

    m_fetch_inactive_feed_error_isValid = ::OpenAPI::fromJsonValue(m_fetch_inactive_feed_error, json[QString("FETCH_INACTIVE_FEED_ERROR")]);
    ...
    m_internal_service_error_isValid = ::OpenAPI::fromJsonValue(m_internal_service_error, json[QString("INTERNAL_SERVICE_ERROR")]);
    ...
    m_malformed_xml_isValid = ::OpenAPI::fromJsonValue(m_malformed_xml, json[QString("MALFORMED_XML")]);
    ...
    m_no_verified_domain_isValid = ::OpenAPI::fromJsonValue(m_no_verified_domain, json[QString("NO_VERIFIED_DOMAIN")]);
    ...
    m_required_columns_missing_isValid = ::OpenAPI::fromJsonValue(m_required_columns_missing, json[QString("REQUIRED_COLUMNS_MISSING")]);
...
QJsonObject OAICatalogsFeedValidationErrors::asJsonObject() const {
    ...
    if (m_delimiter_error_isSet) {
        obj.insert(QString("DELIMITER_ERROR"), ::OpenAPI::toJsonValue(m_delimiter_error));
    }
    ...
    if (m_encoding_error_isSet) {
        obj.insert(QString("ENCODING_ERROR"), ::OpenAPI::toJsonValue(m_encoding_error));
    }
    if (m_feed_length_too_long_isSet) {
        obj.insert(QString("FEED_LENGTH_TOO_LONG"), ::OpenAPI::toJsonValue(m_feed_length_too_long));
    }
    if (m_feed_too_small_isSet) {
        obj.insert(QString("FEED_TOO_SMALL"), ::OpenAPI::toJsonValue(m_feed_too_small));
    }
    if (m_fetch_error_isSet) {
        obj.insert(QString("FETCH_ERROR"), ::OpenAPI::toJsonValue(m_fetch_error));
    }
    if (m_fetch_inactive_feed_error_isSet) {
        obj.insert(QString("FETCH_INACTIVE_FEED_ERROR"), ::OpenAPI::toJsonValue(m_fetch_inactive_feed_error));
    }
    ...
    if (m_internal_service_error_isSet) {
        obj.insert(QString("INTERNAL_SERVICE_ERROR"), ::OpenAPI::toJsonValue(m_internal_service_error));
    }
    ...
    if (m_malformed_xml_isSet) {
        obj.insert(QString("MALFORMED_XML"), ::OpenAPI::toJsonValue(m_malformed_xml));
    }
    ...
    if (m_no_verified_domain_isSet) {
        obj.insert(QString("NO_VERIFIED_DOMAIN"), ::OpenAPI::toJsonValue(m_no_verified_domain));
    }
    ...
    if (m_required_columns_missing_isSet) {
        obj.insert(QString("REQUIRED_COLUMNS_MISSING"), ::OpenAPI::toJsonValue(m_required_columns_missing));
    }
...
void OAICatalogsFeedValidationErrors::setDelimiterError(const qint32 &delimiter_error) {
    m_delimiter_error = delimiter_error;
    m_delimiter_error_isSet = true;
}
...
void OAICatalogsFeedValidationErrors::setEncodingError(const qint32 &encoding_error) {
    m_encoding_error = encoding_error;
    m_encoding_error_isSet = true;
}
...
void OAICatalogsFeedValidationErrors::setFeedLengthTooLong(const qint32 &feed_length_too_long) {
    m_feed_length_too_long = feed_length_too_long;
    m_feed_length_too_long_isSet = true;
}
...
void OAICatalogsFeedValidationErrors::setFeedTooSmall(const qint32 &feed_too_small) {
    m_feed_too_small = feed_too_small;
    m_feed_too_small_isSet = true;
}
...
void OAICatalogsFeedValidationErrors::setFetchError(const qint32 &fetch_error) {
    m_fetch_error = fetch_error;
    m_fetch_error_isSet = true;
}
...
void OAICatalogsFeedValidationErrors::setFetchInactiveFeedError(const qint32 &fetch_inactive_feed_error) {
    m_fetch_inactive_feed_error = fetch_inactive_feed_error;
    m_fetch_inactive_feed_error_isSet = true;
}
...
void OAICatalogsFeedValidationErrors::setInternalServiceError(const qint32 &internal_service_error) {
    m_internal_service_error = internal_service_error;
    m_internal_service_error_isSet = true;
}
...
void OAICatalogsFeedValidationErrors::setMalformedXml(const qint32 &malformed_xml) {
    m_malformed_xml = malformed_xml;
    m_malformed_xml_isSet = true;
}
...
void OAICatalogsFeedValidationErrors::setNoVerifiedDomain(const qint32 &no_verified_domain) {
    m_no_verified_domain = no_verified_domain;
    m_no_verified_domain_isSet = true;
}
...
void OAICatalogsFeedValidationErrors::setRequiredColumnsMissing(const qint32 &required_columns_missing) {
    m_required_columns_missing = required_columns_missing;
    m_required_columns_missing_isSet = true;
}
