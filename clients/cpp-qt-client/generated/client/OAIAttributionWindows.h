...
/*
 * OAIAttributionWindows.h
 *
 * 
 */

#ifndef OAIAttributionWindows_H
#define OAIAttributionWindows_H
...
class OAIAttributionWindows : public OAIObject {
public:
    OAIAttributionWindows();
    OAIAttributionWindows(const QString &json);
    ~OAIAttributionWindows() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAttributionWindows)

#endif // OAIAttributionWindows_H
