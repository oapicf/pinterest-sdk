...
public:
    ...
    OAIPinMediaSourceVideoID(const QString &json);
    ...
    OAIContentType getCoverImageContentType() const;
    void setCoverImageContentType(const OAIContentType &cover_image_content_type);
    ...
    qint32 getCoverImageKeyFrameTime() const;
    void setCoverImageKeyFrameTime(const qint32 &cover_image_key_frame_time);
    bool is_cover_image_key_frame_time_Set() const;
    bool is_cover_image_key_frame_time_Valid() const;
...
private:
    ...
    OAIContentType m_cover_image_content_type;
    ...
    qint32 m_cover_image_key_frame_time;
    bool m_cover_image_key_frame_time_isSet;
    bool m_cover_image_key_frame_time_isValid;
