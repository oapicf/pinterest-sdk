...
public:
    ...
    OAICatalogsItemValidationDetails getAgeGroupNormalized() const;
    void setAgeGroupNormalized(const OAICatalogsItemValidationDetails &age_group_normalized);
    ...
    OAICatalogsItemValidationDetails getAvailabilityNormalized() const;
    void setAvailabilityNormalized(const OAICatalogsItemValidationDetails &availability_normalized);
    bool is_availability_normalized_Set() const;
    bool is_availability_normalized_Valid() const;

    OAICatalogsItemValidationDetails getConditionNormalized() const;
    void setConditionNormalized(const OAICatalogsItemValidationDetails &condition_normalized);
    ...
    OAICatalogsItemValidationDetails getGenderNormalized() const;
    void setGenderNormalized(const OAICatalogsItemValidationDetails &gender_normalized);
    ...
    OAICatalogsItemValidationDetails getSizeTypeNormalized() const;
    void setSizeTypeNormalized(const OAICatalogsItemValidationDetails &size_type_normalized);
...
private:
    ...
    OAICatalogsItemValidationDetails age_group_normalized;
    ...
    OAICatalogsItemValidationDetails availability_normalized;
    bool m_availability_normalized_isSet;
    bool m_availability_normalized_isValid;

    OAICatalogsItemValidationDetails condition_normalized;
    ...
    OAICatalogsItemValidationDetails gender_normalized;
    ...
    OAICatalogsItemValidationDetails size_type_normalized;
