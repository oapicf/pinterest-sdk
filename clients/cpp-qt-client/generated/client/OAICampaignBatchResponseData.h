...
public:
    ...
    OAICampaignBatchResponseData(const QString &json);
...
private:
    ...
    OAICampaignBidOptions m_bid_options;
    ...
    OAICampaignObjectiveType m_objective_type;
    ...
    OAINullableEntityStatus m_status;
    bool m_status_isSet;
