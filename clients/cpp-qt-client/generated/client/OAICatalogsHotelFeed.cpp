...
OAICatalogsHotelFeed::OAICatalogsHotelFeed(const QString &json) {
...
void OAICatalogsHotelFeed::fromJson(const QString &jsonString) {
...
QString OAICatalogsHotelFeed::getCatalogType() const {
    return m_catalog_type;
}
void OAICatalogsHotelFeed::setCatalogType(const QString &catalog_type) {
...
bool OAICatalogsHotelFeed::isValid() const {
    ...
    return m_catalog_id_isValid && m_catalog_type_isValid && m_created_at_isValid && m_default_locale_isValid && m_format_isValid && m_id_isValid && m_location_isValid && m_name_isValid && m_status_isValid && m_updated_at_isValid && true;
}
