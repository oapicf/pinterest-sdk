...
bool OAICatalogsHotelFeed::isValid() const {
    ...
    return m_name_isValid && m_format_isValid && m_catalog_type_isValid && m_credentials_isValid && m_location_isValid && m_preferred_processing_schedule_isValid && m_status_isValid && m_default_currency_isValid && m_default_locale_isValid && m_catalog_id_isValid && true;
}
