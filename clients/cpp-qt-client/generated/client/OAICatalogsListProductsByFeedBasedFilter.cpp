...
OAICatalogsListProductsByFeedBasedFilter::OAICatalogsListProductsByFeedBasedFilter(const QString &json) {
...
void OAICatalogsListProductsByFeedBasedFilter::fromJson(const QString &jsonString) {
