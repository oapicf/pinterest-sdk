...
#ifndef OAILeadFormCommon_H
#define OAILeadFormCommon_H
...
class OAILeadFormCommon : public OAIObject {
public:
    OAILeadFormCommon();
    OAILeadFormCommon(QString json);
    ~OAILeadFormCommon() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILeadFormCommon)

#endif // OAILeadFormCommon_H
