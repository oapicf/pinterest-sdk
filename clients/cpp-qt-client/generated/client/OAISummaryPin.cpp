...
OAISummaryPin::OAISummaryPin(const QString &json) {
...
void OAISummaryPin::fromJson(const QString &jsonString) {
...
QString OAISummaryPin::getId() const {
    return m_id;
}
void OAISummaryPin::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAISummaryPin::is_id_Set() const{
    return m_id_isSet;
}

bool OAISummaryPin::is_id_Valid() const{
    return m_id_isValid;
}
