...
OAIBidFloorSpec::OAIBidFloorSpec(const QString &json) {
...
void OAIBidFloorSpec::fromJson(const QString &jsonString) {
...
OAIBidFloorObjectiveType OAIBidFloorSpec::getObjectiveType() const {
    return m_objective_type;
}
void OAIBidFloorSpec::setObjectiveType(const OAIBidFloorObjectiveType &objective_type) {
...
bool OAIBidFloorSpec::isValid() const {
    ...
    return m_billable_event_isValid && m_currency_isValid && true;
}
