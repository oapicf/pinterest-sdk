...
OAICatalogsUpdateCreativeAssetsItem::OAICatalogsUpdateCreativeAssetsItem(const QString &json) {
...
void OAICatalogsUpdateCreativeAssetsItem::fromJson(const QString &jsonString) {
