...
OAIKeyword::OAIKeyword(const QString &json) {
...
void OAIKeyword::fromJson(const QString &jsonString) {
...
OAIMatchType OAIKeyword::getMatchType() const {
    return m_match_type;
}
void OAIKeyword::setMatchType(const OAIMatchType &match_type) {
...
bool OAIKeyword::isValid() const {
    ...
    return m_id_isValid && m_match_type_isValid && m_parent_id_isValid && m_value_isValid && true;
}
