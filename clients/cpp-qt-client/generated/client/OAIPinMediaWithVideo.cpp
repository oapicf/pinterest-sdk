...
OAIPinMediaWithVideo::OAIPinMediaWithVideo(const QString &json) {
...
void OAIPinMediaWithVideo::fromJson(const QString &jsonString) {
...
OAIImageSize OAIPinMediaWithVideo::getImages() const {
    return m_images;
}
void OAIPinMediaWithVideo::setImages(const OAIImageSize &images) {
    m_images = images;
    m_images_isSet = true;
}
...
QString OAIPinMediaWithVideo::getVideoUrlHls() const {
    return m_video_url_hls;
}
void OAIPinMediaWithVideo::setVideoUrlHls(const QString &video_url_hls) {
    m_video_url_hls = video_url_hls;
    m_video_url_hls_isSet = true;
}

bool OAIPinMediaWithVideo::is_video_url_hls_Set() const{
    return m_video_url_hls_isSet;
}

bool OAIPinMediaWithVideo::is_video_url_hls_Valid() const{
