...
OAIPinMediaWithImage_allOf_images OAIPinMediaWithVideo::getImages() const {
    return m_images;
}
void OAIPinMediaWithVideo::setImages(const OAIPinMediaWithImage_allOf_images &images) {
    m_images = images;
    m_images_isSet = true;
}
