...
/*
 * OAICatalogs_product_group_feed_based_case.h
 *
 * 
 */

#ifndef OAICatalogs_product_group_feed_based_case_H
#define OAICatalogs_product_group_feed_based_case_H
...
class OAICatalogs_product_group_feed_based_case : public OAIObject {
public:
    OAICatalogs_product_group_feed_based_case();
    OAICatalogs_product_group_feed_based_case(QString json);
    ~OAICatalogs_product_group_feed_based_case() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICatalogs_product_group_feed_based_case)

#endif // OAICatalogs_product_group_feed_based_case_H
