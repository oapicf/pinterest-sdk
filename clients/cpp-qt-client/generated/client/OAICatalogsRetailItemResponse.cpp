...
OAICatalogsRetailItemResponse::OAICatalogsRetailItemResponse(const QString &json) {
...
void OAICatalogsRetailItemResponse::fromJson(const QString &jsonString) {
...
QString OAICatalogsRetailItemResponse::getCatalogType() const {
    return m_catalog_type;
}
void OAICatalogsRetailItemResponse::setCatalogType(const QString &catalog_type) {
...
QString OAICatalogsRetailItemResponse::getItemResponseKind() const {
    return m_item_response_kind;
}
void OAICatalogsRetailItemResponse::setItemResponseKind(const QString &item_response_kind) {
    m_item_response_kind = item_response_kind;
    m_item_response_kind_isSet = true;
}

bool OAICatalogsRetailItemResponse::is_item_response_kind_Set() const{
    return m_item_response_kind_isSet;
}

bool OAICatalogsRetailItemResponse::is_item_response_kind_Valid() const{
