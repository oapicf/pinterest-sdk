...
OAISSIOAccountAddress::OAISSIOAccountAddress(const QString &json) {
...
void OAISSIOAccountAddress::fromJson(const QString &jsonString) {
...
void OAISSIOAccountAddress::fromJsonObject(QJsonObject json) {
    ...
    m_order_legal_entity_isValid = ::OpenAPI::fromJsonValue(m_order_legal_entity, json[QString("order_legal_entity")]);
...
QJsonObject OAISSIOAccountAddress::asJsonObject() const {
    ...
    if (m_order_legal_entity_isSet) {
        obj.insert(QString("order_legal_entity"), ::OpenAPI::toJsonValue(m_order_legal_entity));
    }
    if (m_purpose_isSet) {
...
void OAISSIOAccountAddress::setOrderLegalEntity(const QString &order_legal_entity) {
    m_order_legal_entity = order_legal_entity;
    m_order_legal_entity_isSet = true;
}
