...
OAICatalogsItemsBatch::OAICatalogsItemsBatch(const QString &json) {
...
void OAICatalogsItemsBatch::fromJson(const QString &jsonString) {
...
QString OAICatalogsItemsBatch::getCatalogType() const {
    return m_catalog_type;
}
void OAICatalogsItemsBatch::setCatalogType(const QString &catalog_type) {
    m_catalog_type = catalog_type;
    m_catalog_type_isSet = true;
}

bool OAICatalogsItemsBatch::is_catalog_type_Set() const{
    return m_catalog_type_isSet;
}

bool OAICatalogsItemsBatch::is_catalog_type_Valid() const{
...
QList<OAICreativeAssetsProcessingRecord> OAICatalogsItemsBatch::getItems() const {
    return m_items;
}
void OAICatalogsItemsBatch::setItems(const QList<OAICreativeAssetsProcessingRecord> &items) {
    m_items = items;
    m_items_isSet = true;
}
