...
public:
    ...
    OAIConversionEventDeviceInfo(const QString &json);
    ...
    OAIFormFactor getFormFactor() const;
    void setFormFactor(const OAIFormFactor &form_factor);
    ...
    OAINetworkType getNetworkType() const;
    void setNetworkType(const OAINetworkType &network_type);
    bool is_network_type_Set() const;
    bool is_network_type_Valid() const;

    OAIOsFamily getOsFamily() const;
    void setOsFamily(const OAIOsFamily &os_family);
...
private:
    ...
    OAINetworkType m_network_type;
    bool m_network_type_isSet;
    bool m_network_type_isValid;

    OAIOsFamily m_os_family;
