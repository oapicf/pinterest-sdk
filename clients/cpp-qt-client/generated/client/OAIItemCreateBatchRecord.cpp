...
OAIItemCreateBatchRecord::OAIItemCreateBatchRecord(const QString &json) {
...
void OAIItemCreateBatchRecord::fromJson(const QString &jsonString) {
...
OAIItemAttributesRequest OAIItemCreateBatchRecord::getAttributes() const {
    return m_attributes;
}
void OAIItemCreateBatchRecord::setAttributes(const OAIItemAttributesRequest &attributes) {
