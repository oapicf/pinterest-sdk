...
public:
    ...
    * @param[in]  oai_brand_accounts_create_request OAIBrand_accounts_create_request [required]
    */
    virtual void brandAccounts_create(const QString &business_hierarchy_id, const OAIBrand_accounts_create_request &oai_brand_accounts_create_request);

    /**
    * @param[in]  business_hierarchy_id QString [required]
    * @param[in]  brand_account_id QString [required]
    * @param[in]  oai_brand_accounts_update_request OAIBrand_accounts_update_request [required]
    */
    virtual void brandAccounts_update(const QString &business_hierarchy_id, const QString &brand_account_id, const OAIBrand_accounts_update_request &oai_brand_accounts_update_request);
    ...
    * @param[in]  oai_system_user_update_request OAISystem_user_update_request [required]
    */
    virtual void systemUser_update(const QString &business_id, const QString &system_user_id, const OAISystem_user_update_request &oai_system_user_update_request);
...
Q_SIGNALS:
    ...
    void brandAccounts_createSignal(OAIBrand_accounts_create_200_response summary);
    void brandAccounts_updateSignal(OAIBrand_accounts_create_200_response summary);
    ...
    void brandAccounts_createSignalFull(OAIHttpRequestWorker *worker, OAIBrand_accounts_create_200_response summary);
    void brandAccounts_updateSignalFull(OAIHttpRequestWorker *worker, OAIBrand_accounts_create_200_response summary);
    ...
    Q_DECL_DEPRECATED_X("Use brandAccounts_createSignalError() instead")
    void brandAccounts_createSignalE(OAIBrand_accounts_create_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void brandAccounts_createSignalError(OAIBrand_accounts_create_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use brandAccounts_updateSignalError() instead")
    void brandAccounts_updateSignalE(OAIBrand_accounts_create_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void brandAccounts_updateSignalError(OAIBrand_accounts_create_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use systemUser_updateSignalError() instead")
    void systemUser_updateSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    ...
    Q_DECL_DEPRECATED_X("Use brandAccounts_createSignalErrorFull() instead")
    void brandAccounts_createSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    ...
    Q_DECL_DEPRECATED_X("Use brandAccounts_updateSignalErrorFull() instead")
    void brandAccounts_updateSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    ...
    Q_DECL_DEPRECATED_X("Use systemUser_updateSignalErrorFull() instead")
    void systemUser_updateSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
