...
OAIAdGroupCreateRequest::OAIAdGroupCreateRequest(const QString &json) {
...
void OAIAdGroupCreateRequest::fromJson(const QString &jsonString) {
...
double OAIAdGroupCreateRequest::getBidMultiplier() const {
    return m_bid_multiplier;
}
void OAIAdGroupCreateRequest::setBidMultiplier(const double &bid_multiplier) {
    m_bid_multiplier = bid_multiplier;
    m_bid_multiplier_isSet = true;
}

bool OAIAdGroupCreateRequest::is_bid_multiplier_Set() const{
    return m_bid_multiplier_isSet;
}

bool OAIAdGroupCreateRequest::is_bid_multiplier_Valid() const{
...
OAIBidStrategyType OAIAdGroupCreateRequest::getBidStrategyType() const {
    return m_bid_strategy_type;
}
void OAIAdGroupCreateRequest::setBidStrategyType(const OAIBidStrategyType &bid_strategy_type) {
...
bool OAIAdGroupCreateRequest::isIsCreativeOptimization() const {
    return m_is_creative_optimization;
}
void OAIAdGroupCreateRequest::setIsCreativeOptimization(const bool &is_creative_optimization) {
    m_is_creative_optimization = is_creative_optimization;
    m_is_creative_optimization_isSet = true;
}

bool OAIAdGroupCreateRequest::is_is_creative_optimization_Set() const{
    return m_is_creative_optimization_isSet;
}

bool OAIAdGroupCreateRequest::is_is_creative_optimization_Valid() const{
...
OAIObject OAIAdGroupCreateRequest::getOptimizationGoalMetadata() const {
    return m_optimization_goal_metadata;
}
void OAIAdGroupCreateRequest::setOptimizationGoalMetadata(const OAIObject &optimization_goal_metadata) {
...
QString OAIAdGroupCreateRequest::getPromotionApplicationLevel() const {
    return m_promotion_application_level;
}
void OAIAdGroupCreateRequest::setPromotionApplicationLevel(const QString &promotion_application_level) {
    m_promotion_application_level = promotion_application_level;
    m_promotion_application_level_isSet = true;
}

bool OAIAdGroupCreateRequest::is_promotion_application_level_Set() const{
    return m_promotion_application_level_isSet;
}

bool OAIAdGroupCreateRequest::is_promotion_application_level_Valid() const{
    return m_promotion_application_level_isValid;
}

QString OAIAdGroupCreateRequest::getPromotionId() const {
    return m_promotion_id;
}
void OAIAdGroupCreateRequest::setPromotionId(const QString &promotion_id) {
    m_promotion_id = promotion_id;
    m_promotion_id_isSet = true;
}

bool OAIAdGroupCreateRequest::is_promotion_id_Set() const{
    return m_promotion_id_isSet;
}

bool OAIAdGroupCreateRequest::is_promotion_id_Valid() const{
    return m_promotion_id_isValid;
}

QList<QString> OAIAdGroupCreateRequest::getPromotionIds() const {
    return m_promotion_ids;
}
void OAIAdGroupCreateRequest::setPromotionIds(const QList<QString> &promotion_ids) {
    m_promotion_ids = promotion_ids;
    m_promotion_ids_isSet = true;
}

bool OAIAdGroupCreateRequest::is_promotion_ids_Set() const{
    return m_promotion_ids_isSet;
}

bool OAIAdGroupCreateRequest::is_promotion_ids_Valid() const{
...
OAIObject OAIAdGroupCreateRequest::getTrackingUrls() const {
    return m_tracking_urls;
}
void OAIAdGroupCreateRequest::setTrackingUrls(const OAIObject &tracking_urls) {
