...
#ifndef OAILeadForm_H
#define OAILeadForm_H
...
class OAILeadForm : public OAIObject {
public:
    OAILeadForm();
    OAILeadForm(const QString &json);
    ~OAILeadForm() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILeadForm)
