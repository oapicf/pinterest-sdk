...
OAICatalogsProductGroupFiltersAllOfRequest OAICatalogsProductGroupCreateRequest::getFilters() const {
    return m_filters;
}
void OAICatalogsProductGroupCreateRequest::setFilters(const OAICatalogsProductGroupFiltersAllOfRequest &filters) {
    m_filters = filters;
