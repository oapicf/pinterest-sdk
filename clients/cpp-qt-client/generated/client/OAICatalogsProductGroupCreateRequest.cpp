...
OAICatalogsProductGroupCreateRequest::OAICatalogsProductGroupCreateRequest(const QString &json) {
...
void OAICatalogsProductGroupCreateRequest::fromJson(const QString &jsonString) {
...
bool OAICatalogsProductGroupCreateRequest::isValid() const {
    ...
    return m_feed_id_isValid && m_filters_isValid && m_name_isValid && true;
}
