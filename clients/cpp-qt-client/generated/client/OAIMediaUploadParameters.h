...
/*
 * OAIMediaUploadParameters.h
 *
 * 
 */

#ifndef OAIMediaUploadParameters_H
#define OAIMediaUploadParameters_H
...
class OAIMediaUploadParameters : public OAIObject {
public:
    OAIMediaUploadParameters();
    OAIMediaUploadParameters(const QString &json);
    ~OAIMediaUploadParameters() override;
...
private:
    ...
    QString m_x_amz_security_token;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMediaUploadParameters)

#endif // OAIMediaUploadParameters_H
