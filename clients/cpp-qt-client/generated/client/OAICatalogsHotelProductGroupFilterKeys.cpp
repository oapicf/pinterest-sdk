...
OAICatalogsHotelProductGroupFilterKeys::OAICatalogsHotelProductGroupFilterKeys(const QString &json) {
...
void OAICatalogsHotelProductGroupFilterKeys::fromJson(const QString &jsonString) {
...
OAIPriceFilterPrice OAICatalogsHotelProductGroupFilterKeys::getPrice() const {
    return m_price;
}
void OAICatalogsHotelProductGroupFilterKeys::setPrice(const OAIPriceFilterPrice &price) {
    m_price = price;
    m_price_isSet = true;
}
...
OAICatalogsProductGroupFilterOperatorTypeCriteria OAICatalogsHotelProductGroupFilterKeys::getCustomLabel0() const {
    return m_custom_label_0;
}
void OAICatalogsHotelProductGroupFilterKeys::setCustomLabel0(const OAICatalogsProductGroupFilterOperatorTypeCriteria &custom_label_0) {
...
OAICatalogsProductGroupFilterOperatorTypeCriteria OAICatalogsHotelProductGroupFilterKeys::getCustomLabel1() const {
    return m_custom_label_1;
}
void OAICatalogsHotelProductGroupFilterKeys::setCustomLabel1(const OAICatalogsProductGroupFilterOperatorTypeCriteria &custom_label_1) {
...
OAICatalogsProductGroupFilterOperatorTypeCriteria OAICatalogsHotelProductGroupFilterKeys::getCustomLabel2() const {
    return m_custom_label_2;
}
void OAICatalogsHotelProductGroupFilterKeys::setCustomLabel2(const OAICatalogsProductGroupFilterOperatorTypeCriteria &custom_label_2) {
...
OAICatalogsProductGroupFilterOperatorTypeCriteria OAICatalogsHotelProductGroupFilterKeys::getCustomLabel3() const {
    return m_custom_label_3;
}
void OAICatalogsHotelProductGroupFilterKeys::setCustomLabel3(const OAICatalogsProductGroupFilterOperatorTypeCriteria &custom_label_3) {
...
OAICatalogsProductGroupFilterOperatorTypeCriteria OAICatalogsHotelProductGroupFilterKeys::getCustomLabel4() const {
    return m_custom_label_4;
}
void OAICatalogsHotelProductGroupFilterKeys::setCustomLabel4(const OAICatalogsProductGroupFilterOperatorTypeCriteria &custom_label_4) {
...
OAICatalogsProductGroupMultipleStringCriteria OAICatalogsHotelProductGroupFilterKeys::getTitleKeywords() const {
    return m_title_keywords;
}
void OAICatalogsHotelProductGroupFilterKeys::setTitleKeywords(const OAICatalogsProductGroupMultipleStringCriteria &title_keywords) {
    m_title_keywords = title_keywords;
    m_title_keywords_isSet = true;
}

bool OAICatalogsHotelProductGroupFilterKeys::is_title_keywords_Set() const{
    return m_title_keywords_isSet;
}

bool OAICatalogsHotelProductGroupFilterKeys::is_title_keywords_Valid() const{
...
bool OAICatalogsHotelProductGroupFilterKeys::isValid() const {
    ...
    return m_price_isValid && m_hotel_id_isValid && m_brand_isValid && m_custom_label_0_isValid && m_custom_label_1_isValid && m_custom_label_2_isValid && m_custom_label_3_isValid && m_custom_label_4_isValid && m_country_isValid && m_title_keywords_isValid && true;
}
