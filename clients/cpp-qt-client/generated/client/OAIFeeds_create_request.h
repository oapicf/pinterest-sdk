...
/*
 * OAIFeeds_create_request.h
 *
 * 
 */

#ifndef OAIFeeds_create_request_H
#define OAIFeeds_create_request_H
...
class OAIFeeds_create_request : public OAIObject {
public:
    OAIFeeds_create_request();
    OAIFeeds_create_request(QString json);
    ~OAIFeeds_create_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFeeds_create_request)

#endif // OAIFeeds_create_request_H
