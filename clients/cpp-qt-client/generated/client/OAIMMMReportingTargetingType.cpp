...
OAIMMMReportingTargetingType::OAIMMMReportingTargetingType(const QString &json) {
...
void OAIMMMReportingTargetingType::fromJson(const QString &jsonString) {
    ...
    if ( jsonString.compare("APPTYPE", Qt::CaseInsensitive) == 0) {
        ...
        m_value = eOAIMMMReportingTargetingType::PLACEMENT;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("AUDIENCE_INCLUDE", Qt::CaseInsensitive) == 0) {
        m_value = eOAIMMMReportingTargetingType::AUDIENCE_INCLUDE;
        m_value_isSet = m_value_isValid = true;
    }
}
...
QString OAIMMMReportingTargetingType::asJson() const {
    ...
    switch (m_value){
        ...
        case eOAIMMMReportingTargetingType::LOCATION:
            val = "LOCATION";
            break;
        case eOAIMMMReportingTargetingType::PLACEMENT:
            val = "PLACEMENT";
            break;
        case eOAIMMMReportingTargetingType::AUDIENCE_INCLUDE:
