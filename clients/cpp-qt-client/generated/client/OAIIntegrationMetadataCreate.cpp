...
OAIIntegrationMetadataCreate::OAIIntegrationMetadataCreate(const QString &json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIIntegrationMetadataCreate::OAIIntegrationMetadataCreate() {
    this->initializeModel();
}

OAIIntegrationMetadataCreate::~OAIIntegrationMetadataCreate() {}

void OAIIntegrationMetadataCreate::initializeModel() {
...
void OAIIntegrationMetadataCreate::fromJson(const QString &jsonString) {
...
void OAIIntegrationMetadataCreate::fromJsonObject(QJsonObject json) {
...
QString OAIIntegrationMetadataCreate::asJson() const {
...
QJsonObject OAIIntegrationMetadataCreate::asJsonObject() const {
    QJsonObject obj;
...
QString OAIIntegrationMetadataCreate::getAdditionalId1() const {
    return m_additional_id_1;
}
void OAIIntegrationMetadataCreate::setAdditionalId1(const QString &additional_id_1) {
    m_additional_id_1 = additional_id_1;
    m_additional_id_1_isSet = true;
}

bool OAIIntegrationMetadataCreate::is_additional_id_1_Set() const{
    return m_additional_id_1_isSet;
}

bool OAIIntegrationMetadataCreate::is_additional_id_1_Valid() const{
    return m_additional_id_1_isValid;
}

QString OAIIntegrationMetadataCreate::getConnectedAdvertiserId() const {
    return m_connected_advertiser_id;
}
void OAIIntegrationMetadataCreate::setConnectedAdvertiserId(const QString &connected_advertiser_id) {
    m_connected_advertiser_id = connected_advertiser_id;
    m_connected_advertiser_id_isSet = true;
}

bool OAIIntegrationMetadataCreate::is_connected_advertiser_id_Set() const{
    return m_connected_advertiser_id_isSet;
}

bool OAIIntegrationMetadataCreate::is_connected_advertiser_id_Valid() const{
    return m_connected_advertiser_id_isValid;
}

QString OAIIntegrationMetadataCreate::getConnectedLbaId() const {
    return m_connected_lba_id;
}
void OAIIntegrationMetadataCreate::setConnectedLbaId(const QString &connected_lba_id) {
    m_connected_lba_id = connected_lba_id;
    m_connected_lba_id_isSet = true;
}

bool OAIIntegrationMetadataCreate::is_connected_lba_id_Set() const{
    return m_connected_lba_id_isSet;
}

bool OAIIntegrationMetadataCreate::is_connected_lba_id_Valid() const{
    return m_connected_lba_id_isValid;
}

QString OAIIntegrationMetadataCreate::getConnectedMerchantId() const {
    return m_connected_merchant_id;
}
void OAIIntegrationMetadataCreate::setConnectedMerchantId(const QString &connected_merchant_id) {
    m_connected_merchant_id = connected_merchant_id;
    m_connected_merchant_id_isSet = true;
}

bool OAIIntegrationMetadataCreate::is_connected_merchant_id_Set() const{
    return m_connected_merchant_id_isSet;
}

bool OAIIntegrationMetadataCreate::is_connected_merchant_id_Valid() const{
    return m_connected_merchant_id_isValid;
}

QString OAIIntegrationMetadataCreate::getConnectedTagId() const {
    return m_connected_tag_id;
}
void OAIIntegrationMetadataCreate::setConnectedTagId(const QString &connected_tag_id) {
    m_connected_tag_id = connected_tag_id;
    m_connected_tag_id_isSet = true;
}

bool OAIIntegrationMetadataCreate::is_connected_tag_id_Set() const{
    return m_connected_tag_id_isSet;
}

bool OAIIntegrationMetadataCreate::is_connected_tag_id_Valid() const{
    return m_connected_tag_id_isValid;
}

QString OAIIntegrationMetadataCreate::getExternalBusinessId() const {
    return m_external_business_id;
}
void OAIIntegrationMetadataCreate::setExternalBusinessId(const QString &external_business_id) {
    m_external_business_id = external_business_id;
    m_external_business_id_isSet = true;
}

bool OAIIntegrationMetadataCreate::is_external_business_id_Set() const{
    return m_external_business_id_isSet;
}

bool OAIIntegrationMetadataCreate::is_external_business_id_Valid() const{
    return m_external_business_id_isValid;
}

QString OAIIntegrationMetadataCreate::getPartnerAccessToken() const {
    return m_partner_access_token;
}
void OAIIntegrationMetadataCreate::setPartnerAccessToken(const QString &partner_access_token) {
    m_partner_access_token = partner_access_token;
    m_partner_access_token_isSet = true;
}

bool OAIIntegrationMetadataCreate::is_partner_access_token_Set() const{
    return m_partner_access_token_isSet;
}

bool OAIIntegrationMetadataCreate::is_partner_access_token_Valid() const{
    return m_partner_access_token_isValid;
}

double OAIIntegrationMetadataCreate::getPartnerAccessTokenExpiry() const {
    return m_partner_access_token_expiry;
}
void OAIIntegrationMetadataCreate::setPartnerAccessTokenExpiry(const double &partner_access_token_expiry) {
    m_partner_access_token_expiry = partner_access_token_expiry;
    m_partner_access_token_expiry_isSet = true;
}

bool OAIIntegrationMetadataCreate::is_partner_access_token_expiry_Set() const{
    return m_partner_access_token_expiry_isSet;
}

bool OAIIntegrationMetadataCreate::is_partner_access_token_expiry_Valid() const{
    return m_partner_access_token_expiry_isValid;
}

QString OAIIntegrationMetadataCreate::getPartnerMetadata() const {
    return m_partner_metadata;
}
void OAIIntegrationMetadataCreate::setPartnerMetadata(const QString &partner_metadata) {
    m_partner_metadata = partner_metadata;
    m_partner_metadata_isSet = true;
}

bool OAIIntegrationMetadataCreate::is_partner_metadata_Set() const{
    return m_partner_metadata_isSet;
}

bool OAIIntegrationMetadataCreate::is_partner_metadata_Valid() const{
    return m_partner_metadata_isValid;
}

QString OAIIntegrationMetadataCreate::getPartnerPrimaryEmail() const {
    return m_partner_primary_email;
}
void OAIIntegrationMetadataCreate::setPartnerPrimaryEmail(const QString &partner_primary_email) {
    m_partner_primary_email = partner_primary_email;
    m_partner_primary_email_isSet = true;
}

bool OAIIntegrationMetadataCreate::is_partner_primary_email_Set() const{
    return m_partner_primary_email_isSet;
}

bool OAIIntegrationMetadataCreate::is_partner_primary_email_Valid() const{
    return m_partner_primary_email_isValid;
}

QString OAIIntegrationMetadataCreate::getPartnerRefreshToken() const {
    return m_partner_refresh_token;
}
void OAIIntegrationMetadataCreate::setPartnerRefreshToken(const QString &partner_refresh_token) {
    m_partner_refresh_token = partner_refresh_token;
    m_partner_refresh_token_isSet = true;
}

bool OAIIntegrationMetadataCreate::is_partner_refresh_token_Set() const{
    return m_partner_refresh_token_isSet;
}

bool OAIIntegrationMetadataCreate::is_partner_refresh_token_Valid() const{
    return m_partner_refresh_token_isValid;
}

double OAIIntegrationMetadataCreate::getPartnerRefreshTokenExpiry() const {
    return m_partner_refresh_token_expiry;
}
void OAIIntegrationMetadataCreate::setPartnerRefreshTokenExpiry(const double &partner_refresh_token_expiry) {
    m_partner_refresh_token_expiry = partner_refresh_token_expiry;
    m_partner_refresh_token_expiry_isSet = true;
}

bool OAIIntegrationMetadataCreate::is_partner_refresh_token_expiry_Set() const{
    return m_partner_refresh_token_expiry_isSet;
}

bool OAIIntegrationMetadataCreate::is_partner_refresh_token_expiry_Valid() const{
    return m_partner_refresh_token_expiry_isValid;
}

QString OAIIntegrationMetadataCreate::getScopes() const {
    return m_scopes;
}
void OAIIntegrationMetadataCreate::setScopes(const QString &scopes) {
    m_scopes = scopes;
    m_scopes_isSet = true;
}

bool OAIIntegrationMetadataCreate::is_scopes_Set() const{
    return m_scopes_isSet;
}

bool OAIIntegrationMetadataCreate::is_scopes_Valid() const{
    return m_scopes_isValid;
}

bool OAIIntegrationMetadataCreate::isSet() const {
...
bool OAIIntegrationMetadataCreate::isValid() const {
