...
OAICatalogsHotelItemsBatch::OAICatalogsHotelItemsBatch(const QString &json) {
...
void OAICatalogsHotelItemsBatch::fromJson(const QString &jsonString) {
...
QString OAICatalogsHotelItemsBatch::getCatalogType() const {
    return m_catalog_type;
}
void OAICatalogsHotelItemsBatch::setCatalogType(const QString &catalog_type) {
