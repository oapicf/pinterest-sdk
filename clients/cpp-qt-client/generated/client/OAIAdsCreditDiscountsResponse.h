...
public:
    ...
    OAIAdsCreditDiscountsResponse(const QString &json);
    ...
    OAIAdsCreditDiscountType getDiscountType() const;
    void setDiscountType(const OAIAdsCreditDiscountType &discount_type);
