...
OAICreateAssetAccessRequestResponse::OAICreateAssetAccessRequestResponse(const QString &json) {
...
void OAICreateAssetAccessRequestResponse::fromJson(const QString &jsonString) {
...
QList<OAIAssetAccessRequestError> OAICreateAssetAccessRequestResponse::getExceptions() const {
    return m_exceptions;
}
void OAICreateAssetAccessRequestResponse::setExceptions(const QList<OAIAssetAccessRequestError> &exceptions) {
