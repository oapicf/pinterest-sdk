...
OAICatalogsProductGroupType::OAICatalogsProductGroupType(const QString &json) {
...
void OAICatalogsProductGroupType::fromJson(const QString &jsonString) {
    ...
    else if ( jsonString.compare("CATALOG_EXPANSION", Qt::CaseInsensitive) == 0) {
        m_value = eOAICatalogsProductGroupType::CATALOG_EXPANSION;
        m_value_isSet = m_value_isValid = true;
    }
}
...
QString OAICatalogsProductGroupType::asJson() const {
    ...
    switch (m_value){
        ...
        case eOAICatalogsProductGroupType::I2PC:
            val = "I2PC";
            break;
        case eOAICatalogsProductGroupType::CATALOG_EXPANSION:
            val = "CATALOG_EXPANSION";
            break;
        default:
            break;
    }
