...
OAIAdsAnalyticsGetAsyncResponse::OAIAdsAnalyticsGetAsyncResponse(const QString &json) {
...
void OAIAdsAnalyticsGetAsyncResponse::fromJson(const QString &jsonString) {
