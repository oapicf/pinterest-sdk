...
OAICustomizableCTAType OAIAdCommon::getCustomizableCtaType() const {
    return m_customizable_cta_type;
}
void OAIAdCommon::setCustomizableCtaType(const OAICustomizableCTAType &customizable_cta_type) {
...
OAIDisclosureType OAIAdCommon::getDisclosureType() const {
    return m_disclosure_type;
}
void OAIAdCommon::setDisclosureType(const OAIDisclosureType &disclosure_type) {
    m_disclosure_type = disclosure_type;
    m_disclosure_type_isSet = true;
}

bool OAIAdCommon::is_disclosure_type_Set() const{
    return m_disclosure_type_isSet;
}

bool OAIAdCommon::is_disclosure_type_Valid() const{
    return m_disclosure_type_isValid;
}

QString OAIAdCommon::getDisclosureUrl() const {
    return m_disclosure_url;
}
void OAIAdCommon::setDisclosureUrl(const QString &disclosure_url) {
    m_disclosure_url = disclosure_url;
    m_disclosure_url_isSet = true;
}

bool OAIAdCommon::is_disclosure_url_Set() const{
    return m_disclosure_url_isSet;
}

bool OAIAdCommon::is_disclosure_url_Valid() const{
...
OAIQuizPinData OAIAdCommon::getQuizPinData() const {
    return m_quiz_pin_data;
}
void OAIAdCommon::setQuizPinData(const OAIQuizPinData &quiz_pin_data) {
...
OAITrackingUrls OAIAdCommon::getTrackingUrls() const {
    return m_tracking_urls;
}
void OAIAdCommon::setTrackingUrls(const OAITrackingUrls &tracking_urls) {
