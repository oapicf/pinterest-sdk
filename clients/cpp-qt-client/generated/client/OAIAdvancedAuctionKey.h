...
/*
 * OAIAdvancedAuctionKey.h
 *
 * Object uniquely identifying a retail catalog item
 */

#ifndef OAIAdvancedAuctionKey_H
#define OAIAdvancedAuctionKey_H
...
class OAIAdvancedAuctionKey : public OAIObject {
public:
    OAIAdvancedAuctionKey();
    OAIAdvancedAuctionKey(const QString &json);
    ~OAIAdvancedAuctionKey() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAdvancedAuctionKey)

#endif // OAIAdvancedAuctionKey_H
