...
public:
    OAIBidFloorSpec();
    OAIBidFloorSpec(const QString &json);
    ...
    OAIBidFloorObjectiveType getObjectiveType() const;
    void setObjectiveType(const OAIBidFloorObjectiveType &objective_type);
...
private:
    ...
    OAIBidFloorObjectiveType m_objective_type;
