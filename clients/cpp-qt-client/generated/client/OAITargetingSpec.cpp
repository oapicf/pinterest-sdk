...
OAITargetingSpec::OAITargetingSpec(const QString &json) {
...
void OAITargetingSpec::fromJson(const QString &jsonString) {
...
QList<OAITargetingSpecAgeBucket> OAITargetingSpec::getAgeBucket() const {
    return m_age_bucket;
}
void OAITargetingSpec::setAgeBucket(const QList<OAITargetingSpecAgeBucket> &age_bucket) {
...
QList<OAITargetingSpecAppType> OAITargetingSpec::getApptype() const {
    return m_apptype;
}
void OAITargetingSpec::setApptype(const QList<OAITargetingSpecAppType> &apptype) {
    m_apptype = apptype;
...
QList<OAITargetingSpecGender> OAITargetingSpec::getGender() const {
    return m_gender;
}
void OAITargetingSpec::setGender(const QList<OAITargetingSpecGender> &gender) {
    m_gender = gender;
    m_gender_isSet = true;
}
...
QList<QString> OAITargetingSpec::getGeoExclude() const {
    return m_geo_exclude;
}
void OAITargetingSpec::setGeoExclude(const QList<QString> &geo_exclude) {
    m_geo_exclude = geo_exclude;
    m_geo_exclude_isSet = true;
}

bool OAITargetingSpec::is_geo_exclude_Set() const{
    return m_geo_exclude_isSet;
}

bool OAITargetingSpec::is_geo_exclude_Valid() const{
...
QList<QString> OAITargetingSpec::getLocationExclude() const {
    return m_location_exclude;
}
void OAITargetingSpec::setLocationExclude(const QList<QString> &location_exclude) {
    m_location_exclude = location_exclude;
    m_location_exclude_isSet = true;
}

bool OAITargetingSpec::is_location_exclude_Set() const{
    return m_location_exclude_isSet;
}

bool OAITargetingSpec::is_location_exclude_Valid() const{
    return m_location_exclude_isValid;
}

QString OAITargetingSpec::getMaximumAge() const {
    return m_maximum_age;
}
void OAITargetingSpec::setMaximumAge(const QString &maximum_age) {
    m_maximum_age = maximum_age;
    m_maximum_age_isSet = true;
}

bool OAITargetingSpec::is_maximum_age_Set() const{
    return m_maximum_age_isSet;
}

bool OAITargetingSpec::is_maximum_age_Valid() const{
    return m_maximum_age_isValid;
}

QString OAITargetingSpec::getMinimumAge() const {
    return m_minimum_age;
}
void OAITargetingSpec::setMinimumAge(const QString &minimum_age) {
    m_minimum_age = minimum_age;
    m_minimum_age_isSet = true;
}

bool OAITargetingSpec::is_minimum_age_Set() const{
    return m_minimum_age_isSet;
}

bool OAITargetingSpec::is_minimum_age_Valid() const{
    return m_minimum_age_isValid;
}

QList<OAITargetingSpecShoppingRetargeting> OAITargetingSpec::getShoppingRetargeting() const {
    return m_shopping_retargeting;
}
void OAITargetingSpec::setShoppingRetargeting(const QList<OAITargetingSpecShoppingRetargeting> &shopping_retargeting) {
