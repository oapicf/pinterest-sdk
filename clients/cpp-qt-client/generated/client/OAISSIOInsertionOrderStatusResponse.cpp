...
OAISSIOInsertionOrderStatusResponse::OAISSIOInsertionOrderStatusResponse(const QString &json) {
...
void OAISSIOInsertionOrderStatusResponse::fromJson(const QString &jsonString) {
