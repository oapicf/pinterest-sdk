...
OAIEntityStatus::OAIEntityStatus(const QString &json) {
...
void OAIEntityStatus::fromJson(const QString &jsonString) {
    ...
    if ( jsonString.compare("ACTIVE", Qt::CaseInsensitive) == 0) {
        ...
        m_value = eOAIEntityStatus::DRAFT;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("DELETED_DRAFT", Qt::CaseInsensitive) == 0) {
        m_value = eOAIEntityStatus::DELETED_DRAFT;
        m_value_isSet = m_value_isValid = true;
    }
}
...
QString OAIEntityStatus::asJson() const {
    ...
    switch (m_value){
        ...
        case eOAIEntityStatus::ARCHIVED:
            val = "ARCHIVED";
            break;
        case eOAIEntityStatus::DRAFT:
            val = "DRAFT";
            break;
        case eOAIEntityStatus::DELETED_DRAFT:
            val = "DELETED_DRAFT";
            break;
        default:
            break;
