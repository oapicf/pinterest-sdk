...
OAICatalogsCreativeAssetsProductGroup::OAICatalogsCreativeAssetsProductGroup(const QString &json) {
...
void OAICatalogsCreativeAssetsProductGroup::fromJson(const QString &jsonString) {
...
bool OAICatalogsCreativeAssetsProductGroup::isValid() const {
    ...
    return m_catalog_id_isValid && m_catalog_type_isValid && m_filters_isValid && m_id_isValid && true;
}
