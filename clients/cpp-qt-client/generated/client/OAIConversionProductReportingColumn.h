...
/*
 * OAIConversionProductReportingColumn.h
 *
 * Conversion Product Reporting columns
 */

#ifndef OAIConversionProductReportingColumn_H
#define OAIConversionProductReportingColumn_H
...
class OAIConversionProductReportingColumn : public OAIEnum {
public:
    OAIConversionProductReportingColumn();
    OAIConversionProductReportingColumn(const QString &json);
    ~OAIConversionProductReportingColumn() override;
    ...
    enum class eOAIConversionProductReportingColumn {
    ...
    OAIConversionProductReportingColumn::eOAIConversionProductReportingColumn getValue() const;
    void setValue(const OAIConversionProductReportingColumn::eOAIConversionProductReportingColumn& value);
...
private:
    ...
    eOAIConversionProductReportingColumn m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConversionProductReportingColumn)

#endif // OAIConversionProductReportingColumn_H
