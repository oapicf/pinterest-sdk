...
OAIAudience::OAIAudience(const QString &json) {
...
void OAIAudience::fromJson(const QString &jsonString) {
...
OAIPinnerListType OAIAudience::getAudienceType() const {
    return m_audience_type;
}
void OAIAudience::setAudienceType(const OAIPinnerListType &audience_type) {
...
QString OAIAudience::getCreatedByCompanyName() const {
    return m_created_by_company_name;
}
void OAIAudience::setCreatedByCompanyName(const QString &created_by_company_name) {
    m_created_by_company_name = created_by_company_name;
    m_created_by_company_name_isSet = true;
}

bool OAIAudience::is_created_by_company_name_Set() const{
    return m_created_by_company_name_isSet;
}

bool OAIAudience::is_created_by_company_name_Valid() const{
...
bool OAIAudience::isIsNca() const {
    return m_is_nca;
}
void OAIAudience::setIsNca(const bool &is_nca) {
    m_is_nca = is_nca;
    m_is_nca_isSet = true;
}

bool OAIAudience::is_is_nca_Set() const{
    return m_is_nca_isSet;
}

bool OAIAudience::is_is_nca_Valid() const{
...
OAIAudienceStatus OAIAudience::getStatus() const {
    return m_status;
}
void OAIAudience::setStatus(const OAIAudienceStatus &status) {
    m_status = status;
    m_status_isSet = true;
}
