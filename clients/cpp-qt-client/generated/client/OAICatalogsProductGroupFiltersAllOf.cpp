...
OAICatalogsProductGroupFiltersAllOf::OAICatalogsProductGroupFiltersAllOf(const QString &json) {
...
void OAICatalogsProductGroupFiltersAllOf::fromJson(const QString &jsonString) {
