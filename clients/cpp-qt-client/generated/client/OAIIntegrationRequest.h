...
/*
 * OAIIntegrationRequest.h
 *
 * Schema used for creating the integration metadata.
 */

#ifndef OAIIntegrationRequest_H
#define OAIIntegrationRequest_H
...
class OAIIntegrationRequest : public OAIObject {
public:
    OAIIntegrationRequest();
    OAIIntegrationRequest(QString json);
    ~OAIIntegrationRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIntegrationRequest)

#endif // OAIIntegrationRequest_H
