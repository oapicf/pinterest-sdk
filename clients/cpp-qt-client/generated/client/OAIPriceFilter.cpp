...
OAIPriceFilter::OAIPriceFilter(const QString &json) {
...
void OAIPriceFilter::fromJson(const QString &jsonString) {
...
OAIPriceFilterPrice OAIPriceFilter::getPrice() const {
    return m_price;
}
void OAIPriceFilter::setPrice(const OAIPriceFilterPrice &price) {
    m_price = price;
    m_price_isSet = true;
}
