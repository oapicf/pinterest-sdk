...
OAIObjectiveType::OAIObjectiveType(const QString &json) {
...
void OAIObjectiveType::fromJson(const QString &jsonString) {
...
QString OAIObjectiveType::asJson() const {
    ...
    switch (m_value){
        ...
        case eOAIObjectiveType::VIDEO_COMPLETION:
            ...
            break;
        case eOAIObjectiveType::SALES:
            val = "SALES";
            break;
        case eOAIObjectiveType::APP_INSTALL:
            val = "APP_INSTALL";
            break;
        case eOAIObjectiveType::CTV_CONSIDERATION:
