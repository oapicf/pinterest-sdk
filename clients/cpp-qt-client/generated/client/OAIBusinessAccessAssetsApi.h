...
public:
    ...
    */
    virtual void businessAssetMembers_get(const QString &business_id, const QString &asset_id, const ::OpenAPI::OptionalParam<bool> &fetch_system_users = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<QString> &bookmark = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<qint32> &page_size = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<qint32> &start_index = ::OpenAPI::OptionalParam<qint32>());
