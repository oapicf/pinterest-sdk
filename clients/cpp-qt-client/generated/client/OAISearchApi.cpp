...
void OAISearchApi::searchUserBoards_get(const ::OpenAPI::OptionalParam<QString> &ad_account_id, const ::OpenAPI::OptionalParam<QString> &query, const ::OpenAPI::OptionalParam<QString> &bookmark, const ::OpenAPI::OptionalParam<qint32> &page_size) {
    ...
    QStringList scopeAuthorizationFlow;
    scopeAuthorizationFlow.append("boards:read");
    scopeAuthorizationFlow.append("boards:read_secret");
    auto tokenAuthorizationFlow = _authFlow.getToken(scopeAuthorizationFlow.join(" "));
    if(tokenAuthorizationFlow.isValid())
        input.headers.insert("Authorization", "Bearer " + tokenAuthorizationFlow.getToken());
    ...
    scopeClientCredentialsFlow.append("boards:read_secret");
...
void OAISearchApi::searchUserPins_list(const QString &query, const ::OpenAPI::OptionalParam<QString> &ad_account_id, const ::OpenAPI::OptionalParam<QString> &bookmark) {
    ...
    scopeAuthorizationFlow.append("boards:read_secret");
    scopeAuthorizationFlow.append("pins:read");
    scopeAuthorizationFlow.append("pins:read_secret");
    auto tokenAuthorizationFlow = _authFlow.getToken(scopeAuthorizationFlow.join(" "));
    if(tokenAuthorizationFlow.isValid())
        input.headers.insert("Authorization", "Bearer " + tokenAuthorizationFlow.getToken());
