...
OAIAdCreateRequest::OAIAdCreateRequest(const QString &json) {
...
void OAIAdCreateRequest::fromJson(const QString &jsonString) {
...
OAICustomizableCTAType OAIAdCreateRequest::getCustomizableCtaType() const {
    return m_customizable_cta_type;
}
void OAIAdCreateRequest::setCustomizableCtaType(const OAICustomizableCTAType &customizable_cta_type) {
...
OAIDisclosureType OAIAdCreateRequest::getDisclosureType() const {
    return m_disclosure_type;
}
void OAIAdCreateRequest::setDisclosureType(const OAIDisclosureType &disclosure_type) {
    m_disclosure_type = disclosure_type;
    m_disclosure_type_isSet = true;
}

bool OAIAdCreateRequest::is_disclosure_type_Set() const{
    return m_disclosure_type_isSet;
}

bool OAIAdCreateRequest::is_disclosure_type_Valid() const{
    return m_disclosure_type_isValid;
}

QString OAIAdCreateRequest::getDisclosureUrl() const {
    return m_disclosure_url;
}
void OAIAdCreateRequest::setDisclosureUrl(const QString &disclosure_url) {
    m_disclosure_url = disclosure_url;
    m_disclosure_url_isSet = true;
}

bool OAIAdCreateRequest::is_disclosure_url_Set() const{
    return m_disclosure_url_isSet;
}

bool OAIAdCreateRequest::is_disclosure_url_Valid() const{
...
bool OAIAdCreateRequest::isIsCarting() const {
    return m_is_carting;
}
void OAIAdCreateRequest::setIsCarting(const bool &is_carting) {
    m_is_carting = is_carting;
    m_is_carting_isSet = true;
}

bool OAIAdCreateRequest::is_is_carting_Set() const{
    return m_is_carting_isSet;
}

bool OAIAdCreateRequest::is_is_carting_Valid() const{
...
OAIObject OAIAdCreateRequest::getQuizPinData() const {
    return m_quiz_pin_data;
}
void OAIAdCreateRequest::setQuizPinData(const OAIObject &quiz_pin_data) {
...
OAIObject OAIAdCreateRequest::getTrackingUrls() const {
    return m_tracking_urls;
}
void OAIAdCreateRequest::setTrackingUrls(const OAIObject &tracking_urls) {
