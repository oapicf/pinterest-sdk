...
public:
    ...
    QList<OAIProductGroupPromotionCreateRequestElement> getProductGroupPromotion() const;
    void setProductGroupPromotion(const QList<OAIProductGroupPromotionCreateRequestElement> &product_group_promotion);
...
private:
    ...
    QList<OAIProductGroupPromotionCreateRequestElement> m_product_group_promotion;
