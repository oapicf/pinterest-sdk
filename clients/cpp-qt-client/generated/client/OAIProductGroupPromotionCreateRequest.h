...
public:
    ...
    QList<OAIItems> getProductGroupPromotion() const;
    void setProductGroupPromotion(const QList<OAIItems> &product_group_promotion);
...
private:
    ...
    QList<OAIItems> product_group_promotion;
