...
OAICatalogsFeedsCreateRequest::OAICatalogsFeedsCreateRequest(const QString &json) {
...
void OAICatalogsFeedsCreateRequest::fromJson(const QString &jsonString) {
...
OAICatalogsCreativeAssetsFeedsCreateRequest_default_locale OAICatalogsFeedsCreateRequest::getDefaultLocale() const {
    return m_default_locale;
}
void OAICatalogsFeedsCreateRequest::setDefaultLocale(const OAICatalogsCreativeAssetsFeedsCreateRequest_default_locale &default_locale) {
...
bool OAICatalogsFeedsCreateRequest::isValid() const {
    ...
    return m_format_isValid && m_location_isValid && m_name_isValid && true;
}
