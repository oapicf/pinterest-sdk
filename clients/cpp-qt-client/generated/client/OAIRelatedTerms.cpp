...
OAIRelatedTerms::OAIRelatedTerms(const QString &json) {
...
void OAIRelatedTerms::fromJson(const QString &jsonString) {
...
void OAIRelatedTerms::fromJsonObject(QJsonObject json) {
    ...
    m_related_term_count_isValid = ::OpenAPI::fromJsonValue(m_related_term_count, json[QString("related_term_count")]);
    m_related_term_count_isSet = !json[QString("related_term_count")].isNull() && m_related_term_count_isValid;

    m_related_terms_list_isValid = ::OpenAPI::fromJsonValue(m_related_terms_list, json[QString("related_terms_list")]);
...
QJsonObject OAIRelatedTerms::asJsonObject() const {
    ...
    if (m_related_term_count_isSet) {
        obj.insert(QString("related_term_count"), ::OpenAPI::toJsonValue(m_related_term_count));
    }
    if (m_related_terms_list.size() > 0) {
        obj.insert(QString("related_terms_list"), ::OpenAPI::toJsonValue(m_related_terms_list));
    }
    return obj;
}
...
void OAIRelatedTerms::setRelatedTermCount(const qint32 &related_term_count) {
    m_related_term_count = related_term_count;
    m_related_term_count_isSet = true;
}
...
QList<OAIRelatedTermsRelatedTermsListItems> OAIRelatedTerms::getRelatedTermsList() const {
    return m_related_terms_list;
}
void OAIRelatedTerms::setRelatedTermsList(const QList<OAIRelatedTermsRelatedTermsListItems> &related_terms_list) {
    m_related_terms_list = related_terms_list;
    m_related_terms_list_isSet = true;
}
