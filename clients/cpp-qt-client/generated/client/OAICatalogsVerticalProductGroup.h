...
public:
    ...
    OAICatalogsVerticalProductGroup(const QString &json);
    ...
    OAICatalogsHotelProductGroupType getType() const;
    void setType(const OAICatalogsHotelProductGroupType &type);
...
private:
    ...
    OAICatalogsHotelProductGroupType m_type;
    bool m_type_isSet;
    bool m_type_isValid;
