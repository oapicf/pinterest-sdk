...
/*
 * OAIReportingColumn.h
 *
 * Reporting Columns
 */

#ifndef OAIReportingColumn_H
#define OAIReportingColumn_H
...
class OAIReportingColumn : public OAIEnum {
public:
    OAIReportingColumn();
    OAIReportingColumn(const QString &json);
    ~OAIReportingColumn() override;
    ...
    enum class eOAIReportingColumn {
    ...
    OAIReportingColumn::eOAIReportingColumn getValue() const;
    void setValue(const OAIReportingColumn::eOAIReportingColumn& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIReportingColumn)

#endif // OAIReportingColumn_H
