...
void OAIProductGroupPromotionsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("productGroupPromotions_get", defaultConf);
    _serverIndices.insert("productGroupPromotions_get", 0);
    _serverConfigs.insert("productGroupPromotions_list", defaultConf);
    _serverIndices.insert("productGroupPromotions_list", 0);
...
void OAIProductGroupPromotionsApi::productGroupPromotions_createCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIProductGroupPromotionResponse output(QString(worker->response));
    worker->deleteLater();
...
void OAIProductGroupPromotionsApi::productGroupPromotions_get(const QString &ad_account_id, const QString &product_group_promotion_id) {
    QString fullPath = QString(_serverConfigs["productGroupPromotions_get"][_serverIndices.value("productGroupPromotions_get")].URL()+"/ad_accounts/{ad_account_id}/product_group_promotions/{product_group_promotion_id}");
...
void OAIProductGroupPromotionsApi::productGroupPromotions_getCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT productGroupPromotions_getSignal(output);
        Q_EMIT productGroupPromotions_getSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("ads:read");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT productGroupPromotions_getSignalE(output, error_type, error_str);
        Q_EMIT productGroupPromotions_getSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT productGroupPromotions_getSignalError(output, error_type, error_str);
        Q_EMIT productGroupPromotions_getSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIProductGroupPromotionsApi::productGroupPromotions_list(const QString &ad_account_id, const ::OpenAPI::OptionalParam<QList<QString>> &product_group_promotion_ids, const ::OpenAPI::OptionalParam<QList<QString>> &entity_statuses, const ::OpenAPI::OptionalParam<QString> &ad_group_id, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<QString> &order, const ::OpenAPI::OptionalParam<QString> &bookmark) {
    QString fullPath = QString(_serverConfigs["productGroupPromotions_list"][_serverIndices.value("productGroupPromotions_list")].URL()+"/ad_accounts/{ad_account_id}/product_group_promotions");
    ...
    if (product_group_promotion_ids.hasValue())
    {
        queryStyle = "form";
        if (queryStyle == "")
            queryStyle = "form";
        ...
        queryDelimiter = getParamStyleDelimiter(queryStyle, "product_group_promotion_ids", true);
        if (product_group_promotion_ids.value().size() > 0) {
            if (QString("multi").indexOf("multi") == 0) {
                for (QString t : product_group_promotion_ids.value()) {
                    if (fullPath.indexOf("?") > 0)
                        fullPath.append(queryPrefix);
                    else
                        fullPath.append("?");
                    fullPath.append("product_group_promotion_ids=").append(::OpenAPI::toStringValue(t));
                }
            } else if (QString("multi").indexOf("ssv") == 0) {
                if (fullPath.indexOf("?") > 0)
                    fullPath.append("&");
                else
                    fullPath.append("?").append(queryPrefix).append("product_group_promotion_ids").append(querySuffix);
                qint32 count = 0;
                for (QString t : product_group_promotion_ids.value()) {
                    if (count > 0) {
...
void OAIProductGroupPromotionsApi::productGroupPromotions_listCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIProduct_group_promotions_list_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT productGroupPromotions_listSignal(output);
        Q_EMIT productGroupPromotions_listSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("ads:read");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT productGroupPromotions_listSignalE(output, error_type, error_str);
        Q_EMIT productGroupPromotions_listSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT productGroupPromotions_listSignalError(output, error_type, error_str);
        Q_EMIT productGroupPromotions_listSignalErrorFull(worker, error_type, error_str);
    }
}
