...
void OAIProductGroupPromotionsApi::setServerIndex(int serverIndex) {
...
void OAIProductGroupPromotionsApi::productGroupPromotions_create(const QString &ad_account_id, const OAIProductGroupPromotionsCreate &oai_product_group_promotions_create) {
...

    {
        ...
        QByteArray output = oai_product_group_promotions_create.asJson().toUtf8();
...
void OAIProductGroupPromotionsApi::productGroupPromotions_createCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIProductGroupPromotions output(QString(worker->response));
    worker->deleteLater();
...
void OAIProductGroupPromotionsApi::productGroupPromotions_list(const QString &ad_account_id, const ::OpenAPI::OptionalParam<QString> &bookmark, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<OAIPinterest_Lib_PaginationOrder> &order, const ::OpenAPI::OptionalParam<QList<QString>> &product_group_promotion_ids, const ::OpenAPI::OptionalParam<QList<OAIEntityStatus>> &entity_statuses, const ::OpenAPI::OptionalParam<QString> &ad_group_id) {
...
void OAIProductGroupPromotionsApi::productGroupPromotions_update(const QString &ad_account_id, const OAIProductGroupPromotionsUpdateWithRequiredBody &oai_product_group_promotions_update_with_required_body) {
...

    {
        ...
        QByteArray output = oai_product_group_promotions_update_with_required_body.asJson().toUtf8();
        input.request_body.append(output);
    }
    for (auto keyValueIt = _defaultHeaders.keyValueBegin(); keyValueIt != _defaultHeaders.keyValueEnd(); keyValueIt++) {
        input.headers.insert(keyValueIt->first, keyValueIt->second);
...
void OAIProductGroupPromotionsApi::productGroups_analyticsCallback(OAIHttpRequestWorker *worker) {
    ...
    QList<OAIProductGroupAnalyticsItems> output;
    QString json(worker->response);
    QByteArray array(json.toStdString().c_str());
    QJsonDocument doc = QJsonDocument::fromJson(array);
    QJsonArray jsonArray = doc.array();
    for (QJsonValue obj : jsonArray) {
        OAIProductGroupAnalyticsItems val;
