...
OAICatalogsFormat::OAICatalogsFormat(const QString &json) {
...
void OAICatalogsFormat::fromJson(const QString &jsonString) {
    ...
    else if ( jsonString.compare("INTEGRATION", Qt::CaseInsensitive) == 0) {
        m_value = eOAICatalogsFormat::INTEGRATION;
        m_value_isSet = m_value_isValid = true;
    }
}
...
QString OAICatalogsFormat::asJson() const {
    ...
    switch (m_value){
        ...
        case eOAICatalogsFormat::XML:
            val = "XML";
            break;
        case eOAICatalogsFormat::INTEGRATION:
            val = "INTEGRATION";
            break;
        default:
            break;
