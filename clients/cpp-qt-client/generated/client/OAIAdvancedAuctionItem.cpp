...
OAIAdvancedAuctionItem::OAIAdvancedAuctionItem(const QString &json) {
...
void OAIAdvancedAuctionItem::fromJson(const QString &jsonString) {
...
bool OAIAdvancedAuctionItem::isValid() const {
    ...
    return m_bid_options_isValid && m_country_isValid && m_item_id_isValid && m_language_isValid && true;
}
