...
OAIProductGroupPromotionResponseItem::OAIProductGroupPromotionResponseItem(const QString &json) {
...
void OAIProductGroupPromotionResponseItem::fromJson(const QString &jsonString) {
