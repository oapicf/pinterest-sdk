...
#ifndef OAILeadFormTest_H
#define OAILeadFormTest_H
...
class OAILeadFormTest : public OAIObject {
public:
    OAILeadFormTest();
    OAILeadFormTest(const QString &json);
    ~OAILeadFormTest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILeadFormTest)

#endif // OAILeadFormTest_H
