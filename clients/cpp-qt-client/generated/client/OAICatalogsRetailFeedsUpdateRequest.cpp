...
OAICatalogsRetailFeedsUpdateRequest::OAICatalogsRetailFeedsUpdateRequest(const QString &json) {
...
void OAICatalogsRetailFeedsUpdateRequest::fromJson(const QString &jsonString) {
...
QString OAICatalogsRetailFeedsUpdateRequest::getCatalogType() const {
    return m_catalog_type;
}
void OAICatalogsRetailFeedsUpdateRequest::setCatalogType(const QString &catalog_type) {
