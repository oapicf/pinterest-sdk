...
OAIQuizPinData OAIAdUpdateRequest::getQuizPinData() const {
    return m_quiz_pin_data;
}
void OAIAdUpdateRequest::setQuizPinData(const OAIQuizPinData &quiz_pin_data) {
...
OAITrackingUrls OAIAdUpdateRequest::getTrackingUrls() const {
    return m_tracking_urls;
}
void OAIAdUpdateRequest::setTrackingUrls(const OAITrackingUrls &tracking_urls) {
