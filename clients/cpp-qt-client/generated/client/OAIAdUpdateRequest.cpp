...
OAIAdUpdateRequest::OAIAdUpdateRequest(const QString &json) {
...
void OAIAdUpdateRequest::fromJson(const QString &jsonString) {
...
OAICustomizableCTAType OAIAdUpdateRequest::getCustomizableCtaType() const {
    return m_customizable_cta_type;
}
void OAIAdUpdateRequest::setCustomizableCtaType(const OAICustomizableCTAType &customizable_cta_type) {
    m_customizable_cta_type = customizable_cta_type;
    m_customizable_cta_type_isSet = true;
}

bool OAIAdUpdateRequest::is_customizable_cta_type_Set() const{
    return m_customizable_cta_type_isSet;
}

bool OAIAdUpdateRequest::is_customizable_cta_type_Valid() const{
...
OAIDisclosureType OAIAdUpdateRequest::getDisclosureType() const {
    return m_disclosure_type;
}
void OAIAdUpdateRequest::setDisclosureType(const OAIDisclosureType &disclosure_type) {
    m_disclosure_type = disclosure_type;
    m_disclosure_type_isSet = true;
}

bool OAIAdUpdateRequest::is_disclosure_type_Set() const{
    return m_disclosure_type_isSet;
}

bool OAIAdUpdateRequest::is_disclosure_type_Valid() const{
    return m_disclosure_type_isValid;
}

QString OAIAdUpdateRequest::getDisclosureUrl() const {
    return m_disclosure_url;
}
void OAIAdUpdateRequest::setDisclosureUrl(const QString &disclosure_url) {
    m_disclosure_url = disclosure_url;
    m_disclosure_url_isSet = true;
}

bool OAIAdUpdateRequest::is_disclosure_url_Set() const{
    return m_disclosure_url_isSet;
}

bool OAIAdUpdateRequest::is_disclosure_url_Valid() const{
    return m_disclosure_url_isValid;
}

OAIGridClickType OAIAdUpdateRequest::getGridClickType() const {
    return m_grid_click_type;
}
void OAIAdUpdateRequest::setGridClickType(const OAIGridClickType &grid_click_type) {
    m_grid_click_type = grid_click_type;
    m_grid_click_type_isSet = true;
}

bool OAIAdUpdateRequest::is_grid_click_type_Set() const{
    return m_grid_click_type_isSet;
}

bool OAIAdUpdateRequest::is_grid_click_type_Valid() const{
...
bool OAIAdUpdateRequest::isIsCarting() const {
    return m_is_carting;
}
void OAIAdUpdateRequest::setIsCarting(const bool &is_carting) {
    m_is_carting = is_carting;
    m_is_carting_isSet = true;
}

bool OAIAdUpdateRequest::is_is_carting_Set() const{
    return m_is_carting_isSet;
}

bool OAIAdUpdateRequest::is_is_carting_Valid() const{
...
QString OAIAdUpdateRequest::getLeadFormId() const {
    return m_lead_form_id;
}
void OAIAdUpdateRequest::setLeadFormId(const QString &lead_form_id) {
    m_lead_form_id = lead_form_id;
    m_lead_form_id_isSet = true;
}

bool OAIAdUpdateRequest::is_lead_form_id_Set() const{
    return m_lead_form_id_isSet;
}

bool OAIAdUpdateRequest::is_lead_form_id_Valid() const{
...
OAIObject OAIAdUpdateRequest::getQuizPinData() const {
    return m_quiz_pin_data;
}
void OAIAdUpdateRequest::setQuizPinData(const OAIObject &quiz_pin_data) {
    m_quiz_pin_data = quiz_pin_data;
    m_quiz_pin_data_isSet = true;
}

bool OAIAdUpdateRequest::is_quiz_pin_data_Set() const{
    return m_quiz_pin_data_isSet;
}

bool OAIAdUpdateRequest::is_quiz_pin_data_Valid() const{
...
OAIObject OAIAdUpdateRequest::getTrackingUrls() const {
    return m_tracking_urls;
}
void OAIAdUpdateRequest::setTrackingUrls(const OAIObject &tracking_urls) {
