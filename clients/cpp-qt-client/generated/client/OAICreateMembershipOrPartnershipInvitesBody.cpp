...
OAICreateMembershipOrPartnershipInvitesBody::OAICreateMembershipOrPartnershipInvitesBody(const QString &json) {
...
void OAICreateMembershipOrPartnershipInvitesBody::fromJson(const QString &jsonString) {
...
OAIBusinessRoleForInvite OAICreateMembershipOrPartnershipInvitesBody::getBusinessRole() const {
    return m_business_role;
}
void OAICreateMembershipOrPartnershipInvitesBody::setBusinessRole(const OAIBusinessRoleForInvite &business_role) {
