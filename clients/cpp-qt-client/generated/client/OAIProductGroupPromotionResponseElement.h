...
/*
 * OAIProductGroupPromotionResponseElement.h
 *
 * 
 */

#ifndef OAIProductGroupPromotionResponseElement_H
#define OAIProductGroupPromotionResponseElement_H
...
class OAIProductGroupPromotionResponseElement : public OAIObject {
public:
    OAIProductGroupPromotionResponseElement();
    OAIProductGroupPromotionResponseElement(QString json);
    ~OAIProductGroupPromotionResponseElement() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProductGroupPromotionResponseElement)

#endif // OAIProductGroupPromotionResponseElement_H
