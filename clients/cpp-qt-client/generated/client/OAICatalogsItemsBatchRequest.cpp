...
QList<OAIItemDeleteDiscontinuedBatchRecord> OAICatalogsItemsBatchRequest::getItems() const {
    return items;
}
void OAICatalogsItemsBatchRequest::setItems(const QList<OAIItemDeleteDiscontinuedBatchRecord> &items) {
    this->items = items;
