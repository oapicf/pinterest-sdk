...
OAICatalogsItemsBatchRequest::OAICatalogsItemsBatchRequest(const QString &json) {
...
void OAICatalogsItemsBatchRequest::fromJson(const QString &jsonString) {
...
QString OAICatalogsItemsBatchRequest::getLanguage() const {
    return m_language;
}
void OAICatalogsItemsBatchRequest::setLanguage(const QString &language) {
    m_language = language;
...
QString OAICatalogsItemsBatchRequest::getOperation() const {
    return m_operation;
}
void OAICatalogsItemsBatchRequest::setOperation(const QString &operation) {
