...
public:
    ...
    */
    void unverifyWebsite_delete(const QString &website);
    ...
    * @param[in]  page_size qint32 [optional]
    */
    void userAccount_followedInterests(const QString &username, const ::OpenAPI::OptionalParam<QString> &bookmark = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<qint32> &page_size = ::OpenAPI::OptionalParam<qint32>());
    ...
    * @param[in]  ad_account_id QString [optional]
    */
    void userFollowing_get(const ::OpenAPI::OptionalParam<QString> &bookmark = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<qint32> &page_size = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<OAIUserFollowingFeedType> &feed_type = ::OpenAPI::OptionalParam<OAIUserFollowingFeedType>(), const ::OpenAPI::OptionalParam<bool> &explicit_following = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<QString> &ad_account_id = ::OpenAPI::OptionalParam<QString>());

    /**
    * @param[in]  bookmark QString [optional]
    * @param[in]  page_size qint32 [optional]
    */
    void userWebsites_get(const ::OpenAPI::OptionalParam<QString> &bookmark = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<qint32> &page_size = ::OpenAPI::OptionalParam<qint32>());

    /**
    * @param[in]  oai_user_website_verify_request OAIUserWebsiteVerifyRequest [required]
    */
    void verifyWebsite_update(const OAIUserWebsiteVerifyRequest &oai_user_website_verify_request);


    void websiteVerification_get();
