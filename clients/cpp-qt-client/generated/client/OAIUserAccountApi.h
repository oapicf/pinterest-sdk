...
public:
    ...
    * @param[in]  page_size qint32 [optional]
    */
    Q_DECL_DEPRECATED virtual void userAccount_followedInterests(const QString &username, const ::OpenAPI::OptionalParam<QString> &bookmark = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<qint32> &page_size = ::OpenAPI::OptionalParam<qint32>());
