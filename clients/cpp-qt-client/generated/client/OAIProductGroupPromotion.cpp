...
QJsonObject OAIProductGroupPromotion::asJsonObject() const {
    ...
    if (m_collections_header_type_isSet) {
...
QString OAIProductGroupPromotion::getCollectionsHeaderType() const {
    return m_collections_header_type;
}
void OAIProductGroupPromotion::setCollectionsHeaderType(const QString &collections_header_type) {
...
QString OAIProductGroupPromotion::getCustomizableCtaType() const {
    return m_customizable_cta_type;
}
void OAIProductGroupPromotion::setCustomizableCtaType(const QString &customizable_cta_type) {
...
QString OAIProductGroupPromotion::getPreferredMediaType() const {
    return m_preferred_media_type;
}
void OAIProductGroupPromotion::setPreferredMediaType(const QString &preferred_media_type) {
