...
public:
    ...
    QList<OAIAccountTemplate> getItems() const;
    void setItems(const QList<OAIAccountTemplate> &items);
...
private:
    ...
    QList<OAIAccountTemplate> m_items;
    bool m_items_isSet;
