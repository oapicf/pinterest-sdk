...
> `country_keywords_metrics_get`(req::`HTTP.Request`, `ad_account_id`::`String`, `country_code`::`String`, `keywords`::`Vector{String}`;) -> `KeywordsMetricsArrayResponse`
...
# **keywords_create**
> `keywords_create`(req::`HTTP.Request`, `ad_account_id`::`String`, `keywords_create_param`::`KeywordsCreate`;) -> `Keywords`
...
# **keywords_get**
> `keywords_get`(req::`HTTP.Request`, `ad_account_id`::`String`; `campaign_id`=nothing, `ad_group_id`=nothing, `ad_group_ids`=nothing, `match_types`=nothing, `bookmark`=nothing, `page_size`=nothing,) -> `KeywordsGet200Response`
...
# **keywords_update**
> `keywords_update`(req::`HTTP.Request`, `ad_account_id`::`String`, `keywords_update_param`::`KeywordsUpdate`;) -> `Keywords`
...
> `trending_keywords_list`(req::`HTTP.Request`, `region`::`TrendsSupportedRegion`, `trend_type`::`TrendType`; `interests`=nothing, `genders`=nothing, `ages`=nothing, `include_keywords`=nothing, `normalize_against_group`=nothing, `limit`=nothing, `include_demographics`=nothing,) -> `TrendingKeywordsResponse`
