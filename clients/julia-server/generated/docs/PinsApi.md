...
> `multi_pins_analytics`(req::`HTTP.Request`, `pin_ids`::`Vector{String}`, `start_date`::`Date`, `end_date`::`Date`, `metric_types`::`Vector{MultiPinsAnalyticsMetricTypesItem}`; `app_types`=nothing, `ad_account_id`=nothing,) -> `Dict{String, Dict}`
...
# **pins_analytics**
> `pins_analytics`(req::`HTTP.Request`, `pin_id`::`String`, `start_date`::`Date`, `end_date`::`Date`, `metric_types`::`Vector{QuerypinanalyticsmetrictypesItems}`; `app_types`=nothing, `split_field`=nothing, `ad_account_id`=nothing,) -> `Dict{String, PinAnalyticsMetricsResponse}`
...
# **pins_create**
> `pins_create`(req::`HTTP.Request`, `pin_create`::`PinCreate`; `ad_account_id`=nothing,) -> `Pin`
...
# **pins_delete**
> `pins_delete`(req::`HTTP.Request`, `pin_id`::`String`; `ad_account_id`=nothing,) -> `Pin`
...
# **pins_get**
> `pins_get`(req::`HTTP.Request`, `pin_id`::`String`; `ad_account_id`=nothing, `pin_metrics`=nothing,) -> `Pin`
...
# **pins_list**
> `pins_list`(req::`HTTP.Request`; `pin_filter`=nothing, `pin_metrics`=nothing, `include_protected_pins`=nothing, `pin_type`=nothing, `creative_types`=nothing, `ad_account_id`=nothing, `domain`=nothing, `domains`=nothing, `include_product_tag_obj`=nothing, `bookmark`=nothing, `page_size`=nothing,) -> `PinsList200Response`
...
# **pins_save**
> `pins_save`(req::`HTTP.Request`, `pin_id`::`String`, `pins_save_request_create`::`PinsSaveRequestCreate`; `ad_account_id`=nothing,) -> `Pin`
...
# **pins_update**
> `pins_update`(req::`HTTP.Request`, `pin_id`::`String`, `pin_update`::`PinUpdate`; `ad_account_id`=nothing,) -> `Pin`
