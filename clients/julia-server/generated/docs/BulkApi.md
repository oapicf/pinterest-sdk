...
> `bulk_download_create`(req::`HTTP.Request`, `ad_account_id`::`String`, `bulk_download_create_param`::`BulkDownloadCreate`;) -> `BulkDownload`
...
# **bulk_request_get**
> `bulk_request_get`(req::`HTTP.Request`, `ad_account_id`::`String`, `bulk_request_id`::`String`; `include_details`=nothing,) -> `BulkJobData`
...
# **bulk_upsert_create**
> `bulk_upsert_create`(req::`HTTP.Request`, `ad_account_id`::`String`, `bulk_upsert_request`::`BulkUpsertRequest`;) -> `BulkUpsertResponse`
