...
> `advanced_auction_items_get_post`(req::`HTTP.Request`, `advanced_auction_items_get_request`::`AdvancedAuctionItemsGetRequest`; `ad_account_id`=nothing,) -> `AdvancedAuctionItems`
...
> `advanced_auction_items_submit_post`(req::`HTTP.Request`, `advanced_auction_items_submit_request`::`AdvancedAuctionItemsSubmitRequest`; `ad_account_id`=nothing,) -> `AdvancedAuctionProcessedItems`
