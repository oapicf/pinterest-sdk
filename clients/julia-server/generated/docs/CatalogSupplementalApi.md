...
> `catalogs_local_inventory_items_batch_operate`(req::`HTTP.Request`, `catalog_id`::`String`, `local_inventory_items_batch_create`::`LocalInventoryItemsBatchCreate`; `ad_account_id`=nothing,) -> `SupplementalItemsBatchResponse`
...
> `catalogs_local_inventory_items_post`(req::`HTTP.Request`, `catalog_id`::`String`, `local_inventory_items_get_create`::`LocalInventoryItemsGetCreate`; `ad_account_id`=nothing,) -> `LocalInventoryItemsGet`
...
> `catalogs_local_stores_create`(req::`HTTP.Request`, `catalog_id`::`String`, `local_store_create`::`Vector{LocalStoreCreate}`; `ad_account_id`=nothing,) -> `Vector{CatalogsLocalStoresCreate200ResponseInner}`
...
> `catalogs_local_stores_delete`(req::`HTTP.Request`, `catalog_id`::`String`, `ids`::`Vector{String}`; `ad_account_id`=nothing,) -> `Vector{CatalogsLocalStoresDelete200ResponseInner}`
...
> `catalogs_local_stores_list`(req::`HTTP.Request`, `catalog_id`::`String`; `ids`=nothing, `ad_account_id`=nothing, `bookmark`=nothing, `page_size`=nothing,) -> `CatalogsLocalStoresList200Response`
...
> `catalogs_local_stores_update`(req::`HTTP.Request`, `catalog_id`::`String`, `local_store_batch_update`::`Vector{LocalStoreBatchUpdate}`; `ad_account_id`=nothing,) -> `Vector{CatalogsLocalStoresCreate200ResponseInner}`
...
> `catalogs_supplemental_items_batch_get`(req::`HTTP.Request`, `catalog_id`::`String`, `batch_id`::`String`; `ad_account_id`=nothing,) -> `SupplementalItemsBatchResponse`
