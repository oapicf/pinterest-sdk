...
**`md_frequency`** | **`Float64`** | Metadata ingestion frequency. | [optional] [default to 1]
**`no_code_capi_domains`** | **`Vector{String}`** | List of advertiser subdomains configured for NoCodeCAPI calls. | [optional] [default to nothing]
