...
> `board_sections_create`(req::`HTTP.Request`, `board_id`::`String`, `board_section_create`::`BoardSectionCreate`; `ad_account_id`=nothing,) -> `BoardSection`
...
> `board_sections_delete`(req::`HTTP.Request`, `board_id`::`String`, `section_id`::`String`; `ad_account_id`=nothing,) -> `BoardSection`
...
# **board_sections_list**
> `board_sections_list`(req::`HTTP.Request`, `board_id`::`String`; `ad_account_id`=nothing, `bookmark`=nothing, `page_size`=nothing,) -> `BoardSectionsList200Response`
...
> `board_sections_list_pins`(req::`HTTP.Request`, `board_id`::`String`, `section_id`::`String`; `ad_account_id`=nothing, `bookmark`=nothing, `page_size`=nothing,) -> `BoardsListPins200Response`
...
> `board_sections_update`(req::`HTTP.Request`, `board_id`::`String`, `section_id`::`String`, `board_section_update_with_required_body`::`BoardSectionUpdateWithRequiredBody`; `ad_account_id`=nothing,) -> `BoardSection`
...
# **boards_create**
> `boards_create`(req::`HTTP.Request`, `board_create`::`BoardCreate`; `ad_account_id`=nothing,) -> `Board`
...
# **boards_delete**
> `boards_delete`(req::`HTTP.Request`, `board_id`::`String`; `ad_account_id`=nothing,) -> `Board`
...
# **boards_get**
> `boards_get`(req::`HTTP.Request`, `board_id`::`String`; `ad_account_id`=nothing,) -> `Board`
...
# **boards_list**
> `boards_list`(req::`HTTP.Request`; `ad_account_id`=nothing, `privacy`=nothing, `bookmark`=nothing, `page_size`=nothing,) -> `BoardsList200Response`
...
# **boards_list_pins**
> `boards_list_pins`(req::`HTTP.Request`, `board_id`::`String`; `creative_types`=nothing, `ad_account_id`=nothing, `pin_metrics`=nothing, `bookmark`=nothing, `page_size`=nothing,) -> `BoardsListPins200Response`
...
# **boards_update**
> `boards_update`(req::`HTTP.Request`, `board_id`::`String`, `board_with_update_privacy_update`::`BoardWithUpdatePrivacyUpdate`; `ad_account_id`=nothing,) -> `BoardWithUpdatePrivacy`
