...
**`promotion_title`** | **`String`** | Internal name for the promotion. | [optional] [default to nothing]
**`promotion_type`** | [**`*PromotionType`**](PromotionType.md) |  | [optional] [default to nothing]
