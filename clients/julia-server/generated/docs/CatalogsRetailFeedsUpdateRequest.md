...
**`format`** | [**`*CatalogsFormat`**](CatalogsFormat.md) |  | [optional] [default to nothing]
**`location`** | **`String`** | The URL where a feed is available for download. This URL is what Pinterest will use to download a feed for processing. | [optional] [default to nothing]
**`name`** | **`String`** | A human-friendly name associated to a given feed. | [optional] [default to nothing]
