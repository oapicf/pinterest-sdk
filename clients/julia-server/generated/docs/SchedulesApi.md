...
# **schedules_create**
> `schedules_create`(req::`HTTP.Request`, `ad_account_id`::`String`, `schedule_create`::`Vector{ScheduleCreate}`;) -> `Vector{SchedulesCreate200ResponseInner}`
...
# **schedules_list**
> `schedules_list`(req::`HTTP.Request`, `ad_account_id`::`String`, `entity_ids`::`Vector{String}`; `bookmark`=nothing, `page_size`=nothing, `order`=nothing, `schedule_statuses`=nothing, `schedule_type`=nothing,) -> `SchedulesList200Response`
...
# **schedules_update**
> `schedules_update`(req::`HTTP.Request`, `ad_account_id`::`String`, `schedule_batch_update`::`Vector{ScheduleBatchUpdate}`;) -> `Vector{SchedulesCreate200ResponseInner}`
