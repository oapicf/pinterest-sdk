...
# **lead_form_get**
> `lead_form_get`(req::`HTTP.Request`, `lead_form_id`::`String`, `ad_account_id`::`String`;) -> `LeadForm`
...
> `lead_form_test_create`(req::`HTTP.Request`, `ad_account_id`::`String`, `lead_form_id`::`String`, `lead_form_test_create_param`::`LeadFormTestCreate`;) -> `LeadFormTest`
...
# **lead_forms_create**
> `lead_forms_create`(req::`HTTP.Request`, `ad_account_id`::`String`, `lead_form_create`::`Vector{LeadFormCreate}`;) -> `LeadFormsCreate200Response`
...
# **lead_forms_list**
> `lead_forms_list`(req::`HTTP.Request`, `ad_account_id`::`String`; `bookmark`=nothing, `page_size`=nothing, `order`=nothing,) -> `LeadFormsList200Response`
...
# **lead_forms_update**
> `lead_forms_update`(req::`HTTP.Request`, `ad_account_id`::`String`, `lead_form_batch_update`::`Vector{LeadFormBatchUpdate}`;) -> `LeadFormsCreate200Response`
