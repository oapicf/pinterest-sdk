...
> `audience_insights_get`(req::`HTTP.Request`, `ad_account_id`::`String`, `audience_insight_type`::`AudienceInsightType`;) -> `AudienceInsights`
...
> `audience_insights_scope_and_type_get`(req::`HTTP.Request`, `ad_account_id`::`String`;) -> `AudienceInsightsScopeAndTypeGet200Response`
