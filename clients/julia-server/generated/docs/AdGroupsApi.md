...
> `ad_groups_audience_sizing`(req::`HTTP.Request`, `ad_account_id`::`String`, `ad_group_audience_sizing_create`::`AdGroupAudienceSizingCreate`;) -> `AdGroupAudienceSizing`
...
> `ad_groups_bid_floor_get`(req::`HTTP.Request`, `ad_account_id`::`String`, `bid_floor_create`::`BidFloorCreate`;) -> `BidFloor`
...
# **ad_groups_create**
> `ad_groups_create`(req::`HTTP.Request`, `ad_account_id`::`String`, `ad_group_create_create`::`Vector{AdGroupCreateCreate}`;) -> `AdGroupsCreate200Response`
...
> `ad_groups_dynamic_titles_download_csv`(req::`HTTP.Request`, `ad_account_id`::`String`, `ad_group_id`::`String`;) -> `DynamicTitlesDownloadCSV`
...
> `ad_groups_dynamic_titles_get_status`(req::`HTTP.Request`, `ad_account_id`::`String`, `ad_group_id`::`String`;) -> `DynamicTitlesGetStatus`
...
> `ad_groups_dynamic_titles_get_upload_url`(req::`HTTP.Request`, `ad_account_id`::`String`, `ad_group_id`::`String`;) -> `DynamicTitlesUploadURL`
...
> `ad_groups_dynamic_titles_process_csv`(req::`HTTP.Request`, `ad_account_id`::`String`, `ad_group_id`::`String`, `dynamic_titles_process_c_s_v_create`::`DynamicTitlesProcessCSVCreate`;) -> `DynamicTitlesProcessCSV`
...
# **ad_groups_get**
> `ad_groups_get`(req::`HTTP.Request`, `ad_group_id`::`String`, `ad_account_id`::`String`;) -> `AdGroup`
...
# **ad_groups_list**
> `ad_groups_list`(req::`HTTP.Request`, `ad_account_id`::`String`; `bookmark`=nothing, `page_size`=nothing, `order`=nothing, `campaign_ids`=nothing, `ad_group_ids`=nothing, `entity_statuses`=nothing, `translate_interests_to_names`=nothing,) -> `AdGroupsList200Response`
...
# **ad_groups_update**
> `ad_groups_update`(req::`HTTP.Request`, `ad_account_id`::`String`, `ad_group_update_batch_update`::`Vector{AdGroupUpdateBatchUpdate}`;) -> `AdGroupsCreate200Response`
...
> `get_ad_groups_by_promotion_ids_list`(req::`HTTP.Request`, `ad_account_id`::`String`, `promotion_ids`::`Vector{String}`; `bookmark`=nothing, `page_size`=nothing, `order`=nothing,) -> `AdGroupsList200Response`
