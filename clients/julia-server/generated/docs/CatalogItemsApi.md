...
# **items_batch_get**
> `items_batch_get`(req::`HTTP.Request`, `batch_id`::`String`; `ad_account_id`=nothing,) -> `CatalogsItemsBatch`
...
# **items_batch_post**
> `items_batch_post`(req::`HTTP.Request`, `catalogs_items_batch_post_request`::`CatalogsItemsBatchPostRequest`; `ad_account_id`=nothing,) -> `CatalogsItemsBatch`
...
# **items_post**
> `items_post`(req::`HTTP.Request`, `catalogs_items_request`::`CatalogsItemsRequest`; `ad_account_id`=nothing,) -> `ItemsPost200Response`
