...
# **media_create**
> `media_create`(req::`HTTP.Request`, `media_upload_create`::`MediaUploadCreate`;) -> `MediaUpload`
...
# **media_get**
> `media_get`(req::`HTTP.Request`, `media_id`::`String`;) -> `Media`
...
# **media_list**
> `media_list`(req::`HTTP.Request`; `bookmark`=nothing, `page_size`=nothing,) -> `MediaList200Response`
