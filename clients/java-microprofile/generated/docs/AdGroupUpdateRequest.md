...
|**bidInMicroCurrency** | **Integer** | Bid price in micro currency. This field is **REQUIRED** for the following campaign objective_type/billable_event combinations: AWARENESS/IMPRESSION, CONSIDERATION/CLICKTHROUGH, CATALOG_SALES/CLICKTHROUGH. |  [optional] |
...
|**promotionApplicationLevel** | [**PromotionApplicationLevelEnum**](#PromotionApplicationLevelEnum) | Specify if the promotion is applied at ad group or item level |  [optional] |
