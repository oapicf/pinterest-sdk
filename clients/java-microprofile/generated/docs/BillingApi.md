...
public class Example {
    public static void main(String[] args) {
        ...
        Date startDueDate = new Date(); // Date | Starting point for due dates when searching for invoices. Format: YYYY-MM-DD
        Date endDueDate = new Date(); // Date | Ending point for due dates when searching for invoices. Format: YYYY-MM-DD
        try {
