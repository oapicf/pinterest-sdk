...
public class Example {
    public static void main(String[] args) {
        ...
        List<AdsAnalyticsAdTargetingType> targetingTypes = Arrays.asList(); // List<AdsAnalyticsAdTargetingType> | Targeting type breakdowns for the report. The reporting per targeting type is independent from each other. [\"AGE_BUCKET_AND_GENDER\"] is in BETA and not yet available to all users.
        ...
        ConversionAttributionWindowDays clickWindowDays = ConversionAttributionWindowDays.fromValue("0"); // ConversionAttributionWindowDays | Number of days to use as the conversion attribution window for a pin click action. Applies to Pinterest Tag conversion metrics. Prior conversion tags use their defined attribution windows. If not specified, defaults to `30` days.
        ConversionAttributionWindowDays engagementWindowDays = ConversionAttributionWindowDays.fromValue("0"); // ConversionAttributionWindowDays | Number of days to use as the conversion attribution window for an engagement action. Engagements include saves, closeups, link clicks, and carousel card swipes. Applies to Pinterest Tag conversion metrics. Prior conversion tags use their defined attribution windows. If not specified, defaults to `30` days.  **Note:** This parameter no longer returns new data. However, you can still access historic data through **Sept 30, 2027**.
        ConversionAttributionWindowDays viewWindowDays = ConversionAttributionWindowDays.fromValue("0"); // ConversionAttributionWindowDays | Number of days to use as the conversion attribution window for a view action. Applies to Pinterest Tag conversion metrics. Prior conversion tags use their defined attribution windows. If not specified, defaults to `1` day.
        ConversionReportTimeType conversionReportTime = ConversionReportTimeType.fromValue("TIME_OF_AD_ACTION"); // ConversionReportTimeType | The date by which the conversion metrics returned from this endpoint will be reported. There are two dates associated with a conversion event: the date that the user interacted with the ad, and the date that the user completed a conversion event.
...
public class Example {
    public static void main(String[] args) {
        ...
        AdsApi apiInstance = new AdsApi(defaultClient);
        String adAccountId = "adAccountId_example"; // String | Unique identifier of an ad account.
        List<AdCreate> adCreate = Arrays.asList(); // List<AdCreate> | 
        try {
...
public class Example {
    public static void main(String[] args) {
        ...
        AdsApi apiInstance = new AdsApi(defaultClient);
        String adId = "adId_example"; // String | The ID of this ad.
        String adAccountId = "adAccountId_example"; // String | Unique identifier of an ad account.
        try {
...
public class Example {
    public static void main(String[] args) {
        ...
        AdsApi apiInstance = new AdsApi(defaultClient);
        String adAccountId = "adAccountId_example"; // String | Unique identifier of an ad account.
        List<AdBatchUpdate> adBatchUpdate = Arrays.asList(); // List<AdBatchUpdate> | 
        try {
...
public class Example {
    public static void main(String[] args) {
        ...
        AdsApi apiInstance = new AdsApi(defaultClient);
        String adAccountId = "adAccountId_example"; // String | Unique identifier of an ad account.
        List<CampaignAdPreviewCreate> campaignAdPreviewCreate = Arrays.asList(); // List<CampaignAdPreviewCreate> | 
        try {
