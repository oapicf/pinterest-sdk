 ...
 */
@JsonbTypeSerializer(ReportingColumnSync.Serializer.class)
@JsonbTypeDeserializer(ReportingColumnSync.Deserializer.class)
public enum ReportingColumnSync {
  ...
  public static final class Deserializer implements JsonbDeserializer<ReportingColumnSync> {
    @Override
    public ReportingColumnSync deserialize(JsonParser parser, DeserializationContext ctx, Type rtType) {
      return fromValue(parser.getString());
    }
  }

  public static final class Serializer implements JsonbSerializer<ReportingColumnSync> {
    @Override
    public void serialize(ReportingColumnSync obj, JsonGenerator generator, SerializationContext ctx) {
