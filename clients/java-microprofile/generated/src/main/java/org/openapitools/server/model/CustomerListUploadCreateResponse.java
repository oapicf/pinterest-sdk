...
public class CustomerListUploadCreateResponse  {
  ...
  */
  @JsonbProperty("customer_list_upload")
  protected CustomerListUpload customerListUpload;

 /**
  * Pre-signed upload URLs corresponding to each part of the upload.
  */
  @JsonbProperty("s3_multipart_upload_data")
  protected S3MultipartUploadData s3MultipartUploadData;
