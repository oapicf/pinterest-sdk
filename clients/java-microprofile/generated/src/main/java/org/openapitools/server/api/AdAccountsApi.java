...
public interface AdAccountsApi  {
    ...
    @Produces({ "application/json" })
    MetricsResponse adAccountTargetingAnalyticsGet(@PathParam("ad_account_id") String adAccountId, @QueryParam("start_date") Date startDate, @QueryParam("end_date") Date endDate, @QueryParam("targeting_types") List<AdsAnalyticsAccountTargetingType> targetingTypes, @QueryParam("columns") List<ReportingColumnSync> columns, @QueryParam("granularity") Granularity granularity, @QueryParam("click_window_days") @DefaultValue("30") BigDecimal clickWindowDays, @QueryParam("engagement_window_days") @DefaultValue("30") BigDecimal engagementWindowDays, @QueryParam("view_window_days") @DefaultValue("1") BigDecimal viewWindowDays, @QueryParam("conversion_report_time") @DefaultValue("TIME_OF_AD_ACTION") String conversionReportTime, @QueryParam("attribution_types") List<ConversionReportAttributionType> attributionTypes, @QueryParam("reporting_timezone") ReportingTimeZone reportingTimezone) throws ApiException, ProcessingException;
    ...
    @Produces({ "application/json" })
    Response adAccountsCreate(AdAccountCreate adAccountCreate) throws ApiException, ProcessingException;
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    Response analyticsCreateConversionProductReport(@PathParam("ad_account_id") String adAccountId, ConversionProductReportCreate conversionProductReportCreate) throws ApiException, ProcessingException;
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    Response analyticsCreateMmmReport(@PathParam("ad_account_id") String adAccountId, MMMReportCreate mmMReportCreate) throws ApiException, ProcessingException;
    ...
    @Produces({ "application/json" })
    Response analyticsCreateTemplateReport(@PathParam("ad_account_id") String adAccountId, @PathParam("template_id") String templateId, @QueryParam("start_date") Date startDate, @QueryParam("end_date") Date endDate, @QueryParam("granularity") Granularity granularity) throws ApiException, ProcessingException;
