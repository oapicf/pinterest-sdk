 ...
 * Product item fields
 */
@JsonbTypeSerializer(NullableCatalogsItemFieldType.Serializer.class)
@JsonbTypeDeserializer(NullableCatalogsItemFieldType.Deserializer.class)
public enum NullableCatalogsItemFieldType {
  ...
  public static final class Deserializer implements JsonbDeserializer<NullableCatalogsItemFieldType> {
    @Override
    public NullableCatalogsItemFieldType deserialize(JsonParser parser, DeserializationContext ctx, Type rtType) {
      return fromValue(parser.getString());
    }
  }

  public static final class Serializer implements JsonbSerializer<NullableCatalogsItemFieldType> {
    @Override
    public void serialize(NullableCatalogsItemFieldType obj, JsonGenerator generator, SerializationContext ctx) {
