 ...
 * Reporting columns
 */
@JsonbTypeSerializer(ReportingColumnAsync.Serializer.class)
@JsonbTypeDeserializer(ReportingColumnAsync.Deserializer.class)
public enum ReportingColumnAsync {
  ...
  public static final class Deserializer implements JsonbDeserializer<ReportingColumnAsync> {
    @Override
    public ReportingColumnAsync deserialize(JsonParser parser, DeserializationContext ctx, Type rtType) {
      return fromValue(parser.getString());
    }
  }

  public static final class Serializer implements JsonbSerializer<ReportingColumnAsync> {
    @Override
    public void serialize(ReportingColumnAsync obj, JsonGenerator generator, SerializationContext ctx) {
      generator.write(obj.value);
    }
  }

  public static ReportingColumnAsync fromValue(String text) {
    for (ReportingColumnAsync b : ReportingColumnAsync.values()) {
