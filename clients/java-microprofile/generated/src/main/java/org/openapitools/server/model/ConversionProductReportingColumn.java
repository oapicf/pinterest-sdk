 ...
 */
@JsonbTypeSerializer(ConversionProductReportingColumn.Serializer.class)
@JsonbTypeDeserializer(ConversionProductReportingColumn.Deserializer.class)
public enum ConversionProductReportingColumn {
  ...
  public static final class Deserializer implements JsonbDeserializer<ConversionProductReportingColumn> {
    @Override
    public ConversionProductReportingColumn deserialize(JsonParser parser, DeserializationContext ctx, Type rtType) {
      return fromValue(parser.getString());
    }
  }

  public static final class Serializer implements JsonbSerializer<ConversionProductReportingColumn> {
    @Override
    public void serialize(ConversionProductReportingColumn obj, JsonGenerator generator, SerializationContext ctx) {
      generator.write(obj.value);
    }
  }

  public static ConversionProductReportingColumn fromValue(String text) {
