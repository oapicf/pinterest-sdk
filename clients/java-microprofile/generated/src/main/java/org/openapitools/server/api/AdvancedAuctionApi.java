...
public interface AdvancedAuctionApi  {
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    Response advancedAuctionItemsSubmitPost(AdvancedAuctionItemsSubmitRequest advancedAuctionItemsSubmitRequest, @QueryParam("ad_account_id") String adAccountId) throws ApiException, ProcessingException;
}
