 ...
 */
@JsonbTypeSerializer(Country.Serializer.class)
@JsonbTypeDeserializer(Country.Deserializer.class)
public enum Country {
  ...
  public static final class Deserializer implements JsonbDeserializer<Country> {
    @Override
  ...
  public static final class Serializer implements JsonbSerializer<Country> {
    @Override
