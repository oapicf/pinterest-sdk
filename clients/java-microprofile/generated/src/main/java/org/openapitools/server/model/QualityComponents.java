...
public class QualityComponents  {
  ...
  @JsonbProperty("advertiser_external_id")
  protected Map<String, QualityComponentDetails> advertiserExternalId = null;

  @JsonbProperty("click_id_epik")
  protected Map<String, QualityComponentDetails> clickIdEpik = null;

 /**
  * Dedup components.
  */
  @JsonbProperty("external_event_id")
  protected Map<String, QualityComponentDetails> externalEventId = null;

 /**
  * User matching identifiers.
  */
  @JsonbProperty("hashed_email")
  protected Map<String, QualityComponentDetails> hashedEmail = null;

  @JsonbProperty("hashed_maid")
  protected Map<String, QualityComponentDetails> hashedMaid = null;

  @JsonbProperty("ip_address")
  protected Map<String, QualityComponentDetails> ipAddress = null;

  @JsonbProperty("order_id")
  protected Map<String, QualityComponentDetails> orderId = null;

  @JsonbProperty("order_value")
  protected Map<String, QualityComponentDetails> orderValue = null;

 /**
  * Product/event metadata.
  */
  @JsonbProperty("product_id")
  protected Map<String, QualityComponentDetails> productId = null;

  @JsonbProperty("source_url")
  protected Map<String, QualityComponentDetails> sourceUrl = null;

  @JsonbProperty("user_agent")
  protected Map<String, QualityComponentDetails> userAgent = null;
