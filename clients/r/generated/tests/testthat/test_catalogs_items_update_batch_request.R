...
context("Test CatalogsItemsUpdateBatchRequest")

model_instance <- CatalogsItemsUpdateBatchRequest$new()
...
test_that("items", {
  # tests for the property `items` (array[ItemUpdateBatchRecord])
