...
context("Test LeadSubscriptionPostParamsCreate")

model_instance <- LeadSubscriptionPostParamsCreate$new()
...
test_that("partner_metadata", {
  # tests for the property `partner_metadata` (LeadSubscriptionPostParamsCreateAllOfPartnerMetadata)
