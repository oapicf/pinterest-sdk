...
context("Test AdvancedAuctionApi")

api_instance <- AdvancedAuctionApi$new()

test_that("AdvancedAuctionItemsGetPost", {
  # tests for AdvancedAuctionItemsGetPost
...
test_that("AdvancedAuctionItemsSubmitPost", {
  # tests for AdvancedAuctionItemsSubmitPost
  # base path: https://api.pinterest.com/v5
