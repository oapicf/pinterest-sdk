...
context("Test CatalogsCreativeAssetsListProductsByCatalogBasedFilterRequest")

model_instance <- CatalogsCreativeAssetsListProductsByCatalogBasedFilterRequest$new()
