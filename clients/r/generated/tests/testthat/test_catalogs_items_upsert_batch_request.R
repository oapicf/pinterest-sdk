...
context("Test CatalogsItemsUpsertBatchRequest")

model_instance <- CatalogsItemsUpsertBatchRequest$new()
...
test_that("items", {
  # tests for the property `items` (array[ItemUpsertBatchRecord])
