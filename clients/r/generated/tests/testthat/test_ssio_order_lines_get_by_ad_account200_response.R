...
context("Test SsioOrderLinesGetByAdAccount200Response")

model_instance <- SsioOrderLinesGetByAdAccount200Response$new()

test_that("items", {
  # tests for the property `items` (array[SSIOOrderLine])
