...
test_that("FETCH_GOOGLE_SHEET_NOT_SHARED", {
  # tests for the property `FETCH_GOOGLE_SHEET_NOT_SHARED` (integer)
  # Update your Google Sheets sharing settings to &#39;Anyone with link&#39; as a Viewer so that Pinterest can access your file.

  # uncomment below to test the property
  #expect_equal(model.instance$`FETCH_GOOGLE_SHEET_NOT_SHARED`, "EXPECTED_RESULT")
})
