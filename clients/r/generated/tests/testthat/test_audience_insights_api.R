...
context("Test AudienceInsightsApi")

api_instance <- AudienceInsightsApi$new()

test_that("AudienceInsightsGet", {
  # tests for AudienceInsightsGet
...
test_that("AudienceInsightsScopeAndTypeGet", {
  # tests for AudienceInsightsScopeAndTypeGet
  # base path: https://api.pinterest.com/v5
