...
context("Test TargetingSpecOperationShoppingRetargeting")

model_instance <- TargetingSpecOperationShoppingRetargeting$new()
...
test_that("values", {
  # tests for the property `values` (array[TargetingSpecShoppingRetargeting])
