...
> array[ProductGroupAnalyticsResponseInner] ProductGroupsAnalytics(ad_account_id, start_date, end_date, product_group_ids, columns, granularity, click_window_days = 30, engagement_window_days = 30, view_window_days = 1, conversion_report_time = "TIME_OF_AD_ACTION", reporting_timezone = var.reporting_timezone)
