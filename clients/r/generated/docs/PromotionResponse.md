...
**promotion_title** | **character** | Internal name for the promotion. | [optional] 
**promotion_type** | [**PromotionType**](PromotionType.md) |  | [optional] [Enum: ] 
...
**ad_account_id** | **character** | The Ad Account ID that this promotion belongs to. | [optional] [Pattern: ^\\d+$] 
**id** | **character** | Promotion ID | [optional] [Pattern: ^\\d+$] 
