...
**billing_period_end_date** | **character** | The end date of the billing period. Format: YYYY-MM-DD | [optional] 
**billing_period_start_date** | **character** | The start date of the billing period. Format: YYYY-MM-DD | [optional] 
**currency** | [**Currency**](Currency.md) |  | [optional] [Enum: ] 
**document_type** | [**BillingInvoiceDocumentType**](BillingInvoiceDocumentType.md) | The type of the document | [optional] [Enum: ] 
**id** | **character** | Unique identifier for the billing invoice | [optional] [Pattern: ^\\d+$] 
**invoice_due_date** | **character** | The date the invoice is due. Format: YYYY-MM-DD | [optional] 
**payment_terms** | **character** | The payment terms of the invoice | [optional] 
**status** | [**BillingInvoiceStatus**](BillingInvoiceStatus.md) | The status of the invoice | [optional] [Enum: ] 
