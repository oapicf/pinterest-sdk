...
------------ | ------------- | ------------- | -------------
**ad_account_id** | **character** | Ad account ID. | 
...
**id** | **character** | Order line ID. | [Pattern: ^\\d+$] 
...
**status** | [**OrderLineStatus**](OrderLineStatus.md) | Order line status. | [Enum: ] 
**type** | **character** | Always \&quot;orderline\&quot;. | 
