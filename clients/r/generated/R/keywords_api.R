...
KeywordsApi <- R6::R6Class(
  ...
  public = list(
    ...
    CountryKeywordsMetricsGet = function(ad_account_id, country_code, keywords, data_file = NULL, ..., .parse = TRUE) {
      local_var_response <- self$CountryKeywordsMetricsGetWithHttpInfo(ad_account_id, country_code, keywords, data_file = data_file, ..., .parse = .parse)
    ...
    CountryKeywordsMetricsGetWithHttpInfo = function(ad_account_id, country_code, keywords, data_file = NULL, ..., .parse = TRUE) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
    ...
    #'
    #' @param ad_account_id Unique identifier of an ad account.
    #' @param keywords_create 
    #' @param data_file (optional) name of the data file to save the result
    #' @param ... Other optional arguments
    #' @param .parse Logical. If \code{TRUE} then the response will be parsed to a generated type. If \code{FALSE} the response will be returned as unparsed text.
    #'
    #' @return Keywords
    KeywordsCreate = function(ad_account_id, keywords_create, data_file = NULL, ..., .parse = TRUE) {
      local_var_response <- self$KeywordsCreateWithHttpInfo(ad_account_id, keywords_create, data_file = data_file, ..., .parse = .parse)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        return(local_var_response$content)
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        return(local_var_response)
    ...
    #' @param .parse Logical. If \code{TRUE} then the response will be parsed to a generated type. If \code{FALSE} the response will be returned as unparsed text.
    #'
    #' @return API response (Keywords) with additional information such as HTTP status code, headers
    KeywordsCreateWithHttpInfo = function(ad_account_id, keywords_create, data_file = NULL, ..., .parse = TRUE) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      if (missing(`keywords_create`)) {
        stop("Missing required parameter `keywords_create`.")
      }
      ...
      if (!missing(`keywords_create`) && is.null(`keywords_create`)) {
        stop("Invalid value for `keywords_create` when calling KeywordsApi$KeywordsCreate, `keywords_create` is not nullable")
      }

      if (!is.null(`keywords_create`)) {
        local_var_body <- `keywords_create`$toJSONString()
      } else {
        local_var_body <- NULL
      }
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$DeserializeResponse(local_var_resp, "Keywords"),
          error = function(e) {
            stop("Failed to deserialize response")
          }
        )
    ...
    #' @param match_types (optional) Keyword [match type](/docs/api-features/targeting-overview/)
    ...
    KeywordsGet = function(ad_account_id, campaign_id = NULL, ad_group_id = NULL, ad_group_ids = NULL, match_types = NULL, bookmark = NULL, page_size = 25, data_file = NULL, ..., .parse = TRUE) {
      local_var_response <- self$KeywordsGetWithHttpInfo(ad_account_id, campaign_id, ad_group_id, ad_group_ids, match_types, bookmark, page_size, data_file = data_file, ..., .parse = .parse)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        return(local_var_response$content)
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        return(local_var_response)
    ...
    KeywordsGetWithHttpInfo = function(ad_account_id, campaign_id = NULL, ad_group_id = NULL, ad_group_ids = NULL, match_types = NULL, bookmark = NULL, page_size = 25, data_file = NULL, ..., .parse = TRUE) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
    ...
    #'
    #' @param ad_account_id Unique identifier of an ad account.
    #' @param keywords_update 
    #' @param data_file (optional) name of the data file to save the result
    #' @param ... Other optional arguments
    #' @param .parse Logical. If \code{TRUE} then the response will be parsed to a generated type. If \code{FALSE} the response will be returned as unparsed text.
    #'
    #' @return Keywords
    KeywordsUpdate = function(ad_account_id, keywords_update, data_file = NULL, ..., .parse = TRUE) {
      local_var_response <- self$KeywordsUpdateWithHttpInfo(ad_account_id, keywords_update, data_file = data_file, ..., .parse = .parse)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        return(local_var_response$content)
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        return(local_var_response)
    ...
    #'
    #' @return API response (Keywords) with additional information such as HTTP status code, headers
    KeywordsUpdateWithHttpInfo = function(ad_account_id, keywords_update, data_file = NULL, ..., .parse = TRUE) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      if (missing(`keywords_update`)) {
        stop("Missing required parameter `keywords_update`.")
      }
      ...
      if (!missing(`keywords_update`) && is.null(`keywords_update`)) {
        stop("Invalid value for `keywords_update` when calling KeywordsApi$KeywordsUpdate, `keywords_update` is not nullable")
      }

      if (!is.null(`keywords_update`)) {
        local_var_body <- `keywords_update`$toJSONString()
      } else {
        local_var_body <- NULL
      }
    ...
    #' @param interests (optional)   The list of supported interests is:   - `animals` - Animals   - `architecture` - Architecture   - `art` - Art   - `beauty` - Beauty   - `childrens_fashion` - Children's Fashion   - `design` - Design   - `diy_and_crafts` - DIY & Crafts   - `education` - Education   - `electronics` - Electronics   - `entertainment` - Entertainment   - `event_planning` - Event Planning   - `finance` - Finance   - `food_and_drinks` - Food & Drink   - `gardening` - Gardening   - `health` - Health   - `home_decor` - Home Decor   - `mens_fashion` - Men's Fashion   - `parenting` - Parenting   - `quotes` - Quotes   - `sport` - Sports   - `travel` - Travel   - `vehicles` - Vehicles   - `wedding` - Wedding   - `womens_fashion` - Women's Fashion
    #' @param genders (optional) If set, filters the results to trends among users who identify with the specified gender(s). If unset, trends among all genders will be returned. The `unknown` group includes users with unspecified or customized gender profile settings.
    #' @param ages (optional) If set, filters the results to trends among users in the specified age range(s). If unset, trends among all age groups will be returned.
    #' @param include_keywords (optional) If set, filters the results to top trends which include at least one of the specified keywords. If unset, no keyword filtering logic is applied.
    #' @param normalize_against_group (optional)  Governs how the resulting time series data will be normalized to a [0-100] scale.    By default (`false`), the data will be normalized independently for each keyword.  The peak search volume observation in *each* keyword's time series will be represented by the value 100.  This is ideal for analyzing when an individual keyword is expected to peak in interest.    If set to `true`, the data will be normalized as a group.  The peak search volume observation across *all* keywords in the response will be represented by the value 100, and all other values scaled accordingly.  Use this option when you wish to compare relative search volume between multiple keywords. (default value: FALSE)
    ...
    #' @param include_demographics (optional) Including the age and gender distribution for each keyword. By default (`false`), the response will not include demographics data. (default value: FALSE)
    #' @param data_file (optional) name of the data file to save the result
    #' @param ... Other optional arguments
    #' @param .parse Logical. If \code{TRUE} then the response will be parsed to a generated type. If \code{FALSE} the response will be returned as unparsed text.
    #'
    #' @return TrendingKeywordsResponse
    TrendingKeywordsList = function(region, trend_type, interests = NULL, genders = NULL, ages = NULL, include_keywords = NULL, normalize_against_group = FALSE, limit = 50, include_demographics = FALSE, data_file = NULL, ..., .parse = TRUE) {
      local_var_response <- self$TrendingKeywordsListWithHttpInfo(region, trend_type, interests, genders, ages, include_keywords, normalize_against_group, limit, include_demographics, data_file = data_file, ..., .parse = .parse)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        return(local_var_response$content)
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        return(local_var_response)
    ...
    TrendingKeywordsListWithHttpInfo = function(region, trend_type, interests = NULL, genders = NULL, ages = NULL, include_keywords = NULL, normalize_against_group = FALSE, limit = 50, include_demographics = FALSE, data_file = NULL, ..., .parse = TRUE) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
