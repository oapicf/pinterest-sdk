...
LeadFormCommonPolicyLinksInner <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return LeadFormCommonPolicyLinksInner as a base R list.
    #' @examples
    #' # convert array of LeadFormCommonPolicyLinksInner (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert LeadFormCommonPolicyLinksInner to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(LeadFormCommonPolicyLinksInnerObject)
    },
