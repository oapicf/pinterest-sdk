...
UpdateMemberResult <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return UpdateMemberResult as a base R list.
    #' @examples
    #' # convert array of UpdateMemberResult (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert UpdateMemberResult to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(UpdateMemberResultObject)
    },
