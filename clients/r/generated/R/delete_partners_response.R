...
DeletePartnersResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return DeletePartnersResponse as a base R list.
    #' @examples
    #' # convert array of DeletePartnersResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert DeletePartnersResponse to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(DeletePartnersResponseObject)
    },
