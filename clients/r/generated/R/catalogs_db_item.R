...
CatalogsDbItem <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return CatalogsDbItem as a base R list.
    #' @examples
    #' # convert array of CatalogsDbItem (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CatalogsDbItem to a base R type
    #'
