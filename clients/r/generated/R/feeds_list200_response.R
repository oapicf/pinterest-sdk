...
FeedsList200Response <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return FeedsList200Response as a base R list.
    #' @examples
    #' # convert array of FeedsList200Response (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert FeedsList200Response to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(FeedsList200ResponseObject)
    },
