...
TermsApi <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return RelatedTerms
    TermsRelatedList = function(terms, data_file = NULL, ..., .parse = TRUE) {
      local_var_response <- self$TermsRelatedListWithHttpInfo(terms, data_file = data_file, ..., .parse = .parse)
    ...
    TermsRelatedListWithHttpInfo = function(terms, data_file = NULL, ..., .parse = TRUE) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$DeserializeResponse(local_var_resp, "RelatedTerms"),
          error = function(e) {
    ...
    TermsSuggestedList = function(term, limit = 4, data_file = NULL, ..., .parse = TRUE) {
      local_var_response <- self$TermsSuggestedListWithHttpInfo(term, limit, data_file = data_file, ..., .parse = .parse)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        return(local_var_response$content)
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        return(local_var_response)
    ...
    TermsSuggestedListWithHttpInfo = function(term, limit = 4, data_file = NULL, ..., .parse = TRUE) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
