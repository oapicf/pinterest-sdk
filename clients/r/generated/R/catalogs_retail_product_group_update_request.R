...
CatalogsRetailProductGroupUpdateRequest <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return CatalogsRetailProductGroupUpdateRequest as a base R list.
    #' @examples
    #' # convert array of CatalogsRetailProductGroupUpdateRequest (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CatalogsRetailProductGroupUpdateRequest to a base R type
    #'
