...
ConversionEventsUserDataAnyOf <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return ConversionEventsUserDataAnyOf as a base R list.
    #' @examples
    #' # convert array of ConversionEventsUserDataAnyOf (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ConversionEventsUserDataAnyOf to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(ConversionEventsUserDataAnyOfObject)
    },
