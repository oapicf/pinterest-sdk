...
#' @field user Metadata for the user that updated the invite/request. \link{BusinessAccessUserSummary} [optional]
...
InviteBusinessRoleBinding <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(`created_by_business_id` = NULL, `created_by_user_id` = NULL, `user` = NULL, `id` = NULL, `invite_data` = NULL, `is_received_invite` = NULL, ...) {
