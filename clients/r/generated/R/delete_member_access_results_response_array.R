...
DeleteMemberAccessResultsResponseArray <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return DeleteMemberAccessResultsResponseArray as a base R list.
    #' @examples
    #' # convert array of DeleteMemberAccessResultsResponseArray (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert DeleteMemberAccessResultsResponseArray to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(DeleteMemberAccessResultsResponseArrayObject)
    },
