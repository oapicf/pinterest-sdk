#' Create a new PromotionArrayElement
#'
#' @description
#' PromotionArrayElement Class
#'
#' @docType class
...
#' @export
PromotionArrayElement <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new PromotionArrayElement class.
    #'
    #' @param data data
    #' @param exception exception
    #' @param ... Other optional arguments.
    initialize = function(`data` = NULL, `exception` = NULL, ...) {
      if (!is.null(`data`)) {
    ...
    #'
    #' @return PromotionArrayElement as a base R list.
    #' @examples
    #' # convert array of PromotionArrayElement (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert PromotionArrayElement to a base R type
    #'
    ...
    #' @description
    #' Deserialize JSON string into an instance of PromotionArrayElement
    #'
    ...
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`exception`)) {
        `exception_object` <- Exception$new()
    ...
    #' @return PromotionArrayElement in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to PromotionArrayElement and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of PromotionArrayElement
    toString = function() {
      self$toJSONString()
    },
...
# PromotionArrayElement$unlock()
#
## Below is an example to define the print function
# PromotionArrayElement$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# PromotionArrayElement$lock()
