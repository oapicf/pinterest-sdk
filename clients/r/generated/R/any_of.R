...
AnyOf <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return AnyOf as a base R list.
    #' @examples
    #' # convert array of AnyOf (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert AnyOf to a base R type
    #'
    ...
    #' @description
    #' Deserialize JSON string into an instance of AnyOf
    #'
    #' @param input_json the JSON input
    #' @return the instance of AnyOf
    ...
    #' @description
    #' Validate JSON input with respect to AnyOf and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`any_of`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for AnyOf: the required field `any_of` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of AnyOf
    toString = function() {
      self$toJSONString()
    },
...
# AnyOf$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
