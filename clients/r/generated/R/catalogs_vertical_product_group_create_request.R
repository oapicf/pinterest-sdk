...
CatalogsVerticalProductGroupCreateRequest <- R6::R6Class(
  ...
  public = list(
    ...
    one_of = list("CatalogsHotelProductGroupCreateRequest"),
    #' Initialize a new CatalogsVerticalProductGroupCreateRequest.
    #'
    #' @description
    #' Initialize a new CatalogsVerticalProductGroupCreateRequest.
    #'
    #' @param instance an instance of the object defined in the oneOf schemas: "CatalogsHotelProductGroupCreateRequest"
    #' @export
    initialize = function(instance = NULL) {
      if (is.null(instance)) {
        ...
        stop(paste("Failed to initialize CatalogsVerticalProductGroupCreateRequest with oneOf schemas CatalogsHotelProductGroupCreateRequest. Provided class name: ",
    ...
    fromJSON = function(input) {
      ...
      if (matched == 1) {
        ...
        # more than 1 match
        stop(paste("Multiple matches found when deserializing the input into CatalogsVerticalProductGroupCreateRequest with oneOf schemas CatalogsHotelProductGroupCreateRequest. Matched schemas: ",
                   paste(matched_schemas, collapse = ", ")))
      } else {
        # no match
        stop(paste("No match found when deserializing the input into CatalogsVerticalProductGroupCreateRequest with oneOf schemas CatalogsHotelProductGroupCreateRequest. Details: >>",
    ...
    #' Validate the input JSON with respect to CatalogsVerticalProductGroupCreateRequest.
    #'
    #' @description
