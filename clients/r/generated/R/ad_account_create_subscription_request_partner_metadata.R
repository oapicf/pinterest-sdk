...
AdAccountCreateSubscriptionRequestPartnerMetadata <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return AdAccountCreateSubscriptionRequestPartnerMetadata as a base R list.
    #' @examples
    #' # convert array of AdAccountCreateSubscriptionRequestPartnerMetadata (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert AdAccountCreateSubscriptionRequestPartnerMetadata to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(AdAccountCreateSubscriptionRequestPartnerMetadataObject)
    },
