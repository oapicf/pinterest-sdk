...
CatalogsDeleteCreativeAssetsItem <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return CatalogsDeleteCreativeAssetsItem as a base R list.
    #' @examples
    #' # convert array of CatalogsDeleteCreativeAssetsItem (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CatalogsDeleteCreativeAssetsItem to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(CatalogsDeleteCreativeAssetsItemObject)
    },
