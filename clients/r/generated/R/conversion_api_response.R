...
ConversionApiResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return ConversionApiResponse as a base R list.
    #' @examples
    #' # convert array of ConversionApiResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ConversionApiResponse to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(ConversionApiResponseObject)
    },
