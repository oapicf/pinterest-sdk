...
MediaUploadRequest <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return MediaUploadRequest as a base R list.
    #' @examples
    #' # convert array of MediaUploadRequest (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert MediaUploadRequest to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(MediaUploadRequestObject)
    },
