#' Create a new ProductGroupPromotionCreateRequestElement
#'
#' @description
#' ProductGroupPromotionCreateRequestElement Class
#'
#' @docType class
#' @title ProductGroupPromotionCreateRequestElement
#' @description ProductGroupPromotionCreateRequestElement Class
...
#' @export
ProductGroupPromotionCreateRequestElement <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new ProductGroupPromotionCreateRequestElement class.
    #'
    ...
    #'
    #' @return ProductGroupPromotionCreateRequestElement as a base R list.
    #' @examples
    #' # convert array of ProductGroupPromotionCreateRequestElement (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ProductGroupPromotionCreateRequestElement to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      ProductGroupPromotionCreateRequestElementObject <- list()
      if (!is.null(self$`id`)) {
        ProductGroupPromotionCreateRequestElementObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`ad_group_id`)) {
        ProductGroupPromotionCreateRequestElementObject[["ad_group_id"]] <-
          self$`ad_group_id`
      }
      if (!is.null(self$`bid_in_micro_currency`)) {
        ProductGroupPromotionCreateRequestElementObject[["bid_in_micro_currency"]] <-
          self$`bid_in_micro_currency`
      }
      if (!is.null(self$`included`)) {
        ProductGroupPromotionCreateRequestElementObject[["included"]] <-
          self$`included`
      }
      if (!is.null(self$`definition`)) {
        ProductGroupPromotionCreateRequestElementObject[["definition"]] <-
          self$`definition`
      }
      if (!is.null(self$`relative_definition`)) {
        ProductGroupPromotionCreateRequestElementObject[["relative_definition"]] <-
          self$`relative_definition`
      }
      if (!is.null(self$`parent_id`)) {
        ProductGroupPromotionCreateRequestElementObject[["parent_id"]] <-
          self$`parent_id`
      }
      if (!is.null(self$`slideshow_collections_title`)) {
        ProductGroupPromotionCreateRequestElementObject[["slideshow_collections_title"]] <-
          self$`slideshow_collections_title`
      }
      if (!is.null(self$`slideshow_collections_description`)) {
        ProductGroupPromotionCreateRequestElementObject[["slideshow_collections_description"]] <-
          self$`slideshow_collections_description`
      }
      if (!is.null(self$`is_mdl`)) {
        ProductGroupPromotionCreateRequestElementObject[["is_mdl"]] <-
          self$`is_mdl`
      }
      if (!is.null(self$`status`)) {
        ProductGroupPromotionCreateRequestElementObject[["status"]] <-
          self$`status`$toSimpleType()
      }
      if (!is.null(self$`tracking_url`)) {
        ProductGroupPromotionCreateRequestElementObject[["tracking_url"]] <-
          self$`tracking_url`
      }
      if (!is.null(self$`catalog_product_group_id`)) {
        ProductGroupPromotionCreateRequestElementObject[["catalog_product_group_id"]] <-
          self$`catalog_product_group_id`
      }
      if (!is.null(self$`catalog_product_group_name`)) {
        ProductGroupPromotionCreateRequestElementObject[["catalog_product_group_name"]] <-
          self$`catalog_product_group_name`
      }
      if (!is.null(self$`collections_hero_pin_id`)) {
        ProductGroupPromotionCreateRequestElementObject[["collections_hero_pin_id"]] <-
          self$`collections_hero_pin_id`
      }
      if (!is.null(self$`collections_hero_destination_url`)) {
        ProductGroupPromotionCreateRequestElementObject[["collections_hero_destination_url"]] <-
          self$`collections_hero_destination_url`
      }
      if (!is.null(self$`grid_click_type`)) {
        ProductGroupPromotionCreateRequestElementObject[["grid_click_type"]] <-
          self$`grid_click_type`$toSimpleType()
      }
      if (!is.null(self$`creative_type`)) {
        ProductGroupPromotionCreateRequestElementObject[["creative_type"]] <-
          self$`creative_type`$toSimpleType()
      }
      return(ProductGroupPromotionCreateRequestElementObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of ProductGroupPromotionCreateRequestElement
    #'
    #' @param input_json the JSON input
    #' @return the instance of ProductGroupPromotionCreateRequestElement
    ...
    #' @return ProductGroupPromotionCreateRequestElement in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to ProductGroupPromotionCreateRequestElement and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of ProductGroupPromotionCreateRequestElement
    toString = function() {
      self$toJSONString()
    },
...
# ProductGroupPromotionCreateRequestElement$unlock()
#
## Below is an example to define the print function
# ProductGroupPromotionCreateRequestElement$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# ProductGroupPromotionCreateRequestElement$lock()
