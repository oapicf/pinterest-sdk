...
#'
#' @description
#' UpdatePartnerAssetAccessBody Class
#'
#' @docType class
#' @title UpdatePartnerAssetAccessBody
#' @description UpdatePartnerAssetAccessBody Class
#' @format An \code{R6Class} generator object
#' @field accesses  list(\link{UpdatePartnerAssetAccessBodyAccessesInner})
...
UpdatePartnerAssetAccessBody <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      ...
      UpdatePartnerAssetAccessBodyObject
    },
    ...
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`accesses`)) {
        self$`accesses` <- ApiClient$new()$deserializeObj(this_object$`accesses`, "array[UpdatePartnerAssetAccessBodyAccessesInner]", loadNamespace("openapi"))
      }
      self
    },
