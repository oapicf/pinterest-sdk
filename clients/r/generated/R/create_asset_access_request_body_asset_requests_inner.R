...
CreateAssetAccessRequestBodyAssetRequestsInner <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return CreateAssetAccessRequestBodyAssetRequestsInner as a base R list.
    #' @examples
    #' # convert array of CreateAssetAccessRequestBodyAssetRequestsInner (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CreateAssetAccessRequestBodyAssetRequestsInner to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(CreateAssetAccessRequestBodyAssetRequestsInnerObject)
    },
