...
SSIOInsertionOrderStatusResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return SSIOInsertionOrderStatusResponse as a base R list.
    #' @examples
    #' # convert array of SSIOInsertionOrderStatusResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert SSIOInsertionOrderStatusResponse to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(SSIOInsertionOrderStatusResponseObject)
    },
