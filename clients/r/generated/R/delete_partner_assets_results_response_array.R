...
DeletePartnerAssetsResultsResponseArray <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return DeletePartnerAssetsResultsResponseArray as a base R list.
    #' @examples
    #' # convert array of DeletePartnerAssetsResultsResponseArray (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert DeletePartnerAssetsResultsResponseArray to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(DeletePartnerAssetsResultsResponseArrayObject)
    },
