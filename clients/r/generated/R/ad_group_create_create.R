#' Create a new AdGroupCreateCreate
#'
#' @description
#' Resource create operation model.
#'
#' @docType class
#' @title AdGroupCreateCreate
#' @description AdGroupCreateCreate Class
...
#' @export
AdGroupCreateCreate <- R6::R6Class(
  "AdGroupCreateCreate",
  public = list(
    ...
    #' @description
    #' Initialize a new AdGroupCreateCreate class.
    #'
    ...
    initialize = function(`billable_event`, `campaign_id`, `name`, `auto_targeting_enabled` = NULL, `bid_in_micro_currency` = NULL, `bid_multiplier` = NULL, `bid_strategy_type` = NULL, `budget_in_micro_currency` = NULL, `budget_type` = NULL, `customer_segment_id` = NULL, `end_time` = NULL, `ext_features` = NULL, `feed_profile_id` = NULL, `is_creative_optimization` = NULL, `is_local_inventory` = NULL, `lifetime_frequency_cap` = NULL, `local_inventory_radius_in_miles` = NULL, `optimization_goal_metadata` = NULL, `pacing_delivery_type` = NULL, `performance_plus_campaign_settings` = NULL, `placement_group` = NULL, `placement_traffic_type` = NULL, `promotion_application_level` = NULL, `promotion_id` = "0", `promotion_ids` = NULL, `start_time` = NULL, `status` = NULL, `targeting_spec` = NULL, `targeting_template_ids` = NULL, `tracking_urls` = NULL, ...) {
    ...
    #'
    #' @return AdGroupCreateCreate as a base R list.
    #' @examples
    #' # convert array of AdGroupCreateCreate (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Deserialize JSON string into an instance of AdGroupCreateCreate
    #'
    #' @param input_json the JSON input
    #' @return the instance of AdGroupCreateCreate
    ...
    #' @return AdGroupCreateCreate in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to AdGroupCreateCreate and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`billable_event`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for AdGroupCreateCreate: the required field `billable_event` is missing."))
      }
      ...
      if (!is.null(input_json$`campaign_id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for AdGroupCreateCreate: the required field `campaign_id` is missing."))
      }
      ...
      if (!is.null(input_json$`name`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for AdGroupCreateCreate: the required field `name` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of AdGroupCreateCreate
    toString = function() {
      self$toJSONString()
    },
...
# AdGroupCreateCreate$unlock()
#
## Below is an example to define the print function
# AdGroupCreateCreate$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# AdGroupCreateCreate$lock()
