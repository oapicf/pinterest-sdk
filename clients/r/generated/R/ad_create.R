...
AdCreate <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new AdCreate class.
    #'
    ...
    initialize = function(`ad_group_id`, `creative_type`, `pin_id`, `android_deep_link` = NULL, `carousel_android_deep_links` = NULL, `carousel_destination_urls` = NULL, `carousel_ios_deep_links` = NULL, `click_tracking_url` = NULL, `collection_items_destination_url_template` = NULL, `collections_header_type` = NULL, `customizable_cta_type` = NULL, `destination_url` = NULL, `disclosure_type` = NULL, `disclosure_url` = NULL, `grid_click_type` = NULL, `ios_deep_link` = NULL, `is_carting` = NULL, `is_collage_accepted_terms` = NULL, `is_collage_single_destination` = NULL, `is_pin_deleted` = NULL, `is_removable` = NULL, `lead_form_id` = NULL, `name` = NULL, `quiz_pin_data` = NULL, `status` = NULL, `tracking_urls` = NULL, `view_tracking_url` = NULL, ...) {
    ...
    #'
    #' @return AdCreate as a base R list.
    #' @examples
    #' # convert array of AdCreate (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Deserialize JSON string into an instance of AdCreate
    #'
    #' @param input_json the JSON input
    #' @return the instance of AdCreate
    ...
    #' @return AdCreate in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to AdCreate and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`ad_group_id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for AdCreate: the required field `ad_group_id` is missing."))
      }
      # check the required field `creative_type`
      if (!is.null(input_json$`creative_type`)) {
        stopifnot(R6::is.R6(input_json$`creative_type`))
      } else {
        stop(paste("The JSON input `", input, "` is invalid for AdCreate: the required field `creative_type` is missing."))
      }
      ...
      if (!is.null(input_json$`pin_id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for AdCreate: the required field `pin_id` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of AdCreate
    toString = function() {
      self$toJSONString()
    },
...
# AdCreate$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
