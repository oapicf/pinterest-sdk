...
CampaignCreateResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return CampaignCreateResponse as a base R list.
    #' @examples
    #' # convert array of CampaignCreateResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CampaignCreateResponse to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(CampaignCreateResponseObject)
    },
