...
#' @field label_type  \link{NullableLabelType}
...
Label <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(`id`, `label_type`, `value`, `status` = NULL, ...) {
      if (!missing(`id`)) {
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for Label: the required field `id` is missing."))
      }
      # check the required field `label_type`
      if (!is.null(input_json$`label_type`)) {
        stopifnot(R6::is.R6(input_json$`label_type`))
      } else {
        stop(paste("The JSON input `", input, "` is invalid for Label: the required field `label_type` is missing."))
      }
      ...
      if (!is.null(input_json$`value`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for Label: the required field `value` is missing."))
      }
    },
