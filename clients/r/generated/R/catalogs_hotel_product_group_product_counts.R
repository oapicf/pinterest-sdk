...
CatalogsHotelProductGroupProductCounts <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return CatalogsHotelProductGroupProductCounts as a base R list.
    #' @examples
    #' # convert array of CatalogsHotelProductGroupProductCounts (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CatalogsHotelProductGroupProductCounts to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(CatalogsHotelProductGroupProductCountsObject)
    },
