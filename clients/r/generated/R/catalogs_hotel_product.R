...
CatalogsHotelProduct <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return CatalogsHotelProduct as a base R list.
    #' @examples
    #' # convert array of CatalogsHotelProduct (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CatalogsHotelProduct to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(CatalogsHotelProductObject)
    },
