...
DeleteInvitesResultsResponseArray <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return DeleteInvitesResultsResponseArray as a base R list.
    #' @examples
    #' # convert array of DeleteInvitesResultsResponseArray (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert DeleteInvitesResultsResponseArray to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(DeleteInvitesResultsResponseArrayObject)
    },
