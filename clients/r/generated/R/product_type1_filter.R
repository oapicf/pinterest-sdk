...
ProductType1Filter <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return ProductType1Filter as a base R list.
    #' @examples
    #' # convert array of ProductType1Filter (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ProductType1Filter to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      if (!is.null(self$`PRODUCT_TYPE_1`)) {
        ProductType1FilterObject[["PRODUCT_TYPE_1"]] <-
          self$extractSimpleType(self$`PRODUCT_TYPE_1`)
      }
      return(ProductType1FilterObject)
    },
