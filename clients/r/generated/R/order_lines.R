...
OrderLines <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(`ad_account_id` = NULL, `budget` = NULL, `end_time` = NULL, `id` = NULL, `name` = NULL, `paid_budget` = NULL, `paid_type` = NULL, `purchase_order_id` = NULL, `start_time` = NULL, `status` = NULL, `type` = NULL, ...) {
