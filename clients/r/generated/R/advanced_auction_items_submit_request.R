...
AdvancedAuctionItemsSubmitRequest <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return AdvancedAuctionItemsSubmitRequest as a base R list.
    #' @examples
    #' # convert array of AdvancedAuctionItemsSubmitRequest (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert AdvancedAuctionItemsSubmitRequest to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(AdvancedAuctionItemsSubmitRequestObject)
    },
