...
BulkDownloadRequestCampaignFilter <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return BulkDownloadRequestCampaignFilter as a base R list.
    #' @examples
    #' # convert array of BulkDownloadRequestCampaignFilter (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert BulkDownloadRequestCampaignFilter to a base R type
    #'
