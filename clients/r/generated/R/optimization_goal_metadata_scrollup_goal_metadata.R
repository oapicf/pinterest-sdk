...
OptimizationGoalMetadataScrollupGoalMetadata <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return OptimizationGoalMetadataScrollupGoalMetadata as a base R list.
    #' @examples
    #' # convert array of OptimizationGoalMetadataScrollupGoalMetadata (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert OptimizationGoalMetadataScrollupGoalMetadata to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(OptimizationGoalMetadataScrollupGoalMetadataObject)
    },
