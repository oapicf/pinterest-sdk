...
#' @field items  list(\link{UserWebsite})
...
UserWebsitesGet200Response <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return UserWebsitesGet200Response as a base R list.
    #' @examples
    #' # convert array of UserWebsitesGet200Response (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert UserWebsitesGet200Response to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(UserWebsitesGet200ResponseObject)
    },
    ...
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`items`)) {
        self$`items` <- ApiClient$new()$deserializeObj(this_object$`items`, "array[UserWebsite]", loadNamespace("openapi"))
      }
      self
    },
