...
CatalogsCreativeAssetsProductGroupUpdateRequest <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return CatalogsCreativeAssetsProductGroupUpdateRequest as a base R list.
    #' @examples
    #' # convert array of CatalogsCreativeAssetsProductGroupUpdateRequest (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CatalogsCreativeAssetsProductGroupUpdateRequest to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(CatalogsCreativeAssetsProductGroupUpdateRequestObject)
    },
