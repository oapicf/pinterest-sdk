...
PinMediaSourceImageBase64 <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(`content_type`, `data`, `source_type`, `is_standard` = TRUE, ...) {
    ...
    #'
    #' @return PinMediaSourceImageBase64 as a base R list.
    #' @examples
    #' # convert array of PinMediaSourceImageBase64 (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert PinMediaSourceImageBase64 to a base R type
    #'
