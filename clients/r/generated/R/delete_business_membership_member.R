#' Create a new DeleteBusinessMembershipMember
#'
#' @description
#' Single instance of a business member to be removed from the business.
#'
#' @docType class
#' @title DeleteBusinessMembershipMember
#' @description DeleteBusinessMembershipMember Class
...
#' @export
DeleteBusinessMembershipMember <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new DeleteBusinessMembershipMember class.
    #'
    ...
    #'
    #' @return DeleteBusinessMembershipMember as a base R list.
    #' @examples
    #' # convert array of DeleteBusinessMembershipMember (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert DeleteBusinessMembershipMember to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      DeleteBusinessMembershipMemberObject <- list()
      if (!is.null(self$`business_role`)) {
        DeleteBusinessMembershipMemberObject[["business_role"]] <-
          self$extractSimpleType(self$`business_role`)
      }
      if (!is.null(self$`member_id`)) {
        DeleteBusinessMembershipMemberObject[["member_id"]] <-
          self$`member_id`
      }
      return(DeleteBusinessMembershipMemberObject)
    },
    ...
    #' @description
    #' Deserialize JSON string into an instance of DeleteBusinessMembershipMember
    #'
    #' @param input_json the JSON input
    #' @return the instance of DeleteBusinessMembershipMember
    ...
    #' @return DeleteBusinessMembershipMember in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to DeleteBusinessMembershipMember and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`business_role`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for DeleteBusinessMembershipMember: the required field `business_role` is missing."))
      }
      ...
      if (!is.null(input_json$`member_id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for DeleteBusinessMembershipMember: the required field `member_id` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of DeleteBusinessMembershipMember
    toString = function() {
      self$toJSONString()
    },
...
# DeleteBusinessMembershipMember$unlock()
#
## Below is an example to define the print function
# DeleteBusinessMembershipMember$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# DeleteBusinessMembershipMember$lock()
