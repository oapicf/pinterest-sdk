#' Create a new KeywordCreateItem
#'
#' @description
#' KeywordCreateItem Class
#'
#' @docType class
#' @title KeywordCreateItem
#' @description KeywordCreateItem Class
...
KeywordCreateItem <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new KeywordCreateItem class.
    #'
    ...
    #'
    #' @return KeywordCreateItem as a base R list.
    #' @examples
    #' # convert array of KeywordCreateItem (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert KeywordCreateItem to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      KeywordCreateItemObject <- list()
      if (!is.null(self$`bid`)) {
        KeywordCreateItemObject[["bid"]] <-
          self$`bid`
      }
      if (!is.null(self$`match_type`)) {
        KeywordCreateItemObject[["match_type"]] <-
          self$extractSimpleType(self$`match_type`)
      }
      if (!is.null(self$`value`)) {
        KeywordCreateItemObject[["value"]] <-
          self$`value`
      }
      return(KeywordCreateItemObject)
    },
    ...
    #' @description
    #' Deserialize JSON string into an instance of KeywordCreateItem
    #'
    #' @param input_json the JSON input
    #' @return the instance of KeywordCreateItem
    ...
    #' @return KeywordCreateItem in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to KeywordCreateItem and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`match_type`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for KeywordCreateItem: the required field `match_type` is missing."))
      }
      ...
      if (!is.null(input_json$`value`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for KeywordCreateItem: the required field `value` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of KeywordCreateItem
    toString = function() {
      self$toJSONString()
    },
...
# KeywordCreateItem$unlock()
#
## Below is an example to define the print function
# KeywordCreateItem$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# KeywordCreateItem$lock()
