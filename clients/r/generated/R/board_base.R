...
BoardBase <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new BoardBase class.
    #'
    #' @param id id
    ...
    initialize = function(`id`, `name`, `board_pins_modified_at` = NULL, `collaborator_count` = NULL, `created_at` = NULL, `description` = NULL, `follower_count` = NULL, `is_ads_only` = FALSE, `media` = NULL, `owner` = NULL, `pin_count` = NULL, ...) {
      if (!missing(`id`)) {
    ...
    #'
    #' @return BoardBase as a base R list.
    #' @examples
    #' # convert array of BoardBase (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert BoardBase to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      BoardBaseObject <- list()
      if (!is.null(self$`board_pins_modified_at`)) {
        BoardBaseObject[["board_pins_modified_at"]] <-
          self$`board_pins_modified_at`
      }
      if (!is.null(self$`collaborator_count`)) {
        BoardBaseObject[["collaborator_count"]] <-
          self$`collaborator_count`
      }
      if (!is.null(self$`created_at`)) {
        BoardBaseObject[["created_at"]] <-
          self$`created_at`
      }
      if (!is.null(self$`description`)) {
        BoardBaseObject[["description"]] <-
          self$`description`
      }
      if (!is.null(self$`follower_count`)) {
        BoardBaseObject[["follower_count"]] <-
          self$`follower_count`
      }
      if (!is.null(self$`id`)) {
        BoardBaseObject[["id"]] <-
      ...
      if (!is.null(self$`is_ads_only`)) {
        BoardBaseObject[["is_ads_only"]] <-
          self$`is_ads_only`
      }
      if (!is.null(self$`media`)) {
        BoardBaseObject[["media"]] <-
          self$extractSimpleType(self$`media`)
      }
      if (!is.null(self$`name`)) {
        BoardBaseObject[["name"]] <-
          self$`name`
      }
      if (!is.null(self$`owner`)) {
        BoardBaseObject[["owner"]] <-
          self$extractSimpleType(self$`owner`)
      }
      if (!is.null(self$`pin_count`)) {
        BoardBaseObject[["pin_count"]] <-
          self$`pin_count`
      }
      return(BoardBaseObject)
    },
    ...
    #' @description
    #' Deserialize JSON string into an instance of BoardBase
    #'
    #' @param input_json the JSON input
    #' @return the instance of BoardBase
    ...
    #' @return BoardBase in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to BoardBase and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for BoardBase: the required field `id` is missing."))
      }
      ...
      if (!is.null(input_json$`name`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for BoardBase: the required field `name` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of BoardBase
    toString = function() {
      self$toJSONString()
    },
...
# BoardBase$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
