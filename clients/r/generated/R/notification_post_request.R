#' @docType class
#' @title NotificationPostRequest
#'
#' @description NotificationPostRequest Class
#'
...
#' @export
NotificationPostRequest <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Deserialize JSON string into an instance of NotificationPostRequest.
    ...
    fromJSON = function(input) {
      ...
      `object_result` <- tryCatch({
          ...
          matched_schemas <- append(matched_schemas, "object")
          matched <- matched + 1
        },
        error = function(err) err
      )
    ...
    #' @description
    #' Serialize NotificationPostRequest to JSON string.
    #' 
    #' @param ... Parameters passed to `jsonlite::toJSON`
    #' @return JSON string representation of the NotificationPostRequest.
    ...
    #' @description
    #' Convert NotificationPostRequest to a base R type
    #'
    ...
    #' @description
    #' Validate the input JSON with respect to NotificationPostRequest and
...
#NotificationPostRequest$unlock()
#
## Below is an example to define the print function
#NotificationPostRequest$set("public", "print", function(...) {
#  print(jsonlite::prettify(self$toJSONString()))
#  invisible(self)
#})
## Uncomment below to lock the class to prevent modifications to the method or field
#NotificationPostRequest$lock()
