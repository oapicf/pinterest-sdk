...
DeleteInvitesResultsResponseArrayItemsInnerException <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return DeleteInvitesResultsResponseArrayItemsInnerException as a base R list.
    #' @examples
    #' # convert array of DeleteInvitesResultsResponseArrayItemsInnerException (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert DeleteInvitesResultsResponseArrayItemsInnerException to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(DeleteInvitesResultsResponseArrayItemsInnerExceptionObject)
    },
