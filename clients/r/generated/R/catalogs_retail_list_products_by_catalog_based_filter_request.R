...
CatalogsRetailListProductsByCatalogBasedFilterRequest <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return CatalogsRetailListProductsByCatalogBasedFilterRequest as a base R list.
    #' @examples
    #' # convert array of CatalogsRetailListProductsByCatalogBasedFilterRequest (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CatalogsRetailListProductsByCatalogBasedFilterRequest to a base R type
    #'
