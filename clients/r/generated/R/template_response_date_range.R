...
TemplateResponseDateRange <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return TemplateResponseDateRange as a base R list.
    #' @examples
    #' # convert array of TemplateResponseDateRange (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert TemplateResponseDateRange to a base R type
    #'
