...
CatalogsDeleteRetailItem <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return CatalogsDeleteRetailItem as a base R list.
    #' @examples
    #' # convert array of CatalogsDeleteRetailItem (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CatalogsDeleteRetailItem to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(CatalogsDeleteRetailItemObject)
    },
