  ...
  public = list(
    ...
    UpdateAdAccountToAdAccountSharedAudienceWithHttpInfo = function(ad_account_id, shared_audience, data_file = NULL, ...) {
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$DeserializeResponse(local_var_resp, "SharedAudienceResponse"),
          error = function(e) {
            stop("Failed to deserialize response")
          }
        )
    ...
    UpdateAdAccountToBusinessSharedAudienceWithHttpInfo = function(ad_account_id, business_shared_audience, data_file = NULL, ...) {
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$DeserializeResponse(local_var_resp, "BusinessSharedAudienceResponse"),
          error = function(e) {
            stop("Failed to deserialize response")
          }
        )
