...
#' @field CUSTOM_LABEL_3  \link{CatalogsProductGroupFilterOperatorTypeCriteria}
...
CustomLabel3Filter <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return CustomLabel3Filter as a base R list.
    #' @examples
    #' # convert array of CustomLabel3Filter (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CustomLabel3Filter to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      if (!is.null(self$`CUSTOM_LABEL_3`)) {
        CustomLabel3FilterObject[["CUSTOM_LABEL_3"]] <-
          self$extractSimpleType(self$`CUSTOM_LABEL_3`)
      }
      return(CustomLabel3FilterObject)
    },
    ...
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`CUSTOM_LABEL_3`)) {
        `custom_label_3_object` <- CatalogsProductGroupFilterOperatorTypeCriteria$new()
    ...
    fromJSONString = function(input_json) {
      this_object <- jsonlite::fromJSON(input_json)
      self$`CUSTOM_LABEL_3` <- CatalogsProductGroupFilterOperatorTypeCriteria$new()$fromJSON(jsonlite::toJSON(this_object$`CUSTOM_LABEL_3`, auto_unbox = TRUE, digits = NA))
      self
    },
