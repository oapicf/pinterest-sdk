...
CatalogsRetailItemsFilter <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return CatalogsRetailItemsFilter as a base R list.
    #' @examples
    #' # convert array of CatalogsRetailItemsFilter (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CatalogsRetailItemsFilter to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(CatalogsRetailItemsFilterObject)
    },
