#' Create a new AdvancedAuctionItemsSubmitDeleteRecord
#'
#' @description
#' Object describing an item bid option deletion operation
#'
#' @docType class
#' @title AdvancedAuctionItemsSubmitDeleteRecord
...
#' @export
AdvancedAuctionItemsSubmitDeleteRecord <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return AdvancedAuctionItemsSubmitDeleteRecord as a base R list.
    #' @examples
    #' # convert array of AdvancedAuctionItemsSubmitDeleteRecord (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert AdvancedAuctionItemsSubmitDeleteRecord to a base R type
    #'
    ...
    #' @description
    #' Deserialize JSON string into an instance of AdvancedAuctionItemsSubmitDeleteRecord
    #'
    #' @param input_json the JSON input
    #' @return the instance of AdvancedAuctionItemsSubmitDeleteRecord
    ...
    #' @return AdvancedAuctionItemsSubmitDeleteRecord in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to AdvancedAuctionItemsSubmitDeleteRecord and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`country`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for AdvancedAuctionItemsSubmitDeleteRecord: the required field `country` is missing."))
      }
      ...
      if (!is.null(input_json$`item_id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for AdvancedAuctionItemsSubmitDeleteRecord: the required field `item_id` is missing."))
      }
    ...
    #'
    #' @return String representation of AdvancedAuctionItemsSubmitDeleteRecord
    toString = function() {
      self$toJSONString()
    },
...
# AdvancedAuctionItemsSubmitDeleteRecord$unlock()
#
## Below is an example to define the print function
# AdvancedAuctionItemsSubmitDeleteRecord$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# AdvancedAuctionItemsSubmitDeleteRecord$lock()
