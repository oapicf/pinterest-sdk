#' Create a new PromotionResponse
#'
#' @description
...
#' @description PromotionResponse Class
...
#' @field ad_account_id The Ad Account ID that this promotion belongs to. character [optional]
#' @field id Promotion ID character [optional]
#' @field status  \link{EntityStatus} [optional]
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
PromotionResponse <- R6::R6Class(
  "PromotionResponse",
  public = list(
    ...
    #' @description
    #' Initialize a new PromotionResponse class.
    #'
    ...
    initialize = function(`discount_status` = NULL, `end_time` = NULL, `external_id` = NULL, `platform_type` = NULL, `promotion_code` = NULL, `promotion_custom_id` = NULL, `promotion_title` = NULL, `promotion_type` = NULL, `start_time` = NULL, `template_values` = NULL, `ad_account_id` = NULL, `id` = NULL, `status` = NULL, ...) {
    ...
    #'
    #' @return PromotionResponse as a base R list.
    #' @examples
    #' # convert array of PromotionResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert PromotionResponse to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      PromotionResponseObject <- list()
      if (!is.null(self$`discount_status`)) {
        PromotionResponseObject[["discount_status"]] <-
          self$`discount_status`
      }
      if (!is.null(self$`end_time`)) {
        PromotionResponseObject[["end_time"]] <-
          self$`end_time`
      }
      if (!is.null(self$`external_id`)) {
        PromotionResponseObject[["external_id"]] <-
          self$`external_id`
      }
      if (!is.null(self$`platform_type`)) {
        PromotionResponseObject[["platform_type"]] <-
          self$`platform_type`
      }
      if (!is.null(self$`promotion_code`)) {
        PromotionResponseObject[["promotion_code"]] <-
          self$`promotion_code`
      }
      if (!is.null(self$`promotion_custom_id`)) {
        PromotionResponseObject[["promotion_custom_id"]] <-
          self$`promotion_custom_id`
      }
      if (!is.null(self$`promotion_title`)) {
        PromotionResponseObject[["promotion_title"]] <-
          self$`promotion_title`
      }
      if (!is.null(self$`promotion_type`)) {
        PromotionResponseObject[["promotion_type"]] <-
          self$`promotion_type`$toSimpleType()
      }
      if (!is.null(self$`start_time`)) {
        PromotionResponseObject[["start_time"]] <-
          self$`start_time`
      }
      if (!is.null(self$`template_values`)) {
        PromotionResponseObject[["template_values"]] <-
          lapply(self$`template_values`, function(x) x$toSimpleType())
      }
      if (!is.null(self$`ad_account_id`)) {
        PromotionResponseObject[["ad_account_id"]] <-
          self$`ad_account_id`
      }
      if (!is.null(self$`id`)) {
        PromotionResponseObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`status`)) {
        PromotionResponseObject[["status"]] <-
    ...
    #' @description
    #' Deserialize JSON string into an instance of PromotionResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of PromotionResponse
    ...
    #' @return PromotionResponse in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to PromotionResponse and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of PromotionResponse
    toString = function() {
      self$toJSONString()
    },
...
# PromotionResponse$unlock()
#
## Below is an example to define the print function
# PromotionResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# PromotionResponse$lock()
