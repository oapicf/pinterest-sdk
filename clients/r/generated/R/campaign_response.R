...
CampaignResponse <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(`id` = NULL, `ad_account_id` = NULL, `name` = NULL, `status` = NULL, `lifetime_spend_cap` = NULL, `daily_spend_cap` = NULL, `order_line_id` = NULL, `tracking_urls` = NULL, `start_time` = NULL, `end_time` = NULL, `is_flexible_daily_budgets` = NULL, `objective_type` = NULL, `created_time` = NULL, `updated_time` = NULL, `type` = NULL, `is_campaign_budget_optimization` = NULL, `summary_status` = NULL, ...) {
      if (!is.null(`id`)) {
