...
TargetingTemplateCreate <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return TargetingTemplateCreate as a base R list.
    #' @examples
    #' # convert array of TargetingTemplateCreate (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert TargetingTemplateCreate to a base R type
    #'
