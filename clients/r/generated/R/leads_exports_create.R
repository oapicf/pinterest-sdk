#' Create a new LeadsExportsCreate
#'
#' @description
#' Resource create operation model.
#'
#' @docType class
#' @title LeadsExportsCreate
#' @description LeadsExportsCreate Class
...
LeadsExportsCreate <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new LeadsExportsCreate class.
    #'
    ...
    #'
    #' @return LeadsExportsCreate as a base R list.
    #' @examples
    #' # convert array of LeadsExportsCreate (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert LeadsExportsCreate to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      LeadsExportsCreateObject <- list()
      if (!is.null(self$`ad_id`)) {
        LeadsExportsCreateObject[["ad_id"]] <-
          self$`ad_id`
      }
      if (!is.null(self$`end_date`)) {
        LeadsExportsCreateObject[["end_date"]] <-
          self$`end_date`
      }
      if (!is.null(self$`start_date`)) {
        LeadsExportsCreateObject[["start_date"]] <-
          self$`start_date`
      }
      return(LeadsExportsCreateObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of LeadsExportsCreate
    #'
    #' @param input_json the JSON input
    #' @return the instance of LeadsExportsCreate
    ...
    #' @return LeadsExportsCreate in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to LeadsExportsCreate and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`ad_id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for LeadsExportsCreate: the required field `ad_id` is missing."))
      }
      ...
      if (!is.null(input_json$`end_date`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for LeadsExportsCreate: the required field `end_date` is missing."))
      }
      ...
      if (!is.null(input_json$`start_date`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for LeadsExportsCreate: the required field `start_date` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of LeadsExportsCreate
    toString = function() {
      self$toJSONString()
    },
...
# LeadsExportsCreate$unlock()
#
## Below is an example to define the print function
# LeadsExportsCreate$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# LeadsExportsCreate$lock()
