...
UpdatePartnerAssetAccessBodyAccessesInner <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return UpdatePartnerAssetAccessBodyAccessesInner as a base R list.
    #' @examples
    #' # convert array of UpdatePartnerAssetAccessBodyAccessesInner (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert UpdatePartnerAssetAccessBodyAccessesInner to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(UpdatePartnerAssetAccessBodyAccessesInnerObject)
    },
