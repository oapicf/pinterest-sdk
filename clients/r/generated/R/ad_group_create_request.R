#' Create a new AdGroupCreateRequest
#'
#' @description
#' AdGroupCreateRequest Class
#'
#' @docType class
#' @title AdGroupCreateRequest
#' @description AdGroupCreateRequest Class
...
#' @field auto_targeting_enabled Enable auto-targeting for ad group.Default value is True. Also known as <a href=\"https://help.pinterest.com/en/business/article/expanded-targeting\" target=\"_blank\">\"expanded targeting\"</a>. character [optional]
...
#' @export
AdGroupCreateRequest <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new AdGroupCreateRequest class.
    #'
    ...
    #' @param budget_type budget_type. Default to "DAILY".
    ...
    #' @param auto_targeting_enabled Enable auto-targeting for ad group.Default value is True. Also known as <a href=\"https://help.pinterest.com/en/business/article/expanded-targeting\" target=\"_blank\">\"expanded targeting\"</a>.
    #' @param placement_group <a href=\"/docs/redoc/#section/Placement-group\">Placement group</a>.
    #' @param pacing_delivery_type pacing_delivery_type. Default to "STANDARD".
    ...
    initialize = function(`name`, `campaign_id`, `billable_event`, `status` = NULL, `budget_in_micro_currency` = NULL, `bid_in_micro_currency` = NULL, `optimization_goal_metadata` = NULL, `budget_type` = "DAILY", `start_time` = NULL, `end_time` = NULL, `targeting_spec` = NULL, `lifetime_frequency_cap` = NULL, `tracking_urls` = NULL, `auto_targeting_enabled` = NULL, `placement_group` = NULL, `pacing_delivery_type` = "STANDARD", `bid_strategy_type` = NULL, `targeting_template_ids` = NULL, ...) {
      if (!missing(`name`)) {
    ...
    #'
    #' @return AdGroupCreateRequest as a base R list.
    #' @examples
    #' # convert array of AdGroupCreateRequest (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert AdGroupCreateRequest to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      AdGroupCreateRequestObject <- list()
      if (!is.null(self$`name`)) {
        AdGroupCreateRequestObject[["name"]] <-
          self$`name`
      }
      if (!is.null(self$`status`)) {
        AdGroupCreateRequestObject[["status"]] <-
          self$`status`$toSimpleType()
      }
      if (!is.null(self$`budget_in_micro_currency`)) {
        AdGroupCreateRequestObject[["budget_in_micro_currency"]] <-
          self$`budget_in_micro_currency`
      }
      if (!is.null(self$`bid_in_micro_currency`)) {
        AdGroupCreateRequestObject[["bid_in_micro_currency"]] <-
          self$`bid_in_micro_currency`
      }
      if (!is.null(self$`optimization_goal_metadata`)) {
        AdGroupCreateRequestObject[["optimization_goal_metadata"]] <-
          self$`optimization_goal_metadata`$toSimpleType()
      }
      if (!is.null(self$`budget_type`)) {
        AdGroupCreateRequestObject[["budget_type"]] <-
          self$`budget_type`$toSimpleType()
      }
      if (!is.null(self$`start_time`)) {
        AdGroupCreateRequestObject[["start_time"]] <-
          self$`start_time`
      }
      if (!is.null(self$`end_time`)) {
        AdGroupCreateRequestObject[["end_time"]] <-
          self$`end_time`
      }
      if (!is.null(self$`targeting_spec`)) {
        AdGroupCreateRequestObject[["targeting_spec"]] <-
          self$`targeting_spec`$toSimpleType()
      }
      if (!is.null(self$`lifetime_frequency_cap`)) {
        AdGroupCreateRequestObject[["lifetime_frequency_cap"]] <-
          self$`lifetime_frequency_cap`
      }
      if (!is.null(self$`tracking_urls`)) {
        AdGroupCreateRequestObject[["tracking_urls"]] <-
          self$`tracking_urls`$toSimpleType()
      }
      if (!is.null(self$`auto_targeting_enabled`)) {
        AdGroupCreateRequestObject[["auto_targeting_enabled"]] <-
          self$`auto_targeting_enabled`
      }
      if (!is.null(self$`placement_group`)) {
        AdGroupCreateRequestObject[["placement_group"]] <-
          self$`placement_group`$toSimpleType()
      }
      if (!is.null(self$`pacing_delivery_type`)) {
        AdGroupCreateRequestObject[["pacing_delivery_type"]] <-
          self$`pacing_delivery_type`$toSimpleType()
      }
      if (!is.null(self$`campaign_id`)) {
        AdGroupCreateRequestObject[["campaign_id"]] <-
          self$`campaign_id`
      }
      if (!is.null(self$`billable_event`)) {
        AdGroupCreateRequestObject[["billable_event"]] <-
          self$`billable_event`$toSimpleType()
      }
      if (!is.null(self$`bid_strategy_type`)) {
        AdGroupCreateRequestObject[["bid_strategy_type"]] <-
          self$`bid_strategy_type`
      }
      if (!is.null(self$`targeting_template_ids`)) {
        AdGroupCreateRequestObject[["targeting_template_ids"]] <-
          self$`targeting_template_ids`
      }
      return(AdGroupCreateRequestObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of AdGroupCreateRequest
    #'
    #' @param input_json the JSON input
    #' @return the instance of AdGroupCreateRequest
    ...
    #' @return AdGroupCreateRequest in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to AdGroupCreateRequest and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`name`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for AdGroupCreateRequest: the required field `name` is missing."))
      }
      ...
      if (!is.null(input_json$`campaign_id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for AdGroupCreateRequest: the required field `campaign_id` is missing."))
      }
      # check the required field `billable_event`
      if (!is.null(input_json$`billable_event`)) {
        stopifnot(R6::is.R6(input_json$`billable_event`))
      } else {
        stop(paste("The JSON input `", input, "` is invalid for AdGroupCreateRequest: the required field `billable_event` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of AdGroupCreateRequest
    toString = function() {
      self$toJSONString()
    },
...
# AdGroupCreateRequest$unlock()
#
## Below is an example to define the print function
# AdGroupCreateRequest$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# AdGroupCreateRequest$lock()
