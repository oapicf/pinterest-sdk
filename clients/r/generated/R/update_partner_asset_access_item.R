#' Create a new UpdatePartnerAssetAccessItem
#'
#' @description
#' UpdatePartnerAssetAccessItem Class
#'
#' @docType class
#' @title UpdatePartnerAssetAccessItem
#' @description UpdatePartnerAssetAccessItem Class
...
#' @export
UpdatePartnerAssetAccessItem <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new UpdatePartnerAssetAccessItem class.
    #'
    ...
    initialize = function(`asset_id`, `partner_id`, `permissions`, ...) {
      if (!missing(`asset_id`)) {
    ...
    #'
    #' @return UpdatePartnerAssetAccessItem as a base R list.
    #' @examples
    #' # convert array of UpdatePartnerAssetAccessItem (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert UpdatePartnerAssetAccessItem to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      UpdatePartnerAssetAccessItemObject <- list()
      if (!is.null(self$`asset_id`)) {
        UpdatePartnerAssetAccessItemObject[["asset_id"]] <-
          self$`asset_id`
      }
      if (!is.null(self$`partner_id`)) {
        UpdatePartnerAssetAccessItemObject[["partner_id"]] <-
          self$`partner_id`
      }
      if (!is.null(self$`permissions`)) {
        UpdatePartnerAssetAccessItemObject[["permissions"]] <-
          self$extractSimpleType(self$`permissions`)
      }
      return(UpdatePartnerAssetAccessItemObject)
    },
    ...
    #' @description
    #' Deserialize JSON string into an instance of UpdatePartnerAssetAccessItem
    #'
    #' @param input_json the JSON input
    #' @return the instance of UpdatePartnerAssetAccessItem
    ...
    #' @return UpdatePartnerAssetAccessItem in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to UpdatePartnerAssetAccessItem and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`asset_id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for UpdatePartnerAssetAccessItem: the required field `asset_id` is missing."))
      }
      ...
      if (!is.null(input_json$`partner_id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for UpdatePartnerAssetAccessItem: the required field `partner_id` is missing."))
      }
      ...
      if (!is.null(input_json$`permissions`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for UpdatePartnerAssetAccessItem: the required field `permissions` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of UpdatePartnerAssetAccessItem
    toString = function() {
      self$toJSONString()
    },
...
# UpdatePartnerAssetAccessItem$unlock()
#
## Below is an example to define the print function
# UpdatePartnerAssetAccessItem$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# UpdatePartnerAssetAccessItem$lock()
