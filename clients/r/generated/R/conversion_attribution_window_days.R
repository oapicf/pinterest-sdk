...
ConversionAttributionWindowDays <- R6::R6Class(
    ...
    public = list(
        ...
        fromJSON = function(ConversionAttributionWindowDaysJson) {
            private$value <- jsonlite::fromJSON(ConversionAttributionWindowDaysJson,
        ...
        fromJSONString = function(ConversionAttributionWindowDaysJson) {
            private$value <- jsonlite::fromJSON(ConversionAttributionWindowDaysJson,
                simplifyVector = FALSE)
            self
        }
