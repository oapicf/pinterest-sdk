#' Create a new BusinessToAdAccountSharedAudienceUpdateWithRequiredBody
#'
#' @description
#' Resource create or update operation model with required body fields (no OptionalProperties).
#'
#' @docType class
#' @title BusinessToAdAccountSharedAudienceUpdateWithRequiredBody
#' @description BusinessToAdAccountSharedAudienceUpdateWithRequiredBody Class
...
#' @export
BusinessToAdAccountSharedAudienceUpdateWithRequiredBody <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new BusinessToAdAccountSharedAudienceUpdateWithRequiredBody class.
    #'
    ...
    #'
    #' @return BusinessToAdAccountSharedAudienceUpdateWithRequiredBody as a base R list.
    #' @examples
    #' # convert array of BusinessToAdAccountSharedAudienceUpdateWithRequiredBody (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert BusinessToAdAccountSharedAudienceUpdateWithRequiredBody to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      BusinessToAdAccountSharedAudienceUpdateWithRequiredBodyObject <- list()
      if (!is.null(self$`audience_id`)) {
        BusinessToAdAccountSharedAudienceUpdateWithRequiredBodyObject[["audience_id"]] <-
          self$`audience_id`
      }
      if (!is.null(self$`operation_type`)) {
        BusinessToAdAccountSharedAudienceUpdateWithRequiredBodyObject[["operation_type"]] <-
          self$extractSimpleType(self$`operation_type`)
      }
      if (!is.null(self$`recipient_account_ids`)) {
        BusinessToAdAccountSharedAudienceUpdateWithRequiredBodyObject[["recipient_account_ids"]] <-
          self$`recipient_account_ids`
      }
      return(BusinessToAdAccountSharedAudienceUpdateWithRequiredBodyObject)
    },
    ...
    #' @description
    #' Deserialize JSON string into an instance of BusinessToAdAccountSharedAudienceUpdateWithRequiredBody
    #'
    #' @param input_json the JSON input
    #' @return the instance of BusinessToAdAccountSharedAudienceUpdateWithRequiredBody
    ...
    #' @return BusinessToAdAccountSharedAudienceUpdateWithRequiredBody in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to BusinessToAdAccountSharedAudienceUpdateWithRequiredBody and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`audience_id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for BusinessToAdAccountSharedAudienceUpdateWithRequiredBody: the required field `audience_id` is missing."))
      }
      # check the required field `operation_type`
      if (!is.null(input_json$`operation_type`)) {
        stopifnot(R6::is.R6(input_json$`operation_type`))
      } else {
        stop(paste("The JSON input `", input, "` is invalid for BusinessToAdAccountSharedAudienceUpdateWithRequiredBody: the required field `operation_type` is missing."))
      }
      ...
      if (!is.null(input_json$`recipient_account_ids`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for BusinessToAdAccountSharedAudienceUpdateWithRequiredBody: the required field `recipient_account_ids` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of BusinessToAdAccountSharedAudienceUpdateWithRequiredBody
    toString = function() {
      self$toJSONString()
    },
...
# BusinessToAdAccountSharedAudienceUpdateWithRequiredBody$unlock()
#
## Below is an example to define the print function
# BusinessToAdAccountSharedAudienceUpdateWithRequiredBody$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# BusinessToAdAccountSharedAudienceUpdateWithRequiredBody$lock()
