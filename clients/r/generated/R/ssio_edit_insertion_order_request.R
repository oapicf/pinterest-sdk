...
SSIOEditInsertionOrderRequest <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(`agency_link` = NULL, `billing_contact_email` = NULL, `billing_contact_firstname` = NULL, `billing_contact_lastname` = NULL, `budget_amount` = NULL, `end_date` = NULL, `media_contact_email` = NULL, `media_contact_firstname` = NULL, `media_contact_lastname` = NULL, `po_number` = NULL, `start_date` = NULL, `user_email` = NULL, `ads_manager_order_line_id` = NULL, `oracle_line_id` = NULL, `salesforce_order_id` = NULL, `salesforce_order_line_id` = NULL, ...) {
