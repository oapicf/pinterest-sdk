...
#' @description ScheduleCreate Class
...
#' @field entity_id entity ID. character
...
ScheduleCreate <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new ScheduleCreate class.
    #'
    ...
    initialize = function(`entity_id`, `delta_value` = NULL, `end_timestamp` = NULL, `entity_type` = NULL, `name` = NULL, `schedule_action` = NULL, `schedule_status` = NULL, `schedule_type` = NULL, `start_timestamp` = NULL, ...) {
    ...
    #'
    #' @return ScheduleCreate as a base R list.
    #' @examples
    #' # convert array of ScheduleCreate (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Deserialize JSON string into an instance of ScheduleCreate
    #'
    #' @param input_json the JSON input
    #' @return the instance of ScheduleCreate
    ...
    #' @return ScheduleCreate in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to ScheduleCreate and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`entity_id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ScheduleCreate: the required field `entity_id` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of ScheduleCreate
    toString = function() {
      self$toJSONString()
    },
...
# ScheduleCreate$unlock()
#
## Below is an example to define the print function
# ScheduleCreate$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
