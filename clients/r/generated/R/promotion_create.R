...
#' @description PromotionCreate Class
...
PromotionCreate <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new PromotionCreate class.
    #'
    ...
    #'
    #' @return PromotionCreate as a base R list.
    #' @examples
    #' # convert array of PromotionCreate (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Deserialize JSON string into an instance of PromotionCreate
    #'
    #' @param input_json the JSON input
    #' @return the instance of PromotionCreate
    ...
    #' @return PromotionCreate in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to PromotionCreate and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`promotion_title`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for PromotionCreate: the required field `promotion_title` is missing."))
      }
      # check the required field `promotion_type`
      if (!is.null(input_json$`promotion_type`)) {
        stopifnot(R6::is.R6(input_json$`promotion_type`))
      } else {
        stop(paste("The JSON input `", input, "` is invalid for PromotionCreate: the required field `promotion_type` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of PromotionCreate
    toString = function() {
      self$toJSONString()
    },
...
# PromotionCreate$unlock()
#
## Below is an example to define the print function
# PromotionCreate$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# PromotionCreate$lock()
