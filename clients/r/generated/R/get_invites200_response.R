#' Create a new GetInvites200Response
#'
#' @description
...
GetInvites200Response <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return GetInvites200Response as a base R list.
    #' @examples
    #' # convert array of GetInvites200Response (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert GetInvites200Response to a base R type
    #'
    ...
    #' @description
    #' Deserialize JSON string into an instance of GetInvites200Response
    #'
    ...
    #' @return GetInvites200Response in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to GetInvites200Response and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`items`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for GetInvites200Response: the required field `items` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of GetInvites200Response
    toString = function() {
      self$toJSONString()
    },
...
# GetInvites200Response$unlock()
#
## Below is an example to define the print function
# GetInvites200Response$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# GetInvites200Response$lock()
