...
TemplateResponseDateRangeRelativeDateRange <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return TemplateResponseDateRangeRelativeDateRange as a base R list.
    #' @examples
    #' # convert array of TemplateResponseDateRangeRelativeDateRange (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert TemplateResponseDateRangeRelativeDateRange to a base R type
    #'
