#' Create a new BusinessMemberAssetsGet200Response
#'
#' @description
...
BusinessMemberAssetsGet200Response <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return BusinessMemberAssetsGet200Response as a base R list.
    #' @examples
    #' # convert array of BusinessMemberAssetsGet200Response (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert BusinessMemberAssetsGet200Response to a base R type
    #'
    ...
    #' @description
    #' Deserialize JSON string into an instance of BusinessMemberAssetsGet200Response
    #'
    ...
    #' @return BusinessMemberAssetsGet200Response in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to BusinessMemberAssetsGet200Response and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`items`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for BusinessMemberAssetsGet200Response: the required field `items` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of BusinessMemberAssetsGet200Response
    toString = function() {
      self$toJSONString()
    },
...
# BusinessMemberAssetsGet200Response$unlock()
#
## Below is an example to define the print function
# BusinessMemberAssetsGet200Response$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# BusinessMemberAssetsGet200Response$lock()
