...
CatalogsReportFeedIngestionStats <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return CatalogsReportFeedIngestionStats as a base R list.
    #' @examples
    #' # convert array of CatalogsReportFeedIngestionStats (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CatalogsReportFeedIngestionStats to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(CatalogsReportFeedIngestionStatsObject)
    },
