  ...
  public = list(
    ...
    AudienceInsightsGetWithHttpInfo = function(ad_account_id, audience_insight_type, data_file = NULL, ...) {
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$DeserializeResponse(local_var_resp, "AudienceInsightsResponse"),
          error = function(e) {
    ...
    AudienceInsightsScopeAndTypeGetWithHttpInfo = function(ad_account_id, data_file = NULL, ...) {
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$DeserializeResponse(local_var_resp, "AudienceDefinitionResponse"),
          error = function(e) {
            stop("Failed to deserialize response")
          }
        )
