...
AdUpdateRequest <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(`id`, `ad_group_id` = NULL, `android_deep_link` = NULL, `carousel_android_deep_links` = NULL, `carousel_destination_urls` = NULL, `carousel_ios_deep_links` = NULL, `click_tracking_url` = NULL, `creative_type` = NULL, `destination_url` = NULL, `ios_deep_link` = NULL, `is_pin_deleted` = NULL, `is_removable` = NULL, `name` = NULL, `status` = NULL, `tracking_urls` = NULL, `view_tracking_url` = NULL, `lead_form_id` = NULL, `grid_click_type` = NULL, `customizable_cta_type` = NULL, `quiz_pin_data` = NULL, `pin_id` = NULL, ...) {
      if (!missing(`id`)) {
    ...
    #'
    #' @return AdUpdateRequest as a base R list.
    #' @examples
    #' # convert array of AdUpdateRequest (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert AdUpdateRequest to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      if (!is.null(self$`is_removable`)) {
        AdUpdateRequestObject[["is_removable"]] <-
          self$`is_removable`
      }
      if (!is.null(self$`name`)) {
        AdUpdateRequestObject[["name"]] <-
          self$`name`
      }
      ...
      if (!is.null(self$`lead_form_id`)) {
        AdUpdateRequestObject[["lead_form_id"]] <-
          self$`lead_form_id`
      }
    ...
    #' @description
    #' Deserialize JSON string into an instance of AdUpdateRequest
    #'
    ...
    #' @return AdUpdateRequest in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to AdUpdateRequest and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for AdUpdateRequest: the required field `id` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of AdUpdateRequest
    toString = function() {
      self$toJSONString()
    },
...
# AdUpdateRequest$unlock()
#
## Below is an example to define the print function
# AdUpdateRequest$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# AdUpdateRequest$lock()
