#' Create a new ConversionAccessToken
#'
#' @description
#' A successful conversion access token response.
#'
#' @docType class
#' @title ConversionAccessToken
#' @description ConversionAccessToken Class
...
#' @export
ConversionAccessToken <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new ConversionAccessToken class.
    #'
    ...
    #'
    #' @return ConversionAccessToken as a base R list.
    #' @examples
    #' # convert array of ConversionAccessToken (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ConversionAccessToken to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      ConversionAccessTokenObject <- list()
      if (!is.null(self$`access_token`)) {
        ConversionAccessTokenObject[["access_token"]] <-
          self$`access_token`
      }
      if (!is.null(self$`token_type`)) {
        ConversionAccessTokenObject[["token_type"]] <-
          self$`token_type`
      }
      return(ConversionAccessTokenObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of ConversionAccessToken
    #'
    #' @param input_json the JSON input
    #' @return the instance of ConversionAccessToken
    ...
    #' @return ConversionAccessToken in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to ConversionAccessToken and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`access_token`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ConversionAccessToken: the required field `access_token` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of ConversionAccessToken
    toString = function() {
      self$toJSONString()
    },
...
# ConversionAccessToken$unlock()
#
## Below is an example to define the print function
# ConversionAccessToken$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# ConversionAccessToken$lock()
