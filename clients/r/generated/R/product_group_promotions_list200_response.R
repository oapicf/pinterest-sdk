#' Create a new ProductGroupPromotionsList200Response
#'
#' @description
...
ProductGroupPromotionsList200Response <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return ProductGroupPromotionsList200Response as a base R list.
    #' @examples
    #' # convert array of ProductGroupPromotionsList200Response (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ProductGroupPromotionsList200Response to a base R type
    #'
    ...
    #' @description
    #' Deserialize JSON string into an instance of ProductGroupPromotionsList200Response
    #'
    ...
    #' @return ProductGroupPromotionsList200Response in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to ProductGroupPromotionsList200Response and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`items`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ProductGroupPromotionsList200Response: the required field `items` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of ProductGroupPromotionsList200Response
    toString = function() {
      self$toJSONString()
    },
...
# ProductGroupPromotionsList200Response$unlock()
#
## Below is an example to define the print function
# ProductGroupPromotionsList200Response$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# ProductGroupPromotionsList200Response$lock()
