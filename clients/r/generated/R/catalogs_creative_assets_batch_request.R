#' Create a new CatalogsCreativeAssetsBatchRequest
#'
#' @description
...
CatalogsCreativeAssetsBatchRequest <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Deserialize JSON string into an instance of CatalogsCreativeAssetsBatchRequest
    #'
...
',
    ...
    #' @description
    #' Validate JSON input with respect to CatalogsCreativeAssetsBatchRequest and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`catalog_type`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for CatalogsCreativeAssetsBatchRequest: the required field `catalog_type` is missing."))
      }
    ...
    #'
    #' @return String representation of CatalogsCreativeAssetsBatchRequest
    toString = function() {
      self$toJSONString()
    },
...
# CatalogsCreativeAssetsBatchRequest$unlock()
#
## Below is an example to define the print function
# CatalogsCreativeAssetsBatchRequest$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# CatalogsCreativeAssetsBatchRequest$lock()
