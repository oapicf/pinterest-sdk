#' @docType class
#' @title ItemResponseOneOf
#'
#' @description ItemResponseOneOf Class
#'
...
ItemResponseOneOf <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new ItemResponseOneOf.
    #'
    ...
    initialize = function(instance = NULL) {
      if (is.null(instance)) {
        ...
        stop(paste("Failed to initialize ItemResponseOneOf with oneOf schemas CatalogsCreativeAssetsItemResponse, CatalogsHotelItemResponse, CatalogsRetailItemResponse. Provided class name: ",
                   get(class(instance)[[1]], pos = -1)$classname))
      }
    },

    #' @description
    #' Deserialize JSON string into an instance of ItemResponseOneOf.
    #' An alias to the method `fromJSON` .
    #'
    #' @param input The input JSON.
    #'
    #' @return An instance of ItemResponseOneOf.
    ...
    fromJSON = function(input) {
      ...
      if (matched == 1) {
        ...
        # more than 1 match
        stop(paste("Multiple matches found when deserializing the input into ItemResponseOneOf with oneOf schemas CatalogsCreativeAssetsItemResponse, CatalogsHotelItemResponse, CatalogsRetailItemResponse. Matched schemas: ",
                   paste(matched_schemas, collapse = ", ")))
      } else {
        # no match
        stop(paste("No match found when deserializing the input into ItemResponseOneOf with oneOf schemas CatalogsCreativeAssetsItemResponse, CatalogsHotelItemResponse, CatalogsRetailItemResponse. Details: >>",
    ...
    #' @description
    #' Serialize ItemResponseOneOf to JSON string.
    #' 
    #' @param ... Parameters passed to `jsonlite::toJSON`
    #' @return JSON string representation of the ItemResponseOneOf.
    ...
    #' @description
    #' Convert ItemResponseOneOf to a base R type
    #'
    ...
    #' @description
    #' Validate the input JSON with respect to ItemResponseOneOf and
...
#ItemResponseOneOf$unlock()
#
## Below is an example to define the print function
#ItemResponseOneOf$set("public", "print", function(...) {
#  print(jsonlite::prettify(self$toJSONString()))
#  invisible(self)
#})
## Uncomment below to lock the class to prevent modifications to the method or field
#ItemResponseOneOf$lock()
