...
ConversionEventResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return ConversionEventResponse as a base R list.
    #' @examples
    #' # convert array of ConversionEventResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ConversionEventResponse to a base R type
    #'
