...
#' @field AD_IMAGE_0_LINK_DUPLICATED ad_image_0_link is duplicated with another ad image link. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_0_LINK_LENGTH_TOO_LONG Ad image link 0 length is too long. The maximum length is 2047 characters. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_0_LINK_REQUIRED Ad image link 0 is required because an image tag was provided. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_0_LINK_WARNING Ad image link 0 format is unsupported. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_0_TAG_DUPLICATED ad_image_0_tag is duplicated with another ad image tag. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_0_TAG_LENGTH_TOO_LONG Ad image tag 0 length is too long. The maximum length is 511 characters. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_0_TAG_REQUIRED Ad image tag 0 is required because an image link was provided. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_10_LINK_DUPLICATED ad_image_10_link is duplicated with another ad image link. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_10_LINK_LENGTH_TOO_LONG Ad image link 10 length is too long. The maximum length is 2047 characters. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_10_LINK_REQUIRED Ad image link 10 is required because an image tag was provided. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_10_LINK_WARNING Ad image link 10 format is unsupported. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_10_TAG_DUPLICATED ad_image_10_tag is duplicated with another ad image tag. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_10_TAG_LENGTH_TOO_LONG Ad image tag 10 length is too long. The maximum length is 511 characters. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_10_TAG_REQUIRED Ad image tag 10 is required because an image link was provided. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_11_LINK_DUPLICATED ad_image_11_link is duplicated with another ad image link. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_11_LINK_LENGTH_TOO_LONG Ad image link 11 length is too long. The maximum length is 2047 characters. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_11_LINK_REQUIRED Ad image link 11 is required because an image tag was provided. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_11_LINK_WARNING Ad image link 11 format is unsupported. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_11_TAG_DUPLICATED ad_image_11_tag is duplicated with another ad image tag. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_11_TAG_LENGTH_TOO_LONG Ad image tag 11 length is too long. The maximum length is 511 characters. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_11_TAG_REQUIRED Ad image tag 11 is required because an image link was provided. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_12_LINK_DUPLICATED ad_image_12_link is duplicated with another ad image link. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_12_LINK_LENGTH_TOO_LONG Ad image link 12 length is too long. The maximum length is 2047 characters. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_12_LINK_REQUIRED Ad image link 12 is required because an image tag was provided. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_12_LINK_WARNING Ad image link 12 format is unsupported. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_12_TAG_DUPLICATED ad_image_12_tag is duplicated with another ad image tag. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_12_TAG_LENGTH_TOO_LONG Ad image tag 12 length is too long. The maximum length is 511 characters. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_12_TAG_REQUIRED Ad image tag 12 is required because an image link was provided. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_13_LINK_DUPLICATED ad_image_13_link is duplicated with another ad image link. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_13_LINK_LENGTH_TOO_LONG Ad image link 13 length is too long. The maximum length is 2047 characters. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_13_LINK_REQUIRED Ad image link 13 is required because an image tag was provided. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_13_LINK_WARNING Ad image link 13 format is unsupported. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_13_TAG_DUPLICATED ad_image_13_tag is duplicated with another ad image tag. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_13_TAG_LENGTH_TOO_LONG Ad image tag 13 length is too long. The maximum length is 511 characters. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_13_TAG_REQUIRED Ad image tag 13 is required because an image link was provided. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_14_LINK_DUPLICATED ad_image_14_link is duplicated with another ad image link. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_14_LINK_LENGTH_TOO_LONG Ad image link 14 length is too long. The maximum length is 2047 characters. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_14_LINK_REQUIRED Ad image link 14 is required because an image tag was provided. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_14_LINK_WARNING Ad image link 14 format is unsupported. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_14_TAG_DUPLICATED ad_image_14_tag is duplicated with another ad image tag. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_14_TAG_LENGTH_TOO_LONG Ad image tag 14 length is too long. The maximum length is 511 characters. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_14_TAG_REQUIRED Ad image tag 14 is required because an image link was provided. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_15_LINK_DUPLICATED ad_image_15_link is duplicated with another ad image link. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_15_LINK_LENGTH_TOO_LONG Ad image link 15 length is too long. The maximum length is 2047 characters. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_15_LINK_REQUIRED Ad image link 15 is required because an image tag was provided. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_15_LINK_WARNING Ad image link 15 format is unsupported. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_15_TAG_DUPLICATED ad_image_15_tag is duplicated with another ad image tag. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_15_TAG_LENGTH_TOO_LONG Ad image tag 15 length is too long. The maximum length is 511 characters. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_15_TAG_REQUIRED Ad image tag 15 is required because an image link was provided. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_16_LINK_DUPLICATED ad_image_16_link is duplicated with another ad image link. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_16_LINK_LENGTH_TOO_LONG Ad image link 16 length is too long. The maximum length is 2047 characters. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_16_LINK_REQUIRED Ad image link 16 is required because an image tag was provided. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_16_LINK_WARNING Ad image link 16 format is unsupported. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_16_TAG_DUPLICATED ad_image_16_tag is duplicated with another ad image tag. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_16_TAG_LENGTH_TOO_LONG Ad image tag 16 length is too long. The maximum length is 511 characters. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_16_TAG_REQUIRED Ad image tag 16 is required because an image link was provided. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_17_LINK_DUPLICATED ad_image_17_link is duplicated with another ad image link. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_17_LINK_LENGTH_TOO_LONG Ad image link 17 length is too long. The maximum length is 2047 characters. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_17_LINK_REQUIRED Ad image link 17 is required because an image tag was provided. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_17_LINK_WARNING Ad image link 17 format is unsupported. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_17_TAG_DUPLICATED ad_image_17_tag is duplicated with another ad image tag. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_17_TAG_LENGTH_TOO_LONG Ad image tag 17 length is too long. The maximum length is 511 characters. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_17_TAG_REQUIRED Ad image tag 17 is required because an image link was provided. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_18_LINK_DUPLICATED ad_image_18_link is duplicated with another ad image link. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_18_LINK_LENGTH_TOO_LONG Ad image link 18 length is too long. The maximum length is 2047 characters. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_18_LINK_REQUIRED Ad image link 18 is required because an image tag was provided. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_18_LINK_WARNING Ad image link 18 format is unsupported. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_18_TAG_DUPLICATED ad_image_18_tag is duplicated with another ad image tag. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_18_TAG_LENGTH_TOO_LONG Ad image tag 18 length is too long. The maximum length is 511 characters. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_18_TAG_REQUIRED Ad image tag 18 is required because an image link was provided. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_19_LINK_DUPLICATED ad_image_19_link is duplicated with another ad image link. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_19_LINK_LENGTH_TOO_LONG Ad image link 19 length is too long. The maximum length is 2047 characters. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_19_LINK_REQUIRED Ad image link 19 is required because an image tag was provided. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_19_LINK_WARNING Ad image link 19 format is unsupported. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_19_TAG_DUPLICATED ad_image_19_tag is duplicated with another ad image tag. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_19_TAG_LENGTH_TOO_LONG Ad image tag 19 length is too long. The maximum length is 511 characters. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_19_TAG_REQUIRED Ad image tag 19 is required because an image link was provided. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_1_LINK_DUPLICATED ad_image_1_link is duplicated with another ad image link. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_1_LINK_LENGTH_TOO_LONG Ad image link 1 length is too long. The maximum length is 2047 characters. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_1_LINK_REQUIRED Ad image link 1 is required because an image tag was provided. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_1_LINK_WARNING Ad image link 1 format is unsupported. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_1_TAG_DUPLICATED ad_image_1_tag is duplicated with another ad image tag. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_1_TAG_LENGTH_TOO_LONG Ad image tag 1 length is too long. The maximum length is 511 characters. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_1_TAG_REQUIRED Ad image tag 1 is required because an image link was provided. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_2_LINK_DUPLICATED ad_image_2_link is duplicated with another ad image link. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_2_LINK_LENGTH_TOO_LONG Ad image link 2 length is too long. The maximum length is 2047 characters. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_2_LINK_REQUIRED Ad image link 2 is required because an image tag was provided. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_2_LINK_WARNING Ad image link 2 format is unsupported. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_2_TAG_DUPLICATED ad_image_2_tag is duplicated with another ad image tag. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_2_TAG_LENGTH_TOO_LONG Ad image tag 2 length is too long. The maximum length is 511 characters. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_2_TAG_REQUIRED Ad image tag 2 is required because an image link was provided. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_3_LINK_DUPLICATED ad_image_3_link is duplicated with another ad image link. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_3_LINK_LENGTH_TOO_LONG Ad image link 3 length is too long. The maximum length is 2047 characters. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_3_LINK_REQUIRED Ad image link 3 is required because an image tag was provided. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_3_LINK_WARNING Ad image link 3 format is unsupported. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_3_TAG_DUPLICATED ad_image_3_tag is duplicated with another ad image tag. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_3_TAG_LENGTH_TOO_LONG Ad image tag 3 length is too long. The maximum length is 511 characters. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_3_TAG_REQUIRED Ad image tag 3 is required because an image link was provided. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_4_LINK_DUPLICATED ad_image_4_link is duplicated with another ad image link. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_4_LINK_LENGTH_TOO_LONG Ad image link 4 length is too long. The maximum length is 2047 characters. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_4_LINK_REQUIRED Ad image link 4 is required because an image tag was provided. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_4_LINK_WARNING Ad image link 4 format is unsupported. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_4_TAG_DUPLICATED ad_image_4_tag is duplicated with another ad image tag. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_4_TAG_LENGTH_TOO_LONG Ad image tag 4 length is too long. The maximum length is 511 characters. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_4_TAG_REQUIRED Ad image tag 4 is required because an image link was provided. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_5_LINK_DUPLICATED ad_image_5_link is duplicated with another ad image link. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_5_LINK_LENGTH_TOO_LONG Ad image link 5 length is too long. The maximum length is 2047 characters. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_5_LINK_REQUIRED Ad image link 5 is required because an image tag was provided. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_5_LINK_WARNING Ad image link 5 format is unsupported. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_5_TAG_DUPLICATED ad_image_5_tag is duplicated with another ad image tag. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_5_TAG_LENGTH_TOO_LONG Ad image tag 5 length is too long. The maximum length is 511 characters. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_5_TAG_REQUIRED Ad image tag 5 is required because an image link was provided. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_6_LINK_DUPLICATED ad_image_6_link is duplicated with another ad image link. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_6_LINK_LENGTH_TOO_LONG Ad image link 6 length is too long. The maximum length is 2047 characters. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_6_LINK_REQUIRED Ad image link 6 is required because an image tag was provided. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_6_LINK_WARNING Ad image link 6 format is unsupported. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_6_TAG_DUPLICATED ad_image_6_tag is duplicated with another ad image tag. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_6_TAG_LENGTH_TOO_LONG Ad image tag 6 length is too long. The maximum length is 511 characters. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_6_TAG_REQUIRED Ad image tag 6 is required because an image link was provided. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_7_LINK_DUPLICATED ad_image_7_link is duplicated with another ad image link. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_7_LINK_LENGTH_TOO_LONG Ad image link 7 length is too long. The maximum length is 2047 characters. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_7_LINK_REQUIRED Ad image link 7 is required because an image tag was provided. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_7_LINK_WARNING Ad image link 7 format is unsupported. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_7_TAG_DUPLICATED ad_image_7_tag is duplicated with another ad image tag. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_7_TAG_LENGTH_TOO_LONG Ad image tag 7 length is too long. The maximum length is 511 characters. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_7_TAG_REQUIRED Ad image tag 7 is required because an image link was provided. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_8_LINK_DUPLICATED ad_image_8_link is duplicated with another ad image link. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_8_LINK_LENGTH_TOO_LONG Ad image link 8 length is too long. The maximum length is 2047 characters. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_8_LINK_REQUIRED Ad image link 8 is required because an image tag was provided. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_8_LINK_WARNING Ad image link 8 format is unsupported. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_8_TAG_DUPLICATED ad_image_8_tag is duplicated with another ad image tag. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_8_TAG_LENGTH_TOO_LONG Ad image tag 8 length is too long. The maximum length is 511 characters. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_8_TAG_REQUIRED Ad image tag 8 is required because an image link was provided. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_9_LINK_DUPLICATED ad_image_9_link is duplicated with another ad image link. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_9_LINK_LENGTH_TOO_LONG Ad image link 9 length is too long. The maximum length is 2047 characters. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_9_LINK_REQUIRED Ad image link 9 is required because an image tag was provided. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_9_LINK_WARNING Ad image link 9 format is unsupported. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_9_TAG_DUPLICATED ad_image_9_tag is duplicated with another ad image tag. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_9_TAG_LENGTH_TOO_LONG Ad image tag 9 length is too long. The maximum length is 511 characters. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_IMAGE_9_TAG_REQUIRED Ad image tag 9 is required because an image link was provided. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_LINK_FORMAT_WARNING Item has an ad link that is formatted incorrectly. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_LINK_SAME_AS_LINK Item has an ad link URL that is duplicate of the link URL. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_VIDEO_0_LINK_DUPLICATED ad_video_0_link is duplicated with another ad video link. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_VIDEO_0_LINK_LENGTH_TOO_LONG ad_video_0_link length is too long. The maximum length is 511 characters. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_VIDEO_0_LINK_REQUIRED ad_video_0_link is required for this item because ad_video_0_tag was provided. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_VIDEO_0_LINK_WARNING ad_video_0_link is formatted incorrectly and will not be published with your items. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_VIDEO_0_TAG_DUPLICATED ad_video_0_tag is duplicated with another ad video tag. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_VIDEO_0_TAG_LENGTH_TOO_LONG ad_video_0_tag length is too long. The maximum length is 511 characters. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_VIDEO_0_TAG_REQUIRED ad_video_0_tag is required because ad_video_0_link was provided. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_VIDEO_1_LINK_DUPLICATED ad_video_1_link is duplicated with another ad video link. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_VIDEO_1_LINK_LENGTH_TOO_LONG ad_video_1_link length is too long. The maximum length is 511 characters. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_VIDEO_1_LINK_REQUIRED ad_video_1_link is required for this item because ad_video_1_tag was provided. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_VIDEO_1_LINK_WARNING ad_video_1_link is formatted incorrectly and will not be published with your items. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_VIDEO_1_TAG_DUPLICATED ad_video_1_tag is duplicated with another ad video tag. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_VIDEO_1_TAG_LENGTH_TOO_LONG ad_video_1_tag length is too long. The maximum length is 511 characters. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_VIDEO_1_TAG_REQUIRED ad_video_1_tag is required because ad_video_1_link was provided. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_VIDEO_2_LINK_DUPLICATED ad_video_2_link is duplicated with another ad video link. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_VIDEO_2_LINK_LENGTH_TOO_LONG ad_video_2_link length is too long. The maximum length is 511 characters. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_VIDEO_2_LINK_REQUIRED ad_video_2_link is required for this item because ad_video_2_tag was provided. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_VIDEO_2_LINK_WARNING ad_video_2_link is formatted incorrectly and will not be published with your items. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_VIDEO_2_TAG_DUPLICATED ad_video_2_tag is duplicated with another ad video tag. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_VIDEO_2_TAG_LENGTH_TOO_LONG ad_video_2_tag length is too long. The maximum length is 511 characters. \link{CatalogsItemValidationDetails} [optional]
#' @field AD_VIDEO_2_TAG_REQUIRED ad_video_2_tag is required because ad_video_2_link was provided. \link{CatalogsItemValidationDetails} [optional]
#' @field ADDITIONAL_IMAGE_LINK_LENGTH_TOO_LONG Item has an additional_image_link URL that contains too many characters, so the item will not be published. \link{CatalogsItemValidationDetails} [optional]
#' @field ADDITIONAL_IMAGE_LINK_WARNING Item has additional_image_link URLs that are formatted incorrectly and will not be published with your items. \link{CatalogsItemValidationDetails} [optional]
#' @field ADWORDS_FORMAT_WARNING Item has an adwords_redirect link that is formatted incorrectly. \link{CatalogsItemValidationDetails} [optional]
#' @field ADWORDS_SAME_AS_LINK Item has an adwords_redirect URL that is duplicate of the link URL. \link{CatalogsItemValidationDetails} [optional]
#' @field AGE_GROUP_INVALID Item has an age group value that is formatted incorrectly, which may limit visibility in recommendations, search results and shopping experiences. \link{CatalogsItemValidationDetails} [optional]
#' @field ANDROID_DEEP_LINK_INVALID Item includes an invalid android_deep_link. \link{CatalogsItemValidationDetails} [optional]
#' @field AVAILABILITY_DATE_INVALID Item has an availability_date value that is formatted incorrectly, this item will be published without an availability date. \link{CatalogsItemValidationDetails} [optional]
#' @field COUNTRY_DOES_NOT_MAP_TO_CURRENCY Item includes a currency that doesn't match the usual currency for the location where the product is sold or shipped. \link{CatalogsItemValidationDetails} [optional]
#' @field CUSTOM_LABEL_LENGTH_TOO_LONG Item has a custom_label value that is too long, this item will be published without that custom label. \link{CatalogsItemValidationDetails} [optional]
#' @field DESCRIPTION_LENGTH_TOO_LONG The description for this item was truncated because it contains too many characters. \link{CatalogsItemValidationDetails} [optional]
#' @field EXPIRATION_DATE_INVALID Item has an expiration_date value that is formatted incorrectly, this item will be published without an expiration date. \link{CatalogsItemValidationDetails} [optional]
#' @field GENDER_INVALID Item has a gender value that is formatted incorrectly, which may limit visibility in recommendations, search results and shopping experiences. \link{CatalogsItemValidationDetails} [optional]
#' @field GTIN_INVALID Item has a GTIN value that is formatted incorrectly. \link{CatalogsItemValidationDetails} [optional]
#' @field IMAGE_LINK_WARNING Item has an image_link URL that is formatted incorrectly and will not be published. \link{CatalogsItemValidationDetails} [optional]
#' @field IOS_DEEP_LINK_INVALID Item includes an invalid ios_deep_link value. \link{CatalogsItemValidationDetails} [optional]
#' @field IS_BUNDLE_INVALID Item has an is_bundle value that is formatted incorrectly, this item will be published without being bundled with other products. \link{CatalogsItemValidationDetails} [optional]
#' @field ITEM_ADDITIONAL_IMAGE_DOWNLOAD_FAILURE Item includes additional_image_links that can't be found. \link{CatalogsItemValidationDetails} [optional]
#' @field LINK_FORMAT_WARNING Item has an invalid product link which contains invalid UTM tracking paramaters. \link{CatalogsItemValidationDetails} [optional]
#' @field MIN_AD_PRICE_INVALID Item includes a min_ad_price value that is formatted incorrectly. \link{CatalogsItemValidationDetails} [optional]
#' @field MPN_INVALID Item has a MPN value that is formatted incorrectly. \link{CatalogsItemValidationDetails} [optional]
#' @field MULTIPACK_INVALID Item has an invalid multipack value. \link{CatalogsItemValidationDetails} [optional]
#' @field OPTIONAL_CONDITION_INVALID Item includes a condition value that is formatted incorrectly, which may limit visibility in recommendations, search results and shopping experiences. \link{CatalogsItemValidationDetails} [optional]
#' @field OPTIONAL_CONDITION_MISSING Item is missing condition value, which may limit visibility in recommendations, search results and shopping experiences. \link{CatalogsItemValidationDetails} [optional]
#' @field OPTIONAL_PRODUCT_CATEGORY_INVALID Item includes a google_product_category value that is not formatted correctly according to the GPC taxonomy. \link{CatalogsItemValidationDetails} [optional]
#' @field OPTIONAL_PRODUCT_CATEGORY_MISSING Item is missing google_product_category. \link{CatalogsItemValidationDetails} [optional]
#' @field PRODUCT_CATEGORY_DEPTH_WARNING Item only has 1 or 2 levels of google_product_category value, which may limit visibility in recommendations, search results and shopping experiences. \link{CatalogsItemValidationDetails} [optional]
#' @field PRODUCT_TYPE_LENGTH_TOO_LONG Item has a product_type value that is too long, this item will be published without that product type. \link{CatalogsItemValidationDetails} [optional]
#' @field SALE_DATE_INVALID Item has a sale_price_effective_date value that is formatted incorrectly, this item will be published without a sale date. \link{CatalogsItemValidationDetails} [optional]
#' @field SALES_PRICE_INVALID Item has an incorrectly formatted sales price. \link{CatalogsItemValidationDetails} [optional]
#' @field SALES_PRICE_TOO_HIGH Item has a sale price value that is higher than the original price of the item. \link{CatalogsItemValidationDetails} [optional]
#' @field SALES_PRICE_TOO_LOW Item has a sale price value that is discounted very low compared to the price. \link{CatalogsItemValidationDetails} [optional]
#' @field SHIPPING_HEIGHT_INVALID Item has an incorrectly formatted shipping_height value. The value must first contain a numeric value then a valid dimension unit type. \link{CatalogsItemValidationDetails} [optional]
#' @field SHIPPING_INVALID Item has a shipping value that is formatted incorrectly. \link{CatalogsItemValidationDetails} [optional]
#' @field SHIPPING_WEIGHT_INVALID Item has an invalid shipping_weight value. \link{CatalogsItemValidationDetails} [optional]
#' @field SHIPPING_WIDTH_INVALID Item has an incorrectly formatted shipping_width value. The value must first contain a numeric value then a valid dimension unit type. \link{CatalogsItemValidationDetails} [optional]
#' @field SIZE_SYSTEM_INVALID Some items have size system values which are not one of the supported size systems. \link{CatalogsItemValidationDetails} [optional]
#' @field SIZE_TYPE_INVALID Item has a size type value that is formatted incorrectly, which may limit visibility in recommendations, search results and shopping experiences. \link{CatalogsItemValidationDetails} [optional]
#' @field TAX_INVALID Item has a tax value that is formatted incorrectly. \link{CatalogsItemValidationDetails} [optional]
#' @field TITLE_LENGTH_TOO_LONG The title for the item was truncated because it contains too many characters. \link{CatalogsItemValidationDetails} [optional]
#' @field TOO_MANY_ADDITIONAL_IMAGE_LINKS Item has a additional_image_link value that exceed the limit for additional images, this item will be published without some of your images. \link{CatalogsItemValidationDetails} [optional]
#' @field UTM_SOURCE_AUTO_CORRECTED Item includes an utm_source value that is formatted incorrectly and has been automatically corrected. \link{CatalogsItemValidationDetails} [optional]
#' @field VIDEO_REQUIRED_WHEN_AD_VIDEO_PROVIDED A video is required in the item when ad_video fields are provided. \link{CatalogsItemValidationDetails} [optional]
#' @field WEIGHT_UNIT_INVALID Item has a weight_unit value that is formatted incorrectly, this item will be published without a weight unit. \link{CatalogsItemValidationDetails} [optional]
    ...
    toSimpleType = function() {
      ...
      if (!is.null(self$`VIDEO_REQUIRED_WHEN_AD_VIDEO_PROVIDED`)) {
        CatalogsItemValidationWarningsObject[["VIDEO_REQUIRED_WHEN_AD_VIDEO_PROVIDED"]] <-
          self$extractSimpleType(self$`VIDEO_REQUIRED_WHEN_AD_VIDEO_PROVIDED`)
      }
      if (!is.null(self$`WEIGHT_UNIT_INVALID`)) {
        CatalogsItemValidationWarningsObject[["WEIGHT_UNIT_INVALID"]] <-
          self$extractSimpleType(self$`WEIGHT_UNIT_INVALID`)
      }
