...
CatalogsHotelFeedsUpdateRequest <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return CatalogsHotelFeedsUpdateRequest as a base R list.
    #' @examples
    #' # convert array of CatalogsHotelFeedsUpdateRequest (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CatalogsHotelFeedsUpdateRequest to a base R type
    #'
