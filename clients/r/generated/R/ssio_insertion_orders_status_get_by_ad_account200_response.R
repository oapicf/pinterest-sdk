#' Create a new SsioInsertionOrdersStatusGetByAdAccount200Response
#'
#' @description
...
SsioInsertionOrdersStatusGetByAdAccount200Response <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return SsioInsertionOrdersStatusGetByAdAccount200Response as a base R list.
    #' @examples
    #' # convert array of SsioInsertionOrdersStatusGetByAdAccount200Response (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert SsioInsertionOrdersStatusGetByAdAccount200Response to a base R type
    #'
    ...
    #' @description
    #' Deserialize JSON string into an instance of SsioInsertionOrdersStatusGetByAdAccount200Response
    #'
    ...
    #' @return SsioInsertionOrdersStatusGetByAdAccount200Response in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to SsioInsertionOrdersStatusGetByAdAccount200Response and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`items`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for SsioInsertionOrdersStatusGetByAdAccount200Response: the required field `items` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of SsioInsertionOrdersStatusGetByAdAccount200Response
    toString = function() {
      self$toJSONString()
    },
...
# SsioInsertionOrdersStatusGetByAdAccount200Response$unlock()
#
## Below is an example to define the print function
# SsioInsertionOrdersStatusGetByAdAccount200Response$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# SsioInsertionOrdersStatusGetByAdAccount200Response$lock()
