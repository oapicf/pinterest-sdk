...
BoardsListPins200Response <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return BoardsListPins200Response as a base R list.
    #' @examples
    #' # convert array of BoardsListPins200Response (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert BoardsListPins200Response to a base R type
    #'
