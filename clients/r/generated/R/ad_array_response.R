...
AdArrayResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return AdArrayResponse as a base R list.
    #' @examples
    #' # convert array of AdArrayResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert AdArrayResponse to a base R type
    #'
