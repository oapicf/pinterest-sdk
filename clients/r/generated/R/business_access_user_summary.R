...
BusinessAccessUserSummary <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return BusinessAccessUserSummary as a base R list.
    #' @examples
    #' # convert array of BusinessAccessUserSummary (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert BusinessAccessUserSummary to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(BusinessAccessUserSummaryObject)
    },
