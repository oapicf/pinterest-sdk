...
ConversionReportAttributionType <- R6::R6Class(
    ...
    public = list(
        ...
        fromJSON = function(ConversionReportAttributionTypeJson) {
            private$value <- jsonlite::fromJSON(ConversionReportAttributionTypeJson,
        ...
        fromJSONString = function(ConversionReportAttributionTypeJson) {
            private$value <- jsonlite::fromJSON(ConversionReportAttributionTypeJson,
                simplifyVector = FALSE)
            self
        }
