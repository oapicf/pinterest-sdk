...
ProductGroupPromotionResponseElement <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return ProductGroupPromotionResponseElement as a base R list.
    #' @examples
    #' # convert array of ProductGroupPromotionResponseElement (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ProductGroupPromotionResponseElement to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(ProductGroupPromotionResponseElementObject)
    },
