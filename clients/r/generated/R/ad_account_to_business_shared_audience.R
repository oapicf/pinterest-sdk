#' Create a new AdAccountToBusinessSharedAudience
#'
#' @description
#' AdAccountToBusinessSharedAudience Class
#'
#' @docType class
#' @title AdAccountToBusinessSharedAudience
#' @description AdAccountToBusinessSharedAudience Class
...
#' @export
AdAccountToBusinessSharedAudience <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new AdAccountToBusinessSharedAudience class.
    #'
    ...
    #'
    #' @return AdAccountToBusinessSharedAudience as a base R list.
    #' @examples
    #' # convert array of AdAccountToBusinessSharedAudience (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert AdAccountToBusinessSharedAudience to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      AdAccountToBusinessSharedAudienceObject <- list()
      if (!is.null(self$`audience_id`)) {
        AdAccountToBusinessSharedAudienceObject[["audience_id"]] <-
          self$`audience_id`
      }
      if (!is.null(self$`permissions`)) {
        AdAccountToBusinessSharedAudienceObject[["permissions"]] <-
          self$extractSimpleType(self$`permissions`)
      }
      if (!is.null(self$`recipient_business_ids`)) {
        AdAccountToBusinessSharedAudienceObject[["recipient_business_ids"]] <-
          self$`recipient_business_ids`
      }
      return(AdAccountToBusinessSharedAudienceObject)
    },
    ...
    #' @description
    #' Deserialize JSON string into an instance of AdAccountToBusinessSharedAudience
    #'
    #' @param input_json the JSON input
    #' @return the instance of AdAccountToBusinessSharedAudience
    ...
    #' @return AdAccountToBusinessSharedAudience in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to AdAccountToBusinessSharedAudience and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`audience_id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for AdAccountToBusinessSharedAudience: the required field `audience_id` is missing."))
      }
      ...
      if (!is.null(input_json$`recipient_business_ids`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for AdAccountToBusinessSharedAudience: the required field `recipient_business_ids` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of AdAccountToBusinessSharedAudience
    toString = function() {
      self$toJSONString()
    },
...
# AdAccountToBusinessSharedAudience$unlock()
#
## Below is an example to define the print function
# AdAccountToBusinessSharedAudience$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# AdAccountToBusinessSharedAudience$lock()
