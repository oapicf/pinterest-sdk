#' Create a new PinAnalyticsDailyMetrics
#'
#' @description
#' PinAnalyticsDailyMetrics Class
#'
#' @docType class
#' @title PinAnalyticsDailyMetrics
#' @description PinAnalyticsDailyMetrics Class
...
#' @export
PinAnalyticsDailyMetrics <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new PinAnalyticsDailyMetrics class.
    #'
    ...
    #'
    #' @return PinAnalyticsDailyMetrics as a base R list.
    #' @examples
    #' # convert array of PinAnalyticsDailyMetrics (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert PinAnalyticsDailyMetrics to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      PinAnalyticsDailyMetricsObject <- list()
      if (!is.null(self$`data_status`)) {
        PinAnalyticsDailyMetricsObject[["data_status"]] <-
          self$extractSimpleType(self$`data_status`)
      }
      if (!is.null(self$`date`)) {
        PinAnalyticsDailyMetricsObject[["date"]] <-
          self$`date`
      }
      if (!is.null(self$`metrics`)) {
        PinAnalyticsDailyMetricsObject[["metrics"]] <-
          self$`metrics`
      }
      return(PinAnalyticsDailyMetricsObject)
    },
    ...
    #' @description
    #' Deserialize JSON string into an instance of PinAnalyticsDailyMetrics
    #'
    #' @param input_json the JSON input
    #' @return the instance of PinAnalyticsDailyMetrics
    ...
    #' @return PinAnalyticsDailyMetrics in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to PinAnalyticsDailyMetrics and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of PinAnalyticsDailyMetrics
    toString = function() {
      self$toJSONString()
    },
...
# PinAnalyticsDailyMetrics$unlock()
#
## Below is an example to define the print function
# PinAnalyticsDailyMetrics$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# PinAnalyticsDailyMetrics$lock()
