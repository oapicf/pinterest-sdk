...
CatalogsFeedIngestionInfo <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return CatalogsFeedIngestionInfo as a base R list.
    #' @examples
    #' # convert array of CatalogsFeedIngestionInfo (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CatalogsFeedIngestionInfo to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(CatalogsFeedIngestionInfoObject)
    },
