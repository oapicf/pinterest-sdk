...
CatalogsCreateHotelItem <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return CatalogsCreateHotelItem as a base R list.
    #' @examples
    #' # convert array of CatalogsCreateHotelItem (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CatalogsCreateHotelItem to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(CatalogsCreateHotelItemObject)
    },
