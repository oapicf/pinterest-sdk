...
.parse_MetricsReportingLevel <- function(vals) {
  res <- gsub("^\\[|\\]$", "", "[ADVERTISER, ADVERTISER_TARGETING, CAMPAIGN, CAMPAIGN_TARGETING, AD_GROUP, AD_GROUP_TARGETING, PIN_PROMOTION, PIN_PROMOTION_TARGETING, KEYWORD, PRODUCT_GROUP, PRODUCT_GROUP_TARGETING, PRODUCT_ITEM]")
  unlist(strsplit(res, ", "))
}
