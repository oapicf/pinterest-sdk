#' Create a new TargetingSpecOperationGender
#'
#' @description
#' TargetingSpecOperationGender Class
#'
#' @docType class
#' @title TargetingSpecOperationGender
...
#' @export
TargetingSpecOperationGender <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new TargetingSpecOperationGender class.
    #'
    #' @param field field
    ...
    initialize = function(`field`, `operation`, `values`, ...) {
      if (!missing(`field`)) {
        if (!(`field` %in% c("GENDER"))) {
          stop(paste("Error! \"", `field`, "\" cannot be assigned to `field`. Must be \"GENDER\".", sep = ""))
        }
    ...
    #'
    #' @return TargetingSpecOperationGender as a base R list.
    #' @examples
    #' # convert array of TargetingSpecOperationGender (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert TargetingSpecOperationGender to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      TargetingSpecOperationGenderObject <- list()
      if (!is.null(self$`field`)) {
        TargetingSpecOperationGenderObject[["field"]] <-
          self$`field`
      }
    ...
    #' @description
    #' Deserialize JSON string into an instance of TargetingSpecOperationGender
    #'
    #' @param input_json the JSON input
    #' @return the instance of TargetingSpecOperationGender
    fromJSON = function(input_json) {
      this_object <- jsonlite::fromJSON(input_json)
      if (!is.null(this_object$`field`)) {
        if (!is.null(this_object$`field`) && !(this_object$`field` %in% c("GENDER"))) {
    ...
    #' @return TargetingSpecOperationGender in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to TargetingSpecOperationGender and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`field`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for TargetingSpecOperationGender: the required field `field` is missing."))
      }
      ...
      if (!is.null(input_json$`values`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for TargetingSpecOperationGender: the required field `values` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of TargetingSpecOperationGender
    toString = function() {
      self$toJSONString()
    },
...
# TargetingSpecOperationGender$unlock()
#
## Below is an example to define the print function
# TargetingSpecOperationGender$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# TargetingSpecOperationGender$lock()
