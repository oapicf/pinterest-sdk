...
AudienceDefinitionResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return AudienceDefinitionResponse as a base R list.
    #' @examples
    #' # convert array of AudienceDefinitionResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert AudienceDefinitionResponse to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(AudienceDefinitionResponseObject)
    },
