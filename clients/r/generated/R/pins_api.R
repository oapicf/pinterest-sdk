...
#'
#' \itemize{
#' \item \emph{ @param } pin_id character
#' \item \emph{ @param } start_date character
#' \item \emph{ @param } end_date character
#' \item \emph{ @param } metric_types list( \link{PinsAnalyticsMetricTypesParameterInner} )
#' \item \emph{ @param } app_types Enum < [ALL, MOBILE, TABLET, WEB] >
#' \item \emph{ @param } split_field Enum < [NO_SPLIT, APP_TYPE] >
#' \item \emph{ @param } ad_account_id character
#' \item \emph{ @returnType } named list( \link{PinAnalyticsMetricsResponse} ) \cr
#'
#'
#' \item status code : 200 | response
#'
#' \item return type : map(PinAnalyticsMetricsResponse)
#' \item response headers :
#'
#' \tabular{ll}{
#' }
#' \item status code : 400 | Invalid pins analytics parameters.
#'
...
#'
#' \itemize{
#' \item \emph{ @param } pin_create \link{PinCreate}
#' \item \emph{ @param } ad_account_id character
...
#' }
#'
#' \strong{ PinsList } \emph{ List Pins }
...
#' \item \emph{ @param } pin_filter Enum < [exclude_native, exclude_repins, has_been_promoted] >
#' \item \emph{ @param } include_protected_pins character
#' \item \emph{ @param } pin_type Enum < [PRIVATE] >
...
#' \tabular{ll}{
#' }
#' \item status code : 400 | Invalid pin filter value
#'
#' \item return type : Error
#' \item response headers :
#'
...
#' }
#'
#' \strong{ PinsSave } \emph{ Save Pin }
#' Save a Pin on a board or board section owned by the \"operation user_account\". - By default, the \"operation user_account\" is the token user_account. Optional: Business Access: Specify an <code>ad_account_id</code> (obtained via <a href='/docs/api/v5/#operation/ad_accounts/list'>List ad accounts</a>) to use the owner of that ad_account as the \"operation user_account\". In order to do this, the token user_account must have one of the following <a href=\"https://help.pinterest.com/en/business/article/share-and-manage-access-to-your-ad-accounts\">Business Access</a> roles on the ad_account:  - For Pins on public or protected boards: Owner, Admin, Analyst, Campaign Manager. - For Pins on secret boards: Owner, Admin.  - Any Pin type can be saved: image Pin, video Pin, Idea Pin, product Pin, etc. - Any public Pin can be saved given a pin ID.
#'
#' \itemize{
#' \item \emph{ @param } pin_id character
#' \item \emph{ @param } pins_save_request \link{PinsSaveRequest}
#' \item \emph{ @param } ad_account_id character
#' \item \emph{ @returnType } \link{Pin} \cr
#'
#'
#' \item status code : 201 | Successfully saved pin.
#'
#' \item return type : Pin
#' \item response headers :
#'
...
#' \tabular{ll}{
#' }
#' \item status code : 404 | Board or Pin not found.
#'
#' \item return type : Error
#' \item response headers :
#'
...
#' }
#'
#' \strong{ PinsUpdate } \emph{ Update Pin }
#' Update a pin owned by the \"operating user_account\". - By default, the \"operation user_account\" is the token user_account.  Optional: Business Access: Specify an <code>ad_account_id</code> (obtained via <a href='/docs/api/v5/#operation/ad_accounts/list'>List ad accounts</a>) to use the owner of that ad_account as the \"operation user_account\". In order to do this, the token user_account must have one of the following <a href=\"https://help.pinterest.com/en/business/article/share-and-manage-access-to-your-ad-accounts\">Business Access</a> roles on the ad_account:  - For Pins on public or protected boards: Owner, Admin, Analyst, Campaign Manager. - For Pins on secret boards: Owner, Admin.  <strong>This endpoint is currently in beta and not available to all apps. <a href='/docs/new/about-beta-access/'>Learn more</a>.</strong>
#'
#' \itemize{
#' \item \emph{ @param } pin_id character
#' \item \emph{ @param } pin_update \link{PinUpdate}
#' \item \emph{ @param } ad_account_id character
#' \item \emph{ @returnType } \link{Pin} \cr
#'
#'
...
#' \tabular{ll}{
#' }
#' \item status code : 403 | Not authorized to update Pin.
#'
#' \item return type : Error
#' \item response headers :
#'
...
PinsApi <- R6::R6Class(
  ...
  public = list(
    ...
    PinsAnalyticsWithHttpInfo = function(pin_id, start_date, end_date, metric_types, app_types = "ALL", split_field = "NO_SPLIT", ad_account_id = NULL, data_file = NULL, ...) {
      ...
      if (!(`split_field` %in% c("NO_SPLIT", "APP_TYPE"))) {
    ...
    PinsListWithHttpInfo = function(bookmark = NULL, page_size = 25, pin_filter = NULL, include_protected_pins = FALSE, pin_type = NULL, creative_types = NULL, ad_account_id = NULL, pin_metrics = FALSE, data_file = NULL, ...) {
      ...
      if (!(`pin_filter` %in% c("exclude_native", "exclude_repins", "has_been_promoted"))) {
