...
PinsApi <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return Pin
    PinsGet = function(pin_id, ad_account_id = NULL, pin_metrics = FALSE, data_file = NULL, ...) {
      local_var_response <- self$PinsGetWithHttpInfo(pin_id, ad_account_id, pin_metrics, data_file = data_file, ...)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        return(local_var_response$content)
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        return(local_var_response)
    ...
    #'
    #' @return API response (Pin) with additional information such as HTTP status code, headers
    PinsGetWithHttpInfo = function(pin_id, ad_account_id = NULL, pin_metrics = FALSE, data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
    ...
    PinsList = function(pin_filter = NULL, pin_metrics = FALSE, include_protected_pins = FALSE, pin_type = NULL, creative_types = NULL, ad_account_id = NULL, bookmark = NULL, page_size = 25, data_file = NULL, ...) {
      local_var_response <- self$PinsListWithHttpInfo(pin_filter, pin_metrics, include_protected_pins, pin_type, creative_types, ad_account_id, bookmark, page_size, data_file = data_file, ...)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        return(local_var_response$content)
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        return(local_var_response)
    ...
    PinsListWithHttpInfo = function(pin_filter = NULL, pin_metrics = FALSE, include_protected_pins = FALSE, pin_type = NULL, creative_types = NULL, ad_account_id = NULL, bookmark = NULL, page_size = 25, data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
