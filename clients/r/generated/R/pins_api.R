...
PinsApi <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return map(map)
    MultiPinsAnalytics = function(pin_ids, start_date, end_date, metric_types, app_types = "ALL", ad_account_id = NULL, data_file = NULL, ..., .parse = TRUE) {
      local_var_response <- self$MultiPinsAnalyticsWithHttpInfo(pin_ids, start_date, end_date, metric_types, app_types, ad_account_id, data_file = data_file, ..., .parse = .parse)
    ...
    MultiPinsAnalyticsWithHttpInfo = function(pin_ids, start_date, end_date, metric_types, app_types = "ALL", ad_account_id = NULL, data_file = NULL, ..., .parse = TRUE) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$DeserializeResponse(local_var_resp, "map(map)"),
          error = function(e) {
    ...
    PinsAnalytics = function(pin_id, start_date, end_date, metric_types, app_types = "ALL", split_field = "NO_SPLIT", ad_account_id = NULL, data_file = NULL, ..., .parse = TRUE) {
      local_var_response <- self$PinsAnalyticsWithHttpInfo(pin_id, start_date, end_date, metric_types, app_types, split_field, ad_account_id, data_file = data_file, ..., .parse = .parse)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        return(local_var_response$content)
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        return(local_var_response)
    ...
    PinsAnalyticsWithHttpInfo = function(pin_id, start_date, end_date, metric_types, app_types = "ALL", split_field = "NO_SPLIT", ad_account_id = NULL, data_file = NULL, ..., .parse = TRUE) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$DeserializeResponse(local_var_resp, "map(PinAnalyticsMetricsResponse)"),
          error = function(e) {
            stop("Failed to deserialize response")
          }
        )
    ...
    #'
    #' @return Pin
    PinsCreate = function(pin_create, ad_account_id = NULL, data_file = NULL, ..., .parse = TRUE) {
      local_var_response <- self$PinsCreateWithHttpInfo(pin_create, ad_account_id, data_file = data_file, ..., .parse = .parse)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        return(local_var_response$content)
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        return(local_var_response)
    ...
    PinsCreateWithHttpInfo = function(pin_create, ad_account_id = NULL, data_file = NULL, ..., .parse = TRUE) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      if (!missing(`pin_create`) && is.null(`pin_create`)) {
        stop("Invalid value for `pin_create` when calling PinsApi$PinsCreate, `pin_create` is not nullable")
      }
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$DeserializeResponse(local_var_resp, "Pin"),
          error = function(e) {
            stop("Failed to deserialize response")
          }
        )
    ...
    #'
    #' @return Pin
    PinsDelete = function(pin_id, ad_account_id = NULL, data_file = NULL, ..., .parse = TRUE) {
      local_var_response <- self$PinsDeleteWithHttpInfo(pin_id, ad_account_id, data_file = data_file, ..., .parse = .parse)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        return(local_var_response$content)
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        return(local_var_response)
    ...
    #'
    #' @return API response (Pin) with additional information such as HTTP status code, headers
    PinsDeleteWithHttpInfo = function(pin_id, ad_account_id = NULL, data_file = NULL, ..., .parse = TRUE) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      if (!is.null(`pin_id`) && !stringr::str_detect(`pin_id`, "^\\d+$")) {
        stop("Invalid value for `pin_id` when calling PinsApi$PinsDelete, must conform to the pattern ^\\d+$.")
      }
    ...
    #'
    #' @return Pin
    PinsGet = function(pin_id, ad_account_id = NULL, pin_metrics = FALSE, data_file = NULL, ..., .parse = TRUE) {
      local_var_response <- self$PinsGetWithHttpInfo(pin_id, ad_account_id, pin_metrics, data_file = data_file, ..., .parse = .parse)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        return(local_var_response$content)
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        return(local_var_response)
    ...
    #'
    #' @return API response (Pin) with additional information such as HTTP status code, headers
    PinsGetWithHttpInfo = function(pin_id, ad_account_id = NULL, pin_metrics = FALSE, data_file = NULL, ..., .parse = TRUE) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      if (!is.null(`pin_id`) && !stringr::str_detect(`pin_id`, "^\\d+$")) {
        stop("Invalid value for `pin_id` when calling PinsApi$PinsGet, must conform to the pattern ^\\d+$.")
      }
    ...
    #' List Pins
    #'
    #' @param pin_filter (optional) The filter to apply to the pins
    #' @param pin_metrics (optional) Specify whether to return 90d and lifetime Pin metrics. Total comments and total reactions are only available with lifetime Pin metrics. If Pin was created before `2023-03-20` lifetime metrics will only be available for Video and Idea Pin formats. Lifetime metrics are available for all Pin formats since then. (default value: FALSE)
    #' @param include_protected_pins (optional) Whether to include protected pins in the results (default value: FALSE)
    ...
    #' @param ad_account_id (optional) Unique identifier of an ad account.
    #' @param domain (optional) Only return pins with links that match the exact domain. Domain should not include 'www.' prefix. For example, 'pinterest.com' is a valid domain, but 'www.pinterest.com' is not (will not match any pins).
    #' @param domains (optional) Only return pins with links whose domain matches any value in the list. Values are joined comma-separated on the wire (e.g. `?domains=instagram.com,jcpenney.com`).
    #' @param include_product_tag_obj (optional) Include product tag objects in the response with their associated links.
    ...
    PinsList = function(pin_filter = NULL, pin_metrics = FALSE, include_protected_pins = FALSE, pin_type = NULL, creative_types = NULL, ad_account_id = NULL, domain = NULL, domains = NULL, include_product_tag_obj = NULL, bookmark = NULL, page_size = 25, data_file = NULL, ..., .parse = TRUE) {
      local_var_response <- self$PinsListWithHttpInfo(pin_filter, pin_metrics, include_protected_pins, pin_type, creative_types, ad_account_id, domain, domains, include_product_tag_obj, bookmark, page_size, data_file = data_file, ..., .parse = .parse)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        return(local_var_response$content)
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        return(local_var_response)
    ...
    PinsListWithHttpInfo = function(pin_filter = NULL, pin_metrics = FALSE, include_protected_pins = FALSE, pin_type = NULL, creative_types = NULL, ad_account_id = NULL, domain = NULL, domains = NULL, include_product_tag_obj = NULL, bookmark = NULL, page_size = 25, data_file = NULL, ..., .parse = TRUE) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      if (!missing(`domain`) && is.null(`domain`)) {
        stop("Invalid value for `domain` when calling PinsApi$PinsList, `domain` is not nullable")
      }

      if (!missing(`domains`) && is.null(`domains`)) {
        stop("Invalid value for `domains` when calling PinsApi$PinsList, `domains` is not nullable")
      }
      if (!is.null(`domains`) && length(`domains`) > 100) {
        stop("Invalid length for `domains` when calling PinsApi$PinsList, number of items must be less than or equal to 100.")
      }
      if (!is.null(`domains`) && length(`domains`) < 1) {
        stop("Invalid length for `domains` when calling PinsApi$PinsList, number of items must be greater than or equal to 1.")
      }

      if (!missing(`include_product_tag_obj`) && is.null(`include_product_tag_obj`)) {
        stop("Invalid value for `include_product_tag_obj` when calling PinsApi$PinsList, `include_product_tag_obj` is not nullable")
      }
      ...
      query_params[["include_product_tag_obj"]] <- `include_product_tag_obj`
    ...
    #'
    #' @param pin_id Unique identifier of a Pin.
    #' @param pins_save_request_create 
    #' @param ad_account_id (optional) Unique identifier of an ad account.
    #' @param data_file (optional) name of the data file to save the result
    #' @param ... Other optional arguments
    #' @param .parse Logical. If \code{TRUE} then the response will be parsed to a generated type. If \code{FALSE} the response will be returned as unparsed text.
    #'
    #' @return Pin
    PinsSave = function(pin_id, pins_save_request_create, ad_account_id = NULL, data_file = NULL, ..., .parse = TRUE) {
      local_var_response <- self$PinsSaveWithHttpInfo(pin_id, pins_save_request_create, ad_account_id, data_file = data_file, ..., .parse = .parse)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        return(local_var_response$content)
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        return(local_var_response)
    ...
    #'
    #' @return API response (Pin) with additional information such as HTTP status code, headers
    PinsSaveWithHttpInfo = function(pin_id, pins_save_request_create, ad_account_id = NULL, data_file = NULL, ..., .parse = TRUE) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      if (missing(`pins_save_request_create`)) {
        stop("Missing required parameter `pins_save_request_create`.")
      }
      ...
      if (!missing(`pins_save_request_create`) && is.null(`pins_save_request_create`)) {
        stop("Invalid value for `pins_save_request_create` when calling PinsApi$PinsSave, `pins_save_request_create` is not nullable")
      }
      ...
      if (!is.null(`pins_save_request_create`)) {
        local_var_body <- `pins_save_request_create`$toJSONString()
      } else {
        local_var_body <- NULL
      }
    ...
    #'
    #' @return Pin
    PinsUpdate = function(pin_id, pin_update, ad_account_id = NULL, data_file = NULL, ..., .parse = TRUE) {
      local_var_response <- self$PinsUpdateWithHttpInfo(pin_id, pin_update, ad_account_id, data_file = data_file, ..., .parse = .parse)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        return(local_var_response$content)
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        return(local_var_response)
    ...
    #'
    #' @return API response (Pin) with additional information such as HTTP status code, headers
    PinsUpdateWithHttpInfo = function(pin_id, pin_update, ad_account_id = NULL, data_file = NULL, ..., .parse = TRUE) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      if (!is.null(`pin_id`) && !stringr::str_detect(`pin_id`, "^\\d+$")) {
        stop("Invalid value for `pin_id` when calling PinsApi$PinsUpdate, must conform to the pattern ^\\d+$.")
      }

      if (!missing(`pin_update`) && is.null(`pin_update`)) {
        stop("Invalid value for `pin_update` when calling PinsApi$PinsUpdate, `pin_update` is not nullable")
      }
