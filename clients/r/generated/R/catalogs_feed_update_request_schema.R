#' @docType class
#' @title CatalogsFeedUpdateRequestSchema
#'
#' @description CatalogsFeedUpdateRequestSchema Class
#'
...
#' @export
CatalogsFeedUpdateRequestSchema <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new CatalogsFeedUpdateRequestSchema.
    #'
    ...
    initialize = function(instance = NULL) {
      if (is.null(instance)) {
        ...
        stop(paste("Failed to initialize CatalogsFeedUpdateRequestSchema with oneOf schemas CatalogsFeedsUpdateRequest, CatalogsVerticalFeedsUpdateRequest. Provided class name: ",
                   get(class(instance)[[1]], pos = -1)$classname))
      }
    },

    #' @description
    #' Deserialize JSON string into an instance of CatalogsFeedUpdateRequestSchema.
    #' An alias to the method `fromJSON` .
    #'
    #' @param input The input JSON.
    #'
    #' @return An instance of CatalogsFeedUpdateRequestSchema.
    ...
    fromJSON = function(input) {
      ...
      if (matched == 1) {
        ...
        # more than 1 match
        stop(paste("Multiple matches found when deserializing the input into CatalogsFeedUpdateRequestSchema with oneOf schemas CatalogsFeedsUpdateRequest, CatalogsVerticalFeedsUpdateRequest. Matched schemas: ",
                   paste(matched_schemas, collapse = ", ")))
      } else {
        # no match
        stop(paste("No match found when deserializing the input into CatalogsFeedUpdateRequestSchema with oneOf schemas CatalogsFeedsUpdateRequest, CatalogsVerticalFeedsUpdateRequest. Details: >>",
    ...
    #' @description
    #' Serialize CatalogsFeedUpdateRequestSchema to JSON string.
    #' 
    #' @param ... Parameters passed to `jsonlite::toJSON`
    #' @return JSON string representation of the CatalogsFeedUpdateRequestSchema.
    ...
    #' @description
    #' Convert CatalogsFeedUpdateRequestSchema to a base R type
    #'
    ...
    #' @description
    #' Validate the input JSON with respect to CatalogsFeedUpdateRequestSchema and
...
#CatalogsFeedUpdateRequestSchema$unlock()
#
## Below is an example to define the print function
#CatalogsFeedUpdateRequestSchema$set("public", "print", function(...) {
#  print(jsonlite::prettify(self$toJSONString()))
#  invisible(self)
#})
## Uncomment below to lock the class to prevent modifications to the method or field
#CatalogsFeedUpdateRequestSchema$lock()
