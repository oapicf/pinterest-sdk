...
#' @field items List of invite/request creation status. If there is an error, an exception object will be returned. If the action was successfully completed, an invite object will be returned. list(\link{InviteActionResultItem}) [optional]
...
CreateInvitesResultsResponseArray <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return CreateInvitesResultsResponseArray as a base R list.
    #' @examples
    #' # convert array of CreateInvitesResultsResponseArray (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CreateInvitesResultsResponseArray to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(CreateInvitesResultsResponseArrayObject)
    },
