...
TopVideoPinsAnalyticsResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return TopVideoPinsAnalyticsResponse as a base R list.
    #' @examples
    #' # convert array of TopVideoPinsAnalyticsResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert TopVideoPinsAnalyticsResponse to a base R type
    #'
