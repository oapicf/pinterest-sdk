...
CatalogsProductGroupType <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Convert CatalogsProductGroupType to a base R type
    #'
...
.parse_CatalogsProductGroupType <- function(vals) {
  res <- gsub("^\\[|\\]$", "", "[MERCHANT_CREATED, ALL_PRODUCTS, BEST_DEALS, PINNER_FAVORITES, TOP_SELLERS, BACK_IN_STOCK, NEW_ARRIVALS, SHOPIFY_COLLECTIONS, I2PC, CATALOG_EXPANSION]")
  unlist(strsplit(res, ", "))
}
