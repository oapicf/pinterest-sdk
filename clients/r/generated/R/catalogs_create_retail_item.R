...
CatalogsCreateRetailItem <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(`attributes`, `item_id`, `operation`, ...) {
    ...
    #'
    #' @return CatalogsCreateRetailItem as a base R list.
    #' @examples
    #' # convert array of CatalogsCreateRetailItem (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CatalogsCreateRetailItem to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(CatalogsCreateRetailItemObject)
    },
