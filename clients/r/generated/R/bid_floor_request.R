...
BidFloorRequest <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return BidFloorRequest as a base R list.
    #' @examples
    #' # convert array of BidFloorRequest (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert BidFloorRequest to a base R type
    #'
