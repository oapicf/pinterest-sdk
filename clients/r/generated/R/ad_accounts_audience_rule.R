#' Create a new AdAccountsAudienceRule
#'
#' @description
...
#'
#' @docType class
#' @title AdAccountsAudienceRule
#' @description AdAccountsAudienceRule Class
...
#' @field objective_type Objective for engagement audience filter. list(\link{AudienceObjectiveType}) [optional]
...
#' @export
AdAccountsAudienceRule <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new AdAccountsAudienceRule class.
    #'
    ...
    #'
    #' @return AdAccountsAudienceRule as a base R list.
    #' @examples
    #' # convert array of AdAccountsAudienceRule (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert AdAccountsAudienceRule to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      AdAccountsAudienceRuleObject <- list()
      if (!is.null(self$`ad_account_id`)) {
        AdAccountsAudienceRuleObject[["ad_account_id"]] <-
          self$`ad_account_id`
      }
      if (!is.null(self$`ad_id`)) {
        AdAccountsAudienceRuleObject[["ad_id"]] <-
          self$`ad_id`
      }
      if (!is.null(self$`campaign_id`)) {
        AdAccountsAudienceRuleObject[["campaign_id"]] <-
          self$`campaign_id`
      }
      if (!is.null(self$`country`)) {
        AdAccountsAudienceRuleObject[["country"]] <-
          self$`country`
      }
      if (!is.null(self$`customer_list_id`)) {
        AdAccountsAudienceRuleObject[["customer_list_id"]] <-
          self$`customer_list_id`
      }
      if (!is.null(self$`engagement_domain`)) {
        AdAccountsAudienceRuleObject[["engagement_domain"]] <-
          self$`engagement_domain`
      }
      if (!is.null(self$`engagement_type`)) {
        AdAccountsAudienceRuleObject[["engagement_type"]] <-
          self$`engagement_type`
      }
      if (!is.null(self$`engager_type`)) {
        AdAccountsAudienceRuleObject[["engager_type"]] <-
          self$`engager_type`
      }
      if (!is.null(self$`event`)) {
        AdAccountsAudienceRuleObject[["event"]] <-
          self$`event`
      }
      if (!is.null(self$`event_data`)) {
        AdAccountsAudienceRuleObject[["event_data"]] <-
          self$extractSimpleType(self$`event_data`)
      }
      if (!is.null(self$`event_source`)) {
        AdAccountsAudienceRuleObject[["event_source"]] <-
          self$`event_source`
      }
      if (!is.null(self$`ingestion_source`)) {
        AdAccountsAudienceRuleObject[["ingestion_source"]] <-
          self$`ingestion_source`
      }
      if (!is.null(self$`objective_type`)) {
        AdAccountsAudienceRuleObject[["objective_type"]] <-
          self$extractSimpleType(self$`objective_type`)
      }
      if (!is.null(self$`percentage`)) {
        AdAccountsAudienceRuleObject[["percentage"]] <-
          self$`percentage`
      }
      if (!is.null(self$`pin_id`)) {
        AdAccountsAudienceRuleObject[["pin_id"]] <-
          self$`pin_id`
      }
      if (!is.null(self$`prefill`)) {
        AdAccountsAudienceRuleObject[["prefill"]] <-
          self$`prefill`
      }
      if (!is.null(self$`retention_days`)) {
        AdAccountsAudienceRuleObject[["retention_days"]] <-
          self$`retention_days`
      }
      if (!is.null(self$`seed_id`)) {
        AdAccountsAudienceRuleObject[["seed_id"]] <-
          self$`seed_id`
      }
      if (!is.null(self$`url`)) {
        AdAccountsAudienceRuleObject[["url"]] <-
          self$`url`
      }
      if (!is.null(self$`visitor_source_id`)) {
        AdAccountsAudienceRuleObject[["visitor_source_id"]] <-
          self$`visitor_source_id`
      }
      return(AdAccountsAudienceRuleObject)
    },
    ...
    #' @description
    #' Deserialize JSON string into an instance of AdAccountsAudienceRule
    #'
    #' @param input_json the JSON input
    #' @return the instance of AdAccountsAudienceRule
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`objective_type`)) {
        self$`objective_type` <- ApiClient$new()$deserializeObj(this_object$`objective_type`, "array[AudienceObjectiveType]", loadNamespace("openapi"))
      }
    ...
    #' @return AdAccountsAudienceRule in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to AdAccountsAudienceRule and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of AdAccountsAudienceRule
    toString = function() {
      self$toJSONString()
    },
...
# AdAccountsAudienceRule$unlock()
#
## Below is an example to define the print function
# AdAccountsAudienceRule$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# AdAccountsAudienceRule$lock()
