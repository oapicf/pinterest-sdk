  ...
  public = list(
    ...
    initialize = function(...) {
      ...
      if (!val %in% enumvec) {
        ...
        warning("Initializing Role with DUMMY_ENUM. Use one of the valid values: ",
          paste0(enumvec, collapse = ", "),
          ". If you did not manually initialize Role, this may already be overwritten by an enum loaded from a JSON config.")
      }
      private$value <- val
    },
