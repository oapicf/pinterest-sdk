...
ConditionFilter <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return ConditionFilter as a base R list.
    #' @examples
    #' # convert array of ConditionFilter (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ConditionFilter to a base R type
    #'
