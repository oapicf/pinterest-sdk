...
AdPreviewURLResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return AdPreviewURLResponse as a base R list.
    #' @examples
    #' # convert array of AdPreviewURLResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert AdPreviewURLResponse to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(AdPreviewURLResponseObject)
    },
