...
AdsAnalyticsResponseInner <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return AdsAnalyticsResponseInner as a base R list.
    #' @examples
    #' # convert array of AdsAnalyticsResponseInner (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert AdsAnalyticsResponseInner to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(AdsAnalyticsResponseInnerObject)
    },
