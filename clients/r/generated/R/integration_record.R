...
IntegrationRecord <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return IntegrationRecord as a base R list.
    #' @examples
    #' # convert array of IntegrationRecord (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert IntegrationRecord to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(IntegrationRecordObject)
    },
