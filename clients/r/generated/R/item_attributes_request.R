  ...
  public = list(
    ...
    toSimpleType = function() {
      ...
      if (!is.null(self$`ad_video_0_link`)) {
        ItemAttributesRequestObject[["ad_video_0_link"]] <-
          self$`ad_video_0_link`
      }
      if (!is.null(self$`ad_video_0_tag`)) {
        ItemAttributesRequestObject[["ad_video_0_tag"]] <-
          self$`ad_video_0_tag`
      }
      if (!is.null(self$`ad_video_1_link`)) {
        ItemAttributesRequestObject[["ad_video_1_link"]] <-
          self$`ad_video_1_link`
      }
      if (!is.null(self$`ad_video_1_tag`)) {
        ItemAttributesRequestObject[["ad_video_1_tag"]] <-
          self$`ad_video_1_tag`
      }
      if (!is.null(self$`ad_video_2_link`)) {
        ItemAttributesRequestObject[["ad_video_2_link"]] <-
      ...
      if (!is.null(self$`custom_number_0`)) {
        ItemAttributesRequestObject[["custom_number_0"]] <-
          self$`custom_number_0`
      }
      if (!is.null(self$`custom_number_1`)) {
        ItemAttributesRequestObject[["custom_number_1"]] <-
          self$`custom_number_1`
      }
      if (!is.null(self$`custom_number_2`)) {
        ItemAttributesRequestObject[["custom_number_2"]] <-
          self$`custom_number_2`
      }
      if (!is.null(self$`custom_number_3`)) {
        ItemAttributesRequestObject[["custom_number_3"]] <-
          self$`custom_number_3`
      }
      if (!is.null(self$`custom_number_4`)) {
        ItemAttributesRequestObject[["custom_number_4"]] <-
      ...
      if (!is.null(self$`ios_deep_link`)) {
        ItemAttributesRequestObject[["ios_deep_link"]] <-
          self$`ios_deep_link`
      }
      ...
      if (!is.null(self$`promotion_id`)) {
        ItemAttributesRequestObject[["promotion_id"]] <-
          self$`promotion_id`
      }
      ...
      if (!is.null(self$`unit_pricing_base_measure`)) {
        ItemAttributesRequestObject[["unit_pricing_base_measure"]] <-
          self$`unit_pricing_base_measure`
      }
      if (!is.null(self$`unit_pricing_measure`)) {
        ItemAttributesRequestObject[["unit_pricing_measure"]] <-
