...
PinAnalyticsMetricsResponseDailyMetricsInner <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return PinAnalyticsMetricsResponseDailyMetricsInner as a base R list.
    #' @examples
    #' # convert array of PinAnalyticsMetricsResponseDailyMetricsInner (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert PinAnalyticsMetricsResponseDailyMetricsInner to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(PinAnalyticsMetricsResponseDailyMetricsInnerObject)
    },
