...
#' @field catalog_product_group_id ID of the catalogs product group that this product group promotion references (required for create operations) character [optional]
#' @field catalog_product_group_name Catalogs product group name character [optional]
#' @field collections_header_type  \link{CollectionsHeaderType} [optional]
...
#' @field customizable_cta_type  \link{ProductGroupPromotionCustomizableCTAType} [optional]
...
#' @field id ID of the product group promotion (required for update operations). character [optional]
...
#' @field is_image_auto_resizing Set to `TRUE` to automatically resize your product images with generative AI. This ensures that images have optimal appearance for better performance. character [optional]
...
#' @field preferred_media_type  \link{PreferredMediaType} [optional]
...
ProductGroupPromotion <- R6::R6Class(
  ...
  public = list(
    ...
    #' @param catalog_product_group_id ID of the catalogs product group that this product group promotion references (required for create operations)
    ...
    #' @param is_image_auto_resizing Set to `TRUE` to automatically resize your product images with generative AI. This ensures that images have optimal appearance for better performance.
    ...
    #' @param preferred_media_type preferred_media_type
    ...
    initialize = function(`ad_group_id` = NULL, `bid_in_micro_currency` = NULL, `catalog_product_group_id` = NULL, `catalog_product_group_name` = NULL, `collections_header_type` = NULL, `collections_hero_destination_url` = NULL, `collections_hero_pin_id` = NULL, `creative_type` = NULL, `customizable_cta_type` = NULL, `definition` = NULL, `grid_click_type` = NULL, `id` = NULL, `included` = NULL, `is_generate_background` = NULL, `is_image_auto_resizing` = NULL, `is_mdl` = NULL, `parent_id` = NULL, `preferred_media_type` = NULL, `relative_definition` = NULL, `selected_image_tag` = NULL, `selected_video_tag` = NULL, `slideshow_collections_description` = NULL, `slideshow_collections_title` = NULL, `status` = NULL, `tracking_url` = NULL, ...) {
      ...
      if (!is.null(`is_image_auto_resizing`)) {
        if (!(is.logical(`is_image_auto_resizing`) && length(`is_image_auto_resizing`) == 1)) {
          stop(paste("Error! Invalid data for `is_image_auto_resizing`. Must be a boolean:", `is_image_auto_resizing`))
        }
        self$`is_image_auto_resizing` <- `is_image_auto_resizing`
      }
      if (!is.null(`is_mdl`)) {
    ...
    toSimpleType = function() {
      ...
      if (!is.null(self$`is_image_auto_resizing`)) {
        ProductGroupPromotionObject[["is_image_auto_resizing"]] <-
          self$`is_image_auto_resizing`
      }
    ...
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`collections_header_type`)) {
        `collections_header_type_object` <- CollectionsHeaderType$new()
      ...
      if (!is.null(this_object$`customizable_cta_type`)) {
        `customizable_cta_type_object` <- ProductGroupPromotionCustomizableCTAType$new()
      ...
      if (!is.null(this_object$`is_image_auto_resizing`)) {
        self$`is_image_auto_resizing` <- this_object$`is_image_auto_resizing`
      }
      ...
      if (!is.null(this_object$`preferred_media_type`)) {
        `preferred_media_type_object` <- PreferredMediaType$new()
    ...
    fromJSONString = function(input_json) {
      ...
      self$`catalog_product_group_id` <- this_object$`catalog_product_group_id`
      self$`catalog_product_group_name` <- this_object$`catalog_product_group_name`
      self$`collections_header_type` <- CollectionsHeaderType$new()$fromJSON(jsonlite::toJSON(this_object$`collections_header_type`, auto_unbox = TRUE, digits = NA))
      self$`collections_hero_destination_url` <- this_object$`collections_hero_destination_url`
      self$`collections_hero_pin_id` <- this_object$`collections_hero_pin_id`
      self$`creative_type` <- CreativeType$new()$fromJSON(jsonlite::toJSON(this_object$`creative_type`, auto_unbox = TRUE, digits = NA))
      self$`customizable_cta_type` <- ProductGroupPromotionCustomizableCTAType$new()$fromJSON(jsonlite::toJSON(this_object$`customizable_cta_type`, auto_unbox = TRUE, digits = NA))
      self$`definition` <- this_object$`definition`
      ...
      self$`is_mdl` <- this_object$`is_mdl`
      self$`parent_id` <- this_object$`parent_id`
      self$`preferred_media_type` <- PreferredMediaType$new()$fromJSON(jsonlite::toJSON(this_object$`preferred_media_type`, auto_unbox = TRUE, digits = NA))
      self$`relative_definition` <- this_object$`relative_definition`
      self$`selected_image_tag` <- this_object$`selected_image_tag`
      self$`selected_video_tag` <- this_object$`selected_video_tag`
      self$`slideshow_collections_description` <- this_object$`slideshow_collections_description`
