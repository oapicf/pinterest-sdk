...
AudienceSubcategory <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return AudienceSubcategory as a base R list.
    #' @examples
    #' # convert array of AudienceSubcategory (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert AudienceSubcategory to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(AudienceSubcategoryObject)
    },
