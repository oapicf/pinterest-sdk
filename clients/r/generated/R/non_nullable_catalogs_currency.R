...
NonNullableCatalogsCurrency <- R6::R6Class(
    ...
    public = list(
        ...
        fromJSON = function(NonNullableCatalogsCurrencyJson) {
            private$value <- jsonlite::fromJSON(NonNullableCatalogsCurrencyJson,
        ...
        fromJSONString = function(NonNullableCatalogsCurrencyJson) {
            private$value <- jsonlite::fromJSON(NonNullableCatalogsCurrencyJson,
                simplifyVector = FALSE)
            self
        }
