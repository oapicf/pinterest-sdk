...
TargetingTemplateKeyword <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return TargetingTemplateKeyword as a base R list.
    #' @examples
    #' # convert array of TargetingTemplateKeyword (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert TargetingTemplateKeyword to a base R type
    #'
