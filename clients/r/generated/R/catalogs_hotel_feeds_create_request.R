...
CatalogsHotelFeedsCreateRequest <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(`catalog_type`, `default_locale`, `format`, `location`, `name`, `catalog_id` = NULL, `credentials` = NULL, `default_currency` = NULL, `preferred_processing_schedule` = NULL, `status` = NULL, ...) {
