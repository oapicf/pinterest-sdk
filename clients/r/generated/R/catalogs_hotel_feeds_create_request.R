...
CatalogsHotelFeedsCreateRequest <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(`catalog_type`, `default_locale`, `format`, `location`, `name`, `catalog_id` = NULL, `credentials` = NULL, `default_currency` = NULL, `preferred_processing_schedule` = NULL, `status` = "ACTIVE", ...) {
    ...
    #'
    #' @return CatalogsHotelFeedsCreateRequest as a base R list.
    #' @examples
    #' # convert array of CatalogsHotelFeedsCreateRequest (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CatalogsHotelFeedsCreateRequest to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(CatalogsHotelFeedsCreateRequestObject)
    },
