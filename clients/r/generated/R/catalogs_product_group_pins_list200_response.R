#' Create a new CatalogsProductGroupPinsList200Response
#'
#' @description
...
CatalogsProductGroupPinsList200Response <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return CatalogsProductGroupPinsList200Response as a base R list.
    #' @examples
    #' # convert array of CatalogsProductGroupPinsList200Response (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CatalogsProductGroupPinsList200Response to a base R type
    #'
    ...
    #' @description
    #' Deserialize JSON string into an instance of CatalogsProductGroupPinsList200Response
    #'
    ...
    #' @return CatalogsProductGroupPinsList200Response in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to CatalogsProductGroupPinsList200Response and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`items`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for CatalogsProductGroupPinsList200Response: the required field `items` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of CatalogsProductGroupPinsList200Response
    toString = function() {
      self$toJSONString()
    },
...
# CatalogsProductGroupPinsList200Response$unlock()
#
## Below is an example to define the print function
# CatalogsProductGroupPinsList200Response$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# CatalogsProductGroupPinsList200Response$lock()
