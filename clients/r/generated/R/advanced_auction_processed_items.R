...
AdvancedAuctionProcessedItems <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return AdvancedAuctionProcessedItems as a base R list.
    #' @examples
    #' # convert array of AdvancedAuctionProcessedItems (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert AdvancedAuctionProcessedItems to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(AdvancedAuctionProcessedItemsObject)
    },
