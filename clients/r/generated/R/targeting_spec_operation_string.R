#' Create a new TargetingSpecOperationString
#'
#' @description
#' TargetingSpecOperationString Class
#'
#' @docType class
#' @title TargetingSpecOperationString
#' @description TargetingSpecOperationString Class
...
#' @export
TargetingSpecOperationString <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new TargetingSpecOperationString class.
    #'
    #' @param field field
    ...
    #'
    #' @return TargetingSpecOperationString as a base R list.
    #' @examples
    #' # convert array of TargetingSpecOperationString (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert TargetingSpecOperationString to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      TargetingSpecOperationStringObject <- list()
      if (!is.null(self$`field`)) {
        TargetingSpecOperationStringObject[["field"]] <-
          self$`field`
      }
      if (!is.null(self$`operation`)) {
        TargetingSpecOperationStringObject[["operation"]] <-
          self$`operation`
      }
      if (!is.null(self$`value`)) {
        TargetingSpecOperationStringObject[["value"]] <-
          self$`value`
      }
      return(TargetingSpecOperationStringObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of TargetingSpecOperationString
    #'
    #' @param input_json the JSON input
    #' @return the instance of TargetingSpecOperationString
    ...
    #' @return TargetingSpecOperationString in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to TargetingSpecOperationString and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`field`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for TargetingSpecOperationString: the required field `field` is missing."))
      }
      ...
      if (!is.null(input_json$`operation`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for TargetingSpecOperationString: the required field `operation` is missing."))
      }
      ...
      if (!is.null(input_json$`value`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for TargetingSpecOperationString: the required field `value` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of TargetingSpecOperationString
    toString = function() {
      self$toJSONString()
    },
...
# TargetingSpecOperationString$unlock()
#
## Below is an example to define the print function
# TargetingSpecOperationString$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# TargetingSpecOperationString$lock()
