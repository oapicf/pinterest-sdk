...
CatalogsProductGroupFiltersRequestAnyOf <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return CatalogsProductGroupFiltersRequestAnyOf as a base R list.
    #' @examples
    #' # convert array of CatalogsProductGroupFiltersRequestAnyOf (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CatalogsProductGroupFiltersRequestAnyOf to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(CatalogsProductGroupFiltersRequestAnyOfObject)
    },
