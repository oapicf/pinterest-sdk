...
CustomerListUpdateRequest <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return CustomerListUpdateRequest as a base R list.
    #' @examples
    #' # convert array of CustomerListUpdateRequest (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CustomerListUpdateRequest to a base R type
    #'
