  ...
  public = list(
    ...
    toSimpleType = function() {
      ...
      if (!is.null(self$`ad_account_id`)) {
        AdAccountCreateSubscriptionResponseObject[["ad_account_id"]] <-
          self$`ad_account_id`
      }
      if (!is.null(self$`api_version`)) {
        AdAccountCreateSubscriptionResponseObject[["api_version"]] <-
          self$`api_version`
      }
      ...
      if (!is.null(self$`lead_form_id`)) {
        AdAccountCreateSubscriptionResponseObject[["lead_form_id"]] <-
          self$`lead_form_id`
      }
      if (!is.null(self$`user_account_id`)) {
        AdAccountCreateSubscriptionResponseObject[["user_account_id"]] <-
          self$`user_account_id`
      }
      if (!is.null(self$`webhook_url`)) {
        AdAccountCreateSubscriptionResponseObject[["webhook_url"]] <-
          self$`webhook_url`
      }
