...
AdCommon <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return AdCommon as a base R list.
    #' @examples
    #' # convert array of AdCommon (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Deserialize JSON string into an instance of AdCommon
    #'
    #' @param input_json the JSON input
    #' @return the instance of AdCommon
    ...
    #' @return AdCommon in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to AdCommon and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of AdCommon
    toString = function() {
      self$toJSONString()
    },
...
# AdCommon$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
