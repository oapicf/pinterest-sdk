#' Create a new BoardsUserFollowsList200Response
#'
#' @description
...
BoardsUserFollowsList200Response <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return BoardsUserFollowsList200Response as a base R list.
    #' @examples
    #' # convert array of BoardsUserFollowsList200Response (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert BoardsUserFollowsList200Response to a base R type
    #'
    ...
    #' @description
    #' Deserialize JSON string into an instance of BoardsUserFollowsList200Response
    #'
    ...
    #' @return BoardsUserFollowsList200Response in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to BoardsUserFollowsList200Response and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`items`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for BoardsUserFollowsList200Response: the required field `items` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of BoardsUserFollowsList200Response
    toString = function() {
      self$toJSONString()
    },
...
# BoardsUserFollowsList200Response$unlock()
#
## Below is an example to define the print function
# BoardsUserFollowsList200Response$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# BoardsUserFollowsList200Response$lock()
