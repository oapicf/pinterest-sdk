#' Create a new TargetingSpecOperationGeo
#'
#' @description
#' TargetingSpecOperationGeo Class
#'
#' @docType class
#' @title TargetingSpecOperationGeo
#' @description TargetingSpecOperationGeo Class
...
#' @export
TargetingSpecOperationGeo <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new TargetingSpecOperationGeo class.
    #'
    #' @param field field
    ...
    initialize = function(`field`, `operation`, `values`, ...) {
      if (!missing(`field`)) {
        if (!(`field` %in% c("GEO"))) {
          stop(paste("Error! \"", `field`, "\" cannot be assigned to `field`. Must be \"GEO\".", sep = ""))
        }
    ...
    #'
    #' @return TargetingSpecOperationGeo as a base R list.
    #' @examples
    #' # convert array of TargetingSpecOperationGeo (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert TargetingSpecOperationGeo to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      TargetingSpecOperationGeoObject <- list()
      if (!is.null(self$`field`)) {
        TargetingSpecOperationGeoObject[["field"]] <-
          self$`field`
      }
      if (!is.null(self$`operation`)) {
        TargetingSpecOperationGeoObject[["operation"]] <-
          self$extractSimpleType(self$`operation`)
      }
      if (!is.null(self$`values`)) {
        TargetingSpecOperationGeoObject[["values"]] <-
          self$`values`
      }
      return(TargetingSpecOperationGeoObject)
    },
    ...
    #' @description
    #' Deserialize JSON string into an instance of TargetingSpecOperationGeo
    #'
    #' @param input_json the JSON input
    #' @return the instance of TargetingSpecOperationGeo
    fromJSON = function(input_json) {
      this_object <- jsonlite::fromJSON(input_json)
      if (!is.null(this_object$`field`)) {
        if (!is.null(this_object$`field`) && !(this_object$`field` %in% c("GEO"))) {
          stop(paste("Error! \"", this_object$`field`, "\" cannot be assigned to `field`. Must be \"GEO\".", sep = ""))
        }
    ...
    #' @return TargetingSpecOperationGeo in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to TargetingSpecOperationGeo and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`field`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for TargetingSpecOperationGeo: the required field `field` is missing."))
      }
      # check the required field `operation`
      if (!is.null(input_json$`operation`)) {
        stopifnot(R6::is.R6(input_json$`operation`))
      } else {
        stop(paste("The JSON input `", input, "` is invalid for TargetingSpecOperationGeo: the required field `operation` is missing."))
      }
      ...
      if (!is.null(input_json$`values`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for TargetingSpecOperationGeo: the required field `values` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of TargetingSpecOperationGeo
    toString = function() {
      self$toJSONString()
    },
...
# TargetingSpecOperationGeo$unlock()
#
## Below is an example to define the print function
# TargetingSpecOperationGeo$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# TargetingSpecOperationGeo$lock()
