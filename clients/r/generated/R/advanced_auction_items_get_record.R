#' Create a new AdvancedAuctionItemsGetRecord
#'
#' @description
#' Object uniquely identifying a retail catalog item
#'
#' @docType class
#' @title AdvancedAuctionItemsGetRecord
#' @description AdvancedAuctionItemsGetRecord Class
...
#' @export
AdvancedAuctionItemsGetRecord <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new AdvancedAuctionItemsGetRecord class.
    #'
    ...
    #'
    #' @return AdvancedAuctionItemsGetRecord as a base R list.
    #' @examples
    #' # convert array of AdvancedAuctionItemsGetRecord (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert AdvancedAuctionItemsGetRecord to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      AdvancedAuctionItemsGetRecordObject <- list()
      if (!is.null(self$`country`)) {
        AdvancedAuctionItemsGetRecordObject[["country"]] <-
          self$`country`$toSimpleType()
      }
      if (!is.null(self$`item_id`)) {
        AdvancedAuctionItemsGetRecordObject[["item_id"]] <-
          self$`item_id`
      }
      if (!is.null(self$`language`)) {
        AdvancedAuctionItemsGetRecordObject[["language"]] <-
          self$`language`$toSimpleType()
      }
      return(AdvancedAuctionItemsGetRecordObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of AdvancedAuctionItemsGetRecord
    #'
    #' @param input_json the JSON input
    #' @return the instance of AdvancedAuctionItemsGetRecord
    ...
    #' @return AdvancedAuctionItemsGetRecord in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to AdvancedAuctionItemsGetRecord and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`country`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for AdvancedAuctionItemsGetRecord: the required field `country` is missing."))
      }
      ...
      if (!is.null(input_json$`item_id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for AdvancedAuctionItemsGetRecord: the required field `item_id` is missing."))
      }
      # check the required field `language`
      if (!is.null(input_json$`language`)) {
        stopifnot(R6::is.R6(input_json$`language`))
      } else {
        stop(paste("The JSON input `", input, "` is invalid for AdvancedAuctionItemsGetRecord: the required field `language` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of AdvancedAuctionItemsGetRecord
    toString = function() {
      self$toJSONString()
    },
...
# AdvancedAuctionItemsGetRecord$unlock()
#
## Below is an example to define the print function
# AdvancedAuctionItemsGetRecord$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# AdvancedAuctionItemsGetRecord$lock()
