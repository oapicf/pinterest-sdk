#' Create a new AdAccountsSubscriptionsGetList200Response
#'
#' @description
...
AdAccountsSubscriptionsGetList200Response <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return AdAccountsSubscriptionsGetList200Response as a base R list.
    #' @examples
    #' # convert array of AdAccountsSubscriptionsGetList200Response (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert AdAccountsSubscriptionsGetList200Response to a base R type
    #'
    ...
    #' @description
    #' Deserialize JSON string into an instance of AdAccountsSubscriptionsGetList200Response
    #'
    ...
    #' @return AdAccountsSubscriptionsGetList200Response in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to AdAccountsSubscriptionsGetList200Response and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`items`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for AdAccountsSubscriptionsGetList200Response: the required field `items` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of AdAccountsSubscriptionsGetList200Response
    toString = function() {
      self$toJSONString()
    },
...
# AdAccountsSubscriptionsGetList200Response$unlock()
#
## Below is an example to define the print function
# AdAccountsSubscriptionsGetList200Response$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# AdAccountsSubscriptionsGetList200Response$lock()
