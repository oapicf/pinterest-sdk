...
CatalogsProductGroupCurrencyCriteria <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return CatalogsProductGroupCurrencyCriteria as a base R list.
    #' @examples
    #' # convert array of CatalogsProductGroupCurrencyCriteria (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CatalogsProductGroupCurrencyCriteria to a base R type
    #'
