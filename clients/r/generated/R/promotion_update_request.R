#' Create a new PromotionUpdateRequest
#'
#' @description
#' PromotionUpdateRequest Class
#'
#' @docType class
#' @title PromotionUpdateRequest
#' @description PromotionUpdateRequest Class
...
#' @export
PromotionUpdateRequest <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new PromotionUpdateRequest class.
    #'
    ...
    initialize = function(`id`, `discount_status` = NULL, `end_time` = NULL, `external_id` = NULL, `platform_type` = NULL, `promotion_code` = NULL, `promotion_custom_id` = NULL, `promotion_title` = NULL, `promotion_type` = NULL, `start_time` = NULL, `template_values` = NULL, `status` = NULL, ...) {
      if (!missing(`id`)) {
    ...
    #'
    #' @return PromotionUpdateRequest as a base R list.
    #' @examples
    #' # convert array of PromotionUpdateRequest (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert PromotionUpdateRequest to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      PromotionUpdateRequestObject <- list()
      if (!is.null(self$`discount_status`)) {
        PromotionUpdateRequestObject[["discount_status"]] <-
          self$`discount_status`
      }
      if (!is.null(self$`end_time`)) {
        PromotionUpdateRequestObject[["end_time"]] <-
          self$`end_time`
      }
      if (!is.null(self$`external_id`)) {
        PromotionUpdateRequestObject[["external_id"]] <-
          self$`external_id`
      }
      if (!is.null(self$`platform_type`)) {
        PromotionUpdateRequestObject[["platform_type"]] <-
          self$`platform_type`
      }
      if (!is.null(self$`promotion_code`)) {
        PromotionUpdateRequestObject[["promotion_code"]] <-
          self$`promotion_code`
      }
      if (!is.null(self$`promotion_custom_id`)) {
        PromotionUpdateRequestObject[["promotion_custom_id"]] <-
          self$`promotion_custom_id`
      }
      if (!is.null(self$`promotion_title`)) {
        PromotionUpdateRequestObject[["promotion_title"]] <-
          self$`promotion_title`
      }
      if (!is.null(self$`promotion_type`)) {
        PromotionUpdateRequestObject[["promotion_type"]] <-
          self$`promotion_type`$toSimpleType()
      }
      if (!is.null(self$`start_time`)) {
        PromotionUpdateRequestObject[["start_time"]] <-
          self$`start_time`
      }
      if (!is.null(self$`template_values`)) {
        PromotionUpdateRequestObject[["template_values"]] <-
          lapply(self$`template_values`, function(x) x$toSimpleType())
      }
      if (!is.null(self$`id`)) {
        PromotionUpdateRequestObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`status`)) {
        PromotionUpdateRequestObject[["status"]] <-
          self$`status`$toSimpleType()
      }
      return(PromotionUpdateRequestObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of PromotionUpdateRequest
    #'
    #' @param input_json the JSON input
    #' @return the instance of PromotionUpdateRequest
    ...
    #' @return PromotionUpdateRequest in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to PromotionUpdateRequest and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for PromotionUpdateRequest: the required field `id` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of PromotionUpdateRequest
    toString = function() {
      self$toJSONString()
    },
...
# PromotionUpdateRequest$unlock()
#
## Below is an example to define the print function
# PromotionUpdateRequest$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# PromotionUpdateRequest$lock()
