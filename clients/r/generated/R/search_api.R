  ...
  public = list(
    ...
    SearchUserBoardsGetWithHttpInfo = function(ad_account_id = NULL, bookmark = NULL, page_size = 25, query = NULL, data_file = NULL, ...) {
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$DeserializeResponse(local_var_resp, "SearchUserBoardsGet200Response"),
          error = function(e) {
            stop("Failed to deserialize response")
          }
        )
    ...
    #' @param ... Other optional arguments
    #'
    #' @return API response (SearchUserPinsList200Response) with additional information such as HTTP status code, headers
    SearchUserPinsListWithHttpInfo = function(query, ad_account_id = NULL, bookmark = NULL, data_file = NULL, ...) {
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$DeserializeResponse(local_var_resp, "SearchUserPinsList200Response"),
          error = function(e) {
            stop("Failed to deserialize response")
          }
        )
