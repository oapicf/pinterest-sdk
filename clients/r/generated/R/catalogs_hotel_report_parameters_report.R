#' @docType class
#' @title CatalogsHotelReportParametersReport
#'
#' @description CatalogsHotelReportParametersReport Class
#'
...
#' @export
CatalogsHotelReportParametersReport <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Deserialize JSON string into an instance of CatalogsHotelReportParametersReport.
    ...
    #' @description
    #' Serialize CatalogsHotelReportParametersReport to JSON string.
    #'
    #' @return JSON string representation of the CatalogsHotelReportParametersReport.
    ...
    #' @description
    #' Serialize CatalogsHotelReportParametersReport to JSON.
    #'
    #' @return JSON representation of the CatalogsHotelReportParametersReport.
    toJSON = function() {
      if (!is.null(self$actual_instance)) {
    ...
    #' @description
    #' Validate the input JSON with respect to CatalogsHotelReportParametersReport and
...
#CatalogsHotelReportParametersReport$unlock()
#
## Below is an example to define the print function
#CatalogsHotelReportParametersReport$set("public", "print", function(...) {
#  print(jsonlite::prettify(self$toJSONString()))
#  invisible(self)
#})
## Uncomment below to lock the class to prevent modifications to the method or field
#CatalogsHotelReportParametersReport$lock()
