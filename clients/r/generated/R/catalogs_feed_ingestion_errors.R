...
CatalogsFeedIngestionErrors <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return CatalogsFeedIngestionErrors as a base R list.
    #' @examples
    #' # convert array of CatalogsFeedIngestionErrors (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CatalogsFeedIngestionErrors to a base R type
    #'
