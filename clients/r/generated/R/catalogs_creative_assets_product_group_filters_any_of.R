...
CatalogsCreativeAssetsProductGroupFiltersAnyOf <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return CatalogsCreativeAssetsProductGroupFiltersAnyOf as a base R list.
    #' @examples
    #' # convert array of CatalogsCreativeAssetsProductGroupFiltersAnyOf (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CatalogsCreativeAssetsProductGroupFiltersAnyOf to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(CatalogsCreativeAssetsProductGroupFiltersAnyOfObject)
    },
