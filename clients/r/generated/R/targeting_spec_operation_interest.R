#' Create a new TargetingSpecOperationInterest
#'
#' @description
#' TargetingSpecOperationInterest Class
#'
#' @docType class
#' @title TargetingSpecOperationInterest
#' @description TargetingSpecOperationInterest Class
...
#' @export
TargetingSpecOperationInterest <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new TargetingSpecOperationInterest class.
    #'
    #' @param field field
    ...
    initialize = function(`field`, `operation`, `values`, ...) {
      if (!missing(`field`)) {
        if (!(`field` %in% c("INTEREST"))) {
          stop(paste("Error! \"", `field`, "\" cannot be assigned to `field`. Must be \"INTEREST\".", sep = ""))
        }
    ...
    #'
    #' @return TargetingSpecOperationInterest as a base R list.
    #' @examples
    #' # convert array of TargetingSpecOperationInterest (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert TargetingSpecOperationInterest to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      TargetingSpecOperationInterestObject <- list()
      if (!is.null(self$`field`)) {
        TargetingSpecOperationInterestObject[["field"]] <-
          self$`field`
      }
      if (!is.null(self$`operation`)) {
        TargetingSpecOperationInterestObject[["operation"]] <-
          self$extractSimpleType(self$`operation`)
      }
      if (!is.null(self$`values`)) {
        TargetingSpecOperationInterestObject[["values"]] <-
          self$`values`
      }
      return(TargetingSpecOperationInterestObject)
    },
    ...
    #' @description
    #' Deserialize JSON string into an instance of TargetingSpecOperationInterest
    #'
    #' @param input_json the JSON input
    #' @return the instance of TargetingSpecOperationInterest
    fromJSON = function(input_json) {
      this_object <- jsonlite::fromJSON(input_json)
      if (!is.null(this_object$`field`)) {
        if (!is.null(this_object$`field`) && !(this_object$`field` %in% c("INTEREST"))) {
          stop(paste("Error! \"", this_object$`field`, "\" cannot be assigned to `field`. Must be \"INTEREST\".", sep = ""))
        }
    ...
    #' @return TargetingSpecOperationInterest in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to TargetingSpecOperationInterest and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`field`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for TargetingSpecOperationInterest: the required field `field` is missing."))
      }
      # check the required field `operation`
      if (!is.null(input_json$`operation`)) {
        stopifnot(R6::is.R6(input_json$`operation`))
      } else {
        stop(paste("The JSON input `", input, "` is invalid for TargetingSpecOperationInterest: the required field `operation` is missing."))
      }
      ...
      if (!is.null(input_json$`values`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for TargetingSpecOperationInterest: the required field `values` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of TargetingSpecOperationInterest
    toString = function() {
      self$toJSONString()
    },
...
# TargetingSpecOperationInterest$unlock()
#
## Below is an example to define the print function
# TargetingSpecOperationInterest$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# TargetingSpecOperationInterest$lock()
