...
PinMediaSourceImagesURLItemsInner <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return PinMediaSourceImagesURLItemsInner as a base R list.
    #' @examples
    #' # convert array of PinMediaSourceImagesURLItemsInner (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert PinMediaSourceImagesURLItemsInner to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(PinMediaSourceImagesURLItemsInnerObject)
    },
