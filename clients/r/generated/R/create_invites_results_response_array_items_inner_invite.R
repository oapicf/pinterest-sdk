...
CreateInvitesResultsResponseArrayItemsInnerInvite <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return CreateInvitesResultsResponseArrayItemsInnerInvite as a base R list.
    #' @examples
    #' # convert array of CreateInvitesResultsResponseArrayItemsInnerInvite (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CreateInvitesResultsResponseArrayItemsInnerInvite to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(CreateInvitesResultsResponseArrayItemsInnerInviteObject)
    },
