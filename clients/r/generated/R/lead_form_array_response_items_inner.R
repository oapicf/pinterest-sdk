...
LeadFormArrayResponseItemsInner <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return LeadFormArrayResponseItemsInner as a base R list.
    #' @examples
    #' # convert array of LeadFormArrayResponseItemsInner (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert LeadFormArrayResponseItemsInner to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(LeadFormArrayResponseItemsInnerObject)
    },
