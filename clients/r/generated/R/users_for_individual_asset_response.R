...
UsersForIndividualAssetResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return UsersForIndividualAssetResponse as a base R list.
    #' @examples
    #' # convert array of UsersForIndividualAssetResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert UsersForIndividualAssetResponse to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(UsersForIndividualAssetResponseObject)
    },
