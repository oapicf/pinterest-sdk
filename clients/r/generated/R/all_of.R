...
AllOf <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return AllOf as a base R list.
    #' @examples
    #' # convert array of AllOf (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert AllOf to a base R type
    #'
    ...
    #' @description
    #' Deserialize JSON string into an instance of AllOf
    #'
    #' @param input_json the JSON input
    #' @return the instance of AllOf
    ...
    #' @description
    #' Validate JSON input with respect to AllOf and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`all_of`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for AllOf: the required field `all_of` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of AllOf
    toString = function() {
      self$toJSONString()
    },
...
# AllOf$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
