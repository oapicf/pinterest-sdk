...
TrackingUrls <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return TrackingUrls as a base R list.
    #' @examples
    #' # convert array of TrackingUrls (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert TrackingUrls to a base R type
    #'
...
# TrackingUrls$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
