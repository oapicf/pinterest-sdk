...
Pin <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(`id`, `alt_text` = NULL, `board_id` = NULL, `board_owner` = NULL, `board_section_id` = NULL, `created_at` = NULL, `creative_type` = NULL, `description` = NULL, `dominant_color` = NULL, `has_been_promoted` = NULL, `is_owner` = NULL, `is_standard` = NULL, `link` = NULL, `media` = NULL, `parent_pin_id` = NULL, `pin_metrics` = NULL, `title` = NULL, ...) {
      if (!missing(`id`)) {
