...
UpdateMemberBusinessRoleBody <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return UpdateMemberBusinessRoleBody as a base R list.
    #' @examples
    #' # convert array of UpdateMemberBusinessRoleBody (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert UpdateMemberBusinessRoleBody to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(UpdateMemberBusinessRoleBodyObject)
    },
