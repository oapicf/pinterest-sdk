#' Create a new LeadSubscription
#'
#' @description
#' LeadSubscription Class
#'
#' @docType class
#' @title LeadSubscription
#' @description LeadSubscription Class
...
LeadSubscription <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new LeadSubscription class.
    #'
    ...
    initialize = function(`ad_account_id` = NULL, `api_version` = NULL, `created_time` = NULL, `cryptographic_algorithm` = NULL, `cryptographic_key` = NULL, `id` = NULL, `lead_form_id` = NULL, `user_account_id` = NULL, `webhook_url` = NULL, ...) {
    ...
    #'
    #' @return LeadSubscription as a base R list.
    #' @examples
    #' # convert array of LeadSubscription (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert LeadSubscription to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      LeadSubscriptionObject <- list()
      if (!is.null(self$`ad_account_id`)) {
        LeadSubscriptionObject[["ad_account_id"]] <-
          self$`ad_account_id`
      }
      if (!is.null(self$`api_version`)) {
        LeadSubscriptionObject[["api_version"]] <-
          self$`api_version`
      }
      if (!is.null(self$`created_time`)) {
        LeadSubscriptionObject[["created_time"]] <-
          self$`created_time`
      }
      if (!is.null(self$`cryptographic_algorithm`)) {
        LeadSubscriptionObject[["cryptographic_algorithm"]] <-
          self$`cryptographic_algorithm`
      }
      if (!is.null(self$`cryptographic_key`)) {
        LeadSubscriptionObject[["cryptographic_key"]] <-
          self$`cryptographic_key`
      }
      if (!is.null(self$`id`)) {
        LeadSubscriptionObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`lead_form_id`)) {
        LeadSubscriptionObject[["lead_form_id"]] <-
          self$`lead_form_id`
      }
      if (!is.null(self$`user_account_id`)) {
        LeadSubscriptionObject[["user_account_id"]] <-
          self$`user_account_id`
      }
      if (!is.null(self$`webhook_url`)) {
        LeadSubscriptionObject[["webhook_url"]] <-
          self$`webhook_url`
      }
      return(LeadSubscriptionObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of LeadSubscription
    #'
    #' @param input_json the JSON input
    #' @return the instance of LeadSubscription
    ...
    #' @return LeadSubscription in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to LeadSubscription and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of LeadSubscription
    toString = function() {
      self$toJSONString()
    },
...
# LeadSubscription$unlock()
#
## Below is an example to define the print function
# LeadSubscription$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# LeadSubscription$lock()
