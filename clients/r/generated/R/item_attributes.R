...
#' @field image_link <= 2000 characters. The links to the main product images. Images should be at least 75x75 pixels to avoid errors. Must start with http:// or https://. list(character) [optional]
#' @field video_link <= 2,000 characters. Hosted link to the product video. File types must be .mp4, .mov or .m4v. File size cannot exceed 2GB. character [optional]
  ...
  public = list(
    ...
    initialize = function(`ad_image_0_link` = NULL, `ad_image_0_tag` = NULL, `ad_image_10_link` = NULL, `ad_image_10_tag` = NULL, `ad_image_11_link` = NULL, `ad_image_11_tag` = NULL, `ad_image_12_link` = NULL, `ad_image_12_tag` = NULL, `ad_image_13_link` = NULL, `ad_image_13_tag` = NULL, `ad_image_14_link` = NULL, `ad_image_14_tag` = NULL, `ad_image_15_link` = NULL, `ad_image_15_tag` = NULL, `ad_image_16_link` = NULL, `ad_image_16_tag` = NULL, `ad_image_17_link` = NULL, `ad_image_17_tag` = NULL, `ad_image_18_link` = NULL, `ad_image_18_tag` = NULL, `ad_image_19_link` = NULL, `ad_image_19_tag` = NULL, `ad_image_1_link` = NULL, `ad_image_1_tag` = NULL, `ad_image_2_link` = NULL, `ad_image_2_tag` = NULL, `ad_image_3_link` = NULL, `ad_image_3_tag` = NULL, `ad_image_4_link` = NULL, `ad_image_4_tag` = NULL, `ad_image_5_link` = NULL, `ad_image_5_tag` = NULL, `ad_image_6_link` = NULL, `ad_image_6_tag` = NULL, `ad_image_7_link` = NULL, `ad_image_7_tag` = NULL, `ad_image_8_link` = NULL, `ad_image_8_tag` = NULL, `ad_image_9_link` = NULL, `ad_image_9_tag` = NULL, `ad_link` = NULL, `ad_video_0_link` = NULL, `ad_video_0_tag` = NULL, `ad_video_1_link` = NULL, `ad_video_1_tag` = NULL, `ad_video_2_link` = NULL, `ad_video_2_tag` = NULL, `adult` = NULL, `age_group` = NULL, `android_deep_link` = NULL, `availability` = NULL, `average_review_rating` = NULL, `brand` = NULL, `checkout_enabled` = NULL, `color` = NULL, `condition` = NULL, `custom_label_0` = NULL, `custom_label_1` = NULL, `custom_label_2` = NULL, `custom_label_3` = NULL, `custom_label_4` = NULL, `custom_number_0` = NULL, `custom_number_1` = NULL, `custom_number_2` = NULL, `custom_number_3` = NULL, `custom_number_4` = NULL, `description` = NULL, `free_shipping_label` = NULL, `free_shipping_limit` = NULL, `gender` = NULL, `google_product_category` = NULL, `gtin` = NULL, `id` = NULL, `installment_price` = NULL, `ios_deep_link` = NULL, `item_group_id` = NULL, `last_updated_time` = NULL, `link` = NULL, `material` = NULL, `min_ad_price` = NULL, `mobile_link` = NULL, `mpn` = NULL, `number_of_ratings` = NULL, `number_of_reviews` = NULL, `pattern` = NULL, `price` = NULL, `product_type` = NULL, `promotion_id` = NULL, `sale_price` = NULL, `sale_price_effective_date` = NULL, `shipping` = NULL, `shipping_height` = NULL, `shipping_weight` = NULL, `shipping_width` = NULL, `size` = NULL, `size_system` = NULL, `size_type` = NULL, `tax` = NULL, `title` = NULL, `unit_pricing_base_measure` = NULL, `unit_pricing_measure` = NULL, `variant_names` = NULL, `variant_values` = NULL, `additional_image_link` = NULL, `ai_disclosures` = NULL, `image_link` = NULL, `video_link` = NULL, ...) {
      if (!is.null(`ad_image_0_link`)) {
        ...
        self$`ad_image_0_link` <- `ad_image_0_link`
      }
      if (!is.null(`ad_image_0_tag`)) {
        if (!(is.character(`ad_image_0_tag`) && length(`ad_image_0_tag`) == 1)) {
          stop(paste("Error! Invalid data for `ad_image_0_tag`. Must be a string:", `ad_image_0_tag`))
        }
        self$`ad_image_0_tag` <- `ad_image_0_tag`
      }
      if (!is.null(`ad_image_10_link`)) {
        if (!(is.character(`ad_image_10_link`) && length(`ad_image_10_link`) == 1)) {
          stop(paste("Error! Invalid data for `ad_image_10_link`. Must be a string:", `ad_image_10_link`))
        }
        self$`ad_image_10_link` <- `ad_image_10_link`
      }
      if (!is.null(`ad_image_10_tag`)) {
        if (!(is.character(`ad_image_10_tag`) && length(`ad_image_10_tag`) == 1)) {
          stop(paste("Error! Invalid data for `ad_image_10_tag`. Must be a string:", `ad_image_10_tag`))
        }
        self$`ad_image_10_tag` <- `ad_image_10_tag`
      }
      if (!is.null(`ad_image_11_link`)) {
        if (!(is.character(`ad_image_11_link`) && length(`ad_image_11_link`) == 1)) {
          stop(paste("Error! Invalid data for `ad_image_11_link`. Must be a string:", `ad_image_11_link`))
        }
        self$`ad_image_11_link` <- `ad_image_11_link`
      }
      if (!is.null(`ad_image_11_tag`)) {
        if (!(is.character(`ad_image_11_tag`) && length(`ad_image_11_tag`) == 1)) {
          stop(paste("Error! Invalid data for `ad_image_11_tag`. Must be a string:", `ad_image_11_tag`))
        }
        self$`ad_image_11_tag` <- `ad_image_11_tag`
      }
      if (!is.null(`ad_image_12_link`)) {
        if (!(is.character(`ad_image_12_link`) && length(`ad_image_12_link`) == 1)) {
          stop(paste("Error! Invalid data for `ad_image_12_link`. Must be a string:", `ad_image_12_link`))
        }
        self$`ad_image_12_link` <- `ad_image_12_link`
      }
      if (!is.null(`ad_image_12_tag`)) {
        if (!(is.character(`ad_image_12_tag`) && length(`ad_image_12_tag`) == 1)) {
          stop(paste("Error! Invalid data for `ad_image_12_tag`. Must be a string:", `ad_image_12_tag`))
        }
        self$`ad_image_12_tag` <- `ad_image_12_tag`
      }
      if (!is.null(`ad_image_13_link`)) {
        if (!(is.character(`ad_image_13_link`) && length(`ad_image_13_link`) == 1)) {
          stop(paste("Error! Invalid data for `ad_image_13_link`. Must be a string:", `ad_image_13_link`))
        }
        self$`ad_image_13_link` <- `ad_image_13_link`
      }
      if (!is.null(`ad_image_13_tag`)) {
        if (!(is.character(`ad_image_13_tag`) && length(`ad_image_13_tag`) == 1)) {
          stop(paste("Error! Invalid data for `ad_image_13_tag`. Must be a string:", `ad_image_13_tag`))
        }
        self$`ad_image_13_tag` <- `ad_image_13_tag`
      }
      if (!is.null(`ad_image_14_link`)) {
        if (!(is.character(`ad_image_14_link`) && length(`ad_image_14_link`) == 1)) {
          stop(paste("Error! Invalid data for `ad_image_14_link`. Must be a string:", `ad_image_14_link`))
        }
        self$`ad_image_14_link` <- `ad_image_14_link`
      }
      if (!is.null(`ad_image_14_tag`)) {
        if (!(is.character(`ad_image_14_tag`) && length(`ad_image_14_tag`) == 1)) {
          stop(paste("Error! Invalid data for `ad_image_14_tag`. Must be a string:", `ad_image_14_tag`))
        }
        self$`ad_image_14_tag` <- `ad_image_14_tag`
      }
      if (!is.null(`ad_image_15_link`)) {
        if (!(is.character(`ad_image_15_link`) && length(`ad_image_15_link`) == 1)) {
          stop(paste("Error! Invalid data for `ad_image_15_link`. Must be a string:", `ad_image_15_link`))
        }
        self$`ad_image_15_link` <- `ad_image_15_link`
      }
      if (!is.null(`ad_image_15_tag`)) {
        if (!(is.character(`ad_image_15_tag`) && length(`ad_image_15_tag`) == 1)) {
          stop(paste("Error! Invalid data for `ad_image_15_tag`. Must be a string:", `ad_image_15_tag`))
        }
        self$`ad_image_15_tag` <- `ad_image_15_tag`
      }
      if (!is.null(`ad_image_16_link`)) {
        if (!(is.character(`ad_image_16_link`) && length(`ad_image_16_link`) == 1)) {
          stop(paste("Error! Invalid data for `ad_image_16_link`. Must be a string:", `ad_image_16_link`))
        }
        self$`ad_image_16_link` <- `ad_image_16_link`
      }
      if (!is.null(`ad_image_16_tag`)) {
        if (!(is.character(`ad_image_16_tag`) && length(`ad_image_16_tag`) == 1)) {
          stop(paste("Error! Invalid data for `ad_image_16_tag`. Must be a string:", `ad_image_16_tag`))
        }
        self$`ad_image_16_tag` <- `ad_image_16_tag`
      }
      if (!is.null(`ad_image_17_link`)) {
        if (!(is.character(`ad_image_17_link`) && length(`ad_image_17_link`) == 1)) {
          stop(paste("Error! Invalid data for `ad_image_17_link`. Must be a string:", `ad_image_17_link`))
        }
        self$`ad_image_17_link` <- `ad_image_17_link`
      }
      if (!is.null(`ad_image_17_tag`)) {
        if (!(is.character(`ad_image_17_tag`) && length(`ad_image_17_tag`) == 1)) {
          stop(paste("Error! Invalid data for `ad_image_17_tag`. Must be a string:", `ad_image_17_tag`))
        }
        self$`ad_image_17_tag` <- `ad_image_17_tag`
      }
      if (!is.null(`ad_image_18_link`)) {
        if (!(is.character(`ad_image_18_link`) && length(`ad_image_18_link`) == 1)) {
          stop(paste("Error! Invalid data for `ad_image_18_link`. Must be a string:", `ad_image_18_link`))
        }
        self$`ad_image_18_link` <- `ad_image_18_link`
      }
      if (!is.null(`ad_image_18_tag`)) {
        if (!(is.character(`ad_image_18_tag`) && length(`ad_image_18_tag`) == 1)) {
          stop(paste("Error! Invalid data for `ad_image_18_tag`. Must be a string:", `ad_image_18_tag`))
        }
        self$`ad_image_18_tag` <- `ad_image_18_tag`
      }
      if (!is.null(`ad_image_19_link`)) {
        if (!(is.character(`ad_image_19_link`) && length(`ad_image_19_link`) == 1)) {
          stop(paste("Error! Invalid data for `ad_image_19_link`. Must be a string:", `ad_image_19_link`))
        }
        self$`ad_image_19_link` <- `ad_image_19_link`
      }
      if (!is.null(`ad_image_19_tag`)) {
        if (!(is.character(`ad_image_19_tag`) && length(`ad_image_19_tag`) == 1)) {
          stop(paste("Error! Invalid data for `ad_image_19_tag`. Must be a string:", `ad_image_19_tag`))
        }
        self$`ad_image_19_tag` <- `ad_image_19_tag`
      }
      if (!is.null(`ad_image_1_link`)) {
        if (!(is.character(`ad_image_1_link`) && length(`ad_image_1_link`) == 1)) {
          stop(paste("Error! Invalid data for `ad_image_1_link`. Must be a string:", `ad_image_1_link`))
        }
        self$`ad_image_1_link` <- `ad_image_1_link`
      }
      if (!is.null(`ad_image_1_tag`)) {
        if (!(is.character(`ad_image_1_tag`) && length(`ad_image_1_tag`) == 1)) {
          stop(paste("Error! Invalid data for `ad_image_1_tag`. Must be a string:", `ad_image_1_tag`))
        }
        self$`ad_image_1_tag` <- `ad_image_1_tag`
      }
      if (!is.null(`ad_image_2_link`)) {
        if (!(is.character(`ad_image_2_link`) && length(`ad_image_2_link`) == 1)) {
          stop(paste("Error! Invalid data for `ad_image_2_link`. Must be a string:", `ad_image_2_link`))
        }
        self$`ad_image_2_link` <- `ad_image_2_link`
      }
      if (!is.null(`ad_image_2_tag`)) {
        if (!(is.character(`ad_image_2_tag`) && length(`ad_image_2_tag`) == 1)) {
          stop(paste("Error! Invalid data for `ad_image_2_tag`. Must be a string:", `ad_image_2_tag`))
        }
        self$`ad_image_2_tag` <- `ad_image_2_tag`
      }
      if (!is.null(`ad_image_3_link`)) {
        if (!(is.character(`ad_image_3_link`) && length(`ad_image_3_link`) == 1)) {
          stop(paste("Error! Invalid data for `ad_image_3_link`. Must be a string:", `ad_image_3_link`))
        }
        self$`ad_image_3_link` <- `ad_image_3_link`
      }
      if (!is.null(`ad_image_3_tag`)) {
        if (!(is.character(`ad_image_3_tag`) && length(`ad_image_3_tag`) == 1)) {
          stop(paste("Error! Invalid data for `ad_image_3_tag`. Must be a string:", `ad_image_3_tag`))
        }
        self$`ad_image_3_tag` <- `ad_image_3_tag`
      }
      if (!is.null(`ad_image_4_link`)) {
        if (!(is.character(`ad_image_4_link`) && length(`ad_image_4_link`) == 1)) {
          stop(paste("Error! Invalid data for `ad_image_4_link`. Must be a string:", `ad_image_4_link`))
        }
        self$`ad_image_4_link` <- `ad_image_4_link`
      }
      if (!is.null(`ad_image_4_tag`)) {
        if (!(is.character(`ad_image_4_tag`) && length(`ad_image_4_tag`) == 1)) {
          stop(paste("Error! Invalid data for `ad_image_4_tag`. Must be a string:", `ad_image_4_tag`))
        }
        self$`ad_image_4_tag` <- `ad_image_4_tag`
      }
      if (!is.null(`ad_image_5_link`)) {
        if (!(is.character(`ad_image_5_link`) && length(`ad_image_5_link`) == 1)) {
          stop(paste("Error! Invalid data for `ad_image_5_link`. Must be a string:", `ad_image_5_link`))
        }
        self$`ad_image_5_link` <- `ad_image_5_link`
      }
      if (!is.null(`ad_image_5_tag`)) {
        if (!(is.character(`ad_image_5_tag`) && length(`ad_image_5_tag`) == 1)) {
          stop(paste("Error! Invalid data for `ad_image_5_tag`. Must be a string:", `ad_image_5_tag`))
        }
        self$`ad_image_5_tag` <- `ad_image_5_tag`
      }
      if (!is.null(`ad_image_6_link`)) {
        if (!(is.character(`ad_image_6_link`) && length(`ad_image_6_link`) == 1)) {
          stop(paste("Error! Invalid data for `ad_image_6_link`. Must be a string:", `ad_image_6_link`))
        }
        self$`ad_image_6_link` <- `ad_image_6_link`
      }
      if (!is.null(`ad_image_6_tag`)) {
        if (!(is.character(`ad_image_6_tag`) && length(`ad_image_6_tag`) == 1)) {
          stop(paste("Error! Invalid data for `ad_image_6_tag`. Must be a string:", `ad_image_6_tag`))
        }
        self$`ad_image_6_tag` <- `ad_image_6_tag`
      }
      if (!is.null(`ad_image_7_link`)) {
        if (!(is.character(`ad_image_7_link`) && length(`ad_image_7_link`) == 1)) {
          stop(paste("Error! Invalid data for `ad_image_7_link`. Must be a string:", `ad_image_7_link`))
        }
        self$`ad_image_7_link` <- `ad_image_7_link`
      }
      if (!is.null(`ad_image_7_tag`)) {
        if (!(is.character(`ad_image_7_tag`) && length(`ad_image_7_tag`) == 1)) {
          stop(paste("Error! Invalid data for `ad_image_7_tag`. Must be a string:", `ad_image_7_tag`))
        }
        self$`ad_image_7_tag` <- `ad_image_7_tag`
      }
      if (!is.null(`ad_image_8_link`)) {
        if (!(is.character(`ad_image_8_link`) && length(`ad_image_8_link`) == 1)) {
          stop(paste("Error! Invalid data for `ad_image_8_link`. Must be a string:", `ad_image_8_link`))
        }
        self$`ad_image_8_link` <- `ad_image_8_link`
      }
      if (!is.null(`ad_image_8_tag`)) {
        if (!(is.character(`ad_image_8_tag`) && length(`ad_image_8_tag`) == 1)) {
          stop(paste("Error! Invalid data for `ad_image_8_tag`. Must be a string:", `ad_image_8_tag`))
        }
        self$`ad_image_8_tag` <- `ad_image_8_tag`
      }
      if (!is.null(`ad_image_9_link`)) {
        if (!(is.character(`ad_image_9_link`) && length(`ad_image_9_link`) == 1)) {
          stop(paste("Error! Invalid data for `ad_image_9_link`. Must be a string:", `ad_image_9_link`))
        }
        self$`ad_image_9_link` <- `ad_image_9_link`
      }
      if (!is.null(`ad_image_9_tag`)) {
        if (!(is.character(`ad_image_9_tag`) && length(`ad_image_9_tag`) == 1)) {
          stop(paste("Error! Invalid data for `ad_image_9_tag`. Must be a string:", `ad_image_9_tag`))
        }
        self$`ad_image_9_tag` <- `ad_image_9_tag`
      }
      if (!is.null(`ad_link`)) {
      ...
      if (!is.null(`ad_video_0_link`)) {
        if (!(is.character(`ad_video_0_link`) && length(`ad_video_0_link`) == 1)) {
          stop(paste("Error! Invalid data for `ad_video_0_link`. Must be a string:", `ad_video_0_link`))
        }
        self$`ad_video_0_link` <- `ad_video_0_link`
      }
      if (!is.null(`ad_video_0_tag`)) {
        if (!(is.character(`ad_video_0_tag`) && length(`ad_video_0_tag`) == 1)) {
          stop(paste("Error! Invalid data for `ad_video_0_tag`. Must be a string:", `ad_video_0_tag`))
        }
        self$`ad_video_0_tag` <- `ad_video_0_tag`
      }
      if (!is.null(`ad_video_1_link`)) {
        if (!(is.character(`ad_video_1_link`) && length(`ad_video_1_link`) == 1)) {
          stop(paste("Error! Invalid data for `ad_video_1_link`. Must be a string:", `ad_video_1_link`))
        }
        self$`ad_video_1_link` <- `ad_video_1_link`
      }
      if (!is.null(`ad_video_1_tag`)) {
        if (!(is.character(`ad_video_1_tag`) && length(`ad_video_1_tag`) == 1)) {
          stop(paste("Error! Invalid data for `ad_video_1_tag`. Must be a string:", `ad_video_1_tag`))
        }
        self$`ad_video_1_tag` <- `ad_video_1_tag`
      }
      if (!is.null(`ad_video_2_link`)) {
        if (!(is.character(`ad_video_2_link`) && length(`ad_video_2_link`) == 1)) {
          stop(paste("Error! Invalid data for `ad_video_2_link`. Must be a string:", `ad_video_2_link`))
        }
        self$`ad_video_2_link` <- `ad_video_2_link`
      }
      if (!is.null(`ad_video_2_tag`)) {
        if (!(is.character(`ad_video_2_tag`) && length(`ad_video_2_tag`) == 1)) {
          stop(paste("Error! Invalid data for `ad_video_2_tag`. Must be a string:", `ad_video_2_tag`))
        }
      ...
      if (!is.null(`custom_number_0`)) {
        if (!(is.numeric(`custom_number_0`) && length(`custom_number_0`) == 1)) {
          stop(paste("Error! Invalid data for `custom_number_0`. Must be an integer:", `custom_number_0`))
        }
        self$`custom_number_0` <- `custom_number_0`
      }
      if (!is.null(`custom_number_1`)) {
        if (!(is.numeric(`custom_number_1`) && length(`custom_number_1`) == 1)) {
          stop(paste("Error! Invalid data for `custom_number_1`. Must be an integer:", `custom_number_1`))
        }
        self$`custom_number_1` <- `custom_number_1`
      }
      if (!is.null(`custom_number_2`)) {
        if (!(is.numeric(`custom_number_2`) && length(`custom_number_2`) == 1)) {
          stop(paste("Error! Invalid data for `custom_number_2`. Must be an integer:", `custom_number_2`))
        }
        self$`custom_number_2` <- `custom_number_2`
      }
      if (!is.null(`custom_number_3`)) {
        if (!(is.numeric(`custom_number_3`) && length(`custom_number_3`) == 1)) {
          stop(paste("Error! Invalid data for `custom_number_3`. Must be an integer:", `custom_number_3`))
        }
        self$`custom_number_3` <- `custom_number_3`
      }
      if (!is.null(`custom_number_4`)) {
        if (!(is.numeric(`custom_number_4`) && length(`custom_number_4`) == 1)) {
          stop(paste("Error! Invalid data for `custom_number_4`. Must be an integer:", `custom_number_4`))
        }
      ...
      if (!is.null(`sale_price_effective_date`)) {
        if (!(is.character(`sale_price_effective_date`) && length(`sale_price_effective_date`) == 1)) {
          stop(paste("Error! Invalid data for `sale_price_effective_date`. Must be a string:", `sale_price_effective_date`))
        }
      ...
      if (!is.null(`unit_pricing_base_measure`)) {
        if (!(is.character(`unit_pricing_base_measure`) && length(`unit_pricing_base_measure`) == 1)) {
          stop(paste("Error! Invalid data for `unit_pricing_base_measure`. Must be a string:", `unit_pricing_base_measure`))
        }
        self$`unit_pricing_base_measure` <- `unit_pricing_base_measure`
      }
      if (!is.null(`unit_pricing_measure`)) {
        if (!(is.character(`unit_pricing_measure`) && length(`unit_pricing_measure`) == 1)) {
          stop(paste("Error! Invalid data for `unit_pricing_measure`. Must be a string:", `unit_pricing_measure`))
        }
    ...
    #'
    #' @return ItemAttributes as a base R list.
    #' @examples
    #' # convert array of ItemAttributes (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ItemAttributes to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      ItemAttributesObject <- list()
      if (!is.null(self$`ad_image_0_link`)) {
        ItemAttributesObject[["ad_image_0_link"]] <-
          self$`ad_image_0_link`
      }
      if (!is.null(self$`ad_image_0_tag`)) {
        ItemAttributesObject[["ad_image_0_tag"]] <-
          self$`ad_image_0_tag`
      }
      if (!is.null(self$`ad_image_10_link`)) {
        ItemAttributesObject[["ad_image_10_link"]] <-
          self$`ad_image_10_link`
      }
      if (!is.null(self$`ad_image_10_tag`)) {
        ItemAttributesObject[["ad_image_10_tag"]] <-
          self$`ad_image_10_tag`
      }
      if (!is.null(self$`ad_image_11_link`)) {
        ItemAttributesObject[["ad_image_11_link"]] <-
          self$`ad_image_11_link`
      }
      if (!is.null(self$`ad_image_11_tag`)) {
        ItemAttributesObject[["ad_image_11_tag"]] <-
          self$`ad_image_11_tag`
      }
      if (!is.null(self$`ad_image_12_link`)) {
        ItemAttributesObject[["ad_image_12_link"]] <-
          self$`ad_image_12_link`
      }
      if (!is.null(self$`ad_image_12_tag`)) {
        ItemAttributesObject[["ad_image_12_tag"]] <-
          self$`ad_image_12_tag`
      }
      if (!is.null(self$`ad_image_13_link`)) {
        ItemAttributesObject[["ad_image_13_link"]] <-
          self$`ad_image_13_link`
      }
      if (!is.null(self$`ad_image_13_tag`)) {
        ItemAttributesObject[["ad_image_13_tag"]] <-
          self$`ad_image_13_tag`
      }
      if (!is.null(self$`ad_image_14_link`)) {
        ItemAttributesObject[["ad_image_14_link"]] <-
          self$`ad_image_14_link`
      }
      if (!is.null(self$`ad_image_14_tag`)) {
        ItemAttributesObject[["ad_image_14_tag"]] <-
          self$`ad_image_14_tag`
      }
      if (!is.null(self$`ad_image_15_link`)) {
        ItemAttributesObject[["ad_image_15_link"]] <-
          self$`ad_image_15_link`
      }
      if (!is.null(self$`ad_image_15_tag`)) {
        ItemAttributesObject[["ad_image_15_tag"]] <-
          self$`ad_image_15_tag`
      }
      if (!is.null(self$`ad_image_16_link`)) {
        ItemAttributesObject[["ad_image_16_link"]] <-
          self$`ad_image_16_link`
      }
      if (!is.null(self$`ad_image_16_tag`)) {
        ItemAttributesObject[["ad_image_16_tag"]] <-
          self$`ad_image_16_tag`
      }
      if (!is.null(self$`ad_image_17_link`)) {
        ItemAttributesObject[["ad_image_17_link"]] <-
          self$`ad_image_17_link`
      }
      if (!is.null(self$`ad_image_17_tag`)) {
        ItemAttributesObject[["ad_image_17_tag"]] <-
          self$`ad_image_17_tag`
      }
      if (!is.null(self$`ad_image_18_link`)) {
        ItemAttributesObject[["ad_image_18_link"]] <-
          self$`ad_image_18_link`
      }
      if (!is.null(self$`ad_image_18_tag`)) {
        ItemAttributesObject[["ad_image_18_tag"]] <-
          self$`ad_image_18_tag`
      }
      if (!is.null(self$`ad_image_19_link`)) {
        ItemAttributesObject[["ad_image_19_link"]] <-
          self$`ad_image_19_link`
      }
      if (!is.null(self$`ad_image_19_tag`)) {
        ItemAttributesObject[["ad_image_19_tag"]] <-
          self$`ad_image_19_tag`
      }
      if (!is.null(self$`ad_image_1_link`)) {
        ItemAttributesObject[["ad_image_1_link"]] <-
          self$`ad_image_1_link`
      }
      if (!is.null(self$`ad_image_1_tag`)) {
        ItemAttributesObject[["ad_image_1_tag"]] <-
          self$`ad_image_1_tag`
      }
      if (!is.null(self$`ad_image_2_link`)) {
        ItemAttributesObject[["ad_image_2_link"]] <-
          self$`ad_image_2_link`
      }
      if (!is.null(self$`ad_image_2_tag`)) {
        ItemAttributesObject[["ad_image_2_tag"]] <-
          self$`ad_image_2_tag`
      }
      if (!is.null(self$`ad_image_3_link`)) {
        ItemAttributesObject[["ad_image_3_link"]] <-
          self$`ad_image_3_link`
      }
      if (!is.null(self$`ad_image_3_tag`)) {
        ItemAttributesObject[["ad_image_3_tag"]] <-
          self$`ad_image_3_tag`
      }
      if (!is.null(self$`ad_image_4_link`)) {
        ItemAttributesObject[["ad_image_4_link"]] <-
          self$`ad_image_4_link`
      }
      if (!is.null(self$`ad_image_4_tag`)) {
        ItemAttributesObject[["ad_image_4_tag"]] <-
          self$`ad_image_4_tag`
      }
      if (!is.null(self$`ad_image_5_link`)) {
        ItemAttributesObject[["ad_image_5_link"]] <-
          self$`ad_image_5_link`
      }
      if (!is.null(self$`ad_image_5_tag`)) {
        ItemAttributesObject[["ad_image_5_tag"]] <-
          self$`ad_image_5_tag`
      }
      if (!is.null(self$`ad_image_6_link`)) {
        ItemAttributesObject[["ad_image_6_link"]] <-
          self$`ad_image_6_link`
      }
      if (!is.null(self$`ad_image_6_tag`)) {
        ItemAttributesObject[["ad_image_6_tag"]] <-
          self$`ad_image_6_tag`
      }
      if (!is.null(self$`ad_image_7_link`)) {
        ItemAttributesObject[["ad_image_7_link"]] <-
          self$`ad_image_7_link`
      }
      if (!is.null(self$`ad_image_7_tag`)) {
        ItemAttributesObject[["ad_image_7_tag"]] <-
          self$`ad_image_7_tag`
      }
      if (!is.null(self$`ad_image_8_link`)) {
        ItemAttributesObject[["ad_image_8_link"]] <-
          self$`ad_image_8_link`
      }
      if (!is.null(self$`ad_image_8_tag`)) {
        ItemAttributesObject[["ad_image_8_tag"]] <-
          self$`ad_image_8_tag`
      }
      if (!is.null(self$`ad_image_9_link`)) {
        ItemAttributesObject[["ad_image_9_link"]] <-
          self$`ad_image_9_link`
      }
      if (!is.null(self$`ad_image_9_tag`)) {
        ItemAttributesObject[["ad_image_9_tag"]] <-
          self$`ad_image_9_tag`
      }
      ...
      if (!is.null(self$`ad_video_0_link`)) {
        ItemAttributesObject[["ad_video_0_link"]] <-
          self$`ad_video_0_link`
      }
      if (!is.null(self$`ad_video_0_tag`)) {
        ItemAttributesObject[["ad_video_0_tag"]] <-
          self$`ad_video_0_tag`
      }
      if (!is.null(self$`ad_video_1_link`)) {
        ItemAttributesObject[["ad_video_1_link"]] <-
          self$`ad_video_1_link`
      }
      if (!is.null(self$`ad_video_1_tag`)) {
        ItemAttributesObject[["ad_video_1_tag"]] <-
          self$`ad_video_1_tag`
      }
      if (!is.null(self$`ad_video_2_link`)) {
        ItemAttributesObject[["ad_video_2_link"]] <-
          self$`ad_video_2_link`
      }
      if (!is.null(self$`ad_video_2_tag`)) {
        ItemAttributesObject[["ad_video_2_tag"]] <-
          self$`ad_video_2_tag`
      }
      ...
      if (!is.null(self$`android_deep_link`)) {
        ItemAttributesObject[["android_deep_link"]] <-
      ...
      if (!is.null(self$`checkout_enabled`)) {
        ItemAttributesObject[["checkout_enabled"]] <-
      ...
      if (!is.null(self$`custom_number_0`)) {
        ItemAttributesObject[["custom_number_0"]] <-
          self$`custom_number_0`
      }
      if (!is.null(self$`custom_number_1`)) {
        ItemAttributesObject[["custom_number_1"]] <-
          self$`custom_number_1`
      }
      if (!is.null(self$`custom_number_2`)) {
        ItemAttributesObject[["custom_number_2"]] <-
          self$`custom_number_2`
      }
      if (!is.null(self$`custom_number_3`)) {
        ItemAttributesObject[["custom_number_3"]] <-
          self$`custom_number_3`
      }
      if (!is.null(self$`custom_number_4`)) {
        ItemAttributesObject[["custom_number_4"]] <-
      ...
      if (!is.null(self$`installment_price`)) {
        ItemAttributesObject[["installment_price"]] <-
          self$`installment_price`
      }
      if (!is.null(self$`ios_deep_link`)) {
        ItemAttributesObject[["ios_deep_link"]] <-
          self$`ios_deep_link`
      }
      ...
      if (!is.null(self$`promotion_id`)) {
        ItemAttributesObject[["promotion_id"]] <-
          self$`promotion_id`
      }
      ...
      if (!is.null(self$`sale_price_effective_date`)) {
        ItemAttributesObject[["sale_price_effective_date"]] <-
      ...
      if (!is.null(self$`unit_pricing_base_measure`)) {
        ItemAttributesObject[["unit_pricing_base_measure"]] <-
          self$`unit_pricing_base_measure`
      }
      if (!is.null(self$`unit_pricing_measure`)) {
        ItemAttributesObject[["unit_pricing_measure"]] <-
          self$`unit_pricing_measure`
      }
      if (!is.null(self$`variant_names`)) {
        ItemAttributesObject[["variant_names"]] <-
          self$`variant_names`
      }
      if (!is.null(self$`variant_values`)) {
        ItemAttributesObject[["variant_values"]] <-
          self$`variant_values`
      }
      ...
      if (!is.null(self$`ai_disclosures`)) {
        ItemAttributesObject[["ai_disclosures"]] <-
    ...
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`ad_image_0_link`)) {
        self$`ad_image_0_link` <- this_object$`ad_image_0_link`
      }
      if (!is.null(this_object$`ad_image_0_tag`)) {
        self$`ad_image_0_tag` <- this_object$`ad_image_0_tag`
      }
      if (!is.null(this_object$`ad_image_10_link`)) {
        self$`ad_image_10_link` <- this_object$`ad_image_10_link`
      }
      if (!is.null(this_object$`ad_image_10_tag`)) {
        self$`ad_image_10_tag` <- this_object$`ad_image_10_tag`
      }
      if (!is.null(this_object$`ad_image_11_link`)) {
        self$`ad_image_11_link` <- this_object$`ad_image_11_link`
      }
      if (!is.null(this_object$`ad_image_11_tag`)) {
        self$`ad_image_11_tag` <- this_object$`ad_image_11_tag`
      }
      if (!is.null(this_object$`ad_image_12_link`)) {
        self$`ad_image_12_link` <- this_object$`ad_image_12_link`
      }
      if (!is.null(this_object$`ad_image_12_tag`)) {
        self$`ad_image_12_tag` <- this_object$`ad_image_12_tag`
      }
      if (!is.null(this_object$`ad_image_13_link`)) {
        self$`ad_image_13_link` <- this_object$`ad_image_13_link`
      }
      if (!is.null(this_object$`ad_image_13_tag`)) {
        self$`ad_image_13_tag` <- this_object$`ad_image_13_tag`
      }
      if (!is.null(this_object$`ad_image_14_link`)) {
        self$`ad_image_14_link` <- this_object$`ad_image_14_link`
      }
      if (!is.null(this_object$`ad_image_14_tag`)) {
        self$`ad_image_14_tag` <- this_object$`ad_image_14_tag`
      }
      if (!is.null(this_object$`ad_image_15_link`)) {
        self$`ad_image_15_link` <- this_object$`ad_image_15_link`
      }
      if (!is.null(this_object$`ad_image_15_tag`)) {
        self$`ad_image_15_tag` <- this_object$`ad_image_15_tag`
      }
      if (!is.null(this_object$`ad_image_16_link`)) {
        self$`ad_image_16_link` <- this_object$`ad_image_16_link`
      }
      if (!is.null(this_object$`ad_image_16_tag`)) {
        self$`ad_image_16_tag` <- this_object$`ad_image_16_tag`
      }
      if (!is.null(this_object$`ad_image_17_link`)) {
        self$`ad_image_17_link` <- this_object$`ad_image_17_link`
      }
      if (!is.null(this_object$`ad_image_17_tag`)) {
        self$`ad_image_17_tag` <- this_object$`ad_image_17_tag`
      }
      if (!is.null(this_object$`ad_image_18_link`)) {
        self$`ad_image_18_link` <- this_object$`ad_image_18_link`
      }
      if (!is.null(this_object$`ad_image_18_tag`)) {
        self$`ad_image_18_tag` <- this_object$`ad_image_18_tag`
      }
      if (!is.null(this_object$`ad_image_19_link`)) {
        self$`ad_image_19_link` <- this_object$`ad_image_19_link`
      }
      if (!is.null(this_object$`ad_image_19_tag`)) {
        self$`ad_image_19_tag` <- this_object$`ad_image_19_tag`
      }
      if (!is.null(this_object$`ad_image_1_link`)) {
        self$`ad_image_1_link` <- this_object$`ad_image_1_link`
      }
      if (!is.null(this_object$`ad_image_1_tag`)) {
        self$`ad_image_1_tag` <- this_object$`ad_image_1_tag`
      }
      if (!is.null(this_object$`ad_image_2_link`)) {
        self$`ad_image_2_link` <- this_object$`ad_image_2_link`
      }
      if (!is.null(this_object$`ad_image_2_tag`)) {
        self$`ad_image_2_tag` <- this_object$`ad_image_2_tag`
      }
      if (!is.null(this_object$`ad_image_3_link`)) {
        self$`ad_image_3_link` <- this_object$`ad_image_3_link`
      }
      if (!is.null(this_object$`ad_image_3_tag`)) {
        self$`ad_image_3_tag` <- this_object$`ad_image_3_tag`
      }
      if (!is.null(this_object$`ad_image_4_link`)) {
        self$`ad_image_4_link` <- this_object$`ad_image_4_link`
      }
      if (!is.null(this_object$`ad_image_4_tag`)) {
        self$`ad_image_4_tag` <- this_object$`ad_image_4_tag`
      }
      if (!is.null(this_object$`ad_image_5_link`)) {
        self$`ad_image_5_link` <- this_object$`ad_image_5_link`
      }
      if (!is.null(this_object$`ad_image_5_tag`)) {
        self$`ad_image_5_tag` <- this_object$`ad_image_5_tag`
      }
      if (!is.null(this_object$`ad_image_6_link`)) {
        self$`ad_image_6_link` <- this_object$`ad_image_6_link`
      }
      if (!is.null(this_object$`ad_image_6_tag`)) {
        self$`ad_image_6_tag` <- this_object$`ad_image_6_tag`
      }
      if (!is.null(this_object$`ad_image_7_link`)) {
        self$`ad_image_7_link` <- this_object$`ad_image_7_link`
      }
      if (!is.null(this_object$`ad_image_7_tag`)) {
        self$`ad_image_7_tag` <- this_object$`ad_image_7_tag`
      }
      if (!is.null(this_object$`ad_image_8_link`)) {
        self$`ad_image_8_link` <- this_object$`ad_image_8_link`
      }
      if (!is.null(this_object$`ad_image_8_tag`)) {
        self$`ad_image_8_tag` <- this_object$`ad_image_8_tag`
      }
      if (!is.null(this_object$`ad_image_9_link`)) {
        self$`ad_image_9_link` <- this_object$`ad_image_9_link`
      }
      if (!is.null(this_object$`ad_image_9_tag`)) {
        self$`ad_image_9_tag` <- this_object$`ad_image_9_tag`
      }
      if (!is.null(this_object$`ad_link`)) {
        self$`ad_link` <- this_object$`ad_link`
      }
      if (!is.null(this_object$`ad_video_0_link`)) {
        self$`ad_video_0_link` <- this_object$`ad_video_0_link`
      }
      if (!is.null(this_object$`ad_video_0_tag`)) {
        self$`ad_video_0_tag` <- this_object$`ad_video_0_tag`
      }
      if (!is.null(this_object$`ad_video_1_link`)) {
        self$`ad_video_1_link` <- this_object$`ad_video_1_link`
      }
      if (!is.null(this_object$`ad_video_1_tag`)) {
        self$`ad_video_1_tag` <- this_object$`ad_video_1_tag`
      }
      if (!is.null(this_object$`ad_video_2_link`)) {
      ...
      if (!is.null(this_object$`custom_number_0`)) {
        self$`custom_number_0` <- this_object$`custom_number_0`
      }
      if (!is.null(this_object$`custom_number_1`)) {
        self$`custom_number_1` <- this_object$`custom_number_1`
      }
      if (!is.null(this_object$`custom_number_2`)) {
        self$`custom_number_2` <- this_object$`custom_number_2`
      }
      if (!is.null(this_object$`custom_number_3`)) {
        self$`custom_number_3` <- this_object$`custom_number_3`
      }
      if (!is.null(this_object$`custom_number_4`)) {
        self$`custom_number_4` <- this_object$`custom_number_4`
      }
      ...
      if (!is.null(this_object$`gtin`)) {
        `gtin_object` <- UpdatableItemAttributesGtin$new()
        `gtin_object`$fromJSON(jsonlite::toJSON(this_object$`gtin`, auto_unbox = TRUE, digits = NA))
        self$`gtin` <- `gtin_object`
      }
      ...
      if (!is.null(this_object$`unit_pricing_base_measure`)) {
        self$`unit_pricing_base_measure` <- this_object$`unit_pricing_base_measure`
      }
      if (!is.null(this_object$`unit_pricing_measure`)) {
    ...
    isValid = function() {
      ...
      if (nchar(self$`custom_label_1`) > 511) {
        return(FALSE)
      }

      if (nchar(self$`custom_label_2`) > 511) {
        return(FALSE)
      }

      if (nchar(self$`custom_label_3`) > 511) {
        return(FALSE)
      }

      if (nchar(self$`custom_label_4`) > 511) {
        return(FALSE)
      }
    ...
    getInvalidFields = function() {
      ...
      if (nchar(self$`custom_label_1`) > 511) {
        invalid_fields["custom_label_1"] <- "Invalid length for `custom_label_1`, must be smaller than or equal to 511."
      }

      if (nchar(self$`custom_label_2`) > 511) {
        invalid_fields["custom_label_2"] <- "Invalid length for `custom_label_2`, must be smaller than or equal to 511."
      }

      if (nchar(self$`custom_label_3`) > 511) {
        invalid_fields["custom_label_3"] <- "Invalid length for `custom_label_3`, must be smaller than or equal to 511."
      }

      if (nchar(self$`custom_label_4`) > 511) {
        invalid_fields["custom_label_4"] <- "Invalid length for `custom_label_4`, must be smaller than or equal to 511."
      }

      if (length(self$`image_link`) < 1) {
        invalid_fields["image_link"] <- "Invalid length for ``, number of items must be greater than or equal to 1."
      }
...
# ItemAttributes$unlock()
#
## Below is an example to define the print function
# ItemAttributes$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
