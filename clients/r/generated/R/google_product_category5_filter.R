...
GoogleProductCategory5Filter <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return GoogleProductCategory5Filter as a base R list.
    #' @examples
    #' # convert array of GoogleProductCategory5Filter (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert GoogleProductCategory5Filter to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      if (!is.null(self$`GOOGLE_PRODUCT_CATEGORY_5`)) {
        GoogleProductCategory5FilterObject[["GOOGLE_PRODUCT_CATEGORY_5"]] <-
          self$extractSimpleType(self$`GOOGLE_PRODUCT_CATEGORY_5`)
      }
      return(GoogleProductCategory5FilterObject)
    },
