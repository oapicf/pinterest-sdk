...
CatalogsFeedCredentials <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return CatalogsFeedCredentials as a base R list.
    #' @examples
    #' # convert array of CatalogsFeedCredentials (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CatalogsFeedCredentials to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(CatalogsFeedCredentialsObject)
    },
