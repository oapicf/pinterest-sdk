...
OrderLinesArrayResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return OrderLinesArrayResponse as a base R list.
    #' @examples
    #' # convert array of OrderLinesArrayResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert OrderLinesArrayResponse to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(OrderLinesArrayResponseObject)
    },
