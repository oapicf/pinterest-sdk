#' Create a new CustomerListUploadResponse
#'
#' @description
...
#' @description CustomerListUploadResponse Class
...
#' @export
CustomerListUploadResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new CustomerListUploadResponse class.
    #'
    ...
    #'
    #' @return CustomerListUploadResponse as a base R list.
    #' @examples
    #' # convert array of CustomerListUploadResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CustomerListUploadResponse to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      CustomerListUploadResponseObject <- list()
      if (!is.null(self$`ad_account_id`)) {
        CustomerListUploadResponseObject[["ad_account_id"]] <-
          self$`ad_account_id`
      }
      if (!is.null(self$`creation_time`)) {
        CustomerListUploadResponseObject[["creation_time"]] <-
          self$`creation_time`
      }
      if (!is.null(self$`customer_list_id`)) {
        CustomerListUploadResponseObject[["customer_list_id"]] <-
          self$`customer_list_id`
      }
      if (!is.null(self$`error_counts`)) {
        CustomerListUploadResponseObject[["error_counts"]] <-
          lapply(self$`error_counts`, function(x) x$toSimpleType())
      }
      if (!is.null(self$`id`)) {
        CustomerListUploadResponseObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`operation`)) {
        CustomerListUploadResponseObject[["operation"]] <-
          self$`operation`$toSimpleType()
      }
      if (!is.null(self$`record_counts`)) {
        CustomerListUploadResponseObject[["record_counts"]] <-
          self$`record_counts`$toSimpleType()
      }
      if (!is.null(self$`state`)) {
        CustomerListUploadResponseObject[["state"]] <-
          self$`state`
      }
      if (!is.null(self$`updated_time`)) {
        CustomerListUploadResponseObject[["updated_time"]] <-
          self$`updated_time`
      }
      return(CustomerListUploadResponseObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of CustomerListUploadResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of CustomerListUploadResponse
    ...
    #' @return CustomerListUploadResponse in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to CustomerListUploadResponse and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`ad_account_id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for CustomerListUploadResponse: the required field `ad_account_id` is missing."))
      }
      ...
      if (!is.null(input_json$`creation_time`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for CustomerListUploadResponse: the required field `creation_time` is missing."))
      }
      ...
      if (!is.null(input_json$`customer_list_id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for CustomerListUploadResponse: the required field `customer_list_id` is missing."))
      }
      ...
      if (!is.null(input_json$`id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for CustomerListUploadResponse: the required field `id` is missing."))
      }
      # check the required field `operation`
      if (!is.null(input_json$`operation`)) {
        stopifnot(R6::is.R6(input_json$`operation`))
      } else {
        stop(paste("The JSON input `", input, "` is invalid for CustomerListUploadResponse: the required field `operation` is missing."))
      }
      ...
      if (!is.null(input_json$`state`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for CustomerListUploadResponse: the required field `state` is missing."))
      }
      ...
      if (!is.null(input_json$`updated_time`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for CustomerListUploadResponse: the required field `updated_time` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of CustomerListUploadResponse
    toString = function() {
      self$toJSONString()
    },
...
# CustomerListUploadResponse$unlock()
#
## Below is an example to define the print function
# CustomerListUploadResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# CustomerListUploadResponse$lock()
