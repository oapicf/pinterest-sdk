#' Create a new AdAccountsAudienceUpdate
#'
#' @description
#' Resource create or update operation model.
#'
#' @docType class
#' @title AdAccountsAudienceUpdate
#' @description AdAccountsAudienceUpdate Class
...
#' @field operation_type Audience operation type (update or remove). Only valid in update request body. \link{AudienceUpdateOperationType} [optional]
#' @field rule  \link{AdAccountsAudienceRule} [optional]
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
AdAccountsAudienceUpdate <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new AdAccountsAudienceUpdate class.
    #'
    ...
    #' @param operation_type Audience operation type (update or remove). Only valid in update request body.
    #' @param rule rule
    #' @param ... Other optional arguments.
    initialize = function(`ad_account_id` = NULL, `audience_type` = NULL, `description` = NULL, `name` = NULL, `operation_type` = NULL, `rule` = NULL, ...) {
    ...
    #'
    #' @return AdAccountsAudienceUpdate as a base R list.
    #' @examples
    #' # convert array of AdAccountsAudienceUpdate (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert AdAccountsAudienceUpdate to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      AdAccountsAudienceUpdateObject <- list()
      if (!is.null(self$`ad_account_id`)) {
        AdAccountsAudienceUpdateObject[["ad_account_id"]] <-
          self$`ad_account_id`
      }
      if (!is.null(self$`audience_type`)) {
        AdAccountsAudienceUpdateObject[["audience_type"]] <-
          self$extractSimpleType(self$`audience_type`)
      }
      if (!is.null(self$`description`)) {
        AdAccountsAudienceUpdateObject[["description"]] <-
          self$`description`
      }
      if (!is.null(self$`name`)) {
        AdAccountsAudienceUpdateObject[["name"]] <-
          self$`name`
      }
      if (!is.null(self$`operation_type`)) {
        AdAccountsAudienceUpdateObject[["operation_type"]] <-
          self$extractSimpleType(self$`operation_type`)
      }
      if (!is.null(self$`rule`)) {
        AdAccountsAudienceUpdateObject[["rule"]] <-
          self$extractSimpleType(self$`rule`)
      }
      return(AdAccountsAudienceUpdateObject)
    },
    ...
    #' @description
    #' Deserialize JSON string into an instance of AdAccountsAudienceUpdate
    #'
    #' @param input_json the JSON input
    #' @return the instance of AdAccountsAudienceUpdate
    ...
    #' @return AdAccountsAudienceUpdate in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to AdAccountsAudienceUpdate and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of AdAccountsAudienceUpdate
    toString = function() {
      self$toJSONString()
    },
...
# AdAccountsAudienceUpdate$unlock()
#
## Below is an example to define the print function
# AdAccountsAudienceUpdate$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# AdAccountsAudienceUpdate$lock()
