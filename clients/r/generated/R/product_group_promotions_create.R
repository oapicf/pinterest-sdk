#' Create a new ProductGroupPromotionsCreate
#'
#' @description
#' Resource create operation model.
#'
#' @docType class
#' @title ProductGroupPromotionsCreate
#' @description ProductGroupPromotionsCreate Class
...
#' @export
ProductGroupPromotionsCreate <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new ProductGroupPromotionsCreate class.
    #'
    ...
    #'
    #' @return ProductGroupPromotionsCreate as a base R list.
    #' @examples
    #' # convert array of ProductGroupPromotionsCreate (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ProductGroupPromotionsCreate to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      ProductGroupPromotionsCreateObject <- list()
      if (!is.null(self$`ad_group_id`)) {
        ProductGroupPromotionsCreateObject[["ad_group_id"]] <-
          self$`ad_group_id`
      }
      if (!is.null(self$`product_group_promotion`)) {
        ProductGroupPromotionsCreateObject[["product_group_promotion"]] <-
          self$extractSimpleType(self$`product_group_promotion`)
      }
      return(ProductGroupPromotionsCreateObject)
    },
    ...
    #' @description
    #' Deserialize JSON string into an instance of ProductGroupPromotionsCreate
    #'
    #' @param input_json the JSON input
    #' @return the instance of ProductGroupPromotionsCreate
    ...
    #' @return ProductGroupPromotionsCreate in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to ProductGroupPromotionsCreate and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`ad_group_id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ProductGroupPromotionsCreate: the required field `ad_group_id` is missing."))
      }
      ...
      if (!is.null(input_json$`product_group_promotion`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ProductGroupPromotionsCreate: the required field `product_group_promotion` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of ProductGroupPromotionsCreate
    toString = function() {
      self$toJSONString()
    },
...
# ProductGroupPromotionsCreate$unlock()
#
## Below is an example to define the print function
# ProductGroupPromotionsCreate$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# ProductGroupPromotionsCreate$lock()
