#' Create a new TargetingSpecOperationLocale
#'
#' @description
#' TargetingSpecOperationLocale Class
#'
#' @docType class
#' @title TargetingSpecOperationLocale
#' @description TargetingSpecOperationLocale Class
...
#' @export
TargetingSpecOperationLocale <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new TargetingSpecOperationLocale class.
    #'
    #' @param field field
    ...
    initialize = function(`field`, `operation`, `values`, ...) {
      if (!missing(`field`)) {
        if (!(`field` %in% c("LOCALE"))) {
          stop(paste("Error! \"", `field`, "\" cannot be assigned to `field`. Must be \"LOCALE\".", sep = ""))
        }
    ...
    #'
    #' @return TargetingSpecOperationLocale as a base R list.
    #' @examples
    #' # convert array of TargetingSpecOperationLocale (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert TargetingSpecOperationLocale to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      TargetingSpecOperationLocaleObject <- list()
      if (!is.null(self$`field`)) {
        TargetingSpecOperationLocaleObject[["field"]] <-
          self$`field`
      }
      if (!is.null(self$`operation`)) {
        TargetingSpecOperationLocaleObject[["operation"]] <-
          self$extractSimpleType(self$`operation`)
      }
      if (!is.null(self$`values`)) {
        TargetingSpecOperationLocaleObject[["values"]] <-
          self$`values`
      }
      return(TargetingSpecOperationLocaleObject)
    },
    ...
    #' @description
    #' Deserialize JSON string into an instance of TargetingSpecOperationLocale
    #'
    #' @param input_json the JSON input
    #' @return the instance of TargetingSpecOperationLocale
    fromJSON = function(input_json) {
      this_object <- jsonlite::fromJSON(input_json)
      if (!is.null(this_object$`field`)) {
        if (!is.null(this_object$`field`) && !(this_object$`field` %in% c("LOCALE"))) {
          stop(paste("Error! \"", this_object$`field`, "\" cannot be assigned to `field`. Must be \"LOCALE\".", sep = ""))
        }
    ...
    #' @return TargetingSpecOperationLocale in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to TargetingSpecOperationLocale and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`field`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for TargetingSpecOperationLocale: the required field `field` is missing."))
      }
      # check the required field `operation`
      if (!is.null(input_json$`operation`)) {
        stopifnot(R6::is.R6(input_json$`operation`))
      } else {
        stop(paste("The JSON input `", input, "` is invalid for TargetingSpecOperationLocale: the required field `operation` is missing."))
      }
      ...
      if (!is.null(input_json$`values`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for TargetingSpecOperationLocale: the required field `values` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of TargetingSpecOperationLocale
    toString = function() {
      self$toJSONString()
    },
...
# TargetingSpecOperationLocale$unlock()
#
## Below is an example to define the print function
# TargetingSpecOperationLocale$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# TargetingSpecOperationLocale$lock()
