...
GetMMMReportResponseData <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return GetMMMReportResponseData as a base R list.
    #' @examples
    #' # convert array of GetMMMReportResponseData (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert GetMMMReportResponseData to a base R type
    #'
