...
CreateAssetAccessRequestErrorMessageInner <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return CreateAssetAccessRequestErrorMessageInner as a base R list.
    #' @examples
    #' # convert array of CreateAssetAccessRequestErrorMessageInner (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CreateAssetAccessRequestErrorMessageInner to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(CreateAssetAccessRequestErrorMessageInnerObject)
    },
