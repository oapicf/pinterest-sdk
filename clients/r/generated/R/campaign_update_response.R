...
CampaignUpdateResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return CampaignUpdateResponse as a base R list.
    #' @examples
    #' # convert array of CampaignUpdateResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CampaignUpdateResponse to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(CampaignUpdateResponseObject)
    },
