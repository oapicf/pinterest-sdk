...
LeadFormArrayResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return LeadFormArrayResponse as a base R list.
    #' @examples
    #' # convert array of LeadFormArrayResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert LeadFormArrayResponse to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(LeadFormArrayResponseObject)
    },
