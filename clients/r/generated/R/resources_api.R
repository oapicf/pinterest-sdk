  ...
  public = list(
    ...
    AdAccountCountriesGetWithHttpInfo = function(data_file = NULL, ...) {
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$DeserializeResponse(local_var_resp, "AdAccountsCountryResponse"),
          error = function(e) {
    ...
    DeliveryMetricsGetWithHttpInfo = function(report_type = NULL, data_file = NULL, ...) {
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$DeserializeResponse(local_var_resp, "DeliveryMetricsResponse"),
          error = function(e) {
            stop("Failed to deserialize response")
          }
        )
    ...
    InterestTargetingOptionsGetWithHttpInfo = function(interest_id, data_file = NULL, ...) {
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$DeserializeResponse(local_var_resp, "SingleInterestTargetingOptionResponse"),
          error = function(e) {
            stop("Failed to deserialize response")
          }
        )
    ...
    MetricsReadyStateGetWithHttpInfo = function(date, data_file = NULL, ...) {
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$DeserializeResponse(local_var_resp, "BookClosedResponse"),
          error = function(e) {
            stop("Failed to deserialize response")
          }
        )
