...
ResourcesApi <- R6::R6Class(
  ...
  public = list(
    ...
    AdAccountCountriesGet = function(data_file = NULL, ..., .parse = TRUE) {
      local_var_response <- self$AdAccountCountriesGetWithHttpInfo(data_file = data_file, ..., .parse = .parse)
    ...
    #' @param .parse Logical. If \code{TRUE} then the response will be parsed to a generated type. If \code{FALSE} the response will be returned as unparsed text.
    #'
    #' @return API response (AdAccountCountriesGet200Response) with additional information such as HTTP status code, headers
    AdAccountCountriesGetWithHttpInfo = function(data_file = NULL, ..., .parse = TRUE) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$DeserializeResponse(local_var_resp, "AdAccountCountriesGet200Response"),
          error = function(e) {
    ...
    DeliveryMetricsGet = function(report_type = NULL, data_file = NULL, ..., .parse = TRUE) {
      local_var_response <- self$DeliveryMetricsGetWithHttpInfo(report_type, data_file = data_file, ..., .parse = .parse)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        return(local_var_response$content)
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        return(local_var_response)
    ...
    #' @param .parse Logical. If \code{TRUE} then the response will be parsed to a generated type. If \code{FALSE} the response will be returned as unparsed text.
    #'
    #' @return API response (DeliveryMetricsGet200Response) with additional information such as HTTP status code, headers
    DeliveryMetricsGetWithHttpInfo = function(report_type = NULL, data_file = NULL, ..., .parse = TRUE) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$DeserializeResponse(local_var_resp, "DeliveryMetricsGet200Response"),
          error = function(e) {
            stop("Failed to deserialize response")
          }
        )
    ...
    InterestTargetingOptionsGet = function(interest_id, data_file = NULL, ..., .parse = TRUE) {
      local_var_response <- self$InterestTargetingOptionsGetWithHttpInfo(interest_id, data_file = data_file, ..., .parse = .parse)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        return(local_var_response$content)
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        return(local_var_response)
    ...
    #' @param .parse Logical. If \code{TRUE} then the response will be parsed to a generated type. If \code{FALSE} the response will be returned as unparsed text.
    #'
    #' @return API response (SingleInterestTargetingOption) with additional information such as HTTP status code, headers
    InterestTargetingOptionsGetWithHttpInfo = function(interest_id, data_file = NULL, ..., .parse = TRUE) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$DeserializeResponse(local_var_resp, "SingleInterestTargetingOption"),
          error = function(e) {
            stop("Failed to deserialize response")
          }
        )
    ...
    #'
    #' @return BookClosed
    MetricsReadyStateGet = function(date, data_file = NULL, ..., .parse = TRUE) {
      local_var_response <- self$MetricsReadyStateGetWithHttpInfo(date, data_file = data_file, ..., .parse = .parse)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        return(local_var_response$content)
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        return(local_var_response)
    ...
    #' @param .parse Logical. If \code{TRUE} then the response will be parsed to a generated type. If \code{FALSE} the response will be returned as unparsed text.
    #'
    #' @return API response (BookClosed) with additional information such as HTTP status code, headers
    MetricsReadyStateGetWithHttpInfo = function(date, data_file = NULL, ..., .parse = TRUE) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$DeserializeResponse(local_var_resp, "BookClosed"),
          error = function(e) {
            stop("Failed to deserialize response")
          }
        )
    ...
    #'
    #' @return array[object]
    TargetingOptionsGet = function(targeting_type, ad_account_id = NULL, client_id = NULL, oauth_signature = NULL, timestamp = NULL, data_file = NULL, ..., .parse = TRUE) {
      local_var_response <- self$TargetingOptionsGetWithHttpInfo(targeting_type, ad_account_id, client_id, oauth_signature, timestamp, data_file = data_file, ..., .parse = .parse)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        return(local_var_response$content)
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        return(local_var_response)
    ...
    TargetingOptionsGetWithHttpInfo = function(targeting_type, ad_account_id = NULL, client_id = NULL, oauth_signature = NULL, timestamp = NULL, data_file = NULL, ..., .parse = TRUE) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
