#' Create a new GetBusinessMembers200Response
#'
#' @description
...
GetBusinessMembers200Response <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return GetBusinessMembers200Response as a base R list.
    #' @examples
    #' # convert array of GetBusinessMembers200Response (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert GetBusinessMembers200Response to a base R type
    #'
    ...
    #' @description
    #' Deserialize JSON string into an instance of GetBusinessMembers200Response
    #'
    ...
    #' @return GetBusinessMembers200Response in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to GetBusinessMembers200Response and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`items`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for GetBusinessMembers200Response: the required field `items` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of GetBusinessMembers200Response
    toString = function() {
      self$toJSONString()
    },
...
# GetBusinessMembers200Response$unlock()
#
## Below is an example to define the print function
# GetBusinessMembers200Response$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# GetBusinessMembers200Response$lock()
