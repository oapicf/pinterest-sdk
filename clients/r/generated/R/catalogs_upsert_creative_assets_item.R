#' Create a new CatalogsUpsertCreativeAssetsItem
#'
#' @description
#' A creative assets item to be upserted.
#'
#' @docType class
#' @title CatalogsUpsertCreativeAssetsItem
#' @description CatalogsUpsertCreativeAssetsItem Class
...
#' @export
CatalogsUpsertCreativeAssetsItem <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new CatalogsUpsertCreativeAssetsItem class.
    #'
    ...
    #'
    #' @return CatalogsUpsertCreativeAssetsItem as a base R list.
    #' @examples
    #' # convert array of CatalogsUpsertCreativeAssetsItem (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CatalogsUpsertCreativeAssetsItem to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      CatalogsUpsertCreativeAssetsItemObject <- list()
      if (!is.null(self$`creative_assets_id`)) {
        CatalogsUpsertCreativeAssetsItemObject[["creative_assets_id"]] <-
          self$`creative_assets_id`
      }
      if (!is.null(self$`operation`)) {
        CatalogsUpsertCreativeAssetsItemObject[["operation"]] <-
          self$`operation`
      }
      if (!is.null(self$`attributes`)) {
        CatalogsUpsertCreativeAssetsItemObject[["attributes"]] <-
          self$`attributes`$toSimpleType()
      }
      return(CatalogsUpsertCreativeAssetsItemObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of CatalogsUpsertCreativeAssetsItem
    #'
    #' @param input_json the JSON input
    #' @return the instance of CatalogsUpsertCreativeAssetsItem
    ...
    #' @return CatalogsUpsertCreativeAssetsItem in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to CatalogsUpsertCreativeAssetsItem and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`creative_assets_id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for CatalogsUpsertCreativeAssetsItem: the required field `creative_assets_id` is missing."))
      }
      ...
      if (!is.null(input_json$`operation`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for CatalogsUpsertCreativeAssetsItem: the required field `operation` is missing."))
      }
      # check the required field `attributes`
      if (!is.null(input_json$`attributes`)) {
        stopifnot(R6::is.R6(input_json$`attributes`))
      } else {
        stop(paste("The JSON input `", input, "` is invalid for CatalogsUpsertCreativeAssetsItem: the required field `attributes` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of CatalogsUpsertCreativeAssetsItem
    toString = function() {
      self$toJSONString()
    },
...
# CatalogsUpsertCreativeAssetsItem$unlock()
#
## Below is an example to define the print function
# CatalogsUpsertCreativeAssetsItem$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# CatalogsUpsertCreativeAssetsItem$lock()
