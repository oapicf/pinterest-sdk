...
#' @field CUSTOM_LABEL_4  \link{CatalogsProductGroupFilterOperatorTypeCriteria}
...
CustomLabel4Filter <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return CustomLabel4Filter as a base R list.
    #' @examples
    #' # convert array of CustomLabel4Filter (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CustomLabel4Filter to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      if (!is.null(self$`CUSTOM_LABEL_4`)) {
        CustomLabel4FilterObject[["CUSTOM_LABEL_4"]] <-
          self$extractSimpleType(self$`CUSTOM_LABEL_4`)
      }
      return(CustomLabel4FilterObject)
    },
    ...
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`CUSTOM_LABEL_4`)) {
        `custom_label_4_object` <- CatalogsProductGroupFilterOperatorTypeCriteria$new()
    ...
    fromJSONString = function(input_json) {
      this_object <- jsonlite::fromJSON(input_json)
      self$`CUSTOM_LABEL_4` <- CatalogsProductGroupFilterOperatorTypeCriteria$new()$fromJSON(jsonlite::toJSON(this_object$`CUSTOM_LABEL_4`, auto_unbox = TRUE, digits = NA))
      self
    },
