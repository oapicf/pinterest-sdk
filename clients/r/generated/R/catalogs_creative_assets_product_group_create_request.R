#' Create a new CatalogsCreativeAssetsProductGroupCreateRequest
#'
#' @description
...
#' @export
CatalogsCreativeAssetsProductGroupCreateRequest <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`description`)) {
        CatalogsCreativeAssetsProductGroupCreateRequestObject[["description"]] <-
          self$`description`
      }
    ...
    #' @description
    #' Deserialize JSON string into an instance of CatalogsCreativeAssetsProductGroupCreateRequest
    #'
    #' @param input_json the JSON input
    #' @return the instance of CatalogsCreativeAssetsProductGroupCreateRequest
    ...
    #' @description
    #' Validate JSON input with respect to CatalogsCreativeAssetsProductGroupCreateRequest and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`catalog_type`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for CatalogsCreativeAssetsProductGroupCreateRequest: the required field `catalog_type` is missing."))
      }
      ...
      if (!is.null(input_json$`name`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for CatalogsCreativeAssetsProductGroupCreateRequest: the required field `name` is missing."))
      }
      # check the required field `filters`
      if (!is.null(input_json$`filters`)) {
        stopifnot(R6::is.R6(input_json$`filters`))
      } else {
        stop(paste("The JSON input `", input, "` is invalid for CatalogsCreativeAssetsProductGroupCreateRequest: the required field `filters` is missing."))
      }
      ...
      if (!is.null(input_json$`catalog_id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for CatalogsCreativeAssetsProductGroupCreateRequest: the required field `catalog_id` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of CatalogsCreativeAssetsProductGroupCreateRequest
    toString = function() {
      self$toJSONString()
    },
...
# CatalogsCreativeAssetsProductGroupCreateRequest$unlock()
#
## Below is an example to define the print function
# CatalogsCreativeAssetsProductGroupCreateRequest$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# CatalogsCreativeAssetsProductGroupCreateRequest$lock()
