#' Create a new LeadFormBatchUpdate
#'
#' @description
#' LeadFormBatchUpdate Class
#'
#' @docType class
#' @title LeadFormBatchUpdate
#' @description LeadFormBatchUpdate Class
...
#' @export
LeadFormBatchUpdate <- R6::R6Class(
  "LeadFormBatchUpdate",
  public = list(
    ...
    #' @description
    #' Initialize a new LeadFormBatchUpdate class.
    #'
    ...
    #'
    #' @return LeadFormBatchUpdate as a base R list.
    #' @examples
    #' # convert array of LeadFormBatchUpdate (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert LeadFormBatchUpdate to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      LeadFormBatchUpdateObject <- list()
      if (!is.null(self$`completion_message`)) {
        LeadFormBatchUpdateObject[["completion_message"]] <-
          self$`completion_message`
      }
      if (!is.null(self$`disclosure_language`)) {
        LeadFormBatchUpdateObject[["disclosure_language"]] <-
          self$`disclosure_language`
      }
      if (!is.null(self$`has_accepted_terms`)) {
        LeadFormBatchUpdateObject[["has_accepted_terms"]] <-
          self$`has_accepted_terms`
      }
      if (!is.null(self$`id`)) {
        LeadFormBatchUpdateObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`name`)) {
        LeadFormBatchUpdateObject[["name"]] <-
          self$`name`
      }
      if (!is.null(self$`policy_links`)) {
        LeadFormBatchUpdateObject[["policy_links"]] <-
          self$extractSimpleType(self$`policy_links`)
      }
      if (!is.null(self$`privacy_policy_link`)) {
        LeadFormBatchUpdateObject[["privacy_policy_link"]] <-
          self$`privacy_policy_link`
      }
      if (!is.null(self$`questions`)) {
        LeadFormBatchUpdateObject[["questions"]] <-
          self$extractSimpleType(self$`questions`)
      }
      if (!is.null(self$`status`)) {
        LeadFormBatchUpdateObject[["status"]] <-
          self$extractSimpleType(self$`status`)
      }
      return(LeadFormBatchUpdateObject)
    },
    ...
    #' @description
    #' Deserialize JSON string into an instance of LeadFormBatchUpdate
    #'
    #' @param input_json the JSON input
    #' @return the instance of LeadFormBatchUpdate
    ...
    #' @return LeadFormBatchUpdate in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to LeadFormBatchUpdate and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for LeadFormBatchUpdate: the required field `id` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of LeadFormBatchUpdate
    toString = function() {
      self$toJSONString()
    },
...
# LeadFormBatchUpdate$unlock()
#
## Below is an example to define the print function
# LeadFormBatchUpdate$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# LeadFormBatchUpdate$lock()
