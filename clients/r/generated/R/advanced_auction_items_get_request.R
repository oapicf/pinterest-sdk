...
AdvancedAuctionItemsGetRequest <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return AdvancedAuctionItemsGetRequest as a base R list.
    #' @examples
    #' # convert array of AdvancedAuctionItemsGetRequest (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert AdvancedAuctionItemsGetRequest to a base R type
    #'
