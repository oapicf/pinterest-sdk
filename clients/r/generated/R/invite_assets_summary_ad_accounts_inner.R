...
InviteAssetsSummaryAdAccountsInner <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return InviteAssetsSummaryAdAccountsInner as a base R list.
    #' @examples
    #' # convert array of InviteAssetsSummaryAdAccountsInner (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert InviteAssetsSummaryAdAccountsInner to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(InviteAssetsSummaryAdAccountsInnerObject)
    },
