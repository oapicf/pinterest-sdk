#' @docType class
#' @title CatalogsProductGroupsUpdateRequestSchema
#'
#' @description CatalogsProductGroupsUpdateRequestSchema Class
#'
...
#' @export
CatalogsProductGroupsUpdateRequestSchema <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new CatalogsProductGroupsUpdateRequestSchema.
    #'
    ...
    initialize = function(instance = NULL) {
      if (is.null(instance)) {
        ...
        stop(paste("Failed to initialize CatalogsProductGroupsUpdateRequestSchema with oneOf schemas CatalogsProductGroupUpdateRequest, CatalogsVerticalProductGroupUpdateRequest. Provided class name: ",
                   get(class(instance)[[1]], pos = -1)$classname))
      }
    },

    #' @description
    #' Deserialize JSON string into an instance of CatalogsProductGroupsUpdateRequestSchema.
    #' An alias to the method `fromJSON` .
    #'
    #' @param input The input JSON.
    #'
    #' @return An instance of CatalogsProductGroupsUpdateRequestSchema.
    ...
    fromJSON = function(input) {
      ...
      if (matched == 1) {
        ...
        # more than 1 match
        stop(paste("Multiple matches found when deserializing the input into CatalogsProductGroupsUpdateRequestSchema with oneOf schemas CatalogsProductGroupUpdateRequest, CatalogsVerticalProductGroupUpdateRequest. Matched schemas: ",
                   paste(matched_schemas, collapse = ", ")))
      } else {
        # no match
        stop(paste("No match found when deserializing the input into CatalogsProductGroupsUpdateRequestSchema with oneOf schemas CatalogsProductGroupUpdateRequest, CatalogsVerticalProductGroupUpdateRequest. Details: >>",
    ...
    #' @description
    #' Serialize CatalogsProductGroupsUpdateRequestSchema to JSON string.
    #' 
    #' @param ... Parameters passed to `jsonlite::toJSON`
    #' @return JSON string representation of the CatalogsProductGroupsUpdateRequestSchema.
    ...
    #' @description
    #' Convert CatalogsProductGroupsUpdateRequestSchema to a base R type
    #'
    ...
    #' @description
    #' Validate the input JSON with respect to CatalogsProductGroupsUpdateRequestSchema and
...
#CatalogsProductGroupsUpdateRequestSchema$unlock()
#
## Below is an example to define the print function
#CatalogsProductGroupsUpdateRequestSchema$set("public", "print", function(...) {
#  print(jsonlite::prettify(self$toJSONString()))
#  invisible(self)
#})
## Uncomment below to lock the class to prevent modifications to the method or field
#CatalogsProductGroupsUpdateRequestSchema$lock()
