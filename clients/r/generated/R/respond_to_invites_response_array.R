#' Create a new RespondToInvitesResponseArray
#'
#' @description
...
#' @export
RespondToInvitesResponseArray <- R6::R6Class(
  "RespondToInvitesResponseArray",
  public = list(
    `items` = NULL,

    #' @description
    #' Initialize a new RespondToInvitesResponseArray class.
    #'
    ...
    #'
    #' @return RespondToInvitesResponseArray as a base R list.
    #' @examples
    #' # convert array of RespondToInvitesResponseArray (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert RespondToInvitesResponseArray to a base R type
    #'
    ...
    #' @description
    #' Deserialize JSON string into an instance of RespondToInvitesResponseArray
    #'
    ...
    #' @return RespondToInvitesResponseArray in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to RespondToInvitesResponseArray and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of RespondToInvitesResponseArray
    toString = function() {
      self$toJSONString()
    },
...
# RespondToInvitesResponseArray$unlock()
#
## Below is an example to define the print function
# RespondToInvitesResponseArray$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# RespondToInvitesResponseArray$lock()
