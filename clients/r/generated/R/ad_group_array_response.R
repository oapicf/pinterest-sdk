...
AdGroupArrayResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return AdGroupArrayResponse as a base R list.
    #' @examples
    #' # convert array of AdGroupArrayResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert AdGroupArrayResponse to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(AdGroupArrayResponseObject)
    },
