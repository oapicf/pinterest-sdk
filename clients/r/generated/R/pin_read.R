...
PinRead <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new PinRead class.
    #'
    #' @param id id
    ...
    initialize = function(`id`, `ai_disclosures` = NULL, `board_id` = NULL, `board_owner` = NULL, `board_section_id` = NULL, `created_at` = NULL, `creative_type` = NULL, `dominant_color` = NULL, `has_been_promoted` = NULL, `is_owner` = NULL, `is_product` = NULL, `is_standard` = NULL, `media` = NULL, `parent_pin_id` = NULL, `pin_metrics` = NULL, `alt_text` = NULL, `description` = NULL, `link` = NULL, `title` = NULL, ...) {
      if (!missing(`id`)) {
    ...
    #'
    #' @return PinRead as a base R list.
    #' @examples
    #' # convert array of PinRead (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    toSimpleType = function() {
      ...
      if (!is.null(self$`is_owner`)) {
        PinReadObject[["is_owner"]] <-
          self$`is_owner`
      }
      if (!is.null(self$`is_product`)) {
        PinReadObject[["is_product"]] <-
          self$`is_product`
      }
      if (!is.null(self$`is_standard`)) {
        PinReadObject[["is_standard"]] <-
          self$`is_standard`
      }
      ...
      if (!is.null(self$`parent_pin_id`)) {
        PinReadObject[["parent_pin_id"]] <-
          self$`parent_pin_id`
      }
      if (!is.null(self$`pin_metrics`)) {
        PinReadObject[["pin_metrics"]] <-
          self$`pin_metrics`
      }
      if (!is.null(self$`alt_text`)) {
        PinReadObject[["alt_text"]] <-
          self$`alt_text`
      }
      if (!is.null(self$`description`)) {
        PinReadObject[["description"]] <-
          self$`description`
      }
    ...
    #' @description
    #' Deserialize JSON string into an instance of PinRead
    #'
    #' @param input_json the JSON input
    #' @return the instance of PinRead
    ...
    #' @description
    #' Validate JSON input with respect to PinRead and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for PinRead: the required field `id` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of PinRead
    toString = function() {
      self$toJSONString()
    },
...
# PinRead$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
