...
ConversionTagListResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return ConversionTagListResponse as a base R list.
    #' @examples
    #' # convert array of ConversionTagListResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ConversionTagListResponse to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(ConversionTagListResponseObject)
    },
