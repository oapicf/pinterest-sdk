#' Create a new CatalogsCreativeAssetsFeed
#'
#' @description
#' Catalogs Creative Asset Feed object
#'
#' @docType class
#' @title CatalogsCreativeAssetsFeed
#' @description CatalogsCreativeAssetsFeed Class
...
#' @export
CatalogsCreativeAssetsFeed <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(`catalog_id`, `catalog_type`, `created_at`, `default_country`, `default_locale`, `format`, `id`, `location`, `name`, `status`, `updated_at`, `credentials` = NULL, `default_currency` = NULL, `preferred_processing_schedule` = NULL, ...) {
    ...
    toSimpleType = function() {
      ...
      if (!is.null(self$`id`)) {
        CatalogsCreativeAssetsFeedObject[["id"]] <-
          self$`id`
      }
    ...
    #' @description
    #' Deserialize JSON string into an instance of CatalogsCreativeAssetsFeed
    #'
    #' @param input_json the JSON input
    #' @return the instance of CatalogsCreativeAssetsFeed
    ...
    #' @description
    #' Validate JSON input with respect to CatalogsCreativeAssetsFeed and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`catalog_type`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for CatalogsCreativeAssetsFeed: the required field `catalog_type` is missing."))
      }
      ...
      if (!is.null(input_json$`created_at`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for CatalogsCreativeAssetsFeed: the required field `created_at` is missing."))
      }
      ...
      if (!is.null(input_json$`id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for CatalogsCreativeAssetsFeed: the required field `id` is missing."))
      }
    ...
    #'
    #' @return String representation of CatalogsCreativeAssetsFeed
    toString = function() {
      self$toJSONString()
    },
...
# CatalogsCreativeAssetsFeed$unlock()
#
## Below is an example to define the print function
# CatalogsCreativeAssetsFeed$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# CatalogsCreativeAssetsFeed$lock()
