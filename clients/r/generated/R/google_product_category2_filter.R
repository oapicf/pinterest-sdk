...
GoogleProductCategory2Filter <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return GoogleProductCategory2Filter as a base R list.
    #' @examples
    #' # convert array of GoogleProductCategory2Filter (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert GoogleProductCategory2Filter to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      if (!is.null(self$`GOOGLE_PRODUCT_CATEGORY_2`)) {
        GoogleProductCategory2FilterObject[["GOOGLE_PRODUCT_CATEGORY_2"]] <-
          self$extractSimpleType(self$`GOOGLE_PRODUCT_CATEGORY_2`)
      }
      return(GoogleProductCategory2FilterObject)
    },
