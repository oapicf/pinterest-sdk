  ...
  public = list(
    ...
    AssetGroupCreateWithHttpInfo = function(business_id, create_asset_group_body, data_file = NULL, ...) {
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$DeserializeResponse(local_var_resp, "CreateAssetGroupResponse"),
          error = function(e) {
    ...
    AssetGroupDeleteWithHttpInfo = function(business_id, delete_asset_group_body, data_file = NULL, ...) {
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$DeserializeResponse(local_var_resp, "DeleteAssetGroupResponse"),
          error = function(e) {
            stop("Failed to deserialize response")
          }
        )
    ...
    AssetGroupUpdateWithHttpInfo = function(business_id, update_asset_group_body, data_file = NULL, ...) {
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$DeserializeResponse(local_var_resp, "UpdateAssetGroupResponse"),
          error = function(e) {
            stop("Failed to deserialize response")
          }
        )
    ...
    BusinessAssetMembersGet = function(business_id, asset_id, fetch_system_users = FALSE, bookmark = NULL, page_size = 25, start_index = 0, data_file = NULL, ...) {
      local_var_response <- self$BusinessAssetMembersGetWithHttpInfo(business_id, asset_id, fetch_system_users, bookmark, page_size, start_index, data_file = data_file, ...)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        return(local_var_response$content)
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        return(local_var_response)
    ...
    BusinessAssetMembersGetWithHttpInfo = function(business_id, asset_id, fetch_system_users = FALSE, bookmark = NULL, page_size = 25, start_index = 0, data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
    ...
    BusinessAssetPartnersGetWithHttpInfo = function(business_id, asset_id, start_index = 0, bookmark = NULL, page_size = 25, data_file = NULL, ...) {
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$DeserializeResponse(local_var_resp, "BusinessAssetPartnersGet200Response"),
          error = function(e) {
            stop("Failed to deserialize response")
          }
        )
    ...
    BusinessMemberAssetsGetWithHttpInfo = function(business_id, member_id, asset_type = "AD_ACCOUNT", start_index = 0, bookmark = NULL, page_size = 25, data_file = NULL, ...) {
      ...
      if (!is.null(`asset_type`) && !(`asset_type` %in% c("AD_ACCOUNT", "PROFILE", "ASSET_GROUP", "CATALOG", "CONSUMER"))) {
        stop("Invalid value for asset_type when calling BusinessAccessAssetsApi$BusinessMemberAssetsGet. Must be [AD_ACCOUNT, PROFILE, ASSET_GROUP, CATALOG, CONSUMER].")
      }
      query_params[["asset_type"]] <- `asset_type`
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$DeserializeResponse(local_var_resp, "BusinessMemberAssetsGet200Response"),
          error = function(e) {
            stop("Failed to deserialize response")
          }
        )
    ...
    BusinessPartnerAssetAccessGetWithHttpInfo = function(business_id, partner_id, partner_type = NULL, asset_type = "AD_ACCOUNT", start_index = 0, page_size = 25, bookmark = NULL, data_file = NULL, ...) {
      ...
      if (!is.null(`asset_type`) && !(`asset_type` %in% c("AD_ACCOUNT", "PROFILE", "ASSET_GROUP", "CATALOG", "CONSUMER"))) {
        stop("Invalid value for asset_type when calling BusinessAccessAssetsApi$BusinessPartnerAssetAccessGet. Must be [AD_ACCOUNT, PROFILE, ASSET_GROUP, CATALOG, CONSUMER].")
      }
      query_params[["asset_type"]] <- `asset_type`
    ...
    DeletePartnerAssetAccessHandlerImplWithHttpInfo = function(business_id, delete_partner_asset_access_body, data_file = NULL, ...) {
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$DeserializeResponse(local_var_resp, "DeletePartnerAssetsResultsResponseArray"),
          error = function(e) {
            stop("Failed to deserialize response")
          }
        )
