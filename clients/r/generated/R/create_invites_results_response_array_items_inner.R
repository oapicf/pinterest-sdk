...
CreateInvitesResultsResponseArrayItemsInner <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return CreateInvitesResultsResponseArrayItemsInner as a base R list.
    #' @examples
    #' # convert array of CreateInvitesResultsResponseArrayItemsInner (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CreateInvitesResultsResponseArrayItemsInner to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(CreateInvitesResultsResponseArrayItemsInnerObject)
    },
