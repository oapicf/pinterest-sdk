...
OauthAccessTokenRequestClientCredentials <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return OauthAccessTokenRequestClientCredentials as a base R list.
    #' @examples
    #' # convert array of OauthAccessTokenRequestClientCredentials (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert OauthAccessTokenRequestClientCredentials to a base R type
    #'
