...
CatalogsProductGroupMultipleStringListCriteria <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return CatalogsProductGroupMultipleStringListCriteria as a base R list.
    #' @examples
    #' # convert array of CatalogsProductGroupMultipleStringListCriteria (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CatalogsProductGroupMultipleStringListCriteria to a base R type
    #'
