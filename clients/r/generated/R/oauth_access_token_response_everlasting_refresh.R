...
#'
#' @description
#' OauthAccessTokenResponseEverlastingRefresh Class
#'
#' @docType class
...
OauthAccessTokenResponseEverlastingRefresh <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(`refresh_token`, `refresh_token_expires_in`, `refresh_token_expires_at`, `access_token`, `token_type`, `expires_in`, `scope`, `response_type` = NULL, ...) {
    ...
    #'
    #' @return OauthAccessTokenResponseEverlastingRefresh as a base R list.
    #' @examples
    #' # convert array of OauthAccessTokenResponseEverlastingRefresh (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert OauthAccessTokenResponseEverlastingRefresh to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(OauthAccessTokenResponseEverlastingRefreshObject)
    },
