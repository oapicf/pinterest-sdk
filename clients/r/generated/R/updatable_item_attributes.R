...
UpdatableItemAttributes <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return UpdatableItemAttributes as a base R list.
    #' @examples
    #' # convert array of UpdatableItemAttributes (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    toSimpleType = function() {
      ...
      if (!is.null(self$`ad_video_0_link`)) {
        UpdatableItemAttributesObject[["ad_video_0_link"]] <-
          self$`ad_video_0_link`
      }
      if (!is.null(self$`ad_video_0_tag`)) {
        UpdatableItemAttributesObject[["ad_video_0_tag"]] <-
          self$`ad_video_0_tag`
      }
      if (!is.null(self$`ad_video_1_link`)) {
        UpdatableItemAttributesObject[["ad_video_1_link"]] <-
          self$`ad_video_1_link`
      }
      if (!is.null(self$`ad_video_1_tag`)) {
        UpdatableItemAttributesObject[["ad_video_1_tag"]] <-
          self$`ad_video_1_tag`
      }
      if (!is.null(self$`ad_video_2_link`)) {
        UpdatableItemAttributesObject[["ad_video_2_link"]] <-
          self$`ad_video_2_link`
      }
      if (!is.null(self$`ad_video_2_tag`)) {
        UpdatableItemAttributesObject[["ad_video_2_tag"]] <-
          self$`ad_video_2_tag`
      }
      ...
      if (!is.null(self$`android_deep_link`)) {
        UpdatableItemAttributesObject[["android_deep_link"]] <-
      ...
      if (!is.null(self$`custom_number_0`)) {
        UpdatableItemAttributesObject[["custom_number_0"]] <-
          self$`custom_number_0`
      }
      if (!is.null(self$`custom_number_1`)) {
        UpdatableItemAttributesObject[["custom_number_1"]] <-
          self$`custom_number_1`
      }
      if (!is.null(self$`custom_number_2`)) {
        UpdatableItemAttributesObject[["custom_number_2"]] <-
          self$`custom_number_2`
      }
      if (!is.null(self$`custom_number_3`)) {
        UpdatableItemAttributesObject[["custom_number_3"]] <-
          self$`custom_number_3`
      }
      if (!is.null(self$`custom_number_4`)) {
        UpdatableItemAttributesObject[["custom_number_4"]] <-
      ...
      if (!is.null(self$`installment_price`)) {
        UpdatableItemAttributesObject[["installment_price"]] <-
          self$`installment_price`
      }
      if (!is.null(self$`ios_deep_link`)) {
        UpdatableItemAttributesObject[["ios_deep_link"]] <-
          self$`ios_deep_link`
      }
      ...
      if (!is.null(self$`promotion_id`)) {
        UpdatableItemAttributesObject[["promotion_id"]] <-
          self$`promotion_id`
      }
      ...
      if (!is.null(self$`sale_price_effective_date`)) {
        UpdatableItemAttributesObject[["sale_price_effective_date"]] <-
      ...
      if (!is.null(self$`unit_pricing_base_measure`)) {
        UpdatableItemAttributesObject[["unit_pricing_base_measure"]] <-
          self$`unit_pricing_base_measure`
      }
      if (!is.null(self$`unit_pricing_measure`)) {
        UpdatableItemAttributesObject[["unit_pricing_measure"]] <-
      ...
      return(UpdatableItemAttributesObject)
    },
