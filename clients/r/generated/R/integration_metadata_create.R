#' Create a new IntegrationMetadataCreate
#'
#' @description
#' Resource create operation model.
#'
#' @docType class
#' @title IntegrationMetadataCreate
#' @description IntegrationMetadataCreate Class
...
#' @export
IntegrationMetadataCreate <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new IntegrationMetadataCreate class.
    #'
    ...
    #'
    #' @return IntegrationMetadataCreate as a base R list.
    #' @examples
    #' # convert array of IntegrationMetadataCreate (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert IntegrationMetadataCreate to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      IntegrationMetadataCreateObject <- list()
      if (!is.null(self$`additional_id_1`)) {
        IntegrationMetadataCreateObject[["additional_id_1"]] <-
          self$`additional_id_1`
      }
      if (!is.null(self$`connected_advertiser_id`)) {
        IntegrationMetadataCreateObject[["connected_advertiser_id"]] <-
          self$`connected_advertiser_id`
      }
      if (!is.null(self$`connected_lba_id`)) {
        IntegrationMetadataCreateObject[["connected_lba_id"]] <-
          self$`connected_lba_id`
      }
      if (!is.null(self$`connected_merchant_id`)) {
        IntegrationMetadataCreateObject[["connected_merchant_id"]] <-
          self$`connected_merchant_id`
      }
      if (!is.null(self$`connected_tag_id`)) {
        IntegrationMetadataCreateObject[["connected_tag_id"]] <-
          self$`connected_tag_id`
      }
      if (!is.null(self$`external_business_id`)) {
        IntegrationMetadataCreateObject[["external_business_id"]] <-
          self$`external_business_id`
      }
      if (!is.null(self$`partner_access_token`)) {
        IntegrationMetadataCreateObject[["partner_access_token"]] <-
          self$`partner_access_token`
      }
      if (!is.null(self$`partner_access_token_expiry`)) {
        IntegrationMetadataCreateObject[["partner_access_token_expiry"]] <-
          self$`partner_access_token_expiry`
      }
      if (!is.null(self$`partner_metadata`)) {
        IntegrationMetadataCreateObject[["partner_metadata"]] <-
          self$`partner_metadata`
      }
      if (!is.null(self$`partner_primary_email`)) {
        IntegrationMetadataCreateObject[["partner_primary_email"]] <-
          self$`partner_primary_email`
      }
      if (!is.null(self$`partner_refresh_token`)) {
        IntegrationMetadataCreateObject[["partner_refresh_token"]] <-
          self$`partner_refresh_token`
      }
      if (!is.null(self$`partner_refresh_token_expiry`)) {
        IntegrationMetadataCreateObject[["partner_refresh_token_expiry"]] <-
          self$`partner_refresh_token_expiry`
      }
      if (!is.null(self$`scopes`)) {
        IntegrationMetadataCreateObject[["scopes"]] <-
          self$`scopes`
      }
      return(IntegrationMetadataCreateObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of IntegrationMetadataCreate
    #'
    #' @param input_json the JSON input
    #' @return the instance of IntegrationMetadataCreate
    ...
    #' @return IntegrationMetadataCreate in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to IntegrationMetadataCreate and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of IntegrationMetadataCreate
    toString = function() {
      self$toJSONString()
    },
...
# IntegrationMetadataCreate$unlock()
#
## Below is an example to define the print function
# IntegrationMetadataCreate$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# IntegrationMetadataCreate$lock()
