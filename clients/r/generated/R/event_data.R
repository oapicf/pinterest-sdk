...
#' @docType class
#' @title EventData
#' @description EventData Class
#' @format An \code{R6Class} generator object
#' @field currency Currency. For example, 'USD'. \link{Currency} [optional]
...
EventData <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new EventData class.
    #'
    ...
    #'
    #' @return EventData as a base R list.
    #' @examples
    #' # convert array of EventData (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert EventData to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      EventDataObject <- list()
      if (!is.null(self$`currency`)) {
        EventDataObject[["currency"]] <-
          self$extractSimpleType(self$`currency`)
      }
      if (!is.null(self$`lead_type`)) {
        EventDataObject[["lead_type"]] <-
          self$`lead_type`
      }
      if (!is.null(self$`line_items`)) {
        EventDataObject[["line_items"]] <-
          self$extractSimpleType(self$`line_items`)
      }
      if (!is.null(self$`order_id`)) {
        EventDataObject[["order_id"]] <-
          self$`order_id`
      }
      if (!is.null(self$`order_quantity`)) {
        EventDataObject[["order_quantity"]] <-
          self$`order_quantity`
      }
      if (!is.null(self$`page_name`)) {
        EventDataObject[["page_name"]] <-
          self$`page_name`
      }
      if (!is.null(self$`promo_code`)) {
        EventDataObject[["promo_code"]] <-
          self$`promo_code`
      }
      if (!is.null(self$`property`)) {
        EventDataObject[["property"]] <-
          self$`property`
      }
      if (!is.null(self$`search_query`)) {
        EventDataObject[["search_query"]] <-
          self$`search_query`
      }
    ...
    #' @description
    #' Deserialize JSON string into an instance of EventData
    #'
    ...
    #' @return EventData in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to EventData and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of EventData
    toString = function() {
      self$toJSONString()
    },
...
# EventData$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
