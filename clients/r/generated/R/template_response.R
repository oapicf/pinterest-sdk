...
TemplateResponse <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(`ad_account_id` = NULL, `ad_account_ids` = NULL, `click_window_days` = NULL, `columns` = NULL, `conversion_report_time_type` = NULL, `creation_source` = NULL, `custom_column_ids` = NULL, `date_range` = NULL, `engagement_window_days` = NULL, `filters_json` = NULL, `granularity` = NULL, `id` = NULL, `ingestion_sources` = NULL, `is_deleted` = NULL, `is_owned_by_user` = NULL, `is_scheduled` = NULL, `name` = NULL, `report_end_relative_days_in_past` = NULL, `report_format` = NULL, `report_level` = NULL, `report_start_relative_days_in_past` = NULL, `type` = NULL, `updated_time` = NULL, `user_id` = NULL, `view_window_days` = NULL, ...) {
