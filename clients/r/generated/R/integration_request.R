...
IntegrationRequest <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return IntegrationRequest as a base R list.
    #' @examples
    #' # convert array of IntegrationRequest (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert IntegrationRequest to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(IntegrationRequestObject)
    },
