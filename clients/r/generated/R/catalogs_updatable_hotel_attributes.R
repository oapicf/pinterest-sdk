...
CatalogsUpdatableHotelAttributes <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(`address` = NULL, `base_price` = NULL, `brand` = NULL, `category` = NULL, `custom_label_0` = NULL, `custom_label_1` = NULL, `custom_label_2` = NULL, `custom_label_3` = NULL, `custom_label_4` = NULL, `description` = NULL, `guest_ratings` = NULL, `latitude` = NULL, `link` = NULL, `longitude` = NULL, `name` = NULL, `neighborhood` = NULL, `sale_price` = NULL, ...) {
      if (!is.null(`address`)) {
    ...
    #'
    #' @return CatalogsUpdatableHotelAttributes as a base R list.
    #' @examples
    #' # convert array of CatalogsUpdatableHotelAttributes (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CatalogsUpdatableHotelAttributes to a base R type
    #'
