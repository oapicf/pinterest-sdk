...
#' @description LeadFormCreate Class
...
LeadFormCreate <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new LeadFormCreate class.
    #'
    ...
    initialize = function(`completion_message`, `has_accepted_terms`, `name`, `privacy_policy_link`, `questions`, `disclosure_language` = NULL, `policy_links` = NULL, `status` = NULL, ...) {
    ...
    #'
    #' @return LeadFormCreate as a base R list.
    #' @examples
    #' # convert array of LeadFormCreate (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Deserialize JSON string into an instance of LeadFormCreate
    #'
    #' @param input_json the JSON input
    #' @return the instance of LeadFormCreate
    ...
    #' @return LeadFormCreate in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to LeadFormCreate and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`completion_message`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for LeadFormCreate: the required field `completion_message` is missing."))
      }
      ...
      if (!is.null(input_json$`has_accepted_terms`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for LeadFormCreate: the required field `has_accepted_terms` is missing."))
      }
      ...
      if (!is.null(input_json$`name`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for LeadFormCreate: the required field `name` is missing."))
      }
      ...
      if (!is.null(input_json$`privacy_policy_link`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for LeadFormCreate: the required field `privacy_policy_link` is missing."))
      }
      ...
      if (!is.null(input_json$`questions`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for LeadFormCreate: the required field `questions` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of LeadFormCreate
    toString = function() {
      self$toJSONString()
    },
...
# LeadFormCreate$unlock()
#
## Below is an example to define the print function
# LeadFormCreate$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
