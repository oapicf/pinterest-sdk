...
CatalogsFeedsCreateRequest <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(`name`, `format`, `location`, `default_currency` = NULL, `default_locale` = NULL, `credentials` = NULL, `preferred_processing_schedule` = NULL, `default_country` = NULL, `default_availability` = NULL, `status` = NULL, ...) {
      if (!missing(`name`)) {
