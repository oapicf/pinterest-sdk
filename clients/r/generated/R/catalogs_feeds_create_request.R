...
CatalogsFeedsCreateRequest <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(`name`, `format`, `location`, `default_currency` = NULL, `default_locale` = NULL, `credentials` = NULL, `preferred_processing_schedule` = NULL, `default_country` = NULL, `default_availability` = NULL, `status` = "ACTIVE", ...) {
      if (!missing(`name`)) {
    ...
    #'
    #' @return CatalogsFeedsCreateRequest as a base R list.
    #' @examples
    #' # convert array of CatalogsFeedsCreateRequest (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CatalogsFeedsCreateRequest to a base R type
    #'
