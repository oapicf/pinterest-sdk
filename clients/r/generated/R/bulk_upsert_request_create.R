...
#' @field catalog_product_groups  list(\link{MultipleProductGroupsInner}) [optional]
#' @field keywords  list(\link{KeywordsRequest}) [optional]
#' @field labels  list(\link{LabelCreateRequest}) [optional]
  ...
  public = list(
    ...
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`catalog_product_groups`)) {
        self$`catalog_product_groups` <- ApiClient$new()$deserializeObj(this_object$`catalog_product_groups`, "array[MultipleProductGroupsInner]", loadNamespace("openapi"))
      }
      ...
      if (!is.null(this_object$`labels`)) {
        self$`labels` <- ApiClient$new()$deserializeObj(this_object$`labels`, "array[LabelCreateRequest]", loadNamespace("openapi"))
      }
