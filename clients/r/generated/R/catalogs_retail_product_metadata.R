#' Create a new CatalogsRetailProductMetadata
#'
#' @description
...
CatalogsRetailProductMetadata <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Validate JSON input with respect to CatalogsRetailProductMetadata and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`price`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for CatalogsRetailProductMetadata: the required field `price` is missing."))
      }
    ...
    #'
    #' @return String representation of CatalogsRetailProductMetadata
    toString = function() {
      self$toJSONString()
    },
...
# CatalogsRetailProductMetadata$unlock()
#
## Below is an example to define the print function
# CatalogsRetailProductMetadata$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# CatalogsRetailProductMetadata$lock()
