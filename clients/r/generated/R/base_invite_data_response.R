...
BaseInviteDataResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return BaseInviteDataResponse as a base R list.
    #' @examples
    #' # convert array of BaseInviteDataResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert BaseInviteDataResponse to a base R type
    #'
