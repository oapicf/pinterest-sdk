...
CatalogsCreativeAssetsProductGroupFiltersAllOf <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return CatalogsCreativeAssetsProductGroupFiltersAllOf as a base R list.
    #' @examples
    #' # convert array of CatalogsCreativeAssetsProductGroupFiltersAllOf (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CatalogsCreativeAssetsProductGroupFiltersAllOf to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(CatalogsCreativeAssetsProductGroupFiltersAllOfObject)
    },
