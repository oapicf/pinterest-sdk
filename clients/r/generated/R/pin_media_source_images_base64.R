...
#' @field items Array with image objects. list(\link{PinMediaSourceImagesBase64ItemsInner})
  ...
  public = list(
    ...
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`items`)) {
        self$`items` <- ApiClient$new()$deserializeObj(this_object$`items`, "array[PinMediaSourceImagesBase64ItemsInner]", loadNamespace("openapi"))
      }
...
',
    ...
    #' Validate JSON input with respect to PinMediaSourceImagesBase64
    #'
    #' @description
