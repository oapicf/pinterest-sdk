...
TargetingTemplateAudienceSizing <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return TargetingTemplateAudienceSizing as a base R list.
    #' @examples
    #' # convert array of TargetingTemplateAudienceSizing (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert TargetingTemplateAudienceSizing to a base R type
    #'
