#' Create a new TargetingSpecOperationList
#'
#' @description
#' TargetingSpecOperationList Class
#'
#' @docType class
#' @title TargetingSpecOperationList
#' @description TargetingSpecOperationList Class
...
#' @export
TargetingSpecOperationList <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new TargetingSpecOperationList class.
    #'
    #' @param field field
    ...
    #'
    #' @return TargetingSpecOperationList as a base R list.
    #' @examples
    #' # convert array of TargetingSpecOperationList (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert TargetingSpecOperationList to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      TargetingSpecOperationListObject <- list()
      if (!is.null(self$`field`)) {
        TargetingSpecOperationListObject[["field"]] <-
          self$`field`
      }
      if (!is.null(self$`operation`)) {
        TargetingSpecOperationListObject[["operation"]] <-
          self$`operation`
      }
      if (!is.null(self$`values`)) {
        TargetingSpecOperationListObject[["values"]] <-
          self$`values`
      }
      return(TargetingSpecOperationListObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of TargetingSpecOperationList
    #'
    #' @param input_json the JSON input
    #' @return the instance of TargetingSpecOperationList
    ...
    #' @return TargetingSpecOperationList in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to TargetingSpecOperationList and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`field`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for TargetingSpecOperationList: the required field `field` is missing."))
      }
      ...
      if (!is.null(input_json$`operation`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for TargetingSpecOperationList: the required field `operation` is missing."))
      }
      ...
      if (!is.null(input_json$`values`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for TargetingSpecOperationList: the required field `values` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of TargetingSpecOperationList
    toString = function() {
      self$toJSONString()
    },
...
# TargetingSpecOperationList$unlock()
#
## Below is an example to define the print function
# TargetingSpecOperationList$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# TargetingSpecOperationList$lock()
