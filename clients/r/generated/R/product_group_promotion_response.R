...
ProductGroupPromotionResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return ProductGroupPromotionResponse as a base R list.
    #' @examples
    #' # convert array of ProductGroupPromotionResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ProductGroupPromotionResponse to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(ProductGroupPromotionResponseObject)
    },
