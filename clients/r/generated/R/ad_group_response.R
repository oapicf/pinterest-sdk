...
#' @field bid_multiplier <a href=\"/docs/getting-started/using-beta-and-restricted-features/\" target=\"blank>Open beta</a> Bid multiplier for ad group. This value is a double between 0.1 and 10.0. Enter 0 to remove the bid multiplier. - Not currently supported for <a href=\"/docs/api-features/pinterest-performance-plus-setup/\" target=\"blank\">Pinterest Performance+ campaigns</a>. numeric [optional]
...
AdGroupResponse <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(`auto_targeting_enabled` = NULL, `bid_in_micro_currency` = NULL, `bid_strategy_type` = NULL, `billable_event` = NULL, `budget_in_micro_currency` = NULL, `budget_type` = NULL, `campaign_id` = NULL, `end_time` = NULL, `is_creative_optimization` = NULL, `lifetime_frequency_cap` = NULL, `name` = NULL, `optimization_goal_metadata` = NULL, `pacing_delivery_type` = NULL, `placement_group` = NULL, `promotion_application_level` = NULL, `promotion_id` = "0", `start_time` = NULL, `status` = NULL, `targeting_spec` = NULL, `targeting_template_ids` = NULL, `tracking_urls` = NULL, `ad_account_id` = NULL, `bid_multiplier` = NULL, `conversion_learning_mode_type` = NULL, `created_time` = NULL, `dca_assets` = NULL, `feed_profile_id` = NULL, `id` = NULL, `summary_status` = NULL, `type` = "adgroup", `updated_time` = NULL, ...) {
    ...
    toSimpleType = function() {
      ...
      if (!is.null(self$`is_creative_optimization`)) {
        AdGroupResponseObject[["is_creative_optimization"]] <-
      ...
      if (!is.null(self$`promotion_application_level`)) {
        AdGroupResponseObject[["promotion_application_level"]] <-
          self$`promotion_application_level`
      }
      if (!is.null(self$`promotion_id`)) {
        AdGroupResponseObject[["promotion_id"]] <-
          self$`promotion_id`
      }
      ...
      if (!is.null(self$`bid_multiplier`)) {
        AdGroupResponseObject[["bid_multiplier"]] <-
          self$`bid_multiplier`
      }
