...
#' @field opt_out_type Flags for different privacy rights laws to opt out users of sharing personal information. Separate values with commas. See the Help Center article about <a href=\"https://help.pinterest.com/en/business/article/limited-data-processing\" target=\"_blank\">limited data processing</a> and the developer's guide for <a href=\"/docs/track-conversions/track-conversions-in-the-api/#whether-the-user-has-opted-out-of-web-or-offline-conversion-events\" target=\"_blank\">tracking conversion events</a> for help with using this parameter. character [optional]
...
ConversionEventsDataInnerCustomData <- R6::R6Class(
  ...
  public = list(
    ...
    #' @param opt_out_type Flags for different privacy rights laws to opt out users of sharing personal information. Separate values with commas. See the Help Center article about <a href=\"https://help.pinterest.com/en/business/article/limited-data-processing\" target=\"_blank\">limited data processing</a> and the developer's guide for <a href=\"/docs/track-conversions/track-conversions-in-the-api/#whether-the-user-has-opted-out-of-web-or-offline-conversion-events\" target=\"_blank\">tracking conversion events</a> for help with using this parameter.
    ...
    #'
    #' @return ConversionEventsDataInnerCustomData as a base R list.
    #' @examples
    #' # convert array of ConversionEventsDataInnerCustomData (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ConversionEventsDataInnerCustomData to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      if (!is.null(self$`contents`)) {
        ConversionEventsDataInnerCustomDataObject[["contents"]] <-
          lapply(self$`contents`, function(x) x$toSimpleType())
      }
      ...
      if (!is.null(self$`external_measurement_id`)) {
        ConversionEventsDataInnerCustomDataObject[["external_measurement_id"]] <-
          self$`external_measurement_id`
      }
      if (!is.null(self$`external_measurement_vendor_id`)) {
        ConversionEventsDataInnerCustomDataObject[["external_measurement_vendor_id"]] <-
      ...
      if (!is.null(self$`predicted_ltv`)) {
        ConversionEventsDataInnerCustomDataObject[["predicted_ltv"]] <-
          self$`predicted_ltv`
      }
      ...
      return(ConversionEventsDataInnerCustomDataObject)
    },
