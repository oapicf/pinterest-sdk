...
GoogleProductCategory0Filter <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return GoogleProductCategory0Filter as a base R list.
    #' @examples
    #' # convert array of GoogleProductCategory0Filter (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert GoogleProductCategory0Filter to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      if (!is.null(self$`GOOGLE_PRODUCT_CATEGORY_0`)) {
        GoogleProductCategory0FilterObject[["GOOGLE_PRODUCT_CATEGORY_0"]] <-
          self$extractSimpleType(self$`GOOGLE_PRODUCT_CATEGORY_0`)
      }
      return(GoogleProductCategory0FilterObject)
    },
