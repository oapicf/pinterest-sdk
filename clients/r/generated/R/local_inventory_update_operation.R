#' Create a new LocalInventoryUpdateOperation
#'
#' @description
#' Update operation for local inventory item
#'
#' @docType class
#' @title LocalInventoryUpdateOperation
#' @description LocalInventoryUpdateOperation Class
#' @format An \code{R6Class} generator object
#' @field attributes  \link{RetailLocalInventoryItemAttributesOptional}
...
#' @export
LocalInventoryUpdateOperation <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new LocalInventoryUpdateOperation class.
    #'
    ...
    #'
    #' @return LocalInventoryUpdateOperation as a base R list.
    #' @examples
    #' # convert array of LocalInventoryUpdateOperation (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert LocalInventoryUpdateOperation to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      LocalInventoryUpdateOperationObject <- list()
      if (!is.null(self$`attributes`)) {
        LocalInventoryUpdateOperationObject[["attributes"]] <-
          self$extractSimpleType(self$`attributes`)
      }
      if (!is.null(self$`item_id`)) {
        LocalInventoryUpdateOperationObject[["item_id"]] <-
          self$`item_id`
      }
      if (!is.null(self$`operation`)) {
        LocalInventoryUpdateOperationObject[["operation"]] <-
          self$`operation`
      }
      if (!is.null(self$`store_code`)) {
        LocalInventoryUpdateOperationObject[["store_code"]] <-
          self$`store_code`
      }
      return(LocalInventoryUpdateOperationObject)
    },
    ...
    #' @description
    #' Deserialize JSON string into an instance of LocalInventoryUpdateOperation
    #'
    #' @param input_json the JSON input
    #' @return the instance of LocalInventoryUpdateOperation
    fromJSON = function(input_json) {
      this_object <- jsonlite::fromJSON(input_json)
      if (!is.null(this_object$`attributes`)) {
        `attributes_object` <- RetailLocalInventoryItemAttributesOptional$new()
    ...
    #' @return LocalInventoryUpdateOperation in JSON format
    ...
    fromJSONString = function(input_json) {
      this_object <- jsonlite::fromJSON(input_json)
      self$`attributes` <- RetailLocalInventoryItemAttributesOptional$new()$fromJSON(jsonlite::toJSON(this_object$`attributes`, auto_unbox = TRUE, digits = NA))
      self$`item_id` <- this_object$`item_id`
      if (!is.null(this_object$`operation`) && !(this_object$`operation` %in% c("UPDATE"))) {
        stop(paste("Error! \"", this_object$`operation`, "\" cannot be assigned to `operation`. Must be \"UPDATE\".", sep = ""))
      }
    ...
    #' @description
    #' Validate JSON input with respect to LocalInventoryUpdateOperation and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`attributes`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for LocalInventoryUpdateOperation: the required field `attributes` is missing."))
      }
      ...
      if (!is.null(input_json$`item_id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for LocalInventoryUpdateOperation: the required field `item_id` is missing."))
      }
      ...
      if (!is.null(input_json$`operation`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for LocalInventoryUpdateOperation: the required field `operation` is missing."))
      }
      ...
      if (!is.null(input_json$`store_code`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for LocalInventoryUpdateOperation: the required field `store_code` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of LocalInventoryUpdateOperation
    toString = function() {
      self$toJSONString()
    },
...
# LocalInventoryUpdateOperation$unlock()
#
## Below is an example to define the print function
# LocalInventoryUpdateOperation$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# LocalInventoryUpdateOperation$lock()
