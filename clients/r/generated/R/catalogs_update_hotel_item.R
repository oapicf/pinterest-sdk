...
CatalogsUpdateHotelItem <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return CatalogsUpdateHotelItem as a base R list.
    #' @examples
    #' # convert array of CatalogsUpdateHotelItem (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CatalogsUpdateHotelItem to a base R type
    #'
