...
BookClosedResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return BookClosedResponse as a base R list.
    #' @examples
    #' # convert array of BookClosedResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert BookClosedResponse to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(BookClosedResponseObject)
    },
