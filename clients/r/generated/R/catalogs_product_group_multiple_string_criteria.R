...
CatalogsProductGroupMultipleStringCriteria <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return CatalogsProductGroupMultipleStringCriteria as a base R list.
    #' @examples
    #' # convert array of CatalogsProductGroupMultipleStringCriteria (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CatalogsProductGroupMultipleStringCriteria to a base R type
    #'
