...
SharedAudience <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return SharedAudience as a base R list.
    #' @examples
    #' # convert array of SharedAudience (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert SharedAudience to a base R type
    #'
