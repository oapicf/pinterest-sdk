#' @docType class
#' @title CatalogsHotelReportStatsParametersReport
#'
#' @description CatalogsHotelReportStatsParametersReport Class
#'
...
#' @export
CatalogsHotelReportStatsParametersReport <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new CatalogsHotelReportStatsParametersReport.
    #'
    ...
    initialize = function(instance = NULL) {
      if (is.null(instance)) {
        ...
        stop(paste("Failed to initialize CatalogsHotelReportStatsParametersReport with oneOf schemas CatalogsReportDistributionIssueFilter, CatalogsReportFeedIngestionFilter. Provided class name: ",
                   get(class(instance)[[1]], pos = -1)$classname))
      }
    },

    #' @description
    #' Deserialize JSON string into an instance of CatalogsHotelReportStatsParametersReport.
    #' An alias to the method `fromJSON` .
    #'
    #' @param input The input JSON.
    #'
    #' @return An instance of CatalogsHotelReportStatsParametersReport.
    ...
    fromJSON = function(input) {
      ...
      if (matched == 1) {
        ...
        # more than 1 match
        stop(paste("Multiple matches found when deserializing the input into CatalogsHotelReportStatsParametersReport with oneOf schemas CatalogsReportDistributionIssueFilter, CatalogsReportFeedIngestionFilter. Matched schemas: ",
                   paste(matched_schemas, collapse = ", ")))
      } else {
        # no match
        stop(paste("No match found when deserializing the input into CatalogsHotelReportStatsParametersReport with oneOf schemas CatalogsReportDistributionIssueFilter, CatalogsReportFeedIngestionFilter. Details: >>",
    ...
    #' @description
    #' Serialize CatalogsHotelReportStatsParametersReport to JSON string.
    #' 
    #' @param ... Parameters passed to `jsonlite::toJSON`
    #' @return JSON string representation of the CatalogsHotelReportStatsParametersReport.
    ...
    #' @description
    #' Convert CatalogsHotelReportStatsParametersReport to a base R type
    #'
    ...
    #' @description
    #' Validate the input JSON with respect to CatalogsHotelReportStatsParametersReport and
...
#CatalogsHotelReportStatsParametersReport$unlock()
#
## Below is an example to define the print function
#CatalogsHotelReportStatsParametersReport$set("public", "print", function(...) {
#  print(jsonlite::prettify(self$toJSONString()))
#  invisible(self)
#})
## Uncomment below to lock the class to prevent modifications to the method or field
#CatalogsHotelReportStatsParametersReport$lock()
