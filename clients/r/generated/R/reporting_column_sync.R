#' @docType class
#' @title ReportingColumnSync
#' @description ReportingColumnSync Class
#' @format An \code{R6Class} generator object
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
ReportingColumnSync <- R6::R6Class(
  "ReportingColumnSync",
  public = list(

    #' @description
    #' Initialize a new ReportingColumnSync class.
    #'
    #' @param ... Optional arguments.
    initialize = function(...) {
      local.optional.var <- list(...)
      val <- unlist(local.optional.var)
      enumvec <- .parse_ReportingColumnSync()
    ...
    #' @description
    #' Convert ReportingColumnSync to a base R type
    #'
    ...
    #' @description
    #' Deserialize JSON string into an instance of ReportingColumnSync
    #'
    #' @param input_json the JSON input
    #'
    #' @return the instance of ReportingColumnSync
    ...
    #' @return ReportingColumnSync in JSON format
