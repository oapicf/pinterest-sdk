#' Create a new BusinessToAdAccountSharedAudience
#'
#' @description
...
#' @description BusinessToAdAccountSharedAudience Class
...
#' @export
BusinessToAdAccountSharedAudience <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new BusinessToAdAccountSharedAudience class.
    #'
    ...
    #'
    #' @return BusinessToAdAccountSharedAudience as a base R list.
    #' @examples
    #' # convert array of BusinessToAdAccountSharedAudience (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert BusinessToAdAccountSharedAudience to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      BusinessToAdAccountSharedAudienceObject <- list()
      if (!is.null(self$`audience_id`)) {
        BusinessToAdAccountSharedAudienceObject[["audience_id"]] <-
          self$`audience_id`
      }
      if (!is.null(self$`permissions`)) {
        BusinessToAdAccountSharedAudienceObject[["permissions"]] <-
          self$extractSimpleType(self$`permissions`)
      }
      if (!is.null(self$`recipient_account_ids`)) {
        BusinessToAdAccountSharedAudienceObject[["recipient_account_ids"]] <-
          self$`recipient_account_ids`
      }
      return(BusinessToAdAccountSharedAudienceObject)
    },
    ...
    #' @description
    #' Deserialize JSON string into an instance of BusinessToAdAccountSharedAudience
    #'
    #' @param input_json the JSON input
    #' @return the instance of BusinessToAdAccountSharedAudience
    ...
    #' @return BusinessToAdAccountSharedAudience in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to BusinessToAdAccountSharedAudience and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`audience_id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for BusinessToAdAccountSharedAudience: the required field `audience_id` is missing."))
      }
      ...
      if (!is.null(input_json$`recipient_account_ids`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for BusinessToAdAccountSharedAudience: the required field `recipient_account_ids` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of BusinessToAdAccountSharedAudience
    toString = function() {
      self$toJSONString()
    },
...
# BusinessToAdAccountSharedAudience$unlock()
#
## Below is an example to define the print function
# BusinessToAdAccountSharedAudience$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# BusinessToAdAccountSharedAudience$lock()
