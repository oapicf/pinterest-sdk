...
AdsAnalyticsCampaignTargetingType <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Convert AdsAnalyticsCampaignTargetingType to a base R type
    #'
...
.parse_AdsAnalyticsCampaignTargetingType <- function(vals) {
  res <- gsub("^\\[|\\]$", "", "[KEYWORD, APPTYPE, GENDER, LOCATION, PLACEMENT, COUNTRY, TARGETED_INTEREST, PINNER_INTEREST, AUDIENCE_INCLUDE, GEO, AGE_BUCKET, REGION, CREATIVE_TYPE, AGE_BUCKET_AND_GENDER, AUDIENCE_MULTIPLIER]")
  unlist(strsplit(res, ", "))
}
