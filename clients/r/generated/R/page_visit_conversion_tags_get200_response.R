...
PageVisitConversionTagsGet200Response <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return PageVisitConversionTagsGet200Response as a base R list.
    #' @examples
    #' # convert array of PageVisitConversionTagsGet200Response (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert PageVisitConversionTagsGet200Response to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(PageVisitConversionTagsGet200ResponseObject)
    },
