...
AdAccountsCountryResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return AdAccountsCountryResponse as a base R list.
    #' @examples
    #' # convert array of AdAccountsCountryResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert AdAccountsCountryResponse to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(AdAccountsCountryResponseObject)
    },
