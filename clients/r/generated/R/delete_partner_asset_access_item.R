#' Create a new DeletePartnerAssetAccessItem
#'
#' @description
#' DeletePartnerAssetAccessItem Class
#'
#' @docType class
#' @title DeletePartnerAssetAccessItem
#' @description DeletePartnerAssetAccessItem Class
...
#' @field partner_type If partner_type=INTERNAL, the deleted asset access is for the access the partner has to your business asset. If partner_type=EXTERNAL, the deleted asset access is for the access you have to the partner's business asset. character [optional]
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
DeletePartnerAssetAccessItem <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new DeletePartnerAssetAccessItem class.
    #'
    ...
    #' @param partner_type If partner_type=INTERNAL, the deleted asset access is for the access the partner has to your business asset. If partner_type=EXTERNAL, the deleted asset access is for the access you have to the partner's business asset.. Default to "INTERNAL".
    #' @param ... Other optional arguments.
    initialize = function(`asset_id`, `partner_id`, `partner_type` = "INTERNAL", ...) {
      if (!missing(`asset_id`)) {
    ...
    #'
    #' @return DeletePartnerAssetAccessItem as a base R list.
    #' @examples
    #' # convert array of DeletePartnerAssetAccessItem (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert DeletePartnerAssetAccessItem to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      DeletePartnerAssetAccessItemObject <- list()
      if (!is.null(self$`asset_id`)) {
        DeletePartnerAssetAccessItemObject[["asset_id"]] <-
          self$`asset_id`
      }
      if (!is.null(self$`partner_id`)) {
        DeletePartnerAssetAccessItemObject[["partner_id"]] <-
          self$`partner_id`
      }
      if (!is.null(self$`partner_type`)) {
        DeletePartnerAssetAccessItemObject[["partner_type"]] <-
          self$`partner_type`
      }
      return(DeletePartnerAssetAccessItemObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of DeletePartnerAssetAccessItem
    #'
    #' @param input_json the JSON input
    #' @return the instance of DeletePartnerAssetAccessItem
    ...
    #' @return DeletePartnerAssetAccessItem in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to DeletePartnerAssetAccessItem and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`asset_id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for DeletePartnerAssetAccessItem: the required field `asset_id` is missing."))
      }
      ...
      if (!is.null(input_json$`partner_id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for DeletePartnerAssetAccessItem: the required field `partner_id` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of DeletePartnerAssetAccessItem
    toString = function() {
      self$toJSONString()
    },
...
# DeletePartnerAssetAccessItem$unlock()
#
## Below is an example to define the print function
# DeletePartnerAssetAccessItem$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# DeletePartnerAssetAccessItem$lock()
