...
#' @field items  list(\link{AccountTemplate})
...
TemplatesList200Response <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return TemplatesList200Response as a base R list.
    #' @examples
    #' # convert array of TemplatesList200Response (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert TemplatesList200Response to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(TemplatesList200ResponseObject)
    },
    ...
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`items`)) {
        self$`items` <- ApiClient$new()$deserializeObj(this_object$`items`, "array[AccountTemplate]", loadNamespace("openapi"))
      }
      self
    },
