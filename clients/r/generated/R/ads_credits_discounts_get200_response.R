#' Create a new AdsCreditsDiscountsGet200Response
#'
#' @description
...
AdsCreditsDiscountsGet200Response <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return AdsCreditsDiscountsGet200Response as a base R list.
    #' @examples
    #' # convert array of AdsCreditsDiscountsGet200Response (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert AdsCreditsDiscountsGet200Response to a base R type
    #'
    ...
    #' @description
    #' Deserialize JSON string into an instance of AdsCreditsDiscountsGet200Response
    #'
    ...
    #' @return AdsCreditsDiscountsGet200Response in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to AdsCreditsDiscountsGet200Response and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`items`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for AdsCreditsDiscountsGet200Response: the required field `items` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of AdsCreditsDiscountsGet200Response
    toString = function() {
      self$toJSONString()
    },
...
# AdsCreditsDiscountsGet200Response$unlock()
#
## Below is an example to define the print function
# AdsCreditsDiscountsGet200Response$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# AdsCreditsDiscountsGet200Response$lock()
