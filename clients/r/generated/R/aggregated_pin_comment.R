#' Create a new AggregatedPinComment
#'
#' @description
#' AggregatedPinComment Class
#'
#' @docType class
#' @title AggregatedPinComment
#' @description AggregatedPinComment Class
...
#' @export
AggregatedPinComment <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new AggregatedPinComment class.
    #'
    #' @param id id
    ...
    initialize = function(`id`, `ai_disclosures` = NULL, `alt_text` = NULL, `board_id` = NULL, `board_owner` = NULL, `board_section_id` = NULL, `created_at` = NULL, `creative_type` = NULL, `description` = NULL, `dominant_color` = NULL, `has_been_promoted` = NULL, `is_owner` = NULL, `is_product` = NULL, `is_standard` = NULL, `link` = NULL, `media` = NULL, `parent_pin_id` = NULL, `pin_metrics` = NULL, `title` = NULL, ...) {
      if (!missing(`id`)) {
    ...
    #'
    #' @return AggregatedPinComment as a base R list.
    #' @examples
    #' # convert array of AggregatedPinComment (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert AggregatedPinComment to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      AggregatedPinCommentObject <- list()
      if (!is.null(self$`ai_disclosures`)) {
        AggregatedPinCommentObject[["ai_disclosures"]] <-
          self$extractSimpleType(self$`ai_disclosures`)
      }
      if (!is.null(self$`alt_text`)) {
        AggregatedPinCommentObject[["alt_text"]] <-
          self$`alt_text`
      }
      if (!is.null(self$`board_id`)) {
        AggregatedPinCommentObject[["board_id"]] <-
          self$`board_id`
      }
      if (!is.null(self$`board_owner`)) {
        AggregatedPinCommentObject[["board_owner"]] <-
          self$extractSimpleType(self$`board_owner`)
      }
      if (!is.null(self$`board_section_id`)) {
        AggregatedPinCommentObject[["board_section_id"]] <-
          self$`board_section_id`
      }
      if (!is.null(self$`created_at`)) {
        AggregatedPinCommentObject[["created_at"]] <-
          self$`created_at`
      }
      if (!is.null(self$`creative_type`)) {
        AggregatedPinCommentObject[["creative_type"]] <-
          self$extractSimpleType(self$`creative_type`)
      }
      if (!is.null(self$`description`)) {
        AggregatedPinCommentObject[["description"]] <-
          self$`description`
      }
      if (!is.null(self$`dominant_color`)) {
        AggregatedPinCommentObject[["dominant_color"]] <-
          self$`dominant_color`
      }
      if (!is.null(self$`has_been_promoted`)) {
        AggregatedPinCommentObject[["has_been_promoted"]] <-
          self$`has_been_promoted`
      }
      if (!is.null(self$`id`)) {
        AggregatedPinCommentObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`is_owner`)) {
        AggregatedPinCommentObject[["is_owner"]] <-
          self$`is_owner`
      }
      if (!is.null(self$`is_product`)) {
        AggregatedPinCommentObject[["is_product"]] <-
          self$`is_product`
      }
      if (!is.null(self$`is_standard`)) {
        AggregatedPinCommentObject[["is_standard"]] <-
          self$`is_standard`
      }
      if (!is.null(self$`link`)) {
        AggregatedPinCommentObject[["link"]] <-
          self$`link`
      }
      if (!is.null(self$`media`)) {
        AggregatedPinCommentObject[["media"]] <-
          self$extractSimpleType(self$`media`)
      }
      if (!is.null(self$`parent_pin_id`)) {
        AggregatedPinCommentObject[["parent_pin_id"]] <-
          self$`parent_pin_id`
      }
      if (!is.null(self$`pin_metrics`)) {
        AggregatedPinCommentObject[["pin_metrics"]] <-
          self$`pin_metrics`
      }
      if (!is.null(self$`title`)) {
        AggregatedPinCommentObject[["title"]] <-
          self$`title`
      }
      return(AggregatedPinCommentObject)
    },
    ...
    #' @description
    #' Deserialize JSON string into an instance of AggregatedPinComment
    #'
    #' @param input_json the JSON input
    #' @return the instance of AggregatedPinComment
    ...
    #' @return AggregatedPinComment in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to AggregatedPinComment and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for AggregatedPinComment: the required field `id` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of AggregatedPinComment
    toString = function() {
      self$toJSONString()
    },
...
# AggregatedPinComment$unlock()
#
## Below is an example to define the print function
# AggregatedPinComment$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# AggregatedPinComment$lock()
