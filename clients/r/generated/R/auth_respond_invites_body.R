...
AuthRespondInvitesBody <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return AuthRespondInvitesBody as a base R list.
    #' @examples
    #' # convert array of AuthRespondInvitesBody (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert AuthRespondInvitesBody to a base R type
    #'
