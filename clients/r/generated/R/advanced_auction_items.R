...
AdvancedAuctionItems <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return AdvancedAuctionItems as a base R list.
    #' @examples
    #' # convert array of AdvancedAuctionItems (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert AdvancedAuctionItems to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(AdvancedAuctionItemsObject)
    },
