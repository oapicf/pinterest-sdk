...
#' @field items  list(\link{BoardSection})
...
BoardSectionsList200Response <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return BoardSectionsList200Response as a base R list.
    #' @examples
    #' # convert array of BoardSectionsList200Response (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert BoardSectionsList200Response to a base R type
    #'
