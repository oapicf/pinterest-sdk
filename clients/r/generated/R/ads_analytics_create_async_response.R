...
AdsAnalyticsCreateAsyncResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return AdsAnalyticsCreateAsyncResponse as a base R list.
    #' @examples
    #' # convert array of AdsAnalyticsCreateAsyncResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert AdsAnalyticsCreateAsyncResponse to a base R type
    #'
