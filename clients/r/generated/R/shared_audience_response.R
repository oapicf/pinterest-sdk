...
SharedAudienceResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return SharedAudienceResponse as a base R list.
    #' @examples
    #' # convert array of SharedAudienceResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert SharedAudienceResponse to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(SharedAudienceResponseObject)
    },
