...
#'
#' \itemize{
#' \item \emph{ @param } media_upload_request \link{MediaUploadRequest}
...
#'
#' \itemize{
#' \item \emph{ @param } media_id character
...
#' \item \emph{ @returnType } \link{MediaList200Response} \cr
#'
#'
#' \item status code : 200 | response
#'
#' \item return type : MediaList200Response
#' \item response headers :
#'
#' \tabular{ll}{
#' }
