...
MediaApi <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return MediaUpload
    MediaCreate = function(media_upload_create, data_file = NULL, ..., .parse = TRUE) {
      local_var_response <- self$MediaCreateWithHttpInfo(media_upload_create, data_file = data_file, ..., .parse = .parse)
    ...
    MediaCreateWithHttpInfo = function(media_upload_create, data_file = NULL, ..., .parse = TRUE) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
    ...
    #'
    #' @return Media
    MediaGet = function(media_id, data_file = NULL, ..., .parse = TRUE) {
      local_var_response <- self$MediaGetWithHttpInfo(media_id, data_file = data_file, ..., .parse = .parse)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        return(local_var_response$content)
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        return(local_var_response)
    ...
    MediaGetWithHttpInfo = function(media_id, data_file = NULL, ..., .parse = TRUE) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
    ...
    MediaList = function(bookmark = NULL, page_size = 25, data_file = NULL, ..., .parse = TRUE) {
      local_var_response <- self$MediaListWithHttpInfo(bookmark, page_size, data_file = data_file, ..., .parse = .parse)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        return(local_var_response$content)
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        return(local_var_response)
    ...
    MediaListWithHttpInfo = function(bookmark = NULL, page_size = 25, data_file = NULL, ..., .parse = TRUE) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
