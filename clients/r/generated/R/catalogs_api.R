...
CatalogsApi <- R6::R6Class(
  ...
  public = list(
    ...
    CatalogsAvailableFilterValues = function(catalog_id, feed_id = NULL, country = NULL, language = NULL, ad_account_id = NULL, data_file = NULL, ...) {
      local_var_response <- self$CatalogsAvailableFilterValuesWithHttpInfo(catalog_id, feed_id, country, language, ad_account_id, data_file = data_file, ...)
    ...
    CatalogsAvailableFilterValuesWithHttpInfo = function(catalog_id, feed_id = NULL, country = NULL, language = NULL, ad_account_id = NULL, data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
