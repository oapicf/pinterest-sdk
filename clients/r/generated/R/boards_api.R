...
BoardsApi <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return BoardSection
    BoardSectionsCreate = function(board_id, board_section_create, ad_account_id = NULL, data_file = NULL, ..., .parse = TRUE) {
      local_var_response <- self$BoardSectionsCreateWithHttpInfo(board_id, board_section_create, ad_account_id, data_file = data_file, ..., .parse = .parse)
    ...
    BoardSectionsCreateWithHttpInfo = function(board_id, board_section_create, ad_account_id = NULL, data_file = NULL, ..., .parse = TRUE) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      if (missing(`board_section_create`)) {
        stop("Missing required parameter `board_section_create`.")
      }
      ...
      if (!missing(`board_section_create`) && is.null(`board_section_create`)) {
        stop("Invalid value for `board_section_create` when calling BoardsApi$BoardSectionsCreate, `board_section_create` is not nullable")
      }
      ...
      if (!is.null(`board_section_create`)) {
        local_var_body <- `board_section_create`$toJSONString()
      } else {
        local_var_body <- NULL
      }
    ...
    #'
    #' @return BoardSection
    BoardSectionsDelete = function(board_id, section_id, ad_account_id = NULL, data_file = NULL, ..., .parse = TRUE) {
      local_var_response <- self$BoardSectionsDeleteWithHttpInfo(board_id, section_id, ad_account_id, data_file = data_file, ..., .parse = .parse)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        return(local_var_response$content)
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        return(local_var_response)
    ...
    #'
    #' @return API response (BoardSection) with additional information such as HTTP status code, headers
    BoardSectionsDeleteWithHttpInfo = function(board_id, section_id, ad_account_id = NULL, data_file = NULL, ..., .parse = TRUE) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
    ...
    BoardSectionsList = function(board_id, ad_account_id = NULL, bookmark = NULL, page_size = 25, data_file = NULL, ..., .parse = TRUE) {
      local_var_response <- self$BoardSectionsListWithHttpInfo(board_id, ad_account_id, bookmark, page_size, data_file = data_file, ..., .parse = .parse)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        return(local_var_response$content)
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        return(local_var_response)
    ...
    BoardSectionsListWithHttpInfo = function(board_id, ad_account_id = NULL, bookmark = NULL, page_size = 25, data_file = NULL, ..., .parse = TRUE) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
    ...
    BoardSectionsListPins = function(board_id, section_id, ad_account_id = NULL, bookmark = NULL, page_size = 25, data_file = NULL, ..., .parse = TRUE) {
      local_var_response <- self$BoardSectionsListPinsWithHttpInfo(board_id, section_id, ad_account_id, bookmark, page_size, data_file = data_file, ..., .parse = .parse)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        return(local_var_response$content)
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        return(local_var_response)
    ...
    BoardSectionsListPinsWithHttpInfo = function(board_id, section_id, ad_account_id = NULL, bookmark = NULL, page_size = 25, data_file = NULL, ..., .parse = TRUE) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
    ...
    #' @param board_id Unique identifier of a board.
    #' @param section_id Unique identifier of a board section.
    #' @param board_section_update_with_required_body 
    #' @param ad_account_id (optional) Unique identifier of an ad account.
    #' @param data_file (optional) name of the data file to save the result
    #' @param ... Other optional arguments
    #' @param .parse Logical. If \code{TRUE} then the response will be parsed to a generated type. If \code{FALSE} the response will be returned as unparsed text.
    #'
    #' @return BoardSection
    BoardSectionsUpdate = function(board_id, section_id, board_section_update_with_required_body, ad_account_id = NULL, data_file = NULL, ..., .parse = TRUE) {
      local_var_response <- self$BoardSectionsUpdateWithHttpInfo(board_id, section_id, board_section_update_with_required_body, ad_account_id, data_file = data_file, ..., .parse = .parse)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        return(local_var_response$content)
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        return(local_var_response)
    ...
    #'
    #' @return API response (BoardSection) with additional information such as HTTP status code, headers
    BoardSectionsUpdateWithHttpInfo = function(board_id, section_id, board_section_update_with_required_body, ad_account_id = NULL, data_file = NULL, ..., .parse = TRUE) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      if (missing(`board_section_update_with_required_body`)) {
        stop("Missing required parameter `board_section_update_with_required_body`.")
      }
      ...
      if (!missing(`board_section_update_with_required_body`) && is.null(`board_section_update_with_required_body`)) {
        stop("Invalid value for `board_section_update_with_required_body` when calling BoardsApi$BoardSectionsUpdate, `board_section_update_with_required_body` is not nullable")
      }
      ...
      if (!is.null(`board_section_update_with_required_body`)) {
        local_var_body <- `board_section_update_with_required_body`$toJSONString()
      } else {
        local_var_body <- NULL
      }
    ...
    #'
    #' @return Board
    BoardsCreate = function(board_create, ad_account_id = NULL, data_file = NULL, ..., .parse = TRUE) {
      local_var_response <- self$BoardsCreateWithHttpInfo(board_create, ad_account_id, data_file = data_file, ..., .parse = .parse)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        return(local_var_response$content)
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        return(local_var_response)
    ...
    BoardsCreateWithHttpInfo = function(board_create, ad_account_id = NULL, data_file = NULL, ..., .parse = TRUE) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
    ...
    #'
    #' @return Board
    BoardsDelete = function(board_id, ad_account_id = NULL, data_file = NULL, ..., .parse = TRUE) {
      local_var_response <- self$BoardsDeleteWithHttpInfo(board_id, ad_account_id, data_file = data_file, ..., .parse = .parse)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        return(local_var_response$content)
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        return(local_var_response)
    ...
    #'
    #' @return API response (Board) with additional information such as HTTP status code, headers
    BoardsDeleteWithHttpInfo = function(board_id, ad_account_id = NULL, data_file = NULL, ..., .parse = TRUE) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
    ...
    #'
    #' @return Board
    BoardsGet = function(board_id, ad_account_id = NULL, data_file = NULL, ..., .parse = TRUE) {
      local_var_response <- self$BoardsGetWithHttpInfo(board_id, ad_account_id, data_file = data_file, ..., .parse = .parse)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        return(local_var_response$content)
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        return(local_var_response)
    ...
    #'
    #' @return API response (Board) with additional information such as HTTP status code, headers
    BoardsGetWithHttpInfo = function(board_id, ad_account_id = NULL, data_file = NULL, ..., .parse = TRUE) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
    ...
    BoardsList = function(ad_account_id = NULL, privacy = NULL, bookmark = NULL, page_size = 25, data_file = NULL, ..., .parse = TRUE) {
      local_var_response <- self$BoardsListWithHttpInfo(ad_account_id, privacy, bookmark, page_size, data_file = data_file, ..., .parse = .parse)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        return(local_var_response$content)
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        return(local_var_response)
    ...
    BoardsListWithHttpInfo = function(ad_account_id = NULL, privacy = NULL, bookmark = NULL, page_size = 25, data_file = NULL, ..., .parse = TRUE) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
    ...
    #'
    #' @return BoardsListPins200Response
    BoardsListPins = function(board_id, creative_types = NULL, ad_account_id = NULL, pin_metrics = FALSE, bookmark = NULL, page_size = 25, data_file = NULL, ..., .parse = TRUE) {
      local_var_response <- self$BoardsListPinsWithHttpInfo(board_id, creative_types, ad_account_id, pin_metrics, bookmark, page_size, data_file = data_file, ..., .parse = .parse)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        return(local_var_response$content)
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        return(local_var_response)
    ...
    #'
    #' @return API response (BoardsListPins200Response) with additional information such as HTTP status code, headers
    BoardsListPinsWithHttpInfo = function(board_id, creative_types = NULL, ad_account_id = NULL, pin_metrics = FALSE, bookmark = NULL, page_size = 25, data_file = NULL, ..., .parse = TRUE) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
    ...
    BoardsUpdate = function(board_id, board_with_update_privacy_update, ad_account_id = NULL, data_file = NULL, ..., .parse = TRUE) {
      local_var_response <- self$BoardsUpdateWithHttpInfo(board_id, board_with_update_privacy_update, ad_account_id, data_file = data_file, ..., .parse = .parse)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        return(local_var_response$content)
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        return(local_var_response)
    ...
    BoardsUpdateWithHttpInfo = function(board_id, board_with_update_privacy_update, ad_account_id = NULL, data_file = NULL, ..., .parse = TRUE) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
