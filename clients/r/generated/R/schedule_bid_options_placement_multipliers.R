#' Create a new ScheduleBidOptionsPlacementMultipliers
#'
#' @description
...
#'
#' @docType class
#' @title ScheduleBidOptionsPlacementMultipliers
#' @description ScheduleBidOptionsPlacementMultipliers Class
...
#' @export
ScheduleBidOptionsPlacementMultipliers <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new ScheduleBidOptionsPlacementMultipliers class.
    #'
    ...
    #'
    #' @return ScheduleBidOptionsPlacementMultipliers as a base R list.
    #' @examples
    #' # convert array of ScheduleBidOptionsPlacementMultipliers (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ScheduleBidOptionsPlacementMultipliers to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      ScheduleBidOptionsPlacementMultipliersObject <- list()
      if (!is.null(self$`browse`)) {
        ScheduleBidOptionsPlacementMultipliersObject[["browse"]] <-
          self$`browse`
      }
      if (!is.null(self$`related_pins`)) {
        ScheduleBidOptionsPlacementMultipliersObject[["related_pins"]] <-
          self$`related_pins`
      }
      if (!is.null(self$`search`)) {
        ScheduleBidOptionsPlacementMultipliersObject[["search"]] <-
          self$`search`
      }
      return(ScheduleBidOptionsPlacementMultipliersObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of ScheduleBidOptionsPlacementMultipliers
    #'
    #' @param input_json the JSON input
    #' @return the instance of ScheduleBidOptionsPlacementMultipliers
    ...
    #' @return ScheduleBidOptionsPlacementMultipliers in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to ScheduleBidOptionsPlacementMultipliers and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of ScheduleBidOptionsPlacementMultipliers
    toString = function() {
      self$toJSONString()
    },
...
# ScheduleBidOptionsPlacementMultipliers$unlock()
#
## Below is an example to define the print function
# ScheduleBidOptionsPlacementMultipliers$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# ScheduleBidOptionsPlacementMultipliers$lock()
