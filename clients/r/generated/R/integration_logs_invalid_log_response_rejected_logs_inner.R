...
IntegrationLogsInvalidLogResponseRejectedLogsInner <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return IntegrationLogsInvalidLogResponseRejectedLogsInner as a base R list.
    #' @examples
    #' # convert array of IntegrationLogsInvalidLogResponseRejectedLogsInner (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert IntegrationLogsInvalidLogResponseRejectedLogsInner to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(IntegrationLogsInvalidLogResponseRejectedLogsInnerObject)
    },
