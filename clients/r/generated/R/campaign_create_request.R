...
CampaignCreateRequest <- R6::R6Class(
  ...
  public = list(
    ...
    #' @param is_flexible_daily_budgets Determine if a campaign has setup for flexible daily budgets, also known as \"Pinterest Performance+ budgets\".. Default to FALSE.
    ...
    initialize = function(`ad_account_id`, `name`, `objective_type`, `daily_spend_cap` = NULL, `end_time` = NULL, `is_automated_campaign` = FALSE, `is_flexible_daily_budgets` = FALSE, `lifetime_spend_cap` = NULL, `order_line_id` = NULL, `start_time` = NULL, `status` = "ACTIVE", `tracking_urls` = NULL, `default_ad_group_budget_in_micro_currency` = NULL, `is_campaign_budget_optimization` = NULL, `bid_options` = NULL, `is_performance_plus` = FALSE, ...) {
