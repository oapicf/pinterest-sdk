#' Create a new OauthAccessTokenResponseCode
#'
#' @description
#' OauthAccessTokenResponseCode Class
#'
#' @docType class
...
OauthAccessTokenResponseCode <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new OauthAccessTokenResponseCode class.
    #'
    ...
    initialize = function(`refresh_token`, `refresh_token_expires_in`, `access_token`, `token_type`, `expires_in`, `scope`, `response_type` = NULL, ...) {
    ...
    #'
    #' @return OauthAccessTokenResponseCode as a base R list.
    #' @examples
    #' # convert array of OauthAccessTokenResponseCode (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert OauthAccessTokenResponseCode to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(OauthAccessTokenResponseCodeObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of OauthAccessTokenResponseCode
    #'
    #' @param input_json the JSON input
    #' @return the instance of OauthAccessTokenResponseCode
    ...
    #' @return OauthAccessTokenResponseCode in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to OauthAccessTokenResponseCode and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`refresh_token`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for OauthAccessTokenResponseCode: the required field `refresh_token` is missing."))
      }
      ...
      if (!is.null(input_json$`refresh_token_expires_in`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for OauthAccessTokenResponseCode: the required field `refresh_token_expires_in` is missing."))
      }
      ...
      if (!is.null(input_json$`access_token`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for OauthAccessTokenResponseCode: the required field `access_token` is missing."))
      }
      ...
      if (!is.null(input_json$`token_type`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for OauthAccessTokenResponseCode: the required field `token_type` is missing."))
      }
      ...
      if (!is.null(input_json$`expires_in`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for OauthAccessTokenResponseCode: the required field `expires_in` is missing."))
      }
      ...
      if (!is.null(input_json$`scope`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for OauthAccessTokenResponseCode: the required field `scope` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of OauthAccessTokenResponseCode
    toString = function() {
      self$toJSONString()
    },
...
# OauthAccessTokenResponseCode$unlock()
#
## Below is an example to define the print function
# OauthAccessTokenResponseCode$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# OauthAccessTokenResponseCode$lock()
