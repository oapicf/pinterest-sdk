...
OauthAccessTokenResponseCode <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(`access_token`, `expires_in`, `scope`, `token_type`, `refresh_token` = NULL, `refresh_token_expires_at` = NULL, `refresh_token_expires_in` = NULL, `response_type` = NULL, ...) {
    ...
    toSimpleType = function() {
      ...
      if (!is.null(self$`refresh_token_expires_at`)) {
        OauthAccessTokenResponseCodeObject[["refresh_token_expires_at"]] <-
