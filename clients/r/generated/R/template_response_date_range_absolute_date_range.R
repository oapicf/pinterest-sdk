...
TemplateResponseDateRangeAbsoluteDateRange <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return TemplateResponseDateRangeAbsoluteDateRange as a base R list.
    #' @examples
    #' # convert array of TemplateResponseDateRangeAbsoluteDateRange (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert TemplateResponseDateRangeAbsoluteDateRange to a base R type
    #'
