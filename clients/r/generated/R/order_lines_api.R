...
#' @section Methods:
#' \describe{
#' \strong{ OrderLinesGet } \emph{ Get order line }
#' Get a specific existing order line associated with an ad account.
#'
#' \itemize{
#' \item \emph{ @param } ad_account_id character
#' \item \emph{ @param } order_line_id character
#' \item \emph{ @returnType } \link{OrderLine} \cr
#'
#'
#' \item status code : 200 | Success
#'
#' \item return type : OrderLine
...
#' }
#'
#' \strong{ OrderLinesList } \emph{ Get order lines }
...
#' \item \emph{ @returnType } \link{OrderLinesList200Response} \cr
#'
#'
#' \item status code : 200 | Success
#'
#' \item return type : OrderLinesList200Response
#' \item response headers :
#'
#' \tabular{ll}{
#' }
