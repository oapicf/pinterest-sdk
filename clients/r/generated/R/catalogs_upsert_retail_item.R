...
CatalogsUpsertRetailItem <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return CatalogsUpsertRetailItem as a base R list.
    #' @examples
    #' # convert array of CatalogsUpsertRetailItem (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CatalogsUpsertRetailItem to a base R type
    #'
