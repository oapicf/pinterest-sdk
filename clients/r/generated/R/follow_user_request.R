...
FollowUserRequest <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return FollowUserRequest as a base R list.
    #' @examples
    #' # convert array of FollowUserRequest (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert FollowUserRequest to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(FollowUserRequestObject)
    },
