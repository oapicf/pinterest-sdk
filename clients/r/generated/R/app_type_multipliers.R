...
AppTypeMultipliers <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return AppTypeMultipliers as a base R list.
    #' @examples
    #' # convert array of AppTypeMultipliers (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert AppTypeMultipliers to a base R type
    #'
