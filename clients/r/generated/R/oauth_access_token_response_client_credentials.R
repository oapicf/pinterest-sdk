#' Create a new OauthAccessTokenResponseClientCredentials
#'
#' @description
...
OauthAccessTokenResponseClientCredentials <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return OauthAccessTokenResponseClientCredentials as a base R list.
    #' @examples
    #' # convert array of OauthAccessTokenResponseClientCredentials (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert OauthAccessTokenResponseClientCredentials to a base R type
    #'
    ...
    #' @description
    #' Deserialize JSON string into an instance of OauthAccessTokenResponseClientCredentials
    #'
    ...
    #' @return OauthAccessTokenResponseClientCredentials in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to OauthAccessTokenResponseClientCredentials and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`expires_in`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for OauthAccessTokenResponseClientCredentials: the required field `expires_in` is missing."))
      }
    ...
    #'
    #' @return String representation of OauthAccessTokenResponseClientCredentials
    toString = function() {
      self$toJSONString()
    },
...
# OauthAccessTokenResponseClientCredentials$unlock()
#
## Below is an example to define the print function
# OauthAccessTokenResponseClientCredentials$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# OauthAccessTokenResponseClientCredentials$lock()
