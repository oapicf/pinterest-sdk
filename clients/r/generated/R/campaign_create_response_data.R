...
CampaignCreateResponseData <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(`ad_account_id` = NULL, `daily_spend_cap` = NULL, `end_time` = NULL, `is_automated_campaign` = NULL, `is_flexible_daily_budgets` = NULL, `lifetime_spend_cap` = NULL, `name` = NULL, `order_line_id` = NULL, `start_time` = NULL, `status` = NULL, `tracking_urls` = NULL, `default_ad_group_budget_in_micro_currency` = NULL, `is_campaign_budget_optimization` = NULL, `id` = NULL, `bid_options` = NULL, `created_time` = NULL, `is_performance_plus` = NULL, `objective_type` = NULL, `summary_status` = NULL, `type` = NULL, `updated_time` = NULL, ...) {
    ...
    #'
    #' @return CampaignCreateResponseData as a base R list.
    #' @examples
    #' # convert array of CampaignCreateResponseData (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CampaignCreateResponseData to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      if (!is.null(self$`bid_options`)) {
        CampaignCreateResponseDataObject[["bid_options"]] <-
      ...
      if (!is.null(self$`is_performance_plus`)) {
        CampaignCreateResponseDataObject[["is_performance_plus"]] <-
      ...
      return(CampaignCreateResponseDataObject)
    },
