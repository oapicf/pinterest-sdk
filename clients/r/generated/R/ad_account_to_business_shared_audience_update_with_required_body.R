#' Create a new AdAccountToBusinessSharedAudienceUpdateWithRequiredBody
#'
#' @description
#' Resource create or update operation model with required body fields (no OptionalProperties).
#'
#' @docType class
#' @title AdAccountToBusinessSharedAudienceUpdateWithRequiredBody
#' @description AdAccountToBusinessSharedAudienceUpdateWithRequiredBody Class
...
#' @export
AdAccountToBusinessSharedAudienceUpdateWithRequiredBody <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new AdAccountToBusinessSharedAudienceUpdateWithRequiredBody class.
    #'
    ...
    #'
    #' @return AdAccountToBusinessSharedAudienceUpdateWithRequiredBody as a base R list.
    #' @examples
    #' # convert array of AdAccountToBusinessSharedAudienceUpdateWithRequiredBody (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert AdAccountToBusinessSharedAudienceUpdateWithRequiredBody to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      AdAccountToBusinessSharedAudienceUpdateWithRequiredBodyObject <- list()
      if (!is.null(self$`audience_id`)) {
        AdAccountToBusinessSharedAudienceUpdateWithRequiredBodyObject[["audience_id"]] <-
          self$`audience_id`
      }
      if (!is.null(self$`operation_type`)) {
        AdAccountToBusinessSharedAudienceUpdateWithRequiredBodyObject[["operation_type"]] <-
          self$extractSimpleType(self$`operation_type`)
      }
      if (!is.null(self$`recipient_business_ids`)) {
        AdAccountToBusinessSharedAudienceUpdateWithRequiredBodyObject[["recipient_business_ids"]] <-
          self$`recipient_business_ids`
      }
      return(AdAccountToBusinessSharedAudienceUpdateWithRequiredBodyObject)
    },
    ...
    #' @description
    #' Deserialize JSON string into an instance of AdAccountToBusinessSharedAudienceUpdateWithRequiredBody
    #'
    #' @param input_json the JSON input
    #' @return the instance of AdAccountToBusinessSharedAudienceUpdateWithRequiredBody
    ...
    #' @return AdAccountToBusinessSharedAudienceUpdateWithRequiredBody in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to AdAccountToBusinessSharedAudienceUpdateWithRequiredBody and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`audience_id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for AdAccountToBusinessSharedAudienceUpdateWithRequiredBody: the required field `audience_id` is missing."))
      }
      # check the required field `operation_type`
      if (!is.null(input_json$`operation_type`)) {
        stopifnot(R6::is.R6(input_json$`operation_type`))
      } else {
        stop(paste("The JSON input `", input, "` is invalid for AdAccountToBusinessSharedAudienceUpdateWithRequiredBody: the required field `operation_type` is missing."))
      }
      ...
      if (!is.null(input_json$`recipient_business_ids`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for AdAccountToBusinessSharedAudienceUpdateWithRequiredBody: the required field `recipient_business_ids` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of AdAccountToBusinessSharedAudienceUpdateWithRequiredBody
    toString = function() {
      self$toJSONString()
    },
...
# AdAccountToBusinessSharedAudienceUpdateWithRequiredBody$unlock()
#
## Below is an example to define the print function
# AdAccountToBusinessSharedAudienceUpdateWithRequiredBody$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# AdAccountToBusinessSharedAudienceUpdateWithRequiredBody$lock()
