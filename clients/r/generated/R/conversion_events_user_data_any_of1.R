...
ConversionEventsUserDataAnyOf1 <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return ConversionEventsUserDataAnyOf1 as a base R list.
    #' @examples
    #' # convert array of ConversionEventsUserDataAnyOf1 (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ConversionEventsUserDataAnyOf1 to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(ConversionEventsUserDataAnyOf1Object)
    },
