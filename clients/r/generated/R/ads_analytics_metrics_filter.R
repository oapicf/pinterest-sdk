...
AdsAnalyticsMetricsFilter <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return AdsAnalyticsMetricsFilter as a base R list.
    #' @examples
    #' # convert array of AdsAnalyticsMetricsFilter (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert AdsAnalyticsMetricsFilter to a base R type
    #'
