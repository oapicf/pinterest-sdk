#' Create a new CatalogsCreativeAssetsItemsFilter
#'
#' @description
#' CatalogsCreativeAssetsItemsFilter Class
#'
#' @docType class
#' @title CatalogsCreativeAssetsItemsFilter
#' @description CatalogsCreativeAssetsItemsFilter Class
...
#' @export
CatalogsCreativeAssetsItemsFilter <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new CatalogsCreativeAssetsItemsFilter class.
    #'
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`creative_assets_ids`)) {
        CatalogsCreativeAssetsItemsFilterObject[["creative_assets_ids"]] <-
    ...
    #' @description
    #' Deserialize JSON string into an instance of CatalogsCreativeAssetsItemsFilter
    #'
    #' @param input_json the JSON input
    #' @return the instance of CatalogsCreativeAssetsItemsFilter
    ...
    #' @description
    #' Validate JSON input with respect to CatalogsCreativeAssetsItemsFilter and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`catalog_type`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for CatalogsCreativeAssetsItemsFilter: the required field `catalog_type` is missing."))
      }
      ...
      if (!is.null(input_json$`creative_assets_ids`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for CatalogsCreativeAssetsItemsFilter: the required field `creative_assets_ids` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of CatalogsCreativeAssetsItemsFilter
    toString = function() {
      self$toJSONString()
    },
    ...
    isValid = function() {
      ...
      if (length(self$`creative_assets_ids`) > 100) {
        return(FALSE)
      }
    ...
    getInvalidFields = function() {
      ...
      if (length(self$`creative_assets_ids`) > 100) {
        invalid_fields["creative_assets_ids"] <- "Invalid length for `creative_assets_ids`, number of items must be less than or equal to 100."
      }
      if (length(self$`creative_assets_ids`) < 1) {
...
# CatalogsCreativeAssetsItemsFilter$unlock()
#
## Below is an example to define the print function
# CatalogsCreativeAssetsItemsFilter$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# CatalogsCreativeAssetsItemsFilter$lock()
