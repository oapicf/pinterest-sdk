...
CatalogsReportDistributionIssueFilter <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return CatalogsReportDistributionIssueFilter as a base R list.
    #' @examples
    #' # convert array of CatalogsReportDistributionIssueFilter (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CatalogsReportDistributionIssueFilter to a base R type
    #'
