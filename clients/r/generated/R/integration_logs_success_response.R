...
IntegrationLogsSuccessResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return IntegrationLogsSuccessResponse as a base R list.
    #' @examples
    #' # convert array of IntegrationLogsSuccessResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert IntegrationLogsSuccessResponse to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(IntegrationLogsSuccessResponseObject)
    },
