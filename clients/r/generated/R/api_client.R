...
ApiClient <- R6::R6Class(
  ...
  public = list(
    ...
    base_path = "https://api.pinterest.com/v5",
    ...
    # Authorization URL
    oauth_authorization_url = "https://www.pinterest.com/oauth/",
    # Token URL
    oauth_token_url = "https://api.pinterest.com/v5/oauth/token",
    # Enable PKCE?
    oauth_pkce = TRUE,
    # Flow type
    oauth_flow_type = "application",
    # Authorization URL
    oauth_authorization_url = "",
    # Token URL
    oauth_token_url = "https://api.pinterest.com/v3/oauth/access_token/",
    # Enable PKCE?
    oauth_pkce = TRUE,
    # Bearer token
    bearer_token = NULL,
