...
AnalyticsMetricsResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return AnalyticsMetricsResponse as a base R list.
    #' @examples
    #' # convert array of AnalyticsMetricsResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert AnalyticsMetricsResponse to a base R type
    #'
