...
CreateAssetInvitesRequestItem <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return CreateAssetInvitesRequestItem as a base R list.
    #' @examples
    #' # convert array of CreateAssetInvitesRequestItem (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CreateAssetInvitesRequestItem to a base R type
    #'
