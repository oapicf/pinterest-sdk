...
Schedule <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new Schedule class.
    #'
    ...
    initialize = function(`entity_id`, `schedule_id`, `delta_value` = NULL, `end_timestamp` = NULL, `entity_type` = NULL, `name` = NULL, `schedule_action` = NULL, `schedule_status` = NULL, `schedule_type` = NULL, `start_timestamp` = NULL, ...) {
    ...
    #'
    #' @return Schedule as a base R list.
    #' @examples
    #' # convert array of Schedule (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert Schedule to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      ScheduleObject <- list()
      if (!is.null(self$`delta_value`)) {
        ScheduleObject[["delta_value"]] <-
      ...
      if (!is.null(self$`entity_id`)) {
        ScheduleObject[["entity_id"]] <-
          self$`entity_id`
      }
      if (!is.null(self$`entity_type`)) {
        ScheduleObject[["entity_type"]] <-
    ...
    #' @description
    #' Deserialize JSON string into an instance of Schedule
    #'
    ...
    #' @description
    #' Validate JSON input with respect to Schedule and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`entity_id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for Schedule: the required field `entity_id` is missing."))
      }
      ...
      if (!is.null(input_json$`schedule_id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for Schedule: the required field `schedule_id` is missing."))
      }
    },
...
# Schedule$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
