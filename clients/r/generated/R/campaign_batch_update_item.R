#' Create a new CampaignBatchUpdateItem
#'
#' @description
#' Single campaign update item with update-specific bid options.
#'
#' @docType class
#' @title CampaignBatchUpdateItem
#' @description CampaignBatchUpdateItem Class
...
#' @field bid_options Object describing an update to the campaign level bid multipliers. \link{CampaignBidOptionsUpdate} [optional]
...
#' @field objective_type  \link{ConversionObjectiveType} [optional]
...
#' @export
CampaignBatchUpdateItem <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new CampaignBatchUpdateItem class.
    #'
    ...
    #' @param bid_options Object describing an update to the campaign level bid multipliers.
    ...
    initialize = function(`id`, `ad_account_id` = NULL, `app_id` = NULL, `app_platform` = NULL, `bid_options` = NULL, `daily_spend_cap` = NULL, `default_ad_group_budget_in_micro_currency` = NULL, `end_time` = NULL, `intended_promotion_type` = NULL, `is_automated_campaign` = NULL, `is_campaign_budget_optimization` = NULL, `is_flexible_daily_budgets` = NULL, `is_ltv_optimized` = NULL, `is_performance_plus` = NULL, `is_top_of_search` = NULL, `lifetime_spend_cap` = NULL, `name` = NULL, `objective_type` = NULL, `order_line_id` = NULL, `performance_plus_campaign_settings` = NULL, `start_time` = NULL, `status` = NULL, `tracking_urls` = NULL, ...) {
      if (!missing(`id`)) {
    ...
    #'
    #' @return CampaignBatchUpdateItem as a base R list.
    #' @examples
    #' # convert array of CampaignBatchUpdateItem (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Deserialize JSON string into an instance of CampaignBatchUpdateItem
    #'
    #' @param input_json the JSON input
    #' @return the instance of CampaignBatchUpdateItem
    ...
    #' @return CampaignBatchUpdateItem in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to CampaignBatchUpdateItem and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for CampaignBatchUpdateItem: the required field `id` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of CampaignBatchUpdateItem
    toString = function() {
      self$toJSONString()
    },
...
# CampaignBatchUpdateItem$unlock()
#
## Below is an example to define the print function
# CampaignBatchUpdateItem$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# CampaignBatchUpdateItem$lock()
