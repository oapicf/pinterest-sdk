...
GoogleProductCategory3Filter <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return GoogleProductCategory3Filter as a base R list.
    #' @examples
    #' # convert array of GoogleProductCategory3Filter (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert GoogleProductCategory3Filter to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      if (!is.null(self$`GOOGLE_PRODUCT_CATEGORY_3`)) {
        GoogleProductCategory3FilterObject[["GOOGLE_PRODUCT_CATEGORY_3"]] <-
          self$extractSimpleType(self$`GOOGLE_PRODUCT_CATEGORY_3`)
      }
      return(GoogleProductCategory3FilterObject)
    },
