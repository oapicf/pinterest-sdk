...
CatalogsCreativeAssetsFeedsCreateRequest <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(`name`, `format`, `default_locale`, `default_country`, `location`, `catalog_type`, `default_currency` = NULL, `credentials` = NULL, `preferred_processing_schedule` = NULL, `catalog_id` = NULL, `status` = "ACTIVE", ...) {
      if (!missing(`name`)) {
    ...
    #'
    #' @return CatalogsCreativeAssetsFeedsCreateRequest as a base R list.
    #' @examples
    #' # convert array of CatalogsCreativeAssetsFeedsCreateRequest (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CatalogsCreativeAssetsFeedsCreateRequest to a base R type
    #'
