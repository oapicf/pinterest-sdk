...
KeywordUpdateBody <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return KeywordUpdateBody as a base R list.
    #' @examples
    #' # convert array of KeywordUpdateBody (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert KeywordUpdateBody to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(KeywordUpdateBodyObject)
    },
