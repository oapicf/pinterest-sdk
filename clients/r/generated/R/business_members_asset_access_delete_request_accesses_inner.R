...
BusinessMembersAssetAccessDeleteRequestAccessesInner <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return BusinessMembersAssetAccessDeleteRequestAccessesInner as a base R list.
    #' @examples
    #' # convert array of BusinessMembersAssetAccessDeleteRequestAccessesInner (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert BusinessMembersAssetAccessDeleteRequestAccessesInner to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(BusinessMembersAssetAccessDeleteRequestAccessesInnerObject)
    },
