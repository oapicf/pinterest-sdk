...
AuthRespondInvitesBodyInvitesInnerAction <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return AuthRespondInvitesBodyInvitesInnerAction as a base R list.
    #' @examples
    #' # convert array of AuthRespondInvitesBodyInvitesInnerAction (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert AuthRespondInvitesBodyInvitesInnerAction to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(AuthRespondInvitesBodyInvitesInnerActionObject)
    },
