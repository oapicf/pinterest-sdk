#' @docType class
#' @title CatalogsFeedCreateRequestSchema
#'
#' @description CatalogsFeedCreateRequestSchema Class
#'
...
#' @export
CatalogsFeedCreateRequestSchema <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new CatalogsFeedCreateRequestSchema.
    #'
    ...
    initialize = function(instance = NULL) {
      if (is.null(instance)) {
        ...
        stop(paste("Failed to initialize CatalogsFeedCreateRequestSchema with oneOf schemas CatalogsFeedsCreateRequest, CatalogsVerticalFeedsCreateRequest. Provided class name: ",
                   get(class(instance)[[1]], pos = -1)$classname))
      }
    },

    #' @description
    #' Deserialize JSON string into an instance of CatalogsFeedCreateRequestSchema.
    #' An alias to the method `fromJSON` .
    #'
    #' @param input The input JSON.
    #'
    #' @return An instance of CatalogsFeedCreateRequestSchema.
    ...
    fromJSON = function(input) {
      ...
      if (matched == 1) {
        ...
        # more than 1 match
        stop(paste("Multiple matches found when deserializing the input into CatalogsFeedCreateRequestSchema with oneOf schemas CatalogsFeedsCreateRequest, CatalogsVerticalFeedsCreateRequest. Matched schemas: ",
                   paste(matched_schemas, collapse = ", ")))
      } else {
        # no match
        stop(paste("No match found when deserializing the input into CatalogsFeedCreateRequestSchema with oneOf schemas CatalogsFeedsCreateRequest, CatalogsVerticalFeedsCreateRequest. Details: >>",
    ...
    #' @description
    #' Serialize CatalogsFeedCreateRequestSchema to JSON string.
    #' 
    #' @param ... Parameters passed to `jsonlite::toJSON`
    #' @return JSON string representation of the CatalogsFeedCreateRequestSchema.
    ...
    #' @description
    #' Convert CatalogsFeedCreateRequestSchema to a base R type
    #'
    ...
    #' @description
    #' Validate the input JSON with respect to CatalogsFeedCreateRequestSchema and
...
#CatalogsFeedCreateRequestSchema$unlock()
#
## Below is an example to define the print function
#CatalogsFeedCreateRequestSchema$set("public", "print", function(...) {
#  print(jsonlite::prettify(self$toJSONString()))
#  invisible(self)
#})
## Uncomment below to lock the class to prevent modifications to the method or field
#CatalogsFeedCreateRequestSchema$lock()
