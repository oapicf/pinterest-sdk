...
PinMediaSourceImagesBase64ItemsInner <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return PinMediaSourceImagesBase64ItemsInner as a base R list.
    #' @examples
    #' # convert array of PinMediaSourceImagesBase64ItemsInner (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert PinMediaSourceImagesBase64ItemsInner to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(PinMediaSourceImagesBase64ItemsInnerObject)
    },
