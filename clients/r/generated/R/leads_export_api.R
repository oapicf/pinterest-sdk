...
LeadsExportApi <- R6::R6Class(
  ...
  public = list(
    ...
    #' @param leads_exports_create 
    #' @param data_file (optional) name of the data file to save the result
    #' @param ... Other optional arguments
    #' @param .parse Logical. If \code{TRUE} then the response will be parsed to a generated type. If \code{FALSE} the response will be returned as unparsed text.
    #'
    #' @return LeadsExports
    LeadsExportCreate = function(ad_account_id, leads_exports_create, data_file = NULL, ..., .parse = TRUE) {
      local_var_response <- self$LeadsExportCreateWithHttpInfo(ad_account_id, leads_exports_create, data_file = data_file, ..., .parse = .parse)
    ...
    #' @param .parse Logical. If \code{TRUE} then the response will be parsed to a generated type. If \code{FALSE} the response will be returned as unparsed text.
    #'
    #' @return API response (LeadsExports) with additional information such as HTTP status code, headers
    LeadsExportCreateWithHttpInfo = function(ad_account_id, leads_exports_create, data_file = NULL, ..., .parse = TRUE) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      if (missing(`leads_exports_create`)) {
        stop("Missing required parameter `leads_exports_create`.")
      }
      ...
      if (!missing(`leads_exports_create`) && is.null(`leads_exports_create`)) {
        stop("Invalid value for `leads_exports_create` when calling LeadsExportApi$LeadsExportCreate, `leads_exports_create` is not nullable")
      }

      if (!is.null(`leads_exports_create`)) {
        local_var_body <- `leads_exports_create`$toJSONString()
      } else {
        local_var_body <- NULL
      }
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$DeserializeResponse(local_var_resp, "LeadsExports"),
          error = function(e) {
    ...
    LeadsExportGet = function(ad_account_id, leads_export_id, data_file = NULL, ..., .parse = TRUE) {
      local_var_response <- self$LeadsExportGetWithHttpInfo(ad_account_id, leads_export_id, data_file = data_file, ..., .parse = .parse)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        return(local_var_response$content)
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        return(local_var_response)
    ...
    LeadsExportGetWithHttpInfo = function(ad_account_id, leads_export_id, data_file = NULL, ..., .parse = TRUE) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$DeserializeResponse(local_var_resp, "LeadsExportResponseData"),
          error = function(e) {
            stop("Failed to deserialize response")
          }
        )
