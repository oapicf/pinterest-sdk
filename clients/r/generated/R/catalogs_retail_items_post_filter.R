...
CatalogsRetailItemsPostFilter <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return CatalogsRetailItemsPostFilter as a base R list.
    #' @examples
    #' # convert array of CatalogsRetailItemsPostFilter (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CatalogsRetailItemsPostFilter to a base R type
    #'
