...
DeletePartnersRequest <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return DeletePartnersRequest as a base R list.
    #' @examples
    #' # convert array of DeletePartnersRequest (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert DeletePartnersRequest to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(DeletePartnersRequestObject)
    },
