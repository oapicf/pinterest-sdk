#' @docType class
#' @title CatalogsProductGroupsCreateRequestSchema
#'
#' @description CatalogsProductGroupsCreateRequestSchema Class
#'
...
#' @export
CatalogsProductGroupsCreateRequestSchema <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new CatalogsProductGroupsCreateRequestSchema.
    #'
    ...
    initialize = function(instance = NULL) {
      if (is.null(instance)) {
        ...
        stop(paste("Failed to initialize CatalogsProductGroupsCreateRequestSchema with oneOf schemas CatalogsProductGroupCreateRequest, CatalogsVerticalProductGroupCreateRequest. Provided class name: ",
                   get(class(instance)[[1]], pos = -1)$classname))
      }
    },

    #' @description
    #' Deserialize JSON string into an instance of CatalogsProductGroupsCreateRequestSchema.
    #' An alias to the method `fromJSON` .
    #'
    #' @param input The input JSON.
    #'
    #' @return An instance of CatalogsProductGroupsCreateRequestSchema.
    ...
    fromJSON = function(input) {
      ...
      if (matched == 1) {
        ...
        # more than 1 match
        stop(paste("Multiple matches found when deserializing the input into CatalogsProductGroupsCreateRequestSchema with oneOf schemas CatalogsProductGroupCreateRequest, CatalogsVerticalProductGroupCreateRequest. Matched schemas: ",
                   paste(matched_schemas, collapse = ", ")))
      } else {
        # no match
        stop(paste("No match found when deserializing the input into CatalogsProductGroupsCreateRequestSchema with oneOf schemas CatalogsProductGroupCreateRequest, CatalogsVerticalProductGroupCreateRequest. Details: >>",
    ...
    #' @description
    #' Serialize CatalogsProductGroupsCreateRequestSchema to JSON string.
    #' 
    #' @param ... Parameters passed to `jsonlite::toJSON`
    #' @return JSON string representation of the CatalogsProductGroupsCreateRequestSchema.
    ...
    #' @description
    #' Convert CatalogsProductGroupsCreateRequestSchema to a base R type
    #'
    ...
    #' @description
    #' Validate the input JSON with respect to CatalogsProductGroupsCreateRequestSchema and
...
#CatalogsProductGroupsCreateRequestSchema$unlock()
#
## Below is an example to define the print function
#CatalogsProductGroupsCreateRequestSchema$set("public", "print", function(...) {
#  print(jsonlite::prettify(self$toJSONString()))
#  invisible(self)
#})
## Uncomment below to lock the class to prevent modifications to the method or field
#CatalogsProductGroupsCreateRequestSchema$lock()
