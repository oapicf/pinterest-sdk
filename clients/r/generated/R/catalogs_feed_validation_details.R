...
CatalogsFeedValidationDetails <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return CatalogsFeedValidationDetails as a base R list.
    #' @examples
    #' # convert array of CatalogsFeedValidationDetails (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CatalogsFeedValidationDetails to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(CatalogsFeedValidationDetailsObject)
    },
