#' Create a new IntegrationsGetList200Response
#'
#' @description
...
IntegrationsGetList200Response <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return IntegrationsGetList200Response as a base R list.
    #' @examples
    #' # convert array of IntegrationsGetList200Response (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert IntegrationsGetList200Response to a base R type
    #'
    ...
    #' @description
    #' Deserialize JSON string into an instance of IntegrationsGetList200Response
    #'
    ...
    #' @return IntegrationsGetList200Response in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to IntegrationsGetList200Response and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`items`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for IntegrationsGetList200Response: the required field `items` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of IntegrationsGetList200Response
    toString = function() {
      self$toJSONString()
    },
...
# IntegrationsGetList200Response$unlock()
#
## Below is an example to define the print function
# IntegrationsGetList200Response$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# IntegrationsGetList200Response$lock()
