...
BusinessMembersAssetAccessDeleteRequest <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return BusinessMembersAssetAccessDeleteRequest as a base R list.
    #' @examples
    #' # convert array of BusinessMembersAssetAccessDeleteRequest (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert BusinessMembersAssetAccessDeleteRequest to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(BusinessMembersAssetAccessDeleteRequestObject)
    },
