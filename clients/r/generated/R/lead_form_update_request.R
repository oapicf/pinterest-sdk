...
LeadFormUpdateRequest <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(`id`, `name` = NULL, `privacy_policy_link` = NULL, `has_accepted_terms` = NULL, `completion_message` = NULL, `status` = NULL, `disclosure_language` = NULL, `questions` = NULL, `policy_links` = NULL, ...) {
      if (!missing(`id`)) {
