#' Create a new LeadFormUpdateRequest
#'
#' @description
#' LeadFormUpdateRequest Class
#'
#' @docType class
#' @title LeadFormUpdateRequest
#' @description LeadFormUpdateRequest Class
...
#' @field id The ID of this lead form to be updated character
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
LeadFormUpdateRequest <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new LeadFormUpdateRequest class.
    #'
    ...
    initialize = function(`id`, `completion_message` = NULL, `disclosure_language` = NULL, `has_accepted_terms` = NULL, `name` = NULL, `policy_links` = NULL, `privacy_policy_link` = NULL, `questions` = NULL, `status` = NULL, ...) {
      if (!missing(`id`)) {
    ...
    #'
    #' @return LeadFormUpdateRequest as a base R list.
    #' @examples
    #' # convert array of LeadFormUpdateRequest (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert LeadFormUpdateRequest to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      LeadFormUpdateRequestObject <- list()
      if (!is.null(self$`completion_message`)) {
        LeadFormUpdateRequestObject[["completion_message"]] <-
          self$`completion_message`
      }
      if (!is.null(self$`disclosure_language`)) {
        LeadFormUpdateRequestObject[["disclosure_language"]] <-
          self$`disclosure_language`
      }
      if (!is.null(self$`has_accepted_terms`)) {
        LeadFormUpdateRequestObject[["has_accepted_terms"]] <-
          self$`has_accepted_terms`
      }
      if (!is.null(self$`name`)) {
        LeadFormUpdateRequestObject[["name"]] <-
          self$`name`
      }
      if (!is.null(self$`policy_links`)) {
        LeadFormUpdateRequestObject[["policy_links"]] <-
          lapply(self$`policy_links`, function(x) x$toSimpleType())
      }
      if (!is.null(self$`privacy_policy_link`)) {
        LeadFormUpdateRequestObject[["privacy_policy_link"]] <-
          self$`privacy_policy_link`
      }
      if (!is.null(self$`questions`)) {
        LeadFormUpdateRequestObject[["questions"]] <-
          lapply(self$`questions`, function(x) x$toSimpleType())
      }
      if (!is.null(self$`status`)) {
        LeadFormUpdateRequestObject[["status"]] <-
          self$`status`$toSimpleType()
      }
      if (!is.null(self$`id`)) {
        LeadFormUpdateRequestObject[["id"]] <-
          self$`id`
      }
      return(LeadFormUpdateRequestObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of LeadFormUpdateRequest
    #'
    #' @param input_json the JSON input
    #' @return the instance of LeadFormUpdateRequest
    ...
    #' @return LeadFormUpdateRequest in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to LeadFormUpdateRequest and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for LeadFormUpdateRequest: the required field `id` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of LeadFormUpdateRequest
    toString = function() {
      self$toJSONString()
    },
...
# LeadFormUpdateRequest$unlock()
#
## Below is an example to define the print function
# LeadFormUpdateRequest$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# LeadFormUpdateRequest$lock()
