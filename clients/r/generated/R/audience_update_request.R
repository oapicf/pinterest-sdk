...
AudienceUpdateRequest <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return AudienceUpdateRequest as a base R list.
    #' @examples
    #' # convert array of AudienceUpdateRequest (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert AudienceUpdateRequest to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(AudienceUpdateRequestObject)
    },
