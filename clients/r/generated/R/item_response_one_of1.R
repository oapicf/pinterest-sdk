#' @docType class
#' @title ItemResponseOneOf1
#'
#' @description ItemResponseOneOf1 Class
#'
...
ItemResponseOneOf1 <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new ItemResponseOneOf1.
    #'
    ...
    initialize = function(instance = NULL) {
      if (is.null(instance)) {
        ...
        stop(paste("Failed to initialize ItemResponseOneOf1 with oneOf schemas CatalogsCreativeAssetsItemErrorResponse, CatalogsHotelItemErrorResponse, CatalogsRetailItemErrorResponse. Provided class name: ",
                   get(class(instance)[[1]], pos = -1)$classname))
      }
    },

    #' @description
    #' Deserialize JSON string into an instance of ItemResponseOneOf1.
    #' An alias to the method `fromJSON` .
    #'
    #' @param input The input JSON.
    #'
    #' @return An instance of ItemResponseOneOf1.
    ...
    fromJSON = function(input) {
      ...
      if (matched == 1) {
        ...
        # more than 1 match
        stop(paste("Multiple matches found when deserializing the input into ItemResponseOneOf1 with oneOf schemas CatalogsCreativeAssetsItemErrorResponse, CatalogsHotelItemErrorResponse, CatalogsRetailItemErrorResponse. Matched schemas: ",
                   paste(matched_schemas, collapse = ", ")))
      } else {
        # no match
        stop(paste("No match found when deserializing the input into ItemResponseOneOf1 with oneOf schemas CatalogsCreativeAssetsItemErrorResponse, CatalogsHotelItemErrorResponse, CatalogsRetailItemErrorResponse. Details: >>",
    ...
    #' @description
    #' Serialize ItemResponseOneOf1 to JSON string.
    #' 
    #' @param ... Parameters passed to `jsonlite::toJSON`
    #' @return JSON string representation of the ItemResponseOneOf1.
    ...
    #' @description
    #' Convert ItemResponseOneOf1 to a base R type
    #'
    ...
    #' @description
    #' Validate the input JSON with respect to ItemResponseOneOf1 and
...
#ItemResponseOneOf1$unlock()
#
## Below is an example to define the print function
#ItemResponseOneOf1$set("public", "print", function(...) {
#  print(jsonlite::prettify(self$toJSONString()))
#  invisible(self)
#})
## Uncomment below to lock the class to prevent modifications to the method or field
#ItemResponseOneOf1$lock()
