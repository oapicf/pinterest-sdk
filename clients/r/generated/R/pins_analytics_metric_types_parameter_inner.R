#' @docType class
#' @title PinsAnalyticsMetricTypesParameterInner
#'
#' @description PinsAnalyticsMetricTypesParameterInner Class
#'
...
#' @export
PinsAnalyticsMetricTypesParameterInner <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(instance = NULL) {
      if (is.null(instance)) {
        ...
        stop(paste("Failed to initialize PinsAnalyticsMetricTypesParameterInner with oneOf schemas character. Provided class name: ",
    ...
    fromJSON = function(input) {
      ...
      if (matched == 1) {
        ...
        # more than 1 match
        stop(paste("Multiple matches found when deserializing the input into PinsAnalyticsMetricTypesParameterInner with oneOf schemas character. Matched schemas: ",
                   paste(matched_schemas, collapse = ", ")))
      } else {
        # no match
        stop(paste("No match found when deserializing the input into PinsAnalyticsMetricTypesParameterInner with oneOf schemas character. Details: >>",
    ...
    #' @description
    #' Convert PinsAnalyticsMetricTypesParameterInner to a base R type
    #'
...
#PinsAnalyticsMetricTypesParameterInner$unlock()
#
## Below is an example to define the print function
#PinsAnalyticsMetricTypesParameterInner$set("public", "print", function(...) {
#  print(jsonlite::prettify(self$toJSONString()))
#  invisible(self)
#})
## Uncomment below to lock the class to prevent modifications to the method or field
#PinsAnalyticsMetricTypesParameterInner$lock()
