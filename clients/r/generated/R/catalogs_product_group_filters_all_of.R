...
CatalogsProductGroupFiltersAllOf <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return CatalogsProductGroupFiltersAllOf as a base R list.
    #' @examples
    #' # convert array of CatalogsProductGroupFiltersAllOf (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CatalogsProductGroupFiltersAllOf to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(CatalogsProductGroupFiltersAllOfObject)
    },
