...
CurrencyFilter <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return CurrencyFilter as a base R list.
    #' @examples
    #' # convert array of CurrencyFilter (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CurrencyFilter to a base R type
    #'
