...
GoogleProductCategory1Filter <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return GoogleProductCategory1Filter as a base R list.
    #' @examples
    #' # convert array of GoogleProductCategory1Filter (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert GoogleProductCategory1Filter to a base R type
    #'
