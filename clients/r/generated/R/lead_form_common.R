...
LeadFormCommon <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return LeadFormCommon as a base R list.
    #' @examples
    #' # convert array of LeadFormCommon (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert LeadFormCommon to a base R type
    #'
