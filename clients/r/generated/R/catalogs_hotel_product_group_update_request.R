...
CatalogsHotelProductGroupUpdateRequest <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return CatalogsHotelProductGroupUpdateRequest as a base R list.
    #' @examples
    #' # convert array of CatalogsHotelProductGroupUpdateRequest (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CatalogsHotelProductGroupUpdateRequest to a base R type
    #'
