...
#' @description ProductCategoryEnum Class
#' @format An \code{R6Class} generator object
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
ProductCategoryEnum <- R6::R6Class(
  "ProductCategoryEnum",
  public = list(

    #' @description
    #' Initialize a new ProductCategoryEnum class.
    #'
    #' @param ... Optional arguments.
    initialize = function(...) {
      local.optional.var <- list(...)
      val <- unlist(local.optional.var)
      enumvec <- .parse_ProductCategoryEnum()
      ...
      if (!val %in% enumvec) {
        ...
        warning("Initializing ProductCategoryEnum with DUMMY_ENUM. Use one of the valid values: ",
          paste0(enumvec, collapse = ", "),
          ". If you did not manually initialize ProductCategoryEnum, this may already be overwritten by an enum loaded from a JSON config.")
      }
      private$value <- val
    },
    ...
    #' @description
    #' Convert ProductCategoryEnum to a base R type
    #'
    ...
    #' @description
    #' Deserialize JSON string into an instance of ProductCategoryEnum
    #'
    #' @param input_json the JSON input
    #'
    #' @return the instance of ProductCategoryEnum
    ...
    #' @return ProductCategoryEnum in JSON format
