...
CreativeAssetsIdFilter <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return CreativeAssetsIdFilter as a base R list.
    #' @examples
    #' # convert array of CreativeAssetsIdFilter (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CreativeAssetsIdFilter to a base R type
    #'
