...
CatalogsHotelProductMetadata <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return CatalogsHotelProductMetadata as a base R list.
    #' @examples
    #' # convert array of CatalogsHotelProductMetadata (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CatalogsHotelProductMetadata to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(CatalogsHotelProductMetadataObject)
    },
