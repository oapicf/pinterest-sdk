...
#' @field items  list(\link{BaseBusinessAssets})
...
BusinessPartnerAssetAccessGet200Response <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return BusinessPartnerAssetAccessGet200Response as a base R list.
    #' @examples
    #' # convert array of BusinessPartnerAssetAccessGet200Response (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert BusinessPartnerAssetAccessGet200Response to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(BusinessPartnerAssetAccessGet200ResponseObject)
    },
    ...
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`items`)) {
        self$`items` <- ApiClient$new()$deserializeObj(this_object$`items`, "array[BaseBusinessAssets]", loadNamespace("openapi"))
      }
      self
    },
