...
CatalogsRetailProductGroupCreateRequest <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(`catalog_id`, `catalog_type`, `filters`, `name`, `country` = NULL, `description` = NULL, `locale` = NULL, ...) {
    ...
    #'
    #' @return CatalogsRetailProductGroupCreateRequest as a base R list.
    #' @examples
    #' # convert array of CatalogsRetailProductGroupCreateRequest (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CatalogsRetailProductGroupCreateRequest to a base R type
    #'
