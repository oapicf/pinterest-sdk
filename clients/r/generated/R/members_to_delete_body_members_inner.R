#' Create a new MembersToDeleteBodyMembersInner
#'
#' @description
#' MembersToDeleteBodyMembersInner Class
#'
#' @docType class
...
MembersToDeleteBodyMembersInner <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return MembersToDeleteBodyMembersInner as a base R list.
    #' @examples
    #' # convert array of MembersToDeleteBodyMembersInner (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert MembersToDeleteBodyMembersInner to a base R type
    #'
    ...
    #' @description
    #' Deserialize JSON string into an instance of MembersToDeleteBodyMembersInner
    #'
    ...
    #' @return MembersToDeleteBodyMembersInner in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to MembersToDeleteBodyMembersInner and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of MembersToDeleteBodyMembersInner
    toString = function() {
      self$toJSONString()
    },
...
# MembersToDeleteBodyMembersInner$unlock()
#
## Below is an example to define the print function
# MembersToDeleteBodyMembersInner$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# MembersToDeleteBodyMembersInner$lock()
