...
#' @field items  list(\link{AdAccountsAudience})
...
AudiencesList200Response <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return AudiencesList200Response as a base R list.
    #' @examples
    #' # convert array of AudiencesList200Response (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert AudiencesList200Response to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(AudiencesList200ResponseObject)
    },
    ...
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`items`)) {
        self$`items` <- ApiClient$new()$deserializeObj(this_object$`items`, "array[AdAccountsAudience]", loadNamespace("openapi"))
      }
      self
    },
