...
LabelError <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new LabelError class.
    #'
    #' @param data data
    ...
    #'
    #' @return LabelError as a base R list.
    #' @examples
    #' # convert array of LabelError (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert LabelError to a base R type
    #'
    ...
    #' @description
    #' Deserialize JSON string into an instance of LabelError
    #'
    ...
    #' @return LabelError in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to LabelError and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of LabelError
    toString = function() {
      self$toJSONString()
    },
...
# LabelError$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
