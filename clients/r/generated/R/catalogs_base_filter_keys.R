#' @docType class
#' @title CatalogsBaseFilterKeys
#'
#' @description CatalogsBaseFilterKeys Class
#'
...
#' @export
CatalogsBaseFilterKeys <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new CatalogsBaseFilterKeys.
    #'
    ...
    initialize = function(instance = NULL) {
      if (is.null(instance)) {
      ...
      } else if (get(class(instance)[[1]], pos = -1)$classname ==  "PinterestProductCategoriesFilter") {
        self$actual_instance <- instance
        self$actual_type <- "PinterestProductCategoriesFilter"
        ...
        stop(paste("Failed to initialize CatalogsBaseFilterKeys with anyOf schemas AvailabilityFilter, BrandFilter, ConditionFilter, CurrencyFilter, CustomLabel0Filter, CustomLabel1Filter, CustomLabel2Filter, CustomLabel3Filter, CustomLabel4Filter, CustomNumber0Filter, CustomNumber1Filter, CustomNumber2Filter, CustomNumber3Filter, CustomNumber4Filter, GenderFilter, GoogleProductCategory0Filter, GoogleProductCategory1Filter, GoogleProductCategory2Filter, GoogleProductCategory3Filter, GoogleProductCategory4Filter, GoogleProductCategory5Filter, GoogleProductCategory6Filter, ItemGroupIdFilter, ItemIdFilter, MaxPriceFilter, MediaTypeFilter, MinPriceFilter, PinterestProductCategoriesFilter, ProductType0Filter, ProductType1Filter, ProductType2Filter, ProductType3Filter, ProductType4Filter, TitleKeywordsFilter. Provided class name: ",
                   get(class(instance)[[1]], pos = -1)$classname))
      }
    },

    #' @description
    #' Deserialize JSON string into an instance of CatalogsBaseFilterKeys.
    #' An alias to the method `fromJSON`.
    #'
    #' @param input The input JSON.
    #'
    #' @return An instance of CatalogsBaseFilterKeys.
    ...
    fromJSON = function(input) {
      ...
      `PinterestProductCategoriesFilter_result` <- tryCatch({
          `PinterestProductCategoriesFilter`$public_methods$validateJSON(input)
          `PinterestProductCategoriesFilter_instance` <- `PinterestProductCategoriesFilter`$new()
          self$actual_instance <- `PinterestProductCategoriesFilter_instance`$fromJSON(input)
          self$actual_type <- "PinterestProductCategoriesFilter"
          return(self)
        },
        error = function(err) err
      ...
      if (!is.null(`PinterestProductCategoriesFilter_result`["error"])) {
        error_messages <- append(error_messages, `PinterestProductCategoriesFilter_result`["message"])
      }

      # no match
      stop(paste("No match found when deserializing the input into CatalogsBaseFilterKeys with anyOf schemas AvailabilityFilter, BrandFilter, ConditionFilter, CurrencyFilter, CustomLabel0Filter, CustomLabel1Filter, CustomLabel2Filter, CustomLabel3Filter, CustomLabel4Filter, CustomNumber0Filter, CustomNumber1Filter, CustomNumber2Filter, CustomNumber3Filter, CustomNumber4Filter, GenderFilter, GoogleProductCategory0Filter, GoogleProductCategory1Filter, GoogleProductCategory2Filter, GoogleProductCategory3Filter, GoogleProductCategory4Filter, GoogleProductCategory5Filter, GoogleProductCategory6Filter, ItemGroupIdFilter, ItemIdFilter, MaxPriceFilter, MediaTypeFilter, MinPriceFilter, PinterestProductCategoriesFilter, ProductType0Filter, ProductType1Filter, ProductType2Filter, ProductType3Filter, ProductType4Filter, TitleKeywordsFilter. Details: >>",
    ...
    #' @description
    #' Convert CatalogsBaseFilterKeys to a base R type
    #'
    ...
    #' @description
    #' Serialize CatalogsBaseFilterKeys to JSON string.
    #'
    #' @param ... Parameters passed to `jsonlite::toJSON`
    #' @return JSON string representation of the CatalogsBaseFilterKeys.
    ...
    #' @description
    #' Validate the input JSON with respect to CatalogsBaseFilterKeys and
...
#CatalogsBaseFilterKeys$unlock()
#
## Below is an example to define the print function
#CatalogsBaseFilterKeys$set("public", "print", function(...) {
#  print(jsonlite::prettify(self$toJSONString()))
#  invisible(self)
#})
## Uncomment below to lock the class to prevent modifications to the method or field
#CatalogsBaseFilterKeys$lock()
