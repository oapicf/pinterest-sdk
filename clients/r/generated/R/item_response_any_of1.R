...
ItemResponseAnyOf1 <- R6::R6Class(
  ...
  public = list(
    ...
    one_of = list("CatalogsHotelItemErrorResponse", "CatalogsRetailItemErrorResponse"),
    #' Initialize a new ItemResponseAnyOf1.
    #'
    #' @description
    #' Initialize a new ItemResponseAnyOf1.
    #'
    #' @param instance an instance of the object defined in the oneOf schemas: "CatalogsHotelItemErrorResponse", "CatalogsRetailItemErrorResponse"
    #' @export
    initialize = function(instance = NULL) {
      if (is.null(instance)) {
        ...
        stop(paste("Failed to initialize ItemResponseAnyOf1 with oneOf schemas CatalogsHotelItemErrorResponse, CatalogsRetailItemErrorResponse. Provided class name: ",
    ...
    fromJSON = function(input) {
      ...
      if (matched == 1) {
        ...
        # more than 1 match
        stop(paste("Multiple matches found when deserializing the input into ItemResponseAnyOf1 with oneOf schemas CatalogsHotelItemErrorResponse, CatalogsRetailItemErrorResponse. Matched schemas: ",
                   paste(matched_schemas, collapse = ", ")))
      } else {
        # no match
        stop(paste("No match found when deserializing the input into ItemResponseAnyOf1 with oneOf schemas CatalogsHotelItemErrorResponse, CatalogsRetailItemErrorResponse. Details: >>",
    ...
    #' Validate the input JSON with respect to ItemResponseAnyOf1.
    #'
    #' @description
