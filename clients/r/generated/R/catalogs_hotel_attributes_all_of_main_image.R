...
CatalogsHotelAttributesAllOfMainImage <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return CatalogsHotelAttributesAllOfMainImage as a base R list.
    #' @examples
    #' # convert array of CatalogsHotelAttributesAllOfMainImage (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CatalogsHotelAttributesAllOfMainImage to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(CatalogsHotelAttributesAllOfMainImageObject)
    },
