...
CampaignUpdateRequest <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(`ad_account_id`, `id`, `bid_options` = NULL, `intended_promotion_type` = NULL, `is_ltv_optimized` = NULL, `is_performance_plus` = NULL, `is_top_of_search` = NULL, `objective_type` = NULL, `daily_spend_cap` = NULL, `default_ad_group_budget_in_micro_currency` = NULL, `end_time` = NULL, `is_automated_campaign` = NULL, `is_campaign_budget_optimization` = NULL, `is_flexible_daily_budgets` = NULL, `lifetime_spend_cap` = NULL, `name` = NULL, `order_line_id` = NULL, `start_time` = NULL, `status` = NULL, `tracking_urls` = NULL, ...) {
    ...
    #'
    #' @return CampaignUpdateRequest as a base R list.
    #' @examples
    #' # convert array of CampaignUpdateRequest (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    toSimpleType = function() {
      ...
      return(CampaignUpdateRequestObject)
    },
