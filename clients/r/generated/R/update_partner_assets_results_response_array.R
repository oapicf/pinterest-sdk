...
UpdatePartnerAssetsResultsResponseArray <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return UpdatePartnerAssetsResultsResponseArray as a base R list.
    #' @examples
    #' # convert array of UpdatePartnerAssetsResultsResponseArray (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert UpdatePartnerAssetsResultsResponseArray to a base R type
    #'
