...
AdResponse <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(`ad_group_id` = NULL, `android_deep_link` = NULL, `carousel_android_deep_links` = NULL, `carousel_destination_urls` = NULL, `carousel_ios_deep_links` = NULL, `click_tracking_url` = NULL, `creative_type` = NULL, `customizable_cta_type` = NULL, `destination_url` = NULL, `disclosure_type` = NULL, `disclosure_url` = NULL, `grid_click_type` = NULL, `ios_deep_link` = NULL, `is_pin_deleted` = NULL, `is_removable` = NULL, `lead_form_id` = NULL, `name` = NULL, `quiz_pin_data` = NULL, `status` = NULL, `tracking_urls` = NULL, `view_tracking_url` = NULL, `pin_id` = NULL, `ad_account_id` = NULL, `campaign_id` = NULL, `collection_items_destination_url_template` = NULL, `created_time` = NULL, `id` = NULL, `rejected_reasons` = NULL, `rejection_labels` = NULL, `review_status` = NULL, `summary_status` = NULL, `type` = NULL, `updated_time` = NULL, ...) {
    ...
    #'
    #' @return AdResponse as a base R list.
    #' @examples
    #' # convert array of AdResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert AdResponse to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      if (!is.null(self$`disclosure_type`)) {
        AdResponseObject[["disclosure_type"]] <-
          self$`disclosure_type`$toSimpleType()
      }
      if (!is.null(self$`disclosure_url`)) {
        AdResponseObject[["disclosure_url"]] <-
          self$`disclosure_url`
      }
