...
BulkDownloadResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return BulkDownloadResponse as a base R list.
    #' @examples
    #' # convert array of BulkDownloadResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert BulkDownloadResponse to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(BulkDownloadResponseObject)
    },
