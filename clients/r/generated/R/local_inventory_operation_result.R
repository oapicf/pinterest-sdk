#' Create a new LocalInventoryOperationResult
#'
#' @description
#' Result model for local inventory operation
#'
#' @docType class
#' @title LocalInventoryOperationResult
#' @description LocalInventoryOperationResult Class
...
#' @export
LocalInventoryOperationResult <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new LocalInventoryOperationResult class.
    #'
    ...
    #'
    #' @return LocalInventoryOperationResult as a base R list.
    #' @examples
    #' # convert array of LocalInventoryOperationResult (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert LocalInventoryOperationResult to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      LocalInventoryOperationResultObject <- list()
      if (!is.null(self$`errors`)) {
        LocalInventoryOperationResultObject[["errors"]] <-
          self$extractSimpleType(self$`errors`)
      }
      if (!is.null(self$`item_id`)) {
        LocalInventoryOperationResultObject[["item_id"]] <-
          self$`item_id`
      }
      if (!is.null(self$`status`)) {
        LocalInventoryOperationResultObject[["status"]] <-
          self$extractSimpleType(self$`status`)
      }
      if (!is.null(self$`store_code`)) {
        LocalInventoryOperationResultObject[["store_code"]] <-
          self$`store_code`
      }
      if (!is.null(self$`supplemental_type`)) {
        LocalInventoryOperationResultObject[["supplemental_type"]] <-
          self$`supplemental_type`
      }
      if (!is.null(self$`warnings`)) {
        LocalInventoryOperationResultObject[["warnings"]] <-
          self$extractSimpleType(self$`warnings`)
      }
      return(LocalInventoryOperationResultObject)
    },
    ...
    #' @description
    #' Deserialize JSON string into an instance of LocalInventoryOperationResult
    #'
    #' @param input_json the JSON input
    #' @return the instance of LocalInventoryOperationResult
    ...
    #' @return LocalInventoryOperationResult in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to LocalInventoryOperationResult and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`item_id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for LocalInventoryOperationResult: the required field `item_id` is missing."))
      }
      # check the required field `status`
      if (!is.null(input_json$`status`)) {
        stopifnot(R6::is.R6(input_json$`status`))
      } else {
        stop(paste("The JSON input `", input, "` is invalid for LocalInventoryOperationResult: the required field `status` is missing."))
      }
      ...
      if (!is.null(input_json$`store_code`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for LocalInventoryOperationResult: the required field `store_code` is missing."))
      }
      ...
      if (!is.null(input_json$`supplemental_type`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for LocalInventoryOperationResult: the required field `supplemental_type` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of LocalInventoryOperationResult
    toString = function() {
      self$toJSONString()
    },
...
# LocalInventoryOperationResult$unlock()
#
## Below is an example to define the print function
# LocalInventoryOperationResult$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# LocalInventoryOperationResult$lock()
