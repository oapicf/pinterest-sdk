...
ProductGroupPromotionUpdateRequest <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return ProductGroupPromotionUpdateRequest as a base R list.
    #' @examples
    #' # convert array of ProductGroupPromotionUpdateRequest (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ProductGroupPromotionUpdateRequest to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(ProductGroupPromotionUpdateRequestObject)
    },
