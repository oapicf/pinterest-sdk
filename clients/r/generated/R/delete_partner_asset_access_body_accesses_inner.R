...
DeletePartnerAssetAccessBodyAccessesInner <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return DeletePartnerAssetAccessBodyAccessesInner as a base R list.
    #' @examples
    #' # convert array of DeletePartnerAssetAccessBodyAccessesInner (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert DeletePartnerAssetAccessBodyAccessesInner to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(DeletePartnerAssetAccessBodyAccessesInnerObject)
    },
