...
AdGroup <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new AdGroup class.
    #'
    ...
    #'
    #' @return AdGroup as a base R list.
    #' @examples
    #' # convert array of AdGroup (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Deserialize JSON string into an instance of AdGroup
    #'
    #' @param input_json the JSON input
    #' @return the instance of AdGroup
    ...
    #' @description
    #' Validate JSON input with respect to AdGroup and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`billable_event`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for AdGroup: the required field `billable_event` is missing."))
      }
      ...
      if (!is.null(input_json$`campaign_id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for AdGroup: the required field `campaign_id` is missing."))
      }
      ...
      if (!is.null(input_json$`conversion_learning_mode_type`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for AdGroup: the required field `conversion_learning_mode_type` is missing."))
      }
      ...
      if (!is.null(input_json$`created_time`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for AdGroup: the required field `created_time` is missing."))
      }
      ...
      if (!is.null(input_json$`id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for AdGroup: the required field `id` is missing."))
      }
      ...
      if (!is.null(input_json$`name`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for AdGroup: the required field `name` is missing."))
      }
      # check the required field `summary_status`
      if (!is.null(input_json$`summary_status`)) {
        stopifnot(R6::is.R6(input_json$`summary_status`))
      } else {
        stop(paste("The JSON input `", input, "` is invalid for AdGroup: the required field `summary_status` is missing."))
      }
      ...
      if (!is.null(input_json$`type`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for AdGroup: the required field `type` is missing."))
      }
      ...
      if (!is.null(input_json$`updated_time`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for AdGroup: the required field `updated_time` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of AdGroup
    toString = function() {
      self$toJSONString()
    },
...
# AdGroup$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
