...
CatalogsCreativeAssetsProductGroup <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return CatalogsCreativeAssetsProductGroup as a base R list.
    #' @examples
    #' # convert array of CatalogsCreativeAssetsProductGroup (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CatalogsCreativeAssetsProductGroup to a base R type
    #'
