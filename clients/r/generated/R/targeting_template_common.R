...
TargetingTemplateCommon <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(`auto_targeting_enabled` = TRUE, `keywords` = NULL, `name` = NULL, `placement_group` = NULL, `targeting_attributes` = NULL, `tracking_urls` = NULL, ...) {
    ...
    #'
    #' @return TargetingTemplateCommon as a base R list.
    #' @examples
    #' # convert array of TargetingTemplateCommon (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert TargetingTemplateCommon to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(TargetingTemplateCommonObject)
    },
