...
AdAccountCreateRequest <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return AdAccountCreateRequest as a base R list.
    #' @examples
    #' # convert array of AdAccountCreateRequest (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert AdAccountCreateRequest to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(AdAccountCreateRequestObject)
    },
