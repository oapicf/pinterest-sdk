...
#' @docType class
#' @title ConversionTag
#' @description ConversionTag Class
...
ConversionTag <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new ConversionTag class.
    #'
    ...
    #'
    #' @return ConversionTag as a base R list.
    #' @examples
    #' # convert array of ConversionTag (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ConversionTag to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      ConversionTagObject <- list()
      if (!is.null(self$`code_snippet`)) {
        ConversionTagObject[["code_snippet"]] <-
          self$`code_snippet`
      }
      if (!is.null(self$`configs`)) {
        ConversionTagObject[["configs"]] <-
          self$`configs`$toSimpleType()
      }
      if (!is.null(self$`enhanced_match_status`)) {
        ConversionTagObject[["enhanced_match_status"]] <-
          self$`enhanced_match_status`$toSimpleType()
      }
      if (!is.null(self$`id`)) {
        ConversionTagObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`last_fired_time_ms`)) {
        ConversionTagObject[["last_fired_time_ms"]] <-
          self$`last_fired_time_ms`
      }
      if (!is.null(self$`name`)) {
        ConversionTagObject[["name"]] <-
          self$`name`
      }
      if (!is.null(self$`version`)) {
        ConversionTagObject[["version"]] <-
          self$`version`
      }
      if (!is.null(self$`ad_account_id`)) {
        ConversionTagObject[["ad_account_id"]] <-
          self$`ad_account_id`
      }
      if (!is.null(self$`status`)) {
        ConversionTagObject[["status"]] <-
          self$`status`$toSimpleType()
      }
      return(ConversionTagObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of ConversionTag
    #'
    #' @param input_json the JSON input
    #' @return the instance of ConversionTag
    ...
    #' @return ConversionTag in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to ConversionTag and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`name`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ConversionTag: the required field `name` is missing."))
      }
      ...
      if (!is.null(input_json$`ad_account_id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ConversionTag: the required field `ad_account_id` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of ConversionTag
    toString = function() {
      self$toJSONString()
    },
...
# ConversionTag$unlock()
#
## Below is an example to define the print function
# ConversionTag$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
