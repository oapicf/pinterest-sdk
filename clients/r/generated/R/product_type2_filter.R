...
ProductType2Filter <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return ProductType2Filter as a base R list.
    #' @examples
    #' # convert array of ProductType2Filter (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ProductType2Filter to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      if (!is.null(self$`PRODUCT_TYPE_2`)) {
        ProductType2FilterObject[["PRODUCT_TYPE_2"]] <-
          self$extractSimpleType(self$`PRODUCT_TYPE_2`)
      }
      return(ProductType2FilterObject)
    },
