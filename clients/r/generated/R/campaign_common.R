...
CampaignCommon <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(`ad_account_id` = NULL, `daily_spend_cap` = NULL, `end_time` = NULL, `is_automated_campaign` = NULL, `is_flexible_daily_budgets` = NULL, `lifetime_spend_cap` = NULL, `name` = NULL, `order_line_id` = NULL, `start_time` = NULL, `status` = NULL, `tracking_urls` = NULL, ...) {
    ...
    #'
    #' @return CampaignCommon as a base R list.
    #' @examples
    #' # convert array of CampaignCommon (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CampaignCommon to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      if (!is.null(self$`is_automated_campaign`)) {
        CampaignCommonObject[["is_automated_campaign"]] <-
          self$`is_automated_campaign`
      }
      if (!is.null(self$`is_flexible_daily_budgets`)) {
        CampaignCommonObject[["is_flexible_daily_budgets"]] <-
