...
CatalogsItemValidationDetails <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return CatalogsItemValidationDetails as a base R list.
    #' @examples
    #' # convert array of CatalogsItemValidationDetails (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CatalogsItemValidationDetails to a base R type
    #'
