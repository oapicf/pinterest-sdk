...
CatalogsFeedValidationErrors <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(`ADULT_INVALID` = NULL, `ADWORDS_FORMAT_INVALID` = NULL, `AVAILABILITY_INVALID` = NULL, `BLOCKLISTED_IMAGE_SIGNATURE` = NULL, `DELIMITER_ERROR` = NULL, `DESCRIPTION_MISSING` = NULL, `DUPLICATE_PRODUCTS` = NULL, `ENCODING_ERROR` = NULL, `FEED_LENGTH_TOO_LONG` = NULL, `FEED_TOO_SMALL` = NULL, `FETCH_ERROR` = NULL, `FETCH_INACTIVE_FEED_ERROR` = NULL, `IMAGE_LINK_INVALID` = NULL, `IMAGE_LINK_LENGTH_TOO_LONG` = NULL, `IMAGE_LINK_MISSING` = NULL, `INTERNAL_SERVICE_ERROR` = NULL, `INVALID_DOMAIN` = NULL, `ITEM_MAIN_IMAGE_DOWNLOAD_FAILURE` = NULL, `ITEMID_MISSING` = NULL, `LINK_FORMAT_INVALID` = NULL, `LINK_LENGTH_TOO_LONG` = NULL, `LIST_PRICE_INVALID` = NULL, `MALFORMED_XML` = NULL, `MAX_ITEMS_PER_ITEM_GROUP_EXCEEDED` = NULL, `NO_VERIFIED_DOMAIN` = NULL, `PARSE_LINE_ERROR` = NULL, `PINJOIN_CONTENT_UNSAFE` = NULL, `PRICE_CANNOT_BE_DETERMINED` = NULL, `PRICE_MISSING` = NULL, `PRODUCT_LINK_MISSING` = NULL, `PRODUCT_PRICE_INVALID` = NULL, `REQUIRED_COLUMNS_MISSING` = NULL, `TITLE_MISSING` = NULL, ...) {
