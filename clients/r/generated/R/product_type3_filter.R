...
ProductType3Filter <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return ProductType3Filter as a base R list.
    #' @examples
    #' # convert array of ProductType3Filter (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ProductType3Filter to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      if (!is.null(self$`PRODUCT_TYPE_3`)) {
        ProductType3FilterObject[["PRODUCT_TYPE_3"]] <-
          self$extractSimpleType(self$`PRODUCT_TYPE_3`)
      }
      return(ProductType3FilterObject)
    },
