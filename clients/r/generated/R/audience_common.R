...
AudienceCommon <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return AudienceCommon as a base R list.
    #' @examples
    #' # convert array of AudienceCommon (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert AudienceCommon to a base R type
    #'
