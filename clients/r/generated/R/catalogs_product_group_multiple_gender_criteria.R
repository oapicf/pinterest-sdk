...
CatalogsProductGroupMultipleGenderCriteria <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return CatalogsProductGroupMultipleGenderCriteria as a base R list.
    #' @examples
    #' # convert array of CatalogsProductGroupMultipleGenderCriteria (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CatalogsProductGroupMultipleGenderCriteria to a base R type
    #'
