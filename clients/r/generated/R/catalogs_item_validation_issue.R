#' @docType class
#' @title CatalogsItemValidationIssue
#' @description CatalogsItemValidationIssue Class
#' @format An \code{R6Class} generator object
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
CatalogsItemValidationIssue <- R6::R6Class(
  "CatalogsItemValidationIssue",
  public = list(

    #' @description
    #' Initialize a new CatalogsItemValidationIssue class.
    #'
    #' @param ... Optional arguments.
    initialize = function(...) {
      local.optional.var <- list(...)
      val <- unlist(local.optional.var)
      enumvec <- .parse_CatalogsItemValidationIssue()
      ...
      if (!val %in% enumvec) {
        ...
        warning("Initializing CatalogsItemValidationIssue with DUMMY_ENUM. Use one of the valid values: ",
          paste0(enumvec, collapse = ", "),
          ". If you did not manually initialize CatalogsItemValidationIssue, this may already be overwritten by an enum loaded from a JSON config.")
      }
      private$value <- val
    },
    ...
    #' @description
    #' Convert CatalogsItemValidationIssue to a base R type
    #'
    ...
    #' @description
    #' Deserialize JSON string into an instance of CatalogsItemValidationIssue
    #'
    #' @param input_json the JSON input
    #'
    #' @return the instance of CatalogsItemValidationIssue
    ...
    #' @return CatalogsItemValidationIssue in JSON format
