#' Create a new CampaignBatchResponseData
#'
#' @description
#' Campaign data in batch response, with all fields optional to support error cases where data may be empty.
#'
#' @docType class
#' @title CampaignBatchResponseData
#' @description CampaignBatchResponseData Class
...
#' @field objective_type  \link{CampaignObjectiveType} [optional]
...
#' @field status  \link{NullableEntityStatus} [optional]
...
#' @export
CampaignBatchResponseData <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new CampaignBatchResponseData class.
    #'
    ...
    #'
    #' @return CampaignBatchResponseData as a base R list.
    #' @examples
    #' # convert array of CampaignBatchResponseData (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CampaignBatchResponseData to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      CampaignBatchResponseDataObject <- list()
      if (!is.null(self$`ad_account_id`)) {
        CampaignBatchResponseDataObject[["ad_account_id"]] <-
          self$`ad_account_id`
      }
      if (!is.null(self$`bid_options`)) {
        CampaignBatchResponseDataObject[["bid_options"]] <-
          self$extractSimpleType(self$`bid_options`)
      }
      if (!is.null(self$`created_time`)) {
        CampaignBatchResponseDataObject[["created_time"]] <-
          self$`created_time`
      }
      if (!is.null(self$`daily_spend_cap`)) {
        CampaignBatchResponseDataObject[["daily_spend_cap"]] <-
          self$`daily_spend_cap`
      }
      if (!is.null(self$`default_ad_group_budget_in_micro_currency`)) {
        CampaignBatchResponseDataObject[["default_ad_group_budget_in_micro_currency"]] <-
          self$`default_ad_group_budget_in_micro_currency`
      }
      if (!is.null(self$`end_time`)) {
        CampaignBatchResponseDataObject[["end_time"]] <-
          self$`end_time`
      }
      if (!is.null(self$`id`)) {
        CampaignBatchResponseDataObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`intended_promotion_type`)) {
        CampaignBatchResponseDataObject[["intended_promotion_type"]] <-
          self$extractSimpleType(self$`intended_promotion_type`)
      }
      if (!is.null(self$`is_automated_campaign`)) {
        CampaignBatchResponseDataObject[["is_automated_campaign"]] <-
          self$`is_automated_campaign`
      }
      if (!is.null(self$`is_campaign_budget_optimization`)) {
        CampaignBatchResponseDataObject[["is_campaign_budget_optimization"]] <-
          self$`is_campaign_budget_optimization`
      }
      if (!is.null(self$`is_carting`)) {
        CampaignBatchResponseDataObject[["is_carting"]] <-
          self$`is_carting`
      }
      if (!is.null(self$`is_flexible_daily_budgets`)) {
        CampaignBatchResponseDataObject[["is_flexible_daily_budgets"]] <-
          self$`is_flexible_daily_budgets`
      }
      if (!is.null(self$`is_ltv_optimized`)) {
        CampaignBatchResponseDataObject[["is_ltv_optimized"]] <-
          self$`is_ltv_optimized`
      }
      if (!is.null(self$`is_performance_plus`)) {
        CampaignBatchResponseDataObject[["is_performance_plus"]] <-
          self$`is_performance_plus`
      }
      if (!is.null(self$`is_top_of_search`)) {
        CampaignBatchResponseDataObject[["is_top_of_search"]] <-
          self$`is_top_of_search`
      }
      if (!is.null(self$`lifetime_spend_cap`)) {
        CampaignBatchResponseDataObject[["lifetime_spend_cap"]] <-
          self$`lifetime_spend_cap`
      }
      if (!is.null(self$`name`)) {
        CampaignBatchResponseDataObject[["name"]] <-
          self$`name`
      }
      if (!is.null(self$`objective_type`)) {
        CampaignBatchResponseDataObject[["objective_type"]] <-
          self$extractSimpleType(self$`objective_type`)
      }
      if (!is.null(self$`order_line_id`)) {
        CampaignBatchResponseDataObject[["order_line_id"]] <-
          self$`order_line_id`
      }
      if (!is.null(self$`performance_plus_campaign_settings`)) {
        CampaignBatchResponseDataObject[["performance_plus_campaign_settings"]] <-
          self$extractSimpleType(self$`performance_plus_campaign_settings`)
      }
      if (!is.null(self$`start_time`)) {
        CampaignBatchResponseDataObject[["start_time"]] <-
          self$`start_time`
      }
      if (!is.null(self$`status`)) {
        CampaignBatchResponseDataObject[["status"]] <-
          self$extractSimpleType(self$`status`)
      }
      if (!is.null(self$`summary_status`)) {
        CampaignBatchResponseDataObject[["summary_status"]] <-
          self$extractSimpleType(self$`summary_status`)
      }
      if (!is.null(self$`tracking_urls`)) {
        CampaignBatchResponseDataObject[["tracking_urls"]] <-
          self$extractSimpleType(self$`tracking_urls`)
      }
      if (!is.null(self$`type`)) {
        CampaignBatchResponseDataObject[["type"]] <-
          self$`type`
      }
      if (!is.null(self$`updated_time`)) {
        CampaignBatchResponseDataObject[["updated_time"]] <-
          self$`updated_time`
      }
      return(CampaignBatchResponseDataObject)
    },
    ...
    #' @description
    #' Deserialize JSON string into an instance of CampaignBatchResponseData
    #'
    #' @param input_json the JSON input
    #' @return the instance of CampaignBatchResponseData
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`status`)) {
        `status_object` <- NullableEntityStatus$new()
    ...
    #' @return CampaignBatchResponseData in JSON format
    ...
    fromJSONString = function(input_json) {
      ...
      self$`start_time` <- this_object$`start_time`
      self$`status` <- NullableEntityStatus$new()$fromJSON(jsonlite::toJSON(this_object$`status`, auto_unbox = TRUE, digits = NA))
    ...
    #' @description
    #' Validate JSON input with respect to CampaignBatchResponseData and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of CampaignBatchResponseData
    toString = function() {
      self$toJSONString()
    },
...
# CampaignBatchResponseData$unlock()
#
## Below is an example to define the print function
# CampaignBatchResponseData$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# CampaignBatchResponseData$lock()
