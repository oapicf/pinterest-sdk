...
AdvancedAuctionOperationError <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return AdvancedAuctionOperationError as a base R list.
    #' @examples
    #' # convert array of AdvancedAuctionOperationError (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert AdvancedAuctionOperationError to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(AdvancedAuctionOperationErrorObject)
    },
