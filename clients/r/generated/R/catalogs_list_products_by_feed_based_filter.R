...
CatalogsListProductsByFeedBasedFilter <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return CatalogsListProductsByFeedBasedFilter as a base R list.
    #' @examples
    #' # convert array of CatalogsListProductsByFeedBasedFilter (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CatalogsListProductsByFeedBasedFilter to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(CatalogsListProductsByFeedBasedFilterObject)
    },
