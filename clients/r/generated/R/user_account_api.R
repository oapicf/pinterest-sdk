...
UserAccountApi <- R6::R6Class(
  ...
  public = list(
    ...
    BoardsUserFollowsList = function(ad_account_id = NULL, explicit_following = FALSE, bookmark = NULL, page_size = 25, data_file = NULL, ..., .parse = TRUE) {
      local_var_response <- self$BoardsUserFollowsListWithHttpInfo(ad_account_id, explicit_following, bookmark, page_size, data_file = data_file, ..., .parse = .parse)
    ...
    BoardsUserFollowsListWithHttpInfo = function(ad_account_id = NULL, explicit_following = FALSE, bookmark = NULL, page_size = 25, data_file = NULL, ..., .parse = TRUE) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
    ...
    #' @param follow_user_create 
    #' @param data_file (optional) name of the data file to save the result
    #' @param ... Other optional arguments
    #' @param .parse Logical. If \code{TRUE} then the response will be parsed to a generated type. If \code{FALSE} the response will be returned as unparsed text.
    #'
    #' @return FollowUser
    FollowUserUpdate = function(username, follow_user_create, data_file = NULL, ..., .parse = TRUE) {
      local_var_response <- self$FollowUserUpdateWithHttpInfo(username, follow_user_create, data_file = data_file, ..., .parse = .parse)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        return(local_var_response$content)
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        return(local_var_response)
    ...
    #' @param .parse Logical. If \code{TRUE} then the response will be parsed to a generated type. If \code{FALSE} the response will be returned as unparsed text.
    #'
    #' @return API response (FollowUser) with additional information such as HTTP status code, headers
    FollowUserUpdateWithHttpInfo = function(username, follow_user_create, data_file = NULL, ..., .parse = TRUE) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      if (missing(`follow_user_create`)) {
        stop("Missing required parameter `follow_user_create`.")
      }
      ...
      if (!missing(`follow_user_create`) && is.null(`follow_user_create`)) {
        stop("Invalid value for `follow_user_create` when calling UserAccountApi$FollowUserUpdate, `follow_user_create` is not nullable")
      }

      if (!is.null(`follow_user_create`)) {
        local_var_body <- `follow_user_create`$toJSONString()
      } else {
        local_var_body <- NULL
      }
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$DeserializeResponse(local_var_resp, "FollowUser"),
          error = function(e) {
            stop("Failed to deserialize response")
          }
        )
    ...
    FollowersList = function(bookmark = NULL, page_size = 25, data_file = NULL, ..., .parse = TRUE) {
      local_var_response <- self$FollowersListWithHttpInfo(bookmark, page_size, data_file = data_file, ..., .parse = .parse)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        return(local_var_response$content)
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        return(local_var_response)
    ...
    FollowersListWithHttpInfo = function(bookmark = NULL, page_size = 25, data_file = NULL, ..., .parse = TRUE) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
    ...
    LinkedBusinessAccountsGet = function(data_file = NULL, ..., .parse = TRUE) {
      local_var_response <- self$LinkedBusinessAccountsGetWithHttpInfo(data_file = data_file, ..., .parse = .parse)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        return(local_var_response$content)
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        return(local_var_response)
    ...
    LinkedBusinessAccountsGetWithHttpInfo = function(data_file = NULL, ..., .parse = TRUE) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
    ...
    #'
    #' @return UserWebsite
    UnverifyWebsiteDelete = function(website, data_file = NULL, ..., .parse = TRUE) {
      local_var_response <- self$UnverifyWebsiteDeleteWithHttpInfo(website, data_file = data_file, ..., .parse = .parse)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        return(local_var_response$content)
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        return(local_var_response)
    ...
    #' @param .parse Logical. If \code{TRUE} then the response will be parsed to a generated type. If \code{FALSE} the response will be returned as unparsed text.
    #'
    #' @return API response (UserWebsite) with additional information such as HTTP status code, headers
    UnverifyWebsiteDeleteWithHttpInfo = function(website, data_file = NULL, ..., .parse = TRUE) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$DeserializeResponse(local_var_resp, "UserWebsite"),
          error = function(e) {
            stop("Failed to deserialize response")
          }
        )
    ...
    UserAccountAnalytics = function(start_date, end_date, from_claimed_content = "BOTH", pin_format = "ALL", app_types = "ALL", content_type = "ALL", source = "ALL", metric_types = NULL, split_field = "NO_SPLIT", ad_account_id = NULL, data_file = NULL, ..., .parse = TRUE) {
      local_var_response <- self$UserAccountAnalyticsWithHttpInfo(start_date, end_date, from_claimed_content, pin_format, app_types, content_type, source, metric_types, split_field, ad_account_id, data_file = data_file, ..., .parse = .parse)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        return(local_var_response$content)
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        return(local_var_response)
    ...
    UserAccountAnalyticsWithHttpInfo = function(start_date, end_date, from_claimed_content = "BOTH", pin_format = "ALL", app_types = "ALL", content_type = "ALL", source = "ALL", metric_types = NULL, split_field = "NO_SPLIT", ad_account_id = NULL, data_file = NULL, ..., .parse = TRUE) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
    ...
    UserAccountAnalyticsTopPins = function(start_date, end_date, sort_by, from_claimed_content = "BOTH", pin_format = "ALL", app_types = "ALL", content_type = "ALL", source = "ALL", metric_types = NULL, num_of_pins = 10, created_in_last_n_days = NULL, ad_account_id = NULL, data_file = NULL, ..., .parse = TRUE) {
      local_var_response <- self$UserAccountAnalyticsTopPinsWithHttpInfo(start_date, end_date, sort_by, from_claimed_content, pin_format, app_types, content_type, source, metric_types, num_of_pins, created_in_last_n_days, ad_account_id, data_file = data_file, ..., .parse = .parse)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        return(local_var_response$content)
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        return(local_var_response)
    ...
    UserAccountAnalyticsTopPinsWithHttpInfo = function(start_date, end_date, sort_by, from_claimed_content = "BOTH", pin_format = "ALL", app_types = "ALL", content_type = "ALL", source = "ALL", metric_types = NULL, num_of_pins = 10, created_in_last_n_days = NULL, ad_account_id = NULL, data_file = NULL, ..., .parse = TRUE) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
    ...
    UserAccountAnalyticsTopVideoPins = function(start_date, end_date, sort_by, from_claimed_content = "BOTH", pin_format = "ALL", app_types = "ALL", content_type = "ALL", source = "ALL", metric_types = NULL, num_of_pins = 10, created_in_last_n_days = NULL, ad_account_id = NULL, data_file = NULL, ..., .parse = TRUE) {
      local_var_response <- self$UserAccountAnalyticsTopVideoPinsWithHttpInfo(start_date, end_date, sort_by, from_claimed_content, pin_format, app_types, content_type, source, metric_types, num_of_pins, created_in_last_n_days, ad_account_id, data_file = data_file, ..., .parse = .parse)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        return(local_var_response$content)
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        return(local_var_response)
    ...
    UserAccountAnalyticsTopVideoPinsWithHttpInfo = function(start_date, end_date, sort_by, from_claimed_content = "BOTH", pin_format = "ALL", app_types = "ALL", content_type = "ALL", source = "ALL", metric_types = NULL, num_of_pins = 10, created_in_last_n_days = NULL, ad_account_id = NULL, data_file = NULL, ..., .parse = TRUE) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
    ...
    UserAccountFollowedInterests = function(username, bookmark = NULL, page_size = 25, data_file = NULL, ..., .parse = TRUE) {
      local_var_response <- self$UserAccountFollowedInterestsWithHttpInfo(username, bookmark, page_size, data_file = data_file, ..., .parse = .parse)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        return(local_var_response$content)
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        return(local_var_response)
    ...
    UserAccountFollowedInterestsWithHttpInfo = function(username, bookmark = NULL, page_size = 25, data_file = NULL, ..., .parse = TRUE) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
    ...
    #'
    #' @return Account
    UserAccountGet = function(ad_account_id = NULL, data_file = NULL, ..., .parse = TRUE) {
      local_var_response <- self$UserAccountGetWithHttpInfo(ad_account_id, data_file = data_file, ..., .parse = .parse)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        return(local_var_response$content)
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        return(local_var_response)
    ...
    UserAccountGetWithHttpInfo = function(ad_account_id = NULL, data_file = NULL, ..., .parse = TRUE) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
    ...
    #'
    #' @return FollowersList200Response
    UserFollowingGet = function(ad_account_id = NULL, explicit_following = FALSE, feed_type = NULL, bookmark = NULL, page_size = 25, data_file = NULL, ..., .parse = TRUE) {
      local_var_response <- self$UserFollowingGetWithHttpInfo(ad_account_id, explicit_following, feed_type, bookmark, page_size, data_file = data_file, ..., .parse = .parse)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        return(local_var_response$content)
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        return(local_var_response)
    ...
    #'
    #' @return API response (FollowersList200Response) with additional information such as HTTP status code, headers
    UserFollowingGetWithHttpInfo = function(ad_account_id = NULL, explicit_following = FALSE, feed_type = NULL, bookmark = NULL, page_size = 25, data_file = NULL, ..., .parse = TRUE) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
    ...
    UserWebsitesGet = function(bookmark = NULL, page_size = 25, data_file = NULL, ..., .parse = TRUE) {
      local_var_response <- self$UserWebsitesGetWithHttpInfo(bookmark, page_size, data_file = data_file, ..., .parse = .parse)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        return(local_var_response$content)
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        return(local_var_response)
    ...
    UserWebsitesGetWithHttpInfo = function(bookmark = NULL, page_size = 25, data_file = NULL, ..., .parse = TRUE) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
    ...
    #'
    #' @return UserWebsite
    VerifyWebsiteUpdate = function(user_website_create, ad_account_id = NULL, data_file = NULL, ..., .parse = TRUE) {
      local_var_response <- self$VerifyWebsiteUpdateWithHttpInfo(user_website_create, ad_account_id, data_file = data_file, ..., .parse = .parse)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        return(local_var_response$content)
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        return(local_var_response)
    ...
    #'
    #' @return API response (UserWebsite) with additional information such as HTTP status code, headers
    VerifyWebsiteUpdateWithHttpInfo = function(user_website_create, ad_account_id = NULL, data_file = NULL, ..., .parse = TRUE) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      if (missing(`user_website_create`)) {
        stop("Missing required parameter `user_website_create`.")
      }

      if (!missing(`user_website_create`) && is.null(`user_website_create`)) {
        stop("Invalid value for `user_website_create` when calling UserAccountApi$VerifyWebsiteUpdate, `user_website_create` is not nullable")
      }
      ...
      if (!is.null(`user_website_create`)) {
        local_var_body <- `user_website_create`$toJSONString()
      } else {
        local_var_body <- NULL
      }
    ...
    WebsiteVerificationGet = function(ad_account_id = NULL, data_file = NULL, ..., .parse = TRUE) {
      local_var_response <- self$WebsiteVerificationGetWithHttpInfo(ad_account_id, data_file = data_file, ..., .parse = .parse)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        return(local_var_response$content)
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        return(local_var_response)
    ...
    #' @param .parse Logical. If \code{TRUE} then the response will be parsed to a generated type. If \code{FALSE} the response will be returned as unparsed text.
    #'
    #' @return API response (UserWebsiteVerification) with additional information such as HTTP status code, headers
    WebsiteVerificationGetWithHttpInfo = function(ad_account_id = NULL, data_file = NULL, ..., .parse = TRUE) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$DeserializeResponse(local_var_resp, "UserWebsiteVerification"),
          error = function(e) {
            stop("Failed to deserialize response")
          }
        )
