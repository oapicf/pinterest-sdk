...
LeadFormCreateRequest <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(`completion_message` = NULL, `disclosure_language` = NULL, `has_accepted_terms` = NULL, `name` = NULL, `policy_links` = NULL, `privacy_policy_link` = NULL, `questions` = NULL, `status` = NULL, ...) {
    ...
    #'
    #' @return LeadFormCreateRequest as a base R list.
    #' @examples
    #' # convert array of LeadFormCreateRequest (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert LeadFormCreateRequest to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(LeadFormCreateRequestObject)
    },
