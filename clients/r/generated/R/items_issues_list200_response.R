...
ItemsIssuesList200Response <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return ItemsIssuesList200Response as a base R list.
    #' @examples
    #' # convert array of ItemsIssuesList200Response (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ItemsIssuesList200Response to a base R type
    #'
