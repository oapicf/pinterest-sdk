...
CatalogsFeedProductCounts <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return CatalogsFeedProductCounts as a base R list.
    #' @examples
    #' # convert array of CatalogsFeedProductCounts (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CatalogsFeedProductCounts to a base R type
    #'
