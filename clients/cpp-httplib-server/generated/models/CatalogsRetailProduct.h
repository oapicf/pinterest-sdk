...
public:
    ...
    [[nodiscard]] CatalogsRetailProductMetadata getMetadata() const;
    void setMetadata(const CatalogsRetailProductMetadata& metadata);
    ...
    NLOHMANN_DEFINE_TYPE_INTRUSIVE(CatalogsRetailProduct,
         catalogType, metadata, pin)
