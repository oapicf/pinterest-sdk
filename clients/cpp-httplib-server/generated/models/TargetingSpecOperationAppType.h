...
public:
    ...
    [[nodiscard]] std::vector<TargetingSpecAppType> getValues() const;
    void setValues(const std::vector<TargetingSpecAppType>& values);
    ...
    NLOHMANN_DEFINE_TYPE_INTRUSIVE(TargetingSpecOperationAppType,
         field, operation, values)

private:
    FieldEnum field;
    TargetingSpecListOperation operation;
    std::vector<TargetingSpecAppType> values;
};
