...
public:
    ...
    [[nodiscard]] CatalogsCreativeAssetsFilterValuesMap getFilterValues() const;
    void setFilterValues(const CatalogsCreativeAssetsFilterValuesMap& filterValues);
    ...
    NLOHMANN_DEFINE_TYPE_INTRUSIVE(CatalogsCreativeAssetsAvailableFilterValues,
         catalogType, filterValues)
