...
public:
    ...
    [[nodiscard]] CatalogsHotelReportParametersReport getReport() const;
    void setReport(const CatalogsHotelReportParametersReport& report);
    ...
    NLOHMANN_DEFINE_TYPE_INTRUSIVE(CatalogsHotelReportParameters,
         catalogType, report)
