...
using ScheduleBatchUpdateDeltaValue = std::variant<
            std::string,
            ScheduleBidMultipliers >;

// JSON serialization functions (inline for header-only)
inline void from_json(const nlohmann::json& j, ScheduleBatchUpdateDeltaValue& obj)
{
    try
    {
    ...
    throw nlohmann::json::type_error::create(302, "Could not deserialize into any variant type of ScheduleBatchUpdateDeltaValue", &j);
}

inline void to_json(nlohmann::json& j, const ScheduleBatchUpdateDeltaValue& obj)
{
