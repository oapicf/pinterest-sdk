...
public:
    ...
    [[nodiscard]] std::vector<TargetingSpecGender> getValues() const;
    void setValues(const std::vector<TargetingSpecGender>& values);
    ...
    NLOHMANN_DEFINE_TYPE_INTRUSIVE(TargetingSpecOperationGender,
         field, operation, values)

private:
    FieldEnum field;
    TargetingSpecListOperation operation;
    std::vector<TargetingSpecGender> values;
};
