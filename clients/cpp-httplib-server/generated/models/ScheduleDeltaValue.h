...
using ScheduleDeltaValue = std::variant<
            std::string,
            ScheduleBidMultipliers >;

// JSON serialization functions (inline for header-only)
inline void from_json(const nlohmann::json& j, ScheduleDeltaValue& obj)
{
    try
    {
    ...
    throw nlohmann::json::type_error::create(302, "Could not deserialize into any variant type of ScheduleDeltaValue", &j);
}

inline void to_json(nlohmann::json& j, const ScheduleDeltaValue& obj)
{
