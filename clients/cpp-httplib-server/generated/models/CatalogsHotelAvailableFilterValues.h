...
public:
    ...
    [[nodiscard]] CatalogsHotelFilterValuesMap getFilterValues() const;
    void setFilterValues(const CatalogsHotelFilterValuesMap& filterValues);
    ...
    NLOHMANN_DEFINE_TYPE_INTRUSIVE(CatalogsHotelAvailableFilterValues,
