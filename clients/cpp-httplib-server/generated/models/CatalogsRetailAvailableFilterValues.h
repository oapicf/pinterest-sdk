...
public:
    ...
    [[nodiscard]] CatalogsRetailFilterValuesMap getFilterValues() const;
    void setFilterValues(const CatalogsRetailFilterValuesMap& filterValues);
    ...
    NLOHMANN_DEFINE_TYPE_INTRUSIVE(CatalogsRetailAvailableFilterValues,
