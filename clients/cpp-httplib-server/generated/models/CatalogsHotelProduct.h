...
public:
    ...
    [[nodiscard]] CatalogsHotelProductMetadata getMetadata() const;
    void setMetadata(const CatalogsHotelProductMetadata& metadata);
    ...
    NLOHMANN_DEFINE_TYPE_INTRUSIVE(CatalogsHotelProduct,
