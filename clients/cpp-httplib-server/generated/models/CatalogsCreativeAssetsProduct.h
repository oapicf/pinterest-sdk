...
public:
    ...
    [[nodiscard]] CatalogsCreativeAssetsProductMetadata getMetadata() const;
    void setMetadata(const CatalogsCreativeAssetsProductMetadata& metadata);
    ...
    NLOHMANN_DEFINE_TYPE_INTRUSIVE(CatalogsCreativeAssetsProduct,
