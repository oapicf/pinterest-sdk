/**
 * The TrendsController file is a very simple one, which does not need to be changed manually,
...
const service = require('../services/TrendsService');
const trends_editorial_articles/list = async (request, response) => {
  await Controller.handleRequest(request, response, service.trends_editorial_articles/list);
};
