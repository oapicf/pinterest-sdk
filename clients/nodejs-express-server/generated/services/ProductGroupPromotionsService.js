...
* */
const product_group_promotions/create = ({ adUnderscoreaccountUnderscoreid, productGroupPromotionsCreate }) => new Promise(
...
* */
const product_group_promotions/list = ({ adUnderscoreaccountUnderscoreid, bookmark, pageUnderscoresize, order, productUnderscoregroupUnderscorepromotionUnderscoreids, entityUnderscorestatuses, adUnderscoregroupUnderscoreid }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        adUnderscoreaccountUnderscoreid,
...
* returns ProductGroupPromotions
* */
const product_group_promotions/update = ({ adUnderscoreaccountUnderscoreid, productGroupPromotionsUpdateWithRequiredBody }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        adUnderscoreaccountUnderscoreid,
...
* returns List
* */
const product_groups/analytics = ({ startUnderscoredate, endUnderscoredate, productUnderscoregroupUnderscoreids, columns, granularity, adUnderscoreaccountUnderscoreid, clickUnderscorewindowUnderscoredays, engagementUnderscorewindowUnderscoredays, viewUnderscorewindowUnderscoredays, conversionUnderscorereportUnderscoretime, reportingUnderscoretimezone }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        startUnderscoredate,
