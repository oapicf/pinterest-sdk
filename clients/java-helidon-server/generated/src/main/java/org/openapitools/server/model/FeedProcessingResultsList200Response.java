...
import org.openapitools.server.model.CatalogsFeedProcessingResult;
...
public class FeedProcessingResultsList200Response   {
    ...
    /**
     * Create FeedProcessingResultsList200Response.
     *
    ...
    public FeedProcessingResultsList200Response(
        String bookmark, 
        List<@Valid CatalogsFeedProcessingResult> items
    ) {
