...
#include "ConversionDeletionRequestsApiImpl.h"
...
#include "CustomerSegmentApiImpl.h"
...
int main() {
    ...
    apiImpls.push_back(std::make_shared<CatalogSupplementalApiImpl>(router));
    apiImpls.push_back(std::make_shared<CatalogsApiImpl>(router));
    apiImpls.push_back(std::make_shared<ConversionDeletionRequestsApiImpl>(router));
    ...
    apiImpls.push_back(std::make_shared<CustomerSegmentApiImpl>(router));
    ...
    apiImpls.push_back(std::make_shared<ProductTagsApiImpl>(router));
    apiImpls.push_back(std::make_shared<PromotionsApiImpl>(router));
    apiImpls.push_back(std::make_shared<ResourcesApiImpl>(router));
    apiImpls.push_back(std::make_shared<SchedulesApiImpl>(router));
    ...
    apiImpls.push_back(std::make_shared<TrendsApiImpl>(router));
