...
public:
    ...
    bool operator==(const IntegrationMetadataUpdate& rhs) const;
    bool operator!=(const IntegrationMetadataUpdate& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const IntegrationMetadataUpdate& o);
    friend  void from_json(const nlohmann::json& j, IntegrationMetadataUpdate& o);
protected:
