...
void Board::setIsAdsOnly(bool const value)
{
    m_Is_ads_only = value;
...
org::openapitools::server::model::BoardMedia Board::getMedia() const
{
    return m_Media;
}
void Board::setMedia(org::openapitools::server::model::BoardMedia const& value)
{
    m_Media = value;
    m_MediaIsSet = true;
}
...
org::openapitools::server::model::BoardPrivacy Board::getPrivacy() const
{
    return m_Privacy;
}
void Board::setPrivacy(org::openapitools::server::model::BoardPrivacy const& value)
{
    m_Privacy = value;
    m_PrivacyIsSet = true;
}
