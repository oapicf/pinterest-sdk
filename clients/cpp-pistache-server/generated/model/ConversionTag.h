...
public:
    ...
    bool operator==(const ConversionTag& rhs) const;
    bool operator!=(const ConversionTag& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const ConversionTag& o);
    friend  void from_json(const nlohmann::json& j, ConversionTag& o);
protected:
