...
public:
    ...
    /// </summary>
    std::vector<AnalyticsMetricsResponse_daily_metrics> getDailyMetrics() const;
    void setDailyMetrics(std::vector<AnalyticsMetricsResponse_daily_metrics> const& value);
...
protected:
    std::vector<AnalyticsMetricsResponse_daily_metrics> m_Daily_metrics;
