...
public:
    ...
    /// 
    /// </summary>
    std::vector<org::openapitools::server::model::AdGroup> getItems() const;
    void setItems(std::vector<org::openapitools::server::model::AdGroup> const& value);
...
protected:
    ...
    std::vector<org::openapitools::server::model::AdGroup> m_Items;
