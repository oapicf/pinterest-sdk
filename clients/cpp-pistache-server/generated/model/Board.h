...
public:
    ...
    /// 
    /// </summary>
    org::openapitools::server::model::Board_owner getOwner() const;
    void setOwner(org::openapitools::server::model::Board_owner const& value);
...
protected:
    ...
    org::openapitools::server::model::Board_owner m_Owner;
    bool m_OwnerIsSet;
