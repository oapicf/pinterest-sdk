...
public:
    ...
    /// 
    /// </summary>
    org::openapitools::server::model::AdGroupCommon_optimization_goal_metadata getOptimizationGoalMetadata() const;
    void setOptimizationGoalMetadata(org::openapitools::server::model::AdGroupCommon_optimization_goal_metadata const& value);
...
protected:
    ...
    org::openapitools::server::model::AdGroupCommon_optimization_goal_metadata m_Optimization_goal_metadata;
