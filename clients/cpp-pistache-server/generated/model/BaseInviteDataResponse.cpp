...
org::openapitools::server::model::InviteDataResponse BaseInviteDataResponse::getInviteData() const
{
    return m_Invite_data;
}
void BaseInviteDataResponse::setInviteData(org::openapitools::server::model::InviteDataResponse const& value)
{
    m_Invite_data = value;
