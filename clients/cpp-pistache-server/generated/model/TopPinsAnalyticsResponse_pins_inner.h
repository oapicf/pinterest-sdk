...
public:
    ...
    bool operator==(const TopPinsAnalyticsResponse_pins_inner& rhs) const;
    bool operator!=(const TopPinsAnalyticsResponse_pins_inner& rhs) const;
    ...
    friend void to_json(nlohmann::json& j, const TopPinsAnalyticsResponse_pins_inner& o);
    friend void from_json(const nlohmann::json& j, TopPinsAnalyticsResponse_pins_inner& o);
protected:
