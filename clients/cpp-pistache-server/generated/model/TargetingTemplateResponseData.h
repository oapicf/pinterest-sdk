...
public:
    ...
    bool operator==(const TargetingTemplateResponseData& rhs) const;
    bool operator!=(const TargetingTemplateResponseData& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const TargetingTemplateResponseData& o);
    friend  void from_json(const nlohmann::json& j, TargetingTemplateResponseData& o);
protected:
    std::string m_Name;
    bool m_NameIsSet;
