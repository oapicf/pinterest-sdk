...
public:
    ...
    bool operator==(const CatalogsReport& rhs) const;
    bool operator!=(const CatalogsReport& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const CatalogsReport& o);
    friend  void from_json(const nlohmann::json& j, CatalogsReport& o);
protected:
