...
public:
    ...
    bool operator==(const AdAccountsAudienceRule& rhs) const;
    bool operator!=(const AdAccountsAudienceRule& rhs) const;
    ...
    /// 
    /// </summary>
    org::openapitools::server::model::EventData getEventData() const;
    void setEventData(org::openapitools::server::model::EventData const& value);
    ...
    /// </summary>
    std::vector<org::openapitools::server::model::AudienceObjectiveType> getObjectiveType() const;
    void setObjectiveType(std::vector<org::openapitools::server::model::AudienceObjectiveType> const& value);
    ...
    friend  void to_json(nlohmann::json& j, const AdAccountsAudienceRule& o);
    friend  void from_json(const nlohmann::json& j, AdAccountsAudienceRule& o);
protected:
    ...
    std::string m_Event;
    bool m_EventIsSet;
    org::openapitools::server::model::EventData m_Event_data;
    ...
    std::vector<org::openapitools::server::model::AudienceObjectiveType> m_Objective_type;
