...
org::openapitools::server::model::AudienceAccountType SharedAudienceAccount::getAccountType() const
{
    return m_Account_type;
}
void SharedAudienceAccount::setAccountType(org::openapitools::server::model::AudienceAccountType const& value)
{
