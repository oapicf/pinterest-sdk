...
public:
    ...
    bool operator==(const ItemResponse_oneOf& rhs) const;
    bool operator!=(const ItemResponse_oneOf& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const ItemResponse_oneOf& o);
    friend  void from_json(const nlohmann::json& j, ItemResponse_oneOf& o);
protected:
