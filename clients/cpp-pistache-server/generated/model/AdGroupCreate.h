...
public:
    ...
    bool operator==(const AdGroupCreate& rhs) const;
    bool operator!=(const AdGroupCreate& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const AdGroupCreate& o);
    friend  void from_json(const nlohmann::json& j, AdGroupCreate& o);
protected:
