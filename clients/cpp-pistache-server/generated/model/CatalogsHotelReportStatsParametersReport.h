...
public:
    ...
    bool operator==(const CatalogsHotelReportStatsParametersReport& rhs) const;
    bool operator!=(const CatalogsHotelReportStatsParametersReport& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const CatalogsHotelReportStatsParametersReport& o);
    friend  void from_json(const nlohmann::json& j, CatalogsHotelReportStatsParametersReport& o);
protected:
