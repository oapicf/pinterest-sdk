...
public:
    ...
    bool operator==(const AdAccountsAudience& rhs) const;
    bool operator!=(const AdAccountsAudience& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const AdAccountsAudience& o);
    friend  void from_json(const nlohmann::json& j, AdAccountsAudience& o);
protected:
