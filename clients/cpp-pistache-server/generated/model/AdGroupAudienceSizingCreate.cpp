...
void AdGroupAudienceSizingCreate::validate() const
{
...
bool AdGroupAudienceSizingCreate::validate(std::stringstream& msg) const
{
    return validate(msg, "");
}

bool AdGroupAudienceSizingCreate::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "AdGroupAudienceSizingCreate" : pathPrefix;
    ...
    if (keywordsIsSet())
    {
        const std::vector<org::openapitools::server::model::AdGroupAudienceSizingKeyword>& value = m_Keywords;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const org::openapitools::server::model::AdGroupAudienceSizingKeyword& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
...
bool AdGroupAudienceSizingCreate::operator==(const AdGroupAudienceSizingCreate& rhs) const
{
    return
...
void to_json(nlohmann::json& j, const AdGroupAudienceSizingCreate& o)
{
...
void from_json(const nlohmann::json& j, AdGroupAudienceSizingCreate& o)
{
...
void AdGroupAudienceSizingCreate::setAutoTargetingEnabled(bool const value)
{
...
std::vector<org::openapitools::server::model::AdGroupAudienceSizingCreativeTypes> AdGroupAudienceSizingCreate::getCreativeTypes() const
{
    return m_Creative_types;
}
void AdGroupAudienceSizingCreate::setCreativeTypes(std::vector<org::openapitools::server::model::AdGroupAudienceSizingCreativeTypes> const& value)
{
...
std::vector<org::openapitools::server::model::AdGroupAudienceSizingKeyword> AdGroupAudienceSizingCreate::getKeywords() const
{
    return m_Keywords;
}
void AdGroupAudienceSizingCreate::setKeywords(std::vector<org::openapitools::server::model::AdGroupAudienceSizingKeyword> const& value)
{
    m_Keywords = value;
...
org::openapitools::server::model::AdgroupPlacementGroupType AdGroupAudienceSizingCreate::getPlacementGroup() const
{
    return m_Placement_group;
}
void AdGroupAudienceSizingCreate::setPlacementGroup(org::openapitools::server::model::AdgroupPlacementGroupType const& value)
{
...
void AdGroupAudienceSizingCreate::setProductGroupIds(std::vector<std::string> const& value)
{
...
org::openapitools::server::model::TargetingSpecOptimal AdGroupAudienceSizingCreate::getTargetingSpec() const
{
    return m_Targeting_spec;
}
void AdGroupAudienceSizingCreate::setTargetingSpec(org::openapitools::server::model::TargetingSpecOptimal const& value)
{
