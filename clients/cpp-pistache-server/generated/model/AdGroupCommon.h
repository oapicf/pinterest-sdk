...
public:
    ...
    bool operator==(const AdGroupCommon& rhs) const;
    bool operator!=(const AdGroupCommon& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const AdGroupCommon& o);
    friend  void from_json(const nlohmann::json& j, AdGroupCommon& o);
protected:
