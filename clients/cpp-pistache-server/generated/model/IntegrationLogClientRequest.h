...
public:
    ...
    /// 
    /// </summary>
    org::openapitools::server::model::HttpMethod getMethod() const;
    void setMethod(org::openapitools::server::model::HttpMethod const& value);
    /// <summary>
    /// HTTP request path.
    /// </summary>
...
protected:
    ...
    org::openapitools::server::model::HttpMethod m_Method;
