...
public:
    ...
    bool operator==(const CatalogsReportStats& rhs) const;
    bool operator!=(const CatalogsReportStats& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const CatalogsReportStats& o);
    friend  void from_json(const nlohmann::json& j, CatalogsReportStats& o);
protected:
