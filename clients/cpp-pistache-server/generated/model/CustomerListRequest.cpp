...
void CustomerListRequest::setListType(UserListType const& value)
{
    m_List_type = value;
...
org::openapitools::server::model::Object CustomerListRequest::getExceptions() const
{
    return m_Exceptions;
}
void CustomerListRequest::setExceptions(org::openapitools::server::model::Object const& value)
{
    m_Exceptions = value;
