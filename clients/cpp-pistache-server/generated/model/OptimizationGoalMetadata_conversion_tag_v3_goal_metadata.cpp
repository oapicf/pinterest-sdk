...
std::string OptimizationGoalMetadata_conversion_tag_v3_goal_metadata::getReportingEvent() const
{
    return m_Reporting_event;
}
void OptimizationGoalMetadata_conversion_tag_v3_goal_metadata::setReportingEvent(std::string const& value)
{
