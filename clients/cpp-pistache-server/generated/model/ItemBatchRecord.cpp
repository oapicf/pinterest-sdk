...
org::openapitools::server::model::UpdatableItemAttributes ItemBatchRecord::getAttributes() const
{
    return m_Attributes;
}
void ItemBatchRecord::setAttributes(org::openapitools::server::model::UpdatableItemAttributes const& value)
{
    m_Attributes = value;
