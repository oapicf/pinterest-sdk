...
org::openapitools::server::model::ItemAttributesRequest ItemBatchRecord::getAttributes() const
{
    return m_Attributes;
}
void ItemBatchRecord::setAttributes(org::openapitools::server::model::ItemAttributesRequest const& value)
{
    m_Attributes = value;
...
std::vector<org::openapitools::server::model::UpdateMaskFieldType> ItemBatchRecord::getUpdateMask() const
{
    return m_Update_mask;
}
void ItemBatchRecord::setUpdateMask(std::vector<org::openapitools::server::model::UpdateMaskFieldType> const& value)
{
    m_Update_mask = value;
