...
public:
    ...
    bool operator==(const PinAnalyticsDailyMetrics& rhs) const;
    bool operator!=(const PinAnalyticsDailyMetrics& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const PinAnalyticsDailyMetrics& o);
    friend  void from_json(const nlohmann::json& j, PinAnalyticsDailyMetrics& o);
protected:
