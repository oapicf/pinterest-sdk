...
org::openapitools::server::model::ItemAttributesRequest CatalogsCreateRetailItem::getAttributes() const
{
    return m_Attributes;
}
void CatalogsCreateRetailItem::setAttributes(org::openapitools::server::model::ItemAttributesRequest const& value)
{
    m_Attributes = value;
}
