...
org::openapitools::server::model::CampaignBidOptionsUpdate CampaignUpdateRequest::getBidOptions() const
{
    return m_Bid_options;
}
void CampaignUpdateRequest::setBidOptions(org::openapitools::server::model::CampaignBidOptionsUpdate const& value)
{
    m_Bid_options = value;
...
org::openapitools::server::model::IntendedPromotionType CampaignUpdateRequest::getIntendedPromotionType() const
{
    return m_Intended_promotion_type;
}
void CampaignUpdateRequest::setIntendedPromotionType(org::openapitools::server::model::IntendedPromotionType const& value)
{
...
void CampaignUpdateRequest::setIsLtvOptimized(bool const value)
{
...
void CampaignUpdateRequest::setIsPerformancePlus(bool const value)
{
...
void CampaignUpdateRequest::setIsTopOfSearch(bool const value)
{
...
void CampaignUpdateRequest::setTrackingUrls(nlohmann::json const& value)
{
