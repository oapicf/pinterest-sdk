...
public:
    ...
    bool operator==(const InviteDataResponse& rhs) const;
    bool operator!=(const InviteDataResponse& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const InviteDataResponse& o);
    friend  void from_json(const nlohmann::json& j, InviteDataResponse& o);
protected:
