...
public:
    ...
    bool operator==(const DeleteBusinessMembershipMember& rhs) const;
    bool operator!=(const DeleteBusinessMembershipMember& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const DeleteBusinessMembershipMember& o);
    friend  void from_json(const nlohmann::json& j, DeleteBusinessMembershipMember& o);
protected:
