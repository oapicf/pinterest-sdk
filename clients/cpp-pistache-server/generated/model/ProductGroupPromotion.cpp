...
ProductGroupPromotion::ProductGroupPromotion()
{
    ...
    m_Is_image_auto_resizing = false;
...
bool ProductGroupPromotion::operator==(const ProductGroupPromotion& rhs) const
{
    ...
    ((!isImageAutoResizingIsSet() && !rhs.isImageAutoResizingIsSet()) || (isImageAutoResizingIsSet() && rhs.isImageAutoResizingIsSet() && isIsImageAutoResizing() == rhs.isIsImageAutoResizing())) &&
...
void to_json(nlohmann::json& j, const ProductGroupPromotion& o)
{
    ...
    if(o.isImageAutoResizingIsSet())
        j["is_image_auto_resizing"] = o.m_Is_image_auto_resizing;
    if(o.isMdlIsSet())
        j["is_mdl"] = o.m_Is_mdl;
    if(o.parentIdIsSet())
...
void from_json(const nlohmann::json& j, ProductGroupPromotion& o)
{
    ...
    if(j.find("is_image_auto_resizing") != j.end())
    {
        j.at("is_image_auto_resizing").get_to(o.m_Is_image_auto_resizing);
        o.m_Is_image_auto_resizingIsSet = true;
    } 
...
org::openapitools::server::model::CollectionsHeaderType ProductGroupPromotion::getCollectionsHeaderType() const
{
    return m_Collections_header_type;
}
void ProductGroupPromotion::setCollectionsHeaderType(org::openapitools::server::model::CollectionsHeaderType const& value)
{
...
org::openapitools::server::model::ProductGroupPromotionCustomizableCTAType ProductGroupPromotion::getCustomizableCtaType() const
{
    return m_Customizable_cta_type;
}
void ProductGroupPromotion::setCustomizableCtaType(org::openapitools::server::model::ProductGroupPromotionCustomizableCTAType const& value)
{
...
void ProductGroupPromotion::setIsImageAutoResizing(bool const value)
{
...
{
    return m_Is_image_auto_resizingIsSet;
}
...
org::openapitools::server::model::PreferredMediaType ProductGroupPromotion::getPreferredMediaType() const
{
    return m_Preferred_media_type;
}
void ProductGroupPromotion::setPreferredMediaType(org::openapitools::server::model::PreferredMediaType const& value)
{
