...
org::openapitools::server::model::UserAccountType Account::getAccountType() const
{
    return m_Account_type;
}
void Account::setAccountType(org::openapitools::server::model::UserAccountType const& value)
{
