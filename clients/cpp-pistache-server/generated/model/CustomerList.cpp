...
void CustomerList::setIsNca(bool const value)
{
    m_Is_nca = value;
    m_Is_ncaIsSet = true;
}
...
org::openapitools::server::model::CustomerListStatus CustomerList::getStatus() const
{
    return m_Status;
}
void CustomerList::setStatus(org::openapitools::server::model::CustomerListStatus const& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}
