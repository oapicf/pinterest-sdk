...
#ifndef ProductGroupPromotionArrayElement_H_
#define ProductGroupPromotionArrayElement_H_
...
public:
    ...
    virtual ~ProductGroupPromotionArrayElement() = default;
    ...
    bool operator==(const ProductGroupPromotionArrayElement& rhs) const;
    bool operator!=(const ProductGroupPromotionArrayElement& rhs) const;
    ...
    friend void to_json(nlohmann::json& j, const ProductGroupPromotionArrayElement& o);
    friend void from_json(const nlohmann::json& j, ProductGroupPromotionArrayElement& o);
protected:
...
#endif /* ProductGroupPromotionArrayElement_H_ */
