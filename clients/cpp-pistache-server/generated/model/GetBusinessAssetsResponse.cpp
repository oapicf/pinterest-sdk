...
org::openapitools::server::model::GetBusinessAssetsResponse_catalog_info GetBusinessAssetsResponse::getCatalogInfo() const
{
    return m_Catalog_info;
}
void GetBusinessAssetsResponse::setCatalogInfo(org::openapitools::server::model::GetBusinessAssetsResponse_catalog_info const& value)
{
