...
org::openapitools::server::model::AdGroupCommon_optimization_goal_metadata AdGroupCommon::getOptimizationGoalMetadata() const
{
    return m_Optimization_goal_metadata;
}
void AdGroupCommon::setOptimizationGoalMetadata(org::openapitools::server::model::AdGroupCommon_optimization_goal_metadata const& value)
{
