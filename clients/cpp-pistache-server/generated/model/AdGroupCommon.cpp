...
void AdGroupCommon::setIsCreativeOptimization(bool const value)
{
...
org::openapitools::server::model::OptimizationGoalMetadata AdGroupCommon::getOptimizationGoalMetadata() const
{
    return m_Optimization_goal_metadata;
}
void AdGroupCommon::setOptimizationGoalMetadata(org::openapitools::server::model::OptimizationGoalMetadata const& value)
{
...
org::openapitools::server::model::PacingDeliveryType AdGroupCommon::getPacingDeliveryType() const
{
    return m_Pacing_delivery_type;
}
void AdGroupCommon::setPacingDeliveryType(org::openapitools::server::model::PacingDeliveryType const& value)
{
...
org::openapitools::server::model::PlacementGroupType AdGroupCommon::getPlacementGroup() const
{
    return m_Placement_group;
}
void AdGroupCommon::setPlacementGroup(org::openapitools::server::model::PlacementGroupType const& value)
{
...
std::string AdGroupCommon::getPromotionApplicationLevel() const
{
    return m_Promotion_application_level;
}
void AdGroupCommon::setPromotionApplicationLevel(std::string const& value)
{
...
std::string AdGroupCommon::getPromotionId() const
{
    return m_Promotion_id;
}
void AdGroupCommon::setPromotionId(std::string const& value)
{
...
org::openapitools::server::model::EntityStatus AdGroupCommon::getStatus() const
{
    return m_Status;
}
void AdGroupCommon::setStatus(org::openapitools::server::model::EntityStatus const& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}
...
org::openapitools::server::model::TargetingSpec AdGroupCommon::getTargetingSpec() const
{
    return m_Targeting_spec;
}
void AdGroupCommon::setTargetingSpec(org::openapitools::server::model::TargetingSpec const& value)
{
...
void AdGroupCommon::setTargetingTemplateIds(std::vector<std::string> const& value)
{
...
org::openapitools::server::model::TrackingUrls AdGroupCommon::getTrackingUrls() const
{
    return m_Tracking_urls;
}
void AdGroupCommon::setTrackingUrls(org::openapitools::server::model::TrackingUrls const& value)
{
