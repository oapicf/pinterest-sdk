...
void from_json(const nlohmann::json& j, ObjectiveType& o)
{
    ...
    if (s == "AWARENESS") {
     ...
     o.setValue(ObjectiveType::eObjectiveType::SALES);
    } 
    else if (s == "APP_INSTALL") {
     o.setValue(ObjectiveType::eObjectiveType::APP_INSTALL);
    } 
    else if (s == "CTV_CONSIDERATION") {
     o.setValue(ObjectiveType::eObjectiveType::CTV_CONSIDERATION);
    }  else {
     std::stringstream ss;
