...
org::openapitools::server::model::ConversionTagV3GoalMetadata OptimizationGoalMetadata::getConversionTagV3GoalMetadata() const
{
    return m_Conversion_tag_v3_goal_metadata;
}
void OptimizationGoalMetadata::setConversionTagV3GoalMetadata(org::openapitools::server::model::ConversionTagV3GoalMetadata const& value)
{
...
org::openapitools::server::model::FrequencyGoalMetadata OptimizationGoalMetadata::getFrequencyGoalMetadata() const
{
    return m_Frequency_goal_metadata;
}
void OptimizationGoalMetadata::setFrequencyGoalMetadata(org::openapitools::server::model::FrequencyGoalMetadata const& value)
{
...
org::openapitools::server::model::ScrollupGoalMetadata OptimizationGoalMetadata::getScrollupGoalMetadata() const
{
    return m_Scrollup_goal_metadata;
}
void OptimizationGoalMetadata::setScrollupGoalMetadata(org::openapitools::server::model::ScrollupGoalMetadata const& value)
{
