...
public:
    ...
    bool operator==(const TemplateBasedReportCreate& rhs) const;
    bool operator!=(const TemplateBasedReportCreate& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const TemplateBasedReportCreate& o);
    friend  void from_json(const nlohmann::json& j, TemplateBasedReportCreate& o);
protected:
