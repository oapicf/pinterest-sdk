...
public:
    ...
    bool operator==(const LeadFormBatchUpdate& rhs) const;
    bool operator!=(const LeadFormBatchUpdate& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const LeadFormBatchUpdate& o);
    friend  void from_json(const nlohmann::json& j, LeadFormBatchUpdate& o);
protected:
