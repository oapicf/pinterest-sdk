...
public:
    ...
    bool operator==(const Ad_accounts_list_200_response& rhs) const;
    bool operator!=(const Ad_accounts_list_200_response& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const Ad_accounts_list_200_response& o);
    friend  void from_json(const nlohmann::json& j, Ad_accounts_list_200_response& o);
protected:
