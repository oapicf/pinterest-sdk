...
org::openapitools::server::model::PlacementType PlacementMultipliers::getPLACEMENT() const
{
    return m_PLACEMENT;
}
void PlacementMultipliers::setPLACEMENT(org::openapitools::server::model::PlacementType const& value)
{
    m_PLACEMENT = value;
