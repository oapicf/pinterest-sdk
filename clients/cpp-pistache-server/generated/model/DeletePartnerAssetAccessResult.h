...
public:
    ...
    bool operator==(const DeletePartnerAssetAccessResult& rhs) const;
    bool operator!=(const DeletePartnerAssetAccessResult& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const DeletePartnerAssetAccessResult& o);
    friend  void from_json(const nlohmann::json& j, DeletePartnerAssetAccessResult& o);
protected:
