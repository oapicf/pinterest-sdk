...
org::openapitools::server::model::CatalogsRetailReportParametersReport CatalogsRetailReportParameters::getReport() const
{
    return m_Report;
}
void CatalogsRetailReportParameters::setReport(org::openapitools::server::model::CatalogsRetailReportParametersReport const& value)
{
    m_Report = value;
}
