...
bool AuthRespondInvitesBody::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    /* Invites */ {
        const std::vector<org::openapitools::server::model::AuthRespondInvitesBodyItem>& value = m_Invites;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const org::openapitools::server::model::AuthRespondInvitesBodyItem& value : value)
            { 
...
std::vector<org::openapitools::server::model::AuthRespondInvitesBodyItem> AuthRespondInvitesBody::getInvites() const
{
    return m_Invites;
}
void AuthRespondInvitesBody::setInvites(std::vector<org::openapitools::server::model::AuthRespondInvitesBodyItem> const& value)
{
    m_Invites = value;
}
