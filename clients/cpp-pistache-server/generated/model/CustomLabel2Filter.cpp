...
org::openapitools::server::model::CatalogsProductGroupFilterOperatorTypeCriteria CustomLabel2Filter::getCUSTOMLABEL2() const
{
    return m_CUSTOM_LABEL_2;
}
void CustomLabel2Filter::setCUSTOMLABEL2(org::openapitools::server::model::CatalogsProductGroupFilterOperatorTypeCriteria const& value)
{
