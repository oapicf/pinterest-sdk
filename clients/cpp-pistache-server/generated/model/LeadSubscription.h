...
public:
    ...
    bool operator==(const LeadSubscription& rhs) const;
    bool operator!=(const LeadSubscription& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const LeadSubscription& o);
    friend  void from_json(const nlohmann::json& j, LeadSubscription& o);
protected:
