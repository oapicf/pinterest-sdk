...
public:
    ...
    bool operator==(const CatalogsProductGroupsUpdateRequestSchema& rhs) const;
    bool operator!=(const CatalogsProductGroupsUpdateRequestSchema& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const CatalogsProductGroupsUpdateRequestSchema& o);
    friend  void from_json(const nlohmann::json& j, CatalogsProductGroupsUpdateRequestSchema& o);
protected:
