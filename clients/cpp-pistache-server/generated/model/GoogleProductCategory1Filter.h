...
public:
    ...
    bool operator==(const GoogleProductCategory1Filter& rhs) const;
    bool operator!=(const GoogleProductCategory1Filter& rhs) const;
    ...
    friend void to_json(nlohmann::json& j, const GoogleProductCategory1Filter& o);
    friend void from_json(const nlohmann::json& j, GoogleProductCategory1Filter& o);
protected:
