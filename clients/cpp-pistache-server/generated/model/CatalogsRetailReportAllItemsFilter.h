...
public:
    ...
    bool operator==(const CatalogsRetailReportAllItemsFilter& rhs) const;
    bool operator!=(const CatalogsRetailReportAllItemsFilter& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const CatalogsRetailReportAllItemsFilter& o);
    friend  void from_json(const nlohmann::json& j, CatalogsRetailReportAllItemsFilter& o);
protected:
