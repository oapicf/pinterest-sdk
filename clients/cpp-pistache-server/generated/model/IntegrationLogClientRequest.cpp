...
org::openapitools::server::model::HttpMethod IntegrationLogClientRequest::getMethod() const
{
    return m_Method;
}
void IntegrationLogClientRequest::setMethod(org::openapitools::server::model::HttpMethod const& value)
{
    m_Method = value;
}
