...
org::openapitools::server::model::TieBreakerType QuizPinData::getTieBreakerType() const
{
    return m_Tie_breaker_type;
}
void QuizPinData::setTieBreakerType(org::openapitools::server::model::TieBreakerType const& value)
{
