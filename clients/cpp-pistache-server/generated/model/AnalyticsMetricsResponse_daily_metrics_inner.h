...
#ifndef AnalyticsMetricsResponse_daily_metrics_inner_H_
#define AnalyticsMetricsResponse_daily_metrics_inner_H_
...
public:
    ...
    virtual ~AnalyticsMetricsResponse_daily_metrics_inner() = default;
    ...
    bool operator==(const AnalyticsMetricsResponse_daily_metrics_inner& rhs) const;
    bool operator!=(const AnalyticsMetricsResponse_daily_metrics_inner& rhs) const;
    ...
    friend void to_json(nlohmann::json& j, const AnalyticsMetricsResponse_daily_metrics_inner& o);
    friend void from_json(const nlohmann::json& j, AnalyticsMetricsResponse_daily_metrics_inner& o);
protected:
...
#endif /* AnalyticsMetricsResponse_daily_metrics_inner_H_ */
