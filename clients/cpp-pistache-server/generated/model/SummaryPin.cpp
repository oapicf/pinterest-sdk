...
org::openapitools::server::model::SummaryPin_media SummaryPin::getMedia() const
{
    return m_Media;
}
void SummaryPin::setMedia(org::openapitools::server::model::SummaryPin_media const& value)
{
    m_Media = value;
    m_MediaIsSet = true;
}
