...
public:
    ...
    void setErrors(std::vector<ItemValidationEvent> const& value);
    ...
    void setWarnings(std::vector<ItemValidationEvent> const& value);
    ...
    void setStatus(ItemProcessingStatus const& value);
