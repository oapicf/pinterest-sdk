...
org::openapitools::server::model::CatalogsStatus Feeds_create_request::getStatus() const
{
    return m_Status;
}
void Feeds_create_request::setStatus(org::openapitools::server::model::CatalogsStatus const& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}
