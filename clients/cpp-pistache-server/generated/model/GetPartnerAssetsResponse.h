...
public:
    ...
    bool operator==(const GetPartnerAssetsResponse& rhs) const;
    bool operator!=(const GetPartnerAssetsResponse& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const GetPartnerAssetsResponse& o);
    friend  void from_json(const nlohmann::json& j, GetPartnerAssetsResponse& o);
protected:
