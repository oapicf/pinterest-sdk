...
org::openapitools::server::model::AdGroupCommon_optimization_goal_metadata AdGroupResponse::getOptimizationGoalMetadata() const
{
    return m_Optimization_goal_metadata;
}
void AdGroupResponse::setOptimizationGoalMetadata(org::openapitools::server::model::AdGroupCommon_optimization_goal_metadata const& value)
{
