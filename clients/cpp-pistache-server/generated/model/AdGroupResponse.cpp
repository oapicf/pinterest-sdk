...
void AdGroupResponse::setBudgetType(std::string const& value)
{
    m_Budget_type = value;
...
void AdGroupResponse::setTrackingUrls(TrackingUrls const& value)
{
...
void AdGroupResponse::setBillableEvent(ActionType const& value)
{
