...
void AdGroupResponse::setIsCreativeOptimization(bool const value)
{
...
std::string AdGroupResponse::getPromotionApplicationLevel() const
{
    return m_Promotion_application_level;
}
void AdGroupResponse::setPromotionApplicationLevel(std::string const& value)
{
...
std::string AdGroupResponse::getPromotionId() const
{
    return m_Promotion_id;
}
void AdGroupResponse::setPromotionId(std::string const& value)
{
...
void AdGroupResponse::setBidMultiplier(double const value)
{
