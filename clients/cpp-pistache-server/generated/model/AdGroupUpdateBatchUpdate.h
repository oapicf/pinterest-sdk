...
public:
    ...
    bool operator==(const AdGroupUpdateBatchUpdate& rhs) const;
    bool operator!=(const AdGroupUpdateBatchUpdate& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const AdGroupUpdateBatchUpdate& o);
    friend  void from_json(const nlohmann::json& j, AdGroupUpdateBatchUpdate& o);
protected:
