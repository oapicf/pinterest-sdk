...
void CatalogsVerticalFeedsCreateRequest::setCatalogType(std::string const& value)
{
...
org::openapitools::server::model::CatalogsCreativeAssetsFeedsCreateRequest_default_locale CatalogsVerticalFeedsCreateRequest::getDefaultLocale() const
{
    return m_Default_locale;
}
void CatalogsVerticalFeedsCreateRequest::setDefaultLocale(org::openapitools::server::model::CatalogsCreativeAssetsFeedsCreateRequest_default_locale const& value)
{
