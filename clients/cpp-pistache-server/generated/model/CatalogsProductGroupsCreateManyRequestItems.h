...
public:
    ...
    bool operator==(const CatalogsProductGroupsCreateManyRequestItems& rhs) const;
    bool operator!=(const CatalogsProductGroupsCreateManyRequestItems& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const CatalogsProductGroupsCreateManyRequestItems& o);
    friend  void from_json(const nlohmann::json& j, CatalogsProductGroupsCreateManyRequestItems& o);
protected:
