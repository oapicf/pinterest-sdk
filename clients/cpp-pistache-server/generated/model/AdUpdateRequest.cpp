...
void AdUpdateRequest::setCustomizableCtaType(std::string const& value)
{
...
org::openapitools::server::model::AdCommon_quiz_pin_data AdUpdateRequest::getQuizPinData() const
{
    return m_Quiz_pin_data;
}
void AdUpdateRequest::setQuizPinData(org::openapitools::server::model::AdCommon_quiz_pin_data const& value)
{
