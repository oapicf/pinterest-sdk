...
org::openapitools::server::model::QuizPinData AdUpdateRequest::getQuizPinData() const
{
    return m_Quiz_pin_data;
}
void AdUpdateRequest::setQuizPinData(org::openapitools::server::model::QuizPinData const& value)
{
...
org::openapitools::server::model::TrackingUrls AdUpdateRequest::getTrackingUrls() const
{
    return m_Tracking_urls;
}
void AdUpdateRequest::setTrackingUrls(org::openapitools::server::model::TrackingUrls const& value)
{
