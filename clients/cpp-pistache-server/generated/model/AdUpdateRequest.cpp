...
org::openapitools::server::model::CustomizableCTAType AdUpdateRequest::getCustomizableCtaType() const
{
    return m_Customizable_cta_type;
}
void AdUpdateRequest::setCustomizableCtaType(org::openapitools::server::model::CustomizableCTAType const& value)
{
...
org::openapitools::server::model::DisclosureType AdUpdateRequest::getDisclosureType() const
{
    return m_Disclosure_type;
}
void AdUpdateRequest::setDisclosureType(org::openapitools::server::model::DisclosureType const& value)
{
...
void AdUpdateRequest::setDisclosureUrl(std::string const& value)
{
...
org::openapitools::server::model::GridClickType AdUpdateRequest::getGridClickType() const
{
    return m_Grid_click_type;
}
void AdUpdateRequest::setGridClickType(org::openapitools::server::model::GridClickType const& value)
{
...
void AdUpdateRequest::setIsCarting(bool const value)
{
    m_Is_carting = value;
...
void AdUpdateRequest::setLeadFormId(std::string const& value)
{
...
void AdUpdateRequest::setQuizPinData(nlohmann::json const& value)
{
...
void AdUpdateRequest::setTrackingUrls(nlohmann::json const& value)
{
