...
bool MetricsResponse::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    if (dataIsSet())
    {
        const std::vector<org::openapitools::server::model::MetricsResponseDataItems>& value = m_Data;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const org::openapitools::server::model::MetricsResponseDataItems& value : value)
            { 
...
std::vector<org::openapitools::server::model::MetricsResponseDataItems> MetricsResponse::getData() const
{
    return m_Data;
}
void MetricsResponse::setData(std::vector<org::openapitools::server::model::MetricsResponseDataItems> const& value)
{
    m_Data = value;
    m_DataIsSet = true;
}
