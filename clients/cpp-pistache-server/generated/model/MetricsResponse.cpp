...
bool MetricsResponse::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    if (dataIsSet())
    {
        const std::vector<nlohmann::json>& value = m_Data;
...
std::vector<nlohmann::json> MetricsResponse::getData() const
{
    return m_Data;
}
void MetricsResponse::setData(std::vector<nlohmann::json> const& value)
{
    m_Data = value;
    m_DataIsSet = true;
}
