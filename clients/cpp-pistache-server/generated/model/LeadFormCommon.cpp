...
std::vector<org::openapitools::server::model::LeadFormCommon_policy_links_inner> LeadFormCommon::getPolicyLinks() const
{
    return m_Policy_links;
}
void LeadFormCommon::setPolicyLinks(std::vector<org::openapitools::server::model::LeadFormCommon_policy_links_inner> const& value)
{
