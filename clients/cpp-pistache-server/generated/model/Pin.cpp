...
org::openapitools::server::model::AiDisclosures Pin::getAiDisclosures() const
{
    return m_Ai_disclosures;
}
void Pin::setAiDisclosures(org::openapitools::server::model::AiDisclosures const& value)
{
...
void Pin::setIsProduct(bool const value)
{
    m_Is_product = value;
