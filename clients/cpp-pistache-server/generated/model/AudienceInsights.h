...
public:
    ...
    bool operator==(const AudienceInsights& rhs) const;
    bool operator!=(const AudienceInsights& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const AudienceInsights& o);
    friend  void from_json(const nlohmann::json& j, AudienceInsights& o);
protected:
