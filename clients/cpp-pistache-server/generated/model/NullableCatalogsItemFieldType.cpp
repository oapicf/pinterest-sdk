...
void from_json(const nlohmann::json& j, NullableCatalogsItemFieldType& o)
{
    ...
    else if (s == "AD_IMAGE_0_LINK") {
     o.setValue(NullableCatalogsItemFieldType::eNullableCatalogsItemFieldType::AD_IMAGE_0_LINK);
    } 
    else if (s == "AD_IMAGE_1_LINK") {
     o.setValue(NullableCatalogsItemFieldType::eNullableCatalogsItemFieldType::AD_IMAGE_1_LINK);
    } 
    else if (s == "AD_IMAGE_2_LINK") {
     o.setValue(NullableCatalogsItemFieldType::eNullableCatalogsItemFieldType::AD_IMAGE_2_LINK);
    } 
    else if (s == "AD_IMAGE_3_LINK") {
     o.setValue(NullableCatalogsItemFieldType::eNullableCatalogsItemFieldType::AD_IMAGE_3_LINK);
    } 
    else if (s == "AD_IMAGE_4_LINK") {
     o.setValue(NullableCatalogsItemFieldType::eNullableCatalogsItemFieldType::AD_IMAGE_4_LINK);
    } 
    else if (s == "AD_IMAGE_5_LINK") {
     o.setValue(NullableCatalogsItemFieldType::eNullableCatalogsItemFieldType::AD_IMAGE_5_LINK);
    } 
    else if (s == "AD_IMAGE_6_LINK") {
     o.setValue(NullableCatalogsItemFieldType::eNullableCatalogsItemFieldType::AD_IMAGE_6_LINK);
    } 
    else if (s == "AD_IMAGE_7_LINK") {
     o.setValue(NullableCatalogsItemFieldType::eNullableCatalogsItemFieldType::AD_IMAGE_7_LINK);
    } 
    else if (s == "AD_IMAGE_8_LINK") {
     o.setValue(NullableCatalogsItemFieldType::eNullableCatalogsItemFieldType::AD_IMAGE_8_LINK);
    } 
    else if (s == "AD_IMAGE_9_LINK") {
     o.setValue(NullableCatalogsItemFieldType::eNullableCatalogsItemFieldType::AD_IMAGE_9_LINK);
    } 
    else if (s == "AD_IMAGE_10_LINK") {
     o.setValue(NullableCatalogsItemFieldType::eNullableCatalogsItemFieldType::AD_IMAGE_10_LINK);
    } 
    else if (s == "AD_IMAGE_11_LINK") {
     o.setValue(NullableCatalogsItemFieldType::eNullableCatalogsItemFieldType::AD_IMAGE_11_LINK);
    } 
    else if (s == "AD_IMAGE_12_LINK") {
     o.setValue(NullableCatalogsItemFieldType::eNullableCatalogsItemFieldType::AD_IMAGE_12_LINK);
    } 
    else if (s == "AD_IMAGE_13_LINK") {
     o.setValue(NullableCatalogsItemFieldType::eNullableCatalogsItemFieldType::AD_IMAGE_13_LINK);
    } 
    else if (s == "AD_IMAGE_14_LINK") {
     o.setValue(NullableCatalogsItemFieldType::eNullableCatalogsItemFieldType::AD_IMAGE_14_LINK);
    } 
    else if (s == "AD_IMAGE_15_LINK") {
     o.setValue(NullableCatalogsItemFieldType::eNullableCatalogsItemFieldType::AD_IMAGE_15_LINK);
    } 
    else if (s == "AD_IMAGE_16_LINK") {
     o.setValue(NullableCatalogsItemFieldType::eNullableCatalogsItemFieldType::AD_IMAGE_16_LINK);
    } 
    else if (s == "AD_IMAGE_17_LINK") {
     o.setValue(NullableCatalogsItemFieldType::eNullableCatalogsItemFieldType::AD_IMAGE_17_LINK);
    } 
    else if (s == "AD_IMAGE_18_LINK") {
     o.setValue(NullableCatalogsItemFieldType::eNullableCatalogsItemFieldType::AD_IMAGE_18_LINK);
    } 
    else if (s == "AD_IMAGE_19_LINK") {
     o.setValue(NullableCatalogsItemFieldType::eNullableCatalogsItemFieldType::AD_IMAGE_19_LINK);
    } 
    else if (s == "AD_IMAGE_0_TAG") {
     o.setValue(NullableCatalogsItemFieldType::eNullableCatalogsItemFieldType::AD_IMAGE_0_TAG);
    } 
    else if (s == "AD_IMAGE_1_TAG") {
     o.setValue(NullableCatalogsItemFieldType::eNullableCatalogsItemFieldType::AD_IMAGE_1_TAG);
    } 
    else if (s == "AD_IMAGE_2_TAG") {
     o.setValue(NullableCatalogsItemFieldType::eNullableCatalogsItemFieldType::AD_IMAGE_2_TAG);
    } 
    else if (s == "AD_IMAGE_3_TAG") {
     o.setValue(NullableCatalogsItemFieldType::eNullableCatalogsItemFieldType::AD_IMAGE_3_TAG);
    } 
    else if (s == "AD_IMAGE_4_TAG") {
     o.setValue(NullableCatalogsItemFieldType::eNullableCatalogsItemFieldType::AD_IMAGE_4_TAG);
    } 
    else if (s == "AD_IMAGE_5_TAG") {
     o.setValue(NullableCatalogsItemFieldType::eNullableCatalogsItemFieldType::AD_IMAGE_5_TAG);
    } 
    else if (s == "AD_IMAGE_6_TAG") {
     o.setValue(NullableCatalogsItemFieldType::eNullableCatalogsItemFieldType::AD_IMAGE_6_TAG);
    } 
    else if (s == "AD_IMAGE_7_TAG") {
     o.setValue(NullableCatalogsItemFieldType::eNullableCatalogsItemFieldType::AD_IMAGE_7_TAG);
    } 
    else if (s == "AD_IMAGE_8_TAG") {
     o.setValue(NullableCatalogsItemFieldType::eNullableCatalogsItemFieldType::AD_IMAGE_8_TAG);
    } 
    else if (s == "AD_IMAGE_9_TAG") {
     o.setValue(NullableCatalogsItemFieldType::eNullableCatalogsItemFieldType::AD_IMAGE_9_TAG);
    } 
    else if (s == "AD_IMAGE_10_TAG") {
     o.setValue(NullableCatalogsItemFieldType::eNullableCatalogsItemFieldType::AD_IMAGE_10_TAG);
    } 
    else if (s == "AD_IMAGE_11_TAG") {
     o.setValue(NullableCatalogsItemFieldType::eNullableCatalogsItemFieldType::AD_IMAGE_11_TAG);
    } 
    else if (s == "AD_IMAGE_12_TAG") {
     o.setValue(NullableCatalogsItemFieldType::eNullableCatalogsItemFieldType::AD_IMAGE_12_TAG);
    } 
    else if (s == "AD_IMAGE_13_TAG") {
     o.setValue(NullableCatalogsItemFieldType::eNullableCatalogsItemFieldType::AD_IMAGE_13_TAG);
    } 
    else if (s == "AD_IMAGE_14_TAG") {
     o.setValue(NullableCatalogsItemFieldType::eNullableCatalogsItemFieldType::AD_IMAGE_14_TAG);
    } 
    else if (s == "AD_IMAGE_15_TAG") {
     o.setValue(NullableCatalogsItemFieldType::eNullableCatalogsItemFieldType::AD_IMAGE_15_TAG);
    } 
    else if (s == "AD_IMAGE_16_TAG") {
     o.setValue(NullableCatalogsItemFieldType::eNullableCatalogsItemFieldType::AD_IMAGE_16_TAG);
    } 
    else if (s == "AD_IMAGE_17_TAG") {
     o.setValue(NullableCatalogsItemFieldType::eNullableCatalogsItemFieldType::AD_IMAGE_17_TAG);
    } 
    else if (s == "AD_IMAGE_18_TAG") {
     o.setValue(NullableCatalogsItemFieldType::eNullableCatalogsItemFieldType::AD_IMAGE_18_TAG);
    } 
    else if (s == "AD_IMAGE_19_TAG") {
     o.setValue(NullableCatalogsItemFieldType::eNullableCatalogsItemFieldType::AD_IMAGE_19_TAG);
    } 
    else if (s == "AD_VIDEO_0_LINK") {
     o.setValue(NullableCatalogsItemFieldType::eNullableCatalogsItemFieldType::AD_VIDEO_0_LINK);
    } 
    else if (s == "AD_VIDEO_1_LINK") {
     o.setValue(NullableCatalogsItemFieldType::eNullableCatalogsItemFieldType::AD_VIDEO_1_LINK);
    } 
    else if (s == "AD_VIDEO_2_LINK") {
     o.setValue(NullableCatalogsItemFieldType::eNullableCatalogsItemFieldType::AD_VIDEO_2_LINK);
    } 
    else if (s == "AD_VIDEO_0_TAG") {
     o.setValue(NullableCatalogsItemFieldType::eNullableCatalogsItemFieldType::AD_VIDEO_0_TAG);
    } 
    else if (s == "AD_VIDEO_1_TAG") {
     o.setValue(NullableCatalogsItemFieldType::eNullableCatalogsItemFieldType::AD_VIDEO_1_TAG);
    } 
    else if (s == "AD_VIDEO_2_TAG") {
     o.setValue(NullableCatalogsItemFieldType::eNullableCatalogsItemFieldType::AD_VIDEO_2_TAG);
    } 
    else if (s == "INSTALLMENT_PRICE") {
     o.setValue(NullableCatalogsItemFieldType::eNullableCatalogsItemFieldType::INSTALLMENT_PRICE);
    } 
    else if (s == "UNIT_PRICE_TOTAL_MEASURE") {
     o.setValue(NullableCatalogsItemFieldType::eNullableCatalogsItemFieldType::UNIT_PRICE_TOTAL_MEASURE);
    } 
    else if (s == "UNIT_PRICE_BASE_MEASURE") {
     o.setValue(NullableCatalogsItemFieldType::eNullableCatalogsItemFieldType::UNIT_PRICE_BASE_MEASURE);
    } 
