...
org::openapitools::server::model::ImageSize PinMediaWithImage::getImages() const
{
    return m_Images;
}
void PinMediaWithImage::setImages(org::openapitools::server::model::ImageSize const& value)
{
    m_Images = value;
    m_ImagesIsSet = true;
}
