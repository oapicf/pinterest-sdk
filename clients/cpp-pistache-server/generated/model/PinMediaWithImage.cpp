...
org::openapitools::server::model::ImageMetadata_images PinMediaWithImage::getImages() const
{
    return m_Images;
}
void PinMediaWithImage::setImages(org::openapitools::server::model::ImageMetadata_images const& value)
{
    m_Images = value;
    m_ImagesIsSet = true;
}
