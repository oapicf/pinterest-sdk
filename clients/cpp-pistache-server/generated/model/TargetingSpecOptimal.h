...
public:
    ...
    bool operator==(const TargetingSpecOptimal& rhs) const;
    bool operator!=(const TargetingSpecOptimal& rhs) const;
    ...
    /// </summary>
    std::vector<org::openapitools::server::model::TargetingSpecAgeBucket> getAGEBUCKET() const;
    void setAGEBUCKET(std::vector<org::openapitools::server::model::TargetingSpecAgeBucket> const& value);
    bool aGEBUCKETIsSet() const;
    void unsetAGE_BUCKET();
    /// <summary>
    /// Allowed devices. If the APPTYPE field is missing, the default behavior in terms of ad delivery is that **All devices/apptypes** will be targeted.
    /// </summary>
    std::vector<org::openapitools::server::model::TargetingSpecAppType> getAPPTYPE() const;
    void setAPPTYPE(std::vector<org::openapitools::server::model::TargetingSpecAppType> const& value);
    ...
    /// </summary>
    std::vector<org::openapitools::server::model::TargetingSpecGender> getGENDER() const;
    void setGENDER(std::vector<org::openapitools::server::model::TargetingSpecGender> const& value);
    ...
    void setGEOEXCLUDE(std::vector<std::string> const& value);
    ...
    void setLOCATIONEXCLUDE(std::vector<std::string> const& value);
    ...
    void setMAXIMUMAGE(std::string const& value);
    ...
    void setMINIMUMAGE(std::string const& value);
    bool mINIMUMAGEIsSet() const;
    void unsetMINIMUM_AGE();
    /// <summary>
    /// Array of object: lookback_window [Integer]: Number of days ago to start lookback timeframe for dynamic retargeting tag_types [Array of integer]: Event types to target for dynamic retargeting exclusion_window [Integer]: Number of days ago to stop lookback timeframe for dynamic retargeting
    /// </summary>
    std::vector<org::openapitools::server::model::TargetingSpecShoppingRetargeting> getSHOPPINGRETARGETING() const;
    void setSHOPPINGRETARGETING(std::vector<org::openapitools::server::model::TargetingSpecShoppingRetargeting> const& value);
    bool sHOPPINGRETARGETINGIsSet() const;
    void unsetSHOPPING_RETARGETING();
    /// <summary>
    /// 
    /// </summary>
    std::vector<org::openapitools::server::model::TargetingStrategy> getTARGETINGSTRATEGY() const;
    void setTARGETINGSTRATEGY(std::vector<org::openapitools::server::model::TargetingStrategy> const& value);
    bool tARGETINGSTRATEGYIsSet() const;
    void unsetTARGETING_STRATEGY();

    friend  void to_json(nlohmann::json& j, const TargetingSpecOptimal& o);
    friend  void from_json(const nlohmann::json& j, TargetingSpecOptimal& o);
protected:
    std::vector<org::openapitools::server::model::TargetingSpecAgeBucket> m_AGE_BUCKET;
    bool m_AGE_BUCKETIsSet;
    std::vector<org::openapitools::server::model::TargetingSpecAppType> m_APPTYPE;
    bool m_APPTYPEIsSet;
    ...
    std::vector<org::openapitools::server::model::TargetingSpecGender> m_GENDER;
    bool m_GENDERIsSet;
    ...
    std::vector<org::openapitools::server::model::TargetingSpecShoppingRetargeting> m_SHOPPING_RETARGETING;
    bool m_SHOPPING_RETARGETINGIsSet;
    std::vector<org::openapitools::server::model::TargetingStrategy> m_TARGETING_STRATEGY;
