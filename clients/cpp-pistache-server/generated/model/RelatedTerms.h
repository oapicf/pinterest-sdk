...
public:
    ...
    /// </summary>
    std::vector<org::openapitools::server::model::RelatedTermsRelatedTermsListItems> getRelatedTermsList() const;
    void setRelatedTermsList(std::vector<org::openapitools::server::model::RelatedTermsRelatedTermsListItems> const& value);
...
protected:
    ...
    std::vector<org::openapitools::server::model::RelatedTermsRelatedTermsListItems> m_Related_terms_list;
