...
org::openapitools::server::model::CampaignBidOptions CampaignCreateResponseData::getBidOptions() const
{
    return m_Bid_options;
}
void CampaignCreateResponseData::setBidOptions(org::openapitools::server::model::CampaignBidOptions const& value)
{
    m_Bid_options = value;
...
void CampaignCreateResponseData::setIsPerformancePlus(bool const value)
{
