...
#ifndef AdGroupUpdate_H_
#define AdGroupUpdate_H_
...
public:
    ...
    bool operator==(const AdGroupUpdate& rhs) const;
    bool operator!=(const AdGroupUpdate& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const AdGroupUpdate& o);
    friend  void from_json(const nlohmann::json& j, AdGroupUpdate& o);
protected:
