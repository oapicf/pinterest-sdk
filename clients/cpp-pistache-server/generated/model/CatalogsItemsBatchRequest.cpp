...
bool CatalogsItemsBatchRequest::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    if (itemsIsSet())
    {
        const std::vector<org::openapitools::server::model::ItemBatchRecord>& value = m_Items;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const org::openapitools::server::model::ItemBatchRecord& value : value)
            { 
...
std::vector<org::openapitools::server::model::ItemBatchRecord> CatalogsItemsBatchRequest::getItems() const
{
    return m_Items;
}
void CatalogsItemsBatchRequest::setItems(std::vector<org::openapitools::server::model::ItemBatchRecord> const& value)
{
    m_Items = value;
    m_ItemsIsSet = true;
}
