...
org::openapitools::server::model::InviteDataResponse InviteResponse::getInviteData() const
{
    return m_Invite_data;
}
void InviteResponse::setInviteData(org::openapitools::server::model::InviteDataResponse const& value)
{
    m_Invite_data = value;
