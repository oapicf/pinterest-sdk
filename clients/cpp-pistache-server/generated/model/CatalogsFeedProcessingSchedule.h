...
public:
    ...
    /// </summary>
    org::openapitools::server::model::CatalogsFeedProcessingScheduleTimezone getTimezone() const;
    void setTimezone(org::openapitools::server::model::CatalogsFeedProcessingScheduleTimezone const& value);
...
protected:
    ...
    org::openapitools::server::model::CatalogsFeedProcessingScheduleTimezone m_Timezone;
