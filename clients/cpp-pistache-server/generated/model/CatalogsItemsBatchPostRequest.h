...
public:
    ...
    bool operator==(const CatalogsItemsBatchPostRequest& rhs) const;
    bool operator!=(const CatalogsItemsBatchPostRequest& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const CatalogsItemsBatchPostRequest& o);
    friend  void from_json(const nlohmann::json& j, CatalogsItemsBatchPostRequest& o);
protected:
