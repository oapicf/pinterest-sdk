...
void TargetingSpec_SHOPPING_RETARGETING_1_inner::validate() const
{
...
bool TargetingSpec_SHOPPING_RETARGETING_1_inner::validate(std::stringstream& msg) const
{
    return validate(msg, "");
}

bool TargetingSpec_SHOPPING_RETARGETING_1_inner::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "TargetingSpec_SHOPPING_RETARGETING_1_inner" : pathPrefix;
...
bool TargetingSpec_SHOPPING_RETARGETING_1_inner::operator==(const TargetingSpec_SHOPPING_RETARGETING_1_inner& rhs) const
{
    return
...
void to_json(nlohmann::json& j, const TargetingSpec_SHOPPING_RETARGETING_1_inner& o)
{
    j = nlohmann::json();
...
void from_json(const nlohmann::json& j, TargetingSpec_SHOPPING_RETARGETING_1_inner& o)
{
...
void TargetingSpec_SHOPPING_RETARGETING_1_inner::setLookbackWindow(int32_t const value)
{
...
std::vector<int32_t> TargetingSpec_SHOPPING_RETARGETING_1_inner::getTagTypes() const
{
    return m_Tag_types;
}
void TargetingSpec_SHOPPING_RETARGETING_1_inner::setTagTypes(std::vector<int32_t> const value)
{
    m_Tag_types = value;
...
void TargetingSpec_SHOPPING_RETARGETING_1_inner::setExclusionWindow(int32_t const value)
{
