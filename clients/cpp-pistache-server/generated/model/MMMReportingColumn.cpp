...
MMMReportingColumn::~MMMReportingColumn() = default;
...
void from_json(const nlohmann::json& j, MMMReportingColumn& o)
{
    ...
    if (s == "SPEND_IN_DOLLAR") {
     ...
     o.setValue(MMMReportingColumn::eMMMReportingColumn::CAMPAIGN_OBJECTIVE_TYPE);
    } 
    else if (s == "PINNER_LIST_NAME") {
     o.setValue(MMMReportingColumn::eMMMReportingColumn::PINNER_LIST_NAME);
    } 
    else if (s == "ADS_CREDIT_SPEND_IN_DOLLAR") {
     o.setValue(MMMReportingColumn::eMMMReportingColumn::ADS_CREDIT_SPEND_IN_DOLLAR);
    } 
    else if (s == "ADVERTISER_PAID_SPEND_IN_DOLLAR") {
     o.setValue(MMMReportingColumn::eMMMReportingColumn::ADVERTISER_PAID_SPEND_IN_DOLLAR);
    } 
    else if (s == "ADVERTISER_PAID_ECPC_IN_DOLLAR") {
     o.setValue(MMMReportingColumn::eMMMReportingColumn::ADVERTISER_PAID_ECPC_IN_DOLLAR);
    } 
    else if (s == "ADVERTISER_PAID_ECPM_IN_DOLLAR") {
     o.setValue(MMMReportingColumn::eMMMReportingColumn::ADVERTISER_PAID_ECPM_IN_DOLLAR);
    }  else {
     std::stringstream ss;
