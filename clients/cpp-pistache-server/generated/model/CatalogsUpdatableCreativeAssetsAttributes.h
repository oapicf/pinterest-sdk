...
public:
    ...
    bool operator==(const CatalogsUpdatableCreativeAssetsAttributes& rhs) const;
    bool operator!=(const CatalogsUpdatableCreativeAssetsAttributes& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const CatalogsUpdatableCreativeAssetsAttributes& o);
    friend  void from_json(const nlohmann::json& j, CatalogsUpdatableCreativeAssetsAttributes& o);
protected:
    std::string m_Title;
    bool m_TitleIsSet;
