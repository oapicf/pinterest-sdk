...
public:
    ...
    /// </summary>
    std::vector<org::openapitools::server::model::AssetAccessRequestError> getExceptions() const;
    void setExceptions(std::vector<org::openapitools::server::model::AssetAccessRequestError> const& value);
...
protected:
    std::vector<org::openapitools::server::model::AssetAccessRequestError> m_Exceptions;
