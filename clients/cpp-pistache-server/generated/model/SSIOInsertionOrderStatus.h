...
public:
    ...
    bool operator==(const SSIOInsertionOrderStatus& rhs) const;
    bool operator!=(const SSIOInsertionOrderStatus& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const SSIOInsertionOrderStatus& o);
    friend  void from_json(const nlohmann::json& j, SSIOInsertionOrderStatus& o);
protected:
