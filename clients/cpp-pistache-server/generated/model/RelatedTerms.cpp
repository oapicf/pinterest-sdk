...
bool RelatedTerms::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    {
        const std::vector<org::openapitools::server::model::RelatedTermsRelatedTermsListItems>& value = m_Related_terms_list;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const org::openapitools::server::model::RelatedTermsRelatedTermsListItems& value : value)
            { 
...
std::vector<org::openapitools::server::model::RelatedTermsRelatedTermsListItems> RelatedTerms::getRelatedTermsList() const
{
    return m_Related_terms_list;
}
void RelatedTerms::setRelatedTermsList(std::vector<org::openapitools::server::model::RelatedTermsRelatedTermsListItems> const& value)
{
