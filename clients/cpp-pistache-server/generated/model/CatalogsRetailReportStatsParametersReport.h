...
public:
    ...
    bool operator==(const CatalogsRetailReportStatsParametersReport& rhs) const;
    bool operator!=(const CatalogsRetailReportStatsParametersReport& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const CatalogsRetailReportStatsParametersReport& o);
    friend  void from_json(const nlohmann::json& j, CatalogsRetailReportStatsParametersReport& o);
protected:
