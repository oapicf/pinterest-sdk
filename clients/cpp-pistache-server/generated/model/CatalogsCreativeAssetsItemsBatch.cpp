...
org::openapitools::server::model::CatalogsType CatalogsCreativeAssetsItemsBatch::getCatalogType() const
{
    return m_Catalog_type;
}
void CatalogsCreativeAssetsItemsBatch::setCatalogType(org::openapitools::server::model::CatalogsType const& value)
{
