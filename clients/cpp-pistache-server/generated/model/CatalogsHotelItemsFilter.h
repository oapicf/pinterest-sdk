...
public:
    ...
    bool operator==(const CatalogsHotelItemsFilter& rhs) const;
    bool operator!=(const CatalogsHotelItemsFilter& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const CatalogsHotelItemsFilter& o);
    friend  void from_json(const nlohmann::json& j, CatalogsHotelItemsFilter& o);
protected:
