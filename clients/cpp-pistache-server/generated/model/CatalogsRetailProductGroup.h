...
public:
    ...
    bool operator==(const CatalogsRetailProductGroup& rhs) const;
    bool operator!=(const CatalogsRetailProductGroup& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const CatalogsRetailProductGroup& o);
    friend  void from_json(const nlohmann::json& j, CatalogsRetailProductGroup& o);
protected:
