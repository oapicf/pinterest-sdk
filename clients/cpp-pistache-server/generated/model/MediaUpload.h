...
public:
    ...
    /// </summary>
    org::openapitools::server::model::MediaUploadParameters getUploadParameters() const;
    void setUploadParameters(org::openapitools::server::model::MediaUploadParameters const& value);
...
protected:
    ...
    org::openapitools::server::model::MediaUploadParameters m_Upload_parameters;
