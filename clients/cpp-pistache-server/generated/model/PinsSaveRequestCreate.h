...
public:
    ...
    bool operator==(const PinsSaveRequestCreate& rhs) const;
    bool operator!=(const PinsSaveRequestCreate& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const PinsSaveRequestCreate& o);
    friend  void from_json(const nlohmann::json& j, PinsSaveRequestCreate& o);
protected:
