...
org::openapitools::server::model::CatalogsProductGroupMultipleStringListCriteria ProductType2Filter::getPRODUCTTYPE2() const
{
    return m_PRODUCT_TYPE_2;
}
void ProductType2Filter::setPRODUCTTYPE2(org::openapitools::server::model::CatalogsProductGroupMultipleStringListCriteria const& value)
{
