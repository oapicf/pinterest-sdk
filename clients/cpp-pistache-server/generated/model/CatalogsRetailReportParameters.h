...
public:
    ...
    /// 
    /// </summary>
    org::openapitools::server::model::CatalogsRetailReportParametersReport getReport() const;
    void setReport(org::openapitools::server::model::CatalogsRetailReportParametersReport const& value);
...
protected:
    ...
    org::openapitools::server::model::CatalogsRetailReportParametersReport m_Report;
