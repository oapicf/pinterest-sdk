...
org::openapitools::server::model::CustomizableCTAType AdCommon::getCustomizableCtaType() const
{
    return m_Customizable_cta_type;
}
void AdCommon::setCustomizableCtaType(org::openapitools::server::model::CustomizableCTAType const& value)
{
...
org::openapitools::server::model::DisclosureType AdCommon::getDisclosureType() const
{
    return m_Disclosure_type;
}
void AdCommon::setDisclosureType(org::openapitools::server::model::DisclosureType const& value)
{
...
void AdCommon::setDisclosureUrl(std::string const& value)
{
