...
org::openapitools::server::model::AdCommon_quiz_pin_data AdCommon::getQuizPinData() const
{
    return m_Quiz_pin_data;
}
void AdCommon::setQuizPinData(org::openapitools::server::model::AdCommon_quiz_pin_data const& value)
{
