...
public:
    ...
    bool operator==(const LeadSubscriptionPostParamsCreate& rhs) const;
    bool operator!=(const LeadSubscriptionPostParamsCreate& rhs) const;
    ...
    /// 
    /// </summary>
    org::openapitools::server::model::LeadSubscriptionPostParamsCreate_allOf_partner_metadata getPartnerMetadata() const;
    void setPartnerMetadata(org::openapitools::server::model::LeadSubscriptionPostParamsCreate_allOf_partner_metadata const& value);
    ...
    friend  void to_json(nlohmann::json& j, const LeadSubscriptionPostParamsCreate& o);
    friend  void from_json(const nlohmann::json& j, LeadSubscriptionPostParamsCreate& o);
protected:
    ...
    org::openapitools::server::model::LeadSubscriptionPostParamsCreate_allOf_partner_metadata m_Partner_metadata;
