...
public:
    ...
    /// </summary>
    org::openapitools::server::model::PartnerMetadata getPartnerMetadata() const;
    void setPartnerMetadata(org::openapitools::server::model::PartnerMetadata const& value);
...
protected:
    ...
    org::openapitools::server::model::PartnerMetadata m_Partner_metadata;
