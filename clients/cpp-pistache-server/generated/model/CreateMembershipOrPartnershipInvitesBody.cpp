...
org::openapitools::server::model::BusinessRoleForInvite CreateMembershipOrPartnershipInvitesBody::getBusinessRole() const
{
    return m_Business_role;
}
void CreateMembershipOrPartnershipInvitesBody::setBusinessRole(org::openapitools::server::model::BusinessRoleForInvite const& value)
{
