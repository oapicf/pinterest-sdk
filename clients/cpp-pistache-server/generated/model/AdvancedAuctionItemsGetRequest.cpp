...
bool AdvancedAuctionItemsGetRequest::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    /* Items */ {
        const std::vector<org::openapitools::server::model::AdvancedAuctionKey>& value = m_Items;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const org::openapitools::server::model::AdvancedAuctionKey& value : value)
            { 
...
std::vector<org::openapitools::server::model::AdvancedAuctionKey> AdvancedAuctionItemsGetRequest::getItems() const
{
    return m_Items;
}
void AdvancedAuctionItemsGetRequest::setItems(std::vector<org::openapitools::server::model::AdvancedAuctionKey> const& value)
{
    m_Items = value;
}
