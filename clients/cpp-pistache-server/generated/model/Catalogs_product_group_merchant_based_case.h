...
#ifndef Catalogs_product_group_merchant_based_case_H_
#define Catalogs_product_group_merchant_based_case_H_
...
/// 
/// </summary>
class  Catalogs_product_group_merchant_based_case
{
public:
    Catalogs_product_group_merchant_based_case();
    virtual ~Catalogs_product_group_merchant_based_case() = default;
    ...
    bool operator==(const Catalogs_product_group_merchant_based_case& rhs) const;
    bool operator!=(const Catalogs_product_group_merchant_based_case& rhs) const;

    /////////////////////////////////////////////
    /// Catalogs_product_group_merchant_based_case members
    ...
    friend void to_json(nlohmann::json& j, const Catalogs_product_group_merchant_based_case& o);
    friend void from_json(const nlohmann::json& j, Catalogs_product_group_merchant_based_case& o);
protected:
    std::string m_Id;
...
#endif /* Catalogs_product_group_merchant_based_case_H_ */
