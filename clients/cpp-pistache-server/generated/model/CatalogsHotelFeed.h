...
public:
    ...
    bool operator==(const CatalogsHotelFeed& rhs) const;
    bool operator!=(const CatalogsHotelFeed& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const CatalogsHotelFeed& o);
    friend  void from_json(const nlohmann::json& j, CatalogsHotelFeed& o);
protected:
