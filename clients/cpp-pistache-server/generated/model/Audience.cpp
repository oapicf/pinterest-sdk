...
org::openapitools::server::model::PinnerListType Audience::getAudienceType() const
{
    return m_Audience_type;
}
void Audience::setAudienceType(org::openapitools::server::model::PinnerListType const& value)
{
...
void Audience::setCreatedByCompanyName(std::string const& value)
{
...
void Audience::setIsNca(bool const value)
{
    m_Is_nca = value;
    m_Is_ncaIsSet = true;
}
...
org::openapitools::server::model::AudienceStatus Audience::getStatus() const
{
    return m_Status;
}
void Audience::setStatus(org::openapitools::server::model::AudienceStatus const& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}
