...
#ifndef AdGroupCreateCreate_H_
#define AdGroupCreateCreate_H_
...
public:
    ...
    bool operator==(const AdGroupCreateCreate& rhs) const;
    bool operator!=(const AdGroupCreateCreate& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const AdGroupCreateCreate& o);
    friend  void from_json(const nlohmann::json& j, AdGroupCreateCreate& o);
protected:
