...
public:
    ...
    bool operator==(const CatalogsReportFeedIngestionStats& rhs) const;
    bool operator!=(const CatalogsReportFeedIngestionStats& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const CatalogsReportFeedIngestionStats& o);
    friend  void from_json(const nlohmann::json& j, CatalogsReportFeedIngestionStats& o);
protected:
