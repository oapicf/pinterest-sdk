...
public:
    ...
    /// </summary>
    std::vector<org::openapitools::server::model::PinAnalyticsDailyMetrics> getDailyMetrics() const;
    void setDailyMetrics(std::vector<org::openapitools::server::model::PinAnalyticsDailyMetrics> const& value);
...
protected:
    std::vector<org::openapitools::server::model::PinAnalyticsDailyMetrics> m_Daily_metrics;
