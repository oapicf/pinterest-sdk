...
public:
    ...
    bool operator==(const CatalogsHotelReportParametersReport& rhs) const;
    bool operator!=(const CatalogsHotelReportParametersReport& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const CatalogsHotelReportParametersReport& o);
    friend  void from_json(const nlohmann::json& j, CatalogsHotelReportParametersReport& o);
protected:
