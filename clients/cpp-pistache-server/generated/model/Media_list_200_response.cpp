...
bool Media_list_200_response::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    /* Items */ {
        const std::vector<org::openapitools::server::model::Media>& value = m_Items;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const org::openapitools::server::model::Media& value : value)
            { 
...
std::vector<org::openapitools::server::model::Media> Media_list_200_response::getItems() const
{
    return m_Items;
}
void Media_list_200_response::setItems(std::vector<org::openapitools::server::model::Media> const& value)
{
    m_Items = value;
}
