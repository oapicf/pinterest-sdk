...
org::openapitools::server::model::PinMediaWithImage_allOf_images PinMediaWithVideo::getImages() const
{
    return m_Images;
}
void PinMediaWithVideo::setImages(org::openapitools::server::model::PinMediaWithImage_allOf_images const& value)
{
    m_Images = value;
    m_ImagesIsSet = true;
}
