...
org::openapitools::server::model::ImageSize PinMediaWithVideo::getImages() const
{
    return m_Images;
}
void PinMediaWithVideo::setImages(org::openapitools::server::model::ImageSize const& value)
{
    m_Images = value;
    m_ImagesIsSet = true;
}
...
void PinMediaWithVideo::setVideoUrl(std::string const& value)
{
    m_Video_url = value;
...
void PinMediaWithVideo::setVideoUrlHls(std::string const& value)
{
