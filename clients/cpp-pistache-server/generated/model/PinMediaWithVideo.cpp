...
org::openapitools::server::model::ImageMetadata_images PinMediaWithVideo::getImages() const
{
    return m_Images;
}
void PinMediaWithVideo::setImages(org::openapitools::server::model::ImageMetadata_images const& value)
{
    m_Images = value;
    m_ImagesIsSet = true;
}
