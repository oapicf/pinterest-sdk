...
#ifndef TargetingSpec_SHOPPING_RETARGETING_1_inner_H_
#define TargetingSpec_SHOPPING_RETARGETING_1_inner_H_
...
public:
    ...
    virtual ~TargetingSpec_SHOPPING_RETARGETING_1_inner() = default;
    ...
    bool operator==(const TargetingSpec_SHOPPING_RETARGETING_1_inner& rhs) const;
    bool operator!=(const TargetingSpec_SHOPPING_RETARGETING_1_inner& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const TargetingSpec_SHOPPING_RETARGETING_1_inner& o);
    friend  void from_json(const nlohmann::json& j, TargetingSpec_SHOPPING_RETARGETING_1_inner& o);
protected:
...
#endif /* TargetingSpec_SHOPPING_RETARGETING_1_inner_H_ */
