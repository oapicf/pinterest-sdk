...
org::openapitools::server::model::PartnerMetadata LeadSubscriptionPostParamsCreate::getPartnerMetadata() const
{
    return m_Partner_metadata;
}
void LeadSubscriptionPostParamsCreate::setPartnerMetadata(org::openapitools::server::model::PartnerMetadata const& value)
{
