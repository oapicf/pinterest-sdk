...
void AdGroupCommon_tracking_urls::validate() const
{
...
bool AdGroupCommon_tracking_urls::validate(std::stringstream& msg) const
{
    return validate(msg, "");
}

bool AdGroupCommon_tracking_urls::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "AdGroupCommon_tracking_urls" : pathPrefix;
...
bool AdGroupCommon_tracking_urls::operator==(const AdGroupCommon_tracking_urls& rhs) const
{
    return
...
void to_json(nlohmann::json& j, const AdGroupCommon_tracking_urls& o)
{
    j = nlohmann::json();
...
void from_json(const nlohmann::json& j, AdGroupCommon_tracking_urls& o)
{
...
std::vector<std::string> AdGroupCommon_tracking_urls::getImpression() const
{
    return m_Impression;
}
void AdGroupCommon_tracking_urls::setImpression(std::vector<std::string> const& value)
{
    m_Impression = value;
    m_ImpressionIsSet = true;
}
bool AdGroupCommon_tracking_urls::impressionIsSet() const
{
    return m_ImpressionIsSet;
}
void AdGroupCommon_tracking_urls::unsetImpression()
{
    m_ImpressionIsSet = false;
}
std::vector<std::string> AdGroupCommon_tracking_urls::getClick() const
{
    return m_Click;
}
void AdGroupCommon_tracking_urls::setClick(std::vector<std::string> const& value)
{
    m_Click = value;
    m_ClickIsSet = true;
}
bool AdGroupCommon_tracking_urls::clickIsSet() const
{
    return m_ClickIsSet;
}
void AdGroupCommon_tracking_urls::unsetClick()
{
    m_ClickIsSet = false;
}
std::vector<std::string> AdGroupCommon_tracking_urls::getEngagement() const
{
    return m_Engagement;
}
void AdGroupCommon_tracking_urls::setEngagement(std::vector<std::string> const& value)
{
    m_Engagement = value;
    m_EngagementIsSet = true;
}
bool AdGroupCommon_tracking_urls::engagementIsSet() const
{
    return m_EngagementIsSet;
}
void AdGroupCommon_tracking_urls::unsetEngagement()
{
    m_EngagementIsSet = false;
}
std::vector<std::string> AdGroupCommon_tracking_urls::getBuyableButton() const
{
    return m_Buyable_button;
}
void AdGroupCommon_tracking_urls::setBuyableButton(std::vector<std::string> const& value)
{
    m_Buyable_button = value;
    m_Buyable_buttonIsSet = true;
}
bool AdGroupCommon_tracking_urls::buyableButtonIsSet() const
{
    return m_Buyable_buttonIsSet;
}
void AdGroupCommon_tracking_urls::unsetBuyable_button()
{
    m_Buyable_buttonIsSet = false;
}
std::vector<std::string> AdGroupCommon_tracking_urls::getAudienceVerification() const
{
    return m_Audience_verification;
}
void AdGroupCommon_tracking_urls::setAudienceVerification(std::vector<std::string> const& value)
{
    m_Audience_verification = value;
    m_Audience_verificationIsSet = true;
}
bool AdGroupCommon_tracking_urls::audienceVerificationIsSet() const
{
    return m_Audience_verificationIsSet;
}
void AdGroupCommon_tracking_urls::unsetAudience_verification()
{
    m_Audience_verificationIsSet = false;
}
