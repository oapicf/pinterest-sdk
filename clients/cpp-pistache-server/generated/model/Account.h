...
public:
    ...
    /// Type of account
    /// </summary>
    org::openapitools::server::model::UserAccountType getAccountType() const;
    void setAccountType(org::openapitools::server::model::UserAccountType const& value);
...
protected:
    std::string m_About;
    bool m_AboutIsSet;
    org::openapitools::server::model::UserAccountType m_Account_type;
