...
org::openapitools::server::model::CatalogsProductGroupFilterOperatorTypeCriteria CustomLabel3Filter::getCUSTOMLABEL3() const
{
    return m_CUSTOM_LABEL_3;
}
void CustomLabel3Filter::setCUSTOMLABEL3(org::openapitools::server::model::CatalogsProductGroupFilterOperatorTypeCriteria const& value)
{
