...
public:
    ...
    bool operator==(const SSIOInsertionOrderUpdate& rhs) const;
    bool operator!=(const SSIOInsertionOrderUpdate& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const SSIOInsertionOrderUpdate& o);
    friend  void from_json(const nlohmann::json& j, SSIOInsertionOrderUpdate& o);
protected:
