...
public:
    ...
    bool operator==(const CatalogsProductGroupsCreateRequestSchema& rhs) const;
    bool operator!=(const CatalogsProductGroupsCreateRequestSchema& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const CatalogsProductGroupsCreateRequestSchema& o);
    friend  void from_json(const nlohmann::json& j, CatalogsProductGroupsCreateRequestSchema& o);
protected:
