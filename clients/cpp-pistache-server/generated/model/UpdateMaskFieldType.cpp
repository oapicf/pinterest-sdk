...
UpdateMaskFieldType::~UpdateMaskFieldType() = default;
...
void from_json(const nlohmann::json& j, UpdateMaskFieldType& o)
{
    ...
    if (s == "ad_link") {
    ...
    else if (s == "custom_number_0") {
     o.setValue(UpdateMaskFieldType::eUpdateMaskFieldType::CUSTOM_NUMBER_0);
    } 
    else if (s == "custom_number_1") {
     o.setValue(UpdateMaskFieldType::eUpdateMaskFieldType::CUSTOM_NUMBER_1);
    } 
    else if (s == "custom_number_2") {
     o.setValue(UpdateMaskFieldType::eUpdateMaskFieldType::CUSTOM_NUMBER_2);
    } 
    else if (s == "custom_number_3") {
     o.setValue(UpdateMaskFieldType::eUpdateMaskFieldType::CUSTOM_NUMBER_3);
    } 
    else if (s == "custom_number_4") {
     o.setValue(UpdateMaskFieldType::eUpdateMaskFieldType::CUSTOM_NUMBER_4);
    } 
     ...
     o.setValue(UpdateMaskFieldType::eUpdateMaskFieldType::PROMOTION_ID);
    }  else {
     std::stringstream ss;
