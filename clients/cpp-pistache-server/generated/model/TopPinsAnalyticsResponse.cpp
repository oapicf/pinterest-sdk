...
bool TopPinsAnalyticsResponse::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    if (pinsIsSet())
    {
        const std::vector<org::openapitools::server::model::TopPinsAnalyticsResponsePinsItems>& value = m_Pins;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const org::openapitools::server::model::TopPinsAnalyticsResponsePinsItems& value : value)
            { 
...
org::openapitools::server::model::TopPinsAnalyticsResponseDateAvailability TopPinsAnalyticsResponse::getDateAvailability() const
{
    return m_Date_availability;
}
void TopPinsAnalyticsResponse::setDateAvailability(org::openapitools::server::model::TopPinsAnalyticsResponseDateAvailability const& value)
{
...
std::vector<org::openapitools::server::model::TopPinsAnalyticsResponsePinsItems> TopPinsAnalyticsResponse::getPins() const
{
    return m_Pins;
}
void TopPinsAnalyticsResponse::setPins(std::vector<org::openapitools::server::model::TopPinsAnalyticsResponsePinsItems> const& value)
{
    m_Pins = value;
    m_PinsIsSet = true;
}
...
org::openapitools::server::model::TopPinsSortBy TopPinsAnalyticsResponse::getSortBy() const
{
    return m_Sort_by;
}
void TopPinsAnalyticsResponse::setSortBy(org::openapitools::server::model::TopPinsSortBy const& value)
{
    m_Sort_by = value;
    m_Sort_byIsSet = true;
}
