...
public:
    ...
    bool operator==(const AdGroupTrackingURLs& rhs) const;
    bool operator!=(const AdGroupTrackingURLs& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const AdGroupTrackingURLs& o);
    friend  void from_json(const nlohmann::json& j, AdGroupTrackingURLs& o);
protected:
