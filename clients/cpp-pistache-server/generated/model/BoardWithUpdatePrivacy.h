...
public:
    ...
    bool operator==(const BoardWithUpdatePrivacy& rhs) const;
    bool operator!=(const BoardWithUpdatePrivacy& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const BoardWithUpdatePrivacy& o);
    friend  void from_json(const nlohmann::json& j, BoardWithUpdatePrivacy& o);
protected:
