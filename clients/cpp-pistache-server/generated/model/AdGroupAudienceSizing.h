...
public:
    ...
    bool operator==(const AdGroupAudienceSizing& rhs) const;
    bool operator!=(const AdGroupAudienceSizing& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const AdGroupAudienceSizing& o);
    friend  void from_json(const nlohmann::json& j, AdGroupAudienceSizing& o);
protected:
