...
#ifndef Catalogs_product_groups_create_201_response_H_
#define Catalogs_product_groups_create_201_response_H_
...
public:
    ...
    virtual ~Catalogs_product_groups_create_201_response() = default;
    ...
    bool operator==(const Catalogs_product_groups_create_201_response& rhs) const;
    bool operator!=(const Catalogs_product_groups_create_201_response& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const Catalogs_product_groups_create_201_response& o);
    friend  void from_json(const nlohmann::json& j, Catalogs_product_groups_create_201_response& o);
protected:
    std::string m_Id;
...
#endif /* Catalogs_product_groups_create_201_response_H_ */
