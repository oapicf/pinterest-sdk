...
org::openapitools::server::model::EventData AudienceRule::getEventData() const
{
    return m_Event_data;
}
void AudienceRule::setEventData(org::openapitools::server::model::EventData const& value)
{
    m_Event_data = value;
