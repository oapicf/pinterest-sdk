...
public:
    ...
    bool operator==(const BoardMedia& rhs) const;
    bool operator!=(const BoardMedia& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const BoardMedia& o);
    friend  void from_json(const nlohmann::json& j, BoardMedia& o);
protected:
