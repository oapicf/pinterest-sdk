...
public:
    ...
    bool operator==(const CatalogsRetailFeedsUpdateRequest& rhs) const;
    bool operator!=(const CatalogsRetailFeedsUpdateRequest& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const CatalogsRetailFeedsUpdateRequest& o);
    friend  void from_json(const nlohmann::json& j, CatalogsRetailFeedsUpdateRequest& o);
protected:
