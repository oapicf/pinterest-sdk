...
org::openapitools::server::model::CatalogsProductGroupMultipleStringCriteria GenderFilter::getGENDER() const
{
    return m_GENDER;
}
void GenderFilter::setGENDER(org::openapitools::server::model::CatalogsProductGroupMultipleStringCriteria const& value)
{
    m_GENDER = value;
}
