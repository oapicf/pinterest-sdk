...
public:
    ...
    bool operator==(const CatalogsVerticalFeedsCreateRequest& rhs) const;
    bool operator!=(const CatalogsVerticalFeedsCreateRequest& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const CatalogsVerticalFeedsCreateRequest& o);
    friend  void from_json(const nlohmann::json& j, CatalogsVerticalFeedsCreateRequest& o);
protected:
