...
public:
    ...
    /// 
    /// </summary>
    org::openapitools::server::model::ConversionTagType getConversionEvent() const;
    void setConversionEvent(org::openapitools::server::model::ConversionTagType const& value);
    ...
    void setReportingConversionEvent(std::string const& value);
...
protected:
    ...
    org::openapitools::server::model::ConversionTagType m_Conversion_event;
