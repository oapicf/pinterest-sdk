...
public:
    ...
    bool operator==(const Page_visit_conversion_tags_get_200_response& rhs) const;
    bool operator!=(const Page_visit_conversion_tags_get_200_response& rhs) const;
    ...
    /// 
    /// </summary>
    std::vector<org::openapitools::server::model::ConversionEventResponse> getItems() const;
    void setItems(std::vector<org::openapitools::server::model::ConversionEventResponse> const& value);

    friend  void to_json(nlohmann::json& j, const Page_visit_conversion_tags_get_200_response& o);
    friend  void from_json(const nlohmann::json& j, Page_visit_conversion_tags_get_200_response& o);
protected:
    std::string m_Bookmark;
    bool m_BookmarkIsSet;
    std::vector<org::openapitools::server::model::ConversionEventResponse> m_Items;
