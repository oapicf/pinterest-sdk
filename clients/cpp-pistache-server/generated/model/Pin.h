...
public:
    ...
    /// </summary>
    org::openapitools::server::model::Object getPinMetrics() const;
    void setPinMetrics(org::openapitools::server::model::Object const& value);
...
protected:
    ...
    std::string m_Note;
    bool m_NoteIsSet;
    org::openapitools::server::model::Object m_Pin_metrics;
