...
public:
    ...
    bool operator==(const CampaignCreateCommon& rhs) const;
    bool operator!=(const CampaignCreateCommon& rhs) const;
    ...
    friend void to_json(nlohmann::json& j, const CampaignCreateCommon& o);
    friend void from_json(const nlohmann::json& j, CampaignCreateCommon& o);
protected:
