...
void CampaignResponse::setIsAutomatedCampaign(bool const value)
{
...
org::openapitools::server::model::TrackingUrls CampaignResponse::getTrackingUrls() const
{
    return m_Tracking_urls;
}
void CampaignResponse::setTrackingUrls(org::openapitools::server::model::TrackingUrls const& value)
{
...
org::openapitools::server::model::CampaignBidOptions CampaignResponse::getBidOptions() const
{
    return m_Bid_options;
}
void CampaignResponse::setBidOptions(org::openapitools::server::model::CampaignBidOptions const& value)
{
    m_Bid_options = value;
...
void CampaignResponse::setIsPerformancePlus(bool const value)
{
