...
void CatalogsVerticalBatchRequest::setCatalogType(std::string const& value)
{
...
std::vector<org::openapitools::server::model::CatalogsCreativeAssetsBatchItem> CatalogsVerticalBatchRequest::getItems() const
{
    return m_Items;
}
void CatalogsVerticalBatchRequest::setItems(std::vector<org::openapitools::server::model::CatalogsCreativeAssetsBatchItem> const& value)
{
    m_Items = value;
}
