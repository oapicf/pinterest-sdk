...
org::openapitools::server::model::QuizPinData AdCreateRequest::getQuizPinData() const
{
    return m_Quiz_pin_data;
}
void AdCreateRequest::setQuizPinData(org::openapitools::server::model::QuizPinData const& value)
{
...
org::openapitools::server::model::TrackingUrls AdCreateRequest::getTrackingUrls() const
{
    return m_Tracking_urls;
}
void AdCreateRequest::setTrackingUrls(org::openapitools::server::model::TrackingUrls const& value)
{
