...
void AdCreateRequest::setCustomizableCtaType(std::string const& value)
{
...
org::openapitools::server::model::AdCommon_quiz_pin_data AdCreateRequest::getQuizPinData() const
{
    return m_Quiz_pin_data;
}
void AdCreateRequest::setQuizPinData(org::openapitools::server::model::AdCommon_quiz_pin_data const& value)
{
