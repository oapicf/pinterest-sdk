...
org::openapitools::server::model::CustomizableCTAType AdCreateRequest::getCustomizableCtaType() const
{
    return m_Customizable_cta_type;
}
void AdCreateRequest::setCustomizableCtaType(org::openapitools::server::model::CustomizableCTAType const& value)
{
...
org::openapitools::server::model::DisclosureType AdCreateRequest::getDisclosureType() const
{
    return m_Disclosure_type;
}
void AdCreateRequest::setDisclosureType(org::openapitools::server::model::DisclosureType const& value)
{
...
void AdCreateRequest::setDisclosureUrl(std::string const& value)
{
...
org::openapitools::server::model::GridClickType AdCreateRequest::getGridClickType() const
{
    return m_Grid_click_type;
}
void AdCreateRequest::setGridClickType(org::openapitools::server::model::GridClickType const& value)
{
...
void AdCreateRequest::setIsCarting(bool const value)
{
    m_Is_carting = value;
...
void AdCreateRequest::setLeadFormId(std::string const& value)
{
...
void AdCreateRequest::setQuizPinData(nlohmann::json const& value)
{
...
void AdCreateRequest::setTrackingUrls(nlohmann::json const& value)
{
