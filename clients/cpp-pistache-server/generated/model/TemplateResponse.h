...
public:
    ...
    /// </summary>
    std::vector<org::openapitools::server::model::std::string> getCustomColumnIds() const;
    void setCustomColumnIds(std::vector<org::openapitools::server::model::std::string> const& value);
...
protected:
    ...
    std::vector<org::openapitools::server::model::std::string> m_Custom_column_ids;
