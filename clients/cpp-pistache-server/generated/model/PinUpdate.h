...
public:
    ...
    /// </summary>
    org::openapitools::server::model::AiDisclosuresUpdate getAiDisclosures() const;
    void setAiDisclosures(org::openapitools::server::model::AiDisclosuresUpdate const& value);
...
protected:
    org::openapitools::server::model::AiDisclosuresUpdate m_Ai_disclosures;
