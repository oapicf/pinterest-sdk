...
public:
    ...
    bool operator==(const ReportingColumn& rhs) const;
    bool operator!=(const ReportingColumn& rhs) const;

    /////////////////////////////////////////////
    /// ReportingColumn members

    ReportingColumn::eReportingColumn getValue() const;
    void setValue(ReportingColumn::eReportingColumn value);
    
    friend  void to_json(nlohmann::json& j, const ReportingColumn& o);
    friend  void from_json(const nlohmann::json& j, ReportingColumn& o);
protected:
    ReportingColumn::eReportingColumn m_value = ReportingColumn::eReportingColumn::INVALID_VALUE_OPENAPI_GENERATED;
};
