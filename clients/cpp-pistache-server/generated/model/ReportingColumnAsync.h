...
public:
    ...
    bool operator==(const ReportingColumnAsync& rhs) const;
    bool operator!=(const ReportingColumnAsync& rhs) const;

    /////////////////////////////////////////////
    /// ReportingColumnAsync members

    ReportingColumnAsync::eReportingColumnAsync getValue() const;
    void setValue(ReportingColumnAsync::eReportingColumnAsync value);
    
    friend  void to_json(nlohmann::json& j, const ReportingColumnAsync& o);
    friend  void from_json(const nlohmann::json& j, ReportingColumnAsync& o);
protected:
    ReportingColumnAsync::eReportingColumnAsync m_value = ReportingColumnAsync::eReportingColumnAsync::INVALID_VALUE_OPENAPI_GENERATED;
};
