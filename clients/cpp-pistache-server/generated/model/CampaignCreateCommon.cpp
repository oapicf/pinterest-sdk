...
void CampaignCreateCommon::setStatus(EntityStatus const& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}
...
void CampaignCreateCommon::setIsCampaignBudgetOptimization(bool const value)
{
...
org::openapitools::server::model::ObjectiveType CampaignCreateCommon::getObjectiveType() const
{
    return m_Objective_type;
}
void CampaignCreateCommon::setObjectiveType(org::openapitools::server::model::ObjectiveType const& value)
{
    m_Objective_type = value;
    m_Objective_typeIsSet = true;
}
bool CampaignCreateCommon::objectiveTypeIsSet() const
{
    return m_Objective_typeIsSet;
}
void CampaignCreateCommon::unsetObjective_type()
{
    m_Objective_typeIsSet = false;
}
