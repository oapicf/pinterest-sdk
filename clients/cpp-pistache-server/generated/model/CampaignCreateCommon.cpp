...
org::openapitools::server::model::TrackingUrls CampaignCreateCommon::getTrackingUrls() const
{
    return m_Tracking_urls;
}
void CampaignCreateCommon::setTrackingUrls(org::openapitools::server::model::TrackingUrls const& value)
{
