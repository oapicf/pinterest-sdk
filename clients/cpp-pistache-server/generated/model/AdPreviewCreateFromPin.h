...
public:
    ...
    bool operator==(const AdPreviewCreateFromPin& rhs) const;
    bool operator!=(const AdPreviewCreateFromPin& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const AdPreviewCreateFromPin& o);
    friend  void from_json(const nlohmann::json& j, AdPreviewCreateFromPin& o);
protected:
    std::string m_Pin_id;
