...
public:
    ...
    bool operator==(const ReportingColumnSync& rhs) const;
    bool operator!=(const ReportingColumnSync& rhs) const;

    /////////////////////////////////////////////
    /// ReportingColumnSync members

    ReportingColumnSync::eReportingColumnSync getValue() const;
    void setValue(ReportingColumnSync::eReportingColumnSync value);
    
    friend  void to_json(nlohmann::json& j, const ReportingColumnSync& o);
    friend  void from_json(const nlohmann::json& j, ReportingColumnSync& o);
protected:
    ReportingColumnSync::eReportingColumnSync m_value = ReportingColumnSync::eReportingColumnSync::INVALID_VALUE_OPENAPI_GENERATED;
};
