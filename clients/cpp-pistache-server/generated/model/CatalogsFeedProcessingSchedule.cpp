...
org::openapitools::server::model::CatalogsFeedProcessingScheduleTimezone CatalogsFeedProcessingSchedule::getTimezone() const
{
    return m_Timezone;
}
void CatalogsFeedProcessingSchedule::setTimezone(org::openapitools::server::model::CatalogsFeedProcessingScheduleTimezone const& value)
{
    m_Timezone = value;
}
