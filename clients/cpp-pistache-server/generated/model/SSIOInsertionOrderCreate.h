...
public:
    ...
    bool operator==(const SSIOInsertionOrderCreate& rhs) const;
    bool operator!=(const SSIOInsertionOrderCreate& rhs) const;
    ...
    /// </summary>
    org::openapitools::server::model::SSIOOrderLineType getOrderLineType() const;
    void setOrderLineType(org::openapitools::server::model::SSIOOrderLineType const& value);
    /// <summary>
    /// The order name
    /// </summary>
    ...
    friend  void to_json(nlohmann::json& j, const SSIOInsertionOrderCreate& o);
    friend  void from_json(const nlohmann::json& j, SSIOInsertionOrderCreate& o);
protected:
    ...
    org::openapitools::server::model::SSIOOrderLineType m_Order_line_type;
