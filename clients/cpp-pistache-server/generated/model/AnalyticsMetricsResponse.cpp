...
bool AnalyticsMetricsResponse::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    {
        const std::vector<AnalyticsMetricsResponse_daily_metrics>& value = m_Daily_metrics;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const AnalyticsMetricsResponse_daily_metrics& value : value)
            { 
...
std::vector<AnalyticsMetricsResponse_daily_metrics> AnalyticsMetricsResponse::getDailyMetrics() const
{
    return m_Daily_metrics;
}
void AnalyticsMetricsResponse::setDailyMetrics(std::vector<AnalyticsMetricsResponse_daily_metrics> const& value)
{
