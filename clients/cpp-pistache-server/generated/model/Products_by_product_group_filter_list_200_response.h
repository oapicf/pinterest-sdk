...
#ifndef Products_by_product_group_filter_list_200_response_H_
#define Products_by_product_group_filter_list_200_response_H_
...
public:
    ...
    virtual ~Products_by_product_group_filter_list_200_response() = default;
    ...
    bool operator==(const Products_by_product_group_filter_list_200_response& rhs) const;
    bool operator!=(const Products_by_product_group_filter_list_200_response& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const Products_by_product_group_filter_list_200_response& o);
    friend  void from_json(const nlohmann::json& j, Products_by_product_group_filter_list_200_response& o);
protected:
...
#endif /* Products_by_product_group_filter_list_200_response_H_ */
