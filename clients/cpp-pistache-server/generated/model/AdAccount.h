...
public:
    ...
    /// Ad account owner
    /// </summary>
    org::openapitools::server::model::AdAccountOwner getOwner() const;
    void setOwner(org::openapitools::server::model::AdAccountOwner const& value);
...
protected:
    ...
    std::string m_Name;
    bool m_NameIsSet;
    org::openapitools::server::model::AdAccountOwner m_Owner;
    bool m_OwnerIsSet;
