...
public:
    ...
    /// 
    /// </summary>
    std::vector<org::openapitools::server::model::ProductGroupPromotionCreateRequestElement> getProductGroupPromotion() const;
    void setProductGroupPromotion(std::vector<org::openapitools::server::model::ProductGroupPromotionCreateRequestElement> const& value);
...
protected:
    ...
    std::vector<org::openapitools::server::model::ProductGroupPromotionCreateRequestElement> m_Product_group_promotion;
