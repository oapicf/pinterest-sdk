...
org::openapitools::server::model::Board_owner PinCreate::getBoardOwner() const
{
    return m_Board_owner;
}
void PinCreate::setBoardOwner(org::openapitools::server::model::Board_owner const& value)
{
    m_Board_owner = value;
...
org::openapitools::server::model::SummaryPin_media PinCreate::getMedia() const
{
    return m_Media;
}
void PinCreate::setMedia(org::openapitools::server::model::SummaryPin_media const& value)
{
    m_Media = value;
    m_MediaIsSet = true;
}
