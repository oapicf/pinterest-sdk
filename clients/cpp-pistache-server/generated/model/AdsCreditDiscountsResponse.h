...
public:
    ...
    /// </summary>
    org::openapitools::server::model::AdsCreditDiscountType getDiscountType() const;
    void setDiscountType(org::openapitools::server::model::AdsCreditDiscountType const& value);
...
protected:
    ...
    org::openapitools::server::model::AdsCreditDiscountType m_DiscountType;
