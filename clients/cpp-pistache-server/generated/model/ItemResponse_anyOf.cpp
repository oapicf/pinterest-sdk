...
org::openapitools::server::model::CatalogsCreativeAssetsAttributes ItemResponse_anyOf::getAttributes() const
{
    return m_Attributes;
}
void ItemResponse_anyOf::setAttributes(org::openapitools::server::model::CatalogsCreativeAssetsAttributes const& value)
{
    m_Attributes = value;
...
void ItemResponse_anyOf::setCreativeAssetsId(std::string const& value)
{
    m_Creative_assets_id = value;
    m_Creative_assets_idIsSet = true;
}
bool ItemResponse_anyOf::creativeAssetsIdIsSet() const
{
    return m_Creative_assets_idIsSet;
}
void ItemResponse_anyOf::unsetCreative_assets_id()
{
    m_Creative_assets_idIsSet = false;
}
