...
org::openapitools::server::model::BidFloorObjectiveType BidFloorSpec::getObjectiveType() const
{
    return m_Objective_type;
}
void BidFloorSpec::setObjectiveType(org::openapitools::server::model::BidFloorObjectiveType const& value)
{
