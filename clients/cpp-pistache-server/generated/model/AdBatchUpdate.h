...
public:
    ...
    bool operator==(const AdBatchUpdate& rhs) const;
    bool operator!=(const AdBatchUpdate& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const AdBatchUpdate& o);
    friend  void from_json(const nlohmann::json& j, AdBatchUpdate& o);
protected:
