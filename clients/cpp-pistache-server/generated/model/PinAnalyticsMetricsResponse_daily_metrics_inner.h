...
public:
    ...
    bool operator==(const PinAnalyticsMetricsResponse_daily_metrics_inner& rhs) const;
    bool operator!=(const PinAnalyticsMetricsResponse_daily_metrics_inner& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const PinAnalyticsMetricsResponse_daily_metrics_inner& o);
    friend  void from_json(const nlohmann::json& j, PinAnalyticsMetricsResponse_daily_metrics_inner& o);
protected:
