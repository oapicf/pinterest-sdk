...
void from_json(const nlohmann::json& j, CreativeType& o)
{
    ...
    if (s == "REGULAR") {
     ...
     o.setValue(CreativeType::eCreativeType::COLLECTION);
    } 
    else if (s == "IDEA") {
     o.setValue(CreativeType::eCreativeType::IDEA);
    } 
    else if (s == "SHOWCASE") {
     o.setValue(CreativeType::eCreativeType::SHOWCASE);
    } 
    else if (s == "QUIZ") {
     o.setValue(CreativeType::eCreativeType::QUIZ);
    } 
    else if (s == "COLLAGE") {
     o.setValue(CreativeType::eCreativeType::COLLAGE);
    } 
    else if (s == "MAX_WIDTH_REGULAR_COLLECTION") {
     o.setValue(CreativeType::eCreativeType::MAX_WIDTH_REGULAR_COLLECTION);
    } 
    else if (s == "MAX_WIDTH_VIDEO_COLLECTION") {
     o.setValue(CreativeType::eCreativeType::MAX_WIDTH_VIDEO_COLLECTION);
    } 
    else if (s == "APP") {
     o.setValue(CreativeType::eCreativeType::APP);
    }  else {
     std::stringstream ss;
