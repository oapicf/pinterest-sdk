...
public:
    ...
    bool operator==(const TrackingUrls& rhs) const;
    bool operator!=(const TrackingUrls& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const TrackingUrls& o);
    friend  void from_json(const nlohmann::json& j, TrackingUrls& o);
protected:
