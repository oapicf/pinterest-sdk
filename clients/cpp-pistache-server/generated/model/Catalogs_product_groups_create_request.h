...
#ifndef Catalogs_product_groups_create_request_H_
#define Catalogs_product_groups_create_request_H_
...
public:
    ...
    virtual ~Catalogs_product_groups_create_request() = default;
    ...
    bool operator==(const Catalogs_product_groups_create_request& rhs) const;
    bool operator!=(const Catalogs_product_groups_create_request& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const Catalogs_product_groups_create_request& o);
    friend  void from_json(const nlohmann::json& j, Catalogs_product_groups_create_request& o);
protected:
    std::string m_Name;
...
#endif /* Catalogs_product_groups_create_request_H_ */
