...
org::openapitools::server::model::CatalogsFeedIngestionDetails Catalogs_feed_processing_result_fields::getIngestionDetails() const
{
    return m_Ingestion_details;
}
void Catalogs_feed_processing_result_fields::setIngestionDetails(org::openapitools::server::model::CatalogsFeedIngestionDetails const& value)
{
    m_Ingestion_details = value;
}
org::openapitools::server::model::CatalogsFeedProcessingStatus Catalogs_feed_processing_result_fields::getStatus() const
{
    return m_Status;
}
void Catalogs_feed_processing_result_fields::setStatus(org::openapitools::server::model::CatalogsFeedProcessingStatus const& value)
{
    m_Status = value;
}
org::openapitools::server::model::CatalogsFeedProductCounts Catalogs_feed_processing_result_fields::getProductCounts() const
{
    return m_Product_counts;
}
void Catalogs_feed_processing_result_fields::setProductCounts(org::openapitools::server::model::CatalogsFeedProductCounts const& value)
{
    m_Product_counts = value;
}
org::openapitools::server::model::CatalogsFeedValidationDetails Catalogs_feed_processing_result_fields::getValidationDetails() const
{
    return m_Validation_details;
}
void Catalogs_feed_processing_result_fields::setValidationDetails(org::openapitools::server::model::CatalogsFeedValidationDetails const& value)
{
