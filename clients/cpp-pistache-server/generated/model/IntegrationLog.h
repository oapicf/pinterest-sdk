...
public:
    ...
    /// Log event type
    /// </summary>
    org::openapitools::server::model::IntegrationLogEventType getEventType() const;
    void setEventType(org::openapitools::server::model::IntegrationLogEventType const& value);
    /// <summary>
    /// 
    /// </summary>
    ...
    /// Log level type
    /// </summary>
    org::openapitools::server::model::IntegrationLogLevel getLogLevel() const;
    void setLogLevel(org::openapitools::server::model::IntegrationLogLevel const& value);
    /// <summary>
    /// 
    /// </summary>
...
protected:
    ...
    bool m_ErrorIsSet;
    org::openapitools::server::model::IntegrationLogEventType m_Event_type;

    std::string m_External_business_id;
    bool m_External_business_idIsSet;
    std::string m_Feed_profile_id;
    bool m_Feed_profile_idIsSet;
    org::openapitools::server::model::IntegrationLogLevel m_Log_level;
