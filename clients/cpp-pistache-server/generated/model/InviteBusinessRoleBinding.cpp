...
org::openapitools::server::model::InviteDataResponse InviteBusinessRoleBinding::getInviteData() const
{
    return m_Invite_data;
}
void InviteBusinessRoleBinding::setInviteData(org::openapitools::server::model::InviteDataResponse const& value)
{
    m_Invite_data = value;
