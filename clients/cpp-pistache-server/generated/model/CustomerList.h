...
public:
    ...
    /// </summary>
    org::openapitools::server::model::CustomerListStatus getStatus() const;
    void setStatus(org::openapitools::server::model::CustomerListStatus const& value);
...
protected:
    ...
    org::openapitools::server::model::CustomerListStatus m_Status;
    bool m_StatusIsSet;
    std::string m_Type;
    bool m_TypeIsSet;
