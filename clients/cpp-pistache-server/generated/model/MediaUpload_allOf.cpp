...
void MediaUpload_allOf::validate() const
{
...
bool MediaUpload_allOf::validate(std::stringstream& msg) const
{
    return validate(msg, "");
}

bool MediaUpload_allOf::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "MediaUpload_allOf" : pathPrefix;

                    
    return success;
}

bool MediaUpload_allOf::operator==(const MediaUpload_allOf& rhs) const
{
    return
...
void to_json(nlohmann::json& j, const MediaUpload_allOf& o)
{
    j = nlohmann::json();
    if(o.mediaIdIsSet())
...
void from_json(const nlohmann::json& j, MediaUpload_allOf& o)
{
...
void MediaUpload_allOf::setMediaId(std::string const& value)
{
    m_Media_id = value;
...
void MediaUpload_allOf::setMediaType(MediaUploadType const& value)
{
    m_Media_type = value;
...
void MediaUpload_allOf::setUploadUrl(std::string const& value)
{
    m_Upload_url = value;
...
org::openapitools::server::model::MediaUpload_allOf_upload_parameters MediaUpload_allOf::getUploadParameters() const
{
    return m_Upload_parameters;
}
void MediaUpload_allOf::setUploadParameters(org::openapitools::server::model::MediaUpload_allOf_upload_parameters const& value)
{
