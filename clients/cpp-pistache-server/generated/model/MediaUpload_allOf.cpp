...
MediaUpload_allOf_upload_parameters MediaUpload_allOf::getUploadParameters() const
{
    return m_Upload_parameters;
}
void MediaUpload_allOf::setUploadParameters(MediaUpload_allOf_upload_parameters const& value)
{
