...
bool AdsAnalyticsCreateAsyncRequest::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    {
        const std::vector<CampaignSummaryStatus>& value = m_Campaign_statuses;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const CampaignSummaryStatus& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
    ...
    {
        const std::vector<ObjectiveType>& value = m_Campaign_objective_types;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const ObjectiveType& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
    ...
    {
        const std::vector<AdGroupSummaryStatus>& value = m_Ad_group_statuses;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const AdGroupSummaryStatus& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
    ...
    if (adStatusesIsSet())
    {
        const std::vector<PinPromotionSummaryStatus>& value = m_Ad_statuses;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const PinPromotionSummaryStatus& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
    ...
    {
        const std::vector<ProductGroupSummaryStatus>& value = m_Product_group_statuses;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const ProductGroupSummaryStatus& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
    ...
    {
        const std::vector<AdsAnalyticsTargetingType>& value = m_Targeting_types;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const AdsAnalyticsTargetingType& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
    ...
    {
        const std::vector<AdsAnalyticsMetricsFilter>& value = m_Metrics_filters;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const AdsAnalyticsMetricsFilter& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
...
void AdsAnalyticsCreateAsyncRequest::setClickWindowDays(ConversionAttributionWindowDays const& value)
{
...
void AdsAnalyticsCreateAsyncRequest::setEngagementWindowDays(ConversionAttributionWindowDays const& value)
{
...
void AdsAnalyticsCreateAsyncRequest::setViewWindowDays(ConversionAttributionWindowDays const& value)
{
...
void AdsAnalyticsCreateAsyncRequest::setAttributionTypes(std::vector<ConversionReportAttributionType> const& value)
{
...
void AdsAnalyticsCreateAsyncRequest::setColumns(std::vector<ReportingColumnAsync> const& value)
{
    m_Columns = value;
}
...
void AdsAnalyticsCreateAsyncRequest::setCampaignStatuses(std::vector<CampaignSummaryStatus> const& value)
{
...
void AdsAnalyticsCreateAsyncRequest::setCampaignObjectiveTypes(std::vector<ObjectiveType> const& value)
{
...
void AdsAnalyticsCreateAsyncRequest::setAdGroupStatuses(std::vector<AdGroupSummaryStatus> const& value)
{
...
void AdsAnalyticsCreateAsyncRequest::setAdStatuses(std::vector<PinPromotionSummaryStatus> const& value)
{
    m_Ad_statuses = value;
...
void AdsAnalyticsCreateAsyncRequest::setProductGroupStatuses(std::vector<ProductGroupSummaryStatus> const& value)
{
...
void AdsAnalyticsCreateAsyncRequest::setTargetingTypes(std::vector<AdsAnalyticsTargetingType> const& value)
{
...
void AdsAnalyticsCreateAsyncRequest::setMetricsFilters(std::vector<AdsAnalyticsMetricsFilter> const& value)
{
