...
bool AdsAnalyticsCreateAsyncRequest::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    {
        const std::vector<org::openapitools::server::model::AdsAnalyticsCreateAsyncRequest_allOf_custom_conversion_event_metrics>& value = m_Custom_conversion_event_metrics;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const org::openapitools::server::model::AdsAnalyticsCreateAsyncRequest_allOf_custom_conversion_event_metrics& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
...
std::vector<std::string> AdsAnalyticsCreateAsyncRequest::getTargetingTypes() const
{
    return m_Targeting_types;
}
void AdsAnalyticsCreateAsyncRequest::setTargetingTypes(std::vector<std::string> const& value)
{
...
std::vector<org::openapitools::server::model::AdsAnalyticsCreateAsyncRequest_allOf_custom_conversion_event_metrics> AdsAnalyticsCreateAsyncRequest::getCustomConversionEventMetrics() const
{
    return m_Custom_conversion_event_metrics;
}
void AdsAnalyticsCreateAsyncRequest::setCustomConversionEventMetrics(std::vector<org::openapitools::server::model::AdsAnalyticsCreateAsyncRequest_allOf_custom_conversion_event_metrics> const& value)
{
