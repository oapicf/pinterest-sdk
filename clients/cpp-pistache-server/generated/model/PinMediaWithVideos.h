...
public:
    ...
    /// 
    /// </summary>
    std::vector<org::openapitools::server::model::VideoMetadataWithItemType> getItems() const;
    void setItems(std::vector<org::openapitools::server::model::VideoMetadataWithItemType> const& value);
...
protected:
    std::vector<org::openapitools::server::model::VideoMetadataWithItemType> m_Items;
    bool m_ItemsIsSet;
