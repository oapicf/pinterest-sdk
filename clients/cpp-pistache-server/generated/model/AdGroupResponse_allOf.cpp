...
org::openapitools::server::model::AnyType AdGroupResponse_allOf::getDcaAssets() const
{
    return m_Dca_assets;
}
void AdGroupResponse_allOf::setDcaAssets(org::openapitools::server::model::AnyType const& value)
{
    m_Dca_assets = value;
