...
public:
    ...
    bool operator==(const LeadFormUpdateRequest& rhs) const;
    bool operator!=(const LeadFormUpdateRequest& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const LeadFormUpdateRequest& o);
    friend  void from_json(const nlohmann::json& j, LeadFormUpdateRequest& o);
protected:
    std::string m_Name;
    bool m_NameIsSet;
