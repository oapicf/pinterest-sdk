...
public:
    ...
    bool operator==(const GetMMMReportResponseData& rhs) const;
    bool operator!=(const GetMMMReportResponseData& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const GetMMMReportResponseData& o);
    friend  void from_json(const nlohmann::json& j, GetMMMReportResponseData& o);
protected:
