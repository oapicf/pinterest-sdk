...
public:
    ...
    bool operator==(const LeadSubscriptionPostParams& rhs) const;
    bool operator!=(const LeadSubscriptionPostParams& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const LeadSubscriptionPostParams& o);
    friend  void from_json(const nlohmann::json& j, LeadSubscriptionPostParams& o);
protected:
