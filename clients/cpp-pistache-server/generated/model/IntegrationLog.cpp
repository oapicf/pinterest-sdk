...
bool IntegrationLog::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    if (messageIsSet())
    {
        ...
        {
            success = false;
            msg << currentValuePath << ": must be at most 8192 characters long;";
        }
...
org::openapitools::server::model::IntegrationLogEventType IntegrationLog::getEventType() const
{
    return m_Event_type;
}
void IntegrationLog::setEventType(org::openapitools::server::model::IntegrationLogEventType const& value)
{
    m_Event_type = value;
}
...
org::openapitools::server::model::IntegrationLogLevel IntegrationLog::getLogLevel() const
{
    return m_Log_level;
}
void IntegrationLog::setLogLevel(org::openapitools::server::model::IntegrationLogLevel const& value)
{
    m_Log_level = value;
}
