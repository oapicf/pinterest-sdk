...
public:
    ...
    bool operator==(const ProductGroupPromotionResponseElement& rhs) const;
    bool operator!=(const ProductGroupPromotionResponseElement& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const ProductGroupPromotionResponseElement& o);
    friend  void from_json(const nlohmann::json& j, ProductGroupPromotionResponseElement& o);
protected:
    std::string m_Id;
    bool m_IdIsSet;
