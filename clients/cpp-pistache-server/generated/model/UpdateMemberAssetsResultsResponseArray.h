...
public:
    ...
    /// </summary>
    std::vector<org::openapitools::server::model::UpdateMemberAssetResultItem> getItems() const;
    void setItems(std::vector<org::openapitools::server::model::UpdateMemberAssetResultItem> const& value);
...
protected:
    std::vector<org::openapitools::server::model::UpdateMemberAssetResultItem> m_Items;
    bool m_ItemsIsSet;
