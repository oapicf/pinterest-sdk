...
void AdResponse::setCreativeType(std::string const& value)
{
...
void AdResponse::setStatus(EntityStatus const& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}
...
void AdResponse::setTrackingUrls(TrackingUrls const& value)
{
