...
org::openapitools::server::model::CustomizableCTAType AdResponse::getCustomizableCtaType() const
{
    return m_Customizable_cta_type;
}
void AdResponse::setCustomizableCtaType(org::openapitools::server::model::CustomizableCTAType const& value)
{
...
org::openapitools::server::model::DisclosureType AdResponse::getDisclosureType() const
{
    return m_Disclosure_type;
}
void AdResponse::setDisclosureType(org::openapitools::server::model::DisclosureType const& value)
{
...
std::string AdResponse::getDisclosureUrl() const
{
    return m_Disclosure_url;
}
void AdResponse::setDisclosureUrl(std::string const& value)
{
...
org::openapitools::server::model::QuizPinData AdResponse::getQuizPinData() const
{
    return m_Quiz_pin_data;
}
void AdResponse::setQuizPinData(org::openapitools::server::model::QuizPinData const& value)
{
...
org::openapitools::server::model::TrackingUrls AdResponse::getTrackingUrls() const
{
    return m_Tracking_urls;
}
void AdResponse::setTrackingUrls(org::openapitools::server::model::TrackingUrls const& value)
{
