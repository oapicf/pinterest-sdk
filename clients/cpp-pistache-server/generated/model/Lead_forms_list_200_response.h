...
public:
    ...
    /// 
    /// </summary>
    std::vector<org::openapitools::server::model::LeadFormResponse> getItems() const;
    void setItems(std::vector<org::openapitools::server::model::LeadFormResponse> const& value);
    /// <summary>
    /// 
    /// </summary>
...
protected:
    std::vector<org::openapitools::server::model::LeadFormResponse> m_Items;
