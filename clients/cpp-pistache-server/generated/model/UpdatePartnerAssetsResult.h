...
public:
    ...
    bool operator==(const UpdatePartnerAssetsResult& rhs) const;
    bool operator!=(const UpdatePartnerAssetsResult& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const UpdatePartnerAssetsResult& o);
    friend  void from_json(const nlohmann::json& j, UpdatePartnerAssetsResult& o);
protected:
