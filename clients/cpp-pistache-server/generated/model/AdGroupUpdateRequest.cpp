...
std::map<std::string, std::vector<std::string>> AdGroupUpdateRequest::getTargetingSpec() const
{
    return m_Targeting_spec;
}
void AdGroupUpdateRequest::setTargetingSpec(std::map<std::string, std::vector<std::string>> const& value)
{
