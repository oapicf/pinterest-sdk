...
void from_json(const nlohmann::json& j, CatalogsProductGroup& o)
{
    ...
    if(j.find("feed_id") != j.end())
    {
        j.at("feed_id").get_to(o.m_Feed_id);
        o.m_Feed_idIsSet = true;
    } 
...
CatalogsProductGroupFilters CatalogsProductGroup::getFilters() const
{
    return m_Filters;
}
void CatalogsProductGroup::setFilters(CatalogsProductGroupFilters const& value)
{
    m_Filters = value;
}
CatalogsProductGroupType CatalogsProductGroup::getType() const
{
    return m_Type;
}
void CatalogsProductGroup::setType(CatalogsProductGroupType const& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}
...
CatalogsProductGroupStatus CatalogsProductGroup::getStatus() const
{
    return m_Status;
}
void CatalogsProductGroup::setStatus(CatalogsProductGroupStatus const& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}
