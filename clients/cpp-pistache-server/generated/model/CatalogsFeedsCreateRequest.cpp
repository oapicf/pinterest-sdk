...
org::openapitools::server::model::CatalogsCreativeAssetsFeedsCreateRequest_default_locale CatalogsFeedsCreateRequest::getDefaultLocale() const
{
    return m_Default_locale;
}
void CatalogsFeedsCreateRequest::setDefaultLocale(org::openapitools::server::model::CatalogsCreativeAssetsFeedsCreateRequest_default_locale const& value)
{
...
org::openapitools::server::model::CatalogsStatus CatalogsFeedsCreateRequest::getStatus() const
{
    return m_Status;
}
void CatalogsFeedsCreateRequest::setStatus(org::openapitools::server::model::CatalogsStatus const& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}
