...
public:
    ...
    bool operator==(const AdUpdateRequest& rhs) const;
    bool operator!=(const AdUpdateRequest& rhs) const;
    ...
    /// </summary>
    nlohmann::json getQuizPinData() const;
    void setQuizPinData(nlohmann::json const& value);
    ...
    friend  void to_json(nlohmann::json& j, const AdUpdateRequest& o);
    friend  void from_json(const nlohmann::json& j, AdUpdateRequest& o);
protected:
    std::string m_Id;
