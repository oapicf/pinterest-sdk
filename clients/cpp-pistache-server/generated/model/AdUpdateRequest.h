...
public:
    ...
    /// 
    /// </summary>
    org::openapitools::server::model::AdCommon_quiz_pin_data getQuizPinData() const;
    void setQuizPinData(org::openapitools::server::model::AdCommon_quiz_pin_data const& value);
...
protected:
    ...
    org::openapitools::server::model::AdCommon_quiz_pin_data m_Quiz_pin_data;
