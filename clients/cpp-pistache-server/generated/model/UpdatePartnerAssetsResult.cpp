...
org::openapitools::server::model::AssetTypeResponse UpdatePartnerAssetsResult::getAssetType() const
{
    return m_Asset_type;
}
void UpdatePartnerAssetsResult::setAssetType(org::openapitools::server::model::AssetTypeResponse const& value)
{
    m_Asset_type = value;
