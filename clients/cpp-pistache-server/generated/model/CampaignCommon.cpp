...
org::openapitools::server::model::CampaignSummaryStatus CampaignCommon::getSummaryStatus() const
{
    return m_Summary_status;
}
void CampaignCommon::setSummaryStatus(org::openapitools::server::model::CampaignSummaryStatus const& value)
{
    m_Summary_status = value;
    m_Summary_statusIsSet = true;
}
bool CampaignCommon::summaryStatusIsSet() const
{
    return m_Summary_statusIsSet;
}
void CampaignCommon::unsetSummary_status()
{
    m_Summary_statusIsSet = false;
}
