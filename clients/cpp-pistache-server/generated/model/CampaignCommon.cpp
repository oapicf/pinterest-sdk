...
void CampaignCommon::setIsAutomatedCampaign(bool const value)
{
...
void CampaignCommon::setIsFlexibleDailyBudgets(bool const value)
{
...
org::openapitools::server::model::TrackingUrls CampaignCommon::getTrackingUrls() const
{
    return m_Tracking_urls;
}
void CampaignCommon::setTrackingUrls(org::openapitools::server::model::TrackingUrls const& value)
{
