...
public:
    ...
    /// 
    /// </summary>
    org::openapitools::server::model::CatalogsFeedIngestionWarnings getWarnings() const;
    void setWarnings(org::openapitools::server::model::CatalogsFeedIngestionWarnings const& value);
...
protected:
    ...
    org::openapitools::server::model::CatalogsFeedIngestionWarnings m_Warnings;
