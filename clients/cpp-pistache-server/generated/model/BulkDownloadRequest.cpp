...
bool BulkDownloadRequest::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    if (entityTypesIsSet())
    {
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const BulkEntityType& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
                        
        success = value.validate(msg, currentValuePath + ".entityTypes") && success;
...
void BulkDownloadRequest::setOutputFormat(BulkOutputFormat const& value)
{
