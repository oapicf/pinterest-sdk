...
bool BusinessMemberAssetsSummary::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    if (adAccountsIsSet())
    {
        const std::vector<org::openapitools::server::model::AssetIdWithPermissions>& value = m_Ad_accounts;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const org::openapitools::server::model::AssetIdWithPermissions& value : value)
            { 
    ...
    if (profilesIsSet())
    {
        const std::vector<org::openapitools::server::model::AssetIdWithPermissions>& value = m_Profiles;
...
std::vector<org::openapitools::server::model::AssetIdWithPermissions> BusinessMemberAssetsSummary::getAdAccounts() const
{
    return m_Ad_accounts;
}
void BusinessMemberAssetsSummary::setAdAccounts(std::vector<org::openapitools::server::model::AssetIdWithPermissions> const& value)
{
    m_Ad_accounts = value;
...
std::vector<org::openapitools::server::model::AssetIdWithPermissions> BusinessMemberAssetsSummary::getProfiles() const
{
    return m_Profiles;
}
void BusinessMemberAssetsSummary::setProfiles(std::vector<org::openapitools::server::model::AssetIdWithPermissions> const& value)
{
    m_Profiles = value;
