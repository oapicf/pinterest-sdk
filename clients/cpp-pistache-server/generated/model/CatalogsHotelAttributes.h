...
public:
    ...
    bool operator==(const CatalogsHotelAttributes& rhs) const;
    bool operator!=(const CatalogsHotelAttributes& rhs) const;
    ...
    /// </summary>
    org::openapitools::server::model::CatalogsHotelMainImage getMainImage() const;
    void setMainImage(org::openapitools::server::model::CatalogsHotelMainImage const& value);
    bool mainImageIsSet() const;
    void unsetMain_image();

    friend  void to_json(nlohmann::json& j, const CatalogsHotelAttributes& o);
    friend  void from_json(const nlohmann::json& j, CatalogsHotelAttributes& o);
protected:
    ...
    org::openapitools::server::model::CatalogsHotelMainImage m_Main_image;
