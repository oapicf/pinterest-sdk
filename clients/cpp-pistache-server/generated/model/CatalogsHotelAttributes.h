...
public:
    ...
    /// 
    /// </summary>
    org::openapitools::server::model::CatalogsHotelAttributes_allOf_main_image getMainImage() const;
    void setMainImage(org::openapitools::server::model::CatalogsHotelAttributes_allOf_main_image const& value);
...
protected:
    ...
    org::openapitools::server::model::CatalogsHotelAttributes_allOf_main_image m_Main_image;
