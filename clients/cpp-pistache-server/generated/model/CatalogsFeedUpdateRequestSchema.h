...
public:
    ...
    bool operator==(const CatalogsFeedUpdateRequestSchema& rhs) const;
    bool operator!=(const CatalogsFeedUpdateRequestSchema& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const CatalogsFeedUpdateRequestSchema& o);
    friend  void from_json(const nlohmann::json& j, CatalogsFeedUpdateRequestSchema& o);
protected:
