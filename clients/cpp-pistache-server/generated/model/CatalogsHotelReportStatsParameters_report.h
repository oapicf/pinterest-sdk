...
public:
    ...
    bool operator==(const CatalogsHotelReportStatsParameters_report& rhs) const;
    bool operator!=(const CatalogsHotelReportStatsParameters_report& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const CatalogsHotelReportStatsParameters_report& o);
    friend  void from_json(const nlohmann::json& j, CatalogsHotelReportStatsParameters_report& o);
protected:
