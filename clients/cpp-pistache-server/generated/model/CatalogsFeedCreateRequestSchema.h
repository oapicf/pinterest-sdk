...
public:
    ...
    bool operator==(const CatalogsFeedCreateRequestSchema& rhs) const;
    bool operator!=(const CatalogsFeedCreateRequestSchema& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const CatalogsFeedCreateRequestSchema& o);
    friend  void from_json(const nlohmann::json& j, CatalogsFeedCreateRequestSchema& o);
protected:
