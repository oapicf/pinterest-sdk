...
public:
    ...
    bool operator==(const CampaignCreateItem& rhs) const;
    bool operator!=(const CampaignCreateItem& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const CampaignCreateItem& o);
    friend  void from_json(const nlohmann::json& j, CampaignCreateItem& o);
protected:
