...
org::openapitools::server::model::AdsCreditDiscountType AdsCreditDiscountsResponse::getDiscountType() const
{
    return m_DiscountType;
}
void AdsCreditDiscountsResponse::setDiscountType(org::openapitools::server::model::AdsCreditDiscountType const& value)
{
