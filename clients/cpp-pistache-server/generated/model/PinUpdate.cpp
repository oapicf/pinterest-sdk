...
bool PinUpdate::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    {
        const std::vector<org::openapitools::server::model::CarouselSlot>& value = m_Carousel_slots;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const org::openapitools::server::model::CarouselSlot& value : value)
            { 
...
org::openapitools::server::model::AiDisclosuresUpdate PinUpdate::getAiDisclosures() const
{
    return m_Ai_disclosures;
}
void PinUpdate::setAiDisclosures(org::openapitools::server::model::AiDisclosuresUpdate const& value)
{
...
std::vector<org::openapitools::server::model::CarouselSlot> PinUpdate::getCarouselSlots() const
{
    return m_Carousel_slots;
}
void PinUpdate::setCarouselSlots(std::vector<org::openapitools::server::model::CarouselSlot> const& value)
{
