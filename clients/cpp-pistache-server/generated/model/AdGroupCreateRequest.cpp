...
org::openapitools::server::model::BidStrategyType AdGroupCreateRequest::getBidStrategyType() const
{
    return m_Bid_strategy_type;
}
void AdGroupCreateRequest::setBidStrategyType(org::openapitools::server::model::BidStrategyType const& value)
{
...
void AdGroupCreateRequest::setOptimizationGoalMetadata(nlohmann::json const& value)
{
...
void AdGroupCreateRequest::setPromotionIds(std::vector<std::string> const& value)
{
...
void AdGroupCreateRequest::setTrackingUrls(nlohmann::json const& value)
{
