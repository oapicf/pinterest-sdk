...
org::openapitools::server::model::AdGroupCommon_optimization_goal_metadata AdGroupCreateRequest::getOptimizationGoalMetadata() const
{
    return m_Optimization_goal_metadata;
}
void AdGroupCreateRequest::setOptimizationGoalMetadata(org::openapitools::server::model::AdGroupCommon_optimization_goal_metadata const& value)
{
...
org::openapitools::server::model::AdGroupCommon_tracking_urls AdGroupCreateRequest::getTrackingUrls() const
{
    return m_Tracking_urls;
}
void AdGroupCreateRequest::setTrackingUrls(org::openapitools::server::model::AdGroupCommon_tracking_urls const& value)
{
