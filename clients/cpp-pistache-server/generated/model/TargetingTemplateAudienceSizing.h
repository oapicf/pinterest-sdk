...
public:
    ...
    /// 
    /// </summary>
    org::openapitools::server::model::TargetingTemplateAudienceSizingReachEstimate getReachEstimate() const;
    void setReachEstimate(org::openapitools::server::model::TargetingTemplateAudienceSizingReachEstimate const& value);
...
protected:
    org::openapitools::server::model::TargetingTemplateAudienceSizingReachEstimate m_Reach_estimate;
