...
void AdCreateRequest_inner::validate() const
{
...
bool AdCreateRequest_inner::validate(std::stringstream& msg) const
{
    return validate(msg, "");
}

bool AdCreateRequest_inner::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "AdCreateRequest_inner" : pathPrefix;
...
bool AdCreateRequest_inner::operator==(const AdCreateRequest_inner& rhs) const
{
    return
...
void to_json(nlohmann::json& j, const AdCreateRequest_inner& o)
{
    j = nlohmann::json();
...
void from_json(const nlohmann::json& j, AdCreateRequest_inner& o)
{
...
std::string AdCreateRequest_inner::getAdGroupId() const
{
    return m_Ad_group_id;
}
void AdCreateRequest_inner::setAdGroupId(std::string const& value)
{
    m_Ad_group_id = value;
}
std::string AdCreateRequest_inner::getAndroidDeepLink() const
{
    return m_Android_deep_link;
}
void AdCreateRequest_inner::setAndroidDeepLink(std::string const& value)
{
...
std::vector<std::string> AdCreateRequest_inner::getCarouselAndroidDeepLinks() const
{
    return m_Carousel_android_deep_links;
}
void AdCreateRequest_inner::setCarouselAndroidDeepLinks(std::vector<std::string> const& value)
{
...
std::vector<std::string> AdCreateRequest_inner::getCarouselDestinationUrls() const
{
    return m_Carousel_destination_urls;
}
void AdCreateRequest_inner::setCarouselDestinationUrls(std::vector<std::string> const& value)
{
...
std::vector<std::string> AdCreateRequest_inner::getCarouselIosDeepLinks() const
{
    return m_Carousel_ios_deep_links;
}
void AdCreateRequest_inner::setCarouselIosDeepLinks(std::vector<std::string> const& value)
{
...
std::string AdCreateRequest_inner::getClickTrackingUrl() const
{
    return m_Click_tracking_url;
}
void AdCreateRequest_inner::setClickTrackingUrl(std::string const& value)
{
...
org::openapitools::server::model::CreativeType AdCreateRequest_inner::getCreativeType() const
{
    return m_Creative_type;
}
void AdCreateRequest_inner::setCreativeType(org::openapitools::server::model::CreativeType const& value)
{
    m_Creative_type = value;
}
std::string AdCreateRequest_inner::getDestinationUrl() const
{
    return m_Destination_url;
}
void AdCreateRequest_inner::setDestinationUrl(std::string const& value)
{
...
std::string AdCreateRequest_inner::getIosDeepLink() const
{
    return m_Ios_deep_link;
}
void AdCreateRequest_inner::setIosDeepLink(std::string const& value)
{
...
void AdCreateRequest_inner::setIsPinDeleted(bool const value)
{
...
void AdCreateRequest_inner::setIsRemovable(bool const value)
{
...
std::string AdCreateRequest_inner::getName() const
{
    return m_Name;
}
void AdCreateRequest_inner::setName(std::string const& value)
{
    m_Name = value;
    m_NameIsSet = true;
}
...
std::string AdCreateRequest_inner::getPinId() const
{
    return m_Pin_id;
}
void AdCreateRequest_inner::setPinId(std::string const& value)
{
    m_Pin_id = value;
}
org::openapitools::server::model::EntityStatus AdCreateRequest_inner::getStatus() const
{
    return m_Status;
}
void AdCreateRequest_inner::setStatus(org::openapitools::server::model::EntityStatus const& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}
...
org::openapitools::server::model::AdCommon_tracking_urls AdCreateRequest_inner::getTrackingUrls() const
{
    return m_Tracking_urls;
}
void AdCreateRequest_inner::setTrackingUrls(org::openapitools::server::model::AdCommon_tracking_urls const& value)
{
...
std::string AdCreateRequest_inner::getViewTrackingUrl() const
{
    return m_View_tracking_url;
}
void AdCreateRequest_inner::setViewTrackingUrl(std::string const& value)
{
