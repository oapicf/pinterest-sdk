...
public:
    ...
    /// 
    /// </summary>
    org::openapitools::server::model::BusinessRoleForInvite getBusinessRole() const;
    void setBusinessRole(org::openapitools::server::model::BusinessRoleForInvite const& value);
    /// <summary>
    /// 
    /// </summary>
...
protected:
    org::openapitools::server::model::BusinessRoleForInvite m_Business_role;
