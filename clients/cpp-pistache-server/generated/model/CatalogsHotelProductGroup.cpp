...
org::openapitools::server::model::CatalogsHotelProductGroupType CatalogsHotelProductGroup::getType() const
{
    return m_Type;
}
void CatalogsHotelProductGroup::setType(org::openapitools::server::model::CatalogsHotelProductGroupType const& value)
{
    m_Type = value;
}
