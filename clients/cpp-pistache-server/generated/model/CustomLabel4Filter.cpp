...
org::openapitools::server::model::CatalogsProductGroupFilterOperatorTypeCriteria CustomLabel4Filter::getCUSTOMLABEL4() const
{
    return m_CUSTOM_LABEL_4;
}
void CustomLabel4Filter::setCUSTOMLABEL4(org::openapitools::server::model::CatalogsProductGroupFilterOperatorTypeCriteria const& value)
{
