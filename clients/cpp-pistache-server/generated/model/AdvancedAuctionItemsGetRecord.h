...
public:
    ...
    bool operator==(const AdvancedAuctionItemsGetRecord& rhs) const;
    bool operator!=(const AdvancedAuctionItemsGetRecord& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const AdvancedAuctionItemsGetRecord& o);
    friend  void from_json(const nlohmann::json& j, AdvancedAuctionItemsGetRecord& o);
protected:
