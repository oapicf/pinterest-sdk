...
public:
    ...
    bool operator==(const ItemAttributesRequestImageLink& rhs) const;
    bool operator!=(const ItemAttributesRequestImageLink& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const ItemAttributesRequestImageLink& o);
    friend  void from_json(const nlohmann::json& j, ItemAttributesRequestImageLink& o);
protected:
