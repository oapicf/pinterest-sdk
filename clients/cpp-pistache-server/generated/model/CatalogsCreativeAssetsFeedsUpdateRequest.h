...
public:
    ...
    bool operator==(const CatalogsCreativeAssetsFeedsUpdateRequest& rhs) const;
    bool operator!=(const CatalogsCreativeAssetsFeedsUpdateRequest& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const CatalogsCreativeAssetsFeedsUpdateRequest& o);
    friend  void from_json(const nlohmann::json& j, CatalogsCreativeAssetsFeedsUpdateRequest& o);
protected:
