...
public:
    ...
    /// 
    /// </summary>
    std::vector<org::openapitools::server::model::Campaign> getItems() const;
    void setItems(std::vector<org::openapitools::server::model::Campaign> const& value);
...
protected:
    ...
    std::vector<org::openapitools::server::model::Campaign> m_Items;
