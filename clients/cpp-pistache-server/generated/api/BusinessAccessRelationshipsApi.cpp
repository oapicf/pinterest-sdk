...
void BusinessAccessRelationshipsApi::brand_accounts_create_handler(const Pistache::Rest::Request& request, Pistache::Http::ResponseWriter response) {
    try {
        ...
        try {
            nlohmann::json::parse(request.body()).get_to(brandAccountsCreateRequest);
            brandAccountsCreateRequest.validate();
        } catch (std::exception& e) {
...
#define HTTP_BEARER_AUTH_DEFINED 0
            ...
            this->brand_accounts_create(businessHierarchyId, brandAccountsCreateRequest, response);
...
void BusinessAccessRelationshipsApi::brand_accounts_update_handler(const Pistache::Rest::Request& request, Pistache::Http::ResponseWriter response) {
    try {
        ...
        try {
            nlohmann::json::parse(request.body()).get_to(brandAccountsUpdateRequest);
            brandAccountsUpdateRequest.validate();
        } catch (std::exception& e) {
            this->handleParsingException(e, response);
            return;
        }
...
#define HTTP_BEARER_AUTH_DEFINED 0
            ...
            this->brand_accounts_update(businessHierarchyId, brandAccountId, brandAccountsUpdateRequest, response);
            } catch (Pistache::Http::HttpError &e) {
                response.send(static_cast<Pistache::Http::Code>(e.code()), e.what());
                return;
            } catch (std::exception &e) {
...
void BusinessAccessRelationshipsApi::system_user_update_handler(const Pistache::Rest::Request& request, Pistache::Http::ResponseWriter response) {
    try {
        ...
        try {
            nlohmann::json::parse(request.body()).get_to(systemUserUpdateRequest);
            systemUserUpdateRequest.validate();
        } catch (std::exception& e) {
            this->handleParsingException(e, response);
            return;
        }
...
#define HTTP_BEARER_AUTH_DEFINED 0
            ...
            this->system_user_update(businessId, systemUserId, systemUserUpdateRequest, response);
            } catch (Pistache::Http::HttpError &e) {
                response.send(static_cast<Pistache::Http::Code>(e.code()), e.what());
                return;
            } catch (std::exception &e) {
