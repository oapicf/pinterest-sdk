...
private:
    ...
    virtual void events_create(const HttpBearerToken &accessToken,  const std::string &adAccountId, const org::openapitools::server::model::ConversionEvents &conversionEvents, const std::optional<bool> &test, Pistache::Http::ResponseWriter &response) = 0;
