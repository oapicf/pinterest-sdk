...
private:
    ...
    /// </remarks>
    /// <param name="pinFilter">The filter to apply to the pins (optional, default to &quot;&quot;)</param>
    /// <param name="pinMetrics">Specify whether to return 90d and lifetime Pin metrics. Total comments and total reactions are only available with lifetime Pin metrics. If Pin was created before &#x60;2023-03-20&#x60; lifetime metrics will only be available for Video and Idea Pin formats. Lifetime metrics are available for all Pin formats since then. (optional, default to false)</param>
    ...
    virtual void pins_list( const std::optional<std::string> &pinFilter, const std::optional<bool> &pinMetrics, const std::optional<bool> &includeProtectedPins, const std::optional<std::string> &pinType, const std::optional<std::vector<org::openapitools::server::model::CreativeType>> &creativeTypes, const std::optional<std::string> &adAccountId, const std::optional<std::string> &bookmark, const std::optional<int32_t> &pageSize, Pistache::Http::ResponseWriter &response) = 0;
    /// <summary>
    /// Save Pin
    /// </summary>
    /// <remarks>
