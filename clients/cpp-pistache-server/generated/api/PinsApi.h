...
private:
    ...
    virtual void pins_save(const std::string &pinId, const org::openapitools::server::model::Pins_save_request &pinsSaveRequest, Pistache::Http::ResponseWriter &response) = 0;
