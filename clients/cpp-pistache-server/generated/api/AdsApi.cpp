...
void AdsApi::setupRoutes() {
    ...
    Routes::Post(*router, base + "/ad_accounts/:ad_account_id/campaign_ad_preview", Routes::bind(&AdsApi::campaign_ad_preview_create_handler, this));
    Routes::Delete(*router, base + "/ad_accounts/:ad_account_id/campaign_ad_preview", Routes::bind(&AdsApi::campaign_ad_preview_delete_handler, this));
    Routes::Get(*router, base + "/ad_accounts/:ad_account_id/campaign_ad_preview", Routes::bind(&AdsApi::campaign_ad_preview_read_handler, this));
...
#define HTTP_BEARER_AUTH_DEFINED 0
#endif
#define REST_PATH "/ad_accounts/:ad_account_id/ad_previews" 
...
void AdsApi::ad_targeting_analytics_get_handler(const Pistache::Rest::Request& request, Pistache::Http::ResponseWriter response) {
    try {
        ...
        std::optional<ConversionAttributionWindowDays> clickWindowDays;
        if (clickWindowDaysQuery.has_value()) {
            ConversionAttributionWindowDays valueQuery_instance;
        ...
        std::optional<ConversionAttributionWindowDays> engagementWindowDays;
        ...
        std::optional<ConversionAttributionWindowDays> viewWindowDays;
        ...
        std::optional<ConversionReportTimeType> conversionReportTime;
        if (conversionReportTimeQuery.has_value()) {
            ConversionReportTimeType valueQuery_instance;
...
#define HTTP_BEARER_AUTH_DEFINED 0
            ...
            this->ad_targeting_analytics_get(adAccountId, adIds, startDate, endDate, targetingTypes, columns, granularity, clickWindowDays, engagementWindowDays, viewWindowDays, conversionReportTime, attributionTypes, reportingTimezone, sortColumns, sortAscending, response);
            } catch (Pistache::Http::HttpError &e) {
                response.send(static_cast<Pistache::Http::Code>(e.code()), e.what());
                return;
            } catch (std::exception &e) {
...
#define HTTP_BEARER_AUTH_DEFINED 0
#endif
#define REST_PATH "/ad_accounts/:ad_account_id/ads/targeting_analytics" 
    static_assert(HTTP_BASIC_AUTH_DEFINED + HTTP_BEARER_AUTH_DEFINED < 2, "Path '" REST_PATH "' has more than one security scheme specified, and the Pistache server generator does not support that.");
#undef REST_PATH
#ifdef HTTP_BEARER_AUTH_DEFINED
#undef HTTP_BEARER_AUTH_DEFINED
...
#define HTTP_BEARER_AUTH_DEFINED 0
            ...
            this->ads_analytics(startDate, endDate, columns, granularity, adAccountId, pinIds, adIds, clickWindowDays, engagementWindowDays, viewWindowDays, conversionReportTime, campaignIds, reportingTimezone, response);
            } catch (Pistache::Http::HttpError &e) {
                response.send(static_cast<Pistache::Http::Code>(e.code()), e.what());
                return;
            } catch (std::exception &e) {
...
#define HTTP_BEARER_AUTH_DEFINED 0
#endif
#define REST_PATH "/ad_accounts/:ad_account_id/ads/analytics" 
    static_assert(HTTP_BASIC_AUTH_DEFINED + HTTP_BEARER_AUTH_DEFINED < 2, "Path '" REST_PATH "' has more than one security scheme specified, and the Pistache server generator does not support that.");
#undef REST_PATH
#ifdef HTTP_BEARER_AUTH_DEFINED
#undef HTTP_BEARER_AUTH_DEFINED
...
void AdsApi::ads_create_handler(const Pistache::Rest::Request& request, Pistache::Http::ResponseWriter response) {
    try {
        ...
        // Getting the body param
                std::vector<AdCreate> adCreate;
        
        
    

        try {
            nlohmann::json::parse(request.body()).get_to(adCreate);
            for (const auto& validationParam : adCreate) 
...
#define HTTP_BEARER_AUTH_DEFINED 0
            ...
            this->ads_create(adAccountId, adCreate, response);
            } catch (Pistache::Http::HttpError &e) {
                response.send(static_cast<Pistache::Http::Code>(e.code()), e.what());
                return;
            } catch (std::exception &e) {
...
#define HTTP_BEARER_AUTH_DEFINED 0
#endif
#define REST_PATH "/ad_accounts/:ad_account_id/ads" 
    static_assert(HTTP_BASIC_AUTH_DEFINED + HTTP_BEARER_AUTH_DEFINED < 2, "Path '" REST_PATH "' has more than one security scheme specified, and the Pistache server generator does not support that.");
#undef REST_PATH
#ifdef HTTP_BEARER_AUTH_DEFINED
#undef HTTP_BEARER_AUTH_DEFINED
...
#define HTTP_BEARER_AUTH_DEFINED 0
            ...
            this->ads_get(adId, adAccountId, response);
            } catch (Pistache::Http::HttpError &e) {
                response.send(static_cast<Pistache::Http::Code>(e.code()), e.what());
                return;
            } catch (std::exception &e) {
...
#define HTTP_BEARER_AUTH_DEFINED 0
#endif
#define REST_PATH "/ad_accounts/:ad_account_id/ads/:ad_id" 
    static_assert(HTTP_BASIC_AUTH_DEFINED + HTTP_BEARER_AUTH_DEFINED < 2, "Path '" REST_PATH "' has more than one security scheme specified, and the Pistache server generator does not support that.");
#undef REST_PATH
#ifdef HTTP_BEARER_AUTH_DEFINED
#undef HTTP_BEARER_AUTH_DEFINED
...
#define HTTP_BEARER_AUTH_DEFINED 0
            ...
            this->ads_list(adAccountId, bookmark, pageSize, order, campaignIds, adGroupIds, adIds, entityStatuses, response);
            } catch (Pistache::Http::HttpError &e) {
                response.send(static_cast<Pistache::Http::Code>(e.code()), e.what());
                return;
            } catch (std::exception &e) {
...
void AdsApi::ads_update_handler(const Pistache::Rest::Request& request, Pistache::Http::ResponseWriter response) {
    try {
        ...
        // Getting the body param
                std::vector<AdBatchUpdate> adBatchUpdate;
        
        
    

        try {
            nlohmann::json::parse(request.body()).get_to(adBatchUpdate);
            for (const auto& validationParam : adBatchUpdate) 
                validationParam.validate();
        } catch (std::exception& e) {
            this->handleParsingException(e, response);
            return;
...
#define HTTP_BEARER_AUTH_DEFINED 0
            ...
            this->ads_update(adAccountId, adBatchUpdate, response);
            } catch (Pistache::Http::HttpError &e) {
                response.send(static_cast<Pistache::Http::Code>(e.code()), e.what());
                return;
            } catch (std::exception &e) {
...
void AdsApi::campaign_ad_preview_create_handler(const Pistache::Rest::Request& request, Pistache::Http::ResponseWriter response) {
    try {
        ...
        // Getting the body param
                std::vector<CampaignAdPreviewCreate> campaignAdPreviewCreate;
        
        
    

        try {
            nlohmann::json::parse(request.body()).get_to(campaignAdPreviewCreate);
            for (const auto& validationParam : campaignAdPreviewCreate) 
                validationParam.validate();
        } catch (std::exception& e) {
            this->handleParsingException(e, response);
            return;
...
#define HTTP_BEARER_AUTH_DEFINED 0
            ...
            this->campaign_ad_preview_create(adAccountId, campaignAdPreviewCreate, response);
            } catch (Pistache::Http::HttpError &e) {
                response.send(static_cast<Pistache::Http::Code>(e.code()), e.what());
                return;
            } catch (std::exception &e) {
...
#define HTTP_BEARER_AUTH_DEFINED 0
#endif
#define REST_PATH "/ad_accounts/:ad_account_id/campaign_ad_preview" 
    static_assert(HTTP_BASIC_AUTH_DEFINED + HTTP_BEARER_AUTH_DEFINED < 2, "Path '" REST_PATH "' has more than one security scheme specified, and the Pistache server generator does not support that.");
#undef REST_PATH
#ifdef HTTP_BEARER_AUTH_DEFINED
#undef HTTP_BEARER_AUTH_DEFINED
...
void AdsApi::campaign_ad_preview_delete_handler(const Pistache::Rest::Request& request, Pistache::Http::ResponseWriter response) {
    try {
...
#define HTTP_BEARER_AUTH_DEFINED 0
            ...
            this->campaign_ad_preview_delete(adGroupIds, adAccountId, response);
            } catch (Pistache::Http::HttpError &e) {
                response.send(static_cast<Pistache::Http::Code>(e.code()), e.what());
                return;
            } catch (std::exception &e) {
...
void AdsApi::campaign_ad_preview_read_handler(const Pistache::Rest::Request& request, Pistache::Http::ResponseWriter response) {
    try {
...
#define HTTP_BEARER_AUTH_DEFINED 0
            ...
            this->campaign_ad_preview_read(adGroupIds, adAccountId, response);
            } catch (Pistache::Http::HttpError &e) {
                response.send(static_cast<Pistache::Http::Code>(e.code()), e.what());
                return;
            } catch (std::exception &e) {
