...
private:
    ...
    virtual void analytics_create_template_report(const std::string &adAccountId, const std::string &templateId, const std::optional<std::string> &startDate, const std::optional<std::string> &endDate, const std::optional<Granularity> &granularity, Pistache::Http::ResponseWriter &response) = 0;
    /// <summary>
