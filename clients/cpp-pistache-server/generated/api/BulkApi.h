...
private:
    ...
    virtual void bulk_download_create( const std::string &adAccountId, const org::openapitools::server::model::BulkDownloadCreate &bulkDownloadCreate, Pistache::Http::ResponseWriter &response) = 0;
    /// <summary>
