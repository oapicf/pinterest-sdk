...
private:
    ...
    virtual void boards_list_pins( const std::string &boardId, const std::optional<std::string> &bookmark, const std::optional<int32_t> &pageSize, const std::optional<std::vector<org::openapitools::server::model::CreativeType>> &creativeTypes, const std::optional<std::string> &adAccountId, const std::optional<bool> &pinMetrics, Pistache::Http::ResponseWriter &response) = 0;
    /// <summary>
    /// Update board
    /// </summary>
    /// <remarks>
