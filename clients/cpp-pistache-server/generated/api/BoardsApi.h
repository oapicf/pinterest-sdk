...
private:
    ...
    virtual void board_sections_create( const std::string &boardId, const org::openapitools::server::model::BoardSectionCreate &boardSectionCreate, const std::optional<std::string> &adAccountId, Pistache::Http::ResponseWriter &response) = 0;
    /// <summary>
    ...
    /// <param name="adAccountId">Unique identifier of an ad account. (optional, default to &quot;&quot;)</param>
    virtual void board_sections_update( const std::string &boardId, const std::string &sectionId, const org::openapitools::server::model::BoardSectionUpdateWithRequiredBody &boardSectionUpdateWithRequiredBody, const std::optional<std::string> &adAccountId, Pistache::Http::ResponseWriter &response) = 0;
    /// <summary>
    /// Create board
    /// </summary>
    /// <remarks>
    ...
    /// <param name="adAccountId">Unique identifier of an ad account. (optional, default to &quot;&quot;)</param>
    virtual void boards_create( const org::openapitools::server::model::BoardCreate &boardCreate, const std::optional<std::string> &adAccountId, Pistache::Http::ResponseWriter &response) = 0;
    /// <summary>
    /// Delete board
    /// </summary>
    /// <remarks>
    ...
    /// <param name="bookmark">Cursor used to fetch the next page of items (optional, default to &quot;&quot;)</param>
    /// <param name="pageSize">Maximum number of items to include in a single page. See documentation on [Pagination](/docs/reference/pagination/) for more information. (optional, default to 25)</param>
    virtual void boards_list( const std::optional<std::string> &adAccountId, const std::optional<org::openapitools::server::model::BoardPrivacyFilter> &privacy, const std::optional<std::string> &bookmark, const std::optional<int32_t> &pageSize, Pistache::Http::ResponseWriter &response) = 0;
    /// <summary>
    /// List Pins on board
    /// </summary>
    /// <remarks>
    ...
    /// <param name="bookmark">Cursor used to fetch the next page of items (optional, default to &quot;&quot;)</param>
    /// <param name="pageSize">Maximum number of items to include in a single page. See documentation on [Pagination](/docs/reference/pagination/) for more information. (optional, default to 25)</param>
    virtual void boards_list_pins( const std::string &boardId, const std::optional<std::vector<org::openapitools::server::model::CreativeType>> &creativeTypes, const std::optional<std::string> &adAccountId, const std::optional<bool> &pinMetrics, const std::optional<std::string> &bookmark, const std::optional<int32_t> &pageSize, Pistache::Http::ResponseWriter &response) = 0;
    /// <summary>
    /// Update board
    /// </summary>
    /// <remarks>
    ...
    /// <param name="adAccountId">Unique identifier of an ad account. (optional, default to &quot;&quot;)</param>
    virtual void boards_update( const std::string &boardId, const org::openapitools::server::model::BoardWithUpdatePrivacyUpdate &boardWithUpdatePrivacyUpdate, const std::optional<std::string> &adAccountId, Pistache::Http::ResponseWriter &response) = 0;
