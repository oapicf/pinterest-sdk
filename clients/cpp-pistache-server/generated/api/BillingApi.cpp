...
void BillingApi::ads_credit_redeem_handler(const Pistache::Rest::Request& request, Pistache::Http::ResponseWriter response) {
    try {
        ...
        try {
            nlohmann::json::parse(request.body()).get_to(adsCreditRedeemCreate);
            adsCreditRedeemCreate.validate();
        } catch (std::exception& e) {
...
#define HTTP_BEARER_AUTH_DEFINED 0
            ...
            this->ads_credit_redeem(adAccountId, adsCreditRedeemCreate, response);
...
void BillingApi::billing_invoices_get_handler(const Pistache::Rest::Request& request, Pistache::Http::ResponseWriter response) {
    try {
        ...
        std::optional<BillingInvoiceDocumentType> documentType;
        if (documentTypeQuery.has_value()) {
            BillingInvoiceDocumentType valueQuery_instance;
...
#define HTTP_BEARER_AUTH_DEFINED 0
            ...
            this->billing_invoices_get(adAccountId, bookmark, pageSize, order, sort, status, documentType, startDueDate, endDueDate, response);
            } catch (Pistache::Http::HttpError &e) {
                response.send(static_cast<Pistache::Http::Code>(e.code()), e.what());
                return;
            } catch (std::exception &e) {
...
#define HTTP_BEARER_AUTH_DEFINED 0
            ...
            this->billing_profiles_get(isActive, adAccountId, bookmark, pageSize, response);
            } catch (Pistache::Http::HttpError &e) {
                response.send(static_cast<Pistache::Http::Code>(e.code()), e.what());
                return;
            } catch (std::exception &e) {
...
void BillingApi::ssio_insertion_order_create_handler(const Pistache::Rest::Request& request, Pistache::Http::ResponseWriter response) {
    try {
        ...
        try {
            nlohmann::json::parse(request.body()).get_to(sSIOInsertionOrderCreate);
            sSIOInsertionOrderCreate.validate();
        } catch (std::exception& e) {
            this->handleParsingException(e, response);
            return;
        }
...
#define HTTP_BEARER_AUTH_DEFINED 0
            ...
            this->ssio_insertion_order_create(adAccountId, sSIOInsertionOrderCreate, response);
            } catch (Pistache::Http::HttpError &e) {
                response.send(static_cast<Pistache::Http::Code>(e.code()), e.what());
                return;
            } catch (std::exception &e) {
...
void BillingApi::ssio_insertion_order_edit_handler(const Pistache::Rest::Request& request, Pistache::Http::ResponseWriter response) {
    try {
        ...
        try {
            nlohmann::json::parse(request.body()).get_to(sSIOInsertionOrderUpdate);
            sSIOInsertionOrderUpdate.validate();
        } catch (std::exception& e) {
            this->handleParsingException(e, response);
            return;
        }
...
#define HTTP_BEARER_AUTH_DEFINED 0
            ...
            this->ssio_insertion_order_edit(adAccountId, sSIOInsertionOrderUpdate, response);
            } catch (Pistache::Http::HttpError &e) {
                response.send(static_cast<Pistache::Http::Code>(e.code()), e.what());
                return;
            } catch (std::exception &e) {
...
#define HTTP_BEARER_AUTH_DEFINED 0
            ...
            this->ssio_order_lines_get_by_ad_account(adAccountId, pinOrderId, bookmark, pageSize, response);
            } catch (Pistache::Http::HttpError &e) {
                response.send(static_cast<Pistache::Http::Code>(e.code()), e.what());
                return;
            } catch (std::exception &e) {
