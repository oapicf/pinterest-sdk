...
private:
    ...
    /// <param name="adAccountId">Unique identifier of an ad account. (optional, default to &quot;&quot;)</param>
    virtual void catalogs_product_groups_create(const org::openapitools::server::model::Catalogs_product_groups_create_request &catalogsProductGroupsCreateRequest, const std::optional<std::string> &adAccountId, Pistache::Http::ResponseWriter &response) = 0;
    /// <summary>
    ...
    /// <param name="pageSize">Maximum number of items to include in a single page of the response. See documentation on &lt;a href&#x3D;&#39;/docs/getting-started/pagination/&#39;&gt;Pagination&lt;/a&gt; for more information. (optional, default to 25)</param>
    /// <param name="adAccountId">Unique identifier of an ad account. (optional, default to &quot;&quot;)</param>
    virtual void catalogs_product_groups_list(const std::optional<std::string> &feedId, const std::optional<std::string> &catalogId, const std::optional<std::string> &bookmark, const std::optional<int32_t> &pageSize, const std::optional<std::string> &adAccountId, Pistache::Http::ResponseWriter &response) = 0;
    /// <summary>
    ...
    virtual void items_get(const std::optional<std::string> &country, const std::optional<std::string> &language, const std::optional<std::string> &adAccountId, const std::optional<std::vector<std::string>> &itemIds, const org::openapitools::server::model::std::optional<CatalogsItemsFilters> &filters, Pistache::Http::ResponseWriter &response) = 0;
    /// <summary>
