...
const std::string NotificationApi::base = "/v5";
...
void NotificationApi::setupRoutes() {
    ...
    Routes::Post(*router, base + "/notifications", Routes::bind(&NotificationApi::notification_post_handler, this));
...
void NotificationApi::notification_post_handler(const Pistache::Rest::Request& request, Pistache::Http::ResponseWriter response) {
    try {
        ...
        try {
            nlohmann::json::parse(request.body()).get_to(notificationPostRequest);
            notificationPostRequest.validate();
        } catch (std::exception& e) {
...
#define HTTP_BEARER_AUTH_DEFINED 0
            ...
            this->notification_post(notificationPostRequest, response);
...
#define HTTP_BEARER_AUTH_DEFINED 0
#endif
#define REST_PATH "/notifications" 
