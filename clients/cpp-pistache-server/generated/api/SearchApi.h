...
private:
    ...
    virtual void search_user_boards_get( const std::optional<std::string> &adAccountId, const std::optional<std::string> &query, const std::optional<std::string> &bookmark, const std::optional<int32_t> &pageSize, Pistache::Http::ResponseWriter &response) = 0;
    /// <summary>
    /// Search user&#39;s Pins
    /// </summary>
    /// <remarks>
