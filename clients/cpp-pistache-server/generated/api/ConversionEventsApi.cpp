...
void ConversionEventsApi::handleParsingException(const std::exception& ex, Pistache::Http::ResponseWriter &response) const noexcept {
...
void ConversionEventsApi::handleOperationException(const std::exception& ex, Pistache::Http::ResponseWriter &response) const noexcept {
...
void ConversionEventsApi::events_create_handler(const Pistache::Rest::Request& request, Pistache::Http::ResponseWriter response) {
    try {
        ...
        try {
            nlohmann::json::parse(request.body()).get_to(conversionEventsCreate);
            conversionEventsCreate.validate();
        } catch (std::exception& e) {
...
#define HTTP_BEARER_AUTH_DEFINED 1
            ...
            this->events_create(bearerToken,adAccountId, conversionEventsCreate, test, response);
...
#define HTTP_BEARER_AUTH_DEFINED 0
#endif
#define REST_PATH "/ad_accounts/:ad_account_id/events" 
