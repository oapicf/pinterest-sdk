...
private:
    ...
    virtual void audience_insights_get(const std::string &adAccountId, const std::optional<AudienceInsightType> &audienceInsightType, Pistache::Http::ResponseWriter &response) = 0;
