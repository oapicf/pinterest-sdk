...
private:
    ...
    virtual void integrations_commerce_patch( const std::string &externalBusinessId, const org::openapitools::server::model::IntegrationMetadataUpdate &integrationMetadataUpdate, Pistache::Http::ResponseWriter &response) = 0;
    /// <summary>
    ...
    virtual void integrations_commerce_post( const org::openapitools::server::model::IntegrationMetadataCreate &integrationMetadataCreate, Pistache::Http::ResponseWriter &response) = 0;
    /// <summary>
    ...
    virtual void integrations_logs_post( const org::openapitools::server::model::IntegrationLogsRequestCreate &integrationLogsRequestCreate, Pistache::Http::ResponseWriter &response) = 0;
    /// <summary>
