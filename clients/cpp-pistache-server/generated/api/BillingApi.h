...
private:
    ...
    /// <param name="status">Status of billing invoices to filter by (optional, default to &quot;&quot;)</param>
    /// <param name="documentType">Document type of billing invoices to filter by (optional, default to &quot;&quot;)</param>
    ...
    virtual void billing_invoices_get( const std::string &adAccountId, const std::optional<std::string> &bookmark, const std::optional<int32_t> &pageSize, const std::optional<std::string> &sort, const std::optional<std::string> &order, const std::optional<std::string> &status, const std::optional<std::string> &documentType, const std::optional<std::string> &startDueDate, const std::optional<std::string> &endDueDate, Pistache::Http::ResponseWriter &response) = 0;
    /// <summary>
