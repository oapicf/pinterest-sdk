...
private:
    ...
    virtual void boards_user_follows_list( const std::optional<std::string> &adAccountId, const std::optional<bool> &explicitFollowing, const std::optional<std::string> &bookmark, const std::optional<int32_t> &pageSize, Pistache::Http::ResponseWriter &response) = 0;
    /// <summary>
    /// Follow user
    /// </summary>
    /// <remarks>
    ...
    virtual void follow_user_update( const std::string &username, const org::openapitools::server::model::FollowUserCreate &followUserCreate, Pistache::Http::ResponseWriter &response) = 0;
    /// <summary>
    /// List followers
    /// </summary>
    /// <remarks>
    ...
    /// <param name="adAccountId">Unique identifier of an ad account. (optional, default to &quot;&quot;)</param>
    virtual void user_account_analytics( const std::optional<std::string> &startDate, const std::optional<std::string> &endDate, const std::optional<std::string> &fromClaimedContent, const std::optional<std::string> &pinFormat, const std::optional<std::string> &appTypes, const std::optional<std::string> &contentType, const std::optional<std::string> &source, const std::optional<std::vector<org::openapitools::server::model::QuerymetrictypesItems>> &metricTypes, const std::optional<std::string> &splitField, const std::optional<std::string> &adAccountId, Pistache::Http::ResponseWriter &response) = 0;
    /// <summary>
    ...
    /// <param name="adAccountId">Unique identifier of an ad account. (optional, default to &quot;&quot;)</param>
    virtual void user_account_analytics_top_pins( const std::optional<std::string> &startDate, const std::optional<std::string> &endDate, const std::optional<org::openapitools::server::model::TopPinsSortBy> &sortBy, const std::optional<std::string> &fromClaimedContent, const std::optional<std::string> &pinFormat, const std::optional<std::string> &appTypes, const std::optional<std::string> &contentType, const std::optional<std::string> &source, const std::optional<std::vector<org::openapitools::server::model::QuerymetrictypesItems>> &metricTypes, const std::optional<int32_t> &numOfPins, const std::optional<double> &createdInLastNDays, const std::optional<std::string> &adAccountId, Pistache::Http::ResponseWriter &response) = 0;
    /// <summary>
    ...
    /// <param name="createdInLastNDays">Get metrics for pins created in the last \&quot;n\&quot; days. (optional, default to 0.0)</param>
    /// <param name="adAccountId">Unique identifier of an ad account. (optional, default to &quot;&quot;)</param>
    virtual void user_account_analytics_top_video_pins( const std::optional<std::string> &startDate, const std::optional<std::string> &endDate, const std::optional<org::openapitools::server::model::TopVideoPinsSortBy> &sortBy, const std::optional<std::string> &fromClaimedContent, const std::optional<std::string> &pinFormat, const std::optional<std::string> &appTypes, const std::optional<std::string> &contentType, const std::optional<std::string> &source, const std::optional<std::vector<org::openapitools::server::model::QueryvideopinmetrictypesItems>> &metricTypes, const std::optional<int32_t> &numOfPins, const std::optional<double> &createdInLastNDays, const std::optional<std::string> &adAccountId, Pistache::Http::ResponseWriter &response) = 0;
    /// <summary>
    ...
    /// <param name="bookmark">Cursor used to fetch the next page of items (optional, default to &quot;&quot;)</param>
    /// <param name="pageSize">Maximum number of items to include in a single page. See documentation on [Pagination](/docs/reference/pagination/) for more information. (optional, default to 25)</param>
    virtual void user_following_get( const std::optional<std::string> &adAccountId, const std::optional<bool> &explicitFollowing, const std::optional<org::openapitools::server::model::UserFollowingFeedType> &feedType, const std::optional<std::string> &bookmark, const std::optional<int32_t> &pageSize, Pistache::Http::ResponseWriter &response) = 0;
    /// <summary>
    /// Get user websites
    /// </summary>
    /// <remarks>
    ...
    /// <param name="adAccountId">Unique identifier of an ad account. (optional, default to &quot;&quot;)</param>
    virtual void verify_website_update( const org::openapitools::server::model::UserWebsiteCreate &userWebsiteCreate, const std::optional<std::string> &adAccountId, Pistache::Http::ResponseWriter &response) = 0;
    /// <summary>
