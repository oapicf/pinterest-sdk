...
private:
    ...
    virtual void trending_keywords_list(const TrendsSupportedRegion &region, const TrendType &trendType, const std::optional<std::vector<std::string>> &interests, const std::optional<std::vector<std::string>> &genders, const std::optional<std::vector<std::string>> &ages, const std::optional<bool> &normalizeAgainstGroup, const std::optional<int32_t> &limit, Pistache::Http::ResponseWriter &response) = 0;
