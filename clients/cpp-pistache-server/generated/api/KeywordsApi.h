...
private:
    ...
    virtual void keywords_create( const std::string &adAccountId, const org::openapitools::server::model::KeywordsCreate &keywordsCreate, Pistache::Http::ResponseWriter &response) = 0;
    /// <summary>
    /// Get keywords
    /// </summary>
    /// <remarks>
    ...
    virtual void keywords_get( const std::string &adAccountId, const std::optional<std::string> &campaignId, const std::optional<std::string> &adGroupId, const std::optional<std::vector<std::string>> &adGroupIds, const std::optional<std::vector<org::openapitools::server::model::MatchType>> &matchTypes, const std::optional<std::string> &bookmark, const std::optional<int32_t> &pageSize, Pistache::Http::ResponseWriter &response) = 0;
    /// <summary>
    /// Update keywords
    /// </summary>
    /// <remarks>
    ...
    virtual void keywords_update( const std::string &adAccountId, const org::openapitools::server::model::KeywordsUpdate &keywordsUpdate, Pistache::Http::ResponseWriter &response) = 0;
    /// <summary>
    ...
    /// <param name="includeKeywords">If set, filters the results to top trends which include at least one of the specified keywords. If unset, no keyword filtering logic is applied. (optional, default to std::vector&lt;std::shared_ptr&lt;std::string&gt;&gt;())</param>
    ...
    virtual void trending_keywords_list( const TrendsSupportedRegion &region, const TrendType &trendType, const std::optional<std::vector<org::openapitools::server::model::TrendsL1Interest>> &interests, const std::optional<std::vector<org::openapitools::server::model::TrendsGenderFilter>> &genders, const std::optional<std::vector<org::openapitools::server::model::TrendsAgeBucket>> &ages, const std::optional<std::vector<std::string>> &includeKeywords, const std::optional<bool> &normalizeAgainstGroup, const std::optional<int32_t> &limit, const std::optional<bool> &includeDemographics, Pistache::Http::ResponseWriter &response) = 0;
