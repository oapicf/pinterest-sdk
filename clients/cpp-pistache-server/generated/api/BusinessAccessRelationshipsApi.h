...
private:
    ...
    virtual void brand_accounts_create( const std::string &businessHierarchyId, const org::openapitools::server::model::Brand_accounts_create_request &brandAccountsCreateRequest, Pistache::Http::ResponseWriter &response) = 0;
    /// <summary>
    ...
    virtual void brand_accounts_update( const std::string &businessHierarchyId, const std::string &brandAccountId, const org::openapitools::server::model::Brand_accounts_update_request &brandAccountsUpdateRequest, Pistache::Http::ResponseWriter &response) = 0;
    /// <summary>
    ...
    virtual void system_user_update( const std::string &businessId, const std::string &systemUserId, const org::openapitools::server::model::System_user_update_request &systemUserUpdateRequest, Pistache::Http::ResponseWriter &response) = 0;
    /// <summary>
