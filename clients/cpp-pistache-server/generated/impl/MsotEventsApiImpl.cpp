...
void MsotEventsApiImpl::msot_events_create(const std::string &adAccountId, const ConversionMSOTEvents &conversionMSOTEvents, Pistache::Http::ResponseWriter &response) {
