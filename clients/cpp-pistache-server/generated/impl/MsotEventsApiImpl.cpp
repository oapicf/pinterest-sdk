...
MsotEventsApiImpl::MsotEventsApiImpl(const std::shared_ptr<Pistache::Rest::Router>& rtr)
    : MsotEventsApi(rtr)
{
...
void MsotEventsApiImpl::msot_events_create(const std::string &adAccountId, const ConversionMSOTEventsCreate &conversionMSOTEventsCreate, Pistache::Http::ResponseWriter &response) {
