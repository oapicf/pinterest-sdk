...
void BusinessAccessRelationshipsApiImpl::brand_accounts_create(const std::string &businessHierarchyId, const Brand_accounts_create_request &brandAccountsCreateRequest, Pistache::Http::ResponseWriter &response) {
    response.send(Pistache::Http::Code::Ok, "Do some magic\n");
}
void BusinessAccessRelationshipsApiImpl::brand_accounts_update(const std::string &businessHierarchyId, const std::string &brandAccountId, const Brand_accounts_update_request &brandAccountsUpdateRequest, Pistache::Http::ResponseWriter &response) {
    response.send(Pistache::Http::Code::Ok, "Do some magic\n");
}
...
void BusinessAccessRelationshipsApiImpl::system_user_update(const std::string &businessId, const std::string &systemUserId, const System_user_update_request &systemUserUpdateRequest, Pistache::Http::ResponseWriter &response) {
    response.send(Pistache::Http::Code::Ok, "Do some magic\n");
}
