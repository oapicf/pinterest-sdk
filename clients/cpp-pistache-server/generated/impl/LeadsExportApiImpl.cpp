...
void LeadsExportApiImpl::leads_export_create(const std::string &adAccountId, const LeadsExportsCreate &leadsExportsCreate, Pistache::Http::ResponseWriter &response) {
