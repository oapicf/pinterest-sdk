...
void ConversionEventsApiImpl::events_create(const HttpBearerToken &bearerToken, const std::string &adAccountId, const ConversionEventsCreate &conversionEventsCreate, const std::optional<bool> &test, Pistache::Http::ResponseWriter &response) {
