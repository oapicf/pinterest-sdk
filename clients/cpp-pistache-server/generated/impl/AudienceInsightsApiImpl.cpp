...
void AudienceInsightsApiImpl::audience_insights_get(const std::string &adAccountId, const std::optional<AudienceInsightType> &audienceInsightType, Pistache::Http::ResponseWriter &response) {
    response.send(Pistache::Http::Code::Ok, "Do some magic\n");
}
