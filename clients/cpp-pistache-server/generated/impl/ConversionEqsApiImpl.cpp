...
ConversionEqsApiImpl::ConversionEqsApiImpl(const std::shared_ptr<Pistache::Rest::Router>& rtr)
    : ConversionEqsApi(rtr)
{
...
void ConversionEqsApiImpl::conversion_eqs_list(const std::optional<org::openapitools::server::model::LookbackPeriodOptions> &lookbackPeriod, const std::string &adAccountId, const std::optional<org::openapitools::server::model::SourcePlatformOptions> &sourcePlatform, const std::optional<org::openapitools::server::model::IngestionSourceOptions> &ingestionSource, Pistache::Http::ResponseWriter &response) {
