...
void CatalogItemsApiImpl::items_batch_post(const Items_batch_post_request &itemsBatchPostRequest, const std::optional<std::string> &adAccountId, Pistache::Http::ResponseWriter &response) {
    response.send(Pistache::Http::Code::Ok, "Do some magic\n");
}
