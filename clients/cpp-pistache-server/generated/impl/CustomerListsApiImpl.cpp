...
void CustomerListsApiImpl::customer_lists_create(const std::string &adAccountId, const CustomerListCreate &customerListCreate, Pistache::Http::ResponseWriter &response) {
...
void CustomerListsApiImpl::customer_lists_list(const std::string &adAccountId, const std::optional<std::string> &bookmark, const std::optional<int32_t> &pageSize, const std::optional<org::openapitools::server::model::Pinterest_Lib_PaginationOrder> &order, const std::optional<bool> &excludeNca, Pistache::Http::ResponseWriter &response) {
    response.send(Pistache::Http::Code::Ok, "Do some magic\n");
}
void CustomerListsApiImpl::customer_lists_update(const std::string &adAccountId, const std::string &customerListId, const CustomerListUpdateWithRequiredBody &customerListUpdateWithRequiredBody, Pistache::Http::ResponseWriter &response) {
    response.send(Pistache::Http::Code::Ok, "Do some magic\n");
}
