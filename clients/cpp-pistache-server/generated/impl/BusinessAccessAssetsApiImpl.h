...
public:
    ...
    void asset_group_create(const std::string &businessId, const AssetGroupInputCreate &assetGroupInputCreate, Pistache::Http::ResponseWriter &response);
    void asset_group_delete(const std::string &businessId, const AssetGroupDeletionDelete &assetGroupDeletionDelete, Pistache::Http::ResponseWriter &response);
    void asset_group_update(const std::string &businessId, const AssetGroupModificationReadOrUpdate &assetGroupModificationReadOrUpdate, Pistache::Http::ResponseWriter &response);
    void business_asset_members_get(const std::string &businessId, const std::string &assetId, const std::optional<int32_t> &startIndex, const std::optional<bool> &fetchSystemUsers, const std::optional<std::string> &bookmark, const std::optional<int32_t> &pageSize, Pistache::Http::ResponseWriter &response);
