...
public:
    ...
    void business_asset_members_get(const std::string &businessId, const std::string &assetId, const std::optional<bool> &fetchSystemUsers, const std::optional<std::string> &bookmark, const std::optional<int32_t> &pageSize, const std::optional<int32_t> &startIndex, Pistache::Http::ResponseWriter &response);
