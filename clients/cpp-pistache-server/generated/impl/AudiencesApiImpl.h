...
public:
    ...
    void audiences_create_custom(const std::string &adAccountId, const AudienceCreateCustomRequest &audienceCreateCustomRequest, Pistache::Http::ResponseWriter &response);
    void audiences_get(const std::string &adAccountId, const std::string &audienceId, Pistache::Http::ResponseWriter &response);
    void audiences_list(const std::string &adAccountId, const std::optional<std::string> &bookmark, const std::optional<std::string> &order, const std::optional<int32_t> &pageSize, const std::optional<std::string> &ownershipType, Pistache::Http::ResponseWriter &response);
