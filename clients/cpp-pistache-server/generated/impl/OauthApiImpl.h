...
public:
    ...
    void oauth_conversion_token(Pistache::Http::ResponseWriter &response);
    void oauth_token(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter &response);
    void token_revoke(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter &response);
