...
void BulkApiImpl::bulk_download_create(const std::string &adAccountId, const BulkDownloadCreate &bulkDownloadCreate, Pistache::Http::ResponseWriter &response) {
    response.send(Pistache::Http::Code::Ok, "Do some magic\n");
}
void BulkApiImpl::bulk_request_get(const std::string &adAccountId, const std::string &bulkRequestId, const std::optional<bool> &includeDetails, Pistache::Http::ResponseWriter &response) {
    response.send(Pistache::Http::Code::Ok, "Do some magic\n");
}
