...
public:
    ...
    void cancel_invites_or_requests(const std::string &businessId, const CancelInvitesRequest &cancelInvitesRequest, Pistache::Http::ResponseWriter &response);
    ...
    void get_invites(const std::string &businessId, const std::optional<bool> &isMember, const std::optional<std::vector<org::openapitools::server::model::InviteFilterStatus>> &inviteStatus, const std::optional<org::openapitools::server::model::InviteType> &inviteType, const std::optional<std::string> &bookmark, const std::optional<int32_t> &pageSize, Pistache::Http::ResponseWriter &response);
