...
ProductTagsApiImpl::ProductTagsApiImpl(const std::shared_ptr<Pistache::Rest::Router>& rtr)
    : ProductTagsApi(rtr)
{
...
void ProductTagsApiImpl::product_tags_bulk_add(const std::string &pinId, const ProductTagsBulkAddRequest &productTagsBulkAddRequest, Pistache::Http::ResponseWriter &response) {
    response.send(Pistache::Http::Code::Ok, "Do some magic\n");
}
void ProductTagsApiImpl::product_tags_bulk_delete(const std::string &pinId, const ProductTagsBulkDeleteRequest &productTagsBulkDeleteRequest, Pistache::Http::ResponseWriter &response) {
    response.send(Pistache::Http::Code::Ok, "Do some magic\n");
}
void ProductTagsApiImpl::product_tags_list(const std::string &pinId, Pistache::Http::ResponseWriter &response) {
    response.send(Pistache::Http::Code::Ok, "Do some magic\n");
}
