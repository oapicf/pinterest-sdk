...
std::string CatalogsDeleteCreativeAssetsItem::toJsonString(bool prettyJson /* = false */)
{
...
boost::property_tree::ptree CatalogsDeleteCreativeAssetsItem::toPropertyTree()
{
    return toPropertyTree_internal();
}

void CatalogsDeleteCreativeAssetsItem::fromPropertyTree(boost::property_tree::ptree const& pt)
{
    fromPropertyTree_internal(pt);
}

std::string CatalogsDeleteCreativeAssetsItem::toJsonString_internal(bool prettyJson)
{
	std::stringstream ss;
...
void CatalogsDeleteCreativeAssetsItem::fromJsonString_internal(std::string const& jsonString)
{
...
ptree CatalogsDeleteCreativeAssetsItem::toPropertyTree_internal()
{
	ptree pt;
	ptree tmp_node;
...
void CatalogsDeleteCreativeAssetsItem::fromPropertyTree_internal(ptree const &pt)
{
	ptree tmp_node;
