...
std::string IntegrationMetadata::toJsonString(bool prettyJson /* = false */)
{
...
boost::property_tree::ptree IntegrationMetadata::toPropertyTree()
{
    return toPropertyTree_internal();
}

void IntegrationMetadata::fromPropertyTree(boost::property_tree::ptree const& pt)
{
    fromPropertyTree_internal(pt);
}

std::string IntegrationMetadata::toJsonString_internal(bool prettyJson)
{
	std::stringstream ss;
...
void IntegrationMetadata::fromJsonString_internal(std::string const& jsonString)
{
...
ptree IntegrationMetadata::toPropertyTree_internal()
{
	ptree pt;
	ptree tmp_node;
...
void IntegrationMetadata::fromPropertyTree_internal(ptree const &pt)
{
	ptree tmp_node;
