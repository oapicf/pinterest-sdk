...
std::string LineItem::toJsonString(bool prettyJson /* = false */)
{
...
boost::property_tree::ptree LineItem::toPropertyTree()
{
    return toPropertyTree_internal();
}

void LineItem::fromPropertyTree(boost::property_tree::ptree const& pt)
{
    fromPropertyTree_internal(pt);
}

std::string LineItem::toJsonString_internal(bool prettyJson)
{
	std::stringstream ss;
...
void LineItem::fromJsonString_internal(std::string const& jsonString)
{
...
ptree LineItem::toPropertyTree_internal()
{
	ptree pt;
	ptree tmp_node;
...
void LineItem::fromPropertyTree_internal(ptree const &pt)
{
	ptree tmp_node;
