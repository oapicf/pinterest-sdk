...
std::string ConversionTagCreate::toJsonString(bool prettyJson /* = false */)
{
...
boost::property_tree::ptree ConversionTagCreate::toPropertyTree()
{
    return toPropertyTree_internal();
}

void ConversionTagCreate::fromPropertyTree(boost::property_tree::ptree const& pt)
{
    fromPropertyTree_internal(pt);
}

std::string ConversionTagCreate::toJsonString_internal(bool prettyJson)
{
	std::stringstream ss;
...
void ConversionTagCreate::fromJsonString_internal(std::string const& jsonString)
{
...
ptree ConversionTagCreate::toPropertyTree_internal()
{
	ptree pt;
	ptree tmp_node;
...
void ConversionTagCreate::fromPropertyTree_internal(ptree const &pt)
{
	ptree tmp_node;
