...
std::string SSIOOrderLine::toJsonString(bool prettyJson /* = false */)
{
...
boost::property_tree::ptree SSIOOrderLine::toPropertyTree()
{
    return toPropertyTree_internal();
}

void SSIOOrderLine::fromPropertyTree(boost::property_tree::ptree const& pt)
{
    fromPropertyTree_internal(pt);
}

std::string SSIOOrderLine::toJsonString_internal(bool prettyJson)
{
	std::stringstream ss;
...
void SSIOOrderLine::fromJsonString_internal(std::string const& jsonString)
{
...
ptree SSIOOrderLine::toPropertyTree_internal()
{
	ptree pt;
	ptree tmp_node;
...
void SSIOOrderLine::fromPropertyTree_internal(ptree const &pt)
{
	ptree tmp_node;
