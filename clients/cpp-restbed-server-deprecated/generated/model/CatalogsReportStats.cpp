...
CatalogsReportStats::~CatalogsReportStats() = default;

std::string CatalogsReportStats::toJsonString(bool prettyJson /* = false */)
{
...
boost::property_tree::ptree CatalogsReportStats::toPropertyTree()
{
    return toPropertyTree_internal();
}

void CatalogsReportStats::fromPropertyTree(boost::property_tree::ptree const& pt)
{
    fromPropertyTree_internal(pt);
}

std::string CatalogsReportStats::toJsonString_internal(bool prettyJson)
{
	std::stringstream ss;
...
void CatalogsReportStats::fromJsonString_internal(std::string const& jsonString)
{
...
ptree CatalogsReportStats::toPropertyTree_internal()
{
	ptree pt;
	ptree tmp_node;
...
void CatalogsReportStats::fromPropertyTree_internal(ptree const &pt)
{
	ptree tmp_node;
