...
std::string CustomerList::toJsonString(bool prettyJson /* = false */)
{
...
boost::property_tree::ptree CustomerList::toPropertyTree()
{
    return toPropertyTree_internal();
}

void CustomerList::fromPropertyTree(boost::property_tree::ptree const& pt)
{
    fromPropertyTree_internal(pt);
}

std::string CustomerList::toJsonString_internal(bool prettyJson)
{
	std::stringstream ss;
...
void CustomerList::fromJsonString_internal(std::string const& jsonString)
{
...
ptree CustomerList::toPropertyTree_internal()
{
	ptree pt;
	ptree tmp_node;
...
void CustomerList::fromPropertyTree_internal(ptree const &pt)
{
	ptree tmp_node;
...
void CustomerList::setExceptions(std::shared_ptr<Object> value)
{
	m_Exceptions = value;
}
