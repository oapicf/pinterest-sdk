...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestRestApi.CatalogsProductGroupFilters();
  });
  ...
  describe('CatalogsProductGroupFilters', function() {
    it('should create an instance of CatalogsProductGroupFilters', function() {
      ...
      //var instance = new PinterestRestApi.CatalogsProductGroupFilters();
      //expect(instance).to.be.a(PinterestRestApi.CatalogsProductGroupFilters);
    });
