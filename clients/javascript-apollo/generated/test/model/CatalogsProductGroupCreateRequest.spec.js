...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestRestApi.CatalogsProductGroupCreateRequest();
  });
  ...
  describe('CatalogsProductGroupCreateRequest', function() {
    it('should create an instance of CatalogsProductGroupCreateRequest', function() {
      ...
      //var instance = new PinterestRestApi.CatalogsProductGroupCreateRequest();
      //expect(instance).to.be.a(PinterestRestApi.CatalogsProductGroupCreateRequest);
    });
