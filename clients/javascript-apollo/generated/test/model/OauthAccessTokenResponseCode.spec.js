...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestRestApi.OauthAccessTokenResponseCode();
  });
  ...
  describe('OauthAccessTokenResponseCode', function() {
    it('should create an instance of OauthAccessTokenResponseCode', function() {
      ...
      //var instance = new PinterestRestApi.OauthAccessTokenResponseCode();
      //expect(instance).to.be.a(PinterestRestApi.OauthAccessTokenResponseCode);
    });
