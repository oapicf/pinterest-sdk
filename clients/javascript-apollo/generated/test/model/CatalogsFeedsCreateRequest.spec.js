...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestRestApi.CatalogsFeedsCreateRequest();
  });
  ...
  describe('CatalogsFeedsCreateRequest', function() {
    it('should create an instance of CatalogsFeedsCreateRequest', function() {
      ...
      //var instance = new PinterestRestApi.CatalogsFeedsCreateRequest();
      //expect(instance).to.be.a(PinterestRestApi.CatalogsFeedsCreateRequest);
    });
