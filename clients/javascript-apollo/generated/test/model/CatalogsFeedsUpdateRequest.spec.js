...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestRestApi.CatalogsFeedsUpdateRequest();
  });
  ...
  describe('CatalogsFeedsUpdateRequest', function() {
    it('should create an instance of CatalogsFeedsUpdateRequest', function() {
      ...
      //var instance = new PinterestRestApi.CatalogsFeedsUpdateRequest();
      //expect(instance).to.be.a(PinterestRestApi.CatalogsFeedsUpdateRequest);
    });
