...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestRestApi.CatalogsProductGroup();
  });
  ...
  describe('CatalogsProductGroup', function() {
    it('should create an instance of CatalogsProductGroup', function() {
      // uncomment below and update the code to test CatalogsProductGroup
      //var instance = new PinterestRestApi.CatalogsProductGroup();
      //expect(instance).to.be.a(PinterestRestApi.CatalogsProductGroup);
    });
