...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestRestApi.AdsAnalyticsCreateAsyncRequest();
  });
  ...
  describe('AdsAnalyticsCreateAsyncRequest', function() {
    it('should create an instance of AdsAnalyticsCreateAsyncRequest', function() {
      ...
      //var instance = new PinterestRestApi.AdsAnalyticsCreateAsyncRequest();
      //expect(instance).to.be.a(PinterestRestApi.AdsAnalyticsCreateAsyncRequest);
    });
