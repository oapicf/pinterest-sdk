...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestRestApi.MediaUploadAllOf();
  });
  ...
  describe('MediaUploadAllOf', function() {
    it('should create an instance of MediaUploadAllOf', function() {
      // uncomment below and update the code to test MediaUploadAllOf
      //var instance = new PinterestRestApi.MediaUploadAllOf();
      //expect(instance).to.be.a(PinterestRestApi.MediaUploadAllOf);
    });
