...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestRestApi.OauthAccessTokenRequestRefresh();
  });
  ...
  describe('OauthAccessTokenRequestRefresh', function() {
    it('should create an instance of OauthAccessTokenRequestRefresh', function() {
      ...
      //var instance = new PinterestRestApi.OauthAccessTokenRequestRefresh();
      //expect(instance).to.be.a(PinterestRestApi.OauthAccessTokenRequestRefresh);
    });
