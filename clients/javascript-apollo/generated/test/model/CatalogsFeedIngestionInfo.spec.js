...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestRestApi.CatalogsFeedIngestionInfo();
  });
  ...
  describe('CatalogsFeedIngestionInfo', function() {
    it('should create an instance of CatalogsFeedIngestionInfo', function() {
      ...
      //var instance = new PinterestRestApi.CatalogsFeedIngestionInfo();
      //expect(instance).to.be.a(PinterestRestApi.CatalogsFeedIngestionInfo);
    });
