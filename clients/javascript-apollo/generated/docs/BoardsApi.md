...
let apiInstance = new PinterestRestApi.BoardsApi();
let boardId = "boardId_example"; // String | Unique identifier of a board.
let boardSection = new PinterestRestApi.BoardSection(); // BoardSection | Create a board section.
...
let boardId = "boardId_example"; // String | Unique identifier of a board.
let sectionId = "sectionId_example"; // String | Unique identifier of a board section.
let boardSection = new PinterestRestApi.BoardSection(); // BoardSection | Update a board section.
...
let apiInstance = new PinterestRestApi.BoardsApi();
let board = new PinterestRestApi.Board(); // Board | Create a board using a single board json object.
...
let apiInstance = new PinterestRestApi.BoardsApi();
let boardId = "boardId_example"; // String | Unique identifier of a board.
let boardUpdate = new PinterestRestApi.BoardUpdate(); // BoardUpdate | Update a board.
