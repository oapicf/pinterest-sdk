# PinterestRestApi.AdAccountsApi
...
let apiInstance = new PinterestRestApi.AdAccountsApi();
...
let apiInstance = new PinterestRestApi.AdAccountsApi();
let adAccountId = "adAccountId_example"; // String | Unique identifier of an ad account.
let adsAnalyticsCreateAsyncRequest = new PinterestRestApi.AdsAnalyticsCreateAsyncRequest(); // AdsAnalyticsCreateAsyncRequest | 
