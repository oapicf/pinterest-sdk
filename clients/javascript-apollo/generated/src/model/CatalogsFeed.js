...
class CatalogsFeed {
     ...
     * @param defaultCountry {Country} 
     * @param defaultAvailability {ProductAvailabilityType} 
     * @param defaultCurrency {NullableCurrency} 
     ...
     * @param credentials {CatalogsFeedCredentials} 
     ...
     * @param preferredProcessingSchedule {CatalogsFeedProcessingSchedule} 
     * @param status {CatalogsStatus} 
     */
