...
export default {
    Query: {
        ...
        AdTargetingAnalyticsGet: ($adAccountId, $adIds, $startDate, $endDate, $targetingTypes, $columns, $granularity, $clickWindowDays, $engagementWindowDays, $viewWindowDays, $conversionReportTime, $attributionTypes, $reportingTimezone) => {
            return {
        ...
        AdsAnalytics: ($adAccountId, $startDate, $endDate, $columns, $granularity, $adIds, $clickWindowDays, $engagementWindowDays, $viewWindowDays, $conversionReportTime, $pinIds, $campaignIds, $reportingTimezone) => {
            return {
                "adAccountId": "adAccountId_example",
                "startDate": "2013-10-20",
                "endDate": "2013-10-20",
