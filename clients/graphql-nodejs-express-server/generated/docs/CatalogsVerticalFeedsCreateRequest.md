...
------------ | ------------- | ------------- | -------------
**catalogId** | **String!** | Catalog id pertaining to the feed. If not provided, feed will use a default catalog based on type. | [optional] [default to null]
...
**defaultLocale** | [***CatalogsCreativeAssetsFeedsCreateRequestDefaultLocale**](CatalogsCreativeAssetsFeedsCreateRequest_default_locale.md) |  | [default to null]
