...
**audienceType** | [***PinnerListType**](PinnerListType.md) | [Audience types](/docs/reference/glossary/#Audience Types): ACTALIKE, ENGAGEMENT, CUSTOMER_LIST and VISITOR | [optional] [default to null]
**createdByCompanyName** | **String** | The company that created this audience. | [optional] [default to null]
...
**isNca** | **Boolean!** | Whether the audience derives from a new customer acquisition (expanded matching) customer list. Read-only. | [optional] [default to null]
