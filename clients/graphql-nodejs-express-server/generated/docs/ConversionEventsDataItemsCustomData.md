...
**contentIds** | **String!** | List of products IDs. We recommend using this if you are a merchant for PageVisit, AddToCart and Checkouts. For detail, please check [here](https://help.pinterest.com/en/business/article/before-you-get-started-with-catalogs) (Install the Pinterest tag section). | [optional] [default to null]
...
**externalMeasurementId** | **String** | Only use when instructed. | [optional] [default to null]
**externalMeasurementVendorId** | **Int** | Only use when instructed. | [optional] [default to null]
...
**predictedLtv** | **String** | Predicted lifetime value of user associated with the event. Accepted as a string in the request; it will be parsed into a double. | [optional] [default to null]
