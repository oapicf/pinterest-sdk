...
------------ | ------------- | ------------- | -------------
**autoTargetingEnabled** | **Boolean** | Enable auto-targeting for ad group. Default value is True. Also known as [\&quot;Performance+ targeting\&quot;](https://help.pinterest.com/en/business/article/performance-plus-targeting). | [optional] [default to null]
...
**targetingSpecOperations** | [**TargetingSpecOperations**](TargetingSpecOperations.md) |  | [optional] [default to null]
