...
**createdByBusiness** | [***TodoObjectMapping**](.md) | Metadata for the business that created the invite/request. | [optional] [default to null]
**createdByUser** | [***TodoObjectMapping**](.md) | Metadata for the user that created the invite/request. | [optional] [default to null]
