...
------------ | ------------- | ------------- | -------------
**aiDisclosures** | [***AiDisclosures**](AiDisclosures.md) | AI disclosure declarations the creator has made about this Pin. | [optional] [default to null]
...
**isProduct** | **Boolean!** | Whether the Pin is a product Pin. | [optional] [readonly] [default to null]
