...
------------ | ------------- | ------------- | -------------
**createdTime** | **String!** | Timestamp when the conversion deletion request was succesfully created. | [readonly] [default to null]
**processedTime** | **String** | Timestamp when the conversion deletion request was processed. | [optional] [readonly] [default to null]
