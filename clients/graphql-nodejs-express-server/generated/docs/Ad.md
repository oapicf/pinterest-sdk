...
------------ | ------------- | ------------- | -------------
**adAccountId** | **String!** | The ID of the advertiser that this ad belongs to. | [readonly] [default to null]
...
**campaignId** | **String!** | ID of the ad campaign that contains this ad. | [readonly] [default to null]
...
**cartingPlatformType** | **Int!** | The vendor platform type of the carting/WTB ad. | [optional] [readonly] [default to null]
**cartingProducts** | [**CartingProduct**](CartingProduct.md) | Array of carting/WTB products for the ad. | [optional] [readonly] [default to null]
...
**collectionsHeaderType** | [***AdCollectionsHeaderType**](AdCollectionsHeaderType.md) |  | [optional] [default to null]
**createdTime** | **Int!** | Pin creation time. Unix timestamp in seconds. | [optional] [readonly] [default to null]
...
**isCollageAcceptedTerms** | **Boolean!** | Whether the advertiser has accepted the terms and conditions for collage ad. | [optional] [default to null]
**isCollageSingleDestination** | **Boolean!** | Whether the collage ad has a single destination url override. | [optional] [default to null]
...
**pinId** | **String!** | Pin ID. This field may only be updated for draft ads. | [default to null]
...
**rejectedReasons** | [**AdDisapprovalReasons**](AdDisapprovalReasons.md) | Enum reason why the pin was rejected. Returned if &#x60;review_status&#x60; is \&quot;REJECTED\&quot;. | [readonly] [default to null]
**rejectionLabels** | **String!** | Text reason why the pin was rejected. Returned if &#x60;review_status&#x60; is \&quot;REJECTED\&quot;. | [readonly] [default to null]
**reviewStatus** | [***AdReviewStatus**](AdReviewStatus.md) | Ad review status | [readonly] [default to null]
**status** | [***EntityStatus**](EntityStatus.md) |  | [optional] [default to null]
**summaryStatus** | [***PinPromotionSummaryStatus**](PinPromotionSummaryStatus.md) | Ad summary status | [readonly] [default to null]
**trackingUrls** | [***TrackingUrls**](TrackingUrls.md) |  | [optional] [default to null]
**Type_** | **String!** | Always \&quot;ad\&quot;. | [readonly] [default to null]
**updatedTime** | **Int!** | Last update time. Unix timestamp in seconds. | [optional] [readonly] [default to null]
