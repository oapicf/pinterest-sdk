...
class TrendsApi {
    ...
    def trendsEditorialArticlesList ( ProductCategoryRegion region, Closure onSuccess, Closure onFailure)  {
        String resourcePath = "/trends/editorial_articles"
