...
class TargetingSpec  implements \JsonSerializable
{
        /**
    ...
    /**
     * @var TargetingSpecTARGETINGSTRATEGYInner[]|null
     * @SerializedName("TARGETING_STRATEGY")
     * @Assert\All({
     *   @Assert\Type("\OpenAPIServer\Model\TargetingSpecTARGETINGSTRATEGYInner")
     * })
     ...
     * @param TargetingSpecTARGETINGSTRATEGYInner[]|null $tARGETINGSTRATEGY
     */
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            isset($data['TARGETING_STRATEGY']) ? array_map(fn($item) => TargetingSpecTARGETINGSTRATEGYInner::tryFrom($item), $data['TARGETING_STRATEGY']) : null,
        );
    }
