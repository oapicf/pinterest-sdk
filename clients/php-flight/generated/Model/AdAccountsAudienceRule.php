...
/**
 * Class representing the AdAccountsAudienceRule model.
 *
...
class AdAccountsAudienceRule  implements \JsonSerializable
{
        /**
     * Ad account ID.
     *
     ...
     *
     * @var AudienceObjectiveType[]|null
     * @SerializedName("objective_type")
     * @Assert\All({
     *   @Assert\Type("\OpenAPIServer\Model\AudienceObjectiveType")
     * })
     ...
     * @param AudienceObjectiveType[]|null $objectiveType
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            isset($data['objective_type']) ? array_map(fn($item) => AudienceObjectiveType::tryFrom($item), $data['objective_type']) : null,
