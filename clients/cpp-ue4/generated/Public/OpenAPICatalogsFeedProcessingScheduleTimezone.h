...
/*
 * OpenAPICatalogsFeedProcessingScheduleTimezone
 *
 * The timezone selected for the processing schedule time
 */
class OPENAPI_API OpenAPICatalogsFeedProcessingScheduleTimezone : public Model
{
public:
    virtual ~OpenAPICatalogsFeedProcessingScheduleTimezone() {}
