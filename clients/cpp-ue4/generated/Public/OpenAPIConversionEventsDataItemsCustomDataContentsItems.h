...
/*
 * OpenAPIConversionEventsDataItemsCustomDataContentsItems
 *
 * 
 */
class OPENAPI_API OpenAPIConversionEventsDataItemsCustomDataContentsItems : public Model
{
public:
    virtual ~OpenAPIConversionEventsDataItemsCustomDataContentsItems() {}
