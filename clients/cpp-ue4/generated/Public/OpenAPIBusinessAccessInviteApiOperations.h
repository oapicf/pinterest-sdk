...
#include "OpenAPICancelInvitesResponse.h"
...
public:
	...
	/* Unique identifier of the requesting business. */
	FString BusinessId;
	OpenAPICancelInvitesRequest OpenAPICancelInvitesRequest;
};
...
public:
    ...
    OpenAPICancelInvitesResponse Content;
};
...
public:
	...
	TOptional<TArray<OpenAPIInviteFilterStatus>> InviteStatus;
