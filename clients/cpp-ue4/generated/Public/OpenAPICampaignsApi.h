...
public:
	...
	* See also: Request::SetShouldRetry */
	...
	class AdPinsAnalyticsRequest;
	class AdPinsAnalyticsResponse;
	...
	class GetCampaignDeliveryEstimatesRequest;
	class GetCampaignDeliveryEstimatesResponse;
	
    DECLARE_DELEGATE_OneParam(FAdPinsAnalyticsDelegate, const AdPinsAnalyticsResponse&);
    ...
    DECLARE_DELEGATE_OneParam(FGetCampaignDeliveryEstimatesDelegate, const GetCampaignDeliveryEstimatesResponse&);
    
    FHttpRequestPtr AdPinsAnalytics(const AdPinsAnalyticsRequest& Request, const FAdPinsAnalyticsDelegate& Delegate = FAdPinsAnalyticsDelegate()) const;
    ...
    FHttpRequestPtr GetCampaignDeliveryEstimates(const GetCampaignDeliveryEstimatesRequest& Request, const FGetCampaignDeliveryEstimatesDelegate& Delegate = FGetCampaignDeliveryEstimatesDelegate()) const;
    
private:
    void OnAdPinsAnalyticsResponse(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FAdPinsAnalyticsDelegate Delegate) const;
    ...
    void OnGetCampaignDeliveryEstimatesResponse(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FGetCampaignDeliveryEstimatesDelegate Delegate) const;
