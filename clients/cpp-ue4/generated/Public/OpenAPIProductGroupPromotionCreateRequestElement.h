...
/*
 * OpenAPIProductGroupPromotionCreateRequestElement
 *
 * 
 */
class OPENAPI_API OpenAPIProductGroupPromotionCreateRequestElement : public Model
{
public:
    virtual ~OpenAPIProductGroupPromotionCreateRequestElement() {}
