...
public:
	...
	* See also: Request::SetShouldRetry */
	...
	class BillingInvoiceDownloadGetRequest;
	class BillingInvoiceDownloadGetResponse;
	class BillingInvoicesGetRequest;
	class BillingInvoicesGetResponse;
    ...
    DECLARE_DELEGATE_OneParam(FBillingInvoiceDownloadGetDelegate, const BillingInvoiceDownloadGetResponse&);
    DECLARE_DELEGATE_OneParam(FBillingInvoicesGetDelegate, const BillingInvoicesGetResponse&);
    ...
    FHttpRequestPtr BillingInvoiceDownloadGet(const BillingInvoiceDownloadGetRequest& Request, const FBillingInvoiceDownloadGetDelegate& Delegate = FBillingInvoiceDownloadGetDelegate()) const;
    FHttpRequestPtr BillingInvoicesGet(const BillingInvoicesGetRequest& Request, const FBillingInvoicesGetDelegate& Delegate = FBillingInvoicesGetDelegate()) const;
...
private:
    ...
    void OnBillingInvoiceDownloadGetResponse(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FBillingInvoiceDownloadGetDelegate Delegate) const;
    void OnBillingInvoicesGetResponse(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FBillingInvoicesGetDelegate Delegate) const;
