...
/*
 * OpenAPIProductGroupPromotionResponseElement
 *
 * 
 */
class OPENAPI_API OpenAPIProductGroupPromotionResponseElement : public Model
{
public:
    virtual ~OpenAPIProductGroupPromotionResponseElement() {}
