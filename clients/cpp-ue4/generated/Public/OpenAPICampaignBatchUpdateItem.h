...
/*
 * OpenAPICampaignBatchUpdateItem
 *
 * Single campaign update item with update-specific bid options.
 */
class OPENAPI_API OpenAPICampaignBatchUpdateItem : public Model
{
public:
    virtual ~OpenAPICampaignBatchUpdateItem() {}
	...
	TOptional<OpenAPIConversionObjectiveType> ObjectiveType;
