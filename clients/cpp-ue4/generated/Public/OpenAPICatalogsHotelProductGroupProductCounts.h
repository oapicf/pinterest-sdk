...
/*
 * OpenAPICatalogsHotelProductGroupProductCounts
 *
 * Product counts for a Hotel CatalogsProductGroup
 */
class OPENAPI_API OpenAPICatalogsHotelProductGroupProductCounts : public Model
{
public:
    virtual ~OpenAPICatalogsHotelProductGroupProductCounts() {}
