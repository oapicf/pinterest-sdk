...
/*
 * OpenAPICatalogsFeedUpdateRequestSchema
 *
 * 
 */
class OPENAPI_API OpenAPICatalogsFeedUpdateRequestSchema : public Model
{
public:
    virtual ~OpenAPICatalogsFeedUpdateRequestSchema() {}
