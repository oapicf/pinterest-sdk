...
/*
 * OpenAPIAdGroupUpdateRequest
 *
 * 
 */
class OPENAPI_API OpenAPIAdGroupUpdateRequest : public Model
{
public:
    virtual ~OpenAPIAdGroupUpdateRequest() {}
	...
	static FString EnumToString(const PromotionApplicationLevelEnum& EnumValue);
	static bool EnumFromString(const FString& EnumAsString, PromotionApplicationLevelEnum& EnumValue);
	/* Specify if the promotion is applied at ad group or item level */
	TOptional<PromotionApplicationLevelEnum> PromotionApplicationLevel;
