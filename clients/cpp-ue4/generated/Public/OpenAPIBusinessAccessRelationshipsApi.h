...
public:
	...
	* See also: Request::SetShouldRetry */
	...
	class BrandAccountsCreateResponse;
	class BrandAccountsUpdateRequest;
	class BrandAccountsUpdateResponse;
	...
	class SystemUserUpdateResponse;
	class UpdateBusinessMembershipsRequest;
	class UpdateBusinessMembershipsResponse;
	
    DECLARE_DELEGATE_OneParam(FBrandAccountsCreateDelegate, const BrandAccountsCreateResponse&);
    DECLARE_DELEGATE_OneParam(FBrandAccountsUpdateDelegate, const BrandAccountsUpdateResponse&);
    ...
    DECLARE_DELEGATE_OneParam(FSystemUserUpdateDelegate, const SystemUserUpdateResponse&);
    DECLARE_DELEGATE_OneParam(FUpdateBusinessMembershipsDelegate, const UpdateBusinessMembershipsResponse&);
    
    FHttpRequestPtr BrandAccountsCreate(const BrandAccountsCreateRequest& Request, const FBrandAccountsCreateDelegate& Delegate = FBrandAccountsCreateDelegate()) const;
    FHttpRequestPtr BrandAccountsUpdate(const BrandAccountsUpdateRequest& Request, const FBrandAccountsUpdateDelegate& Delegate = FBrandAccountsUpdateDelegate()) const;
    ...
    FHttpRequestPtr SystemUserUpdate(const SystemUserUpdateRequest& Request, const FSystemUserUpdateDelegate& Delegate = FSystemUserUpdateDelegate()) const;
...
private:
    void OnBrandAccountsCreateResponse(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FBrandAccountsCreateDelegate Delegate) const;
    void OnBrandAccountsUpdateResponse(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FBrandAccountsUpdateDelegate Delegate) const;
    ...
    void OnSystemUserUpdateResponse(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FSystemUserUpdateDelegate Delegate) const;
