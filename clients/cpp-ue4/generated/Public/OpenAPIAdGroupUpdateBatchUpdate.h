...
/*
 * OpenAPIAdGroupUpdateBatchUpdate
 *
 * 
 */
class OPENAPI_API OpenAPIAdGroupUpdateBatchUpdate : public Model
{
public:
    virtual ~OpenAPIAdGroupUpdateBatchUpdate() {}
	...
	TOptional<TArray<OpenAPITargetingSpecOperations>> TargetingSpecOperations;
