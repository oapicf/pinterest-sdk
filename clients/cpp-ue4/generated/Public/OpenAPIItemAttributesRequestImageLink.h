...
/*
 * OpenAPIItemAttributesRequestImageLink
 *
 ...
 */
class OPENAPI_API OpenAPIItemAttributesRequestImageLink : public Model
{
public:
    virtual ~OpenAPIItemAttributesRequestImageLink() {}
