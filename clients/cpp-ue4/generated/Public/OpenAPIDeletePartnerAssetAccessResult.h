...
/*
 * OpenAPIDeletePartnerAssetAccessResult
 *
 * The terminated asset access.
 */
class OPENAPI_API OpenAPIDeletePartnerAssetAccessResult : public Model
{
public:
    virtual ~OpenAPIDeletePartnerAssetAccessResult() {}
