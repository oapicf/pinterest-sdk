...
/*
 * OpenAPICatalogsCreativeAssetsFeedsUpdateRequest
 *
 * Request object for updating a feed.
 */
class OPENAPI_API OpenAPICatalogsCreativeAssetsFeedsUpdateRequest : public Model
{
public:
    virtual ~OpenAPICatalogsCreativeAssetsFeedsUpdateRequest() {}
