...
/*
 * OpenAPICatalogsProductGroupsCreate201Response
 *
 * 
 */
class OPENAPI_API OpenAPICatalogsProductGroupsCreate201Response : public Model
{
public:
    virtual ~OpenAPICatalogsProductGroupsCreate201Response() {}
