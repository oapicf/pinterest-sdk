...
public:
	...
	* See also: Request::SetShouldRetry */
	...
	class CampaignAdPreviewCreateRequest;
	class CampaignAdPreviewCreateResponse;
	class CampaignAdPreviewDeleteRequest;
	class CampaignAdPreviewDeleteResponse;
	class CampaignAdPreviewReadRequest;
	class CampaignAdPreviewReadResponse;
    ...
    DECLARE_DELEGATE_OneParam(FCampaignAdPreviewCreateDelegate, const CampaignAdPreviewCreateResponse&);
    DECLARE_DELEGATE_OneParam(FCampaignAdPreviewDeleteDelegate, const CampaignAdPreviewDeleteResponse&);
    DECLARE_DELEGATE_OneParam(FCampaignAdPreviewReadDelegate, const CampaignAdPreviewReadResponse&);
    ...
    FHttpRequestPtr CampaignAdPreviewCreate(const CampaignAdPreviewCreateRequest& Request, const FCampaignAdPreviewCreateDelegate& Delegate = FCampaignAdPreviewCreateDelegate()) const;
    FHttpRequestPtr CampaignAdPreviewDelete(const CampaignAdPreviewDeleteRequest& Request, const FCampaignAdPreviewDeleteDelegate& Delegate = FCampaignAdPreviewDeleteDelegate()) const;
    FHttpRequestPtr CampaignAdPreviewRead(const CampaignAdPreviewReadRequest& Request, const FCampaignAdPreviewReadDelegate& Delegate = FCampaignAdPreviewReadDelegate()) const;
...
private:
    ...
    void OnCampaignAdPreviewCreateResponse(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FCampaignAdPreviewCreateDelegate Delegate) const;
    void OnCampaignAdPreviewDeleteResponse(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FCampaignAdPreviewDeleteDelegate Delegate) const;
    void OnCampaignAdPreviewReadResponse(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FCampaignAdPreviewReadDelegate Delegate) const;
