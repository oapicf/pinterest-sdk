...
/*
 * OpenAPICatalogsProductGroupsUpdateRequestSchema
 *
 * 
 */
class OPENAPI_API OpenAPICatalogsProductGroupsUpdateRequestSchema : public Model
{
public:
    virtual ~OpenAPICatalogsProductGroupsUpdateRequestSchema() {}
