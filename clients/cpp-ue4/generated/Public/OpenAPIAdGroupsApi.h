...
public:
	...
	* See also: Request::SetShouldRetry */
	...
	class AdGroupsDynamicTitlesDownloadCsvRequest;
	class AdGroupsDynamicTitlesDownloadCsvResponse;
	class AdGroupsDynamicTitlesGetStatusRequest;
	class AdGroupsDynamicTitlesGetStatusResponse;
	class AdGroupsDynamicTitlesGetUploadUrlRequest;
	class AdGroupsDynamicTitlesGetUploadUrlResponse;
	class AdGroupsDynamicTitlesProcessCsvRequest;
	class AdGroupsDynamicTitlesProcessCsvResponse;
	...
	class GetAdGroupsByPromotionIdsListRequest;
	class GetAdGroupsByPromotionIdsListResponse;
	
    DECLARE_DELEGATE_OneParam(FAdGroupsBidFloorGetDelegate, const AdGroupsBidFloorGetResponse&);
    DECLARE_DELEGATE_OneParam(FAdGroupsDynamicTitlesDownloadCsvDelegate, const AdGroupsDynamicTitlesDownloadCsvResponse&);
    DECLARE_DELEGATE_OneParam(FAdGroupsDynamicTitlesGetStatusDelegate, const AdGroupsDynamicTitlesGetStatusResponse&);
    DECLARE_DELEGATE_OneParam(FAdGroupsDynamicTitlesGetUploadUrlDelegate, const AdGroupsDynamicTitlesGetUploadUrlResponse&);
    DECLARE_DELEGATE_OneParam(FAdGroupsDynamicTitlesProcessCsvDelegate, const AdGroupsDynamicTitlesProcessCsvResponse&);
    ...
    DECLARE_DELEGATE_OneParam(FGetAdGroupsByPromotionIdsListDelegate, const GetAdGroupsByPromotionIdsListResponse&);
    ...
    FHttpRequestPtr AdGroupsDynamicTitlesDownloadCsv(const AdGroupsDynamicTitlesDownloadCsvRequest& Request, const FAdGroupsDynamicTitlesDownloadCsvDelegate& Delegate = FAdGroupsDynamicTitlesDownloadCsvDelegate()) const;
    FHttpRequestPtr AdGroupsDynamicTitlesGetStatus(const AdGroupsDynamicTitlesGetStatusRequest& Request, const FAdGroupsDynamicTitlesGetStatusDelegate& Delegate = FAdGroupsDynamicTitlesGetStatusDelegate()) const;
    FHttpRequestPtr AdGroupsDynamicTitlesGetUploadUrl(const AdGroupsDynamicTitlesGetUploadUrlRequest& Request, const FAdGroupsDynamicTitlesGetUploadUrlDelegate& Delegate = FAdGroupsDynamicTitlesGetUploadUrlDelegate()) const;
    FHttpRequestPtr AdGroupsDynamicTitlesProcessCsv(const AdGroupsDynamicTitlesProcessCsvRequest& Request, const FAdGroupsDynamicTitlesProcessCsvDelegate& Delegate = FAdGroupsDynamicTitlesProcessCsvDelegate()) const;
    ...
    FHttpRequestPtr GetAdGroupsByPromotionIdsList(const GetAdGroupsByPromotionIdsListRequest& Request, const FGetAdGroupsByPromotionIdsListDelegate& Delegate = FGetAdGroupsByPromotionIdsListDelegate()) const;
...
private:
    ...
    void OnAdGroupsDynamicTitlesDownloadCsvResponse(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FAdGroupsDynamicTitlesDownloadCsvDelegate Delegate) const;
    void OnAdGroupsDynamicTitlesGetStatusResponse(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FAdGroupsDynamicTitlesGetStatusDelegate Delegate) const;
    void OnAdGroupsDynamicTitlesGetUploadUrlResponse(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FAdGroupsDynamicTitlesGetUploadUrlDelegate Delegate) const;
    void OnAdGroupsDynamicTitlesProcessCsvResponse(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FAdGroupsDynamicTitlesProcessCsvDelegate Delegate) const;
    ...
    void OnGetAdGroupsByPromotionIdsListResponse(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FGetAdGroupsByPromotionIdsListDelegate Delegate) const;
