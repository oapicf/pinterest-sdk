...
/*
 * OpenAPICampaignBatchResponseData
 *
 * Campaign data in batch response, with all fields optional to support error cases where data may be empty.
 */
class OPENAPI_API OpenAPICampaignBatchResponseData : public Model
{
public:
    virtual ~OpenAPICampaignBatchResponseData() {}
	...
	TOptional<OpenAPICampaignObjectiveType> ObjectiveType;
	...
	TOptional<OpenAPINullableEntityStatus> Status;
	TOptional<OpenAPISummaryStatus> SummaryStatus;
