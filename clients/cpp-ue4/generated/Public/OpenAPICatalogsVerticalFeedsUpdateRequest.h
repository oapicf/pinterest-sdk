...
/*
 * OpenAPICatalogsVerticalFeedsUpdateRequest
 *
 * Request object for updating a feed.
 */
class OPENAPI_API OpenAPICatalogsVerticalFeedsUpdateRequest : public Model
{
public:
    virtual ~OpenAPICatalogsVerticalFeedsUpdateRequest() {}
