...
/*
 * OpenAPIConversionEventsUserDataProperties
 *
 * 
 */
class OPENAPI_API OpenAPIConversionEventsUserDataProperties : public Model
{
public:
    virtual ~OpenAPIConversionEventsUserDataProperties() {}
	...
	TOptional<FString> ClientIpAddress;
	/* The user agent string of the user's web browser. We highly recommend this for all events. It may improve reporting performance such as ROAS/CPA. */
	TOptional<FString> ClientUserAgent;
