...
/*
 * OpenAPIScheduleBidOptionsGenderMultipliers
 *
 ...
 */
class OPENAPI_API OpenAPIScheduleBidOptionsGenderMultipliers : public Model
{
public:
    virtual ~OpenAPIScheduleBidOptionsGenderMultipliers() {}
