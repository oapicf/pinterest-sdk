 ...
 */
class OPENAPI_API OpenAPIAgeBucketMultipliers : public Model
{
public:
    virtual ~OpenAPIAgeBucketMultipliers() {}
	bool FromJson(const TSharedPtr<FJsonValue>& JsonValue) final;
	void WriteJson(JsonWriter& Writer) const final;

	/* Age bucket identifier. */
	TOptional<OpenAPITargetingSpecAgeBucket> AgeBucket;
};
