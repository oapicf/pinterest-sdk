...
#include "OpenAPIFollowUserCreate.h"
...
public:
	...
	/* A valid username */
	FString Username;
	OpenAPIFollowUserCreate OpenAPIFollowUserCreate;
};
...
public:
	...
	TOptional<TArray<OpenAPIQuerymetrictypesItems>> MetricTypes;
...
public:
	...
	OpenAPITopVideoPinsSortBy SortBy;
	enum class FromClaimedContentEnum
	{
		Other,
		Claimed,
	...
	TOptional<TArray<OpenAPIQueryvideopinmetrictypesItems>> MetricTypes;
	/* Number of pins to include, default is 10. Max is 50. */
	TOptional<int32> NumOfPins;
	enum class CreatedInLastNDaysEnum
	{
...
public:
	...
	OpenAPIUserWebsiteCreate OpenAPIUserWebsiteCreate;
	/* Unique identifier of an ad account. */
	TOptional<FString> AdAccountId;
};
...
public:
    ...
    OpenAPIUserWebsiteVerification Content;
};
