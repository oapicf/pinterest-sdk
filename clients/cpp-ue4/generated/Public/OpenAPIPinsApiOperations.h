...
#include "OpenAPIPinsSaveRequestCreate.h"
...
public:
	...
	TArray<OpenAPIMultiPinsAnalyticsMetricTypesItem> MetricTypes;
...
public:
	...
	TArray<OpenAPIQuerypinanalyticsmetrictypesItems> MetricTypes;
	enum class AppTypesEnum
	{
		All,
		Mobile,
...
public:
	...
	TOptional<OpenAPIPinFilter> PinFilter;
	/* Specify whether to return 90d and lifetime Pin metrics. Total comments and total reactions are only available with lifetime Pin metrics. If Pin was created before `2023-03-20` lifetime metrics will only be available for Video and Idea Pin formats. Lifetime metrics are available for all Pin formats since then. */
	TOptional<bool> PinMetrics;
	...
	TOptional<OpenAPIPinType> PinType;
...
public:
	...
	/* Unique identifier of a Pin. */
	FString PinId;
	OpenAPIPinsSaveRequestCreate OpenAPIPinsSaveRequestCreate;
	/* Unique identifier of an ad account. */
	TOptional<FString> AdAccountId;
};
