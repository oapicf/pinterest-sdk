...
/*
 * OpenAPICatalogsHotelFeedsUpdateRequest
 *
 * Request object for updating a feed.
 */
class OPENAPI_API OpenAPICatalogsHotelFeedsUpdateRequest : public Model
{
public:
    virtual ~OpenAPICatalogsHotelFeedsUpdateRequest() {}
