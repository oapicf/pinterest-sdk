 ...
 */
class OPENAPI_API OpenAPIAdAccountsAudienceRule : public Model
{
public:
    virtual ~OpenAPIAdAccountsAudienceRule() {}
	...
	TOptional<TArray<OpenAPIAudienceObjectiveType>> ObjectiveType;
