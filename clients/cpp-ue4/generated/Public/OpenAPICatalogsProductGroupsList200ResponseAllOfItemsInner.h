...
/*
 * OpenAPICatalogsProductGroupsList200ResponseAllOfItemsInner
 *
 * 
 */
class OPENAPI_API OpenAPICatalogsProductGroupsList200ResponseAllOfItemsInner : public Model
{
public:
    virtual ~OpenAPICatalogsProductGroupsList200ResponseAllOfItemsInner() {}
