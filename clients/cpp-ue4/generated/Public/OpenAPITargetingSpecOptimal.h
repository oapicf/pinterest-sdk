...
/*
 * OpenAPITargetingSpecOptimal
 *
 * 
 */
class OPENAPI_API OpenAPITargetingSpecOptimal : public Model
{
public:
    virtual ~OpenAPITargetingSpecOptimal() {}
	...
	TOptional<TArray<OpenAPITargetingStrategy>> TargetingStrategy;
};
