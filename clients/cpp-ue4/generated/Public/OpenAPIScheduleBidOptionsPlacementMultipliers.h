...
/*
 * OpenAPIScheduleBidOptionsPlacementMultipliers
 *
 ...
 */
class OPENAPI_API OpenAPIScheduleBidOptionsPlacementMultipliers : public Model
{
public:
    virtual ~OpenAPIScheduleBidOptionsPlacementMultipliers() {}
	bool FromJson(const TSharedPtr<FJsonValue>& JsonValue) final;
	void WriteJson(JsonWriter& Writer) const final;

	/* Browse (home-feed and related surfaces) */
	TOptional<double> Browse;
	/* Related-Pins placement */
	TOptional<double> RelatedPins;
	/* Search placement */
	TOptional<double> Search;
};
