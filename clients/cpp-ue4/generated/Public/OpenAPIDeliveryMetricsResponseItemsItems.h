...
/*
 * OpenAPIDeliveryMetricsResponseItemsItems
 *
 * 
 */
class OPENAPI_API OpenAPIDeliveryMetricsResponseItemsItems : public Model
{
public:
    virtual ~OpenAPIDeliveryMetricsResponseItemsItems() {}
