...
/*
 * OpenAPICatalogsReportDistributionStats
 *
 * 
 */
class OPENAPI_API OpenAPICatalogsReportDistributionStats : public Model
{
public:
    virtual ~OpenAPICatalogsReportDistributionStats() {}
