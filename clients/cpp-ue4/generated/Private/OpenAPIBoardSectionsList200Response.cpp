...
void OpenAPIBoardSectionsList200Response::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIBoardSectionsList200Response::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
