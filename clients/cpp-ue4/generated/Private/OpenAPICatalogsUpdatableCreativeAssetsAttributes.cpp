...
void OpenAPICatalogsUpdatableCreativeAssetsAttributes::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPICatalogsUpdatableCreativeAssetsAttributes::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
