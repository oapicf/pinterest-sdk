...
void OpenAPIAdsCreditsDiscountsGet200Response::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIAdsCreditsDiscountsGet200Response::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
