...
void OpenAPIAdAccountsAudiencesSharedAccountsList200Response::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIAdAccountsAudiencesSharedAccountsList200Response::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
