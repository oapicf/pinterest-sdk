...
void OpenAPIBoardsUserFollowsList200Response::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIBoardsUserFollowsList200Response::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
