...
void OpenAPIPromotionsList200Response::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIPromotionsList200Response::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
