...
void OpenAPIAdvancedAuctionProcessedItem::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIAdvancedAuctionProcessedItem::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
