...
inline FStringFormatArg ToStringFormatArg(const OpenAPIConversionEventsDataInner::EventNameEnum& Value)
{
...
inline FStringFormatArg ToStringFormatArg(const OpenAPIConversionEventsDataInner::ActionSourceEnum& Value)
{
	return FStringFormatArg(ToString(Value));
}
