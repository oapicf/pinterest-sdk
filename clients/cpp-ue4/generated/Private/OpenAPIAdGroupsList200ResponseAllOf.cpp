...
void OpenAPIAdGroupsList200ResponseAllOf::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIAdGroupsList200ResponseAllOf::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
