...
void OpenAPICatalogsUpdatableHotelAttributes::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPICatalogsUpdatableHotelAttributes::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
