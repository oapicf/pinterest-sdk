...
inline FString ToString(const OpenAPICatalogsFeedCreateRequestSchema::CatalogTypeEnum& Value)
{
	switch (Value)
	{
	case OpenAPICatalogsFeedCreateRequestSchema::CatalogTypeEnum::CreativeAssets:
		return TEXT("CREATIVE_ASSETS");
	}

	UE_LOG(LogOpenAPI, Error, TEXT("Invalid OpenAPICatalogsFeedCreateRequestSchema::CatalogTypeEnum Value (%d)"), (int)Value);
	return TEXT("");
}

FString OpenAPICatalogsFeedCreateRequestSchema::EnumToString(const OpenAPICatalogsFeedCreateRequestSchema::CatalogTypeEnum& EnumValue)
{
	return ToString(EnumValue);
}

inline bool FromString(const FString& EnumAsString, OpenAPICatalogsFeedCreateRequestSchema::CatalogTypeEnum& Value)
{
	static TMap<FString, OpenAPICatalogsFeedCreateRequestSchema::CatalogTypeEnum> StringToEnum = { 
		{ TEXT("CREATIVE_ASSETS"), OpenAPICatalogsFeedCreateRequestSchema::CatalogTypeEnum::CreativeAssets }, };
...
bool OpenAPICatalogsFeedCreateRequestSchema::EnumFromString(const FString& EnumAsString, OpenAPICatalogsFeedCreateRequestSchema::CatalogTypeEnum& EnumValue)
{
	return FromString(EnumAsString, EnumValue);
}

inline void WriteJsonValue(JsonWriter& Writer, const OpenAPICatalogsFeedCreateRequestSchema::CatalogTypeEnum& Value)
{
	WriteJsonValue(Writer, ToString(Value));
}

inline bool TryGetJsonValue(const TSharedPtr<FJsonValue>& JsonValue, OpenAPICatalogsFeedCreateRequestSchema::CatalogTypeEnum& Value)
{
	FString TmpValue;
...
void OpenAPICatalogsFeedCreateRequestSchema::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPICatalogsFeedCreateRequestSchema::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
