...
void OpenAPIUserAccountFollowedInterests200Response::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIUserAccountFollowedInterests200Response::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
