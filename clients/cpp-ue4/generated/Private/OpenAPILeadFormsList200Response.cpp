...
void OpenAPILeadFormsList200Response::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPILeadFormsList200Response::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
