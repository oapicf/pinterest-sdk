...
void OpenAPITargetingTemplateList200Response::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPITargetingTemplateList200Response::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
