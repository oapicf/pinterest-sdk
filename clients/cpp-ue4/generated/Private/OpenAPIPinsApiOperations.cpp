...
inline FStringFormatArg ToStringFormatArg(const OpenAPIPinsApi::PinsAnalyticsRequest::MetricTypesEnum& Value)
{
...
inline FStringFormatArg ToStringFormatArg(const OpenAPIPinsApi::PinsAnalyticsRequest::AppTypesEnum& Value)
{
	return FStringFormatArg(ToString(Value));
}
...
inline FStringFormatArg ToStringFormatArg(const OpenAPIPinsApi::PinsAnalyticsRequest::SplitFieldEnum& Value)
{
	return FStringFormatArg(ToString(Value));
}
...
FString OpenAPIPinsApi::PinsAnalyticsRequest::ComputePath() const
{
	...
	{ TEXT("pin_id"), ToStringFormatArg(PinId) } };
