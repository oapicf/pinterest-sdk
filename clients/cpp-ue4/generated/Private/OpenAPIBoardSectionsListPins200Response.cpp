...
#include "OpenAPIBoardSectionsListPins200Response.h"
...
void OpenAPIBoardSectionsListPins200Response::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIBoardSectionsListPins200Response::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
