...
void OpenAPIAdAccountAnalyticsItems::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIAdAccountAnalyticsItems::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
