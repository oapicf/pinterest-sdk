...
void OpenAPIAdGroupCommonTrackingUrls::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIAdGroupCommonTrackingUrls::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
