...
void OpenAPITopVideoPinsAnalyticsResponsePinsItems::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPITopVideoPinsAnalyticsResponsePinsItems::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
