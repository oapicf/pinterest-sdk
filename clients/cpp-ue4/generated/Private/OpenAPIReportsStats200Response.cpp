...
void OpenAPIReportsStats200Response::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIReportsStats200Response::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
