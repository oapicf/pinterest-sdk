...
inline FString ToString(const OpenAPITargetingTemplateResponseData::StatusEnum& Value)
{
	switch (Value)
	{
	case OpenAPITargetingTemplateResponseData::StatusEnum::Active:
		return TEXT("ACTIVE");
	case OpenAPITargetingTemplateResponseData::StatusEnum::Deleted:
		return TEXT("DELETED");
	}

	UE_LOG(LogOpenAPI, Error, TEXT("Invalid OpenAPITargetingTemplateResponseData::StatusEnum Value (%d)"), (int)Value);
	return TEXT("");
}

FString OpenAPITargetingTemplateResponseData::EnumToString(const OpenAPITargetingTemplateResponseData::StatusEnum& EnumValue)
{
	return ToString(EnumValue);
}

inline bool FromString(const FString& EnumAsString, OpenAPITargetingTemplateResponseData::StatusEnum& Value)
{
	static TMap<FString, OpenAPITargetingTemplateResponseData::StatusEnum> StringToEnum = { 
		{ TEXT("ACTIVE"), OpenAPITargetingTemplateResponseData::StatusEnum::Active },
		{ TEXT("DELETED"), OpenAPITargetingTemplateResponseData::StatusEnum::Deleted }, };
...
bool OpenAPITargetingTemplateResponseData::EnumFromString(const FString& EnumAsString, OpenAPITargetingTemplateResponseData::StatusEnum& EnumValue)
{
	return FromString(EnumAsString, EnumValue);
}

inline void WriteJsonValue(JsonWriter& Writer, const OpenAPITargetingTemplateResponseData::StatusEnum& Value)
{
	WriteJsonValue(Writer, ToString(Value));
}

inline bool TryGetJsonValue(const TSharedPtr<FJsonValue>& JsonValue, OpenAPITargetingTemplateResponseData::StatusEnum& Value)
{
	FString TmpValue;
...
void OpenAPITargetingTemplateResponseData::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPITargetingTemplateResponseData::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
