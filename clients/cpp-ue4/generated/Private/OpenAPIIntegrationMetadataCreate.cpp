...
#include "OpenAPIIntegrationMetadataCreate.h"
...
void OpenAPIIntegrationMetadataCreate::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIIntegrationMetadataCreate::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
