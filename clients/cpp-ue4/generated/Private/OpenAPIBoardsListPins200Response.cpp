...
void OpenAPIBoardsListPins200Response::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIBoardsListPins200Response::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
