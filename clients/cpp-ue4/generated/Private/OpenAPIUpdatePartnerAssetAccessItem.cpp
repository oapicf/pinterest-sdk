...
void OpenAPIUpdatePartnerAssetAccessItem::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIUpdatePartnerAssetAccessItem::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
