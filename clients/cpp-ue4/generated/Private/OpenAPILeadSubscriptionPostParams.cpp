...
#include "OpenAPILeadSubscriptionPostParams.h"
...
void OpenAPILeadSubscriptionPostParams::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPILeadSubscriptionPostParams::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
