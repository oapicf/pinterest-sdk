...
void OpenAPIPinAnalyticsDailyMetrics::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIPinAnalyticsDailyMetrics::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
