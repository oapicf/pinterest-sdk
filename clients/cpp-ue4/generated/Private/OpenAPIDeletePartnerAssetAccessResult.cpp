...
void OpenAPIDeletePartnerAssetAccessResult::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIDeletePartnerAssetAccessResult::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
