...
void OpenAPIAdGroupsList200Response::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIAdGroupsList200Response::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
