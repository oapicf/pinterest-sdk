...
void OpenAPIGetPartnerAssetsResponse::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIGetPartnerAssetsResponse::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
