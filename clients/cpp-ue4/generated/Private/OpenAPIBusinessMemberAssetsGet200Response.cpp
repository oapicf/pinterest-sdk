...
void OpenAPIBusinessMemberAssetsGet200Response::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIBusinessMemberAssetsGet200Response::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
