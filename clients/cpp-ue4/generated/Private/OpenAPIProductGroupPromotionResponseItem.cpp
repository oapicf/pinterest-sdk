...
void OpenAPIProductGroupPromotionResponseItem::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIProductGroupPromotionResponseItem::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
