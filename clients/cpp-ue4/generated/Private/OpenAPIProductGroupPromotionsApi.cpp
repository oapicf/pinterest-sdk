...
FHttpRequestPtr OpenAPIProductGroupPromotionsApi::ProductGroupPromotionGet(const ProductGroupPromotionGetRequest& Request, const FProductGroupPromotionGetDelegate& Delegate /*= FProductGroupPromotionGetDelegate()*/) const
{
	if (!IsValid())
		return nullptr;
	...
	HttpRequest->OnProcessRequestComplete().BindRaw(this, &OpenAPIProductGroupPromotionsApi::OnProductGroupPromotionGetResponse, Delegate);
	HttpRequest->ProcessRequest();
	return HttpRequest;
}

void OpenAPIProductGroupPromotionsApi::OnProductGroupPromotionGetResponse(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FProductGroupPromotionGetDelegate Delegate) const
{
	ProductGroupPromotionGetResponse Response;
