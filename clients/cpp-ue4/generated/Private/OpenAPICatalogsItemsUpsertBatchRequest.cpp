...
inline FString ToString(const OpenAPICatalogsItemsUpsertBatchRequest::LanguageEnum& Value)
{
	...
	case OpenAPICatalogsItemsUpsertBatchRequest::LanguageEnum::Nl2:
		return TEXT("NL");
	case OpenAPICatalogsItemsUpsertBatchRequest::LanguageEnum::_False:
		return TEXT("false");
...
inline bool FromString(const FString& EnumAsString, OpenAPICatalogsItemsUpsertBatchRequest::LanguageEnum& Value)
{
	static TMap<FString, OpenAPICatalogsItemsUpsertBatchRequest::LanguageEnum> StringToEnum = { 
		...
		{ TEXT("false"), OpenAPICatalogsItemsUpsertBatchRequest::LanguageEnum::_False },
...
inline FString ToString(const OpenAPICatalogsItemsUpsertBatchRequest::OperationEnum& Value)
{
	switch (Value)
	{
	case OpenAPICatalogsItemsUpsertBatchRequest::OperationEnum::Upsert:
		return TEXT("UPSERT");
	}

	UE_LOG(LogOpenAPI, Error, TEXT("Invalid OpenAPICatalogsItemsUpsertBatchRequest::OperationEnum Value (%d)"), (int)Value);
	return TEXT("");
}

FString OpenAPICatalogsItemsUpsertBatchRequest::EnumToString(const OpenAPICatalogsItemsUpsertBatchRequest::OperationEnum& EnumValue)
{
	return ToString(EnumValue);
}

inline bool FromString(const FString& EnumAsString, OpenAPICatalogsItemsUpsertBatchRequest::OperationEnum& Value)
{
	static TMap<FString, OpenAPICatalogsItemsUpsertBatchRequest::OperationEnum> StringToEnum = { 
		{ TEXT("UPSERT"), OpenAPICatalogsItemsUpsertBatchRequest::OperationEnum::Upsert }, };
...
bool OpenAPICatalogsItemsUpsertBatchRequest::EnumFromString(const FString& EnumAsString, OpenAPICatalogsItemsUpsertBatchRequest::OperationEnum& EnumValue)
{
	return FromString(EnumAsString, EnumValue);
}

inline void WriteJsonValue(JsonWriter& Writer, const OpenAPICatalogsItemsUpsertBatchRequest::OperationEnum& Value)
{
	WriteJsonValue(Writer, ToString(Value));
}

inline bool TryGetJsonValue(const TSharedPtr<FJsonValue>& JsonValue, OpenAPICatalogsItemsUpsertBatchRequest::OperationEnum& Value)
{
	FString TmpValue;
	if (JsonValue->TryGetString(TmpValue))
	{
