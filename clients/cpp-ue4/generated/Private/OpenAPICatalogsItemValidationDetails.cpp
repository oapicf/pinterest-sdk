...
void OpenAPICatalogsItemValidationDetails::WriteJson(JsonWriter& Writer) const
{
	...
	{
		Writer->WriteIdentifierPrefix(TEXT("attribute_name")); WriteJsonValue(Writer, AttributeName.GetValue());
	}
	if (ProvidedValue.IsSet())
	{
		Writer->WriteIdentifierPrefix(TEXT("provided_value")); WriteJsonValue(Writer, ProvidedValue.GetValue());
	}
