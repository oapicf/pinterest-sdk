...
void OpenAPIAdvancedAuctionItemsGetRequest::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIAdvancedAuctionItemsGetRequest::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
