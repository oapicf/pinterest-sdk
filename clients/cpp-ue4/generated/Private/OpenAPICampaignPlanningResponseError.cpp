...
void OpenAPICampaignPlanningResponseError::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPICampaignPlanningResponseError::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
