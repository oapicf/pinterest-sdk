...
void OpenAPIMembersToDeleteBodyMembersInner::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIMembersToDeleteBodyMembersInner::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
