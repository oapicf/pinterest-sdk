...
void OpenAPIFollowersList200Response::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIFollowersList200Response::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
