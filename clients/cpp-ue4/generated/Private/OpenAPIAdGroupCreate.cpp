...
#include "OpenAPIAdGroupCreate.h"
...
void OpenAPIAdGroupCreate::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIAdGroupCreate::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
