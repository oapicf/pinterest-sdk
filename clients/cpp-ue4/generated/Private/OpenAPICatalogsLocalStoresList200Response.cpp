...
void OpenAPICatalogsLocalStoresList200Response::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPICatalogsLocalStoresList200Response::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
