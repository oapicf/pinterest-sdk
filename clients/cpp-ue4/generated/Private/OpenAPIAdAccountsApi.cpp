...
FHttpRequestPtr OpenAPIAdAccountsApi::AdGroupsList(const AdGroupsListRequest& Request, const FAdGroupsListDelegate& Delegate /*= FAdGroupsListDelegate()*/) const
{
	if (!IsValid())
		return nullptr;
	...
	HttpRequest->OnProcessRequestComplete().BindRaw(this, &OpenAPIAdAccountsApi::OnAdGroupsListResponse, Delegate);
	HttpRequest->ProcessRequest();
	return HttpRequest;
}

void OpenAPIAdAccountsApi::OnAdGroupsListResponse(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FAdGroupsListDelegate Delegate) const
{
...
FHttpRequestPtr OpenAPIAdAccountsApi::AdsList(const AdsListRequest& Request, const FAdsListDelegate& Delegate /*= FAdsListDelegate()*/) const
{
	if (!IsValid())
		return nullptr;
	...
	HttpRequest->OnProcessRequestComplete().BindRaw(this, &OpenAPIAdAccountsApi::OnAdsListResponse, Delegate);
	HttpRequest->ProcessRequest();
	return HttpRequest;
}

void OpenAPIAdAccountsApi::OnAdsListResponse(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FAdsListDelegate Delegate) const
{
...
FHttpRequestPtr OpenAPIAdAccountsApi::CampaignsList(const CampaignsListRequest& Request, const FCampaignsListDelegate& Delegate /*= FCampaignsListDelegate()*/) const
{
	if (!IsValid())
		return nullptr;
	...
	HttpRequest->OnProcessRequestComplete().BindRaw(this, &OpenAPIAdAccountsApi::OnCampaignsListResponse, Delegate);
	HttpRequest->ProcessRequest();
	return HttpRequest;
}

void OpenAPIAdAccountsApi::OnCampaignsListResponse(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FCampaignsListDelegate Delegate) const
{
