...
void OpenAPITopPinsAnalyticsResponsePinsItems::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPITopPinsAnalyticsResponsePinsItems::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
