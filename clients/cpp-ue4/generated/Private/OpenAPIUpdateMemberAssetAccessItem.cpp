...
void OpenAPIUpdateMemberAssetAccessItem::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIUpdateMemberAssetAccessItem::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
