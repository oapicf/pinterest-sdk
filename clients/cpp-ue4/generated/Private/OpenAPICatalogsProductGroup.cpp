...
inline FString ToString(const OpenAPICatalogsProductGroup::CatalogTypeEnum& Value)
{
	switch (Value)
	{
	case OpenAPICatalogsProductGroup::CatalogTypeEnum::Retail:
		return TEXT("RETAIL");
	}

	UE_LOG(LogOpenAPI, Error, TEXT("Invalid OpenAPICatalogsProductGroup::CatalogTypeEnum Value (%d)"), (int)Value);
	return TEXT("");
}

FString OpenAPICatalogsProductGroup::EnumToString(const OpenAPICatalogsProductGroup::CatalogTypeEnum& EnumValue)
{
	return ToString(EnumValue);
}

inline bool FromString(const FString& EnumAsString, OpenAPICatalogsProductGroup::CatalogTypeEnum& Value)
{
	static TMap<FString, OpenAPICatalogsProductGroup::CatalogTypeEnum> StringToEnum = { 
		{ TEXT("RETAIL"), OpenAPICatalogsProductGroup::CatalogTypeEnum::Retail }, };
...
bool OpenAPICatalogsProductGroup::EnumFromString(const FString& EnumAsString, OpenAPICatalogsProductGroup::CatalogTypeEnum& EnumValue)
{
	return FromString(EnumAsString, EnumValue);
}

inline void WriteJsonValue(JsonWriter& Writer, const OpenAPICatalogsProductGroup::CatalogTypeEnum& Value)
{
	WriteJsonValue(Writer, ToString(Value));
}

inline bool TryGetJsonValue(const TSharedPtr<FJsonValue>& JsonValue, OpenAPICatalogsProductGroup::CatalogTypeEnum& Value)
{
	FString TmpValue;
