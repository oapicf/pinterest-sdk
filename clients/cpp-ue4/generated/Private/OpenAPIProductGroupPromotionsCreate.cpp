...
void OpenAPIProductGroupPromotionsCreate::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIProductGroupPromotionsCreate::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
