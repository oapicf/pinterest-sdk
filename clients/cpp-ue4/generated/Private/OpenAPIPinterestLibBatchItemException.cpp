...
void OpenAPIPinterestLibBatchItemException::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIPinterestLibBatchItemException::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
