...
void OpenAPIAdGroupArrayResponseElement::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIAdGroupArrayResponseElement::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
