...
void OpenAPIBusinessAssetsGet200Response::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIBusinessAssetsGet200Response::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
