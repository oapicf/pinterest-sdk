...
#include "OpenAPIIntegrationMetadataUpdate.h"
...
void OpenAPIIntegrationMetadataUpdate::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIIntegrationMetadataUpdate::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
