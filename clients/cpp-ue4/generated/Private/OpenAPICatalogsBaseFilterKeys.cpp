...
void OpenAPICatalogsBaseFilterKeys::WriteJson(JsonWriter& Writer) const
{
	...
	Writer->WriteIdentifierPrefix(TEXT("CUSTOM_NUMBER_2")); WriteJsonValue(Writer, CUSTOMNUMBER2);
	Writer->WriteIdentifierPrefix(TEXT("CUSTOM_NUMBER_3")); WriteJsonValue(Writer, CUSTOMNUMBER3);
	Writer->WriteIdentifierPrefix(TEXT("CUSTOM_NUMBER_4")); WriteJsonValue(Writer, CUSTOMNUMBER4);
	Writer->WriteIdentifierPrefix(TEXT("TITLE_KEYWORDS")); WriteJsonValue(Writer, TitleKeywords);
	Writer->WriteIdentifierPrefix(TEXT("PINTEREST_PRODUCT_CATEGORIES")); WriteJsonValue(Writer, PinterestProductCategories);
	Writer->WriteObjectEnd();
}

bool OpenAPICatalogsBaseFilterKeys::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
	...
	ParseSuccess &= TryGetJsonValue(*Object, TEXT("TITLE_KEYWORDS"), TitleKeywords);
