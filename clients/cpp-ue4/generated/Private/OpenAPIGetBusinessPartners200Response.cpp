...
void OpenAPIGetBusinessPartners200Response::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIGetBusinessPartners200Response::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
