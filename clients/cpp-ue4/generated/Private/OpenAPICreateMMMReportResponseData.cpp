...
void OpenAPICreateMMMReportResponseData::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPICreateMMMReportResponseData::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
