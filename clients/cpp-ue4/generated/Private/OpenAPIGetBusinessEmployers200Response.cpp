...
void OpenAPIGetBusinessEmployers200Response::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIGetBusinessEmployers200Response::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
