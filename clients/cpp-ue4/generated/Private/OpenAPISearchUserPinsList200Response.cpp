...
void OpenAPISearchUserPinsList200Response::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPISearchUserPinsList200Response::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
