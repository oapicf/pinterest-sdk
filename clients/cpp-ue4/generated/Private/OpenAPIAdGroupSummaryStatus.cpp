...
inline FString ToString(const OpenAPIAdGroupSummaryStatus::Values& Value)
{
	...
	case OpenAPIAdGroupSummaryStatus::Values::Draft:
		return TEXT("DRAFT");
	case OpenAPIAdGroupSummaryStatus::Values::DeletedDraft:
...
inline bool FromString(const FString& EnumAsString, OpenAPIAdGroupSummaryStatus::Values& Value)
{
	static TMap<FString, OpenAPIAdGroupSummaryStatus::Values> StringToEnum = { 
		...
		{ TEXT("DRAFT"), OpenAPIAdGroupSummaryStatus::Values::Draft },
		{ TEXT("DELETED_DRAFT"), OpenAPIAdGroupSummaryStatus::Values::DeletedDraft }, };
