...
inline FString ToString(const OpenAPIUpdateMaskFieldType::Values& Value)
{
	...
	case OpenAPIUpdateMaskFieldType::Values::CustomNumber0:
		return TEXT("custom_number_0");
	case OpenAPIUpdateMaskFieldType::Values::CustomNumber1:
		return TEXT("custom_number_1");
	case OpenAPIUpdateMaskFieldType::Values::CustomNumber2:
		return TEXT("custom_number_2");
	case OpenAPIUpdateMaskFieldType::Values::CustomNumber3:
		return TEXT("custom_number_3");
	case OpenAPIUpdateMaskFieldType::Values::CustomNumber4:
		return TEXT("custom_number_4");
	...
	case OpenAPIUpdateMaskFieldType::Values::PromotionId:
		return TEXT("promotion_id");
	}
...
inline bool FromString(const FString& EnumAsString, OpenAPIUpdateMaskFieldType::Values& Value)
{
	static TMap<FString, OpenAPIUpdateMaskFieldType::Values> StringToEnum = { 
		...
		{ TEXT("custom_number_0"), OpenAPIUpdateMaskFieldType::Values::CustomNumber0 },
		{ TEXT("custom_number_1"), OpenAPIUpdateMaskFieldType::Values::CustomNumber1 },
		{ TEXT("custom_number_2"), OpenAPIUpdateMaskFieldType::Values::CustomNumber2 },
		{ TEXT("custom_number_3"), OpenAPIUpdateMaskFieldType::Values::CustomNumber3 },
		{ TEXT("custom_number_4"), OpenAPIUpdateMaskFieldType::Values::CustomNumber4 },
		...
		{ TEXT("promotion_id"), OpenAPIUpdateMaskFieldType::Values::PromotionId }, };
