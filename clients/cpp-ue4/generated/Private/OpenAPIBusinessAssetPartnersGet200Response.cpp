...
void OpenAPIBusinessAssetPartnersGet200Response::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIBusinessAssetPartnersGet200Response::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
