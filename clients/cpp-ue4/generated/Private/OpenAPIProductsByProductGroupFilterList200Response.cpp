...
void OpenAPIProductsByProductGroupFilterList200Response::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIProductsByProductGroupFilterList200Response::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
