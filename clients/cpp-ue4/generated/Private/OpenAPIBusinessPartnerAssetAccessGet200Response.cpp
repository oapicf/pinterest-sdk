...
void OpenAPIBusinessPartnerAssetAccessGet200Response::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIBusinessPartnerAssetAccessGet200Response::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
