...
inline FString ToString(const OpenAPIObjectiveType::Values& Value)
{
	...
	case OpenAPIObjectiveType::Values::Sales:
		return TEXT("SALES");
	case OpenAPIObjectiveType::Values::AppInstall:
		return TEXT("APP_INSTALL");
	case OpenAPIObjectiveType::Values::CtvConsideration:
...
inline bool FromString(const FString& EnumAsString, OpenAPIObjectiveType::Values& Value)
{
	static TMap<FString, OpenAPIObjectiveType::Values> StringToEnum = { 
		...
		{ TEXT("SALES"), OpenAPIObjectiveType::Values::Sales },
		{ TEXT("APP_INSTALL"), OpenAPIObjectiveType::Values::AppInstall },
		{ TEXT("CTV_CONSIDERATION"), OpenAPIObjectiveType::Values::CtvConsideration }, };
