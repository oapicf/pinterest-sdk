...
inline FString ToString(const OpenAPIObjectiveType::Values& Value)
{
	...
	case OpenAPIObjectiveType::Values::AwarenessReserved:
		return TEXT("AWARENESS_RESERVED");
	case OpenAPIObjectiveType::Values::Engagement:
...
inline bool FromString(const FString& EnumAsString, OpenAPIObjectiveType::Values& Value)
{
	static TMap<FString, OpenAPIObjectiveType::Values> StringToEnum = { 
		...
		{ TEXT("AWARENESS_RESERVED"), OpenAPIObjectiveType::Values::AwarenessReserved },
		{ TEXT("ENGAGEMENT"), OpenAPIObjectiveType::Values::Engagement }, };
...
inline FStringFormatArg ToStringFormatArg(const OpenAPIObjectiveType::Values& Value)
{
