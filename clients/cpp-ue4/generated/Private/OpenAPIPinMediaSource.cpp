...
inline FStringFormatArg ToStringFormatArg(const OpenAPIPinMediaSource::SourceTypeEnum& Value)
{
...
inline FStringFormatArg ToStringFormatArg(const OpenAPIPinMediaSource::ContentTypeEnum& Value)
{
	return FStringFormatArg(ToString(Value));
}
