...
inline FString ToString(const OpenAPICatalogsVerticalProductGroup::CatalogTypeEnum& Value)
{
	switch (Value)
	{
	case OpenAPICatalogsVerticalProductGroup::CatalogTypeEnum::CreativeAssets:
...
inline bool FromString(const FString& EnumAsString, OpenAPICatalogsVerticalProductGroup::CatalogTypeEnum& Value)
{
	static TMap<FString, OpenAPICatalogsVerticalProductGroup::CatalogTypeEnum> StringToEnum = { 
		{ TEXT("CREATIVE_ASSETS"), OpenAPICatalogsVerticalProductGroup::CatalogTypeEnum::CreativeAssets }, };
