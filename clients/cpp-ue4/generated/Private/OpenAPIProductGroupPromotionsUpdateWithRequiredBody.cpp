...
void OpenAPIProductGroupPromotionsUpdateWithRequiredBody::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIProductGroupPromotionsUpdateWithRequiredBody::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
