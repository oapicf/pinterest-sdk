...
void OpenAPICatalogsListProductsByFilterRequestOneOf::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPICatalogsListProductsByFilterRequestOneOf::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
