...
void OpenAPIItemsIssuesList200Response::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIItemsIssuesList200Response::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
