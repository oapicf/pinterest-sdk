...
void OpenAPIConversionEventsDataItems::WriteJson(JsonWriter& Writer) const
{
	...
	if (AppInfo.IsSet())
	{
		Writer->WriteIdentifierPrefix(TEXT("app_info")); WriteJsonValue(Writer, AppInfo.GetValue());
	}
	if (AppName.IsSet())
	{
	...
	if (DeviceInfo.IsSet())
	{
		Writer->WriteIdentifierPrefix(TEXT("device_info")); WriteJsonValue(Writer, DeviceInfo.GetValue());
	}
...
bool OpenAPIConversionEventsDataItems::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
	...
	ParseSuccess &= TryGetJsonValue(*Object, TEXT("app_info"), AppInfo);
	...
	ParseSuccess &= TryGetJsonValue(*Object, TEXT("device_info"), DeviceInfo);
