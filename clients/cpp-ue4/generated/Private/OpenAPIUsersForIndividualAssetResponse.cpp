...
void OpenAPIUsersForIndividualAssetResponse::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIUsersForIndividualAssetResponse::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
