...
inline FString ToString(const OpenAPIMMMReportingColumn::Values& Value)
{
	...
	case OpenAPIMMMReportingColumn::Values::CampaignObjectiveType:
		return TEXT("CAMPAIGN_OBJECTIVE_TYPE");
	case OpenAPIMMMReportingColumn::Values::PinnerListName:
		return TEXT("PINNER_LIST_NAME");
	case OpenAPIMMMReportingColumn::Values::AdsCreditSpendInDollar:
		return TEXT("ADS_CREDIT_SPEND_IN_DOLLAR");
	case OpenAPIMMMReportingColumn::Values::AdvertiserPaidSpendInDollar:
		return TEXT("ADVERTISER_PAID_SPEND_IN_DOLLAR");
	case OpenAPIMMMReportingColumn::Values::AdvertiserPaidEcpcInDollar:
		return TEXT("ADVERTISER_PAID_ECPC_IN_DOLLAR");
	case OpenAPIMMMReportingColumn::Values::AdvertiserPaidEcpmInDollar:
		return TEXT("ADVERTISER_PAID_ECPM_IN_DOLLAR");
	}
...
inline bool FromString(const FString& EnumAsString, OpenAPIMMMReportingColumn::Values& Value)
{
	static TMap<FString, OpenAPIMMMReportingColumn::Values> StringToEnum = { 
		...
		{ TEXT("CAMPAIGN_OBJECTIVE_TYPE"), OpenAPIMMMReportingColumn::Values::CampaignObjectiveType },
		{ TEXT("PINNER_LIST_NAME"), OpenAPIMMMReportingColumn::Values::PinnerListName },
		{ TEXT("ADS_CREDIT_SPEND_IN_DOLLAR"), OpenAPIMMMReportingColumn::Values::AdsCreditSpendInDollar },
		{ TEXT("ADVERTISER_PAID_SPEND_IN_DOLLAR"), OpenAPIMMMReportingColumn::Values::AdvertiserPaidSpendInDollar },
		{ TEXT("ADVERTISER_PAID_ECPC_IN_DOLLAR"), OpenAPIMMMReportingColumn::Values::AdvertiserPaidEcpcInDollar },
		{ TEXT("ADVERTISER_PAID_ECPM_IN_DOLLAR"), OpenAPIMMMReportingColumn::Values::AdvertiserPaidEcpmInDollar }, };
