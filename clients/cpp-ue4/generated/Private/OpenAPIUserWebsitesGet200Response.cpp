...
void OpenAPIUserWebsitesGet200Response::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIUserWebsitesGet200Response::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
