...
void OpenAPIOrderLinesList200Response::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIOrderLinesList200Response::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
