...
void OpenAPITemplatesList200Response::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPITemplatesList200Response::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
