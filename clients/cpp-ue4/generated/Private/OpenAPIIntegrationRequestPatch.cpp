...
void OpenAPIIntegrationRequestPatch::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIIntegrationRequestPatch::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
