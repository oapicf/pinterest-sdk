...
void OpenAPIGetBusinessMembers200Response::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIGetBusinessMembers200Response::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
