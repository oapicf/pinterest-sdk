...
void OpenAPIAudiencesList200Response::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIAudiencesList200Response::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
