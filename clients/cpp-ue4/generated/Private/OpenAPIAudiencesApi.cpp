...
FHttpRequestPtr OpenAPIAudiencesApi::AudiencesCreateCustom(const AudiencesCreateCustomRequest& Request, const FAudiencesCreateCustomDelegate& Delegate /*= FAudiencesCreateCustomDelegate()*/) const
{
	if (!IsValid())
		return nullptr;
	...
	HttpRequest->OnProcessRequestComplete().BindRaw(this, &OpenAPIAudiencesApi::OnAudiencesCreateCustomResponse, Delegate);
	HttpRequest->ProcessRequest();
	return HttpRequest;
}

void OpenAPIAudiencesApi::OnAudiencesCreateCustomResponse(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FAudiencesCreateCustomDelegate Delegate) const
{
	AudiencesCreateCustomResponse Response;
	HandleResponse(HttpResponse, bSucceeded, Response);
	Delegate.ExecuteIfBound(Response);
}
