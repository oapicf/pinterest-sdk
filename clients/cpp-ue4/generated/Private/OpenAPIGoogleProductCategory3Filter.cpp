...
void OpenAPIGoogleProductCategory3Filter::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIGoogleProductCategory3Filter::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
