...
inline FString ToString(const OpenAPICatalogsCreativeAssetsFeedsCreateRequest::CatalogTypeEnum& Value)
{
	switch (Value)
	{
	case OpenAPICatalogsCreativeAssetsFeedsCreateRequest::CatalogTypeEnum::CreativeAssets:
		return TEXT("CREATIVE_ASSETS");
	}

	UE_LOG(LogOpenAPI, Error, TEXT("Invalid OpenAPICatalogsCreativeAssetsFeedsCreateRequest::CatalogTypeEnum Value (%d)"), (int)Value);
	return TEXT("");
}

FString OpenAPICatalogsCreativeAssetsFeedsCreateRequest::EnumToString(const OpenAPICatalogsCreativeAssetsFeedsCreateRequest::CatalogTypeEnum& EnumValue)
{
	return ToString(EnumValue);
}

inline bool FromString(const FString& EnumAsString, OpenAPICatalogsCreativeAssetsFeedsCreateRequest::CatalogTypeEnum& Value)
{
	static TMap<FString, OpenAPICatalogsCreativeAssetsFeedsCreateRequest::CatalogTypeEnum> StringToEnum = { 
		{ TEXT("CREATIVE_ASSETS"), OpenAPICatalogsCreativeAssetsFeedsCreateRequest::CatalogTypeEnum::CreativeAssets }, };
...
bool OpenAPICatalogsCreativeAssetsFeedsCreateRequest::EnumFromString(const FString& EnumAsString, OpenAPICatalogsCreativeAssetsFeedsCreateRequest::CatalogTypeEnum& EnumValue)
{
	return FromString(EnumAsString, EnumValue);
}

inline void WriteJsonValue(JsonWriter& Writer, const OpenAPICatalogsCreativeAssetsFeedsCreateRequest::CatalogTypeEnum& Value)
{
	WriteJsonValue(Writer, ToString(Value));
}

inline bool TryGetJsonValue(const TSharedPtr<FJsonValue>& JsonValue, OpenAPICatalogsCreativeAssetsFeedsCreateRequest::CatalogTypeEnum& Value)
{
	FString TmpValue;
