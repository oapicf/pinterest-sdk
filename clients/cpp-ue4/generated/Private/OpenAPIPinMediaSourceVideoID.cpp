...
void OpenAPIPinMediaSourceVideoID::WriteJson(JsonWriter& Writer) const
{
	...
	if (CoverImageKeyFrameTime.IsSet())
	{
		Writer->WriteIdentifierPrefix(TEXT("cover_image_key_frame_time")); WriteJsonValue(Writer, CoverImageKeyFrameTime.GetValue());
	}
...
bool OpenAPIPinMediaSourceVideoID::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
	...
	ParseSuccess &= TryGetJsonValue(*Object, TEXT("cover_image_key_frame_time"), CoverImageKeyFrameTime);
