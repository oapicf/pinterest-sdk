...
inline FString ToString(const OpenAPIMMMReportingTargetingType::Values& Value)
{
	...
	case OpenAPIMMMReportingTargetingType::Values::Placement:
		return TEXT("PLACEMENT");
	case OpenAPIMMMReportingTargetingType::Values::AudienceInclude:
...
inline bool FromString(const FString& EnumAsString, OpenAPIMMMReportingTargetingType::Values& Value)
{
	static TMap<FString, OpenAPIMMMReportingTargetingType::Values> StringToEnum = { 
		...
		{ TEXT("PLACEMENT"), OpenAPIMMMReportingTargetingType::Values::Placement },
		{ TEXT("AUDIENCE_INCLUDE"), OpenAPIMMMReportingTargetingType::Values::AudienceInclude }, };
