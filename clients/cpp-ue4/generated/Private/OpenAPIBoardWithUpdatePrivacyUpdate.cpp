...
void OpenAPIBoardWithUpdatePrivacyUpdate::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIBoardWithUpdatePrivacyUpdate::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
