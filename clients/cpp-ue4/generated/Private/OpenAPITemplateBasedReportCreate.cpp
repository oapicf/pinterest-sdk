...
#include "OpenAPITemplateBasedReportCreate.h"
...
void OpenAPITemplateBasedReportCreate::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPITemplateBasedReportCreate::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
