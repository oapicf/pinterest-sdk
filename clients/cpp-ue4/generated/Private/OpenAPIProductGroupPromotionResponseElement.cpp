...
void OpenAPIProductGroupPromotionResponseElement::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIProductGroupPromotionResponseElement::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
