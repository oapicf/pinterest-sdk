...
void OpenAPIBillingInvoicesGet200Response::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIBillingInvoicesGet200Response::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
