...
inline FString ToString(const OpenAPIBillingProfilesResponse::BillingTypeEnum& Value)
{
	switch (Value)
	{
	case OpenAPIBillingProfilesResponse::BillingTypeEnum::CreditCard:
		return TEXT("CREDIT_CARD");
	case OpenAPIBillingProfilesResponse::BillingTypeEnum::Invoice:
		return TEXT("INVOICE");
	case OpenAPIBillingProfilesResponse::BillingTypeEnum::Internal:
		return TEXT("INTERNAL");
	case OpenAPIBillingProfilesResponse::BillingTypeEnum::Recurring:
		return TEXT("RECURRING");
	case OpenAPIBillingProfilesResponse::BillingTypeEnum::Prepaid:
		return TEXT("PREPAID");
	}

	UE_LOG(LogOpenAPI, Error, TEXT("Invalid OpenAPIBillingProfilesResponse::BillingTypeEnum Value (%d)"), (int)Value);
	return TEXT("");
}

FString OpenAPIBillingProfilesResponse::EnumToString(const OpenAPIBillingProfilesResponse::BillingTypeEnum& EnumValue)
{
	return ToString(EnumValue);
}

inline bool FromString(const FString& EnumAsString, OpenAPIBillingProfilesResponse::BillingTypeEnum& Value)
{
	static TMap<FString, OpenAPIBillingProfilesResponse::BillingTypeEnum> StringToEnum = { 
		{ TEXT("CREDIT_CARD"), OpenAPIBillingProfilesResponse::BillingTypeEnum::CreditCard },
		{ TEXT("INVOICE"), OpenAPIBillingProfilesResponse::BillingTypeEnum::Invoice },
		{ TEXT("INTERNAL"), OpenAPIBillingProfilesResponse::BillingTypeEnum::Internal },
		{ TEXT("RECURRING"), OpenAPIBillingProfilesResponse::BillingTypeEnum::Recurring },
		{ TEXT("PREPAID"), OpenAPIBillingProfilesResponse::BillingTypeEnum::Prepaid }, };
...
bool OpenAPIBillingProfilesResponse::EnumFromString(const FString& EnumAsString, OpenAPIBillingProfilesResponse::BillingTypeEnum& EnumValue)
{
	return FromString(EnumAsString, EnumValue);
}

inline void WriteJsonValue(JsonWriter& Writer, const OpenAPIBillingProfilesResponse::BillingTypeEnum& Value)
{
	WriteJsonValue(Writer, ToString(Value));
}

inline bool TryGetJsonValue(const TSharedPtr<FJsonValue>& JsonValue, OpenAPIBillingProfilesResponse::BillingTypeEnum& Value)
{
	FString TmpValue;
