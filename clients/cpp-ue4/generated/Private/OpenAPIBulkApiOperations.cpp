...
void OpenAPIBulkApi::BulkDownloadCreateRequest::SetupHttpRequest(const FHttpRequestRef& HttpRequest) const
{
	...
	if (Consumes.Num() == 0 || Consumes.Contains(TEXT("application/json")))
	{
		...
		WriteJsonValue(Writer, OpenAPIBulkDownloadCreate);
		Writer->Close();
	...
	{
		UE_LOG(LogOpenAPI, Error, TEXT("Body parameter (OpenAPIBulkDownloadCreate) was ignored, not supported in multipart form"));
	}
	else if (Consumes.Contains(TEXT("application/x-www-form-urlencoded")))
	{
		UE_LOG(LogOpenAPI, Error, TEXT("Body parameter (OpenAPIBulkDownloadCreate) was ignored, not supported in urlencoded requests"));
	}
	else
	{
...
FString OpenAPIBulkApi::BulkRequestGetRequest::ComputePath() const
{
	...
	{
		QueryParams.Add(FString(TEXT("include_details=")) + ToUrlString(IncludeDetails.GetValue()));
	}
	Path += TCHAR('?');
