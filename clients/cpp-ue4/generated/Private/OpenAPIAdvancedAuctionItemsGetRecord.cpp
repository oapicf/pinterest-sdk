...
void OpenAPIAdvancedAuctionItemsGetRecord::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIAdvancedAuctionItemsGetRecord::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
