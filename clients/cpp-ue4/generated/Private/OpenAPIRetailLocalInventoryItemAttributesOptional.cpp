...
void OpenAPIRetailLocalInventoryItemAttributesOptional::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIRetailLocalInventoryItemAttributesOptional::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
