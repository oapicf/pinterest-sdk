...
void OpenAPIAnalyticsMetricsResponseDailyMetricsInner::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIAnalyticsMetricsResponseDailyMetricsInner::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
