...
void OpenAPIIntegrationsGetList200Response::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIIntegrationsGetList200Response::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
