...
void OpenAPICampaignPlanningConversionAttribution::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPICampaignPlanningConversionAttribution::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
