...
void OpenAPIBusinessAccessRelationshipsApi::BrandAccountsCreateRequest::SetupHttpRequest(const FHttpRequestRef& HttpRequest) const
{
	...
	if (Consumes.Num() == 0 || Consumes.Contains(TEXT("application/json")))
	{
		...
		WriteJsonValue(Writer, OpenAPIBrandAccountsCreateRequest);
		Writer->Close();
	...
	{
		UE_LOG(LogOpenAPI, Error, TEXT("Body parameter (OpenAPIBrandAccountsCreateRequest) was ignored, not supported in multipart form"));
	}
	else if (Consumes.Contains(TEXT("application/x-www-form-urlencoded")))
	{
		UE_LOG(LogOpenAPI, Error, TEXT("Body parameter (OpenAPIBrandAccountsCreateRequest) was ignored, not supported in urlencoded requests"));
	}
	else
	{
...
void OpenAPIBusinessAccessRelationshipsApi::BrandAccountsUpdateRequest::SetupHttpRequest(const FHttpRequestRef& HttpRequest) const
{
	...
	if (Consumes.Num() == 0 || Consumes.Contains(TEXT("application/json")))
	{
		...
		WriteJsonValue(Writer, OpenAPIBrandAccountsUpdateRequest);
		Writer->Close();
	...
	{
		UE_LOG(LogOpenAPI, Error, TEXT("Body parameter (OpenAPIBrandAccountsUpdateRequest) was ignored, not supported in multipart form"));
	}
	else if (Consumes.Contains(TEXT("application/x-www-form-urlencoded")))
	{
		UE_LOG(LogOpenAPI, Error, TEXT("Body parameter (OpenAPIBrandAccountsUpdateRequest) was ignored, not supported in urlencoded requests"));
	}
	else
	{
		UE_LOG(LogOpenAPI, Error, TEXT("Request ContentType not supported (%s)"), *FString::Join(Consumes, TEXT(",")));
...
void OpenAPIBusinessAccessRelationshipsApi::BrandAccountsUpdateResponse::SetHttpResponseCode(EHttpResponseCodes::Type InHttpResponseCode)
{
	...
	case 400:
		...
		break;
	case 401:
		SetResponseString(TEXT("Not authenticated to update Brand Account"));
		break;
	case 403:
		SetResponseString(TEXT("Not authorized to update Brand Account"));
		break;
	case 404:
		SetResponseString(TEXT("Brand account not found"));
		break;
	case 409:
		SetResponseString(TEXT("This account is not a brand account."));
		break;
	case 429:
...
void OpenAPIBusinessAccessRelationshipsApi::SystemUserUpdateRequest::SetupHttpRequest(const FHttpRequestRef& HttpRequest) const
{
	...
	if (Consumes.Num() == 0 || Consumes.Contains(TEXT("application/json")))
	{
		...
		WriteJsonValue(Writer, OpenAPISystemUserUpdateRequest);
		Writer->Close();
	...
	{
		UE_LOG(LogOpenAPI, Error, TEXT("Body parameter (OpenAPISystemUserUpdateRequest) was ignored, not supported in multipart form"));
	}
	else if (Consumes.Contains(TEXT("application/x-www-form-urlencoded")))
	{
		UE_LOG(LogOpenAPI, Error, TEXT("Body parameter (OpenAPISystemUserUpdateRequest) was ignored, not supported in urlencoded requests"));
	}
	else
	{
		UE_LOG(LogOpenAPI, Error, TEXT("Request ContentType not supported (%s)"), *FString::Join(Consumes, TEXT(",")));
...
void OpenAPIBusinessAccessRelationshipsApi::SystemUserUpdateResponse::SetHttpResponseCode(EHttpResponseCodes::Type InHttpResponseCode)
{
	...
	{
	case 200:
		SetResponseString(TEXT("System user updated successfully."));
		break;
	case 400:
		SetResponseString(TEXT("Invalid parameters."));
		break;
