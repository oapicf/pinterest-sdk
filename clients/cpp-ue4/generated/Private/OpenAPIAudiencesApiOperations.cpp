...
FString OpenAPIAudiencesApi::AudiencesGetRequest::ComputePath() const
{
	TMap<FString, FStringFormatArg> PathParams = { 
	{ TEXT("ad_account_id"), ToStringFormatArg(AdAccountId) },
	{ TEXT("audience_id"), ToStringFormatArg(AudienceId) } };
...
inline FStringFormatArg ToStringFormatArg(const OpenAPIAudiencesApi::AudiencesListRequest::EntityStatusesEnum& Value)
{
...
inline FStringFormatArg ToStringFormatArg(const OpenAPIAudiencesApi::AudiencesListRequest::OrderEnum& Value)
{
	return FStringFormatArg(ToString(Value));
}
