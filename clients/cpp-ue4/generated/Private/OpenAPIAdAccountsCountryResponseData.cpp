...
void OpenAPIAdAccountsCountryResponseData::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIAdAccountsCountryResponseData::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
