...
void OpenAPIInviteAssetsSummaryAdAccountsInner::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIInviteAssetsSummaryAdAccountsInner::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
