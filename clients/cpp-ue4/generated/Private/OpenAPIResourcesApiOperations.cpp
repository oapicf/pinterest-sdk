...
inline FStringFormatArg ToStringFormatArg(const OpenAPIResourcesApi::DeliveryMetricsGetRequest::ReportTypeEnum& Value)
{
...
FString OpenAPIResourcesApi::InterestTargetingOptionsGetRequest::ComputePath() const
{
	...
	{ TEXT("interest_id"), ToStringFormatArg(InterestId) } };
...
inline FStringFormatArg ToStringFormatArg(const OpenAPIResourcesApi::TargetingOptionsGetRequest::TargetingTypeEnum& Value)
{
	return FStringFormatArg(ToString(Value));
}
...
{
	TMap<FString, FStringFormatArg> PathParams = { 
	{ TEXT("targeting_type"), ToStringFormatArg(TargetingType) } };
