...
inline FString ToString(const OpenAPICatalogsVerticalFeedsCreateRequest::CatalogTypeEnum& Value)
{
	switch (Value)
	{
	case OpenAPICatalogsVerticalFeedsCreateRequest::CatalogTypeEnum::CreativeAssets:
		return TEXT("CREATIVE_ASSETS");
	}

	UE_LOG(LogOpenAPI, Error, TEXT("Invalid OpenAPICatalogsVerticalFeedsCreateRequest::CatalogTypeEnum Value (%d)"), (int)Value);
	return TEXT("");
}

FString OpenAPICatalogsVerticalFeedsCreateRequest::EnumToString(const OpenAPICatalogsVerticalFeedsCreateRequest::CatalogTypeEnum& EnumValue)
{
	return ToString(EnumValue);
}

inline bool FromString(const FString& EnumAsString, OpenAPICatalogsVerticalFeedsCreateRequest::CatalogTypeEnum& Value)
{
	static TMap<FString, OpenAPICatalogsVerticalFeedsCreateRequest::CatalogTypeEnum> StringToEnum = { 
		{ TEXT("CREATIVE_ASSETS"), OpenAPICatalogsVerticalFeedsCreateRequest::CatalogTypeEnum::CreativeAssets }, };
...
bool OpenAPICatalogsVerticalFeedsCreateRequest::EnumFromString(const FString& EnumAsString, OpenAPICatalogsVerticalFeedsCreateRequest::CatalogTypeEnum& EnumValue)
{
	return FromString(EnumAsString, EnumValue);
}

inline void WriteJsonValue(JsonWriter& Writer, const OpenAPICatalogsVerticalFeedsCreateRequest::CatalogTypeEnum& Value)
{
	WriteJsonValue(Writer, ToString(Value));
}

inline bool TryGetJsonValue(const TSharedPtr<FJsonValue>& JsonValue, OpenAPICatalogsVerticalFeedsCreateRequest::CatalogTypeEnum& Value)
{
	FString TmpValue;
