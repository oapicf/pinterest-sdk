...
void OpenAPIConversionEventResponse::WriteJson(JsonWriter& Writer) const
{
	...
	if (ReportingConversionEvent.IsSet())
	{
		Writer->WriteIdentifierPrefix(TEXT("reporting_conversion_event")); WriteJsonValue(Writer, ReportingConversionEvent.GetValue());
	}
...
bool OpenAPIConversionEventResponse::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
	...
	ParseSuccess &= TryGetJsonValue(*Object, TEXT("reporting_conversion_event"), ReportingConversionEvent);
