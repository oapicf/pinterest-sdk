...
inline FString ToString(const OpenAPIBusinessAccessRole::Values& Value)
{
	...
	case OpenAPIBusinessAccessRole::Values::FinanceView:
		return TEXT("FINANCE_VIEW");
	case OpenAPIBusinessAccessRole::Values::FinanceEdit:
...
inline bool FromString(const FString& EnumAsString, OpenAPIBusinessAccessRole::Values& Value)
{
	static TMap<FString, OpenAPIBusinessAccessRole::Values> StringToEnum = { 
		...
		{ TEXT("FINANCE_VIEW"), OpenAPIBusinessAccessRole::Values::FinanceView },
		{ TEXT("FINANCE_EDIT"), OpenAPIBusinessAccessRole::Values::FinanceEdit },
