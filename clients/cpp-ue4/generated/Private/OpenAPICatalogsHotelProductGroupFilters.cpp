...
void OpenAPICatalogsHotelProductGroupFilters::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPICatalogsHotelProductGroupFilters::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
