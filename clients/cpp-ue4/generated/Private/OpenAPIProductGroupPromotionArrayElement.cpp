...
void OpenAPIProductGroupPromotionArrayElement::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIProductGroupPromotionArrayElement::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
