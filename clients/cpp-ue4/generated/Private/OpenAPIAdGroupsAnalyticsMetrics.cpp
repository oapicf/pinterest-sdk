...
void OpenAPIAdGroupsAnalyticsMetrics::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIAdGroupsAnalyticsMetrics::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
