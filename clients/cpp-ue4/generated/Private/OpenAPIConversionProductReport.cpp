...
void OpenAPIConversionProductReport::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIConversionProductReport::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
