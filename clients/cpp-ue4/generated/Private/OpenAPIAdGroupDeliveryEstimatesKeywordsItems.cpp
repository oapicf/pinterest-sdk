...
void OpenAPIAdGroupDeliveryEstimatesKeywordsItems::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIAdGroupDeliveryEstimatesKeywordsItems::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
