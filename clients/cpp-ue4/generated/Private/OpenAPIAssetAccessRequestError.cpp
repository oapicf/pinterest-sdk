...
void OpenAPIAssetAccessRequestError::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIAssetAccessRequestError::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
