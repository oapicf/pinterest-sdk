...
#include "OpenAPIAggregatedPinComment.h"
...
void OpenAPIAggregatedPinComment::WriteJson(JsonWriter& Writer) const
{
	...
	if (IsProduct.IsSet())
	{
		Writer->WriteIdentifierPrefix(TEXT("is_product")); WriteJsonValue(Writer, IsProduct.GetValue());
	}
	if (IsStandard.IsSet())
	{
...
bool OpenAPIAggregatedPinComment::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
	...
	ParseSuccess &= TryGetJsonValue(*Object, TEXT("is_product"), IsProduct);
