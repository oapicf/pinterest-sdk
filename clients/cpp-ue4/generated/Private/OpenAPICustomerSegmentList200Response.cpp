...
void OpenAPICustomerSegmentList200Response::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPICustomerSegmentList200Response::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
