...
void OpenAPIBusinessMembershipMember::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIBusinessMembershipMember::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
