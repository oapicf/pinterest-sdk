...
inline FStringFormatArg ToStringFormatArg(const OpenAPITargetingSpec::AgeBucketEnum& Value)
{
...
inline FStringFormatArg ToStringFormatArg(const OpenAPITargetingSpec::ApptypeEnum& Value)
{
	return FStringFormatArg(ToString(Value));
}
...
inline FStringFormatArg ToStringFormatArg(const OpenAPITargetingSpec::GenderEnum& Value)
{
	return FStringFormatArg(ToString(Value));
}
...
inline FStringFormatArg ToStringFormatArg(const OpenAPITargetingSpec::TargetingStrategyEnum& Value)
{
	return FStringFormatArg(ToString(Value));
}
