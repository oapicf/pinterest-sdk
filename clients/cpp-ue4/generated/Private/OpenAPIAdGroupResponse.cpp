...
inline FString ToString(const OpenAPIAdGroupResponse::PromotionApplicationLevelEnum& Value)
{
	switch (Value)
	{
	case OpenAPIAdGroupResponse::PromotionApplicationLevelEnum::None:
		return TEXT("NONE");
	case OpenAPIAdGroupResponse::PromotionApplicationLevelEnum::Item:
		return TEXT("ITEM");
	case OpenAPIAdGroupResponse::PromotionApplicationLevelEnum::AdGroup:
		return TEXT("AD_GROUP");
	}

	UE_LOG(LogOpenAPI, Error, TEXT("Invalid OpenAPIAdGroupResponse::PromotionApplicationLevelEnum Value (%d)"), (int)Value);
	return TEXT("");
}

FString OpenAPIAdGroupResponse::EnumToString(const OpenAPIAdGroupResponse::PromotionApplicationLevelEnum& EnumValue)
{
	return ToString(EnumValue);
}

inline bool FromString(const FString& EnumAsString, OpenAPIAdGroupResponse::PromotionApplicationLevelEnum& Value)
{
	static TMap<FString, OpenAPIAdGroupResponse::PromotionApplicationLevelEnum> StringToEnum = { 
		{ TEXT("NONE"), OpenAPIAdGroupResponse::PromotionApplicationLevelEnum::None },
		{ TEXT("ITEM"), OpenAPIAdGroupResponse::PromotionApplicationLevelEnum::Item },
		{ TEXT("AD_GROUP"), OpenAPIAdGroupResponse::PromotionApplicationLevelEnum::AdGroup }, };
...
bool OpenAPIAdGroupResponse::EnumFromString(const FString& EnumAsString, OpenAPIAdGroupResponse::PromotionApplicationLevelEnum& EnumValue)
{
	return FromString(EnumAsString, EnumValue);
}

inline void WriteJsonValue(JsonWriter& Writer, const OpenAPIAdGroupResponse::PromotionApplicationLevelEnum& Value)
{
	WriteJsonValue(Writer, ToString(Value));
}

inline bool TryGetJsonValue(const TSharedPtr<FJsonValue>& JsonValue, OpenAPIAdGroupResponse::PromotionApplicationLevelEnum& Value)
{
	FString TmpValue;
	if (JsonValue->TryGetString(TmpValue))
	{
