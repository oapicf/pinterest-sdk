...
void OpenAPISearchPartnerPins200Response::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPISearchPartnerPins200Response::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
