...
FHttpRequestPtr OpenAPICatalogsApi::CatalogsProductGroupPinsList(const CatalogsProductGroupPinsListRequest& Request, const FCatalogsProductGroupPinsListDelegate& Delegate /*= FCatalogsProductGroupPinsListDelegate()*/) const
{
	if (!IsValid())
		return nullptr;
	...
	HttpRequest->OnProcessRequestComplete().BindRaw(this, &OpenAPICatalogsApi::OnCatalogsProductGroupPinsListResponse, Delegate);
	HttpRequest->ProcessRequest();
	return HttpRequest;
}

void OpenAPICatalogsApi::OnCatalogsProductGroupPinsListResponse(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FCatalogsProductGroupPinsListDelegate Delegate) const
{
...
FHttpRequestPtr OpenAPICatalogsApi::CatalogsProductGroupsCreateMany(const CatalogsProductGroupsCreateManyRequest& Request, const FCatalogsProductGroupsCreateManyDelegate& Delegate /*= FCatalogsProductGroupsCreateManyDelegate()*/) const
{
	if (!IsValid())
		return nullptr;
	...
	HttpRequest->OnProcessRequestComplete().BindRaw(this, &OpenAPICatalogsApi::OnCatalogsProductGroupsCreateManyResponse, Delegate);
	HttpRequest->ProcessRequest();
	return HttpRequest;
}

void OpenAPICatalogsApi::OnCatalogsProductGroupsCreateManyResponse(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FCatalogsProductGroupsCreateManyDelegate Delegate) const
{
...
FHttpRequestPtr OpenAPICatalogsApi::CatalogsProductGroupsDeleteMany(const CatalogsProductGroupsDeleteManyRequest& Request, const FCatalogsProductGroupsDeleteManyDelegate& Delegate /*= FCatalogsProductGroupsDeleteManyDelegate()*/) const
{
	if (!IsValid())
		return nullptr;
	...
	HttpRequest->OnProcessRequestComplete().BindRaw(this, &OpenAPICatalogsApi::OnCatalogsProductGroupsDeleteManyResponse, Delegate);
	HttpRequest->ProcessRequest();
	return HttpRequest;
}

void OpenAPICatalogsApi::OnCatalogsProductGroupsDeleteManyResponse(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FCatalogsProductGroupsDeleteManyDelegate Delegate) const
{
...
FHttpRequestPtr OpenAPICatalogsApi::CatalogsProductGroupsGet(const CatalogsProductGroupsGetRequest& Request, const FCatalogsProductGroupsGetDelegate& Delegate /*= FCatalogsProductGroupsGetDelegate()*/) const
{
	if (!IsValid())
		return nullptr;
	...
	HttpRequest->OnProcessRequestComplete().BindRaw(this, &OpenAPICatalogsApi::OnCatalogsProductGroupsGetResponse, Delegate);
	HttpRequest->ProcessRequest();
	return HttpRequest;
}

void OpenAPICatalogsApi::OnCatalogsProductGroupsGetResponse(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FCatalogsProductGroupsGetDelegate Delegate) const
{
...
FHttpRequestPtr OpenAPICatalogsApi::CatalogsProductGroupsProductCountsGet(const CatalogsProductGroupsProductCountsGetRequest& Request, const FCatalogsProductGroupsProductCountsGetDelegate& Delegate /*= FCatalogsProductGroupsProductCountsGetDelegate()*/) const
{
	if (!IsValid())
		return nullptr;
	...
	HttpRequest->OnProcessRequestComplete().BindRaw(this, &OpenAPICatalogsApi::OnCatalogsProductGroupsProductCountsGetResponse, Delegate);
	HttpRequest->ProcessRequest();
	return HttpRequest;
}

void OpenAPICatalogsApi::OnCatalogsProductGroupsProductCountsGetResponse(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FCatalogsProductGroupsProductCountsGetDelegate Delegate) const
{
...
FHttpRequestPtr OpenAPICatalogsApi::FeedsIngest(const FeedsIngestRequest& Request, const FFeedsIngestDelegate& Delegate /*= FFeedsIngestDelegate()*/) const
{
	if (!IsValid())
		return nullptr;
	...
	HttpRequest->OnProcessRequestComplete().BindRaw(this, &OpenAPICatalogsApi::OnFeedsIngestResponse, Delegate);
	HttpRequest->ProcessRequest();
	return HttpRequest;
}

void OpenAPICatalogsApi::OnFeedsIngestResponse(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FFeedsIngestDelegate Delegate) const
{
...
FHttpRequestPtr OpenAPICatalogsApi::ItemsIssuesList(const ItemsIssuesListRequest& Request, const FItemsIssuesListDelegate& Delegate /*= FItemsIssuesListDelegate()*/) const
{
	if (!IsValid())
		return nullptr;
	...
	HttpRequest->OnProcessRequestComplete().BindRaw(this, &OpenAPICatalogsApi::OnItemsIssuesListResponse, Delegate);
	HttpRequest->ProcessRequest();
	return HttpRequest;
}

void OpenAPICatalogsApi::OnItemsIssuesListResponse(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FItemsIssuesListDelegate Delegate) const
{
...
FHttpRequestPtr OpenAPICatalogsApi::ItemsPost(const ItemsPostRequest& Request, const FItemsPostDelegate& Delegate /*= FItemsPostDelegate()*/) const
{
	if (!IsValid())
		return nullptr;
	...
	HttpRequest->OnProcessRequestComplete().BindRaw(this, &OpenAPICatalogsApi::OnItemsPostResponse, Delegate);
	HttpRequest->ProcessRequest();
	return HttpRequest;
}

void OpenAPICatalogsApi::OnItemsPostResponse(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FItemsPostDelegate Delegate) const
{
...
FHttpRequestPtr OpenAPICatalogsApi::ProductsByProductGroupFilterList(const ProductsByProductGroupFilterListRequest& Request, const FProductsByProductGroupFilterListDelegate& Delegate /*= FProductsByProductGroupFilterListDelegate()*/) const
{
	if (!IsValid())
		return nullptr;
	...
	HttpRequest->OnProcessRequestComplete().BindRaw(this, &OpenAPICatalogsApi::OnProductsByProductGroupFilterListResponse, Delegate);
	HttpRequest->ProcessRequest();
	return HttpRequest;
}

void OpenAPICatalogsApi::OnProductsByProductGroupFilterListResponse(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FProductsByProductGroupFilterListDelegate Delegate) const
{
...
FHttpRequestPtr OpenAPICatalogsApi::ReportsCreate(const ReportsCreateRequest& Request, const FReportsCreateDelegate& Delegate /*= FReportsCreateDelegate()*/) const
{
	if (!IsValid())
		return nullptr;
	...
	HttpRequest->OnProcessRequestComplete().BindRaw(this, &OpenAPICatalogsApi::OnReportsCreateResponse, Delegate);
	HttpRequest->ProcessRequest();
	return HttpRequest;
}

void OpenAPICatalogsApi::OnReportsCreateResponse(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FReportsCreateDelegate Delegate) const
{
...
FHttpRequestPtr OpenAPICatalogsApi::ReportsGet(const ReportsGetRequest& Request, const FReportsGetDelegate& Delegate /*= FReportsGetDelegate()*/) const
{
	if (!IsValid())
		return nullptr;
	...
	HttpRequest->OnProcessRequestComplete().BindRaw(this, &OpenAPICatalogsApi::OnReportsGetResponse, Delegate);
	HttpRequest->ProcessRequest();
	return HttpRequest;
}

void OpenAPICatalogsApi::OnReportsGetResponse(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FReportsGetDelegate Delegate) const
{
...
FHttpRequestPtr OpenAPICatalogsApi::ReportsStats(const ReportsStatsRequest& Request, const FReportsStatsDelegate& Delegate /*= FReportsStatsDelegate()*/) const
{
	if (!IsValid())
		return nullptr;
	...
	HttpRequest->OnProcessRequestComplete().BindRaw(this, &OpenAPICatalogsApi::OnReportsStatsResponse, Delegate);
	HttpRequest->ProcessRequest();
	return HttpRequest;
}

void OpenAPICatalogsApi::OnReportsStatsResponse(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FReportsStatsDelegate Delegate) const
{
