...
void OpenAPIBulkDownloadCampaignFilter::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIBulkDownloadCampaignFilter::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
