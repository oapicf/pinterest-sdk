...
void OpenAPICampaignBatchUpdateItem::WriteJson(JsonWriter& Writer) const
{
	...
	if (AppPlatform.IsSet())
	{
		Writer->WriteIdentifierPrefix(TEXT("app_platform")); WriteJsonValue(Writer, AppPlatform.GetValue());
	}
	if (BidOptions.IsSet())
	{
...
bool OpenAPICampaignBatchUpdateItem::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
	...
	ParseSuccess &= TryGetJsonValue(*Object, TEXT("app_platform"), AppPlatform);
