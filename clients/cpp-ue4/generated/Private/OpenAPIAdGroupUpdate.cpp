...
#include "OpenAPIAdGroupUpdate.h"
...
void OpenAPIAdGroupUpdate::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIAdGroupUpdate::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
