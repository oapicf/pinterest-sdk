...
void OpenAPIInviteAssetsSummaryProfilesInner::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIInviteAssetsSummaryProfilesInner::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
