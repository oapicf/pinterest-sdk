...
void OpenAPICatalogsProductGroupMultipleMediaTypesCriteria::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPICatalogsProductGroupMultipleMediaTypesCriteria::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
