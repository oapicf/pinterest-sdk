...
inline FString ToString(const OpenAPIBulkEntityType::Values& Value)
{
	...
	case OpenAPIBulkEntityType::Values::Keyword:
		return TEXT("KEYWORD");
	case OpenAPIBulkEntityType::Values::Label:
		return TEXT("LABEL");
	case OpenAPIBulkEntityType::Values::Schedule:
		return TEXT("SCHEDULE");
	case OpenAPIBulkEntityType::Values::EntityHistory:
		return TEXT("ENTITY_HISTORY");
	}
...
inline bool FromString(const FString& EnumAsString, OpenAPIBulkEntityType::Values& Value)
{
	static TMap<FString, OpenAPIBulkEntityType::Values> StringToEnum = { 
		...
		{ TEXT("LABEL"), OpenAPIBulkEntityType::Values::Label },
		{ TEXT("SCHEDULE"), OpenAPIBulkEntityType::Values::Schedule },
		{ TEXT("ENTITY_HISTORY"), OpenAPIBulkEntityType::Values::EntityHistory }, };
