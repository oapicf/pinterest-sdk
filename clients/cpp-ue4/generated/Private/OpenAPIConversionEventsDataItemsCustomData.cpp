...
void OpenAPIConversionEventsDataItemsCustomData::WriteJson(JsonWriter& Writer) const
{
	...
	if (ExternalMeasurementId.IsSet())
	{
		Writer->WriteIdentifierPrefix(TEXT("external_measurement_id")); WriteJsonValue(Writer, ExternalMeasurementId.GetValue());
	}
	if (ExternalMeasurementVendorId.IsSet())
	{
		Writer->WriteIdentifierPrefix(TEXT("external_measurement_vendor_id")); WriteJsonValue(Writer, ExternalMeasurementVendorId.GetValue());
	}
	if (Np.IsSet())
	{
	...
	if (PredictedLtv.IsSet())
	{
		Writer->WriteIdentifierPrefix(TEXT("predicted_ltv")); WriteJsonValue(Writer, PredictedLtv.GetValue());
	}
...
bool OpenAPIConversionEventsDataItemsCustomData::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
	...
	ParseSuccess &= TryGetJsonValue(*Object, TEXT("external_measurement_id"), ExternalMeasurementId);
	ParseSuccess &= TryGetJsonValue(*Object, TEXT("external_measurement_vendor_id"), ExternalMeasurementVendorId);
	...
	ParseSuccess &= TryGetJsonValue(*Object, TEXT("predicted_ltv"), PredictedLtv);
