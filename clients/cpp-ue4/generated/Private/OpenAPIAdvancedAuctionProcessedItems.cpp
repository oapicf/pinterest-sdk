...
void OpenAPIAdvancedAuctionProcessedItems::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIAdvancedAuctionProcessedItems::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
