...
void OpenAPISSIOInsertionOrderUpdate::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPISSIOInsertionOrderUpdate::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
