...
void OpenAPISchedulesList200Response::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPISchedulesList200Response::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
