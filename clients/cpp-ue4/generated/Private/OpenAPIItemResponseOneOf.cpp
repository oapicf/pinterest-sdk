...
#include "OpenAPIItemResponseOneOf.h"
...
void OpenAPIItemResponseOneOf::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIItemResponseOneOf::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
