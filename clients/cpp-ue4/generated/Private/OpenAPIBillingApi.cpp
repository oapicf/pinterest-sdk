...
FHttpRequestPtr OpenAPIBillingApi::BillingInvoiceDownloadGet(const BillingInvoiceDownloadGetRequest& Request, const FBillingInvoiceDownloadGetDelegate& Delegate /*= FBillingInvoiceDownloadGetDelegate()*/) const
{
	if (!IsValid())
		return nullptr;
	...
	HttpRequest->OnProcessRequestComplete().BindRaw(this, &OpenAPIBillingApi::OnBillingInvoiceDownloadGetResponse, Delegate);
	HttpRequest->ProcessRequest();
	return HttpRequest;
}

void OpenAPIBillingApi::OnBillingInvoiceDownloadGetResponse(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FBillingInvoiceDownloadGetDelegate Delegate) const
{
	BillingInvoiceDownloadGetResponse Response;
	HandleResponse(HttpResponse, bSucceeded, Response);
	Delegate.ExecuteIfBound(Response);
}

FHttpRequestPtr OpenAPIBillingApi::BillingInvoicesGet(const BillingInvoicesGetRequest& Request, const FBillingInvoicesGetDelegate& Delegate /*= FBillingInvoicesGetDelegate()*/) const
{
	if (!IsValid())
		return nullptr;
	...
	HttpRequest->OnProcessRequestComplete().BindRaw(this, &OpenAPIBillingApi::OnBillingInvoicesGetResponse, Delegate);
	HttpRequest->ProcessRequest();
	return HttpRequest;
}

void OpenAPIBillingApi::OnBillingInvoicesGetResponse(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FBillingInvoicesGetDelegate Delegate) const
{
	BillingInvoicesGetResponse Response;
	HandleResponse(HttpResponse, bSucceeded, Response);
	Delegate.ExecuteIfBound(Response);
}
