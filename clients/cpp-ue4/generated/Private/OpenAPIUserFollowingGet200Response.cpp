...
void OpenAPIUserFollowingGet200Response::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIUserFollowingGet200Response::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
