...
#include "OpenAPIBaseBusinessAssets.h"
...
void OpenAPIBaseBusinessAssets::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIBaseBusinessAssets::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
