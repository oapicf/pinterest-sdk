...
void OpenAPICatalogsList200Response::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPICatalogsList200Response::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
