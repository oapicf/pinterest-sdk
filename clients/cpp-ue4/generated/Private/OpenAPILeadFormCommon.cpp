...
#include "OpenAPILeadFormCommon.h"
...
void OpenAPILeadFormCommon::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPILeadFormCommon::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
