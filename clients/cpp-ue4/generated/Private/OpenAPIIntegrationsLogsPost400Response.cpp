...
#include "OpenAPIIntegrationsLogsPost400Response.h"
...
void OpenAPIIntegrationsLogsPost400Response::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIIntegrationsLogsPost400Response::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
