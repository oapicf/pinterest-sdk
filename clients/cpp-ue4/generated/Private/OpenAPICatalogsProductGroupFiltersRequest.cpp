...
void OpenAPICatalogsProductGroupFiltersRequest::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPICatalogsProductGroupFiltersRequest::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
