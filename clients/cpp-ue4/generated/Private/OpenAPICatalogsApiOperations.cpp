...
void OpenAPICatalogsApi::CatalogsProductGroupsCreateRequest::SetupHttpRequest(const FHttpRequestRef& HttpRequest) const
{
	...
	if (Consumes.Num() == 0 || Consumes.Contains(TEXT("application/json")))
	{
		...
		WriteJsonValue(Writer, OpenAPICatalogsProductGroupsCreateRequest);
		Writer->Close();
	...
	{
		UE_LOG(LogOpenAPI, Error, TEXT("Body parameter (OpenAPICatalogsProductGroupsCreateRequest) was ignored, not supported in multipart form"));
	}
	else if (Consumes.Contains(TEXT("application/x-www-form-urlencoded")))
	{
		UE_LOG(LogOpenAPI, Error, TEXT("Body parameter (OpenAPICatalogsProductGroupsCreateRequest) was ignored, not supported in urlencoded requests"));
	}
	else
	{
