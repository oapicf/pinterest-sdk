...
void OpenAPIPinMediaSourceImagesURLItem::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIPinMediaSourceImagesURLItem::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
