...
module BoardsApiHandler =
    ...
    let BoardSectionsCreate (pathParams:BoardSectionsCreatePathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let serviceArgs = {    pathParams=pathParams; bodyParams=bodyParams } : BoardSectionsCreateArgs
    ...
    let BoardSectionsDelete (pathParams:BoardSectionsDeletePathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          let serviceArgs = {    pathParams=pathParams;  } : BoardSectionsDeleteArgs
    ...
    let BoardSectionsUpdate (pathParams:BoardSectionsUpdatePathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let serviceArgs = {    pathParams=pathParams; bodyParams=bodyParams } : BoardSectionsUpdateArgs
    ...
    let BoardsCreate  : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let serviceArgs = {     bodyParams=bodyParams } : BoardsCreateArgs
    ...
    let BoardsDelete (pathParams:BoardsDeletePathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          let serviceArgs = {    pathParams=pathParams;  } : BoardsDeleteArgs
    ...
    let BoardsGet (pathParams:BoardsGetPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          let serviceArgs = {    pathParams=pathParams;  } : BoardsGetArgs
    ...
    let BoardsUpdate (pathParams:BoardsUpdatePathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let serviceArgs = {    pathParams=pathParams; bodyParams=bodyParams } : BoardsUpdateArgs
