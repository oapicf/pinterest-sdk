...
module AuthSchemes =
  ...
  let configureOAuth (settings:IConfiguration) services =
    (getOAuthBuilder settings "pinterest_oauth2") services "pinterest_oauth2" "https://www.pinterest.com/oauth/" ["ads:read";"ads:write";"boards:read";"boards:read_secret";"boards:write";"boards:write_secret";"catalogs:read";"catalogs:write";"pins:read";"pins:read_secret";"pins:write";"pins:write_secret";"user_accounts:read";] settings
