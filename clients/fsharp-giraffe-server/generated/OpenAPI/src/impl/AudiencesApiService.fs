...
module AudiencesApiServiceImplementation =
    ...
    type AudiencesApiServiceImpl() =
      interface IAudiencesApiService with
        ...
        member this.AudiencesCreate ctx args =
          if true then
        ...
        member this.AudiencesCreateCustom ctx args =
          if true then
            let content = "Success" :> obj :?> Audience // this cast is obviously wrong, and is only intended to allow generated project to compile   
        ...
        member this.AudiencesGet ctx args =
          if true then
            let content = "Success" :> obj :?> Audience // this cast is obviously wrong, and is only intended to allow generated project to compile   
        ...
        member this.AudiencesList ctx args =
          if true then
        ...
        member this.AudiencesUpdate ctx args =
          if true then
            let content = "Success" :> obj :?> Audience // this cast is obviously wrong, and is only intended to allow generated project to compile   
