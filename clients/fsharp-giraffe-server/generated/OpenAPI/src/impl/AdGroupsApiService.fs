...
module AdGroupsApiServiceImplementation =
    ...
    type AdGroupsApiServiceImpl() =
      interface IAdGroupsApiService with
        ...
        member this.AdGroupsAnalytics ctx args =
          if true then
        ...
        member this.AdGroupsAudienceSizing ctx args =
          if true then
        ...
        member this.AdGroupsBidFloorGet ctx args =
          if true then
        ...
        member this.AdGroupsCreate ctx args =
          if true then
        ...
        member this.AdGroupsDynamicTitlesDownloadCsv ctx args =
          if true then
        ...
        member this.AdGroupsDynamicTitlesGetStatus ctx args =
          if true then
        ...
        member this.AdGroupsDynamicTitlesGetUploadUrl ctx args =
          if true then
        ...
        member this.AdGroupsDynamicTitlesProcessCsv ctx args =
          if true then
        ...
        member this.AdGroupsGet ctx args =
          if true then
        ...
        member this.AdGroupsList ctx args =
          if true then
        ...
        member this.AdGroupsTargetingAnalyticsGet ctx args =
          if true then
        ...
        member this.AdGroupsUpdate ctx args =
          if true then
            let content = "The request has succeeded." :> obj :?> AdGroupsCreate200Response // this cast is obviously wrong, and is only intended to allow generated project to compile   
        ...
        member this.GetAdGroupsByPromotionIdsList ctx args =
          if true then
            let content = "The request has succeeded." :> obj :?> AdGroupsList200Response // this cast is obviously wrong, and is only intended to allow generated project to compile   
