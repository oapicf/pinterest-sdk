...
public class CatalogsProductGroupsList200ResponseAllOfItemsInner   {
  ...
  public CatalogsProductGroupsList200ResponseAllOfItemsInner (String id, String name, String description, CatalogsProductGroupFilters filters, Boolean isFeatured, CatalogsProductGroupType type, CatalogsProductGroupStatus status, Integer createdAt, Integer updatedAt, String feedId, CatalogTypeEnum catalogType) {
    this.id = id;
    this.name = name;
