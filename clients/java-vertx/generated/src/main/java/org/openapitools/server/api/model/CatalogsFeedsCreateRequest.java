...
public class CatalogsFeedsCreateRequest   {
  ...
  public CatalogsFeedsCreateRequest (Country defaultCountry, ProductAvailabilityType defaultAvailability, NullableCurrency defaultCurrency, String name, CatalogsFormat format, String defaultLocale, CatalogsFeedCredentials credentials, String location, CatalogsFeedProcessingSchedule preferredProcessingSchedule) {
