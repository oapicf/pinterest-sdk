...
public class CatalogsProductGroup   {
  ...
  public CatalogsProductGroup (String id, String name, String description, CatalogsProductGroupFilters filters, CatalogsProductGroupType type, CatalogsProductGroupStatus status, String feedId, Integer createdAt, Integer updatedAt) {
    this.id = id;
    this.name = name;
