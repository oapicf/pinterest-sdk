...
```php
adsAnalytics($ad_account_id, $start_date, $end_date, $ad_ids, $columns, $granularity, $click_window_days, $engagement_window_days, $view_window_days, $conversion_report_time): \OpenAPI\Client\Model\AdsAnalyticsResponseInner[]
```
