...
------------ | ------------- | ------------- | -------------
**operation_type** | [**\OpenAPI\Client\Model\UserListOperationType**](UserListOperationType.md) | Customer list update operation type (add or remove). Only valid in update request body. |
