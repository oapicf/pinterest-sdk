...
/**
 * TargetingSpecOperationMinMaxAge Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TargetingSpecOperationMinMaxAge implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TargetingSpecOperationMinMaxAge';
    ...
    */
    ...
    public function setValue($value)
    {
        ...
        if (!is_null($value) && (!preg_match("/^\\d+\\+?$/", ObjectSerializer::toString($value)))) {
            throw new \InvalidArgumentException("invalid value for \$value when calling TargetingSpecOperationMinMaxAge., must conform to the pattern /^\\d+\\+?$/.");
        }
