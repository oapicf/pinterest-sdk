...
/**
 * AudienceUpdateRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AudienceUpdateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AudienceUpdateRequest';
    ...
    */
    ...
    public function setAdAccountId($ad_account_id)
    {
        ...
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($ad_account_id)))) {
            throw new \InvalidArgumentException("invalid value for \$ad_account_id when calling AudienceUpdateRequest., must conform to the pattern /^\\d+$/.");
        }
     ...
     * Sets operation_type
     *
     * @param \OpenAPI\Client\Model\AudienceUpdateOperationType|null $operation_type operation_type
     *
     * @return self
     */
