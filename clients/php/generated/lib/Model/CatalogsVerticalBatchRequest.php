 ...
 */
class CatalogsVerticalBatchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'CatalogsVerticalBatchRequest';
    ...
    public function setCatalogId($catalog_id)
    {
        ...
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($catalog_id)))) {
            throw new \InvalidArgumentException("invalid value for \$catalog_id when calling CatalogsVerticalBatchRequest., must conform to the pattern /^\\d+$/.");
        }
     ...
     * Gets items
     *
     * @return \OpenAPI\Client\Model\CatalogsCreativeAssetsBatchItem[]
     */
     ...
     * Sets items
     *
     * @param \OpenAPI\Client\Model\CatalogsCreativeAssetsBatchItem[] $items Array with creative assets item operations
     *
     * @return self
     */
    public function setItems($items)
    {
        ...
        if ((count($items) > 1000)) {
            throw new \InvalidArgumentException('invalid value for $items when calling CatalogsVerticalBatchRequest., number of items must be less than or equal to 1000.');
        }
        if ((count($items) < 1)) {
            throw new \InvalidArgumentException('invalid length for $items when calling CatalogsVerticalBatchRequest., number of items must be greater than or equal to 1.');
        }
