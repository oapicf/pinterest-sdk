...
/**
 * CatalogsReportAllItemsFilter Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CatalogsReportAllItemsFilter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CatalogsReportAllItemsFilter';
    ...
    */
    ...
    public function setCatalogId($catalog_id)
    {
        ...
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($catalog_id)))) {
            throw new \InvalidArgumentException("invalid value for \$catalog_id when calling CatalogsReportAllItemsFilter., must conform to the pattern /^\\d+$/.");
        }
