 ...
 */
class ImageBase64 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Image_Base64';
    ...
    */
    ...
    public function setData($data)
    {
        ...
        if ((!preg_match("/[a-zA-Z0-9+\/=]+/", ObjectSerializer::toString($data)))) {
            throw new \InvalidArgumentException("invalid value for \$data when calling ImageBase64., must conform to the pattern /[a-zA-Z0-9+\/=]+/.");
        }
