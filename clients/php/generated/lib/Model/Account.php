...
class Account implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const ACCOUNT_TYPE_PINNER = 'PINNER';
    ...
    */
     ...
     * Sets board_count
     *
     * @param int|null $board_count User account board count.<br/>**Note**: Board count on user account level may differ from counts found elsewhere due to attribution of collaborative Boards.
     *
     * @return self
     */
