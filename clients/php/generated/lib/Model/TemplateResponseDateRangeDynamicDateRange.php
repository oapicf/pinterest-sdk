...
/**
 * TemplateResponseDateRangeDynamicDateRange Class Doc Comment
 *
 * @category Class
 ...
 */
class TemplateResponseDateRangeDynamicDateRange implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TemplateResponse_date_range_dynamic_date_range';
    ...
    {
        return [
            self::RANGE_YEAR_TO_DATE,
            self::RANGE_QUARTER_TO_DATE,
            self::RANGE_MONTH_TO_DATE,
            self::RANGE_LAST_MONTH,
            self::RANGE_LAST_QUARTER,
        ];
    }
