 ...
 */
class AudienceCreateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setAdAccountId($ad_account_id)
    {
        ...
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($ad_account_id)))) {
            throw new \InvalidArgumentException("invalid value for \$ad_account_id when calling AudienceCreateRequest., must conform to the pattern /^\\d+$/.");
        }
     ...
     * Gets rule
     *
     * @return \OpenAPI\Client\Model\AudienceRule
     */
     ...
     * Sets rule
     *
     * @param \OpenAPI\Client\Model\AudienceRule $rule rule
     *
     * @return self
     */
     ...
     * Gets audience_type
     *
     * @return \OpenAPI\Client\Model\AudienceType
     */
     ...
     * Sets audience_type
     *
     * @param \OpenAPI\Client\Model\AudienceType $audience_type <a href=\"/docs/reference/glossary/#Audience Types\">Audience types</a>: ACTALIKE, ENGAGEMENT, CUSTOMER_LIST and VISITOR. Values are case-sensitive.
     *
     * @return self
     */
