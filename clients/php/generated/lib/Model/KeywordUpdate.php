...
/**
 * KeywordUpdate Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class KeywordUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'KeywordUpdate';
    ...
    */
    ...
    public function setId($id)
    {
        ...
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($id)))) {
            throw new \InvalidArgumentException("invalid value for \$id when calling KeywordUpdate., must conform to the pattern /^\\d+$/.");
        }
