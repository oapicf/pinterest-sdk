...
/**
 * CampaignIdFilter Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CampaignIdFilter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CampaignIdFilter';
    ...
    */
    ...
    public function setCampaignIds($campaign_ids)
    {
        ...
        if ((count($campaign_ids) > 500)) {
            throw new \InvalidArgumentException('invalid value for $campaign_ids when calling CampaignIdFilter., number of items must be less than or equal to 500.');
        }
        if ((count($campaign_ids) < 1)) {
            throw new \InvalidArgumentException('invalid length for $campaign_ids when calling CampaignIdFilter., number of items must be greater than or equal to 1.');
        }
