 ...
 */
class TargetingSpecOperations implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'TargetingSpecOperations';
    ...
    public const FIELD_MINIMUM_AGE = 'MINIMUM_AGE';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->container['field'] = static::$openAPIModelName;
    }
    ...
    public function setValue($value)
    {
        ...
        if (!is_null($value) && (!preg_match("/^\\d+\\+?$/", ObjectSerializer::toString($value)))) {
            throw new \InvalidArgumentException("invalid value for \$value when calling TargetingSpecOperations., must conform to the pattern /^\\d+\\+?$/.");
        }
