...
/**
 * AdAccountAnalyticsResponseInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AdAccountAnalyticsResponseInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AdAccountAnalyticsResponse_inner';
    ...
    */
     ...
     * Sets ad_account_id
     *
     * @param string $ad_account_id The ID of the advertiser that this metrics belongs to.
     *
     * @return self
     */
    public function setAdAccountId($ad_account_id)
    {
        ...
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($ad_account_id)))) {
            throw new \InvalidArgumentException("invalid value for \$ad_account_id when calling AdAccountAnalyticsResponseInner., must conform to the pattern /^\\d+$/.");
        }
