...
/**
 * CatalogsItemsBatchPostRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CatalogsItemsBatchPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'CatalogsItemsBatchPostRequest';
    ...
    public function setCatalogId($catalog_id)
    {
        ...
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($catalog_id)))) {
            throw new \InvalidArgumentException("invalid value for \$catalog_id when calling CatalogsItemsBatchPostRequest., must conform to the pattern /^\\d+$/.");
        }
