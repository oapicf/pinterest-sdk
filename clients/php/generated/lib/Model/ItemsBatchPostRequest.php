...
/**
 * ItemsBatchPostRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ItemsBatchPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'items_batch_post_request';
    ...
    protected static $openAPITypes = [
        ...
        'items' => '\OpenAPI\Client\Model\ItemDeleteBatchRecord[]',
        'language' => 'string',
        'operation' => '\OpenAPI\Client\Model\BatchOperation'
    ];
    ...
    */
    ...
    public function setCatalogId($catalog_id)
    {
        ...
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($catalog_id)))) {
            throw new \InvalidArgumentException("invalid value for \$catalog_id when calling ItemsBatchPostRequest., must conform to the pattern /^\\d+$/.");
        }
     ...
     * Gets items
     *
     * @return \OpenAPI\Client\Model\ItemDeleteBatchRecord[]
     */
     ...
     * Sets items
     *
     * @param \OpenAPI\Client\Model\ItemDeleteBatchRecord[] $items Array with catalogs items
     *
     * @return self
     */
     ...
     * Gets operation
     *
     * @return \OpenAPI\Client\Model\BatchOperation
     */
     ...
     * Sets operation
     *
     * @param \OpenAPI\Client\Model\BatchOperation $operation operation
     *
     * @return self
     */
