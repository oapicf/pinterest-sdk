...
public struct AdAccountsAudienceRule: Codable {
    /// Ad account ID.
    ...
    public var objectiveType: [AudienceObjectiveType]?
    ...
    public init(from decoder: Decoder) throws {
        ...
        objectiveType = try container.decodeIfPresent([AudienceObjectiveType].self, forKey: .objectiveType)
