...
public struct AdGroupUpdateRequest: Codable {
    ...
    public var optimizationGoalMetadata: [String: Any]?
    ...
    public init(bidMultiplier: Double? = nil, id: String, targetingSpecOperations: [TargetingSpecOperations]? = nil, autoTargetingEnabled: Bool? = nil, bidInMicroCurrency: Int? = nil, bidStrategyType: BidStrategyType? = nil, billableEvent: ActionType? = nil, budgetInMicroCurrency: Int? = nil, budgetType: BudgetType? = nil, campaignId: String? = nil, endTime: Int? = nil, isCreativeOptimization: Bool? = nil, lifetimeFrequencyCap: Int? = nil, name: String? = nil, optimizationGoalMetadata: [String: Any]? = nil, pacingDeliveryType: PacingDeliveryType? = nil, placementGroup: PlacementGroupType? = nil, promotionApplicationLevel: PromotionApplicationLevel? = nil, promotionId: String? = "0", promotionIds: [String]? = nil, startTime: Int? = nil, status: EntityStatus? = nil, targetingSpec: TargetingSpec? = nil, targetingTemplateIds: [String]? = nil, trackingUrls: [String: Any]? = nil) {
    ...
    public init(from decoder: Decoder) throws {
        ...
        optimizationGoalMetadata = try container.decodeIfPresent([String: Any].self, forKey: .optimizationGoalMetadata)
        ...
        targetingSpec = try container.decodeIfPresent(TargetingSpec.self, forKey: .targetingSpec)
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        if let optimizationGoalMetadata = optimizationGoalMetadata {
            try container.encodeIfPresent(try JSONSerialization.data(withJSONObject: optimizationGoalMetadata), forKey: .optimizationGoalMetadata)
        }
