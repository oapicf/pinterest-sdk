...
public struct Campaign: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        objectiveType = try container.decode(CampaignObjectiveType.self, forKey: .objectiveType)
