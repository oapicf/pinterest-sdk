...
public struct AdGroupCreateRequest: Codable {
    ...
    public init(autoTargetingEnabled: Bool? = nil, bidMultiplier: Double? = nil, budgetType: BudgetType? = nil, pacingDeliveryType: PacingDeliveryType? = nil, bidInMicroCurrency: Int? = nil, bidStrategyType: BidStrategyType? = nil, billableEvent: ActionType, budgetInMicroCurrency: Int? = nil, campaignId: String, endTime: Int? = nil, isCreativeOptimization: Bool? = nil, lifetimeFrequencyCap: Int? = nil, name: String, optimizationGoalMetadata: [String: Any]? = nil, placementGroup: PlacementGroupType? = nil, promotionApplicationLevel: PromotionApplicationLevel? = nil, promotionId: String? = "0", promotionIds: [String]? = nil, startTime: Int? = nil, status: EntityStatus? = nil, targetingSpec: TargetingSpec? = nil, targetingTemplateIds: [String]? = nil, trackingUrls: [String: Any]? = nil) {
