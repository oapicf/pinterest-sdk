//
// CatalogsCreativeAssetsFeed.swift
//
...
public struct CatalogsCreativeAssetsFeed: Codable {
    ...
    public init(catalogId: String, catalogType: CatalogType, createdAt: Date, credentials: CatalogsFeedCredentials? = nil, defaultCountry: Country, defaultCurrency: NullableCurrency? = nil, defaultLocale: String, format: CatalogsFormat, id: String, location: String, name: String?, preferredProcessingSchedule: CatalogsFeedProcessingSchedule? = nil, status: CatalogsStatus, updatedAt: Date) {
