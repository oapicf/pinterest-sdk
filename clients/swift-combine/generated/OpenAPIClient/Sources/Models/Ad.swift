...
public struct Ad: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        carouselAndroidDeepLinks = try container.decodeIfPresent([String].self, forKey: .carouselAndroidDeepLinks)
        carouselDestinationUrls = try container.decodeIfPresent([String].self, forKey: .carouselDestinationUrls)
        carouselIosDeepLinks = try container.decodeIfPresent([String].self, forKey: .carouselIosDeepLinks)
        cartingPlatformType = try container.decodeIfPresent(Int.self, forKey: .cartingPlatformType)
        cartingProducts = try container.decodeIfPresent([CartingProduct].self, forKey: .cartingProducts)
        clickTrackingUrl = try container.decodeIfPresent(String.self, forKey: .clickTrackingUrl)
        collectionItemsDestinationUrlTemplate = try container.decodeIfPresent(String.self, forKey: .collectionItemsDestinationUrlTemplate)
        collectionsHeaderType = try container.decodeIfPresent(AdCollectionsHeaderType.self, forKey: .collectionsHeaderType)
        createdTime = try container.decodeIfPresent(Int.self, forKey: .createdTime)
        creativeType = try container.decode(CreativeType.self, forKey: .creativeType)
        customizableCtaType = try container.decodeIfPresent(CustomizableCTAType.self, forKey: .customizableCtaType)
        destinationUrl = try container.decodeIfPresent(String.self, forKey: .destinationUrl)
        disclosureType = try container.decodeIfPresent(DisclosureType.self, forKey: .disclosureType)
        disclosureUrl = try container.decodeIfPresent(String.self, forKey: .disclosureUrl)
        gridClickType = try container.decodeIfPresent(GridClickType.self, forKey: .gridClickType)
        id = try container.decode(String.self, forKey: .id)
        iosDeepLink = try container.decodeIfPresent(String.self, forKey: .iosDeepLink)
        isCarting = try container.decodeIfPresent(Bool.self, forKey: .isCarting)
        isCollageAcceptedTerms = try container.decodeIfPresent(Bool.self, forKey: .isCollageAcceptedTerms)
        isCollageSingleDestination = try container.decodeIfPresent(Bool.self, forKey: .isCollageSingleDestination)
        isPinDeleted = try container.decodeIfPresent(Bool.self, forKey: .isPinDeleted)
        isRemovable = try container.decodeIfPresent(Bool.self, forKey: .isRemovable)
        ...
        quizPinData = try container.decodeIfPresent(QuizPinData.self, forKey: .quizPinData)
        rejectedReasons = try container.decode([AdDisapprovalReasons].self, forKey: .rejectedReasons)
        rejectionLabels = try container.decode([String].self, forKey: .rejectionLabels)
        reviewStatus = try container.decode(AdReviewStatus.self, forKey: .reviewStatus)
        status = try container.decodeIfPresent(EntityStatus.self, forKey: .status)
        summaryStatus = try container.decode(PinPromotionSummaryStatus.self, forKey: .summaryStatus)
        ...
        viewTrackingUrl = try container.decodeIfPresent(String.self, forKey: .viewTrackingUrl)
    }
