...
public struct AdCreate: Codable {
    ...
    public init(adGroupId: String, androidDeepLink: String? = nil, carouselAndroidDeepLinks: [String]? = nil, carouselDestinationUrls: [String]? = nil, carouselIosDeepLinks: [String]? = nil, clickTrackingUrl: String? = nil, collectionItemsDestinationUrlTemplate: String? = nil, collectionsHeaderType: AdCollectionsHeaderType? = nil, creativeType: CreativeType, customizableCtaType: CustomizableCTAType? = nil, destinationUrl: String? = nil, disclosureType: DisclosureType? = nil, disclosureUrl: String? = nil, gridClickType: GridClickType? = nil, iosDeepLink: String? = nil, isCarting: Bool? = nil, isCollageAcceptedTerms: Bool? = nil, isCollageSingleDestination: Bool? = nil, isPinDeleted: Bool? = nil, isRemovable: Bool? = nil, leadFormId: String? = nil, name: String? = nil, pinId: String, quizPinData: QuizPinData? = nil, status: EntityStatus? = nil, trackingUrls: TrackingUrls? = nil, viewTrackingUrl: String? = nil) {
