...
public struct CampaignBatchUpdateItem: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        appPlatform = try container.decodeIfPresent(MobileAppPlatform.self, forKey: .appPlatform)
        ...
        objectiveType = try container.decodeIfPresent(ConversionObjectiveType.self, forKey: .objectiveType)
