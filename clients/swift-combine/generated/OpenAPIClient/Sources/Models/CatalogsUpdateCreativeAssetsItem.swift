...
public struct CatalogsUpdateCreativeAssetsItem: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        attributes = try container.decode(CatalogsUpdatableCreativeAssetsAttributes.self, forKey: .attributes)
