//
// ConversionEventsDataItemsCustomData.swift
//
...
public struct ConversionEventsDataItemsCustomData: Codable {
    ...
    public var contents: [ConversionEventsDataItemsCustomDataContentsItems]?
    ...
    public init(from decoder: Decoder) throws {
        ...
        contentBrand = try container.decodeIfPresent(String.self, forKey: .contentBrand)
        contentCategory = try container.decodeIfPresent(String.self, forKey: .contentCategory)
        ...
        contents = try container.decodeIfPresent([ConversionEventsDataItemsCustomDataContentsItems].self, forKey: .contents)
        currency = try container.decodeIfPresent(String.self, forKey: .currency)
        externalMeasurementId = try container.decodeIfPresent(String.self, forKey: .externalMeasurementId)
        externalMeasurementVendorId = try container.decodeIfPresent(Int.self, forKey: .externalMeasurementVendorId)
        np = try container.decodeIfPresent(String.self, forKey: .np)
        numItems = try container.decodeIfPresent(Int64.self, forKey: .numItems)
        ...
        predictedLtv = try container.decodeIfPresent(String.self, forKey: .predictedLtv)
