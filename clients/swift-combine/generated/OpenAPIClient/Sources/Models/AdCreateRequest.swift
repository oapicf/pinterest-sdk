...
public struct AdCreateRequest: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        quizPinData = try container.decodeIfPresent([String: Any].self, forKey: .quizPinData)
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        if let quizPinData = quizPinData {
            try container.encodeIfPresent(try JSONSerialization.data(withJSONObject: quizPinData), forKey: .quizPinData)
        }
