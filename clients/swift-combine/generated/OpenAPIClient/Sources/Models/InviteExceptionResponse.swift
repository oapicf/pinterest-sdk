...
public struct InviteExceptionResponse: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        inviteOrRequestId = try container.decodeIfPresent(String.self, forKey: .inviteOrRequestId)
        message = try container.decodeIfPresent(String.self, forKey: .message)
        usersOrPartnerIds = try container.decodeIfPresent([String].self, forKey: .usersOrPartnerIds)
    }
