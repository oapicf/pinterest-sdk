...
public struct SSIOOrderLine: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        acceptedTermsId = try container.decodeIfPresent(String.self, forKey: .acceptedTermsId)
        acceptedTermsTime = try container.decodeIfPresent(String.self, forKey: .acceptedTermsTime)
        ...
        billToCompanyName = try container.decodeIfPresent(String.self, forKey: .billToCompanyName)
        ...
        pmpName = try container.decodeIfPresent(String.self, forKey: .pmpName)
