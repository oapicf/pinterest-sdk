...
public struct CatalogsCreativeAssetsProductGroupFilterKeys: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        CREATIVE_ASSETS_ID = try container.decode(CatalogsProductGroupMultipleStringCriteria.self, forKey: .CREATIVE_ASSETS_ID)
        ...
        LINK = try container.decode(CatalogsProductGroupFilterOperatorTypeCriteria.self, forKey: .LINK)
    }
