...
public struct TrendingKeyword: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        demographics = try container.decodeIfPresent(TrendingKeywordDemographics.self, forKey: .demographics)
        hasPrediction = try container.decodeIfPresent(Bool.self, forKey: .hasPrediction)
        keyword = try container.decodeIfPresent(String.self, forKey: .keyword)
        pctGrowthMom = try container.decodeIfPresent(Int.self, forKey: .pctGrowthMom)
        pctGrowthWow = try container.decodeIfPresent(Int.self, forKey: .pctGrowthWow)
        pctGrowthYoy = try container.decodeIfPresent(Int.self, forKey: .pctGrowthYoy)
        predictedTimeSeries = try container.decodeIfPresent(PredictedTimeSeries.self, forKey: .predictedTimeSeries)
