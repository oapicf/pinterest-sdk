...
public struct CatalogsCreativeAssetsBatchRequest: Codable {
    ...
    public init(catalogId: String? = nil, catalogType: CatalogType, country: Country, items: [CatalogsCreativeAssetsBatchItem], language: Language) {
    ...
    public init(from decoder: Decoder) throws {
        ...
        items = try container.decode([CatalogsCreativeAssetsBatchItem].self, forKey: .items)
