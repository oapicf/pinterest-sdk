...
public struct CampaignAdPreview: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        pinId = try container.decodeIfPresent(Int.self, forKey: .pinId)
        pinPromotionId = try container.decodeIfPresent(Int.self, forKey: .pinPromotionId)
        promotedProductGroupId = try container.decodeIfPresent(Int.self, forKey: .promotedProductGroupId)
