...
public struct ConversionEventsUserDataProperties: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        clickId = try container.decodeIfPresent(String.self, forKey: .clickId)
        clientIpAddress = try container.decodeIfPresent(String.self, forKey: .clientIpAddress)
        clientUserAgent = try container.decodeIfPresent(String.self, forKey: .clientUserAgent)
        country = try container.decodeIfPresent([String].self, forKey: .country)
        ct = try container.decodeIfPresent([String].self, forKey: .ct)
        db = try container.decodeIfPresent([String].self, forKey: .db)
        em = try container.decodeIfPresent([String].self, forKey: .em)
        externalId = try container.decodeIfPresent([String].self, forKey: .externalId)
        fn = try container.decodeIfPresent([String].self, forKey: .fn)
        ge = try container.decodeIfPresent([String].self, forKey: .ge)
        hashedMaids = try container.decodeIfPresent([String].self, forKey: .hashedMaids)
        ...
        ph = try container.decodeIfPresent([String].self, forKey: .ph)
        st = try container.decodeIfPresent([String].self, forKey: .st)
        zp = try container.decodeIfPresent([String].self, forKey: .zp)
    }
