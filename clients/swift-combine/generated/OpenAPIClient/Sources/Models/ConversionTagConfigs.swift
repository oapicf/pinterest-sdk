...
public struct ConversionTagConfigs: Codable {
    ...
    public var noCodeCapiDomains: [String]?

    public init(aemDbEnabled: Bool? = false, aemEnabled: Bool? = false, aemExternalIdEnabled: Bool? = false, aemFnlnEnabled: Bool? = false, aemGeEnabled: Bool? = false, aemLocEnabled: Bool? = false, aemPhEnabled: Bool? = false, mdFrequency: Double? = 1, noCodeCapiDomains: [String]? = nil) {
        ...
        self.noCodeCapiDomains = noCodeCapiDomains
    }
    ...
    public enum CodingKeys: String, CodingKey, CaseIterable {
        ...
        case noCodeCapiDomains = "no_code_capi_domains"
    }
    ...
    public init(from decoder: Decoder) throws {
        ...
        noCodeCapiDomains = try container.decodeIfPresent([String].self, forKey: .noCodeCapiDomains)
    }
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(noCodeCapiDomains, forKey: .noCodeCapiDomains)
    }
}
