...
public struct CatalogsFeedIngestionWarnings: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        AD_IMAGE_DOWNLOAD_CONTENT_READ_ERROR = try container.decodeIfPresent(Int.self, forKey: .AD_IMAGE_DOWNLOAD_CONTENT_READ_ERROR)
        AD_IMAGE_DOWNLOAD_DNS_LOOKUP_ERROR = try container.decodeIfPresent(Int.self, forKey: .AD_IMAGE_DOWNLOAD_DNS_LOOKUP_ERROR)
        AD_IMAGE_DOWNLOAD_FILE_NOT_ACCESSIBLE = try container.decodeIfPresent(Int.self, forKey: .AD_IMAGE_DOWNLOAD_FILE_NOT_ACCESSIBLE)
        AD_IMAGE_DOWNLOAD_FILE_NOT_FOUND = try container.decodeIfPresent(Int.self, forKey: .AD_IMAGE_DOWNLOAD_FILE_NOT_FOUND)
        aDIMAGEDOWNLOADHTTPSTATUS400 = try container.decodeIfPresent(Int.self, forKey: .aDIMAGEDOWNLOADHTTPSTATUS400)
        aDIMAGEDOWNLOADHTTPSTATUS403 = try container.decodeIfPresent(Int.self, forKey: .aDIMAGEDOWNLOADHTTPSTATUS403)
        aDIMAGEDOWNLOADHTTPSTATUS404 = try container.decodeIfPresent(Int.self, forKey: .aDIMAGEDOWNLOADHTTPSTATUS404)
        aDIMAGEDOWNLOADHTTPSTATUS405 = try container.decodeIfPresent(Int.self, forKey: .aDIMAGEDOWNLOADHTTPSTATUS405)
        aDIMAGEDOWNLOADHTTPSTATUS410 = try container.decodeIfPresent(Int.self, forKey: .aDIMAGEDOWNLOADHTTPSTATUS410)
        aDIMAGEDOWNLOADHTTPSTATUS429 = try container.decodeIfPresent(Int.self, forKey: .aDIMAGEDOWNLOADHTTPSTATUS429)
        aDIMAGEDOWNLOADHTTPSTATUS500 = try container.decodeIfPresent(Int.self, forKey: .aDIMAGEDOWNLOADHTTPSTATUS500)
        aDIMAGEDOWNLOADHTTPSTATUS502 = try container.decodeIfPresent(Int.self, forKey: .aDIMAGEDOWNLOADHTTPSTATUS502)
        aDIMAGEDOWNLOADHTTPSTATUS503 = try container.decodeIfPresent(Int.self, forKey: .aDIMAGEDOWNLOADHTTPSTATUS503)
        aDIMAGEDOWNLOADHTTPSTATUS504 = try container.decodeIfPresent(Int.self, forKey: .aDIMAGEDOWNLOADHTTPSTATUS504)
        aDIMAGEDOWNLOADHTTPSTATUS507 = try container.decodeIfPresent(Int.self, forKey: .aDIMAGEDOWNLOADHTTPSTATUS507)
        aDIMAGEDOWNLOADHTTPSTATUS508 = try container.decodeIfPresent(Int.self, forKey: .aDIMAGEDOWNLOADHTTPSTATUS508)
        aDIMAGEDOWNLOADHTTPSTATUS520 = try container.decodeIfPresent(Int.self, forKey: .aDIMAGEDOWNLOADHTTPSTATUS520)
        aDIMAGEDOWNLOADHTTPSTATUS521 = try container.decodeIfPresent(Int.self, forKey: .aDIMAGEDOWNLOADHTTPSTATUS521)
        aDIMAGEDOWNLOADHTTPSTATUS522 = try container.decodeIfPresent(Int.self, forKey: .aDIMAGEDOWNLOADHTTPSTATUS522)
        aDIMAGEDOWNLOADHTTPSTATUS525 = try container.decodeIfPresent(Int.self, forKey: .aDIMAGEDOWNLOADHTTPSTATUS525)
        AD_IMAGE_DOWNLOAD_INTERNAL_CONFIGURATION_ERROR = try container.decodeIfPresent(Int.self, forKey: .AD_IMAGE_DOWNLOAD_INTERNAL_CONFIGURATION_ERROR)
        AD_IMAGE_DOWNLOAD_INTERNAL_ERROR = try container.decodeIfPresent(Int.self, forKey: .AD_IMAGE_DOWNLOAD_INTERNAL_ERROR)
        AD_IMAGE_DOWNLOAD_INTERNAL_FAILED_TO_DOWNLOAD = try container.decodeIfPresent(Int.self, forKey: .AD_IMAGE_DOWNLOAD_INTERNAL_FAILED_TO_DOWNLOAD)
        AD_IMAGE_DOWNLOAD_INTERNAL_MALFORMED_URL = try container.decodeIfPresent(Int.self, forKey: .AD_IMAGE_DOWNLOAD_INTERNAL_MALFORMED_URL)
        AD_IMAGE_DOWNLOAD_INTERNAL_RATE_LIMITED = try container.decodeIfPresent(Int.self, forKey: .AD_IMAGE_DOWNLOAD_INTERNAL_RATE_LIMITED)
        AD_IMAGE_DOWNLOAD_INTERNAL_REQUEST_EXPIRED = try container.decodeIfPresent(Int.self, forKey: .AD_IMAGE_DOWNLOAD_INTERNAL_REQUEST_EXPIRED)
        AD_IMAGE_DOWNLOAD_INVALID_FILE = try container.decodeIfPresent(Int.self, forKey: .AD_IMAGE_DOWNLOAD_INVALID_FILE)
        AD_IMAGE_DOWNLOAD_SITE_ERROR = try container.decodeIfPresent(Int.self, forKey: .AD_IMAGE_DOWNLOAD_SITE_ERROR)
        AD_IMAGE_DOWNLOAD_SITE_TIMEOUT = try container.decodeIfPresent(Int.self, forKey: .AD_IMAGE_DOWNLOAD_SITE_TIMEOUT)
        AD_IMAGE_DOWNLOAD_SSL_ERROR = try container.decodeIfPresent(Int.self, forKey: .AD_IMAGE_DOWNLOAD_SSL_ERROR)
        AD_IMAGE_DOWNLOAD_SSL_HANDSHAKE_ERROR = try container.decodeIfPresent(Int.self, forKey: .AD_IMAGE_DOWNLOAD_SSL_HANDSHAKE_ERROR)
        AD_IMAGE_PROCESSING_EMPTY_FILE = try container.decodeIfPresent(Int.self, forKey: .AD_IMAGE_PROCESSING_EMPTY_FILE)
        AD_IMAGE_PROCESSING_HEIGHT_TOO_SMALL = try container.decodeIfPresent(Int.self, forKey: .AD_IMAGE_PROCESSING_HEIGHT_TOO_SMALL)
        AD_IMAGE_PROCESSING_TOO_MANY_PIXELS = try container.decodeIfPresent(Int.self, forKey: .AD_IMAGE_PROCESSING_TOO_MANY_PIXELS)
        AD_IMAGE_PROCESSING_TYPE_MISMATCH = try container.decodeIfPresent(Int.self, forKey: .AD_IMAGE_PROCESSING_TYPE_MISMATCH)
        AD_IMAGE_PROCESSING_WIDTH_TOO_SMALL = try container.decodeIfPresent(Int.self, forKey: .AD_IMAGE_PROCESSING_WIDTH_TOO_SMALL)
        AD_VIDEO_DOWNLOAD_CONTENT_READ_ERROR = try container.decodeIfPresent(Int.self, forKey: .AD_VIDEO_DOWNLOAD_CONTENT_READ_ERROR)
        AD_VIDEO_DOWNLOAD_DNS_LOOKUP_ERROR = try container.decodeIfPresent(Int.self, forKey: .AD_VIDEO_DOWNLOAD_DNS_LOOKUP_ERROR)
        AD_VIDEO_DOWNLOAD_FILE_NOT_ACCESSIBLE = try container.decodeIfPresent(Int.self, forKey: .AD_VIDEO_DOWNLOAD_FILE_NOT_ACCESSIBLE)
        AD_VIDEO_DOWNLOAD_FILE_NOT_FOUND = try container.decodeIfPresent(Int.self, forKey: .AD_VIDEO_DOWNLOAD_FILE_NOT_FOUND)
        aDVIDEODOWNLOADHTTPSTATUS400 = try container.decodeIfPresent(Int.self, forKey: .aDVIDEODOWNLOADHTTPSTATUS400)
        aDVIDEODOWNLOADHTTPSTATUS403 = try container.decodeIfPresent(Int.self, forKey: .aDVIDEODOWNLOADHTTPSTATUS403)
        aDVIDEODOWNLOADHTTPSTATUS404 = try container.decodeIfPresent(Int.self, forKey: .aDVIDEODOWNLOADHTTPSTATUS404)
        aDVIDEODOWNLOADHTTPSTATUS405 = try container.decodeIfPresent(Int.self, forKey: .aDVIDEODOWNLOADHTTPSTATUS405)
        aDVIDEODOWNLOADHTTPSTATUS410 = try container.decodeIfPresent(Int.self, forKey: .aDVIDEODOWNLOADHTTPSTATUS410)
        aDVIDEODOWNLOADHTTPSTATUS429 = try container.decodeIfPresent(Int.self, forKey: .aDVIDEODOWNLOADHTTPSTATUS429)
        aDVIDEODOWNLOADHTTPSTATUS500 = try container.decodeIfPresent(Int.self, forKey: .aDVIDEODOWNLOADHTTPSTATUS500)
        aDVIDEODOWNLOADHTTPSTATUS502 = try container.decodeIfPresent(Int.self, forKey: .aDVIDEODOWNLOADHTTPSTATUS502)
        aDVIDEODOWNLOADHTTPSTATUS503 = try container.decodeIfPresent(Int.self, forKey: .aDVIDEODOWNLOADHTTPSTATUS503)
        aDVIDEODOWNLOADHTTPSTATUS504 = try container.decodeIfPresent(Int.self, forKey: .aDVIDEODOWNLOADHTTPSTATUS504)
        aDVIDEODOWNLOADHTTPSTATUS507 = try container.decodeIfPresent(Int.self, forKey: .aDVIDEODOWNLOADHTTPSTATUS507)
        aDVIDEODOWNLOADHTTPSTATUS508 = try container.decodeIfPresent(Int.self, forKey: .aDVIDEODOWNLOADHTTPSTATUS508)
        aDVIDEODOWNLOADHTTPSTATUS520 = try container.decodeIfPresent(Int.self, forKey: .aDVIDEODOWNLOADHTTPSTATUS520)
        aDVIDEODOWNLOADHTTPSTATUS521 = try container.decodeIfPresent(Int.self, forKey: .aDVIDEODOWNLOADHTTPSTATUS521)
        aDVIDEODOWNLOADHTTPSTATUS522 = try container.decodeIfPresent(Int.self, forKey: .aDVIDEODOWNLOADHTTPSTATUS522)
        aDVIDEODOWNLOADHTTPSTATUS525 = try container.decodeIfPresent(Int.self, forKey: .aDVIDEODOWNLOADHTTPSTATUS525)
        AD_VIDEO_DOWNLOAD_INTERNAL_CONFIGURATION_ERROR = try container.decodeIfPresent(Int.self, forKey: .AD_VIDEO_DOWNLOAD_INTERNAL_CONFIGURATION_ERROR)
        AD_VIDEO_DOWNLOAD_INTERNAL_ERROR = try container.decodeIfPresent(Int.self, forKey: .AD_VIDEO_DOWNLOAD_INTERNAL_ERROR)
        AD_VIDEO_DOWNLOAD_INTERNAL_FAILED_TO_DOWNLOAD = try container.decodeIfPresent(Int.self, forKey: .AD_VIDEO_DOWNLOAD_INTERNAL_FAILED_TO_DOWNLOAD)
        AD_VIDEO_DOWNLOAD_INTERNAL_MALFORMED_URL = try container.decodeIfPresent(Int.self, forKey: .AD_VIDEO_DOWNLOAD_INTERNAL_MALFORMED_URL)
        AD_VIDEO_DOWNLOAD_INTERNAL_RATE_LIMITED = try container.decodeIfPresent(Int.self, forKey: .AD_VIDEO_DOWNLOAD_INTERNAL_RATE_LIMITED)
        AD_VIDEO_DOWNLOAD_INTERNAL_REQUEST_EXPIRED = try container.decodeIfPresent(Int.self, forKey: .AD_VIDEO_DOWNLOAD_INTERNAL_REQUEST_EXPIRED)
        AD_VIDEO_DOWNLOAD_INVALID_FILE = try container.decodeIfPresent(Int.self, forKey: .AD_VIDEO_DOWNLOAD_INVALID_FILE)
        AD_VIDEO_DOWNLOAD_SITE_ERROR = try container.decodeIfPresent(Int.self, forKey: .AD_VIDEO_DOWNLOAD_SITE_ERROR)
        AD_VIDEO_DOWNLOAD_SITE_TIMEOUT = try container.decodeIfPresent(Int.self, forKey: .AD_VIDEO_DOWNLOAD_SITE_TIMEOUT)
        AD_VIDEO_DOWNLOAD_SSL_ERROR = try container.decodeIfPresent(Int.self, forKey: .AD_VIDEO_DOWNLOAD_SSL_ERROR)
        AD_VIDEO_DOWNLOAD_SSL_HANDSHAKE_ERROR = try container.decodeIfPresent(Int.self, forKey: .AD_VIDEO_DOWNLOAD_SSL_HANDSHAKE_ERROR)
        AD_VIDEO_LENGTH_TOO_SHORT = try container.decodeIfPresent(Int.self, forKey: .AD_VIDEO_LENGTH_TOO_SHORT)
        AD_VIDEO_PROCESSING_EMPTY_FILE = try container.decodeIfPresent(Int.self, forKey: .AD_VIDEO_PROCESSING_EMPTY_FILE)
        AD_VIDEO_PROCESSING_HEIGHT_TOO_SMALL = try container.decodeIfPresent(Int.self, forKey: .AD_VIDEO_PROCESSING_HEIGHT_TOO_SMALL)
        AD_VIDEO_PROCESSING_TOO_MANY_PIXELS = try container.decodeIfPresent(Int.self, forKey: .AD_VIDEO_PROCESSING_TOO_MANY_PIXELS)
        AD_VIDEO_PROCESSING_TYPE_MISMATCH = try container.decodeIfPresent(Int.self, forKey: .AD_VIDEO_PROCESSING_TYPE_MISMATCH)
        AD_VIDEO_PROCESSING_WIDTH_TOO_SMALL = try container.decodeIfPresent(Int.self, forKey: .AD_VIDEO_PROCESSING_WIDTH_TOO_SMALL)
        ADDITIONAL_IMAGE_FILE_NOT_ACCESSIBLE = try container.decodeIfPresent(Int.self, forKey: .ADDITIONAL_IMAGE_FILE_NOT_ACCESSIBLE)
        ADDITIONAL_IMAGE_FILE_NOT_FOUND = try container.decodeIfPresent(Int.self, forKey: .ADDITIONAL_IMAGE_FILE_NOT_FOUND)
        ADDITIONAL_IMAGE_INVALID_FILE = try container.decodeIfPresent(Int.self, forKey: .ADDITIONAL_IMAGE_INVALID_FILE)
        ADDITIONAL_IMAGE_LEVEL_INTERNAL_ERROR = try container.decodeIfPresent(Int.self, forKey: .ADDITIONAL_IMAGE_LEVEL_INTERNAL_ERROR)
        ADDITIONAL_IMAGE_MALFORMED_URL = try container.decodeIfPresent(Int.self, forKey: .ADDITIONAL_IMAGE_MALFORMED_URL)
        FETCH_GOOGLE_SHEET_PUBLIC_CAN_EDIT = try container.decodeIfPresent(Int.self, forKey: .FETCH_GOOGLE_SHEET_PUBLIC_CAN_EDIT)
        HOTEL_PRICE_HEADER_IS_PRESENT = try container.decodeIfPresent(Int.self, forKey: .HOTEL_PRICE_HEADER_IS_PRESENT)
        VIDEO_DOWNLOAD_VIDEO_TOO_SHORT = try container.decodeIfPresent(Int.self, forKey: .VIDEO_DOWNLOAD_VIDEO_TOO_SHORT)
        VIDEO_FILE_NOT_ACCESSIBLE = try container.decodeIfPresent(Int.self, forKey: .VIDEO_FILE_NOT_ACCESSIBLE)
        VIDEO_FILE_NOT_FOUND = try container.decodeIfPresent(Int.self, forKey: .VIDEO_FILE_NOT_FOUND)
        VIDEO_INVALID_FILE = try container.decodeIfPresent(Int.self, forKey: .VIDEO_INVALID_FILE)
        VIDEO_LEVEL_INTERNAL_ERROR = try container.decodeIfPresent(Int.self, forKey: .VIDEO_LEVEL_INTERNAL_ERROR)
        VIDEO_MALFORMED_URL = try container.decodeIfPresent(Int.self, forKey: .VIDEO_MALFORMED_URL)
    }
