...
public enum CatalogsRetailReportStatsParametersReport: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        if let value = try? container.decode(CatalogsReportDistributionIssueFilter.self) {
            ...
            throw DecodingError.typeMismatch(Self.Type.self, .init(codingPath: decoder.codingPath, debugDescription: "Unable to decode instance of CatalogsRetailReportStatsParametersReport"))
        }
    }
}
