//
// AssetGroupUpdateItemReadOrUpdateItem.swift
//
...
public struct AssetGroupUpdateItemReadOrUpdateItem: Codable {
    ...
    public init(assetGroupId: String, assetGroupTypes: [AssetGroupType]? = nil, assetsToAdd: [String]? = nil, assetsToRemove: [String]? = nil, description: String? = nil, name: String? = nil) {
    ...
    public init(from decoder: Decoder) throws {
        ...
        assetGroupId = try container.decode(String.self, forKey: .assetGroupId)
        assetGroupTypes = try container.decodeIfPresent([AssetGroupType].self, forKey: .assetGroupTypes)
        assetsToAdd = try container.decodeIfPresent([String].self, forKey: .assetsToAdd)
        assetsToRemove = try container.decodeIfPresent([String].self, forKey: .assetsToRemove)
