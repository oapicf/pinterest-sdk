...
public struct ConversionEventsDataItemsCustomDataContentsItems: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        itemBrand = try container.decodeIfPresent(String.self, forKey: .itemBrand)
        itemBrandId = try container.decodeIfPresent(String.self, forKey: .itemBrandId)
