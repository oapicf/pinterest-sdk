...
namespace Org.OpenAPITools.Models
{
    ...
    public partial class ImageDetails : IEquatable<ImageDetails>, IValidatableObject
    {
        ...
        public ImageDetails(int width = default(int), int? height = default(int?), string url = default(string))
        {
            ...
            this.Height = height ?? throw new ArgumentNullException("height is a required property for ImageDetails and cannot be null");
            // to ensure "url" is required (not null)
            this.Url = url ?? throw new ArgumentNullException("url is a required property for ImageDetails and cannot be null");
        }
