...
namespace Org.OpenAPITools.Models
{
    ...
    public partial class TargetingTypeFilter : IEquatable<TargetingTypeFilter>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as TargetingTypeFilter);
        }

        /// <summary>
        /// Returns true if TargetingTypeFilter instances are equal
        /// </summary>
        /// <param name="input">Instance of TargetingTypeFilter to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TargetingTypeFilter input)
        {
            if (input == null)
                return false;
