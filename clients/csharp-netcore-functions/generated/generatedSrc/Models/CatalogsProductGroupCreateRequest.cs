...
namespace Org.OpenAPITools.Models
{
    ...
    public partial class CatalogsProductGroupCreateRequest : IEquatable<CatalogsProductGroupCreateRequest>, IValidatableObject
    {
        ...
        public CatalogsProductGroupCreateRequest(string feedId = default(string), string name = default(string), string description = default(string), CatalogsProductGroupFilters filters = default(CatalogsProductGroupFilters))
        {
            ...
            this.FeedId = feedId ?? throw new ArgumentNullException("feedId is a required property for CatalogsProductGroupCreateRequest and cannot be null");
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for CatalogsProductGroupCreateRequest and cannot be null");
            // to ensure "filters" is required (not null)
            this.Filters = filters ?? throw new ArgumentNullException("filters is a required property for CatalogsProductGroupCreateRequest and cannot be null");
