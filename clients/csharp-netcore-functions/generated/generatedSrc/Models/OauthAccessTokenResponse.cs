...
namespace Org.OpenAPITools.Models
{
    ...
    public partial class OauthAccessTokenResponse : IEquatable<OauthAccessTokenResponse>, IValidatableObject
    {
        ...
        public OauthAccessTokenResponse(ResponseTypeEnum? responseType = default(ResponseTypeEnum?), string accessToken = default(string), string tokenType = "bearer", int expiresIn = default(int), string scope = default(string))
        {
            ...
            this.AccessToken = accessToken ?? throw new ArgumentNullException("accessToken is a required property for OauthAccessTokenResponse and cannot be null");
            // to ensure "tokenType" is required (not null)
            this.TokenType = tokenType ?? throw new ArgumentNullException("tokenType is a required property for OauthAccessTokenResponse and cannot be null");
            this.ExpiresIn = expiresIn;
            // to ensure "scope" is required (not null)
            this.Scope = scope ?? throw new ArgumentNullException("scope is a required property for OauthAccessTokenResponse and cannot be null");
