...
-type openapi_bulk_upsert_request_update() ::
  ...
  | {'catalog_product_groups', list(openapi_bulk_upsert_request_update_catalog_product_groups_items:openapi_bulk_upsert_request_update_catalog_product_groups_items()) }
  | {'keywords', list(openapi_keyword_update_generated:openapi_keyword_update_generated()) }
  ...
  | {'schedules', list(openapi_schedule_update_request:openapi_schedule_update_request()) }
  ].
