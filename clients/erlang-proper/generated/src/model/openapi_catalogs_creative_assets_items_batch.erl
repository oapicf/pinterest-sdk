...
-export([openapi_catalogs_creative_assets_items_batch/0]).

-export([openapi_catalogs_creative_assets_items_batch/1]).
...
openapi_catalogs_creative_assets_items_batch() ->
    openapi_catalogs_creative_assets_items_batch([]).

openapi_catalogs_creative_assets_items_batch(Fields) ->
