-module(openapi_catalogs_vertical_feeds_update_request).

-include("openapi.hrl").

-export([openapi_catalogs_vertical_feeds_update_request/0]).

-export([openapi_catalogs_vertical_feeds_update_request/1]).
