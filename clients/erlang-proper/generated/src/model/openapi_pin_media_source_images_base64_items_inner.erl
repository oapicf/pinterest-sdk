...
-export([openapi_pin_media_source_images_base64_items_inner/0]).

-export([openapi_pin_media_source_images_base64_items_inner/1]).
...
openapi_pin_media_source_images_base64_items_inner() ->
    openapi_pin_media_source_images_base64_items_inner([]).

openapi_pin_media_source_images_base64_items_inner(Fields) ->
