...
-export([openapi_promotion_create_request/0]).

-export([openapi_promotion_create_request/1]).
...
openapi_promotion_create_request() ->
    openapi_promotion_create_request([]).

openapi_promotion_create_request(Fields) ->
