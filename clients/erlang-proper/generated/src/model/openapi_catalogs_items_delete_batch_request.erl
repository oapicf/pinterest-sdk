...
-export([openapi_catalogs_items_delete_batch_request/0]).

-export([openapi_catalogs_items_delete_batch_request/1]).
...
openapi_catalogs_items_delete_batch_request() ->
    openapi_catalogs_items_delete_batch_request([]).

openapi_catalogs_items_delete_batch_request(Fields) ->
