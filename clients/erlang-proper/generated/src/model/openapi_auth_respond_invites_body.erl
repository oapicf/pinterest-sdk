...
-type openapi_auth_respond_invites_body() ::
  [ {'invites', list(openapi_auth_respond_invites_body_item:openapi_auth_respond_invites_body_item()) }
  ].
...
openapi_auth_respond_invites_body(Fields) ->
  Default = [ {'invites', list(openapi_auth_respond_invites_body_item:openapi_auth_respond_invites_body_item(), 1, 100) }
            ],
