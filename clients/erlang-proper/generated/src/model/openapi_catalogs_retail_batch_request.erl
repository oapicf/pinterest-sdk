...
-type openapi_catalogs_retail_batch_request() ::
  ...
  | {'items', list(openapi_catalogs_retail_batch_request_items_items:openapi_catalogs_retail_batch_request_items_items()) }
  | {'language', binary() }
  ].
...
openapi_catalogs_retail_batch_request(Fields) ->
  Default = [ {'catalog_id', binary() }
            ...
            , {'country', openapi_country:openapi_country() }
            , {'items', list(openapi_catalogs_retail_batch_request_items_items:openapi_catalogs_retail_batch_request_items_items(), 1, 1000) }
