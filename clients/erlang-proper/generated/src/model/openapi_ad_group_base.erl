-module(openapi_ad_group_base).

-include("openapi.hrl").

-export([openapi_ad_group_base/0]).

-export([openapi_ad_group_base/1]).

-export_type([openapi_ad_group_base/0]).

-type openapi_ad_group_base() ::
...
openapi_ad_group_base() ->
    openapi_ad_group_base([]).

openapi_ad_group_base(Fields) ->
