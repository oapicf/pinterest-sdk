-module(openapi_ad_common).

-include("openapi.hrl").

-export([openapi_ad_common/0]).

-export([openapi_ad_common/1]).

-export_type([openapi_ad_common/0]).

-type openapi_ad_common() ::
  [ {'ad_group_id', binary() }
