...
-export([openapi_catalogs_retail_report_stats_parameters/0]).

-export([openapi_catalogs_retail_report_stats_parameters/1]).
...
openapi_catalogs_retail_report_stats_parameters() ->
    openapi_catalogs_retail_report_stats_parameters([]).

openapi_catalogs_retail_report_stats_parameters(Fields) ->
