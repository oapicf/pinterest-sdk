...
-export([openapi_catalogs_product_metadata/0]).

-export([openapi_catalogs_product_metadata/1]).
...
openapi_catalogs_product_metadata() ->
    openapi_catalogs_product_metadata([]).

openapi_catalogs_product_metadata(Fields) ->
