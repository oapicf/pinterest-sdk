-module(openapi_ad_group_create).

-include("openapi.hrl").

-export([openapi_ad_group_create/0]).

-export([openapi_ad_group_create/1]).

-export_type([openapi_ad_group_create/0]).

-type openapi_ad_group_create() ::
...
openapi_ad_group_create() ->
    openapi_ad_group_create([]).

openapi_ad_group_create(Fields) ->
