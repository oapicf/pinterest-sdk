...
-export([openapi_catalogs_hotel_feeds_update_request/0]).

-export([openapi_catalogs_hotel_feeds_update_request/1]).
...
openapi_catalogs_hotel_feeds_update_request() ->
    openapi_catalogs_hotel_feeds_update_request([]).

openapi_catalogs_hotel_feeds_update_request(Fields) ->
