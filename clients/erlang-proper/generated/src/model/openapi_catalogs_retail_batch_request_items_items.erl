...
-export([openapi_catalogs_retail_batch_request_items_items/0]).

-export([openapi_catalogs_retail_batch_request_items_items/1]).
...
openapi_catalogs_retail_batch_request_items_items() ->
    openapi_catalogs_retail_batch_request_items_items([]).

openapi_catalogs_retail_batch_request_items_items(Fields) ->
