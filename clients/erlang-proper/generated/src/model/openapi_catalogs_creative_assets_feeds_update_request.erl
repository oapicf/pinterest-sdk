-module(openapi_catalogs_creative_assets_feeds_update_request).

-include("openapi.hrl").

-export([openapi_catalogs_creative_assets_feeds_update_request/0]).

-export([openapi_catalogs_creative_assets_feeds_update_request/1]).
