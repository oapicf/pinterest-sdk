...
-export([openapi_product_tags_bulk_delete_request/0]).

-export([openapi_product_tags_bulk_delete_request/1]).
...
openapi_product_tags_bulk_delete_request() ->
    openapi_product_tags_bulk_delete_request([]).

openapi_product_tags_bulk_delete_request(Fields) ->
