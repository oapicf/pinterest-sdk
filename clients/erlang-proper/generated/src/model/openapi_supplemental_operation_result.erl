-module(openapi_supplemental_operation_result).

-include("openapi.hrl").

-export([openapi_supplemental_operation_result/0]).

-export([openapi_supplemental_operation_result/1]).

-export_type([openapi_supplemental_operation_result/0]).

-type openapi_supplemental_operation_result() ::
...
openapi_supplemental_operation_result() ->
    openapi_supplemental_operation_result([]).

openapi_supplemental_operation_result(Fields) ->
