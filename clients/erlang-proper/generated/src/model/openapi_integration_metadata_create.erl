-module(openapi_integration_metadata_create).

-include("openapi.hrl").

-export([openapi_integration_metadata_create/0]).

-export([openapi_integration_metadata_create/1]).

-export_type([openapi_integration_metadata_create/0]).

-type openapi_integration_metadata_create() ::
...
openapi_integration_metadata_create() ->
    openapi_integration_metadata_create([]).

openapi_integration_metadata_create(Fields) ->
