...
-export([openapi_updatable_item_attributes/0]).

-export([openapi_updatable_item_attributes/1]).
...
openapi_updatable_item_attributes() ->
    openapi_updatable_item_attributes([]).

openapi_updatable_item_attributes(Fields) ->
