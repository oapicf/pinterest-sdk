...
-export([openapi_delete_partner_asset_access_item/0]).

-export([openapi_delete_partner_asset_access_item/1]).
...
openapi_delete_partner_asset_access_item() ->
    openapi_delete_partner_asset_access_item([]).

openapi_delete_partner_asset_access_item(Fields) ->
