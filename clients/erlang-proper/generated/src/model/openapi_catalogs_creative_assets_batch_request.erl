-module(openapi_catalogs_creative_assets_batch_request).

-include("openapi.hrl").

-export([openapi_catalogs_creative_assets_batch_request/0]).

-export([openapi_catalogs_creative_assets_batch_request/1]).
...
openapi_catalogs_creative_assets_batch_request() ->
    openapi_catalogs_creative_assets_batch_request([]).

openapi_catalogs_creative_assets_batch_request(Fields) ->
