...
-export([openapi_advertiser_defined_events_get_200_response/0]).

-export([openapi_advertiser_defined_events_get_200_response/1]).
...
openapi_advertiser_defined_events_get_200_response() ->
    openapi_advertiser_defined_events_get_200_response([]).

openapi_advertiser_defined_events_get_200_response(Fields) ->
