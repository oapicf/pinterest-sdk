...
-export([openapi_targeting_spec_operation_geo_exclude/0]).

-export([openapi_targeting_spec_operation_geo_exclude/1]).
...
openapi_targeting_spec_operation_geo_exclude() ->
    openapi_targeting_spec_operation_geo_exclude([]).

openapi_targeting_spec_operation_geo_exclude(Fields) ->
  Default = [ {'field', elements([<<"GEO_EXCLUDE">>]) }
            , {'operation', openapi_targeting_spec_list_operation:openapi_targeting_spec_list_operation() }
            , {'values', list(binary()) }
            ],
