...
-export([openapi_catalogs_retail_report_all_items_filter/0]).

-export([openapi_catalogs_retail_report_all_items_filter/1]).
...
openapi_catalogs_retail_report_all_items_filter() ->
    openapi_catalogs_retail_report_all_items_filter([]).

openapi_catalogs_retail_report_all_items_filter(Fields) ->
