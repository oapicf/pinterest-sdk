...
-export([openapi_ad_array_response_element/0]).

-export([openapi_ad_array_response_element/1]).
...
openapi_ad_array_response_element() ->
    openapi_ad_array_response_element([]).

openapi_ad_array_response_element(Fields) ->
  Default = [ {'data', openapi_ad_response:openapi_ad_response() }
            , {'exceptions', openapi_exception:openapi_exception() }
            ],
