...
-export([openapi_catalogs_hotel_available_filter_values/0]).

-export([openapi_catalogs_hotel_available_filter_values/1]).
...
openapi_catalogs_hotel_available_filter_values() ->
    openapi_catalogs_hotel_available_filter_values([]).

openapi_catalogs_hotel_available_filter_values(Fields) ->
