...
-export([openapi_catalogs_items_batch_post_request/0]).

-export([openapi_catalogs_items_batch_post_request/1]).
...
openapi_catalogs_items_batch_post_request() ->
    openapi_catalogs_items_batch_post_request([]).

openapi_catalogs_items_batch_post_request(Fields) ->
