-module(openapi_schedule_create_request).

-include("openapi.hrl").

-export([openapi_schedule_create_request/0]).

-export([openapi_schedule_create_request/1]).

-export_type([openapi_schedule_create_request/0]).

-type openapi_schedule_create_request() ::
  [ {'entity_id', binary() }
  | {'entity_type', binary() }
...
openapi_schedule_create_request() ->
    openapi_schedule_create_request([]).

openapi_schedule_create_request(Fields) ->
