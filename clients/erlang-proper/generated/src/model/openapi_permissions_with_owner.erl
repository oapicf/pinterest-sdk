...
openapi_permissions_with_owner() ->
  elements([<<"ADMIN">>, <<"ANALYST">>, <<"FINANCE_MANAGER">>, <<"FINANCE_EDIT">>, <<"FINANCE_VIEW">>, <<"AUDIENCE_MANAGER">>, <<"CAMPAIGN_MANAGER">>, <<"CATALOGS_MANAGER">>, <<"CATALOGS_VIEWER">>, <<"PROFILE_PUBLISHER">>, <<"OWNER">>]).
