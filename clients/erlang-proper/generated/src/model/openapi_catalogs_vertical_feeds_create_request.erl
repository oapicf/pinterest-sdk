...
-export([openapi_catalogs_vertical_feeds_create_request/0]).

-export([openapi_catalogs_vertical_feeds_create_request/1]).
...
openapi_catalogs_vertical_feeds_create_request() ->
    openapi_catalogs_vertical_feeds_create_request([]).

openapi_catalogs_vertical_feeds_create_request(Fields) ->
