...
-export([openapi_business_to_business_shared_audience/0]).

-export([openapi_business_to_business_shared_audience/1]).
...
openapi_business_to_business_shared_audience() ->
    openapi_business_to_business_shared_audience([]).

openapi_business_to_business_shared_audience(Fields) ->
