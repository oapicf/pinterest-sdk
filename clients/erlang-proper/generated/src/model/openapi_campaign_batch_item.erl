...
-export([openapi_campaign_batch_item/0]).

-export([openapi_campaign_batch_item/1]).
...
openapi_campaign_batch_item() ->
    openapi_campaign_batch_item([]).

openapi_campaign_batch_item(Fields) ->
  Default = [ {'data', openapi_campaign_batch_response_data:openapi_campaign_batch_response_data() }
            , {'exceptions', list(openapi_exception:openapi_exception()) }
            ],
