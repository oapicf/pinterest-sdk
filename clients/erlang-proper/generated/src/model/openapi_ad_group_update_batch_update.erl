...
-export([openapi_ad_group_update_batch_update/0]).

-export([openapi_ad_group_update_batch_update/1]).
...
openapi_ad_group_update_batch_update() ->
    openapi_ad_group_update_batch_update([]).

openapi_ad_group_update_batch_update(Fields) ->
