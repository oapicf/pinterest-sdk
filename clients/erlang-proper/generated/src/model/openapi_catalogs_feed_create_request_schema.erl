-module(openapi_catalogs_feed_create_request_schema).

-include("openapi.hrl").

-export([openapi_catalogs_feed_create_request_schema/0]).

-export([openapi_catalogs_feed_create_request_schema/1]).

-export_type([openapi_catalogs_feed_create_request_schema/0]).

-type openapi_catalogs_feed_create_request_schema() ::
  [ {'catalog_id', binary() }
  | {'catalog_type', binary() }
...
openapi_catalogs_feed_create_request_schema() ->
    openapi_catalogs_feed_create_request_schema([]).

openapi_catalogs_feed_create_request_schema(Fields) ->
