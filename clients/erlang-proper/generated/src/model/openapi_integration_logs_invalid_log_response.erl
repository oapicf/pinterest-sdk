...
-type openapi_integration_logs_invalid_log_response() ::
  [ {'rejected_logs', list(openapi_integration_logs_invalid_log_response_rejected_logs_items:openapi_integration_logs_invalid_log_response_rejected_logs_items()) }
  ].
...
openapi_integration_logs_invalid_log_response(Fields) ->
  Default = [ {'rejected_logs', list(openapi_integration_logs_invalid_log_response_rejected_logs_items:openapi_integration_logs_invalid_log_response_rejected_logs_items()) }
            ],
