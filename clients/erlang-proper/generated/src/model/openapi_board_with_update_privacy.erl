...
-export([openapi_board_with_update_privacy/0]).

-export([openapi_board_with_update_privacy/1]).
...
openapi_board_with_update_privacy() ->
    openapi_board_with_update_privacy([]).

openapi_board_with_update_privacy(Fields) ->
