...
-export([openapi_catalogs_retail_report_stats_parameters_report/0]).

-export([openapi_catalogs_retail_report_stats_parameters_report/1]).
...
openapi_catalogs_retail_report_stats_parameters_report() ->
    openapi_catalogs_retail_report_stats_parameters_report([]).

openapi_catalogs_retail_report_stats_parameters_report(Fields) ->
