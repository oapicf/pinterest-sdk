...
-export([openapi_catalogs_hotel_report_parameters/0]).

-export([openapi_catalogs_hotel_report_parameters/1]).
...
openapi_catalogs_hotel_report_parameters() ->
    openapi_catalogs_hotel_report_parameters([]).

openapi_catalogs_hotel_report_parameters(Fields) ->
