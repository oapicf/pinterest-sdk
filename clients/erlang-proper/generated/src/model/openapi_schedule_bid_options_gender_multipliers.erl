...
-export([openapi_schedule_bid_options_gender_multipliers/0]).

-export([openapi_schedule_bid_options_gender_multipliers/1]).
...
openapi_schedule_bid_options_gender_multipliers() ->
    openapi_schedule_bid_options_gender_multipliers([]).

openapi_schedule_bid_options_gender_multipliers(Fields) ->
