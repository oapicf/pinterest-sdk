-module(openapi_ad_create).

-include("openapi.hrl").

-export([openapi_ad_create/0]).

-export([openapi_ad_create/1]).

-export_type([openapi_ad_create/0]).

-type openapi_ad_create() ::
  [ {'ad_group_id', binary() }
