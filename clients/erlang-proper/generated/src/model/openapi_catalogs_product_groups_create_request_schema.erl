...
-export([openapi_catalogs_product_groups_create_request_schema/0]).

-export([openapi_catalogs_product_groups_create_request_schema/1]).
...
openapi_catalogs_product_groups_create_request_schema() ->
    openapi_catalogs_product_groups_create_request_schema([]).

openapi_catalogs_product_groups_create_request_schema(Fields) ->
