...
-export([openapi_conversion_events_data_items/0]).

-export([openapi_conversion_events_data_items/1]).
...
openapi_conversion_events_data_items() ->
    openapi_conversion_events_data_items([]).

openapi_conversion_events_data_items(Fields) ->
