...
-type openapi_bulk_upsert_request_create() ::
  ...
  | {'catalog_product_groups', list(openapi_multiple_product_groups_inner:openapi_multiple_product_groups_inner()) }
  | {'keywords', list(openapi_keywords_request:openapi_keywords_request()) }
  | {'labels', list(openapi_label_create_request:openapi_label_create_request()) }
