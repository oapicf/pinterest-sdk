-module(openapi_catalogs_retail_items_batch).

-include("openapi.hrl").

-export([openapi_catalogs_retail_items_batch/0]).

-export([openapi_catalogs_retail_items_batch/1]).

-export_type([openapi_catalogs_retail_items_batch/0]).
...
openapi_catalogs_retail_items_batch() ->
    openapi_catalogs_retail_items_batch([]).
