...
-type openapi_update_member_asset_access_body() ::
  [ {'accesses', list(openapi_update_member_asset_access_item:openapi_update_member_asset_access_item()) }
  ].
...
openapi_update_member_asset_access_body(Fields) ->
  Default = [ {'accesses', list(openapi_update_member_asset_access_item:openapi_update_member_asset_access_item(), 1, 50) }
            ],
