...
-export([openapi_catalogs_retail_items_post_filter/0]).

-export([openapi_catalogs_retail_items_post_filter/1]).
...
openapi_catalogs_retail_items_post_filter() ->
    openapi_catalogs_retail_items_post_filter([]).

openapi_catalogs_retail_items_post_filter(Fields) ->
