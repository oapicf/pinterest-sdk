-module(openapi_item_attributes_request).

-include("openapi.hrl").

-export([openapi_item_attributes_request/0]).

-export([openapi_item_attributes_request/1]).

-export_type([openapi_item_attributes_request/0]).

-type openapi_item_attributes_request() ::
  [ {'ad_link', binary() }
  | {'adult', boolean() }
  | {'age_group', binary() }
  | {'availability', binary() }
...
openapi_item_attributes_request() ->
    openapi_item_attributes_request([]).

openapi_item_attributes_request(Fields) ->
