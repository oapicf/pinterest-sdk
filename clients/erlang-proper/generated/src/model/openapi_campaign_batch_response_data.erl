...
-export([openapi_campaign_batch_response_data/0]).

-export([openapi_campaign_batch_response_data/1]).
...
openapi_campaign_batch_response_data() ->
    openapi_campaign_batch_response_data([]).

openapi_campaign_batch_response_data(Fields) ->
