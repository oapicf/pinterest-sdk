...
-type openapi_update_member_assets_results_response_array() ::
  [ {'items', list(openapi_update_member_asset_result_item:openapi_update_member_asset_result_item()) }
  ].
...
openapi_update_member_assets_results_response_array(Fields) ->
  Default = [ {'items', list(openapi_update_member_asset_result_item:openapi_update_member_asset_result_item()) }
            ],
