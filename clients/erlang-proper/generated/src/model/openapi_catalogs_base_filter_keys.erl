-module(openapi_catalogs_base_filter_keys).

-include("openapi.hrl").

-export([openapi_catalogs_base_filter_keys/0]).

-export([openapi_catalogs_base_filter_keys/1]).

-export_type([openapi_catalogs_base_filter_keys/0]).

-type openapi_catalogs_base_filter_keys() ::
...
openapi_catalogs_base_filter_keys() ->
    openapi_catalogs_base_filter_keys([]).

openapi_catalogs_base_filter_keys(Fields) ->
