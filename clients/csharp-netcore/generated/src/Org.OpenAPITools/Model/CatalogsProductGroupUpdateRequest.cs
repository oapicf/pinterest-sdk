...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class CatalogsProductGroupUpdateRequest : IEquatable<CatalogsProductGroupUpdateRequest>, IValidatableObject
    {
        ...
        public CatalogsProductGroupUpdateRequest(string feedId = default(string), string name = default(string), string description = default(string), CatalogsProductGroupFilters filters = default(CatalogsProductGroupFilters))
        {
            ...
            if (feedId == null) {
                throw new ArgumentNullException("feedId is a required property for CatalogsProductGroupUpdateRequest and cannot be null");
            }
            this.FeedId = feedId;
            // to ensure "name" is required (not null)
            if (name == null) {
                throw new ArgumentNullException("name is a required property for CatalogsProductGroupUpdateRequest and cannot be null");
            }
            this.Name = name;
            // to ensure "filters" is required (not null)
            if (filters == null) {
                throw new ArgumentNullException("filters is a required property for CatalogsProductGroupUpdateRequest and cannot be null");
            }
