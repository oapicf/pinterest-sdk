...
public struct CatalogsItemsCreateBatchRequest: Sendable, Codable, Hashable {
    ...
    public init(country: Country, items: [ItemCreateBatchRecord], language: Language, operation: Operation) {
