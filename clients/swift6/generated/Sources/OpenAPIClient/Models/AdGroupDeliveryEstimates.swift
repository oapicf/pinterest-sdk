...
public struct AdGroupDeliveryEstimates: Sendable, Codable, Hashable {

    public static let monthlyFrequencyCapRule = NumericRule<Int>(minimum: 0, exclusiveMinimum: false, maximum: nil, exclusiveMaximum: false, multipleOf: nil)
