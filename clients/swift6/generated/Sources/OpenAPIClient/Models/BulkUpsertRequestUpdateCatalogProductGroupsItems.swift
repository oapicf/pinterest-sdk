//
// BulkUpsertRequestUpdateCatalogProductGroupsItems.swift
//
...
public enum BulkUpsertRequestUpdateCatalogProductGroupsItems: Sendable, Codable, Hashable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        if let value = try? container.decode(CatalogsProductGroupUpdateRequest.self) {
            ...
            throw DecodingError.typeMismatch(Self.Type.self, .init(codingPath: decoder.codingPath, debugDescription: "Unable to decode instance of BulkUpsertRequestUpdateCatalogProductGroupsItems"))
        }
    }
}
