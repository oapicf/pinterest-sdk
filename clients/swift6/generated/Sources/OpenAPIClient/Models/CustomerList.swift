...
public struct CustomerList: Sendable, Codable, Hashable {
    ...
    public var exceptions: JSONValue?
    /** Customer list ID. */
    ...
    public init(adAccountId: String? = nil, createdTime: Double? = nil, exceptions: JSONValue? = nil, id: String, isNca: Bool? = nil, name: String, numBatches: Double? = nil, numRemovedUserRecords: Double? = nil, numUploadedUserRecords: Double? = nil, status: CustomerListStatus? = nil, type: String? = nil, updatedTime: Double? = nil) {
