...
public struct CampaignUpdateRequest: Sendable, Codable, Hashable {
    ...
    public init(bidOptions: CampaignBidOptionsUpdate? = nil, intendedPromotionType: IntendedPromotionType? = nil, isLtvOptimized: Bool? = nil, isPerformancePlus: Bool? = nil, isTopOfSearch: Bool? = nil, objectiveType: ObjectiveType? = nil, adAccountId: String, dailySpendCap: Int? = nil, defaultAdGroupBudgetInMicroCurrency: Int? = nil, endTime: Int? = nil, id: String, isAutomatedCampaign: Bool? = nil, isCampaignBudgetOptimization: Bool? = nil, isFlexibleDailyBudgets: Bool? = nil, lifetimeSpendCap: Int? = nil, name: String? = nil, orderLineId: String? = nil, startTime: Int? = nil, status: EntityStatus? = nil, trackingUrls: JSONValue? = nil) {
