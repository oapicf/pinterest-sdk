...
public struct CatalogsItemsUpsertBatchRequest: Sendable, Codable, Hashable {
    ...
    public init(country: Country, items: [ItemUpsertBatchRecord], language: Language, operation: Operation) {
