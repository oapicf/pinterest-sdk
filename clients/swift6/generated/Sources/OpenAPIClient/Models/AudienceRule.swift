...
public struct AudienceRule: Sendable, Codable, Hashable {
    ...
    public static let visitorSourceIdRule = StringRule(minLength: nil, maxLength: nil, pattern: "/^\\d+$/")
    /** Ad account ID. */
