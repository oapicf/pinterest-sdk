...
public struct CatalogsRetailReportAllItemsFilter: Sendable, Codable, Hashable {
    ...
    public static let productGroupIdRule = StringRule(minLength: nil, maxLength: nil, pattern: "/^\\d+$/")
