...
public struct TargetingSpec: Sendable, Codable, Hashable {
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(GEO_EXCLUDE, forKey: .GEO_EXCLUDE)
        try container.encodeIfPresent(INTEREST, forKey: .INTEREST)
        try container.encodeIfPresent(LOCALE, forKey: .LOCALE)
        try container.encodeIfPresent(LOCATION, forKey: .LOCATION)
        try container.encodeIfPresent(LOCATION_EXCLUDE, forKey: .LOCATION_EXCLUDE)
