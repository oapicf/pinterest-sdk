...
**attributionTypes** | [ConversionReportAttributionType] | List of attribution types for the conversion report. | [optional] 
...
**campaignObjectiveTypes** | [CampaignObjectiveType] | List of values for filtering. [\&quot;WEB_SESSIONS\&quot;] is in BETA. | [optional] 
...
**columns** | [ReportingColumnAsync] | Metric and entity columns. Pin promotion and ad related columns are not supported for Product Item level reports. | [optional] 
...
**customConversionEventMetrics** | [CustomConversionEventMetrics] | List of advertiser-defined custom conversion event metrics to include in the report | [optional] 
...
**targetingTypes** | [AdAdsAnalyticsAsyncTargetingTypes] | List of targeting types. Requires &#x60;level&#x60; to be a value ending in &#x60;_TARGETING&#x60;. | [optional] 
