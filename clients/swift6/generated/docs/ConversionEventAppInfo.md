...
**installTime** | **Int** | App install time. Unix timestamp in seconds | [optional] 
**userAgent** | **String** | User Agent request header. Primarily used for Web events | [optional] 
**windowHeight** | **Int** | Inner height of the window or viewport. | [optional] 
**windowWidth** | **Int** | Inner width of the window or viewport. | [optional] 
