...
For more, see <a class=\"reference external\" href=\"https://help.pinterest.com/en/business/article/lead-ads\">Lead ads</a>."
  [ad_account_id string?, lead_form_id string?]
  (check-required-params ad_account_id lead_form_id)
...
(defn-spec lead-form-get lead-form-response-spec
  "Get lead form by id
  <strong>This feature is currently in beta and not available to all apps, if you're interested in joining the beta, please reach out to your Pinterest account manager.</strong>
...
For more, see <a class=\"reference external\" href=\"https://help.pinterest.com/en/business/article/lead-ads\">Lead ads</a>."
  [ad_account_id string?, lead_form_id string?]
  (let [res (:data (lead-form-get-with-http-info ad_account_id lead_form_id))]
    (if (:decode-models *api-context*)
       (st/decode lead-form-response-spec res st/string-transformer)
       res)))
...
- List of answers should follow the questions creation order."
  [ad_account_id string?, lead_form_id string?, lead-form-test-request lead-form-test-request]
  (check-required-params ad_account_id lead_form_id lead-form-test-request)
  (call-api "/ad_accounts/{ad_account_id}/lead_forms/{lead_form_id}/test" :post
            {:path-params   {"ad_account_id" ad_account_id "lead_form_id" lead_form_id }
             :header-params {}
             :query-params  {}
             :form-params   {}
             :body-param    lead-form-test-request
             :content-types ["application/json"]
             :accepts       ["application/json"]
             :auth-names    ["pinterest_oauth2"]}))

(defn-spec lead-form-test-create lead-form-test-response-spec
  "Create lead form test data
  Create lead form test data based on the list of answers provided as part of the body.
- List of answers should follow the questions creation order."
  [ad_account_id string?, lead_form_id string?, lead-form-test-request lead-form-test-request]
  (let [res (:data (lead-form-test-create-with-http-info ad_account_id lead_form_id lead-form-test-request))]
    (if (:decode-models *api-context*)
       (st/decode lead-form-test-response-spec res st/string-transformer)
       res)))
...
For more, see <a class=\"reference external\" href=\"https://help.pinterest.com/en/business/article/lead-ads\">Lead ads</a>."
  [ad_account_id string?, lead-form-create-request (s/coll-of lead-form-create-request-spec)]
  (check-required-params ad_account_id lead-form-create-request)
  (call-api "/ad_accounts/{ad_account_id}/lead_forms" :post
            {:path-params   {"ad_account_id" ad_account_id }
             :header-params {}
             :query-params  {}
             :form-params   {}
             :body-param    lead-form-create-request
             :content-types ["application/json"]
             :accepts       ["application/json"]
             :auth-names    ["pinterest_oauth2"]}))

(defn-spec lead-forms-create lead-form-array-response-spec
  "Create lead forms
  <strong>This feature is currently in beta and not available to all apps, if you're interested in joining the beta, please reach out to your Pinterest account manager.</strong>
...
For more, see <a class=\"reference external\" href=\"https://help.pinterest.com/en/business/article/lead-ads\">Lead ads</a>."
  [ad_account_id string?, lead-form-create-request (s/coll-of lead-form-create-request-spec)]
  (let [res (:data (lead-forms-create-with-http-info ad_account_id lead-form-create-request))]
    (if (:decode-models *api-context*)
       (st/decode lead-form-array-response-spec res st/string-transformer)
       res)))
...
For more, see <a class=\"reference external\" href=\"https://help.pinterest.com/en/business/article/lead-ads\">Lead ads</a>."
  [ad_account_id string?, lead-form-update-request (s/coll-of lead-form-update-request-spec)]
  (check-required-params ad_account_id lead-form-update-request)
  (call-api "/ad_accounts/{ad_account_id}/lead_forms" :patch
            {:path-params   {"ad_account_id" ad_account_id }
             :header-params {}
             :query-params  {}
             :form-params   {}
             :body-param    lead-form-update-request
             :content-types ["application/json"]
             :accepts       ["application/json"]
             :auth-names    ["pinterest_oauth2"]}))

(defn-spec lead-forms-update lead-form-array-response-spec
  "Update lead forms
  <strong>This feature is currently in beta and not available to all apps, if you're interested in joining the beta, please reach out to your Pinterest account manager.</strong>
...
For more, see <a class=\"reference external\" href=\"https://help.pinterest.com/en/business/article/lead-ads\">Lead ads</a>."
  [ad_account_id string?, lead-form-update-request (s/coll-of lead-form-update-request-spec)]
  (let [res (:data (lead-forms-update-with-http-info ad_account_id lead-form-update-request))]
    (if (:decode-models *api-context*)
       (st/decode lead-form-array-response-spec res st/string-transformer)
       res)))
