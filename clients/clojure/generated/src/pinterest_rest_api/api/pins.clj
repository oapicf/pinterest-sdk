...
(defn-spec pins-list-with-http-info any?
  ...
  ([{:keys [pin_filter pin_metrics include_protected_pins pin_type creative_types ad_account_id bookmark page_size]} (s/map-of keyword? any?)]
   (call-api "/pins" :get
             {:path-params   {}
              :header-params {}
              :query-params  {"pin_filter" pin_filter "pin_metrics" pin_metrics "include_protected_pins" include_protected_pins "pin_type" pin_type "creative_types" (with-collection-format creative_types :multi) "ad_account_id" ad_account_id "bookmark" bookmark "page_size" page_size }
              :form-params   {}
              :content-types []
              :accepts       ["application/json"]
              :auth-names    ["pinterest_oauth2" "client_credentials"]})))
...
- Any public Pin can be saved given a pin ID."
  ([pin_id string?, pins-save-request pins-save-request, ] (pins-save-with-http-info pin_id pins-save-request nil))
  ([pin_id string?, pins-save-request pins-save-request, {:keys [ad_account_id]} (s/map-of keyword? any?)]
   (check-required-params pin_id pins-save-request)
   (call-api "/pins/{pin_id}/save" :post
             {:path-params   {"pin_id" pin_id }
              :header-params {}
              :query-params  {"ad_account_id" ad_account_id }
              :form-params   {}
              :body-param    pins-save-request
              :content-types ["application/json"]
              :accepts       ["application/json"]
...
- Any Pin type can be saved: image Pin, video Pin, Idea Pin, product Pin, etc.
- Any public Pin can be saved given a pin ID."
  ([pin_id string?, pins-save-request pins-save-request, ] (pins-save pin_id pins-save-request nil))
  ([pin_id string?, pins-save-request pins-save-request, optional-params any?]
   (let [res (:data (pins-save-with-http-info pin_id pins-save-request optional-params))]
     (if (:decode-models *api-context*)
        (st/decode pin-spec res st/string-transformer)
        res))))
