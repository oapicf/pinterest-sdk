(ns pinterest-rest-api.api.product-tags
...
(defn-spec product-tags-bulk-add-with-http-info any?
...
- If a product tag is already tagged on the pin, it is treated as a no-op success."
  [pin_id string?, product-tags-bulk-add-request product-tags-bulk-add-request]
  (check-required-params pin_id product-tags-bulk-add-request)
  (call-api "/pins/{pin_id}/product_tags" :post
            {:path-params   {"pin_id" pin_id }
             :header-params {}
             :query-params  {}
             :form-params   {}
             :body-param    product-tags-bulk-add-request
             :content-types ["application/json"]
             :accepts       ["application/json"]
             :auth-names    ["pinterest_oauth2"]}))

(defn-spec product-tags-bulk-add product-tags-response-spec
  "Add product tags to pin
  Add product tags to a pin. Product tags allow you to tag product pins onto a hero pin.
- Maximum 24 product tags can be added in a single request.
- Duplicate pin_ids in the request will result in an error.
...
- If a product tag is already tagged on the pin, it is treated as a no-op success."
  [pin_id string?, product-tags-bulk-add-request product-tags-bulk-add-request]
  (let [res (:data (product-tags-bulk-add-with-http-info pin_id product-tags-bulk-add-request))]
    (if (:decode-models *api-context*)
       (st/decode product-tags-response-spec res st/string-transformer)
       res)))


(defn-spec product-tags-bulk-delete-with-http-info any?
...
- If a product tag is not found on the pin, it is treated as a no-op success."
  [pin_id string?, product-tags-bulk-delete-request product-tags-bulk-delete-request]
  (check-required-params pin_id product-tags-bulk-delete-request)
  (call-api "/pins/{pin_id}/product_tags/bulk-delete" :post
            {:path-params   {"pin_id" pin_id }
             :header-params {}
             :query-params  {}
             :form-params   {}
             :body-param    product-tags-bulk-delete-request
             :content-types ["application/json"]
             :accepts       ["application/json"]
             :auth-names    ["pinterest_oauth2"]}))

(defn-spec product-tags-bulk-delete any?
  "Delete product tags from pin
  Delete product tags from a pin.
- If a product tag is not found on the pin, it is treated as a no-op success."
  [pin_id string?, product-tags-bulk-delete-request product-tags-bulk-delete-request]
  (let [res (:data (product-tags-bulk-delete-with-http-info pin_id product-tags-bulk-delete-request))]
    (if (:decode-models *api-context*)
       (st/decode any? res st/string-transformer)
       res)))


(defn-spec product-tags-list-with-http-info any?
...
- Returns an empty array if the pin has no product tags."
  ...
  (call-api "/pins/{pin_id}/product_tags" :get
            {:path-params   {"pin_id" pin_id }
             :header-params {}
             :query-params  {}
             :form-params   {}
...
(defn-spec product-tags-list product-tags-response-spec
  "Get product tags for pin
  Retrieve all product tags for a pin.
- Returns an empty array if the pin has no product tags."
  [pin_id string?]
  (let [res (:data (product-tags-list-with-http-info pin_id))]
    (if (:decode-models *api-context*)
       (st/decode product-tags-response-spec res st/string-transformer)
       res)))
