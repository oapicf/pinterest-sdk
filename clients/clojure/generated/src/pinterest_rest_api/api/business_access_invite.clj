...
(defn-spec cancel-invites-or-requests-with-http-info any?
  ...
  [business_id string?, cancel-invites-body cancel-invites-body]
  (check-required-params business_id cancel-invites-body)
  (call-api "/businesses/{business_id}/invites" :delete
            {:path-params   {"business_id" business_id }
             :header-params {}
             :query-params  {}
             :form-params   {}
             :body-param    cancel-invites-body
             :content-types ["application/json"]
             :accepts       ["application/json"]
             :auth-names    ["pinterest_oauth2"]}))

(defn-spec cancel-invites-or-requests delete-invites-results-response-array-spec
  "Cancel invites/requests
  Cancel membership/partnership invites and/or requests."
  [business_id string?, cancel-invites-body cancel-invites-body]
  (let [res (:data (cancel-invites-or-requests-with-http-info business_id cancel-invites-body))]
    (if (:decode-models *api-context*)
       (st/decode delete-invites-results-response-array-spec res st/string-transformer)
       res)))
