...
[Learn more](/docs/api-features/shopping-overview/)"
  ...
  ([feed_id string?, {:keys [ad_account_id bookmark page_size]} (s/map-of keyword? any?)]
...
If you require access, please reach out to your partner manager."
  ([catalogs-feed-create-request-schema catalogs-feed-create-request-schema, ] (feeds-create-with-http-info catalogs-feed-create-request-schema nil))
  ([catalogs-feed-create-request-schema catalogs-feed-create-request-schema, {:keys [ad_account_id]} (s/map-of keyword? any?)]
   (check-required-params catalogs-feed-create-request-schema)
   (call-api "/catalogs/feeds" :post
             {:path-params   {}
              :header-params {}
              :query-params  {"ad_account_id" ad_account_id }
              :form-params   {}
              :body-param    catalogs-feed-create-request-schema
...
Note: Access to the Creative Assets catalog type is restricted to a specific group of users.
If you require access, please reach out to your partner manager."
  ([catalogs-feed-create-request-schema catalogs-feed-create-request-schema, ] (feeds-create catalogs-feed-create-request-schema nil))
  ([catalogs-feed-create-request-schema catalogs-feed-create-request-schema, optional-params any?]
   (let [res (:data (feeds-create-with-http-info catalogs-feed-create-request-schema optional-params))]
     (if (:decode-models *api-context*)
...
(defn-spec feeds-delete catalogs-feed-spec
  "Delete feed
  Delete a feed owned by the \"operation user_account\".
- By default, the \"operation user_account\" is the token user_account.
...
For Retail partners, refer to [Before you get started with Catalogs](https://help.pinterest.com/en/business/article/before-you-get-started-with-catalogs). For Hotel partners, refer to [Pinterest API for shopping](/docs/api-features/shopping-overview/)."
  ...
  ([{:keys [catalog_id ad_account_id bookmark page_size]} (s/map-of keyword? any?)]
   (call-api "/catalogs/feeds" :get
             {:path-params   {}
              :header-params {}
              :query-params  {"catalog_id" catalog_id "ad_account_id" ad_account_id "bookmark" bookmark "page_size" page_size }
              :form-params   {}
              :content-types []
              :accepts       ["application/json"]
              :auth-names    ["pinterest_oauth2" "client_credentials"]})))
...
Note: Access to the Creative Assets catalog type is restricted to a specific group of users.
If you require access, please reach out to your partner manager."
  ([feed_id string?, catalogs-feed-update-request-schema catalogs-feed-update-request-schema, ] (feeds-update-with-http-info feed_id catalogs-feed-update-request-schema nil))
  ([feed_id string?, catalogs-feed-update-request-schema catalogs-feed-update-request-schema, {:keys [ad_account_id]} (s/map-of keyword? any?)]
   (check-required-params feed_id catalogs-feed-update-request-schema)
   (call-api "/catalogs/feeds/{feed_id}" :patch
             {:path-params   {"feed_id" feed_id }
              :header-params {}
              :query-params  {"ad_account_id" ad_account_id }
              :form-params   {}
              :body-param    catalogs-feed-update-request-schema
              :content-types ["application/json"]
              :accepts       ["application/json"]
              :auth-names    ["pinterest_oauth2" "client_credentials"]})))
...
Note: Access to the Creative Assets catalog type is restricted to a specific group of users.
If you require access, please reach out to your partner manager."
  ([feed_id string?, catalogs-feed-update-request-schema catalogs-feed-update-request-schema, ] (feeds-update feed_id catalogs-feed-update-request-schema nil))
  ([feed_id string?, catalogs-feed-update-request-schema catalogs-feed-update-request-schema, optional-params any?]
   (let [res (:data (feeds-update-with-http-info feed_id catalogs-feed-update-request-schema optional-params))]
     (if (:decode-models *api-context*)
        (st/decode catalogs-feed-spec res st/string-transformer)
        res))))
...
[Learn more](/docs/api-features/shopping-overview/)"
  ...
  ([processing_result_id string?, {:keys [item_numbers item_validation_issue ad_account_id bookmark page_size]} (s/map-of keyword? any?)]
   ...
   (call-api "/catalogs/processing_results/{processing_result_id}/item_issues" :get
             {:path-params   {"processing_result_id" processing_result_id }
              :header-params {}
              :query-params  {"item_numbers" (with-collection-format item_numbers :multi) "item_validation_issue" item_validation_issue "ad_account_id" ad_account_id "bookmark" bookmark "page_size" page_size }
              :form-params   {}
              :content-types []
              :accepts       ["application/json"]
              :auth-names    ["pinterest_oauth2"]})))
