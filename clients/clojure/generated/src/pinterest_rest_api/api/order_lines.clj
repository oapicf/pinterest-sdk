...
(defn-spec order-lines-get-with-http-info any?
  ...
  [ad_account_id string?, order_line_id string?]
  (check-required-params ad_account_id order_line_id)
  (call-api "/ad_accounts/{ad_account_id}/order_lines/{order_line_id}" :get
            {:path-params   {"ad_account_id" ad_account_id "order_line_id" order_line_id }
             :header-params {}
             :query-params  {}
             :form-params   {}
             :content-types []
...
(defn-spec order-lines-get order-line-spec
  ...
  Get a specific existing order line associated with an ad account."
  [ad_account_id string?, order_line_id string?]
  (let [res (:data (order-lines-get-with-http-info ad_account_id order_line_id))]
