...
(defn-spec promotions-create-with-http-info any?
  ...
  [ad_account_id string?, promotion-create-request (s/coll-of promotion-create-request-spec)]
  (check-required-params ad_account_id promotion-create-request)
  (call-api "/ad_accounts/{ad_account_id}/promotions" :post
            {:path-params   {"ad_account_id" ad_account_id }
             :header-params {}
             :query-params  {}
             :form-params   {}
             :body-param    promotion-create-request
...
(defn-spec promotions-create promotions-response-spec
  ...
  Create multiple new promotions."
  [ad_account_id string?, promotion-create-request (s/coll-of promotion-create-request-spec)]
  (let [res (:data (promotions-create-with-http-info ad_account_id promotion-create-request))]
...
(defn-spec promotions-delete-with-http-info any?
  ...
  [ad_account_id string?, promotion_id string?]
  (check-required-params ad_account_id promotion_id)
  (call-api "/ad_accounts/{ad_account_id}/promotions/{promotion_id}" :delete
            {:path-params   {"ad_account_id" ad_account_id "promotion_id" promotion_id }
             :header-params {}
             :query-params  {}
             :form-params   {}
             :content-types []
...
(defn-spec promotions-delete any?
  "Delete promotion by id
  Delete a promotion within Pinterest."
  [ad_account_id string?, promotion_id string?]
  (let [res (:data (promotions-delete-with-http-info ad_account_id promotion_id))]
    (if (:decode-models *api-context*)
...
(defn-spec promotions-get promotion-response-spec
  "Get promotion by id
  Get a promotion by its Pinterest-specific id. It must be associated with the provided ad account id."
  [ad_account_id string?, promotion_id string?]
  (let [res (:data (promotions-get-with-http-info ad_account_id promotion_id))]
    (if (:decode-models *api-context*)
       (st/decode promotion-response-spec res st/string-transformer)
       res)))
...
(defn-spec promotions-update-with-http-info any?
  ...
  [ad_account_id string?, promotion-update-request (s/coll-of promotion-update-request-spec)]
  (check-required-params ad_account_id promotion-update-request)
  (call-api "/ad_accounts/{ad_account_id}/promotions" :patch
            {:path-params   {"ad_account_id" ad_account_id }
             :header-params {}
             :query-params  {}
             :form-params   {}
             :body-param    promotion-update-request
             :content-types ["application/json"]
             :accepts       ["application/json"]
             :auth-names    ["pinterest_oauth2"]}))
...
(defn-spec promotions-update promotions-response-spec
  ...
  Update multiple promotions."
  [ad_account_id string?, promotion-update-request (s/coll-of promotion-update-request-spec)]
  (let [res (:data (promotions-update-with-http-info ad_account_id promotion-update-request))]
    (if (:decode-models *api-context*)
       (st/decode promotions-response-spec res st/string-transformer)
       res)))
