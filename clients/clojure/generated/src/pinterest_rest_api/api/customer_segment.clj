(ns pinterest-rest-api.api.customer-segment
...
(defn-spec customer-segment-create-with-http-info any?
  ...
  [ad_account_id string?, customer-segment-create customer-segment-create]
  (check-required-params ad_account_id customer-segment-create)
  (call-api "/ad_accounts/{ad_account_id}/customer_segments" :post
            {:path-params   {"ad_account_id" ad_account_id }
             :header-params {}
             :query-params  {}
             :form-params   {}
             :body-param    customer-segment-create
             :content-types ["application/json"]
             :accepts       ["application/json"]
             :auth-names    ["pinterest_oauth2"]}))

(defn-spec customer-segment-create customer-segment-spec
  "Create customer segments
  Customer segments allow advertisers to define existing customers for Pinterest Performance+ campaigns. Customer segments are made up of audience lists."
  [ad_account_id string?, customer-segment-create customer-segment-create]
  (let [res (:data (customer-segment-create-with-http-info ad_account_id customer-segment-create))]
    (if (:decode-models *api-context*)
       (st/decode customer-segment-spec res st/string-transformer)
       res)))


(defn-spec customer-segment-list-with-http-info any?
  "List customer segments
  Get a list of the customer segments in the specified `ad_account_id`."
  ([ad_account_id string?, ] (customer-segment-list-with-http-info ad_account_id nil))
  ([ad_account_id string?, {:keys [bookmark page_size order include_sizing search_query]} (s/map-of keyword? any?)]
   ...
   (call-api "/ad_accounts/{ad_account_id}/customer_segments" :get
             {:path-params   {"ad_account_id" ad_account_id }
              :header-params {}
...
(defn-spec customer-segment-list customer-segment-list-200-response-spec
  "List customer segments
  Get a list of the customer segments in the specified `ad_account_id`."
  ([ad_account_id string?, ] (customer-segment-list ad_account_id nil))
  ([ad_account_id string?, optional-params any?]
   (let [res (:data (customer-segment-list-with-http-info ad_account_id optional-params))]
     (if (:decode-models *api-context*)
        (st/decode customer-segment-list-200-response-spec res st/string-transformer)
        res))))


(defn-spec customer-segment-update-with-http-info any?
  "Update customer segments
  Update the customer segment given advertiser ID and customer segment ID"
  [ad_account_id string?, customer-segment-update-request-update-with-required-body customer-segment-update-request-update-with-required-body]
  (check-required-params ad_account_id customer-segment-update-request-update-with-required-body)
  (call-api "/ad_accounts/{ad_account_id}/customer_segments" :patch
            {:path-params   {"ad_account_id" ad_account_id }
             :header-params {}
             :query-params  {}
             :form-params   {}
             :body-param    customer-segment-update-request-update-with-required-body
             :content-types ["application/json"]
             :accepts       ["application/json"]
             :auth-names    ["pinterest_oauth2"]}))

(defn-spec customer-segment-update any?
  "Update customer segments
  Update the customer segment given advertiser ID and customer segment ID"
  [ad_account_id string?, customer-segment-update-request-update-with-required-body customer-segment-update-request-update-with-required-body]
  (let [res (:data (customer-segment-update-with-http-info ad_account_id customer-segment-update-request-update-with-required-body))]
    (if (:decode-models *api-context*)
