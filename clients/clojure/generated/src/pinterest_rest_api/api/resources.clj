(ns pinterest-rest-api.api.resources
...
(defn-spec ad-account-countries-get-with-http-info any?
  "Get ad accounts countries
  Get Ad Accounts countries"
  []
  (call-api "/resources/ad_account_countries" :get
            {:path-params   {}
             :header-params {}
             :query-params  {}
             :form-params   {}
...
(defn-spec ad-account-countries-get ad-account-countries-get-200-response-spec
  "Get ad accounts countries
  Get Ad Accounts countries"
  []
  (let [res (:data (ad-account-countries-get-with-http-info))]
    (if (:decode-models *api-context*)
       (st/decode ad-account-countries-get-200-response-spec res st/string-transformer)
       res)))


(defn-spec delivery-metrics-get-with-http-info any?
...
See [Organic Analytics](/docs/api-features/analytics-overview/) and [Ads Analytics](/docs/api-features/ads-reporting/) for more information."
  ([] (delivery-metrics-get-with-http-info nil))
  ([{:keys [report_type]} (s/map-of keyword? any?)]
   (call-api "/resources/delivery_metrics" :get
             {:path-params   {}
              :header-params {}
...
(defn-spec delivery-metrics-get delivery-metrics-get-200-response-spec
  "Get available metrics' definitions
  Get the definitions for ads and organic metrics available across both synchronous and asynchronous report endpoints.
The `display_name` attribute will match how the metric is named in our native tools like Ads Manager.
See [Organic Analytics](/docs/api-features/analytics-overview/) and [Ads Analytics](/docs/api-features/ads-reporting/) for more information."
  ([] (delivery-metrics-get nil))
  ([optional-params any?]
   (let [res (:data (delivery-metrics-get-with-http-info optional-params))]
     (if (:decode-models *api-context*)
        (st/decode delivery-metrics-get-200-response-spec res st/string-transformer)
        res))))


(defn-spec interest-targeting-options-get-with-http-info any?
...
Click [here](https://docs.google.com/spreadsheets/d/1HxL-0Z3p2fgxis9YBP2HWC3tvPrs1hAuHDRtH-NJTIM/edit#gid=118370875) for a spreadsheet listing interests and their IDs."
  [interest_id string?]
  (check-required-params interest_id)
  (call-api "/resources/targeting/interests/{interest_id}" :get
            {:path-params   {"interest_id" interest_id }
             :header-params {}
             :query-params  {}
             :form-params   {}
             :content-types []
...
(defn-spec interest-targeting-options-get single-interest-targeting-option-spec
  "Get interest details
  Get details of a specific interest given interest ID.

Click [here](https://docs.google.com/spreadsheets/d/1HxL-0Z3p2fgxis9YBP2HWC3tvPrs1hAuHDRtH-NJTIM/edit#gid=118370875) for a spreadsheet listing interests and their IDs."
  [interest_id string?]
  (let [res (:data (interest-targeting-options-get-with-http-info interest_id))]
    (if (:decode-models *api-context*)
       (st/decode single-interest-targeting-option-spec res st/string-transformer)
       res)))


(defn-spec lead-form-questions-get-with-http-info any?
...
**This endpoint is currently in beta and not available to all apps. [Learn more](/docs/getting-started/using-beta-and-restricted-features/).**"
  []
  (call-api "/resources/lead_form_questions" :get
            {:path-params   {}
             :header-params {}
             :query-params  {}
             :form-params   {}
...
(defn-spec lead-form-questions-get any?
  "Get lead form questions
  Get a list of all lead form question type names. Some questions might not be used.

**This endpoint is currently in beta and not available to all apps. [Learn more](/docs/getting-started/using-beta-and-restricted-features/).**"
  []
  (let [res (:data (lead-form-questions-get-with-http-info))]
    (if (:decode-models *api-context*)
       (st/decode any? res st/string-transformer)
       res)))


(defn-spec metrics-ready-state-get-with-http-info any?
  "Get metrics ready state
  Learn whether conversion or non-conversion metrics are finalized and ready to query."
  [date string?]
  (check-required-params date)
  (call-api "/resources/metrics_ready_state" :get
            {:path-params   {}
             :header-params {}
...
(defn-spec metrics-ready-state-get book-closed-spec
  "Get metrics ready state
  Learn whether conversion or non-conversion metrics are finalized and ready to query."
  [date string?]
  (let [res (:data (metrics-ready-state-get-with-http-info date))]
    (if (:decode-models *api-context*)
       (st/decode book-closed-spec res st/string-transformer)
       res)))


(defn-spec targeting-options-get-with-http-info any?
  ...
  You can use targeting values in ads placement to define your intended audience.
    ...
    **Sample return:**
    ...
    ```"
  ([targeting_type public-targeting-type, ] (targeting-options-get-with-http-info targeting_type nil))
  ([targeting_type public-targeting-type, {:keys [ad_account_id client_id oauth_signature timestamp]} (s/map-of keyword? any?)]
   (check-required-params targeting_type)
   (call-api "/resources/targeting/{targeting_type}" :get
             {:path-params   {"targeting_type" targeting_type }
              :header-params {}
              :query-params  {"ad_account_id" ad_account_id "client_id" client_id "oauth_signature" oauth_signature "timestamp" timestamp }
              :form-params   {}
              :content-types []
              :accepts       ["application/json"]
              :auth-names    ["pinterest_oauth2" "client_credentials"]})))

(defn-spec targeting-options-get (s/coll-of any?)
  "Get targeting options
  You can use targeting values in ads placement to define your intended audience.
    ...
    **Sample return:**
    ...
    [{\"36313\": \"Australia: Moreton Bay - North\", \"124735\": \"Canada: North Battleford\", \"36109\": \"Australia: Murray\", \"36108\": \"Australia: Mid North Coast\", \"36101\": \"Australia: Capital Region\", \"811\": \"U.S.: Reno\", \"36103\": \"Australia: Central West\", \"36102\": \"Australia: Central Coast\", \"36105\": \"Australia: Far West and Orana\", \"36104\": \"Australia: Coffs Harbour - Grafton\", \"36107\": \"Australia: Illawarra\", \"36106\": \"Australia: Hunter Valley Exc Newcastle\", \"554017\": \"New Zealand: Wanganui\", \"554016\": \"New Zealand: Marlborough\", \"554015\": \"New Zealand: Gisborne\", \"554014\": \"New Zealand: Tararua\", \"554013\": \"New Zealand: Invercargill\", \"GR\": \"Greece\", \"554011\": \"New Zealand: Whangarei\", \"554010\": \"New Zealand: Far North\", \"717\": \"U.S.: Quincy-Hannibal-Keokuk\", \"716\": \"U.S.: Baton Rouge\",...}]
    ```"
  ([targeting_type public-targeting-type, ] (targeting-options-get targeting_type nil))
  ([targeting_type public-targeting-type, optional-params any?]
   (let [res (:data (targeting-options-get-with-http-info targeting_type optional-params))]
     (if (:decode-models *api-context*)
