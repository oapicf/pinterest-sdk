...
For more, see <a class=\"reference external\" href=\"https://help.pinterest.com/en/business/article/lead-ads\">Lead ads</a>."
  [ad_account_id string?, leads-export-create-request leads-export-create-request]
  (check-required-params ad_account_id leads-export-create-request)
  (call-api "/ad_accounts/{ad_account_id}/leads_export" :post
            {:path-params   {"ad_account_id" ad_account_id }
             :header-params {}
             :query-params  {}
             :form-params   {}
             :body-param    leads-export-create-request
             :content-types ["application/json"]
             :accepts       ["application/json"]
             :auth-names    ["pinterest_oauth2"]}))

(defn-spec leads-export-create leads-export-create-response-spec
  "Create a request to export leads collected from a lead ad
  <strong>This feature is currently in beta and not available to all apps, if you're interested in joining the beta, please reach out to your Pinterest account manager.</strong>
...
For more, see <a class=\"reference external\" href=\"https://help.pinterest.com/en/business/article/lead-ads\">Lead ads</a>."
  [ad_account_id string?, leads-export-create-request leads-export-create-request]
  (let [res (:data (leads-export-create-with-http-info ad_account_id leads-export-create-request))]
    (if (:decode-models *api-context*)
       (st/decode leads-export-create-response-spec res st/string-transformer)
       res)))
