(ns pinterest-rest-api.api.leads-export
...
(defn-spec leads-export-create-with-http-info any?
...
For more, see [Lead ads](https://help.pinterest.com/en/business/article/lead-ads)."
  [ad_account_id string?, leads-exports-create leads-exports-create]
  (check-required-params ad_account_id leads-exports-create)
  (call-api "/ad_accounts/{ad_account_id}/leads_export" :post
            {:path-params   {"ad_account_id" ad_account_id }
             :header-params {}
             :query-params  {}
             :form-params   {}
             :body-param    leads-exports-create
             :content-types ["application/json"]
             :accepts       ["application/json"]
             :auth-names    ["pinterest_oauth2"]}))

(defn-spec leads-export-create leads-exports-spec
  "Create a request to export leads collected from a lead ad
  **This feature is currently in beta and not available to all apps. If you're interested in joining the beta, please reach out to your Pinterest account manager.**
...
For more, see [Lead ads](https://help.pinterest.com/en/business/article/lead-ads)."
  [ad_account_id string?, leads-exports-create leads-exports-create]
  (let [res (:data (leads-export-create-with-http-info ad_account_id leads-exports-create))]
    (if (:decode-models *api-context*)
       (st/decode leads-exports-spec res st/string-transformer)
       res)))


(defn-spec leads-export-get-with-http-info any?
...
For more, see [Lead ads](https://help.pinterest.com/en/business/article/lead-ads)."
  [ad_account_id string?, leads_export_id string?]
  (check-required-params ad_account_id leads_export_id)
  (call-api "/ad_accounts/{ad_account_id}/leads_export/{leads_export_id}" :get
            {:path-params   {"ad_account_id" ad_account_id "leads_export_id" leads_export_id }
             :header-params {}
             :query-params  {}
             :form-params   {}
             :content-types []
...
(defn-spec leads-export-get leads-export-response-data-spec
  "Get the lead export from the lead export create call
  **This feature is currently in beta and not available to all apps. If you're interested in joining the beta, please reach out to your Pinterest account manager.**
...
For more, see [Lead ads](https://help.pinterest.com/en/business/article/lead-ads)."
  [ad_account_id string?, leads_export_id string?]
  (let [res (:data (leads-export-get-with-http-info ad_account_id leads_export_id))]
    (if (:decode-models *api-context*)
       (st/decode leads-export-response-data-spec res st/string-transformer)
       res)))
