(ns pinterest-rest-api.api.catalog-supplemental
...
(defn-spec catalogs-local-inventory-items-batch-operate-with-http-info any?
...
[Learn more](/docs/api-features/shopping-overview/)"
  ([catalog_id string?, local-inventory-items-batch-create local-inventory-items-batch-create, ] (catalogs-local-inventory-items-batch-operate-with-http-info catalog_id local-inventory-items-batch-create nil))
  ([catalog_id string?, local-inventory-items-batch-create local-inventory-items-batch-create, {:keys [ad_account_id]} (s/map-of keyword? any?)]
   (check-required-params catalog_id local-inventory-items-batch-create)
   (call-api "/catalogs/{catalog_id}/local_inventory_items/batch" :post
             {:path-params   {"catalog_id" catalog_id }
              :header-params {}
              :query-params  {"ad_account_id" ad_account_id }
              :form-params   {}
              :body-param    local-inventory-items-batch-create
              :content-types ["application/json"]
              :accepts       ["application/json"]
              :auth-names    ["pinterest_oauth2"]})))

(defn-spec catalogs-local-inventory-items-batch-operate supplemental-items-batch-response-spec
  "Operate on local inventory item batch
  Managing local inventory information in batches supporting CREATE, UPDATE, UPSERT, DELETE operations.
Up to 1000 items per request to match catalogs/items.
...
[Learn more](/docs/api-features/shopping-overview/)"
  ([catalog_id string?, local-inventory-items-batch-create local-inventory-items-batch-create, ] (catalogs-local-inventory-items-batch-operate catalog_id local-inventory-items-batch-create nil))
  ([catalog_id string?, local-inventory-items-batch-create local-inventory-items-batch-create, optional-params any?]
   (let [res (:data (catalogs-local-inventory-items-batch-operate-with-http-info catalog_id local-inventory-items-batch-create optional-params))]
     (if (:decode-models *api-context*)
        (st/decode supplemental-items-batch-response-spec res st/string-transformer)
        res))))


(defn-spec catalogs-local-inventory-items-post-with-http-info any?
...
[Learn more](/docs/api-features/shopping-overview/)"
  ([catalog_id string?, local-inventory-items-get-create local-inventory-items-get-create, ] (catalogs-local-inventory-items-post-with-http-info catalog_id local-inventory-items-get-create nil))
  ([catalog_id string?, local-inventory-items-get-create local-inventory-items-get-create, {:keys [ad_account_id]} (s/map-of keyword? any?)]
   (check-required-params catalog_id local-inventory-items-get-create)
   (call-api "/catalogs/{catalog_id}/local_inventory_items/query" :post
             {:path-params   {"catalog_id" catalog_id }
              :header-params {}
              :query-params  {"ad_account_id" ad_account_id }
              :form-params   {}
              :body-param    local-inventory-items-get-create
              :content-types ["application/json"]
              :accepts       ["application/json"]
              :auth-names    ["pinterest_oauth2"]})))

(defn-spec catalogs-local-inventory-items-post local-inventory-items-get-spec
  "Get local inventory items (POST)
  Get local inventory items for a catalog owned by the \"operation user_account\".
...
[Learn more](/docs/api-features/shopping-overview/)"
  ([catalog_id string?, local-inventory-items-get-create local-inventory-items-get-create, ] (catalogs-local-inventory-items-post catalog_id local-inventory-items-get-create nil))
  ([catalog_id string?, local-inventory-items-get-create local-inventory-items-get-create, optional-params any?]
   (let [res (:data (catalogs-local-inventory-items-post-with-http-info catalog_id local-inventory-items-get-create optional-params))]
     (if (:decode-models *api-context*)
        (st/decode local-inventory-items-get-spec res st/string-transformer)
        res))))


(defn-spec catalogs-local-stores-create-with-http-info any?
  "Create local stores
...
[Learn more](/docs/api-features/shopping-overview/)"
  ([catalog_id string?, local-store-create (s/coll-of local-store-create-spec), ] (catalogs-local-stores-create-with-http-info catalog_id local-store-create nil))
  ([catalog_id string?, local-store-create (s/coll-of local-store-create-spec), {:keys [ad_account_id]} (s/map-of keyword? any?)]
   (check-required-params catalog_id local-store-create)
   (call-api "/catalogs/{catalog_id}/local_stores" :post
             {:path-params   {"catalog_id" catalog_id }
              :header-params {}
              :query-params  {"ad_account_id" ad_account_id }
              :form-params   {}
              :body-param    local-store-create
              :content-types ["application/json"]
              :accepts       ["application/json"]
              :auth-names    ["pinterest_oauth2"]})))

(defn-spec catalogs-local-stores-create (s/coll-of catalogs-local-stores-create-200-response-inner-spec)
  "Create local stores
  Create a local store for a catalog owned by the \"operation user_account\".
- By default, the \"operation user_account\" is the token user_account.
- Supports optional filtering by store codes.
...
[Learn more](/docs/api-features/shopping-overview/)"
  ([catalog_id string?, local-store-create (s/coll-of local-store-create-spec), ] (catalogs-local-stores-create catalog_id local-store-create nil))
  ([catalog_id string?, local-store-create (s/coll-of local-store-create-spec), optional-params any?]
   (let [res (:data (catalogs-local-stores-create-with-http-info catalog_id local-store-create optional-params))]
     (if (:decode-models *api-context*)
        (st/decode (s/coll-of catalogs-local-stores-create-200-response-inner-spec) res st/string-transformer)
        res))))


(defn-spec catalogs-local-stores-delete-with-http-info any?
  "Delete local stores
  ...
  [Learn more](/docs/api-features/shopping-overview/)"
  ([catalog_id string?, ids (s/coll-of string?), ] (catalogs-local-stores-delete-with-http-info catalog_id ids nil))
  ([catalog_id string?, ids (s/coll-of string?), {:keys [ad_account_id]} (s/map-of keyword? any?)]
   (check-required-params catalog_id ids)
   (call-api "/catalogs/{catalog_id}/local_stores" :delete
             {:path-params   {"catalog_id" catalog_id }
              :header-params {}
              :query-params  {"ids" (with-collection-format ids :csv) "ad_account_id" ad_account_id }
              :form-params   {}
              :content-types []
              :accepts       ["application/json"]
              :auth-names    ["pinterest_oauth2"]})))

(defn-spec catalogs-local-stores-delete (s/coll-of catalogs-local-stores-delete-200-response-inner-spec)
  "Delete local stores
  Delete multiple local stores for a catalog owned by the \"operation user_account\".
  - By default, the \"operation user_account\" is the token user_account.
  - Supports optional filtering by store codes.
  ...
  [Learn more](/docs/api-features/shopping-overview/)"
  ([catalog_id string?, ids (s/coll-of string?), ] (catalogs-local-stores-delete catalog_id ids nil))
  ([catalog_id string?, ids (s/coll-of string?), optional-params any?]
   (let [res (:data (catalogs-local-stores-delete-with-http-info catalog_id ids optional-params))]
     (if (:decode-models *api-context*)
        (st/decode (s/coll-of catalogs-local-stores-delete-200-response-inner-spec) res st/string-transformer)
        res))))


(defn-spec catalogs-local-stores-list-with-http-info any?
  "List local stores
...
[Learn more](/docs/api-features/shopping-overview/)"
  ([catalog_id string?, ] (catalogs-local-stores-list-with-http-info catalog_id nil))
  ([catalog_id string?, {:keys [ids ad_account_id bookmark page_size]} (s/map-of keyword? any?)]
   (check-required-params catalog_id)
   (call-api "/catalogs/{catalog_id}/local_stores" :get
             {:path-params   {"catalog_id" catalog_id }
              :header-params {}
              :query-params  {"ids" (with-collection-format ids :csv) "ad_account_id" ad_account_id "bookmark" bookmark "page_size" page_size }
              :form-params   {}
              :content-types []
              :accepts       ["application/json"]
              :auth-names    ["pinterest_oauth2"]})))

(defn-spec catalogs-local-stores-list catalogs-local-stores-list-200-response-spec
  "List local stores
  Fetch local stores for a catalog owned by the \"operation user_account\".
- By default, the \"operation user_account\" is the token user_account.
- Supports optional filtering by store codes.
...
[Learn more](/docs/api-features/shopping-overview/)"
  ([catalog_id string?, ] (catalogs-local-stores-list catalog_id nil))
  ([catalog_id string?, optional-params any?]
   (let [res (:data (catalogs-local-stores-list-with-http-info catalog_id optional-params))]
     (if (:decode-models *api-context*)
        (st/decode catalogs-local-stores-list-200-response-spec res st/string-transformer)
        res))))


(defn-spec catalogs-local-stores-update-with-http-info any?
  "Update local stores
  ...
  [Learn more](/docs/api-features/shopping-overview/)"
  ([catalog_id string?, local-store-batch-update (s/coll-of local-store-batch-update-spec), ] (catalogs-local-stores-update-with-http-info catalog_id local-store-batch-update nil))
  ([catalog_id string?, local-store-batch-update (s/coll-of local-store-batch-update-spec), {:keys [ad_account_id]} (s/map-of keyword? any?)]
   (check-required-params catalog_id local-store-batch-update)
   (call-api "/catalogs/{catalog_id}/local_stores" :patch
             {:path-params   {"catalog_id" catalog_id }
              :header-params {}
              :query-params  {"ad_account_id" ad_account_id }
              :form-params   {}
              :body-param    local-store-batch-update
              :content-types ["application/json"]
              :accepts       ["application/json"]
              :auth-names    ["pinterest_oauth2"]})))

(defn-spec catalogs-local-stores-update (s/coll-of catalogs-local-stores-create-200-response-inner-spec)
  "Update local stores
  Update a local store for a catalog owned by the \"operation user_account\".
  - By default, the \"operation user_account\" is the token user_account.
  - Supports optional filtering by store codes.
  ...
  [Learn more](/docs/api-features/shopping-overview/)"
  ([catalog_id string?, local-store-batch-update (s/coll-of local-store-batch-update-spec), ] (catalogs-local-stores-update catalog_id local-store-batch-update nil))
  ([catalog_id string?, local-store-batch-update (s/coll-of local-store-batch-update-spec), optional-params any?]
   (let [res (:data (catalogs-local-stores-update-with-http-info catalog_id local-store-batch-update optional-params))]
     (if (:decode-models *api-context*)
        (st/decode (s/coll-of catalogs-local-stores-create-200-response-inner-spec) res st/string-transformer)
        res))))


(defn-spec catalogs-supplemental-items-batch-get-with-http-info any?
...
[Learn more](/docs/api-features/shopping-overview/)"
  ([catalog_id string?, batch_id string?, ] (catalogs-supplemental-items-batch-get-with-http-info catalog_id batch_id nil))
  ([catalog_id string?, batch_id string?, {:keys [ad_account_id]} (s/map-of keyword? any?)]
   (check-required-params catalog_id batch_id)
   (call-api "/catalogs/{catalog_id}/supplemental_items/batch/{batch_id}" :get
             {:path-params   {"catalog_id" catalog_id "batch_id" batch_id }
              :header-params {}
              :query-params  {"ad_account_id" ad_account_id }
              :form-params   {}
              :content-types []
...
(defn-spec catalogs-supplemental-items-batch-get supplemental-items-batch-response-spec
  "Get supplemental items batch status
  Fetch the status and results of a supplemental items batch operation.
- By default, the \"operation user_account\" is the token user_account.
...
[Learn more](/docs/api-features/shopping-overview/)"
  ([catalog_id string?, batch_id string?, ] (catalogs-supplemental-items-batch-get catalog_id batch_id nil))
  ([catalog_id string?, batch_id string?, optional-params any?]
   (let [res (:data (catalogs-supplemental-items-batch-get-with-http-info catalog_id batch_id optional-params))]
     (if (:decode-models *api-context*)
        (st/decode supplemental-items-batch-response-spec res st/string-transformer)
        res))))
