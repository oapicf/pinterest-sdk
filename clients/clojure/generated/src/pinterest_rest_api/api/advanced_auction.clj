(ns pinterest-rest-api.api.advanced-auction
...
(defn-spec advanced-auction-items-get-post-with-http-info any?
...
This endpoint is not available to all users."
  ([advanced-auction-items-get-request advanced-auction-items-get-request, ] (advanced-auction-items-get-post-with-http-info advanced-auction-items-get-request nil))
  ([advanced-auction-items-get-request advanced-auction-items-get-request, {:keys [ad_account_id]} (s/map-of keyword? any?)]
   (check-required-params advanced-auction-items-get-request)
   (call-api "/advanced_auction/items/get" :post
             {:path-params   {}
              :header-params {}
              :query-params  {"ad_account_id" ad_account_id }
              :form-params   {}
              :body-param    advanced-auction-items-get-request
              :content-types ["application/json"]
              :accepts       ["application/json"]
              :auth-names    ["pinterest_oauth2"]})))

(defn-spec advanced-auction-items-get-post advanced-auction-items-spec
  "Get item bid options (POST)
  Get the bid options for a batch of retail catalog items.
...
This endpoint is not available to all users."
  ([advanced-auction-items-get-request advanced-auction-items-get-request, ] (advanced-auction-items-get-post advanced-auction-items-get-request nil))
  ([advanced-auction-items-get-request advanced-auction-items-get-request, optional-params any?]
   (let [res (:data (advanced-auction-items-get-post-with-http-info advanced-auction-items-get-request optional-params))]
     (if (:decode-models *api-context*)
        (st/decode advanced-auction-items-spec res st/string-transformer)
        res))))


(defn-spec advanced-auction-items-submit-post-with-http-info any?
...
This endpoint is not available to all users."
  ([advanced-auction-items-submit-request advanced-auction-items-submit-request, ] (advanced-auction-items-submit-post-with-http-info advanced-auction-items-submit-request nil))
  ([advanced-auction-items-submit-request advanced-auction-items-submit-request, {:keys [ad_account_id]} (s/map-of keyword? any?)]
   (check-required-params advanced-auction-items-submit-request)
   (call-api "/advanced_auction/items/submit" :post
             {:path-params   {}
              :header-params {}
              :query-params  {"ad_account_id" ad_account_id }
              :form-params   {}
              :body-param    advanced-auction-items-submit-request
              :content-types ["application/json"]
              :accepts       ["application/json"]
              :auth-names    ["pinterest_oauth2"]})))

(defn-spec advanced-auction-items-submit-post advanced-auction-processed-items-spec
  "Operate on item level bid options
  This endpoint supports multiple operations on a set of one or more bid options (bid price and bid adjustments for targeting categories) for retail catalog items. These advanced auction settings are applied in campaigns using objective_type `CATALOG_SALES` and ad groups using bid_strategy_type `MAX_BID`.
...
This endpoint is not available to all users."
  ([advanced-auction-items-submit-request advanced-auction-items-submit-request, ] (advanced-auction-items-submit-post advanced-auction-items-submit-request nil))
  ([advanced-auction-items-submit-request advanced-auction-items-submit-request, optional-params any?]
   (let [res (:data (advanced-auction-items-submit-post-with-http-info advanced-auction-items-submit-request optional-params))]
     (if (:decode-models *api-context*)
        (st/decode advanced-auction-processed-items-spec res st/string-transformer)
        res))))
