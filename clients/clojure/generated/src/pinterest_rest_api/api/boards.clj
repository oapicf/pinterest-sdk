...
- By default, the \"operation user_account\" is the token user_account."
  ([board_id string?, board-section-create board-section-create, ] (board-sections-create-with-http-info board_id board-section-create nil))
  ([board_id string?, board-section-create board-section-create, {:keys [ad_account_id]} (s/map-of keyword? any?)]
   (check-required-params board_id board-section-create)
   (call-api "/boards/{board_id}/sections" :post
             {:path-params   {"board_id" board_id }
              :header-params {}
              :query-params  {"ad_account_id" ad_account_id }
              :form-params   {}
              :body-param    board-section-create
...
Optional: Business Access: Specify an ad_account_id to use the owner of that ad_account as the \"operation user_account\".
- By default, the \"operation user_account\" is the token user_account."
  ([board_id string?, board-section-create board-section-create, ] (board-sections-create board_id board-section-create nil))
  ([board_id string?, board-section-create board-section-create, optional-params any?]
   (let [res (:data (board-sections-create-with-http-info board_id board-section-create optional-params))]
...
(defn-spec board-sections-delete board-section-spec
  "Delete board section
  Delete a board section on a board owned by the \"operation user_account\" - or on a group board that has been shared with this account.
Optional: Business Access: Specify an ad_account_id to use the owner of that ad_account as the \"operation user_account\".
- By default, the \"operation user_account\" is the token user_account."
...
Optional: Business Access: Specify an ad_account_id to use the owner of that ad_account as the \"operation user_account\".
- By default, the \"operation user_account\" is the token user_account."
  ([board_id string?, section_id string?, board-section-update-with-required-body board-section-update-with-required-body, ] (board-sections-update-with-http-info board_id section_id board-section-update-with-required-body nil))
  ([board_id string?, section_id string?, board-section-update-with-required-body board-section-update-with-required-body, {:keys [ad_account_id]} (s/map-of keyword? any?)]
   (check-required-params board_id section_id board-section-update-with-required-body)
   (call-api "/boards/{board_id}/sections/{section_id}" :patch
             {:path-params   {"board_id" board_id "section_id" section_id }
              :header-params {}
              :query-params  {"ad_account_id" ad_account_id }
              :form-params   {}
              :body-param    board-section-update-with-required-body
              :content-types ["application/json"]
              :accepts       ["application/json"]
              :auth-names    ["pinterest_oauth2"]})))
...
Optional: Business Access: Specify an ad_account_id to use the owner of that ad_account as the \"operation user_account\".
- By default, the \"operation user_account\" is the token user_account."
  ([board_id string?, section_id string?, board-section-update-with-required-body board-section-update-with-required-body, ] (board-sections-update board_id section_id board-section-update-with-required-body nil))
  ([board_id string?, section_id string?, board-section-update-with-required-body board-section-update-with-required-body, optional-params any?]
   (let [res (:data (board-sections-update-with-http-info board_id section_id board-section-update-with-required-body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode board-section-spec res st/string-transformer)
        res))))
...
(defn-spec boards-delete board-spec
  "Delete board
  Delete a board owned by the \"operation user_account\".
* Optional: Business Access: Specify an ad_account_id to use the owner of that ad_account as the \"operation user_account\".
* By default, the \"operation user_account\" is the token user_account."
...
- By default, the \"operation user_account\" is the token user_account."
  ...
  ([board_id string?, {:keys [creative_types ad_account_id pin_metrics bookmark page_size]} (s/map-of keyword? any?)]
   (check-required-params board_id)
   (call-api "/boards/{board_id}/pins" :get
             {:path-params   {"board_id" board_id }
              :header-params {}
              :query-params  {"creative_types" (with-collection-format creative_types :multi) "ad_account_id" ad_account_id "pin_metrics" pin_metrics "bookmark" bookmark "page_size" page_size }
              :form-params   {}
              :content-types []
              :accepts       ["application/json"]
              :auth-names    ["pinterest_oauth2" "client_credentials"]})))
