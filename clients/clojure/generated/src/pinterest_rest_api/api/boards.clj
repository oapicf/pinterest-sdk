(ns pinterest-rest-api.api.boards
...
(defn-spec board-sections-create-with-http-info any?
...
- By default, the \"operation user_account\" is the token user_account."
  ([board_id string?, board-section board-section, ] (board-sections-create-with-http-info board_id board-section nil))
  ([board_id string?, board-section board-section, {:keys [ad_account_id]} (s/map-of keyword? any?)]
   (check-required-params board_id board-section)
   (call-api "/boards/{board_id}/sections" :post
             {:path-params   {"board_id" board_id }
              :header-params {}
              :query-params  {"ad_account_id" ad_account_id }
              :form-params   {}
              :body-param    board-section
              :content-types ["application/json"]
              :accepts       ["application/json"]
              :auth-names    ["pinterest_oauth2"]})))

(defn-spec board-sections-create board-section-spec
  "Create board section
  Create a board section on a board owned by the \"operation user_account\" - or on a group board that has been shared with this account.
Optional: Business Access: Specify an ad_account_id to use the owner of that ad_account as the \"operation user_account\".
- By default, the \"operation user_account\" is the token user_account."
  ([board_id string?, board-section board-section, ] (board-sections-create board_id board-section nil))
  ([board_id string?, board-section board-section, optional-params any?]
   (let [res (:data (board-sections-create-with-http-info board_id board-section optional-params))]
     (if (:decode-models *api-context*)
        (st/decode board-section-spec res st/string-transformer)
        res))))


(defn-spec board-sections-delete-with-http-info any?
...
Optional: Business Access: Specify an ad_account_id to use the owner of that ad_account as the \"operation user_account\".
- By default, the \"operation user_account\" is the token user_account."
  ([board_id string?, section_id string?, ] (board-sections-delete-with-http-info board_id section_id nil))
  ([board_id string?, section_id string?, {:keys [ad_account_id]} (s/map-of keyword? any?)]
   (check-required-params board_id section_id)
   (call-api "/boards/{board_id}/sections/{section_id}" :delete
             {:path-params   {"board_id" board_id "section_id" section_id }
              :header-params {}
              :query-params  {"ad_account_id" ad_account_id }
              :form-params   {}
              :content-types []
...
(defn-spec board-sections-delete any?
  "Delete board section
  Delete a board section on a board owned by the \"operation user_account\" - or on a group board that has been shared with this account.
Optional: Business Access: Specify an ad_account_id to use the owner of that ad_account as the \"operation user_account\".
- By default, the \"operation user_account\" is the token user_account."
  ([board_id string?, section_id string?, ] (board-sections-delete board_id section_id nil))
  ([board_id string?, section_id string?, optional-params any?]
   (let [res (:data (board-sections-delete-with-http-info board_id section_id optional-params))]
     (if (:decode-models *api-context*)
        (st/decode any? res st/string-transformer)
        res))))


(defn-spec board-sections-list-with-http-info any?
  "List board sections
...
Optional: Business Access: Specify an ad_account_id to use the owner of that ad_account as the \"operation user_account\".
- By default, the \"operation user_account\" is the token user_account."
  ([board_id string?, ] (board-sections-list-with-http-info board_id nil))
  ([board_id string?, {:keys [ad_account_id bookmark page_size]} (s/map-of keyword? any?)]
   (check-required-params board_id)
   (call-api "/boards/{board_id}/sections" :get
             {:path-params   {"board_id" board_id }
              :header-params {}
              :query-params  {"ad_account_id" ad_account_id "bookmark" bookmark "page_size" page_size }
              :form-params   {}
              :content-types []
              :accepts       ["application/json"]
              :auth-names    ["pinterest_oauth2" "client_credentials"]})))

(defn-spec board-sections-list board-sections-list-200-response-spec
  "List board sections
  Get a list of all board sections from a board owned by the \"operation user_account\" - or a group board that has been shared with this account.
Optional: Business Access: Specify an ad_account_id to use the owner of that ad_account as the \"operation user_account\".
- By default, the \"operation user_account\" is the token user_account."
  ([board_id string?, ] (board-sections-list board_id nil))
  ([board_id string?, optional-params any?]
   (let [res (:data (board-sections-list-with-http-info board_id optional-params))]
     (if (:decode-models *api-context*)
        (st/decode board-sections-list-200-response-spec res st/string-transformer)
        res))))


(defn-spec board-sections-list-pins-with-http-info any?
...
Optional: Business Access: Specify an ad_account_id to use the owner of that ad_account as the \"operation user_account\".
- By default, the \"operation user_account\" is the token user_account."
  ([board_id string?, section_id string?, ] (board-sections-list-pins-with-http-info board_id section_id nil))
  ([board_id string?, section_id string?, {:keys [ad_account_id bookmark page_size]} (s/map-of keyword? any?)]
   (check-required-params board_id section_id)
   (call-api "/boards/{board_id}/sections/{section_id}/pins" :get
             {:path-params   {"board_id" board_id "section_id" section_id }
              :header-params {}
              :query-params  {"ad_account_id" ad_account_id "bookmark" bookmark "page_size" page_size }
              :form-params   {}
...
(defn-spec board-sections-list-pins boards-list-pins-200-response-spec
  "List Pins on board section
  Get a list of the Pins on a board section of a board owned by the \"operation user_account\" - or on a group board that has been shared with this account.
Optional: Business Access: Specify an ad_account_id to use the owner of that ad_account as the \"operation user_account\".
- By default, the \"operation user_account\" is the token user_account."
  ([board_id string?, section_id string?, ] (board-sections-list-pins board_id section_id nil))
  ([board_id string?, section_id string?, optional-params any?]
   (let [res (:data (board-sections-list-pins-with-http-info board_id section_id optional-params))]
     (if (:decode-models *api-context*)
        (st/decode boards-list-pins-200-response-spec res st/string-transformer)
        res))))


(defn-spec board-sections-update-with-http-info any?
...
Optional: Business Access: Specify an ad_account_id to use the owner of that ad_account as the \"operation user_account\".
- By default, the \"operation user_account\" is the token user_account."
  ([board_id string?, section_id string?, board-section board-section, ] (board-sections-update-with-http-info board_id section_id board-section nil))
  ([board_id string?, section_id string?, board-section board-section, {:keys [ad_account_id]} (s/map-of keyword? any?)]
   (check-required-params board_id section_id board-section)
   (call-api "/boards/{board_id}/sections/{section_id}" :patch
             {:path-params   {"board_id" board_id "section_id" section_id }
              :header-params {}
              :query-params  {"ad_account_id" ad_account_id }
              :form-params   {}
...
(defn-spec board-sections-update board-section-spec
  "Update board section
  Update a board section on a board owned by the \"operation user_account\" - or on a group board that has been shared with this account.
Optional: Business Access: Specify an ad_account_id to use the owner of that ad_account as the \"operation user_account\".
- By default, the \"operation user_account\" is the token user_account."
  ([board_id string?, section_id string?, board-section board-section, ] (board-sections-update board_id section_id board-section nil))
  ([board_id string?, section_id string?, board-section board-section, optional-params any?]
   (let [res (:data (board-sections-update-with-http-info board_id section_id board-section optional-params))]
     (if (:decode-models *api-context*)
        (st/decode board-section-spec res st/string-transformer)
        res))))


(defn-spec boards-create-with-http-info any?
  "Create board
  Create a board owned by the \"operation user_account\".
Optional: Business Access: Specify an ad_account_id to use the owner of that ad_account as the \"operation user_account\".
* By default, the \"operation user_account\" is the token user_account."
  ([board-create board-create, ] (boards-create-with-http-info board-create nil))
  ([board-create board-create, {:keys [ad_account_id]} (s/map-of keyword? any?)]
   (check-required-params board-create)
   (call-api "/boards" :post
             {:path-params   {}
              :header-params {}
              :query-params  {"ad_account_id" ad_account_id }
              :form-params   {}
              :body-param    board-create
              :content-types ["application/json"]
              :accepts       ["application/json"]
              :auth-names    ["pinterest_oauth2" "client_credentials"]})))

(defn-spec boards-create board-spec
  "Create board
  Create a board owned by the \"operation user_account\".
Optional: Business Access: Specify an ad_account_id to use the owner of that ad_account as the \"operation user_account\".
* By default, the \"operation user_account\" is the token user_account."
  ([board-create board-create, ] (boards-create board-create nil))
  ([board-create board-create, optional-params any?]
   (let [res (:data (boards-create-with-http-info board-create optional-params))]
     (if (:decode-models *api-context*)
        (st/decode board-spec res st/string-transformer)
        res))))


(defn-spec boards-delete-with-http-info any?
  "Delete board
  Delete a board owned by the \"operation user_account\".
* Optional: Business Access: Specify an ad_account_id to use the owner of that ad_account as the \"operation user_account\".
* By default, the \"operation user_account\" is the token user_account."
  ([board_id string?, ] (boards-delete-with-http-info board_id nil))
  ([board_id string?, {:keys [ad_account_id]} (s/map-of keyword? any?)]
   (check-required-params board_id)
   (call-api "/boards/{board_id}" :delete
             {:path-params   {"board_id" board_id }
              :header-params {}
              :query-params  {"ad_account_id" ad_account_id }
              :form-params   {}
...
(defn-spec boards-delete any?
  "Delete board
  Delete a board owned by the \"operation user_account\".
* Optional: Business Access: Specify an ad_account_id to use the owner of that ad_account as the \"operation user_account\".
* By default, the \"operation user_account\" is the token user_account."
  ([board_id string?, ] (boards-delete board_id nil))
  ([board_id string?, optional-params any?]
   (let [res (:data (boards-delete-with-http-info board_id optional-params))]
     (if (:decode-models *api-context*)
        (st/decode any? res st/string-transformer)
        res))))


(defn-spec boards-get-with-http-info any?
  "Get board
  Get a board owned by the operation user_account - or a group board that has been shared with this account.
* Optional: Business Access: Specify an ad_account_id to use the owner of that ad_account as the \"operation user_account\".
* By default, the \"operation user_account\" is the token user_account."
  ([board_id string?, ] (boards-get-with-http-info board_id nil))
  ([board_id string?, {:keys [ad_account_id]} (s/map-of keyword? any?)]
   (check-required-params board_id)
   (call-api "/boards/{board_id}" :get
             {:path-params   {"board_id" board_id }
              :header-params {}
              :query-params  {"ad_account_id" ad_account_id }
              :form-params   {}
...
(defn-spec boards-get board-spec
  "Get board
  Get a board owned by the operation user_account - or a group board that has been shared with this account.
* Optional: Business Access: Specify an ad_account_id to use the owner of that ad_account as the \"operation user_account\".
* By default, the \"operation user_account\" is the token user_account."
  ([board_id string?, ] (boards-get board_id nil))
  ([board_id string?, optional-params any?]
   (let [res (:data (boards-get-with-http-info board_id optional-params))]
     (if (:decode-models *api-context*)
        (st/decode board-spec res st/string-transformer)
        res))))


(defn-spec boards-list-with-http-info any?
  "List boards
...
* If no privacy is specified, all boards that can be returned (based on the scopes of the token and ad_account role if applicable) will be returned."
  ([] (boards-list-with-http-info nil))
  ([{:keys [ad_account_id privacy bookmark page_size]} (s/map-of keyword? any?)]
   (call-api "/boards" :get
             {:path-params   {}
              :header-params {}
              :query-params  {"ad_account_id" ad_account_id "privacy" privacy "bookmark" bookmark "page_size" page_size }
              :form-params   {}
              :content-types []
              :accepts       ["application/json"]
              :auth-names    ["pinterest_oauth2" "client_credentials"]})))

(defn-spec boards-list boards-list-200-response-spec
  "List boards
  Get a list of the boards owned by the \"operation user_account\" + group boards where this account is a collaborator
Optional: Business Access: Specify an ad_account_id to use the owner of that ad_account as the \"operation user_account\".
Optional: Specify a privacy type (public, protected, or secret) to indicate which boards to return.
* If no privacy is specified, all boards that can be returned (based on the scopes of the token and ad_account role if applicable) will be returned."
  ([] (boards-list nil))
  ([optional-params any?]
   (let [res (:data (boards-list-with-http-info optional-params))]
     (if (:decode-models *api-context*)
        (st/decode boards-list-200-response-spec res st/string-transformer)
        res))))


(defn-spec boards-list-pins-with-http-info any?
  "List Pins on board
...
- Optional: Business Access: Specify an ad_account_id to use the owner of that ad_account as the \"operation user_account\".
- By default, the \"operation user_account\" is the token user_account."
  ([board_id string?, ] (boards-list-pins-with-http-info board_id nil))
  ([board_id string?, {:keys [bookmark page_size creative_types ad_account_id pin_metrics]} (s/map-of keyword? any?)]
   (check-required-params board_id)
   (call-api "/boards/{board_id}/pins" :get
             {:path-params   {"board_id" board_id }
              :header-params {}
              :query-params  {"bookmark" bookmark "page_size" page_size "creative_types" (with-collection-format creative_types :multi) "ad_account_id" ad_account_id "pin_metrics" pin_metrics }
              :form-params   {}
              :content-types []
              :accepts       ["application/json"]
              :auth-names    ["pinterest_oauth2" "client_credentials"]})))

(defn-spec boards-list-pins boards-list-pins-200-response-spec
  "List Pins on board
  Get a list of the Pins on a board owned by the \"operation user_account\" - or on a group board that has been shared with this account.
- Optional: Business Access: Specify an ad_account_id to use the owner of that ad_account as the \"operation user_account\".
- By default, the \"operation user_account\" is the token user_account."
  ([board_id string?, ] (boards-list-pins board_id nil))
  ([board_id string?, optional-params any?]
   (let [res (:data (boards-list-pins-with-http-info board_id optional-params))]
     (if (:decode-models *api-context*)
        (st/decode boards-list-pins-200-response-spec res st/string-transformer)
        res))))


(defn-spec boards-update-with-http-info any?
  "Update board
  Update a board owned by the \"operating user_account\".
* Optional: Business Access: Specify an ad_account_id to use the owner of that ad_account as the \"operation user_account\".
* By default, the \"operation user_account\" is the token user_account."
  ([board_id string?, board-with-update-privacy-update board-with-update-privacy-update, ] (boards-update-with-http-info board_id board-with-update-privacy-update nil))
  ([board_id string?, board-with-update-privacy-update board-with-update-privacy-update, {:keys [ad_account_id]} (s/map-of keyword? any?)]
   (check-required-params board_id board-with-update-privacy-update)
   (call-api "/boards/{board_id}" :patch
             {:path-params   {"board_id" board_id }
              :header-params {}
              :query-params  {"ad_account_id" ad_account_id }
              :form-params   {}
              :body-param    board-with-update-privacy-update
              :content-types ["application/json"]
              :accepts       ["application/json"]
              :auth-names    ["pinterest_oauth2" "client_credentials"]})))

(defn-spec boards-update board-with-update-privacy-spec
  "Update board
  Update a board owned by the \"operating user_account\".
* Optional: Business Access: Specify an ad_account_id to use the owner of that ad_account as the \"operation user_account\".
* By default, the \"operation user_account\" is the token user_account."
  ([board_id string?, board-with-update-privacy-update board-with-update-privacy-update, ] (boards-update board_id board-with-update-privacy-update nil))
  ([board_id string?, board-with-update-privacy-update board-with-update-privacy-update, optional-params any?]
   (let [res (:data (boards-update-with-http-info board_id board-with-update-privacy-update optional-params))]
     (if (:decode-models *api-context*)
        (st/decode board-with-update-privacy-spec res st/string-transformer)
        res))))
