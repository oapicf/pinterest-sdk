(ns pinterest-rest-api.api.catalog-reports
...
Optional: Business Access: Specify an `ad_account_id` (obtained via [List ad accounts](/docs/api/v5/#operation/ad_accounts/list)) to use the owner of that ad_account as the \"operation user_account\". In order to do this, the token user_account must have one of the following [Business Access](https://help.pinterest.com/en/business/article/share-and-manage-access-to-your-ad-accounts) roles on the ad_account: Owner, Admin, Catalogs Manager."
  ([parameters catalogs-report-stats-parameters, ] (reports-stats-with-http-info parameters nil))
  ([parameters catalogs-report-stats-parameters, {:keys [ad_account_id bookmark page_size]} (s/map-of keyword? any?)]
   (check-required-params parameters)
   (call-api "/catalogs/reports/stats" :get
             {:path-params   {}
              :header-params {}
              :query-params  {"ad_account_id" ad_account_id "parameters" parameters "bookmark" bookmark "page_size" page_size }
              :form-params   {}
              :content-types []
              :accepts       ["application/json"]
              :auth-names    ["pinterest_oauth2"]})))
...
Optional: Business Access: Specify an `ad_account_id` (obtained via [List ad accounts](/docs/api/v5/#operation/ad_accounts/list)) to use the owner of that ad_account as the \"operation user_account\". In order to do this, the token user_account must have one of the following [Business Access](https://help.pinterest.com/en/business/article/share-and-manage-access-to-your-ad-accounts) roles on the ad_account: Owner, Admin, Catalogs Manager."
  ([parameters catalogs-report-stats-parameters, ] (reports-stats parameters nil))
  ([parameters catalogs-report-stats-parameters, optional-params any?]
