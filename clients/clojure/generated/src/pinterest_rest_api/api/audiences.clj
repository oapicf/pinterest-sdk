(ns pinterest-rest-api.api.audiences
...
(defn-spec audiences-create-with-http-info any?
  "Create audience
  Create a new audience for the ad account."
  [ad_account_id string?, ad-accounts-audience-create ad-accounts-audience-create]
  (check-required-params ad_account_id ad-accounts-audience-create)
  (call-api "/ad_accounts/{ad_account_id}/audiences" :post
            {:path-params   {"ad_account_id" ad_account_id }
             :header-params {}
             :query-params  {}
             :form-params   {}
             :body-param    ad-accounts-audience-create
             :content-types ["application/json"]
             :accepts       ["application/json"]
             :auth-names    ["pinterest_oauth2"]}))

(defn-spec audiences-create ad-accounts-audience-spec
  "Create audience
  Create a new audience for the ad account."
  [ad_account_id string?, ad-accounts-audience-create ad-accounts-audience-create]
  (let [res (:data (audiences-create-with-http-info ad_account_id ad-accounts-audience-create))]
    (if (:decode-models *api-context*)
       (st/decode ad-accounts-audience-spec res st/string-transformer)
       res)))


(defn-spec audiences-get-with-http-info any?
  "Get audience
  Get a specific audience given the audience ID."
  [audience_id string?, ad_account_id string?]
  (check-required-params audience_id ad_account_id)
  (call-api "/ad_accounts/{ad_account_id}/audiences/{audience_id}" :get
            {:path-params   {"audience_id" audience_id "ad_account_id" ad_account_id }
             :header-params {}
             :query-params  {}
             :form-params   {}
             :content-types []
...
(defn-spec audiences-get ad-accounts-audience-spec
  "Get audience
  Get a specific audience given the audience ID."
  [audience_id string?, ad_account_id string?]
  (let [res (:data (audiences-get-with-http-info audience_id ad_account_id))]
    (if (:decode-models *api-context*)
       (st/decode ad-accounts-audience-spec res st/string-transformer)
       res)))


(defn-spec audiences-list-with-http-info any?
  "List audiences
  Get list of audiences for the ad account."
  ([ad_account_id string?, ] (audiences-list-with-http-info ad_account_id nil))
  ([ad_account_id string?, {:keys [bookmark page_size order ownership_type exclude_nca]} (s/map-of keyword? any?)]
   (check-required-params ad_account_id)
   (call-api "/ad_accounts/{ad_account_id}/audiences" :get
             {:path-params   {"ad_account_id" ad_account_id }
              :header-params {}
              :query-params  {"bookmark" bookmark "page_size" page_size "order" order "ownership_type" ownership_type "exclude_nca" exclude_nca }
              :form-params   {}
              :content-types []
              :accepts       ["application/json"]
              :auth-names    ["pinterest_oauth2" "client_credentials"]})))

(defn-spec audiences-list audiences-list-200-response-spec
  "List audiences
  Get list of audiences for the ad account."
  ([ad_account_id string?, ] (audiences-list ad_account_id nil))
  ([ad_account_id string?, optional-params any?]
   (let [res (:data (audiences-list-with-http-info ad_account_id optional-params))]
     (if (:decode-models *api-context*)
        (st/decode audiences-list-200-response-spec res st/string-transformer)
        res))))


(defn-spec audiences-update-with-http-info any?
  "Update audience
  Update an existing audience for the ad account."
  [audience_id string?, ad_account_id string?, ad-accounts-audience-update ad-accounts-audience-update]
  (check-required-params audience_id ad_account_id ad-accounts-audience-update)
  (call-api "/ad_accounts/{ad_account_id}/audiences/{audience_id}" :patch
            {:path-params   {"audience_id" audience_id "ad_account_id" ad_account_id }
             :header-params {}
             :query-params  {}
             :form-params   {}
             :body-param    ad-accounts-audience-update
             :content-types ["application/json"]
             :accepts       ["application/json"]
             :auth-names    ["pinterest_oauth2"]}))

(defn-spec audiences-update ad-accounts-audience-spec
  "Update audience
  Update an existing audience for the ad account."
  [audience_id string?, ad_account_id string?, ad-accounts-audience-update ad-accounts-audience-update]
  (let [res (:data (audiences-update-with-http-info audience_id ad_account_id ad-accounts-audience-update))]
    (if (:decode-models *api-context*)
       (st/decode ad-accounts-audience-spec res st/string-transformer)
       res)))
