(ns pinterest-rest-api.api.conversions
...
(defn-spec advertiser-defined-events-create-with-http-info any?
  "Create advertiser defined events
  Map advertiser defined events to standard events for the given ad account."
  [ad_account_id string?, advertiser-defined-events-create-request advertiser-defined-events-create-request]
  (check-required-params ad_account_id advertiser-defined-events-create-request)
  (call-api "/ad_accounts/{ad_account_id}/advertiser_defined_events" :post
            {:path-params   {"ad_account_id" ad_account_id }
             :header-params {}
             :query-params  {}
             :form-params   {}
             :body-param    advertiser-defined-events-create-request
             :content-types ["application/json"]
             :accepts       ["application/json"]
             :auth-names    ["pinterest_oauth2" "client_credentials"]}))

(defn-spec advertiser-defined-events-create advertiser-defined-events-create-200-response-spec
  "Create advertiser defined events
  Map advertiser defined events to standard events for the given ad account."
  [ad_account_id string?, advertiser-defined-events-create-request advertiser-defined-events-create-request]
  (let [res (:data (advertiser-defined-events-create-with-http-info ad_account_id advertiser-defined-events-create-request))]
    (if (:decode-models *api-context*)
       (st/decode advertiser-defined-events-create-200-response-spec res st/string-transformer)
       res)))


(defn-spec advertiser-defined-events-delete-with-http-info any?
  "Delete advertiser defined events
  Untrack advertiser defined events for the given ad account."
  [ad_account_id string?, event_names (s/coll-of string?)]
  (check-required-params ad_account_id event_names)
  (call-api "/ad_accounts/{ad_account_id}/advertiser_defined_events" :delete
            {:path-params   {"ad_account_id" ad_account_id }
             :header-params {}
             :query-params  {"event_names" (with-collection-format event_names :csv) }
             :form-params   {}
             :content-types []
             :accepts       ["application/json"]
             :auth-names    ["pinterest_oauth2" "client_credentials"]}))

(defn-spec advertiser-defined-events-delete advertiser-defined-events-create-200-response-spec
  "Delete advertiser defined events
  Untrack advertiser defined events for the given ad account."
  [ad_account_id string?, event_names (s/coll-of string?)]
  (let [res (:data (advertiser-defined-events-delete-with-http-info ad_account_id event_names))]
    (if (:decode-models *api-context*)
       (st/decode advertiser-defined-events-create-200-response-spec res st/string-transformer)
       res)))


(defn-spec advertiser-defined-events-get-with-http-info any?
  "Get advertiser defined events
  Get advertiser defined events for the given ad account."
  [ad_account_id string?]
  (check-required-params ad_account_id)
  (call-api "/ad_accounts/{ad_account_id}/advertiser_defined_events" :get
            {:path-params   {"ad_account_id" ad_account_id }
             :header-params {}
             :query-params  {}
             :form-params   {}
...
(defn-spec advertiser-defined-events-get advertiser-defined-events-get-200-response-spec
  "Get advertiser defined events
  Get advertiser defined events for the given ad account."
  [ad_account_id string?]
  (let [res (:data (advertiser-defined-events-get-with-http-info ad_account_id))]
    (if (:decode-models *api-context*)
       (st/decode advertiser-defined-events-get-200-response-spec res st/string-transformer)
       res)))


(defn-spec advertiser-defined-events-update-with-http-info any?
  "Update advertiser defined events
  Update advertiser defined event names or mappings for the given ad account."
  [ad_account_id string?, advertiser-defined-events-create-request advertiser-defined-events-create-request]
  (check-required-params ad_account_id advertiser-defined-events-create-request)
  (call-api "/ad_accounts/{ad_account_id}/advertiser_defined_events" :patch
            {:path-params   {"ad_account_id" ad_account_id }
             :header-params {}
             :query-params  {}
             :form-params   {}
...
(defn-spec advertiser-defined-events-update advertiser-defined-events-create-200-response-spec
  "Update advertiser defined events
  Update advertiser defined event names or mappings for the given ad account."
  [ad_account_id string?, advertiser-defined-events-create-request advertiser-defined-events-create-request]
  (let [res (:data (advertiser-defined-events-update-with-http-info ad_account_id advertiser-defined-events-create-request))]
    (if (:decode-models *api-context*)
       (st/decode advertiser-defined-events-create-200-response-spec res st/string-transformer)
       res)))
