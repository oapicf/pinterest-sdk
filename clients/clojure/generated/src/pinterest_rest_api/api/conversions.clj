...
(defn-spec advertiser-defined-events-get advertiser-defined-events-response-spec
  "Get advertiser defined events
  <p>Get advertiser defined events for the given ad account.</p>"
  [ad_account_id string?]
  (let [res (:data (advertiser-defined-events-get-with-http-info ad_account_id))]
    (if (:decode-models *api-context*)
       (st/decode advertiser-defined-events-response-spec res st/string-transformer)
       res)))
