(ns pinterest-rest-api.api.catalog-product-groups
...
[Learn more](/docs/api-features/shopping-overview/)"
  ...
  ([product_group_id string?, {:keys [ad_account_id pin_metrics bookmark page_size]} (s/map-of keyword? any?)]
   ...
   (call-api "/catalogs/product_groups/{product_group_id}/products" :get
             {:path-params   {"product_group_id" product_group_id }
              :header-params {}
              :query-params  {"ad_account_id" ad_account_id "pin_metrics" pin_metrics "bookmark" bookmark "page_size" page_size }
              :form-params   {}
              :content-types []
...
If you require access, please reach out to your partner manager."
  ([catalogs-product-groups-create-request-schema catalogs-product-groups-create-request-schema, ] (catalogs-product-groups-create-with-http-info catalogs-product-groups-create-request-schema nil))
  ([catalogs-product-groups-create-request-schema catalogs-product-groups-create-request-schema, {:keys [ad_account_id]} (s/map-of keyword? any?)]
   (check-required-params catalogs-product-groups-create-request-schema)
   (call-api "/catalogs/product_groups" :post
             {:path-params   {}
              :header-params {}
              :query-params  {"ad_account_id" ad_account_id }
              :form-params   {}
              :body-param    catalogs-product-groups-create-request-schema
...
Note: Access to the Creative Assets catalog type is restricted to a specific group of users.
If you require access, please reach out to your partner manager."
  ([catalogs-product-groups-create-request-schema catalogs-product-groups-create-request-schema, ] (catalogs-product-groups-create catalogs-product-groups-create-request-schema nil))
  ([catalogs-product-groups-create-request-schema catalogs-product-groups-create-request-schema, optional-params any?]
   (let [res (:data (catalogs-product-groups-create-with-http-info catalogs-product-groups-create-request-schema optional-params))]
     (if (:decode-models *api-context*)
...
Note: Access to the Creative Assets catalog type is restricted to a specific group of users.
If you require access, please reach out to your partner manager."
  ([catalogs-product-groups-create-many-request-items (s/coll-of catalogs-product-groups-create-many-request-items-spec), ] (catalogs-product-groups-create-many-with-http-info catalogs-product-groups-create-many-request-items nil))
  ([catalogs-product-groups-create-many-request-items (s/coll-of catalogs-product-groups-create-many-request-items-spec), {:keys [ad_account_id]} (s/map-of keyword? any?)]
   (check-required-params catalogs-product-groups-create-many-request-items)
   (call-api "/catalogs/product_groups/multiple" :post
             {:path-params   {}
              :header-params {}
              :query-params  {"ad_account_id" ad_account_id }
              :form-params   {}
              :body-param    catalogs-product-groups-create-many-request-items
              :content-types ["application/json"]
              :accepts       ["application/json"]
              :auth-names    ["pinterest_oauth2"]})))
...
Note: Access to the Creative Assets catalog type is restricted to a specific group of users.
If you require access, please reach out to your partner manager."
  ([catalogs-product-groups-create-many-request-items (s/coll-of catalogs-product-groups-create-many-request-items-spec), ] (catalogs-product-groups-create-many catalogs-product-groups-create-many-request-items nil))
  ([catalogs-product-groups-create-many-request-items (s/coll-of catalogs-product-groups-create-many-request-items-spec), optional-params any?]
   (let [res (:data (catalogs-product-groups-create-many-with-http-info catalogs-product-groups-create-many-request-items optional-params))]
     (if (:decode-models *api-context*)
...
(defn-spec catalogs-product-groups-delete catalogs-vertical-product-group-spec
  "Delete product group
  Delete a product group owned by the \"operation user_account\" from being in use in Catalogs.
- By default, the \"operation user_account\" is the token user_account.
...
[Learn more](/docs/api-features/shopping-overview/)"
  ...
  ([{:keys [id feed_id catalog_id ad_account_id bookmark page_size]} (s/map-of keyword? any?)]
   (call-api "/catalogs/product_groups" :get
             {:path-params   {}
              :header-params {}
              :query-params  {"id" (with-collection-format id :csv) "feed_id" feed_id "catalog_id" catalog_id "ad_account_id" ad_account_id "bookmark" bookmark "page_size" page_size }
              :form-params   {}
              :content-types []
              :accepts       ["application/json"]
              :auth-names    ["pinterest_oauth2"]})))
...
Note: Access to the Creative Assets catalog type is restricted to a specific group of users.
If you require access, please reach out to your partner manager."
  ([product_group_id string?, catalogs-product-groups-update-request-schema catalogs-product-groups-update-request-schema, ] (catalogs-product-groups-update-with-http-info product_group_id catalogs-product-groups-update-request-schema nil))
  ([product_group_id string?, catalogs-product-groups-update-request-schema catalogs-product-groups-update-request-schema, {:keys [ad_account_id]} (s/map-of keyword? any?)]
   (check-required-params product_group_id catalogs-product-groups-update-request-schema)
   (call-api "/catalogs/product_groups/{product_group_id}" :patch
             {:path-params   {"product_group_id" product_group_id }
              :header-params {}
              :query-params  {"ad_account_id" ad_account_id }
              :form-params   {}
              :body-param    catalogs-product-groups-update-request-schema
              :content-types ["application/json"]
              :accepts       ["application/json"]
              :auth-names    ["pinterest_oauth2"]})))
...
Note: Access to the Creative Assets catalog type is restricted to a specific group of users.
If you require access, please reach out to your partner manager."
  ([product_group_id string?, catalogs-product-groups-update-request-schema catalogs-product-groups-update-request-schema, ] (catalogs-product-groups-update product_group_id catalogs-product-groups-update-request-schema nil))
  ([product_group_id string?, catalogs-product-groups-update-request-schema catalogs-product-groups-update-request-schema, optional-params any?]
   (let [res (:data (catalogs-product-groups-update-with-http-info product_group_id catalogs-product-groups-update-request-schema optional-params))]
     (if (:decode-models *api-context*)
        (st/decode catalogs-vertical-product-group-spec res st/string-transformer)
        res))))
