...
**This endpoint might not be available to all apps. [Learn more](/docs/getting-started/using-beta-and-restricted-features/).**"
  [ad_account_id string?, ads-credit-redeem-create ads-credit-redeem-create]
  (check-required-params ad_account_id ads-credit-redeem-create)
  (call-api "/ad_accounts/{ad_account_id}/ads_credit/redeem" :post
            {:path-params   {"ad_account_id" ad_account_id }
             :header-params {}
             :query-params  {}
             :form-params   {}
             :body-param    ads-credit-redeem-create
             :content-types ["application/json"]
             :accepts       ["application/json"]
             :auth-names    ["pinterest_oauth2"]}))

(defn-spec ads-credit-redeem ads-credit-redeem-spec
  "Redeem ad credits
  Redeem ads credit on behalf of the ad account id and apply it towards billing.

**This endpoint might not be available to all apps. [Learn more](/docs/getting-started/using-beta-and-restricted-features/).**"
  [ad_account_id string?, ads-credit-redeem-create ads-credit-redeem-create]
  (let [res (:data (ads-credit-redeem-with-http-info ad_account_id ads-credit-redeem-create))]
    (if (:decode-models *api-context*)
       (st/decode ads-credit-redeem-spec res st/string-transformer)
       res)))
...
(defn-spec billing-invoices-get-with-http-info any?
  ...
  ([ad_account_id string?, {:keys [bookmark page_size order sort status document_type start_due_date end_due_date]} (s/map-of keyword? any?)]
   (check-required-params ad_account_id)
   (call-api "/ad_accounts/{ad_account_id}/billing_invoices" :get
             {:path-params   {"ad_account_id" ad_account_id }
              :header-params {}
              :query-params  {"bookmark" bookmark "page_size" page_size "order" order "sort" sort "status" status "document_type" document_type "start_due_date" start_due_date "end_due_date" end_due_date }
              :form-params   {}
              :content-types []
              :accepts       ["application/json"]
              :auth-names    ["pinterest_oauth2"]})))
...
**This endpoint might not be available to all apps. [Learn more](/docs/getting-started/using-beta-and-restricted-features/).**"
  ([is_active boolean?, ad_account_id string?, ] (billing-profiles-get-with-http-info is_active ad_account_id nil))
  ([is_active boolean?, ad_account_id string?, {:keys [bookmark page_size]} (s/map-of keyword? any?)]
   (check-required-params is_active ad_account_id)
...
**This endpoint might not be available to all apps. [Learn more](/docs/getting-started/using-beta-and-restricted-features/).**"
  ([is_active boolean?, ad_account_id string?, ] (billing-profiles-get is_active ad_account_id nil))
  ([is_active boolean?, ad_account_id string?, optional-params any?]
   (let [res (:data (billing-profiles-get-with-http-info is_active ad_account_id optional-params))]
     (if (:decode-models *api-context*)
...
(defn-spec ssio-accounts-get ssio-account-spec
  "Get Salesforce account details including bill-to information.
  Get Salesforce account details including bill-to information to be used in insertion orders process for `ad_account_id`.
  - The token's `user_account` must either be the owner of the specified ad account, or have one of the necessary roles granted via [Business Access](https://help.pinterest.com/en/business/article/share-and-manage-access-to-your-ad-accounts): Admin, Finance, Campaign."
  [ad_account_id string?]
  (let [res (:data (ssio-accounts-get-with-http-info ad_account_id))]
    (if (:decode-models *api-context*)
       (st/decode ssio-account-spec res st/string-transformer)
       res)))
...
(defn-spec ssio-insertion-order-create-with-http-info any?
  ...
  - The token's `user_account` must either be the owner of the specified ad account, or have one of the necessary roles granted via [Business Access](https://help.pinterest.com/en/business/article/share-and-manage-access-to-your-ad-accounts): Admin, Finance, Campaign."
  [ad_account_id string?, ssio-insertion-order-create ssio-insertion-order-create]
  (check-required-params ad_account_id ssio-insertion-order-create)
  (call-api "/ad_accounts/{ad_account_id}/ssio/insertion_orders" :post
            {:path-params   {"ad_account_id" ad_account_id }
             :header-params {}
             :query-params  {}
             :form-params   {}
             :body-param    ssio-insertion-order-create
             :content-types ["application/json"]
             :accepts       ["application/json"]
             :auth-names    ["pinterest_oauth2"]}))

(defn-spec ssio-insertion-order-create ssio-insertion-order-spec
  "Create insertion order through SSIO.
  Create insertion order through SSIO for `ad_account_id`.
  - The token's `user_account` must either be the owner of the specified ad account, or have one of the necessary roles granted via [Business Access](https://help.pinterest.com/en/business/article/share-and-manage-access-to-your-ad-accounts): Admin, Finance, Campaign."
  [ad_account_id string?, ssio-insertion-order-create ssio-insertion-order-create]
  (let [res (:data (ssio-insertion-order-create-with-http-info ad_account_id ssio-insertion-order-create))]
    (if (:decode-models *api-context*)
       (st/decode ssio-insertion-order-spec res st/string-transformer)
       res)))
...
(defn-spec ssio-insertion-order-edit-with-http-info any?
  ...
  - The token's `user_account` must either be the owner of the specified ad account, or have one of the necessary roles granted via [Business Access](https://help.pinterest.com/en/business/article/share-and-manage-access-to-your-ad-accounts): Admin, Finance, Campaign."
  [ad_account_id string?, ssio-insertion-order-update ssio-insertion-order-update]
  (check-required-params ad_account_id ssio-insertion-order-update)
  (call-api "/ad_accounts/{ad_account_id}/ssio/insertion_orders" :patch
            {:path-params   {"ad_account_id" ad_account_id }
             :header-params {}
             :query-params  {}
             :form-params   {}
             :body-param    ssio-insertion-order-update
             :content-types ["application/json"]
             :accepts       ["application/json"]
             :auth-names    ["pinterest_oauth2"]}))

(defn-spec ssio-insertion-order-edit ssio-insertion-order-spec
  "Edit insertion order through SSIO.
  Edit insertion order through SSIO for `ad_account_id`.
  - The token's `user_account` must either be the owner of the specified ad account, or have one of the necessary roles granted via [Business Access](https://help.pinterest.com/en/business/article/share-and-manage-access-to-your-ad-accounts): Admin, Finance, Campaign."
  [ad_account_id string?, ssio-insertion-order-update ssio-insertion-order-update]
  (let [res (:data (ssio-insertion-order-edit-with-http-info ad_account_id ssio-insertion-order-update))]
    (if (:decode-models *api-context*)
       (st/decode ssio-insertion-order-spec res st/string-transformer)
       res)))
...
(defn-spec ssio-order-lines-get-by-ad-account-with-http-info any?
  ...
  ([ad_account_id string?, {:keys [pin_order_id bookmark page_size]} (s/map-of keyword? any?)]
   (check-required-params ad_account_id)
   (call-api "/ad_accounts/{ad_account_id}/ssio/order_lines" :get
             {:path-params   {"ad_account_id" ad_account_id }
              :header-params {}
              :query-params  {"pin_order_id" pin_order_id "bookmark" bookmark "page_size" page_size }
              :form-params   {}
              :content-types []
              :accepts       ["application/json"]
              :auth-names    ["pinterest_oauth2"]})))
