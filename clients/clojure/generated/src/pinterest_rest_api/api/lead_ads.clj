(ns pinterest-rest-api.api.lead-ads
...
(defn-spec ad-accounts-subscriptions-del-by-id-with-http-info any?
  ...
  [ad_account_id string?, subscription_id string?]
  (check-required-params ad_account_id subscription_id)
  (call-api "/ad_accounts/{ad_account_id}/leads/subscriptions/{subscription_id}" :delete
            {:path-params   {"ad_account_id" ad_account_id "subscription_id" subscription_id }
             :header-params {}
             :query-params  {}
             :form-params   {}
             :content-types []
...
(defn-spec ad-accounts-subscriptions-del-by-id lead-subscription-spec
  "Delete lead ads subscription
  Delete an existing lead ads webhook subscription by ID.
  - Only requests for the OWNER or ADMIN of the ad_account will be allowed.'"
  [ad_account_id string?, subscription_id string?]
  (let [res (:data (ad-accounts-subscriptions-del-by-id-with-http-info ad_account_id subscription_id))]
    (if (:decode-models *api-context*)
       (st/decode lead-subscription-spec res st/string-transformer)
       res)))


(defn-spec ad-accounts-subscriptions-get-by-id-with-http-info any?
  "Get lead ads subscription by ID
  Get an existing lead ads webhook subscription by ID.
  - Only requests for the OWNER or ADMIN of the ad_account will be allowed.'"
  [ad_account_id string?, subscription_id string?]
  (check-required-params ad_account_id subscription_id)
  (call-api "/ad_accounts/{ad_account_id}/leads/subscriptions/{subscription_id}" :get
            {:path-params   {"ad_account_id" ad_account_id "subscription_id" subscription_id }
             :header-params {}
             :query-params  {}
             :form-params   {}
...
(defn-spec ad-accounts-subscriptions-get-by-id lead-subscription-spec
  "Get lead ads subscription by ID
  Get an existing lead ads webhook subscription by ID.
  - Only requests for the OWNER or ADMIN of the ad_account will be allowed.'"
  [ad_account_id string?, subscription_id string?]
  (let [res (:data (ad-accounts-subscriptions-get-by-id-with-http-info ad_account_id subscription_id))]
    (if (:decode-models *api-context*)
       (st/decode lead-subscription-spec res st/string-transformer)
       res)))


(defn-spec ad-accounts-subscriptions-get-list-with-http-info any?
  "Get lead ads subscriptions
  Get the advertiser's list of lead ads subscriptions. Only requests for the OWNER or ADMIN of the ad_account will be allowed."
  ([ad_account_id string?, ] (ad-accounts-subscriptions-get-list-with-http-info ad_account_id nil))
  ([ad_account_id string?, {:keys [bookmark page_size]} (s/map-of keyword? any?)]
   (check-required-params ad_account_id)
   (call-api "/ad_accounts/{ad_account_id}/leads/subscriptions" :get
...
(defn-spec ad-accounts-subscriptions-get-list ad-accounts-subscriptions-get-list-200-response-spec
  "Get lead ads subscriptions
  Get the advertiser's list of lead ads subscriptions. Only requests for the OWNER or ADMIN of the ad_account will be allowed."
  ([ad_account_id string?, ] (ad-accounts-subscriptions-get-list ad_account_id nil))
  ([ad_account_id string?, optional-params any?]
   (let [res (:data (ad-accounts-subscriptions-get-list-with-http-info ad_account_id optional-params))]
     (if (:decode-models *api-context*)
        (st/decode ad-accounts-subscriptions-get-list-200-response-spec res st/string-transformer)
        res))))


(defn-spec ad-accounts-subscriptions-post-with-http-info any?
...
Subscriptions allow Pinterest to deliver lead data from Ads Manager directly to the subscriber. Subscriptions can exist for a specific lead form or at ad account level.
  ...
  [ad_account_id string?, lead-subscription-post-params-create lead-subscription-post-params-create]
  (check-required-params ad_account_id lead-subscription-post-params-create)
  (call-api "/ad_accounts/{ad_account_id}/leads/subscriptions" :post
            {:path-params   {"ad_account_id" ad_account_id }
             :header-params {}
             :query-params  {}
             :form-params   {}
             :body-param    lead-subscription-post-params-create
             :content-types ["application/json"]
             :accepts       ["application/json"]
             :auth-names    ["pinterest_oauth2"]}))

(defn-spec ad-accounts-subscriptions-post lead-subscription-spec
  "Create lead ads subscription
  Create a lead ads webhook subscription.
Subscriptions allow Pinterest to deliver lead data from Ads Manager directly to the subscriber. Subscriptions can exist for a specific lead form or at ad account level.
  - Only requests for the OWNER or ADMIN of the ad_account will be allowed.
  ...
  - For data security, egress lead data is encrypted with AES-256-GCM."
  [ad_account_id string?, lead-subscription-post-params-create lead-subscription-post-params-create]
  (let [res (:data (ad-accounts-subscriptions-post-with-http-info ad_account_id lead-subscription-post-params-create))]
    (if (:decode-models *api-context*)
       (st/decode lead-subscription-spec res st/string-transformer)
       res)))
