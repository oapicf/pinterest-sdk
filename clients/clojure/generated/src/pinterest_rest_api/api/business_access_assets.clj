(ns pinterest-rest-api.api.business-access-assets
  (:require [pinterest-rest-api.core :refer [call-api check-required-params with-collection-format *api-context*]]
            ...
            [pinterest-rest-api.specs.reports-stats-parameters-parameter :refer :all]
            [pinterest-rest-api.specs.pacing-delivery-type :refer :all]
            [pinterest-rest-api.specs.ad-group-id-filter :refer :all]
            ...
            [pinterest-rest-api.specs.advertiser-defined-events-response :refer :all]
            ...
            [pinterest-rest-api.specs.conversion-msot-events :refer :all]
            [pinterest-rest-api.specs.catalogs-product-groups-update-request :refer :all]
            [pinterest-rest-api.specs.system-user-update-request :refer :all]
            ...
            [pinterest-rest-api.specs.trending-keyword-demographics-gender-distribution :refer :all]
            ...
            [pinterest-rest-api.specs.item-response-one-of :refer :all]
            ...
            [pinterest-rest-api.specs.conversion-product-report-request :refer :all]
            ...
            [pinterest-rest-api.specs.promotion-update-request :refer :all]
            [pinterest-rest-api.specs.customer-list-upload-response :refer :all]
            ...
            [pinterest-rest-api.specs.promotion-common :refer :all]
            ...
            [pinterest-rest-api.specs.campaign-id-filter :refer :all]
            ...
            [pinterest-rest-api.specs.catalogs-report-all-items-filter :refer :all]
            ...
            [pinterest-rest-api.specs.brand-accounts-create-200-response :refer :all]
            ...
            [pinterest-rest-api.specs.trending-keyword-demographics-age-distribution :refer :all]
            ...
            [pinterest-rest-api.specs.targeting-spec-operation-string :refer :all]
            ...
            [pinterest-rest-api.specs.promotion-create-request :refer :all]
            [pinterest-rest-api.specs.gender-bucket :refer :all]
            [pinterest-rest-api.specs.catalogs-hotel-address :refer :all]
            [pinterest-rest-api.specs.local-store-update :refer :all]
            ...
            [pinterest-rest-api.specs.search-user-pins-list-200-response :refer :all]
            ...
            [pinterest-rest-api.specs.integrations-logs-post-400-response :refer :all]
            ...
            [pinterest-rest-api.specs.brand-accounts-update-request :refer :all]
            ...
            [pinterest-rest-api.specs.brand-accounts-create-request :refer :all]
            ...
            [pinterest-rest-api.specs.lead-subscription-post-params-create-all-of-partner-metadata :refer :all]
            ...
            [pinterest-rest-api.specs.all-of :refer :all]
            ...
            [pinterest-rest-api.specs.conversion-access-token-response :refer :all]
            ...
            [pinterest-rest-api.specs.any-of :refer :all]
            ...
            [pinterest-rest-api.specs.targeting-spec-operation-min-max-age :refer :all]
            ...
            [pinterest-rest-api.specs.item-response-one-of-1 :refer :all]
            ...
            [pinterest-rest-api.specs.campaign-objectives-filter :refer :all]
            ...
            [pinterest-rest-api.specs.targeting-spec-operation-list :refer :all]
...
(defn-spec asset-group-create-with-http-info any?
...
- An <a href=\"https://help.pinterest.com/en/business/article/asset-groups\">asset group</a> is a custom group of assets based on how you’d like to manage your accounts."
  [business_id string?, create-asset-group-body create-asset-group-body]
  (check-required-params business_id create-asset-group-body)
  (call-api "/businesses/{business_id}/asset_groups" :post
            {:path-params   {"business_id" business_id }
             :header-params {}
             :query-params  {}
             :form-params   {}
             :body-param    create-asset-group-body
             :content-types ["application/json"]
             :accepts       ["application/json"]
             :auth-names    ["pinterest_oauth2"]}))

(defn-spec asset-group-create create-asset-group-response-spec
  "Create a new asset group.
  Create a new asset group with the specified parameters.
- An <a href=\"https://help.pinterest.com/en/business/article/asset-groups\">asset group</a> is a custom group of assets based on how you’d like to manage your accounts."
  [business_id string?, create-asset-group-body create-asset-group-body]
  (let [res (:data (asset-group-create-with-http-info business_id create-asset-group-body))]
    (if (:decode-models *api-context*)
       (st/decode create-asset-group-response-spec res st/string-transformer)
       res)))


(defn-spec asset-group-delete-with-http-info any?
  "Delete asset groups.
  Delete a batch of asset groups."
  [business_id string?, delete-asset-group-body delete-asset-group-body]
  (check-required-params business_id delete-asset-group-body)
  (call-api "/businesses/{business_id}/asset_groups" :delete
            {:path-params   {"business_id" business_id }
             :header-params {}
             :query-params  {}
             :form-params   {}
             :body-param    delete-asset-group-body
             :content-types ["application/json"]
             :accepts       ["application/json"]
             :auth-names    ["pinterest_oauth2"]}))

(defn-spec asset-group-delete delete-asset-group-response-spec
  "Delete asset groups.
  Delete a batch of asset groups."
  [business_id string?, delete-asset-group-body delete-asset-group-body]
  (let [res (:data (asset-group-delete-with-http-info business_id delete-asset-group-body))]
    (if (:decode-models *api-context*)
       (st/decode delete-asset-group-response-spec res st/string-transformer)
       res)))


(defn-spec asset-group-update-with-http-info any?
  "Update asset groups.
  Update a batch of asset groups with the specified parameters."
  [business_id string?, update-asset-group-body update-asset-group-body]
  (check-required-params business_id update-asset-group-body)
  (call-api "/businesses/{business_id}/asset_groups" :patch
            {:path-params   {"business_id" business_id }
             :header-params {}
             :query-params  {}
             :form-params   {}
             :body-param    update-asset-group-body
             :content-types ["application/json"]
             :accepts       ["application/json"]
             :auth-names    ["pinterest_oauth2"]}))

(defn-spec asset-group-update update-asset-group-response-spec
  "Update asset groups.
  Update a batch of asset groups with the specified parameters."
  [business_id string?, update-asset-group-body update-asset-group-body]
  (let [res (:data (asset-group-update-with-http-info business_id update-asset-group-body))]
    (if (:decode-models *api-context*)
       (st/decode update-asset-group-response-spec res st/string-transformer)
       res)))


(defn-spec business-asset-members-get-with-http-info any?
  "Get members with access to asset
  Get all the members the requesting business has granted access to on the given asset."
  ([business_id string?, asset_id string?, ] (business-asset-members-get-with-http-info business_id asset_id nil))
  ([business_id string?, asset_id string?, {:keys [fetch_system_users bookmark page_size start_index]} (s/map-of keyword? any?)]
   (check-required-params business_id asset_id)
   (call-api "/businesses/{business_id}/assets/{asset_id}/members" :get
             {:path-params   {"business_id" business_id "asset_id" asset_id }
              :header-params {}
              :query-params  {"fetch_system_users" fetch_system_users "bookmark" bookmark "page_size" page_size "start_index" start_index }
              :form-params   {}
              :content-types []
              :accepts       ["application/json"]
              :auth-names    ["pinterest_oauth2"]})))

(defn-spec business-asset-members-get business-asset-members-get-200-response-spec
  "Get members with access to asset
  Get all the members the requesting business has granted access to on the given asset."
  ([business_id string?, asset_id string?, ] (business-asset-members-get business_id asset_id nil))
  ([business_id string?, asset_id string?, optional-params any?]
   (let [res (:data (business-asset-members-get-with-http-info business_id asset_id optional-params))]
     (if (:decode-models *api-context*)
        (st/decode business-asset-members-get-200-response-spec res st/string-transformer)
        res))))


(defn-spec business-asset-partners-get-with-http-info any?
...
you cannot be shared with a different partner."
  ([business_id string?, asset_id string?, ] (business-asset-partners-get-with-http-info business_id asset_id nil))
  ([business_id string?, asset_id string?, {:keys [start_index bookmark page_size]} (s/map-of keyword? any?)]
   (check-required-params business_id asset_id)
   (call-api "/businesses/{business_id}/assets/{asset_id}/partners" :get
             {:path-params   {"business_id" business_id "asset_id" asset_id }
              :header-params {}
              :query-params  {"start_index" start_index "bookmark" bookmark "page_size" page_size }
              :form-params   {}
              :content-types []
              :accepts       ["application/json"]
              :auth-names    ["pinterest_oauth2"]})))

(defn-spec business-asset-partners-get business-asset-partners-get-200-response-spec
  "Get partners with access to asset
  Get all the partners the requesting business has granted access to on the given asset.
Note: If the asset has been shared with you, an empty array will be returned. This is because an asset shared with
you cannot be shared with a different partner."
  ([business_id string?, asset_id string?, ] (business-asset-partners-get business_id asset_id nil))
  ([business_id string?, asset_id string?, optional-params any?]
   (let [res (:data (business-asset-partners-get-with-http-info business_id asset_id optional-params))]
     (if (:decode-models *api-context*)
        (st/decode business-asset-partners-get-200-response-spec res st/string-transformer)
        res))))


(defn-spec business-assets-get-with-http-info any?
  "List business assets
  Get all the assets the requesting business has access to. This includes assets the business owns and assets the business has access to through partnerships."
  ([business_id string?, ] (business-assets-get-with-http-info business_id nil))
  ([business_id string?, {:keys [permissions child_asset_id asset_group_id asset_type start_index bookmark page_size]} (s/map-of keyword? any?)]
   (check-required-params business_id)
   (call-api "/businesses/{business_id}/assets" :get
             {:path-params   {"business_id" business_id }
              :header-params {}
              :query-params  {"permissions" (with-collection-format permissions :multi) "child_asset_id" child_asset_id "asset_group_id" asset_group_id "asset_type" asset_type "start_index" start_index "bookmark" bookmark "page_size" page_size }
              :form-params   {}
              :content-types []
              :accepts       ["application/json"]
              :auth-names    ["pinterest_oauth2"]})))

(defn-spec business-assets-get business-assets-get-200-response-spec
  "List business assets
  Get all the assets the requesting business has access to. This includes assets the business owns and assets the business has access to through partnerships."
  ([business_id string?, ] (business-assets-get business_id nil))
  ([business_id string?, optional-params any?]
   (let [res (:data (business-assets-get-with-http-info business_id optional-params))]
     (if (:decode-models *api-context*)
        (st/decode business-assets-get-200-response-spec res st/string-transformer)
        res))))


(defn-spec business-member-assets-get-with-http-info any?
...
The return response will include the permissions the member has to that asset and the asset type."
  ([business_id string?, member_id string?, ] (business-member-assets-get-with-http-info business_id member_id nil))
  ([business_id string?, member_id string?, {:keys [asset_type start_index bookmark page_size]} (s/map-of keyword? any?)]
   (check-required-params business_id member_id)
   (call-api "/businesses/{business_id}/members/{member_id}/assets" :get
             {:path-params   {"business_id" business_id "member_id" member_id }
              :header-params {}
              :query-params  {"asset_type" asset_type "start_index" start_index "bookmark" bookmark "page_size" page_size }
              :form-params   {}
              :content-types []
              :accepts       ["application/json"]
              :auth-names    ["pinterest_oauth2"]})))

(defn-spec business-member-assets-get business-member-assets-get-200-response-spec
  "Get assets assigned to a member
  Get assets on which you assigned asset permissions to the given member. Can be used to:
- get all assets, regardless of asset type or
- get assets of one asset type by using the asset_type query.
The return response will include the permissions the member has to that asset and the asset type."
  ([business_id string?, member_id string?, ] (business-member-assets-get business_id member_id nil))
  ([business_id string?, member_id string?, optional-params any?]
   (let [res (:data (business-member-assets-get-with-http-info business_id member_id optional-params))]
     (if (:decode-models *api-context*)
        (st/decode business-member-assets-get-200-response-spec res st/string-transformer)
        res))))


(defn-spec business-members-asset-access-delete-with-http-info any?
  "Delete member access to asset
  Terminate multiple members' access to an asset."
  [business_id string?, business-members-asset-access-delete-request business-members-asset-access-delete-request]
  (check-required-params business_id business-members-asset-access-delete-request)
  (call-api "/businesses/{business_id}/members/assets/access" :delete
            {:path-params   {"business_id" business_id }
             :header-params {}
             :query-params  {}
             :form-params   {}
             :body-param    business-members-asset-access-delete-request
             :content-types ["application/json"]
             :accepts       ["application/json"]
             :auth-names    ["pinterest_oauth2"]}))

(defn-spec business-members-asset-access-delete delete-member-access-results-response-array-spec
  "Delete member access to asset
  Terminate multiple members' access to an asset."
  [business_id string?, business-members-asset-access-delete-request business-members-asset-access-delete-request]
  (let [res (:data (business-members-asset-access-delete-with-http-info business_id business-members-asset-access-delete-request))]
    (if (:decode-models *api-context*)
       (st/decode delete-member-access-results-response-array-spec res st/string-transformer)
       res)))


(defn-spec business-members-asset-access-update-with-http-info any?
...
Note: Not all listed permissions are applicable to each asset type. For example, PROFILE_PUBLISHER would not be applicable to an asset of type AD_ACCOUNT. The permission level PROFILE_PUBLISHER is only available to an asset of the type PROFILE."
  [business_id string?, update-member-asset-access-body update-member-asset-access-body]
  (check-required-params business_id update-member-asset-access-body)
  (call-api "/businesses/{business_id}/members/assets/access" :patch
            {:path-params   {"business_id" business_id }
             :header-params {}
             :query-params  {}
             :form-params   {}
             :body-param    update-member-asset-access-body
             :content-types ["application/json"]
             :accepts       ["application/json"]
             :auth-names    ["pinterest_oauth2"]}))

(defn-spec business-members-asset-access-update update-member-assets-results-response-array-spec
  "Assign/Update member asset permissions
  Grant multiple members access to assets and/or update multiple member's exisiting permissions to an asset.
Note: Not all listed permissions are applicable to each asset type. For example, PROFILE_PUBLISHER would not be applicable to an asset of type AD_ACCOUNT. The permission level PROFILE_PUBLISHER is only available to an asset of the type PROFILE."
  [business_id string?, update-member-asset-access-body update-member-asset-access-body]
  (let [res (:data (business-members-asset-access-update-with-http-info business_id update-member-asset-access-body))]
    (if (:decode-models *api-context*)
       (st/decode update-member-assets-results-response-array-spec res st/string-transformer)
       res)))


(defn-spec business-partner-asset-access-get-with-http-info any?
...
- partner_type=EXTERNAL, you will retrieve the partner's business assets that the partner has granted you access to."
  ([business_id string?, partner_id string?, ] (business-partner-asset-access-get-with-http-info business_id partner_id nil))
  ([business_id string?, partner_id string?, {:keys [partner_type asset_type start_index page_size bookmark]} (s/map-of keyword? any?)]
   (check-required-params business_id partner_id)
   (call-api "/businesses/{business_id}/partners/{partner_id}/assets" :get
             {:path-params   {"business_id" business_id "partner_id" partner_id }
              :header-params {}
              :query-params  {"partner_type" partner_type "asset_type" asset_type "start_index" start_index "page_size" page_size "bookmark" bookmark }
              :form-params   {}
              :content-types []
              :accepts       ["application/json"]
              :auth-names    ["pinterest_oauth2"]})))

(defn-spec business-partner-asset-access-get business-partner-asset-access-get-200-response-spec
  "Get assets assigned to a partner or assets assigned by a partner
  Can be used to get the business assets your partner has granted you access to or the business assets you have
granted your partner access to. If you specify:
- partner_type=INTERNAL, you will retrieve your business assets that the partner has access to.
- partner_type=EXTERNAL, you will retrieve the partner's business assets that the partner has granted you access to."
  ([business_id string?, partner_id string?, ] (business-partner-asset-access-get business_id partner_id nil))
  ([business_id string?, partner_id string?, optional-params any?]
   (let [res (:data (business-partner-asset-access-get-with-http-info business_id partner_id optional-params))]
     (if (:decode-models *api-context*)
        (st/decode business-partner-asset-access-get-200-response-spec res st/string-transformer)
        res))))


(defn-spec delete-partner-asset-access-handler-impl-with-http-info any?
...
- partner_type=EXTERNAL: You will terminate your own access to your partner's business assets."
  [business_id string?, delete-partner-asset-access-body delete-partner-asset-access-body]
  (check-required-params business_id delete-partner-asset-access-body)
  (call-api "/businesses/{business_id}/partners/assets" :delete
            {:path-params   {"business_id" business_id }
             :header-params {}
             :query-params  {}
             :form-params   {}
             :body-param    delete-partner-asset-access-body
             :content-types ["application/json"]
             :accepts       ["application/json"]
             :auth-names    ["pinterest_oauth2"]}))

(defn-spec delete-partner-asset-access-handler-impl delete-partner-assets-results-response-array-spec
  "Delete partner access to asset
  Terminate multiple partners' access to an asset. If
- partner_type=INTERNAL: You will terminate a partner's asset access to your business assets.
- partner_type=EXTERNAL: You will terminate your own access to your partner's business assets."
  [business_id string?, delete-partner-asset-access-body delete-partner-asset-access-body]
  (let [res (:data (delete-partner-asset-access-handler-impl-with-http-info business_id delete-partner-asset-access-body))]
    (if (:decode-models *api-context*)
       (st/decode delete-partner-assets-results-response-array-spec res st/string-transformer)
       res)))


(defn-spec update-partner-asset-access-handler-impl-with-http-info any?
...
the type PROFILE."
  [business_id string?, update-partner-asset-access-body update-partner-asset-access-body]
  (check-required-params business_id update-partner-asset-access-body)
  (call-api "/businesses/{business_id}/partners/assets" :patch
            {:path-params   {"business_id" business_id }
             :header-params {}
             :query-params  {}
             :form-params   {}
             :body-param    update-partner-asset-access-body
             :content-types ["application/json"]
             :accepts       ["application/json"]
             :auth-names    ["pinterest_oauth2"]}))

(defn-spec update-partner-asset-access-handler-impl update-partner-assets-results-response-array-spec
  "Assign/Update partner asset permissions
  Grant multiple partners access to assets and/or update multiple partner's exisiting permissions to an asset.
If your partner already had permissions on the asset, they will be overriden with the new permissions you assign to them.
To learn more about permission levels, visit https://help.pinterest.com/en/business/article/business-manager-overview
...
the type PROFILE."
  [business_id string?, update-partner-asset-access-body update-partner-asset-access-body]
  (let [res (:data (update-partner-asset-access-handler-impl-with-http-info business_id update-partner-asset-access-body))]
    (if (:decode-models *api-context*)
       (st/decode update-partner-assets-results-response-array-spec res st/string-transformer)
       res)))
