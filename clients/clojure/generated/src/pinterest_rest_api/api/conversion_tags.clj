...
(defn-spec conversion-tags-create conversion-tag-response-spec
  "Create conversion tag
  Create a conversion tag, also known as <a href=\"https://help.pinterest.com/en/business/article/set-up-the-pinterest-tag\" target=\"_blank\">Pinterest tag</a>, with the option to enable enhanced match.<p/>
The Pinterest Tag tracks actions people take on the ad account’ s website after they view the ad account's ad on Pinterest. The advertiser needs to customize this tag to track conversions.<p/>
For more information, see:<p/>
...
<a class=\"reference external\" href=\"/docs/api-features/pinterest-tag/#enhanced-match\">Enhanced match</a>"
  ...
  (let [res (:data (conversion-tags-create-with-http-info ad_account_id conversion-tag-create))]
    (if (:decode-models *api-context*)
       (st/decode conversion-tag-response-spec res st/string-transformer)
       res)))
...
(defn-spec conversion-tags-get conversion-tag-response-spec
  "Get conversion tag
  Get information about an existing conversion tag."
  [ad_account_id string?, conversion_tag_id string?]
...
(defn-spec conversion-tags-list conversion-tag-list-response-spec
  "Get conversion tags
  List conversion tags associated with an ad account."
  ...
  ([ad_account_id string?, optional-params any?]
   (let [res (:data (conversion-tags-list-with-http-info ad_account_id optional-params))]
     (if (:decode-models *api-context*)
        (st/decode conversion-tag-list-response-spec res st/string-transformer)
        res))))
