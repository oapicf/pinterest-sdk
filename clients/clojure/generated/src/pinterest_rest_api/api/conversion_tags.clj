(ns pinterest-rest-api.api.conversion-tags
...
(defn-spec conversion-tags-create-with-http-info any?
...
[Enhanced match](/docs/track-conversions/pinterest-tag/#enhanced-match)"
  [ad_account_id string?, conversion-tag-create conversion-tag-create]
  (check-required-params ad_account_id conversion-tag-create)
  (call-api "/ad_accounts/{ad_account_id}/conversion_tags" :post
            {:path-params   {"ad_account_id" ad_account_id }
             :header-params {}
             :query-params  {}
             :form-params   {}
             :body-param    conversion-tag-create
             :content-types ["application/json"]
             :accepts       ["application/json"]
             :auth-names    ["pinterest_oauth2"]}))

(defn-spec conversion-tags-create conversion-tag-spec
  "Create conversion tag
  Create a conversion tag, also known as [Pinterest tag](https://help.pinterest.com/en/business/article/set-up-the-pinterest-tag), with the option to enable enhanced match.
...
[Enhanced match](/docs/track-conversions/pinterest-tag/#enhanced-match)"
  [ad_account_id string?, conversion-tag-create conversion-tag-create]
  (let [res (:data (conversion-tags-create-with-http-info ad_account_id conversion-tag-create))]
    (if (:decode-models *api-context*)
       (st/decode conversion-tag-spec res st/string-transformer)
       res)))


(defn-spec conversion-tags-get-with-http-info any?
  "Get conversion tag
  Get information about an existing conversion tag."
  [ad_account_id string?, conversion_tag_id string?]
  (check-required-params ad_account_id conversion_tag_id)
  (call-api "/ad_accounts/{ad_account_id}/conversion_tags/{conversion_tag_id}" :get
            {:path-params   {"ad_account_id" ad_account_id "conversion_tag_id" conversion_tag_id }
             :header-params {}
             :query-params  {}
             :form-params   {}
             :content-types []
...
(defn-spec conversion-tags-get conversion-tag-spec
  "Get conversion tag
  Get information about an existing conversion tag."
  [ad_account_id string?, conversion_tag_id string?]
  (let [res (:data (conversion-tags-get-with-http-info ad_account_id conversion_tag_id))]
    (if (:decode-models *api-context*)
       (st/decode conversion-tag-spec res st/string-transformer)
       res)))


(defn-spec conversion-tags-list-with-http-info any?
  "List conversion tags
  List conversion tags associated with an ad account."
  ([ad_account_id string?, ] (conversion-tags-list-with-http-info ad_account_id nil))
  ([ad_account_id string?, {:keys [filter_deleted]} (s/map-of keyword? any?)]
   (check-required-params ad_account_id)
   (call-api "/ad_accounts/{ad_account_id}/conversion_tags" :get
             {:path-params   {"ad_account_id" ad_account_id }
              :header-params {}
              :query-params  {"filter_deleted" filter_deleted }
              :form-params   {}
              :content-types []
              :accepts       ["application/json"]
              :auth-names    ["pinterest_oauth2" "client_credentials"]})))

(defn-spec conversion-tags-list conversion-tags-list-200-response-spec
  "List conversion tags
  List conversion tags associated with an ad account."
  ([ad_account_id string?, ] (conversion-tags-list ad_account_id nil))
  ([ad_account_id string?, optional-params any?]
   (let [res (:data (conversion-tags-list-with-http-info ad_account_id optional-params))]
     (if (:decode-models *api-context*)
        (st/decode conversion-tags-list-200-response-spec res st/string-transformer)
        res))))


(defn-spec ocpm-eligible-conversion-tags-get-with-http-info any?
  "Get Ocpm eligible conversion tags
  Get Ocpm eligible conversion tag events for an ad account."
  [ad_account_id string?]
  (check-required-params ad_account_id)
  (call-api "/ad_accounts/{ad_account_id}/conversion_tags/ocpm_eligible" :get
            {:path-params   {"ad_account_id" ad_account_id }
             :header-params {}
             :query-params  {}
             :form-params   {}
...
(defn-spec ocpm-eligible-conversion-tags-get (s/map-of string? (s/coll-of conversion-event-response-spec))
  "Get Ocpm eligible conversion tags
  Get Ocpm eligible conversion tag events for an ad account."
  [ad_account_id string?]
  (let [res (:data (ocpm-eligible-conversion-tags-get-with-http-info ad_account_id))]
    (if (:decode-models *api-context*)
       (st/decode (s/map-of string? (s/coll-of conversion-event-response-spec)) res st/string-transformer)
       res)))


(defn-spec page-visit-conversion-tags-get-with-http-info any?
  "Get page visit conversion tags
  Get all page visit conversion tag events for an ad account."
  ([ad_account_id string?, ] (page-visit-conversion-tags-get-with-http-info ad_account_id nil))
  ([ad_account_id string?, {:keys [bookmark page_size order]} (s/map-of keyword? any?)]
   (check-required-params ad_account_id)
   (call-api "/ad_accounts/{ad_account_id}/conversion_tags/page_visit" :get
             {:path-params   {"ad_account_id" ad_account_id }
              :header-params {}
...
(defn-spec page-visit-conversion-tags-get page-visit-conversion-tags-get-200-response-spec
  "Get page visit conversion tags
  Get all page visit conversion tag events for an ad account."
  ([ad_account_id string?, ] (page-visit-conversion-tags-get ad_account_id nil))
  ([ad_account_id string?, optional-params any?]
   (let [res (:data (page-visit-conversion-tags-get-with-http-info ad_account_id optional-params))]
     (if (:decode-models *api-context*)
        (st/decode page-visit-conversion-tags-get-200-response-spec res st/string-transformer)
        res))))
