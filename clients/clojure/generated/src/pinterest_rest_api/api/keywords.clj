...
<p><b>Rate limit</b>: <a href=\"/docs/reference/rate-limits/\">WRITE</a>.</p>"
  [ad_account_id string?, keywords-request keywords-request]
  (check-required-params ad_account_id keywords-request)
  (call-api "/ad_accounts/{ad_account_id}/keywords" :post
            {:path-params   {"ad_account_id" ad_account_id }
             :header-params {}
             :query-params  {}
             :form-params   {}
             :body-param    keywords-request
             :content-types ["application/json"]
             :accepts       ["application/json"]
             :auth-names    ["pinterest_oauth2"]}))

(defn-spec keywords-create keywords-response-spec
  "Create keywords
  <p>Create keywords for following entity types(advertiser, campaign, ad group or ad).</p> <p>For more information, see <a target=\"_blank\" href=\"https://help.pinterest.com/en/business/article/keyword-targeting\">Keyword targeting</a>.</p>
<p><b>Notes:</b></p> <ul style=\"list-style-type: square;\"> <li>Advertisers and campaigns can only be assigned keywords with excluding ('_NEGATIVE').</li> <li>All keyword match types are available for ad groups.</li> </ul> <p>For more information on match types, see <a  target=\"_blank\" href=\"/docs/api-features/targeting-overview/\">match type enums</a>.</p>
<p><b>Returns:</b></p> <ul style=\"list-style-type: square;\"> <li><p>A successful call returns an object containing an array of new keyword objects and an empty &quot;errors&quot; object array.</p></li> <li><p>An unsuccessful call returns an empty keywords array, and, instead, inserts the entire object with nulled/negated properties into the &quot;errors&quot; object array:</p> <pre class=\"last literal-block\"> { \"keywords\": [], \"errors\": [ { \"data\": { \"archived\": null, \"match_type\": \"EXACT\", \"parent_type\": null, \"value\": \"foobar\", \"parent_id\": null, \"type\": \"keyword\", \"id\": null }, \"error_messages\": [ \"Advertisers and Campaigns only accept excluded targeting attributes.\" ] } } </pre></li> </ul>
<p><b>Rate limit</b>: <a href=\"/docs/reference/rate-limits/\">WRITE</a>.</p>"
  [ad_account_id string?, keywords-request keywords-request]
  (let [res (:data (keywords-create-with-http-info ad_account_id keywords-request))]
    (if (:decode-models *api-context*)
       (st/decode keywords-response-spec res st/string-transformer)
       res)))
...
<p><b>Returns:</b></p> <ul style=\"list-style-type: square;\"> <li><p>A successful call returns an object containing an array of new keyword objects and an empty &quot;errors&quot; object array.</p></li> <li><p>An unsuccessful call returns an empty keywords array, and, instead, inserts the entire object with nulled/negated properties into the &quot;errors&quot; object array:</p> <pre class=\"last literal-block\"> { \"keywords\": [], \"errors\": [ { \"data\": { \"archived\": null, \"match_type\": \"EXACT\", \"parent_type\": null, \"value\": \"foobar\", \"parent_id\": null, \"type\": \"keyword\", \"id\": null }, \"error_messages\": [ \"Advertisers and Campaigns only accept excluded targeting attributes.\" ] } } </pre></li> </ul>"
  ...
  ([ad_account_id string?, {:keys [campaign_id ad_group_id ad_group_ids match_types page_size bookmark]} (s/map-of keyword? any?)]
   (check-required-params ad_account_id)
   (call-api "/ad_accounts/{ad_account_id}/keywords" :get
             {:path-params   {"ad_account_id" ad_account_id }
              :header-params {}
              :query-params  {"campaign_id" campaign_id "ad_group_id" ad_group_id "ad_group_ids" (with-collection-format ad_group_ids :multi) "match_types" (with-collection-format match_types :multi) "page_size" page_size "bookmark" bookmark }
              :form-params   {}
              :content-types []
              :accepts       ["application/json"]
              :auth-names    ["pinterest_oauth2" "client_credentials"]})))
...
(defn-spec keywords-update-with-http-info any?
  ...
  [ad_account_id string?, keyword-update-body keyword-update-body]
  (check-required-params ad_account_id keyword-update-body)
  (call-api "/ad_accounts/{ad_account_id}/keywords" :patch
            {:path-params   {"ad_account_id" ad_account_id }
             :header-params {}
             :query-params  {}
             :form-params   {}
             :body-param    keyword-update-body
             :content-types ["application/json"]
             :accepts       ["application/json"]
             :auth-names    ["pinterest_oauth2"]}))

(defn-spec keywords-update keywords-response-spec
  "Update keywords
  <p>Update one or more keywords' bid and archived fields.</p> <p>Archiving a keyword effectively deletes it - keywords no longer receive metrics and no longer visible within the parent entity's keywords list.</p>"
  [ad_account_id string?, keyword-update-body keyword-update-body]
  (let [res (:data (keywords-update-with-http-info ad_account_id keyword-update-body))]
    (if (:decode-models *api-context*)
       (st/decode keywords-response-spec res st/string-transformer)
       res)))
...
(defn-spec trending-keywords-list-with-http-info any?
  ...
  ([region trends-supported-region, trend_type trend-type, {:keys [interests genders ages include_keywords normalize_against_group limit include_prediction include_demographics]} (s/map-of keyword? any?)]
