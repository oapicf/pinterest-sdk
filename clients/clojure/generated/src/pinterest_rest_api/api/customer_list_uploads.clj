...
(defn-spec customer-list-uploads-get customer-list-upload-response-spec
  "Get customer list upload
  <a href=\"/docs/getting-started/using-beta-and-restricted-features/\" target=\"_blank\">Closed beta</a>
<p>Get the metadata for a given upload by its ID.</p>"
  [ad_account_id string?, customer_list_id string?, customer_list_upload_id string?]
  (let [res (:data (customer-list-uploads-get-with-http-info ad_account_id customer_list_id customer_list_upload_id))]
    (if (:decode-models *api-context*)
       (st/decode customer-list-upload-response-spec res st/string-transformer)
       res)))
...
(defn-spec customer-list-uploads-run customer-list-upload-response-spec
  "Run customer list upload
  <a href=\"/docs/getting-started/using-beta-and-restricted-features/\" target=\"_blank\">Closed beta</a>
<p>Begin processing a customer list upload.</p>"
  [ad_account_id string?, customer_list_id string?, customer_list_upload_id string?]
