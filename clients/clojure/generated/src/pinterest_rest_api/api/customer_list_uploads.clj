(ns pinterest-rest-api.api.customer-list-uploads
...
(defn-spec customer-list-uploads-create-with-http-info any?
...
**Please review the [update customer list endpoint](/docs/api/v5/customer_lists-update/) documentation for additional information.**"
  [ad_account_id string?, customer_list_id string?, customer-list-upload-create-request customer-list-upload-create-request]
  (check-required-params ad_account_id customer_list_id customer-list-upload-create-request)
  (call-api "/ad_accounts/{ad_account_id}/customer_lists/{customer_list_id}/uploads" :post
            {:path-params   {"ad_account_id" ad_account_id "customer_list_id" customer_list_id }
             :header-params {}
             :query-params  {}
             :form-params   {}
             :body-param    customer-list-upload-create-request
             :content-types ["application/json"]
             :accepts       ["application/json"]
             :auth-names    ["pinterest_oauth2"]}))

(defn-spec customer-list-uploads-create customer-list-upload-create-response-spec
  "Create customer list upload
  Create a customer list upload request for multipart S3 upload.
...
**Please review the [update customer list endpoint](/docs/api/v5/customer_lists-update/) documentation for additional information.**"
  [ad_account_id string?, customer_list_id string?, customer-list-upload-create-request customer-list-upload-create-request]
  (let [res (:data (customer-list-uploads-create-with-http-info ad_account_id customer_list_id customer-list-upload-create-request))]
    (if (:decode-models *api-context*)
       (st/decode customer-list-upload-create-response-spec res st/string-transformer)
       res)))


(defn-spec customer-list-uploads-get-with-http-info any?
  "Get customer list upload
  Get the metadata for a given upload by its ID."
  [ad_account_id string?, customer_list_id string?, customer_list_upload_id string?]
  (check-required-params ad_account_id customer_list_id customer_list_upload_id)
  (call-api "/ad_accounts/{ad_account_id}/customer_lists/{customer_list_id}/uploads/{customer_list_upload_id}" :get
            {:path-params   {"ad_account_id" ad_account_id "customer_list_id" customer_list_id "customer_list_upload_id" customer_list_upload_id }
             :header-params {}
             :query-params  {}
             :form-params   {}
             :content-types []
...
(defn-spec customer-list-uploads-get customer-list-upload-spec
  "Get customer list upload
  Get the metadata for a given upload by its ID."
  [ad_account_id string?, customer_list_id string?, customer_list_upload_id string?]
  (let [res (:data (customer-list-uploads-get-with-http-info ad_account_id customer_list_id customer_list_upload_id))]
    (if (:decode-models *api-context*)
       (st/decode customer-list-upload-spec res st/string-transformer)
       res)))


(defn-spec customer-list-uploads-run-with-http-info any?
  "Run customer list upload
  Begin processing a customer list upload."
  [ad_account_id string?, customer_list_id string?, customer_list_upload_id string?]
  (check-required-params ad_account_id customer_list_id customer_list_upload_id)
  (call-api "/ad_accounts/{ad_account_id}/customer_lists/{customer_list_id}/uploads/{customer_list_upload_id}/run" :post
            {:path-params   {"ad_account_id" ad_account_id "customer_list_id" customer_list_id "customer_list_upload_id" customer_list_upload_id }
             :header-params {}
             :query-params  {}
             :form-params   {}
...
(defn-spec customer-list-uploads-run customer-list-upload-spec
  "Run customer list upload
  Begin processing a customer list upload."
  [ad_account_id string?, customer_list_id string?, customer_list_upload_id string?]
  (let [res (:data (customer-list-uploads-run-with-http-info ad_account_id customer_list_id customer_list_upload_id))]
    (if (:decode-models *api-context*)
       (st/decode customer-list-upload-spec res st/string-transformer)
       res)))
