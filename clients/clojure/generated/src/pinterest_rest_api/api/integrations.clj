...
(defn-spec integrations-commerce-del integration-metadata-spec
  "Delete commerce integration
  Delete commerce integration metadata for the given external business ID. Note: If you're interested in joining the beta, please reach out to your Pinterest account manager."
  [external_business_id string?]
...
(defn-spec integrations-commerce-patch-with-http-info any?
  ...
  [external_business_id string?, integration-metadata-update integration-metadata-update]
  (check-required-params external_business_id integration-metadata-update)
  (call-api "/integrations/commerce/{external_business_id}" :patch
            {:path-params   {"external_business_id" external_business_id }
             :header-params {}
             :query-params  {}
             :form-params   {}
             :body-param    integration-metadata-update
...
(defn-spec integrations-commerce-patch integration-metadata-spec
  ...
  Update commerce integration metadata for the given external business ID. Note: If you're interested in joining the beta, please reach out to your Pinterest account manager."
  [external_business_id string?, integration-metadata-update integration-metadata-update]
  (let [res (:data (integrations-commerce-patch-with-http-info external_business_id integration-metadata-update))]
    (if (:decode-models *api-context*)
       (st/decode integration-metadata-spec res st/string-transformer)
       res)))
...
(defn-spec integrations-commerce-post-with-http-info any?
  ...
  [integration-metadata-create integration-metadata-create]
  (check-required-params integration-metadata-create)
  (call-api "/integrations/commerce" :post
            {:path-params   {}
             :header-params {}
             :query-params  {}
             :form-params   {}
             :body-param    integration-metadata-create
             :content-types ["application/json"]
             :accepts       ["application/json"]
             :auth-names    ["pinterest_oauth2"]}))
...
(defn-spec integrations-commerce-post integration-metadata-spec
  ...
  Create commerce integration metadata to link an external business ID with a Pinterest merchant & ad account. Note: If you're interested in joining the beta, please reach out to your Pinterest account manager."
  [integration-metadata-create integration-metadata-create]
  (let [res (:data (integrations-commerce-post-with-http-info integration-metadata-create))]
    (if (:decode-models *api-context*)
       (st/decode integration-metadata-spec res st/string-transformer)
       res)))
...
Note: If you're interested in joining the beta, please reach out to your Pinterest account manager."
  [integration-logs-request-create integration-logs-request-create]
  (check-required-params integration-logs-request-create)
  (call-api "/integrations/logs" :post
            {:path-params   {}
             :header-params {}
             :query-params  {}
             :form-params   {}
             :body-param    integration-logs-request-create
             :content-types ["application/json"]
             :accepts       ["application/json"]
             :auth-names    ["pinterest_oauth2"]}))
...
Note: If you're interested in joining the beta, please reach out to your Pinterest account manager."
  [integration-logs-request-create integration-logs-request-create]
  (let [res (:data (integrations-logs-post-with-http-info integration-logs-request-create))]
    (if (:decode-models *api-context*)
