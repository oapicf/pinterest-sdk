...
Note: If you're interested in joining the beta, please reach out to your Pinterest account manager."
  [external_business_id string?, integration-request-patch integration-request-patch]
  (check-required-params external_business_id integration-request-patch)
...
Note: If you're interested in joining the beta, please reach out to your Pinterest account manager."
  [external_business_id string?, integration-request-patch integration-request-patch]
  (let [res (:data (integrations-commerce-patch-with-http-info external_business_id integration-request-patch))]
    (if (:decode-models *api-context*)
       (st/decode integration-metadata-spec res st/string-transformer)
       res)))
...
Note: If you're interested in joining the beta, please reach out to your Pinterest account manager."
  ...
  (check-required-params integration-request)
...
Note: If you're interested in joining the beta, please reach out to your Pinterest account manager."
  [integration-request integration-request]
  (let [res (:data (integrations-commerce-post-with-http-info integration-request))]
    (if (:decode-models *api-context*)
       (st/decode integration-metadata-spec res st/string-transformer)
       res)))
