(ns pinterest-rest-api.api.msot-events
...
(defn-spec msot-events-create-with-http-info any?
...
- These events will not be used in Reporting."
  [ad_account_id string?, conversion-msot-events-create conversion-msot-events-create]
  (check-required-params ad_account_id conversion-msot-events-create)
  (call-api "/ad_accounts/{ad_account_id}/msot/events" :post
            {:path-params   {"ad_account_id" ad_account_id }
             :header-params {}
             :query-params  {}
             :form-params   {}
             :body-param    conversion-msot-events-create
             :content-types ["application/json"]
             :accepts       ["application/json"]
             :auth-names    ["pinterest_oauth2"]}))

(defn-spec msot-events-create any?
  "Send Measurement Source Of Truth (MSOT) attributed conversion events
  **This feature is currently in beta and not available to all apps.**
If you are interested in joining the beta, reach out to your Pinterest account manager.
...
- These events will not be used in Reporting."
  [ad_account_id string?, conversion-msot-events-create conversion-msot-events-create]
  (let [res (:data (msot-events-create-with-http-info ad_account_id conversion-msot-events-create))]
