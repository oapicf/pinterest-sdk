...
- These events will NOT be used in Reporting."
  [ad_account_id string?, conversion-msot-events conversion-msot-events]
  (check-required-params ad_account_id conversion-msot-events)
  (call-api "/ad_accounts/{ad_account_id}/msot/events" :post
            {:path-params   {"ad_account_id" ad_account_id }
             :header-params {}
             :query-params  {}
             :form-params   {}
             :body-param    conversion-msot-events
...
- These events will NOT be used in Reporting."
  [ad_account_id string?, conversion-msot-events conversion-msot-events]
  (let [res (:data (msot-events-create-with-http-info ad_account_id conversion-msot-events))]
