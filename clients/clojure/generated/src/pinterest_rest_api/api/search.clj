...
If using Business Access: Specify an ad_account_id to use the owner of that ad_account as the \"operation user_account\". See <a href='/docs/getting-started/using-business-access/'>Understanding Business Access</a> for more information."
  ...
  ([{:keys [ad_account_id bookmark page_size query]} (s/map-of keyword? any?)]
   (call-api "/search/boards" :get
             {:path-params   {}
              :header-params {}
              :query-params  {"ad_account_id" ad_account_id "bookmark" bookmark "page_size" page_size "query" query }
              :form-params   {}
              :content-types []
              :accepts       ["application/json"]
              :auth-names    ["pinterest_oauth2" "client_credentials"]})))

(defn-spec search-user-boards-get search-user-boards-get-200-response-spec
  "Search user's boards
  Search for boards for the \"operation user_account\". This includes boards of all board types.
- By default, the \"operation user_account\" is the token user_account.
...
If using Business Access: Specify an ad_account_id to use the owner of that ad_account as the \"operation user_account\". See <a href='/docs/getting-started/using-business-access/'>Understanding Business Access</a> for more information."
  ...
  ([optional-params any?]
   (let [res (:data (search-user-boards-get-with-http-info optional-params))]
     (if (:decode-models *api-context*)
        (st/decode search-user-boards-get-200-response-spec res st/string-transformer)
        res))))
...
(defn-spec search-user-pins-list search-user-pins-list-200-response-spec
  "Search user's Pins
  Search for pins for the \"operation user_account\".
- By default, the \"operation user_account\" is the token user_account.
...
If using Business Access: Specify an ad_account_id to use the owner of that ad_account as the \"operation user_account\". See <a href='/docs/getting-started/using-business-access/'>Understanding Business Access</a> for more information."
  ...
  ([query string?, optional-params any?]
   (let [res (:data (search-user-pins-list-with-http-info query optional-params))]
     (if (:decode-models *api-context*)
        (st/decode search-user-pins-list-200-response-spec res st/string-transformer)
        res))))
