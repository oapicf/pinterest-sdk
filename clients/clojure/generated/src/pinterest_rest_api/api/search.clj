(ns pinterest-rest-api.api.search
...
(defn-spec search-partner-pins-with-http-info any?
...
Get the top 10 Pins by a given search term."
  ([term string?, country_code string?, ] (search-partner-pins-with-http-info term country_code nil))
  ([term string?, country_code string?, {:keys [bookmark locale limit]} (s/map-of keyword? any?)]
   (check-required-params term country_code)
   (call-api "/search/partner/pins" :get
             {:path-params   {}
              :header-params {}
              :query-params  {"term" term "country_code" country_code "bookmark" bookmark "locale" locale "limit" limit }
              :form-params   {}
              :content-types []
              :accepts       ["application/json"]
              :auth-names    ["pinterest_oauth2"]})))

(defn-spec search-partner-pins search-partner-pins-200-response-spec
  "Search pins by a given search term
  **This endpoint is currently in beta and not available to all apps. [Learn more](/docs/getting-started/using-beta-and-restricted-features/).**

Get the top 10 Pins by a given search term."
  ([term string?, country_code string?, ] (search-partner-pins term country_code nil))
  ([term string?, country_code string?, optional-params any?]
   (let [res (:data (search-partner-pins-with-http-info term country_code optional-params))]
     (if (:decode-models *api-context*)
        (st/decode search-partner-pins-200-response-spec res st/string-transformer)
        res))))


(defn-spec search-user-boards-get-with-http-info any?
...
If using Business Access: Specify an ad_account_id to use the owner of that ad_account as the \"operation user_account\". See [Understanding Business Access](/docs/getting-started/using-business-access/) for more information."
  ([] (search-user-boards-get-with-http-info nil))
  ([{:keys [ad_account_id query bookmark page_size]} (s/map-of keyword? any?)]
   (call-api "/search/boards" :get
             {:path-params   {}
              :header-params {}
              :query-params  {"ad_account_id" ad_account_id "query" query "bookmark" bookmark "page_size" page_size }
              :form-params   {}
              :content-types []
              :accepts       ["application/json"]
              :auth-names    ["pinterest_oauth2" "client_credentials"]})))

(defn-spec search-user-boards-get boards-list-200-response-spec
  "Search user's boards
  Search for boards for the \"operation user_account\". This includes boards of all board types.
- By default, the \"operation user_account\" is the token user_account.

If using Business Access: Specify an ad_account_id to use the owner of that ad_account as the \"operation user_account\". See [Understanding Business Access](/docs/getting-started/using-business-access/) for more information."
  ([] (search-user-boards-get nil))
  ([optional-params any?]
   (let [res (:data (search-user-boards-get-with-http-info optional-params))]
     (if (:decode-models *api-context*)
        (st/decode boards-list-200-response-spec res st/string-transformer)
        res))))


(defn-spec search-user-pins-list-with-http-info any?
  "Search user's Pins
  Search for pins for the \"operation user_account\".
- By default, the \"operation user_account\" is the token user_account.

If using Business Access: Specify an ad_account_id to use the owner of that ad_account as the \"operation user_account\". See [Understanding Business Access](/docs/getting-started/using-business-access/) for more information."
  ([query string?, ] (search-user-pins-list-with-http-info query nil))
  ([query string?, {:keys [ad_account_id bookmark]} (s/map-of keyword? any?)]
   (check-required-params query)
   (call-api "/search/pins" :get
             {:path-params   {}
              :header-params {}
              :query-params  {"ad_account_id" ad_account_id "query" query "bookmark" bookmark }
              :form-params   {}
              :content-types []
              :accepts       ["application/json"]
              :auth-names    ["pinterest_oauth2"]})))

(defn-spec search-user-pins-list pins-list-200-response-spec
  "Search user's Pins
  Search for pins for the \"operation user_account\".
- By default, the \"operation user_account\" is the token user_account.

If using Business Access: Specify an ad_account_id to use the owner of that ad_account as the \"operation user_account\". See [Understanding Business Access](/docs/getting-started/using-business-access/) for more information."
  ([query string?, ] (search-user-pins-list query nil))
  ([query string?, optional-params any?]
   (let [res (:data (search-user-pins-list-with-http-info query optional-params))]
     (if (:decode-models *api-context*)
