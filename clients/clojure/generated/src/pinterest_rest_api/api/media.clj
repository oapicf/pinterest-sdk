(ns pinterest-rest-api.api.media
...
(defn-spec media-create-with-http-info any?
...
**[Learn more](/docs/api-features/creating-boards-and-pins/#creating-video-pins)** about video Pin creation."
  [media-upload-create media-upload-create]
  (check-required-params media-upload-create)
  (call-api "/media" :post
            {:path-params   {}
             :header-params {}
             :query-params  {}
             :form-params   {}
             :body-param    media-upload-create
             :content-types ["application/json"]
             :accepts       ["application/json"]
             :auth-names    ["pinterest_oauth2"]}))

(defn-spec media-create media-upload-spec
  "Register media upload
  Register your intent to upload media.
...
**[Learn more](/docs/api-features/creating-boards-and-pins/#creating-video-pins)** about video Pin creation."
  [media-upload-create media-upload-create]
  (let [res (:data (media-create-with-http-info media-upload-create))]
    (if (:decode-models *api-context*)
       (st/decode media-upload-spec res st/string-transformer)
       res)))


(defn-spec media-get-with-http-info any?
  "Get media upload details
  Get details for a registered media upload, including its current status.

**[Learn more](/docs/api-features/creating-boards-and-pins/#creating-video-pins)** about video Pin creation."
  [media_id string?]
  (check-required-params media_id)
  (call-api "/media/{media_id}" :get
            {:path-params   {"media_id" media_id }
             :header-params {}
             :query-params  {}
             :form-params   {}
             :content-types []
...
(defn-spec media-get media-spec
  "Get media upload details
  Get details for a registered media upload, including its current status.

**[Learn more](/docs/api-features/creating-boards-and-pins/#creating-video-pins)** about video Pin creation."
  [media_id string?]
  (let [res (:data (media-get-with-http-info media_id))]
    (if (:decode-models *api-context*)
       (st/decode media-spec res st/string-transformer)
       res)))


(defn-spec media-list-with-http-info any?
  "List media uploads
  List media uploads filtered by given parameters.

**[Learn more](/docs/api-features/creating-boards-and-pins/#creating-video-pins)** about video Pin creation."
  ([] (media-list-with-http-info nil))
...
(defn-spec media-list media-list-200-response-spec
  "List media uploads
  List media uploads filtered by given parameters.
...
**[Learn more](/docs/api-features/creating-boards-and-pins/#creating-video-pins)** about video Pin creation."
  ([] (media-list nil))
  ([optional-params any?]
   (let [res (:data (media-list-with-http-info optional-params))]
     (if (:decode-models *api-context*)
        (st/decode media-list-200-response-spec res st/string-transformer)
        res))))
