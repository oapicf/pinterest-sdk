...
<strong><a href='/docs/api-features/creating-boards-and-pins/#creating-video-pins'>Learn more</a></strong> about video Pin creation."
  [media-upload-request media-upload-request]
  (check-required-params media-upload-request)
  (call-api "/media" :post
            {:path-params   {}
             :header-params {}
             :query-params  {}
             :form-params   {}
             :body-param    media-upload-request
...
<strong><a href='/docs/api-features/creating-boards-and-pins/#creating-video-pins'>Learn more</a></strong> about video Pin creation."
  [media-upload-request media-upload-request]
  (let [res (:data (media-create-with-http-info media-upload-request))]
...
(defn-spec media-get media-upload-details-spec
  "Get media upload details
  Get details for a registered media upload, including its current status.
...
<strong><a href='/docs/api-features/creating-boards-and-pins/#creating-video-pins'>Learn more</a></strong> about video Pin creation."
  ...
  (let [res (:data (media-get-with-http-info media_id))]
    (if (:decode-models *api-context*)
       (st/decode media-upload-details-spec res st/string-transformer)
       res)))
