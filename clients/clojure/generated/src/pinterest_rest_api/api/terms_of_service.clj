(ns pinterest-rest-api.api.terms-of-service
...
(defn-spec terms-of-service-get-with-http-info any?
  "Get terms of service
  Get the text of the terms of service and see whether the advertiser has accepted the terms of service."
  ([ad_account_id string?, ] (terms-of-service-get-with-http-info ad_account_id nil))
  ([ad_account_id string?, {:keys [include_html tos_type]} (s/map-of keyword? any?)]
   (check-required-params ad_account_id)
   (call-api "/ad_accounts/{ad_account_id}/terms_of_service" :get
             {:path-params   {"ad_account_id" ad_account_id }
              :header-params {}
              :query-params  {"include_html" include_html "tos_type" tos_type }
              :form-params   {}
              :content-types []
              :accepts       ["application/json"]
              :auth-names    ["pinterest_oauth2"]})))

(defn-spec terms-of-service-get terms-of-service-spec
  "Get terms of service
  Get the text of the terms of service and see whether the advertiser has accepted the terms of service."
  ([ad_account_id string?, ] (terms-of-service-get ad_account_id nil))
  ([ad_account_id string?, optional-params any?]
   (let [res (:data (terms-of-service-get-with-http-info ad_account_id optional-params))]
     (if (:decode-models *api-context*)
        (st/decode terms-of-service-spec res st/string-transformer)
        res))))
