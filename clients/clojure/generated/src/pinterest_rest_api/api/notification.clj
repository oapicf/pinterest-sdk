(ns pinterest-rest-api.api.notification
...
(defn-spec notification-post-with-http-info any?
  "Receive notifications from external partners.
  Used by third-party partners to send notifications to Pinterest. These notifications could be specific for your use-case or generic notification that are accepted by Pinterests' systems. This API is gated and you need to request access to this feature."
  [notification-post-request notification-post-request]
  (check-required-params notification-post-request)
  (call-api "/notifications" :post
            {:path-params   {}
             :header-params {}
             :query-params  {}
             :form-params   {}
             :body-param    notification-post-request
             :content-types ["application/json"]
             :accepts       ["application/json"]
             :auth-names    ["pinterest_oauth2" "client_credentials"]}))

(defn-spec notification-post notification-response-spec
  "Receive notifications from external partners.
  Used by third-party partners to send notifications to Pinterest. These notifications could be specific for your use-case or generic notification that are accepted by Pinterests' systems. This API is gated and you need to request access to this feature."
  [notification-post-request notification-post-request]
  (let [res (:data (notification-post-with-http-info notification-post-request))]
    (if (:decode-models *api-context*)
       (st/decode notification-response-spec res st/string-transformer)
       res)))
