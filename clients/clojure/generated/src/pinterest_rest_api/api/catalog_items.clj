(ns pinterest-rest-api.api.catalog-items
...
- The item UPSERT operation is restricted to users without a feed data source. If you plan to migrate item ingestion from feeds to the API, please reach out to your partner manager or via the Help Center to get assistance."
  ([catalogs-items-batch-post-request catalogs-items-batch-post-request, ] (items-batch-post-with-http-info catalogs-items-batch-post-request nil))
  ([catalogs-items-batch-post-request catalogs-items-batch-post-request, {:keys [ad_account_id]} (s/map-of keyword? any?)]
   (check-required-params catalogs-items-batch-post-request)
   (call-api "/catalogs/items/batch" :post
             {:path-params   {}
              :header-params {}
              :query-params  {"ad_account_id" ad_account_id }
              :form-params   {}
              :body-param    catalogs-items-batch-post-request
...
If you require access, please reach out to your partner manager.
- The item UPSERT operation is restricted to users without a feed data source. If you plan to migrate item ingestion from feeds to the API, please reach out to your partner manager or via the Help Center to get assistance."
  ([catalogs-items-batch-post-request catalogs-items-batch-post-request, ] (items-batch-post catalogs-items-batch-post-request nil))
  ([catalogs-items-batch-post-request catalogs-items-batch-post-request, optional-params any?]
   (let [res (:data (items-batch-post-with-http-info catalogs-items-batch-post-request optional-params))]
     (if (:decode-models *api-context*)
        (st/decode catalogs-items-batch-spec res st/string-transformer)
        res))))
...
(defn-spec items-post items-post-200-response-spec
  "Get catalogs items (POST)
  Get the items of the catalog owned by the \"operation user_account\". [See detailed documentation here.](/docs/api-features/shopping-overview/#Update%20items%20in%20batch)
- By default, the \"operation user_account\" is the token user_account.
...
If you require access, please reach out to your partner manager."
  ...
  ([catalogs-items-request catalogs-items-request, optional-params any?]
   (let [res (:data (items-post-with-http-info catalogs-items-request optional-params))]
     (if (:decode-models *api-context*)
        (st/decode items-post-200-response-spec res st/string-transformer)
        res))))
