(ns pinterest-rest-api.specs.local-store-batch-update
...
(def local-store-batch-update-data
  {
...
(def local-store-batch-update-spec
  (ds/spec
    {:name ::local-store-batch-update
     :spec local-store-batch-update-data}))
