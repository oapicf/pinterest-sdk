(ns pinterest-rest-api.specs.customer-list-upload-response
...
(def customer-list-upload-response-data
  {
...
(def customer-list-upload-response-spec
  (ds/spec
    {:name ::customer-list-upload-response
     :spec customer-list-upload-response-data}))
