(ns pinterest-rest-api.specs.ad-group-create-create
...
(def ad-group-create-create-data
  {
...
(def ad-group-create-create-spec
  (ds/spec
    {:name ::ad-group-create-create
     :spec ad-group-create-create-data}))
