(ns pinterest-rest-api.specs.product-group-promotion-create-request-element
...
(def product-group-promotion-create-request-element-data
  {
   (ds/opt :id) string?
...
(def product-group-promotion-create-request-element-spec
  (ds/spec
    {:name ::product-group-promotion-create-request-element
     :spec product-group-promotion-create-request-element-data}))
