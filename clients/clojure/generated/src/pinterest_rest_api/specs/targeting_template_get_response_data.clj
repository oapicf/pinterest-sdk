(ns pinterest-rest-api.specs.targeting-template-get-response-data
...
(def targeting-template-get-response-data-data
  {
   (ds/opt :name) string?
...
(def targeting-template-get-response-data-spec
  (ds/spec
    {:name ::targeting-template-get-response-data
     :spec targeting-template-get-response-data-data}))
