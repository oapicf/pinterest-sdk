(ns pinterest-rest-api.specs.catalogs-feed-create-request-schema
...
(def catalogs-feed-create-request-schema-data
  {
...
(def catalogs-feed-create-request-schema-spec
  (ds/spec
    {:name ::catalogs-feed-create-request-schema
     :spec catalogs-feed-create-request-schema-data}))
