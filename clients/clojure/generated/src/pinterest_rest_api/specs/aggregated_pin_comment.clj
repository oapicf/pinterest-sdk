(ns pinterest-rest-api.specs.aggregated-pin-comment
...
(def aggregated-pin-comment-data
  {
...
(def aggregated-pin-comment-spec
  (ds/spec
    {:name ::aggregated-pin-comment
     :spec aggregated-pin-comment-data}))
