(ns pinterest-rest-api.specs.catalogs-base-filter-keys
...
(def catalogs-base-filter-keys-data
  {
...
(def catalogs-base-filter-keys-spec
  (ds/spec
    {:name ::catalogs-base-filter-keys
     :spec catalogs-base-filter-keys-data}))
