(ns pinterest-rest-api.specs.catalogs-hotel-feeds-create-request
...
(def catalogs-hotel-feeds-create-request-data
  {
...
(def catalogs-hotel-feeds-create-request-spec
  (ds/spec
    {:name ::catalogs-hotel-feeds-create-request
     :spec catalogs-hotel-feeds-create-request-data}))
