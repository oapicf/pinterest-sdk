(ns pinterest-rest-api.specs.feeds-update-request
...
(def feeds-update-request-spec
  (ds/spec
    {:name ::feeds-update-request
     :spec feeds-update-request-data}))
