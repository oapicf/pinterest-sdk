(ns pinterest-rest-api.specs.item-response-one-of
...
(def item-response-one-of-spec
  (ds/spec
    {:name ::item-response-one-of
     :spec item-response-one-of-data}))
