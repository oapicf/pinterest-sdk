(ns pinterest-rest-api.specs.schedules-create-200-response-inner-data
...
(def schedules-create-200-response-inner-data-data
  {
...
(def schedules-create-200-response-inner-data-spec
  (ds/spec
    {:name ::schedules-create-200-response-inner-data
     :spec schedules-create-200-response-inner-data-data}))
