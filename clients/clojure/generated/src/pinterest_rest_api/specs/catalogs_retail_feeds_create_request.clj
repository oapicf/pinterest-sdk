(ns pinterest-rest-api.specs.catalogs-retail-feeds-create-request
...
(def catalogs-retail-feeds-create-request-data
  {
   ...
   (ds/req :default_locale) catalogs-creative-assets-feeds-create-request-default-locale-spec
...
(def catalogs-retail-feeds-create-request-spec
  (ds/spec
    {:name ::catalogs-retail-feeds-create-request
     :spec catalogs-retail-feeds-create-request-data}))
