(ns pinterest-rest-api.specs.feeds-create-request
...
(def feeds-create-request-spec
  (ds/spec
    {:name ::feeds-create-request
     :spec feeds-create-request-data}))
