(ns pinterest-rest-api.specs.catalogs-creative-assets-feed
...
(def catalogs-creative-assets-feed-data
  {
...
(def catalogs-creative-assets-feed-spec
  (ds/spec
    {:name ::catalogs-creative-assets-feed
     :spec catalogs-creative-assets-feed-data}))
