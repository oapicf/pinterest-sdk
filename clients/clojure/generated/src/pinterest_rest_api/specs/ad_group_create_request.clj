(ns pinterest-rest-api.specs.ad-group-create-request
...
(def ad-group-create-request-data
  {
   ...
   (ds/req :name) string?
   (ds/opt :optimization_goal_metadata) any?
...
(def ad-group-create-request-spec
  (ds/spec
    {:name ::ad-group-create-request
     :spec ad-group-create-request-data}))
