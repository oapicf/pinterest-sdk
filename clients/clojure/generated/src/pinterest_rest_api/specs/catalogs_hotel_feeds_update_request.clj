(ns pinterest-rest-api.specs.catalogs-hotel-feeds-update-request
...
(def catalogs-hotel-feeds-update-request-data
  {
...
(def catalogs-hotel-feeds-update-request-spec
  (ds/spec
    {:name ::catalogs-hotel-feeds-update-request
     :spec catalogs-hotel-feeds-update-request-data}))
