(ns pinterest-rest-api.specs.campaign-batch-update-item
...
(def campaign-batch-update-item-data
  {
   ...
   (ds/opt :name) string?
   (ds/opt :objective_type) conversion-objective-type-spec
...
(def campaign-batch-update-item-spec
  (ds/spec
    {:name ::campaign-batch-update-item
     :spec campaign-batch-update-item-data}))
