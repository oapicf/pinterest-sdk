(ns pinterest-rest-api.specs.integration-metadata-create
...
(def integration-metadata-create-data
  {
...
(def integration-metadata-create-spec
  (ds/spec
    {:name ::integration-metadata-create
     :spec integration-metadata-create-data}))
