...
(def catalogs-creative-assets-product-group-filter-keys-data
  {
...
(def catalogs-creative-assets-product-group-filter-keys-spec
  (ds/spec
    {:name ::catalogs-creative-assets-product-group-filter-keys
     :spec catalogs-creative-assets-product-group-filter-keys-data}))
