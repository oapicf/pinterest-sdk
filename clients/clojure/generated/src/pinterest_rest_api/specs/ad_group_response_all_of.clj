(ns pinterest-rest-api.specs.ad-group-response-all-of
...
(def ad-group-response-all-of-data
  {
   (ds/opt :name) string?
...
(def ad-group-response-all-of-spec
  (ds/spec
    {:name ::ad-group-response-all-of
     :spec ad-group-response-all-of-data}))
