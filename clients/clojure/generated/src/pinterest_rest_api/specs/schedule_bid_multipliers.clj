(ns pinterest-rest-api.specs.schedule-bid-multipliers
...
(def schedule-bid-multipliers-data
  {
...
(def schedule-bid-multipliers-spec
  (ds/spec
    {:name ::schedule-bid-multipliers
     :spec schedule-bid-multipliers-data}))
