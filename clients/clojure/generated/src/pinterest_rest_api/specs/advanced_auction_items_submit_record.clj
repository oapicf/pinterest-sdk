(ns pinterest-rest-api.specs.advanced-auction-items-submit-record
...
(def advanced-auction-items-submit-record-spec
  (ds/spec
    {:name ::advanced-auction-items-submit-record
     :spec advanced-auction-items-submit-record-data}))
