...
(def product-group-promotion-data
  {
   ...
   (ds/opt :collections_header_type) collections-header-type-spec
   ...
   (ds/opt :customizable_cta_type) product-group-promotion-customizable-cta-type-spec
   ...
   (ds/opt :is_image_auto_resizing) boolean?
   (ds/opt :is_mdl) boolean?
   (ds/opt :parent_id) string?
   (ds/opt :preferred_media_type) preferred-media-type-spec
