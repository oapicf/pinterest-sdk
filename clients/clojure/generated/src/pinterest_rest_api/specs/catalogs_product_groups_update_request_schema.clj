(ns pinterest-rest-api.specs.catalogs-product-groups-update-request-schema
...
(def catalogs-product-groups-update-request-schema-data
  {
...
(def catalogs-product-groups-update-request-schema-spec
  (ds/spec
    {:name ::catalogs-product-groups-update-request-schema
     :spec catalogs-product-groups-update-request-schema-data}))
