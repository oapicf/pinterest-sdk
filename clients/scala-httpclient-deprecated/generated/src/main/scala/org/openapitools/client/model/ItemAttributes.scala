...
case class ItemAttributes (
  ...
  additionalImageLink: Option[List[String]] = None,
  ...
  averageReviewRating: Option[Number] = None,
  ...
  numberOfRatings: Option[Integer] = None,
  // The number of reviews available for the item.
  numberOfReviews: Option[Integer] = None,
