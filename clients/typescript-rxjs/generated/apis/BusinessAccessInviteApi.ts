...
export class BusinessAccessInviteApi extends BaseAPI {
     ...
     */
    cancelInvitesOrRequests({ businessId, cancelInvitesRequest }: CancelInvitesOrRequestsRequest): Observable<CancelInvitesResponse>
    cancelInvitesOrRequests({ businessId, cancelInvitesRequest }: CancelInvitesOrRequestsRequest, opts?: OperationOpts): Observable<AjaxResponse<CancelInvitesResponse>>
    cancelInvitesOrRequests({ businessId, cancelInvitesRequest }: CancelInvitesOrRequestsRequest, opts?: OperationOpts): Observable<CancelInvitesResponse | AjaxResponse<CancelInvitesResponse>> {
        throwIfNullOrUndefined(businessId, 'businessId', 'cancelInvitesOrRequests');
        throwIfNullOrUndefined(cancelInvitesRequest, 'cancelInvitesRequest', 'cancelInvitesOrRequests');
        ...
        return this.request<CancelInvitesResponse>({
