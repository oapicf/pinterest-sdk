...
export class CatalogReportsApi extends BaseAPI {
     ...
     * List report stats
     */
    reportsStats({ parameters, adAccountId, bookmark, pageSize }: ReportsStatsRequest): Observable<ReportsStats200Response>
    reportsStats({ parameters, adAccountId, bookmark, pageSize }: ReportsStatsRequest, opts?: OperationOpts): Observable<AjaxResponse<ReportsStats200Response>>
    reportsStats({ parameters, adAccountId, bookmark, pageSize }: ReportsStatsRequest, opts?: OperationOpts): Observable<ReportsStats200Response | AjaxResponse<ReportsStats200Response>> {
