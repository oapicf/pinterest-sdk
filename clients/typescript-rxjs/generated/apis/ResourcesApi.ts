...
export class ResourcesApi extends BaseAPI {
     ...
     */
    targetingOptionsGet({ targetingType, clientId, oauthSignature, timestamp }: TargetingOptionsGetRequest): Observable<Array<object>>
    targetingOptionsGet({ targetingType, clientId, oauthSignature, timestamp }: TargetingOptionsGetRequest, opts?: OperationOpts): Observable<AjaxResponse<Array<object>>>
    targetingOptionsGet({ targetingType, clientId, oauthSignature, timestamp }: TargetingOptionsGetRequest, opts?: OperationOpts): Observable<Array<object> | AjaxResponse<Array<object>>> {
