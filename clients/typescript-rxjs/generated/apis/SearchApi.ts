...
export class SearchApi extends BaseAPI {
     ...
     * Search user\'s Pins
     */
    searchUserPinsList({ query: queryAlias, adAccountId, bookmark }: SearchUserPinsListRequest): Observable<SearchUserPinsList200Response>
    searchUserPinsList({ query: queryAlias, adAccountId, bookmark }: SearchUserPinsListRequest, opts?: OperationOpts): Observable<AjaxResponse<SearchUserPinsList200Response>>
    searchUserPinsList({ query: queryAlias, adAccountId, bookmark }: SearchUserPinsListRequest, opts?: OperationOpts): Observable<SearchUserPinsList200Response | AjaxResponse<SearchUserPinsList200Response>> {
        ...
        return this.request<SearchUserPinsList200Response>({
            url: '/search/pins',
            method: 'GET',
            headers,
            query,
