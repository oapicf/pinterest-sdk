...
export class BusinessAccessAssetsApi extends BaseAPI {
     ...
     */
    businessAssetMembersGet({ businessId, assetId, fetchSystemUsers, bookmark, pageSize, startIndex }: BusinessAssetMembersGetRequest): Observable<BusinessAssetMembersGet200Response>
    businessAssetMembersGet({ businessId, assetId, fetchSystemUsers, bookmark, pageSize, startIndex }: BusinessAssetMembersGetRequest, opts?: OperationOpts): Observable<AjaxResponse<BusinessAssetMembersGet200Response>>
    businessAssetMembersGet({ businessId, assetId, fetchSystemUsers, bookmark, pageSize, startIndex }: BusinessAssetMembersGetRequest, opts?: OperationOpts): Observable<BusinessAssetMembersGet200Response | AjaxResponse<BusinessAssetMembersGet200Response>> {
