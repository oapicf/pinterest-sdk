...
export class BillingApi extends BaseAPI {
     ...
     */
    billingInvoicesGet({ adAccountId, bookmark, pageSize, sort, order, status, documentType, startDueDate, endDueDate }: BillingInvoicesGetRequest): Observable<BillingInvoicesGet200Response>
    billingInvoicesGet({ adAccountId, bookmark, pageSize, sort, order, status, documentType, startDueDate, endDueDate }: BillingInvoicesGetRequest, opts?: OperationOpts): Observable<AjaxResponse<BillingInvoicesGet200Response>>
    billingInvoicesGet({ adAccountId, bookmark, pageSize, sort, order, status, documentType, startDueDate, endDueDate }: BillingInvoicesGetRequest, opts?: OperationOpts): Observable<BillingInvoicesGet200Response | AjaxResponse<BillingInvoicesGet200Response>> {
