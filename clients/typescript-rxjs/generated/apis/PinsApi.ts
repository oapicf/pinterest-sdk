...
export class PinsApi extends BaseAPI {
     ...
     * Delete Pin
     */
    pinsDelete({ pinId, adAccountId }: PinsDeleteRequest): Observable<Pin>
    pinsDelete({ pinId, adAccountId }: PinsDeleteRequest, opts?: OperationOpts): Observable<AjaxResponse<Pin>>
    pinsDelete({ pinId, adAccountId }: PinsDeleteRequest, opts?: OperationOpts): Observable<Pin | AjaxResponse<Pin>> {
     ...
     * List Pins
     */
    pinsList({ pinFilter, pinMetrics, includeProtectedPins, pinType, creativeTypes, adAccountId, domain, domains, includeProductTagObj, bookmark, pageSize }: PinsListRequest): Observable<PinsList200Response>
    pinsList({ pinFilter, pinMetrics, includeProtectedPins, pinType, creativeTypes, adAccountId, domain, domains, includeProductTagObj, bookmark, pageSize }: PinsListRequest, opts?: OperationOpts): Observable<AjaxResponse<PinsList200Response>>
    pinsList({ pinFilter, pinMetrics, includeProtectedPins, pinType, creativeTypes, adAccountId, domain, domains, includeProductTagObj, bookmark, pageSize }: PinsListRequest, opts?: OperationOpts): Observable<PinsList200Response | AjaxResponse<PinsList200Response>> {
        ...
        if (domains != null) { query['domains'] = domains; }
        if (includeProductTagObj != null) { query['include_product_tag_obj'] = includeProductTagObj; }
     ...
     * Save Pin
     */
    pinsSave({ pinId, pinsSaveRequestCreate, adAccountId }: PinsSaveRequest): Observable<Pin>
    pinsSave({ pinId, pinsSaveRequestCreate, adAccountId }: PinsSaveRequest, opts?: OperationOpts): Observable<AjaxResponse<Pin>>
    pinsSave({ pinId, pinsSaveRequestCreate, adAccountId }: PinsSaveRequest, opts?: OperationOpts): Observable<Pin | AjaxResponse<Pin>> {
        throwIfNullOrUndefined(pinId, 'pinId', 'pinsSave');
        throwIfNullOrUndefined(pinsSaveRequestCreate, 'pinsSaveRequestCreate', 'pinsSave');
