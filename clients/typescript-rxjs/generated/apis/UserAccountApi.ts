...
export class UserAccountApi extends BaseAPI {
     ...
     * Verify website
     */
    verifyWebsiteUpdate({ userWebsiteVerifyRequest }: VerifyWebsiteUpdateRequest): Observable<UserWebsiteSummary>
    verifyWebsiteUpdate({ userWebsiteVerifyRequest }: VerifyWebsiteUpdateRequest, opts?: OperationOpts): Observable<AjaxResponse<UserWebsiteSummary>>
    verifyWebsiteUpdate({ userWebsiteVerifyRequest }: VerifyWebsiteUpdateRequest, opts?: OperationOpts): Observable<UserWebsiteSummary | AjaxResponse<UserWebsiteSummary>> {
     ...
     */
    websiteVerificationGet(): Observable<UserWebsiteVerificationCode>
    websiteVerificationGet(opts?: OperationOpts): Observable<AjaxResponse<UserWebsiteVerificationCode>>
    websiteVerificationGet(opts?: OperationOpts): Observable<UserWebsiteVerificationCode | AjaxResponse<UserWebsiteVerificationCode>> {
        const headers: HttpHeaders = {
            // oauth required
            ...(this.configuration.accessToken != null
                ? { Authorization: typeof this.configuration.accessToken === 'function'
