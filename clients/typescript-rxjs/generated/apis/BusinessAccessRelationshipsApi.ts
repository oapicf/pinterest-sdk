...
export class BusinessAccessRelationshipsApi extends BaseAPI {
     ...
     */
    brandAccountsCreate({ businessHierarchyId, brandAccountsCreateRequest }: BrandAccountsCreateRequest): Observable<BrandAccountsCreate200Response>
    brandAccountsCreate({ businessHierarchyId, brandAccountsCreateRequest }: BrandAccountsCreateRequest, opts?: OperationOpts): Observable<AjaxResponse<BrandAccountsCreate200Response>>
    brandAccountsCreate({ businessHierarchyId, brandAccountsCreateRequest }: BrandAccountsCreateRequest, opts?: OperationOpts): Observable<BrandAccountsCreate200Response | AjaxResponse<BrandAccountsCreate200Response>> {
        throwIfNullOrUndefined(businessHierarchyId, 'businessHierarchyId', 'brandAccountsCreate');
        throwIfNullOrUndefined(brandAccountsCreateRequest, 'brandAccountsCreateRequest', 'brandAccountsCreate');
        ...
        return this.request<BrandAccountsCreate200Response>({
     ...
     */
    brandAccountsUpdate({ businessHierarchyId, brandAccountId, brandAccountsUpdateRequest }: BrandAccountsUpdateRequest): Observable<BrandAccountsCreate200Response>
    brandAccountsUpdate({ businessHierarchyId, brandAccountId, brandAccountsUpdateRequest }: BrandAccountsUpdateRequest, opts?: OperationOpts): Observable<AjaxResponse<BrandAccountsCreate200Response>>
    brandAccountsUpdate({ businessHierarchyId, brandAccountId, brandAccountsUpdateRequest }: BrandAccountsUpdateRequest, opts?: OperationOpts): Observable<BrandAccountsCreate200Response | AjaxResponse<BrandAccountsCreate200Response>> {
        ...
        throwIfNullOrUndefined(brandAccountsUpdateRequest, 'brandAccountsUpdateRequest', 'brandAccountsUpdate');
        ...
        return this.request<BrandAccountsCreate200Response>({
            url: '/business_access/business_hierarchy/{business_hierarchy_id}/brand_accounts/{brand_account_id}'.replace('{business_hierarchy_id}', encodeURI(businessHierarchyId)).replace('{brand_account_id}', encodeURI(brandAccountId)),
            method: 'PATCH',
            headers,
     ...
     */
    getBusinessMembers({ businessId, fetchSystemUsers, assetsSummary, businessRoles, memberIds, startIndex, bookmark, pageSize }: GetBusinessMembersRequest): Observable<GetBusinessMembers200Response>
    getBusinessMembers({ businessId, fetchSystemUsers, assetsSummary, businessRoles, memberIds, startIndex, bookmark, pageSize }: GetBusinessMembersRequest, opts?: OperationOpts): Observable<AjaxResponse<GetBusinessMembers200Response>>
    getBusinessMembers({ businessId, fetchSystemUsers, assetsSummary, businessRoles, memberIds, startIndex, bookmark, pageSize }: GetBusinessMembersRequest, opts?: OperationOpts): Observable<GetBusinessMembers200Response | AjaxResponse<GetBusinessMembers200Response>> {
     ...
     */
    systemUserUpdate({ businessId, systemUserId, systemUserUpdateRequest }: SystemUserUpdateRequest): Observable<void>
    systemUserUpdate({ businessId, systemUserId, systemUserUpdateRequest }: SystemUserUpdateRequest, opts?: OperationOpts): Observable<void | AjaxResponse<void>>
    systemUserUpdate({ businessId, systemUserId, systemUserUpdateRequest }: SystemUserUpdateRequest, opts?: OperationOpts): Observable<void | AjaxResponse<void>> {
        ...
        throwIfNullOrUndefined(systemUserUpdateRequest, 'systemUserUpdateRequest', 'systemUserUpdate');
