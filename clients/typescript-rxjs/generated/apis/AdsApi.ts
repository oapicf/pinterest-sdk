...
export class AdsApi extends BaseAPI {
     ...
     */
    adTargetingAnalyticsGet({ adAccountId, adIds, startDate, endDate, targetingTypes, columns, granularity, clickWindowDays, engagementWindowDays, viewWindowDays, conversionReportTime, attributionTypes, reportingTimezone }: AdTargetingAnalyticsGetRequest): Observable<MetricsResponse>
    adTargetingAnalyticsGet({ adAccountId, adIds, startDate, endDate, targetingTypes, columns, granularity, clickWindowDays, engagementWindowDays, viewWindowDays, conversionReportTime, attributionTypes, reportingTimezone }: AdTargetingAnalyticsGetRequest, opts?: OperationOpts): Observable<AjaxResponse<MetricsResponse>>
    adTargetingAnalyticsGet({ adAccountId, adIds, startDate, endDate, targetingTypes, columns, granularity, clickWindowDays, engagementWindowDays, viewWindowDays, conversionReportTime, attributionTypes, reportingTimezone }: AdTargetingAnalyticsGetRequest, opts?: OperationOpts): Observable<MetricsResponse | AjaxResponse<MetricsResponse>> {
     ...
     * Get ad analytics
     */
    adsAnalytics({ adAccountId, startDate, endDate, columns, granularity, adIds, clickWindowDays, engagementWindowDays, viewWindowDays, conversionReportTime, pinIds, campaignIds, reportingTimezone }: AdsAnalyticsRequest): Observable<Array<AdsAnalyticsResponseInner>>
    adsAnalytics({ adAccountId, startDate, endDate, columns, granularity, adIds, clickWindowDays, engagementWindowDays, viewWindowDays, conversionReportTime, pinIds, campaignIds, reportingTimezone }: AdsAnalyticsRequest, opts?: OperationOpts): Observable<AjaxResponse<Array<AdsAnalyticsResponseInner>>>
    adsAnalytics({ adAccountId, startDate, endDate, columns, granularity, adIds, clickWindowDays, engagementWindowDays, viewWindowDays, conversionReportTime, pinIds, campaignIds, reportingTimezone }: AdsAnalyticsRequest, opts?: OperationOpts): Observable<Array<AdsAnalyticsResponseInner> | AjaxResponse<Array<AdsAnalyticsResponseInner>>> {
