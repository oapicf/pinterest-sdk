...
export class KeywordsApi extends BaseAPI {
     ...
     */
    trendingKeywordsList({ region, trendType, interests, genders, ages, normalizeAgainstGroup, limit }: TrendingKeywordsListRequest): Observable<TrendingKeywordsResponse>
    trendingKeywordsList({ region, trendType, interests, genders, ages, normalizeAgainstGroup, limit }: TrendingKeywordsListRequest, opts?: OperationOpts): Observable<AjaxResponse<TrendingKeywordsResponse>>
    trendingKeywordsList({ region, trendType, interests, genders, ages, normalizeAgainstGroup, limit }: TrendingKeywordsListRequest, opts?: OperationOpts): Observable<TrendingKeywordsResponse | AjaxResponse<TrendingKeywordsResponse>> {
