...
export class KeywordsApi extends BaseAPI {
     ...
     * Get keywords
     */
    keywordsGet({ adAccountId, campaignId, adGroupId, adGroupIds, matchTypes, pageSize, bookmark }: KeywordsGetRequest): Observable<KeywordsGet200Response>
    keywordsGet({ adAccountId, campaignId, adGroupId, adGroupIds, matchTypes, pageSize, bookmark }: KeywordsGetRequest, opts?: OperationOpts): Observable<AjaxResponse<KeywordsGet200Response>>
    keywordsGet({ adAccountId, campaignId, adGroupId, adGroupIds, matchTypes, pageSize, bookmark }: KeywordsGetRequest, opts?: OperationOpts): Observable<KeywordsGet200Response | AjaxResponse<KeywordsGet200Response>> {
     ...
     */
    trendingKeywordsList({ region, trendType, interests, genders, ages, includeKeywords, normalizeAgainstGroup, limit, includePrediction, includeDemographics }: TrendingKeywordsListRequest): Observable<TrendingKeywordsResponse>
    trendingKeywordsList({ region, trendType, interests, genders, ages, includeKeywords, normalizeAgainstGroup, limit, includePrediction, includeDemographics }: TrendingKeywordsListRequest, opts?: OperationOpts): Observable<AjaxResponse<TrendingKeywordsResponse>>
    trendingKeywordsList({ region, trendType, interests, genders, ages, includeKeywords, normalizeAgainstGroup, limit, includePrediction, includeDemographics }: TrendingKeywordsListRequest, opts?: OperationOpts): Observable<TrendingKeywordsResponse | AjaxResponse<TrendingKeywordsResponse>> {
        ...
        if (includePrediction != null) { query['include_prediction'] = includePrediction; }
