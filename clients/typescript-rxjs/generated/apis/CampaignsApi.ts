...
export class CampaignsApi extends BaseAPI {
     ...
     * Get pins analytics
     */
    adPinsAnalytics({ adAccountId, campaignId, pinIds, startDate, endDate, columns, granularity, clickWindowDays, engagementWindowDays, viewWindowDays, conversionReportTime }: AdPinsAnalyticsRequest): Observable<Array<AdPinAnalytics>>
    adPinsAnalytics({ adAccountId, campaignId, pinIds, startDate, endDate, columns, granularity, clickWindowDays, engagementWindowDays, viewWindowDays, conversionReportTime }: AdPinsAnalyticsRequest, opts?: OperationOpts): Observable<AjaxResponse<Array<AdPinAnalytics>>>
    adPinsAnalytics({ adAccountId, campaignId, pinIds, startDate, endDate, columns, granularity, clickWindowDays, engagementWindowDays, viewWindowDays, conversionReportTime }: AdPinsAnalyticsRequest, opts?: OperationOpts): Observable<Array<AdPinAnalytics> | AjaxResponse<Array<AdPinAnalytics>>> {
     ...
     */
    campaignsAnalytics({ adAccountId, startDate, endDate, campaignIds, columns, granularity, clickWindowDays, engagementWindowDays, viewWindowDays, conversionReportTime, aggregateReportRows, reportingTimezone }: CampaignsAnalyticsRequest): Observable<Array<CampaignsAnalyticsResponseInner>>
    campaignsAnalytics({ adAccountId, startDate, endDate, campaignIds, columns, granularity, clickWindowDays, engagementWindowDays, viewWindowDays, conversionReportTime, aggregateReportRows, reportingTimezone }: CampaignsAnalyticsRequest, opts?: OperationOpts): Observable<AjaxResponse<Array<CampaignsAnalyticsResponseInner>>>
    campaignsAnalytics({ adAccountId, startDate, endDate, campaignIds, columns, granularity, clickWindowDays, engagementWindowDays, viewWindowDays, conversionReportTime, aggregateReportRows, reportingTimezone }: CampaignsAnalyticsRequest, opts?: OperationOpts): Observable<Array<CampaignsAnalyticsResponseInner> | AjaxResponse<Array<CampaignsAnalyticsResponseInner>>> {
