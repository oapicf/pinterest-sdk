...
export class AdGroupsApi extends BaseAPI {
     ...
     */
    adGroupsAnalytics({ adAccountId, startDate, endDate, adGroupIds, columns, granularity, clickWindowDays, engagementWindowDays, viewWindowDays, conversionReportTime, aggregateReportRows, reportingTimezone }: AdGroupsAnalyticsRequest): Observable<Array<AdGroupsAnalyticsResponseInner>>
    adGroupsAnalytics({ adAccountId, startDate, endDate, adGroupIds, columns, granularity, clickWindowDays, engagementWindowDays, viewWindowDays, conversionReportTime, aggregateReportRows, reportingTimezone }: AdGroupsAnalyticsRequest, opts?: OperationOpts): Observable<AjaxResponse<Array<AdGroupsAnalyticsResponseInner>>>
    adGroupsAnalytics({ adAccountId, startDate, endDate, adGroupIds, columns, granularity, clickWindowDays, engagementWindowDays, viewWindowDays, conversionReportTime, aggregateReportRows, reportingTimezone }: AdGroupsAnalyticsRequest, opts?: OperationOpts): Observable<Array<AdGroupsAnalyticsResponseInner> | AjaxResponse<Array<AdGroupsAnalyticsResponseInner>>> {
    ...
    adGroupsAudienceSizing({ adAccountId, adGroupAudienceSizingRequest }: AdGroupsAudienceSizingRequest, opts?: OperationOpts): Observable<AdGroupAudienceSizingResponse | AjaxResponse<AdGroupAudienceSizingResponse>> {
        ...
        throwIfNullOrUndefined(adGroupAudienceSizingRequest, 'adGroupAudienceSizingRequest', 'adGroupsAudienceSizing');
     ...
     */
    adGroupsTargetingAnalyticsGet({ adAccountId, adGroupIds, startDate, endDate, targetingTypes, columns, granularity, clickWindowDays, engagementWindowDays, viewWindowDays, conversionReportTime, attributionTypes, reportingTimezone }: AdGroupsTargetingAnalyticsGetRequest): Observable<MetricsResponse>
    adGroupsTargetingAnalyticsGet({ adAccountId, adGroupIds, startDate, endDate, targetingTypes, columns, granularity, clickWindowDays, engagementWindowDays, viewWindowDays, conversionReportTime, attributionTypes, reportingTimezone }: AdGroupsTargetingAnalyticsGetRequest, opts?: OperationOpts): Observable<AjaxResponse<MetricsResponse>>
    adGroupsTargetingAnalyticsGet({ adAccountId, adGroupIds, startDate, endDate, targetingTypes, columns, granularity, clickWindowDays, engagementWindowDays, viewWindowDays, conversionReportTime, attributionTypes, reportingTimezone }: AdGroupsTargetingAnalyticsGetRequest, opts?: OperationOpts): Observable<MetricsResponse | AjaxResponse<MetricsResponse>> {
