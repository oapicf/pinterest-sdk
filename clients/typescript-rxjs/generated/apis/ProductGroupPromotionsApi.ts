...
export class ProductGroupPromotionsApi extends BaseAPI {
     ...
     */
    productGroupsAnalytics({ adAccountId, startDate, endDate, productGroupIds, columns, granularity, clickWindowDays, engagementWindowDays, viewWindowDays, conversionReportTime, reportingTimezone }: ProductGroupsAnalyticsRequest): Observable<Array<ProductGroupAnalyticsResponseInner>>
    productGroupsAnalytics({ adAccountId, startDate, endDate, productGroupIds, columns, granularity, clickWindowDays, engagementWindowDays, viewWindowDays, conversionReportTime, reportingTimezone }: ProductGroupsAnalyticsRequest, opts?: OperationOpts): Observable<AjaxResponse<Array<ProductGroupAnalyticsResponseInner>>>
    productGroupsAnalytics({ adAccountId, startDate, endDate, productGroupIds, columns, granularity, clickWindowDays, engagementWindowDays, viewWindowDays, conversionReportTime, reportingTimezone }: ProductGroupsAnalyticsRequest, opts?: OperationOpts): Observable<Array<ProductGroupAnalyticsResponseInner> | AjaxResponse<Array<ProductGroupAnalyticsResponseInner>>> {
