...
public class LabelUpdateRequest   {
  private @Valid List<@Valid LabelUpdateItem> labels = new ArrayList<>();
  ...
  @JsonCreator
  public LabelUpdateRequest(
    @JsonProperty(required = true, value = "labels") List<@Valid LabelUpdateItem> labels
  ) {
    this.labels = labels;
  }
  ...
  @NotNull @Valid public List<@Valid LabelUpdateItem> getLabels() {
    return labels;
  }
  ...
  public LabelUpdateRequest removeLabelsItem(LabelUpdateItem labelsItem) {
