...
public class CatalogsCreativeAssetsAvailableFilterValues   {
  ...
  public CatalogsCreativeAssetsAvailableFilterValues(
    ...
    @JsonProperty(required = true, value = "filter_values") CatalogsCreativeAssetsFilterValuesMap filterValues
  ) {
  ...
  @ApiModelProperty(required = true, value = "")
  @JsonProperty(required = true, value = "filter_values")
  @NotNull @Valid public CatalogsCreativeAssetsFilterValuesMap getFilterValues() {
    return filterValues;
  }
