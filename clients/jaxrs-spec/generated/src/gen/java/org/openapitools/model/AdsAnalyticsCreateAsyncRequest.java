...
public class AdsAnalyticsCreateAsyncRequest   {
  ...
  private @Valid List<CampaignObjectiveType> campaignObjectiveTypes = new ArrayList<>();
  ...
  private @Valid List<@Valid CustomConversionEventMetrics> customConversionEventMetrics = new ArrayList<>();
  ...
  private @Valid List<AdAdsAnalyticsAsyncTargetingTypes> targetingTypes = new ArrayList<>();
  ...
  public AdsAnalyticsCreateAsyncRequest removeCampaignObjectiveTypesItem(CampaignObjectiveType campaignObjectiveTypesItem) {
  ...
  @Valid public List<@Valid CustomConversionEventMetrics> getCustomConversionEventMetrics() {
  ...
  public AdsAnalyticsCreateAsyncRequest removeCustomConversionEventMetricsItem(CustomConversionEventMetrics customConversionEventMetricsItem) {
    if (customConversionEventMetricsItem != null && this.customConversionEventMetrics != null) {
      this.customConversionEventMetrics.remove(customConversionEventMetricsItem);
    }
  ...
  public AdsAnalyticsCreateAsyncRequest removeTargetingTypesItem(AdAdsAnalyticsAsyncTargetingTypes targetingTypesItem) {
