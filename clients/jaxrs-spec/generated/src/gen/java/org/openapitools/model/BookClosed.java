...
public class BookClosed   {
  ...
  @JsonCreator
  public BookClosed(
    @JsonProperty(required = true, value = "conversion_metrics_ready") Boolean conversionMetricsReady,
    @JsonProperty(required = true, value = "non_conversion_metrics_ready") Boolean nonConversionMetricsReady
  ) {
  ...
  @JsonProperty(required = true, value = "conversion_metrics_ready")
  @NotNull public Boolean getConversionMetricsReady() {
  ...
  @JsonProperty(required = true, value = "non_conversion_metrics_ready")
  @NotNull public Boolean getNonConversionMetricsReady() {
