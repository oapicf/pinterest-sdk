...
public class CatalogsLocalStoresList200Response   {
  ...
  private @Valid List<@Valid LocalStore> items = new ArrayList<>();
  ...
  @JsonCreator
  public CatalogsLocalStoresList200Response(
    @JsonProperty(required = true, value = "items") List<@Valid LocalStore> items
  ) {
    this.items = items;
  }
  ...
  @NotNull @Valid public List<@Valid LocalStore> getItems() {
    return items;
  }
  ...
  public CatalogsLocalStoresList200Response removeItemsItem(LocalStore itemsItem) {
