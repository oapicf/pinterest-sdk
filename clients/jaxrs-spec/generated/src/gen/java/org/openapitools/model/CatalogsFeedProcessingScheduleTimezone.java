...
public enum CatalogsFeedProcessingScheduleTimezone {
  ...
  CatalogsFeedProcessingScheduleTimezone(String value) {
    this.value = value;
  }
     ...
     */
    public static CatalogsFeedProcessingScheduleTimezone fromString(String s) {
      for (CatalogsFeedProcessingScheduleTimezone b : CatalogsFeedProcessingScheduleTimezone.values()) {
  ...
  @JsonCreator
  public static CatalogsFeedProcessingScheduleTimezone fromValue(String value) {
    for (CatalogsFeedProcessingScheduleTimezone b : CatalogsFeedProcessingScheduleTimezone.values()) {
