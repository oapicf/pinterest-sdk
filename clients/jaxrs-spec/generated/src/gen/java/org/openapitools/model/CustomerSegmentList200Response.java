...
public class CustomerSegmentList200Response   {
  ...
  private @Valid List<@Valid CustomerSegment> items = new ArrayList<>();
  ...
  @JsonCreator
  public CustomerSegmentList200Response(
    @JsonProperty(required = true, value = "items") List<@Valid CustomerSegment> items
  ) {
    this.items = items;
  }
  ...
  @NotNull @Valid public List<@Valid CustomerSegment> getItems() {
    return items;
  }
  ...
  public CustomerSegmentList200Response removeItemsItem(CustomerSegment itemsItem) {
