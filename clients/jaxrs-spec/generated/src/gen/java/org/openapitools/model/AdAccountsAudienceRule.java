...
public class AdAccountsAudienceRule   {
  ...
  private @Valid List<String> adId = new ArrayList<>();
  private @Valid List<String> campaignId = new ArrayList<>();
  ...
  private @Valid List<AudienceObjectiveType> objectiveType = new ArrayList<>();
  private Integer percentage;
  private @Valid List<String> pinId = new ArrayList<>();
  private Boolean prefill;
  private Integer retentionDays;
  private @Valid List<String> seedId = new ArrayList<>();
  ...
  public AdAccountsAudienceRule removeAdIdItem(String adIdItem) {
  ...
  public AdAccountsAudienceRule removeCampaignIdItem(String campaignIdItem) {
  ...
  public AdAccountsAudienceRule removeEngagementDomainItem(String engagementDomainItem) {
  ...
  @Valid public EventData getEventData() {
    return eventData;
  }
  ...
  public AdAccountsAudienceRule removeObjectiveTypeItem(AudienceObjectiveType objectiveTypeItem) {
  ...
  public AdAccountsAudienceRule removePinIdItem(String pinIdItem) {
  ...
  public AdAccountsAudienceRule removeSeedIdItem(String seedIdItem) {
  ...
  public AdAccountsAudienceRule removeUrlItem(String urlItem) {
