...
public class AdGroupArrayResponse   {
  private @Valid List<@Valid AdGroupArrayResponseElement> items = new ArrayList<>();
  ...
  @JsonProperty("items")
  @Valid public List<@Valid AdGroupArrayResponseElement> getItems() {
    return items;
  }
  ...
  public AdGroupArrayResponse removeItemsItem(AdGroupArrayResponseElement itemsItem) {
