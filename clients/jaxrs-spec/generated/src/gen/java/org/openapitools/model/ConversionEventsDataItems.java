...
public class ConversionEventsDataItems   {
  ...
  public ConversionEventsDataItems(
    ...
    @JsonProperty(required = true, value = "user_data") ConversionEventsUserDataProperties userData
  ) {
  ...
  @Valid public ConversionEventAppInfo getAppInfo() {
    return appInfo;
  }
  ...
  @Valid public ConversionEventsDataItemsCustomData getCustomData() {
    return customData;
  }
  ...
  @Valid public ConversionEventDeviceInfo getDeviceInfo() {
    return deviceInfo;
  }
  ...
  @NotNull @Valid public ConversionEventsUserDataProperties getUserData() {
    return userData;
  }
