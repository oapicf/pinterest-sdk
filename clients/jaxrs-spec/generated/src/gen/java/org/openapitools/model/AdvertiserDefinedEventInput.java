...
public class AdvertiserDefinedEventInput   {
  ...
  @JsonCreator
  public AdvertiserDefinedEventInput(
    @JsonProperty(required = true, value = "mapped_conversion_type") AdvertiserDefinedEventMappingType mappedConversionType,
  ...
  @JsonProperty(required = true, value = "mapped_conversion_type")
  @NotNull public AdvertiserDefinedEventMappingType getMappedConversionType() {
