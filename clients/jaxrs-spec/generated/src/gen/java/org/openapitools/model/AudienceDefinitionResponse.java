...
@JsonTypeName("AudienceDefinitionResponse")
...
public class AudienceDefinitionResponse   {
  ...
  @JsonProperty("items")
  @Valid public List<@Valid AudienceDefinition> getItems() {
    return items;
  }
  ...
  public AudienceDefinitionResponse removeItemsItem(AudienceDefinition itemsItem) {
