...
@JsonTypeName("schedules_list_200_response")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaJAXRSSpecServerCodegen", date = "2026-08-30T09:54:53.087121019Z[Etc/UTC]", comments = "Generator version: 7.24.0")
public class SchedulesList200Response   {
  private String bookmark;
  private @Valid List<@Valid Schedule> items = new ArrayList<>();

  public SchedulesList200Response() {
  }

  @JsonCreator
  public SchedulesList200Response(
    @JsonProperty(required = true, value = "items") List<@Valid Schedule> items
  ) {
    this.items = items;
  }
  ...
  /**
   **/
  public SchedulesList200Response items(List<@Valid Schedule> items) {
    this.items = items;
    return this;
  }
  ...
  @NotNull @Valid public List<@Valid Schedule> getItems() {
    return items;
  }

  @JsonProperty(required = true, value = "items")
  public void setItems(List<@Valid Schedule> items) {
    this.items = items;
  }
  ...
  public SchedulesList200Response removeItemsItem(Schedule itemsItem) {
