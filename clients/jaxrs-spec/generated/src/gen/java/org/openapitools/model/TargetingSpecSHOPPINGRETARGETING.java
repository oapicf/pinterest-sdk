...
public class TargetingSpecShoppingRetargeting   {
  ...
  public TargetingSpecShoppingRetargeting removeTagTypesItem(Integer tagTypesItem) {
    if (tagTypesItem != null && this.tagTypes != null) {
      this.tagTypes.remove(tagTypesItem);
    }
