...
public class PerformancePlusCampaignSettings   {
  ...
  private @Valid List<String> pinnerListExclusions = new ArrayList<>();
  ...
  public PerformancePlusCampaignSettings removePinnerListExclusionsItem(String pinnerListExclusionsItem) {
    if (pinnerListExclusionsItem != null && this.pinnerListExclusions != null) {
      this.pinnerListExclusions.remove(pinnerListExclusionsItem);
    }
