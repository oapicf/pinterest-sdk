...
public class S3MultipartUploadData   {
  private @Valid List<@Valid S3FilePart> fileParts = new ArrayList<>();
  ...
  @Valid public List<@Valid S3FilePart> getFileParts() {
    return fileParts;
  }
  ...
  public S3MultipartUploadData removeFilePartsItem(S3FilePart filePartsItem) {
    if (filePartsItem != null && this.fileParts != null) {
      this.fileParts.remove(filePartsItem);
    }
