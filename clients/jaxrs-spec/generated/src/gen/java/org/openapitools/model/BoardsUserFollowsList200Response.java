...
public class BoardsUserFollowsList200Response   {
  ...
  @JsonCreator
  public BoardsUserFollowsList200Response(
    @JsonProperty(required = true, value = "items") List<@Valid Board> items
  ) {
    this.items = items;
  }
  ...
  public BoardsUserFollowsList200Response removeItemsItem(Board itemsItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.bookmark, boardsUserFollowsList200Response.bookmark) &&
        Objects.equals(this.items, boardsUserFollowsList200Response.items);
  }
