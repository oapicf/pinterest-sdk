...
public class LocalInventoryItemsGetCreate   {
  private @Valid List<@Valid ItemIdStoreCodePair> itemFilters = new ArrayList<>();
  ...
  @JsonCreator
  public LocalInventoryItemsGetCreate(
    @JsonProperty(required = true, value = "item_filters") List<@Valid ItemIdStoreCodePair> itemFilters
  ) {
  ...
  @JsonProperty(required = true, value = "item_filters")
  @NotNull @Valid  @Size(min=1,max=1000)public List<@Valid ItemIdStoreCodePair> getItemFilters() {
    return itemFilters;
  }
  ...
  public LocalInventoryItemsGetCreate removeItemFiltersItem(ItemIdStoreCodePair itemFiltersItem) {
    if (itemFiltersItem != null && this.itemFilters != null) {
      this.itemFilters.remove(itemFiltersItem);
    }
