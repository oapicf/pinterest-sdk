...
public class LeadFormsCreate200Response   {
  private @Valid List<@Valid LeadFormsCreate200ResponseItemsInner> items = new ArrayList<>();
  ...
  @JsonCreator
  public LeadFormsCreate200Response(
    @JsonProperty(required = true, value = "items") List<@Valid LeadFormsCreate200ResponseItemsInner> items
  ) {
    this.items = items;
  }
  ...
  @NotNull @Valid public List<@Valid LeadFormsCreate200ResponseItemsInner> getItems() {
    return items;
  }
  ...
  public LeadFormsCreate200Response removeItemsItem(LeadFormsCreate200ResponseItemsInner itemsItem) {
