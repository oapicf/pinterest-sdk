...
@JsonTypeName("CatalogsRetailAvailableFilterValues")
...
public class CatalogsRetailAvailableFilterValues   {
  ...
  public CatalogsRetailAvailableFilterValues(
    ...
    @JsonProperty(required = true, value = "filter_values") CatalogsRetailFilterValuesMap filterValues
  ) {
  ...
  @NotNull @Valid public CatalogsRetailFilterValuesMap getFilterValues() {
    return filterValues;
  }
