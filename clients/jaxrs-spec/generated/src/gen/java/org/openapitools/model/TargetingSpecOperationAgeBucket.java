...
public class TargetingSpecOperationAgeBucket   {
  ...
  private @Valid List<TargetingSpecAgeBucket> values = new ArrayList<>();
  ...
  public TargetingSpecOperationAgeBucket(
    ...
    @JsonProperty(required = true, value = "values") List<TargetingSpecAgeBucket> values
  ) {
    this.field = field;
  ...
  @NotNull public List<TargetingSpecAgeBucket> getValues() {
    return values;
  }
  ...
  public TargetingSpecOperationAgeBucket removeValuesItem(TargetingSpecAgeBucket valuesItem) {
