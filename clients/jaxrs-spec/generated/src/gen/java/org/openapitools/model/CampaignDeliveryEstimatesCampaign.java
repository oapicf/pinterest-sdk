...
public class CampaignDeliveryEstimatesCampaign   {
  private @Valid List<@Valid AdGroupDeliveryEstimates> adGroups = new ArrayList<>();
  ...
  @JsonCreator
  public CampaignDeliveryEstimatesCampaign(
    @JsonProperty(required = true, value = "ad_groups") List<@Valid AdGroupDeliveryEstimates> adGroups,
    @JsonProperty(required = true, value = "budget_duration_type") BudgetDurationType budgetDurationType,
    @JsonProperty(required = true, value = "objective_type") DeliveryEstimateObjectiveType objectiveType,
  ...
  @JsonProperty(required = true, value = "ad_groups")
  @NotNull @Valid  @Size(min=1,max=10)public List<@Valid AdGroupDeliveryEstimates> getAdGroups() {
    return adGroups;
  }
  ...
  public CampaignDeliveryEstimatesCampaign removeAdGroupsItem(AdGroupDeliveryEstimates adGroupsItem) {
  ...
  @JsonProperty(required = true, value = "budget_duration_type")
  @NotNull public BudgetDurationType getBudgetDurationType() {
  ...
  @NotNull public DeliveryEstimateObjectiveType getObjectiveType() {
