...
public class SearchPartnerPins200Response   {
  ...
  private @Valid List<@Valid SummaryPin> items = new ArrayList<>();
  ...
  @JsonCreator
  public SearchPartnerPins200Response(
    @JsonProperty(required = true, value = "items") List<@Valid SummaryPin> items
  ) {
    this.items = items;
  }
  ...
  @NotNull @Valid public List<@Valid SummaryPin> getItems() {
    return items;
  }
  ...
  public SearchPartnerPins200Response removeItemsItem(SummaryPin itemsItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.bookmark, searchPartnerPins200Response.bookmark) &&
        Objects.equals(this.items, searchPartnerPins200Response.items);
  }
