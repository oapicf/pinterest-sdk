...
public class CatalogsHotelAvailableFilterValues   {
  ...
  public CatalogsHotelAvailableFilterValues(
    ...
    @JsonProperty(required = true, value = "filter_values") CatalogsHotelFilterValuesMap filterValues
  ) {
  ...
  @NotNull @Valid public CatalogsHotelFilterValuesMap getFilterValues() {
    return filterValues;
  }
