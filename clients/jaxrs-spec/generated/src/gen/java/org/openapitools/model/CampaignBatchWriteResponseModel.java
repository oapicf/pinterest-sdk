...
public class CampaignBatchWriteResponseModel   {
  private @Valid List<@Valid CampaignBatchItem> items = new ArrayList<>();
  ...
  @JsonCreator
  public CampaignBatchWriteResponseModel(
    @JsonProperty(required = true, value = "items") List<@Valid CampaignBatchItem> items
  ) {
    this.items = items;
  }
  ...
  @NotNull @Valid public List<@Valid CampaignBatchItem> getItems() {
    return items;
  }
  ...
  public CampaignBatchWriteResponseModel removeItemsItem(CampaignBatchItem itemsItem) {
