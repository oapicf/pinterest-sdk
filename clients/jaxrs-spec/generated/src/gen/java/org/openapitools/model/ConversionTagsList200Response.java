...
public class ConversionTagsList200Response   {
  ...
  @JsonCreator
  public ConversionTagsList200Response(
    @JsonProperty(required = true, value = "items") List<@Valid ConversionTag> items
  ) {
    this.items = items;
  }
  ...
  @NotNull @Valid public List<@Valid ConversionTag> getItems() {
    return items;
  }
  ...
  public ConversionTagsList200Response removeItemsItem(ConversionTag itemsItem) {
