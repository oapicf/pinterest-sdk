...
public class FeedProcessingResultsList200Response   {
  ...
  @JsonProperty("items")
  @NotNull @Valid public List<@Valid CatalogsFeedProcessingResult> getItems() {
    return items;
  }
  ...
  public FeedProcessingResultsList200Response removeItemsItem(CatalogsFeedProcessingResult itemsItem) {
