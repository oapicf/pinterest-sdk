...
public class BoardMedia   {
  private @Valid String imageCoverUrl;
  private @Valid List<String> pinThumbnailUrls;
  ...
  public BoardMedia removePinThumbnailUrlsItem(String pinThumbnailUrlsItem) {
    if (pinThumbnailUrlsItem != null && this.pinThumbnailUrls != null) {
      this.pinThumbnailUrls.remove(pinThumbnailUrlsItem);
    }
