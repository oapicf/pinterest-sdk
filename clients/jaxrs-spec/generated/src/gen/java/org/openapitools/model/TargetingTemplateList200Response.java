...
public class TargetingTemplateList200Response   {
  ...
  private @Valid List<@Valid TargetingTemplate> items = new ArrayList<>();
  ...
  @JsonCreator
  public TargetingTemplateList200Response(
    @JsonProperty(required = true, value = "items") List<@Valid TargetingTemplate> items
  ) {
    this.items = items;
  }
  ...
  @NotNull @Valid public List<@Valid TargetingTemplate> getItems() {
    return items;
  }
  ...
  public TargetingTemplateList200Response removeItemsItem(TargetingTemplate itemsItem) {
