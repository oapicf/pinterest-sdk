...
public class BusinessAssetsGet200Response   {
  ...
  private @Valid List<@Valid BusinessAssets> items = new ArrayList<>();
  ...
  @JsonCreator
  public BusinessAssetsGet200Response(
    @JsonProperty(required = true, value = "items") List<@Valid BusinessAssets> items
  ) {
    this.items = items;
  }
  ...
  @NotNull @Valid public List<@Valid BusinessAssets> getItems() {
    return items;
  }
  ...
  public BusinessAssetsGet200Response removeItemsItem(BusinessAssets itemsItem) {
