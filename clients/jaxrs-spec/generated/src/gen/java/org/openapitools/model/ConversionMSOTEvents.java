...
public class ConversionMSOTEvents   {
  ...
  public enum AttributionModelEnum {
     ...
     */
    public static AttributionModelEnum fromString(String s) {
  ...
  public enum AttributionScopeEnum {
     ...
     * <a href="https://download.oracle.com/otndocs/jcp/jaxrs-2_0-fr-eval-spec/index.html">See JAX RS 2.0 Specification, section 3.2, p. 12</a>
     */
    public static AttributionScopeEnum fromString(String s) {
  ...
  public enum EventNameEnum {
     ...
     * <a href="https://download.oracle.com/otndocs/jcp/jaxrs-2_0-fr-eval-spec/index.html">See JAX RS 2.0 Specification, section 3.2, p. 12</a>
     */
    public static EventNameEnum fromString(String s) {
  ...
  public ConversionMSOTEvents(
    ...
    @JsonProperty(required = true, value = "attribution_scope") AttributionScopeEnum attributionScope,
    @JsonProperty(required = true, value = "event_id") String eventId,
    @JsonProperty(required = true, value = "event_name") EventNameEnum eventName,
  ...
  public ConversionMSOTEvents removeActionTimestampsItem(Long actionTimestampsItem) {
  ...
  @JsonProperty(required = true, value = "attribution_scope")
  @NotNull public AttributionScopeEnum getAttributionScope() {
  ...
  @NotNull public EventNameEnum getEventName() {
    return eventName;
  }
