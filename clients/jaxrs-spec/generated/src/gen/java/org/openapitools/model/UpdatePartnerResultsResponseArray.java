...
@JsonTypeName("UpdatePartnerResultsResponseArray")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaJAXRSSpecServerCodegen", date = "2024-11-05T02:21:14.931372798Z[Etc/UTC]", comments = "Generator version: 7.9.0")
public class UpdatePartnerResultsResponseArray   {
  private @Valid List<@Valid UpdatePartnerResultsResponseArrayItemsInner> items = new ArrayList<>();
  ...
  @JsonProperty("items")
  @Valid public List<@Valid UpdatePartnerResultsResponseArrayItemsInner> getItems() {
    return items;
  }
  ...
  public UpdatePartnerResultsResponseArray removeItemsItem(UpdatePartnerResultsResponseArrayItemsInner itemsItem) {
