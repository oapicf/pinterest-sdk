...
public class KeywordsUpdate   {
  private @Valid List<@Valid KeywordUpdateItem> keywords = new ArrayList<>();
  ...
  @Valid public List<@Valid KeywordUpdateItem> getKeywords() {
    return keywords;
  }
  ...
  public KeywordsUpdate removeKeywordsItem(KeywordUpdateItem keywordsItem) {
