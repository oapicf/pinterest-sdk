...
public class ConversionDeletionRequestList200Response   {
  ...
  private @Valid List<@Valid ConversionDeletionRequest> items = new ArrayList<>();
  ...
  @JsonCreator
  public ConversionDeletionRequestList200Response(
    @JsonProperty(required = true, value = "items") List<@Valid ConversionDeletionRequest> items
  ) {
    this.items = items;
  }
  ...
  @NotNull @Valid public List<@Valid ConversionDeletionRequest> getItems() {
    return items;
  }
  ...
  public ConversionDeletionRequestList200Response removeItemsItem(ConversionDeletionRequest itemsItem) {
