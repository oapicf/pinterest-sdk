...
public class ConversionEvents   {
  private @Valid List<@Valid ConversionApiResponseEventsItems> events = new ArrayList<>();
  ...
  @JsonCreator
  public ConversionEvents(
    @JsonProperty(required = true, value = "events") List<@Valid ConversionApiResponseEventsItems> events,
  ...
  @Valid public List<@Valid ConversionApiResponseEventsItems> getEvents() {
    return events;
  }
  ...
  public ConversionEvents removeEventsItem(ConversionApiResponseEventsItems eventsItem) {
