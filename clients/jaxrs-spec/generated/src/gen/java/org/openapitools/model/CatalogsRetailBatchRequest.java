...
public class CatalogsRetailBatchRequest   {
  ...
  private @Valid List<@Valid CatalogsRetailBatchRequestItemsItems> items = new ArrayList<>();
  ...
  public CatalogsRetailBatchRequest(
    ...
    @JsonProperty(required = true, value = "items") List<@Valid CatalogsRetailBatchRequestItemsItems> items,
  ...
  @NotNull @Valid  @Size(min=1,max=1000)public List<@Valid CatalogsRetailBatchRequestItemsItems> getItems() {
    return items;
  }
  ...
  public CatalogsRetailBatchRequest removeItemsItem(CatalogsRetailBatchRequestItemsItems itemsItem) {
