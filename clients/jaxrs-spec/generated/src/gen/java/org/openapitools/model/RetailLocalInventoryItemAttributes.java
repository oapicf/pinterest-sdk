...
public class RetailLocalInventoryItemAttributes   {
  ...
  @JsonCreator
  public RetailLocalInventoryItemAttributes(
    @JsonProperty(required = true, value = "availability") ItemAvailability availability,
    @JsonProperty(required = true, value = "price") String price
  ) {
  ...
  @NotNull public ItemAvailability getAvailability() {
    return availability;
  }
  ...
  @NotNull public String getPrice() {
    return price;
  }
