...
public class AdAccountsApi {
    ...
    public Response adGroupsAudienceSizing(@PathParam("ad_account_id") @Pattern(regexp="^\\d+$") @Size(max=18) @ApiParam("Unique identifier of an ad account.") String adAccountId,@Valid @NotNull AdGroupAudienceSizingRequest adGroupAudienceSizingRequest) {
        return Response.ok().entity("magic!").build();
    }
    ...
    public Response adGroupsCreate(@PathParam("ad_account_id") @Pattern(regexp="^\\d+$") @Size(max=18) @ApiParam("Unique identifier of an ad account.") String adAccountId,@Valid @NotNull List<@Valid AdGroupCreateRequest> adGroupCreateRequest) {
        return Response.ok().entity("magic!").build();
    }
    ...
    public Response adGroupsUpdate(@PathParam("ad_account_id") @Pattern(regexp="^\\d+$") @Size(max=18) @ApiParam("Unique identifier of an ad account.") String adAccountId,@Valid @NotNull List<@Valid AdGroupUpdateRequest> adGroupUpdateRequest) {
        return Response.ok().entity("magic!").build();
    }
    ...
    public Response adPinsAnalytics(@PathParam("ad_account_id") @Pattern(regexp="^\\d+$") @Size(max=18) @ApiParam("Unique identifier of an ad account.") String adAccountId,@QueryParam("campaign_id") @NotNull @Pattern(regexp="^\\d+$") @Size(max=18)  @ApiParam("Campaign Id to use to filter the results.")  String campaignId,@QueryParam("pin_ids") @NotNull @Size(min=1,max=100)  @ApiParam("List of Pin IDs.")  List<@Pattern(regexp = "^\\d+$")String> pinIds,@QueryParam("start_date") @NotNull  @ApiParam("Metric report start date (UTC). Format: YYYY-MM-DD. Cannot be more than 90 days back from today.")  LocalDate startDate,@QueryParam("end_date") @NotNull  @ApiParam("Metric report end date (UTC). Format: YYYY-MM-DD. Cannot be more than 90 days past start_date.")  LocalDate endDate,@QueryParam("columns") @NotNull  @ApiParam("Columns to retrieve, encoded as a comma-separated string. **NOTE**: Any metrics defined as MICRO_DOLLARS returns a value based on the advertiser profile&#39;s currency field. For USD,($1/1,000,000, or $0.000001 - one one-ten-thousandth of a cent). it&#39;s microdollars. Otherwise, it&#39;s in microunits of the advertiser&#39;s currency.&lt;br/&gt;For example, if the advertiser&#39;s currency is GBP (British pound sterling), all MICRO_DOLLARS fields will be in GBP microunits (1/1,000,000 British pound).&lt;br/&gt;If a column has no value, it may not be returned")  List<String> columns,@QueryParam("granularity") @NotNull  @ApiParam("TOTAL - metrics are aggregated over the specified date range.&lt;br&gt; DAY - metrics are broken down daily.&lt;br&gt; HOUR - metrics are broken down hourly.&lt;br&gt;WEEKLY - metrics are broken down weekly.&lt;br&gt;MONTHLY - metrics are broken down monthly")  Granularity granularity,@QueryParam("click_window_days") @DefaultValue("30")  @ApiParam("Number of days to use as the conversion attribution window for a pin click action. Applies to Pinterest Tag conversion metrics. Prior conversion tags use their defined attribution windows. If not specified, defaults to &#x60;30&#x60; days.")  Integer clickWindowDays,@QueryParam("engagement_window_days") @DefaultValue("30")  @ApiParam("Number of days to use as the conversion attribution window for an engagement action. Engagements include saves, closeups, link clicks, and carousel card swipes. Applies to Pinterest Tag conversion metrics. Prior conversion tags use their defined attribution windows. If not specified, defaults to &#x60;30&#x60; days.&lt;br&gt; &lt;strong&gt;Note:&lt;/strong&gt; This parameter no longer returns new data. However, you can still access historic data through &lt;strong&gt;Sept 30, 2027&lt;/strong&gt;.")  Integer engagementWindowDays,@QueryParam("view_window_days") @DefaultValue("1")  @ApiParam("Number of days to use as the conversion attribution window for a view action. Applies to Pinterest Tag conversion metrics. Prior conversion tags use their defined attribution windows. If not specified, defaults to &#x60;1&#x60; day.")  Integer viewWindowDays,@QueryParam("conversion_report_time") @DefaultValue("TIME_OF_AD_ACTION")  @ApiParam("The date by which the conversion metrics returned from this endpoint will be reported. There are two dates associated with a conversion event: the date that the user interacted with the ad, and the date that the user completed a conversion event.")  String conversionReportTime) {
        return Response.ok().entity("magic!").build();
    }
    ...
    public Response adsAnalytics(@PathParam("ad_account_id") @Pattern(regexp="^\\d+$") @Size(max=18) @ApiParam("Unique identifier of an ad account.") String adAccountId,@QueryParam("start_date") @NotNull  @ApiParam("Metric report start date (UTC). Format: YYYY-MM-DD. Cannot be more than 90 days back from today.")  LocalDate startDate,@QueryParam("end_date") @NotNull  @ApiParam("Metric report end date (UTC). Format: YYYY-MM-DD. Cannot be more than 90 days past start_date.")  LocalDate endDate,@QueryParam("columns") @NotNull  @ApiParam("Columns to retrieve, encoded as a comma-separated string. **NOTE**: Any metrics defined as MICRO_DOLLARS returns a value based on the advertiser profile&#39;s currency field. For USD,($1/1,000,000, or $0.000001 - one one-ten-thousandth of a cent). it&#39;s microdollars. Otherwise, it&#39;s in microunits of the advertiser&#39;s currency.&lt;br/&gt;For example, if the advertiser&#39;s currency is GBP (British pound sterling), all MICRO_DOLLARS fields will be in GBP microunits (1/1,000,000 British pound).&lt;br/&gt;If a column has no value, it may not be returned")  List<String> columns,@QueryParam("granularity") @NotNull  @ApiParam("TOTAL - metrics are aggregated over the specified date range.&lt;br&gt; DAY - metrics are broken down daily.&lt;br&gt; HOUR - metrics are broken down hourly.&lt;br&gt;WEEKLY - metrics are broken down weekly.&lt;br&gt;MONTHLY - metrics are broken down monthly")  Granularity granularity,@QueryParam("ad_ids") @Size(min=1,max=250)  @ApiParam("List of Ad Ids to use to filter the results.")  List<@Pattern(regexp = "^\\d+$")String> adIds,@QueryParam("click_window_days") @DefaultValue("30")  @ApiParam("Number of days to use as the conversion attribution window for a pin click action. Applies to Pinterest Tag conversion metrics. Prior conversion tags use their defined attribution windows. If not specified, defaults to &#x60;30&#x60; days.")  Integer clickWindowDays,@QueryParam("engagement_window_days") @DefaultValue("30")  @ApiParam("Number of days to use as the conversion attribution window for an engagement action. Engagements include saves, closeups, link clicks, and carousel card swipes. Applies to Pinterest Tag conversion metrics. Prior conversion tags use their defined attribution windows. If not specified, defaults to &#x60;30&#x60; days.&lt;br&gt; &lt;strong&gt;Note:&lt;/strong&gt; This parameter no longer returns new data. However, you can still access historic data through &lt;strong&gt;Sept 30, 2027&lt;/strong&gt;.")  Integer engagementWindowDays,@QueryParam("view_window_days") @DefaultValue("1")  @ApiParam("Number of days to use as the conversion attribution window for a view action. Applies to Pinterest Tag conversion metrics. Prior conversion tags use their defined attribution windows. If not specified, defaults to &#x60;1&#x60; day.")  Integer viewWindowDays,@QueryParam("conversion_report_time") @DefaultValue("TIME_OF_AD_ACTION")  @ApiParam("The date by which the conversion metrics returned from this endpoint will be reported. There are two dates associated with a conversion event: the date that the user interacted with the ad, and the date that the user completed a conversion event.")  String conversionReportTime,@QueryParam("pin_ids") @Size(min=1,max=100)  @ApiParam("List of Pin IDs.")  List<@Pattern(regexp = "^\\d+$")String> pinIds,@QueryParam("campaign_ids") @Size(min=1,max=250)  @ApiParam("List of Campaign Ids to use to filter the results.")  List<@Pattern(regexp = "^\\d+$")@Size(max = 18)String> campaignIds,@QueryParam("reporting_timezone")  @ApiParam("Specify the timezone to be applied for the reporting. This feature is currently in BETA and is not available to all users.")  ReportingTimeZone reportingTimezone) {
        return Response.ok().entity("magic!").build();
    }
    ...
    public Response adsCreate(@PathParam("ad_account_id") @Pattern(regexp="^\\d+$") @Size(max=18) @ApiParam("Unique identifier of an ad account.") String adAccountId,@Valid @NotNull List<@Valid AdCreateRequest> adCreateRequest) {
        return Response.ok().entity("magic!").build();
    }
    ...
    public Response adsList(@PathParam("ad_account_id") @Pattern(regexp="^\\d+$") @Size(max=18) @ApiParam("Unique identifier of an ad account.") String adAccountId,@QueryParam("campaign_ids") @Size(min=1,max=250)  @ApiParam("List of Campaign Ids to use to filter the results.")  List<@Pattern(regexp = "^\\d+$")@Size(max = 18)String> campaignIds,@QueryParam("ad_group_ids") @Size(min=1,max=250)  @ApiParam("List of Ad group Ids to use to filter the results.")  List<@Pattern(regexp = "^\\d+$")String> adGroupIds,@QueryParam("ad_ids") @Size(min=1,max=250)  @ApiParam("List of Ad Ids to use to filter the results.")  List<@Pattern(regexp = "^\\d+$")String> adIds,@QueryParam("entity_statuses")  @ApiParam("Entity status")  List<String> entityStatuses,@QueryParam("page_size") @Min(1) @Max(250) @DefaultValue("25")  @ApiParam("Maximum number of items to include in a single page of the response. See documentation on &lt;a href&#x3D;&#39;/docs/reference/pagination/&#39;&gt;Pagination&lt;/a&gt; for more information.")  Integer pageSize,@QueryParam("order")  @ApiParam("The order in which to sort the items returned: “ASCENDING” or “DESCENDING” by ID. Note that higher-value IDs are associated with more-recently added items.")  String order,@QueryParam("bookmark")  @ApiParam("Cursor used to fetch the next page of items")  String bookmark) {
        return Response.ok().entity("magic!").build();
    }
    ...
    public Response adsUpdate(@PathParam("ad_account_id") @Pattern(regexp="^\\d+$") @Size(max=18) @ApiParam("Unique identifier of an ad account.") String adAccountId,@Valid @NotNull List<@Valid AdUpdateRequest> adUpdateRequest) {
        return Response.ok().entity("magic!").build();
    }
    ...
    public Response analyticsCreateConversionProductReport(@PathParam("ad_account_id") @Pattern(regexp="^\\d+$") @Size(max=18) @ApiParam("Unique identifier of an ad account.") String adAccountId,@Valid @NotNull ConversionProductReportRequest conversionProductReportRequest) {
        return Response.ok().entity("magic!").build();
    }
    ...
    public Response audiencesList(@PathParam("ad_account_id") @Pattern(regexp="^\\d+$") @Size(max=18) @ApiParam("Unique identifier of an ad account.") String adAccountId,@QueryParam("bookmark")  @ApiParam("Cursor used to fetch the next page of items")  String bookmark,@QueryParam("order")  @ApiParam("The order in which to sort the items returned: “ASCENDING” or “DESCENDING” by ID. For received audiences, it is sorted by sharing event time. Note that higher-value IDs are associated with more-recently added items.")  String order,@QueryParam("page_size") @Min(1) @Max(250) @DefaultValue("25")  @ApiParam("Maximum number of items to include in a single page of the response. See documentation on &lt;a href&#x3D;&#39;/docs/reference/pagination/&#39;&gt;Pagination&lt;/a&gt; for more information.")  Integer pageSize,@QueryParam("ownership_type") @DefaultValue("OWNED")  @ApiParam("Filter audiences by ownership type.")  String ownershipType) {
        return Response.ok().entity("magic!").build();
    }
    ...
    public Response audiencesUpdate(@PathParam("ad_account_id") @Pattern(regexp="^\\d+$") @Size(max=18) @ApiParam("Unique identifier of an ad account.") String adAccountId,@PathParam("audience_id") @Pattern(regexp="^\\d+$") @Size(max=18) @ApiParam("Unique identifier of an audience") String audienceId,@Valid @NotNull AudienceUpdateRequest audienceUpdateRequest) {
        return Response.ok().entity("magic!").build();
    }
    ...
    public Response billingInvoicesGet(@PathParam("ad_account_id") @Pattern(regexp="^\\d+$") @Size(max=18) @ApiParam("Unique identifier of an ad account.") String adAccountId,@QueryParam("bookmark")  @ApiParam("Cursor used to fetch the next page of items")  String bookmark,@QueryParam("page_size") @Min(1) @Max(250) @DefaultValue("25")  @ApiParam("Maximum number of items to include in a single page of the response. See documentation on &lt;a href&#x3D;&#39;/docs/reference/pagination/&#39;&gt;Pagination&lt;/a&gt; for more information.")  Integer pageSize,@QueryParam("sort") @DefaultValue("DUE_DATE")  @ApiParam("Field of which to sort billing invoices")  String sort,@QueryParam("order")  @ApiParam("The order in which to sort the items returned: “ASCENDING” or “DESCENDING” by ID. Note that higher-value IDs are associated with more-recently added items.")  String order,@QueryParam("status")  @ApiParam("Status of billing invoices to filter by")  String status,@QueryParam("document_type")  @ApiParam("Document type of billing invoices to filter by")  String documentType,@QueryParam("start_due_date") @Pattern(regexp="^(\\d{4})-(\\d{2})-(\\d{2})$")  @ApiParam("Starting point for due dates when searching for invoices. Format: YYYY-MM-DD")  LocalDate startDueDate,@QueryParam("end_due_date") @Pattern(regexp="^(\\d{4})-(\\d{2})-(\\d{2})$")  @ApiParam("Ending point for due dates when searching for invoices. Format: YYYY-MM-DD")  LocalDate endDueDate) {
        return Response.ok().entity("magic!").build();
    }
    ...
    public Response billingProfilesGet(@PathParam("ad_account_id") @Pattern(regexp="^\\d+$") @Size(max=18) @ApiParam("Unique identifier of an ad account.") String adAccountId,@QueryParam("is_active") @NotNull  @ApiParam("Return active billing profiles, if false return all billing profiles.")  Boolean isActive,@QueryParam("bookmark")  @ApiParam("Cursor used to fetch the next page of items")  String bookmark,@QueryParam("page_size") @Min(1) @Max(250) @DefaultValue("25")  @ApiParam("Maximum number of items to include in a single page of the response. See documentation on &lt;a href&#x3D;&#39;/docs/reference/pagination/&#39;&gt;Pagination&lt;/a&gt; for more information.")  Integer pageSize) {
        return Response.ok().entity("magic!").build();
    }
    ...
    public Response campaignsList(@PathParam("ad_account_id") @Pattern(regexp="^\\d+$") @Size(max=18) @ApiParam("Unique identifier of an ad account.") String adAccountId,@QueryParam("campaign_ids") @Size(min=1,max=250)  @ApiParam("List of Campaign Ids to use to filter the results.")  List<@Pattern(regexp = "^\\d+$")@Size(max = 18)String> campaignIds,@QueryParam("entity_statuses")  @ApiParam("Entity status")  List<String> entityStatuses,@QueryParam("page_size") @Min(1) @Max(250) @DefaultValue("25")  @ApiParam("Maximum number of items to include in a single page of the response. See documentation on &lt;a href&#x3D;&#39;/docs/reference/pagination/&#39;&gt;Pagination&lt;/a&gt; for more information.")  Integer pageSize,@QueryParam("order")  @ApiParam("The order in which to sort the items returned: “ASCENDING” or “DESCENDING” by ID. Note that higher-value IDs are associated with more-recently added items.")  String order,@QueryParam("bookmark")  @ApiParam("Cursor used to fetch the next page of items")  String bookmark) {
        return Response.ok().entity("magic!").build();
    }
    ...
    public Response customerListUploadsCreate(@PathParam("ad_account_id") @Pattern(regexp="^\\d+$") @Size(max=18) @ApiParam("Unique identifier of an ad account.") String adAccountId,@PathParam("customer_list_id") @Pattern(regexp="^\\d+$") @Size(max=18) @ApiParam("Unique identifier of a customer list") String customerListId,@Valid @NotNull CustomerListUploadCreateRequest customerListUploadCreateRequest) {
        return Response.ok().entity("magic!").build();
    }
    ...
    public Response customerListUploadsGet(@PathParam("ad_account_id") @Pattern(regexp="^\\d+$") @Size(max=18) @ApiParam("Unique identifier of an ad account.") String adAccountId,@PathParam("customer_list_id") @Pattern(regexp="^\\d+$") @Size(max=18) @ApiParam("Unique identifier of a customer list") String customerListId,@PathParam("customer_list_upload_id") @Pattern(regexp="^\\d+$") @Size(max=18) @ApiParam("Unique identifier of a customer list upload") String customerListUploadId) {
        return Response.ok().entity("magic!").build();
    }
    ...
    public Response customerListUploadsRun(@PathParam("ad_account_id") @Pattern(regexp="^\\d+$") @Size(max=18) @ApiParam("Unique identifier of an ad account.") String adAccountId,@PathParam("customer_list_id") @Pattern(regexp="^\\d+$") @Size(max=18) @ApiParam("Unique identifier of a customer list") String customerListId,@PathParam("customer_list_upload_id") @Pattern(regexp="^\\d+$") @Size(max=18) @ApiParam("Unique identifier of a customer list upload") String customerListUploadId) {
        return Response.ok().entity("magic!").build();
    }
    ...
    public Response keywordsGet(@PathParam("ad_account_id") @Pattern(regexp="^\\d+$") @Size(max=18) @ApiParam("Unique identifier of an ad account.") String adAccountId,@QueryParam("campaign_id") @Pattern(regexp="^\\d+$") @Size(max=18)  @ApiParam("Campaign Id to use to filter the results.")  String campaignId,@QueryParam("ad_group_id") @Pattern(regexp="^\\d+$") @Size(max=18)  @ApiParam("Ad group Id.")  String adGroupId,@QueryParam("ad_group_ids") @Size(min=1,max=250)  @ApiParam("List of Ad group Ids to retrieve keywords from. This feature is currently in BETA and is not available to all users.")  List<@Pattern(regexp = "^\\d+$")@Size(max = 18)String> adGroupIds,@QueryParam("match_types") @Size(min=1,max=5)  @ApiParam("Keyword &lt;a target&#x3D;\&quot;_blank\&quot; href&#x3D;\&quot;/docs/api-features/targeting-overview/\&quot;&gt;match type&lt;/a&gt;")  List<MatchType> matchTypes,@QueryParam("page_size") @Min(1) @DefaultValue("25")  @ApiParam("Maximum number of items to include in a single page of the response. Default maximum of 250. See documentation on &lt;a href&#x3D;&#39;/docs/reference/pagination/&#39;&gt;Pagination&lt;/a&gt; for more information.")  Integer pageSize,@QueryParam("bookmark")  @ApiParam("Cursor used to fetch the next page of items")  String bookmark) {
        return Response.ok().entity("magic!").build();
    }
    ...
    public Response labelsList(@PathParam("ad_account_id") @Pattern(regexp="^\\d+$") @Size(max=18) @ApiParam("Unique identifier of an ad account.") String adAccountId,@QueryParam("campaign_ids") @Size(min=1,max=250)  @ApiParam("List of Campaign Ids to use to filter the results.")  List<@Pattern(regexp = "^\\d+$")@Size(max = 18)String> campaignIds,@QueryParam("label_ids") @Size(min=1,max=250)  @ApiParam("List of Label Ids to use to filter the results.")  List<@Pattern(regexp = "^\\d+$")@Size(max = 18)String> labelIds,@QueryParam("entity_statuses")  @ApiParam("Label entity status")  List<String> entityStatuses,@QueryParam("label_types")  @ApiParam("Label type.")  List<String> labelTypes,@QueryParam("page_size") @Min(1) @Max(250) @DefaultValue("25")  @ApiParam("Maximum number of items to include in a single page of the response. See documentation on &lt;a href&#x3D;&#39;/docs/reference/pagination/&#39;&gt;Pagination&lt;/a&gt; for more information.")  Integer pageSize,@QueryParam("bookmark")  @ApiParam("Cursor used to fetch the next page of items")  String bookmark) {
        return Response.ok().entity("magic!").build();
    }
    ...
    public Response leadFormsCreate(@PathParam("ad_account_id") @Pattern(regexp="^\\d+$") @Size(max=18) @ApiParam("Unique identifier of an ad account.") String adAccountId,@Valid @NotNull List<@Valid LeadFormCreateRequest> leadFormCreateRequest) {
        return Response.ok().entity("magic!").build();
    }
    ...
    public Response leadFormsUpdate(@PathParam("ad_account_id") @Pattern(regexp="^\\d+$") @Size(max=18) @ApiParam("Unique identifier of an ad account.") String adAccountId,@Valid @NotNull List<@Valid LeadFormUpdateRequest> leadFormUpdateRequest) {
        return Response.ok().entity("magic!").build();
    }
    ...
    public Response leadsExportCreate(@PathParam("ad_account_id") @Pattern(regexp="^\\d+$") @Size(max=18) @ApiParam("Unique identifier of an ad account.") String adAccountId,@Valid @NotNull LeadsExportCreateRequest leadsExportCreateRequest) {
        return Response.ok().entity("magic!").build();
    }
    ...
    public Response msotEventsCreate(@PathParam("ad_account_id") @Pattern(regexp="^\\d+$") @Size(max=18) @ApiParam("Unique identifier of an ad account.") String adAccountId,@Valid @NotNull ConversionMSOTEvents conversionMSOTEvents) {
        return Response.ok().entity("magic!").build();
    }
    ...
    public Response productGroupPromotionsList(@PathParam("ad_account_id") @Pattern(regexp="^\\d+$") @Size(max=18) @ApiParam("Unique identifier of an ad account.") String adAccountId,@QueryParam("product_group_promotion_ids") @Size(min=1,max=250)  @ApiParam("List of Product group promotion Ids.")  List<@Pattern(regexp = "^\\d+$")String> productGroupPromotionIds,@QueryParam("entity_statuses")  @ApiParam("Entity status")  List<String> entityStatuses,@QueryParam("ad_group_id") @Pattern(regexp="^\\d+$") @Size(max=18)  @ApiParam("Ad group Id.")  String adGroupId,@QueryParam("page_size") @Min(1) @Max(250) @DefaultValue("25")  @ApiParam("Maximum number of items to include in a single page of the response. See documentation on &lt;a href&#x3D;&#39;/docs/reference/pagination/&#39;&gt;Pagination&lt;/a&gt; for more information.")  Integer pageSize,@QueryParam("order")  @ApiParam("The order in which to sort the items returned: “ASCENDING” or “DESCENDING” by ID. Note that higher-value IDs are associated with more-recently added items.")  String order,@QueryParam("bookmark")  @ApiParam("Cursor used to fetch the next page of items")  String bookmark) {
        return Response.ok().entity("magic!").build();
    }
    ...
    public Response promotionsCreate(@PathParam("ad_account_id") @Pattern(regexp="^\\d+$") @Size(max=18) @ApiParam("Unique identifier of an ad account.") String adAccountId,@Valid @NotNull List<@Valid PromotionCreateRequest> promotionCreateRequest) {
        return Response.ok().entity("magic!").build();
    }
    ...
    public Response promotionsDelete(@PathParam("ad_account_id") @Pattern(regexp="^\\d+$") @Size(max=18) @ApiParam("Unique identifier of an ad account.") String adAccountId,@PathParam("promotion_id") @Pattern(regexp="^\\d+$") @Size(max=18) @ApiParam("Unique identifier of a promotion") String promotionId) {
        return Response.ok().entity("magic!").build();
    }
    ...
    public Response promotionsGet(@PathParam("ad_account_id") @Pattern(regexp="^\\d+$") @Size(max=18) @ApiParam("Unique identifier of an ad account.") String adAccountId,@PathParam("promotion_id") @Pattern(regexp="^\\d+$") @Size(max=18) @ApiParam("Unique identifier of a promotion") String promotionId) {
        return Response.ok().entity("magic!").build();
    }
    ...
    public Response promotionsUpdate(@PathParam("ad_account_id") @Pattern(regexp="^\\d+$") @Size(max=18) @ApiParam("Unique identifier of an ad account.") String adAccountId,@Valid @NotNull List<@Valid PromotionUpdateRequest> promotionUpdateRequest) {
        return Response.ok().entity("magic!").build();
    }
    ...
    public Response targetingTemplateList(@PathParam("ad_account_id") @Pattern(regexp="^\\d+$") @Size(max=18) @ApiParam("Unique identifier of an ad account.") String adAccountId,@QueryParam("order")  @ApiParam("The order in which to sort the items returned: “ASCENDING” or “DESCENDING” by ID. Note that higher-value IDs are associated with more-recently added items.")  String order,@QueryParam("include_sizing") @DefaultValue("false")  @ApiParam("Include audience sizing in result or not")  Boolean includeSizing,@QueryParam("search_query")  @ApiParam("Search keyword for targeting templates")  String searchQuery,@QueryParam("page_size") @Min(1) @Max(250) @DefaultValue("25")  @ApiParam("Maximum number of items to include in a single page of the response. See documentation on &lt;a href&#x3D;&#39;/docs/reference/pagination/&#39;&gt;Pagination&lt;/a&gt; for more information.")  Integer pageSize,@QueryParam("bookmark")  @ApiParam("Cursor used to fetch the next page of items")  String bookmark) {
        return Response.ok().entity("magic!").build();
    }
    ...
    public Response targetingTemplateUpdate(@PathParam("ad_account_id") @Pattern(regexp="^\\d+$") @Size(max=18) @ApiParam("Unique identifier of an ad account.") String adAccountId,@Valid @NotNull TargetingTemplateUpdateRequest targetingTemplateUpdateRequest) {
        return Response.ok().entity("magic!").build();
    }
    ...
    public Response updateAdAccountToAdAccountSharedAudience(@PathParam("ad_account_id") @Pattern(regexp="^\\d+$") @Size(max=18) @ApiParam("Unique identifier of an ad account.") String adAccountId,@Valid @NotNull SharedAudience sharedAudience) {
        return Response.ok().entity("magic!").build();
    }
    ...
    public Response updateAdAccountToBusinessSharedAudience(@PathParam("ad_account_id") @Pattern(regexp="^\\d+$") @Size(max=18) @ApiParam("Unique identifier of an ad account.") String adAccountId,@Valid @NotNull BusinessSharedAudience businessSharedAudience) {
        return Response.ok().entity("magic!").build();
    }
}
