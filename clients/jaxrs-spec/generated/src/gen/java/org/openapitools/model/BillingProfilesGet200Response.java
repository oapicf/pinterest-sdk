...
public class BillingProfilesGet200Response   {
  ...
  private @Valid List<@Valid BillingProfilesResponse> items = new ArrayList<>();
  ...
  @JsonCreator
  public BillingProfilesGet200Response(
    @JsonProperty(required = true, value = "items") List<@Valid BillingProfilesResponse> items
  ) {
    this.items = items;
  }
  ...
  @NotNull @Valid public List<@Valid BillingProfilesResponse> getItems() {
    return items;
  }
  ...
  public BillingProfilesGet200Response removeItemsItem(BillingProfilesResponse itemsItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.bookmark, billingProfilesGet200Response.bookmark) &&
        Objects.equals(this.items, billingProfilesGet200Response.items);
  }
