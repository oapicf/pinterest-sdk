...
public class AdvertiserDefinedEventsCreate200Response   {
  private @Valid List<@Valid AdvertiserDefinedEventProcessingRecord> items = new ArrayList<>();
  ...
  @JsonCreator
  public AdvertiserDefinedEventsCreate200Response(
    @JsonProperty(required = true, value = "items") List<@Valid AdvertiserDefinedEventProcessingRecord> items
  ) {
    this.items = items;
  }
  ...
  @NotNull @Valid public List<@Valid AdvertiserDefinedEventProcessingRecord> getItems() {
    return items;
  }
  ...
  public AdvertiserDefinedEventsCreate200Response removeItemsItem(AdvertiserDefinedEventProcessingRecord itemsItem) {
