...
public class BidOptionsAppTypeMultipliers   {
  ...
  @Valid public BigDecimal getAndroidMobile() {
  ...
  @Valid public BigDecimal getAndroidTablet() {
  ...
  @ApiModelProperty(value = "")
  @JsonProperty("ipad")
  @Valid public BigDecimal getIpad() {
    return ipad;
  }
  ...
  @ApiModelProperty(value = "")
  @JsonProperty("iphone")
  @Valid public BigDecimal getIphone() {
    return iphone;
  }
  ...
  @ApiModelProperty(value = "")
  @JsonProperty("web")
  @Valid public BigDecimal getWeb() {
    return web;
  }
  ...
  @Valid public BigDecimal getWebMobile() {
    return webMobile;
  }
