...
public class ConversionEventsCreate   {
  private @Valid List<@Valid ConversionEventsDataItems> data = new ArrayList<>();
  ...
  @JsonCreator
  public ConversionEventsCreate(
    @JsonProperty(required = true, value = "data") List<@Valid ConversionEventsDataItems> data
  ) {
    this.data = data;
  }
  ...
  @NotNull @Valid  @Size(min=1,max=1000)public List<@Valid ConversionEventsDataItems> getData() {
    return data;
  }
  ...
  public ConversionEventsCreate removeDataItem(ConversionEventsDataItems dataItem) {
