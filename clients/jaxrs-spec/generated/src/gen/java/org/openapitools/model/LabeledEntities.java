...
public class LabeledEntities   {
  private @Valid List<@Valid EntityLabel> entitiesLabels = new ArrayList<>();
  private @Valid List<@Valid EntityLabelError> errors = new ArrayList<>();
  ...
  @Valid public List<@Valid EntityLabel> getEntitiesLabels() {
  ...
  public LabeledEntities removeEntitiesLabelsItem(EntityLabel entitiesLabelsItem) {
    if (entitiesLabelsItem != null && this.entitiesLabels != null) {
      this.entitiesLabels.remove(entitiesLabelsItem);
    }
  ...
  @JsonProperty("errors")
  @Valid public List<@Valid EntityLabelError> getErrors() {
    return errors;
  }
  ...
  public LabeledEntities removeErrorsItem(EntityLabelError errorsItem) {
