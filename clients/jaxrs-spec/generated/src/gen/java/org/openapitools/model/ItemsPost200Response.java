...
public class ItemsPost200Response   {
  ...
  @JsonCreator
  public ItemsPost200Response(
    @JsonProperty(required = true, value = "items") List<@Valid ItemResponse> items
  ) {
    this.items = items;
  }
  ...
  @NotNull @Valid public List<@Valid ItemResponse> getItems() {
    return items;
  }
  ...
  public ItemsPost200Response removeItemsItem(ItemResponse itemsItem) {
