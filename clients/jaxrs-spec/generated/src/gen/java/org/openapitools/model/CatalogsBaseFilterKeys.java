...
@JsonTypeName("CatalogsBaseFilterKeys")
...
public class CatalogsBaseFilterKeys   {
  ...
  public CatalogsBaseFilterKeys(
    ...
    @JsonProperty(required = true, value = "CUSTOM_LABEL_2") CatalogsProductGroupFilterOperatorTypeCriteria CUSTOM_LABEL_2,
    @JsonProperty(required = true, value = "CUSTOM_LABEL_3") CatalogsProductGroupFilterOperatorTypeCriteria CUSTOM_LABEL_3,
    @JsonProperty(required = true, value = "CUSTOM_LABEL_4") CatalogsProductGroupFilterOperatorTypeCriteria CUSTOM_LABEL_4,
    ...
    @JsonProperty(required = true, value = "CUSTOM_NUMBER_1") CatalogsProductGroupUint32Criteria CUSTOM_NUMBER_1,
    @JsonProperty(required = true, value = "CUSTOM_NUMBER_2") CatalogsProductGroupUint32Criteria CUSTOM_NUMBER_2,
    @JsonProperty(required = true, value = "CUSTOM_NUMBER_3") CatalogsProductGroupUint32Criteria CUSTOM_NUMBER_3,
  ...
  @NotNull @Valid public CatalogsProductGroupFilterOperatorTypeCriteria getCUSTOMLABEL0() {
  ...
  @NotNull @Valid public CatalogsProductGroupFilterOperatorTypeCriteria getCUSTOMLABEL2() {
  ...
  @NotNull @Valid public CatalogsProductGroupFilterOperatorTypeCriteria getCUSTOMLABEL4() {
  ...
  @ApiModelProperty(required = true, value = "")
  @JsonProperty(required = true, value = "CUSTOM_NUMBER_1")
  @NotNull @Valid public CatalogsProductGroupUint32Criteria getCUSTOMNUMBER1() {
  ...
  @ApiModelProperty(required = true, value = "")
  @JsonProperty(required = true, value = "CUSTOM_NUMBER_2")
  @NotNull @Valid public CatalogsProductGroupUint32Criteria getCUSTOMNUMBER2() {
  ...
  @ApiModelProperty(required = true, value = "")
  @JsonProperty(required = true, value = "CUSTOM_NUMBER_3")
  @NotNull @Valid public CatalogsProductGroupUint32Criteria getCUSTOMNUMBER3() {
  ...
  @ApiModelProperty(required = true, value = "")
  @JsonProperty(required = true, value = "TITLE_KEYWORDS")
  @NotNull @Valid public CatalogsProductGroupMultipleStringCriteria getTITLEKEYWORDS() {
