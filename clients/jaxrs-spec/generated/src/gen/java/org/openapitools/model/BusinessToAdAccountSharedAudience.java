...
@JsonTypeName("BusinessToAdAccountSharedAudience")
...
public class BusinessToAdAccountSharedAudience   {
  ...
  public BusinessToAdAccountSharedAudience removePermissionsItem(Role permissionsItem) {
  ...
  public BusinessToAdAccountSharedAudience removeRecipientAccountIdsItem(String recipientAccountIdsItem) {
