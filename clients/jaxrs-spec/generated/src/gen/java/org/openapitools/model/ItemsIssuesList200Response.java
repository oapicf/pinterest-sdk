...
public class ItemsIssuesList200Response   {
  ...
  private @Valid List<@Valid CatalogsItemValidationIssues> items = new ArrayList<>();
  ...
  @JsonCreator
  public ItemsIssuesList200Response(
    @JsonProperty(required = true, value = "items") List<@Valid CatalogsItemValidationIssues> items
  ) {
    this.items = items;
  }
  ...
  @NotNull @Valid public List<@Valid CatalogsItemValidationIssues> getItems() {
    return items;
  }
  ...
  public ItemsIssuesList200Response removeItemsItem(CatalogsItemValidationIssues itemsItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.bookmark, itemsIssuesList200Response.bookmark) &&
        Objects.equals(this.items, itemsIssuesList200Response.items);
  }
