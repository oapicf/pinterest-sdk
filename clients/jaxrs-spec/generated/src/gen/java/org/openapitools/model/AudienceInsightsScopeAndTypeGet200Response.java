...
public class AudienceInsightsScopeAndTypeGet200Response   {
  private @Valid List<@Valid AudienceDefinition> items = new ArrayList<>();
  ...
  @JsonCreator
  public AudienceInsightsScopeAndTypeGet200Response(
    @JsonProperty(required = true, value = "items") List<@Valid AudienceDefinition> items
  ) {
    this.items = items;
  }
  ...
  @NotNull @Valid public List<@Valid AudienceDefinition> getItems() {
    return items;
  }
  ...
  public AudienceInsightsScopeAndTypeGet200Response removeItemsItem(AudienceDefinition itemsItem) {
