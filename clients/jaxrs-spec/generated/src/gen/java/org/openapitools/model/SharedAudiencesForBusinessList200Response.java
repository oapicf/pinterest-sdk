...
@JsonTypeName("shared_audiences_for_business_list_200_response")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaJAXRSSpecServerCodegen", date = "2026-08-30T09:54:53.087121019Z[Etc/UTC]", comments = "Generator version: 7.24.0")
public class SharedAudiencesForBusinessList200Response   {
  private String bookmark;
  private @Valid List<@Valid Audience> items = new ArrayList<>();

  public SharedAudiencesForBusinessList200Response() {
  }

  @JsonCreator
  public SharedAudiencesForBusinessList200Response(
    @JsonProperty(required = true, value = "items") List<@Valid Audience> items
  ) {
    this.items = items;
  }
  ...
  @NotNull @Valid public List<@Valid Audience> getItems() {
    return items;
  }
  ...
  public SharedAudiencesForBusinessList200Response removeItemsItem(Audience itemsItem) {
