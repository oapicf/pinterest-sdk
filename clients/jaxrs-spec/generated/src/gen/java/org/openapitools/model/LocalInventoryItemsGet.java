...
public class LocalInventoryItemsGet   {
  private @Valid List<@Valid LocalInventoryItemResponse> items = new ArrayList<>();
  ...
  @JsonCreator
  public LocalInventoryItemsGet(
    @JsonProperty(required = true, value = "items") List<@Valid LocalInventoryItemResponse> items
  ) {
    this.items = items;
  }
  ...
  @Valid public List<@Valid LocalInventoryItemResponse> getItems() {
    return items;
  }
  ...
  public LocalInventoryItemsGet removeItemsItem(LocalInventoryItemResponse itemsItem) {
