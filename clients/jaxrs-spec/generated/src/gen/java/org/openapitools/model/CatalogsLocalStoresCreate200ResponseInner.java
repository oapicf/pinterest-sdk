...
public class CatalogsLocalStoresCreate200ResponseInner   {
  ...
  @JsonCreator
  public CatalogsLocalStoresCreate200ResponseInner(
    @JsonProperty(required = true, value = "data") CatalogsLocalStoresCreate200ResponseInnerData data
  ) {
    this.data = data;
  }
  ...
  @NotNull @Valid public CatalogsLocalStoresCreate200ResponseInnerData getData() {
    return data;
  }
