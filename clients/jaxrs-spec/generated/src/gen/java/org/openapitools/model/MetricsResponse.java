...
public class MetricsResponse   {
  private @Valid List<@Valid MetricsResponseDataItems> data = new ArrayList<>();
  ...
  @JsonProperty("data")
  @Valid public List<@Valid MetricsResponseDataItems> getData() {
    return data;
  }
  ...
  public MetricsResponse removeDataItem(MetricsResponseDataItems dataItem) {
