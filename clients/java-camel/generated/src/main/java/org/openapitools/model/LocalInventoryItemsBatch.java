...
public class LocalInventoryItemsBatch {
   ...
   */
  public LocalInventoryItemsBatch(String batchId, Date createdTime, List<SupplementalOperationResult> operationResults, SupplementalItemBatchOperationStatus status) {
