...
public class CatalogsCreativeAssetsFeed implements CatalogsFeed {
   ...
   */
  public CatalogsCreativeAssetsFeed(String catalogId, CatalogTypeEnum catalogType, Date createdAt, Country defaultCountry, String defaultLocale, CatalogsFormat format, String id, String location, String name, CatalogsStatus status, Date updatedAt) {
