        ...
        **/
        rest()
            ...
            .patch("/boards/{board_id}/sections/{section_id}")
                ...
                .outType(BoardSection.class)
                .consumes("application/json")
                .type(BoardSectionUpdateWithRequiredBody.class)
                ...
                .endParam()
                .param()
                    .name("boardSectionUpdateWithRequiredBody")
                    .type(RestParamType.body)
                    .required(true)
                .endParam()
        ...
        **/
        rest()
            ...
            .patch("/boards/{board_id}")
                ...
                .id("boardsUpdateApi")
                .produces("application/json")
                .outType(BoardWithUpdatePrivacy.class)
                .consumes("application/json")
                .type(BoardWithUpdatePrivacyUpdate.class)
                ...
                .endParam()
                .param()
                    .name("boardWithUpdatePrivacyUpdate")
                    .type(RestParamType.body)
                    .required(true)
                .endParam()
