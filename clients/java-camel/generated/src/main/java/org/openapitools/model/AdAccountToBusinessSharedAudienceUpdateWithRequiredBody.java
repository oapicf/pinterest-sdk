...
@Schema(name = "AdAccountToBusinessSharedAudienceUpdateWithRequiredBody", description = "Resource create or update operation model with required body fields (no OptionalProperties).")
...
public class AdAccountToBusinessSharedAudienceUpdateWithRequiredBody {
  ...
  public AdAccountToBusinessSharedAudienceUpdateWithRequiredBody() {
    super();
  }
   ...
   */
  public AdAccountToBusinessSharedAudienceUpdateWithRequiredBody(String audienceId, OperationType operationType, List<@Pattern(regexp = "^\\d+$")String> recipientBusinessIds) {
