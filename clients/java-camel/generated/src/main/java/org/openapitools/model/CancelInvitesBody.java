...
@Schema(name = "CancelInvitesBody", description = "Request body used to cancel invites")
...
public class CancelInvitesBody {
  ...
  @Schema(name = "invite_ids", example = "[\"1234567890123456789\",\"1122334455667788991\"]", description = "List of invite/request ids to be cancelled", requiredMode = Schema.RequiredMode.REQUIRED)
