...
public class GetBusinessMembers200Response {
   ...
   */
  public GetBusinessMembers200Response(List<@Valid UserBusinessRoleBinding> items) {
    this.items = items;
  }
   ...
   */
  @NotNull @Valid 
  @Schema(name = "items", description = "List of business members.", requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty("items")
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.bookmark, getBusinessMembers200Response.bookmark) &&
