...
public class AdCommon {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.adGroupId, adCommon.adGroupId) &&
        equalsNullable(this.androidDeepLink, adCommon.androidDeepLink) &&
        equalsNullable(this.carouselAndroidDeepLinks, adCommon.carouselAndroidDeepLinks) &&
        equalsNullable(this.carouselDestinationUrls, adCommon.carouselDestinationUrls) &&
        equalsNullable(this.carouselIosDeepLinks, adCommon.carouselIosDeepLinks) &&
        equalsNullable(this.clickTrackingUrl, adCommon.clickTrackingUrl) &&
        Objects.equals(this.creativeType, adCommon.creativeType) &&
        equalsNullable(this.customizableCtaType, adCommon.customizableCtaType) &&
        equalsNullable(this.destinationUrl, adCommon.destinationUrl) &&
        equalsNullable(this.disclosureType, adCommon.disclosureType) &&
        equalsNullable(this.disclosureUrl, adCommon.disclosureUrl) &&
        equalsNullable(this.gridClickType, adCommon.gridClickType) &&
        equalsNullable(this.iosDeepLink, adCommon.iosDeepLink) &&
        Objects.equals(this.isPinDeleted, adCommon.isPinDeleted) &&
        Objects.equals(this.isRemovable, adCommon.isRemovable) &&
        equalsNullable(this.leadFormId, adCommon.leadFormId) &&
        equalsNullable(this.name, adCommon.name) &&
        equalsNullable(this.quizPinData, adCommon.quizPinData) &&
        Objects.equals(this.status, adCommon.status) &&
        equalsNullable(this.trackingUrls, adCommon.trackingUrls) &&
        equalsNullable(this.viewTrackingUrl, adCommon.viewTrackingUrl);
  }
