...
public class UserFollowingGet200Response {
   ...
   */
  @NotNull @Valid 
  @Schema(name = "items", description = "Users", requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty("items")
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.bookmark, userFollowingGet200Response.bookmark) &&
        Objects.equals(this.items, userFollowingGet200Response.items);
  }
