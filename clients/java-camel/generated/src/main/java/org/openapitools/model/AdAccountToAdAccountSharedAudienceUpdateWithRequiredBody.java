...
@Schema(name = "AdAccountToAdAccountSharedAudienceUpdateWithRequiredBody", description = "Resource create or update operation model with required body fields (no OptionalProperties).")
...
public class AdAccountToAdAccountSharedAudienceUpdateWithRequiredBody {
   ...
   */
  public AdAccountToAdAccountSharedAudienceUpdateWithRequiredBody(String audienceId, OperationType operationType, List<@Pattern(regexp = "^\\d+$")String> recipientAccountIds) {
