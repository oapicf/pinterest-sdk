...
public class SsioInsertionOrdersStatusGetByAdAccount200Response {
   ...
   */
  public SsioInsertionOrdersStatusGetByAdAccount200Response(List<@Valid SSIOInsertionOrderStatus> items) {
    this.items = items;
  }
   ...
   */
  @NotNull @Valid 
  @Schema(name = "items", description = "Insertion orders status by ad acount id", requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty("items")
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.bookmark, ssioInsertionOrdersStatusGetByAdAccount200Response.bookmark) &&
