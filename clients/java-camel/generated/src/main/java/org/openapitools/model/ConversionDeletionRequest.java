...
public class ConversionDeletionRequest {
  ...
  @DateTimeFormat(iso = DateTimeFormat.ISO.DATE)
  private JsonNullable<Date> processedTime = JsonNullable.<Date>undefined();
   ...
   */
  public ConversionDeletionRequest(Date createdTime, String requestId, ConversionDeletionRequestStatus status) {
  ...
  public JsonNullable<Date> getProcessedTime() {
    return processedTime;
  }

  public void setProcessedTime(JsonNullable<Date> processedTime) {
