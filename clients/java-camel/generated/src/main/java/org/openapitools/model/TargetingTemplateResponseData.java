...
public class TargetingTemplateResponseData {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(autoTargetingEnabled, keywords, name, placementGroup, targetingAttributes, hashCodeNullable(trackingUrls), adAccountId, createdTime, id, hashCodeNullable(sizing), status, updatedTime);
  }
