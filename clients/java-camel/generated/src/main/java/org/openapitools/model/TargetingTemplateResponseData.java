...
public class TargetingTemplateResponseData {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, targetingTemplateResponseData.name) &&
        ...
        equalsNullable(this.trackingUrls, targetingTemplateResponseData.trackingUrls) &&
        ...
        equalsNullable(this.sizing, targetingTemplateResponseData.sizing);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, autoTargetingEnabled, targetingAttributes, placementGroup, keywords, hashCodeNullable(trackingUrls), id, createdTime, updatedTime, adAccountId, status, hashCodeNullable(sizing));
  }
