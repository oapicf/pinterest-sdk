        ...
        **/
        rest()
            ...
            .get("/resources/ad_account_countries")
                ...
                .outType(AdAccountCountriesGet200Response.class)
        ...
        **/
        rest()
            ...
            .get("/resources/delivery_metrics")
                ...
                .produces("application/json")
                .outType(DeliveryMetricsGet200Response.class)
                .param()
                    .name("reportType")
        ...
        **/
        rest()
            ...
            .get("/resources/targeting/interests/{interest_id}")
                ...
                .produces("application/json")
                .outType(SingleInterestTargetingOption.class)
                .param()
                    .name("interestId")
