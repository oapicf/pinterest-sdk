...
public class TargetingSpecOperationLocationExclude implements TargetingSpecOperations {
  ...
  public TargetingSpecOperationLocationExclude() {
    super();
  }
   ...
   */
  public TargetingSpecOperationLocationExclude(FieldEnum field, TargetingSpecListOperation operation, List<String> values) {
    this.field = field;
  ...
  public TargetingSpecOperationLocationExclude addValuesItem(String valuesItem) {
    if (this.values == null) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.field, targetingSpecOperationLocationExclude.field) &&
        Objects.equals(this.operation, targetingSpecOperationLocationExclude.operation) &&
        Objects.equals(this.values, targetingSpecOperationLocationExclude.values);
  }
