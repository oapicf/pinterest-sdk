...
@JsonTypeName("business_asset_partners_get_200_response")
...
public class BusinessAssetPartnersGet200Response {
  ...
  public BusinessAssetPartnersGet200Response() {
    super();
  }
   ...
   */
  public BusinessAssetPartnersGet200Response(List<@Valid UserSingleAssetBinding> items) {
    this.items = items;
  }
   ...
   */
  @NotNull @Valid 
  @Schema(name = "items", description = "List of partners with permissions to the asset.", requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty("items")
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.bookmark, businessAssetPartnersGet200Response.bookmark) &&
        Objects.equals(this.items, businessAssetPartnersGet200Response.items);
  }
