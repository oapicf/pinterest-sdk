...
public class DeleteInvitesResultsResponseArrayItemsInner {
  ...
  private JsonNullable<DeleteInvitesResultsResponseArrayItemsInnerException> exception = JsonNullable.<DeleteInvitesResultsResponseArrayItemsInnerException>undefined();
  ...
  public JsonNullable<DeleteInvitesResultsResponseArrayItemsInnerException> getException() {
    return exception;
  }

  public void setException(JsonNullable<DeleteInvitesResultsResponseArrayItemsInnerException> exception) {
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.exception, deleteInvitesResultsResponseArrayItemsInner.exception) &&
        equalsNullable(this.invite, deleteInvitesResultsResponseArrayItemsInner.invite);
  }
