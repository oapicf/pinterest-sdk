        ...
        **/
        rest()
            ...
            .get("/ad_accounts/{ad_account_id}/campaigns/analytics")
                ...
                .produces("application/json")
                .outType(CampaignsAnalyticsResponseInner[].class)
                .param()
                    .name("adAccountId")
                    .type(RestParamType.path)
                    .required(true)
        ...
        **/
        rest()
            ...
            .post("/ad_accounts/{ad_account_id}/campaigns")
                ...
                .produces("application/json")
                .outType(CampaignCreateResponse.class)
                .consumes("application/json")
                .type(CampaignCreateRequest[].class)
        ...
        **/
        rest()
            ...
            .get("/ad_accounts/{ad_account_id}/campaigns/{campaign_id}")
                ...
                .id("campaignsGetApi")
                .produces("application/json")
                .outType(CampaignResponse.class)
                .param()
                    .name("adAccountId")
                    .type(RestParamType.path)
                    .required(true)
        ...
        **/
        rest()
            ...
            .patch("/ad_accounts/{ad_account_id}/campaigns")
                ...
                .produces("application/json")
                .outType(CampaignUpdateResponse.class)
                .consumes("application/json")
                .type(CampaignUpdateRequest[].class)
