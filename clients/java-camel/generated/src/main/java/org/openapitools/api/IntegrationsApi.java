        ...
        **/
        rest()
            ...
            .patch("/integrations/commerce/{external_business_id}")
                ...
                .type(IntegrationMetadataUpdate.class)
                ...
                .endParam()
                .param()
                    .name("integrationMetadataUpdate")
        ...
        **/
        rest()
            ...
            .post("/integrations/commerce")
                ...
                .outType(IntegrationMetadata.class)
                .consumes("application/json")
                .type(IntegrationMetadataCreate.class)
                
                .param()
                    .name("integrationMetadataCreate")
                    .type(RestParamType.body)
                    .required(true)
                .endParam()
        ...
        **/
        rest()
            ...
            .post("/integrations/logs")
                ...
                .consumes("application/json")
                .type(IntegrationLogsRequestCreate.class)
                
                .param()
                    .name("integrationLogsRequestCreate")
                    .type(RestParamType.body)
                    .required(true)
                .endParam()
