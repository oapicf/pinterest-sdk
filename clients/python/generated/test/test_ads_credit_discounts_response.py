...
class TestAdsCreditDiscountsResponse(unittest.TestCase):
    """AdsCreditDiscountsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AdsCreditDiscountsResponse:
        ...
        """
        model = AdsCreditDiscountsResponse()
        if include_optional:
    ...
    def testAdsCreditDiscountsResponse(self):
        """Test AdsCreditDiscountsResponse"""
