...
class TestConversionEventsUserData(unittest.TestCase):
    """ConversionEventsUserData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConversionEventsUserData:
        ...
        """
        model = ConversionEventsUserData()
        if include_optional:
    ...
    def testConversionEventsUserData(self):
        """Test ConversionEventsUserData"""
