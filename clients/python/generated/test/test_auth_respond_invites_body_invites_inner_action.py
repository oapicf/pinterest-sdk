...
class TestAuthRespondInvitesBodyInvitesInnerAction(unittest.TestCase):
    """AuthRespondInvitesBodyInvitesInnerAction unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuthRespondInvitesBodyInvitesInnerAction:
        ...
        """
        model = AuthRespondInvitesBodyInvitesInnerAction()
        if include_optional:
    ...
    def testAuthRespondInvitesBodyInvitesInnerAction(self):
        """Test AuthRespondInvitesBodyInvitesInnerAction"""
