...
class TestSSIOInsertionOrderStatus(unittest.TestCase):
    """SSIOInsertionOrderStatus unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SSIOInsertionOrderStatus:
        ...
        """
        model = SSIOInsertionOrderStatus()
        if include_optional:
    ...
    def testSSIOInsertionOrderStatus(self):
        """Test SSIOInsertionOrderStatus"""
