...
class TestUserWebsiteVerifyRequest(unittest.TestCase):
    """UserWebsiteVerifyRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserWebsiteVerifyRequest:
        ...
        """
        model = UserWebsiteVerifyRequest()
        if include_optional:
    ...
    def testUserWebsiteVerifyRequest(self):
        """Test UserWebsiteVerifyRequest"""
