...
class TestSSIOAccountItem(unittest.TestCase):
    """SSIOAccountItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SSIOAccountItem:
