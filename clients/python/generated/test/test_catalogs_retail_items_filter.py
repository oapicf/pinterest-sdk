...
class TestCatalogsRetailItemsFilter(unittest.TestCase):
    """CatalogsRetailItemsFilter unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CatalogsRetailItemsFilter:
        ...
        """
        model = CatalogsRetailItemsFilter()
        if include_optional:
    ...
    def testCatalogsRetailItemsFilter(self):
        """Test CatalogsRetailItemsFilter"""
