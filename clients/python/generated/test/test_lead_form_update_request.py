...
class TestLeadFormUpdateRequest(unittest.TestCase):
    """LeadFormUpdateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LeadFormUpdateRequest:
        """Test LeadFormUpdateRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LeadFormUpdateRequest`
        """
        model = LeadFormUpdateRequest()
        if include_optional:
    ...
    def testLeadFormUpdateRequest(self):
        """Test LeadFormUpdateRequest"""
