...
class TestAdCreateRequest(unittest.TestCase):
    """AdCreateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AdCreateRequest:
        """Test AdCreateRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AdCreateRequest`
        """
        model = AdCreateRequest()
        if include_optional:
