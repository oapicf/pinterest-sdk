...
class TestAdPreviewRequest(unittest.TestCase):
    """AdPreviewRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AdPreviewRequest:
