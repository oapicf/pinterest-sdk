...
class TestBoardWithUpdatePrivacy(unittest.TestCase):
    """BoardWithUpdatePrivacy unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BoardWithUpdatePrivacy:
        """Test BoardWithUpdatePrivacy
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BoardWithUpdatePrivacy`
        """
        model = BoardWithUpdatePrivacy()
        if include_optional:
    ...
    def testBoardWithUpdatePrivacy(self):
        """Test BoardWithUpdatePrivacy"""
