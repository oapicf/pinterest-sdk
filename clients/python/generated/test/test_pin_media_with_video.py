...
class TestPinMediaWithVideo(unittest.TestCase):
    """PinMediaWithVideo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PinMediaWithVideo:
    ...
    def testPinMediaWithVideo(self):
        """Test PinMediaWithVideo"""
