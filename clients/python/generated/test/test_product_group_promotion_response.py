...
class TestProductGroupPromotionResponse(unittest.TestCase):
    """ProductGroupPromotionResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProductGroupPromotionResponse:
        ...
        """
        model = ProductGroupPromotionResponse()
        if include_optional:
            return ProductGroupPromotionResponse(
                items = [
                    pinterestsdk.models.product_group_promotion_response_item.ProductGroupPromotionResponseItem(
    ...
    def testProductGroupPromotionResponse(self):
        """Test ProductGroupPromotionResponse"""
