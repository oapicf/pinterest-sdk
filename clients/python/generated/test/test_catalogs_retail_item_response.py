...
class TestCatalogsRetailItemResponse(unittest.TestCase):
    """CatalogsRetailItemResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CatalogsRetailItemResponse:
        ...
        """
        model = CatalogsRetailItemResponse()
        if include_optional:
            return CatalogsRetailItemResponse(
                attributes = pinterestsdk.models.item_attributes.ItemAttributes(),
                catalog_type = 'RETAIL',
                item_id = 'DS0294-M',
                pins = [
    ...
    def testCatalogsRetailItemResponse(self):
        """Test CatalogsRetailItemResponse"""
