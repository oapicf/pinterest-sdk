...
class TestConversionEventsDataInner(unittest.TestCase):
    """ConversionEventsDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConversionEventsDataInner:
        ...
        """
        model = ConversionEventsDataInner()
        if include_optional:
    ...
    def testConversionEventsDataInner(self):
        """Test ConversionEventsDataInner"""
