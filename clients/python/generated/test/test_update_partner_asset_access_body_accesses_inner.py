...
class TestUpdatePartnerAssetAccessBodyAccessesInner(unittest.TestCase):
    """UpdatePartnerAssetAccessBodyAccessesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdatePartnerAssetAccessBodyAccessesInner:
        ...
        """
        model = UpdatePartnerAssetAccessBodyAccessesInner()
        if include_optional:
    ...
    def testUpdatePartnerAssetAccessBodyAccessesInner(self):
        """Test UpdatePartnerAssetAccessBodyAccessesInner"""
