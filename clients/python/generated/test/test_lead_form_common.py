...
class TestLeadFormCommon(unittest.TestCase):
    """LeadFormCommon unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LeadFormCommon:
        """Test LeadFormCommon
