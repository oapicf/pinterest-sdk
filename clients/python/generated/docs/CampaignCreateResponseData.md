...
**is_flexible_daily_budgets** | **bool** | Determine if a campaign has setup for flexible daily budgets, also known as \&quot;Pinterest Performance+ budgets\&quot;. | [optional] 
...
**order_line_id** | **str** | Order line ID that appears on the invoice. | [optional] 
...
**bid_options** | [**CampaignBidOptions**](CampaignBidOptions.md) |  | [optional] 
**created_time** | **int** | Campaign creation time. Unix timestamp in seconds. | [optional] 
**is_performance_plus** | **bool** | Enable Pinterest Performance+ for your campaign. To learn more, see &lt;a href&#x3D;\&quot;https://developers.pinterest.com/docs/api-features/pinterest-performance-plus-setup/\&quot;&gt;Pinterest Performance+ Setup&lt;/a&gt;. | [optional] 
...
json = "{}"
# create an instance of CampaignCreateResponseData from a JSON string
campaign_create_response_data_instance = CampaignCreateResponseData.from_json(json)
# print the JSON string representation of the object
print(CampaignCreateResponseData.to_json())

# convert the object into a dict
campaign_create_response_data_dict = campaign_create_response_data_instance.to_dict()
# create an instance of CampaignCreateResponseData from a dict
campaign_create_response_data_from_dict = CampaignCreateResponseData.from_dict(campaign_create_response_data_dict)
```
