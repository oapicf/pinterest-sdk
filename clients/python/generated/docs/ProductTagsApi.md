...
with pinterestsdk.ApiClient(configuration) as api_client:
    ...
    api_instance = pinterestsdk.ProductTagsApi(api_client)
    pin_id = 'pin_id_example' # str | Unique identifier of the hero pin that will receive product tags.
    product_tags_bulk_add_request = pinterestsdk.ProductTagsBulkAddRequest() # ProductTagsBulkAddRequest | 
...
with pinterestsdk.ApiClient(configuration) as api_client:
    ...
    api_instance = pinterestsdk.ProductTagsApi(api_client)
    pin_id = 'pin_id_example' # str | Unique identifier of the hero pin that will receive product tags.
    product_tags_bulk_delete_request = pinterestsdk.ProductTagsBulkDeleteRequest() # ProductTagsBulkDeleteRequest | 
