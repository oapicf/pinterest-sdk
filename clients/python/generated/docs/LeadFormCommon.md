...
lead_form_common_instance = LeadFormCommon.from_json(json)
# print the JSON string representation of the object
print(LeadFormCommon.to_json())

# convert the object into a dict
lead_form_common_dict = lead_form_common_instance.to_dict()
# create an instance of LeadFormCommon from a dict
lead_form_common_from_dict = LeadFormCommon.from_dict(lead_form_common_dict)
```
