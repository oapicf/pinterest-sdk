...
with pinterestsdk.ApiClient(configuration) as api_client:
    ...
    api_instance = pinterestsdk.ConversionDeletionRequestsApi(api_client)
    ad_account_id = 'ad_account_id_example' # str | Unique identifier of an ad account.
    conversion_deletion_request_create = pinterestsdk.ConversionDeletionRequestCreate() # ConversionDeletionRequestCreate | 

    try:
        # Create a conversion deletion request
        api_response = api_instance.conversion_deletion_request_create(ad_account_id, conversion_deletion_request_create)
        print("The response of ConversionDeletionRequestsApi->conversion_deletion_request_create:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ConversionDeletionRequestsApi->conversion_deletion_request_create: %s\n" % e)
```
...
with pinterestsdk.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = pinterestsdk.ConversionDeletionRequestsApi(api_client)
    request_id = 'request_id_example' # str | Unique identifier of the conversion deletion request
    ad_account_id = 'ad_account_id_example' # str | Unique identifier of an ad account.

    try:
        # Delete a conversion deletion request
        api_response = api_instance.conversion_deletion_request_delete(request_id, ad_account_id)
        print("The response of ConversionDeletionRequestsApi->conversion_deletion_request_delete:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ConversionDeletionRequestsApi->conversion_deletion_request_delete: %s\n" % e)
```
...
with pinterestsdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Get a single conversion deletion request
        api_response = api_instance.conversion_deletion_request_get(request_id, ad_account_id)
        print("The response of ConversionDeletionRequestsApi->conversion_deletion_request_get:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ConversionDeletionRequestsApi->conversion_deletion_request_get: %s\n" % e)
```
...
> ConversionDeletionRequestList200Response conversion_deletion_request_list(ad_account_id, bookmark=bookmark, page_size=page_size, order=order)
...
with pinterestsdk.ApiClient(configuration) as api_client:
    ...
    try:
        # List conversion deletion requests
        api_response = api_instance.conversion_deletion_request_list(ad_account_id, bookmark=bookmark, page_size=page_size, order=order)
        print("The response of ConversionDeletionRequestsApi->conversion_deletion_request_list:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ConversionDeletionRequestsApi->conversion_deletion_request_list: %s\n" % e)
```
