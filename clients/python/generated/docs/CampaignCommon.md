...
json = "{}"
# create an instance of CampaignCommon from a JSON string
campaign_common_instance = CampaignCommon.from_json(json)
# print the JSON string representation of the object
print(CampaignCommon.to_json())

# convert the object into a dict
campaign_common_dict = campaign_common_instance.to_dict()
# create an instance of CampaignCommon from a dict
campaign_common_from_dict = CampaignCommon.from_dict(campaign_common_dict)
```
