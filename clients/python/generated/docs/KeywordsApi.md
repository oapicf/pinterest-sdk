...
with pinterestsdk.ApiClient(configuration) as api_client:
    ...
    api_instance = pinterestsdk.KeywordsApi(api_client)
    ad_account_id = 'ad_account_id_example' # str | Unique identifier of an ad account.
    keywords_create = pinterestsdk.KeywordsCreate() # KeywordsCreate | 
...
with pinterestsdk.ApiClient(configuration) as api_client:
    ...
    match_types = [pinterestsdk.MatchType()] # List[MatchType] | Keyword [match type](/docs/api-features/targeting-overview/) (optional)
...
with pinterestsdk.ApiClient(configuration) as api_client:
    ...
    api_instance = pinterestsdk.KeywordsApi(api_client)
    ad_account_id = 'ad_account_id_example' # str | Unique identifier of an ad account.
    keywords_update = pinterestsdk.KeywordsUpdate() # KeywordsUpdate | 
