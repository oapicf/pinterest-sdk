...
**accepted_terms_time** | **str** | The UTC timestamp (to the nearest sec) of when terms were accepted | [optional] 
...
**media_contact_firstname** | **str** | Billing contact first name | [optional] 
**media_contact_lastname** | **str** | Billing contact first name | [optional] 
