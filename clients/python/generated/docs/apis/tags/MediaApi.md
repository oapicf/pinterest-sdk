<a name="__pageTop"></a>
# pinterestsdk.apis.tags.media_api.MediaApi

All URIs are relative to *https://api.pinterest.com/v5*

Method | HTTP request | Description
------------- | ------------- | -------------
[**media_create**](#media_create) | **post** /media | Register media upload
[**media_get**](#media_get) | **get** /media/{media_id} | Get media upload details
[**media_list**](#media_list) | **get** /media | List media uploads

# **media_create**
<a name="media_create"></a>
...
```python
import pinterestsdk
from pinterestsdk.apis.tags import media_api
...
201 | [ApiResponseFor201](#media_create.ApiResponseFor201) | response
default | [ApiResponseForDefault](#media_create.ApiResponseForDefault) | Unexpected error

#### media_create.ApiResponseFor201
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
...
#### media_create.ApiResponseForDefault
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
...
------------- | ------------- | -------------
n/a | api_client.ApiResponseWithoutDeserialization | When skip_deserialization is True this response is returned
200 | [ApiResponseFor200](#media_get.ApiResponseFor200) | response
404 | [ApiResponseFor404](#media_get.ApiResponseFor404) | Media upload not found
default | [ApiResponseForDefault](#media_get.ApiResponseForDefault) | Unexpected error

#### media_get.ApiResponseFor200
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
...
#### media_get.ApiResponseForDefault
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
body | typing.Union[SchemaFor0ResponseBodyApplicationJson, ] |  |
...
------------- | ------------- | -------------
n/a | api_client.ApiResponseWithoutDeserialization | When skip_deserialization is True this response is returned
200 | [ApiResponseFor200](#media_list.ApiResponseFor200) | response
default | [ApiResponseForDefault](#media_list.ApiResponseForDefault) | Unexpected error

#### media_list.ApiResponseFor200
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
body | typing.Union[SchemaFor200ResponseBodyApplicationJson, ] |  |
...
------------ | ------------- | ------------- | ------------- | -------------
**[items](#items)** | list, tuple,  | tuple,  | Media | [optional] 
...
Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | -------------
list, tuple,  | tuple,  | Media | 

### Tuple Items
Class Name | Input Type | Accessed Type | Description | Notes
------------- | ------------- | ------------- | ------------- | -------------
[**MediaUploadDetails**]({{complexTypePrefix}}MediaUploadDetails.md) | [**MediaUploadDetails**]({{complexTypePrefix}}MediaUploadDetails.md) | [**MediaUploadDetails**]({{complexTypePrefix}}MediaUploadDetails.md) |  | 

#### media_list.ApiResponseForDefault
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
body | typing.Union[SchemaFor0ResponseBodyApplicationJson, ] |  |
