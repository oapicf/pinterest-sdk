...
json = "{}"
# create an instance of LeadFormUpdateRequest from a JSON string
lead_form_update_request_instance = LeadFormUpdateRequest.from_json(json)
# print the JSON string representation of the object
print(LeadFormUpdateRequest.to_json())

# convert the object into a dict
lead_form_update_request_dict = lead_form_update_request_instance.to_dict()
# create an instance of LeadFormUpdateRequest from a dict
lead_form_update_request_from_dict = LeadFormUpdateRequest.from_dict(lead_form_update_request_dict)
```
