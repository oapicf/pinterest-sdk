...
json = "{}"
# create an instance of CampaignCreateCommon from a JSON string
campaign_create_common_instance = CampaignCreateCommon.from_json(json)
# print the JSON string representation of the object
print(CampaignCreateCommon.to_json())

# convert the object into a dict
campaign_create_common_dict = campaign_create_common_instance.to_dict()
# create an instance of CampaignCreateCommon from a dict
campaign_create_common_from_dict = CampaignCreateCommon.from_dict(campaign_create_common_dict)
```
