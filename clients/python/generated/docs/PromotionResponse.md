...
**ad_account_id** | **str** | The Ad Account ID that this promotion belongs to. | [optional] 
**id** | **str** | Promotion ID | [optional] 
...
json = "{}"
# create an instance of PromotionResponse from a JSON string
promotion_response_instance = PromotionResponse.from_json(json)
# print the JSON string representation of the object
print(PromotionResponse.to_json())

# convert the object into a dict
promotion_response_dict = promotion_response_instance.to_dict()
# create an instance of PromotionResponse from a dict
promotion_response_from_dict = PromotionResponse.from_dict(promotion_response_dict)
```
