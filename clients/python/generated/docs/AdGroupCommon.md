...
json = "{}"
# create an instance of AdGroupCommon from a JSON string
ad_group_common_instance = AdGroupCommon.from_json(json)
# print the JSON string representation of the object
print(AdGroupCommon.to_json())

# convert the object into a dict
ad_group_common_dict = ad_group_common_instance.to_dict()
# create an instance of AdGroupCommon from a dict
ad_group_common_from_dict = AdGroupCommon.from_dict(ad_group_common_dict)
```
