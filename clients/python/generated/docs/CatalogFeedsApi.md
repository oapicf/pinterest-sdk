...
with pinterestsdk.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = pinterestsdk.CatalogFeedsApi(api_client)
    catalogs_feed_create_request_schema = pinterestsdk.CatalogsFeedCreateRequestSchema() # CatalogsFeedCreateRequestSchema | 
    ad_account_id = 'ad_account_id_example' # str | Unique identifier of an ad account. (optional)
...
with pinterestsdk.ApiClient(configuration) as api_client:
    ...
    api_instance = pinterestsdk.CatalogFeedsApi(api_client)
    feed_id = 'feed_id_example' # str | Unique identifier of a feed.
    catalogs_feed_update_request_schema = pinterestsdk.CatalogsFeedUpdateRequestSchema() # CatalogsFeedUpdateRequestSchema | 
    ad_account_id = 'ad_account_id_example' # str | Unique identifier of an ad account. (optional)
