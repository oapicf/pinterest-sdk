...
**objective_type** | [**ConversionObjectiveType**](ConversionObjectiveType.md) |  | [optional] 
...
campaign_batch_update_item_instance = CampaignBatchUpdateItem.from_json(json)
# print the JSON string representation of the object
print(CampaignBatchUpdateItem.to_json())

# convert the object into a dict
campaign_batch_update_item_dict = campaign_batch_update_item_instance.to_dict()
# create an instance of CampaignBatchUpdateItem from a dict
campaign_batch_update_item_from_dict = CampaignBatchUpdateItem.from_dict(campaign_batch_update_item_dict)
```
