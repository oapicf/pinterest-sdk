...
------------ | ------------- | ------------- | -------------
**action_source** | **str** | &lt;p&gt;The source indicating where the conversion event occurred.&lt;/p&gt; - &#x60;app_android&#x60; - &#x60;app_ios&#x60; - &#x60;web&#x60; - &#x60;offline&#x60; | 
...
conversion_events_data_inner_instance = ConversionEventsDataInner.from_json(json)
# print the JSON string representation of the object
print(ConversionEventsDataInner.to_json())

# convert the object into a dict
conversion_events_data_inner_dict = conversion_events_data_inner_instance.to_dict()
# create an instance of ConversionEventsDataInner from a dict
conversion_events_data_inner_from_dict = ConversionEventsDataInner.from_dict(conversion_events_data_inner_dict)
```
