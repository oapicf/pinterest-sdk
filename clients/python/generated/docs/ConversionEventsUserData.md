...
json = "{}"
# create an instance of ConversionEventsUserData from a JSON string
conversion_events_user_data_instance = ConversionEventsUserData.from_json(json)
# print the JSON string representation of the object
print(ConversionEventsUserData.to_json())

# convert the object into a dict
conversion_events_user_data_dict = conversion_events_user_data_instance.to_dict()
# create an instance of ConversionEventsUserData from a dict
conversion_events_user_data_from_dict = ConversionEventsUserData.from_dict(conversion_events_user_data_dict)
```
