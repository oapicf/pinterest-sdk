...
SchemaFor200ResponseBodyApplicationJson = BookClosedResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _metrics_ready_state_get_oapg(
        self,
...
class MetricsReadyStateGet(BaseApi):
    ...
    def metrics_ready_state_get(
        ...
        return self._metrics_ready_state_get_oapg(
