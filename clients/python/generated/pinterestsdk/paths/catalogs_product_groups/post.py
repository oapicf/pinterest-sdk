...
# body param
SchemaForRequestBodyApplicationJson = CatalogsProductGroupCreateRequest


request_body_catalogs_product_group_create_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = CatalogsProductGroup
...
class BaseApi(api_client.Api):
    @typing.overload
    def _catalogs_product_groups_create_oapg(
        self,
    ...
    def _catalogs_product_groups_create_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_catalogs_product_group_create_request.serialize(body, content_type)
...
class CatalogsProductGroupsCreate(BaseApi):
    ...
    def catalogs_product_groups_create(
        ...
        return self._catalogs_product_groups_create_oapg(
            body=body,
