...
request_body_campaign_create_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = CampaignCreateResponse
...
class BaseApi(api_client.Api):
    ...
    def _campaigns_create_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_campaign_create_request.serialize(body, content_type)
...
class CampaignsCreate(BaseApi):
    ...
    def campaigns_create(
        ...
        return self._campaigns_create_oapg(
            body=body,
