...
request_body_campaign_update_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = CampaignUpdateResponse
...
class BaseApi(api_client.Api):
    ...
    def _campaigns_update_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_campaign_update_request.serialize(body, content_type)
...
class CampaignsUpdate(BaseApi):
    ...
    def campaigns_update(
        ...
        return self._campaigns_update_oapg(
            body=body,
