...
# body param
SchemaForRequestBodyApplicationJson = AudienceCreateRequest


request_body_audience_create_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _audiences_create_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_audience_create_request.serialize(body, content_type)
...
class AudiencesCreate(BaseApi):
    ...
    def audiences_create(
        ...
        return self._audiences_create_oapg(
            body=body,
