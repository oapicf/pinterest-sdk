...
request_body_ad_group_update_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _ad_groups_update_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_ad_group_update_request.serialize(body, content_type)
...
class AdGroupsUpdate(BaseApi):
    ...
    def ad_groups_update(
        ...
        return self._ad_groups_update_oapg(
            body=body,
