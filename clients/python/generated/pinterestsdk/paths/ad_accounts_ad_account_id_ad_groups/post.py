...
request_body_ad_group_create_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = AdGroupArrayResponse
...
class BaseApi(api_client.Api):
    ...
    def _ad_groups_create_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_ad_group_create_request.serialize(body, content_type)
...
class AdGroupsCreate(BaseApi):
    ...
    def ad_groups_create(
        ...
        return self._ad_groups_create_oapg(
            body=body,
