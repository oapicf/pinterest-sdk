...
SchemaFor200ResponseBodyApplicationJson = TopVideoPinsAnalyticsResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _user_account_analytics_top_video_pins_oapg(
        self,
...
class UserAccountAnalyticsTopVideoPins(BaseApi):
    ...
    def user_account_analytics_top_video_pins(
        ...
        return self._user_account_analytics_top_video_pins_oapg(
