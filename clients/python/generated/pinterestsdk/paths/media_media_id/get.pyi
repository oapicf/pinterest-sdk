...
RequestRequiredPathParams = typing_extensions.TypedDict(
    ...
    {
        'media_id': typing.Union[MediaIdSchema, str, ],
    }
)
...
request_path_media_id = api_client.PathParameter(
    name="media_id",
    style=api_client.ParameterStyle.SIMPLE,
    schema=MediaIdSchema,
    required=True,
)
SchemaFor200ResponseBodyApplicationJson = MediaUploadDetails
