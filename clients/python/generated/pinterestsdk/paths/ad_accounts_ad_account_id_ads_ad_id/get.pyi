...
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        ...
        'ad_id': typing.Union[AdIdSchema, str, ],
    }
)
...
request_path_ad_id = api_client.PathParameter(
    name="ad_id",
    style=api_client.ParameterStyle.SIMPLE,
    schema=AdIdSchema,
    required=True,
)
SchemaFor200ResponseBodyApplicationJson = AdResponse
