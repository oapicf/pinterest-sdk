...
# body param
SchemaForRequestBodyApplicationJson = CatalogsFeedsCreateRequest


request_body_catalogs_feeds_create_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = CatalogsFeed
...
class BaseApi(api_client.Api):
    ...
    def _feeds_create_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_catalogs_feeds_create_request.serialize(body, content_type)
...
class FeedsCreate(BaseApi):
    ...
    def feeds_create(
        ...
        return self._feeds_create_oapg(
            body=body,
