...
# body param
SchemaForRequestBodyApplicationJson = KeywordUpdateBody


request_body_keyword_update_body = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _keywords_update_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_keyword_update_body.serialize(body, content_type)
...
class KeywordsUpdate(BaseApi):
    ...
    def keywords_update(
        ...
        return self._keywords_update_oapg(
            body=body,
