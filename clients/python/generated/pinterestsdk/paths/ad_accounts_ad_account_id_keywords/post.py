...
# body param
SchemaForRequestBodyApplicationJson = KeywordsRequest


request_body_keywords_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _keywords_create_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_keywords_request.serialize(body, content_type)
...
class KeywordsCreate(BaseApi):
    ...
    def keywords_create(
        ...
        return self._keywords_create_oapg(
            body=body,
