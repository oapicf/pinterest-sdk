...
# body param
SchemaForRequestBodyApplicationJson = CatalogsItemsBatchRequest


request_body_catalogs_items_batch_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = CatalogsItemsBatch
...
class BaseApi(api_client.Api):
    ...
    def _items_batch_post_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_catalogs_items_batch_request.serialize(body, content_type)
...
class ItemsBatchPost(BaseApi):
    ...
    def items_batch_post(
        ...
        return self._items_batch_post_oapg(
            body=body,
