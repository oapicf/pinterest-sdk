...
# body param
SchemaForRequestBodyApplicationJson = Pin


request_body_pin = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _pins_create_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_pin.serialize(body, content_type)
