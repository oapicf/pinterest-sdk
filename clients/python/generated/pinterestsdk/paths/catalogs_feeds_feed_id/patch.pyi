...
# body param
SchemaForRequestBodyApplicationJson = CatalogsFeedsUpdateRequest


request_body_catalogs_feeds_update_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = CatalogsFeed
...
class BaseApi(api_client.Api):
    ...
    def _feeds_update_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_catalogs_feeds_update_request.serialize(body, content_type)
...
class FeedsUpdate(BaseApi):
    ...
    def feeds_update(
        ...
        return self._feeds_update_oapg(
            body=body,
