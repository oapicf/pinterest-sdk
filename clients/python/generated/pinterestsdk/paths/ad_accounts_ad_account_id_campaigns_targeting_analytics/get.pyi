...
AttributionTypesSchema = ConversionReportAttributionType
RequestRequiredQueryParams = typing_extensions.TypedDict(
    'RequestRequiredQueryParams',
    {
        'campaign_ids': typing.Union[CampaignIdsSchema, list, tuple, ],
        'start_date': typing.Union[StartDateSchema, str, date, ],
        'end_date': typing.Union[EndDateSchema, str, date, ],
        'targeting_types': typing.Union[TargetingTypesSchema, list, tuple, ],
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'attribution_types': typing.Union[AttributionTypesSchema, ],
    },
    total=False
)
...
request_query_targeting_types = api_client.QueryParameter(
    name="targeting_types",
    style=api_client.ParameterStyle.FORM,
    schema=TargetingTypesSchema,
    required=True,
)
...
request_query_attribution_types = api_client.QueryParameter(
    name="attribution_types",
    style=api_client.ParameterStyle.FORM,
    schema=AttributionTypesSchema,
)
# Path params
...
SchemaFor200ResponseBodyApplicationJson = MetricsResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _campaign_targeting_analytics_get_oapg(
        self,
    ...
    def _campaign_targeting_analytics_get_oapg(
        ...
        for parameter in (
            ...
            request_query_attribution_types,
        ):
...
class CampaignTargetingAnalyticsGet(BaseApi):
    ...
    def campaign_targeting_analytics_get(
        ...
        return self._campaign_targeting_analytics_get_oapg(
