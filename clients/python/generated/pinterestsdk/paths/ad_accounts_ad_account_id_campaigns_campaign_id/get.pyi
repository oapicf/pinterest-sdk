...
request_path_campaign_id = api_client.PathParameter(
    name="campaign_id",
    style=api_client.ParameterStyle.SIMPLE,
    schema=CampaignIdSchema,
    required=True,
)
SchemaFor200ResponseBodyApplicationJson = CampaignResponse
...
class CampaignsGet(BaseApi):
    ...
    def campaigns_get(
        ...
        return self._campaigns_get_oapg(
