...
# body param
SchemaForRequestBodyApplicationJson = ProductGroupPromotionCreateRequest


request_body_product_group_promotion_create_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ProductGroupPromotionArrayResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _product_group_promotions_create_oapg(
        self,
    ...
    def _product_group_promotions_create_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_product_group_promotion_create_request.serialize(body, content_type)
...
class ProductGroupPromotionsCreate(BaseApi):
    ...
    def product_group_promotions_create(
        ...
        return self._product_group_promotions_create_oapg(
            body=body,
