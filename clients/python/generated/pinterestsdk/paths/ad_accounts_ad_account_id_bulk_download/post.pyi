...
# body param
SchemaForRequestBodyApplicationJson = BulkDownloadRequest


request_body_bulk_download_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = BulkDownloadResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _bulk_download_create_oapg(
        self,
    ...
    def _bulk_download_create_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_bulk_download_request.serialize(body, content_type)
...
class BulkDownloadCreate(BaseApi):
    ...
    def bulk_download_create(
        ...
        return self._bulk_download_create_oapg(
            body=body,
