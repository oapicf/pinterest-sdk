...
# body param
SchemaForRequestBodyApplicationJson = BidFloorRequest


request_body_bid_floor_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = BidFloor
...
class BaseApi(api_client.Api):
    @typing.overload
    def _ad_groups_bid_floor_get_oapg(
        self,
    ...
    def _ad_groups_bid_floor_get_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_bid_floor_request.serialize(body, content_type)
...
class AdGroupsBidFloorGet(BaseApi):
    ...
    def ad_groups_bid_floor_get(
        ...
        return self._ad_groups_bid_floor_get_oapg(
            body=body,
