...
class AdAccountIdSchema(
    ...
    pass
BulkRequestIdSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'ad_account_id': typing.Union[AdAccountIdSchema, str, ],
        'bulk_request_id': typing.Union[BulkRequestIdSchema, str, ],
    }
)
...
request_path_bulk_request_id = api_client.PathParameter(
    name="bulk_request_id",
    style=api_client.ParameterStyle.SIMPLE,
    schema=BulkRequestIdSchema,
    required=True,
)
SchemaFor200ResponseBodyApplicationJson = BulkUpsertStatusResponse
...
class BulkRequestGet(BaseApi):
    ...
    def bulk_request_get(
        ...
        return self._bulk_request_get_oapg(
