...
SchemaFor200ResponseBodyApplicationJson = CatalogsProductGroupProductCounts
...
class BaseApi(api_client.Api):
    @typing.overload
    def _catalogs_product_groups_product_counts_get_oapg(
        self,
...
class CatalogsProductGroupsProductCountsGet(BaseApi):
    ...
    def catalogs_product_groups_product_counts_get(
        ...
        return self._catalogs_product_groups_product_counts_get_oapg(
