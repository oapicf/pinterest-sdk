...
ItemValidationIssueSchema = CatalogsItemValidationIssue
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'item_numbers': typing.Union[ItemNumbersSchema, list, tuple, ],
        'item_validation_issue': typing.Union[ItemValidationIssueSchema, ],
...
request_query_item_numbers = api_client.QueryParameter(
    name="item_numbers",
    style=api_client.ParameterStyle.FORM,
    schema=ItemNumbersSchema,
    explode=True,
)
request_query_item_validation_issue = api_client.QueryParameter(
    name="item_validation_issue",
    style=api_client.ParameterStyle.FORM,
    schema=ItemValidationIssueSchema,
    explode=True,
)
...
class ProcessingResultIdSchema(
    schemas.StrSchema
):
    pass
RequestRequiredPathParams = typing_extensions.TypedDict(
    ...
    {
        'processing_result_id': typing.Union[ProcessingResultIdSchema, str, ],
    }
)
...
request_path_processing_result_id = api_client.PathParameter(
    name="processing_result_id",
    style=api_client.ParameterStyle.SIMPLE,
    schema=ProcessingResultIdSchema,
    required=True,
)
                ...
                class properties:
                    ...
                    class items(
                        ...
                        class MetaOapg:
                            ...
                            @staticmethod
                            def items() -> typing.Type['CatalogsItemValidationIssues']:
                                return CatalogsItemValidationIssues
                    
                        def __new__(
                            cls,
                            arg: typing.Union[typing.Tuple['CatalogsItemValidationIssues'], typing.List['CatalogsItemValidationIssues']],
                            _configuration: typing.Optional[schemas.Configuration] = None,
                        ) -> 'items':
                            return super().__new__(
                                cls,
                        ...
                        def __getitem__(self, i: int) -> 'CatalogsItemValidationIssues':
                            return super().__getitem__(i)
                    __annotations__ = {
                        "items": items,
                    }
...
SchemaFor501ResponseBodyApplicationJson = Error
...
class BaseApi(api_client.Api):
    ...
    def _items_issues_list_oapg(
        ...
        _path_params = {}
        for parameter in (
            request_path_processing_result_id,
        ):
        ...
        for parameter in (
            ...
            request_query_item_numbers,
            request_query_item_validation_issue,
...
class ItemsIssuesList(BaseApi):
    ...
    def items_issues_list(
        ...
        return self._items_issues_list_oapg(
