...
SchemaFor200ResponseBodyApplicationJson = DeliveryMetricsResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _delivery_metrics_get_oapg(
        self,
...
class DeliveryMetricsGet(BaseApi):
    ...
    def delivery_metrics_get(
        ...
        return self._delivery_metrics_get_oapg(
