...
RequestRequiredQueryParams = typing_extensions.TypedDict(
    ...
    {
        'ad_ids': typing.Union[AdIdsSchema, list, tuple, ],
...
request_query_ad_ids = api_client.QueryParameter(
    name="ad_ids",
...
class BaseApi(api_client.Api):
    @typing.overload
    def _ad_targeting_analytics_get_oapg(
        self,
...
class AdTargetingAnalyticsGet(BaseApi):
    ...
    def ad_targeting_analytics_get(
        ...
        return self._ad_targeting_analytics_get_oapg(
