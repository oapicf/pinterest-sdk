...
RequestRequiredQueryParams = typing_extensions.TypedDict(
    ...
    {
        'ad_group_ids': typing.Union[AdGroupIdsSchema, list, tuple, ],
...
class BaseApi(api_client.Api):
    @typing.overload
    def _ad_groups_targeting_analytics_get_oapg(
        self,
...
class AdGroupsTargetingAnalyticsGet(BaseApi):
    ...
    def ad_groups_targeting_analytics_get(
        ...
        return self._ad_groups_targeting_analytics_get_oapg(
