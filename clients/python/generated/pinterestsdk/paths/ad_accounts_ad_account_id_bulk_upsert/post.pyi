...
# body param
SchemaForRequestBodyApplicationJson = BulkUpsertRequest


request_body_bulk_upsert_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = BulkUpsertResponse
...
class BaseApi(api_client.Api):
    ...
    def _bulk_upsert_create_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_bulk_upsert_request.serialize(body, content_type)
...
class BulkUpsertCreate(BaseApi):
    ...
    def bulk_upsert_create(
        ...
        return self._bulk_upsert_create_oapg(
            body=body,
