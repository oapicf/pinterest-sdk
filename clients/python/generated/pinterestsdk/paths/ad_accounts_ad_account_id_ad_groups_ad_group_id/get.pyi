...
request_path_ad_group_id = api_client.PathParameter(
    name="ad_group_id",
    style=api_client.ParameterStyle.SIMPLE,
    schema=AdGroupIdSchema,
    required=True,
)
SchemaFor200ResponseBodyApplicationJson = AdGroupResponse
...
class AdGroupsGet(BaseApi):
    ...
    def ad_groups_get(
        ...
        return self._ad_groups_get_oapg(
