...
# body param
SchemaForRequestBodyApplicationJson = CustomerListRequest


request_body_customer_list_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _customer_lists_create_oapg(
        self,
    ...
    def _customer_lists_create_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_customer_list_request.serialize(body, content_type)
...
class CustomerListsCreate(BaseApi):
    ...
    def customer_lists_create(
        ...
        return self._customer_lists_create_oapg(
            body=body,
