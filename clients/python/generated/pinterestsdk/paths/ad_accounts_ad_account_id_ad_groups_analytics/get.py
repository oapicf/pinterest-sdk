...
SchemaFor200ResponseBodyApplicationJson = AdGroupsAnalyticsResponse
...
class AdGroupsAnalytics(BaseApi):
    ...
    def ad_groups_analytics(
        ...
        return self._ad_groups_analytics_oapg(
