...
# body param
SchemaForRequestBodyApplicationJson = AdPreviewRequest


request_body_ad_preview_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = AdPreviewURLResponse
...
class BaseApi(api_client.Api):
    ...
    def _ad_previews_create_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_ad_preview_request.serialize(body, content_type)
...
class AdPreviewsCreate(BaseApi):
    ...
    def ad_previews_create(
        ...
        return self._ad_previews_create_oapg(
            body=body,
