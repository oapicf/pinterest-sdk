...
class OauthApi:
    ...
    def oauth_conversion_token_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ConversionAccessToken]:
        """Generate OAuth access token for conversion API
    ...
    def _oauth_token_serialize(
        ...
        if continuous_refresh is not None:
            _form_params.append(('continuous_refresh', continuous_refresh))
    ...
    def token_revoke(
        ...
        token_type_hint: Annotated[Optional[Any], Field(description="The type of the token to revoke. Please refer to [our developer guide for more information](https://developers.pinterest.com/docs/getting-started/set-up-authentication-and-authorization/) for more information.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
