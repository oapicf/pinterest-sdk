...
class AdAccountsApi:
    ...
    def ad_account_analytics_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[AdAccountAnalyticsItems]]:
        """Get ad account analytics
    ...
    def analytics_create_conversion_product_report(
        ...
        _param = self._analytics_create_conversion_product_report_serialize(
            ad_account_id=ad_account_id,
            conversion_product_report_create=conversion_product_report_create,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def analytics_create_conversion_product_report_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ConversionProductReport]:
        """Create a request for a brand, category, SKU report
    ...
    def _analytics_create_conversion_product_report_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if conversion_product_report_create is not None:
            _body_params = conversion_product_report_create
    ...
    def analytics_create_mmm_report(
        ...
        _param = self._analytics_create_mmm_report_serialize(
            ad_account_id=ad_account_id,
            mmm_report_create=mmm_report_create,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _analytics_create_mmm_report_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if mmm_report_create is not None:
            _body_params = mmm_report_create
    ...
    def analytics_create_template_report(
        ...
        granularity: Annotated[Optional[Granularity], Field(description="  TOTAL - metrics are aggregated over the specified date range.    DAY - metrics are broken down daily.    HOUR - metrics are broken down hourly.    WEEK - metrics are broken down weekly.    MONTH - metrics are broken down monthly")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
