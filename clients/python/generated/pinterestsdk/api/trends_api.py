...
class TrendsApi:
    ...
    @validate_call
    def trends_editorial_articles_list(
        self,
        ...
        _param = self._trends_editorial_articles_list_serialize(
            region=region,
    ...
    @validate_call
    def trends_editorial_articles_list_with_http_info(
        self,
        region: Annotated[ProductCategoryRegion, Field(description="     The geographic region of interest. Only top product categories within the specified region will be returned.      The `region` parameter is formatted as ISO 3166-2 country codes delimited by `+`.      - `US` - United States     - `GB+IE` - Great Britain & Ireland     - `CA` - Canada")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[TrendsEditorial]]:
        """Returns editorial articles for a given region
    ...
    @validate_call
    def trends_editorial_articles_list_without_preload_content(
        self,
        region: Annotated[ProductCategoryRegion, Field(description="     The geographic region of interest. Only top product categories within the specified region will be returned.      The `region` parameter is formatted as ISO 3166-2 country codes delimited by `+`.      - `US` - United States     - `GB+IE` - Great Britain & Ireland     - `CA` - Canada")],
        _request_timeout: Union[
            None,
    ...
    def _trends_editorial_articles_list_serialize(
        self,
        region,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/trends/editorial_articles',
