...
class KeywordsApi:
    ...
    def _keywords_create_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if keywords_create is not None:
            _body_params = keywords_create
    ...
    def keywords_get(
        ...
        match_types: Annotated[Optional[Annotated[List[MatchType], Field(min_length=1, max_length=5)]], Field(description="Keyword [match type](/docs/api-features/targeting-overview/)")] = None,
    ...
    def trending_keywords_list(
        ...
        genders: Annotated[Optional[List[TrendsGenderFilter]], Field(description="If set, filters the results to trends among users who identify with the specified gender(s). If unset, trends among all genders will be returned. The `unknown` group includes users with unspecified or customized gender profile settings.")] = None,
        ages: Annotated[Optional[List[TrendsAgeBucket]], Field(description="If set, filters the results to trends among users in the specified age range(s). If unset, trends among all age groups will be returned.")] = None,
        ...
        include_demographics: Annotated[Optional[StrictBool], Field(description="Including the age and gender distribution for each keyword. By default (`false`), the response will not include demographics data.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
