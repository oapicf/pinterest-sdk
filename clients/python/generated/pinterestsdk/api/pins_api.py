...
class PinsApi:
    ...
    def pins_list(
        self,
        pin_filter: Annotated[Optional[PinFilter], Field(description="The filter to apply to the pins")] = None,
        pin_metrics: Annotated[Optional[StrictBool], Field(description="Specify whether to return 90d and lifetime Pin metrics. Total comments and total reactions are only available with lifetime Pin metrics. If Pin was created before `2023-03-20` lifetime metrics will only be available for Video and Idea Pin formats. Lifetime metrics are available for all Pin formats since then.")] = None,
        ...
        pin_type: Annotated[Optional[PinType], Field(description="The type of pins to return, currently only enabled for private pins")] = None,
        ...
        ad_account_id: Annotated[Optional[Annotated[str, Field(strict=True, max_length=18)]], Field(description="Unique identifier of an ad account.")] = None,
        domain: Annotated[Optional[StrictStr], Field(description="Only return pins with links that match the exact domain. Domain should not include 'www.' prefix. For example, 'pinterest.com' is a valid domain, but 'www.pinterest.com' is not (will not match any pins).")] = None,
        domains: Annotated[Optional[Annotated[List[StrictStr], Field(min_length=1, max_length=100)]], Field(description="Only return pins with links whose domain matches any value in the list. Values are joined comma-separated on the wire (e.g. `?domains=instagram.com,jcpenney.com`).")] = None,
        include_product_tag_obj: Annotated[Optional[StrictBool], Field(description="Include product tag objects in the response with their associated links.")] = None,
        ...
        _param = self._pins_list_serialize(
            ...
            domain=domain,
            domains=domains,
            include_product_tag_obj=include_product_tag_obj,
            bookmark=bookmark,
            page_size=page_size,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    def _pins_list_serialize(
        ...
        if pin_filter is not None:
            ...
            _query_params.append(('pin_filter', pin_filter.value))
        ...
        if pin_type is not None:
            ...
            _query_params.append(('pin_type', pin_type.value))
        ...
        if include_product_tag_obj is not None:
            
            _query_params.append(('include_product_tag_obj', include_product_tag_obj))
    ...
    def pins_save(
        ...
        _param = self._pins_save_serialize(
            pin_id=pin_id,
            pins_save_request_create=pins_save_request_create,
            ad_account_id=ad_account_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _pins_save_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if pins_save_request_create is not None:
            _body_params = pins_save_request_create
