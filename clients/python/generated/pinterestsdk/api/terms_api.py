...
class TermsApi:
    ...
    def terms_related_list(
        ...
        _param = self._terms_related_list_serialize(
            terms=terms,
    ...
    @validate_call
    def terms_related_list_with_http_info(
        self,
        terms: Annotated[List[StrictStr], Field(description="List of input terms.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def terms_related_list_without_preload_content(
        self,
        terms: Annotated[List[StrictStr], Field(description="List of input terms.")],
        _request_timeout: Union[
            None,
    ...
    def _terms_related_list_serialize(
        self,
        terms,
        _request_auth,
        _content_type,
    ...
    def terms_suggested_list(
        ...
        limit: Annotated[Optional[Annotated[int, Field(le=10, strict=True, ge=1)]], Field(description="Max suggested terms to return.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._terms_suggested_list_serialize(
            term=term,
            limit=limit,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def terms_suggested_list_with_http_info(
        self,
        term: Annotated[StrictStr, Field(description="Input term.")],
        limit: Annotated[Optional[Annotated[int, Field(le=10, strict=True, ge=1)]], Field(description="Max suggested terms to return.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def terms_suggested_list_without_preload_content(
        self,
        term: Annotated[StrictStr, Field(description="Input term.")],
        limit: Annotated[Optional[Annotated[int, Field(le=10, strict=True, ge=1)]], Field(description="Max suggested terms to return.")] = None,
        _request_timeout: Union[
    ...
    def _terms_suggested_list_serialize(
        self,
        term,
        limit,
        _request_auth,
