...
class FeedFields(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, default_country, default_availability, default_currency, name, format, default_locale, credentials, location, preferred_processing_schedule, status, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, default_country, default_availability, default_currency, name, format, default_locale, credentials, location, preferred_processing_schedule, status, *args, **kwargs):  # noqa: E501
        """FeedFields - a model defined in OpenAPI
