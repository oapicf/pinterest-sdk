        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['KeywordMetricsResponse']:
                        return KeywordMetricsResponse
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['KeywordMetricsResponse'], typing.List['KeywordMetricsResponse']],
                ...
                def __getitem__(self, i: int) -> 'KeywordMetricsResponse':
