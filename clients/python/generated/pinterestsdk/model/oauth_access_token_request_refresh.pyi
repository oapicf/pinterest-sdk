...
class OauthAccessTokenRequestRefresh(
    ...
    class MetaOapg:
        ...
        class all_of_1(
            ...
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["refresh_token", "scope", ], str]):
            ...
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["refresh_token", "scope", ], str]):
