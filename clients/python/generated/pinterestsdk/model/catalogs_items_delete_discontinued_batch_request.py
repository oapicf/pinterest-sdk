        ...
        class properties:
            ...
            class items(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['ItemDeleteDiscontinuedBatchRecord']:
                        return ItemDeleteDiscontinuedBatchRecord
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['ItemDeleteDiscontinuedBatchRecord'], typing.List['ItemDeleteDiscontinuedBatchRecord']],
                ...
                def __getitem__(self, i: int) -> 'ItemDeleteDiscontinuedBatchRecord':
