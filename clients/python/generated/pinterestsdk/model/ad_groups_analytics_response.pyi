...
class AdGroupsAnalyticsResponse(
    ...
    class MetaOapg:
        ...
        class items(
            ...
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["AD_GROUP_ID"], typing_extensions.Literal["DATE"], str, ]):
            ...
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["AD_GROUP_ID"], typing_extensions.Literal["DATE"], str, ]):
