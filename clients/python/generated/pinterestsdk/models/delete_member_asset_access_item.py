...
class DeleteMemberAssetAccessItem(BaseModel):
    ...
    """ # noqa: E501
    asset_id: Annotated[str, Field(strict=True, max_length=25)] = Field(description="Id of the asset on which to remove member permissions.")
    member_id: Annotated[str, Field(strict=True, max_length=25)] = Field(description="Unique identifier of the member on which to perform the asset permission removal")
