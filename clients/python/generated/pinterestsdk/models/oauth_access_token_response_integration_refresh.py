...
class OauthAccessTokenResponseIntegrationRefresh(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["refresh_token", "refresh_token_expires_in", "access_token", "expires_in", "response_type", "scope", "token_type"]
