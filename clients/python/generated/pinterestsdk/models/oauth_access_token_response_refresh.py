...
class OauthAccessTokenResponseRefresh(BaseModel):
    ...
    refresh_token_expires_at: StrictInt
    refresh_token_expires_in: StrictInt
    __properties: ClassVar[List[str]] = ["access_token", "expires_in", "response_type", "scope", "token_type", "refresh_token", "refresh_token_expires_at", "refresh_token_expires_in"]
