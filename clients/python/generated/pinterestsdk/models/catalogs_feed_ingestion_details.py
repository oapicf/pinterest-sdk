...
class CatalogsFeedIngestionDetails(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "errors": CatalogsFeedIngestionErrors.from_dict(obj["errors"]) if obj.get("errors") is not None else None,
            "info": CatalogsFeedIngestionInfo.from_dict(obj["info"]) if obj.get("info") is not None else None,
            "warnings": CatalogsFeedIngestionWarnings.from_dict(obj["warnings"]) if obj.get("warnings") is not None else None
        })
        return _obj
