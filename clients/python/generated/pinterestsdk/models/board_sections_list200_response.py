...
class BoardSectionsList200Response(BaseModel):
    ...
    items: List[BoardSection] = Field(description="Board sections")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [BoardSection.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
