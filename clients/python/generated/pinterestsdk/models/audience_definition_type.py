...
class AudienceDefinitionType(BaseModel):
    """
    ...
    def scope_validate_enum(cls, value):
        ...
        if value not in set(['IMPRESSION_PLUS_ENGAGEMENT', 'ENGAGEMENT']):
            raise ValueError("must be one of enum values ('IMPRESSION_PLUS_ENGAGEMENT', 'ENGAGEMENT')")
        return value
