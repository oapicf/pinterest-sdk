...
class DeletePartnersRequest(BaseModel):
    """
    DeletePartnersRequest
    """ # noqa: E501
    partner_ids: Annotated[List[Annotated[str, Field(strict=True, max_length=22)]], Field(min_length=1, max_length=50)]
    partner_type: Optional[StrictStr] = None
