...
class CancelInviteResultItem(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "exception": CancelInviteException.from_dict(obj["exception"]) if obj.get("exception") is not None else None,
            "invite": CancelInviteResult.from_dict(obj["invite"]) if obj.get("invite") is not None else None
        })
        return _obj
