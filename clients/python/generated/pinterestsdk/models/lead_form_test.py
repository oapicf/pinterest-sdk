...
class LeadFormTest(BaseModel):
    ...
    """ # noqa: E501
    subscription_id: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="Subscription ID.", json_schema_extra={"examples": ["8078432025948590686"]})
