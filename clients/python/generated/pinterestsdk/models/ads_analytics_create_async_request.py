...
class AdsAnalyticsCreateAsyncRequest(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "custom_conversion_event_metrics": [CustomConversionEventMetrics.from_dict(_item) for _item in obj["custom_conversion_event_metrics"]] if obj.get("custom_conversion_event_metrics") is not None else None,
