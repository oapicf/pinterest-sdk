...
class SharedAudienceCommon(BaseModel):
    """
    SharedAudienceCommon
    """ # noqa: E501
    audience_id: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="Unique identifier of an audience")
    operation_type: Optional[OperationType] = None
    __properties: ClassVar[List[str]] = ["audience_id", "operation_type"]
