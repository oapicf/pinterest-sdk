...
class GetBusinessAssetsResponseCatalogInfo(BaseModel):
    """
    ...
    id: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="Catalog ID.")
    name: Optional[StrictStr] = Field(default=None, description="Catalog name")
    __properties: ClassVar[List[str]] = ["catalog_type", "id", "name"]
