...
class LeadFormsCreate200ResponseItemsInner(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": LeadForm.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "exceptions": [PinterestLibBatchItemException.from_dict(_item) for _item in obj["exceptions"]] if obj.get("exceptions") is not None else None
        })
        return _obj
