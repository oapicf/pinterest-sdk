...
class InviteAssetsSummaryProfilesInner(BaseModel):
    """
    InviteAssetsSummaryProfilesInner
    """ # noqa: E501
    id: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="Unique identifier of a business profile.")
