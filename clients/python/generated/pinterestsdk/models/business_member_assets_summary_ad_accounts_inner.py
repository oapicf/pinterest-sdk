...
class BusinessMemberAssetsSummaryAdAccountsInner(BaseModel):
    """
    BusinessMemberAssetsSummaryAdAccountsInner
    """ # noqa: E501
    id: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=20)]] = Field(default=None, description="Unique identifier of a business ad account.")
