...
class BulkUpsertRequest(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "create": BulkUpsertRequestCreate.from_dict(obj["create"]) if obj.get("create") is not None else None,
            "update": BulkUpsertRequestUpdate.from_dict(obj["update"]) if obj.get("update") is not None else None
        })
        return _obj
