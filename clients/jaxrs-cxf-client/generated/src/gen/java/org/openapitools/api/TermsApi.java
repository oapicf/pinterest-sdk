...
public interface TermsApi  {
    ...
    @ApiOperation(value = "List related terms", tags={  })
    @ApiResponses(value = { 
    ...
    public RelatedTerms termsRelatedList(@QueryParam("terms") List<String> terms);
    ...
    @Path("/suggested")
    @Produces({ "application/json" })
    @ApiOperation(value = "List suggested terms", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Success", response = String.class, responseContainer = "List"),
        @ApiResponse(code = 400, message = "Invalid terms suggested parameters.", response = Error.class),
        @ApiResponse(code = 200, message = "Unexpected error", response = Error.class) })
    public List<String> termsSuggestedList(@QueryParam("term") String term, @QueryParam("limit") @DefaultValue("4")Integer limit);
}
