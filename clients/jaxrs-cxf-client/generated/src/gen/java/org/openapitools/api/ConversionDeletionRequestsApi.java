...
public interface ConversionDeletionRequestsApi  {
    ...
    @ApiOperation(value = "Create a conversion deletion request", tags={  })
    @ApiResponses(value = { 
    ...
    public ConversionDeletionRequest conversionDeletionRequestCreate(@PathParam("ad_account_id") String adAccountId, ConversionDeletionRequestCreate conversionDeletionRequestCreate);
    ...
    @Path("/{request_id}")
    @Produces({ "application/json" })
    @ApiOperation(value = "Delete a conversion deletion request", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "The request has succeeded.", response = ConversionDeletionRequest.class),
        ...
        @ApiResponse(code = 429, message = "The user has sent too many requests in a given amount of time and is being rate limited.", response = PinterestLibError.class),
        @ApiResponse(code = 200, message = "An unexpected error response.", response = PinterestLibError.class) })
    public ConversionDeletionRequest conversionDeletionRequestDelete(@PathParam("request_id") String requestId, @PathParam("ad_account_id") String adAccountId);
    ...
    @Path("/{request_id}")
    @Produces({ "application/json" })
    @ApiOperation(value = "Get a single conversion deletion request", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "The request has succeeded.", response = ConversionDeletionRequest.class),
        @ApiResponse(code = 400, message = "The request could not be understood by the server due to unexpected data.", response = PinterestLibError.class),
        @ApiResponse(code = 401, message = "Authentication is required and has either failed or not been provided.", response = PinterestLibError.class),
        ...
        @ApiResponse(code = 429, message = "The user has sent too many requests in a given amount of time and is being rate limited.", response = PinterestLibError.class),
        @ApiResponse(code = 200, message = "An unexpected error response.", response = PinterestLibError.class) })
    public ConversionDeletionRequest conversionDeletionRequestGet(@PathParam("request_id") String requestId, @PathParam("ad_account_id") String adAccountId);
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "List conversion deletion requests", tags={  })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 429, message = "The user has sent too many requests in a given amount of time and is being rate limited.", response = PinterestLibError.class),
        @ApiResponse(code = 200, message = "An unexpected error response.", response = PinterestLibError.class) })
    public ConversionDeletionRequestList200Response conversionDeletionRequestList(@PathParam("ad_account_id") String adAccountId, @QueryParam("bookmark") String bookmark, @QueryParam("page_size") @DefaultValue("25")Integer pageSize, @QueryParam("order") PinterestLibPaginationOrder order);
}
