...
public interface MsotEventsApi  {
    ...
    @ApiOperation(value = "Send Measurement Source Of Truth (MSOT) attributed conversion events", tags={  })
    @ApiResponses(value = { 
    ...
    public void msotEventsCreate(@PathParam("ad_account_id") String adAccountId, ConversionMSOTEventsCreate conversionMSOTEventsCreate);
}
