...
public interface CustomerSegmentApi  {
    ...
    @ApiOperation(value = "Create customer segments", tags={  })
    @ApiResponses(value = { 
    ...
    public CustomerSegment customerSegmentCreate(@PathParam("ad_account_id") String adAccountId, CustomerSegmentCreate customerSegmentCreate);
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "List customer segments", tags={  })
    @ApiResponses(value = { 
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Update customer segments", tags={  })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 429, message = "The user has sent too many requests in a given amount of time and is being rate limited.", response = PinterestLibError.class),
        @ApiResponse(code = 200, message = "An unexpected error response.", response = PinterestLibError.class) })
    public void customerSegmentUpdate(@PathParam("ad_account_id") String adAccountId, CustomerSegmentUpdateRequestUpdateWithRequiredBody customerSegmentUpdateRequestUpdateWithRequiredBody);
}
