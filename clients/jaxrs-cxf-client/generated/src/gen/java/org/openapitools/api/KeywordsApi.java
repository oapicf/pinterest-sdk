...
public interface KeywordsApi  {
    ...
    @ApiOperation(value = "Get country's keyword metrics", tags={  })
    @ApiResponses(value = { 
    ...
    public KeywordsMetricsArrayResponse countryKeywordsMetricsGet(@PathParam("ad_account_id") String adAccountId, @QueryParam("country_code") String countryCode, @QueryParam("keywords") List<String> keywords);
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Create keywords", tags={  })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 429, message = "The user has sent too many requests in a given amount of time and is being rate limited.", response = PinterestLibError.class),
        @ApiResponse(code = 200, message = "An unexpected error response.", response = PinterestLibError.class) })
    public Keywords keywordsCreate(@PathParam("ad_account_id") String adAccountId, KeywordsCreate keywordsCreate);
    ...
    @Path("/ad_accounts/{ad_account_id}/keywords")
    @Produces({ "application/json" })
    @ApiOperation(value = "Get keywords", tags={  })
    @ApiResponses(value = { 
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Update keywords", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "The request has succeeded.", response = Keywords.class),
        @ApiResponse(code = 400, message = "The request could not be understood by the server due to unexpected data.", response = PinterestLibError.class),
        @ApiResponse(code = 401, message = "Authentication is required and has either failed or not been provided.", response = PinterestLibError.class),
        ...
        @ApiResponse(code = 429, message = "The user has sent too many requests in a given amount of time and is being rate limited.", response = PinterestLibError.class),
        @ApiResponse(code = 200, message = "An unexpected error response.", response = PinterestLibError.class) })
    public Keywords keywordsUpdate(@PathParam("ad_account_id") String adAccountId, KeywordsUpdate keywordsUpdate);
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "List trending keywords", tags={  })
    @ApiResponses(value = { 
