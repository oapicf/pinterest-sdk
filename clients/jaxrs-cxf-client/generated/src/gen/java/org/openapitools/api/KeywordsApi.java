...
public interface KeywordsApi  {
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error", response = Error.class) })
    public KeywordsResponse keywordsCreate(@PathParam("ad_account_id") String adAccountId, KeywordsRequest keywordsRequest);
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Success", response = KeywordsResponse.class),
        @ApiResponse(code = 200, message = "Unexpected error", response = Error.class) })
    public KeywordsResponse keywordsUpdate(@PathParam("ad_account_id") String adAccountId, KeywordUpdateBody keywordUpdateBody);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error", response = Error.class) })
    public TrendingKeywordsResponse trendingKeywordsList(@PathParam("region") TrendsSupportedRegion region, @PathParam("trend_type") TrendType trendType, @QueryParam("interests") List<String> interests, @QueryParam("genders") List<String> genders, @QueryParam("ages") List<String> ages, @QueryParam("normalize_against_group") @DefaultValue("false")Boolean normalizeAgainstGroup, @QueryParam("limit") @DefaultValue("50")Integer limit);
}
