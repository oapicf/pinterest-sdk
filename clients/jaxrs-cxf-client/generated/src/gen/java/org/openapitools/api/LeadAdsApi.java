...
public interface LeadAdsApi  {
    ...
    @Path("/{subscription_id}")
    @Produces({ "application/json" })
    @ApiOperation(value = "Get lead ads subscription", tags={  })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 404, message = "Subscription not found.", response = Error.class),
        @ApiResponse(code = 200, message = "Unexpected error.", response = Error.class) })
    public AdAccountGetSubscriptionResponse adAccountsSubscriptionsGetById(@PathParam("ad_account_id") String adAccountId, @PathParam("subscription_id") String subscriptionId);
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Get lead ads subscriptions", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Success", response = AdAccountsSubscriptionsGetList200Response.class),
        @ApiResponse(code = 403, message = "Can't access this subscription.", response = Error.class),
        @ApiResponse(code = 200, message = "Unexpected error.", response = Error.class) })
    public AdAccountsSubscriptionsGetList200Response adAccountsSubscriptionsGetList(@PathParam("ad_account_id") String adAccountId, @QueryParam("page_size") @DefaultValue("25")Integer pageSize, @QueryParam("bookmark") String bookmark);
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Create lead ads subscription", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Success", response = AdAccountCreateSubscriptionResponse.class),
        @ApiResponse(code = 400, message = "Invalid input parameters.", response = Error.class),
        @ApiResponse(code = 403, message = "Can't access this subscription.", response = Error.class),
        @ApiResponse(code = 200, message = "Unexpected error.", response = Error.class) })
    public AdAccountCreateSubscriptionResponse adAccountsSubscriptionsPost(@PathParam("ad_account_id") String adAccountId, AdAccountCreateSubscriptionRequest adAccountCreateSubscriptionRequest);
}
