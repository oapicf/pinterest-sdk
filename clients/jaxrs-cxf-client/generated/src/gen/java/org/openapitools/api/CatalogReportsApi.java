...
public interface CatalogReportsApi  {
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error", response = Error.class) })
    public ReportsStats200Response reportsStats(@QueryParam("parameters") ReportsStatsParametersParameter parameters, @QueryParam("ad_account_id") String adAccountId, @QueryParam("page_size") @DefaultValue("25")Integer pageSize, @QueryParam("bookmark") String bookmark);
}
