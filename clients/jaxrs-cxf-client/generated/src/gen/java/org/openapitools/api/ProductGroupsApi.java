...
public interface ProductGroupsApi  {
    ...
    @ApiOperation(value = "Get catalog product groups", tags={  })
    @ApiResponses(value = { 
    ...
    public AdAccountsCatalogsProductGroupsList200Response adAccountsCatalogsProductGroupsList(@PathParam("ad_account_id") String adAccountId, @QueryParam("feed_profile_id") String feedProfileId);
}
