...
public interface SearchApi  {
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error", response = Error.class) })
    public SearchUserPinsList200Response searchUserPinsList(@QueryParam("query") String query, @QueryParam("ad_account_id") String adAccountId, @QueryParam("bookmark") String bookmark);
}
