...
public interface ConversionEqsApi  {
    ...
    @ApiOperation(value = "Get event quality score (EQS)", tags={  })
    @ApiResponses(value = { 
    ...
    public List<EventQualityScore> conversionEqsList(@QueryParam("lookback_period") LookbackPeriodOptions lookbackPeriod, @PathParam("ad_account_id") String adAccountId, @QueryParam("source_platform") SourcePlatformOptions sourcePlatform, @QueryParam("ingestion_source") IngestionSourceOptions ingestionSource);
}
