...
public interface AdAccountsApi  {
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error", response = Error.class) })
    public AdAccountsList200Response adAccountsList(@QueryParam("bookmark") String bookmark, @QueryParam("page_size") @DefaultValue("25")Integer pageSize, @QueryParam("include_shared_accounts") @DefaultValue("true")Boolean includeSharedAccounts);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error", response = Error.class) })
    public AdsAnalyticsCreateAsyncResponse analyticsCreateTemplateReport(@PathParam("ad_account_id") String adAccountId, @PathParam("template_id") String templateId, @QueryParam("start_date") LocalDate startDate, @QueryParam("end_date") LocalDate endDate, @QueryParam("granularity") Granularity granularity);
