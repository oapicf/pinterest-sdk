...
public interface AudienceInsightsApi  {
    ...
    public AudienceInsightsResponse audienceInsightsGet(@PathParam("ad_account_id") String adAccountId, @QueryParam("audience_insight_type") @DefaultValue("YOUR_TOTAL_AUDIENCE")AudienceInsightType audienceInsightType);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error", response = Error.class) })
    public AudienceDefinitionResponse audienceInsightsScopeAndTypeGet(@PathParam("ad_account_id") String adAccountId);
}
