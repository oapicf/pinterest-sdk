...
public interface AudienceSharingApi  {
    ...
    public AdAccountsAudiencesSharedAccountsList200Response adAccountsAudiencesSharedAccountsList(@PathParam("ad_account_id") String adAccountId, @QueryParam("audience_id") String audienceId, @QueryParam("account_type") @DefaultValue("AD_ACCOUNT")AudienceAccountType accountType, @QueryParam("page_size") @DefaultValue("25")Integer pageSize, @QueryParam("bookmark") String bookmark);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error", response = Error.class) })
    public AudiencesList200Response sharedAudiencesForBusinessList(@PathParam("business_id") String businessId, @QueryParam("bookmark") String bookmark, @QueryParam("order") String order, @QueryParam("page_size") @DefaultValue("25")Integer pageSize);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error", response = Error.class) })
    public SharedAudienceResponse updateAdAccountToAdAccountSharedAudience(@PathParam("ad_account_id") String adAccountId, SharedAudience sharedAudience);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 400, message = "Invalid ad account id.", response = Error.class),
        @ApiResponse(code = 200, message = "Unexpected error", response = Error.class) })
    public BusinessSharedAudienceResponse updateAdAccountToBusinessSharedAudience(@PathParam("ad_account_id") String adAccountId, BusinessSharedAudience businessSharedAudience);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 400, message = "Invalid parameters.", response = Error.class),
        @ApiResponse(code = 200, message = "Unexpected error", response = Error.class) })
    public SharedAudienceResponse updateBusinessToAdAccountSharedAudience(@PathParam("business_id") String businessId, SharedAudience sharedAudience);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 400, message = "Invalid parameters.", response = Error.class),
        @ApiResponse(code = 200, message = "Unexpected error", response = Error.class) })
    public BusinessSharedAudienceResponse updateBusinessToBusinessSharedAudience(@PathParam("business_id") String businessId, BusinessSharedAudience businessSharedAudience);
}
