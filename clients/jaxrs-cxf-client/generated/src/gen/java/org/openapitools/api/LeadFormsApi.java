...
public interface LeadFormsApi  {
    ...
    @ApiOperation(value = "Get lead form by id", tags={  })
    @ApiResponses(value = { 
    ...
    public LeadFormResponse leadFormGet(@PathParam("ad_account_id") String adAccountId, @PathParam("lead_form_id") String leadFormId);
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Create lead form test data", tags={  })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error", response = Error.class) })
    public LeadFormTestResponse leadFormTestCreate(@PathParam("ad_account_id") String adAccountId, @PathParam("lead_form_id") String leadFormId, LeadFormTestRequest leadFormTestRequest);
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Create lead forms", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Success", response = LeadFormArrayResponse.class),
        @ApiResponse(code = 400, message = "Invalid ad account lead forms parameters.", response = Error.class),
        @ApiResponse(code = 200, message = "Unexpected error", response = Error.class) })
    public LeadFormArrayResponse leadFormsCreate(@PathParam("ad_account_id") String adAccountId, List<LeadFormCreateRequest> leadFormCreateRequest);
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "List lead forms", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Success", response = LeadFormsList200Response.class),
        @ApiResponse(code = 400, message = "Invalid ad account lead forms parameters.", response = Error.class),
        @ApiResponse(code = 200, message = "Unexpected error", response = Error.class) })
    public LeadFormsList200Response leadFormsList(@PathParam("ad_account_id") String adAccountId, @QueryParam("page_size") @DefaultValue("25")Integer pageSize, @QueryParam("order") String order, @QueryParam("bookmark") String bookmark);
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Update lead forms", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Success", response = LeadFormArrayResponse.class),
        @ApiResponse(code = 400, message = "Invalid ad account lead forms parameters.", response = Error.class),
        @ApiResponse(code = 200, message = "Unexpected error", response = Error.class) })
    public LeadFormArrayResponse leadFormsUpdate(@PathParam("ad_account_id") String adAccountId, List<LeadFormUpdateRequest> leadFormUpdateRequest);
}
