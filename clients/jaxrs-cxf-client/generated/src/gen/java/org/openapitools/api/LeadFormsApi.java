...
public interface LeadFormsApi  {
    ...
    public LeadForm leadFormGet(@PathParam("lead_form_id") String leadFormId, @PathParam("ad_account_id") String adAccountId);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 404, message = "The requested resource could not be found on this server.", response = PinterestLibError.class),
        @ApiResponse(code = 200, message = "An unexpected error response.", response = PinterestLibError.class) })
    public LeadFormTest leadFormTestCreate(@PathParam("ad_account_id") String adAccountId, @PathParam("lead_form_id") String leadFormId, LeadFormTestCreate leadFormTestCreate);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 429, message = "The user has sent too many requests in a given amount of time and is being rate limited.", response = PinterestLibError.class),
        @ApiResponse(code = 200, message = "An unexpected error response.", response = PinterestLibError.class) })
    public LeadFormsCreate200Response leadFormsCreate(@PathParam("ad_account_id") String adAccountId, List<LeadFormCreate> leadFormCreate);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 429, message = "The user has sent too many requests in a given amount of time and is being rate limited.", response = PinterestLibError.class),
        @ApiResponse(code = 200, message = "An unexpected error response.", response = PinterestLibError.class) })
    public LeadFormsList200Response leadFormsList(@PathParam("ad_account_id") String adAccountId, @QueryParam("bookmark") String bookmark, @QueryParam("page_size") @DefaultValue("25")Integer pageSize, @QueryParam("order") PinterestLibPaginationOrder order);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 429, message = "The user has sent too many requests in a given amount of time and is being rate limited.", response = PinterestLibError.class),
        @ApiResponse(code = 200, message = "An unexpected error response.", response = PinterestLibError.class) })
    public LeadFormsCreate200Response leadFormsUpdate(@PathParam("ad_account_id") String adAccountId, List<LeadFormBatchUpdate> leadFormBatchUpdate);
}
