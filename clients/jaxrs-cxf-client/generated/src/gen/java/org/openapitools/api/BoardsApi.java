...
public interface BoardsApi  {
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error", response = Error.class) })
    public Board boardsCreate(Board board, @QueryParam("ad_account_id") String adAccountId);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error", response = Error.class) })
    public BoardsList200Response boardsList(@QueryParam("ad_account_id") String adAccountId, @QueryParam("bookmark") String bookmark, @QueryParam("page_size") @DefaultValue("25")Integer pageSize, @QueryParam("privacy") String privacy);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 404, message = "Board not found.", response = Error.class),
        @ApiResponse(code = 200, message = "Unexpected error", response = Error.class) })
    public BoardsListPins200Response boardsListPins(@PathParam("board_id") String boardId, @QueryParam("bookmark") String bookmark, @QueryParam("page_size") @DefaultValue("25")Integer pageSize, @QueryParam("creative_types") List<String> creativeTypes, @QueryParam("ad_account_id") String adAccountId, @QueryParam("pin_metrics") @DefaultValue("false")Boolean pinMetrics);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 429, message = "This request exceeded a rate limit. This can happen if the client exceeds one of the published rate limits or if multiple write operations are applied to an object within a short time window.", response = Error.class),
        @ApiResponse(code = 200, message = "Unexpected error", response = Error.class) })
    public Board boardsUpdate(@PathParam("board_id") String boardId, BoardUpdate boardUpdate, @QueryParam("ad_account_id") String adAccountId);
}
