...
public interface BulkApi  {
    ...
    public BulkDownloadResponse bulkDownloadCreate(@PathParam("ad_account_id") String adAccountId, BulkDownloadRequest bulkDownloadRequest);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error", response = Error.class) })
    public BulkUpsertStatusResponse bulkRequestGet(@PathParam("ad_account_id") String adAccountId, @PathParam("bulk_request_id") String bulkRequestId, @QueryParam("include_details") @DefaultValue("false")Boolean includeDetails);
