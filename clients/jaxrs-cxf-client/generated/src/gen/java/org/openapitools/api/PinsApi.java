...
public interface PinsApi  {
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 429, message = "The user has sent too many requests in a given amount of time and is being rate limited.", response = PinterestLibError.class),
        @ApiResponse(code = 200, message = "An unexpected error response.", response = PinterestLibError.class) })
    public PinsList200Response pinsList(@QueryParam("pin_filter") String pinFilter, @QueryParam("pin_metrics") @DefaultValue("false")Boolean pinMetrics, @QueryParam("include_protected_pins") @DefaultValue("false")Boolean includeProtectedPins, @QueryParam("pin_type") String pinType, @QueryParam("creative_types") List<CreativeType> creativeTypes, @QueryParam("ad_account_id") String adAccountId, @QueryParam("bookmark") String bookmark, @QueryParam("page_size") @DefaultValue("25")Integer pageSize);
