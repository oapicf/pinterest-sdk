...
public interface PinsApi  {
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 404, message = "Pin not found.", response = Error.class),
        @ApiResponse(code = 200, message = "Unexpected error", response = Error.class) })
    public void pinsDelete(@PathParam("pin_id") String pinId, @QueryParam("ad_account_id") String adAccountId);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 404, message = "Pin not found.", response = Error.class),
        @ApiResponse(code = 200, message = "Unexpected error", response = Error.class) })
    public Pin pinsGet(@PathParam("pin_id") String pinId, @QueryParam("pin_metrics") @DefaultValue("false")Boolean pinMetrics, @QueryParam("ad_account_id") String adAccountId);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error", response = Error.class) })
    public PinsList200Response pinsList(@QueryParam("bookmark") String bookmark, @QueryParam("page_size") @DefaultValue("25")Integer pageSize, @QueryParam("pin_filter") String pinFilter, @QueryParam("include_protected_pins") @DefaultValue("false")Boolean includeProtectedPins, @QueryParam("pin_type") String pinType, @QueryParam("creative_types") List<String> creativeTypes, @QueryParam("ad_account_id") String adAccountId, @QueryParam("pin_metrics") @DefaultValue("false")Boolean pinMetrics);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error", response = Error.class) })
    public Pin pinsSave(@PathParam("pin_id") String pinId, PinsSaveRequest pinsSaveRequest, @QueryParam("ad_account_id") String adAccountId);
