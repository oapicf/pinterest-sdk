...
public interface SchedulesApi  {
    ...
    @ApiOperation(value = "Create schedules", tags={  })
    @ApiResponses(value = { 
    ...
    public List<SchedulesCreate200ResponseInner> schedulesCreate(@PathParam("ad_account_id") String adAccountId, List<ScheduleCreate> scheduleCreate);
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Get Schedules", tags={  })
    @ApiResponses(value = { 
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Update schedules", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "The request has succeeded.", response = SchedulesCreate200ResponseInner.class, responseContainer = "List"),
        @ApiResponse(code = 400, message = "The request could not be understood by the server due to unexpected data.", response = PinterestLibError.class),
        @ApiResponse(code = 401, message = "Authentication is required and has either failed or not been provided.", response = PinterestLibError.class),
        ...
        @ApiResponse(code = 429, message = "The user has sent too many requests in a given amount of time and is being rate limited.", response = PinterestLibError.class),
        @ApiResponse(code = 200, message = "An unexpected error response.", response = PinterestLibError.class) })
    public List<SchedulesCreate200ResponseInner> schedulesUpdate(@PathParam("ad_account_id") String adAccountId, List<ScheduleBatchUpdate> scheduleBatchUpdate);
}
