...
public interface CustomerListUploadsApi  {
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error", response = Error.class) })
    public CustomerListUploadResponse customerListUploadsGet(@PathParam("ad_account_id") String adAccountId, @PathParam("customer_list_id") String customerListId, @PathParam("customer_list_upload_id") String customerListUploadId);
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Success", response = CustomerListUploadResponse.class),
        @ApiResponse(code = 200, message = "Unexpected error", response = Error.class) })
    public CustomerListUploadResponse customerListUploadsRun(@PathParam("ad_account_id") String adAccountId, @PathParam("customer_list_id") String customerListId, @PathParam("customer_list_upload_id") String customerListUploadId);
}
