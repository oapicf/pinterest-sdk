...
public interface CatalogSupplementalApi  {
    ...
    @ApiOperation(value = "Operate on local inventory item batch", tags={  })
    @ApiResponses(value = { 
    ...
    public SupplementalItemsBatchResponse catalogsLocalInventoryItemsBatchOperate(@PathParam("catalog_id") String catalogId, LocalInventoryItemsBatchCreate localInventoryItemsBatchCreate, @QueryParam("ad_account_id") String adAccountId);
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Get local inventory items (POST)", tags={  })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 429, message = "The user has sent too many requests in a given amount of time and is being rate limited.", response = PinterestLibError.class),
        @ApiResponse(code = 200, message = "An unexpected error response.", response = PinterestLibError.class) })
    public LocalInventoryItemsGet catalogsLocalInventoryItemsPost(@PathParam("catalog_id") String catalogId, LocalInventoryItemsGetCreate localInventoryItemsGetCreate, @QueryParam("ad_account_id") String adAccountId);
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Create local stores", tags={  })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 429, message = "The user has sent too many requests in a given amount of time and is being rate limited.", response = PinterestLibError.class),
        @ApiResponse(code = 200, message = "An unexpected error response.", response = PinterestLibError.class) })
    public List<CatalogsLocalStoresCreate200ResponseInner> catalogsLocalStoresCreate(@PathParam("catalog_id") String catalogId, List<LocalStoreCreate> localStoreCreate, @QueryParam("ad_account_id") String adAccountId);
    ...
    @Path("/local_stores")
    @Produces({ "application/json" })
    @ApiOperation(value = "Delete local stores", tags={  })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 429, message = "The user has sent too many requests in a given amount of time and is being rate limited.", response = PinterestLibError.class),
        @ApiResponse(code = 200, message = "An unexpected error response.", response = PinterestLibError.class) })
    public List<CatalogsLocalStoresDelete200ResponseInner> catalogsLocalStoresDelete(@PathParam("catalog_id") String catalogId, @QueryParam("ids") List<String> ids, @QueryParam("ad_account_id") String adAccountId);
    ...
    @Path("/local_stores")
    @Produces({ "application/json" })
    @ApiOperation(value = "List local stores", tags={  })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 429, message = "The user has sent too many requests in a given amount of time and is being rate limited.", response = PinterestLibError.class),
        @ApiResponse(code = 200, message = "An unexpected error response.", response = PinterestLibError.class) })
    public CatalogsLocalStoresList200Response catalogsLocalStoresList(@PathParam("catalog_id") String catalogId, @QueryParam("ids") List<String> ids, @QueryParam("ad_account_id") String adAccountId, @QueryParam("bookmark") String bookmark, @QueryParam("page_size") @DefaultValue("25")Integer pageSize);
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Update local stores", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "The request has succeeded.", response = CatalogsLocalStoresCreate200ResponseInner.class, responseContainer = "List"),
        @ApiResponse(code = 400, message = "The request could not be understood by the server due to unexpected data.", response = PinterestLibError.class),
        @ApiResponse(code = 401, message = "Authentication is required and has either failed or not been provided.", response = PinterestLibError.class),
        ...
        @ApiResponse(code = 429, message = "The user has sent too many requests in a given amount of time and is being rate limited.", response = PinterestLibError.class),
        @ApiResponse(code = 200, message = "An unexpected error response.", response = PinterestLibError.class) })
    public List<CatalogsLocalStoresCreate200ResponseInner> catalogsLocalStoresUpdate(@PathParam("catalog_id") String catalogId, List<LocalStoreBatchUpdate> localStoreBatchUpdate, @QueryParam("ad_account_id") String adAccountId);
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Get supplemental items batch status", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "The request has succeeded.", response = SupplementalItemsBatchResponse.class),
        @ApiResponse(code = 400, message = "The request could not be understood by the server due to unexpected data.", response = PinterestLibError.class),
        @ApiResponse(code = 401, message = "Authentication is required and has either failed or not been provided.", response = PinterestLibError.class),
        ...
        @ApiResponse(code = 429, message = "The user has sent too many requests in a given amount of time and is being rate limited.", response = PinterestLibError.class),
        @ApiResponse(code = 200, message = "An unexpected error response.", response = PinterestLibError.class) })
    public SupplementalItemsBatchResponse catalogsSupplementalItemsBatchGet(@PathParam("catalog_id") String catalogId, @PathParam("batch_id") String batchId, @QueryParam("ad_account_id") String adAccountId);
}
