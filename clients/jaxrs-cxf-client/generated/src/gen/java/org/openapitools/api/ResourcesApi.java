...
public interface ResourcesApi  {
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 429, message = "The user has sent too many requests in a given amount of time and is being rate limited.", response = PinterestLibError.class),
        @ApiResponse(code = 200, message = "An unexpected error response.", response = PinterestLibError.class) })
    public SingleInterestTargetingOption interestTargetingOptionsGet(@PathParam("interest_id") String interestId);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 429, message = "The user has sent too many requests in a given amount of time and is being rate limited.", response = PinterestLibError.class),
        @ApiResponse(code = 200, message = "An unexpected error response.", response = PinterestLibError.class) })
    public BookClosed metricsReadyStateGet(@QueryParam("date") String date);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 429, message = "The user has sent too many requests in a given amount of time and is being rate limited.", response = PinterestLibError.class),
        @ApiResponse(code = 200, message = "An unexpected error response.", response = PinterestLibError.class) })
    public List<Object> targetingOptionsGet(@PathParam("targeting_type") PublicTargetingType targetingType, @QueryParam("ad_account_id") String adAccountId, @QueryParam("client_id") String clientId, @QueryParam("oauth_signature") String oauthSignature, @QueryParam("timestamp") String timestamp);
}
