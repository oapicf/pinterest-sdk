...
public interface CatalogsApi  {
    ...
    @ApiOperation(value = "List available filter values", tags={  })
    @ApiResponses(value = { 
    ...
    public CatalogsAvailableFilterValues catalogsAvailableFilterValues(@QueryParam("catalog_id") String catalogId, @QueryParam("feed_id") String feedId, @QueryParam("country") Country country, @QueryParam("language") CatalogsLocale language, @QueryParam("ad_account_id") String adAccountId);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 429, message = "The user has sent too many requests in a given amount of time and is being rate limited.", response = PinterestLibError.class),
        @ApiResponse(code = 200, message = "An unexpected error response.", response = PinterestLibError.class) })
    public Catalog catalogsCreate(CatalogCreate catalogCreate, @QueryParam("ad_account_id") String adAccountId);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 429, message = "The user has sent too many requests in a given amount of time and is being rate limited.", response = PinterestLibError.class),
        @ApiResponse(code = 200, message = "An unexpected error response.", response = PinterestLibError.class) })
    public CatalogsList200Response catalogsList(@QueryParam("ad_account_id") String adAccountId, @QueryParam("bookmark") String bookmark, @QueryParam("page_size") @DefaultValue("25")Integer pageSize);
}
