...
public interface CatalogsApi  {
    ...
    @ApiOperation(value = "Create catalog", tags={  })
    @ApiResponses(value = { 
    ...
    public Catalog catalogsCreate(CatalogsCreateRequest catalogsCreateRequest, @QueryParam("ad_account_id") String adAccountId);
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "List products by product group", tags={  })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error.", response = Error.class) })
    public CatalogsProductGroupPinsList200Response catalogsProductGroupPinsList(@PathParam("product_group_id") String productGroupId, @QueryParam("bookmark") String bookmark, @QueryParam("page_size") @DefaultValue("25")Integer pageSize, @QueryParam("ad_account_id") String adAccountId, @QueryParam("pin_metrics") @DefaultValue("false")Boolean pinMetrics);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error.", response = Error.class) })
    public CatalogsVerticalProductGroup catalogsProductGroupsCreate(MultipleProductGroupsInner multipleProductGroupsInner, @QueryParam("ad_account_id") String adAccountId);
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Create product groups", tags={  })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 409, message = "Conflict. Can't create this catalogs product group with this value.", response = Error.class),
        @ApiResponse(code = 200, message = "Unexpected error.", response = Error.class) })
    public List<String> catalogsProductGroupsCreateMany(List<MultipleProductGroupsInner> multipleProductGroupsInner, @QueryParam("ad_account_id") String adAccountId);
    ...
    @Path("/product_groups/multiple")
    @Produces({ "application/json" })
    @ApiOperation(value = "Delete product groups", tags={  })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 409, message = "Conflict. Can't delete this catalogs product group.", response = Error.class),
        @ApiResponse(code = 200, message = "Unexpected error.", response = Error.class) })
    public void catalogsProductGroupsDeleteMany(@QueryParam("id") List<Integer> id, @QueryParam("ad_account_id") String adAccountId);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error.", response = Error.class) })
    public CatalogsVerticalProductGroup catalogsProductGroupsGet(@PathParam("product_group_id") String productGroupId, @QueryParam("ad_account_id") String adAccountId);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 409, message = "Conflict. Can't create this catalogs product group with this value.", response = Error.class),
        @ApiResponse(code = 200, message = "Unexpected error.", response = Error.class) })
    public CatalogsProductGroupsList200Response catalogsProductGroupsList(@QueryParam("id") List<Integer> id, @QueryParam("feed_id") String feedId, @QueryParam("catalog_id") String catalogId, @QueryParam("bookmark") String bookmark, @QueryParam("page_size") @DefaultValue("25")Integer pageSize, @QueryParam("ad_account_id") String adAccountId);
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Get product counts", tags={  })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error.", response = Error.class) })
    public CatalogsProductGroupProductCountsVertical catalogsProductGroupsProductCountsGet(@PathParam("product_group_id") String productGroupId, @QueryParam("ad_account_id") String adAccountId);
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Update single product group", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Success", response = CatalogsVerticalProductGroup.class),
        @ApiResponse(code = 400, message = "Invalid parameters.", response = Error.class),
        @ApiResponse(code = 401, message = "Unauthorized access.", response = Error.class),
        ...
        @ApiResponse(code = 200, message = "Unexpected error.", response = Error.class) })
    public CatalogsVerticalProductGroup catalogsProductGroupsUpdate(@PathParam("product_group_id") String productGroupId, CatalogsProductGroupsUpdateRequest catalogsProductGroupsUpdateRequest, @QueryParam("ad_account_id") String adAccountId);
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "List feed processing results", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Ingest feed items", tags={  })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 404, message = "Data feed not found.", response = Error.class),
        @ApiResponse(code = 200, message = "Unexpected error", response = Error.class) })
    public CatalogsFeedIngestion feedsIngest(@PathParam("feed_id") String feedId, @QueryParam("ad_account_id") String adAccountId);
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "List item issues", tags={  })
    @ApiResponses(value = { 
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "List products by filter", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Success", response = CatalogsProductGroupPinsList200Response.class),
        @ApiResponse(code = 401, message = "Unauthorized access.", response = Error.class),
        @ApiResponse(code = 409, message = "Conflict. Can't get products.", response = Error.class),
        @ApiResponse(code = 200, message = "Unexpected error.", response = Error.class) })
    public CatalogsProductGroupPinsList200Response productsByProductGroupFilterList(CatalogsListProductsByFilterRequest catalogsListProductsByFilterRequest, @QueryParam("bookmark") String bookmark, @QueryParam("page_size") @DefaultValue("25")Integer pageSize, @QueryParam("ad_account_id") String adAccountId, @QueryParam("pin_metrics") @DefaultValue("false")Boolean pinMetrics);
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Build catalogs report", tags={  })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 409, message = "Can't access this feature without an existing catalog.", response = Error.class),
        @ApiResponse(code = 200, message = "Unexpected error", response = Error.class) })
    public CatalogsCreateReportResponse reportsCreate(CatalogsReportParameters catalogsReportParameters, @QueryParam("ad_account_id") String adAccountId);
    ...
    @Path("/reports")
    @Produces({ "application/json" })
    @ApiOperation(value = "Get catalogs report", tags={  })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 409, message = "Can't access this feature without an existing catalog.", response = Error.class),
        @ApiResponse(code = 200, message = "Unexpected error", response = Error.class) })
    public CatalogsReport reportsGet(@QueryParam("token") String token, @QueryParam("ad_account_id") String adAccountId);
    ...
    @Path("/reports/stats")
    @Produces({ "application/json" })
    @ApiOperation(value = "List report stats", tags={  })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error", response = Error.class) })
    public ReportsStats200Response reportsStats(@QueryParam("parameters") CatalogsReportParameters parameters, @QueryParam("ad_account_id") String adAccountId, @QueryParam("page_size") @DefaultValue("25")Integer pageSize, @QueryParam("bookmark") String bookmark);
}
