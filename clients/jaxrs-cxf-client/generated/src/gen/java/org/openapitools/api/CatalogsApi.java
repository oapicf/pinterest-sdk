...
public interface CatalogsApi  {
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error.", response = Error.class) })
    public void catalogsProductGroupsDelete(@PathParam("product_group_id") String productGroupId);
    ...
    @Path("/product_groups")
    @Produces({ "application/json" })
    @ApiOperation(value = "Get product groups list", tags={  })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 409, message = "Conflict. Can't create this catalogs product group with this value.", response = Error.class),
        @ApiResponse(code = 200, message = "Unexpected error.", response = Error.class) })
    public Paginated catalogsProductGroupsList(@QueryParam("feed_id") String feedId, @QueryParam("bookmark") String bookmark, @QueryParam("page_size") @DefaultValue("25")Integer pageSize);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error.", response = Error.class) })
    public CatalogsProductGroup catalogsProductGroupsUpdate(@PathParam("product_group_id") String productGroupId, CatalogsProductGroupUpdateRequest catalogsProductGroupUpdateRequest);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error.", response = Error.class) })
    public Paginated feedProcessingResultsList(@PathParam("feed_id") String feedId, @QueryParam("bookmark") String bookmark, @QueryParam("page_size") @DefaultValue("25")Integer pageSize);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error", response = Error.class) })
    public void feedsDelete(@PathParam("feed_id") String feedId);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 404, message = "Data feed not found.", response = Error.class),
        @ApiResponse(code = 200, message = "Unexpected error.", response = Error.class) })
    public CatalogsFeed feedsGet(@PathParam("feed_id") String feedId);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 401, message = "Unauthorized access.", response = Error.class),
        @ApiResponse(code = 200, message = "Unexpected error.", response = Error.class) })
    public Paginated feedsList(@QueryParam("bookmark") String bookmark, @QueryParam("page_size") @DefaultValue("25")Integer pageSize);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 404, message = "Data feed not found.", response = Error.class),
        @ApiResponse(code = 200, message = "Unexpected error", response = Error.class) })
    public CatalogsFeed feedsUpdate(@PathParam("feed_id") String feedId, CatalogsFeedsUpdateRequest catalogsFeedsUpdateRequest);
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Get catalogs items batch", tags={  })
    @ApiResponses(value = { 
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Perform an operation on an item batch", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Response containing the requested catalogs items batch", response = CatalogsItemsBatch.class),
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error", response = Error.class) })
    public CatalogsItems itemsGet(@QueryParam("country") String country, @QueryParam("item_ids") List<String> itemIds, @QueryParam("language") String language);
}
