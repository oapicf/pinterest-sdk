...
public interface AdGroupsApi  {
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 429, message = "The user has sent too many requests in a given amount of time and is being rate limited.", response = PinterestLibError.class),
        @ApiResponse(code = 200, message = "An unexpected error response.", response = PinterestLibError.class) })
    public AdGroupAudienceSizing adGroupsAudienceSizing(@PathParam("ad_account_id") String adAccountId, AdGroupAudienceSizingCreate adGroupAudienceSizingCreate);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 429, message = "The user has sent too many requests in a given amount of time and is being rate limited.", response = PinterestLibError.class),
        @ApiResponse(code = 200, message = "An unexpected error response.", response = PinterestLibError.class) })
    public BidFloor adGroupsBidFloorGet(@PathParam("ad_account_id") String adAccountId, BidFloorCreate bidFloorCreate);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 429, message = "The user has sent too many requests in a given amount of time and is being rate limited.", response = PinterestLibError.class),
        @ApiResponse(code = 200, message = "An unexpected error response.", response = PinterestLibError.class) })
    public AdGroupsCreate200Response adGroupsCreate(@PathParam("ad_account_id") String adAccountId, List<AdGroupCreateCreate> adGroupCreateCreate);
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Get dynamic titles CSV download URL", tags={  })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 429, message = "The user has sent too many requests in a given amount of time and is being rate limited.", response = PinterestLibError.class),
        @ApiResponse(code = 200, message = "An unexpected error response.", response = PinterestLibError.class) })
    public DynamicTitlesDownloadCSV adGroupsDynamicTitlesDownloadCsv(@PathParam("ad_account_id") String adAccountId, @PathParam("ad_group_id") String adGroupId);
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Get dynamic titles status", tags={  })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 429, message = "The user has sent too many requests in a given amount of time and is being rate limited.", response = PinterestLibError.class),
        @ApiResponse(code = 200, message = "An unexpected error response.", response = PinterestLibError.class) })
    public DynamicTitlesGetStatus adGroupsDynamicTitlesGetStatus(@PathParam("ad_account_id") String adAccountId, @PathParam("ad_group_id") String adGroupId);
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Get dynamic titles upload URL", tags={  })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 429, message = "The user has sent too many requests in a given amount of time and is being rate limited.", response = PinterestLibError.class),
        @ApiResponse(code = 200, message = "An unexpected error response.", response = PinterestLibError.class) })
    public DynamicTitlesUploadURL adGroupsDynamicTitlesGetUploadUrl(@PathParam("ad_account_id") String adAccountId, @PathParam("ad_group_id") String adGroupId);
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Process dynamic titles CSV", tags={  })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 429, message = "The user has sent too many requests in a given amount of time and is being rate limited.", response = PinterestLibError.class),
        @ApiResponse(code = 200, message = "An unexpected error response.", response = PinterestLibError.class) })
    public DynamicTitlesProcessCSV adGroupsDynamicTitlesProcessCsv(@PathParam("ad_account_id") String adAccountId, @PathParam("ad_group_id") String adGroupId, DynamicTitlesProcessCSVCreate dynamicTitlesProcessCSVCreate);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 429, message = "The user has sent too many requests in a given amount of time and is being rate limited.", response = PinterestLibError.class),
        @ApiResponse(code = 200, message = "An unexpected error response.", response = PinterestLibError.class) })
    public AdGroup adGroupsGet(@PathParam("ad_group_id") String adGroupId, @PathParam("ad_account_id") String adAccountId);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 429, message = "The user has sent too many requests in a given amount of time and is being rate limited.", response = PinterestLibError.class),
        @ApiResponse(code = 200, message = "An unexpected error response.", response = PinterestLibError.class) })
    public AdGroupsCreate200Response adGroupsUpdate(@PathParam("ad_account_id") String adAccountId, List<AdGroupUpdateBatchUpdate> adGroupUpdateBatchUpdate);
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "List of ad groups using promotions IDs.", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "The request has succeeded.", response = AdGroupsList200Response.class),
        @ApiResponse(code = 400, message = "The request could not be understood by the server due to unexpected data.", response = PinterestLibError.class),
        @ApiResponse(code = 401, message = "Authentication is required and has either failed or not been provided.", response = PinterestLibError.class),
        ...
        @ApiResponse(code = 429, message = "The user has sent too many requests in a given amount of time and is being rate limited.", response = PinterestLibError.class),
        @ApiResponse(code = 200, message = "An unexpected error response.", response = PinterestLibError.class) })
    public AdGroupsList200Response getAdGroupsByPromotionIdsList(@PathParam("ad_account_id") String adAccountId, @QueryParam("promotion_ids") List<String> promotionIds, @QueryParam("bookmark") String bookmark, @QueryParam("page_size") @DefaultValue("25")Integer pageSize, @QueryParam("order") PinterestLibPaginationOrder order);
}
