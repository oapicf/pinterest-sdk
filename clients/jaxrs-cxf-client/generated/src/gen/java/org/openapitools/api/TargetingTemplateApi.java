...
public interface TargetingTemplateApi  {
    ...
    @ApiOperation(value = "Create targeting templates", tags={  })
    @ApiResponses(value = { 
    ...
    public TargetingTemplate targetingTemplateCreate(@PathParam("ad_account_id") String adAccountId, TargetingTemplateCreate targetingTemplateCreate);
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "List targeting templates", tags={  })
    @ApiResponses(value = { 
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Update targeting templates", tags={  })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 429, message = "The user has sent too many requests in a given amount of time and is being rate limited.", response = PinterestLibError.class),
        @ApiResponse(code = 200, message = "An unexpected error response.", response = PinterestLibError.class) })
    public void targetingTemplateUpdate(@PathParam("ad_account_id") String adAccountId, TargetingTemplateUpdateRequestReadOrUpdate targetingTemplateUpdateRequestReadOrUpdate);
}
