...
public interface IntegrationsApi  {
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 409, message = "Can't access this integration metadata.", response = Error.class),
        @ApiResponse(code = 200, message = "Unexpected error.", response = Error.class) })
    public IntegrationMetadata integrationsCommercePatch(@PathParam("external_business_id") String externalBusinessId, IntegrationRequestPatch integrationRequestPatch);
