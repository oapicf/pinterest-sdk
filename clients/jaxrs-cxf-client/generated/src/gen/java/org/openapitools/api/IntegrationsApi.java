...
public interface IntegrationsApi  {
    ...
    @ApiOperation(value = "Delete commerce integration", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/commerce/{external_business_id}")
    @Produces({ "application/json" })
    @ApiOperation(value = "Get commerce integration", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "The request has succeeded.", response = IntegrationMetadata.class),
        @ApiResponse(code = 400, message = "The request could not be understood by the server due to unexpected data.", response = PinterestLibError.class),
        @ApiResponse(code = 401, message = "Authentication is required and has either failed or not been provided.", response = PinterestLibError.class),
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Update commerce integration", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "The request has succeeded.", response = IntegrationMetadata.class),
        @ApiResponse(code = 400, message = "The request could not be understood by the server due to unexpected data.", response = PinterestLibError.class),
        @ApiResponse(code = 401, message = "Authentication is required and has either failed or not been provided.", response = PinterestLibError.class),
        ...
        @ApiResponse(code = 429, message = "The user has sent too many requests in a given amount of time and is being rate limited.", response = PinterestLibError.class),
        @ApiResponse(code = 200, message = "An unexpected error response.", response = PinterestLibError.class) })
    public IntegrationMetadata integrationsCommercePatch(@PathParam("external_business_id") String externalBusinessId, IntegrationMetadataUpdate integrationMetadataUpdate);
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Create commerce integration", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "The request has succeeded.", response = IntegrationMetadata.class),
        ...
        @ApiResponse(code = 429, message = "The user has sent too many requests in a given amount of time and is being rate limited.", response = PinterestLibError.class),
        @ApiResponse(code = 200, message = "An unexpected error response.", response = PinterestLibError.class) })
    public IntegrationMetadata integrationsCommercePost(IntegrationMetadataCreate integrationMetadataCreate);
    ...
    @Path("/{id}")
    @Produces({ "application/json" })
    @ApiOperation(value = "Get integration metadata", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Get integration metadata list", tags={  })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 429, message = "The user has sent too many requests in a given amount of time and is being rate limited.", response = PinterestLibError.class),
        @ApiResponse(code = 200, message = "An unexpected error response.", response = PinterestLibError.class) })
    public IntegrationsGetList200Response integrationsGetList(@QueryParam("bookmark") String bookmark, @QueryParam("page_size") @DefaultValue("25")Integer pageSize);
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Receives batched logs from integration applications.", tags={  })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 429, message = "The user has sent too many requests in a given amount of time and is being rate limited.", response = PinterestLibError.class),
        @ApiResponse(code = 200, message = "An unexpected error response.", response = PinterestLibError.class) })
    public IntegrationLogsSuccessResponse integrationsLogsPost(IntegrationLogsRequestCreate integrationLogsRequestCreate);
}
