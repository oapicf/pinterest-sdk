...
public class Example {
  public static void main(String[] args) {
    ...
    List<PinsAnalyticsMetricTypesParameterInner> metricTypes = Arrays.asList(); // List<PinsAnalyticsMetricTypesParameterInner> | Pin metric types to get data for, default is all.
