...
import com.github.oapicf.pinterestsdk.api.ConversionEqsApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    ConversionEqsApi apiInstance = new ConversionEqsApi(defaultClient);
    LookbackPeriodOptions lookbackPeriod = LookbackPeriodOptions.fromValue("1d"); // LookbackPeriodOptions | Lookback window (number of days).
    String adAccountId = "adAccountId_example"; // String | Unique identifier of an ad account.
    SourcePlatformOptions sourcePlatform = SourcePlatformOptions.fromValue("WEB"); // SourcePlatformOptions | Source platform of event.
    IngestionSourceOptions ingestionSource = IngestionSourceOptions.fromValue("TAG"); // IngestionSourceOptions | Ingestion source of event.
    try {
