...
public class CatalogsFeedValidationWarnings {
  public static final String SERIALIZED_NAME_TITLE_LENGTH_TOO_LONG = "title_length_too_long";
  @SerializedName(SERIALIZED_NAME_TITLE_LENGTH_TOO_LONG)
  private Integer titleLengthTooLong;

  public static final String SERIALIZED_NAME_DESCRIPTION_LENGTH_TOO_LONG = "description_length_too_long";
  @SerializedName(SERIALIZED_NAME_DESCRIPTION_LENGTH_TOO_LONG)
  private Integer descriptionLengthTooLong;

  public static final String SERIALIZED_NAME_GENDER_INVALID = "gender_invalid";
  @SerializedName(SERIALIZED_NAME_GENDER_INVALID)
  private Integer genderInvalid;

  public static final String SERIALIZED_NAME_AGE_GROUP_INVALID = "age_group_invalid";
  @SerializedName(SERIALIZED_NAME_AGE_GROUP_INVALID)
  private Integer ageGroupInvalid;

  public static final String SERIALIZED_NAME_SIZE_TYPE_INVALID = "size_type_invalid";
  @SerializedName(SERIALIZED_NAME_SIZE_TYPE_INVALID)
  private Integer sizeTypeInvalid;

  public static final String SERIALIZED_NAME_LINK_FORMAT_WARNING = "link_format_warning";
  @SerializedName(SERIALIZED_NAME_LINK_FORMAT_WARNING)
  private Integer linkFormatWarning;

  public static final String SERIALIZED_NAME_DUPLICATE_PRODUCTS = "duplicate_products";
  @SerializedName(SERIALIZED_NAME_DUPLICATE_PRODUCTS)
  private Integer duplicateProducts;

  public static final String SERIALIZED_NAME_DUPLICATE_LINKS = "duplicate_links";
  @SerializedName(SERIALIZED_NAME_DUPLICATE_LINKS)
  private Integer duplicateLinks;

  public static final String SERIALIZED_NAME_SALES_PRICE_INVALID = "sales_price_invalid";
  @SerializedName(SERIALIZED_NAME_SALES_PRICE_INVALID)
  private Integer salesPriceInvalid;

  public static final String SERIALIZED_NAME_PRODUCT_CATEGORY_DEPTH_WARNING = "product_category_depth_warning";
  @SerializedName(SERIALIZED_NAME_PRODUCT_CATEGORY_DEPTH_WARNING)
  private Integer productCategoryDepthWarning;

  public static final String SERIALIZED_NAME_ADWORDS_SAME_AS_LINK = "adwords_same_as_link";
  @SerializedName(SERIALIZED_NAME_ADWORDS_SAME_AS_LINK)
  private Integer adwordsSameAsLink;

  public static final String SERIALIZED_NAME_DUPLICATE_HEADERS = "duplicate_headers";
  @SerializedName(SERIALIZED_NAME_DUPLICATE_HEADERS)
  private Integer duplicateHeaders;

  public static final String SERIALIZED_NAME_FETCH_SAME_SIGNATURE = "fetch_same_signature";
  @SerializedName(SERIALIZED_NAME_FETCH_SAME_SIGNATURE)
  private Integer fetchSameSignature;

  public static final String SERIALIZED_NAME_ADWORDS_FORMAT_WARNING = "adwords_format_warning";
  @SerializedName(SERIALIZED_NAME_ADWORDS_FORMAT_WARNING)
  private Integer adwordsFormatWarning;

  public static final String SERIALIZED_NAME_ADDITIONAL_IMAGE_LINK_WARNING = "additional_image_link_warning";
  @SerializedName(SERIALIZED_NAME_ADDITIONAL_IMAGE_LINK_WARNING)
  private Integer additionalImageLinkWarning;

  public static final String SERIALIZED_NAME_IMAGE_LINK_WARNING = "image_link_warning";
  @SerializedName(SERIALIZED_NAME_IMAGE_LINK_WARNING)
  private Integer imageLinkWarning;

  public static final String SERIALIZED_NAME_SHIPPING_INVALID = "shipping_invalid";
  @SerializedName(SERIALIZED_NAME_SHIPPING_INVALID)
  private Integer shippingInvalid;

  public static final String SERIALIZED_NAME_TAX_INVALID = "tax_invalid";
  @SerializedName(SERIALIZED_NAME_TAX_INVALID)
  private Integer taxInvalid;

  public static final String SERIALIZED_NAME_SHIPPING_WEIGHT_INVALID = "shipping_weight_invalid";
  @SerializedName(SERIALIZED_NAME_SHIPPING_WEIGHT_INVALID)
  private Integer shippingWeightInvalid;

  public static final String SERIALIZED_NAME_EXPIRATION_DATE_INVALID = "expiration_date_invalid";
  @SerializedName(SERIALIZED_NAME_EXPIRATION_DATE_INVALID)
  private Integer expirationDateInvalid;

  public static final String SERIALIZED_NAME_AVAILABILITY_DATE_INVALID = "availability_date_invalid";
  @SerializedName(SERIALIZED_NAME_AVAILABILITY_DATE_INVALID)
  private Integer availabilityDateInvalid;

  public static final String SERIALIZED_NAME_SALE_DATE_INVALID = "sale_date_invalid";
  @SerializedName(SERIALIZED_NAME_SALE_DATE_INVALID)
  private Integer saleDateInvalid;

  public static final String SERIALIZED_NAME_WEIGHT_UNIT_INVALID = "weight_unit_invalid";
  @SerializedName(SERIALIZED_NAME_WEIGHT_UNIT_INVALID)
  private Integer weightUnitInvalid;

  public static final String SERIALIZED_NAME_IS_BUNDLE_INVALID = "is_bundle_invalid";
  @SerializedName(SERIALIZED_NAME_IS_BUNDLE_INVALID)
  private Integer isBundleInvalid;

  public static final String SERIALIZED_NAME_UPDATED_TIME_INVALID = "updated_time_invalid";
  @SerializedName(SERIALIZED_NAME_UPDATED_TIME_INVALID)
  private Integer updatedTimeInvalid;

  public static final String SERIALIZED_NAME_CUSTOM_LABEL_LENGTH_TOO_LONG = "custom_label_length_too_long";
  @SerializedName(SERIALIZED_NAME_CUSTOM_LABEL_LENGTH_TOO_LONG)
  private Integer customLabelLengthTooLong;

  public static final String SERIALIZED_NAME_PRODUCT_TYPE_LENGTH_TOO_LONG = "product_type_length_too_long";
  @SerializedName(SERIALIZED_NAME_PRODUCT_TYPE_LENGTH_TOO_LONG)
  private Integer productTypeLengthTooLong;

  public static final String SERIALIZED_NAME_TOO_MANY_ADDITIONAL_IMAGE_LINKS = "too_many_additional_image_links";
  @SerializedName(SERIALIZED_NAME_TOO_MANY_ADDITIONAL_IMAGE_LINKS)
  private Integer tooManyAdditionalImageLinks;

  public static final String SERIALIZED_NAME_MULTIPACK_INVALID = "multipack_invalid";
  @SerializedName(SERIALIZED_NAME_MULTIPACK_INVALID)
  private Integer multipackInvalid;

  public static final String SERIALIZED_NAME_INDEXED_PRODUCT_COUNT_LARGE_DELTA = "indexed_product_count_large_delta";
  @SerializedName(SERIALIZED_NAME_INDEXED_PRODUCT_COUNT_LARGE_DELTA)
  private Integer indexedProductCountLargeDelta;

  public static final String SERIALIZED_NAME_ITEM_ADDITIONAL_IMAGE_DOWNLOAD_FAILURE = "item_additional_image_download_failure";
  @SerializedName(SERIALIZED_NAME_ITEM_ADDITIONAL_IMAGE_DOWNLOAD_FAILURE)
  private Integer itemAdditionalImageDownloadFailure;

  public static final String SERIALIZED_NAME_OPTIONAL_PRODUCT_CATEGORY_MISSING = "optional_product_category_missing";
  @SerializedName(SERIALIZED_NAME_OPTIONAL_PRODUCT_CATEGORY_MISSING)
  private Integer optionalProductCategoryMissing;

  public static final String SERIALIZED_NAME_OPTIONAL_PRODUCT_CATEGORY_INVALID = "optional_product_category_invalid";
  @SerializedName(SERIALIZED_NAME_OPTIONAL_PRODUCT_CATEGORY_INVALID)
  private Integer optionalProductCategoryInvalid;

  public static final String SERIALIZED_NAME_OPTIONAL_CONDITION_MISSING = "optional_condition_missing";
  @SerializedName(SERIALIZED_NAME_OPTIONAL_CONDITION_MISSING)
  private Integer optionalConditionMissing;

  public static final String SERIALIZED_NAME_OPTIONAL_CONDITION_INVALID = "optional_condition_invalid";
  @SerializedName(SERIALIZED_NAME_OPTIONAL_CONDITION_INVALID)
  private Integer optionalConditionInvalid;

  public static final String SERIALIZED_NAME_IOS_DEEP_LINK_INVALID = "ios_deep_link_invalid";
  @SerializedName(SERIALIZED_NAME_IOS_DEEP_LINK_INVALID)
  private Integer iosDeepLinkInvalid;

  public static final String SERIALIZED_NAME_ANDROID_DEEP_LINK_INVALID = "android_deep_link_invalid";
  @SerializedName(SERIALIZED_NAME_ANDROID_DEEP_LINK_INVALID)
  private Integer androidDeepLinkInvalid;

  public static final String SERIALIZED_NAME_AVAILABILITY_NORMALIZED = "availability_normalized";
  @SerializedName(SERIALIZED_NAME_AVAILABILITY_NORMALIZED)
  private Integer availabilityNormalized;

  public static final String SERIALIZED_NAME_CONDITION_NORMALIZED = "condition_normalized";
  @SerializedName(SERIALIZED_NAME_CONDITION_NORMALIZED)
  private Integer conditionNormalized;

  public static final String SERIALIZED_NAME_GENDER_NORMALIZED = "gender_normalized";
  @SerializedName(SERIALIZED_NAME_GENDER_NORMALIZED)
  private Integer genderNormalized;

  public static final String SERIALIZED_NAME_SIZE_TYPE_NORMALIZED = "size_type_normalized";
  @SerializedName(SERIALIZED_NAME_SIZE_TYPE_NORMALIZED)
  private Integer sizeTypeNormalized;

  public static final String SERIALIZED_NAME_AGE_GROUP_NORMALIZED = "age_group_normalized";
  @SerializedName(SERIALIZED_NAME_AGE_GROUP_NORMALIZED)
  private Integer ageGroupNormalized;

  public static final String SERIALIZED_NAME_UTM_SOURCE_AUTO_CORRECTED = "utm_source_auto_corrected";
  @SerializedName(SERIALIZED_NAME_UTM_SOURCE_AUTO_CORRECTED)
  private Integer utmSourceAutoCorrected;

  public static final String SERIALIZED_NAME_COUNTRY_DOES_NOT_MAP_TO_CURRENCY = "country_does_not_map_to_currency";
  @SerializedName(SERIALIZED_NAME_COUNTRY_DOES_NOT_MAP_TO_CURRENCY)
  private Integer countryDoesNotMapToCurrency;

  public static final String SERIALIZED_NAME_MIN_AD_PRICE_INVALID = "min_ad_price_invalid";
  @SerializedName(SERIALIZED_NAME_MIN_AD_PRICE_INVALID)
