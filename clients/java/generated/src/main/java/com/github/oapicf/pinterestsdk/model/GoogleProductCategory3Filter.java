...
public class GoogleProductCategory3Filter {
  ...
  public GoogleProductCategory3Filter GOOGLE_PRODUCT_CATEGORY_3(@javax.annotation.Nonnull CatalogsProductGroupMultipleStringListCriteria GOOGLE_PRODUCT_CATEGORY_3) {
  ...
  public void setGOOGLEPRODUCTCATEGORY3(@javax.annotation.Nonnull CatalogsProductGroupMultipleStringListCriteria GOOGLE_PRODUCT_CATEGORY_3) {
    this.GOOGLE_PRODUCT_CATEGORY_3 = GOOGLE_PRODUCT_CATEGORY_3;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("GOOGLE_PRODUCT_CATEGORY_3"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("GOOGLE_PRODUCT_CATEGORY_3"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleProductCategory3Filter.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GoogleProductCategory3Filter is not found in the empty JSON string", GoogleProductCategory3Filter.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleProductCategory3Filter.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GoogleProductCategory3Filter` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      // validate the required field `GOOGLE_PRODUCT_CATEGORY_3`
      CatalogsProductGroupMultipleStringListCriteria.validateJsonElement(jsonObj.get("GOOGLE_PRODUCT_CATEGORY_3"));
  }
