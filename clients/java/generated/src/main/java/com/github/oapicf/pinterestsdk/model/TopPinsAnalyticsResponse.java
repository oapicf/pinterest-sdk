...
import com.github.oapicf.pinterestsdk.model.TopPinsAnalyticsResponsePinsItems;
...
public class TopPinsAnalyticsResponse {
  ...
  public TopPinsAnalyticsResponse dateAvailability(@javax.annotation.Nullable TopPinsAnalyticsResponseDateAvailability dateAvailability) {
  ...
  public TopPinsAnalyticsResponse pins(@javax.annotation.Nullable List<TopPinsAnalyticsResponsePinsItems> pins) {
    this.pins = pins;
    return this;
  }
  ...
  public void setPins(@javax.annotation.Nullable List<TopPinsAnalyticsResponsePinsItems> pins) {
    this.pins = pins;
  }


  public TopPinsAnalyticsResponse sortBy(@javax.annotation.Nullable TopPinsSortBy sortBy) {
    this.sortBy = sortBy;
    return this;
  }
  ...
  public void setSortBy(@javax.annotation.Nullable TopPinsSortBy sortBy) {
    this.sortBy = sortBy;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to TopPinsAnalyticsResponse
   */
      ...
      if (jsonObj.get("pins") != null && !jsonObj.get("pins").isJsonNull()) {
        ...
        if (jsonArraypins != null) {
          ...
          for (int i = 0; i < jsonArraypins.size(); i++) {
            TopPinsAnalyticsResponsePinsItems.validateJsonElement(jsonArraypins.get(i));
          };
        }
      }
      // validate the optional field `sort_by`
      if (jsonObj.get("sort_by") != null && !jsonObj.get("sort_by").isJsonNull()) {
        TopPinsSortBy.validateJsonElement(jsonObj.get("sort_by"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TopPinsAnalyticsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TopPinsAnalyticsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TopPinsAnalyticsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TopPinsAnalyticsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<TopPinsAnalyticsResponse>() {
           @Override
           public void write(JsonWriter out, TopPinsAnalyticsResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TopPinsAnalyticsResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TopPinsAnalyticsResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TopPinsAnalyticsResponse
   * @throws IOException if the JSON string is invalid with respect to TopPinsAnalyticsResponse
   */
  public static TopPinsAnalyticsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TopPinsAnalyticsResponse.class);
  }

  /**
   * Convert an instance of TopPinsAnalyticsResponse to an JSON string
   *
   * @return JSON string
   */
