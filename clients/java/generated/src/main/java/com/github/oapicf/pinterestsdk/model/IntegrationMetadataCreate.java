...
public class IntegrationMetadataCreate {
  ...
  public IntegrationMetadataCreate additionalId1(@javax.annotation.Nullable String additionalId1) {
  ...
  public IntegrationMetadataCreate connectedAdvertiserId(@javax.annotation.Nullable String connectedAdvertiserId) {
  ...
  public IntegrationMetadataCreate connectedLbaId(@javax.annotation.Nullable String connectedLbaId) {
  ...
  public IntegrationMetadataCreate connectedMerchantId(@javax.annotation.Nullable String connectedMerchantId) {
  ...
  public IntegrationMetadataCreate connectedTagId(@javax.annotation.Nullable String connectedTagId) {
  ...
  public IntegrationMetadataCreate externalBusinessId(@javax.annotation.Nullable String externalBusinessId) {
  ...
  public IntegrationMetadataCreate partnerAccessToken(@javax.annotation.Nullable String partnerAccessToken) {
  ...
  public IntegrationMetadataCreate partnerAccessTokenExpiry(@javax.annotation.Nullable BigDecimal partnerAccessTokenExpiry) {
  ...
  public IntegrationMetadataCreate partnerMetadata(@javax.annotation.Nullable String partnerMetadata) {
  ...
  public IntegrationMetadataCreate partnerPrimaryEmail(@javax.annotation.Nullable String partnerPrimaryEmail) {
  ...
  public IntegrationMetadataCreate partnerRefreshToken(@javax.annotation.Nullable String partnerRefreshToken) {
  ...
  public IntegrationMetadataCreate partnerRefreshTokenExpiry(@javax.annotation.Nullable BigDecimal partnerRefreshTokenExpiry) {
  ...
  public IntegrationMetadataCreate scopes(@javax.annotation.Nullable String scopes) {
    this.scopes = scopes;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("additional_id_1", "connected_advertiser_id", "connected_lba_id", "connected_merchant_id", "connected_tag_id", "external_business_id", "partner_access_token", "partner_access_token_expiry", "partner_metadata", "partner_primary_email", "partner_refresh_token", "partner_refresh_token_expiry", "scopes"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to IntegrationMetadataCreate
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IntegrationMetadataCreate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in IntegrationMetadataCreate is not found in the empty JSON string", IntegrationMetadataCreate.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IntegrationMetadataCreate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `IntegrationMetadataCreate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IntegrationMetadataCreate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IntegrationMetadataCreate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IntegrationMetadataCreate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IntegrationMetadataCreate.class));

       return (TypeAdapter<T>) new TypeAdapter<IntegrationMetadataCreate>() {
           @Override
           public void write(JsonWriter out, IntegrationMetadataCreate value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IntegrationMetadataCreate read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IntegrationMetadataCreate given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IntegrationMetadataCreate
   * @throws IOException if the JSON string is invalid with respect to IntegrationMetadataCreate
   */
  public static IntegrationMetadataCreate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IntegrationMetadataCreate.class);
  }

  /**
   * Convert an instance of IntegrationMetadataCreate to an JSON string
   *
   * @return JSON string
   */
