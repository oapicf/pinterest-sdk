...
public class CatalogsFeedCreateRequestSchema extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(CatalogsFeedCreateRequestSchema.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!CatalogsFeedCreateRequestSchema.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'CatalogsFeedCreateRequestSchema' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<CatalogsFeedCreateRequestSchema>() {
                @Override
                public void write(JsonWriter out, CatalogsFeedCreateRequestSchema value) throws IOException {
                ...
                @Override
                public CatalogsFeedCreateRequestSchema read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        errorMessages.add(String.format(java.util.Locale.ROOT, "Deserialization for CatalogsVerticalFeedsCreateRequest failed with `%s`.", e.getMessage()));
                    ...
                    try {
                        ...
                        // deserialization failed, continue
                        errorMessages.add(String.format(java.util.Locale.ROOT, "Deserialization for CatalogsFeedsCreateRequest failed with `%s`.", e.getMessage()));
                        log.log(Level.FINER, "Input data does not match schema 'CatalogsFeedsCreateRequest'", e);
                    }

                    if (match == 1) {
                        CatalogsFeedCreateRequestSchema ret = new CatalogsFeedCreateRequestSchema();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for CatalogsFeedCreateRequestSchema: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public CatalogsFeedCreateRequestSchema(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return CatalogsFeedCreateRequestSchema.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to CatalogsFeedCreateRequestSchema
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for CatalogsFeedCreateRequestSchema with oneOf schemas: CatalogsFeedsCreateRequest, CatalogsVerticalFeedsCreateRequest. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of CatalogsFeedCreateRequestSchema given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of CatalogsFeedCreateRequestSchema
     * @throws IOException if the JSON string is invalid with respect to CatalogsFeedCreateRequestSchema
     */
    public static CatalogsFeedCreateRequestSchema fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, CatalogsFeedCreateRequestSchema.class);
    }

    /**
     * Convert an instance of CatalogsFeedCreateRequestSchema to an JSON string
     *
     * @return JSON string
     */
