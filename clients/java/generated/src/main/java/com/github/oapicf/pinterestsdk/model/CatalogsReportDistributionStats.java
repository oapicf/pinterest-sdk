...
public class CatalogsReportDistributionStats {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("catalog_id", "code", "code_label", "ineligible_for_ads", "ineligible_for_organic", "message", "occurrences", "report_type"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to CatalogsReportDistributionStats
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CatalogsReportDistributionStats.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CatalogsReportDistributionStats is not found in the empty JSON string", CatalogsReportDistributionStats.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CatalogsReportDistributionStats.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CatalogsReportDistributionStats` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CatalogsReportDistributionStats.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CatalogsReportDistributionStats' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CatalogsReportDistributionStats> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CatalogsReportDistributionStats.class));

       return (TypeAdapter<T>) new TypeAdapter<CatalogsReportDistributionStats>() {
           @Override
           public void write(JsonWriter out, CatalogsReportDistributionStats value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CatalogsReportDistributionStats read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CatalogsReportDistributionStats given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CatalogsReportDistributionStats
   * @throws IOException if the JSON string is invalid with respect to CatalogsReportDistributionStats
   */
  public static CatalogsReportDistributionStats fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CatalogsReportDistributionStats.class);
  }

  /**
   * Convert an instance of CatalogsReportDistributionStats to an JSON string
   *
   * @return JSON string
   */
