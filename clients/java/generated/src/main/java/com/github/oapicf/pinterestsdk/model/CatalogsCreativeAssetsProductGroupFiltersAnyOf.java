...
public class CatalogsCreativeAssetsProductGroupFiltersAnyOf {
  ...
  public CatalogsCreativeAssetsProductGroupFiltersAnyOf anyOf(@javax.annotation.Nonnull List<CatalogsCreativeAssetsProductGroupFilterKeys> anyOf) {
    this.anyOf = anyOf;
    return this;
  }
  ...
  public void setAnyOf(@javax.annotation.Nonnull List<CatalogsCreativeAssetsProductGroupFilterKeys> anyOf) {
    this.anyOf = anyOf;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CatalogsCreativeAssetsProductGroupFiltersAnyOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CatalogsCreativeAssetsProductGroupFiltersAnyOf is not found in the empty JSON string", CatalogsCreativeAssetsProductGroupFiltersAnyOf.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CatalogsCreativeAssetsProductGroupFiltersAnyOf.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CatalogsCreativeAssetsProductGroupFiltersAnyOf` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("any_of") != null) {
        ...
        for (int i = 0; i < jsonArrayanyOf.size(); i++) {
          CatalogsCreativeAssetsProductGroupFilterKeys.validateJsonElement(jsonArrayanyOf.get(i));
        }
      }
  }
