...
public class CatalogsFeedsCreateRequest {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("default_currency", "name", "format", "default_locale", "credentials", "location", "preferred_processing_schedule", "default_country", "default_availability", "status"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("name", "format", "location"));
  }
