...
import com.github.oapicf.pinterestsdk.model.SearchUserPinsList200Response;
...
public class SearchApi {
     ...
     */
    public SearchUserPinsList200Response searchUserPinsList(@javax.annotation.Nonnull String query, @javax.annotation.Nullable String adAccountId, @javax.annotation.Nullable String bookmark) throws ApiException {
        ApiResponse<SearchUserPinsList200Response> localVarResp = searchUserPinsListWithHttpInfo(query, adAccountId, bookmark);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<SearchUserPinsList200Response> searchUserPinsListWithHttpInfo(@javax.annotation.Nonnull String query, @javax.annotation.Nullable String adAccountId, @javax.annotation.Nullable String bookmark) throws ApiException {
        okhttp3.Call localVarCall = searchUserPinsListValidateBeforeCall(query, adAccountId, bookmark, null);
        Type localVarReturnType = new TypeToken<SearchUserPinsList200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call searchUserPinsListAsync(@javax.annotation.Nonnull String query, @javax.annotation.Nullable String adAccountId, @javax.annotation.Nullable String bookmark, final ApiCallback<SearchUserPinsList200Response> _callback) throws ApiException {
