...
public class CampaignCreateResponseData {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("ad_account_id", "name", "status", "lifetime_spend_cap", "daily_spend_cap", "order_line_id", "tracking_urls", "start_time", "end_time", "is_flexible_daily_budgets", "default_ad_group_budget_in_micro_currency", "is_automated_campaign", "id", "objective_type", "created_time", "updated_time", "type", "is_campaign_budget_optimization", "summary_status"));
