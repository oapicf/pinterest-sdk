...
public class GetPartnerAssetsResponse {
  ...
  public GetPartnerAssetsResponse assetGroupInfo(@javax.annotation.Nullable AssetGroupBinding assetGroupInfo) {
  ...
  public GetPartnerAssetsResponse assetId(@javax.annotation.Nullable String assetId) {
  ...
  public GetPartnerAssetsResponse assetType(@javax.annotation.Nullable String assetType) {
  ...
  public GetPartnerAssetsResponse permissions(@javax.annotation.Nullable List<String> permissions) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetPartnerAssetsResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetPartnerAssetsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GetPartnerAssetsResponse is not found in the empty JSON string", GetPartnerAssetsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetPartnerAssetsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GetPartnerAssetsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetPartnerAssetsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetPartnerAssetsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetPartnerAssetsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetPartnerAssetsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<GetPartnerAssetsResponse>() {
           @Override
           public void write(JsonWriter out, GetPartnerAssetsResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetPartnerAssetsResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetPartnerAssetsResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetPartnerAssetsResponse
   * @throws IOException if the JSON string is invalid with respect to GetPartnerAssetsResponse
   */
  public static GetPartnerAssetsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetPartnerAssetsResponse.class);
  }

  /**
   * Convert an instance of GetPartnerAssetsResponse to an JSON string
   *
   * @return JSON string
   */
