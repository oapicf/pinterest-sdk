...
public class CatalogsHotelFeedsCreateRequest {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("default_currency", "name", "format", "default_locale", "credentials", "location", "preferred_processing_schedule", "catalog_type", "catalog_id", "status"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("name", "format", "default_locale", "location", "catalog_type"));
  }
