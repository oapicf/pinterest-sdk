...
public class ProductType1Filter {
  ...
  public ProductType1Filter PRODUCT_TYPE_1(@javax.annotation.Nonnull CatalogsProductGroupMultipleStringListCriteria PRODUCT_TYPE_1) {
  ...
  public void setPRODUCTTYPE1(@javax.annotation.Nonnull CatalogsProductGroupMultipleStringListCriteria PRODUCT_TYPE_1) {
    this.PRODUCT_TYPE_1 = PRODUCT_TYPE_1;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("PRODUCT_TYPE_1"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("PRODUCT_TYPE_1"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProductType1Filter.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ProductType1Filter is not found in the empty JSON string", ProductType1Filter.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProductType1Filter.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ProductType1Filter` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      // validate the required field `PRODUCT_TYPE_1`
      CatalogsProductGroupMultipleStringListCriteria.validateJsonElement(jsonObj.get("PRODUCT_TYPE_1"));
  }
