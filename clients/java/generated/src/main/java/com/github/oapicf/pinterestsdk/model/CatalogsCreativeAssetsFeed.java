...
public class CatalogsCreativeAssetsFeed {
  ...
  public CatalogsCreativeAssetsFeed catalogType(@javax.annotation.Nonnull CatalogTypeEnum catalogType) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("catalog_id", "catalog_type", "created_at", "credentials", "default_country", "default_currency", "default_locale", "format", "id", "location", "name", "preferred_processing_schedule", "status", "updated_at"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("catalog_id", "catalog_type", "created_at", "default_country", "default_locale", "format", "id", "location", "name", "status", "updated_at"));
  }
