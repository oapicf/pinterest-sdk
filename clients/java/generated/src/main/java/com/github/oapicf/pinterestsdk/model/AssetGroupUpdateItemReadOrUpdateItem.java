...
public class AssetGroupUpdateItemReadOrUpdateItem {
  ...
  public AssetGroupUpdateItemReadOrUpdateItem assetGroupId(@javax.annotation.Nonnull String assetGroupId) {
  ...
  public AssetGroupUpdateItemReadOrUpdateItem assetGroupTypes(@javax.annotation.Nullable List<AssetGroupType> assetGroupTypes) {
  ...
  public AssetGroupUpdateItemReadOrUpdateItem assetsToAdd(@javax.annotation.Nullable List<String> assetsToAdd) {
  ...
  public AssetGroupUpdateItemReadOrUpdateItem assetsToRemove(@javax.annotation.Nullable List<String> assetsToRemove) {
  ...
  public AssetGroupUpdateItemReadOrUpdateItem description(@javax.annotation.Nullable String description) {
  ...
  public AssetGroupUpdateItemReadOrUpdateItem name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AssetGroupUpdateItemReadOrUpdateItem
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AssetGroupUpdateItemReadOrUpdateItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AssetGroupUpdateItemReadOrUpdateItem is not found in the empty JSON string", AssetGroupUpdateItemReadOrUpdateItem.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AssetGroupUpdateItemReadOrUpdateItem.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AssetGroupUpdateItemReadOrUpdateItem` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AssetGroupUpdateItemReadOrUpdateItem.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AssetGroupUpdateItemReadOrUpdateItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AssetGroupUpdateItemReadOrUpdateItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AssetGroupUpdateItemReadOrUpdateItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AssetGroupUpdateItemReadOrUpdateItem.class));

       return (TypeAdapter<T>) new TypeAdapter<AssetGroupUpdateItemReadOrUpdateItem>() {
           @Override
           public void write(JsonWriter out, AssetGroupUpdateItemReadOrUpdateItem value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AssetGroupUpdateItemReadOrUpdateItem read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AssetGroupUpdateItemReadOrUpdateItem given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AssetGroupUpdateItemReadOrUpdateItem
   * @throws IOException if the JSON string is invalid with respect to AssetGroupUpdateItemReadOrUpdateItem
   */
  public static AssetGroupUpdateItemReadOrUpdateItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AssetGroupUpdateItemReadOrUpdateItem.class);
  }

  /**
   * Convert an instance of AssetGroupUpdateItemReadOrUpdateItem to an JSON string
   *
   * @return JSON string
   */
