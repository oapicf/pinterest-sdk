...
public class CatalogsProductGroupFiltersAnyOf {
  ...
  public CatalogsProductGroupFiltersAnyOf anyOf(@javax.annotation.Nonnull List<CatalogsProductGroupFilterKeys> anyOf) {
    this.anyOf = anyOf;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CatalogsProductGroupFiltersAnyOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CatalogsProductGroupFiltersAnyOf is not found in the empty JSON string", CatalogsProductGroupFiltersAnyOf.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CatalogsProductGroupFiltersAnyOf.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CatalogsProductGroupFiltersAnyOf` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
