...
public class LeadFormResponse {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("completion_message", "disclosure_language", "has_accepted_terms", "name", "policy_links", "privacy_policy_link", "questions", "status", "ad_account_id", "created_time", "id", "updated_time"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LeadFormResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in LeadFormResponse is not found in the empty JSON string", LeadFormResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LeadFormResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `LeadFormResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
