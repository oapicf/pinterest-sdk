...
import com.github.oapicf.pinterestsdk.model.CustomNumber0Filter;
import com.github.oapicf.pinterestsdk.model.CustomNumber1Filter;
import com.github.oapicf.pinterestsdk.model.CustomNumber2Filter;
import com.github.oapicf.pinterestsdk.model.CustomNumber3Filter;
import com.github.oapicf.pinterestsdk.model.CustomNumber4Filter;
...
import com.github.oapicf.pinterestsdk.model.PinterestProductCategoriesFilter;
...
import com.github.oapicf.pinterestsdk.model.TitleKeywordsFilter;
...
public class CatalogsBaseFilterKeys extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(CatalogsBaseFilterKeys.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!CatalogsBaseFilterKeys.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'CatalogsBaseFilterKeys' and its subtypes
            }
            ...
            final TypeAdapter<CustomNumber0Filter> adapterCustomNumber0Filter = gson.getDelegateAdapter(this, TypeToken.get(CustomNumber0Filter.class));
            final TypeAdapter<CustomNumber1Filter> adapterCustomNumber1Filter = gson.getDelegateAdapter(this, TypeToken.get(CustomNumber1Filter.class));
            final TypeAdapter<CustomNumber2Filter> adapterCustomNumber2Filter = gson.getDelegateAdapter(this, TypeToken.get(CustomNumber2Filter.class));
            final TypeAdapter<CustomNumber3Filter> adapterCustomNumber3Filter = gson.getDelegateAdapter(this, TypeToken.get(CustomNumber3Filter.class));
            final TypeAdapter<CustomNumber4Filter> adapterCustomNumber4Filter = gson.getDelegateAdapter(this, TypeToken.get(CustomNumber4Filter.class));
            final TypeAdapter<TitleKeywordsFilter> adapterTitleKeywordsFilter = gson.getDelegateAdapter(this, TypeToken.get(TitleKeywordsFilter.class));
            final TypeAdapter<PinterestProductCategoriesFilter> adapterPinterestProductCategoriesFilter = gson.getDelegateAdapter(this, TypeToken.get(PinterestProductCategoriesFilter.class));

            return (TypeAdapter<T>) new TypeAdapter<CatalogsBaseFilterKeys>() {
                @Override
                public void write(JsonWriter out, CatalogsBaseFilterKeys value) throws IOException {
                    ...
                    // check if the actual instance is of the type `CustomNumber0Filter`
                    if (value.getActualInstance() instanceof CustomNumber0Filter) {
                        JsonElement element = adapterCustomNumber0Filter.toJsonTree((CustomNumber0Filter)value.getActualInstance());
                        elementAdapter.write(out, element);
                        return;
                    }
                    // check if the actual instance is of the type `CustomNumber1Filter`
                    if (value.getActualInstance() instanceof CustomNumber1Filter) {
                        JsonElement element = adapterCustomNumber1Filter.toJsonTree((CustomNumber1Filter)value.getActualInstance());
                        elementAdapter.write(out, element);
                        return;
                    }
                    // check if the actual instance is of the type `CustomNumber2Filter`
                    if (value.getActualInstance() instanceof CustomNumber2Filter) {
                        JsonElement element = adapterCustomNumber2Filter.toJsonTree((CustomNumber2Filter)value.getActualInstance());
                        elementAdapter.write(out, element);
                        return;
                    }
                    // check if the actual instance is of the type `CustomNumber3Filter`
                    if (value.getActualInstance() instanceof CustomNumber3Filter) {
                        JsonElement element = adapterCustomNumber3Filter.toJsonTree((CustomNumber3Filter)value.getActualInstance());
                        elementAdapter.write(out, element);
                        return;
                    }
                    // check if the actual instance is of the type `CustomNumber4Filter`
                    if (value.getActualInstance() instanceof CustomNumber4Filter) {
                        JsonElement element = adapterCustomNumber4Filter.toJsonTree((CustomNumber4Filter)value.getActualInstance());
                        elementAdapter.write(out, element);
                        return;
                    }
                    // check if the actual instance is of the type `TitleKeywordsFilter`
                    if (value.getActualInstance() instanceof TitleKeywordsFilter) {
                        JsonElement element = adapterTitleKeywordsFilter.toJsonTree((TitleKeywordsFilter)value.getActualInstance());
                        elementAdapter.write(out, element);
                        return;
                    }
                    // check if the actual instance is of the type `PinterestProductCategoriesFilter`
                    if (value.getActualInstance() instanceof PinterestProductCategoriesFilter) {
                        JsonElement element = adapterPinterestProductCategoriesFilter.toJsonTree((PinterestProductCategoriesFilter)value.getActualInstance());
                        elementAdapter.write(out, element);
                        return;
                    }
                ...
                @Override
                public CatalogsBaseFilterKeys read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        CatalogsBaseFilterKeys ret = new CatalogsBaseFilterKeys();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    } catch (Exception e) {
                        // deserialization failed, continue
                        errorMessages.add(String.format(java.util.Locale.ROOT, "Deserialization for MinPriceFilter failed with `%s`.", e.getMessage()));
                    ...
                    try {
                        ...
                        // deserialization failed, continue
                        errorMessages.add(String.format(java.util.Locale.ROOT, "Deserialization for MaxPriceFilter failed with `%s`.", e.getMessage()));
                    ...
                    try {
                        ...
                        // deserialization failed, continue
                        errorMessages.add(String.format(java.util.Locale.ROOT, "Deserialization for CurrencyFilter failed with `%s`.", e.getMessage()));
                    ...
                    try {
                        ...
                        // deserialization failed, continue
                        errorMessages.add(String.format(java.util.Locale.ROOT, "Deserialization for ItemIdFilter failed with `%s`.", e.getMessage()));
                    ...
                    try {
                        ...
                        // deserialization failed, continue
                        errorMessages.add(String.format(java.util.Locale.ROOT, "Deserialization for AvailabilityFilter failed with `%s`.", e.getMessage()));
                    ...
                    try {
                        ...
                        // deserialization failed, continue
                        errorMessages.add(String.format(java.util.Locale.ROOT, "Deserialization for BrandFilter failed with `%s`.", e.getMessage()));
                    ...
                    try {
                        ...
                        // deserialization failed, continue
                        errorMessages.add(String.format(java.util.Locale.ROOT, "Deserialization for ConditionFilter failed with `%s`.", e.getMessage()));
                    ...
                    try {
                        ...
                        // deserialization failed, continue
                        errorMessages.add(String.format(java.util.Locale.ROOT, "Deserialization for ItemGroupIdFilter failed with `%s`.", e.getMessage()));
                    ...
                    try {
                        ...
                        // deserialization failed, continue
                        errorMessages.add(String.format(java.util.Locale.ROOT, "Deserialization for GenderFilter failed with `%s`.", e.getMessage()));
                    ...
                    try {
                        ...
                        // deserialization failed, continue
                        errorMessages.add(String.format(java.util.Locale.ROOT, "Deserialization for ProductType4Filter failed with `%s`.", e.getMessage()));
                    ...
                    try {
                        ...
                        // deserialization failed, continue
                        errorMessages.add(String.format(java.util.Locale.ROOT, "Deserialization for ProductType3Filter failed with `%s`.", e.getMessage()));
                    ...
                    try {
                        ...
                        // deserialization failed, continue
                        errorMessages.add(String.format(java.util.Locale.ROOT, "Deserialization for ProductType2Filter failed with `%s`.", e.getMessage()));
                    ...
                    try {
                        ...
                        // deserialization failed, continue
                        errorMessages.add(String.format(java.util.Locale.ROOT, "Deserialization for ProductType1Filter failed with `%s`.", e.getMessage()));
                    ...
                    try {
                        ...
                        // deserialization failed, continue
                        errorMessages.add(String.format(java.util.Locale.ROOT, "Deserialization for ProductType0Filter failed with `%s`.", e.getMessage()));
                    ...
                    // deserialize CustomNumber0Filter
                    try {
                        // validate the JSON object to see if any exception is thrown
                        CustomNumber0Filter.validateJsonElement(jsonElement);
                        actualAdapter = adapterCustomNumber0Filter;
                        CatalogsBaseFilterKeys ret = new CatalogsBaseFilterKeys();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    } catch (Exception e) {
                        // deserialization failed, continue
                        errorMessages.add(String.format(java.util.Locale.ROOT, "Deserialization for CustomNumber0Filter failed with `%s`.", e.getMessage()));
                        log.log(Level.FINER, "Input data does not match schema 'CustomNumber0Filter'", e);
                    }
                    // deserialize CustomNumber1Filter
                    try {
                        // validate the JSON object to see if any exception is thrown
                        CustomNumber1Filter.validateJsonElement(jsonElement);
                        actualAdapter = adapterCustomNumber1Filter;
                        CatalogsBaseFilterKeys ret = new CatalogsBaseFilterKeys();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    } catch (Exception e) {
                        // deserialization failed, continue
                        errorMessages.add(String.format(java.util.Locale.ROOT, "Deserialization for CustomNumber1Filter failed with `%s`.", e.getMessage()));
                        log.log(Level.FINER, "Input data does not match schema 'CustomNumber1Filter'", e);
                    }
                    // deserialize CustomNumber2Filter
                    try {
                        // validate the JSON object to see if any exception is thrown
                        CustomNumber2Filter.validateJsonElement(jsonElement);
                        actualAdapter = adapterCustomNumber2Filter;
                        CatalogsBaseFilterKeys ret = new CatalogsBaseFilterKeys();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    } catch (Exception e) {
                        // deserialization failed, continue
                        errorMessages.add(String.format(java.util.Locale.ROOT, "Deserialization for CustomNumber2Filter failed with `%s`.", e.getMessage()));
                        log.log(Level.FINER, "Input data does not match schema 'CustomNumber2Filter'", e);
                    }
                    // deserialize CustomNumber3Filter
                    try {
                        // validate the JSON object to see if any exception is thrown
                        CustomNumber3Filter.validateJsonElement(jsonElement);
                        actualAdapter = adapterCustomNumber3Filter;
                        CatalogsBaseFilterKeys ret = new CatalogsBaseFilterKeys();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    } catch (Exception e) {
                        // deserialization failed, continue
                        errorMessages.add(String.format(java.util.Locale.ROOT, "Deserialization for CustomNumber3Filter failed with `%s`.", e.getMessage()));
                        log.log(Level.FINER, "Input data does not match schema 'CustomNumber3Filter'", e);
                    }
                    // deserialize CustomNumber4Filter
                    try {
                        // validate the JSON object to see if any exception is thrown
                        CustomNumber4Filter.validateJsonElement(jsonElement);
                        actualAdapter = adapterCustomNumber4Filter;
                        CatalogsBaseFilterKeys ret = new CatalogsBaseFilterKeys();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    } catch (Exception e) {
                        // deserialization failed, continue
                        errorMessages.add(String.format(java.util.Locale.ROOT, "Deserialization for CustomNumber4Filter failed with `%s`.", e.getMessage()));
                        log.log(Level.FINER, "Input data does not match schema 'CustomNumber4Filter'", e);
                    }
                    // deserialize TitleKeywordsFilter
                    try {
                        // validate the JSON object to see if any exception is thrown
                        TitleKeywordsFilter.validateJsonElement(jsonElement);
                        actualAdapter = adapterTitleKeywordsFilter;
                        CatalogsBaseFilterKeys ret = new CatalogsBaseFilterKeys();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    } catch (Exception e) {
                        // deserialization failed, continue
                        errorMessages.add(String.format(java.util.Locale.ROOT, "Deserialization for TitleKeywordsFilter failed with `%s`.", e.getMessage()));
                        log.log(Level.FINER, "Input data does not match schema 'TitleKeywordsFilter'", e);
                    }
                    // deserialize PinterestProductCategoriesFilter
                    try {
                        // validate the JSON object to see if any exception is thrown
                        PinterestProductCategoriesFilter.validateJsonElement(jsonElement);
                        actualAdapter = adapterPinterestProductCategoriesFilter;
                        CatalogsBaseFilterKeys ret = new CatalogsBaseFilterKeys();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    } catch (Exception e) {
                        // deserialization failed, continue
                        errorMessages.add(String.format(java.util.Locale.ROOT, "Deserialization for PinterestProductCategoriesFilter failed with `%s`.", e.getMessage()));
                        log.log(Level.FINER, "Input data does not match schema 'PinterestProductCategoriesFilter'", e);
                    }

                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for CatalogsBaseFilterKeys: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public CatalogsBaseFilterKeys(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    static {
        ...
        schemas.put("CustomNumber0Filter", CustomNumber0Filter.class);
        schemas.put("CustomNumber1Filter", CustomNumber1Filter.class);
        schemas.put("CustomNumber2Filter", CustomNumber2Filter.class);
        schemas.put("CustomNumber3Filter", CustomNumber3Filter.class);
        schemas.put("CustomNumber4Filter", CustomNumber4Filter.class);
        schemas.put("TitleKeywordsFilter", TitleKeywordsFilter.class);
        schemas.put("PinterestProductCategoriesFilter", PinterestProductCategoriesFilter.class);
    }

    @Override
    public Map<String, Class<?>> getSchemas() {
        return CatalogsBaseFilterKeys.schemas;
    }
    ...
    public void setActualInstance(Object instance) {
        ...
        if (instance instanceof CustomNumber0Filter) {
            super.setActualInstance(instance);
            return;
        }

        if (instance instanceof CustomNumber1Filter) {
            super.setActualInstance(instance);
            return;
        }

        if (instance instanceof CustomNumber2Filter) {
            super.setActualInstance(instance);
            return;
        }

        if (instance instanceof CustomNumber3Filter) {
            super.setActualInstance(instance);
            return;
        }

        if (instance instanceof CustomNumber4Filter) {
            super.setActualInstance(instance);
            return;
        }

        if (instance instanceof TitleKeywordsFilter) {
            super.setActualInstance(instance);
            return;
        }

        if (instance instanceof PinterestProductCategoriesFilter) {
            super.setActualInstance(instance);
            return;
        }
    ...
    /**
     * Get the actual instance of `CustomNumber0Filter`. If the actual instance is not `CustomNumber0Filter`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `CustomNumber0Filter`
     * @throws ClassCastException if the instance is not `CustomNumber0Filter`
     */
    public CustomNumber0Filter getCustomNumber0Filter() throws ClassCastException {
        return (CustomNumber0Filter)super.getActualInstance();
    }

    /**
     * Get the actual instance of `CustomNumber1Filter`. If the actual instance is not `CustomNumber1Filter`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `CustomNumber1Filter`
     * @throws ClassCastException if the instance is not `CustomNumber1Filter`
     */
    public CustomNumber1Filter getCustomNumber1Filter() throws ClassCastException {
        return (CustomNumber1Filter)super.getActualInstance();
    }

    /**
     * Get the actual instance of `CustomNumber2Filter`. If the actual instance is not `CustomNumber2Filter`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `CustomNumber2Filter`
     * @throws ClassCastException if the instance is not `CustomNumber2Filter`
     */
    public CustomNumber2Filter getCustomNumber2Filter() throws ClassCastException {
        return (CustomNumber2Filter)super.getActualInstance();
    }

    /**
     * Get the actual instance of `CustomNumber3Filter`. If the actual instance is not `CustomNumber3Filter`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `CustomNumber3Filter`
     * @throws ClassCastException if the instance is not `CustomNumber3Filter`
     */
    public CustomNumber3Filter getCustomNumber3Filter() throws ClassCastException {
        return (CustomNumber3Filter)super.getActualInstance();
    }

    /**
     * Get the actual instance of `CustomNumber4Filter`. If the actual instance is not `CustomNumber4Filter`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `CustomNumber4Filter`
     * @throws ClassCastException if the instance is not `CustomNumber4Filter`
     */
    public CustomNumber4Filter getCustomNumber4Filter() throws ClassCastException {
        return (CustomNumber4Filter)super.getActualInstance();
    }

    /**
     * Get the actual instance of `TitleKeywordsFilter`. If the actual instance is not `TitleKeywordsFilter`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `TitleKeywordsFilter`
     * @throws ClassCastException if the instance is not `TitleKeywordsFilter`
     */
    public TitleKeywordsFilter getTitleKeywordsFilter() throws ClassCastException {
        return (TitleKeywordsFilter)super.getActualInstance();
    }

    /**
     * Get the actual instance of `PinterestProductCategoriesFilter`. If the actual instance is not `PinterestProductCategoriesFilter`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `PinterestProductCategoriesFilter`
     * @throws ClassCastException if the instance is not `PinterestProductCategoriesFilter`
     */
    public PinterestProductCategoriesFilter getPinterestProductCategoriesFilter() throws ClassCastException {
        return (PinterestProductCategoriesFilter)super.getActualInstance();
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to CatalogsBaseFilterKeys
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        // validate the json string with CustomNumber0Filter
        try {
            CustomNumber0Filter.validateJsonElement(jsonElement);
            return;
        } catch (Exception e) {
        ...
        // validate the json string with CustomNumber1Filter
        try {
            CustomNumber1Filter.validateJsonElement(jsonElement);
            return;
        } catch (Exception e) {
        ...
        // validate the json string with CustomNumber2Filter
        try {
            CustomNumber2Filter.validateJsonElement(jsonElement);
            return;
        } catch (Exception e) {
        ...
        // validate the json string with CustomNumber3Filter
        try {
            CustomNumber3Filter.validateJsonElement(jsonElement);
            return;
        } catch (Exception e) {
        ...
        // validate the json string with CustomNumber4Filter
        try {
            CustomNumber4Filter.validateJsonElement(jsonElement);
            return;
        } catch (Exception e) {
        ...
        // validate the json string with TitleKeywordsFilter
        try {
            TitleKeywordsFilter.validateJsonElement(jsonElement);
            return;
        } catch (Exception e) {
        ...
        // validate the json string with PinterestProductCategoriesFilter
        try {
            PinterestProductCategoriesFilter.validateJsonElement(jsonElement);
            return;
        } catch (Exception e) {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for CatalogsBaseFilterKeys with anyOf schemas: AvailabilityFilter, BrandFilter, ConditionFilter, CurrencyFilter, CustomLabel0Filter, CustomLabel1Filter, CustomLabel2Filter, CustomLabel3Filter, CustomLabel4Filter, CustomNumber0Filter, CustomNumber1Filter, CustomNumber2Filter, CustomNumber3Filter, CustomNumber4Filter, GenderFilter, GoogleProductCategory0Filter, GoogleProductCategory1Filter, GoogleProductCategory2Filter, GoogleProductCategory3Filter, GoogleProductCategory4Filter, GoogleProductCategory5Filter, GoogleProductCategory6Filter, ItemGroupIdFilter, ItemIdFilter, MaxPriceFilter, MediaTypeFilter, MinPriceFilter, PinterestProductCategoriesFilter, ProductType0Filter, ProductType1Filter, ProductType2Filter, ProductType3Filter, ProductType4Filter, TitleKeywordsFilter. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of CatalogsBaseFilterKeys given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of CatalogsBaseFilterKeys
     * @throws IOException if the JSON string is invalid with respect to CatalogsBaseFilterKeys
     */
    public static CatalogsBaseFilterKeys fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, CatalogsBaseFilterKeys.class);
    }

    /**
     * Convert an instance of CatalogsBaseFilterKeys to an JSON string
     *
     * @return JSON string
     */
