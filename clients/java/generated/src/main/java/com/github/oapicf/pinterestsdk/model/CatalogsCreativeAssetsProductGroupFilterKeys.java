...
import com.github.oapicf.pinterestsdk.model.LinkFilter;
...
public class CatalogsCreativeAssetsProductGroupFilterKeys extends AbstractOpenApiSchema {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            final TypeAdapter<LinkFilter> adapterLinkFilter = gson.getDelegateAdapter(this, TypeToken.get(LinkFilter.class));
            ...
            return (TypeAdapter<T>) new TypeAdapter<CatalogsCreativeAssetsProductGroupFilterKeys>() {
                ...
                public void write(JsonWriter out, CatalogsCreativeAssetsProductGroupFilterKeys value) throws IOException {
                    ...
                    // check if the actual instance is of the type `LinkFilter`
                    if (value.getActualInstance() instanceof LinkFilter) {
                        JsonElement element = adapterLinkFilter.toJsonTree((LinkFilter)value.getActualInstance());
                        elementAdapter.write(out, element);
                        return;
                    }
                ...
                public CatalogsCreativeAssetsProductGroupFilterKeys read(JsonReader in) throws IOException {
                    ...
                    // deserialize LinkFilter
                    try {
                        // validate the JSON object to see if any exception is thrown
                        LinkFilter.validateJsonElement(jsonElement);
                        actualAdapter = adapterLinkFilter;
                        CatalogsCreativeAssetsProductGroupFilterKeys ret = new CatalogsCreativeAssetsProductGroupFilterKeys();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    } catch (Exception e) {
                        // deserialization failed, continue
                        errorMessages.add(String.format(java.util.Locale.ROOT, "Deserialization for LinkFilter failed with `%s`.", e.getMessage()));
                        log.log(Level.FINER, "Input data does not match schema 'LinkFilter'", e);
                    }
    ...
    static {
        ...
        schemas.put("LinkFilter", LinkFilter.class);
    }
    ...
    public void setActualInstance(Object instance) {
        ...
        if (instance instanceof LinkFilter) {
            super.setActualInstance(instance);
            return;
        }
    ...
    /**
     * Get the actual instance of `LinkFilter`. If the actual instance is not `LinkFilter`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `LinkFilter`
     * @throws ClassCastException if the instance is not `LinkFilter`
     */
    public LinkFilter getLinkFilter() throws ClassCastException {
        return (LinkFilter)super.getActualInstance();
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        // validate the json string with LinkFilter
        try {
            LinkFilter.validateJsonElement(jsonElement);
            return;
        } catch (Exception e) {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for CatalogsCreativeAssetsProductGroupFilterKeys with anyOf schemas: CreativeAssetsIdFilter, CustomLabel0Filter, CustomLabel1Filter, CustomLabel2Filter, CustomLabel3Filter, CustomLabel4Filter, GoogleProductCategory0Filter, GoogleProductCategory1Filter, GoogleProductCategory2Filter, GoogleProductCategory3Filter, GoogleProductCategory4Filter, GoogleProductCategory5Filter, GoogleProductCategory6Filter, LinkFilter, MediaTypeFilter, TitleKeywordsFilter. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }
