...
public class AdAccountCreateSubscriptionResponse {
  ...
  public AdAccountCreateSubscriptionResponse adAccountId(@javax.annotation.Nullable String adAccountId) {
  ...
  public AdAccountCreateSubscriptionResponse apiVersion(@javax.annotation.Nullable String apiVersion) {
  ...
  public AdAccountCreateSubscriptionResponse leadFormId(@javax.annotation.Nullable String leadFormId) {
  ...
  public AdAccountCreateSubscriptionResponse userAccountId(@javax.annotation.Nullable String userAccountId) {
  ...
  public AdAccountCreateSubscriptionResponse webhookUrl(@javax.annotation.Nullable String webhookUrl) {
