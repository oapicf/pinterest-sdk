...
public class CatalogsCreativeAssetsItemResponse {
  ...
  public CatalogsCreativeAssetsItemResponse catalogType(@javax.annotation.Nonnull CatalogTypeEnum catalogType) {
  ...
  public CatalogsCreativeAssetsItemResponse itemResponseKind(@javax.annotation.Nonnull ItemResponseKindEnum itemResponseKind) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("attributes", "catalog_type", "creative_assets_id", "item_response_kind", "pins"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CatalogsCreativeAssetsItemResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CatalogsCreativeAssetsItemResponse is not found in the empty JSON string", CatalogsCreativeAssetsItemResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CatalogsCreativeAssetsItemResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CatalogsCreativeAssetsItemResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
