...
public class DeletePartnersRequest {
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeletePartnersRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("partner_type") != null && !jsonObj.get("partner_type").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("partner_type"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeletePartnersRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeletePartnersRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeletePartnersRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeletePartnersRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DeletePartnersRequest>() {
           @Override
           public void write(JsonWriter out, DeletePartnersRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeletePartnersRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeletePartnersRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeletePartnersRequest
   * @throws IOException if the JSON string is invalid with respect to DeletePartnersRequest
   */
  public static DeletePartnersRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeletePartnersRequest.class);
  }

  /**
   * Convert an instance of DeletePartnersRequest to an JSON string
   *
   * @return JSON string
   */
