...
public class AdUpdateRequest {
  ...
  public AdUpdateRequest customizableCtaType(@javax.annotation.Nullable CustomizableCTAType customizableCtaType) {
  ...
  public AdUpdateRequest disclosureType(@javax.annotation.Nullable DisclosureType disclosureType) {
  ...
  public AdUpdateRequest disclosureUrl(@javax.annotation.Nullable String disclosureUrl) {
  ...
  public AdUpdateRequest isCarting(@javax.annotation.Nullable Boolean isCarting) {
  ...
  public AdUpdateRequest quizPinData(@javax.annotation.Nullable Object quizPinData) {
  ...
  public AdUpdateRequest trackingUrls(@javax.annotation.Nullable Object trackingUrls) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AdUpdateRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AdUpdateRequest is not found in the empty JSON string", AdUpdateRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AdUpdateRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AdUpdateRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
