...
public class CreateAssetInvitesRequestItem {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("asset_id_to_permissions", "invite_id", "invite_type"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("asset_id_to_permissions", "invite_id", "invite_type"));
  }
