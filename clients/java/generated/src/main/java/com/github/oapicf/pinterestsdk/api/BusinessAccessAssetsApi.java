...
public class BusinessAccessAssetsApi {
     ...
     */
    public okhttp3.Call businessAssetMembersGetCall(@javax.annotation.Nonnull String businessId, @javax.annotation.Nonnull String assetId, @javax.annotation.Nullable Boolean fetchSystemUsers, @javax.annotation.Nullable String bookmark, @javax.annotation.Nullable Integer pageSize, @javax.annotation.Nullable Integer startIndex, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call businessAssetMembersGetValidateBeforeCall(@javax.annotation.Nonnull String businessId, @javax.annotation.Nonnull String assetId, @javax.annotation.Nullable Boolean fetchSystemUsers, @javax.annotation.Nullable String bookmark, @javax.annotation.Nullable Integer pageSize, @javax.annotation.Nullable Integer startIndex, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'businessId' is set
        if (businessId == null) {
        ...
        return businessAssetMembersGetCall(businessId, assetId, fetchSystemUsers, bookmark, pageSize, startIndex, _callback);
     ...
     */
    public BusinessAssetMembersGet200Response businessAssetMembersGet(@javax.annotation.Nonnull String businessId, @javax.annotation.Nonnull String assetId, @javax.annotation.Nullable Boolean fetchSystemUsers, @javax.annotation.Nullable String bookmark, @javax.annotation.Nullable Integer pageSize, @javax.annotation.Nullable Integer startIndex) throws ApiException {
        ApiResponse<BusinessAssetMembersGet200Response> localVarResp = businessAssetMembersGetWithHttpInfo(businessId, assetId, fetchSystemUsers, bookmark, pageSize, startIndex);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<BusinessAssetMembersGet200Response> businessAssetMembersGetWithHttpInfo(@javax.annotation.Nonnull String businessId, @javax.annotation.Nonnull String assetId, @javax.annotation.Nullable Boolean fetchSystemUsers, @javax.annotation.Nullable String bookmark, @javax.annotation.Nullable Integer pageSize, @javax.annotation.Nullable Integer startIndex) throws ApiException {
        okhttp3.Call localVarCall = businessAssetMembersGetValidateBeforeCall(businessId, assetId, fetchSystemUsers, bookmark, pageSize, startIndex, null);
     ...
     */
    public okhttp3.Call businessAssetMembersGetAsync(@javax.annotation.Nonnull String businessId, @javax.annotation.Nonnull String assetId, @javax.annotation.Nullable Boolean fetchSystemUsers, @javax.annotation.Nullable String bookmark, @javax.annotation.Nullable Integer pageSize, @javax.annotation.Nullable Integer startIndex, final ApiCallback<BusinessAssetMembersGet200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = businessAssetMembersGetValidateBeforeCall(businessId, assetId, fetchSystemUsers, bookmark, pageSize, startIndex, _callback);
        Type localVarReturnType = new TypeToken<BusinessAssetMembersGet200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
