...
public class BulkDownloadResponse {
  ...
  public BulkDownloadResponse requestId(@javax.annotation.Nullable String requestId) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BulkDownloadResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in BulkDownloadResponse is not found in the empty JSON string", BulkDownloadResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BulkDownloadResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `BulkDownloadResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
