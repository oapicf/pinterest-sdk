 ...
 * Product item fields
 */
@JsonAdapter(NullableCatalogsItemFieldType.Adapter.class)
public enum NullableCatalogsItemFieldType {
  ...
  public static class Adapter extends TypeAdapter<NullableCatalogsItemFieldType> {
    @Override
    public void write(final JsonWriter jsonWriter, final NullableCatalogsItemFieldType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public NullableCatalogsItemFieldType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return NullableCatalogsItemFieldType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    NullableCatalogsItemFieldType.fromValue(value);
  }
}
