...
import com.github.oapicf.pinterestsdk.model.TieBreakerType;
...
public class QuizPinData {
  ...
  public QuizPinData tieBreakerType(@javax.annotation.Nullable TieBreakerType tieBreakerType) {
  ...
  public void setTieBreakerType(@javax.annotation.Nullable TieBreakerType tieBreakerType) {
    this.tieBreakerType = tieBreakerType;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("questions", "results", "tie_breaker_custom_result", "tie_breaker_type"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("tie_breaker_type") != null && !jsonObj.get("tie_breaker_type").isJsonNull()) {
        TieBreakerType.validateJsonElement(jsonObj.get("tie_breaker_type"));
      }
  }
