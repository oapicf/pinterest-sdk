...
public class CreativeAssetsIdFilter {
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreativeAssetsIdFilter
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      // validate the required field `CREATIVE_ASSETS_ID`
      CatalogsProductGroupMultipleStringCriteria.validateJsonElement(jsonObj.get("CREATIVE_ASSETS_ID"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreativeAssetsIdFilter.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreativeAssetsIdFilter' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreativeAssetsIdFilter> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreativeAssetsIdFilter.class));

       return (TypeAdapter<T>) new TypeAdapter<CreativeAssetsIdFilter>() {
           @Override
           public void write(JsonWriter out, CreativeAssetsIdFilter value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreativeAssetsIdFilter read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreativeAssetsIdFilter given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreativeAssetsIdFilter
   * @throws IOException if the JSON string is invalid with respect to CreativeAssetsIdFilter
   */
  public static CreativeAssetsIdFilter fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreativeAssetsIdFilter.class);
  }

  /**
   * Convert an instance of CreativeAssetsIdFilter to an JSON string
   *
   * @return JSON string
   */
