...
public class PinMediaSource extends AbstractOpenApiSchema {
    ...
    public PinMediaSource(PinMediaSourceImageBase64 o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public PinMediaSource(PinMediaSourceImageURL o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public PinMediaSource(PinMediaSourceImagesBase64 o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public PinMediaSource(PinMediaSourceImagesURL o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public PinMediaSource(PinMediaSourcePinURL o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public PinMediaSource(PinMediaSourceVideoID o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
