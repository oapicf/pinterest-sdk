...
public class OptimizationGoalMetadataScrollupGoalMetadata {
  ...
  public OptimizationGoalMetadataScrollupGoalMetadata scrollupGoalValueInMicroCurrency(@javax.annotation.Nullable String scrollupGoalValueInMicroCurrency) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OptimizationGoalMetadataScrollupGoalMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in OptimizationGoalMetadataScrollupGoalMetadata is not found in the empty JSON string", OptimizationGoalMetadataScrollupGoalMetadata.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OptimizationGoalMetadataScrollupGoalMetadata.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `OptimizationGoalMetadataScrollupGoalMetadata` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
