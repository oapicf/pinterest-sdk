...
public class CatalogsCreativeAssetsBatchItem extends AbstractOpenApiSchema {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>) new TypeAdapter<CatalogsCreativeAssetsBatchItem>() {
                ...
                public void write(JsonWriter out, CatalogsCreativeAssetsBatchItem value) throws IOException {
                    ...
                    throw new IOException("Failed to serialize as the type doesn't match oneOf schemas: CatalogsCreateCreativeAssetsItem, CatalogsDeleteCreativeAssetsItem, CatalogsUpdateCreativeAssetsItem, CatalogsUpsertCreativeAssetsItem");
                }
                ...
                public CatalogsCreativeAssetsBatchItem read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        match++;
                        log.log(Level.FINER, "Input data matches schema 'CatalogsCreateCreativeAssetsItem'");
                    } catch (Exception e) {
                    ...
                    try {
                        ...
                        match++;
                        log.log(Level.FINER, "Input data matches schema 'CatalogsUpsertCreativeAssetsItem'");
                    } catch (Exception e) {
                        // deserialization failed, continue
                    ...
                    try {
                        ...
                        match++;
                        log.log(Level.FINER, "Input data matches schema 'CatalogsUpdateCreativeAssetsItem'");
                    } catch (Exception e) {
                        // deserialization failed, continue
                    ...
                    try {
                        ...
                        match++;
                        log.log(Level.FINER, "Input data matches schema 'CatalogsDeleteCreativeAssetsItem'");
                    } catch (Exception e) {
                        // deserialization failed, continue
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for CatalogsCreativeAssetsBatchItem: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for CatalogsCreativeAssetsBatchItem with oneOf schemas: CatalogsCreateCreativeAssetsItem, CatalogsDeleteCreativeAssetsItem, CatalogsUpdateCreativeAssetsItem, CatalogsUpsertCreativeAssetsItem. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }
