...
public class CatalogsProductGroupFilters extends AbstractOpenApiSchema {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>) new TypeAdapter<CatalogsProductGroupFilters>() {
                ...
                public void write(JsonWriter out, CatalogsProductGroupFilters value) throws IOException {
                    ...
                    throw new IOException("Failed to serialize as the type doesn't match anyOf schemas: CatalogsProductGroupFiltersAllOf, CatalogsProductGroupFiltersAnyOf");
                }
                ...
                public CatalogsProductGroupFilters read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        errorMessages.add(String.format(java.util.Locale.ROOT, "Deserialization for CatalogsProductGroupFiltersAnyOf failed with `%s`.", e.getMessage()));
                    ...
                    try {
                        ...
                        // deserialization failed, continue
                        errorMessages.add(String.format(java.util.Locale.ROOT, "Deserialization for CatalogsProductGroupFiltersAllOf failed with `%s`.", e.getMessage()));
                        log.log(Level.FINER, "Input data does not match schema 'CatalogsProductGroupFiltersAllOf'", e);
                    }

                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for CatalogsProductGroupFilters: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public CatalogsProductGroupFilters(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for CatalogsProductGroupFilters with anyOf schemas: CatalogsProductGroupFiltersAllOf, CatalogsProductGroupFiltersAnyOf. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }
