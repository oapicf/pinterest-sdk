...
public class CatalogsRetailProductMetadata {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("item_id", "item_group_id", "availability", "price", "sale_price", "currency"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("item_id", "item_group_id", "availability", "price", "sale_price", "currency"));
  }
