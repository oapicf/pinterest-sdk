...
public class ConversionEventsUserDataAnyOf2 {
  ...
  static {
    ...
    openapiRequiredFields = new HashSet<String>(Arrays.asList("client_ip_address", "client_user_agent"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ConversionEventsUserDataAnyOf2
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ConversionEventsUserDataAnyOf2.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ConversionEventsUserDataAnyOf2 is not found in the empty JSON string", ConversionEventsUserDataAnyOf2.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ConversionEventsUserDataAnyOf2.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ConversionEventsUserDataAnyOf2` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ConversionEventsUserDataAnyOf2.openapiRequiredFields) {
      ...
      if (!jsonObj.get("client_ip_address").isJsonPrimitive()) {
      ...
      if (!jsonObj.get("client_user_agent").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ConversionEventsUserDataAnyOf2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ConversionEventsUserDataAnyOf2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ConversionEventsUserDataAnyOf2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ConversionEventsUserDataAnyOf2.class));

       return (TypeAdapter<T>) new TypeAdapter<ConversionEventsUserDataAnyOf2>() {
           @Override
           public void write(JsonWriter out, ConversionEventsUserDataAnyOf2 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ConversionEventsUserDataAnyOf2 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ConversionEventsUserDataAnyOf2 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ConversionEventsUserDataAnyOf2
   * @throws IOException if the JSON string is invalid with respect to ConversionEventsUserDataAnyOf2
   */
  public static ConversionEventsUserDataAnyOf2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ConversionEventsUserDataAnyOf2.class);
  }

  /**
   * Convert an instance of ConversionEventsUserDataAnyOf2 to an JSON string
   *
   * @return JSON string
   */
