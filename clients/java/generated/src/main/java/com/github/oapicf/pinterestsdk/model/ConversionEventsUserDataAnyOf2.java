...
public class ConversionEventsUserDataAnyOf2 {
  ...
  static {
    ...
    openapiRequiredFields.add("client_ip_address");
    openapiRequiredFields.add("client_user_agent");
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ConversionEventsUserDataAnyOf2.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ConversionEventsUserDataAnyOf2 is not found in the empty JSON string", ConversionEventsUserDataAnyOf2.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ConversionEventsUserDataAnyOf2.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ConversionEventsUserDataAnyOf2` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
