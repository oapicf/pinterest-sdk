...
public class AdGroupCommon {
  ...
  public AdGroupCommon isCreativeOptimization(@javax.annotation.Nullable Boolean isCreativeOptimization) {
  ...
  public AdGroupCommon promotionApplicationLevel(@javax.annotation.Nullable PromotionApplicationLevelEnum promotionApplicationLevel) {
  ...
  public AdGroupCommon promotionId(@javax.annotation.Nullable String promotionId) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("auto_targeting_enabled", "bid_in_micro_currency", "bid_strategy_type", "billable_event", "budget_in_micro_currency", "budget_type", "campaign_id", "end_time", "is_creative_optimization", "lifetime_frequency_cap", "name", "optimization_goal_metadata", "pacing_delivery_type", "placement_group", "promotion_application_level", "promotion_id", "start_time", "status", "targeting_spec", "targeting_template_ids", "tracking_urls"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AdGroupCommon.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AdGroupCommon is not found in the empty JSON string", AdGroupCommon.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AdGroupCommon.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AdGroupCommon` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
