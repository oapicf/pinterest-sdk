...
public class ConditionFilter {
  ...
  static {
    ...
    openapiRequiredFields = new HashSet<String>(Arrays.asList("CONDITION"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ConditionFilter.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ConditionFilter is not found in the empty JSON string", ConditionFilter.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ConditionFilter.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ConditionFilter` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      CatalogsProductGroupMultipleStringCriteria.validateJsonElement(jsonObj.get("CONDITION"));
  }
