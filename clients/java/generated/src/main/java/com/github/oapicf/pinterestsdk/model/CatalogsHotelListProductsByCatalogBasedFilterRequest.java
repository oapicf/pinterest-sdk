...
public class CatalogsHotelListProductsByCatalogBasedFilterRequest {
   ...
   * @throws IOException if the JSON Element is invalid with respect to CatalogsHotelListProductsByCatalogBasedFilterRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CatalogsHotelListProductsByCatalogBasedFilterRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CatalogsHotelListProductsByCatalogBasedFilterRequest is not found in the empty JSON string", CatalogsHotelListProductsByCatalogBasedFilterRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CatalogsHotelListProductsByCatalogBasedFilterRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CatalogsHotelListProductsByCatalogBasedFilterRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CatalogsHotelListProductsByCatalogBasedFilterRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CatalogsHotelListProductsByCatalogBasedFilterRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CatalogsHotelListProductsByCatalogBasedFilterRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CatalogsHotelListProductsByCatalogBasedFilterRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CatalogsHotelListProductsByCatalogBasedFilterRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CatalogsHotelListProductsByCatalogBasedFilterRequest>() {
           @Override
           public void write(JsonWriter out, CatalogsHotelListProductsByCatalogBasedFilterRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CatalogsHotelListProductsByCatalogBasedFilterRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CatalogsHotelListProductsByCatalogBasedFilterRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CatalogsHotelListProductsByCatalogBasedFilterRequest
   * @throws IOException if the JSON string is invalid with respect to CatalogsHotelListProductsByCatalogBasedFilterRequest
   */
  public static CatalogsHotelListProductsByCatalogBasedFilterRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CatalogsHotelListProductsByCatalogBasedFilterRequest.class);
  }

  /**
   * Convert an instance of CatalogsHotelListProductsByCatalogBasedFilterRequest to an JSON string
   *
   * @return JSON string
   */
