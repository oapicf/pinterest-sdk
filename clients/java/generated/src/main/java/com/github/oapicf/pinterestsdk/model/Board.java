...
public class Board {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("id", "created_at", "board_pins_modified_at", "name", "description", "collaborator_count", "pin_count", "follower_count", "media", "owner", "privacy"));
