...
public class BillingProfilesResponse {
  ...
  public BillingProfilesResponse billingType(@javax.annotation.Nullable BillingTypeEnum billingType) {
  ...
  public void setBillingType(@javax.annotation.Nullable BillingTypeEnum billingType) {
    this.billingType = billingType;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("billing_type") != null && !jsonObj.get("billing_type").isJsonNull()) && !jsonObj.get("billing_type").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `billing_type` to be a primitive type in the JSON string but got `%s`", jsonObj.get("billing_type").toString()));
      }
      // validate the optional field `billing_type`
      if (jsonObj.get("billing_type") != null && !jsonObj.get("billing_type").isJsonNull()) {
        BillingTypeEnum.validateJsonElement(jsonObj.get("billing_type"));
      }
