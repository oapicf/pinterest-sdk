...
public class CatalogsProductGroupMultipleStringListCriteria {
  ...
  public CatalogsProductGroupMultipleStringListCriteria negated(@javax.annotation.Nullable Boolean negated) {
  ...
  public CatalogsProductGroupMultipleStringListCriteria values(@javax.annotation.Nonnull List<List<String>> values) {
    this.values = values;
    return this;
  }
  ...
  public void setValues(@javax.annotation.Nonnull List<List<String>> values) {
    this.values = values;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CatalogsProductGroupMultipleStringListCriteria.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CatalogsProductGroupMultipleStringListCriteria is not found in the empty JSON string", CatalogsProductGroupMultipleStringListCriteria.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CatalogsProductGroupMultipleStringListCriteria.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CatalogsProductGroupMultipleStringListCriteria` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
