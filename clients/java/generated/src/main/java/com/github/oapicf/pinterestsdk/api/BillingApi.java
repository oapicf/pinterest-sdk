...
public class BillingApi {
     ...
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Successfully fetched Billing invoice information for a given ad account </td><td>  -  </td></tr>
     ...
     */
    public okhttp3.Call billingInvoicesGetCall(@javax.annotation.Nonnull String adAccountId, @javax.annotation.Nullable String bookmark, @javax.annotation.Nullable Integer pageSize, @javax.annotation.Nullable String sort, @javax.annotation.Nullable String order, @javax.annotation.Nullable String status, @javax.annotation.Nullable String documentType, @javax.annotation.Nullable LocalDate startDueDate, @javax.annotation.Nullable LocalDate endDueDate, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call billingInvoicesGetValidateBeforeCall(@javax.annotation.Nonnull String adAccountId, @javax.annotation.Nullable String bookmark, @javax.annotation.Nullable Integer pageSize, @javax.annotation.Nullable String sort, @javax.annotation.Nullable String order, @javax.annotation.Nullable String status, @javax.annotation.Nullable String documentType, @javax.annotation.Nullable LocalDate startDueDate, @javax.annotation.Nullable LocalDate endDueDate, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'adAccountId' is set
        if (adAccountId == null) {
            throw new ApiException("Missing the required parameter 'adAccountId' when calling billingInvoicesGet(Async)");
        }

        return billingInvoicesGetCall(adAccountId, bookmark, pageSize, sort, order, status, documentType, startDueDate, endDueDate, _callback);
     ...
     */
    public BillingInvoicesGet200Response billingInvoicesGet(@javax.annotation.Nonnull String adAccountId, @javax.annotation.Nullable String bookmark, @javax.annotation.Nullable Integer pageSize, @javax.annotation.Nullable String sort, @javax.annotation.Nullable String order, @javax.annotation.Nullable String status, @javax.annotation.Nullable String documentType, @javax.annotation.Nullable LocalDate startDueDate, @javax.annotation.Nullable LocalDate endDueDate) throws ApiException {
        ApiResponse<BillingInvoicesGet200Response> localVarResp = billingInvoicesGetWithHttpInfo(adAccountId, bookmark, pageSize, sort, order, status, documentType, startDueDate, endDueDate);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<BillingInvoicesGet200Response> billingInvoicesGetWithHttpInfo(@javax.annotation.Nonnull String adAccountId, @javax.annotation.Nullable String bookmark, @javax.annotation.Nullable Integer pageSize, @javax.annotation.Nullable String sort, @javax.annotation.Nullable String order, @javax.annotation.Nullable String status, @javax.annotation.Nullable String documentType, @javax.annotation.Nullable LocalDate startDueDate, @javax.annotation.Nullable LocalDate endDueDate) throws ApiException {
        okhttp3.Call localVarCall = billingInvoicesGetValidateBeforeCall(adAccountId, bookmark, pageSize, sort, order, status, documentType, startDueDate, endDueDate, null);
     ...
     */
    public okhttp3.Call billingInvoicesGetAsync(@javax.annotation.Nonnull String adAccountId, @javax.annotation.Nullable String bookmark, @javax.annotation.Nullable Integer pageSize, @javax.annotation.Nullable String sort, @javax.annotation.Nullable String order, @javax.annotation.Nullable String status, @javax.annotation.Nullable String documentType, @javax.annotation.Nullable LocalDate startDueDate, @javax.annotation.Nullable LocalDate endDueDate, final ApiCallback<BillingInvoicesGet200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = billingInvoicesGetValidateBeforeCall(adAccountId, bookmark, pageSize, sort, order, status, documentType, startDueDate, endDueDate, _callback);
        Type localVarReturnType = new TypeToken<BillingInvoicesGet200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
