...
public class CatalogsProductGroup {
  ...
  * @throws IOException if the JSON Element is invalid with respect to CatalogsProductGroup
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CatalogsProductGroup.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CatalogsProductGroup is not found in the empty JSON string", CatalogsProductGroup.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CatalogsProductGroup.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CatalogsProductGroup` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CatalogsProductGroup.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CatalogsProductGroup.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CatalogsProductGroup' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CatalogsProductGroup> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CatalogsProductGroup.class));

       return (TypeAdapter<T>) new TypeAdapter<CatalogsProductGroup>() {
           @Override
           public void write(JsonWriter out, CatalogsProductGroup value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CatalogsProductGroup read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of CatalogsProductGroup given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CatalogsProductGroup
  * @throws IOException if the JSON string is invalid with respect to CatalogsProductGroup
  */
  public static CatalogsProductGroup fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CatalogsProductGroup.class);
  }

 /**
  * Convert an instance of CatalogsProductGroup to an JSON string
  *
  * @return JSON string
  */
