...
public class AssetGroupBinding {
  ...
  public AssetGroupBinding catalogsIds(@javax.annotation.Nullable List<String> catalogsIds) {
  ...
  public void setCatalogsIds(@javax.annotation.Nullable List<String> catalogsIds) {
    this.catalogsIds = catalogsIds;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      // ensure the optional json data is an array if present
      if (jsonObj.get("catalogs_ids") != null && !jsonObj.get("catalogs_ids").isJsonNull() && !jsonObj.get("catalogs_ids").isJsonArray()) {
