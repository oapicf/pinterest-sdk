...
import com.github.oapicf.pinterestsdk.model.CatalogsRetailBatchRequestItemsItems;
...
public class CatalogsRetailBatchRequest {
  ...
  public CatalogsRetailBatchRequest catalogId(@javax.annotation.Nullable String catalogId) {
  ...
  public CatalogsRetailBatchRequest items(@javax.annotation.Nonnull List<CatalogsRetailBatchRequestItemsItems> items) {
    this.items = items;
    return this;
  }
  ...
  public void setItems(@javax.annotation.Nonnull List<CatalogsRetailBatchRequestItemsItems> items) {
    this.items = items;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("items") != null) {
        ...
        for (int i = 0; i < jsonArrayitems.size(); i++) {
          CatalogsRetailBatchRequestItemsItems.validateJsonElement(jsonArrayitems.get(i));
        }
      }
