...
public class CatalogsProductGroupsCreateManyRequestItems extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(CatalogsProductGroupsCreateManyRequestItems.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!CatalogsProductGroupsCreateManyRequestItems.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'CatalogsProductGroupsCreateManyRequestItems' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<CatalogsProductGroupsCreateManyRequestItems>() {
                @Override
                public void write(JsonWriter out, CatalogsProductGroupsCreateManyRequestItems value) throws IOException {
                ...
                @Override
                public CatalogsProductGroupsCreateManyRequestItems read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        CatalogsProductGroupsCreateManyRequestItems ret = new CatalogsProductGroupsCreateManyRequestItems();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for CatalogsProductGroupsCreateManyRequestItems: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public CatalogsProductGroupsCreateManyRequestItems(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return CatalogsProductGroupsCreateManyRequestItems.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to CatalogsProductGroupsCreateManyRequestItems
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for CatalogsProductGroupsCreateManyRequestItems with oneOf schemas: CatalogsProductGroupCreateRequest, CatalogsVerticalProductGroupCreateRequest. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of CatalogsProductGroupsCreateManyRequestItems given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of CatalogsProductGroupsCreateManyRequestItems
     * @throws IOException if the JSON string is invalid with respect to CatalogsProductGroupsCreateManyRequestItems
     */
    public static CatalogsProductGroupsCreateManyRequestItems fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, CatalogsProductGroupsCreateManyRequestItems.class);
    }

    /**
     * Convert an instance of CatalogsProductGroupsCreateManyRequestItems to an JSON string
     *
     * @return JSON string
     */
