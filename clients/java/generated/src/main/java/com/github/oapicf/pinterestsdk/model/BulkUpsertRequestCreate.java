...
public class BulkUpsertRequestCreate {
  ...
  public BulkUpsertRequestCreate catalogProductGroups(@javax.annotation.Nullable List<MultipleProductGroupsInner> catalogProductGroups) {
  ...
  public void setCatalogProductGroups(@javax.annotation.Nullable List<MultipleProductGroupsInner> catalogProductGroups) {
    this.catalogProductGroups = catalogProductGroups;
  }
  ...
  public BulkUpsertRequestCreate labels(@javax.annotation.Nullable List<LabelCreateRequest> labels) {
    this.labels = labels;
    return this;
  }
  ...
  public void setLabels(@javax.annotation.Nullable List<LabelCreateRequest> labels) {
    this.labels = labels;
  }
      ...
      if (jsonObj.get("catalog_product_groups") != null && !jsonObj.get("catalog_product_groups").isJsonNull()) {
        ...
        if (jsonArraycatalogProductGroups != null) {
          ...
          for (int i = 0; i < jsonArraycatalogProductGroups.size(); i++) {
            MultipleProductGroupsInner.validateJsonElement(jsonArraycatalogProductGroups.get(i));
          };
        }
      }
      ...
      if (jsonObj.get("labels") != null && !jsonObj.get("labels").isJsonNull()) {
        ...
        if (jsonArraylabels != null) {
          ...
          for (int i = 0; i < jsonArraylabels.size(); i++) {
            LabelCreateRequest.validateJsonElement(jsonArraylabels.get(i));
          };
        }
      }
