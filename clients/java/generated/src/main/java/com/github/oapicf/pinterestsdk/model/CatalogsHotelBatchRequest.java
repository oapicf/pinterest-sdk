...
public class CatalogsHotelBatchRequest {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("catalog_id", "catalog_type", "country", "items", "language"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("catalog_type", "country", "items", "language"));
  }
