...
public class BulkUpsertResponse {
  ...
  public BulkUpsertResponse requestId(@javax.annotation.Nullable String requestId) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BulkUpsertResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in BulkUpsertResponse is not found in the empty JSON string", BulkUpsertResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BulkUpsertResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `BulkUpsertResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
