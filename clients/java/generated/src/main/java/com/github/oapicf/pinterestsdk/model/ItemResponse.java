...
public class ItemResponse extends AbstractOpenApiSchema {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>) new TypeAdapter<ItemResponse>() {
                ...
                public void write(JsonWriter out, ItemResponse value) throws IOException {
                    ...
                    throw new IOException("Failed to serialize as the type doesn't match anyOf schemae: ItemResponseAnyOf, ItemResponseAnyOf1");
                }
    ...
    public ItemResponse(ItemResponseAnyOf o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ItemResponse(ItemResponseAnyOf1 o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
