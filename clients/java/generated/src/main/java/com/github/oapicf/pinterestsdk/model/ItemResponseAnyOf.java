...
public class ItemResponseAnyOf extends AbstractOpenApiSchema {
            ...
            return (TypeAdapter<T>) new TypeAdapter<ItemResponseAnyOf>() {
                ...
                public ItemResponseAnyOf read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        // deserialization failed, continue
                        errorMessages.add(String.format("Deserialization for CatalogsCreativeAssetsItemResponse failed with `%s`.", e.getMessage()));
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for ItemResponseAnyOf with oneOf schemas: CatalogsCreativeAssetsItemResponse, CatalogsHotelItemResponse, CatalogsRetailItemResponse. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }
