...
public class AdvancedAuctionItemsSubmitRequest {
  ...
  public AdvancedAuctionItemsSubmitRequest catalogId(@javax.annotation.Nonnull String catalogId) {
  ...
  public AdvancedAuctionItemsSubmitRequest items(@javax.annotation.Nonnull List<AdvancedAuctionItemsSubmitRecord> items) {
    this.items = items;
    return this;
  }
  ...
  public void setItems(@javax.annotation.Nonnull List<AdvancedAuctionItemsSubmitRecord> items) {
    this.items = items;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AdvancedAuctionItemsSubmitRequest
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AdvancedAuctionItemsSubmitRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AdvancedAuctionItemsSubmitRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AdvancedAuctionItemsSubmitRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AdvancedAuctionItemsSubmitRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AdvancedAuctionItemsSubmitRequest>() {
           @Override
           public void write(JsonWriter out, AdvancedAuctionItemsSubmitRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AdvancedAuctionItemsSubmitRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AdvancedAuctionItemsSubmitRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AdvancedAuctionItemsSubmitRequest
   * @throws IOException if the JSON string is invalid with respect to AdvancedAuctionItemsSubmitRequest
   */
  public static AdvancedAuctionItemsSubmitRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AdvancedAuctionItemsSubmitRequest.class);
  }

  /**
   * Convert an instance of AdvancedAuctionItemsSubmitRequest to an JSON string
   *
   * @return JSON string
   */
