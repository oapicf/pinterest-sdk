...
public class AdGroupsAnalyticsResponseInner {
  ...
  public AdGroupsAnalyticsResponseInner AD_GROUP_ID(@javax.annotation.Nullable String AD_GROUP_ID) {
  ...
  public AdGroupsAnalyticsResponseInner DATE(@javax.annotation.Nullable LocalDate DATE) {
    this.DATE = DATE;
    return this;
  }
   ...
   * @return the AdGroupsAnalyticsResponseInner instance itself
   */
   ...
   * @throws IOException if the JSON Element is invalid with respect to AdGroupsAnalyticsResponseInner
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AdGroupsAnalyticsResponseInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AdGroupsAnalyticsResponseInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AdGroupsAnalyticsResponseInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AdGroupsAnalyticsResponseInner.class));

       return (TypeAdapter<T>) new TypeAdapter<AdGroupsAnalyticsResponseInner>() {
           @Override
           public void write(JsonWriter out, AdGroupsAnalyticsResponseInner value) throws IOException {
           ...
           @Override
           public AdGroupsAnalyticsResponseInner read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             AdGroupsAnalyticsResponseInner instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of AdGroupsAnalyticsResponseInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AdGroupsAnalyticsResponseInner
   * @throws IOException if the JSON string is invalid with respect to AdGroupsAnalyticsResponseInner
   */
  public static AdGroupsAnalyticsResponseInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AdGroupsAnalyticsResponseInner.class);
  }

  /**
   * Convert an instance of AdGroupsAnalyticsResponseInner to an JSON string
   *
   * @return JSON string
   */
