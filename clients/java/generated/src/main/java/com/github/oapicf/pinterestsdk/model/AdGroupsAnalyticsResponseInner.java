...
public class AdGroupsAnalyticsResponseInner {
  ...
  public AdGroupsAnalyticsResponseInner AD_GROUP_ID(@javax.annotation.Nonnull String AD_GROUP_ID) {
  ...
  public void setADGROUPID(@javax.annotation.Nonnull String AD_GROUP_ID) {
    this.AD_GROUP_ID = AD_GROUP_ID;
  }
