...
public class CatalogsProductGroupsCreateRequest extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(CatalogsProductGroupsCreateRequest.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!CatalogsProductGroupsCreateRequest.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'CatalogsProductGroupsCreateRequest' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<CatalogsProductGroupsCreateRequest>() {
                @Override
                public void write(JsonWriter out, CatalogsProductGroupsCreateRequest value) throws IOException {
                ...
                @Override
                public CatalogsProductGroupsCreateRequest read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        CatalogsProductGroupsCreateRequest ret = new CatalogsProductGroupsCreateRequest();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for CatalogsProductGroupsCreateRequest: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public CatalogsProductGroupsCreateRequest(CatalogsProductGroupCreateRequest o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public CatalogsProductGroupsCreateRequest(CatalogsVerticalProductGroupCreateRequest o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return CatalogsProductGroupsCreateRequest.schemas;
    }
  ...
  * @throws IOException if the JSON Element is invalid with respect to CatalogsProductGroupsCreateRequest
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for CatalogsProductGroupsCreateRequest with oneOf schemas: CatalogsProductGroupCreateRequest, CatalogsVerticalProductGroupCreateRequest. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
    }
  }

 /**
  * Create an instance of CatalogsProductGroupsCreateRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CatalogsProductGroupsCreateRequest
  * @throws IOException if the JSON string is invalid with respect to CatalogsProductGroupsCreateRequest
  */
  public static CatalogsProductGroupsCreateRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CatalogsProductGroupsCreateRequest.class);
  }

 /**
  * Convert an instance of CatalogsProductGroupsCreateRequest to an JSON string
  *
  * @return JSON string
  */
