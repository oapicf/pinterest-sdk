...
import com.github.oapicf.pinterestsdk.model.CatalogsItemsBatchPostRequest;
import com.github.oapicf.pinterestsdk.model.CatalogsItemsRequest;
import com.github.oapicf.pinterestsdk.model.ItemsPost200Response;
...
public class CatalogItemsApi {
     ...
     */
    public okhttp3.Call itemsBatchPostCall(@javax.annotation.Nonnull CatalogsItemsBatchPostRequest catalogsItemsBatchPostRequest, @javax.annotation.Nullable String adAccountId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = catalogsItemsBatchPostRequest;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call itemsBatchPostValidateBeforeCall(@javax.annotation.Nonnull CatalogsItemsBatchPostRequest catalogsItemsBatchPostRequest, @javax.annotation.Nullable String adAccountId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'catalogsItemsBatchPostRequest' is set
        if (catalogsItemsBatchPostRequest == null) {
            throw new ApiException("Missing the required parameter 'catalogsItemsBatchPostRequest' when calling itemsBatchPost(Async)");
        }

        return itemsBatchPostCall(catalogsItemsBatchPostRequest, adAccountId, _callback);
     ...
     */
    public CatalogsItemsBatch itemsBatchPost(@javax.annotation.Nonnull CatalogsItemsBatchPostRequest catalogsItemsBatchPostRequest, @javax.annotation.Nullable String adAccountId) throws ApiException {
        ApiResponse<CatalogsItemsBatch> localVarResp = itemsBatchPostWithHttpInfo(catalogsItemsBatchPostRequest, adAccountId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<CatalogsItemsBatch> itemsBatchPostWithHttpInfo(@javax.annotation.Nonnull CatalogsItemsBatchPostRequest catalogsItemsBatchPostRequest, @javax.annotation.Nullable String adAccountId) throws ApiException {
        okhttp3.Call localVarCall = itemsBatchPostValidateBeforeCall(catalogsItemsBatchPostRequest, adAccountId, null);
        Type localVarReturnType = new TypeToken<CatalogsItemsBatch>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call itemsBatchPostAsync(@javax.annotation.Nonnull CatalogsItemsBatchPostRequest catalogsItemsBatchPostRequest, @javax.annotation.Nullable String adAccountId, final ApiCallback<CatalogsItemsBatch> _callback) throws ApiException {

        okhttp3.Call localVarCall = itemsBatchPostValidateBeforeCall(catalogsItemsBatchPostRequest, adAccountId, _callback);
        Type localVarReturnType = new TypeToken<CatalogsItemsBatch>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public ItemsPost200Response itemsPost(@javax.annotation.Nonnull CatalogsItemsRequest catalogsItemsRequest, @javax.annotation.Nullable String adAccountId) throws ApiException {
        ApiResponse<ItemsPost200Response> localVarResp = itemsPostWithHttpInfo(catalogsItemsRequest, adAccountId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ItemsPost200Response> itemsPostWithHttpInfo(@javax.annotation.Nonnull CatalogsItemsRequest catalogsItemsRequest, @javax.annotation.Nullable String adAccountId) throws ApiException {
        okhttp3.Call localVarCall = itemsPostValidateBeforeCall(catalogsItemsRequest, adAccountId, null);
        Type localVarReturnType = new TypeToken<ItemsPost200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call itemsPostAsync(@javax.annotation.Nonnull CatalogsItemsRequest catalogsItemsRequest, @javax.annotation.Nullable String adAccountId, final ApiCallback<ItemsPost200Response> _callback) throws ApiException {
