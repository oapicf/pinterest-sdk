...
public class CatalogsItemsBatchPostRequest extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(CatalogsItemsBatchPostRequest.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!CatalogsItemsBatchPostRequest.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'CatalogsItemsBatchPostRequest' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<CatalogsItemsBatchPostRequest>() {
                @Override
                public void write(JsonWriter out, CatalogsItemsBatchPostRequest value) throws IOException {
                ...
                @Override
                public CatalogsItemsBatchPostRequest read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        CatalogsItemsBatchPostRequest ret = new CatalogsItemsBatchPostRequest();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for CatalogsItemsBatchPostRequest: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public CatalogsItemsBatchPostRequest(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return CatalogsItemsBatchPostRequest.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to CatalogsItemsBatchPostRequest
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for CatalogsItemsBatchPostRequest with oneOf schemas: CatalogsItemsBatchRequest, CatalogsVerticalBatchRequest. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of CatalogsItemsBatchPostRequest given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of CatalogsItemsBatchPostRequest
     * @throws IOException if the JSON string is invalid with respect to CatalogsItemsBatchPostRequest
     */
    public static CatalogsItemsBatchPostRequest fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, CatalogsItemsBatchPostRequest.class);
    }

    /**
     * Convert an instance of CatalogsItemsBatchPostRequest to an JSON string
     *
     * @return JSON string
     */
