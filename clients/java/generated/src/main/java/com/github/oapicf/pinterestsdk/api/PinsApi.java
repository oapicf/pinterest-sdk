...
public class PinsApi {
     ...
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
        ...
        <tr><td> 401 </td><td> Not authorized to access board or Pin. </td><td>  -  </td></tr>
     ...
     */
    public okhttp3.Call pinsListCall(@javax.annotation.Nullable String pinFilter, @javax.annotation.Nullable Boolean pinMetrics, @javax.annotation.Nullable Boolean includeProtectedPins, @javax.annotation.Nullable String pinType, @javax.annotation.Nullable List<CreativeType> creativeTypes, @javax.annotation.Nullable String adAccountId, @javax.annotation.Nullable String bookmark, @javax.annotation.Nullable Integer pageSize, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call pinsListValidateBeforeCall(@javax.annotation.Nullable String pinFilter, @javax.annotation.Nullable Boolean pinMetrics, @javax.annotation.Nullable Boolean includeProtectedPins, @javax.annotation.Nullable String pinType, @javax.annotation.Nullable List<CreativeType> creativeTypes, @javax.annotation.Nullable String adAccountId, @javax.annotation.Nullable String bookmark, @javax.annotation.Nullable Integer pageSize, final ApiCallback _callback) throws ApiException {
        return pinsListCall(pinFilter, pinMetrics, includeProtectedPins, pinType, creativeTypes, adAccountId, bookmark, pageSize, _callback);
     ...
     */
    public PinsList200Response pinsList(@javax.annotation.Nullable String pinFilter, @javax.annotation.Nullable Boolean pinMetrics, @javax.annotation.Nullable Boolean includeProtectedPins, @javax.annotation.Nullable String pinType, @javax.annotation.Nullable List<CreativeType> creativeTypes, @javax.annotation.Nullable String adAccountId, @javax.annotation.Nullable String bookmark, @javax.annotation.Nullable Integer pageSize) throws ApiException {
        ApiResponse<PinsList200Response> localVarResp = pinsListWithHttpInfo(pinFilter, pinMetrics, includeProtectedPins, pinType, creativeTypes, adAccountId, bookmark, pageSize);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<PinsList200Response> pinsListWithHttpInfo(@javax.annotation.Nullable String pinFilter, @javax.annotation.Nullable Boolean pinMetrics, @javax.annotation.Nullable Boolean includeProtectedPins, @javax.annotation.Nullable String pinType, @javax.annotation.Nullable List<CreativeType> creativeTypes, @javax.annotation.Nullable String adAccountId, @javax.annotation.Nullable String bookmark, @javax.annotation.Nullable Integer pageSize) throws ApiException {
        okhttp3.Call localVarCall = pinsListValidateBeforeCall(pinFilter, pinMetrics, includeProtectedPins, pinType, creativeTypes, adAccountId, bookmark, pageSize, null);
     ...
     */
    public okhttp3.Call pinsListAsync(@javax.annotation.Nullable String pinFilter, @javax.annotation.Nullable Boolean pinMetrics, @javax.annotation.Nullable Boolean includeProtectedPins, @javax.annotation.Nullable String pinType, @javax.annotation.Nullable List<CreativeType> creativeTypes, @javax.annotation.Nullable String adAccountId, @javax.annotation.Nullable String bookmark, @javax.annotation.Nullable Integer pageSize, final ApiCallback<PinsList200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = pinsListValidateBeforeCall(pinFilter, pinMetrics, includeProtectedPins, pinType, creativeTypes, adAccountId, bookmark, pageSize, _callback);
        Type localVarReturnType = new TypeToken<PinsList200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
