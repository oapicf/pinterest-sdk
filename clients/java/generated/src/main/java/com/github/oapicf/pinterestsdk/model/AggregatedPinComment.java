...
public class AggregatedPinComment {
  ...
  public AggregatedPinComment aiDisclosures(@javax.annotation.Nullable AiDisclosures aiDisclosures) {
  ...
  public AggregatedPinComment altText(@javax.annotation.Nullable String altText) {
  ...
  public AggregatedPinComment boardId(@javax.annotation.Nullable String boardId) {
  ...
  public AggregatedPinComment boardSectionId(@javax.annotation.Nullable String boardSectionId) {
  ...
  public AggregatedPinComment description(@javax.annotation.Nullable String description) {
  ...
  public AggregatedPinComment dominantColor(@javax.annotation.Nullable String dominantColor) {
  ...
  public AggregatedPinComment id(@javax.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public AggregatedPinComment link(@javax.annotation.Nullable String link) {
    this.link = link;
    return this;
  }
  ...
  public AggregatedPinComment parentPinId(@javax.annotation.Nullable String parentPinId) {
  ...
  public AggregatedPinComment title(@javax.annotation.Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("ai_disclosures", "alt_text", "board_id", "board_owner", "board_section_id", "created_at", "creative_type", "description", "dominant_color", "has_been_promoted", "id", "is_owner", "is_product", "is_standard", "link", "media", "parent_pin_id", "pin_metrics", "title"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to AggregatedPinComment
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AggregatedPinComment.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AggregatedPinComment is not found in the empty JSON string", AggregatedPinComment.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AggregatedPinComment.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AggregatedPinComment` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AggregatedPinComment.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AggregatedPinComment.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AggregatedPinComment' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AggregatedPinComment> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AggregatedPinComment.class));

       return (TypeAdapter<T>) new TypeAdapter<AggregatedPinComment>() {
           @Override
           public void write(JsonWriter out, AggregatedPinComment value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AggregatedPinComment read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AggregatedPinComment given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AggregatedPinComment
   * @throws IOException if the JSON string is invalid with respect to AggregatedPinComment
   */
  public static AggregatedPinComment fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AggregatedPinComment.class);
  }

  /**
   * Convert an instance of AggregatedPinComment to an JSON string
   *
   * @return JSON string
   */
