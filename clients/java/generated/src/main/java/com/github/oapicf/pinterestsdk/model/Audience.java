...
public class Audience {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("ad_account_id", "id", "name", "audience_type", "description", "rule", "size", "status", "type", "created_timestamp", "updated_timestamp"));
