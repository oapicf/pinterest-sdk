...
import com.github.oapicf.pinterestsdk.model.CollectionsHeaderType;
...
import com.github.oapicf.pinterestsdk.model.PreferredMediaType;
import com.github.oapicf.pinterestsdk.model.ProductGroupPromotionCustomizableCTAType;
...
public class ProductGroupPromotion {
  ...
  public static final String SERIALIZED_NAME_IS_IMAGE_AUTO_RESIZING = "is_image_auto_resizing";
  @SerializedName(SERIALIZED_NAME_IS_IMAGE_AUTO_RESIZING)
  @javax.annotation.Nullable
  ...
  public ProductGroupPromotion collectionsHeaderType(@javax.annotation.Nullable CollectionsHeaderType collectionsHeaderType) {
  ...
  public void setCollectionsHeaderType(@javax.annotation.Nullable CollectionsHeaderType collectionsHeaderType) {
    this.collectionsHeaderType = collectionsHeaderType;
  }
  ...
  public ProductGroupPromotion customizableCtaType(@javax.annotation.Nullable ProductGroupPromotionCustomizableCTAType customizableCtaType) {
  ...
  public void setCustomizableCtaType(@javax.annotation.Nullable ProductGroupPromotionCustomizableCTAType customizableCtaType) {
    this.customizableCtaType = customizableCtaType;
  }
  ...
  public ProductGroupPromotion isImageAutoResizing(@javax.annotation.Nullable Boolean isImageAutoResizing) {
  ...
  public void setIsImageAutoResizing(@javax.annotation.Nullable Boolean isImageAutoResizing) {
    this.isImageAutoResizing = isImageAutoResizing;
  }
  ...
  public ProductGroupPromotion preferredMediaType(@javax.annotation.Nullable PreferredMediaType preferredMediaType) {
  ...
  public void setPreferredMediaType(@javax.annotation.Nullable PreferredMediaType preferredMediaType) {
    this.preferredMediaType = preferredMediaType;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("collections_header_type") != null && !jsonObj.get("collections_header_type").isJsonNull()) {
        CollectionsHeaderType.validateJsonElement(jsonObj.get("collections_header_type"));
      }
      ...
      if (jsonObj.get("customizable_cta_type") != null && !jsonObj.get("customizable_cta_type").isJsonNull()) {
        ProductGroupPromotionCustomizableCTAType.validateJsonElement(jsonObj.get("customizable_cta_type"));
      }
      ...
      if (jsonObj.get("preferred_media_type") != null && !jsonObj.get("preferred_media_type").isJsonNull()) {
        PreferredMediaType.validateJsonElement(jsonObj.get("preferred_media_type"));
      }
