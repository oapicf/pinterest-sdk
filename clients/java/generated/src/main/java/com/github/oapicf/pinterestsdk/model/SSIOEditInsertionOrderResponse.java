...
public class SSIOEditInsertionOrderResponse {
  ...
  public SSIOEditInsertionOrderResponse pinOrderId(@javax.annotation.Nullable String pinOrderId) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SSIOEditInsertionOrderResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in SSIOEditInsertionOrderResponse is not found in the empty JSON string", SSIOEditInsertionOrderResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SSIOEditInsertionOrderResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `SSIOEditInsertionOrderResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
