...
public class CatalogsRetailFeed {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("created_at", "id", "updated_at", "catalog_type", "credentials", "default_availability", "default_country", "default_currency", "default_locale", "format", "location", "name", "preferred_processing_schedule", "status"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("created_at", "id", "updated_at", "catalog_type", "credentials", "default_availability", "default_country", "default_currency", "default_locale", "format", "location", "name", "preferred_processing_schedule", "status"));
  }
