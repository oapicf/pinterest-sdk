...
public class BulkUpsertRequestUpdate {
  ...
  public BulkUpsertRequestUpdate catalogProductGroups(@javax.annotation.Nullable List<CatalogsProductGroupsUpdateRequest> catalogProductGroups) {
  ...
  public void setCatalogProductGroups(@javax.annotation.Nullable List<CatalogsProductGroupsUpdateRequest> catalogProductGroups) {
    this.catalogProductGroups = catalogProductGroups;
  }


  public BulkUpsertRequestUpdate keywords(@javax.annotation.Nullable List<KeywordUpdate> keywords) {
  ...
  public void setKeywords(@javax.annotation.Nullable List<KeywordUpdate> keywords) {
    this.keywords = keywords;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("ad_groups", "ads", "campaigns", "catalog_product_groups", "keywords", "labels", "product_groups"));
      ...
      if (jsonObj.get("catalog_product_groups") != null && !jsonObj.get("catalog_product_groups").isJsonNull()) {
        ...
        if (jsonArraycatalogProductGroups != null) {
          ...
          for (int i = 0; i < jsonArraycatalogProductGroups.size(); i++) {
            CatalogsProductGroupsUpdateRequest.validateJsonElement(jsonArraycatalogProductGroups.get(i));
          };
        }
      }
