...
import com.github.oapicf.pinterestsdk.model.CatalogsCreativeAssetsFeedsCreateRequest;
...
public class CatalogsVerticalFeedsCreateRequest extends AbstractOpenApiSchema {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            final TypeAdapter<CatalogsCreativeAssetsFeedsCreateRequest> adapterCatalogsCreativeAssetsFeedsCreateRequest = gson.getDelegateAdapter(this, TypeToken.get(CatalogsCreativeAssetsFeedsCreateRequest.class));
            ...
            return (TypeAdapter<T>) new TypeAdapter<CatalogsVerticalFeedsCreateRequest>() {
                ...
                public void write(JsonWriter out, CatalogsVerticalFeedsCreateRequest value) throws IOException {
                    ...
                    // check if the actual instance is of the type `CatalogsCreativeAssetsFeedsCreateRequest`
                    if (value.getActualInstance() instanceof CatalogsCreativeAssetsFeedsCreateRequest) {
                        JsonElement element = adapterCatalogsCreativeAssetsFeedsCreateRequest.toJsonTree((CatalogsCreativeAssetsFeedsCreateRequest)value.getActualInstance());
                        elementAdapter.write(out, element);
                        return;
                    }
                    throw new IOException("Failed to serialize as the type doesn't match oneOf schemas: CatalogsCreativeAssetsFeedsCreateRequest, CatalogsHotelFeedsCreateRequest, CatalogsRetailFeedsCreateRequest");
                }
                ...
                public CatalogsVerticalFeedsCreateRequest read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        errorMessages.add(String.format(java.util.Locale.ROOT, "Deserialization for CatalogsRetailFeedsCreateRequest failed with `%s`.", e.getMessage()));
                    ...
                    try {
                        ...
                        // deserialization failed, continue
                        errorMessages.add(String.format(java.util.Locale.ROOT, "Deserialization for CatalogsHotelFeedsCreateRequest failed with `%s`.", e.getMessage()));
                        log.log(Level.FINER, "Input data does not match schema 'CatalogsHotelFeedsCreateRequest'", e);
                    }
                    // deserialize CatalogsCreativeAssetsFeedsCreateRequest
                    try {
                        // validate the JSON object to see if any exception is thrown
                        CatalogsCreativeAssetsFeedsCreateRequest.validateJsonElement(jsonElement);
                        actualAdapter = adapterCatalogsCreativeAssetsFeedsCreateRequest;
                        match++;
                        log.log(Level.FINER, "Input data matches schema 'CatalogsCreativeAssetsFeedsCreateRequest'");
                    } catch (Exception e) {
                        // deserialization failed, continue
                        errorMessages.add(String.format(java.util.Locale.ROOT, "Deserialization for CatalogsCreativeAssetsFeedsCreateRequest failed with `%s`.", e.getMessage()));
                        log.log(Level.FINER, "Input data does not match schema 'CatalogsCreativeAssetsFeedsCreateRequest'", e);
                    }
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for CatalogsVerticalFeedsCreateRequest: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public CatalogsVerticalFeedsCreateRequest(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    static {
        ...
        schemas.put("CatalogsCreativeAssetsFeedsCreateRequest", CatalogsCreativeAssetsFeedsCreateRequest.class);
    }
     ...
     * CatalogsCreativeAssetsFeedsCreateRequest, CatalogsHotelFeedsCreateRequest, CatalogsRetailFeedsCreateRequest
     *
    ...
    public void setActualInstance(Object instance) {
        ...
        if (instance instanceof CatalogsCreativeAssetsFeedsCreateRequest) {
            super.setActualInstance(instance);
            return;
        }

        throw new RuntimeException("Invalid instance type. Must be CatalogsCreativeAssetsFeedsCreateRequest, CatalogsHotelFeedsCreateRequest, CatalogsRetailFeedsCreateRequest");
    }
     ...
     * CatalogsCreativeAssetsFeedsCreateRequest, CatalogsHotelFeedsCreateRequest, CatalogsRetailFeedsCreateRequest
     *
     * @return The actual instance (CatalogsCreativeAssetsFeedsCreateRequest, CatalogsHotelFeedsCreateRequest, CatalogsRetailFeedsCreateRequest)
     */
    @SuppressWarnings("unchecked")
    @Override
     ...
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `CatalogsCreativeAssetsFeedsCreateRequest`
     * @throws ClassCastException if the instance is not `CatalogsCreativeAssetsFeedsCreateRequest`
     */
    @SuppressWarnings("unchecked")
    public CatalogsCreativeAssetsFeedsCreateRequest getCatalogsCreativeAssetsFeedsCreateRequest() throws ClassCastException {
        return (CatalogsCreativeAssetsFeedsCreateRequest)super.getActualInstance();
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        // validate the json string with CatalogsCreativeAssetsFeedsCreateRequest
        try {
            CatalogsCreativeAssetsFeedsCreateRequest.validateJsonElement(jsonElement);
            validCount++;
        } catch (Exception e) {
        ...
        if (validCount != 1) {
            throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for CatalogsVerticalFeedsCreateRequest with oneOf schemas: CatalogsCreativeAssetsFeedsCreateRequest, CatalogsHotelFeedsCreateRequest, CatalogsRetailFeedsCreateRequest. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }
