...
public class CampaignCreateCommon {
  ...
  public CampaignCreateCommon adAccountId(@javax.annotation.Nullable String adAccountId) {
  ...
  public CampaignCreateCommon dailySpendCap(@javax.annotation.Nullable Integer dailySpendCap) {
  ...
  public CampaignCreateCommon endTime(@javax.annotation.Nullable Integer endTime) {
  ...
  public CampaignCreateCommon isAutomatedCampaign(@javax.annotation.Nullable Boolean isAutomatedCampaign) {
  ...
  public CampaignCreateCommon isFlexibleDailyBudgets(@javax.annotation.Nullable Boolean isFlexibleDailyBudgets) {
  ...
  public CampaignCreateCommon lifetimeSpendCap(@javax.annotation.Nullable Integer lifetimeSpendCap) {
  ...
  public CampaignCreateCommon name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public CampaignCreateCommon orderLineId(@javax.annotation.Nullable String orderLineId) {
  ...
  public CampaignCreateCommon startTime(@javax.annotation.Nullable Integer startTime) {
  ...
  public CampaignCreateCommon status(@javax.annotation.Nullable EntityStatus status) {
    this.status = status;
    return this;
  }
  ...
  public CampaignCreateCommon trackingUrls(@javax.annotation.Nullable TrackingUrls trackingUrls) {
  ...
  public CampaignCreateCommon defaultAdGroupBudgetInMicroCurrency(@javax.annotation.Nullable Integer defaultAdGroupBudgetInMicroCurrency) {
  ...
  public CampaignCreateCommon isCampaignBudgetOptimization(@javax.annotation.Nullable Boolean isCampaignBudgetOptimization) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("ad_account_id", "daily_spend_cap", "end_time", "is_automated_campaign", "is_flexible_daily_budgets", "lifetime_spend_cap", "name", "order_line_id", "start_time", "status", "tracking_urls", "default_ad_group_budget_in_micro_currency", "is_campaign_budget_optimization"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to CampaignCreateCommon
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CampaignCreateCommon.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CampaignCreateCommon is not found in the empty JSON string", CampaignCreateCommon.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CampaignCreateCommon.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CampaignCreateCommon` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CampaignCreateCommon.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CampaignCreateCommon' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CampaignCreateCommon> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CampaignCreateCommon.class));

       return (TypeAdapter<T>) new TypeAdapter<CampaignCreateCommon>() {
           @Override
           public void write(JsonWriter out, CampaignCreateCommon value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CampaignCreateCommon read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CampaignCreateCommon given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CampaignCreateCommon
   * @throws IOException if the JSON string is invalid with respect to CampaignCreateCommon
   */
  public static CampaignCreateCommon fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CampaignCreateCommon.class);
  }

  /**
   * Convert an instance of CampaignCreateCommon to an JSON string
   *
   * @return JSON string
   */
