...
public class TrendingKeywordsResponseTrendsInner {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("keyword", "pct_growth_wow", "pct_growth_mom", "pct_growth_yoy", "time_series"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TrendingKeywordsResponseTrendsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in TrendingKeywordsResponseTrendsInner is not found in the empty JSON string", TrendingKeywordsResponseTrendsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TrendingKeywordsResponseTrendsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `TrendingKeywordsResponseTrendsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
