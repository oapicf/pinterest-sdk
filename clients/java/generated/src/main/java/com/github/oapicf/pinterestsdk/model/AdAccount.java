...
public class AdAccount {
  ...
  public AdAccount timeZone(@javax.annotation.Nullable String timeZone) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("country", "created_time", "currency", "id", "name", "owner", "permissions", "time_zone", "updated_time"));
