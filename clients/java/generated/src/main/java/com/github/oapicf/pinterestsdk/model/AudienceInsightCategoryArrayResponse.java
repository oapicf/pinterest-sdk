...
public class AudienceInsightCategoryArrayResponse {
  ...
  public AudienceInsightCategoryArrayResponse items(@javax.annotation.Nullable List<AudienceInsightCategoryCommon> items) {
    this.items = items;
    return this;
  }
  ...
  public void setItems(@javax.annotation.Nullable List<AudienceInsightCategoryCommon> items) {
    this.items = items;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AudienceInsightCategoryArrayResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AudienceInsightCategoryArrayResponse is not found in the empty JSON string", AudienceInsightCategoryArrayResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AudienceInsightCategoryArrayResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AudienceInsightCategoryArrayResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
