...
public class LeadFormCreateRequest {
  ...
  public LeadFormCreateRequest completionMessage(@javax.annotation.Nullable String completionMessage) {
  ...
  public LeadFormCreateRequest disclosureLanguage(@javax.annotation.Nullable String disclosureLanguage) {
  ...
  public LeadFormCreateRequest name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public LeadFormCreateRequest policyLinks(@javax.annotation.Nullable List<LeadFormCommonPolicyLinksInner> policyLinks) {
  ...
  public LeadFormCreateRequest privacyPolicyLink(@javax.annotation.Nullable String privacyPolicyLink) {
  ...
  public LeadFormCreateRequest status(@javax.annotation.Nullable LeadFormStatus status) {
    this.status = status;
    return this;
  }
