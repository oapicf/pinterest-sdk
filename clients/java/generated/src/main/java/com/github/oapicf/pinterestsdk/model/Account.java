...
public class Account {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("account_type", "id", "profile_image", "website_url", "username", "about", "business_name", "board_count", "pin_count", "follower_count", "following_count", "monthly_views"));
