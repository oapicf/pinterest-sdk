...
import com.github.oapicf.pinterestsdk.model.UserAccountType;
...
public class Account {
  ...
  public Account accountType(@javax.annotation.Nullable UserAccountType accountType) {
  ...
  public void setAccountType(@javax.annotation.Nullable UserAccountType accountType) {
    this.accountType = accountType;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("about", "account_type", "board_count", "business_name", "follower_count", "following_count", "id", "monthly_views", "pin_count", "profile_image", "username", "website_url"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("account_type") != null && !jsonObj.get("account_type").isJsonNull()) {
        UserAccountType.validateJsonElement(jsonObj.get("account_type"));
      }
      ...
      if ((jsonObj.get("profile_image") != null && !jsonObj.get("profile_image").isJsonNull()) && !jsonObj.get("profile_image").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `profile_image` to be a primitive type in the JSON string but got `%s`", jsonObj.get("profile_image").toString()));
      }
