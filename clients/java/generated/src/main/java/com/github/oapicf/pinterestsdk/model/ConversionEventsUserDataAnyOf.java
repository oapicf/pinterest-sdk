...
public class ConversionEventsUserDataAnyOf {
  ...
  public ConversionEventsUserDataAnyOf em(@javax.annotation.Nonnull List<String> em) {
    this.em = em;
    return this;
  }
  ...
  public void setEm(@javax.annotation.Nonnull List<String> em) {
    this.em = em;
  }


  public ConversionEventsUserDataAnyOf hashedMaids(@javax.annotation.Nullable List<String> hashedMaids) {
  ...
  public ConversionEventsUserDataAnyOf clientIpAddress(@javax.annotation.Nullable String clientIpAddress) {
  ...
  public ConversionEventsUserDataAnyOf clientUserAgent(@javax.annotation.Nullable String clientUserAgent) {
