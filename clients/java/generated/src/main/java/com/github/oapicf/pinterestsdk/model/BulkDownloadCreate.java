...
import com.github.oapicf.pinterestsdk.model.BulkDownloadCampaignFilter;
...
public class BulkDownloadCreate {
  ...
  public BulkDownloadCreate campaignFilter(@javax.annotation.Nullable BulkDownloadCampaignFilter campaignFilter) {
  ...
  public void setCampaignFilter(@javax.annotation.Nullable BulkDownloadCampaignFilter campaignFilter) {
    this.campaignFilter = campaignFilter;
  }


  public BulkDownloadCreate entityIds(@javax.annotation.Nullable List<String> entityIds) {
  ...
  public BulkDownloadCreate entityTypes(@javax.annotation.Nullable List<BulkEntityType> entityTypes) {
  ...
  public BulkDownloadCreate outputFormat(@javax.annotation.Nullable BulkOutputFormat outputFormat) {
  ...
  public BulkDownloadCreate updatedSince(@javax.annotation.Nullable String updatedSince) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("campaign_filter", "entity_ids", "entity_types", "output_format", "updated_since"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to BulkDownloadCreate
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BulkDownloadCreate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in BulkDownloadCreate is not found in the empty JSON string", BulkDownloadCreate.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BulkDownloadCreate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `BulkDownloadCreate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("campaign_filter") != null && !jsonObj.get("campaign_filter").isJsonNull()) {
        BulkDownloadCampaignFilter.validateJsonElement(jsonObj.get("campaign_filter"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BulkDownloadCreate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BulkDownloadCreate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BulkDownloadCreate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BulkDownloadCreate.class));

       return (TypeAdapter<T>) new TypeAdapter<BulkDownloadCreate>() {
           @Override
           public void write(JsonWriter out, BulkDownloadCreate value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BulkDownloadCreate read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BulkDownloadCreate given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BulkDownloadCreate
   * @throws IOException if the JSON string is invalid with respect to BulkDownloadCreate
   */
  public static BulkDownloadCreate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BulkDownloadCreate.class);
  }

  /**
   * Convert an instance of BulkDownloadCreate to an JSON string
   *
   * @return JSON string
   */
