...
public class CatalogsRetailBatchRequestItemsItems extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(CatalogsRetailBatchRequestItemsItems.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!CatalogsRetailBatchRequestItemsItems.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'CatalogsRetailBatchRequestItemsItems' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<CatalogsRetailBatchRequestItemsItems>() {
                @Override
                public void write(JsonWriter out, CatalogsRetailBatchRequestItemsItems value) throws IOException {
                    ...
                    throw new IOException("Failed to serialize as the type doesn't match oneOf schemas: CatalogsCreateRetailItem, CatalogsDeleteRetailItem, CatalogsUpdateRetailItem, CatalogsUpsertRetailItem");
                }

                @Override
                public CatalogsRetailBatchRequestItemsItems read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        match++;
                        log.log(Level.FINER, "Input data matches schema 'CatalogsCreateRetailItem'");
                    } catch (Exception e) {
                    ...
                    try {
                        ...
                        match++;
                        log.log(Level.FINER, "Input data matches schema 'CatalogsUpdateRetailItem'");
                    } catch (Exception e) {
                        // deserialization failed, continue
                    ...
                    try {
                        ...
                        match++;
                        log.log(Level.FINER, "Input data matches schema 'CatalogsUpsertRetailItem'");
                    } catch (Exception e) {
                        // deserialization failed, continue
                    ...
                    try {
                        ...
                        match++;
                        log.log(Level.FINER, "Input data matches schema 'CatalogsDeleteRetailItem'");
                    } catch (Exception e) {
                        // deserialization failed, continue
                    ...
                    if (match == 1) {
                        CatalogsRetailBatchRequestItemsItems ret = new CatalogsRetailBatchRequestItemsItems();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for CatalogsRetailBatchRequestItemsItems: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public CatalogsRetailBatchRequestItemsItems(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return CatalogsRetailBatchRequestItemsItems.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to CatalogsRetailBatchRequestItemsItems
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for CatalogsRetailBatchRequestItemsItems with oneOf schemas: CatalogsCreateRetailItem, CatalogsDeleteRetailItem, CatalogsUpdateRetailItem, CatalogsUpsertRetailItem. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of CatalogsRetailBatchRequestItemsItems given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of CatalogsRetailBatchRequestItemsItems
     * @throws IOException if the JSON string is invalid with respect to CatalogsRetailBatchRequestItemsItems
     */
    public static CatalogsRetailBatchRequestItemsItems fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, CatalogsRetailBatchRequestItemsItems.class);
    }

    /**
     * Convert an instance of CatalogsRetailBatchRequestItemsItems to an JSON string
     *
     * @return JSON string
     */
