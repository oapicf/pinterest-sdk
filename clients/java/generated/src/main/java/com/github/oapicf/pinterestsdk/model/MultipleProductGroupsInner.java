...
public class MultipleProductGroupsInner extends AbstractOpenApiSchema {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>) new TypeAdapter<MultipleProductGroupsInner>() {
                ...
                public MultipleProductGroupsInner read(JsonReader in) throws IOException {
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for MultipleProductGroupsInner: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for MultipleProductGroupsInner with oneOf schemas: CatalogsProductGroupCreateRequest, CatalogsVerticalProductGroupCreateRequest. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }
