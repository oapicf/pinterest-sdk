...
public class CatalogsItemValidationIssues {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("errors", "item_id", "item_number", "warnings"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("errors", "item_id", "item_number", "warnings"));
  }
