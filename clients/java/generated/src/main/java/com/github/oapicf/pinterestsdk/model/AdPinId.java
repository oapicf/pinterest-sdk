...
public class AdPinId {
  ...
  public AdPinId pinId(@javax.annotation.Nullable String pinId) {
    this.pinId = pinId;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AdPinId.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AdPinId is not found in the empty JSON string", AdPinId.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AdPinId.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AdPinId` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
