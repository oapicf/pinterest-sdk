...
public class GoogleProductCategory5Filter {
  ...
  public GoogleProductCategory5Filter GOOGLE_PRODUCT_CATEGORY_5(@javax.annotation.Nonnull CatalogsProductGroupMultipleStringListCriteria GOOGLE_PRODUCT_CATEGORY_5) {
  ...
  public void setGOOGLEPRODUCTCATEGORY5(@javax.annotation.Nonnull CatalogsProductGroupMultipleStringListCriteria GOOGLE_PRODUCT_CATEGORY_5) {
    this.GOOGLE_PRODUCT_CATEGORY_5 = GOOGLE_PRODUCT_CATEGORY_5;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("GOOGLE_PRODUCT_CATEGORY_5"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("GOOGLE_PRODUCT_CATEGORY_5"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleProductCategory5Filter.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GoogleProductCategory5Filter is not found in the empty JSON string", GoogleProductCategory5Filter.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleProductCategory5Filter.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GoogleProductCategory5Filter` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      // validate the required field `GOOGLE_PRODUCT_CATEGORY_5`
      CatalogsProductGroupMultipleStringListCriteria.validateJsonElement(jsonObj.get("GOOGLE_PRODUCT_CATEGORY_5"));
  }
