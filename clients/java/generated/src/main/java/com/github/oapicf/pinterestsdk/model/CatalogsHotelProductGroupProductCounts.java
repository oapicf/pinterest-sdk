...
public class CatalogsHotelProductGroupProductCounts {
  ...
  public CatalogsHotelProductGroupProductCounts catalogType(@javax.annotation.Nonnull CatalogTypeEnum catalogType) {
  ...
  public CatalogsHotelProductGroupProductCounts total(@javax.annotation.Nonnull BigDecimal total) {
    this.total = total;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("catalog_type", "total"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("catalog_type", "total"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CatalogsHotelProductGroupProductCounts.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CatalogsHotelProductGroupProductCounts is not found in the empty JSON string", CatalogsHotelProductGroupProductCounts.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CatalogsHotelProductGroupProductCounts.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CatalogsHotelProductGroupProductCounts` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
