...
import com.github.oapicf.pinterestsdk.model.AdsAnalyticsCreateAsyncRequestAllOfCustomConversionEventMetrics;
...
public class AdsAnalyticsCreateAsyncRequest {
  ...
  public AdsAnalyticsCreateAsyncRequest targetingTypes(@javax.annotation.Nullable List<TargetingTypesEnum> targetingTypes) {
  ...
  public AdsAnalyticsCreateAsyncRequest customConversionEventMetrics(@javax.annotation.Nullable List<AdsAnalyticsCreateAsyncRequestAllOfCustomConversionEventMetrics> customConversionEventMetrics) {
  ...
  public void setCustomConversionEventMetrics(@javax.annotation.Nullable List<AdsAnalyticsCreateAsyncRequestAllOfCustomConversionEventMetrics> customConversionEventMetrics) {
    this.customConversionEventMetrics = customConversionEventMetrics;
  }
      ...
      if (jsonObj.get("custom_conversion_event_metrics") != null && !jsonObj.get("custom_conversion_event_metrics").isJsonNull()) {
        ...
        if (jsonArraycustomConversionEventMetrics != null) {
          ...
          for (int i = 0; i < jsonArraycustomConversionEventMetrics.size(); i++) {
            AdsAnalyticsCreateAsyncRequestAllOfCustomConversionEventMetrics.validateJsonElement(jsonArraycustomConversionEventMetrics.get(i));
          };
        }
      }
