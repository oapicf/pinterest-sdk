...
public class ItemAttributesRequestAllOfImageLink extends AbstractOpenApiSchema {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ItemAttributesRequestAllOfImageLink.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ItemAttributesRequestAllOfImageLink' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ItemAttributesRequestAllOfImageLink>() {
                @Override
                public void write(JsonWriter out, ItemAttributesRequestAllOfImageLink value) throws IOException {
                ...
                @Override
                public ItemAttributesRequestAllOfImageLink read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ItemAttributesRequestAllOfImageLink ret = new ItemAttributesRequestAllOfImageLink();
    ...
    public ItemAttributesRequestAllOfImageLink(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return ItemAttributesRequestAllOfImageLink.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to ItemAttributesRequestAllOfImageLink
     */
    ...
    /**
     * Create an instance of ItemAttributesRequestAllOfImageLink given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of ItemAttributesRequestAllOfImageLink
     * @throws IOException if the JSON string is invalid with respect to ItemAttributesRequestAllOfImageLink
     */
    public static ItemAttributesRequestAllOfImageLink fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, ItemAttributesRequestAllOfImageLink.class);
    }

    /**
     * Convert an instance of ItemAttributesRequestAllOfImageLink to an JSON string
     *
     * @return JSON string
     */
