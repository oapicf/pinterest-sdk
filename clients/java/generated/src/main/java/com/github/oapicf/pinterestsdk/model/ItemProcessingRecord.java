...
public class ItemProcessingRecord {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("errors", "item_id", "status", "warnings"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ItemProcessingRecord.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ItemProcessingRecord is not found in the empty JSON string", ItemProcessingRecord.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ItemProcessingRecord.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ItemProcessingRecord` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
