...
public class InviteResponse {
  ...
  public InviteResponse inviteData(@javax.annotation.Nullable InviteDataResponse inviteData) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("assets_summary", "business_roles", "created_by_business", "created_by_user", "created_time", "id", "invite_data", "is_received_invite", "user"));
