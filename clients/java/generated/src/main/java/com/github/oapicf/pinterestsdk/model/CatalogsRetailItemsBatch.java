...
public class CatalogsRetailItemsBatch {
  ...
  public CatalogsRetailItemsBatch catalogType(@javax.annotation.Nonnull CatalogTypeEnum catalogType) {
  ...
  public CatalogsRetailItemsBatch completedTime(@javax.annotation.Nullable OffsetDateTime completedTime) {
  ...
  public CatalogsRetailItemsBatch createdTime(@javax.annotation.Nullable OffsetDateTime createdTime) {
  ...
  static {
    ...
    openapiRequiredFields = new HashSet<String>(Arrays.asList("catalog_type", "created_time"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CatalogsRetailItemsBatch.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CatalogsRetailItemsBatch is not found in the empty JSON string", CatalogsRetailItemsBatch.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CatalogsRetailItemsBatch.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CatalogsRetailItemsBatch` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
