...
public class CatalogsCreativeAssetsFeedsUpdateRequest {
  ...
  public CatalogsCreativeAssetsFeedsUpdateRequest catalogType(@javax.annotation.Nonnull CatalogTypeEnum catalogType) {
  ...
  public CatalogsCreativeAssetsFeedsUpdateRequest credentials(@javax.annotation.Nullable CatalogsFeedCredentials credentials) {
  ...
  public CatalogsCreativeAssetsFeedsUpdateRequest defaultCurrency(@javax.annotation.Nullable NullableCurrency defaultCurrency) {
  ...
  public CatalogsCreativeAssetsFeedsUpdateRequest format(@javax.annotation.Nullable CatalogsFormat format) {
    this.format = format;
    return this;
  }
  ...
  public CatalogsCreativeAssetsFeedsUpdateRequest location(@javax.annotation.Nullable String location) {
  ...
  public CatalogsCreativeAssetsFeedsUpdateRequest name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public CatalogsCreativeAssetsFeedsUpdateRequest preferredProcessingSchedule(@javax.annotation.Nullable CatalogsFeedProcessingSchedule preferredProcessingSchedule) {
  ...
  public CatalogsCreativeAssetsFeedsUpdateRequest status(@javax.annotation.Nullable CatalogsStatus status) {
    this.status = status;
    return this;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CatalogsCreativeAssetsFeedsUpdateRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CatalogsCreativeAssetsFeedsUpdateRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CatalogsCreativeAssetsFeedsUpdateRequest is not found in the empty JSON string", CatalogsCreativeAssetsFeedsUpdateRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CatalogsCreativeAssetsFeedsUpdateRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CatalogsCreativeAssetsFeedsUpdateRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CatalogsCreativeAssetsFeedsUpdateRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CatalogsCreativeAssetsFeedsUpdateRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CatalogsCreativeAssetsFeedsUpdateRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CatalogsCreativeAssetsFeedsUpdateRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CatalogsCreativeAssetsFeedsUpdateRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CatalogsCreativeAssetsFeedsUpdateRequest>() {
           @Override
           public void write(JsonWriter out, CatalogsCreativeAssetsFeedsUpdateRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CatalogsCreativeAssetsFeedsUpdateRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CatalogsCreativeAssetsFeedsUpdateRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CatalogsCreativeAssetsFeedsUpdateRequest
   * @throws IOException if the JSON string is invalid with respect to CatalogsCreativeAssetsFeedsUpdateRequest
   */
  public static CatalogsCreativeAssetsFeedsUpdateRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CatalogsCreativeAssetsFeedsUpdateRequest.class);
  }

  /**
   * Convert an instance of CatalogsCreativeAssetsFeedsUpdateRequest to an JSON string
   *
   * @return JSON string
   */
