...
public class KeywordError {
  ...
  public KeywordError data(@javax.annotation.Nullable Keyword data) {
    this.data = data;
    return this;
  }
  ...
  public void setData(@javax.annotation.Nullable Keyword data) {
    this.data = data;
  }


  public KeywordError errorMessages(@javax.annotation.Nullable List<String> errorMessages) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!KeywordError.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in KeywordError is not found in the empty JSON string", KeywordError.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!KeywordError.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `KeywordError` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
