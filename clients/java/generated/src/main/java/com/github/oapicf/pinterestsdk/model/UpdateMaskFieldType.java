 ...
 */
@JsonAdapter(UpdateMaskFieldType.Adapter.class)
public enum UpdateMaskFieldType {
  ...
  public static class Adapter extends TypeAdapter<UpdateMaskFieldType> {
    @Override
    public void write(final JsonWriter jsonWriter, final UpdateMaskFieldType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public UpdateMaskFieldType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return UpdateMaskFieldType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    UpdateMaskFieldType.fromValue(value);
  }
}
