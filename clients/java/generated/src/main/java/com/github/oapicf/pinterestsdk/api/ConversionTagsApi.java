...
public class ConversionTagsApi {
     ...
     */
    public ConversionTag conversionTagsCreate(@javax.annotation.Nonnull String adAccountId, @javax.annotation.Nonnull ConversionTagCreate conversionTagCreate) throws ApiException {
        ApiResponse<ConversionTag> localVarResp = conversionTagsCreateWithHttpInfo(adAccountId, conversionTagCreate);
     ...
     */
    public ApiResponse<ConversionTag> conversionTagsCreateWithHttpInfo(@javax.annotation.Nonnull String adAccountId, @javax.annotation.Nonnull ConversionTagCreate conversionTagCreate) throws ApiException {
        okhttp3.Call localVarCall = conversionTagsCreateValidateBeforeCall(adAccountId, conversionTagCreate, null);
        Type localVarReturnType = new TypeToken<ConversionTag>(){}.getType();
     ...
     */
    public okhttp3.Call conversionTagsCreateAsync(@javax.annotation.Nonnull String adAccountId, @javax.annotation.Nonnull ConversionTagCreate conversionTagCreate, final ApiCallback<ConversionTag> _callback) throws ApiException {
     ...
     */
    public ConversionTag conversionTagsGet(@javax.annotation.Nonnull String adAccountId, @javax.annotation.Nonnull String conversionTagId) throws ApiException {
        ApiResponse<ConversionTag> localVarResp = conversionTagsGetWithHttpInfo(adAccountId, conversionTagId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ConversionTag> conversionTagsGetWithHttpInfo(@javax.annotation.Nonnull String adAccountId, @javax.annotation.Nonnull String conversionTagId) throws ApiException {
     ...
     */
    public okhttp3.Call conversionTagsGetAsync(@javax.annotation.Nonnull String adAccountId, @javax.annotation.Nonnull String conversionTagId, final ApiCallback<ConversionTag> _callback) throws ApiException {
     ...
     */
    public ConversionTagsList200Response conversionTagsList(@javax.annotation.Nonnull String adAccountId, @javax.annotation.Nullable Boolean filterDeleted) throws ApiException {
        ApiResponse<ConversionTagsList200Response> localVarResp = conversionTagsListWithHttpInfo(adAccountId, filterDeleted);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ConversionTagsList200Response> conversionTagsListWithHttpInfo(@javax.annotation.Nonnull String adAccountId, @javax.annotation.Nullable Boolean filterDeleted) throws ApiException {
        okhttp3.Call localVarCall = conversionTagsListValidateBeforeCall(adAccountId, filterDeleted, null);
        Type localVarReturnType = new TypeToken<ConversionTagsList200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * List conversion tags (asynchronously)
     * List conversion tags associated with an ad account.
     * @param adAccountId Unique identifier of an ad account. (required)
     * @param filterDeleted Filter by deleted status (optional, default to false)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call conversionTagsListAsync(@javax.annotation.Nonnull String adAccountId, @javax.annotation.Nullable Boolean filterDeleted, final ApiCallback<ConversionTagsList200Response> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call pageVisitConversionTagsGetCall(@javax.annotation.Nonnull String adAccountId, @javax.annotation.Nullable String bookmark, @javax.annotation.Nullable Integer pageSize, @javax.annotation.Nullable PinterestLibPaginationOrder order, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call pageVisitConversionTagsGetValidateBeforeCall(@javax.annotation.Nonnull String adAccountId, @javax.annotation.Nullable String bookmark, @javax.annotation.Nullable Integer pageSize, @javax.annotation.Nullable PinterestLibPaginationOrder order, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'adAccountId' is set
        if (adAccountId == null) {
            throw new ApiException("Missing the required parameter 'adAccountId' when calling pageVisitConversionTagsGet(Async)");
        }

        return pageVisitConversionTagsGetCall(adAccountId, bookmark, pageSize, order, _callback);
     ...
     */
    public PageVisitConversionTagsGet200Response pageVisitConversionTagsGet(@javax.annotation.Nonnull String adAccountId, @javax.annotation.Nullable String bookmark, @javax.annotation.Nullable Integer pageSize, @javax.annotation.Nullable PinterestLibPaginationOrder order) throws ApiException {
        ApiResponse<PageVisitConversionTagsGet200Response> localVarResp = pageVisitConversionTagsGetWithHttpInfo(adAccountId, bookmark, pageSize, order);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<PageVisitConversionTagsGet200Response> pageVisitConversionTagsGetWithHttpInfo(@javax.annotation.Nonnull String adAccountId, @javax.annotation.Nullable String bookmark, @javax.annotation.Nullable Integer pageSize, @javax.annotation.Nullable PinterestLibPaginationOrder order) throws ApiException {
        okhttp3.Call localVarCall = pageVisitConversionTagsGetValidateBeforeCall(adAccountId, bookmark, pageSize, order, null);
     ...
     */
    public okhttp3.Call pageVisitConversionTagsGetAsync(@javax.annotation.Nonnull String adAccountId, @javax.annotation.Nullable String bookmark, @javax.annotation.Nullable Integer pageSize, @javax.annotation.Nullable PinterestLibPaginationOrder order, final ApiCallback<PageVisitConversionTagsGet200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = pageVisitConversionTagsGetValidateBeforeCall(adAccountId, bookmark, pageSize, order, _callback);
        Type localVarReturnType = new TypeToken<PageVisitConversionTagsGet200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
