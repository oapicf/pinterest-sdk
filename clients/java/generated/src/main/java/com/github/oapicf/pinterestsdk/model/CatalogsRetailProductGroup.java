...
public class CatalogsRetailProductGroup {
   ...
   * Gets or Sets feedId
   */
  @JsonAdapter(FeedIdEnum.Adapter.class)
  public enum FeedIdEnum {
    ...
    public static class Adapter extends TypeAdapter<FeedIdEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final FeedIdEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public FeedIdEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return FeedIdEnum.fromValue(value);
      }
    }

    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      String value = jsonElement.getAsString();
      FeedIdEnum.fromValue(value);
    }
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      // validate the required field `feed_id`
      FeedIdEnum.validateJsonElement(jsonObj.get("feed_id"));
  }
