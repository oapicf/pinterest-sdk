...
public class CatalogsRetailProductGroup {
  ...
  public CatalogsRetailProductGroup type(@javax.annotation.Nonnull CatalogsProductGroupType type) {
    this.type = type;
    return this;
  }
  ...
  public void setType(@javax.annotation.Nonnull CatalogsProductGroupType type) {
    this.type = type;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("catalog_id", "catalog_type", "country", "created_at", "description", "feed_id", "filters", "id", "is_featured", "locale", "name", "status", "type", "updated_at"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("catalog_id", "catalog_type", "feed_id", "filters", "id", "type"));
  }
