...
public class CatalogsProductGroupCurrencyCriteria {
  ...
  public CatalogsProductGroupCurrencyCriteria negated(@javax.annotation.Nullable Boolean negated) {
  ...
  public CatalogsProductGroupCurrencyCriteria values(@javax.annotation.Nonnull NonNullableCatalogsCurrency values) {
    this.values = values;
    return this;
  }
  ...
  public void setValues(@javax.annotation.Nonnull NonNullableCatalogsCurrency values) {
    this.values = values;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CatalogsProductGroupCurrencyCriteria.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CatalogsProductGroupCurrencyCriteria is not found in the empty JSON string", CatalogsProductGroupCurrencyCriteria.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CatalogsProductGroupCurrencyCriteria.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CatalogsProductGroupCurrencyCriteria` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
