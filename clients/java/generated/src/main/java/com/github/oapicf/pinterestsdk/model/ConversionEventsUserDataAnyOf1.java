...
public class ConversionEventsUserDataAnyOf1 {
  ...
  public ConversionEventsUserDataAnyOf1 em(@javax.annotation.Nullable List<String> em) {
    this.em = em;
    return this;
  }
  ...
  public ConversionEventsUserDataAnyOf1 hashedMaids(@javax.annotation.Nonnull List<String> hashedMaids) {
  ...
  public void setHashedMaids(@javax.annotation.Nonnull List<String> hashedMaids) {
    this.hashedMaids = hashedMaids;
  }


  public ConversionEventsUserDataAnyOf1 clientIpAddress(@javax.annotation.Nullable String clientIpAddress) {
  ...
  public ConversionEventsUserDataAnyOf1 clientUserAgent(@javax.annotation.Nullable String clientUserAgent) {
  ...
  static {
    ...
    openapiRequiredFields = new HashSet<String>(Arrays.asList("hashed_maids"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ConversionEventsUserDataAnyOf1.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ConversionEventsUserDataAnyOf1 is not found in the empty JSON string", ConversionEventsUserDataAnyOf1.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ConversionEventsUserDataAnyOf1.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ConversionEventsUserDataAnyOf1` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
