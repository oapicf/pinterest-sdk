...
public class ProductGroupPromotionResponseItem {
  ...
  public ProductGroupPromotionResponseItem data(@javax.annotation.Nullable ProductGroupPromotion data) {
    this.data = data;
    return this;
  }
  ...
  public void setData(@javax.annotation.Nullable ProductGroupPromotion data) {
    this.data = data;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProductGroupPromotionResponseItem
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ProductGroupPromotion.validateJsonElement(jsonObj.get("data"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProductGroupPromotionResponseItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProductGroupPromotionResponseItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProductGroupPromotionResponseItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProductGroupPromotionResponseItem.class));

       return (TypeAdapter<T>) new TypeAdapter<ProductGroupPromotionResponseItem>() {
           @Override
           public void write(JsonWriter out, ProductGroupPromotionResponseItem value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProductGroupPromotionResponseItem read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ProductGroupPromotionResponseItem given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ProductGroupPromotionResponseItem
   * @throws IOException if the JSON string is invalid with respect to ProductGroupPromotionResponseItem
   */
  public static ProductGroupPromotionResponseItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProductGroupPromotionResponseItem.class);
  }

  /**
   * Convert an instance of ProductGroupPromotionResponseItem to an JSON string
   *
   * @return JSON string
   */
