...
public class KeywordUpdateBody {
   ...
   * @throws IOException if the JSON Element is invalid with respect to KeywordUpdateBody
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!KeywordUpdateBody.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'KeywordUpdateBody' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<KeywordUpdateBody> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(KeywordUpdateBody.class));

       return (TypeAdapter<T>) new TypeAdapter<KeywordUpdateBody>() {
           @Override
           public void write(JsonWriter out, KeywordUpdateBody value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public KeywordUpdateBody read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of KeywordUpdateBody given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of KeywordUpdateBody
   * @throws IOException if the JSON string is invalid with respect to KeywordUpdateBody
   */
  public static KeywordUpdateBody fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, KeywordUpdateBody.class);
  }

  /**
   * Convert an instance of KeywordUpdateBody to an JSON string
   *
   * @return JSON string
   */
