...
public class CatalogsRetailProductGroupUpdateRequest {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("catalog_type", "country", "description", "filters", "locale", "name"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CatalogsRetailProductGroupUpdateRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CatalogsRetailProductGroupUpdateRequest is not found in the empty JSON string", CatalogsRetailProductGroupUpdateRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CatalogsRetailProductGroupUpdateRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CatalogsRetailProductGroupUpdateRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
