...
public class CatalogsRetailFeedsUpdateRequest {
  ...
  public CatalogsRetailFeedsUpdateRequest catalogType(@javax.annotation.Nonnull CatalogTypeEnum catalogType) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("catalog_type", "credentials", "default_availability", "default_currency", "format", "location", "name", "preferred_processing_schedule", "status"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to CatalogsRetailFeedsUpdateRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CatalogsRetailFeedsUpdateRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CatalogsRetailFeedsUpdateRequest is not found in the empty JSON string", CatalogsRetailFeedsUpdateRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CatalogsRetailFeedsUpdateRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CatalogsRetailFeedsUpdateRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CatalogsRetailFeedsUpdateRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CatalogsRetailFeedsUpdateRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CatalogsRetailFeedsUpdateRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CatalogsRetailFeedsUpdateRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CatalogsRetailFeedsUpdateRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CatalogsRetailFeedsUpdateRequest>() {
           @Override
           public void write(JsonWriter out, CatalogsRetailFeedsUpdateRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CatalogsRetailFeedsUpdateRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CatalogsRetailFeedsUpdateRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CatalogsRetailFeedsUpdateRequest
   * @throws IOException if the JSON string is invalid with respect to CatalogsRetailFeedsUpdateRequest
   */
  public static CatalogsRetailFeedsUpdateRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CatalogsRetailFeedsUpdateRequest.class);
  }

  /**
   * Convert an instance of CatalogsRetailFeedsUpdateRequest to an JSON string
   *
   * @return JSON string
   */
