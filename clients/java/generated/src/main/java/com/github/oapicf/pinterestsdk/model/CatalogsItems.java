...
public class CatalogsItems {
  ...
  public CatalogsItems items(@javax.annotation.Nullable List<ItemResponse> items) {
    this.items = items;
    return this;
  }
  ...
  public void setItems(@javax.annotation.Nullable List<ItemResponse> items) {
    this.items = items;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CatalogsItems.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CatalogsItems is not found in the empty JSON string", CatalogsItems.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CatalogsItems.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CatalogsItems` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
