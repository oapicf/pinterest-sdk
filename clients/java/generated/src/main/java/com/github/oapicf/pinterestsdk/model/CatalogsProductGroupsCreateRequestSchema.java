...
public class CatalogsProductGroupsCreateRequestSchema extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(CatalogsProductGroupsCreateRequestSchema.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!CatalogsProductGroupsCreateRequestSchema.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'CatalogsProductGroupsCreateRequestSchema' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<CatalogsProductGroupsCreateRequestSchema>() {
                @Override
                public void write(JsonWriter out, CatalogsProductGroupsCreateRequestSchema value) throws IOException {
                ...
                @Override
                public CatalogsProductGroupsCreateRequestSchema read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        CatalogsProductGroupsCreateRequestSchema ret = new CatalogsProductGroupsCreateRequestSchema();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for CatalogsProductGroupsCreateRequestSchema: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public CatalogsProductGroupsCreateRequestSchema(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return CatalogsProductGroupsCreateRequestSchema.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to CatalogsProductGroupsCreateRequestSchema
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for CatalogsProductGroupsCreateRequestSchema with oneOf schemas: CatalogsProductGroupCreateRequest, CatalogsVerticalProductGroupCreateRequest. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of CatalogsProductGroupsCreateRequestSchema given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of CatalogsProductGroupsCreateRequestSchema
     * @throws IOException if the JSON string is invalid with respect to CatalogsProductGroupsCreateRequestSchema
     */
    public static CatalogsProductGroupsCreateRequestSchema fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, CatalogsProductGroupsCreateRequestSchema.class);
    }

    /**
     * Convert an instance of CatalogsProductGroupsCreateRequestSchema to an JSON string
     *
     * @return JSON string
     */
