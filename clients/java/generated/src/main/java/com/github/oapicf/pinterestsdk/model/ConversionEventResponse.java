...
public class ConversionEventResponse {
  ...
  public static final String SERIALIZED_NAME_REPORTING_CONVERSION_EVENT = "reporting_conversion_event";
  @SerializedName(SERIALIZED_NAME_REPORTING_CONVERSION_EVENT)
  @javax.annotation.Nullable
  ...
  public ConversionEventResponse reportingConversionEvent(@javax.annotation.Nullable String reportingConversionEvent) {
  ...
  public void setReportingConversionEvent(@javax.annotation.Nullable String reportingConversionEvent) {
    this.reportingConversionEvent = reportingConversionEvent;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("ad_account_id", "conversion_event", "conversion_tag_id", "created_time", "reporting_conversion_event"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("reporting_conversion_event") != null && !jsonObj.get("reporting_conversion_event").isJsonNull()) && !jsonObj.get("reporting_conversion_event").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `reporting_conversion_event` to be a primitive type in the JSON string but got `%s`", jsonObj.get("reporting_conversion_event").toString()));
      }
  }
