...
public class PinCreate {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("alt_text", "board_id", "board_section_id", "description", "dominant_color", "link", "media_source", "parent_pin_id", "sponsor_id", "title"));
