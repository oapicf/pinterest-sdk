...
public class PinMediaSourceImagesBase64ItemsInner {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("title", "description", "link", "content_type", "data"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PinMediaSourceImagesBase64ItemsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in PinMediaSourceImagesBase64ItemsInner is not found in the empty JSON string", PinMediaSourceImagesBase64ItemsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PinMediaSourceImagesBase64ItemsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `PinMediaSourceImagesBase64ItemsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
