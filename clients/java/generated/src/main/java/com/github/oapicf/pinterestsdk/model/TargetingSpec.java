...
public class TargetingSpec {
  ...
  public TargetingSpec AGE_BUCKET(@javax.annotation.Nullable List<TargetingSpecAgeBucket> AGE_BUCKET) {
  ...
  public TargetingSpec APPTYPE(@javax.annotation.Nullable List<TargetingSpecAppType> APPTYPE) {
  ...
  public TargetingSpec GENDER(@javax.annotation.Nullable List<TargetingSpecGender> GENDER) {
    this.GENDER = GENDER;
    return this;
  }
  ...
  public TargetingSpec GEO_EXCLUDE(@javax.annotation.Nullable List<String> GEO_EXCLUDE) {
  ...
  public TargetingSpec LOCATION_EXCLUDE(@javax.annotation.Nullable List<String> LOCATION_EXCLUDE) {
  ...
  public TargetingSpec MAXIMUM_AGE(@javax.annotation.Nullable String MAXIMUM_AGE) {
  ...
  public TargetingSpec MINIMUM_AGE(@javax.annotation.Nullable String MINIMUM_AGE) {
