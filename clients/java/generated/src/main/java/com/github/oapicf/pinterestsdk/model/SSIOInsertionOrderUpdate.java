...
public class SSIOInsertionOrderUpdate {
  ...
  public SSIOInsertionOrderUpdate adsManagerOrderLineId(@javax.annotation.Nullable String adsManagerOrderLineId) {
  ...
  public SSIOInsertionOrderUpdate agencyLink(@javax.annotation.Nullable String agencyLink) {
  ...
  public SSIOInsertionOrderUpdate billingContactEmail(@javax.annotation.Nullable String billingContactEmail) {
  ...
  public SSIOInsertionOrderUpdate billingContactFirstname(@javax.annotation.Nullable String billingContactFirstname) {
  ...
  public SSIOInsertionOrderUpdate billingContactLastname(@javax.annotation.Nullable String billingContactLastname) {
  ...
  public SSIOInsertionOrderUpdate budgetAmount(@javax.annotation.Nullable Double budgetAmount) {
  ...
  public SSIOInsertionOrderUpdate endDate(@javax.annotation.Nullable String endDate) {
  ...
  public SSIOInsertionOrderUpdate mediaContactEmail(@javax.annotation.Nullable String mediaContactEmail) {
  ...
  public SSIOInsertionOrderUpdate mediaContactFirstname(@javax.annotation.Nullable String mediaContactFirstname) {
  ...
  public SSIOInsertionOrderUpdate mediaContactLastname(@javax.annotation.Nullable String mediaContactLastname) {
  ...
  public SSIOInsertionOrderUpdate oracleLineId(@javax.annotation.Nullable String oracleLineId) {
  ...
  public SSIOInsertionOrderUpdate poNumber(@javax.annotation.Nullable String poNumber) {
  ...
  public SSIOInsertionOrderUpdate salesforceOrderId(@javax.annotation.Nullable String salesforceOrderId) {
  ...
  public SSIOInsertionOrderUpdate salesforceOrderLineId(@javax.annotation.Nullable String salesforceOrderLineId) {
  ...
  public SSIOInsertionOrderUpdate startDate(@javax.annotation.Nullable String startDate) {
  ...
  public SSIOInsertionOrderUpdate userEmail(@javax.annotation.Nullable String userEmail) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to SSIOInsertionOrderUpdate
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SSIOInsertionOrderUpdate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in SSIOInsertionOrderUpdate is not found in the empty JSON string", SSIOInsertionOrderUpdate.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SSIOInsertionOrderUpdate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `SSIOInsertionOrderUpdate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SSIOInsertionOrderUpdate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SSIOInsertionOrderUpdate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SSIOInsertionOrderUpdate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SSIOInsertionOrderUpdate.class));

       return (TypeAdapter<T>) new TypeAdapter<SSIOInsertionOrderUpdate>() {
           @Override
           public void write(JsonWriter out, SSIOInsertionOrderUpdate value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SSIOInsertionOrderUpdate read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SSIOInsertionOrderUpdate given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SSIOInsertionOrderUpdate
   * @throws IOException if the JSON string is invalid with respect to SSIOInsertionOrderUpdate
   */
  public static SSIOInsertionOrderUpdate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SSIOInsertionOrderUpdate.class);
  }

  /**
   * Convert an instance of SSIOInsertionOrderUpdate to an JSON string
   *
   * @return JSON string
   */
