...
public class TimeSeries {
  ...
  public TimeSeries date(@javax.annotation.Nullable LocalDate date) {
    this.date = date;
    return this;
  }
   ...
   * @return the TimeSeries instance itself
   */
  public TimeSeries putAdditionalProperty(String key, Object value) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TimeSeries.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in TimeSeries is not found in the empty JSON string", TimeSeries.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TimeSeries>() {
           ...
           public TimeSeries read(JsonReader in) throws IOException {
             ...
             TimeSeries instance = thisAdapter.fromJsonTree(jsonObj);
