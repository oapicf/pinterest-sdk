...
public class CatalogsCreativeAssetsItemsFilter {
   ...
   * @throws IOException if the JSON Element is invalid with respect to CatalogsCreativeAssetsItemsFilter
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CatalogsCreativeAssetsItemsFilter.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CatalogsCreativeAssetsItemsFilter is not found in the empty JSON string", CatalogsCreativeAssetsItemsFilter.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CatalogsCreativeAssetsItemsFilter.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CatalogsCreativeAssetsItemsFilter` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CatalogsCreativeAssetsItemsFilter.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CatalogsCreativeAssetsItemsFilter.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CatalogsCreativeAssetsItemsFilter' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CatalogsCreativeAssetsItemsFilter> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CatalogsCreativeAssetsItemsFilter.class));

       return (TypeAdapter<T>) new TypeAdapter<CatalogsCreativeAssetsItemsFilter>() {
           @Override
           public void write(JsonWriter out, CatalogsCreativeAssetsItemsFilter value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CatalogsCreativeAssetsItemsFilter read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CatalogsCreativeAssetsItemsFilter given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CatalogsCreativeAssetsItemsFilter
   * @throws IOException if the JSON string is invalid with respect to CatalogsCreativeAssetsItemsFilter
   */
  public static CatalogsCreativeAssetsItemsFilter fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CatalogsCreativeAssetsItemsFilter.class);
  }

  /**
   * Convert an instance of CatalogsCreativeAssetsItemsFilter to an JSON string
   *
   * @return JSON string
   */
