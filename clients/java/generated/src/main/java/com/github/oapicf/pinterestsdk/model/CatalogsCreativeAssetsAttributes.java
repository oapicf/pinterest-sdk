...
public class CatalogsCreativeAssetsAttributes {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("android_deep_link", "custom_label_0", "custom_label_1", "custom_label_2", "custom_label_3", "custom_label_4", "description", "google_product_category", "ios_deep_link", "link", "title", "visibility", "image_link", "video_link"));
