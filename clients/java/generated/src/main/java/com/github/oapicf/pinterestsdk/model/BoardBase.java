...
public class BoardBase {
  ...
  public BoardBase description(@javax.annotation.Nullable String description) {
  ...
  public BoardBase isAdsOnly(@javax.annotation.Nullable Boolean isAdsOnly) {
  ...
  public BoardBase name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("board_pins_modified_at", "collaborator_count", "created_at", "description", "follower_count", "id", "is_ads_only", "media", "name", "owner", "pin_count"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to BoardBase
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BoardBase.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in BoardBase is not found in the empty JSON string", BoardBase.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BoardBase.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `BoardBase` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : BoardBase.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BoardBase.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BoardBase' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BoardBase> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BoardBase.class));

       return (TypeAdapter<T>) new TypeAdapter<BoardBase>() {
           @Override
           public void write(JsonWriter out, BoardBase value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BoardBase read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BoardBase given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BoardBase
   * @throws IOException if the JSON string is invalid with respect to BoardBase
   */
  public static BoardBase fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BoardBase.class);
  }

  /**
   * Convert an instance of BoardBase to an JSON string
   *
   * @return JSON string
   */
