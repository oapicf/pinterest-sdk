...
import com.github.oapicf.pinterestsdk.model.MetricsResponseDataItems;
...
public class MetricsResponse {
  ...
  public MetricsResponse data(@javax.annotation.Nullable List<MetricsResponseDataItems> data) {
    this.data = data;
    return this;
  }
  ...
  public void setData(@javax.annotation.Nullable List<MetricsResponseDataItems> data) {
    this.data = data;
  }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            MetricsResponseDataItems.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
