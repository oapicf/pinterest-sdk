...
public class FeedsCreateRequest extends AbstractOpenApiSchema {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>) new TypeAdapter<FeedsCreateRequest>() {
                ...
                public FeedsCreateRequest read(JsonReader in) throws IOException {
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for FeedsCreateRequest: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for FeedsCreateRequest with oneOf schemas: CatalogsFeedsCreateRequest, CatalogsVerticalFeedsCreateRequest. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }
