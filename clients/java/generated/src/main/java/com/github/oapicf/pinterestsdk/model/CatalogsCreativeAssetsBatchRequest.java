...
public class CatalogsCreativeAssetsBatchRequest {
  ...
  public CatalogsCreativeAssetsBatchRequest language(@javax.annotation.Nonnull LanguageEnum language) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CatalogsCreativeAssetsBatchRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CatalogsCreativeAssetsBatchRequest is not found in the empty JSON string", CatalogsCreativeAssetsBatchRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CatalogsCreativeAssetsBatchRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CatalogsCreativeAssetsBatchRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
