...
public class IntegrationMetadataUpdate {
  ...
  public IntegrationMetadataUpdate additionalId1(@javax.annotation.Nullable String additionalId1) {
  ...
  public IntegrationMetadataUpdate connectedAdvertiserId(@javax.annotation.Nullable String connectedAdvertiserId) {
  ...
  public IntegrationMetadataUpdate connectedLbaId(@javax.annotation.Nullable String connectedLbaId) {
  ...
  public IntegrationMetadataUpdate connectedMerchantId(@javax.annotation.Nullable String connectedMerchantId) {
  ...
  public IntegrationMetadataUpdate connectedTagId(@javax.annotation.Nullable String connectedTagId) {
  ...
  public IntegrationMetadataUpdate partnerAccessToken(@javax.annotation.Nullable String partnerAccessToken) {
  ...
  public IntegrationMetadataUpdate partnerAccessTokenExpiry(@javax.annotation.Nullable BigDecimal partnerAccessTokenExpiry) {
  ...
  public IntegrationMetadataUpdate partnerMetadata(@javax.annotation.Nullable String partnerMetadata) {
  ...
  public IntegrationMetadataUpdate partnerPrimaryEmail(@javax.annotation.Nullable String partnerPrimaryEmail) {
  ...
  public IntegrationMetadataUpdate partnerRefreshToken(@javax.annotation.Nullable String partnerRefreshToken) {
  ...
  public IntegrationMetadataUpdate partnerRefreshTokenExpiry(@javax.annotation.Nullable BigDecimal partnerRefreshTokenExpiry) {
  ...
  public IntegrationMetadataUpdate scopes(@javax.annotation.Nullable String scopes) {
    this.scopes = scopes;
    return this;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to IntegrationMetadataUpdate
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IntegrationMetadataUpdate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in IntegrationMetadataUpdate is not found in the empty JSON string", IntegrationMetadataUpdate.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IntegrationMetadataUpdate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `IntegrationMetadataUpdate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IntegrationMetadataUpdate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IntegrationMetadataUpdate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IntegrationMetadataUpdate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IntegrationMetadataUpdate.class));

       return (TypeAdapter<T>) new TypeAdapter<IntegrationMetadataUpdate>() {
           @Override
           public void write(JsonWriter out, IntegrationMetadataUpdate value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IntegrationMetadataUpdate read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IntegrationMetadataUpdate given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IntegrationMetadataUpdate
   * @throws IOException if the JSON string is invalid with respect to IntegrationMetadataUpdate
   */
  public static IntegrationMetadataUpdate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IntegrationMetadataUpdate.class);
  }

  /**
   * Convert an instance of IntegrationMetadataUpdate to an JSON string
   *
   * @return JSON string
   */
