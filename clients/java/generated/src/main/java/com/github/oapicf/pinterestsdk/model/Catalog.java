...
public class Catalog {
  ...
  public Catalog createdAt(@javax.annotation.Nonnull OffsetDateTime createdAt) {
  ...
  public Catalog id(@javax.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public Catalog updatedAt(@javax.annotation.Nonnull OffsetDateTime updatedAt) {
  ...
  public Catalog catalogType(@javax.annotation.Nonnull CatalogsType catalogType) {
  ...
  public Catalog name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("created_at", "id", "updated_at", "catalog_type", "name"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("created_at", "id", "updated_at", "catalog_type", "name"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Catalog.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in Catalog is not found in the empty JSON string", Catalog.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Catalog.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Catalog` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
