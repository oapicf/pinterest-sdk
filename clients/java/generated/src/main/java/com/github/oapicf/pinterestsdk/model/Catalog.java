...
public class Catalog {
  ...
  public Catalog name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("catalog_type", "created_at", "id", "name", "updated_at"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("catalog_type", "created_at", "id", "name", "updated_at"));
  }
