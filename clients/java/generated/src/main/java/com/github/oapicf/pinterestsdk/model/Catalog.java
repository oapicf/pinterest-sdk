...
public class Catalog {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("created_at", "id", "updated_at", "name", "catalog_type"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("created_at", "id", "updated_at", "name", "catalog_type"));
  }
