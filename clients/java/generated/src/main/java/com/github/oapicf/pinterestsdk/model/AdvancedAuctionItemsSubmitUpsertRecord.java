...
public class AdvancedAuctionItemsSubmitUpsertRecord {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("country", "item_id", "language", "bid_options", "errors", "update_mask"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("country", "item_id", "language", "bid_options", "update_mask"));
  }
