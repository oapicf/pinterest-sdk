...
import com.github.oapicf.pinterestsdk.model.AuthRespondInvitesBodyItem;
...
public class AuthRespondInvitesBody {
  ...
  public AuthRespondInvitesBody invites(@javax.annotation.Nonnull List<AuthRespondInvitesBodyItem> invites) {
  ...
  public void setInvites(@javax.annotation.Nonnull List<AuthRespondInvitesBodyItem> invites) {
    this.invites = invites;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("invites") != null) {
        ...
        for (int i = 0; i < jsonArrayinvites.size(); i++) {
          AuthRespondInvitesBodyItem.validateJsonElement(jsonArrayinvites.get(i));
        }
      }
  }
