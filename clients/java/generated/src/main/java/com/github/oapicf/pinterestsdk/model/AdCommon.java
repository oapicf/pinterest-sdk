...
public class AdCommon {
  ...
  public AdCommon customizableCtaType(@javax.annotation.Nullable CustomizableCTAType customizableCtaType) {
  ...
  public AdCommon disclosureType(@javax.annotation.Nullable DisclosureType disclosureType) {
  ...
  public AdCommon disclosureUrl(@javax.annotation.Nullable String disclosureUrl) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AdCommon.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AdCommon is not found in the empty JSON string", AdCommon.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AdCommon.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AdCommon` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
