...
import com.github.oapicf.pinterestsdk.model.MediaUploadParameters;
...
public class MediaUpload {
  ...
  public MediaUpload mediaType(@javax.annotation.Nonnull MediaUploadType mediaType) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("media_id", "media_type", "upload_parameters", "upload_url"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (String requiredField : MediaUpload.openapiRequiredFields) {
      ...
      if (jsonObj.get("upload_parameters") != null && !jsonObj.get("upload_parameters").isJsonNull()) {
        MediaUploadParameters.validateJsonElement(jsonObj.get("upload_parameters"));
      }
