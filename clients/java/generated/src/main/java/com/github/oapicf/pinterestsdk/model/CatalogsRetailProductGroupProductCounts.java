...
public class CatalogsRetailProductGroupProductCounts {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("catalog_type", "in_stock", "out_of_stock", "preorder", "total", "videos"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("catalog_type", "in_stock", "out_of_stock", "preorder", "total"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CatalogsRetailProductGroupProductCounts.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CatalogsRetailProductGroupProductCounts is not found in the empty JSON string", CatalogsRetailProductGroupProductCounts.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CatalogsRetailProductGroupProductCounts.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CatalogsRetailProductGroupProductCounts` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
