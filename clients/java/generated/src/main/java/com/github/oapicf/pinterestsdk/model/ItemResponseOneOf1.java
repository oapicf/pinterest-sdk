...
public class ItemResponseOneOf1 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ItemResponseOneOf1.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ItemResponseOneOf1.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ItemResponseOneOf1' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ItemResponseOneOf1>() {
                @Override
                public void write(JsonWriter out, ItemResponseOneOf1 value) throws IOException {
                ...
                @Override
                public ItemResponseOneOf1 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ItemResponseOneOf1 ret = new ItemResponseOneOf1();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for ItemResponseOneOf1: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ItemResponseOneOf1(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return ItemResponseOneOf1.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to ItemResponseOneOf1
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for ItemResponseOneOf1 with oneOf schemas: CatalogsCreativeAssetsItemErrorResponse, CatalogsHotelItemErrorResponse, CatalogsRetailItemErrorResponse. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of ItemResponseOneOf1 given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of ItemResponseOneOf1
     * @throws IOException if the JSON string is invalid with respect to ItemResponseOneOf1
     */
    public static ItemResponseOneOf1 fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, ItemResponseOneOf1.class);
    }

    /**
     * Convert an instance of ItemResponseOneOf1 to an JSON string
     *
     * @return JSON string
     */
