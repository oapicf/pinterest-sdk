...
public class AdsCreditDiscountsResponse {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("active", "advertiser_id", "discountType", "discountInMicroCurrency", "discountCurrency", "title", "remainingDiscountInMicroCurrency"));
