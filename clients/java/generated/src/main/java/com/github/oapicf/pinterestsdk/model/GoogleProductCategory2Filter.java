...
public class GoogleProductCategory2Filter {
  ...
  public GoogleProductCategory2Filter GOOGLE_PRODUCT_CATEGORY_2(@javax.annotation.Nonnull CatalogsProductGroupMultipleStringListCriteria GOOGLE_PRODUCT_CATEGORY_2) {
  ...
  public void setGOOGLEPRODUCTCATEGORY2(@javax.annotation.Nonnull CatalogsProductGroupMultipleStringListCriteria GOOGLE_PRODUCT_CATEGORY_2) {
    this.GOOGLE_PRODUCT_CATEGORY_2 = GOOGLE_PRODUCT_CATEGORY_2;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("GOOGLE_PRODUCT_CATEGORY_2"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("GOOGLE_PRODUCT_CATEGORY_2"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleProductCategory2Filter.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GoogleProductCategory2Filter is not found in the empty JSON string", GoogleProductCategory2Filter.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleProductCategory2Filter.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GoogleProductCategory2Filter` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      // validate the required field `GOOGLE_PRODUCT_CATEGORY_2`
      CatalogsProductGroupMultipleStringListCriteria.validateJsonElement(jsonObj.get("GOOGLE_PRODUCT_CATEGORY_2"));
  }
