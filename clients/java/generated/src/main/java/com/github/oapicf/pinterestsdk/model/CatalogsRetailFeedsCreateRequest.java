...
public class CatalogsRetailFeedsCreateRequest {
  ...
  public CatalogsRetailFeedsCreateRequest catalogId(@javax.annotation.Nullable String catalogId) {
  ...
  public CatalogsRetailFeedsCreateRequest catalogType(@javax.annotation.Nonnull CatalogTypeEnum catalogType) {
  ...
  public CatalogsRetailFeedsCreateRequest credentials(@javax.annotation.Nullable CatalogsFeedCredentials credentials) {
  ...
  public CatalogsRetailFeedsCreateRequest defaultAvailability(@javax.annotation.Nullable ProductAvailabilityType defaultAvailability) {
  ...
  public CatalogsRetailFeedsCreateRequest defaultCountry(@javax.annotation.Nonnull Country defaultCountry) {
  ...
  public CatalogsRetailFeedsCreateRequest defaultCurrency(@javax.annotation.Nullable NullableCurrency defaultCurrency) {
  ...
  public CatalogsRetailFeedsCreateRequest defaultLocale(@javax.annotation.Nonnull CatalogsCreativeAssetsFeedsCreateRequestDefaultLocale defaultLocale) {
  ...
  public CatalogsRetailFeedsCreateRequest format(@javax.annotation.Nonnull CatalogsFormat format) {
    this.format = format;
    return this;
  }
  ...
  public CatalogsRetailFeedsCreateRequest location(@javax.annotation.Nonnull String location) {
  ...
  public CatalogsRetailFeedsCreateRequest name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public CatalogsRetailFeedsCreateRequest preferredProcessingSchedule(@javax.annotation.Nullable CatalogsFeedProcessingSchedule preferredProcessingSchedule) {
  ...
  public CatalogsRetailFeedsCreateRequest status(@javax.annotation.Nullable CatalogsStatus status) {
    this.status = status;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("catalog_id", "catalog_type", "credentials", "default_availability", "default_country", "default_currency", "default_locale", "format", "location", "name", "preferred_processing_schedule", "status"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CatalogsRetailFeedsCreateRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CatalogsRetailFeedsCreateRequest is not found in the empty JSON string", CatalogsRetailFeedsCreateRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CatalogsRetailFeedsCreateRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CatalogsRetailFeedsCreateRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
