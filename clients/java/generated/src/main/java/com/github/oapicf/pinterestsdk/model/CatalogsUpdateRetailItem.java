...
public class CatalogsUpdateRetailItem {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("attributes", "item_id", "operation", "update_mask"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("attributes", "item_id", "operation"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CatalogsUpdateRetailItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CatalogsUpdateRetailItem is not found in the empty JSON string", CatalogsUpdateRetailItem.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CatalogsUpdateRetailItem.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CatalogsUpdateRetailItem` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
