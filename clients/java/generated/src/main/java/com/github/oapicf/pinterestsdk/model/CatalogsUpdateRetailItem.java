...
public class CatalogsUpdateRetailItem {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("item_id", "operation", "attributes", "update_mask"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("item_id", "operation", "attributes"));
  }
