...
public class ItemDeleteDiscontinuedBatchRecord {
  ...
  public ItemDeleteDiscontinuedBatchRecord itemId(@javax.annotation.Nullable String itemId) {
    this.itemId = itemId;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ItemDeleteDiscontinuedBatchRecord.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ItemDeleteDiscontinuedBatchRecord is not found in the empty JSON string", ItemDeleteDiscontinuedBatchRecord.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ItemDeleteDiscontinuedBatchRecord.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ItemDeleteDiscontinuedBatchRecord` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
