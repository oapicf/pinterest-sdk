...
public class PriceFilter {
  ...
  public PriceFilter PRICE(@javax.annotation.Nonnull PriceFilterPrice PRICE) {
    this.PRICE = PRICE;
    return this;
  }
  ...
  public void setPRICE(@javax.annotation.Nonnull PriceFilterPrice PRICE) {
    this.PRICE = PRICE;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("PRICE"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("PRICE"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PriceFilter.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in PriceFilter is not found in the empty JSON string", PriceFilter.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PriceFilter.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `PriceFilter` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      PriceFilterPrice.validateJsonElement(jsonObj.get("PRICE"));
  }
