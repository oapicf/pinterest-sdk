...
public class UserAccountApi {
     ...
     */
    public okhttp3.Call verifyWebsiteUpdateCall(UserWebsiteVerifyRequest userWebsiteVerifyRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call verifyWebsiteUpdateValidateBeforeCall(UserWebsiteVerifyRequest userWebsiteVerifyRequest, final ApiCallback _callback) throws ApiException {
        ...
        return verifyWebsiteUpdateCall(userWebsiteVerifyRequest, _callback);
     ...
     */
    public UserWebsiteSummary verifyWebsiteUpdate(UserWebsiteVerifyRequest userWebsiteVerifyRequest) throws ApiException {
        ApiResponse<UserWebsiteSummary> localVarResp = verifyWebsiteUpdateWithHttpInfo(userWebsiteVerifyRequest);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<UserWebsiteSummary> verifyWebsiteUpdateWithHttpInfo(UserWebsiteVerifyRequest userWebsiteVerifyRequest) throws ApiException {
        okhttp3.Call localVarCall = verifyWebsiteUpdateValidateBeforeCall(userWebsiteVerifyRequest, null);
     ...
     */
    public okhttp3.Call verifyWebsiteUpdateAsync(UserWebsiteVerifyRequest userWebsiteVerifyRequest, final ApiCallback<UserWebsiteSummary> _callback) throws ApiException {

        okhttp3.Call localVarCall = verifyWebsiteUpdateValidateBeforeCall(userWebsiteVerifyRequest, _callback);
        Type localVarReturnType = new TypeToken<UserWebsiteSummary>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call websiteVerificationGetCall(final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call websiteVerificationGetValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        return websiteVerificationGetCall(_callback);
     ...
     */
    public UserWebsiteVerificationCode websiteVerificationGet() throws ApiException {
        ApiResponse<UserWebsiteVerificationCode> localVarResp = websiteVerificationGetWithHttpInfo();
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<UserWebsiteVerificationCode> websiteVerificationGetWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = websiteVerificationGetValidateBeforeCall(null);
     ...
     */
    public okhttp3.Call websiteVerificationGetAsync(final ApiCallback<UserWebsiteVerificationCode> _callback) throws ApiException {

        okhttp3.Call localVarCall = websiteVerificationGetValidateBeforeCall(_callback);
        Type localVarReturnType = new TypeToken<UserWebsiteVerificationCode>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
