...
public class CatalogsFeedProcessingResult {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("created_at", "id", "ingestion_details", "product_counts", "status", "updated_at", "validation_details", "video_counts"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("created_at", "id", "ingestion_details", "product_counts", "status", "updated_at", "validation_details"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("product_counts") != null && !jsonObj.get("product_counts").isJsonNull()) {
