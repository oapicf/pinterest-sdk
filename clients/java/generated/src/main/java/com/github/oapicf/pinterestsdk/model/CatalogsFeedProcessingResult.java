...
import com.github.oapicf.pinterestsdk.model.CatalogsFeedVideoCounts;
...
public class CatalogsFeedProcessingResult {
  ...
  public static final String SERIALIZED_NAME_VIDEO_COUNTS = "video_counts";
  @SerializedName(SERIALIZED_NAME_VIDEO_COUNTS)
  @javax.annotation.Nullable
  ...
  public CatalogsFeedProcessingResult videoCounts(@javax.annotation.Nullable CatalogsFeedVideoCounts videoCounts) {
  ...
  public void setVideoCounts(@javax.annotation.Nullable CatalogsFeedVideoCounts videoCounts) {
    this.videoCounts = videoCounts;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("created_at", "id", "updated_at", "ingestion_details", "product_counts", "status", "validation_details", "video_counts"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("created_at", "id", "updated_at", "ingestion_details", "product_counts", "status", "validation_details"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("video_counts") != null && !jsonObj.get("video_counts").isJsonNull()) {
        CatalogsFeedVideoCounts.validateJsonElement(jsonObj.get("video_counts"));
      }
  }
