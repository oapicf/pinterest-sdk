...
public class CatalogsUpdatableCreativeAssetsAttributes {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("android_deep_link", "custom_label_0", "custom_label_1", "custom_label_2", "custom_label_3", "custom_label_4", "description", "google_product_category", "ios_deep_link", "link", "title", "visibility"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to CatalogsUpdatableCreativeAssetsAttributes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CatalogsUpdatableCreativeAssetsAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CatalogsUpdatableCreativeAssetsAttributes is not found in the empty JSON string", CatalogsUpdatableCreativeAssetsAttributes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CatalogsUpdatableCreativeAssetsAttributes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CatalogsUpdatableCreativeAssetsAttributes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CatalogsUpdatableCreativeAssetsAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CatalogsUpdatableCreativeAssetsAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CatalogsUpdatableCreativeAssetsAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CatalogsUpdatableCreativeAssetsAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<CatalogsUpdatableCreativeAssetsAttributes>() {
           @Override
           public void write(JsonWriter out, CatalogsUpdatableCreativeAssetsAttributes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CatalogsUpdatableCreativeAssetsAttributes read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CatalogsUpdatableCreativeAssetsAttributes given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CatalogsUpdatableCreativeAssetsAttributes
   * @throws IOException if the JSON string is invalid with respect to CatalogsUpdatableCreativeAssetsAttributes
   */
  public static CatalogsUpdatableCreativeAssetsAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CatalogsUpdatableCreativeAssetsAttributes.class);
  }

  /**
   * Convert an instance of CatalogsUpdatableCreativeAssetsAttributes to an JSON string
   *
   * @return JSON string
   */
