...
public class TargetingTemplateGetResponseData {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("auto_targeting_enabled", "keywords", "name", "placement_group", "targeting_attributes", "tracking_urls", "ad_account_id", "created_time", "id", "sizing", "status", "updated_time", "valid"));
