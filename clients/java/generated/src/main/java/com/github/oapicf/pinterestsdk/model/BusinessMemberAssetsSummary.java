...
import com.github.oapicf.pinterestsdk.model.BusinessMemberAssetsSummaryAdAccountsInner;
import com.github.oapicf.pinterestsdk.model.BusinessMemberAssetsSummaryProfilesInner;
...
public class BusinessMemberAssetsSummary {
  ...
  public BusinessMemberAssetsSummary adAccounts(@javax.annotation.Nullable List<BusinessMemberAssetsSummaryAdAccountsInner> adAccounts) {
  ...
  public void setAdAccounts(@javax.annotation.Nullable List<BusinessMemberAssetsSummaryAdAccountsInner> adAccounts) {
    this.adAccounts = adAccounts;
  }


  public BusinessMemberAssetsSummary profiles(@javax.annotation.Nullable List<BusinessMemberAssetsSummaryProfilesInner> profiles) {
  ...
  public void setProfiles(@javax.annotation.Nullable List<BusinessMemberAssetsSummaryProfilesInner> profiles) {
    this.profiles = profiles;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to BusinessMemberAssetsSummary
   */
      ...
      if (jsonObj.get("ad_accounts") != null && !jsonObj.get("ad_accounts").isJsonNull()) {
        ...
        if (jsonArrayadAccounts != null) {
          ...
          for (int i = 0; i < jsonArrayadAccounts.size(); i++) {
            BusinessMemberAssetsSummaryAdAccountsInner.validateJsonElement(jsonArrayadAccounts.get(i));
          };
        }
      }
      if (jsonObj.get("profiles") != null && !jsonObj.get("profiles").isJsonNull()) {
        ...
        if (jsonArrayprofiles != null) {
          ...
          for (int i = 0; i < jsonArrayprofiles.size(); i++) {
            BusinessMemberAssetsSummaryProfilesInner.validateJsonElement(jsonArrayprofiles.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BusinessMemberAssetsSummary.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BusinessMemberAssetsSummary' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BusinessMemberAssetsSummary> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BusinessMemberAssetsSummary.class));

       return (TypeAdapter<T>) new TypeAdapter<BusinessMemberAssetsSummary>() {
           @Override
           public void write(JsonWriter out, BusinessMemberAssetsSummary value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BusinessMemberAssetsSummary read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BusinessMemberAssetsSummary given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BusinessMemberAssetsSummary
   * @throws IOException if the JSON string is invalid with respect to BusinessMemberAssetsSummary
   */
  public static BusinessMemberAssetsSummary fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BusinessMemberAssetsSummary.class);
  }

  /**
   * Convert an instance of BusinessMemberAssetsSummary to an JSON string
   *
   * @return JSON string
   */
