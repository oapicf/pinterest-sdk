...
import com.github.oapicf.pinterestsdk.model.AssetIdWithPermissions;
...
public class BusinessMemberAssetsSummary {
  ...
  public BusinessMemberAssetsSummary adAccounts(@javax.annotation.Nullable List<AssetIdWithPermissions> adAccounts) {
  ...
  public void setAdAccounts(@javax.annotation.Nullable List<AssetIdWithPermissions> adAccounts) {
    this.adAccounts = adAccounts;
  }


  public BusinessMemberAssetsSummary profiles(@javax.annotation.Nullable List<AssetIdWithPermissions> profiles) {
  ...
  public void setProfiles(@javax.annotation.Nullable List<AssetIdWithPermissions> profiles) {
    this.profiles = profiles;
  }
      ...
      if (jsonObj.get("ad_accounts") != null && !jsonObj.get("ad_accounts").isJsonNull()) {
        ...
        if (jsonArrayadAccounts != null) {
          ...
          for (int i = 0; i < jsonArrayadAccounts.size(); i++) {
            AssetIdWithPermissions.validateJsonElement(jsonArrayadAccounts.get(i));
          };
        }
      }
      if (jsonObj.get("profiles") != null && !jsonObj.get("profiles").isJsonNull()) {
        ...
        if (jsonArrayprofiles != null) {
          ...
          for (int i = 0; i < jsonArrayprofiles.size(); i++) {
            AssetIdWithPermissions.validateJsonElement(jsonArrayprofiles.get(i));
          };
        }
      }
  }
