...
import com.github.oapicf.pinterestsdk.model.CancelInvitesRequest;
import com.github.oapicf.pinterestsdk.model.CancelInvitesResponse;
...
import com.github.oapicf.pinterestsdk.model.InviteFilterStatus;
...
public class BusinessAccessInviteApi {
     ...
     */
    public okhttp3.Call cancelInvitesOrRequestsCall(@javax.annotation.Nonnull String businessId, @javax.annotation.Nonnull CancelInvitesRequest cancelInvitesRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = cancelInvitesRequest;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call cancelInvitesOrRequestsValidateBeforeCall(@javax.annotation.Nonnull String businessId, @javax.annotation.Nonnull CancelInvitesRequest cancelInvitesRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'businessId' is set
        if (businessId == null) {
        ...
        if (cancelInvitesRequest == null) {
            throw new ApiException("Missing the required parameter 'cancelInvitesRequest' when calling cancelInvitesOrRequests(Async)");
        }

        return cancelInvitesOrRequestsCall(businessId, cancelInvitesRequest, _callback);
     ...
     */
    public CancelInvitesResponse cancelInvitesOrRequests(@javax.annotation.Nonnull String businessId, @javax.annotation.Nonnull CancelInvitesRequest cancelInvitesRequest) throws ApiException {
        ApiResponse<CancelInvitesResponse> localVarResp = cancelInvitesOrRequestsWithHttpInfo(businessId, cancelInvitesRequest);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<CancelInvitesResponse> cancelInvitesOrRequestsWithHttpInfo(@javax.annotation.Nonnull String businessId, @javax.annotation.Nonnull CancelInvitesRequest cancelInvitesRequest) throws ApiException {
        okhttp3.Call localVarCall = cancelInvitesOrRequestsValidateBeforeCall(businessId, cancelInvitesRequest, null);
        Type localVarReturnType = new TypeToken<CancelInvitesResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call cancelInvitesOrRequestsAsync(@javax.annotation.Nonnull String businessId, @javax.annotation.Nonnull CancelInvitesRequest cancelInvitesRequest, final ApiCallback<CancelInvitesResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = cancelInvitesOrRequestsValidateBeforeCall(businessId, cancelInvitesRequest, _callback);
        Type localVarReturnType = new TypeToken<CancelInvitesResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call getInvitesCall(@javax.annotation.Nonnull String businessId, @javax.annotation.Nullable Boolean isMember, @javax.annotation.Nullable List<InviteFilterStatus> inviteStatus, @javax.annotation.Nullable InviteType inviteType, @javax.annotation.Nullable String bookmark, @javax.annotation.Nullable Integer pageSize, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
     ...
     */
    public GetInvites200Response getInvites(@javax.annotation.Nonnull String businessId, @javax.annotation.Nullable Boolean isMember, @javax.annotation.Nullable List<InviteFilterStatus> inviteStatus, @javax.annotation.Nullable InviteType inviteType, @javax.annotation.Nullable String bookmark, @javax.annotation.Nullable Integer pageSize) throws ApiException {
     ...
     */
    public okhttp3.Call getInvitesAsync(@javax.annotation.Nonnull String businessId, @javax.annotation.Nullable Boolean isMember, @javax.annotation.Nullable List<InviteFilterStatus> inviteStatus, @javax.annotation.Nullable InviteType inviteType, @javax.annotation.Nullable String bookmark, @javax.annotation.Nullable Integer pageSize, final ApiCallback<GetInvites200Response> _callback) throws ApiException {
