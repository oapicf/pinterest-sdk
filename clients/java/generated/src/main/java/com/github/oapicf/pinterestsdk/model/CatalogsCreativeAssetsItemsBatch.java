...
public class CatalogsCreativeAssetsItemsBatch {
  ...
  public CatalogsCreativeAssetsItemsBatch batchId(@javax.annotation.Nullable String batchId) {
  ...
  public CatalogsCreativeAssetsItemsBatch catalogType(@javax.annotation.Nonnull CatalogTypeEnum catalogType) {
  ...
  public CatalogsCreativeAssetsItemsBatch completedTime(@javax.annotation.Nullable OffsetDateTime completedTime) {
  ...
  public CatalogsCreativeAssetsItemsBatch createdTime(@javax.annotation.Nullable OffsetDateTime createdTime) {
  ...
  public CatalogsCreativeAssetsItemsBatch items(@javax.annotation.Nullable List<CreativeAssetsProcessingRecord> items) {
    this.items = items;
    return this;
  }
  ...
  public void setItems(@javax.annotation.Nullable List<CreativeAssetsProcessingRecord> items) {
    this.items = items;
  }


  public CatalogsCreativeAssetsItemsBatch status(@javax.annotation.Nullable BatchOperationStatus status) {
    this.status = status;
    return this;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CatalogsCreativeAssetsItemsBatch
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
      ...
      if (jsonObj.get("items") != null && !jsonObj.get("items").isJsonNull()) {
        ...
        if (jsonArrayitems != null) {
          ...
          for (int i = 0; i < jsonArrayitems.size(); i++) {
            CreativeAssetsProcessingRecord.validateJsonElement(jsonArrayitems.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CatalogsCreativeAssetsItemsBatch.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CatalogsCreativeAssetsItemsBatch' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CatalogsCreativeAssetsItemsBatch> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CatalogsCreativeAssetsItemsBatch.class));

       return (TypeAdapter<T>) new TypeAdapter<CatalogsCreativeAssetsItemsBatch>() {
           @Override
           public void write(JsonWriter out, CatalogsCreativeAssetsItemsBatch value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CatalogsCreativeAssetsItemsBatch read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CatalogsCreativeAssetsItemsBatch given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CatalogsCreativeAssetsItemsBatch
   * @throws IOException if the JSON string is invalid with respect to CatalogsCreativeAssetsItemsBatch
   */
  public static CatalogsCreativeAssetsItemsBatch fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CatalogsCreativeAssetsItemsBatch.class);
  }

  /**
   * Convert an instance of CatalogsCreativeAssetsItemsBatch to an JSON string
   *
   * @return JSON string
   */
