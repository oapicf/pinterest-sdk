...
public class AudienceInsights {
  ...
  public AudienceInsights categories(@javax.annotation.Nullable List<AudienceCategory> categories) {
  ...
  public AudienceInsights date(@javax.annotation.Nullable String date) {
    this.date = date;
    return this;
  }
  ...
  public AudienceInsights demographics(@javax.annotation.Nullable AudienceDemographics demographics) {
  ...
  public AudienceInsights size(@javax.annotation.Nullable Integer size) {
    this.size = size;
    return this;
  }
  ...
  public AudienceInsights sizeIsUpperBound(@javax.annotation.Nullable Boolean sizeIsUpperBound) {
  ...
  public AudienceInsights type(@javax.annotation.Nullable AudienceInsightType type) {
    this.type = type;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("categories", "date", "demographics", "size", "size_is_upper_bound", "type"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to AudienceInsights
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AudienceInsights.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AudienceInsights is not found in the empty JSON string", AudienceInsights.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AudienceInsights.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AudienceInsights` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AudienceInsights.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AudienceInsights' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AudienceInsights> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AudienceInsights.class));

       return (TypeAdapter<T>) new TypeAdapter<AudienceInsights>() {
           @Override
           public void write(JsonWriter out, AudienceInsights value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AudienceInsights read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AudienceInsights given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AudienceInsights
   * @throws IOException if the JSON string is invalid with respect to AudienceInsights
   */
  public static AudienceInsights fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AudienceInsights.class);
  }

  /**
   * Convert an instance of AudienceInsights to an JSON string
   *
   * @return JSON string
   */
