...
public class Keyword {
  ...
  public Keyword id(@javax.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public Keyword matchType(@javax.annotation.Nullable MatchType matchType) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("archived", "bid", "id", "match_type", "parent_id", "parent_type", "type", "value"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("id", "match_type", "parent_id", "value"));
  }
