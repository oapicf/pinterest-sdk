...
public class CatalogsRetailListProductsByCatalogBasedFilterRequest {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("catalog_id", "catalog_type", "country", "filters", "locale"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("catalog_id", "catalog_type", "country", "filters", "locale"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CatalogsRetailListProductsByCatalogBasedFilterRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CatalogsRetailListProductsByCatalogBasedFilterRequest is not found in the empty JSON string", CatalogsRetailListProductsByCatalogBasedFilterRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CatalogsRetailListProductsByCatalogBasedFilterRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CatalogsRetailListProductsByCatalogBasedFilterRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
