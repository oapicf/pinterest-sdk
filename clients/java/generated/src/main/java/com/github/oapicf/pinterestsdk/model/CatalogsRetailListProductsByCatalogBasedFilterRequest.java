...
public class CatalogsRetailListProductsByCatalogBasedFilterRequest {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("catalog_type", "catalog_id", "filters", "country", "locale"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("catalog_type", "catalog_id", "filters", "country", "locale"));
  }
