...
public class IntegrationMetadata {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("id", "external_business_id", "connected_merchant_id", "connected_user_id", "connected_advertiser_id", "connected_lba_id", "connected_tag_id", "partner_access_token_expiry", "partner_refresh_token_expiry", "scopes", "created_timestamp", "updated_timestamp", "additional_id_1", "partner_metadata"));
