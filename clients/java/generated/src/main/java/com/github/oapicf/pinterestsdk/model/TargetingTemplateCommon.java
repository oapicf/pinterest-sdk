...
public class TargetingTemplateCommon {
  ...
  public TargetingTemplateCommon autoTargetingEnabled(@javax.annotation.Nullable Boolean autoTargetingEnabled) {
  ...
  public TargetingTemplateCommon keywords(@javax.annotation.Nullable List<TargetingTemplateKeyword> keywords) {
  ...
  public TargetingTemplateCommon name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public TargetingTemplateCommon placementGroup(@javax.annotation.Nullable PlacementGroupType placementGroup) {
  ...
  public TargetingTemplateCommon targetingAttributes(@javax.annotation.Nullable TargetingSpec targetingAttributes) {
  ...
  public TargetingTemplateCommon trackingUrls(@javax.annotation.Nullable TrackingUrls trackingUrls) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to TargetingTemplateCommon
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TargetingTemplateCommon.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TargetingTemplateCommon' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TargetingTemplateCommon> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TargetingTemplateCommon.class));

       return (TypeAdapter<T>) new TypeAdapter<TargetingTemplateCommon>() {
           @Override
           public void write(JsonWriter out, TargetingTemplateCommon value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TargetingTemplateCommon read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TargetingTemplateCommon given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TargetingTemplateCommon
   * @throws IOException if the JSON string is invalid with respect to TargetingTemplateCommon
   */
  public static TargetingTemplateCommon fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TargetingTemplateCommon.class);
  }

  /**
   * Convert an instance of TargetingTemplateCommon to an JSON string
   *
   * @return JSON string
   */
