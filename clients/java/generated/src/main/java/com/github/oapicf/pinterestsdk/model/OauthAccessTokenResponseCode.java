...
public class OauthAccessTokenResponseCode {
  ...
  public OauthAccessTokenResponseCode refreshToken(@javax.annotation.Nullable String refreshToken) {
  ...
  public OauthAccessTokenResponseCode refreshTokenExpiresAt(@javax.annotation.Nullable Integer refreshTokenExpiresAt) {
  ...
  public void setRefreshTokenExpiresAt(@javax.annotation.Nullable Integer refreshTokenExpiresAt) {
    this.refreshTokenExpiresAt = refreshTokenExpiresAt;
  }


  public OauthAccessTokenResponseCode refreshTokenExpiresIn(@javax.annotation.Nullable Integer refreshTokenExpiresIn) {
  ...
  public void setRefreshTokenExpiresIn(@javax.annotation.Nullable Integer refreshTokenExpiresIn) {
    this.refreshTokenExpiresIn = refreshTokenExpiresIn;
  }


  public OauthAccessTokenResponseCode accessToken(@javax.annotation.Nonnull String accessToken) {
  ...
  public OauthAccessTokenResponseCode expiresIn(@javax.annotation.Nonnull Integer expiresIn) {
  ...
  public OauthAccessTokenResponseCode scope(@javax.annotation.Nonnull String scope) {
    this.scope = scope;
    return this;
  }
  ...
  public OauthAccessTokenResponseCode tokenType(@javax.annotation.Nonnull String tokenType) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("refresh_token", "refresh_token_expires_at", "refresh_token_expires_in", "access_token", "expires_in", "response_type", "scope", "token_type"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("access_token", "expires_in", "scope", "token_type"));
  }
