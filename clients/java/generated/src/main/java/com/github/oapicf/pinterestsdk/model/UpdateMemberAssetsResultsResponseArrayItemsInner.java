...
public class UpdateMemberAssetsResultsResponseArrayItemsInner {
  ...
  public UpdateMemberAssetsResultsResponseArrayItemsInner response(@javax.annotation.Nullable UsersForIndividualAssetResponse response) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateMemberAssetsResultsResponseArrayItemsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UpdateMemberAssetsResultsResponseArrayItemsInner is not found in the empty JSON string", UpdateMemberAssetsResultsResponseArrayItemsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateMemberAssetsResultsResponseArrayItemsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UpdateMemberAssetsResultsResponseArrayItemsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
