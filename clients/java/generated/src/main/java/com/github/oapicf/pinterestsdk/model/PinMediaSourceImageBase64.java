...
public class PinMediaSourceImageBase64 {
  ...
  public PinMediaSourceImageBase64 contentType(@javax.annotation.Nonnull ContentType contentType) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("content_type", "data", "is_standard", "source_type"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("content_type", "data", "source_type"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PinMediaSourceImageBase64
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PinMediaSourceImageBase64.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PinMediaSourceImageBase64' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PinMediaSourceImageBase64> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PinMediaSourceImageBase64.class));

       return (TypeAdapter<T>) new TypeAdapter<PinMediaSourceImageBase64>() {
           @Override
           public void write(JsonWriter out, PinMediaSourceImageBase64 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PinMediaSourceImageBase64 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PinMediaSourceImageBase64 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PinMediaSourceImageBase64
   * @throws IOException if the JSON string is invalid with respect to PinMediaSourceImageBase64
   */
  public static PinMediaSourceImageBase64 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PinMediaSourceImageBase64.class);
  }

  /**
   * Convert an instance of PinMediaSourceImageBase64 to an JSON string
   *
   * @return JSON string
   */
