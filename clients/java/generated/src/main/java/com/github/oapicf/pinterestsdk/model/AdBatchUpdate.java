...
public class AdBatchUpdate {
  ...
  public AdBatchUpdate adGroupId(@javax.annotation.Nullable String adGroupId) {
  ...
  public AdBatchUpdate androidDeepLink(@javax.annotation.Nullable String androidDeepLink) {
  ...
  public AdBatchUpdate carouselAndroidDeepLinks(@javax.annotation.Nullable List<String> carouselAndroidDeepLinks) {
  ...
  public AdBatchUpdate carouselDestinationUrls(@javax.annotation.Nullable List<String> carouselDestinationUrls) {
  ...
  public AdBatchUpdate carouselIosDeepLinks(@javax.annotation.Nullable List<String> carouselIosDeepLinks) {
  ...
  public AdBatchUpdate clickTrackingUrl(@javax.annotation.Nullable String clickTrackingUrl) {
  ...
  public AdBatchUpdate collectionItemsDestinationUrlTemplate(@javax.annotation.Nullable String collectionItemsDestinationUrlTemplate) {
  ...
  public AdBatchUpdate collectionsHeaderType(@javax.annotation.Nullable AdCollectionsHeaderType collectionsHeaderType) {
  ...
  public AdBatchUpdate creativeType(@javax.annotation.Nullable CreativeType creativeType) {
  ...
  public AdBatchUpdate customizableCtaType(@javax.annotation.Nullable CustomizableCTAType customizableCtaType) {
  ...
  public AdBatchUpdate destinationUrl(@javax.annotation.Nullable String destinationUrl) {
  ...
  public AdBatchUpdate disclosureType(@javax.annotation.Nullable DisclosureType disclosureType) {
  ...
  public AdBatchUpdate disclosureUrl(@javax.annotation.Nullable String disclosureUrl) {
  ...
  public AdBatchUpdate gridClickType(@javax.annotation.Nullable GridClickType gridClickType) {
  ...
  public AdBatchUpdate id(@javax.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public AdBatchUpdate iosDeepLink(@javax.annotation.Nullable String iosDeepLink) {
  ...
  public AdBatchUpdate isCarting(@javax.annotation.Nullable Boolean isCarting) {
  ...
  public AdBatchUpdate isCollageAcceptedTerms(@javax.annotation.Nullable Boolean isCollageAcceptedTerms) {
  ...
  public AdBatchUpdate isCollageSingleDestination(@javax.annotation.Nullable Boolean isCollageSingleDestination) {
  ...
  public AdBatchUpdate isPinDeleted(@javax.annotation.Nullable Boolean isPinDeleted) {
  ...
  public AdBatchUpdate isRemovable(@javax.annotation.Nullable Boolean isRemovable) {
  ...
  public AdBatchUpdate leadFormId(@javax.annotation.Nullable String leadFormId) {
  ...
  public AdBatchUpdate name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public AdBatchUpdate pinId(@javax.annotation.Nullable String pinId) {
    this.pinId = pinId;
    return this;
  }
  ...
  public AdBatchUpdate quizPinData(@javax.annotation.Nullable QuizPinData quizPinData) {
  ...
  public AdBatchUpdate status(@javax.annotation.Nullable EntityStatus status) {
    this.status = status;
    return this;
  }
  ...
  public AdBatchUpdate trackingUrls(@javax.annotation.Nullable TrackingUrls trackingUrls) {
  ...
  public AdBatchUpdate viewTrackingUrl(@javax.annotation.Nullable String viewTrackingUrl) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to AdBatchUpdate
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AdBatchUpdate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AdBatchUpdate is not found in the empty JSON string", AdBatchUpdate.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AdBatchUpdate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AdBatchUpdate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AdBatchUpdate.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AdBatchUpdate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AdBatchUpdate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AdBatchUpdate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AdBatchUpdate.class));

       return (TypeAdapter<T>) new TypeAdapter<AdBatchUpdate>() {
           @Override
           public void write(JsonWriter out, AdBatchUpdate value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AdBatchUpdate read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AdBatchUpdate given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AdBatchUpdate
   * @throws IOException if the JSON string is invalid with respect to AdBatchUpdate
   */
  public static AdBatchUpdate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AdBatchUpdate.class);
  }

  /**
   * Convert an instance of AdBatchUpdate to an JSON string
   *
   * @return JSON string
   */
