...
public class InviteExceptionResponse {
  ...
  public InviteExceptionResponse code(@javax.annotation.Nullable Integer code) {
    this.code = code;
    return this;
  }
  ...
  public InviteExceptionResponse inviteOrRequestId(@javax.annotation.Nullable String inviteOrRequestId) {
  ...
  public void setInviteOrRequestId(@javax.annotation.Nullable String inviteOrRequestId) {
    this.inviteOrRequestId = inviteOrRequestId;
  }


  public InviteExceptionResponse message(@javax.annotation.Nullable String message) {
  ...
  public InviteExceptionResponse usersOrPartnerIds(@javax.annotation.Nullable List<String> usersOrPartnerIds) {
  ...
  public void setUsersOrPartnerIds(@javax.annotation.Nullable List<String> usersOrPartnerIds) {
    this.usersOrPartnerIds = usersOrPartnerIds;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("code", "invite_or_request_id", "message", "users_or_partner_ids"));
