...
public class AdGroupArrayResponseElement {
  ...
  public AdGroupArrayResponseElement data(@javax.annotation.Nullable AdGroupResponse data) {
    this.data = data;
    return this;
  }
  ...
  public void setData(@javax.annotation.Nullable AdGroupResponse data) {
    this.data = data;
  }


  public AdGroupArrayResponseElement exceptions(@javax.annotation.Nullable List<Exception> exceptions) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AdGroupArrayResponseElement.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AdGroupArrayResponseElement is not found in the empty JSON string", AdGroupArrayResponseElement.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AdGroupArrayResponseElement.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AdGroupArrayResponseElement` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
