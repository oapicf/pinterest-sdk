...
import com.github.oapicf.pinterestsdk.model.IntegrationsLogsPost400Response;
...
public class IntegrationsApi {
     ...
     */
    public okhttp3.Call integrationsCommercePatchCall(@javax.annotation.Nonnull String externalBusinessId, @javax.annotation.Nonnull IntegrationRequestPatch integrationRequestPatch, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call integrationsCommercePatchValidateBeforeCall(@javax.annotation.Nonnull String externalBusinessId, @javax.annotation.Nonnull IntegrationRequestPatch integrationRequestPatch, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'externalBusinessId' is set
        if (externalBusinessId == null) {
        ...
        if (integrationRequestPatch == null) {
            throw new ApiException("Missing the required parameter 'integrationRequestPatch' when calling integrationsCommercePatch(Async)");
        }
     ...
     */
    public IntegrationMetadata integrationsCommercePatch(@javax.annotation.Nonnull String externalBusinessId, @javax.annotation.Nonnull IntegrationRequestPatch integrationRequestPatch) throws ApiException {
     ...
     */
    public ApiResponse<IntegrationMetadata> integrationsCommercePatchWithHttpInfo(@javax.annotation.Nonnull String externalBusinessId, @javax.annotation.Nonnull IntegrationRequestPatch integrationRequestPatch) throws ApiException {
     ...
     */
    public okhttp3.Call integrationsCommercePatchAsync(@javax.annotation.Nonnull String externalBusinessId, @javax.annotation.Nonnull IntegrationRequestPatch integrationRequestPatch, final ApiCallback<IntegrationMetadata> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call integrationsCommercePostCall(@javax.annotation.Nonnull IntegrationRequest integrationRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call integrationsCommercePostValidateBeforeCall(@javax.annotation.Nonnull IntegrationRequest integrationRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'integrationRequest' is set
        if (integrationRequest == null) {
            throw new ApiException("Missing the required parameter 'integrationRequest' when calling integrationsCommercePost(Async)");
        }
     ...
     */
    public IntegrationMetadata integrationsCommercePost(@javax.annotation.Nonnull IntegrationRequest integrationRequest) throws ApiException {
     ...
     */
    public ApiResponse<IntegrationMetadata> integrationsCommercePostWithHttpInfo(@javax.annotation.Nonnull IntegrationRequest integrationRequest) throws ApiException {
     ...
     */
    public okhttp3.Call integrationsCommercePostAsync(@javax.annotation.Nonnull IntegrationRequest integrationRequest, final ApiCallback<IntegrationMetadata> _callback) throws ApiException {
