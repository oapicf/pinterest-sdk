...
public class BidFloorSpec {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("countries", "currency", "objective_type", "billable_event", "optimization_goal_metadata", "creative_type"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("currency", "billable_event"));
  }
