...
import com.github.oapicf.pinterestsdk.model.BidFloorObjectiveType;
...
public class BidFloorSpec {
  ...
  public BidFloorSpec objectiveType(@javax.annotation.Nullable BidFloorObjectiveType objectiveType) {
  ...
  public void setObjectiveType(@javax.annotation.Nullable BidFloorObjectiveType objectiveType) {
    this.objectiveType = objectiveType;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("billable_event", "countries", "creative_type", "currency", "objective_type", "optimization_goal_metadata"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("billable_event", "currency"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BidFloorSpec.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in BidFloorSpec is not found in the empty JSON string", BidFloorSpec.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BidFloorSpec.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `BidFloorSpec` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("objective_type") != null && !jsonObj.get("objective_type").isJsonNull()) {
        BidFloorObjectiveType.validateJsonElement(jsonObj.get("objective_type"));
      }
