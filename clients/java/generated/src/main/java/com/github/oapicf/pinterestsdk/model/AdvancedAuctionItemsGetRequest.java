...
import com.github.oapicf.pinterestsdk.model.AdvancedAuctionKey;
...
public class AdvancedAuctionItemsGetRequest {
  ...
  public AdvancedAuctionItemsGetRequest catalogId(@javax.annotation.Nonnull String catalogId) {
  ...
  public AdvancedAuctionItemsGetRequest items(@javax.annotation.Nonnull List<AdvancedAuctionKey> items) {
    this.items = items;
    return this;
  }
  ...
  public void setItems(@javax.annotation.Nonnull List<AdvancedAuctionKey> items) {
    this.items = items;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AdvancedAuctionItemsGetRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AdvancedAuctionItemsGetRequest is not found in the empty JSON string", AdvancedAuctionItemsGetRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AdvancedAuctionItemsGetRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AdvancedAuctionItemsGetRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("items") != null) {
        ...
        for (int i = 0; i < jsonArrayitems.size(); i++) {
          AdvancedAuctionKey.validateJsonElement(jsonArrayitems.get(i));
        }
      }
  }
