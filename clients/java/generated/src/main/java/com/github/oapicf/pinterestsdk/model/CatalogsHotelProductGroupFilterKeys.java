...
import com.github.oapicf.pinterestsdk.model.PriceFilterPrice;
...
public class CatalogsHotelProductGroupFilterKeys extends AbstractOpenApiSchema {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>) new TypeAdapter<CatalogsHotelProductGroupFilterKeys>() {
                ...
                public void write(JsonWriter out, CatalogsHotelProductGroupFilterKeys value) throws IOException {
                    ...
                    throw new IOException("Failed to serialize as the type doesn't match anyOf schemas: BrandFilter, CountryFilter, CustomLabel0Filter, CustomLabel1Filter, CustomLabel2Filter, CustomLabel3Filter, CustomLabel4Filter, HotelIdFilter, PriceFilter, TitleKeywordsFilter");
                }
                ...
                public CatalogsHotelProductGroupFilterKeys read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        errorMessages.add(String.format(java.util.Locale.ROOT, "Deserialization for PriceFilter failed with `%s`.", e.getMessage()));
                    ...
                    try {
                        ...
                        // deserialization failed, continue
                        errorMessages.add(String.format(java.util.Locale.ROOT, "Deserialization for HotelIdFilter failed with `%s`.", e.getMessage()));
                    ...
                    try {
                        ...
                        // deserialization failed, continue
                        errorMessages.add(String.format(java.util.Locale.ROOT, "Deserialization for CountryFilter failed with `%s`.", e.getMessage()));
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for CatalogsHotelProductGroupFilterKeys: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
     ...
     * BrandFilter, CountryFilter, CustomLabel0Filter, CustomLabel1Filter, CustomLabel2Filter, CustomLabel3Filter, CustomLabel4Filter, HotelIdFilter, PriceFilter, TitleKeywordsFilter
     *
    ...
    public void setActualInstance(Object instance) {
        ...
        throw new RuntimeException("Invalid instance type. Must be BrandFilter, CountryFilter, CustomLabel0Filter, CustomLabel1Filter, CustomLabel2Filter, CustomLabel3Filter, CustomLabel4Filter, HotelIdFilter, PriceFilter, TitleKeywordsFilter");
    }
     ...
     * BrandFilter, CountryFilter, CustomLabel0Filter, CustomLabel1Filter, CustomLabel2Filter, CustomLabel3Filter, CustomLabel4Filter, HotelIdFilter, PriceFilter, TitleKeywordsFilter
     *
     * @return The actual instance (BrandFilter, CountryFilter, CustomLabel0Filter, CustomLabel1Filter, CustomLabel2Filter, CustomLabel3Filter, CustomLabel4Filter, HotelIdFilter, PriceFilter, TitleKeywordsFilter)
     */
    @SuppressWarnings("unchecked")
    @Override
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for CatalogsHotelProductGroupFilterKeys with anyOf schemas: BrandFilter, CountryFilter, CustomLabel0Filter, CustomLabel1Filter, CustomLabel2Filter, CustomLabel3Filter, CustomLabel4Filter, HotelIdFilter, PriceFilter, TitleKeywordsFilter. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }
