...
public class CatalogsHotelProductGroupFilterKeys extends AbstractOpenApiSchema {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>) new TypeAdapter<CatalogsHotelProductGroupFilterKeys>() {
                ...
                public void write(JsonWriter out, CatalogsHotelProductGroupFilterKeys value) throws IOException {
                    ...
                    throw new IOException("Failed to serialize as the type doesn't match anyOf schemae: BrandFilter, CountryFilter, CustomLabel0Filter, CustomLabel1Filter, CustomLabel2Filter, CustomLabel3Filter, CustomLabel4Filter, HotelIdFilter, PriceFilter");
                }
    ...
    public CatalogsHotelProductGroupFilterKeys(BrandFilter o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public CatalogsHotelProductGroupFilterKeys(CountryFilter o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public CatalogsHotelProductGroupFilterKeys(CustomLabel0Filter o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public CatalogsHotelProductGroupFilterKeys(CustomLabel1Filter o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public CatalogsHotelProductGroupFilterKeys(CustomLabel2Filter o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public CatalogsHotelProductGroupFilterKeys(CustomLabel3Filter o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public CatalogsHotelProductGroupFilterKeys(CustomLabel4Filter o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public CatalogsHotelProductGroupFilterKeys(HotelIdFilter o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public CatalogsHotelProductGroupFilterKeys(PriceFilter o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
