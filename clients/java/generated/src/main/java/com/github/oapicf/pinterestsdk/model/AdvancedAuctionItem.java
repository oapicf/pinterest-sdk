...
public class AdvancedAuctionItem {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("bid_options", "country", "item_id", "language"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("bid_options", "country", "item_id", "language"));
  }
