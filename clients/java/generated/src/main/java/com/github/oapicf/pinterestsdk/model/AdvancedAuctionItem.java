...
public class AdvancedAuctionItem {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("country", "item_id", "language", "bid_options"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("country", "item_id", "language", "bid_options"));
  }
