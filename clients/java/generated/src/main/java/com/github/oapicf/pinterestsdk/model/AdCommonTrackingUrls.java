...
public class AdCommonTrackingUrls {
  ...
  * @throws IOException if the JSON Element is invalid with respect to AdCommonTrackingUrls
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AdCommonTrackingUrls.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AdCommonTrackingUrls is not found in the empty JSON string", AdCommonTrackingUrls.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AdCommonTrackingUrls.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AdCommonTrackingUrls` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AdCommonTrackingUrls.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AdCommonTrackingUrls' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AdCommonTrackingUrls> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AdCommonTrackingUrls.class));

       return (TypeAdapter<T>) new TypeAdapter<AdCommonTrackingUrls>() {
           @Override
           public void write(JsonWriter out, AdCommonTrackingUrls value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AdCommonTrackingUrls read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of AdCommonTrackingUrls given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AdCommonTrackingUrls
  * @throws IOException if the JSON string is invalid with respect to AdCommonTrackingUrls
  */
  public static AdCommonTrackingUrls fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AdCommonTrackingUrls.class);
  }

 /**
  * Convert an instance of AdCommonTrackingUrls to an JSON string
  *
  * @return JSON string
  */
