...
public class AdAccountsCountryResponse {
  ...
  public AdAccountsCountryResponse items(@javax.annotation.Nullable List<AdAccountsCountryResponseData> items) {
    this.items = items;
    return this;
  }
  ...
  public void setItems(@javax.annotation.Nullable List<AdAccountsCountryResponseData> items) {
    this.items = items;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AdAccountsCountryResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AdAccountsCountryResponse is not found in the empty JSON string", AdAccountsCountryResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AdAccountsCountryResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AdAccountsCountryResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
