...
import com.github.oapicf.pinterestsdk.model.TopVideoPinsAnalyticsResponseDateAvailability;
import com.github.oapicf.pinterestsdk.model.TopVideoPinsAnalyticsResponsePinsItems;
...
public class TopVideoPinsAnalyticsResponse {
  ...
  public TopVideoPinsAnalyticsResponse dateAvailability(@javax.annotation.Nullable TopVideoPinsAnalyticsResponseDateAvailability dateAvailability) {
  ...
  public void setDateAvailability(@javax.annotation.Nullable TopVideoPinsAnalyticsResponseDateAvailability dateAvailability) {
    this.dateAvailability = dateAvailability;
  }


  public TopVideoPinsAnalyticsResponse pins(@javax.annotation.Nullable List<TopVideoPinsAnalyticsResponsePinsItems> pins) {
    this.pins = pins;
    return this;
  }
  ...
  public void setPins(@javax.annotation.Nullable List<TopVideoPinsAnalyticsResponsePinsItems> pins) {
    this.pins = pins;
  }


  public TopVideoPinsAnalyticsResponse sortBy(@javax.annotation.Nullable TopVideoPinsSortBy sortBy) {
    this.sortBy = sortBy;
    return this;
  }
  ...
  public void setSortBy(@javax.annotation.Nullable TopVideoPinsSortBy sortBy) {
    this.sortBy = sortBy;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TopVideoPinsAnalyticsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in TopVideoPinsAnalyticsResponse is not found in the empty JSON string", TopVideoPinsAnalyticsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TopVideoPinsAnalyticsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `TopVideoPinsAnalyticsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("date_availability") != null && !jsonObj.get("date_availability").isJsonNull()) {
        TopVideoPinsAnalyticsResponseDateAvailability.validateJsonElement(jsonObj.get("date_availability"));
      }
      if (jsonObj.get("pins") != null && !jsonObj.get("pins").isJsonNull()) {
        ...
        if (jsonArraypins != null) {
          ...
          for (int i = 0; i < jsonArraypins.size(); i++) {
            TopVideoPinsAnalyticsResponsePinsItems.validateJsonElement(jsonArraypins.get(i));
          };
        }
      }
      // validate the optional field `sort_by`
      if (jsonObj.get("sort_by") != null && !jsonObj.get("sort_by").isJsonNull()) {
        TopVideoPinsSortBy.validateJsonElement(jsonObj.get("sort_by"));
      }
  }
