...
public class AudienceCreateCustomRequest {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("ad_account_id", "name", "rule", "sharing_type", "data_party", "category"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("name", "rule", "sharing_type", "data_party"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AudienceCreateCustomRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AudienceCreateCustomRequest is not found in the empty JSON string", AudienceCreateCustomRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AudienceCreateCustomRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AudienceCreateCustomRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
