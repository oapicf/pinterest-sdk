...
import com.github.oapicf.pinterestsdk.model.AdCollectionsHeaderType;
import com.github.oapicf.pinterestsdk.model.AdDisapprovalReasons;
import com.github.oapicf.pinterestsdk.model.AdReviewStatus;
import com.github.oapicf.pinterestsdk.model.CartingProduct;
...
public class Ad {
  ...
  public static final String SERIALIZED_NAME_CARTING_PLATFORM_TYPE = "carting_platform_type";
  @SerializedName(SERIALIZED_NAME_CARTING_PLATFORM_TYPE)
  @javax.annotation.Nullable
  private Integer cartingPlatformType;

  public static final String SERIALIZED_NAME_CARTING_PRODUCTS = "carting_products";
  @SerializedName(SERIALIZED_NAME_CARTING_PRODUCTS)
  @javax.annotation.Nullable
  ...
  public static final String SERIALIZED_NAME_IS_COLLAGE_ACCEPTED_TERMS = "is_collage_accepted_terms";
  @SerializedName(SERIALIZED_NAME_IS_COLLAGE_ACCEPTED_TERMS)
  @javax.annotation.Nullable
  private Boolean isCollageAcceptedTerms;

  public static final String SERIALIZED_NAME_IS_COLLAGE_SINGLE_DESTINATION = "is_collage_single_destination";
  @SerializedName(SERIALIZED_NAME_IS_COLLAGE_SINGLE_DESTINATION)
  @javax.annotation.Nullable
  ...
  public Ad adGroupId(@javax.annotation.Nonnull String adGroupId) {
  ...
  public Ad androidDeepLink(@javax.annotation.Nullable String androidDeepLink) {
  ...
  public Ad carouselAndroidDeepLinks(@javax.annotation.Nullable List<String> carouselAndroidDeepLinks) {
  ...
  public Ad carouselDestinationUrls(@javax.annotation.Nullable List<String> carouselDestinationUrls) {
  ...
  public Ad carouselIosDeepLinks(@javax.annotation.Nullable List<String> carouselIosDeepLinks) {
  ...
  public Ad clickTrackingUrl(@javax.annotation.Nullable String clickTrackingUrl) {
  ...
  public Ad collectionItemsDestinationUrlTemplate(@javax.annotation.Nullable String collectionItemsDestinationUrlTemplate) {
  ...
  public Ad collectionsHeaderType(@javax.annotation.Nullable AdCollectionsHeaderType collectionsHeaderType) {
  ...
  public void setCollectionsHeaderType(@javax.annotation.Nullable AdCollectionsHeaderType collectionsHeaderType) {
    this.collectionsHeaderType = collectionsHeaderType;
  }
  ...
  public Ad creativeType(@javax.annotation.Nonnull CreativeType creativeType) {
  ...
  public Ad customizableCtaType(@javax.annotation.Nullable CustomizableCTAType customizableCtaType) {
  ...
  public Ad destinationUrl(@javax.annotation.Nullable String destinationUrl) {
  ...
  public Ad disclosureType(@javax.annotation.Nullable DisclosureType disclosureType) {
  ...
  public Ad disclosureUrl(@javax.annotation.Nullable String disclosureUrl) {
  ...
  public Ad gridClickType(@javax.annotation.Nullable GridClickType gridClickType) {
  ...
  public Ad id(@javax.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public Ad iosDeepLink(@javax.annotation.Nullable String iosDeepLink) {
  ...
  public Ad isCarting(@javax.annotation.Nullable Boolean isCarting) {
  ...
  public Ad isCollageAcceptedTerms(@javax.annotation.Nullable Boolean isCollageAcceptedTerms) {
  ...
  public void setIsCollageAcceptedTerms(@javax.annotation.Nullable Boolean isCollageAcceptedTerms) {
    this.isCollageAcceptedTerms = isCollageAcceptedTerms;
  }


  public Ad isCollageSingleDestination(@javax.annotation.Nullable Boolean isCollageSingleDestination) {
  ...
  public void setIsCollageSingleDestination(@javax.annotation.Nullable Boolean isCollageSingleDestination) {
    this.isCollageSingleDestination = isCollageSingleDestination;
  }


  public Ad isPinDeleted(@javax.annotation.Nullable Boolean isPinDeleted) {
  ...
  public Ad isRemovable(@javax.annotation.Nullable Boolean isRemovable) {
  ...
  public Ad leadFormId(@javax.annotation.Nullable String leadFormId) {
  ...
  public Ad pinId(@javax.annotation.Nonnull String pinId) {
    this.pinId = pinId;
    return this;
  }
  ...
  public Ad quizPinData(@javax.annotation.Nullable QuizPinData quizPinData) {
  ...
  public Ad status(@javax.annotation.Nullable EntityStatus status) {
    this.status = status;
    return this;
  }
  ...
  public Ad trackingUrls(@javax.annotation.Nullable TrackingUrls trackingUrls) {
  ...
  public Ad viewTrackingUrl(@javax.annotation.Nullable String viewTrackingUrl) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("ad_account_id", "ad_group_id", "android_deep_link", "campaign_id", "carousel_android_deep_links", "carousel_destination_urls", "carousel_ios_deep_links", "carting_platform_type", "carting_products", "click_tracking_url", "collection_items_destination_url_template", "collections_header_type", "created_time", "creative_type", "customizable_cta_type", "destination_url", "disclosure_type", "disclosure_url", "grid_click_type", "id", "ios_deep_link", "is_carting", "is_collage_accepted_terms", "is_collage_single_destination", "is_pin_deleted", "is_removable", "lead_form_id", "name", "pin_id", "quiz_pin_data", "rejected_reasons", "rejection_labels", "review_status", "status", "summary_status", "tracking_urls", "type", "updated_time", "view_tracking_url"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("ad_account_id", "ad_group_id", "campaign_id", "creative_type", "id", "pin_id", "rejected_reasons", "rejection_labels", "review_status", "summary_status", "type"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Ad.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in Ad is not found in the empty JSON string", Ad.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Ad.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Ad` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Ad.openapiRequiredFields) {
      ...
      if (jsonObj.get("carting_products") != null && !jsonObj.get("carting_products").isJsonNull()) {
        JsonArray jsonArraycartingProducts = jsonObj.getAsJsonArray("carting_products");
        if (jsonArraycartingProducts != null) {
          // ensure the json data is an array
          if (!jsonObj.get("carting_products").isJsonArray()) {
            throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `carting_products` to be an array in the JSON string but got `%s`", jsonObj.get("carting_products").toString()));
          }

          // validate the optional field `carting_products` (array)
          for (int i = 0; i < jsonArraycartingProducts.size(); i++) {
            CartingProduct.validateJsonElement(jsonArraycartingProducts.get(i));
          };
        }
      }
      ...
      if (jsonObj.get("collections_header_type") != null && !jsonObj.get("collections_header_type").isJsonNull()) {
        AdCollectionsHeaderType.validateJsonElement(jsonObj.get("collections_header_type"));
      }
      ...
      if (jsonObj.get("rejected_reasons") == null) {
        throw new IllegalArgumentException("Expected the field `linkedContent` to be an array in the JSON string but got `null`");
      } else if (!jsonObj.get("rejected_reasons").isJsonArray()) {
      ...
      // ensure the required json array is present
      if (jsonObj.get("rejection_labels") == null) {
        throw new IllegalArgumentException("Expected the field `linkedContent` to be an array in the JSON string but got `null`");
      } else if (!jsonObj.get("rejection_labels").isJsonArray()) {
      ...
      AdReviewStatus.validateJsonElement(jsonObj.get("review_status"));
