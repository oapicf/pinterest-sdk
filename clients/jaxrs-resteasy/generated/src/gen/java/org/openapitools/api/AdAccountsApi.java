...
public class AdAccountsApi  {
    ...
    throws NotFoundException {
        return service.adAccountsCatalogsProductGroupsList(adAccountId,feedProfileId,securityContext);
    }
    @POST
    ...
    throws NotFoundException {
        return service.adsAnalytics(adAccountId,startDate,endDate,adIds,columns,granularity,clickWindowDays,engagementWindowDays,viewWindowDays,conversionReportTime,securityContext);
    }
    @POST
