...
public interface BusinessesApiService {
      ...
      Response assetGroupCreate(String businessId,CreateAssetGroupBody createAssetGroupBody,SecurityContext securityContext)
      throws NotFoundException;
      Response assetGroupDelete(String businessId,DeleteAssetGroupBody deleteAssetGroupBody,SecurityContext securityContext)
      throws NotFoundException;
      Response assetGroupUpdate(String businessId,UpdateAssetGroupBody updateAssetGroupBody,SecurityContext securityContext)
      throws NotFoundException;
      ...
      throws NotFoundException;
      Response businessMemberAssetsGet(String businessId,String memberId,String assetType,Integer startIndex,String bookmark,Integer pageSize,SecurityContext securityContext)
      throws NotFoundException;
      Response businessMembersAssetAccessDelete(String businessId,BusinessMembersAssetAccessDeleteRequest businessMembersAssetAccessDeleteRequest,SecurityContext securityContext)
      throws NotFoundException;
      ...
      throws NotFoundException;
      Response businessPartnerAssetAccessGet(String businessId,String partnerId,PartnerType partnerType,String assetType,Integer startIndex,Integer pageSize,String bookmark,SecurityContext securityContext)
      throws NotFoundException;
      Response cancelInvitesOrRequests(String businessId,CancelInvitesBody cancelInvitesBody,SecurityContext securityContext)
      throws NotFoundException;
      ...
      throws NotFoundException;
      Response deleteBusinessMembership(String businessId,MembersToDeleteBody membersToDeleteBody,SecurityContext securityContext)
      throws NotFoundException;
      Response deleteBusinessPartners(String businessId,DeletePartnersRequest deletePartnersRequest,SecurityContext securityContext)
      throws NotFoundException;
      ...
      throws NotFoundException;
      Response getInvites(String businessId,Boolean isMember,List<String> inviteStatus,InviteType inviteType,String bookmark,Integer pageSize,SecurityContext securityContext)
      throws NotFoundException;
      ...
      throws NotFoundException;
      Response updateBusinessToAdAccountSharedAudience(String businessId,SharedAudience sharedAudience,SecurityContext securityContext)
      throws NotFoundException;
      Response updateBusinessToBusinessSharedAudience(String businessId,BusinessSharedAudience businessSharedAudience,SecurityContext securityContext)
      throws NotFoundException;
