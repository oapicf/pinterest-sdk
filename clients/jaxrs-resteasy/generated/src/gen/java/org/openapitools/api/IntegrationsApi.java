...
public class IntegrationsApi  {
    ...
    throws NotFoundException {
        return service.integrationsCommercePatch(externalBusinessId,integrationMetadataUpdate,securityContext);
    }
    @POST
    @Path("/commerce")
    @Consumes({ "application/json" })
    ...
    throws NotFoundException {
        return service.integrationsCommercePost(integrationMetadataCreate,securityContext);
    }
    @GET
    @Path("/{id}")
    ...
    throws NotFoundException {
        return service.integrationsLogsPost(integrationLogsRequestCreate,securityContext);
    }
}
