...
public class CatalogsApi  {
    ...
    throws NotFoundException {
        return service.catalogsProductGroupsCreate(catalogsProductGroupCreateRequest,securityContext);
    }
    @DELETE
    ...
    throws NotFoundException {
        return service.catalogsProductGroupsDelete(productGroupId,securityContext);
    }
    @GET
    @Path("/product_groups")
    ...
    throws NotFoundException {
        return service.catalogsProductGroupsList(feedId,bookmark,pageSize,securityContext);
    }
    @PATCH
    @Path("/product_groups/{product_group_id}")
    @Consumes({ "application/json" })
    ...
    throws NotFoundException {
        return service.catalogsProductGroupsUpdate(productGroupId,catalogsProductGroupUpdateRequest,securityContext);
    }
    @GET
    ...
    throws NotFoundException {
        return service.feedProcessingResultsList(feedId,bookmark,pageSize,securityContext);
    }
    @POST
    @Path("/feeds")
    @Consumes({ "application/json" })
    ...
    throws NotFoundException {
        return service.feedsCreate(catalogsFeedsCreateRequest,securityContext);
    }
    @DELETE
    @Path("/feeds/{feed_id}")
    ...
    throws NotFoundException {
        return service.feedsDelete(feedId,securityContext);
    }
    @GET
    @Path("/feeds/{feed_id}")
    ...
    throws NotFoundException {
        return service.feedsGet(feedId,securityContext);
    }
    @GET
    @Path("/feeds")
    ...
    throws NotFoundException {
        return service.feedsList(bookmark,pageSize,securityContext);
    }
    @PATCH
    @Path("/feeds/{feed_id}")
    @Consumes({ "application/json" })
    ...
    throws NotFoundException {
        return service.feedsUpdate(feedId,catalogsFeedsUpdateRequest,securityContext);
    }
    @GET
    ...
    throws NotFoundException {
        return service.itemsBatchGet(batchId,securityContext);
    }
    @POST
    @Path("/items/batch")
    @Consumes({ "application/json" })
    ...
    throws NotFoundException {
        return service.itemsBatchPost(catalogsItemsBatchRequest,securityContext);
    }
    @GET
    @Path("/items")
    ...
    throws NotFoundException {
        return service.itemsGet(country,itemIds,language,securityContext);
    }
}
