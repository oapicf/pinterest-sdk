...
public class TrendsApi  {
    ...
    throws NotFoundException {
        return service.trendingKeywordsList(region,trendType,interests,genders,ages,includeKeywords,normalizeAgainstGroup,limit,includeDemographics,securityContext);
    }
    @GET
    ...
    throws NotFoundException {
        return service.trendsEditorialArticlesList(region,securityContext);
    }
    @GET
