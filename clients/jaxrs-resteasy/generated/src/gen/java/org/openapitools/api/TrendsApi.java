...
public class TrendsApi  {
    ...
    public Response trendingKeywordsList( @PathParam("region") TrendsSupportedRegion region, @PathParam("trend_type") TrendType trendType, @QueryParam("interests") List<String> interests, @QueryParam("genders") List<String> genders, @QueryParam("ages") List<String> ages, @Size(min=1,max=50) @QueryParam("include_keywords") List<@Size(min = 1, max = 100)String> includeKeywords, @DefaultValue("false") @QueryParam("normalize_against_group") Boolean normalizeAgainstGroup, @Min(1) @Max(50) @DefaultValue("50") @QueryParam("limit") Integer limit, @DefaultValue("false") @QueryParam("include_prediction") Boolean includePrediction, @DefaultValue("false") @QueryParam("include_demographics") Boolean includeDemographics,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.trendingKeywordsList(region,trendType,interests,genders,ages,includeKeywords,normalizeAgainstGroup,limit,includePrediction,includeDemographics,securityContext);
    }
    @GET
    ...
    throws NotFoundException {
        return service.trendsFeaturedTopicsList(region,interest,securityContext);
    }
    @GET
    ...
    throws NotFoundException {
        return service.trendsProductCategoriesDetailsList(productCategories,region,lookbackWindow,engagementType,securityContext);
    }
    @GET
    ...
    throws NotFoundException {
        return service.trendsProductCategoriesTrendingList(region,verticals,ages,genders,engagementType,securityContext);
    }
}
