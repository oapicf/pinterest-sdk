...
public class BoardsApi  {
    ...
    throws NotFoundException {
        return service.boardsCreate(board,adAccountId,securityContext);
    }
    @DELETE
    @Path("/{board_id}")
    ...
    throws NotFoundException {
        return service.boardsList(adAccountId,bookmark,pageSize,privacy,securityContext);
    }
    @GET
    @Path("/{board_id}/pins")
    ...
    throws NotFoundException {
        return service.boardsUpdate(boardId,boardUpdate,adAccountId,securityContext);
    }
}
