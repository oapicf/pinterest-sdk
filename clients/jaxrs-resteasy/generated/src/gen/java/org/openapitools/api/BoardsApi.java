...
public class BoardsApi  {
    ...
    throws NotFoundException {
        return service.boardSectionsCreate(boardId,boardSection,securityContext);
    }
    @DELETE
    ...
    throws NotFoundException {
        return service.boardSectionsDelete(boardId,sectionId,securityContext);
    }
    @GET
    @Path("/{board_id}/sections")
    ...
    throws NotFoundException {
        return service.boardSectionsList(boardId,bookmark,pageSize,securityContext);
    }
    @GET
    ...
    throws NotFoundException {
        return service.boardSectionsListPins(boardId,sectionId,bookmark,pageSize,securityContext);
    }
    @PATCH
    @Path("/{board_id}/sections/{section_id}")
    @Consumes({ "application/json" })
    ...
    throws NotFoundException {
        return service.boardSectionsUpdate(boardId,sectionId,boardSection,securityContext);
    }
    @POST
    ...
    throws NotFoundException {
        return service.boardsCreate(board,securityContext);
    }
    @DELETE
    @Path("/{board_id}")
    ...
    throws NotFoundException {
        return service.boardsDelete(boardId,securityContext);
    }
    @GET
    @Path("/{board_id}")
    ...
    throws NotFoundException {
        return service.boardsGet(boardId,securityContext);
    }
    @GET
    ...
    throws NotFoundException {
        return service.boardsList(bookmark,pageSize,privacy,securityContext);
    }
    @GET
    @Path("/{board_id}/pins")
    ...
    throws NotFoundException {
        return service.boardsListPins(boardId,bookmark,pageSize,securityContext);
    }
    @PATCH
    @Path("/{board_id}")
    @Consumes({ "application/json" })
    ...
    throws NotFoundException {
        return service.boardsUpdate(boardId,boardUpdate,securityContext);
    }
}
