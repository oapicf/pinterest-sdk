...
public class BoardsApi  {
    ...
    throws NotFoundException {
        return service.boardSectionsCreate(boardId,boardSectionCreate,adAccountId,securityContext);
    }
    @DELETE
    ...
    throws NotFoundException {
        return service.boardSectionsUpdate(boardId,sectionId,boardSectionUpdateWithRequiredBody,adAccountId,securityContext);
    }
    @POST
    ...
    throws NotFoundException {
        return service.boardsListPins(boardId,creativeTypes,adAccountId,pinMetrics,bookmark,pageSize,securityContext);
    }
    @PATCH
    @Path("/{board_id}")
    @Consumes({ "application/json" })
