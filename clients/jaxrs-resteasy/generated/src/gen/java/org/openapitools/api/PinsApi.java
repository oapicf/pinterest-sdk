...
public class PinsApi  {
    ...
    throws NotFoundException {
        return service.pinsGet(pinId,adAccountId,pinMetrics,securityContext);
    }
    @GET
    ...
    throws NotFoundException {
        return service.pinsList(pinFilter,pinMetrics,includeProtectedPins,pinType,creativeTypes,adAccountId,domain,domains,includeProductTagObj,bookmark,pageSize,securityContext);
    }
    @POST
    @Path("/{pin_id}/save")
    @Consumes({ "application/json" })
    ...
    throws NotFoundException {
        return service.pinsSave(pinId,pinsSaveRequestCreate,adAccountId,securityContext);
    }
    @PATCH
    @Path("/{pin_id}")
    @Consumes({ "application/json" })
    ...
    throws NotFoundException {
        return service.productTagsBulkAdd(pinId,productTagsBulkAddRequest,securityContext);
    }
    @POST
    ...
    throws NotFoundException {
        return service.productTagsBulkDelete(pinId,productTagsBulkDeleteRequest,securityContext);
    }
    @GET
    @Path("/{pin_id}/product_tags")
    ...
    throws NotFoundException {
        return service.productTagsList(pinId,securityContext);
    }
}
