...
public class BillingInvoiceResponse   {
 ...
 @Pattern(regexp="^(\\d{4})-(\\d{2})-(\\d{2})$")  public Date getBillingPeriodEndDate() {
 ...
 @Pattern(regexp="^(\\d{4})-(\\d{2})-(\\d{2})$")  public Date getBillingPeriodStartDate() {
 ...
 @Pattern(regexp="^(\\d{4})-(\\d{2})-(\\d{2})$")  public Date getInvoiceDueDate() {
