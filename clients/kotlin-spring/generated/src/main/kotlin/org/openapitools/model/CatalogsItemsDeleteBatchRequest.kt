...
data class CatalogsItemsDeleteBatchRequest(
    ...
    @get:JsonProperty("language", required = true) val language: CatalogsItemsDeleteBatchRequest.Language,

    @Schema(required = true, description = "")
    @param:JsonProperty("operation")
    @get:JsonProperty("operation", required = true) override val operation: CatalogsItemsDeleteBatchRequest.Operation = kotlin.String.DELETE
