...
data class AdGroupCommon(
    ...
    @get:JsonProperty("bid_strategy_type") val bidStrategyType: AdGroupCommon.BidStrategyType? = null,
    ...
    @get:JsonProperty("promotion_application_level") val promotionApplicationLevel: AdGroupCommon.PromotionApplicationLevel? = null,
