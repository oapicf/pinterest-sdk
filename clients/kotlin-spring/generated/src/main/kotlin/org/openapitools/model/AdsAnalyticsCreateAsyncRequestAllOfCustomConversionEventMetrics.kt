...
data class AdsAnalyticsCreateAsyncRequestAllOfCustomConversionEventMetrics(
    ...
    @Schema(example = "ADE_COST_PER_ACTION", required = true, description = "Metrics for custom defined conversion event.")
    @get:JsonProperty("custom_event_metrics_type", required = true) val customEventMetricsType: AdsAnalyticsCreateAsyncRequestAllOfCustomConversionEventMetrics.CustomEventMetricsType,

    @Schema(example = "null", required = true, description = "Name of the advertiser-defined custom conversion event")
    ...
    */
    enum class CustomEventMetricsType(@get:JsonValue val value: kotlin.String) {
        ...
        companion object {
            @JvmStatic
            @JsonCreator
            fun forValue(value: kotlin.String): CustomEventMetricsType {
                return values().firstOrNull{it -> it.value == value}
                    ?: throw IllegalArgumentException("Unexpected value '$value' for enum 'AdsAnalyticsCreateAsyncRequestAllOfCustomConversionEventMetrics'")
            }
        }
    }
