...
data class ImageBase64(
    ...
    @get:JsonProperty("content_type", required = true) val contentType: ImageBase64.ContentType,
        ...
        companion object {
            ...
            fun forValue(value: kotlin.String): ContentType {
                return values().firstOrNull{it -> it.value == value}
                    ?: throw IllegalArgumentException("Unexpected value '$value' for enum 'ImageBase64'")
            }
        }
    }
