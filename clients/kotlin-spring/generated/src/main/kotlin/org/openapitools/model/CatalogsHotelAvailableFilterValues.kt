...
data class CatalogsHotelAvailableFilterValues(
    ...
    @get:JsonProperty("catalog_type", required = true) val catalogType: CatalogsHotelAvailableFilterValues.CatalogType,
        ...
        companion object {
            ...
            fun forValue(value: kotlin.String): CatalogType {
                return values().firstOrNull{it -> it.value == value}
                    ?: throw IllegalArgumentException("Unexpected value '$value' for enum 'CatalogsHotelAvailableFilterValues'")
            }
        }
    }
