...
data class PromotionCreateRequest(
    ...
    @Schema(example = "Black Friday 10% off", required = true, description = "Internal name for the promotion.")
    @get:JsonProperty("promotion_title", required = true) val promotionTitle: kotlin.String,

    @field:Valid
    @Schema(example = "null", required = true, description = "")
    @get:JsonProperty("promotion_type", required = true) val promotionType: PromotionType,

    @Schema(example = "ACTIVE", description = "Discount status based on the current time and start and end time of discount")
    @get:JsonProperty("discount_status") val discountStatus: PromotionCreateRequest.DiscountStatus? = null,
        ...
        companion object {
            ...
            fun forValue(value: kotlin.String): DiscountStatus {
                return values().firstOrNull{it -> it.value == value}
                    ?: throw IllegalArgumentException("Unexpected value '$value' for enum 'PromotionCreateRequest'")
            }
        }
    }
