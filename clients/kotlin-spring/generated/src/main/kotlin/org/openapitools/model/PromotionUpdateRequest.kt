...
data class PromotionUpdateRequest(
    ...
    @Schema(example = "7834020347906", required = true, description = "Promotion ID")
    @get:JsonProperty("id", required = true) val id: kotlin.String,

    @Schema(example = "ACTIVE", description = "Discount status based on the current time and start and end time of discount")
    @get:JsonProperty("discount_status") val discountStatus: PromotionUpdateRequest.DiscountStatus? = null,
        ...
        companion object {
            ...
            fun forValue(value: kotlin.String): DiscountStatus {
                return values().firstOrNull{it -> it.value == value}
                    ?: throw IllegalArgumentException("Unexpected value '$value' for enum 'PromotionUpdateRequest'")
            }
        }
    }
