...
data class PromotionResponse(
    ...
    @get:JsonProperty("discount_status") val discountStatus: PromotionResponse.DiscountStatus? = null,
    ...
    @Schema(example = "549755885175", description = "The Ad Account ID that this promotion belongs to.")
    @get:JsonProperty("ad_account_id") val adAccountId: kotlin.String? = null,

    @get:Pattern(regexp="^\\d+$")
    @Schema(example = "7834020347906", description = "Promotion ID")
        ...
        companion object {
            ...
            fun forValue(value: kotlin.String): DiscountStatus {
                return values().firstOrNull{it -> it.value == value}
                    ?: throw IllegalArgumentException("Unexpected value '$value' for enum 'PromotionResponse'")
            }
        }
    }
