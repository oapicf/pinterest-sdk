...
data class UpdateBusinessMembershipsResponse(
    ...
    @field:Valid
    @Schema(description = "List of members with updated business access role.")
    @field:JsonInclude(JsonInclude.Include.NON_NULL)
    @field:JsonSetter(nulls = Nulls.SKIP)
    @param:JsonProperty("items")
    @get:JsonProperty("items") val items: kotlin.collections.List<BusinessMembershipMember>? = null
) {
