...
*/
enum class ConversionTagTypeOptimal(@get:JsonValue val value: kotlin.String) {
    ...
    companion object {
        @JvmStatic
        @JsonCreator
        fun forValue(value: kotlin.String): ConversionTagTypeOptimal {
                return values().firstOrNull{it -> it.value == value}
                    ?: throw IllegalArgumentException("Unexpected value '$value' for enum 'ConversionTagTypeOptimal'")
        }
    }
}
