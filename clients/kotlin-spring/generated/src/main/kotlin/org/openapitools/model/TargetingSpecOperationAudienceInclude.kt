 ...
 */
data class TargetingSpecOperationAudienceInclude(

    @Schema(required = true, description = "")
    @param:JsonProperty("field")
    @get:JsonProperty("field", required = true) override val `field`: TargetingSpecOperationAudienceInclude.`Field` = kotlin.String.AUDIENCE_INCLUDE,
