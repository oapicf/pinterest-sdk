...
data class PinsSaveRequestCreate(
    ...
    @Schema(description = "Unique identifier of the board to which the pin will be saved.")
    @param:JsonProperty("board_id")
    @get:JsonProperty("board_id") val boardId: kotlin.String? = null,

    @get:Pattern(regexp="^\\d+$")
    @Schema(description = "Unique identifier of the board section to which the pin will be saved.")
