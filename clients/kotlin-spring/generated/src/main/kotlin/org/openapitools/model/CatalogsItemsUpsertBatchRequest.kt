...
data class CatalogsItemsUpsertBatchRequest(
    ...
    @get:JsonProperty("items", required = true) val items: kotlin.collections.List<ItemUpsertBatchRecord>,

    @Schema(required = true, description = "We recommend using the CatalogsLocale values.")
    @param:JsonProperty("language")
    @get:JsonProperty("language", required = true) val language: CatalogsItemsUpsertBatchRequest.Language,

    @Schema(required = true, description = "")
    @param:JsonProperty("operation")
    @get:JsonProperty("operation", required = true) override val operation: CatalogsItemsUpsertBatchRequest.Operation = kotlin.String.UPSERT
