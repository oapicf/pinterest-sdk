...
data class CatalogsRetailBatchRequest(
    ...
    @get:JsonProperty("catalog_type", required = true) override val catalogType: CatalogsRetailBatchRequest.CatalogType = kotlin.String.RETAIL,
    ...
    @Schema(required = true, description = "Array with catalogs item operations")
    @param:JsonProperty("items")
    @get:JsonProperty("items", required = true) val items: kotlin.collections.List<CatalogsRetailBatchRequestItemsItems>,
