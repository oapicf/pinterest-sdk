...
interface CatalogsRetailBatchRequestItemsInner {
        ...
        val updateMask: kotlin.collections.List<UpdateMaskFieldType>? 
                ...
                @get:Schema(example = "1641483432072", description = "The millisecond timestamp when the item was lastly modified by the merchant.")
        ...
        companion object {
            ...
            fun forValue(value: kotlin.String): Operation {
                return values().firstOrNull{it -> it.value == value}
                    ?: throw IllegalArgumentException("Unexpected value '$value' for enum 'CatalogsRetailBatchRequestItemsInner'")
            }
        }
    }
