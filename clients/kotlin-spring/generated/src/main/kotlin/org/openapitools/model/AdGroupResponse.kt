...
data class AdGroupResponse(
    ...
    @field:JsonProperty("budget_type") val budgetType: AdGroupResponse.BudgetType? = null,
    ...
    @field:JsonProperty("conversion_learning_mode_type") val conversionLearningModeType: AdGroupResponse.ConversionLearningModeType? = null,
