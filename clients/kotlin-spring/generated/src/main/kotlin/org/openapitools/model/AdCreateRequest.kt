...
data class AdCreateRequest(
    ...
    @Schema(example = "2680059592705", required = true, description = "ID of the ad group that contains the ad.")
    ...
    @get:JsonProperty("customizable_cta_type") val customizableCtaType: AdCreateRequest.CustomizableCtaType? = null,
        ...
        companion object {
            ...
            fun forValue(value: kotlin.String): CustomizableCtaType {
                return values().firstOrNull{it -> it.value == value}
                    ?: throw IllegalArgumentException("Unexpected value '$value' for enum 'AdCreateRequest'")
            }
        }
    }
