...
*/
enum class DataStatus(@get:JsonValue val value: kotlin.String) {
    ...
    companion object {
        @JvmStatic
        @JsonCreator
        fun forValue(value: kotlin.String): DataStatus {
                return values().firstOrNull{it -> it.value == value}
                    ?: throw IllegalArgumentException("Unexpected value '$value' for enum 'DataStatus'")
        }
    }
}
