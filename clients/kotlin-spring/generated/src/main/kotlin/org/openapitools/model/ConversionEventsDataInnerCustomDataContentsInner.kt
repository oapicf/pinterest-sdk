...
data class ConversionEventsDataInnerCustomDataContentsInner(
    ...
    @Schema(example = "null", description = "The id of a product. We recommend using this if you are a merchant for AddToCart and Checkouts. For detail, please check <a href=\"https://help.pinterest.com/en/business/article/before-you-get-started-with-catalogs\" target=\"_blank\">here</a> (Install the Pinterest tag section).")
    @get:JsonProperty("id") val id: kotlin.String? = null,

    @Schema(example = "null", description = "The brand of a product.")
    @get:JsonProperty("item_brand") val itemBrand: kotlin.String? = null,

    @Schema(example = "null", description = "The category of a product.")
    @get:JsonProperty("item_category") val itemCategory: kotlin.String? = null,

    @Schema(example = "null", description = "The name of a product.")
    @get:JsonProperty("item_name") val itemName: kotlin.String? = null,

    @Schema(example = "null", description = "The price of a product. Accepted as a string in the request; it will be parsed into a double. This is the original item value before any discount. We recommend using this if you are a merchant for PageVisit, AddToCart and Checkouts. For detail, please check <a href=\"https://help.pinterest.com/en/business/article/before-you-get-started-with-catalogs\" target=\"_blank\">here</a> (Install the Pinterest tag section).")
    @get:JsonProperty("item_price") val itemPrice: kotlin.String? = null,

    @Schema(example = "null", description = "The amount of a product. We recommend using this if you are a merchant for AddToCart and Checkouts. For detail, please check <a href=\"https://help.pinterest.com/en/business/article/before-you-get-started-with-catalogs\" target=\"_blank\">here</a> (Install the Pinterest tag section).")
