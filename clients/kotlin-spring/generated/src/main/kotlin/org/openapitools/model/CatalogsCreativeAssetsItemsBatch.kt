...
data class CatalogsCreativeAssetsItemsBatch(
    ...
    @get:JsonProperty("catalog_type", required = true) override val catalogType: CatalogsCreativeAssetsItemsBatch.CatalogType = kotlin.String.CREATIVE_ASSETS,
    ...
    @get:JsonProperty("items") val items: kotlin.collections.List<CreativeAssetsProcessingRecord>? = null,
