...
data class CatalogsHotelReportParameters(
    ...
    @get:JsonProperty("catalog_type", required = true) val catalogType: CatalogsHotelReportParameters.CatalogType,
        ...
        companion object {
            ...
            fun forValue(value: kotlin.String): CatalogType {
                return values().firstOrNull{it -> it.value == value}
                    ?: throw IllegalArgumentException("Unexpected value '$value' for enum 'CatalogsHotelReportParameters'")
            }
        }
    }
