...
data class CatalogsReportAllItemsFilter(
    ...
    @get:JsonProperty("report_type", required = true) val reportType: CatalogsReportAllItemsFilter.ReportType,
        ...
        companion object {
            ...
            fun forValue(value: kotlin.String): ReportType {
                return values().firstOrNull{it -> it.value == value}
                    ?: throw IllegalArgumentException("Unexpected value '$value' for enum 'CatalogsReportAllItemsFilter'")
            }
        }
    }
