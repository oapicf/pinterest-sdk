...
data class FeaturedTrend(
    ...
    @field:Valid
    @Schema(example = "null", required = true, description = "The main interest category")
    @get:JsonProperty("interest", required = true) val interest: InterestsEnum,

    @field:Valid
    @Schema(example = "null", description = "Market code (e.g., 'US', 'UK', etc.)")
    @get:JsonProperty("market") val market: ProductCategoryRegion? = null,

    @field:Valid
    @Schema(example = "null", description = "List of trending topics within this interest category")
