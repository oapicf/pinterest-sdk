...
data class ItemAttributes(
    ...
    @Schema(example = "[\"https://scene.example.com/image/image_v2.jpg\",\"https://scene.example.com/image/image_v3.jpg\"]", description = "<= 2000 characters. The links to additional images for your product. Up to ten additional images can be used to show a product from different angles or to show different stages. Must begin with http:// or https://.")
    ...
    @get:Size(min=1)
    @Schema(example = "[\"https://scene.example.com/image/image.jpg\"]", description = "<= 2000 characters. The links to the main product images. Images should be at least 75x75 pixels to avoid errors. Must start with http:// or https://.")
    @field:JsonInclude(JsonInclude.Include.NON_NULL)
    @field:JsonSetter(nulls = Nulls.SKIP)
    @param:JsonProperty("image_link")
    @get:JsonProperty("image_link") val imageLink: kotlin.collections.List<kotlin.String>? = null,

    @Schema(example = "https://www.example.com/cat/womens-clothing/denim-shirt-0294.mp4", description = "<= 2,000 characters. Hosted link to the product video. File types must be .mp4, .mov or .m4v. File size cannot exceed 2GB.")
