...
data class CatalogsCreateCreativeAssetsItem(
    ...
    @get:JsonProperty("operation", required = true) val operation: CatalogsCreateCreativeAssetsItem.Operation,
        ...
        companion object {
            ...
            fun forValue(value: kotlin.String): Operation {
                return values().firstOrNull{it -> it.value == value}
                    ?: throw IllegalArgumentException("Unexpected value '$value' for enum 'CatalogsCreateCreativeAssetsItem'")
            }
        }
    }
