...
data class AdPreviewShopping(
    ...
    @get:JsonProperty("creative_type", required = true) val creativeType: AdPreviewShopping.CreativeType,
    ...
    @get:JsonProperty("preferred_media_type") val preferredMediaType: AdPreviewShopping.PreferredMediaType? = null,
        ...
        companion object {
            ...
            fun forValue(value: kotlin.String): CreativeType {
                return values().firstOrNull{it -> it.value == value}
                    ?: throw IllegalArgumentException("Unexpected value '$value' for enum 'AdPreviewShopping'")
            }
        }
    }
