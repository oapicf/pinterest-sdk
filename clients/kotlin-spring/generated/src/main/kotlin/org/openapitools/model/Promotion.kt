...
data class Promotion(
    ...
    @Schema(required = true, readOnly = true, description = "The Ad Account ID that this promotion belongs to.")
    ...
    @Schema(required = true, description = "Internal name for the promotion.")
