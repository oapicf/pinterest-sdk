...
data class ItemAttributesRequest(
    ...
    @field:Valid
    @Schema(example = "null", description = "")
    @get:JsonProperty("image_link") val imageLink: ItemAttributesRequestAllOfImageLink? = null,

    @Schema(example = "true", description = "By default, product pins created from a catalog are able to be saved by Pinners. If you want to disable the save pin feature, set this attribute to true. This feature is only available for allowlisted merchants. Please contact your account manager to enable this feature.")
