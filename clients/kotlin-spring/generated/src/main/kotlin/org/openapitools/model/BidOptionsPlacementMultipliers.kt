...
data class BidOptionsPlacementMultipliers(
    ...
    @get:JsonProperty("browse") val browse: java.math.BigDecimal? = null,

    @Schema(description = "")
    @field:JsonInclude(JsonInclude.Include.NON_NULL)
    @field:JsonSetter(nulls = Nulls.SKIP)
    @param:JsonProperty("related_pins")
    @get:JsonProperty("related_pins") val relatedPins: java.math.BigDecimal? = null,

    @Schema(description = "")
    @field:JsonInclude(JsonInclude.Include.NON_NULL)
    @field:JsonSetter(nulls = Nulls.SKIP)
    @param:JsonProperty("search")
    @get:JsonProperty("search") val search: java.math.BigDecimal? = null
) {
