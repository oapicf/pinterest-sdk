...
data class CatalogsCreativeAssetsProduct(
    ...
    @get:JsonProperty("catalog_type", required = true) override val catalogType: CatalogsCreativeAssetsProduct.CatalogType = kotlin.String.CREATIVE_ASSETS,
