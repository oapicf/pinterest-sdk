...
data class TargetingSpec(
    ...
    @get:JsonProperty("AUDIENCE_INCLUDE'") val auDIENCEINCLUDEQuote: kotlin.collections.List<kotlin.String>? = null,
    ...
    @Schema(example = "null", description = "24 ISO 639-1 two letter language codes. If the LOCALE field is missing, the default behavior in terms of ad delivery is that **All languages will be target, only english non-sublanguage will be targeted**.")
    ...
    */
    enum class AGEBUCKET(val value: kotlin.String) {
        ...
        @JsonProperty("18-24") _18Minus24("18-24"),
        @JsonProperty("21+") _21Plus("21+"),
        @JsonProperty("25-34") _25Minus34("25-34"),
        @JsonProperty("35-44") _35Minus44("35-44"),
        @JsonProperty("45-49") _45Minus49("45-49"),
        @JsonProperty("50-54") _50Minus54("50-54"),
        @JsonProperty("55-64") _55Minus64("55-64"),
        @JsonProperty("65+") _65Plus("65+")
    }
    ...
    */
    enum class APPTYPE(val value: kotlin.String) {
        ...
        @JsonProperty("android_mobile") android_mobile("android_mobile"),
        @JsonProperty("android_tablet") android_tablet("android_tablet"),
        @JsonProperty("ipad") ipad("ipad"),
        @JsonProperty("iphone") iphone("iphone"),
        @JsonProperty("web") web("web"),
        @JsonProperty("web_mobile") web_mobile("web_mobile")
    }
    ...
    */
    enum class TARGETINGSTRATEGY(val value: kotlin.String) {
        ...
        @JsonProperty("CHOOSE_YOUR_OWN") CHOOSE_YOUR_OWN("CHOOSE_YOUR_OWN"),
        @JsonProperty("FIND_NEW_CUSTOMERS") FIND_NEW_CUSTOMERS("FIND_NEW_CUSTOMERS"),
        @JsonProperty("RECONNECT_WITH_USERS") RECONNECT_WITH_USERS("RECONNECT_WITH_USERS")
    }
