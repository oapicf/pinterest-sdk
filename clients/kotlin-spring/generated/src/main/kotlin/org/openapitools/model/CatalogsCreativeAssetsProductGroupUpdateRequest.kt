...
data class CatalogsCreativeAssetsProductGroupUpdateRequest(
    ...
    @get:JsonProperty("catalog_type", required = true) override val catalogType: CatalogsCreativeAssetsProductGroupUpdateRequest.CatalogType = kotlin.String.CREATIVE_ASSETS,
