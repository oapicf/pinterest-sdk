...
data class CustomerListUploadResponse(
    ...
    @get:JsonProperty("state", required = true) val state: CustomerListUploadResponse.State,
        ...
        companion object {
            ...
            fun forValue(value: kotlin.String): State {
                return values().firstOrNull{it -> it.value == value}
                    ?: throw IllegalArgumentException("Unexpected value '$value' for enum 'CustomerListUploadResponse'")
            }
        }
    }
