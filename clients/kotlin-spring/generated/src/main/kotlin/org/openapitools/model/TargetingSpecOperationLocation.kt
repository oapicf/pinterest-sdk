 ...
 */
data class TargetingSpecOperationLocation(

    @Schema(required = true, description = "")
    @param:JsonProperty("field")
    @get:JsonProperty("field", required = true) override val `field`: TargetingSpecOperationLocation.`Field` = kotlin.String.LOCATION,
