...
data class ProductGroupAnalyticsResponseInner(
    ...
    @Schema(example = "null", required = true, description = "The ID of the product group that this metrics belongs to.")
    @get:JsonProperty("PRODUCT_GROUP_ID", required = true) val PRODUCT_GROUP_ID: kotlin.String,
