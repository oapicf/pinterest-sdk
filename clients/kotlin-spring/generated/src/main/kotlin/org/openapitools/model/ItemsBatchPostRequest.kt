...
data class ItemsBatchPostRequest(
    ...
    @get:JsonProperty("catalog_type", required = true) val catalogType: ItemsBatchPostRequest.CatalogType,
        ...
        companion object {
            ...
            fun forValue(value: kotlin.String): CatalogType {
                return values().firstOrNull{it -> it.value == value}
                    ?: throw IllegalArgumentException("Unexpected value '$value' for enum 'ItemsBatchPostRequest'")
            }
        }
    }
