...
data class DeleteAssetGroupResponseExceptionsInner(
    ...
    @Schema(example = "29", description = "Error code associated with the error deleting asset group.")
    @get:JsonProperty("code") val code: kotlin.Int? = null,

    @Schema(example = "You are not permitted to access that resource.", description = "Error message associated with the error deleting asset group.")
