...
interface AdvancedAuctionItemsSubmitRecord {
        ...
        val updateMask: kotlin.collections.List<UpdateMaskBidOptionField>
                ...
                @get:Schema(example = "null", description = "Array with validation errors for the supplied item bid option modification operation. A non empty errors list means this single item operation was not applied.")
