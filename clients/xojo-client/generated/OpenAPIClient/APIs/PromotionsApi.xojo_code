...
Protected Class PromotionsApi
	#tag Method, Flags = &h0
		Sub PromotionsCreate(, adAccountId As String, promotionCreate() As OpenAPIClient.Models.PromotionCreate)
		  ...
		  Dim localVarPath As String = "/ad_accounts/{ad_account_id}/promotions"
		  ...
		  AddHandler localVarHTTPSocket.PageReceived, addressof me.PromotionsCreate_handler
		  AddHandler localVarHTTPSocket.Error, addressof Me.PromotionsCreate_error
	...
	#tag Method, Flags = &h21
		Private Function PromotionsCreatePrivateFuncDeserializeResponse(HTTPStatus As Integer, Headers As InternetHeaders, error As OpenAPIClient.OpenAPIClientException, Content As String, ByRef outData As OpenAPIClient.Models.PromotionsResponse) As Boolean
		  ...
		  If HTTPStatus > 199 and HTTPStatus < 300 then
		    If contentType.LeftB(16) = "application/json" then
			  ...
			  outData = New OpenAPIClient.Models.PromotionsResponse
			  Try
	...
	#tag Method, Flags = &h21
		Private Sub PromotionsCreate_error(sender As HTTPSecureSocket, Code As Integer)
		  If sender <> nil Then sender.Close()

		  Dim error As New OpenAPIClient.OpenAPIClientException(Code)
		  Dim data As OpenAPIClient.Models.PromotionsResponse
		  CallbackHandler.PromotionsCreateCallback(error, data)
		End Sub
	#tag EndMethod

	#tag Method, Flags = &h21
		Private Sub PromotionsCreate_handler(sender As HTTPSecureSocket, URL As String, HTTPStatus As Integer, Headers As InternetHeaders, Content As String)
		  #Pragma Unused URL
		  ...
		  Dim data As OpenAPIClient.Models.PromotionsResponse
		  Call PromotionsCreatePrivateFuncDeserializeResponse(HTTPStatus, Headers, error, Content, data)
	...
	#tag Method, Flags = &h0
		Sub PromotionsGet(, promotionId As String, adAccountId As String)
		  ...
		  AddHandler localVarHTTPSocket.Error, addressof Me.PromotionsGet_error
	...
	#tag Method, Flags = &h21
		Private Sub PromotionsGet_error(sender As HTTPSecureSocket, Code As Integer)
		  If sender <> nil Then sender.Close()
	...
	#tag Method, Flags = &h21
		Private Sub PromotionsGet_handler(sender As HTTPSecureSocket, URL As String, HTTPStatus As Integer, Headers As InternetHeaders, Content As String)
		  #Pragma Unused URL
	...
	#tag Method, Flags = &h0
		Sub PromotionsList(, adAccountId As String, Optional bookmark As Xoson.O.OptionalString, Optional pageSize As Xoson.O.OptionalInteger, order As OpenAPIClient.Models.PinterestLibPaginationOrderOptional)
		  ...
		  AddHandler localVarHTTPSocket.PageReceived, addressof me.PromotionsList_handler
		  AddHandler localVarHTTPSocket.Error, addressof Me.PromotionsList_error
	...
	#tag Method, Flags = &h21
		Private Function PromotionsListPrivateFuncDeserializeResponse(HTTPStatus As Integer, Headers As InternetHeaders, error As OpenAPIClient.OpenAPIClientException, Content As String, ByRef outData As OpenAPIClient.Models.PromotionsList200Response) As Boolean
		  Dim contentType As String = Headers.Value("Content-Type")
		  Dim contentEncoding As TextEncoding = OpenAPIClient.EncodingFromContentType(contentType)
		  Content = DefineEncoding(Content, contentEncoding)
		  ...
		  If HTTPStatus > 199 and HTTPStatus < 300 then
		    If contentType.LeftB(16) = "application/json" then
			  ...
			  outData = New OpenAPIClient.Models.PromotionsList200Response
			  Try
		        Xoson.fromJSON(outData, Content.toText())
	...
	#tag Method, Flags = &h21
		Private Sub PromotionsList_error(sender As HTTPSecureSocket, Code As Integer)
		  If sender <> nil Then sender.Close()

		  Dim error As New OpenAPIClient.OpenAPIClientException(Code)
		  Dim data As OpenAPIClient.Models.PromotionsList200Response
		  CallbackHandler.PromotionsListCallback(error, data)
		End Sub
	#tag EndMethod

	#tag Method, Flags = &h21
		Private Sub PromotionsList_handler(sender As HTTPSecureSocket, URL As String, HTTPStatus As Integer, Headers As InternetHeaders, Content As String)
		  #Pragma Unused URL
		  ...
		  Dim data As OpenAPIClient.Models.PromotionsList200Response
		  Call PromotionsListPrivateFuncDeserializeResponse(HTTPStatus, Headers, error, Content, data)
	...
	#tag Method, Flags = &h0
		Sub PromotionsUpdate(, adAccountId As String, promotionBatchUpdate() As OpenAPIClient.Models.PromotionBatchUpdate)
		  ...
		  AddHandler localVarHTTPSocket.PageReceived, addressof me.PromotionsUpdate_handler
		  AddHandler localVarHTTPSocket.Error, addressof Me.PromotionsUpdate_error
	...
	#tag Method, Flags = &h21
		Private Function PromotionsUpdatePrivateFuncDeserializeResponse(HTTPStatus As Integer, Headers As InternetHeaders, error As OpenAPIClient.OpenAPIClientException, Content As String, ByRef outData As OpenAPIClient.Models.PromotionsResponse) As Boolean
		  Dim contentType As String = Headers.Value("Content-Type")
		  Dim contentEncoding As TextEncoding = OpenAPIClient.EncodingFromContentType(contentType)
		  Content = DefineEncoding(Content, contentEncoding)
	...
	#tag Method, Flags = &h21
		Private Sub PromotionsUpdate_error(sender As HTTPSecureSocket, Code As Integer)
		  If sender <> nil Then sender.Close()

		  Dim error As New OpenAPIClient.OpenAPIClientException(Code)
		  Dim data As OpenAPIClient.Models.PromotionsResponse
		  CallbackHandler.PromotionsUpdateCallback(error, data)
		End Sub
	#tag EndMethod

	#tag Method, Flags = &h21
		Private Sub PromotionsUpdate_handler(sender As HTTPSecureSocket, URL As String, HTTPStatus As Integer, Headers As InternetHeaders, Content As String)
		  #Pragma Unused URL
		  ...
		  Dim data As OpenAPIClient.Models.PromotionsResponse
		  Call PromotionsUpdatePrivateFuncDeserializeResponse(HTTPStatus, Headers, error, Content, data)
	...
	#tag Property, Flags = &h0
		CallbackHandler As OpenAPIClient.APIs.PromotionsApiCallbackHandler
	#tag EndProperty
