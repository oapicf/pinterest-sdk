...
Protected Class ConversionEventsApi
	#tag Method, Flags = &h0
		Sub EventsCreate(, adAccountId As String, conversionEvents As OpenAPIClient.Models.ConversionEvents, Optional test As Xoson.O.OptionalBoolean)
		  ...
		  Dim localVarPath As String = "/ad_accounts/{ad_account_id}/events"
		  ...
		  AddHandler localVarHTTPSocket.PageReceived, addressof me.EventsCreate_handler
		  AddHandler localVarHTTPSocket.Error, addressof Me.EventsCreate_error
	...
	#tag Method, Flags = &h21
		Private Sub EventsCreate_error(sender As HTTPSecureSocket, Code As Integer)
	...
	#tag Method, Flags = &h21
		Private Sub EventsCreate_handler(sender As HTTPSecureSocket, URL As String, HTTPStatus As Integer, Headers As InternetHeaders, Content As String)
		  #Pragma Unused URL
	...
	#tag Property, Flags = &h0
		CallbackHandler As OpenAPIClient.APIs.ConversionEventsApiCallbackHandler
	#tag EndProperty
