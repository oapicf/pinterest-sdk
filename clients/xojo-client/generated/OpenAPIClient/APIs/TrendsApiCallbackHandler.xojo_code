#tag Interface
Protected Interface TrendsApiCallbackHandler
	#tag Method, Flags = &h0
		Sub TrendsEditorialArticlesListCallback(status As OpenAPIClient.OpenAPIClientException, data() As OpenAPIClient.Models.TrendsEditorial)
