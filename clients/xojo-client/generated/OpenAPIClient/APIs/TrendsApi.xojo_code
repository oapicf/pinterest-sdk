#tag Class
Protected Class TrendsApi
	#tag Method, Flags = &h0
		Sub TrendsEditorialArticlesList(, region As OpenAPIClient.Models.ProductCategoryRegion)
		  // Operation trends_editorial_articles/list
		  ...
		  //
		  // Invokes TrendsApiCallbackHandler.TrendsEditorialArticlesListCallback(TrendsEditorial) on completion. 
		  //
		  ...
		  Dim localVarPath As String = "/trends/editorial_articles"
		  
		  
		  
		  AddHandler localVarHTTPSocket.PageReceived, addressof me.TrendsEditorialArticlesList_handler
		  AddHandler localVarHTTPSocket.Error, addressof Me.TrendsEditorialArticlesList_error
	...
	#tag Method, Flags = &h21
		Private Function TrendsEditorialArticlesListPrivateFuncDeserializeResponse(HTTPStatus As Integer, Headers As InternetHeaders, error As OpenAPIClient.OpenAPIClientException, Content As String, outData() As OpenAPIClient.Models.TrendsEditorial) As Boolean
	...
	#tag Method, Flags = &h21
		Private Sub TrendsEditorialArticlesList_error(sender As HTTPSecureSocket, Code As Integer)
		  If sender <> nil Then sender.Close()

		  Dim error As New OpenAPIClient.OpenAPIClientException(Code)
		  Dim data() As OpenAPIClient.Models.TrendsEditorial
		  CallbackHandler.TrendsEditorialArticlesListCallback(error, data)
		End Sub
	#tag EndMethod

	#tag Method, Flags = &h21
		Private Sub TrendsEditorialArticlesList_handler(sender As HTTPSecureSocket, URL As String, HTTPStatus As Integer, Headers As InternetHeaders, Content As String)
		  #Pragma Unused URL
		  ...
		  Dim data() As OpenAPIClient.Models.TrendsEditorial
		  Call TrendsEditorialArticlesListPrivateFuncDeserializeResponse(HTTPStatus, Headers, error, Content, data)
	...
	#tag Method, Flags = &h0
		Sub TrendsFeaturedTopicsList(, region As OpenAPIClient.Models.ProductCategoryRegion, interest As OpenAPIClient.Models.InterestsEnumOptional)
		  ...
		  //
		  // Invokes TrendsApiCallbackHandler.TrendsFeaturedTopicsListCallback(FeaturedTrend) on completion. 
		  //
	...
	#tag Method, Flags = &h0
		Sub TrendsProductCategoriesDetailsList(, productCategories() As ProductCategoryEnum, region As OpenAPIClient.Models.ProductCategoryRegion, lookbackWindow As OpenAPIClient.Models.ProductCategoryDetailLookbackWindowOptional, engagementType As OpenAPIClient.Models.ProductCategoriesEngagementTypeOptional)
		  ...
		  //
		  // Invokes TrendsApiCallbackHandler.TrendsProductCategoriesDetailsListCallback(ProductCategoryDetails) on completion. 
		  //
	...
	#tag Method, Flags = &h0
		Sub TrendsProductCategoriesTrendingList(, region As OpenAPIClient.Models.ProductCategoryRegion, verticals() As VerticalProductCategory, ages() As AgeTrendsBucket, genders() As GenderBucket, engagementType As OpenAPIClient.Models.ProductCategoriesEngagementTypeOptional)
		  ...
		  // - parameter engagementType: (query)     Type of engagement metric to analyze. - &#x60;ENGAGEMENT&#x60; - Overall engagement metric - &#x60;OUTBOUND_CLICK&#x60; - Number of outbound clicks - &#x60;SAVE&#x60; - Number of pin saves (optional, default to Nil)
		  //
		  // Invokes TrendsApiCallbackHandler.TrendsProductCategoriesTrendingListCallback(TrendingProductCategory) on completion. 
		  //
	...
	#tag Property, Flags = &h0
		CallbackHandler As OpenAPIClient.APIs.TrendsApiCallbackHandler
	#tag EndProperty
