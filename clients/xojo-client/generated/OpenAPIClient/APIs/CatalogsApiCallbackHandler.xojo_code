...
Protected Interface CatalogsApiCallbackHandler
	#tag Method, Flags = &h0
		Sub CatalogsAvailableFilterValuesCallback(status As OpenAPIClient.OpenAPIClientException, Optional data As OpenAPIClient.Models.CatalogsAvailableFilterValues)
