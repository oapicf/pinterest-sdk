#tag Class
Protected Class AudienceInsightsApi
	#tag Method, Flags = &h0
		Sub AudienceInsightsGet(, adAccountId As String, audienceInsightType As OpenAPIClient.Models.AudienceInsightType)
		  // Operation audience_insights/get
		  ...
		  Dim localVarPath As String = "/ad_accounts/{ad_account_id}/audience_insights"
		  ...
		  AddHandler localVarHTTPSocket.PageReceived, addressof me.AudienceInsightsGet_handler
		  AddHandler localVarHTTPSocket.Error, addressof Me.AudienceInsightsGet_error
	...
	#tag Method, Flags = &h21
		Private Sub AudienceInsightsGet_error(sender As HTTPSecureSocket, Code As Integer)
	...
	#tag Method, Flags = &h21
		Private Sub AudienceInsightsGet_handler(sender As HTTPSecureSocket, URL As String, HTTPStatus As Integer, Headers As InternetHeaders, Content As String)
		  #Pragma Unused URL
	...
	#tag Method, Flags = &h0
		Sub AudienceInsightsScopeAndTypeGet(, adAccountId As String)
		  // Operation audience_insights_scope_and_type/get
		  ...
		  Dim localVarPath As String = "/ad_accounts/{ad_account_id}/insights/audiences"
		  ...
		  AddHandler localVarHTTPSocket.PageReceived, addressof me.AudienceInsightsScopeAndTypeGet_handler
		  AddHandler localVarHTTPSocket.Error, addressof Me.AudienceInsightsScopeAndTypeGet_error
	...
	#tag Method, Flags = &h21
		Private Sub AudienceInsightsScopeAndTypeGet_error(sender As HTTPSecureSocket, Code As Integer)
		  If sender <> nil Then sender.Close()
	...
	#tag Method, Flags = &h21
		Private Sub AudienceInsightsScopeAndTypeGet_handler(sender As HTTPSecureSocket, URL As String, HTTPStatus As Integer, Headers As InternetHeaders, Content As String)
		  #Pragma Unused URL
	...
	#tag Property, Flags = &h0
		CallbackHandler As OpenAPIClient.APIs.AudienceInsightsApiCallbackHandler
	#tag EndProperty
