...
Protected Class MsotEventsApi
	#tag Method, Flags = &h0
		Sub MsotEventsCreate(, adAccountId As String, conversionMSOTEvents As OpenAPIClient.Models.ConversionMSOTEvents)
		  ...
		  Dim localVarPath As String = "/ad_accounts/{ad_account_id}/msot/events"
		  ...
		  AddHandler localVarHTTPSocket.PageReceived, addressof Me.MsotEventsCreate_handler
		  AddHandler localVarHTTPSocket.Error, addressof Me.MsotEventsCreate_error
	...
	#tag Method, Flags = &h21
		Private Sub MsotEventsCreate_error(sender As HTTPSecureSocket, Code As Integer)
		  If sender <> nil Then sender.Close()

		  Dim error As New OpenAPIClient.OpenAPIClientException(Code)
		  CallbackHandler.MsotEventsCreateCallback(error)
		End Sub
	#tag EndMethod

	#tag Method, Flags = &h21
		Private Sub MsotEventsCreate_handler(sender As HTTPSecureSocket, URL As String, HTTPStatus As Integer, Headers As InternetHeaders, Content As String)
		  #Pragma Unused URL
	...
	#tag Property, Flags = &h0
		CallbackHandler As OpenAPIClient.APIs.MsotEventsApiCallbackHandler
	#tag EndProperty
