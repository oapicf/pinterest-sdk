#tag Class
Protected Class PinMediaWithVideos
Inherits CodegenModel{name='PinMedia', schemaName='PinMedia', parent='null', parentSchema='null', interfaces=null, interfaceModels=[], allParents=null, parentModel=null, children=5, anyOf=[], oneOf=[], allOf=[], classname='PinMedia', title='Pin media', description='Pin media objects.', classVarName='PinMedia', modelJson='{
  "title" : "Pin media",
  "type" : "object",
  "properties" : {
    "media_type" : {
  ...
  "type" : "string"
	...
	#tag Property, Flags = &h0
		items() As OpenAPIClient.Models.VideoMetadata
	#tag EndProperty
