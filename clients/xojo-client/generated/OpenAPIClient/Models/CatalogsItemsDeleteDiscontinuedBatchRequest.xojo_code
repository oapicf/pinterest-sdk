#tag Class
Protected Class CatalogsItemsDeleteDiscontinuedBatchRequest
	...
	#tag Property, Flags = &h0
		...
		#tag EndNote
		items() As OpenAPIClient.Models.ItemDeleteDiscontinuedBatchRecord
	#tag EndProperty
	...
	#tag Method, Flags = &h0
		Shared Function OperationEnumToString(value As OperationEnum) As String
		  Select Case value
		    ...
		    Case OperationEnum.DeleteDiscontinued
