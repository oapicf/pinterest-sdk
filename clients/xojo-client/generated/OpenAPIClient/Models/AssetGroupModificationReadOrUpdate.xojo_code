#tag Class
Protected Class AssetGroupModificationReadOrUpdate

	#tag Property, Flags = &h0
		#tag Note
			A list of asset groups and the data that will be used to update them.
		#tag EndNote
		asset_groups_to_update() As OpenAPIClient.Models.AssetGroupUpdateItemReadOrUpdateItem
	#tag EndProperty
	...
	#tag Property, Flags = &h0
		...
		#tag EndNote
		exceptions() As OpenAPIClient.Models.AssetGroupUpdateError
	#tag EndProperty
