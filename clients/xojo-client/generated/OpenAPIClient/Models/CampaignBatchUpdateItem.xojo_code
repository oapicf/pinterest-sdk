#tag Class
Protected Class CampaignBatchUpdateItem

	#tag Property, Flags = &h0
		#tag Note
			Setting this field does nothing. The ad account ID gets set from the path parameter.
		#tag EndNote
		Attributes( Deprecated ) ad_account_id As Xoson.O.OptionalString
	#tag EndProperty
	...
	#tag Property, Flags = &h0
		...
		#tag EndNote
		app_platform As Xoson.O.OptionalString
	#tag EndProperty
	...
	#tag Property, Flags = &h0
		...
		#tag EndNote
		Attributes( Deprecated ) default_ad_group_budget_in_micro_currency As Xoson.O.OptionalInteger
	#tag EndProperty
