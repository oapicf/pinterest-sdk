...
#
# billing_invoice_download_get test
#
# uncomment below and update the test
#my $billing_invoice_download_get_ad_account_id = undef; # replace NULL with a proper value
#my $billing_invoice_download_get_billing_invoice_id = undef; # replace NULL with a proper value
#my $billing_invoice_download_get_result = $api->billing_invoice_download_get(ad_account_id => $billing_invoice_download_get_ad_account_id, billing_invoice_id => $billing_invoice_download_get_billing_invoice_id);

#
# billing_invoices_get test
#
# uncomment below and update the test
#my $billing_invoices_get_ad_account_id = undef; # replace NULL with a proper value
#my $billing_invoices_get_bookmark = undef; # replace NULL with a proper value
#my $billing_invoices_get_page_size = undef; # replace NULL with a proper value
#my $billing_invoices_get_sort = undef; # replace NULL with a proper value
#my $billing_invoices_get_order = undef; # replace NULL with a proper value
#my $billing_invoices_get_status = undef; # replace NULL with a proper value
#my $billing_invoices_get_document_type = undef; # replace NULL with a proper value
#my $billing_invoices_get_start_due_date = undef; # replace NULL with a proper value
#my $billing_invoices_get_end_due_date = undef; # replace NULL with a proper value
#my $billing_invoices_get_result = $api->billing_invoices_get(ad_account_id => $billing_invoices_get_ad_account_id, bookmark => $billing_invoices_get_bookmark, page_size => $billing_invoices_get_page_size, sort => $billing_invoices_get_sort, order => $billing_invoices_get_order, status => $billing_invoices_get_status, document_type => $billing_invoices_get_document_type, start_due_date => $billing_invoices_get_start_due_date, end_due_date => $billing_invoices_get_end_due_date);
