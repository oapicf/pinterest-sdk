...
#my $pins_get_result = $api->pins_get(pin_id => $pins_get_pin_id, ad_account_id => $pins_get_ad_account_id, pin_metrics => $pins_get_pin_metrics);
...
#my $pins_list_result = $api->pins_list(pin_filter => $pins_list_pin_filter, pin_metrics => $pins_list_pin_metrics, include_protected_pins => $pins_list_include_protected_pins, pin_type => $pins_list_pin_type, creative_types => $pins_list_creative_types, ad_account_id => $pins_list_ad_account_id, bookmark => $pins_list_bookmark, page_size => $pins_list_page_size);
