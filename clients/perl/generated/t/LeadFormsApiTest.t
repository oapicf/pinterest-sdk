...
#
# lead_forms_create test
#
# uncomment below and update the test
#my $lead_forms_create_ad_account_id = undef; # replace NULL with a proper value
#my $lead_forms_create_lead_form_create_request = undef; # replace NULL with a proper value
#my $lead_forms_create_result = $api->lead_forms_create(ad_account_id => $lead_forms_create_ad_account_id, lead_form_create_request => $lead_forms_create_lead_form_create_request);
...
#
# lead_forms_update test
#
# uncomment below and update the test
#my $lead_forms_update_ad_account_id = undef; # replace NULL with a proper value
#my $lead_forms_update_lead_form_update_request = undef; # replace NULL with a proper value
#my $lead_forms_update_result = $api->lead_forms_update(ad_account_id => $lead_forms_update_ad_account_id, lead_form_update_request => $lead_forms_update_lead_form_update_request);
