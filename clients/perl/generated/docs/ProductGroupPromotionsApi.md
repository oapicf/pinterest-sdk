...
> ProductGroupPromotions product_group_promotions_create(ad_account_id => $ad_account_id, product_group_promotions_create => $product_group_promotions_create)
...
my $product_group_promotions_create = WWW::OpenAPIClient::Object::ProductGroupPromotionsCreate->new(); # ProductGroupPromotionsCreate | 

eval {
    my $result = $api_instance->product_group_promotions_create(ad_account_id => $ad_account_id, product_group_promotions_create => $product_group_promotions_create);
    print Dumper($result);
};
if ($@) {
...
> ProductGroupPromotion product_group_promotions_get(ad_account_id => $ad_account_id, product_group_promotion_id => $product_group_promotion_id)
...
> ProductGroupPromotionsList200Response product_group_promotions_list(ad_account_id => $ad_account_id, bookmark => $bookmark, page_size => $page_size, order => $order, product_group_promotion_ids => $product_group_promotion_ids, entity_statuses => $entity_statuses, ad_group_id => $ad_group_id)
...
eval {
    my $result = $api_instance->product_group_promotions_list(ad_account_id => $ad_account_id, bookmark => $bookmark, page_size => $page_size, order => $order, product_group_promotion_ids => $product_group_promotion_ids, entity_statuses => $entity_statuses, ad_group_id => $ad_group_id);
    print Dumper($result);
};
if ($@) {
...
> ProductGroupPromotions product_group_promotions_update(ad_account_id => $ad_account_id, product_group_promotions_update_with_required_body => $product_group_promotions_update_with_required_body)
...
my $ad_account_id = "ad_account_id_example"; # string | Unique identifier of an ad account.
my $product_group_promotions_update_with_required_body = WWW::OpenAPIClient::Object::ProductGroupPromotionsUpdateWithRequiredBody->new(); # ProductGroupPromotionsUpdateWithRequiredBody | 

eval {
    my $result = $api_instance->product_group_promotions_update(ad_account_id => $ad_account_id, product_group_promotions_update_with_required_body => $product_group_promotions_update_with_required_body);
    print Dumper($result);
};
if ($@) {
...
> ARRAY[ProductGroupAnalyticsItems] product_groups_analytics(start_date => $start_date, end_date => $end_date, product_group_ids => $product_group_ids, columns => $columns, granularity => $granularity, ad_account_id => $ad_account_id, click_window_days => $click_window_days, engagement_window_days => $engagement_window_days, view_window_days => $view_window_days, conversion_report_time => $conversion_report_time, reporting_timezone => $reporting_timezone)
...
eval {
    my $result = $api_instance->product_groups_analytics(start_date => $start_date, end_date => $end_date, product_group_ids => $product_group_ids, columns => $columns, granularity => $granularity, ad_account_id => $ad_account_id, click_window_days => $click_window_days, engagement_window_days => $engagement_window_days, view_window_days => $view_window_days, conversion_report_time => $conversion_report_time, reporting_timezone => $reporting_timezone);
    print Dumper($result);
};
if ($@) {
