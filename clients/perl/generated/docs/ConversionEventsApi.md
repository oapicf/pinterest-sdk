...
# **events_create**
> ConversionEvents events_create(ad_account_id => $ad_account_id, conversion_events_create => $conversion_events_create, test => $test)
...
my $conversion_events_create = WWW::OpenAPIClient::Object::ConversionEventsCreate->new(); # ConversionEventsCreate | 
...
eval {
    my $result = $api_instance->events_create(ad_account_id => $ad_account_id, conversion_events_create => $conversion_events_create, test => $test);
    print Dumper($result);
};
if ($@) {
