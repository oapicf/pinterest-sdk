# WWW::OpenAPIClient::Object::TrendingTopic
...
**time_series** | **HASH[string,double]** | Time series data showing trend values over time, with dates as keys and values as numeric | 
