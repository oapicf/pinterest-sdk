# WWW::OpenAPIClient::Object::BillingInvoiceResponse

## Load the model package
```perl
use WWW::OpenAPIClient::Object::BillingInvoiceResponse;
```
...
**document_type** | **string** | The type of the document | [optional] 
