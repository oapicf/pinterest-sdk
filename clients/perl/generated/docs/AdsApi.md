...
# **ads_analytics**
> ARRAY[AdsAnalyticsResponseInner] ads_analytics(ad_account_id => $ad_account_id, start_date => $start_date, end_date => $end_date, columns => $columns, granularity => $granularity, ad_ids => $ad_ids, click_window_days => $click_window_days, engagement_window_days => $engagement_window_days, view_window_days => $view_window_days, conversion_report_time => $conversion_report_time, pin_ids => $pin_ids, campaign_ids => $campaign_ids, reporting_timezone => $reporting_timezone)
...
eval {
    my $result = $api_instance->ads_analytics(ad_account_id => $ad_account_id, start_date => $start_date, end_date => $end_date, columns => $columns, granularity => $granularity, ad_ids => $ad_ids, click_window_days => $click_window_days, engagement_window_days => $engagement_window_days, view_window_days => $view_window_days, conversion_report_time => $conversion_report_time, pin_ids => $pin_ids, campaign_ids => $campaign_ids, reporting_timezone => $reporting_timezone);
    print Dumper($result);
};
if ($@) {
