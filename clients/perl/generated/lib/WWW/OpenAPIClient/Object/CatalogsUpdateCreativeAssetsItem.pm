...
#
package WWW::OpenAPIClient::Object::CatalogsUpdateCreativeAssetsItem;
...
__PACKAGE__->class_documentation({description => 'A creative assets item to be updated.',
...
__PACKAGE__->method_documentation({
    'attributes' => {
        datatype => 'CatalogsUpdatableCreativeAssetsAttributes',
