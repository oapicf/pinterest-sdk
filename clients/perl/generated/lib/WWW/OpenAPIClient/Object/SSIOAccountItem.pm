...
#
package WWW::OpenAPIClient::Object::SSIOAccountItem;
...
__PACKAGE__->class_documentation({description => 'Salesforce account item with billing and terms information.',
...
__PACKAGE__->method_documentation({
    'addresses' => {
        datatype => 'ARRAY[SSIOAccountAddress]',
        base_name => 'addresses',
