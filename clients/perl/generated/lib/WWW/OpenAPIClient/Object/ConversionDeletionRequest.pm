...
#
package WWW::OpenAPIClient::Object::ConversionDeletionRequest;
...
__PACKAGE__->class_documentation({description => 'Conversion deletion request',
...
__PACKAGE__->method_documentation({
    ...
    'status' => {
        datatype => 'ConversionDeletionRequestStatus',
        base_name => 'status',
