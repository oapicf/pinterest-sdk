...
#
package WWW::OpenAPIClient::Object::CatalogsRetailListProductsByCatalogBasedFilterRequest;
...
__PACKAGE__->class_documentation({description => 'Request object to list products for a given retail catalog_id and product group filter.',
...
__PACKAGE__->method_documentation({
    ...
    'filters' => {
        datatype => 'CatalogsProductGroupFilters',
        base_name => 'filters',
        description => '',
        format => '',
        read_only => '',
