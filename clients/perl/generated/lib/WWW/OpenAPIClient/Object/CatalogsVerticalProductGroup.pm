...
#
package WWW::OpenAPIClient::Object::CatalogsVerticalProductGroup;
...
__PACKAGE__->method_documentation({
    ...
    'status' => {
        datatype => 'CatalogsProductGroupStatus',
        base_name => 'status',
        description => '',
        format => '',
        read_only => '',
    ...
    'type' => {
        datatype => 'CatalogsHotelProductGroupType',
        base_name => 'type',
        description => '',
        format => '',
        read_only => '',
