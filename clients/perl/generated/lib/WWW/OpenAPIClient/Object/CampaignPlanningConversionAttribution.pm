...
#
package WWW::OpenAPIClient::Object::CampaignPlanningConversionAttribution;
...
__PACKAGE__->class_documentation({description => 'Attribution windows for a conversion event.',
...
__PACKAGE__->method_documentation({
    'click_window_days' => {
        datatype => 'CampaignPlanningConversionAttributionWindowDays',
