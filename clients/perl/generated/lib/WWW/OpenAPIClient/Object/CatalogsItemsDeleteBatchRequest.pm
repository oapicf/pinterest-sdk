...
#
package WWW::OpenAPIClient::Object::CatalogsItemsDeleteBatchRequest;
...
__PACKAGE__->class_documentation({description => 'Request object to delete catalogs items',
...
__PACKAGE__->method_documentation({
    ...
    'items' => {
        datatype => 'ARRAY[ItemDeleteBatchRecord]',
        base_name => 'items',
