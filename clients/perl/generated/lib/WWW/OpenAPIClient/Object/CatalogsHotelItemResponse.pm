...
#
package WWW::OpenAPIClient::Object::CatalogsHotelItemResponse;
...
__PACKAGE__->class_documentation({description => 'Object describing a hotel record',
...
__PACKAGE__->method_documentation({
    'attributes' => {
        datatype => 'CatalogsHotelAttributes',
