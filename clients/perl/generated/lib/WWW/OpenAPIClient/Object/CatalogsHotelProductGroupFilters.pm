...
#
package WWW::OpenAPIClient::Object::CatalogsHotelProductGroupFilters;
...
__PACKAGE__->class_documentation({description => 'Object holding a group of filters for a hotel product group',
...
__PACKAGE__->method_documentation({
    'any_of' => {
        datatype => 'ARRAY[CatalogsHotelProductGroupFilterKeys]',
        base_name => 'any_of',
        description => '',
        format => '',
        read_only => '',
