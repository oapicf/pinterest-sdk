...
#
package WWW::OpenAPIClient::Object::CatalogsRetailFilterValuesMap;
...
__PACKAGE__->class_documentation({description => 'A map of filter attributes to their available values.',
...
__PACKAGE__->method_documentation({
    ...
    'ad_video_tags' => {
        datatype => 'ARRAY[string]',
        base_name => 'ad_video_tags',
        description => '',
        format => '',
        read_only => '',
            },
    'availability' => {
        datatype => 'ARRAY[ProductAvailability]',
    ...
    'condition' => {
        datatype => 'ARRAY[ProductCondition]',
        base_name => 'condition',
        description => '',
        format => '',
        read_only => '',
