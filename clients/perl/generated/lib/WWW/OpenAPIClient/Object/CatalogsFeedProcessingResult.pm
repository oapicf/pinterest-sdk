...
#
package WWW::OpenAPIClient::Object::CatalogsFeedProcessingResult;
...
__PACKAGE__->method_documentation({
    ...
    'ingestion_details' => {
        datatype => 'CatalogsFeedIngestionDetails',
        base_name => 'ingestion_details',
        description => '',
        format => '',
        read_only => '',
            },
    'product_counts' => {
        datatype => 'CatalogsFeedProductCounts',
        base_name => 'product_counts',
        description => '',
        format => '',
        read_only => '',
            },
    'status' => {
        datatype => 'CatalogsFeedProcessingStatus',
        base_name => 'status',
        description => '',
        format => '',
        read_only => '',
    ...
    'validation_details' => {
        datatype => 'CatalogsFeedValidationDetails',
        base_name => 'validation_details',
        description => '',
        format => '',
        read_only => '',
            },
    'video_counts' => {
        datatype => 'CatalogsFeedVideoCounts',
        base_name => 'video_counts',
        description => '',
        format => '',
        read_only => '',
            },
