...
#
package WWW::OpenAPIClient::Object::CatalogsItemsCreateBatchRequest;
...
__PACKAGE__->class_documentation({description => 'Request object to create catalogs items',
...
__PACKAGE__->method_documentation({
    ...
    'items' => {
        datatype => 'ARRAY[ItemCreateBatchRecord]',
        base_name => 'items',
