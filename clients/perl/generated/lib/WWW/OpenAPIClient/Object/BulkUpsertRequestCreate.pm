...
#
package WWW::OpenAPIClient::Object::BulkUpsertRequestCreate;
...
__PACKAGE__->method_documentation({
    ...
    'catalog_product_groups' => {
        datatype => 'ARRAY[BulkUpsertRequestCreateCatalogProductGroupsItems]',
    ...
    'keywords' => {
        datatype => 'ARRAY[KeywordsRequest]',
        base_name => 'keywords',
        description => '',
        format => '',
        read_only => '',
    ...
    'labels' => {
        datatype => 'ARRAY[LabelBulkCreateRequest]',
        base_name => 'labels',
        description => '',
        format => '',
        read_only => '',
    ...
    'product_groups' => {
        datatype => 'ARRAY[ProductGroupPromotionCreateRequest]',
    ...
    'schedules' => {
        datatype => 'ARRAY[ScheduleCreateRequest]',
        base_name => 'schedules',
        description => '',
        format => '',
        read_only => '',
