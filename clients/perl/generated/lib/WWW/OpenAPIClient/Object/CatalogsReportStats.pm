...
#
package WWW::OpenAPIClient::Object::CatalogsReportStats;
...
__PACKAGE__->class_documentation({description => 'Diagnostics aggregated numbers',
...
__PACKAGE__->method_documentation({
    ...
    'ineligible_for_organic' => {
        datatype => 'boolean',
        base_name => 'ineligible_for_organic',
