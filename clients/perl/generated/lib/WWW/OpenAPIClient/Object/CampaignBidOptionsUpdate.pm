...
#
package WWW::OpenAPIClient::Object::CampaignBidOptionsUpdate;
...
__PACKAGE__->class_documentation({description => 'Object describing an update to the campaign level bid multipliers.',
...
__PACKAGE__->method_documentation({
    'age_bucket_multipliers' => {
        datatype => 'AgeBucketMultipliers',
        base_name => 'age_bucket_multipliers',
        description => 'Age bucket multipliers for bid adjustments.',
        format => '',
        read_only => '',
            },
    'app_type_multipliers' => {
        datatype => 'AppTypeMultipliers',
        base_name => 'app_type_multipliers',
        description => 'App type multipliers for bid adjustments.',
        format => '',
        read_only => '',
            },
    'audience_multipliers' => {
        datatype => 'CampaignAudienceMultipliers',
        base_name => 'audience_multipliers',
        description => 'Audience multipliers for bid adjustments.',
        format => '',
        read_only => '',
            },
    'freq_bid_multiplier_time_window' => {
        datatype => 'FreqBidMultiplierTimeWindow',
        base_name => 'freq_bid_multiplier_time_window',
        description => 'The time window for frequency bid multipliers.',
        format => '',
        read_only => '',
            },
    'frequency_multipliers' => {
        datatype => 'FrequencyMultipliers',
        base_name => 'frequency_multipliers',
        description => 'Frequency multipliers for bid adjustments.',
        format => '',
        read_only => '',
            },
    'gender_multipliers' => {
        datatype => 'GenderMultipliers',
        base_name => 'gender_multipliers',
        description => 'Gender multipliers for bid adjustments.',
        format => '',
        read_only => '',
            },
    'placement_multipliers' => {
        datatype => 'PlacementMultipliers',
        base_name => 'placement_multipliers',
        description => 'Placement multipliers for bid adjustments.',
        format => '',
        read_only => '',
            },
    'update_mask' => {
        datatype => 'ARRAY[CampaignBidOptionsUpdateMaskItems]',
        base_name => 'update_mask',
