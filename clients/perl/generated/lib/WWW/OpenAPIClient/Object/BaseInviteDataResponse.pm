...
#
package WWW::OpenAPIClient::Object::BaseInviteDataResponse;
...
__PACKAGE__->class_documentation({description => 'Common invite/request data returned by the business access endpoints.',
