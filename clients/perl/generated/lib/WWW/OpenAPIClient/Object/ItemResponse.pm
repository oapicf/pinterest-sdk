...
#
package WWW::OpenAPIClient::Object::ItemResponse;
...
__PACKAGE__->class_documentation({description => 'Object describing an item record or error. Discriminated by &#x60;item_response_kind&#x60; (one unique value per leaf).',
                                  class => 'ItemResponse',
                                  required => [], # TODO
}                                 );
...
__PACKAGE__->method_documentation({
    'attributes' => {
        datatype => 'CatalogsCreativeAssetsAttributes',
