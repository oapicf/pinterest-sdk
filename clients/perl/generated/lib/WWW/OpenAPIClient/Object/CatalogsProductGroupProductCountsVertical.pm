...
#
package WWW::OpenAPIClient::Object::CatalogsProductGroupProductCountsVertical;
...
__PACKAGE__->class_documentation({description => 'Product counts for a CatalogsProductGroup',
