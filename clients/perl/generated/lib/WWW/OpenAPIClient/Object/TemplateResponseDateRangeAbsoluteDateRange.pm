...
#
package WWW::OpenAPIClient::Object::TemplateResponseDateRangeAbsoluteDateRange;
...
__PACKAGE__->class_documentation({description => 'The absolute date range of the template',
