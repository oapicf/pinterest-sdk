...
#
package WWW::OpenAPIClient::Object::CatalogsCreativeAssetsProductGroupFilters;
...
__PACKAGE__->class_documentation({description => 'Object holding a group of filters for a creative assets product group',
...
__PACKAGE__->method_documentation({
    'any_of' => {
        datatype => 'ARRAY[CatalogsCreativeAssetsProductGroupFilterKeys]',
        base_name => 'any_of',
        description => '',
        format => '',
        read_only => '',
