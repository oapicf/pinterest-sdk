...
#
package WWW::OpenAPIClient::Object::TemplateResponseDateRange;
...
__PACKAGE__->method_documentation({
    'absolute_date_range' => {
        datatype => 'TemplateResponseDateRangeAbsoluteDateRange',
        base_name => 'absolute_date_range',
        description => '',
        format => '',
        read_only => '',
            },
    'dynamic_date_range' => {
        datatype => 'TemplateResponseDateRangeDynamicDateRange',
        base_name => 'dynamic_date_range',
        description => '',
        format => '',
        read_only => '',
            },
    'relative_date_range' => {
        datatype => 'TemplateResponseDateRangeRelativeDateRange',
        base_name => 'relative_date_range',
        description => '',
        format => '',
        read_only => '',
            },
