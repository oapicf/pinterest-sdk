...
#
package WWW::OpenAPIClient::Object::AdvancedAuctionItemsSubmitRecord;
...
__PACKAGE__->class_documentation({description => 'Object describing an item bid option operation',
