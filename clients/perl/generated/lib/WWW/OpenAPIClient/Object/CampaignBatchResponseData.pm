...
#
package WWW::OpenAPIClient::Object::CampaignBatchResponseData;
...
__PACKAGE__->class_documentation({description => 'Campaign data in batch response, with all fields optional to support error cases where data may be empty.',
...
__PACKAGE__->method_documentation({
    ...
    'bid_options' => {
        datatype => 'CampaignBidOptions',
        base_name => 'bid_options',
        description => '[Restricted](/docs/getting-started/using-beta-and-restricted-features/)  Object describing the campaign level bid multipliers.',
        format => '',
        read_only => '',
            },
    'created_time' => {
    ...
    'objective_type' => {
        datatype => 'CampaignObjectiveType',
