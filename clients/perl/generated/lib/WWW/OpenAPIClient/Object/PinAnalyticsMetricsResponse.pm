...
#
package WWW::OpenAPIClient::Object::PinAnalyticsMetricsResponse;
...
__PACKAGE__->method_documentation({
    'daily_metrics' => {
        datatype => 'ARRAY[PinAnalyticsDailyMetrics]',
        base_name => 'daily_metrics',
...
__PACKAGE__->openapi_types( {
    ...
    'lifetime_metrics' => 'HASH[string,int]',
    'summary_metrics' => 'HASH[string,double]'
} );
