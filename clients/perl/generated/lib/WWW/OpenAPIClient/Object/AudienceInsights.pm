...
#
package WWW::OpenAPIClient::Object::AudienceInsights;
...
__PACKAGE__->class_documentation({description => 'Audience interests and demographics.',
...
__PACKAGE__->method_documentation({
    'categories' => {
        datatype => 'ARRAY[AudienceCategory]',
