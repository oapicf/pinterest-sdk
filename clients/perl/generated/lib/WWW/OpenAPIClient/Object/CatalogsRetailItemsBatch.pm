...
#
package WWW::OpenAPIClient::Object::CatalogsRetailItemsBatch;
...
__PACKAGE__->class_documentation({description => 'Object describing the catalogs retail items batch',
...
__PACKAGE__->method_documentation({
    ...
    'items' => {
        datatype => 'ARRAY[ItemProcessingRecord]',
        base_name => 'items',
