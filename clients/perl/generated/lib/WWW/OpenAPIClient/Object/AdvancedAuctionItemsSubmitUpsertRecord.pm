...
#
package WWW::OpenAPIClient::Object::AdvancedAuctionItemsSubmitUpsertRecord;
...
__PACKAGE__->class_documentation({description => 'Object describing an item bid option upsert operation',
...
__PACKAGE__->method_documentation({
    'bid_options' => {
        datatype => 'AdvancedAuctionBidOptions',
    ...
    'errors' => {
        datatype => 'ARRAY[AdvancedAuctionOperationError]',
        base_name => 'errors',
    ...
    'update_mask' => {
        datatype => 'ARRAY[UpdateMaskBidOptionField]',
