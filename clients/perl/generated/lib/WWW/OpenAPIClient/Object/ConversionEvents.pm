...
#
package WWW::OpenAPIClient::Object::ConversionEvents;
...
__PACKAGE__->class_documentation({description => 'Conversion events.',
...
__PACKAGE__->method_documentation({
    'events' => {
        datatype => 'ARRAY[ConversionApiResponseEventsItems]',
        base_name => 'events',
    ...
    'num_events_processed' => {
        datatype => 'int',
        base_name => 'num_events_processed',
