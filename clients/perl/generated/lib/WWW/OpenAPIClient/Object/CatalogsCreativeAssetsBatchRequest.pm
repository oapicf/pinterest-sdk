...
#
package WWW::OpenAPIClient::Object::CatalogsCreativeAssetsBatchRequest;
...
__PACKAGE__->class_documentation({description => 'Request object to update catalogs creative assets items',
