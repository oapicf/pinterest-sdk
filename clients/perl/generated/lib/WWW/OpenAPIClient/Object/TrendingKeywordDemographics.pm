...
#
package WWW::OpenAPIClient::Object::TrendingKeywordDemographics;
...
__PACKAGE__->method_documentation({
    'age_distribution' => {
        datatype => 'TrendingKeywordDemographicsAgeDistribution',
        base_name => 'age_distribution',
        description => '',
        format => '',
        read_only => '',
            },
    'gender_distribution' => {
        datatype => 'TrendingKeywordDemographicsGenderDistribution',
