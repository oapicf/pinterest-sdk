...
#
package WWW::OpenAPIClient::Object::IntegrationLogClientError;
...
__PACKAGE__->class_documentation({description => 'System error details included in the log sent by the client.',
