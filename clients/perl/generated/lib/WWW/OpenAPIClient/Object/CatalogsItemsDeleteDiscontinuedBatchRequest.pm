...
#
package WWW::OpenAPIClient::Object::CatalogsItemsDeleteDiscontinuedBatchRequest;
...
__PACKAGE__->class_documentation({description => 'Request object to discontinue catalogs items',
...
__PACKAGE__->method_documentation({
    ...
    'items' => {
        datatype => 'ARRAY[ItemDeleteDiscontinuedBatchRecord]',
        base_name => 'items',
