...
#
package WWW::OpenAPIClient::Object::AdvancedAuctionItemsSubmitRequest;
...
__PACKAGE__->class_documentation({description => 'Request containing operations to perform on bid prices and bid multipliers for a batch of retail catalog items',
...
__PACKAGE__->method_documentation({
    ...
    'items' => {
        datatype => 'ARRAY[AdvancedAuctionItemsSubmitRecord]',
        base_name => 'items',
