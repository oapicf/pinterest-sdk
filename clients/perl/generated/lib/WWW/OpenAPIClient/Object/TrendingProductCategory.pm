...
#
package WWW::OpenAPIClient::Object::TrendingProductCategory;
...
__PACKAGE__->class_documentation({description => 'Trending shopping product category',
...
__PACKAGE__->method_documentation({
    ...
    'percent_relative_volume' => {
        datatype => 'int',
        base_name => 'percent_relative_volume',
    ...
    'pinterest_product_category_id' => {
        datatype => 'int',
        base_name => 'pinterest_product_category_id',
