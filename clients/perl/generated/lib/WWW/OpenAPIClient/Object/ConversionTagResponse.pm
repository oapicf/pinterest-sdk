...
#
package WWW::OpenAPIClient::Object::ConversionTagResponse;
...
__PACKAGE__->method_documentation({
    'code_snippet' => {
        datatype => 'string',
        base_name => 'code_snippet',
        description => 'Tag code snippet.',
        format => '',
        read_only => '',
            },
    'configs' => {
        datatype => 'ConversionTagConfigs',
        base_name => 'configs',
        description => '',
        format => '',
        read_only => '',
    ...
    'enhanced_match_status' => {
        datatype => 'EnhancedMatchStatusType',
        base_name => 'enhanced_match_status',
