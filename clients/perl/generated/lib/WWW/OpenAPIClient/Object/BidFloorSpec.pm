...
#
package WWW::OpenAPIClient::Object::BidFloorSpec;
...
__PACKAGE__->class_documentation({description => 'Bid floor specification for a given campaign configuration.',
                                  class => 'BidFloorSpec',
                                  required => [], # TODO
}                                 );
...
__PACKAGE__->method_documentation({
    ...
    'objective_type' => {
        datatype => 'BidFloorObjectiveType',
