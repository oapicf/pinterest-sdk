...
#
package WWW::OpenAPIClient::Object::BulkCampaignDeliveryEstimatesResponse;
...
__PACKAGE__->class_documentation({description => 'Bulk campaign delivery estimates response.',
...
__PACKAGE__->method_documentation({
    'data' => {
        datatype => 'ARRAY[BulkCampaignDeliveryEstimatesItem]',
        base_name => 'data',
