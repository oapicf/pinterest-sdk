...
#
package WWW::OpenAPIClient::Object::LeadFormQuestion;
...
__PACKAGE__->method_documentation({
    'custom_question_field_type' => {
        datatype => 'LeadFormQuestionFieldType',
        base_name => 'custom_question_field_type',
        description => '',
        format => '',
        read_only => '',
            },
    'custom_question_label' => {
        datatype => 'string',
        base_name => 'custom_question_label',
    ...
    'custom_question_options' => {
        ...
        base_name => 'custom_question_options',
        description => 'Question options for a custom question.',
        format => '',
        read_only => '',
            },
    'question_type' => {
        datatype => 'LeadFormQuestionType',
        base_name => 'question_type',
        description => '',
        format => '',
        read_only => '',
            },
