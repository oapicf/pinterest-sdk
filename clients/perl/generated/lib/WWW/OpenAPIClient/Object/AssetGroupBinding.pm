...
#
package WWW::OpenAPIClient::Object::AssetGroupBinding;
...
__PACKAGE__->method_documentation({
    ...
    'asset_group_description' => {
        datatype => 'string',
        base_name => 'asset_group_description',
