...
#
package WWW::OpenAPIClient::Object::IntegrationMetadataCreate;
...
__PACKAGE__->method_documentation({
    ...
    'connected_advertiser_id' => {
        datatype => 'string',
        base_name => 'connected_advertiser_id',
        description => '',
        format => '',
        read_only => '',
            },
    ...
    'connected_merchant_id' => {
        datatype => 'string',
        base_name => 'connected_merchant_id',
        description => '',
        format => '',
        read_only => '',
            },
    ...
    'partner_access_token_expiry' => {
        datatype => 'double',
        base_name => 'partner_access_token_expiry',
        description => '',
        format => '',
        read_only => '',
            },
    ...
    'partner_primary_email' => {
        datatype => 'string',
        base_name => 'partner_primary_email',
        description => '',
        format => '',
        read_only => '',
            },
    ...
    'partner_refresh_token_expiry' => {
        datatype => 'double',
        base_name => 'partner_refresh_token_expiry',
        description => '',
        format => '',
        read_only => '',
            },
