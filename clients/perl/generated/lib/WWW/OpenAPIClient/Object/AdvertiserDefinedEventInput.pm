...
#
package WWW::OpenAPIClient::Object::AdvertiserDefinedEventInput;
...
__PACKAGE__->class_documentation({description => 'Advertiser defined event input for create/update operations',
...
__PACKAGE__->method_documentation({
    'mapped_conversion_type' => {
        datatype => 'AdvertiserDefinedEventMappingType',
        base_name => 'mapped_conversion_type',
