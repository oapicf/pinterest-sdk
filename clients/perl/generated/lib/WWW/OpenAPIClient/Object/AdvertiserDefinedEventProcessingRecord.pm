...
#
package WWW::OpenAPIClient::Object::AdvertiserDefinedEventProcessingRecord;
...
__PACKAGE__->class_documentation({description => 'Processing record for an advertiser defined event operation',
