...
#
package WWW::OpenAPIClient::Object::AdvancedAuctionBidOptions;
...
__PACKAGE__->class_documentation({description => 'Object describing a retail catalog item&#39;s bid options (bid price and bid multipliers).',
