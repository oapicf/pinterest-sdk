...
#
package WWW::OpenAPIClient::Object::CatalogsRetailFeedsCreateRequest;
...
__PACKAGE__->class_documentation({description => 'Request object for creating a retail feed.',
...
__PACKAGE__->method_documentation({
    'catalog_id' => {
        ...
        description => 'Catalog id pertaining to the feed. If not provided, feed will use a default catalog based on type. Currently, this field has no effect.',
        format => '',
        read_only => '',
            },
    'catalog_type' => {
