...
#
package WWW::OpenAPIClient::Object::SSIOAccount;
...
__PACKAGE__->class_documentation({description => 'Salesforce account details including bill-to information.',
                                  class => 'SSIOAccount',
                                  required => [], # TODO
}                                 );
...
__PACKAGE__->method_documentation({
    'billto_infos' => {
        datatype => 'ARRAY[SSIOAccountItem]',
        base_name => 'billto_infos',
    ...
    'pmp_names' => {
        datatype => 'ARRAY[SSIOAccountPMPName]',
        base_name => 'pmp_names',
        description => '',
        format => '',
        read_only => '',
