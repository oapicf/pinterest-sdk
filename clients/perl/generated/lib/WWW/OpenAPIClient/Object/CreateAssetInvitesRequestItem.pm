...
#
package WWW::OpenAPIClient::Object::CreateAssetInvitesRequestItem;
...
__PACKAGE__->class_documentation({description => 'Object declaring an asset role update to an invite.',
...
__PACKAGE__->method_documentation({
    'asset_id_to_permissions' => {
        datatype => 'HASH[string,ARRAY[Permissions]]',
        base_name => 'asset_id_to_permissions',
