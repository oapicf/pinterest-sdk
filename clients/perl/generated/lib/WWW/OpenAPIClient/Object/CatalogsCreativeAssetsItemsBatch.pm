...
#
package WWW::OpenAPIClient::Object::CatalogsCreativeAssetsItemsBatch;
...
__PACKAGE__->class_documentation({description => 'Object describing the catalogs creative assets items batch',
...
__PACKAGE__->method_documentation({
    ...
    'items' => {
        datatype => 'ARRAY[CreativeAssetsProcessingRecord]',
        base_name => 'items',
