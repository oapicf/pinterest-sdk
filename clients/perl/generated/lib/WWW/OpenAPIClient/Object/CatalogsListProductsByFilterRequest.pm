...
#
package WWW::OpenAPIClient::Object::CatalogsListProductsByFilterRequest;
...
__PACKAGE__->class_documentation({description => 'Request object to list products for a given product group filter.',
