...
#
package WWW::OpenAPIClient::Object::ItemUpdateBatchRecord;
...
__PACKAGE__->class_documentation({description => 'Object describing an item batch record to update items',
...
__PACKAGE__->method_documentation({
    'attributes' => {
        datatype => 'UpdatableItemAttributes',
    ...
    'update_mask' => {
        datatype => 'ARRAY[UpdateMaskFieldType]',
