...
#
package WWW::OpenAPIClient::Object::CatalogsRetailReportAllItemsFilter;
...
__PACKAGE__->class_documentation({description => 'ALL_ITEMS filter for retail catalogs. Optional product_group_id scopes the report to items in that product group. If omitted, all items are included.',
