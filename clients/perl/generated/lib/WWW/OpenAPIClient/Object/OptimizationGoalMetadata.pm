...
__PACKAGE__->method_documentation({
    'conversion_tag_v3_goal_metadata' => {
        datatype => 'OptimizationGoalMetadataConversionTagV3GoalMetadata',
    ...
    'frequency_goal_metadata' => {
        datatype => 'OptimizationGoalMetadataFrequencyGoalMetadata',
    ...
    'scrollup_goal_metadata' => {
        datatype => 'OptimizationGoalMetadataScrollupGoalMetadata',
