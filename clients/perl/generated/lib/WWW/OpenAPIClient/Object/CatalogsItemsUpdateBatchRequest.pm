...
#
package WWW::OpenAPIClient::Object::CatalogsItemsUpdateBatchRequest;
...
__PACKAGE__->class_documentation({description => 'Request object to update catalogs items',
...
__PACKAGE__->method_documentation({
    ...
    'items' => {
        datatype => 'ARRAY[ItemUpdateBatchRecord]',
        base_name => 'items',
