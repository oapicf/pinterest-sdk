...
#
package WWW::OpenAPIClient::Object::MediaUpload;
...
__PACKAGE__->class_documentation({description => 'Media upload that has been registered but not uploaded/processed yet.',
                                  class => 'MediaUpload',
                                  required => [], # TODO
}                                 );
...
__PACKAGE__->method_documentation({
    ...
    'upload_parameters' => {
        datatype => 'MediaUploadParameters',
        base_name => 'upload_parameters',
