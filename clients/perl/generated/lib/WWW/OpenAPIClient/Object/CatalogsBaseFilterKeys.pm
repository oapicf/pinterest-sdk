...
#
package WWW::OpenAPIClient::Object::CatalogsBaseFilterKeys;
...
__PACKAGE__->class_documentation({description => 'Base filter keys shared across catalog filtering',
...
__PACKAGE__->method_documentation({
    ...
    'pinterest_product_categories' => {
        datatype => 'CatalogsProductGroupMultiplePinterestProductCategoryCriteria',
        base_name => 'PINTEREST_PRODUCT_CATEGORIES',
        description => '',
        format => '',
        read_only => '',
            },
