...
#
package WWW::OpenAPIClient::Object::CartingProduct;
...
__PACKAGE__->method_documentation({
    ...
    'display_preferred_retailers_only' => {
        datatype => 'boolean',
        base_name => 'display_preferred_retailers_only',
    ...
    'display_product_price' => {
        datatype => 'boolean',
        base_name => 'display_product_price',
        description => 'Whether to display the price for the carting product',
        format => '',
        read_only => '',
            },
    'preferred_retailers' => {
        datatype => 'ARRAY[CartingRetailer]',
        base_name => 'preferred_retailers',
    ...
    'randomize_preferred_retailers' => {
        datatype => 'boolean',
        base_name => 'randomize_preferred_retailers',
