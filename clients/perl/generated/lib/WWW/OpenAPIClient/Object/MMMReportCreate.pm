...
#
package WWW::OpenAPIClient::Object::MMMReportCreate;
...
__PACKAGE__->method_documentation({
    'advertiser_ids' => {
        ...
        base_name => 'advertiser_ids',
        description => 'Advertiser IDs for multi-advertiser report',
        format => '',
        read_only => '',
            },
    'columns' => {
        datatype => 'ARRAY[MMMReportingColumn]',
        base_name => 'columns',
    ...
    'countries' => {
        datatype => 'ARRAY[TargetingAdvertiserCountry]',
        base_name => 'countries',
    ...
    'granularity' => {
        datatype => 'MMMReportGranularity',
        base_name => 'granularity',
        description => '  DAY - metrics are broken down daily.    WEEK - metrics are broken down weekly.',
        format => '',
        read_only => '',
            },
    'level' => {
        datatype => 'MMMReportLevel',
        base_name => 'level',
    ...
    'targeting_types' => {
        datatype => 'ARRAY[MMMReportingTargetingType]',
