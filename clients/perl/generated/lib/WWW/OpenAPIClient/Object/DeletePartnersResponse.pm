...
#
package WWW::OpenAPIClient::Object::DeletePartnersResponse;
...
__PACKAGE__->class_documentation({description => 'An object with a list of partners that were deleted.',
