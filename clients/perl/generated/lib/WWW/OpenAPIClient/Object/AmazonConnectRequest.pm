...
#
package WWW::OpenAPIClient::Object::AmazonConnectRequest;
...
__PACKAGE__->class_documentation({description => 'Request containing OTP and Amazon storefront info called by Amazon',
...
__PACKAGE__->method_documentation({
    'amazon_storefront_id' => {
        datatype => 'string',
        base_name => 'amazon_storefront_id',
    ...
    'amazon_storefront_name' => {
        datatype => 'string',
        base_name => 'amazon_storefront_name',
    ...
    'amazon_storefront_url' => {
        datatype => 'string',
        base_name => 'amazon_storefront_url',
    ...
    'is_amazon_account_linked' => {
        datatype => 'boolean',
        base_name => 'is_amazon_account_linked',
