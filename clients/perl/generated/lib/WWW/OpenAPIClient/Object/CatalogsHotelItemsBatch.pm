...
#
package WWW::OpenAPIClient::Object::CatalogsHotelItemsBatch;
...
__PACKAGE__->class_documentation({description => 'Object describing the catalogs hotel items batch. If specified, you must provide all properties.',
...
__PACKAGE__->method_documentation({
    ...
    'items' => {
        datatype => 'ARRAY[HotelProcessingRecord]',
        base_name => 'items',
