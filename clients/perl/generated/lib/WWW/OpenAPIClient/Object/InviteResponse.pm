...
#
package WWW::OpenAPIClient::Object::InviteResponse;
...
__PACKAGE__->class_documentation({description => 'A user&#39;s username or email OR a partner id that caused the error.',
...
__PACKAGE__->method_documentation({
    ...
    'invite_data' => {
        datatype => 'InviteDataResponse',
        base_name => 'invite_data',
        description => '',
        format => '',
        read_only => '',
            },
