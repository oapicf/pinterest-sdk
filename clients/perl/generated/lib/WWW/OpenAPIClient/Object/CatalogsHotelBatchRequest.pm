...
#
package WWW::OpenAPIClient::Object::CatalogsHotelBatchRequest;
...
__PACKAGE__->class_documentation({description => 'Request object to update catalogs hotel items',
...
__PACKAGE__->method_documentation({
    ...
    'items' => {
        datatype => 'ARRAY[CatalogsHotelBatchItem]',
        base_name => 'items',
