...
#
package WWW::OpenAPIClient::Object::DeletedMembersResponse;
...
__PACKAGE__->class_documentation({description => 'An object with a list of members that were deleted.',
