...
#
package WWW::OpenAPIClient::Object::CatalogsFeedIngestionDetails;
...
__PACKAGE__->method_documentation({
    'errors' => {
        datatype => 'CatalogsFeedIngestionErrors',
        base_name => 'errors',
        description => '',
        format => '',
        read_only => '',
    ...
    'info' => {
        datatype => 'CatalogsFeedIngestionInfo',
        base_name => 'info',
        description => '',
        format => '',
        read_only => '',
    ...
    'warnings' => {
        datatype => 'CatalogsFeedIngestionWarnings',
        base_name => 'warnings',
        description => '',
        format => '',
        read_only => '',
