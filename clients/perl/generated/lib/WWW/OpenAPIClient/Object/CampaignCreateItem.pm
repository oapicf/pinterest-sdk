...
#
package WWW::OpenAPIClient::Object::CampaignCreateItem;
...
__PACKAGE__->class_documentation({description => 'Single campaign create item with create-specific defaults.',
