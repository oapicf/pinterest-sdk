...
#
package WWW::OpenAPIClient::Object::AdvancedAuctionOperationError;
...
__PACKAGE__->class_documentation({description => 'Error which occurred when applying a bid options operation to a specific item.',
