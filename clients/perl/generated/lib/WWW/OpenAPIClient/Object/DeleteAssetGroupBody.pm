...
#
package WWW::OpenAPIClient::Object::DeleteAssetGroupBody;
...
__PACKAGE__->class_documentation({description => 'Request body used to delete asset groups',
...
__PACKAGE__->method_documentation({
    'asset_groups_to_delete' => {
        ...
        base_name => 'asset_groups_to_delete',
