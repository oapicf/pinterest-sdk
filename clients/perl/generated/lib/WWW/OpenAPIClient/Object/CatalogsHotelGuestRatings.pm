...
#
package WWW::OpenAPIClient::Object::CatalogsHotelGuestRatings;
...
__PACKAGE__->class_documentation({description => 'If specified, you must provide all properties',
