...
#
package WWW::OpenAPIClient::Object::CatalogsVerticalsListProductsByCatalogBasedFilterRequest;
...
__PACKAGE__->class_documentation({description => 'Request object to list products for a given catalog_id and product group filter.',
