...
#
package WWW::OpenAPIClient::Object::AdvertiserDefinedEvent;
...
__PACKAGE__->class_documentation({description => 'Advertiser defined event',
...
__PACKAGE__->method_documentation({
    'mapped_conversion_type' => {
        datatype => 'ConversionTagTypeOptimal',
