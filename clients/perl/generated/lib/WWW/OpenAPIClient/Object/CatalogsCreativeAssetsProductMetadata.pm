...
#
package WWW::OpenAPIClient::Object::CatalogsCreativeAssetsProductMetadata;
...
__PACKAGE__->class_documentation({description => 'Creative assets product metadata entity',
...
__PACKAGE__->method_documentation({
    ...
    'visibility' => {
        datatype => 'CreativeAssetsVisibilityType',
