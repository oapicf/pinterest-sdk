...
#
package WWW::OpenAPIClient::Object::CatalogsRetailProductGroupCreateRequest;
...
__PACKAGE__->class_documentation({description => 'Request object for creating a product group.',
...
__PACKAGE__->method_documentation({
    ...
    'filters' => {
        datatype => 'CatalogsProductGroupFiltersRequest',
        base_name => 'filters',
        description => '',
        format => '',
        read_only => '',
