...
#
package WWW::OpenAPIClient::Object::OauthAccessTokenResponseClientCredentials;
...
__PACKAGE__->class_documentation({description => 'A successful OAuth client token response for the client token flow.',
