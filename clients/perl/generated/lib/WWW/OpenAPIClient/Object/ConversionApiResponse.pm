...
#
package WWW::OpenAPIClient::Object::ConversionApiResponse;
...
__PACKAGE__->class_documentation({description => 'Schema describing the object in the response, which contains information about the events that were received and processed.',
...
__PACKAGE__->method_documentation({
    'events' => {
        datatype => 'ARRAY[ConversionApiResponseEventsInner]',
        base_name => 'events',
