...
#
package WWW::OpenAPIClient::Object::PinMediaSource;
...
__PACKAGE__->class_documentation({description => 'Pin media source that can be an image, video, or a mix of both passed in as a request.',
...
__PACKAGE__->method_documentation({
    ...
    'cover_image_content_type' => {
        datatype => 'ContentType',
        base_name => 'cover_image_content_type',
    ...
    'cover_image_key_frame_time' => {
        datatype => 'int',
        base_name => 'cover_image_key_frame_time',
    ...
    'items' => {
        datatype => 'ARRAY[PinMediaSourceImagesURLItem]',
        base_name => 'items',
