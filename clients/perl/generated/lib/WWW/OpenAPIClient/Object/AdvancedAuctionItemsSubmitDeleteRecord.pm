...
#
package WWW::OpenAPIClient::Object::AdvancedAuctionItemsSubmitDeleteRecord;
...
__PACKAGE__->class_documentation({description => 'Object describing an item bid option deletion operation',
