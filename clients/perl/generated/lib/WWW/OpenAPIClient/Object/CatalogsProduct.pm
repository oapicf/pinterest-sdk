...
#
package WWW::OpenAPIClient::Object::CatalogsProduct;
...
__PACKAGE__->class_documentation({description => 'Catalogs product for all verticals',
...
__PACKAGE__->method_documentation({
    ...
    'metadata' => {
        datatype => 'CatalogsCreativeAssetsProductMetadata',
        base_name => 'metadata',
        description => '',
        format => '',
        read_only => '',
