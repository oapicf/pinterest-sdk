...
#
package WWW::OpenAPIClient::Object::InviteExceptionResponse;
...
__PACKAGE__->class_documentation({description => 'An exception object if there is an error performing the action. Will only be provided if there is an error.',
...
__PACKAGE__->method_documentation({
    ...
    'invite_or_request_id' => {
        datatype => 'string',
        base_name => 'invite_or_request_id',
    ...
    'users_or_partner_ids' => {
        ...
        base_name => 'users_or_partner_ids',
