...
#
package WWW::OpenAPIClient::Object::BulkUpsertRequestUpdate;
...
__PACKAGE__->class_documentation({description => 'Request for creation of entities in bulk.',
...
__PACKAGE__->method_documentation({
    ...
    'catalog_product_groups' => {
        datatype => 'ARRAY[BulkUpsertRequestUpdateCatalogProductGroupsItems]',
        base_name => 'catalog_product_groups',
        description => '',
        format => '',
        read_only => '',
            },
    'keywords' => {
        datatype => 'ARRAY[KeywordUpdateGenerated]',
        base_name => 'keywords',
        description => '',
        format => '',
        read_only => '',
    ...
    'labels' => {
        datatype => 'ARRAY[LabelBulkUpdateRequest]',
        base_name => 'labels',
        description => '',
        format => '',
        read_only => '',
    ...
    'product_groups' => {
        datatype => 'ARRAY[ProductGroupPromotionUpdateRequest]',
        base_name => 'product_groups',
        description => '',
        format => '',
        read_only => '',
            },
    'schedules' => {
        datatype => 'ARRAY[ScheduleUpdateRequest]',
        base_name => 'schedules',
        description => '',
        format => '',
        read_only => '',
