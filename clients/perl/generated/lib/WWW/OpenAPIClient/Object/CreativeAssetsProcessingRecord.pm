...
#
package WWW::OpenAPIClient::Object::CreativeAssetsProcessingRecord;
...
__PACKAGE__->class_documentation({description => 'Object describing an item processing record',
...
__PACKAGE__->method_documentation({
    ...
    'errors' => {
        datatype => 'ARRAY[ItemValidationEvent]',
        base_name => 'errors',
