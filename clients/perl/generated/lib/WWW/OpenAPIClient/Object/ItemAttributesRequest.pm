...
#
package WWW::OpenAPIClient::Object::ItemAttributesRequest;
...
__PACKAGE__->method_documentation({
    ...
    'ai_disclosures' => {
        datatype => 'ARRAY[CatalogsAiContentDisclosure]',
        base_name => 'ai_disclosures',
    ...
    'image_link' => {
        datatype => 'ItemAttributesRequestImageLink',
        base_name => 'image_link',
        description => '',
        format => '',
        read_only => '',
            },
    ...
    'video_link' => {
        datatype => 'string',
        base_name => 'video_link',
        description => '&lt;&#x3D; 2,000 characters Hosted link to the product video. File types for linked videos must be .mp4, .mov or .m4v. File size cannot exceed 2GB.',
        format => '',
        read_only => '',
            },
});
