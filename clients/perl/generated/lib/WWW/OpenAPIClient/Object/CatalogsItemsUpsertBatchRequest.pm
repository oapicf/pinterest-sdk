...
#
package WWW::OpenAPIClient::Object::CatalogsItemsUpsertBatchRequest;
...
__PACKAGE__->class_documentation({description => 'Request object to upsert catalogs items',
...
__PACKAGE__->method_documentation({
    ...
    'items' => {
        datatype => 'ARRAY[ItemUpsertBatchRecord]',
        base_name => 'items',
