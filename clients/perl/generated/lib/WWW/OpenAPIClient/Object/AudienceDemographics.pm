...
#
package WWW::OpenAPIClient::Object::AudienceDemographics;
...
__PACKAGE__->class_documentation({description => 'Audience demographics',
...
__PACKAGE__->method_documentation({
    'ages' => {
        datatype => 'ARRAY[AudienceDemographicValue]',
        base_name => 'ages',
