...
#
package WWW::OpenAPIClient::Object::TargetingSpecOptimal;
...
__PACKAGE__->method_documentation({
    ...
    'geo_exclude' => {
        datatype => 'ARRAY[string]',
        base_name => 'GEO_EXCLUDE',
        description => '[Closed beta](/docs/getting-started/using-beta-and-restricted-features/)  Region codes or postal codes to exclude from the targeting inclusion area.  See &#x60;GEO&#x60; parameter in this targeting spec for rules, syntax, and other information.',
        format => '',
        read_only => '',
            },
    'interest' => {
    ...
    'location_exclude' => {
        datatype => 'ARRAY[string]',
        base_name => 'LOCATION_EXCLUDE',
        description => '[Closed beta](/docs/getting-started/using-beta-and-restricted-features/)  Metropolitan codes and/or ISO-Alpha-2, two-letter country codes to exclude from targeting.  See &#x60;LOCATION&#x60; parameter in this targeting spec for rules, syntax, and other information.',
        format => '',
        read_only => '',
            },
    'maximum_age' => {
    ...
    'targeting_strategy' => {
        datatype => 'ARRAY[TargetingStrategy]',
