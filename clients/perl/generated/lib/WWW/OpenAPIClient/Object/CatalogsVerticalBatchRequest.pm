...
#
package WWW::OpenAPIClient::Object::CatalogsVerticalBatchRequest;
...
__PACKAGE__->class_documentation({description => 'A request object that can have multiple operations on a single batch',
...
__PACKAGE__->method_documentation({
    ...
    'items' => {
        datatype => 'ARRAY[CatalogsCreativeAssetsBatchItem]',
        base_name => 'items',
