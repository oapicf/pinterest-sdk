# Org.OpenAPITools.Model.ConversionMSOTEventsCreate
...
**ActionTimestamps** | **List&lt;long&gt;** | Timestamp(s) when the ad action(s) happened. Unix timestamp in seconds. | [optional] 
**AttributionModel** | **AttributionModel** | The attribution model used to attribute the conversion event. | [optional] 
**AttributionScope** | **AttributionScope** | Ad event type. | [optional] 
...
**Currency** | **Currency** | Currency code for the &#x60;value&#x60; field, required if &#x60;value&#x60; is present. Currency Codes should be in ISO 4217 standard. | [optional] 
