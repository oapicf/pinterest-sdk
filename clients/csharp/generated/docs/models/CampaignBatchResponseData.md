# Org.OpenAPITools.Model.CampaignBatchResponseData
...
**CreatedTime** | **int** | Campaign creation time. Unix timestamp in seconds. | [optional] [readonly] 
**DailySpendCap** | **int** | Note: The default for this field is null, which is treated the same as 0. For campaign budget optimization, a daily or lifetime spend cap must be set, but not both. For ad group level budgets, this field must be 0 or unset. | [optional] 
...
**IsCarting** | **bool** | Whether the campaign contains a carting(where-to-buy link) ad. | [optional] [readonly] 
...
**Status** | **NullableEntityStatus** |  | [optional] 
**SummaryStatus** | **SummaryStatus** |  | [optional] [readonly] 
**TrackingUrls** | [**TrackingUrls**](TrackingUrls.md) |  | [optional] 
**Type** | **string** | Always \&quot;campaign\&quot;. | [optional] [readonly] 
**UpdatedTime** | **int** | UTC timestamp. Last update time. | [optional] [readonly] 
