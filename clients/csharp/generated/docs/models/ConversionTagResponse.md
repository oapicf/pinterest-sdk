# Org.OpenAPITools.Model.ConversionTagResponse
...
**EnhancedMatchStatus** | **EnhancedMatchStatusType** | The enhanced match status of the tag | [optional] [readonly] 
**Id** | **string** | Tag ID. | [optional] [readonly] 
**LastFiredTimeMs** | **decimal** | Time for the last event fired. | [optional] [readonly] 
**VarVersion** | **string** | Version number. | [optional] [readonly] 
**Status** | **EntityStatus** |  | [optional] [readonly] 
