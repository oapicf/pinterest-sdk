...
namespace Example
{
    public class CatalogsProductGroupsCreateExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new CatalogsApi(Configuration.Default);
...
> Paginated CatalogsProductGroupsList (string feedId, string bookmark = null, int? pageSize = null)
...
> Paginated FeedProcessingResultsList (string feedId, string bookmark = null, int? pageSize = null)
...
> Paginated FeedsList (string bookmark = null, int? pageSize = null)
