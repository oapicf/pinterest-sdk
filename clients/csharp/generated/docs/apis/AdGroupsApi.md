...
> AdGroupAudienceSizingResponse AdGroupsAudienceSizing (string adAccountId, AdGroupAudienceSizingRequest adGroupAudienceSizingRequest)
...
> MetricsResponse AdGroupsTargetingAnalyticsGet (string adAccountId, List<string> adGroupIds, DateOnly startDate, DateOnly endDate, List<AdsAnalyticsAdGroupTargetingType> targetingTypes, List<string> columns, Granularity granularity, int clickWindowDays = null, int engagementWindowDays = null, int viewWindowDays = null, string conversionReportTime = null, List<ConversionReportAttributionType> attributionTypes = null, ReportingTimeZone reportingTimezone = null)
