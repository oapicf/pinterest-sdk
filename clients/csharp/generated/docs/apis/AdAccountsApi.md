...
# **AdAccountAnalytics**
> List&lt;AdAccountAnalyticsResponseInner&gt; AdAccountAnalytics (string adAccountId, DateOnly startDate, DateOnly endDate, List<string> columns, Granularity granularity, int clickWindowDays = null, int engagementWindowDays = null, int viewWindowDays = null, string conversionReportTime = null, ReportingTimeZone reportingTimezone = null)
...
# **AdAccountsCreate**
> AdAccount AdAccountsCreate (AdAccountCreate adAccountCreate)
...
# **AdAccountsList**
> AdAccountsList200Response AdAccountsList (bool includeSharedAccounts = null, string bookmark = null, int pageSize = null)
...
> AdsAnalyticsCreateAsyncResponse AnalyticsCreateConversionProductReport (string adAccountId, ConversionProductReportRequest conversionProductReportRequest)
...
> TemplateBasedReport AnalyticsCreateTemplateReport (string adAccountId, string templateId, DateOnly startDate = null, DateOnly endDate = null, Granularity granularity = null)
...
| **granularity** | **Granularity** |    TOTAL - metrics are aggregated over the specified date range.    DAY - metrics are broken down daily.    HOUR - metrics are broken down hourly.    WEEKLY - metrics are broken down weekly.    MONTHLY - metrics are broken down monthly | [optional]  |
...
> AdsAnalyticsGetAsyncResponse AnalyticsGetConversionProductReport (string adAccountId, string token)
