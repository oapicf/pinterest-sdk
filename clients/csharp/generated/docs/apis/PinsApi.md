...
# **MultiPinsAnalytics**
> Dictionary&lt;string, Dictionary&lt;string, PinAnalyticsMetricsResponse&gt;&gt; MultiPinsAnalytics (List<string> pinIds, DateOnly startDate, DateOnly endDate, List<string> metricTypes, string appTypes = null, string adAccountId = null)
...
| **metricTypes** | [**List&lt;string&gt;**](string.md) | Pin metric types to get data for. |  |
...
# **PinsAnalytics**
> Dictionary&lt;string, PinAnalyticsMetricsResponse&gt; PinsAnalytics (string pinId, DateOnly startDate, DateOnly endDate, List<string> metricTypes, string appTypes = null, string splitField = null, string adAccountId = null)
