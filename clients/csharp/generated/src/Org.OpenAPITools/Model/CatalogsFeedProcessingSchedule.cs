...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class CatalogsFeedProcessingSchedule :  IEquatable<CatalogsFeedProcessingSchedule>, IValidatableObject
    {
        ...
        public CatalogsFeedProcessingSchedule(string time = default(string), TimezoneEnum timezone = default(TimezoneEnum))
        {
            ...
            if (time == null)
            {
                throw new InvalidDataException("time is a required property for CatalogsFeedProcessingSchedule and cannot be null");
            }
            else
            {
                this.Time = time;
            ...
            if (timezone == null)
            {
                throw new InvalidDataException("timezone is a required property for CatalogsFeedProcessingSchedule and cannot be null");
            }
            else
            {
