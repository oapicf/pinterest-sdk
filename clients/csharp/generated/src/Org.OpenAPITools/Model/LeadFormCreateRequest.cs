...
namespace Org.OpenAPITools.Model
{
    ...
    /// <summary>
    /// A Json converter for type <see cref="LeadFormCreateRequest" />
    /// </summary>
    public class LeadFormCreateRequestJsonConverter : JsonConverter<LeadFormCreateRequest>
    {
        /// <summary>
        /// Deserializes json to <see cref="LeadFormCreateRequest" />
        /// </summary>
        ...
        public override LeadFormCreateRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new LeadFormCreateRequest(completionMessage, disclosureLanguage, hasAcceptedTerms, name, policyLinks, privacyPolicyLink, questions, status);
        }

        /// <summary>
        /// Serializes a <see cref="LeadFormCreateRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="leadFormCreateRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, LeadFormCreateRequest leadFormCreateRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, leadFormCreateRequest, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="LeadFormCreateRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="leadFormCreateRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        ...
        public void WriteProperties(Utf8JsonWriter writer, LeadFormCreateRequest leadFormCreateRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (leadFormCreateRequest.DisclosureLanguageOption.IsSet)
                if (leadFormCreateRequest.DisclosureLanguageOption.Value != null)
                    writer.WriteString("disclosure_language", leadFormCreateRequest.DisclosureLanguage);
                else
            ...
            if (leadFormCreateRequest.PolicyLinksOption.IsSet)
            {
                ...
                JsonSerializer.Serialize(writer, leadFormCreateRequest.PolicyLinks, jsonSerializerOptions);
            }
            ...
            {
                var statusRawValue = LeadFormStatusValueConverter.ToJsonValue(leadFormCreateRequest.Status!.Value);
