...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class CatalogsFeed :  IEquatable<CatalogsFeed>, IValidatableObject
    {
        ...
        public CatalogsFeed(DateTime createdAt = default(DateTime), string id = default(string), DateTime updatedAt = default(DateTime), Country defaultCountry = default(Country), ProductAvailabilityType defaultAvailability = default(ProductAvailabilityType), NullableCurrency defaultCurrency = default(NullableCurrency), string name = default(string), CatalogsFormat format = default(CatalogsFormat), string defaultLocale = default(string), CatalogsFeedCredentials credentials = default(CatalogsFeedCredentials), string location = default(string), CatalogsFeedProcessingSchedule preferredProcessingSchedule = default(CatalogsFeedProcessingSchedule), CatalogsStatus status = default(CatalogsStatus))
        {
            ...
            {
                throw new InvalidDataException("defaultCountry is a required property for CatalogsFeed and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("defaultAvailability is a required property for CatalogsFeed and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("defaultCurrency is a required property for CatalogsFeed and cannot be null");
            }
            else
            {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for CatalogsFeed and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (format == null)
            {
                throw new InvalidDataException("format is a required property for CatalogsFeed and cannot be null");
            }
            else
            {
                this.Format = format;
            ...
            {
                throw new InvalidDataException("defaultLocale is a required property for CatalogsFeed and cannot be null");
            }
            else
            {
            ...
            if (credentials == null)
            {
                throw new InvalidDataException("credentials is a required property for CatalogsFeed and cannot be null");
            }
            else
            {
            ...
            if (location == null)
            {
                throw new InvalidDataException("location is a required property for CatalogsFeed and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("preferredProcessingSchedule is a required property for CatalogsFeed and cannot be null");
            }
            else
            {
            ...
            if (status == null)
            {
                throw new InvalidDataException("status is a required property for CatalogsFeed and cannot be null");
            }
            else
            {
                this.Status = status;
