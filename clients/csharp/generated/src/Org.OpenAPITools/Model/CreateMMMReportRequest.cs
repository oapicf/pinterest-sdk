...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class CreateMMMReportRequest : IValidatableObject
    {
        ...
        [JsonConstructor]
        public CreateMMMReportRequest(List<MMMReportingColumn> columns, string endDate, GranularityEnum granularity, LevelEnum level, string reportName, string startDate, List<MMMReportingTargetingType> targetingTypes, Option<List<TargetingAdvertiserCountry>?> countries = default)
        {
            Columns = columns;
            EndDate = endDate;
    ...
    public class CreateMMMReportRequestJsonConverter : JsonConverter<CreateMMMReportRequest>
    {
        ...
        public override CreateMMMReportRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new CreateMMMReportRequest(columns.Value!, endDate.Value!, granularity.Value!.Value!, level.Value!.Value!, reportName.Value!, startDate.Value!, targetingTypes.Value!, countries);
        }
