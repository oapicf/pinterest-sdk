...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class OauthAccessTokenResponseRefresh : IValidatableObject
    {
        ...
        public OauthAccessTokenResponseRefresh(ResponseTypeEnum? responseType = default(ResponseTypeEnum?), string accessToken = default(string), string tokenType = @"bearer", int expiresIn = default(int), string scope = default(string))
        {
            // to ensure "accessToken" is required (not null)
            if (accessToken == null)
            {
                throw new ArgumentNullException("accessToken is a required property for OauthAccessTokenResponseRefresh and cannot be null");
            }
            this.AccessToken = accessToken;
            // to ensure "tokenType" is required (not null)
            if (tokenType == null)
            {
                throw new ArgumentNullException("tokenType is a required property for OauthAccessTokenResponseRefresh and cannot be null");
            }
            ...
            if (scope == null)
            {
                throw new ArgumentNullException("scope is a required property for OauthAccessTokenResponseRefresh and cannot be null");
            }
            this.Scope = scope;
