...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class CatalogsCreateRetailItem : IValidatableObject
    {
        ...
        public CatalogsCreateRetailItem(string itemId = default(string), OperationEnum operation = default(OperationEnum), ItemAttributes attributes = default(ItemAttributes))
        {
