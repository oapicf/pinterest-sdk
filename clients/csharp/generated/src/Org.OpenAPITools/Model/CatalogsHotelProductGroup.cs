...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CatalogsHotelProductGroup")]
    public partial class CatalogsHotelProductGroup : IValidatableObject
    {
        ...
        protected CatalogsHotelProductGroup() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CatalogsHotelProductGroup" /> class.
        /// </summary>
        /// <param name="catalogType">catalogType (required).</param>
        /// <param name="id">ID of the hotel product group. (required).</param>
        ...
        /// <param name="catalogId">catalogId (required).</param>
        public CatalogsHotelProductGroup(CatalogTypeEnum catalogType = default(CatalogTypeEnum), string id = default(string), string name = default(string), string description = default(string), CatalogsHotelProductGroupFilters filters = default(CatalogsHotelProductGroupFilters), int createdAt = default(int), int updatedAt = default(int), string catalogId = default(string))
        {
            this.CatalogType = catalogType;
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for CatalogsHotelProductGroup and cannot be null");
            }
            this.Id = id;
            // to ensure "filters" is required (not null)
            if (filters == null)
            {
                throw new ArgumentNullException("filters is a required property for CatalogsHotelProductGroup and cannot be null");
            }
            this.Filters = filters;
            // to ensure "catalogId" is required (not null)
            if (catalogId == null)
            {
                throw new ArgumentNullException("catalogId is a required property for CatalogsHotelProductGroup and cannot be null");
            }
