...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class CatalogsFeedCredentials :  IEquatable<CatalogsFeedCredentials>, IValidatableObject
    {
        ...
        public CatalogsFeedCredentials(string password = default(string), string username = default(string))
        {
            ...
            if (password == null)
            {
                throw new InvalidDataException("password is a required property for CatalogsFeedCredentials and cannot be null");
            }
            else
            {
            ...
            if (username == null)
            {
                throw new InvalidDataException("username is a required property for CatalogsFeedCredentials and cannot be null");
            }
            else
            {
