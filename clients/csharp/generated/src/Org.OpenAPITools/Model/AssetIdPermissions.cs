...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AssetIdPermissions")]
    public partial class AssetIdPermissions : IValidatableObject
    {
        ...
        public AssetIdPermissions(string assetId = default(string), string assetType = default(string), List<string> permissions = default(List<string>), AssetGroupBinding assetGroupInfo = default(AssetGroupBinding))
        {
