...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SSIOEditInsertionOrderRequest")]
    public partial class SSIOEditInsertionOrderRequest : IValidatableObject
    {
        ...
        public SSIOEditInsertionOrderRequest(string startDate = default(string), string endDate = default(string), string poNumber = default(string), decimal budgetAmount = default(decimal), string billingContactFirstname = default(string), string billingContactLastname = default(string), string billingContactEmail = default(string), string mediaContactFirstname = default(string), string mediaContactLastname = default(string), string mediaContactEmail = default(string), string agencyLink = default(string), string userEmail = default(string), string oracleLineId = default(string), string salesforceOrderId = default(string), string salesforceOrderLineId = default(string), string adsManagerOrderLineId = default(string))
        {
