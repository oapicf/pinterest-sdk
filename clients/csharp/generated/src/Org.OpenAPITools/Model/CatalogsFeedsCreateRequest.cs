...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CatalogsFeedsCreateRequest")]
    public partial class CatalogsFeedsCreateRequest : IValidatableObject
    {
        ...
        public CatalogsFeedsCreateRequest(NullableCurrency? defaultCurrency = default(NullableCurrency?), string name = default(string), CatalogsFormat format = default(CatalogsFormat), CatalogsFeedsCreateRequestDefaultLocale defaultLocale = default(CatalogsFeedsCreateRequestDefaultLocale), CatalogsFeedCredentials credentials = default(CatalogsFeedCredentials), string location = default(string), CatalogsFeedProcessingSchedule preferredProcessingSchedule = default(CatalogsFeedProcessingSchedule), Country? defaultCountry = default(Country?), ProductAvailabilityType? defaultAvailability = default(ProductAvailabilityType?), CatalogsStatus? status = default(CatalogsStatus?))
        {
            ...
            if (location == null)
            {
                throw new ArgumentNullException("location is a required property for CatalogsFeedsCreateRequest and cannot be null");
            }
