...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreativeAssetsProcessingRecord")]
    public partial class CreativeAssetsProcessingRecord : IValidatableObject
    {
        ...
        public CreativeAssetsProcessingRecord(string creativeAssetsId = default(string), List<ItemValidationEvent> errors = default(List<ItemValidationEvent>), List<ItemValidationEvent> warnings = default(List<ItemValidationEvent>), ItemProcessingStatus? status = default(ItemProcessingStatus?))
        {
