...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class CatalogsItemsUpsertBatchRequest : IValidatableObject
    {
        ...
        public CatalogsItemsUpsertBatchRequest(Country country = default(Country), CatalogsItemsRequestLanguage language = default(CatalogsItemsRequestLanguage), BatchOperation operation = default(BatchOperation), List<ItemUpsertBatchRecord> items = default(List<ItemUpsertBatchRecord>))
        {
            this.Country = country;
            // to ensure "language" is required (not null)
            if (language == null)
            {
                throw new ArgumentNullException("language is a required property for CatalogsItemsUpsertBatchRequest and cannot be null");
            }
