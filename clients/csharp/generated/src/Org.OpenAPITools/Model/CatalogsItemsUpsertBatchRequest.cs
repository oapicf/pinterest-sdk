...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    public partial class CatalogsItemsUpsertBatchRequestJsonConverter : JsonConverter<CatalogsItemsUpsertBatchRequest>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="CatalogsItemsUpsertBatchRequestJsonConverter" /> class.
        /// </summary>
        public CatalogsItemsUpsertBatchRequestJsonConverter()
        {
            OnCreated();
        }
        ...
        public override CatalogsItemsUpsertBatchRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<CatalogsItemsUpsertBatchRequest.LanguageEnum?> language = default;
            Option<CatalogsItemsUpsertBatchRequest.OperationEnum?> operation = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "language":
                            ...
                            if (languageRawValue != null)
                                language = new Option<CatalogsItemsUpsertBatchRequest.LanguageEnum?>(CatalogsItemsUpsertBatchRequest.LanguageEnumFromStringOrDefault(languageRawValue));
                            break;
                        case "operation":
                            string? operationRawValue = utf8JsonReader.GetString();
                            if (operationRawValue != null)
                                operation = new Option<CatalogsItemsUpsertBatchRequest.OperationEnum?>(CatalogsItemsUpsertBatchRequest.OperationEnumFromStringOrDefault(operationRawValue));
                            break;
                        default:
                            break;
                    }
            ...
            return new CatalogsItemsUpsertBatchRequest(country.Value!.Value!, items.Value!, language.Value!.Value!, operation.Value!.Value!);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, CatalogsItemsUpsertBatchRequest catalogsItemsUpsertBatchRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            var languageRawValue = CatalogsItemsUpsertBatchRequest.LanguageEnumToJsonValue(catalogsItemsUpsertBatchRequest.Language);
            writer.WriteString("language", languageRawValue);
            var operationRawValue = CatalogsItemsUpsertBatchRequest.OperationEnumToJsonValue(catalogsItemsUpsertBatchRequest.Operation);
