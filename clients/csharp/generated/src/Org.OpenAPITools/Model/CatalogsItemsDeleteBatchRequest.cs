...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    public partial class CatalogsItemsDeleteBatchRequestJsonConverter : JsonConverter<CatalogsItemsDeleteBatchRequest>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="CatalogsItemsDeleteBatchRequestJsonConverter" /> class.
        /// </summary>
        public CatalogsItemsDeleteBatchRequestJsonConverter()
        {
            OnCreated();
        }
        ...
        public override CatalogsItemsDeleteBatchRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<CatalogsItemsDeleteBatchRequest.LanguageEnum?> language = default;
            Option<CatalogsItemsDeleteBatchRequest.OperationEnum?> operation = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "language":
                            ...
                            if (languageRawValue != null)
                                language = new Option<CatalogsItemsDeleteBatchRequest.LanguageEnum?>(CatalogsItemsDeleteBatchRequest.LanguageEnumFromStringOrDefault(languageRawValue));
                            break;
                        case "operation":
                            string? operationRawValue = utf8JsonReader.GetString();
                            if (operationRawValue != null)
                                operation = new Option<CatalogsItemsDeleteBatchRequest.OperationEnum?>(CatalogsItemsDeleteBatchRequest.OperationEnumFromStringOrDefault(operationRawValue));
                            break;
                        default:
                            break;
                    }
            ...
            return new CatalogsItemsDeleteBatchRequest(country.Value!.Value!, items.Value!, language.Value!.Value!, operation.Value!.Value!);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, CatalogsItemsDeleteBatchRequest catalogsItemsDeleteBatchRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            var languageRawValue = CatalogsItemsDeleteBatchRequest.LanguageEnumToJsonValue(catalogsItemsDeleteBatchRequest.Language);
            writer.WriteString("language", languageRawValue);
            var operationRawValue = CatalogsItemsDeleteBatchRequest.OperationEnumToJsonValue(catalogsItemsDeleteBatchRequest.Operation);
