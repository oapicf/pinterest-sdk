...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class CatalogsItemsDeleteBatchRequest : IValidatableObject
    {
        ...
        public CatalogsItemsDeleteBatchRequest(Country country = default(Country), Language language = default(Language), BatchOperation operation = default(BatchOperation), List<ItemDeleteBatchRecord> items = default(List<ItemDeleteBatchRecord>))
        {
