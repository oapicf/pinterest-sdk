...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AdCommon_tracking_urls")]
    public partial class AdCommonTrackingUrls : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AdCommonTrackingUrls" /> class.
        /// </summary>
        ...
        public AdCommonTrackingUrls(List<string> impression = default(List<string>), List<string> click = default(List<string>), List<string> engagement = default(List<string>), List<string> buyableButton = default(List<string>), List<string> audienceVerification = default(List<string>))
        {
