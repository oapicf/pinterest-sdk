...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CatalogsRetailItemsFilter")]
    public partial class CatalogsRetailItemsFilter : IValidatableObject
    {
        ...
        protected CatalogsRetailItemsFilter() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CatalogsRetailItemsFilter" /> class.
        /// </summary>
        ...
        public CatalogsRetailItemsFilter(CatalogTypeEnum catalogType = default(CatalogTypeEnum), List<string> itemIds = default(List<string>), string catalogId = default(string))
        {
            this.CatalogType = catalogType;
            // to ensure "itemIds" is required (not null)
            if (itemIds == null)
            {
                throw new ArgumentNullException("itemIds is a required property for CatalogsRetailItemsFilter and cannot be null");
            }
