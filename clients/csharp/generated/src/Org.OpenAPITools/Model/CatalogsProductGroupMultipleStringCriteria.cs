...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class CatalogsProductGroupMultipleStringCriteria :  IEquatable<CatalogsProductGroupMultipleStringCriteria>, IValidatableObject
    {
        ...
        public CatalogsProductGroupMultipleStringCriteria(List<string> values = default(List<string>), bool negated = default(bool))
        {
            ...
            if (values == null)
            {
                throw new InvalidDataException("values is a required property for CatalogsProductGroupMultipleStringCriteria and cannot be null");
            }
            else
            {
                this.Values = values;
            ...
            if (negated == null)
            {
                throw new InvalidDataException("negated is a required property for CatalogsProductGroupMultipleStringCriteria and cannot be null");
            }
            else
            {
