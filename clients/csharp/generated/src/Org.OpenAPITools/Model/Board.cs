...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Board : IValidatableObject
    {
        ...
        public Board(string name = default(string), string description = default(string), BoardMedia media = default(BoardMedia), BoardOwner owner = default(BoardOwner), PrivacyEnum? privacy = PrivacyEnum.PUBLIC)
        {
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for CollaboratorCount, must be a value greater than or equal to 0.", new [] { "CollaboratorCount" });
            }

            // PinCount (int) minimum
            if (this.PinCount < (int)0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for PinCount, must be a value greater than or equal to 0.", new [] { "PinCount" });
            }

            // FollowerCount (int) minimum
            if (this.FollowerCount < (int)0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for FollowerCount, must be a value greater than or equal to 0.", new [] { "FollowerCount" });
            }
