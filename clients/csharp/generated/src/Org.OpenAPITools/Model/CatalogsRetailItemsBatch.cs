...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CatalogsRetailItemsBatch")]
    public partial class CatalogsRetailItemsBatch : IValidatableObject
    {
        ...
        protected CatalogsRetailItemsBatch() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CatalogsRetailItemsBatch" /> class.
        /// </summary>
        ...
        public CatalogsRetailItemsBatch(string batchId = default(string), BatchOperationStatus? status = default(BatchOperationStatus?), CatalogsType catalogType = default(CatalogsType), List<ItemProcessingRecord> items = default(List<ItemProcessingRecord>))
        {
