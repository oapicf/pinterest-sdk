...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CatalogsListProductsByFilterRequest_oneOf")]
    public partial class CatalogsListProductsByFilterRequestOneOf : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CatalogsListProductsByFilterRequestOneOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CatalogsListProductsByFilterRequestOneOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CatalogsListProductsByFilterRequestOneOf" /> class.
        /// </summary>
        ...
        public CatalogsListProductsByFilterRequestOneOf(string feedId = default(string), CatalogsProductGroupFilters filters = default(CatalogsProductGroupFilters))
        {
            // to ensure "feedId" is required (not null)
            if (feedId == null)
            {
                throw new ArgumentNullException("feedId is a required property for CatalogsListProductsByFilterRequestOneOf and cannot be null");
            }
            this.FeedId = feedId;
            // to ensure "filters" is required (not null)
            if (filters == null)
            {
                throw new ArgumentNullException("filters is a required property for CatalogsListProductsByFilterRequestOneOf and cannot be null");
            }
