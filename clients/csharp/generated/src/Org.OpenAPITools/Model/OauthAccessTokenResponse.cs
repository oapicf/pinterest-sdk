...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class OauthAccessTokenResponse :  IEquatable<OauthAccessTokenResponse>, IValidatableObject
    {
        ...
        public OauthAccessTokenResponse(ResponseTypeEnum? responseType = default(ResponseTypeEnum?), string accessToken = default(string), string tokenType = "bearer", int expiresIn = default(int), string scope = default(string))
        {
            ...
            if (accessToken == null)
            {
                throw new InvalidDataException("accessToken is a required property for OauthAccessTokenResponse and cannot be null");
            }
            else
            {
            ...
            if (tokenType == null)
            {
                throw new InvalidDataException("tokenType is a required property for OauthAccessTokenResponse and cannot be null");
            }
            else
            {
            ...
            if (expiresIn == null)
            {
                throw new InvalidDataException("expiresIn is a required property for OauthAccessTokenResponse and cannot be null");
            }
            else
            {
            ...
            if (scope == null)
            {
                throw new InvalidDataException("scope is a required property for OauthAccessTokenResponse and cannot be null");
            }
            else
            {
                this.Scope = scope;
