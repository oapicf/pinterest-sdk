...
namespace Org.OpenAPITools.Model
{
    ...
    public class CountryJsonConverter : JsonConverter<Country>
    {
        ...
        {
            writer.WriteStringValue(CountryValueConverter.ToJsonValue(country).ToString());
        }
    }
    ...
    public class CountryNullableJsonConverter : JsonConverter<Country?>
    {
        ...
        {
            if (country.HasValue)
                writer.WriteStringValue(CountryValueConverter.ToJsonValue(country.Value).ToString());
            else
