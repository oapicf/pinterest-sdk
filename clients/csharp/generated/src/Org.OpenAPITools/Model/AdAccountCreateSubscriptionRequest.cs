...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class AdAccountCreateSubscriptionRequest : IValidatableObject
    {
        ...
        public AdAccountCreateSubscriptionRequest(string webhookUrl = default(string), string leadFormId = default(string), string partnerAccessToken = default(string), string partnerRefreshToken = default(string))
        {
