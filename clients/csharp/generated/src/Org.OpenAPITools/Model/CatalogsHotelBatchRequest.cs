...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class CatalogsHotelBatchRequest : IValidatableObject
    {
        ...
        [JsonConstructor]
        public CatalogsHotelBatchRequest(CatalogTypeEnum catalogType, Country country, LanguageEnum language, List<CatalogsHotelBatchItem> items, Option<string?> catalogId = default)
        {
    ...
    /// </summary>
    public class CatalogsHotelBatchRequestJsonConverter : JsonConverter<CatalogsHotelBatchRequest>
    {
        /// <summary>
        ...
        public override CatalogsHotelBatchRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new CatalogsHotelBatchRequest(catalogType.Value!.Value!, country.Value!.Value!, language.Value!.Value!, items.Value!, catalogId);
        }
