...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class PinMediaSourceVideoID :  IEquatable<PinMediaSourceVideoID>, IValidatableObject
    {
        ...
        public PinMediaSourceVideoID(SourceTypeEnum sourceType = default(SourceTypeEnum), string coverImageUrl = default(string), string mediaId = default(string))
        {
            ...
            if (sourceType == null)
            {
                throw new InvalidDataException("sourceType is a required property for PinMediaSourceVideoID and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("coverImageUrl is a required property for PinMediaSourceVideoID and cannot be null");
            }
            else
            {
            ...
            if (mediaId == null)
            {
                throw new InvalidDataException("mediaId is a required property for PinMediaSourceVideoID and cannot be null");
            }
            else
            {
