...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BusinessMemberAssetsSummary_ad_accounts_inner")]
    public partial class BusinessMemberAssetsSummaryAdAccountsInner : IValidatableObject
    {
        ...
        public BusinessMemberAssetsSummaryAdAccountsInner(string id = default(string), List<string> permissions = default(List<string>))
        {
            this.Id = id;
