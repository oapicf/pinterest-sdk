...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ConversionEventsUserData_anyOf_2")]
    public partial class ConversionEventsUserDataAnyOf2 : IValidatableObject
    {
        ...
        protected ConversionEventsUserDataAnyOf2() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ConversionEventsUserDataAnyOf2" /> class.
        /// </summary>
        ...
        /// <param name="clientIpAddress">The user&#39;s IP address, which can be either in IPv4 or IPv6 format. Used for matching. We highly recommend this for all events. It may improve reporting performance such as ROAS/CPA. (required).</param>
        /// <param name="clientUserAgent">The user agent string of the user&#39;s web browser. We highly recommend this for all events. It may improve reporting performance such as ROAS/CPA. (required).</param>
        public ConversionEventsUserDataAnyOf2(List<string> em = default(List<string>), List<string> hashedMaids = default(List<string>), string clientIpAddress = default(string), string clientUserAgent = default(string))
        {
            // to ensure "clientIpAddress" is required (not null)
            if (clientIpAddress == null)
            {
                throw new ArgumentNullException("clientIpAddress is a required property for ConversionEventsUserDataAnyOf2 and cannot be null");
            }
            this.ClientIpAddress = clientIpAddress;
            // to ensure "clientUserAgent" is required (not null)
            if (clientUserAgent == null)
            {
                throw new ArgumentNullException("clientUserAgent is a required property for ConversionEventsUserDataAnyOf2 and cannot be null");
            }
        ...
        */
        [DataMember(Name = "client_ip_address", IsRequired = true, EmitDefaultValue = true)]
        ...
        */
        [DataMember(Name = "client_user_agent", IsRequired = true, EmitDefaultValue = true)]
