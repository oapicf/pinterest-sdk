...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class PinCreate : IValidatableObject
    {
        ...
        public PinCreate(string link = default(string), string title = default(string), string description = default(string), string dominantColor = default(string), string altText = default(string), string boardId = default(string), string boardSectionId = default(string), BoardOwner boardOwner = default(BoardOwner), SummaryPinMedia media = default(SummaryPinMedia), PinMediaSource mediaSource = default(PinMediaSource), string parentPinId = default(string), string note = default(string))
        {
            this.Link = link;
            this.Title = title;
