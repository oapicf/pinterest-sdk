...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    public partial class CatalogsItemsRequestJsonConverter : JsonConverter<CatalogsItemsRequest>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="CatalogsItemsRequestJsonConverter" /> class.
        /// </summary>
        public CatalogsItemsRequestJsonConverter()
        {
            OnCreated();
        }
        ...
        public override CatalogsItemsRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<CatalogsItemsRequest.LanguageEnum?> language = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "language":
                            ...
                            if (languageRawValue != null)
                                language = new Option<CatalogsItemsRequest.LanguageEnum?>(CatalogsItemsRequest.LanguageEnumFromStringOrDefault(languageRawValue));
                            break;
                        default:
                            break;
                    }
            ...
            return new CatalogsItemsRequest(country.Value!.Value!, filters.Value!, language.Value!.Value!);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, CatalogsItemsRequest catalogsItemsRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            var languageRawValue = CatalogsItemsRequest.LanguageEnumToJsonValue(catalogsItemsRequest.Language);
