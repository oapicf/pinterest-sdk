...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class PinUpdate : IValidatableObject
    {
        ...
        [JsonConstructor]
        public PinUpdate(Option<string?> altText = default, Option<string?> boardId = default, Option<string?> boardSectionId = default, Option<string?> description = default, Option<string?> link = default, Option<string?> title = default, Option<List<PinUpdateCarouselSlotsInner>?> carouselSlots = default, Option<string?> note = default)
        {
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<List<PinUpdateCarouselSlotsInner>?> CarouselSlotsOption { get; private set; }
        ...
        public List<PinUpdateCarouselSlotsInner>? CarouselSlots { get { return this.CarouselSlotsOption; } set { this.CarouselSlotsOption = new(value); } }
    ...
    public class PinUpdateJsonConverter : JsonConverter<PinUpdate>
    {
        ...
        public override PinUpdate Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<PinUpdateCarouselSlotsInner>?> carouselSlots = default;
            ...
            return new PinUpdate(altText, boardId, boardSectionId, description, link, title, carouselSlots, note);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, PinUpdate pinUpdate, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (pinUpdate.BoardIdOption.IsSet)
                if (pinUpdate.BoardIdOption.Value != null)
            ...
            if (pinUpdate.NoteOption.IsSet)
                if (pinUpdate.NoteOption.Value != null)
                    writer.WriteString("note", pinUpdate.Note);
                else
