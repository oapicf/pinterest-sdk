...
namespace Org.OpenAPITools.Model
{
    ...
    public static class RoleValueConverter
    {
        ...
        public static string ToJsonValue(Role value)
        {
            ...
            if (value == Role.FINANCEEDIT)
                return "FINANCE_EDIT";

            if (value == Role.FINANCEVIEW)
                return "FINANCE_VIEW";
    ...
    public class RoleNullableJsonConverter : JsonConverter<Role?>
    {
        ...
        {
            if (role.HasValue)
                writer.WriteStringValue(RoleValueConverter.ToJsonValue(role.Value).ToString());
            else
