...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CatalogsHotelFeedsCreateRequest")]
    public partial class CatalogsHotelFeedsCreateRequest : IValidatableObject
    {
        ...
        protected CatalogsHotelFeedsCreateRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CatalogsHotelFeedsCreateRequest" /> class.
        /// </summary>
        ...
        public CatalogsHotelFeedsCreateRequest(NullableCurrency? defaultCurrency = default(NullableCurrency?), string name = default(string), CatalogsFormat format = default(CatalogsFormat), CatalogsFeedsCreateRequestDefaultLocale defaultLocale = default(CatalogsFeedsCreateRequestDefaultLocale), CatalogsFeedCredentials credentials = default(CatalogsFeedCredentials), string location = default(string), CatalogsFeedProcessingSchedule preferredProcessingSchedule = default(CatalogsFeedProcessingSchedule), CatalogsType catalogType = default(CatalogsType), string catalogId = default(string), CatalogsStatus? status = default(CatalogsStatus?))
        {
            ...
            {
                throw new ArgumentNullException("defaultLocale is a required property for CatalogsHotelFeedsCreateRequest and cannot be null");
            }
            this.DefaultLocale = defaultLocale;
            // to ensure "location" is required (not null)
            if (location == null)
            {
                throw new ArgumentNullException("location is a required property for CatalogsHotelFeedsCreateRequest and cannot be null");
            }
