...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class LeadFormUpdateRequest : IValidatableObject
    {
        ...
        [JsonConstructor]
        public LeadFormUpdateRequest(string id, Option<string?> completionMessage = default, Option<string?> disclosureLanguage = default, Option<bool?> hasAcceptedTerms = default, Option<string?> name = default, Option<List<LeadFormCommonPolicyLinksInner>?> policyLinks = default, Option<string?> privacyPolicyLink = default, Option<List<LeadFormQuestion>?> questions = default, Option<LeadFormStatus?> status = default)
        {
            Id = id;
    ...
    public class LeadFormUpdateRequestJsonConverter : JsonConverter<LeadFormUpdateRequest>
    {
        ...
        public override LeadFormUpdateRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new LeadFormUpdateRequest(id.Value!, completionMessage, disclosureLanguage, hasAcceptedTerms, name, policyLinks, privacyPolicyLink, questions, status);
        }
