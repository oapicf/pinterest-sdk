...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CampaignUpdateRequest")]
    public partial class CampaignUpdateRequest : IValidatableObject
    {
        ...
        protected CampaignUpdateRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CampaignUpdateRequest" /> class.
        /// </summary>
        ...
        public CampaignUpdateRequest(string id = default(string), string adAccountId = default(string), string name = default(string), EntityStatus? status = default(EntityStatus?), int? lifetimeSpendCap = default(int?), int? dailySpendCap = default(int?), string orderLineId = default(string), TrackingUrls trackingUrls = default(TrackingUrls), int? startTime = default(int?), int? endTime = default(int?), bool? isFlexibleDailyBudgets = default(bool?), int? defaultAdGroupBudgetInMicroCurrency = default(int?), bool? isAutomatedCampaign = default(bool?), bool? isCampaignBudgetOptimization = default(bool?), ObjectiveType? objectiveType = default(ObjectiveType?))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for CampaignUpdateRequest and cannot be null");
            }
            this.Id = id;
            // to ensure "adAccountId" is required (not null)
            if (adAccountId == null)
            {
                throw new ArgumentNullException("adAccountId is a required property for CampaignUpdateRequest and cannot be null");
            }
