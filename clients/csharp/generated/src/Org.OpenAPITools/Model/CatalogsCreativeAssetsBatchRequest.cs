...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class CatalogsCreativeAssetsBatchRequest : IValidatableObject
    {
        ...
        [JsonConstructor]
        public CatalogsCreativeAssetsBatchRequest(CatalogTypeEnum catalogType, Country country, LanguageEnum language, List<CatalogsCreativeAssetsBatchItem> items, Option<string?> catalogId = default)
        {
    ...
    public class CatalogsCreativeAssetsBatchRequestJsonConverter : JsonConverter<CatalogsCreativeAssetsBatchRequest>
    {
        ...
        public override CatalogsCreativeAssetsBatchRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new CatalogsCreativeAssetsBatchRequest(catalogType.Value!.Value!, country.Value!.Value!, language.Value!.Value!, items.Value!, catalogId);
        }
