...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    public partial class CatalogsItemsUpdateBatchRequestJsonConverter : JsonConverter<CatalogsItemsUpdateBatchRequest>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="CatalogsItemsUpdateBatchRequestJsonConverter" /> class.
        /// </summary>
        public CatalogsItemsUpdateBatchRequestJsonConverter()
        {
            OnCreated();
        }
        ...
        public override CatalogsItemsUpdateBatchRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<CatalogsItemsUpdateBatchRequest.LanguageEnum?> language = default;
            Option<CatalogsItemsUpdateBatchRequest.OperationEnum?> operation = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "language":
                            ...
                            if (languageRawValue != null)
                                language = new Option<CatalogsItemsUpdateBatchRequest.LanguageEnum?>(CatalogsItemsUpdateBatchRequest.LanguageEnumFromStringOrDefault(languageRawValue));
                            break;
                        case "operation":
                            string? operationRawValue = utf8JsonReader.GetString();
                            if (operationRawValue != null)
                                operation = new Option<CatalogsItemsUpdateBatchRequest.OperationEnum?>(CatalogsItemsUpdateBatchRequest.OperationEnumFromStringOrDefault(operationRawValue));
                            break;
                        default:
                            break;
                    }
            ...
            return new CatalogsItemsUpdateBatchRequest(country.Value!.Value!, items.Value!, language.Value!.Value!, operation.Value!.Value!);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, CatalogsItemsUpdateBatchRequest catalogsItemsUpdateBatchRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            var languageRawValue = CatalogsItemsUpdateBatchRequest.LanguageEnumToJsonValue(catalogsItemsUpdateBatchRequest.Language);
            writer.WriteString("language", languageRawValue);
            var operationRawValue = CatalogsItemsUpdateBatchRequest.OperationEnumToJsonValue(catalogsItemsUpdateBatchRequest.Operation);
