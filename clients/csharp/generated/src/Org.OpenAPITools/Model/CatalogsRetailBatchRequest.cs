...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class CatalogsRetailBatchRequest : IValidatableObject
    {
        ...
        [JsonConstructor]
        public CatalogsRetailBatchRequest(CatalogTypeEnum catalogType, Country country, List<CatalogsRetailBatchRequestItemsItems> items, LanguageEnum language, Option<string?> catalogId = default)
        {
    ...
    /// </summary>
    public partial class CatalogsRetailBatchRequestJsonConverter : JsonConverter<CatalogsRetailBatchRequest>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="CatalogsRetailBatchRequestJsonConverter" /> class.
        /// </summary>
        public CatalogsRetailBatchRequestJsonConverter()
        {
            OnCreated();
        }
        ...
        public override CatalogsRetailBatchRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<CatalogsRetailBatchRequestItemsItems>?> items = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "country":
                            ...
                            break;
                        case "items":
                            items = new Option<List<CatalogsRetailBatchRequestItemsItems>?>(JsonSerializer.Deserialize<List<CatalogsRetailBatchRequestItemsItems>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        case "language":
            ...
            if (catalogId.IsSet && catalogId.Value == null)
                throw new ArgumentNullException(nameof(catalogId), "Property is not nullable for class CatalogsRetailBatchRequest.");

            return new CatalogsRetailBatchRequest(catalogType.Value!.Value!, country.Value!.Value!, items.Value!, language.Value!.Value!, catalogId);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, CatalogsRetailBatchRequest catalogsRetailBatchRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (catalogsRetailBatchRequest.CatalogIdOption.IsSet && catalogsRetailBatchRequest.CatalogId == null)
                throw new ArgumentNullException(nameof(catalogsRetailBatchRequest.CatalogId), "Property is required for class CatalogsRetailBatchRequest.");
            ...
            if (catalogsRetailBatchRequest.CatalogIdOption.IsSet)
                writer.WriteString("catalog_id", catalogsRetailBatchRequest.CatalogId);
        }
    }
}
