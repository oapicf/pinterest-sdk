...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CatalogsRetailListProductsByCatalogBasedFilterRequest")]
    public partial class CatalogsRetailListProductsByCatalogBasedFilterRequest : IValidatableObject
    {
        ...
        protected CatalogsRetailListProductsByCatalogBasedFilterRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CatalogsRetailListProductsByCatalogBasedFilterRequest" /> class.
        /// </summary>
        ...
        public CatalogsRetailListProductsByCatalogBasedFilterRequest(CatalogTypeEnum catalogType = default(CatalogTypeEnum), string catalogId = default(string), CatalogsProductGroupFilters filters = default(CatalogsProductGroupFilters), Country country = default(Country), CatalogsLocale locale = default(CatalogsLocale))
        {
            this.CatalogType = catalogType;
            // to ensure "catalogId" is required (not null)
            if (catalogId == null)
            {
                throw new ArgumentNullException("catalogId is a required property for CatalogsRetailListProductsByCatalogBasedFilterRequest and cannot be null");
            }
            this.CatalogId = catalogId;
            // to ensure "filters" is required (not null)
            if (filters == null)
            {
                throw new ArgumentNullException("filters is a required property for CatalogsRetailListProductsByCatalogBasedFilterRequest and cannot be null");
            }
