...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Pin : IValidatableObject
    {
        ...
        public Pin(string link = default(string), string title = default(string), string description = default(string), string dominantColor = default(string), string altText = default(string), string boardId = default(string), string boardSectionId = default(string), PinMediaSource mediaSource = default(PinMediaSource), string parentPinId = default(string), bool isStandard = default(bool), string note = default(string), Object pinMetrics = default(Object))
        {
            this.Link = link;
            this.Title = title;
