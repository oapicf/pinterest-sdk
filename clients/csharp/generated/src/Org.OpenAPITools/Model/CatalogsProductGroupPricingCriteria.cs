...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class CatalogsProductGroupPricingCriteria : IValidatableObject
    {
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Values, must be a value greater than or equal to 0.", new [] { "Values" });
            }
