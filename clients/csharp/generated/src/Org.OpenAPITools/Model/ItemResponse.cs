...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class ItemResponse : AbstractOpenAPISchema, IValidatableObject
    {
        ...
        {
            return (ItemResponseAnyOf)ActualInstance;
        }
        ...
        {
            return (ItemResponseAnyOf1)ActualInstance;
        }
        ...
        {
            return JsonConvert.SerializeObject(ActualInstance, ItemResponse.SerializerSettings);
        }
