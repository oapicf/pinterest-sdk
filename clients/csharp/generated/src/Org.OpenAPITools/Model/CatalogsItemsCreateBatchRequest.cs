...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    public partial class CatalogsItemsCreateBatchRequestJsonConverter : JsonConverter<CatalogsItemsCreateBatchRequest>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="CatalogsItemsCreateBatchRequestJsonConverter" /> class.
        /// </summary>
        public CatalogsItemsCreateBatchRequestJsonConverter()
        {
            OnCreated();
        }
        ...
        public override CatalogsItemsCreateBatchRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<CatalogsItemsCreateBatchRequest.LanguageEnum?> language = default;
            Option<CatalogsItemsCreateBatchRequest.OperationEnum?> operation = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "language":
                            ...
                            if (languageRawValue != null)
                                language = new Option<CatalogsItemsCreateBatchRequest.LanguageEnum?>(CatalogsItemsCreateBatchRequest.LanguageEnumFromStringOrDefault(languageRawValue));
                            break;
                        case "operation":
                            string? operationRawValue = utf8JsonReader.GetString();
                            if (operationRawValue != null)
                                operation = new Option<CatalogsItemsCreateBatchRequest.OperationEnum?>(CatalogsItemsCreateBatchRequest.OperationEnumFromStringOrDefault(operationRawValue));
                            break;
                        default:
                            break;
                    }
            ...
            return new CatalogsItemsCreateBatchRequest(country.Value!.Value!, items.Value!, language.Value!.Value!, operation.Value!.Value!);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, CatalogsItemsCreateBatchRequest catalogsItemsCreateBatchRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            var languageRawValue = CatalogsItemsCreateBatchRequest.LanguageEnumToJsonValue(catalogsItemsCreateBatchRequest.Language);
            writer.WriteString("language", languageRawValue);
            var operationRawValue = CatalogsItemsCreateBatchRequest.OperationEnumToJsonValue(catalogsItemsCreateBatchRequest.Operation);
