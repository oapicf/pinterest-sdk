...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OauthAccessTokenResponseIntegrationRefresh")]
    public partial class OauthAccessTokenResponseIntegrationRefresh : IValidatableObject
    {
        ...
        protected OauthAccessTokenResponseIntegrationRefresh() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OauthAccessTokenResponseIntegrationRefresh" /> class.
        /// </summary>
        ...
        public OauthAccessTokenResponseIntegrationRefresh(ResponseTypeEnum? responseType = default(ResponseTypeEnum?), string accessToken = default(string), string tokenType = @"bearer", int expiresIn = default(int), string scope = default(string), string refreshToken = default(string), int refreshTokenExpiresIn = default(int))
        {
            // to ensure "accessToken" is required (not null)
            if (accessToken == null)
            {
                throw new ArgumentNullException("accessToken is a required property for OauthAccessTokenResponseIntegrationRefresh and cannot be null");
            }
            this.AccessToken = accessToken;
            // to ensure "tokenType" is required (not null)
            if (tokenType == null)
            {
                throw new ArgumentNullException("tokenType is a required property for OauthAccessTokenResponseIntegrationRefresh and cannot be null");
            }
            ...
            if (scope == null)
            {
                throw new ArgumentNullException("scope is a required property for OauthAccessTokenResponseIntegrationRefresh and cannot be null");
            }
            this.Scope = scope;
            // to ensure "refreshToken" is required (not null)
            if (refreshToken == null)
            {
                throw new ArgumentNullException("refreshToken is a required property for OauthAccessTokenResponseIntegrationRefresh and cannot be null");
            }
