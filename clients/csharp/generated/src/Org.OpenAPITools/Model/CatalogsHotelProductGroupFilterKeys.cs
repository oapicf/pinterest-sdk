...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class CatalogsHotelProductGroupFilterKeys : AbstractOpenAPISchema, IValidatableObject
    {
        ...
        {
            return (PriceFilter)this.ActualInstance;
        }
        ...
        {
            return (HotelIdFilter)this.ActualInstance;
        }
        ...
        {
            return (CountryFilter)this.ActualInstance;
        }
        ...
        {
            return JsonConvert.SerializeObject(this.ActualInstance, CatalogsHotelProductGroupFilterKeys.SerializerSettings);
        }
