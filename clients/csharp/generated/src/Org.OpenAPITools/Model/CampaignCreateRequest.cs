...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class CampaignCreateRequest : IValidatableObject
    {
        ...
        public CampaignCreateRequest(string adAccountId = default(string), string name = default(string), EntityStatus? status = "ACTIVE", int? lifetimeSpendCap = default(int?), int? dailySpendCap = default(int?), string orderLineId = default(string), TrackingUrls trackingUrls = default(TrackingUrls), int? startTime = default(int?), int? endTime = default(int?), bool? isFlexibleDailyBudgets = false, int? defaultAdGroupBudgetInMicroCurrency = default(int?), bool? isAutomatedCampaign = false, ObjectiveType objectiveType = default(ObjectiveType))
        {
            ...
            // use default value if no "isFlexibleDailyBudgets" provided
            this.IsFlexibleDailyBudgets = isFlexibleDailyBudgets ?? false;
            this.DefaultAdGroupBudgetInMicroCurrency = defaultAdGroupBudgetInMicroCurrency;
            // use default value if no "isAutomatedCampaign" provided
            this.IsAutomatedCampaign = isAutomatedCampaign ?? false;
        }
