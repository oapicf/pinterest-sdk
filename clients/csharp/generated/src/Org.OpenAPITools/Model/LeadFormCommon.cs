...
namespace Org.OpenAPITools.Model
{
    ...
    public class LeadFormCommonJsonConverter : JsonConverter<LeadFormCommon>
    {
        ...
        public override LeadFormCommon Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new LeadFormCommon(completionMessage, disclosureLanguage, hasAcceptedTerms, name, policyLinks, privacyPolicyLink, questions, status);
        }
