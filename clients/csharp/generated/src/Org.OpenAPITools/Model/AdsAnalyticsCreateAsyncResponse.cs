...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class AdsAnalyticsCreateAsyncResponse : IValidatableObject
    {
        ...
        public AdsAnalyticsCreateAsyncResponse(BulkReportingJobStatus? reportStatus = default(BulkReportingJobStatus?), string token = default(string), string message = default(string))
        {
