...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CatalogsCreativeAssetsProductGroupCreateRequest")]
    public partial class CatalogsCreativeAssetsProductGroupCreateRequest : IValidatableObject
    {
        ...
        protected CatalogsCreativeAssetsProductGroupCreateRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CatalogsCreativeAssetsProductGroupCreateRequest" /> class.
        /// </summary>
        ...
        public CatalogsCreativeAssetsProductGroupCreateRequest(CatalogTypeEnum catalogType = default(CatalogTypeEnum), string name = default(string), string description = default(string), CatalogsCreativeAssetsProductGroupFilters filters = default(CatalogsCreativeAssetsProductGroupFilters), string catalogId = default(string))
        {
            this.CatalogType = catalogType;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for CatalogsCreativeAssetsProductGroupCreateRequest and cannot be null");
            }
            this.Name = name;
            // to ensure "filters" is required (not null)
            if (filters == null)
            {
                throw new ArgumentNullException("filters is a required property for CatalogsCreativeAssetsProductGroupCreateRequest and cannot be null");
            }
            this.Filters = filters;
            // to ensure "catalogId" is required (not null)
            if (catalogId == null)
            {
                throw new ArgumentNullException("catalogId is a required property for CatalogsCreativeAssetsProductGroupCreateRequest and cannot be null");
            }
