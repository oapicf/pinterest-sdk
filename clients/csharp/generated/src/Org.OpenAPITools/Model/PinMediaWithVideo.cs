...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class PinMediaWithVideo : PinMedia, IValidatableObject
    {
        ...
        public PinMediaWithVideo(ImageMetadataImages images = default(ImageMetadataImages), string coverImageUrl = default(string), string videoUrl = default(string), decimal duration = default(decimal), int height = default(int), int width = default(int), string mediaType = @"PinMediaWithVideo") : base(mediaType)
        {
            this.Images = images;
