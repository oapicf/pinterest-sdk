...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SSIOInsertionOrderStatus")]
    public partial class SSIOInsertionOrderStatus : IValidatableObject
    {
        ...
        public SSIOInsertionOrderStatus(string pinOrderId = default(string), string status = default(string), string creationTime = default(string))
        {
