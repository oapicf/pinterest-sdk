...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class IntegrationLog : IValidatableObject
    {
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for ExternalBusinessId, length must be less than 2048.", new [] { "ExternalBusinessId" });
            }

            // AdvertiserId (string) maxLength
            if (this.AdvertiserId != null && this.AdvertiserId.Length > 128)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for AdvertiserId, length must be less than 128.", new [] { "AdvertiserId" });
            }

            // MerchantId (string) maxLength
            if (this.MerchantId != null && this.MerchantId.Length > 128)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for MerchantId, length must be less than 128.", new [] { "MerchantId" });
            }

            // TagId (string) maxLength
            if (this.TagId != null && this.TagId.Length > 128)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for TagId, length must be less than 128.", new [] { "TagId" });
            }

            // FeedProfileId (string) maxLength
            if (this.FeedProfileId != null && this.FeedProfileId.Length > 128)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for FeedProfileId, length must be less than 128.", new [] { "FeedProfileId" });
            }
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for AppVersionNumber, length must be less than 20.", new [] { "AppVersionNumber" });
            }

            // PlatformVersionNumber (string) maxLength
            if (this.PlatformVersionNumber != null && this.PlatformVersionNumber.Length > 20)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for PlatformVersionNumber, length must be less than 20.", new [] { "PlatformVersionNumber" });
            }
