...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CatalogsRetailFeedsUpdateRequest")]
    public partial class CatalogsRetailFeedsUpdateRequest : IValidatableObject
    {
        ...
        protected CatalogsRetailFeedsUpdateRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CatalogsRetailFeedsUpdateRequest" /> class.
        /// </summary>
        ...
        public CatalogsRetailFeedsUpdateRequest(NullableCurrency? defaultCurrency = default(NullableCurrency?), string name = default(string), CatalogsFormat? format = default(CatalogsFormat?), CatalogsFeedCredentials credentials = default(CatalogsFeedCredentials), string location = default(string), CatalogsFeedProcessingSchedule preferredProcessingSchedule = default(CatalogsFeedProcessingSchedule), CatalogsStatus? status = default(CatalogsStatus?), CatalogsType catalogType = default(CatalogsType), ProductAvailabilityType? defaultAvailability = default(ProductAvailabilityType?))
        {
