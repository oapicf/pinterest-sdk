...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ConversionEventsUserData_anyOf_1")]
    public partial class ConversionEventsUserDataAnyOf1 : IValidatableObject
    {
        ...
        protected ConversionEventsUserDataAnyOf1() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ConversionEventsUserDataAnyOf1" /> class.
        /// </summary>
        ...
        /// <param name="hashedMaids">Sha256 hashes of user&#39;s \&quot;Google Advertising IDs\&quot; (GAIDs) or \&quot;Apple&#39;s Identifier for Advertisers\&quot; (IDFAs). Used for matching. We highly recommend this on checkout events at least. It may improve reporting performance such as ROAS/CPA. The string should be in the UTF-8 format. (required).</param>
        ...
        public ConversionEventsUserDataAnyOf1(List<string> em = default(List<string>), List<string> hashedMaids = default(List<string>), string clientIpAddress = default(string), string clientUserAgent = default(string))
        {
            // to ensure "hashedMaids" is required (not null)
            if (hashedMaids == null)
            {
                throw new ArgumentNullException("hashedMaids is a required property for ConversionEventsUserDataAnyOf1 and cannot be null");
            }
        ...
        */
        [DataMember(Name = "hashed_maids", IsRequired = true, EmitDefaultValue = true)]
