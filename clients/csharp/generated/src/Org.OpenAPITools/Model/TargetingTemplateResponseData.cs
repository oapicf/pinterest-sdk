...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TargetingTemplateResponseData")]
    public partial class TargetingTemplateResponseData : IValidatableObject
    {
        ...
        */
        ...
        public TargetingTemplateResponseData(string name = default(string), bool autoTargetingEnabled = true, TargetingSpec targetingAttributes = default(TargetingSpec), PlacementGroupType? placementGroup = default(PlacementGroupType?), List<TargetingTemplateKeyword> keywords = default(List<TargetingTemplateKeyword>), TrackingUrls trackingUrls = default(TrackingUrls), string id = default(string), int createdTime = default(int), int updatedTime = default(int), string adAccountId = default(string), StatusEnum? status = StatusEnum.ACTIVE, TargetingTemplateAudienceSizing sizing = default(TargetingTemplateAudienceSizing))
        {
            this.Name = name;
