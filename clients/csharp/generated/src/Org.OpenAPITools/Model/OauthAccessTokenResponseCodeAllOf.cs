...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class OauthAccessTokenResponseCodeAllOf :  IEquatable<OauthAccessTokenResponseCodeAllOf>, IValidatableObject
    {
        ...
        public OauthAccessTokenResponseCodeAllOf(string refreshToken = default(string), int refreshTokenExpiresIn = default(int))
        {
            ...
            {
                throw new InvalidDataException("refreshToken is a required property for OauthAccessTokenResponseCodeAllOf and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("refreshTokenExpiresIn is a required property for OauthAccessTokenResponseCodeAllOf and cannot be null");
            }
            else
            {
