...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CatalogsCreativeAssetsItemsBatch")]
    public partial class CatalogsCreativeAssetsItemsBatch : IValidatableObject
    {
        ...
        protected CatalogsCreativeAssetsItemsBatch() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CatalogsCreativeAssetsItemsBatch" /> class.
        /// </summary>
        ...
        public CatalogsCreativeAssetsItemsBatch(string batchId = default(string), BatchOperationStatus? status = default(BatchOperationStatus?), CatalogsType catalogType = default(CatalogsType), List<CreativeAssetsProcessingRecord> items = default(List<CreativeAssetsProcessingRecord>))
        {
