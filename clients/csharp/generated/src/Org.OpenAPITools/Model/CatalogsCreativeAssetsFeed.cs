...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CatalogsCreativeAssetsFeed")]
    public partial class CatalogsCreativeAssetsFeed : IValidatableObject
    {
        ...
        protected CatalogsCreativeAssetsFeed() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CatalogsCreativeAssetsFeed" /> class.
        /// </summary>
        ...
        public CatalogsCreativeAssetsFeed(DateTime createdAt = default(DateTime), string id = default(string), DateTime updatedAt = default(DateTime), string name = default(string), CatalogsFormat format = default(CatalogsFormat), CatalogsType catalogType = default(CatalogsType), CatalogsFeedCredentials credentials = default(CatalogsFeedCredentials), string location = default(string), CatalogsFeedProcessingSchedule preferredProcessingSchedule = default(CatalogsFeedProcessingSchedule), CatalogsStatus status = default(CatalogsStatus), NullableCurrency defaultCurrency = default(NullableCurrency), string defaultLocale = default(string), Country defaultCountry = default(Country), string catalogId = default(string))
        {
            ...
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for CatalogsCreativeAssetsFeed and cannot be null");
            }
            this.Name = name;
            this.Format = format;
            ...
            if (credentials == null)
            {
                throw new ArgumentNullException("credentials is a required property for CatalogsCreativeAssetsFeed and cannot be null");
            }
            this.Credentials = credentials;
            // to ensure "location" is required (not null)
            if (location == null)
            {
                throw new ArgumentNullException("location is a required property for CatalogsCreativeAssetsFeed and cannot be null");
            }
            this.Location = location;
            // to ensure "preferredProcessingSchedule" is required (not null)
            if (preferredProcessingSchedule == null)
            {
                throw new ArgumentNullException("preferredProcessingSchedule is a required property for CatalogsCreativeAssetsFeed and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("defaultLocale is a required property for CatalogsCreativeAssetsFeed and cannot be null");
            }
            ...
            if (catalogId == null)
            {
                throw new ArgumentNullException("catalogId is a required property for CatalogsCreativeAssetsFeed and cannot be null");
            }
