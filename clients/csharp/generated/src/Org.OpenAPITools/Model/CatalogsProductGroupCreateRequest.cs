...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class CatalogsProductGroupCreateRequest :  IEquatable<CatalogsProductGroupCreateRequest>, IValidatableObject
    {
        ...
        public CatalogsProductGroupCreateRequest(string feedId = default(string), string name = default(string), string description = default(string), CatalogsProductGroupFilters filters = default(CatalogsProductGroupFilters))
        {
            ...
            if (feedId == null)
            {
                throw new InvalidDataException("feedId is a required property for CatalogsProductGroupCreateRequest and cannot be null");
            }
            else
            {
                this.FeedId = feedId;
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for CatalogsProductGroupCreateRequest and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (filters == null)
            {
                throw new InvalidDataException("filters is a required property for CatalogsProductGroupCreateRequest and cannot be null");
            }
            else
            {
