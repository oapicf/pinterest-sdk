...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class CatalogsProductGroupCreateRequest : IValidatableObject
    {
        ...
        public CatalogsProductGroupCreateRequest(string name = default(string), string description = default(string), bool isFeatured = false, CatalogsProductGroupFiltersRequest filters = default(CatalogsProductGroupFiltersRequest), string feedId = default(string))
        {
