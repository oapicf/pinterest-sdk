...
namespace Org.OpenAPITools.Model
{
    ...
    /// AdCreateRequest
    /// </summary>
    [DataContract(Name = "AdCreateRequest")]
    public partial class AdCreateRequest : IValidatableObject
    {
        ...
        /// </summary>
        [DataMember(Name = "creative_type", IsRequired = true, EmitDefaultValue = true)]
        ...
        public enum CustomizableCtaTypeEnum
        {
            ...
            /// <summary>
            /// Enum VISITWEBSITE for value: VISIT_WEBSITE
            /// </summary>
        ...
        protected AdCreateRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AdCreateRequest" /> class.
        /// </summary>
        /// <param name="adGroupId">ID of the ad group that contains the ad. (required).</param>
        ...
        /// <param name="creativeType">creativeType (required).</param>
        ...
        public AdCreateRequest(string adGroupId = default(string), string androidDeepLink = default(string), List<string> carouselAndroidDeepLinks = default(List<string>), List<string> carouselDestinationUrls = default(List<string>), List<string> carouselIosDeepLinks = default(List<string>), string clickTrackingUrl = default(string), CreativeType creativeType = default(CreativeType), string destinationUrl = default(string), string iosDeepLink = default(string), bool isPinDeleted = default(bool), bool isRemovable = default(bool), string name = default(string), EntityStatus? status = default(EntityStatus?), AdCommonTrackingUrls trackingUrls = default(AdCommonTrackingUrls), string viewTrackingUrl = default(string), string leadFormId = default(string), GridClickType? gridClickType = default(GridClickType?), CustomizableCtaTypeEnum? customizableCtaType = default(CustomizableCtaTypeEnum?), AdCommonQuizPinData quizPinData = default(AdCommonQuizPinData), string pinId = default(string))
        {
            ...
            if (pinId == null)
            {
                throw new ArgumentNullException("pinId is a required property for AdCreateRequest and cannot be null");
            }
            this.PinId = pinId;
