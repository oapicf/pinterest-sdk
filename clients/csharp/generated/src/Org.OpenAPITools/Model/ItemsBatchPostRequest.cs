...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class ItemsBatchPostRequest : IValidatableObject
    {
        ...
        public ItemsBatchPostRequest(CatalogsVerticalBatchRequest catalogsVerticalBatchRequest, Country country, List<ItemDeleteBatchRecord> items, LanguageEnum language, Option<string?> catalogId = default)
        {
        ...
        /// <param name="language">We recommend using the CatalogsLocale values.</param>
        /// <param name="catalogId">Catalog id pertaining to the creative assets item. If not provided, default to oldest creative assets catalog</param>
        public ItemsBatchPostRequest(CatalogsItemsBatchRequest catalogsItemsBatchRequest, Country country, List<ItemDeleteBatchRecord> items, LanguageEnum language, Option<string?> catalogId = default)
        {
    ...
    public class ItemsBatchPostRequestJsonConverter : JsonConverter<ItemsBatchPostRequest>
    {
        ...
        public override ItemsBatchPostRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (catalogsVerticalBatchRequest != null)
                return new ItemsBatchPostRequest(catalogsVerticalBatchRequest, countryParsedValue, itemsParsedValue, languageParsedValue, catalogId);

            if (catalogsItemsBatchRequest != null)
                return new ItemsBatchPostRequest(catalogsItemsBatchRequest, countryParsedValue, itemsParsedValue, languageParsedValue, catalogId);
