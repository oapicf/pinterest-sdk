...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class ItemsBatchPostRequest : IValidatableObject
    {
        ...
        public ItemsBatchPostRequest(CatalogsVerticalBatchRequest catalogsVerticalBatchRequest, Country country, LanguageEnum language, List<ItemDeleteBatchRecord> items, Option<string?> catalogId = default)
        {
        ...
        /// <param name="items">Array with catalogs items</param>
        /// <param name="catalogId">Catalog id pertaining to the creative assets item. If not provided, default to oldest creative assets catalog</param>
        public ItemsBatchPostRequest(CatalogsItemsBatchRequest catalogsItemsBatchRequest, Country country, LanguageEnum language, List<ItemDeleteBatchRecord> items, Option<string?> catalogId = default)
        {
    ...
    public class ItemsBatchPostRequestJsonConverter : JsonConverter<ItemsBatchPostRequest>
    {
        ...
        public override ItemsBatchPostRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<ItemsBatchPostRequest.LanguageEnum?> language = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "language":
                            ...
                            if (languageRawValue != null)
                                language = new Option<ItemsBatchPostRequest.LanguageEnum?>(ItemsBatchPostRequest.LanguageEnumFromStringOrDefault(languageRawValue));
                            break;
                        case "items":
        ...
        public void WriteProperties(Utf8JsonWriter writer, ItemsBatchPostRequest itemsBatchPostRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            var languageRawValue = ItemsBatchPostRequest.LanguageEnumToJsonValue(itemsBatchPostRequest.Language);
