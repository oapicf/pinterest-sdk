...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "InviteAssetsSummary_ad_accounts_inner")]
    public partial class InviteAssetsSummaryAdAccountsInner : IValidatableObject
    {
        ...
        public InviteAssetsSummaryAdAccountsInner(string id = default(string), List<string> permissions = default(List<string>))
        {
            this.Id = id;
