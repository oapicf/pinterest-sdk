...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AdGroupResponseAllOf :  IEquatable<AdGroupResponseAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AdGroupResponseAllOf" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as AdGroupResponseAllOf);
        }

        /// <summary>
        /// Returns true if AdGroupResponseAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of AdGroupResponseAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AdGroupResponseAllOf input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    ...
                    (this.LifetimeFrequencyCap != null &&
