...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class LeadFormResponse : IValidatableObject
    {
        ...
        public LeadFormResponse(string name = default(string), string privacyPolicyLink = default(string), bool hasAcceptedTerms = default(bool), string completionMessage = default(string), LeadFormStatus? status = default(LeadFormStatus?), string disclosureLanguage = default(string), List<LeadFormQuestion> questions = default(List<LeadFormQuestion>), string id = default(string), string adAccountId = default(string), int createdTime = default(int), int updatedTime = default(int))
        {
            this.Name = name;
