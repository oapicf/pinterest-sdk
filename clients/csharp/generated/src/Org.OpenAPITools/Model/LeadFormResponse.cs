...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class LeadFormResponse : IValidatableObject
    {
        ...
        [JsonConstructor]
        public LeadFormResponse(Option<string?> completionMessage = default, Option<string?> disclosureLanguage = default, Option<bool?> hasAcceptedTerms = default, Option<string?> name = default, Option<List<LeadFormCommonPolicyLinksInner>?> policyLinks = default, Option<string?> privacyPolicyLink = default, Option<List<LeadFormQuestion>?> questions = default, Option<LeadFormStatus?> status = default, Option<string?> adAccountId = default, Option<int?> createdTime = default, Option<string?> id = default, Option<int?> updatedTime = default)
        {
    ...
    public class LeadFormResponseJsonConverter : JsonConverter<LeadFormResponse>
    {
        ...
        public override LeadFormResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new LeadFormResponse(completionMessage, disclosureLanguage, hasAcceptedTerms, name, policyLinks, privacyPolicyLink, questions, status, adAccountId, createdTime, id, updatedTime);
        }
