...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class LeadFormResponse : IValidatableObject
    {
        ...
        [JsonConstructor]
        public LeadFormResponse(Option<string?> name = default, Option<string?> privacyPolicyLink = default, Option<bool?> hasAcceptedTerms = default, Option<string?> completionMessage = default, Option<LeadFormStatus?> status = default, Option<string?> disclosureLanguage = default, Option<List<LeadFormQuestion>?> questions = default, Option<List<LeadFormCommonPolicyLinksInner>?> policyLinks = default, Option<string?> id = default, Option<string?> adAccountId = default, Option<int?> createdTime = default, Option<int?> updatedTime = default)
        {
            NameOption = name;
    ...
    /// <summary>
    /// A Json converter for type <see cref="LeadFormResponse" />
    /// </summary>
    public class LeadFormResponseJsonConverter : JsonConverter<LeadFormResponse>
    {
        /// <summary>
        /// Deserializes json to <see cref="LeadFormResponse" />
        /// </summary>
        ...
        public override LeadFormResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (hasAcceptedTerms.IsSet && hasAcceptedTerms.Value == null)
                throw new ArgumentNullException(nameof(hasAcceptedTerms), "Property is not nullable for class LeadFormResponse.");

            if (status.IsSet && status.Value == null)
                throw new ArgumentNullException(nameof(status), "Property is not nullable for class LeadFormResponse.");

            if (questions.IsSet && questions.Value == null)
                throw new ArgumentNullException(nameof(questions), "Property is not nullable for class LeadFormResponse.");

            if (policyLinks.IsSet && policyLinks.Value == null)
                throw new ArgumentNullException(nameof(policyLinks), "Property is not nullable for class LeadFormResponse.");

            if (id.IsSet && id.Value == null)
                throw new ArgumentNullException(nameof(id), "Property is not nullable for class LeadFormResponse.");

            if (adAccountId.IsSet && adAccountId.Value == null)
                throw new ArgumentNullException(nameof(adAccountId), "Property is not nullable for class LeadFormResponse.");

            if (createdTime.IsSet && createdTime.Value == null)
                throw new ArgumentNullException(nameof(createdTime), "Property is not nullable for class LeadFormResponse.");

            if (updatedTime.IsSet && updatedTime.Value == null)
                throw new ArgumentNullException(nameof(updatedTime), "Property is not nullable for class LeadFormResponse.");

            return new LeadFormResponse(name, privacyPolicyLink, hasAcceptedTerms, completionMessage, status, disclosureLanguage, questions, policyLinks, id, adAccountId, createdTime, updatedTime);
        }

        /// <summary>
        /// Serializes a <see cref="LeadFormResponse" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="leadFormResponse"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, LeadFormResponse leadFormResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, leadFormResponse, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="LeadFormResponse" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="leadFormResponse"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, LeadFormResponse leadFormResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            if (leadFormResponse.QuestionsOption.IsSet && leadFormResponse.Questions == null)
                throw new ArgumentNullException(nameof(leadFormResponse.Questions), "Property is required for class LeadFormResponse.");

            if (leadFormResponse.PolicyLinksOption.IsSet && leadFormResponse.PolicyLinks == null)
                throw new ArgumentNullException(nameof(leadFormResponse.PolicyLinks), "Property is required for class LeadFormResponse.");

            if (leadFormResponse.IdOption.IsSet && leadFormResponse.Id == null)
                throw new ArgumentNullException(nameof(leadFormResponse.Id), "Property is required for class LeadFormResponse.");

            if (leadFormResponse.AdAccountIdOption.IsSet && leadFormResponse.AdAccountId == null)
                throw new ArgumentNullException(nameof(leadFormResponse.AdAccountId), "Property is required for class LeadFormResponse.");

            if (leadFormResponse.NameOption.IsSet)
                if (leadFormResponse.NameOption.Value != null)
                    writer.WriteString("name", leadFormResponse.Name);
                else
                    writer.WriteNull("name");

            if (leadFormResponse.PrivacyPolicyLinkOption.IsSet)
                if (leadFormResponse.PrivacyPolicyLinkOption.Value != null)
                    writer.WriteString("privacy_policy_link", leadFormResponse.PrivacyPolicyLink);
                else
                    writer.WriteNull("privacy_policy_link");

            if (leadFormResponse.HasAcceptedTermsOption.IsSet)
                writer.WriteBoolean("has_accepted_terms", leadFormResponse.HasAcceptedTermsOption.Value!.Value);

            if (leadFormResponse.CompletionMessageOption.IsSet)
                if (leadFormResponse.CompletionMessageOption.Value != null)
                    writer.WriteString("completion_message", leadFormResponse.CompletionMessage);
                else
                    writer.WriteNull("completion_message");

            if (leadFormResponse.StatusOption.IsSet)
            {
                var statusRawValue = LeadFormStatusValueConverter.ToJsonValue(leadFormResponse.Status!.Value);
                writer.WriteString("status", statusRawValue);
            }
            if (leadFormResponse.DisclosureLanguageOption.IsSet)
                if (leadFormResponse.DisclosureLanguageOption.Value != null)
                    writer.WriteString("disclosure_language", leadFormResponse.DisclosureLanguage);
                else
                    writer.WriteNull("disclosure_language");

            if (leadFormResponse.QuestionsOption.IsSet)
            {
                writer.WritePropertyName("questions");
                JsonSerializer.Serialize(writer, leadFormResponse.Questions, jsonSerializerOptions);
            }
            if (leadFormResponse.PolicyLinksOption.IsSet)
            {
                writer.WritePropertyName("policy_links");
                JsonSerializer.Serialize(writer, leadFormResponse.PolicyLinks, jsonSerializerOptions);
            }
            if (leadFormResponse.IdOption.IsSet)
                writer.WriteString("id", leadFormResponse.Id);

            if (leadFormResponse.AdAccountIdOption.IsSet)
                writer.WriteString("ad_account_id", leadFormResponse.AdAccountId);

            if (leadFormResponse.CreatedTimeOption.IsSet)
                writer.WriteNumber("created_time", leadFormResponse.CreatedTimeOption.Value!.Value);

            if (leadFormResponse.UpdatedTimeOption.IsSet)
                writer.WriteNumber("updated_time", leadFormResponse.UpdatedTimeOption.Value!.Value);
        }
    }
}
