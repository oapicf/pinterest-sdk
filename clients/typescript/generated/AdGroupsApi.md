...
let body:.AdGroupsApiAdGroupsAnalyticsRequest = {
...
apiInstance.adGroupsAnalytics(body).then((data:any) => {
...
let body:.AdGroupsApiAdGroupsAudienceSizingRequest = {
  // string | Unique identifier of an ad account.
  adAccountId: "4",
...
apiInstance.adGroupsAudienceSizing(body).then((data:any) => {
  console.log('API called successfully. Returned data: ' + data);
}).catch((error:any) => console.error(error));
```
...
let body:.AdGroupsApiAdGroupsBidFloorGetRequest = {
  // string | Unique identifier of an ad account.
  adAccountId: "4",
...
apiInstance.adGroupsBidFloorGet(body).then((data:any) => {
  console.log('API called successfully. Returned data: ' + data);
}).catch((error:any) => console.error(error));
```
...
let body:.AdGroupsApiAdGroupsCreateRequest = {
  // string | Unique identifier of an ad account.
  adAccountId: "4",
...
apiInstance.adGroupsCreate(body).then((data:any) => {
  console.log('API called successfully. Returned data: ' + data);
}).catch((error:any) => console.error(error));
```
...
let body:.AdGroupsApiAdGroupsGetRequest = {
  // string | Unique identifier of an ad account.
  adAccountId: "4",
...
apiInstance.adGroupsGet(body).then((data:any) => {
  console.log('API called successfully. Returned data: ' + data);
}).catch((error:any) => console.error(error));
```
...
let body:.AdGroupsApiAdGroupsListRequest = {
  // string | Unique identifier of an ad account.
  adAccountId: "4",
...
apiInstance.adGroupsList(body).then((data:any) => {
  console.log('API called successfully. Returned data: ' + data);
}).catch((error:any) => console.error(error));
```
...
let body:.AdGroupsApiAdGroupsTargetingAnalyticsGetRequest = {
  // string | Unique identifier of an ad account.
  adAccountId: "4",
  // Array<string> | List of Ad group Ids to use to filter the results.
  adGroupIds: [
...
apiInstance.adGroupsTargetingAnalyticsGet(body).then((data:any) => {
  console.log('API called successfully. Returned data: ' + data);
}).catch((error:any) => console.error(error));
```
...
let body:.AdGroupsApiAdGroupsUpdateRequest = {
  // string | Unique identifier of an ad account.
  adAccountId: "4",
...
apiInstance.adGroupsUpdate(body).then((data:any) => {
  console.log('API called successfully. Returned data: ' + data);
}).catch((error:any) => console.error(error));
```
