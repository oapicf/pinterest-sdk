...
export class ObservableAdvancedAuctionApi {
     ...
     * @param [adAccountId] Unique identifier of an ad account.
     */
    public advancedAuctionItemsGetPostWithHttpInfo(advancedAuctionItemsGetRequest: AdvancedAuctionItemsGetRequest, adAccountId?: string, _options?: Configuration): Observable<HttpInfo<AdvancedAuctionItems>> {
        const requestContextPromise = this.requestFactory.advancedAuctionItemsGetPost(advancedAuctionItemsGetRequest, adAccountId, _options);
     ...
     * @param [adAccountId] Unique identifier of an ad account.
     */
    public advancedAuctionItemsGetPost(advancedAuctionItemsGetRequest: AdvancedAuctionItemsGetRequest, adAccountId?: string, _options?: Configuration): Observable<AdvancedAuctionItems> {
     ...
     * @param [adAccountId] Unique identifier of an ad account.
     */
    public advancedAuctionItemsSubmitPostWithHttpInfo(advancedAuctionItemsSubmitRequest: AdvancedAuctionItemsSubmitRequest, adAccountId?: string, _options?: Configuration): Observable<HttpInfo<AdvancedAuctionProcessedItems>> {
        const requestContextPromise = this.requestFactory.advancedAuctionItemsSubmitPost(advancedAuctionItemsSubmitRequest, adAccountId, _options);
     ...
     * @param [adAccountId] Unique identifier of an ad account.
     */
    public advancedAuctionItemsSubmitPost(advancedAuctionItemsSubmitRequest: AdvancedAuctionItemsSubmitRequest, adAccountId?: string, _options?: Configuration): Observable<AdvancedAuctionProcessedItems> {
...
export class ObservableAudienceSharingApi {
     ...
     * @param [bookmark] Cursor used to fetch the next page of items
     */
    public adAccountsAudiencesSharedAccountsListWithHttpInfo(adAccountId: string, audienceId: string, accountType: AudienceAccountType, pageSize?: number, bookmark?: string, _options?: Configuration): Observable<HttpInfo<AdAccountsAudiencesSharedAccountsList200Response>> {
        const requestContextPromise = this.requestFactory.adAccountsAudiencesSharedAccountsList(adAccountId, audienceId, accountType, pageSize, bookmark, _options);
     ...
     * @param [bookmark] Cursor used to fetch the next page of items
     */
    public adAccountsAudiencesSharedAccountsList(adAccountId: string, audienceId: string, accountType: AudienceAccountType, pageSize?: number, bookmark?: string, _options?: Configuration): Observable<AdAccountsAudiencesSharedAccountsList200Response> {
     ...
     * @param [bookmark] Cursor used to fetch the next page of items
     */
    public businessAccountAudiencesSharedAccountsListWithHttpInfo(businessId: string, audienceId: string, accountType: AudienceAccountType, pageSize?: number, bookmark?: string, _options?: Configuration): Observable<HttpInfo<AdAccountsAudiencesSharedAccountsList200Response>> {
        const requestContextPromise = this.requestFactory.businessAccountAudiencesSharedAccountsList(businessId, audienceId, accountType, pageSize, bookmark, _options);
     ...
     * @param [bookmark] Cursor used to fetch the next page of items
     */
    public businessAccountAudiencesSharedAccountsList(businessId: string, audienceId: string, accountType: AudienceAccountType, pageSize?: number, bookmark?: string, _options?: Configuration): Observable<AdAccountsAudiencesSharedAccountsList200Response> {
     ...
     * @param [pageSize] Maximum number of items to include in a single page of the response. See documentation on &lt;a href&#x3D;\&#39;/docs/reference/pagination/\&#39;&gt;Pagination&lt;/a&gt; for more information.
     */
    public sharedAudiencesForBusinessListWithHttpInfo(businessId: string, bookmark?: string, order?: 'ASCENDING' | 'DESCENDING', pageSize?: number, _options?: Configuration): Observable<HttpInfo<AudiencesList200Response>> {
        const requestContextPromise = this.requestFactory.sharedAudiencesForBusinessList(businessId, bookmark, order, pageSize, _options);
     ...
     * @param [pageSize] Maximum number of items to include in a single page of the response. See documentation on &lt;a href&#x3D;\&#39;/docs/reference/pagination/\&#39;&gt;Pagination&lt;/a&gt; for more information.
     */
    public sharedAudiencesForBusinessList(businessId: string, bookmark?: string, order?: 'ASCENDING' | 'DESCENDING', pageSize?: number, _options?: Configuration): Observable<AudiencesList200Response> {
     ...
     */
    public updateAdAccountToAdAccountSharedAudienceWithHttpInfo(adAccountId: string, sharedAudience: SharedAudience, _options?: Configuration): Observable<HttpInfo<SharedAudienceResponse>> {
        const requestContextPromise = this.requestFactory.updateAdAccountToAdAccountSharedAudience(adAccountId, sharedAudience, _options);
     ...
     * @param sharedAudience
     */
    public updateAdAccountToAdAccountSharedAudience(adAccountId: string, sharedAudience: SharedAudience, _options?: Configuration): Observable<SharedAudienceResponse> {
     ...
     */
    public updateAdAccountToBusinessSharedAudienceWithHttpInfo(adAccountId: string, businessSharedAudience: BusinessSharedAudience, _options?: Configuration): Observable<HttpInfo<BusinessSharedAudienceResponse>> {
        const requestContextPromise = this.requestFactory.updateAdAccountToBusinessSharedAudience(adAccountId, businessSharedAudience, _options);
     ...
     * @param businessSharedAudience
     */
    public updateAdAccountToBusinessSharedAudience(adAccountId: string, businessSharedAudience: BusinessSharedAudience, _options?: Configuration): Observable<BusinessSharedAudienceResponse> {
     ...
     * @param sharedAudience
     */
    public updateBusinessToAdAccountSharedAudienceWithHttpInfo(businessId: string, sharedAudience: SharedAudience, _options?: Configuration): Observable<HttpInfo<SharedAudienceResponse>> {
        const requestContextPromise = this.requestFactory.updateBusinessToAdAccountSharedAudience(businessId, sharedAudience, _options);
     ...
     * @param sharedAudience
     */
    public updateBusinessToAdAccountSharedAudience(businessId: string, sharedAudience: SharedAudience, _options?: Configuration): Observable<SharedAudienceResponse> {
     ...
     * @param businessSharedAudience
     */
    public updateBusinessToBusinessSharedAudienceWithHttpInfo(businessId: string, businessSharedAudience: BusinessSharedAudience, _options?: Configuration): Observable<HttpInfo<BusinessSharedAudienceResponse>> {
        const requestContextPromise = this.requestFactory.updateBusinessToBusinessSharedAudience(businessId, businessSharedAudience, _options);
     ...
     * @param businessSharedAudience
     */
    public updateBusinessToBusinessSharedAudience(businessId: string, businessSharedAudience: BusinessSharedAudience, _options?: Configuration): Observable<BusinessSharedAudienceResponse> {
...
export class ObservableBusinessAccessAssetsApi {
     ...
     */
    public assetGroupCreateWithHttpInfo(businessId: string, createAssetGroupBody: CreateAssetGroupBody, _options?: Configuration): Observable<HttpInfo<CreateAssetGroupResponse>> {
        const requestContextPromise = this.requestFactory.assetGroupCreate(businessId, createAssetGroupBody, _options);
     ...
     * @param createAssetGroupBody
     */
    public assetGroupCreate(businessId: string, createAssetGroupBody: CreateAssetGroupBody, _options?: Configuration): Observable<CreateAssetGroupResponse> {
     ...
     */
    public assetGroupDeleteWithHttpInfo(businessId: string, deleteAssetGroupBody: DeleteAssetGroupBody, _options?: Configuration): Observable<HttpInfo<DeleteAssetGroupResponse>> {
        const requestContextPromise = this.requestFactory.assetGroupDelete(businessId, deleteAssetGroupBody, _options);
     ...
     * @param deleteAssetGroupBody
     */
    public assetGroupDelete(businessId: string, deleteAssetGroupBody: DeleteAssetGroupBody, _options?: Configuration): Observable<DeleteAssetGroupResponse> {
     ...
     */
    public assetGroupUpdateWithHttpInfo(businessId: string, updateAssetGroupBody: UpdateAssetGroupBody, _options?: Configuration): Observable<HttpInfo<UpdateAssetGroupResponse>> {
        const requestContextPromise = this.requestFactory.assetGroupUpdate(businessId, updateAssetGroupBody, _options);
     ...
     * @param updateAssetGroupBody
     */
    public assetGroupUpdate(businessId: string, updateAssetGroupBody: UpdateAssetGroupBody, _options?: Configuration): Observable<UpdateAssetGroupResponse> {
     ...
     */
    public businessAssetMembersGetWithHttpInfo(businessId: string, assetId: string, bookmark?: string, pageSize?: number, startIndex?: number, _options?: Configuration): Observable<HttpInfo<BusinessAssetMembersGet200Response>> {
        const requestContextPromise = this.requestFactory.businessAssetMembersGet(businessId, assetId, bookmark, pageSize, startIndex, _options);
     ...
     * @param [startIndex] An index to start fetching the results from. Only the results starting from this index will be returned.
     */
    public businessAssetMembersGet(businessId: string, assetId: string, bookmark?: string, pageSize?: number, startIndex?: number, _options?: Configuration): Observable<BusinessAssetMembersGet200Response> {
     ...
     * @param [pageSize] Maximum number of items to include in a single page of the response. See documentation on &lt;a href&#x3D;\&#39;/docs/reference/pagination/\&#39;&gt;Pagination&lt;/a&gt; for more information.
     */
    public businessAssetPartnersGetWithHttpInfo(businessId: string, assetId: string, startIndex?: number, bookmark?: string, pageSize?: number, _options?: Configuration): Observable<HttpInfo<BusinessAssetPartnersGet200Response>> {
        const requestContextPromise = this.requestFactory.businessAssetPartnersGet(businessId, assetId, startIndex, bookmark, pageSize, _options);
     ...
     * @param [pageSize] Maximum number of items to include in a single page of the response. See documentation on &lt;a href&#x3D;\&#39;/docs/reference/pagination/\&#39;&gt;Pagination&lt;/a&gt; for more information.
     */
    public businessAssetPartnersGet(businessId: string, assetId: string, startIndex?: number, bookmark?: string, pageSize?: number, _options?: Configuration): Observable<BusinessAssetPartnersGet200Response> {
     ...
     * @param [pageSize] Maximum number of items to include in a single page of the response. See documentation on &lt;a href&#x3D;\&#39;/docs/reference/pagination/\&#39;&gt;Pagination&lt;/a&gt; for more information.
     */
    public businessAssetsGetWithHttpInfo(businessId: string, permissions?: Array<PermissionsWithOwner>, childAssetId?: string, assetGroupId?: string, assetType?: 'AD_ACCOUNT' | 'PROFILE' | 'ASSET_GROUP', startIndex?: number, bookmark?: string, pageSize?: number, _options?: Configuration): Observable<HttpInfo<BusinessAssetsGet200Response>> {
        const requestContextPromise = this.requestFactory.businessAssetsGet(businessId, permissions, childAssetId, assetGroupId, assetType, startIndex, bookmark, pageSize, _options);
     ...
     * @param [pageSize] Maximum number of items to include in a single page of the response. See documentation on &lt;a href&#x3D;\&#39;/docs/reference/pagination/\&#39;&gt;Pagination&lt;/a&gt; for more information.
     */
    public businessAssetsGet(businessId: string, permissions?: Array<PermissionsWithOwner>, childAssetId?: string, assetGroupId?: string, assetType?: 'AD_ACCOUNT' | 'PROFILE' | 'ASSET_GROUP', startIndex?: number, bookmark?: string, pageSize?: number, _options?: Configuration): Observable<BusinessAssetsGet200Response> {
     ...
     * @param [pageSize] Maximum number of items to include in a single page of the response. See documentation on &lt;a href&#x3D;\&#39;/docs/reference/pagination/\&#39;&gt;Pagination&lt;/a&gt; for more information.
     */
    public businessMemberAssetsGetWithHttpInfo(businessId: string, memberId: string, assetType?: 'AD_ACCOUNT' | 'PROFILE' | 'ASSET_GROUP', startIndex?: number, bookmark?: string, pageSize?: number, _options?: Configuration): Observable<HttpInfo<BusinessMemberAssetsGet200Response>> {
        const requestContextPromise = this.requestFactory.businessMemberAssetsGet(businessId, memberId, assetType, startIndex, bookmark, pageSize, _options);
     ...
     * @param [pageSize] Maximum number of items to include in a single page of the response. See documentation on &lt;a href&#x3D;\&#39;/docs/reference/pagination/\&#39;&gt;Pagination&lt;/a&gt; for more information.
     */
    public businessMemberAssetsGet(businessId: string, memberId: string, assetType?: 'AD_ACCOUNT' | 'PROFILE' | 'ASSET_GROUP', startIndex?: number, bookmark?: string, pageSize?: number, _options?: Configuration): Observable<BusinessMemberAssetsGet200Response> {
     ...
     */
    public businessMembersAssetAccessDeleteWithHttpInfo(businessId: string, businessMembersAssetAccessDeleteRequest: BusinessMembersAssetAccessDeleteRequest, _options?: Configuration): Observable<HttpInfo<DeleteMemberAccessResultsResponseArray>> {
        const requestContextPromise = this.requestFactory.businessMembersAssetAccessDelete(businessId, businessMembersAssetAccessDeleteRequest, _options);
     ...
     * @param businessMembersAssetAccessDeleteRequest List member assset permissions to delete.
     */
    public businessMembersAssetAccessDelete(businessId: string, businessMembersAssetAccessDeleteRequest: BusinessMembersAssetAccessDeleteRequest, _options?: Configuration): Observable<DeleteMemberAccessResultsResponseArray> {
     ...
     */
    public businessMembersAssetAccessUpdateWithHttpInfo(businessId: string, updateMemberAssetAccessBody: UpdateMemberAssetAccessBody, _options?: Configuration): Observable<HttpInfo<UpdateMemberAssetsResultsResponseArray>> {
        const requestContextPromise = this.requestFactory.businessMembersAssetAccessUpdate(businessId, updateMemberAssetAccessBody, _options);
     ...
     * @param updateMemberAssetAccessBody List of member asset permissions to create or update.
     */
    public businessMembersAssetAccessUpdate(businessId: string, updateMemberAssetAccessBody: UpdateMemberAssetAccessBody, _options?: Configuration): Observable<UpdateMemberAssetsResultsResponseArray> {
     ...
     * @param [bookmark] Cursor used to fetch the next page of items
     */
    public businessPartnerAssetAccessGetWithHttpInfo(businessId: string, partnerId: string, partnerType?: PartnerType, assetType?: 'AD_ACCOUNT' | 'PROFILE' | 'ASSET_GROUP', startIndex?: number, pageSize?: number, bookmark?: string, _options?: Configuration): Observable<HttpInfo<BusinessPartnerAssetAccessGet200Response>> {
        const requestContextPromise = this.requestFactory.businessPartnerAssetAccessGet(businessId, partnerId, partnerType, assetType, startIndex, pageSize, bookmark, _options);
     ...
     * @param [bookmark] Cursor used to fetch the next page of items
     */
    public businessPartnerAssetAccessGet(businessId: string, partnerId: string, partnerType?: PartnerType, assetType?: 'AD_ACCOUNT' | 'PROFILE' | 'ASSET_GROUP', startIndex?: number, pageSize?: number, bookmark?: string, _options?: Configuration): Observable<BusinessPartnerAssetAccessGet200Response> {
     ...
     */
    public deletePartnerAssetAccessHandlerImplWithHttpInfo(businessId: string, deletePartnerAssetAccessBody: DeletePartnerAssetAccessBody, _options?: Configuration): Observable<HttpInfo<DeletePartnerAssetsResultsResponseArray>> {
        const requestContextPromise = this.requestFactory.deletePartnerAssetAccessHandlerImpl(businessId, deletePartnerAssetAccessBody, _options);
     ...
     * @param deletePartnerAssetAccessBody
     */
    public deletePartnerAssetAccessHandlerImpl(businessId: string, deletePartnerAssetAccessBody: DeletePartnerAssetAccessBody, _options?: Configuration): Observable<DeletePartnerAssetsResultsResponseArray> {
     ...
     */
    public updatePartnerAssetAccessHandlerImplWithHttpInfo(businessId: string, updatePartnerAssetAccessBody: UpdatePartnerAssetAccessBody, _options?: Configuration): Observable<HttpInfo<UpdatePartnerAssetsResultsResponseArray>> {
        const requestContextPromise = this.requestFactory.updatePartnerAssetAccessHandlerImpl(businessId, updatePartnerAssetAccessBody, _options);
     ...
     * @param updatePartnerAssetAccessBody A list of assets and permissions to assign to your partners.
     */
    public updatePartnerAssetAccessHandlerImpl(businessId: string, updatePartnerAssetAccessBody: UpdatePartnerAssetAccessBody, _options?: Configuration): Observable<UpdatePartnerAssetsResultsResponseArray> {
...
export class ObservableBusinessAccessInviteApi {
     ...
     */
    public assetAccessRequestsCreateWithHttpInfo(businessId: string, createAssetAccessRequestBody: CreateAssetAccessRequestBody, _options?: Configuration): Observable<HttpInfo<CreateAssetAccessRequestResponse>> {
        const requestContextPromise = this.requestFactory.assetAccessRequestsCreate(businessId, createAssetAccessRequestBody, _options);
     ...
     * @param createAssetAccessRequestBody
     */
    public assetAccessRequestsCreate(businessId: string, createAssetAccessRequestBody: CreateAssetAccessRequestBody, _options?: Configuration): Observable<CreateAssetAccessRequestResponse> {
     ...
     */
    public cancelInvitesOrRequestsWithHttpInfo(businessId: string, cancelInvitesBody: CancelInvitesBody, _options?: Configuration): Observable<HttpInfo<DeleteInvitesResultsResponseArray>> {
        const requestContextPromise = this.requestFactory.cancelInvitesOrRequests(businessId, cancelInvitesBody, _options);
     ...
     * @param cancelInvitesBody A list with invite ids
     */
    public cancelInvitesOrRequests(businessId: string, cancelInvitesBody: CancelInvitesBody, _options?: Configuration): Observable<DeleteInvitesResultsResponseArray> {
     ...
     */
    public createAssetInvitesWithHttpInfo(businessId: string, createAssetInvitesRequest: CreateAssetInvitesRequest, _options?: Configuration): Observable<HttpInfo<UpdateInvitesResultsResponseArray>> {
        const requestContextPromise = this.requestFactory.createAssetInvites(businessId, createAssetInvitesRequest, _options);
     ...
     * @param createAssetInvitesRequest A list of invites/requests together with the asset permissions to be assigned to the invite/request. 
     */
    public createAssetInvites(businessId: string, createAssetInvitesRequest: CreateAssetInvitesRequest, _options?: Configuration): Observable<UpdateInvitesResultsResponseArray> {
     ...
     */
    public createMembershipOrPartnershipInvitesWithHttpInfo(businessId: string, createMembershipOrPartnershipInvitesBody: CreateMembershipOrPartnershipInvitesBody, _options?: Configuration): Observable<HttpInfo<CreateInvitesResultsResponseArray>> {
        const requestContextPromise = this.requestFactory.createMembershipOrPartnershipInvites(businessId, createMembershipOrPartnershipInvitesBody, _options);
     ...
     * @param createMembershipOrPartnershipInvitesBody An object with the properties: invite_type, partners, members, business_role
     */
    public createMembershipOrPartnershipInvites(businessId: string, createMembershipOrPartnershipInvitesBody: CreateMembershipOrPartnershipInvitesBody, _options?: Configuration): Observable<CreateInvitesResultsResponseArray> {
     ...
     * @param [pageSize] Maximum number of items to include in a single page of the response. See documentation on &lt;a href&#x3D;\&#39;/docs/reference/pagination/\&#39;&gt;Pagination&lt;/a&gt; for more information.
     */
    public getInvitesWithHttpInfo(businessId: string, isMember?: boolean, inviteStatus?: Array<'PENDING' | 'EXPIRED'>, inviteType?: InviteType, bookmark?: string, pageSize?: number, _options?: Configuration): Observable<HttpInfo<GetInvites200Response>> {
        const requestContextPromise = this.requestFactory.getInvites(businessId, isMember, inviteStatus, inviteType, bookmark, pageSize, _options);
     ...
     * @param [pageSize] Maximum number of items to include in a single page of the response. See documentation on &lt;a href&#x3D;\&#39;/docs/reference/pagination/\&#39;&gt;Pagination&lt;/a&gt; for more information.
     */
    public getInvites(businessId: string, isMember?: boolean, inviteStatus?: Array<'PENDING' | 'EXPIRED'>, inviteType?: InviteType, bookmark?: string, pageSize?: number, _options?: Configuration): Observable<GetInvites200Response> {
     ...
     */
    public respondBusinessAccessInvitesWithHttpInfo(authRespondInvitesBody: AuthRespondInvitesBody, _options?: Configuration): Observable<HttpInfo<RespondToInvitesResponseArray>> {
        const requestContextPromise = this.requestFactory.respondBusinessAccessInvites(authRespondInvitesBody, _options);
     ...
     * @param authRespondInvitesBody
     */
    public respondBusinessAccessInvites(authRespondInvitesBody: AuthRespondInvitesBody, _options?: Configuration): Observable<RespondToInvitesResponseArray> {
...
export class ObservableBusinessAccessRelationshipsApi {
     ...
     */
    public deleteBusinessMembershipWithHttpInfo(businessId: string, membersToDeleteBody: MembersToDeleteBody, _options?: Configuration): Observable<HttpInfo<DeletedMembersResponse>> {
        const requestContextPromise = this.requestFactory.deleteBusinessMembership(businessId, membersToDeleteBody, _options);
     ...
     * @param membersToDeleteBody List of members with role to delete.
     */
    public deleteBusinessMembership(businessId: string, membersToDeleteBody: MembersToDeleteBody, _options?: Configuration): Observable<DeletedMembersResponse> {
     ...
     */
    public deleteBusinessPartnersWithHttpInfo(businessId: string, deletePartnersRequest: DeletePartnersRequest, _options?: Configuration): Observable<HttpInfo<DeletePartnersResponse>> {
        const requestContextPromise = this.requestFactory.deleteBusinessPartners(businessId, deletePartnersRequest, _options);
     ...
     * @param deletePartnersRequest An object containing a \&quot;partner_ids\&quot; property composed of a list of partner IDs and a \&quot;partners_type\&quot; property specifying the type of partners to delete. 
     */
    public deleteBusinessPartners(businessId: string, deletePartnersRequest: DeletePartnersRequest, _options?: Configuration): Observable<DeletePartnersResponse> {
     ...
     * @param [bookmark] Cursor used to fetch the next page of items
     */
    public getBusinessEmployersWithHttpInfo(pageSize?: number, bookmark?: string, _options?: Configuration): Observable<HttpInfo<GetBusinessEmployers200Response>> {
        const requestContextPromise = this.requestFactory.getBusinessEmployers(pageSize, bookmark, _options);
     ...
     * @param [bookmark] Cursor used to fetch the next page of items
     */
    public getBusinessEmployers(pageSize?: number, bookmark?: string, _options?: Configuration): Observable<GetBusinessEmployers200Response> {
     ...
     * @param [pageSize] Maximum number of items to include in a single page of the response. See documentation on &lt;a href&#x3D;\&#39;/docs/reference/pagination/\&#39;&gt;Pagination&lt;/a&gt; for more information.
     */
    public getBusinessMembersWithHttpInfo(businessId: string, assetsSummary?: boolean, businessRoles?: Array<MemberBusinessRole>, memberIds?: string, startIndex?: number, bookmark?: string, pageSize?: number, _options?: Configuration): Observable<HttpInfo<GetBusinessMembers200Response>> {
        const requestContextPromise = this.requestFactory.getBusinessMembers(businessId, assetsSummary, businessRoles, memberIds, startIndex, bookmark, pageSize, _options);
     ...
     * @param [pageSize] Maximum number of items to include in a single page of the response. See documentation on &lt;a href&#x3D;\&#39;/docs/reference/pagination/\&#39;&gt;Pagination&lt;/a&gt; for more information.
     */
    public getBusinessMembers(businessId: string, assetsSummary?: boolean, businessRoles?: Array<MemberBusinessRole>, memberIds?: string, startIndex?: number, bookmark?: string, pageSize?: number, _options?: Configuration): Observable<GetBusinessMembers200Response> {
     ...
     * @param [bookmark] Cursor used to fetch the next page of items
     */
    public getBusinessPartnersWithHttpInfo(businessId: string, assetsSummary?: boolean, partnerType?: PartnerType, partnerIds?: string, startIndex?: number, pageSize?: number, bookmark?: string, _options?: Configuration): Observable<HttpInfo<GetBusinessPartners200Response>> {
        const requestContextPromise = this.requestFactory.getBusinessPartners(businessId, assetsSummary, partnerType, partnerIds, startIndex, pageSize, bookmark, _options);
     ...
     * @param [bookmark] Cursor used to fetch the next page of items
     */
    public getBusinessPartners(businessId: string, assetsSummary?: boolean, partnerType?: PartnerType, partnerIds?: string, startIndex?: number, pageSize?: number, bookmark?: string, _options?: Configuration): Observable<GetBusinessPartners200Response> {
     ...
     */
    public updateBusinessMembershipsWithHttpInfo(businessId: string, updateMemberBusinessRoleBody: Array<UpdateMemberBusinessRoleBody>, _options?: Configuration): Observable<HttpInfo<UpdateMemberResultsResponseArray>> {
        const requestContextPromise = this.requestFactory.updateBusinessMemberships(businessId, updateMemberBusinessRoleBody, _options);
     ...
     * @param updateMemberBusinessRoleBody List of objects with the member id and the business_role.
     */
    public updateBusinessMemberships(businessId: string, updateMemberBusinessRoleBody: Array<UpdateMemberBusinessRoleBody>, _options?: Configuration): Observable<UpdateMemberResultsResponseArray> {
...
export class ObservableCatalogsApi {
     ...
     * @param [adAccountId] Unique identifier of an ad account.
     */
    public catalogsCreateWithHttpInfo(catalogsCreateRequest: CatalogsCreateRequest, adAccountId?: string, _options?: Configuration): Observable<HttpInfo<Catalog>> {
        const requestContextPromise = this.requestFactory.catalogsCreate(catalogsCreateRequest, adAccountId, _options);
     ...
     * @param [adAccountId] Unique identifier of an ad account.
     */
    public catalogsCreate(catalogsCreateRequest: CatalogsCreateRequest, adAccountId?: string, _options?: Configuration): Observable<Catalog> {
     ...
     * @param [pinMetrics] Specify whether to return 90d and lifetime Pin metrics. Total comments and total reactions are only available with lifetime Pin metrics. If Pin was created before &lt;code&gt;2023-03-20&lt;/code&gt; lifetime metrics will only be available for Video and Idea Pin formats. Lifetime metrics are available for all Pin formats since then.
     */
    public catalogsProductGroupPinsListWithHttpInfo(productGroupId: string, bookmark?: string, pageSize?: number, adAccountId?: string, pinMetrics?: boolean, _options?: Configuration): Observable<HttpInfo<CatalogsProductGroupPinsList200Response>> {
        const requestContextPromise = this.requestFactory.catalogsProductGroupPinsList(productGroupId, bookmark, pageSize, adAccountId, pinMetrics, _options);
     ...
     * @param [pinMetrics] Specify whether to return 90d and lifetime Pin metrics. Total comments and total reactions are only available with lifetime Pin metrics. If Pin was created before &lt;code&gt;2023-03-20&lt;/code&gt; lifetime metrics will only be available for Video and Idea Pin formats. Lifetime metrics are available for all Pin formats since then.
     */
    public catalogsProductGroupPinsList(productGroupId: string, bookmark?: string, pageSize?: number, adAccountId?: string, pinMetrics?: boolean, _options?: Configuration): Observable<CatalogsProductGroupPinsList200Response> {
     ...
     * @param [adAccountId] Unique identifier of an ad account.
     */
    public catalogsProductGroupsCreateWithHttpInfo(multipleProductGroupsInner: MultipleProductGroupsInner, adAccountId?: string, _options?: Configuration): Observable<HttpInfo<CatalogsVerticalProductGroup>> {
        const requestContextPromise = this.requestFactory.catalogsProductGroupsCreate(multipleProductGroupsInner, adAccountId, _options);
     ...
     * @param [adAccountId] Unique identifier of an ad account.
     */
    public catalogsProductGroupsCreate(multipleProductGroupsInner: MultipleProductGroupsInner, adAccountId?: string, _options?: Configuration): Observable<CatalogsVerticalProductGroup> {
     ...
     * @param [adAccountId] Unique identifier of an ad account.
     */
    public catalogsProductGroupsCreateManyWithHttpInfo(multipleProductGroupsInner: Array<MultipleProductGroupsInner>, adAccountId?: string, _options?: Configuration): Observable<HttpInfo<Array<string>>> {
        const requestContextPromise = this.requestFactory.catalogsProductGroupsCreateMany(multipleProductGroupsInner, adAccountId, _options);
     ...
     * @param [adAccountId] Unique identifier of an ad account.
     */
    public catalogsProductGroupsCreateMany(multipleProductGroupsInner: Array<MultipleProductGroupsInner>, adAccountId?: string, _options?: Configuration): Observable<Array<string>> {
     ...
     * @param [adAccountId] Unique identifier of an ad account.
     */
    public catalogsProductGroupsDeleteManyWithHttpInfo(id: Array<number>, adAccountId?: string, _options?: Configuration): Observable<HttpInfo<void>> {
        const requestContextPromise = this.requestFactory.catalogsProductGroupsDeleteMany(id, adAccountId, _options);
     ...
     * @param [adAccountId] Unique identifier of an ad account.
     */
    public catalogsProductGroupsDeleteMany(id: Array<number>, adAccountId?: string, _options?: Configuration): Observable<void> {
     ...
     * @param [adAccountId] Unique identifier of an ad account.
     */
    public catalogsProductGroupsGetWithHttpInfo(productGroupId: string, adAccountId?: string, _options?: Configuration): Observable<HttpInfo<CatalogsVerticalProductGroup>> {
     ...
     * @param [adAccountId] Unique identifier of an ad account.
     */
    public catalogsProductGroupsGet(productGroupId: string, adAccountId?: string, _options?: Configuration): Observable<CatalogsVerticalProductGroup> {
     ...
     * @param [adAccountId] Unique identifier of an ad account.
     */
    public catalogsProductGroupsListWithHttpInfo(id?: Array<number>, feedId?: string, catalogId?: string, bookmark?: string, pageSize?: number, adAccountId?: string, _options?: Configuration): Observable<HttpInfo<CatalogsProductGroupsList200Response>> {
        const requestContextPromise = this.requestFactory.catalogsProductGroupsList(id, feedId, catalogId, bookmark, pageSize, adAccountId, _options);
     ...
     * @param [adAccountId] Unique identifier of an ad account.
     */
    public catalogsProductGroupsList(id?: Array<number>, feedId?: string, catalogId?: string, bookmark?: string, pageSize?: number, adAccountId?: string, _options?: Configuration): Observable<CatalogsProductGroupsList200Response> {
     ...
     * @param [adAccountId] Unique identifier of an ad account.
     */
    public catalogsProductGroupsProductCountsGetWithHttpInfo(productGroupId: string, adAccountId?: string, _options?: Configuration): Observable<HttpInfo<CatalogsProductGroupProductCountsVertical>> {
     ...
     * @param [adAccountId] Unique identifier of an ad account.
     */
    public catalogsProductGroupsProductCountsGet(productGroupId: string, adAccountId?: string, _options?: Configuration): Observable<CatalogsProductGroupProductCountsVertical> {
     ...
     * @param [adAccountId] Unique identifier of an ad account.
     */
    public catalogsProductGroupsUpdateWithHttpInfo(productGroupId: string, catalogsProductGroupsUpdateRequest: CatalogsProductGroupsUpdateRequest, adAccountId?: string, _options?: Configuration): Observable<HttpInfo<CatalogsVerticalProductGroup>> {
     ...
     * @param [adAccountId] Unique identifier of an ad account.
     */
    public catalogsProductGroupsUpdate(productGroupId: string, catalogsProductGroupsUpdateRequest: CatalogsProductGroupsUpdateRequest, adAccountId?: string, _options?: Configuration): Observable<CatalogsVerticalProductGroup> {
     ...
     * @param [adAccountId] Unique identifier of an ad account.
     */
    public feedsIngestWithHttpInfo(feedId: string, adAccountId?: string, _options?: Configuration): Observable<HttpInfo<CatalogsFeedIngestion>> {
        const requestContextPromise = this.requestFactory.feedsIngest(feedId, adAccountId, _options);
     ...
     * @param [adAccountId] Unique identifier of an ad account.
     */
    public feedsIngest(feedId: string, adAccountId?: string, _options?: Configuration): Observable<CatalogsFeedIngestion> {
     ...
     * @param [adAccountId] Unique identifier of an ad account.
     */
    public itemsPostWithHttpInfo(catalogsItemsRequest: CatalogsItemsRequest, adAccountId?: string, _options?: Configuration): Observable<HttpInfo<CatalogsItems>> {
        const requestContextPromise = this.requestFactory.itemsPost(catalogsItemsRequest, adAccountId, _options);
     ...
     * @param [adAccountId] Unique identifier of an ad account.
     */
    public itemsPost(catalogsItemsRequest: CatalogsItemsRequest, adAccountId?: string, _options?: Configuration): Observable<CatalogsItems> {
     ...
     * @param [pinMetrics] Specify whether to return 90d and lifetime Pin metrics. Total comments and total reactions are only available with lifetime Pin metrics. If Pin was created before &lt;code&gt;2023-03-20&lt;/code&gt; lifetime metrics will only be available for Video and Idea Pin formats. Lifetime metrics are available for all Pin formats since then.
     */
    public productsByProductGroupFilterListWithHttpInfo(catalogsListProductsByFilterRequest: CatalogsListProductsByFilterRequest, bookmark?: string, pageSize?: number, adAccountId?: string, pinMetrics?: boolean, _options?: Configuration): Observable<HttpInfo<CatalogsProductGroupPinsList200Response>> {
        const requestContextPromise = this.requestFactory.productsByProductGroupFilterList(catalogsListProductsByFilterRequest, bookmark, pageSize, adAccountId, pinMetrics, _options);
     ...
     * @param [pinMetrics] Specify whether to return 90d and lifetime Pin metrics. Total comments and total reactions are only available with lifetime Pin metrics. If Pin was created before &lt;code&gt;2023-03-20&lt;/code&gt; lifetime metrics will only be available for Video and Idea Pin formats. Lifetime metrics are available for all Pin formats since then.
     */
    public productsByProductGroupFilterList(catalogsListProductsByFilterRequest: CatalogsListProductsByFilterRequest, bookmark?: string, pageSize?: number, adAccountId?: string, pinMetrics?: boolean, _options?: Configuration): Observable<CatalogsProductGroupPinsList200Response> {
     ...
     * @param [adAccountId] Unique identifier of an ad account.
     */
    public reportsCreateWithHttpInfo(catalogsReportParameters: CatalogsReportParameters, adAccountId?: string, _options?: Configuration): Observable<HttpInfo<CatalogsCreateReportResponse>> {
        const requestContextPromise = this.requestFactory.reportsCreate(catalogsReportParameters, adAccountId, _options);
     ...
     * @param [adAccountId] Unique identifier of an ad account.
     */
    public reportsCreate(catalogsReportParameters: CatalogsReportParameters, adAccountId?: string, _options?: Configuration): Observable<CatalogsCreateReportResponse> {
     ...
     * @param [adAccountId] Unique identifier of an ad account.
     */
    public reportsGetWithHttpInfo(token: string, adAccountId?: string, _options?: Configuration): Observable<HttpInfo<CatalogsReport>> {
        const requestContextPromise = this.requestFactory.reportsGet(token, adAccountId, _options);
     ...
     * @param [adAccountId] Unique identifier of an ad account.
     */
    public reportsGet(token: string, adAccountId?: string, _options?: Configuration): Observable<CatalogsReport> {
     ...
     * @param [bookmark] Cursor used to fetch the next page of items
     */
    public reportsStatsWithHttpInfo(parameters: CatalogsReportParameters, adAccountId?: string, pageSize?: number, bookmark?: string, _options?: Configuration): Observable<HttpInfo<ReportsStats200Response>> {
        const requestContextPromise = this.requestFactory.reportsStats(parameters, adAccountId, pageSize, bookmark, _options);
     ...
     * @param [bookmark] Cursor used to fetch the next page of items
     */
    public reportsStats(parameters: CatalogsReportParameters, adAccountId?: string, pageSize?: number, bookmark?: string, _options?: Configuration): Observable<ReportsStats200Response> {
...
export class ObservableKeywordsApi {
    ...
    public trendingKeywordsListWithHttpInfo(region: TrendsSupportedRegion, trendType: TrendType, interests?: Array<'animals' | 'architecture' | 'art' | 'beauty' | 'childrens_fashion' | 'design' | 'diy_and_crafts' | 'education' | 'electronics' | 'entertainment' | 'event_planning' | 'finance' | 'food_and_drinks' | 'gardening' | 'health' | 'home_decor' | 'mens_fashion' | 'parenting' | 'quotes' | 'sport' | 'travel' | 'vehicles' | 'wedding' | 'womens_fashion'>, genders?: Array<'female' | 'male' | 'unknown'>, ages?: Array<'18-24' | '25-34' | '35-44' | '45-49' | '50-54' | '55-64' | '65+'>, includeKeywords?: Array<string>, normalizeAgainstGroup?: boolean, limit?: number, _options?: Configuration): Observable<HttpInfo<TrendingKeywordsResponse>> {
        const requestContextPromise = this.requestFactory.trendingKeywordsList(region, trendType, interests, genders, ages, includeKeywords, normalizeAgainstGroup, limit, _options);
...
export class ObservableLeadFormsApi {
     ...
     */
    public leadFormsCreateWithHttpInfo(adAccountId: string, leadFormCreateRequest: Array<LeadFormCreateRequest>, _options?: Configuration): Observable<HttpInfo<LeadFormArrayResponse>> {
        const requestContextPromise = this.requestFactory.leadFormsCreate(adAccountId, leadFormCreateRequest, _options);
     ...
     * @param leadFormCreateRequest List of lead forms to create, size limit [1, 30].
     */
    public leadFormsCreate(adAccountId: string, leadFormCreateRequest: Array<LeadFormCreateRequest>, _options?: Configuration): Observable<LeadFormArrayResponse> {
     ...
     */
    public leadFormsUpdateWithHttpInfo(adAccountId: string, leadFormUpdateRequest: Array<LeadFormUpdateRequest>, _options?: Configuration): Observable<HttpInfo<LeadFormArrayResponse>> {
        const requestContextPromise = this.requestFactory.leadFormsUpdate(adAccountId, leadFormUpdateRequest, _options);
     ...
     * @param leadFormUpdateRequest List of lead forms to update, size limit [1, 30].
     */
    public leadFormsUpdate(adAccountId: string, leadFormUpdateRequest: Array<LeadFormUpdateRequest>, _options?: Configuration): Observable<LeadFormArrayResponse> {
...
export class ObservableLeadsExportApi {
     ...
     */
    public leadsExportCreateWithHttpInfo(adAccountId: string, leadsExportCreateRequest: LeadsExportCreateRequest, _options?: Configuration): Observable<HttpInfo<LeadsExportCreateResponse>> {
        const requestContextPromise = this.requestFactory.leadsExportCreate(adAccountId, leadsExportCreateRequest, _options);
     ...
     * @param leadsExportCreateRequest
     */
    public leadsExportCreate(adAccountId: string, leadsExportCreateRequest: LeadsExportCreateRequest, _options?: Configuration): Observable<LeadsExportCreateResponse> {
     ...
     */
    public leadsExportGetWithHttpInfo(adAccountId: string, leadsExportId: string, _options?: Configuration): Observable<HttpInfo<LeadsExportResponseData>> {
        const requestContextPromise = this.requestFactory.leadsExportGet(adAccountId, leadsExportId, _options);
     ...
     * @param leadsExportId lead_export_id token returned from the create a lead export endpoint
     */
    public leadsExportGet(adAccountId: string, leadsExportId: string, _options?: Configuration): Observable<LeadsExportResponseData> {
...
export class ObservablePinsApi {
     ...
     * @param [adAccountId] Unique identifier of an ad account.
     */
    public multiPinsAnalyticsWithHttpInfo(pinIds: Array<string>, startDate: string, endDate: string, metricTypes: Array<PinsAnalyticsMetricTypesParameterInner>, appTypes?: 'ALL' | 'MOBILE' | 'TABLET' | 'WEB', adAccountId?: string, _options?: Configuration): Observable<HttpInfo<{ [key: string]: { [key: string]: PinAnalyticsMetricsResponse; }; }>> {
        const requestContextPromise = this.requestFactory.multiPinsAnalytics(pinIds, startDate, endDate, metricTypes, appTypes, adAccountId, _options);
     ...
     * @param [adAccountId] Unique identifier of an ad account.
     */
    public multiPinsAnalytics(pinIds: Array<string>, startDate: string, endDate: string, metricTypes: Array<PinsAnalyticsMetricTypesParameterInner>, appTypes?: 'ALL' | 'MOBILE' | 'TABLET' | 'WEB', adAccountId?: string, _options?: Configuration): Observable<{ [key: string]: { [key: string]: PinAnalyticsMetricsResponse; }; }> {
...
export class ObservableResourcesApi {
     ...
     * @param [adAccountId] Unique identifier of an ad account.
     */
    public targetingOptionsGetWithHttpInfo(targetingType: 'APPTYPE' | 'GENDER' | 'LOCALE' | 'AGE_BUCKET' | 'LOCATION' | 'GEO' | 'INTEREST' | 'KEYWORD' | 'AUDIENCE_INCLUDE' | 'AUDIENCE_EXCLUDE', clientId?: string, oauthSignature?: string, timestamp?: string, adAccountId?: string, _options?: Configuration): Observable<HttpInfo<Array<any>>> {
        const requestContextPromise = this.requestFactory.targetingOptionsGet(targetingType, clientId, oauthSignature, timestamp, adAccountId, _options);
     ...
     * @param [adAccountId] Unique identifier of an ad account.
     */
    public targetingOptionsGet(targetingType: 'APPTYPE' | 'GENDER' | 'LOCALE' | 'AGE_BUCKET' | 'LOCATION' | 'GEO' | 'INTEREST' | 'KEYWORD' | 'AUDIENCE_INCLUDE' | 'AUDIENCE_EXCLUDE', clientId?: string, oauthSignature?: string, timestamp?: string, adAccountId?: string, _options?: Configuration): Observable<Array<any>> {
...
export class ObservableTargetingTemplateApi {
     ...
     */
    public targetingTemplateCreateWithHttpInfo(adAccountId: string, targetingTemplateCreate: TargetingTemplateCreate, _options?: Configuration): Observable<HttpInfo<TargetingTemplateGetResponseData>> {
        const requestContextPromise = this.requestFactory.targetingTemplateCreate(adAccountId, targetingTemplateCreate, _options);
     ...
     * @param targetingTemplateCreate targeting template creation entity
     */
    public targetingTemplateCreate(adAccountId: string, targetingTemplateCreate: TargetingTemplateCreate, _options?: Configuration): Observable<TargetingTemplateGetResponseData> {
     ...
     * @param [bookmark] Cursor used to fetch the next page of items
     */
    public targetingTemplateListWithHttpInfo(adAccountId: string, order?: 'ASCENDING' | 'DESCENDING', includeSizing?: boolean, searchQuery?: string, pageSize?: number, bookmark?: string, _options?: Configuration): Observable<HttpInfo<TargetingTemplateList200Response>> {
        const requestContextPromise = this.requestFactory.targetingTemplateList(adAccountId, order, includeSizing, searchQuery, pageSize, bookmark, _options);
     ...
     * @param [bookmark] Cursor used to fetch the next page of items
     */
    public targetingTemplateList(adAccountId: string, order?: 'ASCENDING' | 'DESCENDING', includeSizing?: boolean, searchQuery?: string, pageSize?: number, bookmark?: string, _options?: Configuration): Observable<TargetingTemplateList200Response> {
     ...
     */
    public targetingTemplateUpdateWithHttpInfo(adAccountId: string, targetingTemplateUpdateRequest: TargetingTemplateUpdateRequest, _options?: Configuration): Observable<HttpInfo<void>> {
        const requestContextPromise = this.requestFactory.targetingTemplateUpdate(adAccountId, targetingTemplateUpdateRequest, _options);
     ...
     * @param targetingTemplateUpdateRequest Operation type and targeting template ID
     */
    public targetingTemplateUpdate(adAccountId: string, targetingTemplateUpdateRequest: TargetingTemplateUpdateRequest, _options?: Configuration): Observable<void> {
...
export class ObservableUserAccountApi {
     ...
     * @param [adAccountId] Unique identifier of an ad account.
     */
    public verifyWebsiteUpdateWithHttpInfo(userWebsiteVerifyRequest: UserWebsiteVerifyRequest, adAccountId?: string, _options?: Configuration): Observable<HttpInfo<UserWebsiteSummary>> {
        const requestContextPromise = this.requestFactory.verifyWebsiteUpdate(userWebsiteVerifyRequest, adAccountId, _options);
     ...
     * @param [adAccountId] Unique identifier of an ad account.
     */
    public verifyWebsiteUpdate(userWebsiteVerifyRequest: UserWebsiteVerifyRequest, adAccountId?: string, _options?: Configuration): Observable<UserWebsiteSummary> {
     ...
     * @param [adAccountId] Unique identifier of an ad account.
     */
    public websiteVerificationGetWithHttpInfo(adAccountId?: string, _options?: Configuration): Observable<HttpInfo<UserWebsiteVerificationCode>> {
        const requestContextPromise = this.requestFactory.websiteVerificationGet(adAccountId, _options);
     ...
     * @param [adAccountId] Unique identifier of an ad account.
     */
    public websiteVerificationGet(adAccountId?: string, _options?: Configuration): Observable<UserWebsiteVerificationCode> {
