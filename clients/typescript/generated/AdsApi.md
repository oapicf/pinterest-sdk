...
let body:.AdsApiAdPreviewsCreateRequest = {
...
apiInstance.adPreviewsCreate(body).then((data:any) => {
...
let body:.AdsApiAdTargetingAnalyticsGetRequest = {
  // string | Unique identifier of an ad account.
  adAccountId: "4",
...
apiInstance.adTargetingAnalyticsGet(body).then((data:any) => {
  console.log('API called successfully. Returned data: ' + data);
}).catch((error:any) => console.error(error));
```
...
let body:.AdsApiAdsAnalyticsRequest = {
  // string | Unique identifier of an ad account.
  adAccountId: "4",
  // string | Metric report start date (UTC). Format: YYYY-MM-DD. Cannot be more than 90 days back from today.
  startDate: new Date('1970-01-01').toISOString().split('T')[0];,
...
apiInstance.adsAnalytics(body).then((data:any) => {
  console.log('API called successfully. Returned data: ' + data);
}).catch((error:any) => console.error(error));
```
...
let body:.AdsApiAdsCreateRequest = {
  // string | Unique identifier of an ad account.
  adAccountId: "4",
...
apiInstance.adsCreate(body).then((data:any) => {
  console.log('API called successfully. Returned data: ' + data);
}).catch((error:any) => console.error(error));
```
...
apiInstance.adsGet(body).then((data:any) => {
  console.log('API called successfully. Returned data: ' + data);
}).catch((error:any) => console.error(error));
```
...
apiInstance.adsList(body).then((data:any) => {
  console.log('API called successfully. Returned data: ' + data);
}).catch((error:any) => console.error(error));
```
...
let body:.AdsApiAdsUpdateRequest = {
  // string | Unique identifier of an ad account.
  adAccountId: "4",
...
apiInstance.adsUpdate(body).then((data:any) => {
  console.log('API called successfully. Returned data: ' + data);
}).catch((error:any) => console.error(error));
```
