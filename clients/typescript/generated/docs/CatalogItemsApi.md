...
```typescript
import { createConfiguration, CatalogItemsApi } from '';
import type { CatalogItemsApiItemsBatchGetRequest } from '';

const configuration = createConfiguration();
const apiInstance = new CatalogItemsApi(configuration);

const request: CatalogItemsApiItemsBatchGetRequest = {
...
```typescript
import { createConfiguration, CatalogItemsApi } from '';
import type { CatalogItemsApiItemsBatchPostRequest } from '';

const configuration = createConfiguration();
const apiInstance = new CatalogItemsApi(configuration);

const request: CatalogItemsApiItemsBatchPostRequest = {
...
```typescript
import { createConfiguration, CatalogItemsApi } from '';
import type { CatalogItemsApiItemsPostRequest } from '';

const configuration = createConfiguration();
const apiInstance = new CatalogItemsApi(configuration);

const request: CatalogItemsApiItemsPostRequest = {
