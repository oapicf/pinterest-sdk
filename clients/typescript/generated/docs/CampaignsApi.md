...
import type { CampaignsApiAdPinsAnalyticsRequest } from '';

const configuration = createConfiguration();
const apiInstance = new CampaignsApi(configuration);

const request: CampaignsApiAdPinsAnalyticsRequest = {
...
const data = await apiInstance.adPinsAnalytics(request);
