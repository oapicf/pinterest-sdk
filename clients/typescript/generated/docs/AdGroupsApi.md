...
```typescript
import { createConfiguration, AdGroupsApi } from '';
import type { AdGroupsApiAdGroupsAnalyticsRequest } from '';

const configuration = createConfiguration();
const apiInstance = new AdGroupsApi(configuration);

const request: AdGroupsApiAdGroupsAnalyticsRequest = {
...
```typescript
import { createConfiguration, AdGroupsApi } from '';
import type { AdGroupsApiAdGroupsAudienceSizingRequest } from '';

const configuration = createConfiguration();
const apiInstance = new AdGroupsApi(configuration);

const request: AdGroupsApiAdGroupsAudienceSizingRequest = {
    // Unique identifier of an ad account.
  adAccountId: "4",
...
const data = await apiInstance.adGroupsAudienceSizing(request);
console.log('API called successfully. Returned data:', data);
```
...
```typescript
import { createConfiguration, AdGroupsApi } from '';
import type { AdGroupsApiAdGroupsBidFloorGetRequest } from '';

const configuration = createConfiguration();
const apiInstance = new AdGroupsApi(configuration);

const request: AdGroupsApiAdGroupsBidFloorGetRequest = {
    // Unique identifier of an ad account.
  adAccountId: "4",
...
const data = await apiInstance.adGroupsBidFloorGet(request);
console.log('API called successfully. Returned data:', data);
```
...
```typescript
import { createConfiguration, AdGroupsApi } from '';
import type { AdGroupsApiAdGroupsCreateRequest } from '';

const configuration = createConfiguration();
const apiInstance = new AdGroupsApi(configuration);

const request: AdGroupsApiAdGroupsCreateRequest = {
    // Unique identifier of an ad account.
  adAccountId: "4",
...
const data = await apiInstance.adGroupsCreate(request);
console.log('API called successfully. Returned data:', data);
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **adGroupCreateRequest** | **Array<AdGroupCreateRequest>**| List of ad groups to create, size limit [1, 30]. |
 **adAccountId** | [**string**] | Unique identifier of an ad account. | defaults to undefined
...
```typescript
import { createConfiguration, AdGroupsApi } from '';
import type { AdGroupsApiAdGroupsGetRequest } from '';

const configuration = createConfiguration();
const apiInstance = new AdGroupsApi(configuration);

const request: AdGroupsApiAdGroupsGetRequest = {
    // Unique identifier of an ad account.
  adAccountId: "4",
...
const data = await apiInstance.adGroupsGet(request);
console.log('API called successfully. Returned data:', data);
```
...
------------- | ------------- | ------------- | -------------
 **adAccountId** | [**string**] | Unique identifier of an ad account. | defaults to undefined
 **adGroupId** | [**string**] | Unique identifier of an ad group. | defaults to undefined
...
```typescript
import { createConfiguration, AdGroupsApi } from '';
import type { AdGroupsApiAdGroupsListRequest } from '';

const configuration = createConfiguration();
const apiInstance = new AdGroupsApi(configuration);

const request: AdGroupsApiAdGroupsListRequest = {
    // Unique identifier of an ad account.
  adAccountId: "4",
  ...
  bookmark: "bookmark_example",
    // Return interests as text names (if value is true) rather than topic IDs. (optional)
  translateInterestsToNames: false,
};

const data = await apiInstance.adGroupsList(request);
console.log('API called successfully. Returned data:', data);
```
...
```typescript
import { createConfiguration, AdGroupsApi } from '';
import type { AdGroupsApiAdGroupsTargetingAnalyticsGetRequest } from '';

const configuration = createConfiguration();
const apiInstance = new AdGroupsApi(configuration);

const request: AdGroupsApiAdGroupsTargetingAnalyticsGetRequest = {
    // Unique identifier of an ad account.
  adAccountId: "4",
    // List of Ad group Ids to use to filter the results.
  adGroupIds: [
...
# **adGroupsUpdate**
> AdGroupArrayResponse adGroupsUpdate(adGroupUpdateRequest)
...
```typescript
import { createConfiguration, AdGroupsApi } from '';
import type { AdGroupsApiAdGroupsUpdateRequest } from '';

const configuration = createConfiguration();
const apiInstance = new AdGroupsApi(configuration);

const request: AdGroupsApiAdGroupsUpdateRequest = {
    // Unique identifier of an ad account.
  adAccountId: "4",
...
const data = await apiInstance.adGroupsUpdate(request);
console.log('API called successfully. Returned data:', data);
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **adGroupUpdateRequest** | **Array<AdGroupUpdateRequest>**| List of ad groups to update, size limit [1, 30]. |
 **adAccountId** | [**string**] | Unique identifier of an ad account. | defaults to undefined
