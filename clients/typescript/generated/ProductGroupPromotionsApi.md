...
```typescript
import { createConfiguration, ProductGroupPromotionsApi } from '';
import type { ProductGroupPromotionsApiProductGroupPromotionsCreateRequest } from '';

const configuration = createConfiguration();
const apiInstance = new ProductGroupPromotionsApi(configuration);

const request: ProductGroupPromotionsApiProductGroupPromotionsCreateRequest = {
...
const data = await apiInstance.productGroupPromotionsCreate(request);
...
```typescript
import { createConfiguration, ProductGroupPromotionsApi } from '';
import type { ProductGroupPromotionsApiProductGroupPromotionsGetRequest } from '';

const configuration = createConfiguration();
const apiInstance = new ProductGroupPromotionsApi(configuration);

const request: ProductGroupPromotionsApiProductGroupPromotionsGetRequest = {
    // Unique identifier of an ad account.
  adAccountId: "4",
...
const data = await apiInstance.productGroupPromotionsGet(request);
console.log('API called successfully. Returned data:', data);
```
...
```typescript
import { createConfiguration, ProductGroupPromotionsApi } from '';
import type { ProductGroupPromotionsApiProductGroupPromotionsListRequest } from '';

const configuration = createConfiguration();
const apiInstance = new ProductGroupPromotionsApi(configuration);

const request: ProductGroupPromotionsApiProductGroupPromotionsListRequest = {
    // Unique identifier of an ad account.
  adAccountId: "4",
    // List of Product group promotion Ids. (optional)
...
const data = await apiInstance.productGroupPromotionsList(request);
console.log('API called successfully. Returned data:', data);
```
...
```typescript
import { createConfiguration, ProductGroupPromotionsApi } from '';
import type { ProductGroupPromotionsApiProductGroupPromotionsUpdateRequest } from '';

const configuration = createConfiguration();
const apiInstance = new ProductGroupPromotionsApi(configuration);

const request: ProductGroupPromotionsApiProductGroupPromotionsUpdateRequest = {
    // Unique identifier of an ad account.
  adAccountId: "4",
...
const data = await apiInstance.productGroupPromotionsUpdate(request);
console.log('API called successfully. Returned data:', data);
```
...
```typescript
import { createConfiguration, ProductGroupPromotionsApi } from '';
import type { ProductGroupPromotionsApiProductGroupsAnalyticsRequest } from '';

const configuration = createConfiguration();
const apiInstance = new ProductGroupPromotionsApi(configuration);

const request: ProductGroupPromotionsApiProductGroupsAnalyticsRequest = {
    // Unique identifier of an ad account.
  adAccountId: "4",
...
const data = await apiInstance.productGroupsAnalytics(request);
console.log('API called successfully. Returned data:', data);
```
