...
class AudienceInsightsController extends Controller
{
    ...
    public function __construct(
        private readonly AudienceInsightsApiInterface $api,
     ...
     *
     */
    public function audienceInsightsGet(Request $request, string $adAccountId): JsonResponse
    {
        ...
        if ($apiResult instanceof \OpenAPI\Server\Model\AudienceInsights) {
     ...
     *
     */
    public function audienceInsightsScopeAndTypeGet(Request $request, string $adAccountId): JsonResponse
    {
        $validator = Validator::make(
            array_merge(
                [
        ...
        if ($apiResult instanceof \OpenAPI\Server\Model\AudienceInsightsScopeAndTypeGet200Response) {
            return response()->json($this->serde->serialize($apiResult, format: 'array'), 200);
        }
