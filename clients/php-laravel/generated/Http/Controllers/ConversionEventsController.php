...
class ConversionEventsController extends Controller
{
    ...
    public function __construct(
        private readonly ConversionEventsApiInterface $api,
     ...
     *
     */
    public function eventsCreate(Request $request, string $adAccountId): JsonResponse
    {
        ...
        $conversionEventsCreate = $this->serde->deserialize($request->getContent(), from: 'json', to: \OpenAPI\Server\Model\ConversionEventsCreate::class);

        $test = $request->boolean('test');


        $apiResult = $this->api->eventsCreate($adAccountId, $conversionEventsCreate, $test);

        if ($apiResult instanceof \OpenAPI\Server\Model\ConversionEvents) {
