...
class OauthController extends Controller
{
    ...
    public function oauthConversionToken(Request $request): JsonResponse
    {
        ...
        if ($apiResult instanceof \OpenAPI\Server\Model\ConversionAccessTokenResponse) {
    ...
    public function tokenRevoke(Request $request): JsonResponse
    {
        ...
        $tokenTypeHint = $this->serde->deserialize($request->getContent(), from: 'json', to: \OpenAPI\Server\Model\TokenRevocationRequestTokenTypeHint::class);
