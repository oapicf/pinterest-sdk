...
class LeadsExportController extends Controller
{
    ...
    public function leadsExportCreate(Request $request, string $adAccountId): JsonResponse
    {
        ...
        $leadsExportsCreate = $this->serde->deserialize($request->getContent(), from: 'json', to: \OpenAPI\Server\Model\LeadsExportsCreate::class);


        $apiResult = $this->api->leadsExportCreate($adAccountId, $leadsExportsCreate);

        if ($apiResult instanceof \OpenAPI\Server\Model\LeadsExports) {
