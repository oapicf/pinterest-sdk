...
class BillingController extends Controller
{
    ...
    public function billingInvoicesGet(Request $request, string $adAccountId): JsonResponse
    {
        ...
        $sort = $this->serde->deserialize($request->getContent(), from: 'json', to: \OpenAPI\Server\Model\BillingInvoicesGetSortParameter::class);

        $order = $this->serde->deserialize($request->getContent(), from: 'json', to: \OpenAPI\Server\Model\AdGroupsListOrderParameter::class);

        $status = $this->serde->deserialize($request->getContent(), from: 'json', to: \OpenAPI\Server\Model\BillingInvoicesGetStatusParameter::class);

        $documentType = $this->serde->deserialize($request->getContent(), from: 'json', to: \OpenAPI\Server\Model\BillingInvoicesGetDocumentTypeParameter::class);
        ...
        $apiResult = $this->api->billingInvoicesGet($adAccountId, $bookmark, $pageSize, $sort, $order, $status, $documentType, $startDueDate, $endDueDate);
