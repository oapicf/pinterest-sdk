...
class KeywordsController extends Controller
{
    ...
    public function keywordsGet(Request $request, string $adAccountId): JsonResponse
    {
        ...
        $apiResult = $this->api->keywordsGet($adAccountId, $campaignId, $adGroupId, $adGroupIds, $matchTypes, $pageSize, $bookmark);
    ...
    public function trendingKeywordsList(Request $request, \OpenAPI\Server\Model\TrendsSupportedRegion $region, \OpenAPI\Server\Model\TrendType $trendType): JsonResponse
    {
        ...
        $includePrediction = $request->boolean('includePrediction');

        $includeDemographics = $request->boolean('includeDemographics');


        $apiResult = $this->api->trendingKeywordsList($region, $trendType, $interests, $genders, $ages, $includeKeywords, $normalizeAgainstGroup, $limit, $includePrediction, $includeDemographics);
