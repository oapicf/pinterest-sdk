...
class AdGroupsController extends Controller
{
    ...
    public function adGroupsAnalytics(Request $request, string $adAccountId): JsonResponse
    {
        ...
        $apiResult = $this->api->adGroupsAnalytics($adAccountId, $startDate, $endDate, $adGroupIds, $columns, $granularity, $clickWindowDays, $engagementWindowDays, $viewWindowDays, $conversionReportTime, $aggregateReportRows, $reportingTimezone);
    ...
    public function adGroupsTargetingAnalyticsGet(Request $request, string $adAccountId): JsonResponse
    {
        ...
        $apiResult = $this->api->adGroupsTargetingAnalyticsGet($adAccountId, $adGroupIds, $startDate, $endDate, $targetingTypes, $columns, $granularity, $clickWindowDays, $engagementWindowDays, $viewWindowDays, $conversionReportTime, $attributionTypes, $reportingTimezone);
