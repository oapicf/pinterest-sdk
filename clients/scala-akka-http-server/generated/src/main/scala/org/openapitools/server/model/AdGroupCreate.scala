...
/**
 * @param adAccountId Advertiser ID. for example: ''null''
 ...
 * @param conversionLearningModeType oCPM learn mode for example: ''null''
 * @param createdTime Ad group creation time. Unix timestamp in seconds. for example: ''null''
 ...
 * @param updatedTime Ad group last update time. Unix timestamp in seconds. for example: ''null''
...
*/
final case class AdGroupCreate (
