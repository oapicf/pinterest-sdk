 ...
 *
 * @param adImageTags  for example: ''null''
 * @param adVideoTags  for example: ''null''
 ...
 * @param productType0  for example: ''null''
 * @param productType1  for example: ''null''
 * @param productType2  for example: ''null''
 * @param productType3  for example: ''null''
 * @param productType4  for example: ''null''
*/
final case class CatalogsRetailFilterValuesMap (
