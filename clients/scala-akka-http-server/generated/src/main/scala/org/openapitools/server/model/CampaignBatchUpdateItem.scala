 ...
 * @param bidOptions Object describing an update to the campaign level bid multipliers. for example: ''null''
 ...
 * @param id Campaign ID, must be associated with the ad account ID provided in the path. for example: ''549755885175''
...
*/
final case class CampaignBatchUpdateItem (
  ...
  objectiveType: Option[ConversionObjectiveType] = None,
