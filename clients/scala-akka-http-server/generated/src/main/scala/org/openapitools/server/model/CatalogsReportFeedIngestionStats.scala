 ...
 * @param code The event code that a diagnostics aggregated number references for example: ''112''
 * @param codeLabel A human-friendly label for the event code (e.g, 'AVAILABILITY_INVALID') for example: ''AVAILABILITY_INVALID''
...
*/
final case class CatalogsReportFeedIngestionStats (
