 ...
 * @param isStandard Whether the Pin is standard or not. See documentation on <a href=\"https://developers.pinterest.com/docs/content/update/\">Changes to Pin creation</a> for more information. for example: ''null''
 ...
 * @param pinMetrics Pin metrics with associated time intervals if any. for example: ''{"pin_metrics":[{"90d":{"pin_click":7,"impression":2,"clickthrough":3},"all_time":{"pin_click":7,"impression":2,"clickthrough":3,"reaction":10,"comment":2}},null]}''
*/
