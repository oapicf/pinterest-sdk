    ...
    ## API
          ...
          |`org.openapitools.server.api.AdsApi`|Representing trait|
              |`org.openapitools.server.api.AdsApiImpl`|Default implementation|
                ...
                * `GET /v5/ad_accounts/{ad_account_id}/ads/analytics?startDate=[value]&endDate=[value]&adIds=[value]&columns=[value]&granularity=[value]&clickWindowDays=[value]&engagementWindowDays=[value]&viewWindowDays=[value]&conversionReportTime=[value]&pinIds=[value]&campaignIds=[value]&reportingTimezone=[value]` - Get ad analytics
          ...
          |`org.openapitools.server.api.BillingApi`|Representing trait|
              |`org.openapitools.server.api.BillingApiImpl`|Default implementation|
                ...
                * `GET /v5/ad_accounts/{ad_account_id}/billing_invoices?bookmark=[value]&pageSize=[value]&sort=[value]&order=[value]&status=[value]&documentType=[value]&startDueDate=[value]&endDueDate=[value]` - Get billing invoices
          ...
          |`org.openapitools.server.api.BusinessAccessAssetsApi`|Representing trait|
              |`org.openapitools.server.api.BusinessAccessAssetsApiImpl`|Default implementation|
                ...
                * `GET /v5/businesses/{business_id}/assets/{asset_id}/members?fetchSystemUsers=[value]&bookmark=[value]&pageSize=[value]&startIndex=[value]` - Get members with access to asset
          ...
          |`org.openapitools.server.api.KeywordsApi`|Representing trait|
              |`org.openapitools.server.api.KeywordsApiImpl`|Default implementation|
                ...
                * `GET /v5/ad_accounts/{ad_account_id}/keywords?campaignId=[value]&adGroupId=[value]&adGroupIds=[value]&matchTypes=[value]&pageSize=[value]&bookmark=[value]` - Get keywords
                * `PATCH /v5/ad_accounts/{ad_account_id}/keywords` - Update keywords
                * `GET /v5/trends/keywords/{region}/top/{trend_type}?interests=[value]&genders=[value]&ages=[value]&includeKeywords=[value]&normalizeAgainstGroup=[value]&limit=[value]&includePrediction=[value]&includeDemographics=[value]` - List trending keywords
          ...
          |`org.openapitools.server.api.LabelsApi`|Representing trait|
              |`org.openapitools.server.api.LabelsApiImpl`|Default implementation|
                ...
                * `GET /v5/ad_accounts/{ad_account_id}/labels?campaignIds=[value]&labelIds=[value]&entityStatuses=[value]&labelTypes=[value]&pageSize=[value]&bookmark=[value]` - List labels
          ...
          |Name|Role|
          |----|----|
          |`org.openapitools.server.api.ProductCategoriesController`|akka-http API controller|
          |`org.openapitools.server.api.ProductCategoriesApi`|Representing trait|
              |`org.openapitools.server.api.ProductCategoriesApiImpl`|Default implementation|
          ...
          |`org.openapitools.server.api.PromotionsApi`|Representing trait|
              |`org.openapitools.server.api.PromotionsApiImpl`|Default implementation|
                ...
                * `GET /v5/ad_accounts/{ad_account_id}/promotions?pageSize=[value]&order=[value]&bookmark=[value]` - Get promotions
