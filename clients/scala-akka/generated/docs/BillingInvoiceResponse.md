...
**documentType** | [**DocumentType**](#DocumentType) | The type of the document |  [optional]
...
**status** | [**Status**](#Status) | The status of the invoice |  [optional]


## Enum: DocumentType
Allowed values: [INVOICE, CREDIT_MEMO]
