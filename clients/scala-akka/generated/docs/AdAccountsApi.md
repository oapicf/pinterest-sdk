...
object Example extends App {
    ...
    val request = apiInstance.adAccountAnalytics(adAccountId, startDate, endDate, columns, granularity, clickWindowDays, engagementWindowDays, viewWindowDays, conversionReportTime, reportingTimezone)
...
> analyticsCreateConversionProductReport(analyticsCreateConversionProductReportRequest): ApiRequest[AdsAnalyticsCreateAsyncResponse]
...
object Example extends App {
    ...
    val request = apiInstance.analyticsCreateConversionProductReport(adAccountId, conversionProductReportRequest)
    val response = apiInvoker.execute(request)
...
> analyticsGetConversionProductReport(analyticsGetConversionProductReportRequest): ApiRequest[AdsAnalyticsGetAsyncResponse]
