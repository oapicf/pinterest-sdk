...
**status** | [**Status**](#Status) | Customer list status. TOO_SMALL - the list has less than 100 Pinterest users. |  [optional]
**`type`** | **String** | Always \&quot;customerlist\&quot;. |  [optional]
**updatedTime** | **BigDecimal** | Last update time. Unix timestamp in seconds. |  [optional]
**exceptions** | **Any** | Customer list errors |  [optional]


## Enum: Status
Allowed values: [PROCESSING, READY, TOO_SMALL, UPLOADING]
