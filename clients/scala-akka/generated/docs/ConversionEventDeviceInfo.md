...
**formFactor** | [**FormFactor**](#FormFactor) | Device form factor |  [optional]
...
**languages** | **Seq&lt;String&gt;** | List of user installed languages. ISO 639-1 format |  [optional]
**locale** | **String** | Device locale BCP-47 format |  [optional]
**model** | **String** | Device model name |  [optional]
**networkType** | [**NetworkType**](#NetworkType) | Network type: 4G, 5G, ethernet, wifi In Android: NetworkCapabilities.getNetworkCapabilities() |  [optional]
**osFamily** | [**OsFamily**](#OsFamily) | OS Family |  [optional]
...
## Enum: FormFactor
Allowed values: [desktop, laptop, cellphone, tablet, smartwatch, tv, vr, console, other]



## Enum: NetworkType
Allowed values: [wifi, cellular_2g, cellular_3g, cellular_4g, cellular_5g, cellular_6g, ethernet, unknown]



## Enum: OsFamily
Allowed values: [ios, android, macos, windows, linux, bsd, other]
