...
**creativeType** | [**CreativeType**](#CreativeType) | Ad format of the shopping ad preview. | 
...
**preferredMediaType** | [**PreferredMediaType**](#PreferredMediaType) | Preferred media type. |  [optional]
**videoTag** | **String** | Multi video template tag, image_tag and video_tag are mutual exclusive. |  [optional]


## Enum: CreativeType
Allowed values: [SHOPPING, CAROUSEL, COLLECTION, REGULAR]
