...
**createdByBusiness** | **Any** | Metadata for the business that created the invite/request. |  [optional]
**createdByUser** | **Any** | Metadata for the user that created the invite/request. |  [optional]
