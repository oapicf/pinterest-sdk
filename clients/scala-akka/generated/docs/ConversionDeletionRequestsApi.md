...
[**conversionDeletionRequestCreateWithHttpInfo**](ConversionDeletionRequestsApi.md#conversionDeletionRequestCreateWithHttpInfo) | **POST** /ad_accounts/{ad_account_id}/conversion_deletion_requests | Create a conversion deletion request
...
[**conversionDeletionRequestDeleteWithHttpInfo**](ConversionDeletionRequestsApi.md#conversionDeletionRequestDeleteWithHttpInfo) | **DELETE** /ad_accounts/{ad_account_id}/conversion_deletion_requests/{request_id} | Delete a conversion deletion request
...
[**conversionDeletionRequestGetWithHttpInfo**](ConversionDeletionRequestsApi.md#conversionDeletionRequestGetWithHttpInfo) | **GET** /ad_accounts/{ad_account_id}/conversion_deletion_requests/{request_id} | Get a single conversion deletion request
...
[**conversionDeletionRequestListWithHttpInfo**](ConversionDeletionRequestsApi.md#conversionDeletionRequestListWithHttpInfo) | **GET** /ad_accounts/{ad_account_id}/conversion_deletion_requests | List conversion deletion requests



## conversionDeletionRequestCreate

> conversionDeletionRequestCreate(conversionDeletionRequestCreateRequest): ApiRequest[ConversionDeletionRequest]
...
object Example extends App {
    ...
    val apiInstance = ConversionDeletionRequestsApi("https://api.pinterest.com/v5")
    val adAccountId: String = adAccountId_example // String | Unique identifier of an ad account.

    val conversionDeletionRequestCreate: ConversionDeletionRequestCreate =  // ConversionDeletionRequestCreate | 
    
    val request = apiInstance.conversionDeletionRequestCreate(adAccountId, conversionDeletionRequestCreate)
...
ApiRequest[[**ConversionDeletionRequest**](ConversionDeletionRequest.md)]
...
> conversionDeletionRequestDelete(conversionDeletionRequestDeleteRequest): ApiRequest[ConversionDeletionRequest]
...
object Example extends App {
    ...
    val apiInvoker = ApiInvoker()
    val apiInstance = ConversionDeletionRequestsApi("https://api.pinterest.com/v5")
    val requestId: String = requestId_example // String | Unique identifier of the conversion deletion request

    val adAccountId: String = adAccountId_example // String | Unique identifier of an ad account.
    
    val request = apiInstance.conversionDeletionRequestDelete(requestId, adAccountId)
    val response = apiInvoker.execute(request)
...
> conversionDeletionRequestGet(conversionDeletionRequestGetRequest): ApiRequest[ConversionDeletionRequest]
...
object Example extends App {
    ...
    val request = apiInstance.conversionDeletionRequestGet(requestId, adAccountId)
    val response = apiInvoker.execute(request)
...
> conversionDeletionRequestList(conversionDeletionRequestListRequest): ApiRequest[ConversionDeletionRequestList200Response]
...
object Example extends App {
    ...
    val request = apiInstance.conversionDeletionRequestList(adAccountId, bookmark, pageSize, order)
    val response = apiInvoker.execute(request)
...
ApiRequest[[**ConversionDeletionRequestList200Response**](ConversionDeletionRequestList200Response.md)]
