...
class BusinessAccessAssetsApi(baseUrl: String) {
   ...
   */
  def businessAssetMembersGet(businessId: String, assetId: String, fetchSystemUsers: Option[Boolean] = None, bookmark: Option[String] = None, pageSize: Option[Int] = None, startIndex: Option[Int] = None): ApiRequest[BusinessAssetMembersGet200Response] =
