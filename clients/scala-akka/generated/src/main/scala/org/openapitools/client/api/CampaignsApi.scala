...
class CampaignsApi(baseUrl: String) {
   ...
   * 
   * Expected answers:
   *   code 200 : Seq[AdPinAnalytics] (Success)
   *   code 400 : Error (Invalid ad account pins analytics parameters.)
   ...
   */
  def adPinsAnalytics(adAccountId: String, campaignId: String, pinIds: Seq[String], startDate: LocalDate, endDate: LocalDate, columns: Seq[String], granularity: Granularity, clickWindowDays: Option[Int] = None, engagementWindowDays: Option[Int] = None, viewWindowDays: Option[Int] = None, conversionReportTime: Option[String] = None): ApiRequest[Seq[AdPinAnalytics]] =
   ...
   * @param reportingTimezone Specify the timezone to be applied for the reporting. This feature is currently in BETA and is not available to all users.
   */
  def campaignsAnalytics(adAccountId: String, startDate: LocalDate, endDate: LocalDate, campaignIds: Seq[String], columns: Seq[String], granularity: Granularity, clickWindowDays: Option[Int] = None, engagementWindowDays: Option[Int] = None, viewWindowDays: Option[Int] = None, conversionReportTime: Option[String] = None, aggregateReportRows: Option[Boolean] = None, reportingTimezone: Option[ReportingTimeZone] = None): ApiRequest[Seq[CampaignsAnalyticsResponseInner]] =
