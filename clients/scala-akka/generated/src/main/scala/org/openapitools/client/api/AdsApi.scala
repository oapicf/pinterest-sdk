...
class AdsApi(baseUrl: String) {
   ...
   * @param reportingTimezone Specify the timezone to be applied for the reporting. This feature is currently in BETA and is not available to all users.
   */
  def adsAnalytics(adAccountId: String, startDate: LocalDate, endDate: LocalDate, columns: Seq[String], granularity: Granularity, adIds: Seq[String], clickWindowDays: Option[Int] = None, engagementWindowDays: Option[Int] = None, viewWindowDays: Option[Int] = None, conversionReportTime: Option[String] = None, pinIds: Seq[String], campaignIds: Seq[String], reportingTimezone: Option[ReportingTimeZone] = None): ApiRequest[Seq[AdsAnalyticsResponseInner]] =
