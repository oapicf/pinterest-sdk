...
class PinsApi(baseUrl: String) {
   ...
   */
  def pinsList(pinFilter: Option[String] = None, pinMetrics: Option[Boolean] = None, includeProtectedPins: Option[Boolean] = None, pinType: Option[String] = None, creativeTypes: Seq[CreativeType], adAccountId: Option[String] = None, bookmark: Option[String] = None, pageSize: Option[Int] = None): ApiRequest[PinsList200Response] =
