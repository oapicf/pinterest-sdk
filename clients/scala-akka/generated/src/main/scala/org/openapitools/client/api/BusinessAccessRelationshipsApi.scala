...
class BusinessAccessRelationshipsApi(baseUrl: String) {
   ...
   * 
   * Expected answers:
   *   code 200 : BrandAccountsCreate200Response (Success)
   ...
   */
  def brandAccountsCreate(businessHierarchyId: String, brandAccountsCreateRequest: BrandAccountsCreateRequest): ApiRequest[BrandAccountsCreate200Response] =
    ApiRequest[BrandAccountsCreate200Response](ApiMethods.POST, baseUrl, "/business_access/business_hierarchy/{business_hierarchy_id}/brand_accounts", "application/json")
      .withBody(brandAccountsCreateRequest)
      .withPathParam("business_hierarchy_id", businessHierarchyId)
      .withSuccessResponse[BrandAccountsCreate200Response](200)
   ...
   *   code 200 : BrandAccountsCreate200Response (Success)
   *   code 400 : Error (Invalid parameters.)
   *   code 401 : Error (Not authenticated to update Brand Account)
   *   code 403 : Error (Not authorized to update Brand Account)
   *   code 404 : Error (Brand account not found)
   *   code 409 : Error (This account is not a brand account.)
   ...
   */
  def brandAccountsUpdate(businessHierarchyId: String, brandAccountId: String, brandAccountsUpdateRequest: BrandAccountsUpdateRequest): ApiRequest[BrandAccountsCreate200Response] =
    ApiRequest[BrandAccountsCreate200Response](ApiMethods.PATCH, baseUrl, "/business_access/business_hierarchy/{business_hierarchy_id}/brand_accounts/{brand_account_id}", "application/json")
      .withBody(brandAccountsUpdateRequest)
      .withPathParam("business_hierarchy_id", businessHierarchyId)
   ...
   * @param pageSize Maximum number of items to include in a single page of the response. See documentation on <a href='/docs/reference/pagination/'>Pagination</a> for more information.
   */
  def getBusinessMembers(businessId: String, fetchSystemUsers: Option[Boolean] = None, assetsSummary: Option[Boolean] = None, businessRoles: Seq[MemberBusinessRole], memberIds: Option[String] = None, startIndex: Option[Int] = None, bookmark: Option[String] = None, pageSize: Option[Int] = None): ApiRequest[GetBusinessMembers200Response] =
   ...
   * 
   * Expected answers:
   *   code 200 :  (System user updated successfully.)
   *   code 400 : Error (Invalid parameters.)
   *   code 0 : Error (Unexpected error)
   * 
   * @param businessId Unique identifier of the requesting business.
   ...
   */
  def systemUserUpdate(businessId: String, systemUserId: String, systemUserUpdateRequest: SystemUserUpdateRequest): ApiRequest[Unit] =
    ApiRequest[Unit](ApiMethods.PATCH, baseUrl, "/businesses/{business_id}/system_users/{system_user_id}", "application/json")
      .withBody(systemUserUpdateRequest)
      .withPathParam("business_id", businessId)
