...
case class TargetingSpec (
  ...
  AGE_BUCKET: Option[TargetingSpecEnums.Seq[AGEBUCKET]] = None,
  /* Allowed devices. If the APPTYPE field is missing, the default behavior in terms of ad delivery is that **All devices/apptypes** will be targeted. */
  APPTYPE: Option[TargetingSpecEnums.Seq[APPTYPE]] = None,
  ...
  GENDER: Option[TargetingSpecEnums.Seq[GENDER]] = None,
  ...
  /*  */
  TARGETING_STRATEGY: Option[TargetingSpecEnums.Seq[TARGETINGSTRATEGY]] = None
) extends ApiModel

object TargetingSpecEnums {

  type Seq[AGEBUCKET] = Seq[AGEBUCKET].Value
  type Seq[APPTYPE] = Seq[APPTYPE].Value
  type Seq[GENDER] = Seq[GENDER].Value
  type Seq[TARGETINGSTRATEGY] = Seq[TARGETINGSTRATEGY].Value
  object Seq[AGEBUCKET] extends Enumeration {
  }

  object Seq[APPTYPE] extends Enumeration {
  }

  object Seq[GENDER] extends Enumeration {
  }

  object Seq[TARGETINGSTRATEGY] extends Enumeration {
  }
