...
case class AdGroupAudienceSizingRequest (
  ...
  creativeTypes: Option[AdGroupAudienceSizingRequestEnums.Seq[CreativeTypes]] = None,
...
object AdGroupAudienceSizingRequestEnums {
  ...
  type Seq[CreativeTypes] = Seq[CreativeTypes].Value
  object Seq[CreativeTypes] extends Enumeration {
  }
