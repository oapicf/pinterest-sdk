...
class SearchApi(baseUrl: String) {
   ...
   * 
   * Expected answers:
   *   code 200 : SearchUserPinsList200Response (Success)
   ...
   * @param bookmark Cursor used to fetch the next page of items
   */
  def searchUserPinsList(query: String, adAccountId: Option[String] = None, bookmark: Option[String] = None): ApiRequest[SearchUserPinsList200Response] =
    ApiRequest[SearchUserPinsList200Response](ApiMethods.GET, baseUrl, "/search/pins", "application/json")
      .withQueryParam("ad_account_id", adAccountId)
      .withQueryParam("query", query)
      .withQueryParam("bookmark", bookmark)
      .withSuccessResponse[SearchUserPinsList200Response](200)
