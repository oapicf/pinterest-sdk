...
class AdAccountsApi(baseUrl: String) {
   ...
   *   code 400 : Error (Invalid ad account ads analytics brand, category, SKU parameters)
   *   code 0 : Error (Unexpected error)
   * 
   * @param adAccountId Unique identifier of an ad account.
   * @param conversionProductReportRequest 
   */
  def analyticsCreateConversionProductReport(adAccountId: String, conversionProductReportRequest: ConversionProductReportRequest): ApiRequest[AdsAnalyticsCreateAsyncResponse] =
    ApiRequest[AdsAnalyticsCreateAsyncResponse](ApiMethods.POST, baseUrl, "/ad_accounts/{ad_account_id}/reports/brand_category_sku", "application/json")
      .withBody(conversionProductReportRequest)
      .withPathParam("ad_account_id", adAccountId)
   ...
   */
  def analyticsGetConversionProductReport(adAccountId: String, token: String): ApiRequest[AdsAnalyticsGetAsyncResponse] =
    ApiRequest[AdsAnalyticsGetAsyncResponse](ApiMethods.GET, baseUrl, "/ad_accounts/{ad_account_id}/reports/brand_category_sku", "application/json")
