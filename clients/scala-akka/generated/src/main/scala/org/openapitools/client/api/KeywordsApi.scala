...
class KeywordsApi(baseUrl: String) {
   ...
   */
  def keywordsGet(adAccountId: String, campaignId: Option[String] = None, adGroupId: Option[String] = None, adGroupIds: Seq[String], matchTypes: Seq[MatchType], pageSize: Option[Int] = None, bookmark: Option[String] = None): ApiRequest[KeywordsGet200Response] =
   ...
   */
  def trendingKeywordsList(region: TrendsSupportedRegion, trendType: TrendType, interests: Seq[String], genders: Seq[String], ages: Seq[String], includeKeywords: Seq[String], normalizeAgainstGroup: Option[Boolean] = None, limit: Option[Int] = None, includePrediction: Option[Boolean] = None, includeDemographics: Option[Boolean] = None): ApiRequest[TrendingKeywordsResponse] =
    ApiRequest[TrendingKeywordsResponse](ApiMethods.GET, baseUrl, "/trends/keywords/{region}/top/{trend_type}", "application/json")
      ...
      .withQueryParam("include_prediction", includePrediction)
