...
class BoardsApi(baseUrl: String) {
   ...
   */
  def boardsListPins(boardId: String, bookmark: Option[String] = None, pageSize: Option[Int] = None, creativeTypes: Seq[CreativeType], adAccountId: Option[String] = None, pinMetrics: Option[Boolean] = None): ApiRequest[BoardsListPins200Response] =
