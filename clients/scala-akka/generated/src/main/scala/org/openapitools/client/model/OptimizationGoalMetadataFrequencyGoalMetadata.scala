...
case class OptimizationGoalMetadataFrequencyGoalMetadata (
  ...
  timerange: Option[OptimizationGoalMetadataFrequencyGoalMetadataEnums.Timerange] = None
) extends ApiModel

object OptimizationGoalMetadataFrequencyGoalMetadataEnums {

  type Timerange = Timerange.Value
