...
@ApiModel(description="An object containing a list of all the asset access requests")@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaResteasyEapServerCodegen", date = "2026-08-30T09:54:43.403996865Z[Etc/UTC]", comments = "Generator version: 7.24.0")
public class CreateAssetAccessRequestBody   {
  ...
  @NotNull
 @Size(min=1,max=100)  public List<@Valid CreateAssetAccessRequestItem> getAssetRequests() {
