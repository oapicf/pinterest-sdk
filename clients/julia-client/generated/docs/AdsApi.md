...
# **ad_previews_create**
> `ad_previews_create`(_api::`AdsApi`, `ad_account_id`::`String`, `ad_preview_request`::`AdPreviewRequest`; _mediaType=nothing) -> `AdPreviewURLResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `ad_previews_create`(_api::`AdsApi`, response_stream::`Channel`, `ad_account_id`::`String`, `ad_preview_request`::`AdPreviewRequest`; _mediaType=nothing) -> `Channel`{ `AdPreviewURLResponse` }, `OpenAPI.Clients.ApiResponse`
...
# **ads_analytics**
> `ads_analytics`(_api::`AdsApi`, `start_date`::`Date`, `end_date`::`Date`, `columns`::`Vector{ReportingColumnSync}`, `granularity`::`Granularity`, `ad_account_id`::`String`; `pin_ids`=nothing, `ad_ids`=nothing, `click_window_days`=nothing, `engagement_window_days`=nothing, `view_window_days`=nothing, `conversion_report_time`=nothing, `campaign_ids`=nothing, `reporting_timezone`=nothing, _mediaType=nothing) -> `Vector{AdsAnalytics}`, `OpenAPI.Clients.ApiResponse` <br/>
> `ads_analytics`(_api::`AdsApi`, response_stream::`Channel`, `start_date`::`Date`, `end_date`::`Date`, `columns`::`Vector{ReportingColumnSync}`, `granularity`::`Granularity`, `ad_account_id`::`String`; `pin_ids`=nothing, `ad_ids`=nothing, `click_window_days`=nothing, `engagement_window_days`=nothing, `view_window_days`=nothing, `conversion_report_time`=nothing, `campaign_ids`=nothing, `reporting_timezone`=nothing, _mediaType=nothing) -> `Channel`{ `Vector{AdsAnalytics}` }, `OpenAPI.Clients.ApiResponse`
...
# **ads_create**
> `ads_create`(_api::`AdsApi`, `ad_account_id`::`String`, `ad_create`::`Vector{AdCreate}`; _mediaType=nothing) -> `AdBatchWriteResponseModel`, `OpenAPI.Clients.ApiResponse` <br/>
> `ads_create`(_api::`AdsApi`, response_stream::`Channel`, `ad_account_id`::`String`, `ad_create`::`Vector{AdCreate}`; _mediaType=nothing) -> `Channel`{ `AdBatchWriteResponseModel` }, `OpenAPI.Clients.ApiResponse`
...
# **ads_get**
> `ads_get`(_api::`AdsApi`, `ad_id`::`String`, `ad_account_id`::`String`; _mediaType=nothing) -> `Ad`, `OpenAPI.Clients.ApiResponse` <br/>
> `ads_get`(_api::`AdsApi`, response_stream::`Channel`, `ad_id`::`String`, `ad_account_id`::`String`; _mediaType=nothing) -> `Channel`{ `Ad` }, `OpenAPI.Clients.ApiResponse`
...
# **ads_list**
> `ads_list`(_api::`AdsApi`, `ad_account_id`::`String`; `bookmark`=nothing, `page_size`=nothing, `order`=nothing, `campaign_ids`=nothing, `ad_group_ids`=nothing, `ad_ids`=nothing, `entity_statuses`=nothing, _mediaType=nothing) -> `AdsList200Response`, `OpenAPI.Clients.ApiResponse` <br/>
> `ads_list`(_api::`AdsApi`, response_stream::`Channel`, `ad_account_id`::`String`; `bookmark`=nothing, `page_size`=nothing, `order`=nothing, `campaign_ids`=nothing, `ad_group_ids`=nothing, `ad_ids`=nothing, `entity_statuses`=nothing, _mediaType=nothing) -> `Channel`{ `AdsList200Response` }, `OpenAPI.Clients.ApiResponse`
...
# **ads_update**
> `ads_update`(_api::`AdsApi`, `ad_account_id`::`String`, `ad_batch_update`::`Vector{AdBatchUpdate}`; _mediaType=nothing) -> `AdBatchWriteResponseModel`, `OpenAPI.Clients.ApiResponse` <br/>
> `ads_update`(_api::`AdsApi`, response_stream::`Channel`, `ad_account_id`::`String`, `ad_batch_update`::`Vector{AdBatchUpdate}`; _mediaType=nothing) -> `Channel`{ `AdBatchWriteResponseModel` }, `OpenAPI.Clients.ApiResponse`
...
> `campaign_ad_preview_create`(_api::`AdsApi`, `ad_account_id`::`String`, `campaign_ad_preview_create_param`::`Vector{CampaignAdPreviewCreate}`; _mediaType=nothing) -> `Vector{CampaignAdPreviewCreate200ResponseInner}`, `OpenAPI.Clients.ApiResponse` <br/>
> `campaign_ad_preview_create`(_api::`AdsApi`, response_stream::`Channel`, `ad_account_id`::`String`, `campaign_ad_preview_create_param`::`Vector{CampaignAdPreviewCreate}`; _mediaType=nothing) -> `Channel`{ `Vector{CampaignAdPreviewCreate200ResponseInner}` }, `OpenAPI.Clients.ApiResponse`
...
> `campaign_ad_preview_delete`(_api::`AdsApi`, `ad_group_ids`::`Vector{String}`, `ad_account_id`::`String`; _mediaType=nothing) -> `Vector{CampaignAdPreviewDelete200ResponseInner}`, `OpenAPI.Clients.ApiResponse` <br/>
> `campaign_ad_preview_delete`(_api::`AdsApi`, response_stream::`Channel`, `ad_group_ids`::`Vector{String}`, `ad_account_id`::`String`; _mediaType=nothing) -> `Channel`{ `Vector{CampaignAdPreviewDelete200ResponseInner}` }, `OpenAPI.Clients.ApiResponse`
...
> `campaign_ad_preview_read`(_api::`AdsApi`, `ad_group_ids`::`Vector{String}`, `ad_account_id`::`String`; _mediaType=nothing) -> `Vector{CampaignAdPreview}`, `OpenAPI.Clients.ApiResponse` <br/>
> `campaign_ad_preview_read`(_api::`AdsApi`, response_stream::`Channel`, `ad_group_ids`::`Vector{String}`, `ad_account_id`::`String`; _mediaType=nothing) -> `Channel`{ `Vector{CampaignAdPreview}` }, `OpenAPI.Clients.ApiResponse`
