...
# **events_create**
> `events_create`(_api::`ConversionEventsApi`, `ad_account_id`::`String`, `conversion_events_create`::`ConversionEventsCreate`; `test`=nothing, _mediaType=nothing) -> `ConversionEvents`, `OpenAPI.Clients.ApiResponse` <br/>
> `events_create`(_api::`ConversionEventsApi`, response_stream::`Channel`, `ad_account_id`::`String`, `conversion_events_create`::`ConversionEventsCreate`; `test`=nothing, _mediaType=nothing) -> `Channel`{ `ConversionEvents` }, `OpenAPI.Clients.ApiResponse`
...
------------- | ------------- | ------------- | -------------
 **_api** | **`ConversionEventsApi`** | API context | 
