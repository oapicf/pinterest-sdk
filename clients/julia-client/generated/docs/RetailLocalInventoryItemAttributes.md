...
**`availability`** | [**`*ItemAvailability`**](ItemAvailability.md) | Availability status of the item | [default to nothing]
**`price`** | **`String`** | The price of the product. It supports the following formats, \&quot;49.99 USD\&quot;, \&quot;49.99USD\&quot; and \&quot;49.99\&quot;. If the currency is not included, we default to US dollars. | [default to nothing]
