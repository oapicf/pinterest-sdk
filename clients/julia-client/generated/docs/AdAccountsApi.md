...
> `ad_account_analytics`(_api::`AdAccountsApi`, `start_date`::`Date`, `end_date`::`Date`, `columns`::`Vector{ReportingColumnSync}`, `granularity`::`Granularity`, `ad_account_id`::`String`; `click_window_days`=nothing, `engagement_window_days`=nothing, `view_window_days`=nothing, `conversion_report_time`=nothing, `reporting_timezone`=nothing, _mediaType=nothing) -> `Vector{AdAccountAnalyticsItems}`, `OpenAPI.Clients.ApiResponse` <br/>
> `ad_account_analytics`(_api::`AdAccountsApi`, response_stream::`Channel`, `start_date`::`Date`, `end_date`::`Date`, `columns`::`Vector{ReportingColumnSync}`, `granularity`::`Granularity`, `ad_account_id`::`String`; `click_window_days`=nothing, `engagement_window_days`=nothing, `view_window_days`=nothing, `conversion_report_time`=nothing, `reporting_timezone`=nothing, _mediaType=nothing) -> `Channel`{ `Vector{AdAccountAnalyticsItems}` }, `OpenAPI.Clients.ApiResponse`
...
------------- | ------------- | ------------- | -------------
 **_api** | **`AdAccountsApi`** | API context | 
...
> `ad_account_targeting_analytics_get`(_api::`AdAccountsApi`, `ad_account_id`::`String`, `start_date`::`Date`, `end_date`::`Date`, `targeting_types`::`Vector{AdsAnalyticsAccountTargetingType}`, `columns`::`Vector{ReportingColumnSync}`, `granularity`::`Granularity`; `click_window_days`=nothing, `engagement_window_days`=nothing, `view_window_days`=nothing, `conversion_report_time`=nothing, `attribution_types`=nothing, `reporting_timezone`=nothing, _mediaType=nothing) -> `MetricsResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `ad_account_targeting_analytics_get`(_api::`AdAccountsApi`, response_stream::`Channel`, `ad_account_id`::`String`, `start_date`::`Date`, `end_date`::`Date`, `targeting_types`::`Vector{AdsAnalyticsAccountTargetingType}`, `columns`::`Vector{ReportingColumnSync}`, `granularity`::`Granularity`; `click_window_days`=nothing, `engagement_window_days`=nothing, `view_window_days`=nothing, `conversion_report_time`=nothing, `attribution_types`=nothing, `reporting_timezone`=nothing, _mediaType=nothing) -> `Channel`{ `MetricsResponse` }, `OpenAPI.Clients.ApiResponse`
...
# **ad_accounts_create**
> `ad_accounts_create`(_api::`AdAccountsApi`, `ad_account_create`::`AdAccountCreate`; _mediaType=nothing) -> `AdAccount`, `OpenAPI.Clients.ApiResponse` <br/>
> `ad_accounts_create`(_api::`AdAccountsApi`, response_stream::`Channel`, `ad_account_create`::`AdAccountCreate`; _mediaType=nothing) -> `Channel`{ `AdAccount` }, `OpenAPI.Clients.ApiResponse`
...
# **ad_accounts_get**
> `ad_accounts_get`(_api::`AdAccountsApi`, `ad_account_id`::`String`; _mediaType=nothing) -> `AdAccount`, `OpenAPI.Clients.ApiResponse` <br/>
> `ad_accounts_get`(_api::`AdAccountsApi`, response_stream::`Channel`, `ad_account_id`::`String`; _mediaType=nothing) -> `Channel`{ `AdAccount` }, `OpenAPI.Clients.ApiResponse`
...
# **ad_accounts_list**
> `ad_accounts_list`(_api::`AdAccountsApi`; `include_shared_accounts`=nothing, `bookmark`=nothing, `page_size`=nothing, _mediaType=nothing) -> `AdAccountsList200Response`, `OpenAPI.Clients.ApiResponse` <br/>
> `ad_accounts_list`(_api::`AdAccountsApi`, response_stream::`Channel`; `include_shared_accounts`=nothing, `bookmark`=nothing, `page_size`=nothing, _mediaType=nothing) -> `Channel`{ `AdAccountsList200Response` }, `OpenAPI.Clients.ApiResponse`
...
> `analytics_create_conversion_product_report`(_api::`AdAccountsApi`, `ad_account_id`::`String`, `conversion_product_report_create`::`ConversionProductReportCreate`; _mediaType=nothing) -> `ConversionProductReport`, `OpenAPI.Clients.ApiResponse` <br/>
> `analytics_create_conversion_product_report`(_api::`AdAccountsApi`, response_stream::`Channel`, `ad_account_id`::`String`, `conversion_product_report_create`::`ConversionProductReportCreate`; _mediaType=nothing) -> `Channel`{ `ConversionProductReport` }, `OpenAPI.Clients.ApiResponse`
...
> `analytics_create_mmm_report`(_api::`AdAccountsApi`, `ad_account_id`::`String`, `m_m_m_report_create`::`MMMReportCreate`; _mediaType=nothing) -> `MMMReport`, `OpenAPI.Clients.ApiResponse` <br/>
> `analytics_create_mmm_report`(_api::`AdAccountsApi`, response_stream::`Channel`, `ad_account_id`::`String`, `m_m_m_report_create`::`MMMReportCreate`; _mediaType=nothing) -> `Channel`{ `MMMReport` }, `OpenAPI.Clients.ApiResponse`
...
> `analytics_create_report`(_api::`AdAccountsApi`, `ad_account_id`::`String`, `ads_analytics_create_async_request`::`AdsAnalyticsCreateAsyncRequest`; _mediaType=nothing) -> `AdsAnalyticsCreateAsyncResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `analytics_create_report`(_api::`AdAccountsApi`, response_stream::`Channel`, `ad_account_id`::`String`, `ads_analytics_create_async_request`::`AdsAnalyticsCreateAsyncRequest`; _mediaType=nothing) -> `Channel`{ `AdsAnalyticsCreateAsyncResponse` }, `OpenAPI.Clients.ApiResponse`
...
> `analytics_create_template_report`(_api::`AdAccountsApi`, `ad_account_id`::`String`, `template_id`::`String`; `start_date`=nothing, `end_date`=nothing, `granularity`=nothing, _mediaType=nothing) -> `TemplateBasedReport`, `OpenAPI.Clients.ApiResponse` <br/>
> `analytics_create_template_report`(_api::`AdAccountsApi`, response_stream::`Channel`, `ad_account_id`::`String`, `template_id`::`String`; `start_date`=nothing, `end_date`=nothing, `granularity`=nothing, _mediaType=nothing) -> `Channel`{ `TemplateBasedReport` }, `OpenAPI.Clients.ApiResponse`
...
> `analytics_get_conversion_product_report`(_api::`AdAccountsApi`, `ad_account_id`::`String`, `token`::`String`; _mediaType=nothing) -> `ConversionProductReport`, `OpenAPI.Clients.ApiResponse` <br/>
> `analytics_get_conversion_product_report`(_api::`AdAccountsApi`, response_stream::`Channel`, `ad_account_id`::`String`, `token`::`String`; _mediaType=nothing) -> `Channel`{ `ConversionProductReport` }, `OpenAPI.Clients.ApiResponse`
...
> `analytics_get_mmm_report`(_api::`AdAccountsApi`, `ad_account_id`::`String`, `token`::`String`; _mediaType=nothing) -> `MMMReport`, `OpenAPI.Clients.ApiResponse` <br/>
> `analytics_get_mmm_report`(_api::`AdAccountsApi`, response_stream::`Channel`, `ad_account_id`::`String`, `token`::`String`; _mediaType=nothing) -> `Channel`{ `MMMReport` }, `OpenAPI.Clients.ApiResponse`
...
> `analytics_get_report`(_api::`AdAccountsApi`, `ad_account_id`::`String`, `token`::`String`; _mediaType=nothing) -> `AdsAnalyticsGetAsyncResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `analytics_get_report`(_api::`AdAccountsApi`, response_stream::`Channel`, `ad_account_id`::`String`, `token`::`String`; _mediaType=nothing) -> `Channel`{ `AdsAnalyticsGetAsyncResponse` }, `OpenAPI.Clients.ApiResponse`
...
# **sandbox_delete**
> `sandbox_delete`(_api::`AdAccountsApi`, `ad_account_id`::`String`; _mediaType=nothing) -> `String`, `OpenAPI.Clients.ApiResponse` <br/>
> `sandbox_delete`(_api::`AdAccountsApi`, response_stream::`Channel`, `ad_account_id`::`String`; _mediaType=nothing) -> `Channel`{ `String` }, `OpenAPI.Clients.ApiResponse`
...
# **templates_list**
> `templates_list`(_api::`AdAccountsApi`, `ad_account_id`::`String`; `bookmark`=nothing, `page_size`=nothing, `order`=nothing, _mediaType=nothing) -> `TemplatesList200Response`, `OpenAPI.Clients.ApiResponse` <br/>
> `templates_list`(_api::`AdAccountsApi`, response_stream::`Channel`, `ad_account_id`::`String`; `bookmark`=nothing, `page_size`=nothing, `order`=nothing, _mediaType=nothing) -> `Channel`{ `TemplatesList200Response` }, `OpenAPI.Clients.ApiResponse`
