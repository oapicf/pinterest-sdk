...
------------ | ------------- | ------------- | -------------
**value** | This is a oneOf model. The value must be exactly one of the following types: CatalogsReportDistributionIssueFilter, CatalogsReportFeedIngestionFilter |  | [optional] 
