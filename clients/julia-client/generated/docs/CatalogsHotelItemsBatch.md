...
**`items`** | [**`Vector{HotelProcessingRecord}`**](HotelProcessingRecord.md) | Array with the catalogs items processing records part of the catalogs items batch | [optional] [default to nothing]
