...
> `product_tags_bulk_add`(_api::`ProductTagsApi`, `pin_id`::`String`, `product_tags_bulk_add_request`::`ProductTagsBulkAddRequest`; _mediaType=nothing) -> `ProductTagsResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `product_tags_bulk_add`(_api::`ProductTagsApi`, response_stream::`Channel`, `pin_id`::`String`, `product_tags_bulk_add_request`::`ProductTagsBulkAddRequest`; _mediaType=nothing) -> `Channel`{ `ProductTagsResponse` }, `OpenAPI.Clients.ApiResponse`
...
------------- | ------------- | ------------- | -------------
 **_api** | **`ProductTagsApi`** | API context | 
...
> `product_tags_bulk_delete`(_api::`ProductTagsApi`, `pin_id`::`String`, `product_tags_bulk_delete_request`::`ProductTagsBulkDeleteRequest`; _mediaType=nothing) -> `Nothing`, `OpenAPI.Clients.ApiResponse` <br/>
> `product_tags_bulk_delete`(_api::`ProductTagsApi`, response_stream::`Channel`, `pin_id`::`String`, `product_tags_bulk_delete_request`::`ProductTagsBulkDeleteRequest`; _mediaType=nothing) -> `Channel`{ `Nothing` }, `OpenAPI.Clients.ApiResponse`
...
# **product_tags_list**
> `product_tags_list`(_api::`ProductTagsApi`, `pin_id`::`String`; _mediaType=nothing) -> `ProductTagsResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `product_tags_list`(_api::`ProductTagsApi`, response_stream::`Channel`, `pin_id`::`String`; _mediaType=nothing) -> `Channel`{ `ProductTagsResponse` }, `OpenAPI.Clients.ApiResponse`
