...
> `customer_segment_create`(_api::`CustomerSegmentApi`, `ad_account_id`::`String`, `customer_segment_create_param`::`CustomerSegmentCreate`; _mediaType=nothing) -> `CustomerSegment`, `OpenAPI.Clients.ApiResponse` <br/>
> `customer_segment_create`(_api::`CustomerSegmentApi`, response_stream::`Channel`, `ad_account_id`::`String`, `customer_segment_create_param`::`CustomerSegmentCreate`; _mediaType=nothing) -> `Channel`{ `CustomerSegment` }, `OpenAPI.Clients.ApiResponse`
...
------------- | ------------- | ------------- | -------------
 **_api** | **`CustomerSegmentApi`** | API context | 
...
> `customer_segment_list`(_api::`CustomerSegmentApi`, `ad_account_id`::`String`; `bookmark`=nothing, `page_size`=nothing, `order`=nothing, `include_sizing`=nothing, `search_query`=nothing, _mediaType=nothing) -> `CustomerSegmentList200Response`, `OpenAPI.Clients.ApiResponse` <br/>
> `customer_segment_list`(_api::`CustomerSegmentApi`, response_stream::`Channel`, `ad_account_id`::`String`; `bookmark`=nothing, `page_size`=nothing, `order`=nothing, `include_sizing`=nothing, `search_query`=nothing, _mediaType=nothing) -> `Channel`{ `CustomerSegmentList200Response` }, `OpenAPI.Clients.ApiResponse`
...
> `customer_segment_update`(_api::`CustomerSegmentApi`, `ad_account_id`::`String`, `customer_segment_update_request_update_with_required_body`::`CustomerSegmentUpdateRequestUpdateWithRequiredBody`; _mediaType=nothing) -> `Nothing`, `OpenAPI.Clients.ApiResponse` <br/>
> `customer_segment_update`(_api::`CustomerSegmentApi`, response_stream::`Channel`, `ad_account_id`::`String`, `customer_segment_update_request_update_with_required_body`::`CustomerSegmentUpdateRequestUpdateWithRequiredBody`; _mediaType=nothing) -> `Channel`{ `Nothing` }, `OpenAPI.Clients.ApiResponse`
