...
# **ad_pins_analytics**
> `ad_pins_analytics`(_api::`CampaignsApi`, `campaign_id`::`String`, `pin_ids`::`Vector{String}`, `start_date`::`Date`, `end_date`::`Date`, `columns`::`Vector{ReportingColumnSync}`, `granularity`::`Granularity`, `ad_account_id`::`String`; `click_window_days`=nothing, `engagement_window_days`=nothing, `view_window_days`=nothing, `conversion_report_time`=nothing, _mediaType=nothing) -> `Vector{AdPinAnalytics}`, `OpenAPI.Clients.ApiResponse` <br/>
> `ad_pins_analytics`(_api::`CampaignsApi`, response_stream::`Channel`, `campaign_id`::`String`, `pin_ids`::`Vector{String}`, `start_date`::`Date`, `end_date`::`Date`, `columns`::`Vector{ReportingColumnSync}`, `granularity`::`Granularity`, `ad_account_id`::`String`; `click_window_days`=nothing, `engagement_window_days`=nothing, `view_window_days`=nothing, `conversion_report_time`=nothing, _mediaType=nothing) -> `Channel`{ `Vector{AdPinAnalytics}` }, `OpenAPI.Clients.ApiResponse`
...
# **campaigns_analytics**
> `campaigns_analytics`(_api::`CampaignsApi`, `start_date`::`Date`, `end_date`::`Date`, `campaign_ids`::`Vector{String}`, `columns`::`Vector{ReportingColumnSync}`, `granularity`::`Granularity`, `ad_account_id`::`String`; `click_window_days`=nothing, `engagement_window_days`=nothing, `view_window_days`=nothing, `conversion_report_time`=nothing, `aggregate_report_rows`=nothing, `reporting_timezone`=nothing, _mediaType=nothing) -> `Vector{CampaignsAnalyticsMetrics}`, `OpenAPI.Clients.ApiResponse` <br/>
> `campaigns_analytics`(_api::`CampaignsApi`, response_stream::`Channel`, `start_date`::`Date`, `end_date`::`Date`, `campaign_ids`::`Vector{String}`, `columns`::`Vector{ReportingColumnSync}`, `granularity`::`Granularity`, `ad_account_id`::`String`; `click_window_days`=nothing, `engagement_window_days`=nothing, `view_window_days`=nothing, `conversion_report_time`=nothing, `aggregate_report_rows`=nothing, `reporting_timezone`=nothing, _mediaType=nothing) -> `Channel`{ `Vector{CampaignsAnalyticsMetrics}` }, `OpenAPI.Clients.ApiResponse`
...
# **campaigns_create**
> `campaigns_create`(_api::`CampaignsApi`, `ad_account_id`::`String`, `campaign_create_item`::`Vector{CampaignCreateItem}`; _mediaType=nothing) -> `CampaignBatchWriteResponseModel`, `OpenAPI.Clients.ApiResponse` <br/>
> `campaigns_create`(_api::`CampaignsApi`, response_stream::`Channel`, `ad_account_id`::`String`, `campaign_create_item`::`Vector{CampaignCreateItem}`; _mediaType=nothing) -> `Channel`{ `CampaignBatchWriteResponseModel` }, `OpenAPI.Clients.ApiResponse`
...
# **campaigns_get**
> `campaigns_get`(_api::`CampaignsApi`, `campaign_id`::`String`, `ad_account_id`::`String`; _mediaType=nothing) -> `Campaign`, `OpenAPI.Clients.ApiResponse` <br/>
> `campaigns_get`(_api::`CampaignsApi`, response_stream::`Channel`, `campaign_id`::`String`, `ad_account_id`::`String`; _mediaType=nothing) -> `Channel`{ `Campaign` }, `OpenAPI.Clients.ApiResponse`
...
# **campaigns_list**
> `campaigns_list`(_api::`CampaignsApi`, `ad_account_id`::`String`; `bookmark`=nothing, `page_size`=nothing, `order`=nothing, `campaign_ids`=nothing, `entity_statuses`=nothing, _mediaType=nothing) -> `CampaignsList200Response`, `OpenAPI.Clients.ApiResponse` <br/>
> `campaigns_list`(_api::`CampaignsApi`, response_stream::`Channel`, `ad_account_id`::`String`; `bookmark`=nothing, `page_size`=nothing, `order`=nothing, `campaign_ids`=nothing, `entity_statuses`=nothing, _mediaType=nothing) -> `Channel`{ `CampaignsList200Response` }, `OpenAPI.Clients.ApiResponse`
...
# **campaigns_update**
> `campaigns_update`(_api::`CampaignsApi`, `ad_account_id`::`String`, `campaign_batch_update_item`::`Vector{CampaignBatchUpdateItem}`; _mediaType=nothing) -> `CampaignBatchWriteResponseModel`, `OpenAPI.Clients.ApiResponse` <br/>
> `campaigns_update`(_api::`CampaignsApi`, response_stream::`Channel`, `ad_account_id`::`String`, `campaign_batch_update_item`::`Vector{CampaignBatchUpdateItem}`; _mediaType=nothing) -> `Channel`{ `CampaignBatchWriteResponseModel` }, `OpenAPI.Clients.ApiResponse`
...
> `get_campaign_delivery_estimates`(_api::`CampaignsApi`, `ad_account_id`::`String`, `campaign_delivery_estimates_campaign`::`Vector{CampaignDeliveryEstimatesCampaign}`; _mediaType=nothing) -> `CampaignDeliveryEstimatesResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_campaign_delivery_estimates`(_api::`CampaignsApi`, response_stream::`Channel`, `ad_account_id`::`String`, `campaign_delivery_estimates_campaign`::`Vector{CampaignDeliveryEstimatesCampaign}`; _mediaType=nothing) -> `Channel`{ `CampaignDeliveryEstimatesResponse` }, `OpenAPI.Clients.ApiResponse`
