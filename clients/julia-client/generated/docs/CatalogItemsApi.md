...
# **items_batch_get**
> `items_batch_get`(_api::`CatalogItemsApi`, `batch_id`::`String`; `ad_account_id`=nothing, _mediaType=nothing) -> `CatalogsItemsBatch`, `OpenAPI.Clients.ApiResponse` <br/>
> `items_batch_get`(_api::`CatalogItemsApi`, response_stream::`Channel`, `batch_id`::`String`; `ad_account_id`=nothing, _mediaType=nothing) -> `Channel`{ `CatalogsItemsBatch` }, `OpenAPI.Clients.ApiResponse`
...
------------- | ------------- | ------------- | -------------
 **_api** | **`CatalogItemsApi`** | API context | 
...
# **items_batch_post**
> `items_batch_post`(_api::`CatalogItemsApi`, `catalogs_items_batch_post_request`::`CatalogsItemsBatchPostRequest`; `ad_account_id`=nothing, _mediaType=nothing) -> `CatalogsItemsBatch`, `OpenAPI.Clients.ApiResponse` <br/>
> `items_batch_post`(_api::`CatalogItemsApi`, response_stream::`Channel`, `catalogs_items_batch_post_request`::`CatalogsItemsBatchPostRequest`; `ad_account_id`=nothing, _mediaType=nothing) -> `Channel`{ `CatalogsItemsBatch` }, `OpenAPI.Clients.ApiResponse`
...
# **items_post**
> `items_post`(_api::`CatalogItemsApi`, `catalogs_items_request`::`CatalogsItemsRequest`; `ad_account_id`=nothing, _mediaType=nothing) -> `ItemsPost200Response`, `OpenAPI.Clients.ApiResponse` <br/>
> `items_post`(_api::`CatalogItemsApi`, response_stream::`Channel`, `catalogs_items_request`::`CatalogsItemsRequest`; `ad_account_id`=nothing, _mediaType=nothing) -> `Channel`{ `ItemsPost200Response` }, `OpenAPI.Clients.ApiResponse`
