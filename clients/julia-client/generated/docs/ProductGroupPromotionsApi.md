...
> `product_group_promotions_create`(_api::`ProductGroupPromotionsApi`, `ad_account_id`::`String`, `product_group_promotions_create_param`::`ProductGroupPromotionsCreate`; _mediaType=nothing) -> `ProductGroupPromotions`, `OpenAPI.Clients.ApiResponse` <br/>
> `product_group_promotions_create`(_api::`ProductGroupPromotionsApi`, response_stream::`Channel`, `ad_account_id`::`String`, `product_group_promotions_create_param`::`ProductGroupPromotionsCreate`; _mediaType=nothing) -> `Channel`{ `ProductGroupPromotions` }, `OpenAPI.Clients.ApiResponse`
...
------------- | ------------- | ------------- | -------------
 **_api** | **`ProductGroupPromotionsApi`** | API context | 
...
> `product_group_promotions_get`(_api::`ProductGroupPromotionsApi`, `ad_account_id`::`String`, `product_group_promotion_id`::`String`; _mediaType=nothing) -> `ProductGroupPromotion`, `OpenAPI.Clients.ApiResponse` <br/>
> `product_group_promotions_get`(_api::`ProductGroupPromotionsApi`, response_stream::`Channel`, `ad_account_id`::`String`, `product_group_promotion_id`::`String`; _mediaType=nothing) -> `Channel`{ `ProductGroupPromotion` }, `OpenAPI.Clients.ApiResponse`
...
> `product_group_promotions_list`(_api::`ProductGroupPromotionsApi`, `ad_account_id`::`String`; `bookmark`=nothing, `page_size`=nothing, `order`=nothing, `product_group_promotion_ids`=nothing, `entity_statuses`=nothing, `ad_group_id`=nothing, _mediaType=nothing) -> `ProductGroupPromotionsList200Response`, `OpenAPI.Clients.ApiResponse` <br/>
> `product_group_promotions_list`(_api::`ProductGroupPromotionsApi`, response_stream::`Channel`, `ad_account_id`::`String`; `bookmark`=nothing, `page_size`=nothing, `order`=nothing, `product_group_promotion_ids`=nothing, `entity_statuses`=nothing, `ad_group_id`=nothing, _mediaType=nothing) -> `Channel`{ `ProductGroupPromotionsList200Response` }, `OpenAPI.Clients.ApiResponse`
...
> `product_group_promotions_update`(_api::`ProductGroupPromotionsApi`, `ad_account_id`::`String`, `product_group_promotions_update_with_required_body`::`ProductGroupPromotionsUpdateWithRequiredBody`; _mediaType=nothing) -> `ProductGroupPromotions`, `OpenAPI.Clients.ApiResponse` <br/>
> `product_group_promotions_update`(_api::`ProductGroupPromotionsApi`, response_stream::`Channel`, `ad_account_id`::`String`, `product_group_promotions_update_with_required_body`::`ProductGroupPromotionsUpdateWithRequiredBody`; _mediaType=nothing) -> `Channel`{ `ProductGroupPromotions` }, `OpenAPI.Clients.ApiResponse`
...
> `product_groups_analytics`(_api::`ProductGroupPromotionsApi`, `start_date`::`Date`, `end_date`::`Date`, `product_group_ids`::`Vector{String}`, `columns`::`Vector{ReportingColumnSync}`, `granularity`::`Granularity`, `ad_account_id`::`String`; `click_window_days`=nothing, `engagement_window_days`=nothing, `view_window_days`=nothing, `conversion_report_time`=nothing, `reporting_timezone`=nothing, _mediaType=nothing) -> `Vector{ProductGroupAnalyticsItems}`, `OpenAPI.Clients.ApiResponse` <br/>
> `product_groups_analytics`(_api::`ProductGroupPromotionsApi`, response_stream::`Channel`, `start_date`::`Date`, `end_date`::`Date`, `product_group_ids`::`Vector{String}`, `columns`::`Vector{ReportingColumnSync}`, `granularity`::`Granularity`, `ad_account_id`::`String`; `click_window_days`=nothing, `engagement_window_days`=nothing, `view_window_days`=nothing, `conversion_report_time`=nothing, `reporting_timezone`=nothing, _mediaType=nothing) -> `Channel`{ `Vector{ProductGroupAnalyticsItems}` }, `OpenAPI.Clients.ApiResponse`
