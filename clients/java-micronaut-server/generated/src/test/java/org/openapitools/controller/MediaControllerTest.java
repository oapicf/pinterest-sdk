...
public class MediaControllerTest {
    ...
    void mediaCreateMethodTest() {
        // given
        MediaUploadRequest mediaUploadRequest = new MediaUploadRequest(null);
    ...
    void mediaCreateClientApiTest() throws IOException {
        // given
        MediaUploadRequest body = new MediaUploadRequest(null);
    ...
    void mediaListMethodTest() {
        ...
        // when
        Paginated result = controller.mediaList(bookmark, pageSize).block();
