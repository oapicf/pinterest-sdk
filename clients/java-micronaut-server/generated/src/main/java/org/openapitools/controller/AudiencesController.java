...
public class AudiencesController {
    ...
    @Operation(
        ...
        parameters = {
            ...
            @Parameter(name = "ownershipType", description = "<strong>This feature is currently in beta and not available to all apps.</strong> Filter audiences by ownership type.")
        },
        security = {
            @SecurityRequirement(name = "pinterest_oauth2", scopes = { "ads:read" })
        }
