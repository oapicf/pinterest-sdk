...
public class ItemsBatchPostRequest {
    ...
    public ItemsBatchPostRequest(Country country, Language language, BatchOperation operation, List<@Valid ItemDeleteBatchRecord> items, CatalogsType catalogType) {
