...
public class CatalogsItemsBatch {
    ...
    public CatalogsItemsBatch(CatalogsType catalogType, OffsetDateTime createdTime) {
     ...
     */
    @NotNull
    @Schema(name = "created_time", accessMode = Schema.AccessMode.READ_ONLY, description = "Date and time (UTC) of the batch creation: YYYY-MM-DD'T'hh:mm:ss", requiredMode = Schema.RequiredMode.REQUIRED)
