 ...
 */
@JsonPropertyOrder({
  CatalogsHotelReportStatsParametersReport.JSON_PROPERTY_FEED_ID,
  CatalogsHotelReportStatsParametersReport.JSON_PROPERTY_PROCESSING_RESULT_ID,
  CatalogsHotelReportStatsParametersReport.JSON_PROPERTY_REPORT_TYPE,
  CatalogsHotelReportStatsParametersReport.JSON_PROPERTY_CATALOG_ID
})
@JsonTypeName("CatalogsHotelReportStatsParametersReport")
...
public class CatalogsHotelReportStatsParametersReport {
    ...
    public CatalogsHotelReportStatsParametersReport(String feedId, ReportTypeEnum reportType) {
        this.feedId = feedId;
