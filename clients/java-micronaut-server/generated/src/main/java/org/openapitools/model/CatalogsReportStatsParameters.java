 ...
 */
@Schema(name = "CatalogsReportStatsParameters", description = "Report stats parameters")
@JsonPropertyOrder({
  CatalogsReportStatsParameters.JSON_PROPERTY_CATALOG_TYPE,
  CatalogsReportStatsParameters.JSON_PROPERTY_REPORT
})
@JsonTypeName("CatalogsReportStatsParameters")
