...
public class KeywordsController {
    ...
    @Operation(
        ...
        parameters = {
            ...
            @Parameter(name = "pageSize", description = "Maximum number of items to include in a single page of the response. Default maximum of 250. See documentation on <a href='/docs/reference/pagination/'>Pagination</a> for more information."),
    ...
    public Mono<KeywordsGet200Response> keywordsGet(
        ...
        @QueryValue(value="ad_group_ids") @Nullable @Size(min=1, max=250) List<@Pattern(regexp = "^\\d+$")@Size(max = 18)String> adGroupIds, 
        @QueryValue(value="match_types") @Nullable @Size(min=1, max=5) List<MatchType> matchTypes, 
        @QueryValue(value="page_size", defaultValue="25") @Nullable @Min(1) Integer pageSize, 
    ...
    @Operation(
        ...
        parameters = {
            ...
            @Parameter(name = "includePrediction", description = "<a href=\"/docs/getting-started/using-beta-and-restricted-features/\" target=\"blank\" target=\"blank\">Closed beta</a> Including predicted weekly search volume data for the next 90 days. By default (`false`), the response will not include predicted data."),
            @Parameter(name = "includeDemographics", description = "<a href=\"/docs/getting-started/using-beta-and-restricted-features/\" target=\"blank\" target=\"blank\">Closed beta</a> Including the age and gender distribution for each keyword. By default (`false`), the response will not include demographics data.")
        },
        security = {
    ...
    public Mono<TrendingKeywordsResponse> trendingKeywordsList(
        ...
        @QueryValue(value="include_prediction", defaultValue="false") @Nullable Boolean includePrediction, 
