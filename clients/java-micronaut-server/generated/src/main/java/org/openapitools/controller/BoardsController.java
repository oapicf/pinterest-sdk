...
public class BoardsController {
    ...
    @Operation(
        ...
        parameters = {
            ...
            @Parameter(name = "boardSectionCreate", required = true),
    ...
    @Produces(value = {"application/json"})
    @Secured({SecurityRule.IS_AUTHENTICATED})
    public Mono<BoardSection> boardSectionsDelete(
        @PathVariable(value="board_id") @NotNull @Pattern(regexp="^\\d+$") String boardId, 
    ...
    @Operation(
        ...
        parameters = {
            @Parameter(name = "boardId", description = "Unique identifier of a board.", required = true),
            @Parameter(name = "sectionId", description = "Unique identifier of a board section.", required = true),
            @Parameter(name = "boardSectionUpdateWithRequiredBody", required = true),
            @Parameter(name = "adAccountId", description = "Unique identifier of an ad account.")
        },
        security = {
            @SecurityRequirement(name = "pinterest_oauth2", scopes = { "boards:read", "boards:write" })
    ...
    @Operation(
        ...
        parameters = {
            @Parameter(name = "boardCreate", required = true),
            @Parameter(name = "adAccountId", description = "Unique identifier of an ad account.")
        },
        security = {
            @SecurityRequirement(name = "pinterest_oauth2", scopes = { "boards:read", "boards:write" }),
    ...
    @Operation(
        ...
        parameters = {
            @Parameter(name = "boardId", required = true),
            @Parameter(name = "adAccountId", description = "Unique identifier of an ad account.")
        },
        security = {
            @SecurityRequirement(name = "pinterest_oauth2", scopes = { "boards:read", "boards:write" })
    ...
    @Produces(value = {"application/json"})
    @Secured({SecurityRule.IS_AUTHENTICATED})
    public Mono<Board> boardsDelete(
        @PathVariable(value="board_id") @NotNull @Pattern(regexp="^\\d+$") String boardId, 
        @QueryValue(value="ad_account_id") @Nullable @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId
    ) {
    ...
    @Operation(
        ...
        parameters = {
            @Parameter(name = "adAccountId", description = "Unique identifier of an ad account."),
            @Parameter(name = "privacy", description = "The privacy level of the board"),
            @Parameter(name = "bookmark", description = "Cursor used to fetch the next page of items"),
            @Parameter(name = "pageSize", description = "Maximum number of items to include in a single page. See documentation on [Pagination](/docs/reference/pagination/) for more information.")
        },
        security = {
    ...
    @Operation(
        ...
        parameters = {
            @Parameter(name = "boardId", required = true),
            @Parameter(name = "boardWithUpdatePrivacyUpdate", required = true),
            @Parameter(name = "adAccountId", description = "Unique identifier of an ad account.")
        },
        security = {
            @SecurityRequirement(name = "pinterest_oauth2", scopes = { "boards:read", "boards:write" }),
    ...
    @Consumes(value = {"application/json"})
    @Secured({SecurityRule.IS_AUTHENTICATED})
    public Mono<BoardWithUpdatePrivacy> boardsUpdate(
        @PathVariable(value="board_id") @NotNull @Pattern(regexp="^\\d+$") String boardId, 
