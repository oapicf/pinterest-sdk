 ...
 */
@Schema(name = "CatalogsVerticalsListProductsByCatalogBasedFilterRequest", description = "Request object to list products for a given catalog_id and product group filter.")
@JsonPropertyOrder({
