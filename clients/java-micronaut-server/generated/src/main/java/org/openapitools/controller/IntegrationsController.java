...
public class IntegrationsController {
    ...
    @Operation(
        ...
        parameters = {
            @Parameter(name = "externalBusinessId", description = "External business ID for the integration.", required = true),
            @Parameter(name = "integrationRequestPatch", description = "Parameters to get create/update the Integration Metadata", required = true)
        },
        security = {
            @SecurityRequirement(name = "pinterest_oauth2", scopes = { "ads:write" })
        }
    ...
    public Mono<IntegrationMetadata> integrationsCommercePatch(
        @PathVariable(value="external_business_id") @NotNull String externalBusinessId, 
        @Body @NotNull @Valid IntegrationRequestPatch integrationRequestPatch
    ) {
    ...
    @Operation(
        ...
        parameters = {
            @Parameter(name = "integrationRequest", description = "Parameters to get create/update the Integration Metadata", required = true)
        },
        security = {
            @SecurityRequirement(name = "pinterest_oauth2", scopes = { "ads:write" })
        }
    ...
    public Mono<IntegrationMetadata> integrationsCommercePost(
        @Body @NotNull @Valid IntegrationRequest integrationRequest
    ) {
