 ...
 */
@Schema(name = "PinMediaSource", description = "Pin media source that can be an image, video, or a mix of both passed in as a request.")
@JsonPropertyOrder({
...
public class PinMediaSource {
    ...
    public PinMediaSource(ContentType contentType, String data, SourceTypeEnum sourceType, String url, String mediaId, List<@Valid PinMediaSourceImagesURLItem> items) {
