...
public class PinsController {
    ...
    public Mono<Map<String, Map<String, PinAnalyticsMetricsResponse>>> multiPinsAnalytics(
        ...
        @QueryValue(value="metric_types") @NotNull List<MultiPinsAnalyticsMetricTypesItem> metricTypes, 
    ...
    public Mono<Map<String, PinAnalyticsMetricsResponse>> pinsAnalytics(
        ...
        @QueryValue(value="start_date") @NotNull @Format("yyyy-MM-dd") LocalDate startDate, 
        @QueryValue(value="end_date") @NotNull @Format("yyyy-MM-dd") LocalDate endDate, 
        @QueryValue(value="metric_types") @NotNull List<QuerypinanalyticsmetrictypesItems> metricTypes, 
        @QueryValue(value="app_types", defaultValue="ALL") @Nullable String appTypes, 
    ...
    @Operation(
        ...
        parameters = {
            ...
            @Parameter(name = "adAccountId", description = "Unique identifier of an ad account."),
            @Parameter(name = "domain", description = "Only return pins with links that match the exact domain. Domain should not include 'www.' prefix. For example, 'pinterest.com' is a valid domain, but 'www.pinterest.com' is not (will not match any pins)."),
            @Parameter(name = "domains", description = "Only return pins with links whose domain matches any value in the list. Values are joined comma-separated on the wire (e.g. `?domains=instagram.com,jcpenney.com`)."),
            @Parameter(name = "includeProductTagObj", description = "Include product tag objects in the response with their associated links."),
    ...
    public Mono<PinsList200Response> pinsList(
        @QueryValue(value="pin_filter") @Nullable PinFilter pinFilter, 
        @QueryValue(value="pin_metrics", defaultValue="false") @Nullable Boolean pinMetrics, 
        @QueryValue(value="include_protected_pins", defaultValue="false") @Nullable Boolean includeProtectedPins, 
        @QueryValue(value="pin_type") @Nullable PinType pinType, 
        @QueryValue(value="creative_types") @Nullable List<CreativeType> creativeTypes, 
        @QueryValue(value="ad_account_id") @Nullable @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId, 
        @QueryValue(value="domain") @Nullable String domain, 
        @QueryValue(value="domains") @Nullable @Size(min=1, max=100) List<String> domains, 
        @QueryValue(value="include_product_tag_obj") @Nullable Boolean includeProductTagObj, 
    ...
    @Operation(
        ...
        parameters = {
            @Parameter(name = "pinId", description = "Unique identifier of a Pin.", required = true),
            @Parameter(name = "pinsSaveRequestCreate", required = true),
            @Parameter(name = "adAccountId", description = "Unique identifier of an ad account.")
        },
        security = {
            @SecurityRequirement(name = "pinterest_oauth2", scopes = { "boards:read", "boards:write", "pins:read", "pins:write" })
    ...
    public Mono<Pin> pinsSave(
        @PathVariable(value="pin_id") @NotNull String pinId, 
        @Body @NotNull @Valid PinsSaveRequestCreate pinsSaveRequestCreate, 
        @QueryValue(value="ad_account_id") @Nullable @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId
    ) {
