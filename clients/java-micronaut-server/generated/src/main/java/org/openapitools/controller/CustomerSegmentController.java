...
@Controller
@Tag(name = "CustomerSegment", description = "The CustomerSegment API")
public class CustomerSegmentController {
    ...
    @Operation(
        ...
        responses = {
            @ApiResponse(responseCode = "200", description = "The request has succeeded.", content = {
                @Content(mediaType = "application/json", schema = @Schema(implementation = CustomerSegment.class))
            }),
        ...
        parameters = {
            ...
            @Parameter(name = "customerSegmentCreate", required = true)
        },
        security = {
    ...
    public Mono<CustomerSegment> customerSegmentCreate(
        ...
        // TODO implement customerSegmentCreate();
    ...
    @Operation(
        ...
        responses = {
            @ApiResponse(responseCode = "200", description = "The request has succeeded.", content = {
                @Content(mediaType = "application/json", schema = @Schema(implementation = CustomerSegmentList200Response.class))
            }),
            @ApiResponse(responseCode = "400", description = "The request could not be understood by the server due to unexpected data.", content = {
                @Content(mediaType = "application/json", schema = @Schema(implementation = PinterestLibError.class))
            }),
    ...
    @Produces(value = {"application/json"})
    @Secured({SecurityRule.IS_AUTHENTICATED})
    public Mono<CustomerSegmentList200Response> customerSegmentList(
        @PathVariable(value="ad_account_id") @NotNull @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId, 
        ...
        // TODO implement customerSegmentList();
        return Mono.error(new HttpStatusException(HttpStatus.NOT_IMPLEMENTED, null));
    }
    ...
    @Operation(
        ...
        parameters = {
            @Parameter(name = "adAccountId", description = "Unique identifier of an ad account.", required = true),
            @Parameter(name = "customerSegmentUpdateRequestUpdateWithRequiredBody", required = true)
        },
        security = {
            @SecurityRequirement(name = "pinterest_oauth2", scopes = { "ads:write" })
        }
