...
public class CatalogsListProductsByFilterRequest {
    ...
    public CatalogsListProductsByFilterRequest(String feedId, CatalogsProductGroupFilters filters, CatalogTypeEnum catalogType, String catalogId, Country country, CatalogsLocale locale) {
        this.feedId = feedId;
