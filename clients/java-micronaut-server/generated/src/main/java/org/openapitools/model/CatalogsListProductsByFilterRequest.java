 ...
 */
@Schema(name = "CatalogsListProductsByFilterRequest", description = "Request object to list products for a given product group filter.")
@JsonPropertyOrder({
...
public class CatalogsListProductsByFilterRequest {
    ...
    public CatalogsListProductsByFilterRequest(String feedId, CatalogsProductGroupFilters filters, String catalogId, CatalogTypeEnum catalogType, Country country, CatalogsLocale locale) {
        this.feedId = feedId;
