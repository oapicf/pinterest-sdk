 ...
 * Error item response
 */
@Schema(name = "ItemResponse_oneOf_1", description = "Error item response")
@JsonPropertyOrder({
  ItemResponseOneOf1.JSON_PROPERTY_CATALOG_TYPE,
  ItemResponseOneOf1.JSON_PROPERTY_ERRORS,
  ItemResponseOneOf1.JSON_PROPERTY_ITEM_ID,
  ItemResponseOneOf1.JSON_PROPERTY_HOTEL_ID,
  ItemResponseOneOf1.JSON_PROPERTY_CREATIVE_ASSETS_ID
})
...
public class ItemResponseOneOf1 {
    ...
    public ItemResponseOneOf1(CatalogsType catalogType, List<@Valid ItemValidationEvent> errors) {
