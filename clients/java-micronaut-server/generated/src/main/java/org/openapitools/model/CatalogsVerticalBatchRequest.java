...
public class CatalogsVerticalBatchRequest {
    ...
    public CatalogsVerticalBatchRequest(CatalogTypeEnum catalogType, Country country, LanguageEnum language, List<@Valid CatalogsCreativeAssetsBatchItem> items) {
