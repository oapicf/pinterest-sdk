 ...
 */
@Schema(name = "CatalogsVerticalBatchRequest", description = "A request object that can have multiple operations on a single batch")
@JsonPropertyOrder({
...
public class CatalogsVerticalBatchRequest {
    ...
    public CatalogsVerticalBatchRequest(CatalogTypeEnum catalogType, Country country, List<@Valid CatalogsCreativeAssetsBatchItem> items, LanguageEnum language) {
