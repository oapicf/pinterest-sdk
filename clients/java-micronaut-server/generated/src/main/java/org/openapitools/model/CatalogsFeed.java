...
public class CatalogsFeed {
    ...
    public CatalogsFeed(OffsetDateTime createdAt, String id, OffsetDateTime updatedAt, CatalogsType catalogType, CatalogsFeedCredentials credentials, ProductAvailabilityType defaultAvailability, Country defaultCountry, NullableCurrency defaultCurrency, String defaultLocale, CatalogsFormat _format, String location, String name, CatalogsFeedProcessingSchedule preferredProcessingSchedule, CatalogsStatus status, String catalogId) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(createdAt, id, updatedAt, catalogType, credentials, defaultAvailability, defaultCountry, defaultCurrency, defaultLocale, _format, location, name, preferredProcessingSchedule, status, catalogId);
    }
