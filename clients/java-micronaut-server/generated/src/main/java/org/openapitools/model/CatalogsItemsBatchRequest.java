...
public class CatalogsItemsBatchRequest {
    ...
    public CatalogsItemsBatchRequest(Country country, CatalogsItemsRequestLanguage language, BatchOperation operation, List<@Valid ItemDeleteBatchRecord> items) {
