 ...
 */
@JsonPropertyOrder({
  CatalogsProductGroupsCreateManyRequestItems.JSON_PROPERTY_DESCRIPTION,
  CatalogsProductGroupsCreateManyRequestItems.JSON_PROPERTY_FEED_ID,
  CatalogsProductGroupsCreateManyRequestItems.JSON_PROPERTY_FILTERS,
  CatalogsProductGroupsCreateManyRequestItems.JSON_PROPERTY_IS_FEATURED,
  CatalogsProductGroupsCreateManyRequestItems.JSON_PROPERTY_NAME
})
...
public class CatalogsProductGroupsCreateManyRequestItems {
    ...
    public CatalogsProductGroupsCreateManyRequestItems(String feedId, CatalogsProductGroupFiltersRequest filters, String name, String catalogId, CatalogTypeEnum catalogType) {
        this.feedId = feedId;
