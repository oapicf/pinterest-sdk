...
public class ConversionsController {
    ...
    @Operation(
        ...
        responses = {
            @ApiResponse(responseCode = "200", description = "The request has succeeded.", content = {
                @Content(mediaType = "application/json", schema = @Schema(implementation = AdvertiserDefinedEventsCreate200Response.class))
            }),
        ...
        parameters = {
            ...
            @Parameter(name = "advertiserDefinedEventsCreateRequest", required = true)
        },
        security = {
    ...
    public Mono<AdvertiserDefinedEventsCreate200Response> advertiserDefinedEventsCreate(
        ...
        // TODO implement advertiserDefinedEventsCreate();
    ...
    @Operation(
        ...
        parameters = {
            @Parameter(name = "adAccountId", description = "Unique identifier of an ad account.", required = true),
            @Parameter(name = "eventNames", description = "List of event names to delete", required = true)
        },
        security = {
            @SecurityRequirement(name = "pinterest_oauth2", scopes = { "ads:write" }),
            @SecurityRequirement(name = "client_credentials", scopes = { "ads:write" })
    ...
    @Produces(value = {"application/json"})
    @Secured({SecurityRule.IS_AUTHENTICATED})
    public Mono<AdvertiserDefinedEventsCreate200Response> advertiserDefinedEventsDelete(
        @PathVariable(value="ad_account_id") @NotNull @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId, 
        @QueryValue(value="event_names") @NotNull List<String> eventNames
    ) {
        // TODO implement advertiserDefinedEventsDelete();
        return Mono.error(new HttpStatusException(HttpStatus.NOT_IMPLEMENTED, null));
    }
    ...
    @Operation(
        ...
        responses = {
            @ApiResponse(responseCode = "200", description = "The request has succeeded.", content = {
                @Content(mediaType = "application/json", schema = @Schema(implementation = AdvertiserDefinedEventsGet200Response.class))
            }),
            @ApiResponse(responseCode = "400", description = "The request could not be understood by the server due to unexpected data.", content = {
                @Content(mediaType = "application/json", schema = @Schema(implementation = PinterestLibError.class))
            }),
    ...
    @Produces(value = {"application/json"})
    @Secured({SecurityRule.IS_AUTHENTICATED})
    public Mono<AdvertiserDefinedEventsGet200Response> advertiserDefinedEventsGet(
        @PathVariable(value="ad_account_id") @NotNull @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId
    ) {
    ...
    @Consumes(value = {"application/json"})
    @Secured({SecurityRule.IS_AUTHENTICATED})
    public Mono<AdvertiserDefinedEventsCreate200Response> advertiserDefinedEventsUpdate(
        @PathVariable(value="ad_account_id") @NotNull @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId, 
        @Body @NotNull @Valid AdvertiserDefinedEventsCreateRequest advertiserDefinedEventsCreateRequest
    ) {
        // TODO implement advertiserDefinedEventsUpdate();
        return Mono.error(new HttpStatusException(HttpStatus.NOT_IMPLEMENTED, null));
    }
