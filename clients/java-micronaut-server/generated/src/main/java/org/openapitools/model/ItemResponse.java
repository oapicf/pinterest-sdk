 ...
 */
@Schema(name = "ItemResponse", description = "Object describing an item record or error")
@JsonPropertyOrder({
...
public class ItemResponse {
    ...
    public ItemResponse(CatalogsType catalogType, List<@Valid ItemValidationEvent> errors) {
