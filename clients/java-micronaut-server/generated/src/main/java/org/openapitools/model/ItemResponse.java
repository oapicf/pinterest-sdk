 ...
 */
@Schema(name = "ItemResponse", description = "Object describing an item record or error. Discriminated by `item_response_kind` (one unique value per leaf).")
@JsonPropertyOrder({
...
public class ItemResponse {
    ...
    public ItemResponse(CatalogTypeEnum catalogType, ItemResponseKindEnum itemResponseKind, List<@Valid ItemValidationEvent> errors) {
