 ...
 */
@Schema(name = "CatalogsVerticalFeedsUpdateRequest", description = "Request object for updating a feed.")
@JsonPropertyOrder({
...
public class CatalogsVerticalFeedsUpdateRequest {
    ...
    public CatalogsVerticalFeedsUpdateRequest(CatalogTypeEnum catalogType) {
