...
# **pinsAnalytics**
```java
Mono<Map<String, AnalyticsMetricsResponse>> PinsController.pinsAnalytics(pinIdstartDateendDatemetricTypesappTypessplitFieldadAccountId)
```
...
**metricTypes** | [**List&lt;String&gt;**](../../docs/models/String.md) | Pin metric types to get data for, default is all. | [enum: `IMPRESSION`, `SAVE`, `PIN_CLICK`, `OUTBOUND_CLICK`, `VIDEO_MRC_VIEW`, `VIDEO_AVG_WATCH_TIME`, `VIDEO_V50_WATCH_TIME`, `QUARTILE_95_PERCENT_VIEW`]
...
# **pinsCreate**
```java
Mono<Pin> PinsController.pinsCreate(pin)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
**pin** | [**Pin**](../../docs/models/Pin.md) | Create a new Pin. |
...
# **pinsDelete**
```java
Mono<Object> PinsController.pinsDelete(pinId)
```
...
# **pinsGet**
```java
Mono<Pin> PinsController.pinsGet(pinIdadAccountId)
```
