...
**metricTypes** | [**List&lt;MultiPinsAnalyticsMetricTypesItem&gt;**](../../docs/models/MultiPinsAnalyticsMetricTypesItem.md) | Pin metric types to get data for. |
...
# **pinsDelete**
```java
Mono<Pin> PinsController.pinsDelete(pinIdadAccountId)
```
...
# **pinsList**
```java
Mono<PinsList200Response> PinsController.pinsList(pinFilterpinMetricsincludeProtectedPinspinTypecreativeTypesadAccountIddomaindomainsincludeProductTagObjbookmarkpageSize)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
**pinFilter** | [**PinFilter**](../../docs/models/.md) | The filter to apply to the pins | [optional parameter] [enum: `exclude_native`, `exclude_repins`, `has_been_promoted`]
**pinMetrics** | `Boolean` | Specify whether to return 90d and lifetime Pin metrics. Total comments and total reactions are only available with lifetime Pin metrics. If Pin was created before &#x60;2023-03-20&#x60; lifetime metrics will only be available for Video and Idea Pin formats. Lifetime metrics are available for all Pin formats since then. | [optional parameter] [default to `false`]
**includeProtectedPins** | `Boolean` | Whether to include protected pins in the results | [optional parameter] [default to `false`]
**pinType** | [**PinType**](../../docs/models/.md) | The type of pins to return, currently only enabled for private pins | [optional parameter] [enum: `PRIVATE`]
...
**adAccountId** | `String` | Unique identifier of an ad account. | [optional parameter]
**domain** | `String` | Only return pins with links that match the exact domain. Domain should not include &#39;www.&#39; prefix. For example, &#39;pinterest.com&#39; is a valid domain, but &#39;www.pinterest.com&#39; is not (will not match any pins). | [optional parameter]
**domains** | [**List&lt;String&gt;**](../../docs/models/String.md) | Only return pins with links whose domain matches any value in the list. Values are joined comma-separated on the wire (e.g. &#x60;?domains&#x3D;instagram.com,jcpenney.com&#x60;). | [optional parameter]
**includeProductTagObj** | `Boolean` | Include product tag objects in the response with their associated links. | [optional parameter]
...
# **pinsSave**
```java
Mono<Pin> PinsController.pinsSave(pinIdpinsSaveRequestCreateadAccountId)
```
...
------------- | ------------- | ------------- | -------------
**pinId** | `String` | Unique identifier of a Pin. |
**pinsSaveRequestCreate** | [**PinsSaveRequestCreate**](../../docs/models/PinsSaveRequestCreate.md) |  |
**adAccountId** | `String` | Unique identifier of an ad account. | [optional parameter]
