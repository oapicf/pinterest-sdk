...
[**adGroupsAudienceSizing**](#adGroupsAudienceSizing) | **GET** /ad_accounts/{ad_account_id}/ad_groups/audience_sizing | Get audience sizing
...
------------- | ------------- | ------------- | -------------
**adAccountId** | `String` | Unique identifier of an ad account. |
**adGroupCreateRequest** | [**List&lt;AdGroupCreateRequest&gt;**](../../docs/models/AdGroupCreateRequest.md) | List of ad groups to create, size limit [1, 30]. |
...
------------- | ------------- | ------------- | -------------
**adAccountId** | `String` | Unique identifier of an ad account. |
**adGroupUpdateRequest** | [**List&lt;AdGroupUpdateRequest&gt;**](../../docs/models/AdGroupUpdateRequest.md) | List of ad groups to update, size limit [1, 30]. |
