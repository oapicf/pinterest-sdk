...
The controller class is defined in **[AdGroupsController.java](../../src/main/java/org/openapitools/controller/AdGroupsController.java)**
...
# **adGroupsAnalytics**
```java
Mono<List<AdGroupsAnalyticsMetrics>> AdGroupsController.adGroupsAnalytics(startDateendDateadGroupIdscolumnsgranularityadAccountIdclickWindowDaysengagementWindowDaysviewWindowDaysconversionReportTimeaggregateReportRowsreportingTimezone)
```
...
### Return type
[**List&lt;AdGroupsAnalyticsMetrics&gt;**](../../docs/models/AdGroupsAnalyticsMetrics.md)
...
```java
Mono<AdGroupAudienceSizing> AdGroupsController.adGroupsAudienceSizing(adAccountIdadGroupAudienceSizingCreate)
```
...
------------- | ------------- | ------------- | -------------
**adAccountId** | `String` | Unique identifier of an ad account. |
**adGroupAudienceSizingCreate** | [**AdGroupAudienceSizingCreate**](../../docs/models/AdGroupAudienceSizingCreate.md) |  |

### Return type
[**AdGroupAudienceSizing**](../../docs/models/AdGroupAudienceSizing.md)
...
# **adGroupsBidFloorGet**
```java
Mono<BidFloor> AdGroupsController.adGroupsBidFloorGet(adAccountIdbidFloorCreate)
```
...
------------- | ------------- | ------------- | -------------
**adAccountId** | `String` | Unique identifier of an ad account. |
**bidFloorCreate** | [**BidFloorCreate**](../../docs/models/BidFloorCreate.md) |  |
...
# **adGroupsCreate**
```java
Mono<AdGroupsCreate200Response> AdGroupsController.adGroupsCreate(adAccountIdadGroupCreateCreate)
```
...
------------- | ------------- | ------------- | -------------
**adAccountId** | `String` | Unique identifier of an ad account. |
**adGroupCreateCreate** | [**List&lt;@Valid AdGroupCreateCreate&gt;**](../../docs/models/AdGroupCreateCreate.md) |  |

### Return type
[**AdGroupsCreate200Response**](../../docs/models/AdGroupsCreate200Response.md)
...
```java
Mono<DynamicTitlesDownloadCSV> AdGroupsController.adGroupsDynamicTitlesDownloadCsv(adAccountIdadGroupId)
```
...
### Return type
[**DynamicTitlesDownloadCSV**](../../docs/models/DynamicTitlesDownloadCSV.md)
...
```java
Mono<DynamicTitlesGetStatus> AdGroupsController.adGroupsDynamicTitlesGetStatus(adAccountIdadGroupId)
```
...
### Return type
[**DynamicTitlesGetStatus**](../../docs/models/DynamicTitlesGetStatus.md)
...
```java
Mono<DynamicTitlesUploadURL> AdGroupsController.adGroupsDynamicTitlesGetUploadUrl(adAccountIdadGroupId)
```
...
### Return type
[**DynamicTitlesUploadURL**](../../docs/models/DynamicTitlesUploadURL.md)
...
```java
Mono<DynamicTitlesProcessCSV> AdGroupsController.adGroupsDynamicTitlesProcessCsv(adAccountIdadGroupIddynamicTitlesProcessCSVCreate)
```
...
**adAccountId** | `String` | Unique identifier of an ad account. |
**adGroupId** | `String` | Ad group ID. |
**dynamicTitlesProcessCSVCreate** | [**DynamicTitlesProcessCSVCreate**](../../docs/models/DynamicTitlesProcessCSVCreate.md) |  |

### Return type
[**DynamicTitlesProcessCSV**](../../docs/models/DynamicTitlesProcessCSV.md)
...
# **adGroupsGet**
```java
Mono<AdGroup> AdGroupsController.adGroupsGet(adGroupIdadAccountId)
```
...
### Return type
[**AdGroup**](../../docs/models/AdGroup.md)
...
# **adGroupsList**
```java
Mono<AdGroupsList200Response> AdGroupsController.adGroupsList(adAccountIdbookmarkpageSizeordercampaignIdsadGroupIdsentityStatusestranslateInterestsToNames)
```
...
### Return type
[**AdGroupsList200Response**](../../docs/models/AdGroupsList200Response.md)
...
```java
Mono<MetricsResponse> AdGroupsController.adGroupsTargetingAnalyticsGet(adAccountIdadGroupIdsstartDateendDatetargetingTypescolumnsgranularityclickWindowDaysengagementWindowDaysviewWindowDaysconversionReportTimeattributionTypesreportingTimezonesortColumnssortAscending)
```
...
**startDate** | `LocalDate` | Metric report start date (UTC). Format: YYYY-MM-DD. Cannot be more than 90 days back from today. |
**endDate** | `LocalDate` | Metric report end date (UTC). Format: YYYY-MM-DD. Cannot be more than 90 days past start_date. |
**targetingTypes** | [**List&lt;AdsAnalyticsAdGroupTargetingType&gt;**](../../docs/models/AdsAnalyticsAdGroupTargetingType.md) | Targeting type breakdowns for the report. The reporting per targeting type is independent from each other. [\&quot;AGE_BUCKET_AND_GENDER\&quot;, \&quot;CREATIVE_ENHANCEMENTS\&quot;] are in BETA and not yet available to all users. |
**columns** | [**List&lt;ReportingColumnSync&gt;**](../../docs/models/ReportingColumnSync.md) | Columns to retrieve, encoded as a comma-separated string. **NOTE**: Any metrics defined as MICRO_DOLLARS returns a value based on the advertiser profile&#39;s currency field. For USD, ($1/1,000,000, or $0.000001 - one one-ten-thousandth of a cent). it&#39;s microdollars. Otherwise, it&#39;s in microunits of the advertiser&#39;s currency.  For example, if the advertiser&#39;s currency is GBP (British pound sterling), all MICRO_DOLLARS fields will be in GBP microunits (1/1,000,000 British pound).  If a column has no value, it may not be returned. |
**granularity** | [**Granularity**](../../docs/models/.md) |   TOTAL - metrics are aggregated over the specified date range.    DAY - metrics are broken down daily.    HOUR - metrics are broken down hourly.    WEEK - metrics are broken down weekly.    MONTH - metrics are broken down monthly | [enum: `TOTAL`, `DAY`, `HOUR`, `WEEK`, `MONTH`]
**clickWindowDays** | `BigDecimal` | Number of days to use as the conversion attribution window for a pin click action. Applies to Pinterest Tag conversion metrics. Prior conversion tags use their defined attribution windows. If not specified, defaults to &#x60;30&#x60; days. | [optional parameter] [default to `30`] [enum: `0`, `1`, `7`, `14`, `30`, `60`]
**engagementWindowDays** | `BigDecimal` | Number of days to use as the conversion attribution window for an engagement action. Engagements include saves, closeups, link clicks, and carousel card swipes. Applies to Pinterest Tag conversion metrics. Prior conversion tags use their defined attribution windows. If not specified, defaults to &#x60;30&#x60; days. **Note:** This parameter no longer returns new data. However, you can still access historic data through **Sept 30, 2027**. | [optional parameter] [default to `30`] [enum: `0`, `1`, `7`, `14`, `30`, `60`]
...
# **adGroupsUpdate**
```java
Mono<AdGroupsCreate200Response> AdGroupsController.adGroupsUpdate(adAccountIdadGroupUpdateBatchUpdate)
```
...
------------- | ------------- | ------------- | -------------
**adAccountId** | `String` | Unique identifier of an ad account. |
**adGroupUpdateBatchUpdate** | [**List&lt;@Valid AdGroupUpdateBatchUpdate&gt;**](../../docs/models/AdGroupUpdateBatchUpdate.md) |  |
...
```java
Mono<AdGroupsList200Response> AdGroupsController.getAdGroupsByPromotionIdsList(adAccountIdpromotionIdsbookmarkpageSizeorder)
```
...
------------- | ------------- | ------------- | -------------
**adAccountId** | `String` | Unique identifier of an ad account. |
**promotionIds** | [**List&lt;String&gt;**](../../docs/models/String.md) | List of Promotion IDs to use to filter the results. |
**bookmark** | `String` | Cursor used to fetch the next page of items | [optional parameter]
**pageSize** | `Integer` | Maximum number of items to include in a single page. See documentation on [Pagination](/docs/reference/pagination/) for more information. | [optional parameter] [default to `25`]
**order** | [**PinterestLibPaginationOrder**](../../docs/models/.md) | The order in which to sort the items returned: \&quot;ASCENDING\&quot; or \&quot;DESCENDING\&quot; by ID. Note that higher-value IDs are associated with more-recently added items. | [optional parameter] [enum: `ASCENDING`, `DESCENDING`]
