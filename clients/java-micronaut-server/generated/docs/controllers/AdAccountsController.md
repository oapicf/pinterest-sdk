...
# **adAccountAnalytics**
```java
Mono<List<AdAccountAnalyticsResponseInner>> AdAccountsController.adAccountAnalytics(adAccountIdstartDateendDatecolumnsgranularityclickWindowDaysengagementWindowDaysviewWindowDaysconversionReportTime)
```
...
### Return type
[**List&lt;AdAccountAnalyticsResponseInner&gt;**](../../docs/models/AdAccountAnalyticsResponseInner.md)
...
```java
Mono<MetricsResponse> AdAccountsController.adAccountTargetingAnalyticsGet(adAccountIdstartDateendDatetargetingTypescolumnsgranularityclickWindowDaysengagementWindowDaysviewWindowDaysconversionReportTimeattributionTypes)
```
...
# **adAccountsCreate**
```java
Mono<AdAccount> AdAccountsController.adAccountsCreate(adAccountCreateRequest)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
**adAccountCreateRequest** | [**AdAccountCreateRequest**](../../docs/models/AdAccountCreateRequest.md) | Ad account to create. |
...
# **adAccountsList**
```java
Mono<AdAccountsList200Response> AdAccountsController.adAccountsList(bookmarkpageSizeincludeSharedAccounts)
```
...
```java
Mono<CreateMMMReportResponse> AdAccountsController.analyticsCreateMmmReport(adAccountIdcreateMMMReportRequest)
```
...
------------- | ------------- | ------------- | -------------
**adAccountId** | `String` | Unique identifier of an ad account. |
**createMMMReportRequest** | [**CreateMMMReportRequest**](../../docs/models/CreateMMMReportRequest.md) |  |

### Return type
[**CreateMMMReportResponse**](../../docs/models/CreateMMMReportResponse.md)
...
```java
Mono<AdsAnalyticsCreateAsyncResponse> AdAccountsController.analyticsCreateTemplateReport(adAccountIdtemplateIdstartDateendDategranularity)
```
...
**granularity** | [**Granularity**](../../docs/models/.md) | TOTAL - metrics are aggregated over the specified date range.&lt;br&gt; DAY - metrics are broken down daily.&lt;br&gt; HOUR - metrics are broken down hourly.&lt;br&gt;WEEKLY - metrics are broken down weekly.&lt;br&gt;MONTHLY - metrics are broken down monthly | [optional parameter] [enum: `TOTAL`, `DAY`, `HOUR`, `WEEK`, `MONTH`]
...
```java
Mono<GetMMMReportResponse> AdAccountsController.analyticsGetMmmReport(adAccountIdtoken)
```
...
### Return type
[**GetMMMReportResponse**](../../docs/models/GetMMMReportResponse.md)
...
# **templatesList**
```java
Mono<TemplatesList200Response> AdAccountsController.templatesList(adAccountIdpageSizeorderbookmark)
```
