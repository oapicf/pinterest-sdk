...
```java
Mono<MetricsResponse> CampaignsController.campaignTargetingAnalyticsGet(adAccountIdcampaignIdsstartDateendDatetargetingTypescolumnsgranularityclickWindowDaysengagementWindowDaysviewWindowDaysconversionReportTimeattributionTypes)
```
...
# **campaignsAnalytics**
```java
Mono<List<CampaignsAnalyticsResponseInner>> CampaignsController.campaignsAnalytics(adAccountIdstartDateendDatecampaignIdscolumnsgranularityclickWindowDaysengagementWindowDaysviewWindowDaysconversionReportTime)
```
