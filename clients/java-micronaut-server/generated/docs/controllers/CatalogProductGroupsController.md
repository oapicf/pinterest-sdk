...
```java
Mono<CatalogsProductGroupPinsList200Response> CatalogProductGroupsController.catalogsProductGroupPinsList(productGroupIdadAccountIdpinMetricsbookmarkpageSize)
```
...
* **client_credentials**, scopes: `boards:read`, `catalogs:read`, `pins:read`
...
```java
Mono<CatalogsVerticalProductGroup> CatalogProductGroupsController.catalogsProductGroupsCreate(catalogsProductGroupsCreateRequestSchemaadAccountId)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
**catalogsProductGroupsCreateRequestSchema** | [**CatalogsProductGroupsCreateRequestSchema**](../../docs/models/CatalogsProductGroupsCreateRequestSchema.md) |  |
**adAccountId** | `String` | Unique identifier of an ad account. | [optional parameter]
...
```java
Mono<List<String>> CatalogProductGroupsController.catalogsProductGroupsCreateMany(catalogsProductGroupsCreateManyRequestItemsadAccountId)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
**catalogsProductGroupsCreateManyRequestItems** | [**List&lt;CatalogsProductGroupsCreateManyRequestItems&gt;**](../../docs/models/CatalogsProductGroupsCreateManyRequestItems.md) |  |
**adAccountId** | `String` | Unique identifier of an ad account. | [optional parameter]
...
```java
Mono<CatalogsVerticalProductGroup> CatalogProductGroupsController.catalogsProductGroupsDelete(productGroupIdadAccountId)
```
...
```java
Mono<CatalogsProductGroupsList200Response> CatalogProductGroupsController.catalogsProductGroupsList(idfeedIdcatalogIdadAccountIdbookmarkpageSize)
```
...
```java
Mono<CatalogsVerticalProductGroup> CatalogProductGroupsController.catalogsProductGroupsUpdate(productGroupIdcatalogsProductGroupsUpdateRequestSchemaadAccountId)
```
...
------------- | ------------- | ------------- | -------------
**productGroupId** | `String` | Unique identifier of a product group |
**catalogsProductGroupsUpdateRequestSchema** | [**CatalogsProductGroupsUpdateRequestSchema**](../../docs/models/CatalogsProductGroupsUpdateRequestSchema.md) |  |
**adAccountId** | `String` | Unique identifier of an ad account. | [optional parameter]
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
**catalogsListProductsByFilterRequest** | [**CatalogsListProductsByFilterRequest**](../../docs/models/CatalogsListProductsByFilterRequest.md) |  |
**bookmark** | `String` | Cursor used to fetch the next page of items | [optional parameter]
**pageSize** | `Integer` | Maximum number of items to include in a single page. See documentation on [Pagination](/docs/reference/pagination/) for more information. | [optional parameter] [default to `25`]
**adAccountId** | `String` | Unique identifier of an ad account. | [optional parameter]
**pinMetrics** | `Boolean` | Specify whether to return 90d and lifetime Pin metrics. Total comments and total reactions are only available with lifetime Pin metrics. If Pin was created before &#x60;2023-03-20&#x60; lifetime metrics will only be available for Video and Idea Pin formats. Lifetime metrics are available for all Pin formats since then. | [optional parameter] [default to `false`]
