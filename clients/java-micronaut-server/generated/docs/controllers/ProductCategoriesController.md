...
The controller class is defined in **[ProductCategoriesController.java](../../src/main/java/org/openapitools/controller/ProductCategoriesController.java)**
...
```java
Mono<List<FeaturedTrend>> ProductCategoriesController.trendsFeaturedTopicsList(regioninterest)
```
...
```java
Mono<List<ProductCategoryDetails>> ProductCategoriesController.trendsProductCategoriesDetailsList(productCategoriesregionlookbackWindowengagementType)
```
...
```java
Mono<List<TrendingProductCategory>> ProductCategoriesController.trendsProductCategoriesTrendingList(regionverticalsagesgendersengagementType)
```
