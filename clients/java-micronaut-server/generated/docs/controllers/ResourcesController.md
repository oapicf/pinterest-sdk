...
```java
Mono<AdAccountCountriesGet200Response> ResourcesController.adAccountCountriesGet()
```
...
### Return type
[**AdAccountCountriesGet200Response**](../../docs/models/AdAccountCountriesGet200Response.md)
...
# **deliveryMetricsGet**
```java
Mono<DeliveryMetricsGet200Response> ResourcesController.deliveryMetricsGet(reportType)
```
...
------------- | ------------- | ------------- | -------------
**reportType** | [**ReportType**](../../docs/models/.md) | Report type. | [optional parameter] [enum: `SYNC`, `ASYNC`]

### Return type
[**DeliveryMetricsGet200Response**](../../docs/models/DeliveryMetricsGet200Response.md)
...
```java
Mono<SingleInterestTargetingOption> ResourcesController.interestTargetingOptionsGet(interestId)
```
...
### Return type
[**SingleInterestTargetingOption**](../../docs/models/SingleInterestTargetingOption.md)
...
```java
Mono<BookClosed> ResourcesController.metricsReadyStateGet(date)
```
...
### Return type
[**BookClosed**](../../docs/models/BookClosed.md)
...
# **targetingOptionsGet**
```java
Mono<List<Object>> ResourcesController.targetingOptionsGet(targetingTypeadAccountIdclientIdoauthSignaturetimestamp)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
**targetingType** | [**PublicTargetingType**](../../docs/models/.md) | Public targeting type | [enum: `APPTYPE`, `GENDER`, `LOCALE`, `AGE_BUCKET`, `LOCATION`, `GEO`, `INTEREST`, `KEYWORD`, `AUDIENCE_INCLUDE`, `AUDIENCE_EXCLUDE`]
