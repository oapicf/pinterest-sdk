...
```java
Mono<List<ProductGroupAnalyticsResponseInner>> ProductGroupPromotionsController.productGroupsAnalytics(adAccountIdstartDateendDateproductGroupIdscolumnsgranularityclickWindowDaysengagementWindowDaysviewWindowDaysconversionReportTimereportingTimezone)
```
