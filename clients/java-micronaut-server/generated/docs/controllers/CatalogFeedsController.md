...
```java
Mono<FeedProcessingResultsList200Response> CatalogFeedsController.feedProcessingResultsList(feedIdbookmarkpageSizeadAccountId)
```
...
# **feedsCreate**
```java
Mono<CatalogsFeed> CatalogFeedsController.feedsCreate(feedsCreateRequestadAccountId)
```
...
# **feedsDelete**
```java
Mono<Object> CatalogFeedsController.feedsDelete(feedIdadAccountId)
```
...
# **feedsList**
```java
Mono<FeedsList200Response> CatalogFeedsController.feedsList(bookmarkpageSizecatalogIdadAccountId)
```
...
# **feedsUpdate**
```java
Mono<CatalogsFeed> CatalogFeedsController.feedsUpdate(feedIdfeedsUpdateRequestadAccountId)
```
...
# **itemsIssuesList**
```java
Mono<ItemsIssuesList200Response> CatalogFeedsController.itemsIssuesList(processingResultIdbookmarkpageSizeitemNumbersitemValidationIssueadAccountId)
```
