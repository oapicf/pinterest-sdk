...
The class is defined in **[BulkDownloadCreate.java](../../src/main/java/org/openapitools/model/BulkDownloadCreate.java)**

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**campaignFilter** | [`BulkDownloadCampaignFilter`](BulkDownloadCampaignFilter.md) |  |  [optional property]
