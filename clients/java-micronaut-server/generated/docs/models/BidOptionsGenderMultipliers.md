...
The class is defined in **[BidOptionsGenderMultipliers.java](../../src/main/java/org/openapitools/model/BidOptionsGenderMultipliers.java)**

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**female** | `BigDecimal` |  |  [optional property]
**male** | `BigDecimal` |  |  [optional property]
