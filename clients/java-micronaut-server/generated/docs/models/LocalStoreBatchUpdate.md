...
The class is defined in **[LocalStoreBatchUpdate.java](../../src/main/java/org/openapitools/model/LocalStoreBatchUpdate.java)**
...
**country** | `Country` | Country code where the store is located. |  [optional property]
...
**name** | `String` | The name of the local store. |  [optional property]
...
**storeCode** | `String` | Merchant provided code for the local store. Unique within the merchant&#39;s catalog. |  [optional property]
