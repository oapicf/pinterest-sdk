...
The class is defined in **[Promotion.java](../../src/main/java/org/openapitools/model/Promotion.java)**

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**adAccountId** | `String` | The Ad Account ID that this promotion belongs to. |  [readonly property]
