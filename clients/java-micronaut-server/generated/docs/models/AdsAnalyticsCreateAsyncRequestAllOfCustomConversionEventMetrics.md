...
The class is defined in **[AdsAnalyticsCreateAsyncRequestAllOfCustomConversionEventMetrics.java](../../src/main/java/org/openapitools/model/AdsAnalyticsCreateAsyncRequestAllOfCustomConversionEventMetrics.java)**
