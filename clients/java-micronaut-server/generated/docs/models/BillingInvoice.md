...
The class is defined in **[BillingInvoice.java](../../src/main/java/org/openapitools/model/BillingInvoice.java)**
...
**documentType** | `BillingInvoiceDocumentType` | The type of the document |  [optional property]
...
**status** | `BillingInvoiceStatus` | The status of the invoice |  [optional property]
