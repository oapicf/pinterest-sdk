...
The class is defined in **[FrequencyMultipliers.java](../../src/main/java/org/openapitools/model/FrequencyMultipliers.java)**

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**IMPRESSION_COUNT** | `String` | Impression count identifier. |  [optional property]
