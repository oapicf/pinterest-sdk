...
The class is defined in **[TrendingKeywordsResponseTrendsInnerTimeSeries.java](../../src/main/java/org/openapitools/model/TrendingKeywordsResponseTrendsInnerTimeSeries.java)**

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**date** | `LocalDate` |  |  [optional property]
