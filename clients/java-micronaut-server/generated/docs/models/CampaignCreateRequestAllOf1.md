...
The class is defined in **[CampaignCreateRequestAllOf1.java](../../src/main/java/org/openapitools/model/CampaignCreateRequestAllOf1.java)**

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**bidOptions** | [`CampaignBidOptionsCreate`](CampaignBidOptionsCreate.md) |  |  [optional property]
**intendedPromotionType** | `IntendedPromotionType` |  |  [optional property]
**isAutomatedCampaign** | `Boolean` | Note: This field is immutable unless the campaign is in draft status. Specifies whether the campaign was created in the automated campaign flow. When using Automated Campaigns, a daily spend cap must be set, and Pinterest Performance+ may not be used. The following objective types are supported: - CONSIDERATION - WEB\\_CONVERSION - SALES - CATALOG\\_SALES |  [optional property]
