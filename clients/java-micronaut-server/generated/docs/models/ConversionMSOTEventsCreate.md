...
The class is defined in **[ConversionMSOTEventsCreate.java](../../src/main/java/org/openapitools/model/ConversionMSOTEventsCreate.java)**
...
**attributionModel** | `AttributionModel` | The attribution model used to attribute the conversion event. |  [optional property]
**attributionScope** | `AttributionScope` | Ad event type. |  [optional property]
...
**clickWindow** | `String` | Click window used for attribution (for example, &#x60;1d&#x60;, &#x60;7d&#x60;, &#x60;30d&#x60;, &#x60;lifetime&#x60;). |  [optional property]
**currency** | `Currency` | Currency code for the &#x60;value&#x60; field, required if &#x60;value&#x60; is present. Currency Codes should be in ISO 4217 standard. |  [optional property]
