...
The class is defined in **[CustomerListCreate.java](../../src/main/java/org/openapitools/model/CustomerListCreate.java)**
...
**listType** | `UserListType` | Type of customer list (e.g., EMAIL, IDFA, MAID). |  [optional property]
