...
The class is defined in **[BidOptionsPlacementMultipliers.java](../../src/main/java/org/openapitools/model/BidOptionsPlacementMultipliers.java)**

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**browse** | `BigDecimal` |  |  [optional property]
**relatedPins** | `BigDecimal` |  |  [optional property]
**search** | `BigDecimal` |  |  [optional property]
