...
/**
  * Represents the Swagger definition for LeadFormCreateRequest.
...
object LeadFormCreateRequest {
  implicit lazy val leadFormCreateRequestJsonFormat: Format[LeadFormCreateRequest] = {
    val realJsonFormat = Json.format[LeadFormCreateRequest]
    val declaredPropNames = Set("name", "privacyPolicyLink", "hasAcceptedTerms", "completionMessage", "status", "disclosureLanguage", "questions", "policyLinks")
    ...
    Format(
      ...
      Writes { leadFormCreateRequest =>
        val jsObj = realJsonFormat.writes(leadFormCreateRequest)
