...
/**
  * Represents the Swagger definition for ConversionEventsUserData_anyOf_1.
...
object ConversionEventsUserDataAnyOf1 {
  implicit lazy val conversionEventsUserDataAnyOf1JsonFormat: Format[ConversionEventsUserDataAnyOf1] = Json.format[ConversionEventsUserDataAnyOf1]
}
