...
/**
  * Represents the Swagger definition for AdGroupAudienceSizing.
...
object AdGroupAudienceSizing {
  implicit lazy val adGroupAudienceSizingJsonFormat: Format[AdGroupAudienceSizing] = Json.format[AdGroupAudienceSizing]
}
