...
/**
  * Represents the Swagger definition for ConversionEventsUserDataProperties.
...
object ConversionEventsUserDataProperties {
  implicit lazy val conversionEventsUserDataPropertiesJsonFormat: Format[ConversionEventsUserDataProperties] = Json.format[ConversionEventsUserDataProperties]
}
