...
/**
  * Represents the Swagger definition for PinRead.
...
object PinRead {
  implicit lazy val pinReadJsonFormat: Format[PinRead] = {
    val realJsonFormat = Json.format[PinRead]
    ...
    Format(
      ...
      Writes { pinRead =>
        val jsObj = realJsonFormat.writes(pinRead)
