...
/**
  * Represents the Swagger definition for AdGroupUpdateRequestAllOf1.
...
object AdGroupUpdateRequestAllOf1 {
  implicit lazy val adGroupUpdateRequestAllOf1JsonFormat: Format[AdGroupUpdateRequestAllOf1] = Json.format[AdGroupUpdateRequestAllOf1]
}
