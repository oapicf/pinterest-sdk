...
case class CatalogsItemsUpdateBatchRequest(
  ...
  language: CatalogsItemsUpdateBatchRequest.Language.Value,
  operation: CatalogsItemsUpdateBatchRequest.Operation.Value
)

object CatalogsItemsUpdateBatchRequest {
  implicit lazy val catalogsItemsUpdateBatchRequestJsonFormat: Format[CatalogsItemsUpdateBatchRequest] = Json.format[CatalogsItemsUpdateBatchRequest]
