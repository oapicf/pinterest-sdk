...
object CampaignUpdateRequest {
  implicit lazy val campaignUpdateRequestJsonFormat: Format[CampaignUpdateRequest] = {
    ...
    val declaredPropNames = Set("id", "adAccountId", "dailySpendCap", "endTime", "isAutomatedCampaign", "isFlexibleDailyBudgets", "lifetimeSpendCap", "name", "orderLineId", "startTime", "status", "trackingUrls", "defaultAdGroupBudgetInMicroCurrency", "isCampaignBudgetOptimization", "bidOptions", "isPerformancePlus", "objectiveType")
