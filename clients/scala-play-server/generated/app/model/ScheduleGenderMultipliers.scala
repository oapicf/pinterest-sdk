...
object ScheduleGenderMultipliers {
  implicit lazy val scheduleGenderMultipliersJsonFormat: Format[ScheduleGenderMultipliers] = {
    val realJsonFormat = Json.format[ScheduleGenderMultipliers]
    ...
    Format(
      ...
      Writes { scheduleGenderMultipliers =>
        val jsObj = realJsonFormat.writes(scheduleGenderMultipliers)
