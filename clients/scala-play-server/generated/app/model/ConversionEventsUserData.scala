...
object ConversionEventsUserData {
  implicit lazy val conversionEventsUserDataJsonFormat: Format[ConversionEventsUserData] = {
    val realJsonFormat = Json.format[ConversionEventsUserData]
    val declaredPropNames = Set("clickId", "clientIpAddress", "clientUserAgent", "country", "ct", "db", "em", "externalId", "fn", "ge", "hashedMaids", "ln", "partnerId", "ph", "st", "zp")
    ...
    Format(
      ...
      Writes { conversionEventsUserData =>
        val jsObj = realJsonFormat.writes(conversionEventsUserData)
