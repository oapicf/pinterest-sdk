...
object ScheduleBidOptionsGenderMultipliers {
  implicit lazy val scheduleBidOptionsGenderMultipliersJsonFormat: Format[ScheduleBidOptionsGenderMultipliers] = {
    val realJsonFormat = Json.format[ScheduleBidOptionsGenderMultipliers]
    ...
    Format(
      ...
      Writes { scheduleBidOptionsGenderMultipliers =>
        val jsObj = realJsonFormat.writes(scheduleBidOptionsGenderMultipliers)
