...
/**
  * Represents the Swagger definition for AdGroup.
...
object AdGroup {
  implicit lazy val adGroupJsonFormat: Format[AdGroup] = {
    val realJsonFormat = Json.format[AdGroup]
    ...
    Format(
      ...
      Writes { adGroup =>
        val jsObj = realJsonFormat.writes(adGroup)
