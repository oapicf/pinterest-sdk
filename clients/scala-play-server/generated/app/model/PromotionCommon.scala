...
/**
  * Represents the Swagger definition for PromotionCommon.
...
case class PromotionCommon(
  discountStatus: Option[PromotionCommon.DiscountStatus.Value],
  endTime: Option[Int],
...
object PromotionCommon {
  implicit lazy val promotionCommonJsonFormat: Format[PromotionCommon] = Json.format[PromotionCommon]
