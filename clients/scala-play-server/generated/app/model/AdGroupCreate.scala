...
/**
  * Represents the Swagger definition for AdGroupCreate.
...
object AdGroupCreate {
  implicit lazy val adGroupCreateJsonFormat: Format[AdGroupCreate] = {
    val realJsonFormat = Json.format[AdGroupCreate]
    ...
    Format(
      ...
      Writes { adGroupCreate =>
        val jsObj = realJsonFormat.writes(adGroupCreate)
