...
/**
  * Represents the Swagger definition for CatalogsHotelReportParametersReport.
...
case class CatalogsHotelReportParametersReport(
  ...
  reportType: CatalogsHotelReportParametersReport.ReportType.Value,
  catalogId: Option[String]
  additionalProperties: 
)

object CatalogsHotelReportParametersReport {
  implicit lazy val catalogsHotelReportParametersReportJsonFormat: Format[CatalogsHotelReportParametersReport] = {
    val realJsonFormat = Json.format[CatalogsHotelReportParametersReport]
    ...
    Format(
      ...
      Writes { catalogsHotelReportParametersReport =>
        val jsObj = realJsonFormat.writes(catalogsHotelReportParametersReport)
