...
/**
  * Represents the Swagger definition for CatalogsItemsBatchPostRequest.
...
case class CatalogsItemsBatchPostRequest(
  ...
  catalogType: CatalogsItemsBatchPostRequest.CatalogType.Value,
  country: Country,
  items: List[ItemDeleteBatchRecord],
  language: CatalogsItemsBatchPostRequest.Language.Value,
  operation: CatalogsItemsBatchPostRequest.Operation.Value
)

object CatalogsItemsBatchPostRequest {
  implicit lazy val catalogsItemsBatchPostRequestJsonFormat: Format[CatalogsItemsBatchPostRequest] = Json.format[CatalogsItemsBatchPostRequest]
