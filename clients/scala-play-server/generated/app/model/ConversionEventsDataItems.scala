...
/**
  * Represents the Swagger definition for ConversionEventsDataItems.
...
object ConversionEventsDataItems {
  implicit lazy val conversionEventsDataItemsJsonFormat: Format[ConversionEventsDataItems] = Json.format[ConversionEventsDataItems]
}
