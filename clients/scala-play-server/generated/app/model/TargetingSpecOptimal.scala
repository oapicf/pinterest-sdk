...
/**
  * Represents the Swagger definition for TargetingSpecOptimal.
...
object TargetingSpecOptimal {
  implicit lazy val targetingSpecOptimalJsonFormat: Format[TargetingSpecOptimal] = Json.format[TargetingSpecOptimal]
}
