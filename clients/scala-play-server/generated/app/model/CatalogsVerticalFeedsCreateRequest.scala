...
object CatalogsVerticalFeedsCreateRequest {
  implicit lazy val catalogsVerticalFeedsCreateRequestJsonFormat: Format[CatalogsVerticalFeedsCreateRequest] = {
    ...
    val declaredPropNames = Set("defaultCurrency", "name", "format", "defaultLocale", "credentials", "location", "preferredProcessingSchedule", "catalogType", "defaultCountry", "defaultAvailability", "catalogId")
