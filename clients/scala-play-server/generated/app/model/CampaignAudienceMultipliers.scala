...
object CampaignAudienceMultipliers {
  implicit lazy val campaignAudienceMultipliersJsonFormat: Format[CampaignAudienceMultipliers] = {
    val realJsonFormat = Json.format[CampaignAudienceMultipliers]
    ...
    Format(
      ...
      Writes { campaignAudienceMultipliers =>
        val jsObj = realJsonFormat.writes(campaignAudienceMultipliers)
