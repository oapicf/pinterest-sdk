...
/**
  * Represents the Swagger definition for AdGroupResponse_allOf.
...
case class AdGroupResponseAllOf(
  ...
  budgetType: Option[AdGroupResponseAllOf.BudgetType.Value],
  ...
  conversionLearningModeType: Option[AdGroupResponseAllOf.ConversionLearningModeType.Value],
...
object AdGroupResponseAllOf {
  implicit lazy val adGroupResponseAllOfJsonFormat: Format[AdGroupResponseAllOf] = {
    val realJsonFormat = Json.format[AdGroupResponseAllOf]
    val declaredPropNames = Set("name", "status", "budgetInMicroCurrency", "bidInMicroCurrency", "budgetType", "startTime", "endTime", "targetingSpec", "lifetimeFrequencyCap", "trackingUrls", "autoTargetingEnabled", "placementGroup", "pacingDeliveryType", "conversionLearningModeType", "summaryStatus", "feedProfileId")
    ...
    Format(
      ...
      Writes { adGroupResponseAllOf =>
        val jsObj = realJsonFormat.writes(adGroupResponseAllOf)
