...
/**
  * Represents the Swagger definition for PromotionUpdateRequest.
...
case class PromotionUpdateRequest(
  discountStatus: Option[PromotionUpdateRequest.DiscountStatus.Value],
  endTime: Option[Int],
...
object PromotionUpdateRequest {
  implicit lazy val promotionUpdateRequestJsonFormat: Format[PromotionUpdateRequest] = {
    val realJsonFormat = Json.format[PromotionUpdateRequest]
    val declaredPropNames = Set("discountStatus", "endTime", "externalId", "platformType", "promotionCode", "promotionCustomId", "promotionTitle", "promotionType", "startTime", "templateValues", "id", "status")
    ...
    Format(
      ...
      Writes { promotionUpdateRequest =>
        val jsObj = realJsonFormat.writes(promotionUpdateRequest)
