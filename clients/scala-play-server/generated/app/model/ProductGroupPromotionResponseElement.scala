...
/**
  * Represents the Swagger definition for ProductGroupPromotionResponseElement.
...
object ProductGroupPromotionResponseElement {
  implicit lazy val productGroupPromotionResponseElementJsonFormat: Format[ProductGroupPromotionResponseElement] = {
    val realJsonFormat = Json.format[ProductGroupPromotionResponseElement]
    ...
    Format(
      ...
      Writes { productGroupPromotionResponseElement =>
        val jsObj = realJsonFormat.writes(productGroupPromotionResponseElement)
