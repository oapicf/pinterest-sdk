...
/**
  * Represents the Swagger definition for AdGroupUpdateBatchUpdate.
...
object AdGroupUpdateBatchUpdate {
  implicit lazy val adGroupUpdateBatchUpdateJsonFormat: Format[AdGroupUpdateBatchUpdate] = Json.format[AdGroupUpdateBatchUpdate]
}
