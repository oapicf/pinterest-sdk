...
object BusinessToBusinessSharedAudienceUpdateWithRequiredBody {
  implicit lazy val businessToBusinessSharedAudienceUpdateWithRequiredBodyJsonFormat: Format[BusinessToBusinessSharedAudienceUpdateWithRequiredBody] = Json.format[BusinessToBusinessSharedAudienceUpdateWithRequiredBody]
}
