...
object ScheduleBidOptionsPlacementMultipliers {
  implicit lazy val scheduleBidOptionsPlacementMultipliersJsonFormat: Format[ScheduleBidOptionsPlacementMultipliers] = Json.format[ScheduleBidOptionsPlacementMultipliers]
}
