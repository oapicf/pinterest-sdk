...
object FrequencyMultipliers {
  implicit lazy val frequencyMultipliersJsonFormat: Format[FrequencyMultipliers] = {
    val realJsonFormat = Json.format[FrequencyMultipliers]
    val declaredPropNames = Set("IMPRESSION_COUNT")
    ...
    Format(
      ...
      Writes { frequencyMultipliers =>
        val jsObj = realJsonFormat.writes(frequencyMultipliers)
