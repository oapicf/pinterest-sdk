...
/**
  * Represents the Swagger definition for KeywordUpdateItem.
...
object KeywordUpdateItem {
  implicit lazy val keywordUpdateItemJsonFormat: Format[KeywordUpdateItem] = Json.format[KeywordUpdateItem]
}
