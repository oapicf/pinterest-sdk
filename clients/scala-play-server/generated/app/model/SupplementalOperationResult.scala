...
case class SupplementalOperationResult(
  ...
  storeCode: String,
  supplementalType: SupplementalOperationResult.SupplementalType.Value,
  warnings: Option[List[SupplementalItemValidationEvent]]
)

object SupplementalOperationResult {
  implicit lazy val supplementalOperationResultJsonFormat: Format[SupplementalOperationResult] = Json.format[SupplementalOperationResult]
