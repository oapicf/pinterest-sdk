...
object CampaignCreateCommon {
  implicit lazy val campaignCreateCommonJsonFormat: Format[CampaignCreateCommon] = {
    ...
    val declaredPropNames = Set("adAccountId", "dailySpendCap", "endTime", "isAutomatedCampaign", "isFlexibleDailyBudgets", "lifetimeSpendCap", "name", "orderLineId", "startTime", "status", "trackingUrls", "defaultAdGroupBudgetInMicroCurrency", "isCampaignBudgetOptimization")
