...
object ConversionEventsDataItemsCustomData {
  implicit lazy val conversionEventsDataItemsCustomDataJsonFormat: Format[ConversionEventsDataItemsCustomData] = Json.format[ConversionEventsDataItemsCustomData]
}
