...
object CampaignCreateRequest {
  implicit lazy val campaignCreateRequestJsonFormat: Format[CampaignCreateRequest] = {
    ...
    val declaredPropNames = Set("adAccountId", "dailySpendCap", "endTime", "isAutomatedCampaign", "isFlexibleDailyBudgets", "lifetimeSpendCap", "name", "orderLineId", "startTime", "status", "trackingUrls", "defaultAdGroupBudgetInMicroCurrency", "isCampaignBudgetOptimization", "bidOptions", "isPerformancePlus", "objectiveType")
