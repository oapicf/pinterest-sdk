...
case class BrandAccountProfileImageUpdate(
  contentType: Option[BrandAccountProfileImageUpdate.ContentType.Value],
  data: Option[String]
)

object BrandAccountProfileImageUpdate {
  implicit lazy val brandAccountProfileImageUpdateJsonFormat: Format[BrandAccountProfileImageUpdate] = Json.format[BrandAccountProfileImageUpdate]
