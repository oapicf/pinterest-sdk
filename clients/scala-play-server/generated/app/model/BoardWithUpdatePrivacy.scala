...
/**
  * Represents the Swagger definition for BoardWithUpdatePrivacy.
...
object BoardWithUpdatePrivacy {
  implicit lazy val boardWithUpdatePrivacyJsonFormat: Format[BoardWithUpdatePrivacy] = {
    val realJsonFormat = Json.format[BoardWithUpdatePrivacy]
    ...
    Format(
      ...
      Writes { boardWithUpdatePrivacy =>
        val jsObj = realJsonFormat.writes(boardWithUpdatePrivacy)
