...
/**
  * Represents the Swagger definition for PromotionCreateRequest.
...
case class PromotionCreateRequest(
  discountStatus: Option[PromotionCreateRequest.DiscountStatus.Value],
  endTime: Option[Int],
...
object PromotionCreateRequest {
  implicit lazy val promotionCreateRequestJsonFormat: Format[PromotionCreateRequest] = {
    val realJsonFormat = Json.format[PromotionCreateRequest]
    val declaredPropNames = Set("discountStatus", "endTime", "externalId", "platformType", "promotionCode", "promotionCustomId", "promotionTitle", "promotionType", "startTime", "templateValues")
    ...
    Format(
      ...
      Writes { promotionCreateRequest =>
        val jsObj = realJsonFormat.writes(promotionCreateRequest)
