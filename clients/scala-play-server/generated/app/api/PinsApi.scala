...
trait PinsApi {
  ...
  /**
    ...
    */
  def pinsList(pinFilter: Option[String], pinMetrics: Option[Boolean], includeProtectedPins: Option[Boolean], pinType: Option[String], creativeTypes: Option[List[CreativeType]], adAccountId: Option[String], bookmark: Option[String], pageSize: Option[Int]): PinsList200Response
