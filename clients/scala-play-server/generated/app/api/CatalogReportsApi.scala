...
trait CatalogReportsApi {
  ...
  /**
    ...
    */
  def reportsStats(parameters: ReportsStatsParametersParameter, adAccountId: Option[String], pageSize: Option[Int], bookmark: Option[String]): ReportsStats200Response
}
