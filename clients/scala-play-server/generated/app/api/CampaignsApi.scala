...
trait CampaignsApi {
  /**
    ...
    */
  def adPinsAnalytics(adAccountId: String, campaignId: String, pinIds: List[String], startDate: LocalDate, endDate: LocalDate, columns: List[String], granularity: Granularity, clickWindowDays: Option[Int], engagementWindowDays: Option[Int], viewWindowDays: Option[Int], conversionReportTime: Option[String]): List[AdPinAnalytics]
