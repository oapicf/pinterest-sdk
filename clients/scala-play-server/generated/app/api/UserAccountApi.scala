...
trait UserAccountApi {
  /**
    ...
    */
  def boardsUserFollowsList(adAccountId: Option[String], explicitFollowing: Option[Boolean], bookmark: Option[String], pageSize: Option[Int]): BoardsList200Response
  ...
  /**
    ...
    */
  def followUserUpdate(username: String, followUserCreate: FollowUserCreate): FollowUser
  ...
  /**
    ...
    */
  def unverifyWebsiteDelete(website: String): UserWebsite
  ...
  /**
    ...
    * @param adAccountId Unique identifier of an ad account.
    */
  def userAccountAnalytics(startDate: LocalDate, endDate: LocalDate, fromClaimedContent: Option[String], pinFormat: Option[String], appTypes: Option[String], contentType: Option[String], source: Option[String], metricTypes: Option[List[QuerymetrictypesItems]], splitField: Option[String], adAccountId: Option[String]): Map[String, AnalyticsMetricsResponse]
  ...
  /**
    ...
    * @param adAccountId Unique identifier of an ad account.
    */
  def userAccountAnalyticsTopVideoPins(startDate: LocalDate, endDate: LocalDate, sortBy: TopVideoPinsSortBy, fromClaimedContent: Option[String], pinFormat: Option[String], appTypes: Option[String], contentType: Option[String], source: Option[String], metricTypes: Option[List[QueryvideopinmetrictypesItems]], numOfPins: Option[Int], createdInLastNDays: Option[BigDecimal], adAccountId: Option[String]): TopVideoPinsAnalyticsResponse
  ...
  /**
    ...
    * @param pageSize Maximum number of items to include in a single page. See documentation on [Pagination](/docs/reference/pagination/) for more information.
    */
  def userFollowingGet(adAccountId: Option[String], explicitFollowing: Option[Boolean], feedType: Option[UserFollowingFeedType], bookmark: Option[String], pageSize: Option[Int]): FollowersList200Response
  ...
  /**
    ...
    * @param adAccountId Unique identifier of an ad account.
    */
  def verifyWebsiteUpdate(userWebsiteCreate: UserWebsiteCreate, adAccountId: Option[String]): UserWebsite
  ...
  /**
    ...
    * @param adAccountId Unique identifier of an ad account.
    */
  def websiteVerificationGet(adAccountId: Option[String]): UserWebsiteVerification
}
