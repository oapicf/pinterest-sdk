...
trait KeywordsApi {
  /**
    ...
    */
  def countryKeywordsMetricsGet(adAccountId: String, countryCode: String, keywords: List[String]): KeywordsMetricsArrayResponse
  ...
  /**
    ...
    * @param adAccountId Unique identifier of an ad account.
    */
  def keywordsCreate(adAccountId: String, keywordsRequest: KeywordsRequest): KeywordsResponse
  ...
  /**
    ...
    * @param adAccountId Unique identifier of an ad account.
    */
  def keywordsUpdate(adAccountId: String, keywordUpdateBody: KeywordUpdateBody): KeywordsResponse
