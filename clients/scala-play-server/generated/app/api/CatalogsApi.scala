...
trait CatalogsApi {
  /**
    ...
    */
  def catalogsCreate(catalogsCreateRequest: CatalogsCreateRequest, adAccountId: Option[String]): Catalog
  ...
  /**
    ...
    * @param adAccountId Unique identifier of an ad account.
    */
  def itemsPost(catalogsItemsRequest: CatalogsItemsRequest, adAccountId: Option[String]): CatalogsItems
  ...
  /**
    ...
    * @param bookmark Cursor used to fetch the next page of items
    */
  def reportsStats(parameters: CatalogsReportParameters, adAccountId: Option[String], pageSize: Option[Int], bookmark: Option[String]): ReportsStats200Response
}
