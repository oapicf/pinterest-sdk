...
trait AdAccountsApi {
  ...
  /**
    ...
    * @param reportingTimezone Specify the timezone to be applied for the reporting. This feature is currently in BETA and is not available to all users.
    */
  def adAccountTargetingAnalyticsGet(adAccountId: String, startDate: LocalDate, endDate: LocalDate, targetingTypes: List[AdsAnalyticsAccountTargetingType], columns: List[ReportingColumnSync], granularity: Granularity, clickWindowDays: Option[BigDecimal], engagementWindowDays: Option[BigDecimal], viewWindowDays: Option[BigDecimal], conversionReportTime: Option[String], attributionTypes: Option[List[ConversionReportAttributionType]], reportingTimezone: Option[ReportingTimeZone]): MetricsResponse
  ...
  /**
    ...
    * @param adAccountId Unique identifier of an ad account.
    */
  def analyticsCreateConversionProductReport(adAccountId: String, conversionProductReportCreate: ConversionProductReportCreate): ConversionProductReport
  ...
  /**
    ...
    */
  def analyticsCreateMmmReport(adAccountId: String, mMMReportCreate: MMMReportCreate): MMMReport
  ...
  /**
    ...
    */
  def analyticsGetConversionProductReport(adAccountId: String, token: String): ConversionProductReport
  ...
  /**
    ...
    * @param token Token returned from the post request creation call
    */
  def analyticsGetMmmReport(adAccountId: String, token: String): MMMReport
  ...
  /**
    ...
    */
  def templatesList(adAccountId: String, bookmark: Option[String], pageSize: Option[Int], order: Option[PaginationOrder]): TemplatesList200Response
}
