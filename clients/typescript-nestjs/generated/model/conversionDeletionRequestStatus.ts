...
export const ConversionDeletionRequestStatus = {
    Pending: 'PENDING' as ConversionDeletionRequestStatus,
    Submitted: 'SUBMITTED' as ConversionDeletionRequestStatus,
    Cancelled: 'CANCELLED' as ConversionDeletionRequestStatus
};
