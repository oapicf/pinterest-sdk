...
export class CatalogItemsService {
    ...
    public itemsBatchGet(batchId: string, adAccountId?: string, itemsBatchGetOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.get<CatalogsItemsBatch>(`${this.basePath}/catalogs/items/batch/${encodeURIComponent(String(batchId))}`,
                    {
     ...
     */
    public itemsPost(catalogsItemsRequest: CatalogsItemsRequest, adAccountId?: string, itemsPostOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<ItemsPost200Response>>;
    public itemsPost(catalogsItemsRequest: CatalogsItemsRequest, adAccountId?: string, itemsPostOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.post<ItemsPost200Response>(`${this.basePath}/catalogs/items`,
