...
export class ConversionTagsService {
    ...
    public conversionTagsCreate(adAccountId: string, conversionTagCreate: ConversionTagCreate, conversionTagsCreateOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.post<ConversionTag>(`${this.basePath}/ad_accounts/${encodeURIComponent(String(adAccountId))}/conversion_tags`,
                    conversionTagCreate,
                    {
    ...
    public conversionTagsGet(adAccountId: string, conversionTagId: string, conversionTagsGetOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.get<ConversionTag>(`${this.basePath}/ad_accounts/${encodeURIComponent(String(adAccountId))}/conversion_tags/${encodeURIComponent(String(conversionTagId))}`,
                    {
                        withCredentials: this.configuration.withCredentials,
    ...
    public conversionTagsList(adAccountId: string, filterDeleted?: boolean, conversionTagsListOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.get<ConversionTagsList200Response>(`${this.basePath}/ad_accounts/${encodeURIComponent(String(adAccountId))}/conversion_tags`,
                    {
    ...
    public ocpmEligibleConversionTagsGet(adAccountId: string, ocpmEligibleConversionTagsGetOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.get<{ [key: string]: Array<ConversionEventResponse>; }>(`${this.basePath}/ad_accounts/${encodeURIComponent(String(adAccountId))}/conversion_tags/ocpm_eligible`,
                    {
                        withCredentials: this.configuration.withCredentials,
     ...
     */
    public pageVisitConversionTagsGet(adAccountId: string, bookmark?: string, pageSize?: number, order?: PinterestLibPaginationOrder, pageVisitConversionTagsGetOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<PageVisitConversionTagsGet200Response>>;
    public pageVisitConversionTagsGet(adAccountId: string, bookmark?: string, pageSize?: number, order?: PinterestLibPaginationOrder, pageVisitConversionTagsGetOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        if (adAccountId === null || adAccountId === undefined) {
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.get<PageVisitConversionTagsGet200Response>(`${this.basePath}/ad_accounts/${encodeURIComponent(String(adAccountId))}/conversion_tags/page_visit`,
                    {
                        params: queryParameters,
                        withCredentials: this.configuration.withCredentials,
