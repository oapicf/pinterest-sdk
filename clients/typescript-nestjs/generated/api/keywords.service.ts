...
export class KeywordsService {
     ...
     */
    public keywordsGet(adAccountId: string, campaignId?: string, adGroupId?: string, adGroupIds?: Array<string>, matchTypes?: Array<MatchType>, pageSize?: number, bookmark?: string, keywordsGetOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<KeywordsGet200Response>>;
    public keywordsGet(adAccountId: string, campaignId?: string, adGroupId?: string, adGroupIds?: Array<string>, matchTypes?: Array<MatchType>, pageSize?: number, bookmark?: string, keywordsGetOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        if (adAccountId === null || adAccountId === undefined) {
    ...
    public trendingKeywordsList(region: TrendsSupportedRegion, trendType: TrendType, interests?: Array<'animals' | 'architecture' | 'art' | 'beauty' | 'childrens_fashion' | 'design' | 'diy_and_crafts' | 'education' | 'electronics' | 'entertainment' | 'event_planning' | 'finance' | 'food_and_drinks' | 'gardening' | 'health' | 'home_decor' | 'mens_fashion' | 'parenting' | 'quotes' | 'sport' | 'travel' | 'vehicles' | 'wedding' | 'womens_fashion'>, genders?: Array<'female' | 'male' | 'unknown'>, ages?: Array<'18-24' | '25-34' | '35-44' | '45-49' | '50-54' | '55-64' | '65+'>, includeKeywords?: Array<string>, normalizeAgainstGroup?: boolean, limit?: number, includePrediction?: boolean, includeDemographics?: boolean, trendingKeywordsListOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        ...
        if (includePrediction !== undefined && includePrediction !== null) {
            queryParameters.append('include_prediction', <any>includePrediction);
        }
