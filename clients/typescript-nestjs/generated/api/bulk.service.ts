...
export class BulkService {
     ...
     */
    public bulkDownloadCreate(adAccountId: string, bulkDownloadCreate: BulkDownloadCreate, bulkDownloadCreateOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<BulkDownload>>;
    public bulkDownloadCreate(adAccountId: string, bulkDownloadCreate: BulkDownloadCreate, bulkDownloadCreateOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.post<BulkDownload>(`${this.basePath}/ad_accounts/${encodeURIComponent(String(adAccountId))}/bulk/download`,
                    bulkDownloadCreate,
                    {
     ...
     */
    public bulkRequestGet(adAccountId: string, bulkRequestId: string, includeDetails?: boolean, bulkRequestGetOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<BulkJobData>>;
    public bulkRequestGet(adAccountId: string, bulkRequestId: string, includeDetails?: boolean, bulkRequestGetOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.get<BulkJobData>(`${this.basePath}/ad_accounts/${encodeURIComponent(String(adAccountId))}/bulk/${encodeURIComponent(String(bulkRequestId))}`,
                    {
    ...
    public bulkUpsertCreate(adAccountId: string, bulkUpsertRequest: BulkUpsertRequest, bulkUpsertCreateOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.post<BulkUpsertResponse>(`${this.basePath}/ad_accounts/${encodeURIComponent(String(adAccountId))}/bulk/upsert`,
                    bulkUpsertRequest,
                    {
                        withCredentials: this.configuration.withCredentials,
