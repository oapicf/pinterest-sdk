...
export class ProductGroupPromotionsService {
     ...
     */
    public productGroupPromotionsCreate(adAccountId: string, productGroupPromotionCreateRequest: ProductGroupPromotionCreateRequest, productGroupPromotionsCreateOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<ProductGroupPromotionResponse>>;
    public productGroupPromotionsCreate(adAccountId: string, productGroupPromotionCreateRequest: ProductGroupPromotionCreateRequest, productGroupPromotionsCreateOpts?: { config?: AxiosRequestConfig }): Observable<any> {
    ...
    public productGroupPromotionsGet(adAccountId: string, productGroupPromotionId: string, productGroupPromotionsGetOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.get<ProductGroupPromotion>(`${this.basePath}/ad_accounts/${encodeURIComponent(String(ad_account_id))}/product_group_promotions/${encodeURIComponent(String(product_group_promotion_id))}`,
                    {
                        withCredentials: this.configuration.withCredentials,
     ...
     */
    public productGroupPromotionsUpdate(adAccountId: string, productGroupPromotionUpdateRequest: ProductGroupPromotionUpdateRequest, productGroupPromotionsUpdateOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<ProductGroupPromotionResponse>>;
    public productGroupPromotionsUpdate(adAccountId: string, productGroupPromotionUpdateRequest: ProductGroupPromotionUpdateRequest, productGroupPromotionsUpdateOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        if (adAccountId === null || adAccountId === undefined) {
