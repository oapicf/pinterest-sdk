...
export class BusinessAccessInviteService {
    ...
    public assetAccessRequestsCreate(businessId: string, createAssetAccessRequestBody: CreateAssetAccessRequestBody, assetAccessRequestsCreateOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.post<CreateAssetAccessRequestResponse>(`${this.basePath}/businesses/${encodeURIComponent(String(businessId))}/requests/assets/access`,
     ...
     */
    public cancelInvitesOrRequests(businessId: string, cancelInvitesRequest: CancelInvitesRequest, cancelInvitesOrRequestsOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<CancelInvitesResponse>>;
    public cancelInvitesOrRequests(businessId: string, cancelInvitesRequest: CancelInvitesRequest, cancelInvitesOrRequestsOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        if (businessId === null || businessId === undefined) {
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.delete<CancelInvitesResponse>(`${this.basePath}/businesses/${encodeURIComponent(String(businessId))}/invites`,
                    {
                        withCredentials: this.configuration.withCredentials,
    ...
    public createAssetInvites(businessId: string, createAssetInvitesRequest: CreateAssetInvitesRequest, createAssetInvitesOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.post<UpdateInvitesResultsResponseArray>(`${this.basePath}/businesses/${encodeURIComponent(String(businessId))}/invites/assets/access`,
    ...
    public createMembershipOrPartnershipInvites(businessId: string, createMembershipOrPartnershipInvitesBody: CreateMembershipOrPartnershipInvitesBody, createMembershipOrPartnershipInvitesOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.post<CreateInvitesResultsResponseArray>(`${this.basePath}/businesses/${encodeURIComponent(String(businessId))}/invites`,
     ...
     */
    public getInvites(businessId: string, isMember?: boolean, inviteStatus?: Array<InviteFilterStatus>, inviteType?: InviteType, bookmark?: string, pageSize?: number, getInvitesOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<GetInvites200Response>>;
    public getInvites(businessId: string, isMember?: boolean, inviteStatus?: Array<InviteFilterStatus>, inviteType?: InviteType, bookmark?: string, pageSize?: number, getInvitesOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        if (businessId === null || businessId === undefined) {
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.get<GetInvites200Response>(`${this.basePath}/businesses/${encodeURIComponent(String(businessId))}/invites`,
                    {
