...
export class BusinessAccessAssetsService {
     ...
     */
    public businessAssetMembersGet(businessId: string, assetId: string, fetchSystemUsers?: boolean, bookmark?: string, pageSize?: number, startIndex?: number, businessAssetMembersGetOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<BusinessAssetMembersGet200Response>>;
    public businessAssetMembersGet(businessId: string, assetId: string, fetchSystemUsers?: boolean, bookmark?: string, pageSize?: number, startIndex?: number, businessAssetMembersGetOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        if (businessId === null || businessId === undefined) {
     ...
     */
    public businessMemberAssetsGet(businessId: string, memberId: string, assetType?: 'AD_ACCOUNT' | 'PROFILE' | 'ASSET_GROUP' | 'CATALOG' | 'CONSUMER', startIndex?: number, bookmark?: string, pageSize?: number, businessMemberAssetsGetOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<BusinessMemberAssetsGet200Response>>;
    public businessMemberAssetsGet(businessId: string, memberId: string, assetType?: 'AD_ACCOUNT' | 'PROFILE' | 'ASSET_GROUP' | 'CATALOG' | 'CONSUMER', startIndex?: number, bookmark?: string, pageSize?: number, businessMemberAssetsGetOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        if (businessId === null || businessId === undefined) {
     ...
     */
    public businessPartnerAssetAccessGet(businessId: string, partnerId: string, partnerType?: PartnerType, assetType?: 'AD_ACCOUNT' | 'PROFILE' | 'ASSET_GROUP' | 'CATALOG' | 'CONSUMER', startIndex?: number, pageSize?: number, bookmark?: string, businessPartnerAssetAccessGetOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<BusinessPartnerAssetAccessGet200Response>>;
    public businessPartnerAssetAccessGet(businessId: string, partnerId: string, partnerType?: PartnerType, assetType?: 'AD_ACCOUNT' | 'PROFILE' | 'ASSET_GROUP' | 'CATALOG' | 'CONSUMER', startIndex?: number, pageSize?: number, bookmark?: string, businessPartnerAssetAccessGetOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        if (businessId === null || businessId === undefined) {
