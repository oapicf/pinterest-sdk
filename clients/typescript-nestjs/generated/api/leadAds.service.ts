...
export class LeadAdsService {
     ...
     */
    public adAccountsSubscriptionsDelById(adAccountId: string, subscriptionId: string, adAccountsSubscriptionsDelByIdOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<LeadSubscription>>;
    public adAccountsSubscriptionsDelById(adAccountId: string, subscriptionId: string, adAccountsSubscriptionsDelByIdOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.delete<LeadSubscription>(`${this.basePath}/ad_accounts/${encodeURIComponent(String(adAccountId))}/leads/subscriptions/${encodeURIComponent(String(subscriptionId))}`,
                    {
    ...
    public adAccountsSubscriptionsGetById(adAccountId: string, subscriptionId: string, adAccountsSubscriptionsGetByIdOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.get<LeadSubscription>(`${this.basePath}/ad_accounts/${encodeURIComponent(String(adAccountId))}/leads/subscriptions/${encodeURIComponent(String(subscriptionId))}`,
                    {
                        withCredentials: this.configuration.withCredentials,
    ...
    public adAccountsSubscriptionsGetList(adAccountId: string, bookmark?: string, pageSize?: number, adAccountsSubscriptionsGetListOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.get<AdAccountsSubscriptionsGetList200Response>(`${this.basePath}/ad_accounts/${encodeURIComponent(String(adAccountId))}/leads/subscriptions`,
                    {
    ...
    public adAccountsSubscriptionsPost(adAccountId: string, leadSubscriptionPostParamsCreate: LeadSubscriptionPostParamsCreate, adAccountsSubscriptionsPostOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.post<LeadSubscription>(`${this.basePath}/ad_accounts/${encodeURIComponent(String(adAccountId))}/leads/subscriptions`,
