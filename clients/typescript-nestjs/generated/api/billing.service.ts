    ...
    public billingInvoiceDownloadGet(adAccountId: string, billingInvoiceId: string, billingInvoiceDownloadGetOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.get<BillingInvoiceDownloadResponse>(`${this.basePath}/ad_accounts/${encodeURIComponent(String(ad_account_id))}/billing_invoice/${encodeURIComponent(String(billing_invoice_id))}/download`,
                    {
                        withCredentials: this.configuration.withCredentials,
    ...
    public billingInvoicesGet(adAccountId: string, bookmark?: string, pageSize?: number, sort?: 'DUE_DATE' | 'BILLING_PERIOD' | 'DOCUMENT_TYPE' | 'TOTAL_AMOUNT' | 'INVOICE_NUMBER', order?: 'ASCENDING' | 'DESCENDING', status?: 'OPEN' | 'CLOSED', documentType?: 'INVOICE' | 'CREDIT_MEMO', startDueDate?: string, endDueDate?: string, billingInvoicesGetOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.get<BillingInvoicesGet200Response>(`${this.basePath}/ad_accounts/${encodeURIComponent(String(ad_account_id))}/billing_invoices`,
                    {
                        params: queryParameters,
                        withCredentials: this.configuration.withCredentials,
