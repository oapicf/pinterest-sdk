...
export class BoardsService {
     ...
     */
    public boardSectionsCreate(boardId: string, boardSectionCreate: BoardSectionCreate, adAccountId?: string, boardSectionsCreateOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<BoardSection>>;
    public boardSectionsCreate(boardId: string, boardSectionCreate: BoardSectionCreate, adAccountId?: string, boardSectionsCreateOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.post<BoardSection>(`${this.basePath}/boards/${encodeURIComponent(String(boardId))}/sections`,
                    boardSectionCreate,
                    {
     ...
     */
    public boardSectionsDelete(boardId: string, sectionId: string, adAccountId?: string, boardSectionsDeleteOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<BoardSection>>;
    public boardSectionsDelete(boardId: string, sectionId: string, adAccountId?: string, boardSectionsDeleteOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.delete<BoardSection>(`${this.basePath}/boards/${encodeURIComponent(String(boardId))}/sections/${encodeURIComponent(String(sectionId))}`,
                    {
                        params: queryParameters,
                        withCredentials: this.configuration.withCredentials,
    ...
    public boardSectionsList(boardId: string, adAccountId?: string, bookmark?: string, pageSize?: number, boardSectionsListOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.get<BoardSectionsList200Response>(`${this.basePath}/boards/${encodeURIComponent(String(boardId))}/sections`,
                    {
                        params: queryParameters,
                        withCredentials: this.configuration.withCredentials,
    ...
    public boardSectionsListPins(boardId: string, sectionId: string, adAccountId?: string, bookmark?: string, pageSize?: number, boardSectionsListPinsOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.get<BoardsListPins200Response>(`${this.basePath}/boards/${encodeURIComponent(String(boardId))}/sections/${encodeURIComponent(String(sectionId))}/pins`,
                    {
                        params: queryParameters,
                        withCredentials: this.configuration.withCredentials,
     ...
     */
    public boardSectionsUpdate(boardId: string, sectionId: string, boardSectionUpdateWithRequiredBody: BoardSectionUpdateWithRequiredBody, adAccountId?: string, boardSectionsUpdateOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<BoardSection>>;
    public boardSectionsUpdate(boardId: string, sectionId: string, boardSectionUpdateWithRequiredBody: BoardSectionUpdateWithRequiredBody, adAccountId?: string, boardSectionsUpdateOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        if (boardId === null || boardId === undefined) {
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.patch<BoardSection>(`${this.basePath}/boards/${encodeURIComponent(String(boardId))}/sections/${encodeURIComponent(String(sectionId))}`,
     ...
     */
    public boardsDelete(boardId: string, adAccountId?: string, boardsDeleteOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<Board>>;
    public boardsDelete(boardId: string, adAccountId?: string, boardsDeleteOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.delete<Board>(`${this.basePath}/boards/${encodeURIComponent(String(boardId))}`,
                    {
                        params: queryParameters,
                        withCredentials: this.configuration.withCredentials,
    ...
    public boardsGet(boardId: string, adAccountId?: string, boardsGetOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.get<Board>(`${this.basePath}/boards/${encodeURIComponent(String(boardId))}`,
                    {
                        params: queryParameters,
                        withCredentials: this.configuration.withCredentials,
     ...
     */
    public boardsListPins(boardId: string, creativeTypes?: Array<CreativeType>, adAccountId?: string, pinMetrics?: boolean, bookmark?: string, pageSize?: number, boardsListPinsOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<BoardsListPins200Response>>;
    public boardsListPins(boardId: string, creativeTypes?: Array<CreativeType>, adAccountId?: string, pinMetrics?: boolean, bookmark?: string, pageSize?: number, boardsListPinsOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        if (boardId === null || boardId === undefined) {
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.get<BoardsListPins200Response>(`${this.basePath}/boards/${encodeURIComponent(String(boardId))}/pins`,
                    {
                        params: queryParameters,
                        withCredentials: this.configuration.withCredentials,
    ...
    public boardsUpdate(boardId: string, boardWithUpdatePrivacyUpdate: BoardWithUpdatePrivacyUpdate, adAccountId?: string, boardsUpdateOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.patch<BoardWithUpdatePrivacy>(`${this.basePath}/boards/${encodeURIComponent(String(boardId))}`,
