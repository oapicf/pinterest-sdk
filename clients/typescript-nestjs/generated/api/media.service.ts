...
export class MediaService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public mediaList(bookmark?: string, pageSize?: number, ): Observable<AxiosResponse<Paginated & object>>;
    public mediaList(bookmark?: string, pageSize?: number, ): Observable<any> {
        ...
        return this.httpClient.get<Paginated & object>(`${this.basePath}/media`,
            {
