...
export class UserAccountService {
     ...
     */
    public boardsUserFollowsList(adAccountId?: string, explicitFollowing?: boolean, bookmark?: string, pageSize?: number, boardsUserFollowsListOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<BoardsList200Response>>;
    public boardsUserFollowsList(adAccountId?: string, explicitFollowing?: boolean, bookmark?: string, pageSize?: number, boardsUserFollowsListOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.get<BoardsList200Response>(`${this.basePath}/user_account/following/boards`,
                    {
     ...
     */
    public followUserUpdate(username: string, followUserCreate: FollowUserCreate, followUserUpdateOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<FollowUser>>;
    public followUserUpdate(username: string, followUserCreate: FollowUserCreate, followUserUpdateOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.post<FollowUser>(`${this.basePath}/user_account/following/${encodeURIComponent(String(username))}`,
                    followUserCreate,
                    {
                        withCredentials: this.configuration.withCredentials,
     ...
     */
    public unverifyWebsiteDelete(website: string, unverifyWebsiteDeleteOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<UserWebsite>>;
    public unverifyWebsiteDelete(website: string, unverifyWebsiteDeleteOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.delete<UserWebsite>(`${this.basePath}/user_account/websites`,
                    {
                        params: queryParameters,
                        withCredentials: this.configuration.withCredentials,
     ...
     */
    public userAccountAnalytics(startDate: string, endDate: string, fromClaimedContent?: 'OTHER' | 'CLAIMED' | 'BOTH', pinFormat?: 'ALL' | 'ORGANIC_IMAGE' | 'ORGANIC_PRODUCT' | 'ORGANIC_VIDEO' | 'ADS_STANDARD' | 'ADS_PRODUCT' | 'ADS_VIDEO' | 'ADS_IDEA', appTypes?: 'ALL' | 'MOBILE' | 'TABLET' | 'WEB', contentType?: 'ALL' | 'PAID' | 'ORGANIC', source?: 'ALL' | 'YOUR_PINS' | 'OTHER_PINS', metricTypes?: Array<QuerymetrictypesItems>, splitField?: 'NO_SPLIT' | 'APP_TYPE' | 'OWNED_CONTENT' | 'SOURCE' | 'PIN_FORMAT', adAccountId?: string, userAccountAnalyticsOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<{ [key: string]: AnalyticsMetricsResponse; }>>;
    public userAccountAnalytics(startDate: string, endDate: string, fromClaimedContent?: 'OTHER' | 'CLAIMED' | 'BOTH', pinFormat?: 'ALL' | 'ORGANIC_IMAGE' | 'ORGANIC_PRODUCT' | 'ORGANIC_VIDEO' | 'ADS_STANDARD' | 'ADS_PRODUCT' | 'ADS_VIDEO' | 'ADS_IDEA', appTypes?: 'ALL' | 'MOBILE' | 'TABLET' | 'WEB', contentType?: 'ALL' | 'PAID' | 'ORGANIC', source?: 'ALL' | 'YOUR_PINS' | 'OTHER_PINS', metricTypes?: Array<QuerymetrictypesItems>, splitField?: 'NO_SPLIT' | 'APP_TYPE' | 'OWNED_CONTENT' | 'SOURCE' | 'PIN_FORMAT', adAccountId?: string, userAccountAnalyticsOpts?: { config?: AxiosRequestConfig }): Observable<any> {
     ...
     */
    public userAccountAnalyticsTopPins(startDate: string, endDate: string, sortBy: TopPinsSortBy, fromClaimedContent?: 'OTHER' | 'CLAIMED' | 'BOTH', pinFormat?: 'ALL' | 'ORGANIC_IMAGE' | 'ORGANIC_PRODUCT' | 'ORGANIC_VIDEO' | 'ADS_STANDARD' | 'ADS_PRODUCT' | 'ADS_VIDEO' | 'ADS_IDEA', appTypes?: 'ALL' | 'MOBILE' | 'TABLET' | 'WEB', contentType?: 'ALL' | 'PAID' | 'ORGANIC', source?: 'ALL' | 'YOUR_PINS' | 'OTHER_PINS', metricTypes?: Array<QuerymetrictypesItems>, numOfPins?: number, createdInLastNDays?: 30, adAccountId?: string, userAccountAnalyticsTopPinsOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<TopPinsAnalyticsResponse>>;
    public userAccountAnalyticsTopPins(startDate: string, endDate: string, sortBy: TopPinsSortBy, fromClaimedContent?: 'OTHER' | 'CLAIMED' | 'BOTH', pinFormat?: 'ALL' | 'ORGANIC_IMAGE' | 'ORGANIC_PRODUCT' | 'ORGANIC_VIDEO' | 'ADS_STANDARD' | 'ADS_PRODUCT' | 'ADS_VIDEO' | 'ADS_IDEA', appTypes?: 'ALL' | 'MOBILE' | 'TABLET' | 'WEB', contentType?: 'ALL' | 'PAID' | 'ORGANIC', source?: 'ALL' | 'YOUR_PINS' | 'OTHER_PINS', metricTypes?: Array<QuerymetrictypesItems>, numOfPins?: number, createdInLastNDays?: 30, adAccountId?: string, userAccountAnalyticsTopPinsOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        if (startDate === null || startDate === undefined) {
     ...
     */
    public userFollowingGet(adAccountId?: string, explicitFollowing?: boolean, feedType?: UserFollowingFeedType, bookmark?: string, pageSize?: number, userFollowingGetOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<FollowersList200Response>>;
    public userFollowingGet(adAccountId?: string, explicitFollowing?: boolean, feedType?: UserFollowingFeedType, bookmark?: string, pageSize?: number, userFollowingGetOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        let queryParameters = new URLSearchParams();
        if (adAccountId !== undefined && adAccountId !== null) {
            queryParameters.append('ad_account_id', <any>adAccountId);
        }
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.get<FollowersList200Response>(`${this.basePath}/user_account/following`,
                    {
                        params: queryParameters,
                        withCredentials: this.configuration.withCredentials,
     ...
     */
    public verifyWebsiteUpdate(userWebsiteCreate: UserWebsiteCreate, adAccountId?: string, verifyWebsiteUpdateOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<UserWebsite>>;
    public verifyWebsiteUpdate(userWebsiteCreate: UserWebsiteCreate, adAccountId?: string, verifyWebsiteUpdateOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.post<UserWebsite>(`${this.basePath}/user_account/websites`,
                    userWebsiteCreate,
                    {
                        params: queryParameters,
                        withCredentials: this.configuration.withCredentials,
     ...
     */
    public websiteVerificationGet(adAccountId?: string, websiteVerificationGetOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<UserWebsiteVerification>>;
    public websiteVerificationGet(adAccountId?: string, websiteVerificationGetOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.get<UserWebsiteVerification>(`${this.basePath}/user_account/websites/verification`,
                    {
                        params: queryParameters,
                        withCredentials: this.configuration.withCredentials,
