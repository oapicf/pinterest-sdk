...
export class AdGroupsService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public adGroupsAudienceSizing(adAccountId: string, adGroupAudienceSizingRequest?: AdGroupAudienceSizingRequest, ): Observable<AxiosResponse<AdGroupAudienceSizingResponse>>;
    public adGroupsAudienceSizing(adAccountId: string, adGroupAudienceSizingRequest?: AdGroupAudienceSizingRequest, ): Observable<any> {
        if (adAccountId === null || adAccountId === undefined) {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public adGroupsBidFloorGet(adAccountId: string, bidFloorRequest: BidFloorRequest, ): Observable<AxiosResponse<BidFloor>>;
    public adGroupsBidFloorGet(adAccountId: string, bidFloorRequest: BidFloorRequest, ): Observable<any> {
        if (adAccountId === null || adAccountId === undefined) {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public adGroupsCreate(adAccountId: string, adGroupCreateRequest: Array<AdGroupCreateRequest>, ): Observable<AxiosResponse<AdGroupArrayResponse>>;
    public adGroupsCreate(adAccountId: string, adGroupCreateRequest: Array<AdGroupCreateRequest>, ): Observable<any> {
        if (adAccountId === null || adAccountId === undefined) {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public adGroupsGet(adAccountId: string, adGroupId: string, ): Observable<AxiosResponse<AdGroupResponse>>;
    public adGroupsGet(adAccountId: string, adGroupId: string, ): Observable<any> {
        if (adAccountId === null || adAccountId === undefined) {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public adGroupsList(adAccountId: string, campaignIds?: Array<string>, adGroupIds?: Array<string>, entityStatuses?: Array<'ACTIVE' | 'PAUSED' | 'ARCHIVED' | 'DRAFT' | 'DELETED_DRAFT'>, pageSize?: number, order?: 'ASCENDING' | 'DESCENDING', bookmark?: string, translateInterestsToNames?: boolean, ): Observable<AxiosResponse<AdGroupsList200Response>>;
    public adGroupsList(adAccountId: string, campaignIds?: Array<string>, adGroupIds?: Array<string>, entityStatuses?: Array<'ACTIVE' | 'PAUSED' | 'ARCHIVED' | 'DRAFT' | 'DELETED_DRAFT'>, pageSize?: number, order?: 'ASCENDING' | 'DESCENDING', bookmark?: string, translateInterestsToNames?: boolean, ): Observable<any> {
        if (adAccountId === null || adAccountId === undefined) {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public adGroupsUpdate(adAccountId: string, adGroupUpdateRequest: Array<AdGroupUpdateRequest>, ): Observable<AxiosResponse<AdGroupArrayResponse>>;
    public adGroupsUpdate(adAccountId: string, adGroupUpdateRequest: Array<AdGroupUpdateRequest>, ): Observable<any> {
        if (adAccountId === null || adAccountId === undefined) {
