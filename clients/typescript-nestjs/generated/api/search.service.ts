...
export class SearchService {
     ...
     */
    public searchUserPinsList(query: string, adAccountId?: string, bookmark?: string, searchUserPinsListOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<SearchUserPinsList200Response>>;
    public searchUserPinsList(query: string, adAccountId?: string, bookmark?: string, searchUserPinsListOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.get<SearchUserPinsList200Response>(`${this.basePath}/search/pins`,
                    {
                        params: queryParameters,
                        withCredentials: this.configuration.withCredentials,
