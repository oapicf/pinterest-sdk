...
export class AdsService {
     ...
     */
    public adsCreate(adAccountId: string, adCreateRequest: Array<AdCreateRequest>, adsCreateOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<AdArrayResponse>>;
    public adsCreate(adAccountId: string, adCreateRequest: Array<AdCreateRequest>, adsCreateOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        if (adAccountId === null || adAccountId === undefined) {
     ...
     */
    public adsGet(adAccountId: string, adId: string, adsGetOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<AdResponse>>;
    public adsGet(adAccountId: string, adId: string, adsGetOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        if (adAccountId === null || adAccountId === undefined) {
     ...
     */
    public adsList(adAccountId: string, campaignIds?: Array<string>, adGroupIds?: Array<string>, adIds?: Array<string>, entityStatuses?: Array<'ACTIVE' | 'PAUSED' | 'ARCHIVED' | 'DRAFT' | 'DELETED_DRAFT'>, pageSize?: number, order?: 'ASCENDING' | 'DESCENDING', bookmark?: string, adsListOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<AdsList200Response>>;
    public adsList(adAccountId: string, campaignIds?: Array<string>, adGroupIds?: Array<string>, adIds?: Array<string>, entityStatuses?: Array<'ACTIVE' | 'PAUSED' | 'ARCHIVED' | 'DRAFT' | 'DELETED_DRAFT'>, pageSize?: number, order?: 'ASCENDING' | 'DESCENDING', bookmark?: string, adsListOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        if (adAccountId === null || adAccountId === undefined) {
     ...
     */
    public adsUpdate(adAccountId: string, adUpdateRequest: Array<AdUpdateRequest>, adsUpdateOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<AdArrayResponse>>;
    public adsUpdate(adAccountId: string, adUpdateRequest: Array<AdUpdateRequest>, adsUpdateOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        if (adAccountId === null || adAccountId === undefined) {
