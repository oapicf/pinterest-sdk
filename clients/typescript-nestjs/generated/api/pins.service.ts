...
export class PinsService {
     ...
     */
    public pinsList(pinFilter?: 'exclude_native' | 'exclude_repins' | 'has_been_promoted', pinMetrics?: boolean, includeProtectedPins?: boolean, pinType?: 'PRIVATE', creativeTypes?: Array<CreativeType>, adAccountId?: string, bookmark?: string, pageSize?: number, pinsListOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<PinsList200Response>>;
    public pinsList(pinFilter?: 'exclude_native' | 'exclude_repins' | 'has_been_promoted', pinMetrics?: boolean, includeProtectedPins?: boolean, pinType?: 'PRIVATE', creativeTypes?: Array<CreativeType>, adAccountId?: string, bookmark?: string, pageSize?: number, pinsListOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        let queryParameters = new URLSearchParams();
