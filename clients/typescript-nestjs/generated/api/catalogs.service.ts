...
export class CatalogsService {
     ...
     */
    public catalogsCreate(catalogCreate: CatalogCreate, adAccountId?: string, catalogsCreateOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<Catalog>>;
    public catalogsCreate(catalogCreate: CatalogCreate, adAccountId?: string, catalogsCreateOpts?: { config?: AxiosRequestConfig }): Observable<any> {
     ...
     */
    public catalogsList(adAccountId?: string, bookmark?: string, pageSize?: number, catalogsListOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<CatalogsList200Response>>;
    public catalogsList(adAccountId?: string, bookmark?: string, pageSize?: number, catalogsListOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        let queryParameters = new URLSearchParams();
        if (adAccountId !== undefined && adAccountId !== null) {
            queryParameters.append('ad_account_id', <any>adAccountId);
        }
