...
pub trait Trends<E: std::fmt::Debug + Send + Sync + 'static = ()>: super::ErrorHandler<E> {
    /// Returns editorial articles for a given region.
    ///
    /// TrendsEditorialArticlesSlashList - GET /v5/trends/editorial_articles
    ...
    host: &Host,
    cookies: &CookieJar,
      query_params: &models::TrendsEditorialArticlesSlashListQueryParams,
    ) -> Result<TrendsEditorialArticlesSlashListResponse, E>;
