...
pub trait AudienceInsights<E: std::fmt::Debug + Send + Sync + 'static = ()>: super::ErrorHandler<E> {
    ...
    ) -> Result<AudienceInsightsScopeAndTypeSlashGetResponse, E>;
    ...
    ) -> Result<AudienceInsightsSlashGetResponse, E>;
}
