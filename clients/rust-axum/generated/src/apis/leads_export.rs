...
pub trait LeadsExport<E: std::fmt::Debug + Send + Sync + 'static = ()>: super::ErrorHandler<E> {
    ...
    cookies: &CookieJar,
      path_params: &models::LeadsExportSlashCreatePathParams,
            body: &models::LeadsExportsCreate,
    ) -> Result<LeadsExportSlashCreateResponse, E>;
    ...
    ) -> Result<LeadsExportSlashGetResponse, E>;
}
