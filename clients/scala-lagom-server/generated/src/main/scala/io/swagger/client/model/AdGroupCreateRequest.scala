...
case class AdGroupCreateRequest (
            ...
            /* Campaign ID of the ad group. */
                  ...
                  bidStrategyType:  Option[AdGroupCreateRequestBidStrategyTypeEnum.AdGroupCreateRequestBidStrategyTypeEnum],
...
implicit val format: Format[AdGroupCreateRequest] = Json.format
}

object AdGroupCreateRequestBidStrategyTypeEnum extends Enumeration {
  val   AUTOMATIC_BID, MAX_BID, TARGET_AVG,  = Value
  type AdGroupCreateRequestBidStrategyTypeEnum = Value
  implicit val format: Format[Value] = Format(Reads.enumNameReads(this), Writes.enumNameWrites[AdGroupCreateRequestBidStrategyTypeEnum.type])
}
