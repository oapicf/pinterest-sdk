...
case class CatalogsFeedValidationWarnings (
            ...
            /* Your feed contains duplicate headers. */
                  ...
                  FETCH_SAME_SIGNATURE:  Option[CatalogsFeedValidationWarningsFETCH_SAME_SIGNATUREEnum.CatalogsFeedValidationWarningsFETCH_SAME_SIGNATUREEnum],
...
implicit val format: Format[CatalogsFeedValidationWarnings] = Json.format
}

object CatalogsFeedValidationWarningsFETCH_SAME_SIGNATUREEnum extends Enumeration {
  val   1 = Value
  type CatalogsFeedValidationWarningsFETCH_SAME_SIGNATUREEnum = Value
  implicit val format: Format[Value] = Format(Reads.enumNameReads(this), Writes.enumNameWrites[CatalogsFeedValidationWarningsFETCH_SAME_SIGNATUREEnum.type])
}
