...
The class is defined in **[BusinessAssets.java](../../src/main/java/org/openapitools/model/BusinessAssets.java)**
...
**catalogInfo** | [`CatalogBinding`](CatalogBinding.md) | An object containing all the information specific to the provided catalog. This field will be populated only if asset_type equals &#39;CATALOG&#39;. |  [optional property]
