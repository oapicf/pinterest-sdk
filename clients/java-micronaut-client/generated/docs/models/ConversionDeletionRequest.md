...
The class is defined in **[ConversionDeletionRequest.java](../../src/main/java/org/openapitools/model/ConversionDeletionRequest.java)**

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**createdTime** | `LocalDate` | Timestamp when the conversion deletion request was succesfully created. |  [readonly property]
**processedTime** | `LocalDate` | Timestamp when the conversion deletion request was processed. |  [optional property] [readonly property]
