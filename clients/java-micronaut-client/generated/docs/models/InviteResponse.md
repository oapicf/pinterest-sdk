...
**createdByBusiness** | `Object` | Metadata for the business that created the invite/request. |  [optional property]
**createdByUser** | `Object` | Metadata for the user that created the invite/request. |  [optional property]
