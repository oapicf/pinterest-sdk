...
The class is defined in **[PromotionResponse.java](../../src/main/java/org/openapitools/model/PromotionResponse.java)**

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**discountStatus** | [**DiscountStatusEnum**](#DiscountStatusEnum) | Discount status based on the current time and start and end time of discount |  [optional property]
...
**adAccountId** | `String` | The Ad Account ID that this promotion belongs to. |  [optional property]
**id** | `String` | Promotion ID |  [optional property]
