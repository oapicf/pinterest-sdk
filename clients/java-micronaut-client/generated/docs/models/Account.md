...
**accountType** | `UserAccountType` | Type of account |  [optional property]
**boardCount** | `Integer` |   User account board count.   **Note**: Board count on user account level may differ from counts found elsewhere due to attribution of collaborative Boards. |  [optional property] [readonly property]
