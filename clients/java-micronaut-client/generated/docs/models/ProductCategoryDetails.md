...
The class is defined in **[ProductCategoryDetails.java](../../src/main/java/org/openapitools/model/ProductCategoryDetails.java)**

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**demographics** | [`ProductCategoriesDemographic`](ProductCategoriesDemographic.md) |  |  [optional property]
...
**metricsHighlights** | [`ProductCategoriesMetricsHighlights`](ProductCategoriesMetricsHighlights.md) |  |  [optional property]
...
**relatedSearches** | `List&lt;String&gt;` | Related search terms for this product category |  [optional property]
**timeSeries** | `Map&lt;String, BigDecimal&gt;` | Time series data showing trend values over time, indexed between 0 and 100 |  [optional property]
