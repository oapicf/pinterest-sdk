...
The class is defined in **[EventData.java](../../src/main/java/org/openapitools/model/EventData.java)**

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**currency** | `Currency` | Currency. For example, &#39;USD&#39;. |  [optional property]
