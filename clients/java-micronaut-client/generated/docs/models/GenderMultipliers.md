...
The class is defined in **[GenderMultipliers.java](../../src/main/java/org/openapitools/model/GenderMultipliers.java)**

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**GENDER** | `TargetingSpecGender` | Gender identifier. |  [optional property]
