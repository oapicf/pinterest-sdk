...
The class is defined in **[ReportingColumnAsync.java](../../src/main/java/org/openapitools/model/ReportingColumnAsync.java)**
...
* `IS_CATALOG_CREATIVE_CAMPAIGN` (value: `"IS_CATALOG_CREATIVE_CAMPAIGN"`)
