...
------------ | ------------- | ------------- | -------------
**ageDistribution** | `TrendingKeywordDemographicsAgeDistribution` |  |  [optional property]
**genderDistribution** | `TrendingKeywordDemographicsGenderDistribution` |  |  [optional property]
