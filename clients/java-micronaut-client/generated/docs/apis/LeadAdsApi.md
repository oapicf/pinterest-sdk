...
```java
Mono<LeadSubscription> LeadAdsApi.adAccountsSubscriptionsGetById(adAccountIdsubscriptionId)
```
...
```java
Mono<AdAccountsSubscriptionsGetList200Response> LeadAdsApi.adAccountsSubscriptionsGetList(adAccountIdbookmarkpageSize)
```
...
```java
Mono<LeadSubscription> LeadAdsApi.adAccountsSubscriptionsPost(adAccountIdleadSubscriptionPostParamsCreate)
```
