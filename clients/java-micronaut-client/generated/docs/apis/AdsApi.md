...
# **adsAnalytics**
```java
Mono<List<AdsAnalyticsResponseInner>> AdsApi.adsAnalytics(adAccountIdstartDateendDateadIdscolumnsgranularityclickWindowDaysengagementWindowDaysviewWindowDaysconversionReportTime)
```
