...
```java
Mono<CatalogsAvailableFilterValues> CatalogsApi.catalogsAvailableFilterValues(catalogIdfeedIdcountrylanguageadAccountId)
```
...
# **catalogsCreate**
```java
Mono<Catalog> CatalogsApi.catalogsCreate(catalogCreateadAccountId)
```
...
# **catalogsList**
```java
Mono<CatalogsList200Response> CatalogsApi.catalogsList(adAccountIdbookmarkpageSize)
```
