...
```java
Mono<FeedProcessingResultsList200Response> CatalogFeedsApi.feedProcessingResultsList(feedIdadAccountIdbookmarkpageSize)
```
...
# **feedsCreate**
```java
Mono<CatalogsFeed> CatalogFeedsApi.feedsCreate(catalogsFeedCreateRequestSchemaadAccountId)
```
...
# **feedsDelete**
```java
Mono<CatalogsFeed> CatalogFeedsApi.feedsDelete(feedIdadAccountId)
```
...
# **feedsList**
```java
Mono<FeedsList200Response> CatalogFeedsApi.feedsList(catalogIdadAccountIdbookmarkpageSize)
```
...
# **feedsUpdate**
```java
Mono<CatalogsFeed> CatalogFeedsApi.feedsUpdate(feedIdcatalogsFeedUpdateRequestSchemaadAccountId)
```
...
# **itemsIssuesList**
```java
Mono<ItemsIssuesList200Response> CatalogFeedsApi.itemsIssuesList(processingResultIditemNumbersitemValidationIssueadAccountIdbookmarkpageSize)
```
