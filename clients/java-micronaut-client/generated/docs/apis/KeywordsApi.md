...
| **matchTypes** | [**List&lt;MatchType&gt;**](MatchType.md)| Keyword &lt;a target&#x3D;\&quot;_blank\&quot; href&#x3D;\&quot;/docs/ads/targeting/#Match%20type%20and%20targeting%20level\&quot;&gt;match type&lt;/a&gt; | [optional parameter] |
...
```java
Mono<TrendingKeywordsResponse> KeywordsApi.trendingKeywordsList(regiontrendTypeinterestsgendersagesnormalizeAgainstGrouplimit)
```
