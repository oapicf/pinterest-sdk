...
```java
Mono<List<ProductGroupAnalyticsResponseInner>> ProductGroupPromotionsApi.productGroupsAnalytics(adAccountIdstartDateendDateproductGroupIdscolumnsgranularityclickWindowDaysengagementWindowDaysviewWindowDaysconversionReportTimereportingTimezone)
```
