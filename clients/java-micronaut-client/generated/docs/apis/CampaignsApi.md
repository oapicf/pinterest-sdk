...
# **adPinsAnalytics**
```java
Mono<List<AdPinAnalytics>> CampaignsApi.adPinsAnalytics(campaignIdpinIdsstartDateendDatecolumnsgranularityadAccountIdclickWindowDaysengagementWindowDaysviewWindowDaysconversionReportTime)
```
...
```java
Mono<MetricsResponse> CampaignsApi.campaignTargetingAnalyticsGet(adAccountIdcampaignIdsstartDateendDatetargetingTypescolumnsgranularityclickWindowDaysengagementWindowDaysviewWindowDaysconversionReportTimeattributionTypesreportingTimezone)
```
...
# **campaignsAnalytics**
```java
Mono<List<CampaignsAnalyticsMetrics>> CampaignsApi.campaignsAnalytics(startDateendDatecampaignIdscolumnsgranularityadAccountIdclickWindowDaysengagementWindowDaysviewWindowDaysconversionReportTimeaggregateReportRowsreportingTimezone)
```
...
# **campaignsCreate**
```java
Mono<CampaignBatchWriteResponseModel> CampaignsApi.campaignsCreate(adAccountIdcampaignCreateItem)
```
...
|------------- | ------------- | ------------- | -------------|
| **adAccountId** | `String`| Unique identifier of an ad account. | |
| **campaignCreateItem** | [**List&lt;@Valid CampaignCreateItem&gt;**](CampaignCreateItem.md)|  | |
...
# **campaignsGet**
```java
Mono<Campaign> CampaignsApi.campaignsGet(campaignIdadAccountId)
```
...
# **campaignsList**
```java
Mono<CampaignsList200Response> CampaignsApi.campaignsList(adAccountIdbookmarkpageSizeordercampaignIdsentityStatuses)
```
...
# **campaignsUpdate**
```java
Mono<CampaignBatchWriteResponseModel> CampaignsApi.campaignsUpdate(adAccountIdcampaignBatchUpdateItem)
```
...
|------------- | ------------- | ------------- | -------------|
| **adAccountId** | `String`| Unique identifier of an ad account. | |
| **campaignBatchUpdateItem** | [**List&lt;@Valid CampaignBatchUpdateItem&gt;**](CampaignBatchUpdateItem.md)|  | |
...
```java
Mono<CampaignDeliveryEstimatesResponse> CampaignsApi.getCampaignDeliveryEstimates(adAccountIdcampaignDeliveryEstimatesCampaign)
```
...
|------------- | ------------- | ------------- | -------------|
| **adAccountId** | `String`| Unique identifier of an ad account. | |
| **campaignDeliveryEstimatesCampaign** | [**List&lt;@Valid CampaignDeliveryEstimatesCampaign&gt;**](CampaignDeliveryEstimatesCampaign.md)|  | |
