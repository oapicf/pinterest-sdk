...
public interface ProductGroupPromotionsApi {
    ...
    Mono<ProductGroupPromotions> productGroupPromotionsCreate(
    ...
    @Consumes({"application/json"})
    Mono<ProductGroupPromotion> productGroupPromotionsGet(
        @PathVariable(name="ad_account_id") @NotNull @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId, 
    ...
    @Consumes({"application/json"})
    @Produces({"application/json"})
    Mono<ProductGroupPromotions> productGroupPromotionsUpdate(
        @PathVariable(name="ad_account_id") @NotNull @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId, 
    ...
    @Consumes({"application/json"})
    Mono<List<ProductGroupAnalyticsItems>> productGroupsAnalytics(
