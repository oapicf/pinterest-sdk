 ...
 */
@JsonPropertyOrder({
  TargetingSpecOperationAppType.JSON_PROPERTY_FIELD,
  TargetingSpecOperationAppType.JSON_PROPERTY_OPERATION,
  TargetingSpecOperationAppType.JSON_PROPERTY_VALUES
})
