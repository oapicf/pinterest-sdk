 ...
 */
@JsonPropertyOrder({
  TargetingSpecOperationGeoExclude.JSON_PROPERTY_FIELD,
  TargetingSpecOperationGeoExclude.JSON_PROPERTY_OPERATION,
  TargetingSpecOperationGeoExclude.JSON_PROPERTY_VALUES
})
