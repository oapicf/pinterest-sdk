...
public class CatalogsHotelFeedsCreateRequest {
    ...
    public CatalogsHotelFeedsCreateRequest(CatalogsType catalogType, CatalogsFeedsCreateRequestDefaultLocale defaultLocale, CatalogsFormat _format, String location, String name) {
