...
public class CatalogsCreativeAssetsFeed {
    ...
    public CatalogsCreativeAssetsFeed(String catalogId, CatalogTypeEnum catalogType, OffsetDateTime createdAt, Country defaultCountry, String defaultLocale, CatalogsFormat _format, String id, String location, String name, CatalogsStatus status, OffsetDateTime updatedAt) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(catalogId, catalogType, createdAt, credentials, defaultCountry, defaultCurrency, defaultLocale, _format, id, location, name, preferredProcessingSchedule, status, updatedAt);
    }
