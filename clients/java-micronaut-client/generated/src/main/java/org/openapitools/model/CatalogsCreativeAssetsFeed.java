...
public class CatalogsCreativeAssetsFeed {
    ...
    public CatalogsCreativeAssetsFeed(OffsetDateTime createdAt, String id, OffsetDateTime updatedAt, String catalogId, CatalogsType catalogType, CatalogsFeedCredentials credentials, Country defaultCountry, NullableCurrency defaultCurrency, String defaultLocale, CatalogsFormat _format, String location, String name, CatalogsFeedProcessingSchedule preferredProcessingSchedule, CatalogsStatus status) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(createdAt, id, updatedAt, catalogId, catalogType, credentials, defaultCountry, defaultCurrency, defaultLocale, _format, location, name, preferredProcessingSchedule, status);
    }
