...
public class CatalogsRetailFeedsCreateRequest {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(defaultCurrency, name, _format, defaultLocale, credentials, location, preferredProcessingSchedule, catalogType, defaultCountry, defaultAvailability);
    }
