...
public class CatalogsRetailFeed {
    ...
    public CatalogsRetailFeed(CatalogTypeEnum catalogType, OffsetDateTime createdAt, Country defaultCountry, String defaultLocale, CatalogsFormat _format, String id, String location, String name, CatalogsStatus status, OffsetDateTime updatedAt) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(catalogType, createdAt, credentials, defaultAvailability, defaultCountry, defaultCurrency, defaultLocale, _format, id, location, name, preferredProcessingSchedule, status, updatedAt);
    }
