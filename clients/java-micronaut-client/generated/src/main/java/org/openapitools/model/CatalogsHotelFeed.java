...
public class CatalogsHotelFeed {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(createdAt, id, updatedAt, catalogId, catalogType, credentials, defaultCurrency, defaultLocale, _format, location, name, preferredProcessingSchedule, status);
    }
