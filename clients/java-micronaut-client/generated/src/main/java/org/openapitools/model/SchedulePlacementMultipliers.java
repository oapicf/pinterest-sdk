 ...
 */
@JsonPropertyOrder({
  SchedulePlacementMultipliers.JSON_PROPERTY_BROWSE,
  SchedulePlacementMultipliers.JSON_PROPERTY_RELATED_PINS,
  SchedulePlacementMultipliers.JSON_PROPERTY_SEARCH
})
