...
public class ItemsBatchPostRequest {
    ...
    public ItemsBatchPostRequest(CatalogTypeEnum catalogType, Country country, List<@Valid ItemDeleteBatchRecord> items, LanguageEnum language, BatchOperation operation) {
