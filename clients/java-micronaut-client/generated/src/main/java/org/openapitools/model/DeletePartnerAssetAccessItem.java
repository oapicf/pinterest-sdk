 ...
 */
@JsonPropertyOrder({
  DeletePartnerAssetAccessItem.JSON_PROPERTY_ASSET_ID,
  DeletePartnerAssetAccessItem.JSON_PROPERTY_PARTNER_ID,
  DeletePartnerAssetAccessItem.JSON_PROPERTY_PARTNER_TYPE
})
