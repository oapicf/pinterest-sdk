...
public class AdGroupsApiTest {
    ...
    public void adGroupsAnalyticsTest() {
        ...
        // when
        List<AdGroupsAnalyticsResponseInner> body = api.adGroupsAnalytics(adAccountId, startDate, endDate, adGroupIds, columns, granularity, clickWindowDays, engagementWindowDays, viewWindowDays, conversionReportTime).block();

        // then
        // TODO implement the adGroupsAnalyticsTest()
    }
    ...
    public void adGroupsAudienceSizingTest() {
        ...
        // when
        AdGroupAudienceSizingResponse body = api.adGroupsAudienceSizing(adAccountId, adGroupAudienceSizingRequest).block();

        // then
        // TODO implement the adGroupsAudienceSizingTest()
    }
    ...
    public void adGroupsBidFloorGetTest() {
        ...
        // when
        BidFloor body = api.adGroupsBidFloorGet(adAccountId, bidFloorRequest).block();

        // then
        // TODO implement the adGroupsBidFloorGetTest()
    }
    ...
    public void adGroupsCreateTest() {
        // given
        String adAccountId = "example";
        List<AdGroupCreateRequest> adGroupCreateRequest = Arrays.asList();

        // when
        AdGroupArrayResponse body = api.adGroupsCreate(adAccountId, adGroupCreateRequest).block();

        // then
        // TODO implement the adGroupsCreateTest()
    }
    ...
    public void adGroupsGetTest() {
        ...
        // when
        AdGroupResponse body = api.adGroupsGet(adAccountId, adGroupId).block();

        // then
        // TODO implement the adGroupsGetTest()
    }
    ...
    public void adGroupsListTest() {
        ...
        // when
        AdGroupsList200Response body = api.adGroupsList(adAccountId, campaignIds, adGroupIds, entityStatuses, pageSize, order, bookmark, translateInterestsToNames).block();

        // then
        // TODO implement the adGroupsListTest()
    }
    ...
    public void adGroupsTargetingAnalyticsGetTest() {
        ...
        // when
        MetricsResponse body = api.adGroupsTargetingAnalyticsGet(adAccountId, adGroupIds, startDate, endDate, targetingTypes, columns, granularity, clickWindowDays, engagementWindowDays, viewWindowDays, conversionReportTime, attributionTypes).block();

        // then
        // TODO implement the adGroupsTargetingAnalyticsGetTest()
    }
    ...
    public void adGroupsUpdateTest() {
        // given
        String adAccountId = "example";
        List<AdGroupUpdateRequest> adGroupUpdateRequest = Arrays.asList();

        // when
        AdGroupArrayResponse body = api.adGroupsUpdate(adAccountId, adGroupUpdateRequest).block();

        // then
        // TODO implement the adGroupsUpdateTest()
    }
