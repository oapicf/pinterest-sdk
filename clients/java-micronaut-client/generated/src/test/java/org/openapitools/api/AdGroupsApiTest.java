...
public class AdGroupsApiTest {
    ...
    public void adGroupsAnalyticsTest() {
        ...
        // when
        List<AdGroupsAnalyticsResponseInner> body = api.adGroupsAnalytics(adAccountId, startDate, endDate, adGroupIds, columns, granularity, clickWindowDays, engagementWindowDays, viewWindowDays, conversionReportTime, aggregateReportRows, reportingTimezone).block();
    ...
    public void adGroupsTargetingAnalyticsGetTest() {
        ...
        // when
        MetricsResponse body = api.adGroupsTargetingAnalyticsGet(adAccountId, adGroupIds, startDate, endDate, targetingTypes, columns, granularity, clickWindowDays, engagementWindowDays, viewWindowDays, conversionReportTime, attributionTypes, reportingTimezone).block();
