...
public class PinsApiTest {
    ...
    public void multiPinsAnalyticsTest() {
        ...
        // when
        Map<String, Map<String, PinAnalyticsMetricsResponse>> body = api.multiPinsAnalytics(pinIds, startDate, endDate, metricTypes, appTypes, adAccountId).block();

        // then
        // TODO implement the multiPinsAnalyticsTest()
    }
    ...
    public void pinsGetTest() {
        ...
        // when
        Pin body = api.pinsGet(pinId, adAccountId, pinMetrics).block();
    ...
    public void pinsListTest() {
        ...
        // when
        PinsList200Response body = api.pinsList(pinFilter, pinMetrics, includeProtectedPins, pinType, creativeTypes, adAccountId, bookmark, pageSize).block();
