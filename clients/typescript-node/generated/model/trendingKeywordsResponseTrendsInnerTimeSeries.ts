...
*/
export class TrendingKeywordsResponseTrendsInnerTimeSeries extends null<String, number> {
    'date'?: string;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(TrendingKeywordsResponseTrendsInnerTimeSeries.attributeTypeMap);
    }
}
