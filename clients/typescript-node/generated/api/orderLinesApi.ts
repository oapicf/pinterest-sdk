...
export class OrderLinesApi {
     ...
     */
    public async orderLinesGet (orderLineId: string, adAccountId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: OrderLine;  }> {
     ...
     */
    public async orderLinesList (adAccountId: string, bookmark?: string, pageSize?: number, order?: PinterestLibPaginationOrder, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: OrderLinesList200Response;  }> {
