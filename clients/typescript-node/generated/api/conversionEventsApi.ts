...
export class ConversionEventsApi {
     ...
     */
    public async eventsCreate (adAccountId: string, conversionEventsCreate: ConversionEventsCreate, test?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ConversionEvents;  }> {
        ...
        // verify required parameter 'conversionEventsCreate' is not null or undefined
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(conversionEventsCreate, "ConversionEventsCreate")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: ConversionEvents;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "ConversionEvents");
