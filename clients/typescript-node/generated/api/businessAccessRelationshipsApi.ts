...
export class BusinessAccessRelationshipsApi {
     ...
     */
    public async brandAccountsCreate (businessHierarchyId: string, brandAccountsCreateRequest: BrandAccountsCreateRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: BrandAccountsCreate200Response;  }> {
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(brandAccountsCreateRequest, "BrandAccountsCreateRequest")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: BrandAccountsCreate200Response;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "BrandAccountsCreate200Response");
     ...
     */
    public async brandAccountsUpdate (businessHierarchyId: string, brandAccountId: string, brandAccountsUpdateRequest: BrandAccountsUpdateRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: BrandAccountsCreate200Response;  }> {
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(brandAccountsUpdateRequest, "BrandAccountsUpdateRequest")
        };
     ...
     */
    public async systemUserUpdate (businessId: string, systemUserId: string, systemUserUpdateRequest: SystemUserUpdateRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(systemUserUpdateRequest, "SystemUserUpdateRequest")
        };
