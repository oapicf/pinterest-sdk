...
export class IntegrationsApi {
     ...
     */
    public async integrationsCommerceDel (externalBusinessId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: IntegrationMetadata;  }> {
     ...
     */
    public async integrationsCommercePatch (externalBusinessId: string, integrationMetadataUpdate: IntegrationMetadataUpdate, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: IntegrationMetadata;  }> {
        const localVarPath = this.basePath + '/integrations/commerce/{external_business_id}'
            .replace('{external_business_id}', encodeURIComponent(String(externalBusinessId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'integrationMetadataUpdate' is not null or undefined
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(integrationMetadataUpdate, "IntegrationMetadataUpdate")
        };
     ...
     */
    public async integrationsCommercePost (integrationMetadataCreate: IntegrationMetadataCreate, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: IntegrationMetadata;  }> {
        ...
        // verify required parameter 'integrationMetadataCreate' is not null or undefined
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(integrationMetadataCreate, "IntegrationMetadataCreate")
        };
     ...
     */
    public async integrationsLogsPost (integrationLogsRequestCreate: IntegrationLogsRequestCreate, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: IntegrationLogsSuccessResponse;  }> {
        ...
        // verify required parameter 'integrationLogsRequestCreate' is not null or undefined
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(integrationLogsRequestCreate, "IntegrationLogsRequestCreate")
        };
