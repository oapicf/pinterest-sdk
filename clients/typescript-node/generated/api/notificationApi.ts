...
export class NotificationApi {
     ...
     */
    public async notificationPost (notificationPostRequest: NotificationPostRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: NotificationResponse;  }> {
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(notificationPostRequest, "NotificationPostRequest")
        };
