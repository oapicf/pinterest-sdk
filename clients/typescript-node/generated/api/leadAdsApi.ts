...
export class LeadAdsApi {
     ...
     */
    public async adAccountsSubscriptionsDelById (adAccountId: string, subscriptionId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: LeadSubscription;  }> {
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: LeadSubscription;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "LeadSubscription");
     ...
     * @param subscriptionId Unique identifier of a subscription.
     */
    public async adAccountsSubscriptionsGetById (adAccountId: string, subscriptionId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: LeadSubscription;  }> {
        const localVarPath = this.basePath + '/ad_accounts/{ad_account_id}/leads/subscriptions/{subscription_id}'
            .replace('{ad_account_id}', encodeURIComponent(String(adAccountId)))
            .replace('{subscription_id}', encodeURIComponent(String(subscriptionId)));
        let localVarQueryParameters: any = {};
     ...
     */
    public async adAccountsSubscriptionsGetList (adAccountId: string, bookmark?: string, pageSize?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: AdAccountsSubscriptionsGetList200Response;  }> {
     ...
     */
    public async adAccountsSubscriptionsPost (adAccountId: string, leadSubscriptionPostParamsCreate: LeadSubscriptionPostParamsCreate, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: LeadSubscription;  }> {
        const localVarPath = this.basePath + '/ad_accounts/{ad_account_id}/leads/subscriptions'
            .replace('{ad_account_id}', encodeURIComponent(String(adAccountId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(leadSubscriptionPostParamsCreate, "LeadSubscriptionPostParamsCreate")
        };
