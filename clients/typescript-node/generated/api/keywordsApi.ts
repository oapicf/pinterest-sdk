...
export class KeywordsApi {
     ...
     */
    public async keywordsGet (adAccountId: string, campaignId?: string, adGroupId?: string, adGroupIds?: Array<string>, matchTypes?: Array<MatchType>, pageSize?: number, bookmark?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: KeywordsGet200Response;  }> {
        const localVarPath = this.basePath + '/ad_accounts/{ad_account_id}/keywords'
            .replace('{' + 'ad_account_id' + '}', encodeURIComponent(String(adAccountId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
    ...
    public async trendingKeywordsList (region: TrendsSupportedRegion, trendType: TrendType, interests?: Array<'animals' | 'architecture' | 'art' | 'beauty' | 'childrens_fashion' | 'design' | 'diy_and_crafts' | 'education' | 'electronics' | 'entertainment' | 'event_planning' | 'finance' | 'food_and_drinks' | 'gardening' | 'health' | 'home_decor' | 'mens_fashion' | 'parenting' | 'quotes' | 'sport' | 'travel' | 'vehicles' | 'wedding' | 'womens_fashion'>, genders?: Array<'female' | 'male' | 'unknown'>, ages?: Array<'18-24' | '25-34' | '35-44' | '45-49' | '50-54' | '55-64' | '65+'>, includeKeywords?: Array<string>, normalizeAgainstGroup?: boolean, limit?: number, includePrediction?: boolean, includeDemographics?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: TrendingKeywordsResponse;  }> {
        ...
        if (includePrediction !== undefined) {
            localVarQueryParameters['include_prediction'] = ObjectSerializer.serialize(includePrediction, "boolean");
        }
