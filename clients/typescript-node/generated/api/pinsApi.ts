...
export class PinsApi {
    ...
    public async multiPinsAnalytics (pinIds: Array<string>, startDate: string, endDate: string, metricTypes: Array<MultiPinsAnalyticsMetricTypesItem>, appTypes?: 'ALL' | 'MOBILE' | 'TABLET' | 'WEB', adAccountId?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: { [key: string]: { [key: string]: PinAnalyticsMetricsResponse; }; };  }> {
        ...
        if (metricTypes !== undefined) {
            localVarQueryParameters['metric_types'] = ObjectSerializer.serialize(metricTypes, "Array<MultiPinsAnalyticsMetricTypesItem>");
        }
     ...
     * @param adAccountId Unique identifier of an ad account.
     */
    public async pinsAnalytics (pinId: string, startDate: string, endDate: string, metricTypes: Array<QuerypinanalyticsmetrictypesItems>, appTypes?: 'ALL' | 'MOBILE' | 'TABLET' | 'WEB', splitField?: 'NO_SPLIT' | 'APP_TYPE', adAccountId?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: { [key: string]: PinAnalyticsMetricsResponse; };  }> {
        ...
        if (metricTypes !== undefined) {
            localVarQueryParameters['metric_types'] = ObjectSerializer.serialize(metricTypes, "Array<QuerypinanalyticsmetrictypesItems>");
        }
     ...
     * @param adAccountId Unique identifier of an ad account.
     */
    public async pinsDelete (pinId: string, adAccountId?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Pin;  }> {
     ...
     */
    public async pinsGet (pinId: string, adAccountId?: string, pinMetrics?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Pin;  }> {
        const localVarPath = this.basePath + '/pins/{pin_id}'
            .replace('{pin_id}', encodeURIComponent(String(pinId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
     ...
     */
    public async pinsList (pinFilter?: PinFilter, pinMetrics?: boolean, includeProtectedPins?: boolean, pinType?: PinType, creativeTypes?: Array<CreativeType>, adAccountId?: string, domain?: string, domains?: Array<string>, includeProductTagObj?: boolean, bookmark?: string, pageSize?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PinsList200Response;  }> {
        const localVarPath = this.basePath + '/pins';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        ...
        if (pinFilter !== undefined) {
            localVarQueryParameters['pin_filter'] = ObjectSerializer.serialize(pinFilter, "PinFilter");
        }
        ...
        if (pinType !== undefined) {
            localVarQueryParameters['pin_type'] = ObjectSerializer.serialize(pinType, "PinType");
        }
        ...
        if (includeProductTagObj !== undefined) {
            localVarQueryParameters['include_product_tag_obj'] = ObjectSerializer.serialize(includeProductTagObj, "boolean");
        }
     ...
     * @param adAccountId Unique identifier of an ad account.
     */
    public async pinsSave (pinId: string, pinsSaveRequestCreate: PinsSaveRequestCreate, adAccountId?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Pin;  }> {
        ...
        // verify required parameter 'pinsSaveRequestCreate' is not null or undefined
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(pinsSaveRequestCreate, "PinsSaveRequestCreate")
        };
