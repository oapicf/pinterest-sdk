...
export class SearchApi {
     ...
     */
    public async searchUserBoardsGet (adAccountId?: string, query?: string, bookmark?: string, pageSize?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: BoardsList200Response;  }> {
