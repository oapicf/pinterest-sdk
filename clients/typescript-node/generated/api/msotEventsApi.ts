...
export enum MsotEventsApiApiKeys {
}

export class MsotEventsApi {
    ...
    public setApiKey(key: MsotEventsApiApiKeys, value: string) {
        (this.authentications as any)[MsotEventsApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    public async msotEventsCreate (adAccountId: string, conversionMSOTEventsCreate: ConversionMSOTEventsCreate, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/ad_accounts/{ad_account_id}/msot/events'
        ...
        // verify required parameter 'conversionMSOTEventsCreate' is not null or undefined
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(conversionMSOTEventsCreate, "ConversionMSOTEventsCreate")
        };
