...
export class MsotEventsApi {
     ...
     */
    public async msotEventsCreate (adAccountId: string, conversionMSOTEvents: ConversionMSOTEvents, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(conversionMSOTEvents, "ConversionMSOTEvents")
        };
