...
export class CatalogsApi {
     ...
     * @param adAccountId Unique identifier of an ad account.
     */
    public async itemsPost (catalogsItemsRequest: CatalogsItemsRequest, adAccountId?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: CatalogsItems;  }> {
        const localVarPath = this.basePath + '/catalogs/items';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
     ...
     * @param bookmark Cursor used to fetch the next page of items
     */
    public async reportsStats (parameters: CatalogsReportParameters, adAccountId?: string, pageSize?: number, bookmark?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ReportsStats200Response;  }> {
        ...
        if (parameters !== undefined) {
            localVarQueryParameters['parameters'] = ObjectSerializer.serialize(parameters, "CatalogsReportParameters");
        }
