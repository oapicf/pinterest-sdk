...
export class CatalogsApi {
     ...
     * @param adAccountId Unique identifier of an ad account.
     */
    public async catalogsCreate (catalogCreate: CatalogCreate, adAccountId?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Catalog;  }> {
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(catalogCreate, "CatalogCreate")
        };
     ...
     */
    public async catalogsList (adAccountId?: string, bookmark?: string, pageSize?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: CatalogsList200Response;  }> {
        const localVarPath = this.basePath + '/catalogs';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
