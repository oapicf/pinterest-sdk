...
export class CatalogReportsApi {
     ...
     */
    public async reportsStats (parameters: CatalogsReportStatsParameters, adAccountId?: string, bookmark?: string, pageSize?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ReportsStats200Response;  }> {
        ...
        if (parameters !== undefined) {
            localVarQueryParameters['parameters'] = ObjectSerializer.serialize(parameters, "CatalogsReportStatsParameters");
        }
