...
export class MediaApi {
     ...
     */
    public async mediaCreate (mediaUploadCreate: MediaUploadCreate, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: MediaUpload;  }> {
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(mediaUploadCreate, "MediaUploadCreate")
        };
     ...
     */
    public async mediaGet (mediaId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Media;  }> {
