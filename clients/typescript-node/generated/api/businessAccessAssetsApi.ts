...
export class BusinessAccessAssetsApi {
     ...
     */
    public async businessAssetMembersGet (businessId: string, assetId: string, fetchSystemUsers?: boolean, bookmark?: string, pageSize?: number, startIndex?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: BusinessAssetMembersGet200Response;  }> {
     ...
     * @param pageSize Maximum number of items to include in a single page of the response. See documentation on &lt;a href&#x3D;\&#39;/docs/reference/pagination/\&#39;&gt;Pagination&lt;/a&gt; for more information.
     */
    public async businessMemberAssetsGet (businessId: string, memberId: string, assetType?: 'AD_ACCOUNT' | 'PROFILE' | 'ASSET_GROUP' | 'CATALOG' | 'CONSUMER', startIndex?: number, bookmark?: string, pageSize?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: BusinessMemberAssetsGet200Response;  }> {
