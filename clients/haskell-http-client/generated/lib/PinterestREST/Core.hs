...
module PinterestREST.Core where
...
-- |
data PinterestRESTConfig = PinterestRESTConfig
...
-- | display the config
instance P.Show PinterestRESTConfig where
  show c =
    T.printf
...
-- | constructs a default PinterestRESTConfig
--
-- configHost:
--
...
-- configUserAgent:
--
-- @"pinterest-rest/0.1.0.0"@
--
newConfig :: IO PinterestRESTConfig
newConfig = do
    logCxt <- initLogContext
    return $ PinterestRESTConfig
        { configHost = "https://api.pinterest.com/v5"
        , configUserAgent = "pinterest-rest/0.1.0.0"
...
addAuthMethod :: AuthMethod auth => PinterestRESTConfig -> auth -> PinterestRESTConfig
addAuthMethod config@PinterestRESTConfig {configAuthMethods = as} a =
  config { configAuthMethods = AnyAuthMethod a : as}

-- | updates the config to use stdout logging
withStdoutLogging :: PinterestRESTConfig -> IO PinterestRESTConfig
...
withStderrLogging :: PinterestRESTConfig -> IO PinterestRESTConfig
...
withNoLogging :: PinterestRESTConfig -> PinterestRESTConfig
withNoLogging p = p { configLogExecWithContext =  runNullLogExec}

-- * PinterestRESTRequest
...
data PinterestRESTRequest req contentType res accept = PinterestRESTRequest
  { rMethod  :: NH.Method   -- ^ Method of PinterestRESTRequest
  , rUrlPath :: [BCL.ByteString] -- ^ Endpoint of PinterestRESTRequest
  , rParams   :: Params -- ^ params of PinterestRESTRequest
  , rAuthTypes :: [P.TypeRep] -- ^ types of auth methods
  }
  deriving (P.Show)

-- | 'rMethod' Lens
rMethodL :: Lens_' (PinterestRESTRequest req contentType res accept) NH.Method
rMethodL f PinterestRESTRequest{..} = (\rMethod -> PinterestRESTRequest { rMethod, ..} ) <$> f rMethod
{-# INLINE rMethodL #-}

-- | 'rUrlPath' Lens
rUrlPathL :: Lens_' (PinterestRESTRequest req contentType res accept) [BCL.ByteString]
rUrlPathL f PinterestRESTRequest{..} = (\rUrlPath -> PinterestRESTRequest { rUrlPath, ..} ) <$> f rUrlPath
{-# INLINE rUrlPathL #-}

-- | 'rParams' Lens
rParamsL :: Lens_' (PinterestRESTRequest req contentType res accept) Params
rParamsL f PinterestRESTRequest{..} = (\rParams -> PinterestRESTRequest { rParams, ..} ) <$> f rParams
{-# INLINE rParamsL #-}

-- | 'rParams' Lens
rAuthTypesL :: Lens_' (PinterestRESTRequest req contentType res accept) [P.TypeRep]
rAuthTypesL f PinterestRESTRequest{..} = (\rAuthTypes -> PinterestRESTRequest { rAuthTypes, ..} ) <$> f rAuthTypes
{-# INLINE rAuthTypesL #-}
...
class HasBodyParam req param where
  setBodyParam :: forall contentType res accept. (Consumes req contentType, MimeRender contentType param) => PinterestRESTRequest req contentType res accept -> param -> PinterestRESTRequest req contentType res accept
  setBodyParam req xs =
...
class HasOptionalParam req param where
  ...
  applyOptionalParam :: PinterestRESTRequest req contentType res accept -> param -> PinterestRESTRequest req contentType res accept
  applyOptionalParam = (-&-)
  {-# INLINE applyOptionalParam #-}

  -- | infix operator \/ alias for 'addOptionalParam'
  (-&-) :: PinterestRESTRequest req contentType res accept -> param -> PinterestRESTRequest req contentType res accept
  (-&-) = applyOptionalParam
  {-# INLINE (-&-) #-}
...
-- ** PinterestRESTRequest Utils

_mkRequest :: NH.Method -- ^ Method
          -> [BCL.ByteString] -- ^ Endpoint
          -> PinterestRESTRequest req contentType res accept -- ^ req: Request Type, res: Response Type
_mkRequest m u = PinterestRESTRequest m u _mkParams []

_mkParams :: Params
_mkParams = Params [] [] ParamBodyNone

setHeader ::
     PinterestRESTRequest req contentType res accept
  -> [NH.Header]
  -> PinterestRESTRequest req contentType res accept
...
removeHeader :: PinterestRESTRequest req contentType res accept -> [NH.HeaderName] -> PinterestRESTRequest req contentType res accept
...
_setContentTypeHeader :: forall req contentType res accept. MimeType contentType => PinterestRESTRequest req contentType res accept -> PinterestRESTRequest req contentType res accept
_setContentTypeHeader req =
    case mimeType (P.Proxy :: P.Proxy contentType) of
        Just m -> req `setHeader` [("content-type", BC.pack $ P.show m)]
        Nothing -> req `removeHeader` ["content-type"]

_setAcceptHeader :: forall req contentType res accept. MimeType accept => PinterestRESTRequest req contentType res accept -> PinterestRESTRequest req contentType res accept
...
addForm :: PinterestRESTRequest req contentType res accept -> WH.Form -> PinterestRESTRequest req contentType res accept
addForm req newform =
...
_addMultiFormPart :: PinterestRESTRequest req contentType res accept -> NH.Part -> PinterestRESTRequest req contentType res accept
...
_setBodyBS :: PinterestRESTRequest req contentType res accept -> B.ByteString -> PinterestRESTRequest req contentType res accept
_setBodyBS req body =
    req & L.set (rParamsL . paramsBodyL) (ParamBodyB body)

_setBodyLBS :: PinterestRESTRequest req contentType res accept -> BL.ByteString -> PinterestRESTRequest req contentType res accept
_setBodyLBS req body =
    req & L.set (rParamsL . paramsBodyL) (ParamBodyBL body)

_hasAuthType :: AuthMethod authMethod => PinterestRESTRequest req contentType res accept -> P.Proxy authMethod -> PinterestRESTRequest req contentType res accept
...
class P.Typeable a =>
  ...
  applyAuthMethod
    ...
    -> a
    -> PinterestRESTRequest req contentType res accept
    -> IO (PinterestRESTRequest req contentType res accept)
...
_applyAuthMethods
  ...
  -> PinterestRESTConfig
  -> IO (PinterestRESTRequest req contentType res accept)
_applyAuthMethods req config@(PinterestRESTConfig {configAuthMethods = as}) =
  foldlM go req as
  where
