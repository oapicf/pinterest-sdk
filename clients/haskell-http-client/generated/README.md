## OpenAPI Auto-Generated [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) Bindings to `Pinterest REST API`

The library in `lib` provides auto-generated-from-OpenAPI [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) bindings to the Pinterest REST API API.
...
| baseModule                      | Set the base module namespace                                                                                                 |          | PinterestREST                      |
| cabalPackage                    | Set the cabal package name, which consists of one or more alphanumeric words separated by hyphens                             |          | pinterest-rest                    |
...
| configType                      | Set the name of the type used for configuration                                                                               |          | PinterestRESTConfig                      |
...
| requestType                     | Set the name of the type used to generate requests                                                                            |          | PinterestRESTRequest                     |
...
| MODULE              | NOTES                                               |
| ------------------- | --------------------------------------------------- |
| PinterestREST.Client    | use the "dispatch" functions to send requests       |
| PinterestREST.Core      | core functions, config and request types            |
| PinterestREST.API       | construct api requests                              |
| PinterestREST.Model     | describes api models                                |
| PinterestREST.MimeTypes | encoding/decoding MIME types (content-types/accept) |
| PinterestREST.ModelLens | lenses for model fields                             |
| PinterestREST.Logging   | logging functions and utils                         |
