...
var _ resource.Resource = &SearchResource{}
var _ resource.ResourceWithImportState = &SearchResource{}
...
func (r *SearchResource) Schema(_ context.Context, _ resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schema.Schema{
		Description: "Manages a search resource.",
		Attributes: map[string]schema.Attribute{
		},
	}
}

func (r *SearchResource) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *SearchResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	resp.Diagnostics.AddError("Not Supported", "Create is not supported for search")
}
