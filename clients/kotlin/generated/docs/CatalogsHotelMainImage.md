...
| ------------ | ------------- | ------------- | ------------- |
| **link** | **kotlin.String** | &lt;&#x3D; 2000 characters. The link to the main hotel image. Image should be at least 75x75 pixels to avoid errors. Must start with http:// or https://. |  [optional] |
