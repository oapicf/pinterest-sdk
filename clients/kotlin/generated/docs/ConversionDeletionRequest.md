...
| ------------ | ------------- | ------------- | ------------- |
| **createdTime** | [**java.time.LocalDate**](java.time.LocalDate.md) | Timestamp when the conversion deletion request was succesfully created. |  [readonly] |
...
| **processedTime** | [**java.time.LocalDate**](java.time.LocalDate.md) | Timestamp when the conversion deletion request was processed. |  [optional] [readonly] |
