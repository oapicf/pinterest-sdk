...
| **createdTime** | **kotlin.Int** | Ad group creation time. Unix timestamp in seconds. |  [readonly] |
| **id** | **kotlin.String** | Ad group ID. |  |
| **name** | **kotlin.String** | Ad group name. |  |
| **summaryStatus** | [**SummaryStatus**](SummaryStatus.md) |  |  [readonly] |
| **type** | **kotlin.String** | Always \&quot;adgroup\&quot;. |  [readonly] |
| **updatedTime** | **kotlin.Int** | Ad group last update time. Unix timestamp in seconds. |  [readonly] |
| **adAccountId** | **kotlin.String** | Advertiser ID. |  [optional] [readonly] |
...
| **customerSegmentId** | **kotlin.String** | Customer segment ID applied to the ad group. We currently only support 1 customer segment per ad group. To use customer segments, do not set the &#x60;targeting_template_ids&#x60; field as well as the &#x60;AUDIENCE_INCLUDE&#x60; field of the &#x60;targeting_spec&#x60;. To clear the customer segment ID, set this field to &#39;0&#39;. |  [optional] |
| **dcaAssets** | [**kotlin.Any**](.md) | [DCA] The Dynamic creative assets to use for DCA. Dynamic Creative Assembly (DCA) accepts basic creative assets of an ad (image, video, title, call to action, logo etc). Then it automatically generates optimized ad combinations based on these assets. |  [optional] [readonly] |
...
| **isLocalInventory** | **kotlin.Boolean** | Indicates whether the ad group should use the local inventory. |  [optional] |
...
| **localInventoryRadiusInMiles** | [**java.math.BigDecimal**](java.math.BigDecimal.md) | The targeting radius of the local inventory ads in miles. |  [optional] |
...
| **promotionIds** | **kotlin.collections.List&lt;kotlin.String&gt;** | Promotion IDs list. To clear this field, set to an empty array []. |  [optional] |
...
| **autoTargetingEnabled** | **kotlin.Boolean** | Enable auto-targeting for ad group. Default value is True. Also known as [\&quot;Performance+ targeting\&quot;](https://help.pinterest.com/en/business/article/performance-plus-targeting). |  [optional] |
