...
try {
    ...
    println("4xx response calling ProductCategoriesApi#trendsFeaturedTopicsList")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling ProductCategoriesApi#trendsFeaturedTopicsList")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling ProductCategoriesApi#trendsProductCategoriesDetailsList")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling ProductCategoriesApi#trendsProductCategoriesDetailsList")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling ProductCategoriesApi#trendsProductCategoriesTrendingList")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling ProductCategoriesApi#trendsProductCategoriesTrendingList")
    e.printStackTrace()
}
```
