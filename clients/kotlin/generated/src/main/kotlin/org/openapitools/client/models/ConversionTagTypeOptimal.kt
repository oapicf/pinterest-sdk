...
enum class ConversionTagTypeOptimal(val value: kotlin.String) {
    ...
    companion object {
         ...
         */
        fun encode(data: kotlin.Any?): kotlin.String? = if (data is ConversionTagTypeOptimal) "$data" else null

        /**
         * Returns a valid [ConversionTagTypeOptimal] for [data], null otherwise.
         */
        fun decode(data: kotlin.Any?): ConversionTagTypeOptimal? = data?.let {
