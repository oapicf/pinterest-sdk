...
enum class BidFloorObjectiveType(val value: kotlin.String) {
    ...
    companion object {
         ...
         */
        fun encode(data: kotlin.Any?): kotlin.String? = if (data is BidFloorObjectiveType) "$data" else null

        /**
         * Returns a valid [BidFloorObjectiveType] for [data], null otherwise.
         */
        fun decode(data: kotlin.Any?): BidFloorObjectiveType? = data?.let {
