...
class ProductGroupPromotionsApi(basePath: kotlin.String = defaultBasePath, client: OkHttpClient = ApiClient.defaultClient) : ApiClient(basePath, client) {
    companion object {
        @JvmStatic
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun productGroupPromotionsGet(adAccountId: kotlin.String, productGroupPromotionId: kotlin.String) : ProductGroupPromotionResponse {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun productGroupPromotionsGetWithHttpInfo(adAccountId: kotlin.String, productGroupPromotionId: kotlin.String) : ApiResponse<ProductGroupPromotionResponse?> {
        ...
        return request<Unit, ProductGroupPromotionResponse>(
            localVariableConfig
        )
    }
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun productGroupPromotionsList(adAccountId: kotlin.String, productGroupPromotionIds: kotlin.collections.List<kotlin.String>? = null, entityStatuses: kotlin.collections.List<EntityStatusesProductGroupPromotionsList>? = EntityStatusesProductGroupPromotionsList.arrayListOf(ACTIVE,PAUSED), adGroupId: kotlin.String? = null, pageSize: kotlin.Int? = 25, order: OrderProductGroupPromotionsList? = null, bookmark: kotlin.String? = null) : ProductGroupPromotionsList200Response {
