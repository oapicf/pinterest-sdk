...
enum class AdsAnalyticsAdTargetingType(val value: kotlin.String) {
    ...
    companion object {
         ...
         */
        fun encode(data: kotlin.Any?): kotlin.String? = if (data is AdsAnalyticsAdTargetingType) "$data" else null

        /**
         * Returns a valid [AdsAnalyticsAdTargetingType] for [data], null otherwise.
         */
        fun decode(data: kotlin.Any?): AdsAnalyticsAdTargetingType? = data?.let {
