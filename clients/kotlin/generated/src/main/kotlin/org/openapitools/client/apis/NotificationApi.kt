...
open class NotificationApi(basePath: kotlin.String = defaultBasePath, client: Call.Factory = ApiClient.defaultClient) : ApiClient(basePath, client) {
    ...
    fun notificationPost(notificationPostRequest: NotificationPostRequest) : NotificationResponse {
        val localVarResponse = notificationPostWithHttpInfo(notificationPostRequest = notificationPostRequest)

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as NotificationResponse
    ...
    fun notificationPostWithHttpInfo(notificationPostRequest: NotificationPostRequest) : ApiResponse<NotificationResponse?> {
        val localVariableConfig = notificationPostRequestConfig(notificationPostRequest = notificationPostRequest)

        return request<NotificationPostRequest, NotificationResponse>(
            localVariableConfig
        )
    }
    ...
    fun notificationPostRequestConfig(notificationPostRequest: NotificationPostRequest) : RequestConfig<NotificationPostRequest> {
        val localVariableBody = notificationPostRequest
