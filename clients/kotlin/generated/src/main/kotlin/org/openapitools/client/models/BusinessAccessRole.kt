...
enum class BusinessAccessRole(val value: kotlin.String) {
    ...
    companion object {
         ...
         */
        fun encode(data: kotlin.Any?): kotlin.String? = if (data is BusinessAccessRole) "$data" else null

        /**
         * Returns a valid [BusinessAccessRole] for [data], null otherwise.
         */
        fun decode(data: kotlin.Any?): BusinessAccessRole? = data?.let {
