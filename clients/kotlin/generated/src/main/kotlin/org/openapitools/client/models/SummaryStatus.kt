...
enum class SummaryStatus(val value: kotlin.String) {
    ...
    companion object {
         ...
         */
        fun encode(data: kotlin.Any?): kotlin.String? = if (data is SummaryStatus) "$data" else null

        /**
         * Returns a valid [SummaryStatus] for [data], null otherwise.
         */
        fun decode(data: kotlin.Any?): SummaryStatus? = data?.let {
