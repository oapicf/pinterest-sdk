...
enum class BusinessRole(val value: kotlin.String) {
    ...
    companion object {
         ...
         */
        fun encode(data: kotlin.Any?): kotlin.String? = if (data is BusinessRole) "$data" else null

        /**
         * Returns a valid [BusinessRole] for [data], null otherwise.
         */
        fun decode(data: kotlin.Any?): BusinessRole? = data?.let {
