...
class AdResponseTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of AdResponse
        //val modelInstance = AdResponse()
        ...
        // to test the property `adAccountId` - The ID of the advertiser that this ad belongs to.
        should("test adAccountId") {
            // uncomment below to test the property
            //modelInstance.adAccountId shouldBe ("TODO")
        }

        // to test the property `campaignId` - ID of the ad campaign that contains this ad.
        should("test campaignId") {
            // uncomment below to test the property
            //modelInstance.campaignId shouldBe ("TODO")
        }

        // to test the property `collectionItemsDestinationUrlTemplate` - Destination URL template for all items within a collections drawer.
        should("test collectionItemsDestinationUrlTemplate") {
            // uncomment below to test the property
            //modelInstance.collectionItemsDestinationUrlTemplate shouldBe ("TODO")
        }

        // to test the property `createdTime` - Pin creation time. Unix timestamp in seconds.
        should("test createdTime") {
            // uncomment below to test the property
            //modelInstance.createdTime shouldBe ("TODO")
        }

        // to test the property `id` - The ID of this ad.
        should("test id") {
            // uncomment below to test the property
            //modelInstance.id shouldBe ("TODO")
        }

        // to test the property `rejectedReasons` - Enum reason why the pin was rejected. Returned if <code>review_status</code> is \"REJECTED\".
        should("test rejectedReasons") {
            // uncomment below to test the property
            //modelInstance.rejectedReasons shouldBe ("TODO")
        }

        // to test the property `rejectionLabels` - Text reason why the pin was rejected. Returned if <code>review_status</code> is \"REJECTED\".
        should("test rejectionLabels") {
            // uncomment below to test the property
            //modelInstance.rejectionLabels shouldBe ("TODO")
        }

        // to test the property `reviewStatus` - Ad review status
        should("test reviewStatus") {
            // uncomment below to test the property
            //modelInstance.reviewStatus shouldBe ("TODO")
        }

        // to test the property `type` - Always \"ad\".
        should("test type") {
            // uncomment below to test the property
        ...
        // to test the property `summaryStatus` - Ad summary status
