...
class LeadFormResponseTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of LeadFormResponse
        //val modelInstance = LeadFormResponse()
        ...
        // to test the property `createdTime` - Lead form creation time. Unix timestamp in seconds.
