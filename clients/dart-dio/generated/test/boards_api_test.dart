...
/// tests for BoardsApi
void main() {
  final instance = Openapi().getBoardsApi();
  ...
  group(BoardsApi, () {
    ...
    //
    //Future<BoardsListPins200Response> boardsListPins(String boardId, { String bookmark, int pageSize, BuiltList<CreativeType> creativeTypes, String adAccountId, bool pinMetrics }) async
