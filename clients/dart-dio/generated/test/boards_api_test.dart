...
void main() {
  ...
  group(BoardsApi, () {
    ...
    //
    //Future<BoardsListPins200Response> boardsListPins(String boardId, { String bookmark, int pageSize, BuiltList<String> creativeTypes, String adAccountId, bool pinMetrics }) async
