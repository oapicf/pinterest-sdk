...
// tests for ProductGroupPromotionCreateRequestElement
void main() {
  final instance = ProductGroupPromotionCreateRequestElementBuilder();
  // TODO add properties to the builder and call build()

  group(ProductGroupPromotionCreateRequestElement, () {
