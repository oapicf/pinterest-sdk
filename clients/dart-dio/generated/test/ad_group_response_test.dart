...
void main() {
  final instance = AdGroupResponseBuilder();
  // TODO add properties to the builder and call build()

  group(AdGroupResponse, () {
    // Ad group name.
    // String name
    ...
    // Always \"adgroup\".
    // String type (default value: 'adgroup')
    ...
    // JsonObject dcaAssets
    test('to test the property `dcaAssets`', () async {
      // TODO
    });
