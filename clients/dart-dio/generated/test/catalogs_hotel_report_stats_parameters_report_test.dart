...
// tests for CatalogsHotelReportStatsParametersReport
void main() {
  final instance = CatalogsHotelReportStatsParametersReportBuilder();
  // TODO add properties to the builder and call build()

  group(CatalogsHotelReportStatsParametersReport, () {
    // String reportType
