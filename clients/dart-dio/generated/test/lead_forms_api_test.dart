...
void main() {
  final instance = Openapi().getLeadFormsApi();
  ...
  group(LeadFormsApi, () {
    ...
    //
    //Future<LeadFormArrayResponse> leadFormsCreate(String adAccountId, BuiltList<LeadFormCreateRequest> leadFormCreateRequest) async
    ...
    //
    //Future<LeadFormArrayResponse> leadFormsUpdate(String adAccountId, BuiltList<LeadFormUpdateRequest> leadFormUpdateRequest) async
