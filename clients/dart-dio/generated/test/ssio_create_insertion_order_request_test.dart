...
// tests for SSIOCreateInsertionOrderRequest
void main() {
  final instance = SSIOCreateInsertionOrderRequestBuilder();
  // TODO add properties to the builder and call build()

  group(SSIOCreateInsertionOrderRequest, () {
    ...
    test('to test the property `billtoBillingAddressId`', () async {
      // TODO
    });
