...
void main() {
  final instance = Openapi().getUserAccountApi();

  group(UserAccountApi, () {
    ...
    //
    //Future<BuiltList<LinkedBusiness>> linkedBusinessAccountsGet() async
    ...
    //
    //Future<BuiltMap<String, AnalyticsMetricsResponse>> userAccountAnalytics(Date startDate, Date endDate, { String fromClaimedContent, String pinFormat, String appTypes, String contentType, String source_, BuiltList<String> metricTypes, String splitField, String adAccountId }) async
    ...
    //
    //Future<TopPinsAnalyticsResponse> userAccountAnalyticsTopPins(Date startDate, Date endDate, String sortBy, { String fromClaimedContent, String pinFormat, String appTypes, String contentType, String source_, BuiltList<String> metricTypes, int numOfPins, int createdInLastNDays, String adAccountId }) async
    ...
    //
    //Future<TopVideoPinsAnalyticsResponse> userAccountAnalyticsTopVideoPins(Date startDate, Date endDate, String sortBy, { String fromClaimedContent, String pinFormat, String appTypes, String contentType, String source_, BuiltList<String> metricTypes, int numOfPins, int createdInLastNDays, String adAccountId }) async
