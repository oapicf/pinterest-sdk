...
void main() {
  final instance = Openapi().getBusinessAccessAssetsApi();

  group(BusinessAccessAssetsApi, () {
    ...
    //
    //Future<BusinessAssetsGet200Response> businessAssetsGet(String businessId, { BuiltList<PermissionsWithOwner> permissions, String childAssetId, String assetGroupId, String assetType, int startIndex, String bookmark, int pageSize }) async
