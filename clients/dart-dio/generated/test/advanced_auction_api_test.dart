...
/// tests for AdvancedAuctionApi
void main() {
  final instance = Openapi().getAdvancedAuctionApi();

  group(AdvancedAuctionApi, () {
    ...
    test('test advancedAuctionItemsGetPost', () async {
      // TODO
    });
    ...
    test('test advancedAuctionItemsSubmitPost', () async {
      // TODO
    });
