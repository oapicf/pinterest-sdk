...
void main() {
  final instance = ConversionProductReportRequestBuilder();
  // TODO add properties to the builder and call build()

  group(ConversionProductReportRequest, () {
    ...
    // BuiltList<ConversionProductReportingColumn> columns
    ...
    // BuiltList<String> productSkuIds
