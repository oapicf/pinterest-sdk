...
// tests for CatalogsRetailProductGroupUpdateRequest
void main() {
  final instance = CatalogsRetailProductGroupUpdateRequestBuilder();
  // TODO add properties to the builder and call build()

  group(CatalogsRetailProductGroupUpdateRequest, () {
