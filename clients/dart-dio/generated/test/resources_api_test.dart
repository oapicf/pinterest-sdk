...
void main() {
  final instance = Openapi().getResourcesApi();
  ...
  group(ResourcesApi, () {
    ...
    //
    //Future<BuiltList<JsonObject>> targetingOptionsGet(String targetingType, { String clientId, String oauthSignature, String timestamp, String adAccountId }) async
