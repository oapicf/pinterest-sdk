...
// tests for ConversionEventsDataInnerCustomDataContentsInner
void main() {
  final instance = ConversionEventsDataInnerCustomDataContentsInnerBuilder();
  // TODO add properties to the builder and call build()

  group(ConversionEventsDataInnerCustomDataContentsInner, () {
    ...
    // String itemBrand
    test('to test the property `itemBrand`', () async {
      // TODO
    });

    // The category of a product.
    // String itemCategory
    test('to test the property `itemCategory`', () async {
      // TODO
    });
    ...
    // String itemPrice
    test('to test the property `itemPrice`', () async {
      // TODO
    });
