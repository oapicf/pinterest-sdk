...
// tests for CatalogsCreativeAssetsProductGroupFilterKeys
void main() {
  final instance = CatalogsCreativeAssetsProductGroupFilterKeysBuilder();
  // TODO add properties to the builder and call build()

  group(CatalogsCreativeAssetsProductGroupFilterKeys, () {
    // CatalogsProductGroupMultipleStringCriteria CREATIVE_ASSETS_ID
    test('to test the property `CREATIVE_ASSETS_ID`', () async {
      // TODO
    });
