...
// tests for CatalogsCreativeAssetsFeedsCreateRequest
void main() {
  final instance = CatalogsCreativeAssetsFeedsCreateRequestBuilder();
  // TODO add properties to the builder and call build()

  group(CatalogsCreativeAssetsFeedsCreateRequest, () {
