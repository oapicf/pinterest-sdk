...
part 'create_asset_access_request_item.g.dart';
...
@BuiltValue()
abstract class CreateAssetAccessRequestItem implements Built<CreateAssetAccessRequestItem, CreateAssetAccessRequestItemBuilder> {
  ...
  CreateAssetAccessRequestItem._();

  factory CreateAssetAccessRequestItem([void updates(CreateAssetAccessRequestItemBuilder b)]) = _$CreateAssetAccessRequestItem;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CreateAssetAccessRequestItemBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<CreateAssetAccessRequestItem> get serializer => _$CreateAssetAccessRequestItemSerializer();
}

class _$CreateAssetAccessRequestItemSerializer implements PrimitiveSerializer<CreateAssetAccessRequestItem> {
  @override
  final Iterable<Type> types = const [CreateAssetAccessRequestItem, _$CreateAssetAccessRequestItem];

  @override
  final String wireName = r'CreateAssetAccessRequestItem';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    CreateAssetAccessRequestItem object, {
  ...
  void _deserializeProperties(
    ...
    required CreateAssetAccessRequestItemBuilder result,
  ...
  @override
  CreateAssetAccessRequestItem deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = CreateAssetAccessRequestItemBuilder();
