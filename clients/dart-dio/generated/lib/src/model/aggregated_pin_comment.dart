...
part 'aggregated_pin_comment.g.dart';
...
/// * [title] 
@BuiltValue()
abstract class AggregatedPinComment implements Built<AggregatedPinComment, AggregatedPinCommentBuilder> {
  ...
  AggregatedPinComment._();

  factory AggregatedPinComment([void updates(AggregatedPinCommentBuilder b)]) = _$AggregatedPinComment;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(AggregatedPinCommentBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<AggregatedPinComment> get serializer => _$AggregatedPinCommentSerializer();
}

class _$AggregatedPinCommentSerializer implements PrimitiveSerializer<AggregatedPinComment> {
  @override
  final Iterable<Type> types = const [AggregatedPinComment, _$AggregatedPinComment];

  @override
  final String wireName = r'AggregatedPinComment';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    AggregatedPinComment object, {
  ...
  void _deserializeProperties(
    ...
    required AggregatedPinCommentBuilder result,
  ...
  @override
  AggregatedPinComment deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = AggregatedPinCommentBuilder();
