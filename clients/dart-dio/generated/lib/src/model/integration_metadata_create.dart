...
part 'integration_metadata_create.g.dart';
...
/// * [scopes] 
@BuiltValue()
abstract class IntegrationMetadataCreate implements Built<IntegrationMetadataCreate, IntegrationMetadataCreateBuilder> {
  ...
  IntegrationMetadataCreate._();

  factory IntegrationMetadataCreate([void updates(IntegrationMetadataCreateBuilder b)]) = _$IntegrationMetadataCreate;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(IntegrationMetadataCreateBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<IntegrationMetadataCreate> get serializer => _$IntegrationMetadataCreateSerializer();
}

class _$IntegrationMetadataCreateSerializer implements PrimitiveSerializer<IntegrationMetadataCreate> {
  @override
  final Iterable<Type> types = const [IntegrationMetadataCreate, _$IntegrationMetadataCreate];

  @override
  final String wireName = r'IntegrationMetadataCreate';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    IntegrationMetadataCreate object, {
  ...
  void _deserializeProperties(
    ...
    required IntegrationMetadataCreateBuilder result,
  ...
  @override
  IntegrationMetadataCreate deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = IntegrationMetadataCreateBuilder();
