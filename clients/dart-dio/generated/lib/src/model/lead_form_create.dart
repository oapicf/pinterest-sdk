...
/// * [status] 
@BuiltValue()
abstract class LeadFormCreate implements Built<LeadFormCreate, LeadFormCreateBuilder> {
  ...
  factory LeadFormCreate([void updates(LeadFormCreateBuilder b)]) = _$LeadFormCreate;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(LeadFormCreateBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<LeadFormCreate> get serializer => _$LeadFormCreateSerializer();
}

class _$LeadFormCreateSerializer implements PrimitiveSerializer<LeadFormCreate> {
  @override
  final Iterable<Type> types = const [LeadFormCreate, _$LeadFormCreate];

  @override
  final String wireName = r'LeadFormCreate';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    LeadFormCreate object, {
  ...
  void _deserializeProperties(
    ...
    required LeadFormCreateBuilder result,
  ...
  @override
  LeadFormCreate deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = LeadFormCreateBuilder();
