...
part 'schedule_batch_update.g.dart';
...
@BuiltValue()
abstract class ScheduleBatchUpdate implements Built<ScheduleBatchUpdate, ScheduleBatchUpdateBuilder> {
  ...
  ScheduleBatchUpdate._();

  factory ScheduleBatchUpdate([void updates(ScheduleBatchUpdateBuilder b)]) = _$ScheduleBatchUpdate;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ScheduleBatchUpdateBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ScheduleBatchUpdate> get serializer => _$ScheduleBatchUpdateSerializer();
}

class _$ScheduleBatchUpdateSerializer implements PrimitiveSerializer<ScheduleBatchUpdate> {
  @override
  final Iterable<Type> types = const [ScheduleBatchUpdate, _$ScheduleBatchUpdate];

  @override
  final String wireName = r'ScheduleBatchUpdate';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    ScheduleBatchUpdate object, {
  ...
  void _deserializeProperties(
    ...
    required ScheduleBatchUpdateBuilder result,
  ...
  @override
  ScheduleBatchUpdate deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ScheduleBatchUpdateBuilder();
