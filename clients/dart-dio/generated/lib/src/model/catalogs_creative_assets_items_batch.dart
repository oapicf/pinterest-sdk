...
part 'catalogs_creative_assets_items_batch.g.dart';
...
/// * [status] 
@BuiltValue()
abstract class CatalogsCreativeAssetsItemsBatch implements Built<CatalogsCreativeAssetsItemsBatch, CatalogsCreativeAssetsItemsBatchBuilder> {
  ...
  BuiltList<CreativeAssetsProcessingRecord>? get items;

  @BuiltValueField(wireName: r'status')
  BatchOperationStatus? get status;
  // enum statusEnum {  PROCESSING,  COMPLETED,  FAILED,  };

  CatalogsCreativeAssetsItemsBatch._();

  factory CatalogsCreativeAssetsItemsBatch([void updates(CatalogsCreativeAssetsItemsBatchBuilder b)]) = _$CatalogsCreativeAssetsItemsBatch;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CatalogsCreativeAssetsItemsBatchBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<CatalogsCreativeAssetsItemsBatch> get serializer => _$CatalogsCreativeAssetsItemsBatchSerializer();
}

class _$CatalogsCreativeAssetsItemsBatchSerializer implements PrimitiveSerializer<CatalogsCreativeAssetsItemsBatch> {
  @override
  final Iterable<Type> types = const [CatalogsCreativeAssetsItemsBatch, _$CatalogsCreativeAssetsItemsBatch];

  @override
  final String wireName = r'CatalogsCreativeAssetsItemsBatch';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    CatalogsCreativeAssetsItemsBatch object, {
  ...
  void _deserializeProperties(
    ...
    required CatalogsCreativeAssetsItemsBatchBuilder result,
  ...
  @override
  CatalogsCreativeAssetsItemsBatch deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = CatalogsCreativeAssetsItemsBatchBuilder();
