...
abstract class CatalogsItemsUpdateBatchRequest implements Built<CatalogsItemsUpdateBatchRequest, CatalogsItemsUpdateBatchRequestBuilder> {
  ...
  CatalogsItemsUpdateBatchRequestOperationEnum get operation;
...
class _$CatalogsItemsUpdateBatchRequestSerializer implements PrimitiveSerializer<CatalogsItemsUpdateBatchRequest> {
  ...
  Iterable<Object?> _serializeProperties(
    ...
    yield serializers.serialize(
      object.operation,
      specifiedType: const FullType(CatalogsItemsUpdateBatchRequestOperationEnum),
    );
  }
      ...
      switch (key) {
        ...
        case r'operation':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(CatalogsItemsUpdateBatchRequestOperationEnum),
          ) as CatalogsItemsUpdateBatchRequestOperationEnum;
...
class CatalogsItemsUpdateBatchRequestOperationEnum extends EnumClass {

  @BuiltValueEnumConst(wireName: r'UPDATE')
  static const CatalogsItemsUpdateBatchRequestOperationEnum UPDATE = _$catalogsItemsUpdateBatchRequestOperationEnum_UPDATE;

  static Serializer<CatalogsItemsUpdateBatchRequestOperationEnum> get serializer => _$catalogsItemsUpdateBatchRequestOperationEnumSerializer;

  const CatalogsItemsUpdateBatchRequestOperationEnum._(String name): super(name);

  static BuiltSet<CatalogsItemsUpdateBatchRequestOperationEnum> get values => _$catalogsItemsUpdateBatchRequestOperationEnumValues;
  static CatalogsItemsUpdateBatchRequestOperationEnum valueOf(String name) => _$catalogsItemsUpdateBatchRequestOperationEnumValueOf(name);
}
