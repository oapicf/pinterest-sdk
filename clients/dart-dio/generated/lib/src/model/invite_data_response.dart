...
part 'invite_data_response.g.dart';
...
/// * [inviteType] - The type of invite. - 'MEMBER_INVITE' is to invite a member to access your business assets. - 'PARTNER_INVITE' is to invite a partner to access your business assets. - 'PARTNER_REQUEST' is to request access a partner's business assets.
...
@BuiltValue()
abstract class InviteDataResponse implements Built<InviteDataResponse, InviteDataResponseBuilder> {
  ...
  InviteDataResponse._();

  factory InviteDataResponse([void updates(InviteDataResponseBuilder b)]) = _$InviteDataResponse;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(InviteDataResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<InviteDataResponse> get serializer => _$InviteDataResponseSerializer();
}

class _$InviteDataResponseSerializer implements PrimitiveSerializer<InviteDataResponse> {
  @override
  final Iterable<Type> types = const [InviteDataResponse, _$InviteDataResponse];

  @override
  final String wireName = r'InviteDataResponse';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    InviteDataResponse object, {
  ...
  void _deserializeProperties(
    ...
    required InviteDataResponseBuilder result,
  ...
  @override
  InviteDataResponse deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = InviteDataResponseBuilder();
