...
import 'package:openapi/src/model/catalogs_retail_batch_request_items_inner.dart';
...
abstract class CatalogsRetailBatchRequest implements Built<CatalogsRetailBatchRequest, CatalogsRetailBatchRequestBuilder> {
  ...
  BuiltList<CatalogsRetailBatchRequestItemsInner> get items;
...
class _$CatalogsRetailBatchRequestSerializer implements PrimitiveSerializer<CatalogsRetailBatchRequest> {
  ...
  Iterable<Object?> _serializeProperties(
    ...
    yield serializers.serialize(
      object.items,
      specifiedType: const FullType(BuiltList, [FullType(CatalogsRetailBatchRequestItemsInner)]),
    );
    yield r'language';
    yield serializers.serialize(
      object.language,
      ...
      switch (key) {
        ...
        case r'items':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(BuiltList, [FullType(CatalogsRetailBatchRequestItemsInner)]),
          ) as BuiltList<CatalogsRetailBatchRequestItemsInner>;
