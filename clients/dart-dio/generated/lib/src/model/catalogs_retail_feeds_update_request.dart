...
part 'catalogs_retail_feeds_update_request.g.dart';
...
abstract class CatalogsRetailFeedsUpdateRequest implements Built<CatalogsRetailFeedsUpdateRequest, CatalogsRetailFeedsUpdateRequestBuilder> {
  ...
  CatalogsRetailFeedsUpdateRequest._();

  factory CatalogsRetailFeedsUpdateRequest([void updates(CatalogsRetailFeedsUpdateRequestBuilder b)]) = _$CatalogsRetailFeedsUpdateRequest;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CatalogsRetailFeedsUpdateRequestBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<CatalogsRetailFeedsUpdateRequest> get serializer => _$CatalogsRetailFeedsUpdateRequestSerializer();
}

class _$CatalogsRetailFeedsUpdateRequestSerializer implements PrimitiveSerializer<CatalogsRetailFeedsUpdateRequest> {
  @override
  final Iterable<Type> types = const [CatalogsRetailFeedsUpdateRequest, _$CatalogsRetailFeedsUpdateRequest];

  @override
  final String wireName = r'CatalogsRetailFeedsUpdateRequest';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    CatalogsRetailFeedsUpdateRequest object, {
  ...
  void _deserializeProperties(
    ...
    required CatalogsRetailFeedsUpdateRequestBuilder result,
  ...
  @override
  CatalogsRetailFeedsUpdateRequest deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = CatalogsRetailFeedsUpdateRequestBuilder();
