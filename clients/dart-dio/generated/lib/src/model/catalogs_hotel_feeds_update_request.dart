...
part 'catalogs_hotel_feeds_update_request.g.dart';
...
abstract class CatalogsHotelFeedsUpdateRequest implements Built<CatalogsHotelFeedsUpdateRequest, CatalogsHotelFeedsUpdateRequestBuilder> {
  ...
  CatalogsHotelFeedsUpdateRequest._();

  factory CatalogsHotelFeedsUpdateRequest([void updates(CatalogsHotelFeedsUpdateRequestBuilder b)]) = _$CatalogsHotelFeedsUpdateRequest;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CatalogsHotelFeedsUpdateRequestBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<CatalogsHotelFeedsUpdateRequest> get serializer => _$CatalogsHotelFeedsUpdateRequestSerializer();
}

class _$CatalogsHotelFeedsUpdateRequestSerializer implements PrimitiveSerializer<CatalogsHotelFeedsUpdateRequest> {
  @override
  final Iterable<Type> types = const [CatalogsHotelFeedsUpdateRequest, _$CatalogsHotelFeedsUpdateRequest];

  @override
  final String wireName = r'CatalogsHotelFeedsUpdateRequest';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    CatalogsHotelFeedsUpdateRequest object, {
  ...
  void _deserializeProperties(
    ...
    required CatalogsHotelFeedsUpdateRequestBuilder result,
  ...
  @override
  CatalogsHotelFeedsUpdateRequest deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = CatalogsHotelFeedsUpdateRequestBuilder();
