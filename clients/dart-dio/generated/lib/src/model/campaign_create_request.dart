...
part 'campaign_create_request.g.dart';
...
/// * [objectiveType] 
@BuiltValue()
abstract class CampaignCreateRequest implements CampaignCreateCommon, Built<CampaignCreateRequest, CampaignCreateRequestBuilder> {
  ...
  CampaignCreateRequest._();

  factory CampaignCreateRequest([void updates(CampaignCreateRequestBuilder b)]) = _$CampaignCreateRequest;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CampaignCreateRequestBuilder b) => b
      ..isPerformancePlus = false;

  @BuiltValueSerializer(custom: true)
  static Serializer<CampaignCreateRequest> get serializer => _$CampaignCreateRequestSerializer();
}

class _$CampaignCreateRequestSerializer implements PrimitiveSerializer<CampaignCreateRequest> {
  @override
  final Iterable<Type> types = const [CampaignCreateRequest, _$CampaignCreateRequest];

  @override
  final String wireName = r'CampaignCreateRequest';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    CampaignCreateRequest object, {
    ...
    if (object.bidOptions != null) {
      ...
      yield serializers.serialize(
        object.bidOptions,
        specifiedType: const FullType(CampaignBidOptionsCreate),
      );
    }
  ...
  void _deserializeProperties(
    ...
    required CampaignCreateRequestBuilder result,
  ...
  @override
  CampaignCreateRequest deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = CampaignCreateRequestBuilder();
