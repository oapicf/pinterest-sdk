...
@BuiltValue()
abstract class AdGroupCreateRequest implements AdGroupCommon, Built<AdGroupCreateRequest, AdGroupCreateRequestBuilder> {
  /// <a href=\"/docs/getting-started/using-beta-and-restricted-features/\" target=\"blank>Open beta</a> Bid multiplier for ad group. This value is a double between 0.1 and 10.0. Enter 0 to remove the bid multiplier. - Make sure the `bid_strategy` type for your ad group is set to `AUTOMATIC_BID`. - Not currently supported for <a href=\"/docs/api-features/pinterest-performance-plus-setup/\" target=\"blank\">Pinterest Performance+ campaigns</a>.
...
class AdGroupCreateRequestBidStrategyTypeEnum extends EnumClass {
  ...
  static const AdGroupCreateRequestBidStrategyTypeEnum AUTOMATIC_BID = _$adGroupCreateRequestBidStrategyTypeEnum_AUTOMATIC_BID;
  /// Bid strategy type. For Campaigns with Video Completion objectives, the only supported bid strategy type is AUTOMATIC_BID, also known as \"Pinterest Performance+ bidding\".
  @BuiltValueEnumConst(wireName: r'MAX_BID')
  static const AdGroupCreateRequestBidStrategyTypeEnum MAX_BID = _$adGroupCreateRequestBidStrategyTypeEnum_MAX_BID;
  /// Bid strategy type. For Campaigns with Video Completion objectives, the only supported bid strategy type is AUTOMATIC_BID, also known as \"Pinterest Performance+ bidding\".
  @BuiltValueEnumConst(wireName: r'TARGET_AVG')
  static const AdGroupCreateRequestBidStrategyTypeEnum TARGET_AVG = _$adGroupCreateRequestBidStrategyTypeEnum_TARGET_AVG;

  static Serializer<AdGroupCreateRequestBidStrategyTypeEnum> get serializer => _$adGroupCreateRequestBidStrategyTypeEnumSerializer;

  const AdGroupCreateRequestBidStrategyTypeEnum._(String name): super(name);

  static BuiltSet<AdGroupCreateRequestBidStrategyTypeEnum> get values => _$adGroupCreateRequestBidStrategyTypeEnumValues;
  static AdGroupCreateRequestBidStrategyTypeEnum valueOf(String name) => _$adGroupCreateRequestBidStrategyTypeEnumValueOf(name);
}
