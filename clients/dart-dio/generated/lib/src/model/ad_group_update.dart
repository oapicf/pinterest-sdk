...
/// * [pacingDeliveryType] 
@BuiltValue()
abstract class AdGroupUpdate implements AdGroupBase, Built<AdGroupUpdate, AdGroupUpdateBuilder> {
  ...
  factory AdGroupUpdate([void updates(AdGroupUpdateBuilder b)]) = _$AdGroupUpdate;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(AdGroupUpdateBuilder b) => b
      ..type = 'adgroup'
      ..promotionId = '0';

  @BuiltValueSerializer(custom: true)
  static Serializer<AdGroupUpdate> get serializer => _$AdGroupUpdateSerializer();
}

class _$AdGroupUpdateSerializer implements PrimitiveSerializer<AdGroupUpdate> {
  @override
  final Iterable<Type> types = const [AdGroupUpdate, _$AdGroupUpdate];

  @override
  final String wireName = r'AdGroupUpdate';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    AdGroupUpdate object, {
  ...
  void _deserializeProperties(
    ...
    required AdGroupUpdateBuilder result,
  ...
  @override
  AdGroupUpdate deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = AdGroupUpdateBuilder();
