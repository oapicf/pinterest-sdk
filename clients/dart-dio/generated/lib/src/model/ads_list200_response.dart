...
/// * [items] 
@BuiltValue()
abstract class AdsList200Response implements Built<AdsList200Response, AdsList200ResponseBuilder> {
  @BuiltValueField(wireName: r'bookmark')
  String? get bookmark;

  @BuiltValueField(wireName: r'items')
  BuiltList<Ad> get items;
...
class _$AdsList200ResponseSerializer implements PrimitiveSerializer<AdsList200Response> {
  ...
  Iterable<Object?> _serializeProperties(
    ...
    yield serializers.serialize(
      object.items,
      specifiedType: const FullType(BuiltList, [FullType(Ad)]),
    );
  }
