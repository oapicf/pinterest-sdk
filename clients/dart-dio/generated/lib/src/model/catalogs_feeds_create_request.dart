...
part 'catalogs_feeds_create_request.g.dart';
...
/// * [status] 
@BuiltValue()
abstract class CatalogsFeedsCreateRequest implements Built<CatalogsFeedsCreateRequest, CatalogsFeedsCreateRequestBuilder> {
  ...
  CatalogsFeedsCreateRequest._();

  factory CatalogsFeedsCreateRequest([void updates(CatalogsFeedsCreateRequestBuilder b)]) = _$CatalogsFeedsCreateRequest;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CatalogsFeedsCreateRequestBuilder b) => b
      ..status = CatalogsStatus.ACTIVE;

  @BuiltValueSerializer(custom: true)
  static Serializer<CatalogsFeedsCreateRequest> get serializer => _$CatalogsFeedsCreateRequestSerializer();
}

class _$CatalogsFeedsCreateRequestSerializer implements PrimitiveSerializer<CatalogsFeedsCreateRequest> {
  @override
  final Iterable<Type> types = const [CatalogsFeedsCreateRequest, _$CatalogsFeedsCreateRequest];

  @override
  final String wireName = r'CatalogsFeedsCreateRequest';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    CatalogsFeedsCreateRequest object, {
  ...
  void _deserializeProperties(
    ...
    required CatalogsFeedsCreateRequestBuilder result,
    ...
    for (var i = 0; i < serializedList.length; i += 2) {
      ...
      switch (key) {
        ...
        case r'default_locale':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType.nullable(CatalogsCreativeAssetsFeedsCreateRequestDefaultLocale),
  ...
  @override
  CatalogsFeedsCreateRequest deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = CatalogsFeedsCreateRequestBuilder();
