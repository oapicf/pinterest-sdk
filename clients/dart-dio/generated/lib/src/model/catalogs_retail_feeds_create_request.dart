...
part 'catalogs_retail_feeds_create_request.g.dart';
...
/// * [status] 
@BuiltValue()
abstract class CatalogsRetailFeedsCreateRequest implements Built<CatalogsRetailFeedsCreateRequest, CatalogsRetailFeedsCreateRequestBuilder> {
  /// Catalog id pertaining to the feed. If not provided, feed will use a default catalog based on type.
  @BuiltValueField(wireName: r'catalog_id')
  String? get catalogId;

  @BuiltValueField(wireName: r'catalog_type')
  CatalogsRetailFeedsCreateRequestCatalogTypeEnum get catalogType;
  ...
  CatalogsRetailFeedsCreateRequest._();

  factory CatalogsRetailFeedsCreateRequest([void updates(CatalogsRetailFeedsCreateRequestBuilder b)]) = _$CatalogsRetailFeedsCreateRequest;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CatalogsRetailFeedsCreateRequestBuilder b) => b
      ..status = CatalogsStatus.ACTIVE;

  @BuiltValueSerializer(custom: true)
  static Serializer<CatalogsRetailFeedsCreateRequest> get serializer => _$CatalogsRetailFeedsCreateRequestSerializer();
}

class _$CatalogsRetailFeedsCreateRequestSerializer implements PrimitiveSerializer<CatalogsRetailFeedsCreateRequest> {
  @override
  final Iterable<Type> types = const [CatalogsRetailFeedsCreateRequest, _$CatalogsRetailFeedsCreateRequest];

  @override
  final String wireName = r'CatalogsRetailFeedsCreateRequest';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    CatalogsRetailFeedsCreateRequest object, {
    ...
    yield serializers.serialize(
      object.catalogType,
      specifiedType: const FullType(CatalogsRetailFeedsCreateRequestCatalogTypeEnum),
    );
  ...
  void _deserializeProperties(
    ...
    required CatalogsRetailFeedsCreateRequestBuilder result,
      ...
      switch (key) {
        ...
        case r'catalog_type':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(CatalogsRetailFeedsCreateRequestCatalogTypeEnum),
          ) as CatalogsRetailFeedsCreateRequestCatalogTypeEnum;
  ...
  @override
  CatalogsRetailFeedsCreateRequest deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = CatalogsRetailFeedsCreateRequestBuilder();
...
class CatalogsRetailFeedsCreateRequestCatalogTypeEnum extends EnumClass {

  @BuiltValueEnumConst(wireName: r'RETAIL')
  static const CatalogsRetailFeedsCreateRequestCatalogTypeEnum RETAIL = _$catalogsRetailFeedsCreateRequestCatalogTypeEnum_RETAIL;

  static Serializer<CatalogsRetailFeedsCreateRequestCatalogTypeEnum> get serializer => _$catalogsRetailFeedsCreateRequestCatalogTypeEnumSerializer;

  const CatalogsRetailFeedsCreateRequestCatalogTypeEnum._(String name): super(name);

  static BuiltSet<CatalogsRetailFeedsCreateRequestCatalogTypeEnum> get values => _$catalogsRetailFeedsCreateRequestCatalogTypeEnumValues;
  static CatalogsRetailFeedsCreateRequestCatalogTypeEnum valueOf(String name) => _$catalogsRetailFeedsCreateRequestCatalogTypeEnumValueOf(name);
}
