...
/// * [pacingDeliveryType] 
@BuiltValue()
abstract class AdGroup implements AdGroupBase, Built<AdGroup, AdGroupBuilder> {
  ...
  factory AdGroup([void updates(AdGroupBuilder b)]) = _$AdGroup;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(AdGroupBuilder b) => b
      ..type = 'adgroup'
      ..promotionId = '0';

  @BuiltValueSerializer(custom: true)
  static Serializer<AdGroup> get serializer => _$AdGroupSerializer();
}

class _$AdGroupSerializer implements PrimitiveSerializer<AdGroup> {
  @override
  final Iterable<Type> types = const [AdGroup, _$AdGroup];

  @override
  final String wireName = r'AdGroup';
  ...
  void _deserializeProperties(
    ...
    required AdGroupBuilder result,
