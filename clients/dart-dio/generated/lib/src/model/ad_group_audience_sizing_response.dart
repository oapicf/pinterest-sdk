...
part 'ad_group_audience_sizing_response.g.dart';
...
@BuiltValue()
abstract class AdGroupAudienceSizingResponse implements Built<AdGroupAudienceSizingResponse, AdGroupAudienceSizingResponseBuilder> {
  ...
  AdGroupAudienceSizingResponse._();

  factory AdGroupAudienceSizingResponse([void updates(AdGroupAudienceSizingResponseBuilder b)]) = _$AdGroupAudienceSizingResponse;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(AdGroupAudienceSizingResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<AdGroupAudienceSizingResponse> get serializer => _$AdGroupAudienceSizingResponseSerializer();
}

class _$AdGroupAudienceSizingResponseSerializer implements PrimitiveSerializer<AdGroupAudienceSizingResponse> {
  @override
  final Iterable<Type> types = const [AdGroupAudienceSizingResponse, _$AdGroupAudienceSizingResponse];

  @override
  final String wireName = r'AdGroupAudienceSizingResponse';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    AdGroupAudienceSizingResponse object, {
  ...
  void _deserializeProperties(
    ...
    required AdGroupAudienceSizingResponseBuilder result,
  ...
  @override
  AdGroupAudienceSizingResponse deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = AdGroupAudienceSizingResponseBuilder();
