...
part 'local_store_create.g.dart';
...
@BuiltValue()
abstract class LocalStoreCreate implements Built<LocalStoreCreate, LocalStoreCreateBuilder> {
  ...
  factory LocalStoreCreate([void updates(LocalStoreCreateBuilder b)]) = _$LocalStoreCreate;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(LocalStoreCreateBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<LocalStoreCreate> get serializer => _$LocalStoreCreateSerializer();
}

class _$LocalStoreCreateSerializer implements PrimitiveSerializer<LocalStoreCreate> {
  @override
  final Iterable<Type> types = const [LocalStoreCreate, _$LocalStoreCreate];

  @override
  final String wireName = r'LocalStoreCreate';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    LocalStoreCreate object, {
  ...
  void _deserializeProperties(
    ...
    required LocalStoreCreateBuilder result,
  ...
  @override
  LocalStoreCreate deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = LocalStoreCreateBuilder();
