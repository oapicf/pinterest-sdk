...
import 'package:openapi/src/model/conversion_events_data_items_custom_data.dart';
...
part 'conversion_events_data_items.g.dart';

/// ConversionEventsDataItems
///
/// Properties:
/// * [actionSource] - The source indicating where the conversion event occurred. - `app_android` - `app_ios` - `web` - `offline`
...
/// * [userData] - Object containing customer information data. Note, It is required at least one of 1) em, 2) hashed_maids or 3) pair client_ip_address + client_user_agent.
/// * [wifi] - Whether the event occurred when the user device was connected to wifi.
@BuiltValue()
abstract class ConversionEventsDataItems implements Built<ConversionEventsDataItems, ConversionEventsDataItemsBuilder> {
  ...
  ConversionEventsDataItemsCustomData? get customData;
  ...
  ConversionEventsUserDataProperties get userData;

  /// Whether the event occurred when the user device was connected to wifi.
  @BuiltValueField(wireName: r'wifi')
  bool? get wifi;

  ConversionEventsDataItems._();

  factory ConversionEventsDataItems([void updates(ConversionEventsDataItemsBuilder b)]) = _$ConversionEventsDataItems;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ConversionEventsDataItemsBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ConversionEventsDataItems> get serializer => _$ConversionEventsDataItemsSerializer();
}

class _$ConversionEventsDataItemsSerializer implements PrimitiveSerializer<ConversionEventsDataItems> {
  @override
  final Iterable<Type> types = const [ConversionEventsDataItems, _$ConversionEventsDataItems];

  @override
  final String wireName = r'ConversionEventsDataItems';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    ConversionEventsDataItems object, {
    ...
    if (object.customData != null) {
      ...
      yield serializers.serialize(
        object.customData,
        specifiedType: const FullType(ConversionEventsDataItemsCustomData),
      );
    }
    ...
    yield serializers.serialize(
      object.userData,
      specifiedType: const FullType(ConversionEventsUserDataProperties),
    );
    if (object.wifi != null) {
      yield r'wifi';
      yield serializers.serialize(
  ...
  void _deserializeProperties(
    ...
    required ConversionEventsDataItemsBuilder result,
    ...
    for (var i = 0; i < serializedList.length; i += 2) {
      ...
      switch (key) {
        ...
        case r'app_info':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType.nullable(ConversionEventAppInfo),
        ...
        case r'custom_data':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType.nullable(ConversionEventsDataItemsCustomData),
          ) as ConversionEventsDataItemsCustomData?;
          if (valueDes == null) continue;
        ...
        case r'device_info':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType.nullable(ConversionEventDeviceInfo),
        ...
        case r'user_data':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(ConversionEventsUserDataProperties),
          ) as ConversionEventsUserDataProperties;
  ...
  @override
  ConversionEventsDataItems deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ConversionEventsDataItemsBuilder();
