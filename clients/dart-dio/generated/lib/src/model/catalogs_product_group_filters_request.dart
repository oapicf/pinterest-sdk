...
import 'package:openapi/src/model/any_of.dart';
import 'package:openapi/src/model/all_of.dart';
...
class _$CatalogsProductGroupFiltersRequestSerializer implements PrimitiveSerializer<CatalogsProductGroupFiltersRequest> {
  ...
  CatalogsProductGroupFiltersRequest deserialize(
    ...
    Object? anyOfDataSrc;
    final targetType = const FullType(AnyOf, [FullType(AnyOf), FullType(AllOf), ]);
