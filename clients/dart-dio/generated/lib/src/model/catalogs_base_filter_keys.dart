...
import 'package:openapi/src/model/pinterest_product_categories_filter.dart';
...
part 'catalogs_base_filter_keys.g.dart';
...
@BuiltValue()
abstract class CatalogsBaseFilterKeys implements Built<CatalogsBaseFilterKeys, CatalogsBaseFilterKeysBuilder> {
  ...
  CatalogsBaseFilterKeys._();

  factory CatalogsBaseFilterKeys([void updates(CatalogsBaseFilterKeysBuilder b)]) = _$CatalogsBaseFilterKeys;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CatalogsBaseFilterKeysBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<CatalogsBaseFilterKeys> get serializer => _$CatalogsBaseFilterKeysSerializer();
}

class _$CatalogsBaseFilterKeysSerializer implements PrimitiveSerializer<CatalogsBaseFilterKeys> {
  @override
  final Iterable<Type> types = const [CatalogsBaseFilterKeys, _$CatalogsBaseFilterKeys];

  @override
  final String wireName = r'CatalogsBaseFilterKeys';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    CatalogsBaseFilterKeys object, {
