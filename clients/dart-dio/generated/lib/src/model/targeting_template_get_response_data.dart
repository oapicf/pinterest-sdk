...
import 'package:openapi/src/model/targeting_template_response_data.dart';
import 'package:built_value/built_value.dart';
import 'package:built_value/serializer.dart';

part 'targeting_template_get_response_data.g.dart';
...
@BuiltValue()
abstract class TargetingTemplateGetResponseData implements TargetingTemplateResponseData, Built<TargetingTemplateGetResponseData, TargetingTemplateGetResponseDataBuilder> {
  /// Inform if the targeting template is valid (ex. would be false if has revoked audience)
  @BuiltValueField(wireName: r'valid')
  bool? get valid;

  TargetingTemplateGetResponseData._();

  factory TargetingTemplateGetResponseData([void updates(TargetingTemplateGetResponseDataBuilder b)]) = _$TargetingTemplateGetResponseData;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(TargetingTemplateGetResponseDataBuilder b) => b
      ..autoTargetingEnabled = true
      ..status = TargetingTemplateResponseDataStatusEnum.valueOf('ACTIVE');

  @BuiltValueSerializer(custom: true)
  static Serializer<TargetingTemplateGetResponseData> get serializer => _$TargetingTemplateGetResponseDataSerializer();
}

class _$TargetingTemplateGetResponseDataSerializer implements PrimitiveSerializer<TargetingTemplateGetResponseData> {
  @override
  final Iterable<Type> types = const [TargetingTemplateGetResponseData, _$TargetingTemplateGetResponseData];

  @override
  final String wireName = r'TargetingTemplateGetResponseData';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    TargetingTemplateGetResponseData object, {
  ...
  void _deserializeProperties(
    ...
    required TargetingTemplateGetResponseDataBuilder result,
  ...
  @override
  TargetingTemplateGetResponseData deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = TargetingTemplateGetResponseDataBuilder();
...
class TargetingTemplateGetResponseDataStatusEnum extends EnumClass {

  /// Indicate targeting template is active or Deleted
  @BuiltValueEnumConst(wireName: r'ACTIVE')
  static const TargetingTemplateGetResponseDataStatusEnum ACTIVE = _$targetingTemplateGetResponseDataStatusEnum_ACTIVE;
  /// Indicate targeting template is active or Deleted
  @BuiltValueEnumConst(wireName: r'DELETED')
  static const TargetingTemplateGetResponseDataStatusEnum DELETED = _$targetingTemplateGetResponseDataStatusEnum_DELETED;

  static Serializer<TargetingTemplateGetResponseDataStatusEnum> get serializer => _$targetingTemplateGetResponseDataStatusEnumSerializer;

  const TargetingTemplateGetResponseDataStatusEnum._(String name): super(name);

  static BuiltSet<TargetingTemplateGetResponseDataStatusEnum> get values => _$targetingTemplateGetResponseDataStatusEnumValues;
  static TargetingTemplateGetResponseDataStatusEnum valueOf(String name) => _$targetingTemplateGetResponseDataStatusEnumValueOf(name);
}
