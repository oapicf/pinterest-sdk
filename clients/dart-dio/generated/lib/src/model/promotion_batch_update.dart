...
part 'promotion_batch_update.g.dart';
...
@BuiltValue()
abstract class PromotionBatchUpdate implements Built<PromotionBatchUpdate, PromotionBatchUpdateBuilder> {
  ...
  PromotionBatchUpdate._();

  factory PromotionBatchUpdate([void updates(PromotionBatchUpdateBuilder b)]) = _$PromotionBatchUpdate;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PromotionBatchUpdateBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PromotionBatchUpdate> get serializer => _$PromotionBatchUpdateSerializer();
}

class _$PromotionBatchUpdateSerializer implements PrimitiveSerializer<PromotionBatchUpdate> {
  @override
  final Iterable<Type> types = const [PromotionBatchUpdate, _$PromotionBatchUpdate];

  @override
  final String wireName = r'PromotionBatchUpdate';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    PromotionBatchUpdate object, {
  ...
  void _deserializeProperties(
    ...
    required PromotionBatchUpdateBuilder result,
  ...
  @override
  PromotionBatchUpdate deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = PromotionBatchUpdateBuilder();
