...
part 'campaign_create_item.g.dart';
...
/// * [trackingUrls] 
@BuiltValue()
abstract class CampaignCreateItem implements Built<CampaignCreateItem, CampaignCreateItemBuilder> {
  ...
  CampaignCreateItem._();

  factory CampaignCreateItem([void updates(CampaignCreateItemBuilder b)]) = _$CampaignCreateItem;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CampaignCreateItemBuilder b) => b
  ...
  static Serializer<CampaignCreateItem> get serializer => _$CampaignCreateItemSerializer();
}

class _$CampaignCreateItemSerializer implements PrimitiveSerializer<CampaignCreateItem> {
  @override
  final Iterable<Type> types = const [CampaignCreateItem, _$CampaignCreateItem];

  @override
  final String wireName = r'CampaignCreateItem';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    CampaignCreateItem object, {
  ...
  void _deserializeProperties(
    ...
    required CampaignCreateItemBuilder result,
  ...
  @override
  CampaignCreateItem deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = CampaignCreateItemBuilder();
