...
abstract class AdCommon  {
  ...
  static Serializer<AdCommon> get serializer => _$AdCommonSerializer();
}

class _$AdCommonSerializer implements PrimitiveSerializer<AdCommon> {
  @override
  final Iterable<Type> types = const [AdCommon];

  @override
  final String wireName = r'AdCommon';
  ...
  @override
  AdCommon deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    return serializers.deserialize(serialized, specifiedType: FullType($AdCommon)) as $AdCommon;
  }
}

/// a concrete implementation of [AdCommon], since [AdCommon] is not instantiable
@BuiltValue(instantiable: true)
abstract class $AdCommon implements AdCommon, Built<$AdCommon, $AdCommonBuilder> {
  $AdCommon._();

  factory $AdCommon([void Function($AdCommonBuilder)? updates]) = _$$AdCommon;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults($AdCommonBuilder b) => b;
...
class _$$AdCommonSerializer implements PrimitiveSerializer<$AdCommon> {
  @override
  final Iterable<Type> types = const [$AdCommon, _$$AdCommon];
  ...
  Object serialize(
    ...
    return serializers.serialize(object, specifiedType: FullType(AdCommon))!;
  }
  ...
  void _deserializeProperties(
    ...
    required AdCommonBuilder result,
