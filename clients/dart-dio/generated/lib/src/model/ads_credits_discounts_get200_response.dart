...
/// * [items] 
@BuiltValue()
abstract class AdsCreditsDiscountsGet200Response implements Built<AdsCreditsDiscountsGet200Response, AdsCreditsDiscountsGet200ResponseBuilder> {
  @BuiltValueField(wireName: r'bookmark')
  String? get bookmark;

  @BuiltValueField(wireName: r'items')
  BuiltList<AdsCreditDiscountsResponse> get items;
...
class _$AdsCreditsDiscountsGet200ResponseSerializer implements PrimitiveSerializer<AdsCreditsDiscountsGet200Response> {
  ...
  Iterable<Object?> _serializeProperties(
    ...
    yield serializers.serialize(
      object.items,
      specifiedType: const FullType(BuiltList, [FullType(AdsCreditDiscountsResponse)]),
    );
  }
      ...
      switch (key) {
        ...
        case r'items':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(BuiltList, [FullType(AdsCreditDiscountsResponse)]),
          ) as BuiltList<AdsCreditDiscountsResponse>;
