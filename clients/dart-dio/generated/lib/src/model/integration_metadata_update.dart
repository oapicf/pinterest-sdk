...
part 'integration_metadata_update.g.dart';
...
/// * [scopes] 
@BuiltValue()
abstract class IntegrationMetadataUpdate implements Built<IntegrationMetadataUpdate, IntegrationMetadataUpdateBuilder> {
  ...
  IntegrationMetadataUpdate._();

  factory IntegrationMetadataUpdate([void updates(IntegrationMetadataUpdateBuilder b)]) = _$IntegrationMetadataUpdate;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(IntegrationMetadataUpdateBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<IntegrationMetadataUpdate> get serializer => _$IntegrationMetadataUpdateSerializer();
}

class _$IntegrationMetadataUpdateSerializer implements PrimitiveSerializer<IntegrationMetadataUpdate> {
  @override
  final Iterable<Type> types = const [IntegrationMetadataUpdate, _$IntegrationMetadataUpdate];

  @override
  final String wireName = r'IntegrationMetadataUpdate';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    IntegrationMetadataUpdate object, {
  ...
  void _deserializeProperties(
    ...
    required IntegrationMetadataUpdateBuilder result,
  ...
  @override
  IntegrationMetadataUpdate deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = IntegrationMetadataUpdateBuilder();
