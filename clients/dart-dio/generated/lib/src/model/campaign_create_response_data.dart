...
part 'campaign_create_response_data.g.dart';
...
@BuiltValue()
abstract class CampaignCreateResponseData implements CampaignCreateCommon, CampaignResponse, Built<CampaignCreateResponseData, CampaignCreateResponseDataBuilder> {
  CampaignCreateResponseData._();

  factory CampaignCreateResponseData([void updates(CampaignCreateResponseDataBuilder b)]) = _$CampaignCreateResponseData;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CampaignCreateResponseDataBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<CampaignCreateResponseData> get serializer => _$CampaignCreateResponseDataSerializer();
}

class _$CampaignCreateResponseDataSerializer implements PrimitiveSerializer<CampaignCreateResponseData> {
  @override
  final Iterable<Type> types = const [CampaignCreateResponseData, _$CampaignCreateResponseData];

  @override
  final String wireName = r'CampaignCreateResponseData';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    CampaignCreateResponseData object, {
  ...
  void _deserializeProperties(
    ...
    required CampaignCreateResponseDataBuilder result,
  ...
  @override
  CampaignCreateResponseData deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = CampaignCreateResponseDataBuilder();
