...
/// * [pinId] - Pin ID.
@BuiltValue()
abstract class AdCreateRequest implements AdCommon, AdPinId, Built<AdCreateRequest, AdCreateRequestBuilder> {
  AdCreateRequest._();

  factory AdCreateRequest([void updates(AdCreateRequestBuilder b)]) = _$AdCreateRequest;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(AdCreateRequestBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<AdCreateRequest> get serializer => _$AdCreateRequestSerializer();
}

class _$AdCreateRequestSerializer implements PrimitiveSerializer<AdCreateRequest> {
  @override
  final Iterable<Type> types = const [AdCreateRequest, _$AdCreateRequest];

  @override
  final String wireName = r'AdCreateRequest';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    AdCreateRequest object, {
  ...
  void _deserializeProperties(
    ...
    required AdCreateRequestBuilder result,
  ...
  @override
  AdCreateRequest deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = AdCreateRequestBuilder();
