...
part 'ad_account_get_subscription_response.g.dart';
...
/// * [createdTime] - Lead subscription creation time. Unix timestamp in milliseconds.
...
@BuiltValue()
abstract class AdAccountGetSubscriptionResponse implements Built<AdAccountGetSubscriptionResponse, AdAccountGetSubscriptionResponseBuilder> {
  /// Lead form ID.
  ...
  AdAccountGetSubscriptionResponse._();

  factory AdAccountGetSubscriptionResponse([void updates(AdAccountGetSubscriptionResponseBuilder b)]) = _$AdAccountGetSubscriptionResponse;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(AdAccountGetSubscriptionResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<AdAccountGetSubscriptionResponse> get serializer => _$AdAccountGetSubscriptionResponseSerializer();
}

class _$AdAccountGetSubscriptionResponseSerializer implements PrimitiveSerializer<AdAccountGetSubscriptionResponse> {
  @override
  final Iterable<Type> types = const [AdAccountGetSubscriptionResponse, _$AdAccountGetSubscriptionResponse];

  @override
  final String wireName = r'AdAccountGetSubscriptionResponse';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    AdAccountGetSubscriptionResponse object, {
  ...
  void _deserializeProperties(
    ...
    required AdAccountGetSubscriptionResponseBuilder result,
  ...
  @override
  AdAccountGetSubscriptionResponse deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = AdAccountGetSubscriptionResponseBuilder();
