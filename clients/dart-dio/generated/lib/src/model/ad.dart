...
import 'package:openapi/src/model/ad_review_status.dart';
...
import 'package:openapi/src/model/ad_disapproval_reasons.dart';
...
import 'package:openapi/src/model/carting_product.dart';
...
/// * [cartingPlatformType] - The vendor platform type of the carting/WTB ad.
/// * [cartingProducts] - Array of carting/WTB products for the ad.
...
/// * [rejectedReasons] - Enum reason why the pin was rejected. Returned if `review_status` is \"REJECTED\".
/// * [rejectionLabels] - Text reason why the pin was rejected. Returned if `review_status` is \"REJECTED\".
...
abstract class Ad implements Built<Ad, AdBuilder> {
  ...
  @BuiltValueField(wireName: r'carting_platform_type')
  int? get cartingPlatformType;

  /// Array of carting/WTB products for the ad.
  @BuiltValueField(wireName: r'carting_products')
  BuiltList<CartingProduct>? get cartingProducts;
  ...
  BuiltList<AdDisapprovalReasons> get rejectedReasons;
  ...
  AdReviewStatus get reviewStatus;
...
class _$AdSerializer implements PrimitiveSerializer<Ad> {
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.cartingPlatformType != null) {
      yield r'carting_platform_type';
      yield serializers.serialize(
        object.cartingPlatformType,
        specifiedType: const FullType(int),
      );
    }
    if (object.cartingProducts != null) {
      yield r'carting_products';
      yield serializers.serialize(
        object.cartingProducts,
        specifiedType: const FullType(BuiltList, [FullType(CartingProduct)]),
      );
    }
    ...
    yield serializers.serialize(
      ...
      specifiedType: const FullType(BuiltList, [FullType(AdDisapprovalReasons)]),
    );
    ...
    yield serializers.serialize(
      object.reviewStatus,
      specifiedType: const FullType(AdReviewStatus),
    );
    ...
    for (var i = 0; i < serializedList.length; i += 2) {
      ...
      switch (key) {
        ...
        case r'carousel_ios_deep_links':
          ...
          break;
        case r'carting_platform_type':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType.nullable(int),
          ) as int?;
          if (valueDes == null) continue;
          result.cartingPlatformType = valueDes;
          break;
        case r'carting_products':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType.nullable(BuiltList, [FullType(CartingProduct)]),
          ) as BuiltList<CartingProduct>?;
          if (valueDes == null) continue;
          result.cartingProducts.replace(valueDes);
          break;
        ...
        case r'rejected_reasons':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(BuiltList, [FullType(AdDisapprovalReasons)]),
          ) as BuiltList<AdDisapprovalReasons>;
