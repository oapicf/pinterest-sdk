...
part 'catalogs_creative_assets_feeds_update_request.g.dart';
...
abstract class CatalogsCreativeAssetsFeedsUpdateRequest implements Built<CatalogsCreativeAssetsFeedsUpdateRequest, CatalogsCreativeAssetsFeedsUpdateRequestBuilder> {
  ...
  CatalogsCreativeAssetsFeedsUpdateRequest._();

  factory CatalogsCreativeAssetsFeedsUpdateRequest([void updates(CatalogsCreativeAssetsFeedsUpdateRequestBuilder b)]) = _$CatalogsCreativeAssetsFeedsUpdateRequest;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CatalogsCreativeAssetsFeedsUpdateRequestBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<CatalogsCreativeAssetsFeedsUpdateRequest> get serializer => _$CatalogsCreativeAssetsFeedsUpdateRequestSerializer();
}

class _$CatalogsCreativeAssetsFeedsUpdateRequestSerializer implements PrimitiveSerializer<CatalogsCreativeAssetsFeedsUpdateRequest> {
  @override
  final Iterable<Type> types = const [CatalogsCreativeAssetsFeedsUpdateRequest, _$CatalogsCreativeAssetsFeedsUpdateRequest];

  @override
  final String wireName = r'CatalogsCreativeAssetsFeedsUpdateRequest';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    CatalogsCreativeAssetsFeedsUpdateRequest object, {
  ...
  void _deserializeProperties(
    ...
    required CatalogsCreativeAssetsFeedsUpdateRequestBuilder result,
  ...
  @override
  CatalogsCreativeAssetsFeedsUpdateRequest deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = CatalogsCreativeAssetsFeedsUpdateRequestBuilder();
