...
part 'ad_group_create_create.g.dart';
...
/// * [trackingUrls] 
@BuiltValue()
abstract class AdGroupCreateCreate implements Built<AdGroupCreateCreate, AdGroupCreateCreateBuilder> {
  ...
  AdGroupCreateCreate._();

  factory AdGroupCreateCreate([void updates(AdGroupCreateCreateBuilder b)]) = _$AdGroupCreateCreate;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(AdGroupCreateCreateBuilder b) => b
      ..budgetType = BudgetType.DAILY
      ..pacingDeliveryType = PacingDeliveryType.STANDARD
      ..promotionId = '0';

  @BuiltValueSerializer(custom: true)
  static Serializer<AdGroupCreateCreate> get serializer => _$AdGroupCreateCreateSerializer();
}

class _$AdGroupCreateCreateSerializer implements PrimitiveSerializer<AdGroupCreateCreate> {
  @override
  final Iterable<Type> types = const [AdGroupCreateCreate, _$AdGroupCreateCreate];

  @override
  final String wireName = r'AdGroupCreateCreate';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    AdGroupCreateCreate object, {
  ...
  void _deserializeProperties(
    ...
    required AdGroupCreateCreateBuilder result,
  ...
  @override
  AdGroupCreateCreate deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = AdGroupCreateCreateBuilder();
