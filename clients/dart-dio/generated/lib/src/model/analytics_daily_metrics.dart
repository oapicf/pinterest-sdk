...
part 'analytics_daily_metrics.g.dart';
...
abstract class AnalyticsDailyMetrics implements Built<AnalyticsDailyMetrics, AnalyticsDailyMetricsBuilder> {
  ...
  AnalyticsDailyMetrics._();

  factory AnalyticsDailyMetrics([void updates(AnalyticsDailyMetricsBuilder b)]) = _$AnalyticsDailyMetrics;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(AnalyticsDailyMetricsBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<AnalyticsDailyMetrics> get serializer => _$AnalyticsDailyMetricsSerializer();
}

class _$AnalyticsDailyMetricsSerializer implements PrimitiveSerializer<AnalyticsDailyMetrics> {
  @override
  final Iterable<Type> types = const [AnalyticsDailyMetrics, _$AnalyticsDailyMetrics];

  @override
  final String wireName = r'AnalyticsDailyMetrics';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    AnalyticsDailyMetrics object, {
  ...
  void _deserializeProperties(
    ...
    required AnalyticsDailyMetricsBuilder result,
  ...
  @override
  AnalyticsDailyMetrics deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = AnalyticsDailyMetricsBuilder();
