...
import 'package:openapi/src/model/targeting_strategy.dart';
...
part 'targeting_spec_optimal.g.dart';
...
/// * [GEO_EXCLUDE] - [Closed beta](/docs/getting-started/using-beta-and-restricted-features/)  Region codes or postal codes to exclude from the targeting inclusion area.  See `GEO` parameter in this targeting spec for rules, syntax, and other information.
...
/// * [LOCATION_EXCLUDE] - [Closed beta](/docs/getting-started/using-beta-and-restricted-features/)  Metropolitan codes and/or ISO-Alpha-2, two-letter country codes to exclude from targeting.  See `LOCATION` parameter in this targeting spec for rules, syntax, and other information.
...
/// * [TARGETING_STRATEGY] 
@BuiltValue()
abstract class TargetingSpecOptimal implements Built<TargetingSpecOptimal, TargetingSpecOptimalBuilder> {
  ...
  BuiltList<TargetingStrategy>? get TARGETING_STRATEGY;

  TargetingSpecOptimal._();

  factory TargetingSpecOptimal([void updates(TargetingSpecOptimalBuilder b)]) = _$TargetingSpecOptimal;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(TargetingSpecOptimalBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<TargetingSpecOptimal> get serializer => _$TargetingSpecOptimalSerializer();
}

class _$TargetingSpecOptimalSerializer implements PrimitiveSerializer<TargetingSpecOptimal> {
  @override
  final Iterable<Type> types = const [TargetingSpecOptimal, _$TargetingSpecOptimal];

  @override
  final String wireName = r'TargetingSpecOptimal';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    TargetingSpecOptimal object, {
    ...
    if (object.TARGETING_STRATEGY != null) {
      ...
      yield serializers.serialize(
        ...
        specifiedType: const FullType.nullable(BuiltList, [FullType(TargetingStrategy)]),
      );
    }
  }
  ...
  void _deserializeProperties(
    ...
    required TargetingSpecOptimalBuilder result,
      ...
      switch (key) {
        ...
        case r'TARGETING_STRATEGY':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType.nullable(BuiltList, [FullType(TargetingStrategy)]),
          ) as BuiltList<TargetingStrategy>?;
          if (valueDes == null) continue;
  ...
  @override
  TargetingSpecOptimal deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = TargetingSpecOptimalBuilder();
