...
abstract class AdGroupBase  {
  ...
  ConversionLearningModeType? get conversionLearningModeType;
  ...
  static Serializer<AdGroupBase> get serializer => _$AdGroupBaseSerializer();
}

class _$AdGroupBaseSerializer implements PrimitiveSerializer<AdGroupBase> {
  @override
  final Iterable<Type> types = const [AdGroupBase];

  @override
  final String wireName = r'AdGroupBase';
  ...
  @override
  AdGroupBase deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    return serializers.deserialize(serialized, specifiedType: FullType($AdGroupBase)) as $AdGroupBase;
  }
}

/// a concrete implementation of [AdGroupBase], since [AdGroupBase] is not instantiable
@BuiltValue(instantiable: true)
abstract class $AdGroupBase implements AdGroupBase, Built<$AdGroupBase, $AdGroupBaseBuilder> {
  $AdGroupBase._();

  factory $AdGroupBase([void Function($AdGroupBaseBuilder)? updates]) = _$$AdGroupBase;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults($AdGroupBaseBuilder b) => b;
...
class _$$AdGroupBaseSerializer implements PrimitiveSerializer<$AdGroupBase> {
  @override
  final Iterable<Type> types = const [$AdGroupBase, _$$AdGroupBase];
  ...
  Object serialize(
    ...
    return serializers.serialize(object, specifiedType: FullType(AdGroupBase))!;
  }
  ...
  void _deserializeProperties(
    ...
    required AdGroupBaseBuilder result,
  ...
  $AdGroupBase deserialize(
    ...
    final result = $AdGroupBaseBuilder();
