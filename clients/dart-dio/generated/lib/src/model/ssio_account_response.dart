...
part 'ssio_account_response.g.dart';
...
/// * [pmpNames] 
@BuiltValue()
abstract class SSIOAccountResponse implements Built<SSIOAccountResponse, SSIOAccountResponseBuilder> {
  ...
  SSIOAccountResponse._();

  factory SSIOAccountResponse([void updates(SSIOAccountResponseBuilder b)]) = _$SSIOAccountResponse;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(SSIOAccountResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<SSIOAccountResponse> get serializer => _$SSIOAccountResponseSerializer();
}

class _$SSIOAccountResponseSerializer implements PrimitiveSerializer<SSIOAccountResponse> {
  @override
  final Iterable<Type> types = const [SSIOAccountResponse, _$SSIOAccountResponse];

  @override
  final String wireName = r'SSIOAccountResponse';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    SSIOAccountResponse object, {
  ...
  void _deserializeProperties(
    ...
    required SSIOAccountResponseBuilder result,
  ...
  @override
  SSIOAccountResponse deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = SSIOAccountResponseBuilder();
