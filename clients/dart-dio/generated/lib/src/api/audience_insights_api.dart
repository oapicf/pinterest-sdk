...
class AudienceInsightsApi {
  ...
  Future<Response<AudienceInsightsResponse>> audienceInsightsGet({ 
    ...
    final _path = r'/ad_accounts/{ad_account_id}/audience_insights'.replaceAll('{' r'ad_account_id' '}', encodeQueryParameter(_serializers, adAccountId, const FullType(String)).toString());
    ...
    final _queryParameters = <String, dynamic>{
      r'audience_insight_type': encodeQueryParameter(_serializers, audienceInsightType, const FullType(AudienceInsightType)),
    };
  ...
  Future<Response<AudienceDefinitionResponse>> audienceInsightsScopeAndTypeGet({ 
    ...
    final _path = r'/ad_accounts/{ad_account_id}/insights/audiences'.replaceAll('{' r'ad_account_id' '}', encodeQueryParameter(_serializers, adAccountId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
