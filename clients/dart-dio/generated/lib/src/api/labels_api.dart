...
import 'package:openapi/src/model/labeled_entities.dart';
import 'package:openapi/src/model/labeled_entities_create.dart';
...
import 'package:openapi/src/model/query_label_entity_statuses_items.dart';
import 'package:openapi/src/model/query_label_types_items.dart';
...
class LabelsApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [LabeledEntities] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<LabeledEntities>> labelsApply({ 
    required String adAccountId,
    required String labelId,
    required LabeledEntitiesCreate labeledEntitiesCreate,
    ...
    final _path = r'/ad_accounts/{ad_account_id}/labels/{label_id}/apply'.replaceAll('{' r'ad_account_id' '}', encodeQueryParameter(_serializers, adAccountId, const FullType(String)).toString()).replaceAll('{' r'label_id' '}', encodeQueryParameter(_serializers, labelId, const FullType(String)).toString());
    ...
    try {
      const _type = FullType(LabeledEntitiesCreate);
      _bodyData = _serializers.serialize(labeledEntitiesCreate, specifiedType: _type);
    ...
    LabeledEntities? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(LabeledEntities),
      ) as LabeledEntities;
    ...
    return Response<LabeledEntities>(
      data: _responseData,
  ...
  Future<Response<LabelsList200Response>> labelsList({ 
    ...
    BuiltList<QueryLabelEntityStatusesItems>? entityStatuses,
    BuiltList<QueryLabelTypesItems>? labelTypes,
    String? bookmark,
    int? pageSize = 25,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (entityStatuses != null) r'entity_statuses': encodeCollectionQueryParameter<QueryLabelEntityStatusesItems>(_serializers, entityStatuses, const FullType(BuiltList, [FullType(QueryLabelEntityStatusesItems)]), format: ListFormat.multi,),
      if (labelTypes != null) r'label_types': encodeCollectionQueryParameter<QueryLabelTypesItems>(_serializers, labelTypes, const FullType(BuiltList, [FullType(QueryLabelTypesItems)]), format: ListFormat.multi,),
  ...
  /// Returns a [Future] containing a [Response] with a [LabeledEntities] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<LabeledEntities>> labelsRemove({ 
    required String adAccountId,
    required String labelId,
    required LabeledEntitiesCreate labeledEntitiesCreate,
    CancelToken? cancelToken,
    ...
    final _path = r'/ad_accounts/{ad_account_id}/labels/{label_id}/remove'.replaceAll('{' r'ad_account_id' '}', encodeQueryParameter(_serializers, adAccountId, const FullType(String)).toString()).replaceAll('{' r'label_id' '}', encodeQueryParameter(_serializers, labelId, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
