...
class BoardsApi {
  ...
  Future<Response<BoardSection>> boardSectionsCreate({ 
    ...
    final _path = r'/boards/{board_id}/sections'.replaceAll('{' r'board_id' '}', encodeQueryParameter(_serializers, boardId, const FullType(String)).toString());
  ...
  Future<Response<BoardSection>> boardSectionsDelete({ 
    ...
    final _path = r'/boards/{board_id}/sections/{section_id}'.replaceAll('{' r'board_id' '}', encodeQueryParameter(_serializers, boardId, const FullType(String)).toString()).replaceAll('{' r'section_id' '}', encodeQueryParameter(_serializers, sectionId, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BoardSectionsList200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BoardSectionsList200Response>> boardSectionsList({ 
    required String boardId,
    String? adAccountId,
    String? bookmark,
    int? pageSize = 25,
    ...
    BoardSectionsList200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(BoardSectionsList200Response),
    ...
    return Response<BoardSectionsList200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BoardsListPins200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BoardsListPins200Response>> boardSectionsListPins({ 
    required String boardId,
    required String sectionId,
    String? adAccountId,
    String? bookmark,
    ...
    final _path = r'/boards/{board_id}/sections/{section_id}/pins'.replaceAll('{' r'board_id' '}', encodeQueryParameter(_serializers, boardId, const FullType(String)).toString()).replaceAll('{' r'section_id' '}', encodeQueryParameter(_serializers, sectionId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    BoardsListPins200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(BoardsListPins200Response),
    ...
    return Response<BoardsListPins200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Board>> boardsCreate({ 
    required BoardCreate boardCreate,
    String? adAccountId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    try {
      const _type = FullType(BoardCreate);
      _bodyData = _serializers.serialize(boardCreate, specifiedType: _type);
  ...
  Future<Response<Board>> boardsDelete({ 
    ...
    final _path = r'/boards/{board_id}'.replaceAll('{' r'board_id' '}', encodeQueryParameter(_serializers, boardId, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [Board] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Board>> boardsGet({ 
    required String boardId,
    String? adAccountId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BoardsList200Response>> boardsList({ 
    String? adAccountId,
    ...
    final _queryParameters = <String, dynamic>{
      if (adAccountId != null) r'ad_account_id': encodeQueryParameter(_serializers, adAccountId, const FullType(String)),
      if (privacy != null) r'privacy': encodeQueryParameter(_serializers, privacy, const FullType(BoardPrivacyFilter)),
      if (bookmark != null) r'bookmark': encodeQueryParameter(_serializers, bookmark, const FullType(String)),
      if (pageSize != null) r'page_size': encodeQueryParameter(_serializers, pageSize, const FullType(int)),
    };
  ...
  Future<Response<BoardsListPins200Response>> boardsListPins({ 
    ...
    final _path = r'/boards/{board_id}/pins'.replaceAll('{' r'board_id' '}', encodeQueryParameter(_serializers, boardId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BoardWithUpdatePrivacy] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BoardWithUpdatePrivacy>> boardsUpdate({ 
    required String boardId,
    required BoardWithUpdatePrivacyUpdate boardWithUpdatePrivacyUpdate,
    String? adAccountId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    try {
      const _type = FullType(BoardWithUpdatePrivacyUpdate);
      _bodyData = _serializers.serialize(boardWithUpdatePrivacyUpdate, specifiedType: _type);
    ...
    BoardWithUpdatePrivacy? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(BoardWithUpdatePrivacy),
    ...
    return Response<BoardWithUpdatePrivacy>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
