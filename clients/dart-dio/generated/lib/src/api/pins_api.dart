...
import 'package:openapi/src/model/multi_pins_analytics_metric_types_item.dart';
...
import 'package:openapi/src/model/pin_filter.dart';
import 'package:openapi/src/model/pin_type.dart';
import 'package:openapi/src/model/pin_update.dart';
import 'package:openapi/src/model/pins_list200_response.dart';
import 'package:openapi/src/model/pins_save_request_create.dart';
import 'package:openapi/src/model/pinterest_lib_error.dart';
import 'package:openapi/src/model/querypinanalyticsmetrictypes_items.dart';
...
class PinsApi {
  ...
  Future<Response<BuiltMap<String, BuiltMap<String, PinAnalyticsMetricsResponse>>>> multiPinsAnalytics({ 
    ...
    required BuiltList<MultiPinsAnalyticsMetricTypesItem> metricTypes,
    String? appTypes = 'ALL',
    String? adAccountId,
    ...
    final _queryParameters = <String, dynamic>{
      ...
      r'metric_types': encodeCollectionQueryParameter<MultiPinsAnalyticsMetricTypesItem>(_serializers, metricTypes, const FullType(BuiltList, [FullType(MultiPinsAnalyticsMetricTypesItem)]), format: ListFormat.csv,),
  ...
  Future<Response<BuiltMap<String, PinAnalyticsMetricsResponse>>> pinsAnalytics({ 
    ...
    required Date startDate,
    required Date endDate,
    required BuiltList<QuerypinanalyticsmetrictypesItems> metricTypes,
    String? appTypes = 'ALL',
    ...
    final _queryParameters = <String, dynamic>{
      ...
      r'end_date': encodeQueryParameter(_serializers, endDate, const FullType(Date)),
      if (appTypes != null) r'app_types': encodeQueryParameter(_serializers, appTypes, const FullType(String)),
      r'metric_types': encodeCollectionQueryParameter<QuerypinanalyticsmetrictypesItems>(_serializers, metricTypes, const FullType(BuiltList, [FullType(QuerypinanalyticsmetrictypesItems)]), format: ListFormat.csv,),
  ...
  /// Returns a [Future] containing a [Response] with a [Pin] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Pin>> pinsDelete({ 
    required String pinId,
    String? adAccountId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
  ...
  /// * [domains] - Only return pins with links whose domain matches any value in the list. Values are joined comma-separated on the wire (e.g. `?domains=instagram.com,jcpenney.com`).
  /// * [includeProductTagObj] - Include product tag objects in the response with their associated links.
  ...
  Future<Response<PinsList200Response>> pinsList({ 
    ...
    final _queryParameters = <String, dynamic>{
      if (pinFilter != null) r'pin_filter': encodeQueryParameter(_serializers, pinFilter, const FullType(PinFilter)),
      if (pinMetrics != null) r'pin_metrics': encodeQueryParameter(_serializers, pinMetrics, const FullType(bool)),
      ...
      if (pinType != null) r'pin_type': encodeQueryParameter(_serializers, pinType, const FullType(PinType)),
      ...
      if (includeProductTagObj != null) r'include_product_tag_obj': encodeQueryParameter(_serializers, includeProductTagObj, const FullType(bool)),
  ...
  Future<Response<Pin>> pinsSave({ 
    required String pinId,
    required PinsSaveRequestCreate pinsSaveRequestCreate,
    String? adAccountId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    try {
      const _type = FullType(PinsSaveRequestCreate);
      _bodyData = _serializers.serialize(pinsSaveRequestCreate, specifiedType: _type);
