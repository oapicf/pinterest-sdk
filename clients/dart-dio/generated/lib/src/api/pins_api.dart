...
import 'package:openapi/src/model/pin_analytics_metrics_response.dart';
import 'package:openapi/src/model/pin_create.dart';
import 'package:openapi/src/model/pin_update.dart';
import 'package:openapi/src/model/pins_list200_response.dart';
import 'package:openapi/src/model/pins_save_request.dart';
...
class PinsApi {
  ...
  const PinsApi(this._dio, this._serializers);
  ...
  /// * [metricTypes] - Pin metric types to get data for.
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltMap<String, BuiltMap<String, PinAnalyticsMetricsResponse>>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltMap<String, BuiltMap<String, PinAnalyticsMetricsResponse>>>> multiPinsAnalytics({ 
    required BuiltList<String> pinIds,
    required Date startDate,
    required Date endDate,
    required BuiltList<String> metricTypes,
    String? appTypes = 'ALL',
    String? adAccountId,
    ...
    final _queryParameters = <String, dynamic>{
      ...
      r'metric_types': encodeCollectionQueryParameter<String>(_serializers, metricTypes, const FullType(BuiltList, [FullType(String)]), format: ListFormat.csv,),
    ...
    BuiltMap<String, BuiltMap<String, PinAnalyticsMetricsResponse>>? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(BuiltMap, [FullType(String), FullType(BuiltMap)]),
      ) as BuiltMap<String, BuiltMap<String, PinAnalyticsMetricsResponse>>;
    ...
    return Response<BuiltMap<String, BuiltMap<String, PinAnalyticsMetricsResponse>>>(
      data: _responseData,
  ...
  ///
  /// Parameters:
  /// * [pinId] - Unique identifier of a Pin.
  /// * [startDate] - Metric report start date (UTC). Format: YYYY-MM-DD. Cannot be more than 90 days back from today.
  /// * [endDate] - Metric report end date (UTC). Format: YYYY-MM-DD. Cannot be more than 90 days past start_date.
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltMap<String, PinAnalyticsMetricsResponse>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltMap<String, PinAnalyticsMetricsResponse>>> pinsAnalytics({ 
    ...
    final _path = r'/pins/{pin_id}/analytics'.replaceAll('{' r'pin_id' '}', encodeQueryParameter(_serializers, pinId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    BuiltMap<String, PinAnalyticsMetricsResponse>? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(BuiltMap, [FullType(String), FullType(PinAnalyticsMetricsResponse)]),
      ) as BuiltMap<String, PinAnalyticsMetricsResponse>;
    ...
    return Response<BuiltMap<String, PinAnalyticsMetricsResponse>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [Pin] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Pin>> pinsCreate({ 
    required PinCreate pinCreate,
    String? adAccountId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    try {
      const _type = FullType(PinCreate);
      _bodyData = _serializers.serialize(pinCreate, specifiedType: _type);
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> pinsDelete({ 
    required String pinId,
    String? adAccountId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/pins/{pin_id}'.replaceAll('{' r'pin_id' '}', encodeQueryParameter(_serializers, pinId, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  ///
  /// Parameters:
  /// * [pinFilter] - The filter to apply to the pins
  /// * [pinMetrics] - Specify whether to return 90d and lifetime Pin metrics. Total comments and total reactions are only available with lifetime Pin metrics. If Pin was created before `2023-03-20` lifetime metrics will only be available for Video and Idea Pin formats. Lifetime metrics are available for all Pin formats since then.
  /// * [includeProtectedPins] - Whether to include protected pins in the results
  /// * [pinType] - The type of pins to return, currently only enabled for private pins
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PinsList200Response>> pinsList({ 
    String? pinFilter,
    bool? pinMetrics = false,
    bool? includeProtectedPins = false,
    String? pinType,
    ...
    final _queryParameters = <String, dynamic>{
      if (pinFilter != null) r'pin_filter': encodeQueryParameter(_serializers, pinFilter, const FullType(String)),
      if (pinMetrics != null) r'pin_metrics': encodeQueryParameter(_serializers, pinMetrics, const FullType(bool)),
      if (includeProtectedPins != null) r'include_protected_pins': encodeQueryParameter(_serializers, includeProtectedPins, const FullType(bool)),
      if (pinType != null) r'pin_type': encodeQueryParameter(_serializers, pinType, const FullType(String)),
  ...
  /// Returns a [Future] containing a [Response] with a [Pin] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Pin>> pinsSave({ 
    required String pinId,
    required PinsSaveRequest pinsSaveRequest,
    String? adAccountId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/pins/{pin_id}/save'.replaceAll('{' r'pin_id' '}', encodeQueryParameter(_serializers, pinId, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(PinsSaveRequest);
      _bodyData = _serializers.serialize(pinsSaveRequest, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [Pin] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Pin>> pinsUpdate({ 
    required String pinId,
    required PinUpdate pinUpdate,
    String? adAccountId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    try {
      const _type = FullType(PinUpdate);
      _bodyData = _serializers.serialize(pinUpdate, specifiedType: _type);
