...
class LeadFormsApi {
  ...
  Future<Response<LeadFormTestResponse>> leadFormTestCreate({ 
    ...
    final _path = r'/ad_accounts/{ad_account_id}/lead_forms/{lead_form_id}/test'.replaceAll('{' r'ad_account_id' '}', encodeQueryParameter(_serializers, adAccountId, const FullType(String)).toString()).replaceAll('{' r'lead_form_id' '}', encodeQueryParameter(_serializers, leadFormId, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<LeadFormArrayResponse>> leadFormsCreate({ 
    ...
    final _path = r'/ad_accounts/{ad_account_id}/lead_forms'.replaceAll('{' r'ad_account_id' '}', encodeQueryParameter(_serializers, adAccountId, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [LeadFormsList200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<LeadFormsList200Response>> leadFormsList({ 
    ...
    LeadFormsList200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(LeadFormsList200Response),
    ...
    return Response<LeadFormsList200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
