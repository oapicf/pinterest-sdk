...
class OauthApi {
  ...
  Future<Response<ConversionAccessToken>> oauthConversionToken({ 
    ...
    final _path = r'/oauth/conversion_token';
  ...
  /// * [tokenTypeHint] - The type of the token to revoke. Please refer to [our developer guide for more information](https://developers.pinterest.com/docs/getting-started/set-up-authentication-and-authorization/) for more information.
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<void>> tokenRevoke({ 
    ...
    final _path = r'/oauth/token/revoke';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
