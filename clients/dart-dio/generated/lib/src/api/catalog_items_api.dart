...
class CatalogItemsApi {
  ...
  Future<Response<CatalogsItemsBatch>> itemsBatchGet({ 
    ...
    final _path = r'/catalogs/items/batch/{batch_id}'.replaceAll('{' r'batch_id' '}', encodeQueryParameter(_serializers, batchId, const FullType(String)).toString());
    ...
    CatalogsItemsBatch? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(CatalogsItemsBatch),
    ...
    return Response<CatalogsItemsBatch>(
      data: _responseData,
  ...
  Future<Response<CatalogsItemsBatch>> itemsBatchPost({ 
    ...
    final _path = r'/catalogs/items/batch';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<CatalogsItems>> itemsPost({ 
    ...
    try {
      const _type = FullType(CatalogsItemsRequest);
      _bodyData = _serializers.serialize(catalogsItemsRequest, specifiedType: _type);
