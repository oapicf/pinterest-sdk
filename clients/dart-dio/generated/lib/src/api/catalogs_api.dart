...
import 'package:openapi/src/model/catalogs_create_request.dart';
...
class CatalogsApi {
  ...
  Future<Response<Catalog>> catalogsCreate({ 
    required CatalogsCreateRequest catalogsCreateRequest,
    String? adAccountId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    try {
      const _type = FullType(CatalogsCreateRequest);
      _bodyData = _serializers.serialize(catalogsCreateRequest, specifiedType: _type);
