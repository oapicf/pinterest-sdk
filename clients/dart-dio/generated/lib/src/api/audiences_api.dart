...
import 'package:openapi/src/model/ad_accounts_audience_create.dart';
import 'package:openapi/src/model/ad_accounts_audience_update.dart';
import 'package:openapi/src/model/audience_ownership_type.dart';
...
class AudiencesApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [AdAccountsAudience] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AdAccountsAudience>> audiencesCreate({ 
    required String adAccountId,
    required AdAccountsAudienceCreate adAccountsAudienceCreate,
    ...
    try {
      const _type = FullType(AdAccountsAudienceCreate);
      _bodyData = _serializers.serialize(adAccountsAudienceCreate, specifiedType: _type);
    ...
    AdAccountsAudience? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(AdAccountsAudience),
      ) as AdAccountsAudience;
    ...
    return Response<AdAccountsAudience>(
      data: _responseData,
  ...
  /// Returns a [Future] containing a [Response] with a [AdAccountsAudience] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AdAccountsAudience>> audiencesGet({ 
    ...
    final _path = r'/ad_accounts/{ad_account_id}/audiences/{audience_id}'.replaceAll('{' r'audience_id' '}', encodeQueryParameter(_serializers, audienceId, const FullType(String)).toString()).replaceAll('{' r'ad_account_id' '}', encodeQueryParameter(_serializers, adAccountId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [ownershipType] 
  /// * [excludeNca] - When true, excludes audiences derived from new customer acquisition (expanded matching) customer lists from the result. Defaults to false (include all).
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<AudiencesList200Response>> audiencesList({ 
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (ownershipType != null) r'ownership_type': encodeQueryParameter(_serializers, ownershipType, const FullType(AudienceOwnershipType)),
  ...
  /// Returns a [Future] containing a [Response] with a [AdAccountsAudience] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AdAccountsAudience>> audiencesUpdate({ 
    required String audienceId,
    required String adAccountId,
    required AdAccountsAudienceUpdate adAccountsAudienceUpdate,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(AdAccountsAudienceUpdate);
      _bodyData = _serializers.serialize(adAccountsAudienceUpdate, specifiedType: _type);
