...
class BulkApi {
  ...
  Future<Response<BulkDownloadResponse>> bulkDownloadCreate({ 
    ...
    final _path = r'/ad_accounts/{ad_account_id}/bulk/download'.replaceAll('{' r'ad_account_id' '}', encodeQueryParameter(_serializers, adAccountId, const FullType(String)).toString());
  ...
  Future<Response<BulkUpsertStatusResponse>> bulkRequestGet({ 
    ...
    final _path = r'/ad_accounts/{ad_account_id}/bulk/{bulk_request_id}'.replaceAll('{' r'ad_account_id' '}', encodeQueryParameter(_serializers, adAccountId, const FullType(String)).toString()).replaceAll('{' r'bulk_request_id' '}', encodeQueryParameter(_serializers, bulkRequestId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    final _queryParameters = <String, dynamic>{
      if (includeDetails != null) r'include_details': encodeQueryParameter(_serializers, includeDetails, const FullType(bool)),
    };
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BulkUpsertResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BulkUpsertResponse>> bulkUpsertCreate({ 
    required String adAccountId,
    required BulkUpsertRequest bulkUpsertRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/ad_accounts/{ad_account_id}/bulk/upsert'.replaceAll('{' r'ad_account_id' '}', encodeQueryParameter(_serializers, adAccountId, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(BulkUpsertRequest);
      _bodyData = _serializers.serialize(bulkUpsertRequest, specifiedType: _type);
    ...
    BulkUpsertResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(BulkUpsertResponse),
    ...
    return Response<BulkUpsertResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
