...
import 'package:openapi/src/model/customer_segment_create.dart';
import 'package:openapi/src/model/customer_segment_list200_response.dart';
import 'package:openapi/src/model/customer_segment_update_request_update_with_required_body.dart';
...
class CustomerSegmentApi {
  ...
  const CustomerSegmentApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [CustomerSegment] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CustomerSegment>> customerSegmentCreate({ 
    required String adAccountId,
    required CustomerSegmentCreate customerSegmentCreate,
    ...
    final _path = r'/ad_accounts/{ad_account_id}/customer_segments'.replaceAll('{' r'ad_account_id' '}', encodeQueryParameter(_serializers, adAccountId, const FullType(String)).toString());
    ...
    try {
      const _type = FullType(CustomerSegmentCreate);
      _bodyData = _serializers.serialize(customerSegmentCreate, specifiedType: _type);
    ...
    CustomerSegment? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(CustomerSegment),
      ) as CustomerSegment;
    ...
    return Response<CustomerSegment>(
      data: _responseData,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [CustomerSegmentList200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CustomerSegmentList200Response>> customerSegmentList({ 
    required String adAccountId,
    String? bookmark,
    int? pageSize = 25,
    ...
    CustomerSegmentList200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(CustomerSegmentList200Response),
      ) as CustomerSegmentList200Response;
    ...
    return Response<CustomerSegmentList200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> customerSegmentUpdate({ 
    required String adAccountId,
    required CustomerSegmentUpdateRequestUpdateWithRequiredBody customerSegmentUpdateRequestUpdateWithRequiredBody,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(CustomerSegmentUpdateRequestUpdateWithRequiredBody);
      _bodyData = _serializers.serialize(customerSegmentUpdateRequestUpdateWithRequiredBody, specifiedType: _type);
