...
class MsotEventsApi {
  ...
  Future<Response<void>> msotEventsCreate({ 
    ...
    final _path = r'/ad_accounts/{ad_account_id}/msot/events'.replaceAll('{' r'ad_account_id' '}', encodeQueryParameter(_serializers, adAccountId, const FullType(String)).toString());
