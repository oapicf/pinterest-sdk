...
import 'package:openapi/src/model/trends_editorial.dart';
...
class TrendsApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<TrendsEditorial>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<TrendsEditorial>>> trendsEditorialArticlesList({ 
    ...
    final _path = r'/trends/editorial_articles';
    ...
    BuiltList<TrendsEditorial>? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(BuiltList, [FullType(TrendsEditorial)]),
      ) as BuiltList<TrendsEditorial>;
    ...
    return Response<BuiltList<TrendsEditorial>>(
      data: _responseData,
