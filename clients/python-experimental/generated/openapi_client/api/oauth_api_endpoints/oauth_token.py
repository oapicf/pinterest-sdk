...
# body param
SchemaForRequestBodyApplicationXWwwFormUrlencoded = OauthAccessTokenRequest
...
_path = '/oauth/token'
_method = 'POST'
SchemaFor200ResponseBodyApplicationJson = OauthAccessTokenResponse
...
class OauthToken(api_client.Api):
