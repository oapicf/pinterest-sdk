...
class FromClaimedContentSchema(
    ...
    @property
    def BOTH(cls):
        return cls._enum_by_value["BOTH"]("BOTH")
...
class PinFormatSchema(
    ...
    @property
    def PRODUCT(cls):
        return cls._enum_by_value["PRODUCT"]("PRODUCT")
...
class MetricTypesSchema(
    ...
    class _items(
        ...
        def OUTBOUND_CLICK_RATE(cls):
            return cls._enum_by_value["OUTBOUND_CLICK_RATE"]("OUTBOUND_CLICK_RATE")
        ...
        def PIN_CLICK_RATE(cls):
            return cls._enum_by_value["PIN_CLICK_RATE"]("PIN_CLICK_RATE")
        ...
        @property
        def SAVE_RATE(cls):
            return cls._enum_by_value["SAVE_RATE"]("SAVE_RATE")
...
class SplitFieldSchema(
    ...
    def OWNED_CONTENT(cls):
        return cls._enum_by_value["OWNED_CONTENT"]("OWNED_CONTENT")
    
    @classmethod
    @property
    def PIN_FORMAT(cls):
        return cls._enum_by_value["PIN_FORMAT"]("PIN_FORMAT")
...
RequestOptionalQueryParams = typing.TypedDict(
    ...
    {
        'from_claimed_content': FromClaimedContentSchema,
        'pin_format': PinFormatSchema,
...
class UserAccountAnalytics(api_client.Api):
