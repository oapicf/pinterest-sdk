...
{ 
    ...
    public partial class CatalogsFeedProcessingResult : IEquatable<CatalogsFeedProcessingResult>
    {
        ...
        /// </summary>
        [DataMember(Name="video_counts", EmitDefaultValue=false)]
        ...
        public bool Equals(CatalogsFeedProcessingResult other)
        {
            ...
            return 
                ...
                (
                    VideoCounts == other.VideoCounts ||
                    VideoCounts != null &&
                    VideoCounts.Equals(other.VideoCounts)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (VideoCounts != null)
                    hashCode = hashCode * 59 + VideoCounts.GetHashCode();
                return hashCode;
            }
        }
