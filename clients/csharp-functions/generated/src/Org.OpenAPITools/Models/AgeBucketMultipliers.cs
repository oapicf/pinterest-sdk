...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class AgeBucketMultipliers : IEquatable<AgeBucketMultipliers>
    {
        /// <summary>
        /// Age bucket identifier.
        /// </summary>
        /// <value>Age bucket identifier.</value>
        [DataMember(Name="AGE_BUCKET", EmitDefaultValue=false)]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((AgeBucketMultipliers)obj);
        }

        /// <summary>
        /// Returns true if AgeBucketMultipliers instances are equal
        /// </summary>
        /// <param name="other">Instance of AgeBucketMultipliers to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AgeBucketMultipliers other)
        {
        ...
        public static bool operator ==(AgeBucketMultipliers left, AgeBucketMultipliers right)
        {
