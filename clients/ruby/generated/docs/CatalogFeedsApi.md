...
> <CatalogsFeed> feeds_create(catalogs_feed_create_request_schema, opts)
...
api_instance = PinterestSdkClient::CatalogFeedsApi.new
catalogs_feed_create_request_schema = PinterestSdkClient::CatalogsFeedsCreateRequest.new({format: PinterestSdkClient::CatalogsFormat::TSV, location: 'location_example', name: 'name_example'}) # CatalogsFeedCreateRequestSchema | 
opts = {
  ad_account_id: 'ad_account_id_example' # String | Unique identifier of an ad account.
}
...
begin
  # Create feed
  result = api_instance.feeds_create(catalogs_feed_create_request_schema, opts)
  p result
rescue PinterestSdkClient::ApiError => e
...
> <Array(<CatalogsFeed>, Integer, Hash)> feeds_create_with_http_info(catalogs_feed_create_request_schema, opts)

```ruby
begin
  # Create feed
  data, status_code, headers = api_instance.feeds_create_with_http_info(catalogs_feed_create_request_schema, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <CatalogsFeed>
rescue PinterestSdkClient::ApiError => e
...
> <CatalogsFeed> feeds_delete(feed_id, opts)
...
begin
  # Delete feed
  result = api_instance.feeds_delete(feed_id, opts)
  p result
rescue PinterestSdkClient::ApiError => e
...
> <Array(<CatalogsFeed>, Integer, Hash)> feeds_delete_with_http_info(feed_id, opts)
...
> <CatalogsFeed> feeds_update(feed_id, catalogs_feed_update_request_schema, opts)
...
api_instance = PinterestSdkClient::CatalogFeedsApi.new
feed_id = 'feed_id_example' # String | Unique identifier of a feed.
catalogs_feed_update_request_schema = PinterestSdkClient::CatalogsFeedsUpdateRequest.new # CatalogsFeedUpdateRequestSchema | 
opts = {
  ad_account_id: 'ad_account_id_example' # String | Unique identifier of an ad account.
}
...
begin
  # Update feed
  result = api_instance.feeds_update(feed_id, catalogs_feed_update_request_schema, opts)
  p result
rescue PinterestSdkClient::ApiError => e
...
> <Array(<CatalogsFeed>, Integer, Hash)> feeds_update_with_http_info(feed_id, catalogs_feed_update_request_schema, opts)

```ruby
begin
  # Update feed
  data, status_code, headers = api_instance.feeds_update_with_http_info(feed_id, catalogs_feed_update_request_schema, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <CatalogsFeed>
rescue PinterestSdkClient::ApiError => e
