# PinterestSdkClient::ProductCategoriesApi
...
begin
  ...
  puts "Error when calling ProductCategoriesApi->trends_featured_topics_list: #{e}"
end
```
...
begin
  ...
  puts "Error when calling ProductCategoriesApi->trends_featured_topics_list_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling ProductCategoriesApi->trends_product_categories_details_list: #{e}"
end
```
...
begin
  ...
  puts "Error when calling ProductCategoriesApi->trends_product_categories_details_list_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling ProductCategoriesApi->trends_product_categories_trending_list: #{e}"
end
```
...
begin
  ...
  puts "Error when calling ProductCategoriesApi->trends_product_categories_trending_list_with_http_info: #{e}"
end
```
