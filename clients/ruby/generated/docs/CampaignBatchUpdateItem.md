# PinterestSdkClient::CampaignBatchUpdateItem

## Properties

| Name | Type | Description | Notes |
| ---- | ---- | ----------- | ----- |
| **ad_account_id** | **String** | Setting this field does nothing. The ad account ID gets set from the path parameter. | [optional] |
| **app_id** | **String** | [Closed beta](/docs/getting-started/using-beta-and-restricted-features/)  The store ID of the mobile app for &#x60;APP_INSTALL&#x60; campaigns. | [optional] |
...
instance = PinterestSdkClient::CampaignBatchUpdateItem.new(
