...
# Unit tests for PinterestSdkClient::AdCreateRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe PinterestSdkClient::AdCreateRequest do
  let(:instance) { PinterestSdkClient::AdCreateRequest.new }

  describe 'test an instance of AdCreateRequest' do
    it 'should create an instance of AdCreateRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(PinterestSdkClient::AdCreateRequest)
    end
  end
