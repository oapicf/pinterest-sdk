...
# Unit tests for PinterestSdkClient::AdUpdateRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe PinterestSdkClient::AdUpdateRequest do
  let(:instance) { PinterestSdkClient::AdUpdateRequest.new }

  describe 'test an instance of AdUpdateRequest' do
    it 'should create an instance of AdUpdateRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(PinterestSdkClient::AdUpdateRequest)
    end
  end
