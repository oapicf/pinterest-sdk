...
# Unit tests for PinterestSdkClient::AdGroupResponseAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe PinterestSdkClient::AdGroupResponseAllOf do
  let(:instance) { PinterestSdkClient::AdGroupResponseAllOf.new }

  describe 'test an instance of AdGroupResponseAllOf' do
    it 'should create an instance of AdGroupResponseAllOf' do
      expect(instance).to be_instance_of(PinterestSdkClient::AdGroupResponseAllOf)
    end
  end
