...
module PinterestSdkClient
  class AdAccountsApi
    ...
    def ad_account_analytics(start_date, end_date, columns, granularity, ad_account_id, opts = {})
      data, _status_code, _headers = ad_account_analytics_with_http_info(start_date, end_date, columns, granularity, ad_account_id, opts)
      data
    end
    ...
    # @option opts [String] :conversion_report_time The date by which the conversion metrics returned from this endpoint will be reported. There are two dates associated with a conversion event: the date that the user interacted with the ad, and the date that the user completed a conversion event. (default to 'TIME_OF_AD_ACTION')
    # @option opts [ReportingTimeZone] :reporting_timezone Specify the timezone to be applied for the reporting. This feature is currently in BETA and is not available to all users.
    # @return [Array<(Array<AdAccountAnalyticsItems>, Integer, Hash)>] Array<AdAccountAnalyticsItems> data, response status code and response headers
    def ad_account_analytics_with_http_info(start_date, end_date, columns, granularity, ad_account_id, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'Array<AdAccountAnalyticsItems>'
    ...
    # @param start_date [Date] Metric report start date (UTC). Format: YYYY-MM-DD. Cannot be more than 90 days back from today.
    # @param end_date [Date] Metric report end date (UTC). Format: YYYY-MM-DD. Cannot be more than 90 days past start_date.
    # @param targeting_types [Array<AdsAnalyticsAccountTargetingType>] Targeting type breakdowns for the report. The reporting per targeting type is independent from each other. [\&quot;AGE_BUCKET_AND_GENDER\&quot;] is in BETA and not yet available to all users.
    # @param columns [Array<ReportingColumnSync>] Columns to retrieve, encoded as a comma-separated string. **NOTE**: Any metrics defined as MICRO_DOLLARS returns a value based on the advertiser profile&#39;s currency field. For USD, ($1/1,000,000, or $0.000001 - one one-ten-thousandth of a cent). it&#39;s microdollars. Otherwise, it&#39;s in microunits of the advertiser&#39;s currency.  For example, if the advertiser&#39;s currency is GBP (British pound sterling), all MICRO_DOLLARS fields will be in GBP microunits (1/1,000,000 British pound).  If a column has no value, it may not be returned.
    # @param granularity [Granularity]   TOTAL - metrics are aggregated over the specified date range.    DAY - metrics are broken down daily.    HOUR - metrics are broken down hourly.    WEEK - metrics are broken down weekly.    MONTH - metrics are broken down monthly
    # @param [Hash] opts the optional parameters
    # @option opts [Float] :click_window_days Number of days to use as the conversion attribution window for a pin click action. Applies to Pinterest Tag conversion metrics. Prior conversion tags use their defined attribution windows. If not specified, defaults to &#x60;30&#x60; days. (default to 30)
    ...
    # @param ad_account_id [String] Unique identifier of an ad account.
    # @param conversion_product_report_create [ConversionProductReportCreate] 
    # @param [Hash] opts the optional parameters
    # @return [ConversionProductReport]
    def analytics_create_conversion_product_report(ad_account_id, conversion_product_report_create, opts = {})
      data, _status_code, _headers = analytics_create_conversion_product_report_with_http_info(ad_account_id, conversion_product_report_create, opts)
      data
    end
    ...
    # @param conversion_product_report_create [ConversionProductReportCreate] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(ConversionProductReport, Integer, Hash)>] ConversionProductReport data, response status code and response headers
    def analytics_create_conversion_product_report_with_http_info(ad_account_id, conversion_product_report_create, opts = {})
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && conversion_product_report_create.nil?
        fail ArgumentError, "Missing the required parameter 'conversion_product_report_create' when calling AdAccountsApi.analytics_create_conversion_product_report"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(conversion_product_report_create)

      # return_type
      return_type = opts[:debug_return_type] || 'ConversionProductReport'
    ...
    # @param ad_account_id [String] 
    # @param mmm_report_create [MMMReportCreate] 
    # @param [Hash] opts the optional parameters
    # @return [MMMReport]
    def analytics_create_mmm_report(ad_account_id, mmm_report_create, opts = {})
      data, _status_code, _headers = analytics_create_mmm_report_with_http_info(ad_account_id, mmm_report_create, opts)
      data
    end
    ...
    # @param mmm_report_create [MMMReportCreate] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(MMMReport, Integer, Hash)>] MMMReport data, response status code and response headers
    def analytics_create_mmm_report_with_http_info(ad_account_id, mmm_report_create, opts = {})
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && mmm_report_create.nil?
        fail ArgumentError, "Missing the required parameter 'mmm_report_create' when calling AdAccountsApi.analytics_create_mmm_report"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(mmm_report_create)

      # return_type
      return_type = opts[:debug_return_type] || 'MMMReport'
    ...
    # @option opts [Granularity] :granularity   TOTAL - metrics are aggregated over the specified date range.    DAY - metrics are broken down daily.    HOUR - metrics are broken down hourly.    WEEK - metrics are broken down weekly.    MONTH - metrics are broken down monthly
