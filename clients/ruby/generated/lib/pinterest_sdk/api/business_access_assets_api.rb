...
module PinterestSdkClient
  class BusinessAccessAssetsApi
    ...
    def asset_group_create(business_id, create_asset_group_body, opts = {})
      data, _status_code, _headers = asset_group_create_with_http_info(business_id, create_asset_group_body, opts)
      data
    end
    ...
    def asset_group_create_with_http_info(business_id, create_asset_group_body, opts = {})
      ...
      if @api_client.config.client_side_validation && create_asset_group_body.nil?
        fail ArgumentError, "Missing the required parameter 'create_asset_group_body' when calling BusinessAccessAssetsApi.asset_group_create"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(create_asset_group_body)

      # return_type
      return_type = opts[:debug_return_type] || 'CreateAssetGroupResponse'
    ...
    def asset_group_delete(business_id, delete_asset_group_body, opts = {})
      data, _status_code, _headers = asset_group_delete_with_http_info(business_id, delete_asset_group_body, opts)
      data
    end
    ...
    def asset_group_delete_with_http_info(business_id, delete_asset_group_body, opts = {})
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && delete_asset_group_body.nil?
        fail ArgumentError, "Missing the required parameter 'delete_asset_group_body' when calling BusinessAccessAssetsApi.asset_group_delete"
      end
      # resource path
      local_var_path = '/businesses/{business_id}/asset_groups'.sub('{' + 'business_id' + '}', CGI.escape(business_id.to_s))
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(delete_asset_group_body)

      # return_type
      return_type = opts[:debug_return_type] || 'DeleteAssetGroupResponse'
    ...
    def asset_group_update(business_id, update_asset_group_body, opts = {})
      data, _status_code, _headers = asset_group_update_with_http_info(business_id, update_asset_group_body, opts)
      data
    end
    ...
    def asset_group_update_with_http_info(business_id, update_asset_group_body, opts = {})
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && update_asset_group_body.nil?
        fail ArgumentError, "Missing the required parameter 'update_asset_group_body' when calling BusinessAccessAssetsApi.asset_group_update"
      end
      # resource path
      local_var_path = '/businesses/{business_id}/asset_groups'.sub('{' + 'business_id' + '}', CGI.escape(business_id.to_s))
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(update_asset_group_body)

      # return_type
      return_type = opts[:debug_return_type] || 'UpdateAssetGroupResponse'
    ...
    def business_asset_partners_get_with_http_info(business_id, asset_id, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'BusinessAssetPartnersGet200Response'
    ...
    def business_member_assets_get_with_http_info(business_id, member_id, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'BusinessMemberAssetsGet200Response'
    ...
    def business_members_asset_access_delete(business_id, business_members_asset_access_delete_request, opts = {})
      data, _status_code, _headers = business_members_asset_access_delete_with_http_info(business_id, business_members_asset_access_delete_request, opts)
      data
    end
    ...
    def business_members_asset_access_delete_with_http_info(business_id, business_members_asset_access_delete_request, opts = {})
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && business_members_asset_access_delete_request.nil?
        fail ArgumentError, "Missing the required parameter 'business_members_asset_access_delete_request' when calling BusinessAccessAssetsApi.business_members_asset_access_delete"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(business_members_asset_access_delete_request)
    ...
    def delete_partner_asset_access_handler_impl_with_http_info(business_id, delete_partner_asset_access_body, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'DeletePartnerAssetsResultsResponseArray'
