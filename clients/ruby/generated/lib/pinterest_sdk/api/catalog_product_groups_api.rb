...
module PinterestSdkClient
  class CatalogProductGroupsApi
    ...
    def catalogs_product_groups_create(multiple_product_groups_inner, opts = {})
      data, _status_code, _headers = catalogs_product_groups_create_with_http_info(multiple_product_groups_inner, opts)
      data
    end
    ...
    def catalogs_product_groups_create_with_http_info(multiple_product_groups_inner, opts = {})
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && multiple_product_groups_inner.nil?
        fail ArgumentError, "Missing the required parameter 'multiple_product_groups_inner' when calling CatalogProductGroupsApi.catalogs_product_groups_create"
      end
      if @api_client.config.client_side_validation && !opts[:'ad_account_id'].nil? && opts[:'ad_account_id'].to_s.length > 18
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(multiple_product_groups_inner)
    ...
    # @option opts [String] :ad_account_id Unique identifier of an ad account.
    # @return [Array<String>]
    def catalogs_product_groups_create_many(multiple_product_groups_inner, opts = {})
      data, _status_code, _headers = catalogs_product_groups_create_many_with_http_info(multiple_product_groups_inner, opts)
      data
    end
    ...
    def catalogs_product_groups_create_many_with_http_info(multiple_product_groups_inner, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CatalogProductGroupsApi.catalogs_product_groups_create_many ...'
      end
      # verify the required parameter 'multiple_product_groups_inner' is set
      if @api_client.config.client_side_validation && multiple_product_groups_inner.nil?
        fail ArgumentError, "Missing the required parameter 'multiple_product_groups_inner' when calling CatalogProductGroupsApi.catalogs_product_groups_create_many"
      end
      if @api_client.config.client_side_validation && multiple_product_groups_inner.length > 1000
        fail ArgumentError, 'invalid value for "multiple_product_groups_inner" when calling CatalogProductGroupsApi.catalogs_product_groups_create_many, number of items must be less than or equal to 1000.'
      end

      if @api_client.config.client_side_validation && multiple_product_groups_inner.length < 1
        fail ArgumentError, 'invalid value for "multiple_product_groups_inner" when calling CatalogProductGroupsApi.catalogs_product_groups_create_many, number of items must be greater than or equal to 1.'
      end
    ...
    # @option opts [String] :ad_account_id Unique identifier of an ad account.
    # @return [CatalogsVerticalProductGroup]
    def catalogs_product_groups_update(product_group_id, catalogs_product_groups_update_request, opts = {})
      data, _status_code, _headers = catalogs_product_groups_update_with_http_info(product_group_id, catalogs_product_groups_update_request, opts)
      data
    end
    ...
    # @option opts [String] :ad_account_id Unique identifier of an ad account.
    # @return [Array<(CatalogsVerticalProductGroup, Integer, Hash)>] CatalogsVerticalProductGroup data, response status code and response headers
    def catalogs_product_groups_update_with_http_info(product_group_id, catalogs_product_groups_update_request, opts = {})
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && catalogs_product_groups_update_request.nil?
        fail ArgumentError, "Missing the required parameter 'catalogs_product_groups_update_request' when calling CatalogProductGroupsApi.catalogs_product_groups_update"
      end
      if @api_client.config.client_side_validation && !opts[:'ad_account_id'].nil? && opts[:'ad_account_id'].to_s.length > 18
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(catalogs_product_groups_update_request)
