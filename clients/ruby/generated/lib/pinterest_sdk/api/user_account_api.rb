...
module PinterestSdkClient
  class UserAccountApi
    ...
    # @param follow_user_create [FollowUserCreate] 
    # @param [Hash] opts the optional parameters
    # @return [FollowUser]
    ...
    # @param follow_user_create [FollowUserCreate] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(FollowUser, Integer, Hash)>] FollowUser data, response status code and response headers
    ...
    # @param website [String] Website with path or domain only
    # @param [Hash] opts the optional parameters
    # @return [Array<(UserWebsite, Integer, Hash)>] UserWebsite data, response status code and response headers
    ...
    # @option opts [Array<QuerymetrictypesItems>] :metric_types Metric types to get data for, default is all.
    ...
    # @param start_date [Date] Metric report start date (UTC). Format: YYYY-MM-DD. Cannot be more than 90 days back from today.
    # @param end_date [Date] Metric report end date (UTC). Format: YYYY-MM-DD. Cannot be more than 90 days past start_date.
    # @param sort_by [TopPinsSortBy] Specify sorting order for metrics
    # @param [Hash] opts the optional parameters
    # @option opts [String] :from_claimed_content Filter on Pins that match your claimed domain. (default to 'BOTH')
    # @option opts [String] :pin_format Pin formats to get data for, default is all. (default to 'ALL')
    # @option opts [String] :app_types Apps or devices to get data for, default is all. (default to 'ALL')
    ...
    # @option opts [Float] :created_in_last_n_days Get metrics for pins created in the last \&quot;n\&quot; days.
    # @option opts [String] :ad_account_id Unique identifier of an ad account.
    ...
    # @param start_date [Date] Metric report start date (UTC). Format: YYYY-MM-DD. Cannot be more than 90 days back from today.
    # @param end_date [Date] Metric report end date (UTC). Format: YYYY-MM-DD. Cannot be more than 90 days past start_date.
    # @param sort_by [TopVideoPinsSortBy] Specify sorting order for video metrics
    # @param [Hash] opts the optional parameters
    # @option opts [String] :from_claimed_content Filter on Pins that match your claimed domain. (default to 'BOTH')
    # @option opts [String] :pin_format Pin formats to get data for, default is all. (default to 'ALL')
    # @option opts [String] :app_types Apps or devices to get data for, default is all. (default to 'ALL')
    # @option opts [String] :content_type Filter to paid or organic data. Default is all. (default to 'ALL')
    # @option opts [String] :source Filter to activity from Pins created and saved by your, or activity created and saved by others from your claimed accounts (default to 'ALL')
    # @option opts [Array<QueryvideopinmetrictypesItems>] :metric_types Metric types to get video data for, default is all.
    # @option opts [Integer] :num_of_pins Number of pins to include, default is 10. Max is 50. (default to 10)
    # @option opts [Float] :created_in_last_n_days Get metrics for pins created in the last \&quot;n\&quot; days.
    # @option opts [String] :ad_account_id Unique identifier of an ad account.
    ...
    # @param user_website_create [UserWebsiteCreate] 
    # @param [Hash] opts the optional parameters
    # @option opts [String] :ad_account_id Unique identifier of an ad account.
    # @return [UserWebsite]
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :ad_account_id Unique identifier of an ad account.
    # @return [Array<(UserWebsiteVerification, Integer, Hash)>] UserWebsiteVerification data, response status code and response headers
