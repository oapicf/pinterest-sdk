...
module PinterestSdkClient
  class ResourcesApi
    ...
    def ad_account_countries_get_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'AdAccountsCountryResponse'
    ...
    def delivery_metrics_get_with_http_info(opts = {})
      ...
      if @api_client.config.client_side_validation && opts[:'report_type'] && !allowable_values.include?(opts[:'report_type'])
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'DeliveryMetricsResponse'
    ...
    def interest_targeting_options_get_with_http_info(interest_id, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'SingleInterestTargetingOptionResponse'
    ...
    def metrics_ready_state_get_with_http_info(date, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'BookClosedResponse'
    ...
    def targeting_options_get_with_http_info(targeting_type, opts = {})
      ...
      if @api_client.config.client_side_validation && !allowable_values.include?(targeting_type)
        fail ArgumentError, "invalid value for \"targeting_type\", must be one of #{allowable_values}"
      end
