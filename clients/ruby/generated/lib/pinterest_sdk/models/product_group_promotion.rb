...
module PinterestSdkClient
  class ProductGroupPromotion < ApiModelBase
    ...
    def valid?
      ...
      collections_header_type_validator = EnumAttributeValidator.new('String', ["SHOP_THIS_COLLECTION", "EXPLORE_THIS_COLLECTION", "NO_HEADER", "ON_SALE", "GET_DEAL"])
      ...
      customizable_cta_type_validator = EnumAttributeValidator.new('String', ["SHOP_NOW", "BOOK_NOW", "ON_SALE", "GET_DEAL", "BUY_ONLINE_PICKUP_IN_STORE"])
      ...
      preferred_media_type_validator = EnumAttributeValidator.new('String', ["VIDEO", "IMAGE"])
    ...
    def collections_header_type=(collections_header_type)
      validator = EnumAttributeValidator.new('String', ["SHOP_THIS_COLLECTION", "EXPLORE_THIS_COLLECTION", "NO_HEADER", "ON_SALE", "GET_DEAL"])
      unless validator.valid?(collections_header_type)
        fail ArgumentError, "invalid value for \"collections_header_type\", must be one of #{validator.allowable_values}."
      end
      @collections_header_type = collections_header_type
    end
    ...
    def customizable_cta_type=(customizable_cta_type)
      validator = EnumAttributeValidator.new('String', ["SHOP_NOW", "BOOK_NOW", "ON_SALE", "GET_DEAL", "BUY_ONLINE_PICKUP_IN_STORE"])
      unless validator.valid?(customizable_cta_type)
        fail ArgumentError, "invalid value for \"customizable_cta_type\", must be one of #{validator.allowable_values}."
      end
      @customizable_cta_type = customizable_cta_type
    end
    ...
    def preferred_media_type=(preferred_media_type)
      validator = EnumAttributeValidator.new('String', ["VIDEO", "IMAGE"])
      unless validator.valid?(preferred_media_type)
        fail ArgumentError, "invalid value for \"preferred_media_type\", must be one of #{validator.allowable_values}."
      end
      @preferred_media_type = preferred_media_type
    end
