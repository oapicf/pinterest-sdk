...
module PinterestSdkClient
  ...
  class InviteExceptionResponse < ApiModelBase
    ...
    def invite_or_request_id=(invite_or_request_id)
      pattern = Regexp.new(/^\d+$/)
      if !invite_or_request_id.nil? && invite_or_request_id !~ pattern
        fail ArgumentError, "invalid value for \"invite_or_request_id\", must conform to the pattern #{pattern}."
      end
