...
module PinterestSdkClient
  class AdGroupResponse < ApiModelBase
    ...
    # oCPM learn mode
    attr_accessor :conversion_learning_mode_type

    # Ad group creation time. Unix timestamp in seconds.
    attr_accessor :created_time

    # [DCA] The Dynamic creative assets to use for DCA. Dynamic Creative Assembly (DCA) accepts basic creative assets of an ad (image, video, title, call to action, logo etc). Then it automatically generates optimized ad combinations based on these assets.
    attr_accessor :dca_assets
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `PinterestSdkClient::AdGroupResponse`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def bid_strategy_type=(bid_strategy_type)
      ...
      unless validator.valid?(bid_strategy_type)
        fail ArgumentError, "invalid value for \"bid_strategy_type\", must be one of #{validator.allowable_values}."
      end
      @bid_strategy_type = bid_strategy_type
    end
    ...
    def conversion_learning_mode_type=(conversion_learning_mode_type)
      ...
      unless validator.valid?(conversion_learning_mode_type)
        fail ArgumentError, "invalid value for \"conversion_learning_mode_type\", must be one of #{validator.allowable_values}."
      end
      @conversion_learning_mode_type = conversion_learning_mode_type
    end
    ...
    def hash
      [auto_targeting_enabled, bid_in_micro_currency, bid_strategy_type, billable_event, budget_in_micro_currency, budget_type, campaign_id, end_time, is_creative_optimization, lifetime_frequency_cap, name, optimization_goal_metadata, pacing_delivery_type, placement_group, promotion_application_level, promotion_id, start_time, status, targeting_spec, targeting_template_ids, tracking_urls, ad_account_id, bid_multiplier, conversion_learning_mode_type, created_time, dca_assets, feed_profile_id, id, summary_status, type, updated_time].hash
    end
