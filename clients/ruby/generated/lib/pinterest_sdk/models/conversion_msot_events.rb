...
module PinterestSdkClient
  ...
  class ConversionMSOTEvents < ApiModelBase
    ...
    def attribution_model=(attribution_model)
      validator = EnumAttributeValidator.new('String', ["first_touch", "last_touch", "multi_touch"])
      unless validator.valid?(attribution_model)
        fail ArgumentError, "invalid value for \"attribution_model\", must be one of #{validator.allowable_values}."
      end
      @attribution_model = attribution_model
    end
    ...
    def attribution_scope=(attribution_scope)
      validator = EnumAttributeValidator.new('String', ["view", "engagement", "click"])
      unless validator.valid?(attribution_scope)
        fail ArgumentError, "invalid value for \"attribution_scope\", must be one of #{validator.allowable_values}."
      end
      @attribution_scope = attribution_scope
    end
    ...
    def event_name=(event_name)
      validator = EnumAttributeValidator.new('String', ["add_to_cart", "checkout", "lead", "signup"])
