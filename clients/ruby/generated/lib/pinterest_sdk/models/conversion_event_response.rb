...
module PinterestSdkClient
  class ConversionEventResponse < ApiModelBase
    ...
    attr_accessor :reporting_conversion_event
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `PinterestSdkClient::ConversionEventResponse` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `PinterestSdkClient::ConversionEventResponse`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'reporting_conversion_event')
        self.reporting_conversion_event = attributes[:'reporting_conversion_event']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          reporting_conversion_event == o.reporting_conversion_event
    end
    ...
    def hash
      [ad_account_id, conversion_event, conversion_tag_id, created_time, reporting_conversion_event].hash
    end
