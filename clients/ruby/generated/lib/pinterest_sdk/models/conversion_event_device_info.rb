...
module PinterestSdkClient
  ...
  class ConversionEventDeviceInfo < ApiModelBase
    ...
    def form_factor=(form_factor)
      validator = EnumAttributeValidator.new('String', ["desktop", "laptop", "cellphone", "tablet", "smartwatch", "tv", "vr", "console", "other"])
    ...
    def network_type=(network_type)
      validator = EnumAttributeValidator.new('String', ["wifi", "cellular_2g", "cellular_3g", "cellular_4g", "cellular_5g", "cellular_6g", "ethernet", "unknown"])
    ...
    def os_family=(os_family)
      validator = EnumAttributeValidator.new('String', ["ios", "android", "macos", "windows", "linux", "bsd", "other"])
      unless validator.valid?(os_family)
        fail ArgumentError, "invalid value for \"os_family\", must be one of #{validator.allowable_values}."
      end
      @os_family = os_family
    end
