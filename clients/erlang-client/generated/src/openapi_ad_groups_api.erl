...
-spec ad_groups/audience_sizing(ctx:ctx(), binary(), openapi_ad_group_audience_sizing_request:openapi_ad_group_audience_sizing_request()) -> {ok, openapi_ad_group_audience_sizing_response:openapi_ad_group_audience_sizing_response(), openapi_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), openapi_utils:response_info()}.
ad_groups/audience_sizing(Ctx, AdAccountId, OpenapiAdGroupAudienceSizingRequest) ->
    ad_groups/audience_sizing(Ctx, AdAccountId, OpenapiAdGroupAudienceSizingRequest, #{}).

-spec ad_groups/audience_sizing(ctx:ctx(), binary(), openapi_ad_group_audience_sizing_request:openapi_ad_group_audience_sizing_request(), maps:map()) -> {ok, openapi_ad_group_audience_sizing_response:openapi_ad_group_audience_sizing_response(), openapi_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), openapi_utils:response_info()}.
ad_groups/audience_sizing(Ctx, AdAccountId, OpenapiAdGroupAudienceSizingRequest, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(openapi_api, config, #{})),
