...
-spec media/list(ctx:ctx()) -> {ok, openapi_paginated:openapi_paginated(), openapi_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), openapi_utils:response_info()}.
media/list(Ctx) ->
    media/list(Ctx, #{}).

-spec media/list(ctx:ctx(), maps:map()) -> {ok, openapi_paginated:openapi_paginated(), openapi_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), openapi_utils:response_info()}.
