...
-spec customer_list_uploads/get(ctx:ctx(), binary(), binary(), binary()) -> {ok, openapi_customer_list_upload:openapi_customer_list_upload(), openapi_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), openapi_utils:response_info()}.
customer_list_uploads/get(Ctx, AdAccountId, CustomerListId, CustomerListUploadId) ->
    customer_list_uploads/get(Ctx, AdAccountId, CustomerListId, CustomerListUploadId, #{}).

-spec customer_list_uploads/get(ctx:ctx(), binary(), binary(), binary(), maps:map()) -> {ok, openapi_customer_list_upload:openapi_customer_list_upload(), openapi_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), openapi_utils:response_info()}.
...
-spec customer_list_uploads/run(ctx:ctx(), binary(), binary(), binary()) -> {ok, openapi_customer_list_upload:openapi_customer_list_upload(), openapi_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), openapi_utils:response_info()}.
customer_list_uploads/run(Ctx, AdAccountId, CustomerListId, CustomerListUploadId) ->
    customer_list_uploads/run(Ctx, AdAccountId, CustomerListId, CustomerListUploadId, #{}).

-spec customer_list_uploads/run(ctx:ctx(), binary(), binary(), binary(), maps:map()) -> {ok, openapi_customer_list_upload:openapi_customer_list_upload(), openapi_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), openapi_utils:response_info()}.
