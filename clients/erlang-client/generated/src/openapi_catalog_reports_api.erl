...
-spec reports/stats(ctx:ctx(), openapi_reports_stats_parameters_parameter) -> {ok, openapi_reports_stats_200_response:openapi_reports_stats_200_response(), openapi_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), openapi_utils:response_info()}.
reports/stats(Ctx, Parameters) ->
    reports/stats(Ctx, Parameters, #{}).

-spec reports/stats(ctx:ctx(), openapi_reports_stats_parameters_parameter, maps:map()) -> {ok, openapi_reports_stats_200_response:openapi_reports_stats_200_response(), openapi_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), openapi_utils:response_info()}.
