...
-spec ads_credit/redeem(ctx:ctx(), binary(), openapi_ads_credit_redeem_create:openapi_ads_credit_redeem_create()) -> {ok, openapi_ads_credit_redeem:openapi_ads_credit_redeem(), openapi_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), openapi_utils:response_info()}.
ads_credit/redeem(Ctx, AdAccountId, OpenapiAdsCreditRedeemCreate) ->
    ads_credit/redeem(Ctx, AdAccountId, OpenapiAdsCreditRedeemCreate, #{}).

-spec ads_credit/redeem(ctx:ctx(), binary(), openapi_ads_credit_redeem_create:openapi_ads_credit_redeem_create(), maps:map()) -> {ok, openapi_ads_credit_redeem:openapi_ads_credit_redeem(), openapi_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), openapi_utils:response_info()}.
ads_credit/redeem(Ctx, AdAccountId, OpenapiAdsCreditRedeemCreate, Optional) ->
    ...
    QS = [],
    Headers = [],
    Body1 = OpenapiAdsCreditRedeemCreate,
...
billing_invoices/get(Ctx, AdAccountId, Optional) ->
    ...
    QS = lists:flatten([])++openapi_utils:optional_params(['bookmark', 'page_size', 'order', 'sort', 'status', 'document_type', 'start_due_date', 'end_due_date'], _OptionalParams),
    Headers = [],
    Body1 = [],
    ContentTypeHeader = openapi_utils:select_header_content_type([]),
    Opts = maps:get(hackney_opts, Optional, []),
...
-spec billing_profiles/get(ctx:ctx(), boolean(), binary()) -> {ok, openapi_billing_profiles_get_200_response:openapi_billing_profiles_get_200_response(), openapi_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), openapi_utils:response_info()}.
billing_profiles/get(Ctx, IsActive, AdAccountId) ->
    billing_profiles/get(Ctx, IsActive, AdAccountId, #{}).

-spec billing_profiles/get(ctx:ctx(), boolean(), binary(), maps:map()) -> {ok, openapi_billing_profiles_get_200_response:openapi_billing_profiles_get_200_response(), openapi_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), openapi_utils:response_info()}.
billing_profiles/get(Ctx, IsActive, AdAccountId, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(openapi_api, config, #{})),
...
-spec ssio_accounts/get(ctx:ctx(), binary()) -> {ok, openapi_s_sio_account:openapi_s_sio_account(), openapi_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), openapi_utils:response_info()}.
ssio_accounts/get(Ctx, AdAccountId) ->
    ssio_accounts/get(Ctx, AdAccountId, #{}).

-spec ssio_accounts/get(ctx:ctx(), binary(), maps:map()) -> {ok, openapi_s_sio_account:openapi_s_sio_account(), openapi_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), openapi_utils:response_info()}.
...
-spec ssio_insertion_order/create(ctx:ctx(), binary(), openapi_ssio_insertion_order_create:openapi_ssio_insertion_order_create()) -> {ok, openapi_s_sio_insertion_order:openapi_s_sio_insertion_order(), openapi_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), openapi_utils:response_info()}.
ssio_insertion_order/create(Ctx, AdAccountId, OpenapiSsioInsertionOrderCreate) ->
    ssio_insertion_order/create(Ctx, AdAccountId, OpenapiSsioInsertionOrderCreate, #{}).

-spec ssio_insertion_order/create(ctx:ctx(), binary(), openapi_ssio_insertion_order_create:openapi_ssio_insertion_order_create(), maps:map()) -> {ok, openapi_s_sio_insertion_order:openapi_s_sio_insertion_order(), openapi_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), openapi_utils:response_info()}.
ssio_insertion_order/create(Ctx, AdAccountId, OpenapiSsioInsertionOrderCreate, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(openapi_api, config, #{})),
    ...
    QS = [],
    Headers = [],
    Body1 = OpenapiSsioInsertionOrderCreate,
    ContentTypeHeader = openapi_utils:select_header_content_type([<<"application/json">>]),
    Opts = maps:get(hackney_opts, Optional, []),
...
-spec ssio_insertion_order/edit(ctx:ctx(), binary(), openapi_ssio_insertion_order_update:openapi_ssio_insertion_order_update()) -> {ok, openapi_s_sio_insertion_order:openapi_s_sio_insertion_order(), openapi_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), openapi_utils:response_info()}.
ssio_insertion_order/edit(Ctx, AdAccountId, OpenapiSsioInsertionOrderUpdate) ->
    ssio_insertion_order/edit(Ctx, AdAccountId, OpenapiSsioInsertionOrderUpdate, #{}).

-spec ssio_insertion_order/edit(ctx:ctx(), binary(), openapi_ssio_insertion_order_update:openapi_ssio_insertion_order_update(), maps:map()) -> {ok, openapi_s_sio_insertion_order:openapi_s_sio_insertion_order(), openapi_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), openapi_utils:response_info()}.
ssio_insertion_order/edit(Ctx, AdAccountId, OpenapiSsioInsertionOrderUpdate, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(openapi_api, config, #{})),
    ...
    QS = [],
    Headers = [],
    Body1 = OpenapiSsioInsertionOrderUpdate,
    ContentTypeHeader = openapi_utils:select_header_content_type([<<"application/json">>]),
    Opts = maps:get(hackney_opts, Optional, []),
...
ssio_order_lines/get_by_ad_account(Ctx, AdAccountId, Optional) ->
    ...
    QS = lists:flatten([])++openapi_utils:optional_params(['pin_order_id', 'bookmark', 'page_size'], _OptionalParams),
    Headers = [],
    Body1 = [],
    ContentTypeHeader = openapi_utils:select_header_content_type([]),
    Opts = maps:get(hackney_opts, Optional, []),
