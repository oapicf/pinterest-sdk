...
-spec board_sections/list(ctx:ctx(), binary()) -> {ok, openapi_board_sections_list_200_response:openapi_board_sections_list_200_response(), openapi_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), openapi_utils:response_info()}.
board_sections/list(Ctx, BoardId) ->
    board_sections/list(Ctx, BoardId, #{}).

-spec board_sections/list(ctx:ctx(), binary(), maps:map()) -> {ok, openapi_board_sections_list_200_response:openapi_board_sections_list_200_response(), openapi_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), openapi_utils:response_info()}.
board_sections/list(Ctx, BoardId, Optional) ->
    ...
    Method = get,
    Path = [?BASE_URL, "/boards/", BoardId, "/sections"],
    QS = lists:flatten([])++openapi_utils:optional_params(['ad_account_id', 'bookmark', 'page_size'], _OptionalParams),
    Headers = [],
    Body1 = [],
    ContentTypeHeader = openapi_utils:select_header_content_type([]),
    Opts = maps:get(hackney_opts, Optional, []),
...
-spec board_sections/list_pins(ctx:ctx(), binary(), binary()) -> {ok, openapi_boards_list_pins_200_response:openapi_boards_list_pins_200_response(), openapi_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), openapi_utils:response_info()}.
board_sections/list_pins(Ctx, BoardId, SectionId) ->
    board_sections/list_pins(Ctx, BoardId, SectionId, #{}).

-spec board_sections/list_pins(ctx:ctx(), binary(), binary(), maps:map()) -> {ok, openapi_boards_list_pins_200_response:openapi_boards_list_pins_200_response(), openapi_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), openapi_utils:response_info()}.
board_sections/list_pins(Ctx, BoardId, SectionId, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(openapi_api, config, #{})),

    Method = get,
    Path = [?BASE_URL, "/boards/", BoardId, "/sections/", SectionId, "/pins"],
    QS = lists:flatten([])++openapi_utils:optional_params(['ad_account_id', 'bookmark', 'page_size'], _OptionalParams),
    Headers = [],
    Body1 = [],
    ContentTypeHeader = openapi_utils:select_header_content_type([]),
...
-spec boards/create(ctx:ctx(), openapi_board_create:openapi_board_create()) -> {ok, openapi_board:openapi_board(), openapi_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), openapi_utils:response_info()}.
boards/create(Ctx, OpenapiBoardCreate) ->
    boards/create(Ctx, OpenapiBoardCreate, #{}).

-spec boards/create(ctx:ctx(), openapi_board_create:openapi_board_create(), maps:map()) -> {ok, openapi_board:openapi_board(), openapi_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), openapi_utils:response_info()}.
boards/create(Ctx, OpenapiBoardCreate, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(openapi_api, config, #{})),

    Method = post,
    Path = [?BASE_URL, "/boards"],
    QS = lists:flatten([])++openapi_utils:optional_params(['ad_account_id'], _OptionalParams),
    Headers = [],
    Body1 = OpenapiBoardCreate,
    ContentTypeHeader = openapi_utils:select_header_content_type([<<"application/json">>]),
    Opts = maps:get(hackney_opts, Optional, []),
...
-spec boards/list(ctx:ctx()) -> {ok, openapi_boards_list_200_response:openapi_boards_list_200_response(), openapi_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), openapi_utils:response_info()}.
boards/list(Ctx) ->
    boards/list(Ctx, #{}).

-spec boards/list(ctx:ctx(), maps:map()) -> {ok, openapi_boards_list_200_response:openapi_boards_list_200_response(), openapi_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), openapi_utils:response_info()}.
boards/list(Ctx, Optional) ->
    ...
    Method = get,
    Path = [?BASE_URL, "/boards"],
    QS = lists:flatten([])++openapi_utils:optional_params(['ad_account_id', 'privacy', 'bookmark', 'page_size'], _OptionalParams),
    Headers = [],
    Body1 = [],
    ContentTypeHeader = openapi_utils:select_header_content_type([]),
    Opts = maps:get(hackney_opts, Optional, []),
...
-spec boards/list_pins(ctx:ctx(), binary()) -> {ok, openapi_boards_list_pins_200_response:openapi_boards_list_pins_200_response(), openapi_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), openapi_utils:response_info()}.
boards/list_pins(Ctx, BoardId) ->
    boards/list_pins(Ctx, BoardId, #{}).

-spec boards/list_pins(ctx:ctx(), binary(), maps:map()) -> {ok, openapi_boards_list_pins_200_response:openapi_boards_list_pins_200_response(), openapi_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), openapi_utils:response_info()}.
...
-spec boards/update(ctx:ctx(), binary(), openapi_board_with_update_privacy_update:openapi_board_with_update_privacy_update()) -> {ok, openapi_board_with_update_privacy:openapi_board_with_update_privacy(), openapi_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), openapi_utils:response_info()}.
boards/update(Ctx, BoardId, OpenapiBoardWithUpdatePrivacyUpdate) ->
    boards/update(Ctx, BoardId, OpenapiBoardWithUpdatePrivacyUpdate, #{}).

-spec boards/update(ctx:ctx(), binary(), openapi_board_with_update_privacy_update:openapi_board_with_update_privacy_update(), maps:map()) -> {ok, openapi_board_with_update_privacy:openapi_board_with_update_privacy(), openapi_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), openapi_utils:response_info()}.
boards/update(Ctx, BoardId, OpenapiBoardWithUpdatePrivacyUpdate, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(openapi_api, config, #{})),
    ...
    QS = lists:flatten([])++openapi_utils:optional_params(['ad_account_id'], _OptionalParams),
    Headers = [],
    Body1 = OpenapiBoardWithUpdatePrivacyUpdate,
    ContentTypeHeader = openapi_utils:select_header_content_type([<<"application/json">>]),
    Opts = maps:get(hackney_opts, Optional, []),
