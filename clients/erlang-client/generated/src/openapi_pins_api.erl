...
-spec pins/delete(ctx:ctx(), binary()) -> {ok, openapi_pin:openapi_pin(), openapi_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), openapi_utils:response_info()}.
pins/delete(Ctx, PinId) ->
    pins/delete(Ctx, PinId, #{}).

-spec pins/delete(ctx:ctx(), binary(), maps:map()) -> {ok, openapi_pin:openapi_pin(), openapi_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), openapi_utils:response_info()}.
...
pins/get(Ctx, PinId, Optional) ->
    ...
    Method = get,
    Path = [?BASE_URL, "/pins/", PinId, ""],
    QS = lists:flatten([])++openapi_utils:optional_params(['ad_account_id', 'pin_metrics'], _OptionalParams),
    Headers = [],
    Body1 = [],
    ContentTypeHeader = openapi_utils:select_header_content_type([]),
    Opts = maps:get(hackney_opts, Optional, []),
...
pins/list(Ctx, Optional) ->
    ...
    Method = get,
    Path = [?BASE_URL, "/pins"],
    QS = lists:flatten([])++openapi_utils:optional_params(['pin_filter', 'pin_metrics', 'include_protected_pins', 'pin_type', 'creative_types', 'ad_account_id', 'domain', 'domains', 'include_product_tag_obj', 'bookmark', 'page_size'], _OptionalParams),
    Headers = [],
    Body1 = [],
    ContentTypeHeader = openapi_utils:select_header_content_type([]),
    Opts = maps:get(hackney_opts, Optional, []),
...
-spec pins/save(ctx:ctx(), binary(), openapi_pins_save_request_create:openapi_pins_save_request_create()) -> {ok, openapi_pin:openapi_pin(), openapi_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), openapi_utils:response_info()}.
pins/save(Ctx, PinId, OpenapiPinsSaveRequestCreate) ->
    pins/save(Ctx, PinId, OpenapiPinsSaveRequestCreate, #{}).

-spec pins/save(ctx:ctx(), binary(), openapi_pins_save_request_create:openapi_pins_save_request_create(), maps:map()) -> {ok, openapi_pin:openapi_pin(), openapi_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), openapi_utils:response_info()}.
pins/save(Ctx, PinId, OpenapiPinsSaveRequestCreate, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(openapi_api, config, #{})),
    ...
    QS = lists:flatten([])++openapi_utils:optional_params(['ad_account_id'], _OptionalParams),
    Headers = [],
    Body1 = OpenapiPinsSaveRequestCreate,
    ContentTypeHeader = openapi_utils:select_header_content_type([<<"application/json">>]),
    Opts = maps:get(hackney_opts, Optional, []),
