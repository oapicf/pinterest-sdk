...
--
SELECT `items`, `bookmark` FROM `get_business_employers_200_response` WHERE 1;

--
-- INSERT template for table `get_business_employers_200_response`
--
INSERT INTO `get_business_employers_200_response`(`items`, `bookmark`) VALUES (?, ?);

--
-- UPDATE template for table `get_business_employers_200_response`
--
UPDATE `get_business_employers_200_response` SET `items` = ?, `bookmark` = ? WHERE 1;

--
-- DELETE template for table `get_business_employers_200_response`
--
DELETE FROM `get_business_employers_200_response` WHERE 0;
