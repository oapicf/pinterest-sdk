...
--
SELECT `bookmark`, `items` FROM `shared_audiences_for_business_list_200_response` WHERE 1;
...
--
UPDATE `shared_audiences_for_business_list_200_response` SET `bookmark` = ?, `items` = ? WHERE 1;

--
-- DELETE template for table `shared_audiences_for_business_list_200_response`
--
DELETE FROM `shared_audiences_for_business_list_200_response` WHERE 0;
