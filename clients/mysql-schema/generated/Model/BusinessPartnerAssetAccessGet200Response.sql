...
--
SELECT `bookmark`, `items` FROM `business_partner_asset_access_get_200_response` WHERE 1;
...
--
UPDATE `business_partner_asset_access_get_200_response` SET `bookmark` = ?, `items` = ? WHERE 1;
