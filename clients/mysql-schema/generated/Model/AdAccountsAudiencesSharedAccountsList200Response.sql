...
--
SELECT `bookmark`, `items` FROM `ad_accounts_audiences_shared_accounts_list_200_response` WHERE 1;
...
--
UPDATE `ad_accounts_audiences_shared_accounts_list_200_response` SET `bookmark` = ?, `items` = ? WHERE 1;
