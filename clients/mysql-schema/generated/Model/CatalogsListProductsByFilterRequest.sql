...
--
SELECT `feed_id`, `filters`, `catalog_id`, `catalog_type`, `country`, `locale` FROM `CatalogsListProductsByFilterRequest` WHERE 1;

--
-- INSERT template for table `CatalogsListProductsByFilterRequest`
--
INSERT INTO `CatalogsListProductsByFilterRequest`(`feed_id`, `filters`, `catalog_id`, `catalog_type`, `country`, `locale`) VALUES (?, ?, ?, ?, ?, ?);

--
-- UPDATE template for table `CatalogsListProductsByFilterRequest`
--
UPDATE `CatalogsListProductsByFilterRequest` SET `feed_id` = ?, `filters` = ?, `catalog_id` = ?, `catalog_type` = ?, `country` = ?, `locale` = ? WHERE 1;
