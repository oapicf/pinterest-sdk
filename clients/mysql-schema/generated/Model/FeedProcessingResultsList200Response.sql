...
--
SELECT `bookmark`, `items` FROM `feed_processing_results_list_200_response` WHERE 1;
...
--
UPDATE `feed_processing_results_list_200_response` SET `bookmark` = ?, `items` = ? WHERE 1;
