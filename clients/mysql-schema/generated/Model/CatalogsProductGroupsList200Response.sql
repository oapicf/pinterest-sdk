...
--
SELECT `bookmark`, `items` FROM `catalogs_product_groups_list_200_response` WHERE 1;
...
--
UPDATE `catalogs_product_groups_list_200_response` SET `bookmark` = ?, `items` = ? WHERE 1;
