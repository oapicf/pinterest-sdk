...
--
SELECT `bookmark`, `items` FROM `ssio_insertion_orders_status_get_by_ad_account_200_response` WHERE 1;
...
--
UPDATE `ssio_insertion_orders_status_get_by_ad_account_200_response` SET `bookmark` = ?, `items` = ? WHERE 1;
