...
--
SELECT `bookmark`, `items` FROM `product_group_promotions_list_200_response` WHERE 1;
...
--
UPDATE `product_group_promotions_list_200_response` SET `bookmark` = ?, `items` = ? WHERE 1;
