...
--
SELECT `ad_account_id`, `audience_type`, `created_by_company_name`, `created_timestamp`, `description`, `id`, `is_nca`, `name`, `rule`, `size`, `status`, `type`, `updated_timestamp` FROM `Audience` WHERE 1;
...
--
UPDATE `Audience` SET `ad_account_id` = ?, `audience_type` = ?, `created_by_company_name` = ?, `created_timestamp` = ?, `description` = ?, `id` = ?, `is_nca` = ?, `name` = ?, `rule` = ?, `size` = ?, `status` = ?, `type` = ?, `updated_timestamp` = ? WHERE 1;
