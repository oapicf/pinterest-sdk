...
--
SELECT `asset_id`, `partner_id`, `partner_type` FROM `DeletePartnerAssetAccessBody_accesses_inner` WHERE 1;

--
-- INSERT template for table `DeletePartnerAssetAccessBody_accesses_inner`
--
INSERT INTO `DeletePartnerAssetAccessBody_accesses_inner`(`asset_id`, `partner_id`, `partner_type`) VALUES (?, ?, ?);

--
-- UPDATE template for table `DeletePartnerAssetAccessBody_accesses_inner`
--
UPDATE `DeletePartnerAssetAccessBody_accesses_inner` SET `asset_id` = ?, `partner_id` = ?, `partner_type` = ? WHERE 1;
