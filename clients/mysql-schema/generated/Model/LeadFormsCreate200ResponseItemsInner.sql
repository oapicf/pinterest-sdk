...
--
SELECT `data`, `exceptions` FROM `lead_forms_create_200_response_items_inner` WHERE 1;
...
--
UPDATE `lead_forms_create_200_response_items_inner` SET `data` = ?, `exceptions` = ? WHERE 1;

--
-- DELETE template for table `lead_forms_create_200_response_items_inner`
--
DELETE FROM `lead_forms_create_200_response_items_inner` WHERE 0;
