...
--
SELECT `catalog_type`, `item_ids`, `catalog_id`, `hotel_ids` FROM `CatalogsItemsFilters` WHERE 1;

--
-- INSERT template for table `CatalogsItemsFilters`
--
INSERT INTO `CatalogsItemsFilters`(`catalog_type`, `item_ids`, `catalog_id`, `hotel_ids`) VALUES (?, ?, ?, ?);

--
-- UPDATE template for table `CatalogsItemsFilters`
--
UPDATE `CatalogsItemsFilters` SET `catalog_type` = ?, `item_ids` = ?, `catalog_id` = ?, `hotel_ids` = ? WHERE 1;
