...
--
SELECT `address_primary`, `address_secondary`, `city`, `country`, `created_at`, `id`, `latitude`, `longitude`, `name`, `postal_code`, `region`, `store_code`, `updated_at`, `exceptions` FROM `catalogs_local_stores_create_200_response_inner_data` WHERE 1;
...
--
UPDATE `catalogs_local_stores_create_200_response_inner_data` SET `address_primary` = ?, `address_secondary` = ?, `city` = ?, `country` = ?, `created_at` = ?, `id` = ?, `latitude` = ?, `longitude` = ?, `name` = ?, `postal_code` = ?, `region` = ?, `store_code` = ?, `updated_at` = ?, `exceptions` = ? WHERE 1;

--
-- DELETE template for table `catalogs_local_stores_create_200_response_inner_data`
--
DELETE FROM `catalogs_local_stores_create_200_response_inner_data` WHERE 0;
