...
--
SELECT `items` FROM `advertiser_defined_events_create_200_response` WHERE 1;
...
--
UPDATE `advertiser_defined_events_create_200_response` SET `items` = ? WHERE 1;

--
-- DELETE template for table `advertiser_defined_events_create_200_response`
--
DELETE FROM `advertiser_defined_events_create_200_response` WHERE 0;
