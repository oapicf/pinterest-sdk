--
-- Pinterest REST API.
-- Prepared SQL queries for 'catalogs_retail_filter_values_map' definition.
--
...
--
DELETE FROM `catalogs_retail_filter_values_map` WHERE 0;
