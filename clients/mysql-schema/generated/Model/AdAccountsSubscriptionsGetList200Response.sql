...
--
SELECT `items`, `bookmark` FROM `ad_accounts_subscriptions_get_list_200_response` WHERE 1;

--
-- INSERT template for table `ad_accounts_subscriptions_get_list_200_response`
--
INSERT INTO `ad_accounts_subscriptions_get_list_200_response`(`items`, `bookmark`) VALUES (?, ?);

--
-- UPDATE template for table `ad_accounts_subscriptions_get_list_200_response`
--
UPDATE `ad_accounts_subscriptions_get_list_200_response` SET `items` = ?, `bookmark` = ? WHERE 1;
