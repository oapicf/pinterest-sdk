...
--
SELECT `bookmark`, `items` FROM `search_user_boards_get_200_response` WHERE 1;

--
-- INSERT template for table `search_user_boards_get_200_response`
--
INSERT INTO `search_user_boards_get_200_response`(`bookmark`, `items`) VALUES (?, ?);

--
-- UPDATE template for table `search_user_boards_get_200_response`
--
UPDATE `search_user_boards_get_200_response` SET `bookmark` = ?, `items` = ? WHERE 1;
