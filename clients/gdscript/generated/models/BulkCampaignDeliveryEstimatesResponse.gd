extends Resource
class_name BulkCampaignDeliveryEstimatesResponse
...
# BulkCampaignDeliveryEstimatesResponse Model
...
static func bzz_denormalize_single(from_dict: Dictionary):
	...
	if from_dict.has("data"):
		me.data = BulkCampaignDeliveryEstimatesItem.bzz_denormalize_multiple(from_dict["data"])
	return me
