...
def asData : LocalInventoryItemsGetData = {
LocalInventoryItemsGetData(
...
given RW[LocalInventoryItemsGet] = summon[RW[ujson.Value]].bimap[LocalInventoryItemsGet](_.asJson, json => read[LocalInventoryItemsGetData](json).asModel)
