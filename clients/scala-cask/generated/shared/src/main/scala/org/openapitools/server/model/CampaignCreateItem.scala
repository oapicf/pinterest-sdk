...
def asData : CampaignCreateItemData = {
CampaignCreateItemData(
...
given RW[CampaignCreateItem] = summon[RW[ujson.Value]].bimap[CampaignCreateItem](_.asJson, json => read[CampaignCreateItemData](json).asModel)
