...
def asData : PlacementMultipliersData = {
PlacementMultipliersData(
    PLACEMENT = PLACEMENT.getOrElse(null) /*  1 */
...
given RW[PlacementMultipliers] = summon[RW[ujson.Value]].bimap[PlacementMultipliers](_.asJson, json => read[PlacementMultipliersData](json).asModel)
