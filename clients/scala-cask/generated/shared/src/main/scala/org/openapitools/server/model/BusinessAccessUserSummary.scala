...
def asData : BusinessAccessUserSummaryData = {
BusinessAccessUserSummaryData(
...
given RW[BusinessAccessUserSummary] = summon[RW[ujson.Value]].bimap[BusinessAccessUserSummary](_.asJson, json => read[BusinessAccessUserSummaryData](json).asModel)
