...
def asData : UpdateInvitesResultsResponseArrayData = {
UpdateInvitesResultsResponseArrayData(
...
given RW[UpdateInvitesResultsResponseArray] = summon[RW[ujson.Value]].bimap[UpdateInvitesResultsResponseArray](_.asJson, json => read[UpdateInvitesResultsResponseArrayData](json).asModel)
