...
def asData : TemplateBasedReportData = {
TemplateBasedReportData(
...
given RW[TemplateBasedReport] = summon[RW[ujson.Value]].bimap[TemplateBasedReport](_.asJson, json => read[TemplateBasedReportData](json).asModel)
...
enum Fields(val fieldName : String) extends Field(fieldName) {
    ...
    case templateId extends Fields("templateId")
