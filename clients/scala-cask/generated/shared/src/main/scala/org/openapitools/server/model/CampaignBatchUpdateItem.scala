...
def asData : CampaignBatchUpdateItemData = {
CampaignBatchUpdateItemData(
    adAccountId = adAccountId.getOrElse("") /*  1 */,
    appId = appId.getOrElse("") /*  1 */,
    appPlatform = appPlatform.getOrElse(null) /*  1 */,
...
given RW[CampaignBatchUpdateItem] = summon[RW[ujson.Value]].bimap[CampaignBatchUpdateItem](_.asJson, json => read[CampaignBatchUpdateItemData](json).asModel)
...
enum Fields(val fieldName : String) extends Field(fieldName) {
    ...
    case appPlatform extends Fields("appPlatform")
