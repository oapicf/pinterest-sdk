...
def asData : BoardSectionCreateData = {
BoardSectionCreateData(
    id = id.getOrElse("") /*  1 */,
    name = name /* 2 */
...
given RW[BoardSectionCreate] = summon[RW[ujson.Value]].bimap[BoardSectionCreate](_.asJson, json => read[BoardSectionCreateData](json).asModel)
