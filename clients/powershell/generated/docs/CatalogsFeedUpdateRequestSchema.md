...
```powershell
$CatalogsFeedUpdateRequestSchema = Initialize-PSOpenAPIToolsCatalogsFeedUpdateRequestSchema  -CatalogType null `
 -Credentials null `
...
```powershell
$CatalogsFeedUpdateRequestSchema | ConvertTo-JSON
```
