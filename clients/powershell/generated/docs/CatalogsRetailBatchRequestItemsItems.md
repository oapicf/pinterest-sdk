...
```powershell
$CatalogsRetailBatchRequestItemsItems = Initialize-PSOpenAPIToolsCatalogsRetailBatchRequestItemsItems  -Attributes null `
 -ItemId DS0294-M `
 -Operation null `
...
```powershell
$CatalogsRetailBatchRequestItemsItems | ConvertTo-JSON
```
