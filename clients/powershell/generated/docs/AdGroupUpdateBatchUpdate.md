...
**LifetimeFrequencyCap** | **Int32** | Set a limit to the number of times a promoted pin from this campaign can be impressed by a pinner within the past rolling 30 days. Only available for CPM (cost per mille (1000 impressions))  ad groups. A CPM ad group has an IMPRESSION [billable_event](https://help.pinterest.com/en/business/article/billable-events) value. This field **REQUIRES** the &#x60;end_time&#x60; field. | [optional] 
...
```powershell
$AdGroupUpdateBatchUpdate = Initialize-PSOpenAPIToolsAdGroupUpdateBatchUpdate  -AutoTargetingEnabled null `
...
```powershell
$AdGroupUpdateBatchUpdate | ConvertTo-JSON
```
