...
**CreatedByBusiness** | [**SystemCollectionsHashtable**](.md) | Metadata for the business that created the invite/request. | [optional] 
**CreatedByUser** | [**SystemCollectionsHashtable**](.md) | Metadata for the user that created the invite/request. | [optional] 
...
```powershell
$InviteResponse = Initialize-PSOpenAPIToolsInviteResponse  -Id 383791336903426391 `
 -InviteData null `
