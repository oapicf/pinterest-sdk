...
```powershell
$TopPinsAnalyticsResponsePinsItems = Initialize-PSOpenAPIToolsTopPinsAnalyticsResponsePinsItems  -DataStatus null `
 -Metrics null `
 -PinId null
```
...
```powershell
$TopPinsAnalyticsResponsePinsItems | ConvertTo-JSON
```
