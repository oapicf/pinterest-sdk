...
```powershell
$BulkUpsertRequestUpdateCatalogProductGroupsItems = Initialize-PSOpenAPIToolsBulkUpsertRequestUpdateCatalogProductGroupsItems  -Description null `
 -Filters null `
 -IsFeatured null `
 -Name Most Popular `
 -CatalogType null `
...
```powershell
$BulkUpsertRequestUpdateCatalogProductGroupsItems | ConvertTo-JSON
```
