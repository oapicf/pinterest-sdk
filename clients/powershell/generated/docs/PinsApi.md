...
$MetricTypes = "IMPRESSION" # MultiPinsAnalyticsMetricTypesItem[] | Pin metric types to get data for.
...
$AiDisclosures = Initialize-AiDisclosures -Values "AI_MODIFIED"
...
$PinCreate = Initialize-PinCreate -AiDisclosures $AiDisclosures -AltText "MyAltText" -BoardId "MyBoardId" -BoardSectionId "MyBoardSectionId" -Description "MyDescription" -DominantColor "MyDominantColor" -Link "MyLink" -MediaSource $PinMediaSource -ParentPinId "MyParentPinId" -SponsorId "MySponsorId" -Title "MyTitle" # PinCreate | 
$AdAccountId = "MyAdAccountId" # String | Unique identifier of an ad account. (optional)
...
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-PinFilter] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-PinMetrics] <System.Nullable[Boolean]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IncludeProtectedPins] <System.Nullable[Boolean]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-PinType] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-CreativeTypes] <PSCustomObject[]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-AdAccountId] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Domain] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Domains] <String[]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IncludeProductTagObj] <System.Nullable[Boolean]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Bookmark] <String><br>
...
$PinFilter = "exclude_native" # PinFilter | The filter to apply to the pins (optional)
$PinMetrics = $true # Boolean | Specify whether to return 90d and lifetime Pin metrics. Total comments and total reactions are only available with lifetime Pin metrics. If Pin was created before `2023-03-20` lifetime metrics will only be available for Video and Idea Pin formats. Lifetime metrics are available for all Pin formats since then. (optional) (default to $false)
$IncludeProtectedPins = $true # Boolean | Whether to include protected pins in the results (optional) (default to $false)
$PinType = "PRIVATE" # PinType | The type of pins to return, currently only enabled for private pins (optional)
...
$AdAccountId = "MyAdAccountId" # String | Unique identifier of an ad account. (optional)
$Domain = "MyDomain" # String | Only return pins with links that match the exact domain. Domain should not include 'www.' prefix. For example, 'pinterest.com' is a valid domain, but 'www.pinterest.com' is not (will not match any pins). (optional)
$Domains = "MyDomains" # String[] | Only return pins with links whose domain matches any value in the list. Values are joined comma-separated on the wire (e.g. `?domains=instagram.com,jcpenney.com`). (optional)
$IncludeProductTagObj = $true # Boolean | Include product tag objects in the response with their associated links. (optional)
...
# List Pins
try {
    $Result = Invoke-PinsList -PinFilter $PinFilter -PinMetrics $PinMetrics -IncludeProtectedPins $IncludeProtectedPins -PinType $PinType -CreativeTypes $CreativeTypes -AdAccountId $AdAccountId -Domain $Domain -Domains $Domains -IncludeProductTagObj $IncludeProductTagObj -Bookmark $Bookmark -PageSize $PageSize
} catch {
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **PinFilter** | [**PinFilter**](PinFilter.md)| The filter to apply to the pins | [optional] 
 **PinMetrics** | **Boolean**| Specify whether to return 90d and lifetime Pin metrics. Total comments and total reactions are only available with lifetime Pin metrics. If Pin was created before &#x60;2023-03-20&#x60; lifetime metrics will only be available for Video and Idea Pin formats. Lifetime metrics are available for all Pin formats since then. | [optional] [default to $false]
 **IncludeProtectedPins** | **Boolean**| Whether to include protected pins in the results | [optional] [default to $false]
 **PinType** | [**PinType**](PinType.md)| The type of pins to return, currently only enabled for private pins | [optional] 
...
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-PinId] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-PinsSaveRequestCreate] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-AdAccountId] <String><br>
...
$PinId = "MyPinId" # String | Unique identifier of a Pin.
$PinsSaveRequestCreate = Initialize-PinsSaveRequestCreate -BoardId "MyBoardId" -BoardSectionId "MyBoardSectionId" # PinsSaveRequestCreate | 
$AdAccountId = "MyAdAccountId" # String | Unique identifier of an ad account. (optional)

# Save Pin
try {
    $Result = Invoke-PinsSave -PinId $PinId -PinsSaveRequestCreate $PinsSaveRequestCreate -AdAccountId $AdAccountId
} catch {
...
$PinId = "MyPinId" # String | 
$AiDisclosuresUpdate = Initialize-AiDisclosuresUpdate -Values "AI_MODIFIED"
$CarouselSlot = Initialize-CarouselSlot -Description "MyDescription" -Link "MyLink" -Title "MyTitle"
$PinUpdate = Initialize-PinUpdate -AiDisclosures $AiDisclosuresUpdate -AltText "MyAltText" -BoardId "MyBoardId" -BoardSectionId "MyBoardSectionId" -CarouselSlots $CarouselSlot -Description "MyDescription" -Link "MyLink" -Title "MyTitle" # PinUpdate | 
$AdAccountId = "MyAdAccountId" # String | Unique identifier of an ad account. (optional)
