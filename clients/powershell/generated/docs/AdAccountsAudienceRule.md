...
**ObjectiveType** | [**AudienceObjectiveType[]**](AudienceObjectiveType.md) | Objective for engagement audience filter. | [optional] 
...
```powershell
$AdAccountsAudienceRule = Initialize-PSOpenAPIToolsAdAccountsAudienceRule  -AdAccountId null `
 -AdId null `
 -CampaignId null `
 -Country null `
 -CustomerListId null `
...
```powershell
$AdAccountsAudienceRule | ConvertTo-JSON
```
