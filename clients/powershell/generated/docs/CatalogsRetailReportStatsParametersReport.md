...
```powershell
$CatalogsRetailReportStatsParametersReport = Initialize-PSOpenAPIToolsCatalogsRetailReportStatsParametersReport  -FeedId null `
...
```powershell
$CatalogsRetailReportStatsParametersReport | ConvertTo-JSON
```
