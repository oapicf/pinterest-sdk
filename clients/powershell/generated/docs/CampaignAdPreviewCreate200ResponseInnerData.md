...
```powershell
$CampaignAdPreviewCreate200ResponseInnerData = Initialize-PSOpenAPIToolsCampaignAdPreviewCreate200ResponseInnerData  -AdAccountId 549755885175 `
...
```powershell
$CampaignAdPreviewCreate200ResponseInnerData | ConvertTo-JSON
```
