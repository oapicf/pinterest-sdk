...
```powershell
$CatalogsProductGroupsCreateRequestSchema = Initialize-PSOpenAPIToolsCatalogsProductGroupsCreateRequestSchema  -Description null `
...
```powershell
$CatalogsProductGroupsCreateRequestSchema | ConvertTo-JSON
```
