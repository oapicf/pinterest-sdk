...
**GEOEXCLUDE** | **String[]** | [Closed beta](/docs/getting-started/using-beta-and-restricted-features/)  Region codes or postal codes to exclude from the targeting inclusion area.  See &#x60;GEO&#x60; parameter in this targeting spec for rules, syntax, and other information. | [optional] 
...
**TARGETINGSTRATEGY** | [**TargetingStrategy[]**](TargetingStrategy.md) |  | [optional] 

## Examples

- Prepare the resource
```powershell
$TargetingSpecOptimal = Initialize-PSOpenAPIToolsTargetingSpecOptimal  -AGEBUCKET null `
 -APPTYPE null `
...
```powershell
$TargetingSpecOptimal | ConvertTo-JSON
```
