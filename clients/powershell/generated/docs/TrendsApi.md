# PSOpenAPITools.PSOpenAPITools\Api.TrendsApi

All URIs are relative to *https://api.pinterest.com/v5*

Method | HTTP request | Description
------------- | ------------- | -------------
[**Invoke-TrendsEditorialArticlesList**](TrendsApi.md#Invoke-TrendsEditorialArticlesList) | **GET** /trends/editorial_articles | Returns editorial articles for a given region
[**Invoke-TrendsFeaturedTopicsList**](TrendsApi.md#Invoke-TrendsFeaturedTopicsList) | **GET** /trends/topics/featured | Get featured topics
[**Invoke-TrendsProductCategoriesDetailsList**](TrendsApi.md#Invoke-TrendsProductCategoriesDetailsList) | **GET** /trends/product_categories/details | Get product category details
[**Invoke-TrendsProductCategoriesTrendingList**](TrendsApi.md#Invoke-TrendsProductCategoriesTrendingList) | **GET** /trends/product_categories/trending | Get a list of growing Shopping Product Categories


<a id="Invoke-TrendsEditorialArticlesList"></a>
# **Invoke-TrendsEditorialArticlesList**
> TrendsEditorial[] Invoke-TrendsEditorialArticlesList<br>
...
# Returns editorial articles for a given region
try {
    $Result = Invoke-TrendsEditorialArticlesList -Region $Region
} catch {
    Write-Host ("Exception occurred when calling Invoke-TrendsEditorialArticlesList: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
...
[**TrendsEditorial[]**](TrendsEditorial.md) (PSCustomObject)
