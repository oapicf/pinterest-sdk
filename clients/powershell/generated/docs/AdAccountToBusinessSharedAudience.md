...
```powershell
$AdAccountToBusinessSharedAudience = Initialize-PSOpenAPIToolsAdAccountToBusinessSharedAudience  -AudienceId 2542621871096 `
...
```powershell
$AdAccountToBusinessSharedAudience | ConvertTo-JSON
```
