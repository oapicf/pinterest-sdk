...
$Limit = 56 # Int32 | Max search result size (optional) (default to 10)
...
> BoardsList200Response Search-UserBoardsGet<br>
...
# Search user's boards
try {
    $Result = Search-UserBoardsGet -AdAccountId $AdAccountId -Query $Query -Bookmark $Bookmark -PageSize $PageSize
} catch {
...
$Query = "MyQuery" # String | Search query. Can contain pin description keywords or comma-separated pin IDs.
$AdAccountId = "MyAdAccountId" # String | Unique identifier of an ad account. (optional)
$Bookmark = "MyBookmark" # String | Cursor used to fetch the next page of items (optional)
