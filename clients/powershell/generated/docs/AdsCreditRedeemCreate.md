...
```powershell
$AdsCreditRedeemCreate = Initialize-PSOpenAPIToolsAdsCreditRedeemCreate  -OfferCodeHash 138e9e0ff7e38cf511b880975eb574c09aa9d5e1657590ab0431040da68caa67 `
 -ValidateOnly true
```

- Convert the resource to JSON
```powershell
$AdsCreditRedeemCreate | ConvertTo-JSON
```
