...
```powershell
$RetailLocalInventoryItemAttributes = Initialize-PSOpenAPIToolsRetailLocalInventoryItemAttributes  -AdLink https://examplelink.com `
...
```powershell
$RetailLocalInventoryItemAttributes | ConvertTo-JSON
```
