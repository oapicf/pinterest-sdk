...
```powershell
$CatalogsHotelAttributesAllOfMainImage = Initialize-PSOpenAPIToolsCatalogsHotelAttributesAllOfMainImage  -Link null `
 -Tag null
```

- Convert the resource to JSON
```powershell
$CatalogsHotelAttributesAllOfMainImage | ConvertTo-JSON
```
