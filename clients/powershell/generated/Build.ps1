...
$Manifest = @{
    ...
    Description = 'PSOpenAPITools - the PowerShell module for Pinterest REST API'

    ModuleVersion = '0.1.2'

    RootModule = 'PSOpenAPITools.psm1'
    Guid = '{44D2295A-019F-4751-8124-0D3BFF0F6E51}' # Has to be static, otherwise each new build will be considered different module
