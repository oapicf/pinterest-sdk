...
function Invoke-AdGroupsBidFloorGet {
    ...
    Process {
        ...
        if (!$BidFloorRequest) {
            throw "Error! The required parameter `BidFloorRequest` missing when calling adGroupsBidFloor_get."
        }

        $LocalVarBodyParameter = $BidFloorRequest | ConvertTo-Json -Depth 100
...
function Invoke-AdGroupsAnalytics {
    ...
    Process {
        ...
        $LocalVarResult = Invoke-ApiClient -Method 'GET' `
                                ...
                                -FormParameters $LocalVarFormParameters `
                                -CookieParameters $LocalVarCookieParameters `
                                -ReturnType "AdGroupsAnalyticsResponseInner[]" `
                                -IsBodyNullable $false
...
.PARAMETER AdGroupAudienceSizingRequest
No description available.
...
function Invoke-AdGroupsAudienceSizing {
    ...
    Process {
        ...
        if (!$AdGroupAudienceSizingRequest) {
            throw "Error! The required parameter `AdGroupAudienceSizingRequest` missing when calling adGroups_audienceSizing."
        }

        $LocalVarBodyParameter = $AdGroupAudienceSizingRequest | ConvertTo-Json -Depth 100
        ...
        $LocalVarResult = Invoke-ApiClient -Method 'POST' `
                                ...
                                -FormParameters $LocalVarFormParameters `
                                -CookieParameters $LocalVarCookieParameters `
                                -ReturnType "AdGroupAudienceSizingResponse" `
                                -IsBodyNullable $false
...
.PARAMETER AdGroupCreateRequest
...
function Invoke-AdGroupsCreate {
    ...
    Process {
        ...
        if (!$AdGroupCreateRequest) {
            throw "Error! The required parameter `AdGroupCreateRequest` missing when calling adGroups_create."
        }

        $LocalVarBodyParameter = ConvertTo-Json @($AdGroupCreateRequest) -Depth 100
        ...
        $LocalVarResult = Invoke-ApiClient -Method 'POST' `
                                ...
                                -FormParameters $LocalVarFormParameters `
                                -CookieParameters $LocalVarCookieParameters `
                                -ReturnType "AdGroupArrayResponse" `
                                -IsBodyNullable $false
...
.PARAMETER AdGroupUpdateRequest
...
function Invoke-AdGroupsUpdate {
    ...
    Process {
        ...
        if (!$AdGroupUpdateRequest) {
            throw "Error! The required parameter `AdGroupUpdateRequest` missing when calling adGroups_update."
        }

        $LocalVarBodyParameter = ConvertTo-Json @($AdGroupUpdateRequest) -Depth 100
