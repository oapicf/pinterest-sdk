...
function Invoke-AdsAnalytics {
    ...
    Process {
        ...
        $LocalVarResult = Invoke-ApiClient -Method 'GET' `
                                ...
                                -FormParameters $LocalVarFormParameters `
                                -CookieParameters $LocalVarCookieParameters `
                                -ReturnType "AdsAnalyticsResponseInner[]" `
                                -IsBodyNullable $false
...
function Invoke-AdsCreate {
    ...
    Process {
        ...
        if (!$AdCreateRequest) {
            throw "Error! The required parameter `AdCreateRequest` missing when calling ads_create."
        }

        $LocalVarBodyParameter = ConvertTo-Json @($AdCreateRequest) -Depth 100
...
function Invoke-AdsUpdate {
    ...
    Process {
        ...
        if (!$AdUpdateRequest) {
            throw "Error! The required parameter `AdUpdateRequest` missing when calling ads_update."
        }

        $LocalVarBodyParameter = ConvertTo-Json @($AdUpdateRequest) -Depth 100
