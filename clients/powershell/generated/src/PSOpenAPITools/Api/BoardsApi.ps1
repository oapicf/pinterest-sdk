...
function Invoke-BoardSectionsCreate {
    ...
    Process {
        ...
        if (!$BoardSectionCreate) {
            throw "Error! The required parameter `BoardSectionCreate` missing when calling boardSections_create."
        }

        $LocalVarBodyParameter = $BoardSectionCreate | ConvertTo-Json -Depth 100
...
.PARAMETER BoardSectionUpdateWithRequiredBody
No description available.
...
function Invoke-BoardSectionsUpdate {
    ...
    Process {
        ...
        if (!$BoardSectionUpdateWithRequiredBody) {
            throw "Error! The required parameter `BoardSectionUpdateWithRequiredBody` missing when calling boardSections_update."
        }

        $LocalVarBodyParameter = $BoardSectionUpdateWithRequiredBody | ConvertTo-Json -Depth 100
...
function Invoke-BoardsCreate {
    ...
    Process {
        ...
        if (!$BoardCreate) {
            throw "Error! The required parameter `BoardCreate` missing when calling boards_create."
        }

        $LocalVarBodyParameter = $BoardCreate | ConvertTo-Json -Depth 100
...
.PARAMETER BoardWithUpdatePrivacyUpdate
No description available.
...
function Invoke-BoardsUpdate {
    ...
    Process {
        ...
        if (!$BoardWithUpdatePrivacyUpdate) {
            throw "Error! The required parameter `BoardWithUpdatePrivacyUpdate` missing when calling boards_update."
        }

        $LocalVarBodyParameter = $BoardWithUpdatePrivacyUpdate | ConvertTo-Json -Depth 100
        ...
        $LocalVarResult = Invoke-ApiClient -Method 'PATCH' `
                                ...
                                -FormParameters $LocalVarFormParameters `
                                -CookieParameters $LocalVarCookieParameters `
                                -ReturnType "BoardWithUpdatePrivacy" `
                                -IsBodyNullable $false
