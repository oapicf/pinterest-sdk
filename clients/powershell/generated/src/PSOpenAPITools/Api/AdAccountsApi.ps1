...
.PARAMETER ConversionProductReportRequest
No description available.
...
function Invoke-AnalyticsCreateConversionProductReport {
    ...
    Process {
        ...
        if (!$ConversionProductReportRequest) {
            throw "Error! The required parameter `ConversionProductReportRequest` missing when calling analytics_createConversionProductReport."
        }

        $LocalVarBodyParameter = $ConversionProductReportRequest | ConvertTo-Json -Depth 100
