...
function Trace-UserUpdate {
    ...
    Process {
        ...
        if (!$FollowUserCreate) {
            throw "Error! The required parameter `FollowUserCreate` missing when calling followUser_update."
        }

        $LocalVarBodyParameter = $FollowUserCreate | ConvertTo-Json -Depth 100
...
function Test-WebsiteUpdate {
    ...
    Process {
        ...
        if (!$UserWebsiteCreate) {
            throw "Error! The required parameter `UserWebsiteCreate` missing when calling verifyWebsite_update."
        }

        $LocalVarBodyParameter = $UserWebsiteCreate | ConvertTo-Json -Depth 100
...
function Invoke-WebsiteVerificationGet {
    ...
    Process {
        ...
        $LocalVarResult = Invoke-ApiClient -Method 'GET' `
                                ...
                                -FormParameters $LocalVarFormParameters `
                                -CookieParameters $LocalVarCookieParameters `
                                -ReturnType "UserWebsiteVerification" `
                                -IsBodyNullable $false
