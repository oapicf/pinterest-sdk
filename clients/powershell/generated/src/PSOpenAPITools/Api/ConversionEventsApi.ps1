...
.PARAMETER ConversionEventsCreate
No description available.
...
function Invoke-EventsCreate {
    ...
    Process {
        ...
        if (!$ConversionEventsCreate) {
            throw "Error! The required parameter `ConversionEventsCreate` missing when calling events_create."
        }

        $LocalVarBodyParameter = $ConversionEventsCreate | ConvertTo-Json -Depth 100
