...
.PARAMETER CancelInvitesRequest
No description available.
...
function Stop-InvitesOrRequests {
    ...
    Process {
        ...
        if (!$CancelInvitesRequest) {
            throw "Error! The required parameter `CancelInvitesRequest` missing when calling cancelInvitesOrRequests."
        }

        $LocalVarBodyParameter = $CancelInvitesRequest | ConvertTo-Json -Depth 100
        ...
        $LocalVarResult = Invoke-ApiClient -Method 'DELETE' `
                                ...
                                -FormParameters $LocalVarFormParameters `
                                -CookieParameters $LocalVarCookieParameters `
                                -ReturnType "CancelInvitesResponse" `
                                -IsBodyNullable $false
