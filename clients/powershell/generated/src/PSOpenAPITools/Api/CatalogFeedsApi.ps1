...
.PARAMETER CatalogsFeedCreateRequestSchema
No description available.
...
function Invoke-FeedsCreate {
    ...
    Process {
        ...
        if (!$CatalogsFeedCreateRequestSchema) {
            throw "Error! The required parameter `CatalogsFeedCreateRequestSchema` missing when calling feeds_create."
        }

        $LocalVarBodyParameter = $CatalogsFeedCreateRequestSchema | ConvertTo-Json -Depth 100
...
.PARAMETER CatalogsFeedUpdateRequestSchema
No description available.
...
function Invoke-FeedsUpdate {
    ...
    Process {
        ...
        if (!$CatalogsFeedUpdateRequestSchema) {
            throw "Error! The required parameter `CatalogsFeedUpdateRequestSchema` missing when calling feeds_update."
        }

        $LocalVarBodyParameter = $CatalogsFeedUpdateRequestSchema | ConvertTo-Json -Depth 100
