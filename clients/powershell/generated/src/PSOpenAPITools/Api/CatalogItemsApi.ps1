...
.PARAMETER CatalogsItemsBatchPostRequest
No description available.
...
function Invoke-ItemsBatchPost {
    ...
    Process {
        ...
        if (!$CatalogsItemsBatchPostRequest) {
            throw "Error! The required parameter `CatalogsItemsBatchPostRequest` missing when calling itemsBatch_post."
        }

        $LocalVarBodyParameter = $CatalogsItemsBatchPostRequest | ConvertTo-Json -Depth 100
...
function Invoke-ItemsPost {
    ...
    Process {
        ...
        $LocalVarResult = Invoke-ApiClient -Method 'POST' `
                                ...
                                -FormParameters $LocalVarFormParameters `
                                -CookieParameters $LocalVarCookieParameters `
                                -ReturnType "ItemsPost200Response" `
                                -IsBodyNullable $false
