...
AdAccountsAudience<PSCustomObject>
#>

function Initialize-AdAccountsAudience {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AdAccountsAudience' | Write-Debug
...
Convert from JSON to AdAccountsAudience<PSCustomObject>
...
AdAccountsAudience<PSCustomObject>
#>
function ConvertFrom-JsonToAdAccountsAudience {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AdAccountsAudience' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AdAccountsAudience
