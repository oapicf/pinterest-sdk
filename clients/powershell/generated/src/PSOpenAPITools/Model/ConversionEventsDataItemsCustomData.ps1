...
ConversionEventsDataItemsCustomData<PSCustomObject>
#>

function Initialize-ConversionEventsDataItemsCustomData {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ConversionEventsDataItemsCustomData' | Write-Debug
...
Convert from JSON to ConversionEventsDataItemsCustomData<PSCustomObject>
...
ConversionEventsDataItemsCustomData<PSCustomObject>
#>
function ConvertFrom-JsonToConversionEventsDataItemsCustomData {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ConversionEventsDataItemsCustomData' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ConversionEventsDataItemsCustomData
