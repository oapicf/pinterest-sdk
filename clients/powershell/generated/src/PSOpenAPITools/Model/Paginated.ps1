...
Paginated<PSCustomObject>
#>

function Initialize-Paginated {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => Paginated' | Write-Debug
...
Convert from JSON to Paginated<PSCustomObject>
...
Paginated<PSCustomObject>
#>
function ConvertFrom-JsonToPaginated {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => Paginated' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Paginated
