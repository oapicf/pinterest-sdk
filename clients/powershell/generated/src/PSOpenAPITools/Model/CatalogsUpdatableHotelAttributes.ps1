...
function ConvertFrom-JsonToCatalogsUpdatableHotelAttributes {
    ...
    Process {
        ...
        $AllProperties = ("address", "base_price", "brand", "category", "custom_label_0", "custom_label_1", "custom_label_2", "custom_label_3", "custom_label_4", "description", "guest_ratings", "latitude", "link", "longitude", "name", "neighborhood", "sale_price")
