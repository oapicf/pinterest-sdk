...
CatalogsUpdatableHotelAttributes<PSCustomObject>
#>

function Initialize-CatalogsUpdatableHotelAttributes {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CatalogsUpdatableHotelAttributes' | Write-Debug
...
Convert from JSON to CatalogsUpdatableHotelAttributes<PSCustomObject>
...
CatalogsUpdatableHotelAttributes<PSCustomObject>
#>
function ConvertFrom-JsonToCatalogsUpdatableHotelAttributes {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CatalogsUpdatableHotelAttributes' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CatalogsUpdatableHotelAttributes
        $AllProperties = ("name", "link", "description", "brand", "latitude", "longitude", "neighborhood", "address", "custom_label_0", "custom_label_1", "custom_label_2", "custom_label_3", "custom_label_4", "category", "base_price", "sale_price", "guest_ratings")
