...
IntegrationLogsInvalidLogResponseRejectedLogsItems<PSCustomObject>
#>

function Initialize-IntegrationLogsInvalidLogResponseRejectedLogsItems {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => IntegrationLogsInvalidLogResponseRejectedLogsItems' | Write-Debug
...
Convert from JSON to IntegrationLogsInvalidLogResponseRejectedLogsItems<PSCustomObject>
...
IntegrationLogsInvalidLogResponseRejectedLogsItems<PSCustomObject>
#>
function ConvertFrom-JsonToIntegrationLogsInvalidLogResponseRejectedLogsItems {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => IntegrationLogsInvalidLogResponseRejectedLogsItems' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntegrationLogsInvalidLogResponseRejectedLogsItems
        $AllProperties = ('field', 'log_index', 'reason', 'value')
