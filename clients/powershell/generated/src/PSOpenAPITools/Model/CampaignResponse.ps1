...
function ConvertFrom-JsonToCampaignResponse {
    ...
    Process {
        ...
        $AllProperties = ("id", "ad_account_id", "name", "status", "lifetime_spend_cap", "daily_spend_cap", "order_line_id", "tracking_urls", "start_time", "end_time", "is_flexible_daily_budgets", "objective_type", "created_time", "updated_time", "type", "is_campaign_budget_optimization", "summary_status")
