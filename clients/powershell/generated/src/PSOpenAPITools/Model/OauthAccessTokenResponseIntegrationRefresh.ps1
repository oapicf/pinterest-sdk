...
OauthAccessTokenResponseIntegrationRefresh<PSCustomObject>
#>

function Initialize-OauthAccessTokenResponseIntegrationRefresh {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => OauthAccessTokenResponseIntegrationRefresh' | Write-Debug
...
Convert from JSON to OauthAccessTokenResponseIntegrationRefresh<PSCustomObject>
...
OauthAccessTokenResponseIntegrationRefresh<PSCustomObject>
#>
function ConvertFrom-JsonToOauthAccessTokenResponseIntegrationRefresh {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => OauthAccessTokenResponseIntegrationRefresh' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in OauthAccessTokenResponseIntegrationRefresh
        $AllProperties = ("refresh_token", "refresh_token_expires_in", "access_token", "expires_in", "response_type", "scope", "token_type")
