...
LocalInventoryUpsertOperation<PSCustomObject>
#>

function Initialize-LocalInventoryUpsertOperation {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => LocalInventoryUpsertOperation' | Write-Debug
...
Convert from JSON to LocalInventoryUpsertOperation<PSCustomObject>
...
LocalInventoryUpsertOperation<PSCustomObject>
#>
function ConvertFrom-JsonToLocalInventoryUpsertOperation {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => LocalInventoryUpsertOperation' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in LocalInventoryUpsertOperation
