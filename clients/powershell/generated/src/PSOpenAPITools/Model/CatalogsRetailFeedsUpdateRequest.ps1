...
CatalogsRetailFeedsUpdateRequest<PSCustomObject>
#>

function Initialize-CatalogsRetailFeedsUpdateRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CatalogsRetailFeedsUpdateRequest' | Write-Debug
...
Convert from JSON to CatalogsRetailFeedsUpdateRequest<PSCustomObject>
...
CatalogsRetailFeedsUpdateRequest<PSCustomObject>
#>
function ConvertFrom-JsonToCatalogsRetailFeedsUpdateRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CatalogsRetailFeedsUpdateRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CatalogsRetailFeedsUpdateRequest
        $AllProperties = ('catalog_type', 'credentials', 'default_availability', 'default_currency', 'format', 'location', 'name', 'preferred_processing_schedule', 'status')
