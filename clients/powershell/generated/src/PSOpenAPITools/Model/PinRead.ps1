...
PinRead<PSCustomObject>
#>

function Initialize-PinRead {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PinRead' | Write-Debug
...
Convert from JSON to PinRead<PSCustomObject>
...
PinRead<PSCustomObject>
#>
function ConvertFrom-JsonToPinRead {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PinRead' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PinRead
        $AllProperties = ('ai_disclosures', 'board_id', 'board_owner', 'board_section_id', 'created_at', 'creative_type', 'dominant_color', 'has_been_promoted', 'id', 'is_owner', 'is_product', 'is_standard', 'media', 'parent_pin_id', 'pin_metrics', 'alt_text', 'description', 'link', 'title')
