...
CampaignCreateItem<PSCustomObject>
#>

function Initialize-CampaignCreateItem {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CampaignCreateItem' | Write-Debug
...
Convert from JSON to CampaignCreateItem<PSCustomObject>
...
CampaignCreateItem<PSCustomObject>
#>
function ConvertFrom-JsonToCampaignCreateItem {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CampaignCreateItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CampaignCreateItem
        $AllProperties = ('ad_account_id', 'app_id', 'app_platform', 'bid_options', 'daily_spend_cap', 'default_ad_group_budget_in_micro_currency', 'end_time', 'intended_promotion_type', 'is_automated_campaign', 'is_campaign_budget_optimization', 'is_flexible_daily_budgets', 'is_ltv_optimized', 'is_performance_plus', 'is_top_of_search', 'lifetime_spend_cap', 'name', 'objective_type', 'order_line_id', 'start_time', 'status', 'tracking_urls')
