...
ProductGroupPromotionCreateRequestElement<PSCustomObject>
#>

function Initialize-ProductGroupPromotionCreateRequestElement {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ProductGroupPromotionCreateRequestElement' | Write-Debug
...
Convert from JSON to ProductGroupPromotionCreateRequestElement<PSCustomObject>
...
ProductGroupPromotionCreateRequestElement<PSCustomObject>
#>
function ConvertFrom-JsonToProductGroupPromotionCreateRequestElement {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ProductGroupPromotionCreateRequestElement' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ProductGroupPromotionCreateRequestElement
