...
CatalogsItemsDeleteBatchRequest<PSCustomObject>
#>

function Initialize-CatalogsItemsDeleteBatchRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CatalogsItemsDeleteBatchRequest' | Write-Debug
...
Convert from JSON to CatalogsItemsDeleteBatchRequest<PSCustomObject>
...
CatalogsItemsDeleteBatchRequest<PSCustomObject>
#>
function ConvertFrom-JsonToCatalogsItemsDeleteBatchRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CatalogsItemsDeleteBatchRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CatalogsItemsDeleteBatchRequest
