...
AssetGroupInputCreate<PSCustomObject>
#>

function Initialize-AssetGroupInputCreate {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AssetGroupInputCreate' | Write-Debug
...
Convert from JSON to AssetGroupInputCreate<PSCustomObject>
...
AssetGroupInputCreate<PSCustomObject>
#>
function ConvertFrom-JsonToAssetGroupInputCreate {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AssetGroupInputCreate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AssetGroupInputCreate
        $AllProperties = ('asset_group', 'asset_group_description', 'asset_group_name', 'asset_group_types')
        ...
        If ([string]::IsNullOrEmpty($Json) -or $Json -eq "{}") { # empty json
            throw "Error! Empty JSON cannot be serialized due to the required property 'asset_group_description' missing."
        }
