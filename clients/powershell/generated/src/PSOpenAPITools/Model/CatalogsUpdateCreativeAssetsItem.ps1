...
CatalogsUpdateCreativeAssetsItem<PSCustomObject>
#>

function Initialize-CatalogsUpdateCreativeAssetsItem {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CatalogsUpdateCreativeAssetsItem' | Write-Debug
...
Convert from JSON to CatalogsUpdateCreativeAssetsItem<PSCustomObject>
...
CatalogsUpdateCreativeAssetsItem<PSCustomObject>
#>
function ConvertFrom-JsonToCatalogsUpdateCreativeAssetsItem {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CatalogsUpdateCreativeAssetsItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CatalogsUpdateCreativeAssetsItem
