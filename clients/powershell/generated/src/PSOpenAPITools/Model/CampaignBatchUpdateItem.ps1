...
CampaignBatchUpdateItem<PSCustomObject>
#>

function Initialize-CampaignBatchUpdateItem {
    [CmdletBinding()]
    Param (
        ...
        [ValidateSet("AWARENESS", "CONSIDERATION", "WEB_CONVERSION", "CATALOG_SALES", "VIDEO_COMPLETION", "APP_INSTALL", "SALES", "LEADS", "CTV_CONSIDERATION")]
        [PSCustomObject]
        ${ObjectiveType},
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CampaignBatchUpdateItem' | Write-Debug
...
Convert from JSON to CampaignBatchUpdateItem<PSCustomObject>
...
CampaignBatchUpdateItem<PSCustomObject>
#>
function ConvertFrom-JsonToCampaignBatchUpdateItem {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CampaignBatchUpdateItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CampaignBatchUpdateItem
        $AllProperties = ('ad_account_id', 'app_id', 'app_platform', 'bid_options', 'daily_spend_cap', 'default_ad_group_budget_in_micro_currency', 'end_time', 'id', 'intended_promotion_type', 'is_automated_campaign', 'is_campaign_budget_optimization', 'is_flexible_daily_budgets', 'is_ltv_optimized', 'is_performance_plus', 'is_top_of_search', 'lifetime_spend_cap', 'name', 'objective_type', 'order_line_id', 'performance_plus_campaign_settings', 'start_time', 'status', 'tracking_urls')
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match 'app_platform'))) { #optional property not found
            $AppPlatform = $null
        } else {
            $AppPlatform = $JsonParameters.PSobject.Properties['app_platform'].value
        }
