...
function ConvertFrom-JsonToIntegrationMetadata {
    ...
    Process {
        ...
        $AllProperties = ('additional_id_1', 'connected_advertiser_id', 'connected_lba_id', 'connected_merchant_id', 'connected_tag_id', 'connected_user_id', 'created_timestamp', 'external_business_id', 'id', 'partner_access_token_expiry', 'partner_metadata', 'partner_refresh_token_expiry', 'scopes', 'updated_timestamp')
