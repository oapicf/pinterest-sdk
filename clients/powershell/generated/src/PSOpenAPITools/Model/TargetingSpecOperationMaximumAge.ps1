...
TargetingSpecOperationMaximumAge<PSCustomObject>
#>

function Initialize-TargetingSpecOperationMaximumAge {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("MAXIMUM_AGE")]
        [String]
        ${Field},
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TargetingSpecOperationMaximumAge' | Write-Debug
...
Convert from JSON to TargetingSpecOperationMaximumAge<PSCustomObject>
...
TargetingSpecOperationMaximumAge<PSCustomObject>
#>
function ConvertFrom-JsonToTargetingSpecOperationMaximumAge {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TargetingSpecOperationMaximumAge' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TargetingSpecOperationMaximumAge
