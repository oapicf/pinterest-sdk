...
CatalogsReportFeedIngestionStats<PSCustomObject>
#>

function Initialize-CatalogsReportFeedIngestionStats {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CatalogsReportFeedIngestionStats' | Write-Debug
...
Convert from JSON to CatalogsReportFeedIngestionStats<PSCustomObject>
...
CatalogsReportFeedIngestionStats<PSCustomObject>
#>
function ConvertFrom-JsonToCatalogsReportFeedIngestionStats {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CatalogsReportFeedIngestionStats' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CatalogsReportFeedIngestionStats
        $AllProperties = ("report_type", "catalog_id", "code", "code_label", "message", "occurrences", "severity")
