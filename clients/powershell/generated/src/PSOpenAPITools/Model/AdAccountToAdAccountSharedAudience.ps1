...
AdAccountToAdAccountSharedAudience<PSCustomObject>
#>

function Initialize-AdAccountToAdAccountSharedAudience {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AdAccountToAdAccountSharedAudience' | Write-Debug
...
Convert from JSON to AdAccountToAdAccountSharedAudience<PSCustomObject>
...
AdAccountToAdAccountSharedAudience<PSCustomObject>
#>
function ConvertFrom-JsonToAdAccountToAdAccountSharedAudience {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AdAccountToAdAccountSharedAudience' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AdAccountToAdAccountSharedAudience
