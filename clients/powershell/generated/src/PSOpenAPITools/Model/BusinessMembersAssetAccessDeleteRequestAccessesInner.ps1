...
BusinessMembersAssetAccessDeleteRequestAccessesInner<PSCustomObject>
#>

function Initialize-BusinessMembersAssetAccessDeleteRequestAccessesInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BusinessMembersAssetAccessDeleteRequestAccessesInner' | Write-Debug
...
Convert from JSON to BusinessMembersAssetAccessDeleteRequestAccessesInner<PSCustomObject>
...
BusinessMembersAssetAccessDeleteRequestAccessesInner<PSCustomObject>
#>
function ConvertFrom-JsonToBusinessMembersAssetAccessDeleteRequestAccessesInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BusinessMembersAssetAccessDeleteRequestAccessesInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BusinessMembersAssetAccessDeleteRequestAccessesInner
