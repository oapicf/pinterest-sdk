...
SSIOInsertionOrderCreate<PSCustomObject>
#>

function Initialize-SSIOInsertionOrderCreate {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SSIOInsertionOrderCreate' | Write-Debug
...
Convert from JSON to SSIOInsertionOrderCreate<PSCustomObject>
...
SSIOInsertionOrderCreate<PSCustomObject>
#>
function ConvertFrom-JsonToSSIOInsertionOrderCreate {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        If ([string]::IsNullOrEmpty($Json) -or $Json -eq "{}") { # empty json
            throw "Error! Empty JSON cannot be serialized due to the required property 'accepted_terms_id' missing."
        }
