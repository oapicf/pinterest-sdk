...
ProductTagsError<PSCustomObject>
#>

function Initialize-ProductTagsError {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ProductTagsError' | Write-Debug
...
Convert from JSON to ProductTagsError<PSCustomObject>
...
ProductTagsError<PSCustomObject>
#>
function ConvertFrom-JsonToProductTagsError {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ProductTagsError' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ProductTagsError
        $AllProperties = ('code', 'details', 'message')
