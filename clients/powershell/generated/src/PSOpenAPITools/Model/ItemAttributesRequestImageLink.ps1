...
ItemAttributesRequestImageLink<PSCustomObject>
#>
function ConvertFrom-JsonToItemAttributesRequestImageLink {
    [CmdletBinding()]
    Param (
        [AllowEmptyString()]
        [string]$Json
    ...
    Process {
        ...
        try {
            ...
            Write-Debug "Failed to match 'String' defined in oneOf (ItemAttributesRequestImageLink). Proceeding to the next one if any."
        }
