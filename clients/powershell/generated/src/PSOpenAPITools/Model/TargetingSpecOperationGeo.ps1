...
TargetingSpecOperationGeo<PSCustomObject>
#>

function Initialize-TargetingSpecOperationGeo {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TargetingSpecOperationGeo' | Write-Debug
...
Convert from JSON to TargetingSpecOperationGeo<PSCustomObject>
...
TargetingSpecOperationGeo<PSCustomObject>
#>
function ConvertFrom-JsonToTargetingSpecOperationGeo {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TargetingSpecOperationGeo' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TargetingSpecOperationGeo
