...
function ConvertFrom-JsonToCatalogsRetailFeedsCreateRequest {
    ...
    Process {
        ...
        $AllProperties = ('catalog_id', 'catalog_type', 'credentials', 'default_availability', 'default_country', 'default_currency', 'default_locale', 'format', 'location', 'name', 'preferred_processing_schedule', 'status')
