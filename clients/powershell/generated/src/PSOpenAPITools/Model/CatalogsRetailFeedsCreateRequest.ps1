...
function ConvertFrom-JsonToCatalogsRetailFeedsCreateRequest {
    ...
    Process {
        ...
        $AllProperties = ("default_currency", "name", "format", "default_locale", "credentials", "location", "preferred_processing_schedule", "catalog_type", "default_country", "default_availability")
