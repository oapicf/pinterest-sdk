...
ProductGroupPromotionCreateRequest<PSCustomObject>
#>

function Initialize-ProductGroupPromotionCreateRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ProductGroupPromotionCreateRequest' | Write-Debug
...
Convert from JSON to ProductGroupPromotionCreateRequest<PSCustomObject>
...
ProductGroupPromotionCreateRequest<PSCustomObject>
#>
function ConvertFrom-JsonToProductGroupPromotionCreateRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ProductGroupPromotionCreateRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ProductGroupPromotionCreateRequest
