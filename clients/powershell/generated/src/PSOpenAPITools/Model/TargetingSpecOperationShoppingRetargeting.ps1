...
TargetingSpecOperationShoppingRetargeting<PSCustomObject>
#>

function Initialize-TargetingSpecOperationShoppingRetargeting {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("SHOPPING_RETARGETING")]
        [String]
        ${Field},
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TargetingSpecOperationShoppingRetargeting' | Write-Debug
...
Convert from JSON to TargetingSpecOperationShoppingRetargeting<PSCustomObject>
...
TargetingSpecOperationShoppingRetargeting<PSCustomObject>
#>
function ConvertFrom-JsonToTargetingSpecOperationShoppingRetargeting {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TargetingSpecOperationShoppingRetargeting' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TargetingSpecOperationShoppingRetargeting
