...
CustomConversionEventMetrics<PSCustomObject>
#>

function Initialize-CustomConversionEventMetrics {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CustomConversionEventMetrics' | Write-Debug
...
Convert from JSON to CustomConversionEventMetrics<PSCustomObject>
...
CustomConversionEventMetrics<PSCustomObject>
#>
function ConvertFrom-JsonToCustomConversionEventMetrics {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CustomConversionEventMetrics' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CustomConversionEventMetrics
