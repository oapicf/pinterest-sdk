...
AdGroupCreateCreate<PSCustomObject>
#>

function Initialize-AdGroupCreateCreate {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AdGroupCreateCreate' | Write-Debug
...
Convert from JSON to AdGroupCreateCreate<PSCustomObject>
...
AdGroupCreateCreate<PSCustomObject>
#>
function ConvertFrom-JsonToAdGroupCreateCreate {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AdGroupCreateCreate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AdGroupCreateCreate
