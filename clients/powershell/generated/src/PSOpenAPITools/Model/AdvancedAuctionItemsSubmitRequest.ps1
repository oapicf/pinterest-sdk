...
AdvancedAuctionItemsSubmitRequest<PSCustomObject>
#>

function Initialize-AdvancedAuctionItemsSubmitRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AdvancedAuctionItemsSubmitRequest' | Write-Debug
...
Convert from JSON to AdvancedAuctionItemsSubmitRequest<PSCustomObject>
...
AdvancedAuctionItemsSubmitRequest<PSCustomObject>
#>
function ConvertFrom-JsonToAdvancedAuctionItemsSubmitRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AdvancedAuctionItemsSubmitRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AdvancedAuctionItemsSubmitRequest
