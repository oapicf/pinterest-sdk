...
function Initialize-IntegrationRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => IntegrationRequest' | Write-Debug
...
Convert from JSON to IntegrationRequest<PSCustomObject>
...
IntegrationRequest<PSCustomObject>
#>
function ConvertFrom-JsonToIntegrationRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => IntegrationRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntegrationRequest
        $AllProperties = ("external_business_id", "connected_merchant_id", "connected_advertiser_id", "connected_lba_id", "connected_tag_id", "partner_access_token", "partner_refresh_token", "partner_primary_email", "partner_access_token_expiry", "partner_refresh_token_expiry", "scopes", "additional_id_1", "partner_metadata")
