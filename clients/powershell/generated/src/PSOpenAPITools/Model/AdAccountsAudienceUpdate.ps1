...
AdAccountsAudienceUpdate<PSCustomObject>
#>

function Initialize-AdAccountsAudienceUpdate {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AdAccountsAudienceUpdate' | Write-Debug
...
Convert from JSON to AdAccountsAudienceUpdate<PSCustomObject>
...
AdAccountsAudienceUpdate<PSCustomObject>
#>
function ConvertFrom-JsonToAdAccountsAudienceUpdate {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AdAccountsAudienceUpdate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AdAccountsAudienceUpdate
        $AllProperties = ('ad_account_id', 'audience_type', 'description', 'name', 'operation_type', 'rule')
