...
AdvancedAuctionItemsSubmitDeleteRecord<PSCustomObject>
#>

function Initialize-AdvancedAuctionItemsSubmitDeleteRecord {
    [CmdletBinding()]
    Param (
        ...
        [ValidateSet("AM", "AR", "AZ", "BG", "BN", "BS", "CA", "CS", "DA", "DV", "DZ", "DE", "EL", "EN", "ES", "ET", "FA", "FI", "FR", "HE", "HI", "HR", "HU", "HY", "ID", "IN", "IS", "IT", "IW", "JA", "KA", "KM", "KO", "LO", "LT", "LV", "MK", "MN", "MS", "MY", "NB", "NE", "NL", "false", "PL", "PT", "RO", "RU", "SK", "SL", "SQ", "SR", "SV", "TL", "UK", "VI", "TE", "TH", "TR", "XX", "ZH")]
        [PSCustomObject]
        ${Language},
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AdvancedAuctionItemsSubmitDeleteRecord' | Write-Debug
...
Convert from JSON to AdvancedAuctionItemsSubmitDeleteRecord<PSCustomObject>
...
AdvancedAuctionItemsSubmitDeleteRecord<PSCustomObject>
#>
function ConvertFrom-JsonToAdvancedAuctionItemsSubmitDeleteRecord {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AdvancedAuctionItemsSubmitDeleteRecord' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AdvancedAuctionItemsSubmitDeleteRecord
        $AllProperties = ('country', 'errors', 'item_id', 'language', 'operation')
