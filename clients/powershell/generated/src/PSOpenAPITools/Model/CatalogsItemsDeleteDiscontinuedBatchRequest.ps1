...
CatalogsItemsDeleteDiscontinuedBatchRequest<PSCustomObject>
#>

function Initialize-CatalogsItemsDeleteDiscontinuedBatchRequest {
    [CmdletBinding()]
    Param (
...
Convert from JSON to CatalogsItemsDeleteDiscontinuedBatchRequest<PSCustomObject>
...
CatalogsItemsDeleteDiscontinuedBatchRequest<PSCustomObject>
#>
function ConvertFrom-JsonToCatalogsItemsDeleteDiscontinuedBatchRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CatalogsItemsDeleteDiscontinuedBatchRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CatalogsItemsDeleteDiscontinuedBatchRequest
        $AllProperties = ('country', 'items', 'language', 'operation')
