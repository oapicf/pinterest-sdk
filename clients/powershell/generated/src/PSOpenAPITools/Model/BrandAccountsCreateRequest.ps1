...
BrandAccountsCreateRequest<PSCustomObject>
#>

function Initialize-BrandAccountsCreateRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BrandAccountsCreateRequest' | Write-Debug
...
Convert from JSON to BrandAccountsCreateRequest<PSCustomObject>
...
BrandAccountsCreateRequest<PSCustomObject>
#>
function ConvertFrom-JsonToBrandAccountsCreateRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BrandAccountsCreateRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BrandAccountsCreateRequest
