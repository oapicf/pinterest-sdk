...
DeletePartnerAssetAccessBody<PSCustomObject>
#>

function Initialize-DeletePartnerAssetAccessBody {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => DeletePartnerAssetAccessBody' | Write-Debug
...
Convert from JSON to DeletePartnerAssetAccessBody<PSCustomObject>
...
DeletePartnerAssetAccessBody<PSCustomObject>
#>
function ConvertFrom-JsonToDeletePartnerAssetAccessBody {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => DeletePartnerAssetAccessBody' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in DeletePartnerAssetAccessBody
