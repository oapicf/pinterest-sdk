...
PinsList200Response<PSCustomObject>
#>

function Initialize-PinsList200Response {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PinsList200Response' | Write-Debug
...
Convert from JSON to PinsList200Response<PSCustomObject>
...
PinsList200Response<PSCustomObject>
#>
function ConvertFrom-JsonToPinsList200Response {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PinsList200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PinsList200Response
