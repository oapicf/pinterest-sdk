...
CampaignBatchResponseData<PSCustomObject>
#>

function Initialize-CampaignBatchResponseData {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CampaignBatchResponseData' | Write-Debug
...
Convert from JSON to CampaignBatchResponseData<PSCustomObject>
...
CampaignBatchResponseData<PSCustomObject>
#>
function ConvertFrom-JsonToCampaignBatchResponseData {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CampaignBatchResponseData' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CampaignBatchResponseData
