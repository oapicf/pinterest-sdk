...
OauthAccessToken<PSCustomObject>
#>
...
function Initialize-OauthAccessToken {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => OauthAccessToken' | Write-Debug
...
Convert from JSON to OauthAccessToken<PSCustomObject>
...
OauthAccessToken<PSCustomObject>
#>
function ConvertFrom-JsonToOauthAccessToken {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => OauthAccessToken' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in OauthAccessToken
        $AllProperties = ('access_token', 'expires_in', 'refresh_token', 'refresh_token_expires_at', 'refresh_token_expires_in', 'response_type', 'scope', 'token_type')
