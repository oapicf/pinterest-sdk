...
CatalogsReportAllItemsFilter<PSCustomObject>
#>

function Initialize-CatalogsReportAllItemsFilter {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CatalogsReportAllItemsFilter' | Write-Debug
...
Convert from JSON to CatalogsReportAllItemsFilter<PSCustomObject>
...
CatalogsReportAllItemsFilter<PSCustomObject>
#>
function ConvertFrom-JsonToCatalogsReportAllItemsFilter {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CatalogsReportAllItemsFilter' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CatalogsReportAllItemsFilter
