...
ImageBase64<PSCustomObject>
#>

function Initialize-ImageBase64 {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ImageBase64' | Write-Debug
...
Convert from JSON to ImageBase64<PSCustomObject>
...
ImageBase64<PSCustomObject>
#>
function ConvertFrom-JsonToImageBase64 {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ImageBase64' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ImageBase64
