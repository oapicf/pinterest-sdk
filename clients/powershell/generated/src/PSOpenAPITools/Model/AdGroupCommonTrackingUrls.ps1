...
AdGroupCommonTrackingUrls<PSCustomObject>
#>

function Initialize-AdGroupCommonTrackingUrls {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AdGroupCommonTrackingUrls' | Write-Debug
...
Convert from JSON to AdGroupCommonTrackingUrls<PSCustomObject>
...
AdGroupCommonTrackingUrls<PSCustomObject>
#>
function ConvertFrom-JsonToAdGroupCommonTrackingUrls {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AdGroupCommonTrackingUrls' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AdGroupCommonTrackingUrls
