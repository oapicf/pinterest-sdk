...
TargetingSpecOperationInterest<PSCustomObject>
#>

function Initialize-TargetingSpecOperationInterest {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("INTEREST")]
        [String]
        ${Field},
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TargetingSpecOperationInterest' | Write-Debug
...
Convert from JSON to TargetingSpecOperationInterest<PSCustomObject>
...
TargetingSpecOperationInterest<PSCustomObject>
#>
function ConvertFrom-JsonToTargetingSpecOperationInterest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TargetingSpecOperationInterest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TargetingSpecOperationInterest
