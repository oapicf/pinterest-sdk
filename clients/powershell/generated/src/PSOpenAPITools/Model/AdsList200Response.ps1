...
AdsList200Response<PSCustomObject>
#>

function Initialize-AdsList200Response {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AdsList200Response' | Write-Debug
...
Convert from JSON to AdsList200Response<PSCustomObject>
...
AdsList200Response<PSCustomObject>
#>
function ConvertFrom-JsonToAdsList200Response {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AdsList200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AdsList200Response
