...
CatalogsCreativeAssetsFeedsCreateRequest<PSCustomObject>
#>

function Initialize-CatalogsCreativeAssetsFeedsCreateRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CatalogsCreativeAssetsFeedsCreateRequest' | Write-Debug
...
Convert from JSON to CatalogsCreativeAssetsFeedsCreateRequest<PSCustomObject>
...
CatalogsCreativeAssetsFeedsCreateRequest<PSCustomObject>
#>
function ConvertFrom-JsonToCatalogsCreativeAssetsFeedsCreateRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CatalogsCreativeAssetsFeedsCreateRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CatalogsCreativeAssetsFeedsCreateRequest
        $AllProperties = ('catalog_id', 'catalog_type', 'credentials', 'default_country', 'default_currency', 'default_locale', 'format', 'location', 'name', 'preferred_processing_schedule', 'status')
