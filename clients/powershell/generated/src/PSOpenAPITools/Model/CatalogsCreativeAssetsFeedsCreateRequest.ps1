...
function ConvertFrom-JsonToCatalogsCreativeAssetsFeedsCreateRequest {
    ...
    Process {
        ...
        $AllProperties = ("default_currency", "name", "format", "default_locale", "default_country", "credentials", "location", "preferred_processing_schedule", "catalog_type", "catalog_id", "status")
