...
function ConvertFrom-JsonToSSIOInsertionOrderCommon {
    ...
    Process {
        ...
        $AllProperties = ("agency_link", "billing_contact_email", "billing_contact_firstname", "billing_contact_lastname", "budget_amount", "end_date", "media_contact_email", "media_contact_firstname", "media_contact_lastname", "po_number", "start_date", "user_email")
