...
AdGroupCreate<PSCustomObject>
#>

function Initialize-AdGroupCreate {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AdGroupCreate' | Write-Debug
...
Convert from JSON to AdGroupCreate<PSCustomObject>
...
AdGroupCreate<PSCustomObject>
#>
function ConvertFrom-JsonToAdGroupCreate {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AdGroupCreate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AdGroupCreate
