...
TargetingSpecOperationMinMaxAge<PSCustomObject>
#>

function Initialize-TargetingSpecOperationMinMaxAge {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("MINIMUM_AGE", "MAXIMUM_AGE")]
        [String]
        ${Field},
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TargetingSpecOperationMinMaxAge' | Write-Debug
...
Convert from JSON to TargetingSpecOperationMinMaxAge<PSCustomObject>
...
TargetingSpecOperationMinMaxAge<PSCustomObject>
#>
function ConvertFrom-JsonToTargetingSpecOperationMinMaxAge {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TargetingSpecOperationMinMaxAge' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TargetingSpecOperationMinMaxAge
