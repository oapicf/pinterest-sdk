...
TargetingSpecOperationAudienceExclude<PSCustomObject>
#>

function Initialize-TargetingSpecOperationAudienceExclude {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("AUDIENCE_EXCLUDE")]
        [String]
        ${Field},
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TargetingSpecOperationAudienceExclude' | Write-Debug
...
Convert from JSON to TargetingSpecOperationAudienceExclude<PSCustomObject>
...
TargetingSpecOperationAudienceExclude<PSCustomObject>
#>
function ConvertFrom-JsonToTargetingSpecOperationAudienceExclude {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TargetingSpecOperationAudienceExclude' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TargetingSpecOperationAudienceExclude
