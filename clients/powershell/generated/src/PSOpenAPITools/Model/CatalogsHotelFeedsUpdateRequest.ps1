...
CatalogsHotelFeedsUpdateRequest<PSCustomObject>
#>

function Initialize-CatalogsHotelFeedsUpdateRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CatalogsHotelFeedsUpdateRequest' | Write-Debug
...
Convert from JSON to CatalogsHotelFeedsUpdateRequest<PSCustomObject>
...
CatalogsHotelFeedsUpdateRequest<PSCustomObject>
#>
function ConvertFrom-JsonToCatalogsHotelFeedsUpdateRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CatalogsHotelFeedsUpdateRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CatalogsHotelFeedsUpdateRequest
        $AllProperties = ('catalog_type', 'credentials', 'default_currency', 'format', 'location', 'name', 'preferred_processing_schedule', 'status')
