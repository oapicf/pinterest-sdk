...
OauthAccessTokenResponseEverlastingRefresh<PSCustomObject>
#>

function Initialize-OauthAccessTokenResponseEverlastingRefresh {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => OauthAccessTokenResponseEverlastingRefresh' | Write-Debug
...
Convert from JSON to OauthAccessTokenResponseEverlastingRefresh<PSCustomObject>
...
OauthAccessTokenResponseEverlastingRefresh<PSCustomObject>
#>
function ConvertFrom-JsonToOauthAccessTokenResponseEverlastingRefresh {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => OauthAccessTokenResponseEverlastingRefresh' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in OauthAccessTokenResponseEverlastingRefresh
        $AllProperties = ("response_type", "access_token", "token_type", "expires_in", "scope", "refresh_token", "refresh_token_expires_in", "refresh_token_expires_at")
