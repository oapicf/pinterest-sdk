...
AdvancedAuctionKey<PSCustomObject>
#>

function Initialize-AdvancedAuctionKey {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AdvancedAuctionKey' | Write-Debug
...
Convert from JSON to AdvancedAuctionKey<PSCustomObject>
...
AdvancedAuctionKey<PSCustomObject>
#>
function ConvertFrom-JsonToAdvancedAuctionKey {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AdvancedAuctionKey' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AdvancedAuctionKey
        $AllProperties = ('country', 'item_id', 'language')
