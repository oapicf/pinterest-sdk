...
CatalogsHotelItemsFilter<PSCustomObject>
#>

function Initialize-CatalogsHotelItemsFilter {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CatalogsHotelItemsFilter' | Write-Debug
        ...
        if ($HotelIds.length -gt 100) {
            throw "invalid value for 'HotelIds', number of items must be less than or equal to 100."
        }
...
Convert from JSON to CatalogsHotelItemsFilter<PSCustomObject>
...
CatalogsHotelItemsFilter<PSCustomObject>
#>
function ConvertFrom-JsonToCatalogsHotelItemsFilter {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CatalogsHotelItemsFilter' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CatalogsHotelItemsFilter
