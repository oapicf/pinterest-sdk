...
AdGroupAudienceSizing<PSCustomObject>
#>

function Initialize-AdGroupAudienceSizing {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AdGroupAudienceSizing' | Write-Debug
...
Convert from JSON to AdGroupAudienceSizing<PSCustomObject>
...
AdGroupAudienceSizing<PSCustomObject>
#>
function ConvertFrom-JsonToAdGroupAudienceSizing {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AdGroupAudienceSizing' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AdGroupAudienceSizing
