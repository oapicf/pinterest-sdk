...
.PARAMETER FETCHGOOGLESHEETNOTSHARED
...
function ConvertFrom-JsonToCatalogsFeedIngestionErrors {
    ...
    Process {
        ...
        $AllProperties = ("ACCOUNT_FLAGGED", "FETCH_GOOGLE_SHEET_NOT_SHARED", "IMAGE_FILE_NOT_ACCESSIBLE", "IMAGE_FILE_NOT_FOUND", "IMAGE_INVALID_FILE", "IMAGE_LEVEL_INTERNAL_ERROR", "IMAGE_MALFORMED_URL", "LARGE_PRODUCT_COUNT_DECREASE", "LINE_LEVEL_INTERNAL_ERROR")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "FETCH_GOOGLE_SHEET_NOT_SHARED"))) { #optional property not found
            $FETCHGOOGLESHEETNOTSHARED = $null
        } else {
            $FETCHGOOGLESHEETNOTSHARED = $JsonParameters.PSobject.Properties["FETCH_GOOGLE_SHEET_NOT_SHARED"].value
        }
