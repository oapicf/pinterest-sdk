...
TargetingSpecOperationLocale<PSCustomObject>
#>

function Initialize-TargetingSpecOperationLocale {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TargetingSpecOperationLocale' | Write-Debug
...
Convert from JSON to TargetingSpecOperationLocale<PSCustomObject>
...
TargetingSpecOperationLocale<PSCustomObject>
#>
function ConvertFrom-JsonToTargetingSpecOperationLocale {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TargetingSpecOperationLocale' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TargetingSpecOperationLocale
