    ...
    Process {
        ...
        if ($match -ne 0) { # no match yet
            ...
            try {
                ...
                # fail to match the schema defined in anyOf, proceed to the next one
                Write-Debug "Failed to match 'TitleKeywordsFilter' defined in anyOf (CatalogsHotelProductGroupFilterKeys). Proceeding to the next one if any."
            }
        }
        ...
        if ($match -eq 1) {
            return [PSCustomObject]@{
                ...
                "anyOfSchemas" = @("BrandFilter", "CountryFilter", "CustomLabel0Filter", "CustomLabel1Filter", "CustomLabel2Filter", "CustomLabel3Filter", "CustomLabel4Filter", "HotelIdFilter", "PriceFilter", "TitleKeywordsFilter")
            }
        } else {
            throw "Error! The JSON payload doesn't matches any type defined in anyOf schemas ([BrandFilter, CountryFilter, CustomLabel0Filter, CustomLabel1Filter, CustomLabel2Filter, CustomLabel3Filter, CustomLabel4Filter, HotelIdFilter, PriceFilter, TitleKeywordsFilter]). JSON Payload: $($Json)"
        }
    }
}
