...
AdvancedAuctionProcessedItem<PSCustomObject>
#>

function Initialize-AdvancedAuctionProcessedItem {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AdvancedAuctionProcessedItem' | Write-Debug
...
Convert from JSON to AdvancedAuctionProcessedItem<PSCustomObject>
...
AdvancedAuctionProcessedItem<PSCustomObject>
#>
function ConvertFrom-JsonToAdvancedAuctionProcessedItem {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AdvancedAuctionProcessedItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AdvancedAuctionProcessedItem
        $AllProperties = ("operation", "item_id", "country", "language", "bid_options", "update_mask", "errors")
