...
BrandAccountUpdate<PSCustomObject>
#>

function Initialize-BrandAccountUpdate {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BrandAccountUpdate' | Write-Debug
...
Convert from JSON to BrandAccountUpdate<PSCustomObject>
...
BrandAccountUpdate<PSCustomObject>
#>
function ConvertFrom-JsonToBrandAccountUpdate {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BrandAccountUpdate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BrandAccountUpdate
