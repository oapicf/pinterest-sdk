...
UpdateMemberAssetAccessItem<PSCustomObject>
#>

function Initialize-UpdateMemberAssetAccessItem {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => UpdateMemberAssetAccessItem' | Write-Debug
...
Convert from JSON to UpdateMemberAssetAccessItem<PSCustomObject>
...
UpdateMemberAssetAccessItem<PSCustomObject>
#>
function ConvertFrom-JsonToUpdateMemberAssetAccessItem {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => UpdateMemberAssetAccessItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in UpdateMemberAssetAccessItem
