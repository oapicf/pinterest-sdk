...
BulkDownloadCampaignFilter<PSCustomObject>
#>

function Initialize-BulkDownloadCampaignFilter {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BulkDownloadCampaignFilter' | Write-Debug
...
Convert from JSON to BulkDownloadCampaignFilter<PSCustomObject>
...
BulkDownloadCampaignFilter<PSCustomObject>
#>
function ConvertFrom-JsonToBulkDownloadCampaignFilter {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BulkDownloadCampaignFilter' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BulkDownloadCampaignFilter
        $AllProperties = ('campaign_status', 'end_time', 'name', 'objective_type', 'start_time')
