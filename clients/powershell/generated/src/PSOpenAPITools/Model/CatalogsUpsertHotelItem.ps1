...
CatalogsUpsertHotelItem<PSCustomObject>
#>

function Initialize-CatalogsUpsertHotelItem {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CatalogsUpsertHotelItem' | Write-Debug
...
Convert from JSON to CatalogsUpsertHotelItem<PSCustomObject>
...
CatalogsUpsertHotelItem<PSCustomObject>
#>
function ConvertFrom-JsonToCatalogsUpsertHotelItem {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CatalogsUpsertHotelItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CatalogsUpsertHotelItem
