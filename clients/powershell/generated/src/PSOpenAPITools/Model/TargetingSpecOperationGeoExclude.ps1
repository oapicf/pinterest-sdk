...
TargetingSpecOperationGeoExclude<PSCustomObject>
#>

function Initialize-TargetingSpecOperationGeoExclude {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("GEO_EXCLUDE")]
        [String]
        ${Field},
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TargetingSpecOperationGeoExclude' | Write-Debug
...
Convert from JSON to TargetingSpecOperationGeoExclude<PSCustomObject>
...
TargetingSpecOperationGeoExclude<PSCustomObject>
#>
function ConvertFrom-JsonToTargetingSpecOperationGeoExclude {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TargetingSpecOperationGeoExclude' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TargetingSpecOperationGeoExclude
