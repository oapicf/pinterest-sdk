...
function Initialize-LocalStore {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => LocalStore' | Write-Debug
...
Convert from JSON to LocalStore<PSCustomObject>
...
LocalStore<PSCustomObject>
#>
function ConvertFrom-JsonToLocalStore {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => LocalStore' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in LocalStore
        $AllProperties = ('address_primary', 'address_secondary', 'city', 'country', 'created_at', 'id', 'latitude', 'longitude', 'name', 'postal_code', 'region', 'store_code', 'updated_at')
