...
IntegrationMetadataUpdate<PSCustomObject>
#>

function Initialize-IntegrationMetadataUpdate {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => IntegrationMetadataUpdate' | Write-Debug
...
Convert from JSON to IntegrationMetadataUpdate<PSCustomObject>
...
IntegrationMetadataUpdate<PSCustomObject>
#>
function ConvertFrom-JsonToIntegrationMetadataUpdate {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => IntegrationMetadataUpdate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntegrationMetadataUpdate
