...
function ConvertFrom-JsonToOptimizationGoalMetadataConversionTagV3GoalMetadata {
    ...
    Process {
        ...
        $AllProperties = ("attribution_windows", "conversion_event", "conversion_tag_id", "cpa_goal_value_in_micro_currency", "is_roas_optimized", "learning_mode_type", "reporting_event")
