...
CatalogsProductMetadata<PSCustomObject>
#>

function Initialize-CatalogsProductMetadata {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CatalogsProductMetadata' | Write-Debug
...
Convert from JSON to CatalogsProductMetadata<PSCustomObject>
...
CatalogsProductMetadata<PSCustomObject>
#>
function ConvertFrom-JsonToCatalogsProductMetadata {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CatalogsProductMetadata' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CatalogsProductMetadata
