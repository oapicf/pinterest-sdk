...
KeywordCreateItem<PSCustomObject>
#>

function Initialize-KeywordCreateItem {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => KeywordCreateItem' | Write-Debug
...
Convert from JSON to KeywordCreateItem<PSCustomObject>
...
KeywordCreateItem<PSCustomObject>
#>
function ConvertFrom-JsonToKeywordCreateItem {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => KeywordCreateItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in KeywordCreateItem
