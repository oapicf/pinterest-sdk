...
ConversionAccessTokenResponse<PSCustomObject>
#>

function Initialize-ConversionAccessTokenResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ConversionAccessTokenResponse' | Write-Debug
...
Convert from JSON to ConversionAccessTokenResponse<PSCustomObject>
...
ConversionAccessTokenResponse<PSCustomObject>
#>
function ConvertFrom-JsonToConversionAccessTokenResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ConversionAccessTokenResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ConversionAccessTokenResponse
