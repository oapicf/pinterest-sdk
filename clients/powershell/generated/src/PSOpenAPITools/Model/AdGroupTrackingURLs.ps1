...
AdGroupTrackingURLs<PSCustomObject>
#>

function Initialize-AdGroupTrackingURLs {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AdGroupTrackingURLs' | Write-Debug
...
Convert from JSON to AdGroupTrackingURLs<PSCustomObject>
...
AdGroupTrackingURLs<PSCustomObject>
#>
function ConvertFrom-JsonToAdGroupTrackingURLs {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AdGroupTrackingURLs' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AdGroupTrackingURLs
        $AllProperties = ('audience_verification', 'buyable_button', 'click', 'engagement', 'impression')
