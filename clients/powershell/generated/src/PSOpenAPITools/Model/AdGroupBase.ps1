...
AdGroupBase<PSCustomObject>
#>

function Initialize-AdGroupBase {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AdGroupBase' | Write-Debug
...
Convert from JSON to AdGroupBase<PSCustomObject>
...
AdGroupBase<PSCustomObject>
#>
function ConvertFrom-JsonToAdGroupBase {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AdGroupBase' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AdGroupBase
