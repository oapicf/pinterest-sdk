...
function ConvertFrom-JsonToTargetingTemplateGetResponseData {
    ...
    Process {
        ...
        $AllProperties = ("name", "auto_targeting_enabled", "targeting_attributes", "placement_group", "keywords", "tracking_urls", "id", "created_time", "updated_time", "ad_account_id", "status", "sizing", "valid")
