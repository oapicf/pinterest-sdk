...
UpdatePartnerAssetAccessItem<PSCustomObject>
#>

function Initialize-UpdatePartnerAssetAccessItem {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => UpdatePartnerAssetAccessItem' | Write-Debug
...
Convert from JSON to UpdatePartnerAssetAccessItem<PSCustomObject>
...
UpdatePartnerAssetAccessItem<PSCustomObject>
#>
function ConvertFrom-JsonToUpdatePartnerAssetAccessItem {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => UpdatePartnerAssetAccessItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in UpdatePartnerAssetAccessItem
        $AllProperties = ('asset_id', 'partner_id', 'permissions')
