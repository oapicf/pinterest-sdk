...
TargetingSpecOperationList<PSCustomObject>
#>

function Initialize-TargetingSpecOperationList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TargetingSpecOperationList' | Write-Debug
...
Convert from JSON to TargetingSpecOperationList<PSCustomObject>
...
TargetingSpecOperationList<PSCustomObject>
#>
function ConvertFrom-JsonToTargetingSpecOperationList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TargetingSpecOperationList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TargetingSpecOperationList
