...
BusinessAccessError<PSCustomObject>
#>

function Initialize-BusinessAccessError {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BusinessAccessError' | Write-Debug
...
Convert from JSON to BusinessAccessError<PSCustomObject>
...
BusinessAccessError<PSCustomObject>
#>
function ConvertFrom-JsonToBusinessAccessError {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BusinessAccessError' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BusinessAccessError
