...
function ConvertFrom-JsonToCatalogsFeedsCreateRequest {
    ...
    Process {
        ...
        $AllProperties = ("default_currency", "name", "format", "default_locale", "credentials", "location", "preferred_processing_schedule", "default_country", "default_availability", "status")
