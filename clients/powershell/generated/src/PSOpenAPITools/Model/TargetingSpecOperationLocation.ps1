...
TargetingSpecOperationLocation<PSCustomObject>
#>

function Initialize-TargetingSpecOperationLocation {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TargetingSpecOperationLocation' | Write-Debug
...
Convert from JSON to TargetingSpecOperationLocation<PSCustomObject>
...
TargetingSpecOperationLocation<PSCustomObject>
#>
function ConvertFrom-JsonToTargetingSpecOperationLocation {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TargetingSpecOperationLocation' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TargetingSpecOperationLocation
