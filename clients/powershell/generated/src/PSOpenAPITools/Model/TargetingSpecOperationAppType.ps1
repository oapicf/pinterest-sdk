...
TargetingSpecOperationAppType<PSCustomObject>
#>

function Initialize-TargetingSpecOperationAppType {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TargetingSpecOperationAppType' | Write-Debug
...
Convert from JSON to TargetingSpecOperationAppType<PSCustomObject>
...
TargetingSpecOperationAppType<PSCustomObject>
#>
function ConvertFrom-JsonToTargetingSpecOperationAppType {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TargetingSpecOperationAppType' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TargetingSpecOperationAppType
