...
LocalInventoryUpdateOperation<PSCustomObject>
#>

function Initialize-LocalInventoryUpdateOperation {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => LocalInventoryUpdateOperation' | Write-Debug
...
Convert from JSON to LocalInventoryUpdateOperation<PSCustomObject>
...
LocalInventoryUpdateOperation<PSCustomObject>
#>
function ConvertFrom-JsonToLocalInventoryUpdateOperation {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => LocalInventoryUpdateOperation' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in LocalInventoryUpdateOperation
