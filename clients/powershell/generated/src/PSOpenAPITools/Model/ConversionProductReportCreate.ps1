...
ConversionProductReportCreate<PSCustomObject>
#>

function Initialize-ConversionProductReportCreate {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ConversionProductReportCreate' | Write-Debug
        ...
        if (!$ProductSkuIds -and $ProductSkuIds.length -gt 30000) {
            throw "invalid value for 'ProductSkuIds', number of items must be less than or equal to 30000."
        }
...
Convert from JSON to ConversionProductReportCreate<PSCustomObject>
...
ConversionProductReportCreate<PSCustomObject>
#>
function ConvertFrom-JsonToConversionProductReportCreate {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ConversionProductReportCreate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ConversionProductReportCreate
