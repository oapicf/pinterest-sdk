...
BoardBase<PSCustomObject>
#>

function Initialize-BoardBase {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BoardBase' | Write-Debug
...
Convert from JSON to BoardBase<PSCustomObject>
...
BoardBase<PSCustomObject>
#>
function ConvertFrom-JsonToBoardBase {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BoardBase' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BoardBase
        $AllProperties = ("board_pins_modified_at", "collaborator_count", "created_at", "description", "follower_count", "id", "is_ads_only", "media", "name", "owner", "pin_count")
