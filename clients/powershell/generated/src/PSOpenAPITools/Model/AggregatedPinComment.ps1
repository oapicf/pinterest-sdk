...
AggregatedPinComment<PSCustomObject>
#>

function Initialize-AggregatedPinComment {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AggregatedPinComment' | Write-Debug
...
Convert from JSON to AggregatedPinComment<PSCustomObject>
...
AggregatedPinComment<PSCustomObject>
#>
function ConvertFrom-JsonToAggregatedPinComment {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AggregatedPinComment' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AggregatedPinComment
        $AllProperties = ('ai_disclosures', 'alt_text', 'board_id', 'board_owner', 'board_section_id', 'created_at', 'creative_type', 'description', 'dominant_color', 'has_been_promoted', 'id', 'is_owner', 'is_product', 'is_standard', 'link', 'media', 'parent_pin_id', 'pin_metrics', 'title')
