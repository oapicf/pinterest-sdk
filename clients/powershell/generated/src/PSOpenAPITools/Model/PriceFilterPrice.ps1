...
PriceFilterPrice<PSCustomObject>
#>

function Initialize-PriceFilterPrice {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PriceFilterPrice' | Write-Debug
...
Convert from JSON to PriceFilterPrice<PSCustomObject>
...
PriceFilterPrice<PSCustomObject>
#>
function ConvertFrom-JsonToPriceFilterPrice {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PriceFilterPrice' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PriceFilterPrice
