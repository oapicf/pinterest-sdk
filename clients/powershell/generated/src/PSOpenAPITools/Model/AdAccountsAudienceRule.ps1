...
AdAccountsAudienceRule<PSCustomObject>
#>

function Initialize-AdAccountsAudienceRule {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AdAccountsAudienceRule' | Write-Debug
...
Convert from JSON to AdAccountsAudienceRule<PSCustomObject>
...
AdAccountsAudienceRule<PSCustomObject>
#>
function ConvertFrom-JsonToAdAccountsAudienceRule {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AdAccountsAudienceRule' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AdAccountsAudienceRule
        $AllProperties = ('ad_account_id', 'ad_id', 'campaign_id', 'country', 'customer_list_id', 'engagement_domain', 'engagement_type', 'engager_type', 'event', 'event_data', 'event_source', 'ingestion_source', 'objective_type', 'percentage', 'pin_id', 'prefill', 'retention_days', 'seed_id', 'url', 'visitor_source_id')
