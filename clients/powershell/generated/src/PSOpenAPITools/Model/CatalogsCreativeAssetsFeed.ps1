...
function ConvertFrom-JsonToCatalogsCreativeAssetsFeed {
    ...
    Process {
        ...
        $AllProperties = ('catalog_id', 'catalog_type', 'created_at', 'credentials', 'default_country', 'default_currency', 'default_locale', 'format', 'id', 'location', 'name', 'preferred_processing_schedule', 'status', 'updated_at')
