...
function ConvertFrom-JsonToCatalogsCreativeAssetsFeed {
    ...
    Process {
        ...
        $AllProperties = ("created_at", "id", "updated_at", "catalog_id", "catalog_type", "credentials", "default_country", "default_currency", "default_locale", "format", "location", "name", "preferred_processing_schedule", "status")
