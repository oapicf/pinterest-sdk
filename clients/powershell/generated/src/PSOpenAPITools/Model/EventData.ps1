...
function Initialize-EventData {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => EventData' | Write-Debug
...
Convert from JSON to EventData<PSCustomObject>
...
EventData<PSCustomObject>
#>
function ConvertFrom-JsonToEventData {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => EventData' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in EventData
