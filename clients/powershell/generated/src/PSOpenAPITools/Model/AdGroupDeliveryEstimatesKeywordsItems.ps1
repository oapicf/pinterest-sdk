...
AdGroupDeliveryEstimatesKeywordsItems<PSCustomObject>
#>

function Initialize-AdGroupDeliveryEstimatesKeywordsItems {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AdGroupDeliveryEstimatesKeywordsItems' | Write-Debug
...
Convert from JSON to AdGroupDeliveryEstimatesKeywordsItems<PSCustomObject>
...
AdGroupDeliveryEstimatesKeywordsItems<PSCustomObject>
#>
function ConvertFrom-JsonToAdGroupDeliveryEstimatesKeywordsItems {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AdGroupDeliveryEstimatesKeywordsItems' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AdGroupDeliveryEstimatesKeywordsItems
