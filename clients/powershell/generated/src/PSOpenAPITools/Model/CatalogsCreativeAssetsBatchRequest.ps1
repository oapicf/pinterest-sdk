...
CatalogsCreativeAssetsBatchRequest<PSCustomObject>
#>

function Initialize-CatalogsCreativeAssetsBatchRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CatalogsCreativeAssetsBatchRequest' | Write-Debug
...
Convert from JSON to CatalogsCreativeAssetsBatchRequest<PSCustomObject>
...
CatalogsCreativeAssetsBatchRequest<PSCustomObject>
#>
function ConvertFrom-JsonToCatalogsCreativeAssetsBatchRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CatalogsCreativeAssetsBatchRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CatalogsCreativeAssetsBatchRequest
        $AllProperties = ('catalog_id', 'catalog_type', 'country', 'items', 'language')
