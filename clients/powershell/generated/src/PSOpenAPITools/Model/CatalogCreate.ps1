...
CatalogCreate<PSCustomObject>
#>

function Initialize-CatalogCreate {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CatalogCreate' | Write-Debug
...
Convert from JSON to CatalogCreate<PSCustomObject>
...
CatalogCreate<PSCustomObject>
#>
function ConvertFrom-JsonToCatalogCreate {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CatalogCreate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CatalogCreate
