...
ItemResponseOneOf<PSCustomObject>
#>
function ConvertFrom-JsonToItemResponseOneOf {
    [CmdletBinding()]
    Param (
        [AllowEmptyString()]
        [string]$Json
    ...
    Process {
        ...
        try {
            ...
            Write-Debug "Failed to match 'CatalogsCreativeAssetsItemResponse' defined in oneOf (ItemResponseOneOf). Proceeding to the next one if any."
        }
        ...
        try {
            ...
            # fail to match the schema defined in oneOf, proceed to the next one
            Write-Debug "Failed to match 'CatalogsHotelItemResponse' defined in oneOf (ItemResponseOneOf). Proceeding to the next one if any."
        }
        ...
        try {
            ...
            # fail to match the schema defined in oneOf, proceed to the next one
            Write-Debug "Failed to match 'CatalogsRetailItemResponse' defined in oneOf (ItemResponseOneOf). Proceeding to the next one if any."
        }
