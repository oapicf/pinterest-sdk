...
function ConvertFrom-JsonToConversionTagConfigs {
    ...
    Process {
        ...
        $AllProperties = ("aem_db_enabled", "aem_enabled", "aem_external_id_enabled", "aem_fnln_enabled", "aem_ge_enabled", "aem_loc_enabled", "aem_ph_enabled", "md_frequency", "no_code_capi_domains")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "no_code_capi_domains"))) { #optional property not found
            $NoCodeCapiDomains = $null
        } else {
            $NoCodeCapiDomains = $JsonParameters.PSobject.Properties["no_code_capi_domains"].value
        }
