...
function Initialize-AdGroup {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AdGroup' | Write-Debug
...
Convert from JSON to AdGroup<PSCustomObject>
...
AdGroup<PSCustomObject>
#>
function ConvertFrom-JsonToAdGroup {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AdGroup' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AdGroup
