...
AnyOf<PSCustomObject>
#>

function Initialize-AnyOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AnyOf' | Write-Debug
...
Convert from JSON to AnyOf<PSCustomObject>
...
AnyOf<PSCustomObject>
#>
function ConvertFrom-JsonToAnyOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AnyOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AnyOf
