...
function ConvertFrom-JsonToSSIOCreateInsertionOrderRequest {
    ...
    Process {
        ...
        If ([string]::IsNullOrEmpty($Json) -or $Json -eq "{}") { # empty json
            throw "Error! Empty JSON cannot be serialized due to the required property 'billing_contact_email' missing."
        }
