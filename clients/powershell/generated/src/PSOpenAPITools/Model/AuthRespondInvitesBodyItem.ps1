...
AuthRespondInvitesBodyItem<PSCustomObject>
#>

function Initialize-AuthRespondInvitesBodyItem {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AuthRespondInvitesBodyItem' | Write-Debug
...
Convert from JSON to AuthRespondInvitesBodyItem<PSCustomObject>
...
AuthRespondInvitesBodyItem<PSCustomObject>
#>
function ConvertFrom-JsonToAuthRespondInvitesBodyItem {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AuthRespondInvitesBodyItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AuthRespondInvitesBodyItem
