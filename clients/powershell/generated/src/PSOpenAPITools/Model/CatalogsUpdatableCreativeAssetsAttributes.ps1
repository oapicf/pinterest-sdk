...
CatalogsUpdatableCreativeAssetsAttributes<PSCustomObject>
#>

function Initialize-CatalogsUpdatableCreativeAssetsAttributes {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CatalogsUpdatableCreativeAssetsAttributes' | Write-Debug
...
Convert from JSON to CatalogsUpdatableCreativeAssetsAttributes<PSCustomObject>
...
CatalogsUpdatableCreativeAssetsAttributes<PSCustomObject>
#>
function ConvertFrom-JsonToCatalogsUpdatableCreativeAssetsAttributes {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CatalogsUpdatableCreativeAssetsAttributes' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CatalogsUpdatableCreativeAssetsAttributes
        $AllProperties = ("title", "description", "link", "ios_deep_link", "android_deep_link", "google_product_category", "custom_label_0", "custom_label_1", "custom_label_2", "custom_label_3", "custom_label_4", "visibility")
