...
BusinessToAdAccountSharedAudienceUpdateWithRequiredBody<PSCustomObject>
#>

function Initialize-BusinessToAdAccountSharedAudienceUpdateWithRequiredBody {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BusinessToAdAccountSharedAudienceUpdateWithRequiredBody' | Write-Debug
...
Convert from JSON to BusinessToAdAccountSharedAudienceUpdateWithRequiredBody<PSCustomObject>
...
BusinessToAdAccountSharedAudienceUpdateWithRequiredBody<PSCustomObject>
#>
function ConvertFrom-JsonToBusinessToAdAccountSharedAudienceUpdateWithRequiredBody {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BusinessToAdAccountSharedAudienceUpdateWithRequiredBody' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BusinessToAdAccountSharedAudienceUpdateWithRequiredBody
