...
InviteDataResponse<PSCustomObject>
#>

function Initialize-InviteDataResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => InviteDataResponse' | Write-Debug
...
Convert from JSON to InviteDataResponse<PSCustomObject>
...
InviteDataResponse<PSCustomObject>
#>
function ConvertFrom-JsonToInviteDataResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => InviteDataResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in InviteDataResponse
