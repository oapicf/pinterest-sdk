...
AnalyticsDailyMetrics<PSCustomObject>
#>

function Initialize-AnalyticsDailyMetrics {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AnalyticsDailyMetrics' | Write-Debug
...
Convert from JSON to AnalyticsDailyMetrics<PSCustomObject>
...
AnalyticsDailyMetrics<PSCustomObject>
#>
function ConvertFrom-JsonToAnalyticsDailyMetrics {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AnalyticsDailyMetrics' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AnalyticsDailyMetrics
