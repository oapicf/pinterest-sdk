...
AdAccountToAdAccountSharedAudienceUpdateWithRequiredBody<PSCustomObject>
#>

function Initialize-AdAccountToAdAccountSharedAudienceUpdateWithRequiredBody {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AdAccountToAdAccountSharedAudienceUpdateWithRequiredBody' | Write-Debug
...
Convert from JSON to AdAccountToAdAccountSharedAudienceUpdateWithRequiredBody<PSCustomObject>
...
AdAccountToAdAccountSharedAudienceUpdateWithRequiredBody<PSCustomObject>
#>
function ConvertFrom-JsonToAdAccountToAdAccountSharedAudienceUpdateWithRequiredBody {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AdAccountToAdAccountSharedAudienceUpdateWithRequiredBody' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AdAccountToAdAccountSharedAudienceUpdateWithRequiredBody
