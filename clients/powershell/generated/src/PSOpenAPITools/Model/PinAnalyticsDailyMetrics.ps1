...
PinAnalyticsDailyMetrics<PSCustomObject>
#>

function Initialize-PinAnalyticsDailyMetrics {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PinAnalyticsDailyMetrics' | Write-Debug
...
Convert from JSON to PinAnalyticsDailyMetrics<PSCustomObject>
...
PinAnalyticsDailyMetrics<PSCustomObject>
#>
function ConvertFrom-JsonToPinAnalyticsDailyMetrics {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PinAnalyticsDailyMetrics' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PinAnalyticsDailyMetrics
