...
function ConvertFrom-JsonToLeadFormResponse {
    ...
    Process {
        ...
        $AllProperties = ("name", "privacy_policy_link", "has_accepted_terms", "completion_message", "status", "disclosure_language", "questions", "policy_links", "id", "ad_account_id", "created_time", "updated_time")
