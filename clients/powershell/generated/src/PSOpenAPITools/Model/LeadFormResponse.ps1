...
function ConvertFrom-JsonToLeadFormResponse {
    ...
    Process {
        ...
        $AllProperties = ("completion_message", "disclosure_language", "has_accepted_terms", "name", "policy_links", "privacy_policy_link", "questions", "status", "ad_account_id", "created_time", "id", "updated_time")
