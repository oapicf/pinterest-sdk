...
TargetingSpecOperationLocationExclude<PSCustomObject>
#>

function Initialize-TargetingSpecOperationLocationExclude {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("LOCATION_EXCLUDE")]
        [String]
        ${Field},
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TargetingSpecOperationLocationExclude' | Write-Debug
...
Convert from JSON to TargetingSpecOperationLocationExclude<PSCustomObject>
...
TargetingSpecOperationLocationExclude<PSCustomObject>
#>
function ConvertFrom-JsonToTargetingSpecOperationLocationExclude {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TargetingSpecOperationLocationExclude' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TargetingSpecOperationLocationExclude
