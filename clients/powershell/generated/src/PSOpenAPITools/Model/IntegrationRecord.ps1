...
function ConvertFrom-JsonToIntegrationRecord {
    ...
    Process {
        ...
        $AllProperties = ("additional_id_1", "connected_advertiser_id", "connected_lba_id", "connected_merchant_id", "connected_tag_id", "connected_user_id", "created_time", "external_business_id", "id", "partner_access_token", "partner_access_token_expiry", "partner_metadata", "partner_primary_email", "partner_refresh_token", "partner_refresh_token_expiry", "scopes", "updated_time")
