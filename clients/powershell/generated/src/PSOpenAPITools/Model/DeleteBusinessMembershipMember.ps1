...
DeleteBusinessMembershipMember<PSCustomObject>
#>

function Initialize-DeleteBusinessMembershipMember {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => DeleteBusinessMembershipMember' | Write-Debug
...
Convert from JSON to DeleteBusinessMembershipMember<PSCustomObject>
...
DeleteBusinessMembershipMember<PSCustomObject>
#>
function ConvertFrom-JsonToDeleteBusinessMembershipMember {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => DeleteBusinessMembershipMember' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in DeleteBusinessMembershipMember
