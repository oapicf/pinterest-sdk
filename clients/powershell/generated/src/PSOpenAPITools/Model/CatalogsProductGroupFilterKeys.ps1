    ...
    Process {
        ...
        if ($match -ne 0) { # no match yet
            ...
            try {
                ...
                # fail to match the schema defined in anyOf, proceed to the next one
                Write-Debug "Failed to match 'CustomNumber0Filter' defined in anyOf (CatalogsProductGroupFilterKeys). Proceeding to the next one if any."
            }
        }
        ...
        if ($match -ne 0) { # no match yet
            ...
            try {
                ...
                # fail to match the schema defined in anyOf, proceed to the next one
                Write-Debug "Failed to match 'CustomNumber1Filter' defined in anyOf (CatalogsProductGroupFilterKeys). Proceeding to the next one if any."
            }
        }
        ...
        if ($match -ne 0) { # no match yet
            ...
            try {
                ...
                # fail to match the schema defined in anyOf, proceed to the next one
                Write-Debug "Failed to match 'CustomNumber2Filter' defined in anyOf (CatalogsProductGroupFilterKeys). Proceeding to the next one if any."
            }
        }
        ...
        if ($match -ne 0) { # no match yet
            ...
            try {
                ...
                # fail to match the schema defined in anyOf, proceed to the next one
                Write-Debug "Failed to match 'CustomNumber3Filter' defined in anyOf (CatalogsProductGroupFilterKeys). Proceeding to the next one if any."
            }
        }
        ...
        if ($match -ne 0) { # no match yet
            ...
            try {
                ...
                # fail to match the schema defined in anyOf, proceed to the next one
                Write-Debug "Failed to match 'CustomNumber4Filter' defined in anyOf (CatalogsProductGroupFilterKeys). Proceeding to the next one if any."
            }
        }
        ...
        if ($match -ne 0) { # no match yet
            ...
            try {
                ...
                # fail to match the schema defined in anyOf, proceed to the next one
                Write-Debug "Failed to match 'TitleKeywordsFilter' defined in anyOf (CatalogsProductGroupFilterKeys). Proceeding to the next one if any."
            }
        }
