...
LeadSubscriptionPostParamsCreate<PSCustomObject>
#>

function Initialize-LeadSubscriptionPostParamsCreate {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => LeadSubscriptionPostParamsCreate' | Write-Debug
...
Convert from JSON to LeadSubscriptionPostParamsCreate<PSCustomObject>
...
LeadSubscriptionPostParamsCreate<PSCustomObject>
#>
function ConvertFrom-JsonToLeadSubscriptionPostParamsCreate {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => LeadSubscriptionPostParamsCreate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in LeadSubscriptionPostParamsCreate
        $AllProperties = ("lead_form_id", "webhook_url", "partner_access_token", "partner_metadata", "partner_refresh_token")
