...
CatalogsRetailProduct<PSCustomObject>
#>

function Initialize-CatalogsRetailProduct {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CatalogsRetailProduct' | Write-Debug
...
Convert from JSON to CatalogsRetailProduct<PSCustomObject>
...
CatalogsRetailProduct<PSCustomObject>
#>
function ConvertFrom-JsonToCatalogsRetailProduct {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CatalogsRetailProduct' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CatalogsRetailProduct
