...
ConversionEventsDataItems<PSCustomObject>
#>

function Initialize-ConversionEventsDataItems {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ConversionEventsDataItems' | Write-Debug
...
Convert from JSON to ConversionEventsDataItems<PSCustomObject>
...
ConversionEventsDataItems<PSCustomObject>
#>
function ConvertFrom-JsonToConversionEventsDataItems {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ConversionEventsDataItems' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ConversionEventsDataItems
