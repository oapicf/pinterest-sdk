...
CatalogsUpsertCreativeAssetsItem<PSCustomObject>
#>

function Initialize-CatalogsUpsertCreativeAssetsItem {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CatalogsUpsertCreativeAssetsItem' | Write-Debug
...
Convert from JSON to CatalogsUpsertCreativeAssetsItem<PSCustomObject>
...
CatalogsUpsertCreativeAssetsItem<PSCustomObject>
#>
function ConvertFrom-JsonToCatalogsUpsertCreativeAssetsItem {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CatalogsUpsertCreativeAssetsItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CatalogsUpsertCreativeAssetsItem
