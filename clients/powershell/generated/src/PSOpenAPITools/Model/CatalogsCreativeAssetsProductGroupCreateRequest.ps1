...
CatalogsCreativeAssetsProductGroupCreateRequest<PSCustomObject>
#>

function Initialize-CatalogsCreativeAssetsProductGroupCreateRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CatalogsCreativeAssetsProductGroupCreateRequest' | Write-Debug
...
Convert from JSON to CatalogsCreativeAssetsProductGroupCreateRequest<PSCustomObject>
...
CatalogsCreativeAssetsProductGroupCreateRequest<PSCustomObject>
#>
function ConvertFrom-JsonToCatalogsCreativeAssetsProductGroupCreateRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CatalogsCreativeAssetsProductGroupCreateRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CatalogsCreativeAssetsProductGroupCreateRequest
        $AllProperties = ("catalog_id", "catalog_type", "description", "filters", "name")
