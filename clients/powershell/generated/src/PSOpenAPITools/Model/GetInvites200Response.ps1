...
GetInvites200Response<PSCustomObject>
#>

function Initialize-GetInvites200Response {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => GetInvites200Response' | Write-Debug
...
Convert from JSON to GetInvites200Response<PSCustomObject>
...
GetInvites200Response<PSCustomObject>
#>
function ConvertFrom-JsonToGetInvites200Response {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => GetInvites200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in GetInvites200Response
