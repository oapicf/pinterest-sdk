...
ProductGroupPromotionsCreate<PSCustomObject>
#>

function Initialize-ProductGroupPromotionsCreate {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ProductGroupPromotionsCreate' | Write-Debug
...
Convert from JSON to ProductGroupPromotionsCreate<PSCustomObject>
...
ProductGroupPromotionsCreate<PSCustomObject>
#>
function ConvertFrom-JsonToProductGroupPromotionsCreate {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ProductGroupPromotionsCreate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ProductGroupPromotionsCreate
