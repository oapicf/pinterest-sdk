...
CatalogsItemsUpdateBatchRequest<PSCustomObject>
#>

function Initialize-CatalogsItemsUpdateBatchRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CatalogsItemsUpdateBatchRequest' | Write-Debug
...
Convert from JSON to CatalogsItemsUpdateBatchRequest<PSCustomObject>
...
CatalogsItemsUpdateBatchRequest<PSCustomObject>
#>
function ConvertFrom-JsonToCatalogsItemsUpdateBatchRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CatalogsItemsUpdateBatchRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CatalogsItemsUpdateBatchRequest
