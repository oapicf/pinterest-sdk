...
ProductGroupPromotionResponseElement<PSCustomObject>
#>

function Initialize-ProductGroupPromotionResponseElement {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ProductGroupPromotionResponseElement' | Write-Debug
...
Convert from JSON to ProductGroupPromotionResponseElement<PSCustomObject>
...
ProductGroupPromotionResponseElement<PSCustomObject>
#>
function ConvertFrom-JsonToProductGroupPromotionResponseElement {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ProductGroupPromotionResponseElement' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ProductGroupPromotionResponseElement
