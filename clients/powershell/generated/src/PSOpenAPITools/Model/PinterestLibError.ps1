...
PinterestLibError<PSCustomObject>
#>

function Initialize-PinterestLibError {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PinterestLibError' | Write-Debug
...
Convert from JSON to PinterestLibError<PSCustomObject>
...
PinterestLibError<PSCustomObject>
#>
function ConvertFrom-JsonToPinterestLibError {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PinterestLibError' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PinterestLibError
