...
function ConvertFrom-JsonToProductGroupPromotion {
    ...
    Process {
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match 'is_image_auto_resizing'))) { #optional property not found
            $IsImageAutoResizing = $null
        } else {
            $IsImageAutoResizing = $JsonParameters.PSobject.Properties['is_image_auto_resizing'].value
        }
