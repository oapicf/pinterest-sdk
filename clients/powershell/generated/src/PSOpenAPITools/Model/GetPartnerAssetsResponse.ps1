...
GetPartnerAssetsResponse<PSCustomObject>
#>

function Initialize-GetPartnerAssetsResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => GetPartnerAssetsResponse' | Write-Debug
...
Convert from JSON to GetPartnerAssetsResponse<PSCustomObject>
...
GetPartnerAssetsResponse<PSCustomObject>
#>
function ConvertFrom-JsonToGetPartnerAssetsResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => GetPartnerAssetsResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in GetPartnerAssetsResponse
