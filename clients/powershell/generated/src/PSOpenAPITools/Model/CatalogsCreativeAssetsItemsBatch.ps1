...
CatalogsCreativeAssetsItemsBatch<PSCustomObject>
#>

function Initialize-CatalogsCreativeAssetsItemsBatch {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CatalogsCreativeAssetsItemsBatch' | Write-Debug
...
Convert from JSON to CatalogsCreativeAssetsItemsBatch<PSCustomObject>
...
CatalogsCreativeAssetsItemsBatch<PSCustomObject>
#>
function ConvertFrom-JsonToCatalogsCreativeAssetsItemsBatch {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CatalogsCreativeAssetsItemsBatch' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CatalogsCreativeAssetsItemsBatch
