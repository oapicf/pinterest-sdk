...
#ifndef BOOST_BEAST_OPENAPI_CLIENT_ResourcesApi_
#define BOOST_BEAST_OPENAPI_CLIENT_ResourcesApi_
...
{
public:
    ResourcesApiException(boost::beast::http::status statusCode, std::string what);
...
public:
    ...
    /// Get Ad Accounts countries
    /// </remarks>
    virtual std::shared_ptr<Ad_account_countries_get_200_response>
    ...
    /// </remarks>
    virtual std::shared_ptr<Delivery_metrics_get_200_response>
    deliveryMetrics_get(
    ...
    /// </remarks>
    virtual std::shared_ptr<SingleInterestTargetingOption>
    ...
    /// </remarks>
    virtual std::shared_ptr<BookClosed>
    ...
    /// </remarks>
    virtual std::vector<std::shared_ptr<boost::json::value>>
...
#endif /* BOOST_BEAST_OPENAPI_CLIENT_ResourcesApi_ */
