...
CatalogSupplementalApiException::CatalogSupplementalApiException(boost::beast::http::status statusCode, std::string what)
  : m_status(statusCode),
    m_what(what)
{
}

boost::beast::http::status CatalogSupplementalApiException::getStatus() const
{
    return m_status;
}
...
std::shared_ptr<SupplementalItemsBatchResponse>
CatalogSupplementalApi::catalogsLocalInventoryItemsBatch_operate(
    ...
    std::string path = m_context + "/catalogs/{catalog_id}/local_inventory_items/batch";
    ...
    if (isJsonContentType(requestContentType)) {
        serializedRequestBody = boost::json::serialize(toRequestJsonValue(localInventoryItemsBatchCreate));
    } else {
        throw std::invalid_argument("Content type '" + requestContentType + "' does not support structured request bodies");
    }
    // path params
    replacePathParameter(path, "catalog_id", catalogId);
    // query params
    std::stringstream queryParameterStream;
    const char* queryParameterSeparator = "?";
    if (adAccountId) {
    ...
    std::shared_ptr<SupplementalItemsBatchResponse> deserializedResponse = std::make_shared<SupplementalItemsBatchResponse>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<SupplementalItemsBatchResponse>>::deserialize(
    ...
    if (statusCode == boost::beast::http::status(201)) {
        ResponseBodyDeserializer<std::shared_ptr<LocalInventoryItemsBatch>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
    ...
    if (statusCode == boost::beast::http::status(400)) {
        throw CatalogSupplementalApiException(statusCode, "The request could not be understood by the server due to unexpected data.");
    }
    if (statusCode == boost::beast::http::status(401)) {
        throw CatalogSupplementalApiException(statusCode, "Authentication is required and has either failed or not been provided.");
    }
    if (statusCode == boost::beast::http::status(403)) {
        throw CatalogSupplementalApiException(statusCode, "The request was valid, but the server is refusing action. The user might not have the necessary permissions for a resource.");
    }
    if (statusCode == boost::beast::http::status(404)) {
        throw CatalogSupplementalApiException(statusCode, "The requested resource could not be found on this server.");
    }
    if (statusCode == boost::beast::http::status(429)) {
        throw CatalogSupplementalApiException(statusCode, "The user has sent too many requests in a given amount of time and is being rate limited.");
    }
    throw CatalogSupplementalApiException(statusCode, "An unexpected error response.");
}
std::shared_ptr<LocalInventoryItemsGet>
CatalogSupplementalApi::catalogsLocalInventoryItems_post(
    ...
    std::string serializedRequestBody;
    std::string path = m_context + "/catalogs/{catalog_id}/local_inventory_items/query";
    std::map<std::string, std::string> headers;
    static const std::vector<std::string> contentTypes{ "application/json", };
    std::string requestContentType = selectPreferredContentType(contentTypes);
    headers["Content-Type"] = requestContentType;
    // Body params
    if (isJsonContentType(requestContentType)) {
        serializedRequestBody = boost::json::serialize(toRequestJsonValue(localInventoryItemsGetCreate));
    } else {
        throw std::invalid_argument("Content type '" + requestContentType + "' does not support structured request bodies");
    }
    // path params
    ...
    std::shared_ptr<LocalInventoryItemsGet> deserializedResponse = std::make_shared<LocalInventoryItemsGet>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<LocalInventoryItemsGet>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::vector<std::shared_ptr<Catalogs_local_stores_create_200_response_inner>>
CatalogSupplementalApi::catalogsLocalStores_create(
    ...
    std::string serializedRequestBody;
    std::string path = m_context + "/catalogs/{catalog_id}/local_stores";
    std::map<std::string, std::string> headers;
    static const std::vector<std::string> contentTypes{ "application/json", };
    std::string requestContentType = selectPreferredContentType(contentTypes);
    headers["Content-Type"] = requestContentType;
    // Body params
    if (isJsonContentType(requestContentType)) {
        serializedRequestBody = boost::json::serialize(toRequestJsonValue(localStoreCreate));
    } else {
        throw std::invalid_argument("Content type '" + requestContentType + "' does not support structured request bodies");
    }
    // path params
    ...
    std::vector<std::shared_ptr<Catalogs_local_stores_create_200_response_inner>> deserializedResponse = std::vector<std::shared_ptr<Catalogs_local_stores_create_200_response_inner>>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::vector<std::shared_ptr<Catalogs_local_stores_create_200_response_inner>>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
    ...
    if (statusCode == boost::beast::http::status(201)) {
        ResponseBodyDeserializer<std::vector<std::shared_ptr<LocalStore>>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::vector<std::shared_ptr<Catalogs_local_stores_delete_200_response_inner>>
CatalogSupplementalApi::catalogsLocalStores_delete(
    ...
    std::vector<std::shared_ptr<Catalogs_local_stores_delete_200_response_inner>> deserializedResponse = std::vector<std::shared_ptr<Catalogs_local_stores_delete_200_response_inner>>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::vector<std::shared_ptr<Catalogs_local_stores_delete_200_response_inner>>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<Catalogs_local_stores_list_200_response>
CatalogSupplementalApi::catalogsLocalStores_list(
    ...
    std::shared_ptr<Catalogs_local_stores_list_200_response> deserializedResponse = std::make_shared<Catalogs_local_stores_list_200_response>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<Catalogs_local_stores_list_200_response>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::vector<std::shared_ptr<Catalogs_local_stores_create_200_response_inner>>
CatalogSupplementalApi::catalogsLocalStores_update(
    ...
    // Body params
    if (isJsonContentType(requestContentType)) {
        serializedRequestBody = boost::json::serialize(toRequestJsonValue(localStoreBatchUpdate));
    } else {
        throw std::invalid_argument("Content type '" + requestContentType + "' does not support structured request bodies");
    }
    // path params
...
std::shared_ptr<SupplementalItemsBatchResponse>
CatalogSupplementalApi::catalogsSupplementalItemsBatch_get(
    const std::string& catalogId, const std::string& batchId, const boost::optional<std::string>& adAccountId) {
    std::string serializedRequestBody;
    std::string path = m_context + "/catalogs/{catalog_id}/supplemental_items/batch/{batch_id}";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "catalog_id", catalogId);
    replacePathParameter(path, "batch_id", batchId);
    // query params
    std::stringstream queryParameterStream;
    const char* queryParameterSeparator = "?";
    if (adAccountId) {
...
std::string CatalogSupplementalApi::base64encode(const std::string& str) {
    return base64encodeImpl(str);
}

void CatalogSupplementalApi::setPreferredMediaTypeHeader(std::map<std::string, std::string>& headers, const std::string& headerName, const std::vector<std::string>& contentTypes) {
    const std::string contentType = selectPreferredContentType(contentTypes);
    headers[headerName] = contentType;
}

void CatalogSupplementalApi::handleStdException(const std::exception&) {
    throw;
}

void CatalogSupplementalApi::handleUncaughtException() {
    throw;
}
