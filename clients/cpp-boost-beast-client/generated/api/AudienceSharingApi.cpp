...
AudienceSharingApiException::AudienceSharingApiException(boost::beast::http::status statusCode, std::string what)
  : m_status(statusCode),
    m_what(what)
{
}

boost::beast::http::status AudienceSharingApiException::getStatus() const
{
    return m_status;
}
...
std::shared_ptr<Ad_accounts_audiences_shared_accounts_list_200_response>
AudienceSharingApi::adAccountsAudiencesSharedAccounts_list(
    ...
    std::string path = m_context + "/ad_accounts/{ad_account_id}/audiences/shared/accounts";
    ...
    const char* queryParameterSeparator = "?";
        appendQueryParameter(
            ...
            queryParameterSeparator,
            "audience_id",
            serializeQueryParameterValue(audienceId));
        appendQueryParameter(
            queryParameterStream,
            queryParameterSeparator,
            "account_type",
            serializeQueryParameterValue(accountType));
    if (bookmark) {
        appendQueryParameter(
            queryParameterStream,
            queryParameterSeparator,
    ...
    std::shared_ptr<Ad_accounts_audiences_shared_accounts_list_200_response> deserializedResponse = std::make_shared<Ad_accounts_audiences_shared_accounts_list_200_response>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<Ad_accounts_audiences_shared_accounts_list_200_response>>::deserialize(
    ...
    if (statusCode == boost::beast::http::status(400)) {
        throw AudienceSharingApiException(statusCode, "The request could not be understood by the server due to unexpected data.");
    }
    if (statusCode == boost::beast::http::status(401)) {
        throw AudienceSharingApiException(statusCode, "Authentication is required and has either failed or not been provided.");
    }
    if (statusCode == boost::beast::http::status(403)) {
        throw AudienceSharingApiException(statusCode, "The request was valid, but the server is refusing action. The user might not have the necessary permissions for a resource.");
    }
    if (statusCode == boost::beast::http::status(404)) {
        throw AudienceSharingApiException(statusCode, "The requested resource could not be found on this server.");
    }
    if (statusCode == boost::beast::http::status(429)) {
        throw AudienceSharingApiException(statusCode, "The user has sent too many requests in a given amount of time and is being rate limited.");
    }
    throw AudienceSharingApiException(statusCode, "An unexpected error response.");
}
std::shared_ptr<Ad_accounts_audiences_shared_accounts_list_200_response>
AudienceSharingApi::businessAccountAudiencesSharedAccounts_list(
    ...
    std::string serializedRequestBody;
    std::string path = m_context + "/businesses/{business_id}/audiences/shared/accounts";
    std::map<std::string, std::string> headers;
    // path params
...
std::shared_ptr<Shared_audiences_for_business_list_200_response>
AudienceSharingApi::sharedAudiencesForBusiness_list(
    ...
    std::string serializedRequestBody;
    std::string path = m_context + "/businesses/{business_id}/audiences";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "business_id", businessId);
    // query params
    ...
    std::shared_ptr<Shared_audiences_for_business_list_200_response> deserializedResponse = std::make_shared<Shared_audiences_for_business_list_200_response>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<Shared_audiences_for_business_list_200_response>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<AdAccountToAdAccountSharedAudience>
AudienceSharingApi::updateAdAccountToAdAccountSharedAudience(
    ...
    std::string serializedRequestBody;
    std::string path = m_context + "/ad_accounts/{ad_account_id}/audiences/ad_accounts/shared";
    std::map<std::string, std::string> headers;
    ...
    if (isJsonContentType(requestContentType)) {
        serializedRequestBody = boost::json::serialize(toRequestJsonValue(adAccountToAdAccountSharedAudienceUpdateWithRequiredBody));
    } else {
    ...
    std::shared_ptr<AdAccountToAdAccountSharedAudience> deserializedResponse = std::make_shared<AdAccountToAdAccountSharedAudience>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<AdAccountToAdAccountSharedAudience>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<AdAccountToBusinessSharedAudience>
AudienceSharingApi::updateAdAccountToBusinessSharedAudience(
    ...
    std::string serializedRequestBody;
    std::string path = m_context + "/ad_accounts/{ad_account_id}/audiences/businesses/shared";
    std::map<std::string, std::string> headers;
    static const std::vector<std::string> contentTypes{ "application/json", };
    std::string requestContentType = selectPreferredContentType(contentTypes);
    headers["Content-Type"] = requestContentType;
    // Body params
    if (isJsonContentType(requestContentType)) {
        serializedRequestBody = boost::json::serialize(toRequestJsonValue(adAccountToBusinessSharedAudienceUpdateWithRequiredBody));
    } else {
        throw std::invalid_argument("Content type '" + requestContentType + "' does not support structured request bodies");
    }
    // path params
    ...
    std::shared_ptr<AdAccountToBusinessSharedAudience> deserializedResponse = std::make_shared<AdAccountToBusinessSharedAudience>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<AdAccountToBusinessSharedAudience>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<BusinessToAdAccountSharedAudience>
AudienceSharingApi::updateBusinessToAdAccountSharedAudience(
    ...
    std::string serializedRequestBody;
    std::string path = m_context + "/businesses/{business_id}/audiences/ad_accounts/shared";
    std::map<std::string, std::string> headers;
    static const std::vector<std::string> contentTypes{ "application/json", };
    std::string requestContentType = selectPreferredContentType(contentTypes);
    headers["Content-Type"] = requestContentType;
    // Body params
    if (isJsonContentType(requestContentType)) {
        serializedRequestBody = boost::json::serialize(toRequestJsonValue(businessToAdAccountSharedAudienceUpdateWithRequiredBody));
    } else {
        throw std::invalid_argument("Content type '" + requestContentType + "' does not support structured request bodies");
    }
    // path params
    ...
    std::shared_ptr<BusinessToAdAccountSharedAudience> deserializedResponse = std::make_shared<BusinessToAdAccountSharedAudience>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<BusinessToAdAccountSharedAudience>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<BusinessToBusinessSharedAudience>
AudienceSharingApi::updateBusinessToBusinessSharedAudience(
    ...
    std::string serializedRequestBody;
    std::string path = m_context + "/businesses/{business_id}/audiences/businesses/shared";
    std::map<std::string, std::string> headers;
    static const std::vector<std::string> contentTypes{ "application/json", };
    std::string requestContentType = selectPreferredContentType(contentTypes);
    headers["Content-Type"] = requestContentType;
    // Body params
    if (isJsonContentType(requestContentType)) {
        serializedRequestBody = boost::json::serialize(toRequestJsonValue(businessToBusinessSharedAudienceUpdateWithRequiredBody));
    } else {
        throw std::invalid_argument("Content type '" + requestContentType + "' does not support structured request bodies");
    }
    // path params
    ...
    std::shared_ptr<BusinessToBusinessSharedAudience> deserializedResponse = std::make_shared<BusinessToBusinessSharedAudience>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<BusinessToBusinessSharedAudience>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::string AudienceSharingApi::base64encode(const std::string& str) {
    return base64encodeImpl(str);
}

void AudienceSharingApi::setPreferredMediaTypeHeader(std::map<std::string, std::string>& headers, const std::string& headerName, const std::vector<std::string>& contentTypes) {
    const std::string contentType = selectPreferredContentType(contentTypes);
    headers[headerName] = contentType;
}

void AudienceSharingApi::handleStdException(const std::exception&) {
    throw;
}

void AudienceSharingApi::handleUncaughtException() {
    throw;
}
