...
AdAccountsApiException::AdAccountsApiException(boost::beast::http::status statusCode, std::string what)
  : m_status(statusCode),
    m_what(what)
{
}

boost::beast::http::status AdAccountsApiException::getStatus() const
{
    return m_status;
}
...
AdAccountsApi::adAccountTargetingAnalytics_get(
    ...
    std::string path = m_context + "/ad_accounts/{ad_account_id}/targeting_analytics";
    ...
    if (statusCode == boost::beast::http::status(400)) {
        throw AdAccountsApiException(statusCode, "The request could not be understood by the server due to unexpected data.");
    }
    if (statusCode == boost::beast::http::status(401)) {
        throw AdAccountsApiException(statusCode, "Authentication is required and has either failed or not been provided.");
    }
    if (statusCode == boost::beast::http::status(403)) {
        throw AdAccountsApiException(statusCode, "The request was valid, but the server is refusing action. The user might not have the necessary permissions for a resource.");
    }
    if (statusCode == boost::beast::http::status(404)) {
        throw AdAccountsApiException(statusCode, "The requested resource could not be found on this server.");
    }
    if (statusCode == boost::beast::http::status(429)) {
        throw AdAccountsApiException(statusCode, "The user has sent too many requests in a given amount of time and is being rate limited.");
    }
    throw AdAccountsApiException(statusCode, "An unexpected error response.");
}
std::vector<std::shared_ptr<AdAccountAnalyticsItems>>
AdAccountsApi::adAccount_analytics(
    ...
    std::string serializedRequestBody;
    std::string path = m_context + "/ad_accounts/{ad_account_id}/analytics";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "ad_account_id", adAccountId);
    // query params
    ...
    std::vector<std::shared_ptr<AdAccountAnalyticsItems>> deserializedResponse = std::vector<std::shared_ptr<AdAccountAnalyticsItems>>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::vector<std::shared_ptr<AdAccountAnalyticsItems>>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<AdAccount>
AdAccountsApi::adAccounts_create(
    const std::shared_ptr<AdAccountCreate>& adAccountCreate) {
    std::string serializedRequestBody;
    std::string path = m_context + "/ad_accounts";
    std::map<std::string, std::string> headers;
    ...
    if (isJsonContentType(requestContentType)) {
        serializedRequestBody = boost::json::serialize(toRequestJsonValue(adAccountCreate));
    } else {
    ...
    std::shared_ptr<AdAccount> deserializedResponse = std::make_shared<AdAccount>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<AdAccount>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<Ad_accounts_list_200_response>
AdAccountsApi::adAccounts_list(
    ...
    if (includeSharedAccounts) {
        appendQueryParameter(
            ...
            serializeQueryParameterValue(*includeSharedAccounts));
    }
    if (bookmark) {
        appendQueryParameter(
            queryParameterStream,
    ...
    std::shared_ptr<Ad_accounts_list_200_response> deserializedResponse = std::make_shared<Ad_accounts_list_200_response>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<Ad_accounts_list_200_response>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<AdAccount>
AdAccountsApi::adAccounts_get(
    const std::string& adAccountId) {
    std::string serializedRequestBody;
    std::string path = m_context + "/ad_accounts/{ad_account_id}";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "ad_account_id", adAccountId);
...
std::shared_ptr<ConversionProductReport>
AdAccountsApi::analytics_createConversionProductReport(
    const std::string& adAccountId, const std::shared_ptr<ConversionProductReportCreate>& conversionProductReportCreate) {
    std::string serializedRequestBody;
    std::string path = m_context + "/ad_accounts/{ad_account_id}/reports/brand_category_sku";
    std::map<std::string, std::string> headers;
    static const std::vector<std::string> contentTypes{ "application/json", };
    std::string requestContentType = selectPreferredContentType(contentTypes);
    headers["Content-Type"] = requestContentType;
    // Body params
    if (isJsonContentType(requestContentType)) {
        serializedRequestBody = boost::json::serialize(toRequestJsonValue(conversionProductReportCreate));
    } else {
        throw std::invalid_argument("Content type '" + requestContentType + "' does not support structured request bodies");
    }
    // path params
    ...
    std::shared_ptr<ConversionProductReport> deserializedResponse = std::make_shared<ConversionProductReport>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<ConversionProductReport>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<ConversionProductReport>
AdAccountsApi::analytics_getConversionProductReport(
...
std::shared_ptr<MMMReport>
AdAccountsApi::analytics_createMmmReport(
    const std::string& adAccountId, const std::shared_ptr<MMMReportCreate>& mMMReportCreate) {
    std::string serializedRequestBody;
    std::string path = m_context + "/ad_accounts/{ad_account_id}/mmm_reports";
    std::map<std::string, std::string> headers;
    static const std::vector<std::string> contentTypes{ "application/json", };
    std::string requestContentType = selectPreferredContentType(contentTypes);
    headers["Content-Type"] = requestContentType;
    // Body params
    if (isJsonContentType(requestContentType)) {
        serializedRequestBody = boost::json::serialize(toRequestJsonValue(mMMReportCreate));
    } else {
        throw std::invalid_argument("Content type '" + requestContentType + "' does not support structured request bodies");
    }
    // path params
    ...
    std::shared_ptr<MMMReport> deserializedResponse = std::make_shared<MMMReport>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<MMMReport>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<MMMReport>
AdAccountsApi::analytics_getMmmReport(
    const std::string& adAccountId, const std::string& token) {
    std::string serializedRequestBody;
    std::string path = m_context + "/ad_accounts/{ad_account_id}/mmm_reports";
    std::map<std::string, std::string> headers;
...
std::shared_ptr<AdsAnalyticsCreateAsyncResponse>
AdAccountsApi::analytics_createReport(
    const std::string& adAccountId, const std::shared_ptr<AdsAnalyticsCreateAsyncRequest>& adsAnalyticsCreateAsyncRequest) {
    std::string serializedRequestBody;
    std::string path = m_context + "/ad_accounts/{ad_account_id}/reports";
    std::map<std::string, std::string> headers;
    static const std::vector<std::string> contentTypes{ "application/json", };
    std::string requestContentType = selectPreferredContentType(contentTypes);
    headers["Content-Type"] = requestContentType;
    // Body params
    if (isJsonContentType(requestContentType)) {
        serializedRequestBody = boost::json::serialize(toRequestJsonValue(adsAnalyticsCreateAsyncRequest));
    } else {
        throw std::invalid_argument("Content type '" + requestContentType + "' does not support structured request bodies");
    }
    // path params
    ...
    std::shared_ptr<AdsAnalyticsCreateAsyncResponse> deserializedResponse = std::make_shared<AdsAnalyticsCreateAsyncResponse>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<AdsAnalyticsCreateAsyncResponse>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<AdsAnalyticsGetAsyncResponse>
AdAccountsApi::analytics_getReport(
    const std::string& adAccountId, const std::string& token) {
    std::string serializedRequestBody;
    std::string path = m_context + "/ad_accounts/{ad_account_id}/reports";
    std::map<std::string, std::string> headers;
    ...
    std::shared_ptr<AdsAnalyticsGetAsyncResponse> deserializedResponse = std::make_shared<AdsAnalyticsGetAsyncResponse>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<AdsAnalyticsGetAsyncResponse>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<TemplateBasedReport>
AdAccountsApi::analytics_createTemplateReport(
    ...
    std::string serializedRequestBody;
    std::string path = m_context + "/ad_accounts/{ad_account_id}/templates/{template_id}/reports";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "ad_account_id", adAccountId);
    replacePathParameter(path, "template_id", templateId);
    // query params
    std::stringstream queryParameterStream;
    const char* queryParameterSeparator = "?";
    if (startDate) {
    ...
    std::shared_ptr<TemplateBasedReport> deserializedResponse = std::make_shared<TemplateBasedReport>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<TemplateBasedReport>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
AdAccountsApi::sandbox_delete(
    const std::string& adAccountId) {
    std::string serializedRequestBody;
    std::string path = m_context + "/ad_accounts/{ad_account_id}/sandbox";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "ad_account_id", adAccountId);
...
std::shared_ptr<Templates_list_200_response>
AdAccountsApi::templates_list(
    ...
    std::string serializedRequestBody;
    std::string path = m_context + "/ad_accounts/{ad_account_id}/templates";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "ad_account_id", adAccountId);
    // query params
    ...
    std::shared_ptr<Templates_list_200_response> deserializedResponse = std::make_shared<Templates_list_200_response>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<Templates_list_200_response>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::string AdAccountsApi::base64encode(const std::string& str) {
    return base64encodeImpl(str);
}

void AdAccountsApi::setPreferredMediaTypeHeader(std::map<std::string, std::string>& headers, const std::string& headerName, const std::vector<std::string>& contentTypes) {
    const std::string contentType = selectPreferredContentType(contentTypes);
    headers[headerName] = contentType;
}

void AdAccountsApi::handleStdException(const std::exception&) {
    throw;
}

void AdAccountsApi::handleUncaughtException() {
    throw;
}
