...
ConversionTagsApiException::ConversionTagsApiException(boost::beast::http::status statusCode, std::string what)
  : m_status(statusCode),
    m_what(what)
{
}

boost::beast::http::status ConversionTagsApiException::getStatus() const
{
    return m_status;
}
...
std::shared_ptr<ConversionTag>
ConversionTagsApi::conversionTags_create(
    ...
    std::string path = m_context + "/ad_accounts/{ad_account_id}/conversion_tags";
    ...
    if (isJsonContentType(requestContentType)) {
        serializedRequestBody = boost::json::serialize(toRequestJsonValue(conversionTagCreate));
    } else {
    ...
    std::shared_ptr<ConversionTag> deserializedResponse = std::make_shared<ConversionTag>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<ConversionTag>>::deserialize(
    ...
    if (statusCode == boost::beast::http::status(400)) {
        throw ConversionTagsApiException(statusCode, "The request could not be understood by the server due to unexpected data.");
    }
    if (statusCode == boost::beast::http::status(401)) {
        throw ConversionTagsApiException(statusCode, "Authentication is required and has either failed or not been provided.");
    }
    if (statusCode == boost::beast::http::status(403)) {
        throw ConversionTagsApiException(statusCode, "The request was valid, but the server is refusing action. The user might not have the necessary permissions for a resource.");
    }
    if (statusCode == boost::beast::http::status(404)) {
        throw ConversionTagsApiException(statusCode, "The requested resource could not be found on this server.");
    }
    if (statusCode == boost::beast::http::status(429)) {
        throw ConversionTagsApiException(statusCode, "The user has sent too many requests in a given amount of time and is being rate limited.");
    }
    throw ConversionTagsApiException(statusCode, "An unexpected error response.");
}
std::shared_ptr<Conversion_tags_list_200_response>
ConversionTagsApi::conversionTags_list(
    ...
    if (filterDeleted) {
        appendQueryParameter(
            ...
            queryParameterSeparator,
            "filter_deleted",
            serializeQueryParameterValue(*filterDeleted));
    }
    ...
    std::shared_ptr<Conversion_tags_list_200_response> deserializedResponse = std::make_shared<Conversion_tags_list_200_response>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<Conversion_tags_list_200_response>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<ConversionTag>
ConversionTagsApi::conversionTags_get(
    const std::string& adAccountId, const std::string& conversionTagId) {
    std::string serializedRequestBody;
    std::string path = m_context + "/ad_accounts/{ad_account_id}/conversion_tags/{conversion_tag_id}";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "ad_account_id", adAccountId);
    replacePathParameter(path, "conversion_tag_id", conversionTagId);
...
std::map<std::string, std::vector<std::shared_ptr<ConversionEventResponse>>>
ConversionTagsApi::ocpmEligibleConversionTags_get(
    const std::string& adAccountId) {
    std::string serializedRequestBody;
    std::string path = m_context + "/ad_accounts/{ad_account_id}/conversion_tags/ocpm_eligible";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "ad_account_id", adAccountId);
    ...
    std::map<std::string, std::vector<std::shared_ptr<ConversionEventResponse>>> deserializedResponse = std::map<std::string, std::vector<std::shared_ptr<ConversionEventResponse>>>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::map<std::string, std::vector<std::shared_ptr<ConversionEventResponse>>>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            true);
...
std::shared_ptr<Page_visit_conversion_tags_get_200_response>
ConversionTagsApi::pageVisitConversionTags_get(
    ...
    std::string serializedRequestBody;
    std::string path = m_context + "/ad_accounts/{ad_account_id}/conversion_tags/page_visit";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "ad_account_id", adAccountId);
    // query params
    ...
    std::shared_ptr<Page_visit_conversion_tags_get_200_response> deserializedResponse = std::make_shared<Page_visit_conversion_tags_get_200_response>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<Page_visit_conversion_tags_get_200_response>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::string ConversionTagsApi::base64encode(const std::string& str) {
    return base64encodeImpl(str);
}

void ConversionTagsApi::setPreferredMediaTypeHeader(std::map<std::string, std::string>& headers, const std::string& headerName, const std::vector<std::string>& contentTypes) {
    const std::string contentType = selectPreferredContentType(contentTypes);
    headers[headerName] = contentType;
}

void ConversionTagsApi::handleStdException(const std::exception&) {
    throw;
}

void ConversionTagsApi::handleUncaughtException() {
    throw;
}
