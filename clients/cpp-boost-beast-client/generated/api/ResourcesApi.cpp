...
ResourcesApiException::ResourcesApiException(boost::beast::http::status statusCode, std::string what)
  : m_status(statusCode),
    m_what(what)
{
}

boost::beast::http::status ResourcesApiException::getStatus() const
{
    return m_status;
}
...
std::shared_ptr<Ad_account_countries_get_200_response>
ResourcesApi::adAccountCountries_get(
    ) {
    std::string serializedRequestBody;
    std::string path = m_context + "/resources/ad_account_countries";
    ...
    std::shared_ptr<Ad_account_countries_get_200_response> deserializedResponse = std::make_shared<Ad_account_countries_get_200_response>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<Ad_account_countries_get_200_response>>::deserialize(
    ...
    if (statusCode == boost::beast::http::status(400)) {
        throw ResourcesApiException(statusCode, "The request could not be understood by the server due to unexpected data.");
    }
    if (statusCode == boost::beast::http::status(401)) {
        throw ResourcesApiException(statusCode, "Authentication is required and has either failed or not been provided.");
    }
    if (statusCode == boost::beast::http::status(403)) {
        throw ResourcesApiException(statusCode, "The request was valid, but the server is refusing action. The user might not have the necessary permissions for a resource.");
    }
    if (statusCode == boost::beast::http::status(404)) {
        throw ResourcesApiException(statusCode, "The requested resource could not be found on this server.");
    }
    if (statusCode == boost::beast::http::status(429)) {
        throw ResourcesApiException(statusCode, "The user has sent too many requests in a given amount of time and is being rate limited.");
    }
    throw ResourcesApiException(statusCode, "An unexpected error response.");
}
std::shared_ptr<Delivery_metrics_get_200_response>
ResourcesApi::deliveryMetrics_get(
    const boost::optional<std::shared_ptr<ReportType>>& reportType) {
    std::string serializedRequestBody;
    std::string path = m_context + "/resources/delivery_metrics";
    std::map<std::string, std::string> headers;
    // query params
    std::stringstream queryParameterStream;
    const char* queryParameterSeparator = "?";
    if (reportType) {
        appendQueryParameter(
            ...
            queryParameterSeparator,
            "report_type",
            serializeQueryParameterValue(*reportType));
    }
    ...
    std::shared_ptr<Delivery_metrics_get_200_response> deserializedResponse = std::make_shared<Delivery_metrics_get_200_response>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<Delivery_metrics_get_200_response>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<SingleInterestTargetingOption>
ResourcesApi::interestTargetingOptions_get(
    const std::string& interestId) {
    std::string serializedRequestBody;
    std::string path = m_context + "/resources/targeting/interests/{interest_id}";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "interest_id", interestId);
    ...
    std::shared_ptr<SingleInterestTargetingOption> deserializedResponse = std::make_shared<SingleInterestTargetingOption>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<SingleInterestTargetingOption>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
void
ResourcesApi::leadFormQuestions_get(
    ) {
    std::string serializedRequestBody;
    std::string path = m_context + "/resources/lead_form_questions";
    std::map<std::string, std::string> headers;
...
std::shared_ptr<BookClosed>
ResourcesApi::metricsReadyState_get(
    const std::string& date) {
    std::string serializedRequestBody;
    std::string path = m_context + "/resources/metrics_ready_state";
    std::map<std::string, std::string> headers;
    // query params
    std::stringstream queryParameterStream;
    const char* queryParameterSeparator = "?";
        appendQueryParameter(
            ...
            queryParameterSeparator,
            "date",
            serializeQueryParameterValue(date));
    path += queryParameterStream.str();
    ...
    std::shared_ptr<BookClosed> deserializedResponse = std::make_shared<BookClosed>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<BookClosed>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::vector<std::shared_ptr<boost::json::value>>
ResourcesApi::targetingOptions_get(
    const std::shared_ptr<PublicTargetingType>& targetingType, const boost::optional<std::string>& adAccountId, const boost::optional<std::string>& clientId, const boost::optional<std::string>& oauthSignature, const boost::optional<std::string>& timestamp) {
    std::string serializedRequestBody;
    std::string path = m_context + "/resources/targeting/{targeting_type}";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "targeting_type", targetingType);
    // query params
    std::stringstream queryParameterStream;
    const char* queryParameterSeparator = "?";
    if (adAccountId) {
    ...
    if (clientId) {
        appendQueryParameter(
            ...
            queryParameterSeparator,
            "client_id",
            serializeQueryParameterValue(*clientId));
    }
    if (oauthSignature) {
        appendQueryParameter(
            queryParameterStream,
            queryParameterSeparator,
            "oauth_signature",
            serializeQueryParameterValue(*oauthSignature));
    }
    if (timestamp) {
        appendQueryParameter(
            queryParameterStream,
            queryParameterSeparator,
            "timestamp",
            serializeQueryParameterValue(*timestamp));
    }
    path += queryParameterStream.str();
    ...
    std::vector<std::shared_ptr<boost::json::value>> deserializedResponse = std::vector<std::shared_ptr<boost::json::value>>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::vector<std::shared_ptr<boost::json::value>>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::string ResourcesApi::base64encode(const std::string& str) {
    return base64encodeImpl(str);
}

void ResourcesApi::setPreferredMediaTypeHeader(std::map<std::string, std::string>& headers, const std::string& headerName, const std::vector<std::string>& contentTypes) {
    const std::string contentType = selectPreferredContentType(contentTypes);
    headers[headerName] = contentType;
}

void ResourcesApi::handleStdException(const std::exception&) {
    throw;
}

void ResourcesApi::handleUncaughtException() {
    throw;
}
