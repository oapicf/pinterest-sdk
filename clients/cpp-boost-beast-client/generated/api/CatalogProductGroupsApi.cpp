...
CatalogProductGroupsApiException::CatalogProductGroupsApiException(boost::beast::http::status statusCode, std::string what)
  : m_status(statusCode),
    m_what(what)
{
}

boost::beast::http::status CatalogProductGroupsApiException::getStatus() const
{
    return m_status;
}
...
std::shared_ptr<Catalogs_product_group_pins_list_200_response>
CatalogProductGroupsApi::catalogsProductGroupPins_list(
    ...
    std::string path = m_context + "/catalogs/product_groups/{product_group_id}/products";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "product_group_id", productGroupId);
    // query params
    std::stringstream queryParameterStream;
    const char* queryParameterSeparator = "?";
    if (adAccountId) {
    ...
    if (pinMetrics) {
        appendQueryParameter(
            ...
            queryParameterSeparator,
            "pin_metrics",
            serializeQueryParameterValue(*pinMetrics));
    }
    if (bookmark) {
        appendQueryParameter(
            queryParameterStream,
    ...
    std::shared_ptr<Catalogs_product_group_pins_list_200_response> deserializedResponse = std::make_shared<Catalogs_product_group_pins_list_200_response>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<Catalogs_product_group_pins_list_200_response>>::deserialize(
    ...
    if (statusCode == boost::beast::http::status(400)) {
        throw CatalogProductGroupsApiException(statusCode, "The request could not be understood by the server due to unexpected data.");
    }
    if (statusCode == boost::beast::http::status(401)) {
        throw CatalogProductGroupsApiException(statusCode, "Authentication is required and has either failed or not been provided.");
    }
    if (statusCode == boost::beast::http::status(403)) {
        throw CatalogProductGroupsApiException(statusCode, "The request was valid, but the server is refusing action. The user might not have the necessary permissions for a resource.");
    }
    if (statusCode == boost::beast::http::status(404)) {
        throw CatalogProductGroupsApiException(statusCode, "The requested resource could not be found on this server.");
    }
    if (statusCode == boost::beast::http::status(429)) {
        throw CatalogProductGroupsApiException(statusCode, "The user has sent too many requests in a given amount of time and is being rate limited.");
    }
    throw CatalogProductGroupsApiException(statusCode, "An unexpected error response.");
}
std::shared_ptr<CatalogsVerticalProductGroup>
CatalogProductGroupsApi::catalogsProductGroups_create(
    ...
    std::string serializedRequestBody;
    std::string path = m_context + "/catalogs/product_groups";
    std::map<std::string, std::string> headers;
    ...
    if (isJsonContentType(requestContentType)) {
        serializedRequestBody = boost::json::serialize(toRequestJsonValue(catalogsProductGroupsCreateRequestSchema));
    } else {
    ...
    std::shared_ptr<CatalogsVerticalProductGroup> deserializedResponse = std::make_shared<CatalogsVerticalProductGroup>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<CatalogsVerticalProductGroup>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<Catalogs_product_groups_list_200_response>
CatalogProductGroupsApi::catalogsProductGroups_list(
    ...
    if (feedId) {
        appendQueryParameter(
            ...
            queryParameterSeparator,
            "feed_id",
            serializeQueryParameterValue(*feedId));
    }
    if (catalogId) {
        appendQueryParameter(
            queryParameterStream,
            queryParameterSeparator,
            "catalog_id",
            serializeQueryParameterValue(*catalogId));
    }
    if (adAccountId) {
        appendQueryParameter(
            queryParameterStream,
    ...
    std::shared_ptr<Catalogs_product_groups_list_200_response> deserializedResponse = std::make_shared<Catalogs_product_groups_list_200_response>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<Catalogs_product_groups_list_200_response>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
CatalogProductGroupsApi::catalogsProductGroups_createMany(
    ...
    std::string serializedRequestBody;
    std::string path = m_context + "/catalogs/product_groups/multiple";
    std::map<std::string, std::string> headers;
    static const std::vector<std::string> contentTypes{ "application/json", };
    std::string requestContentType = selectPreferredContentType(contentTypes);
    headers["Content-Type"] = requestContentType;
    // Body params
    if (isJsonContentType(requestContentType)) {
        serializedRequestBody = boost::json::serialize(toRequestJsonValue(catalogsProductGroupsCreateManyRequestItems));
    } else {
        throw std::invalid_argument("Content type '" + requestContentType + "' does not support structured request bodies");
    }
    // query params
    ...
    std::vector<std::shared_ptr<std::string>> deserializedResponse = std::vector<std::shared_ptr<std::string>>();
    if (statusCode == boost::beast::http::status(201)) {
        ResponseBodyDeserializer<std::vector<std::shared_ptr<std::string>>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
void
CatalogProductGroupsApi::catalogsProductGroups_deleteMany(
...
std::shared_ptr<CatalogsVerticalProductGroup>
CatalogProductGroupsApi::catalogsProductGroups_delete(
    const std::string& productGroupId, const boost::optional<std::string>& adAccountId) {
    std::string serializedRequestBody;
    std::string path = m_context + "/catalogs/product_groups/{product_group_id}";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "product_group_id", productGroupId);
    // query params
...
std::shared_ptr<CatalogsVerticalProductGroup>
CatalogProductGroupsApi::catalogsProductGroups_get(
    const std::string& productGroupId, const boost::optional<std::string>& adAccountId) {
    std::string serializedRequestBody;
    std::string path = m_context + "/catalogs/product_groups/{product_group_id}";
    std::map<std::string, std::string> headers;
...
std::shared_ptr<CatalogsVerticalProductGroup>
CatalogProductGroupsApi::catalogsProductGroups_update(
    ...
    // Body params
    if (isJsonContentType(requestContentType)) {
        serializedRequestBody = boost::json::serialize(toRequestJsonValue(catalogsProductGroupsUpdateRequestSchema));
    } else {
        throw std::invalid_argument("Content type '" + requestContentType + "' does not support structured request bodies");
    }
    // path params
...
std::shared_ptr<CatalogsProductGroupProductCountsVertical>
CatalogProductGroupsApi::catalogsProductGroups_productCountsGet(
    const std::string& productGroupId, const boost::optional<std::string>& adAccountId) {
    std::string serializedRequestBody;
    std::string path = m_context + "/catalogs/product_groups/{product_group_id}/product_counts";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "product_group_id", productGroupId);
    // query params
    ...
    std::shared_ptr<CatalogsProductGroupProductCountsVertical> deserializedResponse = std::make_shared<CatalogsProductGroupProductCountsVertical>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<CatalogsProductGroupProductCountsVertical>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<Catalogs_product_group_pins_list_200_response>
CatalogProductGroupsApi::productsByProductGroupFilter_list(
    ...
    std::string serializedRequestBody;
    std::string path = m_context + "/catalogs/products/get_by_product_group_filters";
    std::map<std::string, std::string> headers;
    static const std::vector<std::string> contentTypes{ "application/json", };
    std::string requestContentType = selectPreferredContentType(contentTypes);
    headers["Content-Type"] = requestContentType;
    // Body params
    if (isJsonContentType(requestContentType)) {
        serializedRequestBody = boost::json::serialize(toRequestJsonValue(catalogsListProductsByFilterRequest));
    } else {
        throw std::invalid_argument("Content type '" + requestContentType + "' does not support structured request bodies");
    }
    // query params
...
std::string CatalogProductGroupsApi::base64encode(const std::string& str) {
    return base64encodeImpl(str);
}

void CatalogProductGroupsApi::setPreferredMediaTypeHeader(std::map<std::string, std::string>& headers, const std::string& headerName, const std::vector<std::string>& contentTypes) {
    const std::string contentType = selectPreferredContentType(contentTypes);
    headers[headerName] = contentType;
}

void CatalogProductGroupsApi::handleStdException(const std::exception&) {
    throw;
}

void CatalogProductGroupsApi::handleUncaughtException() {
    throw;
}
