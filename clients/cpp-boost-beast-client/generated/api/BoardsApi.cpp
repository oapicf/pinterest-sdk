...
BoardsApiException::BoardsApiException(boost::beast::http::status statusCode, std::string what)
  : m_status(statusCode),
    m_what(what)
{
}

boost::beast::http::status BoardsApiException::getStatus() const
{
    return m_status;
}
...
std::shared_ptr<BoardSection>
BoardsApi::boardSections_create(
    ...
    std::string path = m_context + "/boards/{board_id}/sections";
    ...
    if (isJsonContentType(requestContentType)) {
        serializedRequestBody = boost::json::serialize(toRequestJsonValue(boardSectionCreate));
    } else {
        throw std::invalid_argument("Content type '" + requestContentType + "' does not support structured request bodies");
    }
    // path params
    replacePathParameter(path, "board_id", boardId);
    // query params
    std::stringstream queryParameterStream;
    const char* queryParameterSeparator = "?";
    if (adAccountId) {
    ...
    std::shared_ptr<BoardSection> deserializedResponse = std::make_shared<BoardSection>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<BoardSection>>::deserialize(
    ...
    if (statusCode == boost::beast::http::status(400)) {
        throw BoardsApiException(statusCode, "The request could not be understood by the server due to unexpected data.");
    }
    if (statusCode == boost::beast::http::status(401)) {
        throw BoardsApiException(statusCode, "Authentication is required and has either failed or not been provided.");
    }
    if (statusCode == boost::beast::http::status(403)) {
        throw BoardsApiException(statusCode, "The request was valid, but the server is refusing action. The user might not have the necessary permissions for a resource.");
    }
    if (statusCode == boost::beast::http::status(404)) {
        throw BoardsApiException(statusCode, "The requested resource could not be found on this server.");
    }
    if (statusCode == boost::beast::http::status(429)) {
        throw BoardsApiException(statusCode, "The user has sent too many requests in a given amount of time and is being rate limited.");
    }
    throw BoardsApiException(statusCode, "An unexpected error response.");
}
std::shared_ptr<Board_sections_list_200_response>
BoardsApi::boardSections_list(
    ...
    std::shared_ptr<Board_sections_list_200_response> deserializedResponse = std::make_shared<Board_sections_list_200_response>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<Board_sections_list_200_response>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<BoardSection>
BoardsApi::boardSections_delete(
    const std::string& boardId, const std::string& sectionId, const boost::optional<std::string>& adAccountId) {
    std::string serializedRequestBody;
    std::string path = m_context + "/boards/{board_id}/sections/{section_id}";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "board_id", boardId);
    replacePathParameter(path, "section_id", sectionId);
    // query params
    std::stringstream queryParameterStream;
    const char* queryParameterSeparator = "?";
    if (adAccountId) {
...
std::shared_ptr<BoardSection>
BoardsApi::boardSections_update(
    ...
    // Body params
    if (isJsonContentType(requestContentType)) {
        serializedRequestBody = boost::json::serialize(toRequestJsonValue(boardSectionUpdateWithRequiredBody));
    } else {
        throw std::invalid_argument("Content type '" + requestContentType + "' does not support structured request bodies");
    }
    // path params
...
std::shared_ptr<Boards_list_pins_200_response>
BoardsApi::boardSections_listPins(
    ...
    std::string serializedRequestBody;
    std::string path = m_context + "/boards/{board_id}/sections/{section_id}/pins";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "board_id", boardId);
    replacePathParameter(path, "section_id", sectionId);
    ...
    std::shared_ptr<Boards_list_pins_200_response> deserializedResponse = std::make_shared<Boards_list_pins_200_response>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<Boards_list_pins_200_response>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
BoardsApi::boards_create(
    ...
    std::string serializedRequestBody;
    std::string path = m_context + "/boards";
    std::map<std::string, std::string> headers;
    static const std::vector<std::string> contentTypes{ "application/json", };
    std::string requestContentType = selectPreferredContentType(contentTypes);
    headers["Content-Type"] = requestContentType;
    // Body params
    if (isJsonContentType(requestContentType)) {
        serializedRequestBody = boost::json::serialize(toRequestJsonValue(boardCreate));
    } else {
        throw std::invalid_argument("Content type '" + requestContentType + "' does not support structured request bodies");
    }
    // query params
    ...
    std::shared_ptr<Board> deserializedResponse = std::make_shared<Board>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<Board>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
BoardsApi::boards_list(
    ...
    if (privacy) {
        appendQueryParameter(
            ...
            queryParameterSeparator,
            "privacy",
            serializeQueryParameterValue(*privacy));
    }
    if (bookmark) {
        appendQueryParameter(
            queryParameterStream,
...
BoardsApi::boards_delete(
    ...
    std::string serializedRequestBody;
    std::string path = m_context + "/boards/{board_id}";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "board_id", boardId);
    // query params
...
std::shared_ptr<BoardWithUpdatePrivacy>
BoardsApi::boards_update(
    ...
    // Body params
    if (isJsonContentType(requestContentType)) {
        serializedRequestBody = boost::json::serialize(toRequestJsonValue(boardWithUpdatePrivacyUpdate));
    } else {
        throw std::invalid_argument("Content type '" + requestContentType + "' does not support structured request bodies");
    }
    // path params
    ...
    std::shared_ptr<BoardWithUpdatePrivacy> deserializedResponse = std::make_shared<BoardWithUpdatePrivacy>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<BoardWithUpdatePrivacy>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
BoardsApi::boards_listPins(
    ...
    std::string serializedRequestBody;
    std::string path = m_context + "/boards/{board_id}/pins";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "board_id", boardId);
    // query params
...
std::string BoardsApi::base64encode(const std::string& str) {
    return base64encodeImpl(str);
}

void BoardsApi::setPreferredMediaTypeHeader(std::map<std::string, std::string>& headers, const std::string& headerName, const std::vector<std::string>& contentTypes) {
    const std::string contentType = selectPreferredContentType(contentTypes);
    headers[headerName] = contentType;
}

void BoardsApi::handleStdException(const std::exception&) {
    throw;
}

void BoardsApi::handleUncaughtException() {
    throw;
}
