...
BusinessAccessInviteApiException::BusinessAccessInviteApiException(boost::beast::http::status statusCode, std::string what)
  : m_status(statusCode),
    m_what(what)
{
}

boost::beast::http::status BusinessAccessInviteApiException::getStatus() const
{
    return m_status;
}
...
std::shared_ptr<CreateAssetAccessRequestResponse>
BusinessAccessInviteApi::assetAccessRequests_create(
    ...
    std::string path = m_context + "/businesses/{business_id}/requests/assets/access";
    ...
    if (isJsonContentType(requestContentType)) {
        serializedRequestBody = boost::json::serialize(toRequestJsonValue(createAssetAccessRequestBody));
    } else {
    ...
    std::shared_ptr<CreateAssetAccessRequestResponse> deserializedResponse = std::make_shared<CreateAssetAccessRequestResponse>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<CreateAssetAccessRequestResponse>>::deserialize(
    ...
    if (statusCode == boost::beast::http::status(400)) {
        throw BusinessAccessInviteApiException(statusCode, "The request could not be understood by the server due to unexpected data.");
    }
    if (statusCode == boost::beast::http::status(401)) {
        throw BusinessAccessInviteApiException(statusCode, "Authentication is required and has either failed or not been provided.");
    }
    if (statusCode == boost::beast::http::status(403)) {
        throw BusinessAccessInviteApiException(statusCode, "The request was valid, but the server is refusing action. The user might not have the necessary permissions for a resource.");
    }
    if (statusCode == boost::beast::http::status(404)) {
        throw BusinessAccessInviteApiException(statusCode, "The requested resource could not be found on this server.");
    }
    if (statusCode == boost::beast::http::status(429)) {
        throw BusinessAccessInviteApiException(statusCode, "The user has sent too many requests in a given amount of time and is being rate limited.");
    }
    throw BusinessAccessInviteApiException(statusCode, "An unexpected error response.");
}
std::shared_ptr<CancelInvitesResponse>
BusinessAccessInviteApi::cancelInvitesOrRequests(
    const std::string& businessId, const std::shared_ptr<CancelInvitesRequest>& cancelInvitesRequest) {
    std::string serializedRequestBody;
    std::string path = m_context + "/businesses/{business_id}/invites";
    std::map<std::string, std::string> headers;
    static const std::vector<std::string> contentTypes{ "application/json", };
    std::string requestContentType = selectPreferredContentType(contentTypes);
    headers["Content-Type"] = requestContentType;
    // Body params
    if (isJsonContentType(requestContentType)) {
        serializedRequestBody = boost::json::serialize(toRequestJsonValue(cancelInvitesRequest));
    } else {
        throw std::invalid_argument("Content type '" + requestContentType + "' does not support structured request bodies");
    }
    // path params
    ...
    std::shared_ptr<CancelInvitesResponse> deserializedResponse = std::make_shared<CancelInvitesResponse>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<CancelInvitesResponse>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<CreateInvitesResultsResponseArray>
BusinessAccessInviteApi::createMembershipOrPartnershipInvites(
    ...
    // Body params
    if (isJsonContentType(requestContentType)) {
        serializedRequestBody = boost::json::serialize(toRequestJsonValue(createMembershipOrPartnershipInvitesBody));
    } else {
        throw std::invalid_argument("Content type '" + requestContentType + "' does not support structured request bodies");
    }
    // path params
    ...
    std::shared_ptr<CreateInvitesResultsResponseArray> deserializedResponse = std::make_shared<CreateInvitesResultsResponseArray>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<CreateInvitesResultsResponseArray>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<Get_invites_200_response>
BusinessAccessInviteApi::get_invites(
    ...
    if (isMember) {
        appendQueryParameter(
            ...
            queryParameterSeparator,
            "is_member",
            serializeQueryParameterValue(*isMember));
    }
    if (inviteStatus) {
    ...
    if (inviteType) {
        appendQueryParameter(
            ...
            queryParameterSeparator,
            "invite_type",
            serializeQueryParameterValue(*inviteType));
    }
    if (bookmark) {
        appendQueryParameter(
            queryParameterStream,
    ...
    std::shared_ptr<Get_invites_200_response> deserializedResponse = std::make_shared<Get_invites_200_response>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<Get_invites_200_response>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<UpdateInvitesResultsResponseArray>
BusinessAccessInviteApi::createAssetInvites(
    const std::string& businessId, const std::shared_ptr<CreateAssetInvitesRequest>& createAssetInvitesRequest) {
    std::string serializedRequestBody;
    std::string path = m_context + "/businesses/{business_id}/invites/assets/access";
    std::map<std::string, std::string> headers;
    static const std::vector<std::string> contentTypes{ "application/json", };
    std::string requestContentType = selectPreferredContentType(contentTypes);
    headers["Content-Type"] = requestContentType;
    // Body params
    if (isJsonContentType(requestContentType)) {
        serializedRequestBody = boost::json::serialize(toRequestJsonValue(createAssetInvitesRequest));
    } else {
        throw std::invalid_argument("Content type '" + requestContentType + "' does not support structured request bodies");
    }
    // path params
    ...
    std::shared_ptr<UpdateInvitesResultsResponseArray> deserializedResponse = std::make_shared<UpdateInvitesResultsResponseArray>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<UpdateInvitesResultsResponseArray>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<RespondToInvitesResponseArray>
BusinessAccessInviteApi::respondBusinessAccessInvites(
    const std::shared_ptr<AuthRespondInvitesBody>& authRespondInvitesBody) {
    std::string serializedRequestBody;
    std::string path = m_context + "/businesses/invites";
    std::map<std::string, std::string> headers;
    static const std::vector<std::string> contentTypes{ "application/json", };
    std::string requestContentType = selectPreferredContentType(contentTypes);
    headers["Content-Type"] = requestContentType;
    // Body params
    if (isJsonContentType(requestContentType)) {
        serializedRequestBody = boost::json::serialize(toRequestJsonValue(authRespondInvitesBody));
    } else {
        throw std::invalid_argument("Content type '" + requestContentType + "' does not support structured request bodies");
    }
    ...
    std::shared_ptr<RespondToInvitesResponseArray> deserializedResponse = std::make_shared<RespondToInvitesResponseArray>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<RespondToInvitesResponseArray>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::string BusinessAccessInviteApi::base64encode(const std::string& str) {
    return base64encodeImpl(str);
}

void BusinessAccessInviteApi::setPreferredMediaTypeHeader(std::map<std::string, std::string>& headers, const std::string& headerName, const std::vector<std::string>& contentTypes) {
    const std::string contentType = selectPreferredContentType(contentTypes);
    headers[headerName] = contentType;
}

void BusinessAccessInviteApi::handleStdException(const std::exception&) {
    throw;
}

void BusinessAccessInviteApi::handleUncaughtException() {
    throw;
}
