...
BusinessAccessRelationshipsApiException::BusinessAccessRelationshipsApiException(boost::beast::http::status statusCode, std::string what)
  : m_status(statusCode),
    m_what(what)
{
}

boost::beast::http::status BusinessAccessRelationshipsApiException::getStatus() const
{
    return m_status;
}
...
std::shared_ptr<BrandAccount>
BusinessAccessRelationshipsApi::brandAccounts_create(
    ...
    std::string path = m_context + "/business_access/business_hierarchy/{business_hierarchy_id}/brand_accounts";
    ...
    if (isJsonContentType(requestContentType)) {
        serializedRequestBody = boost::json::serialize(toRequestJsonValue(brandAccountCreate));
    } else {
        throw std::invalid_argument("Content type '" + requestContentType + "' does not support structured request bodies");
    }
    // path params
    replacePathParameter(path, "business_hierarchy_id", businessHierarchyId);
    ...
    std::shared_ptr<BrandAccount> deserializedResponse = std::make_shared<BrandAccount>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<BrandAccount>>::deserialize(
    ...
    if (statusCode == boost::beast::http::status(400)) {
        throw BusinessAccessRelationshipsApiException(statusCode, "The request could not be understood by the server due to unexpected data.");
    }
    if (statusCode == boost::beast::http::status(401)) {
        throw BusinessAccessRelationshipsApiException(statusCode, "Authentication is required and has either failed or not been provided.");
    }
    if (statusCode == boost::beast::http::status(403)) {
        throw BusinessAccessRelationshipsApiException(statusCode, "The request was valid, but the server is refusing action. The user might not have the necessary permissions for a resource.");
    }
    if (statusCode == boost::beast::http::status(404)) {
        throw BusinessAccessRelationshipsApiException(statusCode, "The requested resource could not be found on this server.");
    }
    if (statusCode == boost::beast::http::status(429)) {
        throw BusinessAccessRelationshipsApiException(statusCode, "The user has sent too many requests in a given amount of time and is being rate limited.");
    }
    throw BusinessAccessRelationshipsApiException(statusCode, "An unexpected error response.");
}
std::shared_ptr<BrandAccount>
BusinessAccessRelationshipsApi::brandAccounts_update(
    ...
    std::string serializedRequestBody;
    std::string path = m_context + "/business_access/business_hierarchy/{business_hierarchy_id}/brand_accounts/{brand_account_id}";
    std::map<std::string, std::string> headers;
    static const std::vector<std::string> contentTypes{ "application/json", };
    std::string requestContentType = selectPreferredContentType(contentTypes);
    headers["Content-Type"] = requestContentType;
    // Body params
    if (isJsonContentType(requestContentType)) {
        serializedRequestBody = boost::json::serialize(toRequestJsonValue(brandAccountUpdate));
    } else {
        throw std::invalid_argument("Content type '" + requestContentType + "' does not support structured request bodies");
    }
    // path params
    replacePathParameter(path, "brand_account_id", brandAccountId);
    replacePathParameter(path, "business_hierarchy_id", businessHierarchyId);
    ...
    if (statusCode == boost::beast::http::status(409)) {
        throw BusinessAccessRelationshipsApiException(statusCode, "The request could not be processed because of a conflict in the current state of the resource.");
    }
    if (statusCode == boost::beast::http::status(429)) {
        throw BusinessAccessRelationshipsApiException(statusCode, "The user has sent too many requests in a given amount of time and is being rate limited.");
    }
...
std::shared_ptr<Delete_business_membership_200_response>
BusinessAccessRelationshipsApi::deleteBusinessMembership(
    const std::string& businessId, const std::shared_ptr<DeleteBusinessMembershipBody>& deleteBusinessMembershipBody) {
    std::string serializedRequestBody;
    std::string path = m_context + "/businesses/{business_id}/members";
    std::map<std::string, std::string> headers;
    static const std::vector<std::string> contentTypes{ "application/json", };
    std::string requestContentType = selectPreferredContentType(contentTypes);
    headers["Content-Type"] = requestContentType;
    // Body params
    if (isJsonContentType(requestContentType)) {
        serializedRequestBody = boost::json::serialize(toRequestJsonValue(deleteBusinessMembershipBody));
    } else {
        throw std::invalid_argument("Content type '" + requestContentType + "' does not support structured request bodies");
    }
    // path params
    ...
    std::shared_ptr<Delete_business_membership_200_response> deserializedResponse = std::make_shared<Delete_business_membership_200_response>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<Delete_business_membership_200_response>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<Get_business_employers_200_response>
BusinessAccessRelationshipsApi::get_businessMembers(
    ...
    if (assetsSummary) {
        appendQueryParameter(
            ...
            queryParameterSeparator,
            "assets_summary",
            serializeQueryParameterValue(*assetsSummary));
    }
    if (businessRoles) {
    ...
    if (memberIds) {
        appendQueryParameter(
            ...
            queryParameterSeparator,
            "member_ids",
            serializeQueryParameterValue(*memberIds));
    }
    if (startIndex) {
        appendQueryParameter(
            queryParameterStream,
    ...
    std::shared_ptr<Get_business_employers_200_response> deserializedResponse = std::make_shared<Get_business_employers_200_response>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<Get_business_employers_200_response>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<UpdateBusinessMembershipsResponse>
BusinessAccessRelationshipsApi::update_businessMemberships(
    ...
    // Body params
    if (isJsonContentType(requestContentType)) {
        serializedRequestBody = boost::json::serialize(toRequestJsonValue(businessMembershipMember));
    } else {
        throw std::invalid_argument("Content type '" + requestContentType + "' does not support structured request bodies");
    }
    // path params
    ...
    std::shared_ptr<UpdateBusinessMembershipsResponse> deserializedResponse = std::make_shared<UpdateBusinessMembershipsResponse>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<UpdateBusinessMembershipsResponse>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<DeleteBusinessPartners>
BusinessAccessRelationshipsApi::deleteBusinessPartners(
    const std::string& businessId, const std::shared_ptr<DeleteBusinessPartnersDelete>& deleteBusinessPartnersDelete) {
    std::string serializedRequestBody;
    std::string path = m_context + "/businesses/{business_id}/partners";
    std::map<std::string, std::string> headers;
    static const std::vector<std::string> contentTypes{ "application/json", };
    std::string requestContentType = selectPreferredContentType(contentTypes);
    headers["Content-Type"] = requestContentType;
    // Body params
    if (isJsonContentType(requestContentType)) {
        serializedRequestBody = boost::json::serialize(toRequestJsonValue(deleteBusinessPartnersDelete));
    } else {
        throw std::invalid_argument("Content type '" + requestContentType + "' does not support structured request bodies");
    }
    // path params
    ...
    std::shared_ptr<DeleteBusinessPartners> deserializedResponse = std::make_shared<DeleteBusinessPartners>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<DeleteBusinessPartners>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<Get_business_employers_200_response>
BusinessAccessRelationshipsApi::get_businessPartners(
    ...
    if (partnerIds) {
        appendQueryParameter(
            ...
            queryParameterSeparator,
            "partner_ids",
            serializeQueryParameterValue(*partnerIds));
    }
    if (startIndex) {
        appendQueryParameter(
            queryParameterStream,
...
void
BusinessAccessRelationshipsApi::systemUser_update(
    ...
    std::string serializedRequestBody;
    std::string path = m_context + "/businesses/{business_id}/system_users/{system_user_id}";
    std::map<std::string, std::string> headers;
    static const std::vector<std::string> contentTypes{ "application/json", };
    std::string requestContentType = selectPreferredContentType(contentTypes);
    headers["Content-Type"] = requestContentType;
    // Body params
    if (isJsonContentType(requestContentType)) {
        serializedRequestBody = boost::json::serialize(toRequestJsonValue(systemUserUpdateWithRequiredBody));
    } else {
        throw std::invalid_argument("Content type '" + requestContentType + "' does not support structured request bodies");
    }
    // path params
    replacePathParameter(path, "business_id", businessId);
    replacePathParameter(path, "system_user_id", systemUserId);
...
std::string BusinessAccessRelationshipsApi::base64encode(const std::string& str) {
    return base64encodeImpl(str);
}

void BusinessAccessRelationshipsApi::setPreferredMediaTypeHeader(std::map<std::string, std::string>& headers, const std::string& headerName, const std::vector<std::string>& contentTypes) {
    const std::string contentType = selectPreferredContentType(contentTypes);
    headers[headerName] = contentType;
}

void BusinessAccessRelationshipsApi::handleStdException(const std::exception&) {
    throw;
}

void BusinessAccessRelationshipsApi::handleUncaughtException() {
    throw;
}
