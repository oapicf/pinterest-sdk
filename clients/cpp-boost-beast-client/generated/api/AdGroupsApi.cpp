...
AdGroupsApiException::AdGroupsApiException(boost::beast::http::status statusCode, std::string what)
  : m_status(statusCode),
    m_what(what)
{
}

boost::beast::http::status AdGroupsApiException::getStatus() const
{
    return m_status;
}
...
std::shared_ptr<BidFloor>
AdGroupsApi::adGroupsBidFloor_get(
    const std::string& adAccountId, const std::shared_ptr<BidFloorCreate>& bidFloorCreate) {
    std::string serializedRequestBody;
    std::string path = m_context + "/ad_accounts/{ad_account_id}/bid_floor";
    ...
    if (isJsonContentType(requestContentType)) {
        serializedRequestBody = boost::json::serialize(toRequestJsonValue(bidFloorCreate));
    } else {
    ...
    std::shared_ptr<BidFloor> deserializedResponse = std::make_shared<BidFloor>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<BidFloor>>::deserialize(
    ...
    if (statusCode == boost::beast::http::status(400)) {
        throw AdGroupsApiException(statusCode, "The request could not be understood by the server due to unexpected data.");
    }
    if (statusCode == boost::beast::http::status(401)) {
        throw AdGroupsApiException(statusCode, "Authentication is required and has either failed or not been provided.");
    }
    if (statusCode == boost::beast::http::status(403)) {
        throw AdGroupsApiException(statusCode, "The request was valid, but the server is refusing action. The user might not have the necessary permissions for a resource.");
    }
    if (statusCode == boost::beast::http::status(404)) {
        throw AdGroupsApiException(statusCode, "The requested resource could not be found on this server.");
    }
    if (statusCode == boost::beast::http::status(429)) {
        throw AdGroupsApiException(statusCode, "The user has sent too many requests in a given amount of time and is being rate limited.");
    }
    throw AdGroupsApiException(statusCode, "An unexpected error response.");
}
std::shared_ptr<DynamicTitlesDownloadCSV>
AdGroupsApi::adGroupsDynamicTitles_downloadCsv(
    const std::string& adAccountId, const std::string& adGroupId) {
    std::string serializedRequestBody;
    std::string path = m_context + "/ad_accounts/{ad_account_id}/ad_groups/{ad_group_id}/dynamic_titles/csv";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "ad_account_id", adAccountId);
    replacePathParameter(path, "ad_group_id", adGroupId);
    ...
    std::shared_ptr<DynamicTitlesDownloadCSV> deserializedResponse = std::make_shared<DynamicTitlesDownloadCSV>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<DynamicTitlesDownloadCSV>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<DynamicTitlesGetStatus>
AdGroupsApi::adGroupsDynamicTitles_getStatus(
    const std::string& adAccountId, const std::string& adGroupId) {
    std::string serializedRequestBody;
    std::string path = m_context + "/ad_accounts/{ad_account_id}/ad_groups/{ad_group_id}/dynamic_titles/status";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "ad_account_id", adAccountId);
    replacePathParameter(path, "ad_group_id", adGroupId);
    ...
    std::shared_ptr<DynamicTitlesGetStatus> deserializedResponse = std::make_shared<DynamicTitlesGetStatus>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<DynamicTitlesGetStatus>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<DynamicTitlesUploadURL>
AdGroupsApi::adGroupsDynamicTitles_getUploadUrl(
    const std::string& adAccountId, const std::string& adGroupId) {
    std::string serializedRequestBody;
    std::string path = m_context + "/ad_accounts/{ad_account_id}/ad_groups/{ad_group_id}/dynamic_titles/uploads";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "ad_account_id", adAccountId);
    replacePathParameter(path, "ad_group_id", adGroupId);
    ...
    std::shared_ptr<DynamicTitlesUploadURL> deserializedResponse = std::make_shared<DynamicTitlesUploadURL>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<DynamicTitlesUploadURL>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<DynamicTitlesProcessCSV>
AdGroupsApi::adGroupsDynamicTitles_processCsv(
    ...
    std::string serializedRequestBody;
    std::string path = m_context + "/ad_accounts/{ad_account_id}/ad_groups/{ad_group_id}/dynamic_titles";
    std::map<std::string, std::string> headers;
    static const std::vector<std::string> contentTypes{ "application/json", };
    std::string requestContentType = selectPreferredContentType(contentTypes);
    headers["Content-Type"] = requestContentType;
    // Body params
    if (isJsonContentType(requestContentType)) {
        serializedRequestBody = boost::json::serialize(toRequestJsonValue(dynamicTitlesProcessCSVCreate));
    } else {
        throw std::invalid_argument("Content type '" + requestContentType + "' does not support structured request bodies");
    }
    // path params
    ...
    std::shared_ptr<DynamicTitlesProcessCSV> deserializedResponse = std::make_shared<DynamicTitlesProcessCSV>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<DynamicTitlesProcessCSV>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
AdGroupsApi::adGroupsTargetingAnalytics_get(
    ...
    std::string serializedRequestBody;
    std::string path = m_context + "/ad_accounts/{ad_account_id}/ad_groups/targeting_analytics";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "ad_account_id", adAccountId);
    // query params
...
std::vector<std::shared_ptr<AdGroupsAnalyticsMetrics>>
AdGroupsApi::adGroups_analytics(
    ...
    std::string serializedRequestBody;
    std::string path = m_context + "/ad_accounts/{ad_account_id}/ad_groups/analytics";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "ad_account_id", adAccountId);
    // query params
    ...
    std::vector<std::shared_ptr<AdGroupsAnalyticsMetrics>> deserializedResponse = std::vector<std::shared_ptr<AdGroupsAnalyticsMetrics>>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::vector<std::shared_ptr<AdGroupsAnalyticsMetrics>>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<AdGroupAudienceSizing>
AdGroupsApi::adGroups_audienceSizing(
    const std::string& adAccountId, const std::shared_ptr<AdGroupAudienceSizingCreate>& adGroupAudienceSizingCreate) {
    std::string serializedRequestBody;
    std::string path = m_context + "/ad_accounts/{ad_account_id}/ad_groups/audience_sizing";
    std::map<std::string, std::string> headers;
    static const std::vector<std::string> contentTypes{ "application/json", };
    std::string requestContentType = selectPreferredContentType(contentTypes);
    headers["Content-Type"] = requestContentType;
    // Body params
    if (isJsonContentType(requestContentType)) {
        serializedRequestBody = boost::json::serialize(toRequestJsonValue(adGroupAudienceSizingCreate));
    } else {
        throw std::invalid_argument("Content type '" + requestContentType + "' does not support structured request bodies");
    }
    // path params
    ...
    std::shared_ptr<AdGroupAudienceSizing> deserializedResponse = std::make_shared<AdGroupAudienceSizing>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<AdGroupAudienceSizing>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<Ad_groups_create_200_response>
AdGroupsApi::adGroups_create(
    const std::string& adAccountId, const std::vector<std::shared_ptr<AdGroupCreateCreate>>& adGroupCreateCreate) {
    std::string serializedRequestBody;
    std::string path = m_context + "/ad_accounts/{ad_account_id}/ad_groups";
    std::map<std::string, std::string> headers;
    static const std::vector<std::string> contentTypes{ "application/json", };
    std::string requestContentType = selectPreferredContentType(contentTypes);
    headers["Content-Type"] = requestContentType;
    // Body params
    if (isJsonContentType(requestContentType)) {
        serializedRequestBody = boost::json::serialize(toRequestJsonValue(adGroupCreateCreate));
    } else {
        throw std::invalid_argument("Content type '" + requestContentType + "' does not support structured request bodies");
    }
    // path params
    ...
    std::shared_ptr<Ad_groups_create_200_response> deserializedResponse = std::make_shared<Ad_groups_create_200_response>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<Ad_groups_create_200_response>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<Ad_groups_list_200_response>
AdGroupsApi::adGroups_list(
    ...
    if (translateInterestsToNames) {
        appendQueryParameter(
            ...
            serializeQueryParameterValue(*translateInterestsToNames));
    }
    path += queryParameterStream.str();
    ...
    std::shared_ptr<Ad_groups_list_200_response> deserializedResponse = std::make_shared<Ad_groups_list_200_response>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<Ad_groups_list_200_response>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
AdGroupsApi::adGroups_update(
    ...
    // Body params
    if (isJsonContentType(requestContentType)) {
        serializedRequestBody = boost::json::serialize(toRequestJsonValue(adGroupUpdateBatchUpdate));
    } else {
        throw std::invalid_argument("Content type '" + requestContentType + "' does not support structured request bodies");
    }
    // path params
...
std::shared_ptr<AdGroup>
AdGroupsApi::adGroups_get(
    const std::string& adGroupId, const std::string& adAccountId) {
    std::string serializedRequestBody;
    std::string path = m_context + "/ad_accounts/{ad_account_id}/ad_groups/{ad_group_id}";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "ad_group_id", adGroupId);
    replacePathParameter(path, "ad_account_id", adAccountId);
    ...
    std::shared_ptr<AdGroup> deserializedResponse = std::make_shared<AdGroup>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<AdGroup>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<Ad_groups_list_200_response>
AdGroupsApi::getAdGroupsByPromotionIds_list(
    ...
    std::string serializedRequestBody;
    std::string path = m_context + "/ad_accounts/{ad_account_id}/promotion_applied_entities";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "ad_account_id", adAccountId);
    // query params
...
std::string AdGroupsApi::base64encode(const std::string& str) {
    return base64encodeImpl(str);
}

void AdGroupsApi::setPreferredMediaTypeHeader(std::map<std::string, std::string>& headers, const std::string& headerName, const std::vector<std::string>& contentTypes) {
    const std::string contentType = selectPreferredContentType(contentTypes);
    headers[headerName] = contentType;
}

void AdGroupsApi::handleStdException(const std::exception&) {
    throw;
}

void AdGroupsApi::handleUncaughtException() {
    throw;
}
