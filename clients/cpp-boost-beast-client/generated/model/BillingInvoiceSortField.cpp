...
BillingInvoiceSortField::BillingInvoiceSortField(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string BillingInvoiceSortField::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value BillingInvoiceSortField::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void BillingInvoiceSortField::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for BillingInvoiceSortField");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object BillingInvoiceSortField::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void BillingInvoiceSortField::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<BillingInvoiceSortField>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<BillingInvoiceSortField>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<BillingInvoiceSortField>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<BillingInvoiceSortField>>>::fromJsonValue(boost::json::parse(json));
}
