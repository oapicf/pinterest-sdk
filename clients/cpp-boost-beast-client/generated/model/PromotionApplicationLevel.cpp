...
PromotionApplicationLevel::PromotionApplicationLevel(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string PromotionApplicationLevel::toJsonString(bool prettyJson /* = false */) const
{
...
void PromotionApplicationLevel::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value PromotionApplicationLevel::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void PromotionApplicationLevel::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for PromotionApplicationLevel");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object PromotionApplicationLevel::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void PromotionApplicationLevel::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<PromotionApplicationLevel>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<PromotionApplicationLevel>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<PromotionApplicationLevel>>>::fromJsonValue(boost::json::parse(json));
}
