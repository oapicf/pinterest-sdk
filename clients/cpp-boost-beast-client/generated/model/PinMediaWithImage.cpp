...
PinMediaWithImage::PinMediaWithImage(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string PinMediaWithImage::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value PinMediaWithImage::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void PinMediaWithImage::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for PinMediaWithImage");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object PinMediaWithImage::toJsonObject_internal() const
{
...
void PinMediaWithImage::fromJsonObject_internal(boost::json::object const& object)
{
    m_ImagesIsSet = false;
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<PinMediaWithImage>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<PinMediaWithImage>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<PinMediaWithImage>>>::fromJsonValue(boost::json::parse(json));
}
