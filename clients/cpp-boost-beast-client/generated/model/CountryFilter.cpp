...
CountryFilter::CountryFilter(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string CountryFilter::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value CountryFilter::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CountryFilter::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CountryFilter");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CountryFilter::toJsonObject_internal() const
{
...
void CountryFilter::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CountryFilter>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CountryFilter>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CountryFilter>>>::fromJsonValue(boost::json::parse(json));
}
