...
DynamicTitlesProcessCSVCreate::DynamicTitlesProcessCSVCreate(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string DynamicTitlesProcessCSVCreate::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value DynamicTitlesProcessCSVCreate::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void DynamicTitlesProcessCSVCreate::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for DynamicTitlesProcessCSVCreate");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object DynamicTitlesProcessCSVCreate::toJsonObject_internal() const
{
...
void DynamicTitlesProcessCSVCreate::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<DynamicTitlesProcessCSVCreate>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<DynamicTitlesProcessCSVCreate>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<DynamicTitlesProcessCSVCreate>>>::fromJsonValue(boost::json::parse(json));
}
