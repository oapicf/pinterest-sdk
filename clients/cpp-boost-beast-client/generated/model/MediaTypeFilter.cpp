...
MediaTypeFilter::MediaTypeFilter(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string MediaTypeFilter::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value MediaTypeFilter::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void MediaTypeFilter::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for MediaTypeFilter");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object MediaTypeFilter::toJsonObject_internal() const
{
...
void MediaTypeFilter::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<MediaTypeFilter>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<MediaTypeFilter>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<MediaTypeFilter>>>::fromJsonValue(boost::json::parse(json));
}
