...
GoogleProductCategory6Filter::GoogleProductCategory6Filter(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string GoogleProductCategory6Filter::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value GoogleProductCategory6Filter::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void GoogleProductCategory6Filter::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for GoogleProductCategory6Filter");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object GoogleProductCategory6Filter::toJsonObject_internal() const
{
...
void GoogleProductCategory6Filter::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<GoogleProductCategory6Filter>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<GoogleProductCategory6Filter>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<GoogleProductCategory6Filter>>>::fromJsonValue(boost::json::parse(json));
}
