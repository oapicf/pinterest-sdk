...
CatalogsHotelProduct::CatalogsHotelProduct(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value CatalogsHotelProduct::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogsHotelProduct::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogsHotelProduct");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogsHotelProduct::toJsonObject_internal() const
{
    boost::json::object object;
        object["catalog_type"] = JsonValueConverter<std::string>::toJsonValue(getCatalogType());
        object["metadata"] = JsonValueConverter<std::shared_ptr<CatalogsHotelProductMetadata>>::toJsonValue(getMetadata());
        object["pin"] = JsonValueConverter<std::shared_ptr<Pin>>::toJsonValue(getPin());
    return object;
}

void CatalogsHotelProduct::fromJsonObject_internal(boost::json::object const& object)
{
    {
    ...
    }
    {
        ...
        if (MetadataIt != object.end()) {
            setMetadata(JsonValueConverter<std::shared_ptr<CatalogsHotelProductMetadata>>::fromJsonValue(MetadataIt->value()));
        }
    }
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogsHotelProduct>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CatalogsHotelProduct>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogsHotelProduct>>>::fromJsonValue(boost::json::parse(json));
}
