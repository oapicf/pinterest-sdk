...
UpdateMemberAssetsResultsResponseArray::UpdateMemberAssetsResultsResponseArray(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string UpdateMemberAssetsResultsResponseArray::toJsonString(bool prettyJson /* = false */) const
{
...
void UpdateMemberAssetsResultsResponseArray::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value UpdateMemberAssetsResultsResponseArray::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void UpdateMemberAssetsResultsResponseArray::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for UpdateMemberAssetsResultsResponseArray");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object UpdateMemberAssetsResultsResponseArray::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_ItemsIsSet) {
            object["items"] = JsonValueConverter<std::vector<std::shared_ptr<UpdateMemberAssetResultItem>>>::toJsonValue(getItems());
        }
    return object;
}

void UpdateMemberAssetsResultsResponseArray::fromJsonObject_internal(boost::json::object const& object)
{
    m_ItemsIsSet = false;
    {
        const auto ItemsIt = object.find("items");
        if (ItemsIt != object.end()) {
            setItems(JsonValueConverter<std::vector<std::shared_ptr<UpdateMemberAssetResultItem>>>::fromJsonValue(ItemsIt->value()));
        }
    }
}
...
void UpdateMemberAssetsResultsResponseArray::setItems(std::vector<std::shared_ptr<UpdateMemberAssetResultItem>> value)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<UpdateMemberAssetsResultsResponseArray>>>::toJsonValue(data));
}
...
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<UpdateMemberAssetsResultsResponseArray>>>::fromJsonValue(boost::json::parse(json));
}
