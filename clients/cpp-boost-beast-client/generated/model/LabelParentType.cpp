...
LabelParentType::LabelParentType(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string LabelParentType::toJsonString(bool prettyJson /* = false */) const
{
...
void LabelParentType::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value LabelParentType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void LabelParentType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for LabelParentType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object LabelParentType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void LabelParentType::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<LabelParentType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<LabelParentType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<LabelParentType>>>::fromJsonValue(boost::json::parse(json));
}
