...
#ifndef BOOST_BEAST_OPENAPI_CLIENT_CampaignBatchResponseData_MODEL_H_
#define BOOST_BEAST_OPENAPI_CLIENT_CampaignBatchResponseData_MODEL_H_
...
public:
    ...
    explicit CampaignBatchResponseData(boost::json::value const& value);
    ...
    void setObjectiveType(std::shared_ptr<CampaignObjectiveType> value);
    ...
    void setStatus(std::shared_ptr<NullableEntityStatus> value);
...
protected:
    ...
    std::shared_ptr<CampaignObjectiveType> m_Objective_type = nullptr;
    ...
    std::shared_ptr<NullableEntityStatus> m_Status = nullptr;
    bool m_StatusIsSet = false;
    std::shared_ptr<SummaryStatus> m_Summary_status = nullptr;
    bool m_Summary_statusIsSet = false;
...
#endif /* BOOST_BEAST_OPENAPI_CLIENT_CampaignBatchResponseData_MODEL_H_ */
