...
BulkDownload::BulkDownload(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string BulkDownload::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value BulkDownload::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void BulkDownload::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for BulkDownload");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object BulkDownload::toJsonObject_internal() const
{
...
void BulkDownload::fromJsonObject_internal(boost::json::object const& object)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<BulkDownload>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<BulkDownload>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<BulkDownload>>>::fromJsonValue(boost::json::parse(json));
}
