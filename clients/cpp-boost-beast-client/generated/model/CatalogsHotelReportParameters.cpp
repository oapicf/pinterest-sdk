...
CatalogsHotelReportParameters::CatalogsHotelReportParameters(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string CatalogsHotelReportParameters::toJsonString(bool prettyJson /* = false */) const
{
...
void CatalogsHotelReportParameters::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value CatalogsHotelReportParameters::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogsHotelReportParameters::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogsHotelReportParameters");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogsHotelReportParameters::toJsonObject_internal() const
{
    boost::json::object object;
        object["catalog_type"] = JsonValueConverter<std::string>::toJsonValue(getCatalogType());
        object["report"] = JsonValueConverter<std::shared_ptr<CatalogsHotelReportParametersReport>>::toJsonValue(getReport());
    return object;
}

void CatalogsHotelReportParameters::fromJsonObject_internal(boost::json::object const& object)
{
    {
    ...
    }
    {
        ...
        if (ReportIt != object.end()) {
            setReport(JsonValueConverter<std::shared_ptr<CatalogsHotelReportParametersReport>>::fromJsonValue(ReportIt->value()));
        }
    }
}
...
void CatalogsHotelReportParameters::setCatalogType(std::string value)
{
...
void CatalogsHotelReportParameters::setReport(std::shared_ptr<CatalogsHotelReportParametersReport> value)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogsHotelReportParameters>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CatalogsHotelReportParameters>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogsHotelReportParameters>>>::fromJsonValue(boost::json::parse(json));
}
