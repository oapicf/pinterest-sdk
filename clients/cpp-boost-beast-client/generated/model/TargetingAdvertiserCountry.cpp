...
TargetingAdvertiserCountry::TargetingAdvertiserCountry(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value TargetingAdvertiserCountry::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void TargetingAdvertiserCountry::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for TargetingAdvertiserCountry");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object TargetingAdvertiserCountry::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void TargetingAdvertiserCountry::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<TargetingAdvertiserCountry>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<TargetingAdvertiserCountry>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<TargetingAdvertiserCountry>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<TargetingAdvertiserCountry>>>::fromJsonValue(boost::json::parse(json));
}
