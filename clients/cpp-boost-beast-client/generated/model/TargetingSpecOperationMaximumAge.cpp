...
TargetingSpecOperationMaximumAge::TargetingSpecOperationMaximumAge(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string TargetingSpecOperationMaximumAge::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value TargetingSpecOperationMaximumAge::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void TargetingSpecOperationMaximumAge::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for TargetingSpecOperationMaximumAge");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object TargetingSpecOperationMaximumAge::toJsonObject_internal() const
{
...
void TargetingSpecOperationMaximumAge::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<TargetingSpecOperationMaximumAge>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<TargetingSpecOperationMaximumAge>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<TargetingSpecOperationMaximumAge>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<TargetingSpecOperationMaximumAge>>>::fromJsonValue(boost::json::parse(json));
}
