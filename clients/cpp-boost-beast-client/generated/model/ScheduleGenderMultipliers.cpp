...
ScheduleGenderMultipliers::ScheduleGenderMultipliers(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ScheduleGenderMultipliers::toJsonString(bool prettyJson /* = false */) const
{
...
void ScheduleGenderMultipliers::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value ScheduleGenderMultipliers::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ScheduleGenderMultipliers::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ScheduleGenderMultipliers");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ScheduleGenderMultipliers::toJsonObject_internal() const
{
...
void ScheduleGenderMultipliers::fromJsonObject_internal(boost::json::object const& object)
{
    m_GENDERIsSet = false;
    {
...
void ScheduleGenderMultipliers::setGENDER(std::shared_ptr<TargetingSpecGender> value)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ScheduleGenderMultipliers>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ScheduleGenderMultipliers>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ScheduleGenderMultipliers>>>::fromJsonValue(boost::json::parse(json));
}
