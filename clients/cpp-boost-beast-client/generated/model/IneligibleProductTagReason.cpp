...
IneligibleProductTagReason::IneligibleProductTagReason(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string IneligibleProductTagReason::toJsonString(bool prettyJson /* = false */) const
{
...
void IneligibleProductTagReason::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value IneligibleProductTagReason::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void IneligibleProductTagReason::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for IneligibleProductTagReason");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object IneligibleProductTagReason::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void IneligibleProductTagReason::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<IneligibleProductTagReason>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<IneligibleProductTagReason>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<IneligibleProductTagReason>>>::fromJsonValue(boost::json::parse(json));
}
