...
EnhancedMatchStatusType::EnhancedMatchStatusType(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value EnhancedMatchStatusType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void EnhancedMatchStatusType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for EnhancedMatchStatusType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object EnhancedMatchStatusType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void EnhancedMatchStatusType::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<EnhancedMatchStatusType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<EnhancedMatchStatusType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<EnhancedMatchStatusType>>>::fromJsonValue(boost::json::parse(json));
}
