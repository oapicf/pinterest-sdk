...
PinMediaSourceVideoID::PinMediaSourceVideoID(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value PinMediaSourceVideoID::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void PinMediaSourceVideoID::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for PinMediaSourceVideoID");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object PinMediaSourceVideoID::toJsonObject_internal() const
{
...
void PinMediaSourceVideoID::fromJsonObject_internal(boost::json::object const& object)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<PinMediaSourceVideoID>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<PinMediaSourceVideoID>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<PinMediaSourceVideoID>>>::fromJsonValue(boost::json::parse(json));
}
