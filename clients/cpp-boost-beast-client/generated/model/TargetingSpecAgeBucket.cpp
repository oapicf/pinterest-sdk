...
TargetingSpecAgeBucket::TargetingSpecAgeBucket(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value TargetingSpecAgeBucket::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void TargetingSpecAgeBucket::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for TargetingSpecAgeBucket");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object TargetingSpecAgeBucket::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void TargetingSpecAgeBucket::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<TargetingSpecAgeBucket>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<TargetingSpecAgeBucket>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<TargetingSpecAgeBucket>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<TargetingSpecAgeBucket>>>::fromJsonValue(boost::json::parse(json));
}
