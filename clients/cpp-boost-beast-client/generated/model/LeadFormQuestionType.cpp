...
LeadFormQuestionType::LeadFormQuestionType(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string LeadFormQuestionType::toJsonString(bool prettyJson /* = false */) const
{
...
void LeadFormQuestionType::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value LeadFormQuestionType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void LeadFormQuestionType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for LeadFormQuestionType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object LeadFormQuestionType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void LeadFormQuestionType::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<LeadFormQuestionType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<LeadFormQuestionType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<LeadFormQuestionType>>>::fromJsonValue(boost::json::parse(json));
}
