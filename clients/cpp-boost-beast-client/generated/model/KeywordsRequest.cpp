...
KeywordsRequest::KeywordsRequest(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value KeywordsRequest::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void KeywordsRequest::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for KeywordsRequest");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object KeywordsRequest::toJsonObject_internal() const
{
    boost::json::object object;
        object["keywords"] = JsonValueConverter<std::vector<std::shared_ptr<KeywordsCommon>>>::toJsonValue(getKeywords());
        object["parent_id"] = JsonValueConverter<std::string>::toJsonValue(getParentId());
    return object;
}

void KeywordsRequest::fromJsonObject_internal(boost::json::object const& object)
{
    {
        const auto KeywordsIt = object.find("keywords");
        if (KeywordsIt != object.end()) {
            setKeywords(JsonValueConverter<std::vector<std::shared_ptr<KeywordsCommon>>>::fromJsonValue(KeywordsIt->value()));
        }
    }
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<KeywordsRequest>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<KeywordsRequest>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<KeywordsRequest>>>::fromJsonValue(boost::json::parse(json));
}
