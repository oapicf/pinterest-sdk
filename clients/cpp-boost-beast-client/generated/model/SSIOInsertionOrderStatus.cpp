...
SSIOInsertionOrderStatus::SSIOInsertionOrderStatus(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value SSIOInsertionOrderStatus::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void SSIOInsertionOrderStatus::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for SSIOInsertionOrderStatus");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object SSIOInsertionOrderStatus::toJsonObject_internal() const
{
...
void SSIOInsertionOrderStatus::fromJsonObject_internal(boost::json::object const& object)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<SSIOInsertionOrderStatus>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<SSIOInsertionOrderStatus>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<SSIOInsertionOrderStatus>>>::fromJsonValue(boost::json::parse(json));
}
