...
ConversionTagTypeOptimal::ConversionTagTypeOptimal(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ConversionTagTypeOptimal::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value ConversionTagTypeOptimal::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ConversionTagTypeOptimal::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ConversionTagTypeOptimal");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ConversionTagTypeOptimal::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void ConversionTagTypeOptimal::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ConversionTagTypeOptimal>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ConversionTagTypeOptimal>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ConversionTagTypeOptimal>>>::fromJsonValue(boost::json::parse(json));
}
