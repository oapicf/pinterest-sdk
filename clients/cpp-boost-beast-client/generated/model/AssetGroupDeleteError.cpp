...
AssetGroupDeleteError::AssetGroupDeleteError(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string AssetGroupDeleteError::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value AssetGroupDeleteError::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AssetGroupDeleteError::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AssetGroupDeleteError");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AssetGroupDeleteError::toJsonObject_internal() const
{
...
void AssetGroupDeleteError::fromJsonObject_internal(boost::json::object const& object)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AssetGroupDeleteError>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AssetGroupDeleteError>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AssetGroupDeleteError>>>::fromJsonValue(boost::json::parse(json));
}
