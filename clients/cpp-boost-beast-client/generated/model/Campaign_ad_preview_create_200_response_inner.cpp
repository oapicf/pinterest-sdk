...
Campaign_ad_preview_create_200_response_inner::Campaign_ad_preview_create_200_response_inner(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string Campaign_ad_preview_create_200_response_inner::toJsonString(bool prettyJson /* = false */) const
{
...
void Campaign_ad_preview_create_200_response_inner::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value Campaign_ad_preview_create_200_response_inner::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void Campaign_ad_preview_create_200_response_inner::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for Campaign_ad_preview_create_200_response_inner");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object Campaign_ad_preview_create_200_response_inner::toJsonObject_internal() const
{
    boost::json::object object;
        object["data"] = JsonValueConverter<std::shared_ptr<Campaign_ad_preview_create_200_response_inner_data>>::toJsonValue(getData());
    return object;
}

void Campaign_ad_preview_create_200_response_inner::fromJsonObject_internal(boost::json::object const& object)
{
    {
        const auto DataIt = object.find("data");
        if (DataIt != object.end()) {
            setData(JsonValueConverter<std::shared_ptr<Campaign_ad_preview_create_200_response_inner_data>>::fromJsonValue(DataIt->value()));
        }
    }
}

std::shared_ptr<Campaign_ad_preview_create_200_response_inner_data> Campaign_ad_preview_create_200_response_inner::getData() const
{
    return m_Data;
}

void Campaign_ad_preview_create_200_response_inner::setData(std::shared_ptr<Campaign_ad_preview_create_200_response_inner_data> value)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<Campaign_ad_preview_create_200_response_inner>>>::toJsonValue(data));
}
...
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<Campaign_ad_preview_create_200_response_inner>>>::fromJsonValue(boost::json::parse(json));
}
