...
Granularity::Granularity(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string Granularity::toJsonString(bool prettyJson /* = false */) const
{
...
void Granularity::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value Granularity::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void Granularity::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for Granularity");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object Granularity::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void Granularity::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<Granularity>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<Granularity>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<Granularity>>>::fromJsonValue(boost::json::parse(json));
}
