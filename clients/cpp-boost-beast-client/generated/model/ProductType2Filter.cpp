...
ProductType2Filter::ProductType2Filter(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ProductType2Filter::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value ProductType2Filter::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ProductType2Filter::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ProductType2Filter");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ProductType2Filter::toJsonObject_internal() const
{
...
void ProductType2Filter::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<ProductType2Filter>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ProductType2Filter>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ProductType2Filter>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ProductType2Filter>>>::fromJsonValue(boost::json::parse(json));
}
