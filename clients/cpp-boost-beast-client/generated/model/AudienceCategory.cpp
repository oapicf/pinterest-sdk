...
AudienceCategory::AudienceCategory(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value AudienceCategory::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AudienceCategory::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AudienceCategory");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AudienceCategory::toJsonObject_internal() const
{
    boost::json::object object;
        ...
        if (m_IndexIsSet) {
            object["index"] = JsonValueConverter<double>::toJsonValue(getIndex());
        }
        if (m_KeyIsSet) {
        ...
        if (m_RatioIsSet) {
            object["ratio"] = JsonValueConverter<double>::toJsonValue(getRatio());
        }
        if (m_SubcategoriesIsSet) {
            object["subcategories"] = JsonValueConverter<std::vector<std::shared_ptr<AudienceSubcategory>>>::toJsonValue(getSubcategories());
        }
    return object;
}

void AudienceCategory::fromJsonObject_internal(boost::json::object const& object)
{
    m_IdIsSet = false;
    m_IndexIsSet = false;
    m_KeyIsSet = false;
    ...
    }
    {
        ...
        if (IndexIt != object.end()) {
            setIndex(JsonValueConverter<double>::fromJsonValue(IndexIt->value()));
        }
    }
    {
    ...
    {
        const auto RatioIt = object.find("ratio");
        if (RatioIt != object.end()) {
            setRatio(JsonValueConverter<double>::fromJsonValue(RatioIt->value()));
        }
    }
    {
        const auto SubcategoriesIt = object.find("subcategories");
        if (SubcategoriesIt != object.end()) {
            setSubcategories(JsonValueConverter<std::vector<std::shared_ptr<AudienceSubcategory>>>::fromJsonValue(SubcategoriesIt->value()));
        }
    }
}
...
void AudienceCategory::setSubcategories(std::vector<std::shared_ptr<AudienceSubcategory>> value)
{
    
    m_Subcategories = std::move(value);
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AudienceCategory>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AudienceCategory>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AudienceCategory>>>::fromJsonValue(boost::json::parse(json));
}
