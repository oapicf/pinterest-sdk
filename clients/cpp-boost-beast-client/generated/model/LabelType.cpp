...
LabelType::LabelType(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string LabelType::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value LabelType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void LabelType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for LabelType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object LabelType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void LabelType::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<LabelType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<LabelType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<LabelType>>>::fromJsonValue(boost::json::parse(json));
}
