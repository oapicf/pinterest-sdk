...
LeadsExportStatus::LeadsExportStatus(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value LeadsExportStatus::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void LeadsExportStatus::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for LeadsExportStatus");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object LeadsExportStatus::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void LeadsExportStatus::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<LeadsExportStatus>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<LeadsExportStatus>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<LeadsExportStatus>>>::fromJsonValue(boost::json::parse(json));
}
