...
DeleteBusinessMembershipMember::DeleteBusinessMembershipMember(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string DeleteBusinessMembershipMember::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value DeleteBusinessMembershipMember::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void DeleteBusinessMembershipMember::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for DeleteBusinessMembershipMember");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object DeleteBusinessMembershipMember::toJsonObject_internal() const
{
    boost::json::object object;
        object["business_role"] = JsonValueConverter<std::shared_ptr<BusinessRoleForMembers>>::toJsonValue(getBusinessRole());
        object["member_id"] = JsonValueConverter<std::string>::toJsonValue(getMemberId());
    return object;
}

void DeleteBusinessMembershipMember::fromJsonObject_internal(boost::json::object const& object)
{
    {
        const auto Business_roleIt = object.find("business_role");
        if (Business_roleIt != object.end()) {
            setBusinessRole(JsonValueConverter<std::shared_ptr<BusinessRoleForMembers>>::fromJsonValue(Business_roleIt->value()));
        }
    }
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<DeleteBusinessMembershipMember>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<DeleteBusinessMembershipMember>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<DeleteBusinessMembershipMember>>>::fromJsonValue(boost::json::parse(json));
}
