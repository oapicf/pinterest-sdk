...
DataOutputFormat::DataOutputFormat(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string DataOutputFormat::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value DataOutputFormat::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void DataOutputFormat::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for DataOutputFormat");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object DataOutputFormat::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void DataOutputFormat::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<DataOutputFormat>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<DataOutputFormat>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<DataOutputFormat>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<DataOutputFormat>>>::fromJsonValue(boost::json::parse(json));
}
