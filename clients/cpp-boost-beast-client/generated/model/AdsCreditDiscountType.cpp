...
AdsCreditDiscountType::AdsCreditDiscountType(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value AdsCreditDiscountType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AdsCreditDiscountType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AdsCreditDiscountType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AdsCreditDiscountType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void AdsCreditDiscountType::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<AdsCreditDiscountType>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AdsCreditDiscountType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AdsCreditDiscountType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AdsCreditDiscountType>>>::fromJsonValue(boost::json::parse(json));
}
