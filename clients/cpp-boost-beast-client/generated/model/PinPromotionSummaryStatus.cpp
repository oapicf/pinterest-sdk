...
PinPromotionSummaryStatus::PinPromotionSummaryStatus(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string PinPromotionSummaryStatus::toJsonString(bool prettyJson /* = false */) const
{
...
void PinPromotionSummaryStatus::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value PinPromotionSummaryStatus::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void PinPromotionSummaryStatus::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for PinPromotionSummaryStatus");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object PinPromotionSummaryStatus::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void PinPromotionSummaryStatus::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<PinPromotionSummaryStatus>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<PinPromotionSummaryStatus>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<PinPromotionSummaryStatus>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<PinPromotionSummaryStatus>>>::fromJsonValue(boost::json::parse(json));
}
