...
MemberBusinessRole::MemberBusinessRole(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string MemberBusinessRole::toJsonString(bool prettyJson /* = false */) const
{
...
void MemberBusinessRole::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value MemberBusinessRole::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void MemberBusinessRole::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for MemberBusinessRole");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object MemberBusinessRole::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void MemberBusinessRole::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<MemberBusinessRole>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<MemberBusinessRole>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<MemberBusinessRole>>>::fromJsonValue(boost::json::parse(json));
}
