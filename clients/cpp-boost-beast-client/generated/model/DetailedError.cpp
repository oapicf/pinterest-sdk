...
DetailedError::DetailedError(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string DetailedError::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value DetailedError::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void DetailedError::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for DetailedError");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object DetailedError::toJsonObject_internal() const
{
    boost::json::object object;
        object["code"] = JsonValueConverter<int32_t>::toJsonValue(getCode());
        object["details"] = JsonValueConverter<boost::json::value>::toJsonValue(getDetails());
        object["message"] = JsonValueConverter<std::string>::toJsonValue(getMessage());
    return object;
}

void DetailedError::fromJsonObject_internal(boost::json::object const& object)
{
    {
    ...
    }
    {
        ...
        if (DetailsIt != object.end()) {
            setDetails(JsonValueConverter<boost::json::value>::fromJsonValue(DetailsIt->value()));
        }
    }
    {
...
boost::json::value DetailedError::getDetails() const
{
    return m_Details;
}

void DetailedError::setDetails(boost::json::value value)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<DetailedError>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<DetailedError>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<DetailedError>>>::fromJsonValue(boost::json::parse(json));
}
