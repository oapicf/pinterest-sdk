...
BusinessAccessUserSummary::BusinessAccessUserSummary(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value BusinessAccessUserSummary::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void BusinessAccessUserSummary::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for BusinessAccessUserSummary");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object BusinessAccessUserSummary::toJsonObject_internal() const
{
...
void BusinessAccessUserSummary::fromJsonObject_internal(boost::json::object const& object)
{
    m_EmailIsSet = false;
    m_IdIsSet = false;
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<BusinessAccessUserSummary>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<BusinessAccessUserSummary>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<BusinessAccessUserSummary>>>::fromJsonValue(boost::json::parse(json));
}
