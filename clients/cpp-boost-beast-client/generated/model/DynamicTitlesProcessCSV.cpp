...
DynamicTitlesProcessCSV::DynamicTitlesProcessCSV(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value DynamicTitlesProcessCSV::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void DynamicTitlesProcessCSV::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for DynamicTitlesProcessCSV");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object DynamicTitlesProcessCSV::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_ErrorsIsSet) {
            object["errors"] = JsonValueConverter<std::vector<std::shared_ptr<DynamicTitlesProcessCSVError>>>::toJsonValue(getErrors());
        }
        if (m_StatusIsSet) {
...
void DynamicTitlesProcessCSV::fromJsonObject_internal(boost::json::object const& object)
{
    m_ErrorsIsSet = false;
    m_StatusIsSet = false;
    {
        ...
        if (ErrorsIt != object.end()) {
            setErrors(JsonValueConverter<std::vector<std::shared_ptr<DynamicTitlesProcessCSVError>>>::fromJsonValue(ErrorsIt->value()));
        }
    }
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<DynamicTitlesProcessCSV>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<DynamicTitlesProcessCSV>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<DynamicTitlesProcessCSV>>>::fromJsonValue(boost::json::parse(json));
}
