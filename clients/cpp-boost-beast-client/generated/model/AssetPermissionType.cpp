...
AssetPermissionType::AssetPermissionType(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string AssetPermissionType::toJsonString(bool prettyJson /* = false */) const
{
...
void AssetPermissionType::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value AssetPermissionType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AssetPermissionType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AssetPermissionType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AssetPermissionType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void AssetPermissionType::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<AssetPermissionType>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AssetPermissionType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AssetPermissionType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AssetPermissionType>>>::fromJsonValue(boost::json::parse(json));
}
