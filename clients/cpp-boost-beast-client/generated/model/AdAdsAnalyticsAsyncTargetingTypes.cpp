...
AdAdsAnalyticsAsyncTargetingTypes::AdAdsAnalyticsAsyncTargetingTypes(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string AdAdsAnalyticsAsyncTargetingTypes::toJsonString(bool prettyJson /* = false */) const
{
...
void AdAdsAnalyticsAsyncTargetingTypes::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value AdAdsAnalyticsAsyncTargetingTypes::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AdAdsAnalyticsAsyncTargetingTypes::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AdAdsAnalyticsAsyncTargetingTypes");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AdAdsAnalyticsAsyncTargetingTypes::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void AdAdsAnalyticsAsyncTargetingTypes::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AdAdsAnalyticsAsyncTargetingTypes>>>::toJsonValue(data));
}
...
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AdAdsAnalyticsAsyncTargetingTypes>>>::fromJsonValue(boost::json::parse(json));
}
