...
CatalogsCreativeAssetsProduct::CatalogsCreativeAssetsProduct(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value CatalogsCreativeAssetsProduct::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogsCreativeAssetsProduct::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogsCreativeAssetsProduct");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogsCreativeAssetsProduct::toJsonObject_internal() const
{
    boost::json::object object;
        object["catalog_type"] = JsonValueConverter<std::string>::toJsonValue(getCatalogType());
        object["metadata"] = JsonValueConverter<std::shared_ptr<CatalogsCreativeAssetsProductMetadata>>::toJsonValue(getMetadata());
        object["pin"] = JsonValueConverter<std::shared_ptr<Pin>>::toJsonValue(getPin());
    return object;
}

void CatalogsCreativeAssetsProduct::fromJsonObject_internal(boost::json::object const& object)
{
    {
    ...
    {
        const auto MetadataIt = object.find("metadata");
        if (MetadataIt != object.end()) {
            setMetadata(JsonValueConverter<std::shared_ptr<CatalogsCreativeAssetsProductMetadata>>::fromJsonValue(MetadataIt->value()));
        }
    }
    {
        const auto PinIt = object.find("pin");
        if (PinIt != object.end()) {
            setPin(JsonValueConverter<std::shared_ptr<Pin>>::fromJsonValue(PinIt->value()));
        }
    }
}
...
void CatalogsCreativeAssetsProduct::setMetadata(std::shared_ptr<CatalogsCreativeAssetsProductMetadata> value)
{
...
void CatalogsCreativeAssetsProduct::setPin(std::shared_ptr<Pin> value)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogsCreativeAssetsProduct>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CatalogsCreativeAssetsProduct>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogsCreativeAssetsProduct>>>::fromJsonValue(boost::json::parse(json));
}
