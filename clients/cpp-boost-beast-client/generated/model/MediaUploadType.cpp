...
MediaUploadType::MediaUploadType(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value MediaUploadType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void MediaUploadType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for MediaUploadType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object MediaUploadType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void MediaUploadType::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<MediaUploadType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<MediaUploadType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<MediaUploadType>>>::fromJsonValue(boost::json::parse(json));
}
