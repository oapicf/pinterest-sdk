...
CatalogsProductGroupUpdateRequest::CatalogsProductGroupUpdateRequest(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string CatalogsProductGroupUpdateRequest::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value CatalogsProductGroupUpdateRequest::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogsProductGroupUpdateRequest::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogsProductGroupUpdateRequest");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogsProductGroupUpdateRequest::toJsonObject_internal() const
{
...
void CatalogsProductGroupUpdateRequest::fromJsonObject_internal(boost::json::object const& object)
{
...
void CatalogsProductGroupUpdateRequest::setFilters(std::shared_ptr<CatalogsProductGroupFiltersRequest> value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<CatalogsProductGroupUpdateRequest>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogsProductGroupUpdateRequest>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CatalogsProductGroupUpdateRequest>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogsProductGroupUpdateRequest>>>::fromJsonValue(boost::json::parse(json));
}
