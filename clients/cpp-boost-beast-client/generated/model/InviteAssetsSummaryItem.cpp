...
InviteAssetsSummaryItem::InviteAssetsSummaryItem(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value InviteAssetsSummaryItem::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void InviteAssetsSummaryItem::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for InviteAssetsSummaryItem");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object InviteAssetsSummaryItem::toJsonObject_internal() const
{
...
void InviteAssetsSummaryItem::fromJsonObject_internal(boost::json::object const& object)
{
    m_IdIsSet = false;
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<InviteAssetsSummaryItem>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<InviteAssetsSummaryItem>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<InviteAssetsSummaryItem>>>::fromJsonValue(boost::json::parse(json));
}
