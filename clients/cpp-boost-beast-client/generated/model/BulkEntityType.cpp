...
BulkEntityType::BulkEntityType(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string BulkEntityType::toJsonString(bool prettyJson /* = false */) const
{
...
void BulkEntityType::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value BulkEntityType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void BulkEntityType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for BulkEntityType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object BulkEntityType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void BulkEntityType::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<BulkEntityType>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<BulkEntityType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<BulkEntityType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<BulkEntityType>>>::fromJsonValue(boost::json::parse(json));
}
