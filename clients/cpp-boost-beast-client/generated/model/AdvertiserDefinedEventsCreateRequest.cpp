...
AdvertiserDefinedEventsCreateRequest::AdvertiserDefinedEventsCreateRequest(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string AdvertiserDefinedEventsCreateRequest::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value AdvertiserDefinedEventsCreateRequest::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AdvertiserDefinedEventsCreateRequest::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AdvertiserDefinedEventsCreateRequest");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AdvertiserDefinedEventsCreateRequest::toJsonObject_internal() const
{
    boost::json::object object;
        object["items"] = JsonValueConverter<std::vector<std::shared_ptr<AdvertiserDefinedEventInput>>>::toJsonValue(getItems());
    return object;
}

void AdvertiserDefinedEventsCreateRequest::fromJsonObject_internal(boost::json::object const& object)
{
    {
        const auto ItemsIt = object.find("items");
        if (ItemsIt != object.end()) {
            setItems(JsonValueConverter<std::vector<std::shared_ptr<AdvertiserDefinedEventInput>>>::fromJsonValue(ItemsIt->value()));
        }
    }
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AdvertiserDefinedEventsCreateRequest>>>::toJsonValue(data));
}
...
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AdvertiserDefinedEventsCreateRequest>>>::fromJsonValue(boost::json::parse(json));
}
