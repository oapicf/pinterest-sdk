...
QualityComponentIssue::QualityComponentIssue(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string QualityComponentIssue::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value QualityComponentIssue::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void QualityComponentIssue::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for QualityComponentIssue");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object QualityComponentIssue::toJsonObject_internal() const
{
...
void QualityComponentIssue::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<QualityComponentIssue>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<QualityComponentIssue>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<QualityComponentIssue>>>::fromJsonValue(boost::json::parse(json));
}
