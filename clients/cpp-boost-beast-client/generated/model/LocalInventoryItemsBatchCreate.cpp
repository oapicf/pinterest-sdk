...
LocalInventoryItemsBatchCreate::LocalInventoryItemsBatchCreate(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value LocalInventoryItemsBatchCreate::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void LocalInventoryItemsBatchCreate::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for LocalInventoryItemsBatchCreate");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object LocalInventoryItemsBatchCreate::toJsonObject_internal() const
{
    boost::json::object object;
        object["operations"] = JsonValueConverter<std::vector<std::shared_ptr<LocalInventoryOperation>>>::toJsonValue(getOperations());
    return object;
}

void LocalInventoryItemsBatchCreate::fromJsonObject_internal(boost::json::object const& object)
{
    {
        const auto OperationsIt = object.find("operations");
        if (OperationsIt != object.end()) {
            setOperations(JsonValueConverter<std::vector<std::shared_ptr<LocalInventoryOperation>>>::fromJsonValue(OperationsIt->value()));
        }
    }
}
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<LocalInventoryItemsBatchCreate>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<LocalInventoryItemsBatchCreate>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<LocalInventoryItemsBatchCreate>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<LocalInventoryItemsBatchCreate>>>::fromJsonValue(boost::json::parse(json));
}
