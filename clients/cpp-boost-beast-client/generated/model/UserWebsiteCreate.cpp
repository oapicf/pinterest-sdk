...
UserWebsiteCreate::UserWebsiteCreate(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string UserWebsiteCreate::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value UserWebsiteCreate::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void UserWebsiteCreate::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for UserWebsiteCreate");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object UserWebsiteCreate::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_Verification_methodIsSet) {
            object["verification_method"] = JsonValueConverter<std::shared_ptr<WebsiteVerificationMethod>>::toJsonValue(getVerificationMethod());
        }
        if (m_WebsiteIsSet) {
...
void UserWebsiteCreate::fromJsonObject_internal(boost::json::object const& object)
{
    m_Verification_methodIsSet = false;
    m_WebsiteIsSet = false;
    {
        const auto Verification_methodIt = object.find("verification_method");
        if (Verification_methodIt != object.end()) {
            setVerificationMethod(JsonValueConverter<std::shared_ptr<WebsiteVerificationMethod>>::fromJsonValue(Verification_methodIt->value()));
        }
    }
    {
...
void UserWebsiteCreate::setVerificationMethod(std::shared_ptr<WebsiteVerificationMethod> value)
{
    ...
    m_Verification_method = std::move(value);
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<UserWebsiteCreate>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<UserWebsiteCreate>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<UserWebsiteCreate>>>::fromJsonValue(boost::json::parse(json));
}
