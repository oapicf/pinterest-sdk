...
AudienceStatus::AudienceStatus(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string AudienceStatus::toJsonString(bool prettyJson /* = false */) const
{
...
void AudienceStatus::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value AudienceStatus::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AudienceStatus::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AudienceStatus");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AudienceStatus::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void AudienceStatus::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<AudienceStatus>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AudienceStatus>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AudienceStatus>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AudienceStatus>>>::fromJsonValue(boost::json::parse(json));
}
