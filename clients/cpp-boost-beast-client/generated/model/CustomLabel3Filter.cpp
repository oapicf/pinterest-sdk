...
CustomLabel3Filter::CustomLabel3Filter(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string CustomLabel3Filter::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value CustomLabel3Filter::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CustomLabel3Filter::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CustomLabel3Filter");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CustomLabel3Filter::toJsonObject_internal() const
{
...
void CustomLabel3Filter::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CustomLabel3Filter>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CustomLabel3Filter>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CustomLabel3Filter>>>::fromJsonValue(boost::json::parse(json));
}
