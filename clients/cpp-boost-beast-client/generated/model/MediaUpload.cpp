...
MediaUpload::MediaUpload(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value MediaUpload::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void MediaUpload::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for MediaUpload");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object MediaUpload::toJsonObject_internal() const
{
    boost::json::object object;
        object["media_id"] = JsonValueConverter<std::string>::toJsonValue(getMediaId());
        object["media_type"] = JsonValueConverter<std::shared_ptr<MediaUploadType>>::toJsonValue(getMediaType());
        if (m_Upload_parametersIsSet) {
            object["upload_parameters"] = JsonValueConverter<std::shared_ptr<MediaUploadParameters>>::toJsonValue(getUploadParameters());
        }
...
void MediaUpload::fromJsonObject_internal(boost::json::object const& object)
{
    ...
    }
    {
        ...
        if (Media_typeIt != object.end()) {
            setMediaType(JsonValueConverter<std::shared_ptr<MediaUploadType>>::fromJsonValue(Media_typeIt->value()));
        }
    }
    {
        const auto Upload_parametersIt = object.find("upload_parameters");
        if (Upload_parametersIt != object.end()) {
            setUploadParameters(JsonValueConverter<std::shared_ptr<MediaUploadParameters>>::fromJsonValue(Upload_parametersIt->value()));
        }
    }
    {
...
void MediaUpload::setUploadParameters(std::shared_ptr<MediaUploadParameters> value)
{
    ...
    m_Upload_parameters = std::move(value);
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<MediaUpload>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<MediaUpload>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<MediaUpload>>>::fromJsonValue(boost::json::parse(json));
}
