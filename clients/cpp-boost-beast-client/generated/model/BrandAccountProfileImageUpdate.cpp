...
BrandAccountProfileImageUpdate::BrandAccountProfileImageUpdate(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value BrandAccountProfileImageUpdate::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void BrandAccountProfileImageUpdate::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for BrandAccountProfileImageUpdate");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object BrandAccountProfileImageUpdate::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_Content_typeIsSet) {
            object["content_type"] = JsonValueConverter<std::string>::toJsonValue(getContentType());
        }
        if (m_DataIsSet) {
...
void BrandAccountProfileImageUpdate::fromJsonObject_internal(boost::json::object const& object)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<BrandAccountProfileImageUpdate>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<BrandAccountProfileImageUpdate>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<BrandAccountProfileImageUpdate>>>::fromJsonValue(boost::json::parse(json));
}
