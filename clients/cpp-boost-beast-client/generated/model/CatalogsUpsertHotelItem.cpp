...
CatalogsUpsertHotelItem::CatalogsUpsertHotelItem(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string CatalogsUpsertHotelItem::toJsonString(bool prettyJson /* = false */) const
{
...
void CatalogsUpsertHotelItem::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value CatalogsUpsertHotelItem::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogsUpsertHotelItem::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogsUpsertHotelItem");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogsUpsertHotelItem::toJsonObject_internal() const
{
...
void CatalogsUpsertHotelItem::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
void CatalogsUpsertHotelItem::setAttributes(std::shared_ptr<CatalogsHotelAttributes> value)
{
...
void CatalogsUpsertHotelItem::setHotelId(std::string value)
{
...
void CatalogsUpsertHotelItem::setOperation(std::string value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<CatalogsUpsertHotelItem>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogsUpsertHotelItem>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CatalogsUpsertHotelItem>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogsUpsertHotelItem>>>::fromJsonValue(boost::json::parse(json));
}
