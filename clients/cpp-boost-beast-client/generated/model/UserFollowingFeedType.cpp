...
UserFollowingFeedType::UserFollowingFeedType(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string UserFollowingFeedType::toJsonString(bool prettyJson /* = false */) const
{
...
void UserFollowingFeedType::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value UserFollowingFeedType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void UserFollowingFeedType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for UserFollowingFeedType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object UserFollowingFeedType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void UserFollowingFeedType::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<UserFollowingFeedType>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<UserFollowingFeedType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<UserFollowingFeedType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<UserFollowingFeedType>>>::fromJsonValue(boost::json::parse(json));
}
