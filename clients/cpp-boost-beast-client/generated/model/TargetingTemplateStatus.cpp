...
TargetingTemplateStatus::TargetingTemplateStatus(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string TargetingTemplateStatus::toJsonString(bool prettyJson /* = false */) const
{
...
void TargetingTemplateStatus::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value TargetingTemplateStatus::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void TargetingTemplateStatus::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for TargetingTemplateStatus");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object TargetingTemplateStatus::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void TargetingTemplateStatus::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<TargetingTemplateStatus>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<TargetingTemplateStatus>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<TargetingTemplateStatus>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<TargetingTemplateStatus>>>::fromJsonValue(boost::json::parse(json));
}
