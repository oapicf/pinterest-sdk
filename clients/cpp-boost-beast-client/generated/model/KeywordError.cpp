...
KeywordError::KeywordError(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string KeywordError::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value KeywordError::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void KeywordError::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for KeywordError");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object KeywordError::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_DataIsSet) {
            object["data"] = JsonValueConverter<std::shared_ptr<Keyword>>::toJsonValue(getData());
        }
...
void KeywordError::fromJsonObject_internal(boost::json::object const& object)
{
    m_DataIsSet = false;
    m_Error_messagesIsSet = false;
    {
        ...
        if (DataIt != object.end()) {
            setData(JsonValueConverter<std::shared_ptr<Keyword>>::fromJsonValue(DataIt->value()));
        }
    }
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<KeywordError>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<KeywordError>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<KeywordError>>>::fromJsonValue(boost::json::parse(json));
}
