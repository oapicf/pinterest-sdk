...
#ifndef BOOST_BEAST_OPENAPI_CLIENT_TargetingSpecOptimal_MODEL_H_
#define BOOST_BEAST_OPENAPI_CLIENT_TargetingSpecOptimal_MODEL_H_
...
{
public:
    TargetingSpecOptimal() = default;
    explicit TargetingSpecOptimal(boost::json::value const& value);
    ...
    /// </summary>
    std::vector<std::shared_ptr<std::string>> getAUDIENCEEXCLUDE() const;
    void setAUDIENCEEXCLUDE(std::vector<std::shared_ptr<std::string>> value);

    /// <summary>
    /// Targeted customer list IDs. For example: [\&quot;2542620905473\&quot;]. Audience lists need to have at least 100 people with Pinterest accounts in them Audience lists need to have at least 100 people with Pinterest accounts in them. If the AUDIENCE_INCLUDE field is missing, the default behavior in terms of ad delivery is that **All users will be included**.
    /// </summary>
    std::vector<std::shared_ptr<std::string>> getAUDIENCEINCLUDE() const;
    void setAUDIENCEINCLUDE(std::vector<std::shared_ptr<std::string>> value);
    ...
    void setTARGETINGSTRATEGY(std::vector<std::shared_ptr<TargetingStrategy>> value);
...
protected:
    ...
    bool m_APPTYPEIsSet = false;
    std::vector<std::shared_ptr<std::string>> m_AUDIENCE_EXCLUDE;
    bool m_AUDIENCE_EXCLUDEIsSet = false;
    std::vector<std::shared_ptr<std::string>> m_AUDIENCE_INCLUDE;
    bool m_AUDIENCE_INCLUDEIsSet = false;
    std::vector<std::shared_ptr<TargetingSpecGender>> m_GENDER;
    bool m_GENDERIsSet = false;
    std::vector<std::string> m_GEO;
    bool m_GEOIsSet = false;
    std::vector<std::string> m_GEO_EXCLUDE;
    bool m_GEO_EXCLUDEIsSet = false;
    std::vector<std::string> m_INTEREST;
    bool m_INTERESTIsSet = false;
    ...
    bool m_LOCATION_EXCLUDEIsSet = false;
    std::string m_MAXIMUM_AGE = "";
    bool m_MAXIMUM_AGEIsSet = false;
    std::string m_MINIMUM_AGE = "";
    bool m_MINIMUM_AGEIsSet = false;
    std::vector<std::shared_ptr<TargetingSpecShoppingRetargeting>> m_SHOPPING_RETARGETING;
    bool m_SHOPPING_RETARGETINGIsSet = false;
    std::vector<std::shared_ptr<TargetingStrategy>> m_TARGETING_STRATEGY;
    bool m_TARGETING_STRATEGYIsSet = false;
};
...
#endif /* BOOST_BEAST_OPENAPI_CLIENT_TargetingSpecOptimal_MODEL_H_ */
