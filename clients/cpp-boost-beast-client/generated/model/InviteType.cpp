...
InviteType::InviteType(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string InviteType::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value InviteType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void InviteType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for InviteType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object InviteType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void InviteType::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<InviteType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<InviteType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<InviteType>>>::fromJsonValue(boost::json::parse(json));
}
