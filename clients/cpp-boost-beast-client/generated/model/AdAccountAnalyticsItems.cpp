...
AdAccountAnalyticsItems::AdAccountAnalyticsItems(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value AdAccountAnalyticsItems::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AdAccountAnalyticsItems::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AdAccountAnalyticsItems");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AdAccountAnalyticsItems::toJsonObject_internal() const
{
...
void AdAccountAnalyticsItems::fromJsonObject_internal(boost::json::object const& object)
{
    m_DATEIsSet = false;
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AdAccountAnalyticsItems>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AdAccountAnalyticsItems>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AdAccountAnalyticsItems>>>::fromJsonValue(boost::json::parse(json));
}
