...
DeleteBusinessPartnersDelete::DeleteBusinessPartnersDelete(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value DeleteBusinessPartnersDelete::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void DeleteBusinessPartnersDelete::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for DeleteBusinessPartnersDelete");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object DeleteBusinessPartnersDelete::toJsonObject_internal() const
{
    boost::json::object object;
        object["partner_ids"] = JsonValueConverter<std::vector<std::shared_ptr<std::string>>>::toJsonValue(getPartnerIds());
        if (m_Partner_typeIsSet) {
            object["partner_type"] = JsonValueConverter<std::shared_ptr<NullablePartnerType>>::toJsonValue(getPartnerType());
        }
    return object;
}

void DeleteBusinessPartnersDelete::fromJsonObject_internal(boost::json::object const& object)
{
    m_Partner_typeIsSet = false;
    {
        const auto Partner_idsIt = object.find("partner_ids");
        if (Partner_idsIt != object.end()) {
            setPartnerIds(JsonValueConverter<std::vector<std::shared_ptr<std::string>>>::fromJsonValue(Partner_idsIt->value()));
        }
    }
    {
        const auto Partner_typeIt = object.find("partner_type");
        if (Partner_typeIt != object.end()) {
            setPartnerType(JsonValueConverter<std::shared_ptr<NullablePartnerType>>::fromJsonValue(Partner_typeIt->value()));
        }
    }
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<DeleteBusinessPartnersDelete>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<DeleteBusinessPartnersDelete>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<DeleteBusinessPartnersDelete>>>::fromJsonValue(boost::json::parse(json));
}
