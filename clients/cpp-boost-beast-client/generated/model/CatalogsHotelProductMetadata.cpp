...
CatalogsHotelProductMetadata::CatalogsHotelProductMetadata(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string CatalogsHotelProductMetadata::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value CatalogsHotelProductMetadata::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogsHotelProductMetadata::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogsHotelProductMetadata");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogsHotelProductMetadata::toJsonObject_internal() const
{
...
void CatalogsHotelProductMetadata::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogsHotelProductMetadata>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CatalogsHotelProductMetadata>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogsHotelProductMetadata>>>::fromJsonValue(boost::json::parse(json));
}
