...
CatalogsCreativeAssetsProductGroupProductCounts::CatalogsCreativeAssetsProductGroupProductCounts(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value CatalogsCreativeAssetsProductGroupProductCounts::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogsCreativeAssetsProductGroupProductCounts::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogsCreativeAssetsProductGroupProductCounts");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogsCreativeAssetsProductGroupProductCounts::toJsonObject_internal() const
{
...
void CatalogsCreativeAssetsProductGroupProductCounts::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogsCreativeAssetsProductGroupProductCounts>>>::toJsonValue(data));
}
...
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogsCreativeAssetsProductGroupProductCounts>>>::fromJsonValue(boost::json::parse(json));
}
