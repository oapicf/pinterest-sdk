...
CustomerListUploadCreateRequest::CustomerListUploadCreateRequest(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value CustomerListUploadCreateRequest::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CustomerListUploadCreateRequest::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CustomerListUploadCreateRequest");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CustomerListUploadCreateRequest::toJsonObject_internal() const
{
    boost::json::object object;
        object["operation"] = JsonValueConverter<std::shared_ptr<UserListOperationType>>::toJsonValue(getOperation());
        object["total_parts"] = JsonValueConverter<int32_t>::toJsonValue(getTotalParts());
    return object;
}

void CustomerListUploadCreateRequest::fromJsonObject_internal(boost::json::object const& object)
{
    {
    ...
    {
        const auto Total_partsIt = object.find("total_parts");
        if (Total_partsIt != object.end()) {
            setTotalParts(JsonValueConverter<int32_t>::fromJsonValue(Total_partsIt->value()));
        }
    }
}
...
void CustomerListUploadCreateRequest::setTotalParts(int32_t value)
{
    ...
    m_Total_parts = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<CustomerListUploadCreateRequest>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CustomerListUploadCreateRequest>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CustomerListUploadCreateRequest>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CustomerListUploadCreateRequest>>>::fromJsonValue(boost::json::parse(json));
}
