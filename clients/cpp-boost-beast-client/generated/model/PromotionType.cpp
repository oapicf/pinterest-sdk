...
PromotionType::PromotionType(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value PromotionType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void PromotionType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for PromotionType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object PromotionType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void PromotionType::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<PromotionType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<PromotionType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<PromotionType>>>::fromJsonValue(boost::json::parse(json));
}
