...
QueryLabelTypesItems::QueryLabelTypesItems(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string QueryLabelTypesItems::toJsonString(bool prettyJson /* = false */) const
{
...
void QueryLabelTypesItems::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value QueryLabelTypesItems::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void QueryLabelTypesItems::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for QueryLabelTypesItems");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object QueryLabelTypesItems::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void QueryLabelTypesItems::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<QueryLabelTypesItems>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<QueryLabelTypesItems>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<QueryLabelTypesItems>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<QueryLabelTypesItems>>>::fromJsonValue(boost::json::parse(json));
}
