...
ProductTagsBulkDeleteRequest::ProductTagsBulkDeleteRequest(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value ProductTagsBulkDeleteRequest::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ProductTagsBulkDeleteRequest::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ProductTagsBulkDeleteRequest");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ProductTagsBulkDeleteRequest::toJsonObject_internal() const
{
    boost::json::object object;
        object["product_tags"] = JsonValueConverter<std::vector<std::shared_ptr<ProductTagItem>>>::toJsonValue(getProductTags());
    return object;
}

void ProductTagsBulkDeleteRequest::fromJsonObject_internal(boost::json::object const& object)
{
    {
        const auto Product_tagsIt = object.find("product_tags");
        if (Product_tagsIt != object.end()) {
            setProductTags(JsonValueConverter<std::vector<std::shared_ptr<ProductTagItem>>>::fromJsonValue(Product_tagsIt->value()));
        }
    }
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ProductTagsBulkDeleteRequest>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ProductTagsBulkDeleteRequest>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ProductTagsBulkDeleteRequest>>>::fromJsonValue(boost::json::parse(json));
}
