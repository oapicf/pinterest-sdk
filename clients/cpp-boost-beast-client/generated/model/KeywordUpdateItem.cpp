...
KeywordUpdateItem::KeywordUpdateItem(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string KeywordUpdateItem::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value KeywordUpdateItem::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void KeywordUpdateItem::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for KeywordUpdateItem");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object KeywordUpdateItem::toJsonObject_internal() const
{
...
void KeywordUpdateItem::fromJsonObject_internal(boost::json::object const& object)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<KeywordUpdateItem>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<KeywordUpdateItem>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<KeywordUpdateItem>>>::fromJsonValue(boost::json::parse(json));
}
