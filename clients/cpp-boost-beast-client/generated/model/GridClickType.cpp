...
GridClickType::GridClickType(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string GridClickType::toJsonString(bool prettyJson /* = false */) const
{
...
void GridClickType::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value GridClickType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void GridClickType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for GridClickType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object GridClickType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void GridClickType::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<GridClickType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<GridClickType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<GridClickType>>>::fromJsonValue(boost::json::parse(json));
}
