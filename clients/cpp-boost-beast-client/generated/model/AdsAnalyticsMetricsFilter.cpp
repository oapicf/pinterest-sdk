...
AdsAnalyticsMetricsFilter::AdsAnalyticsMetricsFilter(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value AdsAnalyticsMetricsFilter::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AdsAnalyticsMetricsFilter::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AdsAnalyticsMetricsFilter");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AdsAnalyticsMetricsFilter::toJsonObject_internal() const
{
    boost::json::object object;
        object["field"] = JsonValueConverter<std::shared_ptr<AdsAnalyticsFilterColumn>>::toJsonValue(getField());
        object["operator"] = JsonValueConverter<std::shared_ptr<AdsAnalyticsFilterOperator>>::toJsonValue(getROperator());
        object["values"] = JsonValueConverter<std::vector<double>>::toJsonValue(getValues());
    return object;
}

void AdsAnalyticsMetricsFilter::fromJsonObject_internal(boost::json::object const& object)
{
    {
        const auto FieldIt = object.find("field");
        if (FieldIt != object.end()) {
            setField(JsonValueConverter<std::shared_ptr<AdsAnalyticsFilterColumn>>::fromJsonValue(FieldIt->value()));
        }
    }
    {
        const auto r_operatorIt = object.find("operator");
        if (r_operatorIt != object.end()) {
            setROperator(JsonValueConverter<std::shared_ptr<AdsAnalyticsFilterOperator>>::fromJsonValue(r_operatorIt->value()));
        }
    }
    {
        const auto ValuesIt = object.find("values");
        if (ValuesIt != object.end()) {
            setValues(JsonValueConverter<std::vector<double>>::fromJsonValue(ValuesIt->value()));
        }
    }
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AdsAnalyticsMetricsFilter>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AdsAnalyticsMetricsFilter>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AdsAnalyticsMetricsFilter>>>::fromJsonValue(boost::json::parse(json));
}
