...
MMMReportLevel::MMMReportLevel(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string MMMReportLevel::toJsonString(bool prettyJson /* = false */) const
{
...
void MMMReportLevel::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value MMMReportLevel::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void MMMReportLevel::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for MMMReportLevel");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object MMMReportLevel::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void MMMReportLevel::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<MMMReportLevel>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<MMMReportLevel>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<MMMReportLevel>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<MMMReportLevel>>>::fromJsonValue(boost::json::parse(json));
}
