...
PlacementGroupType::PlacementGroupType(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value PlacementGroupType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void PlacementGroupType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for PlacementGroupType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object PlacementGroupType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void PlacementGroupType::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<PlacementGroupType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<PlacementGroupType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<PlacementGroupType>>>::fromJsonValue(boost::json::parse(json));
}
