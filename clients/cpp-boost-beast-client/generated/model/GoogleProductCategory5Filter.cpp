...
GoogleProductCategory5Filter::GoogleProductCategory5Filter(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string GoogleProductCategory5Filter::toJsonString(bool prettyJson /* = false */) const
{
...
void GoogleProductCategory5Filter::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value GoogleProductCategory5Filter::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void GoogleProductCategory5Filter::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for GoogleProductCategory5Filter");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object GoogleProductCategory5Filter::toJsonObject_internal() const
{
...
void GoogleProductCategory5Filter::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
void GoogleProductCategory5Filter::setGOOGLEPRODUCTCATEGORY5(std::shared_ptr<CatalogsProductGroupMultipleStringListCriteria> value)
{
    
    m_GOOGLE_PRODUCT_CATEGORY_5 = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<GoogleProductCategory5Filter>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<GoogleProductCategory5Filter>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<GoogleProductCategory5Filter>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<GoogleProductCategory5Filter>>>::fromJsonValue(boost::json::parse(json));
}
