...
Delete_business_membership_200_response::Delete_business_membership_200_response(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string Delete_business_membership_200_response::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value Delete_business_membership_200_response::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void Delete_business_membership_200_response::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for Delete_business_membership_200_response");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object Delete_business_membership_200_response::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_Deleted_membersIsSet) {
            object["deleted_members"] = JsonValueConverter<std::vector<std::shared_ptr<std::string>>>::toJsonValue(getDeletedMembers());
        }
    return object;
}

void Delete_business_membership_200_response::fromJsonObject_internal(boost::json::object const& object)
{
    m_Deleted_membersIsSet = false;
    {
        const auto Deleted_membersIt = object.find("deleted_members");
        if (Deleted_membersIt != object.end()) {
            setDeletedMembers(JsonValueConverter<std::vector<std::shared_ptr<std::string>>>::fromJsonValue(Deleted_membersIt->value()));
        }
    }
}
...
void Delete_business_membership_200_response::setDeletedMembers(std::vector<std::shared_ptr<std::string>> value)
{
    ...
    m_Deleted_members = std::move(value);
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<Delete_business_membership_200_response>>>::toJsonValue(data));
}
...
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<Delete_business_membership_200_response>>>::fromJsonValue(boost::json::parse(json));
}
