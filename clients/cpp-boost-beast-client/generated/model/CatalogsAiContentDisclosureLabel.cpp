...
CatalogsAiContentDisclosureLabel::CatalogsAiContentDisclosureLabel(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string CatalogsAiContentDisclosureLabel::toJsonString(bool prettyJson /* = false */) const
{
...
void CatalogsAiContentDisclosureLabel::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value CatalogsAiContentDisclosureLabel::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogsAiContentDisclosureLabel::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogsAiContentDisclosureLabel");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogsAiContentDisclosureLabel::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void CatalogsAiContentDisclosureLabel::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<CatalogsAiContentDisclosureLabel>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogsAiContentDisclosureLabel>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CatalogsAiContentDisclosureLabel>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogsAiContentDisclosureLabel>>>::fromJsonValue(boost::json::parse(json));
}
