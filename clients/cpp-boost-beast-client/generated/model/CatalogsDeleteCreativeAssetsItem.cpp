...
CatalogsDeleteCreativeAssetsItem::CatalogsDeleteCreativeAssetsItem(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value CatalogsDeleteCreativeAssetsItem::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogsDeleteCreativeAssetsItem::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogsDeleteCreativeAssetsItem");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogsDeleteCreativeAssetsItem::toJsonObject_internal() const
{
...
void CatalogsDeleteCreativeAssetsItem::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<CatalogsDeleteCreativeAssetsItem>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogsDeleteCreativeAssetsItem>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CatalogsDeleteCreativeAssetsItem>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogsDeleteCreativeAssetsItem>>>::fromJsonValue(boost::json::parse(json));
}
