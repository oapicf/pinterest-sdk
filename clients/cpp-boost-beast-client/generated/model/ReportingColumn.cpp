...
ReportingColumn::ReportingColumn(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ReportingColumn::toJsonString(bool prettyJson /* = false */) const
{
...
void ReportingColumn::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value ReportingColumn::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ReportingColumn::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ReportingColumn");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ReportingColumn::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void ReportingColumn::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<ReportingColumn>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ReportingColumn>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ReportingColumn>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ReportingColumn>>>::fromJsonValue(boost::json::parse(json));
}
