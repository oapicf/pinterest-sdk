...
GoogleProductCategory0Filter::GoogleProductCategory0Filter(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string GoogleProductCategory0Filter::toJsonString(bool prettyJson /* = false */) const
{
...
void GoogleProductCategory0Filter::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value GoogleProductCategory0Filter::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void GoogleProductCategory0Filter::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for GoogleProductCategory0Filter");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object GoogleProductCategory0Filter::toJsonObject_internal() const
{
...
void GoogleProductCategory0Filter::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
void GoogleProductCategory0Filter::setGOOGLEPRODUCTCATEGORY0(std::shared_ptr<CatalogsProductGroupMultipleStringListCriteria> value)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<GoogleProductCategory0Filter>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<GoogleProductCategory0Filter>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<GoogleProductCategory0Filter>>>::fromJsonValue(boost::json::parse(json));
}
