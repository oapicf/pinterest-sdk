...
PinAnalyticsDailyMetrics::PinAnalyticsDailyMetrics(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string PinAnalyticsDailyMetrics::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value PinAnalyticsDailyMetrics::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void PinAnalyticsDailyMetrics::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for PinAnalyticsDailyMetrics");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object PinAnalyticsDailyMetrics::toJsonObject_internal() const
{
...
void PinAnalyticsDailyMetrics::fromJsonObject_internal(boost::json::object const& object)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<PinAnalyticsDailyMetrics>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<PinAnalyticsDailyMetrics>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<PinAnalyticsDailyMetrics>>>::fromJsonValue(boost::json::parse(json));
}
