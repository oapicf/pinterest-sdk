...
LabelBulkUpdateRequest::LabelBulkUpdateRequest(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string LabelBulkUpdateRequest::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value LabelBulkUpdateRequest::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void LabelBulkUpdateRequest::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for LabelBulkUpdateRequest");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object LabelBulkUpdateRequest::toJsonObject_internal() const
{
    boost::json::object object;
        ...
        object["status"] = JsonValueConverter<std::shared_ptr<LabelStatusBulkUpdate>>::toJsonValue(getStatus());
    return object;
}

void LabelBulkUpdateRequest::fromJsonObject_internal(boost::json::object const& object)
{
    {
    ...
    }
    {
        ...
        if (StatusIt != object.end()) {
            setStatus(JsonValueConverter<std::shared_ptr<LabelStatusBulkUpdate>>::fromJsonValue(StatusIt->value()));
        }
    }
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<LabelBulkUpdateRequest>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<LabelBulkUpdateRequest>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<LabelBulkUpdateRequest>>>::fromJsonValue(boost::json::parse(json));
}
