...
AdvancedAuctionItems::AdvancedAuctionItems(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string AdvancedAuctionItems::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value AdvancedAuctionItems::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AdvancedAuctionItems::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AdvancedAuctionItems");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AdvancedAuctionItems::toJsonObject_internal() const
{
    boost::json::object object;
        ...
        if (m_ItemsIsSet) {
            object["items"] = JsonValueConverter<std::vector<std::shared_ptr<AdvancedAuctionItem>>>::toJsonValue(getItems());
        }
    return object;
}

void AdvancedAuctionItems::fromJsonObject_internal(boost::json::object const& object)
{
    ...
    }
    {
        ...
        if (ItemsIt != object.end()) {
            setItems(JsonValueConverter<std::vector<std::shared_ptr<AdvancedAuctionItem>>>::fromJsonValue(ItemsIt->value()));
        }
    }
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AdvancedAuctionItems>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AdvancedAuctionItems>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AdvancedAuctionItems>>>::fromJsonValue(boost::json::parse(json));
}
