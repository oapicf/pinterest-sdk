...
ConversionDeletionRequestCreate::ConversionDeletionRequestCreate(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ConversionDeletionRequestCreate::toJsonString(bool prettyJson /* = false */) const
{
...
void ConversionDeletionRequestCreate::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value ConversionDeletionRequestCreate::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ConversionDeletionRequestCreate::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ConversionDeletionRequestCreate");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ConversionDeletionRequestCreate::toJsonObject_internal() const
{
    boost::json::object object;
        object["deletion_targets"] = JsonValueConverter<std::shared_ptr<ConversionDeletionRequestTargets>>::toJsonValue(getDeletionTargets());
    return object;
}

void ConversionDeletionRequestCreate::fromJsonObject_internal(boost::json::object const& object)
{
    {
        const auto Deletion_targetsIt = object.find("deletion_targets");
        if (Deletion_targetsIt != object.end()) {
            setDeletionTargets(JsonValueConverter<std::shared_ptr<ConversionDeletionRequestTargets>>::fromJsonValue(Deletion_targetsIt->value()));
        }
    }
}
...
void ConversionDeletionRequestCreate::setDeletionTargets(std::shared_ptr<ConversionDeletionRequestTargets> value)
{
    
    m_Deletion_targets = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<ConversionDeletionRequestCreate>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ConversionDeletionRequestCreate>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ConversionDeletionRequestCreate>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ConversionDeletionRequestCreate>>>::fromJsonValue(boost::json::parse(json));
}
