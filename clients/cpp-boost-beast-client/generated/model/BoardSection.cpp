...
BoardSection::BoardSection(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string BoardSection::toJsonString(bool prettyJson /* = false */) const
{
...
void BoardSection::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value BoardSection::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void BoardSection::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for BoardSection");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object BoardSection::toJsonObject_internal() const
{
...
void BoardSection::fromJsonObject_internal(boost::json::object const& object)
{
    m_IdIsSet = false;
    {
...
void BoardSection::setId(std::string value)
{
...
void BoardSection::setName(std::string value)
{
    
    m_Name = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<BoardSection>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<BoardSection>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<BoardSection>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<BoardSection>>>::fromJsonValue(boost::json::parse(json));
}
