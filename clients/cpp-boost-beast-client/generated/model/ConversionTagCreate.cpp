...
ConversionTagCreate::ConversionTagCreate(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value ConversionTagCreate::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ConversionTagCreate::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ConversionTagCreate");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ConversionTagCreate::toJsonObject_internal() const
{
...
void ConversionTagCreate::fromJsonObject_internal(boost::json::object const& object)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ConversionTagCreate>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ConversionTagCreate>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ConversionTagCreate>>>::fromJsonValue(boost::json::parse(json));
}
