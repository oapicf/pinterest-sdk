...
ProductGroupPromotionCustomizableCTAType::ProductGroupPromotionCustomizableCTAType(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value ProductGroupPromotionCustomizableCTAType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ProductGroupPromotionCustomizableCTAType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ProductGroupPromotionCustomizableCTAType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ProductGroupPromotionCustomizableCTAType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void ProductGroupPromotionCustomizableCTAType::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ProductGroupPromotionCustomizableCTAType>>>::toJsonValue(data));
}
...
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ProductGroupPromotionCustomizableCTAType>>>::fromJsonValue(boost::json::parse(json));
}
