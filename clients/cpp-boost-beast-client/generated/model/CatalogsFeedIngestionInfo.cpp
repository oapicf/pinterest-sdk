...
CatalogsFeedIngestionInfo::CatalogsFeedIngestionInfo(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value CatalogsFeedIngestionInfo::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogsFeedIngestionInfo::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogsFeedIngestionInfo");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogsFeedIngestionInfo::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_IN_STOCKIsSet) {
            object["IN_STOCK"] = JsonValueConverter<int32_t>::toJsonValue(getINSTOCK());
        }
        if (m_OUT_OF_STOCKIsSet) {
            object["OUT_OF_STOCK"] = JsonValueConverter<int32_t>::toJsonValue(getOUTOFSTOCK());
        }
        if (m_PREORDERIsSet) {
            object["PREORDER"] = JsonValueConverter<int32_t>::toJsonValue(getPREORDER());
        }
    return object;
}

void CatalogsFeedIngestionInfo::fromJsonObject_internal(boost::json::object const& object)
{
    ...
    m_PREORDERIsSet = false;
    {
        ...
        if (IN_STOCKIt != object.end()) {
            setINSTOCK(JsonValueConverter<int32_t>::fromJsonValue(IN_STOCKIt->value()));
        }
    }
    {
        const auto OUT_OF_STOCKIt = object.find("OUT_OF_STOCK");
        if (OUT_OF_STOCKIt != object.end()) {
            setOUTOFSTOCK(JsonValueConverter<int32_t>::fromJsonValue(OUT_OF_STOCKIt->value()));
        }
    }
    {
        const auto PREORDERIt = object.find("PREORDER");
        if (PREORDERIt != object.end()) {
            setPREORDER(JsonValueConverter<int32_t>::fromJsonValue(PREORDERIt->value()));
        }
    }
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogsFeedIngestionInfo>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CatalogsFeedIngestionInfo>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogsFeedIngestionInfo>>>::fromJsonValue(boost::json::parse(json));
}
