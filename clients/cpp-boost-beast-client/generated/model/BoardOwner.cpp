...
BoardOwner::BoardOwner(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string BoardOwner::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value BoardOwner::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void BoardOwner::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for BoardOwner");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object BoardOwner::toJsonObject_internal() const
{
...
void BoardOwner::fromJsonObject_internal(boost::json::object const& object)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<BoardOwner>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<BoardOwner>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<BoardOwner>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<BoardOwner>>>::fromJsonValue(boost::json::parse(json));
}
