...
QuizPinOption::QuizPinOption(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value QuizPinOption::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void QuizPinOption::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for QuizPinOption");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object QuizPinOption::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_IdIsSet) {
            object["id"] = JsonValueConverter<double>::toJsonValue(getId());
        }
        if (m_TextIsSet) {
...
void QuizPinOption::fromJsonObject_internal(boost::json::object const& object)
{
    m_IdIsSet = false;
    m_TextIsSet = false;
    {
        ...
        if (IdIt != object.end()) {
            setId(JsonValueConverter<double>::fromJsonValue(IdIt->value()));
        }
    }
    {
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<QuizPinOption>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<QuizPinOption>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<QuizPinOption>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<QuizPinOption>>>::fromJsonValue(boost::json::parse(json));
}
