...
PinFilter::PinFilter(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value PinFilter::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void PinFilter::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for PinFilter");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object PinFilter::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void PinFilter::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<PinFilter>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<PinFilter>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<PinFilter>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<PinFilter>>>::fromJsonValue(boost::json::parse(json));
}
