...
ScheduleAction::ScheduleAction(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ScheduleAction::toJsonString(bool prettyJson /* = false */) const
{
...
void ScheduleAction::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value ScheduleAction::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ScheduleAction::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ScheduleAction");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ScheduleAction::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void ScheduleAction::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ScheduleAction>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ScheduleAction>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ScheduleAction>>>::fromJsonValue(boost::json::parse(json));
}
