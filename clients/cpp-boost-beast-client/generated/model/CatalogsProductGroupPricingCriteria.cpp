...
CatalogsProductGroupPricingCriteria::CatalogsProductGroupPricingCriteria(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value CatalogsProductGroupPricingCriteria::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogsProductGroupPricingCriteria::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogsProductGroupPricingCriteria");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogsProductGroupPricingCriteria::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_InclusionIsSet) {
            object["inclusion"] = JsonValueConverter<bool>::toJsonValue(isInclusion());
        }
        if (m_NegatedIsSet) {
            object["negated"] = JsonValueConverter<bool>::toJsonValue(isNegated());
        }
        object["values"] = JsonValueConverter<double>::toJsonValue(getValues());
    return object;
}

void CatalogsProductGroupPricingCriteria::fromJsonObject_internal(boost::json::object const& object)
{
    m_InclusionIsSet = false;
    m_NegatedIsSet = false;
    {
        const auto InclusionIt = object.find("inclusion");
        if (InclusionIt != object.end()) {
            setInclusion(JsonValueConverter<bool>::fromJsonValue(InclusionIt->value()));
        }
    }
    {
    ...
    }
    {
        ...
        if (ValuesIt != object.end()) {
            setValues(JsonValueConverter<double>::fromJsonValue(ValuesIt->value()));
        }
    }
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogsProductGroupPricingCriteria>>>::toJsonValue(data));
}
...
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogsProductGroupPricingCriteria>>>::fromJsonValue(boost::json::parse(json));
}
