...
RespondToInvitesResponseArray::RespondToInvitesResponseArray(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string RespondToInvitesResponseArray::toJsonString(bool prettyJson /* = false */) const
{
...
void RespondToInvitesResponseArray::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value RespondToInvitesResponseArray::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void RespondToInvitesResponseArray::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for RespondToInvitesResponseArray");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object RespondToInvitesResponseArray::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_ItemsIsSet) {
            object["items"] = JsonValueConverter<std::vector<std::shared_ptr<RespondToInviteResultItem>>>::toJsonValue(getItems());
        }
    return object;
}

void RespondToInvitesResponseArray::fromJsonObject_internal(boost::json::object const& object)
{
    m_ItemsIsSet = false;
    {
        const auto ItemsIt = object.find("items");
        if (ItemsIt != object.end()) {
            setItems(JsonValueConverter<std::vector<std::shared_ptr<RespondToInviteResultItem>>>::fromJsonValue(ItemsIt->value()));
        }
    }
}
...
void RespondToInvitesResponseArray::setItems(std::vector<std::shared_ptr<RespondToInviteResultItem>> value)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<RespondToInvitesResponseArray>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<RespondToInvitesResponseArray>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<RespondToInvitesResponseArray>>>::fromJsonValue(boost::json::parse(json));
}
