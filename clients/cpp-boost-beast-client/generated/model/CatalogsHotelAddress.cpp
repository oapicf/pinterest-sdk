...
CatalogsHotelAddress::CatalogsHotelAddress(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value CatalogsHotelAddress::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogsHotelAddress::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogsHotelAddress");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogsHotelAddress::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_Addr1IsSet) {
            object["addr1"] = JsonValueConverter<std::string>::toJsonValue(getAddr1());
        }
        if (m_CityIsSet) {
...
void CatalogsHotelAddress::fromJsonObject_internal(boost::json::object const& object)
{
    m_Addr1IsSet = false;
    m_CityIsSet = false;
    ...
    m_RegionIsSet = false;
    {
        const auto Addr1It = object.find("addr1");
        if (Addr1It != object.end()) {
            setAddr1(JsonValueConverter<std::string>::fromJsonValue(Addr1It->value()));
        }
    }
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogsHotelAddress>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CatalogsHotelAddress>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogsHotelAddress>>>::fromJsonValue(boost::json::parse(json));
}
