...
UserWebsite::UserWebsite(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string UserWebsite::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value UserWebsite::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void UserWebsite::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for UserWebsite");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object UserWebsite::toJsonObject_internal() const
{
    boost::json::object object;
        ...
        if (m_Verified_atIsSet) {
            object["verified_at"] = JsonValueConverter<std::string>::toJsonValue(getVerifiedAt());
        }
        if (m_WebsiteIsSet) {
...
void UserWebsite::fromJsonObject_internal(boost::json::object const& object)
{
    m_StatusIsSet = false;
    ...
    {
        const auto Verified_atIt = object.find("verified_at");
        if (Verified_atIt != object.end()) {
            setVerifiedAt(JsonValueConverter<std::string>::fromJsonValue(Verified_atIt->value()));
        }
    }
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<UserWebsite>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<UserWebsite>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<UserWebsite>>>::fromJsonValue(boost::json::parse(json));
}
