...
AssetTypeResponse::AssetTypeResponse(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value AssetTypeResponse::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AssetTypeResponse::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AssetTypeResponse");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AssetTypeResponse::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void AssetTypeResponse::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<AssetTypeResponse>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AssetTypeResponse>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AssetTypeResponse>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AssetTypeResponse>>>::fromJsonValue(boost::json::parse(json));
}
