...
AdsAnalyticsAccountTargetingType::AdsAnalyticsAccountTargetingType(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string AdsAnalyticsAccountTargetingType::toJsonString(bool prettyJson /* = false */) const
{
...
void AdsAnalyticsAccountTargetingType::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value AdsAnalyticsAccountTargetingType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AdsAnalyticsAccountTargetingType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AdsAnalyticsAccountTargetingType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AdsAnalyticsAccountTargetingType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void AdsAnalyticsAccountTargetingType::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<AdsAnalyticsAccountTargetingType>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AdsAnalyticsAccountTargetingType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AdsAnalyticsAccountTargetingType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AdsAnalyticsAccountTargetingType>>>::fromJsonValue(boost::json::parse(json));
}
