...
LeadFormTestCreate::LeadFormTestCreate(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string LeadFormTestCreate::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value LeadFormTestCreate::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void LeadFormTestCreate::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for LeadFormTestCreate");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object LeadFormTestCreate::toJsonObject_internal() const
{
    boost::json::object object;
        object["answers"] = JsonValueConverter<std::vector<std::string>>::toJsonValue(getAnswers());
    return object;
}

void LeadFormTestCreate::fromJsonObject_internal(boost::json::object const& object)
{
    {
        const auto AnswersIt = object.find("answers");
        if (AnswersIt != object.end()) {
            setAnswers(JsonValueConverter<std::vector<std::string>>::fromJsonValue(AnswersIt->value()));
        }
    }
}
...
void LeadFormTestCreate::setAnswers(std::vector<std::string> value)
{
    ...
    m_Answers = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<LeadFormTestCreate>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<LeadFormTestCreate>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<LeadFormTestCreate>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<LeadFormTestCreate>>>::fromJsonValue(boost::json::parse(json));
}
