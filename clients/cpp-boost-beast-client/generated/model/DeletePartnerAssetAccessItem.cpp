...
DeletePartnerAssetAccessItem::DeletePartnerAssetAccessItem(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value DeletePartnerAssetAccessItem::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void DeletePartnerAssetAccessItem::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for DeletePartnerAssetAccessItem");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object DeletePartnerAssetAccessItem::toJsonObject_internal() const
{
    boost::json::object object;
        ...
        if (m_Partner_typeIsSet) {
            object["partner_type"] = JsonValueConverter<std::string>::toJsonValue(getPartnerType());
        }
    return object;
}

void DeletePartnerAssetAccessItem::fromJsonObject_internal(boost::json::object const& object)
{
    ...
    }
    {
        ...
        if (Partner_typeIt != object.end()) {
            setPartnerType(JsonValueConverter<std::string>::fromJsonValue(Partner_typeIt->value()));
        }
    }
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<DeletePartnerAssetAccessItem>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<DeletePartnerAssetAccessItem>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<DeletePartnerAssetAccessItem>>>::fromJsonValue(boost::json::parse(json));
}
