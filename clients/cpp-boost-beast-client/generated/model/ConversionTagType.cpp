...
ConversionTagType::ConversionTagType(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ConversionTagType::toJsonString(bool prettyJson /* = false */) const
{
...
void ConversionTagType::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value ConversionTagType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ConversionTagType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ConversionTagType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ConversionTagType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void ConversionTagType::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<ConversionTagType>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ConversionTagType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ConversionTagType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ConversionTagType>>>::fromJsonValue(boost::json::parse(json));
}
