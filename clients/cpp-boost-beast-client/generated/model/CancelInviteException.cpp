...
CancelInviteException::CancelInviteException(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string CancelInviteException::toJsonString(bool prettyJson /* = false */) const
{
...
void CancelInviteException::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value CancelInviteException::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CancelInviteException::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CancelInviteException");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CancelInviteException::toJsonObject_internal() const
{
...
void CancelInviteException::fromJsonObject_internal(boost::json::object const& object)
{
...
void CancelInviteException::setInviteId(std::string value)
{
...
void CancelInviteException::setMessage(std::string value)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CancelInviteException>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CancelInviteException>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CancelInviteException>>>::fromJsonValue(boost::json::parse(json));
}
