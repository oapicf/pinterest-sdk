...
ProductCategoryRegion::ProductCategoryRegion(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ProductCategoryRegion::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value ProductCategoryRegion::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ProductCategoryRegion::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ProductCategoryRegion");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ProductCategoryRegion::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void ProductCategoryRegion::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<ProductCategoryRegion>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ProductCategoryRegion>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ProductCategoryRegion>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ProductCategoryRegion>>>::fromJsonValue(boost::json::parse(json));
}
