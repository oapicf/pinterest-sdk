...
LocalInventoryItemsGetCreate::LocalInventoryItemsGetCreate(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value LocalInventoryItemsGetCreate::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void LocalInventoryItemsGetCreate::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for LocalInventoryItemsGetCreate");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object LocalInventoryItemsGetCreate::toJsonObject_internal() const
{
    boost::json::object object;
        object["item_filters"] = JsonValueConverter<std::vector<std::shared_ptr<ItemIdStoreCodePair>>>::toJsonValue(getItemFilters());
    return object;
}

void LocalInventoryItemsGetCreate::fromJsonObject_internal(boost::json::object const& object)
{
    {
        const auto Item_filtersIt = object.find("item_filters");
        if (Item_filtersIt != object.end()) {
            setItemFilters(JsonValueConverter<std::vector<std::shared_ptr<ItemIdStoreCodePair>>>::fromJsonValue(Item_filtersIt->value()));
        }
    }
}
...
void LocalInventoryItemsGetCreate::setItemFilters(std::vector<std::shared_ptr<ItemIdStoreCodePair>> value)
{
    ...
    m_Item_filters = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<LocalInventoryItemsGetCreate>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<LocalInventoryItemsGetCreate>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<LocalInventoryItemsGetCreate>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<LocalInventoryItemsGetCreate>>>::fromJsonValue(boost::json::parse(json));
}
