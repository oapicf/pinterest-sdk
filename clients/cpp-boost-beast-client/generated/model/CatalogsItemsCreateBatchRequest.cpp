...
CatalogsItemsCreateBatchRequest::CatalogsItemsCreateBatchRequest(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string CatalogsItemsCreateBatchRequest::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value CatalogsItemsCreateBatchRequest::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogsItemsCreateBatchRequest::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogsItemsCreateBatchRequest");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogsItemsCreateBatchRequest::toJsonObject_internal() const
{
    boost::json::object object;
        object["country"] = JsonValueConverter<std::shared_ptr<Country>>::toJsonValue(getCountry());
        object["items"] = JsonValueConverter<std::vector<std::shared_ptr<ItemCreateBatchRecord>>>::toJsonValue(getItems());
...
void CatalogsItemsCreateBatchRequest::fromJsonObject_internal(boost::json::object const& object)
{
    {
    ...
    }
    {
        ...
        if (ItemsIt != object.end()) {
            setItems(JsonValueConverter<std::vector<std::shared_ptr<ItemCreateBatchRecord>>>::fromJsonValue(ItemsIt->value()));
        }
    }
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogsItemsCreateBatchRequest>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CatalogsItemsCreateBatchRequest>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogsItemsCreateBatchRequest>>>::fromJsonValue(boost::json::parse(json));
}
