...
LeadFormPolicyLink::LeadFormPolicyLink(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value LeadFormPolicyLink::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void LeadFormPolicyLink::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for LeadFormPolicyLink");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object LeadFormPolicyLink::toJsonObject_internal() const
{
...
void LeadFormPolicyLink::fromJsonObject_internal(boost::json::object const& object)
{
    m_LabelIsSet = false;
    m_LinkIsSet = false;
    {
        const auto LabelIt = object.find("label");
        if (LabelIt != object.end()) {
            setLabel(JsonValueConverter<std::string>::fromJsonValue(LabelIt->value()));
        }
    }
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<LeadFormPolicyLink>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<LeadFormPolicyLink>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<LeadFormPolicyLink>>>::fromJsonValue(boost::json::parse(json));
}
