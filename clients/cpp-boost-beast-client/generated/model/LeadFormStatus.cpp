...
LeadFormStatus::LeadFormStatus(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string LeadFormStatus::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value LeadFormStatus::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void LeadFormStatus::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for LeadFormStatus");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object LeadFormStatus::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void LeadFormStatus::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<LeadFormStatus>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<LeadFormStatus>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<LeadFormStatus>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<LeadFormStatus>>>::fromJsonValue(boost::json::parse(json));
}
