...
Audience::Audience(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value Audience::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void Audience::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for Audience");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object Audience::toJsonObject_internal() const
{
    boost::json::object object;
        ...
        if (m_Audience_typeIsSet) {
            object["audience_type"] = JsonValueConverter<std::shared_ptr<PinnerListType>>::toJsonValue(getAudienceType());
        }
        ...
        if (m_RuleIsSet) {
            object["rule"] = JsonValueConverter<std::shared_ptr<AudienceRule>>::toJsonValue(getRule());
        }
        if (m_SizeIsSet) {
...
void Audience::fromJsonObject_internal(boost::json::object const& object)
{
    ...
    }
    {
        ...
        if (Audience_typeIt != object.end()) {
            setAudienceType(JsonValueConverter<std::shared_ptr<PinnerListType>>::fromJsonValue(Audience_typeIt->value()));
        }
    }
    {
    ...
    }
    {
        ...
        if (RuleIt != object.end()) {
            setRule(JsonValueConverter<std::shared_ptr<AudienceRule>>::fromJsonValue(RuleIt->value()));
        }
    }
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<Audience>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<Audience>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<Audience>>>::fromJsonValue(boost::json::parse(json));
}
