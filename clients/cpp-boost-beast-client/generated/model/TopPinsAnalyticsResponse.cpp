...
TopPinsAnalyticsResponse::TopPinsAnalyticsResponse(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value TopPinsAnalyticsResponse::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void TopPinsAnalyticsResponse::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for TopPinsAnalyticsResponse");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object TopPinsAnalyticsResponse::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_Date_availabilityIsSet) {
            object["date_availability"] = JsonValueConverter<std::shared_ptr<TopPinsAnalyticsResponseDateAvailability>>::toJsonValue(getDateAvailability());
        }
        if (m_PinsIsSet) {
            object["pins"] = JsonValueConverter<std::vector<std::shared_ptr<TopPinsAnalyticsResponsePinsItems>>>::toJsonValue(getPins());
        }
        if (m_Sort_byIsSet) {
            object["sort_by"] = JsonValueConverter<std::shared_ptr<TopPinsSortBy>>::toJsonValue(getSortBy());
        }
    return object;
}

void TopPinsAnalyticsResponse::fromJsonObject_internal(boost::json::object const& object)
{
    ...
    m_Sort_byIsSet = false;
    {
        ...
        if (Date_availabilityIt != object.end()) {
            setDateAvailability(JsonValueConverter<std::shared_ptr<TopPinsAnalyticsResponseDateAvailability>>::fromJsonValue(Date_availabilityIt->value()));
        }
    }
    {
        const auto PinsIt = object.find("pins");
        if (PinsIt != object.end()) {
            setPins(JsonValueConverter<std::vector<std::shared_ptr<TopPinsAnalyticsResponsePinsItems>>>::fromJsonValue(PinsIt->value()));
        }
    }
    {
        const auto Sort_byIt = object.find("sort_by");
        if (Sort_byIt != object.end()) {
            setSortBy(JsonValueConverter<std::shared_ptr<TopPinsSortBy>>::fromJsonValue(Sort_byIt->value()));
        }
    }
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<TopPinsAnalyticsResponse>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<TopPinsAnalyticsResponse>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<TopPinsAnalyticsResponse>>>::fromJsonValue(boost::json::parse(json));
}
