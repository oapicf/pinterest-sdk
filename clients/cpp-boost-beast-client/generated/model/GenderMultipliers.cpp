...
GenderMultipliers::GenderMultipliers(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string GenderMultipliers::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value GenderMultipliers::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void GenderMultipliers::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for GenderMultipliers");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object GenderMultipliers::toJsonObject_internal() const
{
...
void GenderMultipliers::fromJsonObject_internal(boost::json::object const& object)
{
    m_GENDERIsSet = false;
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<GenderMultipliers>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<GenderMultipliers>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<GenderMultipliers>>>::fromJsonValue(boost::json::parse(json));
}
