...
NullalbleMatchType::NullalbleMatchType(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string NullalbleMatchType::toJsonString(bool prettyJson /* = false */) const
{
...
void NullalbleMatchType::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value NullalbleMatchType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void NullalbleMatchType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for NullalbleMatchType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object NullalbleMatchType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void NullalbleMatchType::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<NullalbleMatchType>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<NullalbleMatchType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<NullalbleMatchType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<NullalbleMatchType>>>::fromJsonValue(boost::json::parse(json));
}
