...
BoardSectionUpdateWithRequiredBody::BoardSectionUpdateWithRequiredBody(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string BoardSectionUpdateWithRequiredBody::toJsonString(bool prettyJson /* = false */) const
{
...
void BoardSectionUpdateWithRequiredBody::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value BoardSectionUpdateWithRequiredBody::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void BoardSectionUpdateWithRequiredBody::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for BoardSectionUpdateWithRequiredBody");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object BoardSectionUpdateWithRequiredBody::toJsonObject_internal() const
{
...
void BoardSectionUpdateWithRequiredBody::fromJsonObject_internal(boost::json::object const& object)
{
    m_IdIsSet = false;
    {
...
void BoardSectionUpdateWithRequiredBody::setId(std::string value)
{
...
void BoardSectionUpdateWithRequiredBody::setName(std::string value)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<BoardSectionUpdateWithRequiredBody>>>::toJsonValue(data));
}
...
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<BoardSectionUpdateWithRequiredBody>>>::fromJsonValue(boost::json::parse(json));
}
