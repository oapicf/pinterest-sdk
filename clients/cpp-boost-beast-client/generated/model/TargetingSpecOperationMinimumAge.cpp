...
TargetingSpecOperationMinimumAge::TargetingSpecOperationMinimumAge(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value TargetingSpecOperationMinimumAge::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void TargetingSpecOperationMinimumAge::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for TargetingSpecOperationMinimumAge");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object TargetingSpecOperationMinimumAge::toJsonObject_internal() const
{
...
void TargetingSpecOperationMinimumAge::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<TargetingSpecOperationMinimumAge>>>::toJsonValue(data));
}
...
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<TargetingSpecOperationMinimumAge>>>::fromJsonValue(boost::json::parse(json));
}
