...
PromotionsResponse::PromotionsResponse(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value PromotionsResponse::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void PromotionsResponse::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for PromotionsResponse");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object PromotionsResponse::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_PromotionsIsSet) {
            object["promotions"] = JsonValueConverter<std::vector<std::shared_ptr<PromotionArrayElement>>>::toJsonValue(getPromotions());
        }
    return object;
}

void PromotionsResponse::fromJsonObject_internal(boost::json::object const& object)
{
    m_PromotionsIsSet = false;
    {
        const auto PromotionsIt = object.find("promotions");
        if (PromotionsIt != object.end()) {
            setPromotions(JsonValueConverter<std::vector<std::shared_ptr<PromotionArrayElement>>>::fromJsonValue(PromotionsIt->value()));
        }
    }
}
...
void PromotionsResponse::setPromotions(std::vector<std::shared_ptr<PromotionArrayElement>> value)
{
    ...
    m_Promotions = std::move(value);
    m_PromotionsIsSet = true;
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<PromotionsResponse>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<PromotionsResponse>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<PromotionsResponse>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<PromotionsResponse>>>::fromJsonValue(boost::json::parse(json));
}
