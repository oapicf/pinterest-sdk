...
Campaign_ad_preview_delete_200_response_inner_status::Campaign_ad_preview_delete_200_response_inner_status(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value Campaign_ad_preview_delete_200_response_inner_status::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void Campaign_ad_preview_delete_200_response_inner_status::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for Campaign_ad_preview_delete_200_response_inner_status");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object Campaign_ad_preview_delete_200_response_inner_status::toJsonObject_internal() const
{
    boost::json::object object;
        object["statusCode"] = JsonValueConverter<double>::toJsonValue(getStatusCode());
...
void Campaign_ad_preview_delete_200_response_inner_status::fromJsonObject_internal(boost::json::object const& object)
{
    {
        const auto StatusCodeIt = object.find("statusCode");
        if (StatusCodeIt != object.end()) {
            setStatusCode(JsonValueConverter<double>::fromJsonValue(StatusCodeIt->value()));
        }
    }
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<Campaign_ad_preview_delete_200_response_inner_status>>>::toJsonValue(data));
}
...
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<Campaign_ad_preview_delete_200_response_inner_status>>>::fromJsonValue(boost::json::parse(json));
}
