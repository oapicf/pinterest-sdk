...
IntegrationLogLevel::IntegrationLogLevel(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string IntegrationLogLevel::toJsonString(bool prettyJson /* = false */) const
{
...
void IntegrationLogLevel::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value IntegrationLogLevel::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void IntegrationLogLevel::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for IntegrationLogLevel");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object IntegrationLogLevel::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void IntegrationLogLevel::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<IntegrationLogLevel>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<IntegrationLogLevel>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<IntegrationLogLevel>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<IntegrationLogLevel>>>::fromJsonValue(boost::json::parse(json));
}
