...
TrendsSupportedRegion::TrendsSupportedRegion(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string TrendsSupportedRegion::toJsonString(bool prettyJson /* = false */) const
{
...
void TrendsSupportedRegion::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value TrendsSupportedRegion::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void TrendsSupportedRegion::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for TrendsSupportedRegion");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object TrendsSupportedRegion::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void TrendsSupportedRegion::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<TrendsSupportedRegion>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<TrendsSupportedRegion>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<TrendsSupportedRegion>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<TrendsSupportedRegion>>>::fromJsonValue(boost::json::parse(json));
}
