...
ItemIdStoreCodePair::ItemIdStoreCodePair(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ItemIdStoreCodePair::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value ItemIdStoreCodePair::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ItemIdStoreCodePair::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ItemIdStoreCodePair");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ItemIdStoreCodePair::toJsonObject_internal() const
{
...
void ItemIdStoreCodePair::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ItemIdStoreCodePair>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ItemIdStoreCodePair>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ItemIdStoreCodePair>>>::fromJsonValue(boost::json::parse(json));
}
