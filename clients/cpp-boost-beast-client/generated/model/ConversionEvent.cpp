...
ConversionEvent::ConversionEvent(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ConversionEvent::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value ConversionEvent::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ConversionEvent::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ConversionEvent");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ConversionEvent::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void ConversionEvent::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ConversionEvent>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ConversionEvent>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ConversionEvent>>>::fromJsonValue(boost::json::parse(json));
}
