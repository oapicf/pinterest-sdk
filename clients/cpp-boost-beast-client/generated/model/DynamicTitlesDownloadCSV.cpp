...
DynamicTitlesDownloadCSV::DynamicTitlesDownloadCSV(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string DynamicTitlesDownloadCSV::toJsonString(bool prettyJson /* = false */) const
{
...
void DynamicTitlesDownloadCSV::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value DynamicTitlesDownloadCSV::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void DynamicTitlesDownloadCSV::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for DynamicTitlesDownloadCSV");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object DynamicTitlesDownloadCSV::toJsonObject_internal() const
{
...
void DynamicTitlesDownloadCSV::fromJsonObject_internal(boost::json::object const& object)
{
...
void DynamicTitlesDownloadCSV::setDownloadUrl(std::string value)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<DynamicTitlesDownloadCSV>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<DynamicTitlesDownloadCSV>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<DynamicTitlesDownloadCSV>>>::fromJsonValue(boost::json::parse(json));
}
