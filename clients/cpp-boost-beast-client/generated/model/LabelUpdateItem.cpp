...
LabelUpdateItem::LabelUpdateItem(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string LabelUpdateItem::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value LabelUpdateItem::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void LabelUpdateItem::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for LabelUpdateItem");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object LabelUpdateItem::toJsonObject_internal() const
{
    boost::json::object object;
        object["id"] = JsonValueConverter<std::string>::toJsonValue(getId());
        if (m_StatusIsSet) {
            object["status"] = JsonValueConverter<std::shared_ptr<LabelStatus>>::toJsonValue(getStatus());
        }
        if (m_ValueIsSet) {
...
void LabelUpdateItem::fromJsonObject_internal(boost::json::object const& object)
{
    m_StatusIsSet = false;
    m_ValueIsSet = false;
    {
    ...
    }
    {
        ...
        if (StatusIt != object.end()) {
            setStatus(JsonValueConverter<std::shared_ptr<LabelStatus>>::fromJsonValue(StatusIt->value()));
        }
    }
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<LabelUpdateItem>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<LabelUpdateItem>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<LabelUpdateItem>>>::fromJsonValue(boost::json::parse(json));
}
