...
CustomerSegmentCreate::CustomerSegmentCreate(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value CustomerSegmentCreate::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CustomerSegmentCreate::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CustomerSegmentCreate");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CustomerSegmentCreate::toJsonObject_internal() const
{
...
void CustomerSegmentCreate::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CustomerSegmentCreate>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CustomerSegmentCreate>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CustomerSegmentCreate>>>::fromJsonValue(boost::json::parse(json));
}
