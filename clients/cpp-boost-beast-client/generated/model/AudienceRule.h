...
#ifndef BOOST_BEAST_OPENAPI_CLIENT_AudienceRule_MODEL_H_
#define BOOST_BEAST_OPENAPI_CLIENT_AudienceRule_MODEL_H_
...
public:
    ...
    explicit AudienceRule(boost::json::value const& value);
    ...
    void setObjectiveType(std::vector<std::shared_ptr<ObjectiveType>> value);
...
#endif /* BOOST_BEAST_OPENAPI_CLIENT_AudienceRule_MODEL_H_ */
