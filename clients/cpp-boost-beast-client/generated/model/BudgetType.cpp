...
BudgetType::BudgetType(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string BudgetType::toJsonString(bool prettyJson /* = false */) const
{
...
void BudgetType::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value BudgetType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void BudgetType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for BudgetType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object BudgetType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void BudgetType::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<BudgetType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<BudgetType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<BudgetType>>>::fromJsonValue(boost::json::parse(json));
}
