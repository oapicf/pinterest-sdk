...
BillingInvoiceDocumentType::BillingInvoiceDocumentType(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value BillingInvoiceDocumentType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void BillingInvoiceDocumentType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for BillingInvoiceDocumentType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object BillingInvoiceDocumentType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void BillingInvoiceDocumentType::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<BillingInvoiceDocumentType>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<BillingInvoiceDocumentType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<BillingInvoiceDocumentType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<BillingInvoiceDocumentType>>>::fromJsonValue(boost::json::parse(json));
}
