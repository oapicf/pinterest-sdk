...
BookClosed::BookClosed(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string BookClosed::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value BookClosed::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void BookClosed::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for BookClosed");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object BookClosed::toJsonObject_internal() const
{
    boost::json::object object;
        object["conversion_metrics_ready"] = JsonValueConverter<bool>::toJsonValue(isConversionMetricsReady());
        object["non_conversion_metrics_ready"] = JsonValueConverter<bool>::toJsonValue(isNonConversionMetricsReady());
    return object;
}

void BookClosed::fromJsonObject_internal(boost::json::object const& object)
{
    {
        const auto Conversion_metrics_readyIt = object.find("conversion_metrics_ready");
        if (Conversion_metrics_readyIt != object.end()) {
            setConversionMetricsReady(JsonValueConverter<bool>::fromJsonValue(Conversion_metrics_readyIt->value()));
        }
    }
    {
        const auto Non_conversion_metrics_readyIt = object.find("non_conversion_metrics_ready");
        if (Non_conversion_metrics_readyIt != object.end()) {
            setNonConversionMetricsReady(JsonValueConverter<bool>::fromJsonValue(Non_conversion_metrics_readyIt->value()));
        }
    }
}
...
void BookClosed::setConversionMetricsReady(bool value)
{
    ...
    m_Conversion_metrics_ready = std::move(value);
}
...
void BookClosed::setNonConversionMetricsReady(bool value)
{
    ...
    m_Non_conversion_metrics_ready = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<BookClosed>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<BookClosed>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<BookClosed>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<BookClosed>>>::fromJsonValue(boost::json::parse(json));
}
