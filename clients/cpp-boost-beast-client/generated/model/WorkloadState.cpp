...
WorkloadState::WorkloadState(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string WorkloadState::toJsonString(bool prettyJson /* = false */) const
{
...
void WorkloadState::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value WorkloadState::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void WorkloadState::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for WorkloadState");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object WorkloadState::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void WorkloadState::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<WorkloadState>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<WorkloadState>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<WorkloadState>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<WorkloadState>>>::fromJsonValue(boost::json::parse(json));
}
