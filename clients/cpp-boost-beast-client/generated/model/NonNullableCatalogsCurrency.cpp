...
NonNullableCatalogsCurrency::NonNullableCatalogsCurrency(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value NonNullableCatalogsCurrency::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void NonNullableCatalogsCurrency::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for NonNullableCatalogsCurrency");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object NonNullableCatalogsCurrency::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void NonNullableCatalogsCurrency::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<NonNullableCatalogsCurrency>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<NonNullableCatalogsCurrency>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<NonNullableCatalogsCurrency>>>::fromJsonValue(boost::json::parse(json));
}
