...
FrequencyGoalMetadataTimerange::FrequencyGoalMetadataTimerange(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string FrequencyGoalMetadataTimerange::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value FrequencyGoalMetadataTimerange::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void FrequencyGoalMetadataTimerange::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for FrequencyGoalMetadataTimerange");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object FrequencyGoalMetadataTimerange::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void FrequencyGoalMetadataTimerange::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<FrequencyGoalMetadataTimerange>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<FrequencyGoalMetadataTimerange>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<FrequencyGoalMetadataTimerange>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<FrequencyGoalMetadataTimerange>>>::fromJsonValue(boost::json::parse(json));
}
