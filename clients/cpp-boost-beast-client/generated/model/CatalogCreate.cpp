...
CatalogCreate::CatalogCreate(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string CatalogCreate::toJsonString(bool prettyJson /* = false */) const
{
...
void CatalogCreate::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value CatalogCreate::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogCreate::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogCreate");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogCreate::toJsonObject_internal() const
{
...
void CatalogCreate::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
void CatalogCreate::setCatalogType(std::shared_ptr<CatalogsType> value)
{
...
void CatalogCreate::setName(std::string value)
{
    
    m_Name = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<CatalogCreate>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogCreate>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CatalogCreate>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogCreate>>>::fromJsonValue(boost::json::parse(json));
}
