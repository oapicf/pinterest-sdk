...
IntegrationLogsRequestCreate::IntegrationLogsRequestCreate(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string IntegrationLogsRequestCreate::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value IntegrationLogsRequestCreate::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void IntegrationLogsRequestCreate::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for IntegrationLogsRequestCreate");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object IntegrationLogsRequestCreate::toJsonObject_internal() const
{
    boost::json::object object;
        object["logs"] = JsonValueConverter<std::vector<std::shared_ptr<IntegrationLog>>>::toJsonValue(getLogs());
    return object;
}

void IntegrationLogsRequestCreate::fromJsonObject_internal(boost::json::object const& object)
{
    {
        const auto LogsIt = object.find("logs");
        if (LogsIt != object.end()) {
            setLogs(JsonValueConverter<std::vector<std::shared_ptr<IntegrationLog>>>::fromJsonValue(LogsIt->value()));
        }
    }
}
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<IntegrationLogsRequestCreate>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<IntegrationLogsRequestCreate>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<IntegrationLogsRequestCreate>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<IntegrationLogsRequestCreate>>>::fromJsonValue(boost::json::parse(json));
}
