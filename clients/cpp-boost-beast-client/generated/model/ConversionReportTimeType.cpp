...
ConversionReportTimeType::ConversionReportTimeType(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ConversionReportTimeType::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value ConversionReportTimeType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ConversionReportTimeType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ConversionReportTimeType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ConversionReportTimeType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void ConversionReportTimeType::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<ConversionReportTimeType>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ConversionReportTimeType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ConversionReportTimeType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ConversionReportTimeType>>>::fromJsonValue(boost::json::parse(json));
}
