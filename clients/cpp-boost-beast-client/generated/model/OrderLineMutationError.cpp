...
OrderLineMutationError::OrderLineMutationError(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value OrderLineMutationError::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void OrderLineMutationError::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for OrderLineMutationError");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object OrderLineMutationError::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_DataIsSet) {
            object["data"] = JsonValueConverter<std::shared_ptr<OrderLine>>::toJsonValue(getData());
        }
        if (m_Error_messagesIsSet) {
            object["error_messages"] = JsonValueConverter<std::vector<std::string>>::toJsonValue(getErrorMessages());
        }
    return object;
}

void OrderLineMutationError::fromJsonObject_internal(boost::json::object const& object)
{
    m_DataIsSet = false;
    m_Error_messagesIsSet = false;
    {
        ...
        if (DataIt != object.end()) {
            setData(JsonValueConverter<std::shared_ptr<OrderLine>>::fromJsonValue(DataIt->value()));
        }
    }
    {
        const auto Error_messagesIt = object.find("error_messages");
        if (Error_messagesIt != object.end()) {
            setErrorMessages(JsonValueConverter<std::vector<std::string>>::fromJsonValue(Error_messagesIt->value()));
        }
    }
}
...
void OrderLineMutationError::setErrorMessages(std::vector<std::string> value)
{
    ...
    m_Error_messages = std::move(value);
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<OrderLineMutationError>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<OrderLineMutationError>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<OrderLineMutationError>>>::fromJsonValue(boost::json::parse(json));
}
