...
CatalogsAvailableFilterValues::CatalogsAvailableFilterValues(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string CatalogsAvailableFilterValues::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value CatalogsAvailableFilterValues::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogsAvailableFilterValues::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogsAvailableFilterValues");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogsAvailableFilterValues::toJsonObject_internal() const
{
...
void CatalogsAvailableFilterValues::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<CatalogsAvailableFilterValues>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogsAvailableFilterValues>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CatalogsAvailableFilterValues>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogsAvailableFilterValues>>>::fromJsonValue(boost::json::parse(json));
}
