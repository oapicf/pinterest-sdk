...
AiDisclosures::AiDisclosures(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string AiDisclosures::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value AiDisclosures::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AiDisclosures::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AiDisclosures");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AiDisclosures::toJsonObject_internal() const
{
...
void AiDisclosures::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AiDisclosures>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AiDisclosures>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AiDisclosures>>>::fromJsonValue(boost::json::parse(json));
}
