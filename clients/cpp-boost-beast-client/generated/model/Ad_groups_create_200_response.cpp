...
Ad_groups_create_200_response::Ad_groups_create_200_response(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string Ad_groups_create_200_response::toJsonString(bool prettyJson /* = false */) const
{
...
void Ad_groups_create_200_response::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value Ad_groups_create_200_response::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void Ad_groups_create_200_response::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for Ad_groups_create_200_response");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object Ad_groups_create_200_response::toJsonObject_internal() const
{
    boost::json::object object;
        object["items"] = JsonValueConverter<std::vector<std::shared_ptr<Ad_groups_create_200_response_items_inner>>>::toJsonValue(getItems());
    return object;
}

void Ad_groups_create_200_response::fromJsonObject_internal(boost::json::object const& object)
{
    {
        const auto ItemsIt = object.find("items");
        if (ItemsIt != object.end()) {
            setItems(JsonValueConverter<std::vector<std::shared_ptr<Ad_groups_create_200_response_items_inner>>>::fromJsonValue(ItemsIt->value()));
        }
    }
}

std::vector<std::shared_ptr<Ad_groups_create_200_response_items_inner>> Ad_groups_create_200_response::getItems() const
{
    return m_Items;
}

void Ad_groups_create_200_response::setItems(std::vector<std::shared_ptr<Ad_groups_create_200_response_items_inner>> value)
{
    
    m_Items = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<Ad_groups_create_200_response>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<Ad_groups_create_200_response>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<Ad_groups_create_200_response>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<Ad_groups_create_200_response>>>::fromJsonValue(boost::json::parse(json));
}
