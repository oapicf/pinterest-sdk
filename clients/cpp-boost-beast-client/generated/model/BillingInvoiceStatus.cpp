...
BillingInvoiceStatus::BillingInvoiceStatus(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string BillingInvoiceStatus::toJsonString(bool prettyJson /* = false */) const
{
...
void BillingInvoiceStatus::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value BillingInvoiceStatus::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void BillingInvoiceStatus::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for BillingInvoiceStatus");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object BillingInvoiceStatus::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void BillingInvoiceStatus::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<BillingInvoiceStatus>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<BillingInvoiceStatus>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<BillingInvoiceStatus>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<BillingInvoiceStatus>>>::fromJsonValue(boost::json::parse(json));
}
