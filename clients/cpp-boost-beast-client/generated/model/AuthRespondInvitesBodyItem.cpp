...
AuthRespondInvitesBodyItem::AuthRespondInvitesBodyItem(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string AuthRespondInvitesBodyItem::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value AuthRespondInvitesBodyItem::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AuthRespondInvitesBodyItem::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AuthRespondInvitesBodyItem");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AuthRespondInvitesBodyItem::toJsonObject_internal() const
{
    boost::json::object object;
        object["action"] = JsonValueConverter<std::shared_ptr<AuthRespondInviteAction>>::toJsonValue(getAction());
        object["invite_id"] = JsonValueConverter<std::string>::toJsonValue(getInviteId());
    return object;
}

void AuthRespondInvitesBodyItem::fromJsonObject_internal(boost::json::object const& object)
{
    {
        const auto ActionIt = object.find("action");
        if (ActionIt != object.end()) {
            setAction(JsonValueConverter<std::shared_ptr<AuthRespondInviteAction>>::fromJsonValue(ActionIt->value()));
        }
    }
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AuthRespondInvitesBodyItem>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AuthRespondInvitesBodyItem>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AuthRespondInvitesBodyItem>>>::fromJsonValue(boost::json::parse(json));
}
