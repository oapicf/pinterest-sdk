...
AdPinPreviewCreativeType::AdPinPreviewCreativeType(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string AdPinPreviewCreativeType::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value AdPinPreviewCreativeType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AdPinPreviewCreativeType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AdPinPreviewCreativeType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AdPinPreviewCreativeType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void AdPinPreviewCreativeType::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<AdPinPreviewCreativeType>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AdPinPreviewCreativeType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AdPinPreviewCreativeType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AdPinPreviewCreativeType>>>::fromJsonValue(boost::json::parse(json));
}
