...
AppTypeMultipliers::AppTypeMultipliers(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string AppTypeMultipliers::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value AppTypeMultipliers::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AppTypeMultipliers::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AppTypeMultipliers");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AppTypeMultipliers::toJsonObject_internal() const
{
...
void AppTypeMultipliers::fromJsonObject_internal(boost::json::object const& object)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AppTypeMultipliers>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AppTypeMultipliers>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AppTypeMultipliers>>>::fromJsonValue(boost::json::parse(json));
}
