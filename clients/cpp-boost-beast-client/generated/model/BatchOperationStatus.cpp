...
BatchOperationStatus::BatchOperationStatus(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value BatchOperationStatus::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void BatchOperationStatus::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for BatchOperationStatus");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object BatchOperationStatus::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void BatchOperationStatus::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<BatchOperationStatus>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<BatchOperationStatus>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<BatchOperationStatus>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<BatchOperationStatus>>>::fromJsonValue(boost::json::parse(json));
}
