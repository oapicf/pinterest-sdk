...
CampaignPlanningConversionEvent::CampaignPlanningConversionEvent(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string CampaignPlanningConversionEvent::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value CampaignPlanningConversionEvent::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CampaignPlanningConversionEvent::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CampaignPlanningConversionEvent");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CampaignPlanningConversionEvent::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void CampaignPlanningConversionEvent::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CampaignPlanningConversionEvent>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CampaignPlanningConversionEvent>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CampaignPlanningConversionEvent>>>::fromJsonValue(boost::json::parse(json));
}
