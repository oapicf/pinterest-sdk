...
ProductAvailabilityType::ProductAvailabilityType(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ProductAvailabilityType::toJsonString(bool prettyJson /* = false */) const
{
...
void ProductAvailabilityType::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value ProductAvailabilityType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ProductAvailabilityType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ProductAvailabilityType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ProductAvailabilityType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void ProductAvailabilityType::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<ProductAvailabilityType>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ProductAvailabilityType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ProductAvailabilityType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ProductAvailabilityType>>>::fromJsonValue(boost::json::parse(json));
}
