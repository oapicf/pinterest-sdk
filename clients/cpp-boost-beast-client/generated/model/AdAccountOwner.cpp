...
AdAccountOwner::AdAccountOwner(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value AdAccountOwner::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AdAccountOwner::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AdAccountOwner");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AdAccountOwner::toJsonObject_internal() const
{
...
void AdAccountOwner::fromJsonObject_internal(boost::json::object const& object)
{
    m_IdIsSet = false;
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AdAccountOwner>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AdAccountOwner>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AdAccountOwner>>>::fromJsonValue(boost::json::parse(json));
}
