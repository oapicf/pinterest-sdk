...
InviteStatus::InviteStatus(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string InviteStatus::toJsonString(bool prettyJson /* = false */) const
{
...
void InviteStatus::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value InviteStatus::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void InviteStatus::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for InviteStatus");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object InviteStatus::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void InviteStatus::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<InviteStatus>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<InviteStatus>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<InviteStatus>>>::fromJsonValue(boost::json::parse(json));
}
