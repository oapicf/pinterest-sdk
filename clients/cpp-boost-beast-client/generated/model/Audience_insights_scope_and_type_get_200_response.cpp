...
Audience_insights_scope_and_type_get_200_response::Audience_insights_scope_and_type_get_200_response(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string Audience_insights_scope_and_type_get_200_response::toJsonString(bool prettyJson /* = false */) const
{
...
void Audience_insights_scope_and_type_get_200_response::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value Audience_insights_scope_and_type_get_200_response::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void Audience_insights_scope_and_type_get_200_response::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for Audience_insights_scope_and_type_get_200_response");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object Audience_insights_scope_and_type_get_200_response::toJsonObject_internal() const
{
    boost::json::object object;
        object["items"] = JsonValueConverter<std::vector<std::shared_ptr<AudienceDefinition>>>::toJsonValue(getItems());
    return object;
}

void Audience_insights_scope_and_type_get_200_response::fromJsonObject_internal(boost::json::object const& object)
{
    {
        const auto ItemsIt = object.find("items");
        if (ItemsIt != object.end()) {
            setItems(JsonValueConverter<std::vector<std::shared_ptr<AudienceDefinition>>>::fromJsonValue(ItemsIt->value()));
        }
    }
}

std::vector<std::shared_ptr<AudienceDefinition>> Audience_insights_scope_and_type_get_200_response::getItems() const
{
    return m_Items;
}

void Audience_insights_scope_and_type_get_200_response::setItems(std::vector<std::shared_ptr<AudienceDefinition>> value)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<Audience_insights_scope_and_type_get_200_response>>>::toJsonValue(data));
}
...
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<Audience_insights_scope_and_type_get_200_response>>>::fromJsonValue(boost::json::parse(json));
}
