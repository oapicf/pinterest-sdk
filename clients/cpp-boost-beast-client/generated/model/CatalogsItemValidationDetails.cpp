...
CatalogsItemValidationDetails::CatalogsItemValidationDetails(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string CatalogsItemValidationDetails::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value CatalogsItemValidationDetails::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogsItemValidationDetails::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogsItemValidationDetails");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogsItemValidationDetails::toJsonObject_internal() const
{
    boost::json::object object;
        object["attribute_name"] = JsonValueConverter<std::shared_ptr<NullableCatalogsItemFieldType>>::toJsonValue(getAttributeName());
        object["provided_value"] = JsonValueConverter<std::string>::toJsonValue(getProvidedValue());
    return object;
}

void CatalogsItemValidationDetails::fromJsonObject_internal(boost::json::object const& object)
{
    {
        const auto Attribute_nameIt = object.find("attribute_name");
        if (Attribute_nameIt != object.end()) {
            setAttributeName(JsonValueConverter<std::shared_ptr<NullableCatalogsItemFieldType>>::fromJsonValue(Attribute_nameIt->value()));
        }
    }
    {
        const auto Provided_valueIt = object.find("provided_value");
        if (Provided_valueIt != object.end()) {
            setProvidedValue(JsonValueConverter<std::string>::fromJsonValue(Provided_valueIt->value()));
        }
    }
}
...
void CatalogsItemValidationDetails::setAttributeName(std::shared_ptr<NullableCatalogsItemFieldType> value)
{
    ...
    m_Attribute_name = std::move(value);
}
...
void CatalogsItemValidationDetails::setProvidedValue(std::string value)
{
    ...
    m_Provided_value = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<CatalogsItemValidationDetails>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogsItemValidationDetails>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CatalogsItemValidationDetails>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogsItemValidationDetails>>>::fromJsonValue(boost::json::parse(json));
}
