...
AdsCreditRedeemCreate::AdsCreditRedeemCreate(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value AdsCreditRedeemCreate::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AdsCreditRedeemCreate::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AdsCreditRedeemCreate");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AdsCreditRedeemCreate::toJsonObject_internal() const
{
    boost::json::object object;
        object["offerCodeHash"] = JsonValueConverter<std::string>::toJsonValue(getOfferCodeHash());
        object["validateOnly"] = JsonValueConverter<bool>::toJsonValue(isValidateOnly());
    return object;
}

void AdsCreditRedeemCreate::fromJsonObject_internal(boost::json::object const& object)
{
    {
        const auto OfferCodeHashIt = object.find("offerCodeHash");
        if (OfferCodeHashIt != object.end()) {
            setOfferCodeHash(JsonValueConverter<std::string>::fromJsonValue(OfferCodeHashIt->value()));
        }
    }
    {
...
void AdsCreditRedeemCreate::setOfferCodeHash(std::string value)
{
    ...
    m_OfferCodeHash = std::move(value);
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AdsCreditRedeemCreate>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AdsCreditRedeemCreate>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AdsCreditRedeemCreate>>>::fromJsonValue(boost::json::parse(json));
}
