...
BusinessMembersAssetAccessDeleteBody::BusinessMembersAssetAccessDeleteBody(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string BusinessMembersAssetAccessDeleteBody::toJsonString(bool prettyJson /* = false */) const
{
...
void BusinessMembersAssetAccessDeleteBody::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value BusinessMembersAssetAccessDeleteBody::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void BusinessMembersAssetAccessDeleteBody::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for BusinessMembersAssetAccessDeleteBody");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object BusinessMembersAssetAccessDeleteBody::toJsonObject_internal() const
{
    boost::json::object object;
        object["accesses"] = JsonValueConverter<std::vector<std::shared_ptr<DeleteMemberAssetAccessItem>>>::toJsonValue(getAccesses());
    return object;
}

void BusinessMembersAssetAccessDeleteBody::fromJsonObject_internal(boost::json::object const& object)
{
    {
        const auto AccessesIt = object.find("accesses");
        if (AccessesIt != object.end()) {
            setAccesses(JsonValueConverter<std::vector<std::shared_ptr<DeleteMemberAssetAccessItem>>>::fromJsonValue(AccessesIt->value()));
        }
    }
}

std::vector<std::shared_ptr<DeleteMemberAssetAccessItem>> BusinessMembersAssetAccessDeleteBody::getAccesses() const
{
    return m_Accesses;
}

void BusinessMembersAssetAccessDeleteBody::setAccesses(std::vector<std::shared_ptr<DeleteMemberAssetAccessItem>> value)
{
    
    m_Accesses = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<BusinessMembersAssetAccessDeleteBody>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<BusinessMembersAssetAccessDeleteBody>>>::toJsonValue(data));
}
...
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<BusinessMembersAssetAccessDeleteBody>>>::fromJsonValue(boost::json::parse(json));
}
