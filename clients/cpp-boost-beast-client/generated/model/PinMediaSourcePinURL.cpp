...
PinMediaSourcePinURL::PinMediaSourcePinURL(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value PinMediaSourcePinURL::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void PinMediaSourcePinURL::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for PinMediaSourcePinURL");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object PinMediaSourcePinURL::toJsonObject_internal() const
{
...
void PinMediaSourcePinURL::fromJsonObject_internal(boost::json::object const& object)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<PinMediaSourcePinURL>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<PinMediaSourcePinURL>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<PinMediaSourcePinURL>>>::fromJsonValue(boost::json::parse(json));
}
