...
MinPriceFilter::MinPriceFilter(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string MinPriceFilter::toJsonString(bool prettyJson /* = false */) const
{
...
void MinPriceFilter::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value MinPriceFilter::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void MinPriceFilter::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for MinPriceFilter");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object MinPriceFilter::toJsonObject_internal() const
{
...
void MinPriceFilter::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
void MinPriceFilter::setMINPRICE(std::shared_ptr<CatalogsProductGroupPricingCriteria> value)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<MinPriceFilter>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<MinPriceFilter>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<MinPriceFilter>>>::fromJsonValue(boost::json::parse(json));
}
