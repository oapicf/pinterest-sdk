...
BoardPrivacyFilter::BoardPrivacyFilter(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string BoardPrivacyFilter::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value BoardPrivacyFilter::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void BoardPrivacyFilter::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for BoardPrivacyFilter");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object BoardPrivacyFilter::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void BoardPrivacyFilter::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<BoardPrivacyFilter>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<BoardPrivacyFilter>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<BoardPrivacyFilter>>>::fromJsonValue(boost::json::parse(json));
}
