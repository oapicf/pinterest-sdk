...
AssetIdPermissions::AssetIdPermissions(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string AssetIdPermissions::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value AssetIdPermissions::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AssetIdPermissions::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AssetIdPermissions");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AssetIdPermissions::toJsonObject_internal() const
{
...
void AssetIdPermissions::fromJsonObject_internal(boost::json::object const& object)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<AssetIdPermissions>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AssetIdPermissions>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AssetIdPermissions>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AssetIdPermissions>>>::fromJsonValue(boost::json::parse(json));
}
