...
AssetGroupDeletionDelete::AssetGroupDeletionDelete(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string AssetGroupDeletionDelete::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value AssetGroupDeletionDelete::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AssetGroupDeletionDelete::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AssetGroupDeletionDelete");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AssetGroupDeletionDelete::toJsonObject_internal() const
{
    boost::json::object object;
        object["asset_groups_to_delete"] = JsonValueConverter<std::vector<std::shared_ptr<std::string>>>::toJsonValue(getAssetGroupsToDelete());
    return object;
}

void AssetGroupDeletionDelete::fromJsonObject_internal(boost::json::object const& object)
{
    {
        const auto Asset_groups_to_deleteIt = object.find("asset_groups_to_delete");
        if (Asset_groups_to_deleteIt != object.end()) {
            setAssetGroupsToDelete(JsonValueConverter<std::vector<std::shared_ptr<std::string>>>::fromJsonValue(Asset_groups_to_deleteIt->value()));
        }
    }
}
...
void AssetGroupDeletionDelete::setAssetGroupsToDelete(std::vector<std::shared_ptr<std::string>> value)
{
    ...
    m_Asset_groups_to_delete = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<AssetGroupDeletionDelete>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AssetGroupDeletionDelete>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AssetGroupDeletionDelete>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AssetGroupDeletionDelete>>>::fromJsonValue(boost::json::parse(json));
}
