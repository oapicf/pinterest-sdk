...
TargetingSpecOperationAudienceInclude::TargetingSpecOperationAudienceInclude(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string TargetingSpecOperationAudienceInclude::toJsonString(bool prettyJson /* = false */) const
{
...
void TargetingSpecOperationAudienceInclude::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value TargetingSpecOperationAudienceInclude::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void TargetingSpecOperationAudienceInclude::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for TargetingSpecOperationAudienceInclude");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object TargetingSpecOperationAudienceInclude::toJsonObject_internal() const
{
...
void TargetingSpecOperationAudienceInclude::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
std::string TargetingSpecOperationAudienceInclude::getField() const
{
    return m_Field;
}

void TargetingSpecOperationAudienceInclude::setField(std::string value)
{
...
void TargetingSpecOperationAudienceInclude::setOperation(std::shared_ptr<TargetingSpecListOperation> value)
{
...
void TargetingSpecOperationAudienceInclude::setValues(std::vector<std::string> value)
{
    
    m_Values = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<TargetingSpecOperationAudienceInclude>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<TargetingSpecOperationAudienceInclude>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<TargetingSpecOperationAudienceInclude>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<TargetingSpecOperationAudienceInclude>>>::fromJsonValue(boost::json::parse(json));
}
