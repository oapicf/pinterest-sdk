...
TemplateBasedReport::TemplateBasedReport(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value TemplateBasedReport::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void TemplateBasedReport::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for TemplateBasedReport");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object TemplateBasedReport::toJsonObject_internal() const
{
    boost::json::object object;
        ...
        object["template_id"] = JsonValueConverter<std::string>::toJsonValue(getTemplateId());
        if (m_TokenIsSet) {
...
void TemplateBasedReport::fromJsonObject_internal(boost::json::object const& object)
{
    ...
    {
        const auto Template_idIt = object.find("template_id");
        if (Template_idIt != object.end()) {
            setTemplateId(JsonValueConverter<std::string>::fromJsonValue(Template_idIt->value()));
        }
    }
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<TemplateBasedReport>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<TemplateBasedReport>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<TemplateBasedReport>>>::fromJsonValue(boost::json::parse(json));
}
