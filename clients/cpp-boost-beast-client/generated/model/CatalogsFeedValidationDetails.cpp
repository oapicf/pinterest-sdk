...
CatalogsFeedValidationDetails::CatalogsFeedValidationDetails(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value CatalogsFeedValidationDetails::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogsFeedValidationDetails::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogsFeedValidationDetails");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogsFeedValidationDetails::toJsonObject_internal() const
{
    boost::json::object object;
        object["errors"] = JsonValueConverter<std::shared_ptr<CatalogsFeedValidationErrors>>::toJsonValue(getErrors());
        object["warnings"] = JsonValueConverter<std::shared_ptr<CatalogsFeedValidationWarnings>>::toJsonValue(getWarnings());
    return object;
}

void CatalogsFeedValidationDetails::fromJsonObject_internal(boost::json::object const& object)
{
    {
        const auto ErrorsIt = object.find("errors");
        if (ErrorsIt != object.end()) {
            setErrors(JsonValueConverter<std::shared_ptr<CatalogsFeedValidationErrors>>::fromJsonValue(ErrorsIt->value()));
        }
    }
    {
        const auto WarningsIt = object.find("warnings");
        if (WarningsIt != object.end()) {
            setWarnings(JsonValueConverter<std::shared_ptr<CatalogsFeedValidationWarnings>>::fromJsonValue(WarningsIt->value()));
        }
    }
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogsFeedValidationDetails>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CatalogsFeedValidationDetails>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogsFeedValidationDetails>>>::fromJsonValue(boost::json::parse(json));
}
