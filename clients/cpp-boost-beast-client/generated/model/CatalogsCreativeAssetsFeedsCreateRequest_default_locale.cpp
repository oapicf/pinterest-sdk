...
CatalogsCreativeAssetsFeedsCreateRequest_default_locale::CatalogsCreativeAssetsFeedsCreateRequest_default_locale(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value CatalogsCreativeAssetsFeedsCreateRequest_default_locale::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogsCreativeAssetsFeedsCreateRequest_default_locale::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogsCreativeAssetsFeedsCreateRequest_default_locale");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogsCreativeAssetsFeedsCreateRequest_default_locale::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void CatalogsCreativeAssetsFeedsCreateRequest_default_locale::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogsCreativeAssetsFeedsCreateRequest_default_locale>>>::toJsonValue(data));
}
...
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogsCreativeAssetsFeedsCreateRequest_default_locale>>>::fromJsonValue(boost::json::parse(json));
}
