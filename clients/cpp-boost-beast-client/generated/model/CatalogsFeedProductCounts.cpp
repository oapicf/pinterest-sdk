...
CatalogsFeedProductCounts::CatalogsFeedProductCounts(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value CatalogsFeedProductCounts::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogsFeedProductCounts::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogsFeedProductCounts");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogsFeedProductCounts::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_IngestedIsSet) {
            object["ingested"] = JsonValueConverter<int32_t>::toJsonValue(getIngested());
        }
        if (m_OriginalIsSet) {
            object["original"] = JsonValueConverter<int32_t>::toJsonValue(getOriginal());
        }
    return object;
}

void CatalogsFeedProductCounts::fromJsonObject_internal(boost::json::object const& object)
{
    m_IngestedIsSet = false;
    m_OriginalIsSet = false;
    {
        const auto IngestedIt = object.find("ingested");
        if (IngestedIt != object.end()) {
            setIngested(JsonValueConverter<int32_t>::fromJsonValue(IngestedIt->value()));
        }
    }
    {
        const auto OriginalIt = object.find("original");
        if (OriginalIt != object.end()) {
            setOriginal(JsonValueConverter<int32_t>::fromJsonValue(OriginalIt->value()));
        }
    }
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogsFeedProductCounts>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CatalogsFeedProductCounts>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogsFeedProductCounts>>>::fromJsonValue(boost::json::parse(json));
}
