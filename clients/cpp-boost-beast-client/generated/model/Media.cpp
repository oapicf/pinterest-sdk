...
Media::Media(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string Media::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value Media::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void Media::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for Media");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object Media::toJsonObject_internal() const
{
    boost::json::object object;
        ...
        if (m_StatusIsSet) {
            object["status"] = JsonValueConverter<std::shared_ptr<MediaUploadStatus>>::toJsonValue(getStatus());
        }
    return object;
}

void Media::fromJsonObject_internal(boost::json::object const& object)
{
    m_StatusIsSet = false;
    {
    ...
    }
    {
        ...
        if (StatusIt != object.end()) {
            setStatus(JsonValueConverter<std::shared_ptr<MediaUploadStatus>>::fromJsonValue(StatusIt->value()));
        }
    }
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<Media>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<Media>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<Media>>>::fromJsonValue(boost::json::parse(json));
}
