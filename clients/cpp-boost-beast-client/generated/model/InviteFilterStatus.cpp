...
InviteFilterStatus::InviteFilterStatus(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string InviteFilterStatus::toJsonString(bool prettyJson /* = false */) const
{
...
void InviteFilterStatus::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value InviteFilterStatus::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void InviteFilterStatus::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for InviteFilterStatus");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object InviteFilterStatus::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void InviteFilterStatus::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<InviteFilterStatus>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<InviteFilterStatus>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<InviteFilterStatus>>>::fromJsonValue(boost::json::parse(json));
}
