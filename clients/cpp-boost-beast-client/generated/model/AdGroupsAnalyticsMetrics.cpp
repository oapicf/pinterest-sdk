...
AdGroupsAnalyticsMetrics::AdGroupsAnalyticsMetrics(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string AdGroupsAnalyticsMetrics::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value AdGroupsAnalyticsMetrics::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AdGroupsAnalyticsMetrics::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AdGroupsAnalyticsMetrics");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AdGroupsAnalyticsMetrics::toJsonObject_internal() const
{
...
void AdGroupsAnalyticsMetrics::fromJsonObject_internal(boost::json::object const& object)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AdGroupsAnalyticsMetrics>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AdGroupsAnalyticsMetrics>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AdGroupsAnalyticsMetrics>>>::fromJsonValue(boost::json::parse(json));
}
