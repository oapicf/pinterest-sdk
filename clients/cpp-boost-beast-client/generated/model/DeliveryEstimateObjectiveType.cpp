...
DeliveryEstimateObjectiveType::DeliveryEstimateObjectiveType(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string DeliveryEstimateObjectiveType::toJsonString(bool prettyJson /* = false */) const
{
...
void DeliveryEstimateObjectiveType::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value DeliveryEstimateObjectiveType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void DeliveryEstimateObjectiveType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for DeliveryEstimateObjectiveType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object DeliveryEstimateObjectiveType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void DeliveryEstimateObjectiveType::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<DeliveryEstimateObjectiveType>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<DeliveryEstimateObjectiveType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<DeliveryEstimateObjectiveType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<DeliveryEstimateObjectiveType>>>::fromJsonValue(boost::json::parse(json));
}
