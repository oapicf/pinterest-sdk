...
NullableCatalogsItemFieldType::NullableCatalogsItemFieldType(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value NullableCatalogsItemFieldType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void NullableCatalogsItemFieldType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for NullableCatalogsItemFieldType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object NullableCatalogsItemFieldType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void NullableCatalogsItemFieldType::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<NullableCatalogsItemFieldType>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<NullableCatalogsItemFieldType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<NullableCatalogsItemFieldType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<NullableCatalogsItemFieldType>>>::fromJsonValue(boost::json::parse(json));
}
