...
AdvancedAuctionProcessedItems::AdvancedAuctionProcessedItems(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string AdvancedAuctionProcessedItems::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value AdvancedAuctionProcessedItems::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AdvancedAuctionProcessedItems::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AdvancedAuctionProcessedItems");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AdvancedAuctionProcessedItems::toJsonObject_internal() const
{
    boost::json::object object;
        ...
        if (m_ItemsIsSet) {
            object["items"] = JsonValueConverter<std::vector<std::shared_ptr<AdvancedAuctionItemsSubmitRecord>>>::toJsonValue(getItems());
        }
    return object;
}

void AdvancedAuctionProcessedItems::fromJsonObject_internal(boost::json::object const& object)
{
    ...
    }
    {
        ...
        if (ItemsIt != object.end()) {
            setItems(JsonValueConverter<std::vector<std::shared_ptr<AdvancedAuctionItemsSubmitRecord>>>::fromJsonValue(ItemsIt->value()));
        }
    }
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AdvancedAuctionProcessedItems>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AdvancedAuctionProcessedItems>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AdvancedAuctionProcessedItems>>>::fromJsonValue(boost::json::parse(json));
}
