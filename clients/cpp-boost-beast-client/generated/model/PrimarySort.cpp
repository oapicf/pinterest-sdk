...
PrimarySort::PrimarySort(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string PrimarySort::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value PrimarySort::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void PrimarySort::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for PrimarySort");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object PrimarySort::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void PrimarySort::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<PrimarySort>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<PrimarySort>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<PrimarySort>>>::fromJsonValue(boost::json::parse(json));
}
