...
BidStrategyType::BidStrategyType(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value BidStrategyType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void BidStrategyType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for BidStrategyType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object BidStrategyType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void BidStrategyType::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<BidStrategyType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<BidStrategyType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<BidStrategyType>>>::fromJsonValue(boost::json::parse(json));
}
