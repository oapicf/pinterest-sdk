...
LabelError::LabelError(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string LabelError::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value LabelError::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void LabelError::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for LabelError");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object LabelError::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_DataIsSet) {
            object["data"] = JsonValueConverter<std::shared_ptr<LabelErrorData>>::toJsonValue(getData());
        }
...
void LabelError::fromJsonObject_internal(boost::json::object const& object)
{
    m_DataIsSet = false;
    m_Error_messagesIsSet = false;
    {
        ...
        if (DataIt != object.end()) {
            setData(JsonValueConverter<std::shared_ptr<LabelErrorData>>::fromJsonValue(DataIt->value()));
        }
    }
    {
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<LabelError>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<LabelError>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<LabelError>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<LabelError>>>::fromJsonValue(boost::json::parse(json));
}
