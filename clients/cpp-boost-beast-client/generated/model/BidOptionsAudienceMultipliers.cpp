...
BidOptionsAudienceMultipliers::BidOptionsAudienceMultipliers(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value BidOptionsAudienceMultipliers::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void BidOptionsAudienceMultipliers::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for BidOptionsAudienceMultipliers");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object BidOptionsAudienceMultipliers::toJsonObject_internal() const
{
    boost::json::object object;
        object["audience_id"] = JsonValueConverter<std::string>::toJsonValue(getAudienceId());
        object["multiplier"] = JsonValueConverter<double>::toJsonValue(getMultiplier());
    return object;
}

void BidOptionsAudienceMultipliers::fromJsonObject_internal(boost::json::object const& object)
{
    {
    ...
    {
        const auto MultiplierIt = object.find("multiplier");
        if (MultiplierIt != object.end()) {
            setMultiplier(JsonValueConverter<double>::fromJsonValue(MultiplierIt->value()));
        }
    }
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<BidOptionsAudienceMultipliers>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<BidOptionsAudienceMultipliers>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<BidOptionsAudienceMultipliers>>>::fromJsonValue(boost::json::parse(json));
}
