...
CatalogsFeed::CatalogsFeed(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value CatalogsFeed::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogsFeed::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogsFeed");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogsFeed::toJsonObject_internal() const
{
...
void CatalogsFeed::fromJsonObject_internal(boost::json::object const& object)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogsFeed>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CatalogsFeed>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogsFeed>>>::fromJsonValue(boost::json::parse(json));
}
