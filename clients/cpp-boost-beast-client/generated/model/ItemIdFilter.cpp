...
ItemIdFilter::ItemIdFilter(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ItemIdFilter::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value ItemIdFilter::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ItemIdFilter::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ItemIdFilter");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ItemIdFilter::toJsonObject_internal() const
{
...
void ItemIdFilter::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
void ItemIdFilter::setITEMID(std::shared_ptr<CatalogsProductGroupMultipleStringCriteria> value)
{
    
    m_ITEM_ID = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<ItemIdFilter>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ItemIdFilter>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ItemIdFilter>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ItemIdFilter>>>::fromJsonValue(boost::json::parse(json));
}
