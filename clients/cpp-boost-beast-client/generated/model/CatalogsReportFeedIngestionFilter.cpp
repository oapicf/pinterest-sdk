...
CatalogsReportFeedIngestionFilter::CatalogsReportFeedIngestionFilter(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value CatalogsReportFeedIngestionFilter::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogsReportFeedIngestionFilter::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogsReportFeedIngestionFilter");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogsReportFeedIngestionFilter::toJsonObject_internal() const
{
...
void CatalogsReportFeedIngestionFilter::fromJsonObject_internal(boost::json::object const& object)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<CatalogsReportFeedIngestionFilter>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogsReportFeedIngestionFilter>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CatalogsReportFeedIngestionFilter>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogsReportFeedIngestionFilter>>>::fromJsonValue(boost::json::parse(json));
}
