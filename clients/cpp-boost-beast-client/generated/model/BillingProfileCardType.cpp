...
BillingProfileCardType::BillingProfileCardType(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string BillingProfileCardType::toJsonString(bool prettyJson /* = false */) const
{
...
void BillingProfileCardType::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value BillingProfileCardType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void BillingProfileCardType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for BillingProfileCardType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object BillingProfileCardType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void BillingProfileCardType::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<BillingProfileCardType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<BillingProfileCardType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<BillingProfileCardType>>>::fromJsonValue(boost::json::parse(json));
}
