...
GenderBucket::GenderBucket(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value GenderBucket::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void GenderBucket::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for GenderBucket");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object GenderBucket::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void GenderBucket::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<GenderBucket>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<GenderBucket>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<GenderBucket>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<GenderBucket>>>::fromJsonValue(boost::json::parse(json));
}
