...
CampaignBidOptionsUpdateMaskItems::CampaignBidOptionsUpdateMaskItems(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value CampaignBidOptionsUpdateMaskItems::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CampaignBidOptionsUpdateMaskItems::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CampaignBidOptionsUpdateMaskItems");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CampaignBidOptionsUpdateMaskItems::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void CampaignBidOptionsUpdateMaskItems::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<CampaignBidOptionsUpdateMaskItems>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CampaignBidOptionsUpdateMaskItems>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CampaignBidOptionsUpdateMaskItems>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CampaignBidOptionsUpdateMaskItems>>>::fromJsonValue(boost::json::parse(json));
}
