...
UpdateMaskBidOptionField::UpdateMaskBidOptionField(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string UpdateMaskBidOptionField::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value UpdateMaskBidOptionField::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void UpdateMaskBidOptionField::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for UpdateMaskBidOptionField");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object UpdateMaskBidOptionField::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void UpdateMaskBidOptionField::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<UpdateMaskBidOptionField>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<UpdateMaskBidOptionField>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<UpdateMaskBidOptionField>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<UpdateMaskBidOptionField>>>::fromJsonValue(boost::json::parse(json));
}
