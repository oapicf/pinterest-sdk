...
TopPinsSortBy::TopPinsSortBy(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string TopPinsSortBy::toJsonString(bool prettyJson /* = false */) const
{
...
void TopPinsSortBy::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value TopPinsSortBy::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void TopPinsSortBy::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for TopPinsSortBy");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object TopPinsSortBy::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void TopPinsSortBy::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<TopPinsSortBy>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<TopPinsSortBy>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<TopPinsSortBy>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<TopPinsSortBy>>>::fromJsonValue(boost::json::parse(json));
}
