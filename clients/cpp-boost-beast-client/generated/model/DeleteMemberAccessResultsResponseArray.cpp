...
DeleteMemberAccessResultsResponseArray::DeleteMemberAccessResultsResponseArray(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string DeleteMemberAccessResultsResponseArray::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value DeleteMemberAccessResultsResponseArray::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void DeleteMemberAccessResultsResponseArray::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for DeleteMemberAccessResultsResponseArray");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object DeleteMemberAccessResultsResponseArray::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_ItemsIsSet) {
            object["items"] = JsonValueConverter<std::vector<std::shared_ptr<DeleteMemberAccessResult>>>::toJsonValue(getItems());
        }
    return object;
}

void DeleteMemberAccessResultsResponseArray::fromJsonObject_internal(boost::json::object const& object)
{
    m_ItemsIsSet = false;
    {
        const auto ItemsIt = object.find("items");
        if (ItemsIt != object.end()) {
            setItems(JsonValueConverter<std::vector<std::shared_ptr<DeleteMemberAccessResult>>>::fromJsonValue(ItemsIt->value()));
        }
    }
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<DeleteMemberAccessResultsResponseArray>>>::toJsonValue(data));
}
...
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<DeleteMemberAccessResultsResponseArray>>>::fromJsonValue(boost::json::parse(json));
}
