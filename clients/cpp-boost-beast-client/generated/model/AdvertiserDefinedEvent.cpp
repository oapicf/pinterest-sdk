...
AdvertiserDefinedEvent::AdvertiserDefinedEvent(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string AdvertiserDefinedEvent::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value AdvertiserDefinedEvent::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AdvertiserDefinedEvent::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AdvertiserDefinedEvent");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AdvertiserDefinedEvent::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_Mapped_conversion_typeIsSet) {
            object["mapped_conversion_type"] = JsonValueConverter<std::shared_ptr<ConversionTagTypeOptimal>>::toJsonValue(getMappedConversionType());
        }
        if (m_NameIsSet) {
...
void AdvertiserDefinedEvent::fromJsonObject_internal(boost::json::object const& object)
{
    ...
    m_NameIsSet = false;
    {
        ...
        if (Mapped_conversion_typeIt != object.end()) {
            setMappedConversionType(JsonValueConverter<std::shared_ptr<ConversionTagTypeOptimal>>::fromJsonValue(Mapped_conversion_typeIt->value()));
        }
    }
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AdvertiserDefinedEvent>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AdvertiserDefinedEvent>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AdvertiserDefinedEvent>>>::fromJsonValue(boost::json::parse(json));
}
