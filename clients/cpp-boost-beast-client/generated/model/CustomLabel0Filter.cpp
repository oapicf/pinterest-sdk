...
CustomLabel0Filter::CustomLabel0Filter(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value CustomLabel0Filter::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CustomLabel0Filter::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CustomLabel0Filter");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CustomLabel0Filter::toJsonObject_internal() const
{
...
void CustomLabel0Filter::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CustomLabel0Filter>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CustomLabel0Filter>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CustomLabel0Filter>>>::fromJsonValue(boost::json::parse(json));
}
