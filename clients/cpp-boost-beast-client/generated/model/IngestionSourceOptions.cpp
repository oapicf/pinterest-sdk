...
IngestionSourceOptions::IngestionSourceOptions(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string IngestionSourceOptions::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value IngestionSourceOptions::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void IngestionSourceOptions::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for IngestionSourceOptions");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object IngestionSourceOptions::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void IngestionSourceOptions::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<IngestionSourceOptions>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<IngestionSourceOptions>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<IngestionSourceOptions>>>::fromJsonValue(boost::json::parse(json));
}
