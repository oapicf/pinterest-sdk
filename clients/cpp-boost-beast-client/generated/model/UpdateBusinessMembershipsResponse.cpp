...
UpdateBusinessMembershipsResponse::UpdateBusinessMembershipsResponse(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string UpdateBusinessMembershipsResponse::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value UpdateBusinessMembershipsResponse::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void UpdateBusinessMembershipsResponse::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for UpdateBusinessMembershipsResponse");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object UpdateBusinessMembershipsResponse::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_ItemsIsSet) {
            object["items"] = JsonValueConverter<std::vector<std::shared_ptr<BusinessMembershipMember>>>::toJsonValue(getItems());
        }
    return object;
}

void UpdateBusinessMembershipsResponse::fromJsonObject_internal(boost::json::object const& object)
{
    m_ItemsIsSet = false;
    {
        const auto ItemsIt = object.find("items");
        if (ItemsIt != object.end()) {
            setItems(JsonValueConverter<std::vector<std::shared_ptr<BusinessMembershipMember>>>::fromJsonValue(ItemsIt->value()));
        }
    }
}
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<UpdateBusinessMembershipsResponse>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<UpdateBusinessMembershipsResponse>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<UpdateBusinessMembershipsResponse>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<UpdateBusinessMembershipsResponse>>>::fromJsonValue(boost::json::parse(json));
}
