...
Interest::Interest(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value Interest::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void Interest::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for Interest");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object Interest::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_Canonical_urlIsSet) {
            object["canonical_url"] = JsonValueConverter<std::string>::toJsonValue(getCanonicalUrl());
        }
        if (m_IdIsSet) {
...
void Interest::fromJsonObject_internal(boost::json::object const& object)
{
    ...
    m_NameIsSet = false;
    {
        const auto Canonical_urlIt = object.find("canonical_url");
        if (Canonical_urlIt != object.end()) {
            setCanonicalUrl(JsonValueConverter<std::string>::fromJsonValue(Canonical_urlIt->value()));
        }
    }
    {
...
void Interest::setCanonicalUrl(std::string value)
{
    ...
    m_Canonical_url = std::move(value);
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<Interest>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<Interest>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<Interest>>>::fromJsonValue(boost::json::parse(json));
}
