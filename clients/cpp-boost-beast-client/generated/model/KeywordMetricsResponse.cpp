...
KeywordMetricsResponse::KeywordMetricsResponse(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string KeywordMetricsResponse::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value KeywordMetricsResponse::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void KeywordMetricsResponse::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for KeywordMetricsResponse");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object KeywordMetricsResponse::toJsonObject_internal() const
{
    boost::json::object object;
        ...
        if (m_MetricsIsSet) {
            object["metrics"] = JsonValueConverter<std::shared_ptr<KeywordMetrics>>::toJsonValue(getMetrics());
        }
    return object;
}

void KeywordMetricsResponse::fromJsonObject_internal(boost::json::object const& object)
{
    ...
    }
    {
        ...
        if (MetricsIt != object.end()) {
            setMetrics(JsonValueConverter<std::shared_ptr<KeywordMetrics>>::fromJsonValue(MetricsIt->value()));
        }
    }
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<KeywordMetricsResponse>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<KeywordMetricsResponse>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<KeywordMetricsResponse>>>::fromJsonValue(boost::json::parse(json));
}
