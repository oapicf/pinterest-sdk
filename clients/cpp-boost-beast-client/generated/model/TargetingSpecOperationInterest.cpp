...
TargetingSpecOperationInterest::TargetingSpecOperationInterest(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string TargetingSpecOperationInterest::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value TargetingSpecOperationInterest::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void TargetingSpecOperationInterest::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for TargetingSpecOperationInterest");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object TargetingSpecOperationInterest::toJsonObject_internal() const
{
...
void TargetingSpecOperationInterest::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<TargetingSpecOperationInterest>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<TargetingSpecOperationInterest>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<TargetingSpecOperationInterest>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<TargetingSpecOperationInterest>>>::fromJsonValue(boost::json::parse(json));
}
