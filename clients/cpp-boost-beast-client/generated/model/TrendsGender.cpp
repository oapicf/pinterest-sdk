...
TrendsGender::TrendsGender(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string TrendsGender::toJsonString(bool prettyJson /* = false */) const
{
...
void TrendsGender::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value TrendsGender::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void TrendsGender::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for TrendsGender");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object TrendsGender::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void TrendsGender::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<TrendsGender>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<TrendsGender>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<TrendsGender>>>::fromJsonValue(boost::json::parse(json));
}
