...
MMMReport::MMMReport(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string MMMReport::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value MMMReport::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void MMMReport::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for MMMReport");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object MMMReport::toJsonObject_internal() const
{
...
void MMMReport::fromJsonObject_internal(boost::json::object const& object)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<MMMReport>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<MMMReport>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<MMMReport>>>::fromJsonValue(boost::json::parse(json));
}
