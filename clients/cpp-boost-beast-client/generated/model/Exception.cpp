...
Exception::Exception(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string Exception::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value Exception::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void Exception::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for Exception");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object Exception::toJsonObject_internal() const
{
...
void Exception::fromJsonObject_internal(boost::json::object const& object)
{
    m_CodeIsSet = false;
    {
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<Exception>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<Exception>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<Exception>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<Exception>>>::fromJsonValue(boost::json::parse(json));
}
