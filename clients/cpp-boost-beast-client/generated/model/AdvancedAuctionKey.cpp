...
AdvancedAuctionKey::AdvancedAuctionKey(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string AdvancedAuctionKey::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value AdvancedAuctionKey::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AdvancedAuctionKey::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AdvancedAuctionKey");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AdvancedAuctionKey::toJsonObject_internal() const
{
...
void AdvancedAuctionKey::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AdvancedAuctionKey>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AdvancedAuctionKey>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AdvancedAuctionKey>>>::fromJsonValue(boost::json::parse(json));
}
