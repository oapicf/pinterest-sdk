...
OverallStatusOptions::OverallStatusOptions(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string OverallStatusOptions::toJsonString(bool prettyJson /* = false */) const
{
...
void OverallStatusOptions::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value OverallStatusOptions::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void OverallStatusOptions::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for OverallStatusOptions");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object OverallStatusOptions::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void OverallStatusOptions::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<OverallStatusOptions>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<OverallStatusOptions>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<OverallStatusOptions>>>::fromJsonValue(boost::json::parse(json));
}
