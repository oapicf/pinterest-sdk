...
PublicTargetingType::PublicTargetingType(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string PublicTargetingType::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value PublicTargetingType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void PublicTargetingType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for PublicTargetingType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object PublicTargetingType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void PublicTargetingType::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<PublicTargetingType>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<PublicTargetingType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<PublicTargetingType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<PublicTargetingType>>>::fromJsonValue(boost::json::parse(json));
}
