...
CatalogsHotelProductGroupFiltersAnyOf::CatalogsHotelProductGroupFiltersAnyOf(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string CatalogsHotelProductGroupFiltersAnyOf::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value CatalogsHotelProductGroupFiltersAnyOf::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogsHotelProductGroupFiltersAnyOf::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogsHotelProductGroupFiltersAnyOf");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogsHotelProductGroupFiltersAnyOf::toJsonObject_internal() const
{
...
void CatalogsHotelProductGroupFiltersAnyOf::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogsHotelProductGroupFiltersAnyOf>>>::toJsonValue(data));
}
...
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogsHotelProductGroupFiltersAnyOf>>>::fromJsonValue(boost::json::parse(json));
}
