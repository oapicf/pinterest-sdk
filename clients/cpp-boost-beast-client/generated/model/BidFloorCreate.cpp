...
BidFloorCreate::BidFloorCreate(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string BidFloorCreate::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value BidFloorCreate::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void BidFloorCreate::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for BidFloorCreate");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object BidFloorCreate::toJsonObject_internal() const
{
    boost::json::object object;
        object["bid_floor_specs"] = JsonValueConverter<std::vector<std::shared_ptr<BidFloorSpec>>>::toJsonValue(getBidFloorSpecs());
...
void BidFloorCreate::fromJsonObject_internal(boost::json::object const& object)
{
    m_Targeting_specIsSet = false;
    {
        const auto Bid_floor_specsIt = object.find("bid_floor_specs");
        if (Bid_floor_specsIt != object.end()) {
            setBidFloorSpecs(JsonValueConverter<std::vector<std::shared_ptr<BidFloorSpec>>>::fromJsonValue(Bid_floor_specsIt->value()));
        }
    }
    {
...
void BidFloorCreate::setBidFloorSpecs(std::vector<std::shared_ptr<BidFloorSpec>> value)
{
    ...
    m_Bid_floor_specs = std::move(value);
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<BidFloorCreate>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<BidFloorCreate>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<BidFloorCreate>>>::fromJsonValue(boost::json::parse(json));
}
