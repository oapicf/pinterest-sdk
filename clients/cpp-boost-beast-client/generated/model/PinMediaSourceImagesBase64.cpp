...
PinMediaSourceImagesBase64::PinMediaSourceImagesBase64(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value PinMediaSourceImagesBase64::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void PinMediaSourceImagesBase64::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for PinMediaSourceImagesBase64");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object PinMediaSourceImagesBase64::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_IndexIsSet) {
            object["index"] = JsonValueConverter<int32_t>::toJsonValue(getIndex());
        }
        object["items"] = JsonValueConverter<std::vector<std::shared_ptr<PinMediaSourceImagesBase64Item>>>::toJsonValue(getItems());
        object["source_type"] = JsonValueConverter<std::string>::toJsonValue(getSourceType());
    return object;
}

void PinMediaSourceImagesBase64::fromJsonObject_internal(boost::json::object const& object)
{
    m_IndexIsSet = false;
    {
    ...
    }
    {
        ...
        if (ItemsIt != object.end()) {
            setItems(JsonValueConverter<std::vector<std::shared_ptr<PinMediaSourceImagesBase64Item>>>::fromJsonValue(ItemsIt->value()));
        }
    }
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<PinMediaSourceImagesBase64>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<PinMediaSourceImagesBase64>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<PinMediaSourceImagesBase64>>>::fromJsonValue(boost::json::parse(json));
}
