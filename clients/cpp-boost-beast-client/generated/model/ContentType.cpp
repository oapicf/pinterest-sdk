...
ContentType::ContentType(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ContentType::toJsonString(bool prettyJson /* = false */) const
{
...
void ContentType::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value ContentType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ContentType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ContentType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ContentType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void ContentType::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<ContentType>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ContentType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ContentType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ContentType>>>::fromJsonValue(boost::json::parse(json));
}
