...
ItemAttributesRequestImageLink::ItemAttributesRequestImageLink(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ItemAttributesRequestImageLink::toJsonString(bool prettyJson /* = false */) const
{
...
void ItemAttributesRequestImageLink::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value ItemAttributesRequestImageLink::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ItemAttributesRequestImageLink::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ItemAttributesRequestImageLink");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ItemAttributesRequestImageLink::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void ItemAttributesRequestImageLink::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ItemAttributesRequestImageLink>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ItemAttributesRequestImageLink>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ItemAttributesRequestImageLink>>>::fromJsonValue(boost::json::parse(json));
}
