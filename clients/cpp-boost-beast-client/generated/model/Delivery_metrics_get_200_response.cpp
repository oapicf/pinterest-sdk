...
Delivery_metrics_get_200_response::Delivery_metrics_get_200_response(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string Delivery_metrics_get_200_response::toJsonString(bool prettyJson /* = false */) const
{
...
void Delivery_metrics_get_200_response::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value Delivery_metrics_get_200_response::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void Delivery_metrics_get_200_response::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for Delivery_metrics_get_200_response");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object Delivery_metrics_get_200_response::toJsonObject_internal() const
{
    boost::json::object object;
        object["items"] = JsonValueConverter<std::vector<std::shared_ptr<DeliveryMetricsResponseItemsItems>>>::toJsonValue(getItems());
    return object;
}

void Delivery_metrics_get_200_response::fromJsonObject_internal(boost::json::object const& object)
{
    {
        const auto ItemsIt = object.find("items");
        if (ItemsIt != object.end()) {
            setItems(JsonValueConverter<std::vector<std::shared_ptr<DeliveryMetricsResponseItemsItems>>>::fromJsonValue(ItemsIt->value()));
        }
    }
}

std::vector<std::shared_ptr<DeliveryMetricsResponseItemsItems>> Delivery_metrics_get_200_response::getItems() const
{
    return m_Items;
}

void Delivery_metrics_get_200_response::setItems(std::vector<std::shared_ptr<DeliveryMetricsResponseItemsItems>> value)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<Delivery_metrics_get_200_response>>>::toJsonValue(data));
}
...
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<Delivery_metrics_get_200_response>>>::fromJsonValue(boost::json::parse(json));
}
