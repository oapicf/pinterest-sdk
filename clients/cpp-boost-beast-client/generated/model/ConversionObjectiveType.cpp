...
ConversionObjectiveType::ConversionObjectiveType(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value ConversionObjectiveType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ConversionObjectiveType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ConversionObjectiveType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ConversionObjectiveType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void ConversionObjectiveType::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<ConversionObjectiveType>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ConversionObjectiveType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ConversionObjectiveType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ConversionObjectiveType>>>::fromJsonValue(boost::json::parse(json));
}
