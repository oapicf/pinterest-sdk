...
ConversionLearningModeType::ConversionLearningModeType(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ConversionLearningModeType::toJsonString(bool prettyJson /* = false */) const
{
...
void ConversionLearningModeType::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value ConversionLearningModeType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ConversionLearningModeType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ConversionLearningModeType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ConversionLearningModeType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void ConversionLearningModeType::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ConversionLearningModeType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ConversionLearningModeType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ConversionLearningModeType>>>::fromJsonValue(boost::json::parse(json));
}
