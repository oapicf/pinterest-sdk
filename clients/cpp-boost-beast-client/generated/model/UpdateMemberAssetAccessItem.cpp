...
UpdateMemberAssetAccessItem::UpdateMemberAssetAccessItem(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value UpdateMemberAssetAccessItem::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void UpdateMemberAssetAccessItem::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for UpdateMemberAssetAccessItem");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object UpdateMemberAssetAccessItem::toJsonObject_internal() const
{
    boost::json::object object;
        object["asset_id"] = JsonValueConverter<std::string>::toJsonValue(getAssetId());
        object["member_id"] = JsonValueConverter<std::string>::toJsonValue(getMemberId());
        object["permissions"] = JsonValueConverter<std::vector<std::shared_ptr<Permissions>>>::toJsonValue(getPermissions());
    return object;
}

void UpdateMemberAssetAccessItem::fromJsonObject_internal(boost::json::object const& object)
{
    {
    ...
    {
        const auto Member_idIt = object.find("member_id");
        if (Member_idIt != object.end()) {
            setMemberId(JsonValueConverter<std::string>::fromJsonValue(Member_idIt->value()));
        }
    }
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<UpdateMemberAssetAccessItem>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<UpdateMemberAssetAccessItem>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<UpdateMemberAssetAccessItem>>>::fromJsonValue(boost::json::parse(json));
}
