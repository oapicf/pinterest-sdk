...
SupplementalItemBatchOperationStatus::SupplementalItemBatchOperationStatus(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string SupplementalItemBatchOperationStatus::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value SupplementalItemBatchOperationStatus::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void SupplementalItemBatchOperationStatus::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for SupplementalItemBatchOperationStatus");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object SupplementalItemBatchOperationStatus::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void SupplementalItemBatchOperationStatus::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<SupplementalItemBatchOperationStatus>>>::toJsonValue(data));
}
...
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<SupplementalItemBatchOperationStatus>>>::fromJsonValue(boost::json::parse(json));
}
