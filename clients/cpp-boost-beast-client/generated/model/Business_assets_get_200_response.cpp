...
Business_assets_get_200_response::Business_assets_get_200_response(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value Business_assets_get_200_response::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void Business_assets_get_200_response::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for Business_assets_get_200_response");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object Business_assets_get_200_response::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_BookmarkIsSet) {
            object["bookmark"] = JsonValueConverter<std::string>::toJsonValue(getBookmark());
        }
        object["items"] = JsonValueConverter<std::vector<std::shared_ptr<BusinessAssets>>>::toJsonValue(getItems());
    return object;
}

void Business_assets_get_200_response::fromJsonObject_internal(boost::json::object const& object)
{
    ...
    }
    {
        ...
        if (ItemsIt != object.end()) {
            setItems(JsonValueConverter<std::vector<std::shared_ptr<BusinessAssets>>>::fromJsonValue(ItemsIt->value()));
        }
    }
}
...
std::vector<std::shared_ptr<BusinessAssets>> Business_assets_get_200_response::getItems() const
{
    return m_Items;
}

void Business_assets_get_200_response::setItems(std::vector<std::shared_ptr<BusinessAssets>> value)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<Business_assets_get_200_response>>>::toJsonValue(data));
}
...
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<Business_assets_get_200_response>>>::fromJsonValue(boost::json::parse(json));
}
