...
ItemCreateBatchRecord::ItemCreateBatchRecord(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ItemCreateBatchRecord::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value ItemCreateBatchRecord::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ItemCreateBatchRecord::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ItemCreateBatchRecord");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ItemCreateBatchRecord::toJsonObject_internal() const
{
...
void ItemCreateBatchRecord::fromJsonObject_internal(boost::json::object const& object)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ItemCreateBatchRecord>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ItemCreateBatchRecord>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ItemCreateBatchRecord>>>::fromJsonValue(boost::json::parse(json));
}
