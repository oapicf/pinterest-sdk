...
FormFactor::FormFactor(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string FormFactor::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value FormFactor::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void FormFactor::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for FormFactor");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object FormFactor::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void FormFactor::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<FormFactor>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<FormFactor>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<FormFactor>>>::fromJsonValue(boost::json::parse(json));
}
