...
CatalogsProductGroupMultipleStringCriteria::CatalogsProductGroupMultipleStringCriteria(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value CatalogsProductGroupMultipleStringCriteria::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogsProductGroupMultipleStringCriteria::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogsProductGroupMultipleStringCriteria");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogsProductGroupMultipleStringCriteria::toJsonObject_internal() const
{
...
void CatalogsProductGroupMultipleStringCriteria::fromJsonObject_internal(boost::json::object const& object)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogsProductGroupMultipleStringCriteria>>>::toJsonValue(data));
}
...
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogsProductGroupMultipleStringCriteria>>>::fromJsonValue(boost::json::parse(json));
}
