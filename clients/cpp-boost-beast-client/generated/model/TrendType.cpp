...
TrendType::TrendType(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string TrendType::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value TrendType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void TrendType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for TrendType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object TrendType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void TrendType::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<TrendType>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<TrendType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<TrendType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<TrendType>>>::fromJsonValue(boost::json::parse(json));
}
