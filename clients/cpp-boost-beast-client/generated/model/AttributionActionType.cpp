...
AttributionActionType::AttributionActionType(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value AttributionActionType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AttributionActionType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AttributionActionType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AttributionActionType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void AttributionActionType::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AttributionActionType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AttributionActionType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AttributionActionType>>>::fromJsonValue(boost::json::parse(json));
}
