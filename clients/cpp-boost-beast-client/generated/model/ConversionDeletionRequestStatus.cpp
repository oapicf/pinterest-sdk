...
ConversionDeletionRequestStatus::ConversionDeletionRequestStatus(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ConversionDeletionRequestStatus::toJsonString(bool prettyJson /* = false */) const
{
...
void ConversionDeletionRequestStatus::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value ConversionDeletionRequestStatus::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ConversionDeletionRequestStatus::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ConversionDeletionRequestStatus");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ConversionDeletionRequestStatus::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void ConversionDeletionRequestStatus::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ConversionDeletionRequestStatus>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ConversionDeletionRequestStatus>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ConversionDeletionRequestStatus>>>::fromJsonValue(boost::json::parse(json));
}
