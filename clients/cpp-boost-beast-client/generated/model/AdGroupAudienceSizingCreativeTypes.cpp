...
AdGroupAudienceSizingCreativeTypes::AdGroupAudienceSizingCreativeTypes(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string AdGroupAudienceSizingCreativeTypes::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value AdGroupAudienceSizingCreativeTypes::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AdGroupAudienceSizingCreativeTypes::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AdGroupAudienceSizingCreativeTypes");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AdGroupAudienceSizingCreativeTypes::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void AdGroupAudienceSizingCreativeTypes::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<AdGroupAudienceSizingCreativeTypes>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AdGroupAudienceSizingCreativeTypes>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AdGroupAudienceSizingCreativeTypes>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AdGroupAudienceSizingCreativeTypes>>>::fromJsonValue(boost::json::parse(json));
}
