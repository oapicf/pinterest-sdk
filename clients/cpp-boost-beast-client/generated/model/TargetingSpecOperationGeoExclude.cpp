...
TargetingSpecOperationGeoExclude::TargetingSpecOperationGeoExclude(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string TargetingSpecOperationGeoExclude::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value TargetingSpecOperationGeoExclude::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void TargetingSpecOperationGeoExclude::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for TargetingSpecOperationGeoExclude");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object TargetingSpecOperationGeoExclude::toJsonObject_internal() const
{
...
void TargetingSpecOperationGeoExclude::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<TargetingSpecOperationGeoExclude>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<TargetingSpecOperationGeoExclude>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<TargetingSpecOperationGeoExclude>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<TargetingSpecOperationGeoExclude>>>::fromJsonValue(boost::json::parse(json));
}
