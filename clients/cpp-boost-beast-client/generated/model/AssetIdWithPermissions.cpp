...
AssetIdWithPermissions::AssetIdWithPermissions(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string AssetIdWithPermissions::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value AssetIdWithPermissions::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AssetIdWithPermissions::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AssetIdWithPermissions");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AssetIdWithPermissions::toJsonObject_internal() const
{
...
void AssetIdWithPermissions::fromJsonObject_internal(boost::json::object const& object)
{
    m_IdIsSet = false;
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AssetIdWithPermissions>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AssetIdWithPermissions>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AssetIdWithPermissions>>>::fromJsonValue(boost::json::parse(json));
}
