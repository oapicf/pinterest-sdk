...
PacingDeliveryType::PacingDeliveryType(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string PacingDeliveryType::toJsonString(bool prettyJson /* = false */) const
{
...
void PacingDeliveryType::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value PacingDeliveryType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void PacingDeliveryType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for PacingDeliveryType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object PacingDeliveryType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void PacingDeliveryType::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<PacingDeliveryType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<PacingDeliveryType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<PacingDeliveryType>>>::fromJsonValue(boost::json::parse(json));
}
