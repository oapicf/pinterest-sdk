...
BrandFilter::BrandFilter(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string BrandFilter::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value BrandFilter::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void BrandFilter::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for BrandFilter");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object BrandFilter::toJsonObject_internal() const
{
...
void BrandFilter::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<BrandFilter>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<BrandFilter>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<BrandFilter>>>::fromJsonValue(boost::json::parse(json));
}
