...
TargetingSpecOperationAppType::TargetingSpecOperationAppType(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string TargetingSpecOperationAppType::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value TargetingSpecOperationAppType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void TargetingSpecOperationAppType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for TargetingSpecOperationAppType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object TargetingSpecOperationAppType::toJsonObject_internal() const
{
    boost::json::object object;
        object["field"] = JsonValueConverter<std::string>::toJsonValue(getField());
        object["operation"] = JsonValueConverter<std::shared_ptr<TargetingSpecListOperation>>::toJsonValue(getOperation());
        object["values"] = JsonValueConverter<std::vector<std::shared_ptr<TargetingSpecAppType>>>::toJsonValue(getValues());
    return object;
}

void TargetingSpecOperationAppType::fromJsonObject_internal(boost::json::object const& object)
{
    {
    ...
    }
    {
        ...
        if (OperationIt != object.end()) {
            setOperation(JsonValueConverter<std::shared_ptr<TargetingSpecListOperation>>::fromJsonValue(OperationIt->value()));
        }
    }
    {
        const auto ValuesIt = object.find("values");
        if (ValuesIt != object.end()) {
            setValues(JsonValueConverter<std::vector<std::shared_ptr<TargetingSpecAppType>>>::fromJsonValue(ValuesIt->value()));
        }
    }
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<TargetingSpecOperationAppType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<TargetingSpecOperationAppType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<TargetingSpecOperationAppType>>>::fromJsonValue(boost::json::parse(json));
}
