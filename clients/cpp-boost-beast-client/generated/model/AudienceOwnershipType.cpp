...
AudienceOwnershipType::AudienceOwnershipType(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value AudienceOwnershipType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AudienceOwnershipType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AudienceOwnershipType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AudienceOwnershipType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void AudienceOwnershipType::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AudienceOwnershipType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AudienceOwnershipType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AudienceOwnershipType>>>::fromJsonValue(boost::json::parse(json));
}
