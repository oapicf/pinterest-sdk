...
CatalogsProductGroupFiltersAllOf::CatalogsProductGroupFiltersAllOf(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string CatalogsProductGroupFiltersAllOf::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value CatalogsProductGroupFiltersAllOf::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogsProductGroupFiltersAllOf::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogsProductGroupFiltersAllOf");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogsProductGroupFiltersAllOf::toJsonObject_internal() const
{
...
void CatalogsProductGroupFiltersAllOf::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogsProductGroupFiltersAllOf>>>::toJsonValue(data));
}
...
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogsProductGroupFiltersAllOf>>>::fromJsonValue(boost::json::parse(json));
}
