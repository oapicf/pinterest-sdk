...
CampaignsAnalyticsMetrics::CampaignsAnalyticsMetrics(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string CampaignsAnalyticsMetrics::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value CampaignsAnalyticsMetrics::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CampaignsAnalyticsMetrics::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CampaignsAnalyticsMetrics");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CampaignsAnalyticsMetrics::toJsonObject_internal() const
{
...
void CampaignsAnalyticsMetrics::fromJsonObject_internal(boost::json::object const& object)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CampaignsAnalyticsMetrics>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CampaignsAnalyticsMetrics>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CampaignsAnalyticsMetrics>>>::fromJsonValue(boost::json::parse(json));
}
