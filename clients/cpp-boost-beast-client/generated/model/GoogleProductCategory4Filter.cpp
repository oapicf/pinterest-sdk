...
GoogleProductCategory4Filter::GoogleProductCategory4Filter(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string GoogleProductCategory4Filter::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value GoogleProductCategory4Filter::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void GoogleProductCategory4Filter::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for GoogleProductCategory4Filter");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object GoogleProductCategory4Filter::toJsonObject_internal() const
{
...
void GoogleProductCategory4Filter::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<GoogleProductCategory4Filter>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<GoogleProductCategory4Filter>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<GoogleProductCategory4Filter>>>::fromJsonValue(boost::json::parse(json));
}
