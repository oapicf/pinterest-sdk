...
CatalogsItemsUpdateBatchRequest::CatalogsItemsUpdateBatchRequest(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value CatalogsItemsUpdateBatchRequest::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogsItemsUpdateBatchRequest::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogsItemsUpdateBatchRequest");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogsItemsUpdateBatchRequest::toJsonObject_internal() const
{
    boost::json::object object;
        object["country"] = JsonValueConverter<std::shared_ptr<Country>>::toJsonValue(getCountry());
        object["items"] = JsonValueConverter<std::vector<std::shared_ptr<ItemUpdateBatchRecord>>>::toJsonValue(getItems());
...
void CatalogsItemsUpdateBatchRequest::fromJsonObject_internal(boost::json::object const& object)
{
    {
    ...
    }
    {
        ...
        if (ItemsIt != object.end()) {
            setItems(JsonValueConverter<std::vector<std::shared_ptr<ItemUpdateBatchRecord>>>::fromJsonValue(ItemsIt->value()));
        }
    }
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogsItemsUpdateBatchRequest>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CatalogsItemsUpdateBatchRequest>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogsItemsUpdateBatchRequest>>>::fromJsonValue(boost::json::parse(json));
}
