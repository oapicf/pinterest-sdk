...
AdAccountEntityType::AdAccountEntityType(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string AdAccountEntityType::toJsonString(bool prettyJson /* = false */) const
{
...
void AdAccountEntityType::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value AdAccountEntityType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AdAccountEntityType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AdAccountEntityType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AdAccountEntityType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void AdAccountEntityType::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AdAccountEntityType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AdAccountEntityType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AdAccountEntityType>>>::fromJsonValue(boost::json::parse(json));
}
