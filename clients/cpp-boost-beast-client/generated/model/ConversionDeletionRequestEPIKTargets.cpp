...
ConversionDeletionRequestEPIKTargets::ConversionDeletionRequestEPIKTargets(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value ConversionDeletionRequestEPIKTargets::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ConversionDeletionRequestEPIKTargets::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ConversionDeletionRequestEPIKTargets");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ConversionDeletionRequestEPIKTargets::toJsonObject_internal() const
{
...
void ConversionDeletionRequestEPIKTargets::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ConversionDeletionRequestEPIKTargets>>>::toJsonValue(data));
}
...
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ConversionDeletionRequestEPIKTargets>>>::fromJsonValue(boost::json::parse(json));
}
