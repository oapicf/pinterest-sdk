...
FilterOperatorType::FilterOperatorType(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value FilterOperatorType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void FilterOperatorType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for FilterOperatorType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object FilterOperatorType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void FilterOperatorType::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<FilterOperatorType>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<FilterOperatorType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<FilterOperatorType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<FilterOperatorType>>>::fromJsonValue(boost::json::parse(json));
}
