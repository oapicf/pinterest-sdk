...
ScheduleAudienceMultipliers::ScheduleAudienceMultipliers(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ScheduleAudienceMultipliers::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value ScheduleAudienceMultipliers::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ScheduleAudienceMultipliers::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ScheduleAudienceMultipliers");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ScheduleAudienceMultipliers::toJsonObject_internal() const
{
...
void ScheduleAudienceMultipliers::fromJsonObject_internal(boost::json::object const& object)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ScheduleAudienceMultipliers>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ScheduleAudienceMultipliers>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ScheduleAudienceMultipliers>>>::fromJsonValue(boost::json::parse(json));
}
