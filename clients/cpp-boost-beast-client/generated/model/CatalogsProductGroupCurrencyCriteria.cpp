...
CatalogsProductGroupCurrencyCriteria::CatalogsProductGroupCurrencyCriteria(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string CatalogsProductGroupCurrencyCriteria::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value CatalogsProductGroupCurrencyCriteria::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogsProductGroupCurrencyCriteria::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogsProductGroupCurrencyCriteria");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogsProductGroupCurrencyCriteria::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_NegatedIsSet) {
            object["negated"] = JsonValueConverter<bool>::toJsonValue(isNegated());
        }
        object["values"] = JsonValueConverter<std::shared_ptr<NonNullableCatalogsCurrency>>::toJsonValue(getValues());
    return object;
}

void CatalogsProductGroupCurrencyCriteria::fromJsonObject_internal(boost::json::object const& object)
{
    ...
    }
    {
        ...
        if (ValuesIt != object.end()) {
            setValues(JsonValueConverter<std::shared_ptr<NonNullableCatalogsCurrency>>::fromJsonValue(ValuesIt->value()));
        }
    }
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogsProductGroupCurrencyCriteria>>>::toJsonValue(data));
}
...
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogsProductGroupCurrencyCriteria>>>::fromJsonValue(boost::json::parse(json));
}
