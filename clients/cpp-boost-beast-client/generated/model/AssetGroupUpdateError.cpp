...
AssetGroupUpdateError::AssetGroupUpdateError(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string AssetGroupUpdateError::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value AssetGroupUpdateError::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AssetGroupUpdateError::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AssetGroupUpdateError");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AssetGroupUpdateError::toJsonObject_internal() const
{
...
void AssetGroupUpdateError::fromJsonObject_internal(boost::json::object const& object)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AssetGroupUpdateError>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AssetGroupUpdateError>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AssetGroupUpdateError>>>::fromJsonValue(boost::json::parse(json));
}
