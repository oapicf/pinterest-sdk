...
UpdatePartnerAssetsResult::UpdatePartnerAssetsResult(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string UpdatePartnerAssetsResult::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value UpdatePartnerAssetsResult::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void UpdatePartnerAssetsResult::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for UpdatePartnerAssetsResult");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object UpdatePartnerAssetsResult::toJsonObject_internal() const
{
...
void UpdatePartnerAssetsResult::fromJsonObject_internal(boost::json::object const& object)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<UpdatePartnerAssetsResult>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<UpdatePartnerAssetsResult>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<UpdatePartnerAssetsResult>>>::fromJsonValue(boost::json::parse(json));
}
