...
UsersForIndividualAssetResponse::UsersForIndividualAssetResponse(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string UsersForIndividualAssetResponse::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value UsersForIndividualAssetResponse::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void UsersForIndividualAssetResponse::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for UsersForIndividualAssetResponse");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object UsersForIndividualAssetResponse::toJsonObject_internal() const
{
...
void UsersForIndividualAssetResponse::fromJsonObject_internal(boost::json::object const& object)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<UsersForIndividualAssetResponse>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<UsersForIndividualAssetResponse>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<UsersForIndividualAssetResponse>>>::fromJsonValue(boost::json::parse(json));
}
