...
CatalogsProductGroupType::CatalogsProductGroupType(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string CatalogsProductGroupType::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value CatalogsProductGroupType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogsProductGroupType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogsProductGroupType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogsProductGroupType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void CatalogsProductGroupType::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogsProductGroupType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CatalogsProductGroupType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogsProductGroupType>>>::fromJsonValue(boost::json::parse(json));
}
