...
TitleKeywordsFilter::TitleKeywordsFilter(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value TitleKeywordsFilter::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void TitleKeywordsFilter::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for TitleKeywordsFilter");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object TitleKeywordsFilter::toJsonObject_internal() const
{
...
void TitleKeywordsFilter::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<TitleKeywordsFilter>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<TitleKeywordsFilter>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<TitleKeywordsFilter>>>::fromJsonValue(boost::json::parse(json));
}
