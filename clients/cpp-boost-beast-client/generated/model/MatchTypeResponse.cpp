...
MatchTypeResponse::MatchTypeResponse(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string MatchTypeResponse::toJsonString(bool prettyJson /* = false */) const
{
...
void MatchTypeResponse::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value MatchTypeResponse::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void MatchTypeResponse::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for MatchTypeResponse");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object MatchTypeResponse::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void MatchTypeResponse::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<MatchTypeResponse>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<MatchTypeResponse>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<MatchTypeResponse>>>::fromJsonValue(boost::json::parse(json));
}
