...
AdvancedAuctionItemsGetRequest::AdvancedAuctionItemsGetRequest(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value AdvancedAuctionItemsGetRequest::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AdvancedAuctionItemsGetRequest::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AdvancedAuctionItemsGetRequest");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AdvancedAuctionItemsGetRequest::toJsonObject_internal() const
{
    boost::json::object object;
        object["catalog_id"] = JsonValueConverter<std::string>::toJsonValue(getCatalogId());
        object["items"] = JsonValueConverter<std::vector<std::shared_ptr<AdvancedAuctionKey>>>::toJsonValue(getItems());
    return object;
}

void AdvancedAuctionItemsGetRequest::fromJsonObject_internal(boost::json::object const& object)
{
    {
    ...
    }
    {
        ...
        if (ItemsIt != object.end()) {
            setItems(JsonValueConverter<std::vector<std::shared_ptr<AdvancedAuctionKey>>>::fromJsonValue(ItemsIt->value()));
        }
    }
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AdvancedAuctionItemsGetRequest>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AdvancedAuctionItemsGetRequest>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AdvancedAuctionItemsGetRequest>>>::fromJsonValue(boost::json::parse(json));
}
