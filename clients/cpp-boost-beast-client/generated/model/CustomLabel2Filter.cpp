...
CustomLabel2Filter::CustomLabel2Filter(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value CustomLabel2Filter::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CustomLabel2Filter::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CustomLabel2Filter");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CustomLabel2Filter::toJsonObject_internal() const
{
...
void CustomLabel2Filter::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
std::shared_ptr<CatalogsProductGroupFilterOperatorTypeCriteria> CustomLabel2Filter::getCUSTOMLABEL2() const
{
    return m_CUSTOM_LABEL_2;
}

void CustomLabel2Filter::setCUSTOMLABEL2(std::shared_ptr<CatalogsProductGroupFilterOperatorTypeCriteria> value)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CustomLabel2Filter>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CustomLabel2Filter>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CustomLabel2Filter>>>::fromJsonValue(boost::json::parse(json));
}
