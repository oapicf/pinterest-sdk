...
AssetAccessRequestError::AssetAccessRequestError(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string AssetAccessRequestError::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value AssetAccessRequestError::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AssetAccessRequestError::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AssetAccessRequestError");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AssetAccessRequestError::toJsonObject_internal() const
{
    boost::json::object object;
        ...
        if (m_MessagesIsSet) {
            object["messages"] = JsonValueConverter<std::vector<std::string>>::toJsonValue(getMessages());
        }
    return object;
}

void AssetAccessRequestError::fromJsonObject_internal(boost::json::object const& object)
{
    m_CodeIsSet = false;
    ...
    {
        const auto MessagesIt = object.find("messages");
        if (MessagesIt != object.end()) {
            setMessages(JsonValueConverter<std::vector<std::string>>::fromJsonValue(MessagesIt->value()));
        }
    }
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AssetAccessRequestError>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AssetAccessRequestError>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AssetAccessRequestError>>>::fromJsonValue(boost::json::parse(json));
}
