...
LocalInventoryDeleteOperation::LocalInventoryDeleteOperation(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string LocalInventoryDeleteOperation::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value LocalInventoryDeleteOperation::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void LocalInventoryDeleteOperation::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for LocalInventoryDeleteOperation");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object LocalInventoryDeleteOperation::toJsonObject_internal() const
{
...
void LocalInventoryDeleteOperation::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<LocalInventoryDeleteOperation>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<LocalInventoryDeleteOperation>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<LocalInventoryDeleteOperation>>>::fromJsonValue(boost::json::parse(json));
}
