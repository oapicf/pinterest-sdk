...
CarouselSlot::CarouselSlot(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value CarouselSlot::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CarouselSlot::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CarouselSlot");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CarouselSlot::toJsonObject_internal() const
{
...
void CarouselSlot::fromJsonObject_internal(boost::json::object const& object)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CarouselSlot>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CarouselSlot>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CarouselSlot>>>::fromJsonValue(boost::json::parse(json));
}
