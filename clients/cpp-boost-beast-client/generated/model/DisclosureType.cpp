...
DisclosureType::DisclosureType(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value DisclosureType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void DisclosureType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for DisclosureType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object DisclosureType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void DisclosureType::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<DisclosureType>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<DisclosureType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<DisclosureType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<DisclosureType>>>::fromJsonValue(boost::json::parse(json));
}
