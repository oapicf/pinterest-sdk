...
CatalogsReport::CatalogsReport(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string CatalogsReport::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value CatalogsReport::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogsReport::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogsReport");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogsReport::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_Report_statusIsSet) {
            object["report_status"] = JsonValueConverter<std::string>::toJsonValue(getReportStatus());
        }
        if (m_SizeIsSet) {
...
void CatalogsReport::fromJsonObject_internal(boost::json::object const& object)
{
    ...
    m_UrlIsSet = false;
    {
        ...
        if (Report_statusIt != object.end()) {
            setReportStatus(JsonValueConverter<std::string>::fromJsonValue(Report_statusIt->value()));
        }
    }
    {
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<CatalogsReport>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogsReport>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CatalogsReport>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogsReport>>>::fromJsonValue(boost::json::parse(json));
}
