...
Pinterest_Lib_Status204::Pinterest_Lib_Status204(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value Pinterest_Lib_Status204::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void Pinterest_Lib_Status204::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for Pinterest_Lib_Status204");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object Pinterest_Lib_Status204::toJsonObject_internal() const
{
...
void Pinterest_Lib_Status204::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<Pinterest_Lib_Status204>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<Pinterest_Lib_Status204>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<Pinterest_Lib_Status204>>>::fromJsonValue(boost::json::parse(json));
}
