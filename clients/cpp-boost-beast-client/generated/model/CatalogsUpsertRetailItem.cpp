...
CatalogsUpsertRetailItem::CatalogsUpsertRetailItem(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string CatalogsUpsertRetailItem::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value CatalogsUpsertRetailItem::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogsUpsertRetailItem::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogsUpsertRetailItem");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogsUpsertRetailItem::toJsonObject_internal() const
{
...
void CatalogsUpsertRetailItem::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogsUpsertRetailItem>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CatalogsUpsertRetailItem>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogsUpsertRetailItem>>>::fromJsonValue(boost::json::parse(json));
}
