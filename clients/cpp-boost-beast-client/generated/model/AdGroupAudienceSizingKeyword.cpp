...
AdGroupAudienceSizingKeyword::AdGroupAudienceSizingKeyword(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string AdGroupAudienceSizingKeyword::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value AdGroupAudienceSizingKeyword::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AdGroupAudienceSizingKeyword::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AdGroupAudienceSizingKeyword");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AdGroupAudienceSizingKeyword::toJsonObject_internal() const
{
...
void AdGroupAudienceSizingKeyword::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AdGroupAudienceSizingKeyword>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AdGroupAudienceSizingKeyword>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AdGroupAudienceSizingKeyword>>>::fromJsonValue(boost::json::parse(json));
}
