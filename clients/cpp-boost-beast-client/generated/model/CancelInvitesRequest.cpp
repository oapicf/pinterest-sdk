...
CancelInvitesRequest::CancelInvitesRequest(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string CancelInvitesRequest::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value CancelInvitesRequest::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CancelInvitesRequest::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CancelInvitesRequest");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CancelInvitesRequest::toJsonObject_internal() const
{
    boost::json::object object;
        object["invite_ids"] = JsonValueConverter<std::vector<std::shared_ptr<std::string>>>::toJsonValue(getInviteIds());
    return object;
}

void CancelInvitesRequest::fromJsonObject_internal(boost::json::object const& object)
{
    {
        const auto Invite_idsIt = object.find("invite_ids");
        if (Invite_idsIt != object.end()) {
            setInviteIds(JsonValueConverter<std::vector<std::shared_ptr<std::string>>>::fromJsonValue(Invite_idsIt->value()));
        }
    }
}
...
void CancelInvitesRequest::setInviteIds(std::vector<std::shared_ptr<std::string>> value)
{
    ...
    m_Invite_ids = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<CancelInvitesRequest>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CancelInvitesRequest>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CancelInvitesRequest>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CancelInvitesRequest>>>::fromJsonValue(boost::json::parse(json));
}
