...
PermissionsWithOwner::PermissionsWithOwner(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string PermissionsWithOwner::toJsonString(bool prettyJson /* = false */) const
{
...
void PermissionsWithOwner::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value PermissionsWithOwner::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void PermissionsWithOwner::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for PermissionsWithOwner");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object PermissionsWithOwner::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void PermissionsWithOwner::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<PermissionsWithOwner>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<PermissionsWithOwner>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<PermissionsWithOwner>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<PermissionsWithOwner>>>::fromJsonValue(boost::json::parse(json));
}
