...
UpdatableItemAttributesGtin::UpdatableItemAttributesGtin(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string UpdatableItemAttributesGtin::toJsonString(bool prettyJson /* = false */) const
{
...
void UpdatableItemAttributesGtin::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value UpdatableItemAttributesGtin::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void UpdatableItemAttributesGtin::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for UpdatableItemAttributesGtin");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object UpdatableItemAttributesGtin::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void UpdatableItemAttributesGtin::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<UpdatableItemAttributesGtin>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<UpdatableItemAttributesGtin>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<UpdatableItemAttributesGtin>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<UpdatableItemAttributesGtin>>>::fromJsonValue(boost::json::parse(json));
}
