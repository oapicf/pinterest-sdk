...
ObjectiveType::ObjectiveType(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ObjectiveType::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value ObjectiveType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ObjectiveType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ObjectiveType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ObjectiveType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void ObjectiveType::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<ObjectiveType>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ObjectiveType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ObjectiveType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ObjectiveType>>>::fromJsonValue(boost::json::parse(json));
}
