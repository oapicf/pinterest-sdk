...
DeliveryMetricsResponseItemsItems::DeliveryMetricsResponseItemsItems(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value DeliveryMetricsResponseItemsItems::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void DeliveryMetricsResponseItemsItems::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for DeliveryMetricsResponseItemsItems");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object DeliveryMetricsResponseItemsItems::toJsonObject_internal() const
{
    boost::json::object object;
        ...
        if (m_Display_nameIsSet) {
            object["display_name"] = JsonValueConverter<std::string>::toJsonValue(getDisplayName());
        }
        if (m_NameIsSet) {
...
void DeliveryMetricsResponseItemsItems::fromJsonObject_internal(boost::json::object const& object)
{
    ...
    {
        const auto Display_nameIt = object.find("display_name");
        if (Display_nameIt != object.end()) {
            setDisplayName(JsonValueConverter<std::string>::fromJsonValue(Display_nameIt->value()));
        }
    }
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<DeliveryMetricsResponseItemsItems>>>::toJsonValue(data));
}
...
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<DeliveryMetricsResponseItemsItems>>>::fromJsonValue(boost::json::parse(json));
}
