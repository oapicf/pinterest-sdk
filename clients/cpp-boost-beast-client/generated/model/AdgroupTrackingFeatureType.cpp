...
AdgroupTrackingFeatureType::AdgroupTrackingFeatureType(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value AdgroupTrackingFeatureType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AdgroupTrackingFeatureType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AdgroupTrackingFeatureType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AdgroupTrackingFeatureType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void AdgroupTrackingFeatureType::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<AdgroupTrackingFeatureType>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AdgroupTrackingFeatureType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AdgroupTrackingFeatureType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AdgroupTrackingFeatureType>>>::fromJsonValue(boost::json::parse(json));
}
