...
PinsSaveRequestCreate::PinsSaveRequestCreate(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string PinsSaveRequestCreate::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value PinsSaveRequestCreate::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void PinsSaveRequestCreate::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for PinsSaveRequestCreate");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object PinsSaveRequestCreate::toJsonObject_internal() const
{
...
void PinsSaveRequestCreate::fromJsonObject_internal(boost::json::object const& object)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<PinsSaveRequestCreate>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<PinsSaveRequestCreate>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<PinsSaveRequestCreate>>>::fromJsonValue(boost::json::parse(json));
}
