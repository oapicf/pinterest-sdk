...
CampaignAdPreviewCreate::CampaignAdPreviewCreate(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value CampaignAdPreviewCreate::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CampaignAdPreviewCreate::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CampaignAdPreviewCreate");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CampaignAdPreviewCreate::toJsonObject_internal() const
{
...
void CampaignAdPreviewCreate::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<CampaignAdPreviewCreate>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CampaignAdPreviewCreate>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CampaignAdPreviewCreate>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CampaignAdPreviewCreate>>>::fromJsonValue(boost::json::parse(json));
}
