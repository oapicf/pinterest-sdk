...
ImageMetadata::ImageMetadata(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value ImageMetadata::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ImageMetadata::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ImageMetadata");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ImageMetadata::toJsonObject_internal() const
{
...
void ImageMetadata::fromJsonObject_internal(boost::json::object const& object)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ImageMetadata>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ImageMetadata>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ImageMetadata>>>::fromJsonValue(boost::json::parse(json));
}
