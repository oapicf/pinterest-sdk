...
NonDraftEntityStatus::NonDraftEntityStatus(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string NonDraftEntityStatus::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value NonDraftEntityStatus::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void NonDraftEntityStatus::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for NonDraftEntityStatus");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object NonDraftEntityStatus::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void NonDraftEntityStatus::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<NonDraftEntityStatus>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<NonDraftEntityStatus>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<NonDraftEntityStatus>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<NonDraftEntityStatus>>>::fromJsonValue(boost::json::parse(json));
}
