...
TargetingSpecListOperation::TargetingSpecListOperation(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string TargetingSpecListOperation::toJsonString(bool prettyJson /* = false */) const
{
...
void TargetingSpecListOperation::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value TargetingSpecListOperation::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void TargetingSpecListOperation::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for TargetingSpecListOperation");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object TargetingSpecListOperation::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void TargetingSpecListOperation::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<TargetingSpecListOperation>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<TargetingSpecListOperation>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<TargetingSpecListOperation>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<TargetingSpecListOperation>>>::fromJsonValue(boost::json::parse(json));
}
