...
BulkOutputFormat::BulkOutputFormat(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value BulkOutputFormat::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void BulkOutputFormat::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for BulkOutputFormat");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object BulkOutputFormat::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void BulkOutputFormat::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<BulkOutputFormat>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<BulkOutputFormat>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<BulkOutputFormat>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<BulkOutputFormat>>>::fromJsonValue(boost::json::parse(json));
}
