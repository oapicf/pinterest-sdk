...
MediaType::MediaType(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string MediaType::toJsonString(bool prettyJson /* = false */) const
{
...
void MediaType::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value MediaType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void MediaType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for MediaType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object MediaType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void MediaType::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<MediaType>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<MediaType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<MediaType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<MediaType>>>::fromJsonValue(boost::json::parse(json));
}
