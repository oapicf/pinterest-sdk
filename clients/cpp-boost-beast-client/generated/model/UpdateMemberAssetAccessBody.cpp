...
UpdateMemberAssetAccessBody::UpdateMemberAssetAccessBody(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string UpdateMemberAssetAccessBody::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value UpdateMemberAssetAccessBody::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void UpdateMemberAssetAccessBody::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for UpdateMemberAssetAccessBody");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object UpdateMemberAssetAccessBody::toJsonObject_internal() const
{
    boost::json::object object;
        object["accesses"] = JsonValueConverter<std::vector<std::shared_ptr<UpdateMemberAssetAccessItem>>>::toJsonValue(getAccesses());
    return object;
}

void UpdateMemberAssetAccessBody::fromJsonObject_internal(boost::json::object const& object)
{
    {
        const auto AccessesIt = object.find("accesses");
        if (AccessesIt != object.end()) {
            setAccesses(JsonValueConverter<std::vector<std::shared_ptr<UpdateMemberAssetAccessItem>>>::fromJsonValue(AccessesIt->value()));
        }
    }
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<UpdateMemberAssetAccessBody>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<UpdateMemberAssetAccessBody>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<UpdateMemberAssetAccessBody>>>::fromJsonValue(boost::json::parse(json));
}
