...
PriceFilter::PriceFilter(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value PriceFilter::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void PriceFilter::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for PriceFilter");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object PriceFilter::toJsonObject_internal() const
{
...
void PriceFilter::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<PriceFilter>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<PriceFilter>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<PriceFilter>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<PriceFilter>>>::fromJsonValue(boost::json::parse(json));
}
