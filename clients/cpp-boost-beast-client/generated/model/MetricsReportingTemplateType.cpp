...
MetricsReportingTemplateType::MetricsReportingTemplateType(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string MetricsReportingTemplateType::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value MetricsReportingTemplateType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void MetricsReportingTemplateType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for MetricsReportingTemplateType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object MetricsReportingTemplateType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void MetricsReportingTemplateType::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<MetricsReportingTemplateType>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<MetricsReportingTemplateType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<MetricsReportingTemplateType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<MetricsReportingTemplateType>>>::fromJsonValue(boost::json::parse(json));
}
