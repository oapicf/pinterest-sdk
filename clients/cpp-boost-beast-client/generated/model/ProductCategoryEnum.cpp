...
ProductCategoryEnum::ProductCategoryEnum(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ProductCategoryEnum::toJsonString(bool prettyJson /* = false */) const
{
...
void ProductCategoryEnum::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value ProductCategoryEnum::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ProductCategoryEnum::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ProductCategoryEnum");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ProductCategoryEnum::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void ProductCategoryEnum::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<ProductCategoryEnum>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ProductCategoryEnum>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ProductCategoryEnum>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ProductCategoryEnum>>>::fromJsonValue(boost::json::parse(json));
}
