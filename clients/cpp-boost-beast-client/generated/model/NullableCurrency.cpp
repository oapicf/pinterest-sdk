...
NullableCurrency::NullableCurrency(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string NullableCurrency::toJsonString(bool prettyJson /* = false */) const
{
...
void NullableCurrency::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value NullableCurrency::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void NullableCurrency::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for NullableCurrency");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object NullableCurrency::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void NullableCurrency::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<NullableCurrency>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<NullableCurrency>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<NullableCurrency>>>::fromJsonValue(boost::json::parse(json));
}
