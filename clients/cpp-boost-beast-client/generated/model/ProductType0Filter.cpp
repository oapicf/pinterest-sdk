...
ProductType0Filter::ProductType0Filter(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ProductType0Filter::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value ProductType0Filter::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ProductType0Filter::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ProductType0Filter");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ProductType0Filter::toJsonObject_internal() const
{
...
void ProductType0Filter::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<ProductType0Filter>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ProductType0Filter>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ProductType0Filter>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ProductType0Filter>>>::fromJsonValue(boost::json::parse(json));
}
