...
ReportType::ReportType(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ReportType::toJsonString(bool prettyJson /* = false */) const
{
...
void ReportType::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value ReportType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ReportType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ReportType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ReportType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void ReportType::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ReportType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ReportType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ReportType>>>::fromJsonValue(boost::json::parse(json));
}
