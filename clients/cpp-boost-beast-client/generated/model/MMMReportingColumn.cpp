...
MMMReportingColumn::MMMReportingColumn(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value MMMReportingColumn::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void MMMReportingColumn::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for MMMReportingColumn");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object MMMReportingColumn::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void MMMReportingColumn::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<MMMReportingColumn>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<MMMReportingColumn>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<MMMReportingColumn>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<MMMReportingColumn>>>::fromJsonValue(boost::json::parse(json));
}
