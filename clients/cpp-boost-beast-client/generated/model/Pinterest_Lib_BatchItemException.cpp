...
Pinterest_Lib_BatchItemException::Pinterest_Lib_BatchItemException(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value Pinterest_Lib_BatchItemException::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void Pinterest_Lib_BatchItemException::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for Pinterest_Lib_BatchItemException");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object Pinterest_Lib_BatchItemException::toJsonObject_internal() const
{
...
void Pinterest_Lib_BatchItemException::fromJsonObject_internal(boost::json::object const& object)
{
    m_CodeIsSet = false;
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<Pinterest_Lib_BatchItemException>>>::toJsonValue(data));
}
...
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<Pinterest_Lib_BatchItemException>>>::fromJsonValue(boost::json::parse(json));
}
