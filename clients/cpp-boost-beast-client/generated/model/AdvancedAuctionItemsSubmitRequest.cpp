...
AdvancedAuctionItemsSubmitRequest::AdvancedAuctionItemsSubmitRequest(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value AdvancedAuctionItemsSubmitRequest::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AdvancedAuctionItemsSubmitRequest::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AdvancedAuctionItemsSubmitRequest");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AdvancedAuctionItemsSubmitRequest::toJsonObject_internal() const
{
...
void AdvancedAuctionItemsSubmitRequest::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
void AdvancedAuctionItemsSubmitRequest::setItems(std::vector<std::shared_ptr<AdvancedAuctionItemsSubmitRecord>> value)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AdvancedAuctionItemsSubmitRequest>>>::toJsonValue(data));
}
...
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AdvancedAuctionItemsSubmitRequest>>>::fromJsonValue(boost::json::parse(json));
}
