...
CatalogUpdate::CatalogUpdate(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value CatalogUpdate::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogUpdate::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogUpdate");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogUpdate::toJsonObject_internal() const
{
...
void CatalogUpdate::fromJsonObject_internal(boost::json::object const& object)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogUpdate>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CatalogUpdate>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogUpdate>>>::fromJsonValue(boost::json::parse(json));
}
