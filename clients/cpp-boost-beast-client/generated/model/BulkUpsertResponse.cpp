...
BulkUpsertResponse::BulkUpsertResponse(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string BulkUpsertResponse::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value BulkUpsertResponse::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void BulkUpsertResponse::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for BulkUpsertResponse");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object BulkUpsertResponse::toJsonObject_internal() const
{
...
void BulkUpsertResponse::fromJsonObject_internal(boost::json::object const& object)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<BulkUpsertResponse>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<BulkUpsertResponse>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<BulkUpsertResponse>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<BulkUpsertResponse>>>::fromJsonValue(boost::json::parse(json));
}
