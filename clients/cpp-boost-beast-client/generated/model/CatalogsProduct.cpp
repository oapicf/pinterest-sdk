...
CatalogsProduct::CatalogsProduct(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string CatalogsProduct::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value CatalogsProduct::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogsProduct::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogsProduct");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogsProduct::toJsonObject_internal() const
{
...
void CatalogsProduct::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<CatalogsProduct>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogsProduct>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CatalogsProduct>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogsProduct>>>::fromJsonValue(boost::json::parse(json));
}
