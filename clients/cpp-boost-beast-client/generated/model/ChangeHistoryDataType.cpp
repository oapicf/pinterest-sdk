...
ChangeHistoryDataType::ChangeHistoryDataType(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ChangeHistoryDataType::toJsonString(bool prettyJson /* = false */) const
{
...
void ChangeHistoryDataType::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value ChangeHistoryDataType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ChangeHistoryDataType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ChangeHistoryDataType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ChangeHistoryDataType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void ChangeHistoryDataType::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<ChangeHistoryDataType>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ChangeHistoryDataType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ChangeHistoryDataType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ChangeHistoryDataType>>>::fromJsonValue(boost::json::parse(json));
}
