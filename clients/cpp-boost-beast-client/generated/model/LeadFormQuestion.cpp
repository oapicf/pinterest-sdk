...
LeadFormQuestion::LeadFormQuestion(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value LeadFormQuestion::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void LeadFormQuestion::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for LeadFormQuestion");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object LeadFormQuestion::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_Custom_question_field_typeIsSet) {
            object["custom_question_field_type"] = JsonValueConverter<std::shared_ptr<LeadFormQuestionFieldType>>::toJsonValue(getCustomQuestionFieldType());
        }
        if (m_Custom_question_labelIsSet) {
            object["custom_question_label"] = JsonValueConverter<std::string>::toJsonValue(getCustomQuestionLabel());
        }
        if (m_Custom_question_optionsIsSet) {
            object["custom_question_options"] = JsonValueConverter<std::vector<std::string>>::toJsonValue(getCustomQuestionOptions());
        }
        if (m_Question_typeIsSet) {
            object["question_type"] = JsonValueConverter<std::shared_ptr<LeadFormQuestionType>>::toJsonValue(getQuestionType());
        }
    return object;
}

void LeadFormQuestion::fromJsonObject_internal(boost::json::object const& object)
{
    ...
    {
        const auto Custom_question_field_typeIt = object.find("custom_question_field_type");
        if (Custom_question_field_typeIt != object.end()) {
            setCustomQuestionFieldType(JsonValueConverter<std::shared_ptr<LeadFormQuestionFieldType>>::fromJsonValue(Custom_question_field_typeIt->value()));
        }
    }
    {
        const auto Custom_question_labelIt = object.find("custom_question_label");
        if (Custom_question_labelIt != object.end()) {
            setCustomQuestionLabel(JsonValueConverter<std::string>::fromJsonValue(Custom_question_labelIt->value()));
        }
    }
    {
        const auto Custom_question_optionsIt = object.find("custom_question_options");
        if (Custom_question_optionsIt != object.end()) {
            setCustomQuestionOptions(JsonValueConverter<std::vector<std::string>>::fromJsonValue(Custom_question_optionsIt->value()));
        }
    }
    {
        const auto Question_typeIt = object.find("question_type");
        if (Question_typeIt != object.end()) {
            setQuestionType(JsonValueConverter<std::shared_ptr<LeadFormQuestionType>>::fromJsonValue(Question_typeIt->value()));
        }
    }
}
...
void LeadFormQuestion::setCustomQuestionFieldType(std::shared_ptr<LeadFormQuestionFieldType> value)
{
    ...
    m_Custom_question_field_type = std::move(value);
...
void LeadFormQuestion::setCustomQuestionLabel(std::string value)
{
    ...
    m_Custom_question_label = std::move(value);
...
void LeadFormQuestion::setCustomQuestionOptions(std::vector<std::string> value)
{
    ...
    m_Custom_question_options = std::move(value);
...
void LeadFormQuestion::setQuestionType(std::shared_ptr<LeadFormQuestionType> value)
{
    ...
    m_Question_type = std::move(value);
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<LeadFormQuestion>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<LeadFormQuestion>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<LeadFormQuestion>>>::fromJsonValue(boost::json::parse(json));
}
