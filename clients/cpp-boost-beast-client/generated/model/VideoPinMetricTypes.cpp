...
VideoPinMetricTypes::VideoPinMetricTypes(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string VideoPinMetricTypes::toJsonString(bool prettyJson /* = false */) const
{
...
void VideoPinMetricTypes::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value VideoPinMetricTypes::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void VideoPinMetricTypes::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for VideoPinMetricTypes");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object VideoPinMetricTypes::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void VideoPinMetricTypes::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<VideoPinMetricTypes>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<VideoPinMetricTypes>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<VideoPinMetricTypes>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<VideoPinMetricTypes>>>::fromJsonValue(boost::json::parse(json));
}
