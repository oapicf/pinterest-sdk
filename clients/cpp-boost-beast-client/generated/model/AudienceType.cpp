...
AudienceType::AudienceType(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string AudienceType::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value AudienceType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AudienceType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AudienceType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AudienceType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void AudienceType::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AudienceType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AudienceType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AudienceType>>>::fromJsonValue(boost::json::parse(json));
}
