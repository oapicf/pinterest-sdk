...
PinMediaSourceImagesURL::PinMediaSourceImagesURL(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value PinMediaSourceImagesURL::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void PinMediaSourceImagesURL::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for PinMediaSourceImagesURL");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object PinMediaSourceImagesURL::toJsonObject_internal() const
{
...
void PinMediaSourceImagesURL::fromJsonObject_internal(boost::json::object const& object)
{
    m_IndexIsSet = false;
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<PinMediaSourceImagesURL>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<PinMediaSourceImagesURL>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<PinMediaSourceImagesURL>>>::fromJsonValue(boost::json::parse(json));
}
