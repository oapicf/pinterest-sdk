...
TargetingSpecOperationAudienceExclude::TargetingSpecOperationAudienceExclude(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string TargetingSpecOperationAudienceExclude::toJsonString(bool prettyJson /* = false */) const
{
...
void TargetingSpecOperationAudienceExclude::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value TargetingSpecOperationAudienceExclude::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void TargetingSpecOperationAudienceExclude::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for TargetingSpecOperationAudienceExclude");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object TargetingSpecOperationAudienceExclude::toJsonObject_internal() const
{
...
void TargetingSpecOperationAudienceExclude::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
void TargetingSpecOperationAudienceExclude::setField(std::string value)
{
...
void TargetingSpecOperationAudienceExclude::setOperation(std::shared_ptr<TargetingSpecListOperation> value)
{
...
void TargetingSpecOperationAudienceExclude::setValues(std::vector<std::string> value)
{
    
    m_Values = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<TargetingSpecOperationAudienceExclude>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<TargetingSpecOperationAudienceExclude>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<TargetingSpecOperationAudienceExclude>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<TargetingSpecOperationAudienceExclude>>>::fromJsonValue(boost::json::parse(json));
}
