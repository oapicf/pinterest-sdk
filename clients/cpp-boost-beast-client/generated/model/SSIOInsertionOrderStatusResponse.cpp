...
SSIOInsertionOrderStatusResponse::SSIOInsertionOrderStatusResponse(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string SSIOInsertionOrderStatusResponse::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value SSIOInsertionOrderStatusResponse::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void SSIOInsertionOrderStatusResponse::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for SSIOInsertionOrderStatusResponse");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object SSIOInsertionOrderStatusResponse::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_Creation_timeIsSet) {
            object["creation_time"] = JsonValueConverter<std::string>::toJsonValue(getCreationTime());
        }
...
void SSIOInsertionOrderStatusResponse::fromJsonObject_internal(boost::json::object const& object)
{
    ...
    m_StatusIsSet = false;
    {
        ...
        if (Creation_timeIt != object.end()) {
            setCreationTime(JsonValueConverter<std::string>::fromJsonValue(Creation_timeIt->value()));
        }
    }
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<SSIOInsertionOrderStatusResponse>>>::toJsonValue(data));
}
...
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<SSIOInsertionOrderStatusResponse>>>::fromJsonValue(boost::json::parse(json));
}
