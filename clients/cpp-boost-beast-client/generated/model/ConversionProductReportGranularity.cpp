...
ConversionProductReportGranularity::ConversionProductReportGranularity(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ConversionProductReportGranularity::toJsonString(bool prettyJson /* = false */) const
{
...
void ConversionProductReportGranularity::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value ConversionProductReportGranularity::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ConversionProductReportGranularity::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ConversionProductReportGranularity");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ConversionProductReportGranularity::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void ConversionProductReportGranularity::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ConversionProductReportGranularity>>>::toJsonValue(data));
}
...
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ConversionProductReportGranularity>>>::fromJsonValue(boost::json::parse(json));
}
