...
InterestsEnum::InterestsEnum(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string InterestsEnum::toJsonString(bool prettyJson /* = false */) const
{
...
void InterestsEnum::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value InterestsEnum::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void InterestsEnum::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for InterestsEnum");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object InterestsEnum::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void InterestsEnum::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<InterestsEnum>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<InterestsEnum>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<InterestsEnum>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<InterestsEnum>>>::fromJsonValue(boost::json::parse(json));
}
