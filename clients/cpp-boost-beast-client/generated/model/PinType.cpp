...
PinType::PinType(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string PinType::toJsonString(bool prettyJson /* = false */) const
{
...
void PinType::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value PinType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void PinType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for PinType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object PinType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void PinType::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<PinType>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<PinType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<PinType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<PinType>>>::fromJsonValue(boost::json::parse(json));
}
