...
CatalogsItemsBatchRequest::CatalogsItemsBatchRequest(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value CatalogsItemsBatchRequest::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogsItemsBatchRequest::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogsItemsBatchRequest");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogsItemsBatchRequest::toJsonObject_internal() const
{
...
void CatalogsItemsBatchRequest::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
std::vector<std::shared_ptr<ItemDeleteBatchRecord>> CatalogsItemsBatchRequest::getItems() const
{
    return m_Items;
}

void CatalogsItemsBatchRequest::setItems(std::vector<std::shared_ptr<ItemDeleteBatchRecord>> value)
{
...
void CatalogsItemsBatchRequest::setOperation(std::string value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<CatalogsItemsBatchRequest>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogsItemsBatchRequest>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CatalogsItemsBatchRequest>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogsItemsBatchRequest>>>::fromJsonValue(boost::json::parse(json));
}
