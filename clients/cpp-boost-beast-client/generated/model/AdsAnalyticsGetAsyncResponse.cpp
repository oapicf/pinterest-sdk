...
AdsAnalyticsGetAsyncResponse::AdsAnalyticsGetAsyncResponse(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value AdsAnalyticsGetAsyncResponse::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AdsAnalyticsGetAsyncResponse::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AdsAnalyticsGetAsyncResponse");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AdsAnalyticsGetAsyncResponse::toJsonObject_internal() const
{
...
void AdsAnalyticsGetAsyncResponse::fromJsonObject_internal(boost::json::object const& object)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<AdsAnalyticsGetAsyncResponse>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AdsAnalyticsGetAsyncResponse>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AdsAnalyticsGetAsyncResponse>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AdsAnalyticsGetAsyncResponse>>>::fromJsonValue(boost::json::parse(json));
}
