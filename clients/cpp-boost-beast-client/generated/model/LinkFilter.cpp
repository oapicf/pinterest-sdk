...
LinkFilter::LinkFilter(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string LinkFilter::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value LinkFilter::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void LinkFilter::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for LinkFilter");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object LinkFilter::toJsonObject_internal() const
{
...
void LinkFilter::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<LinkFilter>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<LinkFilter>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<LinkFilter>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<LinkFilter>>>::fromJsonValue(boost::json::parse(json));
}
