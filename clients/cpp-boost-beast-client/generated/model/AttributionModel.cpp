...
AttributionModel::AttributionModel(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string AttributionModel::toJsonString(bool prettyJson /* = false */) const
{
...
void AttributionModel::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value AttributionModel::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AttributionModel::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AttributionModel");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AttributionModel::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void AttributionModel::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AttributionModel>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AttributionModel>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AttributionModel>>>::fromJsonValue(boost::json::parse(json));
}
