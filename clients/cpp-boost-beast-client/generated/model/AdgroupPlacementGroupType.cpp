...
AdgroupPlacementGroupType::AdgroupPlacementGroupType(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string AdgroupPlacementGroupType::toJsonString(bool prettyJson /* = false */) const
{
...
void AdgroupPlacementGroupType::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value AdgroupPlacementGroupType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AdgroupPlacementGroupType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AdgroupPlacementGroupType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AdgroupPlacementGroupType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void AdgroupPlacementGroupType::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AdgroupPlacementGroupType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AdgroupPlacementGroupType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AdgroupPlacementGroupType>>>::fromJsonValue(boost::json::parse(json));
}
