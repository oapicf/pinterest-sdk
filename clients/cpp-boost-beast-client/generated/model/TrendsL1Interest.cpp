...
TrendsL1Interest::TrendsL1Interest(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value TrendsL1Interest::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void TrendsL1Interest::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for TrendsL1Interest");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object TrendsL1Interest::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void TrendsL1Interest::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<TrendsL1Interest>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<TrendsL1Interest>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<TrendsL1Interest>>>::fromJsonValue(boost::json::parse(json));
}
