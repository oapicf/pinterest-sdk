...
VerticalProductCategory::VerticalProductCategory(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string VerticalProductCategory::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value VerticalProductCategory::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void VerticalProductCategory::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for VerticalProductCategory");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object VerticalProductCategory::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void VerticalProductCategory::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<VerticalProductCategory>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<VerticalProductCategory>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<VerticalProductCategory>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<VerticalProductCategory>>>::fromJsonValue(boost::json::parse(json));
}
