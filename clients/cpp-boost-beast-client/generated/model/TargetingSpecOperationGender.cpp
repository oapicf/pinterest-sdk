...
TargetingSpecOperationGender::TargetingSpecOperationGender(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value TargetingSpecOperationGender::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void TargetingSpecOperationGender::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for TargetingSpecOperationGender");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object TargetingSpecOperationGender::toJsonObject_internal() const
{
    boost::json::object object;
        ...
        object["values"] = JsonValueConverter<std::vector<std::shared_ptr<TargetingSpecGender>>>::toJsonValue(getValues());
    return object;
}

void TargetingSpecOperationGender::fromJsonObject_internal(boost::json::object const& object)
{
    {
    ...
    }
    {
        ...
        if (ValuesIt != object.end()) {
            setValues(JsonValueConverter<std::vector<std::shared_ptr<TargetingSpecGender>>>::fromJsonValue(ValuesIt->value()));
        }
    }
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<TargetingSpecOperationGender>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<TargetingSpecOperationGender>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<TargetingSpecOperationGender>>>::fromJsonValue(boost::json::parse(json));
}
