...
CatalogsRetailProductMetadata::CatalogsRetailProductMetadata(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value CatalogsRetailProductMetadata::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogsRetailProductMetadata::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogsRetailProductMetadata");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogsRetailProductMetadata::toJsonObject_internal() const
{
    boost::json::object object;
        object["availability"] = JsonValueConverter<std::shared_ptr<ProductAvailability>>::toJsonValue(getAvailability());
        ...
        object["price"] = JsonValueConverter<double>::toJsonValue(getPrice());
        object["sale_price"] = JsonValueConverter<double>::toJsonValue(getSalePrice());
    return object;
}

void CatalogsRetailProductMetadata::fromJsonObject_internal(boost::json::object const& object)
{
    {
        const auto AvailabilityIt = object.find("availability");
        if (AvailabilityIt != object.end()) {
            setAvailability(JsonValueConverter<std::shared_ptr<ProductAvailability>>::fromJsonValue(AvailabilityIt->value()));
        }
    }
    {
    ...
    }
    {
        ...
        if (PriceIt != object.end()) {
            setPrice(JsonValueConverter<double>::fromJsonValue(PriceIt->value()));
        }
    }
    {
        const auto Sale_priceIt = object.find("sale_price");
        if (Sale_priceIt != object.end()) {
            setSalePrice(JsonValueConverter<double>::fromJsonValue(Sale_priceIt->value()));
        }
    }
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogsRetailProductMetadata>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CatalogsRetailProductMetadata>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogsRetailProductMetadata>>>::fromJsonValue(boost::json::parse(json));
}
