...
CreateInvitesResultsResponseArray::CreateInvitesResultsResponseArray(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string CreateInvitesResultsResponseArray::toJsonString(bool prettyJson /* = false */) const
{
...
void CreateInvitesResultsResponseArray::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value CreateInvitesResultsResponseArray::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CreateInvitesResultsResponseArray::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CreateInvitesResultsResponseArray");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CreateInvitesResultsResponseArray::toJsonObject_internal() const
{
...
void CreateInvitesResultsResponseArray::fromJsonObject_internal(boost::json::object const& object)
{
    m_ItemsIsSet = false;
    {
...
void CreateInvitesResultsResponseArray::setItems(std::vector<std::shared_ptr<InviteActionResultItem>> value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<CreateInvitesResultsResponseArray>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CreateInvitesResultsResponseArray>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CreateInvitesResultsResponseArray>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CreateInvitesResultsResponseArray>>>::fromJsonValue(boost::json::parse(json));
}
