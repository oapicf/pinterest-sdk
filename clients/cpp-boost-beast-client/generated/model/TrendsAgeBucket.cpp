...
TrendsAgeBucket::TrendsAgeBucket(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string TrendsAgeBucket::toJsonString(bool prettyJson /* = false */) const
{
...
void TrendsAgeBucket::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value TrendsAgeBucket::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void TrendsAgeBucket::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for TrendsAgeBucket");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object TrendsAgeBucket::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void TrendsAgeBucket::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<TrendsAgeBucket>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<TrendsAgeBucket>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<TrendsAgeBucket>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<TrendsAgeBucket>>>::fromJsonValue(boost::json::parse(json));
}
