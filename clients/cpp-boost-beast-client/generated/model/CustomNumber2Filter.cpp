...
CustomNumber2Filter::CustomNumber2Filter(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string CustomNumber2Filter::toJsonString(bool prettyJson /* = false */) const
{
...
void CustomNumber2Filter::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value CustomNumber2Filter::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CustomNumber2Filter::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CustomNumber2Filter");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CustomNumber2Filter::toJsonObject_internal() const
{
...
void CustomNumber2Filter::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
std::shared_ptr<CatalogsProductGroupUint32Criteria> CustomNumber2Filter::getCUSTOMNUMBER2() const
{
    return m_CUSTOM_NUMBER_2;
}

void CustomNumber2Filter::setCUSTOMNUMBER2(std::shared_ptr<CatalogsProductGroupUint32Criteria> value)
{
    
    m_CUSTOM_NUMBER_2 = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<CustomNumber2Filter>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CustomNumber2Filter>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CustomNumber2Filter>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CustomNumber2Filter>>>::fromJsonValue(boost::json::parse(json));
}
