...
CampaignAudienceMultipliers::CampaignAudienceMultipliers(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string CampaignAudienceMultipliers::toJsonString(bool prettyJson /* = false */) const
{
...
void CampaignAudienceMultipliers::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value CampaignAudienceMultipliers::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CampaignAudienceMultipliers::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CampaignAudienceMultipliers");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CampaignAudienceMultipliers::toJsonObject_internal() const
{
...
void CampaignAudienceMultipliers::fromJsonObject_internal(boost::json::object const& object)
{
...
void CampaignAudienceMultipliers::setAUDIENCEID(std::string value)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CampaignAudienceMultipliers>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CampaignAudienceMultipliers>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CampaignAudienceMultipliers>>>::fromJsonValue(boost::json::parse(json));
}
