...
AdsAnalyticsAdTargetingType::AdsAnalyticsAdTargetingType(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value AdsAnalyticsAdTargetingType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AdsAnalyticsAdTargetingType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AdsAnalyticsAdTargetingType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AdsAnalyticsAdTargetingType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void AdsAnalyticsAdTargetingType::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<AdsAnalyticsAdTargetingType>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AdsAnalyticsAdTargetingType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AdsAnalyticsAdTargetingType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AdsAnalyticsAdTargetingType>>>::fromJsonValue(boost::json::parse(json));
}
