...
UpdateInvitesResultsResponseArray::UpdateInvitesResultsResponseArray(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string UpdateInvitesResultsResponseArray::toJsonString(bool prettyJson /* = false */) const
{
...
void UpdateInvitesResultsResponseArray::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value UpdateInvitesResultsResponseArray::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void UpdateInvitesResultsResponseArray::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for UpdateInvitesResultsResponseArray");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object UpdateInvitesResultsResponseArray::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_ItemsIsSet) {
            object["items"] = JsonValueConverter<std::vector<std::shared_ptr<InviteActionResultItem>>>::toJsonValue(getItems());
        }
    return object;
}

void UpdateInvitesResultsResponseArray::fromJsonObject_internal(boost::json::object const& object)
{
    m_ItemsIsSet = false;
    {
        const auto ItemsIt = object.find("items");
        if (ItemsIt != object.end()) {
            setItems(JsonValueConverter<std::vector<std::shared_ptr<InviteActionResultItem>>>::fromJsonValue(ItemsIt->value()));
        }
    }
}

std::vector<std::shared_ptr<InviteActionResultItem>> UpdateInvitesResultsResponseArray::getItems() const
{
    return m_Items;
}

void UpdateInvitesResultsResponseArray::setItems(std::vector<std::shared_ptr<InviteActionResultItem>> value)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<UpdateInvitesResultsResponseArray>>>::toJsonValue(data));
}
...
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<UpdateInvitesResultsResponseArray>>>::fromJsonValue(boost::json::parse(json));
}
