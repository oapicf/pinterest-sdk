...
DataStatus::DataStatus(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value DataStatus::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void DataStatus::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for DataStatus");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object DataStatus::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void DataStatus::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<DataStatus>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<DataStatus>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<DataStatus>>>::fromJsonValue(boost::json::parse(json));
}
