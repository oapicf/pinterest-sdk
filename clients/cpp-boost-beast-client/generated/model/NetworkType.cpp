...
NetworkType::NetworkType(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value NetworkType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void NetworkType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for NetworkType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object NetworkType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void NetworkType::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<NetworkType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<NetworkType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<NetworkType>>>::fromJsonValue(boost::json::parse(json));
}
