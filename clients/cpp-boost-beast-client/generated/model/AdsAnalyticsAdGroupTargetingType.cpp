...
AdsAnalyticsAdGroupTargetingType::AdsAnalyticsAdGroupTargetingType(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string AdsAnalyticsAdGroupTargetingType::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value AdsAnalyticsAdGroupTargetingType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AdsAnalyticsAdGroupTargetingType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AdsAnalyticsAdGroupTargetingType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AdsAnalyticsAdGroupTargetingType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void AdsAnalyticsAdGroupTargetingType::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<AdsAnalyticsAdGroupTargetingType>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AdsAnalyticsAdGroupTargetingType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AdsAnalyticsAdGroupTargetingType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AdsAnalyticsAdGroupTargetingType>>>::fromJsonValue(boost::json::parse(json));
}
