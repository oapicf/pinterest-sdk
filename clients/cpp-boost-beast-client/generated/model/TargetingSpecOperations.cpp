...
TargetingSpecOperations::TargetingSpecOperations(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string TargetingSpecOperations::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value TargetingSpecOperations::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void TargetingSpecOperations::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for TargetingSpecOperations");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object TargetingSpecOperations::toJsonObject_internal() const
{
...
void TargetingSpecOperations::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<TargetingSpecOperations>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<TargetingSpecOperations>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<TargetingSpecOperations>>>::fromJsonValue(boost::json::parse(json));
}
