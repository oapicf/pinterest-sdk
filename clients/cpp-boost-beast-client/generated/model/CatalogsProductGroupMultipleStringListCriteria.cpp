...
CatalogsProductGroupMultipleStringListCriteria::CatalogsProductGroupMultipleStringListCriteria(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string CatalogsProductGroupMultipleStringListCriteria::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value CatalogsProductGroupMultipleStringListCriteria::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogsProductGroupMultipleStringListCriteria::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogsProductGroupMultipleStringListCriteria");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogsProductGroupMultipleStringListCriteria::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_NegatedIsSet) {
            object["negated"] = JsonValueConverter<bool>::toJsonValue(isNegated());
        }
        object["values"] = JsonValueConverter<std::vector<std::shared_ptr<std::vector>>>::toJsonValue(getValues());
    return object;
}

void CatalogsProductGroupMultipleStringListCriteria::fromJsonObject_internal(boost::json::object const& object)
{
    ...
    }
    {
        ...
        if (ValuesIt != object.end()) {
            setValues(JsonValueConverter<std::vector<std::shared_ptr<std::vector>>>::fromJsonValue(ValuesIt->value()));
        }
    }
}
...
std::vector<std::shared_ptr<std::vector>> CatalogsProductGroupMultipleStringListCriteria::getValues() const
{
    return m_Values;
}

void CatalogsProductGroupMultipleStringListCriteria::setValues(std::vector<std::shared_ptr<std::vector>> value)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogsProductGroupMultipleStringListCriteria>>>::toJsonValue(data));
}
...
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogsProductGroupMultipleStringListCriteria>>>::fromJsonValue(boost::json::parse(json));
}
