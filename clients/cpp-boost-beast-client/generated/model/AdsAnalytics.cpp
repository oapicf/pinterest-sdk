...
AdsAnalytics::AdsAnalytics(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string AdsAnalytics::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value AdsAnalytics::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AdsAnalytics::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AdsAnalytics");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AdsAnalytics::toJsonObject_internal() const
{
...
void AdsAnalytics::fromJsonObject_internal(boost::json::object const& object)
{
    m_DATEIsSet = false;
    {
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<AdsAnalytics>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AdsAnalytics>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AdsAnalytics>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AdsAnalytics>>>::fromJsonValue(boost::json::parse(json));
}
