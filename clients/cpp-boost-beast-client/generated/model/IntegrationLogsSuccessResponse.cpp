...
IntegrationLogsSuccessResponse::IntegrationLogsSuccessResponse(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string IntegrationLogsSuccessResponse::toJsonString(bool prettyJson /* = false */) const
{
...
void IntegrationLogsSuccessResponse::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value IntegrationLogsSuccessResponse::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void IntegrationLogsSuccessResponse::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for IntegrationLogsSuccessResponse");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object IntegrationLogsSuccessResponse::toJsonObject_internal() const
{
...
void IntegrationLogsSuccessResponse::fromJsonObject_internal(boost::json::object const& object)
{
...
void IntegrationLogsSuccessResponse::setMessage(std::string value)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<IntegrationLogsSuccessResponse>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<IntegrationLogsSuccessResponse>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<IntegrationLogsSuccessResponse>>>::fromJsonValue(boost::json::parse(json));
}
