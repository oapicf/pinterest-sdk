...
IntendedPromotionType::IntendedPromotionType(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string IntendedPromotionType::toJsonString(bool prettyJson /* = false */) const
{
...
void IntendedPromotionType::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value IntendedPromotionType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void IntendedPromotionType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for IntendedPromotionType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object IntendedPromotionType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void IntendedPromotionType::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<IntendedPromotionType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<IntendedPromotionType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<IntendedPromotionType>>>::fromJsonValue(boost::json::parse(json));
}
