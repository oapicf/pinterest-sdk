...
BusinessRoleForMembers::BusinessRoleForMembers(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string BusinessRoleForMembers::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value BusinessRoleForMembers::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void BusinessRoleForMembers::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for BusinessRoleForMembers");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object BusinessRoleForMembers::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void BusinessRoleForMembers::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<BusinessRoleForMembers>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<BusinessRoleForMembers>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<BusinessRoleForMembers>>>::fromJsonValue(boost::json::parse(json));
}
