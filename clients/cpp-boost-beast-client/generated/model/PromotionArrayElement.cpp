...
PromotionArrayElement::PromotionArrayElement(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value PromotionArrayElement::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void PromotionArrayElement::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for PromotionArrayElement");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object PromotionArrayElement::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_DataIsSet) {
            object["data"] = JsonValueConverter<std::shared_ptr<Promotion>>::toJsonValue(getData());
        }
        if (m_ExceptionIsSet) {
            object["exception"] = JsonValueConverter<std::shared_ptr<Exception>>::toJsonValue(getException());
        }
    return object;
}

void PromotionArrayElement::fromJsonObject_internal(boost::json::object const& object)
{
    m_DataIsSet = false;
    m_ExceptionIsSet = false;
    {
        ...
        if (DataIt != object.end()) {
            setData(JsonValueConverter<std::shared_ptr<Promotion>>::fromJsonValue(DataIt->value()));
        }
    }
    {
        const auto ExceptionIt = object.find("exception");
        if (ExceptionIt != object.end()) {
            setException(JsonValueConverter<std::shared_ptr<Exception>>::fromJsonValue(ExceptionIt->value()));
        }
    }
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<PromotionArrayElement>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<PromotionArrayElement>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<PromotionArrayElement>>>::fromJsonValue(boost::json::parse(json));
}
