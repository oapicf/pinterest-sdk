...
AssetGroupInput::AssetGroupInput(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string AssetGroupInput::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value AssetGroupInput::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AssetGroupInput::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AssetGroupInput");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AssetGroupInput::toJsonObject_internal() const
{
...
void AssetGroupInput::fromJsonObject_internal(boost::json::object const& object)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AssetGroupInput>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AssetGroupInput>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AssetGroupInput>>>::fromJsonValue(boost::json::parse(json));
}
