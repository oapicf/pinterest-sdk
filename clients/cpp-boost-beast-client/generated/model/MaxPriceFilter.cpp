...
MaxPriceFilter::MaxPriceFilter(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string MaxPriceFilter::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value MaxPriceFilter::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void MaxPriceFilter::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for MaxPriceFilter");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object MaxPriceFilter::toJsonObject_internal() const
{
...
void MaxPriceFilter::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<MaxPriceFilter>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<MaxPriceFilter>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<MaxPriceFilter>>>::fromJsonValue(boost::json::parse(json));
}
