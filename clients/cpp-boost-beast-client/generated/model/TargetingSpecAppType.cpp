...
TargetingSpecAppType::TargetingSpecAppType(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value TargetingSpecAppType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void TargetingSpecAppType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for TargetingSpecAppType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object TargetingSpecAppType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void TargetingSpecAppType::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<TargetingSpecAppType>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<TargetingSpecAppType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<TargetingSpecAppType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<TargetingSpecAppType>>>::fromJsonValue(boost::json::parse(json));
}
