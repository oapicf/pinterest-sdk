...
TemplateBasedReportCreate::TemplateBasedReportCreate(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value TemplateBasedReportCreate::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void TemplateBasedReportCreate::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for TemplateBasedReportCreate");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object TemplateBasedReportCreate::toJsonObject_internal() const
{
...
void TemplateBasedReportCreate::fromJsonObject_internal(boost::json::object const& object)
{
...
void TemplateBasedReportCreate::setReportStatus(std::shared_ptr<BulkReportingJobStatus> value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<TemplateBasedReportCreate>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<TemplateBasedReportCreate>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<TemplateBasedReportCreate>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<TemplateBasedReportCreate>>>::fromJsonValue(boost::json::parse(json));
}
