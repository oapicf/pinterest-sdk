...
ConversionAttributionWindowDays::ConversionAttributionWindowDays(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value ConversionAttributionWindowDays::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ConversionAttributionWindowDays::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ConversionAttributionWindowDays");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ConversionAttributionWindowDays::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void ConversionAttributionWindowDays::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ConversionAttributionWindowDays>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ConversionAttributionWindowDays>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ConversionAttributionWindowDays>>>::fromJsonValue(boost::json::parse(json));
}
