...
CatalogsListProductsByFeedBasedFilter::CatalogsListProductsByFeedBasedFilter(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value CatalogsListProductsByFeedBasedFilter::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogsListProductsByFeedBasedFilter::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogsListProductsByFeedBasedFilter");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogsListProductsByFeedBasedFilter::toJsonObject_internal() const
{
...
void CatalogsListProductsByFeedBasedFilter::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogsListProductsByFeedBasedFilter>>>::toJsonValue(data));
}
...
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogsListProductsByFeedBasedFilter>>>::fromJsonValue(boost::json::parse(json));
}
