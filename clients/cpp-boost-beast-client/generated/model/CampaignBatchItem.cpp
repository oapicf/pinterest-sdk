...
CampaignBatchItem::CampaignBatchItem(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value CampaignBatchItem::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CampaignBatchItem::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CampaignBatchItem");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CampaignBatchItem::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_DataIsSet) {
            object["data"] = JsonValueConverter<std::shared_ptr<CampaignBatchResponseData>>::toJsonValue(getData());
        }
...
void CampaignBatchItem::fromJsonObject_internal(boost::json::object const& object)
{
    m_DataIsSet = false;
    m_ExceptionsIsSet = false;
    {
        ...
        if (DataIt != object.end()) {
            setData(JsonValueConverter<std::shared_ptr<CampaignBatchResponseData>>::fromJsonValue(DataIt->value()));
        }
    }
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CampaignBatchItem>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CampaignBatchItem>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CampaignBatchItem>>>::fromJsonValue(boost::json::parse(json));
}
