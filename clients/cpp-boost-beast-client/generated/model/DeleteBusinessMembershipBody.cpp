...
DeleteBusinessMembershipBody::DeleteBusinessMembershipBody(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string DeleteBusinessMembershipBody::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value DeleteBusinessMembershipBody::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void DeleteBusinessMembershipBody::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for DeleteBusinessMembershipBody");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object DeleteBusinessMembershipBody::toJsonObject_internal() const
{
    boost::json::object object;
        object["members"] = JsonValueConverter<std::vector<std::shared_ptr<DeleteBusinessMembershipMember>>>::toJsonValue(getMembers());
    return object;
}

void DeleteBusinessMembershipBody::fromJsonObject_internal(boost::json::object const& object)
{
    {
        const auto MembersIt = object.find("members");
        if (MembersIt != object.end()) {
            setMembers(JsonValueConverter<std::vector<std::shared_ptr<DeleteBusinessMembershipMember>>>::fromJsonValue(MembersIt->value()));
        }
    }
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<DeleteBusinessMembershipBody>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<DeleteBusinessMembershipBody>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<DeleteBusinessMembershipBody>>>::fromJsonValue(boost::json::parse(json));
}
