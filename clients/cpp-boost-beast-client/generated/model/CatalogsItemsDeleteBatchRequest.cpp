...
CatalogsItemsDeleteBatchRequest::CatalogsItemsDeleteBatchRequest(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value CatalogsItemsDeleteBatchRequest::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogsItemsDeleteBatchRequest::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogsItemsDeleteBatchRequest");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogsItemsDeleteBatchRequest::toJsonObject_internal() const
{
...
void CatalogsItemsDeleteBatchRequest::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
void CatalogsItemsDeleteBatchRequest::setCountry(std::shared_ptr<Country> value)
{
...
void CatalogsItemsDeleteBatchRequest::setItems(std::vector<std::shared_ptr<ItemDeleteBatchRecord>> value)
{
...
void CatalogsItemsDeleteBatchRequest::setOperation(std::string value)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogsItemsDeleteBatchRequest>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CatalogsItemsDeleteBatchRequest>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogsItemsDeleteBatchRequest>>>::fromJsonValue(boost::json::parse(json));
}
