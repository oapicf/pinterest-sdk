...
ConversionProductReportBreakdownType::ConversionProductReportBreakdownType(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value ConversionProductReportBreakdownType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ConversionProductReportBreakdownType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ConversionProductReportBreakdownType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ConversionProductReportBreakdownType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void ConversionProductReportBreakdownType::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<ConversionProductReportBreakdownType>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ConversionProductReportBreakdownType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ConversionProductReportBreakdownType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ConversionProductReportBreakdownType>>>::fromJsonValue(boost::json::parse(json));
}
