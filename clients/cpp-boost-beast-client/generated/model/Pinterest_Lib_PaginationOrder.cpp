...
Pinterest_Lib_PaginationOrder::Pinterest_Lib_PaginationOrder(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value Pinterest_Lib_PaginationOrder::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void Pinterest_Lib_PaginationOrder::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for Pinterest_Lib_PaginationOrder");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object Pinterest_Lib_PaginationOrder::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void Pinterest_Lib_PaginationOrder::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<Pinterest_Lib_PaginationOrder>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<Pinterest_Lib_PaginationOrder>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<Pinterest_Lib_PaginationOrder>>>::fromJsonValue(boost::json::parse(json));
}
