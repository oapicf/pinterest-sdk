...
AdShoppingPreviewCreativeType::AdShoppingPreviewCreativeType(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string AdShoppingPreviewCreativeType::toJsonString(bool prettyJson /* = false */) const
{
...
void AdShoppingPreviewCreativeType::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value AdShoppingPreviewCreativeType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AdShoppingPreviewCreativeType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AdShoppingPreviewCreativeType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AdShoppingPreviewCreativeType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void AdShoppingPreviewCreativeType::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<AdShoppingPreviewCreativeType>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AdShoppingPreviewCreativeType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AdShoppingPreviewCreativeType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AdShoppingPreviewCreativeType>>>::fromJsonValue(boost::json::parse(json));
}
