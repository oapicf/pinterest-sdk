...
Catalog::Catalog(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value Catalog::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void Catalog::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for Catalog");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object Catalog::toJsonObject_internal() const
{
    boost::json::object object;
        object["catalog_type"] = JsonValueConverter<std::shared_ptr<CatalogsType>>::toJsonValue(getCatalogType());
...
void Catalog::fromJsonObject_internal(boost::json::object const& object)
{
    {
        const auto Catalog_typeIt = object.find("catalog_type");
        if (Catalog_typeIt != object.end()) {
            setCatalogType(JsonValueConverter<std::shared_ptr<CatalogsType>>::fromJsonValue(Catalog_typeIt->value()));
        }
    }
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<Catalog>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<Catalog>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<Catalog>>>::fromJsonValue(boost::json::parse(json));
}
