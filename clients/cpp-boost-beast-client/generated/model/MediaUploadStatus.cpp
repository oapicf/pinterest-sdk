...
MediaUploadStatus::MediaUploadStatus(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string MediaUploadStatus::toJsonString(bool prettyJson /* = false */) const
{
...
void MediaUploadStatus::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value MediaUploadStatus::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void MediaUploadStatus::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for MediaUploadStatus");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object MediaUploadStatus::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void MediaUploadStatus::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<MediaUploadStatus>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<MediaUploadStatus>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<MediaUploadStatus>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<MediaUploadStatus>>>::fromJsonValue(boost::json::parse(json));
}
