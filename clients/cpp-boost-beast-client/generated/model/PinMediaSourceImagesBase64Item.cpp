...
PinMediaSourceImagesBase64Item::PinMediaSourceImagesBase64Item(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value PinMediaSourceImagesBase64Item::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void PinMediaSourceImagesBase64Item::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for PinMediaSourceImagesBase64Item");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object PinMediaSourceImagesBase64Item::toJsonObject_internal() const
{
...
void PinMediaSourceImagesBase64Item::fromJsonObject_internal(boost::json::object const& object)
{
...
void PinMediaSourceImagesBase64Item::setContentType(std::shared_ptr<ContentType> value)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<PinMediaSourceImagesBase64Item>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<PinMediaSourceImagesBase64Item>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<PinMediaSourceImagesBase64Item>>>::fromJsonValue(boost::json::parse(json));
}
