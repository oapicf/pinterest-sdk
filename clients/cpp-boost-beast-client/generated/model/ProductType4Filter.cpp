...
ProductType4Filter::ProductType4Filter(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ProductType4Filter::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value ProductType4Filter::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ProductType4Filter::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ProductType4Filter");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ProductType4Filter::toJsonObject_internal() const
{
...
void ProductType4Filter::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ProductType4Filter>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ProductType4Filter>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ProductType4Filter>>>::fromJsonValue(boost::json::parse(json));
}
