...
SupplementalItemValidationEvent::SupplementalItemValidationEvent(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string SupplementalItemValidationEvent::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value SupplementalItemValidationEvent::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void SupplementalItemValidationEvent::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for SupplementalItemValidationEvent");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object SupplementalItemValidationEvent::toJsonObject_internal() const
{
    boost::json::object object;
        object["attribute"] = JsonValueConverter<std::string>::toJsonValue(getAttribute());
...
void SupplementalItemValidationEvent::fromJsonObject_internal(boost::json::object const& object)
{
    {
        const auto AttributeIt = object.find("attribute");
        if (AttributeIt != object.end()) {
            setAttribute(JsonValueConverter<std::string>::fromJsonValue(AttributeIt->value()));
        }
    }
    {
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<SupplementalItemValidationEvent>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<SupplementalItemValidationEvent>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<SupplementalItemValidationEvent>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<SupplementalItemValidationEvent>>>::fromJsonValue(boost::json::parse(json));
}
