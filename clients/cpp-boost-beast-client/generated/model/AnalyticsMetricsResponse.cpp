...
AnalyticsMetricsResponse::AnalyticsMetricsResponse(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value AnalyticsMetricsResponse::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AnalyticsMetricsResponse::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AnalyticsMetricsResponse");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AnalyticsMetricsResponse::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_Daily_metricsIsSet) {
            object["daily_metrics"] = JsonValueConverter<std::vector<std::shared_ptr<AnalyticsDailyMetrics>>>::toJsonValue(getDailyMetrics());
        }
...
void AnalyticsMetricsResponse::fromJsonObject_internal(boost::json::object const& object)
{
    ...
    m_Summary_metricsIsSet = false;
    {
        ...
        if (Daily_metricsIt != object.end()) {
            setDailyMetrics(JsonValueConverter<std::vector<std::shared_ptr<AnalyticsDailyMetrics>>>::fromJsonValue(Daily_metricsIt->value()));
        }
    }
    {
...
std::vector<std::shared_ptr<AnalyticsDailyMetrics>> AnalyticsMetricsResponse::getDailyMetrics() const
{
    return m_Daily_metrics;
}

void AnalyticsMetricsResponse::setDailyMetrics(std::vector<std::shared_ptr<AnalyticsDailyMetrics>> value)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AnalyticsMetricsResponse>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AnalyticsMetricsResponse>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AnalyticsMetricsResponse>>>::fromJsonValue(boost::json::parse(json));
}
