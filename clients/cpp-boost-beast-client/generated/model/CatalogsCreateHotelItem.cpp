...
CatalogsCreateHotelItem::CatalogsCreateHotelItem(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string CatalogsCreateHotelItem::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value CatalogsCreateHotelItem::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogsCreateHotelItem::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogsCreateHotelItem");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogsCreateHotelItem::toJsonObject_internal() const
{
...
void CatalogsCreateHotelItem::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogsCreateHotelItem>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CatalogsCreateHotelItem>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogsCreateHotelItem>>>::fromJsonValue(boost::json::parse(json));
}
