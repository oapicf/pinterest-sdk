...
CurrencyFilter::CurrencyFilter(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string CurrencyFilter::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value CurrencyFilter::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CurrencyFilter::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CurrencyFilter");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CurrencyFilter::toJsonObject_internal() const
{
...
void CurrencyFilter::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<CurrencyFilter>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CurrencyFilter>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CurrencyFilter>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CurrencyFilter>>>::fromJsonValue(boost::json::parse(json));
}
