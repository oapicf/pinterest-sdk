...
MultiPinsAnalyticsMetricTypesItem::MultiPinsAnalyticsMetricTypesItem(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value MultiPinsAnalyticsMetricTypesItem::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void MultiPinsAnalyticsMetricTypesItem::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for MultiPinsAnalyticsMetricTypesItem");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object MultiPinsAnalyticsMetricTypesItem::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void MultiPinsAnalyticsMetricTypesItem::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<MultiPinsAnalyticsMetricTypesItem>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<MultiPinsAnalyticsMetricTypesItem>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<MultiPinsAnalyticsMetricTypesItem>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<MultiPinsAnalyticsMetricTypesItem>>>::fromJsonValue(boost::json::parse(json));
}
