...
Country::Country(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value Country::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void Country::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for Country");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object Country::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void Country::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<Country>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<Country>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<Country>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<Country>>>::fromJsonValue(boost::json::parse(json));
}
