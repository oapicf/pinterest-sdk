...
BillingInvoiceDownloadResponse::BillingInvoiceDownloadResponse(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string BillingInvoiceDownloadResponse::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value BillingInvoiceDownloadResponse::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void BillingInvoiceDownloadResponse::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for BillingInvoiceDownloadResponse");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object BillingInvoiceDownloadResponse::toJsonObject_internal() const
{
...
void BillingInvoiceDownloadResponse::fromJsonObject_internal(boost::json::object const& object)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<BillingInvoiceDownloadResponse>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<BillingInvoiceDownloadResponse>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<BillingInvoiceDownloadResponse>>>::fromJsonValue(boost::json::parse(json));
}
