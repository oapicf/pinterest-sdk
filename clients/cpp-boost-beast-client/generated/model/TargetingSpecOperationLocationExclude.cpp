...
TargetingSpecOperationLocationExclude::TargetingSpecOperationLocationExclude(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string TargetingSpecOperationLocationExclude::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value TargetingSpecOperationLocationExclude::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void TargetingSpecOperationLocationExclude::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for TargetingSpecOperationLocationExclude");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object TargetingSpecOperationLocationExclude::toJsonObject_internal() const
{
...
void TargetingSpecOperationLocationExclude::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<TargetingSpecOperationLocationExclude>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<TargetingSpecOperationLocationExclude>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<TargetingSpecOperationLocationExclude>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<TargetingSpecOperationLocationExclude>>>::fromJsonValue(boost::json::parse(json));
}
