...
SystemUserUpdateWithRequiredBody::SystemUserUpdateWithRequiredBody(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string SystemUserUpdateWithRequiredBody::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value SystemUserUpdateWithRequiredBody::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void SystemUserUpdateWithRequiredBody::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for SystemUserUpdateWithRequiredBody");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object SystemUserUpdateWithRequiredBody::toJsonObject_internal() const
{
...
void SystemUserUpdateWithRequiredBody::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<SystemUserUpdateWithRequiredBody>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<SystemUserUpdateWithRequiredBody>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<SystemUserUpdateWithRequiredBody>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<SystemUserUpdateWithRequiredBody>>>::fromJsonValue(boost::json::parse(json));
}
