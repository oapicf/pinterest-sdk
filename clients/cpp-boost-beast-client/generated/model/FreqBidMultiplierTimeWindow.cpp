...
FreqBidMultiplierTimeWindow::FreqBidMultiplierTimeWindow(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string FreqBidMultiplierTimeWindow::toJsonString(bool prettyJson /* = false */) const
{
...
void FreqBidMultiplierTimeWindow::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value FreqBidMultiplierTimeWindow::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void FreqBidMultiplierTimeWindow::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for FreqBidMultiplierTimeWindow");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object FreqBidMultiplierTimeWindow::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void FreqBidMultiplierTimeWindow::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<FreqBidMultiplierTimeWindow>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<FreqBidMultiplierTimeWindow>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<FreqBidMultiplierTimeWindow>>>::fromJsonValue(boost::json::parse(json));
}
