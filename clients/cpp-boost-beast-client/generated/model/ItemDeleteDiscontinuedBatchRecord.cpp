...
ItemDeleteDiscontinuedBatchRecord::ItemDeleteDiscontinuedBatchRecord(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ItemDeleteDiscontinuedBatchRecord::toJsonString(bool prettyJson /* = false */) const
{
...
void ItemDeleteDiscontinuedBatchRecord::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value ItemDeleteDiscontinuedBatchRecord::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ItemDeleteDiscontinuedBatchRecord::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ItemDeleteDiscontinuedBatchRecord");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ItemDeleteDiscontinuedBatchRecord::toJsonObject_internal() const
{
...
void ItemDeleteDiscontinuedBatchRecord::fromJsonObject_internal(boost::json::object const& object)
{
...
void ItemDeleteDiscontinuedBatchRecord::setItemId(std::string value)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ItemDeleteDiscontinuedBatchRecord>>>::toJsonValue(data));
}
...
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ItemDeleteDiscontinuedBatchRecord>>>::fromJsonValue(boost::json::parse(json));
}
