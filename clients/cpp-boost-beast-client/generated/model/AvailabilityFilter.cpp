...
AvailabilityFilter::AvailabilityFilter(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string AvailabilityFilter::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value AvailabilityFilter::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AvailabilityFilter::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AvailabilityFilter");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AvailabilityFilter::toJsonObject_internal() const
{
...
void AvailabilityFilter::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AvailabilityFilter>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AvailabilityFilter>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AvailabilityFilter>>>::fromJsonValue(boost::json::parse(json));
}
