...
InnerProductCategoriesMetricsHighlights::InnerProductCategoriesMetricsHighlights(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string InnerProductCategoriesMetricsHighlights::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value InnerProductCategoriesMetricsHighlights::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void InnerProductCategoriesMetricsHighlights::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for InnerProductCategoriesMetricsHighlights");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object InnerProductCategoriesMetricsHighlights::toJsonObject_internal() const
{
    boost::json::object object;
        object["pct_change_mom"] = JsonValueConverter<double>::toJsonValue(getPctChangeMom());
    return object;
}

void InnerProductCategoriesMetricsHighlights::fromJsonObject_internal(boost::json::object const& object)
{
    {
        const auto Pct_change_momIt = object.find("pct_change_mom");
        if (Pct_change_momIt != object.end()) {
            setPctChangeMom(JsonValueConverter<double>::fromJsonValue(Pct_change_momIt->value()));
        }
    }
}
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<InnerProductCategoriesMetricsHighlights>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<InnerProductCategoriesMetricsHighlights>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<InnerProductCategoriesMetricsHighlights>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<InnerProductCategoriesMetricsHighlights>>>::fromJsonValue(boost::json::parse(json));
}
