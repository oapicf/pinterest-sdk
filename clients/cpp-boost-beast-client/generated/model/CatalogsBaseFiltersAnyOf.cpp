...
CatalogsBaseFiltersAnyOf::CatalogsBaseFiltersAnyOf(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value CatalogsBaseFiltersAnyOf::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogsBaseFiltersAnyOf::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogsBaseFiltersAnyOf");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogsBaseFiltersAnyOf::toJsonObject_internal() const
{
    boost::json::object object;
        object["any_of"] = JsonValueConverter<std::vector<std::shared_ptr<CatalogsBaseFilterKeys>>>::toJsonValue(getAnyOf());
    return object;
}

void CatalogsBaseFiltersAnyOf::fromJsonObject_internal(boost::json::object const& object)
{
    {
        const auto Any_ofIt = object.find("any_of");
        if (Any_ofIt != object.end()) {
            setAnyOf(JsonValueConverter<std::vector<std::shared_ptr<CatalogsBaseFilterKeys>>>::fromJsonValue(Any_ofIt->value()));
        }
    }
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogsBaseFiltersAnyOf>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CatalogsBaseFiltersAnyOf>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogsBaseFiltersAnyOf>>>::fromJsonValue(boost::json::parse(json));
}
