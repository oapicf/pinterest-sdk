...
AgeBucketMultipliers::AgeBucketMultipliers(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string AgeBucketMultipliers::toJsonString(bool prettyJson /* = false */) const
{
...
void AgeBucketMultipliers::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value AgeBucketMultipliers::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AgeBucketMultipliers::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AgeBucketMultipliers");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AgeBucketMultipliers::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_AGE_BUCKETIsSet) {
            object["AGE_BUCKET"] = JsonValueConverter<std::shared_ptr<TargetingSpecAgeBucket>>::toJsonValue(getAGEBUCKET());
        }
    return object;
}

void AgeBucketMultipliers::fromJsonObject_internal(boost::json::object const& object)
{
    m_AGE_BUCKETIsSet = false;
    {
        const auto AGE_BUCKETIt = object.find("AGE_BUCKET");
        if (AGE_BUCKETIt != object.end()) {
            setAGEBUCKET(JsonValueConverter<std::shared_ptr<TargetingSpecAgeBucket>>::fromJsonValue(AGE_BUCKETIt->value()));
        }
    }
}
...
void AgeBucketMultipliers::setAGEBUCKET(std::shared_ptr<TargetingSpecAgeBucket> value)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AgeBucketMultipliers>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AgeBucketMultipliers>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AgeBucketMultipliers>>>::fromJsonValue(boost::json::parse(json));
}
