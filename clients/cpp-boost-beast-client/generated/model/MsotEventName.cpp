...
MsotEventName::MsotEventName(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string MsotEventName::toJsonString(bool prettyJson /* = false */) const
{
...
void MsotEventName::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value MsotEventName::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void MsotEventName::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for MsotEventName");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object MsotEventName::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void MsotEventName::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<MsotEventName>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<MsotEventName>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<MsotEventName>>>::fromJsonValue(boost::json::parse(json));
}
