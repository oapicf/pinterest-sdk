...
OptimizationType::OptimizationType(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string OptimizationType::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value OptimizationType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void OptimizationType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for OptimizationType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object OptimizationType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void OptimizationType::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<OptimizationType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<OptimizationType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<OptimizationType>>>::fromJsonValue(boost::json::parse(json));
}
