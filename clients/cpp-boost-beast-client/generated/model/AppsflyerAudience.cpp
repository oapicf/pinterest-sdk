...
AppsflyerAudience::AppsflyerAudience(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value AppsflyerAudience::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AppsflyerAudience::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AppsflyerAudience");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AppsflyerAudience::toJsonObject_internal() const
{
    boost::json::object object;
        ...
        object["platform"] = JsonValueConverter<std::shared_ptr<AppsflyerPlatform>>::toJsonValue(getPlatform());
    return object;
}

void AppsflyerAudience::fromJsonObject_internal(boost::json::object const& object)
{
    {
    ...
    }
    {
        ...
        if (PlatformIt != object.end()) {
            setPlatform(JsonValueConverter<std::shared_ptr<AppsflyerPlatform>>::fromJsonValue(PlatformIt->value()));
        }
    }
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AppsflyerAudience>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AppsflyerAudience>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AppsflyerAudience>>>::fromJsonValue(boost::json::parse(json));
}
