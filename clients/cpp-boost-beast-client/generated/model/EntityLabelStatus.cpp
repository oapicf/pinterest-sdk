...
EntityLabelStatus::EntityLabelStatus(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string EntityLabelStatus::toJsonString(bool prettyJson /* = false */) const
{
...
void EntityLabelStatus::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value EntityLabelStatus::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void EntityLabelStatus::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for EntityLabelStatus");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object EntityLabelStatus::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void EntityLabelStatus::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<EntityLabelStatus>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<EntityLabelStatus>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<EntityLabelStatus>>>::fromJsonValue(boost::json::parse(json));
}
