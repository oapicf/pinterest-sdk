...
ImageDetails::ImageDetails(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value ImageDetails::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ImageDetails::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ImageDetails");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ImageDetails::toJsonObject_internal() const
{
...
void ImageDetails::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<ImageDetails>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ImageDetails>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ImageDetails>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ImageDetails>>>::fromJsonValue(boost::json::parse(json));
}
