...
LeadFormTest::LeadFormTest(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string LeadFormTest::toJsonString(bool prettyJson /* = false */) const
{
...
void LeadFormTest::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value LeadFormTest::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void LeadFormTest::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for LeadFormTest");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object LeadFormTest::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_Subscription_idIsSet) {
            object["subscription_id"] = JsonValueConverter<std::string>::toJsonValue(getSubscriptionId());
        }
    return object;
}

void LeadFormTest::fromJsonObject_internal(boost::json::object const& object)
{
    m_Subscription_idIsSet = false;
    {
        const auto Subscription_idIt = object.find("subscription_id");
        if (Subscription_idIt != object.end()) {
            setSubscriptionId(JsonValueConverter<std::string>::fromJsonValue(Subscription_idIt->value()));
        }
    }
}
...
void LeadFormTest::setSubscriptionId(std::string value)
{
    
    m_Subscription_id = std::move(value);
    m_Subscription_idIsSet = true;
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<LeadFormTest>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<LeadFormTest>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<LeadFormTest>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<LeadFormTest>>>::fromJsonValue(boost::json::parse(json));
}
