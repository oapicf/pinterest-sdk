...
CatalogsHotelProductGroupType::CatalogsHotelProductGroupType(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value CatalogsHotelProductGroupType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogsHotelProductGroupType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogsHotelProductGroupType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogsHotelProductGroupType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void CatalogsHotelProductGroupType::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogsHotelProductGroupType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CatalogsHotelProductGroupType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogsHotelProductGroupType>>>::fromJsonValue(boost::json::parse(json));
}
