...
TimeSeries::TimeSeries(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string TimeSeries::toJsonString(bool prettyJson /* = false */) const
{
...
void TimeSeries::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value TimeSeries::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void TimeSeries::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for TimeSeries");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object TimeSeries::toJsonObject_internal() const
{
...
void TimeSeries::fromJsonObject_internal(boost::json::object const& object)
{
    m_dateIsSet = false;
    {
...
void TimeSeries::setDate(std::string value)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<TimeSeries>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<TimeSeries>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<TimeSeries>>>::fromJsonValue(boost::json::parse(json));
}
