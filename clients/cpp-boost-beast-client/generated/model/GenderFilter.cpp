...
GenderFilter::GenderFilter(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string GenderFilter::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value GenderFilter::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void GenderFilter::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for GenderFilter");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object GenderFilter::toJsonObject_internal() const
{
...
void GenderFilter::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
void GenderFilter::setGENDER(std::shared_ptr<CatalogsProductGroupMultipleGenderCriteria> value)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<GenderFilter>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<GenderFilter>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<GenderFilter>>>::fromJsonValue(boost::json::parse(json));
}
