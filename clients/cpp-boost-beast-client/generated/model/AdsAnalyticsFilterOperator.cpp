...
AdsAnalyticsFilterOperator::AdsAnalyticsFilterOperator(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string AdsAnalyticsFilterOperator::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value AdsAnalyticsFilterOperator::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AdsAnalyticsFilterOperator::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AdsAnalyticsFilterOperator");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AdsAnalyticsFilterOperator::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void AdsAnalyticsFilterOperator::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AdsAnalyticsFilterOperator>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AdsAnalyticsFilterOperator>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AdsAnalyticsFilterOperator>>>::fromJsonValue(boost::json::parse(json));
}
