...
ChangeHistoryOperationType::ChangeHistoryOperationType(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ChangeHistoryOperationType::toJsonString(bool prettyJson /* = false */) const
{
...
void ChangeHistoryOperationType::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value ChangeHistoryOperationType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ChangeHistoryOperationType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ChangeHistoryOperationType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ChangeHistoryOperationType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void ChangeHistoryOperationType::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<ChangeHistoryOperationType>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ChangeHistoryOperationType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ChangeHistoryOperationType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ChangeHistoryOperationType>>>::fromJsonValue(boost::json::parse(json));
}
