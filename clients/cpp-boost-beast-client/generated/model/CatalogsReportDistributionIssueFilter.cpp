...
CatalogsReportDistributionIssueFilter::CatalogsReportDistributionIssueFilter(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value CatalogsReportDistributionIssueFilter::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogsReportDistributionIssueFilter::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogsReportDistributionIssueFilter");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogsReportDistributionIssueFilter::toJsonObject_internal() const
{
...
void CatalogsReportDistributionIssueFilter::fromJsonObject_internal(boost::json::object const& object)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogsReportDistributionIssueFilter>>>::toJsonValue(data));
}
...
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogsReportDistributionIssueFilter>>>::fromJsonValue(boost::json::parse(json));
}
