...
BusinessMemberSortBy::BusinessMemberSortBy(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string BusinessMemberSortBy::toJsonString(bool prettyJson /* = false */) const
{
...
void BusinessMemberSortBy::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value BusinessMemberSortBy::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void BusinessMemberSortBy::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for BusinessMemberSortBy");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object BusinessMemberSortBy::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void BusinessMemberSortBy::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<BusinessMemberSortBy>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<BusinessMemberSortBy>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<BusinessMemberSortBy>>>::fromJsonValue(boost::json::parse(json));
}
