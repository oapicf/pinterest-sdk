...
Language::Language(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value Language::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void Language::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for Language");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object Language::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void Language::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<Language>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<Language>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<Language>>>::fromJsonValue(boost::json::parse(json));
}
