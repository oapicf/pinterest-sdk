...
LabelStatusBulkUpdate::LabelStatusBulkUpdate(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value LabelStatusBulkUpdate::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void LabelStatusBulkUpdate::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for LabelStatusBulkUpdate");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object LabelStatusBulkUpdate::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void LabelStatusBulkUpdate::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<LabelStatusBulkUpdate>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<LabelStatusBulkUpdate>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<LabelStatusBulkUpdate>>>::fromJsonValue(boost::json::parse(json));
}
