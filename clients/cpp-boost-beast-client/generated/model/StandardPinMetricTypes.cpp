...
StandardPinMetricTypes::StandardPinMetricTypes(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string StandardPinMetricTypes::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value StandardPinMetricTypes::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void StandardPinMetricTypes::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for StandardPinMetricTypes");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object StandardPinMetricTypes::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void StandardPinMetricTypes::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<StandardPinMetricTypes>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<StandardPinMetricTypes>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<StandardPinMetricTypes>>>::fromJsonValue(boost::json::parse(json));
}
