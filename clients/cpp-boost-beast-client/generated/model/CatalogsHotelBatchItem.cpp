...
CatalogsHotelBatchItem::CatalogsHotelBatchItem(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string CatalogsHotelBatchItem::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value CatalogsHotelBatchItem::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogsHotelBatchItem::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogsHotelBatchItem");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogsHotelBatchItem::toJsonObject_internal() const
{
...
void CatalogsHotelBatchItem::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogsHotelBatchItem>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CatalogsHotelBatchItem>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogsHotelBatchItem>>>::fromJsonValue(boost::json::parse(json));
}
