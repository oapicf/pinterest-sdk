...
AdsAnalyticsCreateAsyncResponse::AdsAnalyticsCreateAsyncResponse(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value AdsAnalyticsCreateAsyncResponse::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AdsAnalyticsCreateAsyncResponse::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AdsAnalyticsCreateAsyncResponse");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AdsAnalyticsCreateAsyncResponse::toJsonObject_internal() const
{
...
void AdsAnalyticsCreateAsyncResponse::fromJsonObject_internal(boost::json::object const& object)
{
...
void AdsAnalyticsCreateAsyncResponse::setReportStatus(std::shared_ptr<BulkReportingJobStatus> value)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AdsAnalyticsCreateAsyncResponse>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AdsAnalyticsCreateAsyncResponse>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AdsAnalyticsCreateAsyncResponse>>>::fromJsonValue(boost::json::parse(json));
}
