...
BudgetDurationType::BudgetDurationType(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string BudgetDurationType::toJsonString(bool prettyJson /* = false */) const
{
...
void BudgetDurationType::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value BudgetDurationType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void BudgetDurationType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for BudgetDurationType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object BudgetDurationType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void BudgetDurationType::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<BudgetDurationType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<BudgetDurationType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<BudgetDurationType>>>::fromJsonValue(boost::json::parse(json));
}
