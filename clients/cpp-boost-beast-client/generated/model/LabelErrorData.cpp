...
LabelErrorData::LabelErrorData(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string LabelErrorData::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value LabelErrorData::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void LabelErrorData::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for LabelErrorData");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object LabelErrorData::toJsonObject_internal() const
{
...
void LabelErrorData::fromJsonObject_internal(boost::json::object const& object)
{
    m_IdIsSet = false;
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<LabelErrorData>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<LabelErrorData>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<LabelErrorData>>>::fromJsonValue(boost::json::parse(json));
}
