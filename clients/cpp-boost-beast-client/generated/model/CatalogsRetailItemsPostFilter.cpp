...
CatalogsRetailItemsPostFilter::CatalogsRetailItemsPostFilter(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value CatalogsRetailItemsPostFilter::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogsRetailItemsPostFilter::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogsRetailItemsPostFilter");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogsRetailItemsPostFilter::toJsonObject_internal() const
{
...
void CatalogsRetailItemsPostFilter::fromJsonObject_internal(boost::json::object const& object)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<CatalogsRetailItemsPostFilter>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogsRetailItemsPostFilter>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CatalogsRetailItemsPostFilter>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogsRetailItemsPostFilter>>>::fromJsonValue(boost::json::parse(json));
}
