...
AdUpdateRequestAllOf1::AdUpdateRequestAllOf1(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value AdUpdateRequestAllOf1::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AdUpdateRequestAllOf1::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AdUpdateRequestAllOf1");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AdUpdateRequestAllOf1::toJsonObject_internal() const
{
...
void AdUpdateRequestAllOf1::fromJsonObject_internal(boost::json::object const& object)
{
    m_Pin_idIsSet = false;
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AdUpdateRequestAllOf1>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AdUpdateRequestAllOf1>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AdUpdateRequestAllOf1>>>::fromJsonValue(boost::json::parse(json));
}
