...
OrderLineStatus::OrderLineStatus(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string OrderLineStatus::toJsonString(bool prettyJson /* = false */) const
{
...
void OrderLineStatus::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value OrderLineStatus::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void OrderLineStatus::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for OrderLineStatus");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object OrderLineStatus::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void OrderLineStatus::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<OrderLineStatus>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<OrderLineStatus>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<OrderLineStatus>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<OrderLineStatus>>>::fromJsonValue(boost::json::parse(json));
}
