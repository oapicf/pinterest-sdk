...
OsFamily::OsFamily(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string OsFamily::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value OsFamily::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void OsFamily::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for OsFamily");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object OsFamily::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void OsFamily::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<OsFamily>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<OsFamily>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<OsFamily>>>::fromJsonValue(boost::json::parse(json));
}
