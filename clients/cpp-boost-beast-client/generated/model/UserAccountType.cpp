...
UserAccountType::UserAccountType(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value UserAccountType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void UserAccountType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for UserAccountType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object UserAccountType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void UserAccountType::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<UserAccountType>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<UserAccountType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<UserAccountType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<UserAccountType>>>::fromJsonValue(boost::json::parse(json));
}
