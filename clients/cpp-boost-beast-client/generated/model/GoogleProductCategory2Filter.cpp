...
GoogleProductCategory2Filter::GoogleProductCategory2Filter(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value GoogleProductCategory2Filter::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void GoogleProductCategory2Filter::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for GoogleProductCategory2Filter");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object GoogleProductCategory2Filter::toJsonObject_internal() const
{
...
void GoogleProductCategory2Filter::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<GoogleProductCategory2Filter>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<GoogleProductCategory2Filter>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<GoogleProductCategory2Filter>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<GoogleProductCategory2Filter>>>::fromJsonValue(boost::json::parse(json));
}
