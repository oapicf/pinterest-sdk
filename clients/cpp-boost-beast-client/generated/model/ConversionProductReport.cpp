...
ConversionProductReport::ConversionProductReport(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value ConversionProductReport::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ConversionProductReport::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ConversionProductReport");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ConversionProductReport::toJsonObject_internal() const
{
    boost::json::object object;
        ...
        if (m_Report_statusIsSet) {
            object["report_status"] = JsonValueConverter<std::shared_ptr<BulkReportingJobStatus>>::toJsonValue(getReportStatus());
        }
        if (m_SizeIsSet) {
            object["size"] = JsonValueConverter<double>::toJsonValue(getSize());
        }
        if (m_TokenIsSet) {
...
void ConversionProductReport::fromJsonObject_internal(boost::json::object const& object)
{
    ...
    {
        const auto Report_statusIt = object.find("report_status");
        if (Report_statusIt != object.end()) {
            setReportStatus(JsonValueConverter<std::shared_ptr<BulkReportingJobStatus>>::fromJsonValue(Report_statusIt->value()));
        }
    }
    {
        const auto SizeIt = object.find("size");
        if (SizeIt != object.end()) {
            setSize(JsonValueConverter<double>::fromJsonValue(SizeIt->value()));
        }
    }
    {
...
void ConversionProductReport::setReportStatus(std::shared_ptr<BulkReportingJobStatus> value)
{
    
    m_Report_status = std::move(value);
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ConversionProductReport>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ConversionProductReport>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ConversionProductReport>>>::fromJsonValue(boost::json::parse(json));
}
