...
CatalogsHotelProductGroupUpdateRequest::CatalogsHotelProductGroupUpdateRequest(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value CatalogsHotelProductGroupUpdateRequest::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogsHotelProductGroupUpdateRequest::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogsHotelProductGroupUpdateRequest");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogsHotelProductGroupUpdateRequest::toJsonObject_internal() const
{
...
void CatalogsHotelProductGroupUpdateRequest::fromJsonObject_internal(boost::json::object const& object)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogsHotelProductGroupUpdateRequest>>>::toJsonValue(data));
}
...
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogsHotelProductGroupUpdateRequest>>>::fromJsonValue(boost::json::parse(json));
}
