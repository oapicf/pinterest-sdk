...
ProductTagItem::ProductTagItem(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ProductTagItem::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value ProductTagItem::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ProductTagItem::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ProductTagItem");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ProductTagItem::toJsonObject_internal() const
{
...
void ProductTagItem::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ProductTagItem>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ProductTagItem>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ProductTagItem>>>::fromJsonValue(boost::json::parse(json));
}
