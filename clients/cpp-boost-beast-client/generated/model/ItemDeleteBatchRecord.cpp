...
ItemDeleteBatchRecord::ItemDeleteBatchRecord(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value ItemDeleteBatchRecord::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ItemDeleteBatchRecord::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ItemDeleteBatchRecord");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ItemDeleteBatchRecord::toJsonObject_internal() const
{
...
void ItemDeleteBatchRecord::fromJsonObject_internal(boost::json::object const& object)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ItemDeleteBatchRecord>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ItemDeleteBatchRecord>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ItemDeleteBatchRecord>>>::fromJsonValue(boost::json::parse(json));
}
