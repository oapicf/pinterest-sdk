...
TrendsGenderFilter::TrendsGenderFilter(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string TrendsGenderFilter::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value TrendsGenderFilter::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void TrendsGenderFilter::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for TrendsGenderFilter");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object TrendsGenderFilter::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void TrendsGenderFilter::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<TrendsGenderFilter>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<TrendsGenderFilter>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<TrendsGenderFilter>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<TrendsGenderFilter>>>::fromJsonValue(boost::json::parse(json));
}
