...
CatalogsReportStatsParameters::CatalogsReportStatsParameters(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string CatalogsReportStatsParameters::toJsonString(bool prettyJson /* = false */) const
{
...
void CatalogsReportStatsParameters::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value CatalogsReportStatsParameters::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogsReportStatsParameters::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogsReportStatsParameters");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogsReportStatsParameters::toJsonObject_internal() const
{
...
void CatalogsReportStatsParameters::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
std::string CatalogsReportStatsParameters::getCatalogType() const
{
    return m_Catalog_type;
}

void CatalogsReportStatsParameters::setCatalogType(std::string value)
{
...
std::shared_ptr<CatalogsHotelReportStatsParametersReport> CatalogsReportStatsParameters::getReport() const
{
    return m_Report;
}

void CatalogsReportStatsParameters::setReport(std::shared_ptr<CatalogsHotelReportStatsParametersReport> value)
{
    
    m_Report = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<CatalogsReportStatsParameters>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogsReportStatsParameters>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CatalogsReportStatsParameters>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogsReportStatsParameters>>>::fromJsonValue(boost::json::parse(json));
}
