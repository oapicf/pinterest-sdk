...
CatalogsHotelBatchRequest::CatalogsHotelBatchRequest(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value CatalogsHotelBatchRequest::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogsHotelBatchRequest::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogsHotelBatchRequest");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogsHotelBatchRequest::toJsonObject_internal() const
{
    boost::json::object object;
        ...
        object["items"] = JsonValueConverter<std::vector<std::shared_ptr<CatalogsHotelBatchItem>>>::toJsonValue(getItems());
        object["language"] = JsonValueConverter<std::string>::toJsonValue(getLanguage());
    return object;
}

void CatalogsHotelBatchRequest::fromJsonObject_internal(boost::json::object const& object)
{
    ...
    }
    {
        ...
        if (ItemsIt != object.end()) {
            setItems(JsonValueConverter<std::vector<std::shared_ptr<CatalogsHotelBatchItem>>>::fromJsonValue(ItemsIt->value()));
        }
    }
    {
...
void CatalogsHotelBatchRequest::setCountry(std::shared_ptr<Country> value)
{
...
void CatalogsHotelBatchRequest::setItems(std::vector<std::shared_ptr<CatalogsHotelBatchItem>> value)
{
...
void CatalogsHotelBatchRequest::setLanguage(std::string value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<CatalogsHotelBatchRequest>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogsHotelBatchRequest>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CatalogsHotelBatchRequest>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogsHotelBatchRequest>>>::fromJsonValue(boost::json::parse(json));
}
