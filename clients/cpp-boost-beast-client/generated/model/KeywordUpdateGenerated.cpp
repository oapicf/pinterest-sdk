...
KeywordUpdateGenerated::KeywordUpdateGenerated(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value KeywordUpdateGenerated::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void KeywordUpdateGenerated::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for KeywordUpdateGenerated");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object KeywordUpdateGenerated::toJsonObject_internal() const
{
...
void KeywordUpdateGenerated::fromJsonObject_internal(boost::json::object const& object)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<KeywordUpdateGenerated>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<KeywordUpdateGenerated>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<KeywordUpdateGenerated>>>::fromJsonValue(boost::json::parse(json));
}
