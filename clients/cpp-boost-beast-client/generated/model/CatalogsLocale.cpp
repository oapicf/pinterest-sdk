...
CatalogsLocale::CatalogsLocale(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string CatalogsLocale::toJsonString(bool prettyJson /* = false */) const
{
...
void CatalogsLocale::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value CatalogsLocale::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogsLocale::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogsLocale");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogsLocale::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void CatalogsLocale::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogsLocale>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CatalogsLocale>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogsLocale>>>::fromJsonValue(boost::json::parse(json));
}
