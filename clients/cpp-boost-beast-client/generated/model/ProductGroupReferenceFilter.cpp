...
ProductGroupReferenceFilter::ProductGroupReferenceFilter(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ProductGroupReferenceFilter::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value ProductGroupReferenceFilter::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ProductGroupReferenceFilter::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ProductGroupReferenceFilter");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ProductGroupReferenceFilter::toJsonObject_internal() const
{
...
void ProductGroupReferenceFilter::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ProductGroupReferenceFilter>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ProductGroupReferenceFilter>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ProductGroupReferenceFilter>>>::fromJsonValue(boost::json::parse(json));
}
