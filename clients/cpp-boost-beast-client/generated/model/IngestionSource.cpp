...
IngestionSource::IngestionSource(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string IngestionSource::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value IngestionSource::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void IngestionSource::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for IngestionSource");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object IngestionSource::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void IngestionSource::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<IngestionSource>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<IngestionSource>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<IngestionSource>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<IngestionSource>>>::fromJsonValue(boost::json::parse(json));
}
