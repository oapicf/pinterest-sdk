...
LeadSubscriptionCreate::LeadSubscriptionCreate(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value LeadSubscriptionCreate::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void LeadSubscriptionCreate::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for LeadSubscriptionCreate");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object LeadSubscriptionCreate::toJsonObject_internal() const
{
...
void LeadSubscriptionCreate::fromJsonObject_internal(boost::json::object const& object)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<LeadSubscriptionCreate>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<LeadSubscriptionCreate>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<LeadSubscriptionCreate>>>::fromJsonValue(boost::json::parse(json));
}
