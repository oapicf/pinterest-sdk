...
ProductAvailability::ProductAvailability(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ProductAvailability::toJsonString(bool prettyJson /* = false */) const
{
...
void ProductAvailability::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value ProductAvailability::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ProductAvailability::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ProductAvailability");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ProductAvailability::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void ProductAvailability::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<ProductAvailability>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ProductAvailability>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ProductAvailability>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ProductAvailability>>>::fromJsonValue(boost::json::parse(json));
}
