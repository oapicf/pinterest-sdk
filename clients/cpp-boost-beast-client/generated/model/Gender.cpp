...
Gender::Gender(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string Gender::toJsonString(bool prettyJson /* = false */) const
{
...
void Gender::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value Gender::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void Gender::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for Gender");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object Gender::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void Gender::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<Gender>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<Gender>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<Gender>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<Gender>>>::fromJsonValue(boost::json::parse(json));
}
