...
CatalogsHotelMainImage::CatalogsHotelMainImage(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string CatalogsHotelMainImage::toJsonString(bool prettyJson /* = false */) const
{
...
void CatalogsHotelMainImage::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value CatalogsHotelMainImage::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogsHotelMainImage::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogsHotelMainImage");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogsHotelMainImage::toJsonObject_internal() const
{
    boost::json::object object;
        ...
        if (m_TagIsSet) {
            object["tag"] = JsonValueConverter<std::vector<std::string>>::toJsonValue(getTag());
        }
    return object;
}

void CatalogsHotelMainImage::fromJsonObject_internal(boost::json::object const& object)
{
    m_LinkIsSet = false;
    m_TagIsSet = false;
    {
    ...
    }
    {
        ...
        if (TagIt != object.end()) {
            setTag(JsonValueConverter<std::vector<std::string>>::fromJsonValue(TagIt->value()));
        }
    }
}
...
void CatalogsHotelMainImage::setLink(std::string value)
{
...
void CatalogsHotelMainImage::setTag(std::vector<std::string> value)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogsHotelMainImage>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CatalogsHotelMainImage>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogsHotelMainImage>>>::fromJsonValue(boost::json::parse(json));
}
