...
CatalogsType::CatalogsType(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value CatalogsType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogsType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogsType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogsType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void CatalogsType::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogsType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CatalogsType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogsType>>>::fromJsonValue(boost::json::parse(json));
}
