...
UpdatePartnerAssetAccessItem::UpdatePartnerAssetAccessItem(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string UpdatePartnerAssetAccessItem::toJsonString(bool prettyJson /* = false */) const
{
...
void UpdatePartnerAssetAccessItem::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value UpdatePartnerAssetAccessItem::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void UpdatePartnerAssetAccessItem::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for UpdatePartnerAssetAccessItem");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object UpdatePartnerAssetAccessItem::toJsonObject_internal() const
{
    boost::json::object object;
        ...
        object["permissions"] = JsonValueConverter<std::vector<std::shared_ptr<Permissions>>>::toJsonValue(getPermissions());
    return object;
}

void UpdatePartnerAssetAccessItem::fromJsonObject_internal(boost::json::object const& object)
{
    {
    ...
    }
    {
        ...
        if (PermissionsIt != object.end()) {
            setPermissions(JsonValueConverter<std::vector<std::shared_ptr<Permissions>>>::fromJsonValue(PermissionsIt->value()));
        }
    }
}
...
void UpdatePartnerAssetAccessItem::setAssetId(std::string value)
{
...
void UpdatePartnerAssetAccessItem::setPartnerId(std::string value)
{
...
void UpdatePartnerAssetAccessItem::setPermissions(std::vector<std::shared_ptr<Permissions>> value)
{
    
    m_Permissions = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<UpdatePartnerAssetAccessItem>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<UpdatePartnerAssetAccessItem>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<UpdatePartnerAssetAccessItem>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<UpdatePartnerAssetAccessItem>>>::fromJsonValue(boost::json::parse(json));
}
