...
AudienceDefinition::AudienceDefinition(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value AudienceDefinition::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AudienceDefinition::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AudienceDefinition");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AudienceDefinition::toJsonObject_internal() const
{
...
void AudienceDefinition::fromJsonObject_internal(boost::json::object const& object)
{
    m_dateIsSet = false;
    m_ScopeIsSet = false;
    m_TypeIsSet = false;
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AudienceDefinition>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AudienceDefinition>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AudienceDefinition>>>::fromJsonValue(boost::json::parse(json));
}
