...
CatalogsCreativeAssetsFeedsUpdateRequest::CatalogsCreativeAssetsFeedsUpdateRequest(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value CatalogsCreativeAssetsFeedsUpdateRequest::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogsCreativeAssetsFeedsUpdateRequest::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogsCreativeAssetsFeedsUpdateRequest");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogsCreativeAssetsFeedsUpdateRequest::toJsonObject_internal() const
{
...
void CatalogsCreativeAssetsFeedsUpdateRequest::fromJsonObject_internal(boost::json::object const& object)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<CatalogsCreativeAssetsFeedsUpdateRequest>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogsCreativeAssetsFeedsUpdateRequest>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CatalogsCreativeAssetsFeedsUpdateRequest>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogsCreativeAssetsFeedsUpdateRequest>>>::fromJsonValue(boost::json::parse(json));
}
