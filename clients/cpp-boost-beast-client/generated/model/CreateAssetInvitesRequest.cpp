...
CreateAssetInvitesRequest::CreateAssetInvitesRequest(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value CreateAssetInvitesRequest::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CreateAssetInvitesRequest::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CreateAssetInvitesRequest");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CreateAssetInvitesRequest::toJsonObject_internal() const
{
    boost::json::object object;
        object["invites"] = JsonValueConverter<std::vector<std::shared_ptr<CreateAssetInvitesRequestItem>>>::toJsonValue(getInvites());
    return object;
}

void CreateAssetInvitesRequest::fromJsonObject_internal(boost::json::object const& object)
{
    {
        const auto InvitesIt = object.find("invites");
        if (InvitesIt != object.end()) {
            setInvites(JsonValueConverter<std::vector<std::shared_ptr<CreateAssetInvitesRequestItem>>>::fromJsonValue(InvitesIt->value()));
        }
    }
}
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<CreateAssetInvitesRequest>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CreateAssetInvitesRequest>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CreateAssetInvitesRequest>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CreateAssetInvitesRequest>>>::fromJsonValue(boost::json::parse(json));
}
