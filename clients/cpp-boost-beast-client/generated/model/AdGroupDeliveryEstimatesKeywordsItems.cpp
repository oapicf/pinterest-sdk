...
AdGroupDeliveryEstimatesKeywordsItems::AdGroupDeliveryEstimatesKeywordsItems(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string AdGroupDeliveryEstimatesKeywordsItems::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value AdGroupDeliveryEstimatesKeywordsItems::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AdGroupDeliveryEstimatesKeywordsItems::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AdGroupDeliveryEstimatesKeywordsItems");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AdGroupDeliveryEstimatesKeywordsItems::toJsonObject_internal() const
{
    boost::json::object object;
        object["match_type"] = JsonValueConverter<std::shared_ptr<NullalbleMatchType>>::toJsonValue(getMatchType());
        object["value"] = JsonValueConverter<std::string>::toJsonValue(getValue());
    return object;
}

void AdGroupDeliveryEstimatesKeywordsItems::fromJsonObject_internal(boost::json::object const& object)
{
    {
        const auto Match_typeIt = object.find("match_type");
        if (Match_typeIt != object.end()) {
            setMatchType(JsonValueConverter<std::shared_ptr<NullalbleMatchType>>::fromJsonValue(Match_typeIt->value()));
        }
    }
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AdGroupDeliveryEstimatesKeywordsItems>>>::toJsonValue(data));
}
...
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AdGroupDeliveryEstimatesKeywordsItems>>>::fromJsonValue(boost::json::parse(json));
}
