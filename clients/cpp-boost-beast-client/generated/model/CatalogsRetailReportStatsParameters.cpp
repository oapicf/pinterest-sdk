...
CatalogsRetailReportStatsParameters::CatalogsRetailReportStatsParameters(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string CatalogsRetailReportStatsParameters::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value CatalogsRetailReportStatsParameters::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogsRetailReportStatsParameters::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogsRetailReportStatsParameters");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogsRetailReportStatsParameters::toJsonObject_internal() const
{
    boost::json::object object;
        object["catalog_type"] = JsonValueConverter<std::string>::toJsonValue(getCatalogType());
        object["report"] = JsonValueConverter<std::shared_ptr<CatalogsRetailReportStatsParametersReport>>::toJsonValue(getReport());
    return object;
}

void CatalogsRetailReportStatsParameters::fromJsonObject_internal(boost::json::object const& object)
{
    {
    ...
    }
    {
        ...
        if (ReportIt != object.end()) {
            setReport(JsonValueConverter<std::shared_ptr<CatalogsRetailReportStatsParametersReport>>::fromJsonValue(ReportIt->value()));
        }
    }
}
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<CatalogsRetailReportStatsParameters>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogsRetailReportStatsParameters>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CatalogsRetailReportStatsParameters>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogsRetailReportStatsParameters>>>::fromJsonValue(boost::json::parse(json));
}
