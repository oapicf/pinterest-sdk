...
TargetingSpecTargetingStrategyItems::TargetingSpecTargetingStrategyItems(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string TargetingSpecTargetingStrategyItems::toJsonString(bool prettyJson /* = false */) const
{
...
void TargetingSpecTargetingStrategyItems::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value TargetingSpecTargetingStrategyItems::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void TargetingSpecTargetingStrategyItems::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for TargetingSpecTargetingStrategyItems");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object TargetingSpecTargetingStrategyItems::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void TargetingSpecTargetingStrategyItems::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<TargetingSpecTargetingStrategyItems>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<TargetingSpecTargetingStrategyItems>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<TargetingSpecTargetingStrategyItems>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<TargetingSpecTargetingStrategyItems>>>::fromJsonValue(boost::json::parse(json));
}
