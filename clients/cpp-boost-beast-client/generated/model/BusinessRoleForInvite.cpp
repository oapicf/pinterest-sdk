...
BusinessRoleForInvite::BusinessRoleForInvite(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string BusinessRoleForInvite::toJsonString(bool prettyJson /* = false */) const
{
...
void BusinessRoleForInvite::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value BusinessRoleForInvite::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void BusinessRoleForInvite::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for BusinessRoleForInvite");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object BusinessRoleForInvite::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void BusinessRoleForInvite::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<BusinessRoleForInvite>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<BusinessRoleForInvite>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<BusinessRoleForInvite>>>::fromJsonValue(boost::json::parse(json));
}
