...
AssetSortBy::AssetSortBy(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string AssetSortBy::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value AssetSortBy::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AssetSortBy::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AssetSortBy");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AssetSortBy::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void AssetSortBy::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<AssetSortBy>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AssetSortBy>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AssetSortBy>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AssetSortBy>>>::fromJsonValue(boost::json::parse(json));
}
