...
TrackingUrls::TrackingUrls(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value TrackingUrls::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void TrackingUrls::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for TrackingUrls");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object TrackingUrls::toJsonObject_internal() const
{
...
void TrackingUrls::fromJsonObject_internal(boost::json::object const& object)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<TrackingUrls>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<TrackingUrls>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<TrackingUrls>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<TrackingUrls>>>::fromJsonValue(boost::json::parse(json));
}
