...
UpdateMaskFieldType::UpdateMaskFieldType(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value UpdateMaskFieldType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void UpdateMaskFieldType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for UpdateMaskFieldType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object UpdateMaskFieldType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void UpdateMaskFieldType::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<UpdateMaskFieldType>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<UpdateMaskFieldType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<UpdateMaskFieldType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<UpdateMaskFieldType>>>::fromJsonValue(boost::json::parse(json));
}
