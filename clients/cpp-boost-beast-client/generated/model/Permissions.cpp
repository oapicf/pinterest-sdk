...
Permissions::Permissions(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value Permissions::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void Permissions::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for Permissions");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object Permissions::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void Permissions::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<Permissions>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<Permissions>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<Permissions>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<Permissions>>>::fromJsonValue(boost::json::parse(json));
}
