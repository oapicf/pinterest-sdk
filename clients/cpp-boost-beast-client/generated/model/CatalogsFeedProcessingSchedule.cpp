...
CatalogsFeedProcessingSchedule::CatalogsFeedProcessingSchedule(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value CatalogsFeedProcessingSchedule::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogsFeedProcessingSchedule::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogsFeedProcessingSchedule");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogsFeedProcessingSchedule::toJsonObject_internal() const
{
    boost::json::object object;
        object["time"] = JsonValueConverter<std::string>::toJsonValue(getTime());
        object["timezone"] = JsonValueConverter<std::shared_ptr<CatalogsFeedProcessingScheduleTimezone>>::toJsonValue(getTimezone());
    return object;
}

void CatalogsFeedProcessingSchedule::fromJsonObject_internal(boost::json::object const& object)
{
    {
    ...
    }
    {
        ...
        if (TimezoneIt != object.end()) {
            setTimezone(JsonValueConverter<std::shared_ptr<CatalogsFeedProcessingScheduleTimezone>>::fromJsonValue(TimezoneIt->value()));
        }
    }
}
...
void CatalogsFeedProcessingSchedule::setTimezone(std::shared_ptr<CatalogsFeedProcessingScheduleTimezone> value)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogsFeedProcessingSchedule>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CatalogsFeedProcessingSchedule>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogsFeedProcessingSchedule>>>::fromJsonValue(boost::json::parse(json));
}
