...
AttributionScope::AttributionScope(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string AttributionScope::toJsonString(bool prettyJson /* = false */) const
{
...
void AttributionScope::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value AttributionScope::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AttributionScope::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AttributionScope");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AttributionScope::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void AttributionScope::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<AttributionScope>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AttributionScope>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AttributionScope>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AttributionScope>>>::fromJsonValue(boost::json::parse(json));
}
