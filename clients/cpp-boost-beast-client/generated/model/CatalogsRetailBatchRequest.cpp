...
CatalogsRetailBatchRequest::CatalogsRetailBatchRequest(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string CatalogsRetailBatchRequest::toJsonString(bool prettyJson /* = false */) const
{
...
void CatalogsRetailBatchRequest::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value CatalogsRetailBatchRequest::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogsRetailBatchRequest::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogsRetailBatchRequest");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogsRetailBatchRequest::toJsonObject_internal() const
{
    boost::json::object object;
        ...
        object["items"] = JsonValueConverter<std::vector<std::shared_ptr<CatalogsRetailBatchRequestItemsItems>>>::toJsonValue(getItems());
        object["language"] = JsonValueConverter<std::string>::toJsonValue(getLanguage());
    return object;
}

void CatalogsRetailBatchRequest::fromJsonObject_internal(boost::json::object const& object)
{
    ...
    }
    {
        ...
        if (ItemsIt != object.end()) {
            setItems(JsonValueConverter<std::vector<std::shared_ptr<CatalogsRetailBatchRequestItemsItems>>>::fromJsonValue(ItemsIt->value()));
        }
    }
    {
...
void CatalogsRetailBatchRequest::setCatalogId(std::string value)
{
...
void CatalogsRetailBatchRequest::setCatalogType(std::string value)
{
...
void CatalogsRetailBatchRequest::setCountry(std::shared_ptr<Country> value)
{
...
void CatalogsRetailBatchRequest::setItems(std::vector<std::shared_ptr<CatalogsRetailBatchRequestItemsItems>> value)
{
...
void CatalogsRetailBatchRequest::setLanguage(std::string value)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogsRetailBatchRequest>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CatalogsRetailBatchRequest>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogsRetailBatchRequest>>>::fromJsonValue(boost::json::parse(json));
}
