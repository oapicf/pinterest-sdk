...
ProductType3Filter::ProductType3Filter(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ProductType3Filter::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value ProductType3Filter::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ProductType3Filter::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ProductType3Filter");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ProductType3Filter::toJsonObject_internal() const
{
...
void ProductType3Filter::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ProductType3Filter>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ProductType3Filter>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ProductType3Filter>>>::fromJsonValue(boost::json::parse(json));
}
