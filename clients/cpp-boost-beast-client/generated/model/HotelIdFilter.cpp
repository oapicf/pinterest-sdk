...
HotelIdFilter::HotelIdFilter(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string HotelIdFilter::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value HotelIdFilter::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void HotelIdFilter::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for HotelIdFilter");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object HotelIdFilter::toJsonObject_internal() const
{
...
void HotelIdFilter::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<HotelIdFilter>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<HotelIdFilter>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<HotelIdFilter>>>::fromJsonValue(boost::json::parse(json));
}
