...
TokenTypeHint::TokenTypeHint(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string TokenTypeHint::toJsonString(bool prettyJson /* = false */) const
{
...
void TokenTypeHint::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value TokenTypeHint::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void TokenTypeHint::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for TokenTypeHint");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object TokenTypeHint::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void TokenTypeHint::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<TokenTypeHint>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<TokenTypeHint>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<TokenTypeHint>>>::fromJsonValue(boost::json::parse(json));
}
