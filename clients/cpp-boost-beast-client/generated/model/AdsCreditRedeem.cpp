...
AdsCreditRedeem::AdsCreditRedeem(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value AdsCreditRedeem::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AdsCreditRedeem::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AdsCreditRedeem");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AdsCreditRedeem::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_ErrorCodeIsSet) {
            object["errorCode"] = JsonValueConverter<int32_t>::toJsonValue(getErrorCode());
        }
        if (m_ErrorMessageIsSet) {
            object["errorMessage"] = JsonValueConverter<std::string>::toJsonValue(getErrorMessage());
        }
        if (m_SuccessIsSet) {
...
void AdsCreditRedeem::fromJsonObject_internal(boost::json::object const& object)
{
    m_ErrorCodeIsSet = false;
    m_ErrorMessageIsSet = false;
    m_SuccessIsSet = false;
    {
        const auto ErrorCodeIt = object.find("errorCode");
        if (ErrorCodeIt != object.end()) {
            setErrorCode(JsonValueConverter<int32_t>::fromJsonValue(ErrorCodeIt->value()));
        }
    }
    {
        const auto ErrorMessageIt = object.find("errorMessage");
        if (ErrorMessageIt != object.end()) {
            setErrorMessage(JsonValueConverter<std::string>::fromJsonValue(ErrorMessageIt->value()));
        }
    }
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AdsCreditRedeem>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AdsCreditRedeem>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AdsCreditRedeem>>>::fromJsonValue(boost::json::parse(json));
}
