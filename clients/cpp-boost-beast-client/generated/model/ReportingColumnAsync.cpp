...
ReportingColumnAsync::ReportingColumnAsync(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ReportingColumnAsync::toJsonString(bool prettyJson /* = false */) const
{
...
void ReportingColumnAsync::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value ReportingColumnAsync::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ReportingColumnAsync::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ReportingColumnAsync");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ReportingColumnAsync::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void ReportingColumnAsync::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<ReportingColumnAsync>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ReportingColumnAsync>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ReportingColumnAsync>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ReportingColumnAsync>>>::fromJsonValue(boost::json::parse(json));
}
