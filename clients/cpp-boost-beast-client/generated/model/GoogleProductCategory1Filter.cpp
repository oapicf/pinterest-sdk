...
GoogleProductCategory1Filter::GoogleProductCategory1Filter(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value GoogleProductCategory1Filter::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void GoogleProductCategory1Filter::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for GoogleProductCategory1Filter");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object GoogleProductCategory1Filter::toJsonObject_internal() const
{
...
void GoogleProductCategory1Filter::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<GoogleProductCategory1Filter>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<GoogleProductCategory1Filter>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<GoogleProductCategory1Filter>>>::fromJsonValue(boost::json::parse(json));
}
