...
TargetingSpecOperationGeo::TargetingSpecOperationGeo(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string TargetingSpecOperationGeo::toJsonString(bool prettyJson /* = false */) const
{
...
void TargetingSpecOperationGeo::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value TargetingSpecOperationGeo::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void TargetingSpecOperationGeo::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for TargetingSpecOperationGeo");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object TargetingSpecOperationGeo::toJsonObject_internal() const
{
...
void TargetingSpecOperationGeo::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
void TargetingSpecOperationGeo::setField(std::string value)
{
...
void TargetingSpecOperationGeo::setOperation(std::shared_ptr<TargetingSpecListOperation> value)
{
...
void TargetingSpecOperationGeo::setValues(std::vector<std::string> value)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<TargetingSpecOperationGeo>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<TargetingSpecOperationGeo>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<TargetingSpecOperationGeo>>>::fromJsonValue(boost::json::parse(json));
}
