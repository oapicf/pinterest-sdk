...
WebsiteVerificationMethod::WebsiteVerificationMethod(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string WebsiteVerificationMethod::toJsonString(bool prettyJson /* = false */) const
{
...
void WebsiteVerificationMethod::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value WebsiteVerificationMethod::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void WebsiteVerificationMethod::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for WebsiteVerificationMethod");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object WebsiteVerificationMethod::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void WebsiteVerificationMethod::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<WebsiteVerificationMethod>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<WebsiteVerificationMethod>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<WebsiteVerificationMethod>>>::fromJsonValue(boost::json::parse(json));
}
