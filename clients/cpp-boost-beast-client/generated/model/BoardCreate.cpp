...
BoardCreate::BoardCreate(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value BoardCreate::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void BoardCreate::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for BoardCreate");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object BoardCreate::toJsonObject_internal() const
{
...
void BoardCreate::fromJsonObject_internal(boost::json::object const& object)
{
...
void BoardCreate::setPrivacy(std::shared_ptr<BoardPrivacy> value)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<BoardCreate>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<BoardCreate>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<BoardCreate>>>::fromJsonValue(boost::json::parse(json));
}
