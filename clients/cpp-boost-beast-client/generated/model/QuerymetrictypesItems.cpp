...
QuerymetrictypesItems::QuerymetrictypesItems(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string QuerymetrictypesItems::toJsonString(bool prettyJson /* = false */) const
{
...
void QuerymetrictypesItems::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value QuerymetrictypesItems::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void QuerymetrictypesItems::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for QuerymetrictypesItems");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object QuerymetrictypesItems::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void QuerymetrictypesItems::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<QuerymetrictypesItems>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<QuerymetrictypesItems>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<QuerymetrictypesItems>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<QuerymetrictypesItems>>>::fromJsonValue(boost::json::parse(json));
}
