...
ProductCategoryDetailLookbackWindow::ProductCategoryDetailLookbackWindow(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ProductCategoryDetailLookbackWindow::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value ProductCategoryDetailLookbackWindow::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ProductCategoryDetailLookbackWindow::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ProductCategoryDetailLookbackWindow");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ProductCategoryDetailLookbackWindow::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void ProductCategoryDetailLookbackWindow::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ProductCategoryDetailLookbackWindow>>>::toJsonValue(data));
}
...
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ProductCategoryDetailLookbackWindow>>>::fromJsonValue(boost::json::parse(json));
}
