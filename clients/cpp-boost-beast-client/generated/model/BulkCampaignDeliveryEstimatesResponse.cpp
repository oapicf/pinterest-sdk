...
BulkCampaignDeliveryEstimatesResponse::BulkCampaignDeliveryEstimatesResponse(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string BulkCampaignDeliveryEstimatesResponse::toJsonString(bool prettyJson /* = false */) const
{
...
void BulkCampaignDeliveryEstimatesResponse::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value BulkCampaignDeliveryEstimatesResponse::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void BulkCampaignDeliveryEstimatesResponse::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for BulkCampaignDeliveryEstimatesResponse");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object BulkCampaignDeliveryEstimatesResponse::toJsonObject_internal() const
{
    boost::json::object object;
        object["data"] = JsonValueConverter<std::vector<std::shared_ptr<BulkCampaignDeliveryEstimatesItem>>>::toJsonValue(getData());
    return object;
}

void BulkCampaignDeliveryEstimatesResponse::fromJsonObject_internal(boost::json::object const& object)
{
    {
        const auto DataIt = object.find("data");
        if (DataIt != object.end()) {
            setData(JsonValueConverter<std::vector<std::shared_ptr<BulkCampaignDeliveryEstimatesItem>>>::fromJsonValue(DataIt->value()));
        }
    }
}

std::vector<std::shared_ptr<BulkCampaignDeliveryEstimatesItem>> BulkCampaignDeliveryEstimatesResponse::getData() const
{
    return m_Data;
}

void BulkCampaignDeliveryEstimatesResponse::setData(std::vector<std::shared_ptr<BulkCampaignDeliveryEstimatesItem>> value)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<BulkCampaignDeliveryEstimatesResponse>>>::toJsonValue(data));
}
...
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<BulkCampaignDeliveryEstimatesResponse>>>::fromJsonValue(boost::json::parse(json));
}
