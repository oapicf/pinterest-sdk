...
AdvertiserDefinedEventInput::AdvertiserDefinedEventInput(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string AdvertiserDefinedEventInput::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value AdvertiserDefinedEventInput::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AdvertiserDefinedEventInput::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AdvertiserDefinedEventInput");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AdvertiserDefinedEventInput::toJsonObject_internal() const
{
    boost::json::object object;
        object["mapped_conversion_type"] = JsonValueConverter<std::shared_ptr<AdvertiserDefinedEventMappingType>>::toJsonValue(getMappedConversionType());
        object["name"] = JsonValueConverter<std::string>::toJsonValue(getName());
    return object;
}

void AdvertiserDefinedEventInput::fromJsonObject_internal(boost::json::object const& object)
{
    {
        const auto Mapped_conversion_typeIt = object.find("mapped_conversion_type");
        if (Mapped_conversion_typeIt != object.end()) {
            setMappedConversionType(JsonValueConverter<std::shared_ptr<AdvertiserDefinedEventMappingType>>::fromJsonValue(Mapped_conversion_typeIt->value()));
        }
    }
    {
...
void AdvertiserDefinedEventInput::setMappedConversionType(std::shared_ptr<AdvertiserDefinedEventMappingType> value)
{
    ...
    m_Mapped_conversion_type = std::move(value);
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AdvertiserDefinedEventInput>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AdvertiserDefinedEventInput>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AdvertiserDefinedEventInput>>>::fromJsonValue(boost::json::parse(json));
}
