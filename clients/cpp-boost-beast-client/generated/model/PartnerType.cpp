...
PartnerType::PartnerType(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string PartnerType::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value PartnerType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void PartnerType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for PartnerType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object PartnerType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void PartnerType::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<PartnerType>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<PartnerType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<PartnerType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<PartnerType>>>::fromJsonValue(boost::json::parse(json));
}
