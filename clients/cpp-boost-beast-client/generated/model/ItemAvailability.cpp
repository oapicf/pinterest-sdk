...
ItemAvailability::ItemAvailability(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ItemAvailability::toJsonString(bool prettyJson /* = false */) const
{
...
void ItemAvailability::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value ItemAvailability::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ItemAvailability::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ItemAvailability");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ItemAvailability::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void ItemAvailability::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<ItemAvailability>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ItemAvailability>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ItemAvailability>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ItemAvailability>>>::fromJsonValue(boost::json::parse(json));
}
