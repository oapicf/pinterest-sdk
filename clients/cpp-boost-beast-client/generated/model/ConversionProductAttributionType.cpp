...
ConversionProductAttributionType::ConversionProductAttributionType(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ConversionProductAttributionType::toJsonString(bool prettyJson /* = false */) const
{
...
void ConversionProductAttributionType::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value ConversionProductAttributionType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ConversionProductAttributionType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ConversionProductAttributionType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ConversionProductAttributionType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void ConversionProductAttributionType::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<ConversionProductAttributionType>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ConversionProductAttributionType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ConversionProductAttributionType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ConversionProductAttributionType>>>::fromJsonValue(boost::json::parse(json));
}
