...
OrderLinePaidType::OrderLinePaidType(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string OrderLinePaidType::toJsonString(bool prettyJson /* = false */) const
{
...
void OrderLinePaidType::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value OrderLinePaidType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void OrderLinePaidType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for OrderLinePaidType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object OrderLinePaidType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void OrderLinePaidType::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<OrderLinePaidType>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<OrderLinePaidType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<OrderLinePaidType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<OrderLinePaidType>>>::fromJsonValue(boost::json::parse(json));
}
