...
SourcePlatformOptions::SourcePlatformOptions(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string SourcePlatformOptions::toJsonString(bool prettyJson /* = false */) const
{
...
void SourcePlatformOptions::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value SourcePlatformOptions::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void SourcePlatformOptions::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for SourcePlatformOptions");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object SourcePlatformOptions::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void SourcePlatformOptions::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<SourcePlatformOptions>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<SourcePlatformOptions>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<SourcePlatformOptions>>>::fromJsonValue(boost::json::parse(json));
}
