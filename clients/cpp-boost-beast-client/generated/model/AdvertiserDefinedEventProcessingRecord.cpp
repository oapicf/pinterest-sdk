...
AdvertiserDefinedEventProcessingRecord::AdvertiserDefinedEventProcessingRecord(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value AdvertiserDefinedEventProcessingRecord::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AdvertiserDefinedEventProcessingRecord::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AdvertiserDefinedEventProcessingRecord");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AdvertiserDefinedEventProcessingRecord::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_ExceptionsIsSet) {
            object["exceptions"] = JsonValueConverter<std::vector<std::string>>::toJsonValue(getExceptions());
        }
...
void AdvertiserDefinedEventProcessingRecord::fromJsonObject_internal(boost::json::object const& object)
{
    m_ExceptionsIsSet = false;
    {
        const auto ExceptionsIt = object.find("exceptions");
        if (ExceptionsIt != object.end()) {
            setExceptions(JsonValueConverter<std::vector<std::string>>::fromJsonValue(ExceptionsIt->value()));
        }
    }
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AdvertiserDefinedEventProcessingRecord>>>::toJsonValue(data));
}
...
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AdvertiserDefinedEventProcessingRecord>>>::fromJsonValue(boost::json::parse(json));
}
