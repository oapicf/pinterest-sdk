...
PreferredMediaType::PreferredMediaType(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string PreferredMediaType::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value PreferredMediaType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void PreferredMediaType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for PreferredMediaType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object PreferredMediaType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void PreferredMediaType::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<PreferredMediaType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<PreferredMediaType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<PreferredMediaType>>>::fromJsonValue(boost::json::parse(json));
}
