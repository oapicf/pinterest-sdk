...
CatalogsFeedIngestionDetails::CatalogsFeedIngestionDetails(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value CatalogsFeedIngestionDetails::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogsFeedIngestionDetails::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogsFeedIngestionDetails");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogsFeedIngestionDetails::toJsonObject_internal() const
{
    boost::json::object object;
        object["errors"] = JsonValueConverter<std::shared_ptr<CatalogsFeedIngestionErrors>>::toJsonValue(getErrors());
        object["info"] = JsonValueConverter<std::shared_ptr<CatalogsFeedIngestionInfo>>::toJsonValue(getInfo());
        object["warnings"] = JsonValueConverter<std::shared_ptr<CatalogsFeedIngestionWarnings>>::toJsonValue(getWarnings());
    return object;
}

void CatalogsFeedIngestionDetails::fromJsonObject_internal(boost::json::object const& object)
{
    {
        const auto ErrorsIt = object.find("errors");
        if (ErrorsIt != object.end()) {
            setErrors(JsonValueConverter<std::shared_ptr<CatalogsFeedIngestionErrors>>::fromJsonValue(ErrorsIt->value()));
        }
    }
    {
        const auto InfoIt = object.find("info");
        if (InfoIt != object.end()) {
            setInfo(JsonValueConverter<std::shared_ptr<CatalogsFeedIngestionInfo>>::fromJsonValue(InfoIt->value()));
        }
    }
    {
        const auto WarningsIt = object.find("warnings");
        if (WarningsIt != object.end()) {
            setWarnings(JsonValueConverter<std::shared_ptr<CatalogsFeedIngestionWarnings>>::fromJsonValue(WarningsIt->value()));
        }
    }
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogsFeedIngestionDetails>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CatalogsFeedIngestionDetails>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogsFeedIngestionDetails>>>::fromJsonValue(boost::json::parse(json));
}
