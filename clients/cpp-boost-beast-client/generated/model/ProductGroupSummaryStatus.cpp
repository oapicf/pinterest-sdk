...
ProductGroupSummaryStatus::ProductGroupSummaryStatus(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value ProductGroupSummaryStatus::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ProductGroupSummaryStatus::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ProductGroupSummaryStatus");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ProductGroupSummaryStatus::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void ProductGroupSummaryStatus::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<ProductGroupSummaryStatus>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ProductGroupSummaryStatus>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ProductGroupSummaryStatus>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ProductGroupSummaryStatus>>>::fromJsonValue(boost::json::parse(json));
}
