...
AudienceInsightType::AudienceInsightType(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string AudienceInsightType::toJsonString(bool prettyJson /* = false */) const
{
...
void AudienceInsightType::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value AudienceInsightType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AudienceInsightType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AudienceInsightType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AudienceInsightType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void AudienceInsightType::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<AudienceInsightType>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AudienceInsightType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AudienceInsightType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AudienceInsightType>>>::fromJsonValue(boost::json::parse(json));
}
