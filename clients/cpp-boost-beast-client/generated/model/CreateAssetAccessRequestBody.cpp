...
CreateAssetAccessRequestBody::CreateAssetAccessRequestBody(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value CreateAssetAccessRequestBody::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CreateAssetAccessRequestBody::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CreateAssetAccessRequestBody");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CreateAssetAccessRequestBody::toJsonObject_internal() const
{
    boost::json::object object;
        object["asset_requests"] = JsonValueConverter<std::vector<std::shared_ptr<CreateAssetAccessRequestItem>>>::toJsonValue(getAssetRequests());
    return object;
}

void CreateAssetAccessRequestBody::fromJsonObject_internal(boost::json::object const& object)
{
    {
        const auto Asset_requestsIt = object.find("asset_requests");
        if (Asset_requestsIt != object.end()) {
            setAssetRequests(JsonValueConverter<std::vector<std::shared_ptr<CreateAssetAccessRequestItem>>>::fromJsonValue(Asset_requestsIt->value()));
        }
    }
}
...
void CreateAssetAccessRequestBody::setAssetRequests(std::vector<std::shared_ptr<CreateAssetAccessRequestItem>> value)
{
    ...
    m_Asset_requests = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<CreateAssetAccessRequestBody>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CreateAssetAccessRequestBody>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CreateAssetAccessRequestBody>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CreateAssetAccessRequestBody>>>::fromJsonValue(boost::json::parse(json));
}
