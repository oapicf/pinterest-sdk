...
CampaignPlanningConfidenceLevelAlertReason::CampaignPlanningConfidenceLevelAlertReason(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value CampaignPlanningConfidenceLevelAlertReason::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CampaignPlanningConfidenceLevelAlertReason::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CampaignPlanningConfidenceLevelAlertReason");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CampaignPlanningConfidenceLevelAlertReason::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void CampaignPlanningConfidenceLevelAlertReason::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<CampaignPlanningConfidenceLevelAlertReason>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CampaignPlanningConfidenceLevelAlertReason>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CampaignPlanningConfidenceLevelAlertReason>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CampaignPlanningConfidenceLevelAlertReason>>>::fromJsonValue(boost::json::parse(json));
}
