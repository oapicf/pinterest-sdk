...
BulkRequestStatus::BulkRequestStatus(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string BulkRequestStatus::toJsonString(bool prettyJson /* = false */) const
{
...
void BulkRequestStatus::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value BulkRequestStatus::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void BulkRequestStatus::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for BulkRequestStatus");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object BulkRequestStatus::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void BulkRequestStatus::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<BulkRequestStatus>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<BulkRequestStatus>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<BulkRequestStatus>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<BulkRequestStatus>>>::fromJsonValue(boost::json::parse(json));
}
