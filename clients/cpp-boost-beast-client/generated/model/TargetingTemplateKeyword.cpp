...
TargetingTemplateKeyword::TargetingTemplateKeyword(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string TargetingTemplateKeyword::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value TargetingTemplateKeyword::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void TargetingTemplateKeyword::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for TargetingTemplateKeyword");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object TargetingTemplateKeyword::toJsonObject_internal() const
{
...
void TargetingTemplateKeyword::fromJsonObject_internal(boost::json::object const& object)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<TargetingTemplateKeyword>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<TargetingTemplateKeyword>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<TargetingTemplateKeyword>>>::fromJsonValue(boost::json::parse(json));
}
