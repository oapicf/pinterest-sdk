...
ProductType1Filter::ProductType1Filter(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value ProductType1Filter::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ProductType1Filter::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ProductType1Filter");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ProductType1Filter::toJsonObject_internal() const
{
...
void ProductType1Filter::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ProductType1Filter>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ProductType1Filter>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ProductType1Filter>>>::fromJsonValue(boost::json::parse(json));
}
