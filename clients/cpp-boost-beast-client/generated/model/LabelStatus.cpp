...
LabelStatus::LabelStatus(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value LabelStatus::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void LabelStatus::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for LabelStatus");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object LabelStatus::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void LabelStatus::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<LabelStatus>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<LabelStatus>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<LabelStatus>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<LabelStatus>>>::fromJsonValue(boost::json::parse(json));
}
