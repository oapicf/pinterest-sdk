...
BoardWithUpdatePrivacyUpdate::BoardWithUpdatePrivacyUpdate(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value BoardWithUpdatePrivacyUpdate::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void BoardWithUpdatePrivacyUpdate::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for BoardWithUpdatePrivacyUpdate");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object BoardWithUpdatePrivacyUpdate::toJsonObject_internal() const
{
...
void BoardWithUpdatePrivacyUpdate::fromJsonObject_internal(boost::json::object const& object)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<BoardWithUpdatePrivacyUpdate>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<BoardWithUpdatePrivacyUpdate>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<BoardWithUpdatePrivacyUpdate>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<BoardWithUpdatePrivacyUpdate>>>::fromJsonValue(boost::json::parse(json));
}
