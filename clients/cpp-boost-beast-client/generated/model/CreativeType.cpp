...
CreativeType::CreativeType(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string CreativeType::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value CreativeType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CreativeType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CreativeType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CreativeType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void CreativeType::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CreativeType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CreativeType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CreativeType>>>::fromJsonValue(boost::json::parse(json));
}
