...
AdBatchItem::AdBatchItem(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string AdBatchItem::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value AdBatchItem::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AdBatchItem::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AdBatchItem");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AdBatchItem::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_DataIsSet) {
            object["data"] = JsonValueConverter<std::shared_ptr<Ad>>::toJsonValue(getData());
        }
...
void AdBatchItem::fromJsonObject_internal(boost::json::object const& object)
{
    m_DataIsSet = false;
    m_ExceptionsIsSet = false;
    {
        ...
        if (DataIt != object.end()) {
            setData(JsonValueConverter<std::shared_ptr<Ad>>::fromJsonValue(DataIt->value()));
        }
    }
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AdBatchItem>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AdBatchItem>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AdBatchItem>>>::fromJsonValue(boost::json::parse(json));
}
