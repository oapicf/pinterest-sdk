...
ProductTagsBulkAddRequest::ProductTagsBulkAddRequest(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ProductTagsBulkAddRequest::toJsonString(bool prettyJson /* = false */) const
{
...
void ProductTagsBulkAddRequest::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value ProductTagsBulkAddRequest::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ProductTagsBulkAddRequest::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ProductTagsBulkAddRequest");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ProductTagsBulkAddRequest::toJsonObject_internal() const
{
...
void ProductTagsBulkAddRequest::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
std::vector<std::shared_ptr<ProductTagItem>> ProductTagsBulkAddRequest::getProductTags() const
{
    return m_Product_tags;
}

void ProductTagsBulkAddRequest::setProductTags(std::vector<std::shared_ptr<ProductTagItem>> value)
{
    
    m_Product_tags = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<ProductTagsBulkAddRequest>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ProductTagsBulkAddRequest>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ProductTagsBulkAddRequest>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ProductTagsBulkAddRequest>>>::fromJsonValue(boost::json::parse(json));
}
