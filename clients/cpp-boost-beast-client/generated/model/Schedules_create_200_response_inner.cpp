...
Schedules_create_200_response_inner::Schedules_create_200_response_inner(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value Schedules_create_200_response_inner::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void Schedules_create_200_response_inner::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for Schedules_create_200_response_inner");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object Schedules_create_200_response_inner::toJsonObject_internal() const
{
    boost::json::object object;
        object["data"] = JsonValueConverter<std::shared_ptr<Schedules_create_200_response_inner_data>>::toJsonValue(getData());
    return object;
}

void Schedules_create_200_response_inner::fromJsonObject_internal(boost::json::object const& object)
{
    {
        const auto DataIt = object.find("data");
        if (DataIt != object.end()) {
            setData(JsonValueConverter<std::shared_ptr<Schedules_create_200_response_inner_data>>::fromJsonValue(DataIt->value()));
        }
    }
}
...
void Schedules_create_200_response_inner::setData(std::shared_ptr<Schedules_create_200_response_inner_data> value)
{
    
    m_Data = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<Schedules_create_200_response_inner>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<Schedules_create_200_response_inner>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<Schedules_create_200_response_inner>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<Schedules_create_200_response_inner>>>::fromJsonValue(boost::json::parse(json));
}
