...
SupplementalItemProcessingStatus::SupplementalItemProcessingStatus(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string SupplementalItemProcessingStatus::toJsonString(bool prettyJson /* = false */) const
{
...
void SupplementalItemProcessingStatus::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value SupplementalItemProcessingStatus::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void SupplementalItemProcessingStatus::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for SupplementalItemProcessingStatus");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object SupplementalItemProcessingStatus::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void SupplementalItemProcessingStatus::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<SupplementalItemProcessingStatus>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<SupplementalItemProcessingStatus>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<SupplementalItemProcessingStatus>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<SupplementalItemProcessingStatus>>>::fromJsonValue(boost::json::parse(json));
}
