...
CatalogsFeedIngestion::CatalogsFeedIngestion(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value CatalogsFeedIngestion::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogsFeedIngestion::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogsFeedIngestion");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogsFeedIngestion::toJsonObject_internal() const
{
...
void CatalogsFeedIngestion::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogsFeedIngestion>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CatalogsFeedIngestion>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogsFeedIngestion>>>::fromJsonValue(boost::json::parse(json));
}
