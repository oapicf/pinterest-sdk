...
TrendsGenderDistribution::TrendsGenderDistribution(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string TrendsGenderDistribution::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value TrendsGenderDistribution::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void TrendsGenderDistribution::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for TrendsGenderDistribution");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object TrendsGenderDistribution::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_Gender_distributionIsSet) {
            object["gender_distribution"] = JsonValueConverter<std::shared_ptr<TrendsGender>>::toJsonValue(getGenderDistribution());
        }
    return object;
}

void TrendsGenderDistribution::fromJsonObject_internal(boost::json::object const& object)
{
    m_Gender_distributionIsSet = false;
    {
        ...
        if (Gender_distributionIt != object.end()) {
            setGenderDistribution(JsonValueConverter<std::shared_ptr<TrendsGender>>::fromJsonValue(Gender_distributionIt->value()));
        }
    }
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<TrendsGenderDistribution>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<TrendsGenderDistribution>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<TrendsGenderDistribution>>>::fromJsonValue(boost::json::parse(json));
}
