...
UserSingleAssetBinding::UserSingleAssetBinding(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value UserSingleAssetBinding::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void UserSingleAssetBinding::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for UserSingleAssetBinding");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object UserSingleAssetBinding::toJsonObject_internal() const
{
...
void UserSingleAssetBinding::fromJsonObject_internal(boost::json::object const& object)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<UserSingleAssetBinding>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<UserSingleAssetBinding>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<UserSingleAssetBinding>>>::fromJsonValue(boost::json::parse(json));
}
