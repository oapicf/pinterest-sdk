...
ScrollupGoalMetadata::ScrollupGoalMetadata(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ScrollupGoalMetadata::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value ScrollupGoalMetadata::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ScrollupGoalMetadata::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ScrollupGoalMetadata");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ScrollupGoalMetadata::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_Scrollup_goal_value_in_micro_currencyIsSet) {
            object["scrollup_goal_value_in_micro_currency"] = JsonValueConverter<std::string>::toJsonValue(getScrollupGoalValueInMicroCurrency());
        }
    return object;
}

void ScrollupGoalMetadata::fromJsonObject_internal(boost::json::object const& object)
{
    m_Scrollup_goal_value_in_micro_currencyIsSet = false;
    {
        const auto Scrollup_goal_value_in_micro_currencyIt = object.find("scrollup_goal_value_in_micro_currency");
        if (Scrollup_goal_value_in_micro_currencyIt != object.end()) {
            setScrollupGoalValueInMicroCurrency(JsonValueConverter<std::string>::fromJsonValue(Scrollup_goal_value_in_micro_currencyIt->value()));
        }
    }
}
...
void ScrollupGoalMetadata::setScrollupGoalValueInMicroCurrency(std::string value)
{
    ...
    m_Scrollup_goal_value_in_micro_currency = std::move(value);
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ScrollupGoalMetadata>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ScrollupGoalMetadata>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ScrollupGoalMetadata>>>::fromJsonValue(boost::json::parse(json));
}
