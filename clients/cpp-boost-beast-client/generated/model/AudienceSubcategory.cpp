...
AudienceSubcategory::AudienceSubcategory(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value AudienceSubcategory::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AudienceSubcategory::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AudienceSubcategory");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AudienceSubcategory::toJsonObject_internal() const
{
...
void AudienceSubcategory::fromJsonObject_internal(boost::json::object const& object)
{
    m_IdIsSet = false;
    m_IndexIsSet = false;
    m_KeyIsSet = false;
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AudienceSubcategory>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AudienceSubcategory>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AudienceSubcategory>>>::fromJsonValue(boost::json::parse(json));
}
