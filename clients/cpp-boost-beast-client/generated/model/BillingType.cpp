...
BillingType::BillingType(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string BillingType::toJsonString(bool prettyJson /* = false */) const
{
...
void BillingType::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value BillingType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void BillingType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for BillingType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object BillingType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void BillingType::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<BillingType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<BillingType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<BillingType>>>::fromJsonValue(boost::json::parse(json));
}
