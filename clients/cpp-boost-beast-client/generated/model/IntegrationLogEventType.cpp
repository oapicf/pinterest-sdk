...
IntegrationLogEventType::IntegrationLogEventType(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string IntegrationLogEventType::toJsonString(bool prettyJson /* = false */) const
{
...
void IntegrationLogEventType::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value IntegrationLogEventType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void IntegrationLogEventType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for IntegrationLogEventType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object IntegrationLogEventType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void IntegrationLogEventType::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<IntegrationLogEventType>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<IntegrationLogEventType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<IntegrationLogEventType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<IntegrationLogEventType>>>::fromJsonValue(boost::json::parse(json));
}
