...
ScheduleBidOptions_gender_multipliers::ScheduleBidOptions_gender_multipliers(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ScheduleBidOptions_gender_multipliers::toJsonString(bool prettyJson /* = false */) const
{
...
void ScheduleBidOptions_gender_multipliers::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value ScheduleBidOptions_gender_multipliers::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ScheduleBidOptions_gender_multipliers::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ScheduleBidOptions_gender_multipliers");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ScheduleBidOptions_gender_multipliers::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_GENDERIsSet) {
            object["GENDER"] = JsonValueConverter<std::shared_ptr<TargetingSpecGender>>::toJsonValue(getGENDER());
        }
    return object;
}

void ScheduleBidOptions_gender_multipliers::fromJsonObject_internal(boost::json::object const& object)
{
    m_GENDERIsSet = false;
    {
        const auto GENDERIt = object.find("GENDER");
        if (GENDERIt != object.end()) {
            setGENDER(JsonValueConverter<std::shared_ptr<TargetingSpecGender>>::fromJsonValue(GENDERIt->value()));
        }
    }
}
...
void ScheduleBidOptions_gender_multipliers::setGENDER(std::shared_ptr<TargetingSpecGender> value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<ScheduleBidOptions_gender_multipliers>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ScheduleBidOptions_gender_multipliers>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ScheduleBidOptions_gender_multipliers>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ScheduleBidOptions_gender_multipliers>>>::fromJsonValue(boost::json::parse(json));
}
