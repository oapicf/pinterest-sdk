...
BusinessAccessRole::BusinessAccessRole(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string BusinessAccessRole::toJsonString(bool prettyJson /* = false */) const
{
...
void BusinessAccessRole::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value BusinessAccessRole::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void BusinessAccessRole::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for BusinessAccessRole");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object BusinessAccessRole::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void BusinessAccessRole::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<BusinessAccessRole>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<BusinessAccessRole>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<BusinessAccessRole>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<BusinessAccessRole>>>::fromJsonValue(boost::json::parse(json));
}
