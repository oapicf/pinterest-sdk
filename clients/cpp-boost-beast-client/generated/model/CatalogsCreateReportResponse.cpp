...
CatalogsCreateReportResponse::CatalogsCreateReportResponse(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string CatalogsCreateReportResponse::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value CatalogsCreateReportResponse::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogsCreateReportResponse::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogsCreateReportResponse");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogsCreateReportResponse::toJsonObject_internal() const
{
...
void CatalogsCreateReportResponse::fromJsonObject_internal(boost::json::object const& object)
{
    m_TokenIsSet = false;
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogsCreateReportResponse>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CatalogsCreateReportResponse>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogsCreateReportResponse>>>::fromJsonValue(boost::json::parse(json));
}
