...
UserListType::UserListType(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string UserListType::toJsonString(bool prettyJson /* = false */) const
{
...
void UserListType::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value UserListType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void UserListType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for UserListType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object UserListType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void UserListType::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<UserListType>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<UserListType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<UserListType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<UserListType>>>::fromJsonValue(boost::json::parse(json));
}
