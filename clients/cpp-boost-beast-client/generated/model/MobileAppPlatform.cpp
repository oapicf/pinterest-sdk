...
MobileAppPlatform::MobileAppPlatform(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string MobileAppPlatform::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value MobileAppPlatform::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void MobileAppPlatform::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for MobileAppPlatform");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object MobileAppPlatform::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void MobileAppPlatform::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<MobileAppPlatform>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<MobileAppPlatform>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<MobileAppPlatform>>>::fromJsonValue(boost::json::parse(json));
}
