...
BusinessSearchBy::BusinessSearchBy(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string BusinessSearchBy::toJsonString(bool prettyJson /* = false */) const
{
...
void BusinessSearchBy::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value BusinessSearchBy::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void BusinessSearchBy::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for BusinessSearchBy");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object BusinessSearchBy::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void BusinessSearchBy::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<BusinessSearchBy>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<BusinessSearchBy>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<BusinessSearchBy>>>::fromJsonValue(boost::json::parse(json));
}
