...
CatalogsHotelItemsPostFilter::CatalogsHotelItemsPostFilter(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string CatalogsHotelItemsPostFilter::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value CatalogsHotelItemsPostFilter::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogsHotelItemsPostFilter::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogsHotelItemsPostFilter");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogsHotelItemsPostFilter::toJsonObject_internal() const
{
...
void CatalogsHotelItemsPostFilter::fromJsonObject_internal(boost::json::object const& object)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogsHotelItemsPostFilter>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CatalogsHotelItemsPostFilter>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogsHotelItemsPostFilter>>>::fromJsonValue(boost::json::parse(json));
}
