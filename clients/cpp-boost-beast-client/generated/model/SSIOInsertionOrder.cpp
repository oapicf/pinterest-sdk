...
SSIOInsertionOrder::SSIOInsertionOrder(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string SSIOInsertionOrder::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value SSIOInsertionOrder::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void SSIOInsertionOrder::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for SSIOInsertionOrder");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object SSIOInsertionOrder::toJsonObject_internal() const
{
...
void SSIOInsertionOrder::fromJsonObject_internal(boost::json::object const& object)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<SSIOInsertionOrder>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<SSIOInsertionOrder>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<SSIOInsertionOrder>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<SSIOInsertionOrder>>>::fromJsonValue(boost::json::parse(json));
}
