...
CampaignPlanningConversionAttributionWindowDays::CampaignPlanningConversionAttributionWindowDays(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value CampaignPlanningConversionAttributionWindowDays::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CampaignPlanningConversionAttributionWindowDays::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CampaignPlanningConversionAttributionWindowDays");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CampaignPlanningConversionAttributionWindowDays::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void CampaignPlanningConversionAttributionWindowDays::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CampaignPlanningConversionAttributionWindowDays>>>::toJsonValue(data));
}
...
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CampaignPlanningConversionAttributionWindowDays>>>::fromJsonValue(boost::json::parse(json));
}
