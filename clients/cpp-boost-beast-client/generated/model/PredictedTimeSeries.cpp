...
PredictedTimeSeries::PredictedTimeSeries(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value PredictedTimeSeries::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void PredictedTimeSeries::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for PredictedTimeSeries");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object PredictedTimeSeries::toJsonObject_internal() const
{
...
void PredictedTimeSeries::fromJsonObject_internal(boost::json::object const& object)
{
    m_dateIsSet = false;
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<PredictedTimeSeries>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<PredictedTimeSeries>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<PredictedTimeSeries>>>::fromJsonValue(boost::json::parse(json));
}
