...
QuerypinanalyticsmetrictypesItems::QuerypinanalyticsmetrictypesItems(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string QuerypinanalyticsmetrictypesItems::toJsonString(bool prettyJson /* = false */) const
{
...
void QuerypinanalyticsmetrictypesItems::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value QuerypinanalyticsmetrictypesItems::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void QuerypinanalyticsmetrictypesItems::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for QuerypinanalyticsmetrictypesItems");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object QuerypinanalyticsmetrictypesItems::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void QuerypinanalyticsmetrictypesItems::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<QuerypinanalyticsmetrictypesItems>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<QuerypinanalyticsmetrictypesItems>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<QuerypinanalyticsmetrictypesItems>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<QuerypinanalyticsmetrictypesItems>>>::fromJsonValue(boost::json::parse(json));
}
