...
CatalogsCreateRetailItem::CatalogsCreateRetailItem(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string CatalogsCreateRetailItem::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value CatalogsCreateRetailItem::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogsCreateRetailItem::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogsCreateRetailItem");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogsCreateRetailItem::toJsonObject_internal() const
{
...
void CatalogsCreateRetailItem::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogsCreateRetailItem>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CatalogsCreateRetailItem>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogsCreateRetailItem>>>::fromJsonValue(boost::json::parse(json));
}
