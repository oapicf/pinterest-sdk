...
AiDisclosureItem::AiDisclosureItem(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value AiDisclosureItem::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AiDisclosureItem::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AiDisclosureItem");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AiDisclosureItem::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void AiDisclosureItem::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AiDisclosureItem>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AiDisclosureItem>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AiDisclosureItem>>>::fromJsonValue(boost::json::parse(json));
}
