...
AudienceDemographicValue::AudienceDemographicValue(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value AudienceDemographicValue::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AudienceDemographicValue::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AudienceDemographicValue");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AudienceDemographicValue::toJsonObject_internal() const
{
...
void AudienceDemographicValue::fromJsonObject_internal(boost::json::object const& object)
{
    m_KeyIsSet = false;
    m_NameIsSet = false;
    m_RatioIsSet = false;
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AudienceDemographicValue>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AudienceDemographicValue>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AudienceDemographicValue>>>::fromJsonValue(boost::json::parse(json));
}
