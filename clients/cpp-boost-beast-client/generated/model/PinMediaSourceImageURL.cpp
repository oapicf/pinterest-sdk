...
PinMediaSourceImageURL::PinMediaSourceImageURL(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value PinMediaSourceImageURL::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void PinMediaSourceImageURL::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for PinMediaSourceImageURL");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object PinMediaSourceImageURL::toJsonObject_internal() const
{
...
void PinMediaSourceImageURL::fromJsonObject_internal(boost::json::object const& object)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<PinMediaSourceImageURL>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<PinMediaSourceImageURL>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<PinMediaSourceImageURL>>>::fromJsonValue(boost::json::parse(json));
}
