...
TargetingSpecOperationLocale::TargetingSpecOperationLocale(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string TargetingSpecOperationLocale::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value TargetingSpecOperationLocale::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void TargetingSpecOperationLocale::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for TargetingSpecOperationLocale");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object TargetingSpecOperationLocale::toJsonObject_internal() const
{
...
void TargetingSpecOperationLocale::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<TargetingSpecOperationLocale>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<TargetingSpecOperationLocale>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<TargetingSpecOperationLocale>>>::fromJsonValue(boost::json::parse(json));
}
