...
CreationSource::CreationSource(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string CreationSource::toJsonString(bool prettyJson /* = false */) const
{
...
void CreationSource::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value CreationSource::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CreationSource::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CreationSource");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CreationSource::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void CreationSource::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CreationSource>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CreationSource>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CreationSource>>>::fromJsonValue(boost::json::parse(json));
}
