...
NumericFilterOperatorType::NumericFilterOperatorType(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string NumericFilterOperatorType::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value NumericFilterOperatorType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void NumericFilterOperatorType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for NumericFilterOperatorType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object NumericFilterOperatorType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void NumericFilterOperatorType::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<NumericFilterOperatorType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<NumericFilterOperatorType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<NumericFilterOperatorType>>>::fromJsonValue(boost::json::parse(json));
}
