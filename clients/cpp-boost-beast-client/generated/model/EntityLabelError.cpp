...
EntityLabelError::EntityLabelError(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string EntityLabelError::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value EntityLabelError::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void EntityLabelError::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for EntityLabelError");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object EntityLabelError::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_DataIsSet) {
            object["data"] = JsonValueConverter<std::shared_ptr<EntityLabel>>::toJsonValue(getData());
        }
...
void EntityLabelError::fromJsonObject_internal(boost::json::object const& object)
{
    m_DataIsSet = false;
    m_Error_messagesIsSet = false;
    {
        ...
        if (DataIt != object.end()) {
            setData(JsonValueConverter<std::shared_ptr<EntityLabel>>::fromJsonValue(DataIt->value()));
        }
    }
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<EntityLabelError>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<EntityLabelError>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<EntityLabelError>>>::fromJsonValue(boost::json::parse(json));
}
