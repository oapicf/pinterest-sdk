...
ConversionApiResponseEventsItems::ConversionApiResponseEventsItems(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ConversionApiResponseEventsItems::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value ConversionApiResponseEventsItems::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ConversionApiResponseEventsItems::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ConversionApiResponseEventsItems");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ConversionApiResponseEventsItems::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_Error_messageIsSet) {
            object["error_message"] = JsonValueConverter<std::string>::toJsonValue(getErrorMessage());
        }
        object["status"] = JsonValueConverter<std::shared_ptr<EventProcessingStatus>>::toJsonValue(getStatus());
        if (m_Warning_messageIsSet) {
            object["warning_message"] = JsonValueConverter<std::string>::toJsonValue(getWarningMessage());
        }
    return object;
}

void ConversionApiResponseEventsItems::fromJsonObject_internal(boost::json::object const& object)
{
    m_Error_messageIsSet = false;
    m_Warning_messageIsSet = false;
    {
        const auto Error_messageIt = object.find("error_message");
        if (Error_messageIt != object.end()) {
            setErrorMessage(JsonValueConverter<std::string>::fromJsonValue(Error_messageIt->value()));
        }
    }
    {
        const auto StatusIt = object.find("status");
        if (StatusIt != object.end()) {
            setStatus(JsonValueConverter<std::shared_ptr<EventProcessingStatus>>::fromJsonValue(StatusIt->value()));
        }
    }
    {
        const auto Warning_messageIt = object.find("warning_message");
        if (Warning_messageIt != object.end()) {
            setWarningMessage(JsonValueConverter<std::string>::fromJsonValue(Warning_messageIt->value()));
        }
    }
}
...
void ConversionApiResponseEventsItems::setErrorMessage(std::string value)
{
    ...
    m_Error_message = std::move(value);
...
void ConversionApiResponseEventsItems::setWarningMessage(std::string value)
{
    ...
    m_Warning_message = std::move(value);
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ConversionApiResponseEventsItems>>>::toJsonValue(data));
}
...
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ConversionApiResponseEventsItems>>>::fromJsonValue(boost::json::parse(json));
}
