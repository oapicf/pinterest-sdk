...
BoardSectionCreate::BoardSectionCreate(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string BoardSectionCreate::toJsonString(bool prettyJson /* = false */) const
{
...
void BoardSectionCreate::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value BoardSectionCreate::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void BoardSectionCreate::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for BoardSectionCreate");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object BoardSectionCreate::toJsonObject_internal() const
{
...
void BoardSectionCreate::fromJsonObject_internal(boost::json::object const& object)
{
    m_IdIsSet = false;
    {
...
void BoardSectionCreate::setId(std::string value)
{
...
void BoardSectionCreate::setName(std::string value)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<BoardSectionCreate>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<BoardSectionCreate>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<BoardSectionCreate>>>::fromJsonValue(boost::json::parse(json));
}
