...
CatalogsDeleteRetailItem::CatalogsDeleteRetailItem(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value CatalogsDeleteRetailItem::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogsDeleteRetailItem::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogsDeleteRetailItem");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogsDeleteRetailItem::toJsonObject_internal() const
{
...
void CatalogsDeleteRetailItem::fromJsonObject_internal(boost::json::object const& object)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogsDeleteRetailItem>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CatalogsDeleteRetailItem>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogsDeleteRetailItem>>>::fromJsonValue(boost::json::parse(json));
}
