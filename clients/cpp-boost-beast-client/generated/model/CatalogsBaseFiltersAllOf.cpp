...
CatalogsBaseFiltersAllOf::CatalogsBaseFiltersAllOf(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string CatalogsBaseFiltersAllOf::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value CatalogsBaseFiltersAllOf::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogsBaseFiltersAllOf::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogsBaseFiltersAllOf");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogsBaseFiltersAllOf::toJsonObject_internal() const
{
    boost::json::object object;
        object["all_of"] = JsonValueConverter<std::vector<std::shared_ptr<CatalogsBaseFilterKeys>>>::toJsonValue(getAllOf());
    return object;
}

void CatalogsBaseFiltersAllOf::fromJsonObject_internal(boost::json::object const& object)
{
    {
        const auto All_ofIt = object.find("all_of");
        if (All_ofIt != object.end()) {
            setAllOf(JsonValueConverter<std::vector<std::shared_ptr<CatalogsBaseFilterKeys>>>::fromJsonValue(All_ofIt->value()));
        }
    }
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogsBaseFiltersAllOf>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CatalogsBaseFiltersAllOf>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogsBaseFiltersAllOf>>>::fromJsonValue(boost::json::parse(json));
}
