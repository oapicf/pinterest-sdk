...
PinnerListType::PinnerListType(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value PinnerListType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void PinnerListType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for PinnerListType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object PinnerListType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void PinnerListType::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<PinnerListType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<PinnerListType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<PinnerListType>>>::fromJsonValue(boost::json::parse(json));
}
