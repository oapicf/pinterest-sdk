...
NullableLabelType::NullableLabelType(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string NullableLabelType::toJsonString(bool prettyJson /* = false */) const
{
...
void NullableLabelType::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value NullableLabelType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void NullableLabelType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for NullableLabelType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object NullableLabelType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void NullableLabelType::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<NullableLabelType>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<NullableLabelType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<NullableLabelType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<NullableLabelType>>>::fromJsonValue(boost::json::parse(json));
}
