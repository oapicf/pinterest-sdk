...
IneligibleProductTagErrorItem::IneligibleProductTagErrorItem(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string IneligibleProductTagErrorItem::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value IneligibleProductTagErrorItem::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void IneligibleProductTagErrorItem::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for IneligibleProductTagErrorItem");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object IneligibleProductTagErrorItem::toJsonObject_internal() const
{
    boost::json::object object;
        object["error_message"] = JsonValueConverter<std::shared_ptr<IneligibleProductTagReason>>::toJsonValue(getErrorMessage());
        object["pin_id"] = JsonValueConverter<std::string>::toJsonValue(getPinId());
    return object;
}

void IneligibleProductTagErrorItem::fromJsonObject_internal(boost::json::object const& object)
{
    {
        const auto Error_messageIt = object.find("error_message");
        if (Error_messageIt != object.end()) {
            setErrorMessage(JsonValueConverter<std::shared_ptr<IneligibleProductTagReason>>::fromJsonValue(Error_messageIt->value()));
        }
    }
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<IneligibleProductTagErrorItem>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<IneligibleProductTagErrorItem>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<IneligibleProductTagErrorItem>>>::fromJsonValue(boost::json::parse(json));
}
