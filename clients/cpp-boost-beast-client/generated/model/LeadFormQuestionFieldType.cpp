...
LeadFormQuestionFieldType::LeadFormQuestionFieldType(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string LeadFormQuestionFieldType::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value LeadFormQuestionFieldType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void LeadFormQuestionFieldType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for LeadFormQuestionFieldType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object LeadFormQuestionFieldType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void LeadFormQuestionFieldType::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<LeadFormQuestionFieldType>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<LeadFormQuestionFieldType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<LeadFormQuestionFieldType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<LeadFormQuestionFieldType>>>::fromJsonValue(boost::json::parse(json));
}
