...
SSIOAccountPMPName::SSIOAccountPMPName(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value SSIOAccountPMPName::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void SSIOAccountPMPName::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for SSIOAccountPMPName");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object SSIOAccountPMPName::toJsonObject_internal() const
{
...
void SSIOAccountPMPName::fromJsonObject_internal(boost::json::object const& object)
{
    m_IdIsSet = false;
    m_NameIsSet = false;
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<SSIOAccountPMPName>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<SSIOAccountPMPName>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<SSIOAccountPMPName>>>::fromJsonValue(boost::json::parse(json));
}
