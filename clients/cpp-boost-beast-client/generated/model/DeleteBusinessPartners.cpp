...
DeleteBusinessPartners::DeleteBusinessPartners(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string DeleteBusinessPartners::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value DeleteBusinessPartners::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void DeleteBusinessPartners::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for DeleteBusinessPartners");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object DeleteBusinessPartners::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_Deleted_partnersIsSet) {
            object["deleted_partners"] = JsonValueConverter<std::vector<std::shared_ptr<std::string>>>::toJsonValue(getDeletedPartners());
        }
    return object;
}

void DeleteBusinessPartners::fromJsonObject_internal(boost::json::object const& object)
{
    m_Deleted_partnersIsSet = false;
    {
        const auto Deleted_partnersIt = object.find("deleted_partners");
        if (Deleted_partnersIt != object.end()) {
            setDeletedPartners(JsonValueConverter<std::vector<std::shared_ptr<std::string>>>::fromJsonValue(Deleted_partnersIt->value()));
        }
    }
}
...
void DeleteBusinessPartners::setDeletedPartners(std::vector<std::shared_ptr<std::string>> value)
{
    ...
    m_Deleted_partners = std::move(value);
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<DeleteBusinessPartners>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<DeleteBusinessPartners>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<DeleteBusinessPartners>>>::fromJsonValue(boost::json::parse(json));
}
