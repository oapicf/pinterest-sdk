...
BrandAccountProfileImage::BrandAccountProfileImage(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string BrandAccountProfileImage::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value BrandAccountProfileImage::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void BrandAccountProfileImage::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for BrandAccountProfileImage");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object BrandAccountProfileImage::toJsonObject_internal() const
{
...
void BrandAccountProfileImage::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<BrandAccountProfileImage>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<BrandAccountProfileImage>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<BrandAccountProfileImage>>>::fromJsonValue(boost::json::parse(json));
}
