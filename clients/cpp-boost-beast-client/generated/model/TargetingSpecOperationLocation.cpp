...
TargetingSpecOperationLocation::TargetingSpecOperationLocation(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string TargetingSpecOperationLocation::toJsonString(bool prettyJson /* = false */) const
{
...
void TargetingSpecOperationLocation::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value TargetingSpecOperationLocation::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void TargetingSpecOperationLocation::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for TargetingSpecOperationLocation");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object TargetingSpecOperationLocation::toJsonObject_internal() const
{
...
void TargetingSpecOperationLocation::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
void TargetingSpecOperationLocation::setField(std::string value)
{
...
void TargetingSpecOperationLocation::setOperation(std::shared_ptr<TargetingSpecListOperation> value)
{
...
void TargetingSpecOperationLocation::setValues(std::vector<std::string> value)
{
    
    m_Values = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<TargetingSpecOperationLocation>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<TargetingSpecOperationLocation>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<TargetingSpecOperationLocation>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<TargetingSpecOperationLocation>>>::fromJsonValue(boost::json::parse(json));
}
