...
AmazonConnectResponse::AmazonConnectResponse(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string AmazonConnectResponse::toJsonString(bool prettyJson /* = false */) const
{
...
void AmazonConnectResponse::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value AmazonConnectResponse::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AmazonConnectResponse::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AmazonConnectResponse");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AmazonConnectResponse::toJsonObject_internal() const
{
...
void AmazonConnectResponse::fromJsonObject_internal(boost::json::object const& object)
{
...
void AmazonConnectResponse::setMessage(std::string value)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AmazonConnectResponse>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AmazonConnectResponse>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AmazonConnectResponse>>>::fromJsonValue(boost::json::parse(json));
}
