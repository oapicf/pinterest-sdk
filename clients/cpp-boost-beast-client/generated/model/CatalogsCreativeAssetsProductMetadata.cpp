...
CatalogsCreativeAssetsProductMetadata::CatalogsCreativeAssetsProductMetadata(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string CatalogsCreativeAssetsProductMetadata::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value CatalogsCreativeAssetsProductMetadata::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogsCreativeAssetsProductMetadata::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogsCreativeAssetsProductMetadata");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogsCreativeAssetsProductMetadata::toJsonObject_internal() const
{
    boost::json::object object;
        object["creative_assets_id"] = JsonValueConverter<std::string>::toJsonValue(getCreativeAssetsId());
        object["visibility"] = JsonValueConverter<std::shared_ptr<CreativeAssetsVisibilityType>>::toJsonValue(getVisibility());
    return object;
}

void CatalogsCreativeAssetsProductMetadata::fromJsonObject_internal(boost::json::object const& object)
{
    {
    ...
    }
    {
        ...
        if (VisibilityIt != object.end()) {
            setVisibility(JsonValueConverter<std::shared_ptr<CreativeAssetsVisibilityType>>::fromJsonValue(VisibilityIt->value()));
        }
    }
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogsCreativeAssetsProductMetadata>>>::toJsonValue(data));
}
...
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogsCreativeAssetsProductMetadata>>>::fromJsonValue(boost::json::parse(json));
}
