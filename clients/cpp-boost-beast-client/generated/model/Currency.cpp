...
Currency::Currency(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string Currency::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value Currency::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void Currency::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for Currency");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object Currency::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void Currency::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<Currency>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<Currency>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<Currency>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<Currency>>>::fromJsonValue(boost::json::parse(json));
}
