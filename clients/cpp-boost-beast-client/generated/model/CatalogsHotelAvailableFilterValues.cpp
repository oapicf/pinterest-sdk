...
CatalogsHotelAvailableFilterValues::CatalogsHotelAvailableFilterValues(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string CatalogsHotelAvailableFilterValues::toJsonString(bool prettyJson /* = false */) const
{
...
void CatalogsHotelAvailableFilterValues::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value CatalogsHotelAvailableFilterValues::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogsHotelAvailableFilterValues::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogsHotelAvailableFilterValues");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogsHotelAvailableFilterValues::toJsonObject_internal() const
{
    boost::json::object object;
        object["catalog_type"] = JsonValueConverter<std::string>::toJsonValue(getCatalogType());
        object["filter_values"] = JsonValueConverter<std::shared_ptr<CatalogsHotelFilterValuesMap>>::toJsonValue(getFilterValues());
    return object;
}

void CatalogsHotelAvailableFilterValues::fromJsonObject_internal(boost::json::object const& object)
{
    {
    ...
    }
    {
        ...
        if (Filter_valuesIt != object.end()) {
            setFilterValues(JsonValueConverter<std::shared_ptr<CatalogsHotelFilterValuesMap>>::fromJsonValue(Filter_valuesIt->value()));
        }
    }
}
...
void CatalogsHotelAvailableFilterValues::setCatalogType(std::string value)
{
...
void CatalogsHotelAvailableFilterValues::setFilterValues(std::shared_ptr<CatalogsHotelFilterValuesMap> value)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogsHotelAvailableFilterValues>>>::toJsonValue(data));
}
...
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogsHotelAvailableFilterValues>>>::fromJsonValue(boost::json::parse(json));
}
