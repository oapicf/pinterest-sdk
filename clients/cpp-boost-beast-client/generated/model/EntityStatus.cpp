...
EntityStatus::EntityStatus(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string EntityStatus::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value EntityStatus::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void EntityStatus::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for EntityStatus");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object EntityStatus::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void EntityStatus::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<EntityStatus>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<EntityStatus>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<EntityStatus>>>::fromJsonValue(boost::json::parse(json));
}
