...
TokenGrantType::TokenGrantType(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string TokenGrantType::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value TokenGrantType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void TokenGrantType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for TokenGrantType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object TokenGrantType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void TokenGrantType::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<TokenGrantType>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<TokenGrantType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<TokenGrantType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<TokenGrantType>>>::fromJsonValue(boost::json::parse(json));
}
