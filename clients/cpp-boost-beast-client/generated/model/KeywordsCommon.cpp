...
KeywordsCommon::KeywordsCommon(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value KeywordsCommon::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void KeywordsCommon::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for KeywordsCommon");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object KeywordsCommon::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_BidIsSet) {
            object["bid"] = JsonValueConverter<int32_t>::toJsonValue(getBid());
        }
        object["match_type"] = JsonValueConverter<std::shared_ptr<MatchTypeResponse>>::toJsonValue(getMatchType());
        object["value"] = JsonValueConverter<std::string>::toJsonValue(getValue());
    return object;
}

void KeywordsCommon::fromJsonObject_internal(boost::json::object const& object)
{
    m_BidIsSet = false;
    {
    ...
    }
    {
        ...
        if (Match_typeIt != object.end()) {
            setMatchType(JsonValueConverter<std::shared_ptr<MatchTypeResponse>>::fromJsonValue(Match_typeIt->value()));
        }
    }
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<KeywordsCommon>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<KeywordsCommon>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<KeywordsCommon>>>::fromJsonValue(boost::json::parse(json));
}
