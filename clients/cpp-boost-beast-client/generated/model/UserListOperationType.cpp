...
UserListOperationType::UserListOperationType(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string UserListOperationType::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value UserListOperationType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void UserListOperationType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for UserListOperationType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object UserListOperationType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void UserListOperationType::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<UserListOperationType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<UserListOperationType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<UserListOperationType>>>::fromJsonValue(boost::json::parse(json));
}
