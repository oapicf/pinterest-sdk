...
AdCollectionsHeaderType::AdCollectionsHeaderType(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value AdCollectionsHeaderType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AdCollectionsHeaderType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AdCollectionsHeaderType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AdCollectionsHeaderType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void AdCollectionsHeaderType::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<AdCollectionsHeaderType>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AdCollectionsHeaderType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AdCollectionsHeaderType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AdCollectionsHeaderType>>>::fromJsonValue(boost::json::parse(json));
}
