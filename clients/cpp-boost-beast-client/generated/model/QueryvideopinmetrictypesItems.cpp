...
QueryvideopinmetrictypesItems::QueryvideopinmetrictypesItems(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value QueryvideopinmetrictypesItems::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void QueryvideopinmetrictypesItems::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for QueryvideopinmetrictypesItems");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object QueryvideopinmetrictypesItems::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void QueryvideopinmetrictypesItems::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<QueryvideopinmetrictypesItems>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<QueryvideopinmetrictypesItems>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<QueryvideopinmetrictypesItems>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<QueryvideopinmetrictypesItems>>>::fromJsonValue(boost::json::parse(json));
}
