...
DiscountStatus::DiscountStatus(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string DiscountStatus::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value DiscountStatus::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void DiscountStatus::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for DiscountStatus");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object DiscountStatus::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void DiscountStatus::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<DiscountStatus>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<DiscountStatus>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<DiscountStatus>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<DiscountStatus>>>::fromJsonValue(boost::json::parse(json));
}
