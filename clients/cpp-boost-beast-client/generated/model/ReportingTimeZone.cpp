...
ReportingTimeZone::ReportingTimeZone(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ReportingTimeZone::toJsonString(bool prettyJson /* = false */) const
{
...
void ReportingTimeZone::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value ReportingTimeZone::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ReportingTimeZone::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ReportingTimeZone");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ReportingTimeZone::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void ReportingTimeZone::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ReportingTimeZone>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ReportingTimeZone>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ReportingTimeZone>>>::fromJsonValue(boost::json::parse(json));
}
