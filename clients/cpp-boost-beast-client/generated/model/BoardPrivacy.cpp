...
BoardPrivacy::BoardPrivacy(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value BoardPrivacy::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void BoardPrivacy::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for BoardPrivacy");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object BoardPrivacy::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void BoardPrivacy::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<BoardPrivacy>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<BoardPrivacy>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<BoardPrivacy>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<BoardPrivacy>>>::fromJsonValue(boost::json::parse(json));
}
