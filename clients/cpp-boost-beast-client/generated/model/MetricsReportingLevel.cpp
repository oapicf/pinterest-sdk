...
MetricsReportingLevel::MetricsReportingLevel(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value MetricsReportingLevel::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void MetricsReportingLevel::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for MetricsReportingLevel");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object MetricsReportingLevel::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void MetricsReportingLevel::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<MetricsReportingLevel>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<MetricsReportingLevel>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<MetricsReportingLevel>>>::fromJsonValue(boost::json::parse(json));
}
