...
QueryLabelEntityStatusesItems::QueryLabelEntityStatusesItems(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string QueryLabelEntityStatusesItems::toJsonString(bool prettyJson /* = false */) const
{
...
void QueryLabelEntityStatusesItems::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value QueryLabelEntityStatusesItems::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void QueryLabelEntityStatusesItems::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for QueryLabelEntityStatusesItems");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object QueryLabelEntityStatusesItems::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void QueryLabelEntityStatusesItems::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<QueryLabelEntityStatusesItems>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<QueryLabelEntityStatusesItems>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<QueryLabelEntityStatusesItems>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<QueryLabelEntityStatusesItems>>>::fromJsonValue(boost::json::parse(json));
}
