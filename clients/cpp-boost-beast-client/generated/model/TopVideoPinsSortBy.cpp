...
TopVideoPinsSortBy::TopVideoPinsSortBy(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string TopVideoPinsSortBy::toJsonString(bool prettyJson /* = false */) const
{
...
void TopVideoPinsSortBy::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value TopVideoPinsSortBy::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void TopVideoPinsSortBy::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for TopVideoPinsSortBy");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object TopVideoPinsSortBy::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void TopVideoPinsSortBy::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<TopVideoPinsSortBy>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<TopVideoPinsSortBy>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<TopVideoPinsSortBy>>>::fromJsonValue(boost::json::parse(json));
}
