...
AppsflyerAudienceCreate::AppsflyerAudienceCreate(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value AppsflyerAudienceCreate::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AppsflyerAudienceCreate::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AppsflyerAudienceCreate");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AppsflyerAudienceCreate::toJsonObject_internal() const
{
...
void AppsflyerAudienceCreate::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AppsflyerAudienceCreate>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AppsflyerAudienceCreate>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AppsflyerAudienceCreate>>>::fromJsonValue(boost::json::parse(json));
}
