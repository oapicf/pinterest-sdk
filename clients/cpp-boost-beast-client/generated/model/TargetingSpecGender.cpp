...
TargetingSpecGender::TargetingSpecGender(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value TargetingSpecGender::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void TargetingSpecGender::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for TargetingSpecGender");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object TargetingSpecGender::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void TargetingSpecGender::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<TargetingSpecGender>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<TargetingSpecGender>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<TargetingSpecGender>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<TargetingSpecGender>>>::fromJsonValue(boost::json::parse(json));
}
