...
AdgroupTrackingFeatures::AdgroupTrackingFeatures(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value AdgroupTrackingFeatures::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AdgroupTrackingFeatures::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AdgroupTrackingFeatures");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AdgroupTrackingFeatures::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_EnabledIsSet) {
            object["enabled"] = JsonValueConverter<std::vector<std::shared_ptr<AdgroupTrackingFeatureType>>>::toJsonValue(getEnabled());
        }
    return object;
}

void AdgroupTrackingFeatures::fromJsonObject_internal(boost::json::object const& object)
{
    m_EnabledIsSet = false;
    {
        const auto EnabledIt = object.find("enabled");
        if (EnabledIt != object.end()) {
            setEnabled(JsonValueConverter<std::vector<std::shared_ptr<AdgroupTrackingFeatureType>>>::fromJsonValue(EnabledIt->value()));
        }
    }
}
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<AdgroupTrackingFeatures>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AdgroupTrackingFeatures>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AdgroupTrackingFeatures>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AdgroupTrackingFeatures>>>::fromJsonValue(boost::json::parse(json));
}
