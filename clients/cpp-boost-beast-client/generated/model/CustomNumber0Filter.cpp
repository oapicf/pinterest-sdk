...
CustomNumber0Filter::CustomNumber0Filter(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value CustomNumber0Filter::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CustomNumber0Filter::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CustomNumber0Filter");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CustomNumber0Filter::toJsonObject_internal() const
{
...
void CustomNumber0Filter::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CustomNumber0Filter>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CustomNumber0Filter>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CustomNumber0Filter>>>::fromJsonValue(boost::json::parse(json));
}
