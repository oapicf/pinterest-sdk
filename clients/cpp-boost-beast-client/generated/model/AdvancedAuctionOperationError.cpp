...
AdvancedAuctionOperationError::AdvancedAuctionOperationError(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value AdvancedAuctionOperationError::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AdvancedAuctionOperationError::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AdvancedAuctionOperationError");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AdvancedAuctionOperationError::toJsonObject_internal() const
{
...
void AdvancedAuctionOperationError::fromJsonObject_internal(boost::json::object const& object)
{
    m_CodeIsSet = false;
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AdvancedAuctionOperationError>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AdvancedAuctionOperationError>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AdvancedAuctionOperationError>>>::fromJsonValue(boost::json::parse(json));
}
