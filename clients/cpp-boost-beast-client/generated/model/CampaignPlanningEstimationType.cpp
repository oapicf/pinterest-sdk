...
CampaignPlanningEstimationType::CampaignPlanningEstimationType(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string CampaignPlanningEstimationType::toJsonString(bool prettyJson /* = false */) const
{
...
void CampaignPlanningEstimationType::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value CampaignPlanningEstimationType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CampaignPlanningEstimationType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CampaignPlanningEstimationType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CampaignPlanningEstimationType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void CampaignPlanningEstimationType::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<CampaignPlanningEstimationType>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CampaignPlanningEstimationType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CampaignPlanningEstimationType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CampaignPlanningEstimationType>>>::fromJsonValue(boost::json::parse(json));
}
