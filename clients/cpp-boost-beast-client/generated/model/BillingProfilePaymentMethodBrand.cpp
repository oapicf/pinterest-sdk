...
BillingProfilePaymentMethodBrand::BillingProfilePaymentMethodBrand(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string BillingProfilePaymentMethodBrand::toJsonString(bool prettyJson /* = false */) const
{
...
void BillingProfilePaymentMethodBrand::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value BillingProfilePaymentMethodBrand::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void BillingProfilePaymentMethodBrand::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for BillingProfilePaymentMethodBrand");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object BillingProfilePaymentMethodBrand::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void BillingProfilePaymentMethodBrand::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<BillingProfilePaymentMethodBrand>>>::toJsonValue(data));
}
...
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<BillingProfilePaymentMethodBrand>>>::fromJsonValue(boost::json::parse(json));
}
