...
CatalogsHotelProductGroupCreateRequest::CatalogsHotelProductGroupCreateRequest(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value CatalogsHotelProductGroupCreateRequest::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogsHotelProductGroupCreateRequest::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogsHotelProductGroupCreateRequest");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogsHotelProductGroupCreateRequest::toJsonObject_internal() const
{
...
void CatalogsHotelProductGroupCreateRequest::fromJsonObject_internal(boost::json::object const& object)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogsHotelProductGroupCreateRequest>>>::toJsonValue(data));
}
...
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogsHotelProductGroupCreateRequest>>>::fromJsonValue(boost::json::parse(json));
}
