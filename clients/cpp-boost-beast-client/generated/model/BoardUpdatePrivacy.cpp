...
BoardUpdatePrivacy::BoardUpdatePrivacy(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value BoardUpdatePrivacy::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void BoardUpdatePrivacy::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for BoardUpdatePrivacy");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object BoardUpdatePrivacy::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void BoardUpdatePrivacy::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<BoardUpdatePrivacy>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<BoardUpdatePrivacy>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<BoardUpdatePrivacy>>>::fromJsonValue(boost::json::parse(json));
}
