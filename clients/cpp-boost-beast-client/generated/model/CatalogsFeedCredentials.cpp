...
CatalogsFeedCredentials::CatalogsFeedCredentials(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value CatalogsFeedCredentials::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogsFeedCredentials::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogsFeedCredentials");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogsFeedCredentials::toJsonObject_internal() const
{
...
void CatalogsFeedCredentials::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogsFeedCredentials>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CatalogsFeedCredentials>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogsFeedCredentials>>>::fromJsonValue(boost::json::parse(json));
}
