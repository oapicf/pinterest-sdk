...
PlacementTrafficType::PlacementTrafficType(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string PlacementTrafficType::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value PlacementTrafficType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void PlacementTrafficType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for PlacementTrafficType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object PlacementTrafficType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void PlacementTrafficType::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<PlacementTrafficType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<PlacementTrafficType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<PlacementTrafficType>>>::fromJsonValue(boost::json::parse(json));
}
