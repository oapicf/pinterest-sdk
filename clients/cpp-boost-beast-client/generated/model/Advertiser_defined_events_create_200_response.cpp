...
Advertiser_defined_events_create_200_response::Advertiser_defined_events_create_200_response(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string Advertiser_defined_events_create_200_response::toJsonString(bool prettyJson /* = false */) const
{
...
void Advertiser_defined_events_create_200_response::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value Advertiser_defined_events_create_200_response::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void Advertiser_defined_events_create_200_response::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for Advertiser_defined_events_create_200_response");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object Advertiser_defined_events_create_200_response::toJsonObject_internal() const
{
    boost::json::object object;
        object["items"] = JsonValueConverter<std::vector<std::shared_ptr<AdvertiserDefinedEventProcessingRecord>>>::toJsonValue(getItems());
    return object;
}

void Advertiser_defined_events_create_200_response::fromJsonObject_internal(boost::json::object const& object)
{
    {
        const auto ItemsIt = object.find("items");
        if (ItemsIt != object.end()) {
            setItems(JsonValueConverter<std::vector<std::shared_ptr<AdvertiserDefinedEventProcessingRecord>>>::fromJsonValue(ItemsIt->value()));
        }
    }
}

std::vector<std::shared_ptr<AdvertiserDefinedEventProcessingRecord>> Advertiser_defined_events_create_200_response::getItems() const
{
    return m_Items;
}

void Advertiser_defined_events_create_200_response::setItems(std::vector<std::shared_ptr<AdvertiserDefinedEventProcessingRecord>> value)
{
    
    m_Items = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<Advertiser_defined_events_create_200_response>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<Advertiser_defined_events_create_200_response>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<Advertiser_defined_events_create_200_response>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<Advertiser_defined_events_create_200_response>>>::fromJsonValue(boost::json::parse(json));
}
