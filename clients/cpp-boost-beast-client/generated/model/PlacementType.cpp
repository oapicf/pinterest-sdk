...
PlacementType::PlacementType(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value PlacementType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void PlacementType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for PlacementType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object PlacementType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void PlacementType::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<PlacementType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<PlacementType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<PlacementType>>>::fromJsonValue(boost::json::parse(json));
}
