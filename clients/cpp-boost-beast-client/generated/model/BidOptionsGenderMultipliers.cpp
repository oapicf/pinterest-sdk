...
BidOptionsGenderMultipliers::BidOptionsGenderMultipliers(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value BidOptionsGenderMultipliers::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void BidOptionsGenderMultipliers::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for BidOptionsGenderMultipliers");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object BidOptionsGenderMultipliers::toJsonObject_internal() const
{
...
void BidOptionsGenderMultipliers::fromJsonObject_internal(boost::json::object const& object)
{
    m_FemaleIsSet = false;
    m_MaleIsSet = false;
    {
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<BidOptionsGenderMultipliers>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<BidOptionsGenderMultipliers>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<BidOptionsGenderMultipliers>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<BidOptionsGenderMultipliers>>>::fromJsonValue(boost::json::parse(json));
}
