...
GoogleProductCategory3Filter::GoogleProductCategory3Filter(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string GoogleProductCategory3Filter::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value GoogleProductCategory3Filter::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void GoogleProductCategory3Filter::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for GoogleProductCategory3Filter");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object GoogleProductCategory3Filter::toJsonObject_internal() const
{
...
void GoogleProductCategory3Filter::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<GoogleProductCategory3Filter>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<GoogleProductCategory3Filter>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<GoogleProductCategory3Filter>>>::fromJsonValue(boost::json::parse(json));
}
