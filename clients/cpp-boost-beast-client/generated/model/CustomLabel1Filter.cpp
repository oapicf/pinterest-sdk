...
CustomLabel1Filter::CustomLabel1Filter(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value CustomLabel1Filter::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CustomLabel1Filter::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CustomLabel1Filter");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CustomLabel1Filter::toJsonObject_internal() const
{
...
void CustomLabel1Filter::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CustomLabel1Filter>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CustomLabel1Filter>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CustomLabel1Filter>>>::fromJsonValue(boost::json::parse(json));
}
