...
Lead_forms_list_200_response::Lead_forms_list_200_response(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string Lead_forms_list_200_response::toJsonString(bool prettyJson /* = false */) const
{
...
void Lead_forms_list_200_response::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value Lead_forms_list_200_response::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void Lead_forms_list_200_response::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for Lead_forms_list_200_response");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object Lead_forms_list_200_response::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_BookmarkIsSet) {
            object["bookmark"] = JsonValueConverter<std::string>::toJsonValue(getBookmark());
        }
        object["items"] = JsonValueConverter<std::vector<std::shared_ptr<LeadForm>>>::toJsonValue(getItems());
    return object;
}

void Lead_forms_list_200_response::fromJsonObject_internal(boost::json::object const& object)
{
    ...
    }
    {
        ...
        if (ItemsIt != object.end()) {
            setItems(JsonValueConverter<std::vector<std::shared_ptr<LeadForm>>>::fromJsonValue(ItemsIt->value()));
        }
    }
}

std::string Lead_forms_list_200_response::getBookmark() const
{
    return m_Bookmark;
}

void Lead_forms_list_200_response::setBookmark(std::string value)
{
    
    m_Bookmark = std::move(value);
    m_BookmarkIsSet = true;
}
std::vector<std::shared_ptr<LeadForm>> Lead_forms_list_200_response::getItems() const
{
    return m_Items;
}

void Lead_forms_list_200_response::setItems(std::vector<std::shared_ptr<LeadForm>> value)
{
    
    m_Items = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<Lead_forms_list_200_response>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<Lead_forms_list_200_response>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<Lead_forms_list_200_response>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<Lead_forms_list_200_response>>>::fromJsonValue(boost::json::parse(json));
}
