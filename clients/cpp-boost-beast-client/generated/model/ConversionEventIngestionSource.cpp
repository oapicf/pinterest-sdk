...
ConversionEventIngestionSource::ConversionEventIngestionSource(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ConversionEventIngestionSource::toJsonString(bool prettyJson /* = false */) const
{
...
void ConversionEventIngestionSource::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value ConversionEventIngestionSource::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ConversionEventIngestionSource::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ConversionEventIngestionSource");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ConversionEventIngestionSource::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void ConversionEventIngestionSource::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<ConversionEventIngestionSource>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ConversionEventIngestionSource>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ConversionEventIngestionSource>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ConversionEventIngestionSource>>>::fromJsonValue(boost::json::parse(json));
}
