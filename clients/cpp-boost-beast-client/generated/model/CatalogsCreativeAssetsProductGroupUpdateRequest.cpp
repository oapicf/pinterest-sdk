...
CatalogsCreativeAssetsProductGroupUpdateRequest::CatalogsCreativeAssetsProductGroupUpdateRequest(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string CatalogsCreativeAssetsProductGroupUpdateRequest::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value CatalogsCreativeAssetsProductGroupUpdateRequest::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogsCreativeAssetsProductGroupUpdateRequest::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogsCreativeAssetsProductGroupUpdateRequest");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogsCreativeAssetsProductGroupUpdateRequest::toJsonObject_internal() const
{
...
void CatalogsCreativeAssetsProductGroupUpdateRequest::fromJsonObject_internal(boost::json::object const& object)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogsCreativeAssetsProductGroupUpdateRequest>>>::toJsonValue(data));
}
...
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogsCreativeAssetsProductGroupUpdateRequest>>>::fromJsonValue(boost::json::parse(json));
}
