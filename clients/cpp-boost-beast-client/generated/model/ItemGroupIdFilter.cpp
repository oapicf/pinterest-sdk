...
ItemGroupIdFilter::ItemGroupIdFilter(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ItemGroupIdFilter::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value ItemGroupIdFilter::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ItemGroupIdFilter::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ItemGroupIdFilter");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ItemGroupIdFilter::toJsonObject_internal() const
{
...
void ItemGroupIdFilter::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ItemGroupIdFilter>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ItemGroupIdFilter>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ItemGroupIdFilter>>>::fromJsonValue(boost::json::parse(json));
}
