...
ProductTagsResponse::ProductTagsResponse(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ProductTagsResponse::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value ProductTagsResponse::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ProductTagsResponse::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ProductTagsResponse");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ProductTagsResponse::toJsonObject_internal() const
{
...
void ProductTagsResponse::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ProductTagsResponse>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ProductTagsResponse>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ProductTagsResponse>>>::fromJsonValue(boost::json::parse(json));
}
