...
TieBreakerType::TieBreakerType(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string TieBreakerType::toJsonString(bool prettyJson /* = false */) const
{
...
void TieBreakerType::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value TieBreakerType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void TieBreakerType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for TieBreakerType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object TieBreakerType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void TieBreakerType::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<TieBreakerType>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<TieBreakerType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<TieBreakerType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<TieBreakerType>>>::fromJsonValue(boost::json::parse(json));
}
