...
CampaignSummaryStatus::CampaignSummaryStatus(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string CampaignSummaryStatus::toJsonString(bool prettyJson /* = false */) const
{
...
void CampaignSummaryStatus::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value CampaignSummaryStatus::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CampaignSummaryStatus::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CampaignSummaryStatus");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CampaignSummaryStatus::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void CampaignSummaryStatus::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CampaignSummaryStatus>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CampaignSummaryStatus>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CampaignSummaryStatus>>>::fromJsonValue(boost::json::parse(json));
}
