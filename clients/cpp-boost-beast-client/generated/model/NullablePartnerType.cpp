...
NullablePartnerType::NullablePartnerType(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string NullablePartnerType::toJsonString(bool prettyJson /* = false */) const
{
...
void NullablePartnerType::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value NullablePartnerType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void NullablePartnerType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for NullablePartnerType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object NullablePartnerType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void NullablePartnerType::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<NullablePartnerType>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<NullablePartnerType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<NullablePartnerType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<NullablePartnerType>>>::fromJsonValue(boost::json::parse(json));
}
