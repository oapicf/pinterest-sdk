...
CatalogsItemsRequest::CatalogsItemsRequest(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string CatalogsItemsRequest::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value CatalogsItemsRequest::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogsItemsRequest::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogsItemsRequest");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogsItemsRequest::toJsonObject_internal() const
{
    boost::json::object object;
        object["country"] = JsonValueConverter<std::shared_ptr<Country>>::toJsonValue(getCountry());
        object["filters"] = JsonValueConverter<std::shared_ptr<CatalogsItemsPostFilters>>::toJsonValue(getFilters());
        object["language"] = JsonValueConverter<std::string>::toJsonValue(getLanguage());
    return object;
}

void CatalogsItemsRequest::fromJsonObject_internal(boost::json::object const& object)
{
    {
    ...
    }
    {
        ...
        if (FiltersIt != object.end()) {
            setFilters(JsonValueConverter<std::shared_ptr<CatalogsItemsPostFilters>>::fromJsonValue(FiltersIt->value()));
        }
    }
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogsItemsRequest>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CatalogsItemsRequest>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogsItemsRequest>>>::fromJsonValue(boost::json::parse(json));
}
