...
CreativeAssetsProcessingRecord::CreativeAssetsProcessingRecord(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value CreativeAssetsProcessingRecord::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CreativeAssetsProcessingRecord::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CreativeAssetsProcessingRecord");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CreativeAssetsProcessingRecord::toJsonObject_internal() const
{
...
void CreativeAssetsProcessingRecord::fromJsonObject_internal(boost::json::object const& object)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CreativeAssetsProcessingRecord>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CreativeAssetsProcessingRecord>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CreativeAssetsProcessingRecord>>>::fromJsonValue(boost::json::parse(json));
}
