...
CatalogsRetailProduct::CatalogsRetailProduct(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string CatalogsRetailProduct::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value CatalogsRetailProduct::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogsRetailProduct::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogsRetailProduct");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogsRetailProduct::toJsonObject_internal() const
{
    boost::json::object object;
        object["catalog_type"] = JsonValueConverter<std::string>::toJsonValue(getCatalogType());
        object["metadata"] = JsonValueConverter<std::shared_ptr<CatalogsRetailProductMetadata>>::toJsonValue(getMetadata());
        object["pin"] = JsonValueConverter<std::shared_ptr<Pin>>::toJsonValue(getPin());
    return object;
}

void CatalogsRetailProduct::fromJsonObject_internal(boost::json::object const& object)
{
    {
    ...
    }
    {
        ...
        if (MetadataIt != object.end()) {
            setMetadata(JsonValueConverter<std::shared_ptr<CatalogsRetailProductMetadata>>::fromJsonValue(MetadataIt->value()));
        }
    }
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogsRetailProduct>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CatalogsRetailProduct>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogsRetailProduct>>>::fromJsonValue(boost::json::parse(json));
}
