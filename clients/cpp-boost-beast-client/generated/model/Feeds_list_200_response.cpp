...
Feeds_list_200_response::Feeds_list_200_response(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value Feeds_list_200_response::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void Feeds_list_200_response::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for Feeds_list_200_response");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object Feeds_list_200_response::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_BookmarkIsSet) {
            object["bookmark"] = JsonValueConverter<std::string>::toJsonValue(getBookmark());
        }
        object["items"] = JsonValueConverter<std::vector<std::shared_ptr<CatalogsFeed>>>::toJsonValue(getItems());
    return object;
}

void Feeds_list_200_response::fromJsonObject_internal(boost::json::object const& object)
{
    ...
    }
    {
        ...
        if (ItemsIt != object.end()) {
            setItems(JsonValueConverter<std::vector<std::shared_ptr<CatalogsFeed>>>::fromJsonValue(ItemsIt->value()));
        }
    }
}
...
std::vector<std::shared_ptr<CatalogsFeed>> Feeds_list_200_response::getItems() const
{
    return m_Items;
}

void Feeds_list_200_response::setItems(std::vector<std::shared_ptr<CatalogsFeed>> value)
{
    
    m_Items = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<Feeds_list_200_response>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<Feeds_list_200_response>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<Feeds_list_200_response>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<Feeds_list_200_response>>>::fromJsonValue(boost::json::parse(json));
}
