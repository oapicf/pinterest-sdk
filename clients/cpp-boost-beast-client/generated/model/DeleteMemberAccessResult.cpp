...
DeleteMemberAccessResult::DeleteMemberAccessResult(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value DeleteMemberAccessResult::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void DeleteMemberAccessResult::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for DeleteMemberAccessResult");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object DeleteMemberAccessResult::toJsonObject_internal() const
{
...
void DeleteMemberAccessResult::fromJsonObject_internal(boost::json::object const& object)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<DeleteMemberAccessResult>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<DeleteMemberAccessResult>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<DeleteMemberAccessResult>>>::fromJsonValue(boost::json::parse(json));
}
