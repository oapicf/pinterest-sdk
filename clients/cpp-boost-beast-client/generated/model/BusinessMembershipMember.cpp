...
BusinessMembershipMember::BusinessMembershipMember(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string BusinessMembershipMember::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value BusinessMembershipMember::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void BusinessMembershipMember::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for BusinessMembershipMember");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object BusinessMembershipMember::toJsonObject_internal() const
{
...
void BusinessMembershipMember::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<BusinessMembershipMember>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<BusinessMembershipMember>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<BusinessMembershipMember>>>::fromJsonValue(boost::json::parse(json));
}
