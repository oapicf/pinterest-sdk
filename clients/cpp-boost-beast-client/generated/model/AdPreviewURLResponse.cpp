...
AdPreviewURLResponse::AdPreviewURLResponse(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string AdPreviewURLResponse::toJsonString(bool prettyJson /* = false */) const
{
...
void AdPreviewURLResponse::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value AdPreviewURLResponse::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AdPreviewURLResponse::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AdPreviewURLResponse");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AdPreviewURLResponse::toJsonObject_internal() const
{
...
void AdPreviewURLResponse::fromJsonObject_internal(boost::json::object const& object)
{
    m_UrlIsSet = false;
    {
...
void AdPreviewURLResponse::setUrl(std::string value)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AdPreviewURLResponse>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AdPreviewURLResponse>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AdPreviewURLResponse>>>::fromJsonValue(boost::json::parse(json));
}
