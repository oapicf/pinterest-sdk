...
SummaryPin::SummaryPin(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value SummaryPin::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void SummaryPin::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for SummaryPin");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object SummaryPin::toJsonObject_internal() const
{
...
void SummaryPin::fromJsonObject_internal(boost::json::object const& object)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<SummaryPin>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<SummaryPin>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<SummaryPin>>>::fromJsonValue(boost::json::parse(json));
}
