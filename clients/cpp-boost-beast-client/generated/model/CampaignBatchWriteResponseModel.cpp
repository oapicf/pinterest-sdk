...
CampaignBatchWriteResponseModel::CampaignBatchWriteResponseModel(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string CampaignBatchWriteResponseModel::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value CampaignBatchWriteResponseModel::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CampaignBatchWriteResponseModel::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CampaignBatchWriteResponseModel");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CampaignBatchWriteResponseModel::toJsonObject_internal() const
{
    boost::json::object object;
        object["items"] = JsonValueConverter<std::vector<std::shared_ptr<CampaignBatchItem>>>::toJsonValue(getItems());
    return object;
}

void CampaignBatchWriteResponseModel::fromJsonObject_internal(boost::json::object const& object)
{
    {
        const auto ItemsIt = object.find("items");
        if (ItemsIt != object.end()) {
            setItems(JsonValueConverter<std::vector<std::shared_ptr<CampaignBatchItem>>>::fromJsonValue(ItemsIt->value()));
        }
    }
}
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<CampaignBatchWriteResponseModel>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CampaignBatchWriteResponseModel>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CampaignBatchWriteResponseModel>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CampaignBatchWriteResponseModel>>>::fromJsonValue(boost::json::parse(json));
}
