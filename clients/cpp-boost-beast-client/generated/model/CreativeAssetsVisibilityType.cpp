...
CreativeAssetsVisibilityType::CreativeAssetsVisibilityType(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string CreativeAssetsVisibilityType::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value CreativeAssetsVisibilityType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CreativeAssetsVisibilityType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CreativeAssetsVisibilityType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CreativeAssetsVisibilityType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void CreativeAssetsVisibilityType::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<CreativeAssetsVisibilityType>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CreativeAssetsVisibilityType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CreativeAssetsVisibilityType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CreativeAssetsVisibilityType>>>::fromJsonValue(boost::json::parse(json));
}
