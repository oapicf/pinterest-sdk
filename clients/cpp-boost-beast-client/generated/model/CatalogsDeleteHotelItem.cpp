...
CatalogsDeleteHotelItem::CatalogsDeleteHotelItem(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string CatalogsDeleteHotelItem::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value CatalogsDeleteHotelItem::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogsDeleteHotelItem::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogsDeleteHotelItem");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogsDeleteHotelItem::toJsonObject_internal() const
{
...
void CatalogsDeleteHotelItem::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogsDeleteHotelItem>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CatalogsDeleteHotelItem>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogsDeleteHotelItem>>>::fromJsonValue(boost::json::parse(json));
}
