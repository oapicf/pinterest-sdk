...
IntegrationLogsInvalidLogResponse::IntegrationLogsInvalidLogResponse(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string IntegrationLogsInvalidLogResponse::toJsonString(bool prettyJson /* = false */) const
{
...
void IntegrationLogsInvalidLogResponse::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value IntegrationLogsInvalidLogResponse::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void IntegrationLogsInvalidLogResponse::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for IntegrationLogsInvalidLogResponse");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object IntegrationLogsInvalidLogResponse::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_Rejected_logsIsSet) {
            object["rejected_logs"] = JsonValueConverter<std::vector<std::shared_ptr<IntegrationLogsInvalidLogResponseRejectedLogsItems>>>::toJsonValue(getRejectedLogs());
        }
    return object;
}

void IntegrationLogsInvalidLogResponse::fromJsonObject_internal(boost::json::object const& object)
{
    m_Rejected_logsIsSet = false;
    {
        const auto Rejected_logsIt = object.find("rejected_logs");
        if (Rejected_logsIt != object.end()) {
            setRejectedLogs(JsonValueConverter<std::vector<std::shared_ptr<IntegrationLogsInvalidLogResponseRejectedLogsItems>>>::fromJsonValue(Rejected_logsIt->value()));
        }
    }
}

std::vector<std::shared_ptr<IntegrationLogsInvalidLogResponseRejectedLogsItems>> IntegrationLogsInvalidLogResponse::getRejectedLogs() const
{
    return m_Rejected_logs;
}

void IntegrationLogsInvalidLogResponse::setRejectedLogs(std::vector<std::shared_ptr<IntegrationLogsInvalidLogResponseRejectedLogsItems>> value)
{
    
    m_Rejected_logs = std::move(value);
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<IntegrationLogsInvalidLogResponse>>>::toJsonValue(data));
}
...
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<IntegrationLogsInvalidLogResponse>>>::fromJsonValue(boost::json::parse(json));
}
