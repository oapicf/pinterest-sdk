...
CatalogsRetailReportAllItemsFilter::CatalogsRetailReportAllItemsFilter(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string CatalogsRetailReportAllItemsFilter::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value CatalogsRetailReportAllItemsFilter::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogsRetailReportAllItemsFilter::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogsRetailReportAllItemsFilter");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogsRetailReportAllItemsFilter::toJsonObject_internal() const
{
...
void CatalogsRetailReportAllItemsFilter::fromJsonObject_internal(boost::json::object const& object)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogsRetailReportAllItemsFilter>>>::toJsonValue(data));
}
...
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogsRetailReportAllItemsFilter>>>::fromJsonValue(boost::json::parse(json));
}
