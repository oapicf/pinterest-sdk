...
CustomNumber4Filter::CustomNumber4Filter(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value CustomNumber4Filter::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CustomNumber4Filter::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CustomNumber4Filter");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CustomNumber4Filter::toJsonObject_internal() const
{
...
void CustomNumber4Filter::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CustomNumber4Filter>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CustomNumber4Filter>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CustomNumber4Filter>>>::fromJsonValue(boost::json::parse(json));
}
