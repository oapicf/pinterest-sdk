...
FollowUserCreate::FollowUserCreate(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value FollowUserCreate::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void FollowUserCreate::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for FollowUserCreate");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object FollowUserCreate::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_Auto_followIsSet) {
            object["auto_follow"] = JsonValueConverter<bool>::toJsonValue(isAutoFollow());
        }
    return object;
}

void FollowUserCreate::fromJsonObject_internal(boost::json::object const& object)
{
    m_Auto_followIsSet = false;
    {
        const auto Auto_followIt = object.find("auto_follow");
        if (Auto_followIt != object.end()) {
            setAutoFollow(JsonValueConverter<bool>::fromJsonValue(Auto_followIt->value()));
        }
    }
}
...
void FollowUserCreate::setAutoFollow(bool value)
{
    ...
    m_Auto_follow = std::move(value);
    m_Auto_followIsSet = true;
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<FollowUserCreate>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<FollowUserCreate>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<FollowUserCreate>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<FollowUserCreate>>>::fromJsonValue(boost::json::parse(json));
}
