...
FollowUser::FollowUser(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string FollowUser::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value FollowUser::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void FollowUser::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for FollowUser");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object FollowUser::toJsonObject_internal() const
{
...
void FollowUser::fromJsonObject_internal(boost::json::object const& object)
{
    m_TypeIsSet = false;
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<FollowUser>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<FollowUser>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<FollowUser>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<FollowUser>>>::fromJsonValue(boost::json::parse(json));
}
