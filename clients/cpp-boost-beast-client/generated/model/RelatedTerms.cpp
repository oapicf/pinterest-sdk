...
RelatedTerms::RelatedTerms(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value RelatedTerms::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void RelatedTerms::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for RelatedTerms");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object RelatedTerms::toJsonObject_internal() const
{
    boost::json::object object;
        ...
        if (m_Related_term_countIsSet) {
            object["related_term_count"] = JsonValueConverter<int32_t>::toJsonValue(getRelatedTermCount());
        }
        if (m_Related_terms_listIsSet) {
            object["related_terms_list"] = JsonValueConverter<std::vector<std::shared_ptr<RelatedTermsRelatedTermsListItems>>>::toJsonValue(getRelatedTermsList());
        }
    return object;
}

void RelatedTerms::fromJsonObject_internal(boost::json::object const& object)
{
    m_IdIsSet = false;
    ...
    {
        const auto Related_term_countIt = object.find("related_term_count");
        if (Related_term_countIt != object.end()) {
            setRelatedTermCount(JsonValueConverter<int32_t>::fromJsonValue(Related_term_countIt->value()));
        }
    }
    {
        const auto Related_terms_listIt = object.find("related_terms_list");
        if (Related_terms_listIt != object.end()) {
            setRelatedTermsList(JsonValueConverter<std::vector<std::shared_ptr<RelatedTermsRelatedTermsListItems>>>::fromJsonValue(Related_terms_listIt->value()));
        }
    }
}
...
void RelatedTerms::setRelatedTermCount(int32_t value)
{
    ...
    m_Related_term_count = std::move(value);
...
void RelatedTerms::setRelatedTermsList(std::vector<std::shared_ptr<RelatedTermsRelatedTermsListItems>> value)
{
    ...
    m_Related_terms_list = std::move(value);
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<RelatedTerms>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<RelatedTerms>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<RelatedTerms>>>::fromJsonValue(boost::json::parse(json));
}
