...
EventProcessingStatus::EventProcessingStatus(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string EventProcessingStatus::toJsonString(bool prettyJson /* = false */) const
{
...
void EventProcessingStatus::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value EventProcessingStatus::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void EventProcessingStatus::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for EventProcessingStatus");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object EventProcessingStatus::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void EventProcessingStatus::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<EventProcessingStatus>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<EventProcessingStatus>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<EventProcessingStatus>>>::fromJsonValue(boost::json::parse(json));
}
