...
ActionType::ActionType(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ActionType::toJsonString(bool prettyJson /* = false */) const
{
...
void ActionType::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value ActionType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ActionType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ActionType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ActionType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void ActionType::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ActionType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ActionType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ActionType>>>::fromJsonValue(boost::json::parse(json));
}
