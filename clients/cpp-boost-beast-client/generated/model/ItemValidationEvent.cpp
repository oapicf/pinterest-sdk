...
ItemValidationEvent::ItemValidationEvent(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ItemValidationEvent::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value ItemValidationEvent::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ItemValidationEvent::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ItemValidationEvent");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ItemValidationEvent::toJsonObject_internal() const
{
...
void ItemValidationEvent::fromJsonObject_internal(boost::json::object const& object)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ItemValidationEvent>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ItemValidationEvent>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ItemValidationEvent>>>::fromJsonValue(boost::json::parse(json));
}
