...
OperationType::OperationType(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string OperationType::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value OperationType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void OperationType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for OperationType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object OperationType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void OperationType::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<OperationType>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<OperationType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<OperationType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<OperationType>>>::fromJsonValue(boost::json::parse(json));
}
