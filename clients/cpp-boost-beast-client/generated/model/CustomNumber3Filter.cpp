...
CustomNumber3Filter::CustomNumber3Filter(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string CustomNumber3Filter::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value CustomNumber3Filter::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CustomNumber3Filter::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CustomNumber3Filter");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CustomNumber3Filter::toJsonObject_internal() const
{
...
void CustomNumber3Filter::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CustomNumber3Filter>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CustomNumber3Filter>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CustomNumber3Filter>>>::fromJsonValue(boost::json::parse(json));
}
