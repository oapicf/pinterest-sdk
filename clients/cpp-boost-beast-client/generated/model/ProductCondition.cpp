...
ProductCondition::ProductCondition(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ProductCondition::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value ProductCondition::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ProductCondition::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ProductCondition");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ProductCondition::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void ProductCondition::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ProductCondition>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ProductCondition>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ProductCondition>>>::fromJsonValue(boost::json::parse(json));
}
