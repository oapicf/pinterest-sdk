...
ConversionDeletionRequestUserEmailTargets::ConversionDeletionRequestUserEmailTargets(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value ConversionDeletionRequestUserEmailTargets::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ConversionDeletionRequestUserEmailTargets::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ConversionDeletionRequestUserEmailTargets");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ConversionDeletionRequestUserEmailTargets::toJsonObject_internal() const
{
...
void ConversionDeletionRequestUserEmailTargets::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<ConversionDeletionRequestUserEmailTargets>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ConversionDeletionRequestUserEmailTargets>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ConversionDeletionRequestUserEmailTargets>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ConversionDeletionRequestUserEmailTargets>>>::fromJsonValue(boost::json::parse(json));
}
