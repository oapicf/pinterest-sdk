...
CreativeAssetsIdFilter::CreativeAssetsIdFilter(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value CreativeAssetsIdFilter::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CreativeAssetsIdFilter::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CreativeAssetsIdFilter");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CreativeAssetsIdFilter::toJsonObject_internal() const
{
...
void CreativeAssetsIdFilter::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CreativeAssetsIdFilter>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CreativeAssetsIdFilter>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CreativeAssetsIdFilter>>>::fromJsonValue(boost::json::parse(json));
}
