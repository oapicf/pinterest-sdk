...
ConversionProductReportLevel::ConversionProductReportLevel(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ConversionProductReportLevel::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value ConversionProductReportLevel::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ConversionProductReportLevel::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ConversionProductReportLevel");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ConversionProductReportLevel::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void ConversionProductReportLevel::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ConversionProductReportLevel>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ConversionProductReportLevel>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ConversionProductReportLevel>>>::fromJsonValue(boost::json::parse(json));
}
