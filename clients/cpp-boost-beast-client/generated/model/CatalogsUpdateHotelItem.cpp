...
CatalogsUpdateHotelItem::CatalogsUpdateHotelItem(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value CatalogsUpdateHotelItem::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogsUpdateHotelItem::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogsUpdateHotelItem");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogsUpdateHotelItem::toJsonObject_internal() const
{
    boost::json::object object;
        object["attributes"] = JsonValueConverter<std::shared_ptr<CatalogsUpdatableHotelAttributes>>::toJsonValue(getAttributes());
...
void CatalogsUpdateHotelItem::fromJsonObject_internal(boost::json::object const& object)
{
    {
        const auto AttributesIt = object.find("attributes");
        if (AttributesIt != object.end()) {
            setAttributes(JsonValueConverter<std::shared_ptr<CatalogsUpdatableHotelAttributes>>::fromJsonValue(AttributesIt->value()));
        }
    }
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogsUpdateHotelItem>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CatalogsUpdateHotelItem>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogsUpdateHotelItem>>>::fromJsonValue(boost::json::parse(json));
}
