...
CatalogsHotelReportStatsParameters::CatalogsHotelReportStatsParameters(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string CatalogsHotelReportStatsParameters::toJsonString(bool prettyJson /* = false */) const
{
...
void CatalogsHotelReportStatsParameters::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value CatalogsHotelReportStatsParameters::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogsHotelReportStatsParameters::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogsHotelReportStatsParameters");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogsHotelReportStatsParameters::toJsonObject_internal() const
{
    boost::json::object object;
        object["catalog_type"] = JsonValueConverter<std::string>::toJsonValue(getCatalogType());
        object["report"] = JsonValueConverter<std::shared_ptr<CatalogsHotelReportStatsParametersReport>>::toJsonValue(getReport());
    return object;
}

void CatalogsHotelReportStatsParameters::fromJsonObject_internal(boost::json::object const& object)
{
    {
    ...
    }
    {
        ...
        if (ReportIt != object.end()) {
            setReport(JsonValueConverter<std::shared_ptr<CatalogsHotelReportStatsParametersReport>>::fromJsonValue(ReportIt->value()));
        }
    }
}
...
void CatalogsHotelReportStatsParameters::setCatalogType(std::string value)
{
...
void CatalogsHotelReportStatsParameters::setReport(std::shared_ptr<CatalogsHotelReportStatsParametersReport> value)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogsHotelReportStatsParameters>>>::toJsonValue(data));
}
...
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogsHotelReportStatsParameters>>>::fromJsonValue(boost::json::parse(json));
}
