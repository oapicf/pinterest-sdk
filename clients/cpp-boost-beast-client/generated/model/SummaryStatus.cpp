...
SummaryStatus::SummaryStatus(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string SummaryStatus::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value SummaryStatus::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void SummaryStatus::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for SummaryStatus");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object SummaryStatus::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void SummaryStatus::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<SummaryStatus>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<SummaryStatus>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<SummaryStatus>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<SummaryStatus>>>::fromJsonValue(boost::json::parse(json));
}
