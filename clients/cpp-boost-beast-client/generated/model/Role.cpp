...
Role::Role(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value Role::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void Role::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for Role");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object Role::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void Role::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<Role>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<Role>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<Role>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<Role>>>::fromJsonValue(boost::json::parse(json));
}
