...
MatchType::MatchType(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string MatchType::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value MatchType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void MatchType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for MatchType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object MatchType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void MatchType::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<MatchType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<MatchType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<MatchType>>>::fromJsonValue(boost::json::parse(json));
}
