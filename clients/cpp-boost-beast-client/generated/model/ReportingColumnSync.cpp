...
ReportingColumnSync::ReportingColumnSync(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ReportingColumnSync::toJsonString(bool prettyJson /* = false */) const
{
...
void ReportingColumnSync::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value ReportingColumnSync::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ReportingColumnSync::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ReportingColumnSync");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ReportingColumnSync::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void ReportingColumnSync::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<ReportingColumnSync>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ReportingColumnSync>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ReportingColumnSync>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ReportingColumnSync>>>::fromJsonValue(boost::json::parse(json));
}
