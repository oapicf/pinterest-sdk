...
CatalogsStatus::CatalogsStatus(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string CatalogsStatus::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value CatalogsStatus::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogsStatus::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogsStatus");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogsStatus::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void CatalogsStatus::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogsStatus>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CatalogsStatus>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogsStatus>>>::fromJsonValue(boost::json::parse(json));
}
