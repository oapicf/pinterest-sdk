...
AdPinAnalytics::AdPinAnalytics(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value AdPinAnalytics::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AdPinAnalytics::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AdPinAnalytics");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AdPinAnalytics::toJsonObject_internal() const
{
...
void AdPinAnalytics::fromJsonObject_internal(boost::json::object const& object)
{
    m_DATEIsSet = false;
    {
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<AdPinAnalytics>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AdPinAnalytics>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AdPinAnalytics>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AdPinAnalytics>>>::fromJsonValue(boost::json::parse(json));
}
