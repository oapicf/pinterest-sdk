...
#ifndef BOOST_BEAST_OPENAPI_CLIENT_CatalogsFeedValidationErrors_MODEL_H_
#define BOOST_BEAST_OPENAPI_CLIENT_CatalogsFeedValidationErrors_MODEL_H_
...
public:
    ...
    explicit CatalogsFeedValidationErrors(boost::json::value const& value);
...
protected:
    ...
    bool m_DELIMITER_ERRORIsSet = false;
    ...
    bool m_ENCODING_ERRORIsSet = false;
    int32_t m_FEED_LENGTH_TOO_LONG = 0;
    bool m_FEED_LENGTH_TOO_LONGIsSet = false;
    int32_t m_FEED_TOO_SMALL = 0;
    bool m_FEED_TOO_SMALLIsSet = false;
    int32_t m_FETCH_ERROR = 0;
    bool m_FETCH_ERRORIsSet = false;
    int32_t m_FETCH_INACTIVE_FEED_ERROR = 0;
    bool m_FETCH_INACTIVE_FEED_ERRORIsSet = false;
    ...
    bool m_INTERNAL_SERVICE_ERRORIsSet = false;
    ...
    bool m_MALFORMED_XMLIsSet = false;
    ...
    bool m_NO_VERIFIED_DOMAINIsSet = false;
    ...
    bool m_REQUIRED_COLUMNS_MISSINGIsSet = false;
...
#endif /* BOOST_BEAST_OPENAPI_CLIENT_CatalogsFeedValidationErrors_MODEL_H_ */
