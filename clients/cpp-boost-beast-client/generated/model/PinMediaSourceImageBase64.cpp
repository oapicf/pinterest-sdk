...
PinMediaSourceImageBase64::PinMediaSourceImageBase64(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value PinMediaSourceImageBase64::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void PinMediaSourceImageBase64::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for PinMediaSourceImageBase64");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object PinMediaSourceImageBase64::toJsonObject_internal() const
{
...
void PinMediaSourceImageBase64::fromJsonObject_internal(boost::json::object const& object)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<PinMediaSourceImageBase64>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<PinMediaSourceImageBase64>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<PinMediaSourceImageBase64>>>::fromJsonValue(boost::json::parse(json));
}
