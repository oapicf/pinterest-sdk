...
CampaignObjectiveType::CampaignObjectiveType(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string CampaignObjectiveType::toJsonString(bool prettyJson /* = false */) const
{
...
void CampaignObjectiveType::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value CampaignObjectiveType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CampaignObjectiveType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CampaignObjectiveType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CampaignObjectiveType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void CampaignObjectiveType::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CampaignObjectiveType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CampaignObjectiveType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CampaignObjectiveType>>>::fromJsonValue(boost::json::parse(json));
}
