...
UpdatePartnerAssetsResultsResponseArray::UpdatePartnerAssetsResultsResponseArray(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string UpdatePartnerAssetsResultsResponseArray::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value UpdatePartnerAssetsResultsResponseArray::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void UpdatePartnerAssetsResultsResponseArray::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for UpdatePartnerAssetsResultsResponseArray");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object UpdatePartnerAssetsResultsResponseArray::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_ItemsIsSet) {
            object["items"] = JsonValueConverter<std::vector<std::shared_ptr<UpdatePartnerAssetsResult>>>::toJsonValue(getItems());
        }
    return object;
}

void UpdatePartnerAssetsResultsResponseArray::fromJsonObject_internal(boost::json::object const& object)
{
    m_ItemsIsSet = false;
    {
        const auto ItemsIt = object.find("items");
        if (ItemsIt != object.end()) {
            setItems(JsonValueConverter<std::vector<std::shared_ptr<UpdatePartnerAssetsResult>>>::fromJsonValue(ItemsIt->value()));
        }
    }
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<UpdatePartnerAssetsResultsResponseArray>>>::toJsonValue(data));
}
...
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<UpdatePartnerAssetsResultsResponseArray>>>::fromJsonValue(boost::json::parse(json));
}
