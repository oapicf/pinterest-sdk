...
KeywordInfo::KeywordInfo(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string KeywordInfo::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value KeywordInfo::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void KeywordInfo::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for KeywordInfo");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object KeywordInfo::toJsonObject_internal() const
{
    boost::json::object object;
        object["name"] = JsonValueConverter<std::string>::toJsonValue(getName());
        if (m_Pct_growth_momIsSet) {
            object["pct_growth_mom"] = JsonValueConverter<double>::toJsonValue(getPctGrowthMom());
        }
    return object;
}

void KeywordInfo::fromJsonObject_internal(boost::json::object const& object)
{
    ...
    }
    {
        ...
        if (Pct_growth_momIt != object.end()) {
            setPctGrowthMom(JsonValueConverter<double>::fromJsonValue(Pct_growth_momIt->value()));
        }
    }
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<KeywordInfo>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<KeywordInfo>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<KeywordInfo>>>::fromJsonValue(boost::json::parse(json));
}
