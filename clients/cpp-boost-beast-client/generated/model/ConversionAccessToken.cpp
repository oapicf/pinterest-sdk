...
ConversionAccessToken::ConversionAccessToken(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ConversionAccessToken::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value ConversionAccessToken::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ConversionAccessToken::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ConversionAccessToken");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ConversionAccessToken::toJsonObject_internal() const
{
...
void ConversionAccessToken::fromJsonObject_internal(boost::json::object const& object)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ConversionAccessToken>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ConversionAccessToken>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ConversionAccessToken>>>::fromJsonValue(boost::json::parse(json));
}
