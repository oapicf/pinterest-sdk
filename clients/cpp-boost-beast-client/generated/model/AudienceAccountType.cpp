...
AudienceAccountType::AudienceAccountType(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string AudienceAccountType::toJsonString(bool prettyJson /* = false */) const
{
...
void AudienceAccountType::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value AudienceAccountType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AudienceAccountType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AudienceAccountType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AudienceAccountType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void AudienceAccountType::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AudienceAccountType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AudienceAccountType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AudienceAccountType>>>::fromJsonValue(boost::json::parse(json));
}
