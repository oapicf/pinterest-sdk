...
CustomLabel4Filter::CustomLabel4Filter(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value CustomLabel4Filter::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CustomLabel4Filter::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CustomLabel4Filter");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CustomLabel4Filter::toJsonObject_internal() const
{
...
void CustomLabel4Filter::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CustomLabel4Filter>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CustomLabel4Filter>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CustomLabel4Filter>>>::fromJsonValue(boost::json::parse(json));
}
