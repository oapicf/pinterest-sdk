...
DeleteMemberAssetAccessItem::DeleteMemberAssetAccessItem(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value DeleteMemberAssetAccessItem::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void DeleteMemberAssetAccessItem::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for DeleteMemberAssetAccessItem");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object DeleteMemberAssetAccessItem::toJsonObject_internal() const
{
...
void DeleteMemberAssetAccessItem::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<DeleteMemberAssetAccessItem>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<DeleteMemberAssetAccessItem>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<DeleteMemberAssetAccessItem>>>::fromJsonValue(boost::json::parse(json));
}
