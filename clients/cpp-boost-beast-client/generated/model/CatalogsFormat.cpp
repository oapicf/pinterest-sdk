...
CatalogsFormat::CatalogsFormat(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string CatalogsFormat::toJsonString(bool prettyJson /* = false */) const
{
...
void CatalogsFormat::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value CatalogsFormat::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogsFormat::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogsFormat");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogsFormat::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void CatalogsFormat::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<CatalogsFormat>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogsFormat>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CatalogsFormat>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogsFormat>>>::fromJsonValue(boost::json::parse(json));
}
