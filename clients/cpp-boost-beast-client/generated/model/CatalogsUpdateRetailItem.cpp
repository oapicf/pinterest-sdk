...
CatalogsUpdateRetailItem::CatalogsUpdateRetailItem(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value CatalogsUpdateRetailItem::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogsUpdateRetailItem::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogsUpdateRetailItem");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogsUpdateRetailItem::toJsonObject_internal() const
{
    boost::json::object object;
        object["attributes"] = JsonValueConverter<std::shared_ptr<UpdatableItemAttributes>>::toJsonValue(getAttributes());
...
void CatalogsUpdateRetailItem::fromJsonObject_internal(boost::json::object const& object)
{
    m_Update_maskIsSet = false;
    {
        const auto AttributesIt = object.find("attributes");
        if (AttributesIt != object.end()) {
            setAttributes(JsonValueConverter<std::shared_ptr<UpdatableItemAttributes>>::fromJsonValue(AttributesIt->value()));
        }
    }
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogsUpdateRetailItem>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CatalogsUpdateRetailItem>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogsUpdateRetailItem>>>::fromJsonValue(boost::json::parse(json));
}
