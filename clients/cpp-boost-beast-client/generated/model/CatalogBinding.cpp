...
CatalogBinding::CatalogBinding(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value CatalogBinding::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogBinding::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogBinding");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogBinding::toJsonObject_internal() const
{
...
void CatalogBinding::fromJsonObject_internal(boost::json::object const& object)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogBinding>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CatalogBinding>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogBinding>>>::fromJsonValue(boost::json::parse(json));
}
