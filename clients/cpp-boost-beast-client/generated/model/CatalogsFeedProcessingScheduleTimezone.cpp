...
CatalogsFeedProcessingScheduleTimezone::CatalogsFeedProcessingScheduleTimezone(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string CatalogsFeedProcessingScheduleTimezone::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value CatalogsFeedProcessingScheduleTimezone::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogsFeedProcessingScheduleTimezone::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogsFeedProcessingScheduleTimezone");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogsFeedProcessingScheduleTimezone::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void CatalogsFeedProcessingScheduleTimezone::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<CatalogsFeedProcessingScheduleTimezone>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogsFeedProcessingScheduleTimezone>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CatalogsFeedProcessingScheduleTimezone>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogsFeedProcessingScheduleTimezone>>>::fromJsonValue(boost::json::parse(json));
}
