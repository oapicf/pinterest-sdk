...
ProductGroupPromotions::ProductGroupPromotions(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ProductGroupPromotions::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value ProductGroupPromotions::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ProductGroupPromotions::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ProductGroupPromotions");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ProductGroupPromotions::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_ItemsIsSet) {
            object["items"] = JsonValueConverter<std::vector<std::shared_ptr<ProductGroupPromotionResponseItem>>>::toJsonValue(getItems());
        }
    return object;
}

void ProductGroupPromotions::fromJsonObject_internal(boost::json::object const& object)
{
    m_ItemsIsSet = false;
    {
        const auto ItemsIt = object.find("items");
        if (ItemsIt != object.end()) {
            setItems(JsonValueConverter<std::vector<std::shared_ptr<ProductGroupPromotionResponseItem>>>::fromJsonValue(ItemsIt->value()));
        }
    }
}
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<ProductGroupPromotions>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ProductGroupPromotions>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ProductGroupPromotions>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ProductGroupPromotions>>>::fromJsonValue(boost::json::parse(json));
}
