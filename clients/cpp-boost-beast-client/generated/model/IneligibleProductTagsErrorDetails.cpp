...
IneligibleProductTagsErrorDetails::IneligibleProductTagsErrorDetails(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value IneligibleProductTagsErrorDetails::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void IneligibleProductTagsErrorDetails::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for IneligibleProductTagsErrorDetails");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object IneligibleProductTagsErrorDetails::toJsonObject_internal() const
{
    boost::json::object object;
        object["product_tags"] = JsonValueConverter<std::vector<std::shared_ptr<IneligibleProductTagErrorItem>>>::toJsonValue(getProductTags());
    return object;
}

void IneligibleProductTagsErrorDetails::fromJsonObject_internal(boost::json::object const& object)
{
    {
        const auto Product_tagsIt = object.find("product_tags");
        if (Product_tagsIt != object.end()) {
            setProductTags(JsonValueConverter<std::vector<std::shared_ptr<IneligibleProductTagErrorItem>>>::fromJsonValue(Product_tagsIt->value()));
        }
    }
}
...
void IneligibleProductTagsErrorDetails::setProductTags(std::vector<std::shared_ptr<IneligibleProductTagErrorItem>> value)
{
    ...
    m_Product_tags = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<IneligibleProductTagsErrorDetails>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<IneligibleProductTagsErrorDetails>>>::toJsonValue(data));
}
...
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<IneligibleProductTagsErrorDetails>>>::fromJsonValue(boost::json::parse(json));
}
