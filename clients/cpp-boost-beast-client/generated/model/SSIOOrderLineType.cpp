...
SSIOOrderLineType::SSIOOrderLineType(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string SSIOOrderLineType::toJsonString(bool prettyJson /* = false */) const
{
...
void SSIOOrderLineType::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value SSIOOrderLineType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void SSIOOrderLineType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for SSIOOrderLineType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object SSIOOrderLineType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void SSIOOrderLineType::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<SSIOOrderLineType>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<SSIOOrderLineType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<SSIOOrderLineType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<SSIOOrderLineType>>>::fromJsonValue(boost::json::parse(json));
}
