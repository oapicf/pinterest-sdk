...
CustomNumber1Filter::CustomNumber1Filter(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string CustomNumber1Filter::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value CustomNumber1Filter::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CustomNumber1Filter::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CustomNumber1Filter");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CustomNumber1Filter::toJsonObject_internal() const
{
...
void CustomNumber1Filter::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CustomNumber1Filter>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CustomNumber1Filter>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CustomNumber1Filter>>>::fromJsonValue(boost::json::parse(json));
}
