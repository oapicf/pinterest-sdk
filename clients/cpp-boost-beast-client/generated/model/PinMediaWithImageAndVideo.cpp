...
PinMediaWithImageAndVideo::PinMediaWithImageAndVideo(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value PinMediaWithImageAndVideo::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void PinMediaWithImageAndVideo::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for PinMediaWithImageAndVideo");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object PinMediaWithImageAndVideo::toJsonObject_internal() const
{
...
void PinMediaWithImageAndVideo::fromJsonObject_internal(boost::json::object const& object)
{
    m_ItemsIsSet = false;
    {
...
void PinMediaWithImageAndVideo::setItems(std::vector<std::shared_ptr<PinMediaMetadata>> value)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<PinMediaWithImageAndVideo>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<PinMediaWithImageAndVideo>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<PinMediaWithImageAndVideo>>>::fromJsonValue(boost::json::parse(json));
}
