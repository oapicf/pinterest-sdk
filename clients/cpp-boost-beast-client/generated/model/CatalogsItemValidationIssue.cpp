...
CatalogsItemValidationIssue::CatalogsItemValidationIssue(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value CatalogsItemValidationIssue::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogsItemValidationIssue::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogsItemValidationIssue");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogsItemValidationIssue::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void CatalogsItemValidationIssue::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<CatalogsItemValidationIssue>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogsItemValidationIssue>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CatalogsItemValidationIssue>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogsItemValidationIssue>>>::fromJsonValue(boost::json::parse(json));
}
