...
MediaUploadCreate::MediaUploadCreate(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string MediaUploadCreate::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value MediaUploadCreate::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void MediaUploadCreate::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for MediaUploadCreate");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object MediaUploadCreate::toJsonObject_internal() const
{
...
void MediaUploadCreate::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<MediaUploadCreate>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<MediaUploadCreate>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<MediaUploadCreate>>>::fromJsonValue(boost::json::parse(json));
}
