...
CatalogsVerticalBatchRequest::CatalogsVerticalBatchRequest(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value CatalogsVerticalBatchRequest::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogsVerticalBatchRequest::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogsVerticalBatchRequest");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogsVerticalBatchRequest::toJsonObject_internal() const
{
...
void CatalogsVerticalBatchRequest::fromJsonObject_internal(boost::json::object const& object)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<CatalogsVerticalBatchRequest>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogsVerticalBatchRequest>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CatalogsVerticalBatchRequest>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogsVerticalBatchRequest>>>::fromJsonValue(boost::json::parse(json));
}
