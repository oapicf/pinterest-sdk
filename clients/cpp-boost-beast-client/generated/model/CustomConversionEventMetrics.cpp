...
CustomConversionEventMetrics::CustomConversionEventMetrics(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string CustomConversionEventMetrics::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value CustomConversionEventMetrics::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CustomConversionEventMetrics::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CustomConversionEventMetrics");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CustomConversionEventMetrics::toJsonObject_internal() const
{
    boost::json::object object;
        object["custom_event_metrics_type"] = JsonValueConverter<std::shared_ptr<AdeColumnType>>::toJsonValue(getCustomEventMetricsType());
        object["custom_event_name"] = JsonValueConverter<std::string>::toJsonValue(getCustomEventName());
    return object;
}

void CustomConversionEventMetrics::fromJsonObject_internal(boost::json::object const& object)
{
    {
        const auto Custom_event_metrics_typeIt = object.find("custom_event_metrics_type");
        if (Custom_event_metrics_typeIt != object.end()) {
            setCustomEventMetricsType(JsonValueConverter<std::shared_ptr<AdeColumnType>>::fromJsonValue(Custom_event_metrics_typeIt->value()));
        }
    }
    {
        const auto Custom_event_nameIt = object.find("custom_event_name");
        if (Custom_event_nameIt != object.end()) {
            setCustomEventName(JsonValueConverter<std::string>::fromJsonValue(Custom_event_nameIt->value()));
        }
    }
}
...
void CustomConversionEventMetrics::setCustomEventMetricsType(std::shared_ptr<AdeColumnType> value)
{
    ...
    m_Custom_event_metrics_type = std::move(value);
}
...
void CustomConversionEventMetrics::setCustomEventName(std::string value)
{
    ...
    m_Custom_event_name = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<CustomConversionEventMetrics>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CustomConversionEventMetrics>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CustomConversionEventMetrics>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CustomConversionEventMetrics>>>::fromJsonValue(boost::json::parse(json));
}
