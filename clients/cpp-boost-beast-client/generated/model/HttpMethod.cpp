...
HttpMethod::HttpMethod(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string HttpMethod::toJsonString(bool prettyJson /* = false */) const
{
...
void HttpMethod::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value HttpMethod::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void HttpMethod::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for HttpMethod");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object HttpMethod::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void HttpMethod::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<HttpMethod>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<HttpMethod>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<HttpMethod>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<HttpMethod>>>::fromJsonValue(boost::json::parse(json));
}
