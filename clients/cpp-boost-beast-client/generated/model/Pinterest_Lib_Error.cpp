...
Pinterest_Lib_Error::Pinterest_Lib_Error(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string Pinterest_Lib_Error::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value Pinterest_Lib_Error::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void Pinterest_Lib_Error::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for Pinterest_Lib_Error");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object Pinterest_Lib_Error::toJsonObject_internal() const
{
...
void Pinterest_Lib_Error::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<Pinterest_Lib_Error>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<Pinterest_Lib_Error>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<Pinterest_Lib_Error>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<Pinterest_Lib_Error>>>::fromJsonValue(boost::json::parse(json));
}
