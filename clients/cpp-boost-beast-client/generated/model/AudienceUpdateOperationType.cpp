...
AudienceUpdateOperationType::AudienceUpdateOperationType(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string AudienceUpdateOperationType::toJsonString(bool prettyJson /* = false */) const
{
...
void AudienceUpdateOperationType::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value AudienceUpdateOperationType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AudienceUpdateOperationType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AudienceUpdateOperationType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AudienceUpdateOperationType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void AudienceUpdateOperationType::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AudienceUpdateOperationType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AudienceUpdateOperationType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AudienceUpdateOperationType>>>::fromJsonValue(boost::json::parse(json));
}
