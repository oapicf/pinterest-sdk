...
AssetSearchBy::AssetSearchBy(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value AssetSearchBy::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AssetSearchBy::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AssetSearchBy");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AssetSearchBy::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void AssetSearchBy::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AssetSearchBy>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AssetSearchBy>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AssetSearchBy>>>::fromJsonValue(boost::json::parse(json));
}
