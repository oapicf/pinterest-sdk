...
AdDisapprovalReasons::AdDisapprovalReasons(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value AdDisapprovalReasons::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AdDisapprovalReasons::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AdDisapprovalReasons");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AdDisapprovalReasons::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void AdDisapprovalReasons::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AdDisapprovalReasons>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AdDisapprovalReasons>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AdDisapprovalReasons>>>::fromJsonValue(boost::json::parse(json));
}
