...
NullableLabelStatus::NullableLabelStatus(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value NullableLabelStatus::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void NullableLabelStatus::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for NullableLabelStatus");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object NullableLabelStatus::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void NullableLabelStatus::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<NullableLabelStatus>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<NullableLabelStatus>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<NullableLabelStatus>>>::fromJsonValue(boost::json::parse(json));
}
