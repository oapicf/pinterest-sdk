...
ConditionFilter::ConditionFilter(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ConditionFilter::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value ConditionFilter::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ConditionFilter::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ConditionFilter");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ConditionFilter::toJsonObject_internal() const
{
...
void ConditionFilter::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<ConditionFilter>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ConditionFilter>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ConditionFilter>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ConditionFilter>>>::fromJsonValue(boost::json::parse(json));
}
