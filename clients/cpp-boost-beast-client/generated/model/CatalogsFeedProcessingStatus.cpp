...
CatalogsFeedProcessingStatus::CatalogsFeedProcessingStatus(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value CatalogsFeedProcessingStatus::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogsFeedProcessingStatus::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogsFeedProcessingStatus");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogsFeedProcessingStatus::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void CatalogsFeedProcessingStatus::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<CatalogsFeedProcessingStatus>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogsFeedProcessingStatus>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CatalogsFeedProcessingStatus>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogsFeedProcessingStatus>>>::fromJsonValue(boost::json::parse(json));
}
