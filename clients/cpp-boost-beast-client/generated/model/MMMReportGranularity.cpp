...
MMMReportGranularity::MMMReportGranularity(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string MMMReportGranularity::toJsonString(bool prettyJson /* = false */) const
{
...
void MMMReportGranularity::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value MMMReportGranularity::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void MMMReportGranularity::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for MMMReportGranularity");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object MMMReportGranularity::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void MMMReportGranularity::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<MMMReportGranularity>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<MMMReportGranularity>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<MMMReportGranularity>>>::fromJsonValue(boost::json::parse(json));
}
