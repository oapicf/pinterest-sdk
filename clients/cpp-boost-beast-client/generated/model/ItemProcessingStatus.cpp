...
ItemProcessingStatus::ItemProcessingStatus(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ItemProcessingStatus::toJsonString(bool prettyJson /* = false */) const
{
...
void ItemProcessingStatus::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value ItemProcessingStatus::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ItemProcessingStatus::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ItemProcessingStatus");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ItemProcessingStatus::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void ItemProcessingStatus::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ItemProcessingStatus>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ItemProcessingStatus>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ItemProcessingStatus>>>::fromJsonValue(boost::json::parse(json));
}
