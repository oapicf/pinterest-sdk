...
ProductCategoriesEngagementType::ProductCategoriesEngagementType(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ProductCategoriesEngagementType::toJsonString(bool prettyJson /* = false */) const
{
...
void ProductCategoriesEngagementType::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value ProductCategoriesEngagementType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ProductCategoriesEngagementType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ProductCategoriesEngagementType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ProductCategoriesEngagementType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void ProductCategoriesEngagementType::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<ProductCategoriesEngagementType>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ProductCategoriesEngagementType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ProductCategoriesEngagementType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ProductCategoriesEngagementType>>>::fromJsonValue(boost::json::parse(json));
}
