...
AttributionMatchType::AttributionMatchType(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value AttributionMatchType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AttributionMatchType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AttributionMatchType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AttributionMatchType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void AttributionMatchType::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AttributionMatchType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AttributionMatchType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AttributionMatchType>>>::fromJsonValue(boost::json::parse(json));
}
