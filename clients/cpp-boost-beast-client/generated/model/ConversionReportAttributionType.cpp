...
ConversionReportAttributionType::ConversionReportAttributionType(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ConversionReportAttributionType::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value ConversionReportAttributionType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ConversionReportAttributionType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ConversionReportAttributionType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ConversionReportAttributionType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void ConversionReportAttributionType::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<ConversionReportAttributionType>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ConversionReportAttributionType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ConversionReportAttributionType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ConversionReportAttributionType>>>::fromJsonValue(boost::json::parse(json));
}
