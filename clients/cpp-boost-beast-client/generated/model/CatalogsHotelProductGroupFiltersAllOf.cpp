...
CatalogsHotelProductGroupFiltersAllOf::CatalogsHotelProductGroupFiltersAllOf(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string CatalogsHotelProductGroupFiltersAllOf::toJsonString(bool prettyJson /* = false */) const
{
...
void CatalogsHotelProductGroupFiltersAllOf::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value CatalogsHotelProductGroupFiltersAllOf::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogsHotelProductGroupFiltersAllOf::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogsHotelProductGroupFiltersAllOf");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogsHotelProductGroupFiltersAllOf::toJsonObject_internal() const
{
...
void CatalogsHotelProductGroupFiltersAllOf::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
std::vector<std::shared_ptr<CatalogsHotelProductGroupFilterKeys>> CatalogsHotelProductGroupFiltersAllOf::getAllOf() const
{
    return m_All_of;
}

void CatalogsHotelProductGroupFiltersAllOf::setAllOf(std::vector<std::shared_ptr<CatalogsHotelProductGroupFilterKeys>> value)
{
    
    m_All_of = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<CatalogsHotelProductGroupFiltersAllOf>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogsHotelProductGroupFiltersAllOf>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CatalogsHotelProductGroupFiltersAllOf>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogsHotelProductGroupFiltersAllOf>>>::fromJsonValue(boost::json::parse(json));
}
