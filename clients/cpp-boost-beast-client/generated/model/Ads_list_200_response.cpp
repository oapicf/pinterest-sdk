...
Ads_list_200_response::Ads_list_200_response(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string Ads_list_200_response::toJsonString(bool prettyJson /* = false */) const
{
...
void Ads_list_200_response::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value Ads_list_200_response::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void Ads_list_200_response::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for Ads_list_200_response");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object Ads_list_200_response::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_BookmarkIsSet) {
            object["bookmark"] = JsonValueConverter<std::string>::toJsonValue(getBookmark());
        }
        object["items"] = JsonValueConverter<std::vector<std::shared_ptr<Ad>>>::toJsonValue(getItems());
    return object;
}

void Ads_list_200_response::fromJsonObject_internal(boost::json::object const& object)
{
    ...
    }
    {
        ...
        if (ItemsIt != object.end()) {
            setItems(JsonValueConverter<std::vector<std::shared_ptr<Ad>>>::fromJsonValue(ItemsIt->value()));
        }
    }
}
...
void Ads_list_200_response::setBookmark(std::string value)
{
    
    m_Bookmark = std::move(value);
    m_BookmarkIsSet = true;
}
std::vector<std::shared_ptr<Ad>> Ads_list_200_response::getItems() const
{
    return m_Items;
}

void Ads_list_200_response::setItems(std::vector<std::shared_ptr<Ad>> value)
{
    
    m_Items = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<Ads_list_200_response>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<Ads_list_200_response>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<Ads_list_200_response>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<Ads_list_200_response>>>::fromJsonValue(boost::json::parse(json));
}
