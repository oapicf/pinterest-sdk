...
SSIOAccountAddress::SSIOAccountAddress(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value SSIOAccountAddress::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void SSIOAccountAddress::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for SSIOAccountAddress");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object SSIOAccountAddress::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_Address_idIsSet) {
            object["address_id"] = JsonValueConverter<std::string>::toJsonValue(getAddressId());
        }
        if (m_DisplayIsSet) {
            object["display"] = JsonValueConverter<std::string>::toJsonValue(getDisplay());
        }
        if (m_Order_legal_entityIsSet) {
            object["order_legal_entity"] = JsonValueConverter<std::string>::toJsonValue(getOrderLegalEntity());
        }
        if (m_PurposeIsSet) {
            object["purpose"] = JsonValueConverter<std::string>::toJsonValue(getPurpose());
        }
    return object;
}

void SSIOAccountAddress::fromJsonObject_internal(boost::json::object const& object)
{
    ...
    {
        const auto Address_idIt = object.find("address_id");
        if (Address_idIt != object.end()) {
            setAddressId(JsonValueConverter<std::string>::fromJsonValue(Address_idIt->value()));
        }
    }
    {
        const auto DisplayIt = object.find("display");
        if (DisplayIt != object.end()) {
            setDisplay(JsonValueConverter<std::string>::fromJsonValue(DisplayIt->value()));
        }
    }
    {
        const auto Order_legal_entityIt = object.find("order_legal_entity");
        if (Order_legal_entityIt != object.end()) {
            setOrderLegalEntity(JsonValueConverter<std::string>::fromJsonValue(Order_legal_entityIt->value()));
        }
    }
    {
        const auto PurposeIt = object.find("purpose");
        if (PurposeIt != object.end()) {
            setPurpose(JsonValueConverter<std::string>::fromJsonValue(PurposeIt->value()));
        }
    }
}
...
void SSIOAccountAddress::setOrderLegalEntity(std::string value)
{
    ...
    m_Order_legal_entity = std::move(value);
...
void SSIOAccountAddress::setPurpose(std::string value)
{
    ...
    m_Purpose = std::move(value);
    m_PurposeIsSet = true;
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<SSIOAccountAddress>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<SSIOAccountAddress>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<SSIOAccountAddress>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<SSIOAccountAddress>>>::fromJsonValue(boost::json::parse(json));
}
