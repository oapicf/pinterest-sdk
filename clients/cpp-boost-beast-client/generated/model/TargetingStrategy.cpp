...
TargetingStrategy::TargetingStrategy(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string TargetingStrategy::toJsonString(bool prettyJson /* = false */) const
{
...
void TargetingStrategy::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value TargetingStrategy::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void TargetingStrategy::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for TargetingStrategy");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object TargetingStrategy::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void TargetingStrategy::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<TargetingStrategy>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<TargetingStrategy>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<TargetingStrategy>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<TargetingStrategy>>>::fromJsonValue(boost::json::parse(json));
}
