...
ErrorDetail::ErrorDetail(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value ErrorDetail::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ErrorDetail::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ErrorDetail");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ErrorDetail::toJsonObject_internal() const
{
    boost::json::object object;
        object["count"] = JsonValueConverter<int32_t>::toJsonValue(getCount());
        object["error_code"] = JsonValueConverter<int32_t>::toJsonValue(getErrorCode());
        object["message"] = JsonValueConverter<std::string>::toJsonValue(getMessage());
    return object;
}

void ErrorDetail::fromJsonObject_internal(boost::json::object const& object)
{
    {
    ...
    {
        const auto Error_codeIt = object.find("error_code");
        if (Error_codeIt != object.end()) {
            setErrorCode(JsonValueConverter<int32_t>::fromJsonValue(Error_codeIt->value()));
        }
    }
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ErrorDetail>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ErrorDetail>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ErrorDetail>>>::fromJsonValue(boost::json::parse(json));
}
