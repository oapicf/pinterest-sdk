...
CatalogsReportParameters::CatalogsReportParameters(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string CatalogsReportParameters::toJsonString(bool prettyJson /* = false */) const
{
...
void CatalogsReportParameters::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value CatalogsReportParameters::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogsReportParameters::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogsReportParameters");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogsReportParameters::toJsonObject_internal() const
{
...
void CatalogsReportParameters::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
std::string CatalogsReportParameters::getCatalogType() const
{
    return m_Catalog_type;
}

void CatalogsReportParameters::setCatalogType(std::string value)
{
...
std::shared_ptr<CatalogsHotelReportParametersReport> CatalogsReportParameters::getReport() const
{
    return m_Report;
}

void CatalogsReportParameters::setReport(std::shared_ptr<CatalogsHotelReportParametersReport> value)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogsReportParameters>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CatalogsReportParameters>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogsReportParameters>>>::fromJsonValue(boost::json::parse(json));
}
