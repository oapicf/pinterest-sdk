...
BillingProfileStatus::BillingProfileStatus(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string BillingProfileStatus::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value BillingProfileStatus::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void BillingProfileStatus::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for BillingProfileStatus");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object BillingProfileStatus::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void BillingProfileStatus::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<BillingProfileStatus>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<BillingProfileStatus>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<BillingProfileStatus>>>::fromJsonValue(boost::json::parse(json));
}
