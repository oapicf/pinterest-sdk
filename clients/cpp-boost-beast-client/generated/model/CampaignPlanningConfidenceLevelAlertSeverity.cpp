...
CampaignPlanningConfidenceLevelAlertSeverity::CampaignPlanningConfidenceLevelAlertSeverity(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string CampaignPlanningConfidenceLevelAlertSeverity::toJsonString(bool prettyJson /* = false */) const
{
...
void CampaignPlanningConfidenceLevelAlertSeverity::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value CampaignPlanningConfidenceLevelAlertSeverity::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CampaignPlanningConfidenceLevelAlertSeverity::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CampaignPlanningConfidenceLevelAlertSeverity");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CampaignPlanningConfidenceLevelAlertSeverity::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void CampaignPlanningConfidenceLevelAlertSeverity::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CampaignPlanningConfidenceLevelAlertSeverity>>>::toJsonValue(data));
}
...
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CampaignPlanningConfidenceLevelAlertSeverity>>>::fromJsonValue(boost::json::parse(json));
}
