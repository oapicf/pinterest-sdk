...
CampaignPlanningResponseError::CampaignPlanningResponseError(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string CampaignPlanningResponseError::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value CampaignPlanningResponseError::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CampaignPlanningResponseError::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CampaignPlanningResponseError");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CampaignPlanningResponseError::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_CodeIsSet) {
            object["code"] = JsonValueConverter<std::shared_ptr<CampaignPlanningResponseErrorCode>>::toJsonValue(getCode());
        }
        if (m_MessageIsSet) {
...
void CampaignPlanningResponseError::fromJsonObject_internal(boost::json::object const& object)
{
    m_CodeIsSet = false;
    m_MessageIsSet = false;
    {
        ...
        if (CodeIt != object.end()) {
            setCode(JsonValueConverter<std::shared_ptr<CampaignPlanningResponseErrorCode>>::fromJsonValue(CodeIt->value()));
        }
    }
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CampaignPlanningResponseError>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CampaignPlanningResponseError>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CampaignPlanningResponseError>>>::fromJsonValue(boost::json::parse(json));
}
