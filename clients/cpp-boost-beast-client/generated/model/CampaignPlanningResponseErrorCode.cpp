...
CampaignPlanningResponseErrorCode::CampaignPlanningResponseErrorCode(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string CampaignPlanningResponseErrorCode::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value CampaignPlanningResponseErrorCode::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CampaignPlanningResponseErrorCode::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CampaignPlanningResponseErrorCode");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CampaignPlanningResponseErrorCode::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void CampaignPlanningResponseErrorCode::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CampaignPlanningResponseErrorCode>>>::toJsonValue(data));
}
...
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CampaignPlanningResponseErrorCode>>>::fromJsonValue(boost::json::parse(json));
}
