...
CustomizableCTAType::CustomizableCTAType(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string CustomizableCTAType::toJsonString(bool prettyJson /* = false */) const
{
...
void CustomizableCTAType::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value CustomizableCTAType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CustomizableCTAType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CustomizableCTAType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CustomizableCTAType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void CustomizableCTAType::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CustomizableCTAType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CustomizableCTAType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CustomizableCTAType>>>::fromJsonValue(boost::json::parse(json));
}
