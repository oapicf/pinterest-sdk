...
CatalogsReportStats::CatalogsReportStats(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value CatalogsReportStats::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogsReportStats::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogsReportStats");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogsReportStats::toJsonObject_internal() const
{
...
void CatalogsReportStats::fromJsonObject_internal(boost::json::object const& object)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogsReportStats>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CatalogsReportStats>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogsReportStats>>>::fromJsonValue(boost::json::parse(json));
}
