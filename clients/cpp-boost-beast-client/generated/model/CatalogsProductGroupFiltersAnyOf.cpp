...
CatalogsProductGroupFiltersAnyOf::CatalogsProductGroupFiltersAnyOf(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string CatalogsProductGroupFiltersAnyOf::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value CatalogsProductGroupFiltersAnyOf::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogsProductGroupFiltersAnyOf::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogsProductGroupFiltersAnyOf");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogsProductGroupFiltersAnyOf::toJsonObject_internal() const
{
...
void CatalogsProductGroupFiltersAnyOf::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<CatalogsProductGroupFiltersAnyOf>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogsProductGroupFiltersAnyOf>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CatalogsProductGroupFiltersAnyOf>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogsProductGroupFiltersAnyOf>>>::fromJsonValue(boost::json::parse(json));
}
