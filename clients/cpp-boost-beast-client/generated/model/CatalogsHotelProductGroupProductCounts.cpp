...
CatalogsHotelProductGroupProductCounts::CatalogsHotelProductGroupProductCounts(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string CatalogsHotelProductGroupProductCounts::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value CatalogsHotelProductGroupProductCounts::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogsHotelProductGroupProductCounts::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogsHotelProductGroupProductCounts");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogsHotelProductGroupProductCounts::toJsonObject_internal() const
{
...
void CatalogsHotelProductGroupProductCounts::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<CatalogsHotelProductGroupProductCounts>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogsHotelProductGroupProductCounts>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CatalogsHotelProductGroupProductCounts>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogsHotelProductGroupProductCounts>>>::fromJsonValue(boost::json::parse(json));
}
