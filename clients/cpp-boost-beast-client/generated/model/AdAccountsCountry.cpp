...
AdAccountsCountry::AdAccountsCountry(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value AdAccountsCountry::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AdAccountsCountry::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AdAccountsCountry");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AdAccountsCountry::toJsonObject_internal() const
{
    boost::json::object object;
        object["code"] = JsonValueConverter<std::shared_ptr<Country>>::toJsonValue(getCode());
...
void AdAccountsCountry::fromJsonObject_internal(boost::json::object const& object)
{
    {
        const auto CodeIt = object.find("code");
        if (CodeIt != object.end()) {
            setCode(JsonValueConverter<std::shared_ptr<Country>>::fromJsonValue(CodeIt->value()));
        }
    }
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AdAccountsCountry>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AdAccountsCountry>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AdAccountsCountry>>>::fromJsonValue(boost::json::parse(json));
}
