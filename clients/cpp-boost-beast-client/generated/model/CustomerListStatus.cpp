...
CustomerListStatus::CustomerListStatus(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string CustomerListStatus::toJsonString(bool prettyJson /* = false */) const
{
...
void CustomerListStatus::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value CustomerListStatus::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CustomerListStatus::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CustomerListStatus");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CustomerListStatus::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void CustomerListStatus::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CustomerListStatus>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CustomerListStatus>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CustomerListStatus>>>::fromJsonValue(boost::json::parse(json));
}
