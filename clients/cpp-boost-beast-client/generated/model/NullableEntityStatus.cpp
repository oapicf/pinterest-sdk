...
NullableEntityStatus::NullableEntityStatus(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string NullableEntityStatus::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value NullableEntityStatus::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void NullableEntityStatus::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for NullableEntityStatus");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object NullableEntityStatus::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void NullableEntityStatus::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<NullableEntityStatus>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<NullableEntityStatus>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<NullableEntityStatus>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<NullableEntityStatus>>>::fromJsonValue(boost::json::parse(json));
}
