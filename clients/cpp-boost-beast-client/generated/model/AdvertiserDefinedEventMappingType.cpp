...
AdvertiserDefinedEventMappingType::AdvertiserDefinedEventMappingType(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string AdvertiserDefinedEventMappingType::toJsonString(bool prettyJson /* = false */) const
{
...
void AdvertiserDefinedEventMappingType::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value AdvertiserDefinedEventMappingType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AdvertiserDefinedEventMappingType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AdvertiserDefinedEventMappingType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AdvertiserDefinedEventMappingType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void AdvertiserDefinedEventMappingType::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<AdvertiserDefinedEventMappingType>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AdvertiserDefinedEventMappingType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AdvertiserDefinedEventMappingType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AdvertiserDefinedEventMappingType>>>::fromJsonValue(boost::json::parse(json));
}
