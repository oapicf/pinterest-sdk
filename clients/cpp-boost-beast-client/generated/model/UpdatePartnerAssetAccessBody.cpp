...
UpdatePartnerAssetAccessBody::UpdatePartnerAssetAccessBody(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string UpdatePartnerAssetAccessBody::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value UpdatePartnerAssetAccessBody::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void UpdatePartnerAssetAccessBody::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for UpdatePartnerAssetAccessBody");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object UpdatePartnerAssetAccessBody::toJsonObject_internal() const
{
    boost::json::object object;
        object["accesses"] = JsonValueConverter<std::vector<std::shared_ptr<UpdatePartnerAssetAccessItem>>>::toJsonValue(getAccesses());
    return object;
}

void UpdatePartnerAssetAccessBody::fromJsonObject_internal(boost::json::object const& object)
{
    {
        const auto AccessesIt = object.find("accesses");
        if (AccessesIt != object.end()) {
            setAccesses(JsonValueConverter<std::vector<std::shared_ptr<UpdatePartnerAssetAccessItem>>>::fromJsonValue(AccessesIt->value()));
        }
    }
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<UpdatePartnerAssetAccessBody>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<UpdatePartnerAssetAccessBody>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<UpdatePartnerAssetAccessBody>>>::fromJsonValue(boost::json::parse(json));
}
