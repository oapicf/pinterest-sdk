...
AppsflyerPlatform::AppsflyerPlatform(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string AppsflyerPlatform::toJsonString(bool prettyJson /* = false */) const
{
...
void AppsflyerPlatform::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value AppsflyerPlatform::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AppsflyerPlatform::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AppsflyerPlatform");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AppsflyerPlatform::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void AppsflyerPlatform::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AppsflyerPlatform>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AppsflyerPlatform>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AppsflyerPlatform>>>::fromJsonValue(boost::json::parse(json));
}
