...
AdReviewStatus::AdReviewStatus(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value AdReviewStatus::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AdReviewStatus::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AdReviewStatus");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AdReviewStatus::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void AdReviewStatus::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<AdReviewStatus>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AdReviewStatus>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AdReviewStatus>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AdReviewStatus>>>::fromJsonValue(boost::json::parse(json));
}
