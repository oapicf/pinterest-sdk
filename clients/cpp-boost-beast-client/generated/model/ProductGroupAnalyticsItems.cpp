...
ProductGroupAnalyticsItems::ProductGroupAnalyticsItems(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ProductGroupAnalyticsItems::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value ProductGroupAnalyticsItems::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ProductGroupAnalyticsItems::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ProductGroupAnalyticsItems");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ProductGroupAnalyticsItems::toJsonObject_internal() const
{
...
void ProductGroupAnalyticsItems::fromJsonObject_internal(boost::json::object const& object)
{
    m_DATEIsSet = false;
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ProductGroupAnalyticsItems>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ProductGroupAnalyticsItems>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ProductGroupAnalyticsItems>>>::fromJsonValue(boost::json::parse(json));
}
