...
AdsAnalyticsFilterColumn::AdsAnalyticsFilterColumn(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string AdsAnalyticsFilterColumn::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value AdsAnalyticsFilterColumn::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AdsAnalyticsFilterColumn::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AdsAnalyticsFilterColumn");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AdsAnalyticsFilterColumn::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void AdsAnalyticsFilterColumn::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AdsAnalyticsFilterColumn>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AdsAnalyticsFilterColumn>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AdsAnalyticsFilterColumn>>>::fromJsonValue(boost::json::parse(json));
}
