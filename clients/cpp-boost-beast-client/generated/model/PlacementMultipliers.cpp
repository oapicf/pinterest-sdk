...
PlacementMultipliers::PlacementMultipliers(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string PlacementMultipliers::toJsonString(bool prettyJson /* = false */) const
{
...
void PlacementMultipliers::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value PlacementMultipliers::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void PlacementMultipliers::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for PlacementMultipliers");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object PlacementMultipliers::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_PLACEMENTIsSet) {
            object["PLACEMENT"] = JsonValueConverter<std::shared_ptr<PlacementType>>::toJsonValue(getPLACEMENT());
        }
    return object;
}

void PlacementMultipliers::fromJsonObject_internal(boost::json::object const& object)
{
    m_PLACEMENTIsSet = false;
    {
        const auto PLACEMENTIt = object.find("PLACEMENT");
        if (PLACEMENTIt != object.end()) {
            setPLACEMENT(JsonValueConverter<std::shared_ptr<PlacementType>>::fromJsonValue(PLACEMENTIt->value()));
        }
    }
}
...
void PlacementMultipliers::setPLACEMENT(std::shared_ptr<PlacementType> value)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<PlacementMultipliers>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<PlacementMultipliers>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<PlacementMultipliers>>>::fromJsonValue(boost::json::parse(json));
}
