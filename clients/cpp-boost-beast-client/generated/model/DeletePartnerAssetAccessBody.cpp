...
DeletePartnerAssetAccessBody::DeletePartnerAssetAccessBody(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string DeletePartnerAssetAccessBody::toJsonString(bool prettyJson /* = false */) const
{
...
void DeletePartnerAssetAccessBody::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value DeletePartnerAssetAccessBody::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void DeletePartnerAssetAccessBody::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for DeletePartnerAssetAccessBody");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object DeletePartnerAssetAccessBody::toJsonObject_internal() const
{
    boost::json::object object;
        object["accesses"] = JsonValueConverter<std::vector<std::shared_ptr<DeletePartnerAssetAccessItem>>>::toJsonValue(getAccesses());
    return object;
}

void DeletePartnerAssetAccessBody::fromJsonObject_internal(boost::json::object const& object)
{
    {
        const auto AccessesIt = object.find("accesses");
        if (AccessesIt != object.end()) {
            setAccesses(JsonValueConverter<std::vector<std::shared_ptr<DeletePartnerAssetAccessItem>>>::fromJsonValue(AccessesIt->value()));
        }
    }
}

std::vector<std::shared_ptr<DeletePartnerAssetAccessItem>> DeletePartnerAssetAccessBody::getAccesses() const
{
    return m_Accesses;
}

void DeletePartnerAssetAccessBody::setAccesses(std::vector<std::shared_ptr<DeletePartnerAssetAccessItem>> value)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<DeletePartnerAssetAccessBody>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<DeletePartnerAssetAccessBody>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<DeletePartnerAssetAccessBody>>>::fromJsonValue(boost::json::parse(json));
}
