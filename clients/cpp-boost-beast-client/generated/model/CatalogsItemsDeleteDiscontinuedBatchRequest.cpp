...
CatalogsItemsDeleteDiscontinuedBatchRequest::CatalogsItemsDeleteDiscontinuedBatchRequest(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value CatalogsItemsDeleteDiscontinuedBatchRequest::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogsItemsDeleteDiscontinuedBatchRequest::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogsItemsDeleteDiscontinuedBatchRequest");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogsItemsDeleteDiscontinuedBatchRequest::toJsonObject_internal() const
{
    boost::json::object object;
        object["country"] = JsonValueConverter<std::shared_ptr<Country>>::toJsonValue(getCountry());
        object["items"] = JsonValueConverter<std::vector<std::shared_ptr<ItemDeleteDiscontinuedBatchRecord>>>::toJsonValue(getItems());
...
void CatalogsItemsDeleteDiscontinuedBatchRequest::fromJsonObject_internal(boost::json::object const& object)
{
    {
    ...
    }
    {
        ...
        if (ItemsIt != object.end()) {
            setItems(JsonValueConverter<std::vector<std::shared_ptr<ItemDeleteDiscontinuedBatchRecord>>>::fromJsonValue(ItemsIt->value()));
        }
    }
    {
...
void CatalogsItemsDeleteDiscontinuedBatchRequest::setCountry(std::shared_ptr<Country> value)
{
...
void CatalogsItemsDeleteDiscontinuedBatchRequest::setItems(std::vector<std::shared_ptr<ItemDeleteDiscontinuedBatchRecord>> value)
{
...
std::string CatalogsItemsDeleteDiscontinuedBatchRequest::getOperation() const
{
    return m_Operation;
}

void CatalogsItemsDeleteDiscontinuedBatchRequest::setOperation(std::string value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<CatalogsItemsDeleteDiscontinuedBatchRequest>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogsItemsDeleteDiscontinuedBatchRequest>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CatalogsItemsDeleteDiscontinuedBatchRequest>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogsItemsDeleteDiscontinuedBatchRequest>>>::fromJsonValue(boost::json::parse(json));
}
