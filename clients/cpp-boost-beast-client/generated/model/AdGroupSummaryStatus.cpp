...
AdGroupSummaryStatus::AdGroupSummaryStatus(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string AdGroupSummaryStatus::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value AdGroupSummaryStatus::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AdGroupSummaryStatus::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AdGroupSummaryStatus");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AdGroupSummaryStatus::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void AdGroupSummaryStatus::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<AdGroupSummaryStatus>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AdGroupSummaryStatus>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AdGroupSummaryStatus>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AdGroupSummaryStatus>>>::fromJsonValue(boost::json::parse(json));
}
