...
LabelCreateRequest::LabelCreateRequest(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value LabelCreateRequest::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void LabelCreateRequest::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for LabelCreateRequest");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object LabelCreateRequest::toJsonObject_internal() const
{
...
void LabelCreateRequest::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<LabelCreateRequest>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<LabelCreateRequest>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<LabelCreateRequest>>>::fromJsonValue(boost::json::parse(json));
}
