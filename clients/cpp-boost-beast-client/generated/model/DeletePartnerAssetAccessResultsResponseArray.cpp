...
DeletePartnerAssetAccessResultsResponseArray::DeletePartnerAssetAccessResultsResponseArray(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string DeletePartnerAssetAccessResultsResponseArray::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value DeletePartnerAssetAccessResultsResponseArray::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void DeletePartnerAssetAccessResultsResponseArray::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for DeletePartnerAssetAccessResultsResponseArray");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object DeletePartnerAssetAccessResultsResponseArray::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_ItemsIsSet) {
            object["items"] = JsonValueConverter<std::vector<std::shared_ptr<DeletePartnerAssetAccessResult>>>::toJsonValue(getItems());
        }
    return object;
}

void DeletePartnerAssetAccessResultsResponseArray::fromJsonObject_internal(boost::json::object const& object)
{
    m_ItemsIsSet = false;
    {
        const auto ItemsIt = object.find("items");
        if (ItemsIt != object.end()) {
            setItems(JsonValueConverter<std::vector<std::shared_ptr<DeletePartnerAssetAccessResult>>>::fromJsonValue(ItemsIt->value()));
        }
    }
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<DeletePartnerAssetAccessResultsResponseArray>>>::toJsonValue(data));
}
...
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<DeletePartnerAssetAccessResultsResponseArray>>>::fromJsonValue(boost::json::parse(json));
}
