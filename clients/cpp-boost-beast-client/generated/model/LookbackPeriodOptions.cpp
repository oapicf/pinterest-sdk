...
LookbackPeriodOptions::LookbackPeriodOptions(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string LookbackPeriodOptions::toJsonString(bool prettyJson /* = false */) const
{
...
void LookbackPeriodOptions::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value LookbackPeriodOptions::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void LookbackPeriodOptions::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for LookbackPeriodOptions");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object LookbackPeriodOptions::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void LookbackPeriodOptions::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<LookbackPeriodOptions>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<LookbackPeriodOptions>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<LookbackPeriodOptions>>>::fromJsonValue(boost::json::parse(json));
}
