...
CatalogsRetailAvailableFilterValues::CatalogsRetailAvailableFilterValues(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string CatalogsRetailAvailableFilterValues::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value CatalogsRetailAvailableFilterValues::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogsRetailAvailableFilterValues::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogsRetailAvailableFilterValues");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogsRetailAvailableFilterValues::toJsonObject_internal() const
{
    boost::json::object object;
        object["catalog_type"] = JsonValueConverter<std::string>::toJsonValue(getCatalogType());
        object["filter_values"] = JsonValueConverter<std::shared_ptr<CatalogsRetailFilterValuesMap>>::toJsonValue(getFilterValues());
    return object;
}

void CatalogsRetailAvailableFilterValues::fromJsonObject_internal(boost::json::object const& object)
{
    {
    ...
    }
    {
        ...
        if (Filter_valuesIt != object.end()) {
            setFilterValues(JsonValueConverter<std::shared_ptr<CatalogsRetailFilterValuesMap>>::fromJsonValue(Filter_valuesIt->value()));
        }
    }
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogsRetailAvailableFilterValues>>>::toJsonValue(data));
}
...
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogsRetailAvailableFilterValues>>>::fromJsonValue(boost::json::parse(json));
}
