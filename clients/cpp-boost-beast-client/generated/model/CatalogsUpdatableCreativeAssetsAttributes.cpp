...
CatalogsUpdatableCreativeAssetsAttributes::CatalogsUpdatableCreativeAssetsAttributes(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value CatalogsUpdatableCreativeAssetsAttributes::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogsUpdatableCreativeAssetsAttributes::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogsUpdatableCreativeAssetsAttributes");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogsUpdatableCreativeAssetsAttributes::toJsonObject_internal() const
{
...
void CatalogsUpdatableCreativeAssetsAttributes::fromJsonObject_internal(boost::json::object const& object)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogsUpdatableCreativeAssetsAttributes>>>::toJsonValue(data));
}
...
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogsUpdatableCreativeAssetsAttributes>>>::fromJsonValue(boost::json::parse(json));
}
