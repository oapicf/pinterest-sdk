...
AssetGroupType::AssetGroupType(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value AssetGroupType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AssetGroupType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AssetGroupType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AssetGroupType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void AssetGroupType::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<AssetGroupType>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AssetGroupType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AssetGroupType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AssetGroupType>>>::fromJsonValue(boost::json::parse(json));
}
