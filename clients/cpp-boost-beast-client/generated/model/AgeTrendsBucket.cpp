...
AgeTrendsBucket::AgeTrendsBucket(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value AgeTrendsBucket::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AgeTrendsBucket::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AgeTrendsBucket");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AgeTrendsBucket::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void AgeTrendsBucket::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AgeTrendsBucket>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AgeTrendsBucket>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AgeTrendsBucket>>>::fromJsonValue(boost::json::parse(json));
}
