...
CancelInviteResultUser::CancelInviteResultUser(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string CancelInviteResultUser::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value CancelInviteResultUser::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CancelInviteResultUser::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CancelInviteResultUser");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CancelInviteResultUser::toJsonObject_internal() const
{
...
void CancelInviteResultUser::fromJsonObject_internal(boost::json::object const& object)
{
    m_EmailIsSet = false;
    m_IdIsSet = false;
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<CancelInviteResultUser>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CancelInviteResultUser>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CancelInviteResultUser>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CancelInviteResultUser>>>::fromJsonValue(boost::json::parse(json));
}
