...
MMMReportingTargetingType::MMMReportingTargetingType(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string MMMReportingTargetingType::toJsonString(bool prettyJson /* = false */) const
{
...
void MMMReportingTargetingType::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value MMMReportingTargetingType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void MMMReportingTargetingType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for MMMReportingTargetingType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object MMMReportingTargetingType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void MMMReportingTargetingType::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<MMMReportingTargetingType>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<MMMReportingTargetingType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<MMMReportingTargetingType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<MMMReportingTargetingType>>>::fromJsonValue(boost::json::parse(json));
}
