...
NotificationPostRequest::NotificationPostRequest(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string NotificationPostRequest::toJsonString(bool prettyJson /* = false */) const
{
...
void NotificationPostRequest::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value NotificationPostRequest::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void NotificationPostRequest::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for NotificationPostRequest");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object NotificationPostRequest::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void NotificationPostRequest::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<NotificationPostRequest>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<NotificationPostRequest>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<NotificationPostRequest>>>::fromJsonValue(boost::json::parse(json));
}
