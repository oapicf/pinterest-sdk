...
CatalogsProductGroupStatus::CatalogsProductGroupStatus(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string CatalogsProductGroupStatus::toJsonString(bool prettyJson /* = false */) const
{
...
void CatalogsProductGroupStatus::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value CatalogsProductGroupStatus::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CatalogsProductGroupStatus::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CatalogsProductGroupStatus");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CatalogsProductGroupStatus::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void CatalogsProductGroupStatus::fromJsonObject_internal(boost::json::object const& object)
{
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CatalogsProductGroupStatus>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CatalogsProductGroupStatus>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CatalogsProductGroupStatus>>>::fromJsonValue(boost::json::parse(json));
}
