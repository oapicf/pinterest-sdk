...
case class ProductCategoryDetails (
    _demographics: Option[ProductCategoriesDemographic],
    ...
    _metricsHighlights: Option[ProductCategoriesMetricsHighlights],
    ...
    _predictedTimeSeries: Option[Map[String, Number]],
    _productCategory: ProductCategoryEnum,
    /* Related search terms for this product category */
    _relatedSearches: Option[List[String]],
    /* Time series data showing trend values over time, indexed between 0 and 100 */
    _timeSeries: Option[Map[String, Number]]
)
object ProductCategoryDetails {
    def toStringBody(var_demographics: Object, var_hasPrediction: Object, var_metricsHighlights: Object, var_predictedTimeSeries: Object, var_productCategory: Object, var_relatedSearches: Object, var_timeSeries: Object) =
        s"""
        | {
        | "demographics":$var_demographics,"hasPrediction":$var_hasPrediction,"metricsHighlights":$var_metricsHighlights,"predictedTimeSeries":$var_predictedTimeSeries,"productCategory":$var_productCategory,"relatedSearches":$var_relatedSearches,"timeSeries":$var_timeSeries
        | }
        """.stripMargin
}
