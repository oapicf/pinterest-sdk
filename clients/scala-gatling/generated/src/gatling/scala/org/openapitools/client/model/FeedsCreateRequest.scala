...
object FeedsCreateRequest {
    def toStringBody(var_defaultCurrency: Object, var_name: Object, var_format: Object, var_defaultLocale: Object, var_credentials: Object, var_location: Object, var_preferredProcessingSchedule: Object, var_catalogType: Object, var_defaultCountry: Object, var_defaultAvailability: Object, var_status: Object, var_catalogId: Object) =
        s"""
        | {
        | "defaultCurrency":$var_defaultCurrency,"name":$var_name,"format":$var_format,"defaultLocale":$var_defaultLocale,"credentials":$var_credentials,"location":$var_location,"preferredProcessingSchedule":$var_preferredProcessingSchedule,"catalogType":$var_catalogType,"defaultCountry":$var_defaultCountry,"defaultAvailability":$var_defaultAvailability,"status":$var_status,"catalogId":$var_catalogId
        | }
        """.stripMargin
}
