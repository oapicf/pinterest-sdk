...
object AdGroupUpdateRequestAllOf1 {
    def toStringBody(var_bidMultiplier: Object, var_id: Object, var_targetingSpecOperations: Object) =
        s"""
        | {
        | "bidMultiplier":$var_bidMultiplier,"id":$var_id,"targetingSpecOperations":$var_targetingSpecOperations
        | }
        """.stripMargin
}
