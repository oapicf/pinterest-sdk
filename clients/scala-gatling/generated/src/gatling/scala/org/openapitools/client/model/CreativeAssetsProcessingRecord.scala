...
object CreativeAssetsProcessingRecord {
    def toStringBody(var_creativeAssetsId: Object, var_errors: Object, var_status: Object, var_warnings: Object) =
        s"""
        | {
        | "creativeAssetsId":$var_creativeAssetsId,"errors":$var_errors,"status":$var_status,"warnings":$var_warnings
        | }
        """.stripMargin
}
