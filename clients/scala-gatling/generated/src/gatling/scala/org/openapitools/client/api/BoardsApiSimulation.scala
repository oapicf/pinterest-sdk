...
// Setup http protocol configuration
    ...
    // Set up CSV feeders
    val board_sections/createQUERYFeeder = csv(userDataDirectory + File.separator + "boardSectionsCreate-queryParams.csv").random
    val board_sections/createPATHFeeder = csv(userDataDirectory + File.separator + "boardSectionsCreate-pathParams.csv").random
    val board_sections/deleteQUERYFeeder = csv(userDataDirectory + File.separator + "boardSectionsDelete-queryParams.csv").random
    ...
    val board_sections/updateQUERYFeeder = csv(userDataDirectory + File.separator + "boardSectionsUpdate-queryParams.csv").random
    val board_sections/updatePATHFeeder = csv(userDataDirectory + File.separator + "boardSectionsUpdate-pathParams.csv").random
    val boards/createQUERYFeeder = csv(userDataDirectory + File.separator + "boardsCreate-queryParams.csv").random
    val boards/deleteQUERYFeeder = csv(userDataDirectory + File.separator + "boardsDelete-queryParams.csv").random
    val boards/deletePATHFeeder = csv(userDataDirectory + File.separator + "boardsDelete-pathParams.csv").random
    val boards/getQUERYFeeder = csv(userDataDirectory + File.separator + "boardsGet-queryParams.csv").random
    ...
    val boards/updateQUERYFeeder = csv(userDataDirectory + File.separator + "boardsUpdate-queryParams.csv").random
    ...
    val scnboardSectionsCreate = scenario("boardSectionsCreateSimulation")
        .feed(board_sections/createQUERYFeeder)
    ...
    val scnboardSectionsDelete = scenario("boardSectionsDeleteSimulation")
        .feed(board_sections/deleteQUERYFeeder)
    ...
    val scnboardSectionsUpdate = scenario("boardSectionsUpdateSimulation")
        .feed(board_sections/updateQUERYFeeder)
