...
class OauthApiSimulation extends Simulation {
...
// Setup http protocol configuration
    ...
    val scnoauthToken = scenario("oauthTokenSimulation")
        .exec(http("oauthToken")
        .httpRequest("POST","/oauth/token")
)

    // Run scnoauthToken with warm up and reach a constant rate for entire duration
    scenarioBuilders += scnoauthToken.inject(
