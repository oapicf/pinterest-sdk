...
object ConversionTagConfigs {
    def toStringBody(var_aemEnabled: Object, var_mdFrequency: Object, var_aemFnlnEnabled: Object, var_aemPhEnabled: Object, var_aemGeEnabled: Object, var_aemDbEnabled: Object, var_aemLocEnabled: Object) =
        s"""
        | {
        | "aemEnabled":$var_aemEnabled,"mdFrequency":$var_mdFrequency,"aemFnlnEnabled":$var_aemFnlnEnabled,"aemPhEnabled":$var_aemPhEnabled,"aemGeEnabled":$var_aemGeEnabled,"aemDbEnabled":$var_aemDbEnabled,"aemLocEnabled":$var_aemLocEnabled
        | }
        """.stripMargin
}
