...
case class CampaignCreateItem (
    ...
    _name: String,
    _objectiveType: ConversionObjectiveType,
...
object CampaignCreateItem {
    def toStringBody(var_adAccountId: Object, var_appId: Object, var_appPlatform: Object, var_bidOptions: Object, var_dailySpendCap: Object, var_defaultAdGroupBudgetInMicroCurrency: Object, var_endTime: Object, var_intendedPromotionType: Object, var_isAutomatedCampaign: Object, var_isCampaignBudgetOptimization: Object, var_isFlexibleDailyBudgets: Object, var_isLtvOptimized: Object, var_isPerformancePlus: Object, var_isTopOfSearch: Object, var_lifetimeSpendCap: Object, var_name: Object, var_objectiveType: Object, var_orderLineId: Object, var_startTime: Object, var_status: Object, var_trackingUrls: Object) =
        s"""
        | {
        | "adAccountId":$var_adAccountId,"appId":$var_appId,"appPlatform":$var_appPlatform,"bidOptions":$var_bidOptions,"dailySpendCap":$var_dailySpendCap,"defaultAdGroupBudgetInMicroCurrency":$var_defaultAdGroupBudgetInMicroCurrency,"endTime":$var_endTime,"intendedPromotionType":$var_intendedPromotionType,"isAutomatedCampaign":$var_isAutomatedCampaign,"isCampaignBudgetOptimization":$var_isCampaignBudgetOptimization,"isFlexibleDailyBudgets":$var_isFlexibleDailyBudgets,"isLtvOptimized":$var_isLtvOptimized,"isPerformancePlus":$var_isPerformancePlus,"isTopOfSearch":$var_isTopOfSearch,"lifetimeSpendCap":$var_lifetimeSpendCap,"name":$var_name,"objectiveType":$var_objectiveType,"orderLineId":$var_orderLineId,"startTime":$var_startTime,"status":$var_status,"trackingUrls":$var_trackingUrls
        | }
        """.stripMargin
}
