...
object CampaignAdPreviewCreate200ResponseInnerData {
    def toStringBody(var_adAccountId: Object, var_adGroupId: Object, var_clientId: Object, var_expiresAt: Object, var_isActive: Object, var_pinId: Object, var_pinPromotionId: Object, var_promotedProductGroupId: Object, var_url: Object, var_userId: Object, var_uuid: Object, var_exceptions: Object) =
        s"""
        | {
        | "adAccountId":$var_adAccountId,"adGroupId":$var_adGroupId,"clientId":$var_clientId,"expiresAt":$var_expiresAt,"isActive":$var_isActive,"pinId":$var_pinId,"pinPromotionId":$var_pinPromotionId,"promotedProductGroupId":$var_promotedProductGroupId,"url":$var_url,"userId":$var_userId,"uuid":$var_uuid,"exceptions":$var_exceptions
        | }
        """.stripMargin
}
