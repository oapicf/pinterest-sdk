...
object ConversionEventsDataInnerCustomDataContentsInner {
    def toStringBody(var_id: Object, var_itemBrand: Object, var_itemCategory: Object, var_itemName: Object, var_itemPrice: Object, var_quantity: Object) =
        s"""
        | {
        | "id":$var_id,"itemBrand":$var_itemBrand,"itemCategory":$var_itemCategory,"itemName":$var_itemName,"itemPrice":$var_itemPrice,"quantity":$var_quantity
        | }
        """.stripMargin
}
