...
object CatalogsProductGroupUpdateManyRequestItemsOneOfItems0 {
    def toStringBody(var_description: Object, var_filters: Object, var_isFeatured: Object, var_name: Object, var_id: Object) =
        s"""
        | {
        | "description":$var_description,"filters":$var_filters,"isFeatured":$var_isFeatured,"name":$var_name,"id":$var_id
        | }
        """.stripMargin
}
