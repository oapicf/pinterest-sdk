...
object ConversionTagCreate {
    def toStringBody(var_aemDbEnabled: Object, var_aemEnabled: Object, var_aemExternalIdEnabled: Object, var_aemFnlnEnabled: Object, var_aemGeEnabled: Object, var_aemLocEnabled: Object, var_aemPhEnabled: Object, var_mdFrequency: Object, var_name: Object) =
        s"""
        | {
        | "aemDbEnabled":$var_aemDbEnabled,"aemEnabled":$var_aemEnabled,"aemExternalIdEnabled":$var_aemExternalIdEnabled,"aemFnlnEnabled":$var_aemFnlnEnabled,"aemGeEnabled":$var_aemGeEnabled,"aemLocEnabled":$var_aemLocEnabled,"aemPhEnabled":$var_aemPhEnabled,"mdFrequency":$var_mdFrequency,"name":$var_name
        | }
        """.stripMargin
}
