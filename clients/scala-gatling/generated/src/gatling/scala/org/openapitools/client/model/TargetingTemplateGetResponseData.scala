...
object TargetingTemplateGetResponseData {
    def toStringBody(var_autoTargetingEnabled: Object, var_keywords: Object, var_name: Object, var_placementGroup: Object, var_targetingAttributes: Object, var_trackingUrls: Object, var_adAccountId: Object, var_createdTime: Object, var_id: Object, var_sizing: Object, var_status: Object, var_updatedTime: Object, var_valid: Object) =
        s"""
        | {
        | "autoTargetingEnabled":$var_autoTargetingEnabled,"keywords":$var_keywords,"name":$var_name,"placementGroup":$var_placementGroup,"targetingAttributes":$var_targetingAttributes,"trackingUrls":$var_trackingUrls,"adAccountId":$var_adAccountId,"createdTime":$var_createdTime,"id":$var_id,"sizing":$var_sizing,"status":$var_status,"updatedTime":$var_updatedTime,"valid":$var_valid
        | }
        """.stripMargin
}
