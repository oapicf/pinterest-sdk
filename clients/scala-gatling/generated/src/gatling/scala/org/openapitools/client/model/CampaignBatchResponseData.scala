...
case class CampaignBatchResponseData (
    ...
    _name: Option[String],
    _objectiveType: Option[CampaignObjectiveType],
    ...
    _status: Option[NullableEntityStatus],
    _summaryStatus: Option[SummaryStatus],
...
object CampaignBatchResponseData {
    def toStringBody(var_adAccountId: Object, var_bidOptions: Object, var_createdTime: Object, var_dailySpendCap: Object, var_defaultAdGroupBudgetInMicroCurrency: Object, var_endTime: Object, var_id: Object, var_intendedPromotionType: Object, var_isAutomatedCampaign: Object, var_isCampaignBudgetOptimization: Object, var_isCarting: Object, var_isFlexibleDailyBudgets: Object, var_isLtvOptimized: Object, var_isPerformancePlus: Object, var_isTopOfSearch: Object, var_lifetimeSpendCap: Object, var_name: Object, var_objectiveType: Object, var_orderLineId: Object, var_performancePlusCampaignSettings: Object, var_startTime: Object, var_status: Object, var_summaryStatus: Object, var_trackingUrls: Object, var_type: Object, var_updatedTime: Object) =
        s"""
        | {
        | "adAccountId":$var_adAccountId,"bidOptions":$var_bidOptions,"createdTime":$var_createdTime,"dailySpendCap":$var_dailySpendCap,"defaultAdGroupBudgetInMicroCurrency":$var_defaultAdGroupBudgetInMicroCurrency,"endTime":$var_endTime,"id":$var_id,"intendedPromotionType":$var_intendedPromotionType,"isAutomatedCampaign":$var_isAutomatedCampaign,"isCampaignBudgetOptimization":$var_isCampaignBudgetOptimization,"isCarting":$var_isCarting,"isFlexibleDailyBudgets":$var_isFlexibleDailyBudgets,"isLtvOptimized":$var_isLtvOptimized,"isPerformancePlus":$var_isPerformancePlus,"isTopOfSearch":$var_isTopOfSearch,"lifetimeSpendCap":$var_lifetimeSpendCap,"name":$var_name,"objectiveType":$var_objectiveType,"orderLineId":$var_orderLineId,"performancePlusCampaignSettings":$var_performancePlusCampaignSettings,"startTime":$var_startTime,"status":$var_status,"summaryStatus":$var_summaryStatus,"trackingUrls":$var_trackingUrls,"type":$var_type,"updatedTime":$var_updatedTime
        | }
        """.stripMargin
}
