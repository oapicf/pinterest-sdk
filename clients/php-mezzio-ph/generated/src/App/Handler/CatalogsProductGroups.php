...
class CatalogsProductGroups
{
     ...
     * @PHA\Attribute(name=PHAttribute\Transfer::class, options={"type":\App\DTO\CatalogsProductGroupsCreateRequestSchema::class,"objectAttr":"bodyData"})
     ...
     */
    public function catalogsProductGroupsCreate(ServerRequestInterface $request): \App\DTO\CatalogsVerticalProductGroup
    {
        //TODO implement method
        /** @var \App\DTO\CatalogsProductGroupsCreateQueryData $queryData */
        $queryData = $request->getAttribute("queryData");
        /** @var \App\DTO\CatalogsProductGroupsCreateRequestSchema $bodyData */
