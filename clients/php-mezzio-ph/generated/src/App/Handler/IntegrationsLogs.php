...
class IntegrationsLogs
{
     ...
     * @PHA\Attribute(name=PHAttribute\Transfer::class, options={"type":\App\DTO\IntegrationLogsRequestCreate::class,"objectAttr":"bodyData"})
    ...
    public function integrationsLogsPost(ServerRequestInterface $request): \App\DTO\IntegrationLogsSuccessResponse
    {
        ...
        /** @var \App\DTO\IntegrationLogsRequestCreate $bodyData */
