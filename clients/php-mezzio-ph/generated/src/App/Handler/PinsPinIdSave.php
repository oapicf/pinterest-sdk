...
class PinsPinIdSave
{
     ...
     * @PHA\Attribute(name=PHAttribute\Transfer::class, options={"type":\App\DTO\PinsSaveRequestCreate::class,"objectAttr":"bodyData"})
    ...
    public function pinsSave(ServerRequestInterface $request): \App\DTO\Pin
    {
        ...
        /** @var \App\DTO\PinsSaveRequestCreate $bodyData */
