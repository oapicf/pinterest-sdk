...
class AdAccountsAdAccountIdCustomerLists
{
     ...
     * @PHA\Attribute(name=PHAttribute\Transfer::class, options={"type":\App\DTO\CustomerListCreate::class,"objectAttr":"bodyData"})
    ...
    public function customerListsCreate(ServerRequestInterface $request): \App\DTO\CustomerList
    {
        ...
        /** @var \App\DTO\CustomerListCreate $bodyData */
