...
class IntegrationsCommerceExternalBusinessId
{
     ...
     */
    public function integrationsCommerceDel(ServerRequestInterface $request): \App\DTO\IntegrationMetadata
    {
     ...
     * @PHA\Attribute(name=PHAttribute\Transfer::class, options={"type":\App\DTO\IntegrationMetadataUpdate::class,"objectAttr":"bodyData"})
     * TODO check if producer is valid, if it has correct priority and if it can be moved to class annotation
     * @PHA\Producer(name=PHProducer\Transfer::class, mediaType="application/json")
     * @param ServerRequestInterface $request
     *
    ...
    {
        //TODO implement method
        /** @var \App\DTO\IntegrationMetadataUpdate $bodyData */
