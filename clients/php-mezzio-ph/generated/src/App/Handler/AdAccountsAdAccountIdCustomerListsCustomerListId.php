...
class AdAccountsAdAccountIdCustomerListsCustomerListId
{
     ...
     * @PHA\Attribute(name=PHAttribute\Transfer::class, options={"type":\App\DTO\CustomerListUpdateWithRequiredBody::class,"objectAttr":"bodyData"})
     * TODO check if producer is valid, if it has correct priority and if it can be moved to class annotation
     * @PHA\Producer(name=PHProducer\Transfer::class, mediaType="application/json")
     * @param ServerRequestInterface $request
     *
    ...
    {
        //TODO implement method
        /** @var \App\DTO\CustomerListUpdateWithRequiredBody $bodyData */
