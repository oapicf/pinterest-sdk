...
class CatalogsFeedsFeedId
{
     ...
     */
    public function feedsDelete(ServerRequestInterface $request): \App\DTO\CatalogsFeed
    {
     ...
     * @PHA\Attribute(name=PHAttribute\Transfer::class, options={"type":\App\DTO\CatalogsFeedUpdateRequestSchema::class,"objectAttr":"bodyData"})
     * TODO check if producer is valid, if it has correct priority and if it can be moved to class annotation
     * @PHA\Producer(name=PHProducer\Transfer::class, mediaType="application/json")
     * @param ServerRequestInterface $request
     *
    ...
    public function feedsUpdate(ServerRequestInterface $request): \App\DTO\CatalogsFeed
    {
        ...
        $queryData = $request->getAttribute("queryData");
        /** @var \App\DTO\CatalogsFeedUpdateRequestSchema $bodyData */
