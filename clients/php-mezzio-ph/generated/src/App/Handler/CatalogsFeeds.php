...
class CatalogsFeeds
{
     ...
     * @PHA\Attribute(name=PHAttribute\Transfer::class, options={"type":\App\DTO\CatalogsFeedCreateRequestSchema::class,"objectAttr":"bodyData"})
    ...
    public function feedsCreate(ServerRequestInterface $request): \App\DTO\CatalogsFeed
    {
        ...
        /** @var \App\DTO\CatalogsFeedCreateRequestSchema $bodyData */
