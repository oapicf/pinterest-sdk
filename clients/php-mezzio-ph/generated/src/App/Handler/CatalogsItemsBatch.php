...
class CatalogsItemsBatch
{
     ...
     * @PHA\Attribute(name=PHAttribute\Transfer::class, options={"type":\App\DTO\CatalogsItemsBatchPostRequest::class,"objectAttr":"bodyData"})
    ...
    public function itemsBatchPost(ServerRequestInterface $request): \App\DTO\CatalogsItemsBatch
    {
        ...
        /** @var \App\DTO\CatalogsItemsBatchPostRequest $bodyData */
