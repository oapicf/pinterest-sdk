...
class RelatedTerms
{
     ...
     * @var int|null
     */
    public $related_term_count;

    /**
     * The id of the advertiser.
     * @DTA\Data(field="related_terms_list", nullable=true)
     * @DTA\Strategy(name="Object", options={"type":\App\DTO\Collection460::class})
     * @DTA\Validator(name="TypeCompliant", options={"type":\App\DTO\Collection460::class})
     * @var \App\DTO\Collection460|null
     */
    public $related_terms_list;
