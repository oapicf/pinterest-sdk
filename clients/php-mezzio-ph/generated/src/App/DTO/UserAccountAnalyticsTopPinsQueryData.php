...
/**
 * Query parameters for userAccountAnalyticsTopPins
 */
class UserAccountAnalyticsTopPinsQueryData
{
    /**
     ...
     * TODO add validator(s) and strategy for list of \App\DTO\QuerymetrictypesItems::class and collection format csv inside query string
     * @var \App\DTO\QuerymetrictypesItems[]|null
     */
    public $metric_types;
