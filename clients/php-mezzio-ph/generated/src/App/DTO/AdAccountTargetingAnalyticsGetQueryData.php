...
/**
 * Query parameters for adAccountTargetingAnalyticsGet
 */
class AdAccountTargetingAnalyticsGetQueryData
{
    /**
     ...
     * TODO add validator(s) and strategy for list of \App\DTO\AdsAnalyticsAccountTargetingType::class and collection format csv inside query string
     * @var \App\DTO\AdsAnalyticsAccountTargetingType[]|null
     */
