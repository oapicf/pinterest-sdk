...
/**
 * Query parameters for campaignTargetingAnalyticsGet
 */
class CampaignTargetingAnalyticsGetQueryData
{
     ...
     * TODO add validator(s) and strategy for list of \App\DTO\AdsAnalyticsCampaignTargetingType::class and collection format csv inside query string
     * @var \App\DTO\AdsAnalyticsCampaignTargetingType[]|null
     */
