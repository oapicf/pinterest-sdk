...
/**
 * Query parameters for adTargetingAnalyticsGet
 */
class AdTargetingAnalyticsGetQueryData
{
    /**
    ...
    /**
     * Sort Columns.
     * @DTA\Data(field="sort_columns", nullable=true)
     * @DTA\Strategy(name="QueryStringScalarArray", options={"type":"string", "format":"multi"})
     * @DTA\Validator(name="QueryStringScalarArray", options={"type":"string", "format":"multi", "min_items":1, "max_items":2})
     * @var string[]|null
     */
    public $sort_columns;
     ...
     * TODO add validator(s) and strategy for list of \App\DTO\AdsAnalyticsAdTargetingType::class and collection format csv inside query string
     * @var \App\DTO\AdsAnalyticsAdTargetingType[]|null
     */
