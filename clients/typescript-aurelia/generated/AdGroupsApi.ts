...
export class AdGroupsApi extends Api {
   ...
   */
  async adGroupsAnalytics(params: IAdGroupsAnalyticsParams): Promise<Array<AdGroupsAnalyticsResponseInner>> {
   ...
   * @param params.adAccountId Unique identifier of an ad account.
   * @param params.adGroupAudienceSizingRequest 
   */
  async adGroupsAudienceSizing(params: IAdGroupsAudienceSizingParams): Promise<AdGroupAudienceSizingResponse> {
    // Verify required parameters are set
    this.ensureParamIsSet('adGroupsAudienceSizing', params, 'adAccountId');
    this.ensureParamIsSet('adGroupsAudienceSizing', params, 'adGroupAudienceSizingRequest');
    ...
    const response = await this.httpClient.createRequest(url)
      ...
      .withContent(JSON.stringify(params['adGroupAudienceSizingRequest'] || {}))
   ...
   * @param params.adAccountId Unique identifier of an ad account.
   * @param params.bidFloorRequest Parameters to get bid_floor info
   */
  async adGroupsBidFloorGet(params: IAdGroupsBidFloorGetParams): Promise<BidFloor> {
    ...
    this.ensureParamIsSet('adGroupsBidFloorGet', params, 'bidFloorRequest');
    ...
    const response = await this.httpClient.createRequest(url)
      ...
      // Encode body parameter
      .withHeader('content-type', 'application/json')
      .withContent(JSON.stringify(params['bidFloorRequest'] || {}))
   ...
   * @param params.adAccountId Unique identifier of an ad account.
   * @param params.adGroupCreateRequest List of ad groups to create, size limit [1, 30].
   */
  async adGroupsCreate(params: IAdGroupsCreateParams): Promise<AdGroupArrayResponse> {
    // Verify required parameters are set
    this.ensureParamIsSet('adGroupsCreate', params, 'adAccountId');
    this.ensureParamIsSet('adGroupsCreate', params, 'adGroupCreateRequest');
    ...
    const response = await this.httpClient.createRequest(url)
      ...
      // Encode body parameter
      .withHeader('content-type', 'application/json')
      .withContent(JSON.stringify(params['adGroupCreateRequest'] || {}))
   ...
   * @param params.adAccountId Unique identifier of an ad account.
   * @param params.adGroupId Unique identifier of an ad group.
   */
  async adGroupsGet(params: IAdGroupsGetParams): Promise<AdGroupResponse> {
    // Verify required parameters are set
   ...
   * @param params.startDate Metric report start date (UTC). Format: YYYY-MM-DD. Cannot be more than 90 days back from today.
   * @param params.endDate Metric report end date (UTC). Format: YYYY-MM-DD. Cannot be more than 90 days past start_date.
   * @param params.targetingTypes Targeting type breakdowns for the report. The reporting per targeting type &lt;br&gt; is independent from each other. [\&quot;AGE_BUCKET_AND_GENDER\&quot;, \&quot;CREATIVE_ENHANCEMENTS\&quot;] are in BETA and not yet available to all users.
   * @param params.columns Columns to retrieve, encoded as a comma-separated string. **NOTE**: Any metrics defined as MICRO_DOLLARS returns a value based on the advertiser profile\&#39;s currency field. For USD,($1/1,000,000, or $0.000001 - one one-ten-thousandth of a cent). it\&#39;s microdollars. Otherwise, it\&#39;s in microunits of the advertiser\&#39;s currency.&lt;br/&gt;For example, if the advertiser\&#39;s currency is GBP (British pound sterling), all MICRO_DOLLARS fields will be in GBP microunits (1/1,000,000 British pound).&lt;br/&gt;If a column has no value, it may not be returned
   * @param params.granularity TOTAL - metrics are aggregated over the specified date range.&lt;br&gt; DAY - metrics are broken down daily.&lt;br&gt; HOUR - metrics are broken down hourly.&lt;br&gt;WEEKLY - metrics are broken down weekly.&lt;br&gt;MONTHLY - metrics are broken down monthly
   * @param params.clickWindowDays Number of days to use as the conversion attribution window for a pin click action. Applies to Pinterest Tag conversion metrics. Prior conversion tags use their defined attribution windows. If not specified, defaults to &#x60;30&#x60; days.
   * @param params.engagementWindowDays Number of days to use as the conversion attribution window for an engagement action. Engagements include saves, closeups, link clicks, and carousel card swipes. Applies to Pinterest Tag conversion metrics. Prior conversion tags use their defined attribution windows. If not specified, defaults to &#x60;30&#x60; days.&lt;br&gt; &lt;strong&gt;Note:&lt;/strong&gt; This parameter no longer returns new data. However, you can still access historic data through &lt;strong&gt;Sept 30, 2027&lt;/strong&gt;.
   ...
   * @param params.adAccountId Unique identifier of an ad account.
   * @param params.adGroupUpdateRequest List of ad groups to update, size limit [1, 30].
   */
  async adGroupsUpdate(params: IAdGroupsUpdateParams): Promise<AdGroupArrayResponse> {
    // Verify required parameters are set
    this.ensureParamIsSet('adGroupsUpdate', params, 'adAccountId');
    this.ensureParamIsSet('adGroupsUpdate', params, 'adGroupUpdateRequest');
    ...
    const response = await this.httpClient.createRequest(url)
      ...
      // Encode body parameter
      .withHeader('content-type', 'application/json')
      .withContent(JSON.stringify(params['adGroupUpdateRequest'] || {}))
