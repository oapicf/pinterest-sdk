...
export class AdsApi extends Api {
   ...
   * @param params.adPreviewRequest Create ad preview with pin or image.
   */
   ...
   * @param params.reportingTimezone Specify the timezone to be applied for the reporting. This feature is currently in BETA and is not available to all users.
   */
  async adsAnalytics(params: IAdsAnalyticsParams): Promise<Array<AdsAnalyticsResponseInner>> {
    // Verify required parameters are set
   ...
   * @param params.adAccountId Unique identifier of an ad account.
   * @param params.adCreateRequest List of ads to create, size limit [1, 30].
   */
  async adsCreate(params: IAdsCreateParams): Promise<AdArrayResponse> {
    // Verify required parameters are set
    this.ensureParamIsSet('adsCreate', params, 'adAccountId');
    this.ensureParamIsSet('adsCreate', params, 'adCreateRequest');
    ...
    const response = await this.httpClient.createRequest(url)
      ...
      // Encode body parameter
      .withHeader('content-type', 'application/json')
      .withContent(JSON.stringify(params['adCreateRequest'] || {}))
   ...
   * @param params.adAccountId Unique identifier of an ad account.
   * @param params.adId Unique identifier of an ad.
   */
  async adsGet(params: IAdsGetParams): Promise<AdResponse> {
    // Verify required parameters are set
   ...
   * @param params.adAccountId Unique identifier of an ad account.
   * @param params.adUpdateRequest List of ads to update, size limit [1, 30]
   */
  async adsUpdate(params: IAdsUpdateParams): Promise<AdArrayResponse> {
    // Verify required parameters are set
    this.ensureParamIsSet('adsUpdate', params, 'adAccountId');
    this.ensureParamIsSet('adsUpdate', params, 'adUpdateRequest');
    ...
    const response = await this.httpClient.createRequest(url)
      ...
      // Encode body parameter
      .withHeader('content-type', 'application/json')
      .withContent(JSON.stringify(params['adUpdateRequest'] || {}))
