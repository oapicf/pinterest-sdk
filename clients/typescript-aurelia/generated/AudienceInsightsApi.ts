...
export class AudienceInsightsApi extends Api {
   ...
   */
  async audienceInsightsGet(params: IAudienceInsightsGetParams): Promise<AudienceInsights> {
   ...
   * @param params.adAccountId Unique identifier of an ad account.
   */
  async audienceInsightsScopeAndTypeGet(params: IAudienceInsightsScopeAndTypeGetParams): Promise<AudienceInsightsScopeAndTypeGet200Response> {
    // Verify required parameters are set
