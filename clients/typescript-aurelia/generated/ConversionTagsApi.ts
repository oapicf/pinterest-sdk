...
export class ConversionTagsApi extends Api {
   ...
   * @param params.conversionTagCreate 
   */
  async conversionTagsCreate(params: IConversionTagsCreateParams): Promise<ConversionTag> {
   ...
   */
  async conversionTagsGet(params: IConversionTagsGetParams): Promise<ConversionTag> {
    // Verify required parameters are set
   ...
   * @param params.adAccountId Unique identifier of an ad account.
   * @param params.filterDeleted Filter by deleted status
   */
  async conversionTagsList(params: IConversionTagsListParams): Promise<ConversionTagsList200Response> {
    // Verify required parameters are set
