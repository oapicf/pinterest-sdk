...
export class AdAccountsApi extends Api {
   ...
   * @param params.adAccountId Unique identifier of an ad account.
   * @param params.conversionProductReportRequest 
   */
  async analyticsCreateConversionProductReport(params: IAnalyticsCreateConversionProductReportParams): Promise<AdsAnalyticsCreateAsyncResponse> {
    // Verify required parameters are set
    this.ensureParamIsSet('analyticsCreateConversionProductReport', params, 'adAccountId');
    this.ensureParamIsSet('analyticsCreateConversionProductReport', params, 'conversionProductReportRequest');
    ...
    const response = await this.httpClient.createRequest(url)
      ...
      // Encode body parameter
      .withHeader('content-type', 'application/json')
      .withContent(JSON.stringify(params['conversionProductReportRequest'] || {}))
   ...
   * @param params.granularity    TOTAL - metrics are aggregated over the specified date range.    DAY - metrics are broken down daily.    HOUR - metrics are broken down hourly.    WEEKLY - metrics are broken down weekly.    MONTHLY - metrics are broken down monthly
   */
   ...
   */
  async analyticsGetConversionProductReport(params: IAnalyticsGetConversionProductReportParams): Promise<AdsAnalyticsGetAsyncResponse> {
    // Verify required parameters are set
