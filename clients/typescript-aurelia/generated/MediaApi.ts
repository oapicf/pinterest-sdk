...
export class MediaApi extends Api {
   ...
   * @param params.mediaUploadCreate 
   */
  async mediaCreate(params: IMediaCreateParams): Promise<MediaUpload> {
    // Verify required parameters are set
    this.ensureParamIsSet('mediaCreate', params, 'mediaUploadCreate');
    ...
    const response = await this.httpClient.createRequest(url)
      ...
      .withContent(JSON.stringify(params['mediaUploadCreate'] || {}))
   ...
   * @param params.mediaId Unique identifier for this media upload. Used to track status and for attaching during Pin creation.
   */
  async mediaGet(params: IMediaGetParams): Promise<Media> {
    // Verify required parameters are set
