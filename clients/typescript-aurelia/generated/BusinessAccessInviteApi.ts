...
export class BusinessAccessInviteApi extends Api {
   ...
   * @param params.businessId Unique identifier of the requesting business.
   * @param params.cancelInvitesRequest 
   */
  async cancelInvitesOrRequests(params: ICancelInvitesOrRequestsParams): Promise<CancelInvitesResponse> {
    // Verify required parameters are set
    this.ensureParamIsSet('cancelInvitesOrRequests', params, 'businessId');
    this.ensureParamIsSet('cancelInvitesOrRequests', params, 'cancelInvitesRequest');
    ...
    const response = await this.httpClient.createRequest(url)
      ...
      // Encode body parameter
      .withHeader('content-type', 'application/json')
      .withContent(JSON.stringify(params['cancelInvitesRequest'] || {}))
   ...
   * @param params.businessId Unique identifier of the requesting business.
   * @param params.createAssetInvitesRequest 
   */
   ...
   * @param params.businessId Unique identifier of the requesting business.
   * @param params.createMembershipOrPartnershipInvitesBody 
   */
