...
object AdsAnalyticsAdTargetingType extends Enumeration {
    type AdsAnalyticsAdTargetingType = AdsAnalyticsAdTargetingType.Value
    ...
    val QUIZRESULT = Value("QUIZ_RESULT")
