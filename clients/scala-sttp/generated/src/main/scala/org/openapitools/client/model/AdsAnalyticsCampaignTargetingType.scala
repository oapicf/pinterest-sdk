...
object AdsAnalyticsCampaignTargetingType extends Enumeration {
    type AdsAnalyticsCampaignTargetingType = AdsAnalyticsCampaignTargetingType.Value
    ...
    val CREATIVETYPE = Value("CREATIVE_TYPE")
