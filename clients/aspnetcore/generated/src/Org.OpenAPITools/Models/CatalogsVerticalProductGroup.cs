...
{ 
    ...
    [JsonSubtypes.KnownSubType(typeof(CatalogsCreativeAssetsProductGroup), "CREATIVE_ASSETS")]
    [SwaggerSubType(typeof(CatalogsCreativeAssetsProductGroup), DiscriminatorValue =  "CREATIVE_ASSETS")]
    [JsonSubtypes.KnownSubType(typeof(CatalogsHotelProductGroup), "HOTEL")]
    [SwaggerSubType(typeof(CatalogsHotelProductGroup), DiscriminatorValue =  "HOTEL")]
    [JsonSubtypes.KnownSubType(typeof(CatalogsRetailProductGroup), "RETAIL")]
    [SwaggerSubType(typeof(CatalogsRetailProductGroup), DiscriminatorValue =  "RETAIL")]
    public partial class CatalogsVerticalProductGroup : IEquatable<CatalogsVerticalProductGroup>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((CatalogsVerticalProductGroup)obj);
        }

        /// <summary>
        /// Returns true if CatalogsVerticalProductGroup instances are equal
        /// </summary>
        /// <param name="other">Instance of CatalogsVerticalProductGroup to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CatalogsVerticalProductGroup other)
        {
        ...
        public static bool operator ==(CatalogsVerticalProductGroup left, CatalogsVerticalProductGroup right)
        {
