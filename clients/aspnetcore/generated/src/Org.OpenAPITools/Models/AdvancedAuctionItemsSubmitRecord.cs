...
{ 
    ...
    [JsonSubtypes.KnownSubType(typeof(AdvancedAuctionItemsSubmitDeleteRecord), "DELETE")]
    [SwaggerSubType(typeof(AdvancedAuctionItemsSubmitDeleteRecord), DiscriminatorValue =  "DELETE")]
    [JsonSubtypes.KnownSubType(typeof(AdvancedAuctionItemsSubmitUpsertRecord), "UPSERT")]
    [SwaggerSubType(typeof(AdvancedAuctionItemsSubmitUpsertRecord), DiscriminatorValue =  "UPSERT")]
    public partial class AdvancedAuctionItemsSubmitRecord : IEquatable<AdvancedAuctionItemsSubmitRecord>
    {
        /// <summary>
        ...
        public AdvancedAuctionOperation Operation { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((AdvancedAuctionItemsSubmitRecord)obj);
        }

        /// <summary>
        /// Returns true if AdvancedAuctionItemsSubmitRecord instances are equal
        /// </summary>
        /// <param name="other">Instance of AdvancedAuctionItemsSubmitRecord to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AdvancedAuctionItemsSubmitRecord other)
        {
        ...
        public static bool operator ==(AdvancedAuctionItemsSubmitRecord left, AdvancedAuctionItemsSubmitRecord right)
        {
