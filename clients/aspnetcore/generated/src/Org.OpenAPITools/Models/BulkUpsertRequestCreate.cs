...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class BulkUpsertRequestCreate : IEquatable<BulkUpsertRequestCreate>
    {
        /// <summary>
        ...
        /// </summary>
        [DataMember(Name="catalog_product_groups", EmitDefaultValue=false)]
        public List<MultipleProductGroupsInner> CatalogProductGroups { get; set; }
        ...
        public List<LabelCreateRequest> Labels { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((BulkUpsertRequestCreate)obj);
        }

        /// <summary>
        /// Returns true if BulkUpsertRequestCreate instances are equal
        /// </summary>
        /// <param name="other">Instance of BulkUpsertRequestCreate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BulkUpsertRequestCreate other)
        {
            ...
            return 
                ...
                (
                    CatalogProductGroups == other.CatalogProductGroups ||
                    CatalogProductGroups != null &&
                    other.CatalogProductGroups != null &&
                    CatalogProductGroups.SequenceEqual(other.CatalogProductGroups)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + CatalogProductGroups.GetHashCode();
                    if (Keywords != null)
        ...
        public static bool operator ==(BulkUpsertRequestCreate left, BulkUpsertRequestCreate right)
        {
