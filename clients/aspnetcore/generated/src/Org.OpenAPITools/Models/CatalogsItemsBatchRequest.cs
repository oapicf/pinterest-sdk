...
{ 
    ...
    [JsonSubtypes.KnownSubType(typeof(CatalogsItemsCreateBatchRequest), "CREATE")]
    [SwaggerSubType(typeof(CatalogsItemsCreateBatchRequest), DiscriminatorValue =  "CREATE")]
    [JsonSubtypes.KnownSubType(typeof(CatalogsItemsDeleteBatchRequest), "DELETE")]
    [SwaggerSubType(typeof(CatalogsItemsDeleteBatchRequest), DiscriminatorValue =  "DELETE")]
    [JsonSubtypes.KnownSubType(typeof(CatalogsItemsDeleteDiscontinuedBatchRequest), "DELETE_DISCONTINUED")]
    [SwaggerSubType(typeof(CatalogsItemsDeleteDiscontinuedBatchRequest), DiscriminatorValue =  "DELETE_DISCONTINUED")]
    [JsonSubtypes.KnownSubType(typeof(CatalogsItemsUpdateBatchRequest), "UPDATE")]
    [SwaggerSubType(typeof(CatalogsItemsUpdateBatchRequest), DiscriminatorValue =  "UPDATE")]
    [JsonSubtypes.KnownSubType(typeof(CatalogsItemsUpsertBatchRequest), "UPSERT")]
    [SwaggerSubType(typeof(CatalogsItemsUpsertBatchRequest), DiscriminatorValue =  "UPSERT")]
