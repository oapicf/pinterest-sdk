...
{ 
    ...
    [JsonSubtypes.KnownSubType(typeof(CatalogsCreativeAssetsFeed), "CREATIVE_ASSETS")]
    [SwaggerSubType(typeof(CatalogsCreativeAssetsFeed), DiscriminatorValue =  "CREATIVE_ASSETS")]
    [JsonSubtypes.KnownSubType(typeof(CatalogsHotelFeed), "HOTEL")]
    [SwaggerSubType(typeof(CatalogsHotelFeed), DiscriminatorValue =  "HOTEL")]
    [JsonSubtypes.KnownSubType(typeof(CatalogsRetailFeed), "RETAIL")]
    [SwaggerSubType(typeof(CatalogsRetailFeed), DiscriminatorValue =  "RETAIL")]
    public partial class CatalogsFeed : IEquatable<CatalogsFeed>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((CatalogsFeed)obj);
        }

        /// <summary>
        /// Returns true if CatalogsFeed instances are equal
        /// </summary>
        /// <param name="other">Instance of CatalogsFeed to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CatalogsFeed other)
        {
        ...
        public static bool operator ==(CatalogsFeed left, CatalogsFeed right)
        {
