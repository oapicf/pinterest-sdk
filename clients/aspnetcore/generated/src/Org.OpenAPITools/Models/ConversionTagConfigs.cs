...
{ 
    ...
    public partial class ConversionTagConfigs : IEquatable<ConversionTagConfigs>
    {
        ...
        [DataMember(Name="aem_external_id_enabled", EmitDefaultValue=true)]
        ...
        [DataMember(Name="no_code_capi_domains", EmitDefaultValue=false)]
        ...
        public bool Equals(ConversionTagConfigs other)
        {
            ...
            return 
                ...
                (
                    AemExternalIdEnabled == other.AemExternalIdEnabled ||
                    AemExternalIdEnabled != null &&
                    AemExternalIdEnabled.Equals(other.AemExternalIdEnabled)
                ) && 
                (
                ...
                (
                    NoCodeCapiDomains == other.NoCodeCapiDomains ||
                    NoCodeCapiDomains != null &&
                    other.NoCodeCapiDomains != null &&
                    NoCodeCapiDomains.SequenceEqual(other.NoCodeCapiDomains)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (AemExternalIdEnabled != null)
                    hashCode = hashCode * 59 + AemExternalIdEnabled.GetHashCode();
                    ...
                    if (NoCodeCapiDomains != null)
                    hashCode = hashCode * 59 + NoCodeCapiDomains.GetHashCode();
                return hashCode;
            }
        }
