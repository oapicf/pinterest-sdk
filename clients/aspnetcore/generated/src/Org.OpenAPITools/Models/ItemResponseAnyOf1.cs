...
{ 
    ...
    [JsonSubtypes.KnownSubType(typeof(CatalogsCreativeAssetsItemErrorResponse), "CREATIVE_ASSETS")]
    [SwaggerSubType(typeof(CatalogsCreativeAssetsItemErrorResponse), DiscriminatorValue =  "CREATIVE_ASSETS")]
    [JsonSubtypes.KnownSubType(typeof(CatalogsHotelItemErrorResponse), "HOTEL")]
    [SwaggerSubType(typeof(CatalogsHotelItemErrorResponse), DiscriminatorValue =  "HOTEL")]
    [JsonSubtypes.KnownSubType(typeof(CatalogsRetailItemErrorResponse), "RETAIL")]
    [SwaggerSubType(typeof(CatalogsRetailItemErrorResponse), DiscriminatorValue =  "RETAIL")]
    public partial class ItemResponseAnyOf1 : IEquatable<ItemResponseAnyOf1>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((ItemResponseAnyOf1)obj);
        }

        /// <summary>
        /// Returns true if ItemResponseAnyOf1 instances are equal
        /// </summary>
        /// <param name="other">Instance of ItemResponseAnyOf1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ItemResponseAnyOf1 other)
        {
        ...
        public static bool operator ==(ItemResponseAnyOf1 left, ItemResponseAnyOf1 right)
        {
