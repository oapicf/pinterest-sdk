...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class AuthRespondInvitesBodyInvitesInnerAction : IEquatable<AuthRespondInvitesBodyInvitesInnerAction>
    {
        /// <summary>
        ...
        [Required]
        [DataMember(Name="accept_invite", EmitDefaultValue=true)]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((AuthRespondInvitesBodyInvitesInnerAction)obj);
        }

        /// <summary>
        /// Returns true if AuthRespondInvitesBodyInvitesInnerAction instances are equal
        /// </summary>
        /// <param name="other">Instance of AuthRespondInvitesBodyInvitesInnerAction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthRespondInvitesBodyInvitesInnerAction other)
        {
            ...
            return 
                (
                    AcceptInvite == other.AcceptInvite ||
                    
                    AcceptInvite.Equals(other.AcceptInvite)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + AcceptInvite.GetHashCode();
        ...
        public static bool operator ==(AuthRespondInvitesBodyInvitesInnerAction left, AuthRespondInvitesBodyInvitesInnerAction right)
        {
