...
{ 
    ...
    { 
        ...
        /// <response code="400">Invalid ad account pins analytics parameters.</response>
        /// <response code="0">Unexpected error</response>
        [HttpGet]
        [Route("/v5/ad_accounts/{ad_account_id}/pins/analytics")]
        [ValidateModelState]
        [SwaggerOperation("AdPinsAnalytics")]
        [SwaggerResponse(statusCode: 200, type: typeof(List<AdPinAnalytics>), description: "Success")]
        [SwaggerResponse(statusCode: 400, type: typeof(Error), description: "Invalid ad account pins analytics parameters.")]
        [SwaggerResponse(statusCode: 0, type: typeof(Error), description: "Unexpected error")]
        public virtual IActionResult AdPinsAnalytics([FromRoute (Name = "ad_account_id")][Required][RegularExpression("^\\d+$")] [MaxLength(18)]string adAccountId, [FromQuery (Name = "campaign_id")][Required()][RegularExpression("^\\d+$")] [MaxLength(18)]string campaignId, [FromQuery (Name = "pin_ids")][Required()]List<string> pinIds, [FromQuery (Name = "start_date")][Required()]DateOnly startDate, [FromQuery (Name = "end_date")][Required()]DateOnly endDate, [FromQuery (Name = "columns")][Required()]List<string> columns, [FromQuery (Name = "granularity")][Required()]Granularity granularity, [FromQuery (Name = "click_window_days")]int? clickWindowDays, [FromQuery (Name = "engagement_window_days")]int? engagementWindowDays, [FromQuery (Name = "view_window_days")]int? viewWindowDays, [FromQuery (Name = "conversion_report_time")]string conversionReportTime)
        {
        ...
        /// Update campaigns
        /// </summary>
        /// <remarks>&lt;p&gt;Update multiple ad campaigns based on campaign_ids. &lt;/p&gt; &lt;p&gt;&lt;strong&gt;Note:&lt;/strong&gt;&lt;/p&gt; - &lt;p&gt;The values for &#x60;lifetime_spend_cap&#x60; and &#x60;daily_spend_cap&#x60; are microcurrency amounts based on the currency field set in the advertiser&#39;s profile. (e.g. USD) &lt;p/&gt; &lt;p&gt;Microcurrency is used to track very small transactions, based on the currency set in the advertiser&#39;s profile.&lt;/p&gt; &lt;p&gt;A microcurrency unit is 10^(-6) of the standard unit of currency selected in the advertiser&#39;s profile.&lt;/p&gt; &lt;p&gt;&lt;strong&gt;Equivalency equations&lt;/strong&gt;, using dollars as an example currency:&lt;/p&gt; &lt;ul&gt;   &lt;li&gt;$1 &#x3D; 1,000,000 microdollars&lt;/li&gt;   &lt;li&gt;1 microdollar &#x3D; $0.000001 &lt;/li&gt; &lt;/ul&gt; &lt;p&gt;&lt;strong&gt;To convert between currency and microcurrency&lt;/strong&gt;, using dollars as an example currency:&lt;/p&gt; &lt;ul&gt;   &lt;li&gt;To convert dollars to microdollars, mutiply dollars by 1,000,000&lt;/li&gt;   &lt;li&gt;To convert microdollars to dollars, divide microdollars by 1,000,000&lt;/li&gt; &lt;/ul&gt;</remarks>
        /// <param name="adAccountId">Unique identifier of an ad account.</param>
