...
{ 
    ...
    { 
        ...
        /// <response code="206">Response containing the results of the item bid options operations (where some/all operation results have errors)</response>
        /// <response code="400">Invalid request parameters.</response>
        ...
        [SwaggerResponse(statusCode: 206, type: typeof(AdvancedAuctionProcessedItems), description: "Response containing the results of the item bid options operations (where some/all operation results have errors)")]
        [SwaggerResponse(statusCode: 400, type: typeof(Error), description: "Invalid request parameters.")]
