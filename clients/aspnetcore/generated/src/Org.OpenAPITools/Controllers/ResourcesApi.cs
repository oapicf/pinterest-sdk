...
{ 
    ...
    { 
        ...
        /// </summary>
        /// <remarks>Get a list of all lead form question type names. Some questions might not be used.  &lt;strong&gt;This endpoint is currently in beta and not available to all apps. &lt;a href&#x3D;&#39;/docs/new/about-beta-access/&#39;&gt;Learn more&lt;/a&gt;.&lt;/strong&gt;</remarks>
        /// <response code="200">Success</response>
        /// <response code="0">Unexpected error</response>
        [HttpGet]
        ...
        [SwaggerResponse(statusCode: 0, type: typeof(Error), description: "Unexpected error")]
        public virtual IActionResult TargetingOptionsGet([FromRoute (Name = "targeting_type")][Required]string targetingType, [FromQuery (Name = "client_id")][RegularExpression("^\\d+$")] [MaxLength(18)]string clientId, [FromQuery (Name = "oauth_signature")]string oauthSignature, [FromQuery (Name = "timestamp")][RegularExpression("\\d+")]string timestamp)
        {
