  ...
  module Models
    ...
    module CatalogsProduct
      ...
      def self.build(data)
        ...
        mapping = { 'CREATIVE_ASSETS' => OpenapiClient::Models::CatalogsCreativeAssetsProduct, 'HOTEL' => OpenapiClient::Models::CatalogsHotelProduct, 'RETAIL' => OpenapiClient::Models::CatalogsRetailProduct }
        klass = mapping[key]
