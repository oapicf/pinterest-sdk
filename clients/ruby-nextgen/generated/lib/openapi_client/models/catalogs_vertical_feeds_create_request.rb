  ...
  module Models
    ...
    module CatalogsVerticalFeedsCreateRequest
      ...
      def self.build(data)
        ...
        mapping = { 'CREATIVE_ASSETS' => OpenapiClient::Models::CatalogsCreativeAssetsFeedsCreateRequest, 'HOTEL' => OpenapiClient::Models::CatalogsHotelFeedsCreateRequest, 'RETAIL' => OpenapiClient::Models::CatalogsRetailFeedsCreateRequest }
        klass = mapping[key]
