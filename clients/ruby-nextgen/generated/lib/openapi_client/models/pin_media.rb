...
module OpenapiClient
  module Models
    ...
    module PinMedia
      ...
      def self.build(data)
        key = data['media_type']
        mapping = { 'image' => OpenapiClient::Models::PinMediaWithImage, 'multiple_images' => OpenapiClient::Models::PinMediaWithImages, 'multiple_mixed' => OpenapiClient::Models::PinMediaWithImageAndVideo, 'multiple_videos' => OpenapiClient::Models::PinMediaWithVideos, 'video' => OpenapiClient::Models::PinMediaWithVideo }
        klass = mapping[key]
