  ...
  module Models
    ...
    module CatalogsVerticalProductGroup
      ...
      def self.build(data)
        ...
        mapping = { 'CREATIVE_ASSETS' => OpenapiClient::Models::CatalogsCreativeAssetsProductGroup, 'HOTEL' => OpenapiClient::Models::CatalogsHotelProductGroup, 'RETAIL' => OpenapiClient::Models::CatalogsRetailProductGroup }
        klass = mapping[key]
