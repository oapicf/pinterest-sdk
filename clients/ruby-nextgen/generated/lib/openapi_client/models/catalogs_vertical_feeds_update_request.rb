  ...
  module Models
    ...
    module CatalogsVerticalFeedsUpdateRequest
      ...
      def self.build(data)
        ...
        mapping = { 'CREATIVE_ASSETS' => OpenapiClient::Models::CatalogsCreativeAssetsFeedsUpdateRequest, 'HOTEL' => OpenapiClient::Models::CatalogsHotelFeedsUpdateRequest, 'RETAIL' => OpenapiClient::Models::CatalogsRetailFeedsUpdateRequest }
        klass = mapping[key]
