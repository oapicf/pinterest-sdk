...
module OpenapiClient
  module Models
    ...
    module CatalogsVerticalsListProductsByCatalogBasedFilterRequest
      ...
      def self.build(data)
        key = data['catalog_type']
        mapping = { 'CREATIVE_ASSETS' => OpenapiClient::Models::CatalogsCreativeAssetsListProductsByCatalogBasedFilterRequest, 'HOTEL' => OpenapiClient::Models::CatalogsHotelListProductsByCatalogBasedFilterRequest, 'RETAIL' => OpenapiClient::Models::CatalogsRetailListProductsByCatalogBasedFilterRequest }
        klass = mapping[key]
