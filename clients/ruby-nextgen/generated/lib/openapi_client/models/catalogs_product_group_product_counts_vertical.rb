  ...
  module Models
    ...
    module CatalogsProductGroupProductCountsVertical
      ...
      def self.build(data)
        ...
        mapping = { 'CREATIVE_ASSETS' => OpenapiClient::Models::CatalogsCreativeAssetsProductGroupProductCounts, 'HOTEL' => OpenapiClient::Models::CatalogsHotelProductGroupProductCounts, 'RETAIL' => OpenapiClient::Models::CatalogsRetailProductGroupProductCounts }
        klass = mapping[key]
