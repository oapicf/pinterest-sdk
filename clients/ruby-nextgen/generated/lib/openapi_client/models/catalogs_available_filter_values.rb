  ...
  module Models
    ...
    module CatalogsAvailableFilterValues
      ...
      def self.build(data)
        ...
        mapping = { 'CREATIVE_ASSETS' => OpenapiClient::Models::CatalogsCreativeAssetsAvailableFilterValues, 'HOTEL' => OpenapiClient::Models::CatalogsHotelAvailableFilterValues, 'RETAIL' => OpenapiClient::Models::CatalogsRetailAvailableFilterValues }
        klass = mapping[key]
