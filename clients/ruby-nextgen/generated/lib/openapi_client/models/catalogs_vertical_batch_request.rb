  ...
  module Models
    ...
    module CatalogsVerticalBatchRequest
      ...
      def self.build(data)
        ...
        mapping = { 'CREATIVE_ASSETS' => OpenapiClient::Models::CatalogsCreativeAssetsBatchRequest, 'HOTEL' => OpenapiClient::Models::CatalogsHotelBatchRequest, 'RETAIL' => OpenapiClient::Models::CatalogsRetailBatchRequest }
        klass = mapping[key]
