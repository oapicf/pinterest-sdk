  ...
  module Models
    ...
    module CatalogsHotelReportStatsParametersReport
      ...
      def self.build(data)
        ...
        mapping = { 'DISTRIBUTION_ISSUES' => OpenapiClient::Models::CatalogsReportDistributionIssueFilter, 'FEED_INGESTION_ISSUES' => OpenapiClient::Models::CatalogsReportFeedIngestionFilter }
        klass = mapping[key]
