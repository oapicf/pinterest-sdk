  ...
  module Models
    ...
    module CatalogsFeed
      ...
      def self.build(data)
        ...
        mapping = { 'CREATIVE_ASSETS' => OpenapiClient::Models::CatalogsCreativeAssetsFeed, 'HOTEL' => OpenapiClient::Models::CatalogsHotelFeed, 'RETAIL' => OpenapiClient::Models::CatalogsRetailFeed }
        klass = mapping[key]
