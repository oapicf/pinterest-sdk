...
module OpenapiClient
  module Models
    ...
    module CatalogsRetailReportParametersReport
      ...
      def self.build(data)
        key = data['report_type']
        mapping = { 'ALL_ITEMS' => OpenapiClient::Models::CatalogsRetailReportAllItemsFilter, 'DISTRIBUTION_ISSUES' => OpenapiClient::Models::CatalogsReportDistributionIssueFilter, 'FEED_INGESTION_ISSUES' => OpenapiClient::Models::CatalogsReportFeedIngestionFilter }
        klass = mapping[key]
