...
module OpenapiClient
  module Models
    ...
    module CatalogsHotelBatchItem
      ...
      def self.build(data)
        key = data['operation']
        mapping = { 'CREATE' => OpenapiClient::Models::CatalogsCreateHotelItem, 'DELETE' => OpenapiClient::Models::CatalogsDeleteHotelItem, 'UPDATE' => OpenapiClient::Models::CatalogsUpdateHotelItem, 'UPSERT' => OpenapiClient::Models::CatalogsUpsertHotelItem }
        klass = mapping[key]
