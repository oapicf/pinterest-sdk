...
module OpenapiClient
  module Models
    ...
    module CatalogsCreativeAssetsBatchItem
      ...
      def self.build(data)
        key = data['operation']
        mapping = { 'CREATE' => OpenapiClient::Models::CatalogsCreateCreativeAssetsItem, 'DELETE' => OpenapiClient::Models::CatalogsDeleteCreativeAssetsItem, 'UPDATE' => OpenapiClient::Models::CatalogsUpdateCreativeAssetsItem, 'UPSERT' => OpenapiClient::Models::CatalogsUpsertCreativeAssetsItem }
        klass = mapping[key]
