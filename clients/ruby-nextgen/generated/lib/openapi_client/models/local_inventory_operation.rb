...
module OpenapiClient
  module Models
    ...
    module LocalInventoryOperation
      ...
      def self.build(data)
        key = data['operation']
        mapping = { 'CREATE' => OpenapiClient::Models::LocalInventoryCreateOperation, 'DELETE' => OpenapiClient::Models::LocalInventoryDeleteOperation, 'UPDATE' => OpenapiClient::Models::LocalInventoryUpdateOperation, 'UPSERT' => OpenapiClient::Models::LocalInventoryUpsertOperation }
        klass = mapping[key]
