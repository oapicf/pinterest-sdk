...
module OpenapiClient
  module Models
    ...
    module CatalogsRetailBatchRequestItemsItems
      ...
      def self.build(data)
        key = data['operation']
        mapping = { 'CREATE' => OpenapiClient::Models::CatalogsCreateRetailItem, 'DELETE' => OpenapiClient::Models::CatalogsDeleteRetailItem, 'UPDATE' => OpenapiClient::Models::CatalogsUpdateRetailItem, 'UPSERT' => OpenapiClient::Models::CatalogsUpsertRetailItem }
        klass = mapping[key]
