  ...
  module Models
    ...
    module CatalogsVerticalProductGroupCreateRequest
      ...
      def self.build(data)
        ...
        mapping = { 'CREATIVE_ASSETS' => OpenapiClient::Models::CatalogsCreativeAssetsProductGroupCreateRequest, 'HOTEL' => OpenapiClient::Models::CatalogsHotelProductGroupCreateRequest, 'RETAIL' => OpenapiClient::Models::CatalogsRetailProductGroupCreateRequest }
        klass = mapping[key]
