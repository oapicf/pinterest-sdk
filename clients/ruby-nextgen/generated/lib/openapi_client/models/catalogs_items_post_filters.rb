  ...
  module Models
    ...
    module CatalogsItemsPostFilters
      ...
      def self.build(data)
        ...
        mapping = { 'CREATIVE_ASSETS' => OpenapiClient::Models::CatalogsCreativeAssetsItemsPostFilter, 'HOTEL' => OpenapiClient::Models::CatalogsHotelItemsPostFilter, 'RETAIL' => OpenapiClient::Models::CatalogsRetailItemsPostFilter }
        klass = mapping[key]
