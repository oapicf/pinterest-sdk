  ...
  module Models
    ...
    module CatalogsReportStats
      ...
      def self.build(data)
        ...
        mapping = { 'DISTRIBUTION_ISSUES' => OpenapiClient::Models::CatalogsReportDistributionStats, 'FEED_INGESTION_ISSUES' => OpenapiClient::Models::CatalogsReportFeedIngestionStats }
        klass = mapping[key]
