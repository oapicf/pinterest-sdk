...
module OpenapiClient
  module Models
    ...
    module CatalogsItemsBatchRequest
      ...
      def self.build(data)
        key = data['operation']
        mapping = { 'CREATE' => OpenapiClient::Models::CatalogsItemsCreateBatchRequest, 'DELETE' => OpenapiClient::Models::CatalogsItemsDeleteBatchRequest, 'DELETE_DISCONTINUED' => OpenapiClient::Models::CatalogsItemsDeleteDiscontinuedBatchRequest, 'UPDATE' => OpenapiClient::Models::CatalogsItemsUpdateBatchRequest, 'UPSERT' => OpenapiClient::Models::CatalogsItemsUpsertBatchRequest }
        klass = mapping[key]
