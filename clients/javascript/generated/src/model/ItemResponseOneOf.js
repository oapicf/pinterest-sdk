...
/**
 * The ItemResponseOneOf model module.
 * @module model/ItemResponseOneOf
 * @version 1.1.1-pre.0
 */
class ItemResponseOneOf {
    /**
     * Constructs a new <code>ItemResponseOneOf</code>.
     * Successful item response
     * @alias module:model/ItemResponseOneOf
     * @param {(module:model/CatalogsCreativeAssetsItemResponse|module:model/CatalogsHotelItemResponse|module:model/CatalogsRetailItemResponse)} instance The actual instance to initialize ItemResponseOneOf.
     */
    constructor(instance = null) {
        ...
        if (match > 1) {
            throw new Error("Multiple matches found constructing `ItemResponseOneOf` with oneOf schemas CatalogsCreativeAssetsItemResponse, CatalogsHotelItemResponse, CatalogsRetailItemResponse. Input: " + JSON.stringify(instance));
        } else if (match === 0) {
            this.actualInstance = null; // clear the actual instance in case there are multiple matches
            throw new Error("No match found constructing `ItemResponseOneOf` with oneOf schemas CatalogsCreativeAssetsItemResponse, CatalogsHotelItemResponse, CatalogsRetailItemResponse. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
    ...
    /**
     * Constructs a <code>ItemResponseOneOf</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ItemResponseOneOf} obj Optional instance to populate.
     * @return {module:model/ItemResponseOneOf} The populated <code>ItemResponseOneOf</code> instance.
     */
    static constructFromObject(data, obj) {
        return new ItemResponseOneOf(data);
    }
    ...
    setActualInstance(obj) {
       this.actualInstance = ItemResponseOneOf.constructFromObject(obj).getActualInstance();
    }
     ...
     * @return {module:model/ItemResponseOneOf} An instance of ItemResponseOneOf.
     */
    static fromJSON = function(json_string){
        return ItemResponseOneOf.constructFromObject(JSON.parse(json_string));
    }
}
 ...
 */
ItemResponseOneOf.prototype['catalog_type'] = undefined;

/**
 * @member {module:model/CatalogsCreativeAssetsAttributes} attributes
 */
ItemResponseOneOf.prototype['attributes'] = undefined;

/**
 * The catalog retail item id in the merchant namespace
 * @member {String} item_id
 */
ItemResponseOneOf.prototype['item_id'] = undefined;

/**
 * The pins mapped to the item
 * @member {Array.<module:model/Pin>} pins
 */
ItemResponseOneOf.prototype['pins'] = undefined;

/**
 * The catalog hotel id in the merchant namespace
 * @member {String} hotel_id
 */
ItemResponseOneOf.prototype['hotel_id'] = undefined;

/**
 * The catalog creative assets id in the merchant namespace
 * @member {String} creative_assets_id
 */
ItemResponseOneOf.prototype['creative_assets_id'] = undefined;


ItemResponseOneOf.OneOf = ["CatalogsCreativeAssetsItemResponse", "CatalogsHotelItemResponse", "CatalogsRetailItemResponse"];

export default ItemResponseOneOf;
