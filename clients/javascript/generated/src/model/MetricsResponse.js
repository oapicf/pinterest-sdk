    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [MetricsResponseDataItems]);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        if (data['data']) { // data not null
            ...
            for (const item of data['data']) {
                MetricsResponseDataItems.validateJSON(item);
            };
        }
...
/**
 * @member {Array.<module:model/MetricsResponseDataItems>} data
 */
