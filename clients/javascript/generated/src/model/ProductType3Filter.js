...
class ProductType3Filter {
    ...
    static validateJSON(data) {
        ...
        // validate the optional field `PRODUCT_TYPE_3`
        if (data['PRODUCT_TYPE_3']) { // data not null
          CatalogsProductGroupMultipleStringListCriteria.validateJSON(data['PRODUCT_TYPE_3']);
        }
