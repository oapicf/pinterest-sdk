        ...
        if (instance && typeof instance === 'object' && instance['catalog_type'] !== undefined) {
            ...
            switch (discriminatorValue) {
                case 'CREATIVE_ASSETS':
                    try {
                        CatalogsCreativeAssetsFeedsCreateRequest.validateJSON(instance);
                        this.actualInstance = CatalogsCreativeAssetsFeedsCreateRequest.constructFromObject(instance);
                        return;
                    } catch(err) {
                        throw new Error("Failed to construct CatalogsCreativeAssetsFeedsCreateRequest using discriminator value 'CREATIVE_ASSETS': " + err);
                    }
                case 'HOTEL':
                    try {
                        CatalogsHotelFeedsCreateRequest.validateJSON(instance);
                        this.actualInstance = CatalogsHotelFeedsCreateRequest.constructFromObject(instance);
                        return;
                    } catch(err) {
                        throw new Error("Failed to construct CatalogsHotelFeedsCreateRequest using discriminator value 'HOTEL': " + err);
                    }
                case 'RETAIL':
                    try {
                        CatalogsRetailFeedsCreateRequest.validateJSON(instance);
                        this.actualInstance = CatalogsRetailFeedsCreateRequest.constructFromObject(instance);
                        return;
                    } catch(err) {
                        throw new Error("Failed to construct CatalogsRetailFeedsCreateRequest using discriminator value 'RETAIL': " + err);
                    }
                default:
                    throw new Error("Unrecognized discriminator value '" + discriminatorValue + "' constructing `CatalogsVerticalFeedsCreateRequest`. Expected one of: CREATIVE_ASSETS, HOTEL, RETAIL.");
            }
        }
...
/**
 * @member {module:model/CatalogsVerticalFeedsCreateRequest.CatalogTypeEnum} catalog_type
 */
