...
class CatalogsProductGroupFiltersAnyOf {
    ...
    constructor(anyOf) { 
        ...
        CatalogsProductGroupFiltersAnyOf.initialize(this, anyOf);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CatalogsProductGroupFiltersAnyOf</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CatalogsProductGroupFiltersAnyOf</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CatalogsProductGroupFiltersAnyOf.RequiredProperties) {
...
CatalogsProductGroupFiltersAnyOf.RequiredProperties = ["any_of"];
