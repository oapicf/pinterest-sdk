...
/**
 * The ItemResponseOneOf1 model module.
 * @module model/ItemResponseOneOf1
 * @version 1.1.1-pre.0
 */
class ItemResponseOneOf1 {
    /**
     * Constructs a new <code>ItemResponseOneOf1</code>.
     * Error item response
     * @alias module:model/ItemResponseOneOf1
     * @param {(module:model/CatalogsCreativeAssetsItemErrorResponse|module:model/CatalogsHotelItemErrorResponse|module:model/CatalogsRetailItemErrorResponse)} instance The actual instance to initialize ItemResponseOneOf1.
     */
    constructor(instance = null) {
        ...
        if (match > 1) {
            throw new Error("Multiple matches found constructing `ItemResponseOneOf1` with oneOf schemas CatalogsCreativeAssetsItemErrorResponse, CatalogsHotelItemErrorResponse, CatalogsRetailItemErrorResponse. Input: " + JSON.stringify(instance));
        } else if (match === 0) {
            this.actualInstance = null; // clear the actual instance in case there are multiple matches
            throw new Error("No match found constructing `ItemResponseOneOf1` with oneOf schemas CatalogsCreativeAssetsItemErrorResponse, CatalogsHotelItemErrorResponse, CatalogsRetailItemErrorResponse. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
    ...
    /**
     * Constructs a <code>ItemResponseOneOf1</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ItemResponseOneOf1} obj Optional instance to populate.
     * @return {module:model/ItemResponseOneOf1} The populated <code>ItemResponseOneOf1</code> instance.
     */
    static constructFromObject(data, obj) {
        return new ItemResponseOneOf1(data);
    }
    ...
    setActualInstance(obj) {
       this.actualInstance = ItemResponseOneOf1.constructFromObject(obj).getActualInstance();
    }
     ...
     * @return {module:model/ItemResponseOneOf1} An instance of ItemResponseOneOf1.
     */
    static fromJSON = function(json_string){
        return ItemResponseOneOf1.constructFromObject(JSON.parse(json_string));
    }
}
 ...
 */
ItemResponseOneOf1.prototype['catalog_type'] = undefined;

/**
 * @member {Array.<module:model/ItemValidationEvent>} errors
 */
ItemResponseOneOf1.prototype['errors'] = undefined;

/**
 * The catalog item id in the merchant namespace
 * @member {String} item_id
 */
ItemResponseOneOf1.prototype['item_id'] = undefined;

/**
 * The catalog hotel id in the merchant namespace
 * @member {String} hotel_id
 */
ItemResponseOneOf1.prototype['hotel_id'] = undefined;

/**
 * The catalog creative assets id in the merchant namespace
 * @member {String} creative_assets_id
 */
ItemResponseOneOf1.prototype['creative_assets_id'] = undefined;


ItemResponseOneOf1.OneOf = ["CatalogsCreativeAssetsItemErrorResponse", "CatalogsHotelItemErrorResponse", "CatalogsRetailItemErrorResponse"];

export default ItemResponseOneOf1;
