...
class OrderLine {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            OrderLines.constructFromObject(data, obj);
...
OrderLine.RequiredProperties = ["campaign_ids"];
...
// Implement OrderLines interface:
/**
 * Order line ID.
 * @member {String} id
 */
