...
class ProductType4Filter {
    ...
    static validateJSON(data) {
        ...
        // validate the optional field `PRODUCT_TYPE_4`
        if (data['PRODUCT_TYPE_4']) { // data not null
          CatalogsProductGroupMultipleStringListCriteria.validateJSON(data['PRODUCT_TYPE_4']);
        }
