...
class MediaUploadRequest {
    ...
    /**
     * Validates the JSON data with respect to <code>MediaUploadRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MediaUploadRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of MediaUploadRequest.RequiredProperties) {
...
MediaUploadRequest.RequiredProperties = ["media_type"];
