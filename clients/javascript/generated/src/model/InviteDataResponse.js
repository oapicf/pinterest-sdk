...
/**
 * The InviteDataResponse model module.
 * @module model/InviteDataResponse
 * @version 2.0.1-pre.0
 */
class InviteDataResponse {
    /**
     * Constructs a new <code>InviteDataResponse</code>.
     * Metadata for the invite/request.
     * @alias module:model/InviteDataResponse
     */
    constructor() { 
        
        InviteDataResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InviteDataResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InviteDataResponse} obj Optional instance to populate.
     * @return {module:model/InviteDataResponse} The populated <code>InviteDataResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InviteDataResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>InviteDataResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InviteDataResponse</code>.
     */
 ...
 */
InviteDataResponse.prototype['invite_expiration'] = undefined;
 ...
 */
InviteDataResponse.prototype['invite_status'] = undefined;
...
export default InviteDataResponse;
