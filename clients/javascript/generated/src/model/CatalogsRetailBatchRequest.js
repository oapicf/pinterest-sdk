...
class CatalogsRetailBatchRequest {
     ...
     * @param items {Array.<module:model/CatalogsRetailBatchRequestItemsItems>} Array with catalogs item operations
     * @param language {module:model/CatalogsRetailBatchRequest.LanguageEnum} We recommend using the CatalogsLocale values.
     */
    constructor(catalogType, country, items, language) { 
        
        CatalogsRetailBatchRequest.initialize(this, catalogType, country, items, language);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('items')) {
                obj['items'] = ApiClient.convertToType(data['items'], [CatalogsRetailBatchRequestItemsItems]);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['items']) { // data not null
            ...
            for (const item of data['items']) {
                CatalogsRetailBatchRequestItemsItems.validateJSON(item);
            };
        }
        // ensure the json data is a string
...
CatalogsRetailBatchRequest.RequiredProperties = ["catalog_type", "country", "items", "language"];

/**
 * Catalog id pertaining to the retail item. If not provided, default to oldest retail catalog
 * @member {String} catalog_id
 */
CatalogsRetailBatchRequest.prototype['catalog_id'] = undefined;
 ...
 * @member {Array.<module:model/CatalogsRetailBatchRequestItemsItems>} items
 */
CatalogsRetailBatchRequest.prototype['items'] = undefined;

/**
 * We recommend using the CatalogsLocale values.
 * @member {module:model/CatalogsRetailBatchRequest.LanguageEnum} language
 */
 ...
 * @readonly
 */
CatalogsRetailBatchRequest['LanguageEnum'] = {
