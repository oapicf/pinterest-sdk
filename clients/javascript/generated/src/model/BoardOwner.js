...
class BoardOwner {
     ...
     * @implements module:model/BoardOwner
     */
    constructor() { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            BoardOwner.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>BoardOwner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BoardOwner</code>.
     */
 ...
 */
BoardOwner.prototype['username'] = undefined;


// Implement BoardOwner interface:
/**
 * @member {String} username
 */
BoardOwner.prototype['username'] = undefined;
