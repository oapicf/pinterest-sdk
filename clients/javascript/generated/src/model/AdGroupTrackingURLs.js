...
/**
 * The AdGroupTrackingURLs model module.
 * @module model/AdGroupTrackingURLs
 * @version 2.0.1-pre.0
 */
class AdGroupTrackingURLs {
    /**
     * Constructs a new <code>AdGroupTrackingURLs</code>.
     ...
     * @alias module:model/AdGroupTrackingURLs
     */
    constructor() { 
        
        AdGroupTrackingURLs.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AdGroupTrackingURLs</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AdGroupTrackingURLs} obj Optional instance to populate.
     * @return {module:model/AdGroupTrackingURLs} The populated <code>AdGroupTrackingURLs</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AdGroupTrackingURLs();
    ...
    /**
     * Validates the JSON data with respect to <code>AdGroupTrackingURLs</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AdGroupTrackingURLs</code>.
     */
 ...
 */
AdGroupTrackingURLs.prototype['audience_verification'] = undefined;

/**
 * @member {Array.<String>} buyable_button
 */
AdGroupTrackingURLs.prototype['buyable_button'] = undefined;

/**
 * @member {Array.<String>} click
 */
AdGroupTrackingURLs.prototype['click'] = undefined;

/**
 * @member {Array.<String>} engagement
 */
AdGroupTrackingURLs.prototype['engagement'] = undefined;

/**
 * @member {Array.<String>} impression
 */
AdGroupTrackingURLs.prototype['impression'] = undefined;
...
export default AdGroupTrackingURLs;
