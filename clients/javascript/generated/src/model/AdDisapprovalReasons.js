...
* @readonly
*/
export default class AdDisapprovalReasons {
    ...
    /**
    * Returns a <code>AdDisapprovalReasons</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/AdDisapprovalReasons} The enum <code>AdDisapprovalReasons</code> value.
    */
