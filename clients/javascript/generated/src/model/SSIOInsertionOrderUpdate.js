...
/**
 * The SSIOInsertionOrderUpdate model module.
 * @module model/SSIOInsertionOrderUpdate
 * @version 2.0.1-pre.0
 */
class SSIOInsertionOrderUpdate {
    /**
     * Constructs a new <code>SSIOInsertionOrderUpdate</code>.
     * Resource create or update operation model.
     * @alias module:model/SSIOInsertionOrderUpdate
     */
    constructor() { 
        
        SSIOInsertionOrderUpdate.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SSIOInsertionOrderUpdate</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SSIOInsertionOrderUpdate} obj Optional instance to populate.
     * @return {module:model/SSIOInsertionOrderUpdate} The populated <code>SSIOInsertionOrderUpdate</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SSIOInsertionOrderUpdate();
    ...
    /**
     * Validates the JSON data with respect to <code>SSIOInsertionOrderUpdate</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SSIOInsertionOrderUpdate</code>.
     */
 ...
 */
SSIOInsertionOrderUpdate.prototype['ads_manager_order_line_id'] = undefined;

/**
 * URL link for agency
 * @member {String} agency_link
 */
SSIOInsertionOrderUpdate.prototype['agency_link'] = undefined;

/**
 * The billing contact email
 * @member {String} billing_contact_email
 */
SSIOInsertionOrderUpdate.prototype['billing_contact_email'] = undefined;

/**
 * The billing contact first name
 * @member {String} billing_contact_firstname
 */
SSIOInsertionOrderUpdate.prototype['billing_contact_firstname'] = undefined;

/**
 * The billing contact last name
 * @member {String} billing_contact_lastname
 */
SSIOInsertionOrderUpdate.prototype['billing_contact_lastname'] = undefined;

/**
 * If Budget order line, the budget amount.
 * @member {Number} budget_amount
 */
SSIOInsertionOrderUpdate.prototype['budget_amount'] = undefined;

/**
 * End date of time period. Format: YYYY-MM-DD
 * @member {String} end_date
 */
SSIOInsertionOrderUpdate.prototype['end_date'] = undefined;

/**
 * The media contact email
 * @member {String} media_contact_email
 */
SSIOInsertionOrderUpdate.prototype['media_contact_email'] = undefined;

/**
 * The media contact first name
 * @member {String} media_contact_firstname
 */
SSIOInsertionOrderUpdate.prototype['media_contact_firstname'] = undefined;

/**
 * The media contact last name
 * @member {String} media_contact_lastname
 */
SSIOInsertionOrderUpdate.prototype['media_contact_lastname'] = undefined;

/**
 * LineId in the Oracle DB
 * @member {String} oracle_line_id
 */
SSIOInsertionOrderUpdate.prototype['oracle_line_id'] = undefined;

/**
 * The po number
 * @member {String} po_number
 */
SSIOInsertionOrderUpdate.prototype['po_number'] = undefined;

/**
 * OrderId in SFDC
 * @member {String} salesforce_order_id
 */
SSIOInsertionOrderUpdate.prototype['salesforce_order_id'] = undefined;

/**
 * OrderLineId in SFDC
 * @member {String} salesforce_order_line_id
 */
SSIOInsertionOrderUpdate.prototype['salesforce_order_line_id'] = undefined;

/**
 * Starting date of time period. Format: YYYY-MM-DD
 * @member {String} start_date
 */
SSIOInsertionOrderUpdate.prototype['start_date'] = undefined;

/**
 * The email of user submitting the insertion order
 * @member {String} user_email
 */
SSIOInsertionOrderUpdate.prototype['user_email'] = undefined;
...
export default SSIOInsertionOrderUpdate;
