...
/**
 * The AdBatchUpdate model module.
 * @module model/AdBatchUpdate
 * @version 2.0.1-pre.0
 */
class AdBatchUpdate {
    /**
     * Constructs a new <code>AdBatchUpdate</code>.
     * @alias module:model/AdBatchUpdate
     * @param id {String} The ID of this ad.
     */
    constructor(id) { 
        
        AdBatchUpdate.initialize(this, id);
    }
    ...
    /**
     * Constructs a <code>AdBatchUpdate</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AdBatchUpdate} obj Optional instance to populate.
     * @return {module:model/AdBatchUpdate} The populated <code>AdBatchUpdate</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AdBatchUpdate();
    ...
    /**
     * Validates the JSON data with respect to <code>AdBatchUpdate</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AdBatchUpdate</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AdBatchUpdate.RequiredProperties) {
...
AdBatchUpdate.RequiredProperties = ["id"];

/**
 * ID of the ad group that contains the ad.
 * @member {String} ad_group_id
 */
AdBatchUpdate.prototype['ad_group_id'] = undefined;

/**
 * Deep link URL for Android devices.
 * @member {String} android_deep_link
 */
AdBatchUpdate.prototype['android_deep_link'] = undefined;

/**
 * Comma-separated deep links for the carousel pin on Android.
 * @member {Array.<String>} carousel_android_deep_links
 */
AdBatchUpdate.prototype['carousel_android_deep_links'] = undefined;

/**
 * Comma-separated destination URLs for the carousel pin to promote.
 * @member {Array.<String>} carousel_destination_urls
 */
AdBatchUpdate.prototype['carousel_destination_urls'] = undefined;

/**
 * Comma-separated deep links for the carousel pin on iOS.
 * @member {Array.<String>} carousel_ios_deep_links
 */
AdBatchUpdate.prototype['carousel_ios_deep_links'] = undefined;

/**
 * Tracking url for the ad clicks.
 * @member {String} click_tracking_url
 */
AdBatchUpdate.prototype['click_tracking_url'] = undefined;

/**
 * Destination URL template for all items within a collections drawer.
 * @member {String} collection_items_destination_url_template
 */
AdBatchUpdate.prototype['collection_items_destination_url_template'] = undefined;

/**
 * @member {module:model/AdCollectionsHeaderType} collections_header_type
 */
AdBatchUpdate.prototype['collections_header_type'] = undefined;

/**
 * @member {module:model/CreativeType} creative_type
 */
AdBatchUpdate.prototype['creative_type'] = undefined;

/**
 * @member {module:model/CustomizableCTAType} customizable_cta_type
 */
AdBatchUpdate.prototype['customizable_cta_type'] = undefined;

/**
 * Destination URL.
 * @member {String} destination_url
 */
AdBatchUpdate.prototype['destination_url'] = undefined;

/**
 * @member {module:model/DisclosureType} disclosure_type
 */
AdBatchUpdate.prototype['disclosure_type'] = undefined;

/**
 * URL for a page that provides disclosures about a pharmaceutical product, such as potential side effects. Make sure the URL takes the user directly to the disclosure content and the referenced site is secure.
 * @member {String} disclosure_url
 */
AdBatchUpdate.prototype['disclosure_url'] = undefined;

/**
 * @member {module:model/GridClickType} grid_click_type
 */
AdBatchUpdate.prototype['grid_click_type'] = undefined;

/**
 * The ID of this ad.
 * @member {String} id
 */
AdBatchUpdate.prototype['id'] = undefined;

/**
 * Deep link URL for iOS devices.
 * @member {String} ios_deep_link
 */
AdBatchUpdate.prototype['ios_deep_link'] = undefined;

/**
 * Is the ad a carting/WTB ad?
 * @member {Boolean} is_carting
 */
AdBatchUpdate.prototype['is_carting'] = undefined;

/**
 * Whether the advertiser has accepted the terms and conditions for collage ad.
 * @member {Boolean} is_collage_accepted_terms
 */
AdBatchUpdate.prototype['is_collage_accepted_terms'] = undefined;

/**
 * Whether the collage ad has a single destination url override.
 * @member {Boolean} is_collage_single_destination
 */
AdBatchUpdate.prototype['is_collage_single_destination'] = undefined;

/**
 * Is original pin deleted?
 * @member {Boolean} is_pin_deleted
 */
AdBatchUpdate.prototype['is_pin_deleted'] = undefined;

/**
 * Is pin repinnable?
 * @member {Boolean} is_removable
 */
AdBatchUpdate.prototype['is_removable'] = undefined;

/**
 * Lead form ID for lead ad generation.
 * @member {String} lead_form_id
 */
AdBatchUpdate.prototype['lead_form_id'] = undefined;

/**
 * Name of the ad - 255 chars max.
 * @member {String} name
 */
AdBatchUpdate.prototype['name'] = undefined;

/**
 * Pin ID. This field may only be updated for draft ads.
 * @member {String} pin_id
 */
AdBatchUpdate.prototype['pin_id'] = undefined;

/**
 * Before creating a quiz ad, you must create an organic Pin using POST/Create Pin for each result in the quiz. Quiz ads cannot be saved by a Pinner. Quiz ad results can be saved.
 * @member {module:model/QuizPinData} quiz_pin_data
 */
AdBatchUpdate.prototype['quiz_pin_data'] = undefined;

/**
 * @member {module:model/EntityStatus} status
 */
AdBatchUpdate.prototype['status'] = undefined;

/**
 * @member {module:model/TrackingUrls} tracking_urls
 */
AdBatchUpdate.prototype['tracking_urls'] = undefined;

/**
 * Tracking URL for ad impressions.
 * @member {String} view_tracking_url
 */
AdBatchUpdate.prototype['view_tracking_url'] = undefined;
