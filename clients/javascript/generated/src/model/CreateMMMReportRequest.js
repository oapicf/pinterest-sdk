...
class CreateMMMReportRequest {
    ...
    constructor(columns, endDate, granularity, level, reportName, startDate, targetingTypes) { 
        ...
        CreateMMMReportRequest.initialize(this, columns, endDate, granularity, level, reportName, startDate, targetingTypes);
    }
...
CreateMMMReportRequest.RequiredProperties = ["columns", "end_date", "granularity", "level", "report_name", "start_date", "targeting_types"];
