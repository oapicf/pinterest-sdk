...
class CatalogsHotelItemErrorResponse {
     ...
     * @param catalogType {module:model/CatalogsHotelItemErrorResponse.CatalogTypeEnum} 
     * @param errors {Array.<module:model/ItemValidationEvent>} Array with the errors for the item id requested
     * @param itemResponseKind {module:model/CatalogsHotelItemErrorResponse.ItemResponseKindEnum} Discriminator literal identifying this leaf inside an `ItemResponse` payload.
     */
    constructor(catalogType, errors, itemResponseKind) { 
        
        CatalogsHotelItemErrorResponse.initialize(this, catalogType, errors, itemResponseKind);
    }
...
CatalogsHotelItemErrorResponse.RequiredProperties = ["catalog_type", "errors", "item_response_kind"];

/**
 * @member {module:model/CatalogsHotelItemErrorResponse.CatalogTypeEnum} catalog_type
 */
 ...
 * @member {module:model/CatalogsHotelItemErrorResponse.ItemResponseKindEnum} item_response_kind
 */
CatalogsHotelItemErrorResponse.prototype['item_response_kind'] = undefined;
 ...
 * @readonly
 */
CatalogsHotelItemErrorResponse['CatalogTypeEnum'] = {
 ...
 * @readonly
 */
CatalogsHotelItemErrorResponse['ItemResponseKindEnum'] = {
