...
class CatalogsHotelProductGroupCreateRequest {
    ...
    constructor(catalogId, catalogType, filters, name) { 
        ...
        CatalogsHotelProductGroupCreateRequest.initialize(this, catalogId, catalogType, filters, name);
    }
...
CatalogsHotelProductGroupCreateRequest.RequiredProperties = ["catalog_id", "catalog_type", "filters", "name"];
