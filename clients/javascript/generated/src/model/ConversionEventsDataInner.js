...
class ConversionEventsDataInner {
     ...
     * @param actionSource {String} <p>The source indicating where the conversion event occurred.</p> - `app_android` - `app_ios` - `web` - `offline`
    ...
    constructor(actionSource, eventId, eventName, eventTime, userData) { 
        ...
        ConversionEventsDataInner.initialize(this, actionSource, eventId, eventName, eventTime, userData);
    }
...
ConversionEventsDataInner.RequiredProperties = ["action_source", "event_id", "event_name", "event_time", "user_data"];
 ...
 */
ConversionEventsDataInner.prototype['app_info'] = undefined;
 ...
 */
ConversionEventsDataInner.prototype['device_info'] = undefined;
