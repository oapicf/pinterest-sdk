        ...
        if (instance && typeof instance === 'object' && instance['catalog_type'] !== undefined) {
            ...
            switch (discriminatorValue) {
                case 'CREATIVE_ASSETS':
                    try {
                        CatalogsCreativeAssetsItemsBatch.validateJSON(instance);
                        this.actualInstance = CatalogsCreativeAssetsItemsBatch.constructFromObject(instance);
                        return;
                    } catch(err) {
                        throw new Error("Failed to construct CatalogsCreativeAssetsItemsBatch using discriminator value 'CREATIVE_ASSETS': " + err);
                    }
                case 'HOTEL':
                    try {
                        CatalogsHotelItemsBatch.validateJSON(instance);
                        this.actualInstance = CatalogsHotelItemsBatch.constructFromObject(instance);
                        return;
                    } catch(err) {
                        throw new Error("Failed to construct CatalogsHotelItemsBatch using discriminator value 'HOTEL': " + err);
                    }
                case 'RETAIL':
                    try {
                        CatalogsRetailItemsBatch.validateJSON(instance);
                        this.actualInstance = CatalogsRetailItemsBatch.constructFromObject(instance);
                        return;
                    } catch(err) {
                        throw new Error("Failed to construct CatalogsRetailItemsBatch using discriminator value 'RETAIL': " + err);
                    }
                default:
                    throw new Error("Unrecognized discriminator value '" + discriminatorValue + "' constructing `CatalogsItemsBatch`. Expected one of: CREATIVE_ASSETS, HOTEL, RETAIL.");
            }
        }
...
/**
 * @member {module:model/CatalogsItemsBatch.CatalogTypeEnum} catalog_type
 */
