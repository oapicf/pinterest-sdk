...
/**
 * The LeadFormUpdateRequest model module.
 * @module model/LeadFormUpdateRequest
 * @version 1.1.1-pre.0
 */
class LeadFormUpdateRequest {
    /**
     * Constructs a new <code>LeadFormUpdateRequest</code>.
     * @alias module:model/LeadFormUpdateRequest
     * @implements module:model/LeadFormCommon
     * @param id {String} The ID of this lead form to be updated
     */
    constructor(id) { 
        LeadFormCommon.initialize(this);
        LeadFormUpdateRequest.initialize(this, id);
    }
    ...
    /**
     * Constructs a <code>LeadFormUpdateRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LeadFormUpdateRequest} obj Optional instance to populate.
     * @return {module:model/LeadFormUpdateRequest} The populated <code>LeadFormUpdateRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LeadFormUpdateRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>LeadFormUpdateRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LeadFormUpdateRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of LeadFormUpdateRequest.RequiredProperties) {
...
LeadFormUpdateRequest.RequiredProperties = ["id"];

/**
 * Internal name of the lead form.
 * @member {String} name
 */
LeadFormUpdateRequest.prototype['name'] = undefined;

/**
 * A link to the advertiser's privacy policy. This will be included in the lead form's disclosure language.
 * @member {String} privacy_policy_link
 */
LeadFormUpdateRequest.prototype['privacy_policy_link'] = undefined;
 ...
 */
LeadFormUpdateRequest.prototype['has_accepted_terms'] = undefined;

/**
 * A message for people who complete the form to let them know what happens next.
 * @member {String} completion_message
 */
LeadFormUpdateRequest.prototype['completion_message'] = undefined;

/**
 * @member {module:model/LeadFormStatus} status
 */
LeadFormUpdateRequest.prototype['status'] = undefined;

/**
 * Additional disclosure language to be included in the lead form.
 * @member {String} disclosure_language
 */
LeadFormUpdateRequest.prototype['disclosure_language'] = undefined;

/**
 * List of questions to be displayed on the lead form.
 * @member {Array.<module:model/LeadFormQuestion>} questions
 */
LeadFormUpdateRequest.prototype['questions'] = undefined;

/**
 * List of additional policy links to be displayed on the lead form.
 * @member {Array.<module:model/LeadFormCommonPolicyLinksInner>} policy_links
 */
LeadFormUpdateRequest.prototype['policy_links'] = undefined;

/**
 * The ID of this lead form to be updated
 * @member {String} id
 */
LeadFormUpdateRequest.prototype['id'] = undefined;
...
export default LeadFormUpdateRequest;
