...
class CatalogsItemValidationIssues {
     ...
     */
    constructor(errors, itemId, itemNumber, warnings) { 
        
        CatalogsItemValidationIssues.initialize(this, errors, itemId, itemNumber, warnings);
    }
     ...
     */
    static initialize(obj, errors, itemId, itemNumber, warnings) { 
        obj['errors'] = errors;
        obj['item_id'] = itemId;
...
CatalogsItemValidationIssues.RequiredProperties = ["errors", "item_id", "item_number", "warnings"];
