...
/**
 * The ConversionTag model module.
 * @module model/ConversionTag
 * @version 2.0.1-pre.0
 */
class ConversionTag {
    /**
     * Constructs a new <code>ConversionTag</code>.
     * @alias module:model/ConversionTag
     * @implements module:model/ConversionTagCommon
     * @param name {String} Conversion tag name.
     * @param adAccountId {String} Ad account ID.
     */
    constructor(name, adAccountId) { 
        ConversionTagCommon.initialize(this, name);
    ...
    /**
     * Constructs a <code>ConversionTag</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ConversionTag} obj Optional instance to populate.
     * @return {module:model/ConversionTag} The populated <code>ConversionTag</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ConversionTag();
            ConversionTagCommon.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>ConversionTag</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ConversionTag</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ConversionTag.RequiredProperties) {
...
ConversionTag.RequiredProperties = ["name", "ad_account_id"];
...
// Implement ConversionTagCommon interface:
/**
 * Tag code snippet.
 * @member {String} code_snippet
 */
