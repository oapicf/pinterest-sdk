...
class PinUpdate {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('ai_disclosures')) {
                obj['ai_disclosures'] = ApiClient.convertToType(data['ai_disclosures'], AiDisclosuresUpdate);
            }
            ...
            if (data.hasOwnProperty('carousel_slots')) {
                obj['carousel_slots'] = ApiClient.convertToType(data['carousel_slots'], [CarouselSlot]);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['ai_disclosures']) { // data not null
          AiDisclosuresUpdate.validateJSON(data['ai_disclosures']);
        }
        ...
        if (data['carousel_slots']) { // data not null
            ...
            for (const item of data['carousel_slots']) {
                CarouselSlot.validateJSON(item);
            };
        }
        // ensure the json data is a string
 ...
 * @member {module:model/AiDisclosuresUpdate} ai_disclosures
 */
PinUpdate.prototype['ai_disclosures'] = undefined;
 ...
 * @member {Array.<module:model/CarouselSlot>} carousel_slots
 */
