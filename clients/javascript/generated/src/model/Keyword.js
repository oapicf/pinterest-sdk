...
class Keyword {
     ...
     */
    constructor(id, matchType, parentId, value) { 
        
        Keyword.initialize(this, id, matchType, parentId, value);
    }
     ...
     */
    static initialize(obj, id, matchType, parentId, value) { 
        obj['id'] = id;
...
Keyword.RequiredProperties = ["id", "match_type", "parent_id", "value"];
