...
class CatalogsCreativeAssetsFeedsCreateRequest {
     ...
     * @param catalogType {module:model/CatalogsCreativeAssetsFeedsCreateRequest.CatalogTypeEnum} 
    ...
    constructor(catalogType, defaultCountry, defaultLocale, format, location, name) { 
        ...
        CatalogsCreativeAssetsFeedsCreateRequest.initialize(this, catalogType, defaultCountry, defaultLocale, format, location, name);
    }
...
CatalogsCreativeAssetsFeedsCreateRequest.RequiredProperties = ["catalog_type", "default_country", "default_locale", "format", "location", "name"];
...
/**
 * @member {module:model/CatalogsCreativeAssetsFeedsCreateRequest.CatalogTypeEnum} catalog_type
 */
 ...
 * @readonly
 */
CatalogsCreativeAssetsFeedsCreateRequest['CatalogTypeEnum'] = {
