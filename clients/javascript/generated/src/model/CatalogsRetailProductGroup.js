...
class CatalogsRetailProductGroup {
     ...
     * @param feedId {module:model/CatalogsRetailProductGroup.FeedIdEnum} 
     */
    constructor(catalogType, id, filters, feedId) { 
        
        CatalogsRetailProductGroup.initialize(this, catalogType, id, filters, feedId);
    }
     ...
     */
    static initialize(obj, catalogType, id, filters, feedId) { 
...
CatalogsRetailProductGroup.RequiredProperties = ["catalog_type", "id", "filters", "feed_id"];
...
/**
 * @member {module:model/CatalogsRetailProductGroup.FeedIdEnum} feed_id
 */
...
/**
 * Allowed values for the <code>feed_id</code> property.
 * @enum {String}
 * @readonly
 */
CatalogsRetailProductGroup['FeedIdEnum'] = {
