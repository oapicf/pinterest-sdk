...
class CatalogsRetailProductGroup {
     ...
     * @param type {module:model/CatalogsProductGroupType} 
     */
    constructor(catalogId, catalogType, feedId, filters, id, type) { 
        
        CatalogsRetailProductGroup.initialize(this, catalogId, catalogType, feedId, filters, id, type);
    }
     ...
     */
    static initialize(obj, catalogId, catalogType, feedId, filters, id, type) { 
...
CatalogsRetailProductGroup.RequiredProperties = ["catalog_id", "catalog_type", "feed_id", "filters", "id", "type"];
