...
class CatalogsRetailFeed {
     ...
     */
    constructor(createdAt, id, updatedAt, catalogType, credentials, defaultAvailability, defaultCountry, defaultCurrency, defaultLocale, format, location, name, preferredProcessingSchedule, status) { 
        CatalogsDbItem.initialize(this, createdAt, id, updatedAt);
        CatalogsRetailFeed.initialize(this, createdAt, id, updatedAt, catalogType, credentials, defaultAvailability, defaultCountry, defaultCurrency, defaultLocale, format, location, name, preferredProcessingSchedule, status);
    }
     ...
     */
    static initialize(obj, createdAt, id, updatedAt, catalogType, credentials, defaultAvailability, defaultCountry, defaultCurrency, defaultLocale, format, location, name, preferredProcessingSchedule, status) { 
...
CatalogsRetailFeed.RequiredProperties = ["created_at", "id", "updated_at", "catalog_type", "credentials", "default_availability", "default_country", "default_currency", "default_locale", "format", "location", "name", "preferred_processing_schedule", "status"];
