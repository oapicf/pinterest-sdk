...
class CatalogsRetailFeed {
     ...
     */
    constructor(name, format, catalogType, credentials, location, preferredProcessingSchedule, status, defaultCurrency, defaultLocale, defaultCountry, defaultAvailability) { 
        CatalogsDbItem.initialize(this);
        CatalogsRetailFeed.initialize(this, name, format, catalogType, credentials, location, preferredProcessingSchedule, status, defaultCurrency, defaultLocale, defaultCountry, defaultAvailability);
    }
     ...
     */
    static initialize(obj, name, format, catalogType, credentials, location, preferredProcessingSchedule, status, defaultCurrency, defaultLocale, defaultCountry, defaultAvailability) { 
        obj['name'] = name;
        obj['format'] = format;
...
CatalogsRetailFeed.RequiredProperties = ["name", "format", "catalog_type", "credentials", "location", "preferred_processing_schedule", "status", "default_currency", "default_locale", "default_country", "default_availability"];
