...
* @readonly
*/
export default class VideoPinMetricTypes {
    ...
    /**
    * Returns a <code>VideoPinMetricTypes</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/VideoPinMetricTypes} The enum <code>VideoPinMetricTypes</code> value.
    */
