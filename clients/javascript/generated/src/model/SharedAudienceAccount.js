...
class SharedAudienceAccount {
     ...
     * @param accountType {module:model/AudienceAccountType} account type
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('account_type')) {
                obj['account_type'] = ApiClient.convertToType(data['account_type'], AudienceAccountType);
            }
...
/**
 * account type
 * @member {module:model/AudienceAccountType} account_type
 */
