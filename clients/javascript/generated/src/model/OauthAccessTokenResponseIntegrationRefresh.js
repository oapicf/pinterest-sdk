...
class OauthAccessTokenResponseIntegrationRefresh {
     ...
     */
    constructor(refreshToken, refreshTokenExpiresIn, accessToken, expiresIn, scope, tokenType) { 
        
        OauthAccessTokenResponseIntegrationRefresh.initialize(this, refreshToken, refreshTokenExpiresIn, accessToken, expiresIn, scope, tokenType);
    }
     ...
     */
    static initialize(obj, refreshToken, refreshTokenExpiresIn, accessToken, expiresIn, scope, tokenType) { 
...
OauthAccessTokenResponseIntegrationRefresh.RequiredProperties = ["refresh_token", "refresh_token_expires_in", "access_token", "expires_in", "scope", "token_type"];
