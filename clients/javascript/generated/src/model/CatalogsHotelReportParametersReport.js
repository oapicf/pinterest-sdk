    ...
    constructor(instance = null) {
        ...
        if (instance && typeof instance === 'object' && instance['report_type'] !== undefined) {
            ...
            switch (discriminatorValue) {
                ...
                default:
                    throw new Error("Unrecognized discriminator value '" + discriminatorValue + "' constructing `CatalogsHotelReportParametersReport`. Expected one of: DISTRIBUTION_ISSUES, FEED_INGESTION_ISSUES.");
            }
        }
