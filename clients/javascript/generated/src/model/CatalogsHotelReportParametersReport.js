...
class CatalogsHotelReportParametersReport {
     ...
     * @param {(module:model/CatalogsReportAllItemsFilter|module:model/CatalogsReportDistributionIssueFilter|module:model/CatalogsReportFeedIngestionFilter)} instance The actual instance to initialize CatalogsHotelReportParametersReport.
     */
    constructor(instance = null) {
        ...
        try {
            if (typeof instance === "CatalogsReportAllItemsFilter") {
                this.actualInstance = instance;
            } else {
                // plain JS object
                // validate the object
                CatalogsReportAllItemsFilter.validateJSON(instance); // throw an exception if no match
                // create CatalogsReportAllItemsFilter from JS object
                this.actualInstance = CatalogsReportAllItemsFilter.constructFromObject(instance);
            }
            match++;
        } catch(err) {
            // json data failed to deserialize into CatalogsReportAllItemsFilter
            errorMessages.push("Failed to construct CatalogsReportAllItemsFilter: " + err)
        }

        if (match > 1) {
            throw new Error("Multiple matches found constructing `CatalogsHotelReportParametersReport` with oneOf schemas CatalogsReportAllItemsFilter, CatalogsReportDistributionIssueFilter, CatalogsReportFeedIngestionFilter. Input: " + JSON.stringify(instance));
        } else if (match === 0) {
            this.actualInstance = null; // clear the actual instance in case there are multiple matches
            throw new Error("No match found constructing `CatalogsHotelReportParametersReport` with oneOf schemas CatalogsReportAllItemsFilter, CatalogsReportDistributionIssueFilter, CatalogsReportFeedIngestionFilter. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
    ...
    /**
     * Gets the actual instance, which can be <code>CatalogsReportAllItemsFilter</code>, <code>CatalogsReportDistributionIssueFilter</code>, <code>CatalogsReportFeedIngestionFilter</code>.
     * @return {(module:model/CatalogsReportAllItemsFilter|module:model/CatalogsReportDistributionIssueFilter|module:model/CatalogsReportFeedIngestionFilter)} The actual instance.
     */
    getActualInstance() {
    ...
    /**
     * Sets the actual instance, which can be <code>CatalogsReportAllItemsFilter</code>, <code>CatalogsReportDistributionIssueFilter</code>, <code>CatalogsReportFeedIngestionFilter</code>.
     * @param {(module:model/CatalogsReportAllItemsFilter|module:model/CatalogsReportDistributionIssueFilter|module:model/CatalogsReportFeedIngestionFilter)} obj The actual instance.
     */
...
CatalogsHotelReportParametersReport.OneOf = ["CatalogsReportAllItemsFilter", "CatalogsReportDistributionIssueFilter", "CatalogsReportFeedIngestionFilter"];
