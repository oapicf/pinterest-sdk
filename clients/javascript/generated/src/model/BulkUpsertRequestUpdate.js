    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('catalog_product_groups')) {
                obj['catalog_product_groups'] = ApiClient.convertToType(data['catalog_product_groups'], [BulkUpsertRequestUpdateCatalogProductGroupsItems]);
            }
            if (data.hasOwnProperty('keywords')) {
                obj['keywords'] = ApiClient.convertToType(data['keywords'], [KeywordUpdateGenerated]);
            }
            if (data.hasOwnProperty('labels')) {
                obj['labels'] = ApiClient.convertToType(data['labels'], [LabelBulkUpdateRequest]);
            }
            ...
            if (data.hasOwnProperty('schedules')) {
                obj['schedules'] = ApiClient.convertToType(data['schedules'], [ScheduleUpdateRequest]);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['catalog_product_groups']) { // data not null
            ...
            for (const item of data['catalog_product_groups']) {
                BulkUpsertRequestUpdateCatalogProductGroupsItems.validateJSON(item);
            };
        }
        if (data['keywords']) { // data not null
            ...
            for (const item of data['keywords']) {
                KeywordUpdateGenerated.validateJSON(item);
            };
        }
        if (data['labels']) { // data not null
            ...
            for (const item of data['labels']) {
                LabelBulkUpdateRequest.validateJSON(item);
            };
        }
        ...
        if (data['schedules']) { // data not null
            ...
            for (const item of data['schedules']) {
                ScheduleUpdateRequest.validateJSON(item);
            };
        }
...
/**
 * @member {Array.<module:model/BulkUpsertRequestUpdateCatalogProductGroupsItems>} catalog_product_groups
 */
BulkUpsertRequestUpdate.prototype['catalog_product_groups'] = undefined;

/**
 * @member {Array.<module:model/KeywordUpdateGenerated>} keywords
 */
BulkUpsertRequestUpdate.prototype['keywords'] = undefined;

/**
 * @member {Array.<module:model/LabelBulkUpdateRequest>} labels
 */
BulkUpsertRequestUpdate.prototype['labels'] = undefined;
...
/**
 * @member {Array.<module:model/ScheduleUpdateRequest>} schedules
 */
BulkUpsertRequestUpdate.prototype['schedules'] = undefined;
