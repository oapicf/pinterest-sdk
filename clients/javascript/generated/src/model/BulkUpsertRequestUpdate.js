    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('catalog_product_groups')) {
                obj['catalog_product_groups'] = ApiClient.convertToType(data['catalog_product_groups'], [CatalogsProductGroupsUpdateRequest]);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['catalog_product_groups']) { // data not null
            ...
            for (const item of data['catalog_product_groups']) {
                CatalogsProductGroupsUpdateRequest.validateJSON(item);
            };
        }
...
/**
 * @member {Array.<module:model/CatalogsProductGroupsUpdateRequest>} catalog_product_groups
 */
