...
class CatalogsHotelFeed {
     ...
     */
    constructor(createdAt, id, updatedAt, catalogId, catalogType, credentials, defaultCurrency, defaultLocale, format, location, name, preferredProcessingSchedule, status) { 
        CatalogsDbItem.initialize(this, createdAt, id, updatedAt);
        CatalogsHotelFeed.initialize(this, createdAt, id, updatedAt, catalogId, catalogType, credentials, defaultCurrency, defaultLocale, format, location, name, preferredProcessingSchedule, status);
    }
     ...
     */
    static initialize(obj, createdAt, id, updatedAt, catalogId, catalogType, credentials, defaultCurrency, defaultLocale, format, location, name, preferredProcessingSchedule, status) { 
...
CatalogsHotelFeed.RequiredProperties = ["created_at", "id", "updated_at", "catalog_id", "catalog_type", "credentials", "default_currency", "default_locale", "format", "location", "name", "preferred_processing_schedule", "status"];
