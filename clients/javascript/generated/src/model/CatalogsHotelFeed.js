...
class CatalogsHotelFeed {
     ...
     */
    constructor(createdAt, id, updatedAt, name, format, catalogType, credentials, location, preferredProcessingSchedule, status, defaultCurrency, defaultLocale, catalogId) { 
        CatalogsDbItem.initialize(this, createdAt, id, updatedAt);
        CatalogsHotelFeed.initialize(this, createdAt, id, updatedAt, name, format, catalogType, credentials, location, preferredProcessingSchedule, status, defaultCurrency, defaultLocale, catalogId);
    }
     ...
     */
    static initialize(obj, createdAt, id, updatedAt, name, format, catalogType, credentials, location, preferredProcessingSchedule, status, defaultCurrency, defaultLocale, catalogId) { 
...
CatalogsHotelFeed.RequiredProperties = ["created_at", "id", "updated_at", "name", "format", "catalog_type", "credentials", "location", "preferred_processing_schedule", "status", "default_currency", "default_locale", "catalog_id"];
