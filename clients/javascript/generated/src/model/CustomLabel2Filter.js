...
class CustomLabel2Filter {
     ...
     * @param cUSTOMLABEL2 {module:model/CatalogsProductGroupFilterOperatorTypeCriteria} 
     */
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('CUSTOM_LABEL_2')) {
                obj['CUSTOM_LABEL_2'] = CatalogsProductGroupFilterOperatorTypeCriteria.constructFromObject(data['CUSTOM_LABEL_2']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        // validate the optional field `CUSTOM_LABEL_2`
        if (data['CUSTOM_LABEL_2']) { // data not null
          CatalogsProductGroupFilterOperatorTypeCriteria.validateJSON(data['CUSTOM_LABEL_2']);
        }
...
/**
 * @member {module:model/CatalogsProductGroupFilterOperatorTypeCriteria} CUSTOM_LABEL_2
 */
