...
class OauthAccessTokenResponseClientCredentials {
    ...
    constructor(accessToken, expiresIn, scope, tokenType) { 
        ...
        OauthAccessTokenResponseClientCredentials.initialize(this, accessToken, expiresIn, scope, tokenType);
    }
...
OauthAccessTokenResponseClientCredentials.RequiredProperties = ["access_token", "expires_in", "scope", "token_type"];
