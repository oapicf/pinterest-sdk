...
/**
 * The PinsSaveRequest model module.
 * @module model/PinsSaveRequest
 * @version 1.1.1-pre.0
 */
class PinsSaveRequest {
    /**
     * Constructs a new <code>PinsSaveRequest</code>.
     * @alias module:model/PinsSaveRequest
     */
    constructor() { 
        
        PinsSaveRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PinsSaveRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PinsSaveRequest} obj Optional instance to populate.
     * @return {module:model/PinsSaveRequest} The populated <code>PinsSaveRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PinsSaveRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>PinsSaveRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PinsSaveRequest</code>.
     */
...
export default PinsSaveRequest;
