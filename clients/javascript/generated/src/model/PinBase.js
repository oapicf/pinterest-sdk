...
/**
 * The PinBase model module.
 * @module model/PinBase
 * @version 2.0.1-pre.0
 */
class PinBase {
    /**
     * Constructs a new <code>PinBase</code>.
     * @alias module:model/PinBase
     * @param id {String} 
     */
    constructor(id) { 
    ...
    /**
     * Constructs a <code>PinBase</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PinBase} obj Optional instance to populate.
     * @return {module:model/PinBase} The populated <code>PinBase</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>PinBase</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PinBase</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PinBase.RequiredProperties) {
