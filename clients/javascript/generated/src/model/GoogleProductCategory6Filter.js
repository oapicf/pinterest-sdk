...
class GoogleProductCategory6Filter {
    ...
    static validateJSON(data) {
        ...
        // validate the optional field `GOOGLE_PRODUCT_CATEGORY_6`
        if (data['GOOGLE_PRODUCT_CATEGORY_6']) { // data not null
          CatalogsProductGroupMultipleStringListCriteria.validateJSON(data['GOOGLE_PRODUCT_CATEGORY_6']);
        }
