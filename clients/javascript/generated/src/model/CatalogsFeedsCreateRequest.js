...
class CatalogsFeedsCreateRequest {
     ...
     */
    constructor(format, location, name) { 
        
        CatalogsFeedsCreateRequest.initialize(this, format, location, name);
    }
     ...
     */
    static initialize(obj, format, location, name) { 
        obj['format'] = format;
...
CatalogsFeedsCreateRequest.RequiredProperties = ["format", "location", "name"];
