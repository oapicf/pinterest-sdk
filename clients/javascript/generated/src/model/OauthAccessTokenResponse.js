...
class OauthAccessTokenResponse {
    ...
    constructor(accessToken, expiresIn, scope, tokenType) { 
        ...
        OauthAccessTokenResponse.initialize(this, accessToken, expiresIn, scope, tokenType);
    }
...
OauthAccessTokenResponse.RequiredProperties = ["access_token", "expires_in", "scope", "token_type"];
