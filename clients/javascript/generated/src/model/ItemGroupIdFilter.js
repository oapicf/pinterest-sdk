...
class ItemGroupIdFilter {
    ...
    static validateJSON(data) {
        ...
        // validate the optional field `ITEM_GROUP_ID`
        if (data['ITEM_GROUP_ID']) { // data not null
          CatalogsProductGroupMultipleStringCriteria.validateJSON(data['ITEM_GROUP_ID']);
        }
