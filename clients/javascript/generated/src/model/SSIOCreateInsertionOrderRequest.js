...
class SSIOCreateInsertionOrderRequest {
     ...
     */
    constructor(billingContactEmail, billingContactFirstname, billingContactLastname, mediaContactEmail, mediaContactFirstname, mediaContactLastname, poNumber, startDate, acceptedTermsId, billtoBillingAddressId, billtoBusinessAddressId, billtoCompanyId, currencyInfo, orderLineType, orderName, pmpId) { 
        SSIOInsertionOrderCommon.initialize(this);
        SSIOCreateInsertionOrderRequest.initialize(this, billingContactEmail, billingContactFirstname, billingContactLastname, mediaContactEmail, mediaContactFirstname, mediaContactLastname, poNumber, startDate, acceptedTermsId, billtoBillingAddressId, billtoBusinessAddressId, billtoCompanyId, currencyInfo, orderLineType, orderName, pmpId);
    }
     ...
     */
    static initialize(obj, billingContactEmail, billingContactFirstname, billingContactLastname, mediaContactEmail, mediaContactFirstname, mediaContactLastname, poNumber, startDate, acceptedTermsId, billtoBillingAddressId, billtoBusinessAddressId, billtoCompanyId, currencyInfo, orderLineType, orderName, pmpId) { 
