...
class ItemResponseAnyOf {
     ...
     * @param {(module:model/CatalogsHotelItemResponse|module:model/CatalogsRetailItemResponse)} instance The actual instance to initialize ItemResponseAnyOf.
     */
    constructor(instance = null) {
        ...
        if (match > 1) {
            throw new Error("Multiple matches found constructing `ItemResponseAnyOf` with oneOf schemas CatalogsHotelItemResponse, CatalogsRetailItemResponse. Input: " + JSON.stringify(instance));
        } else if (match === 0) {
            this.actualInstance = null; // clear the actual instance in case there are multiple matches
            throw new Error("No match found constructing `ItemResponseAnyOf` with oneOf schemas CatalogsHotelItemResponse, CatalogsRetailItemResponse. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
    ...
    /**
     * Gets the actual instance, which can be <code>CatalogsHotelItemResponse</code>, <code>CatalogsRetailItemResponse</code>.
     * @return {(module:model/CatalogsHotelItemResponse|module:model/CatalogsRetailItemResponse)} The actual instance.
     */
    getActualInstance() {
    ...
    /**
     * Sets the actual instance, which can be <code>CatalogsHotelItemResponse</code>, <code>CatalogsRetailItemResponse</code>.
     * @param {(module:model/CatalogsHotelItemResponse|module:model/CatalogsRetailItemResponse)} obj The actual instance.
     */
...
ItemResponseAnyOf.OneOf = ["CatalogsHotelItemResponse", "CatalogsRetailItemResponse"];
