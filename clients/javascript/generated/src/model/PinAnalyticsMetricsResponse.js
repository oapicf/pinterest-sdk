    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('daily_metrics')) {
                obj['daily_metrics'] = ApiClient.convertToType(data['daily_metrics'], [PinAnalyticsDailyMetrics]);
            }
    ...
    static validateJSON(data) {
        if (data['daily_metrics']) { // data not null
            ...
            for (const item of data['daily_metrics']) {
                PinAnalyticsDailyMetrics.validateJSON(item);
            };
        }
 ...
 * @member {Array.<module:model/PinAnalyticsDailyMetrics>} daily_metrics
 */
