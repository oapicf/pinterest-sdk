...
class TemplatesList200Response {
     ...
     * @param items {Array.<module:model/AccountTemplate>} 
     */
    constructor(items) { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('items')) {
                obj['items'] = ApiClient.convertToType(data['items'], [AccountTemplate]);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['items']) { // data not null
            ...
            for (const item of data['items']) {
                AccountTemplate.validateJSON(item);
            };
        }
...
/**
 * @member {Array.<module:model/AccountTemplate>} items
 */
