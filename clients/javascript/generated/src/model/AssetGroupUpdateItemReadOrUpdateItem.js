...
/**
 * The AssetGroupUpdateItemReadOrUpdateItem model module.
 * @module model/AssetGroupUpdateItemReadOrUpdateItem
 * @version 2.0.1-pre.0
 */
class AssetGroupUpdateItemReadOrUpdateItem {
    /**
     * Constructs a new <code>AssetGroupUpdateItemReadOrUpdateItem</code>.
     * @alias module:model/AssetGroupUpdateItemReadOrUpdateItem
     * @param assetGroupId {String} Unique identifier of the asset group to update.
     */
    constructor(assetGroupId) { 
        
        AssetGroupUpdateItemReadOrUpdateItem.initialize(this, assetGroupId);
    }
    ...
    /**
     * Constructs a <code>AssetGroupUpdateItemReadOrUpdateItem</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AssetGroupUpdateItemReadOrUpdateItem} obj Optional instance to populate.
     * @return {module:model/AssetGroupUpdateItemReadOrUpdateItem} The populated <code>AssetGroupUpdateItemReadOrUpdateItem</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AssetGroupUpdateItemReadOrUpdateItem();
    ...
    /**
     * Validates the JSON data with respect to <code>AssetGroupUpdateItemReadOrUpdateItem</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AssetGroupUpdateItemReadOrUpdateItem</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AssetGroupUpdateItemReadOrUpdateItem.RequiredProperties) {
...
AssetGroupUpdateItemReadOrUpdateItem.RequiredProperties = ["asset_group_id"];

/**
 * Unique identifier of the asset group to update.
 * @member {String} asset_group_id
 */
AssetGroupUpdateItemReadOrUpdateItem.prototype['asset_group_id'] = undefined;

/**
 * Asset Group Types. Note: The asset group types are used for user reference and categorization purposes only and do not impact the functionality of the asset group.
 * @member {Array.<module:model/AssetGroupType>} asset_group_types
 */
AssetGroupUpdateItemReadOrUpdateItem.prototype['asset_group_types'] = undefined;

/**
 * A list of asset ids to add to the asset group.
 * @member {Array.<String>} assets_to_add
 */
AssetGroupUpdateItemReadOrUpdateItem.prototype['assets_to_add'] = undefined;

/**
 * A list of asset ids to remove from the asset group.
 * @member {Array.<String>} assets_to_remove
 */
AssetGroupUpdateItemReadOrUpdateItem.prototype['assets_to_remove'] = undefined;

/**
 * Asset group description.
 * @member {String} description
 */
AssetGroupUpdateItemReadOrUpdateItem.prototype['description'] = undefined;

/**
 * Asset Group name.
 * @member {String} name
 */
AssetGroupUpdateItemReadOrUpdateItem.prototype['name'] = undefined;
...
export default AssetGroupUpdateItemReadOrUpdateItem;
