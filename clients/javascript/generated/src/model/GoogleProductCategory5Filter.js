...
class GoogleProductCategory5Filter {
    ...
    static validateJSON(data) {
        ...
        // validate the optional field `GOOGLE_PRODUCT_CATEGORY_5`
        if (data['GOOGLE_PRODUCT_CATEGORY_5']) { // data not null
          CatalogsProductGroupMultipleStringListCriteria.validateJSON(data['GOOGLE_PRODUCT_CATEGORY_5']);
        }
