...
class Catalog {
     ...
     */
    constructor(createdAt, id, updatedAt, catalogType, name) { 
        CatalogsDbItem.initialize(this, createdAt, id, updatedAt);
        Catalog.initialize(this, createdAt, id, updatedAt, catalogType, name);
    }
     ...
     */
    static initialize(obj, createdAt, id, updatedAt, catalogType, name) { 
...
Catalog.RequiredProperties = ["created_at", "id", "updated_at", "catalog_type", "name"];
