...
class Catalog {
     ...
     */
    constructor(catalogType, createdAt, id, name, updatedAt) { 
        
        Catalog.initialize(this, catalogType, createdAt, id, name, updatedAt);
    }
     ...
     */
    static initialize(obj, catalogType, createdAt, id, name, updatedAt) { 
...
Catalog.RequiredProperties = ["catalog_type", "created_at", "id", "name", "updated_at"];
