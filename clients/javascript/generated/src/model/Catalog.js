...
class Catalog {
     ...
     */
    constructor(createdAt, id, updatedAt, name, catalogType) { 
        CatalogsDbItem.initialize(this, createdAt, id, updatedAt);
        Catalog.initialize(this, createdAt, id, updatedAt, name, catalogType);
    }
     ...
     */
    static initialize(obj, createdAt, id, updatedAt, name, catalogType) { 
...
Catalog.RequiredProperties = ["created_at", "id", "updated_at", "name", "catalog_type"];
