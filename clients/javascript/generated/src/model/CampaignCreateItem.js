...
/**
 * The CampaignCreateItem model module.
 * @module model/CampaignCreateItem
 * @version 2.0.1-pre.0
 */
class CampaignCreateItem {
    /**
     * Constructs a new <code>CampaignCreateItem</code>.
     * Single campaign create item with create-specific defaults.
     * @alias module:model/CampaignCreateItem
     * @param name {String} Campaign name - 255 chars max.
     * @param objectiveType {module:model/ConversionObjectiveType} 
     */
    constructor(name, objectiveType) { 
        
        CampaignCreateItem.initialize(this, name, objectiveType);
    }
     ...
     */
    static initialize(obj, name, objectiveType) { 
        obj['is_automated_campaign'] = false;
        obj['is_campaign_budget_optimization'] = true;
        obj['is_flexible_daily_budgets'] = false;
    ...
    /**
     * Constructs a <code>CampaignCreateItem</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CampaignCreateItem} obj Optional instance to populate.
     * @return {module:model/CampaignCreateItem} The populated <code>CampaignCreateItem</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CampaignCreateItem();
    ...
    /**
     * Validates the JSON data with respect to <code>CampaignCreateItem</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CampaignCreateItem</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CampaignCreateItem.RequiredProperties) {
...
CampaignCreateItem.RequiredProperties = ["name", "objective_type"];

/**
 * Setting this field does nothing. The ad account ID gets set from the path parameter.
 * @member {String} ad_account_id
 */
CampaignCreateItem.prototype['ad_account_id'] = undefined;
 ...
 */
CampaignCreateItem.prototype['app_id'] = undefined;
 ...
 */
CampaignCreateItem.prototype['app_platform'] = undefined;
 ...
 */
CampaignCreateItem.prototype['bid_options'] = undefined;
 ...
 */
CampaignCreateItem.prototype['daily_spend_cap'] = undefined;

/**
 * Setting this field does nothing.
 * @member {Number} default_ad_group_budget_in_micro_currency
 */
CampaignCreateItem.prototype['default_ad_group_budget_in_micro_currency'] = undefined;
 ...
 */
CampaignCreateItem.prototype['end_time'] = undefined;

/**
 * @member {module:model/IntendedPromotionType} intended_promotion_type
 */
CampaignCreateItem.prototype['intended_promotion_type'] = undefined;
 ...
 * @default false
 */
CampaignCreateItem.prototype['is_automated_campaign'] = false;
 ...
 * @default true
 */
CampaignCreateItem.prototype['is_campaign_budget_optimization'] = true;
 ...
 * @default false
 */
CampaignCreateItem.prototype['is_flexible_daily_budgets'] = false;

/**
 * Specifies whether the campaign is optimized for Lifetime Value (LTV). Only available for eligible advertisers.
 * @member {Boolean} is_ltv_optimized
 */
CampaignCreateItem.prototype['is_ltv_optimized'] = undefined;
 ...
 * @default false
 */
CampaignCreateItem.prototype['is_performance_plus'] = false;
 ...
 * @default false
 */
CampaignCreateItem.prototype['is_top_of_search'] = false;

/**
 * Note: The default for this field is null, which is treated the same as 0. For campaign budget optimization, a daily or lifetime spend cap must be set, but not both. For ad group level budgets, this field must be 0 or unset.
 * @member {Number} lifetime_spend_cap
 */
CampaignCreateItem.prototype['lifetime_spend_cap'] = undefined;

/**
 * Campaign name - 255 chars max.
 * @member {String} name
 */
CampaignCreateItem.prototype['name'] = undefined;

/**
 * @member {module:model/ConversionObjectiveType} objective_type
 */
CampaignCreateItem.prototype['objective_type'] = undefined;
 ...
 */
CampaignCreateItem.prototype['order_line_id'] = undefined;
 ...
 */
CampaignCreateItem.prototype['start_time'] = undefined;

/**
 * @member {module:model/EntityStatus} status
 */
CampaignCreateItem.prototype['status'] = undefined;

/**
 * @member {module:model/TrackingUrls} tracking_urls
 */
CampaignCreateItem.prototype['tracking_urls'] = undefined;
...
export default CampaignCreateItem;
