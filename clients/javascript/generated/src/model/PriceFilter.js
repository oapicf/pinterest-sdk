...
class PriceFilter {
     ...
     * @param PRICE {module:model/PriceFilterPrice} 
     */
    constructor(PRICE) { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('PRICE')) {
                obj['PRICE'] = PriceFilterPrice.constructFromObject(data['PRICE']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['PRICE']) { // data not null
          PriceFilterPrice.validateJSON(data['PRICE']);
        }
...
/**
 * @member {module:model/PriceFilterPrice} PRICE
 */
