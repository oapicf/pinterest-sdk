...
/**
 * The AdAccountsAudienceRule model module.
 * @module model/AdAccountsAudienceRule
 * @version 2.0.1-pre.0
 */
class AdAccountsAudienceRule {
    /**
     * Constructs a new <code>AdAccountsAudienceRule</code>.
     ...
     * @alias module:model/AdAccountsAudienceRule
     */
    constructor() { 
        
        AdAccountsAudienceRule.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AdAccountsAudienceRule</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AdAccountsAudienceRule} obj Optional instance to populate.
     * @return {module:model/AdAccountsAudienceRule} The populated <code>AdAccountsAudienceRule</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AdAccountsAudienceRule();
            ...
            if (data.hasOwnProperty('event_data')) {
                obj['event_data'] = EventData.constructFromObject(data['event_data']);
            }
            ...
            if (data.hasOwnProperty('objective_type')) {
                obj['objective_type'] = ApiClient.convertToType(data['objective_type'], [AudienceObjectiveType]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>AdAccountsAudienceRule</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AdAccountsAudienceRule</code>.
     */
    static validateJSON(data) {
        ...
        if (data['event_data']) { // data not null
          EventData.validateJSON(data['event_data']);
        }
        // ensure the json data is an array
 ...
 */
AdAccountsAudienceRule.prototype['ad_account_id'] = undefined;

/**
 * Ad ID for engagement audience filter.
 * @member {Array.<String>} ad_id
 */
AdAccountsAudienceRule.prototype['ad_id'] = undefined;

/**
 * Campaign ID for engagement audience filter.
 * @member {Array.<String>} campaign_id
 */
AdAccountsAudienceRule.prototype['campaign_id'] = undefined;

/**
 * Valid countries include: \"US\", \"CA\", and \"GB\".
 * @member {String} country
 */
AdAccountsAudienceRule.prototype['country'] = undefined;

/**
 * Customer list ID. For CUSTOMER_LIST `audience_type`.
 * @member {String} customer_list_id
 */
AdAccountsAudienceRule.prototype['customer_list_id'] = undefined;

/**
 * The audience account's verified domain. **Required** for ENGAGEMENT `audience_type`.
 * @member {Array.<String>} engagement_domain
 */
AdAccountsAudienceRule.prototype['engagement_domain'] = undefined;

/**
 * Engagement type enum. Optional for ENGAGEMENT `audience_type`. Supported values are `click`, `save`, `closeup`, `comment` and `like`. All engagements are included if this field is not set.
 * @member {String} engagement_type
 */
AdAccountsAudienceRule.prototype['engagement_type'] = undefined;

/**
 * Optional for ENGAGEMENT. Engager type value should be 1-2.
 * @member {Number} engager_type
 */
AdAccountsAudienceRule.prototype['engager_type'] = undefined;

/**
 * A Pinterest tag event. Optional for VISITOR `audience_type`. Possible values are `pagevisit`, `signup`, `checkout`, `viewcategory`, `search`, `addtocart`, `watchvideo`, `lead`, and `custom`. This field also accepts a partner-defined Pinterest tag event.
 * @member {String} event
 */
AdAccountsAudienceRule.prototype['event'] = undefined;

/**
 * @member {module:model/EventData} event_data
 */
AdAccountsAudienceRule.prototype['event_data'] = undefined;

/**
 * Optional for VISITOR. You can use it as a {'=': [value]}. Supported values are: web, mobile, offline
 * @member {Object} event_source
 */
AdAccountsAudienceRule.prototype['event_source'] = undefined;

/**
 * Optional for VISITOR. You can use it as a {'=': [value]}. Supported values are: tag, mmp, file_upload, conversions_api
 * @member {Object} ingestion_source
 */
AdAccountsAudienceRule.prototype['ingestion_source'] = undefined;

/**
 * Objective for engagement audience filter.
 * @member {Array.<module:model/AudienceObjectiveType>} objective_type
 */
AdAccountsAudienceRule.prototype['objective_type'] = undefined;

/**
 * Percentage should be 1-10. The targeted audience should be this % size across Pinterest.
 * @member {Number} percentage
 */
AdAccountsAudienceRule.prototype['percentage'] = undefined;

/**
 * IDs of engaged organic pins. Optional for ENGAGEMENT `audience_type`. For example, \"pin_id:\": [\"34567\"]
 * @member {Array.<String>} pin_id
 */
AdAccountsAudienceRule.prototype['pin_id'] = undefined;

/**
 * Optional for VISITOR `audience_type`. If `true`, the specified rule on existing engagement data is applied to pre-populate the audience. If `false`, the audience is empty at creation time. The default is `true`.
 * @member {Boolean} prefill
 */
AdAccountsAudienceRule.prototype['prefill'] = undefined;

/**
 * Number of days a Pinterest user remains in the audience. Optional for ENGAGEMENT and VISITOR `audience_type`. Accepted range is 1-540. Defaults to 180 if not specified.
 * @member {Number} retention_days
 */
AdAccountsAudienceRule.prototype['retention_days'] = undefined;

/**
 * Audience ID(s). For ACTALIKE `audience_type`.
 * @member {Array.<String>} seed_id
 */
AdAccountsAudienceRule.prototype['seed_id'] = undefined;
 ...
 */
AdAccountsAudienceRule.prototype['url'] = undefined;

/**
 * The conversion tag ID, or the Pinterest tag ID, that you use on your website. For VISITOR `audience_type`.
 * @member {String} visitor_source_id
 */
AdAccountsAudienceRule.prototype['visitor_source_id'] = undefined;
...
export default AdAccountsAudienceRule;
