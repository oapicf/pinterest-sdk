...
class UpdatePartnerAssetAccessBody {
     ...
     * @param accesses {Array.<module:model/UpdatePartnerAssetAccessItem>} List of partner asset accesses to assign or update.
     */
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('accesses')) {
                obj['accesses'] = ApiClient.convertToType(data['accesses'], [UpdatePartnerAssetAccessItem]);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['accesses']) { // data not null
            ...
            for (const item of data['accesses']) {
                UpdatePartnerAssetAccessItem.validateJSON(item);
            };
        }
 ...
 * @member {Array.<module:model/UpdatePartnerAssetAccessItem>} accesses
 */
