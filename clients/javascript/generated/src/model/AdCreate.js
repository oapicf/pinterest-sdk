...
/**
 * The AdCreate model module.
 * @module model/AdCreate
 * @version 2.0.1-pre.0
 */
class AdCreate {
    /**
     * Constructs a new <code>AdCreate</code>.
     * Resource create operation model.
     * @alias module:model/AdCreate
    ...
    constructor(adGroupId, creativeType, pinId) { 
        ...
        AdCreate.initialize(this, adGroupId, creativeType, pinId);
    }
    ...
    /**
     * Constructs a <code>AdCreate</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AdCreate} obj Optional instance to populate.
     * @return {module:model/AdCreate} The populated <code>AdCreate</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AdCreate();
    ...
    /**
     * Validates the JSON data with respect to <code>AdCreate</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AdCreate</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AdCreate.RequiredProperties) {
