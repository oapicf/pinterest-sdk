    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('catalog_product_groups')) {
                obj['catalog_product_groups'] = ApiClient.convertToType(data['catalog_product_groups'], [MultipleProductGroupsInner]);
            }
            if (data.hasOwnProperty('keywords')) {
                obj['keywords'] = ApiClient.convertToType(data['keywords'], [KeywordsRequest]);
            }
            if (data.hasOwnProperty('labels')) {
                obj['labels'] = ApiClient.convertToType(data['labels'], [LabelCreateRequest]);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['catalog_product_groups']) { // data not null
            ...
            for (const item of data['catalog_product_groups']) {
                MultipleProductGroupsInner.validateJSON(item);
            };
        }
        ...
        if (data['labels']) { // data not null
            ...
            for (const item of data['labels']) {
                LabelCreateRequest.validateJSON(item);
            };
        }
...
/**
 * @member {Array.<module:model/MultipleProductGroupsInner>} catalog_product_groups
 */
...
/**
 * @member {Array.<module:model/LabelCreateRequest>} labels
 */
