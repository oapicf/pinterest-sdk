...
class CatalogsVerticalFeedsUpdateRequest {
     ...
     * @param {(module:model/CatalogsHotelFeedsUpdateRequest|module:model/CatalogsRetailFeedsUpdateRequest)} instance The actual instance to initialize CatalogsVerticalFeedsUpdateRequest.
     */
    constructor(instance = null) {
        ...
        if (match > 1) {
            throw new Error("Multiple matches found constructing `CatalogsVerticalFeedsUpdateRequest` with oneOf schemas CatalogsHotelFeedsUpdateRequest, CatalogsRetailFeedsUpdateRequest. Input: " + JSON.stringify(instance));
        } else if (match === 0) {
            this.actualInstance = null; // clear the actual instance in case there are multiple matches
            throw new Error("No match found constructing `CatalogsVerticalFeedsUpdateRequest` with oneOf schemas CatalogsHotelFeedsUpdateRequest, CatalogsRetailFeedsUpdateRequest. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
    ...
    /**
     * Gets the actual instance, which can be <code>CatalogsHotelFeedsUpdateRequest</code>, <code>CatalogsRetailFeedsUpdateRequest</code>.
     * @return {(module:model/CatalogsHotelFeedsUpdateRequest|module:model/CatalogsRetailFeedsUpdateRequest)} The actual instance.
     */
    getActualInstance() {
    ...
    /**
     * Sets the actual instance, which can be <code>CatalogsHotelFeedsUpdateRequest</code>, <code>CatalogsRetailFeedsUpdateRequest</code>.
     * @param {(module:model/CatalogsHotelFeedsUpdateRequest|module:model/CatalogsRetailFeedsUpdateRequest)} obj The actual instance.
     */
...
CatalogsVerticalFeedsUpdateRequest.OneOf = ["CatalogsHotelFeedsUpdateRequest", "CatalogsRetailFeedsUpdateRequest"];
