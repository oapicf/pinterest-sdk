        ...
        if (instance && typeof instance === 'object' && instance['catalog_type'] !== undefined) {
            ...
            switch (discriminatorValue) {
                case 'CREATIVE_ASSETS':
                    try {
                        CatalogsCreativeAssetsBatchRequest.validateJSON(instance);
                        this.actualInstance = CatalogsCreativeAssetsBatchRequest.constructFromObject(instance);
                        return;
                    } catch(err) {
                        throw new Error("Failed to construct CatalogsCreativeAssetsBatchRequest using discriminator value 'CREATIVE_ASSETS': " + err);
                    }
                case 'HOTEL':
                    try {
                        CatalogsHotelBatchRequest.validateJSON(instance);
                        this.actualInstance = CatalogsHotelBatchRequest.constructFromObject(instance);
                        return;
                    } catch(err) {
                        throw new Error("Failed to construct CatalogsHotelBatchRequest using discriminator value 'HOTEL': " + err);
                    }
                case 'RETAIL':
                    try {
                        CatalogsRetailBatchRequest.validateJSON(instance);
                        this.actualInstance = CatalogsRetailBatchRequest.constructFromObject(instance);
                        return;
                    } catch(err) {
                        throw new Error("Failed to construct CatalogsRetailBatchRequest using discriminator value 'RETAIL': " + err);
                    }
                default:
                    throw new Error("Unrecognized discriminator value '" + discriminatorValue + "' constructing `CatalogsVerticalBatchRequest`. Expected one of: CREATIVE_ASSETS, HOTEL, RETAIL.");
            }
        }
