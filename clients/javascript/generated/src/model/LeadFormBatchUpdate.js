...
/**
 * The LeadFormBatchUpdate model module.
 * @module model/LeadFormBatchUpdate
 * @version 2.0.1-pre.0
 */
class LeadFormBatchUpdate {
    /**
     * Constructs a new <code>LeadFormBatchUpdate</code>.
     * @alias module:model/LeadFormBatchUpdate
     * @param id {String} The ID of this lead form
     */
    constructor(id) { 
        
        LeadFormBatchUpdate.initialize(this, id);
    }
    ...
    /**
     * Constructs a <code>LeadFormBatchUpdate</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LeadFormBatchUpdate} obj Optional instance to populate.
     * @return {module:model/LeadFormBatchUpdate} The populated <code>LeadFormBatchUpdate</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LeadFormBatchUpdate();
    ...
    /**
     * Validates the JSON data with respect to <code>LeadFormBatchUpdate</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LeadFormBatchUpdate</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of LeadFormBatchUpdate.RequiredProperties) {
...
LeadFormBatchUpdate.RequiredProperties = ["id"];

/**
 * A message for people who complete the form to let them know what happens next.
 * @member {String} completion_message
 */
LeadFormBatchUpdate.prototype['completion_message'] = undefined;

/**
 * Additional disclosure language to be included in the lead form.
 * @member {String} disclosure_language
 */
LeadFormBatchUpdate.prototype['disclosure_language'] = undefined;
 ...
 */
LeadFormBatchUpdate.prototype['has_accepted_terms'] = undefined;

/**
 * The ID of this lead form
 * @member {String} id
 */
LeadFormBatchUpdate.prototype['id'] = undefined;

/**
 * Internal name of the lead form.
 * @member {String} name
 */
LeadFormBatchUpdate.prototype['name'] = undefined;

/**
 * List of additional policy links to be displayed on the lead form.
 * @member {Array.<module:model/LeadFormPolicyLink>} policy_links
 */
LeadFormBatchUpdate.prototype['policy_links'] = undefined;

/**
 * A link to the advertiser's privacy policy. This will be included in the lead form's disclosure language.
 * @member {String} privacy_policy_link
 */
LeadFormBatchUpdate.prototype['privacy_policy_link'] = undefined;

/**
 * List of questions to be displayed on the lead form.
 * @member {Array.<module:model/LeadFormQuestion>} questions
 */
LeadFormBatchUpdate.prototype['questions'] = undefined;

/**
 * @member {module:model/LeadFormStatus} status
 */
LeadFormBatchUpdate.prototype['status'] = undefined;
...
export default LeadFormBatchUpdate;
