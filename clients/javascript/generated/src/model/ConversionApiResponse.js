...
class ConversionApiResponse {
    ...
    constructor(events, numEventsProcessed, numEventsReceived) { 
        ...
        ConversionApiResponse.initialize(this, events, numEventsProcessed, numEventsReceived);
    }
...
ConversionApiResponse.RequiredProperties = ["events", "num_events_processed", "num_events_received"];
