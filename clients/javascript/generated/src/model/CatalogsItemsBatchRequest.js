    ...
    constructor(instance = null) {
        ...
        if (instance && typeof instance === 'object' && instance['operation'] !== undefined) {
            ...
            switch (discriminatorValue) {
                case 'CREATE':
                    try {
                        CatalogsItemsCreateBatchRequest.validateJSON(instance);
                        this.actualInstance = CatalogsItemsCreateBatchRequest.constructFromObject(instance);
                        return;
                    } catch(err) {
                        throw new Error("Failed to construct CatalogsItemsCreateBatchRequest using discriminator value 'CREATE': " + err);
                    }
                case 'DELETE':
                    try {
                        CatalogsItemsDeleteBatchRequest.validateJSON(instance);
                        this.actualInstance = CatalogsItemsDeleteBatchRequest.constructFromObject(instance);
                        return;
                    } catch(err) {
                        throw new Error("Failed to construct CatalogsItemsDeleteBatchRequest using discriminator value 'DELETE': " + err);
                    }
                case 'DELETE_DISCONTINUED':
                    try {
                        CatalogsItemsDeleteDiscontinuedBatchRequest.validateJSON(instance);
                        this.actualInstance = CatalogsItemsDeleteDiscontinuedBatchRequest.constructFromObject(instance);
                        return;
                    } catch(err) {
                        throw new Error("Failed to construct CatalogsItemsDeleteDiscontinuedBatchRequest using discriminator value 'DELETE_DISCONTINUED': " + err);
                    }
                case 'UPDATE':
                    try {
                        CatalogsItemsUpdateBatchRequest.validateJSON(instance);
                        this.actualInstance = CatalogsItemsUpdateBatchRequest.constructFromObject(instance);
                        return;
                    } catch(err) {
                        throw new Error("Failed to construct CatalogsItemsUpdateBatchRequest using discriminator value 'UPDATE': " + err);
                    }
                case 'UPSERT':
                    try {
                        CatalogsItemsUpsertBatchRequest.validateJSON(instance);
                        this.actualInstance = CatalogsItemsUpsertBatchRequest.constructFromObject(instance);
                        return;
                    } catch(err) {
                        throw new Error("Failed to construct CatalogsItemsUpsertBatchRequest using discriminator value 'UPSERT': " + err);
                    }
                default:
                    throw new Error("Unrecognized discriminator value '" + discriminatorValue + "' constructing `CatalogsItemsBatchRequest`. Expected one of: CREATE, DELETE, DELETE_DISCONTINUED, UPDATE, UPSERT.");
            }
        }
...
/**
 * @member {module:model/CatalogsItemsBatchRequest.OperationEnum} operation
 */
