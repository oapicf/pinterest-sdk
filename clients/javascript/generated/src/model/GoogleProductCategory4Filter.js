...
class GoogleProductCategory4Filter {
    ...
    static validateJSON(data) {
        ...
        // validate the optional field `GOOGLE_PRODUCT_CATEGORY_4`
        if (data['GOOGLE_PRODUCT_CATEGORY_4']) { // data not null
          CatalogsProductGroupMultipleStringListCriteria.validateJSON(data['GOOGLE_PRODUCT_CATEGORY_4']);
        }
