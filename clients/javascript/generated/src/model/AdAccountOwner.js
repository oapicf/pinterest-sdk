...
class AdAccountOwner {
    ...
    /**
     * Validates the JSON data with respect to <code>AdAccountOwner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AdAccountOwner</code>.
     */
 ...
 * @member {String} id
 */
AdAccountOwner.prototype['id'] = undefined;
