...
class IntegrationLog {
     ...
     * @param eventType {module:model/IntegrationLogEventType} Log event type
     * @param logLevel {module:model/IntegrationLogLevel} Log level type
     */
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('event_type')) {
                obj['event_type'] = ApiClient.convertToType(data['event_type'], IntegrationLogEventType);
            }
            ...
            if (data.hasOwnProperty('log_level')) {
                obj['log_level'] = ApiClient.convertToType(data['log_level'], IntegrationLogLevel);
            }
...
/**
 * Log event type
 * @member {module:model/IntegrationLogEventType} event_type
 */
...
/**
 * Log level type
 * @member {module:model/IntegrationLogLevel} log_level
 */
