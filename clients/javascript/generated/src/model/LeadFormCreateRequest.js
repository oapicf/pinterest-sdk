...
/**
 * The LeadFormCreateRequest model module.
 * @module model/LeadFormCreateRequest
 * @version 1.1.1-pre.0
 */
class LeadFormCreateRequest {
    ...
    /**
     * Constructs a <code>LeadFormCreateRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LeadFormCreateRequest} obj Optional instance to populate.
     * @return {module:model/LeadFormCreateRequest} The populated <code>LeadFormCreateRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LeadFormCreateRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>LeadFormCreateRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
 ...
 * @member {String} name
 */
LeadFormCreateRequest.prototype['name'] = undefined;

/**
 * A link to the advertiser's privacy policy. This will be included in the lead form's disclosure language.
 * @member {String} privacy_policy_link
 */
LeadFormCreateRequest.prototype['privacy_policy_link'] = undefined;

/**
 * Whether the advertiser has accepted Pinterest's terms of service for creating a lead ad.  By sending us TRUE for this parameter, you agree that (i) you will use any personal information received in compliance with the privacy policy you share with Pinterest, and (ii) you will comply with Pinterest's <a href=\"https://policy.pinterest.com/en/lead-ad-terms\">Lead Ad Terms</a>. As a reminder, all advertising on Pinterest is subject to the <a href=\"https://business.pinterest.com/en/pinterest-advertising-services-agreement/\">Pinterest Advertising Services Agreement</a> or an equivalent agreement as set forth on an IO
 * @member {Boolean} has_accepted_terms
 */
LeadFormCreateRequest.prototype['has_accepted_terms'] = undefined;

/**
 * A message for people who complete the form to let them know what happens next.
 * @member {String} completion_message
 */
LeadFormCreateRequest.prototype['completion_message'] = undefined;

/**
 * @member {module:model/LeadFormStatus} status
 */
LeadFormCreateRequest.prototype['status'] = undefined;

/**
 * Additional disclosure language to be included in the lead form.
 * @member {String} disclosure_language
 */
LeadFormCreateRequest.prototype['disclosure_language'] = undefined;

/**
 * List of questions to be displayed on the lead form.
 * @member {Array.<module:model/LeadFormQuestion>} questions
 */
LeadFormCreateRequest.prototype['questions'] = undefined;

/**
 * List of additional policy links to be displayed on the lead form.
 * @member {Array.<module:model/LeadFormCommonPolicyLinksInner>} policy_links
 */
LeadFormCreateRequest.prototype['policy_links'] = undefined;
...
export default LeadFormCreateRequest;
