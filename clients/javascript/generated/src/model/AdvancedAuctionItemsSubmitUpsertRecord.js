...
class AdvancedAuctionItemsSubmitUpsertRecord {
     ...
     */
    constructor(country, itemId, language, bidOptions, updateMask) { 
        AdvancedAuctionItem.initialize(this, country, itemId, language, bidOptions);
        AdvancedAuctionItemsSubmitUpsertRecord.initialize(this, country, itemId, language, bidOptions, updateMask);
    }
     ...
     */
    static initialize(obj, country, itemId, language, bidOptions, updateMask) { 
        obj['country'] = country;
        obj['item_id'] = itemId;
...
AdvancedAuctionItemsSubmitUpsertRecord.RequiredProperties = ["country", "item_id", "language", "bid_options", "update_mask"];
