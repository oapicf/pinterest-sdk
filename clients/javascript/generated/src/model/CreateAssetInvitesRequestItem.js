...
class CreateAssetInvitesRequestItem {
     ...
     */
    constructor(assetIdToPermissions, inviteId, inviteType) { 
        
        CreateAssetInvitesRequestItem.initialize(this, assetIdToPermissions, inviteId, inviteType);
    }
     ...
     */
    static initialize(obj, assetIdToPermissions, inviteId, inviteType) { 
...
CreateAssetInvitesRequestItem.RequiredProperties = ["asset_id_to_permissions", "invite_id", "invite_type"];
