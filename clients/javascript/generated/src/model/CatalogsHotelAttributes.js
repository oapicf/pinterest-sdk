...
class CatalogsHotelAttributes {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('main_image')) {
                obj['main_image'] = ApiClient.convertToType(data['main_image'], CatalogsHotelMainImage);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['main_image']) { // data not null
          CatalogsHotelMainImage.validateJSON(data['main_image']);
        }
 ...
 */
CatalogsHotelAttributes.prototype['ai_disclosures'] = undefined;

/**
 * The main hotel image
 * @member {module:model/CatalogsHotelMainImage} main_image
 */
