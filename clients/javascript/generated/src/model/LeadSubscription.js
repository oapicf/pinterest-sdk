...
/**
 * The LeadSubscription model module.
 * @module model/LeadSubscription
 * @version 2.0.1-pre.0
 */
class LeadSubscription {
    /**
     * Constructs a new <code>LeadSubscription</code>.
     * @alias module:model/LeadSubscription
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>LeadSubscription</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LeadSubscription} obj Optional instance to populate.
     * @return {module:model/LeadSubscription} The populated <code>LeadSubscription</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LeadSubscription();
    ...
    /**
     * Validates the JSON data with respect to <code>LeadSubscription</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LeadSubscription</code>.
     */
