        ...
        if (instance && typeof instance === 'object' && instance['catalog_type'] !== undefined) {
            ...
            switch (discriminatorValue) {
                case 'CREATIVE_ASSETS':
                    try {
                        CatalogsCreativeAssetsProductGroup.validateJSON(instance);
                        this.actualInstance = CatalogsCreativeAssetsProductGroup.constructFromObject(instance);
                        return;
                    } catch(err) {
                        throw new Error("Failed to construct CatalogsCreativeAssetsProductGroup using discriminator value 'CREATIVE_ASSETS': " + err);
                    }
                case 'HOTEL':
                    try {
                        CatalogsHotelProductGroup.validateJSON(instance);
                        this.actualInstance = CatalogsHotelProductGroup.constructFromObject(instance);
                        return;
                    } catch(err) {
                        throw new Error("Failed to construct CatalogsHotelProductGroup using discriminator value 'HOTEL': " + err);
                    }
                case 'RETAIL':
                    try {
                        CatalogsRetailProductGroup.validateJSON(instance);
                        this.actualInstance = CatalogsRetailProductGroup.constructFromObject(instance);
                        return;
                    } catch(err) {
                        throw new Error("Failed to construct CatalogsRetailProductGroup using discriminator value 'RETAIL': " + err);
                    }
                default:
                    throw new Error("Unrecognized discriminator value '" + discriminatorValue + "' constructing `CatalogsVerticalProductGroup`. Expected one of: CREATIVE_ASSETS, HOTEL, RETAIL.");
            }
        }
