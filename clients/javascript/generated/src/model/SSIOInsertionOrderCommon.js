...
/**
 * The SSIOInsertionOrderCommon model module.
 * @module model/SSIOInsertionOrderCommon
 * @version 1.1.1-pre.0
 */
class SSIOInsertionOrderCommon {
    /**
     * Constructs a new <code>SSIOInsertionOrderCommon</code>.
     * @alias module:model/SSIOInsertionOrderCommon
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>SSIOInsertionOrderCommon</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SSIOInsertionOrderCommon} obj Optional instance to populate.
     * @return {module:model/SSIOInsertionOrderCommon} The populated <code>SSIOInsertionOrderCommon</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SSIOInsertionOrderCommon();
    ...
    /**
     * Validates the JSON data with respect to <code>SSIOInsertionOrderCommon</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SSIOInsertionOrderCommon</code>.
     */
...
export default SSIOInsertionOrderCommon;
