...
class PinMediaSource {
    ...
    constructor(instance = null) {
        ...
        if (instance && typeof instance === 'object' && instance['source_type'] !== undefined) {
            var discriminatorValue = instance['source_type'];
            switch (discriminatorValue) {
                case 'image_base64':
                    try {
                        PinMediaSourceImageBase64.validateJSON(instance);
                        this.actualInstance = PinMediaSourceImageBase64.constructFromObject(instance);
                        return;
                    } catch(err) {
                        throw new Error("Failed to construct PinMediaSourceImageBase64 using discriminator value 'image_base64': " + err);
                    }
                case 'image_url':
                    try {
                        PinMediaSourceImageURL.validateJSON(instance);
                        this.actualInstance = PinMediaSourceImageURL.constructFromObject(instance);
                        return;
                    } catch(err) {
                        throw new Error("Failed to construct PinMediaSourceImageURL using discriminator value 'image_url': " + err);
                    }
                case 'multiple_image_base64':
                    try {
                        PinMediaSourceImagesBase64.validateJSON(instance);
                        this.actualInstance = PinMediaSourceImagesBase64.constructFromObject(instance);
                        return;
                    } catch(err) {
                        throw new Error("Failed to construct PinMediaSourceImagesBase64 using discriminator value 'multiple_image_base64': " + err);
                    }
                case 'multiple_image_urls':
                    try {
                        PinMediaSourceImagesURL.validateJSON(instance);
                        this.actualInstance = PinMediaSourceImagesURL.constructFromObject(instance);
                        return;
                    } catch(err) {
                        throw new Error("Failed to construct PinMediaSourceImagesURL using discriminator value 'multiple_image_urls': " + err);
                    }
                case 'pin_url':
                    try {
                        PinMediaSourcePinURL.validateJSON(instance);
                        this.actualInstance = PinMediaSourcePinURL.constructFromObject(instance);
                        return;
                    } catch(err) {
                        throw new Error("Failed to construct PinMediaSourcePinURL using discriminator value 'pin_url': " + err);
                    }
                case 'video_id':
                    try {
                        PinMediaSourceVideoID.validateJSON(instance);
                        this.actualInstance = PinMediaSourceVideoID.constructFromObject(instance);
                        return;
                    } catch(err) {
                        throw new Error("Failed to construct PinMediaSourceVideoID using discriminator value 'video_id': " + err);
                    }
                default:
                    throw new Error("Unrecognized discriminator value '" + discriminatorValue + "' constructing `PinMediaSource`. Expected one of: image_base64, image_url, multiple_image_base64, multiple_image_urls, pin_url, video_id.");
            }
        }
 ...
 */
PinMediaSource.prototype['cover_image_key_frame_time'] = undefined;
