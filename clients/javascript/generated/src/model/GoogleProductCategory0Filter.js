...
class GoogleProductCategory0Filter {
    ...
    static validateJSON(data) {
        ...
        // validate the optional field `GOOGLE_PRODUCT_CATEGORY_0`
        if (data['GOOGLE_PRODUCT_CATEGORY_0']) { // data not null
          CatalogsProductGroupMultipleStringListCriteria.validateJSON(data['GOOGLE_PRODUCT_CATEGORY_0']);
        }
