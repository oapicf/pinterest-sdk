...
class CatalogsRetailProductGroupCreateRequest {
    ...
    constructor(catalogId, catalogType, filters, name) { 
        ...
        CatalogsRetailProductGroupCreateRequest.initialize(this, catalogId, catalogType, filters, name);
    }
...
CatalogsRetailProductGroupCreateRequest.RequiredProperties = ["catalog_id", "catalog_type", "filters", "name"];
