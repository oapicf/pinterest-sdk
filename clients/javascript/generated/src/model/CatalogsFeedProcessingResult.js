...
class CatalogsFeedProcessingResult {
     ...
     */
    constructor(createdAt, id, updatedAt, ingestionDetails, productCounts, status, validationDetails) { 
        CatalogsDbItem.initialize(this, createdAt, id, updatedAt);
        CatalogsFeedProcessingResult.initialize(this, createdAt, id, updatedAt, ingestionDetails, productCounts, status, validationDetails);
    }
     ...
     */
    static initialize(obj, createdAt, id, updatedAt, ingestionDetails, productCounts, status, validationDetails) { 
...
CatalogsFeedProcessingResult.RequiredProperties = ["created_at", "id", "updated_at", "ingestion_details", "product_counts", "status", "validation_details"];
