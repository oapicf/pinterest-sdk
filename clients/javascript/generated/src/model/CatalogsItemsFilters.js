...
class CatalogsItemsFilters {
     ...
     * @param {(module:model/CatalogsHotelItemsFilter|module:model/CatalogsRetailItemsFilter)} instance The actual instance to initialize CatalogsItemsFilters.
     */
    constructor(instance = null) {
        ...
        if (match > 1) {
            throw new Error("Multiple matches found constructing `CatalogsItemsFilters` with oneOf schemas CatalogsHotelItemsFilter, CatalogsRetailItemsFilter. Input: " + JSON.stringify(instance));
        } else if (match === 0) {
            this.actualInstance = null; // clear the actual instance in case there are multiple matches
            throw new Error("No match found constructing `CatalogsItemsFilters` with oneOf schemas CatalogsHotelItemsFilter, CatalogsRetailItemsFilter. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
    ...
    /**
     * Gets the actual instance, which can be <code>CatalogsHotelItemsFilter</code>, <code>CatalogsRetailItemsFilter</code>.
     * @return {(module:model/CatalogsHotelItemsFilter|module:model/CatalogsRetailItemsFilter)} The actual instance.
     */
    getActualInstance() {
    ...
    /**
     * Sets the actual instance, which can be <code>CatalogsHotelItemsFilter</code>, <code>CatalogsRetailItemsFilter</code>.
     * @param {(module:model/CatalogsHotelItemsFilter|module:model/CatalogsRetailItemsFilter)} obj The actual instance.
     */
...
CatalogsItemsFilters.OneOf = ["CatalogsHotelItemsFilter", "CatalogsRetailItemsFilter"];
