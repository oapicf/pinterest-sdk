...
* @readonly
*/
export default class MultiPinsAnalyticsMetricTypesItem {
    ...
    /**
    * Returns a <code>MultiPinsAnalyticsMetricTypesItem</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/MultiPinsAnalyticsMetricTypesItem} The enum <code>MultiPinsAnalyticsMetricTypesItem</code> value.
    */
