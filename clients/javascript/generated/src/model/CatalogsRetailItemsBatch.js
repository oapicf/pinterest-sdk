...
class CatalogsRetailItemsBatch {
     ...
     * @param catalogType {module:model/CatalogsRetailItemsBatch.CatalogTypeEnum} 
     * @param createdTime {Date} Date and time (UTC) of the batch creation: YYYY-MM-DD'T'hh:mm:ss. If null, batch creation was skipped due to a recent duplicate ingestion.
     */
    constructor(catalogType, createdTime) { 
        
        CatalogsRetailItemsBatch.initialize(this, catalogType, createdTime);
    }
     ...
     */
    static initialize(obj, catalogType, createdTime) { 
...
CatalogsRetailItemsBatch.RequiredProperties = ["catalog_type", "created_time"];
...
/**
 * @member {module:model/CatalogsRetailItemsBatch.CatalogTypeEnum} catalog_type
 */
 ...
 * @readonly
 */
CatalogsRetailItemsBatch['CatalogTypeEnum'] = {
