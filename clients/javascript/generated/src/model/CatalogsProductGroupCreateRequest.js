...
class CatalogsProductGroupCreateRequest {
     ...
     * @param name {String} 
     */
    constructor(feedId, filters, name) { 
        
        CatalogsProductGroupCreateRequest.initialize(this, feedId, filters, name);
    }
     ...
     */
    static initialize(obj, feedId, filters, name) { 
        obj['feed_id'] = feedId;
        obj['filters'] = filters;
        obj['name'] = name;
    }
...
CatalogsProductGroupCreateRequest.RequiredProperties = ["feed_id", "filters", "name"];
 ...
 */
CatalogsProductGroupCreateRequest.prototype['is_featured'] = undefined;
