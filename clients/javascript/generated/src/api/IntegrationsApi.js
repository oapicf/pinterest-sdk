...
export default class IntegrationsApi {
    ...
    */
     ...
     * data is of type: {@link module:model/IntegrationMetadata}
     */
    integrationsCommercePatch(externalBusinessId, integrationRequestPatch, callback) {
      let postBody = integrationRequestPatch;
      // verify the required parameter 'externalBusinessId' is set
      if (externalBusinessId === undefined || externalBusinessId === null) {
      ...
      if (integrationRequestPatch === undefined || integrationRequestPatch === null) {
        throw new Error("Missing the required parameter 'integrationRequestPatch' when calling integrationsCommercePatch");
      }
     ...
     * data is of type: {@link module:model/IntegrationMetadata}
     */
    integrationsCommercePost(integrationRequest, callback) {
      ...
      if (integrationRequest === undefined || integrationRequest === null) {
        throw new Error("Missing the required parameter 'integrationRequest' when calling integrationsCommercePost");
      }
