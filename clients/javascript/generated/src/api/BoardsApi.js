...
export default class BoardsApi {
    ...
    */
     ...
     */
    boardSectionsCreate(boardId, boardSection, callback) {
     ...
     */
    boardSectionsDelete(boardId, sectionId, callback) {
      let postBody = null;
      // verify the required parameter 'boardId' is set
      if (boardId === undefined || boardId === null) {
     ...
     * data is of type: {@link module:model/BoardSection}
     */
    boardSectionsUpdate(boardId, sectionId, boardSection, callback) {
      let postBody = boardSection;
      // verify the required parameter 'boardId' is set
      if (boardId === undefined || boardId === null) {
     ...
     * @param {String} opts.bookmark Cursor used to fetch the next page of items
     * @param {Number} opts.pageSize Maximum number of items to include in a single page of the response. See documentation on <a href='/docs/api/v5/#tag/Pagination'>Pagination</a> for more information. (default to 25)
     * @param {module:model/String} opts.privacy Privacy setting for a board.
     ...
     * data is of type: {@link module:model/Board}
     */
    boardsUpdate(boardId, boardUpdate, callback) {
