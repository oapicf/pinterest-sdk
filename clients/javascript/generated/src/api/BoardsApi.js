...
export default class BoardsApi {
    ...
    */
     ...
     * @param {module:model/BoardSectionCreate} boardSectionCreate 
     ...
     */
    boardSectionsCreate(boardId, boardSectionCreate, opts, callback) {
      opts = opts || {};
      let postBody = boardSectionCreate;
      ...
      if (boardSectionCreate === undefined || boardSectionCreate === null) {
        throw new Error("Missing the required parameter 'boardSectionCreate' when calling boardSectionsCreate");
      }
     ...
     * @param {String} boardId Unique identifier of a board.
     * @param {String} sectionId Unique identifier of a board section.
     * @param {module:model/BoardSectionUpdateWithRequiredBody} boardSectionUpdateWithRequiredBody 
     * @param {Object} opts Optional parameters
     * @param {String} [adAccountId] Unique identifier of an ad account.
     ...
     * data is of type: {@link module:model/BoardSection}
     */
    boardSectionsUpdate(boardId, sectionId, boardSectionUpdateWithRequiredBody, opts, callback) {
      opts = opts || {};
      let postBody = boardSectionUpdateWithRequiredBody;
      // verify the required parameter 'boardId' is set
      if (boardId === undefined || boardId === null) {
      ...
      if (boardSectionUpdateWithRequiredBody === undefined || boardSectionUpdateWithRequiredBody === null) {
        throw new Error("Missing the required parameter 'boardSectionUpdateWithRequiredBody' when calling boardSectionsUpdate");
      }
     ...
     * @param {module:model/BoardCreate} boardCreate 
     * @param {Object} opts Optional parameters
     * @param {String} [adAccountId] Unique identifier of an ad account.
     ...
     */
    boardsCreate(boardCreate, opts, callback) {
      opts = opts || {};
      let postBody = boardCreate;
      // verify the required parameter 'boardCreate' is set
      if (boardCreate === undefined || boardCreate === null) {
        throw new Error("Missing the required parameter 'boardCreate' when calling boardsCreate");
      }
     ...
     * @param {Object} opts Optional parameters
     * @param {String} [adAccountId] Unique identifier of an ad account.
     * @param {module:model/BoardPrivacyFilter} [privacy] The privacy level of the board
     * @param {String} [bookmark] Cursor used to fetch the next page of items
     * @param {Number} [pageSize = 25)] Maximum number of items to include in a single page. See documentation on [Pagination](/docs/reference/pagination/) for more information.
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/BoardWithUpdatePrivacy} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} boardId 
     * @param {module:model/BoardWithUpdatePrivacyUpdate} boardWithUpdatePrivacyUpdate 
     * @param {Object} opts Optional parameters
     * @param {String} [adAccountId] Unique identifier of an ad account.
     ...
     * data is of type: {@link module:model/BoardWithUpdatePrivacy}
     */
    boardsUpdate(boardId, boardWithUpdatePrivacyUpdate, opts, callback) {
      opts = opts || {};
      let postBody = boardWithUpdatePrivacyUpdate;
      // verify the required parameter 'boardId' is set
      if (boardId === undefined || boardId === null) {
      ...
      if (boardWithUpdatePrivacyUpdate === undefined || boardWithUpdatePrivacyUpdate === null) {
        throw new Error("Missing the required parameter 'boardWithUpdatePrivacyUpdate' when calling boardsUpdate");
      }
      ...
      let contentTypes = ['application/json'];
      let accepts = ['application/json'];
      let returnType = BoardWithUpdatePrivacy;
      return this.apiClient.callApi(
