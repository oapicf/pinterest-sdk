...
export default class BusinessAccessInviteApi {
    ...
    */
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/CancelInvitesResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} businessId Unique identifier of the requesting business.
     * @param {module:model/CancelInvitesRequest} cancelInvitesRequest 
     ...
     * data is of type: {@link module:model/CancelInvitesResponse}
     */
    cancelInvitesOrRequests(businessId, cancelInvitesRequest, callback) {
      let postBody = cancelInvitesRequest;
      // verify the required parameter 'businessId' is set
      if (businessId === undefined || businessId === null) {
      ...
      if (cancelInvitesRequest === undefined || cancelInvitesRequest === null) {
        throw new Error("Missing the required parameter 'cancelInvitesRequest' when calling cancelInvitesOrRequests");
      }
      ...
      let contentTypes = ['application/json'];
      let accepts = ['application/json'];
      let returnType = CancelInvitesResponse;
      return this.apiClient.callApi(
     ...
     * @param {String} businessId Unique identifier of the requesting business.
     * @param {module:model/CreateAssetInvitesRequest} createAssetInvitesRequest 
     ...
     * @param {String} businessId Unique identifier of the requesting business.
     * @param {module:model/CreateMembershipOrPartnershipInvitesBody} createMembershipOrPartnershipInvitesBody 
     ...
     * @param {Array.<module:model/InviteFilterStatus>} [inviteStatus] A list of invite statuses to filter invites by. Only invites whose status is in the provided statuses will be returned.
