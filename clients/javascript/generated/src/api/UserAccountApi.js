...
export default class UserAccountApi {
    ...
    */
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/FollowUser} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:model/FollowUserCreate} followUserCreate 
     ...
     * data is of type: {@link module:model/FollowUser}
     */
    followUserUpdate(username, followUserCreate, callback) {
      let postBody = followUserCreate;
      ...
      if (followUserCreate === undefined || followUserCreate === null) {
        throw new Error("Missing the required parameter 'followUserCreate' when calling followUserUpdate");
      }
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/UserWebsite} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:model/UserWebsite}
     */
     ...
     * @param {Array.<module:model/QuerymetrictypesItems>} [metricTypes] Metric types to get data for, default is all.
     ...
     * @param {Date} startDate Metric report start date (UTC). Format: YYYY-MM-DD. Cannot be more than 90 days back from today.
     * @param {Date} endDate Metric report end date (UTC). Format: YYYY-MM-DD. Cannot be more than 90 days past start_date.
     * @param {module:model/TopPinsSortBy} sortBy Specify sorting order for metrics
     * @param {Object} opts Optional parameters
     * @param {module:model/String} [fromClaimedContent = 'BOTH')] Filter on Pins that match your claimed domain.
     * @param {module:model/String} [pinFormat = 'ALL')] Pin formats to get data for, default is all.
     * @param {module:model/String} [appTypes = 'ALL')] Apps or devices to get data for, default is all.
     ...
     * @param {Date} startDate Metric report start date (UTC). Format: YYYY-MM-DD. Cannot be more than 90 days back from today.
     * @param {Date} endDate Metric report end date (UTC). Format: YYYY-MM-DD. Cannot be more than 90 days past start_date.
     * @param {module:model/TopVideoPinsSortBy} sortBy Specify sorting order for video metrics
     * @param {Object} opts Optional parameters
     * @param {module:model/String} [fromClaimedContent = 'BOTH')] Filter on Pins that match your claimed domain.
     * @param {module:model/String} [pinFormat = 'ALL')] Pin formats to get data for, default is all.
     * @param {module:model/String} [appTypes = 'ALL')] Apps or devices to get data for, default is all.
     * @param {module:model/String} [contentType = 'ALL')] Filter to paid or organic data. Default is all.
     * @param {module:model/String} [source = 'ALL')] Filter to activity from Pins created and saved by your, or activity created and saved by others from your claimed accounts
     * @param {Array.<module:model/QueryvideopinmetrictypesItems>} [metricTypes] Metric types to get video data for, default is all.
     * @param {Number} [numOfPins = 10)] Number of pins to include, default is 10. Max is 50.
     * @param {module:model/Number} [createdInLastNDays] Get metrics for pins created in the last \"n\" days.
     * @param {String} [adAccountId] Unique identifier of an ad account.
     ...
     * @param {module:model/UserWebsiteCreate} userWebsiteCreate 
     * @param {Object} opts Optional parameters
     * @param {String} [adAccountId] Unique identifier of an ad account.
     ...
     * data is of type: {@link module:model/UserWebsite}
     */
    verifyWebsiteUpdate(userWebsiteCreate, opts, callback) {
      opts = opts || {};
      let postBody = userWebsiteCreate;
      // verify the required parameter 'userWebsiteCreate' is set
      if (userWebsiteCreate === undefined || userWebsiteCreate === null) {
        throw new Error("Missing the required parameter 'userWebsiteCreate' when calling verifyWebsiteUpdate");
      }
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/UserWebsiteVerification} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:model/UserWebsiteVerification}
     */
    websiteVerificationGet(opts, callback) {
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = UserWebsiteVerification;
      return this.apiClient.callApi(
