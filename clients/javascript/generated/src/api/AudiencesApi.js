...
export default class AudiencesApi {
    ...
    */
     ...
     * data is of type: {@link module:model/Audience}
     */
    audiencesUpdate(adAccountId, audienceId, audienceUpdateRequest, callback) {
      let postBody = audienceUpdateRequest;
      // verify the required parameter 'adAccountId' is set
      if (adAccountId === undefined || adAccountId === null) {
      ...
      if (audienceUpdateRequest === undefined || audienceUpdateRequest === null) {
        throw new Error("Missing the required parameter 'audienceUpdateRequest' when calling audiencesUpdate");
      }
