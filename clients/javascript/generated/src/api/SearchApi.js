...
export default class SearchApi {
    ...
    */
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/SearchUserPinsList200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:model/SearchUserPinsList200Response}
     */
    searchUserPinsList(query, opts, callback) {
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = SearchUserPinsList200Response;
      return this.apiClient.callApi(
        '/search/pins', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
