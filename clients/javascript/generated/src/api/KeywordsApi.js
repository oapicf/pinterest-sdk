...
export default class KeywordsApi {
    ...
    */
     ...
     * @param {Number} [pageSize = 25)] Maximum number of items to include in a single page of the response. Default maximum of 250. See documentation on <a href='/docs/reference/pagination/'>Pagination</a> for more information.
     ...
     * @param {Boolean} [includePrediction = false)] <a href=\"/docs/getting-started/using-beta-and-restricted-features/\" target=\"blank\" target=\"blank\">Closed beta</a> Including predicted weekly search volume data for the next 90 days. By default (`false`), the response will not include predicted data.
     * @param {Boolean} [includeDemographics = false)] <a href=\"/docs/getting-started/using-beta-and-restricted-features/\" target=\"blank\" target=\"blank\">Closed beta</a> Including the age and gender distribution for each keyword. By default (`false`), the response will not include demographics data.
    ...
    trendingKeywordsList(region, trendType, opts, callback) {
      ...
      let queryParams = {
        ...
        'limit': opts['limit'],
        'include_prediction': opts['includePrediction'],
