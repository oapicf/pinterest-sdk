...
export default class AdAccountsApi {
    ...
    */
     ...
     * @param {String} adAccountId Unique identifier of an ad account.
     * @param {module:model/ConversionProductReportRequest} conversionProductReportRequest 
     ...
     */
    analyticsCreateConversionProductReport(adAccountId, conversionProductReportRequest, callback) {
      let postBody = conversionProductReportRequest;
      // verify the required parameter 'adAccountId' is set
      if (adAccountId === undefined || adAccountId === null) {
      ...
      if (conversionProductReportRequest === undefined || conversionProductReportRequest === null) {
        throw new Error("Missing the required parameter 'conversionProductReportRequest' when calling analyticsCreateConversionProductReport");
      }
     ...
     * @param {module:model/Granularity} [granularity]    TOTAL - metrics are aggregated over the specified date range.    DAY - metrics are broken down daily.    HOUR - metrics are broken down hourly.    WEEKLY - metrics are broken down weekly.    MONTHLY - metrics are broken down monthly
