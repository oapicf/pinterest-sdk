...
export default class BusinessAccessRelationshipsApi {
    ...
    */
     ...
     * @param {module:model/BrandAccountsCreate200Response} data The data returned by the service call.
     ...
     * @param {module:model/BrandAccountsCreateRequest} brandAccountsCreateRequest 
     ...
     * data is of type: {@link module:model/BrandAccountsCreate200Response}
     */
    brandAccountsCreate(businessHierarchyId, brandAccountsCreateRequest, callback) {
      let postBody = brandAccountsCreateRequest;
      ...
      if (brandAccountsCreateRequest === undefined || brandAccountsCreateRequest === null) {
        throw new Error("Missing the required parameter 'brandAccountsCreateRequest' when calling brandAccountsCreate");
      }
      ...
      let returnType = BrandAccountsCreate200Response;
     ...
     * @param {module:model/BrandAccountsUpdateRequest} brandAccountsUpdateRequest 
     ...
     * data is of type: {@link module:model/BrandAccountsCreate200Response}
     */
    brandAccountsUpdate(businessHierarchyId, brandAccountId, brandAccountsUpdateRequest, callback) {
      let postBody = brandAccountsUpdateRequest;
      // verify the required parameter 'businessHierarchyId' is set
      if (businessHierarchyId === undefined || businessHierarchyId === null) {
      ...
      if (brandAccountsUpdateRequest === undefined || brandAccountsUpdateRequest === null) {
        throw new Error("Missing the required parameter 'brandAccountsUpdateRequest' when calling brandAccountsUpdate");
      }
     ...
     * @param {module:model/SystemUserUpdateRequest} systemUserUpdateRequest 
     ...
     */
    systemUserUpdate(businessId, systemUserId, systemUserUpdateRequest, callback) {
      let postBody = systemUserUpdateRequest;
      // verify the required parameter 'businessId' is set
      if (businessId === undefined || businessId === null) {
      ...
      if (systemUserUpdateRequest === undefined || systemUserUpdateRequest === null) {
        throw new Error("Missing the required parameter 'systemUserUpdateRequest' when calling systemUserUpdate");
      }
