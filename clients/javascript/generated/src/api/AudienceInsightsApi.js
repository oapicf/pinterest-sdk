...
export default class AudienceInsightsApi {
    ...
    */
     ...
     * @param {module:model/AudienceInsights} data The data returned by the service call.
     ...
     * data is of type: {@link module:model/AudienceInsights}
     */
    audienceInsightsGet(adAccountId, audienceInsightType, callback) {
      ...
      let returnType = AudienceInsights;
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/AudienceInsightsScopeAndTypeGet200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:model/AudienceInsightsScopeAndTypeGet200Response}
     */
    audienceInsightsScopeAndTypeGet(adAccountId, callback) {
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = AudienceInsightsScopeAndTypeGet200Response;
      return this.apiClient.callApi(
