...
(function(root, factory) {
  ...
  describe('BusinessAccessRelationshipsApi', function() {
    describe('brandAccountsCreate', function() {
      it('should call brandAccountsCreate successfully', function(done) {
        //uncomment below and update the code to test brandAccountsCreate
        //instance.brandAccountsCreate(function(error) {
    ...
    describe('brandAccountsUpdate', function() {
      it('should call brandAccountsUpdate successfully', function(done) {
        //uncomment below and update the code to test brandAccountsUpdate
        //instance.brandAccountsUpdate(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('systemUserUpdate', function() {
      it('should call systemUserUpdate successfully', function(done) {
        //uncomment below and update the code to test systemUserUpdate
        //instance.systemUserUpdate(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
