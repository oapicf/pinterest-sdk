...
(function(root, factory) {
  ...
  describe('BillingApi', function() {
    ...
    describe('billingInvoiceDownloadGet', function() {
      it('should call billingInvoiceDownloadGet successfully', function(done) {
        //uncomment below and update the code to test billingInvoiceDownloadGet
        //instance.billingInvoiceDownloadGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('billingInvoicesGet', function() {
      it('should call billingInvoicesGet successfully', function(done) {
        //uncomment below and update the code to test billingInvoicesGet
        //instance.billingInvoicesGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
