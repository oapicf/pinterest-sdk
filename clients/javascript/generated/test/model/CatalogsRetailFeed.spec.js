...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.CatalogsRetailFeed();
  });
  ...
  describe('CatalogsRetailFeed', function() {
    it('should create an instance of CatalogsRetailFeed', function() {
      // uncomment below and update the code to test CatalogsRetailFeed
      //var instance = new PinterestSdk.CatalogsRetailFeed();
      //expect(instance).to.be.a(PinterestSdk.CatalogsRetailFeed);
    });
