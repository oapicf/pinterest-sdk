...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.CatalogsRetailProductGroupCreateRequest();
  });
  ...
  describe('CatalogsRetailProductGroupCreateRequest', function() {
    it('should create an instance of CatalogsRetailProductGroupCreateRequest', function() {
      // uncomment below and update the code to test CatalogsRetailProductGroupCreateRequest
      //var instance = new PinterestSdk.CatalogsRetailProductGroupCreateRequest();
      //expect(instance).to.be.a(PinterestSdk.CatalogsRetailProductGroupCreateRequest);
    });
