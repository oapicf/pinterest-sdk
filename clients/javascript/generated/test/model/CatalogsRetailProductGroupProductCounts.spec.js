...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.CatalogsRetailProductGroupProductCounts();
  });
  ...
  describe('CatalogsRetailProductGroupProductCounts', function() {
    it('should create an instance of CatalogsRetailProductGroupProductCounts', function() {
      // uncomment below and update the code to test CatalogsRetailProductGroupProductCounts
      //var instance = new PinterestSdk.CatalogsRetailProductGroupProductCounts();
      //expect(instance).to.be.a(PinterestSdk.CatalogsRetailProductGroupProductCounts);
    });
