...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.PinMediaSourcePinURL();
  });
  ...
  describe('PinMediaSourcePinURL', function() {
    it('should create an instance of PinMediaSourcePinURL', function() {
      // uncomment below and update the code to test PinMediaSourcePinURL
      //var instance = new PinterestSdk.PinMediaSourcePinURL();
      //expect(instance).to.be.a(PinterestSdk.PinMediaSourcePinURL);
    });
