...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.CatalogsHotelProduct();
  });
  ...
  describe('CatalogsHotelProduct', function() {
    it('should create an instance of CatalogsHotelProduct', function() {
      // uncomment below and update the code to test CatalogsHotelProduct
      //var instance = new PinterestSdk.CatalogsHotelProduct();
      //expect(instance).to.be.a(PinterestSdk.CatalogsHotelProduct);
    });
