...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.CatalogsReportAllItemsFilter();
  });
  ...
  describe('CatalogsReportAllItemsFilter', function() {
    it('should create an instance of CatalogsReportAllItemsFilter', function() {
      // uncomment below and update the code to test CatalogsReportAllItemsFilter
      //var instance = new PinterestSdk.CatalogsReportAllItemsFilter();
      //expect(instance).to.be.a(PinterestSdk.CatalogsReportAllItemsFilter);
    });
