...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.AudienceCreateRequest();
  });
  ...
  describe('AudienceCreateRequest', function() {
    it('should create an instance of AudienceCreateRequest', function() {
      // uncomment below and update the code to test AudienceCreateRequest
      //var instance = new PinterestSdk.AudienceCreateRequest();
      //expect(instance).to.be.a(PinterestSdk.AudienceCreateRequest);
    });
