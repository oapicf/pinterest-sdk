...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.CatalogsProductGroupsCreateRequest();
  });
  ...
  describe('CatalogsProductGroupsCreateRequest', function() {
    it('should create an instance of CatalogsProductGroupsCreateRequest', function() {
      // uncomment below and update the code to test CatalogsProductGroupsCreateRequest
      //var instance = new PinterestSdk.CatalogsProductGroupsCreateRequest();
      //expect(instance).to.be.a(PinterestSdk.CatalogsProductGroupsCreateRequest);
    });
