...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.CampaignCommon();
  });
  ...
  describe('CampaignCommon', function() {
    it('should create an instance of CampaignCommon', function() {
      // uncomment below and update the code to test CampaignCommon
      //var instance = new PinterestSdk.CampaignCommon();
      //expect(instance).to.be.a(PinterestSdk.CampaignCommon);
    });
