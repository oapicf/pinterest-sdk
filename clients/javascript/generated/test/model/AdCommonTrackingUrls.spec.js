...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.AdCommonTrackingUrls();
  });
  ...
  describe('AdCommonTrackingUrls', function() {
    it('should create an instance of AdCommonTrackingUrls', function() {
      // uncomment below and update the code to test AdCommonTrackingUrls
      //var instance = new PinterestSdk.AdCommonTrackingUrls();
      //expect(instance).to.be.a(PinterestSdk.AdCommonTrackingUrls);
    });
