...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.KeywordUpdate();
  });
  ...
  describe('KeywordUpdate', function() {
    it('should create an instance of KeywordUpdate', function() {
      // uncomment below and update the code to test KeywordUpdate
      //var instance = new PinterestSdk.KeywordUpdate();
      //expect(instance).to.be.a(PinterestSdk.KeywordUpdate);
    });
