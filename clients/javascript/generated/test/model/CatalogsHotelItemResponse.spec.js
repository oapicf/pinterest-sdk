...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.CatalogsHotelItemResponse();
  });
  ...
  describe('CatalogsHotelItemResponse', function() {
    it('should create an instance of CatalogsHotelItemResponse', function() {
      // uncomment below and update the code to test CatalogsHotelItemResponse
      //var instance = new PinterestSdk.CatalogsHotelItemResponse();
      //expect(instance).to.be.a(PinterestSdk.CatalogsHotelItemResponse);
    });
