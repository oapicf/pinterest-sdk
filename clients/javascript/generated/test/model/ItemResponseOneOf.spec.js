...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.ItemResponseOneOf();
  });
  ...
  describe('ItemResponseOneOf', function() {
    it('should create an instance of ItemResponseOneOf', function() {
      // uncomment below and update the code to test ItemResponseOneOf
      //var instance = new PinterestSdk.ItemResponseOneOf();
      //expect(instance).to.be.a(PinterestSdk.ItemResponseOneOf);
    });
