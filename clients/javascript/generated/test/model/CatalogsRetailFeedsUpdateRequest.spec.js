...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.CatalogsRetailFeedsUpdateRequest();
  });
  ...
  describe('CatalogsRetailFeedsUpdateRequest', function() {
    it('should create an instance of CatalogsRetailFeedsUpdateRequest', function() {
      // uncomment below and update the code to test CatalogsRetailFeedsUpdateRequest
      //var instance = new PinterestSdk.CatalogsRetailFeedsUpdateRequest();
      //expect(instance).to.be.a(PinterestSdk.CatalogsRetailFeedsUpdateRequest);
    });
