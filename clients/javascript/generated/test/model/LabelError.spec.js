...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.LabelError();
  });
  ...
  describe('LabelError', function() {
    it('should create an instance of LabelError', function() {
      // uncomment below and update the code to test LabelError
      //var instance = new PinterestSdk.LabelError();
      //expect(instance).to.be.a(PinterestSdk.LabelError);
    });
