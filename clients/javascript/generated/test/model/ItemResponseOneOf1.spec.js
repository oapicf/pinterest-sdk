...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.ItemResponseOneOf1();
  });
  ...
  describe('ItemResponseOneOf1', function() {
    it('should create an instance of ItemResponseOneOf1', function() {
      // uncomment below and update the code to test ItemResponseOneOf1
      //var instance = new PinterestSdk.ItemResponseOneOf1();
      //expect(instance).to.be.a(PinterestSdk.ItemResponseOneOf1);
    });
