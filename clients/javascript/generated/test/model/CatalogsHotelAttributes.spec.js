...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.CatalogsHotelAttributes();
  });
  ...
  describe('CatalogsHotelAttributes', function() {
    it('should create an instance of CatalogsHotelAttributes', function() {
      // uncomment below and update the code to test CatalogsHotelAttributes
      //var instance = new PinterestSdk.CatalogsHotelAttributes();
      //expect(instance).to.be.a(PinterestSdk.CatalogsHotelAttributes);
    });
