...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.RecordCounts();
  });
  ...
  describe('RecordCounts', function() {
    it('should create an instance of RecordCounts', function() {
      // uncomment below and update the code to test RecordCounts
      //var instance = new PinterestSdk.RecordCounts();
      //expect(instance).to.be.a(PinterestSdk.RecordCounts);
    });
