...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.CatalogsReportFeedIngestionStats();
  });
  ...
  describe('CatalogsReportFeedIngestionStats', function() {
    it('should create an instance of CatalogsReportFeedIngestionStats', function() {
      // uncomment below and update the code to test CatalogsReportFeedIngestionStats
      //var instance = new PinterestSdk.CatalogsReportFeedIngestionStats();
      //expect(instance).to.be.a(PinterestSdk.CatalogsReportFeedIngestionStats);
    });
