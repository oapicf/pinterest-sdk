...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.AdvancedAuctionItem();
  });
  ...
  describe('AdvancedAuctionItem', function() {
    it('should create an instance of AdvancedAuctionItem', function() {
      // uncomment below and update the code to test AdvancedAuctionItem
      //var instance = new PinterestSdk.AdvancedAuctionItem();
      //expect(instance).to.be.a(PinterestSdk.AdvancedAuctionItem);
    });
