...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.FeedsCreateRequest();
  });
  ...
  describe('FeedsCreateRequest', function() {
    it('should create an instance of FeedsCreateRequest', function() {
      // uncomment below and update the code to test FeedsCreateRequest
      //var instance = new PinterestSdk.FeedsCreateRequest();
      //expect(instance).to.be.a(PinterestSdk.FeedsCreateRequest);
    });
