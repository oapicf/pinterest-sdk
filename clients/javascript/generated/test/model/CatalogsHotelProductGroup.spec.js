...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.CatalogsHotelProductGroup();
  });
  ...
  describe('CatalogsHotelProductGroup', function() {
    it('should create an instance of CatalogsHotelProductGroup', function() {
      // uncomment below and update the code to test CatalogsHotelProductGroup
      //var instance = new PinterestSdk.CatalogsHotelProductGroup();
      //expect(instance).to.be.a(PinterestSdk.CatalogsHotelProductGroup);
    });
