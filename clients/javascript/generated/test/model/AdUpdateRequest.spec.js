...
(function(root, factory) {
  ...
  describe('AdUpdateRequest', function() {
    ...
    it('should have the property disclosureType (base name: "disclosure_type")', function() {
      // uncomment below and update the code to test the property disclosureType
      //var instance = new PinterestSdk.AdUpdateRequest();
      //expect(instance).to.be();
    });

    it('should have the property disclosureUrl (base name: "disclosure_url")', function() {
      // uncomment below and update the code to test the property disclosureUrl
      //var instance = new PinterestSdk.AdUpdateRequest();
      //expect(instance).to.be();
    });
