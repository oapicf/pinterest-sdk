...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.AdCommon();
  });
  ...
  describe('AdCommon', function() {
    it('should create an instance of AdCommon', function() {
      // uncomment below and update the code to test AdCommon
      //var instance = new PinterestSdk.AdCommon();
      //expect(instance).to.be.a(PinterestSdk.AdCommon);
    });
