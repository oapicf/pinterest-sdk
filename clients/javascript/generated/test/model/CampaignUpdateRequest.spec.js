...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.CampaignUpdateRequest();
  });
  ...
  describe('CampaignUpdateRequest', function() {
    it('should create an instance of CampaignUpdateRequest', function() {
      // uncomment below and update the code to test CampaignUpdateRequest
      //var instance = new PinterestSdk.CampaignUpdateRequest();
      //expect(instance).to.be.a(PinterestSdk.CampaignUpdateRequest);
    });
