...
(function(root, factory) {
  ...
  describe('CatalogsFeedIngestionInfo', function() {
    ...
    it('should have the property IN_STOCK (base name: "IN_STOCK")', function() {
      // uncomment below and update the code to test the property IN_STOCK
      //var instance = new PinterestSdk.CatalogsFeedIngestionInfo();
      //expect(instance).to.be();
    });

    it('should have the property OUT_OF_STOCK (base name: "OUT_OF_STOCK")', function() {
      // uncomment below and update the code to test the property OUT_OF_STOCK
      //var instance = new PinterestSdk.CatalogsFeedIngestionInfo();
      //expect(instance).to.be();
    });
