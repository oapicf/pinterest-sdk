...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.ImageMetadataImages();
  });
  ...
  describe('ImageMetadataImages', function() {
    it('should create an instance of ImageMetadataImages', function() {
      // uncomment below and update the code to test ImageMetadataImages
      //var instance = new PinterestSdk.ImageMetadataImages();
      //expect(instance).to.be.a(PinterestSdk.ImageMetadataImages);
    });
