...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.CatalogsHotelFeedsUpdateRequest();
  });
  ...
  describe('CatalogsHotelFeedsUpdateRequest', function() {
    it('should create an instance of CatalogsHotelFeedsUpdateRequest', function() {
      // uncomment below and update the code to test CatalogsHotelFeedsUpdateRequest
      //var instance = new PinterestSdk.CatalogsHotelFeedsUpdateRequest();
      //expect(instance).to.be.a(PinterestSdk.CatalogsHotelFeedsUpdateRequest);
    });
