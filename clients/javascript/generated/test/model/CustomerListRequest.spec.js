...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.CustomerListRequest();
  });
  ...
  describe('CustomerListRequest', function() {
    it('should create an instance of CustomerListRequest', function() {
      // uncomment below and update the code to test CustomerListRequest
      //var instance = new PinterestSdk.CustomerListRequest();
      //expect(instance).to.be.a(PinterestSdk.CustomerListRequest);
    });
