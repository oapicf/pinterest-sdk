...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.TargetingSpecOperationList();
  });
  ...
  describe('TargetingSpecOperationList', function() {
    it('should create an instance of TargetingSpecOperationList', function() {
      // uncomment below and update the code to test TargetingSpecOperationList
      //var instance = new PinterestSdk.TargetingSpecOperationList();
      //expect(instance).to.be.a(PinterestSdk.TargetingSpecOperationList);
    });
