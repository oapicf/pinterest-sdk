...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.CatalogsRetailProductGroup();
  });
  ...
  describe('CatalogsRetailProductGroup', function() {
    it('should create an instance of CatalogsRetailProductGroup', function() {
      // uncomment below and update the code to test CatalogsRetailProductGroup
      //var instance = new PinterestSdk.CatalogsRetailProductGroup();
      //expect(instance).to.be.a(PinterestSdk.CatalogsRetailProductGroup);
    });
