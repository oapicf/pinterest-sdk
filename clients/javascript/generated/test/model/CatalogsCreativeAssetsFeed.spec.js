...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.CatalogsCreativeAssetsFeed();
  });
  ...
  describe('CatalogsCreativeAssetsFeed', function() {
    it('should create an instance of CatalogsCreativeAssetsFeed', function() {
      // uncomment below and update the code to test CatalogsCreativeAssetsFeed
      //var instance = new PinterestSdk.CatalogsCreativeAssetsFeed();
      //expect(instance).to.be.a(PinterestSdk.CatalogsCreativeAssetsFeed);
    });
