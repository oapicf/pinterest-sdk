...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.TargetingSpecOperationGender();
  });
  ...
  describe('TargetingSpecOperationGender', function() {
    it('should create an instance of TargetingSpecOperationGender', function() {
      // uncomment below and update the code to test TargetingSpecOperationGender
      //var instance = new PinterestSdk.TargetingSpecOperationGender();
      //expect(instance).to.be.a(PinterestSdk.TargetingSpecOperationGender);
    });
