...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.TargetingTemplateGetResponseData();
  });
  ...
  describe('TargetingTemplateGetResponseData', function() {
    it('should create an instance of TargetingTemplateGetResponseData', function() {
      // uncomment below and update the code to test TargetingTemplateGetResponseData
      //var instance = new PinterestSdk.TargetingTemplateGetResponseData();
      //expect(instance).to.be.a(PinterestSdk.TargetingTemplateGetResponseData);
    });
