...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.ConversionEventsUserDataAnyOf2();
  });
  ...
  describe('ConversionEventsUserDataAnyOf2', function() {
    it('should create an instance of ConversionEventsUserDataAnyOf2', function() {
      // uncomment below and update the code to test ConversionEventsUserDataAnyOf2
      //var instance = new PinterestSdk.ConversionEventsUserDataAnyOf2();
      //expect(instance).to.be.a(PinterestSdk.ConversionEventsUserDataAnyOf2);
    });
