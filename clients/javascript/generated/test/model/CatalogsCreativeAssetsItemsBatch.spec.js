...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.CatalogsCreativeAssetsItemsBatch();
  });
  ...
  describe('CatalogsCreativeAssetsItemsBatch', function() {
    it('should create an instance of CatalogsCreativeAssetsItemsBatch', function() {
      // uncomment below and update the code to test CatalogsCreativeAssetsItemsBatch
      //var instance = new PinterestSdk.CatalogsCreativeAssetsItemsBatch();
      //expect(instance).to.be.a(PinterestSdk.CatalogsCreativeAssetsItemsBatch);
    });
