...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.BulkUpsertRequest();
  });
  ...
  describe('BulkUpsertRequest', function() {
    it('should create an instance of BulkUpsertRequest', function() {
      // uncomment below and update the code to test BulkUpsertRequest
      //var instance = new PinterestSdk.BulkUpsertRequest();
      //expect(instance).to.be.a(PinterestSdk.BulkUpsertRequest);
    });
