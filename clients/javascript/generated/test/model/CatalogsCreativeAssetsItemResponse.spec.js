...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.CatalogsCreativeAssetsItemResponse();
  });
  ...
  describe('CatalogsCreativeAssetsItemResponse', function() {
    it('should create an instance of CatalogsCreativeAssetsItemResponse', function() {
      // uncomment below and update the code to test CatalogsCreativeAssetsItemResponse
      //var instance = new PinterestSdk.CatalogsCreativeAssetsItemResponse();
      //expect(instance).to.be.a(PinterestSdk.CatalogsCreativeAssetsItemResponse);
    });
