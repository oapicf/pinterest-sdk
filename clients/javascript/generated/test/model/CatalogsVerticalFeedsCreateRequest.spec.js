...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.CatalogsVerticalFeedsCreateRequest();
  });
  ...
  describe('CatalogsVerticalFeedsCreateRequest', function() {
    it('should create an instance of CatalogsVerticalFeedsCreateRequest', function() {
      // uncomment below and update the code to test CatalogsVerticalFeedsCreateRequest
      //var instance = new PinterestSdk.CatalogsVerticalFeedsCreateRequest();
      //expect(instance).to.be.a(PinterestSdk.CatalogsVerticalFeedsCreateRequest);
    });
