...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.AnyOf();
  });
  ...
  describe('AnyOf', function() {
    it('should create an instance of AnyOf', function() {
      // uncomment below and update the code to test AnyOf
      //var instance = new PinterestSdk.AnyOf();
      //expect(instance).to.be.a(PinterestSdk.AnyOf);
    });
