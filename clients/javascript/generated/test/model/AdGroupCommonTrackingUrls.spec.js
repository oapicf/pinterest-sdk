...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.AdGroupCommonTrackingUrls();
  });
  ...
  describe('AdGroupCommonTrackingUrls', function() {
    it('should create an instance of AdGroupCommonTrackingUrls', function() {
      // uncomment below and update the code to test AdGroupCommonTrackingUrls
      //var instance = new PinterestSdk.AdGroupCommonTrackingUrls();
      //expect(instance).to.be.a(PinterestSdk.AdGroupCommonTrackingUrls);
    });
