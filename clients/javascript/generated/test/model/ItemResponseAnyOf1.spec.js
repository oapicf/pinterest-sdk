...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.ItemResponseAnyOf1();
  });
  ...
  describe('ItemResponseAnyOf1', function() {
    it('should create an instance of ItemResponseAnyOf1', function() {
      // uncomment below and update the code to test ItemResponseAnyOf1
      //var instance = new PinterestSdk.ItemResponseAnyOf1();
      //expect(instance).to.be.a(PinterestSdk.ItemResponseAnyOf1);
    });
