...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.AudienceCommon();
  });
  ...
  describe('AudienceCommon', function() {
    it('should create an instance of AudienceCommon', function() {
      // uncomment below and update the code to test AudienceCommon
      //var instance = new PinterestSdk.AudienceCommon();
      //expect(instance).to.be.a(PinterestSdk.AudienceCommon);
    });
