...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.LeadSubscriptionPostParamsCreate();
  });
  ...
  describe('LeadSubscriptionPostParamsCreate', function() {
    it('should create an instance of LeadSubscriptionPostParamsCreate', function() {
      // uncomment below and update the code to test LeadSubscriptionPostParamsCreate
      //var instance = new PinterestSdk.LeadSubscriptionPostParamsCreate();
      //expect(instance).to.be.a(PinterestSdk.LeadSubscriptionPostParamsCreate);
    });
