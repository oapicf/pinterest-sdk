...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.CreateMMMReportRequest();
  });
  ...
  describe('CreateMMMReportRequest', function() {
    it('should create an instance of CreateMMMReportRequest', function() {
      // uncomment below and update the code to test CreateMMMReportRequest
