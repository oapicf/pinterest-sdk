...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.FeedsUpdateRequest();
  });
  ...
  describe('FeedsUpdateRequest', function() {
    it('should create an instance of FeedsUpdateRequest', function() {
      // uncomment below and update the code to test FeedsUpdateRequest
      //var instance = new PinterestSdk.FeedsUpdateRequest();
      //expect(instance).to.be.a(PinterestSdk.FeedsUpdateRequest);
    });
