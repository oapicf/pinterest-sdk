...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.ConversionEventsUserDataAnyOf1();
  });
  ...
  describe('ConversionEventsUserDataAnyOf1', function() {
    it('should create an instance of ConversionEventsUserDataAnyOf1', function() {
      // uncomment below and update the code to test ConversionEventsUserDataAnyOf1
      //var instance = new PinterestSdk.ConversionEventsUserDataAnyOf1();
      //expect(instance).to.be.a(PinterestSdk.ConversionEventsUserDataAnyOf1);
    });
