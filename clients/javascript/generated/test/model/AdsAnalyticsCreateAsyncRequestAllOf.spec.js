...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.AdsAnalyticsCreateAsyncRequestAllOf();
  });
  ...
  describe('AdsAnalyticsCreateAsyncRequestAllOf', function() {
    it('should create an instance of AdsAnalyticsCreateAsyncRequestAllOf', function() {
      ...
      //var instance = new PinterestSdk.AdsAnalyticsCreateAsyncRequestAllOf();
      //expect(instance).to.be.a(PinterestSdk.AdsAnalyticsCreateAsyncRequestAllOf);
    });
