...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.CatalogsHotelFilterValuesMap();
  });
  ...
  describe('CatalogsHotelFilterValuesMap', function() {
    it('should create an instance of CatalogsHotelFilterValuesMap', function() {
      // uncomment below and update the code to test CatalogsHotelFilterValuesMap
      //var instance = new PinterestSdk.CatalogsHotelFilterValuesMap();
      //expect(instance).to.be.a(PinterestSdk.CatalogsHotelFilterValuesMap);
    });
