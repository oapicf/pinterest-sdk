...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.CatalogsProductGroupPricingCriteria();
  });
  ...
  describe('CatalogsProductGroupPricingCriteria', function() {
    it('should create an instance of CatalogsProductGroupPricingCriteria', function() {
      ...
      //var instance = new PinterestSdk.CatalogsProductGroupPricingCriteria();
      //expect(instance).to.be.a(PinterestSdk.CatalogsProductGroupPricingCriteria);
    });
