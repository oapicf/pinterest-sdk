...
(function(root, factory) {
  ...
  describe('CampaignCreateResponseData', function() {
    ...
    it('should have the property isPerformancePlus (base name: "is_performance_plus")', function() {
      // uncomment below and update the code to test the property isPerformancePlus
      //var instance = new PinterestSdk.CampaignCreateResponseData();
      //expect(instance).to.be();
    });
