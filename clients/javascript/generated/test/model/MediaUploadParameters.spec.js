...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.MediaUploadParameters();
  });
  ...
  describe('MediaUploadParameters', function() {
    it('should create an instance of MediaUploadParameters', function() {
      // uncomment below and update the code to test MediaUploadParameters
      //var instance = new PinterestSdk.MediaUploadParameters();
      //expect(instance).to.be.a(PinterestSdk.MediaUploadParameters);
    });
