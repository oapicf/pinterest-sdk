...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.AdCreateRequest();
  });
  ...
  describe('AdCreateRequest', function() {
    it('should create an instance of AdCreateRequest', function() {
      // uncomment below and update the code to test AdCreateRequest
      //var instance = new PinterestSdk.AdCreateRequest();
      //expect(instance).to.be.a(PinterestSdk.AdCreateRequest);
    });
