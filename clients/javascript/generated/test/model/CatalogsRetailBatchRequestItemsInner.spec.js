...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.CatalogsRetailBatchRequestItemsInner();
  });
  ...
  describe('CatalogsRetailBatchRequestItemsInner', function() {
    it('should create an instance of CatalogsRetailBatchRequestItemsInner', function() {
      // uncomment below and update the code to test CatalogsRetailBatchRequestItemsInner
      //var instance = new PinterestSdk.CatalogsRetailBatchRequestItemsInner();
      //expect(instance).to.be.a(PinterestSdk.CatalogsRetailBatchRequestItemsInner);
    });
