...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.UpdatePartnerAssetsResult();
  });
  ...
  describe('UpdatePartnerAssetsResult', function() {
    it('should create an instance of UpdatePartnerAssetsResult', function() {
      // uncomment below and update the code to test UpdatePartnerAssetsResult
      //var instance = new PinterestSdk.UpdatePartnerAssetsResult();
      //expect(instance).to.be.a(PinterestSdk.UpdatePartnerAssetsResult);
    });
