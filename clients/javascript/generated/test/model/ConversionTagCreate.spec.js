...
(function(root, factory) {
  ...
  describe('ConversionTagCreate', function() {
    ...
    it('should have the property aemExternalIdEnabled (base name: "aem_external_id_enabled")', function() {
      // uncomment below and update the code to test the property aemExternalIdEnabled
      //var instance = new PinterestSdk.ConversionTagCreate();
      //expect(instance).to.be();
    });
