...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.MultipleProductGroupsInner();
  });
  ...
  describe('MultipleProductGroupsInner', function() {
    it('should create an instance of MultipleProductGroupsInner', function() {
      // uncomment below and update the code to test MultipleProductGroupsInner
      //var instance = new PinterestSdk.MultipleProductGroupsInner();
      //expect(instance).to.be.a(PinterestSdk.MultipleProductGroupsInner);
    });
