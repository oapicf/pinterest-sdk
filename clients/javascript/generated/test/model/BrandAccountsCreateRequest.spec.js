...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.BrandAccountsCreateRequest();
  });
  ...
  describe('BrandAccountsCreateRequest', function() {
    it('should create an instance of BrandAccountsCreateRequest', function() {
      // uncomment below and update the code to test BrandAccountsCreateRequest
      //var instance = new PinterestSdk.BrandAccountsCreateRequest();
      //expect(instance).to.be.a(PinterestSdk.BrandAccountsCreateRequest);
    });
