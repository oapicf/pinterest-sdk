...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.InviteBusinessRoleBinding();
  });
  ...
  describe('InviteBusinessRoleBinding', function() {
    it('should create an instance of InviteBusinessRoleBinding', function() {
      // uncomment below and update the code to test InviteBusinessRoleBinding
