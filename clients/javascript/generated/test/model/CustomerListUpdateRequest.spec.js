...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.CustomerListUpdateRequest();
  });
  ...
  describe('CustomerListUpdateRequest', function() {
    it('should create an instance of CustomerListUpdateRequest', function() {
      // uncomment below and update the code to test CustomerListUpdateRequest
      //var instance = new PinterestSdk.CustomerListUpdateRequest();
      //expect(instance).to.be.a(PinterestSdk.CustomerListUpdateRequest);
    });
