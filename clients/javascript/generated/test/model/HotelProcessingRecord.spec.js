...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.HotelProcessingRecord();
  });
  ...
  describe('HotelProcessingRecord', function() {
    it('should create an instance of HotelProcessingRecord', function() {
      // uncomment below and update the code to test HotelProcessingRecord
      //var instance = new PinterestSdk.HotelProcessingRecord();
      //expect(instance).to.be.a(PinterestSdk.HotelProcessingRecord);
    });
