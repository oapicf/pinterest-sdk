...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.DeletePartnerAssetAccessBodyAccessesInner();
  });
  ...
  describe('DeletePartnerAssetAccessBodyAccessesInner', function() {
    it('should create an instance of DeletePartnerAssetAccessBodyAccessesInner', function() {
      // uncomment below and update the code to test DeletePartnerAssetAccessBodyAccessesInner
      //var instance = new PinterestSdk.DeletePartnerAssetAccessBodyAccessesInner();
      //expect(instance).to.be.a(PinterestSdk.DeletePartnerAssetAccessBodyAccessesInner);
    });
