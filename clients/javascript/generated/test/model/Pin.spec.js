...
(function(root, factory) {
  ...
  describe('Pin', function() {
    ...
    it('should have the property hasBeenPromoted (base name: "has_been_promoted")', function() {
      // uncomment below and update the code to test the property hasBeenPromoted
      //var instance = new PinterestSdk.Pin();
      //expect(instance).to.be();
    });
    ...
    it('should have the property pinMetrics (base name: "pin_metrics")', function() {
      // uncomment below and update the code to test the property pinMetrics
      //var instance = new PinterestSdk.Pin();
      //expect(instance).to.be();
    });
