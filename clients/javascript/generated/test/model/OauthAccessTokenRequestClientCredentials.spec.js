...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.OauthAccessTokenRequestClientCredentials();
  });
  ...
  describe('OauthAccessTokenRequestClientCredentials', function() {
    it('should create an instance of OauthAccessTokenRequestClientCredentials', function() {
      // uncomment below and update the code to test OauthAccessTokenRequestClientCredentials
