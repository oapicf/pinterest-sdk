...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.CatalogsProductGroupProductCountsVertical();
  });
  ...
  describe('CatalogsProductGroupProductCountsVertical', function() {
    it('should create an instance of CatalogsProductGroupProductCountsVertical', function() {
      // uncomment below and update the code to test CatalogsProductGroupProductCountsVertical
      //var instance = new PinterestSdk.CatalogsProductGroupProductCountsVertical();
      //expect(instance).to.be.a(PinterestSdk.CatalogsProductGroupProductCountsVertical);
    });
