...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.CatalogsCreativeAssetsFeedsCreateRequest();
  });
  ...
  describe('CatalogsCreativeAssetsFeedsCreateRequest', function() {
    it('should create an instance of CatalogsCreativeAssetsFeedsCreateRequest', function() {
      // uncomment below and update the code to test CatalogsCreativeAssetsFeedsCreateRequest
      //var instance = new PinterestSdk.CatalogsCreativeAssetsFeedsCreateRequest();
      //expect(instance).to.be.a(PinterestSdk.CatalogsCreativeAssetsFeedsCreateRequest);
    });
