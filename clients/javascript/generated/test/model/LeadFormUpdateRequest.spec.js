...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.LeadFormUpdateRequest();
  });
  ...
  describe('LeadFormUpdateRequest', function() {
    it('should create an instance of LeadFormUpdateRequest', function() {
      // uncomment below and update the code to test LeadFormUpdateRequest
      //var instance = new PinterestSdk.LeadFormUpdateRequest();
      //expect(instance).to.be.a(PinterestSdk.LeadFormUpdateRequest);
    });
