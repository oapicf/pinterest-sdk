...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.CatalogsRetailItemResponse();
  });
  ...
  describe('CatalogsRetailItemResponse', function() {
    it('should create an instance of CatalogsRetailItemResponse', function() {
      // uncomment below and update the code to test CatalogsRetailItemResponse
      //var instance = new PinterestSdk.CatalogsRetailItemResponse();
      //expect(instance).to.be.a(PinterestSdk.CatalogsRetailItemResponse);
    });
