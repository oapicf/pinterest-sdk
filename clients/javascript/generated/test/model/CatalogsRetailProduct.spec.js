...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.CatalogsRetailProduct();
  });
  ...
  describe('CatalogsRetailProduct', function() {
    it('should create an instance of CatalogsRetailProduct', function() {
      // uncomment below and update the code to test CatalogsRetailProduct
      //var instance = new PinterestSdk.CatalogsRetailProduct();
      //expect(instance).to.be.a(PinterestSdk.CatalogsRetailProduct);
    });
