...
(function(root, factory) {
  ...
  describe('AdsAnalyticsCreateAsyncRequest', function() {
    ...
    it('should have the property campaignBrandLabel (base name: "campaign_brand_label")', function() {
      // uncomment below and update the code to test the property campaignBrandLabel
      //var instance = new PinterestSdk.AdsAnalyticsCreateAsyncRequest();
      //expect(instance).to.be();
    });
    ...
    it('should have the property combineTargetingTypes (base name: "combine_targeting_types")', function() {
      // uncomment below and update the code to test the property combineTargetingTypes
      //var instance = new PinterestSdk.AdsAnalyticsCreateAsyncRequest();
      //expect(instance).to.be();
    });

    it('should have the property customConversionEventMetrics (base name: "custom_conversion_event_metrics")', function() {
      // uncomment below and update the code to test the property customConversionEventMetrics
      //var instance = new PinterestSdk.AdsAnalyticsCreateAsyncRequest();
      //expect(instance).to.be();
    });
    ...
    it('should have the property reportingTimezone (base name: "reporting_timezone")', function() {
