...
(function(root, factory) {
  ...
  describe('ConversionTagConfigs', function() {
    ...
    it('should have the property noCodeCapiDomains (base name: "no_code_capi_domains")', function() {
      // uncomment below and update the code to test the property noCodeCapiDomains
      //var instance = new PinterestSdk.ConversionTagConfigs();
      //expect(instance).to.be();
    });
