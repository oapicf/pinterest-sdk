...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.CatalogsProductGroupProductCounts();
  });
  ...
  describe('CatalogsProductGroupProductCounts', function() {
    it('should create an instance of CatalogsProductGroupProductCounts', function() {
      // uncomment below and update the code to test CatalogsProductGroupProductCounts
      //var instance = new PinterestSdk.CatalogsProductGroupProductCounts();
      //expect(instance).to.be.a(PinterestSdk.CatalogsProductGroupProductCounts);
    });
