...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.CatalogsCreativeAssetsProductGroup();
  });
  ...
  describe('CatalogsCreativeAssetsProductGroup', function() {
    it('should create an instance of CatalogsCreativeAssetsProductGroup', function() {
      // uncomment below and update the code to test CatalogsCreativeAssetsProductGroup
      //var instance = new PinterestSdk.CatalogsCreativeAssetsProductGroup();
      //expect(instance).to.be.a(PinterestSdk.CatalogsCreativeAssetsProductGroup);
    });
