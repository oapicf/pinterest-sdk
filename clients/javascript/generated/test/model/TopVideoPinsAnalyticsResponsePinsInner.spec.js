...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.TopVideoPinsAnalyticsResponsePinsInner();
  });
  ...
  describe('TopVideoPinsAnalyticsResponsePinsInner', function() {
    it('should create an instance of TopVideoPinsAnalyticsResponsePinsInner', function() {
      // uncomment below and update the code to test TopVideoPinsAnalyticsResponsePinsInner
      //var instance = new PinterestSdk.TopVideoPinsAnalyticsResponsePinsInner();
      //expect(instance).to.be.a(PinterestSdk.TopVideoPinsAnalyticsResponsePinsInner);
    });
