...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.AllOf();
  });
  ...
  describe('AllOf', function() {
    it('should create an instance of AllOf', function() {
      // uncomment below and update the code to test AllOf
      //var instance = new PinterestSdk.AllOf();
      //expect(instance).to.be.a(PinterestSdk.AllOf);
    });
