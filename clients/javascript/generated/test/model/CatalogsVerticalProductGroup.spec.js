...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.CatalogsVerticalProductGroup();
  });
  ...
  describe('CatalogsVerticalProductGroup', function() {
    it('should create an instance of CatalogsVerticalProductGroup', function() {
      // uncomment below and update the code to test CatalogsVerticalProductGroup
      //var instance = new PinterestSdk.CatalogsVerticalProductGroup();
      //expect(instance).to.be.a(PinterestSdk.CatalogsVerticalProductGroup);
    });
