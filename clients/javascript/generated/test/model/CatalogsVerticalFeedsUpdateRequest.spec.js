...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.CatalogsVerticalFeedsUpdateRequest();
  });
  ...
  describe('CatalogsVerticalFeedsUpdateRequest', function() {
    it('should create an instance of CatalogsVerticalFeedsUpdateRequest', function() {
      // uncomment below and update the code to test CatalogsVerticalFeedsUpdateRequest
      //var instance = new PinterestSdk.CatalogsVerticalFeedsUpdateRequest();
      //expect(instance).to.be.a(PinterestSdk.CatalogsVerticalFeedsUpdateRequest);
    });
