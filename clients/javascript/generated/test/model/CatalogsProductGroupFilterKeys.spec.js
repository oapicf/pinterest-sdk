...
(function(root, factory) {
  ...
  describe('CatalogsProductGroupFilterKeys', function() {
    ...
    it('should have the property PRODUCT_GROUP (base name: "PRODUCT_GROUP")', function() {
      // uncomment below and update the code to test the property PRODUCT_GROUP
      //var instance = new PinterestSdk.CatalogsProductGroupFilterKeys();
      //expect(instance).to.be();
    });
    ...
    it('should have the property TITLE_KEYWORDS (base name: "TITLE_KEYWORDS")', function() {
      // uncomment below and update the code to test the property TITLE_KEYWORDS
      //var instance = new PinterestSdk.CatalogsProductGroupFilterKeys();
      //expect(instance).to.be();
    });
