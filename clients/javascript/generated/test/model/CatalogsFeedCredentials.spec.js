...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.CatalogsFeedCredentials();
  });
  ...
  describe('CatalogsFeedCredentials', function() {
    it('should create an instance of CatalogsFeedCredentials', function() {
      ...
      //var instance = new PinterestSdk.CatalogsFeedCredentials();
      //expect(instance).to.be.a(PinterestSdk.CatalogsFeedCredentials);
    });
