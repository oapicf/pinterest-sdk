...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.CustomerListUpload();
  });
  ...
  describe('CustomerListUpload', function() {
    it('should create an instance of CustomerListUpload', function() {
      // uncomment below and update the code to test CustomerListUpload
      //var instance = new PinterestSdk.CustomerListUpload();
      //expect(instance).to.be.a(PinterestSdk.CustomerListUpload);
    });
