...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.S3FilePart();
  });
  ...
  describe('S3FilePart', function() {
    it('should create an instance of S3FilePart', function() {
      // uncomment below and update the code to test S3FilePart
      //var instance = new PinterestSdk.S3FilePart();
      //expect(instance).to.be.a(PinterestSdk.S3FilePart);
    });
