...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.AdAccountCreateSubscriptionResponse();
  });
  ...
  describe('AdAccountCreateSubscriptionResponse', function() {
    it('should create an instance of AdAccountCreateSubscriptionResponse', function() {
      // uncomment below and update the code to test AdAccountCreateSubscriptionResponse
      //var instance = new PinterestSdk.AdAccountCreateSubscriptionResponse();
      //expect(instance).to.be.a(PinterestSdk.AdAccountCreateSubscriptionResponse);
    });
