...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.CatalogsHotelBatchItem();
  });
  ...
  describe('CatalogsHotelBatchItem', function() {
    it('should create an instance of CatalogsHotelBatchItem', function() {
      // uncomment below and update the code to test CatalogsHotelBatchItem
      //var instance = new PinterestSdk.CatalogsHotelBatchItem();
      //expect(instance).to.be.a(PinterestSdk.CatalogsHotelBatchItem);
    });
