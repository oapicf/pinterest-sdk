...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.CampaignCreateRequest();
  });
  ...
  describe('CampaignCreateRequest', function() {
    it('should create an instance of CampaignCreateRequest', function() {
      // uncomment below and update the code to test CampaignCreateRequest
      //var instance = new PinterestSdk.CampaignCreateRequest();
      //expect(instance).to.be.a(PinterestSdk.CampaignCreateRequest);
    });
