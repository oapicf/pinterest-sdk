...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.CatalogsCreativeAssetsFeedsUpdateRequest();
  });
  ...
  describe('CatalogsCreativeAssetsFeedsUpdateRequest', function() {
    it('should create an instance of CatalogsCreativeAssetsFeedsUpdateRequest', function() {
      // uncomment below and update the code to test CatalogsCreativeAssetsFeedsUpdateRequest
      //var instance = new PinterestSdk.CatalogsCreativeAssetsFeedsUpdateRequest();
      //expect(instance).to.be.a(PinterestSdk.CatalogsCreativeAssetsFeedsUpdateRequest);
    });
