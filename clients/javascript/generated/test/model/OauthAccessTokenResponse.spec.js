...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.OauthAccessTokenResponse();
  });
  ...
  describe('OauthAccessTokenResponse', function() {
    it('should create an instance of OauthAccessTokenResponse', function() {
      ...
      //var instance = new PinterestSdk.OauthAccessTokenResponse();
      //expect(instance).to.be.a(PinterestSdk.OauthAccessTokenResponse);
    });
