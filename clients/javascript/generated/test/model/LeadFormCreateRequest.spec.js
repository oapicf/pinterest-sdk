...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.LeadFormCreateRequest();
  });
  ...
  describe('LeadFormCreateRequest', function() {
    it('should create an instance of LeadFormCreateRequest', function() {
      // uncomment below and update the code to test LeadFormCreateRequest
      //var instance = new PinterestSdk.LeadFormCreateRequest();
      //expect(instance).to.be.a(PinterestSdk.LeadFormCreateRequest);
    });
