...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.AdvancedAuctionItemsSubmitUpsertRecord();
  });
  ...
  describe('AdvancedAuctionItemsSubmitUpsertRecord', function() {
    it('should create an instance of AdvancedAuctionItemsSubmitUpsertRecord', function() {
      // uncomment below and update the code to test AdvancedAuctionItemsSubmitUpsertRecord
      //var instance = new PinterestSdk.AdvancedAuctionItemsSubmitUpsertRecord();
      //expect(instance).to.be.a(PinterestSdk.AdvancedAuctionItemsSubmitUpsertRecord);
    });
