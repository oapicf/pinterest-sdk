...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.CatalogsHotelFeed();
  });
  ...
  describe('CatalogsHotelFeed', function() {
    it('should create an instance of CatalogsHotelFeed', function() {
      // uncomment below and update the code to test CatalogsHotelFeed
      //var instance = new PinterestSdk.CatalogsHotelFeed();
      //expect(instance).to.be.a(PinterestSdk.CatalogsHotelFeed);
    });
