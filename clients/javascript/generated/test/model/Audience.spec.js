...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.Audience();
  });
  ...
  describe('Audience', function() {
    it('should create an instance of Audience', function() {
      // uncomment below and update the code to test Audience
      //var instance = new PinterestSdk.Audience();
      //expect(instance).to.be.a(PinterestSdk.Audience);
    });
    ...
    it('should have the property audienceType (base name: "audience_type")', function() {
      // uncomment below and update the code to test the property audienceType
      //var instance = new PinterestSdk.Audience();
      //expect(instance).to.be();
    });

    it('should have the property createdByCompanyName (base name: "created_by_company_name")', function() {
      // uncomment below and update the code to test the property createdByCompanyName
      //var instance = new PinterestSdk.Audience();
      //expect(instance).to.be();
    });
