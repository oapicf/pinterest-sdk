...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.CatalogsRetailFeedsCreateRequest();
  });
  ...
  describe('CatalogsRetailFeedsCreateRequest', function() {
    it('should create an instance of CatalogsRetailFeedsCreateRequest', function() {
      // uncomment below and update the code to test CatalogsRetailFeedsCreateRequest
      //var instance = new PinterestSdk.CatalogsRetailFeedsCreateRequest();
      //expect(instance).to.be.a(PinterestSdk.CatalogsRetailFeedsCreateRequest);
    });
