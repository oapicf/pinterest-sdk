...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.OrderLines();
  });
  ...
  describe('OrderLines', function() {
    it('should create an instance of OrderLines', function() {
      // uncomment below and update the code to test OrderLines
      //var instance = new PinterestSdk.OrderLines();
      //expect(instance).to.be.a(PinterestSdk.OrderLines);
    });
