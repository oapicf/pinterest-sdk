...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.ConversionEventsUserDataProperties();
  });
  ...
  describe('ConversionEventsUserDataProperties', function() {
    it('should create an instance of ConversionEventsUserDataProperties', function() {
      // uncomment below and update the code to test ConversionEventsUserDataProperties
      //var instance = new PinterestSdk.ConversionEventsUserDataProperties();
      //expect(instance).to.be.a(PinterestSdk.ConversionEventsUserDataProperties);
    });
