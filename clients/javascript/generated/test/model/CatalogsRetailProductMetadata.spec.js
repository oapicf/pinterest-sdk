...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.CatalogsRetailProductMetadata();
  });
  ...
  describe('CatalogsRetailProductMetadata', function() {
    it('should create an instance of CatalogsRetailProductMetadata', function() {
      // uncomment below and update the code to test CatalogsRetailProductMetadata
      //var instance = new PinterestSdk.CatalogsRetailProductMetadata();
      //expect(instance).to.be.a(PinterestSdk.CatalogsRetailProductMetadata);
    });
