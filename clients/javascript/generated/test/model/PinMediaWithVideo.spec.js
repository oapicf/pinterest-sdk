...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.PinMediaWithVideo();
  });
  ...
  describe('PinMediaWithVideo', function() {
    it('should create an instance of PinMediaWithVideo', function() {
      // uncomment below and update the code to test PinMediaWithVideo
      //var instance = new PinterestSdk.PinMediaWithVideo();
      //expect(instance).to.be.a(PinterestSdk.PinMediaWithVideo);
    });
