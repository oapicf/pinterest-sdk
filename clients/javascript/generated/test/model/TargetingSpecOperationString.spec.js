...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.TargetingSpecOperationString();
  });
  ...
  describe('TargetingSpecOperationString', function() {
    it('should create an instance of TargetingSpecOperationString', function() {
      // uncomment below and update the code to test TargetingSpecOperationString
      //var instance = new PinterestSdk.TargetingSpecOperationString();
      //expect(instance).to.be.a(PinterestSdk.TargetingSpecOperationString);
    });
