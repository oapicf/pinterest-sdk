...
(function(root, factory) {
  ...
  describe('PinMediaSourceVideoID', function() {
    ...
    it('should have the property coverImageKeyFrameTime (base name: "cover_image_key_frame_time")', function() {
      // uncomment below and update the code to test the property coverImageKeyFrameTime
      //var instance = new PinterestSdk.PinMediaSourceVideoID();
      //expect(instance).to.be();
    });
