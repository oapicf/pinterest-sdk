...
(function(root, factory) {
  ...
  describe('Account', function() {
    ...
    it('should have the property boardCount (base name: "board_count")', function() {
      // uncomment below and update the code to test the property boardCount
      //var instance = new PinterestSdk.Account();
      //expect(instance).to.be();
    });
    ...
    it('should have the property monthlyViews (base name: "monthly_views")', function() {
      // uncomment below and update the code to test the property monthlyViews
      //var instance = new PinterestSdk.Account();
      //expect(instance).to.be();
    });
