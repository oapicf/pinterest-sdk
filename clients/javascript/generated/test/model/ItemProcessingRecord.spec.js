...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.ItemProcessingRecord();
  });
  ...
  describe('ItemProcessingRecord', function() {
    it('should create an instance of ItemProcessingRecord', function() {
      ...
      //var instance = new PinterestSdk.ItemProcessingRecord();
      //expect(instance).to.be.a(PinterestSdk.ItemProcessingRecord);
    });
