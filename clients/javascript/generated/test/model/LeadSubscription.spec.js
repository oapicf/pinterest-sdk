...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.LeadSubscription();
  });
  ...
  describe('LeadSubscription', function() {
    it('should create an instance of LeadSubscription', function() {
      // uncomment below and update the code to test LeadSubscription
      //var instance = new PinterestSdk.LeadSubscription();
      //expect(instance).to.be.a(PinterestSdk.LeadSubscription);
    });
