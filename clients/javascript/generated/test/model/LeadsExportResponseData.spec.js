...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.LeadsExportResponseData();
  });
  ...
  describe('LeadsExportResponseData', function() {
    it('should create an instance of LeadsExportResponseData', function() {
      // uncomment below and update the code to test LeadsExportResponseData
      //var instance = new PinterestSdk.LeadsExportResponseData();
      //expect(instance).to.be.a(PinterestSdk.LeadsExportResponseData);
    });
