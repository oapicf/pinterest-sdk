...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.CatalogsHotelProductGroupCreateRequest();
  });
  ...
  describe('CatalogsHotelProductGroupCreateRequest', function() {
    it('should create an instance of CatalogsHotelProductGroupCreateRequest', function() {
      // uncomment below and update the code to test CatalogsHotelProductGroupCreateRequest
      //var instance = new PinterestSdk.CatalogsHotelProductGroupCreateRequest();
      //expect(instance).to.be.a(PinterestSdk.CatalogsHotelProductGroupCreateRequest);
    });
