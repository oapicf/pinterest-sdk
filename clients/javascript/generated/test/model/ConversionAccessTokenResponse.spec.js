...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.ConversionAccessTokenResponse();
  });
  ...
  describe('ConversionAccessTokenResponse', function() {
    it('should create an instance of ConversionAccessTokenResponse', function() {
      // uncomment below and update the code to test ConversionAccessTokenResponse
      //var instance = new PinterestSdk.ConversionAccessTokenResponse();
      //expect(instance).to.be.a(PinterestSdk.ConversionAccessTokenResponse);
    });
