...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PinterestSdk.QualityComponentDetails();
  });
  ...
  describe('QualityComponentDetails', function() {
    it('should create an instance of QualityComponentDetails', function() {
      // uncomment below and update the code to test QualityComponentDetails
      //var instance = new PinterestSdk.QualityComponentDetails();
      //expect(instance).to.be.a(PinterestSdk.QualityComponentDetails);
    });
