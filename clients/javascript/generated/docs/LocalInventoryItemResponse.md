# PinterestSdk.LocalInventoryItemResponse
...
**createdAt** | **Number** | The millisecond timestamp when the local inventory item was created | 
**itemId** | **String** | The catalog item id in the merchant namespace | 
**lastUpdatedTime** | **Number** | The millisecond timestamp when the local inventory item was lastly modified by the merchant. | 
