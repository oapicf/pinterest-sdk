# PinterestSdk.SchedulesCreate200ResponseInnerData
...
**endTimestamp** | **Number** | Schedule end time. Unix timestamp in seconds. | [optional] 
...
**startTimestamp** | **Number** | Schedule start time. Unix timestamp in seconds. | [optional] 
**id** | **String** |  | 
