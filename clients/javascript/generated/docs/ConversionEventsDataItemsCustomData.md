# PinterestSdk.ConversionEventsDataItemsCustomData
...
**externalMeasurementVendorId** | **Number** | Only use when instructed. | [optional] 
...
**numItems** | **Number** | Total number of products of the event. For example, the total number of items purchased in a checkout event. We recommend using this if you are a merchant for AddToCart and Checkouts. For detail, please check [here](https://help.pinterest.com/en/business/article/before-you-get-started-with-catalogs) (Install the Pinterest tag section). | [optional] 
