...
**startTime** | **Number** | Ad group start time. Unix timestamp in seconds. Defaults to current time. | [optional] 
**endTime** | **Number** | Ad group end time. Unix timestamp in seconds. | [optional] 
...
* `AUTOMATIC_BID` (value: `"AUTOMATIC_BID"`)

* `MAX_BID` (value: `"MAX_BID"`)

* `TARGET_AVG` (value: `"TARGET_AVG"`)
