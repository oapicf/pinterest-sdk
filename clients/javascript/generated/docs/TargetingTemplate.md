# PinterestSdk.TargetingTemplate
...
**createdTime** | **Number** | Targeting template created time. Unix timestamp in seconds. | [optional] [readonly] 
...
**updatedTime** | **Number** | Targeting template updated time.Unix timestamp in seconds. | [optional] [readonly] 
