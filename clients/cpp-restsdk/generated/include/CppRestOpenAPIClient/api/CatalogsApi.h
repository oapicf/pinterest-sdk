...
public:
    ...
    pplx::task<std::shared_ptr<CatalogsVerticalProductGroup>> catalogsProductGroups_create(
        std::shared_ptr<Multiple_product_groups_inner> multipleProductGroupsInner,
        boost::optional<utility::string_t> adAccountId
    ) const;
    /// <summary>
    ...
    pplx::task<std::vector<utility::string_t>> catalogsProductGroups_createMany(
        std::vector<std::shared_ptr<Multiple_product_groups_inner>> multipleProductGroupsInner,
        boost::optional<utility::string_t> adAccountId
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<CatalogsVerticalProductGroup>> catalogsProductGroups_update(
        utility::string_t productGroupId,
        std::shared_ptr<Catalogs_product_groups_update_request> catalogsProductGroupsUpdateRequest,
        boost::optional<utility::string_t> adAccountId
    ) const;
    /// <summary>
    /// Create catalog
    ...
    /// <param name="adAccountId">Unique identifier of an ad account. (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    /// <param name="itemIds">This parameter is deprecated. Use filters instead. (optional, default to std::vector&lt;std::shared_ptr&lt;utility::string_t&gt;&gt;())</param>
    ...
    pplx::task<std::shared_ptr<CatalogsItems>> items_get(
        ...
        boost::optional<utility::string_t> adAccountId,
        boost::optional<std::vector<utility::string_t>> itemIds,
        boost::optional<std::shared_ptr<CatalogsItemsFilters>> filters
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<Reports_stats_200_response>> reports_stats(
        std::shared_ptr<CatalogsReportParameters> parameters,
        boost::optional<utility::string_t> adAccountId,
        boost::optional<int32_t> pageSize,
        boost::optional<utility::string_t> bookmark
    ) const;
