...
public:
    ...
    /// <param name="adAccountId">Unique identifier of an ad account. (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<Catalogs_product_groups_create_201_response>> catalogsProductGroups_create(
        std::shared_ptr<Catalogs_product_groups_create_request> catalogsProductGroupsCreateRequest,
        boost::optional<utility::string_t> adAccountId
    ) const;
    /// <summary>
    ...
    /// <param name="productGroupId">Unique identifier of a product group</param>
    /// <param name="adAccountId">Unique identifier of an ad account. (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<Catalogs_product_groups_create_201_response>> catalogsProductGroups_get(
        utility::string_t productGroupId,
        boost::optional<utility::string_t> adAccountId
    ) const;
    /// <summary>
    ...
    /// <param name="adAccountId">Unique identifier of an ad account. (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<Catalogs_product_groups_create_201_response>> catalogsProductGroups_update(
        utility::string_t productGroupId,
