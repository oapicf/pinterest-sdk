...
#include "CppRestOpenAPIClient/model/CancelInvitesResponse.h"
...
public:
    ...
    pplx::task<std::shared_ptr<CancelInvitesResponse>> cancelInvitesOrRequests(
        utility::string_t businessId,
        std::shared_ptr<CancelInvitesRequest> cancelInvitesRequest
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<Get_invites_200_response>> get_invites(
        ...
        boost::optional<std::vector<std::shared_ptr<InviteFilterStatus>>> inviteStatus,
