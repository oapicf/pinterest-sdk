...
public:
    ...
    pplx::task<std::shared_ptr<Audience_insights_scope_and_type_get_200_response>> audienceInsightsScopeAndType_get(
    ...
    pplx::task<std::shared_ptr<AudienceInsights>> audienceInsights_get(
        utility::string_t adAccountId,
