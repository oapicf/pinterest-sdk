...
public:
    ...
    pplx::task<std::shared_ptr<AdsAnalyticsCreateAsyncResponse>> analytics_createConversionProductReport(
        utility::string_t adAccountId,
        std::shared_ptr<ConversionProductReportRequest> conversionProductReportRequest
    ) const;
    /// <summary>
    ...
    /// <param name="granularity">   TOTAL - metrics are aggregated over the specified date range.    DAY - metrics are broken down daily.    HOUR - metrics are broken down hourly.    WEEKLY - metrics are broken down weekly.    MONTHLY - metrics are broken down monthly (optional, default to new Granularity())</param>
    ...
    pplx::task<std::shared_ptr<AdsAnalyticsGetAsyncResponse>> analytics_getConversionProductReport(
        utility::string_t adAccountId,
