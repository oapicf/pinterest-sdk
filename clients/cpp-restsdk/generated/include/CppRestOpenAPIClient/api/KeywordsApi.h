...
#include "CppRestOpenAPIClient/model/KeywordsUpdate.h"
...
public:
    ...
    pplx::task<std::shared_ptr<Keywords>> keywords_create(
        utility::string_t adAccountId,
        std::shared_ptr<KeywordsCreate> keywordsCreate
    ) const;
    /// <summary>
    /// Get keywords
    /// </summary>
    ...
    pplx::task<std::shared_ptr<Keywords>> keywords_update(
        utility::string_t adAccountId,
        std::shared_ptr<KeywordsUpdate> keywordsUpdate
    ) const;
    /// <summary>
    ...
    /// <param name="includeKeywords">If set, filters the results to top trends which include at least one of the specified keywords. If unset, no keyword filtering logic is applied. (optional, default to std::vector&lt;std::shared_ptr&lt;utility::string_t&gt;&gt;())</param>
    ...
    pplx::task<std::shared_ptr<TrendingKeywordsResponse>> trendingKeywords_list(
        ...
        boost::optional<std::vector<std::shared_ptr<TrendsL1Interest>>> interests,
        boost::optional<std::vector<std::shared_ptr<TrendsGenderFilter>>> genders,
        boost::optional<std::vector<std::shared_ptr<TrendsAgeBucket>>> ages,
        boost::optional<std::vector<utility::string_t>> includeKeywords,
        boost::optional<bool> normalizeAgainstGroup,
        boost::optional<int32_t> limit,
        boost::optional<bool> includeDemographics
    ) const;
