...
public:
    ...
    pplx::task<std::shared_ptr<ProductGroupPromotionResponse>> productGroupPromotions_create(
    ...
    pplx::task<std::shared_ptr<ProductGroupPromotionResponse>> productGroupPromotions_update(
        utility::string_t adAccountId,
