...
#include "CppRestOpenAPIClient/model/System_user_update_request.h"
...
public:
    ...
    pplx::task<std::shared_ptr<Brand_accounts_create_200_response>> brandAccounts_create(
        utility::string_t businessHierarchyId,
        std::shared_ptr<Brand_accounts_create_request> brandAccountsCreateRequest
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<Brand_accounts_create_200_response>> brandAccounts_update(
        utility::string_t businessHierarchyId,
        utility::string_t brandAccountId,
        std::shared_ptr<Brand_accounts_update_request> brandAccountsUpdateRequest
    ) const;
    /// <summary>
    ...
    pplx::task<void> systemUser_update(
        ...
        std::shared_ptr<System_user_update_request> systemUserUpdateRequest
    ) const;
    /// <summary>
