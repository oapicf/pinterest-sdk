...
public:
    ...
    /// </summary>
    enum class Conversion_learning_mode_typeEnum
    {
        NOT_ACTIVE,
        ACTIVE,
    };
    ...
    Conversion_learning_mode_typeEnum toConversion_learning_mode_typeEnum(const utility::string_t& value) const;
    const utility::string_t fromConversion_learning_mode_typeEnum(const Conversion_learning_mode_typeEnum value) const;
    ...
    /// oCPM learn mode
    /// </summary>
    Conversion_learning_mode_typeEnum getConversionLearningModeType() const;
    bool conversionLearningModeTypeIsSet() const;
    void unsetConversion_learning_mode_type();
    void setConversionLearningModeType(const Conversion_learning_mode_typeEnum value);
...
protected:
    ...
    boost::optional<Conversion_learning_mode_typeEnum> m_Conversion_learning_mode_type;
