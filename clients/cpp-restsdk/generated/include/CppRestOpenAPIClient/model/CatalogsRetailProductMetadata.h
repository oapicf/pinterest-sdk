...
public:
    ...
    void setAvailability(const std::shared_ptr<ProductAvailability>& value);
...
protected:
    std::shared_ptr<ProductAvailability> m_Availability;
    ...
    boost::optional<double> m_Sale_price;
