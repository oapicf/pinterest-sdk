...
public:
    ...
    /// 
    /// </summary>
    std::shared_ptr<TargetingSpec_1> getTargetingSpec() const;
    bool targetingSpecIsSet() const;
    void unsetTargeting_spec();

    void setTargetingSpec(const std::shared_ptr<TargetingSpec_1>& value);


protected:
    std::vector<std::shared_ptr<BidFloorSpec>> m_Bid_floor_specs;
    bool m_Bid_floor_specsIsSet;
    std::shared_ptr<TargetingSpec_1> m_Targeting_spec;
