...
protected:
    ...
    boost::optional<std::vector<Creative_typesEnum>> m_Creative_types;

    boost::optional<std::vector<std::shared_ptr<AdGroupAudienceSizingRequest_keywords_inner>>> m_Keywords;
