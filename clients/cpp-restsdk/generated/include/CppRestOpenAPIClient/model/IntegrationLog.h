...
public:
    ...
    void setEventType(const std::shared_ptr<IntegrationLogEventType>& value);
    ...
    void unsetLog_level();
    void setLogLevel(const std::shared_ptr<IntegrationLogLevel>& value);
...
protected:
    ...
    std::shared_ptr<IntegrationLogEventType> m_Event_type;
    ...
    std::shared_ptr<IntegrationLogLevel> m_Log_level;
