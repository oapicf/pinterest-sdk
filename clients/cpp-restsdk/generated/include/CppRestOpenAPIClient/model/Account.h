...
public:
    ...
    void setAccountType(const std::shared_ptr<UserAccountType>& value);
...
protected:
    ...
    std::shared_ptr<UserAccountType> m_Account_type;
    bool m_Account_typeIsSet;

    boost::optional<int32_t> m_Board_count;

    boost::optional<utility::string_t> m_Business_name;

    boost::optional<int32_t> m_Follower_count;

    boost::optional<int32_t> m_Following_count;

    utility::string_t m_Id;
    bool m_IdIsSet;

    boost::optional<int32_t> m_Monthly_views;

    boost::optional<int32_t> m_Pin_count;
