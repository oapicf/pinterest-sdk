...
public:
    ...
    /// </summary>
    std::vector<utility::string_t> getCatalogsIds() const;
    bool catalogsIdsIsSet() const;
    void unsetCatalogs_ids();
    void setCatalogsIds(const std::vector<utility::string_t>& value);
...
protected:
    ...
    boost::optional<std::vector<utility::string_t>> m_Catalogs_ids;
