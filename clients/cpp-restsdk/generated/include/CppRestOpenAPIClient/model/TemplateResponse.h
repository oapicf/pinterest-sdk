...
public:
    ...
    /// </summary>
    enum class Conversion_report_time_typeEnum
    {
        TIME_OF_AD_ACTION,
        TIME_OF_CONVERSION,
    };
    ...
    /// </summary>
    enum class Creation_sourceEnum
    {
        ADS_API,
    ...
    /// </summary>
    enum class Ingestion_sourcesEnum
    {
        TAG,
        MMP,
        FILE_UPLOAD,
    ...
    /// </summary>
    ColumnsEnum toColumnsEnum(const utility::string_t& value) const;
    const utility::string_t fromColumnsEnum(const ColumnsEnum value) const;
    std::vector<ColumnsEnum> toColumnsEnum(const std::vector<utility::string_t>& value) const;
    std::vector<utility::string_t> fromColumnsEnum(const std::vector<ColumnsEnum>& value) const;
    

    Conversion_report_time_typeEnum toConversion_report_time_typeEnum(const utility::string_t& value) const;
    const utility::string_t fromConversion_report_time_typeEnum(const Conversion_report_time_typeEnum value) const;


    Creation_sourceEnum toCreation_sourceEnum(const utility::string_t& value) const;
    const utility::string_t fromCreation_sourceEnum(const Creation_sourceEnum value) const;

    Ingestion_sourcesEnum toIngestion_sourcesEnum(const utility::string_t& value) const;
    const utility::string_t fromIngestion_sourcesEnum(const Ingestion_sourcesEnum value) const;
    std::vector<Ingestion_sourcesEnum> toIngestion_sourcesEnum(const std::vector<utility::string_t>& value) const;
    std::vector<utility::string_t> fromIngestion_sourcesEnum(const std::vector<Ingestion_sourcesEnum>& value) const;
    ...
    /// A list of columns to be included in the report
    /// </summary>
    std::vector<ColumnsEnum> getColumns() const;
    bool columnsIsSet() const;
    void unsetColumns();
    void setColumns(const std::vector<ColumnsEnum> value);

    /// <summary>
    /// Conversion report time type
    /// </summary>
    Conversion_report_time_typeEnum getConversionReportTimeType() const;
    bool conversionReportTimeTypeIsSet() const;
    void unsetConversion_report_time_type();
    void setConversionReportTimeType(const Conversion_report_time_typeEnum value);

    /// <summary>
    /// The surface used to create this template
    /// </summary>
    Creation_sourceEnum getCreationSource() const;
    bool creationSourceIsSet() const;
    void unsetCreation_source();
    void setCreationSource(const Creation_sourceEnum value);
    ...
    /// The filter on the conversion ingestion source method for conversion metrics
    /// </summary>
    std::vector<Ingestion_sourcesEnum> getIngestionSources() const;
    bool ingestionSourcesIsSet() const;
    void unsetIngestion_sources();
    void setIngestionSources(const std::vector<Ingestion_sourcesEnum> value);
...
protected:
    ...
    Conversion_report_time_typeEnum m_Conversion_report_time_type;
    bool m_Conversion_report_time_typeIsSet;

    Creation_sourceEnum m_Creation_source;
    ...
    boost::optional<std::vector<Ingestion_sourcesEnum>> m_Ingestion_sources;
