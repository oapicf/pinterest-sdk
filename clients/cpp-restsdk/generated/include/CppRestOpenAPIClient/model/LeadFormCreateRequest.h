...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_LeadFormCreateRequest_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_LeadFormCreateRequest_H_
...
public:
    ...
    /// </summary>
    std::vector<std::shared_ptr<LeadFormCommon_policy_links_inner>> getPolicyLinks() const;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_LeadFormCreateRequest_H_ */
