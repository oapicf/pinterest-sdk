...
public:
    ...
    Primary_sortEnum toPrimary_sortEnum(const utility::string_t& value) const;
    const utility::string_t fromPrimary_sortEnum(const Primary_sortEnum value) const;
    ...
    /// </summary>
    std::vector<std::shared_ptr<AdsAnalyticsCreateAsyncRequest_allOf_custom_conversion_event_metrics>> getCustomConversionEventMetrics() const;
    bool customConversionEventMetricsIsSet() const;
    void unsetCustom_conversion_event_metrics();
    void setCustomConversionEventMetrics(const std::vector<std::shared_ptr<AdsAnalyticsCreateAsyncRequest_allOf_custom_conversion_event_metrics>>& value);
    ...
    /// Whether to first sort the report by date or by entity ID of the reporting entity level. Date will be used as the first level key for JSON reports that use BY_DATE. BY_DATE is recommended for large requests.
    /// </summary>
    Primary_sortEnum getPrimarySort() const;
    bool primarySortIsSet() const;
    void unsetPrimary_sort();
    void setPrimarySort(const Primary_sortEnum value);
...
protected:
    ...
    std::vector<std::shared_ptr<AdsAnalyticsCreateAsyncRequest_allOf_custom_conversion_event_metrics>> m_Custom_conversion_event_metrics;
    ...
    Primary_sortEnum m_Primary_sort;
