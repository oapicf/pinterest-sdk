...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_AdAccountsAudienceRule_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_AdAccountsAudienceRule_H_
...
public:
    ...
    /// </summary>
    std::vector<utility::string_t> getAdId() const;
    ...
    /// </summary>
    std::vector<utility::string_t> getCampaignId() const;
    ...
    /// </summary>
    std::vector<utility::string_t> getEngagementDomain() const;
    ...
    void setEventData(const std::shared_ptr<EventData>& value);
    ...
    void setObjectiveType(const std::vector<std::shared_ptr<AudienceObjectiveType>>& value);
    ...
    /// </summary>
    std::vector<utility::string_t> getPinId() const;
    ...
    /// </summary>
    std::vector<utility::string_t> getSeedId() const;
    ...
    /// </summary>
    std::vector<utility::string_t> getUrl() const;
    bool urlIsSet() const;
    void unsetUrl();
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_AdAccountsAudienceRule_H_ */
