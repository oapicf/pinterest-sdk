...
public:
    ...
    /// </summary>
    std::vector<utility::string_t> getCustomQuestionOptions() const;
...
protected:
    boost::optional<std::shared_ptr<LeadFormQuestionFieldType>> m_Custom_question_field_type;

    boost::optional<utility::string_t> m_Custom_question_label;

    boost::optional<std::vector<utility::string_t>> m_Custom_question_options;
