...
public:
    ...
    /// 
    /// </summary>
    std::shared_ptr<AudienceCreateRequest_1_audience_type> getAudienceType() const;
    bool audienceTypeIsSet() const;
    void unsetAudience_type();

    void setAudienceType(const std::shared_ptr<AudienceCreateRequest_1_audience_type>& value);
...
protected:
    ...
    std::shared_ptr<AudienceCreateRequest_1_audience_type> m_Audience_type;
