...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_SSIOInsertionOrderCreate_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_SSIOInsertionOrderCreate_H_
...
public:
    ...
    void setOrderLineType(const std::shared_ptr<SSIOOrderLineType>& value);
...
protected:
    ...
    std::shared_ptr<SSIOOrderLineType> m_Order_line_type;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_SSIOInsertionOrderCreate_H_ */
