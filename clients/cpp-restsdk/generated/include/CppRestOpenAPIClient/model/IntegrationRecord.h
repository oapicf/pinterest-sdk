...
protected:
    boost::optional<utility::string_t> m_Additional_id_1;

    boost::optional<utility::string_t> m_Connected_advertiser_id;

    boost::optional<utility::string_t> m_Connected_lba_id;

    boost::optional<utility::string_t> m_Connected_merchant_id;

    boost::optional<utility::string_t> m_Connected_tag_id;
    ...
    boost::optional<utility::string_t> m_Partner_access_token;

    boost::optional<int32_t> m_Partner_access_token_expiry;

    boost::optional<utility::string_t> m_Partner_metadata;

    boost::optional<utility::string_t> m_Partner_primary_email;

    boost::optional<utility::string_t> m_Partner_refresh_token;

    boost::optional<int32_t> m_Partner_refresh_token_expiry;
