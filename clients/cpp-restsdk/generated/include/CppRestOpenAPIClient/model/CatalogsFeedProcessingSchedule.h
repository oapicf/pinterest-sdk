...
public:
    ...
    TimezoneEnum toTimezoneEnum(const utility::string_t& value) const;
    const utility::string_t fromTimezoneEnum(const TimezoneEnum value) const;
    ...
    /// The timezone considered for the processing schedule time.
    /// </summary>
    TimezoneEnum getTimezone() const;
    bool timezoneIsSet() const;
    void unsetTimezone();
    void setTimezone(const TimezoneEnum value);
...
protected:
    ...
    boost::optional<TimezoneEnum> m_Timezone;
