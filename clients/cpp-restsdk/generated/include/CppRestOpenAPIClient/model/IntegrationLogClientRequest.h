...
public:
    ...
    void unsetMethod();
    void setMethod(const std::shared_ptr<HttpMethod>& value);
    ...
    /// </summary>
    std::map<utility::string_t, utility::string_t> getRequestHeaders() const;
    ...
    /// </summary>
    std::map<utility::string_t, utility::string_t> getResponseHeaders() const;
...
protected:
    ...
    std::shared_ptr<HttpMethod> m_Method;
    bool m_MethodIsSet;
