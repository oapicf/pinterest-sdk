...
protected:
    boost::optional<std::shared_ptr<TemplateResponse_date_range_absolute_date_range>> m_Absolute_date_range;

    boost::optional<std::shared_ptr<TemplateResponse_date_range_dynamic_date_range>> m_Dynamic_date_range;

    boost::optional<std::shared_ptr<TemplateResponse_date_range_relative_date_range>> m_Relative_date_range;
