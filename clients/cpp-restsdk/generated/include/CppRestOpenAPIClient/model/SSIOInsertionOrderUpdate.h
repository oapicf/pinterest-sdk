...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_SSIOInsertionOrderUpdate_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_SSIOInsertionOrderUpdate_H_
...
public:
    ...
    /// </summary>
    utility::string_t getOracleLineId() const;
    bool oracleLineIdIsSet() const;
    void unsetOracle_line_id();
    void setOracleLineId(const utility::string_t& value);
    ...
    /// OrderId in SFDC
    /// </summary>
    utility::string_t getSalesforceOrderId() const;
    bool salesforceOrderIdIsSet() const;
    void unsetSalesforce_order_id();
    void setSalesforceOrderId(const utility::string_t& value);
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_SSIOInsertionOrderUpdate_H_ */
