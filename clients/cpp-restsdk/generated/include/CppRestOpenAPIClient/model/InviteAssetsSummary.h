...
public:
    ...
    /// </summary>
    std::vector<std::shared_ptr<InviteAssetsSummary_ad_accounts_inner>> getAdAccounts() const;
    ...
    /// </summary>
    std::vector<std::shared_ptr<InviteAssetsSummary_profiles_inner>> getProfiles() const;
