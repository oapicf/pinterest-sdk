...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_ConversionEventsDataItemsCustomData_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_ConversionEventsDataItemsCustomData_H_
...
public:
    ...
    /// </summary>
    std::vector<utility::string_t> getContentIds() const;
    ...
    void unsetContents();
    void setContents(const std::vector<std::shared_ptr<ConversionEventsDataItemsCustomDataContentsItems>>& value);
    ...
    /// </summary>
    utility::string_t getExternalMeasurementId() const;
    bool externalMeasurementIdIsSet() const;
    void unsetExternal_measurement_id();
    void setExternalMeasurementId(const utility::string_t& value);
    ...
    /// </summary>
    utility::string_t getPredictedLtv() const;
    bool predictedLtvIsSet() const;
    void unsetPredicted_ltv();
    void setPredictedLtv(const utility::string_t& value);
...
protected:
    boost::optional<utility::string_t> m_Content_brand;

    boost::optional<utility::string_t> m_Content_category;

    std::vector<utility::string_t> m_Content_ids;
    bool m_Content_idsIsSet;

    boost::optional<utility::string_t> m_Content_name;
    ...
    boost::optional<utility::string_t> m_External_measurement_id;

    boost::optional<int32_t> m_External_measurement_vendor_id;

    boost::optional<utility::string_t> m_Np;

    int64_t m_Num_items;
    bool m_Num_itemsIsSet;

    boost::optional<utility::string_t> m_Opt_out_type;

    boost::optional<utility::string_t> m_Order_id;

    boost::optional<utility::string_t> m_Predicted_ltv;

    boost::optional<utility::string_t> m_Search_string;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_ConversionEventsDataItemsCustomData_H_ */
