...
protected:
    ...
    boost::optional<double> m_Paid_budget;

    boost::optional<std::shared_ptr<OrderLinePaidType>> m_Paid_type;

    boost::optional<utility::string_t> m_Purchase_order_id;
