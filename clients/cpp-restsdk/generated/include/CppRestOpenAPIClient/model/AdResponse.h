...
public:
    ...
    /// 
    /// </summary>
    std::shared_ptr<AdCommon_quiz_pin_data> getQuizPinData() const;
    bool quizPinDataIsSet() const;
    void unsetQuiz_pin_data();

    void setQuizPinData(const std::shared_ptr<AdCommon_quiz_pin_data>& value);
...
protected:
    ...
    std::shared_ptr<AdCommon_quiz_pin_data> m_Quiz_pin_data;
