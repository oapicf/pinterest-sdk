...
public:
    ...
    PLACEMENTEnum toPLACEMENTEnum(const utility::string_t& value) const;
    const utility::string_t fromPLACEMENTEnum(const PLACEMENTEnum value) const;


    PLACEMENTEnum getPLACEMENT() const;
    bool pLACEMENTIsSet() const;
    void unsetPLACEMENT();
    void setPLACEMENT(const PLACEMENTEnum value);


protected:
    PLACEMENTEnum m_PLACEMENT;
