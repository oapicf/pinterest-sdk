...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_CampaignCreateResponseData_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_CampaignCreateResponseData_H_
...
public:
    ...
    std::shared_ptr<CampaignSummaryStatus> getSummaryStatus() const;
    bool summaryStatusIsSet() const;
    void unsetSummary_status();
    void setSummaryStatus(const std::shared_ptr<CampaignSummaryStatus>& value);
...
protected:
    ...
    std::shared_ptr<CampaignSummaryStatus> m_Summary_status;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_CampaignCreateResponseData_H_ */
