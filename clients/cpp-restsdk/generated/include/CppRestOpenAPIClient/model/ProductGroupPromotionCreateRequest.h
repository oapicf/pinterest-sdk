...
public:
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<ProductGroupPromotionCommon>>& getProductGroupPromotion();
    bool productGroupPromotionIsSet() const;
    void unsetProduct_group_promotion();

    void setProductGroupPromotion(const std::vector<std::shared_ptr<ProductGroupPromotionCommon>>& value);


protected:
    utility::string_t m_Ad_group_id;
    bool m_Ad_group_idIsSet;
    std::vector<std::shared_ptr<ProductGroupPromotionCommon>> m_Product_group_promotion;
