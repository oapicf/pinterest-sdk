...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_CampaignBatchResponseData_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_CampaignBatchResponseData_H_
...
public:
    ...
    void setBidOptions(const std::shared_ptr<CampaignBidOptions>& value);
    ...
    std::shared_ptr<CampaignObjectiveType> getObjectiveType() const;
    bool objectiveTypeIsSet() const;
    void unsetObjective_type();
    void setObjectiveType(const std::shared_ptr<CampaignObjectiveType>& value);
    ...
    std::shared_ptr<NullableEntityStatus> getStatus() const;
    bool statusIsSet() const;
    void unsetStatus();
    void setStatus(const std::shared_ptr<NullableEntityStatus>& value);
...
protected:
    ...
    boost::optional<std::shared_ptr<CampaignBidOptions>> m_Bid_options;
    ...
    std::shared_ptr<CampaignObjectiveType> m_Objective_type;
    ...
    boost::optional<std::shared_ptr<NullableEntityStatus>> m_Status;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_CampaignBatchResponseData_H_ */
