...
public:
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<Catalogs_product_groups_list_200_response_allOf_items_inner>>& getItems();
    bool itemsIsSet() const;
    void unsetItems();

    void setItems(const std::vector<std::shared_ptr<Catalogs_product_groups_list_200_response_allOf_items_inner>>& value);
...
protected:
    std::vector<std::shared_ptr<Catalogs_product_groups_list_200_response_allOf_items_inner>> m_Items;
    bool m_ItemsIsSet;
