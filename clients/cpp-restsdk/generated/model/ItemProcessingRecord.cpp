...
bool ItemProcessingRecord::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(U("item_id"))))
    {
        ...
        {
            utility::string_t refVal_item_id;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("errors"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<ItemValidationEvent>> refVal_errors;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("warnings"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<ItemValidationEvent>> refVal_warnings;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("status"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<ItemProcessingStatus> refVal_status;
...
bool ItemProcessingRecord::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    {
        std::vector<std::shared_ptr<ItemValidationEvent>> refVal_warnings;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("warnings"))), refVal_warnings );
        setWarnings(refVal_warnings);
    }
