...
bool Paginated::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(U("items"))))
    {
        ...
        {
            std::vector<std::shared_ptr<Object>> refVal_items;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("bookmark"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            utility::string_t refVal_bookmark;
            ok &= ModelBase::fromJson(fieldValue, refVal_bookmark);
            setBookmark(refVal_bookmark);
        }
    }
    return ok;
}
...
bool Paginated::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    {
        utility::string_t refVal_bookmark;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("bookmark"))), refVal_bookmark );
        setBookmark(refVal_bookmark);
    }
    return ok;
}
