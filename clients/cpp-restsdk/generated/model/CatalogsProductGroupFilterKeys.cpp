...
bool CatalogsProductGroupFilterKeys::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(U("CURRENCY"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<CatalogsProductGroupCurrencyCriteria> refVal_CURRENCY;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("BRAND"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<CatalogsProductGroupMultipleStringCriteria> refVal_BRAND;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("CONDITION"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<CatalogsProductGroupMultipleStringCriteria> refVal_CONDITION;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("CUSTOM_LABEL_0"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<CatalogsProductGroupMultipleStringCriteria> refVal_CUSTOM_LABEL_0;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("CUSTOM_LABEL_2"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<CatalogsProductGroupMultipleStringCriteria> refVal_CUSTOM_LABEL_2;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("CUSTOM_LABEL_3"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<CatalogsProductGroupMultipleStringCriteria> refVal_CUSTOM_LABEL_3;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("ITEM_GROUP_ID"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<CatalogsProductGroupMultipleStringCriteria> refVal_ITEM_GROUP_ID;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("GENDER"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<CatalogsProductGroupMultipleStringCriteria> refVal_GENDER;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("PRODUCT_TYPE_4"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<CatalogsProductGroupMultipleStringListCriteria> refVal_PRODUCT_TYPE_4;
            ok &= ModelBase::fromJson(fieldValue, refVal_PRODUCT_TYPE_4);
            setPRODUCTTYPE4(refVal_PRODUCT_TYPE_4);
        }
    }
    ...
    if(val.has_field(utility::conversions::to_string_t(U("PRODUCT_TYPE_2"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<CatalogsProductGroupMultipleStringListCriteria> refVal_PRODUCT_TYPE_2;
            ok &= ModelBase::fromJson(fieldValue, refVal_PRODUCT_TYPE_2);
            setPRODUCTTYPE2(refVal_PRODUCT_TYPE_2);
        }
    }
    if(val.has_field(utility::conversions::to_string_t(U("PRODUCT_TYPE_1"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<CatalogsProductGroupMultipleStringListCriteria> refVal_PRODUCT_TYPE_1;
            ok &= ModelBase::fromJson(fieldValue, refVal_PRODUCT_TYPE_1);
            setPRODUCTTYPE1(refVal_PRODUCT_TYPE_1);
        }
    }
    ...
    if(val.has_field(utility::conversions::to_string_t(U("GOOGLE_PRODUCT_CATEGORY_5"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<CatalogsProductGroupMultipleStringListCriteria> refVal_GOOGLE_PRODUCT_CATEGORY_5;
            ok &= ModelBase::fromJson(fieldValue, refVal_GOOGLE_PRODUCT_CATEGORY_5);
            setGOOGLEPRODUCTCATEGORY5(refVal_GOOGLE_PRODUCT_CATEGORY_5);
        }
    }
    ...
    if(val.has_field(utility::conversions::to_string_t(U("GOOGLE_PRODUCT_CATEGORY_2"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<CatalogsProductGroupMultipleStringListCriteria> refVal_GOOGLE_PRODUCT_CATEGORY_2;
            ok &= ModelBase::fromJson(fieldValue, refVal_GOOGLE_PRODUCT_CATEGORY_2);
            setGOOGLEPRODUCTCATEGORY2(refVal_GOOGLE_PRODUCT_CATEGORY_2);
        }
    }
    if(val.has_field(utility::conversions::to_string_t(U("GOOGLE_PRODUCT_CATEGORY_1"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<CatalogsProductGroupMultipleStringListCriteria> refVal_GOOGLE_PRODUCT_CATEGORY_1;
            ok &= ModelBase::fromJson(fieldValue, refVal_GOOGLE_PRODUCT_CATEGORY_1);
            setGOOGLEPRODUCTCATEGORY1(refVal_GOOGLE_PRODUCT_CATEGORY_1);
        }
    }
...
bool CatalogsProductGroupFilterKeys::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    {
        std::shared_ptr<CatalogsProductGroupMultipleStringListCriteria> refVal_PRODUCT_TYPE_4;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("PRODUCT_TYPE_4"))), refVal_PRODUCT_TYPE_4 );
        setPRODUCTTYPE4(refVal_PRODUCT_TYPE_4);
    }
    ...
    {
        std::shared_ptr<CatalogsProductGroupMultipleStringListCriteria> refVal_PRODUCT_TYPE_2;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("PRODUCT_TYPE_2"))), refVal_PRODUCT_TYPE_2 );
        setPRODUCTTYPE2(refVal_PRODUCT_TYPE_2);
    }
    if(multipart->hasContent(utility::conversions::to_string_t(U("PRODUCT_TYPE_1"))))
    {
        std::shared_ptr<CatalogsProductGroupMultipleStringListCriteria> refVal_PRODUCT_TYPE_1;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("PRODUCT_TYPE_1"))), refVal_PRODUCT_TYPE_1 );
        setPRODUCTTYPE1(refVal_PRODUCT_TYPE_1);
    }
    ...
    {
        std::shared_ptr<CatalogsProductGroupMultipleStringListCriteria> refVal_GOOGLE_PRODUCT_CATEGORY_5;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("GOOGLE_PRODUCT_CATEGORY_5"))), refVal_GOOGLE_PRODUCT_CATEGORY_5 );
        setGOOGLEPRODUCTCATEGORY5(refVal_GOOGLE_PRODUCT_CATEGORY_5);
    }
    ...
    {
        std::shared_ptr<CatalogsProductGroupMultipleStringListCriteria> refVal_GOOGLE_PRODUCT_CATEGORY_2;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("GOOGLE_PRODUCT_CATEGORY_2"))), refVal_GOOGLE_PRODUCT_CATEGORY_2 );
        setGOOGLEPRODUCTCATEGORY2(refVal_GOOGLE_PRODUCT_CATEGORY_2);
    }
    if(multipart->hasContent(utility::conversions::to_string_t(U("GOOGLE_PRODUCT_CATEGORY_1"))))
    {
        std::shared_ptr<CatalogsProductGroupMultipleStringListCriteria> refVal_GOOGLE_PRODUCT_CATEGORY_1;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("GOOGLE_PRODUCT_CATEGORY_1"))), refVal_GOOGLE_PRODUCT_CATEGORY_1 );
        setGOOGLEPRODUCTCATEGORY1(refVal_GOOGLE_PRODUCT_CATEGORY_1);
    }
...
void CatalogsProductGroupFilterKeys::setITEMID(const std::shared_ptr<CatalogsProductGroupCurrencyCriteria>& value)
{
    m_ITEM_ID = value;
    m_ITEM_IDIsSet = true;
}
