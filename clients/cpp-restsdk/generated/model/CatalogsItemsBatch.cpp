...
bool CatalogsItemsBatch::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(U("items"))))
    {
        ...
        {
            std::vector<std::shared_ptr<ItemProcessingRecord>> refVal_items;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("batch_id"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            utility::string_t refVal_batch_id;
            ok &= ModelBase::fromJson(fieldValue, refVal_batch_id);
            setBatchId(refVal_batch_id);
        }
    }
    if(val.has_field(utility::conversions::to_string_t(U("created_time"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            utility::datetime refVal_created_time;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("completed_time"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            utility::datetime refVal_completed_time;
            ok &= ModelBase::fromJson(fieldValue, refVal_completed_time);
            setCompletedTime(refVal_completed_time);
        }
    }
    if(val.has_field(utility::conversions::to_string_t(U("status"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<BatchOperationStatus> refVal_status;
...
bool CatalogsItemsBatch::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    {
        utility::string_t refVal_batch_id;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("batch_id"))), refVal_batch_id );
        setBatchId(refVal_batch_id);
    }
    ...
    {
        utility::datetime refVal_completed_time;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("completed_time"))), refVal_completed_time );
        setCompletedTime(refVal_completed_time);
    }
