...
bool ItemBatchRecord::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(U("attributes"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<ItemAttributes> refVal_attributes;
            ok &= ModelBase::fromJson(fieldValue, refVal_attributes);
            setAttributes(refVal_attributes);
        }
    }
    return ok;
}
...
bool ItemBatchRecord::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    {
        std::shared_ptr<ItemAttributes> refVal_attributes;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("attributes"))), refVal_attributes );
        setAttributes(refVal_attributes);
    }
    return ok;
}
