...
BatchOperationStatus::eBatchOperationStatus toEnum(const EnumUnderlyingType& val)
{
    ...
    if (val == utility::conversions::to_string_t(U("FAILED")))
        return BatchOperationStatus::eBatchOperationStatus::BatchOperationStatus_FAILED;
    return {};
}
...
EnumUnderlyingType fromEnum(BatchOperationStatus::eBatchOperationStatus e)
{
    ...
    case BatchOperationStatus::eBatchOperationStatus::BatchOperationStatus_COMPLETED:
        return U("COMPLETED");
    case BatchOperationStatus::eBatchOperationStatus::BatchOperationStatus_FAILED:
        return U("FAILED");
    default:
        break;
    }
