...
web::json::value CatalogsFeedValidationWarnings::toJson() const
{
    ...
    {   
        ...
        val[utility::conversions::to_string_t(U("FETCH_SAME_SIGNATURE"))] = ModelBase::toJson(refVal);
...
void CatalogsFeedValidationWarnings::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_FETCH_SAME_SIGNATUREIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(U("FETCH_SAME_SIGNATURE")), fromFETCH_SAME_SIGNATUREEnum(m_FETCH_SAME_SIGNATURE)));
    }
    if(m_ADDITIONAL_IMAGE_LINK_LENGTH_TOO_LONGIsSet)
    {
...
CatalogsFeedValidationWarnings::FETCH_SAME_SIGNATUREEnum CatalogsFeedValidationWarnings::toFETCH_SAME_SIGNATUREEnum(const int32_t& value) const
{
    ...
    if (value == utility::conversions::to_string_t("1")) {
        return FETCH_SAME_SIGNATUREEnum::1;
    }
...
const int32_t CatalogsFeedValidationWarnings::fromFETCH_SAME_SIGNATUREEnum(const FETCH_SAME_SIGNATUREEnum value) const
{
    switch(value)
    {
        ...
        case FETCH_SAME_SIGNATUREEnum::1: return utility::conversions::to_string_t("1");
