...
std::shared_ptr<ItemAttributes> ItemCreateBatchRecord::getAttributes() const
{
    return m_Attributes;
}

void ItemCreateBatchRecord::setAttributes(const std::shared_ptr<ItemAttributes>& value)
{
    m_Attributes = value;
