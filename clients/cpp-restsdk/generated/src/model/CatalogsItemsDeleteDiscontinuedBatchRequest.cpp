...
std::shared_ptr<CatalogsItemsRequest_language> CatalogsItemsDeleteDiscontinuedBatchRequest::getLanguage() const
{
    return m_Language;
}


void CatalogsItemsDeleteDiscontinuedBatchRequest::setLanguage(const std::shared_ptr<CatalogsItemsRequest_language>& value)
{
    m_Language = value;
