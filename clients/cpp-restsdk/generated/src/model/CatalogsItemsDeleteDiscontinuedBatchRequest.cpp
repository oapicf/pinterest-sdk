...
std::shared_ptr<Language> CatalogsItemsDeleteDiscontinuedBatchRequest::getLanguage() const
{
    return m_Language;
}

void CatalogsItemsDeleteDiscontinuedBatchRequest::setLanguage(const std::shared_ptr<Language>& value)
{
    m_Language = value;
