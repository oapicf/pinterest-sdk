...
std::vector<std::shared_ptr<InviteAssetsSummary_ad_accounts_inner>>& InviteAssetsSummary::getAdAccounts()
{
...
std::vector<std::shared_ptr<InviteAssetsSummary_profiles_inner>>& InviteAssetsSummary::getProfiles()
{
    return m_Profiles;
}
