...
ItemProcessingStatus::eItemProcessingStatus toEnum(const EnumUnderlyingType& val)
{
    if (val == utility::conversions::to_string_t(_XPLATSTR("SUCCESS")))
        return ItemProcessingStatus::eItemProcessingStatus::SUCCESS;
    if (val == utility::conversions::to_string_t(_XPLATSTR("FAILURE")))
        return ItemProcessingStatus::eItemProcessingStatus::FAILURE;
    if (val == utility::conversions::to_string_t(_XPLATSTR("PROCESSING")))
        return ItemProcessingStatus::eItemProcessingStatus::PROCESSING;
    return {};
}
...
ItemProcessingStatus::ItemProcessingStatus(utility::string_t str){
