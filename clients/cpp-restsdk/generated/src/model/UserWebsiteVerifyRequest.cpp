...
web::json::value UserWebsiteVerifyRequest::toJson() const
{
    ...
    {   
        ...
        val[utility::conversions::to_string_t(U("verification_method"))] = ModelBase::toJson(refVal);
...
void UserWebsiteVerifyRequest::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_Verification_methodIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(U("verification_method")), fromVerification_methodEnum(m_Verification_method)));
    }
}
