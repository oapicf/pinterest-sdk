...
web::json::value CustomerList::toJson() const
{
    ...
    if(m_Num_batchesIsSet)
    {
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("num_batches"))] = ModelBase::toJson(m_Num_batches);
    }
    if(m_Num_removed_user_recordsIsSet)
    {
        
        val[utility::conversions::to_string_t(_XPLATSTR("num_removed_user_records"))] = ModelBase::toJson(m_Num_removed_user_records);
    }
    if(m_Num_uploaded_user_recordsIsSet)
    {
        
        val[utility::conversions::to_string_t(_XPLATSTR("num_uploaded_user_records"))] = ModelBase::toJson(m_Num_uploaded_user_records);
    }
    if(m_StatusIsSet)
    {
...
bool CustomerList::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("num_batches"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(_XPLATSTR("num_batches")));
        if(!fieldValue.is_null())
        {
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("num_removed_user_records"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(_XPLATSTR("num_removed_user_records")));
        if(!fieldValue.is_null())
        {
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("num_uploaded_user_records"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(_XPLATSTR("num_uploaded_user_records")));
        if(!fieldValue.is_null())
        {
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("status"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<CustomerListStatus> refVal_setStatus;
...
void CustomerList::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_Num_batchesIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("num_batches")), m_Num_batches));
    }
    if(m_Num_removed_user_recordsIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("num_removed_user_records")), m_Num_removed_user_records));
    }
    if(m_Num_uploaded_user_recordsIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("num_uploaded_user_records")), m_Num_uploaded_user_records));
    }
    if(m_StatusIsSet)
    {
...
bool CustomerList::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    if(multipart->hasContent(utility::conversions::to_string_t(_XPLATSTR("num_batches"))))
    {
        double refVal_setNumBatches;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(_XPLATSTR("num_batches"))), refVal_setNumBatches );
        setNumBatches(refVal_setNumBatches);
    }
    if(multipart->hasContent(utility::conversions::to_string_t(_XPLATSTR("num_removed_user_records"))))
    {
        double refVal_setNumRemovedUserRecords;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(_XPLATSTR("num_removed_user_records"))), refVal_setNumRemovedUserRecords );
        setNumRemovedUserRecords(refVal_setNumRemovedUserRecords);
    }
    if(multipart->hasContent(utility::conversions::to_string_t(_XPLATSTR("num_uploaded_user_records"))))
    {
        double refVal_setNumUploadedUserRecords;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(_XPLATSTR("num_uploaded_user_records"))), refVal_setNumUploadedUserRecords );
        setNumUploadedUserRecords(refVal_setNumUploadedUserRecords);
    }
...
bool CustomerList::isNcaIsSet() const
{
    return m_Is_ncaIsSet;
}

void CustomerList::unsetIs_nca()
{
    m_Is_ncaIsSet = false;
}
...
void CustomerList::setStatus(const std::shared_ptr<CustomerListStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}
