...
CustomerList::StatusEnum CustomerList::toStatusEnum(const utility::string_t& value) const
{
    ...
    if (value == utility::conversions::to_string_t("TOO_SMALL")) {
        return StatusEnum::TOO_SMALL;
    }
...
const utility::string_t CustomerList::fromStatusEnum(const StatusEnum value) const
{
    switch(value)
    {
        ...
        case StatusEnum::TOO_SMALL: return utility::conversions::to_string_t("TOO_SMALL");
...
CustomerList::StatusEnum CustomerList::getStatus() const
{
    return m_Status;
}


void CustomerList::setStatus(const StatusEnum value)
{
    m_Status = value;
    m_StatusIsSet = true;
}
