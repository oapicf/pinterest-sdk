...
web::json::value PlacementMultipliers::toJson() const
{
    ...
    {   
        ...
        val[utility::conversions::to_string_t(U("PLACEMENT"))] = ModelBase::toJson(refVal);
...
void PlacementMultipliers::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_PLACEMENTIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(U("PLACEMENT")), fromPLACEMENTEnum(m_PLACEMENT)));
    }
}
