...
#include "CppRestOpenAPIClient/model/BusinessMemberAssetsSummary_profiles_inner.h"
...
void BusinessMemberAssetsSummary_profiles_inner::validate()
{
    // TODO: implement validation
}

web::json::value BusinessMemberAssetsSummary_profiles_inner::toJson() const
{
...
bool BusinessMemberAssetsSummary_profiles_inner::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void BusinessMemberAssetsSummary_profiles_inner::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BusinessMemberAssetsSummary_profiles_inner::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t BusinessMemberAssetsSummary_profiles_inner::getId() const
{
    return m_Id;
}


void BusinessMemberAssetsSummary_profiles_inner::setId(const utility::string_t& value)
{
    m_Id = value;
    m_IdIsSet = true;
}

bool BusinessMemberAssetsSummary_profiles_inner::idIsSet() const
{
    return m_IdIsSet;
}

void BusinessMemberAssetsSummary_profiles_inner::unsetId()
{
    m_IdIsSet = false;
}
std::vector<utility::string_t> BusinessMemberAssetsSummary_profiles_inner::getPermissions() const
{
    return m_Permissions;
}


void BusinessMemberAssetsSummary_profiles_inner::setPermissions(const std::vector<utility::string_t>& value)
{
    m_Permissions = value;
    m_PermissionsIsSet = true;
}

bool BusinessMemberAssetsSummary_profiles_inner::permissionsIsSet() const
{
    return m_PermissionsIsSet;
}

void BusinessMemberAssetsSummary_profiles_inner::unsetPermissions()
{
    m_PermissionsIsSet = false;
}
