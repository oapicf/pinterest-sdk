...
std::shared_ptr<CatalogsItemsRequest_language> CatalogsItemsCreateBatchRequest::getLanguage() const
{
    return m_Language;
}


void CatalogsItemsCreateBatchRequest::setLanguage(const std::shared_ptr<CatalogsItemsRequest_language>& value)
{
    m_Language = value;
