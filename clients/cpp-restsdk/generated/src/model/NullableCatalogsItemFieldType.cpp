...
NullableCatalogsItemFieldType::eNullableCatalogsItemFieldType toEnum(const EnumUnderlyingType& val)
{
    ...
    if (val == utility::conversions::to_string_t(U("null")))
        return NullableCatalogsItemFieldType::eNullableCatalogsItemFieldType::NullableCatalogsItemFieldType_r_NULL;
    return {};
}
...
EnumUnderlyingType fromEnum(NullableCatalogsItemFieldType::eNullableCatalogsItemFieldType e)
{
    ...
    case NullableCatalogsItemFieldType::eNullableCatalogsItemFieldType::NullableCatalogsItemFieldType_r_NULL:
        return U("null");
    default:
        break;
    }
