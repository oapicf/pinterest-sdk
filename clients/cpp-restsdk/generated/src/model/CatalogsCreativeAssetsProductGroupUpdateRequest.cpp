...
utility::string_t CatalogsCreativeAssetsProductGroupUpdateRequest::getCatalogType() const
{
    return m_Catalog_type;
}

void CatalogsCreativeAssetsProductGroupUpdateRequest::setCatalogType(const utility::string_t& value)
{
