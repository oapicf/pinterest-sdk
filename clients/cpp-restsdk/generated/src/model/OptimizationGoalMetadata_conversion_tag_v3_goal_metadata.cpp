...
web::json::value OptimizationGoalMetadata_conversion_tag_v3_goal_metadata::toJson() const
{
    ...
    {   
        ...
        val[utility::conversions::to_string_t(U("conversion_event"))] = ModelBase::toJson(refVal);
    ...
    {   
        ...
        utility::string_t refVal = fromLearning_mode_typeEnum(m_Learning_mode_type);
        val[utility::conversions::to_string_t(U("learning_mode_type"))] = ModelBase::toJson(refVal);
...
void OptimizationGoalMetadata_conversion_tag_v3_goal_metadata::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_Conversion_eventIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(U("conversion_event")), fromConversion_eventEnum(m_Conversion_event)));
    }
    if(m_Conversion_tag_idIsSet)
    {
    ...
    if(m_Learning_mode_typeIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(U("learning_mode_type")), fromLearning_mode_typeEnum(m_Learning_mode_type)));
    }
}
