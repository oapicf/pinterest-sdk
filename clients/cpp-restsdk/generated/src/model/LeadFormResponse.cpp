...
std::vector<std::shared_ptr<LeadFormQuestion>> LeadFormResponse::getQuestions() const
{
    return m_Questions;
}
...
std::vector<std::shared_ptr<LeadFormCommon_policy_links_inner>> LeadFormResponse::getPolicyLinks() const
{
