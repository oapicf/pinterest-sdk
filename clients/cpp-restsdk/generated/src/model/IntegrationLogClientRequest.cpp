...
web::json::value IntegrationLogClientRequest::toJson() const
{
    ...
    {   
        ...
        val[utility::conversions::to_string_t(U("method"))] = ModelBase::toJson(refVal);
...
void IntegrationLogClientRequest::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_MethodIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(U("method")), fromMethodEnum(m_Method)));
    }
    if(m_HostIsSet)
    {
