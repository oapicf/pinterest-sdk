...
IntegrationLogClientRequest::MethodEnum IntegrationLogClientRequest::toMethodEnum(const utility::string_t& value) const
{
...
const utility::string_t IntegrationLogClientRequest::fromMethodEnum(const MethodEnum value) const
{
    switch(value)
    {
        ...
        case MethodEnum::HEAD: return utility::conversions::to_string_t("HEAD");
        ...
        case MethodEnum::CONNECT: return utility::conversions::to_string_t("CONNECT");
        
        case MethodEnum::OPTIONS: return utility::conversions::to_string_t("OPTIONS");
        
        case MethodEnum::TRACE: return utility::conversions::to_string_t("TRACE");
...
IntegrationLogClientRequest::MethodEnum IntegrationLogClientRequest::getMethod() const
{
    return m_Method;
}


void IntegrationLogClientRequest::setMethod(const MethodEnum value)
{
    m_Method = value;
    m_MethodIsSet = true;
}
