...
AdsAnalyticsFilterColumn::eAdsAnalyticsFilterColumn toEnum(const EnumUnderlyingType& val)
{
    if (val == utility::conversions::to_string_t(_XPLATSTR("SPEND_IN_DOLLAR")))
        return AdsAnalyticsFilterColumn::eAdsAnalyticsFilterColumn::SPEND_IN_DOLLAR;
    if (val == utility::conversions::to_string_t(_XPLATSTR("TOTAL_IMPRESSION")))
        return AdsAnalyticsFilterColumn::eAdsAnalyticsFilterColumn::TOTAL_IMPRESSION;
    return {};
}
...
AdsAnalyticsFilterColumn::AdsAnalyticsFilterColumn(utility::string_t str){
