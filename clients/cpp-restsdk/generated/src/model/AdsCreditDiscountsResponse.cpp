...
web::json::value AdsCreditDiscountsResponse::toJson() const
{
    ...
    {   
        ...
        utility::string_t refVal = fromDiscountTypeEnum(m_DiscountType);
        val[utility::conversions::to_string_t(U("discountType"))] = ModelBase::toJson(refVal);
...
void AdsCreditDiscountsResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_DiscountTypeIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(U("discountType")), fromDiscountTypeEnum(m_DiscountType)));
    }
    if(m_DiscountInMicroCurrencyIsSet)
    {
