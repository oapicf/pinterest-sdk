...
std::shared_ptr<Language> CatalogsItemsDeleteBatchRequest::getLanguage() const
{
    return m_Language;
}

void CatalogsItemsDeleteBatchRequest::setLanguage(const std::shared_ptr<Language>& value)
{
    m_Language = value;
