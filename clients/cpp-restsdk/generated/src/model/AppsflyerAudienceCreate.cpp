...
#include "CppRestOpenAPIClient/model/AppsflyerAudienceCreate.h"
...
void AppsflyerAudienceCreate::validate()
{
    // TODO: implement validation
}

web::json::value AppsflyerAudienceCreate::toJson() const
{
...
bool AppsflyerAudienceCreate::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void AppsflyerAudienceCreate::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool AppsflyerAudienceCreate::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t AppsflyerAudienceCreate::getName() const
{
    return m_Name;
}


void AppsflyerAudienceCreate::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool AppsflyerAudienceCreate::nameIsSet() const
{
    return m_NameIsSet;
}

void AppsflyerAudienceCreate::unsetName()
{
    m_NameIsSet = false;
}
...
void AppsflyerAudienceCreate::setPlatform(const std::shared_ptr<AppsflyerPlatform>& value)
{
    m_Platform = value;
    m_PlatformIsSet = true;
}

bool AppsflyerAudienceCreate::platformIsSet() const
{
    return m_PlatformIsSet;
}

void AppsflyerAudienceCreate::unsetPlatform()
{
    m_PlatformIsSet = false;
}
