...
std::map<utility::string_t, double>& TopPinsAnalyticsResponse_pins_inner::getMetrics()
{
    return m_Metrics;
}
...
std::map<utility::string_t, std::shared_ptr<DataStatus>>& TopPinsAnalyticsResponse_pins_inner::getDataStatus()
{
