...
web::json::value PinMediaSourceVideoID::toJson() const
{
    ...
    {   
        ...
        val[utility::conversions::to_string_t(U("cover_image_content_type"))] = ModelBase::toJson(refVal);
...
void PinMediaSourceVideoID::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_Cover_image_content_typeIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(U("cover_image_content_type")), fromCover_image_content_typeEnum(m_Cover_image_content_type)));
    }
    if(m_Cover_image_dataIsSet)
    {
...
PinMediaSourceVideoID::Cover_image_content_typeEnum PinMediaSourceVideoID::toCover_image_content_typeEnum(const utility::string_t& value) const
{
    ...
    if (value == utility::conversions::to_string_t("image/jpeg")) {
        return Cover_image_content_typeEnum::image/jpeg;
    }
    
    if (value == utility::conversions::to_string_t("image/png")) {
        return Cover_image_content_typeEnum::image/png;
    }
...
const utility::string_t PinMediaSourceVideoID::fromCover_image_content_typeEnum(const Cover_image_content_typeEnum value) const
{
    switch(value)
    {
        ...
        case Cover_image_content_typeEnum::image/jpeg: return utility::conversions::to_string_t("image/jpeg");
        
        case Cover_image_content_typeEnum::image/png: return utility::conversions::to_string_t("image/png");
