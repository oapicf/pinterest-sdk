...
std::shared_ptr<Object> GoogleProductCategory1Filter::getGOOGLEPRODUCTCATEGORY1() const
{
    return m_GOOGLE_PRODUCT_CATEGORY_1;
}


void GoogleProductCategory1Filter::setGOOGLEPRODUCTCATEGORY1(const std::shared_ptr<Object>& value)
{
