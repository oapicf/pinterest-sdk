...
std::shared_ptr<AdGroupCommon_optimization_goal_metadata> AdGroupUpdateRequest::getOptimizationGoalMetadata() const
{
    return m_Optimization_goal_metadata;
}

void AdGroupUpdateRequest::setOptimizationGoalMetadata(const std::shared_ptr<AdGroupCommon_optimization_goal_metadata>& value)
{
