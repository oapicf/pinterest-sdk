...
web::json::value AdGroupUpdateRequest::toJson() const
{
    ...
    {   
        ...
        utility::string_t refVal = fromBid_strategy_typeEnum(m_Bid_strategy_type);
        val[utility::conversions::to_string_t(U("bid_strategy_type"))] = ModelBase::toJson(refVal);
...
void AdGroupUpdateRequest::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_Bid_strategy_typeIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(U("bid_strategy_type")), fromBid_strategy_typeEnum(m_Bid_strategy_type)));
    }
    if(m_Targeting_template_idsIsSet)
    {
