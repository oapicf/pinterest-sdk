...
void AdGroupUpdateRequest::setStatus(const EntityStatus& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}
...
void AdGroupUpdateRequest::setPlacementGroup(const PlacementGroupType& value)
{
...
void AdGroupUpdateRequest::setPacingDeliveryType(const PacingDeliveryType& value)
{
