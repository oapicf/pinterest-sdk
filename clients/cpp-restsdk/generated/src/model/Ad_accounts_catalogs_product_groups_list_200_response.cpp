...
void Ad_accounts_catalogs_product_groups_list_200_response::validate()
{
    // TODO: implement validation
}

web::json::value Ad_accounts_catalogs_product_groups_list_200_response::toJson() const
{
...
bool Ad_accounts_catalogs_product_groups_list_200_response::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("items"))))
    {
        ...
        {
            std::vector<std::shared_ptr<CatalogProductGroup>> refVal_setItems;
...
void Ad_accounts_catalogs_product_groups_list_200_response::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Ad_accounts_catalogs_product_groups_list_200_response::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<std::shared_ptr<CatalogProductGroup>>& Ad_accounts_catalogs_product_groups_list_200_response::getItems()
{
    return m_Items;
}

void Ad_accounts_catalogs_product_groups_list_200_response::setItems(const std::vector<std::shared_ptr<CatalogProductGroup>>& value)
{
    m_Items = value;
    m_ItemsIsSet = true;
}

bool Ad_accounts_catalogs_product_groups_list_200_response::itemsIsSet() const
{
    return m_ItemsIsSet;
}

void Ad_accounts_catalogs_product_groups_list_200_response::unsetItems()
{
    m_ItemsIsSet = false;
}
utility::string_t Ad_accounts_catalogs_product_groups_list_200_response::getBookmark() const
{
    return m_Bookmark;
}

void Ad_accounts_catalogs_product_groups_list_200_response::setBookmark(const utility::string_t& value)
{
    m_Bookmark = value;
