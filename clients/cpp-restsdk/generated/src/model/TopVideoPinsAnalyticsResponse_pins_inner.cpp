...
std::map<utility::string_t, std::shared_ptr<DataStatus>> TopVideoPinsAnalyticsResponse_pins_inner::getDataStatus() const
{
...
std::map<utility::string_t, double> TopVideoPinsAnalyticsResponse_pins_inner::getMetrics() const
{
    return m_Metrics;
}
