...
utility::string_t AdResponse::getCustomizableCtaType() const
{
    return m_Customizable_cta_type;
}

void AdResponse::setCustomizableCtaType(const utility::string_t& value)
{
...
std::shared_ptr<AdCommon_quiz_pin_data> AdResponse::getQuizPinData() const
{
    return m_Quiz_pin_data;
}

void AdResponse::setQuizPinData(const std::shared_ptr<AdCommon_quiz_pin_data>& value)
{
