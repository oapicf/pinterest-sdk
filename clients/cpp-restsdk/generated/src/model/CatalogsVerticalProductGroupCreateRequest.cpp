...
bool CatalogsVerticalProductGroupCreateRequest::fromJson(const web::json::value& val)
{
    bool ok = true;
...
bool CatalogsVerticalProductGroupCreateRequest::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t CatalogsVerticalProductGroupCreateRequest::getCatalogType() const
{
    return m_Catalog_type;
}

void CatalogsVerticalProductGroupCreateRequest::setCatalogType(const utility::string_t& value)
{
    m_Catalog_type = value;
    m_Catalog_typeIsSet = true;
}

bool CatalogsVerticalProductGroupCreateRequest::catalogTypeIsSet() const
{
    return m_Catalog_typeIsSet;
}

void CatalogsVerticalProductGroupCreateRequest::unsetCatalog_type()
{
    m_Catalog_typeIsSet = false;
}
utility::string_t CatalogsVerticalProductGroupCreateRequest::getName() const
{
    return m_Name;
}

void CatalogsVerticalProductGroupCreateRequest::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool CatalogsVerticalProductGroupCreateRequest::nameIsSet() const
{
    return m_NameIsSet;
}

void CatalogsVerticalProductGroupCreateRequest::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t CatalogsVerticalProductGroupCreateRequest::getDescription() const
{
    return m_Description;
}

void CatalogsVerticalProductGroupCreateRequest::setDescription(const utility::string_t& value)
{
    m_Description = value;
...
std::shared_ptr<CatalogsHotelProductGroupFilters> CatalogsVerticalProductGroupCreateRequest::getFilters() const
{
    return m_Filters;
}

void CatalogsVerticalProductGroupCreateRequest::setFilters(const std::shared_ptr<CatalogsHotelProductGroupFilters>& value)
{
    m_Filters = value;
    m_FiltersIsSet = true;
}

bool CatalogsVerticalProductGroupCreateRequest::filtersIsSet() const
{
    return m_FiltersIsSet;
}

void CatalogsVerticalProductGroupCreateRequest::unsetFilters()
{
    m_FiltersIsSet = false;
}
utility::string_t CatalogsVerticalProductGroupCreateRequest::getCatalogId() const
{
    return m_Catalog_id;
}

void CatalogsVerticalProductGroupCreateRequest::setCatalogId(const utility::string_t& value)
{
    m_Catalog_id = value;
    m_Catalog_idIsSet = true;
}

bool CatalogsVerticalProductGroupCreateRequest::catalogIdIsSet() const
{
    return m_Catalog_idIsSet;
}

void CatalogsVerticalProductGroupCreateRequest::unsetCatalog_id()
{
    m_Catalog_idIsSet = false;
}
}
