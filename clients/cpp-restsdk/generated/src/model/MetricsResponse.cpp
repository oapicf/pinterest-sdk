...
bool MetricsResponse::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::vector<std::shared_ptr<MetricsResponseDataItems>> refVal_setData;
...
void MetricsResponse::setData(const std::vector<std::shared_ptr<MetricsResponseDataItems>>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}
