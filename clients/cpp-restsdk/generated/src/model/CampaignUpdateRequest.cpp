...
std::shared_ptr<CampaignSummaryStatus> CampaignUpdateRequest::getSummaryStatus() const
{
    return m_Summary_status;
}

void CampaignUpdateRequest::setSummaryStatus(const std::shared_ptr<CampaignSummaryStatus>& value)
{
