...
std::vector<std::shared_ptr<AssetGroupType>> UpdateAssetGroupBody_asset_groups_to_update_inner::getAssetGroupTypes() const
{
...
std::vector<utility::string_t> UpdateAssetGroupBody_asset_groups_to_update_inner::getAssetsToAdd() const
{
...
std::vector<utility::string_t> UpdateAssetGroupBody_asset_groups_to_update_inner::getAssetsToRemove() const
{
