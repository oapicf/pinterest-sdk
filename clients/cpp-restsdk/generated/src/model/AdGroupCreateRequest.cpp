...
void AdGroupCreateRequest::setStatus(const EntityStatus& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}
...
void AdGroupCreateRequest::setPlacementGroup(const PlacementGroupType& value)
{
...
void AdGroupCreateRequest::setPacingDeliveryType(const PacingDeliveryType& value)
{
