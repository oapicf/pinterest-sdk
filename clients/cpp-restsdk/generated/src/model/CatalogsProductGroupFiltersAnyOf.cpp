...
std::vector<std::shared_ptr<Object>> CatalogsProductGroupFiltersAnyOf::getAnyOf() const
{
    return m_Any_of;
}


void CatalogsProductGroupFiltersAnyOf::setAnyOf(const std::vector<std::shared_ptr<Object>>& value)
{
    m_Any_of = value;
    m_Any_ofIsSet = true;
}
