...
bool AnalyticsMetricsResponse::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(U("daily_metrics"))))
    {
        ...
        {
            std::vector<std::shared_ptr<AnalyticsMetricsResponse_daily_metrics_inner>> refVal_setDailyMetrics;
...
std::vector<std::shared_ptr<AnalyticsMetricsResponse_daily_metrics_inner>>& AnalyticsMetricsResponse::getDailyMetrics()
{
    return m_Daily_metrics;
}

void AnalyticsMetricsResponse::setDailyMetrics(const std::vector<std::shared_ptr<AnalyticsMetricsResponse_daily_metrics_inner>>& value)
{
