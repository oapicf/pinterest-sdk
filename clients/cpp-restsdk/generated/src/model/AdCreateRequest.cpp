...
std::shared_ptr<AdCommon_tracking_urls> AdCreateRequest::getTrackingUrls() const
{
    return m_Tracking_urls;
}

void AdCreateRequest::setTrackingUrls(const std::shared_ptr<AdCommon_tracking_urls>& value)
{
...
std::shared_ptr<AdCommon_quiz_pin_data> AdCreateRequest::getQuizPinData() const
{
    return m_Quiz_pin_data;
}

void AdCreateRequest::setQuizPinData(const std::shared_ptr<AdCommon_quiz_pin_data>& value)
{
