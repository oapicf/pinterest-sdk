...
bool PinMediaSourceImagesBase64::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("items"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<PinMediaSourceImagesBase64Item>> refVal_setItems;
...
void PinMediaSourceImagesBase64::setItems(const std::vector<std::shared_ptr<PinMediaSourceImagesBase64Item>>& value)
{
    m_Items = value;
    m_ItemsIsSet = true;
}
