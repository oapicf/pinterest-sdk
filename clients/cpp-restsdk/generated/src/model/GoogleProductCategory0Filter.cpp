...
std::shared_ptr<Object> GoogleProductCategory0Filter::getGOOGLEPRODUCTCATEGORY0() const
{
    return m_GOOGLE_PRODUCT_CATEGORY_0;
}


void GoogleProductCategory0Filter::setGOOGLEPRODUCTCATEGORY0(const std::shared_ptr<Object>& value)
{
