...
web::json::value BidFloor::toJson() const
{
    ...
    if(m_Bid_floorsIsSet)
    {
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("bid_floors"))] = ModelBase::toJson(m_Bid_floors);
    }
    if(m_TypeIsSet)
    {
...
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("bid_floors"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(_XPLATSTR("bid_floors")));
...
void BidFloor::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_Bid_floorsIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("bid_floors")), m_Bid_floors));
    }
    if(m_TypeIsSet)
    {
...
bool BidFloor::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    if(multipart->hasContent(utility::conversions::to_string_t(_XPLATSTR("bid_floors"))))
    {
        std::vector<int32_t> refVal_setBidFloors;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(_XPLATSTR("bid_floors"))), refVal_setBidFloors );
        setBidFloors(refVal_setBidFloors);
    }
