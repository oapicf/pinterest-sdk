...
web::json::value IntegrationLogClientError::toJson() const
{
    ...
    if(m_CauseIsSet)
    {
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("cause"))] = ModelBase::toJson(m_Cause);
    }
    if(m_Column_numberIsSet)
    {
        
        val[utility::conversions::to_string_t(_XPLATSTR("column_number"))] = ModelBase::toJson(m_Column_number);
    }
    if(m_File_nameIsSet)
    {
    ...
    if(m_Message_detailIsSet)
    {
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("message_detail"))] = ModelBase::toJson(m_Message_detail);
    }
    if(m_NameIsSet)
    {
    ...
    if(m_Stack_traceIsSet)
    {
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("stack_trace"))] = ModelBase::toJson(m_Stack_trace);
    }
...
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("cause"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(_XPLATSTR("cause")));
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("column_number"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(_XPLATSTR("column_number")));
        if(!fieldValue.is_null())
        {
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("message_detail"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(_XPLATSTR("message_detail")));
        if(!fieldValue.is_null())
        {
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("stack_trace"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(_XPLATSTR("stack_trace")));
        if(!fieldValue.is_null())
        {
...
void IntegrationLogClientError::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_CauseIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("cause")), m_Cause));
    }
    if(m_Column_numberIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("column_number")), m_Column_number));
    }
    if(m_File_nameIsSet)
    {
    ...
    if(m_Message_detailIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("message_detail")), m_Message_detail));
    }
    if(m_NameIsSet)
    {
    ...
    if(m_Stack_traceIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("stack_trace")), m_Stack_trace));
    }
}
...
bool IntegrationLogClientError::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    if(multipart->hasContent(utility::conversions::to_string_t(_XPLATSTR("cause"))))
    {
        utility::string_t refVal_setCause;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(_XPLATSTR("cause"))), refVal_setCause );
        setCause(refVal_setCause);
    }
    if(multipart->hasContent(utility::conversions::to_string_t(_XPLATSTR("column_number"))))
    {
        int32_t refVal_setColumnNumber;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(_XPLATSTR("column_number"))), refVal_setColumnNumber );
        setColumnNumber(refVal_setColumnNumber);
    }
    ...
    if(multipart->hasContent(utility::conversions::to_string_t(_XPLATSTR("message_detail"))))
    {
        utility::string_t refVal_setMessageDetail;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(_XPLATSTR("message_detail"))), refVal_setMessageDetail );
        setMessageDetail(refVal_setMessageDetail);
    }
    ...
    if(multipart->hasContent(utility::conversions::to_string_t(_XPLATSTR("stack_trace"))))
    {
        utility::string_t refVal_setStackTrace;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(_XPLATSTR("stack_trace"))), refVal_setStackTrace );
        setStackTrace(refVal_setStackTrace);
    }
    return ok;
}
