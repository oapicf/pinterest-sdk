...
ProductAvailabilityType::eProductAvailabilityType toEnum(const EnumUnderlyingType& val)
{
    ...
    if (val == utility::conversions::to_string_t(U("null")))
        return ProductAvailabilityType::eProductAvailabilityType::ProductAvailabilityType_NULL;
    return {};
}
...
EnumUnderlyingType fromEnum(ProductAvailabilityType::eProductAvailabilityType e)
{
    ...
    case ProductAvailabilityType::eProductAvailabilityType::ProductAvailabilityType_PREORDER:
        return U("PREORDER");
    case ProductAvailabilityType::eProductAvailabilityType::ProductAvailabilityType_NULL:
        return U("null");
    default:
        break;
    }
