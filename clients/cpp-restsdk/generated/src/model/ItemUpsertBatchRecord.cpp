...
std::shared_ptr<ItemAttributes> ItemUpsertBatchRecord::getAttributes() const
{
    return m_Attributes;
}

void ItemUpsertBatchRecord::setAttributes(const std::shared_ptr<ItemAttributes>& value)
{
    m_Attributes = value;
