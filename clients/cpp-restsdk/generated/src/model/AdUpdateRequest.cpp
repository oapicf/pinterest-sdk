...
bool AdUpdateRequest::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(U("quiz_pin_data"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<AdCommon_quiz_pin_data> refVal_setQuizPinData;
...
utility::string_t AdUpdateRequest::getCustomizableCtaType() const
{
    return m_Customizable_cta_type;
}

void AdUpdateRequest::setCustomizableCtaType(const utility::string_t& value)
{
...
std::shared_ptr<AdCommon_quiz_pin_data> AdUpdateRequest::getQuizPinData() const
{
    return m_Quiz_pin_data;
}

void AdUpdateRequest::setQuizPinData(const std::shared_ptr<AdCommon_quiz_pin_data>& value)
{
