...
{
    if (val == utility::conversions::to_string_t(_XPLATSTR("DAILY")))
        return BudgetType::eBudgetType::DAILY;
    if (val == utility::conversions::to_string_t(_XPLATSTR("LIFETIME")))
        return BudgetType::eBudgetType::LIFETIME;
    if (val == utility::conversions::to_string_t(_XPLATSTR("CBO_ADGROUP")))
        return BudgetType::eBudgetType::CBO_ADGROUP;
    return {};
}
...
BudgetType::BudgetType(utility::string_t str){
