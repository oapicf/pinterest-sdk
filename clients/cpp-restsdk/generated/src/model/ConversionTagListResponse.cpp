...
std::vector<std::shared_ptr<ConversionTag>> ConversionTagListResponse::getItems() const
{
    return m_Items;
}


void ConversionTagListResponse::setItems(const std::vector<std::shared_ptr<ConversionTag>>& value)
{
    m_Items = value;
    m_ItemsIsSet = true;
}
