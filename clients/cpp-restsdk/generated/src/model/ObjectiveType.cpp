...
ObjectiveType::eObjectiveType toEnum(const EnumUnderlyingType& val)
{
    ...
    if (val == utility::conversions::to_string_t(U("VIDEO_COMPLETION")))
        return ObjectiveType::eObjectiveType::ObjectiveType_VIDEO_COMPLETION;
    return {};
}
...
EnumUnderlyingType fromEnum(ObjectiveType::eObjectiveType e)
{
    ...
    case ObjectiveType::eObjectiveType::ObjectiveType_VIDEO_COMPLETION:
        return U("VIDEO_COMPLETION");
    default:
        break;
    }
    return {};
