...
std::vector<std::shared_ptr<CatalogsHotelProductGroupFilterKeys>>& CatalogsHotelProductGroupFilters::getAnyOf()
{
    return m_Any_of;
}
...
std::vector<std::shared_ptr<CatalogsHotelProductGroupFilterKeys>>& CatalogsHotelProductGroupFilters::getAllOf()
{
    return m_All_of;
}
