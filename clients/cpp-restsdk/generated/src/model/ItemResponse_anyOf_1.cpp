...
std::shared_ptr<CatalogsType> ItemResponse_anyOf_1::getCatalogType() const
{
    return m_Catalog_type;
}

void ItemResponse_anyOf_1::setCatalogType(const std::shared_ptr<CatalogsType>& value)
{
    m_Catalog_type = value;
    m_Catalog_typeIsSet = true;
}

bool ItemResponse_anyOf_1::catalogTypeIsSet() const
{
    return m_Catalog_typeIsSet;
}

void ItemResponse_anyOf_1::unsetCatalog_type()
{
    m_Catalog_typeIsSet = false;
}
...
utility::string_t ItemResponse_anyOf_1::getHotelId() const
{
    return m_Hotel_id;
}

void ItemResponse_anyOf_1::setHotelId(const utility::string_t& value)
{
    m_Hotel_id = value;
