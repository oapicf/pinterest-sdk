...
void AdGroupCommon_tracking_urls::validate()
{
    // TODO: implement validation
}

web::json::value AdGroupCommon_tracking_urls::toJson() const
{
...
bool AdGroupCommon_tracking_urls::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void AdGroupCommon_tracking_urls::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool AdGroupCommon_tracking_urls::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<utility::string_t>& AdGroupCommon_tracking_urls::getImpression()
{
    return m_Impression;
}

void AdGroupCommon_tracking_urls::setImpression(const std::vector<utility::string_t>& value)
{
    m_Impression = value;
...
std::vector<utility::string_t>& AdGroupCommon_tracking_urls::getClick()
{
    return m_Click;
}

void AdGroupCommon_tracking_urls::setClick(const std::vector<utility::string_t>& value)
{
    m_Click = value;
    m_ClickIsSet = true;
}
...
std::vector<utility::string_t>& AdGroupCommon_tracking_urls::getEngagement()
{
    return m_Engagement;
}

void AdGroupCommon_tracking_urls::setEngagement(const std::vector<utility::string_t>& value)
{
    m_Engagement = value;
...
std::vector<utility::string_t>& AdGroupCommon_tracking_urls::getBuyableButton()
{
    return m_Buyable_button;
}

void AdGroupCommon_tracking_urls::setBuyableButton(const std::vector<utility::string_t>& value)
{
...
std::vector<utility::string_t>& AdGroupCommon_tracking_urls::getAudienceVerification()
{
    return m_Audience_verification;
}

void AdGroupCommon_tracking_urls::setAudienceVerification(const std::vector<utility::string_t>& value)
{
