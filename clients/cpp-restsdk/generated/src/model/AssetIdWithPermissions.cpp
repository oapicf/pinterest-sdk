...
void AssetIdWithPermissions::validate()
{
    // TODO: implement validation
}

web::json::value AssetIdWithPermissions::toJson() const
{
...
bool AssetIdWithPermissions::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void AssetIdWithPermissions::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool AssetIdWithPermissions::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t AssetIdWithPermissions::getId() const
{
    return m_Id;
}


void AssetIdWithPermissions::setId(const utility::string_t& value)
{
    m_Id = value;
    m_IdIsSet = true;
}
...
std::vector<utility::string_t> AssetIdWithPermissions::getPermissions() const
{
    return m_Permissions;
}


void AssetIdWithPermissions::setPermissions(const std::vector<utility::string_t>& value)
{
    m_Permissions = value;
