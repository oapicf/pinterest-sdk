...
void AdvancedAuctionOperationError::validate()
{
    // TODO: implement validation
}

web::json::value AdvancedAuctionOperationError::toJson() const
{
...
bool AdvancedAuctionOperationError::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void AdvancedAuctionOperationError::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool AdvancedAuctionOperationError::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t AdvancedAuctionOperationError::getMessage() const
{
    return m_Message;
}


void AdvancedAuctionOperationError::setMessage(const utility::string_t& value)
{
    m_Message = value;
    m_MessageIsSet = true;
}
