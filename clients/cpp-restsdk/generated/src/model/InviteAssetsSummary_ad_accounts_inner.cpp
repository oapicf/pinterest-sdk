...
void InviteAssetsSummary_ad_accounts_inner::validate()
{
    // TODO: implement validation
}

web::json::value InviteAssetsSummary_ad_accounts_inner::toJson() const
{
...
bool InviteAssetsSummary_ad_accounts_inner::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void InviteAssetsSummary_ad_accounts_inner::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool InviteAssetsSummary_ad_accounts_inner::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t InviteAssetsSummary_ad_accounts_inner::getId() const
{
    return m_Id;
}


void InviteAssetsSummary_ad_accounts_inner::setId(const utility::string_t& value)
{
    m_Id = value;
    m_IdIsSet = true;
}
...
std::vector<utility::string_t> InviteAssetsSummary_ad_accounts_inner::getPermissions() const
{
    return m_Permissions;
}


void InviteAssetsSummary_ad_accounts_inner::setPermissions(const std::vector<utility::string_t>& value)
{
    m_Permissions = value;
