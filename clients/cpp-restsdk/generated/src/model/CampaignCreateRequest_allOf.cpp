...
#include "CppRestOpenAPIClient/model/CampaignCreateRequest_allOf.h"
...
void CampaignCreateRequest_allOf::validate()
{
    // TODO: implement validation
}

web::json::value CampaignCreateRequest_allOf::toJson() const
{
...
bool CampaignCreateRequest_allOf::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CampaignCreateRequest_allOf::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CampaignCreateRequest_allOf::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::shared_ptr<ObjectiveType> CampaignCreateRequest_allOf::getObjectiveType() const
{
    return m_Objective_type;
}

void CampaignCreateRequest_allOf::setObjectiveType(const std::shared_ptr<ObjectiveType>& value)
{
    m_Objective_type = value;
    m_Objective_typeIsSet = true;
}

bool CampaignCreateRequest_allOf::objectiveTypeIsSet() const
{
    return m_Objective_typeIsSet;
}

void CampaignCreateRequest_allOf::unsetObjective_type()
{
    m_Objective_typeIsSet = false;
}
}
