...
std::shared_ptr<CatalogsType> CatalogsItemsBatch::getCatalogType() const
{
    return m_Catalog_type;
}

void CatalogsItemsBatch::setCatalogType(const std::shared_ptr<CatalogsType>& value)
{
    m_Catalog_type = value;
    m_Catalog_typeIsSet = true;
}

bool CatalogsItemsBatch::catalogTypeIsSet() const
{
    return m_Catalog_typeIsSet;
}

void CatalogsItemsBatch::unsetCatalog_type()
{
    m_Catalog_typeIsSet = false;
}
...
std::vector<std::shared_ptr<HotelProcessingRecord>>& CatalogsItemsBatch::getItems()
{
    return m_Items;
}

void CatalogsItemsBatch::setItems(const std::vector<std::shared_ptr<HotelProcessingRecord>>& value)
{
    m_Items = value;
    m_ItemsIsSet = true;
}
