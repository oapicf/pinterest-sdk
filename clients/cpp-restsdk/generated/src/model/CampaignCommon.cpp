...
std::shared_ptr<CampaignSummaryStatus> CampaignCommon::getSummaryStatus() const
{
    return m_Summary_status;
}

void CampaignCommon::setSummaryStatus(const std::shared_ptr<CampaignSummaryStatus>& value)
{
