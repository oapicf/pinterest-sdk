...
std::shared_ptr<Object> GoogleProductCategory3Filter::getGOOGLEPRODUCTCATEGORY3() const
{
    return m_GOOGLE_PRODUCT_CATEGORY_3;
}


void GoogleProductCategory3Filter::setGOOGLEPRODUCTCATEGORY3(const std::shared_ptr<Object>& value)
{
