...
std::vector<std::shared_ptr<CampaignSummaryStatus>> BulkDownloadRequest_campaign_filter::getCampaignStatus() const
{
...
std::vector<std::shared_ptr<ObjectiveType>> BulkDownloadRequest_campaign_filter::getObjectiveType() const
{
