...
bool Catalogs_product_groups_list_200_response::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(U("items"))))
    {
        ...
        {
            std::vector<std::shared_ptr<Catalogs_product_groups_list_200_response_allOf_items_inner>> refVal_setItems;
...
std::vector<std::shared_ptr<Catalogs_product_groups_list_200_response_allOf_items_inner>>& Catalogs_product_groups_list_200_response::getItems()
{
    return m_Items;
}

void Catalogs_product_groups_list_200_response::setItems(const std::vector<std::shared_ptr<Catalogs_product_groups_list_200_response_allOf_items_inner>>& value)
{
    m_Items = value;
    m_ItemsIsSet = true;
}
