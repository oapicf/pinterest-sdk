...
std::vector<std::shared_ptr<CatalogsProductGroup>>& Catalogs_product_groups_list_200_response::getItems()
{
    return m_Items;
}

void Catalogs_product_groups_list_200_response::setItems(const std::vector<std::shared_ptr<CatalogsProductGroup>>& value)
{
    m_Items = value;
    m_ItemsIsSet = true;
}
