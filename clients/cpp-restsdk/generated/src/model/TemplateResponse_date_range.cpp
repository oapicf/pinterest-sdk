...
web::json::value TemplateResponse_date_range::toJson() const
{
    ...
    if(m_Dynamic_date_range.has_value())
    {
        
        val[utility::conversions::to_string_t(_XPLATSTR("dynamic_date_range"))] = ModelBase::toJson(m_Dynamic_date_range.get());
    }
    if(m_Relative_date_range.has_value())
    {
        
        val[utility::conversions::to_string_t(_XPLATSTR("relative_date_range"))] = ModelBase::toJson(m_Relative_date_range.get());
    }
    if(m_Absolute_date_range.has_value())
    {
        
        val[utility::conversions::to_string_t(_XPLATSTR("absolute_date_range"))] = ModelBase::toJson(m_Absolute_date_range.get());
    }
...
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("dynamic_date_range"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(_XPLATSTR("dynamic_date_range")));
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("relative_date_range"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(_XPLATSTR("relative_date_range")));
        if(!fieldValue.is_null())
        {
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("absolute_date_range"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(_XPLATSTR("absolute_date_range")));
        if(!fieldValue.is_null())
        {
...
void TemplateResponse_date_range::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_Dynamic_date_range.has_value())
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("dynamic_date_range")), m_Dynamic_date_range.get()));
    }
    if(m_Relative_date_range.has_value())
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("relative_date_range")), m_Relative_date_range.get()));
    }
    if(m_Absolute_date_range.has_value())
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("absolute_date_range")), m_Absolute_date_range.get()));
    }
}
...
bool TemplateResponse_date_range::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    if(multipart->hasContent(utility::conversions::to_string_t(_XPLATSTR("dynamic_date_range"))))
    {
        std::shared_ptr<TemplateResponse_date_range_dynamic_date_range> refVal_setDynamicDateRange;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(_XPLATSTR("dynamic_date_range"))), refVal_setDynamicDateRange );
        setDynamicDateRange(refVal_setDynamicDateRange);
    }
    if(multipart->hasContent(utility::conversions::to_string_t(_XPLATSTR("relative_date_range"))))
    {
        std::shared_ptr<TemplateResponse_date_range_relative_date_range> refVal_setRelativeDateRange;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(_XPLATSTR("relative_date_range"))), refVal_setRelativeDateRange );
        setRelativeDateRange(refVal_setRelativeDateRange);
    }
    if(multipart->hasContent(utility::conversions::to_string_t(_XPLATSTR("absolute_date_range"))))
    {
        std::shared_ptr<TemplateResponse_date_range_absolute_date_range> refVal_setAbsoluteDateRange;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(_XPLATSTR("absolute_date_range"))), refVal_setAbsoluteDateRange );
        setAbsoluteDateRange(refVal_setAbsoluteDateRange);
    }
    return ok;
}
...
{
    return m_Dynamic_date_range.get();
}
...
{
    return m_Absolute_date_range.has_value();
}

void TemplateResponse_date_range::unsetAbsolute_date_range()
{
    m_Absolute_date_range.reset();
}
