...
utility::string_t OauthAccessTokenResponseRefresh::getResponseType() const
{
    return m_Response_type;
}

void OauthAccessTokenResponseRefresh::setResponseType(const utility::string_t& value)
{
