...
void UpdatePartnerAssetsResult::setAssetType(const std::shared_ptr<AssetTypeResponse>& value)
{
    m_Asset_type = value;
...
std::vector<utility::string_t> UpdatePartnerAssetsResult::getPermissions() const
{
