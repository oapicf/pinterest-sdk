...
DeliveryMetricsResponse_items_inner::CategoryEnum DeliveryMetricsResponse_items_inner::toCategoryEnum(const utility::string_t& value) const
{
...
const utility::string_t DeliveryMetricsResponse_items_inner::fromCategoryEnum(const CategoryEnum value) const
{
    switch(value)
    {
...
DeliveryMetricsResponse_items_inner::CategoryEnum DeliveryMetricsResponse_items_inner::getCategory() const
{
    return m_Category;
}


void DeliveryMetricsResponse_items_inner::setCategory(const CategoryEnum value)
{
    m_Category = value;
