...
std::shared_ptr<CatalogsItemsRequest_language> CatalogsItemsUpdateBatchRequest::getLanguage() const
{
    return m_Language;
}


void CatalogsItemsUpdateBatchRequest::setLanguage(const std::shared_ptr<CatalogsItemsRequest_language>& value)
{
    m_Language = value;
