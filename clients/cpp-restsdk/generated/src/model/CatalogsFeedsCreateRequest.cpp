...
std::shared_ptr<CatalogsCreativeAssetsFeedsCreateRequest_default_locale> CatalogsFeedsCreateRequest::getDefaultLocale() const
{
    return m_Default_locale;
}


void CatalogsFeedsCreateRequest::setDefaultLocale(const std::shared_ptr<CatalogsCreativeAssetsFeedsCreateRequest_default_locale>& value)
{
