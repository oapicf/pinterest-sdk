...
web::json::value CreateMMMReportRequest::toJson() const
{
    ...
    {   
        ...
        val[utility::conversions::to_string_t(U("granularity"))] = ModelBase::toJson(refVal);
    ...
    {   
        ...
        val[utility::conversions::to_string_t(U("level"))] = ModelBase::toJson(refVal);
...
void CreateMMMReportRequest::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_GranularityIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(U("granularity")), fromGranularityEnum(m_Granularity)));
    }
    if(m_LevelIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(U("level")), fromLevelEnum(m_Level)));
    }
    if(m_Targeting_typesIsSet)
    {
