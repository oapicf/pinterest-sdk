...
void BulkDownload::validate()
{
    // TODO: implement validation
}

web::json::value BulkDownload::toJson() const
{
...
bool BulkDownload::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void BulkDownload::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BulkDownload::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t BulkDownload::getRequestId() const
{
    return m_Request_id;
}


void BulkDownload::setRequestId(const utility::string_t& value)
{
    m_Request_id = value;
