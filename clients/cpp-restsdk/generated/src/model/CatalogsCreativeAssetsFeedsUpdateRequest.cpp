...
CatalogsCreativeAssetsFeedsUpdateRequest::Catalog_typeEnum CatalogsCreativeAssetsFeedsUpdateRequest::toCatalog_typeEnum(const utility::string_t& value) const
{
...
const utility::string_t CatalogsCreativeAssetsFeedsUpdateRequest::fromCatalog_typeEnum(const Catalog_typeEnum value) const
{
    switch(value)
    {
...
CatalogsCreativeAssetsFeedsUpdateRequest::Catalog_typeEnum CatalogsCreativeAssetsFeedsUpdateRequest::getCatalogType() const
{
    return m_Catalog_type;
}


void CatalogsCreativeAssetsFeedsUpdateRequest::setCatalogType(const Catalog_typeEnum value)
{
