...
std::shared_ptr<UpdatableItemAttributes> ItemBatchRecord::getAttributes() const
{
    return m_Attributes;
}

void ItemBatchRecord::setAttributes(const std::shared_ptr<UpdatableItemAttributes>& value)
{
    m_Attributes = value;
