...
web::json::value AdGroupResponse::toJson() const
{
    ...
    {   
        ...
        utility::string_t refVal = fromConversion_learning_mode_typeEnum(m_Conversion_learning_mode_type);
        val[utility::conversions::to_string_t(U("conversion_learning_mode_type"))] = ModelBase::toJson(refVal);
...
void AdGroupResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_Conversion_learning_mode_typeIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(U("conversion_learning_mode_type")), fromConversion_learning_mode_typeEnum(m_Conversion_learning_mode_type)));
    }
    if(m_Summary_statusIsSet)
    {
