...
std::shared_ptr<AdGroupCommon_optimization_goal_metadata> AdGroupResponse::getOptimizationGoalMetadata() const
{
    return m_Optimization_goal_metadata;
}

void AdGroupResponse::setOptimizationGoalMetadata(const std::shared_ptr<AdGroupCommon_optimization_goal_metadata>& value)
{
