...
web::json::value BulkUpsertRequest::toJson() const
{
    ...
    if(m_UpdateIsSet)
    {
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("update"))] = ModelBase::toJson(m_Update);
    }
...
bool BulkUpsertRequest::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("update"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(_XPLATSTR("update")));
        if(!fieldValue.is_null())
        {
...
void BulkUpsertRequest::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_UpdateIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("update")), m_Update));
    }
}
...
bool BulkUpsertRequest::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    if(multipart->hasContent(utility::conversions::to_string_t(_XPLATSTR("update"))))
    {
        std::shared_ptr<BulkUpsertRequestUpdate> refVal_setUpdate;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(_XPLATSTR("update"))), refVal_setUpdate );
        setUpdate(refVal_setUpdate);
    }
    return ok;
}
