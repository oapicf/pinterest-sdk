...
std::shared_ptr<AudienceType> AudienceCreateRequest::getAudienceType() const
{
    return m_Audience_type;
}


void AudienceCreateRequest::setAudienceType(const std::shared_ptr<AudienceType>& value)
{
