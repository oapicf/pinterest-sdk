...
std::shared_ptr<ItemAttributes> CatalogsUpsertRetailItem::getAttributes() const
{
    return m_Attributes;
}

void CatalogsUpsertRetailItem::setAttributes(const std::shared_ptr<ItemAttributes>& value)
{
    m_Attributes = value;
