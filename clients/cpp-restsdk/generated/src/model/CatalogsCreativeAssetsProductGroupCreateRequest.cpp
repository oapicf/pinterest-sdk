...
utility::string_t CatalogsCreativeAssetsProductGroupCreateRequest::getCatalogType() const
{
    return m_Catalog_type;
}

void CatalogsCreativeAssetsProductGroupCreateRequest::setCatalogType(const utility::string_t& value)
{
