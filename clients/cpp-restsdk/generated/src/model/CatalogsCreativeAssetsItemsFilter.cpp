...
utility::string_t CatalogsCreativeAssetsItemsFilter::getCatalogType() const
{
    return m_Catalog_type;
}

void CatalogsCreativeAssetsItemsFilter::setCatalogType(const utility::string_t& value)
{
...
std::vector<utility::string_t>& CatalogsCreativeAssetsItemsFilter::getCreativeAssetsIds()
{
