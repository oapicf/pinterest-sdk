...
std::shared_ptr<CampaignSummaryStatus> CampaignCreateCommon::getSummaryStatus() const
{
    return m_Summary_status;
}

void CampaignCreateCommon::setSummaryStatus(const std::shared_ptr<CampaignSummaryStatus>& value)
{
