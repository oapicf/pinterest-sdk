...
std::shared_ptr<ObjectiveType> CampaignCreateCommon::getObjectiveType() const
{
    return m_Objective_type;
}

void CampaignCreateCommon::setObjectiveType(const std::shared_ptr<ObjectiveType>& value)
{
