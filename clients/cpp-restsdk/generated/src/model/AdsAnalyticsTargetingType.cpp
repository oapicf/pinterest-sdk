...
AdsAnalyticsTargetingType::eAdsAnalyticsTargetingType toEnum(const EnumUnderlyingType& val)
{
    ...
    if (val == utility::conversions::to_string_t(U("AGE_BUCKET_AND_GENDER")))
        return AdsAnalyticsTargetingType::eAdsAnalyticsTargetingType::AdsAnalyticsTargetingType_AGE_BUCKET_AND_GENDER;
    return {};
}
...
EnumUnderlyingType fromEnum(AdsAnalyticsTargetingType::eAdsAnalyticsTargetingType e)
{
    ...
    case AdsAnalyticsTargetingType::eAdsAnalyticsTargetingType::AdsAnalyticsTargetingType_REGION:
        return U("REGION");
    case AdsAnalyticsTargetingType::eAdsAnalyticsTargetingType::AdsAnalyticsTargetingType_AGE_BUCKET_AND_GENDER:
