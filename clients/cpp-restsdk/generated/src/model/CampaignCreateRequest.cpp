...
std::shared_ptr<CampaignSummaryStatus> CampaignCreateRequest::getSummaryStatus() const
{
    return m_Summary_status;
}

void CampaignCreateRequest::setSummaryStatus(const std::shared_ptr<CampaignSummaryStatus>& value)
{
