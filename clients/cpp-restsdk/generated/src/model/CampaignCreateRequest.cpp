...
std::shared_ptr<AdCommon_tracking_urls> CampaignCreateRequest::getTrackingUrls() const
{
    return m_Tracking_urls;
}

void CampaignCreateRequest::setTrackingUrls(const std::shared_ptr<AdCommon_tracking_urls>& value)
{
