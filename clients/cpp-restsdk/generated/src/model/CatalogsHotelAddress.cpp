...
web::json::value CatalogsHotelAddress::toJson() const
{
    ...
    if(m_Addr1IsSet)
    {
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("addr1"))] = ModelBase::toJson(m_Addr1);
    }
    if(m_CityIsSet)
    {
...
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("addr1"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(_XPLATSTR("addr1")));
...
void CatalogsHotelAddress::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_Addr1IsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("addr1")), m_Addr1));
    }
    if(m_CityIsSet)
    {
...
bool CatalogsHotelAddress::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    if(multipart->hasContent(utility::conversions::to_string_t(_XPLATSTR("addr1"))))
    {
        utility::string_t refVal_setAddr1;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(_XPLATSTR("addr1"))), refVal_setAddr1 );
        setAddr1(refVal_setAddr1);
    }
