...
utility::string_t OauthAccessTokenRequestClientCredentials::getGrantType() const
{
    return m_Grant_type;
}

void OauthAccessTokenRequestClientCredentials::setGrantType(const utility::string_t& value)
{
    m_Grant_type = value;
