...
web::json::value AudienceCreateCustomRequest::toJson() const
{
    ...
    if(m_Sharing_typeIsSet)
    {
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("sharing_type"))] = ModelBase::toJson(m_Sharing_type);
    }
    if(m_Data_partyIsSet)
    {
        
        val[utility::conversions::to_string_t(_XPLATSTR("data_party"))] = ModelBase::toJson(m_Data_party);
    }
    if(m_CategoryIsSet)
    {
...
bool AudienceCreateCustomRequest::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("sharing_type"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(_XPLATSTR("sharing_type")));
        if(!fieldValue.is_null())
        {
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data_party"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(_XPLATSTR("data_party")));
        if(!fieldValue.is_null())
        {
...
void AudienceCreateCustomRequest::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_Sharing_typeIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("sharing_type")), m_Sharing_type));
    }
    if(m_Data_partyIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("data_party")), m_Data_party));
    }
    if(m_CategoryIsSet)
    {
...
bool AudienceCreateCustomRequest::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    if(multipart->hasContent(utility::conversions::to_string_t(_XPLATSTR("sharing_type"))))
    {
        std::shared_ptr<AudienceSharingType> refVal_setSharingType;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(_XPLATSTR("sharing_type"))), refVal_setSharingType );
        setSharingType(refVal_setSharingType);
    }
    if(multipart->hasContent(utility::conversions::to_string_t(_XPLATSTR("data_party"))))
    {
        std::shared_ptr<AudienceDataParty> refVal_setDataParty;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(_XPLATSTR("data_party"))), refVal_setDataParty );
        setDataParty(refVal_setDataParty);
    }
