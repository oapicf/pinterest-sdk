...
web::json::value TargetingTemplateUpdateRequest::toJson() const
{
    ...
    {   
        ...
        val[utility::conversions::to_string_t(U("operation_type"))] = ModelBase::toJson(refVal);
...
void TargetingTemplateUpdateRequest::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_Operation_typeIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(U("operation_type")), fromOperation_typeEnum(m_Operation_type)));
    }
    if(m_IdIsSet)
    {
