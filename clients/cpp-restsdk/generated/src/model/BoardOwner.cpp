...
void BoardOwner::validate()
{
    // TODO: implement validation
}

web::json::value BoardOwner::toJson() const
{
...
bool BoardOwner::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void BoardOwner::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BoardOwner::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t BoardOwner::getUsername() const
{
    return m_Username;
}


void BoardOwner::setUsername(const utility::string_t& value)
{
    m_Username = value;
