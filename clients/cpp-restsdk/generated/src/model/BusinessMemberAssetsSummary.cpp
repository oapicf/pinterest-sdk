...
std::vector<std::shared_ptr<BusinessMemberAssetsSummary_ad_accounts_inner>> BusinessMemberAssetsSummary::getAdAccounts() const
{
...
std::vector<std::shared_ptr<BusinessMemberAssetsSummary_profiles_inner>> BusinessMemberAssetsSummary::getProfiles() const
{
    return m_Profiles;
}
