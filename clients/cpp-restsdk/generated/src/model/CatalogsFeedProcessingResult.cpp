...
web::json::value CatalogsFeedProcessingResult::toJson() const
{
    ...
    if(m_Video_countsIsSet)
    {
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("video_counts"))] = ModelBase::toJson(m_Video_counts);
    }
...
bool CatalogsFeedProcessingResult::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("video_counts"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(_XPLATSTR("video_counts")));
        if(!fieldValue.is_null())
        {
            std::shared_ptr<CatalogsFeedVideoCounts> refVal_setVideoCounts;
            ok &= ModelBase::fromJson(fieldValue, refVal_setVideoCounts);
            setVideoCounts(refVal_setVideoCounts);
...
void CatalogsFeedProcessingResult::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_Video_countsIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("video_counts")), m_Video_counts));
    }
}
...
bool CatalogsFeedProcessingResult::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    if(multipart->hasContent(utility::conversions::to_string_t(_XPLATSTR("video_counts"))))
    {
        std::shared_ptr<CatalogsFeedVideoCounts> refVal_setVideoCounts;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(_XPLATSTR("video_counts"))), refVal_setVideoCounts );
        setVideoCounts(refVal_setVideoCounts);
    }
    return ok;
}
...
void CatalogsFeedProcessingResult::setVideoCounts(const std::shared_ptr<CatalogsFeedVideoCounts>& value)
{
