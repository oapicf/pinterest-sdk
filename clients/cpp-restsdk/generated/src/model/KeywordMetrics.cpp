...
web::json::value KeywordMetrics::toJson() const
{
    ...
    if(m_Avg_cpc_in_micro_currencyIsSet)
    {
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("avg_cpc_in_micro_currency"))] = ModelBase::toJson(m_Avg_cpc_in_micro_currency);
    }
...
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("avg_cpc_in_micro_currency"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(_XPLATSTR("avg_cpc_in_micro_currency")));
...
void KeywordMetrics::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_Avg_cpc_in_micro_currencyIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("avg_cpc_in_micro_currency")), m_Avg_cpc_in_micro_currency));
    }
    if(m_Keyword_query_volumeIsSet)
    {
...
bool KeywordMetrics::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    if(multipart->hasContent(utility::conversions::to_string_t(_XPLATSTR("avg_cpc_in_micro_currency"))))
    {
        double refVal_setAvgCpcInMicroCurrency;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(_XPLATSTR("avg_cpc_in_micro_currency"))), refVal_setAvgCpcInMicroCurrency );
        setAvgCpcInMicroCurrency(refVal_setAvgCpcInMicroCurrency);
    }
