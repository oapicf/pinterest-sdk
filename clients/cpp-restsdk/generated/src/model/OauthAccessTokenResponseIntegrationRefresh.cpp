...
web::json::value OauthAccessTokenResponseIntegrationRefresh::toJson() const
{
    ...
    {   
        ...
        val[utility::conversions::to_string_t(U("response_type"))] = ModelBase::toJson(refVal);
...
void OauthAccessTokenResponseIntegrationRefresh::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_Response_typeIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(U("response_type")), fromResponse_typeEnum(m_Response_type)));
    }
    if(m_Access_tokenIsSet)
    {
