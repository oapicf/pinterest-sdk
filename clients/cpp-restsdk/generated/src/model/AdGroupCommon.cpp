...
std::shared_ptr<AdGroupCommon_optimization_goal_metadata> AdGroupCommon::getOptimizationGoalMetadata() const
{
    return m_Optimization_goal_metadata;
}

void AdGroupCommon::setOptimizationGoalMetadata(const std::shared_ptr<AdGroupCommon_optimization_goal_metadata>& value)
{
...
std::shared_ptr<AdGroupCommon_tracking_urls> AdGroupCommon::getTrackingUrls() const
{
    return m_Tracking_urls;
}

void AdGroupCommon::setTrackingUrls(const std::shared_ptr<AdGroupCommon_tracking_urls>& value)
{
