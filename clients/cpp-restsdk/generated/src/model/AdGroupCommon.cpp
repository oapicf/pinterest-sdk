...
std::map<utility::string_t, std::vector<utility::string_t>>& AdGroupCommon::getTargetingSpec()
{
    return m_Targeting_spec;
}

void AdGroupCommon::setTargetingSpec(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
