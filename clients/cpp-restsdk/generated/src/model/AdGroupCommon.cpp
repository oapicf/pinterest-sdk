...
void AdGroupCommon::setStatus(const EntityStatus& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}
...
void AdGroupCommon::setPlacementGroup(const PlacementGroupType& value)
{
...
void AdGroupCommon::setPacingDeliveryType(const PacingDeliveryType& value)
{
