...
utility::string_t AdGroupCommon::getBidStrategyType() const
{
    return m_Bid_strategy_type;
}

void AdGroupCommon::setBidStrategyType(const utility::string_t& value)
{
...
std::vector<utility::string_t>& AdGroupCommon::getTargetingTemplateIds()
{
