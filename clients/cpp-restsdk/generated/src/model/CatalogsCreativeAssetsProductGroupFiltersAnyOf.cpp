...
std::vector<std::shared_ptr<Object>> CatalogsCreativeAssetsProductGroupFiltersAnyOf::getAnyOf() const
{
    return m_Any_of;
}


void CatalogsCreativeAssetsProductGroupFiltersAnyOf::setAnyOf(const std::vector<std::shared_ptr<Object>>& value)
{
    m_Any_of = value;
    m_Any_ofIsSet = true;
}
