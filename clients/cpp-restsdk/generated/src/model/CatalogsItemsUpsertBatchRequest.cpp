...
std::shared_ptr<CatalogsItemsRequest_language> CatalogsItemsUpsertBatchRequest::getLanguage() const
{
    return m_Language;
}


void CatalogsItemsUpsertBatchRequest::setLanguage(const std::shared_ptr<CatalogsItemsRequest_language>& value)
{
    m_Language = value;
