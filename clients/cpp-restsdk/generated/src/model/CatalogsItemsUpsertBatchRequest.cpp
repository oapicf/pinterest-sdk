...
std::shared_ptr<Language> CatalogsItemsUpsertBatchRequest::getLanguage() const
{
    return m_Language;
}

void CatalogsItemsUpsertBatchRequest::setLanguage(const std::shared_ptr<Language>& value)
{
    m_Language = value;
