...
web::json::value RelatedTerms::toJson() const
{
    ...
    if(m_Related_term_countIsSet)
    {
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("related_term_count"))] = ModelBase::toJson(m_Related_term_count);
    }
    if(m_Related_terms_listIsSet)
    {
        
        val[utility::conversions::to_string_t(_XPLATSTR("related_terms_list"))] = ModelBase::toJson(m_Related_terms_list);
    }
...
bool RelatedTerms::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("related_term_count"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(_XPLATSTR("related_term_count")));
        if(!fieldValue.is_null())
        {
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("related_terms_list"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(_XPLATSTR("related_terms_list")));
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<RelatedTermsRelatedTermsListItems>> refVal_setRelatedTermsList;
...
void RelatedTerms::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_Related_term_countIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("related_term_count")), m_Related_term_count));
    }
    if(m_Related_terms_listIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("related_terms_list")), m_Related_terms_list));
    }
}
...
bool RelatedTerms::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    if(multipart->hasContent(utility::conversions::to_string_t(_XPLATSTR("related_term_count"))))
    {
        int32_t refVal_setRelatedTermCount;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(_XPLATSTR("related_term_count"))), refVal_setRelatedTermCount );
        setRelatedTermCount(refVal_setRelatedTermCount);
    }
    if(multipart->hasContent(utility::conversions::to_string_t(_XPLATSTR("related_terms_list"))))
    {
        std::vector<std::shared_ptr<RelatedTermsRelatedTermsListItems>> refVal_setRelatedTermsList;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(_XPLATSTR("related_terms_list"))), refVal_setRelatedTermsList );
        setRelatedTermsList(refVal_setRelatedTermsList);
    }
    return ok;
}
...
void RelatedTerms::setRelatedTermsList(const std::vector<std::shared_ptr<RelatedTermsRelatedTermsListItems>>& value)
{
