...
web::json::value CatalogsReportFeedIngestionStats::toJson() const
{
    ...
    {   
        ...
        val[utility::conversions::to_string_t(U("severity"))] = ModelBase::toJson(refVal);
...
void CatalogsReportFeedIngestionStats::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_SeverityIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(U("severity")), fromSeverityEnum(m_Severity)));
    }
}
