...
std::shared_ptr<CatalogsType> CatalogsHotelBatchRequest::getCatalogType() const
{
    return m_Catalog_type;
}

void CatalogsHotelBatchRequest::setCatalogType(const std::shared_ptr<CatalogsType>& value)
{
...
std::shared_ptr<Language> CatalogsHotelBatchRequest::getLanguage() const
{
    return m_Language;
}

void CatalogsHotelBatchRequest::setLanguage(const std::shared_ptr<Language>& value)
{
    m_Language = value;
