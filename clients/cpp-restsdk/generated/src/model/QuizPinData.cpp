...
web::json::value QuizPinData::toJson() const
{
    ...
    if(m_Tie_breaker_typeIsSet)
    {
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("tie_breaker_type"))] = ModelBase::toJson(m_Tie_breaker_type);
    }
...
bool QuizPinData::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("tie_breaker_type"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<TieBreakerType> refVal_setTieBreakerType;
...
void QuizPinData::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_Tie_breaker_typeIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("tie_breaker_type")), m_Tie_breaker_type));
    }
}
...
void QuizPinData::setTieBreakerType(const std::shared_ptr<TieBreakerType>& value)
{
