...
web::json::value QuizPinData::toJson() const
{
    ...
    {   
        ...
        val[utility::conversions::to_string_t(U("tie_breaker_type"))] = ModelBase::toJson(refVal);
...
void QuizPinData::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_Tie_breaker_typeIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(U("tie_breaker_type")), fromTie_breaker_typeEnum(m_Tie_breaker_type)));
    }
    if(m_Tie_breaker_custom_resultIsSet)
    {
