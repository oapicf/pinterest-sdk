...
std::vector<std::shared_ptr<Object>> CatalogsProductGroupFiltersRequest_anyOf_1::getAllOf() const
{
    return m_All_of;
}


void CatalogsProductGroupFiltersRequest_anyOf_1::setAllOf(const std::vector<std::shared_ptr<Object>>& value)
{
    m_All_of = value;
    m_All_ofIsSet = true;
}
