...
std::shared_ptr<Object> GoogleProductCategory5Filter::getGOOGLEPRODUCTCATEGORY5() const
{
    return m_GOOGLE_PRODUCT_CATEGORY_5;
}


void GoogleProductCategory5Filter::setGOOGLEPRODUCTCATEGORY5(const std::shared_ptr<Object>& value)
{
