...
web::json::value CatalogsFeedIngestionErrors::toJson() const
{
    ...
    {   
        ...
        val[utility::conversions::to_string_t(U("LARGE_PRODUCT_COUNT_DECREASE"))] = ModelBase::toJson(refVal);
...
void CatalogsFeedIngestionErrors::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_LARGE_PRODUCT_COUNT_DECREASEIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(U("LARGE_PRODUCT_COUNT_DECREASE")), fromLARGE_PRODUCT_COUNT_DECREASEEnum(m_LARGE_PRODUCT_COUNT_DECREASE)));
    }
    if(m_ACCOUNT_FLAGGEDIsSet)
    {
...
CatalogsFeedIngestionErrors::LARGE_PRODUCT_COUNT_DECREASEEnum CatalogsFeedIngestionErrors::toLARGE_PRODUCT_COUNT_DECREASEEnum(const int32_t& value) const
{
    ...
    if (value == utility::conversions::to_string_t("1")) {
        return LARGE_PRODUCT_COUNT_DECREASEEnum::1;
    }
...
const int32_t CatalogsFeedIngestionErrors::fromLARGE_PRODUCT_COUNT_DECREASEEnum(const LARGE_PRODUCT_COUNT_DECREASEEnum value) const
{
    switch(value)
    {
        ...
        case LARGE_PRODUCT_COUNT_DECREASEEnum::1: return utility::conversions::to_string_t("1");
