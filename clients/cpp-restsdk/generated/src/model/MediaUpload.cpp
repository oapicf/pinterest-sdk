...
web::json::value MediaUpload::toJson() const
{
    ...
    if(m_Upload_parametersIsSet)
    {
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("upload_parameters"))] = ModelBase::toJson(m_Upload_parameters);
    }
...
bool MediaUpload::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("upload_parameters"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(_XPLATSTR("upload_parameters")));
        if(!fieldValue.is_null())
        {
            std::shared_ptr<MediaUploadParameters> refVal_setUploadParameters;
...
void MediaUpload::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_Upload_parametersIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("upload_parameters")), m_Upload_parameters));
    }
    if(m_Upload_urlIsSet)
    {
...
bool MediaUpload::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    if(multipart->hasContent(utility::conversions::to_string_t(_XPLATSTR("upload_parameters"))))
    {
        std::shared_ptr<MediaUploadParameters> refVal_setUploadParameters;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(_XPLATSTR("upload_parameters"))), refVal_setUploadParameters );
        setUploadParameters(refVal_setUploadParameters);
    }
...
void MediaUpload::setUploadParameters(const std::shared_ptr<MediaUploadParameters>& value)
{
