...
web::json::value CatalogsHotelGuestRatings::toJson() const
{
    ...
    if(m_Number_of_reviewersIsSet)
    {
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("number_of_reviewers"))] = ModelBase::toJson(m_Number_of_reviewers);
    }
    if(m_Max_scoreIsSet)
    {
        
        val[utility::conversions::to_string_t(_XPLATSTR("max_score"))] = ModelBase::toJson(m_Max_score);
    }
    if(m_Rating_systemIsSet)
    {
        
        val[utility::conversions::to_string_t(_XPLATSTR("rating_system"))] = ModelBase::toJson(m_Rating_system);
    }
...
void CatalogsHotelGuestRatings::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_Number_of_reviewersIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("number_of_reviewers")), m_Number_of_reviewers));
    }
    if(m_Max_scoreIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("max_score")), m_Max_score));
    }
    if(m_Rating_systemIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("rating_system")), m_Rating_system));
    }
}
