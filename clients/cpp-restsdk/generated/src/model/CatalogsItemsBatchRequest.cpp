...
std::vector<std::shared_ptr<ItemDeleteDiscontinuedBatchRecord>>& CatalogsItemsBatchRequest::getItems()
{
    return m_Items;
}

void CatalogsItemsBatchRequest::setItems(const std::vector<std::shared_ptr<ItemDeleteDiscontinuedBatchRecord>>& value)
{
    m_Items = value;
    m_ItemsIsSet = true;
}
