...
std::vector<std::shared_ptr<ItemDeleteBatchRecord>>& CatalogsItemsBatchRequest::getItems()
{
    return m_Items;
}

void CatalogsItemsBatchRequest::setItems(const std::vector<std::shared_ptr<ItemDeleteBatchRecord>>& value)
{
    m_Items = value;
    m_ItemsIsSet = true;
}
