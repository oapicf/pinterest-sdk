...
web::json::value TermsOfService::toJson() const
{
    ...
    if(m_Has_acceptedIsSet)
    {
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("has_accepted"))] = ModelBase::toJson(m_Has_accepted);
    }
    if(m_Html.has_value())
    {
        
        val[utility::conversions::to_string_t(_XPLATSTR("html"))] = ModelBase::toJson(m_Html.get());
    }
    if(m_IdIsSet)
    {
...
bool TermsOfService::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("has_accepted"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(_XPLATSTR("has_accepted")));
        if(!fieldValue.is_null())
        {
...
void TermsOfService::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_Has_acceptedIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("has_accepted")), m_Has_accepted));
    }
    if(m_Html.has_value())
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("html")), m_Html.get()));
    }
    if(m_IdIsSet)
    {
...
bool TermsOfService::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    if(multipart->hasContent(utility::conversions::to_string_t(_XPLATSTR("has_accepted"))))
    {
        bool refVal_setHasAccepted;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(_XPLATSTR("has_accepted"))), refVal_setHasAccepted );
        setHasAccepted(refVal_setHasAccepted);
    }
