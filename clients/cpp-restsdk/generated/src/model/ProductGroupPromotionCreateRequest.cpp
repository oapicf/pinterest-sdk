...
bool ProductGroupPromotionCreateRequest::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(U("product_group_promotion"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<Items>> refVal_setProductGroupPromotion;
...
std::vector<std::shared_ptr<Items>>& ProductGroupPromotionCreateRequest::getProductGroupPromotion()
{
    return m_Product_group_promotion;
}

void ProductGroupPromotionCreateRequest::setProductGroupPromotion(const std::vector<std::shared_ptr<Items>>& value)
{
