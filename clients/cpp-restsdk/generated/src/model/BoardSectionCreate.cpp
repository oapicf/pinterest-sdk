...
void BoardSectionCreate::validate()
{
    // TODO: implement validation
}

web::json::value BoardSectionCreate::toJson() const
{
...
bool BoardSectionCreate::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void BoardSectionCreate::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BoardSectionCreate::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t BoardSectionCreate::getId() const
{
    return m_Id;
}


void BoardSectionCreate::setId(const utility::string_t& value)
{
    m_Id = value;
    m_IdIsSet = true;
}
...
utility::string_t BoardSectionCreate::getName() const
{
    return m_Name;
}


void BoardSectionCreate::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool BoardSectionCreate::nameIsSet() const
{
    return m_NameIsSet;
}

void BoardSectionCreate::unsetName()
{
    m_NameIsSet = false;
}
