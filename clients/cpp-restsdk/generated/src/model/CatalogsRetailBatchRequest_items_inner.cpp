...
std::shared_ptr<ItemAttributes> CatalogsRetailBatchRequest_items_inner::getAttributes() const
{
    return m_Attributes;
}

void CatalogsRetailBatchRequest_items_inner::setAttributes(const std::shared_ptr<ItemAttributes>& value)
{
    m_Attributes = value;
