...
LeadFormQuestionType::eLeadFormQuestionType toEnum(const EnumUnderlyingType& val)
{
    ...
    if (val == utility::conversions::to_string_t(U("PREFERRED_CONTACT_METHOD")))
        return LeadFormQuestionType::eLeadFormQuestionType::LeadFormQuestionType_PREFERRED_CONTACT_METHOD;
...
EnumUnderlyingType fromEnum(LeadFormQuestionType::eLeadFormQuestionType e)
{
    ...
    case LeadFormQuestionType::eLeadFormQuestionType::LeadFormQuestionType_COUNTRY:
        return U("COUNTRY");
    case LeadFormQuestionType::eLeadFormQuestionType::LeadFormQuestionType_PREFERRED_CONTACT_METHOD:
        return U("PREFERRED_CONTACT_METHOD");
