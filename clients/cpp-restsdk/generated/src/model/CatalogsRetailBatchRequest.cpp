...
std::shared_ptr<CatalogsItemsRequest_language> CatalogsRetailBatchRequest::getLanguage() const
{
    return m_Language;
}


void CatalogsRetailBatchRequest::setLanguage(const std::shared_ptr<CatalogsItemsRequest_language>& value)
{
    m_Language = value;
