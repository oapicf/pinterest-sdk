...
web::json::value IntegrationLog::toJson() const
{
    ...
    if(m_Log_levelIsSet)
    {
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("log_level"))] = ModelBase::toJson(m_Log_level);
    }
...
bool IntegrationLog::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("event_type"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<IntegrationLogEventType> refVal_setEventType;
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("log_level"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<IntegrationLogLevel> refVal_setLogLevel;
...
void IntegrationLog::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_Log_levelIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("log_level")), m_Log_level));
    }
    if(m_Merchant_id.has_value())
    {
...
void IntegrationLog::setEventType(const std::shared_ptr<IntegrationLogEventType>& value)
{
    m_Event_type = value;
...
void IntegrationLog::setLogLevel(const std::shared_ptr<IntegrationLogLevel>& value)
{
    m_Log_level = value;
