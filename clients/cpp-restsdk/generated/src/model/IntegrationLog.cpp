...
web::json::value IntegrationLog::toJson() const
{
    ...
    {   
        ...
        val[utility::conversions::to_string_t(U("event_type"))] = ModelBase::toJson(refVal);
    ...
    {   
        ...
        val[utility::conversions::to_string_t(U("log_level"))] = ModelBase::toJson(refVal);
...
void IntegrationLog::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_Event_typeIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(U("event_type")), fromEvent_typeEnum(m_Event_type)));
    }
    if(m_Log_levelIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(U("log_level")), fromLog_levelEnum(m_Log_level)));
    }
    if(m_External_business_idIsSet)
    {
