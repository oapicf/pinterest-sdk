...
web::json::value LinkedBusiness::toJson() const
{
    ...
    if(m_Image_large_urlIsSet)
    {
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("image_large_url"))] = ModelBase::toJson(m_Image_large_url);
    }
    if(m_Image_medium_urlIsSet)
    {
        
        val[utility::conversions::to_string_t(_XPLATSTR("image_medium_url"))] = ModelBase::toJson(m_Image_medium_url);
    }
    if(m_Image_small_urlIsSet)
    {
        
        val[utility::conversions::to_string_t(_XPLATSTR("image_small_url"))] = ModelBase::toJson(m_Image_small_url);
    }
    if(m_Image_xlarge_urlIsSet)
    {
        
        val[utility::conversions::to_string_t(_XPLATSTR("image_xlarge_url"))] = ModelBase::toJson(m_Image_xlarge_url);
    }
    if(m_UsernameIsSet)
    {
...
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("image_large_url"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(_XPLATSTR("image_large_url")));
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("image_medium_url"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(_XPLATSTR("image_medium_url")));
        if(!fieldValue.is_null())
        {
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("image_small_url"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(_XPLATSTR("image_small_url")));
        if(!fieldValue.is_null())
        {
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("image_xlarge_url"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(_XPLATSTR("image_xlarge_url")));
        if(!fieldValue.is_null())
        {
...
void LinkedBusiness::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_Image_large_urlIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("image_large_url")), m_Image_large_url));
    }
    if(m_Image_medium_urlIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("image_medium_url")), m_Image_medium_url));
    }
    if(m_Image_small_urlIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("image_small_url")), m_Image_small_url));
    }
    if(m_Image_xlarge_urlIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("image_xlarge_url")), m_Image_xlarge_url));
    }
    if(m_UsernameIsSet)
    {
...
bool LinkedBusiness::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    if(multipart->hasContent(utility::conversions::to_string_t(_XPLATSTR("image_large_url"))))
    {
        utility::string_t refVal_setImageLargeUrl;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(_XPLATSTR("image_large_url"))), refVal_setImageLargeUrl );
        setImageLargeUrl(refVal_setImageLargeUrl);
    }
    if(multipart->hasContent(utility::conversions::to_string_t(_XPLATSTR("image_medium_url"))))
    {
        utility::string_t refVal_setImageMediumUrl;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(_XPLATSTR("image_medium_url"))), refVal_setImageMediumUrl );
        setImageMediumUrl(refVal_setImageMediumUrl);
    }
    if(multipart->hasContent(utility::conversions::to_string_t(_XPLATSTR("image_small_url"))))
    {
        utility::string_t refVal_setImageSmallUrl;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(_XPLATSTR("image_small_url"))), refVal_setImageSmallUrl );
        setImageSmallUrl(refVal_setImageSmallUrl);
    }
    if(multipart->hasContent(utility::conversions::to_string_t(_XPLATSTR("image_xlarge_url"))))
    {
        utility::string_t refVal_setImageXlargeUrl;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(_XPLATSTR("image_xlarge_url"))), refVal_setImageXlargeUrl );
        setImageXlargeUrl(refVal_setImageXlargeUrl);
    }
