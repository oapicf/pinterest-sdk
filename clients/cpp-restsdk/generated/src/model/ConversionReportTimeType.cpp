...
ConversionReportTimeType::eConversionReportTimeType toEnum(const EnumUnderlyingType& val)
{
    if (val == utility::conversions::to_string_t(U("TIME_OF_AD_ACTION")))
        return ConversionReportTimeType::eConversionReportTimeType::ConversionReportTimeType_TIME_OF_AD_ACTION;
    if (val == utility::conversions::to_string_t(U("TIME_OF_CONVERSION")))
        return ConversionReportTimeType::eConversionReportTimeType::ConversionReportTimeType_TIME_OF_CONVERSION;
    return {};
}
...
EnumUnderlyingType fromEnum(ConversionReportTimeType::eConversionReportTimeType e)
{
    switch (e)
    {
    case ConversionReportTimeType::eConversionReportTimeType::ConversionReportTimeType_TIME_OF_AD_ACTION:
        return U("TIME_OF_AD_ACTION");
    case ConversionReportTimeType::eConversionReportTimeType::ConversionReportTimeType_TIME_OF_CONVERSION:
