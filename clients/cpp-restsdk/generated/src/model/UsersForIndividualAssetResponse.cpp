...
void UsersForIndividualAssetResponse::validate()
{
    // TODO: implement validation
}

web::json::value UsersForIndividualAssetResponse::toJson() const
{
...
bool UsersForIndividualAssetResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void UsersForIndividualAssetResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool UsersForIndividualAssetResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t UsersForIndividualAssetResponse::getAssetId() const
{
    return m_Asset_id;
}


void UsersForIndividualAssetResponse::setAssetId(const utility::string_t& value)
{
    m_Asset_id = value;
...
utility::string_t UsersForIndividualAssetResponse::getMemberId() const
{
    return m_Member_id;
}


void UsersForIndividualAssetResponse::setMemberId(const utility::string_t& value)
{
    m_Member_id = value;
...
std::vector<utility::string_t> UsersForIndividualAssetResponse::getPermissions() const
{
    return m_Permissions;
}


void UsersForIndividualAssetResponse::setPermissions(const std::vector<utility::string_t>& value)
{
    m_Permissions = value;
