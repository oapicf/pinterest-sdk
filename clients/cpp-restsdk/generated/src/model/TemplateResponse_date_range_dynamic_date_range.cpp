...
TemplateResponse_date_range_dynamic_date_range::RangeEnum TemplateResponse_date_range_dynamic_date_range::toRangeEnum(const utility::string_t& value) const
{
    ...
    if (value == utility::conversions::to_string_t("LAST_QUARTER")) {
        return RangeEnum::LAST_QUARTER;
    }
...
const utility::string_t TemplateResponse_date_range_dynamic_date_range::fromRangeEnum(const RangeEnum value) const
{
    switch(value)
    {
        ...
        case RangeEnum::LAST_QUARTER: return utility::conversions::to_string_t("LAST_QUARTER");
