...
OauthAccessTokenResponse::Response_typeEnum OauthAccessTokenResponse::toResponse_typeEnum(const utility::string_t& value) const
{
...
const utility::string_t OauthAccessTokenResponse::fromResponse_typeEnum(const Response_typeEnum value) const
{
    switch(value)
    {
...
OauthAccessTokenResponse::Response_typeEnum OauthAccessTokenResponse::getResponseType() const
{
    return m_Response_type;
}


void OauthAccessTokenResponse::setResponseType(const Response_typeEnum value)
{
