...
bool Board::isAdsOnlyIsSet() const
{
    return m_Is_ads_onlyIsSet;
}

void Board::unsetIs_ads_only()
{
    m_Is_ads_onlyIsSet = false;
}
...
void Board::setMedia(const std::shared_ptr<BoardMedia>& value)
{
    m_Media = value;
    m_MediaIsSet = true;
}
...
void Board::setPrivacy(const std::shared_ptr<BoardPrivacy>& value)
{
    m_Privacy = value;
    m_PrivacyIsSet = true;
}
