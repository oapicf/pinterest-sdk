...
pplx::task<std::shared_ptr<ConversionEvents>> ConversionEventsApi::events_create(utility::string_t adAccountId, std::shared_ptr<ConversionEventsCreate> conversionEventsCreate, boost::optional<bool> test) const
{

    // verify the required parameter 'conversionEventsCreate' is set
    if (conversionEventsCreate == nullptr)
    {
        throw ApiException(400, utility::conversions::to_string_t("Missing required parameter 'conversionEventsCreate' when calling ConversionEventsApi->events_create"));
    }
    ...
    if ( localVarConsumeHttpContentTypes.size() == 0 || localVarConsumeHttpContentTypes.find(utility::conversions::to_string_t("application/json")) != localVarConsumeHttpContentTypes.end() )
    {
        ...
        localVarJson = ModelBase::toJson(conversionEventsCreate);
    ...
    else if( localVarConsumeHttpContentTypes.find(utility::conversions::to_string_t("multipart/form-data")) != localVarConsumeHttpContentTypes.end() )
    {
        ...
        if(conversionEventsCreate.get())
        {
            conversionEventsCreate->toMultipart(localVarMultipart, utility::conversions::to_string_t("conversionEventsCreate"));
        }
    ...
    {
        std::shared_ptr<ConversionEvents> localVarResult(new ConversionEvents());
