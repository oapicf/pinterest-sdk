...
------------ | ------------- | ------------- | -------------
**assets_summary** | [**\OpenAPI\Client\Model\BusinessMemberAssetsSummary**](BusinessMemberAssetsSummary.md) | Ad accounts and profiles the business member/partner has access to. | [optional]
