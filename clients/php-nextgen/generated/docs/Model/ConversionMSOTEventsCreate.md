...
**attribution_model** | [**\OpenAPI\Client\Model\AttributionModel**](AttributionModel.md) | The attribution model used to attribute the conversion event. | [optional]
**attribution_scope** | [**\OpenAPI\Client\Model\AttributionScope**](AttributionScope.md) | Ad event type. | [optional]
...
**currency** | [**\OpenAPI\Client\Model\Currency**](Currency.md) | Currency code for the &#x60;value&#x60; field, required if &#x60;value&#x60; is present. Currency Codes should be in ISO 4217 standard. | [optional]
...
**event_name** | [**\OpenAPI\Client\Model\MsotEventName**](MsotEventName.md) | Type of user event. |
