...
```php
trendsEditorialArticlesList($region): \OpenAPI\Client\Model\TrendsEditorial[]
```
...
$apiInstance = new OpenAPI\Client\Api\TrendsApi(
...
try {
    $result = $apiInstance->trendsEditorialArticlesList($region);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling TrendsApi->trendsEditorialArticlesList: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\OpenAPI\Client\Model\TrendsEditorial[]**](../Model/TrendsEditorial.md)
...
try {
    ...
    echo 'Exception when calling TrendsApi->trendsFeaturedTopicsList: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling TrendsApi->trendsProductCategoriesDetailsList: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling TrendsApi->trendsProductCategoriesTrendingList: ', $e->getMessage(), PHP_EOL;
}
```
