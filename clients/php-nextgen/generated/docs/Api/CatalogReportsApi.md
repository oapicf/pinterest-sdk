...
$catalogs_report_parameters = new \OpenAPI\Client\Model\CatalogsRetailReportParameters(); // \OpenAPI\Client\Model\CatalogsReportParameters
...
$parameters = array('key' => new \OpenAPI\Client\Model\\OpenAPI\Client\Model\CatalogsRetailReportStatsParameters()); // \OpenAPI\Client\Model\CatalogsReportStatsParameters | Contains the parameters for report identification.
$ad_account_id = 'ad_account_id_example'; // string | Unique identifier of an ad account.
