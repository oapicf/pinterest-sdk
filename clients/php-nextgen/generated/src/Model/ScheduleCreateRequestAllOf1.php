...
/**
 * ScheduleCreateRequestAllOf1 Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ScheduleCreateRequestAllOf1 implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'ScheduleCreateRequestAllOf1';
    ...
    public function setEntityId(string $entity_id): static
    {
        ...
        if ((!preg_match("/^[C]?\\d+$/", ObjectSerializer::toString($entity_id)))) {
            throw new InvalidArgumentException("invalid value for \$entity_id when calling ScheduleCreateRequestAllOf1., must conform to the pattern /^[C]?\\d+$/.");
        }
