...
/**
 * KeywordUpdateGenerated Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class KeywordUpdateGenerated implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'KeywordUpdateGenerated';
    ...
    public function setId(string $id): static
    {
        ...
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($id)))) {
            throw new InvalidArgumentException("invalid value for \$id when calling KeywordUpdateGenerated., must conform to the pattern /^\\d+$/.");
        }
