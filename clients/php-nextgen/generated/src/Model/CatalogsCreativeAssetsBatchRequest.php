...
/**
 * CatalogsCreativeAssetsBatchRequest Class Doc Comment
 *
 ...
 */
class CatalogsCreativeAssetsBatchRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'CatalogsCreativeAssetsBatchRequest';
    ...
    protected static array $openAPITypes = [
        ...
        'items' => '\OpenAPI\Client\Model\CatalogsCreativeAssetsBatchItem[]',
        'language' => 'string'
    ];
    ...
    public function setCatalogId(?string $catalog_id): static
    {
        ...
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($catalog_id)))) {
            throw new InvalidArgumentException("invalid value for \$catalog_id when calling CatalogsCreativeAssetsBatchRequest., must conform to the pattern /^\\d+$/.");
        }
     ...
     * Gets items
     *
     * @return (\OpenAPI\Client\Model\CatalogsCreateCreativeAssetsItem|\OpenAPI\Client\Model\CatalogsUpsertCreativeAssetsItem|\OpenAPI\Client\Model\CatalogsUpdateCreativeAssetsItem|\OpenAPI\Client\Model\CatalogsDeleteCreativeAssetsItem)[]
     */
     ...
     * Sets items
     *
     * @param (\OpenAPI\Client\Model\CatalogsCreateCreativeAssetsItem|\OpenAPI\Client\Model\CatalogsUpsertCreativeAssetsItem|\OpenAPI\Client\Model\CatalogsUpdateCreativeAssetsItem|\OpenAPI\Client\Model\CatalogsDeleteCreativeAssetsItem)[] $items Array with creative assets item operations
     *
     * @return $this
     */
    public function setItems(array $items): static
    {
        ...
        if ((count($items) > 1000)) {
            throw new InvalidArgumentException('invalid value for $items when calling CatalogsCreativeAssetsBatchRequest., number of items must be less than or equal to 1000.');
        }
        if ((count($items) < 1)) {
            throw new InvalidArgumentException('invalid length for $items when calling CatalogsCreativeAssetsBatchRequest., number of items must be greater than or equal to 1.');
        }
