...
/**
 * CatalogsHotelProductMetadata Class Doc Comment
 *
 ...
 */
class CatalogsHotelProductMetadata implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'CatalogsHotelProductMetadata';
     ...
     * Sets hotel_id
     *
     * @param string $hotel_id The user-created unique ID that represents the hotel item.
     *
     * @return $this
     */
