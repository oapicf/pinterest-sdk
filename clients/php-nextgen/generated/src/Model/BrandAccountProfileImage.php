...
/**
 * BrandAccountProfileImage Class Doc Comment
 *
 ...
 */
class BrandAccountProfileImage implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'BrandAccountProfileImage';
    ...
    public function setData(string $data): static
    {
        ...
        if ((!preg_match("/[a-zA-Z0-9+\/=]+/", ObjectSerializer::toString($data)))) {
            throw new InvalidArgumentException("invalid value for \$data when calling BrandAccountProfileImage., must conform to the pattern /[a-zA-Z0-9+\/=]+/.");
        }
