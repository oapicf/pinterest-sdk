...
/**
 * BidOptionsAudienceMultipliers Class Doc Comment
 *
 ...
 */
class BidOptionsAudienceMultipliers implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'BidOptionsAudienceMultipliers';
    ...
    public function setAudienceId(string $audience_id): static
    {
        ...
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($audience_id)))) {
            throw new InvalidArgumentException("invalid value for \$audience_id when calling BidOptionsAudienceMultipliers., must conform to the pattern /^\\d+$/.");
        }
