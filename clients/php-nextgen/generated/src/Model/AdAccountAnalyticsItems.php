...
/**
 * AdAccountAnalyticsItems Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class AdAccountAnalyticsItems implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'AdAccountAnalyticsItems';
    ...
    public function setAdAccountId(string $ad_account_id): static
    {
        ...
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($ad_account_id)))) {
            throw new InvalidArgumentException("invalid value for \$ad_account_id when calling AdAccountAnalyticsItems., must conform to the pattern /^\\d+$/.");
        }
