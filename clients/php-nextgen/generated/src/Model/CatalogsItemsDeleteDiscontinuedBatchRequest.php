...
/**
 * CatalogsItemsDeleteDiscontinuedBatchRequest Class Doc Comment
 *
 ...
 */
class CatalogsItemsDeleteDiscontinuedBatchRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'CatalogsItemsDeleteDiscontinuedBatchRequest';
    ...
    protected static array $openAPITypes = [
        ...
        'items' => '\OpenAPI\Client\Model\ItemDeleteDiscontinuedBatchRecord[]',
        'language' => 'string',
        'operation' => 'string'
    ];
    ...
    public const OPERATION_DELETE_DISCONTINUED = 'DELETE_DISCONTINUED';
    ...
    {
        return [
            self::OPERATION_DELETE_DISCONTINUED,
        ];
    }
     ...
     * Gets items
     *
     * @return \OpenAPI\Client\Model\ItemDeleteDiscontinuedBatchRecord[]
     */
     ...
     * Sets items
     *
     * @param \OpenAPI\Client\Model\ItemDeleteDiscontinuedBatchRecord[] $items Array with catalogs items
     *
     * @return $this
     */
