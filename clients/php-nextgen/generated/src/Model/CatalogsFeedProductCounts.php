...
/**
 * CatalogsFeedProductCounts Class Doc Comment
 *
 ...
 */
class CatalogsFeedProductCounts implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'CatalogsFeedProductCounts';
     ...
     * @return $this
     */
    public function setIngested(?int $ingested): static
    {
        if (is_null($ingested)) {
