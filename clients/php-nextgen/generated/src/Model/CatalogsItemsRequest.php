...
class CatalogsItemsRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'CatalogsItemsRequest';
     ...
     * Gets filters
     *
     * @return \OpenAPI\Client\Model\CatalogsRetailItemsPostFilter|\OpenAPI\Client\Model\CatalogsHotelItemsPostFilter|\OpenAPI\Client\Model\CatalogsCreativeAssetsItemsPostFilter
     */
    public function getFilters(): \OpenAPI\Client\Model\CatalogsRetailItemsPostFilter|\OpenAPI\Client\Model\CatalogsHotelItemsPostFilter|\OpenAPI\Client\Model\CatalogsCreativeAssetsItemsPostFilter
    {
     ...
     * Sets filters
     *
     * @param \OpenAPI\Client\Model\CatalogsRetailItemsPostFilter|\OpenAPI\Client\Model\CatalogsHotelItemsPostFilter|\OpenAPI\Client\Model\CatalogsCreativeAssetsItemsPostFilter $filters filters
     *
     * @return $this
     */
    public function setFilters(\OpenAPI\Client\Model\CatalogsRetailItemsPostFilter|\OpenAPI\Client\Model\CatalogsHotelItemsPostFilter|\OpenAPI\Client\Model\CatalogsCreativeAssetsItemsPostFilter $filters): static
    {
        if (is_null($filters)) {
