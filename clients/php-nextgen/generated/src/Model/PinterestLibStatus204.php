...
/**
 * PinterestLibStatus204 Class Doc Comment
 *
 ...
 */
class PinterestLibStatus204 implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'Pinterest.Lib.Status204';
    ...
    public const STATUS_CODE_NUMBER_204 = 204;
     ...
     * @return string[]
     */
    public static function getStatusCodeAllowableValues()
    {
        return [
            self::STATUS_CODE_NUMBER_204,
        ];
    }
    ...
    public function listInvalidProperties(): array
    {
        ...
        $allowedValues = self::getStatusCodeAllowableValues();
     ...
     * @return $this
     */
    public function setStatusCode(float $status_code): static
    {
