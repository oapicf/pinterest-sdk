...
/**
 * CatalogsHotelAddress Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class CatalogsHotelAddress implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'CatalogsHotelAddress';
     ...
     * Sets postal_code
     *
     * @param string|null $postal_code Required for countries with a postal code system. Postal or zip code of the hotel.
     *
     * @return $this
     */
