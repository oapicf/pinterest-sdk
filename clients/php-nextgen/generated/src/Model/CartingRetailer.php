...
class CartingRetailer implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'CartingRetailer';
     ...
     * @return $this
     */
    public function setRetailerId(string $retailer_id): static
    {
     ...
     * @return $this
     */
    public function setRetailerName(string $retailer_name): static
    {
