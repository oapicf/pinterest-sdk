...
/**
 * BusinessAccessUserSummary Class Doc Comment
 *
 ...
 */
class BusinessAccessUserSummary implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'BusinessAccessUserSummary';
    ...
    public function setId(?string $id): static
    {
        ...
        if (!is_null($id) && (mb_strlen($id) > 20)) {
            throw new InvalidArgumentException('invalid length for $id when calling BusinessAccessUserSummary., must be smaller than or equal to 20.');
        }
        if (!is_null($id) && (mb_strlen($id) < 1)) {
            throw new InvalidArgumentException('invalid length for $id when calling BusinessAccessUserSummary., must be bigger than or equal to 1.');
        }
