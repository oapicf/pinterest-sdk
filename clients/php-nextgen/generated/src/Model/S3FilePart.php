 ...
 */
class S3FilePart implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'S3FilePart';
     ...
     * Sets part_number
     *
     * @param int $part_number Part number for upload.
     *
     * @return $this
     */
    public function setPartNumber(int $part_number): static
    {
     ...
     * Sets presigned_url
     *
     * @param string $presigned_url Pre-signed URL.
     *
     * @return $this
     */
    public function setPresignedUrl(string $presigned_url): static
    {
