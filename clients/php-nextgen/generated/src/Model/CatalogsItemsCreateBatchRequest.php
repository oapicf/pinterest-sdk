...
/**
 * CatalogsItemsCreateBatchRequest Class Doc Comment
 *
 ...
 */
class CatalogsItemsCreateBatchRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'CatalogsItemsCreateBatchRequest';
    ...
    protected static array $openAPITypes = [
        ...
        'items' => '\OpenAPI\Client\Model\ItemCreateBatchRecord[]',
        'language' => 'string',
        'operation' => 'string'
    ];
     ...
     * Gets items
     *
     * @return \OpenAPI\Client\Model\ItemCreateBatchRecord[]
     */
     ...
     * Sets items
     *
     * @param \OpenAPI\Client\Model\ItemCreateBatchRecord[] $items Array with catalogs items
     *
     * @return $this
     */
    public function setItems(array $items): static
    {
        ...
        if ((count($items) > 1000)) {
            throw new InvalidArgumentException('invalid value for $items when calling CatalogsItemsCreateBatchRequest., number of items must be less than or equal to 1000.');
        }
        if ((count($items) < 1)) {
            throw new InvalidArgumentException('invalid length for $items when calling CatalogsItemsCreateBatchRequest., number of items must be greater than or equal to 1.');
        }
