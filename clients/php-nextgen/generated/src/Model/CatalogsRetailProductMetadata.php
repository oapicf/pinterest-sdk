...
/**
 * CatalogsRetailProductMetadata Class Doc Comment
 *
 ...
 */
class CatalogsRetailProductMetadata implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'CatalogsRetailProductMetadata';
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ($this->container['item_group_id'] === null && !$this->isNullableSetToNull('item_group_id')) {
            $invalidProperties[] = "'item_group_id' is required";
        }
        ...
        if ($this->container['sale_price'] === null && !$this->isNullableSetToNull('sale_price')) {
            $invalidProperties[] = "'sale_price' is required";
        }
     ...
     */
    public function getAvailability(): \OpenAPI\Client\Model\ProductAvailability
    {
     ...
     * @return $this
     */
    public function setAvailability(\OpenAPI\Client\Model\ProductAvailability $availability): static
    {
     ...
     */
    public function getCurrency(): \OpenAPI\Client\Model\NonNullableCatalogsCurrency
    {
     ...
     * @return $this
     */
    public function setCurrency(\OpenAPI\Client\Model\NonNullableCatalogsCurrency $currency): static
    {
        if (is_null($currency)) {
     ...
     * Sets item_group_id
     *
     * @param string|null $item_group_id The parent ID of the product.
     *
     * @return $this
     */
     ...
     * Sets item_id
     *
     * @param string $item_id The user-created unique ID that represents the product.
     *
     * @return $this
     */
     ...
     * Sets sale_price
     *
     * @param float|null $sale_price The discounted price of the product.
     *
     * @return $this
     */
