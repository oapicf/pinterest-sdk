...
/**
 * CatalogsHotelBatchRequest Class Doc Comment
 *
 ...
 */
class CatalogsHotelBatchRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'CatalogsHotelBatchRequest';
    ...
    protected static array $openAPITypes = [
        ...
        'items' => '\OpenAPI\Client\Model\CatalogsHotelBatchItem[]',
        'language' => 'string'
    ];
     ...
     * Sets catalog_id
     *
     * @param string|null $catalog_id Catalog id pertaining to the hotel item. If not provided, default to oldest hotel catalog
     *
     * @return $this
     */
    public function setCatalogId(?string $catalog_id): static
    {
        ...
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($catalog_id)))) {
            throw new InvalidArgumentException("invalid value for \$catalog_id when calling CatalogsHotelBatchRequest., must conform to the pattern /^\\d+$/.");
        }
     ...
     * Gets items
     *
     * @return (\OpenAPI\Client\Model\CatalogsCreateHotelItem|\OpenAPI\Client\Model\CatalogsUpsertHotelItem|\OpenAPI\Client\Model\CatalogsUpdateHotelItem|\OpenAPI\Client\Model\CatalogsDeleteHotelItem)[]
     */
     ...
     * Sets items
     *
     * @param (\OpenAPI\Client\Model\CatalogsCreateHotelItem|\OpenAPI\Client\Model\CatalogsUpsertHotelItem|\OpenAPI\Client\Model\CatalogsUpdateHotelItem|\OpenAPI\Client\Model\CatalogsDeleteHotelItem)[] $items Array with catalogs item operations
     *
     * @return $this
     */
    public function setItems(array $items): static
    {
        ...
        if ((count($items) > 1000)) {
            throw new InvalidArgumentException('invalid value for $items when calling CatalogsHotelBatchRequest., number of items must be less than or equal to 1000.');
        }
        if ((count($items) < 1)) {
            throw new InvalidArgumentException('invalid length for $items when calling CatalogsHotelBatchRequest., number of items must be greater than or equal to 1.');
        }
