...
/**
 * TargetingSpecOperationMinimumAge Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class TargetingSpecOperationMinimumAge implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'TargetingSpecOperationMinimumAge';
    ...
    public function setValue(?string $value): static
    {
        ...
        if (!is_null($value) && (!preg_match("/^\\d+\\+?$/", ObjectSerializer::toString($value)))) {
            throw new InvalidArgumentException("invalid value for \$value when calling TargetingSpecOperationMinimumAge., must conform to the pattern /^\\d+\\+?$/.");
        }
