...
/**
 * CatalogsItemsUpsertBatchRequest Class Doc Comment
 *
 ...
 */
class CatalogsItemsUpsertBatchRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'CatalogsItemsUpsertBatchRequest';
    ...
    protected static array $openAPITypes = [
        ...
        'items' => '\OpenAPI\Client\Model\ItemUpsertBatchRecord[]',
        'language' => 'string',
        'operation' => 'string'
    ];
     ...
     * Gets items
     *
     * @return \OpenAPI\Client\Model\ItemUpsertBatchRecord[]
     */
     ...
     * Sets items
     *
     * @param \OpenAPI\Client\Model\ItemUpsertBatchRecord[] $items Array with catalogs items
     *
     * @return $this
     */
    public function setItems(array $items): static
    {
        ...
        if ((count($items) > 1000)) {
            throw new InvalidArgumentException('invalid value for $items when calling CatalogsItemsUpsertBatchRequest., number of items must be less than or equal to 1000.');
        }
        if ((count($items) < 1)) {
            throw new InvalidArgumentException('invalid length for $items when calling CatalogsItemsUpsertBatchRequest., number of items must be greater than or equal to 1.');
        }
