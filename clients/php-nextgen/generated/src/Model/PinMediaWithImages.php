...
/**
 * PinMediaWithImages Class Doc Comment
 *
 ...
 */
class PinMediaWithImages implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'PinMediaWithImages';
    ...
    protected static array $openAPITypes = [
        'items' => '\OpenAPI\Client\Model\ImageMetadata[]',
        'media_type' => 'string'
    ];
    ...
    public const MEDIA_TYPE_MULTIPLE_IMAGES = 'multiple_images';
    ...
    {
        return [
            self::MEDIA_TYPE_MULTIPLE_IMAGES,
        ];
    }
     ...
     * Sets items
     *
     * @param \OpenAPI\Client\Model\ImageMetadata[]|null $items items
     *
     * @return $this
     */
