...
/**
 * TargetingTemplateAudienceSizingReachEstimate Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class TargetingTemplateAudienceSizingReachEstimate implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'TargetingTemplateAudienceSizingReachEstimate';
     ...
     * Sets estimate
     *
     * @param int|null $estimate estimate
     *
     * @return $this
     */
     ...
     * Sets lower_bound
     *
     * @param int|null $lower_bound lower_bound
     *
     * @return $this
     */
    public function setLowerBound(?int $lower_bound): static
    {
     ...
     * Sets upper_bound
     *
     * @param int|null $upper_bound upper_bound
     *
     * @return $this
     */
    public function setUpperBound(?int $upper_bound): static
    {
