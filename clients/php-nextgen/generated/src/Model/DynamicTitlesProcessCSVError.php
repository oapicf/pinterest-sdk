...
/**
 * DynamicTitlesProcessCSVError Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class DynamicTitlesProcessCSVError implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'DynamicTitlesProcessCSVError';
     ...
     * Sets error_type
     *
     * @param string|null $error_type The type of validation error: INVALID_FILE or ROW_VALIDATION_FAILED.
     *
     * @return $this
     */
     ...
     * Sets row_number
     *
     * @param int|null $row_number The row number with a validation error. -1 indicates a file-level error.
     *
     * @return $this
     */
