...
public class PinsController  {
  ...
  */
  ...
  /*
    public ResponseContext pinsCreate(RequestContext request , Pin pin) {
        return new ResponseContext().status(Status.INTERNAL_SERVER_ERROR).entity( "Not implemented" );
    }
  */

  /*
    public ResponseContext pinsDelete(RequestContext request , String pinId) {
        return new ResponseContext().status(Status.INTERNAL_SERVER_ERROR).entity( "Not implemented" );
    }
  */

  /*
    public ResponseContext pinsGet(RequestContext request , String pinId, String adAccountId) {
        return new ResponseContext().status(Status.INTERNAL_SERVER_ERROR).entity( "Not implemented" );
    }
  */
