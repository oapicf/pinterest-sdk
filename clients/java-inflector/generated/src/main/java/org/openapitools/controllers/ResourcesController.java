...
public class ResourcesController  {
  ...
  /*
    public ResponseContext adAccountCountriesGet(RequestContext request ) {
  ...
  */
  ...
  /*
    public ResponseContext interestTargetingOptionsGet(RequestContext request , String interestId) {
        return new ResponseContext().status(Status.INTERNAL_SERVER_ERROR).entity( "Not implemented" );
    }
  */

  /*
    public ResponseContext leadFormQuestionsGet(RequestContext request ) {
        return new ResponseContext().status(Status.INTERNAL_SERVER_ERROR).entity( "Not implemented" );
    }
  */

  /*
    public ResponseContext metricsReadyStateGet(RequestContext request , String date) {
        return new ResponseContext().status(Status.INTERNAL_SERVER_ERROR).entity( "Not implemented" );
    }
  */
