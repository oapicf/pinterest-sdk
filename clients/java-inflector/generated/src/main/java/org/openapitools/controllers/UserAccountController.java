...
public class UserAccountController  {
  ...
  /*
    public ResponseContext userAccountAnalytics(RequestContext request , Date startDate, Date endDate, String fromClaimedContent, String pinFormat, String appTypes, List<String> metricTypes, String splitField, String adAccountId) {
