...
public class MediaController  {
  ...
  */
  ...
  /*
    public ResponseContext mediaGet(RequestContext request , String mediaId) {
        return new ResponseContext().status(Status.INTERNAL_SERVER_ERROR).entity( "Not implemented" );
    }
  */

  /*
    public ResponseContext mediaList(RequestContext request , String bookmark, Integer pageSize) {
        return new ResponseContext().status(Status.INTERNAL_SERVER_ERROR).entity( "Not implemented" );
    }
  */
