...
public interface CatalogItemsApi  {
    ...
    public CatalogsItemsBatch itemsBatchGet(@PathParam("batch_id") @Pattern(regexp="^[a-zA-Z0-9]+$") String batchId, @QueryParam("ad_account_id") @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error", response = Error.class) })
    public CatalogsItems itemsPost(@Valid CatalogsItemsRequest catalogsItemsRequest, @QueryParam("ad_account_id") @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId);
}
