...
public class ConversionMSOTEventsCreate  {
  ...
  */
  ...
  /**
   * Sets the <code>clickWindow</code> property.
   */
 ...
 @DecimalMin("0")  public Double getTotalEventsFractional() {
    return totalEventsFractional;
  }

  /**
   * Sets the <code>totalEventsFractional</code> property.
   */
  ...
  */
  ...
  /**
   * Sets the <code>viewWindow</code> property.
   */
