...
public interface KeywordsApi  {
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error", response = Error.class) })
    public KeywordsResponse keywordsCreate(@PathParam("ad_account_id") @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId, @Valid KeywordsRequest keywordsRequest);
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Success", response = KeywordsResponse.class),
        @ApiResponse(code = 200, message = "Unexpected error", response = Error.class) })
    public KeywordsResponse keywordsUpdate(@PathParam("ad_account_id") @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId, @Valid KeywordUpdateBody keywordUpdateBody);
