...
public class PerformancePlusCampaignSettings  {
  ...
  */
  ...
  /**
   * Sets the <code>boostProspectingAdGroupBid</code> property.
   */
  ...
  */
  ...
  /**
   * Sets the <code>pinnerListExclusions</code> property.
   */
 public void setPinnerListExclusions(List<String> pinnerListExclusions) {
  ...
  /**
   * Adds a new item to the <code>pinnerListExclusions</code> list.
   */
