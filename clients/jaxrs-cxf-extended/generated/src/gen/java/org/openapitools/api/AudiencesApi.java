...
public interface AudiencesApi  {
    ...
    public AdAccountsAudience audiencesCreate(@PathParam("ad_account_id") @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId, @Valid AdAccountsAudienceCreate adAccountsAudienceCreate);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 429, message = "The user has sent too many requests in a given amount of time and is being rate limited.", response = PinterestLibError.class),
        @ApiResponse(code = 200, message = "An unexpected error response.", response = PinterestLibError.class) })
    public AdAccountsAudience audiencesUpdate(@PathParam("audience_id") @Pattern(regexp="^\\d+$") String audienceId, @PathParam("ad_account_id") @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId, @Valid AdAccountsAudienceUpdate adAccountsAudienceUpdate);
}
