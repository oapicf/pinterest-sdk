...
public interface LeadsExportApi  {
    ...
    public LeadsExportCreateResponse leadsExportCreate(@PathParam("ad_account_id") @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId, @Valid LeadsExportCreateRequest leadsExportCreateRequest);
