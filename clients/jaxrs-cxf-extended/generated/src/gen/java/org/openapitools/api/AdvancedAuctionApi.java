...
public interface AdvancedAuctionApi  {
    ...
    public AdvancedAuctionItems advancedAuctionItemsGetPost(@Valid AdvancedAuctionItemsGetRequest advancedAuctionItemsGetRequest, @QueryParam("ad_account_id") @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 500, message = "Internal error", response = Error.class),
        @ApiResponse(code = 200, message = "Unexpected error", response = Error.class) })
    public AdvancedAuctionProcessedItems advancedAuctionItemsSubmitPost(@Valid AdvancedAuctionItemsSubmitRequest advancedAuctionItemsSubmitRequest, @QueryParam("ad_account_id") @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId);
}
