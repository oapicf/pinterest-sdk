...
public interface TargetingTemplateApi  {
    ...
    public TargetingTemplateGetResponseData targetingTemplateCreate(@PathParam("ad_account_id") @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId, @Valid TargetingTemplateCreate targetingTemplateCreate);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 400, message = "Invalid ad account id.", response = Error.class),
        @ApiResponse(code = 200, message = "Unexpected error", response = Error.class) })
    public void targetingTemplateUpdate(@PathParam("ad_account_id") @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId, @Valid TargetingTemplateUpdateRequest targetingTemplateUpdateRequest);
}
