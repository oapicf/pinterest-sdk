...
public class BulkCampaignDeliveryEstimatesItem  {
  ...
  */
  ...
  /**
   * Sets the <code>adgroupAudienceSizes</code> property.
   */
 public void setAdgroupAudienceSizes(List<@Valid CampaignPlanningAdGroupAudienceSize> adgroupAudienceSizes) {
  ...
  /**
   * Adds a new item to the <code>adgroupAudienceSizes</code> list.
   */
  ...
  */
  ...
  /**
   * Sets the <code>conversionRates</code> property.
   */
 public void setConversionRates(List<@Valid CampaignPlanningConversionRate> conversionRates) {
  ...
  /**
   * Adds a new item to the <code>conversionRates</code> list.
   */
  ...
  */
  ...
  /**
   * Sets the <code>estimateId</code> property.
   */
