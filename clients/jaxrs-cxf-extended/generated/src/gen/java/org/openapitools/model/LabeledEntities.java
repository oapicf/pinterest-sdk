...
public class LabeledEntities  {
  ...
  */
  ...
  /**
   * Sets the <code>entitiesLabels</code> property.
   * <br><em>N.B. <code>entitiesLabels</code> is <b>read only</b>; client code should not call this method</em>.
   */
 public void setEntitiesLabels(List<@Valid EntityLabel> entitiesLabels) {
  ...
  /**
   * Adds a new item to the <code>entitiesLabels</code> list.
   * <br><em>N.B. <code>entitiesLabels</code> is <b>read only</b>; client code should not call this method</em>.
   */
