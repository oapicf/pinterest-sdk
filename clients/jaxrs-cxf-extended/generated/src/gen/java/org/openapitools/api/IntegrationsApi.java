...
public interface IntegrationsApi  {
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 429, message = "The user has sent too many requests in a given amount of time and is being rate limited.", response = PinterestLibError.class),
        @ApiResponse(code = 200, message = "An unexpected error response.", response = PinterestLibError.class) })
    public IntegrationMetadata integrationsCommercePatch(@PathParam("external_business_id") String externalBusinessId, @Valid IntegrationMetadataUpdate integrationMetadataUpdate);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 429, message = "The user has sent too many requests in a given amount of time and is being rate limited.", response = PinterestLibError.class),
        @ApiResponse(code = 200, message = "An unexpected error response.", response = PinterestLibError.class) })
    public IntegrationMetadata integrationsCommercePost(@Valid IntegrationMetadataCreate integrationMetadataCreate);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 429, message = "The user has sent too many requests in a given amount of time and is being rate limited.", response = PinterestLibError.class),
        @ApiResponse(code = 200, message = "An unexpected error response.", response = PinterestLibError.class) })
    public IntegrationLogsSuccessResponse integrationsLogsPost(@Valid IntegrationLogsRequestCreate integrationLogsRequestCreate);
}
