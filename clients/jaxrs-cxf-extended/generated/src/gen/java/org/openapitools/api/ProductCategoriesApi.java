...
public interface ProductCategoriesApi  {
    ...
    @ApiOperation(value = "Get featured topics", tags={ "product_categories" })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Get product category details", tags={ "product_categories" })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Get a list of growing Shopping Product Categories", tags={ "product_categories" })
    @ApiResponses(value = { 
