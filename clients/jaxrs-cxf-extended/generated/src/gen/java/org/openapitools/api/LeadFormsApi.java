...
public interface LeadFormsApi  {
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 400, message = "Invalid ad account lead forms parameters.", response = Error.class),
        @ApiResponse(code = 200, message = "Unexpected error", response = Error.class) })
    public LeadFormArrayResponse leadFormsCreate(@PathParam("ad_account_id") @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId, @Valid List<@Valid LeadFormCreateRequest> leadFormCreateRequest);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 400, message = "Invalid ad account lead forms parameters.", response = Error.class),
        @ApiResponse(code = 200, message = "Unexpected error", response = Error.class) })
    public LeadFormArrayResponse leadFormsUpdate(@PathParam("ad_account_id") @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId, @Valid List<@Valid LeadFormUpdateRequest> leadFormUpdateRequest);
}
