...
public interface BulkApi  {
    ...
    public BulkDownload bulkDownloadCreate(@PathParam("ad_account_id") @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId, @Valid BulkDownloadCreate bulkDownloadCreate);
