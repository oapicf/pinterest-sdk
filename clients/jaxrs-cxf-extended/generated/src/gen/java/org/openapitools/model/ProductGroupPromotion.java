...
public enum CollectionsHeaderTypeEnum {
    ...
    @JsonProperty("SHOP_THIS_COLLECTION") SHOP_THIS_COLLECTION(String.valueOf("SHOP_THIS_COLLECTION")),
    @JsonProperty("EXPLORE_THIS_COLLECTION") EXPLORE_THIS_COLLECTION(String.valueOf("EXPLORE_THIS_COLLECTION")),
    @JsonProperty("NO_HEADER") NO_HEADER(String.valueOf("NO_HEADER")),
    @JsonProperty("ON_SALE") ON_SALE(String.valueOf("ON_SALE")),
    @JsonProperty("GET_DEAL") GET_DEAL(String.valueOf("GET_DEAL"));
...
public enum CustomizableCtaTypeEnum {
    ...
    @JsonProperty("ON_SALE") ON_SALE(String.valueOf("ON_SALE")),
    @JsonProperty("GET_DEAL") GET_DEAL(String.valueOf("GET_DEAL")),
    @JsonProperty("BUY_ONLINE_PICKUP_IN_STORE") BUY_ONLINE_PICKUP_IN_STORE(String.valueOf("BUY_ONLINE_PICKUP_IN_STORE"));
...
public enum PreferredMediaTypeEnum {
  ...
  */
  ...
  public String getCollectionsHeaderType() {
    return collectionsHeaderType == null ? null : collectionsHeaderType.value();
  }
  ...
  */
  ...
  /**
   * Sets the <code>isGenerateBackground</code> property.
   */
  ...
  */
  ...
  public String getPreferredMediaType() {
    return preferredMediaType == null ? null : preferredMediaType.value();
  }
  ...
  */
  ...
  /**
   * Sets the <code>selectedImageTag</code> property.
   */
  ...
  */
  ...
  /**
   * Sets the <code>selectedVideoTag</code> property.
   */
