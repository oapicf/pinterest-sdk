...
public interface BoardsApi  {
    ...
    public BoardSection boardSectionsCreate(@PathParam("board_id") @Pattern(regexp="^\\d+$") String boardId, @Valid BoardSectionCreate boardSectionCreate, @QueryParam("ad_account_id") @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 429, message = "The user has sent too many requests in a given amount of time and is being rate limited.", response = PinterestLibError.class),
        @ApiResponse(code = 200, message = "An unexpected error response.", response = PinterestLibError.class) })
    public BoardSection boardSectionsUpdate(@PathParam("board_id") @Pattern(regexp="^\\d+$") String boardId, @PathParam("section_id") @Pattern(regexp="^\\d+$") String sectionId, @Valid BoardSectionUpdateWithRequiredBody boardSectionUpdateWithRequiredBody, @QueryParam("ad_account_id") @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId);
