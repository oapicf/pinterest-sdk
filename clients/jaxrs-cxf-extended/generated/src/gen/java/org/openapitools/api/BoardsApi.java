...
public interface BoardsApi  {
    ...
    public BoardSection boardSectionsCreate(@PathParam("board_id") @Pattern(regexp="^\\d+$") String boardId, @Valid BoardSection boardSection);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 409, message = "Board section conflict.", response = Error.class),
        @ApiResponse(code = 200, message = "Unexpected error", response = Error.class) })
    public BoardSection boardSectionsUpdate(@PathParam("board_id") @Pattern(regexp="^\\d+$") String boardId, @PathParam("section_id") @Pattern(regexp="^\\d+$") String sectionId, @Valid BoardSection boardSection);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error", response = Error.class) })
    public Board boardsCreate(@Valid Board board);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 429, message = "This request exceeded a rate limit. This can happen if the client exceeds one of the published rate limits or if multiple write operations are applied to an object within a short time window.", response = Error.class),
        @ApiResponse(code = 200, message = "Unexpected error", response = Error.class) })
    public Board boardsUpdate(@PathParam("board_id") @Pattern(regexp="^\\d+$") String boardId, @Valid BoardUpdate boardUpdate);
}
