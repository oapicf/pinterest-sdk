...
public interface ConversionDeletionRequestsApi  {
    ...
    public ConversionDeletionRequest conversionDeletionRequestCreate(@PathParam("ad_account_id") @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId, @Valid ConversionDeletionRequestCreate conversionDeletionRequestCreate);
