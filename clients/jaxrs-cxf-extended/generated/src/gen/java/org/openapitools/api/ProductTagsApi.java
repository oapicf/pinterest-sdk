...
public interface ProductTagsApi  {
    ...
    public ProductTagsResponse productTagsBulkAdd(@PathParam("pin_id") @Pattern(regexp="^\\d+$") String pinId, @Valid ProductTagsBulkAddRequest productTagsBulkAddRequest);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 429, message = "The user has sent too many requests in a given amount of time and is being rate limited.", response = PinterestLibError.class),
        @ApiResponse(code = 200, message = "An unexpected error response.", response = PinterestLibError.class) })
    public void productTagsBulkDelete(@PathParam("pin_id") @Pattern(regexp="^\\d+$") String pinId, @Valid ProductTagsBulkDeleteRequest productTagsBulkDeleteRequest);
