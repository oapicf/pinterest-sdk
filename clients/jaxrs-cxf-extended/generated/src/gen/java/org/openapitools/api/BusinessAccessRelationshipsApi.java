...
public interface BusinessAccessRelationshipsApi  {
    ...
    public BrandAccount brandAccountsCreate(@PathParam("business_hierarchy_id") @Pattern(regexp="^\\d+$") @Size(min=1,max=20) String businessHierarchyId, @Valid BrandAccountCreate brandAccountCreate);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 429, message = "The user has sent too many requests in a given amount of time and is being rate limited.", response = PinterestLibError.class),
        @ApiResponse(code = 200, message = "An unexpected error response.", response = PinterestLibError.class) })
    public BrandAccount brandAccountsUpdate(@PathParam("brand_account_id") String brandAccountId, @PathParam("business_hierarchy_id") @Pattern(regexp="^\\d+$") @Size(min=1,max=20) String businessHierarchyId, @Valid BrandAccountUpdate brandAccountUpdate);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "An unexpected error response.", response = PinterestLibError.class) })
    public DeleteBusinessMembership200Response deleteBusinessMembership(@PathParam("business_id") @Pattern(regexp="^\\d+$") @Size(min=1,max=20) String businessId, @Valid DeleteBusinessMembershipBody deleteBusinessMembershipBody);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 404, message = "The requested resource could not be found on this server.", response = PinterestLibError.class),
        @ApiResponse(code = 200, message = "An unexpected error response.", response = PinterestLibError.class) })
    public DeleteBusinessPartners deleteBusinessPartners(@PathParam("business_id") @Pattern(regexp="^\\d+$") @Size(min=1,max=20) String businessId, @Valid DeleteBusinessPartnersDelete deleteBusinessPartnersDelete);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 429, message = "The user has sent too many requests in a given amount of time and is being rate limited.", response = PinterestLibError.class),
        @ApiResponse(code = 200, message = "An unexpected error response.", response = PinterestLibError.class) })
    public void systemUserUpdate(@PathParam("business_id") @Pattern(regexp="^\\d+$") @Size(min=1,max=20) String businessId, @PathParam("system_user_id") @Pattern(regexp="^\\d+$") @Size(min=1,max=20) String systemUserId, @Valid SystemUserUpdateWithRequiredBody systemUserUpdateWithRequiredBody);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 429, message = "The user has sent too many requests in a given amount of time and is being rate limited.", response = PinterestLibError.class),
        @ApiResponse(code = 200, message = "An unexpected error response.", response = PinterestLibError.class) })
    public UpdateBusinessMembershipsResponse updateBusinessMemberships(@PathParam("business_id") @Pattern(regexp="^\\d+$") @Size(min=1,max=20) String businessId, @Valid List<@Valid BusinessMembershipMember> businessMembershipMember);
}
