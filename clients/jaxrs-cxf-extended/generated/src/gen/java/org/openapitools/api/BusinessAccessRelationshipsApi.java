...
public interface BusinessAccessRelationshipsApi  {
    ...
    public BrandAccountsCreate200Response brandAccountsCreate(@PathParam("business_hierarchy_id") @Pattern(regexp="^\\d+$") @Size(min=1,max=20) String businessHierarchyId, @Valid BrandAccountsCreateRequest brandAccountsCreateRequest);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error", response = Error.class) })
    public BrandAccountsCreate200Response brandAccountsUpdate(@PathParam("business_hierarchy_id") @Pattern(regexp="^\\d+$") @Size(min=1,max=20) String businessHierarchyId, @PathParam("brand_account_id") @Pattern(regexp="^\\d+$") @Size(min=1,max=20) String brandAccountId, @Valid BrandAccountsUpdateRequest brandAccountsUpdateRequest);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error", response = Error.class) })
    public DeletedMembersResponse deleteBusinessMembership(@PathParam("business_id") @Pattern(regexp="^\\d+$") @Size(min=1,max=20) String businessId, @Valid MembersToDeleteBody membersToDeleteBody);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error", response = Error.class) })
    public DeletePartnersResponse deleteBusinessPartners(@PathParam("business_id") @Pattern(regexp="^\\d+$") @Size(min=1,max=20) String businessId, @Valid DeletePartnersRequest deletePartnersRequest);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 400, message = "Invalid parameters.", response = Error.class),
        @ApiResponse(code = 200, message = "Unexpected error", response = Error.class) })
    public void systemUserUpdate(@PathParam("business_id") @Pattern(regexp="^\\d+$") @Size(min=1,max=20) String businessId, @PathParam("system_user_id") @Pattern(regexp="^\\d+$") @Size(min=1,max=20) String systemUserId, @Valid SystemUserUpdateRequest systemUserUpdateRequest);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error", response = Error.class) })
    public UpdateMemberResultsResponseArray updateBusinessMemberships(@PathParam("business_id") @Pattern(regexp="^\\d+$") @Size(min=1,max=20) String businessId, @Valid List<@Valid UpdateMemberBusinessRoleBody> updateMemberBusinessRoleBody);
}
