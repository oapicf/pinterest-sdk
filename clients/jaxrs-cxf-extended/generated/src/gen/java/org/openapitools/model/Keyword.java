...
public class Keyword  {
 ...
 @Pattern(regexp="^\\d+$")  public String getParentId() {
   ...
   * <br><em>N.B. <code>parentId</code> is <b>read only</b>; client code should not call this method</em>.
   */
  ...
  */
   ...
   * <br><em>N.B. <code>parentType</code> is <b>read only</b>; client code should not call this method</em>.
   */
