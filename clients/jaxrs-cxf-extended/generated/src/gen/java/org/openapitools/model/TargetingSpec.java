...
public enum TARGETINGSTRATEGYEnum {
  ...
  */
  ...
  /**
   * Sets the <code>GEO_EXCLUDE</code> property.
   */
 public void setGEOEXCLUDE(List<String> GEO_EXCLUDE) {
  ...
  /**
   * Adds a new item to the <code>GEO_EXCLUDE</code> list.
   */
  ...
  */
  ...
  /**
   * Sets the <code>LOCATION_EXCLUDE</code> property.
   */
 public void setLOCATIONEXCLUDE(List<String> LOCATION_EXCLUDE) {
  ...
  /**
   * Adds a new item to the <code>LOCATION_EXCLUDE</code> list.
   */
