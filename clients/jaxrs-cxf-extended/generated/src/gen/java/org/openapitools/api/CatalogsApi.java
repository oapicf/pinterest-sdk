...
public interface CatalogsApi  {
    ...
    public Object catalogsProductGroupsCreate(@Valid CatalogsProductGroupCreateRequest catalogsProductGroupCreateRequest);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error.", response = Error.class) })
    public CatalogsProductGroup catalogsProductGroupsUpdate(@PathParam("product_group_id") @Pattern(regexp="^\\d+$") String productGroupId, @Valid CatalogsProductGroupUpdateRequest catalogsProductGroupUpdateRequest);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error", response = Error.class) })
    public CatalogsFeed feedsCreate(@Valid CatalogsFeedsCreateRequest catalogsFeedsCreateRequest);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 404, message = "Data feed not found.", response = Error.class),
        @ApiResponse(code = 200, message = "Unexpected error", response = Error.class) })
    public CatalogsFeed feedsUpdate(@PathParam("feed_id") @Pattern(regexp="^\\d+$") String feedId, @Valid CatalogsFeedsUpdateRequest catalogsFeedsUpdateRequest);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error", response = Error.class) })
    public CatalogsItemsBatch itemsBatchPost(@Valid CatalogsItemsBatchRequest catalogsItemsBatchRequest);
