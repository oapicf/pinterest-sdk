...
public interface CatalogsApi  {
    ...
    public Catalog catalogsCreate(@Valid CatalogsCreateRequest catalogsCreateRequest, @QueryParam("ad_account_id") @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 409, message = "Can't access this feature without an existing catalog.", response = Error.class),
        @ApiResponse(code = 200, message = "Unexpected error", response = Error.class) })
    public CatalogsCreateReportResponse reportsCreate(@Valid CatalogsReportParameters catalogsReportParameters, @QueryParam("ad_account_id") @Pattern(regexp="^\\d+$") @Size(max=18) String adAccountId);
