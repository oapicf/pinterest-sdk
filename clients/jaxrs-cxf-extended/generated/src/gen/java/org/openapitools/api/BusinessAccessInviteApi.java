...
public interface BusinessAccessInviteApi  {
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "An unexpected error response.", response = PinterestLibError.class) })
    public CancelInvitesResponse cancelInvitesOrRequests(@PathParam("business_id") @Pattern(regexp="^\\d+$") @Size(min=1) String businessId, @Valid CancelInvitesRequest cancelInvitesRequest);
