...
public interface BusinessAccessInviteApi  {
    ...
    public CreateAssetAccessRequestResponse assetAccessRequestsCreate(@PathParam("business_id") @Pattern(regexp="^\\d+$") @Size(min=1,max=20) String businessId, @Valid CreateAssetAccessRequestBody createAssetAccessRequestBody);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error", response = Error.class) })
    public DeleteInvitesResultsResponseArray cancelInvitesOrRequests(@PathParam("business_id") @Pattern(regexp="^\\d+$") @Size(min=1,max=20) String businessId, @Valid CancelInvitesBody cancelInvitesBody);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error", response = Error.class) })
    public UpdateInvitesResultsResponseArray createAssetInvites(@PathParam("business_id") @Pattern(regexp="^\\d+$") @Size(min=1,max=20) String businessId, @Valid CreateAssetInvitesRequest createAssetInvitesRequest);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error", response = Error.class) })
    public CreateInvitesResultsResponseArray createMembershipOrPartnershipInvites(@PathParam("business_id") @Pattern(regexp="^\\d+$") @Size(min=1,max=20) String businessId, @Valid CreateMembershipOrPartnershipInvitesBody createMembershipOrPartnershipInvitesBody);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error", response = Error.class) })
    public RespondToInvitesResponseArray respondBusinessAccessInvites(@Valid AuthRespondInvitesBody authRespondInvitesBody);
}
